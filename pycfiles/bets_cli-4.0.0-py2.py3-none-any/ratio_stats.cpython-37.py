...
# [GCC 8.4.0]
# Embedded file name: D:\PROJECT_HOME\bets-cli\src\bets\model\stats\ratio_stats.py
# Compiled at: 2019-05-15 20:14:28
...
class RatioStats(AbstractStats):
    KEYS = [
     'date', 'country', 'tournament', 'host_team', 'guest_team',
    ...
    def __init__(self, ratio_1, ratio_X, ratio_2, host_team='', guest_team='', date='', country='', tournament=''):
        ...
        self.ratio_geometric_mean = round((self.ratio_1 * self.ratio_X * self.ratio_2) ** 0.3333333333333333, 2)
