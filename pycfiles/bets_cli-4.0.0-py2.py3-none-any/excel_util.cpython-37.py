...
# [GCC 8.4.0]
# Embedded file name: D:\PROJECT_HOME\bets-cli\src\bets\utils\excel_util.py
# Compiled at: 2019-05-20 04:02:15
    ...
    with open_workbook(file) as (workbook):
        for worksheet in workbook.sheets():
            ...
            for row_index in range(1, worksheet.nrows):
                row_data = {headers[column_index]:worksheet.cell_value(row_index, column_index) for column_index in range(worksheet.ncols)}
