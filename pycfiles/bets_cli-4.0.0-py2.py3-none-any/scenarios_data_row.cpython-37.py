...
# [GCC 8.4.0]
# Embedded file name: D:\PROJECT_HOME\bets-cli\src\bets\ui\scenarios_tab\scenarios_data_row.py
# Compiled at: 2019-05-19 13:46:32
# Size of source mod 2**32: 4301 bytes
from tkinter import BOTH, LEFT, RIGHT, W, X, SE
from tkinter import LabelFrame
from tkinter import filedialog, messagebox
from tkinter.ttk import Button
import tkinter.ttk as TtkLabelFrame
...
class ScenariosDataRow(TtkLabelFrame):
    ...
    def _create_actions(self):
        ...
        Button(actions_frame, text='Delete',
          command=(self.destroy)).grid(column=2, row=0, padx=PAD_X, pady=PAD_Y, sticky=SE)
    ...
    def _export_scenarios(self, file_ext):
        ...
        elif messagebox.askyesno('Confirm export', f"Target file:\n{target_file}"):
