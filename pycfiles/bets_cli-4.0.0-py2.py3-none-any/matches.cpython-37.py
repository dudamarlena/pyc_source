...
# [GCC 8.4.0]
# Embedded file name: D:\PROJECT_HOME\bets-cli\src\bets\model\matches.py
# Compiled at: 2019-05-15 18:21:58
# Size of source mod 2**32: 8433 bytes
...
class Match:
    ...
    def __eq__(self, other):
        if isinstance(other, Match):
            return self.title == other.title and self.ratios == other.ratios
        return False
...
class Matches:
    ...
    @property
    def table(self) -> str:
        return tabulate(tabular_data=[m.dict for m in self],
