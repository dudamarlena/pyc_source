...
# [GCC 8.4.0]
# Embedded file name: D:\PROJECT_HOME\bets-cli\src\bets\ui\matches_tab\pasted_matches_input.py
# Compiled at: 2019-05-04 21:44:43
...
class PastedMatchesInput(LabelFrame):
    ...
    def __init__(self, parent, matches, column=0, row=1):
