...
# [GCC 8.4.0]
# Embedded file name: /Users/mando/neurospaces_project/sspy/source/snapshots/0/build/lib/sspy/plugins/solvers/heccer/solver.py
...
class Solver:
    ...
    def __init__(self, name='Untitled solver', plugin=None, constructor_settings=None, verbose=False):
        ...
        self.dump_options = heccer.heccer_base.HECCER_DUMP_INDEXERS_SUMMARY | heccer.heccer_base.HECCER_DUMP_INDEXERS_STRUCTURE | heccer.heccer_base.HECCER_DUMP_INTERMEDIARY_COMPARTMENTS_PARAMETERS | heccer.heccer_base.HECCER_DUMP_INTERMEDIARY_COMPARTMENT_SUMMARY | heccer.heccer_base.HECCER_DUMP_INTERMEDIARY_MECHANISM_SUMMARY | heccer.heccer_base.HECCER_DUMP_INTERMEDIARY_STRUCTURE | heccer.heccer_base.HECCER_DUMP_INTERMEDIARY_SUMMARY | heccer.heccer_base.HECCER_DUMP_TABLE_GATE_SUMMARY | heccer.heccer_base.HECCER_DUMP_TABLE_GATE_TABLES | heccer.heccer_base.HECCER_DUMP_VM_COMPARTMENT_MATRIX | heccer.heccer_base.HECCER_DUMP_VM_COMPARTMENT_MATRIX_DIAGONALS | heccer.heccer_base.HECCER_DUMP_VM_COMPARTMENT_OPERATIONS | heccer.heccer_base.HECCER_DUMP_VM_MECHANISM_DATA | heccer.heccer_base.HECCER_DUMP_VM_MECHANISM_OPERATIONS | heccer.heccer_base.HECCER_DUMP_VM_CHANNEL_POOL_FLUXES | heccer.heccer_base.HECCER_DUMP_VM_SUMMARY | heccer.heccer_base.HECCER_DUMP_VM_AGGREGATORS
        self.time_step = None
        self.granularity = 1
