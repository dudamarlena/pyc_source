...
class QueenDir(object):
    ...
    def add_queen(self, name, queen, lock, sched):
        ...
        """
        self.lib[name] = {'queen': queen, 'lock': lock, 'sched': sched, 
           'stat': None, 'result': None}
        return
