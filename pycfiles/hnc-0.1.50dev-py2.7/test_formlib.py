...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\hnc\tests\test_formlib.py
# Compiled at: 2013-08-17 13:29:47
...
def DUMMY_OPTIONS(n):
    return [ DummyNamedModel(i, i) for i in range(n) ]
...
class TestSimpleTemplatesFunctions(unittest.TestCase):
    ...
    def _get_multi_form(self, values={}, errors={}, grid=None):
        ...
        class Field(MultipleFormField):
            fields = [
             StringField('enrolled', 'Enrolled'), StringField('graduated', 'Graduated')]
