...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\hnc\tools\cms.py
# Compiled at: 2013-09-02 16:01:29
import logging, polib
...
class StaticContentLoader(object):
    ...
    def __call__(self, key, display_default=True, **kwargs):
        ...
        if result is None:
            result = ('###{}###').format(key) if display_default else ''
        else:
