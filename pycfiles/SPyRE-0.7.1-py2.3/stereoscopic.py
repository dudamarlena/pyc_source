...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\stereoscopic.py
# Compiled at: 2006-02-24 20:00:44
"""
...
__license__ = 'LGPL'
import math, sys, time, types, time, atexit, pdb, pygame
from pygame.locals import FULLSCREEN
import OpenGL.GL as ogl, OpenGL.GLU as oglu, spyre, la
...
class SubordinateEyeCameraRB(SubordinateEyeCamera):
    ...
    def displayBackground(self):
        ...
        ogl.glColorMask(True, False, False, True)
...
class StereoRedBlueCamera(StereoCamera):
    ...
    def displayBackground(self):
        ...
        bits = ogl.GL_DEPTH_BUFFER_BIT
        ogl.glClear(bits)
        ogl.glColorMask(False, True, True, True)
...
class StereoTopBottomInterface(StereoInterface):
    ...
    def __init__(self, interface):
        ...
        interface.keyMap['+'] = self.stereoRightUp
        interface.keyMap['-'] = self.stereoRightDown
