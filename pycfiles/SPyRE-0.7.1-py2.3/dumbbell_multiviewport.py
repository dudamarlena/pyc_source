...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\demos\dumbbell_multiviewport.py
# Compiled at: 2006-01-31 19:48:34
"""
...
@exclude gl.*
"""
import math, sys, atexit, pdb, pygame, OpenGL.GL as ogl, OpenGL.GLU as oglu
sys.path.append('..')
...
def main():
    ...
    light0 = spyre.Bulb([0.9, 0.9, 0.9, 1.0], [
     0.8, 0.8, 0.8, 1.0], [
     0.3, 0.3, 0.3, 1.0])
