...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\test_cams.py
# Compiled at: 2005-12-18 11:27:00
"""Tests for camera methods. Excludes testing OpenGL methods, which are tested in another test
module.

"""
import unittest, math, spyre
...
class T01_Functions(unittest.TestCase):
    ...
    def test003_oneOneOne(self):
        ...
        self.assert_(distance(sph, (1.732, 0.7854, 0.6155)) < FUZZ, sph)
