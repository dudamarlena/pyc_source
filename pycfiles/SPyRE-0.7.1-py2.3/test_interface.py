...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\test_interface.py
# Compiled at: 2005-12-18 11:38:44
...
def makeMouseButtonDownEvent(loc=(
 1, 1, 1)):
    """Create a pygame event for keystroke. """
...
class T03_Pivoting(T02_Basic):
    ...
    def test201_mouse(self):
        ...
        v1 = la.Vector(cam.eye[0] - cam.center[0], cam.eye[1] - cam.center[1], cam.eye[2] - cam.center[2])
        vD = v1 - v0
