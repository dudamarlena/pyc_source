...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/cmdmessenger/params.py
# Compiled at: 2015-01-27 20:17:15
...
int16_to_string = lambda v: str(int(v) & 65535)
int16_from_string = lambda s: int(s)
int16_to_bytes = lambda v: struct.pack('<h', v & 65535)
int16_from_bytes = lambda s: struct.unpack('<h', s)
int32_to_string = lambda v: str(int(v) & 4294967295)
int32_from_string = lambda s: int(s)
int32_to_bytes = lambda v: struct.pack('<i', v & 4294967295)
int32_from_bytes = lambda s: struct.unpack('<i', s)
float_to_string = lambda v: str(float(v))
...
types = {'bool': {'to': bool_to_string, 'from': bool_from_string}, 'int16': {'to': int16_to_string, 'from': int16_from_string}, 'int32': {'to': int32_to_string, 'from': int32_from_string}, 'float': {'to': float_to_string, 'from': float_from_string}, 'double': {'to': double_to_string, 'from': double_from_string}, 'char': {'to': char_to_string, 'from': char_from_string}, 'string': {'to': string_to_string, 'from': string_from_string}, 'float_sci': {'to': floatsci_to_string, 'from': floatsci_from_string}, 'double_sci': {'to': doublesci_to_string, 'from': doublesci_from_string}, 'byte_bool': {'to': bool_to_bytes, 'from': bool_from_bytes}, 'byte_int16': {'to': int16_to_bytes, 'from': int16_from_bytes}, 'byte_int32': {'to': int32_to_bytes, 'from': int32_from_bytes}, 'byte_float': {'to': float_to_bytes, 'from': float_from_bytes}, 'byte_double': {'to': double_to_bytes, 'from': double_from_bytes}}
types['b'] = types['bool']
types['i'] = types['int16']
