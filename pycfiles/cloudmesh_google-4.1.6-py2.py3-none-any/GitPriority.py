...
# Embedded file name: /Users/big/ENV2/lib/python2.7/site-packages/cloudmesh_gitissues/GitPriority.py
# Compiled at: 2016-03-17 02:00:26
    ...
    def sanitize(self, username, repository):
        ...
        if self.issues is None:
            ...
            for issue in self.issues:
                ...
                issue['location'] = ('{}/{}').format(username, repository)
