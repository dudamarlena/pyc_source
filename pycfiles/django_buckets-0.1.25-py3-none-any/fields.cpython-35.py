...
# [GCC 8.4.0]
# Embedded file name: /Volumes/Work/dev/cadasta/django-buckets/buckets/fields.py
# Compiled at: 2017-09-29 08:54:03
...
class S3File(object):
    ...
    def save(self):
        if not self.committed:
            name = os.path.join(self.field.upload_to, os.path.basename(self._file.name))
...
class S3FileField(models.Field):
    ...
    def formfield(self, *args, **kwargs):
        widget = S3FileUploadWidget(upload_to=self.upload_to, accepted_types=self.accepted_types)
