...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pivpy/pivpy.py
...
class PIVAccessor(object):
    ...
    def average(self):
        ...
        if self._average is None:
            ...
            self._average.attrs = self._obj.attrs
        return self._average

    def crop(self, crop_vector=[
 None, None, None, None]):
    ...
    def filterf(self):
        ...
        import scipy.ndimage.filters as gf
    ...
    def vorticity(self):
        ...
        """
        ux, _ = np.gradient((self._obj['u']), (self._obj['x']), (self._obj['y']), axis=(0,
                                                                                        1))
        _, vy = np.gradient((self._obj['v']), (self._obj['x']), (self._obj['y']), axis=(0,
                                                                                        1))
    ...
    def acceleration(self):
        ...
        """
        ux, uy = np.gradient((self._obj['u']), (self._obj['x']), (self._obj['y']), axis=(0,
                                                                                         1))
        vx, vy = np.gradient((self._obj['v']), (self._obj['x']), (self._obj['y']), axis=(0,
                                                                                         1))
    ...
    def tke(self):
        ...
        self._obj['w'] = (self._obj['u'] - self._obj['u'].mean(dim='t')) ** 2 + (self._obj['v'] - self._obj['v'].mean(dim='t')) ** 2
        vel_units = self._obj.attrs['units'][(-1)]
        self._obj.attrs['units'].append(f"({vel_units})^2")
        return self._obj
    ...
    def vec2scal(self, property='curl'):
        ...
        if len(self._obj.attrs['variables']) <= 4:
