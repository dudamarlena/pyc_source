...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysafelogging/__init__.py
# Compiled at: 2017-10-13 08:06:56
# Size of source mod 2**32: 71089 bytes
"""
...
class LogRecord(object):
    ...
    def __init__(self, name, level, pathname, lineno, msg, args, exc_info, func=None, sinfo=None, **kwargs):
        ...
        if args:
            ...
            self.processName = logMultiprocessing or None
        else:
        ...
        elif logProcesses and hasattr(os, 'getpid'):
