...
# [GCC 8.4.0]
# Embedded file name: /home/yjin/Workspace/DiffChip/DiffChip2/DIFFCHIP/ShortRead/ParseBEDFile.py
# Compiled at: 2014-02-11 10:38:19
"""
Created on Oct 13, 2011

@author: Ying Jin
"""
import sys, os, struct, logging, struct, gzip
from array import array
from time import time
from math import ceil, floor
from DIFFCHIP.Constants import BIN_SIZE, MAX_BIT, species_chrom_lengths
from DIFFCHIP.IO.FeatIO import FWTrackII
...
class BAMFile(GenericParser):
    ...
    def __binary_parse(self, data):
        if not data:
            ...
            if bwflag & 16:
                thisstrand = 1
                thisstart = thisstart + struct.unpack('<i', data[16:20])[0]
            else:
                thisstrand = 0
