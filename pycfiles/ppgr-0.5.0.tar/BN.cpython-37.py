...
# Embedded file name: build/bdist.linux-x86_64/egg/pgm/representation/BN.py
# Compiled at: 2020-02-25 01:12:00
...
class Graph(object):
    ...
    def __init__(self, type='list'):
        ...
        self.graph = {'node':[],  'node_idx':[],  'node_weightage':[],  'edge':[],  'edge_weightage':[]}
