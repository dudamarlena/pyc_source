...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pgpu/time_widgets.py
# Compiled at: 2012-10-16 12:42:13
"""
...
class BasicChronograph(tk.Label):
    ...
    def update(self):
        timedif = datetime.timedelta(seconds=time.time()) - (self.starttime + self.time_expired)
        if self.on:
