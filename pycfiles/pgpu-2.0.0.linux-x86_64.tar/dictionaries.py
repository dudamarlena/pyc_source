...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pgpu/dictionaries.py
# Compiled at: 2016-03-15 02:57:09
"""
...
class UpdatingDict(dict):
    ...
    def del_notify(self, obj):
        ...
        """
        assert obj in self.n, 'Cannot remove objects from notification list that are not in it!'
