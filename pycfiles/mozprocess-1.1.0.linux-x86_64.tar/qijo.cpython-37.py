...
# [GCC 8.4.0]
# Embedded file name: /home/ahal/.pyenv/versions/3.7.4/lib/python3.7/site-packages/mozprocess/qijo.py
# Compiled at: 2019-11-18 10:04:42
...
class JobObjectInfo(object):
    mapping = {'JobObjectBasicAndIoAccountingInformation':8, 
     'JobObjectExtendedLimitInformation':9, 
     'JobObjectAssociateCompletionPortInformation':7}
    structures = {7:JOBOBJECT_ASSOCIATE_COMPLETION_PORT, 
...
QueryInformationJobObjectProto = WINFUNCTYPE(BOOL, HANDLE, DWORD, LPVOID, DWORD, LPDWORD)
QueryInformationJobObjectFlags = ((1, 'hJob'), (1, 'JobObjectInfoClass'), (1, 'lpJobObjectInfo'),
                                  (1, 'cbJobObjectInfoLength'), (1, 'lpReturnLength', None))
...
def QueryInformationJobObject(hJob, JobObjectInfoClass):
    ...
    result = _QueryInformationJobObject(hJob=hJob,
