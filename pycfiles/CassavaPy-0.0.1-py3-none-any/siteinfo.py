...
# Embedded file name: /Users/moses/GitHub/cassava_public/cassava/Automater/siteinfo.py
...
class Site(object):
    ...
    def __init__(self, domainurl, webretrievedelay, proxy, targettype, reportstringforresult, target, useragent, friendlyname, regex, fullurl, importantproperty, params, headers, apikey):
        """
    ...
    def buildSiteFromXML(self, siteelement, webretrievedelay, proxy, targettype, target, useragent):
        ...
        return Site(domainurl, webretrievedelay, proxy, targettype, reportstringforresult, target, useragent, sitefriendlyname, regex, fullurl, importantproperty, params, headers, apikey)
    ...
    def MessageToPost(self):
        ...
        Return value(s):
        string -- representing a message to pass #NOMOREPRINTS print to
        the standard output.
    ...
    def ErrorMessage(self):
        ...
        Return value(s):
        string -- representing the error message to pass #NOMOREPRINTS print to
        the standard output.
...
class MultiResultsSite(Site):
    ...
    def __init__(self, site):
        ...
        """
        self._site = site
        super(MultiResultsSite, self).__init__(self._site.URL, self._site.WebRetrieveDelay, self._site.Proxy, self._site.TargetType, self._site.ReportStringForResult, self._site.Target, self._site.UserAgent, self._site.FriendlyName, self._site.RegEx, self._site.FullURL, self._site.ImportantPropertyString, self._site.Params, self._site.Headers, self._site.APIKey)
...
class PostTransactionPositiveCapableSite(Site):
    ...
    def __init__(self, site, postbydefault):
        ...
        if isinstance(self._site.RegEx, basestring):
            ...
            super(PostTransactionPositiveCapableSite, self).__init__(self._site.URL, self._site.WebRetrieveDelay, self._site.Proxy, self._site.TargetType, self._site.ReportStringForResult, self._site.Target, self._site.UserAgent, self._site.FriendlyName, newregexlist, self._site.FullURL, self._site.ImportantPropertyString, self._site.Params, self._site.Headers, self._site.APIKey)
            self.postMessage(self.UserMessage + ' ' + self.FullURL)
            ...
            if content != None:
                ...
                if content != None:
                    if not isinstance(self.FriendlyName, basestring):
...
class PostTransactionAPIKeySite(Site):
    ...
    def __init__(self, site):
        ...
        """
        self._site = site
        super(PostTransactionAPIKeySite, self).__init__(self._site.URL, self._site.WebRetrieveDelay, self._site.Proxy, self._site.TargetType, self._site.ReportStringForResult, self._site.Target, self._site.UserAgent, self._site.FriendlyName, self._site.RegEx, self._site.FullURL, self._site.ImportantPropertyString, self._site.Params, self._site.Headers, self._site.APIKey)
        self.postMessage(self.UserMessage + ' ' + self.FullURL)
        content = self.submitPost(self.Params, self.Headers)
        if content != None:
            if not isinstance(self.FriendlyName, basestring):
