...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/brackets_test.py
# Compiled at: 2020-04-27 11:44:30
...
class BracketsTest(unittest.TestCase):
    ...
    def test_missing_bracket_after(self):
        ...
        expected_message = get_formatted_message('missing_brackets.normal.closing.m',
          count=1, line_start=2, line_end=3)
    ...
    def test_miss_matched_bracket_types(self):
        ...
        expected_message = get_formatted_message('miss_matched_brackets.square.normal',
    ...
    def test_missing_square_bracket_after(self):
        ...
        expected_message = get_formatted_message('missing_brackets.square.closing',
          count=1, line_start=5, line_end=5)
        run_test_scenario(self, path, 1, expected_message)

    def test_missing_square_bracket_after2(self):
        path = 'brackets_samples/missing_square_bracket_after2_error.py'
        expected_message = get_formatted_message('missing_brackets.square.closing.m',
          count=1, line_start=5, line_end=7)
        run_test_scenario(self, path, 1, expected_message)
