...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\gulpy\stream.py
# Compiled at: 2017-01-18 19:03:42
...
class Stream(object):
    __doc__ = "Class that controls the entire stream.\n\n    >>> @Task('t1')\n    ... def t1():\n    ... s = Stream().src('file')\\\n    ...             .pipe(fun1)\\\n    ...             .dest('./dist')\n    ... return s\n\n    "
 ...
 str, object)) -> None:
    ...
    def _treat_files(self) -> None:
        ...
        self.files = [{'name':file,  'iterator':self._get_file_iterator(file)} for file in self.files]
