...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\getfontname\fontname.py
# Compiled at: 2016-08-19 03:55:09
# Size of source mod 2**32: 7705 bytes
...
class FontEntry:
    ...
    def __init__(self, rawstr):
        self.MajorVersion, self.MinorVersion, self.NumOfTables, self.SearchRange, self.EntrySelector, self.RangeShift = unpack(self.FormtStr, rawstr)
        self.Tables = {}
        self.Names = {}
        self.LocalNames = {}
...
class TableEntry:
    ...
    def __init__(self, rawstr):
        ...
        """
        tag, self.CheckSum, self.Offset, self.Length = unpack(self.FormtStr, rawstr)
...
class NameTableHeader:
    ...
    def __init__(self, rawstr):
        ...
        """
        self.Selector, self.Count, self.StringOffset = unpack(self.FormtStr, rawstr)
...
class NameRecord:
    ...
    def __init__(self, rawstr):
        ...
        """
        self.PlatformId, self.EncodingId, self.LangId, self.NameId, self.Length, self.Offset = unpack(self.FormtStr, rawstr)
    ...
    def getNameInfo(self, NameID, PlatformID=3, LanguageID=EN_US):
        ...
        eid, len, infoffset = self.NameRecords.get(nid, self.NameRecords.get(usnid, (None,
                                                                                     None,
                                                                                     None)))
        if eid is None:
            return
...
class OTFName:
    ...
    def loadFontName(self, fontentry):
        fentry = fontentry
