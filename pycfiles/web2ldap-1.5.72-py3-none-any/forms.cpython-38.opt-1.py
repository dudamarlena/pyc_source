...
# Compiled at: 2020-05-04 07:50:30
# Size of source mod 2**32: 32652 bytes
"""
...
class Field:
    ...
    __slots__ = ('accesskey', '_charset', 'default', 'maxLen', 'maxValues', 'name',
                 '_re', 'required', 'text', 'value')

    def __init__(self, name, text, maxLen, maxValues, pattern, required=False, default=None, accesskey=''):
        """
        name
...
class Textarea(Field):
    ...
    def __init__(self, name, text, maxLen, maxValues, pattern, required=False, default=None, accesskey='', rows=10, cols=60):
        self.rows = rows
        self.cols = cols
...
class Input(Field):
    ...
    def __init__(self, name, text, maxLen, maxValues, pattern, required=False, default=None, accesskey='', size=None):
...
class Radio(Field):
    ...
    def __init__(self, name, text, maxValues=1, required=False, default=None, accesskey='', options=None):
        """
...
class Select(Radio):
    ...
    def __init__(self, name, text, maxValues, required=False, default=None, accesskey='', options=None, size=1, ignoreCase=0, multiSelect=0):
        """
        Additional parameters:
        size
...
class DataList(Input, Select):
    ...
    def __init__(self, name, text, maxLen=100, maxValues=1, pattern=None, required=False, default=None, accesskey='', options=None, size=None, ignoreCase=0):
...
class Checkbox(Field):
    ...
    def __init__(self, name, text, maxValues=1, required=False, accesskey='', default=None, checked=0):
        """
...
class Form:
    ...
    __slots__ = ('accept_language', 'env', 'field', 'http_accept_charset', 'http_accept_encoding',
                 'http_accept_language', 'inf', 'input_field_names', 'query_string',
                 'request_method', 'script_name', 'uc_decode', 'uc_encode')
