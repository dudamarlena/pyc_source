...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/roles/role.py
...
class RoleType(type):
    ...
    *Changing role application*
    ...
    def overrides(self, subj):
        ...
        return class_fields(self).intersection(class_fields(subj.__class__).union(instance_fields))
