...
# [GCC 8.4.0]
# Embedded file name: /home/hadoop/nlpy/nlpy/deep/nnprocessors.py
# Compiled at: 2015-01-21 19:36:39
from functions import global_rand, FLOATX
import functools, theano, theano.tensor as T
...
def build_activation(act=None):
    ...
    if '+' in act:
        return functools.reduce(compose, (build_activation(a) for a in act.split('+')))
    options = {'tanh': T.tanh, 'linear': lambda z: z, 
