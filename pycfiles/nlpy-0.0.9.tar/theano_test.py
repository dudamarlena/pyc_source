...
# [GCC 8.4.0]
# Embedded file name: /home/hadoop/nlpy/nlpy/test/pca/theano_test.py
# Compiled at: 2014-11-21 02:42:28
import unittest, theano.tensor as T, theano, numpy as np
...
class TheanoTest(unittest.TestCase):
    ...
    def _test_function4(self):
        ...
        x = T.dscalar('x')
        hs, _ = theano.scan(joke, sequences=[np.array([0.0, 1.0, 2.0])], outputs_info=[np.float64(1.0)], non_sequences=[
         [
          w1, w2, w3]])
        print hs, _
        g1 = 0
