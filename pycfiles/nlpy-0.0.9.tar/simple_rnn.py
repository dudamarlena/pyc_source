...
# [GCC 8.4.0]
# Embedded file name: /home/hadoop/nlpy/nlpy/deep/networks/simple_rnn.py
# Compiled at: 2014-12-18 01:43:49
...
class SimpleRNNLayer(NeuralLayer):
    ...
    def __init__(self, size, target_size=-1, activation='sigmoid', noise=0.0, dropouts=0.0):
        """
    ...
    def _recurrent_func(self):
        (h_list, s_list), _ = theano.scan(fn=self._recurrent_step, sequences=self.x, outputs_info=[self.h0, None], n_steps=self.x.shape[0])
        return (
         h_list, s_list)
