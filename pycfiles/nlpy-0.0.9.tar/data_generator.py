...
# [GCC 8.4.0]
# Embedded file name: /home/hadoop/nlpy/nlpy/lm/data_generator.py
# Compiled at: 2015-01-20 03:45:47
from nlpy.util import LineIterator
import sys, numpy as np, math
from progressbar import ProgressBar
import random, logging as loggers
logging = loggers.getLogger(__name__)

class RNNDataGenerator(object):

    def __init__(self, vocab, data_path, history_len, batch_size=1, overlap=False, progress=False, fixed_length=True, target_vector=False, _just_test=False, shuffle=True, max_words=999, min_words=0):
        """
