...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/staff/templatetags/staff_tags.py
...
def staff_current_app(context, user, staff=None):
    context.update({'app_object':staff, 
     'user':user})
    return context
...
def staff_options(context, user, staff):
    context.update({'opt_object':staff, 
     'user':user})
    return context
