...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/case_studies/templatetags/case_study_tags.py
...
def case_study_current_app(context, user, case_study=None):
    context.update({'app_object':case_study, 
     'user':user})
    return context
...
def case_study_options(context, user, case_study):
    context.update({'opt_object':case_study, 
     'user':user})
    return context
