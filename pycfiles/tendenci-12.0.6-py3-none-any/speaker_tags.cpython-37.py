...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/speakers/templatetags/speaker_tags.py
...
def speaker_current_app(context, user, speaker=None):
    context.update({'app_object':speaker, 
     'user':user})
    return context
...
def speaker_options(context, user, speaker):
    context.update({'opt_object':speaker, 
     'user':user})
    return context
