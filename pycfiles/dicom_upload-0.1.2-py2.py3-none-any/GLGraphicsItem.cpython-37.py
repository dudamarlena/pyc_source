...
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/opengl/GLGraphicsItem.py
...
GLOptions = {'opaque':{GL_DEPTH_TEST: True, 
  GL_BLEND: False, 
  GL_ALPHA_TEST: False, 
  GL_CULL_FACE: False}, 
 'translucent':{GL_DEPTH_TEST: True, 
  GL_BLEND: True, 
  GL_ALPHA_TEST: False, 
  GL_CULL_FACE: False, 
  'glBlendFunc': (GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA)}, 
 'additive':{GL_DEPTH_TEST: False, 
  GL_BLEND: True, 
  GL_ALPHA_TEST: False, 
  GL_CULL_FACE: False, 
...
class GLGraphicsItem(QtCore.QObject):
    ...
    def __init__(self, parentItem=None):
        ...
        self._GLGraphicsItem__transform = Transform3D()
        self._GLGraphicsItem__visible = True
        self.setParentItem(parentItem)
        self.setDepthValue(0)
        self._GLGraphicsItem__glOpts = {}
    ...
    def setParentItem(self, item):
        ...
        if self._GLGraphicsItem__parent is not None:
            ...
            if item is not None:
                item._GLGraphicsItem__children.add(self)
            self._GLGraphicsItem__parent = item
            if self._GLGraphicsItem__parent is not None and self.view() is not self._GLGraphicsItem__parent.view():
                if self.view() is not None:
                    self.view().removeItem(self)
                self._GLGraphicsItem__parent.view().addItem(self)
    ...
    def setGLOptions(self, opts):
        ...
        if isinstance(opts, basestring):
            opts = GLOptions[opts]
        self._GLGraphicsItem__glOpts = opts.copy()
        self.update()
    ...
    def updateGLOptions(self, opts):
        ...
        *opts* must be a dictionary as specified by setGLOptions.
        ...
        """
        self._GLGraphicsItem__glOpts.update(opts)
    ...
    def setTransform(self, tr):
        ...
        self._GLGraphicsItem__transform = Transform3D(tr)
        self.update()

    def resetTransform(self):
        """Reset this item's transform to an identity transformation."""
        self._GLGraphicsItem__transform.setToIdentity()
        self.update()
    ...
    def viewTransform(self):
        ...
        tr = self._GLGraphicsItem__transform
        p = self
        while True:
            p = p.parentItem()
            if p is None:
    ...
    def setVisible(self, vis):
        ...
        self._GLGraphicsItem__visible = vis
        self.update()
    ...
    def setupGLState(self):
        ...
        """
        for k, v in self._GLGraphicsItem__glOpts.items():
            if v is None:
                continue
