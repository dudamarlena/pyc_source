...
class Terminal(object):
    ...
    def recolor(self, color=None, recurse=True):
        if color is None:
            ...
            elif self._value is None or eq(self._value, {}):
    ...
    def saveState(self):
        return {'io':self._io, 
         'multi':self._multi,  'optional':self._optional,  'renamable':self._renamable,  'removable':self._removable,  'multiable':self._multiable}
