...
class RemoteEventHandler(object):
 ...
 L. 240       936  LOAD_FAST                'obj'
              ...
              942  CALL_FUNCTION_EX_KW     1  'keyword args'
 ...
 L. 295      1406  LOAD_FAST                'self'
             ...
             1418  CALL_METHOD_0         0  ''
             1420  BUILD_TUPLE_UNPACK_WITH_CALL_2     2 
             1422  CALL_FUNCTION_EX      0  ''
             1424  POP_TOP          
             1426  POP_EXCEPT       
...
class LocalObjectProxy(object):
    ...
    def __reduce__(self):
        ...
        return (
         unpickleObjectProxy, (self.processId, pid, self.typeStr, None, self.opts))
