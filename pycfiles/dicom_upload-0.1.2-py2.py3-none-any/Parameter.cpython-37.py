...
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/parametertree/Parameter.py
# Compiled at: 2018-05-21 04:28:19
# Size of source mod 2**32: 32309 bytes
...
class Parameter(QtCore.QObject):
    ...
    def __init__(self, **opts):
        ...
        **Keyword Arguments:**
        ...
        if not ('name' not in self.opts or isinstance(self.opts['name'], basestring)):
    ...
    def insertChild(self, pos, child, autoIncrementName=None):
        ...
        if isinstance(child, dict):
            ...
            if name in self.names:
                if child is not self.names[name] and not autoIncrementName is True:
                    if not autoIncrementName is None or child.opts.get('autoIncrementName', False):
