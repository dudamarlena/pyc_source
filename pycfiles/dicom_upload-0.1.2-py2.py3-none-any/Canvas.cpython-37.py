...
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/canvas/Canvas.py
# Compiled at: 2018-05-21 04:28:19
# Size of source mod 2**32: 20748 bytes
if __name__ == '__main__':
    ...
    import graphicsItems.GridItem as GridItem
    if USE_PYSIDE:
...
class Canvas(QtGui.QWidget):
    ...
    def updateRedirect(self, *args):
        ...
        if self.ui.redirectCheck.isChecked():
            if cname != '':
                redirect = man.getCanvas(cname)
            else:
                redirect = None
        elif self.redirect is redirect:
            return
