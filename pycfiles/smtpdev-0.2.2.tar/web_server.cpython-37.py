...
class WebServer(MessageObserver):
 ...
 L.  65        48  SETUP_FINALLY       130  'to 130'

 L.  66        50  SETUP_LOOP          126  'to 126'
               52  LOAD_FAST                'ws'
               54  GET_AITER        
 ...
 L.  68        94  LOAD_FAST                'self'
               96  LOAD_ATTR                _logger
               98  LOAD_METHOD              debug

 L.  69       100  LOAD_STR                 'Websocket connection closed with exception %s'
              102  LOAD_FAST                'ws'
