...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/BinPy/Sequential/registers.py
...
class FourBitRegister(Register):
    ...
    def trigger(self):
        out = []
        for i in range(0, 4):
            ff1 = DFlipFlop(self.inputs[i], Connector(1), self.clock.A, clear=self.clear)
            while True:
