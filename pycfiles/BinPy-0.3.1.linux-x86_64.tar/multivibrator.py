...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/BinPy/tools/multivibrator.py
...
class Multivibrator(threading.Thread):
    ...
    def __init__(self, init_state=1, mode=1, frequency=None, time_period=None, on_time=None, off_time=None):
