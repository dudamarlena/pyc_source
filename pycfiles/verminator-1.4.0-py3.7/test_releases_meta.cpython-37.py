...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_releases_meta.py
# Compiled at: 2019-10-25 02:13:05
# Size of source mod 2**32: 6861 bytes
import unittest
...
class ProductReleaseMetaCase(unittest.TestCase):
    ...
    def assert_vrange_equal(self, vr, other):
        vr = (
         parse_version(vr[0]), parse_version(vr[1]))
    ...
    def test_get_tdc_version_range_legacy(self):
        ...
        self.assert_vrange_equal(pv.get('transwarp')[0], ('transwarp-5.2.1-final',
                                                          'transwarp-5.2.3-final'))
        self.assert_vrange_equal(pv.get('sophonweb')[0], ('sophonweb-1.3.0-final',
                                                          'sophonweb-1.3.0-final'))
    ...
    def test_get_compatible_versions(self):
        ...
        self.assert_vrange_equal(pv.get('transwarp')[0], ('transwarp-5.2.1-final',
                                                          'transwarp-6.0.1-final'))
        self.assert_vrange_equal(pv.get('sophonweb')[0], ('sophonweb-1.3.0-final',
                                                          'sophonweb-2.2.0-final'))
        ...
        self.assert_vrange_equal(pv.get('transwarp')[0], ('transwarp-5.2.1-final',
                                                          'transwarp-6.0.2-final'))
        self.assert_vrange_equal(pv.get('sophonweb')[0], ('sophonweb-2.2.0-final',
                                                          'sophonweb-2.2.1-final'))
    ...
    def test_get_compatible_versions_for_instance(self):
        ...
        self.assert_vrange_equal(pv.get('transwarp')[0], ('transwarp-5.2.2-final',
                                                          'transwarp-5.2.2-final'))
        ...
        self.assert_vrange_equal(pv.get('transwarp')[0], ('transwarp-6.0.2-final',
                                                          'transwarp-6.0.2-final'))
        self.assertTrue(pv.get('sophonweb') is None)
        self.assertTrue(pv.get('tdc') is None)
        self.assertTrue(pv.get('tos') is None)
        pv = meta.get_compatible_versions('sophonweb-2.2.1-final', instance_name='workflow')
        self.assert_vrange_equal(pv.get('transwarp')[0], ('transwarp-5.2.4-final',
                                                          'transwarp-5.2.4-final'))
        self.assert_vrange_equal(pv.get('sophonweb')[0], ('sophonweb-2.2.1-final',
                                                          'sophonweb-2.2.1-final'))
        self.assert_vrange_equal(pv.get('tos')[0], ('tos-1.9.2-final', 'tos-1.9.2-final'))
        self.assert_vrange_equal(pv.get('tdc')[0], ('tdc-2.0.0-rc3', 'tdc-2.0.0-rc3'))