...
class UtilsCase(unittest.TestCase):
    ...
    def test_filter_vrange(self):
        vr = (
         parse_version('sophonweb-1.3.0-final'), parse_version('sophonweb-2.2.1-final'))
        ...
        vr = (
         parse_version('sophonweb-1.3.0-final'), parse_version('sophonweb-1.3.0-final'))
        ...
        vr = (
         parse_version('sophonweb-2.2.0-final'), parse_version('sophonweb-2.2.0-final'))
        other = (parse_version('sophonweb-1.3.0-final'), parse_version('sophonweb-1.3.0-final'))
        self.assertTrue(filter_vrange(vr, other) is None)
        vr = (
         parse_version('sophonweb-2.0.0-final'), parse_version('sophonweb-2.0.0-final'))
        ...
        vr = (
         parse_version('transwarp-5.2.1-final'), parse_version('transwarp-6.0.2-final'))
