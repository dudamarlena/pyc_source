...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\templ\texceptions.py
...
"""
import filepos as tFilepos, ttypes, collections
...
class TemplateUserExecError(TemplateException):
 ...
 L.  72         0  LOAD_GLOBAL           0  'isinstance'
                3  LOAD_FAST             1  'exception'
                6  LOAD_GLOBAL           1  'TemplateException'
                9  CALL_FUNCTION_2       2  None
               12  POP_JUMP_IF_TRUE     30  'to 30'
               15  LOAD_ASSERT              AssertionError
               18  LOAD_GLOBAL           3  'type'
               21  LOAD_FAST             1  'exception'
               24  CALL_FUNCTION_1       1  None
               27  RAISE_VARARGS_2       2  None

 L.  73        30  LOAD_GLOBAL           4  'super'
               33  LOAD_GLOBAL           5  'TemplateUserExecError'
               36  LOAD_FAST             0  'self'
               39  CALL_FUNCTION_2       2  None
               42  LOAD_ATTR             6  '__init__'
               45  LOAD_FAST             1  'exception'
               48  LOAD_FAST             2  'filepos'
               51  CALL_FUNCTION_2       2  None
               54  POP_TOP          

 L.  74        55  LOAD_FAST             4  'definedAtFilepos'
               58  LOAD_FAST             0  'self'
               61  STORE_ATTR            7  'definedAtFilepos'

 L.  75        64  LOAD_FAST             3  'functionName'
               67  LOAD_FAST             0  'self'
               70  STORE_ATTR            8  'function'

 L.  76        73  LOAD_FAST             1  'exception'
               76  LOAD_FAST             0  'self'
               79  STORE_ATTR            9  'cause'

Parse error at or near `LOAD_FAST' instruction at offset 76
