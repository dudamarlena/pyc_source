...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/philip_pal/__main__.py
# Compiled at: 2020-03-13 11:30:21
...
def main():
    ...
    parser.add_argument('--dut_reset', action='store_true', help='Reset device-under-test (DUT)')
    parser.add_argument('--show_pinout', default=None, help='Shows the pinout 1=bluepill, 0=nucleo')
    parser.add_argument('--reset', action='store_true', help='Reset PHiLIP MCU')
    parser.add_argument('--fw', '-f', action='store_true', help='Gets the firmware version')
    parser.add_argument('port', action='store', type=str, nargs='?', help='PHiLIP serial port')
