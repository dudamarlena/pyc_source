...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/../pyipv8/ipv8/attestation/wallet/bonehexact/cryptosystem/ec.py
...
def esum(mod, p, q):
    ...
    y3 = l * (x3 - x1) + y1
    return (
     x3.normalize(), (FP2Value(mod, -1) * y3).normalize())
