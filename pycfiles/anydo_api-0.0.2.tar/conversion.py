...
# Embedded file name: /Users/martijndevos/Documents/tribler/Tribler/community/market/conversion.py
# Compiled at: 2018-02-08 05:46:45
...
class MarketConversion(BinaryConversion):
    ...
    def __init__(self, community):
        ...
        self.define_meta_message(chr(6), community.get_meta_message('info'), self._encode_info, self._decode_info)
        self.define_meta_message(chr(7), community.get_meta_message('match'), self._encode_match, self._decode_match)
        self.define_meta_message(chr(8), community.get_meta_message('accept-match'), self._encode_accept_match, self._decode_accept_match)
        self.define_meta_message(chr(9), community.get_meta_message('decline-match'), self._encode_decline_match, self._decode_decline_match)
        self.define_meta_message(chr(10), community.get_meta_message('proposed-trade'), self._encode_proposed_trade, self._decode_proposed_trade)
        self.define_meta_message(chr(11), community.get_meta_message('declined-trade'), self._encode_declined_trade, self._decode_declined_trade)
        self.define_meta_message(chr(12), community.get_meta_message('counter-trade'), self._encode_proposed_trade, self._decode_proposed_trade)
        self.define_meta_message(chr(13), community.get_meta_message('start-transaction'), self._encode_start_transaction, self._decode_start_transaction)
        self.define_meta_message(chr(14), community.get_meta_message('wallet-info'), self._encode_wallet_info, self._decode_wallet_info)
        self.define_meta_message(chr(15), community.get_meta_message('payment'), self._encode_payment, self._decode_payment)
        self.define_meta_message(chr(16), community.get_meta_message('order-status-request'), self._encode_order_status_request, self._decode_order_status_request)
        self.define_meta_message(chr(17), community.get_meta_message('order-status-response'), self._encode_order_status_response, self._decode_order_status_response)
    ...
    def _decode_payload(self, placeholder, offset, data, types):
        ...
        return (
         offset, placeholder.meta.payload.implement(*args))
