...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/pyipv8/ipv8/test/REST/attestationendpoint/rest_peer_communication.py
...
class HTTPGetRequesterAE(IGetStyleRequestsAE, HTTPRequester):
    ...
    def make_outstanding(self, param_dict):
        ...
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'GET', {'type': 'outstanding'}, param_dict.get('callback', None))
    ...
    def make_verification_output(self, param_dict):
        ...
        """
        interface, port, endpoint = HTTPRequester.get_access_parameters(param_dict)
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'GET', {'type': 'verification_output'}, param_dict.get('callback', None))
        returnValue(response)
        return
    ...
    def make_peers(self, param_dict):
        ...
        """
        interface, port, endpoint = HTTPRequester.get_access_parameters(param_dict)
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'GET', {'type': 'peers'}, param_dict.get('callback', None))
        returnValue(response)
        return
    ...
    def make_attributes(self, param_dict):
        ...
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'GET', request_parameters, param_dict.get('callback', None))
        returnValue(response)
        return
    ...
    def make_dht_block(self, param_dict):
        ...
        response = yield self.make_request(('http://{0}:{1}/{2}').format(interface, port, endpoint), 'GET', request_parameters, param_dict.get('callback', None))
        returnValue(response)
        return
    ...
    def make_drop_identity(self, param_dict):
        ...
        """
        interface, port, endpoint = HTTPRequester.get_access_parameters(param_dict)
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'GET', {'type': 'drop_identity'}, param_dict.get('callback', None))
        returnValue(response)
        return
...
class HTTPPostRequesterAE(IPostStyleRequestsAE, HTTPRequester):
    ...
    def make_attestation_request(self, param_dict):
        ...
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'POST', request_parameters, param_dict.get('callback', None))
        returnValue(response)
        return
    ...
    def make_attest(self, param_dict):
        ...
        if 'attribute_value' in param_dict:
            ...
            raise RequestException('Malformed request: did not specify the attribute_value, i.e. the attestationblob hash')
        response = yield self.make_request(HTTPRequester.basic_url_builder(interface, port, endpoint), 'POST', request_parameters, param_dict.get('callback', None))
        returnValue(response)
        return
