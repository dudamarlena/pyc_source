...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/core/bloomfilter.py
...
class BloomFilter(object):
    ...
    def _overload_constructor_arguments(cls, args, kargs):
        if len(args) >= 2 and isinstance(args[0], binary_type) and isinstance(args[1], int):
            ...
            logger.debug('constructing bloom filter based on f_error_rate %f and %d n_capacity', f_error_rate, n_capacity)
        ...
        return (
         m_size, k_functions, prefix, filter_)
    ...
    def __init__(self, *args, **kargs):
        ...
        if self._m_size >= 2147483648:
            fmt_code, chunk_size = ('Q', 8)
        elif self._m_size >= 32768:
