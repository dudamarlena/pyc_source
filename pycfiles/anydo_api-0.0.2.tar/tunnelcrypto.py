...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/pyipv8/ipv8/messaging/anonymization/tunnelcrypto.py
...
class TunnelCrypto(ECCrypto):
    ...
    def get_session_keys(self, keys, direction):
        keys[(direction + 4)] += 1
        return (
         keys[direction], keys[(direction + 2)], keys[(direction + 4)])
