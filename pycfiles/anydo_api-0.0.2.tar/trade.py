...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/core/trade.py
# Compiled at: 2019-06-08 04:52:20
import random
from anydex.core.message import Message
...
class Trade(Message):
    ...
    def propose(cls, trader_id, order_id, recipient_order_id, assets, timestamp):
        ...
        :rtype: ProposedTrade
        """
        return ProposedTrade(trader_id, order_id, recipient_order_id, random.randint(0, 100000000), assets, timestamp)
    ...
    def decline(cls, trader_id, timestamp, proposed_trade, decline_reason):
        ...
        :rtype: DeclinedTrade
        """
        return DeclinedTrade(trader_id, proposed_trade.recipient_order_id, proposed_trade.order_id, proposed_trade.proposal_id, timestamp, decline_reason)
    ...
    def accept(cls, trader_id, timestamp, proposed_trade):
        ...
        :rtype: AcceptedTrade
        """
        return AcceptedTrade(trader_id, proposed_trade.recipient_order_id, proposed_trade.order_id, proposed_trade.proposal_id, proposed_trade.assets, timestamp)
    ...
    def counter(cls, trader_id, assets, timestamp, proposed_trade):
        ...
        :rtype: CounterTrade
        """
        return CounterTrade(trader_id, proposed_trade.recipient_order_id, proposed_trade.order_id, proposed_trade.proposal_id, assets, timestamp)
...
class ProposedTrade(Trade):
    ...
    def from_network(cls, data):
        ...
        :rtype: ProposedTrade
        """
        return cls(data.trader_id, OrderId(data.trader_id, data.order_number), data.recipient_order_id, data.proposal_id, data.assets, data.timestamp)
...
class DeclinedTrade(Trade):
    ...
    def from_network(cls, data):
        ...
        :rtype: DeclinedTrade
        """
        return cls(data.trader_id, OrderId(data.trader_id, data.order_number), data.recipient_order_id, data.proposal_id, data.timestamp, data.decline_reason)
...
class AcceptedTrade(ProposedTrade):
    ...
    def to_block_dictionary(self):
        ...
        """
        return {'trader_id': self.recipient_order_id.trader_id.as_hex(), 
