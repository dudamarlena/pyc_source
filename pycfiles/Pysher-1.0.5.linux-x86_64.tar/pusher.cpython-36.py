...
# [GCC 8.4.0]
# Embedded file name: /home/nls/.virtualenvs/pysher/lib/python3.6/site-packages/pysher/pusher.py
...
class Pusher(object):
    ...
    def __init__(self, key, cluster='', secure=True, secret='', user_data=None, log_level=logging.INFO, daemon=True, port=443, reconnect_interval=10, custom_host='', auto_sub=False, http_proxy_host='', http_proxy_port=0, http_no_proxy=None, http_proxy_auth=None, **thread_kwargs):
        ...
        self.connection = Connection(self._connection_handler, self.url, reconnect_handler=reconnect_handler, 
         ...
         socket_kwargs=dict(http_proxy_host=http_proxy_host, http_proxy_port=http_proxy_port,
  http_no_proxy=http_no_proxy,
  http_proxy_auth=http_proxy_auth,
  ping_timeout=100), **thread_kwargs)
