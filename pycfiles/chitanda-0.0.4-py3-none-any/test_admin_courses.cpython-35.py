...
# Embedded file name: build/bdist.linux-x86_64/egg/chisubmit/tests/integration/cli/test_admin_courses.py
# Compiled at: 2018-10-02 19:35:34
# Size of source mod 2**32: 10382 bytes
from chisubmit.tests.common import cli_test, ChisubmitCLITestClient, ChisubmitCLITestCase, COURSE1_ID, COURSE1_NAME, COURSE2_ID, COURSE2_NAME
...
class CLIAdminCourseLoadUsers(ChisubmitCLITestCase):
    ...
    def test_admin_course_load_students_two(self, runner):
        ...
        self.assertEqual(len(user_objs), 7)
