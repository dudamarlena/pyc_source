...
# Embedded file name: build/bdist.linux-x86_64/egg/chisubmit/tests/integration/clientlibs/test_rubric_components.py
...
from chisubmit.tests.common import COURSE1_ASSIGNMENTS, COURSE2_ASSIGNMENTS, COURSE1_RUBRICS
...
class RubricComponentTests(ChisubmitClientLibsTestCase):
    fixtures = [
     'users', 'course1', 'course1_pa1', 'course1_pa2']
    ...
    def test_create_rubric_component(self):
        ...
        rc = assignment.create_rubric_component(description='Third Task', points=50, order=3)
