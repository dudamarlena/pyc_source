...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/emrt/necd/content/upgrades/evolve258.py
# Compiled at: 2020-05-04 05:35:07
import logging, transaction, plone.api as api
...
def upgrade(context):
    ...
    queries = [
     dict(portal_type='Question', review_state=[
      'recalled-msa', 'recalled-msa'], reindex_self_only=True)]
