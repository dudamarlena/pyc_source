...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/knxsonos/EIBConnection.py
# Compiled at: 2016-04-08 18:29:27
import errno, socket
...
class EIBConnection():
    ...
    def __EIB_SendRequest(self, data):
        if self.fd == None:
            ...
            if len(data) < 2 or len(data) > 65535:
                self.errno = errno.EINVAL
                return -1
            data = [
    ...
    def __EIBGetAPDU_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 37 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
    ...
    def __EIBGetAPDU_Src_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 37 or len(self.data) < 4:
                self.errno = errno.ECONNRESET
                return -1
            if self.ptr5 != None:
                self.ptr5.data = self.data[2] << 8 | self.data[3]
    ...
    def __EIBGetBusmonitorPacket_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 20 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            self.buf.buffer = self.data[2:]
            return len(self.buf.buffer)
    ...
    def __EIBGetGroup_Src_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 39 or len(self.data) < 6:
                self.errno = errno.ECONNRESET
                return -1
            if self.ptr5 != None:
                self.ptr5.data = self.data[2] << 8 | self.data[3]
            if self.ptr6 != None:
                self.ptr6.data = self.data[4] << 8 | self.data[5]
    ...
    def __EIB_Cache_Clear_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 114 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_Cache_Disable_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 113 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_Cache_Enable_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 1:
                self.errno = errno.EBUSY
                return -1
            if self.data[0] << 8 | self.data[1] != 112 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_Cache_Read_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 117 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            if self.data[4] << 8 | self.data[5] == 0:
    ...
    def __EIB_Cache_Read_Sync_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 116 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            if self.data[4] << 8 | self.data[5] == 0:
                self.errno = errno.ENODEV
    ...
    def __EIB_Cache_Remove_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 115 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_LoadImage_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 99 or len(self.data) < 4:
                self.errno = errno.ECONNRESET
                return -1
    ...
    def __EIB_MC_Authorize_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 87 or len(self.data) < 3:
                self.errno = errno.ECONNRESET
                return -1
            return self.data[2]
    ...
    def __EIB_MC_Connect_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 80 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_MC_Individual_Open_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 73 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_MC_GetMaskVersion_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 89 or len(self.data) < 4:
                self.errno = errno.ECONNRESET
                return -1
            return self.data[2] << 8 | self.data[3]
    ...
    def __EIB_MC_GetPEIType_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 85 or len(self.data) < 4:
                self.errno = errno.ECONNRESET
                return -1
            return self.data[2] << 8 | self.data[3]
    ...
    def __EIB_MC_Progmode_Off_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 96 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_MC_Progmode_Status_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 96 or len(self.data) < 3:
                self.errno = errno.ECONNRESET
                return -1
            return self.data[2]
    ...
    def __EIB_MC_PropertyDesc_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 97 or len(self.data) < 6:
                self.errno = errno.ECONNRESET
                return -1
            if self.ptr2 != None:
                self.ptr2.data = self.data[2]
            if self.ptr4 != None:
                self.ptr4.data = self.data[3] << 8 | self.data[4]
            if self.ptr3 != None:
    ...
    def __EIB_MC_PropertyRead_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 83 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            self.buf.buffer = self.data[2:]
            return len(self.buf.buffer)
    ...
    def __EIB_MC_PropertyScan_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 98 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            self.buf.buffer = self.data[2:]
            return len(self.buf.buffer)
    ...
    def __EIB_MC_PropertyWrite_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 84 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            self.buf.buffer = self.data[2:]
            return len(self.buf.buffer)
    ...
    def __EIB_MC_ReadADC_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 86 or len(self.data) < 4:
                self.errno = errno.ECONNRESET
                return -1
            if self.ptr1 != None:
                self.ptr1.data = self.data[2] << 8 | self.data[3]
            return 0
    ...
    def __EIB_MC_Read_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 81 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            self.buf.buffer = self.data[2:]
            return len(self.buf.buffer)
    ...
    def __EIB_MC_Restart_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 90 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_MC_SetKey_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 2:
                self.errno = errno.EPERM
                return -1
            if self.data[0] << 8 | self.data[1] != 88 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_MC_Write_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 68:
                self.errno = errno.EIO
                return -1
            if self.data[0] << 8 | self.data[1] != 82 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return self.sendlen
    ...
    def __EIB_MC_Write_Plain_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 91 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return self.sendlen
    ...
    def __EIB_M_GetMaskVersion_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 49 or len(self.data) < 4:
                self.errno = errno.ECONNRESET
                return -1
            return self.data[2] << 8 | self.data[3]
    ...
    def __EIB_M_Progmode_Off_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 48 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIB_M_Progmode_Status_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 48 or len(self.data) < 3:
                self.errno = errno.ECONNRESET
                return -1
            return self.data[2]
    ...
    def __EIB_M_ReadIndividualAddresses_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 50 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            self.buf.buffer = self.data[2:]
            return len(self.buf.buffer)
    ...
    def __EIB_M_WriteIndividualAddress_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 65:
                self.errno = errno.EADDRINUSE
                return -1
            if self.data[0] << 8 | self.data[1] != 67:
                self.errno = errno.ETIMEDOUT
                return -1
            if self.data[0] << 8 | self.data[1] != 66:
                self.errno = errno.EADDRNOTAVAIL
                return -1
            if self.data[0] << 8 | self.data[1] != 64 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenBusmonitor_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 1:
                self.errno = errno.EBUSY
                return -1
            if self.data[0] << 8 | self.data[1] != 16 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenBusmonitorText_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 1:
                self.errno = errno.EBUSY
                return -1
            if self.data[0] << 8 | self.data[1] != 17 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpen_GroupSocket_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 38 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenT_Broadcast_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 35 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenT_Connection_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 32 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenT_Group_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 34 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenT_Individual_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 33 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenT_TPDU_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 36 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenVBusmonitor_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 1:
                self.errno = errno.EBUSY
                return -1
            if self.data[0] << 8 | self.data[1] != 18 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBOpenVBusmonitorText_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 1:
                self.errno = errno.EBUSY
                return -1
            if self.data[0] << 8 | self.data[1] != 19 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
    ...
    def __EIBReset_Complete(self):
        ...
        if self.__EIB_GetRequest() == -1:
            ...
            if self.data[0] << 8 | self.data[1] != 4 or len(self.data) < 2:
                self.errno = errno.ECONNRESET
                return -1
            return 0
...
def readaddr(addr):
    if addr.find('.') != -1:
        a, b, c = addr.split('.')
        return (int(a) & 15) << 12 | (int(b) & 15) << 8 | int(c) & 255
...
def readgaddr(addr):
    if addr.count('/') == 2:
        a, b, c = addr.split('/')
        return (int(a) & 31) << 11 | (int(b) & 7) << 8 | int(c) & 255
    if addr.count('/') == 1:
        a, b = addr.split('/')
        return (int(a) & 31) << 11 | int(b) & 2047
    return int(addr, 16) & 65535


def group2string(addr):
    return '%d/%d/%d' % (addr >> 11 & 31, addr >> 8 & 7, addr & 255)


def individual2string(addr):
    return '%d.%d.%d' % (addr >> 12 & 15, addr >> 8 & 15, addr & 255)