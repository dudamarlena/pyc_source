...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/instatrace/stats.py
# Compiled at: 2010-09-19 09:04:41
import logging, math, simplejson as json
            ...
            for line in fd.xreadlines():
                ...
                if len(stat) >= 2:
                    try:
                        ...
                        _log.warn('skipped bad trace value (non-integer?): %s %s', stat[0], stat[1])
