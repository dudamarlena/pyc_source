...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/cmislib/browser_binding.py
# Compiled at: 2014-05-16 01:25:16
"""
...
class BrowserCmisObject(object):
    ...
    def reload(self, **kwargs):
        ...
        self.data = self._cmisClient.binding.get(byObjectIdUrl.encode('utf-8'), self._cmisClient.username, self._cmisClient.password, **kwargs)
        self._initData()
    ...
    def move(self, sourceFolder, targetFolder):
        ...
        result = self._cmisClient.binding.post(moveUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password)
    ...
    def delete(self, **kwargs):
        ...
        result = self._cmisClient.binding.post(delUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password, **kwargs)
...
class BrowserRepository(object):
    ...
    def query(self, statement, **kwargs):
        ...
        result = self._cmisClient.binding.post(queryUrl.encode('utf-8'), self._cmisClient.username, self._cmisClient.password, None, CMIS_FORM_TYPE, **kwargs)
            ...
            if self._data:
                ...
                for obj in self._data['objects']:
                    ...
                    if isinstance(obj, dict) and obj.has_key('object'):
                        ...
                        dataObj = obj
                    cmisObject = getSpecializedObject(BrowserCmisObject(self._cmisClient, self._repository, data=dataObj))
...
class BrowserDocument(BrowserCmisObject):
    ...
    def checkout(self):
        ...
        result = self._cmisClient.binding.post(coUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password)
    ...
    def checkin(self, checkinComment=None, **kwargs):
        ...
        props = {'objectId': self.id, 'cmisaction': 'checkIn'}
        result = self._cmisClient.binding.post(ciUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password, **kwargs)
        return getSpecializedObject(BrowserCmisObject(self._cmisClient, self._repository, data=result))
    ...
    def deleteContentStream(self):
        ...
        result = self._cmisClient.binding.post(delUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password)
...
class BrowserFolder(BrowserCmisObject):
    ...
    def createFolder(self, name, properties={}, **kwargs):
        ...
        result = self._cmisClient.binding.post(createFolderUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password, **kwargs)
    ...
    def createDocumentFromString(self, name, properties={}, contentString=None, contentType=None, contentEncoding=None):
        ...
        props = {'objectId': self.id, 'cmisaction': 'createDocument', 
           'propertyId[0]': 'cmis:name', 
           'propertyValue[0]': name}
        props['propertyId[1]'] = 'cmis:objectTypeId'
        if properties.has_key('cmis:objectTypeId'):
        ...
        result = self._cmisClient.binding.post(createDocUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password)
    ...
    def addObject(self, cmisObject, **kwargs):
        ...
        result = self._cmisClient.binding.post(addUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password)
        return getSpecializedObject(BrowserCmisObject(self._cmisClient, self._repository, data=result))
    ...
    def removeObject(self, cmisObject):
        ...
        props = {'folderId': self.id, 'cmisaction': 'removeObjectFromFolder', 
           'objectId': cmisObject.id}
        result = self._cmisClient.binding.post(remUrl.encode('utf-8'), urlencode(props), 'application/x-www-form-urlencoded', self._cmisClient.username, self._cmisClient.password)
        return getSpecializedObject(BrowserCmisObject(self._cmisClient, self._repository, data=result))
