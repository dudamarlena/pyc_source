...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/cmislib/domain.py
# Compiled at: 2017-08-27 12:29:50
"""
...
class ACE(object):
    ...
    def __cmp__(self, other):
        if isinstance(other, self.__class__) and self.principalId == other.principalId and self.direct == other.direct and not set(self.permissions) ^ set(other.permissions):
            return 0
        return -1
    ...
    def copy(self):
        ...
        """
        return self.__class__(principalId=self.principalId, permissions=self.permissions[:], direct=self.direct)
