...
# Embedded file name: build/bdist.linux-x86_64/egg/clipy/command.py
# Compiled at: 2010-02-15 10:09:10
__doc__ = 'Base classes for defining commands.\n'
import sys, getpass, optparse, pkg_resources
...
class CompositeCommand(Command):
    ...
    def __init__(self, commands=None, registry_cls=None, summary=None, add_help_command=True):
