...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/lpo/test/testexpression.py
...
class SubstituteTestCase(unittest.TestCase):
    ...
    def testTwoVarRepeatedSubstitute(self):
        ...
        expr2 = expr1.substitute(substitution)
        self.assertEquals(repr(expr2), 'corre(c=como(f=uerte, r=apido(as=juan), v=eloz), q=juan)')
