...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/karas/reporter.py
# Compiled at: 2019-01-15 01:15:42
# Size of source mod 2**32: 9873 bytes
import collections, contextlib, math, typing as tp, numpy, six, torch
SCALAR = 100
IMAGE = 200
VIDEO = 300
TEXT = 400
        ...
        for k, v in six.iteritems(d):
            ...
            if isinstance(v, tuple):
                ...
                if isinstance(w, torch.Tensor):
                    w = w.cpu().numpy()
                if not numpy.isscalar(w):
                    if not getattr(w, 'ndim', -1) == 0:
