...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpRigToolkit/loader.py
...
def init(do_reload=False, import_libs=True, dev=False):
    ...
    class tpRigToolkit(importer.Importer):
    ...
    rigtoolkit_importer.import_packages(order=packages_order,
      only_packages=False)
    if do_reload:
