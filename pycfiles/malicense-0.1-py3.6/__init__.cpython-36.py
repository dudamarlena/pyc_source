...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/malicense/__init__.py
# Compiled at: 2018-03-25 02:47:59
...
def main(package=None, licfilename='LICENSE', snapfilename='.lichash', warn_with=print, report_to=None, snap=False, **kwargs):
    """ API version. Must specify either package or licfilename
        ...
        If package is a python package, we will find its top directory,
    ...
    if package is not None:
        ...
        if snap:
            rehash(**newKwargs)
        elif not isLicenseValid(**newKwargs):
            invalid(**newKwargs)
...
def serve(port, logfilename='report.txt'):
