...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/bs4/builder/_html5lib.py
...
class HTML5TreeBuilder(HTMLTreeBuilder):
    ...
    features = [
     'html5lib', PERMISSIVE, HTML_5, HTML]
...
class Element(html5lib.treebuilders._base.Node):
    ...
    def appendChild(self, node):
        if node.element.__class__ == NavigableString and self.element.contents and self.element.contents[(-1)].__class__ == NavigableString:
