...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/bs4/testing.py
# Compiled at: 2013-03-18 16:15:18
"""Helper classes for tests."""
import copy, functools, unittest
...
class HTMLTreeBuilderSmokeTest(object):
    ...
    def test_real_xhtml_document(self):
        ...
        soup = self.soup(markup)
        self.assertEqual(soup.encode('utf-8').replace('\n', ''), markup.replace('\n', ''))
    ...
    def test_correctly_nested_tables(self):
        ...
        self.assertSoupEquals('<table><thead><tr><td>Foo</td></tr></thead><tbody><tr><td>Bar</td></tr></tbody><tfoot><tr><td>Baz</td></tr></tfoot></table>')
    ...
    def test_ampersand_in_attribute_value_gets_escaped(self):
        self.assertSoupEquals('<this is="really messed up & stuff"></this>', '<this is="really messed up &amp; stuff"></this>')
        self.assertSoupEquals('<a href="http://example.org?a=1&b=2;3">foo</a>', '<a href="http://example.org?a=1&amp;b=2;3">foo</a>')
    ...
    def test_smart_quotes_converted_on_the_way_in(self):
        ...
        self.assertEqual(soup.p.string, '‘Foo’')

    def test_non_breaking_spaces_converted_on_the_way_in(self):
        soup = self.soup('<a>&nbsp;&nbsp;</a>')
        self.assertEqual(soup.a.string, '\xa0\xa0')
...
class XMLTreeBuilderSmokeTest(object):
    ...
    def test_docstring_generated(self):
        soup = self.soup('<root/>')
        self.assertEqual(soup.encode(), '<?xml version="1.0" encoding="utf-8"?>\n<root/>')
    ...
    def test_docstring_includes_correct_encoding(self):
        soup = self.soup('<root/>')
        self.assertEqual(soup.encode('latin1'), '<?xml version="1.0" encoding="latin1"?>\n<root/>')
