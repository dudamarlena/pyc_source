...
# [GCC 8.4.0]
# Embedded file name: /home/gianluca/Pubblici/GIThub/MASTER/Videomass/videomass3/vdms_frames/ffmpeg_conf.py
...
class Checkconf(wx.MiniFrame):
    ...
    def __init__(self, out, FFMPEG_LINK, FFPROBE_LINK, FFPLAY_LINK, OS):
        ...
        enable_opt = wx.ListCtrl(nb_panel_3, (wx.ID_ANY), style=(wx.LC_REPORT | wx.SUNKEN_BORDER))
        ...
        disabled_opt = wx.ListCtrl(nb_panel_4, (wx.ID_ANY), style=(wx.LC_REPORT | wx.SUNKEN_BORDER))
