...
# [GCC 8.4.0]
# Embedded file name: /home/gianluca/Pubblici/GIThub/MASTER/Videomass/videomass3/vdms_dialogs/settings.py
# Compiled at: 2020-05-11 07:27:34
# Size of source mod 2**32: 30777 bytes
...
MSGLOG = _('The following settings affect output messages and the log messages\nduring processes. Change only if you know what you are doing.')
OPT_LOGLEV = [
...
class Setup(wx.Dialog):
    ...
    def __init__(self, parent, iconset):
        ...
        boxLabThreads = wx.StaticBoxSizer(wx.StaticBox(tabOne, wx.ID_ANY, _('FFmpeg threads option')), wx.VERTICAL)
        ...
        lab1_pane1 = wx.StaticText(tabOne, wx.ID_ANY, _('Set the number of threads (from 0 to 32)'))
        gridThreads.Add(lab1_pane1, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL, 5)
        self.spinctrl_threads = wx.SpinCtrl(tabOne, (wx.ID_ANY), ('%s' % FF_THREADS[9:]),
          size=(-1, -1),
          min=0,
          max=32,
          style=(wx.TE_PROCESS_ENTER))
        gridThreads.Add(self.spinctrl_threads, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL, 5)
        boxUserpath = wx.StaticBoxSizer(wx.StaticBox(tabOne, wx.ID_ANY, _('Where do you prefer to store files?')), wx.VERTICAL)
        ...
        gridUserpath.Add(self.btn_userpath, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL, 5)
        self.txtctrl_userpath = wx.TextCtrl(tabOne, (wx.ID_ANY), '', style=(wx.TE_READONLY))
        gridUserpath.Add(self.txtctrl_userpath, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL, 5)
        ...
        self.rdbFFmpeg = wx.RadioBox(tabTwo, (wx.ID_ANY), 'Set logging level flags used by FFmpeg',
          choices=OPT_LOGLEV,
          majorDimension=1,
          style=(wx.RA_SPECIFY_COLS))
        gridLog.Add(self.rdbFFmpeg, 0, wx.ALL | wx.EXPAND, 15)
        self.rdbFFplay = wx.RadioBox(tabTwo, (wx.ID_ANY), 'Set logging level flags used by FFplay',
          choices=OPT_LOGLEV,
          majorDimension=1,
          style=(wx.RA_SPECIFY_COLS))
        ...
        gridExec.Add((0, 25), 0)
        self.checkbox_exeFFmpeg = wx.CheckBox(tabThree, wx.ID_ANY, _(' Use a custom path to run FFmpeg'))
        self.btn_pathFFmpeg = wx.Button(tabThree, wx.ID_ANY, _('Browse..'))
        self.txtctrl_ffmpeg = wx.TextCtrl(tabThree, (wx.ID_ANY), '', style=(wx.TE_READONLY))
        ...
        self.checkbox_exeFFprobe = wx.CheckBox(tabThree, wx.ID_ANY, _(' Use a custom path to run FFprobe'))
        self.btn_pathFFprobe = wx.Button(tabThree, wx.ID_ANY, _('Browse..'))
        self.txtctrl_ffprobe = wx.TextCtrl(tabThree, (wx.ID_ANY), '', style=(wx.TE_READONLY))
        ...
        self.checkbox_exeFFplay = wx.CheckBox(tabThree, wx.ID_ANY, _(' Use a custom path to run FFplay'))
        self.btn_pathFFplay = wx.Button(tabThree, wx.ID_ANY, _('Browse..'))
        self.txtctrl_ffplay = wx.TextCtrl(tabThree, (wx.ID_ANY), '', style=(wx.TE_READONLY))
        ...
        self.checkbox_exeMpv = wx.CheckBox(tabThree, wx.ID_ANY, _(' Use a custom path to run mpv player'))
        self.btn_pathMpv = wx.Button(tabThree, wx.ID_ANY, _('Browse..'))
        self.txtctrl_mpv = wx.TextCtrl(tabThree, (wx.ID_ANY), '', style=(wx.TE_READONLY))
        ...
        boxLabIcons = wx.StaticBoxSizer(wx.StaticBox(tabFour, wx.ID_ANY, _('Set Icon Themes')), wx.VERTICAL)
        gridappearance.Add(boxLabIcons, 1, wx.ALL | wx.EXPAND, 15)
        self.cmbx_icons = wx.ComboBox(tabFour, (wx.ID_ANY), choices=[
        ...
        boxLabColor = wx.StaticBoxSizer(wx.StaticBox(tabFour, wx.ID_ANY, _('Custom Colour UI')), wx.VERTICAL)
        gridappearance.Add(boxLabColor, 1, wx.ALL | wx.EXPAND, 15)
        gridTBColor = wx.FlexGridSizer(3, 2, 0, 0)
        boxLabColor.Add(gridTBColor)
        labTBColor = wx.StaticText(tabFour, wx.ID_ANY, _('Change Toolbar Colour:'))
        gridTBColor.Add(labTBColor, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 15)
        btn_TBcolor = wx.Button(tabFour, wx.ID_ANY, _('Bar Colour'))
        gridTBColor.Add(btn_TBcolor, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 15)
        labTBColorBtn = wx.StaticText(tabFour, wx.ID_ANY, _('Change Toolbar Buttons Colour:'))
        gridTBColor.Add(labTBColorBtn, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 15)
        ...
        labFontColor = wx.StaticText(tabFour, wx.ID_ANY, _('Change Buttons Font Colour:'))
        gridTBColor.Add(labFontColor, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 15)
        btn_Fontcolor = wx.Button(tabFour, wx.ID_ANY, _('Font Colour'))
        gridTBColor.Add(btn_Fontcolor, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 15)
        btn_TBcolorClearBtn = wx.Button(tabFour, wx.ID_CLEAR, _('Restore default settings'))
        gridappearance.Add(btn_TBcolorClearBtn, 0, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_HORIZONTAL, 15)
        tabFour.SetSizer(gridappearance)
        ...
        msg = _('Enable custom paths for the executables. If the check boxes are disabled or if the path field is empty, the search for the executables is entrusted to the environment variables.')
    ...
    def current_settings(self):
        ...
        for s in range(self.rdbFFplay.GetCount()):
            if ffplay_loglevel.split()[1] in self.rdbFFplay.GetString(s).split()[0]:
                self.rdbFFplay.SetSelection(s)

        for s in range(self.rdbFFmpeg.GetCount()):
            if FFMPEG_LOGLEVel.split()[1] in self.rdbFFmpeg.GetString(s).split()[0]:
    ...
    def set_Userpath(self, event):
        ...
        dlg = wx.DirDialog(self, _('Set a default directory to save files'), '', wx.DD_DEFAULT_STYLE | wx.DD_DIR_MUST_EXIST)
    ...
    def logging_ffmpeg(self, event):
        ...
        self.full_list[self.rowsNum[4]] = '-loglevel %s -stats -hide_banner -nostdin\n' % s
    ...
    def open_path_ffmpeg(self, event):
        ...
        dialogfile = wx.FileDialog(self, _('Videomass: Where is the ffmpeg executable located?'), '', '', 'ffmpeg binarys (*%s)|*%s| All files (*.*)|*.*' % (
         self.ffmpeg, self.ffmpeg), wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
    ...
    def open_path_ffprobe(self, event):
        ...
        dialfile = wx.FileDialog(self, _('Videomass: Where is the ffprobe executable located?'), '', '', 'ffprobe binarys (*%s)|*%s| All files (*.*)|*.*' % (
         self.ffprobe, self.ffprobe), wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
    ...
    def open_path_ffplay(self, event):
        ...
        dialfile = wx.FileDialog(self, _('Videomass: Where is the ffplay executable located?'), '', '', 'ffplay binarys (*%s)|*%s| All files (*.*)|*.*' % (
         self.ffplay, self.ffplay), wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
        if dialfile.ShowModal() == wx.ID_OK:
            self.txtctrl_ffplay.SetValue('')
    ...
    def open_path_MPV(self, event):
        ...
        dialogfile = wx.FileDialog(self, _('Videomass: Where is the mpv executable located?'), '', '', 'mpv binarys (*%s)|*%s| All files (*.*)|*.*' % (
         self.mpv, self.mpv), wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
        if dialogfile.ShowModal() == wx.ID_OK:
            self.txtctrl_mpv.SetValue('')
    ...
    def onColorDlg(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            if identity == _('Bar Colour'):
                ...
                if identity == _('Buttons Colour'):
                    self.full_list[self.rowsNum[15]] = '%s\n' % choice
                else:
                    if identity == _('Font Colour'):
    ...
    def on_ok(self, event):
        ...
        wx.MessageBox(_('Changes will take affect once the program has been restarted'))
        self.Close()
        event.Skip()