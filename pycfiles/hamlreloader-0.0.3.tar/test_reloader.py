...
# [GCC 8.4.0]
# Embedded file name: /home/jack/code/hamlreloader/hamlreloader/tests/test_reloader.py
# Compiled at: 2013-11-06 15:04:13
import logging
...
def test_watch_directory():
    ...
    condition = Condition()
    p = Process(target=reloader.watch_directory, args=(
     watch_directory, render_directory, condition))
    condition.acquire()
    p.start()
    condition.wait()
    try:
