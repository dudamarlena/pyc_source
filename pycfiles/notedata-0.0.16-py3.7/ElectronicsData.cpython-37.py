...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notedata/dataset/ElectronicsData.py
# Compiled at: 2019-06-05 05:32:22
# Size of source mod 2**32: 6624 bytes
import logging, os, pickle, random, numpy as np, pandas as pd
...
class ElectronicsData:
    ...
    def convert_pd_1(self, overwrite=False):
        ...
        if exists((self.pkl_reviews), overwrite=overwrite):
            if exists((self.pkl_meta), overwrite=overwrite):
                return
