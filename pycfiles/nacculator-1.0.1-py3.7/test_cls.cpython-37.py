...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/tests/test_cls.py
...
import nacc.uds3.fvp as fvp_forms
import nacc.uds3.ivp as ivp_forms
...
def make_filled_record():
    return {'eng_preferred_language':'1', 
