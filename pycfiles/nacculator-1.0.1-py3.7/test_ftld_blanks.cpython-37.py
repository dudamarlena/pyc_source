...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/tests/test_ftld_blanks.py
# Compiled at: 2019-12-05 17:01:18
# Size of source mod 2**32: 14492 bytes
import unittest
...
class TestBlankRulesForFTLD(unittest.TestCase):
    ...
    def test_for_filled_when_ruled_blank(self):
        ...
        expected = ["'LANGA4' is '1' with length '1', but should be blank: 'Blank if Question 4b A4SUB = 0 (No)'."]
    ...
    def test_for_special_case_FTDMRIOS(self):
        ...
        warnings = []
        warnings = redcap2nacc.check_blanks(ipacket, self.options)
        expected = "'FTDMRIOS' is '1                                                           ' with length '60', but should be blank: 'Blank if Question 2a11 FTDMRIOB ne 1 (Yes)'."
