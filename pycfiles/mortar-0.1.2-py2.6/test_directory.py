...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mortar/storage/tests/test_directory.py
...
class StorageDirectoryTests(ReadOnlyStorageTests):
    ...
    def test_xml_in_field(self):
        self.assertEqual(self.storage.load('test')['testxml'].get(), 'some <xml>things\n</xml> different.')
