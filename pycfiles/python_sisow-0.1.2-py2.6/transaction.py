...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tests/transaction.py
# Compiled at: 2012-10-21 14:35:36
""""""
import unittest
...
class TestTransactionResponse(unittest.TestCase):
    ...
    def test_transactionresponse_values(self):
        ...
        self.assertEquals(response.issuerurl, 'https%3a%2f%2fwww.sisow.nl%2fSisow%2fiDeal%2fSimulator.aspx%3fmerchantid%3d2537492455%26txid%3dTEST080484779698%26sha1%3dbb9e98fff00960aa705560a56ff9c64e8e764b41')
...
class TestTransactionResponseFromManual(unittest.TestCase):
    ...
    def test_transactionresponse_values(self):
        ...
        self.assertEquals(response.issuerurl, 'https%3a%2f%2fbetalen.rabobank.nl%2fide%2fide.cgi%3fX009%3dBETAAL%26X010%3d20%26X015%3d%26V020%3d0050000513599081%26V022%3d01%26V021%3d9470173121213998')
