...
# [GCC 8.4.0]
# Embedded file name: /home/vagrant/envs/conversocial/lib/python2.7/site-packages/mongopony/tests/test_simple_strategy.py
...
class ClassFieldMapper(ClassFieldDelegator):
    name_to_mapper = {'Athlete': SimpleAthleteMapper, 
...
class AliasedClassFieldMapper(ClassFieldDelegator):
    name_to_mapper = {'Athlete': AliasedAthleteMapper, 
