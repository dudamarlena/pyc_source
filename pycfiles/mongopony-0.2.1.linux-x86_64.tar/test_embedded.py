...
# [GCC 8.4.0]
# Embedded file name: /home/vagrant/envs/conversocial/lib/python2.7/site-packages/mongopony/tests/test_embedded.py
...
class TestListFields(ConnectionMixin, TestCase):
    ...
    def test_write_person(self):
        person = PeopleMapper.create(first_name='Colin', last_name='Howe', tags=[
         TagMapper.create(tag_id=1, tag_name='awesome')])
