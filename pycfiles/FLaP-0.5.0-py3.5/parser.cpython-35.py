...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\flap\latex\parser.py
# Compiled at: 2017-01-09 09:18:50
...
class Parser:
    ...
    def _spawn(self, tokens, environment):
        ...
        return Parser(tokens, self._create, new_environment)
    ...
    def _rewrite_one(self):
        ...
        if self._next_token.begins_a_group:
            ...
            if self._next_token.is_a_command:
    ...
    def _raise_unexpected_token(self):
        error = "Unexpected {} '{}' in file {} (line {}, column {}).".format(self._next_token._category.name, self._next_token, self._next_token.location.source, self._next_token.location.line, self._next_token.location.column)
    ...
    def _evaluate_one(self):
        ...
        if self._next_token.begins_a_group:
            ...
            if self._next_token.is_a_parameter:
