...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\flap\util\path.py
# Compiled at: 2016-11-01 04:08:27
...
class Path:
    ...
    def absolute_from(self, current_directory):
        ...
        if parts[0].is_current_directory():
            ...
            if parts[0].is_parent_directory():
...
class Unit:
    ...
    def has_any_extension(self):
        return self._match and self._match.group(2) is not None
