...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/bayesdb/bql_grammar.py
...
update_codebook_for_keyword = Combine(update_keyword + single_white + codebook_keyword + single_white + for_keyword).setResultsName('statement_id')
update_codebook_for_keyword.setParseAction(replaceWith('update_codebook'))
update_descriptions_for_keyword = Combine(update_keyword + single_white + description_keyword + single_white + for_keyword).setResultsName('statement_id')
update_descriptions_for_keyword.setParseAction(replaceWith('update_descriptions'))
update_short_names_for_keyword = Combine(update_keyword + single_white + short_name_keyword + single_white + for_keyword).setResultsName('statement_id')
update_short_names_for_keyword.setParseAction(replaceWith('update_short_names'))
update_schema_for_keyword = Combine(update_keyword + single_white + schema_keyword + single_white + for_keyword).setResultsName('statement_id')
update_schema_for_keyword.setParseAction(replaceWith('update_schema'))
update_metadata_for_keyword = Combine(update_keyword + single_white + metadata_keyword + single_white + for_keyword).setResultsName('statement_id')
update_metadata_for_keyword.setParseAction(replaceWith('update_metadata'))
label_columns_for_keyword = Combine(label_keyword + single_white + column_keyword + single_white + for_keyword).setResultsName('statement_id')
...
show_metadata_for_keyword = Combine(show_keyword + single_white + metadata_keyword + single_white + for_keyword).setResultsName('statement_id')
show_metadata_for_keyword.setParseAction(replaceWith('show_metadata'))
show_label_for_keyword = Combine(show_keyword + single_white + label_keyword + single_white + for_keyword).setResultsName('statement_id')
...
show_schema_for_keyword = Combine(show_keyword + single_white + schema_keyword + single_white + for_keyword).setResultsName('statement_id')
show_schema_for_keyword.setParseAction(replaceWith('show_schema'))
show_models_for_keyword = Combine(show_keyword + single_white + model_keyword + single_white + for_keyword).setResultsName('statement_id')
show_models_for_keyword.setParseAction(replaceWith('show_models'))
show_diagnostics_for_keyword = Combine(show_keyword + single_white + diagnostics_keyword + single_white + for_keyword).setResultsName('statement_id')
show_diagnostics_for_keyword.setParseAction(replaceWith('show_diagnostics'))
show_column_lists_for_keyword = Combine(show_keyword + single_white + column_keyword + single_white + list_keyword + single_white + for_keyword).setResultsName('statement_id')
show_column_lists_for_keyword.setParseAction(replaceWith('show_column_lists'))
show_row_lists_for_keyword = Combine(show_keyword + single_white + row_keyword + single_white + list_keyword + single_white + for_keyword).setResultsName('statement_id')
show_row_lists_for_keyword.setParseAction(replaceWith('show_row_lists'))
estimate_pairwise_keyword = Combine(estimate_keyword + single_white + pairwise_keyword).setResultsName('statement_id')
...
estimate_pairwise_row_keyword = Combine(estimate_keyword + single_white + pairwise_keyword + single_white + row_keyword).setResultsName('statement_id')
...
estimate_columns_from_keyword = Combine(estimate_keyword + single_white + column_keyword + single_white + from_keyword).setResultsName('statement_id')
...
save_connected_components_with_threshold_keyword = Combine(save_keyword + single_white + connected_keyword + single_white + components_keyword + single_white + with_keyword + single_white + threshold_keyword)
save_connected_components_keyword = save_connected_components_with_threshold_keyword
save_clusters_with_threshold_keyword = Combine(save_keyword + single_white + clusters_keyword + single_white + with_keyword + single_white + threshold_keyword)
...
float_number = Regex('[-+]?[0-9]*\\.?[0-9]+') | sub_query
...
value = QuotedString('"', escChar='\\') | QuotedString("'", escChar='\\') | Word(printables, excludeChars=',;') | float_number | sub_query
filename = (QuotedString('"', escChar='\\') | QuotedString("'", escChar='\\') | Word(alphanums + '!"/#$%&\'()*+,-.:<=>?@[\\]^_`{|}~')).setResultsName('filename')
label = QuotedString('"', escChar='\\') | QuotedString("'", escChar='\\') | Word(printables, excludeChars=',;')
data_type_literal = categorical_keyword | numerical_keyword | ignore_keyword | key_keyword | cyclic_keyword
cyclic_parameters = Group(Suppress(paren_open_literal) + float_number.setResultsName('min') + Suppress(comma_literal) + float_number.setResultsName('max') + Suppress(paren_close_literal)).setResultsName('parameters')
categorical_parameters = Group(Suppress(paren_open_literal) + int_number.setResultsName('cardinality') + Suppress(paren_close_literal)).setResultsName('parameters')
...
create_btable_function = create_btable_keyword + btable + Suppress(from_keyword) + filename + Optional(with_keyword + codebook_keyword + filename.setResultsName('codebook_file'))
upgrade_btable_function = upgrade_btable_keyword + btable
type_clause = Group(ZeroOrMore(Group(identifier + Suppress(equal_literal) + data_type) + Suppress(comma_literal)) + Group(identifier + Suppress(equal_literal) + data_type)).setResultsName('type_clause')
update_schema_for_function = update_schema_for_keyword + btable + Suppress(set_keyword) + type_clause
label_clause = Group(ZeroOrMore(Group(identifier + Suppress(equal_literal) + OneOrMore(label)) + Suppress(comma_literal)) + Group(identifier + Suppress(equal_literal) + OneOrMore(label))).setResultsName('label_clause')
update_codebook_for_function = update_codebook_for_keyword + btable + Suppress(from_keyword) + filename
update_descriptions_for_function = update_descriptions_for_keyword + btable + Suppress(set_keyword) + label_clause
update_short_names_for_function = update_short_names_for_keyword + btable + Suppress(set_keyword) + label_clause
update_metadata_for_function = update_metadata_for_keyword + btable + (set_keyword + label_clause | from_keyword + filename)
label_columns_for_function = label_columns_for_keyword + btable + (set_keyword + label_clause | from_keyword + filename)
show_columns_function = show_columns_keyword + Optional(identifier.setResultsName('column_list')) + for_keyword + btable
show_metadata_function = show_metadata_for_keyword + btable + Optional(Group(identifier + ZeroOrMore(Suppress(comma_literal) + identifier)).setResultsName('keyset'))
show_label_function = show_label_for_keyword + btable + Optional(Group(identifier + ZeroOrMore(Suppress(comma_literal) + identifier)).setResultsName('columnset'))
execute_file_function = execute_file_keyword + filename
initialize_function = initialize_keyword + Optional(int_number.setResultsName('num_models')) + Suppress(models_for_keyword) + btable + Optional(with_keyword + config_keyword + (naive_bayes_keyword | crp_mixture_keyword).setResultsName('config'))
...
index_clause = Group((Group(int_number + Suppress(hyphen_literal) + int_number) | int_number) + ZeroOrMore(Suppress(comma_literal) + (Group(int_number + Suppress(hyphen_literal) + int_number) | int_number))).setParseAction(list_from_index_clause).setResultsName('index_clause')
...
analyze_function = analyze_keyword + btable + Optional(model_keyword + index_clause) + Suppress(for_keyword) + (int_number.setResultsName('num_iterations') + iteration_keyword | int_number.setResultsName('num_minutes') + minute_keyword) + Optional(with_kernel_clause) + Optional(wait_keyword).setResultsName('wait')
list_btables_function = list_btables_keyword
show_for_btable_statement = (show_schema_for_keyword | show_models_for_keyword | show_diagnostics_for_keyword | show_column_lists_for_keyword | show_analyze_for_keyword | show_row_lists_for_keyword) + btable
...
describe_function = describe_keyword + Optional(Group(identifier + ZeroOrMore(Suppress(comma_literal) + identifier) | all_column_literal).setResultsName('columnset')) + Suppress(for_keyword) + btable
...
management_query = create_btable_function | upgrade_btable_function | update_schema_for_function | execute_file_function | initialize_function | analyze_function | list_btables_function | show_for_btable_statement | load_model_function | save_model_from_function | drop_btable_function | drop_column_list_function | drop_row_list_function | drop_model_function | help_function | update_metadata_for_function | label_columns_for_function | show_label_function | describe_function | update_descriptions_for_function | update_short_names_for_function | update_codebook_for_function | show_metadata_function | show_columns_function | cancel_analyze_for_function | quit_function
row_clause = int_number.setResultsName('row_id') | identifier.setResultsName('column') + equal_literal + value.setResultsName('column_value')
column_list_clause = Group((identifier | all_column_literal) + ZeroOrMore(Suppress(comma_literal | and_keyword) + (identifier | all_column_literal))).setResultsName('column_list')
...
similarity_to_function = Group(similarity_keyword.setResultsName('function_id') + Optional(to_keyword.setResultsName('to') + row_clause) + Optional(with_respect_to_keyword + column_list_clause).setResultsName('with_respect_to')).setResultsName('function')
...
functions_of_two_columns_subclause = with_keyword + identifier.setResultsName('with_column') | of_keyword + identifier.setResultsName('of_column') + with_keyword + identifier.setResultsName('with_column')
dependence_probability_function = Group(dependence_probability_keyword.setResultsName('function_id') + Optional(functions_of_two_columns_subclause)).setResultsName('function')
mutual_information_function = Group(mutual_information_keyword.setResultsName('function_id') + Optional(functions_of_two_columns_subclause)).setResultsName('function')
correlation_function = Group(correlation_keyword.setResultsName('function_id') + Optional(functions_of_two_columns_subclause)).setResultsName('function')
two_column_function = dependence_probability_function | mutual_information_function | correlation_function
probability_of_function = Group(probability_of_keyword.setResultsName('function_id') + identifier.setResultsName('column') + equal_literal.setResultsName('op') + value.setResultsName('value')).setResultsName('function')
predictive_probability_of_function = Group(predictive_probability_of_keyword.setResultsName('function_id') + identifier.setResultsName('column')).setResultsName('function')
...
whereclause_potential_function = similarity_to_function | typicality_function | predictive_probability_of_function | two_column_function | Group(identifier.setResultsName('column'))
single_order_by = Group(whereclause_potential_function.setResultsName('function') + Optional(asc_keyword | desc_keyword).setResultsName('asc_desc') + Optional(conf_keyword + float_number.setResultsName('conf')))
order_by_clause = Group(Suppress(order_by_keyword) + single_order_by + ZeroOrMore(Suppress(comma_literal) + single_order_by)).setResultsName('order_by')
single_where_condition = Group((whereclause_potential_function.setResultsName('function') + operation_literal.setResultsName('operation') + value.setResultsName('value') | key_in_rowlist_clause) + Optional(conf_keyword + float_number.setResultsName('conf')))
where_clause = where_keyword.setResultsName('where_keyword') + Group(single_where_condition + ZeroOrMore(Suppress(and_keyword) + single_where_condition)).setResultsName('where_conditions')
save_connected_components_clause = Group(save_connected_components_keyword.setResultsName('save_connected_components') + float_number.setResultsName('threshold') + (as_keyword + identifier.setResultsName('as_label') | into_keyword + identifier.setResultsName('into_label'))).setResultsName('connected_components_clause')
save_clusters_clause = Group(save_clusters_keyword.setResultsName('save_clusters') + float_number.setResultsName('threshold') + (as_keyword + identifier.setResultsName('as_label') | into_keyword + identifier.setResultsName('into_label'))).setResultsName('clusters_clause')
list_clause = Group(int_number | identifier + ZeroOrMore(Suppress(comma_literal) + (int_number | identifier)))
single_given_condition = Group(identifier.setResultsName('column') + equal_literal + value.setResultsName('value'))
given_clause = Group(given_keyword + Group(single_given_condition + ZeroOrMore(Suppress(comma_literal | and_keyword) + single_given_condition)).setResultsName('given_conditions')).setResultsName('given_clause')
using_models_clause = using_models_keyword + index_clause.setResultsName('using_models_index_clause')
query_id = (select_keyword | infer_keyword | simulate_keyword | estimate_pairwise_row_keyword | estimate_pairwise_keyword | estimate_keyword | create_column_list_keyword).setResultsName('statement_id')
function_in_query = (predictive_probability_of_function | probability_of_function | typicality_function | similarity_to_function | dependence_probability_function | mutual_information_function | correlation_function | column_keyword | dependence_probability_keyword | Group((identifier | all_column_literal).setResultsName('column_id') + Optional(conf_keyword + float_number.setResultsName('conf')))).setResultsName('function')
functions_clause = Group(function_in_query + ZeroOrMore(Suppress(comma_literal) + function_in_query)).setResultsName('functions')
query = Optional(freq_keyword | hist_keyword | summarize_keyword | plot_keyword) + query_id + functions_clause + Suppress(from_keyword) + btable + Optional(where_clause) + Each(Optional(order_by_clause) + Optional(with_confidence_clause) + Optional(Suppress(with_keyword) + int_number.setResultsName('samples') + Suppress(sample_keyword)) + Optional(Suppress(limit_keyword) + int_number.setResultsName('limit')) + Optional(given_clause) + Optional(for_keyword + list_clause.setResultsName('for_list')) + Optional(Suppress(save_to_keyword) + filename) + Optional(save_clusters_clause) + Optional(Suppress(times_keyword) + int_number.setResultsName('times')) + Optional(using_models_clause) + Optional(Suppress(as_keyword) + identifier.setResultsName('as_column_list')) + Optional(Suppress(into_keyword) + identifier.setResultsName('newtablename')))
