...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/bayesdb/parser.py
# Compiled at: 2015-02-12 15:25:14
import utils, os, bql_grammar as bql, pyparsing as pp, functions, operator
...
class Parser(object):
    ...
    def parse_execute_file(self, bql_statement_ast):
        ...
        """
        return (
         'execute_file', dict(filename=self.get_absolute_path(bql_statement_ast.filename)), None)
    ...
    def parse_show_schema(self, bql_statement_ast):
        ...
        """
        return (
         'show_schema', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_show_models(self, bql_statement_ast):
        ...
        """
        return (
         'show_models', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_show_diagnostics(self, bql_statement_ast):
        ...
        """
        return (
         'show_diagnostics', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_drop_column_list(self, bql_statement_ast):
        ...
        return (
         'drop_column_list', dict(tablename=bql_statement_ast.btable, list_name=list_name), None)
    ...
    def parse_drop_row_list(self, bql_statement_ast):
        ...
        if bql_statement_ast.list_name != '':
            list_name = bql_statement_ast.list_name
        return (
         'drop_row_list', dict(tablename=bql_statement_ast.btable, list_name=list_name), None)
    ...
    def parse_drop_models(self, bql_statement_ast):
        ...
        return (
         'drop_models', dict(tablename=bql_statement_ast.btable, model_indices=model_indices), None)
    ...
    def parse_initialize_models(self, bql_statement_ast):
        ...
        return (
         'initialize_models', arguments_dict, None)
    ...
    def parse_create_btable(self, bql_statement_ast):
        ...
        return (
         'create_btable', dict(tablename=tablename, cctypes_full=None), client_dict)
    ...
    def parse_update_short_names(self, bql_statement_ast):
        ...
        return (
         'update_short_names', dict(tablename=tablename, mappings=mappings), None)
    ...
    def parse_update_descriptions(self, bql_statement_ast):
        ...
        return (
         'update_descriptions', dict(tablename=tablename, mappings=mappings), None)
    ...
    def parse_update_schema(self, bql_statement_ast):
        ...
        return (
         'update_schema', dict(tablename=tablename, mappings=mappings), None)
    ...
    def parse_drop_btable(self, bql_statement_ast):
        ...
        """
        return (
         'drop_btable', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_analyze(self, bql_statement_ast):
        ...
        return (
         'analyze',
         dict(tablename=tablename, model_indices=model_indices, iterations=iterations, seconds=seconds, ct_kernel=kernel, background=wait), None)

    def parse_cancel_analyze(self, bql_statement_ast):
        """
        :param bql_statement_ast pyparsing.ParseResults:
        :return ('cancel_analyze', args_dict, None):
        """
        return (
         'cancel_analyze', dict(tablename=bql_statement_ast.btable), None)

    def parse_show_analyze(self, bql_statement_ast):
        """
        :param bql_statement_ast pyparsing.ParseResults:
        :return ('show_analyze', args_dict, None):
        """
        return (
         'show_analyze', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_show_row_lists(self, bql_statement_ast):
        ...
        """
        return (
         'show_row_lists', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_show_column_lists(self, bql_statement_ast):
        ...
        """
        return (
         'show_column_lists', dict(tablename=bql_statement_ast.btable), None)
    ...
    def parse_show_columns(self, bql_statement_ast):
        ...
        """
        return (
         'show_columns', dict(tablename=bql_statement_ast.btable, column_list=bql_statement_ast.column_list[0]), None)
    ...
    def parse_save_models(self, bql_statement_ast):
        ...
        """
        return (
         'save_models', dict(tablename=bql_statement_ast.btable), dict(pkl_path=bql_statement_ast.filename))
    ...
    def parse_load_models(self, bql_statement_ast):
        ...
        """
        return (
         'load_models', dict(tablename=bql_statement_ast.btable), dict(pkl_path=bql_statement_ast.filename))

    def parse_label_columns(self, bql_statement_ast):
        """
        :param bql_statement_ast pyparsing.ParseResults:
    ...
    def parse_show_metadata(self, bql_statement_ast):
        ...
        return (
         'show_metadata', dict(tablename=tablename, keyset=keyset), None)
    ...
    def parse_show_label(self, bql_statement_ast):
        ...
        if bql_statement_ast.columnset != '':
            columnset = bql_statement_ast.columnset
        return (
         'show_labels', dict(tablename=tablename, columnset=columnset), None)
    ...
    def parse_query(self, bql_statement_ast):
        ...
        return (
         statement_id,
         dict(clusters_name=clusters_name, confidence=confidence, functions=functions, givens=givens, limit=limit, modelids=modelids, name=name, newtablename=newtablename, numpredictions=numpredictions, numsamples=numsamples, order_by=order_by, plot=plot, column_list=column_list, row_list=row_list, summarize=summarize, hist=hist, freq=freq, tablename=tablename, threshold=threshold, whereclause=whereclause),
         dict(plot=plot, scatter=False, pairwise=False, filename=filename))
    ...
    def parse_infer(self, bql_statement_ast):
        ...
        return (
         'infer',
         dict(tablename=tablename, functions=functions, newtablename=newtablename, confidence=confidence, whereclause=whereclause, limit=limit, numsamples=numsamples, order_by=order_by, plot=plot, modelids=modelids, summarize=summarize, hist=hist, freq=freq),
    ...
    def parse_select(self, bql_statement_ast):
        ...
        return (
         'select',
         dict(tablename=tablename, whereclause=whereclause, functions=functions, limit=limit, order_by=order_by, plot=plot, numsamples=numsamples, modelids=modelids, summarize=summarize, hist=hist, freq=freq, newtablename=newtablename),
    ...
    def parse_simulate(self, bql_statement_ast):
        ...
        return ('simulate',
         dict(tablename=tablename, functions=functions, newtablename=newtablename, givens=givens, numpredictions=numpredictions, order_by=order_by, plot=plot, modelids=modelids, summarize=summarize, hist=hist, freq=freq),
    ...
    def parse_estimate(self, bql_statement_ast):
        ...
        return (
         'estimate_columns',
         dict(tablename=tablename, functions=functions, whereclause=whereclause, limit=limit, numsamples=numsamples, order_by=order_by, name=name, modelids=modelids),
         None)
    ...
    def parse_estimate_pairwise_row(self, bql_statement_ast):
        ...
        return (
         'estimate_pairwise_row',
         dict(tablename=tablename, function=functions, row_list=row_list, clusters_name=clusters_name, threshold=threshold, modelids=modelids),
    ...
    def parse_estimate_pairwise(self, bql_statement_ast):
        ...
        return (
         'estimate_pairwise',
         dict(tablename=tablename, function_name=function_name, numsamples=numsamples, column_list=column_list, clusters_name=clusters_name, threshold=threshold, modelids=modelids),
         dict(filename=filename))
    ...
    def get_args_pairwise_column(self, function_group, M_c):
        ...
        return (
         of_column_index, with_column_index)
    ...
    def parse_where_clause(self, where_clause_ast, M_c, T, M_c_full, T_full, column_lists):
        ...
        """
        conditions = []
        operator_map = {'<=': operator.le, '<': operator.lt, '=': operator.eq, '>': operator.gt, 
           '>=': operator.ge, 'in': operator.contains}
        for single_condition in where_clause_ast:
            ...
            if single_condition.function.function_id == 'typicality':
                ...
                if column_name in M_c['name_to_idx']:
                    args = (
                     M_c['name_to_idx'][column_name], confidence)
                    ...
                    raise utils.BayesDBParseError('Invalid where clause: column %s was not found in the table' % column_name)
            elif single_condition.function.function_id != '':
                raise utils.BayesDBParseError('Invalid where clause: %s not allowed.' % single_condition.function.function_id)
            else:
    ...
    def parse_column_set(self, column_name, M_c, M_c_full, column_lists=None):
        ...
        return (
         index_list, name_list, ignore_column)
