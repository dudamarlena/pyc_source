...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\examples\plot_mvsc.py
...
clustering = clust[0]
labels_count = [np.unique((clustering[200 * i:200 * (i + 1)]), return_counts=True) for i in range(10)]
