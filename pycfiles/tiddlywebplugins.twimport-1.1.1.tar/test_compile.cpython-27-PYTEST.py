...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.twimport/test/test_compile.py
# Compiled at: 2013-11-12 16:48:14
import __builtin__ as @py_builtins, _pytest.assertion.rewrite as @pytest_ar

def test_compile--- This code section failed: ---

 L.   2         0  SETUP_EXCEPT        111  'to 114'

 L.   3         3  LOAD_CONST               -1
                6  LOAD_CONST               None
                9  IMPORT_NAME           0  'tiddlywebplugins.twimport'
               12  STORE_FAST            0  'tiddlywebplugins'

 L.   4        15  LOAD_GLOBAL           1  'True'
