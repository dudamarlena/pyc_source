...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/arf_tools/src/splitting.py
# Compiled at: 2018-04-07 21:34:02
...
def split_train_test(datax, datay, pourcentage_train=0.8, shuffle=True):
    ...
    return (
     np.array(datax_train), np.array(datay_train),
