...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/s_tui/sources/temp_source.py
...
class TempSource(Source):
    __doc__ = ' This class inherits a source and implements a temprature source '
    THRESHOLD_TEMP = 80
    ...
    def __init__(self, temp_thresh=None):
        ...
        self.pallet = ('temp light', 'temp dark', 'temp light smooth', 'temp dark smooth')
        self.alert_pallet = ('high temp light', 'high temp dark', 'high temp light smooth',
                ...
                for sensor_idx, sensor in enumerate(value):
                    ...
                    if not sensor_label:
                        ...
                        if 'package' not in full_name.lower():
                            if 'physical' not in full_name.lower():
