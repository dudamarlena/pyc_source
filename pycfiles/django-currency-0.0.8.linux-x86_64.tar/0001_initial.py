...
# [GCC 8.4.0]
# Embedded file name: /home/imposeren/kava/django-currency/.env/lib/python2.7/site-packages/currency/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'currency.currency': {'Meta': {'ordering': "('code',)", 'object_name': 'Currency'}, 'code': (
                                    'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '3'}), 
                             'full_name': (
                                         'django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}), 
                             'id': (
                                  'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                             'money_format': (
                                            'django.db.models.fields.CharField', [], {'default': "'%(currency)s%(value)s'", 'max_length': '64', 'blank': 'True'}), 
                             'short_name': (
                                          'django.db.models.fields.CharField', [], {'default': "''", 'max_length': '8', 'blank': 'True'})}, 
       'currency.exchangerate': {'Meta': {'ordering': "('-date', 'base_currency', 'foreign_currency')", 'unique_together': "(('base_currency', 'foreign_currency', 'date'),)", 'object_name': 'ExchangeRate'}, 'base_currency': (
                                                 'django.db.models.fields.related.ForeignKey', [], {'related_name': "'rates'", 'to': "orm['currency.Currency']"}), 
                                 'date': (
                                        'django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}), 
                                 'foreign_currency': (
                                                    'django.db.models.fields.related.ForeignKey', [], {'related_name': "'reverse_rates'", 'to': "orm['currency.Currency']"}), 
                                 'id': (
                                      'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                 'rate': (
                                        'django.db.models.fields.DecimalField', [], {'default': "'1'", 'max_digits': '9', 'decimal_places': '5'})}}
    complete_apps = [
     'currency']