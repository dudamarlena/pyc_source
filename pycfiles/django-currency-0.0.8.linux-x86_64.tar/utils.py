...
# [GCC 8.4.0]
# Embedded file name: /home/imposeren/kava/django-currency/.env/lib/python2.7/site-packages/currency/utils.py
# Compiled at: 2013-10-18 05:53:59
from functools import wraps
from django.core.cache import cache

def _memoize_result(owner_obj=None, func=None, memoize_key=None, args=None, kwargs=None):
    if owner_obj:
        try:
...
def memoize_for_object(func):
    ...
    def inner(self, *args, **kwargs):
        ...
        return _memoize_result(owner_obj=self, func=func, memoize_key=key_args, args=(
