...
# [GCC 8.4.0]
# Embedded file name: /home/robotics/github_repository_cloner/repository_analyzers/online/bitbucket_repository_analyzer.py
# Compiled at: 2019-02-05 04:02:00
# Size of source mod 2**32: 3156 bytes
import dateutil, logging
...
class BitbucketRepositoryAnalyzer(ISCSRepositoryAnalyzer):
    ...
    def __init__(self, settings: dict):
        ...
        """
        self._BitbucketRepositoryAnalyzer__api_bindings = BitbucketApiBindings(settings['bitbucket_api_rate_limit'])
    ...
    def count_stargazers(self, repo_uri: str, details: dict) -> None:
        ...
        :return: None
        """
        details['stars'] = self._BitbucketRepositoryAnalyzer__api_bindings.get_stargazer_count(repo_uri)
    ...
    def count_issues(self, repo_uri: str, details: dict) -> None:
        ...
        :return: None
        """
        for issue in self._BitbucketRepositoryAnalyzer__api_bindings.get_values(self._BitbucketRepositoryAnalyzer__api_bindings.get_issues_api_string(repo_uri)):
    ...
    def count_pull_requests(self, repo_uri: str, details: dict) -> None:
        ...
        :return: None
        """
        for pull_request in self._BitbucketRepositoryAnalyzer__api_bindings.get_values(self._BitbucketRepositoryAnalyzer__api_bindings.get_pull_requests_api_string(repo_uri)):
