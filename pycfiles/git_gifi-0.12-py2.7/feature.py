...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gifi/feature.py
# Compiled at: 2017-06-27 07:21:48
import logging, subprocess
from git import GitCommandError
import epic, git_hub, slack
...
def configuration(repo=None):
    repo = get_repo(repo)
    return Configuration(repo, 'feature', {'finish-with-rebase-interactive': (
                                        False, 'Should do a rebase interactive during feature finishing'), 
       'publish-with-pull-request': (
                                   False, 'Should create a pull request during feature publishing'), 
