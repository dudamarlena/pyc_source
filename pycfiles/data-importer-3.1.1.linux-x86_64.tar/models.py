...
# [GCC 8.4.0]
# Embedded file name: /mnt/d/Sandbox/huru-server/.venv/lib/python2.7/site-packages/data_importer/models.py
...
def get_random_filename(instance, filename):
    ...
    return os.path.join('upload_history', user_dir, date.today().strftime('%Y/%m/%d'), filename)
