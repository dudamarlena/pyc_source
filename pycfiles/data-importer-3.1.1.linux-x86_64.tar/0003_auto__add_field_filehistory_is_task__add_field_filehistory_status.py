...
# [GCC 8.4.0]
# Embedded file name: /mnt/d/Sandbox/huru-server/.venv/lib/python2.7/site-packages/data_importer/south_migrations/0003_auto__add_field_filehistory_is_task__add_field_filehistory_status.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('data_importer_filehistory', 'is_task', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('data_importer_filehistory', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
