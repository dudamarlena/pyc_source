...
# [GCC 8.4.0]
# Embedded file name: /mnt/d/Sandbox/huru-server/.venv/lib/python2.7/site-packages/data_importer/south_migrations/0005_auto__add_filehistorylog.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'data_importer.filehistorylog': {'Meta': {'object_name': 'FileHistoryLog'}, 'created_at': (
                                                     'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}), 
                                        'filehistory': (
                                                      'django.db.models.fields.related.ForeignKey', [], {'to': "orm['data_importer.FileHistory']"}), 
                                        'id': (
                                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                        'log': (
