...
# [GCC 8.4.0]
# Embedded file name: C:\Users\appli\Documents\GitHub\AlphaVantageAPI\alphaVantageAPI\alphavantage.py
# Compiled at: 2019-09-29 14:24:31
# Size of source mod 2**32: 27814 bytes
...
class AlphaVantage(object):
    ...
    def _save_df(self, function: str, df: DataFrame) -> None:
        ...
        if function == 'CURRENCY_EXCHANGE_RATE':
            ...
            if function == 'SECTOR':
                ...
                if function == 'BATCH_STOCK_QUOTES':
        ...
        if function == 'CURRENCY_EXCHANGE_RATE':
            ...
            if function == 'SECTOR':
                ...
                if function == 'BATCH_STOCK_QUOTES':
                    ...
                    column_names = [re.sub('timestamp', 'datetime', name) for name in column_names]
                    column_names = [re.sub('price', 'last', name) for name in column_names]
                else:
                    if function == 'SYMBOL_SEARCH':
                        column_names = [
    ...
    def batch(self, symbols: list, **kwargs) -> DataFrame or None:
        ...
        if not isinstance(symbols, list):
            symbols = [
             symbols]
        parameters = {'function':'BATCH_STOCK_QUOTES', 
