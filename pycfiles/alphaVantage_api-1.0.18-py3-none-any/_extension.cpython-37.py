...
# [GCC 8.4.0]
# Embedded file name: C:\Users\appli\Documents\GitHub\AlphaVantageAPI\alphaVantageAPI\_extension.py
...
class AlphaVantageDownloader(BasePandasObject):
    ...
    def global_quote(self, symbol: str, **kwargs):
    ...
    @output_size.setter
    def output_size(self, value: str):
