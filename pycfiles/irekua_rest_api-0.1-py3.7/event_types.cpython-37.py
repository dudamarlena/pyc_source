...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/irekua_rest_api/views/object_types/event_types.py
...
class EventTypeViewSet(mixins.RetrieveModelMixin, mixins.DestroyModelMixin, mixins.UpdateModelMixin, utils.CustomViewSetMixin, GenericViewSet):
    ...
    serializer_mapping = utils.SerializerMapping.from_module(serializers.object_types.events).extend(add_term_types=(serializers.object_types.terms.SelectSerializer),
