...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/irekua_rest_api/tests/test_synonyms.py
...
class SynonymTestCase(BaseTestCase, APITestCase):
    ...
    def setUp(self):
        ...
        self.terms = [Term.objects.create(term_type=term_type, value=(str(uuid4()))) for _ in range(40)]

    def generate_random_json_data(self):
        term1, term2 = sample(self.terms, 2)
        data = {'source':term1.pk, 
         'target':term2.pk, 
         'metadata':{}}
        return data