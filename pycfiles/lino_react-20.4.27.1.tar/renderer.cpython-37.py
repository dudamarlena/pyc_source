...
# [GCC 8.4.0]
# Embedded file name: /home/tonis/Projects/lino/src/react/lino_react/react/renderer.py
# Compiled at: 2020-04-03 13:42:10
...
import lino.core as ext_requests
 ...
 ar.actor.app_label, ar.actor.__name__, *args, **kw)
    ...
    def action_button(self, obj, ar, ba, label=None, **kw):
        ...
        if ba.action.parameters:
            if not ba.action.no_params_window:
                    ...
                    if hasattr(v.get_handle(), 'get_columns'):
                        ...
                        for c in result['col']:
                            ...
                            if isinstance(c, ComboFieldElement):
                                c.fields_index_hidden = isinstance(c, SimpleRemoteComboFieldElement) or c.fields_index + 1
                                index_mod += 1
