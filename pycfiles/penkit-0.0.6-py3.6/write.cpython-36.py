...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/penkit/write.py
# Compiled at: 2017-12-10 19:07:36
...
def plot_to_svg(plot, width, height, unit=''):
    ...
    for i, layer in enumerate(flipped_plot):
        group = ET.SubElement(svg, 'g', attrib={'inkscape:label':'{}-layer'.format(i), 
         'inkscape:groupmode':'layer'})
        color = PLOT_COLORS[(i % len(PLOT_COLORS))]
        ET.SubElement(group, 'path', attrib={'style':'stroke-width: {}; stroke: {};'.format(stroke_thickness, color), 
         'fill':'none', 
