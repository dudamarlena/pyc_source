...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/otest/test_setup.py
# Compiled at: 2017-05-08 02:21:20
...
def setup_conv():
    ...
    entity.provider_info = ProviderConfigurationResponse(authorization_endpoint='https://example.com')
    cls_factories = {'': oper.factory}
    func_factory = func.factory
    flow_state = FlowState('flows', profile_handler=ProfileHandler, cls_factories=cls_factories,
