...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/otest/session.py
# Compiled at: 2017-06-14 03:31:16
...
class SessionHandler(object):
    ...
    def session_setup(self, path='', flow=None, index=0):
        ...
        for key in _keys:
            if key in ('tests', 'flow_names', 'response_type', 'test_info', 'profile',
                       'test_conf', 'sid'):
                continue
            else:
                del self[key]
