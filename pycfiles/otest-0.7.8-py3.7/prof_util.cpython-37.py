...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/otest/prof_util.py
# Compiled at: 2019-01-04 03:35:19
# Size of source mod 2**32: 11515 bytes
import os
...
FORMPOST = 6
LABEL = [
 'return_type', 'webfinger', 'discover', 'register', 'crypto',
 'extra', 'form_post']
__author__ = 'roland'
EMAP = {'s':'sig', 
 'n':'none',  'e':'enc'}
...
RT = {'C':'code', 
 'I':'id_token',  'T':'token',  'CT':'code token',  'CI':'code id_token', 
 'IT':'id_token token',  'CIT':'code id_token token'}
...
FP = {'T': 'form_post'}
ATTR = [
 'return_type', 'webfinger', 'openid-configuration', 'registration',
...
class ProfileHandler(object):
    ...
    def get_profile_info(self, test_id=None):
        try:
            ...
            return {'Issuer':iss, 
             'Profile':profile,  'Test ID':test_id, 
