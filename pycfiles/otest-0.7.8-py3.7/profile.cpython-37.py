...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/otest/aus/preproc/profile.py
# Compiled at: 2018-06-26 01:35:36
...
def profile_form(prof):
    ...
    el.append('<i>(make sure to register https://&lt;host&gt;:&lt;port&gt;/authz_post as (one of) the redirect URI(s) when enabled!)</i></li></br>')
    if len(p) > FORMPOST:
        if p[FORMPOST] == 'T':
