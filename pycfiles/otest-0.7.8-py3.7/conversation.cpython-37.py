...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/otest/conversation.py
# Compiled at: 2017-05-15 03:23:23
...
class Conversation(object):
    ...
    def __init__(self, flow, entity, msg_factory, check_factory=None, features=None, opid=None, **extra_args):
        self.flow = flow
        self.entity = entity
    ...
    def dump_state(self, filename):
        state = {'client':{'behaviour':self.entity.behaviour, 
        ...
        try:
            state['client']['registration_resp'] = self.entity.registration_response.to_json()
    ...
    def get_redirect_uris(self):
        try:
            ...
            try:
                ...
                try:
                    return self.conf.CLIENT['registration_info']['redirect_uris']
                except KeyError:
                    return self.conf.CLIENT['registration_response']['redirect_uris']