...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/otest/io.py
# Compiled at: 2016-10-29 19:33:51
...
class IO(object):
    ...
    def __init__(self, flows, profile, desc='', profile_handler=None, cache=None, session=None, **kwargs):
        self.flows = flows
        self.cache = cache
...
class ClIO(IO):
    ...
    def __init__(self, flows, profile, desc='', profile_handler=None, cache=None, session=None, **kwargs):
        (IO.__init__)(self, flows, profile, desc, profile_handler, cache, session=session, **kwargs)
