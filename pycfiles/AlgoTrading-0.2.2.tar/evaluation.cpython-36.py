...
# Embedded file name: /Users/vrishank/anaconda3/lib/python3.6/site-packages/algotrader/evaluation.py
...
class Evaluation:
    ...
    def plot_output(self):
        ...
        ax.set(xlabel='Days', ylabel='INR', title=('Running %s on %s stocks' % (self.algo, self.security)))
        ax.grid()
        plt.show()
    ...
    def complete_evaluation(self, get_plots=True, verbose=True):
        """
                ...
                """
        return (
         self.sharpe_ratio(), self.sortino_ratio(), self.roi() * 100)