...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/help/entities/syntax_elements/objects/type_list.py
...
class _Documentation(SyntaxElementDocumentation):
    ...
    def __init__(self):
        super().__init__(TypeCategory.DATA, syntax_elements.LIST_SYNTAX_ELEMENT)
...
_SYMBOL_REFERENCE_DESCRIPTION = 'A reference to a {symbol} defined as either {string_type} or {list_type}.\n\n\nIf it is a {list_type}, it is concatenated with the surrounding elements -\nlists cannot be nested.\n'