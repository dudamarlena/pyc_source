...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/program/parse/parse_shell_command.py
...
_PARSE_FORMAT_MAP = {'COMMAND': instruction_arguments.COMMAND_ARGUMENT.name}