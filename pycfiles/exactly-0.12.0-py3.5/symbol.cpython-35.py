...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/help/entities/concepts/objects/symbol.py
...
class _SymbolConcept(ConceptDocumentation):
    ...
    def __init__(self):
        ...
        self._parser = TextParser({'program_name': formatting.program_name(program_info.PROGRAM_NAME), 
         ...
         'max_type_width': max(map(lambda type_info: len(type_info.identifier), TYPE_INFO_DICT.values())), 
    ...
    def _reference_paragraphs(self) -> List[ParagraphItem]:
        ...
        part_2_parser = TextParser({'program_name': formatting.program_name(program_info.PROGRAM_NAME), 
         ...
         'special_syntax_with_valid_symbol_name_but_invalid_delimiter': symbol_reference_syntax_for_name('VALID_SYMBOL_NAME')[:-1], 
