...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/section_document/element_parsers/token_stream.py
...
class TokenStream:
    ...
    def look_ahead_state(self) -> LookAheadState:
        if self._head_token:
            ...
            if not self._head_syntax_error_description:
