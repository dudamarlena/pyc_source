...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case/validation/sdv_validation.py
# Compiled at: 2020-01-20 18:20:40
# Size of source mod 2**32: 10454 bytes
from abc import ABC, abstractmethod
from enum import Enum
from typing import Iterable, Sequence, Optional, Callable
from exactly_lib.common.report_rendering.text_doc import TextRenderer
from exactly_lib.symbol.path_resolving_environment import PathResolvingEnvironmentPreSds, PathResolvingEnvironmentPostSds, PathResolvingEnvironmentPreOrPostSds, PathResolvingEnvironment
...
class FixedPreOrPostSdsValidator(PreOrPostSdsValidatorPrimitive):
    ...
    def __init__(self, environment: PathResolvingEnvironmentPreOrPostSds, validator: SdvValidator):
...
class SingleStepSdvValidator(SdvValidator):
    ...
    def __init__(self, step_to_apply: ValidationStep, validator: SdvValidator):
...
class PreOrPostSdsSvhValidationErrorValidator:
    ...
    def validate_pre_sds_if_applicable(self, environment: PathResolvingEnvironmentPreSds) -> svh.SuccessOrValidationErrorOrHardError:
        return self._translate(self.validator.validate_pre_sds_if_applicable(environment))

    def validate_post_sds_if_applicable(self, environment: PathResolvingEnvironmentPostSds) -> svh.SuccessOrValidationErrorOrHardError:
        return self._translate(self.validator.validate_post_sds_if_applicable(environment))

    def validate_pre_or_post_sds(self, environment: PathResolvingEnvironmentPreOrPostSds) -> svh.SuccessOrValidationErrorOrHardError:
