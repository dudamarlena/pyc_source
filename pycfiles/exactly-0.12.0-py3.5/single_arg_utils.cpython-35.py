...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/instructions/configuration/utils/single_arg_utils.py
...
MANDATORY_EQ_ARG = a.Single(a.Multiplicity.MANDATORY, a.Named(instruction_arguments.ASSIGNMENT_OPERATOR))
