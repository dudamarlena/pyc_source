...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/cli/program_modes/help/entities_requests.py
...
class EntityHelpRequest(HelpRequest):
    ...
    def __init__(self, entity_type: str, item: EntityHelpItem, individual_entity: EntityDocumentation=None,
...
class EntityHelpRequestRendererResolver:
    ...
    def __init__(self, entity_doc_2_article_contents_renderer, cli_list_renderer_getter: CliListConstructorGetter, all_entities: list):
    ...
    def renderer_for(self, request: EntityHelpRequest) -> SectionContentsConstructor:
        ...
        if item is EntityHelpItem.INDIVIDUAL_ENTITY:
            return with_or_without_name(request.do_include_name_in_output, request.individual_entity.singular_name(), self.entity_doc_2_article_contents_renderer(request.individual_entity))
