...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/type_system/data/path_ddv.py
...
from exactly_lib.test_case_file_structure.path_relativity import SpecificPathRelativity, RESOLVING_DEPENDENCY_OF, DirectoryStructurePartition
...
class PathDdv(Max1DependencyDdv[pathlib.Path], ABC):
    ...
    def resolving_dependencies(self) -> Set[DirectoryStructurePartition]:
        ...
        if relativity.is_absolute:
            ...
            return {
             RESOLVING_DEPENDENCY_OF[relativity.relativity_type]}
