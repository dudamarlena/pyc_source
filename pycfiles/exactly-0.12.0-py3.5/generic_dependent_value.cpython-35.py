...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/generic_dependent_value.py
...
class SdvFromParts(Generic[PRIMITIVE], Sdv[PRIMITIVE]):
    ...
    def __init__(self, make_ddv: Callable[([SymbolTable], Ddv[PRIMITIVE])], symbol_references: Sequence[SymbolReference]=()):
...
def sdv_of_constant_primitive(primitive: PRIMITIVE) -> Sdv[PRIMITIVE]:
    return ConstantSdv(ConstantDdv(ConstantAdv(primitive)))