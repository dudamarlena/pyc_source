...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/cli/program_modes/symbol/impl/reports/symbol_info.py
...
class SourceInfo:
    ...
    def __init__(self, source_location_info: Optional[SourceLocationInfo], source_lines: Optional[List[str]]):
...
class ContextAnd(Generic[SYMBOL_INFO]):
    ...
    def __init__(self, phase: Phase, source_info: SourceInfo, value: SYMBOL_INFO):
        self._phase = phase
...
class SymUsageInPhase(Generic[SYMBOL_INFO]):
    ...
    def __init__(self, phase: Phase, value: SYMBOL_INFO):
        self._phase = phase
        self._value = value
...
class SymbolDefinitionInfo:
    ...
    def __init__(self, phase: Optional[Phase], definition: SymbolDefinition, references: List[ContextAnd[SymbolReference]]):
        self.phase = phase
        self.definition = definition
        self.references = references

    @staticmethod
    def new_builtin(definition: SymbolDefinition, references: List[ContextAnd[SymbolReference]]) -> 'SymbolDefinitionInfo':
