...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/type_system/logic/string_matcher.py
...
class DestinationFilePathGetter:
    ...
    def get(self, tmp_file_space: TmpDirFileSpace, src_file_path: pathlib.Path) -> pathlib.Path:
        """
...
class FileToCheck:
    ...
    def __init__(self, original_file_path: DescribedPath, string_transformer: StringTransformer, tmp_file_for_transformed_getter: DestinationFilePathGetter):
    ...
    def with_transformation(self, string_transformer: StringTransformer) -> 'FileToCheck':
        return FileToCheck(self._original_file_path, string_transformer, self._tmp_file_for_transformed_getter)
    ...
    def transformed_file_path(self, tmp_file_space: TmpDirFileSpace) -> pathlib.Path:
        ...
        if self._string_transformer.is_identity_transformer:
            ...
            return self._transformed_file_path
        self._transformed_file_path = self._tmp_file_for_transformed_getter.get(tmp_file_space, self._original_file_path.primitive)
