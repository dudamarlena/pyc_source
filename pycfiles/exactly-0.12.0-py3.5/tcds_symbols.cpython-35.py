...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_file_structure/tcds_symbols.py
...
SET_AT_SETUP__SYMBOLS = [
 SYMBOL_HDS_CASE,
 SYMBOL_HDS_ACT]
SET_AT_SDS__SYMBOLS = [
 SYMBOL_ACT,
 SYMBOL_TMP]
SET_AT_BEFORE_ASSERT__SYMBOLS = [
 SYMBOL_RESULT]
...
def symbols_rel_hds(hds: HomeDirectoryStructure) -> Dict[(str, str)]:
    return {SYMBOL_HDS_CASE: str(hds.case_dir), 
