...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/parse/parse_list.py
...
def element_of(token: Token) -> lrs.ElementSdv:
    ...
    if len(string_fragments) == 1:
        ...
        string_sdv = parse_string.string_sdv_from_fragments(string_fragments, is_any_data_type())
