...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/validators.py
# Compiled at: 2019-12-27 10:07:42
# Size of source mod 2**32: 3722 bytes
from typing import Optional
from exactly_lib.common.report_rendering.text_doc import TextRenderer
from exactly_lib.symbol.path_resolving_environment import PathResolvingEnvironmentPostSds, PathResolvingEnvironmentPreSds
...
class SvhValidatorViaReturnValues:
    ...
    def validate_post_setup(self, environment: PathResolvingEnvironmentPostSds) -> svh.SuccessOrValidationErrorOrHardError:
        return svh.new_svh_success()
...
class SvhValidatorViaExceptions(SvhPreSdsValidatorViaExceptions, SvhPostSetupValidatorViaExceptions):
...
class SvhValidatorViaExceptionsFromPreAndPostSdsValidators(SvhValidatorViaExceptions):
    ...
    def __init__(self, pre_sds: SvhPreSdsValidatorViaExceptions=None,
