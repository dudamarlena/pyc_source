...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/string_matcher/parse/parts/emptieness.py
...
_DESCRIPTION_OF_EMPTY = 'Matches if the string is empty.\n'