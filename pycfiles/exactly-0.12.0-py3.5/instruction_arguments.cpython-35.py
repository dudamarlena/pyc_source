...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/definitions/instruction_arguments.py
...
REL_SYMBOL_OPTION = a.Option(REL_SYMBOL_OPTION_NAME, SYMBOL_NAME_ARGUMENT.name)
...
OPTIONAL_RELATIVITY_ARGUMENT_USAGE = a.Single(a.Multiplicity.OPTIONAL, RELATIVITY_ARGUMENT)
