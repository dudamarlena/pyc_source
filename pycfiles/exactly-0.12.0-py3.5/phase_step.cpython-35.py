...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/execution/phase_step.py
...
class SimplePhaseStep(tuple):
    ...
    def __new__(cls, phase: phase_identifier.PhaseEnum, step: str):
...
class PhaseStep(tuple):
    ...
    def __new__(cls, phase: phase_identifier.Phase, step: str):
        return tuple.__new__(cls, (phase, step))
