...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/symbol/data/list_sdv.py
...
class StringElementSdv(ElementSdv):
    __doc__ = ' An element that is a string. '
...
class SymbolReferenceElementSdv(ElementSdv):
    __doc__ = ' An element that is a reference to a symbol. '
