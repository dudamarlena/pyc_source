...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/help/the_application_help.py
# Compiled at: 2019-09-20 02:11:24
# Size of source mod 2**32: 3289 bytes
from typing import Sequence, Dict, List
from exactly_lib.common.instruction_setup import SingleInstructionSetup
from exactly_lib.definitions.entity.all_entity_types import CONCEPT_ENTITY_TYPE_NAMES, ACTOR_ENTITY_TYPE_NAMES, CONF_PARAM_ENTITY_TYPE_NAMES, SUITE_REPORTER_ENTITY_TYPE_NAMES, SYNTAX_ELEMENT_ENTITY_TYPE_NAMES, TYPE_ENTITY_TYPE_NAMES, BUILTIN_SYMBOL_ENTITY_TYPE_NAMES, DIRECTIVE_ENTITY_TYPE_NAMES
...
def new_application_help(instructions_setup: InstructionsSetup, suite_configuration_section_instructions: Dict[(str, SingleInstructionSetup)], builtin_symbols: Sequence[BuiltinSymbolDocumentation]=()) -> ApplicationHelp:
    return ApplicationHelp(MainProgramHelp(), test_case_help(instructions_setup), test_suite_help(suite_configuration_section_instructions), entity_name_2_entity_configuration(list(builtin_symbols)))


def entity_name_2_entity_configuration(builtin_symbols: List[BuiltinSymbolDocumentation]) -> Dict[(str, EntityTypeConfiguration)]:
    return {CONCEPT_ENTITY_TYPE_NAMES.identifier: CONCEPT_ENTITY_CONFIGURATION, 
     ...
     BUILTIN_SYMBOL_ENTITY_TYPE_NAMES.identifier: builtin_symbols_entity_configuration(builtin_symbols)}