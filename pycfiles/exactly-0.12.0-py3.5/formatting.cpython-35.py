...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/definitions/formatting.py
...
class SectionName:
    ...
    def __init__(self, name: str):
        self._name = name
        self._formats = {self.SYNTAX: section_header(name), 
         self.PLAIN: name, 
...
def _common_name_with_formatting(name: NameWithGender) -> NameWithGenderWithFormatting:
    return NameWithGenderWithFormatting(name, quoting_begin='"', quoting_end='"')