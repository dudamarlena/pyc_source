...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/type_system/logic/program/command.py
...
class CommandDdv(DirDependentValue[Command]):
    ...
    def __init__(self, command_driver: CommandDriverDdv, arguments: ArgumentsDdv):
        self._command_driver = command_driver
        self._arguments = arguments
        self._validators = tuple(command_driver.validators) + tuple(arguments.validators)
    ...
    def value_of_any_dependency(self, tcds: Tcds) -> Command:
        return Command(self._command_driver.value_of_any_dependency(tcds), self._arguments.value_of_any_dependency(tcds))