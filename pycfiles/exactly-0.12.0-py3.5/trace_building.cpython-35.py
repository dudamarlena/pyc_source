...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/type_system/description/trace_building.py
...
class TraceBuilder:
    ...
    def build_result(self, value: bool) -> MatchingResult:
        return MatchingResult(value, self.as_render(value))

    def build_bool(self, data: bool) -> NodeRenderer[bool]:
        return NodeRendererFromParts(self._header, data, self._details, self._children)
...
class _NodeRendererFromBuilder(NodeRenderer[bool]):
    ...
    def __init__(self, data: bool, builder: TraceBuilder):
        self._data = data
