...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/symbol/logic/resolving_helper.py
...
class LogicTypeResolvingHelper:
    ...
    def __init__(self, symbols: SymbolTable, tcds: Tcds, file_space: TmpDirFileSpace):
...
def resolving_helper__of_full_env(environment: FullResolvingEnvironment) -> LogicTypeResolvingHelper:
    return LogicTypeResolvingHelper(environment.symbols, environment.tcds, environment.application_environment.tmp_files_space)