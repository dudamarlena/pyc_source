...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/string_matcher/parse/parts/num_lines.py
...
def parse__generic(token_parser: TokenParser) -> GenericStringMatcherSdv:
    matcher = parse_integer_matcher.parse(token_parser, ExpectationType.POSITIVE, parse_integer_matcher.validator_for_non_negative)
...
class Description(grammar.SimpleExpressionDescription):
    ...
    def description_rest(self) -> Sequence[ParagraphItem]:
        tp = TextParser({'INTEGER_MATCHER': syntax_elements.INTEGER_MATCHER_SYNTAX_ELEMENT.singular_name})
...
_DESCRIPTION = 'Matches if the number of lines of the string matches {INTEGER_MATCHER}.\n'