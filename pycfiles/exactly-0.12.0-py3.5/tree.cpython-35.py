...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/util/description_tree/tree.py
# Compiled at: 2020-01-23 16:48:00
...
class Node(Generic[NODE_DATA]):
    ...
    def __init__(self, header: str, data: NODE_DATA, details: Sequence[Detail], children: Sequence['Node[NODE_DATA]']):
        self._header = header
        self._data = data
...
class StringDetail(Detail):
    __doc__ = 'A detail that is a string without any special structure.'
...
class HeaderAndValueDetail(Detail):
    ...
    def __init__(self, header: ToStringObject, values: Sequence[Detail], header_text_style: TextStyle=TEXT_STYLE__NEUTRAL):
        self._header = header
        self._values = values
...
class TreeDetail(Detail):
    __doc__ = 'Makes a Detail of a Node.'

    def __init__(self, tree: Node[Any], header_text_style: TextStyle=TEXT_STYLE__NEUTRAL):
        self._tree = tree
        self._header_text_style = header_text_style
