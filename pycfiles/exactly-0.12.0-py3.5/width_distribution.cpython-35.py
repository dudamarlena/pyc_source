...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/util/textformat/rendering/text/table/width_distribution.py
...
class _ColumnInfo:
    ...
    def __init__(self, contents_width: int, assigned_width: int):
...
def _shrink_and_get_superfluous_width(column_infos: list) -> (int, list):
    ...
    return (
     superfluous_width, unsatisfied_columns)
...
def _widen_by_distributing_superfluous_width(superfluous_width: int, accepting_columns: list):
    ...
    growth_distribution = num_cols_that_will_grow_one_more * [base_growth + 1] + (num_cols - num_cols_that_will_grow_one_more) * [base_growth]
