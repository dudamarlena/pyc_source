...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/help/entities/actors/objects/file_interpreter_actor.py
...
from exactly_lib.help.entities.actors.objects.common import ARGUMENT_SYNTAX_ELEMENT, SINGLE_LINE_PROGRAM_ACT_PHASE_CONTENTS_SYNTAX_INITIAL_PARAGRAPH, ActPhaseDocumentationSyntaxBase
...
class FileInterpreterActorDocumentation(ActorDocumentation):
    ...
    def __init__(self):
        ...
        self._tp = TextParser({'shell_syntax_concept': formatting.concept_(concepts.SHELL_SYNTAX_CONCEPT_INFO), 
...
class ActPhaseDocumentationSyntax(ActPhaseDocumentationSyntaxBase):
    ...
    def __init__(self):
        ...
        fm = {'shell_syntax_concept': formatting.concept_(concepts.SHELL_SYNTAX_CONCEPT_INFO)}
    ...
    def syntax_element_descriptions(self) -> List[SyntaxElementDescription]:
        return [
         path_element_2(actor.RELATIVITY_CONFIGURATION, self._parser.fnap(_SOURCE_FILE_SYNTAX_ELEMENT)),
         SyntaxElementDescription(self.argument.name, self._parser.fnap(ARGUMENT_SYNTAX_ELEMENT))]


_SOURCE_FILE_SYNTAX_ELEMENT = 'The path of an existing source code file.\n'
_ACT_PHASE_CONTENTS = 'A single line which is a file name followed by optional arguments.\n\n\nThe file name and arguments may be quoted according to {shell_syntax_concept}.\n'