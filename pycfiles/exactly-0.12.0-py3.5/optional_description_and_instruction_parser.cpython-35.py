...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/section_document/element_parsers/optional_description_and_instruction_parser.py
# Compiled at: 2019-09-20 02:11:24
# Size of source mod 2**32: 3752 bytes
import io, shlex
from exactly_lib.section_document import syntax
from exactly_lib.section_document.element_parsers.section_element_parsers import InstructionParser, InstructionAndDescriptionParser, parse_and_compute_source
from exactly_lib.section_document.parse_source import ParseSource
from exactly_lib.section_document.parsed_section_element import ParsedInstruction
from exactly_lib.section_document.section_element_parsing import new_unrecognized_section_element_error_of_single_line, new_recognized_section_element_error_of_single_line
...
class InstructionWithOptionalDescriptionParser(InstructionAndDescriptionParser):
    ...
    def parse(self, fs_location_info: FileSystemLocationInfo, source: ParseSource) -> ParsedInstruction:
        ...
        ret_val = parse_and_compute_source(self.instruction_parser, fs_location_info, source_copy, description)
...
class _DescriptionExtractor:
    ...
    def extract_and_consume_description(self) -> str:
        try:
            ...
            raise new_recognized_section_element_error_of_single_line(self.source.current_line, 'Syntax error in description: ' + str(ex))
