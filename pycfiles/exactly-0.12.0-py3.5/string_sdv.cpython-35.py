...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/symbol/data/string_sdv.py
...
class StringSdv(DataTypeSdv):
    ...
    def resolve(self, symbols: SymbolTable) -> sv.StringDdv:
        fragments = [fr.resolve(symbols) for fr in self._fragment_sdvs]
    ...
    def string_constant(self) -> str:
        ...
        """
        fragments = [fragment_sdv.string_constant for fragment_sdv in self._fragment_sdvs]
