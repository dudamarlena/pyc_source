...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/program/sdvs/accumulator.py
...
class ProgramElementsSdvAccumulator(ObjectWithTypedSymbolReferences):
    ...
    def __init__(self, stdin: StdinDataSdv, arguments: ArgumentsSdv, transformations: Sequence[StringTransformerSdv]):
        self.stdin = stdin
        self.arguments = arguments
        self.transformations = transformations

    def new_accumulated(self, additional_stdin: StdinDataSdv, additional_arguments: ArgumentsSdv, additional_transformations: Sequence[StringTransformerSdv]) -> 'ProgramElementsSdvAccumulator':
        """Creates a new accumulated instance."""
        return ProgramElementsSdvAccumulator(self.stdin.new_accumulated(additional_stdin), self.arguments.new_accumulated(additional_arguments), tuple(self.transformations) + tuple(additional_transformations))
