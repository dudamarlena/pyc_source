...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/definitions/misc_texts.py
# Compiled at: 2020-01-31 19:27:07
...
OS_PROCESS_NAME = misc_name_with_formatting(name.an_name(name.Name('OS process', 'OS processes')))
EXIT_IDENTIFIER = misc_name_with_formatting(name.an_name(name.name_with_plural_s('exit identifier')))
...
RELATIVITY = misc_name_with_formatting(name.a_name(name.Name('relativity', 'relativities')))
...
SYMBOL_COMMAND_SINGLE_LINE_DESCRIPTION = 'Reports the usage of user defined {symbols} in a test case or test suite'.format(symbols=all_entity_types.SYMBOL_CONCEPT_NAME.plural)
