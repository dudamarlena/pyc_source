...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/common/report_rendering/print.py
# Compiled at: 2020-01-20 18:58:42
...
from exactly_lib.util.simple_textstruct.file_printer_output.print_on_file_printer import LayoutSettings, BlockSettings, PrintablesFactory
...
def layout() -> LayoutSettings:
    return LayoutSettings(major_block=BlockSettings(INDENT, ps.SequencePrintable([ps.NEW_LINE_PRINTABLE,
     ps.NEW_LINE_PRINTABLE])), minor_block=BlockSettings(INDENT, ps.NEW_LINE_PRINTABLE), line_element_indent=INDENT)


def print_document(document: Document, file_printer: FilePrinter):
