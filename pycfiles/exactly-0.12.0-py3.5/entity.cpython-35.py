...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/help/contents_structure/entity.py
...
from exactly_lib.util.textformat.constructor.section import SectionContentsConstructor, ArticleContentsConstructor
...
class EntityTypeHelp(tuple):
    ...
    def __new__(cls, names: EntityTypeNames, entities: Iterable[EntityDocumentation]):
...
class EntityTypeConfiguration(tuple):
    ...
    def __new__(cls, entities_help: EntityTypeHelp, entity_doc_2_article_contents_renderer: Callable[([EntityDocumentation], ArticleContentsConstructor)], cli_list_renderer_getter: CliListConstructorGetter, html_doc_generator_getter: HtmlDocHierarchyGeneratorGetter):
