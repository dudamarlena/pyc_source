...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/execution/phase_step_simple.py
...
ALL_SETUP_WITH_ENV_ARG = (
 SETUP__VALIDATE_PRE_SDS,
...
ALL_BEFORE_ASSERT_WITH_ENV_ARG = (
 BEFORE_ASSERT__VALIDATE_PRE_SDS,
