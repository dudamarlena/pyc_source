...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/processing/test_case_handling_setup.py
...
class ComposedTestCaseTransformer(TestCaseTransformer):
    ...
    def __init__(self, first: TestCaseTransformer, second: TestCaseTransformer):
        self._first = first
        self._second = second
...
class TestCaseHandlingSetup(tuple):
    ...
    def __new__(cls, act_phase_setup: ActPhaseSetup, preprocessor: Preprocessor, transformer: TestCaseTransformer=identity_test_case_transformer()):
