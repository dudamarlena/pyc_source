...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/test_case_utils/file_matcher/file_matcher_models.py
# Compiled at: 2020-01-29 10:16:43
...
class _FileTypeAccessForPath(FileTypeAccess):
    _IS_FILE_TYPE_FUNCTIONS = {FileType.REGULAR: pathlib.Path.is_file, 
