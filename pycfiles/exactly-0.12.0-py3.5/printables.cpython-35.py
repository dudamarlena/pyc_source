...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/exactly_lib/util/simple_textstruct/file_printer_output/printables.py
...
class InterspersedSequencePrintable(Printable):
    ...
    def __init__(self, interspersed_printable: Printable, printables: Sequence[Printable]):
...
class IncreasedIndentPrintable(Printable):
    ...
    def __init__(self, increase: str, printable: Printable):
...
class ColoredPrintable(Printable):
    ...
    def __init__(self, color: ForegroundColor, printable: Printable):
        self._color = color
        self._printable = printable
...
class FontStyledPrintable(Printable):
    ...
    def __init__(self, style: FontStyle, printable: Printable):
        self._style = style
        self._printable = printable
