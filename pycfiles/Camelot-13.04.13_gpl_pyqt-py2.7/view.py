...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/camelot_example/view.py
...
def setup_views():
    ...
    s = select([Person.party_id,
     ...
     func.sum(VisitorReport.visitors).label('visitors')], whereclause=and_(Person.party_id == Movie.director_party_id, Movie.id == VisitorReport.movie_id), group_by=[
     Person.party_id,
     Person.first_name,
     Person.last_name,
     Person.birthdate,
