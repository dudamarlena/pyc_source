...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/admin/action/base.py
...
direct manipulations of the user interface without a need to access the model.
    ...
    def render(self, gui_context, parent):
        ...
        """
        from camelot.view.controls.action_widget import ActionLabel, ActionPushButton, ActionAction
