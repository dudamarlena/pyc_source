...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/test_proxy.py
...
class CollectionProxyCase(ProxyCase):
    ...
    def setUp(self):
        ...
        self.proxy = CollectionProxy(self.person_admin, collection_getter=lambda : self.collection, columns_getter=self.person_admin.get_columns)
...
class QueryProxyCase(ProxyCase):
    ...
    def setUp(self):
        ...
        self.proxy = QueryTableProxy(self.person_admin, query_getter=lambda : Person.query, columns_getter=self.person_admin.get_columns)
    ...
    def test_insert_after_sort(self):
        ...
        related_proxy = QueryTableProxy(self.person_admin, self.proxy.get_query_getter(), self.person_admin.get_columns, max_number_of_rows=1, cache_collection_proxy=self.proxy)
