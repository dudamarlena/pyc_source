...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/action_steps/print_preview.py
# Compiled at: 2013-04-11 17:47:52
from PyQt4 import QtCore, QtGui
from camelot.admin.action import ActionStep, DocumentActionGuiContext
...
class PrintPreviewDialog(QtGui.QPrintPreviewDialog):
    ...
    def __init__(self, printer, gui_context, actions=[], parent=None, flags=0):
...
class PrintPreview(ActionStep):
    ...
    def render(self, gui_context):
        ...
        dialog = PrintPreviewDialog(self.printer, gui_context, actions=[
         EditDocument()], flags=QtCore.Qt.Window)
