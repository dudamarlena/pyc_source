...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/delegates/booldelegate.py
...
class TextBoolDelegate(CustomDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        painter.drawText(rect.x() + 2, rect.y(), rect.width() - 4, rect.height(), Qt.AlignVCenter | Qt.AlignLeft, _(text))
        painter.restore()
        return