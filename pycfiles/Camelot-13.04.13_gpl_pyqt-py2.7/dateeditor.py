...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/editors/dateeditor.py
...
class DateEditor(CustomEditor):
    ...
    def __init__(self, parent=None, editable=True, nullable=True, field_name='date', **kwargs):
