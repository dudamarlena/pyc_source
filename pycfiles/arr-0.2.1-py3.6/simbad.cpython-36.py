...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/arr/simbad.py
# Compiled at: 2019-09-30 09:17:47
...
sim = aq_simbad()
sim.add_votable_fields('otype(V)', 'ids', 'biblio', 'fe_h', 'membership', 'plx', 'pm', 'sp', 'sp_bibcode', 'sp_qual', 'ubv', 'flux(U)', 'flux_bibcode(U)', 'flux(B)', 'flux_bibcode(B)', 'flux(V)', 'flux_bibcode(V)', 'flux(R)', 'flux_bibcode(R)', 'flux(I)', 'flux_bibcode(I)', 'flux(G)', 'flux_bibcode(G)', 'flux(J)', 'flux_bibcode(J)', 'flux(H)', 'flux_bibcode(H)', 'flux(K)', 'flux_bibcode(K)')
flux_types = {'u':('FLUX_U', 'FLUX_BIBCODE_U'), 
