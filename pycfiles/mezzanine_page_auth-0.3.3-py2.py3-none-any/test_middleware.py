...
# [GCC 8.4.0]
# Embedded file name: /Users/simo/PycharmProjects/mezzanine_page_auth/mezzanine_page_auth/tests/test_middleware.py
...
from .factories import OperatorsGroupF, AdminsGroupF, UserF, RichTextPageF, RichTextPageWithGroupF
...
class PageAuthMiddlewareTest(TestCase):
    ...
    def setUp(self):
        ...
        self.app_operator = UserF.create(username=b'app_operator', groups=(
         self.goperators,))
        self.app_admin = UserF.create(username=b'app_admin', groups=(
         self.gadmins,))
        self.n_pages = 3
        self.pages_no_group = [ RichTextPageF() for n in range(0, self.n_pages)
                              ]
        self.pages_with_group = [ RichTextPageWithGroupF() for n in range(0, self.n_pages)
                                ]
