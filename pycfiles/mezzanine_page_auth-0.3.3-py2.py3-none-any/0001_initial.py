...
# [GCC 8.4.0]
# Embedded file name: /Users/simo/PycharmProjects/mezzanine_page_auth/mezzanine_page_auth/migrations/0001_initial.py
# Compiled at: 2013-10-24 11:30:16
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('mezzanine_page_auth_pageauthgroup', (
         (
        ...
        db.send_create_signal('mezzanine_page_auth', ['PageAuthGroup'])

    def backwards(self, orm):
        db.delete_table('mezzanine_page_auth_pageauthgroup')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'mezzanine_page_auth.pageauthgroup': {'Meta': {'ordering': "('group',)", 'object_name': 'PageAuthGroup'}, 'group': (
                                                     'django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Group']"}), 
                                             'id': (
                                                  'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                             'page': (
