...
class QSO(object):
    ...
    def index(self, bucket, start=None, stop=None):
    ...
    def pop(self, key=SENTINEL, default=SENTINEL):
        if key is SENTINEL:
            key = -1
