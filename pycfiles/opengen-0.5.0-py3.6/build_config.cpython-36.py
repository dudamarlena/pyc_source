...
class BuildConfiguration:
    ...
    def __init__(self, build_dir='.'):
        ...
        self._BuildConfiguration__ros_config = None
    ...
    def ros_config(self) -> RosConfiguration:
        ...
        """
        return self._BuildConfiguration__ros_config
    ...
    def with_ros(self, ros_config: RosConfiguration):
        ...
        :return: current instance of BuildConfiguration
        """
        self._BuildConfiguration__build_c_bindings = True
        self._BuildConfiguration__ros_config = ros_config
        return self
