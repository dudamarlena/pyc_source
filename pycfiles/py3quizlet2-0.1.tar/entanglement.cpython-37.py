...
def compute_entanglement(block_matrix):
    ...
    return (
     [
      entanglement_intensity, entanglement_homogeneity, normalized_entanglement_homogeneity], gamma_layers)
...
def compute_entanglement_analysis(network):
    ...
    for i, b in enumerate(blocks):
        ...
        block_analysis = {'Entanglement intensity':I, 
