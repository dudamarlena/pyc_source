...
# Embedded file name: build/bdist.linux-x86_64/egg/py3plex/algorithms/statistics/basic_statistics.py
# Compiled at: 2019-02-24 13:10:35
# Size of source mod 2**32: 2437 bytes
import scipy.io, networkx as nx, pandas as pd, numpy as np
...
def core_network_statistics(G, labels=None, name='example'):
    ...
    point = {'Name':name,  'classes':number_of_classes, 
     'nodes':nodes, 
     'edges':edges, 
     'diameter':diameter, 
     'degree':mean_degree, 
