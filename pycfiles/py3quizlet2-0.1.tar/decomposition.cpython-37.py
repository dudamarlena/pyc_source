...
# Embedded file name: build/bdist.linux-x86_64/egg/py3plex/core/HINMINE/decomposition.py
...
def np_calculate_importance_chi(predicted, label_matrix, actual_pos_nums):
    ...
    predicted_pos_num = np.count_nonzero(predicted)
...
def hinmine_decompose(network, heuristic, cycle=None, parallel=True):
    ...
    for cycle in cycles:
        ...
        hin.decompose_from_iterator('decomposition', heuristic,
          None,
