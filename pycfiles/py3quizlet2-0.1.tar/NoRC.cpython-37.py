...
# Embedded file name: build/bdist.linux-x86_64/egg/py3plex/algorithms/community_detection/NoRC.py
# Compiled at: 2019-04-06 15:10:25
# Size of source mod 2**32: 7537 bytes
import networkx as nx, numpy as np, tqdm
from sklearn.cluster import AffinityPropagation
import sklearn.metrics.pairwise, multiprocessing as mp
...
def page_rank_kernel(index_row):
    pr = sparse_page_rank(_RANK_GRAPH, [index_row], epsilon=1e-06,
      max_steps=100000,
      damping=0.9,
      spread_step=10,
      spread_percent=0.1,
...
def NoRC_communities_main(input_graph, clustering_scheme='hierarchical', max_com_num=100, verbose=False, sparisfy=True, parallel_step=6, prob_threshold=0.0005, community_range=[1, 3, 5, 7, 11, 20, 40, 50, 100, 200, 300], fine_range=3, lag_threshold=10):
    ...
    _RANK_GRAPH = stochastic_normalization(_RANK_GRAPH)
