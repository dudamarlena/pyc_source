...
# Embedded file name: build/bdist.linux-x86_64/egg/py3plex/algorithms/hedwig/core/load.py
# Compiled at: 2019-02-24 13:10:35
# Size of source mod 2**32: 5951 bytes
__doc__ = '\nReading input data.\n\n@author: anze.vavpetic@ijs.si\n'
import rdflib, json, hashlib, os, _pickle as cPickle
...
def load_graph(ontology_list, data, def_format='n3', cache=True):
    ...
    def filter_valid_files(paths):
        if def_format == 'csv':
            filter_fn = lambda p: p.endswith('.csv') or 
        else:
