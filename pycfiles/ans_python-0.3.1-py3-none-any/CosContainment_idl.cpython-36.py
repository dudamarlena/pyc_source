...
# Embedded file name: ./CosContainment_idl.py
...
_0_CosContainment = omniORB.openModule('CosContainment', '/tmp/corba/omni/share/idl/omniORB/COS/CosContainment.idl')
_0_CosContainment__POA = omniORB.openModule('CosContainment__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosContainment.idl')
_0_CosContainment._d_Relationship = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosContainment/Relationship:1.0', 'Relationship')
...
del Relationship
__name__ = 'CosContainment'
_0_CosContainment._d_ContainsRole = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosContainment/ContainsRole:1.0', 'ContainsRole')
...
del ContainsRole
__name__ = 'CosContainment'
_0_CosContainment._d_ContainedInRole = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosContainment/ContainedInRole:1.0', 'ContainedInRole')
