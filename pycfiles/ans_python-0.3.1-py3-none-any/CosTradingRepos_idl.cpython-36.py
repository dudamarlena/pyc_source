...
# Embedded file name: ./CosTradingRepos_idl.py
...
_0_CosTradingRepos = omniORB.openModule('CosTradingRepos', '/tmp/corba/omni/share/idl/omniORB/COS/CosTradingRepos.idl')
_0_CosTradingRepos__POA = omniORB.openModule('CosTradingRepos__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosTradingRepos.idl')
_0_CosTradingRepos._d_ServiceTypeRepository = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTradingRepos/ServiceTypeRepository:1.0', 'ServiceTypeRepository')
...
class ServiceTypeRepository:
    ...
    _d_PropertyMode = (
     omniORB.tcInternal.tv_enum, PropertyMode._NP_RepositoryId, 'PropertyMode', PropertyMode._items)
    ...
    _d_PropStruct = _0_CosTradingRepos.ServiceTypeRepository._d_PropStruct = (
     omniORB.tcInternal.tv_struct, PropStruct, PropStruct._NP_RepositoryId, 'PropStruct', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertyName:1.0'], 'value_type', omniORB.tcInternal.tv_TypeCode, 'mode', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/PropertyMode:1.0'])
    ...
    _d_IncarnationNumber = _0_CosTradingRepos.ServiceTypeRepository._d_IncarnationNumber = (
     omniORB.tcInternal.tv_struct, IncarnationNumber, IncarnationNumber._NP_RepositoryId, 'IncarnationNumber', 'high', omniORB.tcInternal.tv_ulong, 'low', omniORB.tcInternal.tv_ulong)
    ...
    _d_TypeStruct = _0_CosTradingRepos.ServiceTypeRepository._d_TypeStruct = (
     omniORB.tcInternal.tv_struct, TypeStruct, TypeStruct._NP_RepositoryId, 'TypeStruct', 'if_name', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/Identifier:1.0'], 'props', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/PropStructSeq:1.0'], 'super_types', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/ServiceTypeNameSeq:1.0'], 'masked', omniORB.tcInternal.tv_boolean, 'incarnation', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/IncarnationNumber:1.0'])
    ...
    _d_ListOption = (
     omniORB.tcInternal.tv_enum, ListOption._NP_RepositoryId, 'ListOption', ListOption._items)
    ...
    _m_SpecifiedServiceTypes = (
     (
      since, 'incarnation', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/IncarnationNumber:1.0']),)
    ...
    _d_ServiceTypeExists = (
     omniORB.tcInternal.tv_except, ServiceTypeExists, ServiceTypeExists._NP_RepositoryId, 'ServiceTypeExists', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'])
    ...
    _d_InterfaceTypeMismatch = (
     omniORB.tcInternal.tv_except, InterfaceTypeMismatch, InterfaceTypeMismatch._NP_RepositoryId, 'InterfaceTypeMismatch', 'base_service', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'base_if', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/Identifier:1.0'], 'derived_service', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'derived_if', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/Identifier:1.0'])
    ...
    _d_HasSubTypes = (
     omniORB.tcInternal.tv_except, HasSubTypes, HasSubTypes._NP_RepositoryId, 'HasSubTypes', 'the_type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'sub_type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'])
    ...
    _d_AlreadyMasked = (
     omniORB.tcInternal.tv_except, AlreadyMasked, AlreadyMasked._NP_RepositoryId, 'AlreadyMasked', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'])
    ...
    _d_NotMasked = (
     omniORB.tcInternal.tv_except, NotMasked, NotMasked._NP_RepositoryId, 'NotMasked', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'])
    ...
    _d_ValueTypeRedefinition = (
     omniORB.tcInternal.tv_except, ValueTypeRedefinition, ValueTypeRedefinition._NP_RepositoryId, 'ValueTypeRedefinition', 'type_1', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'definition_1', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/PropStruct:1.0'], 'type_2', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'definition_2', omniORB.typeMapping['IDL:omg.org/CosTradingRepos/ServiceTypeRepository/PropStruct:1.0'])
    ...
    _d_DuplicateServiceTypeName = (
     omniORB.tcInternal.tv_except, DuplicateServiceTypeName, DuplicateServiceTypeName._NP_RepositoryId, 'DuplicateServiceTypeName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'])
...
del _objref_ServiceTypeRepository
