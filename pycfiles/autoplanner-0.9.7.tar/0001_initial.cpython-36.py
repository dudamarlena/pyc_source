...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/AutoPlanner/autoplanner/migrations/0001_initial.py
# Compiled at: 2017-07-28 01:43:32
# Size of source mod 2**32: 12840 bytes
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Agent',
       fields=[
      (
     ...
     migrations.CreateModel(name='AgentCategoryPreferences',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'preference by agent and category', 
      'verbose_name_plural':'preferences by agent and category'}),
     migrations.CreateModel(name='AgentTaskExclusion',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='Category',
      ...
      (
       ...
       options={'verbose_name':'Category of tasks', 
      'verbose_name_plural':'Categories of tasks'}),
     migrations.CreateModel(name='MaxTaskAffectation',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'Number of tasks performed by an agent in a category', 
      'verbose_name_plural':'Number of tasks performed by an agent in a category'}),
     migrations.CreateModel(name='MaxTimeTaskAffectation',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'category', models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Category'))],
       options={'verbose_name':'Maximum time spent by an agent in a category', 
     ...
     migrations.CreateModel(name='ScheduleRun',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.AddField(model_name='organization',
     ...
     migrations.AddField(model_name='maxtimetaskaffectation',
       name='organization',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Organization')),
     migrations.AddField(model_name='maxtaskaffectation',
       name='organization',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Organization')),
     migrations.AddField(model_name='category',
       name='organization',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Organization')),
     migrations.AddField(model_name='agenttaskexclusion',
       name='organization',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Organization')),
     migrations.AddField(model_name='agenttaskexclusion',
       name='task',
     ...
     migrations.AddField(model_name='agentcategorypreferences',
       name='category',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Category')),
     migrations.AddField(model_name='agentcategorypreferences',
       name='organization',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Organization')),
     migrations.AddField(model_name='agent',
       name='organization',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='autoplanner.Organization'))]