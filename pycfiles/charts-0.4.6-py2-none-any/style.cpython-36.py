...
# Compiled at: 2019-08-06 06:07:26
# Size of source mod 2**32: 25456 bytes
...
class Style(object):
    ...
    def __init__(self, title, x_title, y_title, units, engine, chart_type, color, color_2, color_2_series, exclude_from_color, normalize_colormap, bubble_series, bubble_size_scalar, candlestick_series, candlestick_increasing_color, candlestick_increasing_line_color, candlestick_decreasing_color, candlestick_decreasing_line_color, subplots, share_subplot_x, scale_factor, dpi, width, height, resample, thin_margin, block_new_plots, animate_figure, animate_titles, animate_frame_ms, y_axis_2_series, linewidth_2_series, linewidth, linewidth_2, marker_size, line_of_best_fit, line_shape, x_axis_showgrid, y_axis_showgrid, y_axis_2_showgrid, x_y_line, x_axis_range, y_axis_range, connect_line_gaps, brand_label, display_brand_label, source, source_color, display_source_label, display_legend, xkcd, silent_display, file_output, date_formatter, html_file_output, display_mpld3, auto_generate_filename, auto_generate_html_filename, save_fig, plotly_url, plotly_as_image, plotly_username, plotly_api_key=''''''''NoneNone[][][][]TrueNonecc.chartfactory_bubble_size_scalarNoneNoneNoneNoneNoneFalseFalsecc.chartfactory_scale_factorcc.chartfactory_dpicc.chartfactory_widthcc.chartfactory_heightNoneFalseFalseFalseNone250[][], plotly_world_readable=NoneNone1FalseNoneTrueTrueTrue[]NoneNoneFalsecc.chartfactory_brand_labelcc.chartfactory_display_brand_labelcc.chartfactory_source'black'cc.chartfactory_display_source_labelTrueFalseFalseNoneNoneNoneFalseFalseFalseTrueNoneFalsecc.plotly_default_usernameNonecc.plotly_world_readable, plotly_sharing=cc.plotly_sharing, plotly_theme=None, plotly_plot_mode=cc.plotly_plot_mode, plotly_webgl=cc.plotly_webgl, plotly_helper=cc.plotly_helper, bokeh_plot_mode=cc.bokeh_plot_mode, style_sheet=cc.chartfactory_default_stylesheet, convert_matplotlib_to_plotly=False):
        self.engine = engine
        self.title = title
    ...
    def plotly_helper(self):
        return self._Style__plotly_helper

    @plotly_helper.setter
    def plotly_helper(self, plotly_helper):
        self._Style__plotly_helper = plotly_helper
