...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/phessianfree/optimize.py
# Compiled at: 2012-11-20 19:44:40
"""
.. module:: optimize
...
"""
import logging, numpy, linesearch, innersolve, objective
from numpy import *

def optimize(f, x0, ndata, gtol=1e-05, maxiter=100, callback=None, props={}):
    """
    ...
    while gnorm > gtol and k < maxiter:
        ...
        gfk = gfkp1
        logger.info(' Iteration %d, fval: %1.8f, gnorm %1.3e, effective iters: %1.2f', k, fval, gnorm, f.pointsProcessed / float(ndata))
        if callback is not None:
