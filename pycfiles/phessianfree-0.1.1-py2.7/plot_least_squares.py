...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/examples/plot_least_squares.py
# Compiled at: 2012-11-01 18:53:34
"""
...
from numpy import *
import scipy.optimize, phessianfree
...
x = phessianfree.sgd(f, x0, ndata, maxiter=30, callback=phf_sgd, props={'SGDInitialStep': 4.0, 'SGDStepScale': 0.1})
