...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tropopause/elasticloadbalancingv2.py
...
class SecureLoadBalancerWithListener(LoadBalancer):
    __doc__ = ' Creates an Application LoadBalancer with a Listener. '
    ...
    def __init__(self, title, template, *args, **kwargs):
        ...
        template.add_resource(Listener((title + 'httpslistener'),
