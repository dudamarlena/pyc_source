...
# [GCC 8.4.0]
# Embedded file name: /Users/travis/build/onfido/faiss_prebuilt/faiss/python/build/lib/faiss/__init__.py
...
def handle_Index(the_class):
    ...
    replace_method(the_class, 'search_and_reconstruct', replacement_search_and_reconstruct, ignore_missing=True)
