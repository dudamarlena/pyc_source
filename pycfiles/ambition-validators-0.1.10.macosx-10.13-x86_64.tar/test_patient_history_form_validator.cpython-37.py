...
# [GCC 8.4.0]
# Embedded file name: /Users/erikvw/.venvs/ambition/lib/python3.7/site-packages/ambition_validators/tests/test_patient_history_form_validator.py
...
class TestPatientHistoryFormValidator(TestCase):
    ...
    def test_neurological_focal_neurologic_deficit_none_invalid(self):
        ListModel.objects.create(name='focal_neurologic_deficit', short_name='focal_neurologic_deficit')
