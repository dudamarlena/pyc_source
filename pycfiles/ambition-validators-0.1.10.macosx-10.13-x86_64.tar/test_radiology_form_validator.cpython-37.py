...
# [GCC 8.4.0]
# Embedded file name: /Users/erikvw/.venvs/ambition/lib/python3.7/site-packages/ambition_validators/tests/test_radiology_form_validator.py
# Compiled at: 2018-01-29 14:27:09
# Size of source mod 2**32: 9219 bytes
...
class TestRadiolodyFormValidator(TestCase):
    ...
    def test_infiltrate_location_none(self):
        ListModel.objects.create(name='infiltrates',
          short_name='infiltrates')
        options = {'cxr_done':YES, 
         'cxr_date':get_utcnow(), 
    ...
    def test_infiltrate_location_not_none(self):
        ListModel.objects.create(name=NORMAL,
          short_name=NORMAL)
        options = {'cxr_type':ListModel.objects.all(), 
    ...
    def test_brain_imaging_reason_other_none(self):
        options = {'brain_imaging_reason':OTHER, 
    ...
    def test_brain_imaging_reason_other_not_none(self):
        options = {'brain_imaging_reason':'new_neurology', 
    ...
    def test_abnormal_results_reason_none(self):
        options = {'are_results_abnormal':YES, 
    ...
    def test_abnormal_results_reason_not_none(self):
        options = {'are_results_abnormal':NO, 
    ...
    def test_abnormal_results_reason_other_none(self):
        ListModel.objects.create(name=OTHER,
          short_name=OTHER)
        options = {'abnormal_results_reason':ListModel.objects.all(), 
    ...
    def test_abnormal_results_reason_other_not_none(self):
        ListModel.objects.create(name='cerebral_oedema',
          short_name='cerebral_oedema')
        options = {'abnormal_results_reason':ListModel.objects.all(), 
    ...
    def test_if_infarcts_location_none(self):
        ListModel.objects.create(name='infarcts',
          short_name='infarcts')
        options = {'abnormal_results_reason':ListModel.objects.all(), 
