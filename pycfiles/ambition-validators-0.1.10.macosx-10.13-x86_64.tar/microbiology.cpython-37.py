...
# [GCC 8.4.0]
# Embedded file name: /Users/erikvw/.venvs/ambition/lib/python3.7/site-packages/ambition_validators/form_validators/microbiology.py
...
class MicrobiologyFormValidator(StudyDayFormValidatorMixin, FormValidator):
    ...
    def clean(self):
        self.validate_study_day_with_datetime(subject_identifier=(self.cleaned_data.get('subject_visit').subject_identifier),
        ...
        condition = self.cleaned_data.get('blood_culture_organism') == BACTERIA or self.cleaned_data.get('blood_culture_organism') == 'bacteria_and_cryptococcus'
        ...
        self.validate_other_specify(field='urine_culture_organism',
        ...
        self.validate_other_specify(field='blood_culture_organism',
        ...
        self.validate_other_specify(field='bacteria_identified',
        ...
        self.validate_other_specify(field='tissue_biopsy_organism',
