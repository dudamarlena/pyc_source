...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/comportamientos/proyectil.py
...
class Proyectil(comportamientos.Comportamiento):
    ...
    def iniciar(self, receptor, velocidad_maxima=5, aceleracion=1, angulo_de_movimiento=90, gravedad=0):
        u"""Construye el comportamiento.
