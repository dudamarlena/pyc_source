...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/mapa_tiled.py
...
class MapaTiled(Mapa):
    ...
    **tiled** puedes escribir:
    ...
    def pre_iniciar(self, ruta_mapa=None, x=0, y=0, densidad=0, restitucion=0, friccion=10.5, amortiguacion=0.1):
        pass

    def iniciar(self, ruta_mapa=None, x=0, y=0, densidad=0, restitucion=0, friccion=10.5, amortiguacion=0.1, reiniciar_si_cambia=True):
    ...
    def _redibujar(self):
        ...
        Mapa.iniciar(self, self.x, self.y, self.grilla, filas=self.filas, columnas=self.columnas, densidad=self.densidad, restitucion=self.restitucion, friccion=self.friccion, amortiguacion=self.amortiguacion)
    ...
    def _cargar_datos_basicos_del_mapa(self, archivo):
        ...
        self.grilla = self.pilas.imagenes.cargar_grilla(self._ruta, self.ancho_imagen / self.ancho_cuadro, self.alto_imagen / self.alto_cuadro)
