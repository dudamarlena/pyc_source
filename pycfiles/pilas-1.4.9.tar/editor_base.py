...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/interprete/editorbase/editor_base.py
# Compiled at: 2016-12-23 13:26:53
import codecs, pilasengine
from PyQt4.QtCore import Qt
from PyQt4.QtGui import QTextEdit, QTextCursor, QFileDialog, QMessageBox
import autocomplete, editor_con_deslizador, highlighter

class EditorBase(autocomplete.CompletionTextEdit, editor_con_deslizador.EditorConDeslizador):
    ...
    def _get_current_line(self):
        raise NotImplementedError('Es necesario sobreescribir                                   el metodo _get_current_line')
    ...
    def _get_position_in_block(self):
        raise NotImplementedError('Es necesario sobreescribir el metodo                                     _get_position_in_block')
    ...
    def abrir_dialogo_guardar_archivo(self):
        return QFileDialog.getSaveFileName(self, 'Guardar Archivo', self.nombre_de_archivo_sugerido, 'Archivos python (*.py)', options=QFileDialog.DontUseNativeDialog)

    def guardar_contenido_con_dialogo(self):
        raise NotImplementedError('Es necesario sobreescribir el metodo                                     guardar_contenido_con_dialogo')

    def obtener_contenido(self):
        """Retorna el contenido del editor segun las condiciones indicadas"""
        raise NotImplementedError('Es necesario sobreescribir el metodo                                     obtener_contenido')
    ...
    def mensaje_contenido_guardado(self):
        QMessageBox.information(self, 'Contenido guardado', 'Se ha guardado el archivo', 'De acuerdo')
