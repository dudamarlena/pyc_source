...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/tortuga.py
...
class Tortuga(Actor):
    ...
    def avanzar(self, pasos):
        ...
        """
        self.hacer_luego(self.pilas.comportamientos.Avanzar, False, pasos, self.velocidad)

    def giraderecha(self, delta):
        u"""Da un giro hacia la derecha de la tortuga.

        :param delta: Los grados que digará en ese sentido.
        """
        self.hacer_luego(self.pilas.comportamientos.Girar, False, -abs(delta), self.velocidad)

    def giraizquierda(self, delta):
        u"""Realiza un giro hacia la izquierda.
    ...
    def dibujar_linea_desde_el_punto_anterior(self):
        u"""Realiza el trazado de una linea desde su posición actual hacia la anterior."""
    ...
    def crear_poligono(self, lados=4, escala=100, sentido=-1):
        u"""dibuja un poligono de lados de los lados indicados.
    ...
    def get_color(self):
        u"""Retorna el color que se utilizará para trazar."""
        return self._color

    def set_color(self, color):
        u"""Define el color que se utilizará para trazar.
    ...
    def pintar(self, color=None):
        u"""Pinta todo el fondo de un solo color.
