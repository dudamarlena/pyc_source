...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/fondos/desplazamiento_horizontal.py
...
class Capa(object):
    ...
    def dibujar_tiled_horizontal(self, painter, ancho, alto):
        ...
        painter.drawTiledPixmap(x_inicial, y_inicial + self.y, ancho, self.imagen.alto(), self.imagen._imagen, abs(dx) % self.imagen.ancho(), dy % self.imagen.alto())
