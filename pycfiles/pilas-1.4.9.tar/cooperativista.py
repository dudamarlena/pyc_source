...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/cooperativista.py
...
class Cooperativista(Actor):
    ...
    def _cargar_animaciones(self):
        ...
        self.animaciones = {'ok': cargar('cooperativista/ok.png', 1), 
    ...
    def definir_cuadro(self, indice):
        u"""Define el cuadro de la animación del actor.
    ...
    def cambiar_animacion(self, nombre):
        u"""Cambia la animación del Cooperativista.
