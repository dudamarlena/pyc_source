...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/escenas/camara.py
...
class Camara(object):
    ...
    def definir_x(self, valor):
        ...
        self.pilas.eventos.mueve_camara.emitir(x=self.x, y=self.y, dx=self.x - anterior_x, dy=0)
    ...
    def definir_y(self, valor):
        ...
        self.pilas.eventos.mueve_camara.emitir(x=self.x, y=self.y, dx=0, dy=self.y - anterior_y)
