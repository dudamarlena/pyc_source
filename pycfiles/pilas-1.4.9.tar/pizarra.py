...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/pizarra.py
...
class Pizarra(Actor):
    ...
    def dibujar_punto(self, x, y, color=colores.negro):
        u"""Dibuja un punto sobre la pizarra.
    ...
    def obtener_coordenada_fisica(self, x, y):
        u"""Convierte las coordenadas de pantalla a coordenadas físicas.
    ...
    def pintar_parte_de_imagen(self, imagen, origen_x, origen_y, ancho, alto, x, y):
        u"""Dibuja una porción de una imagen sobre la pizarra.
    ...
    def pintar_grilla(self, grilla, x, y):
        u"""Dibuja un cuadro de animación sobre la pizarra.
    ...
    def pintar(self, color):
        u"""Pinta toda la pizarra de un solo color.
    ...
    def linea(self, x, y, x2, y2, color=colores.negro, grosor=1):
        u"""Dibuja una linea recta sobre la pizarra.
    ...
    def rectangulo(self, x, y, ancho, alto, color=colores.negro, relleno=False, grosor=1):
        u"""Dibuja un rectángulo sobre la pizarra.
    ...
    def texto(self, cadena, x=0, y=0, magnitud=10, fuente=None, color=colores.negro):
        u"""Dibuja una cadena de texto sobre la pizarra.
    ...
    def poligono(self, puntos, color=colores.negro, grosor=1, cerrado=False):
        u"""Dibuja un polígono sobre la pizarra.
