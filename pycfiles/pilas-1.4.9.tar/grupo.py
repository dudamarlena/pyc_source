...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/grupo.py
...
class Grupo(collections.MutableSequence):
    ...
    def _obtener_valor_de(self, atributo):
        return [ (actor.__class__.__name__, getattr(actor, atributo)) for actor in self._actores
               ]
    ...
    espejado = property(_obtener_espejado, _definir_espejado, doc='Indica si                         se tiene que invertir horizontalmente la imagen de                         los actores.')
    x = property(_obtener_x, _definir_x, doc='Define la posición horizontal del                 grupo de actores.')
    y = property(_obtener_y, _definir_y, doc='Define la posición vertical del                  grupo de  actores.')
    escala = property(_obtener_escala, _definir_escala, doc='Escala de todos                       los actores del grupo')
    rotacion = property(_obtener_rotacion, _definir_rotacion, doc='Angulo de                         rotación  en grados de (0 a 360) de todos los actores                         del grupo')
    escala_x = property(_obtener_escala_x, _definir_escala_x, doc='Escala de tamaño horizontal, 1 es normal,                         2 al doble de tamaño etc...')
    escala_y = property(_obtener_escala_y, _definir_escala_y, doc='Escala de tamaño vertical, 1 es normal, 2 al                         doble de tamaño etc...')
    transparencia = property(_obtener_transparencia, _definir_transparencia, doc='Define el nivel de transparencia, 0 indica                              opaco y 100 la maxima transparencia.')
    fijo = property(_obtener_fijo, _definir_fijo, doc='Indica si los actores                     del grupo deben ser independiente a la cámara.')
    izquierda = property(_obtener_izquierda, _definir_izquierda, doc='Establece                          el espacio entre la izquierda de los actores del                          grupo y el centro de coordenadas del mundo.')
    derecha = property(_obtener_derecha, _definir_derecha, doc='Establece el                        espacio entre la derecha de los actores del grupo                        y el centro de coordenadas del mundo.')
    abajo = property(_obtener_abajo, _definir_abajo, doc='Establece el espacio                      entre la parte inferior de los actores del grupo                      y el centro de coordenadas del mundo.')
    arriba = property(_obtener_arriba, _definir_arriba, doc='Establece el                       espacio entre la parte superior de los actores del grupo                       y el centro de coordenadas del mundo.')
