...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/interprete/ventana_interprete.py
# Compiled at: 2016-08-25 20:52:02
import codecs, os, time, sys
from PyQt4.QtGui import QKeySequence, QIcon, QLabel
from PyQt4 import QtCore
import lanas, pilasengine
...
class VentanaInterprete(Ui_InterpreteWindow):
    ...
    def _conectar_botones(self):
        ...
        self.interprete_button.connect(self.guardar_button, QtCore.SIGNAL('clicked()'), self.cuando_pulsa_el_boton_guardar_interprete)
        self.definir_icono(self.configuracion_button, 'iconos/preferencias.png')
        self.interprete_button.connect(self.configuracion_button, QtCore.SIGNAL('clicked()'), self.cuando_pulsa_el_boton_configuracion)
        self.definir_icono(self.limpiar_button, 'iconos/limpiar.png')
        self.limpiar_button.connect(self.limpiar_button, QtCore.SIGNAL('clicked()'), self.cuando_pulsa_el_boton_limpiar)
        ...
        self.pantalla_completa_button.connect(self.pantalla_completa_button, QtCore.SIGNAL('clicked()'), self.cuando_pulsa_el_boton_pantalla_completa)
    ...
    def pulsa_boton_depuracion(self):
        ...
        pilas.depurador.definir_modos(info=self.pushButton_6.isChecked(), puntos_de_control=self.pushButton_5.isChecked(), radios=False, areas=self.pushButton_3.isChecked(), fisica=self.pushButton_2.isChecked(), posiciones=self.pushButton.isChecked())
