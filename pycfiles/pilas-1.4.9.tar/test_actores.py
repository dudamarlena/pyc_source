...
# [GCC 8.4.0]
# Embedded file name: /Users/hugoruscitti/proyectos/hugoruscitti/pilas/pilasengine/tests/test_actores.py
...
class TestActoresPersonalizados(unittest.TestCase):
    ...
    def test_crear_actor_con_los_argumentos_correctos(self):
        ...
        self.assertTrue(isinstance(actor, pilasengine.actores.Actor), 'Genera correctamente el actor usando argumentos.')
    ...
    def test_crear_actor_con_los_argumentos_correctos_como_diccionarios(self):
        ...
        self.assertTrue(isinstance(actor, pilasengine.actores.Actor), 'Genera correctamente el actor usando argumentos como diccionario.')
