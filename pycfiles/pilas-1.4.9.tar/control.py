...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/controles/control.py
...
class Control(object):
    ...
    def __init__(self, escena, mapa_teclado=None):
        ...
        self.abajo = False
        self.boton = False
        self.mapa_teclado = {simbolos.IZQUIERDA: 'izquierda', simbolos.DERECHA: 'derecha', 
    ...
    def __repr__(self):
        teclas = [ ('{0}:{1}').format(var, getattr(self, var)) for var in self.mapa_teclado.values()
                 ]
