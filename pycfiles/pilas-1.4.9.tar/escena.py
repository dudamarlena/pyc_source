...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/escenas/escena.py
# Compiled at: 2016-08-25 20:52:02
import camara, pilasengine
...
class Escena(object):
    ...
    def __init__(self, pilas):
        ...
        self.grupos = []
        self.mueve_camara = self.pilas.eventos.Evento('mueve_camara')
        self.mueve_mouse = self.pilas.eventos.Evento('mueve_mouse')
        self.click_de_mouse = self.pilas.eventos.Evento('click_de_mouse')
        self.termina_click = self.pilas.eventos.Evento('termina_click')
        self.mueve_rueda = self.pilas.eventos.Evento('mueve_rueda')
        self.pulsa_tecla = self.pilas.eventos.Evento('pulsa_tecla')
        self.suelta_tecla = self.pilas.eventos.Evento('suelta_tecla')
        ...
        self.pulsa_boton = self.pilas.eventos.Evento('pulsa_boton')
        self.mueve_pad = self.pilas.eventos.Evento('mueve_pad')
    ...
    def eliminar_el_motor_de_fisica(self):
        u"""Método especial que se invoca cuando se reinicia pilas, y se tiene que eliminar la escena actual."""
    ...
    def obtener_actores_en(self, x, y):
        return [ a for a in self._actores.obtener_actores() if a.colisiona_con_un_punto(x, y)
               ]
