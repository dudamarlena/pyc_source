...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/habilidades/moverse_con_el_teclado.py
...
class MoverseConElTeclado(habilidades.Habilidad):
    ...
    def iniciar(self, receptor, control=None, direcciones=8, velocidad_maxima=4, aceleracion=1, deceleracion=0.1, con_rotacion=False, velocidad_rotacion=1, marcha_atras=True):
        ...
        if direcciones is not 8 and direcciones is not 4:
            raise Exception('El parametro direcciones solo admite:                            el numero 4 u 8')
        else:
