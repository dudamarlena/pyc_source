...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/interprete/editorbase/highlighter.py
...
def load_syntax():
    ...
    structure = {'comment': ['#'], 'definition': [
       ...
       'operators': [
                   ...
                   '\\&', '\\~', '>>', '<<'], 
       'keywords': [
                  'and', 'assert', 'break', 'c lass', 'continue', 'def', 'class', 'del', 'elif', 'else', 'except', 'exec', 'finally',
...
STYLES = {'keyword': format(COLOR_SCHEME['keyword']), 
