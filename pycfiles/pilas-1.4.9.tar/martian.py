...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/martian.py
...
class Martian(Actor):
    ...
    def definir_cuadro(self, indice):
        u"""Define el cuadro de animación a mostrar.
...
class Esperando(Comportamiento):
    ...
    def iniciar(self, receptor):
        u"""Inicia el comportamiento y define los valores iniciales.
...
class Caminando(Esperando):
    ...
    def avanzar_animacion(self):
        u"""Cambia el cuado de animación para avanzar la animación"""
        self.paso += 1
