...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/emisor.py
...
class Emisor(Actor):
    ...
    def actualizar(self):
        self._contador_frecuencia_creacion += 0.016
    ...
    def crear_particula(self):
        ...
        p = self.pilas.actores.Particula(self, self.x + d_x, self.y + d_y, dx=dx, dy=dy, imagen=self.imagen_particula, vida=self.vida)
