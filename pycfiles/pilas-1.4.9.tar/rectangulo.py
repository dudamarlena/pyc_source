...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/fisica/rectangulo.py
...
class Rectangulo(Figura):
    ...
    def __init__(self, fisica, pilas, x, y, ancho, alto, dinamica=True, densidad=1.0, restitucion=0.56, friccion=10.5, amortiguacion=0.1, sin_rotacion=False, sensor=False, plataforma=False):
        ...
        try:
            fixture = box2d.b2FixtureDef(shape=shape, density=densidad, friction=friccion, restitution=restitucion)
        except TypeError:
            fixture = box2d.b2FixtureDef(shape=shape, density=densidad, linearDamping=amortiguacion, friction=friccion, restitution=restitucion)
    ...
    def definir_vertices(self):
        self._cuerpo.fixtures[0].shape.vertices = box2d.b2PolygonShape(box=(
         self._ancho / 2, self._alto / 2)).vertices
