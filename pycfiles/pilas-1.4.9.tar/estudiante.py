...
# [GCC 8.4.0]
# Embedded file name: ./pilasengine/actores/estudiante.py
# Compiled at: 2016-08-25 20:52:02
import collections
from pilasengine import habilidades
from pilasengine import comportamientos
estructura_comportamiento = collections.namedtuple('Comportamiento', [
 'objeto', 'args', 'kwargs'])
...
class Estudiante(object):
    ...
    def obtener_habilidad(self, classname):
        u"""Obtiene la habilidad asociada a un Actor.
    ...
    def actualizar_habilidades(self):
        u"""Realiza una actualización sobre todas las habilidades."""
        for h in self._habilidades:
            h.actualizar()
    ...
    def tiene_comportamiento(self, classname):
        ...
        :param classname: Referencia a la clase que representa el
                          comportamiento.
        """
        comportamientos_actuales = [ comportamiento.objeto.__class__ for comportamiento in self.comportamientos
                                   ]
        return classname in comportamientos_actuales

    def hacer_luego(self, classname, repetir_por_siempre=False, *args, **kwargs):
        u"""Define un nuevo comportamiento para realizar al final.
    ...
    def _hacer(self, classname, *args, **kwargs):
        comportamiento = estructura_comportamiento(classname(self.pilas), args, kwargs)
    ...
    def _adoptar_el_siguiente_comportamiento(self):
        u""" Obtiene el siguiente comportamiento de la lista de comportamientos
        ...
        if self.comportamientos:
            ...
            self.comportamiento_actual.objeto.iniciar(self, *self.comportamiento_actual.args, **self.comportamiento_actual.kwargs)
        else:
            self.comportamiento_actual = None
        return