...
# [GCC 8.4.0]
# Embedded file name: /Users/hugoruscitti/proyectos/hugoruscitti/pilas/pilasengine/tests/test_habilidades.py
...
class TestHabilidades(unittest.TestCase):
    ...
    def testPuedenAprenderADisparar(self):
        ...
        actor.aprender(self.pilas.habilidades.Disparar, angulo_salida_disparo=90, frecuencia_de_disparo=6, distancia=5, escala=1)
