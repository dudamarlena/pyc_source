...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/django_redirection/views.py
# Compiled at: 2014-08-31 07:53:24
...
@csrf_exempt
def redirect_with_auth_superuser(request, tag, suburl):
...
@csrf_exempt
def redirect_with_auth_staff(request, tag, suburl):
...
@csrf_exempt
def redirect_with_auth_group(request, tag, suburl):
...
@csrf_exempt
def redirect_with_auth_login(request, tag, suburl):
    """If access user is a staff and return return X-Accel-Redirect.
    """
