...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/baron/baron/grammator_control_structures.py
# Compiled at: 2019-07-30 18:47:05
# Size of source mod 2**32: 10993 bytes
...
def include_control_structures(pg):
    ...
    def except_stmt_empty(pack):
        ...
        return [
         {'type':'except', 
          'first_formatting':except_.hidden_tokens_after, 
          'second_formatting':[],  'third_formatting':[],  'fourth_formatting':colon.hidden_tokens_before, 
          'fifth_formatting':colon.hidden_tokens_after, 
          'delimiter':'', 
          'target':{},  'exception':{},  'value':suite}]
    ...
    def for_stmt(pack):
        ...
        return [
         {'type':'for', 
          'async':False, 
          'async_formatting':[] + for_.hidden_tokens_before,  'value':suite, 
          'iterator':exprlist, 
          'target':testlist, 
          'else':{},  'first_formatting':for_.hidden_tokens_after, 
    ...
    def for_else_stmt(pack):
        ...
        return [
         {'type':'for', 
          'value':suite, 
          'async':False, 
          'async_formatting':[] + for_.hidden_tokens_before,  'iterator':exprlist, 
          'target':testlist, 
          'else':else_stmt, 
    ...
    def while_stmt(pack):
        ...
        return [
         {'type':'while', 
          'value':suite, 
          'test':test, 
          'else':{},  'first_formatting':while_.hidden_tokens_after, 
         ...
         {'type':'ifelseblock', 
          'value':[
           {'type':'if', 
            ...
            'first_formatting':if_.hidden_tokens_after, 
            'second_formatting':colon.hidden_tokens_before, 
            'third_formatting':colon.hidden_tokens_after}] + elifs}]
    ...
    def if_elif_else_stmt(pack):
        ...
        return [
         {'type':'ifelseblock', 
          'value':[
           {'type':'if', 
            'value':suite,  'test':test,  'first_formatting':if_.hidden_tokens_after,  'second_formatting':colon.hidden_tokens_before,  'third_formatting':colon.hidden_tokens_after}] + elifs + [else_stmt]}]