...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_internal/legacy_resolve.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 17303 bytes
...
class Resolver(object):
    ...
    def __init__(self, preparer, session, finder, wheel_cache, use_user_site, ignore_dependencies, ignore_installed, ignore_requires_python, force_reinstall, isolated, upgrade_strategy, use_pep517=None, py_version_info=None):
    ...
    def _resolve_one(self, requirement_set, req_to_install):
        ...
        if req_to_install.constraint or req_to_install.prepared:
            ...
            def add_req(subreq, extras_requested):
                sub_install_req = install_req_from_req_string((str(subreq)),
                  req_to_install,
