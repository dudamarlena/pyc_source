...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/Pygments/pygments/lexers/html.py
# Compiled at: 2019-07-30 18:47:12
# Size of source mod 2**32: 19285 bytes
"""
...
class DtdLexer(RegexLexer):
    ...
    def analyse_text(text):
        if not looks_like_xml(text):
            if '<!ELEMENT' in text or '<!ATTLIST' in text or '<!ENTITY' in text:
                return 0.8
