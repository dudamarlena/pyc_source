...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_internal/vcs/versioncontrol.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 19010 bytes
...
from pip._internal.utils.misc import ask_path_exists, backup_dir, call_subprocess, display_path, rmtree
from pip._internal.utils.typing import MYPY_CHECK_RUNNING
if MYPY_CHECK_RUNNING:
    from typing import Any, Dict, Iterable, List, Mapping, Optional, Text, Tuple, Type
...
class VersionControl(object):
    ...
    @classmethod
    def run_command(cls, cmd, show_stdout=True, cwd=None, on_returncode='raise', extra_ok_returncodes=None, command_desc=None, extra_environ=None, spinner=None):
        """
