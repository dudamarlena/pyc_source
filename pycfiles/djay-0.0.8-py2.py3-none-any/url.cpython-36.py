...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/urllib3/urllib3/util/url.py
...
def parse_url(url):
    ...
    if not url:
            ...
            if name:
                if any([ord(x) > 128 for x in name]):
                    ...
                    try:
                        ...
                        raise LocationParseError("Name '%s' is not a valid IDNA label" % name)
        ...
        return Url(scheme=(to_input_type(uri_ref.scheme)),
