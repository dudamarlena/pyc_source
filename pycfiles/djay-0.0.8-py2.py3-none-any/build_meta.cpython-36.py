...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/setuptools/setuptools/build_meta.py
...
class _BuildMetaBackend(object):
    ...
    def build_wheel(self, wheel_directory, config_settings=None, metadata_directory=None):
        ...
        with TemporaryDirectory(dir=wheel_directory) as (tmp_dist_dir):
            sys.argv = sys.argv[:1] + ['bdist_wheel', '--dist-dir', tmp_dist_dir] + config_settings['--global-option']
            self.run_setup()
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        ...
        sys.argv = sys.argv[:1] + ['sdist', '--formats', 'gztar'] + config_settings['--global-option'] + [
