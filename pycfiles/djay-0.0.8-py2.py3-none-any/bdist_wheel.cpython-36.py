...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/wheel/wheel/bdist_wheel.py
# Compiled at: 2019-07-30 18:46:56
# Size of source mod 2**32: 14757 bytes
"""
        ...
        if self.plat_name_supplied:
            ...
            if self.root_is_pure:
                ...
                if self.root_is_pure:
                    ...
                    supported_tags = pep425tags.get_supported(supplied_platform=(plat_name if self.plat_name_supplied else None))
