...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_vendor/lockfile/mkdirlockfile.py
...
class MkdirLockFile(LockBase):
    __doc__ = 'Lock file by creating a directory.'
    ...
    def __init__(self, path, threaded=True, timeout=None):
        ...
        self.unique_name = os.path.join(self.lock_file, '%s.%s%s' % (self.hostname,
         self.tname,
         self.pid))
