...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/mccabe/mccabe.py
# Compiled at: 2019-07-30 18:47:05
# Size of source mod 2**32: 10693 bytes
...
class PathGraphingAstVisitor(ASTVisitor):
    __doc__ = ' A visitor for a parsed Abstract Syntax Tree which finds executable\n        statements.\n    '
...
class McCabeChecker(object):
    __doc__ = 'McCabe cyclomatic complexity checker.'
    name = 'mccabe'
    version = __version__
    _code = 'C901'
...
def main(argv=None):
    if argv is None:
        ...
        opar.add_option('-d', '--dot', dest='dot', help='output a graphviz dot file',
          action='store_true')
        opar.add_option('-m', '--min', dest='threshold', help='minimum complexity for output',
          type='int',
          default=1)
