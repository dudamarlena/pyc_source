...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/pytest/_pytest/unittest.py
# Compiled at: 2019-07-30 18:47:09
# Size of source mod 2**32: 6511 bytes
""" discovery and running of std-library "unittest" style tests. """
from __future__ import absolute_import
import traceback, sys, pytest, py
        ...
        try:
            ...
            try:
                try:
                    ...
                    l.insert(0, 'NOTE: Incompatible Exception Representation, displaying natively:\n\n')
                    pytest.fail((''.join(l)), pytrace=False)
                except (pytest.fail.Exception, KeyboardInterrupt):
                    raise
                except:
                    pytest.fail(('ERROR: Unknown Incompatible Exception representation:\n%r' % (
                     rawexcinfo,)),
                      pytrace=False)
