...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/setuptools/setuptools/msvc.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 40838 bytes
"""
...
class EnvironmentInfo:
    ...
    def OSLibraries(self):
        ...
        if self.vc_ver <= 10.0:
            ...
            return [
             os.path.join(self.si.WindowsSdkDir, 'Lib%s' % arch_subdir)]
        else:
            arch_subdir = self.pi.target_dir(x64=True)
