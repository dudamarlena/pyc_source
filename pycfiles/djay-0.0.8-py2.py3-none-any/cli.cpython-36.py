...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/twine/twine/cli.py
# Compiled at: 2019-07-30 18:47:10
# Size of source mod 2**32: 2132 bytes
from __future__ import absolute_import, division, print_function
from __future__ import unicode_literals
import argparse, pkg_resources, setuptools, tqdm, requests, requests_toolbelt, pkginfo, twine
...
def dep_versions():
    return ', '.join(('{}: {}'.format)(*dependency) for dependency in list_dependencies_and_versions())
