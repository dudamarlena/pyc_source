...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/Pygments/pygments/lexers/ml.py
# Compiled at: 2019-07-30 18:47:12
# Size of source mod 2**32: 27892 bytes
"""
    pygments.lexers.ml
    ~~~~~~~~~~~~~~~~~~
...
class SMLLexer(RegexLexer):
    ...
    alphanumid_reserved = set(('abstype', 'and', 'andalso', 'as', 'case', 'datatype',
                               'do', 'else', 'end', 'exception', 'fn', 'fun', 'handle',
                               'if', 'in', 'infix', 'infixr', 'let', 'local', 'nonfix',
                               'of', 'op', 'open', 'orelse', 'raise', 'rec', 'then',
                               'type', 'val', 'with', 'withtype', 'while', 'eqtype',
                               'functor', 'include', 'sharing', 'sig', 'signature',
