...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/setuptools/setuptools/_vendor/packaging/specifiers.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 28025 bytes
        ...
        for version in iterable:
            ...
            if (self.contains)(parsed_version, **kw):
                if parsed_version.is_prerelease:
                    if not (prereleases or self.prereleases):
    ...
    def __and__(self, other):
        if isinstance(other, string_types):
            ...
            if self._prereleases is None:
                if other._prereleases is not None:
                    specifier._prereleases = other._prereleases
            if self._prereleases is not None:
                if other._prereleases is None:
