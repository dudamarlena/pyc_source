...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/docutils/docutils/parsers/rst/tableparser.py
...
class GridTableParser(TableParser):
    ...
    def parse_table(self):
        ...
        while corners:
            ...
            if not top == self.bottom:
                if left == self.right or top <= self.done[left]:
                    pass
                else:
