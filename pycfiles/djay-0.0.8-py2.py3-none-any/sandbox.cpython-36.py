...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/setuptools/setuptools/sandbox.py
...
class AbstractSandbox:
    ...
    for name in ('stat', 'listdir', 'chdir', 'open', 'chmod', 'chown', 'mkdir', 'remove',
                 'unlink', 'rmdir', 'utime', 'lchown', 'chroot', 'lstat', 'startfile',
