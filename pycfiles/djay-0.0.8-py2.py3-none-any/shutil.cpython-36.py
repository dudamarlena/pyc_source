...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/ant/code/dj/build/lib/python3.6/shutil.py
# Compiled at: 2019-07-30 17:44:33
# Size of source mod 2**32: 40227 bytes
...
_use_fd_functions = {
 os.open, os.stat, os.unlink, os.rmdir} <= os.supports_dir_fd and os.listdir in os.supports_fd and os.stat in os.supports_follow_symlinks
...
def chown(path, user=None, group=None):
    ...
    if group is None:
        ...
        _group = isinstance(group, int) or _get_gid(group)
    if _group is None:
