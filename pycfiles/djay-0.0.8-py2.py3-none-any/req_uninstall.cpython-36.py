...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_internal/req/req_uninstall.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 23105 bytes
                    ...
                    if dist.has_metadata('installed-files.txt'):
                        ...
                        if dist.has_metadata('top_level.txt'):
                            if dist.has_metadata('namespace_packages.txt'):
                                ...
                                namespaces = []
                            for top_level_pkg in [p for p in dist.get_metadata('top_level.txt').splitlines() if p if p not in namespaces]:
