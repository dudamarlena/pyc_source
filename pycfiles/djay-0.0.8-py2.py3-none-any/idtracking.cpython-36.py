...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/jinja2/jinja2/idtracking.py
            ...
            if branch_count == len(branch_symbols):
                ...
                if self.parent is not None:
                    ...
                    if outer_target is not None:
                        self.loads[target] = (
                         VAR_LOAD_ALIAS, outer_target)
                        continue
                self.loads[target] = (
                 VAR_LOAD_RESOLVE, name)
...
class FrameSymbolVisitor(NodeVisitor):
    __doc__ = 'A visitor for `Frame.inspect`.'
