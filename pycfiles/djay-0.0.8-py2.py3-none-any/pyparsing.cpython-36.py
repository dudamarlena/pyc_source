...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/setuptools/setuptools/_vendor/pyparsing.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 232055 bytes
"""
...
class ParserElement(object):
    ...
    def _parseNoCache(self, instring, loc, doActions=True, callPreParse=True):
        ...
        if debugging or self.failAction:
            ...
            if self.parseAction:
                if doActions or self.callDuringTry:
                    if debugging:
                        try:
    ...
    def __add__(self, other):
        ...
        if not isinstance(other, ParserElement):
            warnings.warn(('Cannot combine element of type %s with ParserElement' % type(other)), SyntaxWarning,
              stacklevel=2)
            return
        else:
