...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/twine/twine/settings.py
# Compiled at: 2019-07-30 18:47:10
# Size of source mod 2**32: 10769 bytes
...
class Settings(object):
    ...
    def __init__(self, sign=False, sign_with='gpg', identity=None, username=None, password=None, comment=None, config_file='~/.pypirc', skip_existing=False, cacert=None, client_cert=None, repository_name='pypi', repository_url=None, verbose=False, disable_progress_bar=False, **ignored_kwargs):
    ...
    def _handle_repository_options(self, repository_name, repository_url):
        ...
        self.repository_config['repository'] = utils.normalize_repository_url(self.repository_config['repository'])

    def _handle_authentication(self, username, password):
        self.username = utils.get_username(self.repository_config['repository'], username, self.repository_config)
        self.password = utils.get_password(self.repository_config['repository'], self.username, password, self.repository_config)
    ...
    def create_repository(self):
        ...
        repo = repository.Repository(self.repository_config['repository'], self.username, self.password, self.disable_progress_bar)
