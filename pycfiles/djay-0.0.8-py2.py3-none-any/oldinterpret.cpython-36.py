...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/pytest/_pytest/assertion/oldinterpret.py
# Compiled at: 2019-07-30 18:47:09
# Size of source mod 2**32: 18298 bytes
import traceback, types, py, sys, inspect
...
class Interpretable(View):
    __doc__ = 'A parse tree node with a few extra methods.'
    explanation = None
...
keepalive = []
for astclass, astpattern in {ast.Not: 'not __exprinfo_expr', 
 ast.Invert: '(~__exprinfo_expr)'}.items():
...
for astclass, astpattern in {ast.Add: '(__exprinfo_left + __exprinfo_right)', 
 ast.Sub: '(__exprinfo_left - __exprinfo_right)', 
 ast.Mul: '(__exprinfo_left * __exprinfo_right)', 
 ast.Div: '(__exprinfo_left / __exprinfo_right)', 
 ast.Mod: '(__exprinfo_left % __exprinfo_right)', 
 ast.Power: '(__exprinfo_left ** __exprinfo_right)'}.items():
    ...
    class BinaryArith(Interpretable):
        ...
        def eval(self, frame, astpattern=astpattern):
            ...
            try:
                self.result = frame.eval(astpattern, __exprinfo_left=(left.result),
    ...
    def eval(self, frame):
        ...
        try:
            try:
                ...
                if not self.attrname.startswith('__') or self.attrname.endswith('__'):
                    raise
