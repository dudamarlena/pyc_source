...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/coverage/coverage/results.py
...
class Analysis(object):
    __doc__ = 'The results of analyzing a code unit.'
    ...
    def arcs_missing(self):
        ...
        missing = [p for p in possible if p not in executed if p[0] not in self.no_branch]
    ...
    def arcs_unpredicted(self):
        ...
        possible = self.arc_possibilities()
        executed = self.arcs_executed()
        unpredicted = [e for e in executed if e not in possible if e[0] != e[1]]
...
class Numbers(object):
    __doc__ = 'The numerical results of measuring coverage.\n\n    This holds the basic statistics from `Analysis`, and is used to roll\n    up statistics across files.\n\n    '
    _precision = 0
    _near0 = 1.0
    _near100 = 99.0
