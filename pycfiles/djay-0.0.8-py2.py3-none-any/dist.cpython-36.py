...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/setuptools/setuptools/dist.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 49913 bytes
...
def get_metadata_version(self):
    ...
    if mv is None:
        if self.long_description_content_type or self.provides_extras:
            ...
            if self.maintainer is not None or self.maintainer_email is not None or getattr(self, 'python_requires', None) is not None:
