...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/coverage/coverage/collector.py
...
class PyTracer(object):
    __doc__ = 'Python implementation of the raw data tracer.'
                ...
                if frame == self.last_exc_back:
                    if self.arcs:
                        if self.cur_file_data:
                            pair = (
                             self.last_line, -self.last_exc_firstlineno)
