...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/urllib3/urllib3/util/ssl_.py
# Compiled at: 2019-07-30 18:47:11
# Size of source mod 2**32: 13786 bytes
from __future__ import absolute_import
import errno, warnings, hmac, re
...
_IP_ADDRESS_REGEX = re.compile('^(?:%s|%s|%s)$' % (
 abnf_regexp.IPv4_RE,
 abnf_regexp.IPv6_RE,
...
def ssl_wrap_socket(sock, keyfile=None, certfile=None, cert_reqs=None, ca_certs=None, server_hostname=None, ssl_version=None, ciphers=None, ssl_context=None, ca_cert_dir=None, key_password=None):
    """
