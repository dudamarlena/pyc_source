...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/pytest/_pytest/pytester.py
# Compiled at: 2019-07-30 18:47:09
# Size of source mod 2**32: 22236 bytes
""" (disabled by default) support for testing pytest and pytest plugins. """
import sys, os, codecs, re, time, platform
from fnmatch import fnmatch
import subprocess, py, pytest
...
def pytest_addoption(parser):
    ...
    group.addoption('--no-tools-on-path', action='store_true',
      dest='notoolsonpath',
      default=False,
...
class TmpTestdir:
    ...
    def popen(self, cmdargs, stdout, stderr, **kw):
        ...
        kw['env'] = env
        return (subprocess.Popen)(cmdargs, stdout=stdout, 
         stderr=stderr, **kw)
    ...
    def _getpybinargs(self, scriptname):
        if not self.request.config.getvalue('notoolsonpath'):
            return (
             sys.executable, _pytest_fullpath)
