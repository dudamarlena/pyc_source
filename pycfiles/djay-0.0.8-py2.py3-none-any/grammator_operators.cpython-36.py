...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/baron/baron/grammator_operators.py
# Compiled at: 2019-07-30 18:47:05
# Size of source mod 2**32: 18782 bytes
...
def include_operators(pg):
    ...
    def alone_annotation(pack):
        ...
        return {'type':'standalone_annotation', 
         'target':target, 
    ...
    def augmented_assignment_node_2(pack):
        ...
        return {'type':'assignment', 
         ...
         'target':target, 
         'value':value, 
         'annotation':{},  'annotation_first_formatting':[],  'annotation_second_formatting':[]}
    ...
    def comparison_node(pack):
        ...
        return {'type':'comparison', 
         'first':expr, 
         'value':{'type':'comparison_operator', 
    ...
    def slice(pack):
        colon, = pack
        return {'type':'slice', 
         'lower':{},  'upper':{},  'step':{},  'has_two_colons':False, 
         'first_formatting':colon.hidden_tokens_before, 
         'second_formatting':colon.hidden_tokens_after, 
    ...
    def slice_colon(pack):
        colon, colon2 = pack
        return {'type':'slice', 
         'lower':{},  'upper':{},  'step':{},  'has_two_colons':True, 
         'first_formatting':colon.hidden_tokens_before, 
         'second_formatting':colon.hidden_tokens_after, 
    ...
    def slice_lower(pack):
        ...
        return {'type':'slice', 
         'lower':test, 
         'upper':{},  'step':{},  'has_two_colons':False, 
         'first_formatting':colon.hidden_tokens_before, 
         'second_formatting':colon.hidden_tokens_after, 
         'third_formatting':[],  'fourth_formatting':[]}
    ...
    def slice_lower_colon_colon(pack):
        ...
        return {'type':'slice', 
         'lower':test, 
         'upper':{},  'step':{},  'has_two_colons':True, 
         'first_formatting':colon.hidden_tokens_before, 
         'second_formatting':colon.hidden_tokens_after, 
         'third_formatting':colon2.hidden_tokens_before, 
         'fourth_formatting':colon2.hidden_tokens_after}
