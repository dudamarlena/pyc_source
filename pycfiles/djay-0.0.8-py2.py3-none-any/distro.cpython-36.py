...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_vendor/distro.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 43251 bytes
"""
...
more information.
"""
import os, re, sys, json, shlex, logging, argparse, subprocess
_UNIXCONFDIR = os.environ.get('UNIXCONFDIR', '/etc')
_OS_RELEASE_BASENAME = 'os-release'
NORMALIZED_OS_ID = {'ol': 'oracle'}
NORMALIZED_LSB_ID = {'enterpriseenterprise':'oracle', 
 'redhatenterpriseworkstation':'rhel', 
 'redhatenterpriseserver':'rhel'}
NORMALIZED_DISTRO_ID = {'redhat': 'rhel'}
...
class cached_property(object):
    __doc__ = 'A version of @property which caches the value.  On access, it calls the\n    underlying function and sets the value in `__dict__` so future accesses\n    will not re-call the property.\n    '
...
class LinuxDistribution(object):
    ...
    def version_parts(self, best=False):
        ...
        if version_str:
            ...
            if matches:
                ...
                return (
                 major, minor or '', build_number or '')
        return ('', '', '')
    ...
    def info(self, pretty=False, best=False):
        ...
        return dict(id=(self.id()),
          ...
          version_parts=dict(major=(self.major_version(best)),
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        if sys.version_info[0] == 2:
            if isinstance(lexer.wordchars, bytes):
