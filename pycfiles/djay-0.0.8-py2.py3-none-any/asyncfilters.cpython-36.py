...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/jinja2/jinja2/asyncfilters.py
...
async def do_groupby(environment, value, attribute):
    ...
    return await [filters._GroupTuple(key, await auto_to_seq(values)) for key, values in filters.groupby(sorted((await auto_to_seq(value)),
      key=expr), expr)]
