...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/baron/baron/path.py
# Compiled at: 2019-07-30 18:47:05
# Size of source mod 2**32: 9572 bytes
...
class Position(object):
    ...
    def __eq__(self, other):
        ...
        if not (hasattr(other, 'line') and hasattr(other, 'column')):
            if len(other) < 2:
                return False
        other = Position(other)
...
class BoundingBox(object):
    ...
    def __eq__(self, other):
        ...
        if not (hasattr(other, 'top_left') and hasattr(other, 'bottom_right')):
            if len(other) < 2:
                return False
