...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/pytest/_pytest/pastebin.py
# Compiled at: 2019-07-30 18:47:09
# Size of source mod 2**32: 3198 bytes
""" submit failure or test session information to a pastebin service. """
import pytest, py, sys, tempfile

def pytest_addoption(parser):
    group = parser.getgroup('terminal reporting')
    group._addoption('--pastebin', metavar='mode', action='store',
      dest='pastebin',
      default=None,
      choices=[
     'failed', 'all'],
