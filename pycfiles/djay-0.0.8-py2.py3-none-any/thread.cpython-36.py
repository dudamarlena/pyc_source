...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/requests-toolbelt/requests_toolbelt/threaded/thread.py
# Compiled at: 2019-07-30 18:47:11
# Size of source mod 2**32: 1465 bytes
"""Module containing the SessionThread class."""
import threading, uuid, requests.exceptions as exc
...
class SessionThread(object):
    ...
    def _create_worker(self):
        self._worker = threading.Thread(target=(self._make_request),
          name=(uuid.uuid4()))
