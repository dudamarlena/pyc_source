...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_internal/cli/cmdoptions.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 27444 bytes
"""
...
import logging, textwrap, warnings
...
def check_install_build_global(options, check_options=None):
    ...
    if any(map(getname, names)):
        ...
        warnings.warn('Disabling all use of wheels due to the use of --build-options / --global-options / --install-options.',
          stacklevel=2)
...
skip_requirements_regex = partial(Option,
