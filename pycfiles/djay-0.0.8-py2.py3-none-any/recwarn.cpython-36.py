...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/pytest/_pytest/recwarn.py
...
class WarningsRecorder:
    ...
    def __init__(self):
        ...
        def showwarning(message, category, filename, lineno, line=0):
            self.list.append(RecordedWarning(message, category, filename, lineno, line))
            try:
                self.old_showwarning(message, category, filename,
                  lineno, line=line)
            except TypeError:
