...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/pytest/_pytest/monkeypatch.py
    ...
    while target:
        try:
            ...
            if '.' not in target:
                ...
                pytest.fail('could not import any sub part: %s' % import_path)
...
class monkeypatch:
    __doc__ = ' Object keeping a record of setattr/item/env/syspath changes. '
