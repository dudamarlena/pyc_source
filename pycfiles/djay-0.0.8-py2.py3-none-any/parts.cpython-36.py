...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/docutils/docutils/transforms/parts.py
...
class Contents(Transform):
    ...
    def apply(self):
        ...
        if 'local' in details:
            ...
            while not (isinstance(startnode, nodes.section) or isinstance(startnode, nodes.document)):
