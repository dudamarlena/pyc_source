...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/requests-toolbelt/requests_toolbelt/utils/formdata.py
...
def urlencode(query, *args, **kwargs):
    ...
    if not all(_is_two_tuple(i) for i in original_query_list):
        raise ValueError('Expected query to be able to be converted to a list comprised of length 2 tuples.')
