...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_internal/operations/prepare.py
# Compiled at: 2019-07-30 18:46:55
# Size of source mod 2**32: 11728 bytes
    ...
    def prepare_linked_requirement(self, req, session, finder, upgrade_allowed, require_hashes):
        ...
        with indent_log():
            ...
            try:
                ...
                unpack_url((req.link),
                  (req.source_dir), download_dir,
                  autodelete_unpacked, session=session,
                  hashes=hashes,
            ...
            with self.req_tracker.track(req):
                abstract_dist.prepare_distribution_metadata(finder, self.build_isolation)
