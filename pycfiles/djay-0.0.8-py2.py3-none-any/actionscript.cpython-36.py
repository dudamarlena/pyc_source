...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/Pygments/pygments/lexers/actionscript.py
...
class ActionScriptLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       'super', 'dynamic', 'function', 'const', 'get', 'namespace', 'package', 'set'),
                 suffix='\\b'),
               Keyword.Declaration),
              (
