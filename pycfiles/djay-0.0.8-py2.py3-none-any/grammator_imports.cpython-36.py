...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/baron/baron/grammator_imports.py
...
def include_imports(pg):
    ...
    def from_import_parenthesis(pack):
        ...
        return left_parenthesis.hidden_tokens_before + [{'type':'left_parenthesis',  'value':'('}] + left_parenthesis.hidden_tokens_after + name_as_names + right_parenthesis.hidden_tokens_before + [{'type':'right_parenthesis',  'value':')'}] + right_parenthesis.hidden_tokens_after
    ...
    def dotted_as_name(pack):
        ...
        return [
         {'type':'dotted_as_name', 
          'value':dotted_name, 
          'first_formatting':[],  'second_formatting':[],  'target':''}]
