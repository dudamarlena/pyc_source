...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/coverage/coverage/files.py
# Compiled at: 2019-07-30 18:47:10
# Size of source mod 2**32: 10724 bytes
"""File wrangling."""
from coverage.backward import to_string
from coverage.misc import CoverageException
import fnmatch, os, os.path, re, sys, ntpath, posixpath

class FileLocator(object):
    __doc__ = 'Understand how filenames work.'
...
class TreeMatcher(object):
    __doc__ = 'A matcher for files in a tree.'
...
class FnmatchMatcher(object):
    __doc__ = 'A matcher for files by filename pattern.'
