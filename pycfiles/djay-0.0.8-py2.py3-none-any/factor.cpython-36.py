...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-m_4qh6p6/Pygments/pygments/lexers/factor.py
...
class FactorLexer(RegexLexer):
    ...
    builtin_kernel = words(('-rot', '2bi', '2bi@', '2bi*', '2curry', '2dip', '2drop',
                            ...
                            'while', 'with', 'wrapper', 'wrapper?', 'xor'),
      suffix='\\s')
    ...
    builtin_combinators = words(('2cleave', '2cleave>quot', '3cleave', '3cleave>quot',
                                 ...
                                 'spread', 'to-fixed-point', 'wrong-values', 'wrong-values?'),
      suffix='\\s')
    builtin_math = words(('-', '/', '/f', '/i', '/mod', '2/', '2^', '<', '<=', '<fp-nan>',
                          ...
                          'unless-zero', 'unordered?', 'when-zero', 'zero?'),
      suffix='\\s')
    ...
    builtin_arrays = words(('1array', '2array', '3array', '4array', '<array>', '>array',
                            'array', 'array?', 'pair', 'pair?', 'resize-array'),
      suffix='\\s')
    ...
    builtin_strings = words(('1string', '<string>', '>string', 'resize-string', 'string',
                             'string?'),
      suffix='\\s')
    builtin_vectors = words(('1vector', '<vector>', '>vector', '?push', 'vector', 'vector?'),
      suffix='\\s')
