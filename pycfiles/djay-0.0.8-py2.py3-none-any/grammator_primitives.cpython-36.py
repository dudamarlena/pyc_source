...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/baron/baron/grammator_primitives.py
# Compiled at: 2019-07-30 18:47:05
# Size of source mod 2**32: 10785 bytes
...
def include_primivites(pg, print_function):
    if not print_function:
        ...
        def print_stmt_empty(pack):
            ...
            return {'type':'print', 
             ...
             'destination_formatting':[],  'formatting':[]}
        ...
        def print_stmt(pack):
            ...
            return {'type':'print', 
             ...
             'destination':None, 
             'destination_formatting':[],  'formatting':print_.hidden_tokens_after}
        ...
        def exec_stmt(pack):
            ...
            return {'type':'exec', 
             ...
             'second_formatting':[],  'third_formatting':[],  'fourth_formatting':[],  'fifth_formatting':[]}
        ...
        def exec_stmt_in(pack):
            ...
            return {'type':'exec', 
             ...
             'fourth_formatting':[],  'fifth_formatting':[]}
    ...
    def raise_stmt_empty(pack):
        ...
        return {'type':'raise', 
         ...
         'second_formatting':[],  'third_formatting':[],  'fourth_formatting':[],  'fifth_formatting':[],  'comma_or_from':None}
    ...
    def raise_stmt_from(pack):
        ...
        return {'type':'raise', 
         ...
         'fourth_formatting':[],  'fifth_formatting':[],  'comma_or_from':'from'}
    ...
    def raise_stmt_instance(pack):
        ...
        return {'type':'raise', 
         ...
         'fourth_formatting':[],  'fifth_formatting':[],  'comma_or_from':','}
    ...
    def assert_stmt(pack):
        ...
        return {'type':'assert', 
         ...
         'second_formatting':[],  'third_formatting':[]}
    ...
    def lambdef(pack):
        ...
        return {'type':'lambda', 
         'arguments':[],  'first_formatting':lambda_.hidden_tokens_after, 
