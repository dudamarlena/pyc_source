...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-x0nyl_ya/baron/baron/grammator.py
# Compiled at: 2019-07-30 18:47:05
# Size of source mod 2**32: 30486 bytes
...
def generate_parse(print_function):
    ...
    def main(pack):
        statements, = pack
        if statements:
            return [x for x in statements if x]
        else:
            return []
    ...
    def endl(pack):
        endl, = pack
        indent = ''
        if endl.hidden_tokens_after:
            if endl.hidden_tokens_after[0]['type'] == 'space':
        ...
        return [
         {'type':'endl', 
          ...
          'indent':indent}] + endl.hidden_tokens_after
    ...
    def simple_stmt_semicolon_endl(pack):
        ...
        return [small_stmt,
         {'type':'semicolon', 
          'value':';', 
          'first_formatting':semicolon.hidden_tokens_before, 
          'second_formatting':semicolon.hidden_tokens_after}] + endl
    ...
    def simple_stmt_semicolon(pack):
        ...
        return [small_stmt,
         {'type':'semicolon', 
          'value':';', 
          'first_formatting':semicolon.hidden_tokens_before, 
          'second_formatting':semicolon.hidden_tokens_after}] + simple_stmt
    ...
    def with_item(pack):
        test, = pack
        return {'type':'with_context_item', 
         'as':{},  'first_formatting':[],  'second_formatting':[],  'value':test}
    ...
    def class_stmt(pack):
        ...
        return [
         {'type':'class', 
          ...
          'second_formatting':[],  'third_formatting':[],  'fourth_formatting':[],  'fifth_formatting':colon.hidden_tokens_before, 
          'sixth_formatting':colon.hidden_tokens_after, 
          'inherit_from':[],  'decorators':[],  'value':suite}]
    ...
    def decorator(pack):
        ...
        return [
         {'type':'decorator', 
          'value':{'value':dotted_name, 
           'type':'dotted_name'}, 
          'call':{},  'formatting':at.hidden_tokens_after}] + endl
    ...
    def decorator_empty_call(pack):
        ...
        return [
         {'type':'decorator', 
          'value':{'value':dotted_name, 
           'type':'dotted_name'}, 
          'call':{'third_formatting':right_parenthesis.hidden_tokens_before, 
           'fourth_formatting':right_parenthesis.hidden_tokens_after, 
           'type':'call', 
           'first_formatting':left_parenthesis.hidden_tokens_before, 
           'value':[],  'second_formatting':left_parenthesis.hidden_tokens_after}, 
          'formatting':at.hidden_tokens_after}] + endl
    ...
    def return_annotation_empty(pack):
        return {'value':{},  'first_formatting':[],  'second_formatting':[]}
    ...
    def parameter_fpdef(pack):
        ...
        return [
         {'type':'def_argument', 
          'annotation':{},  'annotation_first_formatting':[],  'annotation_second_formatting':[],  'first_formatting':equal.hidden_tokens_before if equal else [], 
          'second_formatting':equal.hidden_tokens_after if equal else [], 
          'value':test, 
          'target':{'type':'associative_parenthesis', 
           'first_formatting':left_parenthesis.hidden_tokens_before, 
           'second_formatting':left_parenthesis.hidden_tokens_after, 
    ...
    def argument_star(pack):
        ...
        return [
         {'type':'list_argument', 
          'annotation':{},  'annotation_first_formatting':[],  'annotation_second_formatting':[],  'formatting':star.hidden_tokens_after, 
          'value':test}]
    ...
    def argument_star_star(pack):
        ...
        return [
         {'type':'dict_argument', 
          'annotation':{},  'annotation_first_formatting':[],  'annotation_second_formatting':[],  'formatting':double_star.hidden_tokens_after, 
          'value':test}]
