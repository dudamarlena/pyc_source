...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_vendor/distlib/locators.py
# Compiled at: 2019-07-30 18:46:56
# Size of source mod 2**32: 51807 bytes
import gzip
        ...
        if path.endswith(self.source_extensions + self.binary_extensions + self.excluded_extensions):
            ...
            if self.skip_externals:
                if not link.startswith(self.base_url):
                    ...
                    result = referrer.startswith(self.base_url) or False
            else:
