...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-sin1koo5/pip/pip/_vendor/distlib/scripts.py
# Compiled at: 2019-07-30 18:46:56
# Size of source mod 2**32: 16290 bytes
    ...
    if sys.platform.startswith('java'):
        ...
        def _fix_jython_executable(self, executable):
            if self._is_shell(executable):
                ...
                if executable.lower().endswith('jython.exe'):
                    return executable
