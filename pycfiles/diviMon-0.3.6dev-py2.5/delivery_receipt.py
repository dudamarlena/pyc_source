...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/divimon/controllers/uploads/delivery_receipt.py
# Compiled at: 2008-08-05 20:38:22
from base import *
...
class DeliveryReceiptController(UploadController):
    ...
    last_row = {}
    last_trans = None
    parent = dict(area=dict(table=model.Area, column='name'), type=dict(table=model.TransType, column='name'), customer=dict(table=model.Customer, column='name'), agent=dict(table=model.Agent, column='name'), pay_type=dict(table=model.PayType, column='name'), item=dict(table=model.Item, column='name'))
