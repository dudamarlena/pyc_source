...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/divimon/controllers/purchase_order.py
...
class PurchaseOrderController(TransactionController):
    ...
    def render_edit(self):
        return render('/purchase_order/edit.mako')