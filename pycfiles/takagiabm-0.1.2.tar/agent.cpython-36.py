...
# [GCC 8.4.0]
# Embedded file name: /media/hzy/程序/novalide/forgitcommit/NovalIDE/plugins/takagi/takagiabm/agent.py
# Compiled at: 2020-04-18 10:37:19
# Size of source mod 2**32: 7624 bytes
import numpy as np
...
class BaseAgent:
    ...
    def getColorArray(self, pos=None) -> np.array:
    ...
    def setPropertyLater(self, propertyName: str, property):
    ...
    def getTrait(self, traitName: str):
...
class GridAgent(BaseAgent):
    ...
    def __init__(self, pos=np.array([0, 0]), model=None, color='#ffffff'):
        ...
        self.vertArray = takTriangle

    def setSpeed(self, speed: np.ndarray):
        ...
        self.turn(angle)
        self.speed = speed
        self.orientation = self.speed.copy()
    ...
    def turn(self, dir: str):
        self.speed, self.vertArray = kinematics.turnWithVert(dir, self.speed, self.vertArray)
