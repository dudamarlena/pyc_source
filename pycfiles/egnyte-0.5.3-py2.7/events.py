...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/egnyte/events.py
# Compiled at: 2016-12-07 06:58:52
...
class Event(base.Resource):
    ...
    * data - additional data specific for event type and action
    ...
    """
    _url_template = b'pubapi/v1/events/%(id)s'
...
class Events(base.Resource):
    ...
    * timestamp - iso8601 timestamp of latest event
    """
    _url_template = b'pubapi/v1/events/cursor'
    _url_template_list = b'pubapi/v1/events'
    _lazy_attributes = {b'latest_event_id', b'oldest_event_id', b'timestamp'}
    poll_delay = 1.0
    start_id = None
    suppress = None
    folder = None
    ...
    def list(self, start_id, count=None):
        ...
        if json is None:
            ...
            return base.ResultList((Event(self._client, **d) for d in json.get(b'events', ())), json[b'latest_id'], start_id)
            return
