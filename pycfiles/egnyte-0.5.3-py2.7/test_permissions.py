...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/egnyte/tests/test_permissions.py
...
class TestDeprecatedPermissions(EgnyteTestCase):
    ...
    def setUp(self):
        ...
        self.user = self.egnyte.users.create(userName=USER_NAME, externalId=USER_NAME, email='test@example.com', familyName='Doe', givenName='John', active=False, sendInvite=False)
