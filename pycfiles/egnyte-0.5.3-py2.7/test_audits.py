...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/egnyte/tests/test_audits.py
...
class TestAudits(unittest.TestCase):
    ...
    def test_create_and_download_files_audit_report_in_csv(self):
        audit_report = self.egnyte.audits.files('csv', '2017-02-20', '2017-02-24')
        audit_report.wait()
    ...
    def test_create_and_download_logins_report_in_csv(self):
        audit_report = self.egnyte.audits.logins('csv', '2017-02-20', '2017-02-24', ['logins'])
        audit_report.wait()
