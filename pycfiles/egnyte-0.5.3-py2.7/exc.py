...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/egnyte/exc.py
...
class ErrorMapping(dict):
    ...
    def __init__(self, values=None, ok_statuses=(http_client.OK,), ignored_errors=None):
        super(ErrorMapping, self).__init__({http_client.BAD_REQUEST: RequestError, 
...
created_ignore_existing = ErrorMapping(ok_statuses=(http_client.CREATED,), ignored_errors=[
 (
  'Folder already exists at this location', {'http status': 403})])