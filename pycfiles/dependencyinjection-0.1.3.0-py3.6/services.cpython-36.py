...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\dependencyinjection\internal\services.py
# Compiled at: 2018-01-28 08:53:19
# Size of source mod 2**32: 5360 bytes
import typing
from overload import overload
from .common import LifeTime, IServiceProvider, IScopedFactory, ILock, FAKE_LOCK
from .scopedfactory import ScopedFactory
from .provider import ServiceProvider
from .descriptors import Descriptor, CallableDescriptor, InstanceDescriptor, ServiceProviderDescriptor, MapDescriptor
...
class Services:
    ...
    def add(self, service_type: type, obj: (callable, type), lifetime: LifeTime, *, auto_exit=False):
        """
