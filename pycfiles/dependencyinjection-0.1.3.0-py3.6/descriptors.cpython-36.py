...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\dependencyinjection\internal\descriptors.py
# Compiled at: 2018-01-28 08:44:46
...
from .callsites import InstanceCallSite, ServiceProviderCallSite, CallableCallSite, ListedCallSite
...
class CallableDescriptor(Descriptor):
    ...
    def __init__(self, service_type, func, lifetime, **options):
    ...
    def make_callsite(self, service_provider, depend_chain):
        ...
        if params:
            type_resolver = service_provider.get(ParameterTypeResolver)
            for param in params:
                callsite = None
...
class InstanceDescriptor(Descriptor):
    ...
    def __init__(self, service_type, instance):
...
class MapDescriptor(Descriptor):
    ...
    def __init__(self, service_type, target_service_type):
