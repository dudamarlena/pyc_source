...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\dependencyinjection\internal\callsites.py
# Compiled at: 2018-01-28 08:46:49
...
class LifeTimeCallSite(BaseCallSite):
    ...
    def __init__(self, descriptor, base_callsite):
...
class NoLifeTimeCallSite(BaseCallSite):
    __doc__ = ' the callsite does not need to wraped into `LifeTimeCallSite`.'
...
class CallableCallSite(BaseCallSite):
    ...
    def __init__(self, descriptor, func, param_callsites, options):
