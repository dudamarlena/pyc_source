...
# [GCC 8.4.0]
# Embedded file name: /home/marc/Git/common-framework/common/migrations/0001_initial.py
# Compiled at: 2019-06-21 06:38:56
# Size of source mod 2**32: 9474 bytes
from __future__ import unicode_literals
from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion, common.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Global',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name_plural':'globales', 
      'verbose_name':'globale'}),
     migrations.CreateModel(name='GroupMetaData',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name_plural':'métadonnées de groupes', 
      'verbose_name':'métadonnées de groupe'}),
     migrations.CreateModel(name='History',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'restoration_date', models.DateTimeField(null=True, editable=False, verbose_name='dernière restauration', blank=True)),
      (
       'restored', models.NullBooleanField(editable=False, verbose_name='restauré')),
      (
      ...
      (
       'status', models.CharField(max_length=1, choices=[('C', 'Création'), ('U', 'Modification'), ('D', 'Suppression'), ('R', 'Restauration'), ('M', 'Many-to-many')], verbose_name='statut', editable=False)),
      (
       'object_id', models.PositiveIntegerField(verbose_name='identifiant', editable=False)),
      (
      ...
      (
       ...
       options={'verbose_name_plural':'historiques', 
      'ordering':[
       '-creation_date'], 
      'verbose_name':'historique'}),
     migrations.CreateModel(name='HistoryField',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'data_size', models.PositiveIntegerField(verbose_name='taille données', editable=False)),
      (
       'field_name', models.CharField(db_index=True, max_length=100, verbose_name='nom du champ', editable=False)),
      (
      ...
      (
       ...
       options={'verbose_name_plural':'champs modifiés', 
      'ordering':[
       '-creation_date'], 
      'verbose_name':'champ modifié'}),
     migrations.CreateModel(name='MetaData',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name_plural':'métadonnées', 
      'verbose_name':'métadonnée'}),
     migrations.CreateModel(name='UserMetaData',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name_plural':"métadonnées d'utilisateurs", 
      'verbose_name':"métadonnées d'utilisateur"}),
     migrations.CreateModel(name='Webhook',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'format', models.CharField(default='json', max_length=4, choices=[('json', 'JSON'), ('xml', 'XML'), ('yaml', 'YAML')], verbose_name='format')),
      (
       'authorization', models.CharField(null=True, max_length=6, choices=[('Basic', 'Basic'), ('Digest', 'Digest'), ('Token', 'Token'), ('Bearer', 'Bearer'), ('JWT', 'JWT')], verbose_name='authentification', blank=True)),
      (
      ...
      (
       ...
       options={'verbose_name_plural':'web hooks', 
      'verbose_name':'web hook'}),
     migrations.AlterUniqueTogether(name='metadata',
       unique_together=(set([('content_type', 'object_id', 'key')]))),
     migrations.AlterIndexTogether(name='history',
       index_together=(set([('content_type', 'object_id')]))),
     migrations.AlterUniqueTogether(name='global',
