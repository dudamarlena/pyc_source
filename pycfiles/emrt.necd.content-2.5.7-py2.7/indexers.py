...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/emrt/necd/content/indexers.py
# Compiled at: 2020-04-10 03:07:26
...
def SearchableText(context):
    ...
    try:
        conclusions = context.getFolderContents({'portal_type': 'Conclusions'}, full_objects=True)
    except:
        conclusions = []
