...
# [GCC 8.4.0]
# Embedded file name: /home/goncalopp/private/mydocs/programacao/python/mexbtcapi/mexbtcapi/api/mtgox/http_v1/mtgox.py
# Compiled at: 2012-12-27 10:29:42
import base64, hashlib, hmac, time, urllib, urllib2, json
...
def _value_hook(values):
    ...
    if RETURN_TYPE in (Decimal, float):
        ...
        drop = ('currency', 'display', 'item', 'price_currency', 'amount_int', 'price_int',
                'value_int')
    if RETURN_TYPE is int:
        value = 'value_int'
        keep = ('amount_int', 'price_int', 'value_int')
        drop = ('currency', 'display', 'item', 'price_currency', 'amount', 'price',
                'value')
    if RETURN_TYPE is str:
        value = 'display'
        keep = ()
        drop = ('currency', 'amount', 'price', 'value', 'item', 'price_currency', 'amount_int',
                'price_int', 'value_int')
...
class Private:
    ...
    def _order_add(self, order_type, amount, price, currency):
        ...
        data = {'type': order_type, 'amount_int': amount, 
           'price_int': price}
