...
# Embedded file name: /usr/lib/python2.7/site-packages/abiosgaming/client.py
# Compiled at: 2015-12-12 18:03:30
...
class AbiosClient(BaseAbiosClient):
    ...
    def get_matches(self, count=DEFAULT_NUM_ITEMS, addons=[], games=[], competitors=[], tournaments=[], substages=[], order=None, sort=None, starts_after=None, starts_before=None, ends_after=None, ends_before=None):
        return [ Match(data) for data in self._get_matches({'with[]': addons, 'games[]': games, 
    ...
    def get_upcoming_matches(self, count=DEFAULT_NUM_ITEMS, addons=[], games=[], competitors=[], tournaments=[], substages=[], order='start', sort='ASC'):
        """
        ...
        """
        return self.get_matches(count=count, addons=addons, games=games, competitors=competitors, tournaments=tournaments, substages=substages, order=order, sort=sort, starts_after='now')

    def get_recent_results(self, count=DEFAULT_NUM_ITEMS, addons=[], games=[], competitors=[], tournaments=[], substages=[], order='end', sort='DESC'):
        """
        ...
        """
        return self.get_matches(count=count, addons=addons, games=games, competitors=competitors, tournaments=tournaments, substages=substages, order=order, sort=sort, ends_before='now')

    def get_current_matches(self, count=DEFAULT_NUM_ITEMS, addons=[], games=[], competitors=[], tournaments=[], substages=[], order='start', sort='ASC'):
        """
        ...
        :param str sort: (optional), the order in which items are sorted (ASC or DESC).  Default ASC
        """
        return self._get_matches({'with[]': addons, 'games[]': games, 
           'starts_before': 'now', 
           'ends_after': 'now', 
           'sort': sort}, count=count)
    ...
    def get_competitors(self, count=DEFAULT_NUM_ITEMS, q=None, games=[], addons=[], tournaments=[], sort='ASC'):
        """
        ...
        :param str sort: (optional), the order in which items are sorted (ASC or DESC).  Default ASC
        """
        return self._get_competitors({'q': q, 'with[]': addons, 
           'games[]': games, 
           'tournaments[]': tournaments, 
           'sort': sort}, count=count)