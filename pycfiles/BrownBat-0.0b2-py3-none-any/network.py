...
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/brownant/pipeline/network.py
...
class ResponseProperty(PipelineProperty):
    ...
    def provide_value(self, obj):
        if 'content_method' not in self.attr_names:
            raise KeyError('You need create a subclass which inheritance ResponseProperty, and assign `content_method` into self.attr_names')
