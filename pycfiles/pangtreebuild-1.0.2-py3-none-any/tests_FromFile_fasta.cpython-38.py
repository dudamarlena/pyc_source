...
# [GCC 8.4.0]
# Embedded file name: /home/paulina/pangtree/pangtreebuild/tests/tests_pangenome/fasta_providers/tests_FromFile_fasta.py
...
class FromFileFastaProviderFastaTests(unittest.TestCase):
 ...
 L.  14         0  LOAD_GLOBAL              open
                2  LOAD_FAST                'path'
                4  CALL_FUNCTION_1       1  ''
                6  SETUP_WITH           50  'to 50'
                8  STORE_FAST               'fasta_file_hanlder'

 L.  15        10  LOAD_FAST                'fasta_file_hanlder'
               12  LOAD_METHOD              readline
               14  CALL_METHOD_0         0  ''
               16  STORE_FAST               '_'

 L.  16        18  LOAD_FAST                'fasta_file_hanlder'
               20  LOAD_METHOD              read
               22  CALL_METHOD_0         0  ''
