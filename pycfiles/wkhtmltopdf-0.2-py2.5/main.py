...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/wkhtmltopdf/main.py
...
class WKhtmlToPdf(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.defaults = {'screen_resolution': [
                               kwargs.get('screen_resolution', [1024, 768]), list], 
           'color_depth': [
                         kwargs.get('color_depth', 24), int], 
           'flash_plugin': [
                          kwargs.get('flash_plugin', True), bool], 
           'disable_javascript': [
                                kwargs.get('disable_javascript', False), bool], 
           'delay': [
                   kwargs.get('delay', 0), int], 
           'orientation': [
                         kwargs.get('orientation', 'Portrait'), str], 
           'dpi': [
                 kwargs.get('dpi', 100), int], 
           'no_background': [
                           kwargs.get('no_background', False), bool], 
           'grayscale': [
                       kwargs.get('grayscale', False), bool], 
           'http_username': [
                           kwargs.get('http_username', ''), str], 
           'http_password': [
                           kwargs.get('http_password', ''), str], 
           'header_html': [
                         kwargs.get('header_html'), '', str], 
           'footer_html': [
                         kwargs.get('footer_html'), '', str]}
