...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pinocchio/stopwatch.py
...
class Stopwatch(Plugin):
    ...
    def add_options(self, parser, env=os.environ):
        ...
        parser.add_option('--faster-than', action='store', type='float', dest='faster_than', default=None, help='Run only tests that are faster than FASTER_THAN seconds.')
        parser.add_option('--stopwatch-file', action='store', dest='stopwatch_file', default='.nose-stopwatch-times', help='Store test timing results in this file.')
        return
