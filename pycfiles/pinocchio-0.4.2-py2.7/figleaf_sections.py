...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pinocchio/figleaf_sections.py
...
class FigleafSections(Plugin):
    ...
    def add_options(self, parser, env=os.environ):
        ...
        parser.add_option('--figleaf-file', action='store', dest='figleaf_file', default=None, help='Store figleaf section coverage in this file')
        return
    ...
    def startTest(self, test):
        ...
        nose testcases.
        """
        if isinstance(test, nose.case.FunctionTestCase) or isinstance(test, nose.case.MethodTestCase):
