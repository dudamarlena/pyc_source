...
# [GCC 8.4.0]
# Embedded file name: /root/app/RDRPOSTagger-master/SCRDRlearner/SCRDRTreeLearner.py
...
class SCRDRTreeLearner(SCRDRTree):
    ...
    def findMostImprovingRuleForTag(self, startTag, correctTag, correctCounts, wrongObjects):
        ...
        return (
         bestRule, maxImp, affectedObjects[bestRule])
    ...
    def findMostEfficientRule(self, startTag, objects, correctCounts):
        ...
        return (
         rule, correctTag, maxImp, cornerstoneCases, needToCorrectObjects, errorRaisingObjects)
