...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tornado_elastic2/__init__.py
# Compiled at: 2020-04-23 00:16:18
import tornado
...
class ApiElasticHandlerAPM(RequestHandler):
    ...
    def capture_exception(self):
        ...
        apm_elastic.client.capture_exception(context={'request': get_data_from_request(self.request, capture_body=False, capture_headers=True)}, handled=False)
    ...
    def on_finish(self):
        ...
        data_request = get_data_from_request(self.request, capture_body=c_body, capture_headers=apm_elastic.client.config.capture_headers)
        data_response = get_data_from_response(self, capture_headers=apm_elastic.client.config.capture_headers)
