...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/django_debug_html_store/middleware.py
# Compiled at: 2013-02-23 00:30:36
"""
    ...
    def process_response(self, request, response):
        ...
        if re.search(EXCLUDE_REGEX, request.path):
            ...
            if debug_store_type == 'file':
                html_filename = getattr(settings, 'DEBUG_STORE_FILE_PREFIX', 'debug_store')
            ...
            if debug_store_type == 'file':
                ...
                cache.set(cache_name, res_str, 86400)
            return response