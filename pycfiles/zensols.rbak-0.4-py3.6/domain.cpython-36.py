...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/zensols/rbak/domain.py
...
class Target(object):
    __doc__ = 'Represents to where files are backed up.  Sometimes this is an external\n    file system.\n    '
