...
# Embedded file name: build/bdist.linux-x86_64/egg/pyf/componentized/components/configuration.py
...
class Configuration(object):
    ...
    def __init__(self):
        self.__config = dict()
        warnings.warn('Call to deprecated class Configuration.', category=DeprecationWarning)
