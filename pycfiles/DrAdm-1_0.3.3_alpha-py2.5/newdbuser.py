...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DrAdm1/newdbuser.py
# Compiled at: 2009-08-15 09:25:06
"""
...
def main():
    ...
    cli = optparse.OptionParser(description='Create new database user. Part of DrAdm1 utilities pack. http://dradm.org', version='1.0', usage='%prog [options] <user[@host_or_ip]> [database]')
