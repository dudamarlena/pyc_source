...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DrAdm1/newuser.py
# Compiled at: 2009-08-20 16:40:20
"""
...
def main():
    ...
    config = Config()
    cli = optparse.OptionParser(description='Create user and optionally add it to the project. Part of DrAdm1 utilities pack. http://dradm.org', version='1.0', usage='%prog [options] <user> [project]')
