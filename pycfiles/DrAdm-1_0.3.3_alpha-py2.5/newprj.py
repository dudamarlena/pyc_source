...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DrAdm1/newprj.py
# Compiled at: 2009-08-16 18:31:04
"""
...
def main():
    ...
    """
    if not rootcheck():
        errexit('You need superuser privilegez!')
    ...
    cli = optparse.OptionParser(description='Setup directory for the new project. Part of DrAdm1 utilities pack.', version=VERSION, usage='%prog [options] <project>', epilog='More docs at http://dradm.org')
