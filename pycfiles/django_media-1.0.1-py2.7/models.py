...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/media/models.py
...
class Photo(models.Model):
    ...
    uploaded = models.DateTimeField(auto_now_add=True)
    modified = models.DateTimeField(auto_now=True)
    original = models.DateTimeField(editable=False, blank=True, null=True, verbose_name='Original Creation Date')
