...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/extractor.py
# Compiled at: 2006-05-29 09:34:29
"""
...
class Keywords(Structure):
    ...
    _fields_ = [
     (
      'keyword', c_char_p), ('keywordType', KeywordType), ('next', Keywords_p)]
...
class Extractor(object):
    ...
    def extractFromFile(self, filename):
        r"""Extract keywords from a file using its filename.
