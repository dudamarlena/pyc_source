...
# [GCC 8.4.0]
# Embedded file name: oauthost/../oauthost/migrations/0002_auto_20150927_1933.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterField(model_name='authorizationcode',
       name='code',
     ...
     migrations.AlterField(model_name='client',
       name='scopes',
     ...
     migrations.AlterField(model_name='token',
       name='access_token',
