...
# Size of source mod 2**32: 8427 bytes
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='AuthorizationCode', fields=[
      (
      ...
      (
       'uri', oauthost.fields.URLSchemeField(help_text='The URI authorization is bound to.', verbose_name='Redirect URI'))], options={'verbose_name': 'Authorization code', 
      'verbose_name_plural': 'Authorization codes'}, bases=(
      models.Model,)),
     migrations.CreateModel(name='Client', fields=[
      ...
      (
       'hash_sign_supported', models.BooleanField(default=True, help_text='Should be checked if this client supports fragment component (#) in the HTTP "Location" response header field', verbose_name='Supports # in "Location"'))], options={'verbose_name': 'Client', 
      'verbose_name_plural': 'Clients'}, bases=(
      models.Model,)),
     migrations.CreateModel(name='RedirectionEndpoint', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
      ...
      (
       'client', models.ForeignKey(related_name='redirection_uris', verbose_name='Client', to='oauthost.Client', on_delete=models.CASCADE))], options={'verbose_name': 'Redirection Endpoint', 
      'verbose_name_plural': 'Redirection Endpoints'}, bases=(
      models.Model,)),
     migrations.CreateModel(name='Scope', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
      ...
      (
       'status', models.PositiveIntegerField(default=1, db_index=True, verbose_name='Status', choices=[(1, 'Enabled'), (2, 'Disabled')]))], options={'ordering': [
                   'title'], 
      'verbose_name': 'Scope', 
      'verbose_name_plural': 'Scopes'}, bases=(
      models.Model,)),
     migrations.CreateModel(name='Token', fields=[
      ...
      (
       'user', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, help_text='The user token is issued for.', null=True, verbose_name='User', on_delete=models.CASCADE))], options={'verbose_name': 'Token', 
      'verbose_name_plural': 'Tokens'}, bases=(
      models.Model,)),
     migrations.AddField(model_name='client', name='scopes', field=models.ManyToManyField(help_text='The scopes client is restricted to. <i>All registered scopes will be available for the client if none selected.</i>', to='oauthost.Scope', null=True, verbose_name='Scopes', blank=True), preserve_default=True),
     migrations.AddField(model_name='client', name='user', field=models.ForeignKey(verbose_name='Registrant', to=settings.AUTH_USER_MODEL, help_text='User who registered this client.', on_delete=models.CASCADE), preserve_default=True),
     migrations.AddField(model_name='authorizationcode', name='client', field=models.ForeignKey(verbose_name='Client', to='oauthost.Client', help_text='The client authorization is granted for.', on_delete=models.CASCADE), preserve_default=True),
     migrations.AddField(model_name='authorizationcode', name='scopes', field=models.ManyToManyField(help_text='The scopes token issued with this code should be restricted to.', to='oauthost.Scope', null=True, verbose_name='Scopes', blank=True), preserve_default=True),
     migrations.AddField(model_name='authorizationcode', name='user', field=models.ForeignKey(verbose_name='User', to=settings.AUTH_USER_MODEL, help_text='The user authorization is granted for.', on_delete=models.CASCADE), preserve_default=True)]