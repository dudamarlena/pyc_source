...
# Compiled at: 2015-08-02 00:01:47
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='RedirectionEndpoint', fields=[
      ...
      (
       'client', models.ForeignKey(related_name='redirection_uris', verbose_name='Client', to='oauthost.Client'))], options={'verbose_name': 'Redirection Endpoint', 
     ...
     migrations.CreateModel(name='Scope', fields=[
      ...
      (
       'status', models.PositiveIntegerField(default=1, db_index=True, verbose_name='Status', choices=[(1, 'Enabled'), (2, 'Disabled')]))], options={'ordering': ['title'], 
      'verbose_name': 'Scope', 
     ...
     migrations.CreateModel(name='Token', fields=[
      ...
      (
       'user', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, help_text='The user token is issued for.', null=True, verbose_name='User'))], options={'verbose_name': 'Token', 
     ...
     migrations.AddField(model_name='client', name='user', field=models.ForeignKey(verbose_name='Registrant', to=settings.AUTH_USER_MODEL, help_text='User who registered this client.'), preserve_default=True),
     migrations.AddField(model_name='authorizationcode', name='client', field=models.ForeignKey(verbose_name='Client', to='oauthost.Client', help_text='The client authorization is granted for.'), preserve_default=True),
     ...
     migrations.AddField(model_name='authorizationcode', name='user', field=models.ForeignKey(verbose_name='User', to=settings.AUTH_USER_MODEL, help_text='The user authorization is granted for.'), preserve_default=True)]