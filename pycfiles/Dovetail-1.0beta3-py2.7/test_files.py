...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/dovetail/directives/test_files.py
# Compiled at: 2012-08-01 06:15:49
...
class TestFiles(object):
    ...
    def test_newer(self):
        n = Newer(Glob(path.join(BASE, '*', '*.txt')), Glob(path.join(BASE, '*', '*.bin')))
        print n
