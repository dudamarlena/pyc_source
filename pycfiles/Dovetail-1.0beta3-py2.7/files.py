...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/dovetail/directives/files.py
...
class Glob(object):
    r"""A Container Object wrapper for glob.iglob.
    ...
    def best(file_iterator, newer=True):
        ...
        for file_name in file_iterator:
            try:
                ...
                if best is None or newer and current > best or not newer and current < best:
                    best = current
            except os.error:
                if not warned:
