...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/dovetail/util/logging.py
...
class Message(object):
    r"""A log message capturing a piece of information about the execution of Dovetail.
    ...
    def _write_raw(out, indent, level, message):
        ...
        for line in message.splitlines(True):
            if indent and Logger._nested:
                assert out is Logger._out_raw and level < LEVEL.ERROR or out is Logger._err_raw and level == LEVEL.ERROR
