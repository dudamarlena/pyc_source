...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fundamentals/mysql/database.py
...
import readline, glob, pickle, time
    ...
    **Usage**
    ...
    def connect(self):
        ...
        **Return**
        ...
        dbConn = ms.connect(host=host, user=user, passwd=passwd, db=dbName, port=port, use_unicode=True, charset='utf8mb4', local_infile=1, client_flag=ms.constants.CLIENT.MULTI_STATEMENTS, connect_timeout=36000, max_allowed_packet=51200000)
        if self.autocommit:
