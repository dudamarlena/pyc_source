...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fundamentals/mysql/tests/test_get_database_table_column_names.py
...
class test_get_database_table_column_names(unittest.TestCase):
    ...
    def test_get_database_table_column_names_function(self):
        ...
        columnNames = get_database_table_column_names(dbConn=dbConn, log=log, dbTable='testing_table')