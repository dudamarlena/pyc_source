...
# Embedded file name: ZSI/writer.py
# Compiled at: 2018-06-29 21:47:06
__doc__ = 'SOAP message serialization.\n'
...
_standard_ns = [
 (
  'xml', XMLNS.XML), ('xmlns', XMLNS.BASE)]
_reserved_ns = {'SOAP-ENV': SOAP.ENV, 
   'SOAP-ENC': SOAP.ENC, 
   'ZSI': ZSI_SCHEMA_URI, 
   'xsd': SCHEMA.BASE, 
...
class SoapWriter:
    ...
    def __init__(self, envelope=True, encodingStyle=None, header=True, nsdict={}, outputclass=None, **kw):
        ...
        self.dom, self.memo, self.nsdict = outputclass(self), [], nsdict
