...
# Embedded file name: ZSI/parse.py
# Compiled at: 2018-06-29 21:47:06
__doc__ = 'SOAP messaging parsing.\n'
...
class ParsedSoap():
    ...
    def GetMyHeaderElements(self, actorlist=None):
        ...
        if actorlist is None:
            actorlist = [
             None, SOAP.ACTOR_NEXT]
        else:
            actorlist = list(actorlist) + [None, SOAP.ACTOR_NEXT]
        return [ E for E in self.header_elements if _find_actor(E) in actorlist
               ]
    ...
    def WhatMustIUnderstand(self):
        ...
        """
        return [ (E.namespaceURI, E.localName) for E in self.header_elements if _find_mu(E) == '1'
               ]
