...
# Embedded file name: ZSI/TCnumbers.py
# Compiled at: 2018-06-29 21:47:06
__doc__ = 'Typecodes for numbers.\n'
import types
...
class InonPositiveInteger(Integer):
    ...
    """
    type = (
     SCHEMA.XSD3, 'nonPositiveInteger')
...
class InonNegativeInteger(Integer):
    ...
    """
    type = (
     SCHEMA.XSD3, 'nonNegativeInteger')
