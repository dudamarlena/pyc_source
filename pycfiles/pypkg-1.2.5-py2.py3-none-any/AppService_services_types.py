...
# Embedded file name: AppService_services_types.py
...
class nbcr_sdsc_edu_opal_types():
    ...
    class InputFileType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._contents = None
            TClist = [
             ZSI.TC.String(pname='name', aname='_name'), ZSI.TC.Base64String(pname='contents', aname='_contents')]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
                ...
                aname = None
            ZSI.TCcompound.Struct.__init__(self, self.__class__, TClist, pname=name, inorder=0, aname=aname, oname=oname, **kw)
            return
    ...
    class FaultType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            self._message = None
            TClist = [
             ZSI.TC.String(pname='message', aname='_message', optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class FlagsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._textDesc = None
            TClist = [
             ZSI.TC.String(pname='id', aname='_id'), ZSI.TC.String(pname='tag', aname='_tag'), ZSI.TC.String(pname='textDesc', aname='_textDesc', optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class ParamsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            if name:
                ...
                aname = None
            ZSI.TCcompound.Struct.__init__(self, self.__class__, TClist, pname=name, inorder=0, aname=aname, oname=oname, hasextras=1, **kw)
            return
    ...
    class OutputFileType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._url = None
            TClist = [
             ZSI.TC.String(pname='name', aname='_name'), ZSI.TC.URI(pname='url', aname='_url')]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class StatusOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._baseURL = None
            TClist = [
             ZSI.TCnumbers.Iint(pname='code', aname='_code'), ZSI.TC.String(pname='message', aname='_message'), ZSI.TC.URI(pname='baseURL', aname='_baseURL')]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class OutputsByNameInputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._fileName = None
            TClist = [
             ZSI.TC.String(pname='jobID', aname='_jobID'), ZSI.TC.String(pname='fileName', aname='_fileName')]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class getOutputAsBase64ByNameOutput_Dec(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._item = None
            TClist = [
             ZSI.TCnumbers.Ibyte(pname='item', aname='_item', repeatable=1, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class JobInputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
             ZSI.TC.String(pname='argList', aname='_argList', optional=1), ZSI.TCnumbers.Iint(pname='numProcs', aname='_numProcs', optional=1), ns1.InputFileType_Def(name='inputFile', ns=ns, repeatable=1, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class FlagsArrayType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            self._flag = None
            TClist = [
             ns1.FlagsType_Def(name='flag', ns=ns, repeatable=1, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class ImplicitParamsArrayType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            self._param = None
            TClist = [
             ns1.ImplicitParamsType_Def(name='param', ns=ns, repeatable=1, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class ParamsArrayType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._param = None
            TClist = [
             ZSI.TC.String(pname='separator', aname='_separator', optional=1), ns1.ParamsType_Def(name='param', ns=ns, repeatable=1, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class JobOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
             ZSI.TC.URI(pname='stdOut', aname='_stdOut', optional=1), ZSI.TC.URI(pname='stdErr', aname='_stdErr', optional=1), ns1.OutputFileType_Def(name='outputFile', ns=ns, repeatable=1, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class JobSubOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._status = None
            TClist = [
             ZSI.TC.String(pname='jobID', aname='_jobID'), ns1.StatusOutputType_Def(name='status', ns=ns)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class ArgumentsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
             ns1.FlagsArrayType_Def(name='flags', ns=ns, optional=1), ns1.ParamsArrayType_Def(name='taggedParams', ns=ns, optional=1), ns1.ParamsArrayType_Def(name='untaggedParams', ns=ns, optional=1), ns1.ImplicitParamsArrayType_Def(name='implicitParams', ns=ns, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class BlockingOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._jobOut = None
            TClist = [
             ns1.StatusOutputType_Def(name='status', ns=ns), ns1.JobOutputType_Def(name='jobOut', ns=ns)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class AppMetadataType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._types = None
            TClist = [
             ZSI.TC.String(pname='usage', aname='_usage'), ZSI.TC.String(pname='info', aname='_info', repeatable=1, optional=1), ns1.ArgumentsType_Def(name='types', ns=ns, optional=1)]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
    ...
    class AppConfigType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            self._parallel = None
            TClist = [
             ns1.AppMetadataType_Def(name='metadata', ns=ns), ZSI.TC.String(pname='binaryLocation', aname='_binaryLocation'), ZSI.TC.String(pname='defaultArgs', aname='_defaultArgs', optional=1), ZSI.TC.Boolean(pname='parallel', aname='_parallel')]
            oname = name
            if name:
                aname = '_%s' % name
                if ns:
