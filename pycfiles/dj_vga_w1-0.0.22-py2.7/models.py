...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dpl1_main/testing_app/models.py
...
class Test(models.Model):
    ...
    def get_last_page_for(cls, test_id):
        ...
        :param test_id:
        """
        ordered_pages = Test.objects.get(id=test_id).page_set.order_by('-sequence')
...
class Page(models.Model):
    ...
    def __str__(self):
        return ('{0:s} - Page {1:d}').format(self.test, self.sequence)
...
class Question(models.Model):
    ...
    def __str__(self):
        return ('{0:s} - Question : {1:s}').format(self.page, self.text)
