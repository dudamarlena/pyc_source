...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/borg/supergroup/plugin.py
# Compiled at: 2008-04-05 13:36:00
...
manage_addSuperGroupProviderForm = PageTemplateFile('zmi/addSuperGroupProviderForm.pt', globals(), __name__='manage_addSuperGroupProviderForm')
...
def manage_addSuperGroupProvider(dispatcher, id, title=None, REQUEST=None):
    ...
    if REQUEST is not None:
        REQUEST.RESPONSE.redirect('%s/manage_workspace?manage_tabs_message=Super+group+provider+added.' % dispatcher.absolute_url())
    return
