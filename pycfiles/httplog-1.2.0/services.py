...
# [GCC 8.4.0]
# Embedded file name: E:\cd2\env\lib\site-packages\httplog\services.py
# Compiled at: 2016-11-29 02:52:07
from __future__ import absolute_import
import json, re, decisionTable
...
def get_httplog_data(request, request_body, response, permitted_url=None):
    return {'name': get_httplog_name(request, permitted_url), 
