...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/hydro/common/configurator.py
...
class Configurator(object):
    ...
    OPTIMIZER_STATISTICS = {ALL: {'AVG_VALUES_PER_DAY': None, 'AVG_RECORDS_PER_DAY': None, 
