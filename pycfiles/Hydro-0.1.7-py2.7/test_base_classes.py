...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/test/hydro/test_base_classes.py
# Compiled at: 2016-03-22 15:09:41
import unittest, os, inspect
from hydro.base_classes import HydroStr, HydroDatetime, Base, HydroCommandTemplate, HydroDatetime, HydroList, PlanObject, Configurator, HydroDataframe
from pandas import DataFrame as df
from datetime import datetime
__author__ = 'yanivshalev'

class BaseClassesTest(unittest.TestCase):
    params = {'FROM_DATE': '2014-07-01', 
       'TO_DATE': '2014-07-31', 
       'CLIENT_ID': 'some_client', 
       'OBJECT_TYPES': [
                      'obj1', 'obj2']}
    conf = Configurator.config_builder()
    conf.PLAN_ALLOWED_PARAMETERS = {'CLIENT_ID': {'type': HydroStr}, 'FROM_DATE': {'type': HydroDatetime}, 'TO_DATE': {'type': HydroDatetime}, 'OBJECT_TYPES': {'type': HydroList, 'optional': True}}
