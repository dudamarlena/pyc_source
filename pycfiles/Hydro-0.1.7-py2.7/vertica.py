...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/hydro/connectors/vertica.py
# Compiled at: 2015-10-08 07:16:05
...
if __name__ == '__main__':
    params = {'source_type': 'vertica', 'connection_type': 'dsn', 
