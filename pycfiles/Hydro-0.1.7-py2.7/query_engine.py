...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/hydro/query_engine.py
# Compiled at: 2015-10-06 06:45:17
...
class QueryEngine(Base):
    ...
    def __init__(self, modules_dir, connection_handler, cache_engine, execution_plan, logger):
        ...
        optimizer_class = getattr(__import__('%s.optimizer' % self._modules_dir, fromlist=[optimizer_class_name]), optimizer_class_name)
