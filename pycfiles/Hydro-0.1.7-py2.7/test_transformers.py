...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/test/hydro/test_transformers.py
# Compiled at: 2016-03-22 11:40:36
import unittest
...
class TransformersTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_result_2 = DataFrame({'id': ['1', '2'], 'name': ['try1', 'try2'], 'full_name': [
                       'full_try1', nan]})[['id', 'name', 'full_name']]
        self.test_result_3 = DataFrame({'id': ['1', '3'], 'name': ['try1', nan], 'full_name': [
                       'full_try1', 'full_try3']})[['id', 'name', 'full_name']]
        self.test_result_4 = DataFrame({'id': ['1'], 'full_name_left_side': ['try1'], 'full_name_right_side': [
                                  'full_try1']})[['full_name_left_side', 'id',
    ...
    def test_combine(self):
        ...
        comb_res4 = self.transformer.combine(self.test_df_3, self.test_df_2, 'id', 'id', suffixes=('_left_side',
                                                                                                   '_right_side'))
