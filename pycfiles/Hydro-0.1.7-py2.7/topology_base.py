...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/hydro/topology_base.py
...
class Topology(Base):
    ...
    def __init__(self, cache_engine=Configurator.CACHE_ENGINE_IN_MEMORY, base_dir=None, cls=None, logger=None):
        ...
        self.logger.debug(('Topology {0} was instantiated, modules_dir: {1}, templates_dir: {2}').format(type(self).__name__, self._modules_dir, self._templates_dir))
