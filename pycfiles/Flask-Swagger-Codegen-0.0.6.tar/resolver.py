...
# [GCC 8.4.0]
# Embedded file name: /Users/rejown/Development/Project/flask_restful_swagger_codegen/flask_swagger_codegen/resolver.py
# Compiled at: 2015-04-17 02:36:34
import re
from collections import OrderedDict
import operator
from .model import SwaggerFlaskModel, Schema, Field, Resource, Method, ResponseFilter, Validator
...
class FieldResolver(object):
    ...
    format_map = {'int32': 'Integer', 
       ...
       'url': 'Url', 
       'email': 'Email'}
    common_attrs_map = {'default': 'default', 
       'required': 'required'}
    ...
    def _process_schema(self, location, params):
        ...
        for p in params:
            if 'schema' in p:
                ...
                return Validator(self.parent.parent.schemas[schema], many)
            data['properties'][p['name']] = {c:p[c] for c in common if c in p}
