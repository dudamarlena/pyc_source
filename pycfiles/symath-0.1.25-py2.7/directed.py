...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/symath/graph/directed.py
# Compiled at: 2015-08-21 12:09:07
from collections import deque
import copy, scipy.sparse as sparse, symath.datastructures
...
class DirectedGraph(object):
    ...
    def get_edge_color(self, f, t):
        k = (
         f, t)
        if k not in self.edge_colors:
            return 'black'
        return self.edge_colors[k]
