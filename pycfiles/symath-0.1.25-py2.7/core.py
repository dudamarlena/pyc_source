...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/symath/core.py
# Compiled at: 2015-12-07 14:12:28
import traceback, types, copy, operator, random, string
