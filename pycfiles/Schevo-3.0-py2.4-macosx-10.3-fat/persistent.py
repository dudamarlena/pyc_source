...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/schevo/store/persistent.py
# Compiled at: 2007-03-21 14:34:41
"""
$URL: svn+ssh://svn/repos/trunk/durus/persistent.py $
$Id: persistent.py 2633 2006-10-10 15:35:33Z mscott $
"""
import sys
...
try:
    ...
    _GHOST_SAFE_ATTRIBUTES = {'__repr__': 1, '__class__': 1, '__setstate__': 1}
    ...
    class PersistentBase(object):
        ...
        __module__ = __name__
        __slots__ = [
         '_p_status', '_p_serial', '_p_connection', '_p_oid']
...
class Persistent(PersistentBase):
    ...
    _p_changed = property(lambda self: self._p_status == UNSAVED, lambda self, value: value and self._p_note_change())
