...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/schevo/store/btree.py
# Compiled at: 2007-03-21 14:34:41
"""
$URL: svn+ssh://svn/repos/trunk/durus/btree.py $
$Id: btree.py 2633 2006-10-10 15:35:33Z mscott $
"""
import sys
            ...
            if matches:
                ...
                if not is_big(node):
                    if is_big(lower_sibling):
                        ...
                        node.items = lower_sibling.items + [self.items[(p - 1)]] + node.items
                        if not node.is_leaf():
