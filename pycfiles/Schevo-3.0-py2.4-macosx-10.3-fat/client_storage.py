...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/schevo/store/client_storage.py
# Compiled at: 2007-03-21 14:34:41
"""$URL: svn+ssh://svn/repos/trunk/durus/client_storage.py $
$Id: client_storage.py 28318 2006-05-02 19:01:20Z rmasse $
"""
import socket
from schevo.store.error import DurusKeyError, ProtocolError
from schevo.store.error import ReadConflictError, ConflictError
from schevo.store.serialize import split_oids
from schevo.store.storage import Storage
from schevo.store.storage_server import DEFAULT_PORT, DEFAULT_HOST, recv
from schevo.store.storage_server import SocketAddress, StorageServer
from schevo.store.storage_server import STATUS_OKAY, STATUS_KEYERROR, STATUS_INVALID
