...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/schevo/store/tests/stress.py
# Compiled at: 2007-03-21 14:34:40
...
def main():
    ...
    parser.add_option('--cache_size', dest='cache_size', default=4000, type='int', help='Size of client cache (default=4000)')
    parser.add_option('--max-loops', dest='loops', default=10, type='int', help='Maximum number of loops before exiting.')
