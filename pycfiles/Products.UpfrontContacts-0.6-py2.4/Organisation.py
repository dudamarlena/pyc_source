...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Products/UpfrontContacts/Organisation.py
...
class Organisation(BaseFolder):
    ...
    security.declareProtected(permissions.View, 'getPhysicalAddressAsString')
