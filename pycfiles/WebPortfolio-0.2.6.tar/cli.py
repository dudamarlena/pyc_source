...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/web-portfolio/webportfolio/cli.py
...
"""
import os, re, sys, logging, importlib, pkg_resources, utils, __about__, click
CWD = os.getcwd()
...
def create_project(project_name, template='app'):
    ...
    files = [('%s/__init__.py' % APPLICATION_DIR, '# WebPortfolio'),
     (
