...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/web-portfolio/webportfolio/decorators.py
# Compiled at: 2015-11-03 12:47:55
...
def nav_menu_add(name, module_, class_, method_=None, is_class_=False, **kwargs):
    ...
    :return:
    """
    _push_nav_menu(module_=module_, class_=class_, method_=method_, is_class_=is_class_, name=name, **kwargs)
...
def _push_nav_menu(**kwargs):
    ...
    if path not in _NAV_MENU_STACK:
        _NAV_MENU_STACK[path] = {'name': None, 'endpoint': None, 
