...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/web-portfolio/webportfolio/core.py
# Compiled at: 2015-11-03 12:54:46
"""
WebPortfolio

"""
import re, os, sys, inspect, datetime, functools, logging, logging.config, utils
...
class WebPortfolio(FlaskView):
    ...
    _global = dict(WEBPORTFOLIO_NAME=NAME, WEBPORTFOLIO_VERSION=__version__, YEAR=datetime.datetime.now().year, PAGE_META=_default_page_meta)
