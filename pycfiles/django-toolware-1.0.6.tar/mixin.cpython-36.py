...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/4f/p6rdjlq11nz2jwrtdlm918l40000gn/T/pip-install-o463eux1/django-toolware/toolware/utils/mixin.py
...
class StaffRequiredMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        if request.user.is_staff:
            ...
            messages.error(request, 'user lacks sufficient permissions to perform the requested operation')
