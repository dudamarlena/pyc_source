...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/ease_restapi/service/base.py
# Compiled at: 2015-01-25 06:15:54
"""ring info remote api interface base.
"""
__author__ = 'kylinfish@126.com'
__date__ = '2014/09/20'
import os, time, json, random, os.path, requests, six
if six.PY3:
...
def http_result(r):
    ...
    if config.REST_API_DEBUG:
        error_log = {'method': r.request.method, 'url': r.request.url, 
