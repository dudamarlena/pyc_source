...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/ease_restapi/service/ease_msgdata.py
...
class MessageData(object):
    ...
    def __init__(self, target, target_type='users', username=None, **args):
        ...
        """
        self._dict_data = {'target_type': target_type, 
           'target': target, 
           'msg': {'type': 'txt'}, 
           'from': username, 
           'ext': args}
...
class MessageTxtData(MessageData):
    ...
    def __init__(self, message, target, target_type='users', username=None, **args):
        u"""
            :param message: 消息内容.
        """
...
class MessageImgData(MessageData):
    ...
    def __init__(self, url, filename, secret, target, target_type='users', username=None, **args):
        u"""
...
class MessageAudioData(MessageData):
    ...
    def __init__(self, url, filename, length, secret, target, target_type='users', username=None, **args):
        u"""
            :param url: 成功上传文件返回的uuid
            :param filename: 指定一个文件名
            :param length:  默认10
...
class MessageVideoData(MessageData):
    ...
    def __init__(self, filename, thumb, length, secret, file_length, thumb_secret, url, target, target_type='users', username=None, **args):
        u"""
