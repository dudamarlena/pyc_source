...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tikon\Matemáticas\Distribuciones.py
# Compiled at: 2017-09-12 13:17:16
# Size of source mod 2**32: 23801 bytes
import math as mat, numpy as np, pymc3 as pm3, scipy.stats as estad
from pymc import Beta, Cauchy, Chi2, Degenerate, Exponential, Exponweib, Gamma, HalfCauchy, HalfNormal, InverseGamma, Laplace, Logistic, Lognormal, Normal, Pareto, T, Uniform, VonMises, Bernoulli, Binomial, Geometric, Hypergeometric, NegativeBinomial, Poisson, DiscreteUniform, TruncatedNormal, Weibull
inf = np.inf
pi = mat.pi
