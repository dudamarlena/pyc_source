...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/tools.py
...
def escape(value):
    return as_unicode(value).replace(CHAR_ESCAPE, CHAR_ESCAPE + CHAR_ESCAPE).replace(CHAR_SEPARATOR, CHAR_ESCAPE + CHAR_SEPARATOR)
