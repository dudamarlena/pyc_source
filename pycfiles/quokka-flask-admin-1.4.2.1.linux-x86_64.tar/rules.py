...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/form/rules.py
...
class Macro(BaseRule):
    ...
    def _resolve(self, context, name):
        ...
        try:
            ...
            raise Exception('Your template is missing "{% set render_ctx = h.resolve_ctx() %}"')
