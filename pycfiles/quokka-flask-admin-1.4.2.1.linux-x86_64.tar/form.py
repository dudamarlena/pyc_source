...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/model/form.py
...
class InlineBaseFormAdmin(object):
    ...
    """
    _defaults = [
     'form_base_class', 'form_columns', 'form_excluded_columns', 'form_args', 'form_extra_fields']
