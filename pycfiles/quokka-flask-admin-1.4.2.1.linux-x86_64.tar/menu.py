...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/menu.py
...
class MenuView(BaseMenu):
    ...
    def __init__(self, name, view=None, cache=True):
        super(MenuView, self).__init__(name, class_name=view.menu_class_name, icon_type=view.menu_icon_type, icon_value=view.menu_icon_value)
        self._view = view
        self._cache = cache
