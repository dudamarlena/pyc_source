...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/model/fields.py
...
class InlineFieldList(FieldList):
    ...
    def __call__(self, **kwargs):
        ...
        return self.widget(self, template=template, check=self.display_row_controls, **kwargs)
