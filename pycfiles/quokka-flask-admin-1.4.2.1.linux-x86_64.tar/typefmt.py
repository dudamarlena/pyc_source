...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/model/typefmt.py
...
BASE_FORMATTERS = {type(None): empty_formatter, 
   bool: bool_formatter, 
   list: list_formatter, 
   dict: dict_formatter}
EXPORT_FORMATTERS = {type(None): empty_formatter, 
   list: list_formatter, 
   dict: dict_formatter}
if Enum is not None:
