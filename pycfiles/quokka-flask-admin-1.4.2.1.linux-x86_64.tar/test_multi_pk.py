...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/tests/sqla/test_multi_pk.py
...
def test_concrete_multipk_inheritance():
    ...
    rv = client.get('/admin/child/')
    eq_(rv.status_code, 200)
    rv = client.post('/admin/child/new/', data=dict(id=1, id2=2, test='foo', name='bar'))
    eq_(rv.status_code, 302)
