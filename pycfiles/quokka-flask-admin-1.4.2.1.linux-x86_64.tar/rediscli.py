...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/contrib/rediscli.py
# Compiled at: 2016-06-26 14:14:34
import logging, shlex, warnings
...
class RedisCli(BaseView):
    ...
    def __init__(self, redis, name=None, category=None, endpoint=None, url=None):
        ...
        if self.shlex_check and VER < (2, 7, 3):
            warnings.warn('Warning: rediscli uses shlex library and it does not work with unicode until Python 2.7.3. ' + 'To remove this warning, upgrade to Python 2.7.3 or suppress it by setting shlex_check attribute ' + 'to False.')
