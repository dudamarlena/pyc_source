...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/tests/test_model.py
...
class MockModelView(base.BaseModelView):
    ...
    def __init__(self, model, data=None, name=None, category=None, endpoint=None, url=None, **kwargs):
...
def test_mockview():
    ...
    eq_(rv.status_code, 200)
    rv = client.post('/admin/model/new/', data=dict(col1='test1', col2='test2', col3='test3'))
    ...
    ok_('test1' in data)
    rv = client.post('/admin/model/edit/?id=3', data=dict(col1='test!', col2='test@', col3='test#'))
    eq_(rv.status_code, 302)
    ...
    app_iter, status, headers = dispatched_client.post('/dispatched/admin/model/edit/?id=3', data=dict(col1='another test!', col2='test@', col3='test#', _continue_editing='True'))
...
def test_list_columns():
    app, admin = setup()
    view = MockModelView(Model, column_list=[
     'col1', 'col3'], column_labels=dict(col1='Column1'))
    admin.add_view(view)
...
def test_column_filters():
    ...
    eq_([ (f['index'], f['operation']) for f in view._filter_groups['col1'] ], [(0, 'test')])
    eq_([ (f['index'], f['operation']) for f in view._filter_groups['col2'] ], [(1, 'test')])
...
def test_csrf():
    ...
    eq_(rv.status_code, 200)
    ok_('name="csrf_token"' in rv.data.decode('utf-8'))
    ...
    eq_(rv.status_code, 200)
    ok_('Record was successfully deleted.' not in rv.data.decode('utf-8'))
    ok_('Failed to delete record.' in rv.data.decode('utf-8'))
    rv = client.post('/admin/secure/delete/', data=dict(id='1', url='/admin/secure/', csrf_token=csrf_token), follow_redirects=True)
    eq_(rv.status_code, 200)
    ok_('Record was successfully deleted.' in rv.data.decode('utf-8'))
...
def test_export_csv():
    ...
    eq_(rv.status_code, 302)
    view_data = {1: Model(1, 'col1_1', 'col2_1'), 
       2: Model(2, 'col1_2', 'col2_2'), 
       3: Model(3, 'col1_3', 'col2_3')}
    view = MockModelView(Model, view_data, can_export=True, column_list=[
     'col1', 'col2'])
    admin.add_view(view)
    ...
    ok_('Col1,Col2\r\ncol1_1,col2_1\r\ncol1_2,col2_2\r\ncol1_3,col2_3\r\n' == data)
    view = MockModelView(Model, view_data, can_export=True, column_list=[
     'col1', 'col2'], column_export_list=[
     'id', 'col1', 'col2'], endpoint='exportinclusion')
    admin.add_view(view)
    ...
    ok_('Id,Col1,Col2\r\n1,col1_1,col2_1\r\n2,col1_2,col2_2\r\n3,col1_3,col2_3\r\n' == data)
    view = MockModelView(Model, view_data, can_export=True, column_list=[
     'col1', 'col2'], column_export_exclude_list=[
     'col2'], endpoint='exportexclusion')
    admin.add_view(view)
    ...
    eq_(rv.status_code, 200)
    ok_('Col1\r\ncol1_1\r\ncol1_2\r\ncol1_3\r\n' == data)
    view_data[4] = Model(1, '–ut8_1–', '–utf8_2–')
    view = MockModelView(Model, view_data, can_export=True, column_list=[
     'col1', 'col2'], endpoint='utf8')
    admin.add_view(view)
    rv = client.get('/admin/utf8/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_('–ut8_1–,–utf8_2–\r\n' in data)
    view_data = {1: Model(1, 'col1_1', 1), 
       2: Model(2, 'col1_2', 2), 
       3: Model(3, None, 3)}
    view = MockModelView(Model, view_data, can_export=True, column_list=['col1', 'col2'], column_labels={'col1': 'Str Field', 'col2': 'Int Field'}, column_formatters=dict(col2=lambda v, c, m, p: m.col2 * 2), endpoint='types_and_formatters')
    admin.add_view(view)
    ...
    view = MockModelView(Model, view_data, can_export=True, column_list=['col1', 'col2'], column_formatters_export=dict(col2=lambda v, c, m, p: m.col2 * 3), column_formatters=dict(col2=lambda v, c, m, p: m.col2 * 2), column_type_formatters_export=type_formatters, endpoint='export_types_and_formatters')
    admin.add_view(view)
    rv = client.get('/admin/export_types_and_formatters/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_('Col1,Col2\r\ncol1_1,3\r\ncol1_2,6\r\nnull,9\r\n' == data)
    view = MockModelView(Model, can_export=True, column_list=['col1', 'col2'], column_formatters=dict(col1=macro('render_macro')), endpoint='macro_exception')
    admin.add_view(view)
    ...
    view = MockModelView(Model, view_data, can_export=True, column_list=['col1', 'col2'], column_formatters=dict(col1=macro('render_macro')), column_formatters_export=dict(col1=export_formatter), endpoint='macro_exception_formatter_override')
    admin.add_view(view)
    rv = client.get('/admin/macro_exception_formatter_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_('Col1,Col2\r\ncol1_1,1\r\ncol1_2,2\r\n,3\r\n' == data)
    view = MockModelView(Model, view_data, can_export=True, column_list=['col1', 'col2'], column_formatters=dict(col1=macro('render_macro')), column_export_exclude_list=[
     'col1'], endpoint='macro_exception_exclude_override')
    admin.add_view(view)
    rv = client.get('/admin/macro_exception_exclude_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_('Col2\r\n1\r\n2\r\n3\r\n' == data)
    view = MockModelView(Model, view_data, can_export=True, column_list=['col1', 'col2'], column_formatters=dict(col1=macro('render_macro')), column_export_list=[
     'col2'], endpoint='macro_exception_list_override')
    admin.add_view(view)
    rv = client.get('/admin/macro_exception_list_override/export/csv/')
    data = rv.data.decode('utf-8')
    eq_(rv.status_code, 200)
    ok_('Col2\r\n1\r\n2\r\n3\r\n' == data)
    view = MockModelView(Model, view_data, can_export=True, column_list=['col1', 'col2'], column_formatters=dict(col1=macro('render_macro')), endpoint='macro_exception_macro_override')
    admin.add_view(view)
...
def test_list_row_actions():
    ...
    eq_(rv.status_code, 200)
    view = MockModelView(Model, endpoint='test2', can_view_details=True, details_modal=True, edit_modal=True)
    admin.add_view(view)
    actions = view.get_list_row_actions()
    ...
    eq_(rv.status_code, 200)
    view = MockModelView(Model, endpoint='test3', column_extra_row_actions=[
