...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/flask_admin/model/widgets.py
...
class XEditableWidget(object):
    ...
    def __call__(self, field, **kwargs):
        ...
        return HTMLString('<a %s>%s</a>' % (html_params(**kwargs),
    ...
    def get_kwargs(self, field, kwargs):
        ...
        if field.type == 'StringField':
            ...
            kwargs['data-source'] = json.dumps([{'value': '', 'text': gettext('No')}, {'value': '1', 'text': gettext('Yes')}])
        ...
        elif field.type in ('QuerySelectField', 'ModelSelectField', 'QuerySelectMultipleField'):
            kwargs['data-type'] = 'select'
            choices = []
            selected_ids = []
