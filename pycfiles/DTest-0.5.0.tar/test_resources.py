...
# [GCC 8.4.0]
# Embedded file name: /home/klmitch/devel/src/dtest/tests/test_resources.py
# Compiled at: 2011-10-25 16:17:44
from dtest import *
...
@require(test1=ResourceTest('foo', 'bar'), test2=ResourceTest('bar', 'foo'))
