...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/libaskocli/actions/integrate.py
# Compiled at: 2018-11-21 03:51:21
...
class Integrate(object):
    __doc__ = 'Integrate a CSV/TSV file into a distant AskOmics'
    ...
    def run(self, args):
        ...
        if ext in ('.gff', '.gff2', '.gff3') or args.file_type == 'gff':
            ...
            if ext == '.ttl' or args.file_type == 'ttl':
                api.integrate_ttl()
            else:
                if ext in ('.bed', ) or args.file_type == 'bed':
