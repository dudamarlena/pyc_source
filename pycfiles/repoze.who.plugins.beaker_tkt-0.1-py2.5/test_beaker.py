...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/repoze/who/plugins/test_beaker.py
# Compiled at: 2009-04-18 14:01:24
...
class FixtureBase(Base):
    ...
    def setUp(self):
        ...
        self.app = TestApp(app, extra_environ={'REMOTE_ADDR': '127.0.0.1', 
           'repoze.who.logger': DummyLogger()}).get('/')
        self.session_app = TestApp(SessionMiddleware(app), extra_environ={'REMOTE_ADDR': '127.0.0.1', 
           'repoze.who.logger': DummyLogger()}).get('/')
