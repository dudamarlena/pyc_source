...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/repoze/who/plugins/beaker_tkt.py
# Compiled at: 2009-04-19 11:31:25
import os
...
class BeakerAuthTktPlugin(object):
    ...
    def __init__(self, key_name='repoze.who.tkt', session_name='beaker.session'):
