...
# Embedded file name: /Users/mdiazmel/code/aramis/clinica/clinica/iotools/converters/oasis_to_bids/oasis_to_bids.py
...
class OasisToBids(Converter):
    ...
    def convert_clinical_data(self, clinical_data_dir, bids_dir):
        ...
        clinic_specs_path = path.join(iotools_folder, 'data', 'clinical_specifications.xlsx')
    ...
    def convert_images(self, source_dir, dest_dir):
        ...
        def convert_single_subject(subj_folder):
            ...
            subprocess.run(('mri_convert ' + img_file_path + ' ' + output_path), shell=True,
