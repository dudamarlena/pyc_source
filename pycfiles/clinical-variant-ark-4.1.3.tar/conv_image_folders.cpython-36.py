...
# Embedded file name: /Users/mdiazmel/code/aramis/clinica/clinica/iotools/converters/nifd_to_bids/utils/conv_image_folders.py
...
def dict_conversion(medical_images, descriptors):
    ...
    for med_name in medical_images:
        ...
        if old_name.new_name:
            equivalences[old_name.old_name] = (
             desc, old_name.bids_info)
