...
# Embedded file name: /Users/mdiazmel/code/aramis/clinica/clinica/iotools/converters/adni_to_bids/adni_to_bids.py
# Compiled at: 2019-10-10 04:46:11
# Size of source mod 2**32: 6699 bytes
...
class AdniToBids(Converter):
    ...
    def check_adni_dependencies(self):
        ...
        for binary in list_binaries:
            if not is_binary_present(binary):
                raise RuntimeError('%s is not present in your PATH environment.' % binary)
    ...
    def convert_clinical_data(self, clinical_data_dir, out_path):
        ...
        """
        from os import path
        import os, pandas as pd, clinica.iotools.bids_utils as bids
        from clinica.utils.stream import cprint
        import clinica.iotools.converters.adni_to_bids.adni_utils as adni_utils
        clinic_specs_path = path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'data', 'clinical_specifications_adni.xlsx')
        try:
    ...
    def convert_images(self, source_dir, clinical_dir, dest_dir, subjs_list_path=None, modalities=[
 'T1', 'PET_FDG', 'PET_AMYLOID', 'PET_TAU', 'DWI', 'FLAIR']):
        """
        ...
        import pandas as pd
        from clinica.utils.stream import cprint
        import clinica.iotools.converters.adni_to_bids.adni_modalities.adni_t1 as adni_t1, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_fdg_pet as adni_fdg, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_pib_pet as adni_pib, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_av45_fbb_pet as adni_av45_fbb, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_tau_pet as adni_tau, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_dwi as adni_dwi, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_flair as adni_flair, clinica.iotools.converters.adni_to_bids.adni_modalities.adni_fmri as adni_fmri
