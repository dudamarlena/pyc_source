...
# Embedded file name: build/bdist.linux-x86_64/egg/coscmd/cos_comm.py
# Compiled at: 2020-04-17 04:18:41
...
maplist = {'x-cos-copy-source-If-Modified-Since': 'CopySourceIfModifiedSince', 
...
def response_info(rt):
    ...
    return ('Error: [code {code}] {message}\nRequestId: {request_id}').format(code=code, message=message, request_id=to_printable_str(request_id))
...
def change_to_human(_size):
    ...
    res = ''
    if s > 1073741824:
        res = str(round(1.0 * s / 1073741824, 1)) + 'G'
    elif s > 1048576:
        res = str(round(1.0 * s / 1048576, 1)) + 'M'
    elif s > 1024:
