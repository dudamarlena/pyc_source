...
# [GCC 8.4.0]
# Embedded file name: /Users/sam/Documents/fall17/mathviz/mathviz_hopper/src/table.py
# Compiled at: 2017-11-29 12:30:18
"""
Author: Sam Helms
...
"""
import shutil, os, sys, threading, re
...
class Table:
    ...
    def _create_settings(self):
        ...
        """
        self.settings = {'columns': [ {'Header': s, 'accessor': s} for s in self.settings ], 'port': self.port, 
