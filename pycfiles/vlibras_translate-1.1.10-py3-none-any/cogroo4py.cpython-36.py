...
# [GCC 8.4.0]
# Embedded file name: /media/caiomoraes/Acer/Users/CaioMoraes/Documents/computacaoUFPB/TCC/pacote_vlibras/vlibras_translate/cogroo4py/cogroo4py.py
# Compiled at: 2019-11-09 11:18:21
# Size of source mod 2**32: 13383 bytes
"""
...
os.environ['CLASSPATH'] = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cogroo4py.jar')
    ...
    def lemmatize(self, text):
        ...
        if doc is None:
            ...
            for sentence in doc.sentences:
                if sentence.paragraph > last_paragraph:
                    if last_paragraph != -1:
                        ret.append('\n')
                for token in sentence.tokens:
