...
# Embedded file name: /home/tiziano/Development/StarterSquad/prudentia/prudentia/digital_ocean.py
# Compiled at: 2019-02-10 12:34:50
# Size of source mod 2**32: 10308 bytes
import time
...
class DigitalOceanProvider(FactoryProvider):
    NAME = 'digital-ocean'
    DEFAULT_IMAGE_SLUG = 'ubuntu-14-04-x64'
    ...
    def _input_general_env_conf(self):
        ...
        print("If you don't have it please visit https://cloud.digitalocean.com/settings/applications and generate one.")
    ...
    def define_box(self):
        ...
        if io.input_yes_no('register an existing droplet'):
            ...
            default_image = next((img for img in all_images if img['slug'] and self.DEFAULT_IMAGE_SLUG in img['slug']), None)
            if default_image:
    ...
    def create(self, box):
        ...
        if not ext.id:
            ...
            droplet = self.manager.new_droplet(name=box.name, size_id=ext.size, image_id=ext.image, region_id=ext.region, ssh_key_ids=ext.keys.split(','))
