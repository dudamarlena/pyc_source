...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/snipsskills/commands/setup/systemd/bluetooth.py
# Compiled at: 2017-10-26 05:21:34
...
class SystemdBluetooth(Base):
    ...
    def setup_from_params(mqtt_hostname='localhost', mqtt_port=9898):
        ...
        if contents is None:
            ...
            command = SystemdBluetooth.SNIPSBLE_SCRIPT.format(node_bin_path=node_bin_path, node_module_path=NODE_MODULES_DIR, module_name=SystemdBluetooth.SNIPSBLE_MODULE_NAME, serviceUUID=SystemdBluetooth.SNIPSBLE_SERVICE_UUID, characteristicUUID=SystemdBluetooth.SNIPSBLE_CHARACTERISTIC_UUID, mqtt_hostname=mqtt_hostname, mqtt_port=mqtt_port)
