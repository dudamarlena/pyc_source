...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/snipsskills/utils/assistant_downloader.py
# Compiled at: 2017-09-26 14:05:07
...
class Downloader(object):
    ...
    def download(url, output_dir, filename):
        ...
        Downloader.save(response.read(), output_dir, filename)
