...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/snipsskills/utils/snipsfile.py
# Compiled at: 2017-10-30 11:57:42
    ...
    def __init__(self, snipsfile='Snipsfile'):
        ...
        if not yaml_config:
            ...
            for skill in get(yaml_config, ['skills'], []):
                ...
                self.skilldefs.append(SkillDef(name, package_name, class_name, url, params, intent_defs, requires_tts, addons))
