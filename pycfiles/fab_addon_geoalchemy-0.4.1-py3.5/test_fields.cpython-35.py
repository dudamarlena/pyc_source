...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/test_fields.py
...
NL = 'SRID=4326;POLYGON((4.40108047690016 53.3586997019374,2.8607023099851' + '51.4002188897169,6.9247420162497 50.6194989118665,7.67988543219077 ' + '54.0188617734724,4.40108047690016 53.3586997019374))'
show_html = '<label>Latitude:</label> 1.0 <label>Longitude:</label> 4.0 ' + '<div class="leaflet_map" id="location_map"></div>' + '<script type="text/javascript">' + 'createROPointMap("location_map", 1.0, 4.0);</script>'
...
class TestFields(TestCase):
    ...
    def test_show_widget(self):
        ...
        w = str(interf._get_attr_value(obs, 'location2'))
        self.assertIsInstance(w, str)
    ...
    def test_additional_js_css(self):
        ...
        """
        mgr = appbuilder.addon_managers['fab_addon_geoalchemy.manager.GeoAlchemyManager']
    ...
    def testFieldConversion(self):
        ...
        correct_html = 'Latitude: <input type="text" id="location_lat" ' + 'name="location_lat"> Longitude: <input type="text" ' + 'id="location_lon" name="location_lon">' + '<div class="leaflet_map" id="location_map"></div>' + '<script type="text/javascript">' + 'createPointMap("location_map","location_lat", "location_lon")' + ';</script>'
        print(correct_html)
    ...
    def testDataProcessing(self):
        ...
        self.assertEqual(form.location.data, 'SRID=4326;POINT(5.98193 52.34812)')
        self.assertEqual(form.location2.data, 'SRID=3857;POINT(5.98193 52.34812)')
        row = Observation()
        ...
        db.session.commit()
        widget = form.location()
        correct_html = 'Latitude: <input type="text" id="location_lat" ' + 'name="location_lat" value="52.34812"> ' + 'Longitude: <input type="text" id="location_lon" ' + 'name="location_lon" value="5.98193">' + '<div class="leaflet_map" id="location_map"></div>' + '<script type="text/javascript">' + 'createPointMap("location_map","location_lat", "location_lon")' + ';</script>'
        print(widget)
        print(correct_html)
        self.assertEqual(widget, correct_html)
    ...
    def testFormRefresh(self):
        ...
        row = Observation(name='test', location='SRID=4326;POINT(5.98193 52.34812)')
        db.session.add(row)
        db.session.commit()
