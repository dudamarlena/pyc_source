...
Parse error at or near `POP_EXCEPT' instruction at offset 114
    ...
    def p--- This code section failed: ---

 L. 767         0  SETUP_FINALLY        70  'to 70'

 L. 768         2  LOAD_FAST                'activity'
                4  LOAD_CONST               True
                6  COMPARE_OP               is
                8  POP_JUMP_IF_FALSE    32  'to 32'

 L. 769        10  LOAD_CONST               -1
               12  LOAD_GLOBAL              math
               14  LOAD_METHOD              log10
               16  LOAD_FAST                'self'
               18  LOAD_METHOD              get_activity
               20  LOAD_FAST                'solute'
               22  CALL_METHOD_1         1  ''
               24  CALL_METHOD_1         1  ''
               26  BINARY_MULTIPLY  
 ...
 L. 770        32  LOAD_FAST                'activity'
               34  LOAD_CONST               False
               36  COMPARE_OP               is
               38  POP_JUMP_IF_FALSE    66  'to 66'

 L. 771        40  LOAD_CONST               -1
               42  LOAD_GLOBAL              math
               44  LOAD_METHOD              log10
               46  LOAD_FAST                'self'
               48  LOAD_METHOD              get_amount
               50  LOAD_FAST                'solute'
               52  LOAD_STR                 'mol/L'
               54  CALL_METHOD_2         2  ''
               56  LOAD_ATTR                magnitude
               58  CALL_METHOD_1         1  ''
               60  BINARY_MULTIPLY  
               62  POP_BLOCK        
               64  RETURN_VALUE     
