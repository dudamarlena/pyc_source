...
# Embedded file name: /home/ryan/anaconda3/envs/wsl2/lib/python3.8/site-packages/pyEQL/equilibrium.py
# Compiled at: 2020-04-22 01:17:06
# Size of source mod 2**32: 9281 bytes
...
def adjust_temp_pitzer(c1, c2, c3, c4, c5, temp, temp_ref=unit('298.15 K')):
    ...
    """
    pitzer_param = c1 + c2 * (1 / temp + 1 / temp_ref) + c2 * math.log(temp / temp_ref) + c3 * (temp - temp_ref) + c4 * (temp ** 2 - temp_ref ** 2) + c5 * (temp ** (-2) - temp_ref ** (-2))
    return pitzer_param
