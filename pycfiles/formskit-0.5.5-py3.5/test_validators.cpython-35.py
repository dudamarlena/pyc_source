...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/formskit/tests/test_validators.py
...
class ValidatorTestMixin(object):
    ...
    def test_success(self):
        for sample in self.good_samples:
            ...
            if not field_value.error is False:
    ...
    def test_fail(self):
        for sample in self.bad_samples:
            ...
            if self._is_field_value_validator():
                ...
                if not field_value.messages[0].text == self.cls.__name__:
                    raise AssertionError
            else:
