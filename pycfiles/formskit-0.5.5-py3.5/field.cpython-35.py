...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/formskit/field.py
# Compiled at: 2016-04-05 10:41:20
...
class Field(Translable):
    ...
    def __init__(self, name, validators=None, label=None, ignore=False, convert=None):
        self.name = name
        self.label = label
        self.ignore = ignore
        self.form = None
    ...
    def get_values(self):
        ...
        """
        return [self.convert(field_value.value) for field_value in self.values]
    ...
    def set_values(self, values, force=False):
        ...
        self.values = []
        for value in values:
            self.values.append(FieldValue(self, value))
    ...
    def set_value(self, value, index=0, force=False):
        ...
        if not self._can_this_be_edited(force):
            ...
            try:
                ...
                self.values.append(FieldValue(self, self.convert.back(value)))
