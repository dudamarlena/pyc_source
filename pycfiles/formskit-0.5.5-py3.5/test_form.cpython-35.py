...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/formskit/tests/test_form.py
...
class FormTest(TestCase):
    ...
    def test_is_validated(self):
        form = Form()
        data = {form.form_name_value: [form.get_name()]}
    ...
    def test_messages(self):
        ...
        form.add_field('name', validators=[NotEmpty()])
        assert form.validate({form.form_name_value: [form.get_name()]}) is False
...
class IsFormSubmittedTest(TestCase):
    ...
    def test_name_do_not_match(self):
        form = Form()
        raw_data = {Form.form_name_value: [form.get_name() + 'bad']}
        assert form._is_form_submitted(raw_data) is False

    def test_name_match(self):
        form = Form()
        raw_data = {Form.form_name_value: [form.get_name()]}
...
class ParseRawDataTest(TestCase):
    ...
    def test_good_data(self):
        raw_data = {self.form.fields['one'].get_name(): ['value']}
...
class GetReportTest(TestCase):
    ...
    def test_success(self):
        ...
        assert self.form.get_report() == {'success': True, 
         'messages': [], 
    ...
    def test_error_at_form_validator(self):
        ...
        assert self.form.get_report() == {'success': False, 
