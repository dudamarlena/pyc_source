...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/matricks/conversion.py
    ...
    def __init__(self, prog, skipcols=0):
        ...
        if isinstance(prog, (type, FunctionType)):
            ...
            for i in range(len(prog)):
                cf = self._conversion_control_map.get(prog[i], self.__defaultCvt)
