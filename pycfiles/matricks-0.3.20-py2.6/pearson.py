...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/matricks/scoring/pearson.py
# Compiled at: 2011-08-04 03:43:53
from scorer import *
import ppmc
    ...
    def __init__(self, mx, ref, null=None):
        if isinstance(ref, (list, tuple)):
            ...
            if row is None or len(row) == 0:
                raise KeyError('reference vector not found: ' + ref)
