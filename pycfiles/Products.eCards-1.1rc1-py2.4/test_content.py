...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Products/eCards/tests/test_content.py
...
class TestContentEditing(base.eCardTestCase):
    ...
    def testCollectionCanBeOrderedInParent(self):
        ...
        self.failUnless(self.folder.getObjectPosition('collection3') == 0, "eCardCollection subobject 'collection3' should be at position 0.")
