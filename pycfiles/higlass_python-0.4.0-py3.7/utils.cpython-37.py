...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/higlass/utils.py
# Compiled at: 2020-01-26 00:21:31
# Size of source mod 2**32: 3780 bytes
...
FILETYPES = {'cooler':{'description':'multi-resolution cooler file', 
  'extensions':[
   '.mcool'], 
  'datatypes':[
   'matrix']}, 
 'bigwig':{'description':'Genomics focused multi-resolution vector file', 
  'extensions':[
   '.bw', '.bigwig'], 
  'datatypes':[
   'vector']}, 
 'beddb':{'description':'SQLite-based multi-resolution annotation file', 
  'extensions':[
   '.beddb', '.multires.db'], 
  'datatypes':[
   'bedlike', 'gene-annotations']}, 
 'hitile':{'description':'Multi-resolution vector file', 
  'extensions':[
   '.hitile'], 
  'datatypes':[
   'vector']}, 
 'time-interval-json':{'description':'Time interval notation', 
  'extensions':[
   '.htime'], 
  'datatypes':[
   'time-interval']}}
...
def fill_filetype_and_datatype(filename, filetype=None, datatype=None):
    ...
    if filetype is None:
        ...
        if filetype is None:
            ...
            print('Unknown filetype, please specify using the --filetype option',
              file=(sys.stderr))
    ...
    if datatype is None:
        ...
        if datatype is None:
            ...
            print('Unknown datatype, please specify using the --datatype option',
              file=(sys.stderr))
