...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyp_beagle/beagle_residual_photometry.py
# Compiled at: 2019-07-16 04:25:49
import numpy as np
from scipy.interpolate import interp1d
import matplotlib.pyplot as plt, cPickle, os, sys, dependencies.WeightedKDE as WeightedKDE
...
class ResidualPhotometry(object):
    ...
    def compute(self, observed_catalogue, beagle_summary_catalogue, filters, summary_stat=None, cPickleName=None):
        """ 
        ...
        for i in range(filters.n_bands):
            ...
            mask[(obs_flux > 0.0) & (obs_flux_err > 0.0) & (model_flux > 0.0) & (model_flux_err > 0.0)] = True
            ...
            if len(residual) > 0:
                kde_pdf = WeightedKDE.gaussian_kde(residual, weights=1.0 / residualErr)
            else:
                kde_pdf = 0
    ...
    def plot(self, filters, plot_name='BEAGLE_residual_photometry.pdf', x_range=(-1.0, 1.0), n_x=1000, summary_stat='median'):
        """ 
