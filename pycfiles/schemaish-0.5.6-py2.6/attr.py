...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/schemaish/attr.py
# Compiled at: 2010-03-05 09:23:28
"""
Schema attribute types, also imported into the main package.
"""
__all__ = [
 'String', 'Integer', 'Float', 'Decimal', 'Date',
 'Time', 'Boolean', 'Sequence', 'Tuple', 'Structure',
 'DateTime', 'File', 'Invalid']
import itertools, validatish
...
class _StructureMeta(type):
    ...
    def __init__(cls, name, bases, clsattrs):
        cls.__schemaish_structure_attrs__ = list((name, value) for (name, value) in clsattrs.iteritems() if isinstance(value, Attribute))
        attrs = []
