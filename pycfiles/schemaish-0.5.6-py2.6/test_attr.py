...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/schemaish/tests/test_attr.py
...
class TestAttribute(unittest.TestCase):
    ...
    def test__repr__(self):
        attr = self._makeOne(title='title', default=True, description='description', validator=required)
        begin_expected = "schemaish.LeafAttribute(title='title', description='description', validator=<function required"
...
class TestString(unittest.TestCase):
    ...
    def test_description(self):
        self.assertEquals(self._makeOne(description='Description').description, 'Description')
    ...
    def test_validate(self):
        ...
        self.assertRaises(Invalid, self._makeOne(validator=required).validate, None)
        self.assertRaises(Invalid, self._makeOne(validator=required).validate, '')
        return
...
class TestDate(unittest.TestCase):
    ...
    def test_validate(self):
        ...
        self.assertRaises(Invalid, Date(validator=required).validate, None)
        return
...
class TestSequence(unittest.TestCase):
    ...
    def test_nested_validation(self):
        ...
        s.validate(['one'])
        self.assertRaises(Invalid, s.validate, [''])
        s = self._makeOne(Structure([('str', Attr(validator=required))]))
        s.validate([{'str': 'one'}])
        self.assertRaises(Invalid, s.validate, [{}])
...
class TestTuple(unittest.TestCase):
    ...
    def test_validate(self):
        ...
        t.validate(tuple())
        t.validate(('one', 'two'))
        t = self._makeOne([Attr(), Attr()], validator=required)
        t.validate(('one', 'two'))
...
class TestDefaults(unittest.TestCase):
    ...
    def test_defaults(self):
        ...
        self.assertEqual(schema.default, {'address': {'city': 'Leeds', 'street': 'Lidgett Lane'}, 'code': ('legs', 11), 
           'first_names': 'Tim', 
           'last_name': 'Parkin'})