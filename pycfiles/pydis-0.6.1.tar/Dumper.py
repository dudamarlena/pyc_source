...
class FileDumper(object):
    ...
    def get_metadata(self):
        ...
        return [
         (
          'Generator', 'pydirstat'), ('Version', __version__), ('Directory', self._tree.file_provider().abspath(self._rootpath)), ('Total Size', fmtsize(self._treemapview.rootTile().fileinfo().totalSize())), ('Date', time.strftime('%Y-%m-%d %H:%M:%S', time.localtime())), ('Configuration File', self._configuration.get_filename()), ('Python version', sys.version)]
