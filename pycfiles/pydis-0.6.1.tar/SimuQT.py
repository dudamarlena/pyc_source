...
# Embedded file name: build\bdist.win32\egg\dirstat\SimuQT.py
# Compiled at: 2006-06-20 01:56:48
__doc__ = 'This module simulate QT class that TreemapView needs'
        ...
        if b != None:
            ...
            if colors:
                ...
                if self._colorname[0] == '#' and len(self._colorname) in (4, 7):
                    ...
                    if len(listcolor) == 3:
                        (self._r, self._g, self._b) = (
                         listcolor[0] * 17, listcolor[1] * 17, listcolor[2] * 17)
                        colok_ok = True
                    if len(listcolor) == 6:
                        (self._r, self._g, self._b) = (
                         listcolor[0] * 16 + listcolor[1], listcolor[2] * 16 + listcolor[3], listcolor[4] * 16 + listcolor[5])
                        colok_ok = True
                if not colok_ok:
                    (self._r, self._g, self._b) = (
                     51, 51, 51)
