...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Christian\Documents\GitHub\base-node\base_node\__init__.py
# Compiled at: 2016-03-15 16:15:13
...
def get_includes():
    ...
    """
    return [
     package_path().joinpath('Arduino', 'BaseNode')]
...
def install_as_arduino_library(sketchbook_home, overwrite=False):
    ...
    library_path = path(sketchbook_home).joinpath('libraries', sketch_path.name)
