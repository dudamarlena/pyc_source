...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/datadeck/gui/base.py
# Compiled at: 2011-11-23 14:37:56
import wx

class DataDeckFrame(wx.Frame):

    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='DataDeck', pos=wx.DefaultPosition, size=wx.Size(-1, -1), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)
        self.m_menu_mb = wx.MenuBar(0)
        self.m_file_m = wx.Menu()
        self.m_file_new_mi = wx.MenuItem(self.m_file_m, wx.ID_ANY, 'New Package', wx.EmptyString, wx.ITEM_NORMAL)
        self.m_file_m.AppendItem(self.m_file_new_mi)
        self.m_file_open_mi = wx.MenuItem(self.m_file_m, wx.ID_ANY, 'Open', wx.EmptyString, wx.ITEM_NORMAL)
        self.m_file_m.AppendItem(self.m_file_open_mi)
        self.m_file_settings_mi = wx.MenuItem(self.m_file_m, wx.ID_ANY, 'Settings', wx.EmptyString, wx.ITEM_NORMAL)
        self.m_file_m.AppendItem(self.m_file_settings_mi)
        self.m_file_exit_mi = wx.MenuItem(self.m_file_m, wx.ID_ANY, 'Exit', wx.EmptyString, wx.ITEM_NORMAL)
        self.m_file_m.AppendItem(self.m_file_exit_mi)
        self.m_menu_mb.Append(self.m_file_m, 'File')
        self.m_about_m = wx.Menu()
        self.m_about_about_mi = wx.MenuItem(self.m_about_m, wx.ID_ANY, 'About', wx.EmptyString, wx.ITEM_NORMAL)
        self.m_about_m.AppendItem(self.m_about_about_mi)
        self.m_menu_mb.Append(self.m_about_m, 'About')
        ...
        self.m_library_info_b = wx.Button(self.m_notebook_library_p, wx.ID_ANY, 'Info', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_library_info_b.Enable(False)
        bSizer31.Add(self.m_library_info_b, 1, 0, 5)
        self.m_library_edit_b = wx.Button(self.m_notebook_library_p, wx.ID_ANY, 'Edit', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_library_edit_b.Enable(False)
        bSizer31.Add(self.m_library_edit_b, 1, 0, 5)
        self.m_library_delete_b = wx.Button(self.m_notebook_library_p, wx.ID_ANY, 'Delete', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_library_delete_b.Enable(False)
        bSizer31.Add(self.m_library_delete_b, 1, 0, 5)
        bSizer21.Add(bSizer31, 0, wx.ALL | wx.EXPAND, 5)
        sbSizer11 = wx.StaticBoxSizer(wx.StaticBox(self.m_notebook_library_p, wx.ID_ANY, 'Local Packages'), wx.VERTICAL)
        ...
        self.m_library_refresh_b = wx.Button(self.m_notebook_library_p, wx.ID_ANY, 'Refresh', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_notebook_n.AddPage(self.m_notebook_library_p, 'Library', True)
        ...
        self.m_search_b = wx.Button(self.m_notebook_search_p, wx.ID_ANY, 'Search', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer3.Add(self.m_search_b, 1, 0, 5)
        self.m_search_info_b = wx.Button(self.m_notebook_search_p, wx.ID_ANY, 'Info', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_search_info_b.Enable(False)
        bSizer3.Add(self.m_search_info_b, 1, 0, 5)
        self.m_search_download_b = wx.Button(self.m_notebook_search_p, wx.ID_ANY, 'Download', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_search_download_b.Enable(False)
        bSizer3.Add(self.m_search_download_b, 1, 0, 5)
        bSizer2.Add(bSizer3, 0, wx.ALL | wx.EXPAND, 5)
        sbSizer1 = wx.StaticBoxSizer(wx.StaticBox(self.m_notebook_search_p, wx.ID_ANY, 'Search Results'), wx.VERTICAL)
        ...
        self.m_notebook_n.AddPage(self.m_notebook_search_p, 'Search', False)
        ...
        self.m_create_name_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'Name', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_url_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'URL', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_license_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'License', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_author_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'Author', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_author_email_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'Email', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_notes_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'Notes', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_tags_st = wx.StaticText(self.m_notebok_create_p, wx.ID_ANY, 'Tags', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_create_tags_tc.SetToolTipString('Separate tags with spaces, unite-words-with-dashes ')
        bSizer9.Add(self.m_create_tags_tc, 2, wx.ALL, 5)
        bSizer5.Add(bSizer9, 1, wx.EXPAND, 5)
        bSizer61 = wx.BoxSizer(wx.HORIZONTAL)
        bSizer61.AddSpacer((0, 0), 1, wx.EXPAND, 5)
        self.m_create_save_b = wx.Button(self.m_notebok_create_p, wx.ID_ANY, 'Save', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_notebook_n.AddPage(self.m_notebok_create_p, 'Create', False)
        ...
        sbSizer3 = wx.StaticBoxSizer(wx.StaticBox(self.m_console_p, wx.ID_ANY, 'Console Info'), wx.VERTICAL)
        ...
        self.m_console_clear_b = wx.Button(self.m_console_p, wx.ID_ANY, 'Clear Console', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer13.Add(self.m_console_clear_b, 1, wx.ALIGN_RIGHT | wx.ALL, 5)
        self.m_console_killoperations_b = wx.Button(self.m_console_p, wx.ID_ANY, 'Kill Operations', wx.DefaultPosition, wx.DefaultSize, 0)
...
class SettingsFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='Settings', pos=wx.DefaultPosition, size=wx.Size(-1, -1), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)
        bSizer22 = wx.BoxSizer(wx.VERTICAL)
        self.m_panel = wx.Panel(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        bSizer23 = wx.BoxSizer(wx.VERTICAL)
        sbSizer5 = wx.StaticBoxSizer(wx.StaticBox(self.m_panel, wx.ID_ANY, 'TheDataHub'), wx.VERTICAL)
        bSizer24 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_ckan_url_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'API URL', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_api_key_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'API Key', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText17 = wx.StaticText(self.m_panel, wx.ID_ANY, 'Register for an API Key', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText17.Wrap(-1)
        bSizer29.Add(self.m_staticText17, 1, wx.ALL, 5)
        self.m_hyperlink5 = wx.HyperlinkCtrl(self.m_panel, wx.ID_ANY, 'http://thedatahub.org/user/register', 'http://thedatahub.org/user/register', wx.DefaultPosition, wx.DefaultSize, wx.HL_DEFAULT_STYLE)
        bSizer29.Add(self.m_hyperlink5, 2, wx.ALL, 5)
        sbSizer5.Add(bSizer29, 1, wx.ALL, 5)
        bSizer23.Add(sbSizer5, 1, wx.ALL | wx.EXPAND, 5)
        sbSizer6 = wx.StaticBoxSizer(wx.StaticBox(self.m_panel, wx.ID_ANY, 'DataDeck'), wx.VERTICAL)
        bSizer242 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_datadeck_library_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Packages Library', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_datadeck_library_st.Wrap(-1)
        bSizer242.Add(self.m_datadeck_library_st, 0, wx.ALL, 10)
        self.m_datadeck_library_dp = wx.DirPickerCtrl(self.m_panel, wx.ID_ANY, wx.EmptyString, 'Select a folder', wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        ...
        self.m_save_b = wx.Button(self.m_panel, wx.ID_ANY, 'Save', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer25.Add(self.m_save_b, 0, wx.ALL, 5)
        self.m_cancel_b = wx.Button(self.m_panel, wx.ID_ANY, 'Cancel', wx.DefaultPosition, wx.DefaultSize, 0)
...
class InfoFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='Package', pos=wx.DefaultPosition, size=wx.Size(-1, -1), style=wx.DEFAULT_FRAME_STYLE | wx.STAY_ON_TOP | wx.TAB_TRAVERSAL)
        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)
        bSizer4 = wx.BoxSizer(wx.VERTICAL)
        self.m_panel = wx.Panel(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        bSizer5 = wx.BoxSizer(wx.VERTICAL)
        bSizer6 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_name_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Name', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer6, 1, wx.EXPAND, 5)
        bSizer7 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_url_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'URL', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer7, 1, wx.EXPAND, 5)
        bSizer8 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_license_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'License', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer8, 1, wx.EXPAND, 5)
        bSizer71 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_author_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Author', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer71, 1, wx.EXPAND, 5)
        bSizer72 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_author_email_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Email', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer72, 1, wx.EXPAND, 5)
        bSizer11 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_notes_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Notes', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer11, 3, wx.EXPAND, 5)
        bSizer9 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_tags_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Tags', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer5.Add(bSizer9, 1, wx.EXPAND, 5)
        self.m_close_b = wx.Button(self.m_panel, wx.ID_ANY, 'Close', wx.DefaultPosition, wx.DefaultSize, 0)
...
class AboutFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='About', pos=wx.DefaultPosition, size=wx.Size(-1, -1), style=wx.CAPTION | wx.CLOSE_BOX | wx.RESIZE_BORDER | wx.STAY_ON_TOP | wx.TAB_TRAVERSAL)
        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)
        bSizer16 = wx.BoxSizer(wx.VERTICAL)
        self.m_panel = wx.Panel(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        bSizer14 = wx.BoxSizer(wx.VERTICAL)
        self.m_datadeck_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'DataDeck', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_website_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Website', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_website_st.Wrap(-1)
        bSizer161.Add(self.m_website_st, 1, wx.ALL, 5)
        self.m_website_hl = wx.HyperlinkCtrl(self.m_panel, wx.ID_ANY, wx.EmptyString, 'http://task3.cc/projects/datadeck', wx.DefaultPosition, wx.DefaultSize, wx.HL_ALIGN_LEFT)
        bSizer161.Add(self.m_website_hl, 5, wx.ALL, 5)
        bSizer14.Add(bSizer161, 1, wx.EXPAND, 5)
        bSizer1611 = wx.BoxSizer(wx.HORIZONTAL)
        self.m_bugs_st = wx.StaticText(self.m_panel, wx.ID_ANY, 'Bugs', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_bugs_st.Wrap(-1)
        bSizer1611.Add(self.m_bugs_st, 1, wx.ALL, 5)
        self.m_bugs_hl = wx.HyperlinkCtrl(self.m_panel, wx.ID_ANY, wx.EmptyString, 'https://github.com/dgraziotin/datadeck/issues', wx.DefaultPosition, wx.DefaultSize, wx.HL_ALIGN_LEFT)
        bSizer1611.Add(self.m_bugs_hl, 5, wx.ALL, 5)
        bSizer14.Add(bSizer1611, 1, wx.EXPAND, 5)
        sbSizer3 = wx.StaticBoxSizer(wx.StaticBox(self.m_panel, wx.ID_ANY, 'License'), wx.VERTICAL)
...
class DepCheckFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='Dependencies', pos=wx.DefaultPosition, size=wx.Size(500, 300), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)
        bSizer16 = wx.BoxSizer(wx.VERTICAL)
        self.m_panel = wx.Panel(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        bSizer14 = wx.BoxSizer(wx.VERTICAL)
        ...
        bSizer1611.Add(self.m_bugs_hl, 5, wx.ALL, 5)
        bSizer14.Add(bSizer1611, 1, wx.EXPAND, 5)
        sbSizer3 = wx.StaticBoxSizer(wx.StaticBox(self.m_panel, wx.ID_ANY, 'Missing dpm'), wx.VERTICAL)
