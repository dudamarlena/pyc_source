...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/datadeck/gui/util/package.py
# Compiled at: 2011-11-23 15:55:55
"""
This module holds GUI utilities for handling/representing Packages
"""
import wx, os, os.path, shutil, datadeck.gui.package, download, validator, datadeck.operations, datadeck.settings, dpm.lib
...
class PackageUtil(object):
    ...
    def Validate(self, package):
        ...
        except validator.PackageNonValid as e:
