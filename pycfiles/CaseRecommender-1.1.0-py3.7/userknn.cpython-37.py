...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/userknn.py
# Compiled at: 2019-08-20 09:47:28
# Size of source mod 2**32: 10750 bytes
"""
...
class UserKNN(BaseKNN):
    ...
    def __init__(self, train_file=None, test_file=None, output_file=None, similarity_metric='cosine', k_neighbors=None, as_similar_first=False, sep='\t', output_sep='\t'):
        ...
        """
        super(UserKNN, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, similarity_metric=similarity_metric,
          sep=sep,
        ...
        for item in unpredicted_items:
            ...
            if common_users:
                for user_v_id in common_users:
                    ...
                    rui += (self.train_set['feedback'][user_v][item] - self.bui[user_v][item]) * sim_uv if sim_sum != 0 else 0.001
