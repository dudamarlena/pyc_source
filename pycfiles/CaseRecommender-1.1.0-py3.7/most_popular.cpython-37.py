...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/most_popular.py
...
class MostPopular(BaseRatingPrediction):
    ...
    def __init__(self, train_file=None, test_file=None, output_file=None, sep='\t', output_sep='\t'):
        ...
        """
        super(MostPopular, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, sep=sep,
