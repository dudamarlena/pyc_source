...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/base_nsvd1.py
...
class BaseNSVD1(BaseRatingPrediction):
    ...
    def __init__(self, train_file, test_file, output_file=None, factors=10, init_mean=0, init_stdev=0.1, sep='\t', output_sep='\t', random_seed=None):
        """
        ...
        """
        super(BaseNSVD1, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, sep=sep, output_sep=output_sep)
