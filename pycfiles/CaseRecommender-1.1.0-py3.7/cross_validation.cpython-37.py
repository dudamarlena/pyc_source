...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/utils/cross_validation.py
...
class CrossValidation(object):
    ...
    def generate_folds(self):
        ...
        """
        SplitDatabase(input_file=(self.input_file), n_splits=(self.k_folds), dir_folds=(self.dir_folds), sep_read=(self.sep),
          header=(self.header)).k_fold_cross_validation(random_state=(self.random_seed))
    ...
    def execute_algorithm(self):
        ...
        for k in range(self.k_folds):
            ...
            self.recommender.compute(verbose=(self.recommender_verbose), verbose_evaluation=(self.evaluation_in_fold_verbose),
