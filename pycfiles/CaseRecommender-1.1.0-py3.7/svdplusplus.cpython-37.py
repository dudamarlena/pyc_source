...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/svdplusplus.py
# Compiled at: 2019-08-20 09:47:28
# Size of source mod 2**32: 8413 bytes
"""
...
class SVDPlusPlus(MatrixFactorization):
    ...
    def __init__(self, train_file=None, test_file=None, output_file=None, factors=10, learn_rate=0.01, epochs=10, delta=0.015, init_mean=0.1, init_stdev=0.1, bias_learn_rate=0.005, delta_bias=0.002, stop_criteria=0.009, sep='\t', output_sep='\t', random_seed=None, update_delta=False):
        """
        ...
        """
        super(SVDPlusPlus, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, factors=factors,
            ...
            for user in self.test_set['users']:
                ...
                for item in self.test_set['feedback'][user]:
                    self.predictions.append((
                     user, item,
                     self._predict_svd_plus_plus_score(self.user_to_user_id[user], self.item_to_item_id[item], pu, True)))
