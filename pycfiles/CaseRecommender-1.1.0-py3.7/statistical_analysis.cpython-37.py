...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/evaluation/statistical_analysis.py
...
class StatisticalAnalysis(object):
    ...
    def general_analysis(self):
        ...
        print('Correlation:' + str(np.corrcoef(np.array((self.sample1, self.sample2)))[(0,
                                                                                        1)]) + '\n')
