...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/corec.py
# Compiled at: 2019-08-20 09:47:28
# Size of source mod 2**32: 16209 bytes
"""
...
class ECoRec(object):
    ...
    def __init__(self, train_file, test_file, recommenders=(1, 2), confidence_measure='vi', number_sample=10, m=None, sep='\t', ensemble_method=False):
        """
    ...
    def create_unlabeled_set(self):
        ...
        if self.m is None:
            self.m = int(len(unlabeled_data) * 0.1)
    ...
    def update_data(self):
        ...
        while cond:
            shuffle(n_rec)
            cond = [i for i, j in zip(n_rec, self.recommenders) if i == j] or False
