...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/durable/lang.py
...
class value(object):
    ...
    def define(self):
        ...
        if self._op == '$or' or self._op == '$and':
            left_definition = self._left.define()
            if self._op not in left_definition:
                left_definition = [
...
class statechart(object):
    ...
    def define(self):
        ...
        return (
         ('{0}$state').format(self.name), new_definition)
...
class flowchart(object):
    ...
    def define(self):
        ...
        return (
         ('{0}$flow').format(self.name), new_definition)
