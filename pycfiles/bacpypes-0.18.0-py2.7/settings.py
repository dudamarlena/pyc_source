...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bacpypes/settings.py
# Compiled at: 2020-01-29 15:49:51
"""
Settings
"""
import os
...
settings = Settings(debug=set(), color=False, debug_file='', max_bytes=1048576, backup_count=5, route_aware=False)
