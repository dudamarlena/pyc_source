...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python3.4/site-packages/PyIRC/base.py
...
class Event:
    __doc__ = 'A basic event passed around extensions, wherein state can be set.\n\n    :ivar cancelled:\n        The present event is "soft cancelled". Other events may undo this.\n    '
...
class IRCBase(metaclass=ABCMeta):
    __doc__ = 'The base IRC class meant to be used as a base for more concrete\n    implementations.\n\n    :ivar connected:\n        If True, we have connected to the server successfully.\n\n    :ivar registered:\n        If True, we have completed the server handshake and are ready\n        to send commands.\n\n    '

    def __init__(self, serverport, username, nick, gecos, extensions, **kwargs):
    ...
    def load_extension(self, extension):
        ...
        extension = self.extensions[extname] = extension(base=self, **self.kwargs)
