...
class NullFormatter(Formatter):
    __doc__ = 'A stripping formatter that simply removes formatting.'
    do_bold = lambda self: ''
...
class HTMLFormatter(Formatter):
    __doc__ = 'A basic HTML IRC formatting class.'
...
class XTerm16ColourFormatter(ANSIFormatter):
    __doc__ = 'Like the :py:class:`~PyIRC.formatting.formatters.ANSIFormatter`, but\n    for XTerm. Most other terminals support this, excluding Windows.'
