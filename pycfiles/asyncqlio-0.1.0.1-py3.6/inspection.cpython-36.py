...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/asyncqlio/orm/inspection.py
# Compiled at: 2017-11-29 05:57:44
...
def get_row_history(row: 'md_table.Table') -> 'typing.Dict[md_column.Column, typing.Dict[str, typing.Any]]':
    """
