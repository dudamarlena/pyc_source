...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/grouprelease.py
...
class GroupRelease(Model):
    ...
    def get_cache_key(cls, group_id, release_id, environment):
        return ('grouprelease:1:{}:{}').format(group_id, md5_text(('{}:{}').format(release_id, environment)).hexdigest())
