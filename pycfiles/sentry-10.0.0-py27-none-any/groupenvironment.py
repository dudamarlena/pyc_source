...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/groupenvironment.py
...
class GroupEnvironment(Model):
    ...
    first_release = FlexibleForeignKey('sentry.Release', null=True, db_constraint=False, on_delete=DO_NOTHING)
...
post_delete.connect(lambda instance, **kwargs: cache.delete(GroupEnvironment._get_cache_key(instance.group_id, instance.environment_id)), sender=GroupEnvironment, weak=False)