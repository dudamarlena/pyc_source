...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/signals.py
...
issue_resolved = BetterSignal(providing_args=[
...
release_commits_updated = BetterSignal(providing_args=[
 'release', 'removed_commit_ids', 'added_commit_ids'])
