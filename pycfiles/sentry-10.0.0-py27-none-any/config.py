...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/runner/commands/config.py
...
@config.command()
@click.option('--secret', default=False, is_flag=True, help='Hide prompt input when inputing secret data.')
@click.argument('key')
