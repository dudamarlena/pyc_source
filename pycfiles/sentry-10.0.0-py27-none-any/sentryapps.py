...
# [GCC 8.4.0]
# Embedded file name: /c/Users/byk/Documents/Projects/sentry/sentry/src/sentry/api/bases/sentryapps.py
...
class SentryAppsPermission(SentryPermission):
    scope_map = {'GET': ('event:read', 'event:write', 'event:admin', 'project:releases', 'project:read', 'org:read',
...
class SentryAppPermission(SentryPermission):
    unpublished_scope_map = {'GET': ('org:read', 'org:integrations', 'org:write', 'org:admin'), 
       'PUT': ('org:read', 'org:integrations', 'org:write', 'org:admin'), 
       'POST': ('org:write', 'org:admin'), 
       'DELETE': ('org:write', 'org:admin')}
    published_scope_map = {'GET': ('event:read', 'event:write', 'event:admin', 'project:releases', 'project:read', 'org:read',
 'member:read', 'team:read'), 
