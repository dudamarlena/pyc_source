...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/organization_shortid.py
...
def resolve_short_id_scenario(runner):
    ...
    runner.request(method='GET', path='/organizations/%s/shortids/%s/' % (runner.org.slug, group.qualified_short_id))
