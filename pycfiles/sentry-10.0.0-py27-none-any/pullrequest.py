...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/pullrequest.py
...
class PullRequest(Model):
    ...
    def create_or_save(cls, organization_id, repository_id, key, values):
        ...
        """
        affected, created = cls.objects.create_or_update(organization_id=organization_id, repository_id=repository_id, key=key, values=values)
        if created is False:
            instance = cls.objects.get(organization_id=organization_id, repository_id=repository_id, key=key)
