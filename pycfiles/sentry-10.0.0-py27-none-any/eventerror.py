...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/eventerror.py
...
class EventError(object):
    ...
    _messages = {UNKNOWN_ERROR: 'Unknown error', 
    ...
    @property
    def data(self):
        return {k:v for k, v in six.iteritems(self._data) if k != 'type' if k != 'type'}
