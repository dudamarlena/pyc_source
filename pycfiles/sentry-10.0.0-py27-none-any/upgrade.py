...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/runner/commands/upgrade.py
...
def _upgrade(interactive, traceback, verbosity, repair):
    ...
    if 'south' in settings.INSTALLED_APPS or DJANGO_17:
        dj_call_command('migrate', interactive=interactive, traceback=traceback, verbosity=verbosity, migrate=True, merge=True, ignore_ghost_migrations=True)
    else:
