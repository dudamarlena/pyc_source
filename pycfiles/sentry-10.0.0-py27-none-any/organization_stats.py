...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/organization_stats.py
...
class OrganizationStatsEndpoint(OrganizationEndpoint, EnvironmentMixin, StatsMixin):
    ...
    def get(self, request, organization):
        ...
        if not keys:
            ...
            data = tsdb.get_range(model=stat_model, keys=keys, **self._parse_args(request, **query_kwargs))
            if group == 'organization':
