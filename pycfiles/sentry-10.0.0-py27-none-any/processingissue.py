...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/processingissue.py
...
class ProcessingIssueManager(BaseManager):
    ...
    def record_processing_issue(self, raw_event, scope, object, type, data=None):
        ...
        data['_scope'] = scope
        data['_object'] = object
        issue, _ = ProcessingIssue.objects.get_or_create(project_id=raw_event.project_id, checksum=checksum, type=type, defaults=dict(data=data))
