...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/metrics.py
...
class InternalMetrics(object):
    ...
    def incr(self, key, instance=None, tags=None, amount=1, sample_rate=settings.SENTRY_METRICS_SAMPLE_RATE):
...
def incr(key, amount=1, instance=None, tags=None, skip_internal=True, sample_rate=settings.SENTRY_METRICS_SAMPLE_RATE):
