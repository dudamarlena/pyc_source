...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/plugins/interfaces/releasehook.py
...
class ReleaseHook(object):
    ...
    def finish_release(self, version, **values):
        ...
        release.add_project(self.project)
        Activity.objects.create(type=Activity.RELEASE, project=self.project, ident=Activity.get_version_ident(version), data={'version': version}, datetime=values['date_released'])
