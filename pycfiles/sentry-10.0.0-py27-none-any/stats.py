...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/receivers/stats.py
...
post_save.connect(record_instance_creation, weak=False, dispatch_uid='sentry.stats.tasks.record_instance_creation')
