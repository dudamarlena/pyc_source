...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/identity.py
...
from sentry.db.models import ArrayField, BoundedPositiveIntegerField, EncryptedJsonField, FlexibleForeignKey, Model
