...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/groupreference.py
# Compiled at: 2019-08-16 17:27:46
from __future__ import absolute_import
import re
_fixes_re = re.compile('\\b(?:Fix|Fixes|Fixed|Close|Closes|Closed|Resolve|Resolves|Resolved):?\\s+([A-Za-z0-9_\\-\\s\\,]+)\\b', re.I)
_short_id_re = re.compile('\\b([A-Z0-9_-]+-[A-Z0-9]+)\\b', re.I)
