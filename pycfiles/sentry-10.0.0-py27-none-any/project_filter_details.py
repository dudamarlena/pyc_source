...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/project_filter_details.py
    ...
    def put(self, request, project, filter_id):
        ...
        if not serializer.is_valid():
            ...
            if filter_id == 'legacy-browsers':
                if isinstance(current_state, bool) or new_state == 0 or isinstance(new_state, six.binary_type):
