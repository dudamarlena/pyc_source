...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/data_filters.py
# Compiled at: 2019-08-16 17:27:46
from __future__ import absolute_import
import fnmatch, ipaddress, six
...
FILTER_STAT_KEYS_TO_VALUES = {FilterStatKeys.IP_ADDRESS: tsdb.models.project_total_received_ip_address, 
...
def is_valid_release(project_config, release):
    ...
    for the given project.
    """
    invalid_versions = get_path(project_config.config, 'filter_settings', FilterTypes.RELEASES, 'releases')
...
def is_valid_error_message(project_config, message):
    ...
    for the given project.
    """
    filtered_errors = get_path(project_config.config, 'filter_settings', FilterTypes.ERROR_MESSAGES, 'patterns')
