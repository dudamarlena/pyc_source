...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/mediators/mediator.py
# Compiled at: 2019-08-16 17:27:45
from __future__ import absolute_import
import datetime, logging, six, sentry
...
class Mediator(object):
    ...
    @property
    def _params(self):
        return dict((k[1:], v) for k, v in six.iteritems(self.__class__.__dict__) if isinstance(v, Param))
    ...
    def _default_logging(self):
        ...
        if not env.request or not hasattr(env.request, 'resolver_match') or not hasattr(env.request.resolver_match, 'kwargs'):
            return {}
        request_params = env.request.resolver_match.kwargs
        return compact({'org': request_params.get('organization_slug'), 
