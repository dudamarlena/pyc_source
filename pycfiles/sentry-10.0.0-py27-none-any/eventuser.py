...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/eventuser.py
...
class EventUser(Model):
    ...
    def save(self, *args, **kwargs):
        if not (self.ident or self.username or self.email or self.ip_address):
            raise AssertionError('No identifying value found for user')
            self.hash or self.set_hash()
