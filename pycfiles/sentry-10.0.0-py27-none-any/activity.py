...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/tasks/activity.py
...
@instrumented_task(name='sentry.tasks.activity.send_activity_notifications', queue='activity.notify')
