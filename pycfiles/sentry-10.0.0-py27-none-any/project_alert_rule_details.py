...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/incidents/endpoints/project_alert_rule_details.py
...
class ProjectAlertRuleDetailsEndpoint(ProjectAlertRuleEndpoint):
    ...
    def put(self, request, project, alert_rule):
        serializer = DrfAlertRuleSerializer(context={'project': project}, instance=alert_rule, data=request.data, partial=True)
