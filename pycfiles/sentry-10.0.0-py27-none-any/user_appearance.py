...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/user_appearance.py
...
class UserAppearanceEndpoint(UserEndpoint):
    ...
    def get(self, request, user):
        ...
        return Response({'language': options.get('language') or request.LANGUAGE_CODE, 
    ...
    def put(self, request, user):
        ...
        for key in result:
            UserOption.objects.set_value(user=user, key=key_map.get(key, key), value=result.get(key))
