...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/servicehook.py
...
from sentry.db.models import ArrayField, Model, BaseManager, BoundedPositiveIntegerField, EncryptedTextField, FlexibleForeignKey, sane_repr
...
class ServiceHook(Model):
    ...
    status = BoundedPositiveIntegerField(default=0, choices=ObjectStatus.as_choices(), db_index=True)
