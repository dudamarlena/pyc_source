...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/project_tagkey_values.py
...
class ProjectTagKeyValuesEndpoint(ProjectEndpoint, EnvironmentMixin):
    ...
    def get(self, request, project, key):
        ...
        paginator = tagstore.get_tag_value_paginator(project.id, environment_id, tagkey.key, query=request.GET.get('query'), order_by='-last_seen')
