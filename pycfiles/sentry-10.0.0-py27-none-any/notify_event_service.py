...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/rules/actions/notify_event_service.py
...
class NotifyEventServiceAction(EventAction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.form_fields = {'service': {'type': 'choice', 
    ...
    def get_sentry_app_services(self):
        apps = SentryApp.objects.filter(installations__organization_id=self.project.organization_id, is_alertable=True).distinct()
