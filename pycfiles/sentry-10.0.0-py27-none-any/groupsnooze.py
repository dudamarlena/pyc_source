...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/groupsnooze.py
# Compiled at: 2019-08-16 17:27:45
from __future__ import absolute_import
from datetime import timedelta
from django.db import models
from django.utils import timezone
from sentry.db.models import BaseManager, BoundedPositiveIntegerField, FlexibleForeignKey, JSONField, Model, sane_repr
...
class GroupSnooze(Model):
    ...
    def test_frequency_rates(self):
        ...
        rate = tsdb.get_sums(model=tsdb.models.group, keys=[self.group_id], start=start, end=end)[self.group_id]
        if rate >= self.count:
            return False
        return True
    ...
    def test_user_rates(self):
        ...
        rate = tsdb.get_distinct_counts_totals(model=tsdb.models.users_affected_by_group, keys=[self.group_id], start=start, end=end)[self.group_id]
