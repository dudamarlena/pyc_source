...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/web/frontend/debug/debug_new_processing_issues_email.py
...
class DebugNewProcessingIssuesEmailView(View):
    ...
    def get(self, request):
        ...
        return MailPreview(html_template='sentry/emails/activity/new_processing_issues.html', text_template='sentry/emails/activity/new_processing_issues.txt', context={'project': project, 
           ...
           'info_url': absolute_uri(('/settings/{}/projects/{}/processing-issues/').format(org.slug, project.slug))}).render(request)
