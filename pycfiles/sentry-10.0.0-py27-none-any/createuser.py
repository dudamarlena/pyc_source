...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/runner/commands/createuser.py
...
def createuser(email, password, superuser, no_password, no_input):
    ...
    user = User(email=email, username=email, is_superuser=superuser, is_staff=superuser, is_active=True)
    if password:
