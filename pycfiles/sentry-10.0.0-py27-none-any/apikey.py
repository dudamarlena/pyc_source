...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/apikey.py
...
from sentry.db.models import ArrayField, Model, BaseManager, BoundedPositiveIntegerField, FlexibleForeignKey, sane_repr
...
class ApiKey(Model):
    ...
    status = BoundedPositiveIntegerField(default=0, choices=(
     (
      ApiKeyStatus.ACTIVE, _('Active')), (ApiKeyStatus.INACTIVE, _('Inactive'))), db_index=True)
