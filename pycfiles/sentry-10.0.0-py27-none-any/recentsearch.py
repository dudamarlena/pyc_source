...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/recentsearch.py
...
def remove_excess_recent_searches(organization, user, search_type):
    ...
    """
    recent_searches_to_remove = RecentSearch.objects.filter(organization=organization, user=user, type=search_type).order_by('-last_seen')[MAX_RECENT_SEARCHES:]
