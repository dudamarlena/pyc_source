...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/warnings.py
# Compiled at: 2019-08-16 17:27:46
from __future__ import absolute_import
import collections, six, warnings
...
class DeprecatedSettingWarning(DeprecationWarning):
    ...
    def __str__(self):
        chunks = [
         ('The {} setting is deprecated. Please use {} instead.').format(self.setting, self.replacement)]
        if self.removed_in_version:
            chunks.append(('This setting will be removed in Sentry {}.').format(self.removed_in_version))
        if self.url:
