...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/serializers/models/incidentactivity.py
...
class IncidentActivitySerializer(Serializer):
    ...
    def get_attrs(self, item_list, user, **kwargs):
        ...
        serialized_users = serialize(set(item.user for item in item_list if item.user_id), user=user, serializer=user_serializer)
    ...
    def serialize(self, obj, attrs, user):
        ...
        if obj.event_stats_snapshot:
            ...
            event_stats = serializer.serialize(SnubaTSResult(obj.event_stats_snapshot.snuba_values, obj.event_stats_snapshot.start, obj.event_stats_snapshot.end, obj.event_stats_snapshot.period))
