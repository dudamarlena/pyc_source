...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/distutils/commands/build_assets.py
# Compiled at: 2019-11-01 16:39:51
from __future__ import absolute_import
import json, datetime, os, os.path, sys, traceback
...
class BuildAssetsCommand(BaseBuildCommand):
    user_options = BaseBuildCommand.user_options + [
     ...
     (
      'inplace',
      'i',
      'ignore build-lib and put compiled javascript files into the source ' + 'directory alongside your pure Python modules'),
    ...
    def _write_version_file(self, version_info):
        manifest = {'createdAt': datetime.datetime.utcnow().isoformat() + 'Z', 
