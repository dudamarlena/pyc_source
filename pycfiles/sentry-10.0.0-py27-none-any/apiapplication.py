...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/apiapplication.py
...
from sentry.db.models import Model, BaseManager, BoundedPositiveIntegerField, EncryptedTextField, FlexibleForeignKey, sane_repr
...
class ApiApplication(Model):
    ...
    status = BoundedPositiveIntegerField(default=0, choices=(
     ...
     (
      ApiApplicationStatus.inactive, _('Inactive'))), db_index=True)
