...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/lang/javascript/errormapping.py
# Compiled at: 2019-08-16 17:27:45
from __future__ import absolute_import
import re, json, time, logging, random, six
...
HARD_TIMEOUT = 7200
REACT_MAPPING_URL = 'https://raw.githubusercontent.com/facebook/react/master/scripts/error-codes/codes.json'
error_processors = {}
...
class Processor(object):
    ...
    def load_mapping(self):
        ...
        try:
            ...
            response = http_session.get(self.mapping_url, allow_redirects=True, timeout=settings.SENTRY_SOURCE_FETCH_TIMEOUT)
