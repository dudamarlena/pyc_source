...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/canonical.py
# Compiled at: 2019-08-16 17:27:46
from __future__ import absolute_import, print_function
from django.conf import settings
import copy, collections, six
__all__ = ('CanonicalKeyDict', 'CanonicalKeyView', 'get_canonical_name')
LEGACY_KEY_MAPPING = {'exception': ('sentry.interfaces.Exception', ), 
...
CANONICAL_KEY_MAPPING = {'message': ('logentry', 'sentry.interfaces.Message'), 
