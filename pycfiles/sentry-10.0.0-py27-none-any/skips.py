...
# [GCC 8.4.0]
# Embedded file name: /c/Users/byk/Documents/Projects/sentry/sentry/src/sentry/testutils/skips.py
...
requires_cassandra = pytest.mark.skipif(not cassandra_is_available(), reason='requires cassandra server running')
