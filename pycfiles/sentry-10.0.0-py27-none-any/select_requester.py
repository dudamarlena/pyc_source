...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/mediators/external_requests/select_requester.py
...
class SelectRequester(Mediator):
    ...
    def _make_request(self):
        try:
            ...
            logger.info('select-requester.error', extra={'sentry_app': self.sentry_app.slug, 
