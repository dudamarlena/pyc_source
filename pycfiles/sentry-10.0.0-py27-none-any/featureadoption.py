...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/models/featureadoption.py
...
manager.add(68, 'issue_tracker_integration', 'Issue Tracker Integration', 'web', prerequisite=[
 'first_project'])
manager.add(69, 'notification_integration', 'Notification Integration', 'web', prerequisite=[
 'first_project'])
manager.add(70, 'delete_and_discard', 'Delete and Discard Future Events', 'web', prerequisite=[
 'first_event'])
