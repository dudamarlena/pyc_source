...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/db/models/fields/node.py
# Compiled at: 2019-08-16 17:27:45
from __future__ import absolute_import, print_function
from base64 import b64encode
import collections, logging, six, warnings
...
class NodeData(collections.MutableMapping):
    ...
    def bind_data(self, data, ref=None):
        ...
        if self.field is not None and self.ref_version == self.field.ref_version and ref is not None and self.ref != ref:
            raise NodeIntegrityFailure('Node reference for %s is invalid: %s != %s' % (self.id, ref, self.ref))
