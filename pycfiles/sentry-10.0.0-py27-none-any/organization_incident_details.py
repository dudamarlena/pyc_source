...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/organization_incident_details.py
...
class OrganizationIncidentDetailsEndpoint(IncidentEndpoint):
    ...
    def put(self, request, organization, incident):
        ...
        if serializer.is_valid():
            ...
            try:
                incident = update_incident_status(incident=incident, status=result['status'], user=request.user, comment=result.get('comment'))
