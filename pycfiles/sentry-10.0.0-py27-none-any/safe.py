...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/utils/safe.py
...
def trim(value, max_size=settings.SENTRY_MAX_VARIABLE_SIZE, max_depth=6, object_hook=None, _depth=0, _size=0, **kwargs):
    """
