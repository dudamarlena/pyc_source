...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/organization_dashboard_widget_details.py
...
class OrganizationDashboardWidgetDetailsEndpoint(OrganizationDashboardWidgetEndpoint):
    ...
    def put(self, request, organization, dashboard, widget):
        ...
        with transaction.atomic():
            widget.update(title=data.get('title', widget.title), display_type=data.get('displayType', widget.display_type), display_options=data.get('displayOptions', widget.display_options))
