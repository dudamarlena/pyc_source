...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/project_group_stats.py
...
class ProjectGroupStatsEndpoint(ProjectEndpoint, EnvironmentMixin, StatsMixin):
    ...
    def get(self, request, project):
        ...
        if not group_ids:
            return Response(status=204)
        data = tsdb.get_range(model=tsdb.models.group, keys=group_ids, **self._parse_args(request, environment_id))
