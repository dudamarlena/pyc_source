...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/broadcast_details.py
        ...
        if not validator.is_valid():
            ...
            if update_kwargs:
                with transaction.atomic():
                    ...
                    logger.info('broadcasts.update', extra={'ip_address': request.META['REMOTE_ADDR'], 
