...
# [GCC 8.4.0]
# Embedded file name: /usr/src/sentry/src/sentry/api/endpoints/internal_mail.py
...
class InternalMailEndpoint(Endpoint):
    ...
    def get(self, request):
        data = {'mailHost': options.get('mail.host'), 
    ...
    def post(self, request):
        ...
        try:
            send_mail('%s Test Email' % (options.get('mail.subject-prefix'),), body, options.get('mail.from'), [
