...
# [GCC 8.4.0]
# Embedded file name: /home/cyberj/src/python/vtenv2.6/lib/python2.6/site-packages/signature/models.py
# Compiled at: 2011-08-30 05:14:52
...
class Key(models.Model):
    ...
    def generate(cls, passphrase, length=4096, user=None):
        ...
        keys = RSA.gen_key(length, 65537, callback=quiet_callback)
        key = cls()
        key.length = length
        bio = BIO.MemoryBuffer()
...
class Certificate(BaseCert):
    ...
    index = models.TextField(editable=False, default='')
