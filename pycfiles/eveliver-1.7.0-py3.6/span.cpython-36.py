...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/eveliver/span.py
# Compiled at: 2020-03-19 03:31:58
# Size of source mod 2**32: 2429 bytes
import collections, re, string, torch
...
def get_best_span(a, b):
    ...
    score = a.unsqueeze(1) + b.unsqueeze(2) - (torch.gt(ar.unsqueeze(0) - ar.unsqueeze(1), 0).long() + torch.lt(ar.unsqueeze(0) - ar.unsqueeze(1), -15).long()).unsqueeze(0) * 10000000.0
