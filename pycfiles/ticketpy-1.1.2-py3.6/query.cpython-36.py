...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\ticketpy\query.py
# Compiled at: 2017-10-21 19:19:19
# Size of source mod 2**32: 14060 bytes
"""Classes to handle API queries/searches"""
import requests
from ticketpy.model import Venue, Event, Attraction, Classification

class BaseQuery:
    __doc__ = 'Base query/parent class for specific serach types.'
    attr_map = {'start_date_time':'startDateTime', 
    ...
    def _get(self, keyword=None, entity_id=None, sort=None, include_test=None, page=None, size=None, locale=None, **kwargs):
        ...
        search_args.update({'keyword':keyword, 
         'id':entity_id, 
         'sort':sort, 
        ...
        return (self._BaseQuery__get)(**params)
    ...
    def _search_params(self, **kwargs):
        ...
        for k, v in kwargs.items():
            if k in self.attr_map.keys():
                ...
                if k in self.attr_map.values():
                    kw_map[k] = v
                else:
                    kw_map[k] = v

        return {k:v for k, v in kw_map.items() if v is not None if v is not None}


class AttractionQuery(BaseQuery):
    __doc__ = 'Query class for Attractions'

    def __init__(self, api_client):
        self.api_client = api_client
        super().__init__(api_client, 'attractions', Attraction)

    def find(self, sort=None, keyword=None, attraction_id=None, source=None, include_test=None, page=None, size=None, locale=None, **kwargs):
        """
...
class ClassificationQuery(BaseQuery):
    __doc__ = 'Classification search/query class'

    def __init__(self, api_client):
        super().__init__(api_client, 'classifications', Classification)

    def find(self, sort=None, keyword=None, classification_id=None, source=None, include_test=None, page=None, size=None, locale=None, **kwargs):
 ...
 page, size, locale, source=source, **kwargs)
    ...
    def subgenre_by_id(self, subgenre_id):
        ...
        if segment:
            subgenres = [subg for genre in segment.genres for subg in genre.subgenres]
...
class EventQuery(BaseQuery):
    __doc__ = 'Abstraction to search API for events'
 ...
 size, locale, latlong=latlong, radius=radius, unit=unit, 
         start_date_time=start_date_time, end_date_time=end_date_time, 
         onsale_start_date_time=onsale_start_date_time, 
         onsale_end_date_time=onsale_end_date_time, 
         country_code=country_code, 
         state_code=state_code, venue_id=venue_id, 
         attraction_id=attraction_id, segment_id=segment_id, 
         segment_name=segment_name, classification_name=classification_name, 
         classification_id=classification_id, 
         market_id=market_id, 
         promoter_id=promoter_id, dma_id=dma_id, 
         include_tba=include_tba, include_tbd=include_tbd, 
         source=source, client_visibility=client_visibility, **kwargs)

    def by_location(self, latitude, longitude, radius='10', unit='miles', sort='relevance,desc', **kwargs):
        ...
        return (self.find)(latlong=latlong, 
         radius=radius, 
         unit=unit, 
         sort=sort, **kwargs)
...
class VenueQuery(BaseQuery):
    __doc__ = 'Queries for venues'

    def __init__(self, api_client):
        super().__init__(api_client, 'venues', Venue)

    def find(self, keyword=None, venue_id=None, sort=None, state_code=None, country_code=None, source=None, include_test=None, page=None, size=None, locale=None, **kwargs):
 ...
 size, locale, state_code=state_code, country_code=country_code, 
