...
# [GCC 8.4.0]
# Embedded file name: /home/merzky/saga/troy/troy/plugins/strategy/plugin_strategy_basic_early_binding.py
    ...
    def execute(self, workload_id, planner, overlay_mgr, workload_mgr):
        ...
        try:
            ...
            for partition_id in workload.partitions[:1]:
                ...
                workload_mgr.bind_workload(partition.id, overlay.id, bind_mode=troy.EARLY)
                workload.state = partition.state
