...
# [GCC 8.4.0]
# Embedded file name: /home/merzky/saga/troy/troy/workload/workload.py
# Compiled at: 2014-02-27 11:31:04
__author__ = 'TROY Development Team'
__copyright__ = 'Copyright 2013, RADICAL'
__license__ = 'MIT'
import time, radical.utils as ru, troy.utils as tu
    ...
    * *Dispatching:* A scheduled workload is dispatched to the active entities
    ...
    def add_relation(self, descr):
        ...
        for d in descr:
            ...
            if d.head not in self.tasks:
                raise ValueError("relation head '%s' no known" % d.head)
            if d.tail not in self.tasks:
