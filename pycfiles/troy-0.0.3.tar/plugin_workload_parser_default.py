...
# [GCC 8.4.0]
# Embedded file name: /home/merzky/saga/troy/troy/plugins/workload_parser/plugin_workload_parser_default.py
# Compiled at: 2014-02-27 11:31:04
__author__ = 'TROY Development Team'
__copyright__ = 'Copyright 2013, RADICAL'
__license__ = 'MIT'
import radical.utils as ru, troy
PLUGIN_DESCRIPTION = {'type': 'workload_parser', 
   'name': 'default', 
   'version': '0.1', 
...
class PLUGIN_CLASS(troy.PluginBase):
    ...
    **Configuration Options:** None
    ...
    def parse(self, workload_description):
        ...
        return (
         task_descriptions, relation_descriptions)