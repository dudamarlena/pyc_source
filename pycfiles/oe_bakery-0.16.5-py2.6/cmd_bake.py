...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/oebakery/cmd_bake.py
# Compiled at: 2010-02-01 08:52:09
...
class BakeCommand:
    ...
    def run(self):
        ...
        if os.path.islink(os.environ['OE_TMPDIR']) and not os.path.exists(os.path.realpath(os.environ['OE_TMPDIR'])):
