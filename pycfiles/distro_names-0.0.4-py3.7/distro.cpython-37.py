...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/distro/distro.py
# Compiled at: 2019-07-30 22:11:37
...
class Distro:
    __doc__ = 'Distro data wrapper class. Instantiate with a dict'
    ...
    def __init__(self, **kwargs):
        ...
        if self.data.get('versions', None) is None:
            ...
            if isinstance(self.data.get('versions', None), str):
