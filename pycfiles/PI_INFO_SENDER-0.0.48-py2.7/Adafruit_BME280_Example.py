...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/PI_INFO_SENDER/Adafruit_BME280_Example.py
# Compiled at: 2016-09-01 23:01:50
from Adafruit_BME280 import *
import paho.mqtt.client as mqtt, time, json, sys, RPi.GPIO as GPIO, datetime, os, subprocess
IP = sys.argv[1]
PORT = sys.argv[2]
TOPIC = sys.argv[3]
