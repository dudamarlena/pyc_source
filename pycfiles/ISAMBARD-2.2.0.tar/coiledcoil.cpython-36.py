...
# [GCC 8.4.0]
# Embedded file name: /home/cw12401/code/work/isambard/src/isambard/specifications/coiledcoil.py
# Compiled at: 2018-04-18 05:03:52
...
class CoiledCoil(Assembly):
    ...
    def from_parameters(cls, n, aa=28, major_radius=None, major_pitch=None, phi_c_alpha=26.42, minor_helix_type='alpha', auto_build=True):
        ...
        if major_pitch is not None:
            instance.major_pitches = [
             major_pitch] * n
        if major_radius is not None:
            instance.major_radii = [
             major_radius] * n
        if auto_build:
            instance.build()
        return instance
    ...
    def tropocollagen(cls, aa=28, major_radius=5.0, major_pitch=85.0, auto_build=True):
        ...
        auto_build : bool, optional
            If `True`, the model will be built as part of instantiation.
        """
        instance = cls.from_parameters(n=3,
          aa=aa,
