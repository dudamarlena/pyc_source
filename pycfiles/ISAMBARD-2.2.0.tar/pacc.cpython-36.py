...
# [GCC 8.4.0]
# Embedded file name: /home/cw12401/code/work/isambard/src/isambard/evaluation/pacc.py
# Compiled at: 2018-06-29 05:37:35
...
def fit_heptad_register(crangles):
    ...
    hept_p = [x * 51.42857142857143 + 25.714285714285715 for x in range(7)]
    ideal_crangs = [
     hept_p[0],
     hept_p[2],
     hept_p[4],
