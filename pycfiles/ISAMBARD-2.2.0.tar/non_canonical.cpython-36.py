...
# [GCC 8.4.0]
# Embedded file name: /home/cw12401/code/work/isambard/src/isambard/modelling/non_canonical.py
# Compiled at: 2018-04-18 05:16:18
...
def convert_pro_to_hyp(pro):
    ...
    for atom in pro.get_atoms():
        ...
        atom.tags = {'bfactor':1.0,  'charge':' ',  'occupancy':1.0, 
         'state':'A'}
...
def align_nab(tar, ref):
    ...
    """
    rot_trans_1 = find_transformations(tar['N'].array, tar['CA'].array, ref['N'].array, ref['CA'].array)
