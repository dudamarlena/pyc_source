...
# [GCC 8.4.0]
# Embedded file name: /home/cw12401/code/work/isambard/src/isambard/modelling/create_loop_data.py
# Compiled at: 2018-05-24 06:03:05
# Size of source mod 2**32: 6223 bytes
...
def extract_data_for_loops(polypeptide, pdb_code, resolution, create_geometry_path=None):
    ...
    if create_geometry_path:
        ...
        for entering_reg, loop_reg, exiting_reg in loop_regions:
            loop_data, loop_geom = create_loop_dict(polypeptide,
              pp_primitive, entering_reg, loop_reg, exiting_reg, create_geometry_path=create_geometry_path)
...
def create_loop_dict(polypeptide, pp_primitive, entering_reg, loop_reg, exiting_reg, create_geometry_path=None):
    ...
    if not len(loop_region_primitives) == len(loop_and_flanking):
        ...
        if create_geometry_path:
            loop_geom = make_loop_geometry(entering_prims, entering_vector, exiting_prims, exiting_vector)
        else:
            loop_geom = None
    return (
     loop_data, loop_geom)
