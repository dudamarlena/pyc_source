...
# [GCC 8.4.0]
# Embedded file name: /home/anders/work/python/django-pagetimer/pagetimer/tests/test_views.py
# Compiled at: 2016-05-11 11:28:27
...
class EndpointTest(TestCase):
    ...
    def test_not_logged_in(self):
        r = self.client.post(reverse('pagetimer-endpoint'), dict(path='/something/random'))
...
class PurgeTest(TestCase):
    ...
    def test_post(self):
        ...
        u.save()
        self.client.login(username='testuser', password='password')
        r = self.client.post(reverse('pagetimer-purge'), dict(timestamp='2000-01-01 01:01:01'))
