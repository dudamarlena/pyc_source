...
# [GCC 8.4.0]
# Embedded file name: /home/anders/work/python/django-pagetimer/pagetimer/views.py
# Compiled at: 2016-05-11 11:29:55
import csv
...
class PageTimerEndpointView(View):
    ...
    def post(self, request):
        ...
        ipaddress = request.META.get('HTTP_X_FORWARDED_FOR', request.META.get('REMOTE_ADDR', 'none'))
        PageVisit.objects.log_visit(username, session_key, path, ipaddress)
