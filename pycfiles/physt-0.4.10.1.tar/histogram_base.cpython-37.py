...
# [GCC 8.4.0]
# Embedded file name: /home/honza/code/my/physt/tests/../physt/histogram_base.py
# Compiled at: 2020-02-17 14:15:36
# Size of source mod 2**32: 29168 bytes
...
class HistogramBase(abc.ABC):
    ...
    def _merge_meta_data(cls, first: 'HistogramBase', second: 'HistogramBase') -> dict:
        ...
        return {key:(first._meta_data.get(key, None) if first._meta_data.get(key, None) == second._meta_data.get(key, None) else None) for key in keys}
