...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.docs/test/test_web_output.py
# Compiled at: 2011-11-10 12:14:02
"""
...
def test_recipes():
    ...
    response, content = http.request('http://0.0.0.0:8000/recipes', headers={'Accept': 'text/x-tiddlyweb-docs'})
    _confirm_recipes(response, content)
...
def test_recipe():
    ...
    response, content = http.request('http://0.0.0.0:8000/recipes/foobar', headers={'Accept': 'text/x-tiddlyweb-docs'})
    _confirm_recipe(response, content)
...
def test_recipe_tiddlers():
    ...
    response, content = http.request('http://0.0.0.0:8000/recipes/foobar/tiddlers', headers={'Accept': 'text/x-tiddlyweb-docs'})
    _confirm_recipe_tiddlers(response, content)
...
def test_recipe_tiddler():
    ...
    response, content = http.request('http://0.0.0.0:8000/recipes/foobar/tiddlers/fuss', headers={'Accept': 'text/x-tiddlyweb-docs'})
    _confirm_recipe_tiddler(response, content)
