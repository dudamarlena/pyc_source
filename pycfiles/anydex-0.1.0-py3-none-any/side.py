...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/core/side.py
...
class Side(object):
    ...
    def insert_tick(self, tick):
        ...
        """
        if (
         tick.assets.second.asset_id, tick.assets.first.asset_id) not in self._price_level_list_map:
        ...
        if not self._price_level_exists(tick.price):
    ...
    def get_list_representation(self):
        ...
        for asset1, asset2 in self._price_level_list_map.keys():
            rlist.append({'asset1': asset2, 'asset2': asset1, 'ticks': self._price_level_list_map[(asset1, asset2)].get_ticks_list()})
