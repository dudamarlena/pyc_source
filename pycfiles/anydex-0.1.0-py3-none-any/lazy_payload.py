...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/pyipv8/ipv8/messaging/lazy_payload.py
...
class VariablePayload(Payload):
    ...
    def __init__(self, *args, **kwargs):
        ...
        index = 0
        fwd_args = {}
        if not issubclass(super(VariablePayload, self).__class__, VariablePayload) and inspect.ismethod(super(VariablePayload, self).__init__):
