...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/pyipv8/ipv8/keyvault/crypto.py
...
_CURVES = {'very-low': (ec.SECT163K1, 'M2Crypto'), 'low': (
         ec.SECT233K1, 'M2Crypto'), 
   'medium': (
            ec.SECT409K1, 'M2Crypto'), 
   'high': (
          ec.SECT571R1, 'M2Crypto'), 
