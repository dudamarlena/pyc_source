...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/pyipv8/ipv8/keyvault/public/m2crypto.py
...
class M2CryptoPK(PublicKey):
    ...
    def pem_to_bin(self, pem):
        ...
        """
        return decodestring(('').join(pem.split('\n')[1:-2]))

    def key_to_pem(self):
        """Convert a key to the PEM format."""
        return self.ec.public_bytes(encoding=serialization.Encoding.PEM, format=serialization.PublicFormat.SubjectPublicKeyInfo)
