...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/../pyipv8/ipv8/attestation/wallet/bonehexact/cryptosystem/value.py
...
class FP2Value(object):
    ...
    def __add__(self, other):
        ...
        a = self.aC * other.a - self.cC * other.a + self.a * other.aC - self.c * other.aC - self.bC * other.b + self.cC * other.b - self.aC * other.c + self.bC * other.c - self.a * other.cC + self.b * other.cC
        b = self.bC * other.a - self.cC * other.a + self.b * other.aC - self.c * other.aC + self.aC * other.b - self.bC * other.b + self.a * other.bC - self.b * other.bC - self.aC * other.c + self.cC * other.c - self.a * other.cC + self.c * other.cC
        aC = self.aC * other.aC - self.cC * other.aC - self.bC * other.bC + self.cC * other.bC - self.aC * other.cC + self.bC * other.cC
        bC = self.bC * other.aC - self.cC * other.aC + self.aC * other.bC - self.bC * other.bC - self.aC * other.cC + self.cC * other.cC
    ...
    def __sub__(self, other):
        ...
        """
        assert self.mod == other.mod
        a = -self.aC * other.a + self.cC * other.a + self.a * other.aC - self.c * other.aC + self.bC * other.b - self.cC * other.b - self.b * other.bC + self.c * other.bC + self.aC * other.c - self.bC * other.c - self.a * other.cC + self.b * other.cC
        b = -self.bC * other.a + self.cC * other.a + self.b * other.aC - self.c * other.aC - self.aC * other.b + self.bC * other.b + self.a * other.bC - self.b * other.bC + self.aC * other.c - self.cC * other.c - self.a * other.cC + self.c * other.cC
        aC = self.aC * other.aC - self.cC * other.aC - self.bC * other.bC + self.cC * other.bC - self.aC * other.cC + self.bC * other.cC
        bC = self.bC * other.aC - self.cC * other.aC + self.aC * other.bC - self.bC * other.bC - self.aC * other.cC + self.cC * other.cC
        return FP2Value(self.mod, a=a, b=b, aC=aC, bC=bC)
    ...
    def __mul__(self, other):
        ...
        """
        assert self.mod == other.mod
        a = self.a * other.a - self.c * other.a - self.b * other.b + self.c * other.b - self.a * other.c + self.b * other.c
        b = self.b * other.a - self.c * other.a + self.a * other.b - self.b * other.b - self.a * other.c + self.c * other.c
        aC = self.aC * other.aC - self.cC * other.aC - self.bC * other.bC + self.cC * other.bC - self.aC * other.cC + self.bC * other.cC
        bC = self.bC * other.aC - self.cC * other.aC + self.aC * other.bC - self.bC * other.bC - self.aC * other.cC + self.cC * other.cC
        return FP2Value(self.mod, a=a, b=b, aC=aC, bC=bC)
    ...
    def __floordiv__(self, other):
        ...
        """
        assert self.mod == other.mod
        a = self.a * other.aC - self.c * other.aC - self.b * other.bC + self.c * other.bC - self.a * other.cC + self.b * other.cC
        b = self.b * other.aC - self.c * other.aC + self.a * other.bC - self.b * other.bC - self.a * other.cC + self.c * other.cC
        aC = self.aC * other.a - self.cC * other.a - self.bC * other.b + self.cC * other.b - self.aC * other.c + self.bC * other.c
        bC = self.bC * other.a - self.cC * other.a + self.aC * other.b - self.bC * other.b - self.aC * other.c + self.cC * other.c
        return FP2Value(self.mod, a=a, b=b, aC=aC, bC=bC)
