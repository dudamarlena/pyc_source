...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/pyipv8/ipv8/test/mocking/rest/rest_api_peer.py
...
class RestTestPeer(object):
    ...
    def __init__(self, port, overlay_classes, interface='127.0.0.1', memory_dbs=True):
        ...
        self._port = port
        self._interface = interface
        self._ipv8 = TestRestIPv8('curve25519', port, interface, overlay_classes, memory_dbs)
...
class InteractiveRestTestPeer(RestTestPeer, threading.Thread):
    ...
    def __init__(self, port, overlay_classes, get_style_requests, post_style_requests, interface='127.0.0.1', memory_dbs=True):
        """
