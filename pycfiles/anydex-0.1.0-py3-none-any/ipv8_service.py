...
# [GCC 8.4.0]
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/../pyipv8/ipv8_service.py
# Compiled at: 2019-05-23 05:44:26
...
if hasattr(sys.modules['__main__'], 'IPv8'):
    ...
    if __name__ == '__main__' or __name__ == 'ipv8_service':
        ...
        from .ipv8.peerdiscovery.network import Network
        from .ipv8.dht.discovery import DHTDiscoveryCommunity
    _COMMUNITIES = {'AttestationCommunity': AttestationCommunity, 
    ...
    class IPv8(object):
        ...
        def unload_overlay(self, instance):
            with self.overlay_lock:
                ...
                self.strategies = [ (strategy, target_peers) for strategy, target_peers in self.strategies if strategy.overlay != instance ]
