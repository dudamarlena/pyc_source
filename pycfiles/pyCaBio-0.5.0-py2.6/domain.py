...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/cabig/cabio/domain.py
...
class AgentAlias(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.AgentAlias_Def(None).pyclass()
...
class Agent(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Agent_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Anomaly(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Anomaly_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ArrayReporterCytogeneticLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ArrayReporterCytogeneticLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ArrayReporterPhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ArrayReporterPhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ArrayReporter(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ArrayReporter_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Chromosome(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Chromosome_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ClinicalTrialProtocol(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ClinicalTrialProtocol_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class CloneRelativeLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.CloneRelativeLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Clone(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Clone_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ConstrainedRegion(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ConstrainedRegion_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class CytobandPhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.CytobandPhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Cytoband(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Cytoband_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class CytogeneticLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.CytogeneticLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class DiseaseOntologyRelationship(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.DiseaseOntologyRelationship_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class DiseaseOntology(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.DiseaseOntology_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class EvidenceCode(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.EvidenceCode_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Evidence(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Evidence_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ExonArrayReporter(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ExonArrayReporter_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Exon(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Exon_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ExpressedSequenceTag(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ExpressedSequenceTag_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ExpressionArrayReporter(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ExpressionArrayReporter_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneAgentAssociation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneAgentAssociation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneAlias(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneAlias_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneCytogeneticLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneCytogeneticLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneDiseaseAssociation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneDiseaseAssociation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneFunctionAssociation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneFunctionAssociation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneOntologyRelationship(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneOntologyRelationship_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneOntology(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneOntology_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GenePhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GenePhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class GeneRelativeLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.GeneRelativeLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Gene(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Gene_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Histopathology(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Histopathology_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class HomologousAssociation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.HomologousAssociation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Library(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Library_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Location(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Location_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class MarkerAlias(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.MarkerAlias_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class MarkerPhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.MarkerPhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class MarkerRelativeLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.MarkerRelativeLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Marker(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Marker_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class MessengerRNA(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.MessengerRNA_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Microarray(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Microarray_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class MultipleAlignment(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.MultipleAlignment_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class NucleicAcidPhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.NucleicAcidPhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class NucleicAcidSequence(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.NucleicAcidSequence_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class OrganOntologyRelationship(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.OrganOntologyRelationship_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class OrganOntology(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.OrganOntology_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Pathway(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Pathway_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class PhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.PhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class PopulationFrequency(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.PopulationFrequency_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ProteinAlias(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ProteinAlias_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ProteinDomain(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ProteinDomain_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ProteinSequence(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ProteinSequence_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Protein(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Protein_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class ProtocolAssociation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.ProtocolAssociation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Protocol(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Protocol_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class RelativeLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.RelativeLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class SNPArrayReporter(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.SNPArrayReporter_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class SNPCytogeneticLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.SNPCytogeneticLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class SNPPhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.SNPPhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class SNP(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.SNP_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Target(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Target_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Taxon(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Taxon_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Tissue(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Tissue_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class TranscriptArrayReporter(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.TranscriptArrayReporter_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class TranscriptPhysicalLocation(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.TranscriptPhysicalLocation_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Transcript(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Transcript_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return
...
class Vocabulary(WSBean):
    ...
    def __init__(self, holder=None, service=None, **kwargs):
        if not holder:
            holder = schema.Vocabulary_Def(None).pyclass()
        WSBean.__init__(self, holder, service=service, **kwargs)
        return