...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/irssiicon/rforward.py
# Compiled at: 2014-10-31 15:27:08
"""
...
"""
import getpass, os, socket, select, sys, threading
...
HELP = 'Set up a reverse forwarding tunnel across an SSH server, using paramiko. A\nport on the SSH server (given with -p) is forwarded across an SSH session\nback to the local machine, and out to a remote site reachable from this\nnetwork. This is similar to the openssh -R option.\n'
