...
# [GCC 8.4.0]
# Embedded file name: ../kazam/frontend/done_recording.py
# Compiled at: 2019-08-17 21:55:54
# Size of source mod 2**32: 6262 bytes
...
class DoneRecording(Gtk.Window):
    ...
    def __init__(self, icons, tempfile, codec, old_path):
        ...
        self.grid.attach_next_to(self.combobox_editor, self.radiobutton_edit, Gtk.PositionType.RIGHT, 1, 1)
