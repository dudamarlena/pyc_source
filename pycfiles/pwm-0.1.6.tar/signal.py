...
# Embedded file name: build/bdist.linux-x86_64/egg/pwl_maker/signal.py
# Compiled at: 2014-11-01 21:29:45


class Signal(object):
    signal_id = -1

    def __init__(self, name='', initial_value=0, low=0, high=1, slew=0.001):
