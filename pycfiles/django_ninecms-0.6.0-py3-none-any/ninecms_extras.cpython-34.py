...
# [GCC 8.4.0]
# Embedded file name: /home/gkarak/workspace/python/django-ninecms/ninecms/templatetags/ninecms_extras.py
...
class FieldsetNode(template.Node):
    __doc__ = " Fieldset renderer for 'fieldset' tag (see below) "
    ...
    def render(self, context):
        ...
        return t.render(Context({'var': self.nodelist.render(context), 
         'name': self.fieldset_name.resolve(context) if self.resolve else self.fieldset_name, 
         'id': self.fieldset_id}, autoescape=context.autoescape))
