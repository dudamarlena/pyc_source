...
# [GCC 8.4.0]
# Embedded file name: /home/gkarak/workspace/python/rabelvideo/ninecms/utils/status.py
# Compiled at: 2015-12-09 03:19:50
...
import sys, os, pip, ninecms

class Capturing(list):
    __doc__ = ' Capture the stdout using a with statement '
...
def user_stat(user):
    ...
    """
    u = User.objects.all()
    user_stats_config_keys = ('type', 'icon', 'url', 'url_parameters', 'queryset',
                              'date_field')
    user_stats_config = (
     (
    ...
    for stat_list in user_stats_config:
        ...
        user_stats.append({'stat_type': stat['type'], 
         'icon': stat['icon'], 
         'url': stat['url'], 
