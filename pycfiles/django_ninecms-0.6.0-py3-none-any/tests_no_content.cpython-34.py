...
# [GCC 8.4.0]
# Embedded file name: /home/gkarak/workspace/python/django-ninecms/ninecms/tests/tests_no_content.py
...
class NoContentTests(TestCase):
    __doc__ = ' Tests with no initial content and no login '
    ...
    def test_checks(self):
        ...
        with self.settings(MEDIA_ROOT=None, MEDIA_URL=None, ADMINS=None, MANAGERS=None, SESSION_COOKIE_NAME='sessionid', CACHES={'default': {'BACKEND': 'django.core.cache.backends.memcached.MemcachedCache', 
                     'KEY_PREFIX': None}}):
