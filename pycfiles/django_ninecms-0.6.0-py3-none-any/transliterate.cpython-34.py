...
# [GCC 8.4.0]
# Embedded file name: /home/gkarak/workspace/python/django-ninecms/ninecms/utils/transliterate.py
...
def transliterate(s, filename=False, to_lower=False):
    ...
    """
    mapping = {'el': ('αβγδεζηικλμνξοπρστυφωΑΒΓΔΕΖΗΙΚΛΜΝΞΟΠΡΣΤΥΦΩάέίήύόώϊϋΐΰςΆΈΊΉΎΌΏ', 'abgdeziiklmnxoprstyfoABGDEZIIKLMNXOPRSTYFOaeiiyooiyiysAEIIYOO'), 
     'rs': ('абвгдезијклмнопрстуфхцАБВГДЕЗИЈКЛМНОПРСТУФХЦ', 'abvgdezijklmnoprstufhcABVGDEZIJKLMNOPRSTUFHC'), 
     'ru': ('абвгдезийклмнопрстуфхъыьАБВГДЕЗИЙКЛМНОПРСТУФХЪЫЬ', 'abvgdezijklmnoprstufh_y_ABVGDEZIJKLMNOPRSTUFH_Y_'), 
     'bg': ('абвгдезийклмнопрстуфхАБВГДЕЗИЙКЛМНОПРСТУФХ', 'abvgdeziyklmnoprstufhABVGDEZIYKLMNOPRSTUFH')}
    ext_mapping = {'el': (('θ', 'χ', 'ψ', 'Θ', 'Χ', 'Ψ'), ('th', 'ch', 'ps', 'Th', 'Ch', 'Ps')), 
     'rs': (('ђ', 'ж', 'љ', 'њ', 'ћ', 'ч', 'џ', 'ш', 'Ђ', 'Ж', 'Љ', 'Њ', 'Ћ', 'Ч', 'Џ', 'Ш'),
 ('dj', 'zh', 'lj', 'nj', 'c', 'ch', 'dz', 'sh', 'Dj', 'Zh', 'Lj', 'Nj', 'C', 'Ch', 'Dz', 'Sh')), 
     'rs_latin': (('đ', 'ž', 'ć', 'č', 'š', 'Đ', 'Ž', 'Ć', 'Č', 'Š'), ('dj', 'zh', 'c', 'ch', 'sh', 'Dj', 'Zh', 'C', 'Ch', 'Sh')), 
     'ru': (('ж', 'ц', 'ч', 'ш', 'щ', 'ю', 'я', 'Ж', 'Ц', 'Ч', 'Ш', 'Щ', 'Ю', 'Я'), ('zh', 'ts', 'ch', 'sh', 'sch', 'ju', 'ja', 'Zh', 'Ts', 'Ch', 'Sh', 'Sch', 'Ju', 'Ja')), 
     'bg': (('ж', 'ц', 'ч', 'ш', 'щ', 'ю', 'я', 'Ж', 'Ц', 'Ч', 'Ш', 'Щ', 'Ю', 'Я'), ('zh', 'ts', 'ch', 'sh', 'sht', 'yu', 'ya', 'Zh', 'Ts', 'Ch', 'Sh', 'Sht', 'Yu', 'Ya'))}
    for lang in mapping:
