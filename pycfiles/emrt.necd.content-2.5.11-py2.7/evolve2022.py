...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/emrt/necd/content/upgrades/evolve2022.py
...
def reindex_observation(obs, catalog):
    catalog.catalog_object(obs, idxs=tuple(['ms_key_category']), update_metadata=1)
