...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/poll/__init__.py
# Compiled at: 2015-08-24 11:18:56
# Size of source mod 2**32: 11455 bytes
"""
Utilities for polling, retrying, and exception handling.
"""
import collections, inspect, time
...
def exec_(f, ex, until, times=3, timeout=15, interval=1, on_error=lambda e, x: None, *args, **kwargs):
    ...
    while 1:
        ...
        if time.perf_counter() - start_time > timeout:
            msg = "The operation '{}' timed out after {} seconds and {} attempts".format(f.__name__, timeout, count)
