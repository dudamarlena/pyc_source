...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/unit/html/test_player_page.py
...
class TestPlayerPage(TestCase):
    ...
    def test_totals_table_is_first_table_when_totals_tables(self):
        ...
        self.assertEqual(PlayerPage(html=html).totals_table, PlayerPageTotalsTable(html=first_table))
        html.xpath.assert_called_once_with('.//table[@id="per_game"]')