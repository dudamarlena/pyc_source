...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/integration/test_player_regular_season_box_scores.py
...
class TestPlayerRegularSeasonBoxScores(TestCase):
    ...
    def test_get_season_box_scores_for_player_that_does_not_exist_raises_exception(self):
        self.assertRaisesRegex(InvalidPlayerAndSeason,
    ...
    def test_outputting_2019_regular_season_box_scores_for_avery_bradley_as_json(self):
        results = regular_season_player_box_scores(player_identifier='bradlav01',
    ...
    def test_outputting_2019_regular_season_box_scores_for_avery_bradley_as_csv(self):
        output_file_path = os.path.join(os.path.dirname(__file__), './output/test-avery-2019.csv')
        regular_season_player_box_scores(player_identifier='bradlav01',
          season_end_year=2019,
