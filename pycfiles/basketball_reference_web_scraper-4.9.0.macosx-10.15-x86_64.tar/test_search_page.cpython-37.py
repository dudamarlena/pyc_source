...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/unit/html/test_search_page.py
...
class TestSearchPage(TestCase):
    ...
    def test_nba_aba_baa_players_content_query(self):
        self.assertEqual(SearchPage(html=(MagicMock())).nba_aba_baa_players_content_query, '//div[@id="searches"]/div[@id="players"]')
    ...
    def test_nba_aba_baa_players_pagination_links_query(self, mocked_query):
        ...
        self.assertEqual(SearchPage(html=(MagicMock())).nba_aba_baa_players_pagination_links_query, 'some query/div[@class="search-pagination"]/a')

    @patch.object(SearchPage, 'nba_aba_baa_players_content_query', new_callable=PropertyMock)
    def test_nba_aba_baa_player_search_items_query(self, mocked_query):
        mocked_query.return_value = 'some query'
        self.assertEqual(SearchPage(html=(MagicMock())).nba_aba_baa_player_search_items_query, 'some query/div[@class="search-item"]')
    ...
    def test_nba_aba_baa_players_pagination_links(self, mocked_query):
        ...
        self.assertEqual(SearchPage(html=html).nba_aba_baa_players_pagination_links, links)
    ...
    @patch.object(SearchPage, 'nba_aba_baa_players_pagination_links', new_callable=PropertyMock)
    def test_nba_aba_baa_players_pagination_url_is_first_link_href_attrib_when_single_link_is_not_at_end_of_results(self, mocked_links):
        link = MagicMock()
        ...
        self.assertEqual(SearchPage(html=(MagicMock())).nba_aba_baa_players_pagination_url, 'some text content')
    ...
    def test_nba_aba_baa_players_pagination_url_is_second_link_href_attrib_when_multiple_links(self, mocked_links):
        ...
        self.assertEqual(SearchPage(html=(MagicMock())).nba_aba_baa_players_pagination_url, 'some other text content')
    ...
    def test_nba_aba_baa_players(self, mocked_query):
        ...
        self.assertEqual(SearchPage(html=html).nba_aba_baa_players, [
