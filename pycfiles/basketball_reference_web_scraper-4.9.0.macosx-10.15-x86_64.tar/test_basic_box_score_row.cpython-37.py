...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/unit/html/test_basic_box_score_row.py
...
class TestBasicBoxScoreRow(TestCase):
    ...
    def test_made_three_point_field_goals_when_cells_exist(self):
        ...
        self.html.xpath = MagicMock(return_value=[cell])
        self.assertEqual(BasicBoxScoreRow(html=(self.html)).made_three_point_field_goals, 'some made three point field goals')
    ...
    def test_attempted_three_point_field_goals_when_cells_exist(self):
        ...
        self.html.xpath = MagicMock(return_value=[cell])
        self.assertEqual(BasicBoxScoreRow(html=(self.html)).attempted_three_point_field_goals, 'some attempted three point field goals')
