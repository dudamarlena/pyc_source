...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/integration/parsers/test_parse_teams.py
...
from basketball_reference_web_scraper.parsers import TeamAbbreviationParser, TeamTotalsParser

class TestParseTeams(TestCase):

    def setUp(self):
        self.atlanta_box_score_2017_01_01 = requests.get('https://www.basketball-reference.com/boxscores/201701010ATL.html').text
        ...
        self.combined_team_totals = [TeamTotal(team_abbreviation=(table.team_abbreviation), totals=(table.team_totals)) for table in self.page.basic_statistics_tables]
        self.parser = TeamTotalsParser(team_abbreviation_parser=(self.team_abbreviation_parser))
        self.team_totals = self.parser.parse(first_team_totals=(self.combined_team_totals[0]),
