...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/integration/parsers/test_parse_player_advanced_season_totals.py
# Compiled at: 2020-03-05 11:58:35
# Size of source mod 2**32: 5553 bytes
from unittest import TestCase
import requests
from lxml import html
from basketball_reference_web_scraper.data import Team, Position, TEAM_ABBREVIATIONS_TO_TEAM, POSITION_ABBREVIATIONS_TO_POSITION
from basketball_reference_web_scraper.html import PlayerAdvancedSeasonTotalsTable
from basketball_reference_web_scraper.parsers import PlayerAdvancedSeasonTotalsParser, PositionAbbreviationParser, TeamAbbreviationParser

class TestPlayersAdvancedSeasonTotals(TestCase):

    def setUp(self):
        self.season_2019_totals = requests.get('https://www.basketball-reference.com/leagues/NBA_2019_advanced.html').text
        self.parser = PlayerAdvancedSeasonTotalsParser(position_abbreviation_parser=PositionAbbreviationParser(abbreviations_to_positions=POSITION_ABBREVIATIONS_TO_POSITION),
