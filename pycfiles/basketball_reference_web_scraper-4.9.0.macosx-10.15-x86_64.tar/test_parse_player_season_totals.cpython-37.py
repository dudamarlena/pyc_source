...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/integration/parsers/test_parse_player_season_totals.py
# Compiled at: 2020-03-05 11:58:35
# Size of source mod 2**32: 11330 bytes
import os
from unittest import TestCase
import requests
from lxml import html
from basketball_reference_web_scraper.data import Team, Position, POSITION_ABBREVIATIONS_TO_POSITION, TEAM_ABBREVIATIONS_TO_TEAM
from basketball_reference_web_scraper.html import PlayerSeasonTotalTable
from basketball_reference_web_scraper.parsers import PositionAbbreviationParser, TeamAbbreviationParser, PlayerSeasonTotalsParser

class TestPlayersSeasonTotals(TestCase):

    def setUp(self):
        self.season_2001_totals = requests.get('https://www.basketball-reference.com/leagues/NBA_2001_totals.html').text
        self.season_2018_totals = requests.get('https://www.basketball-reference.com/leagues/NBA_2018_totals.html').text
        self.season_2019_totals = requests.get('https://www.basketball-reference.com/leagues/NBA_2019_totals.html').text
        self.jemerrio_jones_blank_age_2019_totals_file = open(os.path.join(os.path.dirname(__file__), '../files/NBA_2019_totals_jemerrio_jones_blank_age.html'))
        self.jemerrio_jones_with_a_blank_age_2019_totals = self.jemerrio_jones_blank_age_2019_totals_file.read()
        self.parser = PlayerSeasonTotalsParser(position_abbreviation_parser=PositionAbbreviationParser(abbreviations_to_positions=POSITION_ABBREVIATIONS_TO_POSITION),
