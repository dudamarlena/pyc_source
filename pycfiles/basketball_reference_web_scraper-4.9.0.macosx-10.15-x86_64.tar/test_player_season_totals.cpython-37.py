...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/unit/client/test_player_season_totals.py
...
class TestPlayerSeasonTotals(TestCase):
    ...
    @patch('basketball_reference_web_scraper.http_client.players_season_totals')
    ...
    def test_other_http_error_is_raised(self, mocked_players_season_totals):
        mocked_players_season_totals.side_effect = HTTPError(response=MagicMock(status_code=(codes.internal_server_error)))
