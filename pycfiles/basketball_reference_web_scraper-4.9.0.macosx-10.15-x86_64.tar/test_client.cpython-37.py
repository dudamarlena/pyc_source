...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/integration/test_client.py
...
class TestClient(TestCase):
    ...
    def test_output_json_box_scores_to_file(self):
        output_file_path = os.path.join(os.path.dirname(__file__), './output/foo.json')
        client.player_box_scores(day=1,
          month=1,
          year=2001,
    ...
    def test_output_json_box_scores_to_memory(self):
        january_first_box_scores = client.player_box_scores(day=1,
          month=1,
          year=2001,
          output_type=(OutputType.JSON))
    ...
    def test_BOS_2018_10_16_play_by_play(self):
        play_by_play = client.play_by_play(home_team=(Team.BOSTON_CELTICS),
          day=16,
          month=10,
          year=2018)
    ...
    def test_BOS_2018_10_16_play_by_play_csv_to_file(self):
        output_file_path = os.path.join(os.path.dirname(__file__), './output/2018_10_16_BOS_pbp.csv')
        client.play_by_play(home_team=(Team.BOSTON_CELTICS),
          day=16,
          month=10,
          year=2018,
          output_type=(OutputType.CSV),
    ...
    def test_overtime_play_by_play(self):
        play_by_play = client.play_by_play(home_team=(Team.PORTLAND_TRAIL_BLAZERS),
          day=22,
          month=10,
          year=2018)
    ...
    def test_overtime_play_by_play_to_csv(self):
        output_file_path = os.path.join(os.path.dirname(__file__), './output/2018_10_22_POR_pbp.csv')
        client.play_by_play(home_team=(Team.PORTLAND_TRAIL_BLAZERS),
          day=22,
          month=10,
          year=2018,
          output_type=(OutputType.CSV),
    ...
    def test_BOS_2018_10_16_play_by_play_json_to_file(self):
        output_file_path = os.path.join(os.path.dirname(__file__), './output/2018_10_16_BOS_pbp.json')
        client.play_by_play(home_team=(Team.BOSTON_CELTICS),
          day=16,
          month=10,
          year=2018,
    ...
    def test_overtime_play_by_play_to_json_file(self):
        output_file_path = os.path.join(os.path.dirname(__file__), './output/2018_10_22_POR_pbp.json')
        client.play_by_play(home_team=(Team.PORTLAND_TRAIL_BLAZERS),
          day=22,
          month=10,
          year=2018,
