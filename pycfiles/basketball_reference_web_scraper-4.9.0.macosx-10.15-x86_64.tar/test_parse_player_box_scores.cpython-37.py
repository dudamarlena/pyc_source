...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/integration/parsers/test_parse_player_box_scores.py
# Compiled at: 2020-03-05 11:58:35
# Size of source mod 2**32: 6123 bytes
from unittest import TestCase
import requests
from lxml import html
from basketball_reference_web_scraper.data import TEAM_ABBREVIATIONS_TO_TEAM, LOCATION_ABBREVIATIONS_TO_POSITION, OUTCOME_ABBREVIATIONS_TO_OUTCOME
...
from basketball_reference_web_scraper.parsers import TeamAbbreviationParser, LocationAbbreviationParser, OutcomeAbbreviationParser, SecondsPlayedParser, PlayerBoxScoresParser

class TestPlayerBoxScores(TestCase):

    def setUp(self):
        self.november_01_2006_daily_leaders = requests.get('https://www.basketball-reference.com/friv/dailyleaders.fcgi?month=11&day=1&year=2006').text
        self.december_18_2015_daily_leaders = requests.get('https://www.basketball-reference.com/friv/dailyleaders.fcgi?month=12&day=18&year=2015').text
        self.november_03_2003_daily_leaders = requests.get('https://www.basketball-reference.com/friv/dailyleaders.fcgi?month=11&day=03&year=2003').text
        self.december_12_2017_daily_leaders = requests.get('https://www.basketball-reference.com/friv/dailyleaders.fcgi?month=12&day=12&year=2017').text
        self.january_29_2017_daily_leaders = requests.get('https://www.basketball-reference.com/friv/dailyleaders.fcgi?month=1&day=29&year=2017').text
        ...
        self.player_box_scores_parser = PlayerBoxScoresParser(team_abbreviation_parser=(self.team_abbreviation_parser),
