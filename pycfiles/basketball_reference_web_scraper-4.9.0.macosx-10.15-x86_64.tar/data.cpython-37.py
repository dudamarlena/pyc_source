...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/basketball_reference_web_scraper/data.py
...
TEAM_ABBREVIATIONS_TO_TEAM = {'ATL':Team.ATLANTA_HAWKS, 
...
TEAM_NAME_TO_TEAM = {'ATLANTA HAWKS':Team.ATLANTA_HAWKS, 
...
POSITION_ABBREVIATIONS_TO_POSITION = {'PG':Position.POINT_GUARD, 
 ...
 'F':Position.FORWARD, 
 'G':Position.GUARD}
LOCATION_ABBREVIATIONS_TO_POSITION = {'':Location.HOME, 
 '@':Location.AWAY}
OUTCOME_ABBREVIATIONS_TO_OUTCOME = {'W':Outcome.WIN, 
 'L':Outcome.LOSS}
LEAGUE_ABBREVIATIONS_TO_LEAGUE = {'NBA':League.NATIONAL_BASKETBALL_ASSOCIATION, 
