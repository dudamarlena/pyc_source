...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/unit/parsers/test_player_data_parser.py
...
class TestPlayerDataParser(TestCase):
    ...
    def setUp(self):
        self.parser = PlayerDataParser(search_result_location_parser=ResourceLocationParser(resource_location_regex=SEARCH_RESULT_RESOURCE_LOCATION_REGEX),
          league_abbreviation_parser=LeagueAbbreviationParser(abbreviations_to_league=LEAGUE_ABBREVIATIONS_TO_LEAGUE))

    def test_parse_name(self):
        parsed_player = self.parser.parse(player=PlayerData(name='jaebaebae',
