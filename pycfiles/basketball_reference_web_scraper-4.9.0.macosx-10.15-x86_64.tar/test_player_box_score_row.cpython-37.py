...
# [GCC 8.4.0]
# Embedded file name: /Users/jaebradley/.virtualenvs/basketball_reference_web_scraper/lib/python3.7/site-packages/tests/unit/html/test_player_box_score_row.py
...
class TestPlayerBoxScoreRow(TestCase):
    ...
    def test_not_equal_when_both_rows_but_different_html(self):
        self.assertNotEqual(PlayerBoxScoreRow(html=MagicMock(name='first html')), PlayerBoxScoreRow(html=MagicMock(name='second html')))

    def test_equal_when_both_rows_and_same_html(self):
        html = MagicMock(name='shared html')
        self.assertEqual(PlayerBoxScoreRow(html=html), PlayerBoxScoreRow(html=html))
