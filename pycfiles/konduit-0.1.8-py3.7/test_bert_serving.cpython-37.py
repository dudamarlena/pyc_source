...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tests/test_bert_serving.py
# Compiled at: 2020-05-07 10:54:00
# Size of source mod 2**32: 1792 bytes
import numpy as np, pytest
from konduit import ParallelInferenceConfig, ServingConfig, TensorFlowStep, InferenceConfiguration
...
def test_server_start():
    ...
    serving_config = ServingConfig(output_data_format='NUMPY',
      log_timings=True)
    model_pipeline_step = TensorFlowStep(path='bert_mrpc_frozen.pb',
      input_data_types={input_names[0]: 'INT32', 
     input_names[1]: 'INT32', 
     input_names[2]: 'INT32'},
    ...
    data_input = {input_names[0]: np.load('../data/input-0.npy'), 
