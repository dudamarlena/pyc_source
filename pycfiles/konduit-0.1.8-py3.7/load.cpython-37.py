...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/konduit/load.py
# Compiled at: 2020-05-07 11:48:09
# Size of source mod 2**32: 8894 bytes
    ...
    if step_type == 'PYTHON':
        ...
        if step_type in MODEL_TYPES:
            ...
            if step_type == 'IMAGE':
                ...
                if step_type == 'WORDPIECE_TOKENIZER':
