...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tests/test_json.py
# Compiled at: 2020-05-07 08:18:12
...
@pytest.mark.unit
@pytest.mark.skip("Can't seem to find the toJson method inside the inference configuration. This might be due to the TextConfig interface addition")
def test_json_compare():
    parallel_inference_config = ParallelInferenceConfig(workers=1)
    serving_config = ServingConfig(http_port=1300,
      output_data_format='NUMPY')
    model_pipeline_step = TensorFlowStep(path='model.pb',
