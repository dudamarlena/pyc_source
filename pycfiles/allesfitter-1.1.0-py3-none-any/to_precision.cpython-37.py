...
# [GCC 8.4.0]
# Embedded file name: /Users/mx/Dropbox (MIT)/Science/Code/allesfitter/utils/to_precision.py
# Compiled at: 2018-11-09 15:02:31
# Size of source mod 2**32: 9016 bytes
"""
...
def to_precision(value, precision, notation='auto', delimiter='e', auto_limit=3, strip_zeros=False, preserve_integer=False):
    """
  ...
  """
    ...
    if notation == 'auto':
        ...
        if notation in ('eng', 'engineering'):
            converter = _eng_notation
        else:
            if notation in ('std', 'standard'):
                converter = _std_notation
            else:
...
def _sci_decompose(value, precision):
  ...
  """
    ...
    return (
     is_neg, sig_digits, dot_power, ten_power)
