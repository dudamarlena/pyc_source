...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tom_education/migrations/0001_initial.py
# Compiled at: 2019-07-17 11:04:19
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='AsyncProcess',
       fields=[
      (
     ...
     migrations.CreateModel(name='TimelapseDataProduct',
       fields=[
      (
     ...
     migrations.CreateModel(name='TimelapseProcess',
       fields=[
      (
     ...
     migrations.CreateModel(name='PipelineProcess',
       fields=[
      (
       'asyncprocess_ptr', models.OneToOneField(auto_created=True, on_delete=(django.db.models.deletion.CASCADE), parent_link=True, primary_key=True, serialize=False, to='tom_education.AsyncProcess')),
      (
      ...
      (
       ...
       bases=('tom_education.asyncprocess', )),
     migrations.CreateModel(name='ObservationTemplate',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'unique_together': {('name', 'target', 'facility')}})]