...
# [GCC 8.4.0]
# Embedded file name: /home/fraoustin/Workspace/flask-logmanager/flask_logmanager/main.py
...
class LogManager(Blueprint):
    ...
    def __init__(self, name='logmanager', import_name=__name__, ui_testing=False, url_prefix='', by_rule=True, level=None, *args, **kwargs):
        (Blueprint.__init__)(self, name, import_name, *args, url_prefix=url_prefix, **kwargs)
        self._level = level
    ...
    def _add_dynamics_logger(self):
        ...
        if not self._level:
            levels = [
             current_app.logger.getEffectiveLevel()]
