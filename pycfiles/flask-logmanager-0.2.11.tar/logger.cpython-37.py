...
# [GCC 8.4.0]
# Embedded file name: /home/fraoustin/Workspace/flask-logmanager/flask_logmanager/models/logger.py
# Compiled at: 2019-07-30 10:36:59
...
class Logger(Model):
    ...
    def rule(self, rule):
        ...
        """
        if self.id is not None:
            if '_rule' in getLogger(self.id).__dict__:
                if getLogger(self.id)._rule != rule:
