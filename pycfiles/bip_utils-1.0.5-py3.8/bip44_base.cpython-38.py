...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\bip_utils\bip44_base.py
# Compiled at: 2020-04-16 16:32:55
# Size of source mod 2**32: 16805 bytes
...
class Bip44Coins(IntEnum):
    __doc__ = ' Enumerative for BIP44 coins. Only some coins are present but it can be extended. '
    BITCOIN = (0, )
    LITECOIN = (2, )
    DOGECOIN = (3, )
    DASH = (5, )
...
class Bip44Changes(IntEnum):
    __doc__ = ' Enumerative for BIP44 changes. '
    CHAIN_EXT = (0, )
    CHAIN_INT = (1, )
...
class Bip44Levels(IntEnum):
    __doc__ = ' Enumerative for BIP44 levels. '
    MASTER = (0, )
    PURPOSE = (1, )
    COIN = (2, )
    ACCOUNT = (3, )
...
class Bip44Base(ABC):
    ...
    def __init__(self, bip32_obj, coin_idx):
        ...
        """
        if not bip32_obj.IsPublicOnly() or bip32_obj.Depth() < Bip44Levels.ACCOUNT or bip32_obj.Depth() > Bip44Levels.ADDRESS_INDEX:
