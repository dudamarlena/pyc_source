...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\bip_utils\bip44.py
# Compiled at: 2020-04-16 11:13:09
...
class Bip44Const:
    ...
    ALLOWED_COINS = [
     ...
     Bip44Coins.ETHEREUM,
     Bip44Coins.RIPPLE]
    COIN_TO_CLASS = {Bip44Coins.BITCOIN: Bip44BitcoinMainNet, 
...
class Bip44(Bip44Base):
    __doc__ = ' BIP44 class. It allows master key generation and children keys derivation in according to BIP-0044.\n    BIP-0044 specifications: https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki\n    '
