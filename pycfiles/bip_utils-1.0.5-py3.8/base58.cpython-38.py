...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\bip_utils\base58.py
# Compiled at: 2020-04-28 06:20:44
...
class Base58Alphabets(IntEnum):
    __doc__ = ' Enumerative for Base58 alphabet. '
    BITCOIN = (0, )
    RIPPLE = (1, )


class Base58Const:
    __doc__ = ' Class container for Base58 constants. '
    RADIX = 58
    CHECKSUM_BYTE_LEN = 4
    ALPHABETS = {Base58Alphabets.BITCOIN: '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', 
     Base58Alphabets.RIPPLE: 'rpshnaf39wBUDNEGHJKLM4PQRST7VWXYZ2bcdeCg65jkm8oFqi1tuvAxyz'}


class Base58Utils:
    __doc__ = ' Class container for Base58 utility functions. '
...
class Base58Encoder:
    __doc__ = ' Base58 encoder class. It provides methods for encoding and checksum encoding to Base58 format. '
...
class Base58Decoder:
    __doc__ = ' Base58 decoder class. It provides methods for decoding and checksum decoding Base58 format. '
