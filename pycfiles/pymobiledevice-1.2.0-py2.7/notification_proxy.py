...
# Compiled at: 2019-03-03 18:43:25
import time, plistlib, time, logging
...
class NPClient(object):
    ...
    def post_notification(self, notification):
        self.service.sendPlist({'Command': 'PostNotification', 'Name': notification})
    ...
    def observe_notification(self, notification):
        ...
        self.service.sendPlist({'Command': 'ObserveNotification', 'Name': notification})
