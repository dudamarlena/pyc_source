...
class installation_proxy(object):
    ...
    def send_cmd_for_bid(self, bid, cmd='Archive', options=None, handler=None, *args):
        cmd = {'Command': cmd, 'ApplicationIdentifier': bid}
        if options:
    ...
    def install_or_upgrade(self, ipaPath, cmd='Install', options={}, handler=None, *args):
        ...
        cmd = {'Command': cmd, 'ClientOptions': options, 
    ...
    def archives_info(self, options={}):
        cmd = {'Command': 'LookupArchive', 'ClientOptions': options}
...
if __name__ == '__main__':
    ...
    parser.add_option('-l', '--listapps', default=False, action='store_true', help='List installed applications')
    parser.add_option('-i', '--install', default=False, action='store', dest='install_ipapath', metavar='FILE', help='Install application on device')
    parser.add_option('-r', '--remove', default=False, action='store', dest='remove_bundleid', metavar='BUNDLE_ID', help='Remove (uninstall) application from device')
    parser.add_option('-g', '--upgrade', default=False, action='store', dest='upgrade_bundleid', metavar='BUNDLE_ID', help='Upgrade application on device')
    parser.add_option('-a', '--archive', default=False, action='store', dest='archive_bundleid', metavar='BUNDLE_ID', help='Archive application on device')
