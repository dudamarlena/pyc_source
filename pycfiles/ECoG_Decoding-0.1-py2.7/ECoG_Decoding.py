...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/Decoding/ECoG_Decoding.py
# Compiled at: 2015-11-21 15:55:23
import numpy as np
...
def Decode(X, Y, nb_classes, ChannelOfInterest, Events, Times, WhatToDecode, nbArtificialSamples, DownsampleFq, FilterData, nbCvFolds, locutoff, hicutoff, nmodels, shufflelabels, earlystopping, VisModelTestAud, subject, verbosity, savefile, filename, Experiment_dir):
    ...
    for train, test in kfolds:
        ...
        X_train_bag_temp, X_validate_bag, Y_train_bag_temp, Y_validate_bag = cross_validation.train_test_split(X_train_fold, Y_train_fold, test_size=0.1)
