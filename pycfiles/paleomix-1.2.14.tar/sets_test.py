...
def test_atomicsets__properties():
    ...
    def _do_test(cls):
        cmd_mock_1 = AtomicCmd(('true', ), CHECK_A=id, EXEC_1='false', IN_1='/foo/bar/in_1.file', IN_2='/foo/bar/in_2.file', OUT_1='/bar/foo/out', TEMP_OUT_1='out.log', AUX_A='/aux/fA', AUX_B='/aux/fB')
        cmd_mock_2 = AtomicCmd(('false', ), CHECK_A=list, EXEC_1='echo', EXEC_2='java', IN_1='/foo/bar/in.file', OUT_1='out.txt')
...
def test_atomicsets__commit():
    ...
    yield (
     _do_test_atomicsets__commit, ParallelCmds)
...
def test_atomicsets__stdout():
    ...
    yield (
     _do_test_atomicsets__stdout, ParallelCmds)
...
def test_atomicsets__terminate():
    ...
    yield (
     _do_test_atomicsets__terminate, ParallelCmds)
...
def test_atomicsets__str__():
    ...
    yield (
     _do_test_atomicsets__str__, ParallelCmds)
...
def test_atomicsets__duplicate_cmds():
    ...
    yield (
     _do_test_atomicsets__duplicate_cmds, ParallelCmds)
...
def test_parallel_commands__ready_single():
    ...
    yield (
     _do_test_parallel_commands__ready_single, True)
...
def test_parallel_commands__ready_two():
    ...
    yield (
     _do_test_parallel_commands__ready_two, True, True, True)
