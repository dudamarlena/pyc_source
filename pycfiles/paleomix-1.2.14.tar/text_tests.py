...
# [GCC 8.4.0]
# Embedded file name: /home/mischu/devel/paleomix/tests/common_tests/text_tests.py
# Compiled at: 2019-10-27 09:55:00
import collections, nose.tools
from nose.tools import assert_equal
from paleomix.common.text import TableError, padded_table, parse_padded_table, parse_lines, parse_lines_by_contig
...
def test_parse_padded_table__two_rows():
    table = [
     ...
     '4     3     2     1',
     'AB    CD    EF    GH']
    expected = [{'A': '4', 'B': '3', 'C': '2', 'D': '1'}, {'A': 'AB', 'B': 'CD', 'C': 'EF', 'D': 'GH'}]
    assert_equal(expected, _parse_padded_table(table))
...
def test_padded_table__newlines():
    ...
    yield (
     _do_test_padded_table__padding__comments, '\r')
...
def test_parse_lines__comments_and_empty_lines():
    ...
    yield (_do_test_parse_lines__comments,
     [
      'abc line1 \n', 'def line2 \n', '   # comment\n'])
    yield (
     _do_test_parse_lines__comments,
     [
      '\n', 'abc line1 \n', 'def line2 \n'])
    yield (_do_test_parse_lines__comments,
     [
...
def test_parse_lines__two_contigs():
    ...
    expected = {'abc': [_RecordMock('abc', 'line1')], 'def': [
