...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/annogesiclib/expression.py
...
class Expression(object):
    ...
    def expression(self, tex_libs, frag_libs, tex_notex, replicates_tex, replicates_frag, tex_wigs, frag_wigs, percent_tex, percent_frag, cutoff_coverage, gffs, features, cover_type, max_color, min_color):
        ...
        gene_expression(input_libs, gffs, percent_tex, percent_frag, wig_f_file, wig_r_file, features, merge_wigs, cutoff_coverage, tex_notex, replicates, self.stat, self.gff_folder, cover_type, max_color, min_color)
