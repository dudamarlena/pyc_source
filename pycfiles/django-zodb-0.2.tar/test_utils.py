...
# [GCC 8.4.0]
# Embedded file name: /Users/osantana/Work/django-zodb/django-zodb/tests/test_utils.py
...
class URIParseTests(TestCase):
    ...
    def test_uris(self):
        ...
        self._t('sc://user:pass@host', scheme='sc', user='user', password='pass', host='host')
        self._t('sc:user:pass@host', scheme='sc', user='user', password='pass', host='host')
        self._t('sc://user:pass@host:1234', scheme='sc', user='user', password='pass', host='host', port=1234)
        self._t('sc://user:pass@host:1234/', scheme='sc', user='user', password='pass', host='host', port=1234, path='/')
        self._t('sc://user:pass@host:1234/path', scheme='sc', user='user', password='pass', host='host', port=1234, path='/path')
        self._t('sc://user:pass@host/path', scheme='sc', user='user', password='pass', host='host', path='/path')
        self._t('sc://user:pass@host///path', scheme='sc', user='user', password='pass', host='host', path='///path')
        self._t('sc://user:pass@host/path/', scheme='sc', user='user', password='pass', host='host', path='/path/')
        self._t('cache://user:pass@host/path/', scheme='cache', user='user', password='pass', host='host', path='/path/')
        self._t('cache://user:pass@host/path/', scheme='cache', user='user', password='pass', host='host', path='/path/')
        ...
        self._t('file:///foo@bar&baz&qux.quxx?bla=ble&bli', scheme='file', path='/foo@bar&baz&qux.quxx', query={'bla': ['ble'], 'bli': ['']})
        ...
        self._t('sc://u:p@h:1/x?a=b', scheme='sc', user='u', password='p', host='h', port=1, path='/x', query={'a': ['b']})
        self._t('sc://u@h:1/x?a=b', scheme='sc', user='u', host='h', port=1, path='/x', query={'a': ['b']})
        self._t('sc://u@:1/x?a=b', scheme='sc', user='u', port=1, path='/x', query={'a': ['b']})
        ...
        self._t('mysql://test_user:test_pass@test_host?compress=1#test_dbname', scheme='mysql', user='test_user', password='test_pass', host='test_host', query={'compress': ['1']}, frag='test_dbname')
