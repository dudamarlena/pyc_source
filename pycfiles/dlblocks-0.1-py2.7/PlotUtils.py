...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/dlblocks/PlotUtils.py
# Compiled at: 2018-12-11 12:52:10
import matplotlib as mpl, matplotlib.pyplot as plt, numpy as np, itertools, cv2, random
...
def plot_confusion_matrix(confusion_matrix, classes=None, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues, outputFile=None):
    """
