...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionoffersoffer_operations.py
...
class GetvversionoffersofferOperations(object):
    """GetvversionoffersofferOperations operations.
    ...
    def value(self, offer_id, version, country=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Retrieves all add-on offers of an offer using country and locale
        information.
        ...
        path_format_arguments = {'offer_id': self._serialize.url('offer_id', offer_id, 'str'), 
    ...
    value.metadata = {'url': '/v{version}/offers/{offer_id}/addons'}

    def value1(self, offer_id, version, country=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Retrieves an offer by its identifier of a partner using country and
        locale information.
        ...
        deserialized = None
        if response.status_code in (200, 201):
            deserialized = self._deserialize('MicrosoftPartnerSdkContractsV1Offer', response)
        if raw:
            client_raw_response = ClientRawResponse(deserialized, response)
            return client_raw_response
        else:
    ...
    value1.metadata = {'url': '/v{version}/offers/{offer_id}'}