...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_device_deployment_device.py
...
class MicrosoftPartnerSdkContractsV1DeviceDeploymentDevice(Model):
    ...
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'serial_number': {'key': 'serialNumber', 'type': 'str'}, 'product_key': {'key': 'productKey', 'type': 'str'}, 'hardware_hash': {'key': 'hardwareHash', 'type': 'str'}, 'model_name': {'key': 'modelName', 'type': 'str'}, 'oem_manufacturer_name': {'key': 'oemManufacturerName', 'type': 'str'}, 'policies': {'key': 'policies', 'type': '[SystemCollectionsGenericKeyValuePairMicrosoftPartnerSdkContractsV1DeviceDeploymentPolicyCategorySystemString]'}, 'uploaded_by': {'key': 'uploadedBy', 'type': 'str'}, 'uploaded_date': {'key': 'uploadedDate', 'type': 'iso-8601'}, 'allowed_operations': {'key': 'allowedOperations', 'type': '[str]'}, 'links': {'key': 'links', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceLinks'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
