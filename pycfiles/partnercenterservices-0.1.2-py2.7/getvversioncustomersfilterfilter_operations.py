...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversioncustomersfilterfilter_operations.py
...
class GetvversioncustomersfilterfilterOperations(object):
    ...
    def value(self, version, filter=None, size=None, seek_operation=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
