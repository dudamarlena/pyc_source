...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_customer_billing_profile.py
...
class MicrosoftPartnerSdkContractsV1CustomerBillingProfile(Model):
    ...
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'first_name': {'key': 'firstName', 'type': 'str'}, 'last_name': {'key': 'lastName', 'type': 'str'}, 'email': {'key': 'email', 'type': 'str'}, 'culture': {'key': 'culture', 'type': 'str'}, 'language': {'key': 'language', 'type': 'str'}, 'company_name': {'key': 'companyName', 'type': 'str'}, 'default_address': {'key': 'defaultAddress', 'type': 'MicrosoftPartnerSdkContractsV1Address'}, 'links': {'key': 'links', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceLinks'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
