...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionrelationshipspartner_operations.py
...
class GetvversionrelationshipspartnerOperations(object):
    """GetvversionrelationshipspartnerOperations operations.
    ...
    def value(self, version, partner_id, relationship_type=None, filter=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Retrieves a segment of a partner's resellers. Optional filtering of
        partner relationships can also be applied.
        Resellers can only be filtered by a string which their name. Full
        search is not supported currently.
        Resellers can be filtered using a
        {Microsoft.Partner.Sdk.Contracts.V1.Query.Filters.FieldFilterOperation.StartsWith}
        filter operation and specifying: Name (Value added reseller name)
        as the filter field.
        ...
        :param partner_id:
        :type partner_id: str
        :param relationship_type: Possible values include: 'none',
         'isIndirectResellerOf', 'isIndirectCloudSolutionProviderOf'
        ...
        path_format_arguments = {'version': self._serialize.url('version', version, 'str'), 
           'partner_id': self._serialize.url('partner_id', partner_id, 'str')}
        url = self._client.format_url(url, **path_format_arguments)
        query_parameters = {}
        if relationship_type is not None:
            query_parameters['relationship_type'] = self._serialize.query('relationship_type', relationship_type, 'str')
    ...
    value.metadata = {'url': '/v{version}/relationships/{partner_id}/customer'}