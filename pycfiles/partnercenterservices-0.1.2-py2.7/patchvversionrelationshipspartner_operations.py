...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/patchvversionrelationshipspartner_operations.py
...
class PatchvversionrelationshipspartnerOperations(object):
    """PatchvversionrelationshipspartnerOperations operations.
    ...
    def id(self, customer_id, partner_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Retries any failed relationships between Customer Distributor and
        Reseller.
    ...
    id.metadata = {'url': '/v{version}/relationships/{partner_id}/customer/{customer_id}'}