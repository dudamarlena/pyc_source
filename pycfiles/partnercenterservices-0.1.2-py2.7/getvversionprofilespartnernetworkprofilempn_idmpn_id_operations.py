...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionprofilespartnernetworkprofilempn_idmpn_id_operations.py
...
class GetvversionprofilespartnernetworkprofilempnIdmpnIdOperations(object):
    """GetvversionprofilespartnernetworkprofilempnIdmpnIdOperations operations.
    ...
    def value(self, version, mpn_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Gets the Microsoft partner network profile.
    ...
    value.metadata = {'url': '/v{version}/profiles/partnernetworkprofile'}