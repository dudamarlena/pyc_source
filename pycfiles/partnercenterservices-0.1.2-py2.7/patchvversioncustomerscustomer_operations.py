...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/patchvversioncustomerscustomer_operations.py
...
class PatchvversioncustomerscustomerOperations(object):
    ...
    def id(self, customer_id, customer, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idusagebudget(self, customer_id, version, ms_correlation_id=None, ms_request_id=None, amount=None, usage_spending_budget=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id1(self, customer_id, service_request_id, service_request, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def value(self, customer_id, user, version, user_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id2(self, customer_id, user_id, user, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Updates the attributes of user in customer tenant.
    ...
    def id_device_policy_updates(self, customer_id, version, ms_correlation_id=None, ms_request_id=None, devices=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id3(self, customer_id, order_id, order, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Update the order.
    ...
    def id4(self, customer_id, subscription_id, subscription, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
