...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionrolesrole_operations.py
...
class GetvversionrolesroleOperations(object):
    """GetvversionrolesroleOperations operations.
    ...
    def value(self, version, role_id=None, size=None, sort_field=None, sort_direction=None, seek_operation=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype:
         ~microsoft.store.partnercenterservices.models.MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1ContractsRoleManagementRole
        ...
        if sort_field is not None:
            query_parameters['sortField'] = self._serialize.query('sort_field', sort_field, 'str')
        if sort_direction is not None:
            query_parameters['sortDirection'] = self._serialize.query('sort_direction', sort_direction, 'str')
        ...
        if response.status_code in (200, 201):
            deserialized = self._deserialize('MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1ContractsRoleManagementRole', response)
        if raw:
    ...
    def value1(self, version, role_id, size=None, sort_field=None, sort_direction=None, seek_operation=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Gets all the roles available.
    ...
    value1.metadata = {'url': '/v{version}/roles/{role_id}/usermembers'}