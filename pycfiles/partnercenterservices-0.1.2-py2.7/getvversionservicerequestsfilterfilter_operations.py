...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionservicerequestsfilterfilter_operations.py
...
class GetvversionservicerequestsfilterfilterOperations(object):
    """GetvversionservicerequestsfilterfilterOperations operations.
    ...
    def value(self, version, filter=None, offset=None, size=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    value.metadata = {'url': '/v{version}/servicerequests'}