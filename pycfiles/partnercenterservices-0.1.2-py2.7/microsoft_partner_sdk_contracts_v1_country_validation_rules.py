...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_country_validation_rules.py
...
class MicrosoftPartnerSdkContractsV1CountryValidationRules(Model):
    ...
    _attribute_map = {'iso2_code': {'key': 'iso2Code', 'type': 'str'}, 'default_culture': {'key': 'defaultCulture', 'type': 'str'}, 'is_state_required': {'key': 'isStateRequired', 'type': 'bool'}, 'supported_states_list': {'key': 'supportedStatesList', 'type': '[str]'}, 'supported_languages_list': {'key': 'supportedLanguagesList', 'type': '[str]'}, 'supported_cultures_list': {'key': 'supportedCulturesList', 'type': '[str]'}, 'is_postal_code_required': {'key': 'isPostalCodeRequired', 'type': 'bool'}, 'postal_code_regex': {'key': 'postalCodeRegex', 'type': 'str'}, 'is_city_required': {'key': 'isCityRequired', 'type': 'bool'}, 'is_vat_id_supported': {'key': 'isVatIdSupported', 'type': 'bool'}, 'tax_id_format': {'key': 'taxIdFormat', 'type': 'str'}, 'tax_id_sample': {'key': 'taxIdSample', 'type': 'str'}, 'vat_id_regex': {'key': 'vatIdRegex', 'type': 'str'}, 'phone_number_regex': {'key': 'phoneNumberRegex', 'type': 'str'}, 'is_tax_id_supported': {'key': 'isTaxIdSupported', 'type': 'bool'}, 'is_tax_id_optional': {'key': 'isTaxIdOptional', 'type': 'bool'}, 'country_calling_codes_list': {'key': 'countryCallingCodesList', 'type': '[str]'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
