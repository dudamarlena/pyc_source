...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/postvversioncustomerscustomer_operations.py
...
class PostvversioncustomerscustomerOperations(object):
    ...
    def idcheckout(self, customer_id, cart_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def value(self, customer_id, user_member, version, role_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idusermembers(self, customer_id, role_id, user_member, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Adds a new user member to a directory role with a given role id.
    ...
    def idlicenseupdates(self, customer_id, user_id, version, ms_correlation_id=None, ms_request_id=None, licenses_to_assign=None, licenses_to_remove=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idusers(self, customer_id, user, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def iddevice_batches(self, customer_id, version, ms_correlation_id=None, ms_request_id=None, batch_id=None, devices=None, custom_headers=None, raw=False, **operation_config):
    ...
    def iddevices(self, customer_id, device_batch_id, devices, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """uploads the list of customer's devices for a given device batch.
    ...
    def idpolicies(self, customer_id, policy, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idverifieddomain(self, customer_id, verified_domain, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Add verified domain.
    ...
    def idorders(self, customer_id, order, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Places the order.
    ...
    def idregistrations(self, customer_id, subscription_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idconversions(self, customer_id, subscription_id, target_conversion, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idupgrades(self, customer_id, subscription_id, target_upgrade, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
