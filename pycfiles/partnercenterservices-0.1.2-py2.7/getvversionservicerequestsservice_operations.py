...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionservicerequestsservice_operations.py
...
class GetvversionservicerequestsserviceOperations(object):
    ...
    def id(self, service_request_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
