...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/putvversionusersuser_operations.py
...
class PutvversionusersuserOperations(object):
    ...
    def idpreferencesnotifications_notification_areachannel_type(self, user_id, notification_area, channel_type, communication_preference, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'user_id': self._serialize.url('user_id', user_id, 'str'), 
