...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_domain_management_domain_federation_settings.py
...
class MicrosoftPartnerSdkContractsV1DomainManagementDomainFederationSettings(Model):
    ...
    """
    _attribute_map = {'active_log_on_uri': {'key': 'activeLogOnUri', 'type': 'str'}, 'default_interactive_authentication_method': {'key': 'defaultInteractiveAuthenticationMethod', 'type': 'str'}, 'federation_brand_name': {'key': 'federationBrandName', 'type': 'str'}, 'issuer_uri': {'key': 'issuerUri', 'type': 'str'}, 'log_off_uri': {'key': 'logOffUri', 'type': 'str'}, 'metadata_exchange_uri': {'key': 'metadataExchangeUri', 'type': 'str'}, 'next_signing_certificate': {'key': 'nextSigningCertificate', 'type': 'str'}, 'open_id_connect_discovery_endpoint': {'key': 'openIdConnectDiscoveryEndpoint', 'type': 'str'}, 'passive_log_on_uri': {'key': 'passiveLogOnUri', 'type': 'str'}, 'preferred_authentication_protocol': {'key': 'preferredAuthenticationProtocol', 'type': 'str'}, 'prompt_login_behavior': {'key': 'promptLoginBehavior', 'type': 'str'}, 'signing_certificate': {'key': 'signingCertificate', 'type': 'str'}, 'signing_certificate_update_status': {'key': 'signingCertificateUpdateStatus', 'type': 'MicrosoftPartnerSdkContractsV1DomainManagementSigningCertificateUpdateStatus'}, 'supports_mfa': {'key': 'supportsMfa', 'type': 'bool'}}
