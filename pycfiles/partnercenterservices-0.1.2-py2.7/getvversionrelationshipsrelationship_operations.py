...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionrelationshipsrelationship_operations.py
...
class GetvversionrelationshipsrelationshipOperations(object):
    """GetvversionrelationshipsrelationshipOperations operations.
    ...
    def value(self, version, relationship_type=None, filter=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    value.metadata = {'url': '/v{version}/relationships'}