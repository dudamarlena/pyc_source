...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/deletevversionrolesrole_operations.py
...
class DeletevversionrolesroleOperations(object):
    """DeletevversionrolesroleOperations operations.
    ...
    def value(self, version, role_id=None, member_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Removes a user member of given member id from role with a given role id
        and id token passed in the header.
    ...
    def id(self, role_id, member_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Removes a user member of given member id from role with a given role id
        and id token passed in the header.
        Defaults to removing from applicable account.
        ...
        path_format_arguments = {'role_id': self._serialize.url('role_id', role_id, 'str'), 
    ...
    id.metadata = {'url': '/v{version}/roles/{role_id}/usermembers/{member_id}'}