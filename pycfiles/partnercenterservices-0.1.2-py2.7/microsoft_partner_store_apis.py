...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/microsoft_partner_store_apis.py
...
class MicrosoftPartnerStoreApis(object):
    ...
    def __init__(self, credentials, base_url=None):
        ...
        client_models = {k:v for k, v in models.__dict__.items() if isinstance(v, type) if isinstance(v, type)}
        self.api_version = 'v1'
        self._serialize = Serializer(client_models)
        self._deserialize = Deserializer(client_models)
        self.getvversionoffersoffer = GetvversionoffersofferOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversioncustomerscustomer = GetvversioncustomerscustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.postvversioncustomerscustomer = PostvversioncustomerscustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversioncustomersfilterfilter = GetvversioncustomersfilterfilterOperations(self._client, self.config, self._serialize, self._deserialize)
        self.deletevversioncustomerscustomer = DeletevversioncustomerscustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.patchvversioncustomerscustomer = PatchvversioncustomerscustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.putvversioncustomerscustomer = PutvversioncustomerscustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.postvversiondomainsdomaincustomer = PostvversiondomainsdomaincustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.headvversioncustomerscustomer = HeadvversioncustomerscustomerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.putvversionusersuser = PutvversionusersuserOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionusersuser = GetvversionusersuserOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionofferscountrycountry = GetvversionofferscountrycountryOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionoffercategoriescountrycountry = GetvversionoffercategoriescountrycountryOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionprofileslegalbusinessvetting_versionvetting_version = GetvversionprofileslegalbusinessvettingVersionvettingVersionOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionprofilespartnernetworkprofilempn_idmpn_id = GetvversionprofilespartnernetworkprofilempnIdmpnIdOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionprofilesmpnmpn_idmpn_id = GetvversionprofilesmpnmpnIdmpnIdOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionrelationshipsrelationship = GetvversionrelationshipsrelationshipOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionrelationshipspartner = GetvversionrelationshipspartnerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.patchvversionrelationshipspartner = PatchvversionrelationshipspartnerOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionratecardsazurecurrencycurrency = GetvversionratecardsazurecurrencycurrencyOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionratecardsazure_sharedcurrencycurrency = GetvversionratecardsazureSharedcurrencycurrencyOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversioncustomersrelationshiprequestsindirect_cloud_solution_provider_idindirect_cloud_solution_provider_id = GetvversioncustomersrelationshiprequestsindirectCloudSolutionProviderIdindirectCloudSolutionProviderIdOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionrolesrole = GetvversionrolesroleOperations(self._client, self.config, self._serialize, self._deserialize)
        self.postvversionrolesrole = PostvversionrolesroleOperations(self._client, self.config, self._serialize, self._deserialize)
        self.deletevversionrolesrole = DeletevversionrolesroleOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionserviceincidentsofficefilterfilter = GetvversionserviceincidentsofficefilterfilterOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionserviceincidentsofficecountfilterfilter = GetvversionserviceincidentsofficecountfilterfilterOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionservicerequestsfilterfilter = GetvversionservicerequestsfilterfilterOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionservicerequestsservice = GetvversionservicerequestsserviceOperations(self._client, self.config, self._serialize, self._deserialize)
        self.patchvversionservicerequestsservice = PatchvversionservicerequestsserviceOperations(self._client, self.config, self._serialize, self._deserialize)
        self.postvversionservicerequestsagent = PostvversionservicerequestsagentOperations(self._client, self.config, self._serialize, self._deserialize)
        self.getvversionvalidationscheckdomainavailabilitydomain = GetvversionvalidationscheckdomainavailabilitydomainOperations(self._client, self.config, self._serialize, self._deserialize)

    def getvversioncountryvalidationrulescountry(self, country, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'country': self._serialize.url('country', country, 'str'), 
    ...
    def postvversioncustomers(self, customer_profile, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'version': self._serialize.url('version', version, 'str')}
        url = self._client.format_url(url, **path_format_arguments)
        query_parameters = {}
        header_parameters = {}
        header_parameters['Content-Type'] = 'application/json; charset=utf-8'
    ...
    def getvversioncustomersusagerecords(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def headvversiondomainsdomain(self, domain, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'domain': self._serialize.url('domain', domain, 'str'), 
           'version': self._serialize.url('version', version, 'str')}
        url = self._client.format_url(url, **path_format_arguments)
        query_parameters = {}
        header_parameters = {}
    ...
    def getvversioninsiderprograms(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def putvversioninsiderprograms(self, insider_program, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def postvversionmigrationssyndication(self, migration_batch, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionmigrationssyndicationmigration_batch_id(self, migration_batch_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'migrationBatchId': self._serialize.url('migration_batch_id', migration_batch_id, 'str'), 
           'version': self._serialize.url('version', version, 'str')}
        url = self._client.format_url(url, **path_format_arguments)
        query_parameters = {}
        header_parameters = {}
    ...
    def getvversionmigrationssyndicationmigration_batch_idmosi_customer_id(self, migration_batch_id, mosi_customer_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionanalyticslicensesdeployment(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionanalyticslicensesusage(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionprofilesorganization(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def putvversionprofilesorganization(self, organization_profile, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def putvversionprofileslegalbusiness(self, legal_business_profile, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionprofilessupport(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def putvversionprofilessupport(self, support_profile, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionprofilesbilling(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def putvversionprofilesbilling(self, billing_profile, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionusagesummary(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionpreferencescatalogoffers(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def putvversionpreferencescatalogoffers(self, offer_ids, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def getvversionservicerequestssupporttopics(self, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def postgeneratetoken(self, grant_type, custom_headers=None, raw=False, **operation_config):
    ...
    def postvversionvalidationsaddress(self, address, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
