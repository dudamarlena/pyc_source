...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionoffercategoriescountrycountry_operations.py
...
class GetvversionoffercategoriescountrycountryOperations(object):
    """GetvversionoffercategoriescountrycountryOperations operations.
    ...
    def value(self, version, country=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Gets all offer categories in country and/or locale.
    ...
    value.metadata = {'url': '/v{version}/offercategories'}