...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionserviceincidentsofficefilterfilter_operations.py
...
class GetvversionserviceincidentsofficefilterfilterOperations(object):
    """GetvversionserviceincidentsofficefilterfilterOperations operations.
    ...
    value.metadata = {'url': '/v{version}/serviceincidents/office'}