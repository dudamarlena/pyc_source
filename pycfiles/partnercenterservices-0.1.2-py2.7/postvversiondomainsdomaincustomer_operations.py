...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/postvversiondomainsdomaincustomer_operations.py
...
class PostvversiondomainsdomaincustomerOperations(object):
    """PostvversiondomainsdomaincustomerOperations operations.
    ...
    def value(self, verified_domain, version, domain, customer_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Add verified domain.
        ...
        if customer_id is not None:
            query_parameters['customer_id'] = self._serialize.query('customer_id', customer_id, 'str')
        header_parameters = {}
    ...
    value.metadata = {'url': '/v{version}/domains/{domain}'}