...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionofferscountrycountry_operations.py
...
class GetvversionofferscountrycountryOperations(object):
    ...
    def value(self, version, country=None, offer_category_id=None, offset=None, size=None, product_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
