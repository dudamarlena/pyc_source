...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_contracts_connect_us_advisory_hours_service_request.py
...
class MicrosoftPartnerSdkContractsV1ContractsConnectUsAdvisoryHoursServiceRequest(Model):
    ...
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'long'}, 'partner_id': {'key': 'partnerId', 'type': 'str'}, 'title': {'key': 'title', 'type': 'str'}, 'description': {'key': 'description', 'type': 'str'}, 'created_date': {'key': 'createdDate', 'type': 'iso-8601'}, 'preferred_language_code': {'key': 'preferredLanguageCode', 'type': 'str'}, 'routing_country_code': {'key': 'routingCountryCode', 'type': 'str'}, 'contact_name': {'key': 'contactName', 'type': 'str'}, 'phone_number': {'key': 'phoneNumber', 'type': 'str'}, 'email': {'key': 'email', 'type': 'str'}, 'billing_hours': {'key': 'billingHours', 'type': 'float'}, 'closed_date': {'key': 'closedDate', 'type': 'iso-8601'}, 'is_open': {'key': 'isOpen', 'type': 'bool'}, 'is_contract_available': {'key': 'isContractAvailable', 'type': 'bool'}}
