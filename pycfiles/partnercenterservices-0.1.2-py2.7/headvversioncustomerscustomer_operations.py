...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/headvversioncustomerscustomer_operations.py
...
class HeadvversioncustomerscustomerOperations(object):
    """HeadvversioncustomerscustomerOperations operations.
    ...
    def idverifieddomain(self, domain, version, customer_id, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
