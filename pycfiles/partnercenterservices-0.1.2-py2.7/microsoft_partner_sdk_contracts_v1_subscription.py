...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_subscription.py
...
class MicrosoftPartnerSdkContractsV1Subscription(Model):
    ...
    """
    _validation = {'contract_type': {'readonly': True}, 'attributes': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'offer_id': {'key': 'offerId', 'type': 'str'}, 'entitlement_id': {'key': 'entitlementId', 'type': 'str'}, 'offer_name': {'key': 'offerName', 'type': 'str'}, 'friendly_name': {'key': 'friendlyName', 'type': 'str'}, 'quantity': {'key': 'quantity', 'type': 'int'}, 'unit_type': {'key': 'unitType', 'type': 'str'}, 'parent_subscription_id': {'key': 'parentSubscriptionId', 'type': 'str'}, 'has_purchasable_addons': {'key': 'hasPurchasableAddons', 'type': 'bool'}, 'creation_date': {'key': 'creationDate', 'type': 'iso-8601'}, 'effective_start_date': {'key': 'effectiveStartDate', 'type': 'iso-8601'}, 'commitment_end_date': {'key': 'commitmentEndDate', 'type': 'iso-8601'}, 'status': {'key': 'status', 'type': 'str'}, 'auto_renew_enabled': {'key': 'autoRenewEnabled', 'type': 'bool'}, 'is_trial': {'key': 'isTrial', 'type': 'bool'}, 'billing_type': {'key': 'billingType', 'type': 'str'}, 'billing_cycle': {'key': 'billingCycle', 'type': 'str'}, 'actions': {'key': 'actions', 'type': '[str]'}, 'partner_id': {'key': 'partnerId', 'type': 'str'}, 'suspension_reasons': {'key': 'suspensionReasons', 'type': '[str]'}, 'attention_needed': {'key': 'attentionNeeded', 'type': 'bool'}, 'attention_reason': {'key': 'attentionReason', 'type': 'str'}, 'action_taken': {'key': 'actionTaken', 'type': 'bool'}, 'contract_type': {'key': 'contractType', 'type': 'str'}, 'links': {'key': 'links', 'type': 'MicrosoftPartnerSdkContractsV1ContractsLinksSubscriptionLinks'}, 'order_id': {'key': 'orderId', 'type': 'str'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
