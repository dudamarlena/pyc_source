...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/deletevversioncustomerscustomer_operations.py
...
class DeletevversioncustomerscustomerOperations(object):
    ...
    def value(self, customer_id, version, member_id=None, role_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id1(self, customer_id, member_id, role_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Removes a user member of given member id from directory role with a
        given role id.
    ...
    def idrelationshipspartner(self, customer_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id_customer_partner_relationshipsreseller(self, customer_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def value1(self, customer_id, version, user_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id3(self, customer_id, device_batch_id, device_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
