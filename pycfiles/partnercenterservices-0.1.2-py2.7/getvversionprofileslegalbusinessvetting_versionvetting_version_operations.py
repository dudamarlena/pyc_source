...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionprofileslegalbusinessvetting_versionvetting_version_operations.py
...
class GetvversionprofileslegalbusinessvettingVersionvettingVersionOperations(object):
    """GetvversionprofileslegalbusinessvettingVersionvettingVersionOperations operations.
    ...
    def value(self, version, vetting_version=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Gets the legal business profile.

        :param version: Possible values include: '1.0', '1'
        :type version: str
        :param vetting_version: (Optional) The vetting version. The default
         value is set to Current. Possible values include: 'none', 'current',
         'lastFinalized'
        :type vetting_version: str
        ...
        query_parameters = {}
        if vetting_version is not None:
            query_parameters['vettingVersion'] = self._serialize.query('vetting_version', vetting_version, 'str')
        header_parameters = {}
    ...
    value.metadata = {'url': '/v{version}/profiles/legalbusiness'}