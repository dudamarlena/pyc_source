...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/patchvversionservicerequestsservice_operations.py
...
class PatchvversionservicerequestsserviceOperations(object):
    """PatchvversionservicerequestsserviceOperations operations.
    ...
    def id(self, service_request_id, service_request, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'service_request_id': self._serialize.url('service_request_id', service_request_id, 'str'), 
