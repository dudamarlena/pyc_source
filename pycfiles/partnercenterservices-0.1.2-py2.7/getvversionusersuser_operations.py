...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionusersuser_operations.py
...
class GetvversionusersuserOperations(object):
    ...
    def idpreferencesnotificationsnotification_areachannel_type(self, notification_area, version, user_id, channel_type, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {'notificationArea': self._serialize.url('notification_area', notification_area, 'str'), 
