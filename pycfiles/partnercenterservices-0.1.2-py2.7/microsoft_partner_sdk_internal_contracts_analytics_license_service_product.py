...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_internal_contracts_analytics_license_service_product.py
...
class MicrosoftPartnerSdkInternalContractsAnalyticsLicenseServiceProduct(Model):
    ...
    """
    _attribute_map = {'product_id': {'key': 'productId', 'type': 'str'}, 'product_name': {'key': 'productName', 'type': 'str'}, 'service_name': {'key': 'serviceName', 'type': 'str'}, 'licenses_sold': {'key': 'licensesSold', 'type': 'long'}, 'licenses_sold_all_channel_all_partner': {'key': 'licensesSoldAllChannelAllPartner', 'type': 'long'}, 'licenses_deployed_all_channel_all_partner': {'key': 'licensesDeployedAllChannelAllPartner', 'type': 'long'}, 'licensed_workloads': {'key': 'licensedWorkloads', 'type': '[MicrosoftPartnerSdkInternalContractsAnalyticsLicenseWorkload]'}}
