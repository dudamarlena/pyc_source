...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/postvversionservicerequestsagent_operations.py
...
class PostvversionservicerequestsagentOperations(object):
    """PostvversionservicerequestsagentOperations operations.
    ...
    def locale(self, agent_locale, service_request, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Creates a service request.

        :param agent_locale:
        :type agent_locale: str
        :param service_request: The service request details.
        ...
        """
        url = self.locale.metadata['url']
        path_format_arguments = {'agent_locale': self._serialize.url('agent_locale', agent_locale, 'str'), 
    ...
    locale.metadata = {'url': '/v{version}/servicerequests/{agent_locale}'}