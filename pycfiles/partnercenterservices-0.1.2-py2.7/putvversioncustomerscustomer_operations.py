...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/putvversioncustomerscustomer_operations.py
...
class PutvversioncustomerscustomerOperations(object):
    ...
    def idprofilesbilling(self, customer_id, customer_billing_profile, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id(self, customer_id, device_batch_id, device_id, device, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id1(self, customer_id, policy_id, policy, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idsupportcontact(self, customer_id, subscription_id, support_contact, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
