...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/postvversionrolesrole_operations.py
...
class PostvversionrolesroleOperations(object):
    ...
    def value(self, user_member, version, role_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def idusermembers(self, role_id, user_member, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Adds a new user member to a role with a given role id and id token
        passed in the header.
        Defaults to adding to applicable account if none is passed.
