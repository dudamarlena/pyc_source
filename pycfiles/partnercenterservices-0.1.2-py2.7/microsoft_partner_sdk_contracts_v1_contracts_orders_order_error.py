...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_contracts_orders_order_error.py
...
class MicrosoftPartnerSdkContractsV1ContractsOrdersOrderError(Model):
    ...
    _attribute_map = {'order_group_id': {'key': 'orderGroupId', 'type': 'str'}, 'code': {'key': 'code', 'type': 'int'}, 'description': {'key': 'description', 'type': 'str'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
