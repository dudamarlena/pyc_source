...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_invoice.py
...
class MicrosoftPartnerSdkContractsV1Invoice(Model):
    ...
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'invoice_date': {'key': 'invoiceDate', 'type': 'iso-8601'}, 'total_charges': {'key': 'totalCharges', 'type': 'float'}, 'paid_amount': {'key': 'paidAmount', 'type': 'float'}, 'currency_code': {'key': 'currencyCode', 'type': 'str'}, 'currency_symbol': {'key': 'currencySymbol', 'type': 'str'}, 'pdf_download_link': {'key': 'pdfDownloadLink', 'type': 'str'}, 'invoice_details': {'key': 'invoiceDetails', 'type': '[MicrosoftPartnerSdkContractsV1InvoiceDetail]'}, 'amendments': {'key': 'amendments', 'type': '[MicrosoftPartnerSdkContractsV1Invoice]'}, 'links': {'key': 'links', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceLinks'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
