...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_legal_business_profile.py
...
class MicrosoftPartnerSdkContractsV1LegalBusinessProfile(Model):
    ...
    _attribute_map = {'company_name': {'key': 'companyName', 'type': 'str'}, 'address': {'key': 'address', 'type': 'MicrosoftPartnerSdkContractsV1Address'}, 'primary_contact': {'key': 'primaryContact', 'type': 'MicrosoftPartnerSdkContractsV1Contact'}, 'company_approver_address': {'key': 'companyApproverAddress', 'type': 'MicrosoftPartnerSdkContractsV1Address'}, 'company_approver_email': {'key': 'companyApproverEmail', 'type': 'str'}, 'vetting_status': {'key': 'vettingStatus', 'type': 'str'}, 'vetting_sub_status': {'key': 'vettingSubStatus', 'type': 'str'}, 'profile_type': {'key': 'profileType', 'type': 'str'}, 'links': {'key': 'links', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceLinks'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
