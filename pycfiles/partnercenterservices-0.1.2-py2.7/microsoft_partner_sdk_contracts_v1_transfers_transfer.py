...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/models/microsoft_partner_sdk_contracts_v1_transfers_transfer.py
...
class MicrosoftPartnerSdkContractsV1TransfersTransfer(Model):
    ...
    _attribute_map = {'transfer_type': {'key': 'transferType', 'type': 'str'}, 'transfer_entity': {'key': 'transferEntity', 'type': 'MicrosoftPartnerSdkContractsV1TransfersTransferEntity'}, 'id': {'key': 'id', 'type': 'str'}, 'state': {'key': 'state', 'type': 'str'}, 'creation_date': {'key': 'creationDate', 'type': 'iso-8601'}, 'expiration_date': {'key': 'expirationDate', 'type': 'iso-8601'}, 'links': {'key': 'links', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceLinks'}, 'attributes': {'key': 'attributes', 'type': 'MicrosoftPartnerSdkContractsV1CommonResourceAttributes'}}
