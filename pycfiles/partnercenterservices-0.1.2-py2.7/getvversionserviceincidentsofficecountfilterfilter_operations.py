...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/microsoft/store/partnercenterservices/operations/getvversionserviceincidentsofficecountfilterfilter_operations.py
...
class GetvversionserviceincidentsofficecountfilterfilterOperations(object):
    """GetvversionserviceincidentsofficecountfilterfilterOperations operations.
    ...
    def value(self, version, filter=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    value.metadata = {'url': '/v{version}/serviceincidents/office/count'}