...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tigre/Utilities/parkerweight.py
# Compiled at: 2017-06-20 08:49:49
from __future__ import print_function
from __future__ import division
import numpy as np, warnings, scipy.io
...
def parkerweight(proj, geo, angles, q):
    ...
    if totangles < 2 * np.pi:
        warnings.warn('Computing Parker weigths for scanning angle equal or bigger than 2*pi Consider disabling Parker weigths.')
