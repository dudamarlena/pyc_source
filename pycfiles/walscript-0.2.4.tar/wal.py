...
# [GCC 8.4.0]
# Embedded file name: walscript/wal.py
# Compiled at: 2017-11-25 10:56:24
"""
wal - web automation layer.
Simple web automation using yaml syntax.
"""
import argparse, os, sys, yaml, time, logging, signal
from selenium import webdriver
from selenium.webdriver.common.keys import Keys
from selenium.common.exceptions import *
from selenium.webdriver.common.action_chains import ActionChains
DEFAULT = {'homepage': 'http://about:blank', 'screen_width': '1366', 
   'screen_height': '768'}
...
class Interpreter(object):
    ...
    def get_commands(self):
        ...
        """
        return {'back': back, 'backward': back, 
           'backwards': back, 
           'clear': clear, 
           'click': click, 
...
def set_window_size(wal, argument):
    ...
    """
    if type(argument) is list:
        wal.driver.set_window_size(int(argument[0]), int(argument[1]))
...
def inspect(element):
    ...
    return (
     '        tag: <%s>',
     element.tag_name + '       name: %s',
     element.get_attribute('name') + '         id: %s',
     element.get_attribute('id') + '      class: %s',
     element.get_attribute('class') + 'selenium_id: %s', element.id)
...
class Wal(object):
    ...
    def parse_arguments(self):
        ...
        argument('input_files', default=sys.stdin, nargs='*')
    ...
    def setup_web_driver(self):
        ...
        driver.set_window_size(DEFAULT['screen_width'], DEFAULT['screen_height'])
