...
class TestThemaCategory(TestCase):
    ...
    def test_create_instance(self):
        ...
        thema_child = ThemaCategory.objects.create(code=thema_child_code,
    ...
    def test_local_header(self):
        thema = ThemaCategory.objects.create(code='AVL',
          header='Music: styles & genres')
        self.assertIsNone(thema.parent)
    ...
    def test_local_notes(self):
        thema = ThemaCategory.objects.create(code='code',
          header='Music: styles & genres',
          notes='With AVL* codes, ALWAYS assign STYLE Qualifier(s) as appropriate')
