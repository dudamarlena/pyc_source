...
# Size of source mod 2**32: 14011 bytes
...
class ThemaFileParser(object):
    __doc__ = 'Base class for EDItEUR Thema parsers.'
...
class ExcelThemaFileParser(ThemaFileParser):
    __doc__ = 'Parser to translate excel EDItEUR Thema files to json.'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l',
      ...
      help='Language to process, e.g. `en` for English, `da` for Danish. Find all supported languages at http://www.editeur.org/151/Thema/',
      required=True)
