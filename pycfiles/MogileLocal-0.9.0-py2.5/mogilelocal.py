...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mogilelocal.py
# Compiled at: 2008-10-16 18:30:57
"""
...
class Client():
    ...
    def send_file(self, key, source, clas=None, blocksize=1048576):
        """
    ...
    def send_bigfile(self, key, source, clas=None, description='', overwrite=True, chunksize=16777216):
        """
    ...
    def get_bigfile_iter(self, key, chunk_size=1048576):
        r"""
