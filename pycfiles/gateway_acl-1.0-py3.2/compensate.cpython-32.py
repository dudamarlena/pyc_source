...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/acl/meta/compensate.py
...
class WithCompensate(Compensate):
    ...
    Access = declared_attr(lambda cls: Column('fk_access_id', ForeignKey(AccessMapped.Id, ondelete='CASCADE'), nullable=False, primary_key=True))
    ...
    @declared_attr
    def aclAccessId(cls):
        raise Exception('An acl access id definition is required')