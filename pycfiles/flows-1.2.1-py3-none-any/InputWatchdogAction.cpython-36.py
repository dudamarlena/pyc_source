...
# [GCC 8.4.0]
# Embedded file name: c:\Users\mastromatteo\Progetti\flows\flows\Actions\InputWatchdogAction.py
...
class DannyFileSystemEventHandler(PatternMatchingEventHandler):
    __doc__ = "Customized watchdog's FileSystemEventHandler"
    delegates = None
...
class WatchdogAction(Action):
    ...
    def on_init(self):
        ...
        my_event_handler = DannyFileSystemEventHandler(self.patterns, self.ignore_patterns, self.ignore_directories, self.case_sensitive)
        ...
        self.observer.schedule(my_event_handler, (self.path), recursive=(self.recursive_flag))
        self.observer.start()
