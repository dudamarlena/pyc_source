...
# [GCC 8.4.0]
# Embedded file name: c:\Users\mastromatteo\Progetti\flows\flows\Actions\GetUrlAction.py
# Compiled at: 2017-03-23 06:22:15
...
class GetUrlAction(Action):
    ...
    def on_input_received(self, action_input=None):
        ...
        return_value = str(status) + ';' + str(error_message[0]) + ';' + str(html)
