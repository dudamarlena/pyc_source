...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/replaylib/__init__.py
# Compiled at: 2010-06-15 23:27:59
import httplib, pickle
from .data import ReplayData
from .stubs import RecordingHTTPConnection, RecordingHTTPSConnection, PlayingHTTPConnection, PlayingHTTPSConnection
__version__ = '0.1'
current = None
record = False
playback = False
