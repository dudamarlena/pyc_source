...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/replaylib/stubs.py
# Compiled at: 2010-06-15 22:24:36
import hashlib, urlparse, urllib, httplib, socket
...
class PlayingHTTPConnection(_http_connection):
    ...
    def getresponse(self):
        ...
        try:
            ...
            raise replaylib.UnknownRequestError('Received a request which has not been recorded.')
