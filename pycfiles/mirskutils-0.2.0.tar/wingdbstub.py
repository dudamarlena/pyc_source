...
# [GCC 8.4.0]
# Embedded file name: ./webapp/wingdbstub.py
...
WINGHOME = getattr(settings, 'WINGHOME', None)
...
if not kWingDebugDisabled and debugger is None and not has_key(os.environ, 'WINGDB_DISABLED') and not has_key(os.environ, 'WINGDB_ACTIVE'):
    exit_on_fail = 0
    try:
