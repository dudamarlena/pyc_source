...
# [GCC 8.4.0]
# Embedded file name: ./webapp/settings.py
...
for root, dirs, files in os.walk(PROJECT_PATH):
    if 'fixtures' in dirs:
        FIXTURE_DIRS = FIXTURE_DIRS + (os.path.join(root, 'fixtures'),)

STATICFILES_DIRS = ()
for root, dirs, files in os.walk(PROJECT_PATH):
    if 'static' in dirs:
        STATICFILES_DIRS = STATICFILES_DIRS + (os.path.join(root, 'static'),)
...
TEMPLATE_CONTEXT_PROCESSORS = ('django.contrib.auth.context_processors.auth', 'django.core.context_processors.debug',
                               ...
                               'django.core.context_processors.request', 'django.core.context_processors.csrf',
...
INSTALLED_APPS = ('django_admin_bootstrapped.bootstrap3', 'django_admin_bootstrapped',
                  ...
                  'mirskutils', 'south', 'compressor', 'sekizai', 'bootstrapform',
                  'webapp.registration')
EMAIL_USE_TLS = False
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DATABASE_ROUTERS = [
 'webapp.routers.ModelDatabaseRouter']
...
LOGGING = {'version': 1, 
   ...
   'handlers': {'null': {'level': 'DEBUG', 
                ...
                'logfile': {'level': 'DEBUG', 
                            ...
                            'filename': PROJECT_PATH + '/realtime.log', 
                            'maxBytes': 50000, 
                            'backupCount': 2, 
                            'formatter': 'standard'}, 
                'console': {'level': 'DEBUG', 
