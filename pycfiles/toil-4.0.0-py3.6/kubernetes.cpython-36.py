...
# Size of source mod 2**32: 44828 bytes
"""
...
import base64, datetime, getpass, kubernetes, logging, os, pickle, pytz, string, subprocess, sys, uuid, time, urllib3
from kubernetes.client.rest import ApiException
from six.moves.queue import Empty, Queue
from toil import applianceSelf, customDockerInitCmd
from toil.batchSystems.abstractBatchSystem import AbstractBatchSystem, BatchSystemLocalSupport, EXIT_STATUS_UNAVAILABLE_VALUE, UpdatedBatchJobInfo
