...
# Size of source mod 2**32: 53294 bytes
"""
...
class Leader(object):
    ...
    def checkForDeadlocks--- This code section failed: ---

 L. 587         0  LOAD_GLOBAL              len
                2  LOAD_DEREF               'self'
                4  LOAD_ATTR                batchSystem
                6  LOAD_ATTR                getRunningBatchJobIDs
                8  CALL_FUNCTION_0       0  '0 positional arguments'
               10  CALL_FUNCTION_1       1  '1 positional argument'
               12  STORE_FAST               'totalRunningJobs'

 L. 588        14  LOAD_DEREF               'self'
               16  LOAD_ATTR                serviceJobsIssued
               18  LOAD_DEREF               'self'
               20  LOAD_ATTR                preemptableServiceJobsIssued
               22  BINARY_ADD       
               24  STORE_FAST               'totalServicesIssued'

 L. 590        26  LOAD_FAST                'totalServicesIssued'
               28  LOAD_FAST                'totalRunningJobs'
               30  COMPARE_OP               >=
               32  POP_JUMP_IF_FALSE   200  'to 200'
               34  LOAD_FAST                'totalRunningJobs'
               36  LOAD_CONST               0
               38  COMPARE_OP               >
               40  POP_JUMP_IF_FALSE   200  'to 200'

 L. 591        42  LOAD_CLOSURE             'self'
               44  BUILD_TUPLE_1         1 
               46  LOAD_LISTCOMP            '<code_object <listcomp>>'
               48  LOAD_STR                 'Leader.checkForDeadlocks.<locals>.<listcomp>'
               50  MAKE_FUNCTION_8          'closure'
               52  LOAD_GLOBAL              list
               54  LOAD_DEREF               'self'
               56  LOAD_ATTR                jobBatchSystemIDToIssuedJob
               58  LOAD_ATTR                keys
               ...
               68  STORE_FAST               'serviceJobs'

 L. 592        70  LOAD_GLOBAL              set
               72  LOAD_CLOSURE             'self'
               74  BUILD_TUPLE_1         1 
               76  LOAD_LISTCOMP            '<code_object <listcomp>>'
               78  LOAD_STR                 'Leader.checkForDeadlocks.<locals>.<listcomp>'
               80  MAKE_FUNCTION_8          'closure'
               82  LOAD_FAST                'serviceJobs'
               84  GET_ITER         
               86  CALL_FUNCTION_1       1  '1 positional argument'
               88  CALL_FUNCTION_1       1  '1 positional argument'
               90  STORE_FAST               'runningServiceJobs'

 L. 593        92  LOAD_GLOBAL              len
               94  LOAD_FAST                'runningServiceJobs'
               96  CALL_FUNCTION_1       1  '1 positional argument'
               98  LOAD_FAST                'totalRunningJobs'
              100  COMPARE_OP               <=
              102  POP_JUMP_IF_TRUE    108  'to 108'
              104  LOAD_ASSERT              AssertionError
              106  RAISE_VARARGS_1       1  'exception'
            108_0  COME_FROM           102  '102'

 L. 596       108  LOAD_GLOBAL              len
              110  LOAD_FAST                'runningServiceJobs'
              112  CALL_FUNCTION_1       1  '1 positional argument'
              114  LOAD_FAST                'totalRunningJobs'
              116  COMPARE_OP               ==
              118  POP_JUMP_IF_FALSE   184  'to 184'

 L. 598       120  LOAD_DEREF               'self'
              122  LOAD_ATTR                potentialDeadlockedJobs
              124  LOAD_FAST                'runningServiceJobs'
              126  COMPARE_OP               !=
              128  POP_JUMP_IF_FALSE   148  'to 148'

 L. 599       130  LOAD_FAST                'runningServiceJobs'
              132  LOAD_DEREF               'self'
              134  STORE_ATTR               potentialDeadlockedJobs

 L. 600       136  LOAD_GLOBAL              time
              138  LOAD_ATTR                time
              140  CALL_FUNCTION_0       0  '0 positional arguments'
              142  LOAD_DEREF               'self'
              144  STORE_ATTR               potentialDeadlockTime
              146  JUMP_ABSOLUTE       198  'to 198'
              148  ELSE                     '182'

 L. 601       148  LOAD_GLOBAL              time
              150  LOAD_ATTR                time
              152  CALL_FUNCTION_0       0  '0 positional arguments'
              154  LOAD_DEREF               'self'
              156  LOAD_ATTR                potentialDeadlockTime
              158  BINARY_SUBTRACT  
              160  LOAD_DEREF               'self'
              162  LOAD_ATTR                config
              164  LOAD_ATTR                deadlockWait
              166  COMPARE_OP               >=
              168  POP_JUMP_IF_FALSE   198  'to 198'

 L. 602       170  LOAD_GLOBAL              DeadlockException
              172  LOAD_STR                 'The system is service deadlocked - all %d running jobs are active services'
              174  LOAD_FAST                'totalRunningJobs'
              176  BINARY_MODULO    
              178  CALL_FUNCTION_1       1  '1 positional argument'
              180  RAISE_VARARGS_1       1  'exception'
              182  JUMP_ABSOLUTE       214  'to 214'
              184  ELSE                     '198'

 L. 605       184  LOAD_GLOBAL              set
              186  CALL_FUNCTION_0       0  '0 positional arguments'
              188  LOAD_DEREF               'self'
              190  STORE_ATTR               potentialDeadlockedJobs

 L. 606       192  LOAD_CONST               0
              194  LOAD_DEREF               'self'
              196  STORE_ATTR               potentialDeadlockTime
            198_0  COME_FROM           168  '168'
              198  JUMP_FORWARD        214  'to 214'
            200_0  COME_FROM            32  '32'

 L. 609       200  LOAD_GLOBAL              set
              202  CALL_FUNCTION_0       0  '0 positional arguments'
              204  LOAD_DEREF               'self'
              206  STORE_ATTR               potentialDeadlockedJobs

 L. 610       208  LOAD_CONST               0
              210  LOAD_DEREF               'self'
              212  STORE_ATTR               potentialDeadlockTime
