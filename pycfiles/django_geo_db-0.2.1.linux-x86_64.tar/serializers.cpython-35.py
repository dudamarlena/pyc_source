...
# [GCC 8.4.0]
# Embedded file name: /home/trjg/code/venv/django-geo-db/lib/python3.5/site-packages/django_geo_db/serializers.py
# Compiled at: 2018-03-10 21:41:48
# Size of source mod 2**32: 2901 bytes
from rest_framework import serializers
from django_geo_db.models import Location, GeoCoordinate, Zipcode, Continent, Country, State, City, County, LocationMap, LocationMapType
...
class CountySerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = County
        fields = ('county_id', 'state', 'name', 'geocoordinate', 'generated_name',
                  'url')
...
class CitySerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = City
        fields = ('city_id', 'state', 'county', 'name', 'geocoordinate', 'generated_name',
                  'url')
...
class LocationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Location
        fields = ('location_id', 'country', 'city', 'county', 'state', 'zipcode', 'geocoordinate',
                  'lat', 'lon', 'name', 'generated_name', 'url')
