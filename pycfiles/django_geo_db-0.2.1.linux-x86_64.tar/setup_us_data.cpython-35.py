...
# [GCC 8.4.0]
# Embedded file name: /home/trjg/code/venv/django-geo-db/lib/python3.5/site-packages/django_geo_db/management/commands/setup_us_data.py
# Compiled at: 2018-02-11 12:18:49
# Size of source mod 2**32: 6608 bytes
from datetime import datetime
from django.core.management.base import BaseCommand
from django_geo_db.models import City, Continent, Country, GeoCoordinate, State, Location, Zipcode, County
...
class Command(BaseCommand):
    ...
    def create_all_countries_and_continents(self):
        ...
        for country, continent, abbrev, lat, lon in generate_countries():
            try:
                ...
                geocoordinate = self._Command__get_geocoordinate(lat, lon)
    ...
    def create_all_us_states(self):
        ...
        for state, abbreviation, latitude, longitude in generate_current_us_states_list():
            try:
                geoCoordinate = self._Command__get_geocoordinate(latitude, longitude)
