...
# [GCC 8.4.0]
# Embedded file name: /home/trjg/code/venv/django-geo-db/lib/python3.5/site-packages/django_geo_db/models.py
# Compiled at: 2018-03-10 21:39:39
# Size of source mod 2**32: 16023 bytes
...
class GeoCoordinate(models.Model):
    ...
    def __str__(self):
        return self.generated_name or self._GeoCoordinate__get_generated_name()

    def save(self, *args, **kwargs):
        self._GeoCoordinate__standardize_fractionals()
        self.generated_name = self._GeoCoordinate__get_generated_name()
        self._GeoCoordinate__generate_whole_fractionals()
    ...
    def split_lat_coordinate(coordinate):
        ...
        if whole[0] == '0':
            ...
            coord_points.append(int(whole[1]))
        coord_points += GeoCoordinate._GeoCoordinate__split_frac(frac)
...
class State(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.generated_name = self._State__get_generated_name()
        return super(State, self).save(*args, **kwargs)

    def __str__(self):
        return self.generated_name or self._State__get_generated_name()
...
class County(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.generated_name = self._County__get_generated_name()
        return super(County, self).save(*args, **kwargs)

    def __str__(self):
        return self.generated_name or self._County__get_generated_name()
...
class City(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.generated_name = self._City__get_generated_name()
    ...
    def __str__(self):
        return self.generated_name or self._City__get_generated_name()
...
class Zipcode(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.generated_name = self._Zipcode__get_generated_name()
        return super(Zipcode, self).save(*args, **kwargs)

    def __str__(self):
        return self.generated_name or self._Zipcode__get_generated_name()
...
class Location(models.Model):
    ...
    def __str__(self):
        return self.generated_name or self._Location__get_generated_name()
    ...
    def save(self, *args, **kwargs):
        self._Location__set_cascading_details()
        self._Location__set_generated_name()
        self._Location__validate_interconnection_details()
    ...
    def __set_generated_name(self):
        self.generated_name = self._Location__get_generated_name()
...
class LocationBounds(models.Model):
    ...
    def __str__(self):
        return '{location}: {max_lat}:{min_lat} {max_lon}:{min_lon}'.format(location=self.location, max_lat=self.max_lat, min_lat=self.min_lat, max_lon=self.max_lon, min_lon=self.min_lon)
