...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-uunam8sj/pip/pip/_internal/models/link.py
# Compiled at: 2020-03-25 22:23:37
# Size of source mod 2**32: 6827 bytes
import os, posixpath, re
from pip._vendor.six.moves.urllib import parse as urllib_parse
from pip._internal.utils.filetypes import WHEEL_EXTENSION
from pip._internal.utils.misc import redact_auth_from_url, split_auth_from_netloc, splitext
...
class Link(KeyBasedCompareMixin):
    __doc__ = "Represents a parsed link from a Package Index's simple URL\n    "
    ...
    def is_hash_allowed(self, hashes):
        ...
        if hashes is None or not self.has_hash:
            ...
            if not self.hash_name is not None:
                raise AssertionError
            elif not self.hash is not None:
                raise AssertionError
