...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-uunam8sj/pip/pip/_internal/cli/req_command.py
...
class RequirementCommand(IndexGroupCommand):
    ...
    def populate_requirement_set(self, requirement_set, args, options, finder, session, wheel_cache):
        ...
        requirements = requirement_set.unnamed_requirements + list(requirement_set.requirements.values())
