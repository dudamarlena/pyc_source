...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-uunam8sj/pip/pip/_internal/req/req_install.py
# Compiled at: 2020-03-25 22:23:37
# Size of source mod 2**32: 30442 bytes
...
from pip._internal.utils.marker_files import PIP_DELETE_MARKER_FILENAME, has_delete_marker_file, write_delete_marker_file
from pip._internal.utils.misc import ask_path_exists, backup_dir, display_path, dist_in_site_packages, dist_in_usersite, get_installed_version, hide_url, redact_auth_from_url, rmtree
...
class InstallRequirement(object):
    ...
    def _set_requirement(self):
        ...
        if not self.req is None:
            ...
            if not self.metadata is not None:
                raise AssertionError
            elif not self.source_dir is not None:
                raise AssertionError
