...
# [GCC 8.4.0]
# Embedded file name: /tmp/src/qsiprep/wrapper/build/lib/python3.6/enum.py
# Compiled at: 2019-03-22 00:31:36
# Size of source mod 2**32: 33472 bytes
import sys
...
class Flag(Enum):
    ...
    def __invert__(self):
        ...
        inverted_members = [m for m in self.__class__ if m not in members if not m._value_ & self._value_]
