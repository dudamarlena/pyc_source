...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-uunam8sj/pip/pip/_vendor/distlib/_backport/sysconfig.py
# Compiled at: 2020-03-25 22:23:37
# Size of source mod 2**32: 26854 bytes
...
if os.name == 'nt':
    if 'pcbuild' in _PROJECT_BASE[-8:].lower():
        _PROJECT_BASE = _safe_realpath(os.path.join(_PROJECT_BASE, pardir))
if os.name == 'nt' and '\\pc\\v' in _PROJECT_BASE[-10:].lower():
    _PROJECT_BASE = _safe_realpath(os.path.join(_PROJECT_BASE, pardir, pardir))
if os.name == 'nt':
    if '\\pcbuild\\amd64' in _PROJECT_BASE[-14:].lower():
        _PROJECT_BASE = _safe_realpath(os.path.join(_PROJECT_BASE, pardir, pardir))
                ...
                if osname[:6] == 'cygwin':
                    ...
                    try:
                        ...
                        if macver:
                            ...
                            osname = 'macosx'
                            if macrelease + '.' >= '10.4.':
                                if '-arch' in get_config_vars().get('CFLAGS', '').strip():
                                    machine = 'fat'
