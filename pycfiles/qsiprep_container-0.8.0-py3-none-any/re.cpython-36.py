...
# [GCC 8.4.0]
# Embedded file name: /tmp/src/qsiprep/wrapper/build/lib/python3.6/re.py
# Compiled at: 2019-03-22 00:31:36
# Size of source mod 2**32: 15552 bytes
...
"""
import enum, sre_compile, sre_parse, functools
try:
    import _locale
except ImportError:
    _locale = None
        ...
        if not flags & DEBUG:
            if len(_cache) >= _MAXCACHE:
                ...
                if p.flags & LOCALE:
                    ...
                    loc = None
            _cache[(type(pattern), pattern, flags)] = (
             p, loc)
        return p
