...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-uunam8sj/pip/pip/_internal/index/package_finder.py
            ...
            if ext not in SUPPORTED_EXTENSIONS:
                ...
                if 'binary' not in self._formats:
                    if ext == WHEEL_EXTENSION:
                        ...
                        version = version or _extract_version_from_fragment(egg_info, self._canonical_name)
                    return version or (
                    ...
                    return supports_python or (False, None)
