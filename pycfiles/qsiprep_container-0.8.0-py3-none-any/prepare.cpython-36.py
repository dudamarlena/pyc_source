...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-uunam8sj/pip/pip/_internal/operations/prepare.py
...
class RequirementPreparer(object):
    ...
    def prepare_installed_requirement(self, req, skip_reason):
        ...
        if not req.satisfied_by:
            ...
            raise AssertionError('did not get skip reason skipped but req.satisfied_by is set to {}'.format(req.satisfied_by))
