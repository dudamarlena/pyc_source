...
# [GCC 8.4.0]
# Embedded file name: /tmp/src/qsiprep/wrapper/build/lib/python3.6/operator.py
# Compiled at: 2019-03-22 00:31:36
# Size of source mod 2**32: 10863 bytes
"""
Operator Interface
...
class methodcaller:
    ...
    def __reduce__(self):
        if not self._kwargs:
            ...
            return (
             partial((self.__class__), (self._name), **self._kwargs), self._args)
