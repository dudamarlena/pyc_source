...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-rpc7z9ca/catsoop/catsoop/__QTYPES__/multiplechoice/multiplechoice.py
# Compiled at: 2020-01-06 01:44:31
# Size of source mod 2**32: 7863 bytes
import json, collections.abc
...
defaults = {'csq_soln':'--', 
 ...
 'csq_options':[],  'csq_show_check':False, 
...
def render_html(last_log, **info):
    ...
    return "<font color='red'>Invalid <tt>multiplechoice</tt> renderer: %s</font>" % r
...
_renderers = {'dropdown':render_html_dropdown, 
