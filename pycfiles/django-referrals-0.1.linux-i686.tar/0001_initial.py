...
# [GCC 8.4.0]
# Embedded file name: /home/craterdome/work/magikally/lib/python2.7/site-packages/referrals/migrations/0001_initial.py
# Compiled at: 2011-12-19 15:14:28
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('referrals_referral', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='referral', unique=True, to=orm['auth.User'])),
         (
          'unique_key', self.gf('django.db.models.fields.CharField')(max_length=100))))
        db.send_create_signal('referrals', ['Referral'])
        db.create_table('referrals_referral_referred_users', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'referral', models.ForeignKey(orm['referrals.referral'], null=False)),
         (
          'user', models.ForeignKey(orm['auth.user'], null=False))))
        db.create_unique('referrals_referral_referred_users', ['referral_id', 'user_id'])

    def backwards(self, orm):
        db.delete_table('referrals_referral')
        db.delete_table('referrals_referral_referred_users')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'referrals.referral': {'Meta': {'object_name': 'Referral'}, 'id': (
                                   'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                              'referred_users': (
                                               'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'referrals'", 'blank': 'True', 'to': "orm['auth.User']"}), 
                              'unique_key': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'}), 
                              'user': (
                                     'django.db.models.fields.related.OneToOneField', [], {'related_name': "'referral'", 'unique': 'True', 'to': "orm['auth.User']"})}}
    complete_apps = [
     'referrals']