...
# Embedded file name: build/bdist.linux-x86_64/egg/test/tests_sugar_syntax.py
# Compiled at: 2019-04-06 01:11:30
...
class TestService(AsyncHTTPTestCase):
    ...
    def test_post_book(self):
        ...
        self.assertEqual(response.code, 200)
        self.assertEqual(response.body, 'Book isbn 978-1617294037 received')
