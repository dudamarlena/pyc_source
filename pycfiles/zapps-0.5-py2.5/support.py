...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/zapps/support.py
# Compiled at: 2008-03-20 03:00:12
INDENT = '    '
import re, sys
from string import *
        ...
        for c in self.children:
            ...
            if testset:
                if not tokens_unseen:
                    ...
                    gen.write(indent, test, ' ', gen.in_test('_token_', tokens_unseen, testset), ':\n')
                    c.output(gen, indent + INDENT)
                test = 'elif'
