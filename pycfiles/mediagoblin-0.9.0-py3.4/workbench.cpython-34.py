...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mediagoblin/tools/workbench.py
# Compiled at: 2016-02-04 13:34:40
# Size of source mod 2**32: 5772 bytes
import os, shutil, tempfile, six
...
class Workbench(object):
    ...
    def localized_file(self, storage, filepath, filename_if_copying=None, keep_extension_if_copying=True):
        """
        ...
        if storage.local_storage:
            ...
            full_dest_filename = os.path.join(self.dir, dest_filename)
            storage.copy_locally(filepath, full_dest_filename)
