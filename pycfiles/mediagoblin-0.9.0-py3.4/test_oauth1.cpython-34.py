...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mediagoblin/tests/test_oauth1.py
# Compiled at: 2016-02-04 13:34:40
# Size of source mod 2**32: 6173 bytes
import pytest
...
class TestOAuth(object):
    ...
    def login(self):
        self.test_app.post('/auth/login/', {'username': self.user.username, 
    ...
    def test_client_register_full_info(self):
        ...
        query = {'application_name': 'Testificate MD', 
    ...
    def test_client_update(self):
        ...
        client_info = response.json
        client = self.db.Client.query.filter_by(id=client_info['client_id']).first()
        update_query = {'type': 'client_update', 
    ...
    def test_request_token(self):
        ...
        request_query = {'oauth_consumer_key': client_id, 
        ...
        request_token = self.db.RequestToken.query.filter_by(token=response['oauth_token']).first()
