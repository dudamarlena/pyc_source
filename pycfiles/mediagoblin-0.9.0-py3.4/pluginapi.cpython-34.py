...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mediagoblin/tools/pluginapi.py
...
class PluginManager(object):
    __doc__ = 'Manager for plugin things\n\n    .. Note::\n\n       This is a Borg class--there is one and only one of this class.\n    '
    _PluginManager__state = {'plugins': [],  'hooks': {},  'template_paths': set(), 
     'template_hooks': {},  'routes': []}
    ...
    def __init__(self):
        self.__dict__ = self._PluginManager__state
