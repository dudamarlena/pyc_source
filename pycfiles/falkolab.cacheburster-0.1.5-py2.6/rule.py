...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/falkolab/cacheburster/rule.py
# Compiled at: 2010-12-17 11:46:30
import zope.component, os.path
...
class CacheBursterRule(object):
    ...
    def __call__(self, request):
        vm = zope.component.getMultiAdapter((self.__resource, request), IVersionManager, self.__manager)
