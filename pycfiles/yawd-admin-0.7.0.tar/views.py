...
# [GCC 8.4.0]
# Embedded file name: /www/elorus/local/lib/python2.7/site-packages/yawdadmin/views.py
...
class AnalyticsAuthView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        credential = ls.ADMIN_GOOGLE_ANALYTICS_FLOW.step2_exchange(request.REQUEST)
...
class AnalyticsConfigView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['analytics_info'] = {'profile': ls.ADMIN_GOOGLE_ANALYTICS['profile_id'], 
...
class AnalyticsConnectView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        ls.ADMIN_GOOGLE_ANALYTICS_FLOW.params['state'] = xsrfutil.generate_token(settings.SECRET_KEY, request.user)
        return HttpResponseRedirect(ls.ADMIN_GOOGLE_ANALYTICS_FLOW.step1_get_authorize_url())
