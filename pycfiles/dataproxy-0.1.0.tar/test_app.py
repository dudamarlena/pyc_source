...
# [GCC 8.4.0]
# Embedded file name: /home/rgrp/hgroot/dataproxy/test/test_app.py
# Compiled at: 2011-01-08 05:57:19
...
class TestDataProxy(object):
    ...
    def setup(self):
        ...
        self.requests = {'no_type': 'url=http://foo.com/foo', 
           ...
           'valid_csv_limit': {'url': 'http://democracyfarm.org/f/ckan/foo.csv', 
                               'max-results': 3, 
                               'format': 'json'}, 
           'csv_json': 'url=http://democracyfarm.org/f/ckan/foo.csv&format=json', 
           'valid_xls': 'url=http://democracyfarm.org/f/ckan/foo.xls', 
           'untyped_csv': {'url': 'http://openeconomics.net/store/8d7d4770-e1d1-11db-9f7e-00145101c316/data', 
                           'type': 'csv'}, 
