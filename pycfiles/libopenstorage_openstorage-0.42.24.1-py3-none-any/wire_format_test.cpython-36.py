...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/wire_format_test.py
...
class WireFormatTest(unittest.TestCase):
    ...
    def testByteSizeFunctions(self):
        ...
        self.assertEqual(10, wire_format.StringByteSize(5, (b'\xd0\xa2\xd0\xb5\xd1\x81\xd1\x82').decode('utf-8')))
