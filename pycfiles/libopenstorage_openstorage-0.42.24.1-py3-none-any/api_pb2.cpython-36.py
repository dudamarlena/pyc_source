...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/api_pb2.py
...
_API = _descriptor.Descriptor(name='Api',
 ...
 _descriptor.FieldDescriptor(name='syntax',
  ...
  serialized_end=370)
_METHOD = _descriptor.Descriptor(name='Method',
  ...
  fields=[
 _descriptor.FieldDescriptor(name='name',
   full_name='google.protobuf.Method.name',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='request_type_url',
   full_name='google.protobuf.Method.request_type_url',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='request_streaming',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='response_type_url',
   full_name='google.protobuf.Method.response_type_url',
   index=3,
   number=4,
   type=9,
   cpp_type=9,
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='response_streaming',
   full_name='google.protobuf.Method.response_streaming',
   index=4,
   number=5,
   type=8,
   cpp_type=7,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='options',
   full_name='google.protobuf.Method.options',
   index=5,
   number=6,
   type=11,
   cpp_type=10,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='syntax',
   full_name='google.protobuf.Method.syntax',
   index=6,
   number=7,
   type=14,
   cpp_type=8,
  ...
  serialized_end=586)
_MIXIN = _descriptor.Descriptor(name='Mixin',
  ...
  fields=[
 _descriptor.FieldDescriptor(name='name',
   full_name='google.protobuf.Mixin.name',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='root',
   full_name='google.protobuf.Mixin.root',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
...
Api = _reflection.GeneratedProtocolMessageType('Api', (_message.Message,), {'DESCRIPTOR':_API, 
 '__module__':'google.protobuf.api_pb2'})
_sym_db.RegisterMessage(Api)
Method = _reflection.GeneratedProtocolMessageType('Method', (_message.Message,), {'DESCRIPTOR':_METHOD, 
 '__module__':'google.protobuf.api_pb2'})
_sym_db.RegisterMessage(Method)
Mixin = _reflection.GeneratedProtocolMessageType('Mixin', (_message.Message,), {'DESCRIPTOR':_MIXIN, 
 '__module__':'google.protobuf.api_pb2'})
