...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/keyring/keyring/backends/SecretService.py
...
from ..errors import InitError, PasswordDeleteError, ExceptionRaisedContext, KeyringLocked
try:
