...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/struct_pb2.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 10732 bytes
...
NULL_VALUE = 0
_STRUCT_FIELDSENTRY = _descriptor.Descriptor(name='FieldsEntry',
 ...
 _descriptor.FieldDescriptor(name='value',
  ...
  serialized_end=182)
_STRUCT = _descriptor.Descriptor(name='Struct',
 ...
 _STRUCT_FIELDSENTRY],
  ...
  serialized_start=50,
  serialized_end=182)
_VALUE = _descriptor.Descriptor(name='Value',
  full_name='google.protobuf.Value',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='null_value',
 ...
 _descriptor.FieldDescriptor(name='number_value',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='string_value',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='bool_value',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='struct_value',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='list_value',
  ...
  extension_ranges=[],
  oneofs=[
 _descriptor.OneofDescriptor(name='kind',
  ...
  serialized_end=419)
_LISTVALUE = _descriptor.Descriptor(name='ListValue',
 ...
 _descriptor.FieldDescriptor(name='values',
   full_name='google.protobuf.ListValue.values',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
