...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/generator_test.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 15244 bytes
...
class GeneratorTest(unittest.TestCase):
    ...
    def testHasDefaultValues(self):
        ...
        expected_has_default_by_name = {'optional_int32':False, 
    ...
    def testNestedTypes(self):
        self.assertEqual(set(unittest_pb2.TestAllTypes.DESCRIPTOR.nested_types), set([
    ...
    def testEnumTypesByName(self):
        file_type = unittest_pb2.DESCRIPTOR
        self.assertEqual(unittest_pb2._FOREIGNENUM, file_type.enum_types_by_name[unittest_pb2._FOREIGNENUM.name])

    def testExtensionsByName(self):
        file_type = unittest_pb2.DESCRIPTOR
        self.assertEqual(unittest_pb2.my_extension_string, file_type.extensions_by_name[unittest_pb2.my_extension_string.name])
    ...
    def testEnumWithDupValue(self):
        self.assertEqual('FOO1', unittest_pb2.TestEnumWithDupValue.Name(unittest_pb2.FOO1))
        self.assertEqual('FOO1', unittest_pb2.TestEnumWithDupValue.Name(unittest_pb2.FOO2))
        self.assertEqual('BAR1', unittest_pb2.TestEnumWithDupValue.Name(unittest_pb2.BAR1))
        self.assertEqual('BAR1', unittest_pb2.TestEnumWithDupValue.Name(unittest_pb2.BAR2))


class SymbolDatabaseRegistrationTest(unittest.TestCase):
    __doc__ = 'Checks that messages, enums and files are correctly registered.'
    ...
    def testEnums(self):
        self.assertEqual('protobuf_unittest.ForeignEnum', symbol_database.Default().pool.FindEnumTypeByName('protobuf_unittest.ForeignEnum').full_name)
        self.assertEqual('protobuf_unittest.TestAllTypes.NestedEnum', symbol_database.Default().pool.FindEnumTypeByName('protobuf_unittest.TestAllTypes.NestedEnum').full_name)

    def testFindFileByName(self):
        self.assertEqual('google/protobuf/unittest.proto', symbol_database.Default().pool.FindFileByName('google/protobuf/unittest.proto').name)
