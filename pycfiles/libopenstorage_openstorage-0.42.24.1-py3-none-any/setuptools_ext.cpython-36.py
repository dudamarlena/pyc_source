...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cffi/cffi/setuptools_ext.py
...
def add_cffi_module(dist, mod_spec):
    ...
    if not isinstance(mod_spec, basestring):
        error("argument to 'cffi_modules=...' must be a str or a list of str, not %r" % (
         type(mod_spec).__name__,))
