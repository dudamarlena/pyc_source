...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/type_checkers.py
...
class FloatValueChecker(object):
    __doc__ = 'Checker used for float fields.  Performs type-check and range check.\n\n  Values exceeding a 32-bit float will be converted to inf/-inf.\n  '
