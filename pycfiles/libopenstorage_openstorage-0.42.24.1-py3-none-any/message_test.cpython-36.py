...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/message_test.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 106383 bytes
...
import copy, math, operator, pickle, pydoc, six, sys, warnings
try:
...
class MessageTest(unittest.TestCase):
    ...
    def testParseErrors(self, message_module):
        ...
        self.assertRaises(message.DecodeError, msg.FromString, b'\x03\x04')

    def testDeterminismParameters(self, message_module):
        golden_data = b'\xe2\x02\nOne string\xe2\x02\nTwo string\xe2\x02\nRed string\xe2\x02\x0bBlue string'
        golden_message = message_module.TestAllTypes()
        golden_message.repeated_string.extend([
         ...
         'Red string',
         'Blue string'])
        self.assertEqual(golden_data, golden_message.SerializeToString(deterministic=None))
        self.assertEqual(golden_data, golden_message.SerializeToString(deterministic=False))
        self.assertEqual(golden_data, golden_message.SerializeToString(deterministic=True))
    ...
    def testPositiveInfinity(self, message_module):
        if message_module is unittest_pb2:
            golden_data = b']\x00\x00\x80\x7fa\x00\x00\x00\x00\x00\x00\xf0\x7f\xcd\x02\x00\x00\x80\x7f\xd1\x02\x00\x00\x00\x00\x00\x00\xf0\x7f'
        else:
            golden_data = b']\x00\x00\x80\x7fa\x00\x00\x00\x00\x00\x00\xf0\x7f\xca\x02\x04\x00\x00\x80\x7f\xd2\x02\x08\x00\x00\x00\x00\x00\x00\xf0\x7f'
        golden_message = message_module.TestAllTypes()
        golden_message.ParseFromString(golden_data)
    ...
    def testNegativeInfinity(self, message_module):
        if message_module is unittest_pb2:
            golden_data = b']\x00\x00\x80\xffa\x00\x00\x00\x00\x00\x00\xf0\xff\xcd\x02\x00\x00\x80\xff\xd1\x02\x00\x00\x00\x00\x00\x00\xf0\xff'
        else:
            golden_data = b']\x00\x00\x80\xffa\x00\x00\x00\x00\x00\x00\xf0\xff\xca\x02\x04\x00\x00\x80\xff\xd2\x02\x08\x00\x00\x00\x00\x00\x00\xf0\xff'
        golden_message = message_module.TestAllTypes()
        golden_message.ParseFromString(golden_data)
    ...
    def testNotANumber(self, message_module):
        golden_data = b']\x00\x00\xc0\x7fa\x00\x00\x00\x00\x00\x00\xf8\x7f\xcd\x02\x00\x00\xc0\x7f\xd1\x02\x00\x00\x00\x00\x00\x00\xf8\x7f'
        golden_message = message_module.TestAllTypes()
        golden_message.ParseFromString(golden_data)
    ...
    def testPositiveInfinityPacked(self, message_module):
        golden_data = b'\xa2\x06\x04\x00\x00\x80\x7f\xaa\x06\x08\x00\x00\x00\x00\x00\x00\xf0\x7f'
        golden_message = message_module.TestPackedTypes()
        golden_message.ParseFromString(golden_data)
    ...
    def testNegativeInfinityPacked(self, message_module):
        golden_data = b'\xa2\x06\x04\x00\x00\x80\xff\xaa\x06\x08\x00\x00\x00\x00\x00\x00\xf0\xff'
        golden_message = message_module.TestPackedTypes()
        golden_message.ParseFromString(golden_data)
    ...
    def testNotANumberPacked(self, message_module):
        golden_data = b'\xa2\x06\x04\x00\x00\xc0\x7f\xaa\x06\x08\x00\x00\x00\x00\x00\x00\xf8\x7f'
        golden_message = message_module.TestPackedTypes()
        golden_message.ParseFromString(golden_data)
    ...
    def testAppendRepeatedCompositeField(self, message_module):
        msg = message_module.TestAllTypes()
        msg.repeated_nested_message.append(message_module.TestAllTypes.NestedMessage(bb=1))
    ...
    def testInsertRepeatedCompositeField(self, message_module):
        msg = message_module.TestAllTypes()
        msg.repeated_nested_message.insert(-1, message_module.TestAllTypes.NestedMessage(bb=1))
        sub_msg = msg.repeated_nested_message[0]
        msg.repeated_nested_message.insert(0, message_module.TestAllTypes.NestedMessage(bb=2))
        msg.repeated_nested_message.insert(99, message_module.TestAllTypes.NestedMessage(bb=3))
        msg.repeated_nested_message.insert(-2, message_module.TestAllTypes.NestedMessage(bb=(-1)))
        msg.repeated_nested_message.insert(-1000, message_module.TestAllTypes.NestedMessage(bb=(-1000)))
        try:
        ...
        self.assertEqual([-1000, 2, -1, 1, 3], [m.bb for m in msg.repeated_nested_message])
    ...
    def testRepeatedFieldsAreSequences(self, message_module):
        ...
        self.assertIsInstance(m.repeated_nested_message, collections_abc.MutableSequence)
    ...
    def testMergeFrom(self, message_module):
        ...
        msg1.MergeFrom(msg2)
        self.assertEqual(1, nested.bb)
        self.assertEqual(msg1.payload.repeated_nested_message, msg1.payload.repeated_nested_message)
...
class Proto2Test(unittest.TestCase):
    ...
    def testMergeFromExtensions(self):
        ...
        self.assertEqual(0, msg1.submessage.Extensions[more_extensions_pb2.optional_int_extension])
        self.assertFalse(msg1.HasField('submessage'))
        msg2.submessage.Extensions[more_extensions_pb2.optional_int_extension] = 123
        msg1.MergeFrom(msg2)
        self.assertEqual(123, msg1.submessage.Extensions[more_extensions_pb2.optional_int_extension])
    ...
    def testPythonicInit(self):
        message = unittest_pb2.TestAllTypes(optional_int32=100,
        ...
        self.assertEqual(message.optional_foreign_message, unittest_pb2.ForeignMessage())
...
class Proto3Test(unittest.TestCase):
    ...
    def testScalarMapDefaults(self):
        ...
        self.assertFalse(-8589934592 in msg.map_int64_int64)
        self.assertFalse(123 in msg.map_uint32_uint32)
        self.assertFalse(8589934592 in msg.map_uint64_uint64)
        ...
        self.assertEqual(0, msg.map_int64_int64[(-8589934592)])
        self.assertEqual(0, msg.map_uint32_uint32[123])
        self.assertEqual(0, msg.map_uint64_uint64[8589934592])
        ...
        self.assertTrue(-8589934592 in msg.map_int64_int64)
        self.assertTrue(123 in msg.map_uint32_uint32)
        self.assertTrue(8589934592 in msg.map_uint64_uint64)
    ...
    def testScalarMap(self):
        ...
        msg.map_int64_int64[-8589934592] = -17179869184
        msg.map_uint32_uint32[123] = 456
        msg.map_uint64_uint64[8589934592] = 17179869184
        ...
        self.assertEqual(-17179869184, msg2.map_int64_int64[(-8589934592)])
        self.assertEqual(456, msg2.map_uint32_uint32[123])
        self.assertEqual(17179869184, msg2.map_uint64_uint64[8589934592])
    ...
    def testMessageMap(self):
        ...
        self.assertIn(str(msg2.map_int32_foreign_message), ('{-456: , 123: c: 1\n}',
                                                            '{123: c: 1\n, -456: }'))
    ...
    def testIntegerMapWithLongs(self):
        ...
        msg.map_int64_int64[long(-8589934592)] = long(-17179869184)
        msg.map_uint32_uint32[long(123)] = long(456)
        msg.map_uint64_uint64[long(8589934592)] = long(17179869184)
        serialized = msg.SerializeToString()
        msg2 = map_unittest_pb2.TestMap()
        msg2.ParseFromString(serialized)
        self.assertEqual(-456, msg2.map_int32_int32[(-123)])
    ...
    def testPython2Map(self):
        if sys.version_info < (3, ):
            ...
            self.assertEqual(4, len(map_int32))
            with self.assertRaises(TypeError):
                map_int32.update(msg2.map_int32_int32, msg2.map_int32_int32)
            with self.assertRaises(TypeError):
                map_int32.update(0)
            with self.assertRaises(TypeError):
    ...
    def testMapDeterministicSerialization(self):
        golden_data = b'r\x0c\n\x07init_op\x12\x01dr\n\n\x05item1\x12\x01er\n\n\x05item2\x12\x01fr\n\n\x05item3\x12\x01gr\x0b\n\x05item4\x12\x02QQr\x12\n\rlocal_init_op\x12\x01ar\x0e\n\tsummaries\x12\x01er\x18\n\x13trainable_variables\x12\x01br\x0e\n\tvariables\x12\x01c'
        msg = map_unittest_pb2.TestMap()
    ...
    def testMessageMapItemValidAfterTopMessageCleared(self):
        ...
        if api_implementation.Type() == 'cpp':
            unused_map = msg.map_int32_all_types
    ...
    def testMapsAreMapping(self):
        ...
        self.assertIsInstance(msg.map_int32_foreign_message, collections_abc.MutableMapping)
    ...
    def testStrictUtf8Check(self):
        ...
        serialized = unittest_proto3_arena_pb2.TestAllTypes(optional_string='😍').SerializeToString()
    ...
    @unittest.skipIf(six.PY3 or sys.maxunicode == UCS2_MAXUNICODE, 'Surrogates are rejected at setters in Python3')
    def testSurrogatesInPython2(self):
        msg = unittest_proto3_arena_pb2.TestAllTypes(optional_string='\ud801\udc01')
        if api_implementation.Type() == 'python':
            self.assertEqual(msg.optional_string, '\ud801\udc01')
        else:
            self.assertEqual(msg.optional_string, '𐐁')
        serialized = msg.SerializeToString()
        msg2 = unittest_proto3_arena_pb2.TestAllTypes()
        msg2.MergeFromString(serialized)
        self.assertEqual(msg2.optional_string, '𐐁')
        msg = unittest_proto3_arena_pb2.TestAllTypes(optional_string=b'\xed\xa0\x81')
        unittest_proto3_arena_pb2.TestAllTypes(optional_string='\ud801')
        unittest_proto3_arena_pb2.TestAllTypes(optional_string='\ud801\ud801')
...
class PackedFieldTest(unittest.TestCase):
    ...
    def testPackedFields(self):
        ...
        golden_data = b'\n\x01\x01\x12\x01\x01\x1a\x01\x01"\x01\x01*\x01\x022\x01\x02:\x04\x01\x00\x00\x00B\x08\x01\x00\x00\x00\x00\x00\x00\x00J\x04\x01\x00\x00\x00R\x08\x01\x00\x00\x00\x00\x00\x00\x00Z\x04\x00\x00\x80?b\x08\x00\x00\x00\x00\x00\x00\xf0?j\x01\x01r\x01\x01'
        self.assertEqual(golden_data, message.SerializeToString())

    def testUnpackedFields(self):
        message = packed_field_test_pb2.TestUnpackedTypes()
        self.setMessage(message)
        golden_data = b'\x08\x01\x10\x01\x18\x01 \x01(\x020\x02=\x01\x00\x00\x00A\x01\x00\x00\x00\x00\x00\x00\x00M\x01\x00\x00\x00Q\x01\x00\x00\x00\x00\x00\x00\x00]\x00\x00\x80?a\x00\x00\x00\x00\x00\x00\xf0?h\x01p\x01'
        self.assertEqual(golden_data, message.SerializeToString())


@unittest.skipIf(api_implementation.Type() != 'cpp' or sys.version_info < (2, 7), 'explicit tests of the C++ implementation for PY27 and above')
@testing_refleaks.TestCase
class OversizeProtosTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        pool.Add(desc)
        cls.proto_cls = message_factory.MessageFactory(pool).GetPrototype(pool.FindMessageTypeByName('f.msg2'))

    def setUp(self):
        self.p = self.proto_cls()
        self.p.field.payload = 'c' * 67108865
