...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/grpcio/grpc/beta/implementations.py
# Compiled at: 2020-01-10 16:25:22
# Size of source mod 2**32: 11878 bytes
...
class StubOptions(object):
    __doc__ = 'A value encapsulating the various options for creation of a Stub.\n\n  This class and its instances have no supported interface - it exists to define\n  the type of its instances and its instances exist to be passed to other\n  functions.\n  '
...
class ServerOptions(object):
    __doc__ = 'A value encapsulating the various options for creation of a Server.\n\n  This class and its instances have no supported interface - it exists to define\n  the type of its instances and its instances exist to be passed to other\n  functions.\n  '
...
def server(service_implementations, options=None):
  ...
  """
    ...
    return _server_adaptations.server(service_implementations, effective_options.multi_method_implementation, effective_options.request_deserializers, effective_options.response_serializers, effective_options.thread_pool, effective_options.thread_pool_size)