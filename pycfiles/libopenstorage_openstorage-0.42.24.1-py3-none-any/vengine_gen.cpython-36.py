...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cffi/cffi/vengine_gen.py
# Compiled at: 2020-01-10 16:25:38
# Size of source mod 2**32: 26676 bytes
import sys, os, types
from . import model
            ...
            if any(isinstance(typ, model.StructOrUnion) for typ in tp.args) or isinstance(tp.result, model.StructOrUnion):
                ...
                if isinstance(indirect_result, model.StructOrUnion):
                    if indirect_result.fldtypes is None:
                        raise TypeError("'%s' is used as result type, but is opaque" % (
