...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/python.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 47399 bytes
"""
...
class PythonLexer(RegexLexer):
    ...
    def innerstring_rules(ttype):
        return [
         (
          '%(\\(\\w+\\))?[-#0 +]*([0-9]+|[*])?(\\.([0-9]+|[*]))?[hlL]?[E-GXc-giorsaux%]',
          String.Interpol),
         (
          '\\{((\\w+)((\\.\\w+)|(\\[[^\\]]+\\]))*)?(\\![sra])?(\\:(.?[<>=\\^])?[-+ ]?#?0?(\\d+)?,?(\\.\\d+)?[E-GXb-gnosx%]?)?\\}',
          String.Interpol),
         (
          '[^\\\\\\\'"%{\\n]+', ttype),
         (
    ...
    tokens = {'root':[
     ...
     'keywords':[
      (
       ...
       'try', 'while', 'yield', 'yield from', 'as', 'with'),
         suffix='\\b'),
       Keyword),
      (
       words(('True', 'False', 'None'), suffix='\\b'), Keyword.Constant)], 
     'builtins':[
      (
       ...
       Name.Builtin),
      (
       '(?<!\\.)(self|Ellipsis|NotImplemented|cls)\\b', Name.Builtin.Pseudo),
      (
     ...
     'magicfuncs':[
      (
       words(('__abs__', '__add__', '__aenter__', '__aexit__', '__aiter__', '__and__', '__anext__',
       ...
       '__ge__', '__get__', '__getattr__', '__getattribute__', '__getitem__', '__gt__',
       '__hash__', '__iadd__', '__iand__', '__ifloordiv__', '__ilshift__', '__imatmul__',
       '__imod__', '__imul__', '__index__', '__init__', '__instancecheck__', '__int__',
       ...
       '__new__', '__next__', '__or__', '__pos__', '__pow__', '__prepare__', '__radd__',
       ...
       '__rrshift__', '__rshift__', '__rsub__', '__rtruediv__', '__rxor__', '__set__',
       '__setattr__', '__setitem__', '__str__', '__sub__', '__subclasscheck__', '__truediv__',
       '__xor__'),
         suffix='\\b'),
       Name.Function.Magic)], 
     'magicvars':[
      (
       words(('__annotations__', '__bases__', '__class__', '__closure__', '__code__', '__defaults__',
       '__dict__', '__doc__', '__file__', '__func__', '__globals__', '__kwdefaults__',
       '__module__', '__mro__', '__name__', '__objclass__', '__qualname__', '__self__',
     ...
     'numbers':[
      (
       ...
       Number.Float),
      (
       '\\d(?:_?\\d)*[eE][+-]?\\d(?:_?\\d)*j?', Number.Float),
      (
       '0[oO](?:_?[0-7])+', Number.Oct),
      (
       '0[bB](?:_?[01])+', Number.Bin),
      (
       '0[xX](?:_?[a-fA-F0-9])+', Number.Hex),
      (
       '\\d(?:_?\\d)*', Number.Integer)], 
     'name':[
      (
       '@' + uni_name, Name.Decorator),
      (
       '@', Operator),
      (
       uni_name, Name)], 
     ...
     'fromimport':[
      (
       '(\\s+)(import)\\b', bygroups(Text, Keyword.Namespace), '#pop'),
      (
       '\\.', Name.Namespace),
      (
    ...
    tokens = {'root':[
     ...
     'builtins':[
      (
       ...
       Name.Builtin),
      (
       '(?<!\\.)(self|None|Ellipsis|NotImplemented|False|True|cls)\\b',
       Name.Builtin.Pseudo),
      (
       ...
       'OverflowWarning', 'PendingDeprecationWarning', 'RecursionError', 'ReferenceError',
     ...
     'magicfuncs':[
      (
       words(('__abs__', '__add__', '__and__', '__call__', '__cmp__', '__coerce__', '__complex__',
       '__contains__', '__del__', '__delattr__', '__delete__', '__delitem__', '__delslice__',
       '__div__', '__divmod__', '__enter__', '__eq__', '__exit__', '__float__', '__floordiv__',
       '__ge__', '__get__', '__getattr__', '__getattribute__', '__getitem__', '__getslice__',
       '__gt__', '__hash__', '__hex__', '__iadd__', '__iand__', '__idiv__', '__ifloordiv__',
       '__ilshift__', '__imod__', '__imul__', '__index__', '__init__', '__instancecheck__',
       '__int__', '__invert__', '__iop__', '__ior__', '__ipow__', '__irshift__',
       '__isub__', '__iter__', '__itruediv__', '__ixor__', '__le__', '__len__', '__long__',
       '__lshift__', '__lt__', '__missing__', '__mod__', '__mul__', '__ne__', '__neg__',
       '__new__', '__nonzero__', '__oct__', '__op__', '__or__', '__pos__', '__pow__',
       '__radd__', '__rand__', '__rcmp__', '__rdiv__', '__rdivmod__', '__repr__',
       '__reversed__', '__rfloordiv__', '__rlshift__', '__rmod__', '__rmul__', '__rop__',
       '__ror__', '__rpow__', '__rrshift__', '__rshift__', '__rsub__', '__rtruediv__',
       '__rxor__', '__set__', '__setattr__', '__setitem__', '__setslice__', '__str__',
       '__sub__', '__subclasscheck__', '__truediv__', '__unicode__', '__xor__'),
         suffix='\\b'),
       Name.Function.Magic)], 
     'magicvars':[
      (
       words(('__bases__', '__class__', '__closure__', '__code__', '__defaults__', '__dict__',
       '__doc__', '__file__', '__func__', '__globals__', '__metaclass__', '__module__',
       '__mro__', '__name__', '__self__', '__slots__', '__weakref__'),
         suffix='\\b'),
       Name.Variable.Magic)], 
     'numbers':[
      (
...
class CythonLexer(RegexLexer):
    ...
    tokens = {'root':[
     ...
     'strings':[
      (
       '%(\\([a-zA-Z0-9]+\\))?[-#0 +]*([0-9]+|[*])?(\\.([0-9]+|[*]))?[hlL]?[E-GXc-giorsux%]',
       String.Interpol),
      (
       '[^\\\\\\\'"%\\n]+', String),
      (
...
class DgLexer(RegexLexer):
    ...
    tokens = {'root':[
      ...
      (
       ...
       'snd', 'sorted', 'sum', 'tail', 'take', 'takewhile', 'vars', 'zip'),
         prefix='(?<!\\.)',
         suffix="(?![\\'\\w])"),
       Name.Builtin),
      (
...
class NumPyLexer(PythonLexer):
    ...
    def analyse_text(text):
        return (shebang_matches(text, 'pythonw?(3(\\.\\d)?)?') or 'import ' in text[:1000]) and ('import numpy' in text or 'from numpy import' in text)