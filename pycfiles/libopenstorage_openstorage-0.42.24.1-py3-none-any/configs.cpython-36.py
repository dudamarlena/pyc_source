...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/configs.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 32135 bytes
"""
...
class TerraformLexer(RegexLexer):
    ...
    embedded_keywords = ('ingress', 'egress', 'listener', 'default', 'connection',
                         'alias', 'terraform', 'tags', 'vars', 'config', 'lifecycle',
                         'timeouts')
    tokens = {'root':[
      include('string'),
      include('punctuation'),
     ...
     'basic':[
      ...
      (
       words(('variable', 'resource', 'provider', 'provisioner', 'module', 'backend', 'data',
       'output'),
         prefix='\\b', suffix='\\b'),
       Keyword.Reserved, 'function'),
      (
       words(embedded_keywords, prefix='\\b', suffix='\\b'),
       Keyword.Declaration),
      (
