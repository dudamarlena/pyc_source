...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/extension_dict.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 8226 bytes
...
class _ExtensionDict(object):
    __doc__ = 'Dict-like container for Extension fields on proto instances.\n\n  Note that in all cases we expect extension handles to be\n  FieldDescriptors.\n  '
    ...
    def __getitem__(self, extension_handle):
        ...
        if result is not None:
            ...
            if extension_handle.label == FieldDescriptor.LABEL_REPEATED:
                ...
                assert getattr(extension_handle.message_type, '_concrete_class', None), 'Uninitialized concrete class found for field %r (message type %r)' % (
                 extension_handle.full_name,
