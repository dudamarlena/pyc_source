...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/formatters/img.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 19838 bytes
"""
...
__all__ = [
 ...
 'BmpImageFormatter']
STYLES = {'NORMAL':[
  '', 'Roman', 'Book', 'Normal', 'Regular', 'Medium'], 
 'ITALIC':[
  'Oblique', 'Italic'], 
 'BOLD':[
  'Bold'], 
...
class ImageFormatter(Formatter):
    ...
    def __init__(self, **options):
        ...
        if not pil_available:
            ...
            self.image_format = get_choice_opt(options,
              'image_format', ['png', 'jpeg', 'gif', 'bmp'], (self.default_image_format),
              normcase=True)
    ...
    def _draw_linenumber(self, posno, lineno):
        ...
        """
        self._draw_text((self._get_linenumber_pos(posno)),
    ...
    def _create_drawables(self, tokensource):
        ...
        for ttype, value in tokensource:
            ...
            for i, line in enumerate(lines):
                temp = line.rstrip('\n')
                if temp:
                    self._draw_text((self._get_text_pos(charno, lineno)),
                      temp,
