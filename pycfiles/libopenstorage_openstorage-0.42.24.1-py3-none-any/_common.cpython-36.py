...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/grpcio/grpc/_common.py
# Compiled at: 2020-01-10 16:25:22
# Size of source mod 2**32: 5397 bytes
"""Shared implementation."""
import logging, time, six, grpc
from grpc._cython import cygrpc
_LOGGER = logging.getLogger(__name__)
CYGRPC_CONNECTIVITY_STATE_TO_CHANNEL_CONNECTIVITY = {cygrpc.ConnectivityState.idle: grpc.ChannelConnectivity.IDLE, 
...
def deserialize(serialized_message, deserializer):
    return _transform(serialized_message, deserializer, 'Exception deserializing message!')
