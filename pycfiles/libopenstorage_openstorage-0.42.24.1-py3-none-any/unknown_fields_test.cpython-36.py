...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/unknown_fields_test.py
...
class UnknownFieldsTest(unittest.TestCase):
    ...
    def testSerializeMessageSetWireFormatUnknownExtension(self):
        ...
        self.assertEqual(unknown_fields[0].wire_type, wire_format.WIRETYPE_LENGTH_DELIMITED)
    ...
    def testDiscardUnknownFields(self):
        ...
        msg.map_int32_all_types[1].optional_nested_message.ParseFromString(other_message.SerializeToString())
        msg.map_string_string['1'] = 'test'
        self.assertNotEqual(b'', msg.map_int32_all_types[1].optional_nested_message.SerializeToString())
        msg.DiscardUnknownFields()
        self.assertEqual(b'', msg.map_int32_all_types[1].optional_nested_message.SerializeToString())
...
class UnknownFieldsAccessorsTest(unittest.TestCase):
    ...
    def CheckUnknownField(self, name, unknown_fields, expected_value):
        ...
        for unknown_field in unknown_fields:
            if unknown_field.field_number == field_descriptor.number:
                ...
                if expected_type == 3:
                    self.assertEqual(expected_value[0], unknown_field.data[0].field_number)
    ...
    def testCheckUnknownFieldValue(self):
        ...
        self.CheckUnknownField('optional_nested_enum', unknown_fields, self.all_fields.optional_nested_enum)
        self.InternalCheckUnknownField('optional_nested_enum', self.all_fields.optional_nested_enum)
        self.CheckUnknownField('repeated_nested_enum', unknown_fields, self.all_fields.repeated_nested_enum)
        self.InternalCheckUnknownField('repeated_nested_enum', self.all_fields.repeated_nested_enum)
        self.CheckUnknownField('optional_int32', unknown_fields, self.all_fields.optional_int32)
        self.InternalCheckUnknownField('optional_int32', self.all_fields.optional_int32)
        self.CheckUnknownField('optional_fixed32', unknown_fields, self.all_fields.optional_fixed32)
        self.InternalCheckUnknownField('optional_fixed32', self.all_fields.optional_fixed32)
        self.CheckUnknownField('optional_fixed64', unknown_fields, self.all_fields.optional_fixed64)
        self.InternalCheckUnknownField('optional_fixed64', self.all_fields.optional_fixed64)
        self.CheckUnknownField('optional_string', unknown_fields, self.all_fields.optional_string.encode('utf-8'))
        self.InternalCheckUnknownField('optional_string', self.all_fields.optional_string)
        self.CheckUnknownField('optionalgroup', unknown_fields, (17, 0, 117))
        self.InternalCheckUnknownField('optionalgroup', self.all_fields.optionalgroup)
    ...
    def testSubUnknownFields(self):
        ...
        nested_message.payload.optional_nested_message.ParseFromString(message.SerializeToString())
        unknown_fields = nested_message.payload.optional_nested_message.UnknownFields()
    ...
    def testUnknownField(self):
        ...
        with self.assertRaises(ValueError) as (context):
            unknown_field.data
        self.assertIn('The parent message might be cleared.', str(context.exception))
...
class UnknownEnumValuesTest(unittest.TestCase):
    ...
    def testCheckUnknownFieldValueForEnum(self):
        ...
        self.CheckUnknownField('optional_nested_enum', self.message.optional_nested_enum)
        self.CheckUnknownField('repeated_nested_enum', self.message.repeated_nested_enum)
        self.CheckUnknownField('packed_nested_enum', self.message.packed_nested_enum)
