...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/secretstorage/secretstorage/collection.py
...
def create_collection(connection: DBusConnection, label: str, alias: str='', session: Optional[Session]=None) -> Collection:
    ...
    collection_path, prompt = service.call('CreateCollection', 'a{sv}s', properties, alias)
