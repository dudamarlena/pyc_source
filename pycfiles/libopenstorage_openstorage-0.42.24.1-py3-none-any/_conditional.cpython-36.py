...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cryptography/cryptography/hazmat/bindings/openssl/_conditional.py
...
CONDITIONAL_NAMES = {'Cryptography_HAS_EC2M':cryptography_has_ec2m, 
 ...
 'Cryptography_HAS_EVP_R_MEMORY_LIMIT_EXCEEDED':cryptography_has_evp_r_memory_limit_exceeded, 
