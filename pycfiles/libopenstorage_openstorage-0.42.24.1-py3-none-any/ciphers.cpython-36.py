...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cryptography/cryptography/hazmat/backends/openssl/ciphers.py
...
class _CipherContext(object):
    ...
    def __init__(self, backend, cipher, mode, operation):
        ...
        try:
            ...
            raise UnsupportedAlgorithm('cipher {} in {} mode is not supported by this backend.'.format(cipher.name, mode.name if mode else mode), _Reasons.UNSUPPORTED_CIPHER)
        ...
        if evp_cipher == self._backend._ffi.NULL:
            ...
            msg += 'is not supported by this backend (Your version of OpenSSL may be too old. Current version: {}.)'.format(self._backend.openssl_version_text())
