...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cryptography/cryptography/hazmat/primitives/poly1305.py
...
class Poly1305(object):
    ...
    def __init__(self, key):
        ...
        if not backend.poly1305_supported():
            raise UnsupportedAlgorithm('poly1305 is not supported by this version of OpenSSL.', _Reasons.UNSUPPORTED_MAC)
