...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/grpcio/grpc/_interceptor.py
# Compiled at: 2020-01-10 16:25:22
# Size of source mod 2**32: 19215 bytes
"""Implementation of gRPC Python interceptors."""
import collections, sys, grpc
...
class _UnaryUnaryMultiCallable(grpc.UnaryUnaryMultiCallable):
    ...
    def _with_call(self, request, timeout=None, metadata=None, credentials=None, wait_for_ready=None, compression=None):
        ...
        def continuation(new_details, request):
            ...
            try:
                response, call = self._thunk(new_method).with_call(request,
                  timeout=new_timeout,
        ...
        call = self._interceptor.intercept_unary_unary(continuation, client_call_details, request)
    ...
    def future(self, request, timeout=None, metadata=None, credentials=None, wait_for_ready=None, compression=None):
        ...
        def continuation(new_details, request):
            new_method, new_timeout, new_metadata, new_credentials, new_wait_for_ready, new_compression = _unwrap_client_call_details(new_details, client_call_details)
            return self._thunk(new_method).future(request,
              timeout=new_timeout,
              metadata=new_metadata,
              credentials=new_credentials,
              wait_for_ready=new_wait_for_ready,
        ...
        try:
            return self._interceptor.intercept_unary_unary(continuation, client_call_details, request)
        except Exception as exception:
            return _FailureOutcome(exception, sys.exc_info()[2])
...
class _UnaryStreamMultiCallable(grpc.UnaryStreamMultiCallable):
    ...
    def __call__(self, request, timeout=None, metadata=None, credentials=None, wait_for_ready=None, compression=None):
        ...
        try:
            return self._interceptor.intercept_unary_stream(continuation, client_call_details, request)
        except Exception as exception:
            return _FailureOutcome(exception, sys.exc_info()[2])
...
class _StreamUnaryMultiCallable(grpc.StreamUnaryMultiCallable):
    ...
    def _with_call(self, request_iterator, timeout=None, metadata=None, credentials=None, wait_for_ready=None, compression=None):
        client_call_details = _ClientCallDetails(self._method, timeout, metadata, credentials, wait_for_ready, compression)

        def continuation(new_details, request_iterator):
            new_method, new_timeout, new_metadata, new_credentials, new_wait_for_ready, new_compression = _unwrap_client_call_details(new_details, client_call_details)
            try:
                response, call = self._thunk(new_method).with_call(request_iterator,
                  timeout=new_timeout,
                  metadata=new_metadata,
                  credentials=new_credentials,
                  wait_for_ready=new_wait_for_ready,
    ...
    def future(self, request_iterator, timeout=None, metadata=None, credentials=None, wait_for_ready=None, compression=None):
        ...
        def continuation(new_details, request_iterator):
            new_method, new_timeout, new_metadata, new_credentials, new_wait_for_ready, new_compression = _unwrap_client_call_details(new_details, client_call_details)
            return self._thunk(new_method).future(request_iterator,
              timeout=new_timeout,
              metadata=new_metadata,
              credentials=new_credentials,
              wait_for_ready=new_wait_for_ready,
        ...
        try:
            return self._interceptor.intercept_stream_unary(continuation, client_call_details, request_iterator)
        except Exception as exception:
            return _FailureOutcome(exception, sys.exc_info()[2])
...
class _StreamStreamMultiCallable(grpc.StreamStreamMultiCallable):
    ...
    def __call__(self, request_iterator, timeout=None, metadata=None, credentials=None, wait_for_ready=None, compression=None):
        ...
        try:
            return self._interceptor.intercept_stream_stream(continuation, client_call_details, request_iterator)
        except Exception as exception:
            return _FailureOutcome(exception, sys.exc_info()[2])
...
def intercept_channel(channel, *interceptors):
    for interceptor in reversed(list(interceptors)):
        if not isinstance(interceptor, grpc.UnaryUnaryClientInterceptor):
            if not isinstance(interceptor, grpc.UnaryStreamClientInterceptor):
                if not isinstance(interceptor, grpc.StreamUnaryClientInterceptor):
                    if not isinstance(interceptor, grpc.StreamStreamClientInterceptor):
                        raise TypeError('interceptor must be grpc.UnaryUnaryClientInterceptor or grpc.UnaryStreamClientInterceptor or grpc.StreamUnaryClientInterceptor or grpc.StreamStreamClientInterceptor or ')
