...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/grpcio/grpc/beta/interfaces.py
# Compiled at: 2020-01-10 16:25:22
# Size of source mod 2**32: 5956 bytes
...
class GRPCServicerContext(six.with_metaclass(abc.ABCMeta)):
    __doc__ = 'Exposes gRPC-specific options and behaviors to code servicing RPCs.'
...
class GRPCInvocationContext(six.with_metaclass(abc.ABCMeta)):
    __doc__ = 'Exposes gRPC-specific options and behaviors to code invoking RPCs.'
