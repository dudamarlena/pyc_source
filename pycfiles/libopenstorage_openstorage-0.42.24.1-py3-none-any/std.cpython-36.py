...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/tqdm/tqdm/std.py
# Compiled at: 2020-01-10 16:25:33
# Size of source mod 2**32: 55546 bytes
"""
...
class Bar(object):
    ...
    def __format__(self, format_spec):
        ...
        if bar_length < N_BARS:
            return bar + frac_bar + charset[0] * (N_BARS - bar_length - 1)
        else:
            return bar
