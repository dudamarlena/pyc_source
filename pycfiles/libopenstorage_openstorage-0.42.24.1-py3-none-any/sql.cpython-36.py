...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/sql.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 31782 bytes
"""
    pygments.lexers.sql
    ~~~~~~~~~~~~~~~~~~~
...
class PostgresLexer(PostgresBase, RegexLexer):
    ...
    tokens = {'root':[
      ...
      (
       '(' + '|'.join(s.replace(' ', '\\s+') for s in DATATYPES + PSEUDO_TYPES) + ')\\b',
       Name.Builtin),
      (
