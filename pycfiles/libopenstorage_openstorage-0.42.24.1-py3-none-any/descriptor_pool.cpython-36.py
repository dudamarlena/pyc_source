...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/descriptor_pool.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 45835 bytes
...
def _Deprecated(func):
    ...
    def NewFunc(*args, **kwargs):
        warnings.warn(('Call to deprecated function %s(). Note: Do add unlinked descriptors to descriptor_pool is wrong. Use Add() or AddSerializedFile() instead.' % func.__name__),
...
class DescriptorPool(object):
    __doc__ = 'A collection of protobufs dynamically constructed by descriptor protos.'
    ...
    """
        ...
        try:
            ...
            if not sub_name in message.extensions_by_name:
                if not sub_name in message.fields_by_name:
                    assert sub_name in message.enum_values_by_name
            return message.file
    ...
    """
        if self._descriptor_db:
            if hasattr(self._descriptor_db, 'FindAllExtensionNumbers'):
    ...
    """
        if not self._descriptor_db:
            return
        elif not hasattr(self._descriptor_db, 'FindFileContainingExtension'):
            return
        else:
            full_name = message_descriptor.full_name
    ...
    """
        if file_proto.name not in self._file_descriptors:
            ...
            file_descriptor = descriptor.FileDescriptor(pool=self,
            ...
            for index, extension_proto in enumerate(file_proto.extension):
                extension_desc = self._MakeFieldDescriptor(extension_proto,
                  (file_proto.package), index, file_descriptor, is_extension=True)
    ...
    """
        ...
        desc = descriptor.EnumDescriptor(name=(enum_proto.name), full_name=enum_name,
          filename=file_name,
          file=file_desc,
          values=values,
            ...
            if field_proto.label == descriptor.FieldDescriptor.LABEL_REPEATED:
                ...
                if field_proto.HasField('default_value'):
                    ...
                    if field_proto.type == descriptor.FieldDescriptor.TYPE_DOUBLE or field_proto.type == descriptor.FieldDescriptor.TYPE_FLOAT:
                        ...
                        if field_proto.type == descriptor.FieldDescriptor.TYPE_STRING:
                            field_desc.default_value = field_proto.default_value
                        else:
                            if field_proto.type == descriptor.FieldDescriptor.TYPE_BOOL:
                                field_desc.default_value = field_proto.default_value.lower() == 'true'
                            else:
                                if field_proto.type == descriptor.FieldDescriptor.TYPE_ENUM:
                                    field_desc.default_value = field_desc.enum_type.values_by_name[field_proto.default_value].number
                                else:
                                    if field_proto.type == descriptor.FieldDescriptor.TYPE_BYTES:
    ...
    """
        return descriptor.EnumValueDescriptor(name=(value_proto.name),
          index=index,
    ...
    """
        ...
        desc = descriptor.ServiceDescriptor(name=(service_proto.name), full_name=service_name,
          index=service_index,
          methods=methods,
    ...
    """
        ...
        return descriptor.MethodDescriptor(name=(method_proto.name), full_name=full_name,
          index=index,
    ...
    """
        for desc in descriptors:
            yield (
             _PrefixWithDot(desc.full_name), desc)
