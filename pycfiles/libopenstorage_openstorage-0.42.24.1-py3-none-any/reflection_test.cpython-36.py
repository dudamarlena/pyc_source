...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/reflection_test.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 137393 bytes
"""Unittest for reflection.py, which also indirectly tests the output of the
pure-Python protocol compiler.
"""
import copy, gc, operator, six, struct
try:
...
class ReflectionTest(unittest.TestCase):
    ...
    def testScalarConstructor(self, message_module):
        proto = message_module.TestAllTypes(optional_int32=24,
    ...
    def testRepeatedScalarConstructor(self, message_module):
        proto = message_module.TestAllTypes(repeated_int32=[
         1, 2, 3, 4],
          repeated_double=[
         1.23, 54.321],
          repeated_bool=[
    ...
    def testMixedConstructor(self, message_module):
        proto = message_module.TestAllTypes(optional_int32=24,
         ...
         message_module.TestAllTypes.NestedMessage(bb=(message_module.TestAllTypes.FOO)),
         message_module.TestAllTypes.NestedMessage(bb=(message_module.TestAllTypes.BAR))],
        ...
        self.assertEqual([
         message_module.TestAllTypes.NestedMessage(bb=(message_module.TestAllTypes.FOO)),
         message_module.TestAllTypes.NestedMessage(bb=(message_module.TestAllTypes.BAR))], list(proto.repeated_nested_message))
        self.assertEqual([
         message_module.ForeignMessage(c=(-43)),
         message_module.ForeignMessage(c=45324),
         message_module.ForeignMessage(c=12)], list(proto.repeated_foreign_message))
        self.assertFalse(proto.HasField('optional_nested_message'))

    def testConstructorTypeError(self, message_module):
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), optional_int32='foo')
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), optional_string=1234)
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), optional_nested_message=1234)
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), repeated_int32=1234)
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), repeated_int32=['foo'])
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), repeated_string=1234)
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), repeated_string=[1234])
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), repeated_nested_message=1234)
        self.assertRaises(TypeError,
          (message_module.TestAllTypes), repeated_nested_message=[1234])
    ...
    def testConstructorInvalidatesCachedByteSize(self, message_module):
        ...
        message = message_module.TestAllTypes(optional_nested_message=(message_module.TestAllTypes.NestedMessage()))
        self.assertEqual(3, message.ByteSize())
        message = message_module.TestAllTypes(repeated_int32=[12])
        if message_module is unittest_pb2:
            self.assertEqual(3, message.ByteSize())
        message = message_module.TestAllTypes(repeated_nested_message=[
    ...
    def testSingularListFields(self, message_module):
        ...
        self.assertEqual([
         ...
         (
          proto.DESCRIPTOR.fields_by_name['optional_string'], 'foo')], proto.ListFields())
        ...
        self.assertEqual([
         ...
         (
          ...
          nested_message)], proto.ListFields())
    ...
    def testRepeatedListFields(self, message_module):
        ...
        self.assertEqual([
         ...
         (
          ...
          [
           'foo', 'bar', 'baz', '0', '1'])], proto.ListFields())
    ...
    """
        ...
        TestGetAndDeserialize('optional_int32', 1073741824, int)
        TestGetAndDeserialize('optional_uint32', 1073741824, int)
        integer_64 = long
        if struct.calcsize('L') == 4:
            TestGetAndDeserialize('optional_uint32', 2147483648, integer_64)
        else:
            TestGetAndDeserialize('optional_uint32', 2147483648, int)
        TestGetAndDeserialize('optional_int64', 1073741824, integer_64)
        TestGetAndDeserialize('optional_int64', 1152921504606846976, integer_64)
        TestGetAndDeserialize('optional_uint64', 1073741824, integer_64)
        TestGetAndDeserialize('optional_uint64', 1152921504606846976, integer_64)
    ...
    """
        ...
        def TestMinAndMaxIntegers(field_name, expected_min, expected_max):
            ...
            self.assertRaises((ValueError, TypeError), setattr, pb, field_name, expected_min - 1)
            self.assertRaises((ValueError, TypeError), setattr, pb, field_name, expected_max + 1)

        TestMinAndMaxIntegers('optional_int32', -2147483648, 2147483647)
        TestMinAndMaxIntegers('optional_uint32', 0, 4294967295)
        TestMinAndMaxIntegers('optional_int64', -9223372036854775808, 9223372036854775807)
        TestMinAndMaxIntegers('optional_uint64', 0, 18446744073709551615)
        pb = message_module.TestAllTypes()
        with self.assertRaises((ValueError, TypeError)):
            pb.optional_uint64 = integer_fn(-9223372036854775808)
        pb = message_module.TestAllTypes()
    ...
    def testNonStandardSingleScalarBoundsChecking(self, message_module):
        self.assetIntegerBoundsChecking(test_util.NonStandardInteger, message_module)
    ...
    def testRepeatedScalarTypeSafety(self, message_module):
        ...
        self.assertRaises(TypeError, proto.repeated_int32.__setitem__, 'index', 23)
    ...
    def testEnum_Name(self, message_module):
        self.assertEqual('FOREIGN_FOO', message_module.ForeignEnum.Name(message_module.FOREIGN_FOO))
        self.assertEqual('FOREIGN_BAR', message_module.ForeignEnum.Name(message_module.FOREIGN_BAR))
        self.assertEqual('FOREIGN_BAZ', message_module.ForeignEnum.Name(message_module.FOREIGN_BAZ))
        self.assertRaises(ValueError, message_module.ForeignEnum.Name, 11312)
        proto = message_module.TestAllTypes()
        self.assertEqual('FOO', proto.NestedEnum.Name(proto.FOO))
        self.assertEqual('FOO', message_module.TestAllTypes.NestedEnum.Name(proto.FOO))
        self.assertEqual('BAR', proto.NestedEnum.Name(proto.BAR))
        self.assertEqual('BAR', message_module.TestAllTypes.NestedEnum.Name(proto.BAR))
        self.assertEqual('BAZ', proto.NestedEnum.Name(proto.BAZ))
        self.assertEqual('BAZ', message_module.TestAllTypes.NestedEnum.Name(proto.BAZ))
        self.assertRaises(ValueError, proto.NestedEnum.Name, 11312)
        self.assertRaises(ValueError, message_module.TestAllTypes.NestedEnum.Name, 11312)
        self.assertRaises(TypeError, message_module.TestAllTypes.NestedEnum.Name, 11312.0)
        self.assertRaises(TypeError, message_module.TestAllTypes.NestedEnum.Name, None)
        self.assertEqual('FOO', message_module.TestAllTypes.NestedEnum.Name(True))

    def testEnum_Value(self, message_module):
        self.assertEqual(message_module.FOREIGN_FOO, message_module.ForeignEnum.Value('FOREIGN_FOO'))
        self.assertEqual(message_module.FOREIGN_FOO, message_module.ForeignEnum.FOREIGN_FOO)
        self.assertEqual(message_module.FOREIGN_BAR, message_module.ForeignEnum.Value('FOREIGN_BAR'))
        self.assertEqual(message_module.FOREIGN_BAR, message_module.ForeignEnum.FOREIGN_BAR)
        self.assertEqual(message_module.FOREIGN_BAZ, message_module.ForeignEnum.Value('FOREIGN_BAZ'))
        self.assertEqual(message_module.FOREIGN_BAZ, message_module.ForeignEnum.FOREIGN_BAZ)
        self.assertRaises(ValueError, message_module.ForeignEnum.Value, 'FO')
        with self.assertRaises(AttributeError):
            message_module.ForeignEnum.FO
        proto = message_module.TestAllTypes()
        self.assertEqual(proto.FOO, proto.NestedEnum.Value('FOO'))
        self.assertEqual(proto.FOO, proto.NestedEnum.FOO)
        self.assertEqual(proto.FOO, message_module.TestAllTypes.NestedEnum.Value('FOO'))
        self.assertEqual(proto.FOO, message_module.TestAllTypes.NestedEnum.FOO)
        self.assertEqual(proto.BAR, proto.NestedEnum.Value('BAR'))
        self.assertEqual(proto.BAR, proto.NestedEnum.BAR)
        self.assertEqual(proto.BAR, message_module.TestAllTypes.NestedEnum.Value('BAR'))
        self.assertEqual(proto.BAR, message_module.TestAllTypes.NestedEnum.BAR)
        self.assertEqual(proto.BAZ, proto.NestedEnum.Value('BAZ'))
        self.assertEqual(proto.BAZ, proto.NestedEnum.BAZ)
        self.assertEqual(proto.BAZ, message_module.TestAllTypes.NestedEnum.Value('BAZ'))
        self.assertEqual(proto.BAZ, message_module.TestAllTypes.NestedEnum.BAZ)
        self.assertRaises(ValueError, proto.NestedEnum.Value, 'Foo')
        with self.assertRaises(AttributeError):
            proto.NestedEnum.Value.Foo
        self.assertRaises(ValueError, message_module.TestAllTypes.NestedEnum.Value, 'Foo')
        with self.assertRaises(AttributeError):
    ...
    def testEnum_KeysAndValues(self, message_module):
        if message_module == unittest_pb2:
            ...
            keys = [
             'FOREIGN_ZERO', 'FOREIGN_FOO', 'FOREIGN_BAR', 'FOREIGN_BAZ']
            values = [0, 4, 5, 6]
            items = [('FOREIGN_ZERO', 0), ('FOREIGN_FOO', 4),
             ('FOREIGN_BAR', 5), ('FOREIGN_BAZ', 6)]
        self.assertEqual(keys, list(message_module.ForeignEnum.keys()))
        self.assertEqual(values, list(message_module.ForeignEnum.values()))
        self.assertEqual(items, list(message_module.ForeignEnum.items()))
        proto = message_module.TestAllTypes()
        if message_module == unittest_pb2:
            keys = [
             'FOO', 'BAR', 'BAZ', 'NEG']
        ...
        self.assertEqual(items, list(proto.NestedEnum.items()))
    ...
    def testStringUTF8Encoding(self, message_module):
        proto = message_module.TestAllTypes()
        self.assertRaises(TypeError, setattr, proto, 'optional_bytes', 'unicode object')
    ...
    def testEmptyNestedMessage(self, message_module):
        proto = message_module.TestAllTypes()
        proto.optional_nested_message.MergeFrom(message_module.TestAllTypes.NestedMessage())
        self.assertTrue(proto.HasField('optional_nested_message'))
        proto = message_module.TestAllTypes()
        proto.optional_nested_message.CopyFrom(message_module.TestAllTypes.NestedMessage())
        self.assertTrue(proto.HasField('optional_nested_message'))
        proto = message_module.TestAllTypes()
...
class Proto2ReflectionTest(unittest.TestCase):
    ...
    def testRepeatedCompositeConstructor(self):
        proto = unittest_pb2.TestAllTypes(repeated_nested_message=[
         unittest_pb2.TestAllTypes.NestedMessage(bb=(unittest_pb2.TestAllTypes.FOO)),
         unittest_pb2.TestAllTypes.NestedMessage(bb=(unittest_pb2.TestAllTypes.BAR))],
          repeated_foreign_message=[
        ...
        self.assertEqual([
         unittest_pb2.TestAllTypes.NestedMessage(bb=(unittest_pb2.TestAllTypes.FOO)),
         unittest_pb2.TestAllTypes.NestedMessage(bb=(unittest_pb2.TestAllTypes.BAR))], list(proto.repeated_nested_message))
        self.assertEqual([
         unittest_pb2.ForeignMessage(c=(-43)),
         unittest_pb2.ForeignMessage(c=45324),
         unittest_pb2.ForeignMessage(c=12)], list(proto.repeated_foreign_message))
        self.assertEqual([
         unittest_pb2.TestAllTypes.RepeatedGroup(),
         unittest_pb2.TestAllTypes.RepeatedGroup(a=1),
         unittest_pb2.TestAllTypes.RepeatedGroup(a=2)], list(proto.repeatedgroup))
    ...
    def testSingularListExtensions(self):
        ...
        self.assertEqual([
         ...
         (
          unittest_pb2.optional_string_extension, 'foo')], proto.ListFields())
    ...
    def testRepeatedListExtensions(self):
        ...
        self.assertEqual([
         ...
         (
          unittest_pb2.repeated_string_extension, ['foo', 'bar', 'baz'])], proto.ListFields())
        ...
        self.assertEqual([
         (
          unittest_pb2.optional_int32_extension, 21),
         (
          unittest_pb2.repeated_fixed32_extension, [1])], proto.ListFields())
    ...
    def testListFieldsAndExtensions(self):
        ...
        self.assertEqual([
         ...
         (
          proto.DESCRIPTOR.fields_by_name['my_float'], 1.0)], proto.ListFields())
    ...
    def testRepeatedComposites(self):
        ...
        self.assertRaises(TypeError, proto.repeated_nested_message.extend, n1)
        self.assertRaises(TypeError, proto.repeated_nested_message.extend, [0])
        wrong_message_type = unittest_pb2.TestAllTypes()
        self.assertRaises(TypeError, proto.repeated_nested_message.extend, [
         wrong_message_type])
    ...
    def testHandWrittenReflection(self):
        ...
        foo_field_descriptor = FieldDescriptor(name='foo_field',
        ...
        mydescriptor = descriptor.Descriptor(name='MyProto',
          full_name='MyProto',
          filename='ignored',
          containing_type=None,
          nested_types=[],
    ...
    def testExtensionIter(self):
        ...
        expected = (
         extension_int32, extension_msg, extension_repeated)
        count = 0
    ...
    def testExtensionContainsError(self):
        ...
        field = more_extensions_pb2.ExtendedMessage.DESCRIPTOR.fields_by_name['optional_int32']
    ...
    def testFileDescriptorErrors(self):
        ...
        m1.name = 'msg1'
        descriptor.FileDescriptor(file_name,
          package_name,
        ...
        with self.assertRaises(TypeError) as (cm):
            descriptor.FileDescriptor(another_file_name,
              package_name,
              serialized_pb=(file_descriptor_proto.SerializeToString()))
...
class FullProtosEqualityTest(unittest.TestCase):
    __doc__ = 'Equality tests using completely-full protos as a starting point.'
...
class ByteSizeTest(unittest.TestCase):
    ...
    def testComposites(self):
        self.proto.optional_nested_message.bb = 16384
        self.assertEqual(7, self.Size())

    def testGroups(self):
        self.proto.optionalgroup.a = 2097152
        self.assertEqual(10, self.Size())
    ...
    def testRepeatedCompositesDelete(self):
        ...
        self.assertEqual(8, self.Size())
        repeated_nested_message = copy.deepcopy(self.proto.repeated_nested_message)
    ...
    def testExtensions(self):
        ...
        field = unittest_pb2.TestAllTypes.DESCRIPTOR.fields_by_name['optional_int32']
...
class SerializationTest(unittest.TestCase):
    ...
    def testSerializeNegativeValues(self):
        ...
        first_proto.optional_int64 = -2199023255552
        first_proto.optional_sint32 = -3
        first_proto.optional_sint64 = -4398046511104
        first_proto.optional_sfixed32 = -5
        first_proto.optional_sfixed64 = -6597069766656
    ...
    def testPackedFieldsWireFormat(self):
        ...
        self.assertEqual(5, d.ReadInt32())
        self.assertEqual(1, d.ReadInt32())
        ...
        self.assertEqual(16, d.ReadInt32())
    ...
    def testFieldProperties(self):
        ...
        self.assertIs(cls.optional_int32.DESCRIPTOR, cls.DESCRIPTOR.fields_by_name['optional_int32'])
        self.assertEqual(cls.OPTIONAL_INT32_FIELD_NUMBER, cls.optional_int32.DESCRIPTOR.number)
        self.assertIs(cls.optional_nested_message.DESCRIPTOR, cls.DESCRIPTOR.fields_by_name['optional_nested_message'])
        self.assertEqual(cls.OPTIONAL_NESTED_MESSAGE_FIELD_NUMBER, cls.optional_nested_message.DESCRIPTOR.number)
        self.assertIs(cls.repeated_int32.DESCRIPTOR, cls.DESCRIPTOR.fields_by_name['repeated_int32'])
        self.assertEqual(cls.REPEATED_INT32_FIELD_NUMBER, cls.repeated_int32.DESCRIPTOR.number)
    ...
    def testInitKwargs(self):
        proto = unittest_pb2.TestAllTypes(optional_int32=1,
          optional_string='foo',
          optional_bool=True,
...
class ClassAPITest(unittest.TestCase):
    ...
    def testMakeClassWithNestedDescriptor(self):
        leaf_desc = descriptor.Descriptor('leaf', 'package.parent.child.leaf', '', containing_type=None,
          fields=[],
          nested_types=[],
          enum_types=[],
          extensions=[])
        child_desc = descriptor.Descriptor('child', 'package.parent.child', '', containing_type=None,
          fields=[],
          nested_types=[
         leaf_desc],
          enum_types=[],
        ...
        sibling_desc = descriptor.Descriptor('sibling', 'package.parent.sibling', '',
          containing_type=None, fields=[], nested_types=[], enum_types=[], extensions=[])
        parent_desc = descriptor.Descriptor('parent', 'package.parent', '', containing_type=None,
          fields=[],
          nested_types=[
         child_desc, sibling_desc],
          enum_types=[],
          extensions=[])
