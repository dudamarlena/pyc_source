...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/grpcio/grpc/beta/_server_adaptations.py
# Compiled at: 2020-01-10 16:25:22
# Size of source mod 2**32: 14641 bytes
"""Translates gRPC's server-side API into gRPC's server-side Beta API."""
import collections, threading, grpc
...
class _SimpleMethodHandler(collections.namedtuple('_MethodHandler', ('request_streaming', 'response_streaming',
...
def server(service_implementations, multi_method_implementation, request_deserializers, response_serializers, thread_pool, thread_pool_size):
    ...
    if thread_pool is None:
        effective_thread_pool = logging_pool.pool(_DEFAULT_POOL_SIZE if thread_pool_size is None else thread_pool_size)
    else:
