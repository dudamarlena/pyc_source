...
# [GCC 8.4.0]
# Embedded file name: /home/lpabon/git/golang/porx/src/github.com/libopenstorage/openstorage-sdk-clients/sdk/python/build/lib/python3.6/site-packages/pycparser/c_parser.py
# Compiled at: 2018-08-31 09:00:24
# Size of source mod 2**32: 69222 bytes
import re
    ...
    def _build_declarations(self, spec, decls, typedef_namespace=False):
        ...
        if decls[0].get('bitsize') is not None:
            ...
            if decls[0]['decl'] is None:
                ...
                decls_0_tail = isinstance(decls[0]['decl'], (
                 c_ast.Struct, c_ast.Union, c_ast.IdentifierType)) or decls[0]['decl']
