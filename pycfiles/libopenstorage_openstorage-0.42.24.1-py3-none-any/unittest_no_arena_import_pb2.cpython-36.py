...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/unittest_no_arena_import_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='google/protobuf/unittest_no_arena_import.proto',
...
_IMPORTNOARENANESTEDMESSAGE = _descriptor.Descriptor(name='ImportNoArenaNestedMessage',
 ...
 _descriptor.FieldDescriptor(name='d',
   full_name='proto2_arena_unittest.ImportNoArenaNestedMessage.d',
   index=0,
   number=1,
   type=5,
   cpp_type=1,
...
ImportNoArenaNestedMessage = _reflection.GeneratedProtocolMessageType('ImportNoArenaNestedMessage', (_message.Message,), {'DESCRIPTOR':_IMPORTNOARENANESTEDMESSAGE, 
