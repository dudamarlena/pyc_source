...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cryptography/cryptography/hazmat/primitives/kdf/concatkdf.py
...
def _common_args_checks(algorithm, length, otherinfo):
    max_length = algorithm.digest_size * 4294967295
    if length > max_length:
        raise ValueError('Can not derive keys larger than {} bits.'.format(max_length))
