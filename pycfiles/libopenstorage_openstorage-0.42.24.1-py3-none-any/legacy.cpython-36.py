...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/pip/pip/_internal/distributions/source/legacy.py
...
class SourceDistribution(AbstractDistribution):
    ...
    def _setup_isolation(self, finder):
        ...
        def _raise_conflicts(conflicting_with, conflicting_reqs):
            ...
            error_message = format_string.format(requirement=(self.req),
              conflicting_with=conflicting_with,
              description=(', '.join('%s is incompatible with %s' % (installed, wanted) for installed, wanted in sorted(conflicting))))
