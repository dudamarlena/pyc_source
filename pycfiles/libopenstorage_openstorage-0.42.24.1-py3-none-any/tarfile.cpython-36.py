...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/pip/pip/_vendor/distlib/_backport/tarfile.py
# Compiled at: 2020-01-10 16:25:21
# Size of source mod 2**32: 92628 bytes
...
import sys, os, stat, errno, time, struct, copy, re
try:
    import grp, pwd
except ImportError:
    grp = pwd = None
...
class _BZ2Proxy(object):
    __doc__ = 'Small proxy class that enables external file object\n       support for "r:bz2" and "w:bz2" modes. This is actually\n       a workaround for a limitation in bz2 module\'s BZ2File\n       class which (unlike gzip.GzipFile) has no support for\n       a file object argument.\n    '
    blocksize = 16384
