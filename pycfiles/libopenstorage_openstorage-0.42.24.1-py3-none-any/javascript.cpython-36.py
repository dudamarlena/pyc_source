...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/javascript.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 60240 bytes
"""
...
class EarlGreyLexer(RegexLexer):
    ...
    tokens = {'root':[
     ...
     'numbers':[
      ...
      (
       '([3-79]|[12][0-9]|3[0-6])r[a-zA-Z\\d]+(\\.[a-zA-Z\\d]+)?',
       Number.Radix),
      (
       '\\d+', Number.Integer)]}
...
class JuttleLexer(RegexLexer):
    ...
    tokens = {'commentsandwhitespace':[
     ...
     'root':[
      ...
      (
       '(var|const|function|reducer|sub|input)\\b', Keyword.Declaration,
       'slashstartsregex'),
      (
      ...
      (
       '(Array|Date|Juttle|Math|Number|Object|RegExp|String)\\b',
       Name.Builtin),
      (
       JS_IDENT, Name.Other),
      (
