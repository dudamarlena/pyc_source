...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/freefem.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 27086 bytes
"""
...
class FreeFemLexer(CppLexer):
    ...
    operators = {
     '+', '-', '*', '.*', '/', './', '%', '^', '^-1', ':', "'"}
    types = {
     'bool', 'border', 'complex', 'dmatrix', 'fespace', 'func', 'gslspline',
    ...
    fespaces = {
     'BDM1', 'BDM1Ortho', 'Edge03d', 'Edge13d', 'Edge23d', 'FEQF', 'HCT',
     ...
     'RT2', 'RT2Ortho'}
    preprocessor = {
     'ENDIFMACRO', 'include', 'IFMACRO', 'load'}
    keywords = {
     'adj',
     'append',
     'area',
