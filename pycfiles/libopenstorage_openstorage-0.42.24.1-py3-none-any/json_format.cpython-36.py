...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/json_format.py
# Compiled at: 2020-01-10 16:25:26
# Size of source mod 2**32: 31474 bytes
...
class Error(Exception):
    __doc__ = 'Top-level module error for json_format.'


class SerializeToJsonError(Error):
    __doc__ = 'Thrown if serialization to JSON fails.'


class ParseError(Error):
    __doc__ = 'Thrown in case of parsing error.'
...
class _Printer(object):
    __doc__ = 'JSON format printer for protocol message.'
        ...
        try:
            ...
            if self.including_default_value_fields:
                ...
                for field in message_descriptor.fields:
                    if not (field.label != descriptor.FieldDescriptor.LABEL_REPEATED and field.cpp_type == descriptor.FieldDescriptor.CPPTYPE_MESSAGE):
...
class _Parser(object):
    __doc__ = 'JSON format parser for protocol message.'
    ...
    """
        ...
        for name in js:
            try:
                ...
                if not field:
                    if _VALID_EXTENSION_NAME.match(name):
                ...
                if value is None:
                    if field.cpp_type == descriptor.FieldDescriptor.CPPTYPE_MESSAGE:
                        if field.message_type.full_name == 'google.protobuf.Value':
                    ...
                    if field.label == descriptor.FieldDescriptor.LABEL_REPEATED:
                        ...
                        if field.cpp_type == descriptor.FieldDescriptor.CPPTYPE_MESSAGE:
                            for item in value:
                                ...
                                if item is None:
                                    if sub_message.DESCRIPTOR.full_name != 'google.protobuf.Value':
                ...
                if value is None:
                    ...
                    if isinstance(value, bool):
                        ...
                        if isinstance(value, six.string_types):
                            ...
                            if isinstance(value, _INT_OR_FLOAT):
...
_WKTJSONMETHODS = {'google.protobuf.Any':[
