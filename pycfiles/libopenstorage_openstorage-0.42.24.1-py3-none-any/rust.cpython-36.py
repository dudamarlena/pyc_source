...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/rust.py
...
class RustLexer(RegexLexer):
    ...
    tokens = {'root':[
     ...
     'base':[
      ...
      (
       words(('as', 'async', 'await', 'box', 'const', 'crate', 'else', 'extern', 'for', 'if',
       'impl', 'in', 'loop', 'match', 'move', 'mut', 'pub', 'ref', 'return', 'static',
       'super', 'trait', 'try', 'unsafe', 'use', 'where', 'while'),
         suffix='\\b'),
       Keyword),
      (
