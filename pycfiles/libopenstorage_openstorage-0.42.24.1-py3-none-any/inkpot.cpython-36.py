...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/styles/inkpot.py
...
from pygments.token import Text, Other, Keyword, Name, Comment, String, Error, Number, Operator, Generic, Whitespace, Punctuation
