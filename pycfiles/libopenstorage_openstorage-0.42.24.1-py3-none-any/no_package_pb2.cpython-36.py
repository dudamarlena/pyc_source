...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/protobuf/google/protobuf/internal/no_package_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='google/protobuf/internal/no_package.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=b'\n)google/protobuf/internal/no_package.proto";\n\x10NoPackageMessage\x12\'\n\x0fno_package_enum\x18\x01 \x01(\x0e2\x0e.NoPackageEnum*?\n\rNoPackageEnum\x12\x16\n\x12NO_PACKAGE_VALUE_0\x10\x00\x12\x16\n\x12NO_PACKAGE_VALUE_1\x10\x01')
_NOPACKAGEENUM = _descriptor.EnumDescriptor(name='NoPackageEnum',
  full_name='NoPackageEnum',
  filename=None,
  file=DESCRIPTOR,
  values=[
 _descriptor.EnumValueDescriptor(name='NO_PACKAGE_VALUE_0',
   index=0,
   number=0,
   serialized_options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='NO_PACKAGE_VALUE_1',
   index=1,
   number=1,
   serialized_options=None,
   type=None)],
...
_NOPACKAGEMESSAGE = _descriptor.Descriptor(name='NoPackageMessage',
  full_name='NoPackageMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='no_package_enum',
...
NoPackageMessage = _reflection.GeneratedProtocolMessageType('NoPackageMessage', (_message.Message,), {'DESCRIPTOR':_NOPACKAGEMESSAGE, 
