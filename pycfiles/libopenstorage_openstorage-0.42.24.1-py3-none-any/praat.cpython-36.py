...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/Pygments/pygments/lexers/praat.py
...
class PraatLexer(RegexLexer):
    ...
    functions_numeric = ('abs', 'appendFile', 'appendFileLine', 'appendInfo', 'appendInfoLine',
                         ...
                         'incompleteGammaP', 'index', 'index_regex', 'integer', 'invBinomialP',
                         ...
                         'selectObject', 'selected', 'semitonesToHertz', 'sentence',
                         'sentencetext', 'sigmoid', 'sin', 'sinc', 'sincpi', 'sinh',
                         'soundPressureToPhon', 'sqrt', 'startsWith', 'studentP',
                         'studentQ', 'tan', 'tanh', 'text', 'variableExists', 'word',
                         'writeFile', 'writeFileLine', 'writeInfo', 'writeInfoLine')
    ...
    objects = ('Activation', 'AffineTransform', 'AmplitudeTier', 'Art', 'Artword',
               ...
               'Network', 'Object', 'OTGrammar', 'OTHistory', 'OTMulti', 'PCA', 'PairDistribution',
    ...
    object_attributes = ('ncol', 'nrow', 'xmin', 'ymin', 'xmax', 'ymax', 'nx', 'ny',
                         'dx', 'dy')
    tokens = {'root':[
      (
     ...
     'object_reference':[
      include('string_interpolated'),
      (
       '([a-z][a-zA-Z0-9_]*|\\d+)', Name.Builtin),
      (
       words(object_attributes, prefix='\\.'), Name.Builtin, '#pop'),
      (
       '\\$', Name.Builtin),
      (
       '\\[', Text, '#pop')], 
     'variable_name':[
      ...
      (
       words(variables_numeric, suffix='(?=[^a-zA-Z0-9\\._"\\\'\\$#\\[:\\(]|\\s|^|$)'),
