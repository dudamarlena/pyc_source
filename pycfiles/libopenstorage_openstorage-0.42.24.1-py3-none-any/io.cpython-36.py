...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/docutils/docutils/io.py
# Compiled at: 2020-01-10 16:25:35
# Size of source mod 2**32: 17155 bytes
"""
...
class Output(TransformSpec):
    ...
    def encode(self, data):
        if self.encoding:
            assert self.encoding.lower() == 'unicode' and isinstance(data, str), 'the encoding given is "unicode" but the output is not a Unicode string'
            return data
        else:
...
class FileInput(Input):
    ...
    def __init__(self, source=None, source_path=None, encoding=None, error_handler='strict', autoclose=True, mode='r' if sys.version_info >= (3, 4) else 'rU', **kwargs):
        """
        :Parameters:
        ...
        if source is None:
            ...
            if sys.version_info >= (3, 0) and check_encoding(self.source, self.encoding) is False:
