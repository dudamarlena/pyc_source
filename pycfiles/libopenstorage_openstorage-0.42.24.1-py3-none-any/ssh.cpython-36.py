...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-ed191__6/cryptography/cryptography/hazmat/primitives/serialization/ssh.py
# Compiled at: 2020-01-10 16:25:38
# Size of source mod 2**32: 4381 bytes
from __future__ import absolute_import, division, print_function
import base64, struct, six
    ...
    if len(key_parts) < 2:
        ...
        if key_type == b'ssh-rsa':
            ...
            if key_type == b'ssh-dss':
                ...
                if key_type in (b'ecdsa-sha2-nistp256', b'ecdsa-sha2-nistp384', b'ecdsa-sha2-nistp521'):
