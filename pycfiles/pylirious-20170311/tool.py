...
# [GCC 8.4.0]
# Embedded file name: d:\shared\tim_working\development\github\pylirious\pylirious\mm-api\python\mm\tool.py
...
def get_toolparam(remote, param_name):
    ...
    if bFound:
        if result_val.type == 0:
            ...
            if result_val.type == 1:
                return result_val.i
            if result_val.type == 2:
                return result_val.b
            if result_val.type == 3:
                return (result_val.x, result_val.y, result_val.z)
            if result_val.type == 4:
                return result_val.m
            return ()
