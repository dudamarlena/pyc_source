...
# [GCC 8.4.0]
# Embedded file name: d:\shared\tim_working\development\github\pylirious\pylirious\mm-api\python\mm\frame.py
...
class mmFrame(object):
    ...
    def set_frame3f(self, f):
        ...
        self.origin = (
         f.origin_x, f.origin_y, f.origin_z)
    ...
    def get_matrix(self):
        ...
        return (
         self.x[0], self.x[1], self.x[2], self.y[0], self.y[1], self.y[2], self.z[0], self.z[1], self.z[2])