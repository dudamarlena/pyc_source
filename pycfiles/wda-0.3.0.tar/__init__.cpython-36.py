...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/9x/c5c95rd13qxgzv4yqjq0_q_c0000gn/T/pip-install-1pxovzpo/facebook-wda/wda/__init__.py
# Compiled at: 2018-08-06 22:55:10
# Size of source mod 2**32: 28799 bytes
from __future__ import print_function
from __future__ import unicode_literals
import base64, copy, functools, json, os, re, time
...
class Rect(object):
    ...
    def __str__(self):
        return 'Rect(x={x}, y={y}, width={w}, height={h})'.format(x=(self.x),
          y=(self.y),
          w=(self.width),
          h=(self.height))
...
class Client(object):
    ...
    def session(self, bundle_id=None, arguments=None, environment=None):
        ...
        if bundle_id is None:
            ...
            capabilities = {'bundleId':bundle_id,  'arguments':arguments, 
            ...
            data = json.dumps({'desiredCapabilities': capabilities})
...
class Selector(object):
    ...
    def __init__(self, httpclient, session, predicate=None, id=None, className=None, type=None, name=None, nameContains=None, nameMatches=None, text=None, textContains=None, textMatches=None, value=None, valueContains=None, label=None, labelContains=None, visible=None, enabled=None, classChain=None, xpath=None, parent_class_chains=[], timeout=10.0, index=0):
        ...
        if self.class_name:
            if not self.class_name.startswith('XCUIElementType'):
    ...
    def _fix_xcui_type(self, s):
        if s is None:
            ...
            return re.sub('/(' + re_element + ')', '/XCUIElementType\\g<1>', s)
    ...
    def get(self, timeout=None, raise_error=True):
        ...
        if self.session.alert.exists:
            if self.http.alert_callback:
