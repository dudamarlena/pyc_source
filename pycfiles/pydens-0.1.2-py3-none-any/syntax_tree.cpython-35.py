...
# [GCC 8.4.0]
# Embedded file name: /notebooks/pydens/build/lib/pydens/syntax_tree.py
...
LABELS_MAPPING = {'__sub__': '-', '__rsub__': '-', 
 '__mul__': '*', '__rmul__': '*', 
 '__div__': '/', '__rdiv__': '/', 
