...
# [GCC 8.4.0]
# Embedded file name: /home/christian/workspace_py/jankflix-python/jankflixmodules/cli/gui.py
# Compiled at: 2013-01-20 18:47:29
...
class JankflixForm(QtGui.QWidget):
    ...
    def updateSearchResults(self, runQueryResult):
        ...
        if len(data) == 1:
            ...
            self.ui.myResultsListView.selectionModel().setCurrentIndex(index, QtGui.QItemSelectionModel.SelectCurrent)
            print 'asdf'
            self.handleChoseSeason()
...
class WorkThread(QtCore.QThread):
    ...
    def downloadFile(self, url, path, block_size=8192):
        ...
        while True:
            ...
            self.emit(self.statusSignal, status)
            self.emit(self.progressSignal, file_size_dl * 100.0 / file_size)
