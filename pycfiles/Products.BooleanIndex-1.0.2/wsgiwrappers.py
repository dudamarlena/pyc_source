...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/wsgiwrappers.py
# Compiled at: 2012-02-27 07:41:58
__doc__ = 'WSGI Wrappers for a Request and Response\n\nThe WSGIRequest and WSGIResponse objects are light wrappers to make it easier\nto deal with an incoming request and sending a response.\n'
import re, warnings
