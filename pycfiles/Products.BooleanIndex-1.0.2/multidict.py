...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/util/multidict.py
...
class UnicodeMultiDict(DictMixin):
    ...
    def popitem(self):
        ...
        return (
         self._decode_key(k), self._decode_value(v))
