...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/PasteDeploy-1.5.0-py2.6.egg/paste/deploy/config.py
# Compiled at: 2012-02-27 07:41:55
__doc__ = 'Paste Configuration Middleware and Objects'
import threading, re
wsgilib = None
local = None
__all__ = [
 'DispatchingConfig', 'CONFIG', 'ConfigMiddleware', 'PrefixMiddleware']
...
class PrefixMiddleware(object):
    ...
    def __init__(self, app, global_conf=None, prefix='/', translate_forwarded_server=True, force_port=None, scheme=None):
        self.app = app
    ...
    def __call__(self, environ, start_response):
        ...
        url = re.sub(self.regprefix, '\\1', url)
        if not url:
            url = '/'
...
# global local ## Warning: Unused global