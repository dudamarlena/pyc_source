...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/session.py
...
import time, random, os, datetime, threading, tempfile
try:
    import cPickle
except ImportError:
