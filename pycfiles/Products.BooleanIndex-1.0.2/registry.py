    ...
    def _pop_object(self, obj=None):
        ...
        try:
            ...
            if obj and popped is not obj:
                raise AssertionError('The object popped (%s) is not the same as the object expected (%s)' % (
                 popped, obj))
        except AttributeError:
