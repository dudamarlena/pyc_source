...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/util/UserDict24.py
...
class UserDict:
    ...
    def update(self, dict):
        if isinstance(dict, UserDict):
            ...
            if isinstance(dict, type(self.data)):
