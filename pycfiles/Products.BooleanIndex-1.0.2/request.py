...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/PasteScript-1.7.5-py2.6.egg/paste/script/request.py
# Compiled at: 2012-02-27 07:41:53
import os, re, sys, urlparse, urllib
            ...
            if not start.startswith('-'):
                ...
                for option in self.ARG_OPTIONS:
                    if start == option:
                        ...
                        args.pop(0)
                        if not args:
                            raise BadCommand('Option %s takes an argument' % option)
