...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/PasteScript-1.7.5-py2.6.egg/paste/script/util/subprocess24.py
...
if mswindows:
    ...
    raise ImportError('Windows subprocess module must be installed: see http://effbot.org/downloads/#subprocess')
