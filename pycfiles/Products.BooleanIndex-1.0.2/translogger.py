...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/translogger.py
...
class TransLogger(object):
    ...
    def write_log(self, environ, method, req_uri, start, status, bytes):
        ...
        d = {'REMOTE_ADDR': remote_addr, 'REMOTE_USER': environ.get('REMOTE_USER') or '-', 
