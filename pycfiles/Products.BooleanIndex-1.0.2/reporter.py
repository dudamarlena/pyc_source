...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/exceptions/reporter.py
...
class WSGIAppReporter(Reporter):
    ...
    def __call__(self, environ, start_response):
        ...
        return [
         formatter.format_html(self.exc_data)]