...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/util/ip4.py
# Compiled at: 2012-02-27 07:41:58
__doc__ = 'IP4 address range set implementation.\n\nImplements an IPv4-range type.\n\nCopyright (C) 2006, Heiko Wundram.\nReleased under the MIT-license.\n'
__author__ = 'Heiko Wundram <me@modelnine.org>'
__version__ = '0.2'
__revision__ = '3'
__date__ = '2006-01-20'
import intset, socket
