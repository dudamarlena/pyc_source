...
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/exceptions/collector.py
...
class ExceptionCollector(object):
    ...
    def collectLine(self, tb, extra_data):
        ...
        if not hasattr(locals, 'has_key'):
            warnings.warn('Frame %s has an invalid locals(): %r' % (
