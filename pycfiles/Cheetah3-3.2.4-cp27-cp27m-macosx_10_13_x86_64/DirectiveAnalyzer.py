...
# [GCC 8.4.0]
# Embedded file name: build/lib.macosx-10.13-x86_64-2.7/Cheetah/DirectiveAnalyzer.py
...
def main():
    ...
    op = OptionParser()
    op.add_option('-f', '--file', dest='file', default=None, help='Specify a single file to analyze')
    op.add_option('-d', '--dir', dest='dir', default=None, help='Specify a directory of templates to analyze')
    op.add_option('--suffix', default='tmpl', dest='suffix', help='Specify a custom template file suffix for the -d option (default: "tmpl")')
