...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/windflow/services/db.py
...
class Database(Service):
    ...
    engine_factory_options = {'connect_args': {'connect_timeout': 2}, 
    ...
    sessionmaker_options = {'autocommit': False, 
     'autoflush': True}
    ...
    def load(self):
        raise NotImplementedError('You must implement `load()` method on Database service, and return your SQLAlchemy base model.')
