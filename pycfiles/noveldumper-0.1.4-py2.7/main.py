...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/n2txt/main.py
# Compiled at: 2020-03-16 23:10:55
import urllib3, requests, chardet
from lxml import html
import HTMLParser, re, click, importlib, sys, os, pickle, click
...
def get_content(url):
    ...
    session.headers.update({'Referer': origin, 
       'Origin': origin, 
