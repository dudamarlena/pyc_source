...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/etheno/logger.py
# Compiled at: 2019-06-27 23:49:12
# Size of source mod 2**32: 13654 bytes
import enum, logging, os, tempfile, threading, time, ptyprocess
...
ANSI_COLOR = '\x1b[1;%dm'
ANSI_BOLD = '\x1b[1m'
LEVEL_COLORS = {CRITICAL: CGAColors.MAGENTA, 
 ERROR: CGAColors.RED, 
...
class ComposableFormatter(object):
    ...
    def __init__(self, *args, **kwargs):
        if len(args) == 1:
            self._parent_formatter = isinstance(args[0], str) or args[0]
        else:
