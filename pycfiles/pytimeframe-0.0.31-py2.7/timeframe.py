...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pytimeframe/timeframe.py
# Compiled at: 2016-01-20 11:49:22
...
class Timeframe(object):
    ...
    def _get_n_unit(cls, frame, period, unit):
        return map(int, re.findall('%s_([0-9]+)_%s' % (period, unit), frame))