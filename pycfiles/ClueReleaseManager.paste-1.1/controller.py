...
# Embedded file name: build/bdist.linux-i686/egg/clue/app/controller.py
# Compiled at: 2008-06-29 13:53:57
import os, cgi, pkg_resources, logging
...
class ControllerApp(object):
    ...
    def __call__(self, environ, start_response):
        try:
            ...
            kwargs = {'error_message': str(err), 'error_extended': None}
    ...
    def access_project(self, environ, start_response):
        ...
        if 'project:' + prjid not in cluemapperconfig.keys():
        ...
        if app is None:
            ...
            logger.debug('controller: registered new project app %r' % prjid)
        newenv = dict(environ)
    ...
    def page_paste(self, environ, start_response):
        if self._pastebin_app is None:
            ...
            app = self._pastebin_app = pastebin.make_app(self.global_config, datastore)
    ...
    def page_createproject(self, environ, start_response):
        ...
        if data:
            ...
            return tmpl.generate(prjid=prj.prjid, name=name, prjurl=prjurl).render()
    ...
    def page_index(self, environ, start_response):
        ...
        kwargs = {'projects': prjs, 'username': username, 
    ...
    def page_readme(self, environ, start_response):
        ...
        return '<html><head><title>README</title></head><body><div id="main"><pre>%s</pre></div></body></html>' % readme
