...
# [GCC 8.4.0]
# Embedded file name: /home/muatik/dahi/dahi/matchers/tfidfMatcher.py
# Compiled at: 2016-07-25 04:19:38
...
class TFIDFMatcher(AbstractMatcher):
    ...
    def generateModel(cls, knowledgeBase):
        ...
        for doc in knowledgeBase.getAll():
            ...
            for term in terms:
                ...
                tf = float(tf * n + 1) / n
                model.setTF(docId=doc.id, term=term, frequency=tf)
    ...
    def match(self, text, length=5):
        ...
        return sorted(docScores.items(), key=operator.itemgetter(1), reverse=True)[:length]
