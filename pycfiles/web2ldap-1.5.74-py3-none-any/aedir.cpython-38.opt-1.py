...
# Compiled at: 2020-05-03 12:42:06
# Size of source mod 2**32: 71721 bytes
"""
...
class AEGroupMember(DerefDynamicDNSelectList, AEObjectMixIn):
 ...
 L. 552       394  BUILD_TUPLE_5         5 
              396  COMPARE_OP               exception-match
          398_400  POP_JUMP_IF_FALSE   446  'to 446'
              402  POP_TOP          
              404  STORE_FAST               'ldap_err'
              406  POP_TOP          
              408  SETUP_FINALLY       434  'to 434'

 L. 559       410  LOAD_GLOBAL              logger
              412  LOAD_METHOD              warning

 L. 560       414  LOAD_STR                 '%s._get_attr_value_dict() searching %r failed: %s'

 L. 561       416  LOAD_FAST                'self'
              418  LOAD_ATTR                __class__
              420  LOAD_ATTR                __name__

 L. 562       422  LOAD_FAST                'member_filter'

 L. 563       424  LOAD_FAST                'ldap_err'

 L. 559       426  CALL_METHOD_4         4  ''
              428  POP_TOP          
              430  POP_BLOCK        
              432  BEGIN_FINALLY    
            434_0  COME_FROM_FINALLY   408  '408'
              434  LOAD_CONST               None
              436  STORE_FAST               'ldap_err'
              438  DELETE_FAST              'ldap_err'
              440  END_FINALLY      
              442  POP_EXCEPT       
              444  JUMP_FORWARD        448  'to 448'
            446_0  COME_FROM           398  '398'
              446  END_FINALLY      
            448_0  COME_FROM           444  '444'
            448_1  COME_FROM           370  '370'

 L. 565       448  LOAD_FAST                'attr_value_dict'
              450  RETURN_VALUE     
               -1  RETURN_LAST      
...
class AEPersonMailaddress(DynamicValueSelectList, RFC822Address):
 ...
 L.1510         0  LOAD_GLOBAL              RFC822Address
 ...
 L.1511        12  LOAD_CONST               False
               14  RETURN_VALUE     
             16_0  COME_FROM            10  '10'

 L.1512        16  LOAD_FAST                'self'
               18  LOAD_METHOD              _get_attr_value_dict
               20  CALL_METHOD_0         0  ''
               22  STORE_FAST               'attr_value_dict'

 L.1514        24  LOAD_FAST                'attr_value_dict'

 L.1513        26  POP_JUMP_IF_FALSE    56  'to 56'

 L.1516        28  LOAD_GLOBAL              len
               30  LOAD_FAST                'attr_value_dict'
               32  CALL_FUNCTION_1       1  ''
               34  LOAD_CONST               1
               36  COMPARE_OP               ==

 L.1513        38  POP_JUMP_IF_FALSE    60  'to 60'

 L.1517        40  LOAD_GLOBAL              tuple
 ...
 L.1513        54  POP_JUMP_IF_FALSE    60  'to 60'
             56_0  COME_FROM            26  '26'

 L.1520        56  LOAD_CONST               True
               58  RETURN_VALUE     
             60_0  COME_FROM            54  '54'
             60_1  COME_FROM            38  '38'

 L.1521        60  LOAD_GLOBAL              DynamicValueSelectList
...
class AECommonNameAEHost(AECommonName):
 ...
 L.1793        30  LOAD_FAST                'attrValues'
               32  RETURN_VALUE     
               -1  RETURN_LAST      
