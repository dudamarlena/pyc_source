...
# [GCC 8.4.0]
# Embedded file name: /home/cbe-master/realfast/anaconda/envs/deployment/lib/python2.7/site-packages/rtpipe/cli.py
# Compiled at: 2016-10-24 18:03:37
import rtpipe.RT as rt, rtpipe.parsecands as pc, rtpipe.parsesdm as ps, rtpipe.reproduce as reproduce, click, os, glob, logging
...
@cli.command()
@click.argument('filename')
@click.option('--snrmin', default=0.0)
@click.option('--snrmax', default=999.0)
@click.option('--bdfdir', default='')
...
@click.option('--threshold', type=float, default=0.0, help='Filter candidates to abs(snr) > threshold')
