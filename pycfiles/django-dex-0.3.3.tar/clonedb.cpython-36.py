...
# [GCC 8.4.0]
# Embedded file name: /home/ggg/www/dev/mogos/mogo88/mogo/dex/management/commands/clonedb.py
# Compiled at: 2017-12-26 07:04:45
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-apps', dest='applist',
          default=None,
          help='Applications to clone: ex: app1,app2,app3')
        parser.add_argument('-m', dest='migrate',
          action='store_true',
          default=False,
          help='Migrate the destination database')
        parser.add_argument('-verb', dest='verbosity',
          default=1,
          help='Set verbosity')
