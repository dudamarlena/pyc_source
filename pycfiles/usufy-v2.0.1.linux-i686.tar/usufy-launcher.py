...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/usufy/usufy-launcher.py
# Compiled at: 2014-12-26 04:32:49
""" 
usufy Copyright (C) F. Brezo and Y. Rubio (i3visio) 2014
...
import argparse, usufy.lib.config_usufy as config, usufy.lib.processing as processing, i3visiotools.wrappers.platforms as platforms
if __name__ == '__main__':
    ...
    groupProcessing.add_argument('-e', '--extension', metavar='<sum_ext>', nargs='+', choices=['json', 'maltego'], required=False, action='store', help='output extension for the summary files (at least one is required).')
