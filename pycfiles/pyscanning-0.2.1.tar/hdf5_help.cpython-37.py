...
# Embedded file name: /home/gmartine/pyscannerbit/pyscannerbit/hdf5_help.py
# Compiled at: 2020-03-04 01:47:30
# Size of source mod 2**32: 4504 bytes
__doc__ = 'Helper routines for accessing HDF5 output of ScannerBit'
import h5py
...
class HDF5(h5py.Group):
    ...
    def get_param_names(self):
        ...
        suffix = '_isvalid'
        return [k[len(prefix):] for k in self.keys() if k.startswith(prefix) if not k.endswith(suffix)]
