...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/create_asset_request.py
# Compiled at: 2020-03-11 08:26:48
# Size of source mod 2**32: 9004 bytes
"""
...
class CreateAssetRequest(object):
    ...
    openapi_types = {'input':'list[InputSettings]', 
    ...
    def __init__(self, input=None, playback_policy=None, demo=None, per_title_encode=None, passthrough=None, mp4_support=None, normalize_audio=False, master_access=None):
