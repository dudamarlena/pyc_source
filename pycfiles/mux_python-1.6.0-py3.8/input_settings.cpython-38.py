...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/input_settings.py
...
class InputSettings(object):
    ...
    def __init__(self, url=None, overlay_settings=None, type=None, text_type=None, language_code=None, name=None, closed_captions=None, passthrough=None):
