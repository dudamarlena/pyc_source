...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/test/test_delivery_usage_api.py
...
class TestDeliveryUsageApi(unittest.TestCase):
    __doc__ = 'DeliveryUsageApi unit test stubs'

    def setUp(self):
        self.api = mux_python.api.delivery_usage_api.DeliveryUsageApi()
