...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/asset_response.py
...
class AssetResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this AssetResponse.  # noqa: E501

        :return: The data of this AssetResponse.  # noqa: E501
        :rtype: Asset
        """
        return self._data
    ...
    def data(self, data):
        ...
        :param data: The data of this AssetResponse.  # noqa: E501
        :type: Asset
        """
        self._data = data
