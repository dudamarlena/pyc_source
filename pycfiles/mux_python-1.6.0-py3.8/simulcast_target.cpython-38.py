...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/simulcast_target.py
...
class SimulcastTarget(object):
    ...
    def __init__(self, id=None, passthrough=None, status=None, stream_key=None, url=None):
    ...
    def status(self, status):
        ...
        """
        allowed_values = [
         'idle', 'starting', 'broadcasting', 'errored']
