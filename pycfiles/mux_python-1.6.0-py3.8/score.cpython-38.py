...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/score.py
# Compiled at: 2020-03-11 08:26:48
# Size of source mod 2**32: 5682 bytes
"""
...
class Score(object):
    ...
    openapi_types = {'watch_time':'int', 
     'view_count':'int', 
     'name':'str', 
     'value':'float', 
     'metric':'str', 
     'items':'list[Metric]'}
    attribute_map = {'watch_time':'watch_time', 
    ...
    def __init__(self, watch_time=None, view_count=None, name=None, value=None, metric=None, items=None):
