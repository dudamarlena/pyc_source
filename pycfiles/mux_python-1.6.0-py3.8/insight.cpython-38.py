...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/insight.py
...
class Insight(object):
    ...
    openapi_types = {'total_watch_time':'int', 
     'total_views':'int', 
     'negative_impact_score':'float', 
     'metric':'float', 
     'filter_value':'str', 
     'filter_column':'str'}
    attribute_map = {'total_watch_time':'total_watch_time', 
    ...
    def __init__(self, total_watch_time=None, total_views=None, negative_impact_score=None, metric=None, filter_value=None, filter_column=None):
