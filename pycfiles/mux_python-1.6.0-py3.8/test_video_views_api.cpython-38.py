...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/test/test_video_views_api.py
...
class TestVideoViewsApi(unittest.TestCase):
    __doc__ = 'VideoViewsApi unit test stubs'

    def setUp(self):
        self.api = mux_python.api.video_views_api.VideoViewsApi()
    ...
    def test_list_video_views(self):
