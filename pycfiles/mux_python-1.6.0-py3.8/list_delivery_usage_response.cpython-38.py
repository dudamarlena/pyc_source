...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/list_delivery_usage_response.py
...
class ListDeliveryUsageResponse(object):
    ...
    openapi_types = {'data':'list[DeliveryReport]', 
     'total_row_count':'int', 
     'timeframe':'list[int]', 
     'limit':'int'}
    ...
    def __init__(self, data=None, total_row_count=None, timeframe=None, limit=None):
