...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/test/test_filters_api.py
...
class TestFiltersApi(unittest.TestCase):
    __doc__ = 'FiltersApi unit test stubs'

    def setUp(self):
        self.api = mux_python.api.filters_api.FiltersApi()
