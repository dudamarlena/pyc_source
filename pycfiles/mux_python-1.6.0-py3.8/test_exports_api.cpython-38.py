...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/test/test_exports_api.py
...
class TestExportsApi(unittest.TestCase):
    __doc__ = 'ExportsApi unit test stubs'

    def setUp(self):
        self.api = mux_python.api.exports_api.ExportsApi()
