...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/api/metrics_api.py
# Compiled at: 2020-03-11 08:26:48
# Size of source mod 2**32: 31707 bytes
"""
...
class MetricsApi(object):
    ...
    def get_metric_timeseries_data(self, metric_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            return (self.get_metric_timeseries_data_with_http_info)(metric_id, **kwargs)
        data = (self.get_metric_timeseries_data_with_http_info)(metric_id, **kwargs)
        return data

    def get_metric_timeseries_data_with_http_info(self, metric_id, **kwargs):
        """Get metric timeseries data  # noqa: E501
        ...
        all_params = [
         'metric_id', 'timeframe', 'filters', 'measurement', 'order_direction', 'group_by']
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_metric_timeseries_data" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'metric_id' not in local_var_params or local_var_params['metric_id'] is None:
                raise ValueError('Missing the required parameter `metric_id` when calling `get_metric_timeseries_data`')
            collection_formats = {}
            path_params = {}
            ...
            if 'measurement' in local_var_params:
                query_params.append(('measurement', local_var_params['measurement']))
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/data/v1/metrics/{METRIC_ID}/timeseries',
              'GET', path_params,
              query_params,
              header_params,
              body=body_params,
              ...
              response_type='GetMetricTimeseriesDataResponse',
    ...
    def get_overall_values(self, metric_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.get_overall_values_with_http_info)(metric_id, **kwargs)
        data = (self.get_overall_values_with_http_info)(metric_id, **kwargs)
        return data

    def get_overall_values_with_http_info(self, metric_id, **kwargs):
        """Get Overall values  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_overall_values" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'metric_id' not in local_var_params or local_var_params['metric_id'] is None:
                raise ValueError('Missing the required parameter `metric_id` when calling `get_overall_values`')
            collection_formats = {}
            path_params = {}
            if 'metric_id' in local_var_params:
                path_params['METRIC_ID'] = local_var_params['metric_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/data/v1/metrics/{METRIC_ID}/overall',
              'GET', path_params,
              query_params,
              header_params,
              body=body_params,
              post_params=form_params,
              files=local_var_files,
              response_type='GetOverallValuesResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
    ...
    def list_all_metric_values(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.list_all_metric_values_with_http_info)(**kwargs)
        data = (self.list_all_metric_values_with_http_info)(**kwargs)
        return data

    def list_all_metric_values_with_http_info(self, **kwargs):
        """List all metric values  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method list_all_metric_values" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            collection_formats = {}
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/data/v1/metrics/comparison',
              'GET', path_params,
              query_params,
              header_params,
              body=body_params,
              post_params=form_params,
              files=local_var_files,
              response_type='ListAllMetricValuesResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
    ...
    def list_breakdown_values(self, metric_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.list_breakdown_values_with_http_info)(metric_id, **kwargs)
        data = (self.list_breakdown_values_with_http_info)(metric_id, **kwargs)
        return data

    def list_breakdown_values_with_http_info(self, metric_id, **kwargs):
        """List breakdown values  # noqa: E501
        ...
        local_var_params = locals()
        all_params = [
         'metric_id', 'group_by', 'measurement', 'filters', 'limit', 'page', 'order_by', 'order_direction', 'timeframe']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method list_breakdown_values" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'metric_id' not in local_var_params or local_var_params['metric_id'] is None:
                raise ValueError('Missing the required parameter `metric_id` when calling `list_breakdown_values`')
            collection_formats = {}
            path_params = {}
            if 'metric_id' in local_var_params:
                path_params['METRIC_ID'] = local_var_params['metric_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/data/v1/metrics/{METRIC_ID}/breakdown',
              'GET', path_params,
              query_params,
              header_params,
              body=body_params,
              post_params=form_params,
              files=local_var_files,
              response_type='ListBreakdownValuesResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
    ...
    def list_insights(self, metric_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.list_insights_with_http_info)(metric_id, **kwargs)
        data = (self.list_insights_with_http_info)(metric_id, **kwargs)
        return data

    def list_insights_with_http_info(self, metric_id, **kwargs):
        """List Insights  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method list_insights" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'metric_id' not in local_var_params or local_var_params['metric_id'] is None:
                raise ValueError('Missing the required parameter `metric_id` when calling `list_insights`')
            collection_formats = {}
            path_params = {}
            if 'metric_id' in local_var_params:
                path_params['METRIC_ID'] = local_var_params['metric_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/data/v1/metrics/{METRIC_ID}/insights',
              'GET', path_params,
              query_params,
              header_params,
              body=body_params,
              post_params=form_params,
              files=local_var_files,
              response_type='ListInsightsResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
