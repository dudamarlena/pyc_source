...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/asset_static_renditions_files.py
...
class AssetStaticRenditionsFiles(object):
    ...
    def __init__(self, name=None, ext=None, height=None, width=None, bitrate=None, filesize=None):
        """AssetStaticRenditionsFiles - a model defined in OpenAPI"""
        self._name = None
        self._ext = None
        self._height = None
        self._width = None
    ...
    def ext(self, ext):
        ...
        if ext not in allowed_values:
            raise ValueError('Invalid value for `ext` ({0}), must be one of {1}'.format(ext, allowed_values))
        self._ext = ext
