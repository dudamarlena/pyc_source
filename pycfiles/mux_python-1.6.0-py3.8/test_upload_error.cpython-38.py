...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/test/test_upload_error.py
...
class TestUploadError(unittest.TestCase):
    __doc__ = 'UploadError unit test stubs'
