...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/api/live_streams_api.py
# Compiled at: 2020-03-11 08:26:48
# Size of source mod 2**32: 50500 bytes
"""
...
class LiveStreamsApi(object):
    ...
    def create_live_stream_with_http_info(self, create_live_stream_request, **kwargs):
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method create_live_stream" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'create_live_stream_request' not in local_var_params or local_var_params['create_live_stream_request'] is None:
                raise ValueError('Missing the required parameter `create_live_stream_request` when calling `create_live_stream`')
            collection_formats = {}
            path_params = {}
            query_params = []
            header_params = {}
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams',
              'POST', path_params,
              query_params,
              header_params,
              body=body_params,
              ...
              response_type='LiveStreamResponse',
    ...
    def create_live_stream_playback_id(self, live_stream_id, create_playback_id_request, **kwargs):
        ...
        data = (self.create_live_stream_playback_id_with_http_info)(live_stream_id, create_playback_id_request, **kwargs)
        return data
    ...
    def create_live_stream_playback_id_with_http_info(self, live_stream_id, create_playback_id_request, **kwargs):
        ...
        local_var_params = locals()
        all_params = [
         'live_stream_id', 'create_playback_id_request']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method create_live_stream_playback_id" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `create_live_stream_playback_id`')
            if 'create_playback_id_request' not in local_var_params or local_var_params['create_playback_id_request'] is None:
                raise ValueError('Missing the required parameter `create_playback_id_request` when calling `create_live_stream_playback_id`')
            collection_formats = {}
            path_params = {}
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams/{LIVE_STREAM_ID}/playback-ids',
              'POST', path_params,
              query_params,
              header_params,
              body=body_params,
    ...
    def create_live_stream_simulcast_target(self, live_stream_id, create_simulcast_target_request, **kwargs):
        ...
        data = (self.create_live_stream_simulcast_target_with_http_info)(live_stream_id, create_simulcast_target_request, **kwargs)
        return data
    ...
    def create_live_stream_simulcast_target_with_http_info(self, live_stream_id, create_simulcast_target_request, **kwargs):
        ...
        local_var_params = locals()
        all_params = [
         'live_stream_id', 'create_simulcast_target_request']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method create_live_stream_simulcast_target" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `create_live_stream_simulcast_target`')
            if 'create_simulcast_target_request' not in local_var_params or local_var_params['create_simulcast_target_request'] is None:
                raise ValueError('Missing the required parameter `create_simulcast_target_request` when calling `create_live_stream_simulcast_target`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams/{LIVE_STREAM_ID}/simulcast-targets',
              'POST', path_params,
              query_params,
              header_params,
              body=body_params,
              post_params=form_params,
              files=local_var_files,
              response_type='SimulcastTargetResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
    ...
    def delete_live_stream(self, live_stream_id, **kwargs):
        ...
        data = (self.delete_live_stream_with_http_info)(live_stream_id, **kwargs)
        return data
    ...
    def delete_live_stream_with_http_info(self, live_stream_id, **kwargs):
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method delete_live_stream" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `delete_live_stream`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams/{LIVE_STREAM_ID}',
              'DELETE', path_params,
              query_params,
              header_params,
              body=body_params,
    ...
    def delete_live_stream_playback_id(self, live_stream_id, playback_id, **kwargs):
        ...
        data = (self.delete_live_stream_playback_id_with_http_info)(live_stream_id, playback_id, **kwargs)
        return data
    ...
    def delete_live_stream_playback_id_with_http_info(self, live_stream_id, playback_id, **kwargs):
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method delete_live_stream_playback_id" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `delete_live_stream_playback_id`')
            if 'playback_id' not in local_var_params or local_var_params['playback_id'] is None:
                raise ValueError('Missing the required parameter `playback_id` when calling `delete_live_stream_playback_id`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
    ...
    def delete_live_stream_simulcast_target(self, live_stream_id, simulcast_target_id, **kwargs):
        ...
        data = (self.delete_live_stream_simulcast_target_with_http_info)(live_stream_id, simulcast_target_id, **kwargs)
        return data
    ...
    def delete_live_stream_simulcast_target_with_http_info(self, live_stream_id, simulcast_target_id, **kwargs):
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method delete_live_stream_simulcast_target" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `delete_live_stream_simulcast_target`')
            if 'simulcast_target_id' not in local_var_params or local_var_params['simulcast_target_id'] is None:
                raise ValueError('Missing the required parameter `simulcast_target_id` when calling `delete_live_stream_simulcast_target`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams/{LIVE_STREAM_ID}/simulcast-targets/{SIMULCAST_TARGET_ID}',
              'DELETE', path_params,
              query_params,
              header_params,
              body=body_params,
    ...
    def get_live_stream(self, live_stream_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.get_live_stream_with_http_info)(live_stream_id, **kwargs)
        data = (self.get_live_stream_with_http_info)(live_stream_id, **kwargs)
        return data

    def get_live_stream_with_http_info(self, live_stream_id, **kwargs):
        """Retrieve a live stream  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_live_stream" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `get_live_stream`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
    ...
    def get_live_stream_simulcast_target(self, live_stream_id, simulcast_target_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.get_live_stream_simulcast_target_with_http_info)(live_stream_id, simulcast_target_id, **kwargs)
        data = (self.get_live_stream_simulcast_target_with_http_info)(live_stream_id, simulcast_target_id, **kwargs)
        return data

    def get_live_stream_simulcast_target_with_http_info(self, live_stream_id, simulcast_target_id, **kwargs):
        """Retrieve a Live Stream Simulcast Target  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_live_stream_simulcast_target" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `get_live_stream_simulcast_target`')
            if 'simulcast_target_id' not in local_var_params or local_var_params['simulcast_target_id'] is None:
                raise ValueError('Missing the required parameter `simulcast_target_id` when calling `get_live_stream_simulcast_target`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
    ...
    def list_live_streams(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.list_live_streams_with_http_info)(**kwargs)
        data = (self.list_live_streams_with_http_info)(**kwargs)
        return data

    def list_live_streams_with_http_info(self, **kwargs):
        """List live streams  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method list_live_streams" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            collection_formats = {}
            ...
            return self.api_client.call_api('/video/v1/live-streams',
              ...
              post_params=form_params,
              files=local_var_files,
              response_type='ListLiveStreamsResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
    ...
    def reset_stream_key(self, live_stream_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.reset_stream_key_with_http_info)(live_stream_id, **kwargs)
        data = (self.reset_stream_key_with_http_info)(live_stream_id, **kwargs)
        return data

    def reset_stream_key_with_http_info(self, live_stream_id, **kwargs):
        """Reset a live stream’s stream key  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method reset_stream_key" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `reset_stream_key`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams/{LIVE_STREAM_ID}/reset-stream-key',
              'POST', path_params,
              query_params,
              header_params,
              body=body_params,
    ...
    def signal_live_stream_complete(self, live_stream_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return (self.signal_live_stream_complete_with_http_info)(live_stream_id, **kwargs)
        data = (self.signal_live_stream_complete_with_http_info)(live_stream_id, **kwargs)
        return data

    def signal_live_stream_complete_with_http_info(self, live_stream_id, **kwargs):
        """Signal a live stream is finished  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method signal_live_stream_complete" % key)
            local_var_params[key] = val
        else:
            del local_var_params['kwargs']
            if 'live_stream_id' not in local_var_params or local_var_params['live_stream_id'] is None:
                raise ValueError('Missing the required parameter `live_stream_id` when calling `signal_live_stream_complete`')
            collection_formats = {}
            path_params = {}
            if 'live_stream_id' in local_var_params:
                path_params['LIVE_STREAM_ID'] = local_var_params['live_stream_id']
            ...
            auth_settings = [
             'accessToken']
            return self.api_client.call_api('/video/v1/live-streams/{LIVE_STREAM_ID}/complete',
              'PUT', path_params,
              query_params,
              header_params,
              body=body_params,
              post_params=form_params,
              files=local_var_files,
              response_type='SignalLiveStreamCompleteResponse',
              auth_settings=auth_settings,
              async_req=(local_var_params.get('async_req')),
              _return_http_data_only=(local_var_params.get('_return_http_data_only')),
              _preload_content=(local_var_params.get('_preload_content', True)),
