...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/mux_python/models/playback_policy.py
...
class PlaybackPolicy(object):
    ...
    def __init__(self):
        """PlaybackPolicy - a model defined in OpenAPI"""
...
(item[0], item[1].to_dict()) # Avoid dead code: item, value.items()))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlaybackPolicy):
            return False
