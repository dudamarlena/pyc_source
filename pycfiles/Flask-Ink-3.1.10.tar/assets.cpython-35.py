...
# [GCC 8.4.0]
# Embedded file name: /home/ubuntu/flask-sapo-ink/flask_ink/assets.py
# Compiled at: 2017-08-30 15:43:50
# Size of source mod 2**32: 6056 bytes
import re, flask
from flask_ink import ink

class AssetLocation(object):
    __doc__ = 'Abstractly represents a location from where your static files\n    get served from.\n\n    '
...
class LocalAssets(AssetLocation):
    __doc__ = "Represents assets served locally. Uses flask's url_for to determine\n    the resource's location.\n\n    "
...
class ExternalLocation(AssetLocation):
    __doc__ = 'Represents assets that are located *somewhere* externally (like a CDN for\n    instance\n\n    '
...
class SapoCDN(ExternalLocation):
    __doc__ = "Specializes the ExternalLocation and adds direct support to Sapo's Ink CDN.\n\n    "
...
class AssetManager(object):
    __doc__ = "Is responsible for storing the available AssetLocation's available and for dispatching\n    to one of the registered instances, the requests for actually generating an URL for a resource.\n\n    "

    def __init__(self, location_map={}, minified=False, asset_version=None, default_location=None):
        """Constructor
