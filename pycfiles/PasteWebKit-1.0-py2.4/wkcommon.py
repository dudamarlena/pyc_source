...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/paste/webkit/wkcommon.py
# Compiled at: 2006-10-22 17:01:02
import cgi, urllib, warnings, inspect, Cookie as CookieEngine
__all__ = [
 'NoDefault', 'htmlEncode', 'htmlDecode', 'urlEncode', 'urlDecode']
try:
