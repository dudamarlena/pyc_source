...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/paste/webkit/servlet_script.py
...
class ServletCommand(Command):
    ...
    max_args = 1
    default_verbosity = 1
    parser = Command.standard_parser(simulate=True, quiet=True, interactive=True, overwrite=True)
