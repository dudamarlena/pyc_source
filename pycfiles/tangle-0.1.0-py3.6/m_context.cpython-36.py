...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/tangle/m_context.py
# Compiled at: 2017-08-24 10:02:16
# Size of source mod 2**32: 6682 bytes
import inspect, six, six.moves
from tangle import m_aspect, m_bean, m_container, m_event

class BeanIdError(ValueError):

    def __init__(self):
        super(BeanIdError, self).__init__('bean id has not been found in application context, check if you input the wrong id!')
