...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/amicleaner/cli.py
# Compiled at: 2018-05-21 06:14:20
# Size of source mod 2**32: 5864 bytes
...
class App(object):
    ...
    def __init__(self, args):
        ...
        self.mapping_strategy = {'key':self.mapping_key, 
    ...
    def prepare_candidates(self, candidates_amis=None):
        ...
        if not candidates_amis:
            ...
            c = AMICleaner()
            mapped_amis = c.map_candidates(candidates_amis=candidates_amis,
    ...
    def clean_orphans(self):
        ...
        answer = input('Do you want to continue and remove {} orphan snapshots [y/N] ? : '.format(len(snaps)))
        ...
        if self.check_orphans:
            ...
            if self.from_ids:
                ...
                if not self.force_delete:
                    answer = input('Do you want to continue and remove {} AMIs [y/N] ? : '.format(len(candidates)))
