...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/labmanager/actions.py
# Compiled at: 2014-02-26 03:49:39
__author__ = 'root'
...
class LabManagerVmProvider(object):
    ...
    def create_machines(self, machine_settings):
        ...
        for machine_name, machine_setting in machine_settings.items():
            ...
            machine_id = self.service.machine_create_under_configuration(self.configuration_id, template_name, network_name, machine_name, machine_desc)
