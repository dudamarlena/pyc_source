...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/labmanager/lmwsproxy.py
...
class LMService(object):
    ...
    def machine_create_under_configuration(self, configuration_id, template_name, network_name, machine_name, machine_description):
        ...
        new_machine_id = self.proxy.service.ConfigurationAddMachineEx(configuration_id, template_id, machine_name, machine_description, 0, 0, newArrayofNetInfo)
