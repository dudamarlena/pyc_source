...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/suds/xsd/sxbase.py
...
class Iter():
 ...
 L. 584         0  LOAD_FAST             0  'self'
                3  LOAD_ATTR             0  'top'
                6  CALL_FUNCTION_0       0  None
                9  STORE_FAST            1  'frame'

 L. 585        12  SETUP_LOOP          130  'to 145'
               15  LOAD_GLOBAL           1  'True'
               18  POP_JUMP_IF_FALSE   144  'to 144'

 L. 586        21  LOAD_FAST             1  'frame'
               24  LOAD_ATTR             2  'next'
               27  CALL_FUNCTION_0       0  None
               30  STORE_FAST            2  'result'

 L. 587        33  LOAD_FAST             2  'result'
               36  LOAD_CONST               None
               39  COMPARE_OP            8  is
               42  POP_JUMP_IF_FALSE    65  'to 65'

 L. 588        45  LOAD_FAST             0  'self'
               48  LOAD_ATTR             4  'pop'
               51  CALL_FUNCTION_0       0  None
               54  POP_TOP          

 L. 589        55  LOAD_FAST             0  'self'
               58  LOAD_ATTR             2  'next'
               61  CALL_FUNCTION_0       0  None
               64  RETURN_END_IF    
             65_0  COME_FROM            42  '42'

 L. 590        65  LOAD_GLOBAL           5  'isinstance'
               68  LOAD_FAST             2  'result'
               71  LOAD_GLOBAL           6  'Content'
               74  CALL_FUNCTION_2       2  None
               77  POP_JUMP_IF_FALSE   121  'to 121'

 L. 591        80  BUILD_LIST_0          0 
               83  LOAD_FAST             0  'self'
               86  LOAD_ATTR             7  'stack'
               89  GET_ITER         
               90  FOR_ITER             15  'to 108'
               93  STORE_FAST            3  'f'
               96  LOAD_FAST             3  'f'
               99  LOAD_ATTR             8  'sx'
              102  LIST_APPEND           2  None
              105  JUMP_BACK            90  'to 90'
              108  STORE_FAST            4  'ancestry'

 L. 592       111  LOAD_FAST             2  'result'
              114  LOAD_FAST             4  'ancestry'
              117  BUILD_TUPLE_2         2 
              120  RETURN_END_IF    
            121_0  COME_FROM            77  '77'

 L. 593       121  LOAD_FAST             0  'self'
              124  LOAD_ATTR             9  'push'
              127  LOAD_FAST             2  'result'
              130  CALL_FUNCTION_1       1  None
              133  POP_TOP          

 L. 594       134  LOAD_FAST             0  'self'
              137  LOAD_ATTR             2  'next'
              140  CALL_FUNCTION_0       0  None
              143  RETURN_END_IF    
            144_0  COME_FROM            18  '18'
              144  POP_BLOCK        
            145_0  COME_FROM            12  '12'
              145  LOAD_CONST               None
              148  RETURN_VALUE     
