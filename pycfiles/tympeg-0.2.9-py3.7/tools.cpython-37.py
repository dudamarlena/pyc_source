...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tympeg/tools.py
...
def convert_files_in_dir_to_vcodec(input_folder, video_codec, video_encoder, rate_control_method, video_rate, speed, audio_encoder, audio_bitrate, channels):
    ...
    if profile == 'low':
        ...
        if profile == 'medium':
            ...
            if profile == 'high':
                ...
                return
    convert_files_in_dir_to_vcodec(input_folder, 'hevc', video_encoder, rate_control_method, rate, speed, audio_encoder, audio_bitrate, channels)
