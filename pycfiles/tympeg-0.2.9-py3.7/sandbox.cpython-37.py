...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tympeg/sandbox.py
# Compiled at: 2017-06-08 13:26:37
    ...
    with open((path.join(output_folder, 'log.txt')), 'w', encoding='utf8') as (f):
        ...
        for file in file_paths:
            ...
            for quality in qualities:
                ...
                input_size = media.file_size / 1000000
                output_size = path.getsize(output_file_path) / 1000000
                file_time += 60
