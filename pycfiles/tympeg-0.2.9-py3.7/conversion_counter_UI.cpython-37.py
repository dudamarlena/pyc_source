...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tympeg/scripts/conversion_counter_UI.py
    ...
    def analyze(self):
        ...
        for dirs in directoryList:
            ...
            for fileNames in os.listdir(rootdir + dirs):
                ...
                elif any((extensions in fileNames for extensions in fileExtensionsToAnalyze)):
    ...
    def printAnalysis(self, printableList, invalidFilesList):
        for i in range(len(printableList) - 1, -1, -1):
            ...
            if self.logIsTerse == False or printableList[i][4] > 0:
                ...
                print()
            if not self.logIsTerse == False:
                if printableList[i][5] > 0:
