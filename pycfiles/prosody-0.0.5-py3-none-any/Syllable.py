...
# Embedded file name: /Users/ryan/DH/prosodic/lib/Syllable.py
# Compiled at: 2018-06-24 22:16:45
...
class Syllable(entity):
    ...
    def feature_pairs(self):
        ...
        return [
         stress + weight, stress + highlow, stress + longshort, weight + longshort, weight + highlow, highlow + longshort]
