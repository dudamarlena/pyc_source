...
# Embedded file name: /Users/ryan/DH/prosodic/lib/MaxEnt.py
# Compiled at: 2018-06-24 22:21:32
...
class DataAggregator:
    ...
    def convert_to_table(self):
        ...
        for key in inputs_to_data:
            ...
            inputs_to_data[key] = (
             violation_matrix, frequency_vector)

        return (
         inputs_to_data, inputs_to_outputs, feature_count)
...
class MaxEntAnalyzer:
    ...
    def train(self, step=0.01, epochs=1000000, tolerance=0.0001, only_positive_weights=True):
        self.step = step
