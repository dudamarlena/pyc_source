...
# Embedded file name: /Users/ryan/DH/prosodic/lib/MaxEnt2.py
    ...
    def convert_to_table(self):
        ...
        for line in self.lines:
            if line not in self.data:
                print (
                 '!?', line, 'not in DataAggregator.data ?')
                continue
...
class MaxEntAnalyzer:
    ...
    def train(self, step=0.1, epochs=10000, tolerance=1e-06, only_positive_weights=True):
        self.step = step
