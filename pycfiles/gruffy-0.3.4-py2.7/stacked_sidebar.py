...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/gruffy/stacked_sidebar.py
# Compiled at: 2013-01-27 09:07:32
    ...
    def draw_bars(self):
        ...
        for row_index, data_row in enumerate(self.norm_data):
            for point_index, data_point in enumerate(data_row['values']):
                tmp1 = self.graph_left + (self.graph_width - data_point * self.graph_width - height[point_index]) + 1
                tmp2 = self.graph_left + self.graph_width - height[point_index] - 1
                ...
                left_y = self.graph_top + self.bar_width * point_index + padding
                ...
                label_center = self.graph_top + self.bar_width * point_index + self.bar_width * self.bar_spacing / 2.0
