...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/_multitarget/widgets/OWClassifierChain.py
...
class OWClassifierChain(OWWidget):
    ...
    def __init__(self, parent=None, signalManager=None, title='Classifier Chain'):
    ...
    def apply(self):
        ...
        if self.base_learner is not None:
            learner = Orange.multitarget.chain.ClassifierChainLearner(name=self.name, learner=self.base_learner, actual_values=self.actual_values)
        classifier = None
