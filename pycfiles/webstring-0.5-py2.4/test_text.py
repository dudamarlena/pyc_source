...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\webstring\tests\test_text.py
# Compiled at: 2007-01-03 01:27:11
...
class Testwebstring(unittest.TestCase):
    ...
    __module__ = __name__
    groupend = '<tr class="tr1"><td id="td1"></td><td id="td2"></td></tr><tr class="tr2"><td id="td1"></td><td id="td2"></td></tr>'
    altgroupend = '<tr class="tr2"><td id="td1"></td><td id="td2"></td></tr><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr>'
    subgroupend = '<td id="td1" /><td id="td1" />'
    addtest = '<html><head><title id="title"></title></head></html><html><body><p id="content"></p></body></html>'
    altaddtest = '<html><body><p id="content" /></body><head><title id="title" /></head></html>'
    field_add = '<p id="content" /><title id="title" />'
    field_group_add = '<title id="title" /><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr>'
    root_group_add = '<html><head><title id="title"></title></head></html><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr>'
    ...
    root_mul = '<html><head><title id="title"></title></head><html><body><p id="content"></p></body></html></html><html><head><title id="title"></title></head><html><body><p id="content"></p></body></html></html><html><head><title id="title"></title></head><html><body><p id="content"></p></body></html></html>'
    root_group_mul = '<tr class="tr1"><td id="td1"></td><td id="td2"></td></tr><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr>'
    ...
    modtest3 = '<html><head><title id="title">Title</title></head><body><p id="content">Test1Test2</p><p id="content2">Test1Test2</p></body></html>'
    ...
    groupmod3 = '<table><tr class="tr1"><td id="td1">Test1Test2</td><td id="td2">Test1Test2</td></tr></table>'
    ...
    modtemplate1 = TextTemplate('<html><head><title id="title">$title$</title></head><body /></html>')
    modtemplate3 = TextTemplate('<html><head><title id="title">$title$</title></head><body><p id="content">$content$</p><p id="content2">$content2$</p></body></html>')
    gentemplate = TextTemplate('<html><head><title id="title">$title$</title></head><html><body><p id="content">$content$</p></body></html></html>')
    atemplate = TextTemplate('<html><head><title id="title">$title$</title></head></html>')
    btemplate = TextTemplate('<html><body><p id="content">$content$</p></body></html>')
    powtemplate = TextTemplate('<html><head /><body><p id="content">$content$</p></body></html>')
    agrouptest = TextTemplate('<table>$$tr1<tr class="tr1"><td id="td1">$td1$</td><td id="td2">$td2$</td></tr>$$</table>')
    bgrouptest = TextTemplate('<table>$$tr2<tr class="tr2"><td id="td1">$td1$</td><td id="td2">$td2$</td></tr>$$</table>')
    subcombotest = TextTemplate('<body><a id="fieldtest" href="atest">$fieldtest$</a>$$grouptest<tr class="grouptest"><td id="groupfield1">$groupfield1$</td><td id="groupfield2">$groupfield2$</td></tr>$$</body>')
    ...
    def test_root_radd(self):
        ...
        final = '<html><body><p id="content"></p></body></html><html><head><title id="title"></title></head></html>'
    ...
    def test_root_field_iadd(self):
        ...
        final = '<html><body><p id="content"></p></body></html><title id="title" />'
        self.atemplate.title %= '<title id="title" />'
    ...
    def test_group_subfield_iadd(self):
        ...
        final = '<tr class="tr1"><td id="td1"></td><td id="td2"></td></tr><td id="td1"></td>'
    ...
    def test_auto_auto_off_hasattr(self):
        ...
        atst = TextTemplate('<html><head><title id="title">$title</title></head><body><p id="content">$content</p></body></html>', False)
    ...
    def test_field_append(self):
        ...
        final = '<html><head><title id="title"><html><head><title id="title"></title></head></html></title></head></html>'
    ...
    def test_group_append(self):
        ...
        final = '<table><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr><table><tr class="tr1"><td id="td1"></td><td id="td2"></td></tr></table></table>'
    ...
    def test_exclude_live(self):
        ...
        testfilter = TextTemplate('<table>$$tr1 <tr class="tr1"><td id="td1">$td1$</td><td id="td2">$td2$</td></tr>$$<p id="r">$r$</p></table>')
    ...
    def test_exclude_group(self):
        ...
        a = TextTemplate()
        a.exclude('tr1')
        a.fromstring('<table>$$tr1 <tr class="tr1"><td id="td1">$td1$</td><td id="td2">$td2$</td></tr>$$<p id="r">$r$</p></table>')
        self.assertEqual(True, len(a) == 1)
    ...
    def test_no_empty_group(self):
        ...
        testfilter = TextTemplate()
        testfilter.exclude('td1')
        testfilter.fromstring('<div>$$tr1 <tr class="tr1"><td id="td1">$td1</td></tr>$$</table></div>')
        testfilter.include('td1')
    ...
    def test_pickle(self):
        test = '<body><a id="fieldtest" href="atest"></a><tr class="grouptest"><td id="groupfield1"></td><td id="groupfield2"></td></tr></body>'
    ...
    def test_delattr_root_template(self):
        ...
        del e.test
        self.assertEqual(e._template, ' is a %s')
