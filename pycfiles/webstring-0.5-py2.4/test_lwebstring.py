...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\webstring\tests\test_lwebstring.py
# Compiled at: 2006-12-21 08:37:15
...
class Testwebstring(unittest.TestCase):
    ...
    modtemplate1 = Template('<html><head><title id="title"/></head><body/></html>', engine='lxml')
    modtemplate3 = Template('<html><head><title id="title"></title></head><body><p id="content"/><p id="content2"/></body></html>', engine='lxml')
    gentemplate = Template(addtest, engine='lxml')
    atemplate = Template('<html><head><title id="title"></title></head></html>', engine='lxml')
    btemplate = Template('<html><body><p id="content"></p></body></html>', engine='lxml')
    powtemplate = Template('<html><head/><body><p id="content"/></body></html>', engine='lxml')
    agrouptest = Template('<table><tr class="tr1"><td id="td1"/><td id="td2"/></tr></table>', engine='lxml')
    bgrouptest = Template('<table><tr class="tr2"><td id="td1"/><td id="td2"/></tr></table>', engine='lxml')
    subcombotest = Template('<body><a id="fieldtest" href="atest"/><tr class="grouptest"><td id="groupfield1"/><td id="groupfield2"/></tr></body>', engine='lxml')
    ...
    htmlt = HTMLTemplate('<html><head><link href="test.css" type="text/css"><title id="title"><body><p id="content"></body></head></html>', engine='lxml')
    ...
    def test_lroot_imod_extended_format(self):
        ...
        final = '<body><a id="fieldtest" href="caliban.html#test" title="This link goes to test">This template is a first test.</a><a id="fieldtest" href="caliban.html#linktest" title="This link goes to Link Test">This other template is a link test.</a><tr class="grouptest"><td id="groupfield1" align="left" title="This column is column first">This first test is the first column.</td><td id="groupfield1" align="right" title="This col is column second">This second test is the second column.</td><td id="groupfield2" align="left" title="This test is next.">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
    ...
    def test_lfield_imod_extended_format(self):
        ...
        final = '<body><a id="fieldtest" href="caliban.html#test" title="This link goes to test">This template is a first test.</a><a id="fieldtest" href="caliban.html#linktest" title="This link goes to Link Test">This other template is a link test.</a><tr class="grouptest"><td id="groupfield1"/><td id="groupfield2"/></tr></body>'
    ...
    def test_lfield_imod_attrib_extended_format(self):
        ...
        final = '<body><a id="fieldtest" href="caliban.html#test" title="This link goes to test">This is a test.</a><a id="fieldtest" href="caliban.html#linktest" title="This link goes to Link Test">This is another test.</a><tr class="grouptest"><td id="groupfield1"/><td id="groupfield2"/></tr></body>'
    ...
    def test_lfield_imod_text_extended_format(self):
        ...
        final = '<body><a id="fieldtest" href="atest">This template is a first test.</a><a id="fieldtest" href="atest">This other template is a link test.</a><tr class="grouptest"><td id="groupfield1"/><td id="groupfield2"/></tr></body>'
    ...
    def test_lgroup_imod_combo_extended_format(self):
        ...
        final = '<body><a id="fieldtest" href="atest"/><tr class="grouptest"><td id="groupfield1" align="left" title="This column is column first">This first test is the first column.</td><td id="groupfield1" align="right" title="This col is column second">This second test is the second column.</td><td id="groupfield2" align="left" title="This test is next.">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
        self.subcombotest.grouptest %= {'groupfield1': {'template': {'text': 'This %(one)s is the %(num)s column.', 'attrib': {'title': 'This %(one)s is column %(num)s'}}, 'sub': ({'text': {'one': 'first test', 'num': 'first'}, 'attrib': {'align': 'left', 'title': {'one': 'column', 'num': 'first'}}}, {'text': 'This second test is the second column.', 'attrib': {'align': 'right', 'title': {'one': 'col', 'num': 'second'}}})}, 'groupfield2': {'template': {'text': 'This $test is a $fill.', 'attrib': {'title': 'This %(one)s is next.'}}, 'sub': ({'text': 'This test is first.', 'attrib': {'align': 'left', 'title': {'one': 'test'}}}, {'text': {'test': 'coltest', 'fill': 'next'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}}
        self.assertEqual(final, self.subcombotest.pipe())
    ...
    def test_lattribute_get(self):
        ...
        atst = Template('<table><tr class="tr1"><td id="td1" align="left"/><td id="td2"/></tr></table>', engine='lxml')
    ...
    def test_lfield_delete_attribute(self):
        ...
        atst = Template('<html><body><p align="left" id="content"></p></body></html>', engine='lxml')
    ...
    def test_lattribute_set_key_noauto(self):
        ...
        atst = Template('<table><tr class="tr1"><td id="td1" align="left"/><td id="td2"/></tr></table>', False, engine='lxml')
        atst['tr1']['td1']['align'] = 'right'
        self.assertEqual(atst['tr1']['td1']['align'], 'right')
    ...
    def test_lfield_attribute_delete_key_noauto(self):
        ...
        atst = Template('<html><body><p align="left" id="content"></p></body></html>', False, engine='lxml')
        del atst['content']['align']
    ...
    def test_lsubfield_purge(self):
        """Tests if an XML attribute is purged from a field or not."""
        final = '<body><a id="fieldtest" href="atest"/><tr class="grouptest"><td/><td id="groupfield2"/></tr></body>'
    ...
    def test_lgroup_nomarks(self):
        ...
        final = '<body><a id="fieldtest" href="atest"/><tr><td/><td/></tr></body>'
    ...
    def test_latemplate_source_interpolation(self):
        ...
        atst = Template('<body><p id="content" title="This %(t1)s is a %(t2)s"/></body>', engine='lxml')
    ...
    def test_latemplate_source_string_template(self):
        """Tests getting attribute template from inline text in the source."""
        final = '<body><p id="content" title="This run is a test."/></body>'
        atst = Template('<body><p id="content" title="This $t1 is a $t2"/></body>', engine='lxml')
        atst.content.update({'title': {'t1': 'run', 't2': 'test.'}})
        self.assertEqual(final, atst.render())
    ...
    def test_lauto_auto_off_attribute(self):
        ...
        atst = Template('<html><head><title id="title" style="style"/></head><body><p id="content"/></body></html>', False, engine='lxml')
    ...
    def test_ltemplates_mixin(self):
        """Tests batch addition of templates to a root Template."""
        final = '<body><a id="fieldtest" href="atest"/><tr class="grouptest"><td id="groupfield1" align="left" title="This column is column first">one</td><td id="groupfield1" align="right" title="This col is column second">This second test is the second column.</td><td id="groupfield2">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
    ...
    def test_ltemplate_from_src_interpolation(self):
        """Tests a template passed in with markup with the Template source."""
        final = '<body><p id="stuff">This run is a test.</p></body>'
        ast = Template('<body><p id="stuff">This %(tst1)s is a %(tst2)s</p></body>', engine='lxml')
        ast.stuff.text = {'tst1': 'run', 'tst2': 'test.'}
        self.assertEqual(final, ast.render())
    ...
    def test_lauto_auto_off_hasattr(self):
        ...
        atst = Template('<html><head><title id="title"/></head><body><p id="content"/></body></html>', False, engine='lxml')
    ...
    def test_lexclude_live(self):
        ...
        testfilter = Template('<table><tr class="tr1"><td id="td1"/><td id="td2"/></tr><p id="r"/></table>', engine='lxml')
    ...
    def test_lgroup_under_group_proc(self):
        ...
        testfilter = Template('<div><table class="thing"><th id="thing2"/><tr class="tr1"><td id="td1"/><td id="td2"/></tr></table></div>', engine='lxml')
    ...
    def test_lhtmltemplate_output_html4(self):
        ...
        final = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">\n<html><head><link href="test.css" type="text/css"><title id="title">Test Page</title></head><body><p id="content">Test Content</p></body></html>'
