...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\webstring\tests\test_webstring.py
# Compiled at: 2007-01-01 18:42:12
...
class Testwebstring(unittest.TestCase):
    ...
    __module__ = __name__
    groupend = '<tr class="tr1"><td id="td1" /><td id="td2" /></tr><tr class="tr2"><td id="td1" /><td id="td2" /></tr>'
    altgroupend = '<tr class="tr2"><td id="td1" /><td id="td2" /></tr><tr class="tr1"><td id="td1" /><td id="td2" /></tr>'
    subgroupend = '<td id="td1" /><td id="td1" />'
    addtest = '<html><head><title id="title" /></head><html><body><p id="content" /></body></html></html>'
    altaddtest = '<html><body><p id="content" /></body><head><title id="title" /></head></html>'
    field_add = '<p id="content" /><title id="title" />'
    field_group_add = '<title id="title" /><tr class="tr1"><td id="td1" /><td id="td2" /></tr>'
    root_group_add = '<html><head><title id="title" /></head><tr class="tr1"><td id="td1" /><td id="td2" /></tr></html>'
    root_element_add = '<html><head><title id="title" /></head><p /></html>'
    field_element_add = '<title id="title" /><p />'
    group_element_add = '<tr class="tr1"><td id="td1" /><td id="td2" /></tr><p />'
    subfield_element_add = '<td id="td1" /><p />'
    multest = '<p id="content" /><p id="content" /><p id="content" />'
    root_mul = '<html><head><title id="title" /></head><html><body><p id="content" /></body></html><html><head><title id="title" /></head><html><body><p id="content" /></body></html></html><html><head><title id="title" /></head><html><body><p id="content" /></body></html></html></html>'
    root_group_mul = '<tr class="tr1"><td id="td1" /><td id="td2" /></tr><tr class="tr1"><td id="td1" /><td id="td2" /></tr><tr class="tr1"><td id="td1" /><td id="td2" /></tr>'
    subfield_group_mul = '<td id="td1" /><td id="td1" /><td id="td1" />'
    modtest1 = '<html><head><title id="title">Test Page</title></head><body /></html>'
    modtest2 = '<html><head><title id="title">Test Page</title></head><html><body><p id="content">Content Goes Here</p></body></html></html>'
    modtest3 = '<html><head><title id="title">Title</title></head><body><p id="content">Test1</p><p id="content">Test2</p><p id="content2">Test1</p><p id="content2">Test2</p></body></html>'
    modtest5 = '<title id="title">Test Page</title>'
    groupmod = '<td id="td1">Test Page</td>'
    groupmod2 = '<table><tr class="tr1"><td id="td1">Test Page</td><td id="td2">Content Goes Here</td></tr></table>'
    groupmod3 = '<table><tr class="tr1"><td id="td1">Test1</td><td id="td1">Test2</td><td id="td2">Test1</td><td id="td2">Test2</td></tr></table>'
    powtest1 = '<p id="content">Test1</p><p id="content">Test2</p>'
    groupow = '<tr class="tr1"><td id="td1">1</td><td id="td2">2</td></tr><tr class="tr1"><td id="td1">3</td><td id="td2">4</td></tr><tr class="tr1"><td id="td1">5</td><td id="td2">6</td></tr>'
    modtemplate1 = Template('<html><head><title id="title" /></head><body /></html>')
    modtemplate3 = Template('<html><head><title id="title"></title></head><body><p id="content" /><p id="content2" /></body></html>')
    gentemplate = Template(addtest)
    atemplate = Template('<html><head><title id="title"></title></head></html>')
    btemplate = Template('<html><body><p id="content"></p></body></html>')
    powtemplate = Template('<html><head /><body><p id="content" /></body></html>')
    agrouptest = Template('<table><tr class="tr1"><td id="td1"/><td id="td2"/></tr></table>')
    bgrouptest = Template('<table><tr class="tr2"><td id="td1"/><td id="td2"/></tr></table>')
    subcombotest = Template('<body><a id="fieldtest" href="atest" /><tr class="grouptest"><td id="groupfield1" /><td id="groupfield2" /></tr></body>')
    ...
    htmlt = HTMLTemplate('<html><head><link href="test.css" type="text/css"><title id="title"><body><p id="content"></body></head></html>')
    ...
    def test_root_radd(self):
        ...
        final = '<html><body><p id="content" /></body><html><head><title id="title" /></head></html></html>'
    ...
    def test_field_root_iadd(self):
        ...
        final = '<title id="title" /><html><body><p id="content" /></body></html>'
    ...
    def test_field_group_iadd(self):
        ...
        self.assertEqual(self.field_group_add, self.atemplate.title.pipe())
    ...
    def test_root_field_iadd(self):
        ...
        final = '<html><body><p id="content" /></body><title id="title" /></html>'
    ...
    def test_group_subfield_iadd(self):
        ...
        final = '<tr class="tr1"><td id="td1" /><td id="td2" /></tr><td id="td1" />'
    ...
    def test_subfield_group_iadd(self):
        ...
        final = '<td id="td1" /><tr class="tr1"><td id="td1" /><td id="td2" /></tr>'
    ...
    def test_field_element_radd(self):
    ...
    def test_field_element_iadd(self):
        """Tests the modifying addition of a field and an Element."""
        self.atemplate.title += _Element('p')
        self.assertEqual(self.field_element_add, self.atemplate.title.pipe())

    def test_group_element_radd(self):
    ...
    def test_group_element_iadd(self):
        """Tests the modifying addition of a group and an Element."""
        self.agrouptest.tr1 += _Element('p')
        self.assertEqual(self.group_element_add, self.agrouptest.tr1.pipe())

    def test_subfield_element_radd(self):
    ...
    def test_subfield_element_iadd(self):
        """Tests the modifying addition of a subfield and an Element."""
        self.agrouptest.tr1.td1 += _Element('p')
        self.assertEqual(self.subfield_element_add, self.agrouptest.tr1.td1.pipe())
    ...
    def test_subfield_imul(self):
        ...
        self.assertEqual(self.subfield_group_mul, self.agrouptest.tr1.td1.pipe())
    ...
    def test_root_tuple_tuple_imod_expand(self):
        ...
        self.modtemplate3 %= ('Title', ('Test1', 'Test2'), ('Test1', 'Test2'))
    ...
    def test_root_dict_tuple_imod_expand(self):
        ...
        self.modtemplate3 %= {'title': 'Title', 'content': ('Test1', 'Test2'), 'content2': ('Test1', 'Test2')}
        self.assertEqual(self.modtest3, self.modtemplate3.pipe())

    def test_group_dict_tuple_imod_expand(self):
        """Tests a modifying dict tuple substitution/expansion of a group."""
        self.agrouptest.tr1 %= {'td1': ('Test1', 'Test2'), 'td2': ('Test1', 'Test2')}
        self.assertEqual(self.groupmod3, self.agrouptest.pipe())
    ...
    def test_root_dict_mod_toomany(self):
        ...
        def tempfunc():
            return self.gentemplate % {'content': 'Content Goes Here', 'title': 'Test Page', 'test': 'Too many'}
    ...
    def test_group_dict_mod_toomany(self):
        ...
        def tempfunc():
            return self.agrouptest.tr1 % {'td1': 'Content Goes Here', 'td2': 'Test Page', 'td3': 'Too many'}
    ...
    def test_root_imod_mass_temp_subs(self):
        ...
        self.rss.item %= {'templates': {'title': {'text': 'Example Title: $content'}, 'ipubdate': {'text': '$month $day, $year'}, 'link': {'text': 'http://www.example.com/rss/$id'}}, 'subs': (({'text': {'content': 'First Example'}}, {'text': {'id': '5423092'}}, 'http://www.example.com/rss/5423092', 'Example of assigning text to a field.', {'text': {'month': 'June', 'day': '06', 'year': '2006'}}), ({'text': {'content': 'Second Example'}}, {'text': {'id': '5423093'}}, 'http://www.example.com/rss/5423093', 'Example of group repetition.', {'text': {'month': 'June', 'day': '06', 'year': '2006'}}))}
        self.assertEqual(final, self.rss.pipe())

    def test_root_imod_extended_format(self):
        """Tests an extended format substitution on a root."""
        final = '<body><a href="caliban.html#test" id="fieldtest" title="This link goes to test">This template is a first test.</a><a href="caliban.html#linktest" id="fieldtest" title="This link goes to Link Test">This other template is a link test.</a><tr class="grouptest"><td align="left" id="groupfield1" title="This column is column first">This first test is the first column.</td><td align="right" id="groupfield1" title="This col is column second">This second test is the second column.</td><td align="left" id="groupfield2" title="This test is next.">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
        self.subcombotest %= {'grouptest': {'groupfield1': {'template': {'text': 'This %(one)s is the %(num)s column.', 'attrib': {'title': 'This %(one)s is column %(num)s'}}, 'sub': ({'text': {'one': 'first test', 'num': 'first'}, 'attrib': {'align': 'left', 'title': {'one': 'column', 'num': 'first'}}}, {'text': 'This second test is the second column.', 'attrib': {'align': 'right', 'title': {'one': 'col', 'num': 'second'}}})}, 'groupfield2': {'template': {'text': 'This $test is a $fill.', 'attrib': {'title': 'This %(one)s is next.'}}, 'sub': ({'text': 'This test is first.', 'attrib': {'align': 'left', 'title': {'one': 'test'}}}, {'text': {'test': 'coltest', 'fill': 'next'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}}, 'fieldtest': {'template': {'text': 'This %(run)s is a %(test)s.', 'attrib': {'href': 'caliban.html#%(link)s', 'title': 'This link goes to %(other)s'}}, 'sub': ({'text': {'test': 'first test', 'run': 'template'}, 'attrib': {'href': {'link': 'test'}, 'title': {'other': 'test'}}}, {'text': {'test': 'link test', 'run': 'other template'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}}
        self.assertEqual(final, self.subcombotest.pipe())

    def test_field_imod_extended_format(self):
        """Tests an extended format substitution on a field."""
        final = '<body><a href="caliban.html#test" id="fieldtest" title="This link goes to test">This template is a first test.</a><a href="caliban.html#linktest" id="fieldtest" title="This link goes to Link Test">This other template is a link test.</a><tr class="grouptest"><td id="groupfield1" /><td id="groupfield2" /></tr></body>'
        self.subcombotest.fieldtest %= {'template': {'text': 'This %(run)s is a %(test)s.', 'attrib': {'href': 'caliban.html#%(link)s', 'title': 'This link goes to %(other)s'}}, 'sub': ({'text': {'test': 'first test', 'run': 'template'}, 'attrib': {'href': {'link': 'test'}, 'title': {'other': 'test'}}}, {'text': {'test': 'link test', 'run': 'other template'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}
        self.assertEqual(final, self.subcombotest.pipe())

    def test_field_imod_attrib_extended_format(self):
        """Tests an extended attribute format substitution on a field."""
        final = '<body><a href="caliban.html#test" id="fieldtest" title="This link goes to test">This is a test.</a><a href="caliban.html#linktest" id="fieldtest" title="This link goes to Link Test">This is another test.</a><tr class="grouptest"><td id="groupfield1" /><td id="groupfield2" /></tr></body>'
        self.subcombotest.fieldtest %= {'template': {'attrib': {'href': 'caliban.html#%(link)s', 'title': 'This link goes to %(other)s'}}, 'sub': ({'text': 'This is a test.', 'attrib': {'href': {'link': 'test'}, 'title': {'other': 'test'}}}, {'text': 'This is another test.', 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}
        self.assertEqual(final, self.subcombotest.pipe())

    def test_field_imod_text_extended_format(self):
        """Tests a text extended format substitution on a field."""
        final = '<body><a href="atest" id="fieldtest">This template is a first test.</a><a href="atest" id="fieldtest">This other template is a link test.</a><tr class="grouptest"><td id="groupfield1" /><td id="groupfield2" /></tr></body>'
        self.subcombotest.fieldtest %= {'template': {'text': 'This %(run)s is a %(test)s.'}, 'sub': ({'text': {'test': 'first test', 'run': 'template'}}, {'text': {'test': 'link test', 'run': 'other template'}})}
        self.assertEqual(final, self.subcombotest.pipe())

    def test_group_imod_combo_extended_format(self):
        """Tests an extended format substitution on a group."""
        final = '<body><a href="atest" id="fieldtest" /><tr class="grouptest"><td align="left" id="groupfield1" title="This column is column first">This first test is the first column.</td><td align="right" id="groupfield1" title="This col is column second">This second test is the second column.</td><td align="left" id="groupfield2" title="This test is next.">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
        self.subcombotest.grouptest %= {'groupfield1': {'template': {'text': 'This %(one)s is the %(num)s column.', 'attrib': {'title': 'This %(one)s is column %(num)s'}}, 'sub': ({'text': {'one': 'first test', 'num': 'first'}, 'attrib': {'align': 'left', 'title': {'one': 'column', 'num': 'first'}}}, {'text': 'This second test is the second column.', 'attrib': {'align': 'right', 'title': {'one': 'col', 'num': 'second'}}})}, 'groupfield2': {'template': {'text': 'This $test is a $fill.', 'attrib': {'title': 'This %(one)s is next.'}}, 'sub': ({'text': 'This test is first.', 'attrib': {'align': 'left', 'title': {'one': 'test'}}}, {'text': {'test': 'coltest', 'fill': 'next'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}}
        self.assertEqual(final, self.subcombotest.pipe())
    ...
    def test_attribute_get(self):
        ...
        atst = Template('<table><tr class="tr1"><td id="td1" align="left"/><td id="td2"/></tr></table>')
    ...
    def test_attribute_set_dict(self):
    ...
    def test_field_delete_attribute(self):
        """Tests deletion of XML attribute attributes."""
        atst = Template('<html><body><p align="left" id="content"></p></body></html>')
        del atst.content.align
        self.assertEqual(False, hasattr(atst.content, 'align'))

    def test_subfield_delete_attribute(self):
    ...
    def test_attribute_get_key_noauto(self):
        """Tests getting XML attributes via key w/o automagic."""
        atst = Template('<table><tr class="tr1"><td id="td1" align="left"/><td id="td2"/></tr></table>')
        self.assertEqual(atst['tr1']['td1']['align'], 'left')

    def test_attribute_set_key_noauto(self):
        """Tests setting attributes via key w/o automagic."""
        atst = Template('<table><tr class="tr1"><td id="td1" align="left"/><td id="td2"/></tr></table>', False)
        atst['tr1']['td1']['align'] = 'right'
        self.assertEqual(atst['tr1']['td1']['align'], 'right')

    def test_attribute_set_key_noauto_dict(self):
    ...
    def test_field_attribute_delete_key(self):
        """Tests deletion of field XML attributes via key."""
        atst = Template('<html><body><p align="left" id="content"></p></body></html>')
        del atst.content['align']
        self.assertEqual(False, hasattr(atst.content, 'align'))

    def test_subfield_attribute_delete_key(self):
    ...
    def test_attribute_iter(self):
        ...
        self.assertEqual(['align', 'id'], test)
    ...
    def test_attribute_contains_not(self):
        """Tests if an attribute is in a field or not."""
        atst = Template('<table><tr class="tr1"><td id="td1" align="left"/><td id="td2"/></tr></table>')
    ...
    def test_update(self):
        ...
        final = '<head><link href="thing.css" id="test" type="text/css" /></head>'
    ...
    def test_field_purge(self):
        """Tests if an XML attribute is purged from a field or not."""
        final = '<body><a /><tr class="grouptest"><td id="groupfield1" /><td id="groupfield2" /></tr></body>'
        self.subcombotest.fieldtest.purge('href', 'id')
        self.assertEqual(final, self.subcombotest.pipe())

    def test_subfield_purge(self):
        """Tests if an XML attribute is purged from a field or not."""
        final = '<body><a href="atest" id="fieldtest" /><tr class="grouptest"><td /><td id="groupfield2" /></tr></body>'
        self.subcombotest.grouptest.groupfield1.purge('id')
        self.assertEqual(final, self.subcombotest.pipe())

    def test_root_nomarks(self):
    ...
    def test_atemplate_string_template(self):
    ...
    def test_atemplate_source_interpolation(self):
        """Tests getting attribute template from inline text in the source."""
        final = '<body><p id="content" title="This run is a test." /></body>'
        atst = Template('<body><p id="content" title="This %(t1)s is a %(t2)s" /></body>')
        atst.content.update({'title': {'t1': 'run', 't2': 'test.'}})
        self.assertEqual(final, atst.render())

    def test_atemplate_source_string_template(self):
        """Tests getting attribute template from inline text in the source."""
        final = '<body><p id="content" title="This run is a test." /></body>'
        atst = Template('<body><p id="content" title="This $t1 is a $t2" /></body>')
        atst.content.update({'title': {'t1': 'run', 't2': 'test.'}})
        self.assertEqual(final, atst.render())

    def test_atemplate_wrongtype(self):
    ...
    def test_atemplate_nodelimiter(self):
        """Tests substituting inline attribute text."""
    ...
    def test_auto_auto_off_attribute(self):
        """Tests if auto turns off magical attributes for attributes."""
        atst = Template('<html><head><title id="title" style="style" /></head><body><p id="content" /></body></html>', False)
    ...
    def test_templates(self):
        ...
        final = '<body><a href="caliban.html#test" id="fieldtest" title="This link goes to test">This template is a first test.</a><a href="caliban.html#linktest" id="fieldtest" title="This link goes to Link Test">This other template is a link test.</a><tr class="grouptest"><td align="left" id="groupfield1" title="This column is column first">This first test is the first column.</td><td align="right" id="groupfield1" title="This col is column second">This second test is the second column.</td><td align="left" id="groupfield2" title="This test is next.">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
        self.subcombotest.templates({'grouptest': {'groupfield1': {'text': 'This %(one)s is the %(num)s column.', 'attrib': {'title': 'This %(one)s is column %(num)s'}}, 'groupfield2': {'text': 'This $test is a $fill.', 'attrib': {'title': 'This %(one)s is next.'}}}, 'fieldtest': {'text': 'This %(run)s is a %(test)s.', 'attrib': {'href': 'caliban.html#%(link)s', 'title': 'This link goes to %(other)s'}}})
        self.subcombotest %= {'grouptest': {'groupfield1': {'sub': ({'text': {'one': 'first test', 'num': 'first'}, 'attrib': {'align': 'left', 'title': {'one': 'column', 'num': 'first'}}}, {'text': 'This second test is the second column.', 'attrib': {'align': 'right', 'title': {'one': 'col', 'num': 'second'}}})}, 'groupfield2': {'sub': ({'text': 'This test is first.', 'attrib': {'align': 'left', 'title': {'one': 'test'}}}, {'text': {'test': 'coltest', 'fill': 'next'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}}, 'fieldtest': {'sub': ({'text': {'test': 'first test', 'run': 'template'}, 'attrib': {'href': {'link': 'test'}, 'title': {'other': 'test'}}}, {'text': {'test': 'link test', 'run': 'other template'}, 'attrib': {'href': {'link': 'linktest'}, 'title': {'other': 'Link Test'}}})}}
        self.assertEqual(final, self.subcombotest.pipe())

    def test_templates_mixin(self):
        """Tests batch addition of templates to a root Template."""
        final = '<body><a href="atest" id="fieldtest" /><tr class="grouptest"><td align="left" id="groupfield1" title="This column is column first">one</td><td align="right" id="groupfield1" title="This col is column second">This second test is the second column.</td><td id="groupfield2">This test is first.</td><td id="groupfield2">This coltest is a next.</td></tr></body>'
        self.subcombotest.grouptest.templates({'groupfield1': {'attrib': {'title': 'This %(one)s is column %(num)s'}}, 'groupfield2': {'text': 'This $test is a $fill.'}})
        self.subcombotest.grouptest %= {'groupfield1': {'sub': ({'text': 'one', 'attrib': {'align': 'left', 'title': {'one': 'column', 'num': 'first'}}}, {'text': 'This second test is the second column.', 'attrib': {'align': 'right', 'title': {'one': 'col', 'num': 'second'}}})}, 'groupfield2': {'sub': ({'text': 'This test is first.'}, {'text': {'test': 'coltest', 'fill': 'next'}})}}
        self.assertEqual(final, self.subcombotest.pipe())

    def test_templates_toomany(self):
        """Raises TypeError if too many templates."""

        def tempfunc():
            """Stub"""
            self.subcombotest.grouptest.templates({'groupfield1': {'attrib': {'title': 'This %(one)s is column %(num)s'}}, 'groupfield2': {'text': 'This $test is a $fill.'}, 'groupfield3': {'text': 'This $test is a $fill.'}})

        self.assertRaises(TypeError, tempfunc)

    def test_templates_wrongtype(self):
        """Raises TypeError if wrong type passed to templates."""

        def tempfunc():
            """Stub"""
            self.subcombotest.grouptest.templates([{'title': 'This %(one)s is column %(num)s'}, {'text': 'This $test is a $fill.'}, {'text': 'This $test is a $fill.'}])
    ...
    def test_template_from_src_string_template(self):
    ...
    def test_template_from_src_interpolation(self):
        """Tests a template passed in with markup with the Template source."""
        final = '<body><p id="stuff">This run is a test.</p></body>'
        ast = Template('<body><p id="stuff">This %(tst1)s is a %(tst2)s</p></body>')
        ast.stuff.text = {'tst1': 'run', 'tst2': 'test.'}
        self.assertEqual(final, ast.render())

    def test_template_nodelimiter(self):
        """Tests setting an inline template with no delimiter"""

        def tempfunc():
            self.gentemplate.content.template = 'This is a place'

        self.assertRaises(TypeError, tempfunc)

    def test_template_wrongtype(self):
        """Tests setting an inline template with the wrong type"""

        def tempfunc():
            self.gentemplate.content.template = [
             'This is a place']

        self.assertRaises(TypeError, tempfunc)

    def test_template_text_interpolation(self):
    ...
    def test_template_text_string_template(self):
    ...
    def test_group_append_element(self):
        """Tests appending an element to a group."""
        final = '<table><tr class="tr1"><td id="td1" /><td id="td2" /><p /></tr></table>'
    ...
    def test_exclude_live(self):
        ...
        testfilter = Template('<table><tr class="tr1"><td id="td1" /><td id="td2" /></tr><p id="r" /></table>')
    ...
    def test_exclude_group(self):
        ...
        a = Template()
        a.exclude('td1', 'td2')
        a.fromstring('<table><tr class="tr1"><td id="td1" /><td id="td2" /></tr><p id="r" /></table>')
        self.assertEqual(True, len(a) == 1)
    ...
    def test_include_wrongtype(self):
        ...
        def tempfunc():
            self.agrouptest.include(['eeee'])

        self.assertRaises(TypeError, tempfunc)

    def test_group_under_group_proc(self):
        """Tests proper group within group processing."""
        testfilter = Template('<div><table class="thing"><th id="thing2" /><tr class="tr1"><td id="td1" /><td id="td2" /></tr></table></div>')
        self.assertEqual(False, hasattr(testfilter.thing, 'td1'))

    def test_group_under_group_proc2(self):
    ...
    def test_htmltemplate_output_xhtml11(self):
    ...
    def test_wsgitemplate(self):
        ...
        final = [
         '<html><head /><body><p id="test">Hello world!\n</p></body></html>']
        ...
        app = WSGITemplate(simple_app, source)
        self.assertEqual(app({}, fake_response), final)
        return

    def test_wsgihtmltemplate(self):
        ...
        app = WSGIHTMLTemplate(simple_app, source)
        self.assertEqual(app({}, fake_response), final)
        return

    def test_wsgihtmltemplate_xhtml10(self):
        """Tests for correct XHTML 1.0 output."""
        final = [
        ...
        app = WSGIHTMLTemplate(simple_app, source, format='xhtml10')
        self.assertEqual(app({}, fake_response), final)
        return

    def test_wsgihtmltemplate_xhtml11(self):
        """Tests for correct XHTML 1.1 output."""
        final = [
         '<?xml version="1.0" encoding="utf-8"?>\n<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">\n<html><head /><body><p id="test">Hello world!\n</p></body></html>']
        source = '<html><head/><body><p id="test"/></body></html>'
        ...
        app = WSGIHTMLTemplate(simple_app, source, format='xhtml11')
        self.assertEqual(app({}, fake_response), final)
        return

    def test_wsgihtmltemplate_isstring(self):
    ...
    def test_wsgitemplate_isstring(self):
    ...
    def test_pickle(self):
        test = '<body><a href="atest" id="fieldtest" /><tr class="grouptest"><td id="groupfield1" /><td id="groupfield2" /></tr></body>'
    ...
    def html_pickle(self):
        test = '<html><head><link href="test.css" type="text/css"><title id="title"><body><p id="content"></body></head></html>'
