...
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/util/models.py
...
class AutomatonVersion(object):
    ...
    def json(self):
        return {'approvalStatus':self.approvalStatus, 
         'archived':self.archived, 
...
class ExportedAutomaton(BaseObject):
    ...
    def json(self):
        return {'automatonConnectionGroups':self.automatonConnectionGroups, 
