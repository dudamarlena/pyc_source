...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/porter2stemmer/porter2stemmer.py
# Compiled at: 2016-03-31 07:15:27
import sys, re
...
class Porter2Stemmer(object):
    ...
    def replace_suffixes_3(self, word):
        ...
        """
        length = len(word)
        replacements = {'tional': 'tion', 'enci': 'ence', 'anci': 'ance', 'abli': 'able', 
           'entli': 'ent', 'ization': 'ize', 'izer': 'ize', 
           'ation': 'ate', 'ator': 'ate', 'alism': 'al', 'aliti': 'al', 
           'alli': 'al', 'fulness': 'ful', 'ousness': 'ous', 
           'ousli': 'ous', 'iveness': 'ive', 'iviti': 'ive', 
    ...
    def replace_suffixes_4(self, word):
        ...
        """
        length = len(word)
        replacements = {'ational': 'ate', 'tional': 'tion', 'alize': 'al', 'icate': 'ic', 
