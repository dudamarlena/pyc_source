...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pifi/MusicController.py
# Compiled at: 2014-10-29 22:23:56
...
logging.basicConfig(level=logging.INFO, format='%(asctime)s %(levelname)s %(module)s.%(funcName)s: %(message)s', filename='/var/log/pifi.log', filemode='w')
