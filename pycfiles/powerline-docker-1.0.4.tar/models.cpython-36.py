...
# Embedded file name: /home/cleber/.pyenv/versions/3.6.2/lib/python3.6/site-packages/powerlibs/django/restless/models.py
# Compiled at: 2017-10-17 11:37:06
...
def serialize_deprecated(src, fields=None, related=None):
    ...
    """
    if isinstance(src, models.Manager) or isinstance(src, models.query.QuerySet):
...
def serialize(src, fields=None, related=None, include=None, exclude=None, fixup=None):
    ...
    if related is not None:
        ...
        if isinstance(src, list) or isinstance(src, models.query.QuerySet) or isinstance(src, set):
