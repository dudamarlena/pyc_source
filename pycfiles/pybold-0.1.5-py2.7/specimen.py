...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pybold/specimen.py
# Compiled at: 2016-03-11 22:15:13
"""
...
import pybold.sequence, pybold.tracefile
...
class SpecimensClient(Endpoint):
    ...
    def get(self, taxon=None, ids=None, bins=None, containers=None, institutions=None, researchers=None, geo=None, timeout=5):
        ...
        result = super(SpecimensClient, self).get({'taxon': taxon, 'ids': ids, 
           'bin': bins, 
