...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pybold/tracefile.py
# Compiled at: 2016-03-11 22:01:32
"""
...
:license: LGPL v3
"""
import StringIO, os.path, tarfile
from pybold import Endpoint, PUBLIC_API_URL
import pybold.sequence, pybold.specimen
    ...
    def parse_from_tar(file_name=None, tar_string=None):
        ...
        for row in fileobj.readlines():
            ...
            if len(row_traceinfo) != 5:
                continue
            tracefiles_d[row_traceinfo[0]] = {'process_id': row_traceinfo[0], 'taxon': row_traceinfo[1], 
        ...
        for member in chromat_tar.getmembers():
            ...
            if not process_id:
                raise ValueError()
            tracefile_list.append(Tracefile(process_id, fileobj, tracefiles_d[process_id]['marker'], tracefiles_d[process_id]['taxon'], tracefiles_d[process_id]['genbank_accession'], member.name))
...
class TracefilesClient(Endpoint):
    ...
    def get(self, taxon=None, ids=None, bins=None, containers=None, institutions=None, researchers=None, geo=None, marker=None, timeout=5):
        ...
        result = super(TracefilesClient, self).get({'taxon': taxon, 
           'ids': ids, 
           'bin': bins, 
