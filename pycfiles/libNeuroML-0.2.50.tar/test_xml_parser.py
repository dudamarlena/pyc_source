...
# [GCC 8.4.0]
# Embedded file name: /home/padraig/libNeuroML/neuroml/test/test_xml_parser.py
...
class TestNeuroMLXMLParser(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        for f in ['simplenet.nml', 'testh5.nml', 'pyr_4_sym.cell.nml', 'MediumNet.net.nml', 'complete.nml']:
            ...
            nml_doc0 = loaders.read_neuroml2_file(file_name, include_includes=True, verbose=True)
