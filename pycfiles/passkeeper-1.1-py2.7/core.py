...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/passkeeper/core.py
# Compiled at: 2013-07-30 21:07:43
...
pwd_table = Table('gaodapwd', metadata, Column('where', String, primary_key=True), Column('user', String), Column('pwd', String))
