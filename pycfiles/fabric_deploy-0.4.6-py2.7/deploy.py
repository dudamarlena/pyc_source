...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fabric_deploy/deploy.py
# Compiled at: 2012-07-29 23:07:50
from __future__ import with_statement
import sys, os
from fabric.api import *
from fabric.decorators import *
from fabric.colors import *
import fabric.state, logging, StringIO, options
...
def setup():
    with settings(warn_only=True):
        dirs = [
         fetch('deploy_to'), fetch('releases_path'), fetch('shared_path')]
