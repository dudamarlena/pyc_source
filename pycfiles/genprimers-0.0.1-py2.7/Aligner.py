...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/lib/Probe/Sequence/Aligner.py
# Compiled at: 2017-03-25 19:38:30
...
def align_seqs(probes, indexed_fasta):
    ...
    for probe_id in probes:
        fasta_handler.write(probes[probe_id].to_fasta(add_info=False, sdss=True) + '\n')

    fasta_handler.close()
    bowtie_cmd = 'bowtie -v 0 -f -k 80 --suppress 5,6,7 ' + indexed_fasta + ' ' + tmp_fasta + "| sort -k1,1 -k2,2 | sed 's/:.>.//g'"
