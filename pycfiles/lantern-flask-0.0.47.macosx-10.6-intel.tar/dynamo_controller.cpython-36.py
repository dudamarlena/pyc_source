...
# [GCC 8.4.0]
# Embedded file name: /Users/jceciliano/coding/Lantern/lantern-flask/.virtualenv/lib/python3.6/site-packages/lantern_flask/controllers/dynamo_controller.py
# Compiled at: 2018-11-30 18:30:16
...
class ExceptionInvalidDynamoControllerType(Exception):
    __doc__ = ' Dynamo Type Not defined, this is a programming error '


class ExceptionInvalidDynamoControllerNotFound(Exception):
    __doc__ = ' Object not found in DB (404 error) '


class DynamoController(object):
    __doc__ = ' Generic Dynamo Access Controller\n        - Error handling\n        - response message/data normalization\n    '
    TYPE_GET = 'get'
    TYPE_CREATE = 'create'
    TYPE_UPDATE = 'update'
    TYPE_DELETE = 'delete'
        ...
        try:
            if type == self.TYPE_GET:
                ...
                if type == self.TYPE_UPDATE:
                    data = json_float_to_decimal(data)
                    d_res = self.table.update_item(Key=primary_keys,
                ...
                if type == self.TYPE_FILTER:
                    ...
                    if return_raw:
                        ...
                        return http_response(code=code, message='Filtered', data=data, count=count, next=next)
