...
# Embedded file name: /Users/denny/project/picme/aiommy/build/lib/tests/test_auth/test_handlers.py
# Compiled at: 2017-11-20 03:41:06
# Size of source mod 2**32: 8349 bytes
import io, json, unittest
from unittest import mock
from urllib import error
from aiommy.auth.handlers import ApiDeprecatedError, FacebookDispatcher, GoogleDispatcher, OAuthException, OAuthGateway, OAuthProfile
...
class OtherOAuthGatewayTestCase(unittest.TestCase):
    ...
    def test_make_request_ok(self):
        ...
        expected = 'response'
        with mock.patch.object((self.gateway), '_send_request',
    ...
    def test_make_request_oauth_exception(self):
        ...
        def send_request(request):
            raise error.HTTPError(self.url, 400, 'msg', {}, io.BytesIO('msg'))
...
class OAuthProfileTestCase(unittest.TestCase):
    ...
    def test_profile(self):
        expected = dict(oauth_id='oauth_id',
...
class FacebookDispatcherTestCase(unittest.TestCase):
    ...
    def test_me(self):
        ...
        with mock.patch.object((self.dispatcher), '_fetch_profile',
          return_value=data) as (mocked_fetch):
            with mock.patch.object((self.dispatcher), 'normalize',
    ...
    def test_normalize(self):
        ...
        profile = dict(oauth_id='oauth_id',
          first_name='first_name',
          last_name='last_name',
          email='email',
    ...
    def test_oauth_exception(self):
        ...
        with mock.patch.object((self.dispatcher.oauth_gateway), '_send_request',
    ...
    def test_api_deprecated_error(self):
        ...
        access_token = 'access_token'
        with mock.patch.object((self.dispatcher), '_fetch_id',
...
class GoogleDispatcherTestCase(unittest.TestCase):
    ...
    def test_oauth_exception_message(self):
        ...
        def raiser(req):
            raise error.HTTPError('url', 400, 'msg', {}, io.BytesIO('ANY MESSAGE'))
