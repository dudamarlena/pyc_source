...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/actioncli/multi.py
...
from zensols.actioncli import Stash, Configurable, PreemptiveStash, StashFactory, chunks
