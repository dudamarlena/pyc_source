...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python3.4/site-packages/dccpi/dcc_rpi_encoder.py
# Compiled at: 2016-12-11 09:40:36
...
import dcc_rpi_encoder_c, operator
...
class DCCRPiEncoder(DCCEncoder):
    ...
    def __init__(self, bit_one_part_min_duration=55, bit_one_part_max_duration=61, bit_one_part_duration=58, bit_zero_part_min_duration=95, bit_zero_part_max_duration=9900, bit_zero_part_duration=100, packet_separation=5):
        """
        ...
        """
        DCCEncoder.__init__(self, bit_one_part_min_duration, bit_one_part_max_duration, bit_one_part_duration, bit_zero_part_min_duration, bit_zero_part_max_duration, bit_zero_part_duration, packet_separation)
    ...
    def payload(self, packets):
        ...
        bitstrings = map(operator.methodcaller('to_bit_string'), packets)
    ...
    def send_bit_string(self, bit_string, times):
        ...
        """
        return dcc_rpi_encoder_c.send_bit_array(bit_string, times, self.bit_one_part_duration, self.bit_zero_part_duration, self.packet_separation)
