...
# [GCC 8.4.0]
# Embedded file name: /Users/jordansuchow/Dropbox/Berkeley/Projects/Current/Wallace/wallace/experiments.py
...
class Experiment(object):
    ...
    def fail_participant(self, participant):
        ...
        participant_nodes = Node.query.filter_by(participant_id=participant.id, failed=False).all()
