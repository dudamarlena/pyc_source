...
# Embedded file name: build/bdist.linux-x86_64/egg/pynomer/pynomer.py
# Compiled at: 2020-02-13 10:36:37
...
class NomerClient:
    ...
    def __init__(self, base_url):
        ...
        Usage::
            ...
            client = NomerClient(base_url="http://localhost:5000/version")
        """
    ...
    def replace(self, id='', name='', matcher='globi-taxon-cache', p=None):
        ...
        """
        res = self.run_nomer(nomer_cmd='replace',
          id=id,
          name=name,
          matcher=matcher,
    ...
    def append(self, id='', name='', matcher='globi-taxon-cache', p=None, o='tsv'):
        ...
        """
        res = self.run_nomer(nomer_cmd='append',
          id=id,
          name=name,
          matcher=matcher,
          p=(self.get_properties(p)),
