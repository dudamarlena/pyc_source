...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/snipsmanagercore/server.py
...
class Server:
    ...
    def __init__(self, mqtt_hostname, mqtt_port, tts_service_id, locale, registry, handle_intent, handlers_dialogue_events=None, handle_start_listening=None, handle_done_listening=None, logger=None):
        """ Initialisation.
    ...
    def start_blocking(self, run_event):
        ...
        """
        topics = [
         ('hermes/intent/#', 0), ('hermes/hotword/#', 0), ('hermes/asr/#', 0), ('hermes/nlu/#', 0),
         ('snipsmanager/#', 0)]
