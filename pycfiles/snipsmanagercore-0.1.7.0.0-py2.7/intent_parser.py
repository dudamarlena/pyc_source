...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/snipsmanagercore/intent_parser.py
    ...
    def get_slot_value(payload, slot_name):
        ...
        for slot in slots:
            ...
            if kind == 'InstantTime':
                ...
                result.append(IntentParser.get_dict_value(slot, ['value', 'value', 'value']) or IntentParser.get_dict_value(slot, ['value', 'value']))
