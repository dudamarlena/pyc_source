    ...
    try:
        ...
        if not renderer.isRaw():
            ...
            if 'contentonly' in db_web_support.req.form:
                ...
                return [
                 db_web_support.req.return_page()]
            ...
            if 'ajax' in db_web_support.req.form:
                return [renderer.getContent(), db_web_support.req.response_headers, db_web_support.req.status]
        ...
        import traceback, StringIO, cgi, socket
        ...
        if 'ajax' in db_web_support.req.form:
            return [
             '500 Internal Server Error', db_web_support.req.response_headers]
        inputstring = ''
