...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyfmi/common/core.py
# Compiled at: 2018-12-15 16:31:42
"""
Module containing base classes and functionality.
"""
import zipfile, tempfile, platform as PL, os, sys, shutil, numpy as N, numpy.ctypeslib as Nct
...
class ModelBase(object):
    ...
    def set(self, variable_name, value):
        ...
        if isinstance(variable_name, basestring):
            ...
            for i in xrange(len(variable_name)):
    ...
    def _exec_simulate_algorithm(self, start_time, final_time, input, module, algorithm, options):
        """ 
        Helper function which performs all steps of an algorithm run which are 
...
def get_files_in_archive(path):
    ...
    """
    files = {'root': path, 'model_desc': None, 'image': None, 'documentation_dir': None, 
       'sources_dir': None, 'binaries_dir': None, 
       'resources_dir': None}
...
class Trajectory:
    ...
    def __init__(self, abscissa, ordinate, tol=1e-08):
        """
