...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/file/tests/test_filedocstrings.py
# Compiled at: 2012-06-20 11:31:01
"""
Generic Test case for ztfy.file doc strings
"""
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        location = 'ztfy.ztfy.file.%s' % test
