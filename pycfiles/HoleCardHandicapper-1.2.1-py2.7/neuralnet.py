...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/holecardhandicapper/model/neuralnet.py
# Compiled at: 2016-12-07 11:20:31
...
class Neuralnet(object):
    ...
    def predict(self, hole, community=[]):
        ...
        if hole_ids == self.cache_holecard_ids and community_ids == self.cache_communitycard_ids:
            if self.debugmode:
                self.__print_cache_hit_log(hole, community)
