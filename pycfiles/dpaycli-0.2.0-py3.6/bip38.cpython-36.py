...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dpaycligraphenebase/bip38.py
...
def encrypt(privkey, passphrase):
    ...
    payload = b'\x01B\xc0' + salt + encrypted_half1 + encrypted_half2
