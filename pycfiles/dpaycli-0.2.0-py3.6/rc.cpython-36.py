...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dpaycli/rc.py
# Compiled at: 2018-10-15 03:18:37
...
from dpaycli.constants import state_object_size_info
import hashlib
...
class RC(object):
    ...
    def get_tx_size(self, op):
        ...
        tx = Signed_Transaction(ref_block_num=ref_block_num, ref_block_prefix=ref_block_prefix,
    ...
    def comment(self, tx_size=1000, permlink_length=10, parent_permlink_length=10):
        ...
        return self.dpay.get_rc_cost(resource_count)
