...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dpaycli/imageuploader.py
# Compiled at: 2018-10-15 00:30:09
# Size of source mod 2**32: 2682 bytes
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
from __future__ import unicode_literals
import logging, json, io, collections, hashlib
from binascii import hexlify, unhexlify
import requests
from .instance import shared_dpay_instance
from dpaycli.account import Account
from dpaycligraphenebase.py23 import integer_types, string_types, text_type, py23_bytes
from dpaycligraphenebase.account import PrivateKey
from dpaycligraphenebase.ecdsasig import sign_message, verify_message

class ImageUploader(object):

    def __init__(self, base_url='https://dsiteimages.com', challenge='ImageSigningChallenge', dpay_instance=None):
