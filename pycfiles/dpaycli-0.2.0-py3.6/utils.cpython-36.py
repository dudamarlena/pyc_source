...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dpaycli/utils.py
# Compiled at: 2018-10-15 03:12:23
# Size of source mod 2**32: 9197 bytes
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
from __future__ import unicode_literals
from builtins import next
import re, time as timenow, math
...
def resolve_authorperm(identifier):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            >>> from dpaycli.utils import resolve_authorperm
            >>> author, permlink = resolve_authorperm('https://dvideo.io/#!/v/pottlund/m5cqkd1a')
            >>> author, permlink = resolve_authorperm("https://dsite.io/witness-category/@gtg/24lfrm-gtg-witness-log")
            >>> author, permlink = resolve_authorperm("@gtg/24lfrm-gtg-witness-log")
            >>> author, permlink = resolve_authorperm("https://dsocial.io/@gtg/24lfrm-gtg-witness-log")
...
def construct_authorperm(*args):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            >>> from dpaycli.utils import construct_authorperm
...
def construct_authorpermvoter(*args):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            >>> from dpaycli.utils import construct_authorpermvoter
