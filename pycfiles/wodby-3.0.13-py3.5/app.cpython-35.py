...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/app.py
# Compiled at: 2020-04-12 05:03:52
# Size of source mod 2**32: 7904 bytes
"""
    Wodby API Client
...
class App(object):
    ...
    def __init__(self, created=None, git_repo_id=None, id=None, name=None, org_id=None, status=None, title=None, updated=None):
