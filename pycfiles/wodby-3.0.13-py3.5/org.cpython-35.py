...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/org.py
...
class Org(object):
    ...
    def __init__(self, created=None, id=None, name=None, status=None, title=None, updated=None):
    ...
    def status(self, status):
        ...
        allowed_values = [
         'ok', 'error', 'creating', 'updating', 'deleting']
