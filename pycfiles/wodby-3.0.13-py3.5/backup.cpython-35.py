...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/backup.py
...
class Backup(object):
    ...
    def __init__(self, created=None, files=None, id=None, instance_id=None, org_id=None, spent=None, status=None, type=None, updated=None):
