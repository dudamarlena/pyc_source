...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/request_instance_create.py
...
class RequestInstanceCreate(object):
    ...
    def __init__(self, app_id=None, git=None, name=None, post_deployment=None, server_id=None, title=None, type=None):
        """RequestInstanceCreate - a model defined in Swagger"""
        self._app_id = None
        self._git = None
        self._name = None
    ...
    def name(self, name):
        ...
        if name is not None and not re.search('^[a-z0-9][a-z0-9-]{0,18}[a-z0-9]$', name):
            raise ValueError('Invalid value for `name`, must be a follow pattern or equal to `/^[a-z0-9][a-z0-9-]{0,18}[a-z0-9]$/`')
        self._name = name
