...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/request_stacks_update.py
...
class RequestStacksUpdate(object):
    ...
    swagger_types = {'stacks': 'list[str]'}
    attribute_map = {'stacks': 'stacks'}

    def __init__(self, stacks=None):
        """RequestStacksUpdate - a model defined in Swagger"""
        self._stacks = None
