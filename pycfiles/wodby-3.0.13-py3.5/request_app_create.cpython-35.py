...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/request_app_create.py
...
class RequestAppCreate(object):
    ...
    swagger_types = {'deployment_type': 'str', 
     'docroot': 'str', 
     ...
     'stack_id': 'str', 
     'title': 'str'}
    attribute_map = {'deployment_type': 'deployment_type', 
     'docroot': 'docroot', 
     'git': 'git', 
    ...
    def __init__(self, deployment_type='vanilla', docroot=None, git=None, instance_name=None, instance_title=None, instance_type=None, name=None, org_id=None, post_deployment=None, server_id=None, services=None, sitename=None, stack_id=None, title=None):
        """RequestAppCreate - a model defined in Swagger"""
    ...
    def deployment_type(self, deployment_type):
        ...
        if deployment_type not in allowed_values:
            raise ValueError('Invalid value for `deployment_type` ({0}), must be one of {1}'.format(deployment_type, allowed_values))
    ...
    def instance_name(self, instance_name):
        ...
        :type: str
        """
        if instance_name is not None and not re.search('^[a-z0-9][a-z0-9-]{0,18}[a-z0-9]$', instance_name):
            raise ValueError('Invalid value for `instance_name`, must be a follow pattern or equal to `/^[a-z0-9][a-z0-9-]{0,18}[a-z0-9]$/`')
    ...
    def name(self, name):
        ...
        if name is not None and not re.search('^[a-z0-9][a-z0-9-]{0,28}[a-z0-9]$', name):
            raise ValueError('Invalid value for `name`, must be a follow pattern or equal to `/^[a-z0-9][a-z0-9-]{0,28}[a-z0-9]$/`')
        self._name = name
