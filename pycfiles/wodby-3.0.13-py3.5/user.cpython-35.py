...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/user.py
# Compiled at: 2020-04-12 05:03:52
# Size of source mod 2**32: 6928 bytes
"""
    Wodby API Client
...
class User(object):
    ...
    def __init__(self, created=None, email=None, first_name=None, id=None, last_name=None, name=None, updated=None):
