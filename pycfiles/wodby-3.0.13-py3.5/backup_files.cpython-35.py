...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/backup_files.py
...
class BackupFiles(object):
    ...
    def __init__(self):
        """BackupFiles - a model defined in Swagger"""
    ...
    def to_dict(self):
        ...
        if issubclass(BackupFiles, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupFiles):
            return False
