...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/git_repo.py
# Compiled at: 2020-04-12 05:03:52
# Size of source mod 2**32: 7248 bytes
"""
    Wodby API Client
...
class GitRepo(object):
    ...
    def __init__(self, created=None, id=None, org_id=None, status=None, title=None, updated=None, url=None):
        """GitRepo - a model defined in Swagger"""
        self._created = None
        self._id = None
        self._org_id = None
        self._status = None
