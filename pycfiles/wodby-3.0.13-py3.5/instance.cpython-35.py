...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/instance.py
...
class Instance(object):
    ...
    def __init__(self, app_id=None, created=None, git_repo_id=None, git_repo_target=None, has_new_version=None, id=None, name=None, org_id=None, status=None, title=None, type=None, updated=None):
    ...
    def status(self, status):
        ...
        allowed_values = [
         'ok', 'unreachable', 'error', 'creating', 'updating', 'deleting']
