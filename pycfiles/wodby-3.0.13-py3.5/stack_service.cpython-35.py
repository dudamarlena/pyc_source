...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/stack_service.py
...
class StackService(object):
    ...
    def __init__(self, default=None, id=None, implementations=None, name=None, required=None, title=None):
        """StackService - a model defined in Swagger"""
        self._default = None
        self._id = None
