...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/api_client.py
# Compiled at: 2020-04-12 05:03:52
# Size of source mod 2**32: 24952 bytes
"""
    Wodby API Client
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None):
        ...
        self.cookie = cookie
        self.user_agent = 'Swagger-Codegen/3.0.13/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if data is None:
            ...
            if type(klass) == str:
                ...
                klass = getattr(wodby.models, klass)
    ...
    def __deserialize_model(self, data, klass):
        ...
        :return: model object.
        """
        if not klass.swagger_types and not self._ApiClient__hasattr(klass, 'get_real_child_model'):
            return data
        kwargs = {}
