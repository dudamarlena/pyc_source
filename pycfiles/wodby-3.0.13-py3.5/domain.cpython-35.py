...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/domain.py
# Compiled at: 2020-04-12 05:03:52
# Size of source mod 2**32: 15774 bytes
"""
    Wodby API Client
...
class Domain(object):
    ...
    def __init__(self, created=None, enabled=None, hsts=None, hsts_subdomains=None, id=None, indexed=None, instance_id=None, name=None, org_id=None, primary=None, protected=None, redirect_to_non_www=None, redirect_to_www=None, ssl=None, ssl_custom=None, ssl_required=None, status=None, type=None, updated=None):
    ...
    def status(self, status):
        ...
        allowed_values = [
         'ok', 'error', 'creating', 'deleting', 'updating', 'disabled']
