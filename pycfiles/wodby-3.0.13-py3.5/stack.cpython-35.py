...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/stack.py
...
class Stack(object):
    ...
    def __init__(self, created=None, id=None, new_version=None, org_id=None, revision_number=None, services=None, title=None, updated=None, version=None):
