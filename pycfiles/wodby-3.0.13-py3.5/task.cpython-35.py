...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wodby/models/task.py
...
class Task(object):
    ...
    def __init__(self, created=None, end=None, id=None, org_id=None, start=None, status=None, title=None, ttl=None, updated=None):
    ...
    def status(self, status):
        ...
        allowed_values = [
         'waiting', 'in_progress', 'done', 'failed', 'canceled']
