...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/tagger/editors/descriptioneditor.py
...
class DescriptionEditor(taggereditor.TaggerEditor, object):
    ...
    def fill_tag_node(self, tag_data_node, *args, **kwargs):
        ...
        tp.Dcc.set_string_attribute_value(node=tag_data_node,
          ...
          attribute_value=(self._description_text.toPlainText()))
