...
# [GCC 8.4.0]
# Embedded file name: /Users/raymond/Projects/TutorGen/python-client/env/lib/python3.4/site-packages/hpitclient/requests_mixin.py
# Compiled at: 2014-10-29 15:05:00
...
class RequestsMixin:
    ...
    def connect(self, retry=True):
        ...
        self._post_data('connect', {'entity_id': self.entity_id, 
         'api_key': self.api_key}, retry=retry)
        self.connected = True
    ...
    def disconnect(self, retry=True):
        ...
        self._post_data('disconnect', {'entity_id': self.entity_id, 
         'api_key': self.api_key}, retry=retry)
        self.connected = False
