...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/invsearch-project/invsearch/inv_index.py
# Compiled at: 2018-11-03 15:21:56
# Size of source mod 2**32: 6383 bytes
"""
...
class InvIndex(object):
    ...
    def find(self, **filters):
        ...
        if len(pk_columns):
            key = pk_columns.pop()
            return [
             self._data[self._index[key][filters[key]]]]
        else:
            set_list = list()
