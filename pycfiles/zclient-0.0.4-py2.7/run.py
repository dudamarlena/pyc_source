...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/zclient/bin/run.py
...
def main():
    ...
    if all_options.getevents:
        ...
        for e in filters.events_display(events, get_props(all_settings, all_options.displayfilter)):
            print e
