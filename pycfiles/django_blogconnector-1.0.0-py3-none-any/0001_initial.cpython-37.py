...
# [GCC 8.4.0]
# Embedded file name: C:\Users\vryhofa\workspace\django-wordpress-rss\htdocs\django_blogconnector\migrations\0001_initial.py
# Compiled at: 2019-05-10 10:49:21
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='BlogCategory',
       fields=[
      (
     ...
     migrations.CreateModel(name='BlogSource',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='BlogUser',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='BlogPost',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
