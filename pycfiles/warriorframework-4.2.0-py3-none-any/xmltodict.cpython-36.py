...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/Framework/OSS/xmltodict.py
# Compiled at: 2020-02-05 00:22:48
# Size of source mod 2**32: 17277 bytes
"""
                    ...
                    if not isinstance(v, dict):
                        ...
                        if isinstance(v, _basestring):
                            ...
                            for ik, iv in list(v.items()):
                                if ik == cdata_key:
                                    cdata = iv
                                elif ik.startswith(attr_prefix):
...
if __name__ == '__main__':
    ...
    try:
        root = parse(stdin, item_depth=item_depth,
