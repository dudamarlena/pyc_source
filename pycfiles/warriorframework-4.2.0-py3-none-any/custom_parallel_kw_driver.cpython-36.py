...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/WarriorCore/custom_parallel_kw_driver.py
...
"""
import warrior.WarriorCore.step_driver as step_driver, traceback
...
def main(step_list, data_repository, tc_status, system_name=None):
    ...
    try:
        testcase_status = execute_custom_parallel(step_list, data_repository, tc_status, system_name)
    except Exception:
