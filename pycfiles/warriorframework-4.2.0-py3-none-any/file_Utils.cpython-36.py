...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/Framework/Utils/file_Utils.py
# Compiled at: 2020-02-05 00:22:48
# Size of source mod 2**32: 46223 bytes
"""
...
"""
import datetime, time, os, sys, string, shutil, zipfile
...
def check_extension_get_absolute_path(relative_path, start_directory, list_extn=[
 '.json', '.xml', '.txt']):
    """
...
def open_file(newfile, mode):
    ...
    try:
        ...
        print_info('file {} opened successfully with mode {}'.format(newfile, mode))
    except IOError as e:
        print_error('found io exception {} while opening file {} in mode {}'.format(str(e), newfile, mode))
        return
    except Exception as e:
        print_error('found exception {} while opening file {} in mode {}'.format(str(e), newfile, mode))
        return
...
def readline(fd, **kwargs):
    ...
    try:
        ...
        print_error('found exception {} while reading line in {}'.format(str(e), fd))
        line = False
...
def readlines(fd, **kwargs):
    ...
    try:
        ...
        print_error('found exception {} while reading lines in {}'.format(str(e), fd))
        lines = False
...
def truncate(fd, **kwargs):
    ...
    try:
        ...
        print_error('found exception {} while truncating {}'.format(str(e), fd))
...
def get_current_position(fd):
    ...
    try:
        ...
        print_error('found exception {} while getting current position on {}'.format(str(e), fd))
...
def move_to_position(fd, offset, **kwargs):
    ...
    try:
        ...
        print_error('found exception {} while moving to position on {}'.format(str(e), fd))
...
def move_to_text(fd, pattern, n=1):
    ...
    try:
        ...
        print_info('moving to {}th pattern {} in file {} successful'.format(n, pattern, fd.name))
    except IndexError:
        print_error('pattern {} not found in {}'.format(pattern, fd))
    except ValueError:
        print_error('file is already closed...')
    except Exception as e:
        print_error('exception {} occurred while seeking pattern {} in {}'.format(str(e), pattern, fd))
...
def get_lines_between(fd, startidx, endidx):
    ...
    try:
        ...
        print_error('file has only {} lines, but expecting {} to {} lines'.format(len(all_lines), startidx, endidx))
    except ValueError:
        print_error('file is already closed...')
    except Exception as e:
        print_error('found exception {} while moving to position on {}'.format(str(e), fd))
...
def fileno(fd):
    ...
    try:
        ...
        print_error('found exception {} while getting integer file descriptor of {}'.format(str(e), fd))
...
def isatty(fd):
    ...
    try:
        ...
        print_error('found exception {} while checking atty of {}'.format(str(e), fd))
...
def get_next_line(fd):
    ...
    try:
        ...
        print_error('found exception {} while getting line of {}'.format(str(e), fd))
        line = False
...
def get_file_name(fd):
    ...
    try:
        ...
        print_error('found exception {} while getting file name of {}'.format(str(e), fd))
...
def get_file_mode(fd):
    ...
    try:
        ...
        print_error('found exception {} while getting file mode of {}'.format(str(e), fd))
...
def copyfileobj(fsrc, fdst):
    ...
    try:
        ...
        print_error('copying file {} to file {} raised exception {}'.format(fsrc, fdst, str(e)))
...
def copyfile(src, dst):
    ...
    try:
        ...
        print_error('copying file {} to file {} raised exception {}'.format(src, dst, str(e)))
...
def copymode(src, dst):
    ...
    try:
        ...
        print_info('mode of src {} copied to dst {} successfully'.format(src, dst))
        status = True
    except Exception as e:
        print_error('copying file mode from {} to file {} raised exception {}'.format(src, dst, str(e)))
...
def copystat(src, dst):
    ...
    try:
        ...
        print_info('metadata of src {} copied to dst {} successfully'.format(src, dst))
        status = True
    except Exception as e:
        print_error('copying file stat from {} to file {} raised exception {}'.format(src, dst, str(e)))
...
def copy2(src, dst):
    ...
    try:
        ...
        print_info('src {} copied to dst {} successfully along with metadata'.format(src, dst))
        status = True
    except Exception as e:
        print_error('copying file {} with metadata to file {} raised exception {}'.format(src, dst, str(e)))
...
def move(src, dst):
    ...
    try:
        ...
        print_error('moving file {} to file {} raised exception {}'.format(src, dst, str(e)))
...
def remove(nfile):
    ...
    try:
        ...
        print_error('removing file {} raised exception {}'.format(nfile, str(e)))
