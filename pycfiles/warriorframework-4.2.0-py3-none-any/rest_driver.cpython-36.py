...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/ProductDrivers/rest_driver.py
...
import warrior.Actions.RestActions

def main(keyword, data_repository, args_repository):
    """Import all actions related to rest driver and call the driver Utils
    to execute a keyword """
    package_list = [
     warrior.Actions.RestActions]
