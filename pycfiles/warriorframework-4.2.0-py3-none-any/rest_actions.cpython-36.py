...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/Actions/RestActions/rest_actions.py
# Compiled at: 2020-02-05 00:22:47
# Size of source mod 2**32: 144377 bytes
"""
...
class RestActions(object):
    ...
    def perform_http_post(self, system_name, variable_config=None, request_id=None, url=None, data=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        r"""Perform a http post actions and get the response
        ...
        ** dict-in-tuple pattern **
        ...
        arguments = {'system_name':system_name, 
         'variable_config':variable_config,  'request_id':request_id, 
         'url':url,  'data':data,  'expected_response':expected_response, 
         'headers':headers,  'user':user, 
         'password':password,  'allow_redirects':allow_redirects,  'timeout':timeout, 
         'json':json,  'cookies':cookies,  'files':files, 
         'proxies':proxies,  'verify':verify,  'stream':stream, 
         'cert':cert,  'var_sub':var_sub}
        ...
        for element in arguments:
            if element in ('json', 'data', 'variable_config') and arguments[element] and arguments[element] is not None:
                arguments[element] = Utils.rest_Utils.check_ext_get_abspath(arguments[element], self.tc_path)

        credentials = (Utils.data_Utils.get_user_specified_tag_values_in_tc)(
         (self.datafile), **arguments)
        if credentials['variable_config']:
            if credentials['variable_config'] is not None:
                credentials['variable_config'] = Utils.rest_Utils.check_ext_get_abspath(credentials['variable_config'], os.path.dirname(self.datafile))
        else:
            for element in credentials:
                credentials = Utils.rest_Utils.resolve_credentials_for_rest(credentials, element, self.datafile, system_name)

            credentials['auth'] = (
             credentials['user'], credentials['password'])
            credentials, popped_args = Utils.rest_Utils.remove_invalid_req_args(credentials, ['user', 'password',
             'request_id',
             'variable_config',
             'var_sub', 'json'])
            ...
            for i in range(0, len(popped_args['json'])):
                if popped_args['json'][i] != 'Error':
                    ...
                    for key in credentials:
                        pNote("Sending argument '{0}': {1}".format(key, credentials[key]))
    ...
    def perform_http_get(self, system_name, variable_config=None, request_id=None, url=None, params=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        """
        ...
        arguments = {'system_name':system_name, 
         'variable_config':variable_config,  'request_id':request_id, 
         'url':url,  'params':params,  'expected_response':expected_response, 
         'headers':headers,  'user':user, 
         'password':password,  'allow_redirects':allow_redirects,  'timeout':timeout, 
         'json':json,  'cookies':cookies,  'files':files, 
         'proxies':proxies,  'verify':verify,  'stream':stream, 
    ...
    def perform_http_put(self, system_name, variable_config=None, request_id=None, data=None, url=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        r"""
        Perform a http post actions and get the response
        This keyword uses the warrior recommended Input datafile format for rest
    ...
    def perform_http_patch(self, system_name, variable_config=None, request_id=None, data=None, url=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        r"""
        Perform a http post actions and get the response
        This keyword uses the warrior recommended Input datafile format for rest
    ...
    def perform_http_delete(self, system_name, variable_config=None, request_id=None, data=None, url=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        r"""
        Perform a http post actions and get the response
        This keyword uses the warrior recommended Input datafile format for rest
    ...
    def perform_http_options(self, system_name, variable_config=None, request_id=None, data=None, url=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        r"""
        Perform a http post actions and get the response
        This keyword uses the warrior recommended Input datafile format for rest
    ...
    def perform_http_head(self, system_name, variable_config=None, request_id=None, data=None, url=None, expected_response=None, headers=None, user=None, password=None, allow_redirects=None, timeout=None, json=None, cookies=None, files=None, proxies=None, verify=None, stream=None, cert=None, var_sub=None):
        r"""
        Perform a http post actions and get the response
        This keyword uses the warrior recommended Input datafile format for rest
    ...
    def verify_response(self, system_name, expected_api_response, expected_response_type, comparison_mode, request_id=None, generate_output_diff_file='Yes'):
        """
        ...
        generate_output_diff_file = Utils.rest_Utils.resolve_value_of_verify(generate_output_diff_file)
        try:
            arguments['expected_api_response'] = Utils.rest_Utils.check_ext_get_abspath(arguments['expected_api_response'], self.tc_path)
            credentials = (Utils.data_Utils.get_user_specified_tag_values_in_tc)(
             (self.datafile), **arguments)
            credentials['expected_api_response'] = Utils.rest_Utils.check_ext_get_abspath(credentials['expected_api_response'], os.path.dirname(self.datafile))
            if request_id:
                response = Utils.data_Utils.get_object_from_datarepository('{0}_{1}_api_response_object'.format(system_name, credentials['request_id']))
            else:
                response = Utils.data_Utils.get_object_from_datarepository('{0}_api_response_object'.format(system_name))
        except Exception as exception:
            pNote(exception, 'error')
            return False

        if any([x in credentials['comparison_mode'] for x in ('xpath=', 'jsonpath=',
                                                              'regex=')]) or credentials['comparison_mode'] == '':
            status = self.rest_object.cmp_content_response(self.datafile, system_name, response, credentials['expected_api_response'], credentials['expected_response_type'], credentials['comparison_mode'])
        else:
            status = self.rest_object.cmp_response(response, credentials['expected_api_response'], credentials['expected_response_type'], output_file, credentials['generate_output_diff_file'])
        return status

    def verify_response_in_console_log(self, dict_expected_event_content=None, expected_event_content_filepath=None):
        """
                ...
                if isinstance(value, dict):
                    ...
                    if '${' in value:
                        ...
                        if env_value is None:
                            print_Utils.print_warning('The env variable {} is not presented .so unable to fetch the value '.format(env_var))
                            return False
                        pat = '(\\$\\{.*\\})'
                        value = re.sub(pat, env_value, value)
                    if re.search(key, lines):
                        if re.search(value, lines):
                            continue
                    print_Utils.print_warning('The {}/{} are not presented in the console log'.format(key, value))
                    return False
        ...
        if expected_event_content_filepath:
            ...
            with open(filepath) as (file_obg):
                ...
                if status:
                    ...
                    print_Utils.print_warning('The expected json (file content) event is not found in the console log')
                    return False