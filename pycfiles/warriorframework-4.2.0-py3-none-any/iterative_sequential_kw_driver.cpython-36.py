...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/WarriorCore/iterative_sequential_kw_driver.py
...
def compute_system_resultfile(kw_resultfile_list, resultsdir, system_name):
    ...
    system_results_dir = Utils.file_Utils.createDir(resultsdir, 'System_Results')
    system_resultfile = Utils.file_Utils.getCustomLogFile('system', system_results_dir, system_name, '.xml')
    Utils.testcase_Utils.append_result_files(system_resultfile, kw_resultfile_list,
      dst_root='System')
...
def execute_iterative_sequential(step_list, data_repository, tc_status, system_list):
    ...
    for system in system_list:
        ...
        system_status = Utils.testcase_Utils.compute_status_using_impact(step_status_list, step_impact_list)
...
def main(step_list, data_repository, tc_status, system_list):
    ...
    try:
        testcase_status = execute_iterative_sequential(step_list, data_repository, tc_status, system_list)
    except Exception:
