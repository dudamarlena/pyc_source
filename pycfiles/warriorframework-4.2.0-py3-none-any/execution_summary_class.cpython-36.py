...
# [GCC 8.4.0]
# Embedded file name: /data/users/snayak/WARRIOR-4.2.0/warriorframework_py3/warrior/WarriorCore/Classes/execution_summary_class.py
# Compiled at: 2020-02-05 00:22:48
# Size of source mod 2**32: 8056 bytes
"""
...
class ExecutionSummary:
    __doc__ = 'Warrior execution summary class'
    ...
    def print_result_in_console(self, junit_file):
        ...
        if file_type == 'Project':
            ...
            for proj in project_exec:
                print_info('{0:10}{1:50}{2:10}{3:30}'.format(proj[0], proj[1], proj[2], proj[3]))

            suite_tc_exec = self.suite_summary(junit_file)
            for suite_tc in suite_tc_exec:
                print_info('{0:10}{1:50}{2:10}{3:30}'.format(suite_tc[0], suite_tc[1], suite_tc[2], suite_tc[3]))
