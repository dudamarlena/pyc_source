...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/systemd_dbus/job.py
...
class Job(object):
    ...
    def __init__(self, job_path):
        ...
        self.__proxy = self.__bus.get_object('org.freedesktop.systemd1', job_path)
        self.__interface = dbus.Interface(self.__proxy, 'org.freedesktop.systemd1.Job')
