...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/systemd_dbus/automount.py
...
class Automount(object):
    ...
    def __init__(self, unit_path):
        ...
        self.__interface = dbus.Interface(self.__proxy, 'org.freedesktop.systemd1.Automount')
