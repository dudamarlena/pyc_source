...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/systemd_dbus/socket.py
# Compiled at: 2016-05-04 02:15:24
...
class Socket(object):
    ...
    def __init__(self, unit_path):
        ...
        self.__interface = dbus.Interface(self.__proxy, 'org.freedesktop.systemd1.Socket')
