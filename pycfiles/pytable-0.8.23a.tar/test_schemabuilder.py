...
# [GCC 8.4.0]
# Embedded file name: /home/mcfletch/pylive/table/pytable/tests/test_schemabuilder.py
...
cats = table('cats', (
 field('cat_id', 'int8', 0, 'Unique cat identifier', constraints=(notNull(), primary())), field('cat_name', 'varchar', 255, "The cat's name", constraints=(notNull(),)), field('declawed', 'bool', 0, "Poor lil' kitty")), 'Primary table for storing critical info about cats')
...
class CatsTest(unittest.TestCase):
    ...
    def testCreate(self):
        ...
        query = sqlquery.SQLQuery(sql=sql)
        try:
            query(connection)
