...
# [GCC 8.4.0]
# Embedded file name: /home/mcfletch/pylive/table/pytable/dbspecifier.py
# Compiled at: 2004-02-19 05:40:37
...
class DBSpecifier(propertied.Propertied):
    """Class specifying database connection using a DBDriver
        ...
        """
    drivername = basic.BasicProperty('drivername', 'The database driver name to use in connecting to the database', baseType=dbdriver.DriverName, defaultValue='PyPgSQL', setDefaultOnGet=0, friendlyName='Driver')
    dsn = common.StringProperty('dsn', 'Database specifier name, the system-specific name for this database', defaultValue='', friendlyName='Data Source')
    database = common.StringProperty('database', 'The name of the database within the database server', defaultValue='', friendlyName='Database Name')
    user = common.StringProperty('user', 'The username used to connect to the database', defaultValue='', friendlyName='User Name')
    password = common.StringProperty('password', 'The password used to connect to the database', defaultValue='', friendlyName='Password')
    host = common.StringProperty('host', 'The network address of the database', defaultValue='', friendlyName='Server Name')
    _keyValues = common.ListProperty('_keyValues', 'List of values which are the "identity" of a specifier', defaultFunction=lambda a, b: [
