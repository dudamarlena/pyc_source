...
# [GCC 8.4.0]
# Embedded file name: /home/mcfletch/pylive/table/pytable/sqlquery.py
# Compiled at: 2007-12-28 17:29:18
...
class SQLQuery(propertied.Propertied):
    ...
    def __call__(self, cursor, **namedarguments):
        ...
        if isinstance(self.sql, (list, tuple)):
            ...
            try:
                ...
                log.info('Failuring processing results for query %s: %s', query, log.getException(err))
                raise
    ...
    def do(self, cursor, query, **namedarguments):
        ...
        try:
            ...
            log.info('Failure executing query %s: %s', query, log.getException(err))
        ...
        except (cursor.connection.driver.OperationalError,
         cursor.connection.driver.ProgrammingError), err:
    ...
    def encodeQuery(self, query, cursor=None):
        ...
        if cursor and not cursor.connection.driver.capabilities.queryUnicode and isinstance(query, unicode):
