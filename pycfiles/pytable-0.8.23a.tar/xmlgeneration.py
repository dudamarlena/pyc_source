...
# [GCC 8.4.0]
# Embedded file name: /home/mcfletch/pylive/table/pytable/xmlgeneration.py
# Compiled at: 2004-04-14 01:41:12
...
class XMLGenerator(propertied.Propertied):
    ...
    def __init__(self, driver=None, **named):
        """Initialise the statement-generator
                ...
                """
        super(XMLGenerator, self).__init__(driver=driver, **named)
...
class XMLReader(propertied.Propertied):
    ...
    dispatchEndMapping = {}
    nodeMapping = {'database': dbschema.DatabaseSchema}
...
if __name__ == '__main__':
    ...
    db = schemabuilder.database(unicode(b'test\xe1', 'latin-1'), [
     schemabuilder.table('sometable', [
      schemabuilder.field('somefield', 'integer', 0, 'Some comment for a field')])])
