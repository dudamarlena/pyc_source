...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/genconf/manifest/_outputfile.py
# Compiled at: 2011-04-07 16:26:02
"""
...
class OutputFile(object):
    ...
    def with_profile(self, profile):
        return OutputFile(lambda : profile, self._target_path, self._template_path, self._template_engine + '-' + self._template_format)
