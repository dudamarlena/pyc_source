...
def download_parser(description):
    ...
    parser.add_argument('--force',
      action='store_true', help='override existing files')
    parser.add_argument('--formats',
      nargs='+', metavar='FORMAT', help='ebook formats (epub, mobi, pdf)')
    parser.add_argument('--with-code-files',
      action='store_true', help='download code files')
    return parser
...
def claim_free_ebook():
    ...
    parser.add_argument('--download',
      action='store_true', help='download ebook')
    parser.add_argument('--slack',
      action='store_true', help='send Slack notification')
    parser.add_argument('--pushover',
      action='store_true', help='send Pushover notification')
    ...
    client = FreePacktBookAnticaptcha(anticaptcha_key=(environ.get('ANTICAPTCHA_KEY')),
