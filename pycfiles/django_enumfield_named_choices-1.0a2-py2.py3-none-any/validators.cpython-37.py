...
# [GCC 8.4.0]
# Embedded file name: /pmc/Work/kolotev/0git/.github/django-enumfield-named-choices/django_enumfield_named_choices/validators.py
# Compiled at: 2019-08-20 20:34:23
...
def validate_available_choice(enum, to_value):
    ...
    if to_value not in (tuple(dict(list(enum.choices())).keys()) if enum.interface is not str else tuple(dict(list(enum.items())).values())):
