...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/cellh5/cellh5write.py
# Compiled at: 2015-11-23 15:36:44
"""
    The CellH5 Project
...
"""
import sys, os, numpy, h5py, pandas, matplotlib.pyplot as plt, unittest, functools, collections
...
class CH5ImageChannelDefinition(CH5PositionDescription):
    fields = [
     'channel_name', 'description', 'is_physical', 'voxel_size', 'color']
...
if __name__ == '__main__':
    ...
    c_def.add_row(channel_name='1', description='rfp', is_physical=True, voxel_size=(1,
                                                                                     1,
                                                                                     1), color='#aabbcc')
    c_def.add_row(channel_name='2', description='gfp', is_physical=True, voxel_size=(1,
                                                                                     1,
                                                                                     1), color='#aabbcc')
