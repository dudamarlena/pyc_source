...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/inotify/watcher.py
...
import array, errno, fcntl, os, termios
...
class Event(object):
    ...
    __slots__ = ('cookie', 'fullpath', 'mask', 'name', 'path', 'raw', 'wd')
...
_event_props = {'access': 'File was accessed', 
...
class Watcher(object):
    ...
    ignored_errors = [
     errno.ENOENT, errno.EPERM, errno.ENOTDIR]
...
class Threshold(object):
    ...
    __slots__ = ('fd', 'threshold', '_iocbuf')
