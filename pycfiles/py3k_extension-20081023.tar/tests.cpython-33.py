...
# Compiled at: 2013-06-28 13:26:44
...
class TestPy3kWarn(unittest.TestCase):
    ...
    def test_ignore_compatible_unicode(self):
        self.assertFalse(main.warnings_for_string('unicode = str\nunicode("abc")\n'))
    ...
    def test_ignore_compatible_basestring(self):
        self.assertFalse(main.warnings_for_string('basestring = str\nbasestring\n'))
    ...
    def test_imports(self):
        self.assertTrue(main.warnings_for_string('from ConfigParser import RawConfigParser\n'))

    def test_imports_with_import_error_caught(self):
        self.assertFalse(main.warnings_for_string('try:\n    from ConfigParser import RawConfigParser\nexcept ImportError:\n    from configparser import RawConfigParser\n'))
    ...
    def test_ignore_compatible_zip(self):
        self.assertFalse(main.warnings_for_string('enumerate(zip([1, 2], [3, 4]))\n'))

    def test_raw_input(self):
        self.assertTrue(main.warnings_for_string('raw_input()\n'))

    def test_ignore_compatible_raw_input(self):
        self.assertFalse(main.warnings_for_string('raw_input = input\nraw_input()\n'))