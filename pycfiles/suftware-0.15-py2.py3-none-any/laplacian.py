...
# [GCC 8.4.0]
# Embedded file name: suftware/src/laplacian.py
...
class Laplacian:
    ...
    def __init__(self, operator_type, operator_order, num_gridpoints, grid_spacing=1.0):
        ...
        if '1d' in operator_type:
            ...
            self._type = operator_type
            self._sparse_matrix, self._kernel_basis = laplacian_2d(num_gridpoints, operator_order, grid_spacing, periodic=periodic, sparse=True, report_kernel=True)
