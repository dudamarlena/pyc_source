...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/reviewbot/tools/pycodestyle.py
...
class PycodestyleTool(Tool):
    ...
    name = b'pycodestyle'
    version = b'1.0'
    description = b'Checks Python code for style errors.'
    timeout = 30
    options = [
    ...
    def check_dependencies(self):
        ...
        """
        return is_exe_in_path(b'pycodestyle')
