...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/graphite/forbin.py
# Compiled at: 2006-02-13 06:31:32
import die, Num
try:
    import TableIO
except ImportError:
...
_lm = {'dotted': (0.04, 0.1), 'dot': (0.04, 0.1), 'finedot': (0.02, 0.1), 'broken': (0.04, 0.8), 
   'dashed': (0.04, 0.5), 'solid': (0.04, 1.0)}
