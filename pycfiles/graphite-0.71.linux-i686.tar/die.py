...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/graphite/die.py
# Compiled at: 2008-02-01 09:18:23
...
class counter:
    ...
    def showreps(self):
        if self.last is not None and self.reps > 1:
            _stderr.write('%s: last message repeated %d times.\n' % (
