...
# [GCC 8.4.0]
# Embedded file name: refstis/weekbias.py
# Compiled at: 2016-06-02 18:08:51
...
def make_weekbias(input_list, refbias_name, basebias):
    ...
    resi_columns_2d = functions.make_resicols_image(residual_image, yfrac=0.25)
    resi_mean, resi_median, resi_std = sigma_clipped_stats(resi_columns_2d[0], sigma=3, iters=20)
