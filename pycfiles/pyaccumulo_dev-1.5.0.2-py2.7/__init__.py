...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyaccumulo/__init__.py
...
class Range(object):
    ...
    def __init__(self, srow=None, scf=None, scq=None, scv=None, sts=None, sinclude=True, erow=None, ecf=None, ecq=None, ecv=None, ets=None, einclude=True):
...
class BatchWriter(object):
    ...
    def __init__(self, conn, table, max_memory=10240, latency_ms=30000, timeout_ms=5000, threads=10):
...
class Accumulo(object):
    ...
    def _process_iterator(self, iter):
        if isinstance(iter, IteratorSetting):
            return iter
        if isinstance(iter, BaseIterator):
    ...
    def create_batch_writer(self, table, max_memory=10240, latency_ms=30000, timeout_ms=5000, threads=10):
