...
# Compiled at: 2020-04-22 19:35:15
# Size of source mod 2**32: 7562 bytes
from aerosandbox.visualization import *
import copy, multiprocessing_on_dill as mp, time
...
def kulfan_coordinates(lower_weights=-0.2 * np.ones(5), upper_weights=0.2 * np.ones(5), TE_thickness=0.005, n_points_per_side=100, N1=0.5, N2=1.0):
    """
