...
# [GCC 8.4.0]
# Embedded file name: /Users/mikko/Projects/django-exmodel/tests/tests.py
# Compiled at: 2015-03-29 06:30:20
...
class RegisterTestCase(TestCase):
    ...
    def test_register(self):
        ...
        self.assertEqual(get_registered_mixins('model', app_label='app')[0], MixinA)

    def test_register_a3(self):
        extend_model('app.model', MixinA)
        extend_model('app.model', MixinB)
        extend_model('app.model', MixinC)
        self.assertEqual(get_registered_mixins('model', app_label='app')[2], MixinC)