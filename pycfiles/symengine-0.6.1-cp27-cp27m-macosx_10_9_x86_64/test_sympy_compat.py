...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/wheel/symengine/tests/test_sympy_compat.py
# Compiled at: 2020-03-16 01:41:57
from symengine.sympy_compat import Integer, Rational, S, Basic, Add, Mul, Pow, symbols, Symbol, log, sin, cos, sech, csch, zeros, atan2, nan, Number, Float, Min, Max, RealDouble, have_mpfr, Abs
...
def test_Float():
    ...
    if have_mpfr:
        ...
        assert isinstance(A, Float)
        assert isinstance(A, RealDouble)
        have_mpfr or raises(ValueError, lambda : Float('1.23', precision=58))
