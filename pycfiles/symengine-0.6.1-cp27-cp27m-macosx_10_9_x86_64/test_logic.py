...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/wheel/symengine/tests/test_logic.py
# Compiled at: 2020-03-16 01:41:57
from symengine.utilities import raises
from symengine.lib.symengine_wrapper import true, false, Eq, Ne, Ge, Gt, Le, Lt, Symbol, I, And, Or, Not, Nand, Nor, Xor, Xnor, Piecewise, Contains, Interval, FiniteSet, oo, log
x = Symbol('x')
y = Symbol('y')
z = Symbol('z')
