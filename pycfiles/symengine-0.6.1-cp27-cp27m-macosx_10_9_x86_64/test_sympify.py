...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/wheel/symengine/tests/test_sympify.py
# Compiled at: 2020-03-16 01:41:57
from symengine.utilities import raises
from symengine import Symbol, Integer, sympify, SympifyError, true, false, pi, nan, oo, zoo, E, I, GoldenRatio, Catalan, Rational, sqrt, Eq
