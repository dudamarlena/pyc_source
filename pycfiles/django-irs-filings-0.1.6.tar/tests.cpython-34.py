...
# [GCC 8.4.0]
# Embedded file name: /Users/sahilchinoy/projects/django-irs-filings/repo/irs/tests/tests.py
# Compiled at: 2016-07-09 03:17:24
...
class IRSFilingsTest(TestCase):
    ...
    def test_committee(self):
        ...
        self.assertEqual(committee.name, 'GARDERE WYNNE SEWELL L L P CAMPAIGN FUND')
    ...
    def test_contributions(self):
        ...
        contributions_list = filing.contributions.values_list('contribution_amount', flat=True)
    ...
    def test_amendments(self):
        ...
        self.assertEqual(filing.amends.first().form_id_number, '9637644')
        amended_filing = F8872.objects.get(form_id_number='9637644')
        self.assertTrue(amended_filing.is_amended)
        self.assertEqual(amended_filing.amended_by.form_id_number, '9637689')
