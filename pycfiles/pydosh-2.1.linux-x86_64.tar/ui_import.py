...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pydosh/ui_import.py
...
class Ui_Import(object):
    ...
    def setupUi(self, Import):
        ...
        self.currencyComboBox = QtGui.QComboBox(Import)
        self.currencyComboBox.setObjectName('currencyComboBox')
        self.gridLayout.addWidget(self.currencyComboBox, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.view, 1, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.CsvImport, 3, 0, 1, 5)
    ...
    def retranslateUi(self, Import):
        ...
        self.label_6.setText(QtGui.QApplication.translate('Import', 'Currency', None, QtGui.QApplication.UnicodeUTF8))
        return
