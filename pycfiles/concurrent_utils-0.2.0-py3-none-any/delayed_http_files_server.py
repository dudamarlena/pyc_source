...
# Embedded file name: build/bdist.linux-x86_64/egg/concurrent_tree_crawler/common/delayed_http_files_server.py
# Compiled at: 2011-09-28 13:50:09
import sys, os, threading, SocketServer, time, SimpleHTTPServer
...
class DelayedHTTPFilesServer:
    ...
    def start(self):
        """
                ...
                """
        self.__server = _ThreadedTCPServer(self.__delay, self.__dir_to_serve, (
...
class _DelayedFilesServerHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ...
    def log_message(self, format_, *args):
        sys.stdout.write(('{} - - [{}] {}\n').format(self.address_string(), self.log_date_time_string(), format_ % args))
