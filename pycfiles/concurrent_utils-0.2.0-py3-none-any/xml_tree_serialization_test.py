...
# Embedded file name: build/bdist.linux-x86_64/egg/concurrent_tree_crawler/test/xml_tree_serialization_test.py
...
from concurrent_tree_crawler.xml_tree_serialization import XMLTreeWriter, XMLTreeReader
