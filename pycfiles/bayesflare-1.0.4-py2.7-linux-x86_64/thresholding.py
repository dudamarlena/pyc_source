...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bayesflare/stats/thresholding.py
# Compiled at: 2017-04-26 11:11:14
from ..misc import mkdir
import numpy as np, bayesflare as pf
...
class Thresholder:
    ...
    def generate_threshold(self):
        ...
        """
        import pickle, glob, pylab as pl
        B = self.B
        ...
        if len(files) < 1000:
            ...
            M.set_taus_exp(0.5 * hours, 5 * hours, 30)
