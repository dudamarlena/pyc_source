...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fdfs_client/connection.py
...
class Connection(object):
    __doc__ = 'Manage TCP comunication to and from Fastdfs Server.'
...
class ConnectionPool(object):
    ...
    def __init__(self, name='', conn_class=Connection, max_conn=None, **conn_kwargs):
        self.pool_name = name
        self.pid = os.getpid()
        self.conn_class = conn_class
        self.max_conn = max_conn or 2147483648
