...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/pydistance/__init__.py
# Compiled at: 2019-03-31 15:54:36
# Size of source mod 2**32: 3603 bytes
from collections import namedtuple
import datetime, math, random, pytz
...
def cartesian_distance(loc1, loc2):
    return math.sqrt((loc1.x - loc1.x) ** 2 + (loc1.y - loc2.y) ** 2)
...
class TravelSolution:
    ...
    def cost(self):
        if self._cost:
            return self._cost
        r_driving = self.gmaps.distance_matrix(origins=(self._src()),
