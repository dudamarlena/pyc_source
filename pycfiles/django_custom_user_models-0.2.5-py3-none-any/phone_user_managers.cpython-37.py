...
# [GCC 8.4.0]
# Embedded file name: M:\Programming\Project\django-auth\auth\CustomAuth\managers\phone_user_managers.py
# Compiled at: 2020-03-08 08:24:38
...
class UserManager(BaseUserManager):
    ...
    def get_by_token(self, token: str, algorithm='HS256'):
        ...
        try:
            decoded = jwt.decode(encoded_token, settings.SECRET_KEY, algorithm)
    ...
    def get_by_sign(self, token: str):
        ...
        try:
            decoded = jwt.decode(encoded_sign, settings.SECRET_KEY, 'HS256')
