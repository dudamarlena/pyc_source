...
# [GCC 8.4.0]
# Embedded file name: M:\Programming\Project\django-auth\auth\CustomAuth\forms\phone_number_user_forms.py
...
class PhoneUserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = PhoneNumberUser
        fields = ('first_name', 'last_name', 'cellphone', 'password', 'email', 'is_superuser',
                  'is_staff', 'is_verify', 'is_active', 'user_permissions', 'groups',
                  'date_verify')
