...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fontmeta.py
# Compiled at: 2018-06-26 01:29:30
# Size of source mod 2**32: 21489 bytes
...
ENCODINGS = {'Roman': 'latin_1'}

class FontMeta:
    __doc__ = 'This Class provides easy way to get data'
    ...
    def _parse_meta(self):
        ...
        for nti in self.FONT['name'].names:
            ...
            if platform_data['name'] == 'Custom':
                ...
                language = {'id':nti.langID,  'value':platform_data['languages'].get(nti.langID, 'Unknown')}
            name_str = nti.toStr()
