...
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/editors/richtexteditor.py
...
class RichTextEditor(CustomEditor, WideEditor):
    ...
    def get_value(self):
        ...
        value = ('').join([ node.toxml() for node in tree.getElementsByTagName('html')[0].getElementsByTagName('body')[0].childNodes ])
