...
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/appscheme.py
# Compiled at: 2013-04-11 17:47:52
__doc__ = 'Encapsulates various ms office schemes'
Office2003BlueStyle = {'SplitterDark': '(21, 28, 171)', 
...
Office2003SilverStyle = {'SplitterDark': '(150, 148, 178)', 
   ...
   'ContextMenuBackColor': '(253, 250, 255)'}
Office2003OliveStyle = {'SplitterDark': '(182, 196, 144)', 
   ...
   'CaptionTextColor': '(0, 0, 0)', 
   'ContextMenuBackColor': '(253, 250, 255)'}
Office2007BlueStyle = {'SplitterDark': '(192, 219, 255)', 
...
Office2007BlackStyle = {'SplitterDark': '(199, 203, 209)', 
...
Office2007SilverStyle = {'SplitterDark': '(119, 118, 151)', 
...
class Scheme(object):
    ...
    def twocolorgradient(self, rgb1, rgb2):
        s = 'qlineargradient(spread:pad, x1:0.5, y1:0, x2:0.5, y2:1, stop:0 rgba%s, 255), stop:1 rgba%s, 255))' % (
         rgb1, rgb2)
        return s

    def fourcolorgradient(self, rgb1, rgb2, rgb3, rgb4):
        s = 'qlineargradient(spread:pad, x1:0.5, y1:0, x2:0.5, y2:1, stop:0 rgba%s, 255), stop:0.4 rgba%s, 255), stop:0.401 rgba%s, 255), stop:1 rgba%s, 255))' % (
         rgb1, rgb2, rgb3, rgb4)
        return s
