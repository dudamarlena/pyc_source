...
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/editors/imageeditor.py
...
class ImageEditor(FileEditor):
    ...
    def __init__(self, parent=None, storage=None, preview_width=100, preview_height=100, field_name='image', **kwargs):
    ...
    def eventFilter(self, object, event):
        ...
        if event.buttons() == QtCore.Qt.LeftButton:
            if self.value:
                post(lambda : self.value.checkout_thumbnail(640, 480), self.show_fullscreen)
            return True
        return False