...
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/filter_operator.py
...
class FilterOperator(QtGui.QWidget):
    ...
    def __init__(self, cls, field_name, field_attributes, default_operator=None, default_value_1=None, default_value_2=None, parent=None):
