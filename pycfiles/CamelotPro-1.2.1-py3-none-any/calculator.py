...
# Embedded file name: build/bdist.linux-x86_64/egg/camelot/view/controls/calculator.py
...
class Calculator(QtGui.QDialog):
    ...
    def ShowCalculate(self):
        ...
        if input == str(self.output.text()):
            reply = QtGui.QMessageBox.question(self, 'Message', 'Do you want to Save and Quit?', QtGui.QMessageBox.Yes, QtGui.QMessageBox.No)
    ...
    def discountClick(self):
        ...
        if ok:
            percentage = 1.0 + eval(str(text)) / 100.0
