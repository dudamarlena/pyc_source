...
# [GCC 8.4.0]
# Embedded file name: /Users/Rich/.virtualenvs/django-applepodcast-demo-AA-FF_Hg/lib/python3.6/site-packages/podcast/tests/__init__.py
# Compiled at: 2017-12-11 01:17:26
...
class PodcastTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.client = Client()
        show = Show.objects.create(title='All About Everything',
          slug='everything',
        ...
        episode_1 = Episode.objects.create(show=show,
          ...
          explicit=False,
          block=False)
        episode_2 = Episode.objects.create(show=show,
          ...
          explicit=False,
          block=False)
        episode_3 = Episode.objects.create(show=show,
          ...
          explicit=False,
          block=False)
        episode_4 = Episode.objects.create(show=show,
