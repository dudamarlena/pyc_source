...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/multicast.py
# Compiled at: 2013-01-18 14:15:22
...
import socket, sys, os, logging, select
...
class Dispatcher(object):
    """Dispatcher objects are registered with `Poller` objects that use
        ...
        class.
        """
    _method_map = {select.EPOLLIN: 'handle_read', 
