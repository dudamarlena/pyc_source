...
# [GCC 8.4.0]
# Embedded file name: /home/arroyo/ovp/suzano-ovp/django-ovp-projects/ovp_projects/views/project.py
# Compiled at: 2017-06-22 10:13:00
...
class ProjectResourceViewSet(mixins.CreateModelMixin, mixins.RetrieveModelMixin, viewsets.GenericViewSet):
    ...
    def get_permissions(self):
        ...
        if self.action == 'create':
            ...
            self.permission_classes = (
             permissions.IsAuthenticated, ProjectCreateOwnsOrIsOrganizationMember)
        if self.action == 'partial_update':
            self.permission_classes = (
             permissions.IsAuthenticated, ProjectRetrieveOwnsOrIsOrganizationMember)
