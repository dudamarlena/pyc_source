...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sutekh/base/gui/plugins/BaseImport.py
...
class BaseImport(BasePlugin):
    ...
    def make_dialog(self, _oWidget):
        ...
        self.oDlg = SutekhDialog('Choose Card Set File or URL', None, gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT, (
    ...
    def make_cs_from_uri(self, sUri, cParser):
        ...
        fIn = urlopen_with_timeout(sUri, fErrorHandler=gui_error_handler)
        if not fIn:
            return
        try:
