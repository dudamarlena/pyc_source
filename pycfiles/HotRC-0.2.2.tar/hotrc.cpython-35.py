...
# [GCC 8.4.0]
# Embedded file name: /home/hotrc/hotrc/hotrc.py
# Compiled at: 2016-07-16 19:43:52
...
class HotRC(object):
    ...
    def remove_alias(self, key, value=None):
        ...
        subprocess.Popen([script, key], stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=False)
