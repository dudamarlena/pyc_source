...
# [GCC 8.4.0]
# Embedded file name: /home/filipeximenes/Projects/django-role-permissions/rolepermissions/tests/test_roles.py
...
class RolRole4(AbstractUserRole):
    available_permissions = {'permission_number_7':True, 
