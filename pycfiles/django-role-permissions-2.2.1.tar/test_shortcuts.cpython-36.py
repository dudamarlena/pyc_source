...
# [GCC 8.4.0]
# Embedded file name: /home/filipeximenes/Projects/django-role-permissions/rolepermissions/tests/test_shortcuts.py
# Compiled at: 2018-12-02 07:23:05
# Size of source mod 2**32: 18744 bytes
from django.test import TestCase
from django.contrib.auth import get_user_model
from django.contrib.auth.models import Group
from model_mommy import mommy
from rolepermissions.roles import RolesManager, AbstractUserRole
from rolepermissions.roles import get_user_roles, retrieve_role, assign_role, remove_role, clear_roles
from rolepermissions.permissions import grant_permission, revoke_permission, available_perm_status, available_perm_names
...
class ShoRole1(AbstractUserRole):
    available_permissions = {'permission1':True, 
     'permission2':True}


class ShoRole2(AbstractUserRole):
    available_permissions = {'permission3':True, 
     'permission4':False}


class ShoRole3(AbstractUserRole):
    role_name = 'sho_new_name'
    available_permissions = {'permission5':False, 
     'permission6':False}


class ShoRole4(AbstractUserRole):
    available_permissions = {'permission1':False, 
     'permission3':False}
...
class RemoveRoleTests(TestCase):
    ...
    class Doctor(AbstractUserRole):
        available_permissions = {'enter_surgery_room': False}

    class Surgeon(AbstractUserRole):
        available_permissions = {'enter_surgery_room':True, 
         'operate':True}
...
class AvailablePermNamesTests(TestCase):
    ...
    def test_queries_no_prefetch(self):
        fetched_user = get_user_model().objects.get(pk=(self.user.pk))
        N = 3
        with self.assertNumQueries(2 * N):
            for i in range(N):
