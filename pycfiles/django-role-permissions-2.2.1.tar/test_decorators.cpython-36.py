...
# [GCC 8.4.0]
# Embedded file name: /home/filipeximenes/Projects/django-role-permissions/rolepermissions/tests/test_decorators.py
# Compiled at: 2018-12-02 07:23:05
# Size of source mod 2**32: 6894 bytes
...
@override_settings(ROLEPERMISSIONS_REDIRECT_TO_LOGIN=True,
  LOGIN_URL='/login/',
...
@override_settings(ROLEPERMISSIONS_REDIRECT_TO_LOGIN=False,
  LOGIN_URL='/login/',
  ROOT_URLCONF='rolepermissions.tests.mock_urls')
