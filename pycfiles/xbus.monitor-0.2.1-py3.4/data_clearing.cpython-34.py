...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/xbus/monitor/models/data_clearing.py
...
class EventType(Base):
    ...
    item_types = relationship('ItemType', lazy='dynamic', secondary='event_type_item_type_rel', backref=backref('event_types', lazy='dynamic'))
...
class ItemColumn(Base):
    ...
    type = relationship('ItemType', foreign_keys=[type_id], backref=backref('columns', lazy='dynamic'))
...
class ItemJoin(Base):
    ...
    parent = relationship('ItemJoin', remote_side=[id], backref=backref('children', lazy='dynamic'))
