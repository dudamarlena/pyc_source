...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/xbus/monitor/views/api/cl_item_type.py
...
def cl_item_type_rel_add(request):
    ...
    if added_record is None:
        raise HTTPNotFound(json_body={'error': 'Item type ID {id} not found'.format(id=rid)})
