...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/internationalization/impl/json_locale.py
# Compiled at: 2013-08-14 09:38:54
"""
...
class JSONFileService(IJSONLocaleFileService):
    ...
    def getPluginJSONFile(self, plugin, locale, scheme):
        ...
        if pluginObj.Component:
            return self.getComponentJSONFile(pluginObj.Component, locale, scheme)
        else:
