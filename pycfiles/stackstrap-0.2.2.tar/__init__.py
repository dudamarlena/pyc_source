...
# [GCC 8.4.0]
# Embedded file name: /Users/evelo/Documents/Repos/stackstrap/stackstrap/commands/__init__.py
...
class CommandLoader(object):
    ...
    def load_commands(self):
        ...
        if self.subparsers is None:
            raise NotImplementedError("The class %s needs to have a 'subparsers' attribute prior to calling load_commands" % self.__class__.__name__)
        self.commands = {}
        for cls in self.commands_to_load:
            command = cls()
            parser = self.subparsers.add_parser(command.name, help=command.__doc__)
