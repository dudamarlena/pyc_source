...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/dbmanagr/model/table.py
...
class Table(BaseItem):
    ...
    def autocomplete_(self, column=None, value=None, format_=OPTION_URI_VALUE_FORMAT):
    ...
    def rows(self, connection, filter_=None, limit=DEFAULT_LIMIT, simplify=None):
        ...
        except (DataError, ProgrammingError, UnknownColumnException, UnicodeEncodeError):
            raise
        except BaseException as e:
            logger.error(e, exc_info=1)
            import sys
            raise type(e), type(e)(('{} (check comment on table {})').format(e.message, self.name)), sys.exc_info()[2]
