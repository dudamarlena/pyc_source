...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tw\core\engine_plugin.py
# Compiled at: 2011-07-14 11:52:18
"""
...
class ToscaWidgetsTemplatePlugin(object):
    ...
    def load_template(self, template_name, template_string=None):
        ...
        uses that feature to its advantage, and for ease of integration
