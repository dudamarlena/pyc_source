...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tw\mods\cp2.py
# Compiled at: 2011-07-14 12:06:29
from pkg_resources import require
require('CherryPy <3.0')
import logging, pprint, cherrypy
...
def start_extension(host_framework, **filter_args):
    cherrypy.root._cp_filters.append(TWInitFilter(host_framework, **filter_args))
