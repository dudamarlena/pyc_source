...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tw\core\registry.py
# Compiled at: 2011-07-14 12:00:40
...
__all__ = [
 'StackedObjectProxy', 'RegistryManager', 'StackedObjectRestorer', 'restorer', 'Registry']
try:
    ...
    class Registry(object):
        ...
        def prepare(self):
            ...
            Any time a new RegistryManager is called, ``prepare`` needs to be
