...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tw\core\js.py
# Compiled at: 2011-07-14 11:57:37
"""
...
__all__ = [
 'js_callback', 'js_function', 'js_symbol', 'encode']
log = logging.getLogger(__name__)

class TWEncoder(JSONEncoder):
    ...
    Technical note: the json (simplejson) package does not support arbitrary
    js injection, which is needed in this module.  We work around this by
    inserting distinct tokens into the JSON encoding stream that can later
    be replaced with the objects' js representations.
