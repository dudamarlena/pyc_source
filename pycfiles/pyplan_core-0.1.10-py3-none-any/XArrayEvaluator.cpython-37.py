...
# Compiled at: 2020-05-08 15:54:13
# Size of source mod 2**32: 33492 bytes
...
class XArrayEvaluator(BaseEvaluator):
 ...
 L. 505         4  LOAD_GLOBAL              isinstance
                6  LOAD_FAST                'node'
                8  LOAD_ATTR                result
               10  LOAD_GLOBAL              xr
               12  LOAD_ATTR                DataArray
               14  CALL_FUNCTION_2       2  '2 positional arguments'
               16  POP_JUMP_IF_FALSE   130  'to 130'

 L. 506        18  LOAD_FAST                'node'
               20  LOAD_ATTR                definition
               22  LOAD_CONST               None
               24  COMPARE_OP               is-not
               26  POP_JUMP_IF_FALSE   130  'to 130'
               28  LOAD_FAST                'node'
               30  LOAD_ATTR                definition
               32  LOAD_STR                 ''
               34  COMPARE_OP               !=
               36  POP_JUMP_IF_FALSE   130  'to 130'

 L. 507        38  LOAD_CONST               0
               40  LOAD_CONST               None
               42  IMPORT_NAME              re
               44  STORE_FAST               're'

 L. 508        46  LOAD_FAST                're'
               48  LOAD_METHOD              sub
 ...
 L. 510        76  LOAD_FAST                'deff'
               ...
               94  POP_JUMP_IF_TRUE    126  'to 126'
               96  LOAD_FAST                'deff'
              ...
              120  LOAD_STR                 'result=pp.create_dataarray('
              122  CALL_METHOD_1         1  '1 positional argument'
              124  POP_JUMP_IF_FALSE   130  'to 130'
            126_0  COME_FROM           114  '114'
            126_1  COME_FROM           104  '104'
            126_2  COME_FROM            94  '94'
            126_3  COME_FROM            84  '84'

 L. 511       126  LOAD_STR                 '1'
              128  STORE_FAST               'res'
            130_0  COME_FROM           124  '124'
            130_1  COME_FROM            36  '36'
            130_2  COME_FROM            26  '26'
            130_3  COME_FROM            16  '16'

 L. 513       130  LOAD_FAST                'res'
              132  RETURN_VALUE     
               -1  RETURN_LAST      
...
'np.nan' # Avoid dead code: repr(x)}).replace('\n', '')
    ...
    def geoUnclusterData(self, result, nodeDic, nodeId, rowIndex, attIndex, latField='latitude', lngField='longitude', geoField='geoField', labelField='labelField', sizeField='sizeField', colorField='colorField', iconField='iconField'):
        _tmp_for_geo = pd.Index([latField, lngField, geoField, labelField,
         sizeField, colorField, iconField],
          name='tmp_for_geo')
