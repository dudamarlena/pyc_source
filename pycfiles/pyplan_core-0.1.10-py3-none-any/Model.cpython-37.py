...
# Compiled at: 2020-05-08 15:54:46
# Size of source mod 2**32: 73873 bytes
...
m.group(1) # Avoid dead code: newRelatedId, currentDef, 0, re.IGNORECASE)
    ...
    def applyBackwardCompatibility(self):
        if self.existNode('selector'):
            ...
            if node.nodeClass == 'function':
                if 'from pyplan_engine.classes.PyplanFunctions import Selector' in node.definition:
