...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/disassociate_public_ip_from_server_instance_request.py
...
class DisassociatePublicIpFromServerInstanceRequest(object):
    ...
    def __init__(self, public_ip_instance_no=None):
        """DisassociatePublicIpFromServerInstanceRequest - a model defined in Swagger"""
    ...
    def public_ip_instance_no(self):
        u"""Gets the public_ip_instance_no of this DisassociatePublicIpFromServerInstanceRequest.  # noqa: E501
    ...
    def public_ip_instance_no(self, public_ip_instance_no):
        u"""Sets the public_ip_instance_no of this DisassociatePublicIpFromServerInstanceRequest.
