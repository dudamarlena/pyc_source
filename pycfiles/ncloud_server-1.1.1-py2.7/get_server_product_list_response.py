...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/get_server_product_list_response.py
...
class GetServerProductListResponse(object):
    ...
    def __init__(self, request_id=None, return_code=None, return_message=None, product_list=None, total_rows=None):
        """GetServerProductListResponse - a model defined in Swagger"""
