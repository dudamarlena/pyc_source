...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/change_server_instance_spec_request.py
...
class ChangeServerInstanceSpecRequest(object):
    ...
    def __init__(self, server_instance_no=None, server_product_code=None):
        """ChangeServerInstanceSpecRequest - a model defined in Swagger"""
    ...
    def server_instance_no(self):
        u"""Gets the server_instance_no of this ChangeServerInstanceSpecRequest.  # noqa: E501
    ...
    def server_instance_no(self, server_instance_no):
        u"""Sets the server_instance_no of this ChangeServerInstanceSpecRequest.
    ...
    def server_product_code(self):
        u"""Gets the server_product_code of this ChangeServerInstanceSpecRequest.  # noqa: E501
    ...
    def server_product_code(self, server_product_code):
        u"""Sets the server_product_code of this ChangeServerInstanceSpecRequest.
        ...
        if server_product_code is None:
            raise ValueError('Invalid value for `server_product_code`, must not be `None`')
