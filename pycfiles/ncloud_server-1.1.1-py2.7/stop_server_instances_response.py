...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/stop_server_instances_response.py
...
class StopServerInstancesResponse(object):
    ...
    def __init__(self, request_id=None, return_code=None, return_message=None, total_rows=None, server_instance_list=None):
        """StopServerInstancesResponse - a model defined in Swagger"""
