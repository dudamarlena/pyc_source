...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/get_nas_volume_instance_list_request.py
...
class GetNasVolumeInstanceListRequest(object):
    ...
    """
    swagger_types = {'volume_allotment_protocol_type_code': 'str', 
       'is_event_configuration': 'bool', 
       'is_snapshot_configuration': 'bool', 
       'nas_volume_instance_no_list': 'list[str]', 
       'region_no': 'str', 
       'zone_no': 'str'}
    attribute_map = {'volume_allotment_protocol_type_code': 'volumeAllotmentProtocolTypeCode', 
    ...
    def __init__(self, volume_allotment_protocol_type_code=None, is_event_configuration=None, is_snapshot_configuration=None, nas_volume_instance_no_list=None, region_no=None, zone_no=None):
        """GetNasVolumeInstanceListRequest - a model defined in Swagger"""
    ...
    def volume_allotment_protocol_type_code(self):
        u"""Gets the volume_allotment_protocol_type_code of this GetNasVolumeInstanceListRequest.  # noqa: E501
    ...
    def volume_allotment_protocol_type_code(self, volume_allotment_protocol_type_code):
        u"""Sets the volume_allotment_protocol_type_code of this GetNasVolumeInstanceListRequest.
    ...
    def is_event_configuration(self):
        u"""Gets the is_event_configuration of this GetNasVolumeInstanceListRequest.  # noqa: E501
    ...
    def is_event_configuration(self, is_event_configuration):
        u"""Sets the is_event_configuration of this GetNasVolumeInstanceListRequest.
    ...
    def is_snapshot_configuration(self):
        u"""Gets the is_snapshot_configuration of this GetNasVolumeInstanceListRequest.  # noqa: E501
    ...
    def is_snapshot_configuration(self, is_snapshot_configuration):
        u"""Sets the is_snapshot_configuration of this GetNasVolumeInstanceListRequest.
    ...
    def nas_volume_instance_no_list(self):
        u"""Gets the nas_volume_instance_no_list of this GetNasVolumeInstanceListRequest.  # noqa: E501
    ...
    def nas_volume_instance_no_list(self, nas_volume_instance_no_list):
        u"""Sets the nas_volume_instance_no_list of this GetNasVolumeInstanceListRequest.
    ...
    @property
    def region_no(self):
        u"""Gets the region_no of this GetNasVolumeInstanceListRequest.  # noqa: E501
    ...
    def region_no(self, region_no):
        u"""Sets the region_no of this GetNasVolumeInstanceListRequest.
    ...
    @property
    def zone_no(self):
        u"""Gets the zone_no of this GetNasVolumeInstanceListRequest.  # noqa: E501
    ...
    def zone_no(self, zone_no):
        u"""Sets the zone_no of this GetNasVolumeInstanceListRequest.
