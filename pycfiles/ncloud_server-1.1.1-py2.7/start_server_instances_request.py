...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/start_server_instances_request.py
...
class StartServerInstancesRequest(object):
    ...
    def __init__(self, server_instance_no_list=None):
        """StartServerInstancesRequest - a model defined in Swagger"""
    ...
    def server_instance_no_list(self):
        u"""Gets the server_instance_no_list of this StartServerInstancesRequest.  # noqa: E501
    ...
    def server_instance_no_list(self, server_instance_no_list):
        u"""Sets the server_instance_no_list of this StartServerInstancesRequest.
