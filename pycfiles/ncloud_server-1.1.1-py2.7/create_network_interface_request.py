...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/create_network_interface_request.py
...
class CreateNetworkInterfaceRequest(object):
    ...
    def __init__(self, private_subnet_instance_no=None, network_interface_name=None, network_interface_ip=None, network_interface_description=None, region_no=None, zone_no=None, server_instance_no=None):
        """CreateNetworkInterfaceRequest - a model defined in Swagger"""
    ...
    def private_subnet_instance_no(self):
        u"""Gets the private_subnet_instance_no of this CreateNetworkInterfaceRequest.  # noqa: E501
    ...
    def private_subnet_instance_no(self, private_subnet_instance_no):
        u"""Sets the private_subnet_instance_no of this CreateNetworkInterfaceRequest.
        ...
        if private_subnet_instance_no is None:
            raise ValueError('Invalid value for `private_subnet_instance_no`, must not be `None`')
        self._private_subnet_instance_no = private_subnet_instance_no
        return

    @property
    def network_interface_name(self):
        u"""Gets the network_interface_name of this CreateNetworkInterfaceRequest.  # noqa: E501
    ...
    def network_interface_name(self, network_interface_name):
        u"""Sets the network_interface_name of this CreateNetworkInterfaceRequest.
        ...
        if network_interface_name is None:
            raise ValueError('Invalid value for `network_interface_name`, must not be `None`')
    ...
    def network_interface_ip(self, network_interface_ip):
        ...
        if network_interface_ip is None:
            raise ValueError('Invalid value for `network_interface_ip`, must not be `None`')
        self._network_interface_ip = network_interface_ip
        return

    @property
    def network_interface_description(self):
        u"""Gets the network_interface_description of this CreateNetworkInterfaceRequest.  # noqa: E501
    ...
    def network_interface_description(self, network_interface_description):
        u"""Sets the network_interface_description of this CreateNetworkInterfaceRequest.
    ...
    @property
    def region_no(self):
        u"""Gets the region_no of this CreateNetworkInterfaceRequest.  # noqa: E501
    ...
    def region_no(self, region_no):
        u"""Sets the region_no of this CreateNetworkInterfaceRequest.
    ...
    @property
    def zone_no(self):
        u"""Gets the zone_no of this CreateNetworkInterfaceRequest.  # noqa: E501
    ...
    def zone_no(self, zone_no):
        u"""Sets the zone_no of this CreateNetworkInterfaceRequest.
    ...
    def server_instance_no(self):
        u"""Gets the server_instance_no of this CreateNetworkInterfaceRequest.  # noqa: E501
    ...
    def server_instance_no(self, server_instance_no):
        u"""Sets the server_instance_no of this CreateNetworkInterfaceRequest.
