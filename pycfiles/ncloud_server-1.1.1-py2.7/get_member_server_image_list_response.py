...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/get_member_server_image_list_response.py
...
class GetMemberServerImageListResponse(object):
    ...
    def __init__(self, request_id=None, return_code=None, return_message=None, total_rows=None, member_server_image_list=None):
        """GetMemberServerImageListResponse - a model defined in Swagger"""
