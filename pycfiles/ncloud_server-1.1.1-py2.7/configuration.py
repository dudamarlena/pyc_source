...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/configuration.py
...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        self.host = 'https://ncloud.apigw.ntruss.com/server/v2'
        ...
        self.secret_key = ''
        self.logger = {}
        self.logger['package_logger'] = logging.getLogger('ncloud_server')
    ...
    def to_debug_report(self):
        ...
        """
        return ('Python SDK Debug Report:\nOS: {env}\nPython Version: {pyversion}\nVersion of the API: 2019-10-17T10:28:43Z\nSDK Package Version: 1.0.0').format(env=sys.platform, pyversion=sys.version)