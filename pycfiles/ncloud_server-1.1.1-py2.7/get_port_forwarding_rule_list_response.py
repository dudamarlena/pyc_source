...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/get_port_forwarding_rule_list_response.py
...
class GetPortForwardingRuleListResponse(object):
    ...
    def __init__(self, port_forwarding_configuration_no=None, port_forwarding_public_ip=None, zone=None, internet_line_type=None, total_rows=None, port_forwarding_rule_list=None):
        """GetPortForwardingRuleListResponse - a model defined in Swagger"""
    ...
    def port_forwarding_configuration_no(self):
        u"""Gets the port_forwarding_configuration_no of this GetPortForwardingRuleListResponse.  # noqa: E501
    ...
    def port_forwarding_configuration_no(self, port_forwarding_configuration_no):
        u"""Sets the port_forwarding_configuration_no of this GetPortForwardingRuleListResponse.
    ...
    def port_forwarding_public_ip(self):
        u"""Gets the port_forwarding_public_ip of this GetPortForwardingRuleListResponse.  # noqa: E501
    ...
    def port_forwarding_public_ip(self, port_forwarding_public_ip):
        u"""Sets the port_forwarding_public_ip of this GetPortForwardingRuleListResponse.
    ...
    @property
    def zone(self):
        u"""Gets the zone of this GetPortForwardingRuleListResponse.  # noqa: E501
    ...
    @zone.setter
    def zone(self, zone):
        u"""Sets the zone of this GetPortForwardingRuleListResponse.
    ...
    def internet_line_type(self):
        u"""Gets the internet_line_type of this GetPortForwardingRuleListResponse.  # noqa: E501
    ...
    def internet_line_type(self, internet_line_type):
        u"""Sets the internet_line_type of this GetPortForwardingRuleListResponse.
