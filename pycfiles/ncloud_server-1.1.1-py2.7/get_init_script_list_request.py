...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/get_init_script_list_request.py
...
class GetInitScriptListRequest(object):
    ...
    def __init__(self):
        """GetInitScriptListRequest - a model defined in Swagger"""
