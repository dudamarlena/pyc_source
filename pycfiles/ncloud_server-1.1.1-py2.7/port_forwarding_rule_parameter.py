...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/port_forwarding_rule_parameter.py
...
class PortForwardingRuleParameter(object):
    ...
    def __init__(self, port_forwarding_external_port=None, port_forwarding_internal_port=None, server_instance_no=None):
        """PortForwardingRuleParameter - a model defined in Swagger"""
    ...
    def port_forwarding_external_port(self):
        u"""Gets the port_forwarding_external_port of this PortForwardingRuleParameter.  # noqa: E501
    ...
    def port_forwarding_external_port(self, port_forwarding_external_port):
        u"""Sets the port_forwarding_external_port of this PortForwardingRuleParameter.
        ...
        if port_forwarding_external_port is None:
            raise ValueError('Invalid value for `port_forwarding_external_port`, must not be `None`')
        self._port_forwarding_external_port = port_forwarding_external_port
        return

    @property
    def port_forwarding_internal_port(self):
        u"""Gets the port_forwarding_internal_port of this PortForwardingRuleParameter.  # noqa: E501
    ...
    def port_forwarding_internal_port(self, port_forwarding_internal_port):
        u"""Sets the port_forwarding_internal_port of this PortForwardingRuleParameter.
        ...
        if port_forwarding_internal_port is None:
            raise ValueError('Invalid value for `port_forwarding_internal_port`, must not be `None`')
        self._port_forwarding_internal_port = port_forwarding_internal_port
        return

    @property
    def server_instance_no(self):
        u"""Gets the server_instance_no of this PortForwardingRuleParameter.  # noqa: E501
    ...
    def server_instance_no(self, server_instance_no):
        u"""Sets the server_instance_no of this PortForwardingRuleParameter.
