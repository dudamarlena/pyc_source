...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/ncloud_server/model/set_nas_volume_access_control_request.py
...
class SetNasVolumeAccessControlRequest(object):
    ...
    def __init__(self, nas_volume_instance_no=None, server_instance_no_list=None, custom_ip_list=None):
        """SetNasVolumeAccessControlRequest - a model defined in Swagger"""
    ...
    def nas_volume_instance_no(self):
        u"""Gets the nas_volume_instance_no of this SetNasVolumeAccessControlRequest.  # noqa: E501

        NAS볼륨인스턴스번호  # noqa: E501

        :return: The nas_volume_instance_no of this SetNasVolumeAccessControlRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def nas_volume_instance_no(self, nas_volume_instance_no):
        u"""Sets the nas_volume_instance_no of this SetNasVolumeAccessControlRequest.

        NAS볼륨인스턴스번호  # noqa: E501

        :param nas_volume_instance_no: The nas_volume_instance_no of this SetNasVolumeAccessControlRequest.  # noqa: E501
        :type: str
        """
    ...
    def server_instance_no_list(self):
        u"""Gets the server_instance_no_list of this SetNasVolumeAccessControlRequest.  # noqa: E501

        서버인스턴스번호리스트  # noqa: E501

        :return: The server_instance_no_list of this SetNasVolumeAccessControlRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def server_instance_no_list(self, server_instance_no_list):
        u"""Sets the server_instance_no_list of this SetNasVolumeAccessControlRequest.

        서버인스턴스번호리스트  # noqa: E501

        :param server_instance_no_list: The server_instance_no_list of this SetNasVolumeAccessControlRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def custom_ip_list(self):
        u"""Gets the custom_ip_list of this SetNasVolumeAccessControlRequest.  # noqa: E501

        커스텀IP리스트  # noqa: E501

        :return: The custom_ip_list of this SetNasVolumeAccessControlRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def custom_ip_list(self, custom_ip_list):
        u"""Sets the custom_ip_list of this SetNasVolumeAccessControlRequest.

        커스텀IP리스트  # noqa: E501

        :param custom_ip_list: The custom_ip_list of this SetNasVolumeAccessControlRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetNasVolumeAccessControlRequest):
            return False
