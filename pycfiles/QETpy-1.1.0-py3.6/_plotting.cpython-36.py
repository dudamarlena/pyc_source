...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/qetpy/plotting/_plotting.py
# Compiled at: 2019-02-07 14:38:29
# Size of source mod 2**32: 57680 bytes
...
__all__ = [
 'plot_psd', 'plot_reim_psd', 'plot_corrcoeff', 'plot_csd', 'plot_decorrelatednoise',
            ...
            for ii in range(nrows * 2):
                ...
                if ii < num_subplots:
                    if nrows > 1:
                        ...
                        axes[(irow, jcolumn)].set_ylabel('Input Referenced Noise [A/$\\sqrt{\\mathrm{Hz}}$]', fontsize=25)
                ...
                if ii < num_subplots:
                    if nrows == 1:
                        ...
                        axes[jcolumn].set_ylabel('Input Referenced Noise [A/$\\sqrt{\\mathrm{Hz}}$]', fontsize=25)
        ...
        if OFnonlinOBJ.npolefit == 3:
            ...
            if OFnonlinOBJ.npolefit == 4:
                ...
                if OFnonlinOBJ.npolefit == 3 or OFnonlinOBJ.npolefit == 4:
                    nmax = t0ind + int(9 * tau_f1 * OFnonlinOBJ.fs)
                else:
                ...
                if OFnonlinOBJ.npolefit == 4:
                    ...
                    if OFnonlinOBJ.npolefit == 4:
                        axes[0][0].loglog(f, (np.abs((OFnonlinOBJ.fourpole)(*variables))[cf]), c='r', label='Fit')
                    else:
                        if OFnonlinOBJ.npolefit == 3:
                            axes[0][0].loglog(f, (np.abs((OFnonlinOBJ.threepole)(*variables))[cf]), c='r', label='Fit')
                        else:
                        ...
                        if OFnonlinOBJ.npolefit == 4:
                            axes[0][1].plot((OFnonlinOBJ.time[nmin:nmax] * 1000.0), ((OFnonlinOBJ.fourpoletime)(*variables)[nmin:nmax]),
                              c='r',
                              label='time domain')
                        else:
                            if OFnonlinOBJ.npolefit == 3:
                                axes[0][1].plot((OFnonlinOBJ.time[nmin:nmax] * 1000.0), ((OFnonlinOBJ.threepoletime)(*variables)[nmin:nmax]),
                                  c='r',
                                  label='time domain')
                            else:
                                axes[0][1].plot((OFnonlinOBJ.time[nmin:nmax] * 1000.0), ((OFnonlinOBJ.twopoletime)(*variables)[nmin:nmax]),
                                  c='r',
                                  label='time domain')
                    axes[0][1].ticklabel_format(style='sci', axis='y', scilimits=(0,
                                                                                  0))
                    ...
                    if OFnonlinOBJ.npolefit == 4:
                        axes[1][0].plot((OFnonlinOBJ.time * 1000.0), (OFnonlinOBJ.fourpoletime)(*variables), c='r', label='time domain')
                    else:
                        if OFnonlinOBJ.npolefit == 3:
                            axes[1][0].plot((OFnonlinOBJ.time * 1000.0), (OFnonlinOBJ.threepoletime)(*variables), c='r', label='time domain')
                        else:
            ...
            if OFnonlinOBJ.npolefit == 4:
                labels = [
                 f"A: ({A * 1000000.0:.4f} +\\- {A_err * 1000000.0:.4f}) [$\\mu$A]",
                 f"B: ({B * 1000000.0:.4f} +\\- {B_err * 1000000.0:.4f}) [$\\mu$A]",
                 f"C: ({C * 1000000.0:.4f} +\\- {C_err * 1000000.0:.4f}) [$\\mu$A]",
                 f"τ, f1: ({tau_f1 * 1000000.0:.4f} +\\- {tau_f1_err * 1000000.0:.4f}) [$\\mu$s]",
                 f"τ, f2: ({tau_f2 * 1000000.0:.4f} +\\- {tau_f2_err * 1000000.0:.4f}) [$\\mu$s]",
                 f"τ, f3: ({tau_f3 * 1000000.0:.4f} +\\- {tau_f3_err * 1000000.0:.4f}) [$\\mu$s]",
                 f"$t_0$: ({t0 * 1000.0:.4f} +\\- {t0_err * 1000.0:.4f}) [ms]",
                 f"τ$_r$: ({tau_r * 1000000.0:.4f} +\\- {tau_r_err * 1000000.0:.4f}) [$\\mu$s]"]
            else:
                if OFnonlinOBJ.npolefit == 3:
                    labels = [
                     f"A: ({A * 1000000.0:.4f} +\\- {A_err * 1000000.0:.4f}) [$\\mu$A]",
                    ...
                    labels = [
                     f"Amplitude: ({A * 1000000.0:.4f} +\\- {A_err * 1000000.0:.4f}) [$\\mu$A]",
                     f"τ$_f$: ({tau_f * 1000000.0:.4f} +\\- {tau_f_err * 1000000.0:.4f}) [$\\mu$s]",
                     f"$t_0$: ({t0 * 1000.0:.4f} +\\- {t0_err * 1000.0:.4f}) [ms]",
                     f"τ$_r$: ({tau_r * 1000000.0:.4f} +\\- {tau_r_err * 1000000.0:.4f}) [$\\mu$s]"]
