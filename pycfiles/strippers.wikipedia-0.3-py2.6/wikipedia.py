...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/strippers/wikipedia.py
# Compiled at: 2011-01-17 23:52:29
import urllib, urllib2, json, types
...
__all__ = ('USER_AGENT', 'WikiArticle', 'open_article')
...
class WikiArticle(object):
    ...
    def __init__(self, soup):
        self.soup = soup
        self.disambiguation = soup.find('a', title='Category:曖昧さ回避') is not None
        return
