...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scythe/algo/algomod.py
# Compiled at: 2014-06-14 10:52:10
...
class AlgoHandler(object):
    ...
    def initCollProc(self, scoringDct, sequenceDct):
        ...
        return (
         processed, unprocessed, coll, uncoll, species2id)
            ...
            for u in uncoll:
                ...
                if scoringDct[u]:
                    ...
                    if tmpMax > globMax:
                        ...
                        if fav:
                            globMaxSps = (
                             sequenceDct[fav[0][0]].species, sequenceDct[fav[0][1]].species)
                            ...
                            if fav1:
                                ...
                                globMaxSps = (
                                 sequenceDct[globMaxIds[0]].species, sequenceDct[u].species)
    ...
    def mx_sum(self, scoringDct, sequenceDct):
        ...
        while max(keylengths) < len(unprocessed):
                ...
                if newtup not in tmdct:
                    ...
                    for l in t:
                        try:
                            ...
                            try:
                                addscore = addscore + pairwisedist[(k, l)]
                            except KeyError:
