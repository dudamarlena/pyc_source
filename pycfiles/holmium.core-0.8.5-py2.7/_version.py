...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/holmium/core/_version.py
...
tag_prefix = ''
parentdir_prefix = 'holmium.core-'
versionfile_source = 'holmium/core/_version.py'
