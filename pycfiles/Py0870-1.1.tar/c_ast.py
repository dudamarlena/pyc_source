...
# Embedded file name: ../py010parser/c_ast.py
    ...
    def show(self, buf=sys.stdout, offset=0, attrnames=False, nodenames=False, showcoord=False, _my_node_name=None):
        ...
        for child_name, child in self.children():
            if isinstance(child, list):
                for entry in child:
                    entry.show(buf, offset=offset + 2, attrnames=attrnames, nodenames=nodenames, showcoord=showcoord, _my_node_name=child_name)
