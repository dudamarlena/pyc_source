...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/datalogue/models/credentials.py
# Compiled at: 2020-05-13 11:17:34
# Size of source mod 2**32: 11259 bytes
import abc
...
class S3Credentials(Credentials):
    ...
    def __init__(self, region: str, client_id: Optional[str]=None, client_secret: Optional[str]=None, endpoint: Optional[str]=None, encryption: Optional[Encryption]=None):
...
class AzureCredentials(Credentials):
    ...
    def __init__(self, account_name: str, account_key: str, endpoint_protocol: AzureEndpointProtocol, blob_type: AzureBlobType):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(account_name: {self.account_name!r}, endpoint_protocol: {self.endpoint_protocol!r}, blob_type: {self.blob_type!r}, account_key: ****)"
...
class HadoopAzureCredentials(Credentials):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(account_name: {self.account_name!r}, account_key: ****)"
...
class AzureSASCredentials(Credentials):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(sas_token: ****, endpoint: {self.endpoint!r})"
