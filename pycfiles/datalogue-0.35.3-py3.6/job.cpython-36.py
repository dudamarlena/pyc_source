...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/datalogue/models/job.py
# Compiled at: 2020-05-13 11:17:34
# Size of source mod 2**32: 10912 bytes
...
class Job:
    ...
    def __init__(self, id: UUID, pipeline_id: Optional[UUID], run_at: datetime, status: JobStatus, remaining_time_millis: Optional[int], percentage_progress: Optional[float], created_by: UUID, errors: Optional[str], started_at: Optional[datetime], ended_at: Optional[datetime], average_records_speed: float, current_records_speed: float, estimated_processed_records_count: int, average_bytes_speed: Optional[float], current_bytes_speed: Optional[float], estimated_processed_bytes_count: Optional[int], total_source_records: Optional[int], total_source_bytes: Optional[int], wait_on: List[UUID]=[], abort_if_overlong: bool=True, frequency: Optional[str]=None, parent_job_id: Optional[UUID]=None):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(id: {self.id!r}, pipeline_id: {self.pipeline_id!r}, status: {self.status!r}, run_at: {self.run_at!r}, wait_on: {self.wait_on!r}, created_by: {self.created_by!r}, remaining_time_millis: {self.remaining_time_millis!r}, percent_progress: {self.percentage_progress!r}, errors: {self.errors!r}, average_records_speed: {self.average_records_speed!r}, current_records_speed: {self.current_records_speed!r}, estimated_processed_records_count: {self.estimated_processed_records_count!r}, average_bytes_speed: {self.average_bytes_speed!r}, current_bytes_speed: {self.current_bytes_speed!r}, estimated_processed_bytes_count: {self.estimated_processed_bytes_count!r}, total_source_records: {self.total_source_records!r}, total_source_bytes: {self.total_source_bytes!r}, ended_at: {self.ended_at!r}, started_at: {self.started_at!r}, abort_if_overlong: {self.abort_if_overlong}, frequency: {self.frequency}, parent_job_id: {self.parent_job_id})"
