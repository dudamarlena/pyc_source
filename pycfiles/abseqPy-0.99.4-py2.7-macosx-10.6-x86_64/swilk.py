...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/TAMO/util/util/swilk.py
...
class intp(_object):
    ...
    def assign(*args):
        return apply(_swilk.intp_assign, args)

    def value(*args):
        return apply(_swilk.intp_value, args)

    def cast(*args):
        return apply(_swilk.intp_cast, args)

    __swig_getmethods__['frompointer'] = lambda x: _swilk.intp_frompointer
    if _newclass:
        frompointer = staticmethod(_swilk.intp_frompointer)
...
class intpPtr(intp):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, intp, 'thisown', 0)
...
class floatp(_object):
    ...
    def assign(*args):
        return apply(_swilk.floatp_assign, args)

    def value(*args):
        return apply(_swilk.floatp_value, args)

    def cast(*args):
        return apply(_swilk.floatp_cast, args)

    __swig_getmethods__['frompointer'] = lambda x: _swilk.floatp_frompointer
    if _newclass:
        frompointer = staticmethod(_swilk.floatp_frompointer)
...
class floatpPtr(floatp):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, floatp, 'thisown', 0)
...
class floatArray(_object):
    ...
    def __getitem__(*args):
        return apply(_swilk.floatArray___getitem__, args)

    def __setitem__(*args):
        return apply(_swilk.floatArray___setitem__, args)

    def cast(*args):
        return apply(_swilk.floatArray_cast, args)

    __swig_getmethods__['frompointer'] = lambda x: _swilk.floatArray_frompointer
    if _newclass:
        frompointer = staticmethod(_swilk.floatArray_frompointer)
...
class floatArrayPtr(floatArray):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, floatArray, 'thisown', 0)
...
def swilk(vect):
    ...
    n_p.assign(len(vect))
    n1_p = intp()
    n1_p.assign(len(vect))
    n2_p = intp()
    n2_p.assign(len(vect) / 2)
    w_p = floatp()
    pw_p = floatp()
    status_p = intp()
    zero = [0] * len(vect)
    ...
    statuses = ['ok ',
     'n1 < 3 ',
     'n > 5000 (non-fatal error) ',
     'n2 < n/2, so insufficient storage for a()',
     'n1 > n or ((n1 < n) & (n < 20)) ',
     'proportion censored, (n-n1)/n, > 0.8 ',
     'effectively zero range (assuming data sorted) ',
     'data not in increasing sort order ']
    if status != 0:
