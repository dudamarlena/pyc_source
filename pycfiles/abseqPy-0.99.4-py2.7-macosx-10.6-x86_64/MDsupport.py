...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/TAMO/MD/MDsupport.py
...
class IntVector(_object):
    ...
    def __len__(*args):
        return apply(_MDsupport.IntVector___len__, args)

    def __nonzero__(*args):
        return apply(_MDsupport.IntVector___nonzero__, args)

    def clear(*args):
        return apply(_MDsupport.IntVector_clear, args)

    def append(*args):
        return apply(_MDsupport.IntVector_append, args)

    def pop(*args):
        return apply(_MDsupport.IntVector_pop, args)

    def __getitem__(*args):
        return apply(_MDsupport.IntVector___getitem__, args)

    def __getslice__(*args):
        return apply(_MDsupport.IntVector___getslice__, args)

    def __setitem__(*args):
        return apply(_MDsupport.IntVector___setitem__, args)

    def __setslice__(*args):
        return apply(_MDsupport.IntVector___setslice__, args)

    def __delitem__(*args):
        return apply(_MDsupport.IntVector___delitem__, args)

    def __delslice__(*args):
        return apply(_MDsupport.IntVector___delslice__, args)
...
class IntVectorPtr(IntVector):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, IntVector, 'thisown', 0)
...
class DoubleVector(_object):
    ...
    def __len__(*args):
        return apply(_MDsupport.DoubleVector___len__, args)

    def __nonzero__(*args):
        return apply(_MDsupport.DoubleVector___nonzero__, args)

    def clear(*args):
        return apply(_MDsupport.DoubleVector_clear, args)

    def append(*args):
        return apply(_MDsupport.DoubleVector_append, args)

    def pop(*args):
        return apply(_MDsupport.DoubleVector_pop, args)

    def __getitem__(*args):
        return apply(_MDsupport.DoubleVector___getitem__, args)

    def __getslice__(*args):
        return apply(_MDsupport.DoubleVector___getslice__, args)

    def __setitem__(*args):
        return apply(_MDsupport.DoubleVector___setitem__, args)

    def __setslice__(*args):
        return apply(_MDsupport.DoubleVector___setslice__, args)

    def __delitem__(*args):
        return apply(_MDsupport.DoubleVector___delitem__, args)

    def __delslice__(*args):
        return apply(_MDsupport.DoubleVector___delslice__, args)
...
class DoubleVectorPtr(DoubleVector):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, DoubleVector, 'thisown', 0)
...
class ProbePtr(Probe):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, Probe, 'thisown', 0)
...
class Probelist_str(_object):
    ...
    if _newclass:
        count = property(_MDsupport.Probelist_str_count_get, _MDsupport.Probelist_str_count_set)
    ...
    if _newclass:
        probes = property(_MDsupport.Probelist_str_probes_get, _MDsupport.Probelist_str_probes_set)
    ...
    def append(*args):
        return apply(_MDsupport.Probelist_str_append, args)
    ...
    def count_re_matches(*args):
        return apply(_MDsupport.Probelist_str_count_re_matches, args)
...
class Probelist_strPtr(Probelist_str):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, Probelist_str, 'thisown', 0)
...
class Probelist(_object):
    ...
    if _newclass:
        count = property(_MDsupport.Probelist_count_get, _MDsupport.Probelist_count_set)
    __swig_setmethods__['probes'] = _MDsupport.Probelist_probes_set
    __swig_getmethods__['probes'] = _MDsupport.Probelist_probes_get
    if _newclass:
        probes = property(_MDsupport.Probelist_probes_get, _MDsupport.Probelist_probes_set)
    ...
    def append(*args):
        return apply(_MDsupport.Probelist_append, args)
    ...
    def get_Z(*args):
        return apply(_MDsupport.Probelist_get_Z, args)

    def get_Zlist(*args):
        return apply(_MDsupport.Probelist_get_Zlist, args)
...
class ProbelistPtr(Probelist):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, Probelist, 'thisown', 0)
...
class SeqMat(_object):
    ...
    def scanbest(*args):
        return apply(_MDsupport.SeqMat_scanbest, args)

    def sumscoresabove(*args):
        return apply(_MDsupport.SeqMat_sumscoresabove, args)

    def score(*args):
        return apply(_MDsupport.SeqMat_score, args)

    def set(*args):
        return apply(_MDsupport.SeqMat_set, args)

    def get(*args):
        return apply(_MDsupport.SeqMat_get, args)

    def get_c(*args):
        return apply(_MDsupport.SeqMat_get_c, args)

    def compute_ambig(*args):
        return apply(_MDsupport.SeqMat_compute_ambig, args)

    def matchstarts(*args):
        return apply(_MDsupport.SeqMat_matchstarts, args)

    def score_probe(*args):
        return apply(_MDsupport.SeqMat_score_probe, args)

    def EMstep(*args):
        return apply(_MDsupport.SeqMat_EMstep, args)

    def setBg(*args):
        return apply(_MDsupport.SeqMat_setBg, args)

    def setmask(*args):
        return apply(_MDsupport.SeqMat_setmask, args)

    def loglikelihood(*args):
        return apply(_MDsupport.SeqMat_loglikelihood, args)
...
class SeqMatPtr(SeqMat):
    ...
    def __init__(self, this):
        ...
        if not hasattr(self, 'thisown'):
            _swig_setattr(self, SeqMat, 'thisown', 0)
