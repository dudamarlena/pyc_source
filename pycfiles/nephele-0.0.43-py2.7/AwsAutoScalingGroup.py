...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/nephele/AwsAutoScalingGroup.py
# Compiled at: 2017-08-01 10:50:37
...
class AwsAutoScalingGroup(AwsProcessor):
    ...
    def do_run(self, args):
        ...
        parser.add_argument(dest='command', nargs='+', help='Command to run on all hosts.')
        ...
        Parallel(n_jobs=jobs)(delayed(ssh)(instance['InstanceId'], 0, [], replaceKey, keyscan, False, verbosity, command, ignoreHostKey=ignoreHostKey, echoCommand=not noEcho, name=('{}:{}: ').format(instance['index'], instance['InstanceId'])) for instance in instances)
