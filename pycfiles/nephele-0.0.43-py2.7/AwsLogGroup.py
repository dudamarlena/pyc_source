...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/nephele/AwsLogGroup.py
# Compiled at: 2017-05-24 08:32:36
import AwsLogStream
...
class AwsLogGroup(AwsProcessor):
    ...
    def loadLogStreams(self):
        response = AwsConnectionFactory.getLogClient().describe_log_streams(logGroupName=self.stackResource.physical_resource_id, orderBy=self.orderBy, descending=self.descending)
