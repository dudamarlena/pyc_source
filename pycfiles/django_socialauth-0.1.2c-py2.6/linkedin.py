...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/socialauth/lib/linkedin.py
...
Enjoy!
"""
import hashlib, urllib2, httplib, time
...
class ProfileApi(LinkedInApi):
    ...
    """
    PROFILE_SELF = LinkedIn.LI_API_URL + '/v1/people/~:(id,first-name,last-name,headline,industry,picture-url,site-standard-profile-request)'
