...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/socialauth/auth_backends.py
# Compiled at: 2010-07-05 02:11:14
        ...
        try:
            ...
            if request.openid and request.openid.sreg:
                ...
                if 'google' in provider:
                    ...
                    try:
                        nickname = request.openid.ax.getSingle(ax_schema['nickname'])
