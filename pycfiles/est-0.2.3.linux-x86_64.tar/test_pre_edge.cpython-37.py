...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/est_venv/lib/python3.7/site-packages/est/core/process/larch/test/test_pre_edge.py
...
try:
    ...
    has_larch = True
    from est.core.process.larch.pre_edge import larch_pre_edge, process_spectr_pre_edge
...
class TestLarchSpectrum(unittest.TestCase):
    ...
    def testProcess(self):
        ...
        conf, res_spectrum = process_spectr_pre_edge(self.spectrum, self.configuration)
