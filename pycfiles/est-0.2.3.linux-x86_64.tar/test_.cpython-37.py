...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/est_venv/lib/python3.7/site-packages/est/app/test_.py
...
__license__ = 'MIT'
__date__ = '12/01/2018'
import sys, argparse, logging, unittest
...
def main(argv):
    ...
    if options.verbose == 1:
        ...
        if options.verbose > 1:
            ...
            test_verbosity = 2
            use_buffer = False
        elif options.qt_binding and options.gui is True:
