...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/est_venv/lib/python3.7/site-packages/est/gui/icons.py
# Compiled at: 2020-03-05 02:52:24
# Size of source mod 2**32: 13556 bytes
...
def getQFile(name):
    ...
    for format_ in _supported_formats:
        format_ = str(format_)
        filename = est.resources._resource_filename(('%s.%s' % (name, format_)), default_directory=(os.path.join('gui', 'icons')))
