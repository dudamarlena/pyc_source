...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/est_venv/lib/python3.7/site-packages/orangecontrib/est/widgets/larch/xftf.py
# Compiled at: 2020-03-05 02:52:24
# Size of source mod 2**32: 10623 bytes
__authors__ = [
 'H. Payno']
__license__ = 'MIT'
__date__ = '06/07/2019'
...
from est.gui.XasObjectViewer import XasObjectViewer, ViewType, _plot_chir_mag, _plot_chir_re, _plot_chir_imag
...
class XFTFWindow(qt.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        mapKeys = [
         'mu', 'chir', 'chir_mag', 'chir_re', 'chir_im', 'chir_pha']
        ...
        self._parametersWindow = _ParameterWindowContainer(parent=self, parametersWindow=_MXFTFParameters)
...
class XFTFOW(_ProcessForOrangeMixIn, OWWidget):
    ...
    name = 'xftf'
    id = 'orange.widgets.xas.larch.xftf'
    description = 'forward XAFS Fourier transform, from chi(k) to chi(R), using common XAFS conventions.'
    icon = 'icons/xftf.png'
    priority = 2
    ...
    def process(self, xas_obj):
        if xas_obj is None:
            ...
            elif 'SET_KWEIGHT' in xas_obj.configuration:
            ...
            if _USE_THREAD is True:
                ...
                process_obj.setProperties({'_larchSettings': self._window._mainwidget._parametersWindow.getParameters()})
...
class QLarch_xftf(est.core.process.larch.xftf.Larch_xftf):
    ...
    def _pool_process(self, xas_obj):
        ...
        for spectrum in xas_obj.spectra:
            runnable = ProcessRunnable(fct=(est.core.process.larch.xftf.process_spectr_xftf), spectrum=spectrum,
