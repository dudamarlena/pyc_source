...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/est_venv/lib/python3.7/site-packages/orangecontrib/est/widgets/larch/mback.py
...
class MbackOW(_ProcessForOrangeMixIn, OWWidget):
    ...
    description = "Match mu(E) data for tabulated f''(E) using the MBACK algorithm and, optionally, the Lee & Xiang extension"
...
class QLarch_mback(est.core.process.larch.mback.Larch_mback):
    ...
    def _pool_process(self, xas_obj):
        ...
        for spectrum in xas_obj.spectra:
            runnable = ProcessRunnable(fct=(est.core.process.larch.mback.process_spectr_mback), spectrum=spectrum,
