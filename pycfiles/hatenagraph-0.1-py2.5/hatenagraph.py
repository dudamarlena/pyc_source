...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hatenagraph.py
# Compiled at: 2009-03-04 08:03:35
import base64, random, sha, urllib2, urllib
...
class HatenaGraph:
    ...
    def get_data(self, graphname, userid=None):
        if userid is None:
            userid = self.userid
        params = {'graphname': graphname, 'type': 'yaml', 
           'username': userid}
