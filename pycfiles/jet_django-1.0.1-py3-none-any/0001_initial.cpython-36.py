...
class Migration(migrations.Migration):
    ...
    dependencies = []
    operations = [
     migrations.CreateModel(name='Dashboard',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'dashboard', 
      'verbose_name_plural':'dashboards', 
      'ordering':('ordering', )}),
     migrations.CreateModel(name='MenuSettings',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'date_add', models.DateTimeField(default=(django.utils.timezone.now), verbose_name='date added'))],
       options={'verbose_name':'menu settings', 
      'verbose_name_plural':'menu settings'}),
     migrations.CreateModel(name='ModelDescription',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'date_add', models.DateTimeField(default=(django.utils.timezone.now), verbose_name='date added'))],
       options={'verbose_name':'model description', 
      'verbose_name_plural':'model descriptions'}),
     migrations.CreateModel(name='Token',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='ViewSettings',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'date_add', models.DateTimeField(default=(django.utils.timezone.now), verbose_name='date added'))],
       options={'verbose_name':'view settings', 
      'verbose_name_plural':'views settings'}),
     migrations.CreateModel(name='Widget',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
