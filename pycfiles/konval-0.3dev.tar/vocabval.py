...
# [GCC 8.4.0]
# Embedded file name: /home/f0/paul/Projects/Py-konval/konval/konval/vocabval.py
# Compiled at: 2011-08-02 09:57:36
"""
    ...
    def __init__(self, vocab, canonize=False, allow_other=False):
        """
                ...
                For example::
                        ...
                        >>> v = IsInVocab(d, allow_other=True)
                        >>> v('corge')
                        'corge'
                        >>> v = IsInVocab(d, canonize=True, allow_other=True)
                        >>> v('foo')
                        'FOO'
                        >>> v('bar')
                        'BAZ'
