...
# [GCC 8.4.0]
# Embedded file name: /home/f0/paul/Projects/Py-konval/konval/konval/stringval.py
# Compiled at: 2011-08-02 10:01:25
"""
...
class ToStripped(BaseValidator):
    """
...
class IsPlainText(IsRegexMatch):
    ...
    def __init__(self):
        IsRegexMatch.__init__(self, '^[a-zA-Z_\\-0-9]*$')
