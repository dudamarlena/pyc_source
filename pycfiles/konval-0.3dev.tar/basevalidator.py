...
# [GCC 8.4.0]
# Embedded file name: /home/f0/paul/Projects/Py-konval/konval/konval/basevalidator.py
# Compiled at: 2011-07-22 10:07:14
"""
Abstract base class for easy construction of validators.

"""
__docformat__ = 'restructuredtext en'
import exceptions, impl
__all__ = [
 'BaseValidator',
 'WrappingValidator']
...
class BaseValidator(object):
    ...
    def raise_conversion_error(self, bad_val, err):
        """
                ...
                messages.
                """
        raise exceptions.ValueError(self.make_conversion_error_msg(bad_val, err))
    ...
    def raise_validation_error(self, bad_val, err):
        """
                ...
                messages.
                """
        raise exceptions.ValueError(self.make_validation_error_msg(bad_val, err))
