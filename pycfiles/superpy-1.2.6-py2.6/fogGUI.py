...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\superpy\demos\pyfog\fogGUI.py
...
class PyFogCmd(GUIUtils.GenericGUICommand):
    ...
    def __init__(self, name='PyFog'):
        ...
        GUIUtils.GenericGUICommand.__init__(self, name, self.run, argList=argList)
    ...
    def _MakeArgList():
        ...
        return [
         ...
         (
          'webSourceFile',
          GUIValidators.ExistingFileNameValidator(initialDir=defaults.__path__[0]),
          '\n            String name of file containing web sites to include as source.\n            '),
         (
          'rssSourceFile',
          GUIValidators.ExistingFileNameValidator(initialDir=defaults.__path__[0], default=os.path.join(defaults.__path__[0], 'exampleRSS.txt')),
         ...
         (
          'user',
          GUIValidators.StringValidator(os.getenv('USER', os.getenv('USERNAME', ''))),
