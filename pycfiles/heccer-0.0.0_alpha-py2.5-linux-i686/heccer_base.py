...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/heccer/heccer_base.py
# Compiled at: 2011-09-13 02:51:45
import _heccer_base, new
...
class InternalResults(_object):
    ...
    if _newclass:
        dVm = _swig_property(_heccer_base.InternalResults_dVm_get, _heccer_base.InternalResults_dVm_set)
...
class ExternalResults(_object):
    ...
    if _newclass:
        dConductance = _swig_property(_heccer_base.ExternalResults_dConductance_get, _heccer_base.ExternalResults_dConductance_set)
    ...
    if _newclass:
        dCurrent = _swig_property(_heccer_base.ExternalResults_dCurrent_get, _heccer_base.ExternalResults_dCurrent_set)
...
class Compartment(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.Compartment_mc_get, _heccer_base.Compartment_mc_set)
    ...
    if _newclass:
        iParent = _swig_property(_heccer_base.Compartment_iParent_get, _heccer_base.Compartment_iParent_set)
    __swig_setmethods__['dCm'] = _heccer_base.Compartment_dCm_set
    __swig_getmethods__['dCm'] = _heccer_base.Compartment_dCm_get
    if _newclass:
        dCm = _swig_property(_heccer_base.Compartment_dCm_get, _heccer_base.Compartment_dCm_set)
    __swig_setmethods__['dEm'] = _heccer_base.Compartment_dEm_set
    __swig_getmethods__['dEm'] = _heccer_base.Compartment_dEm_get
    if _newclass:
        dEm = _swig_property(_heccer_base.Compartment_dEm_get, _heccer_base.Compartment_dEm_set)
    ...
    if _newclass:
        dInitVm = _swig_property(_heccer_base.Compartment_dInitVm_get, _heccer_base.Compartment_dInitVm_set)
    ...
    if _newclass:
        dInject = _swig_property(_heccer_base.Compartment_dInject_get, _heccer_base.Compartment_dInject_set)
    __swig_setmethods__['dRa'] = _heccer_base.Compartment_dRa_set
    __swig_getmethods__['dRa'] = _heccer_base.Compartment_dRa_get
    if _newclass:
        dRa = _swig_property(_heccer_base.Compartment_dRa_get, _heccer_base.Compartment_dRa_set)
    __swig_setmethods__['dRm'] = _heccer_base.Compartment_dRm_set
    __swig_getmethods__['dRm'] = _heccer_base.Compartment_dRm_get
    if _newclass:
        dRm = _swig_property(_heccer_base.Compartment_dRm_get, _heccer_base.Compartment_dRm_set)
...
class EventDistributorMatrix(_object):
    ...
    if _newclass:
        pvObject = _swig_property(_heccer_base.EventDistributorMatrix_pvObject_get, _heccer_base.EventDistributorMatrix_pvObject_set)
    ...
    if _newclass:
        iTarget = _swig_property(_heccer_base.EventDistributorMatrix_iTarget_get, _heccer_base.EventDistributorMatrix_iTarget_set)
    ...
    if _newclass:
        pvProcess = _swig_property(_heccer_base.EventDistributorMatrix_pvProcess_get, _heccer_base.EventDistributorMatrix_pvProcess_set)
...
class EventDistributorData(_object):
    ...
    if _newclass:
        iConnections = _swig_property(_heccer_base.EventDistributorData_iConnections_get, _heccer_base.EventDistributorData_iConnections_set)
    ...
    if _newclass:
        iLast = _swig_property(_heccer_base.EventDistributorData_iLast_get, _heccer_base.EventDistributorData_iLast_set)
    ...
    if _newclass:
        ppedm = _swig_property(_heccer_base.EventDistributorData_ppedm_get, _heccer_base.EventDistributorData_ppedm_set)
...
class EventDistributor(_object):
    ...
    if _newclass:
        pedd = _swig_property(_heccer_base.EventDistributor_pedd_get, _heccer_base.EventDistributor_pedd_set)
    ...
    if _newclass:
        eventDistribute = _swig_property(_heccer_base.EventDistributor_eventDistribute_get, _heccer_base.EventDistributor_eventDistribute_set)
    ...
    if _newclass:
        iSerialEnd = _swig_property(_heccer_base.EventDistributor_iSerialEnd_get, _heccer_base.EventDistributor_iSerialEnd_set)
    ...
    if _newclass:
        iSerialStart = _swig_property(_heccer_base.EventDistributor_iSerialStart_get, _heccer_base.EventDistributor_iSerialStart_set)
...
class EventQueuerMatrix(_object):
    ...
    if _newclass:
        pvObject = _swig_property(_heccer_base.EventQueuerMatrix_pvObject_get, _heccer_base.EventQueuerMatrix_pvObject_set)
    ...
    if _newclass:
        pdEvent = _swig_property(_heccer_base.EventQueuerMatrix_pdEvent_get, _heccer_base.EventQueuerMatrix_pdEvent_set)
    ...
    if _newclass:
        dDelay = _swig_property(_heccer_base.EventQueuerMatrix_dDelay_get, _heccer_base.EventQueuerMatrix_dDelay_set)
    ...
    if _newclass:
        dWeight = _swig_property(_heccer_base.EventQueuerMatrix_dWeight_get, _heccer_base.EventQueuerMatrix_dWeight_set)
    ...
    if _newclass:
        pvAccept = _swig_property(_heccer_base.EventQueuerMatrix_pvAccept_get, _heccer_base.EventQueuerMatrix_pvAccept_set)
...
class EventQueuerData(_object):
    ...
    if _newclass:
        iConnectionIndices = _swig_property(_heccer_base.EventQueuerData_iConnectionIndices_get, _heccer_base.EventQueuerData_iConnectionIndices_set)
    ...
    if _newclass:
        ppiSerial2ConnectionIndex = _swig_property(_heccer_base.EventQueuerData_ppiSerial2ConnectionIndex_get, _heccer_base.EventQueuerData_ppiSerial2ConnectionIndex_set)
    ...
    if _newclass:
        iRows = _swig_property(_heccer_base.EventQueuerData_iRows_get, _heccer_base.EventQueuerData_iRows_set)
    ...
    if _newclass:
        ppeqm = _swig_property(_heccer_base.EventQueuerData_ppeqm_get, _heccer_base.EventQueuerData_ppeqm_set)
...
class EventQueuer(_object):
    ...
    if _newclass:
        peqd = _swig_property(_heccer_base.EventQueuer_peqd_get, _heccer_base.EventQueuer_peqd_set)
    ...
    if _newclass:
        eventDequeue = _swig_property(_heccer_base.EventQueuer_eventDequeue_get, _heccer_base.EventQueuer_eventDequeue_set)
...
class simobj_DES(_object):
    ...
    if _newclass:
        pcName = _swig_property(_heccer_base.simobj_DES_pcName_get, _heccer_base.simobj_DES_pcName_set)
    ...
    if _newclass:
        iStatus = _swig_property(_heccer_base.simobj_DES_iStatus_get, _heccer_base.simobj_DES_iStatus_set)
    ...
    if _newclass:
        iErrorCount = _swig_property(_heccer_base.simobj_DES_iErrorCount_get, _heccer_base.simobj_DES_iErrorCount_set)
    ...
    if _newclass:
        iPreSerials = _swig_property(_heccer_base.simobj_DES_iPreSerials_get, _heccer_base.simobj_DES_iPreSerials_set)
    ...
    if _newclass:
        piPreSerials = _swig_property(_heccer_base.simobj_DES_piPreSerials_get, _heccer_base.simobj_DES_piPreSerials_set)
    __swig_setmethods__['pped'] = _heccer_base.simobj_DES_pped_set
    __swig_getmethods__['pped'] = _heccer_base.simobj_DES_pped_get
    if _newclass:
        pped = _swig_property(_heccer_base.simobj_DES_pped_get, _heccer_base.simobj_DES_pped_set)
    ...
    if _newclass:
        iCores = _swig_property(_heccer_base.simobj_DES_iCores_get, _heccer_base.simobj_DES_iCores_set)
    __swig_setmethods__['ppeq'] = _heccer_base.simobj_DES_ppeq_set
    __swig_getmethods__['ppeq'] = _heccer_base.simobj_DES_ppeq_get
    if _newclass:
        ppeq = _swig_property(_heccer_base.simobj_DES_ppeq_get, _heccer_base.simobj_DES_ppeq_set)
...
class Intermediary(_object):
    ...
    if _newclass:
        iCompartments = _swig_property(_heccer_base.Intermediary_iCompartments_get, _heccer_base.Intermediary_iCompartments_set)
    ...
    if _newclass:
        pcomp = _swig_property(_heccer_base.Intermediary_pcomp_get, _heccer_base.Intermediary_pcomp_set)
    __swig_setmethods__['pmca'] = _heccer_base.Intermediary_pmca_set
    __swig_getmethods__['pmca'] = _heccer_base.Intermediary_pmca_get
    if _newclass:
        pmca = _swig_property(_heccer_base.Intermediary_pmca_get, _heccer_base.Intermediary_pmca_set)
    ...
    if _newclass:
        piC2m = _swig_property(_heccer_base.Intermediary_piC2m_get, _heccer_base.Intermediary_piC2m_set)
    ...
    if _newclass:
        iSerialStart = _swig_property(_heccer_base.Intermediary_iSerialStart_get, _heccer_base.Intermediary_iSerialStart_set)
    ...
    if _newclass:
        iSerialEnd = _swig_property(_heccer_base.Intermediary_iSerialEnd_get, _heccer_base.Intermediary_iSerialEnd_set)
...
class HeccerOptions(_object):
    ...
    if _newclass:
        iOptions = _swig_property(_heccer_base.HeccerOptions_iOptions_get, _heccer_base.HeccerOptions_iOptions_set)
    ...
    if _newclass:
        iCorrections = _swig_property(_heccer_base.HeccerOptions_iCorrections_get, _heccer_base.HeccerOptions_iCorrections_set)
    ...
    if _newclass:
        iIntervalSet = _swig_property(_heccer_base.HeccerOptions_iIntervalSet_get, _heccer_base.HeccerOptions_iIntervalSet_set)
    ...
    if _newclass:
        dIntervalStart = _swig_property(_heccer_base.HeccerOptions_dIntervalStart_get, _heccer_base.HeccerOptions_dIntervalStart_set)
    ...
    if _newclass:
        dIntervalEnd = _swig_property(_heccer_base.HeccerOptions_dIntervalEnd_get, _heccer_base.HeccerOptions_dIntervalEnd_set)
    ...
    if _newclass:
        iActivatorSet = _swig_property(_heccer_base.HeccerOptions_iActivatorSet_get, _heccer_base.HeccerOptions_iActivatorSet_set)
    ...
    if _newclass:
        dConcentrationGateStart = _swig_property(_heccer_base.HeccerOptions_dConcentrationGateStart_get, _heccer_base.HeccerOptions_dConcentrationGateStart_set)
    ...
    if _newclass:
        dConcentrationGateEnd = _swig_property(_heccer_base.HeccerOptions_dConcentrationGateEnd_get, _heccer_base.HeccerOptions_dConcentrationGateEnd_set)
    ...
    if _newclass:
        iIntervalEntries = _swig_property(_heccer_base.HeccerOptions_iIntervalEntries_get, _heccer_base.HeccerOptions_iIntervalEntries_set)
    ...
    if _newclass:
        iSmallTableSize = _swig_property(_heccer_base.HeccerOptions_iSmallTableSize_get, _heccer_base.HeccerOptions_iSmallTableSize_set)
...
class simobj_Heccer(_object):
    ...
    if _newclass:
        pcName = _swig_property(_heccer_base.simobj_Heccer_pcName_get, _heccer_base.simobj_Heccer_pcName_set)
    ...
    if _newclass:
        iStatus = _swig_property(_heccer_base.simobj_Heccer_iStatus_get, _heccer_base.simobj_Heccer_iStatus_set)
    ...
    if _newclass:
        iErrorCount = _swig_property(_heccer_base.simobj_Heccer_iErrorCount_get, _heccer_base.simobj_Heccer_iErrorCount_set)
    __swig_setmethods__['ho'] = _heccer_base.simobj_Heccer_ho_set
    __swig_getmethods__['ho'] = _heccer_base.simobj_Heccer_ho_get
    if _newclass:
        ho = _swig_property(_heccer_base.simobj_Heccer_ho_get, _heccer_base.simobj_Heccer_ho_set)
    ...
    if _newclass:
        dTime = _swig_property(_heccer_base.simobj_Heccer_dTime_get, _heccer_base.simobj_Heccer_dTime_set)
    ...
    if _newclass:
        dStep = _swig_property(_heccer_base.simobj_Heccer_dStep_get, _heccer_base.simobj_Heccer_dStep_set)
    __swig_setmethods__['pts'] = _heccer_base.simobj_Heccer_pts_set
    __swig_getmethods__['pts'] = _heccer_base.simobj_Heccer_pts_get
    if _newclass:
        pts = _swig_property(_heccer_base.simobj_Heccer_pts_get, _heccer_base.simobj_Heccer_pts_set)
    __swig_setmethods__['ped'] = _heccer_base.simobj_Heccer_ped_set
    __swig_getmethods__['ped'] = _heccer_base.simobj_Heccer_ped_get
    if _newclass:
        ped = _swig_property(_heccer_base.simobj_Heccer_ped_get, _heccer_base.simobj_Heccer_ped_set)
    __swig_setmethods__['peq'] = _heccer_base.simobj_Heccer_peq_set
    __swig_getmethods__['peq'] = _heccer_base.simobj_Heccer_peq_get
    if _newclass:
        peq = _swig_property(_heccer_base.simobj_Heccer_peq_get, _heccer_base.simobj_Heccer_peq_set)
    ...
    if _newclass:
        inter = _swig_property(_heccer_base.simobj_Heccer_inter_get, _heccer_base.simobj_Heccer_inter_set)
    ...
    if _newclass:
        indexers = _swig_property(_heccer_base.simobj_Heccer_indexers_get, _heccer_base.simobj_Heccer_indexers_set)
    __swig_setmethods__['tgt'] = _heccer_base.simobj_Heccer_tgt_set
    __swig_getmethods__['tgt'] = _heccer_base.simobj_Heccer_tgt_get
    if _newclass:
        tgt = _swig_property(_heccer_base.simobj_Heccer_tgt_get, _heccer_base.simobj_Heccer_tgt_set)
    __swig_setmethods__['tsmt'] = _heccer_base.simobj_Heccer_tsmt_set
    __swig_getmethods__['tsmt'] = _heccer_base.simobj_Heccer_tsmt_get
    if _newclass:
        tsmt = _swig_property(_heccer_base.simobj_Heccer_tsmt_get, _heccer_base.simobj_Heccer_tsmt_set)
    __swig_setmethods__['vm'] = _heccer_base.simobj_Heccer_vm_set
    __swig_getmethods__['vm'] = _heccer_base.simobj_Heccer_vm_get
    if _newclass:
        vm = _swig_property(_heccer_base.simobj_Heccer_vm_get, _heccer_base.simobj_Heccer_vm_set)
...
class MathComponent(_object):
    ...
    if _newclass:
        iType = _swig_property(_heccer_base.MathComponent_iType_get, _heccer_base.MathComponent_iType_set)
    ...
    if _newclass:
        iSerial = _swig_property(_heccer_base.MathComponent_iSerial_get, _heccer_base.MathComponent_iSerial_set)
    ...
    if _newclass:
        iModelSourceType = _swig_property(_heccer_base.MathComponent_iModelSourceType_get, _heccer_base.MathComponent_iModelSourceType_set)
    ...
    if _newclass:
        iPrototype = _swig_property(_heccer_base.MathComponent_iPrototype_get, _heccer_base.MathComponent_iPrototype_set)
...
class MathComponentArray(_object):
    ...
    if _newclass:
        iMathComponents = _swig_property(_heccer_base.MathComponentArray_iMathComponents_get, _heccer_base.MathComponentArray_iMathComponents_set)
    ...
    if _newclass:
        pmc = _swig_property(_heccer_base.MathComponentArray_pmc_get, _heccer_base.MathComponentArray_pmc_set)
    ...
    if _newclass:
        ppmcIndex = _swig_property(_heccer_base.MathComponentArray_ppmcIndex_get, _heccer_base.MathComponentArray_ppmcIndex_set)
    ...
    if _newclass:
        iCursor = _swig_property(_heccer_base.MathComponentArray_iCursor_get, _heccer_base.MathComponentArray_iCursor_set)
    ...
    if _newclass:
        pmcCursor = _swig_property(_heccer_base.MathComponentArray_pmcCursor_get, _heccer_base.MathComponentArray_pmcCursor_set)
...
class MathComponentInfo(_object):
    ...
    if _newclass:
        iType = _swig_property(_heccer_base.MathComponentInfo_iType_get, _heccer_base.MathComponentInfo_iType_set)
    ...
    if _newclass:
        iChars = _swig_property(_heccer_base.MathComponentInfo_iChars_get, _heccer_base.MathComponentInfo_iChars_set)
...
class SpringMassParameters(_object):
    ...
    if _newclass:
        dTau1 = _swig_property(_heccer_base.SpringMassParameters_dTau1_get, _heccer_base.SpringMassParameters_dTau1_set)
    ...
    if _newclass:
        dTau2 = _swig_property(_heccer_base.SpringMassParameters_dTau2_get, _heccer_base.SpringMassParameters_dTau2_set)
...
class ChannelSpringMass(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelSpringMass_mc_get, _heccer_base.ChannelSpringMass_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelSpringMass_dReversalPotential_get, _heccer_base.ChannelSpringMass_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelSpringMass_iReversalPotential_get, _heccer_base.ChannelSpringMass_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelSpringMass_dMaximalConductance_get, _heccer_base.ChannelSpringMass_dMaximalConductance_set)
    ...
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelSpringMass_iPool_get, _heccer_base.ChannelSpringMass_iPool_set)
    ...
    if _newclass:
        dFrequency = _swig_property(_heccer_base.ChannelSpringMass_dFrequency_get, _heccer_base.ChannelSpringMass_dFrequency_set)
    ...
    if _newclass:
        dInitX = _swig_property(_heccer_base.ChannelSpringMass_dInitX_get, _heccer_base.ChannelSpringMass_dInitX_set)
    ...
    if _newclass:
        dInitY = _swig_property(_heccer_base.ChannelSpringMass_dInitY_get, _heccer_base.ChannelSpringMass_dInitY_set)
    ...
    if _newclass:
        iTable = _swig_property(_heccer_base.ChannelSpringMass_iTable_get, _heccer_base.ChannelSpringMass_iTable_set)
    ...
    if _newclass:
        pdEventTimes = _swig_property(_heccer_base.ChannelSpringMass_pdEventTimes_get, _heccer_base.ChannelSpringMass_pdEventTimes_set)
    ...
    if _newclass:
        pcEventTimes = _swig_property(_heccer_base.ChannelSpringMass_pcEventTimes_get, _heccer_base.ChannelSpringMass_pcEventTimes_set)
    ...
    if _newclass:
        parameters = _swig_property(_heccer_base.ChannelSpringMass_parameters_get, _heccer_base.ChannelSpringMass_parameters_set)
...
class ExponentialDecay(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ExponentialDecay_mc_get, _heccer_base.ExponentialDecay_mc_set)
    ...
    if _newclass:
        dInitValue = _swig_property(_heccer_base.ExponentialDecay_dInitValue_get, _heccer_base.ExponentialDecay_dInitValue_set)
    ...
    if _newclass:
        dBeta = _swig_property(_heccer_base.ExponentialDecay_dBeta_get, _heccer_base.ExponentialDecay_dBeta_set)
    ...
    if _newclass:
        dSteadyState = _swig_property(_heccer_base.ExponentialDecay_dSteadyState_get, _heccer_base.ExponentialDecay_dSteadyState_set)
    ...
    if _newclass:
        dTau = _swig_property(_heccer_base.ExponentialDecay_dTau_get, _heccer_base.ExponentialDecay_dTau_set)
    ...
    if _newclass:
        piExternal = _swig_property(_heccer_base.ExponentialDecay_piExternal_get, _heccer_base.ExponentialDecay_piExternal_set)
...
class ConstantNernst(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ConstantNernst_mc_get, _heccer_base.ConstantNernst_mc_set)
    ...
    if _newclass:
        dCin = _swig_property(_heccer_base.ConstantNernst_dCin_get, _heccer_base.ConstantNernst_dCin_set)
    ...
    if _newclass:
        dConstant = _swig_property(_heccer_base.ConstantNernst_dConstant_get, _heccer_base.ConstantNernst_dConstant_set)
    ...
    if _newclass:
        dCout = _swig_property(_heccer_base.ConstantNernst_dCout_get, _heccer_base.ConstantNernst_dCout_set)
...
class ExternalNernst(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ExternalNernst_mc_get, _heccer_base.ExternalNernst_mc_set)
    ...
    if _newclass:
        dConstant = _swig_property(_heccer_base.ExternalNernst_dConstant_get, _heccer_base.ExternalNernst_dConstant_set)
    ...
    if _newclass:
        dInternal = _swig_property(_heccer_base.ExternalNernst_dInternal_get, _heccer_base.ExternalNernst_dInternal_set)
    ...
    if _newclass:
        iExternal = _swig_property(_heccer_base.ExternalNernst_iExternal_get, _heccer_base.ExternalNernst_iExternal_set)
    ...
    if _newclass:
        dInitPotential = _swig_property(_heccer_base.ExternalNernst_dInitPotential_get, _heccer_base.ExternalNernst_dInitPotential_set)
...
class InternalNernst(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.InternalNernst_mc_get, _heccer_base.InternalNernst_mc_set)
    ...
    if _newclass:
        dConstant = _swig_property(_heccer_base.InternalNernst_dConstant_get, _heccer_base.InternalNernst_dConstant_set)
    ...
    if _newclass:
        iInternal = _swig_property(_heccer_base.InternalNernst_iInternal_get, _heccer_base.InternalNernst_iInternal_set)
    ...
    if _newclass:
        dExternal = _swig_property(_heccer_base.InternalNernst_dExternal_get, _heccer_base.InternalNernst_dExternal_set)
    ...
    if _newclass:
        dInitPotential = _swig_property(_heccer_base.InternalNernst_dInitPotential_get, _heccer_base.InternalNernst_dInitPotential_set)
...
class SpikeGenerator(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.SpikeGenerator_mc_get, _heccer_base.SpikeGenerator_mc_set)
    ...
    if _newclass:
        dRefractory = _swig_property(_heccer_base.SpikeGenerator_dRefractory_get, _heccer_base.SpikeGenerator_dRefractory_set)
    ...
    if _newclass:
        dThreshold = _swig_property(_heccer_base.SpikeGenerator_dThreshold_get, _heccer_base.SpikeGenerator_dThreshold_set)
    ...
    if _newclass:
        dReset = _swig_property(_heccer_base.SpikeGenerator_dReset_get, _heccer_base.SpikeGenerator_dReset_set)
    ...
    if _newclass:
        iSource2Targets = _swig_property(_heccer_base.SpikeGenerator_iSource2Targets_get, _heccer_base.SpikeGenerator_iSource2Targets_set)
...
class GateKinetic(_object):
    ...
    if _newclass:
        dHHAddNum = _swig_property(_heccer_base.GateKinetic_dHHAddNum_get, _heccer_base.GateKinetic_dHHAddNum_set)
    ...
    if _newclass:
        dHHMult = _swig_property(_heccer_base.GateKinetic_dHHMult_get, _heccer_base.GateKinetic_dHHMult_set)
    ...
    if _newclass:
        dHHOffsetM = _swig_property(_heccer_base.GateKinetic_dHHOffsetM_get, _heccer_base.GateKinetic_dHHOffsetM_set)
    ...
    if _newclass:
        iHHFactorFlag = _swig_property(_heccer_base.GateKinetic_iHHFactorFlag_get, _heccer_base.GateKinetic_iHHFactorFlag_set)
    ...
    if _newclass:
        dHHAddDen = _swig_property(_heccer_base.GateKinetic_dHHAddDen_get, _heccer_base.GateKinetic_dHHAddDen_set)
    ...
    if _newclass:
        dHHOffsetE = _swig_property(_heccer_base.GateKinetic_dHHOffsetE_get, _heccer_base.GateKinetic_dHHOffsetE_set)
    ...
    if _newclass:
        dHHDivE = _swig_property(_heccer_base.GateKinetic_dHHDivE_get, _heccer_base.GateKinetic_dHHDivE_set)
    ...
    if _newclass:
        dHHMultExp = _swig_property(_heccer_base.GateKinetic_dHHMultExp_get, _heccer_base.GateKinetic_dHHMultExp_set)
...
class GateConceptParameters(_object):
    ...
    if _newclass:
        gkA = _swig_property(_heccer_base.GateConceptParameters_gkA_get, _heccer_base.GateConceptParameters_gkA_set)
    ...
    if _newclass:
        gkB = _swig_property(_heccer_base.GateConceptParameters_gkB_get, _heccer_base.GateConceptParameters_gkB_set)
...
class GateConcept(_object):
    ...
    if _newclass:
        dInitActivation = _swig_property(_heccer_base.GateConcept_dInitActivation_get, _heccer_base.GateConcept_dInitActivation_set)
    ...
    if _newclass:
        iTable = _swig_property(_heccer_base.GateConcept_iTable_get, _heccer_base.GateConcept_iTable_set)
    ...
    if _newclass:
        parameters = _swig_property(_heccer_base.GateConcept_parameters_get, _heccer_base.GateConcept_parameters_set)
    __swig_setmethods__['htg'] = _heccer_base.GateConcept_htg_set
    __swig_getmethods__['htg'] = _heccer_base.GateConcept_htg_get
    if _newclass:
        htg = _swig_property(_heccer_base.GateConcept_htg_get, _heccer_base.GateConcept_htg_set)
...
class PoweredGateConcept(_object):
    ...
    if _newclass:
        iPower = _swig_property(_heccer_base.PoweredGateConcept_iPower_get, _heccer_base.PoweredGateConcept_iPower_set)
    ...
    if _newclass:
        gc = _swig_property(_heccer_base.PoweredGateConcept_gc_get, _heccer_base.PoweredGateConcept_gc_set)
...
class ChannelActInact(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelActInact_mc_get, _heccer_base.ChannelActInact_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelActInact_dReversalPotential_get, _heccer_base.ChannelActInact_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelActInact_iReversalPotential_get, _heccer_base.ChannelActInact_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelActInact_dMaximalConductance_get, _heccer_base.ChannelActInact_dMaximalConductance_set)
    ...
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelActInact_iPool_get, _heccer_base.ChannelActInact_iPool_set)
    ...
    if _newclass:
        pgcActivation = _swig_property(_heccer_base.ChannelActInact_pgcActivation_get, _heccer_base.ChannelActInact_pgcActivation_set)
    ...
    if _newclass:
        pgcInactivation = _swig_property(_heccer_base.ChannelActInact_pgcInactivation_get, _heccer_base.ChannelActInact_pgcInactivation_set)
...
class ChannelAct(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelAct_mc_get, _heccer_base.ChannelAct_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelAct_dReversalPotential_get, _heccer_base.ChannelAct_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelAct_iReversalPotential_get, _heccer_base.ChannelAct_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelAct_dMaximalConductance_get, _heccer_base.ChannelAct_dMaximalConductance_set)
    __swig_setmethods__['iPool'] = _heccer_base.ChannelAct_iPool_set
    __swig_getmethods__['iPool'] = _heccer_base.ChannelAct_iPool_get
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelAct_iPool_get, _heccer_base.ChannelAct_iPool_set)
    __swig_setmethods__['pgc'] = _heccer_base.ChannelAct_pgc_set
    __swig_getmethods__['pgc'] = _heccer_base.ChannelAct_pgc_get
    if _newclass:
        pgc = _swig_property(_heccer_base.ChannelAct_pgc_get, _heccer_base.ChannelAct_pgc_set)
...
class DualTauParameters(_object):
    ...
    if _newclass:
        dSteadyState = _swig_property(_heccer_base.DualTauParameters_dSteadyState_get, _heccer_base.DualTauParameters_dSteadyState_set)
    __swig_getmethods__['tau'] = _heccer_base.DualTauParameters_tau_get
    if _newclass:
        tau = _swig_property(_heccer_base.DualTauParameters_tau_get)
...
class DualTauParameters_tau(_object):
    ...
    if _newclass:
        dMultiplier = _swig_property(_heccer_base.DualTauParameters_tau_dMultiplier_get, _heccer_base.DualTauParameters_tau_dMultiplier_set)
    ...
    if _newclass:
        dDeNominatorOffset = _swig_property(_heccer_base.DualTauParameters_tau_dDeNominatorOffset_get, _heccer_base.DualTauParameters_tau_dDeNominatorOffset_set)
    ...
    if _newclass:
        dMembraneOffset = _swig_property(_heccer_base.DualTauParameters_tau_dMembraneOffset_get, _heccer_base.DualTauParameters_tau_dMembraneOffset_set)
    ...
    if _newclass:
        dTauDenormalizer = _swig_property(_heccer_base.DualTauParameters_tau_dTauDenormalizer_get, _heccer_base.DualTauParameters_tau_dTauDenormalizer_set)
...
class ChannelPersistentSteadyStateDualTau(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_mc_get, _heccer_base.ChannelPersistentSteadyStateDualTau_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_dReversalPotential_get, _heccer_base.ChannelPersistentSteadyStateDualTau_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_iReversalPotential_get, _heccer_base.ChannelPersistentSteadyStateDualTau_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_dMaximalConductance_get, _heccer_base.ChannelPersistentSteadyStateDualTau_dMaximalConductance_set)
    ...
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_iPool_get, _heccer_base.ChannelPersistentSteadyStateDualTau_iPool_set)
    ...
    if _newclass:
        iFirstPower = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_iFirstPower_get, _heccer_base.ChannelPersistentSteadyStateDualTau_iFirstPower_set)
    ...
    if _newclass:
        iSecondPower = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_iSecondPower_get, _heccer_base.ChannelPersistentSteadyStateDualTau_iSecondPower_set)
    ...
    if _newclass:
        iFirstTable = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_iFirstTable_get, _heccer_base.ChannelPersistentSteadyStateDualTau_iFirstTable_set)
    ...
    if _newclass:
        iSecondTable = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_iSecondTable_get, _heccer_base.ChannelPersistentSteadyStateDualTau_iSecondTable_set)
    ...
    if _newclass:
        dFirstInitActivation = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_dFirstInitActivation_get, _heccer_base.ChannelPersistentSteadyStateDualTau_dFirstInitActivation_set)
    ...
    if _newclass:
        dSecondInitActivation = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_dSecondInitActivation_get, _heccer_base.ChannelPersistentSteadyStateDualTau_dSecondInitActivation_set)
    ...
    if _newclass:
        parameters1 = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_parameters1_get, _heccer_base.ChannelPersistentSteadyStateDualTau_parameters1_set)
    ...
    if _newclass:
        parameters2 = _swig_property(_heccer_base.ChannelPersistentSteadyStateDualTau_parameters2_get, _heccer_base.ChannelPersistentSteadyStateDualTau_parameters2_set)
...
class ChannelPersistentSteadyStateTau(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_mc_get, _heccer_base.ChannelPersistentSteadyStateTau_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_dReversalPotential_get, _heccer_base.ChannelPersistentSteadyStateTau_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_iReversalPotential_get, _heccer_base.ChannelPersistentSteadyStateTau_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_dMaximalConductance_get, _heccer_base.ChannelPersistentSteadyStateTau_dMaximalConductance_set)
    ...
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_iPool_get, _heccer_base.ChannelPersistentSteadyStateTau_iPool_set)
    ...
    if _newclass:
        iPower = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_iPower_get, _heccer_base.ChannelPersistentSteadyStateTau_iPower_set)
    ...
    if _newclass:
        iTable = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_iTable_get, _heccer_base.ChannelPersistentSteadyStateTau_iTable_set)
    ...
    if _newclass:
        dInitActivation = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_dInitActivation_get, _heccer_base.ChannelPersistentSteadyStateTau_dInitActivation_set)
    __swig_getmethods__['parameters'] = _heccer_base.ChannelPersistentSteadyStateTau_parameters_get
    if _newclass:
        parameters = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_get)
...
class ChannelPersistentSteadyStateTau_parameters(_object):
    ...
    if _newclass:
        tc = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_get)
    __swig_getmethods__['ss'] = _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_get
    if _newclass:
        ss = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_get)
...
class ChannelPersistentSteadyStateTau_parameters_tc(_object):
    ...
    if _newclass:
        dNominator = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dNominator_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dNominator_set)
    ...
    if _newclass:
        dDeNominatorOffset = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dDeNominatorOffset_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dDeNominatorOffset_set)
    ...
    if _newclass:
        dMembraneOffset = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dMembraneOffset_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dMembraneOffset_set)
    ...
    if _newclass:
        dTauDenormalizer = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dTauDenormalizer_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_tc_dTauDenormalizer_set)
...
class ChannelPersistentSteadyStateTau_parameters_ss(_object):
    ...
    if _newclass:
        dNominator = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dNominator_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dNominator_set)
    ...
    if _newclass:
        dMultiplier1 = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMultiplier1_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMultiplier1_set)
    ...
    if _newclass:
        dMembraneOffset1 = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMembraneOffset1_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMembraneOffset1_set)
    ...
    if _newclass:
        dTauDenormalizer1 = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dTauDenormalizer1_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dTauDenormalizer1_set)
    ...
    if _newclass:
        dMultiplier2 = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMultiplier2_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMultiplier2_set)
    ...
    if _newclass:
        dMembraneOffset2 = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMembraneOffset2_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dMembraneOffset2_set)
    ...
    if _newclass:
        dTauDenormalizer2 = _swig_property(_heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dTauDenormalizer2_get, _heccer_base.ChannelPersistentSteadyStateTau_parameters_ss_dTauDenormalizer2_set)
...
class DualSteadyStateParameters(_object):
    ...
    if _newclass:
        second = _swig_property(_heccer_base.DualSteadyStateParameters_second_get, _heccer_base.DualSteadyStateParameters_second_set)
    __swig_getmethods__['first'] = _heccer_base.DualSteadyStateParameters_first_get
    if _newclass:
        first = _swig_property(_heccer_base.DualSteadyStateParameters_first_get)
...
class DualSteadyStateParameters_first(_object):
    ...
    if _newclass:
        b = _swig_property(_heccer_base.DualSteadyStateParameters_first_b_get)
    __swig_getmethods__['a'] = _heccer_base.DualSteadyStateParameters_first_a_get
    if _newclass:
        a = _swig_property(_heccer_base.DualSteadyStateParameters_first_a_get)
...
class DualSteadyStateParameters_first_b(_object):
    ...
    if _newclass:
        dMultiplier = _swig_property(_heccer_base.DualSteadyStateParameters_first_b_dMultiplier_get, _heccer_base.DualSteadyStateParameters_first_b_dMultiplier_set)
    ...
    if _newclass:
        dTauDenormalizer = _swig_property(_heccer_base.DualSteadyStateParameters_first_b_dTauDenormalizer_get, _heccer_base.DualSteadyStateParameters_first_b_dTauDenormalizer_set)
    ...
    if _newclass:
        dMembraneDependenceOffset = _swig_property(_heccer_base.DualSteadyStateParameters_first_b_dMembraneDependenceOffset_get, _heccer_base.DualSteadyStateParameters_first_b_dMembraneDependenceOffset_set)
...
class DualSteadyStateParameters_first_a(_object):
    ...
    if _newclass:
        dMultiplier = _swig_property(_heccer_base.DualSteadyStateParameters_first_a_dMultiplier_get, _heccer_base.DualSteadyStateParameters_first_a_dMultiplier_set)
    ...
    if _newclass:
        dMembraneDependenceOffset = _swig_property(_heccer_base.DualSteadyStateParameters_first_a_dMembraneDependenceOffset_get, _heccer_base.DualSteadyStateParameters_first_a_dMembraneDependenceOffset_set)
    ...
    if _newclass:
        dDeNominatorOffset = _swig_property(_heccer_base.DualSteadyStateParameters_first_a_dDeNominatorOffset_get, _heccer_base.DualSteadyStateParameters_first_a_dDeNominatorOffset_set)
    ...
    if _newclass:
        dMembraneOffset = _swig_property(_heccer_base.DualSteadyStateParameters_first_a_dMembraneOffset_get, _heccer_base.DualSteadyStateParameters_first_a_dMembraneOffset_set)
    ...
    if _newclass:
        dTauDenormalizer = _swig_property(_heccer_base.DualSteadyStateParameters_first_a_dTauDenormalizer_get, _heccer_base.DualSteadyStateParameters_first_a_dTauDenormalizer_set)
...
class SteppedTimeConstantParameters(_object):
    ...
    if _newclass:
        b = _swig_property(_heccer_base.SteppedTimeConstantParameters_b_get)
    __swig_getmethods__['a'] = _heccer_base.SteppedTimeConstantParameters_a_get
    if _newclass:
        a = _swig_property(_heccer_base.SteppedTimeConstantParameters_a_get)
...
class SteppedTimeConstantParameters_b(_object):
    ...
    if _newclass:
        dDeNominatorOffset = _swig_property(_heccer_base.SteppedTimeConstantParameters_b_dDeNominatorOffset_get, _heccer_base.SteppedTimeConstantParameters_b_dDeNominatorOffset_set)
    ...
    if _newclass:
        dMembraneOffset = _swig_property(_heccer_base.SteppedTimeConstantParameters_b_dMembraneOffset_get, _heccer_base.SteppedTimeConstantParameters_b_dMembraneOffset_set)
    ...
    if _newclass:
        dTauDenormalizer = _swig_property(_heccer_base.SteppedTimeConstantParameters_b_dTauDenormalizer_get, _heccer_base.SteppedTimeConstantParameters_b_dTauDenormalizer_set)
...
class SteppedTimeConstantParameters_a(_object):
    ...
    if _newclass:
        dThreshold = _swig_property(_heccer_base.SteppedTimeConstantParameters_a_dThreshold_get, _heccer_base.SteppedTimeConstantParameters_a_dThreshold_set)
    ...
    if _newclass:
        dLowTarget = _swig_property(_heccer_base.SteppedTimeConstantParameters_a_dLowTarget_get, _heccer_base.SteppedTimeConstantParameters_a_dLowTarget_set)
    ...
    if _newclass:
        dHighTarget = _swig_property(_heccer_base.SteppedTimeConstantParameters_a_dHighTarget_get, _heccer_base.SteppedTimeConstantParameters_a_dHighTarget_set)
...
class ChannelSteadyStateSteppedTau(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_mc_get, _heccer_base.ChannelSteadyStateSteppedTau_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_dReversalPotential_get, _heccer_base.ChannelSteadyStateSteppedTau_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_iReversalPotential_get, _heccer_base.ChannelSteadyStateSteppedTau_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_dMaximalConductance_get, _heccer_base.ChannelSteadyStateSteppedTau_dMaximalConductance_set)
    ...
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_iPool_get, _heccer_base.ChannelSteadyStateSteppedTau_iPool_set)
    ...
    if _newclass:
        iFirstPower = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_iFirstPower_get, _heccer_base.ChannelSteadyStateSteppedTau_iFirstPower_set)
    ...
    if _newclass:
        iSecondPower = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_iSecondPower_get, _heccer_base.ChannelSteadyStateSteppedTau_iSecondPower_set)
    ...
    if _newclass:
        iFirstTable = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_iFirstTable_get, _heccer_base.ChannelSteadyStateSteppedTau_iFirstTable_set)
    ...
    if _newclass:
        iSecondTable = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_iSecondTable_get, _heccer_base.ChannelSteadyStateSteppedTau_iSecondTable_set)
    ...
    if _newclass:
        dFirstInitActivation = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_dFirstInitActivation_get, _heccer_base.ChannelSteadyStateSteppedTau_dFirstInitActivation_set)
    ...
    if _newclass:
        dSecondInitActivation = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_dSecondInitActivation_get, _heccer_base.ChannelSteadyStateSteppedTau_dSecondInitActivation_set)
    ...
    if _newclass:
        ss_parameters = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_ss_parameters_get, _heccer_base.ChannelSteadyStateSteppedTau_ss_parameters_set)
    ...
    if _newclass:
        tc_parameters = _swig_property(_heccer_base.ChannelSteadyStateSteppedTau_tc_parameters_get, _heccer_base.ChannelSteadyStateSteppedTau_tc_parameters_set)
...
class ActivatorParameters(_object):
    ...
    if _newclass:
        dBasalLevel = _swig_property(_heccer_base.ActivatorParameters_dBasalLevel_get, _heccer_base.ActivatorParameters_dBasalLevel_set)
    ...
    if _newclass:
        dTau = _swig_property(_heccer_base.ActivatorParameters_dTau_get, _heccer_base.ActivatorParameters_dTau_set)
...
class ConcentrationActivator(_object):
    ...
    if _newclass:
        dInitActivation = _swig_property(_heccer_base.ConcentrationActivator_dInitActivation_get, _heccer_base.ConcentrationActivator_dInitActivation_set)
    ...
    if _newclass:
        iTable = _swig_property(_heccer_base.ConcentrationActivator_iTable_get, _heccer_base.ConcentrationActivator_iTable_set)
    ...
    if _newclass:
        iActivator = _swig_property(_heccer_base.ConcentrationActivator_iActivator_get, _heccer_base.ConcentrationActivator_iActivator_set)
    ...
    if _newclass:
        parameters = _swig_property(_heccer_base.ConcentrationActivator_parameters_get, _heccer_base.ConcentrationActivator_parameters_set)
    ...
    if _newclass:
        htg = _swig_property(_heccer_base.ConcentrationActivator_htg_get, _heccer_base.ConcentrationActivator_htg_set)
...
class PoweredActivatorConcept(_object):
    ...
    if _newclass:
        iPower = _swig_property(_heccer_base.PoweredActivatorConcept_iPower_get, _heccer_base.PoweredActivatorConcept_iPower_set)
    ...
    if _newclass:
        ca = _swig_property(_heccer_base.PoweredActivatorConcept_ca_get, _heccer_base.PoweredActivatorConcept_ca_set)
...
class ChannelActConc(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelActConc_mc_get, _heccer_base.ChannelActConc_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelActConc_dReversalPotential_get, _heccer_base.ChannelActConc_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelActConc_iReversalPotential_get, _heccer_base.ChannelActConc_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelActConc_dMaximalConductance_get, _heccer_base.ChannelActConc_dMaximalConductance_set)
    ...
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelActConc_iPool_get, _heccer_base.ChannelActConc_iPool_set)
    __swig_setmethods__['pgc'] = _heccer_base.ChannelActConc_pgc_set
    __swig_getmethods__['pgc'] = _heccer_base.ChannelActConc_pgc_get
    if _newclass:
        pgc = _swig_property(_heccer_base.ChannelActConc_pgc_get, _heccer_base.ChannelActConc_pgc_set)
    __swig_setmethods__['pac'] = _heccer_base.ChannelActConc_pac_set
    __swig_getmethods__['pac'] = _heccer_base.ChannelActConc_pac_get
    if _newclass:
        pac = _swig_property(_heccer_base.ChannelActConc_pac_get, _heccer_base.ChannelActConc_pac_set)
...
class ChannelConc(_object):
    ...
    if _newclass:
        mc = _swig_property(_heccer_base.ChannelConc_mc_get, _heccer_base.ChannelConc_mc_set)
    ...
    if _newclass:
        dReversalPotential = _swig_property(_heccer_base.ChannelConc_dReversalPotential_get, _heccer_base.ChannelConc_dReversalPotential_set)
    ...
    if _newclass:
        iReversalPotential = _swig_property(_heccer_base.ChannelConc_iReversalPotential_get, _heccer_base.ChannelConc_iReversalPotential_set)
    ...
    if _newclass:
        dMaximalConductance = _swig_property(_heccer_base.ChannelConc_dMaximalConductance_get, _heccer_base.ChannelConc_dMaximalConductance_set)
    __swig_setmethods__['iPool'] = _heccer_base.ChannelConc_iPool_set
    __swig_getmethods__['iPool'] = _heccer_base.ChannelConc_iPool_get
    if _newclass:
        iPool = _swig_property(_heccer_base.ChannelConc_iPool_get, _heccer_base.ChannelConc_iPool_set)
    __swig_setmethods__['pac'] = _heccer_base.ChannelConc_pac_set
    __swig_getmethods__['pac'] = _heccer_base.ChannelConc_pac_get
    if _newclass:
        pac = _swig_property(_heccer_base.ChannelConc_pac_get, _heccer_base.ChannelConc_pac_set)
...
class HeccerInterval(_object):
    ...
    if _newclass:
        dStart = _swig_property(_heccer_base.HeccerInterval_dStart_get, _heccer_base.HeccerInterval_dStart_set)
    ...
    if _newclass:
        dEnd = _swig_property(_heccer_base.HeccerInterval_dEnd_get, _heccer_base.HeccerInterval_dEnd_set)
    ...
    if _newclass:
        dStep = _swig_property(_heccer_base.HeccerInterval_dStep_get, _heccer_base.HeccerInterval_dStep_set)
...
class HeccerTableApproximationOptions(_object):
    ...
    if _newclass:
        iShape = _swig_property(_heccer_base.HeccerTableApproximationOptions_iShape_get, _heccer_base.HeccerTableApproximationOptions_iShape_set)
...
class HeccerTabulatedGate(_object):
    ...
    if _newclass:
        pvParameters = _swig_property(_heccer_base.HeccerTabulatedGate_pvParameters_get, _heccer_base.HeccerTabulatedGate_pvParameters_set)
    ...
    if _newclass:
        iSizeParameters = _swig_property(_heccer_base.HeccerTabulatedGate_iSizeParameters_get, _heccer_base.HeccerTabulatedGate_iSizeParameters_set)
    ...
    if _newclass:
        hi = _swig_property(_heccer_base.HeccerTabulatedGate_hi_get, _heccer_base.HeccerTabulatedGate_hi_set)
    ...
    if _newclass:
        htao = _swig_property(_heccer_base.HeccerTabulatedGate_htao_get, _heccer_base.HeccerTabulatedGate_htao_set)
    ...
    if _newclass:
        iEntries = _swig_property(_heccer_base.HeccerTabulatedGate_iEntries_get, _heccer_base.HeccerTabulatedGate_iEntries_set)
    ...
    if _newclass:
        pdA = _swig_property(_heccer_base.HeccerTabulatedGate_pdA_get, _heccer_base.HeccerTabulatedGate_pdA_set)
    ...
    if _newclass:
        pdB = _swig_property(_heccer_base.HeccerTabulatedGate_pdB_get, _heccer_base.HeccerTabulatedGate_pdB_set)
...
class HeccerTabulatedSpringMass(_object):
    ...
    if _newclass:
        pvParameters = _swig_property(_heccer_base.HeccerTabulatedSpringMass_pvParameters_get, _heccer_base.HeccerTabulatedSpringMass_pvParameters_set)
    ...
    if _newclass:
        iSizeParameters = _swig_property(_heccer_base.HeccerTabulatedSpringMass_iSizeParameters_get, _heccer_base.HeccerTabulatedSpringMass_iSizeParameters_set)
    ...
    if _newclass:
        dX1 = _swig_property(_heccer_base.HeccerTabulatedSpringMass_dX1_get, _heccer_base.HeccerTabulatedSpringMass_dX1_set)
    ...
    if _newclass:
        dX2 = _swig_property(_heccer_base.HeccerTabulatedSpringMass_dX2_get, _heccer_base.HeccerTabulatedSpringMass_dX2_set)
    ...
    if _newclass:
        dY1 = _swig_property(_heccer_base.HeccerTabulatedSpringMass_dY1_get, _heccer_base.HeccerTabulatedSpringMass_dY1_set)
    ...
    if _newclass:
        dY2 = _swig_property(_heccer_base.HeccerTabulatedSpringMass_dY2_get, _heccer_base.HeccerTabulatedSpringMass_dY2_set)
...
class TabulatedGateTable(_object):
    ...
    if _newclass:
        phtg = _swig_property(_heccer_base.TabulatedGateTable_phtg_get, _heccer_base.TabulatedGateTable_phtg_set)
    ...
    if _newclass:
        iTabulatedGateCount = _swig_property(_heccer_base.TabulatedGateTable_iTabulatedGateCount_get, _heccer_base.TabulatedGateTable_iTabulatedGateCount_set)
    ...
    if _newclass:
        pdRearranged = _swig_property(_heccer_base.TabulatedGateTable_pdRearranged_get, _heccer_base.TabulatedGateTable_pdRearranged_set)
...
class TabulatedSpringMassTable(_object):
    ...
    if _newclass:
        phtsm = _swig_property(_heccer_base.TabulatedSpringMassTable_phtsm_get, _heccer_base.TabulatedSpringMassTable_phtsm_set)
    ...
    if _newclass:
        iTabulatedSpringMassCount = _swig_property(_heccer_base.TabulatedSpringMassTable_iTabulatedSpringMassCount_get, _heccer_base.TabulatedSpringMassTable_iTabulatedSpringMassCount_set)
...
class TranslationServiceData(_object):
    ...
    if _newclass:
        pneuro = _swig_property(_heccer_base.TranslationServiceData_pneuro_get, _heccer_base.TranslationServiceData_pneuro_set)
    ...
    if _newclass:
        ppistRoot = _swig_property(_heccer_base.TranslationServiceData_ppistRoot_get, _heccer_base.TranslationServiceData_ppistRoot_set)
    ...
    if _newclass:
        phsleRoot = _swig_property(_heccer_base.TranslationServiceData_phsleRoot_get, _heccer_base.TranslationServiceData_phsleRoot_set)
    ...
    if _newclass:
        iModel = _swig_property(_heccer_base.TranslationServiceData_iModel_get, _heccer_base.TranslationServiceData_iModel_set)
