...
# Size of source mod 2**32: 5939 bytes
"""
------------------------------
...
class HTTPSessionClient:
    __doc__ = 'HTTPClient with permanent cookies'
    ...
    def _parse_body(self, kw):
        ...
        if body:
            if data or djson:
                raise AssertionError('you should not specified body with data/json')
        if data:
            if djson:
                raise AssertionError('you should not specified both data and json')
        if data:
