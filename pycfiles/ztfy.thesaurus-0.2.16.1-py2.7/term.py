...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/thesaurus/term.py
# Compiled at: 2013-12-05 11:35:00
...
REVERSE_LINK_ATTRIBUTES = {'generic': 'specifics', 'usage': 'used_for'}
REVERSE_LIST_ATTRIBUTES = {'specifics': 'generic', 'used_for': 'usage'}
...
class ThesaurusTerm(Persistent, Contained):
    ...
    def __init__(self, label, alt=None, definition=None, note=None, generic=None, specifics=[], associations=[], usage=None, used_for=[], created=None, modified=None):
        self.label = label
        self.alt = alt
    ...
    def queryExtensions(self):
        return [ util for util in [ queryUtility(IThesaurusTermExtension, ext) for ext in self.extensions ] if util is not None ]
