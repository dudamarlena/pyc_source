...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/thesaurus/loader/skos.py
# Compiled at: 2013-10-03 05:33:27
import chardet
from lxml import etree
from ztfy.thesaurus.loader import XMLThesaurusLoaderHandler, BaseThesaurusLoader, ThesaurusLoaderTerm, ThesaurusLoaderDescription, XMLThesaurusExporterHandler, BaseThesaurusExporter
                ...
                if element.tag == SKOS + 'prefLabel':
                    ...
                    if term is not None:
                        ...
                        if term not in terms:
                            terms[term] = ThesaurusLoaderTerm(term, alt='', definition='', note='', generic='', specifics='', associations='', usage=key, used_for=[])
                        else:
...
class SKOSThesaurusExporterHandler(XMLThesaurusExporterHandler):
    ...
    def _write(self, thesaurus, configuration=None):
        ...
        nsmap = {'rdf': RDF[1:-1], 'rdfs': RDFS[1:-1], 
           'dc': DC[1:-1], 
           'dct': DCT[1:-1], 
           'map': MAP[1:-1], 
           'skos': SKOS[1:-1]}
