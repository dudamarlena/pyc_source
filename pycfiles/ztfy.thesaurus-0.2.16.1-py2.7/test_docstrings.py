...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/thesaurus/tests/test_docstrings.py
# Compiled at: 2012-01-11 10:29:30
"""
Generic Test case for ztfy.thesaurus doc strings
"""
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        location = 'ztfy.thesaurus.%s' % test
