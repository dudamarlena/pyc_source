...
# [GCC 8.4.0]
# Embedded file name: /Users/drmartiner/projects/django-paymecash/paymecash/models.py
# Compiled at: 2013-09-17 23:51:32
import conf
...
class Payment(models.Model):
    ...
    product_currency = models.CharField('Валюта', max_length=3, default=conf.PAYMECASH_DEFAULT_CURRENCY, choices=CURRENCY_CHOICES)
    payment_type_group_id = models.PositiveSmallIntegerField('Способ платежа', blank=True, null=True, choices=PAYMENT_MODES_CHOICES, default=PAYMENT_CARD)
