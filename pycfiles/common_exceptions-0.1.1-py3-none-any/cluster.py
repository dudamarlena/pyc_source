...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/common_dibbs/clients/rm_client/models/cluster.py
...
class Cluster(object):
    ...
    def __init__(self, id=None, name=None, uuid=None, hints=None, credential=None, public_key=None, status=None, hosts_ids=None, targeted_slaves_count=None, current_slaves_count=None, hosts_ips=None, master_node_id=None, master_node_ip=None, user_id=None, appliance=None, appliance_impl=None):
        """
        ...
        self.attribute_map = {'id': 'id', 
           ...
           'current_slaves_count': 'current_slaves_count', 
           'hosts_ips': 'hosts_ips', 
        ...
        self._current_slaves_count = current_slaves_count
    ...
    def hints(self):
        """
        Gets the hints of this Cluster.
        hints that will be used to select the infrastructure that will host cluster's nodes

        :return: The hints of this Cluster.
        :rtype: str
        """
        return self._hints
    ...
    def hints(self, hints):
        """
        Sets the hints of this Cluster.
        hints that will be used to select the infrastructure that will host cluster's nodes

        :param hints: The hints of this Cluster.
        :type: str
        """
        self._hints = hints
    ...
    def credential(self):
        """
        Gets the credential of this Cluster.
        hints that will be used to select the infrastructure that will host cluster's nodes

        :return: The credential of this Cluster.
        :rtype: str
        """
    ...
    def credential(self, credential):
        """
        Sets the credential of this Cluster.
        hints that will be used to select the infrastructure that will host cluster's nodes

        :param credential: The credential of this Cluster.
        :type: str
        """
        self._credential = credential
    ...
    def targeted_slaves_count(self):
        """
        Gets the targeted_slaves_count of this Cluster.
        targeted number of slaves in the cluster

        :return: The targeted_slaves_count of this Cluster.
        :rtype: int
        """
    ...
    def targeted_slaves_count(self, targeted_slaves_count):
        """
        Sets the targeted_slaves_count of this Cluster.
        targeted number of slaves in the cluster

        :param targeted_slaves_count: The targeted_slaves_count of this Cluster.
        :type: int
        """
        self._targeted_slaves_count = targeted_slaves_count

    @property
    def current_slaves_count(self):
        """
        Gets the current_slaves_count of this Cluster.
        current number of slaves in the cluster

        :return: The current_slaves_count of this Cluster.
        :rtype: int
        """
        return self._current_slaves_count

    @current_slaves_count.setter
    def current_slaves_count(self, current_slaves_count):
        """
        Sets the current_slaves_count of this Cluster.
        current number of slaves in the cluster

        :param current_slaves_count: The current_slaves_count of this Cluster.
        :type: int
        """
        self._current_slaves_count = current_slaves_count
