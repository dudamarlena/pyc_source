...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/common_dibbs/clients/ar_client/models/appliance_implementation.py
...
class ApplianceImplementation(object):
    ...
    def __init__(self, name=None, logo_url=None, image_name=None, site=None, appliance=None, scripts=None):
        """
    ...
    def logo_url(self):
        """
        Gets the logo_url of this ApplianceImplementation.
        URL to a logo image

        :return: The logo_url of this ApplianceImplementation.
        :rtype: str
        """
    ...
    def logo_url(self, logo_url):
        """
        Sets the logo_url of this ApplianceImplementation.
        URL to a logo image

        :param logo_url: The logo_url of this ApplianceImplementation.
        :type: str
        """
        self._logo_url = logo_url
