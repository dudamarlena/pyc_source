...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/emrt/necd/content/roles/localroles.py
...
def get_user_roles_in_context(context, principal_id):
    ...
    if member is not None:
        ...
        if ('{}-{}-{}').format(ldap_wrapper(LDAP_SECTOREXP), sector, country) in groups:
