...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/emrt/necd/content/browser/get_sample_xls.py
# Compiled at: 2019-04-17 12:14:22
...
XLS_SAMPLE_HEADER_INVENTORY = ('Observation description', 'Country', 'NFR code', 'Inventory year',
                               'Pollutants', 'Review year', 'Fuel', 'MS key category',
                               'Parameter', 'Description flags', 'Initial question text')
XLS_SAMPLE_HEADER_PROJECTION = ('Observation description', 'Country', 'NFR code projection',
                                'NFR inventories category code', 'Projection year',
                                'Reference year', 'Pollutants', 'Scenario type',
                                'Review year', 'Activity data type', 'Activity data',
                                'MS Key Category', 'Parameter', 'Description Flags',
    ...
    def populate_cells(self, sheet):
        ...
        for idx, country in enumerate(countries):
            ...
            if is_projection:
                ...
                activity = ('\n').join(activity_data[activity_type]).encode('utf-8') if activity_type else None
