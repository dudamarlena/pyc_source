...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/todoinator/todoinator.py
# Compiled at: 2019-05-13 11:29:40
# Size of source mod 2**32: 9645 bytes
...
def parse_file(txt, filepath):
    r"""Extract todo lines from a file
...
def parse_line(todoline):
    ...
    if vals:
        ...
        priority = 30
    return (
     todoline.replace(token, ''), priority)
