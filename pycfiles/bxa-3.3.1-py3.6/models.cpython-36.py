...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bxa/sherpa/background/models.py
# Compiled at: 2020-01-28 12:31:59
# Size of source mod 2**32: 16456 bytes
"""
Background models for various telescopes and instruments
"""
from sherpa.astro.ui import *
import numpy, json, logging, warnings
...
class ChandraBackground(BackgroundModel):
    ...
    def __init__(self, storage):
        ...
        line1, line2, line3, line4, line5, line6, line7, line8 = [gauss1d('line%d_%s' % (j, i)) for j in range(1, 9)]
        self.lines = [
        ...
        changepoints = [
         0.2, 0.8, 1.3, 2.5, 8.2, 8.4, 8.75, 12]
        changepoints = [0.0, 12]
        for b, clo, chi in zip(self.boxes, changepoints[:-1], changepoints[1:]):
            ...
            b.xhi.freeze()
            b.ampl.min = 1e-08
            b.ampl.max = 100000000.0
            b.ampl.val = 1

        contlevel = const1d('contlevel_%s' % i)
        softlevel = const1d('softlevel_%s' % i)
        softsoftlevel = const1d('softsoftlevel_%s' % i)
        contlevel.c0.min = 1e-06
        softlevel.c0.min = 0.0001
        softsoftlevel.c0.min = 0.0001
        contlevel.c0.max = 10000000000.0
        softlevel.c0.max = 10000000000.0
        softsoftlevel.c0.max = 10000000000.0
        contlevel.c0.val = 0.001
        softlevel.c0.val = 10.0
        softsoftlevel.c0.val = 10.0
    ...
    def set_model(self, stage):
        ...
        ignore(2.0, None)
        notice(0.4, 2)
        logbm.debug('zooming to %.1f %.1f' % (0.4, 2.0))
...
class XMMPNBackground(BackgroundModel):
    ...
    def __init__(self, storage, galactic_NH=1e+20):
        self.storage = storage
        i = self.storage.i
        ...
        copy_data(i, 1002)
        self.pnbunitrsp = get_response(1002, bkg_id=1)
        delete_data(1002)
        ...
        self.galabs.nH = galactic_NH / 1e+22
        self.galabs.nH.freeze()
        self.pnfixwid = [
         self.pnbkgline2, self.pnbkgline3, self.pnbkgline4, self.pnbkgline5, self.pnbkgline6, self.pnbkgline8, self.pnbkgline11]
        ...
        self.pnbkgapec.norm = 5.5841e-05
        self.pnbkgapec.norm.min = 1e-10
        self.pnbkgapec.norm.max = 10000000000.0
        ...
        self.pnbkglcapec.norm.max = 10000000000.0
        ...
        self.pnbkgspline1.Estart = 0.2
        self.pnbkgspline1.Estart.freeze()
        self.pnbkgspline1.Ystart = -1.31506
        self.pnbkgspline1.Ystart.min = -1000000.0
        self.pnbkgspline1.Ystart.max = 1000000.0
        self.pnbkgspline1.Yend = 1064.16
        self.pnbkgspline1.Yend.min = -1000000.0
        self.pnbkgspline1.Yend.max = 1000000.0
        self.pnbkgspline1.YPstart = -106.183
        self.pnbkgspline1.YPstart.min = -1000000.0
        self.pnbkgspline1.YPstart.max = 1000000.0
        self.pnbkgspline1.YPend = -366.092
        self.pnbkgspline1.YPend.min = -1000000.0
        self.pnbkgspline1.YPend.max = 1000000.0
        ...
        self.pnbkgspline2.Ystart.min = -1000000.0
        self.pnbkgspline2.Ystart.max = 1000000.0
        self.pnbkgspline2.Yend = 0.887026
        self.pnbkgspline2.Yend.min = -1000000.0
        self.pnbkgspline2.Yend.max = 1000000.0
        self.pnbkgspline2.YPstart = -0.278401
        self.pnbkgspline2.YPstart.min = -1000000.0
        self.pnbkgspline2.YPstart.max = 1000000.0
        self.pnbkgspline2.YPend = 0.00484809
        self.pnbkgspline2.YPend.min = -1000000.0
        self.pnbkgspline2.YPend.max = 1000000.0
...
class SwiftXRTBackground(BackgroundModel):
    ...
    def __init__(self, storage):
        ...
        lines = [
         (0.1, 0.7, 1.1), (2, 2.15, 2.5), (1, 1.2, 1.4), (0, 0.4, 0.5)]
...
__dir__ = [
 SwiftXRTBackground, SwiftXRTWTBackground, ChandraBackground]