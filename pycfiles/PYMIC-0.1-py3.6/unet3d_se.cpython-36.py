...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pymic/net3d/unet3d_se.py
...
class UNetBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, acti_func, acti_func_param):
        ...
        self.conv1 = ConvolutionLayer(in_channels, out_channels, 3, padding=1,
          acti_func=(get_acti_func(acti_func, acti_func_param)))
        self.conv2 = ConvolutionLayer(out_channels, out_channels, 3, padding=1,
          acti_func=(get_acti_func(acti_func, acti_func_param)))
