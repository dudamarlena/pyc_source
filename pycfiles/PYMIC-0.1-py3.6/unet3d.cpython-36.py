...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pymic/net3d/unet3d.py
...
class UNet3D(nn.Module):
    ...
    def __init__(self, params):
        ...
        if not len(self.ft_chns) == 5:
            if not len(self.ft_chns) == 4:
        ...
        self.up4 = UpBlock((self.ft_chns[1]), (self.ft_chns[0]), (self.ft_chns[0]), dropout_p=0.0,
          trilinear=(self.trilinear))
        self.out_conv = nn.Conv3d((self.ft_chns[0]), (self.n_class), kernel_size=3,
          padding=1)
