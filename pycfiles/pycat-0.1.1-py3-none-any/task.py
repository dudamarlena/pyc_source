...
# Embedded file name: /Users/dan/dev/pyCast/shakecast/sc/app/task.py
...
class Task(object):
    ...
    def __init__(self, name='new_task', task_id=None, func=None, conn=None, args_in=None, loop=False, interval=100, run_in=0, kill_time=None, db_use=False, use_pdb=False):
        self.name = name
        self.id = task_id
        self.func = func
        self.conn = conn
