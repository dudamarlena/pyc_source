...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/irlutils/file/file_utils.py
# Compiled at: 2019-11-23 11:29:51
# Size of source mod 2**32: 6156 bytes
import os, json, shutil, fnmatch, argparse, tempfile
...
def mkdir(d, mode=511, exist_ok=True):
    try:
