...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/vyper/remote.py
# Compiled at: 2019-11-12 13:51:35
...
PROVIDER_TYPE = {'consul':'distconfig.backends.consul.ConsulBackend',  'etcd':'distconfig.backends.etcd.EtcdBackend', 
...
class RemoteProvider(object):
    ...
    def _get_parser(self):
        if self.config_type == 'json':
            return json.loads
        if self.config_type in ('yaml', 'yml'):
