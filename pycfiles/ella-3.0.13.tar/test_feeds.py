...
# [GCC 8.4.0]
# Embedded file name: /Users/xaralis/Workspace/elladev/ella/test_ella/test_core/test_feeds.py
...
from test_ella.test_core import create_basic_categories, create_and_place_more_publishables, list_all_publishables_in_category_by_hour
...
class TestFeeds(TestCase):
    ...
    def test_get_enclosure_uses_formated_photo_when_format_available(self):
        f = Format.objects.create(name='enc_format', max_width=10, max_height=10, flexible_height=False, stretch=False, nocrop=False)
        feeder = RSSTopCategoryListings()
        feeder.format = f
        self._set_photo()
        tools.assert_true(self.publishables[0].photo is not None)
