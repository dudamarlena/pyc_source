...
# [GCC 8.4.0]
# Embedded file name: /Users/xaralis/Workspace/elladev/ella/test_ella/test_core/test_publishable.py
...
class TestUrl(PublishableTestCase):
    ...
    def test_url_on_other_site(self):
        site = Site.objects.create(name='some site', domain='not-example.com')
        category = Category.objects.create(title='再见 category', description='example testing category, second site', site=site, slug='zai-jian-category')
