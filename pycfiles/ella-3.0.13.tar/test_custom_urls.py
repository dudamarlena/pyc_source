...
# [GCC 8.4.0]
# Embedded file name: /Users/xaralis/Workspace/elladev/ella/test_ella/test_core/test_custom_urls.py
...
class CustomObjectDetailTestCase(TestCase):
    urlpatterns = patterns('', url('^$', dummy_view, {'kwarg_from_patterns': 42}, name='prefix'), url('^new/(\\d+)/$', dummy_view, name='prefix-new'), url('^add/(?P<kwarg_from_url>\\d+)/$', dummy_view, name='prefix-add'))
