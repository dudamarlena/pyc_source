...
# [GCC 8.4.0]
# Embedded file name: /Users/xaralis/Workspace/elladev/ella/test_ella/test_positions/test_templatetags.py
...
from ella.positions.templatetags.positions import _get_category_from_pars_var, _parse_position_tag, PositionNode
...
class TestPositionParsing(TestCase):
    ...
    def setUp(self):
        ...
        self.position = Position(category=self.category_nested, name='position-name', text='other text')
        self.position.save()
    ...
    def test_raising_exception_for_templatag_if_no_category_for_tree_path_in_variable(self):
        context = Context({'category': 'bad_three_path'})
