...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Products/PASIPAuth/AuthIPPlugin.py
# Compiled at: 2009-12-02 03:09:45
...
import cidr
manage_addIPAuthPluginForm = PageTemplateFile('www/ipAuthAdd', globals(), __name__='manage_addIPAuthPluginForm')
...
class AuthIPPlugin(BasePlugin):
    ...
    _properties = ({'id': 'remote_ip_addresses', 'type': 'text', 'mode': 'w', 'label': 'A list of <IP Addresses:login id>'},)
    remote_ip_addresses = ''
