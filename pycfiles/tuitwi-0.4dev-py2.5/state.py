...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tuitwi/state.py
# Compiled at: 2010-06-30 10:58:42
import os, curses, curses.ascii
...
class ExitState(State):
    ...
    def __init__(self, stdscr, form, viewstate):
        ...
        self._form.controls['status_line'].text = 'ほんとに終了する? (y/n)'
    ...
    def _cancel(self):
        self._form.controls['status_line'].text = 'TuiTwi ver 0.2'
...
class ConfirmDestroyMessageState(State):
    ...
    def __init__(self, stdscr, form, viewstate):
        State.__init__(self, stdscr, form)
        self._viewstate = viewstate
        self._form.controls['status_line'].text = '発言を削除しますか? (y/n)'
...
class SearchInputState(State):
    ...
    def __init__(self, stdscr, form, viewstate):
        ...
        self._viewstate = viewstate
        self._form.controls['status_line'].text = '検索語句を入力して下さい.無ければTABで戻れます.'
...
class HelpState(State):
    ...
    def __init__(self, stdscr, form, viewstate):
        ...
        self._form.controls['status_line'].text = "press 'q' to quit help."
        self._viewstate = viewstate
...
class ViewState(State):
    ...
    def set_search_word(self, val):
        self._search_word = val
