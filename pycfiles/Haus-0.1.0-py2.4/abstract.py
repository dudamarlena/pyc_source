...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/haus/components/abstract.py
...
class HausComponentError(Exception):
    __module__ = __name__
...
class Component(object):
    ...
    def __call__(self, wrk, *args, **kwargs):
        ...
        """
        raise HausComponentError('Component %s cannot be stacked.' % getattr(self, '__name__', self.__class__.__name__))