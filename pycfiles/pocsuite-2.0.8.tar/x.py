...
# [GCC 8.4.0]
# Embedded file name: /Users/hysia/Code/Pocsuite/pocsuite/api/x.py
# Compiled at: 2018-12-07 04:32:38
"""
Copyright (c) 2014-2016 pocsuite developers (https://seebug.org)
See the file 'docs/COPYING' for copying permission
"""
import os, ast, json, urllib, getpass
try:
...
class ZoomEye:
    ...
    def search(self, dork, page=1, resource='web'):
        req = requests.get(('https://api.zoomeye.org/{}/search?query={}&page={}&facet=app,os').format(resource, urllib.quote(dork), page + 1), headers=self.headers)
        content = json.loads(req.content)
