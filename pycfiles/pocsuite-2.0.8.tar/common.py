...
# [GCC 8.4.0]
# Embedded file name: /Users/hysia/Code/Pocsuite/pocsuite/lib/core/common.py
# Compiled at: 2018-12-07 04:32:38
"""
Copyright (c) 2014-2016 pocsuite developers (https://seebug.org)
See the file 'docs/COPYING' for copying permission
"""
import os, re, sys, imp, ntpath, locale, inspect, posixpath, marshal, unicodedata, time
...
def unhandledExceptionMessage():
    ...
    errMsg += 'Command line: %s\n' % re.sub('.+?\\bpocsuite.py\\b', 'pocsuite.py', (' ').join(sys.argv))
    return errMsg
