...
# [GCC 8.4.0]
# Embedded file name: /Users/hysia/Code/Pocsuite/pocsuite/pocsuite_cli.py
...
def pcsInit(PCS_OPTIONS=None):
    try:
        ...
        if argsDict['dork']:
            ...
            info = z.resources
            logger.log(CUSTOM_LOGGING.SYSINFO, ('Available ZoomEye search limit count: {}').format(info['search-limit']))
