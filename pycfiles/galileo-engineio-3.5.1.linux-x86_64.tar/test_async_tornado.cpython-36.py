...
# [GCC 8.4.0]
# Embedded file name: /home/conrad/prog/galileo-engineio/venv/lib/python3.6/site-packages/tests/asyncio/test_async_tornado.py
...
class TornadoTests(unittest.TestCase):
    ...
    def test_get_tornado_handler(self):
        ...
        self.assertTrue(issubclass(handler, tornado.websocket.WebSocketHandler))
    ...
    def test_translate_request(self):
        ...
        mock_handler.request.headers = {'a':'b', 
         'c':'d', 
    ...
    def test_make_response(self):
        ...
        async_tornado.make_response('202 ACCEPTED', [('foo', 'bar')], b'payload', mock_environ)
