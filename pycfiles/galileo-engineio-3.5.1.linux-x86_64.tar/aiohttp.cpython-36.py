...
# [GCC 8.4.0]
# Embedded file name: /home/conrad/prog/galileo-engineio/venv/lib/python3.6/site-packages/engineio/async_drivers/aiohttp.py
...
class WebSocket(object):
    ...
    async def wait(self):
        ...
        if not isinstance(msg.data, six.binary_type):
            if not isinstance(msg.data, six.text_type):
                raise IOError()
        return msg.data
