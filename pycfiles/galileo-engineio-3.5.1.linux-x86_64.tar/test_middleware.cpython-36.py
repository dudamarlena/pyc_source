...
# [GCC 8.4.0]
# Embedded file name: /home/conrad/prog/galileo-engineio/venv/lib/python3.6/site-packages/tests/common/test_middleware.py
# Compiled at: 2019-08-30 19:22:58
# Size of source mod 2**32: 5046 bytes
import os, unittest, six
if six.PY3:
...
class TestWSGIApp(unittest.TestCase):
    ...
    def test_eio_routing(self):
        ...
        start_response = 'foo'
        m(environ, start_response)
        mock_eio_app.handle_request.assert_called_once_with(environ, start_response)

    def test_static_files(self):
        root_dir = os.path.dirname(__file__)
        m = engineio.WSGIApp('foo', None, static_files={'/':{'content_type':'text/html', 
        ...
        start_response.assert_called_once_with('200 OK', [('Content-Type', 'text/html')])
