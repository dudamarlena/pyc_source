...
# [GCC 8.4.0]
# Embedded file name: /home/conrad/prog/galileo-engineio/venv/lib/python3.6/site-packages/engineio/async_drivers/tornado.py
# Compiled at: 2019-08-30 19:22:57
# Size of source mod 2**32: 5304 bytes
import asyncio, sys
...
def get_tornado_handler(engineio_server):
    ...
    class Handler(tornado.websocket.WebSocketHandler):
        ...
        def __init__(self, *args, **kwargs):
            ...
            if isinstance(engineio_server.cors_allowed_origins, six.string_types):
...
def translate_request(handler):
    ...
    environ = {'wsgi.input':AwaitablePayload(payload),  'wsgi.errors':sys.stderr, 
     'wsgi.version':(1, 0), 
     'wsgi.async':True, 
...
class WebSocket(object):
    ...
    async def send(self, message):
        self.tornado_handler.write_message(message,
