...
# [GCC 8.4.0]
# Embedded file name: /home/dev/dev/django-rest-framework-features/rest_framework_features/apps.py
# Compiled at: 2019-10-04 12:09:45
    ...
    with transaction.atomic():
        ...
        for feature_def in feature_schema.values():
            ...
            for name in description:
                ...
                parent, created = model.objects.get_or_create(name=name,
                  parent=parent)
...
__all__ = ('RestFrameworkFeaturesConfig', )