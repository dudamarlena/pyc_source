...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/dev_unisender/unisender/migrations/0005_auto__chg_field_campaign_name.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('unisender_campaign', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Campaign.name' and its values cannot be restored.")
        db.alter_column('unisender_campaign', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
