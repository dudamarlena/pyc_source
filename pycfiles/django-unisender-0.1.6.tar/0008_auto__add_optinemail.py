...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/dev_unisender/unisender/migrations/0008_auto__add_optinemail.py
# Compiled at: 2014-07-25 02:08:02
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('unisender_optinemail', (
         (
         ...
         (
          'list_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unisender.SubscribeList'], unique=True))))
        db.send_create_signal('unisender', ['OptinEmail'])

    def backwards(self, orm):
        db.delete_table('unisender_optinemail')
    ...
    models = {'unisender.attachment': {'Meta': {'object_name': 'Attachment'}, 'email_message': (
       ...
       'unisender.emailmessage': {'Meta': {'ordering': "('subject',)", 'object_name': 'EmailMessage'}, 'body': (
                                  ...
                                  'series_day': (
                                               'django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                                  'series_time': (
                                                'django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}), 
                                  'subject': (
                                            'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                                  'sync': (
                                         'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
       ...
       'unisender.optinemail': {'Meta': {'object_name': 'OptinEmail'}, 'body': (
                                       'tinymce_4.fields.TinyMCEModelField', [], {}), 
                                'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                'last_error': (
                                             'django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}), 
                                'list_id': (
                                          'django.db.models.fields.related.OneToOneField', [], {'to': "orm['unisender.SubscribeList']", 'unique': 'True'}), 
                                'sender_email': (
                                               'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                                'sender_name': (
                                              'django.db.models.fields.CharField', [], {'max_length': '255'}), 
       ...
       'unisender.tag': {'Meta': {'ordering': "('name',)", 'object_name': 'Tag'}, 'id': (
                         ...
                         'unisender_id': (
                                        'django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})}, 
       'unisender.visitedlink': {'Meta': {'object_name': 'VisitedLink'}, 'campaign': (
                                            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'visited_links'", 'to': "orm['unisender.Campaign']"}), 
                                 'count': (
