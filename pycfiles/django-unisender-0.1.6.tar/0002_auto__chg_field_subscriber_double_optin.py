...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/dev_unisender/unisender/migrations/0002_auto__chg_field_subscriber_double_optin.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('unisender_subscriber', 'double_optin', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):
        db.alter_column('unisender_subscriber', 'double_optin', self.gf('django.db.models.fields.SmallIntegerField')())
