...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/dev_unisender/unisender/migrations/0003_auto__chg_field_emailmessage_tag__chg_field_emailmessage_list_id.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('unisender_emailmessage', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['unisender.Tag']))
        db.alter_column('unisender_emailmessage', 'list_id_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['unisender.SubscribeList']))

    def backwards(self, orm):
        db.alter_column('unisender_emailmessage', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['unisender.Tag']))
        raise RuntimeError("Cannot reverse this migration. 'EmailMessage.list_id' and its values cannot be restored.")
        db.alter_column('unisender_emailmessage', 'list_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['unisender.SubscribeList']))
    ...
    models = {'unisender.campaign': {'Meta': {'ordering': "('name',)", 'object_name': 'Campaign'}, 'contacts': (
       ...
       'unisender.emailmessage': {'Meta': {'ordering': "('subject',)", 'object_name': 'EmailMessage'}, 'body': (
                                  ...
                                  'series_day': (
                                               'django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                                  'series_time': (
                                                'django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}), 
                                  'subject': (
                                            'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                                  'sync': (
                                         'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
