...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/djnago-unisender/unisender/tests/views.py
...
from unisender.views import GetCampaignStatistic, GetTags, GetFields, GetLists, GetCampaigns
...
class UnisenderGetCampaignStatisticTestCase(TestCase):
    ...
    def test_admin_auth_open_page(self):
        ...
        campaign = Campaign.objects.create(name='test', email_message=message, unisender_id=1)
        response = self.client.get(reverse('admin:unisender_campaign_get_statistic', kwargs={'pk': campaign.pk}))
        self.assertRedirects(response, reverse('admin:unisender_campaign_change', args=str(campaign.pk)))
