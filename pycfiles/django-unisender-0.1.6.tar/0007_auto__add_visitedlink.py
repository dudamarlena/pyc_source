...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/dev_unisender/unisender/migrations/0007_auto__add_visitedlink.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('unisender_visitedlink', (
         (
        ...
        db.send_create_signal('unisender', ['VisitedLink'])

    def backwards(self, orm):
        db.delete_table('unisender_visitedlink')
    ...
    models = {'unisender.attachment': {'Meta': {'object_name': 'Attachment'}, 'email_message': (
       ...
       'unisender.emailmessage': {'Meta': {'ordering': "('subject',)", 'object_name': 'EmailMessage'}, 'body': (
                                  ...
                                  'series_day': (
                                               'django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                                  'series_time': (
                                                'django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}), 
                                  'subject': (
                                            'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                                  'sync': (
                                         'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
