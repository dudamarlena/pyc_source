...
# [GCC 8.4.0]
# Embedded file name: /home/africa/work/python/dev_unisender/unisender/migrations/0004_auto__chg_field_campaign_email_message.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('unisender_campaign', 'email_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['unisender.EmailMessage'], null=True))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Campaign.email_message' and its values cannot be restored.")
        db.alter_column('unisender_campaign', 'email_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['unisender.EmailMessage']))
