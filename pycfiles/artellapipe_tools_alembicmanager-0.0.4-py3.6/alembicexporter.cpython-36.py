...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/alembicmanager/widgets/base/alembicexporter.py
# Compiled at: 2020-03-13 13:52:39
# Size of source mod 2**32: 21203 bytes
"""
...
import artellapipe.register, artellapipe.tools.alembicmanager
...
class AlembicExporter(base.BaseWidget, object):
    ...
    def _export(self):
        ...
        if not os.path.exists(out_folder):
            tp.Dcc.confirm_dialog(title='Error during Alembic Exportation',
        ...
        res = tp.Dcc.confirm_dialog(title='Export Alembic File',
    ...
    def _export_alembics(self, export_info):
        ...
        for info in export_info:
            ...
            if os.path.isfile(export_path):
                res = tp.Dcc.confirm_dialog(title='Alembic File already exits!',
            ...
            for node in abc_nodes:
                ...
                for child_node in children_nodes:
                    ...
                    for shape in node_shapes:
                        ...
                        if tp.Dcc.attribute_exists(node=child_node, attribute_name='displaySmoothMesh'):
                            tp.Dcc.set_integer_attribute_value(node=child_node, attribute_name='displaySmoothMesh', attribute_value=2)
                ...
                valid_alembic = alembic.export_alembic(root=[
                 node],
                  alembic_file=export_path,
                  frame_range=[
                 [
                  float(self._start.value()), float(self._end.value())]],
            ...
            self.showOk.emit('Alembic File: {} exported successfully!'.format(os.path.basename(os.path.basename(export_path))))
