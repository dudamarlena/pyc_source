...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pycommunicate\proxies\dom\element.py
# Compiled at: 2016-06-11 13:23:46
...
class ElementWrapper:
    ...
    def set_property(self, property_name, value):
        self.dom.controller.socket_interface.send('element.property.set', self.selector, property_name, value)
