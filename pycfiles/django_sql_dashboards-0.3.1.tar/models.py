...
# [GCC 8.4.0]
# Embedded file name: /home/gthomas/dev/management-server/managementserver/django_sql_dashboards/models.py
# Compiled at: 2014-09-09 03:57:11
import pickle, datetime, logging, decimal
...
class Query(models.Model):
    ...
    cache_ttl = models.IntegerField(default=0, choices=((0, 'No cache'), (60, '1 minute'), (300, '5 minutes'), (3600, '1 hour'), (86400, '1 day'), (604800, '1 week')))
    ...
    def getAll(self, custom_data=None):
        ...
        if ret:
            ...
            self.obj = {'title': self.title, 'subtitle': self.subtitle, 
