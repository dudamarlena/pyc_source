...
# [GCC 8.4.0]
# Embedded file name: E:\Program Files\Anaconda3\lib\site-packages\segpy\packer.py
# Compiled at: 2017-02-17 11:09:13
...
def compile_struct(header_format_class, start_offset=0, length_in_bytes=None, endian='>'):
    ...
    for field in sorted_fields:
        ...
        if len(offset_to_fields[relative_offset]) > 0 and offset_to_fields[relative_offset][0].value_type is not field.value_type:
