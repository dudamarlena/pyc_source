...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\segpy\ibm_float.py
# Compiled at: 2020-04-25 14:33:32
# Size of source mod 2**32: 14984 bytes
from math import frexp, isnan, isinf, ceil, floor, trunc
from numbers import Real
import os, sys
sys.path.append(os.path.dirname(__file__)[:-6][:-4][:-6])
from gaeio.src.segpy.util import four_bytes
