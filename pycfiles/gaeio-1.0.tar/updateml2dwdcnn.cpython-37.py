...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\updateml2dwdcnn.py
# Compiled at: 2020-01-05 11:47:48
# Size of source mod 2**32: 46340 bytes
...
class updateml2dwdcnn(object):
    ...
    def setupGUI(self, UpdateMl2DWdcnn):
        ...
        self.lblnconvblock = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(UpdateMl2DWdcnn)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(UpdateMl2DWdcnn)
        ...
        self.lblpara = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 420, 190, 30))
        self.lblnepoch = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lblnepoch.setObjectName('lblnepoch')
        self.lblnepoch.setGeometry(QtCore.QRect(10, 460, 130, 30))
        self.ldtnepoch = QtWidgets.QLineEdit(UpdateMl2DWdcnn)
        self.ldtnepoch.setObjectName('ldtnepoch')
        self.ldtnepoch.setGeometry(QtCore.QRect(150, 460, 40, 30))
        self.lblbatchsize = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(210, 460, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(UpdateMl2DWdcnn)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(350, 460, 40, 30))
        self.lbllearnrate = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lbllearnrate.setObjectName('lbllearnrate')
        self.lbllearnrate.setGeometry(QtCore.QRect(10, 500, 130, 30))
        self.ldtlearnrate = QtWidgets.QLineEdit(UpdateMl2DWdcnn)
        self.ldtlearnrate.setObjectName('ldtlearnrate')
        self.ldtlearnrate.setGeometry(QtCore.QRect(150, 500, 40, 30))
        self.lbldropout = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lbldropout.setObjectName('lbldropout')
        self.lbldropout.setGeometry(QtCore.QRect(210, 500, 130, 30))
        self.ldtdropout = QtWidgets.QLineEdit(UpdateMl2DWdcnn)
        self.ldtdropout.setObjectName('ldtdropout')
        self.ldtdropout.setGeometry(QtCore.QRect(350, 500, 40, 30))
        self.lblsave = QtWidgets.QLabel(UpdateMl2DWdcnn)
        self.lblsave.setObjectName('lblsave')
        self.lblsave.setGeometry(QtCore.QRect(10, 550, 120, 30))
        self.ldtsave = QtWidgets.QLineEdit(UpdateMl2DWdcnn)
        self.ldtsave.setObjectName('ldtsave')
        self.ldtsave.setGeometry(QtCore.QRect(140, 550, 180, 30))
        self.btnsave = QtWidgets.QPushButton(UpdateMl2DWdcnn)
        self.btnsave.setObjectName('btnsave')
        self.btnsave.setGeometry(QtCore.QRect(330, 550, 60, 30))
        self.btnapply = QtWidgets.QPushButton(UpdateMl2DWdcnn)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(520, 550, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/update.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(UpdateMl2DWdcnn)
        self.msgbox.setObjectName('msgbox')
        _center_x = UpdateMl2DWdcnn.geometry().center().x()
        _center_y = UpdateMl2DWdcnn.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(UpdateMl2DWdcnn)
        QtCore.QMetaObject.connectSlotsByName(UpdateMl2DWdcnn)

    def retranslateGUI(self, UpdateMl2DWdcnn):
        self.dialog = UpdateMl2DWdcnn
        _translate = QtCore.QCoreApplication.translate
        UpdateMl2DWdcnn.setWindowTitle(_translate('UpdateMl2DWdcnn', 'Update 2D-WDCNN'))
        self.lblfrom.setText(_translate('UpdateMl2DWdcnn', 'Select network:'))
        self.ldtfrom.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('UpdateMl2DWdcnn', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('UpdateMl2DWdcnn', 'Training features:'))
        self.lblornt.setText(_translate('UpdateMl2DWdcnn', 'Orientation:'))
        ...
        self.lbltarget.setText(_translate('UpdateMl2DWdcnn', 'Training target:'))
        self.lblweight.setText(_translate('UpdateMl2DWdcnn', 'Training weight:'))
        ...
        self.lbloldsize.setText(_translate('UpdateMl2DWdcnn', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('UpdateMl2DWdcnn', 'height='))
        self.ldtoldheight.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('UpdateMl2DWdcnn', 'width='))
        self.ldtoldwidth.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewsize.setText(_translate('UpdateMl2DWdcnn', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('UpdateMl2DWdcnn', 'height='))
        self.ldtnewheight.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('UpdateMl2DWdcnn', 'width='))
        self.ldtnewwidth.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('UpdateMl2DWdcnn', 'Pre-trained WDCNN architecture:'))
        self.btnviewnetwork.setText(_translate('UpdateMl2DWdcnn', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('UpdateMl2DWdcnn', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('UpdateMl2DWdcnn', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('UpdateMl2DWdcnn', ''))
        ...
        self.lblmasksize.setText(_translate('UpdateMl2DWdcnn', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('UpdateMl2DWdcnn', 'height='))
        self.ldtmaskheight.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('UpdateMl2DWdcnn', 'width='))
        self.ldtmaskwidth.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('UpdateMl2DWdcnn', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('UpdateMl2DWdcnn', 'height='))
        self.ldtpoolheight.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('UpdateMl2DWdcnn', 'width='))
        self.ldtpoolwidth.setText(_translate('UpdateMl2DWdcnn', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('UpdateMl2DWdcnn', 'Specify update parameters:'))
        self.lblnepoch.setText(_translate('UpdateMl2DWdcnn', 'No. of epochs:'))
        self.lblnepoch.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnepoch.setText(_translate('UpdateMl2DWdcnn', '100'))
        self.ldtnepoch.setAlignment(QtCore.Qt.AlignCenter)
        self.lblbatchsize.setText(_translate('UpdateMl2DWdcnn', 'Batch size:'))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('UpdateMl2DWdcnn', '50'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lbllearnrate.setText(_translate('UpdateMl2DWdcnn', 'Learning rate:'))
        self.lbllearnrate.setAlignment(QtCore.Qt.AlignRight)
        self.ldtlearnrate.setText(_translate('UpdateMl2DWdcnn', '1e-4'))
        self.ldtlearnrate.setAlignment(QtCore.Qt.AlignCenter)
        self.lbldropout.setText(_translate('UpdateMl2DWdcnn', 'Dropout rate:'))
        self.lbldropout.setAlignment(QtCore.Qt.AlignRight)
        self.ldtdropout.setText(_translate('UpdateMl2DWdcnn', '0.1'))
        self.ldtdropout.setAlignment(QtCore.Qt.AlignCenter)
        self.lblsave.setText(_translate('UpdateMl2DWdcnn', 'Save new-WDCNN to:'))
        self.ldtsave.setText(_translate('UpdateMl2DWdcnn', ''))
        self.btnsave.setText(_translate('UpdateMl2DWdcnn', 'Browse'))
        self.btnsave.clicked.connect(self.clickBtnSave)
        self.btnapply.setText(_translate('UpdateMl2DWdcnn', 'Update 2D-WDCNN'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnUpdateMl2DWdcnn)
    ...
    def clickBtnUpdateMl2DWdcnn--- This code section failed: ---
 ...
 L. 529        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 531        44  LOAD_STR                 'Update 2D-WDCNN'

 L. 532        46  LOAD_STR                 'No seismic survey available'
 ...
 L. 536        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: No pre-WDCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 538       100  LOAD_STR                 'Update 2D-WDCNN'

 L. 539       102  LOAD_STR                 'No pre-WDCNN network found'
 ...
 L. 544       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in UpdateMl2DWdcnn: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 547       170  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 557       298  LOAD_GLOBAL              vis_msg
              300  LOAD_ATTR                print
              302  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: Non-integer feature size'
              304  LOAD_STR                 'error'
              306  LOAD_CONST               ('type',)
 ...
 L. 559       322  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 564       374  LOAD_GLOBAL              vis_msg
              376  LOAD_ATTR                print
              378  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: Features are not 2D'
              380  LOAD_STR                 'error'
              382  LOAD_CONST               ('type',)
 ...
 L. 566       398  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 574       472  LOAD_GLOBAL              vis_msg
              474  LOAD_ATTR                print
              476  LOAD_STR                 "ERROR in UpdateMl2DWdcnn: Target '%s' not found in seismic data"
 ...
 L. 577       506  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 581       554  LOAD_GLOBAL              vis_msg
              556  LOAD_ATTR                print
              558  LOAD_STR                 "ERROR in UpdateMl2DWdcnn: Weight '%s' not found in seismic data"
 ...
 L. 584       588  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 597       728  LOAD_GLOBAL              vis_msg
              730  LOAD_ATTR                print
              732  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: Non-positive epoch number'
              734  LOAD_STR                 'error'
              736  LOAD_CONST               ('type',)
 ...
 L. 599       752  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 603       784  LOAD_GLOBAL              vis_msg
              786  LOAD_ATTR                print
              788  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: Non-positive batch size'
              790  LOAD_STR                 'error'
              792  LOAD_CONST               ('type',)
 ...
 L. 605       808  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 609       840  LOAD_GLOBAL              vis_msg
              842  LOAD_ATTR                print
              844  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: Non-positive learning rate'
              846  LOAD_STR                 'error'
              848  LOAD_CONST               ('type',)
 ...
 L. 611       864  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 615       896  LOAD_GLOBAL              vis_msg
              898  LOAD_ATTR                print
              900  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: Negative dropout rate'
              902  LOAD_STR                 'error'
              904  LOAD_CONST               ('type',)
 ...
 L. 617       920  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 622       952  LOAD_GLOBAL              vis_msg
              954  LOAD_ATTR                print
              956  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: No name specified for new-WDCNN'
              958  LOAD_STR                 'error'
              960  LOAD_CONST               ('type',)
 ...
 L. 624       976  LOAD_STR                 'Update 2D-WDCNN'

 L. 625       978  LOAD_STR                 'No name specified for new-WDCNN'
 ...
 L. 645      1174  LOAD_GLOBAL              print
             1176  LOAD_STR                 'UpdateMl2DWdcnn: Step 1 - Get training samples:'
 ...
 L. 662      1422  LOAD_GLOBAL              vis_msg
             ...
             1426  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: No training sample found'
             1428  LOAD_STR                 'error'
 ...
 L. 664      1446  LOAD_STR                 'Update 2D-WDCNN'
 ...
 L. 669      1458  LOAD_GLOBAL              print
             1460  LOAD_STR                 'UpdateMl2DWdcnn: Step 2 - Retrieve and interpolate images if necessary: (%d, %d) --> (%d, %d)'
 ...
 L. 681      1588  LOAD_FAST                '_wdxl'

 L. 682      1590  LOAD_FAST                '_wdz'

 L. 683      1592  LOAD_CONST               False
 ...
 L. 687      1662  LOAD_FAST                '_wdinl'

 L. 688      1664  LOAD_FAST                '_wdxl'

 L. 689      1666  LOAD_FAST                '_wdz'

 L. 690      1668  LOAD_CONST               False
 ...
 L. 695      1730  LOAD_GLOBAL              basic_mdt
 ...
 L. 696      1746  LOAD_GLOBAL              vis_msg
             1748  LOAD_ATTR                print
             1750  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: No training sample found'
             1752  LOAD_STR                 'error'
             1754  LOAD_CONST               ('type',)
             1756  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
             1758  POP_TOP          

 L. 697      1760  LOAD_GLOBAL              QtWidgets
             1762  LOAD_ATTR                QMessageBox
             1764  LOAD_METHOD              critical
             1766  LOAD_FAST                'self'
             1768  LOAD_ATTR                msgbox

 L. 698      1770  LOAD_STR                 'Update 2D-WDCNN'

 L. 699      1772  LOAD_STR                 'No training sample found'
             1774  CALL_METHOD_3         3  '3 positional arguments'
             1776  POP_TOP          

 L. 700      1778  LOAD_CONST               None
             1780  RETURN_VALUE     
 ...
 L. 703      1812  LOAD_GLOBAL              basic_mdt
 ...
 L. 711      1888  LOAD_GLOBAL              vis_msg
             1890  LOAD_ATTR                print
             1892  LOAD_STR                 'ERROR in UpdateMl2DWdcnn: No training sample found'
             1894  LOAD_STR                 'error'
             1896  LOAD_CONST               ('type',)
             1898  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
             1900  POP_TOP          

 L. 712      1902  LOAD_GLOBAL              QtWidgets
             1904  LOAD_ATTR                QMessageBox
             1906  LOAD_METHOD              critical
             1908  LOAD_FAST                'self'
             1910  LOAD_ATTR                msgbox

 L. 713      1912  LOAD_STR                 'Update 2D-WDCNN'

 L. 714      1914  LOAD_STR                 'No training sample found'
             1916  CALL_METHOD_3         3  '3 positional arguments'
             1918  POP_TOP          

 L. 715      1920  LOAD_CONST               None
             1922  RETURN_VALUE     
           1924_0  COME_FROM          1884  '1884'

 L. 717      1924  LOAD_FAST                '_image_height_new'
 ...
 L. 718      1944  SETUP_LOOP         1988  'to 1988'
             1946  LOAD_FAST                '_features'
             1948  GET_ITER         
             1950  FOR_ITER           1986  'to 1986'
             1952  STORE_FAST               'f'

 L. 719      1954  LOAD_GLOBAL              basic_image
             1956  LOAD_ATTR                changeImageSize
             1958  LOAD_FAST                '_traindict'
             1960  LOAD_FAST                'f'
             1962  BINARY_SUBSCR    

 L. 720      1964  LOAD_FAST                '_image_height'

 L. 721      1966  LOAD_FAST                '_image_width'

 L. 722      1968  LOAD_FAST                '_image_height_new'

 L. 723      1970  LOAD_FAST                '_image_width_new'
 ...
 L. 724      1988  LOAD_FAST                '_target'
             1990  LOAD_FAST                '_features'
             1992  COMPARE_OP               not-in
         1994_1996  POP_JUMP_IF_FALSE  2028  'to 2028'

 L. 725      1998  LOAD_GLOBAL              basic_image
             2000  LOAD_ATTR                changeImageSize
             2002  LOAD_FAST                '_traindict'
             2004  LOAD_FAST                '_target'
             2006  BINARY_SUBSCR    

 L. 726      2008  LOAD_FAST                '_image_height'

 L. 727      2010  LOAD_FAST                '_image_width'

 L. 728      2012  LOAD_FAST                '_image_height_new'

 L. 729      2014  LOAD_FAST                '_image_width_new'
 ...
 L. 731      2048  LOAD_GLOBAL              basic_image
             2050  LOAD_ATTR                changeImageSize
             2052  LOAD_FAST                '_traindict'
             2054  LOAD_FAST                '_weight'
             2056  BINARY_SUBSCR    

 L. 732      2058  LOAD_FAST                '_image_height'

 L. 733      2060  LOAD_FAST                '_image_width'

 L. 734      2062  LOAD_FAST                '_image_height_new'

 L. 735      2064  LOAD_FAST                '_image_width_new'
 ...
 L. 757      2308  LOAD_GLOBAL              np
             2310  LOAD_METHOD              round
             2312  LOAD_FAST                '_traindict'
             2314  LOAD_FAST                '_target'
             2316  BINARY_SUBSCR    
             2318  CALL_METHOD_1         1  '1 positional argument'
             2320  LOAD_METHOD              astype
             2322  LOAD_GLOBAL              int
             2324  CALL_METHOD_1         1  '1 positional argument'
             2326  LOAD_FAST                '_traindict'
             2328  LOAD_FAST                '_target'
             2330  STORE_SUBSCR     

 L. 760      2332  LOAD_GLOBAL              print
             2334  LOAD_STR                 'UpdateMl2DWdcnn: A total of %d valid training samples'
             2336  LOAD_GLOBAL              basic_mdt
 ...
 L. 762      2350  LOAD_GLOBAL              print
             2352  LOAD_STR                 'UpdateMl2DWdcnn: Step 3 - Start training'
             2354  CALL_FUNCTION_1       1  '1 positional argument'
             2356  POP_TOP          

 L. 764      2358  LOAD_GLOBAL              QtWidgets
             2360  LOAD_METHOD              QProgressDialog
             2362  CALL_METHOD_0         0  '0 positional arguments'
             2364  STORE_FAST               '_pgsdlg'

 L. 765      2366  LOAD_GLOBAL              QtGui
             2368  LOAD_METHOD              QIcon
             2370  CALL_METHOD_0         0  '0 positional arguments'
             2372  STORE_FAST               'icon'

 L. 766      2374  LOAD_FAST                'icon'
             2376  LOAD_METHOD              addPixmap
             2378  LOAD_GLOBAL              QtGui
             2380  LOAD_METHOD              QPixmap
             2382  LOAD_GLOBAL              os
             2384  LOAD_ATTR                path
             2386  LOAD_METHOD              join
             2388  LOAD_FAST                'self'
             2390  LOAD_ATTR                iconpath
             2392  LOAD_STR                 'icons/update.png'
             2394  CALL_METHOD_2         2  '2 positional arguments'
             2396  CALL_METHOD_1         1  '1 positional argument'

 L. 767      2398  LOAD_GLOBAL              QtGui
             2400  LOAD_ATTR                QIcon
             2402  LOAD_ATTR                Normal
             2404  LOAD_GLOBAL              QtGui
             2406  LOAD_ATTR                QIcon
             2408  LOAD_ATTR                Off
             2410  CALL_METHOD_3         3  '3 positional arguments'
             2412  POP_TOP          

 L. 768      2414  LOAD_FAST                '_pgsdlg'
             2416  LOAD_METHOD              setWindowIcon
             2418  LOAD_FAST                'icon'
             2420  CALL_METHOD_1         1  '1 positional argument'
             2422  POP_TOP          

 L. 769      2424  LOAD_FAST                '_pgsdlg'
             2426  LOAD_METHOD              setWindowTitle
             2428  LOAD_STR                 'Update 2D-WDCNN'
             2430  CALL_METHOD_1         1  '1 positional argument'
             2432  POP_TOP          

 L. 770      2434  LOAD_FAST                '_pgsdlg'
             2436  LOAD_METHOD              setCancelButton
             2438  LOAD_CONST               None
             2440  CALL_METHOD_1         1  '1 positional argument'
             2442  POP_TOP          

 L. 771      2444  LOAD_FAST                '_pgsdlg'
             2446  LOAD_METHOD              setWindowFlags
             2448  LOAD_GLOBAL              QtCore
             2450  LOAD_ATTR                Qt
             2452  LOAD_ATTR                WindowStaysOnTopHint
             2454  CALL_METHOD_1         1  '1 positional argument'
             2456  POP_TOP          

 L. 772      2458  LOAD_FAST                '_pgsdlg'
             2460  LOAD_METHOD              forceShow
             2462  CALL_METHOD_0         0  '0 positional arguments'
             2464  POP_TOP          

 L. 773      2466  LOAD_FAST                '_pgsdlg'
             2468  LOAD_METHOD              setFixedWidth
             2470  LOAD_CONST               400
             2472  CALL_METHOD_1         1  '1 positional argument'
             2474  POP_TOP          

 L. 774      2476  LOAD_GLOBAL              ml_wdcnn
             2478  LOAD_ATTR                updateWDCNNSegmentor
             2480  LOAD_FAST                '_traindict'

 L. 775      2482  LOAD_FAST                '_image_height_new'
             2484  LOAD_FAST                '_image_width_new'

 L. 776      2486  LOAD_FAST                '_nepoch'
             2488  LOAD_FAST                '_batchsize'

 L. 777      2490  LOAD_FAST                '_learning_rate'

 L. 778      2492  LOAD_FAST                '_dropout_prob'

 L. 779      2494  LOAD_FAST                'self'
             2496  LOAD_ATTR                modelpath
             2498  LOAD_FAST                'self'
             2500  LOAD_ATTR                modelname

 L. 780      2502  LOAD_CONST               True

 L. 781      2504  LOAD_FAST                '_savepath'
             2506  LOAD_FAST                '_savename'

 L. 782      2508  LOAD_FAST                '_pgsdlg'
             2510  LOAD_CONST               ('imageheight', 'imagewidth', 'nepoch', 'batchsize', 'learningrate', 'dropoutprob', 'wdcnnpath', 'wdcnnname', 'save2disk', 'savepath', 'savename', 'qpgsdlg')
             2512  CALL_FUNCTION_KW_13    13  '13 total positional and keyword args'
             2514  STORE_FAST               '_dccnlog'

 L. 785      2516  LOAD_GLOBAL              QtWidgets
             2518  LOAD_ATTR                QMessageBox
             2520  LOAD_METHOD              information
             2522  LOAD_FAST                'self'
             2524  LOAD_ATTR                msgbox

 L. 786      2526  LOAD_STR                 'Update 2D-WDCNN'

 L. 787      2528  LOAD_STR                 'WDCNN updated successfully'
             2530  CALL_METHOD_3         3  '3 positional arguments'
             2532  POP_TOP          

 L. 789      2534  LOAD_GLOBAL              QtWidgets
             2536  LOAD_ATTR                QMessageBox
             2538  LOAD_METHOD              question
             2540  LOAD_FAST                'self'
             2542  LOAD_ATTR                msgbox
             2544  LOAD_STR                 'Update 2D-DCNN'
             2546  LOAD_STR                 'View learning matrix?'

 L. 790      2548  LOAD_GLOBAL              QtWidgets
             2550  LOAD_ATTR                QMessageBox
             2552  LOAD_ATTR                Yes
             2554  LOAD_GLOBAL              QtWidgets
             2556  LOAD_ATTR                QMessageBox
             2558  LOAD_ATTR                No
             2560  BINARY_OR        

 L. 791      2562  LOAD_GLOBAL              QtWidgets
             2564  LOAD_ATTR                QMessageBox
             2566  LOAD_ATTR                Yes
             2568  CALL_METHOD_5         5  '5 positional arguments'
             2570  STORE_FAST               'reply'

 L. 793      2572  LOAD_FAST                'reply'
             2574  LOAD_GLOBAL              QtWidgets
             2576  LOAD_ATTR                QMessageBox
             2578  LOAD_ATTR                Yes
             2580  COMPARE_OP               ==
         2582_2584  POP_JUMP_IF_FALSE  2652  'to 2652'

 L. 794      2586  LOAD_GLOBAL              QtWidgets
             2588  LOAD_METHOD              QDialog
             2590  CALL_METHOD_0         0  '0 positional arguments'
             2592  STORE_FAST               '_viewmllearnmat'

 L. 795      2594  LOAD_GLOBAL              gui_viewmllearnmat
             2596  CALL_FUNCTION_0       0  '0 positional arguments'
             2598  STORE_FAST               '_gui'

 L. 796      2600  LOAD_FAST                '_dccnlog'
             2602  LOAD_STR                 'learning_curve'
             2604  BINARY_SUBSCR    
             2606  LOAD_FAST                '_gui'
             2608  STORE_ATTR               learnmat

 L. 797      2610  LOAD_FAST                'self'
             2612  LOAD_ATTR                linestyle
             2614  LOAD_FAST                '_gui'
             2616  STORE_ATTR               linestyle

 L. 798      2618  LOAD_FAST                'self'
             2620  LOAD_ATTR                fontstyle
             2622  LOAD_FAST                '_gui'
             2624  STORE_ATTR               fontstyle

 L. 799      2626  LOAD_FAST                '_gui'
             2628  LOAD_METHOD              setupGUI
             2630  LOAD_FAST                '_viewmllearnmat'
             2632  CALL_METHOD_1         1  '1 positional argument'
             2634  POP_TOP          

 L. 800      2636  LOAD_FAST                '_viewmllearnmat'
             2638  LOAD_METHOD              exec
             2640  CALL_METHOD_0         0  '0 positional arguments'
             2642  POP_TOP          

 L. 801      2644  LOAD_FAST                '_viewmllearnmat'
             2646  LOAD_METHOD              show
             2648  CALL_METHOD_0         0  '0 positional arguments'
             2650  POP_TOP          
           2652_0  COME_FROM          2582  '2582'

Parse error at or near `POP_TOP' instruction at offset 2650
...
if __name__ == '__main__':
    ...
    UpdateMl2DWdcnn = QtWidgets.QWidget()
    gui = updateml2dwdcnn()
    gui.setupGUI(UpdateMl2DWdcnn)
    UpdateMl2DWdcnn.show()
    sys.exit(app.exec_())