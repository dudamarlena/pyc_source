...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\evaluateml15ddcnn.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 38114 bytes
...
class evaluateml15ddcnn(object):
    survinfo = {}
    seisdata = {}
    rootpath = ''
    ...
    def setupGUI(self, EvaluateMl15DDcnn):
        EvaluateMl15DDcnn.setObjectName('EvaluateMl15DDcnn')
        EvaluateMl15DDcnn.setFixedSize(810, 500)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/check.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        EvaluateMl15DDcnn.setWindowIcon(icon)
        self.lblfrom = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblfrom.setObjectName('lblfrom')
        self.lblfrom.setGeometry(QtCore.QRect(10, 10, 100, 30))
        self.ldtfrom = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtfrom.setObjectName('ldtfrom')
        self.ldtfrom.setGeometry(QtCore.QRect(110, 10, 210, 30))
        self.btnfrom = QtWidgets.QPushButton(EvaluateMl15DDcnn)
        self.btnfrom.setObjectName('btnfrom')
        self.btnfrom.setGeometry(QtCore.QRect(330, 10, 60, 30))
        self.lblfeature = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblfeature.setObjectName('lblfeature')
        self.lblfeature.setGeometry(QtCore.QRect(10, 60, 100, 30))
        self.lwgfeature = QtWidgets.QListWidget(EvaluateMl15DDcnn)
        ...
        self.lblnconvblock = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(EvaluateMl15DDcnn)
        ...
        self.lblmasksize = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 360, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 360, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 360, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 400, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 400, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 360, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 360, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 360, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 400, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 400, 40, 30))
        self.lblpara = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 370, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(EvaluateMl15DDcnn)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 400, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(EvaluateMl15DDcnn)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 400, 40, 30))
        self.btnapply = QtWidgets.QPushButton(EvaluateMl15DDcnn)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 450, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/check.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(EvaluateMl15DDcnn)
        self.msgbox.setObjectName('msgbox')
        _center_x = EvaluateMl15DDcnn.geometry().center().x()
        _center_y = EvaluateMl15DDcnn.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(EvaluateMl15DDcnn)
        QtCore.QMetaObject.connectSlotsByName(EvaluateMl15DDcnn)

    def retranslateGUI(self, EvaluateMl15DDcnn):
        self.dialog = EvaluateMl15DDcnn
        _translate = QtCore.QCoreApplication.translate
        EvaluateMl15DDcnn.setWindowTitle(_translate('EvaluateMl15DDcnn', 'Evaluate 1.5D-DCNN'))
        self.lblfrom.setText(_translate('EvaluateMl15DDcnn', 'Select network:'))
        self.ldtfrom.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('EvaluateMl15DDcnn', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('EvaluateMl15DDcnn', 'Training features:'))
        self.lblornt.setText(_translate('EvaluateMl15DDcnn', 'Orientation:'))
        ...
        self.lbltarget.setText(_translate('EvaluateMl15DDcnn', 'Training target:'))
        self.lbloldsize.setText(_translate('EvaluateMl15DDcnn', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('EvaluateMl15DDcnn', 'height='))
        self.ldtoldheight.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('EvaluateMl15DDcnn', 'width='))
        self.ldtoldwidth.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewsize.setText(_translate('EvaluateMl15DDcnn', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('EvaluateMl15DDcnn', 'height='))
        self.ldtnewheight.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('EvaluateMl15DDcnn', 'width='))
        self.ldtnewwidth.setText(_translate('EvaluateMl15DDcnn', ''))
        ...
        self.lblnetwork.setText(_translate('EvaluateMl15DDcnn', 'Pre-trained DCNN architecture:'))
        self.btnviewnetwork.setText(_translate('EvaluateMl15DDcnn', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('EvaluateMl15DDcnn', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('EvaluateMl15DDcnn', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('EvaluateMl15DDcnn', ''))
        ...
        self.lblmasksize.setText(_translate('EvaluateMl15DDcnn', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('EvaluateMl15DDcnn', 'height='))
        self.ldtmaskheight.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('EvaluateMl15DDcnn', 'width='))
        self.ldtmaskwidth.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('EvaluateMl15DDcnn', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('EvaluateMl15DDcnn', 'height='))
        self.ldtpoolheight.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('EvaluateMl15DDcnn', 'width='))
        self.ldtpoolwidth.setText(_translate('EvaluateMl15DDcnn', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('EvaluateMl15DDcnn', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('EvaluateMl15DDcnn', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('EvaluateMl15DDcnn', '50'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.btnapply.setText(_translate('EvaluateMl15DDcnn', 'Evaluate 1.5D-DCNN'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnEvaluateMl15DDcnn)
    ...
    def clickBtnEvaluateMl15DDcnn--- This code section failed: ---
 ...
 L. 460        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in EvaluateMl15DDcnn: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 462        44  LOAD_STR                 'Evaluate 1.5D-DCNN'
 ...
 L. 467        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in EvaluateMl15DDcnn: No pre-DCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 469       100  LOAD_STR                 'Evaluate 1.5D-DCNN'

 L. 470       102  LOAD_STR                 'No pre-DCNN network found'
 ...
 L. 475       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in EvaluateMl15DDcnn: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 478       170  LOAD_STR                 'Evaluate 1.5D-DCNN'
 ...
 L. 483       216  LOAD_GLOBAL              vis_msg
              218  LOAD_ATTR                print
              220  LOAD_STR                 "ERROR in EvaluateMl15DDcnn: Target label '%s' not found in seismic data"
 ...
 L. 486       250  LOAD_STR                 'Evaluate 1.5D-DCNN'

 L. 487       252  LOAD_STR                 "Target label '"
              254  LOAD_FAST                'self'
 ...
 L. 500       410  LOAD_GLOBAL              vis_msg
              412  LOAD_ATTR                print
              414  LOAD_STR                 'ERROR in EvaluateMl15DDcnn: Non-integer feature size'
              416  LOAD_STR                 'error'
              418  LOAD_CONST               ('type',)
 ...
 L. 502       434  LOAD_STR                 'Evaluate 1.5D-DCNN'
 ...
 L. 507       486  LOAD_GLOBAL              vis_msg
              488  LOAD_ATTR                print
              490  LOAD_STR                 'ERROR in EvaluateMl15DDcnn: Features are not 2D'
              492  LOAD_STR                 'error'
              494  LOAD_CONST               ('type',)
 ...
 L. 509       510  LOAD_STR                 'Evaluate 1.5D-DCNN'
 ...
 L. 512       522  LOAD_GLOBAL              basic_data
 ...
 L. 514       558  LOAD_GLOBAL              vis_msg
              560  LOAD_ATTR                print
              562  LOAD_STR                 'ERROR in EvaluateMl15DDcnn: Non-positive batch size'
              564  LOAD_STR                 'error'
              566  LOAD_CONST               ('type',)
              568  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              570  POP_TOP          

 L. 515       572  LOAD_GLOBAL              QtWidgets
              574  LOAD_ATTR                QMessageBox
              576  LOAD_METHOD              critical
              578  LOAD_FAST                'self'
              580  LOAD_ATTR                msgbox

 L. 516       582  LOAD_STR                 'Evaluate 1.5D-DCNN'

 L. 517       584  LOAD_STR                 'Non-positive batch size'
              586  CALL_METHOD_3         3  '3 positional arguments'
              588  POP_TOP          

 L. 518       590  LOAD_CONST               None
              592  RETURN_VALUE     
            594_0  COME_FROM           554  '554'

 L. 520       594  LOAD_FAST                'self'
              596  LOAD_ATTR                survinfo
              598  STORE_FAST               '_seisinfo'

 L. 522       600  LOAD_CONST               0
              602  STORE_FAST               '_wdinl'

 L. 523       604  LOAD_CONST               0
              606  STORE_FAST               '_wdxl'

 L. 524       608  LOAD_CONST               0
              610  STORE_FAST               '_wdz'

 L. 525       612  LOAD_FAST                'self'
 ...
 L. 537       822  LOAD_CONST               -1
              824  LOAD_CONST               1
              826  BUILD_LIST_2          2 
              828  CALL_METHOD_2         2  '2 positional arguments'
              830  STORE_FAST               '_xls'

 L. 538       832  LOAD_GLOBAL              seis_ays
 ...
 L. 550      1084  LOAD_CONST               -1
             1086  LOAD_CONST               1
             1088  BUILD_LIST_2          2 
             1090  CALL_METHOD_2         2  '2 positional arguments'
             1092  STORE_FAST               '_zs'

 L. 551      1094  LOAD_GLOBAL              seis_ays
 ...
 L. 552      1114  LOAD_FAST                '_seisinfo'
 ...
 L. 553      1132  LOAD_FAST                '_seisinfo'
             1134  LOAD_STR                 'ILEnd'
             1136  BINARY_SUBSCR    
 ...
 L. 554      1150  LOAD_FAST                '_seisinfo'
 ...
 L. 555      1168  LOAD_FAST                '_seisinfo'
             1170  LOAD_STR                 'ZEnd'
             1172  BINARY_SUBSCR    
             1174  LOAD_FAST                '_wdz'
 ...
 L. 559      1240  LOAD_GLOBAL              basic_mdt
 ...
 L. 577      1418  LOAD_CONST               0
             1420  STORE_FAST               'idxstart'

 L. 578  1422_1424  SETUP_LOOP         2144  'to 2144'
 ...
 L. 582      1454  LOAD_GLOBAL              sys
             1456  LOAD_ATTR                stdout
             1458  LOAD_METHOD              write

 L. 583      1460  LOAD_STR                 '\r>>> Evaluate 1.5D-DCNN, proceeding %.1f%% '
 ...
 L. 590      1546  LOAD_FAST                'idxend'
             1548  STORE_FAST               'idxstart'

 L. 591      1550  LOAD_GLOBAL              basic_mdt
 ...
 L. 593      1562  LOAD_FAST                '_dict'
             1564  LOAD_STR                 'Inline'
             1566  BINARY_SUBSCR    
             1568  STORE_FAST               '_targetdata'

 L. 594      1570  LOAD_FAST                'self'
 ...
 L. 626      1974  LOAD_FAST                '_image_height_new'
 ...
 L. 627      1994  SETUP_LOOP         2038  'to 2038'
             1996  LOAD_FAST                '_features'
             1998  GET_ITER         
             2000  FOR_ITER           2036  'to 2036'
             2002  STORE_FAST               'f'

 L. 628      2004  LOAD_GLOBAL              basic_image
             2006  LOAD_ATTR                changeImageSize
             2008  LOAD_FAST                '_dict'
             2010  LOAD_FAST                'f'
             2012  BINARY_SUBSCR    

 L. 629      2014  LOAD_FAST                '_image_height'

 L. 630      2016  LOAD_FAST                '_image_width'

 L. 631      2018  LOAD_FAST                '_image_height_new'

 L. 632      2020  LOAD_FAST                '_image_width_new'
 ...
 L. 634      2038  LOAD_FAST                '_image_height_new'
 ...
 L. 635      2058  LOAD_GLOBAL              basic_curve
             2060  LOAD_ATTR                changeCurveSize
             2062  LOAD_FAST                '_dict'
             2064  LOAD_FAST                '_target'
             2066  BINARY_SUBSCR    

 L. 636      2068  LOAD_FAST                '_image_height'

 L. 637      2070  LOAD_FAST                '_image_height_new'
 ...
 L. 639      2084  LOAD_GLOBAL              ml_dcnn15d
             2086  LOAD_ATTR                evaluate15DDCNNSegmentor
             2088  LOAD_FAST                '_dict'

 L. 640      2090  LOAD_FAST                '_image_height_new'

 L. 641      2092  LOAD_FAST                '_image_width_new'

 L. 642      2094  LOAD_FAST                'self'
             2096  LOAD_ATTR                modelpath

 L. 643      2098  LOAD_FAST                'self'
             2100  LOAD_ATTR                modelname

 L. 644      2102  LOAD_FAST                '_batch'
             2104  LOAD_CONST               False
             2106  LOAD_CONST               ('imageheight', 'imagewidth', 'dcnnpath', 'dcnnname', 'batchsize', 'verbose')
             2108  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
             2110  STORE_FAST               '_confmatrix'

 L. 646      2112  LOAD_FAST                '_result'
 ...
 L. 650      2144  LOAD_GLOBAL              print
             2146  LOAD_STR                 'Done'
             2148  CALL_FUNCTION_1       1  '1 positional argument'
             2150  POP_TOP          

 L. 652      2152  LOAD_FAST                '_result'
             2154  LOAD_CONST               0
             2156  LOAD_CONST               1
...
if __name__ == '__main__':
    ...
    EvaluateMl15DDcnn = QtWidgets.QWidget()
    gui = evaluateml15ddcnn()
    gui.setupGUI(EvaluateMl15DDcnn)
    EvaluateMl15DDcnn.show()
    sys.exit(app.exec_())