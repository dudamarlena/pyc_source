...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Haibin\AppData\Local\Temp\pip-build-8dr99z6a\segpy\segpy\catalog.py
# Compiled at: 2017-02-16 13:30:25
# Size of source mod 2**32: 20199 bytes
...
class RegularConstantCatalog(Catalog):
    ...
    def __init__(self, key_min, key_max, key_stride, value):
        ...
        super(RegularConstantCatalog, self).__init__(key_min=key_min, key_max=key_max, value_min=value, value_max=value)
...
class LinearRegularCatalog(Catalog):
    ...
    def __init__(self, key_min, key_max, key_stride, value_min, value_max, value_stride):
        ...
        super(LinearRegularCatalog, self).__init__(key_min=key_min, key_max=key_max, value_min=value_min, value_max=value_max)
