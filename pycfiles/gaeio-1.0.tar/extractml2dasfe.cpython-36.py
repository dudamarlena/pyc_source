...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\extractml2dasfe.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 33890 bytes
...
class extractml2dasfe(object):
    ...
    def setupGUI(self, ExtractMl2DAsfe):
        ...
        self.lblnconvblock = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ExtractMl2DAsfe)
        ...
        self.lblmasksize = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 280, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 280, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 280, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 320, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 320, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 280, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 280, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 280, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 320, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 320, 40, 30))
        self.lblpara = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 310, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 350, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 350, 40, 30))
        self.lbltype = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lbltype.setObjectName('lbltype')
        self.lbltype.setGeometry(QtCore.QRect(10, 400, 130, 30))
        self.cbbtype = QtWidgets.QComboBox(ExtractMl2DAsfe)
        self.cbbtype.setObjectName('cbbtype')
        self.cbbtype.setGeometry(QtCore.QRect(150, 400, 240, 30))
        self.lblsave = QtWidgets.QLabel(ExtractMl2DAsfe)
        self.lblsave.setObjectName('lblsave')
        self.lblsave.setGeometry(QtCore.QRect(10, 440, 130, 30))
        self.ldtsave = QtWidgets.QLineEdit(ExtractMl2DAsfe)
        self.ldtsave.setObjectName('ldtsave')
        self.ldtsave.setGeometry(QtCore.QRect(150, 440, 100, 30))
        self.btnapply = QtWidgets.QPushButton(ExtractMl2DAsfe)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(520, 440, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/retrieve.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ExtractMl2DAsfe)
        self.msgbox.setObjectName('msgbox')
        _center_x = ExtractMl2DAsfe.geometry().center().x()
        _center_y = ExtractMl2DAsfe.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ExtractMl2DAsfe)
        QtCore.QMetaObject.connectSlotsByName(ExtractMl2DAsfe)

    def retranslateGUI(self, ExtractMl2DAsfe):
        self.dialog = ExtractMl2DAsfe
        _translate = QtCore.QCoreApplication.translate
        ExtractMl2DAsfe.setWindowTitle(_translate('ExtractMl2DAsfe', 'Extract 2D-ASFE'))
        self.lblfrom.setText(_translate('ExtractMl2DAsfe', 'Select network:'))
        self.ldtfrom.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ExtractMl2DAsfe', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ExtractMl2DAsfe', 'Training features:'))
        self.lblornt.setText(_translate('ExtractMl2DAsfe', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ExtractMl2DAsfe', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ExtractMl2DAsfe', 'height='))
        self.ldtoldheight.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ExtractMl2DAsfe', 'width='))
        self.ldtoldwidth.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewsize.setText(_translate('ExtractMl2DAsfe', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ExtractMl2DAsfe', 'height='))
        self.ldtnewheight.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnewheight.setEnabled(False)
        self.lblnewwidth.setText(_translate('ExtractMl2DAsfe', 'width='))
        self.ldtnewwidth.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnewwidth.setEnabled(False)
        self.lblnetwork.setText(_translate('ExtractMl2DAsfe', 'Pre-trained ASFE architecture:'))
        ...
        self.lblmasksize.setText(_translate('ExtractMl2DAsfe', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ExtractMl2DAsfe', 'height='))
        self.ldtmaskheight.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ExtractMl2DAsfe', 'width='))
        self.ldtmaskwidth.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ExtractMl2DAsfe', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ExtractMl2DAsfe', 'height='))
        self.ldtpoolheight.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ExtractMl2DAsfe', 'width='))
        self.ldtpoolwidth.setText(_translate('ExtractMl2DAsfe', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ExtractMl2DAsfe', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ExtractMl2DAsfe', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ExtractMl2DAsfe', '5000'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lbltype.setText(_translate('ExtractMl2DAsfe', 'Target layer='))
        self.lbltype.setAlignment(QtCore.Qt.AlignRight)
        self.lblsave.setText(_translate('ExtractMl2DAsfe', 'Output prefix='))
        self.lblsave.setAlignment(QtCore.Qt.AlignRight)
        self.ldtsave.setText(_translate('ExtractMl2DAsfe', 'asfe_feature_'))
        self.btnapply.setText(_translate('ExtractMl2DAsfe', 'Extract 2D-ASFE'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnExtractMl2DAsfe)
    ...
    def clickBtnExtractMl2DAsfe(self):
        self.refreshMsgBox()
        if self.checkSurvInfo() is False:
            vis_msg.print('ERROR in ExtractMl2DAsfe: No seismic survey available', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', 'No seismic survey available')
            return
        if ml_tfm.checkCNNModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in ExtractMl2DAsfe: No CNN network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', 'No CNN network found')
            return
        _featurelist = self.modelinfo['feature_list']
        for f in _featurelist:
            if self.checkSeisData(f) is False:
                vis_msg.print(("ERROR in ExtractMl2DAsfe: Feature '%s' not found in seismic data" % f), type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', "Feature '" + f + "' not found in seismic data")
                return
        ...
        if _image_height_old is False or _image_width_old is False or _image_height_new is False or _image_width_new is False:
            vis_msg.print('ERROR in ExtractMl2DAsfe: Non-integer feature size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', 'Non-integer feature size')
            return
        if _image_height_old < 2 or _image_width_old < 2 or _image_height_new < 2 or _image_width_new < 2:
            vis_msg.print('ERROR in ExtractMl2DAsfe: Features are not 2D', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', 'Features are not 2D')
            return
        _batch = basic_data.str2int(self.ldtbatchsize.text())
        if _batch is False or _batch < 1:
            vis_msg.print('ERROR in ExtractMl2DAsfe: Non-positive batch size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', 'Non-positive batch size')
            return
        if len(self.ldtsave.text()) < 1:
            vis_msg.print('ERROR in ExtractMl2DAsfe: No prefix specified', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-ASFE', 'No prefix specified')
            return
        if self.ldtsave.text() + '1' in self.seisdata.keys():
            if self.checkSeisData(self.ldtsave.text() + '1'):
                reply = QtWidgets.QMessageBox.question(self.msgbox, 'Extract 2D-ASFE', 'Prefix ' + self.ldtsave.text() + ' already exists. Overwrite?', QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No, QtWidgets.QMessageBox.No)
        ...
        _pgsdlg.setWindowTitle('Extract 2D-ASFE')
        ...
        for i in range(_nloop):
            ...
            sys.stdout.write('\r>>> Extract 2D-ASFE, proceeding %.1f%% ' % (float(i) / float(_nloop) * 100.0))
            sys.stdout.flush()
        ...
        QtWidgets.QMessageBox.information(self.msgbox, 'Extract 2D-ASFE', str(_nfeature) + ' ASFE features extracted successfully')
...
if __name__ == '__main__':
    ...
    ExtractMl2DAsfe = QtWidgets.QWidget()
    gui = extractml2dasfe()
    gui.setupGUI(ExtractMl2DAsfe)
    ExtractMl2DAsfe.show()
    sys.exit(app.exec_())