...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\extractml2dwcae.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 36922 bytes
...
from cognitivegeo.src.ml.wcaereconstructor import wcaereconstructor as ml_wcae
from cognitivegeo.src.gui.viewml2dwcae import viewml2dwcae as gui_viewml2dwcae
from cognitivegeo.src.vis.messager import messager as vis_msg
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_EnableHighDpiScaling, True)
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_UseHighDpiPixmaps, True)

class extractml2dwcae(object):
    survinfo = {}
    seisdata = {}
    rootpath = ''
    ...
    def setupGUI(self, ExtractMl2DWcae):
        ...
        self.lblnconvblock = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ExtractMl2DWcae)
        ...
        self.lblmasksize = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 350, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 350, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 350, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 390, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 390, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 350, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 350, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 350, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 390, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 390, 40, 30))
        self.lblpara = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 320, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 350, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 350, 40, 30))
        self.lbltype = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lbltype.setObjectName('lbltype')
        self.lbltype.setGeometry(QtCore.QRect(10, 390, 130, 30))
        self.cbbtype = QtWidgets.QComboBox(ExtractMl2DWcae)
        self.cbbtype.setObjectName('cbbtype')
        self.cbbtype.setGeometry(QtCore.QRect(150, 390, 240, 30))
        self.lblsave = QtWidgets.QLabel(ExtractMl2DWcae)
        self.lblsave.setObjectName('lblsave')
        self.lblsave.setGeometry(QtCore.QRect(10, 430, 130, 30))
        self.ldtsave = QtWidgets.QLineEdit(ExtractMl2DWcae)
        self.ldtsave.setObjectName('ldtsave')
        self.ldtsave.setGeometry(QtCore.QRect(150, 430, 100, 30))
        self.btnapply = QtWidgets.QPushButton(ExtractMl2DWcae)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 480, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/retrieve.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ExtractMl2DWcae)
        self.msgbox.setObjectName('msgbox')
        _center_x = ExtractMl2DWcae.geometry().center().x()
        _center_y = ExtractMl2DWcae.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ExtractMl2DWcae)
        QtCore.QMetaObject.connectSlotsByName(ExtractMl2DWcae)

    def retranslateGUI(self, ExtractMl2DWcae):
        self.dialog = ExtractMl2DWcae
        _translate = QtCore.QCoreApplication.translate
        ExtractMl2DWcae.setWindowTitle(_translate('ExtractMl2DWcae', 'Extract 2D-WCAE'))
        self.lblfrom.setText(_translate('ExtractMl2DWcae', 'Select network:'))
        self.ldtfrom.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ExtractMl2DWcae', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ExtractMl2DWcae', 'Training features:'))
        self.lwgfeature.itemSelectionChanged.connect(self.changeLwgFeature)
        self.lblornt.setText(_translate('ExtractMl2DWcae', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ExtractMl2DWcae', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ExtractMl2DWcae', 'height='))
        self.ldtoldheight.setText(_translate('ExtractMl2DWcae', '0'))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ExtractMl2DWcae', 'width='))
        self.ldtoldwidth.setText(_translate('ExtractMl2DWcae', '0'))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtoldwidth.setEnabled(False)
        self.lblnewsize.setText(_translate('ExtractMl2DWcae', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ExtractMl2DWcae', 'height='))
        self.ldtnewheight.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('ExtractMl2DWcae', 'width='))
        self.ldtnewwidth.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('ExtractMl2DWcae', 'Pre-trained WCAE architecture:'))
        self.btnviewnetwork.setText(_translate('ExtractMl2DWcae', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('ExtractMl2DWcae', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ExtractMl2DWcae', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ExtractMl2DWcae', ''))
        ...
        self.lblmasksize.setText(_translate('ExtractMl2DWcae', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ExtractMl2DWcae', 'height='))
        self.ldtmaskheight.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ExtractMl2DWcae', 'width='))
        self.ldtmaskwidth.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ExtractMl2DWcae', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ExtractMl2DWcae', 'height='))
        self.ldtpoolheight.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ExtractMl2DWcae', 'width='))
        self.ldtpoolwidth.setText(_translate('ExtractMl2DWcae', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ExtractMl2DWcae', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ExtractMl2DWcae', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ExtractMl2DWcae', '5'))
        ...
        self.ldtsave.setText(_translate('ExtractMl2DCnn', 'wcae_feature_'))
        self.btnapply.setText(_translate('ExtractMl2DWcae', 'Extract 2D-WCAE'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnExtractMl2DWcae)
    ...
    def clickBtnExtractMl2DWcae(self):
        self.refreshMsgBox()
        if self.checkSurvInfo() is False:
            vis_msg.print('ERROR in ExtractMl2DWcae: No seismic survey available', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', 'No seismic survey available')
            return
        if ml_tfm.checkWCAEModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in ExtractMl2DWcae: No pre-WCAE network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', 'No pre-WCAE network found')
            return
        for f in self.modelinfo['feature_list']:
            if self.checkSeisData(f) is False:
                vis_msg.print(("ERROR in ExtractMl2DWcae: Feature '%s' not found in seismic data" % f), type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', "Feature '" + f + "' not found in seismic data")
                return
        ...
        if _image_height is False or _image_width is False or _image_height_new is False or _image_width_new is False:
            vis_msg.print('ERROR in ExtractMl2DWcae: Non-integer feature size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', 'Non-integer feature size')
            return
        if _image_height < 2 or _image_width < 2 or _image_height_new < 2 or _image_width_new < 2:
            vis_msg.print('ERROR in ExtractMl2DWcae: Features are not 2D', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', 'Features are not 2D')
            return
        _batch = basic_data.str2int(self.ldtbatchsize.text())
        if _batch is False or _batch < 1:
            vis_msg.print('ERROR in ExtractMl2DWcae: Non-positive batch size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', 'Non-positive batch size')
            return
        if len(self.ldtsave.text()) < 1:
            vis_msg.print('ERROR in ExtractMl2DWcae: No prefix specified', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Extract 2D-WCAE', 'No prefix specified')
            return
        if self.ldtsave.text() + '1' in self.seisdata.keys():
            if self.checkSeisData(self.ldtsave.text() + '1'):
                reply = QtWidgets.QMessageBox.question(self.msgbox, 'Extract 2D-WCAE', 'Prefix ' + self.ldtsave.text() + ' already exists. Overwrite?', QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No, QtWidgets.QMessageBox.No)
        ...
        _pgsdlg.setWindowTitle('Extract 2D-CAE')
        ...
        for i in range(_nloop):
            ...
            sys.stdout.write('\r>>> Extract 2D-WCAE, proceeding %.1f%% ' % (float(i) / float(_nloop) * 100.0))
            sys.stdout.flush()
            ...
            _rst = ml_wcae.extractWCAEConvFeature(_dict, imageheight=_image_height_new,
              imagewidth=_image_width_new,
              wcaepath=(self.modelpath),
              wcaename=(self.modelname),
              blockidx=_blockidx,
              layeridx=_layeridx,
              location='full',
              batchsize=_batch,
        ...
        QtWidgets.QMessageBox.information(self.msgbox, 'Extract 2D-WCAE', str(_nfeature) + ' WCAE features extracted successfully')
...
if __name__ == '__main__':
    ...
    ExtractMl2DWcae = QtWidgets.QWidget()
    gui = extractml2dwcae()
    gui.setupGUI(ExtractMl2DWcae)
    ExtractMl2DWcae.show()
    sys.exit(app.exec_())