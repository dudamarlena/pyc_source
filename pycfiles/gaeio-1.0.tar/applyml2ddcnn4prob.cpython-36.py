...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\applyml2ddcnn4prob.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 36733 bytes
...
from cognitivegeo.src.ml.dcnnsegmentor import dcnnsegmentor as ml_dcnn
from cognitivegeo.src.gui.viewml2ddcnn import viewml2ddcnn as gui_viewml2ddcnn
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_EnableHighDpiScaling, True)
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_UseHighDpiPixmaps, True)

class applyml2ddcnn4prob(object):
    survinfo = {}
    seisdata = {}
    rootpath = ''
    ...
    def setupGUI(self, ApplyMl2DDcnn4Prob):
        ApplyMl2DDcnn4Prob.setObjectName('ApplyMl2DDcnn4Prob')
        ApplyMl2DDcnn4Prob.setFixedSize(810, 490)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/apply.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ApplyMl2DDcnn4Prob.setWindowIcon(icon)
        self.lblfrom = QtWidgets.QLabel(ApplyMl2DDcnn4Prob)
        self.lblfrom.setObjectName('lblfrom')
        self.lblfrom.setGeometry(QtCore.QRect(10, 10, 100, 30))
        self.ldtfrom = QtWidgets.QLineEdit(ApplyMl2DDcnn4Prob)
        self.ldtfrom.setObjectName('ldtfrom')
        self.ldtfrom.setGeometry(QtCore.QRect(110, 10, 210, 30))
        self.btnfrom = QtWidgets.QPushButton(ApplyMl2DDcnn4Prob)
        self.btnfrom.setObjectName('btnfrom')
        self.btnfrom.setGeometry(QtCore.QRect(330, 10, 60, 30))
        self.lblfeature = QtWidgets.QLabel(ApplyMl2DDcnn4Prob)
        self.lblfeature.setObjectName('lblfeature')
        self.lblfeature.setGeometry(QtCore.QRect(10, 60, 100, 30))
        self.lwgfeature = QtWidgets.QListWidget(ApplyMl2DDcnn4Prob)
        ...
        self.lblnconvblock = QtWidgets.QLabel(ApplyMl2DDcnn4Prob)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ApplyMl2DDcnn4Prob)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ApplyMl2DDcnn4Prob)
        ...
        self.btnapply = QtWidgets.QPushButton(ApplyMl2DDcnn4Prob)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 440, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/apply.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ApplyMl2DDcnn4Prob)
        self.msgbox.setObjectName('msgbox')
        _center_x = ApplyMl2DDcnn4Prob.geometry().center().x()
        _center_y = ApplyMl2DDcnn4Prob.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ApplyMl2DDcnn4Prob)
        QtCore.QMetaObject.connectSlotsByName(ApplyMl2DDcnn4Prob)

    def retranslateGUI(self, ApplyMl2DDcnn4Prob):
        self.dialog = ApplyMl2DDcnn4Prob
        _translate = QtCore.QCoreApplication.translate
        ApplyMl2DDcnn4Prob.setWindowTitle(_translate('ApplyMl2DDcnn4Prob', 'Apply 2D-DCNN for probabilities'))
        self.lblfrom.setText(_translate('ApplyMl2DDcnn4Prob', 'Select network:'))
        self.ldtfrom.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ApplyMl2DDcnn4Prob', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ApplyMl2DDcnn4Prob', 'Training features:'))
        self.lwgfeature.itemSelectionChanged.connect(self.changeLwgFeature)
        self.lblornt.setText(_translate('ApplyMl2DDcnn4Prob', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ApplyMl2DDcnn4Prob', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ApplyMl2DDcnn4Prob', 'height='))
        self.ldtoldheight.setText(_translate('ApplyMl2DDcnn4Prob', '0'))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ApplyMl2DDcnn4Prob', 'width='))
        self.ldtoldwidth.setText(_translate('ApplyMl2DDcnn4Prob', '0'))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtoldwidth.setEnabled(False)
        self.lblnewsize.setText(_translate('ApplyMl2DDcnn4Prob', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ApplyMl2DDcnn4Prob', 'height='))
        self.ldtnewheight.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('ApplyMl2DDcnn4Prob', 'width='))
        self.ldtnewwidth.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('ApplyMl2DDcnn4Prob', 'Pre-trained DCNN architecture:'))
        self.btnviewnetwork.setText(_translate('ApplyMl2DDcnn4Prob', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('ApplyMl2DDcnn4Prob', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ApplyMl2DDcnn4Prob', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        ...
        self.lblmasksize.setText(_translate('ApplyMl2DDcnn4Prob', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ApplyMl2DDcnn4Prob', 'height='))
        self.ldtmaskheight.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ApplyMl2DDcnn4Prob', 'width='))
        self.ldtmaskwidth.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ApplyMl2DDcnn4Prob', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ApplyMl2DDcnn4Prob', 'height='))
        self.ldtpoolheight.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ApplyMl2DDcnn4Prob', 'width='))
        self.ldtpoolwidth.setText(_translate('ApplyMl2DDcnn4Prob', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ApplyMl2DDcnn4Prob', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ApplyMl2DDcnn4Prob', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ApplyMl2DDcnn4Prob', '5'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lblsave.setText(_translate('ApplyMl2DDcnn4Prob', 'Output profix='))
        self.lblsave.setAlignment(QtCore.Qt.AlignRight)
        self.ldtsave.setText(_translate('ApplyMl2DDcnn4Prob', 'dcnn_prob_'))
        self.ldtsave.setAlignment(QtCore.Qt.AlignCenter)
        self.lbltarget.setText(_translate('ApplyMl2DDcnn4Prob', 'Target ='))
        self.btnapply.setText(_translate('ApplyMl2DDcnn4Prob', 'Apply 2D-DCNN'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnApplyMl2DDcnn4Prob)
    ...
    def clickBtnApplyMl2DDcnn4Prob(self):
        self.refreshMsgBox()
        if self.checkSurvInfo() is False:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: No seismic survey available', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'No seismic survey available')
            return
        if ml_tfm.checkDCNNModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: No pre-DCNN network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'No pre-DCNN network found')
            return
        for f in self.modelinfo['feature_list']:
            if self.checkSeisData(f) is False:
                vis_msg.print(("ERROR in ApplyMl2DDcnn4Prob: Feature '%s' not found in seismic data" % f), type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', "Feature '" + f + "' not found in seismic data")
                return
        ...
        if _image_height is False or _image_width is False or _image_height_new is False or _image_width_new is False:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: Non-integer feature size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'Non-integer feature size')
            return
        if _image_height < 2 or _image_width < 2 or _image_height_new < 2 or _image_width_new < 2:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: Features are not 2D', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'Features are not 2D')
            return
        _batch = basic_data.str2int(self.ldtbatchsize.text())
        if _batch is False or _batch < 1:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: Non-positive batch size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'Non-positive batch size')
            return
        if len(self.ldtsave.text()) < 1:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: No prefix specified', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'No prefix specified')
            return
        if len(self.lwgtarget.selectedItems()) < 1:
            vis_msg.print('ERROR in ApplyMl2DDcnn4Prob: No target class specified', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Apply 2D-DCNN', 'No target class specified')
            return
        ...
        for _class in _classlist:
            if self.ldtsave.text() + str(_class) in self.seisdata.keys():
                if self.checkSeisData(self.ldtsave.text() + str(_class)):
                    reply = QtWidgets.QMessageBox.question(self.msgbox, 'Apply 2D-DCNN', self.ldtsave.text() + ' already exists. Overwrite?', QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No, QtWidgets.QMessageBox.No)
        ...
        _pgsdlg.setWindowTitle('Apply 2D-DCNN')
        ...
        for i in range(_nloop):
            ...
            sys.stdout.write('\r>>> Apply 2D-DCNN, proceeding %.1f%% ' % (float(i) / float(_nloop) * 100.0))
            sys.stdout.flush()
            ...
            _rst = ml_dcnn.probabilityFromDCNNSegmentor(_dict, imageheight=_image_height_new,
              imagewidth=_image_width_new,
              dcnnpath=(self.modelpath),
              dcnnname=(self.modelname),
        ...
        QtWidgets.QMessageBox.information(self.msgbox, 'Apply 2D-DCNN', 'DCNN applied successfully')
...
if __name__ == '__main__':
    ...
    ApplyMl2DDcnn4Prob = QtWidgets.QWidget()
    gui = applyml2ddcnn4prob()
    gui.setupGUI(ApplyMl2DDcnn4Prob)
    ApplyMl2DDcnn4Prob.show()
    sys.exit(app.exec_())