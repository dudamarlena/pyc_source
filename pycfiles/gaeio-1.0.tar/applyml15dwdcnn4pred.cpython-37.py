...
class applyml15dwdcnn4pred(object):
    ...
    def clickBtnApplyMl15DWdcnn4Pred--- This code section failed: ---
 ...
 L. 461        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Pred: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 463        44  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 468        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Pred: No pre-WDCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 470       100  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 471       102  LOAD_STR                 'No pre-WDCNN network found'
 ...
 L. 476       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ApplyMl15DWdcnn4Pred: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    

 L. 477       152  LOAD_STR                 'error'
              154  LOAD_CONST               ('type',)
              156  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              158  POP_TOP          

 L. 478       160  LOAD_GLOBAL              QtWidgets
              162  LOAD_ATTR                QMessageBox
              164  LOAD_METHOD              critical
              166  LOAD_FAST                'self'
              168  LOAD_ATTR                msgbox

 L. 479       170  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 480       172  LOAD_STR                 "Feature '"
              174  LOAD_FAST                'f'
              176  BINARY_ADD       
 ...
 L. 485       220  LOAD_GLOBAL              basic_data
 ...
 L. 486       236  LOAD_GLOBAL              basic_data
 ...
 L. 487       252  LOAD_GLOBAL              basic_data
 ...
 L. 488       268  LOAD_FAST                '_image_height'
 ...
 L. 489       288  LOAD_FAST                '_image_height_new'
 ...
 L. 490       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Pred: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
              318  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              320  POP_TOP          

 L. 491       322  LOAD_GLOBAL              QtWidgets
              324  LOAD_ATTR                QMessageBox
              326  LOAD_METHOD              critical
              328  LOAD_FAST                'self'
              330  LOAD_ATTR                msgbox

 L. 492       332  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 493       334  LOAD_STR                 'Non-integer feature size'
              336  CALL_METHOD_3         3  '3 positional arguments'
              338  POP_TOP          

 L. 494       340  LOAD_CONST               None
              342  RETURN_VALUE     
            344_0  COME_FROM           304  '304'

 L. 495       344  LOAD_FAST                '_image_height'
              346  LOAD_CONST               2
              348  COMPARE_OP               <
 ...
 L. 496       364  LOAD_FAST                '_image_height_new'
              366  LOAD_CONST               2
              368  COMPARE_OP               <
 ...
 L. 497       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Pred: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
              394  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              396  POP_TOP          

 L. 498       398  LOAD_GLOBAL              QtWidgets
              400  LOAD_ATTR                QMessageBox
              402  LOAD_METHOD              critical
              404  LOAD_FAST                'self'
              406  LOAD_ATTR                msgbox

 L. 499       408  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 500       410  LOAD_STR                 'Features are not 2D'
              412  CALL_METHOD_3         3  '3 positional arguments'
              414  POP_TOP          

 L. 501       416  LOAD_CONST               None
              418  RETURN_VALUE     
            420_0  COME_FROM           380  '380'

 L. 503       420  LOAD_GLOBAL              basic_data
 ...
 L. 505       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Pred: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
              466  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              468  POP_TOP          

 L. 506       470  LOAD_GLOBAL              QtWidgets
              472  LOAD_ATTR                QMessageBox
              474  LOAD_METHOD              critical
              476  LOAD_FAST                'self'
              478  LOAD_ATTR                msgbox

 L. 507       480  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 508       482  LOAD_STR                 'Non-positive batch size'
              484  CALL_METHOD_3         3  '3 positional arguments'
              486  POP_TOP          

 L. 509       488  LOAD_CONST               None
              490  RETURN_VALUE     
            492_0  COME_FROM           452  '452'

 L. 511       492  LOAD_GLOBAL              len
              494  LOAD_FAST                'self'
 ...
 L. 512       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ApplyMl15DWdcnn4Pred: No name specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
              522  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              524  POP_TOP          

 L. 513       526  LOAD_GLOBAL              QtWidgets
              528  LOAD_ATTR                QMessageBox
              530  LOAD_METHOD              critical
              532  LOAD_FAST                'self'
              534  LOAD_ATTR                msgbox

 L. 514       536  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 515       538  LOAD_STR                 'No name specified'
              540  CALL_METHOD_3         3  '3 positional arguments'
              542  POP_TOP          

 L. 516       544  LOAD_CONST               None
              546  RETURN_VALUE     
            548_0  COME_FROM           508  '508'

 L. 517       548  LOAD_FAST                'self'
 ...
 L. 518       588  LOAD_GLOBAL              QtWidgets
              590  LOAD_ATTR                QMessageBox
              592  LOAD_METHOD              question
              594  LOAD_FAST                'self'
              596  LOAD_ATTR                msgbox
              598  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 519       600  LOAD_FAST                'self'
 ...
 L. 520       612  LOAD_GLOBAL              QtWidgets
 ...
 L. 537       756  BUILD_MAP_0           0 
              758  STORE_FAST               '_seisdict'

 L. 538       760  LOAD_FAST                'self'
 ...
 L. 551      1024  LOAD_GLOBAL              basic_mdt
 ...
 L. 569      1194  LOAD_CONST               0
             1196  STORE_FAST               'idxstart'

 L. 570  1198_1200  SETUP_LOOP         1772  'to 1772'
 ...
 L. 574      1230  LOAD_GLOBAL              sys
             1232  LOAD_ATTR                stdout
             1234  LOAD_METHOD              write

 L. 575      1236  LOAD_STR                 '\r>>> Apply 1.5D-WDCNN, proceeding %.1f%% '
 ...
 L. 582      1322  LOAD_FAST                'idxend'
             1324  STORE_FAST               'idxstart'

 L. 583      1326  LOAD_GLOBAL              basic_mdt
 ...
 L. 585      1338  LOAD_FAST                '_dict'
             1340  LOAD_STR                 'Inline'
             1342  BINARY_SUBSCR    
             1344  STORE_FAST               '_targetdata'

 L. 586      1346  LOAD_FAST                'self'
 ...
 L. 597      1520  SETUP_LOOP         1602  'to 1602'
 ...
 L. 604      1602  LOAD_FAST                '_image_height_new'
 ...
 L. 605      1622  SETUP_LOOP         1666  'to 1666'
             1624  LOAD_FAST                '_features'
             1626  GET_ITER         
             1628  FOR_ITER           1664  'to 1664'
             1630  STORE_FAST               'f'

 L. 606      1632  LOAD_GLOBAL              basic_image
             1634  LOAD_ATTR                changeImageSize
             1636  LOAD_FAST                '_dict'
             1638  LOAD_FAST                'f'
             1640  BINARY_SUBSCR    

 L. 607      1642  LOAD_FAST                '_image_height'

 L. 608      1644  LOAD_FAST                '_image_width'

 L. 609      1646  LOAD_FAST                '_image_height_new'

 L. 610      1648  LOAD_FAST                '_image_width_new'
 ...
 L. 613      1666  LOAD_GLOBAL              ml_wdcnn15d
             1668  LOAD_ATTR                predictionFrom15DWDCNNSegmentor
             1670  LOAD_FAST                '_dict'

 L. 614      1672  LOAD_FAST                '_image_height_new'

 L. 615      1674  LOAD_FAST                '_image_width_new'

 L. 616      1676  LOAD_FAST                'self'
             1678  LOAD_ATTR                modelpath

 L. 617      1680  LOAD_FAST                'self'
             1682  LOAD_ATTR                modelname

 L. 618      1684  LOAD_FAST                '_batch'
             1686  LOAD_CONST               False
             1688  LOAD_CONST               ('imageheight', 'imagewidth', 'wdcnnpath', 'wdcnnname', 'batchsize', 'verbose')
             1690  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
             1692  STORE_FAST               '_rst'

 L. 620      1694  LOAD_FAST                '_image_height_new'
             1696  LOAD_FAST                '_image_height'
             1698  COMPARE_OP               !=
         1700_1702  POP_JUMP_IF_FALSE  1736  'to 1736'

 L. 621      1704  LOAD_GLOBAL              basic_curve
             1706  LOAD_ATTR                changeCurveSize
             1708  LOAD_FAST                '_rst'

 L. 622      1710  LOAD_FAST                '_image_height_new'

 L. 623      1712  LOAD_FAST                '_image_height'
 ...
 L. 631      1772  LOAD_GLOBAL              print
             1774  LOAD_STR                 'Done'
             1776  CALL_FUNCTION_1       1  '1 positional argument'
             1778  POP_TOP          

 L. 633      1780  LOAD_GLOBAL              np
 ...
 L. 644      1956  LOAD_GLOBAL              QtWidgets
             1958  LOAD_ATTR                QMessageBox
             1960  LOAD_METHOD              information
             1962  LOAD_FAST                'self'
             1964  LOAD_ATTR                msgbox

 L. 645      1966  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 646      1968  LOAD_STR                 'WDCNN applied successfully'
