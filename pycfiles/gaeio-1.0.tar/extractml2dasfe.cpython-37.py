...
class extractml2dasfe(object):
    ...
    def clickBtnExtractMl2DAsfe--- This code section failed: ---
 ...
 L. 450        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ExtractMl2DAsfe: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 452        44  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 457        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ExtractMl2DAsfe: No CNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 459       100  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 466       146  LOAD_GLOBAL              vis_msg
              148  LOAD_ATTR                print
              150  LOAD_STR                 "ERROR in ExtractMl2DAsfe: Feature '%s' not found in seismic data"
              152  LOAD_FAST                'f'
              154  BINARY_MODULO    
 ...
 L. 469       174  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 479       302  LOAD_GLOBAL              vis_msg
              304  LOAD_ATTR                print
              306  LOAD_STR                 'ERROR in ExtractMl2DAsfe: Non-integer feature size'
              308  LOAD_STR                 'error'
              310  LOAD_CONST               ('type',)
 ...
 L. 481       326  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 486       378  LOAD_GLOBAL              vis_msg
              380  LOAD_ATTR                print
              382  LOAD_STR                 'ERROR in ExtractMl2DAsfe: Features are not 2D'
              384  LOAD_STR                 'error'
              386  LOAD_CONST               ('type',)
 ...
 L. 488       402  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 494       450  LOAD_GLOBAL              vis_msg
              452  LOAD_ATTR                print
              454  LOAD_STR                 'ERROR in ExtractMl2DAsfe: Non-positive batch size'
              456  LOAD_STR                 'error'
              458  LOAD_CONST               ('type',)
 ...
 L. 496       474  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 501       506  LOAD_GLOBAL              vis_msg
              508  LOAD_ATTR                print
              510  LOAD_STR                 'ERROR in ExtractMl2DAsfe: No prefix specified'
              512  LOAD_STR                 'error'
              514  LOAD_CONST               ('type',)
 ...
 L. 503       530  LOAD_STR                 'Extract 2D-ASFE'
 ...
 L. 574      1228  LOAD_STR                 '\r>>> Extract 2D-ASFE, proceeding %.1f%% '
