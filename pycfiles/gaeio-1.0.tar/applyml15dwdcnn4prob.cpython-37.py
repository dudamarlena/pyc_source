...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\applyml15dwdcnn4prob.py
# Compiled at: 2019-12-15 20:31:46
# Size of source mod 2**32: 38358 bytes
...
class applyml15dwdcnn4prob(object):
    survinfo = {}
    seisdata = {}
    rootpath = ''
    ...
    def setupGUI(self, ApplyMl15DWdcnn4Prob):
        ApplyMl15DWdcnn4Prob.setObjectName('ApplyMl15DWdcnn4Prob')
        ApplyMl15DWdcnn4Prob.setFixedSize(810, 490)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/apply.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ApplyMl15DWdcnn4Prob.setWindowIcon(icon)
        self.lblfrom = QtWidgets.QLabel(ApplyMl15DWdcnn4Prob)
        self.lblfrom.setObjectName('lblfrom')
        self.lblfrom.setGeometry(QtCore.QRect(10, 10, 100, 30))
        self.ldtfrom = QtWidgets.QLineEdit(ApplyMl15DWdcnn4Prob)
        self.ldtfrom.setObjectName('ldtfrom')
        self.ldtfrom.setGeometry(QtCore.QRect(110, 10, 210, 30))
        self.btnfrom = QtWidgets.QPushButton(ApplyMl15DWdcnn4Prob)
        self.btnfrom.setObjectName('btnfrom')
        self.btnfrom.setGeometry(QtCore.QRect(330, 10, 60, 30))
        self.lblfeature = QtWidgets.QLabel(ApplyMl15DWdcnn4Prob)
        self.lblfeature.setObjectName('lblfeature')
        self.lblfeature.setGeometry(QtCore.QRect(10, 60, 100, 30))
        self.lwgfeature = QtWidgets.QListWidget(ApplyMl15DWdcnn4Prob)
        ...
        self.lblnconvblock = QtWidgets.QLabel(ApplyMl15DWdcnn4Prob)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ApplyMl15DWdcnn4Prob)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ApplyMl15DWdcnn4Prob)
        ...
        self.btnapply = QtWidgets.QPushButton(ApplyMl15DWdcnn4Prob)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 440, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/apply.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ApplyMl15DWdcnn4Prob)
        self.msgbox.setObjectName('msgbox')
        _center_x = ApplyMl15DWdcnn4Prob.geometry().center().x()
        _center_y = ApplyMl15DWdcnn4Prob.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ApplyMl15DWdcnn4Prob)
        QtCore.QMetaObject.connectSlotsByName(ApplyMl15DWdcnn4Prob)

    def retranslateGUI(self, ApplyMl15DWdcnn4Prob):
        self.dialog = ApplyMl15DWdcnn4Prob
        _translate = QtCore.QCoreApplication.translate
        ApplyMl15DWdcnn4Prob.setWindowTitle(_translate('ApplyMl15DWdcnn4Prob', 'Apply 1.5D-WDCNN for probabilities'))
        self.lblfrom.setText(_translate('ApplyMl15DWdcnn4Prob', 'Select network:'))
        self.ldtfrom.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ApplyMl15DWdcnn4Prob', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ApplyMl15DWdcnn4Prob', 'Training features:'))
        self.lwgfeature.itemSelectionChanged.connect(self.changeLwgFeature)
        self.lblornt.setText(_translate('ApplyMl15DWdcnn4Prob', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ApplyMl15DWdcnn4Prob', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ApplyMl15DWdcnn4Prob', 'height='))
        self.ldtoldheight.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ApplyMl15DWdcnn4Prob', 'width='))
        self.ldtoldwidth.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewsize.setText(_translate('ApplyMl15DWdcnn4Prob', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ApplyMl15DWdcnn4Prob', 'height='))
        self.ldtnewheight.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('ApplyMl15DWdcnn4Prob', 'width='))
        self.ldtnewwidth.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtnewwidth.setEnabled(False)
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('ApplyMl15DWdcnn4Prob', 'Pre-trained WDCNN architecture:'))
        self.btnviewnetwork.setText(_translate('ApplyMl15DWdcnn4Prob', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('ApplyMl15DWdcnn4Prob', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ApplyMl15DWdcnn4Prob', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        ...
        self.lblmasksize.setText(_translate('ApplyMl15DWdcnn4Prob', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ApplyMl15DWdcnn4Prob', 'height='))
        self.ldtmaskheight.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ApplyMl15DWdcnn4Prob', 'width='))
        self.ldtmaskwidth.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ApplyMl15DWdcnn4Prob', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ApplyMl15DWdcnn4Prob', 'height='))
        self.ldtpoolheight.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ApplyMl15DWdcnn4Prob', 'width='))
        self.ldtpoolwidth.setText(_translate('ApplyMl15DWdcnn4Prob', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ApplyMl15DWdcnn4Prob', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ApplyMl15DWdcnn4Prob', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ApplyMl15DWdcnn4Prob', '50'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lblsave.setText(_translate('ApplyMl15DWdcnn4Prob', 'Output profix='))
        self.lblsave.setAlignment(QtCore.Qt.AlignRight)
        self.ldtsave.setText(_translate('ApplyMl15DWdcnn4Prob', 'wdcnn_prob_'))
        self.ldtsave.setAlignment(QtCore.Qt.AlignCenter)
        self.lbltarget.setText(_translate('ApplyMl15DWdcnn4Prob', 'Target ='))
        self.btnapply.setText(_translate('ApplyMl15DWdcnn4Prob', 'Apply 1.5D-WDCNN'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnApplyMl15DWdcnn4Prob)
    ...
    def clickBtnApplyMl15DWdcnn4Prob--- This code section failed: ---
 ...
 L. 474        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 476        44  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 481        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: No pre-WDCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 483       100  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 484       102  LOAD_STR                 'No pre-WDCNN network found'
 ...
 L. 489       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ApplyMl15DWdcnn4Prob: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 492       170  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 503       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
 ...
 L. 505       332  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 510       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
 ...
 L. 512       408  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 518       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
 ...
 L. 520       480  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 525       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: No prefix specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
 ...
 L. 527       536  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 532       568  LOAD_GLOBAL              vis_msg
              570  LOAD_ATTR                print
              572  LOAD_STR                 'ERROR in ApplyMl15DWdcnn4Prob: No target class specified'
              574  LOAD_STR                 'error'
              576  LOAD_CONST               ('type',)
 ...
 L. 534       592  LOAD_STR                 'Apply 1.5D-WDCNN'
 ...
 L. 537       604  LOAD_LISTCOMP            '<code_object <listcomp>>'
              606  LOAD_STR                 'applyml15dwdcnn4prob.clickBtnApplyMl15DWdcnn4Prob.<locals>.<listcomp>'
 ...
 L. 575      1148  LOAD_GLOBAL              basic_mdt
 ...
 L. 593      1324  LOAD_CONST               0
             1326  STORE_FAST               'idxstart'

 L. 594  1328_1330  SETUP_LOOP         1948  'to 1948'
 ...
 L. 598      1360  LOAD_GLOBAL              sys
             1362  LOAD_ATTR                stdout
             1364  LOAD_METHOD              write

 L. 599      1366  LOAD_STR                 '\r>>> Apply 1.5D-WDCNN, proceeding %.1f%% '
 ...
 L. 606      1452  LOAD_FAST                'idxend'
             1454  STORE_FAST               'idxstart'

 L. 607      1456  LOAD_GLOBAL              basic_mdt
 ...
 L. 609      1468  LOAD_FAST                '_dict'
             1470  LOAD_STR                 'Inline'
             1472  BINARY_SUBSCR    
             1474  STORE_FAST               '_targetdata'

 L. 610      1476  LOAD_FAST                'self'
 ...
 L. 628      1732  LOAD_FAST                '_image_height_new'
 ...
 L. 629      1752  SETUP_LOOP         1796  'to 1796'
             1754  LOAD_FAST                '_features'
             1756  GET_ITER         
             1758  FOR_ITER           1794  'to 1794'
             1760  STORE_FAST               'f'

 L. 630      1762  LOAD_GLOBAL              basic_image
             1764  LOAD_ATTR                changeImageSize
             1766  LOAD_FAST                '_dict'
             1768  LOAD_FAST                'f'
             1770  BINARY_SUBSCR    

 L. 631      1772  LOAD_FAST                '_image_height'

 L. 632      1774  LOAD_FAST                '_image_width'

 L. 633      1776  LOAD_FAST                '_image_height_new'

 L. 634      1778  LOAD_FAST                '_image_width_new'
 ...
 L. 637      1796  LOAD_GLOBAL              ml_wdcnn15d
             1798  LOAD_ATTR                probabilityFrom15DWDCNNSegmentor
             1800  LOAD_FAST                '_dict'

 L. 638      1802  LOAD_FAST                '_image_height_new'

 L. 639      1804  LOAD_FAST                '_image_width_new'

 L. 640      1806  LOAD_FAST                'self'
             1808  LOAD_ATTR                modelpath

 L. 641      1810  LOAD_FAST                'self'
             1812  LOAD_ATTR                modelname

 L. 642      1814  LOAD_FAST                '_classlist'

 L. 643      1816  LOAD_FAST                '_batch'
             1818  LOAD_CONST               False
             1820  LOAD_CONST               ('imageheight', 'imagewidth', 'wdcnnpath', 'wdcnnname', 'targetlist', 'batchsize', 'verbose')
             1822  CALL_FUNCTION_KW_8     8  '8 total positional and keyword args'
             1824  STORE_FAST               '_rst'

 L. 645      1826  LOAD_FAST                '_image_height_new'
             1828  LOAD_FAST                '_image_height'
             1830  COMPARE_OP               !=
         1832_1834  POP_JUMP_IF_FALSE  1888  'to 1888'

 L. 646      1836  LOAD_GLOBAL              np
 ...
 L. 647      1870  LOAD_GLOBAL              basic_curve
             1872  LOAD_ATTR                changeCurveSize
             1874  LOAD_FAST                '_rst'

 L. 648      1876  LOAD_FAST                '_image_height_new'

 L. 649      1878  LOAD_FAST                '_image_height'
 ...
 L. 655      1948  LOAD_GLOBAL              print
             1950  LOAD_STR                 'Done'
             1952  CALL_FUNCTION_1       1  '1 positional argument'
             1954  POP_TOP          

 L. 657      1956  SETUP_LOOP         2188  'to 2188'
 ...
 L. 667      2188  LOAD_GLOBAL              QtWidgets
             2190  LOAD_ATTR                QMessageBox
             2192  LOAD_METHOD              information
             2194  LOAD_FAST                'self'
             2196  LOAD_ATTR                msgbox

 L. 668      2198  LOAD_STR                 'Apply 1.5D-WDCNN'

 L. 669      2200  LOAD_STR                 'WDCNN applied successfully'
...
if __name__ == '__main__':
    ...
    ApplyMl15DWdcnn4Prob = QtWidgets.QWidget()
    gui = applyml15dwdcnn4prob()
    gui.setupGUI(ApplyMl15DWdcnn4Prob)
    ApplyMl15DWdcnn4Prob.show()
    sys.exit(app.exec_())