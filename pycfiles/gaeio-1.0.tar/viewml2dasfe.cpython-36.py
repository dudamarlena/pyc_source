...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\viewml2dasfe.py
...
from cognitivegeo.src.gui.plotml2dasfeconvmask import plotml2dasfeconvmask as gui_plotml2dasfeconvmask
from cognitivegeo.src.vis.messager import messager as vis_msg
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_EnableHighDpiScaling, True)
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_UseHighDpiPixmaps, True)

class viewml2dasfe(object):
    rootpath = ''
    ...
    def setupGUI(self, ViewMl2DAsfe):
        ...
        self.lblmasksize = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 280, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 280, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 280, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 320, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 320, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 280, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 280, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 280, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 320, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 320, 40, 30))
        self.lblpara = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 230, 190, 30))
        self.lblnepoch = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblnepoch.setObjectName('lblnepoch')
        self.lblnepoch.setGeometry(QtCore.QRect(10, 270, 130, 30))
        self.ldtnepoch = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtnepoch.setObjectName('ldtnepoch')
        self.ldtnepoch.setGeometry(QtCore.QRect(150, 270, 40, 30))
        self.lblbatchsize = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(210, 270, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(350, 270, 40, 30))
        self.lbllearnrate = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lbllearnrate.setObjectName('lbllearnrate')
        self.lbllearnrate.setGeometry(QtCore.QRect(10, 310, 130, 30))
        self.ldtlearnrate = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtlearnrate.setObjectName('ldtlearnrate')
        self.ldtlearnrate.setGeometry(QtCore.QRect(150, 310, 40, 30))
        self.lblfcdropout = QtWidgets.QLabel(ViewMl2DAsfe)
        self.lblfcdropout.setObjectName('lblfcdropout')
        self.lblfcdropout.setGeometry(QtCore.QRect(210, 310, 130, 30))
        self.ldtfcdropout = QtWidgets.QLineEdit(ViewMl2DAsfe)
        self.ldtfcdropout.setObjectName('ldtfcdropout')
        self.ldtfcdropout.setGeometry(QtCore.QRect(350, 310, 40, 30))
        self.btnviewlc = QtWidgets.QPushButton(ViewMl2DAsfe)
        self.btnviewlc.setObjectName('btnviewlc')
        self.btnviewlc.setGeometry(QtCore.QRect(80, 370, 160, 30))
        icon = QtGui.QIcon()
        ...
        self.btnplotlc = QtWidgets.QPushButton(ViewMl2DAsfe)
        self.btnplotlc.setObjectName('btnplotlc')
        self.btnplotlc.setGeometry(QtCore.QRect(320, 370, 160, 30))
        icon = QtGui.QIcon()
        ...
        self.btnplotmask = QtWidgets.QPushButton(ViewMl2DAsfe)
        self.btnplotmask.setObjectName('btnplotmask')
        self.btnplotmask.setGeometry(QtCore.QRect(560, 370, 160, 30))
        icon = QtGui.QIcon()
        ...
        self.msgbox = QtWidgets.QMessageBox(ViewMl2DAsfe)
        self.msgbox.setObjectName('msgbox')
        _center_x = ViewMl2DAsfe.geometry().center().x()
        _center_y = ViewMl2DAsfe.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ViewMl2DAsfe)
        QtCore.QMetaObject.connectSlotsByName(ViewMl2DAsfe)

    def retranslateGUI(self, ViewMl2DAsfe):
        self.dialog = ViewMl2DAsfe
        _translate = QtCore.QCoreApplication.translate
        ViewMl2DAsfe.setWindowTitle(_translate('ViewMl2DAsfe', 'View 2D-ASFE'))
        self.lblfrom.setText(_translate('ViewMl2DAsfe', 'Select network:'))
        self.ldtfrom.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ViewMl2DAsfe', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblattrib.setText(_translate('ViewMl2DAsfe', 'Feature channel:'))
        self.lblpatchsize.setText(_translate('ViewMl2DAsfe', 'Patch size:'))
        self.lblpatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpatchheight.setText(_translate('ViewMl2DAsfe', 'height='))
        self.ldtpatchheight.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtpatchheight.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtpatchheight.setEnabled(False)
        self.lblpatchwidth.setText(_translate('ViewMl2DAsfe', 'width='))
        self.ldtpatchwidth.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtpatchwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtpatchwidth.setEnabled(False)
        self.lblnetwork.setText(_translate('ViewMl2DAsfe', 'Pre-trained ASFE architecture:'))
        self.lblnconvblock.setText(_translate('ViewMl2DAsfe', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lblnfclayer.setText(_translate('ViewMl2DAsfe', 'No. of MLP layers:'))
        self.lblnfclayer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnfclayer.setText(_translate('ViewMl2DAsfe', ''))
        ...
        self.lblmasksize.setText(_translate('ViewMl2DAsfe', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ViewMl2DAsfe', 'height='))
        self.ldtmaskheight.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ViewMl2DAsfe', 'width='))
        self.ldtmaskwidth.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ViewMl2DAsfe', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ViewMl2DAsfe', 'height='))
        self.ldtpoolheight.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ViewMl2DAsfe', 'width='))
        self.ldtpoolwidth.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ViewMl2DAsfe', 'Pre-training parameters:'))
        self.lblnepoch.setText(_translate('ViewMl2DAsfe', 'No. of epochs:'))
        self.lblnepoch.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnepoch.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtnepoch.setEnabled(False)
        self.ldtnepoch.setAlignment(QtCore.Qt.AlignCenter)
        self.lblbatchsize.setText(_translate('ViewMl2DAsfe', 'Batch size:'))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtbatchsize.setEnabled(False)
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lbllearnrate.setText(_translate('ViewMl2DAsfe', 'Learning rate:'))
        self.lbllearnrate.setAlignment(QtCore.Qt.AlignRight)
        self.ldtlearnrate.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtlearnrate.setEnabled(False)
        self.ldtlearnrate.setAlignment(QtCore.Qt.AlignCenter)
        self.lblfcdropout.setText(_translate('ViewMl2DAsfe', 'MLP dropout rate:'))
        self.lblfcdropout.setAlignment(QtCore.Qt.AlignRight)
        self.ldtfcdropout.setText(_translate('ViewMl2DAsfe', ''))
        self.ldtfcdropout.setEnabled(False)
        self.ldtfcdropout.setAlignment(QtCore.Qt.AlignCenter)
        self.btnviewlc.setText(_translate('ViewMl2DAsfe', 'View Learning Matrix'))
        self.btnviewlc.clicked.connect(self.clickBtnViewLc)
        self.btnplotlc.setText(_translate('ViewMl2DAsfe', 'Plot Learning Curve'))
        self.btnplotlc.setDefault(True)
        self.btnplotlc.clicked.connect(self.clickBtnPlotLc)
        self.btnplotmask.setText(_translate('ViewMl2DAsfe', 'Plot Conv. Masks'))
    ...
    def clickBtnFrom(self):
        ...
        _file = _dialog.getOpenFileName(None, 'Select ASFE Network', (self.rootpath), filter='Tensorflow network files (*.meta);; All files (*.*)')
        if len(_file[0]) > 0:
    ...
    def clickBtnViewLc(self):
        ...
        if ml_tfm.checkCNNModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in ViewMl2DAsfe: No ASFE network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'View 2D-ASFE', 'No ASFE network found')
            return
    ...
    def clickBtnPlotMask(self):
        ...
        if ml_tfm.checkCNNModel(self.modelpath, self.modelname) is False:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, 'View 2D-ASFE', 'No ASFE network found')
            return
        _plotmlconvmask = QtWidgets.QDialog()
        _gui = gui_plotml2dasfeconvmask()
        _gui.modelpath = self.modelpath
        _gui.modelname = self.modelname
        _gui.maskstyle = self.maskstyle
        _gui.setupGUI(_plotmlconvmask)
        _plotmlconvmask.exec()
        _plotmlconvmask.show()
...
if __name__ == '__main__':
    ...
    ViewMl2DAsfe = QtWidgets.QWidget()
    gui = viewml2dasfe()
    gui.setupGUI(ViewMl2DAsfe)
    ViewMl2DAsfe.show()
    sys.exit(app.exec_())