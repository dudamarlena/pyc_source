...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\gui\settingsgui.py
# Compiled at: 2020-04-25 15:12:01
# Size of source mod 2**32: 7463 bytes
...
class settingsgui(object):
    ...
    def retranslateGUI(self, SettingsGUI):
        ...
        self.cbxtoolbarleft.setEnabled(False)
        ...
        if self.mainwindow is not None:
            self.cbxtoolbarleft.setChecked(False)
    ...
    def changeCbxToolbarLeft(self):
        ...
        if self.mainwindow is None:
            QtWidgets.QMessageBox.critical(self.msgbox, 'GAEIO', 'No GAEIO found')
            return
        else:
