...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\extractml15dwdcnn.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 37186 bytes
...
import cognitivegeo.src.gui.viewml15dwdcnn as gui_viewml15dwdcnn
import cognitivegeo.src.vis.messager as vis_msg
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_EnableHighDpiScaling, True)
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_UseHighDpiPixmaps, True)

class extractml15dwdcnn(object):
    survinfo = {}
    seisdata = {}
    rootpath = ''
    ...
    def setupGUI(self, ExtractMl15DWdcnn):
        ExtractMl15DWdcnn.setObjectName('ExtractMl15DWdcnn')
        ExtractMl15DWdcnn.setFixedSize(810, 480)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/retrieve.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ExtractMl15DWdcnn.setWindowIcon(icon)
        self.lblfrom = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblfrom.setObjectName('lblfrom')
        self.lblfrom.setGeometry(QtCore.QRect(10, 10, 100, 30))
        self.ldtfrom = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtfrom.setObjectName('ldtfrom')
        self.ldtfrom.setGeometry(QtCore.QRect(110, 10, 210, 30))
        self.btnfrom = QtWidgets.QPushButton(ExtractMl15DWdcnn)
        self.btnfrom.setObjectName('btnfrom')
        self.btnfrom.setGeometry(QtCore.QRect(330, 10, 60, 30))
        self.lblfeature = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblfeature.setObjectName('lblfeature')
        self.lblfeature.setGeometry(QtCore.QRect(10, 60, 100, 30))
        self.lwgfeature = QtWidgets.QListWidget(ExtractMl15DWdcnn)
        ...
        self.lblnconvblock = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ExtractMl15DWdcnn)
        ...
        self.lblmasksize = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 350, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 350, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 350, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 390, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 390, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 350, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 350, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 350, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 390, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 390, 40, 30))
        self.lblpara = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 320, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 350, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 350, 40, 30))
        self.lbltype = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lbltype.setObjectName('lbltype')
        self.lbltype.setGeometry(QtCore.QRect(10, 390, 130, 30))
        self.cbbtype = QtWidgets.QComboBox(ExtractMl15DWdcnn)
        self.cbbtype.setObjectName('cbbtype')
        self.cbbtype.setGeometry(QtCore.QRect(150, 390, 240, 30))
        self.lblsave = QtWidgets.QLabel(ExtractMl15DWdcnn)
        self.lblsave.setObjectName('lblsave')
        self.lblsave.setGeometry(QtCore.QRect(10, 430, 130, 30))
        self.ldtsave = QtWidgets.QLineEdit(ExtractMl15DWdcnn)
        self.ldtsave.setObjectName('ldtsave')
        self.ldtsave.setGeometry(QtCore.QRect(150, 430, 100, 30))
        self.btnapply = QtWidgets.QPushButton(ExtractMl15DWdcnn)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(520, 430, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/retrieve.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ExtractMl15DWdcnn)
        self.msgbox.setObjectName('msgbox')
        _center_x = ExtractMl15DWdcnn.geometry().center().x()
        _center_y = ExtractMl15DWdcnn.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ExtractMl15DWdcnn)
        QtCore.QMetaObject.connectSlotsByName(ExtractMl15DWdcnn)

    def retranslateGUI(self, ExtractMl15DWdcnn):
        self.dialog = ExtractMl15DWdcnn
        _translate = QtCore.QCoreApplication.translate
        ExtractMl15DWdcnn.setWindowTitle(_translate('ExtractMl15DWdcnn', 'Extract 1.5D-WDCNN'))
        self.lblfrom.setText(_translate('ExtractMl15DWdcnn', 'Select network:'))
        self.ldtfrom.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ExtractMl15DWdcnn', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ExtractMl15DWdcnn', 'Training features:'))
        self.lwgfeature.itemSelectionChanged.connect(self.changeLwgFeature)
        self.lblornt.setText(_translate('ExtractMl15DWdcnn', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ExtractMl15DWdcnn', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ExtractMl15DWdcnn', 'height='))
        self.ldtoldheight.setText(_translate('ExtractMl15DWdcnn', '0'))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ExtractMl15DWdcnn', 'width='))
        self.ldtoldwidth.setText(_translate('ExtractMl15DWdcnn', '0'))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtoldwidth.setEnabled(False)
        self.lblnewsize.setText(_translate('ExtractMl15DWdcnn', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ExtractMl15DWdcnn', 'height='))
        self.ldtnewheight.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('ExtractMl15DWdcnn', 'width='))
        self.ldtnewwidth.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('ExtractMl15DWdcnn', 'Pre-trained WDCNN architecture:'))
        self.btnviewnetwork.setText(_translate('ExtractMl15DWdcnn', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('ExtractMl15DWdcnn', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ExtractMl15DWdcnn', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ExtractMl15DWdcnn', ''))
        ...
        self.lblmasksize.setText(_translate('ExtractMl15DWdcnn', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ExtractMl15DWdcnn', 'height='))
        self.ldtmaskheight.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ExtractMl15DWdcnn', 'width='))
        self.ldtmaskwidth.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ExtractMl15DWdcnn', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ExtractMl15DWdcnn', 'height='))
        self.ldtpoolheight.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ExtractMl15DWdcnn', 'width='))
        self.ldtpoolwidth.setText(_translate('ExtractMl15DWdcnn', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ExtractMl15DWdcnn', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ExtractMl15DWdcnn', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ExtractMl15DWdcnn', '5'))
        ...
        self.ldtsave.setText(_translate('ExtractMl2DCnn', 'wdcnn15d_feature_'))
        self.btnapply.setText(_translate('ExtractMl15DWdcnn', 'Extract 1.5D-WDCNN'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnExtractMl15DWdcnn)
    ...
    def clickBtnExtractMl15DWdcnn--- This code section failed: ---
 ...
 L. 480        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ExtractMl15DWdcnn: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 482        44  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 487        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ExtractMl15DWdcnn: No pre-WDCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 489       100  LOAD_STR                 'Extract 1.5D-WDCNN'

 L. 490       102  LOAD_STR                 'No pre-WDCNN network found'
 ...
 L. 495       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ExtractMl15DWdcnn: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 498       170  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 510       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ExtractMl15DWdcnn: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
 ...
 L. 512       332  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 517       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ExtractMl15DWdcnn: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
 ...
 L. 519       408  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 525       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ExtractMl15DWdcnn: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
 ...
 L. 527       480  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 532       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ExtractMl15DWdcnn: No prefix specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
 ...
 L. 534       536  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 539       596  LOAD_GLOBAL              QtWidgets
              ...
              606  LOAD_STR                 'Extract 1.5D-WDCNN'
 ...
 L. 547       666  LOAD_GLOBAL              print
              668  LOAD_STR                 'ExtractMl15DWdcnn: Step 1 - Reformat images'
 ...
 L. 551       708  LOAD_GLOBAL              print
              710  LOAD_STR                 'ExtractMl15DWdcnn: Step 2 - Interpolate images if necessary: (%d, %d) --> (%d, %d)'
 ...
 L. 564       792  LOAD_GLOBAL              print
              794  LOAD_STR                 'ExtractMl15DWdcnn: Step 3 - Extract'
              796  CALL_FUNCTION_1       1  '1 positional argument'
              798  POP_TOP          

 L. 565       800  LOAD_GLOBAL              np
 ...
 L. 587      1008  LOAD_CONST               0
             1010  STORE_FAST               '_blockidx'

 L. 588      1012  LOAD_CONST               0
             1014  STORE_FAST               '_layeridx'

 L. 589      1016  SETUP_LOOP         1092  'to 1092'
 ...
 L. 591      1060  LOAD_FAST                'i'
             1062  STORE_FAST               '_blockidx'

 L. 592      1064  LOAD_FAST                '_featureidx'
 ...
 L. 597      1120  LOAD_CONST               0
             1122  STORE_FAST               'idxstart'

 L. 598  1124_1126  SETUP_LOOP         1502  'to 1502'
 ...
 L. 602      1156  LOAD_GLOBAL              sys
             1158  LOAD_ATTR                stdout
             1160  LOAD_METHOD              write

 L. 603      1162  LOAD_STR                 '\r>>> Extract 1.5D-WDCNN, proceeding %.1f%% '
 ...
 L. 610      1248  LOAD_FAST                'idxend'
             1250  STORE_FAST               'idxstart'

 L. 611      1252  LOAD_GLOBAL              basic_mdt
 ...
 L. 612      1264  LOAD_GLOBAL              ml_wdcnn15d
             1266  LOAD_ATTR                extract15DWDCNNConvFeature
             1268  LOAD_FAST                '_dict'

 L. 613      1270  LOAD_FAST                '_image_height_new'
             1272  LOAD_FAST                '_image_width_new'

 L. 614      1274  LOAD_FAST                'self'
             1276  LOAD_ATTR                modelpath

 L. 615      1278  LOAD_FAST                'self'
             1280  LOAD_ATTR                modelname

 L. 616      1282  LOAD_FAST                '_blockidx'

 L. 617      1284  LOAD_FAST                '_layeridx'
             1286  LOAD_STR                 'full'

 L. 618      1288  LOAD_CONST               1
             1290  LOAD_CONST               True
             1292  LOAD_CONST               ('imageheight', 'imagewidth', 'wdcnnpath', 'wdcnnname', 'blockidx', 'layeridx', 'location', 'batchsize', 'verbose')
             1294  CALL_FUNCTION_KW_10    10  '10 total positional and keyword args'
             1296  STORE_FAST               '_rst'

 L. 621      1298  LOAD_GLOBAL              np
 ...
 L. 623      1326  LOAD_FAST                '_feature_height'
 ...
 L. 625      1380  LOAD_GLOBAL              basic_image
             1382  LOAD_ATTR                changeImageSize
             1384  LOAD_FAST                '_rst'

 L. 626      1386  LOAD_FAST                '_feature_height'

 L. 627      1388  LOAD_FAST                '_feature_width'

 L. 628      1390  LOAD_FAST                '_image_height'

 L. 629      1392  LOAD_FAST                '_image_width'
 ...
 L. 638      1502  LOAD_GLOBAL              print
             1504  LOAD_STR                 'Done'
             1506  CALL_FUNCTION_1       1  '1 positional argument'
             1508  POP_TOP          

 L. 640      1510  LOAD_FAST                'self'
             1512  LOAD_ATTR                survinfo
             1514  STORE_FAST               '_info'

 L. 641      1516  LOAD_FAST                '_info'
             1518  LOAD_STR                 'ILNum'
             1520  BINARY_SUBSCR    
             1522  STORE_FAST               '_inlnum'

 L. 642      1524  LOAD_FAST                '_info'
             1526  LOAD_STR                 'XLNum'
             1528  BINARY_SUBSCR    
             1530  STORE_FAST               '_xlnum'

 L. 643      1532  LOAD_FAST                '_info'
             1534  LOAD_STR                 'ZNum'
             1536  BINARY_SUBSCR    
             1538  STORE_FAST               '_znum'

 L. 644      1540  SETUP_LOOP         1780  'to 1780'
 ...
 L. 656      1780  LOAD_GLOBAL              QtWidgets
             1782  LOAD_ATTR                QMessageBox
             1784  LOAD_METHOD              information
             1786  LOAD_FAST                'self'
             1788  LOAD_ATTR                msgbox

 L. 657      1790  LOAD_STR                 'Extract 1.5D-WDCNN'

 L. 658      1792  LOAD_GLOBAL              str
             1794  LOAD_FAST                '_nfeature'
             1796  CALL_FUNCTION_1       1  '1 positional argument'
             1798  LOAD_STR                 ' WDCNN features extracted successfully'
             1800  BINARY_ADD       
...
if __name__ == '__main__':
    ...
    ExtractMl15DWdcnn = QtWidgets.QWidget()
    gui = extractml15dwdcnn()
    gui.setupGUI(ExtractMl15DWdcnn)
    ExtractMl15DWdcnn.show()
    sys.exit(app.exec_())