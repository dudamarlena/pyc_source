...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\segpy\textual_reel_header.py
# Compiled at: 2020-04-25 14:33:31
# Size of source mod 2**32: 8601 bytes
import os, sys
sys.path.append(os.path.dirname(__file__)[:-6][:-4][:-6])
from gaeio.src.segpy.revisions import SEGY_REVISION_0, SEGY_REVISION_1
