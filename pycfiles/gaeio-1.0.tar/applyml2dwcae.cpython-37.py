...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\applyml2dwcae.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 34546 bytes
...
class applyml2dwcae(object):
    ...
    def setupGUI(self, ApplyMl2DWcae):
        ...
        self.lblnconvblock = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ApplyMl2DWcae)
        ...
        self.lblmasksize = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 350, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 350, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 350, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 390, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 390, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 350, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 350, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 350, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 390, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 390, 40, 30))
        self.lblpara = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 320, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 350, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 350, 40, 30))
        self.lblsave = QtWidgets.QLabel(ApplyMl2DWcae)
        self.lblsave.setObjectName('lblsave')
        self.lblsave.setGeometry(QtCore.QRect(10, 390, 130, 30))
        self.ldtsave = QtWidgets.QLineEdit(ApplyMl2DWcae)
        self.ldtsave.setObjectName('ldtsave')
        self.ldtsave.setGeometry(QtCore.QRect(150, 390, 40, 30))
        self.btnapply = QtWidgets.QPushButton(ApplyMl2DWcae)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 440, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/apply.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ApplyMl2DWcae)
        self.msgbox.setObjectName('msgbox')
        _center_x = ApplyMl2DWcae.geometry().center().x()
        _center_y = ApplyMl2DWcae.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ApplyMl2DWcae)
        QtCore.QMetaObject.connectSlotsByName(ApplyMl2DWcae)

    def retranslateGUI(self, ApplyMl2DWcae):
        self.dialog = ApplyMl2DWcae
        _translate = QtCore.QCoreApplication.translate
        ApplyMl2DWcae.setWindowTitle(_translate('ApplyMl2DWcae', 'Apply 2D-WCAE'))
        self.lblfrom.setText(_translate('ApplyMl2DWcae', 'Select network:'))
        self.ldtfrom.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ApplyMl2DWcae', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ApplyMl2DWcae', 'Training features:'))
        self.lwgfeature.itemSelectionChanged.connect(self.changeLwgFeature)
        self.lblornt.setText(_translate('ApplyMl2DWcae', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ApplyMl2DWcae', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ApplyMl2DWcae', 'height='))
        self.ldtoldheight.setText(_translate('ApplyMl2DWcae', '0'))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ApplyMl2DWcae', 'width='))
        self.ldtoldwidth.setText(_translate('ApplyMl2DWcae', '0'))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtoldwidth.setEnabled(False)
        self.lblnewsize.setText(_translate('ApplyMl2DWcae', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ApplyMl2DWcae', 'height='))
        self.ldtnewheight.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('ApplyMl2DWcae', 'width='))
        self.ldtnewwidth.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('ApplyMl2DWcae', 'Pre-trained WCAE architecture:'))
        self.btnviewnetwork.setText(_translate('ApplyMl2DWcae', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('ApplyMl2DWcae', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ApplyMl2DWcae', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ApplyMl2DWcae', ''))
        ...
        self.lblmasksize.setText(_translate('ApplyMl2DWcae', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ApplyMl2DWcae', 'height='))
        self.ldtmaskheight.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ApplyMl2DWcae', 'width='))
        self.ldtmaskwidth.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ApplyMl2DWcae', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ApplyMl2DWcae', 'height='))
        self.ldtpoolheight.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ApplyMl2DWcae', 'width='))
        self.ldtpoolwidth.setText(_translate('ApplyMl2DWcae', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ApplyMl2DWcae', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ApplyMl2DWcae', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ApplyMl2DWcae', '5'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lblsave.setText(_translate('ApplyMl2DWcae', 'Output name='))
        self.lblsave.setAlignment(QtCore.Qt.AlignRight)
        self.ldtsave.setText(_translate('ApplyMl2DWcae', 'wcae'))
        self.ldtsave.setAlignment(QtCore.Qt.AlignCenter)
        self.btnapply.setText(_translate('ApplyMl2DWcae', 'Apply 2D-WCAE'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnApplyMl2DWcae)
    ...
    def clickBtnFrom(self):
        ...
        _file = _dialog.getOpenFileName(None, 'Select WCAE Network', (self.rootpath), filter='Tensorflow network file (*.meta);; All files (*.*)')
        if len(_file[0]) > 0:
    ...
    def changeLwgFeature(self):
        _shape = [
         0, 0]
        if ml_tfm.checkWCAEModel(self.modelpath, self.modelname):
    ...
    def clickBtnApplyMl2DWcae--- This code section failed: ---
 ...
 L. 459        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ApplyMl2DWcae: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 461        44  LOAD_STR                 'Apply 2D-WCAE'
 ...
 L. 466        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ApplyMl2DWcae: No pre-WCAE network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 468       100  LOAD_STR                 'Apply 2D-WCAE'

 L. 469       102  LOAD_STR                 'No pre-WCAE network found'
 ...
 L. 474       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ApplyMl2DWcae: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
              152  LOAD_STR                 'error'
              154  LOAD_CONST               ('type',)
 ...
 L. 476       170  LOAD_STR                 'Apply 2D-WCAE'
 ...
 L. 482       204  LOAD_GLOBAL              basic_data
 ...
 L. 483       220  LOAD_GLOBAL              basic_data
 ...
 L. 484       236  LOAD_GLOBAL              basic_data
 ...
 L. 485       252  LOAD_GLOBAL              basic_data
 ...
 L. 486       268  LOAD_FAST                '_image_height'
 ...
 L. 487       288  LOAD_FAST                '_image_height_new'
 ...
 L. 488       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ApplyMl2DWcae: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
              318  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              320  POP_TOP          

 L. 489       322  LOAD_GLOBAL              QtWidgets
              324  LOAD_ATTR                QMessageBox
              326  LOAD_METHOD              critical
              328  LOAD_FAST                'self'
              330  LOAD_ATTR                msgbox

 L. 490       332  LOAD_STR                 'Apply 2D-WCAE'

 L. 491       334  LOAD_STR                 'Non-integer feature size'
              336  CALL_METHOD_3         3  '3 positional arguments'
              338  POP_TOP          

 L. 492       340  LOAD_CONST               None
              342  RETURN_VALUE     
            344_0  COME_FROM           304  '304'

 L. 493       344  LOAD_FAST                '_image_height'
              346  LOAD_CONST               2
              348  COMPARE_OP               <
 ...
 L. 494       364  LOAD_FAST                '_image_height_new'
              366  LOAD_CONST               2
              368  COMPARE_OP               <
 ...
 L. 495       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ApplyMl2DWcae: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
              394  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              396  POP_TOP          

 L. 496       398  LOAD_GLOBAL              QtWidgets
              400  LOAD_ATTR                QMessageBox
              402  LOAD_METHOD              critical
              404  LOAD_FAST                'self'
              406  LOAD_ATTR                msgbox

 L. 497       408  LOAD_STR                 'Apply 2D-WCAE'

 L. 498       410  LOAD_STR                 'Features are not 2D'
              412  CALL_METHOD_3         3  '3 positional arguments'
              414  POP_TOP          

 L. 499       416  LOAD_CONST               None
              418  RETURN_VALUE     
            420_0  COME_FROM           380  '380'

 L. 501       420  LOAD_GLOBAL              basic_data
 ...
 L. 503       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ApplyMl2DWcae: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
              466  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              468  POP_TOP          

 L. 504       470  LOAD_GLOBAL              QtWidgets
              472  LOAD_ATTR                QMessageBox
              474  LOAD_METHOD              critical
              476  LOAD_FAST                'self'
              478  LOAD_ATTR                msgbox

 L. 505       480  LOAD_STR                 'Apply 2D-WCAE'

 L. 506       482  LOAD_STR                 'Non-positive batch size'
              484  CALL_METHOD_3         3  '3 positional arguments'
              486  POP_TOP          

 L. 507       488  LOAD_CONST               None
              490  RETURN_VALUE     
            492_0  COME_FROM           452  '452'

 L. 509       492  LOAD_GLOBAL              len
              494  LOAD_FAST                'self'
 ...
 L. 510       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ApplyMl2DWcae: No name specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
              522  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              524  POP_TOP          

 L. 511       526  LOAD_GLOBAL              QtWidgets
              528  LOAD_ATTR                QMessageBox
              530  LOAD_METHOD              critical
              532  LOAD_FAST                'self'
              534  LOAD_ATTR                msgbox

 L. 512       536  LOAD_STR                 'Apply 2D-WCAE'

 L. 513       538  LOAD_STR                 'No name specified'
              540  CALL_METHOD_3         3  '3 positional arguments'
              542  POP_TOP          

 L. 514       544  LOAD_CONST               None
              546  RETURN_VALUE     
            548_0  COME_FROM           508  '508'

 L. 515       548  LOAD_FAST                'self'
 ...
 L. 516       588  LOAD_GLOBAL              QtWidgets
              590  LOAD_ATTR                QMessageBox
              592  LOAD_METHOD              question
              594  LOAD_FAST                'self'
              596  LOAD_ATTR                msgbox
              598  LOAD_STR                 'Apply 2D-WCAE'

 L. 517       600  LOAD_FAST                'self'
 ...
 L. 518       612  LOAD_GLOBAL              QtWidgets
 ...
 L. 528       680  LOAD_FAST                '_seisinfo'
              682  LOAD_STR                 'ILNum'
              684  BINARY_SUBSCR    
              686  STORE_FAST               '_nsample'
            688_0  COME_FROM           676  '676'

 L. 529       688  LOAD_FAST                'self'
 ...
 L. 530       704  LOAD_FAST                '_seisinfo'
              706  LOAD_STR                 'XLNum'
              708  BINARY_SUBSCR    
              710  STORE_FAST               '_nsample'
            712_0  COME_FROM           700  '700'

 L. 531       712  LOAD_FAST                'self'
 ...
 L. 532       728  LOAD_FAST                '_seisinfo'
              730  LOAD_STR                 'ZNum'
              732  BINARY_SUBSCR    
              734  STORE_FAST               '_nsample'
            736_0  COME_FROM           724  '724'

 L. 534       736  LOAD_GLOBAL              int
              738  LOAD_GLOBAL              np
 ...
 L. 550       900  LOAD_CONST               0
              902  STORE_FAST               'idxstart'

 L. 551   904_906  SETUP_LOOP         1520  'to 1520'
 ...
 L. 555       936  LOAD_GLOBAL              sys
              938  LOAD_ATTR                stdout
              940  LOAD_METHOD              write

 L. 556       942  LOAD_STR                 '\r>>> Apply 2D-WCAE, proceeding %.1f%% '
 ...
 L. 563      1028  LOAD_FAST                'idxend'
             1030  STORE_FAST               'idxstart'

 L. 565      1032  BUILD_MAP_0           0 
             1034  STORE_FAST               '_dict'

 L. 566  1036_1038  SETUP_LOOP         1336  'to 1336'
 ...
 L. 567      1050  LOAD_FAST                'self'
             1052  LOAD_ATTR                seisdata
             1054  LOAD_FAST                'f'
             1056  BINARY_SUBSCR    
             1058  STORE_FAST               '_data'

 L. 568      1060  LOAD_GLOBAL              np
 ...
 L. 590      1400  LOAD_GLOBAL              ml_wcae
             1402  LOAD_ATTR                reconstructFromWCAEReconstructor
             1404  LOAD_FAST                '_dict'

 L. 591      1406  LOAD_FAST                '_image_height_new'
             1408  LOAD_FAST                '_image_width_new'

 L. 592      1410  LOAD_FAST                'self'
             1412  LOAD_ATTR                modelpath

 L. 593      1414  LOAD_FAST                'self'
             1416  LOAD_ATTR                modelname

 L. 594      1418  LOAD_FAST                '_batch'
             1420  LOAD_CONST               True
             1422  LOAD_CONST               ('imageheight', 'imagewidth', 'wcaepath', 'wcaename', 'batchsize', 'verbose')
             1424  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
             1426  STORE_FAST               '_rst'

 L. 597      1428  LOAD_FAST                '_image_height_new'
 ...
 L. 598      1448  LOAD_GLOBAL              basic_image
             1450  LOAD_ATTR                changeImageSize
             1452  LOAD_FAST                '_rst'

 L. 599      1454  LOAD_FAST                '_image_height_new'

 L. 600      1456  LOAD_FAST                '_image_width_new'

 L. 601      1458  LOAD_FAST                '_image_height'

 L. 602      1460  LOAD_FAST                '_image_width'
 ...
 L. 612      1528  LOAD_FAST                'self'
             1530  LOAD_ATTR                survinfo
             1532  STORE_FAST               '_info'

 L. 613      1534  LOAD_FAST                '_info'
             1536  LOAD_STR                 'ILNum'
             1538  BINARY_SUBSCR    
             1540  STORE_FAST               '_inlnum'

 L. 614      1542  LOAD_FAST                '_info'
             1544  LOAD_STR                 'XLNum'
             1546  BINARY_SUBSCR    
             1548  STORE_FAST               '_xlnum'

 L. 615      1550  LOAD_FAST                '_info'
             1552  LOAD_STR                 'ZNum'
             1554  BINARY_SUBSCR    
             1556  STORE_FAST               '_znum'

 L. 616      1558  LOAD_FAST                'self'
             1560  LOAD_ATTR                cbbornt
             1562  LOAD_METHOD              currentIndex
             1564  CALL_METHOD_0         0  '0 positional arguments'
             1566  LOAD_CONST               0
             1568  COMPARE_OP               ==
         1570_1572  POP_JUMP_IF_FALSE  1610  'to 1610'

 L. 617      1574  LOAD_GLOBAL              np
             1576  LOAD_METHOD              reshape
             1578  LOAD_FAST                '_result'
             1580  LOAD_CONST               -1
             1582  LOAD_FAST                '_znum'
             1584  LOAD_FAST                '_xlnum'
             1586  BUILD_LIST_3          3 
             1588  CALL_METHOD_2         2  '2 positional arguments'
             1590  STORE_FAST               '_result'

 L. 618      1592  LOAD_GLOBAL              np
             1594  LOAD_METHOD              transpose
             1596  LOAD_FAST                '_result'
             1598  LOAD_CONST               1
             1600  LOAD_CONST               2
             1602  LOAD_CONST               0
             1604  BUILD_LIST_3          3 
             1606  CALL_METHOD_2         2  '2 positional arguments'
             1608  STORE_FAST               '_result'
           1610_0  COME_FROM          1570  '1570'

 L. 619      1610  LOAD_FAST                'self'
             1612  LOAD_ATTR                cbbornt
             1614  LOAD_METHOD              currentIndex
             1616  CALL_METHOD_0         0  '0 positional arguments'
             1618  LOAD_CONST               1
             1620  COMPARE_OP               ==
         1622_1624  POP_JUMP_IF_FALSE  1662  'to 1662'

 L. 620      1626  LOAD_GLOBAL              np
             1628  LOAD_METHOD              reshape
             1630  LOAD_FAST                '_result'
             1632  LOAD_CONST               -1
             1634  LOAD_FAST                '_znum'
             1636  LOAD_FAST                '_inlnum'
             1638  BUILD_LIST_3          3 
             1640  CALL_METHOD_2         2  '2 positional arguments'
             1642  STORE_FAST               '_result'

 L. 621      1644  LOAD_GLOBAL              np
             1646  LOAD_METHOD              transpose
             1648  LOAD_FAST                '_result'
             1650  LOAD_CONST               1
             1652  LOAD_CONST               0
             1654  LOAD_CONST               2
             1656  BUILD_LIST_3          3 
             1658  CALL_METHOD_2         2  '2 positional arguments'
             1660  STORE_FAST               '_result'
           1662_0  COME_FROM          1622  '1622'

 L. 622      1662  LOAD_FAST                'self'
             1664  LOAD_ATTR                cbbornt
             1666  LOAD_METHOD              currentIndex
             1668  CALL_METHOD_0         0  '0 positional arguments'
             1670  LOAD_CONST               2
             1672  COMPARE_OP               ==
         1674_1676  POP_JUMP_IF_FALSE  1696  'to 1696'

 L. 623      1678  LOAD_GLOBAL              np
             1680  LOAD_METHOD              reshape
             1682  LOAD_FAST                '_result'
             1684  LOAD_CONST               -1
             1686  LOAD_FAST                '_xlnum'
             1688  LOAD_FAST                '_inlnum'
             1690  BUILD_LIST_3          3 
             1692  CALL_METHOD_2         2  '2 positional arguments'
             1694  STORE_FAST               '_result'
           1696_0  COME_FROM          1674  '1674'

 L. 625      1696  LOAD_FAST                '_result'
             1698  LOAD_FAST                'self'
             1700  LOAD_ATTR                seisdata
             1702  LOAD_FAST                'self'
             1704  LOAD_ATTR                ldtsave
             1706  LOAD_METHOD              text
             1708  CALL_METHOD_0         0  '0 positional arguments'
             1710  STORE_SUBSCR     

 L. 627      1712  LOAD_GLOBAL              QtWidgets
             1714  LOAD_ATTR                QMessageBox
             1716  LOAD_METHOD              information
             1718  LOAD_FAST                'self'
             1720  LOAD_ATTR                msgbox

 L. 628      1722  LOAD_STR                 'Apply 2D-WCAE'

 L. 629      1724  LOAD_STR                 'WCAE applied successfully'
             1726  CALL_METHOD_3         3  '3 positional arguments'
             1728  POP_TOP          

Parse error at or near `CALL_METHOD_3' instruction at offset 1726
...
if __name__ == '__main__':
    ...
    ApplyMl2DWcae = QtWidgets.QWidget()
    gui = applyml2dwcae()
    gui.setupGUI(ApplyMl2DWcae)
    ApplyMl2DWcae.show()
    sys.exit(app.exec_())