...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\viewml2ddcnn.py
# Compiled at: 2019-12-16 00:14:22
# Size of source mod 2**32: 25433 bytes
...
from cognitivegeo.src.gui.plotml2ddcnnconvmask import plotml2ddcnnconvmask as gui_plotml2ddcnnconvmask
from cognitivegeo.src.vis.messager import messager as vis_msg
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_EnableHighDpiScaling, True)
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_UseHighDpiPixmaps, True)

class viewml2ddcnn(object):
    rootpath = ''
    ...
    def setupGUI(self, ViewMl2DDcnn):
        ...
        self.btnplotlc = QtWidgets.QPushButton(ViewMl2DDcnn)
        ...
        self.btnplotmask = QtWidgets.QPushButton(ViewMl2DDcnn)
        ...
        self.msgbox = QtWidgets.QMessageBox(ViewMl2DDcnn)
        self.msgbox.setObjectName('msgbox')
        _center_x = ViewMl2DDcnn.geometry().center().x()
        _center_y = ViewMl2DDcnn.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ViewMl2DDcnn)
        QtCore.QMetaObject.connectSlotsByName(ViewMl2DDcnn)

    def retranslateGUI(self, ViewMl2DDcnn):
        self.dialog = ViewMl2DDcnn
        _translate = QtCore.QCoreApplication.translate
        ViewMl2DDcnn.setWindowTitle(_translate('ViewMl2DDcnn', 'View 2D-DCNN'))
        self.lblfrom.setText(_translate('ViewMl2DDcnn', 'Select network:'))
        self.ldtfrom.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ViewMl2DDcnn', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ViewMl2DDcnn', 'Training features:'))
        self.lblpatchsize.setText(_translate('ViewMl2DDcnn', 'Image size:'))
        self.lblpatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpatchheight.setText(_translate('ViewMl2DDcnn', 'height='))
        self.ldtpatchheight.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtpatchheight.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtpatchheight.setEnabled(False)
        self.lblpatchwidth.setText(_translate('ViewMl2DDcnn', 'width='))
        self.ldtpatchwidth.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtpatchwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtpatchwidth.setEnabled(False)
        self.lbltarget.setText(_translate('ViewMl2DDcnn', 'Training target:'))
        self.lblnetwork.setText(_translate('ViewMl2DDcnn', 'Pre-trained DCNN architecture:'))
        self.lblnconvblock.setText(_translate('ViewMl2DDcnn', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ViewMl2DDcnn', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ViewMl2DDcnn', ''))
        ...
        self.lblmasksize.setText(_translate('ViewMl2DDcnn', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ViewMl2DDcnn', 'height='))
        self.ldtmaskheight.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ViewMl2DDcnn', 'width='))
        self.ldtmaskwidth.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ViewMl2DDcnn', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ViewMl2DDcnn', 'height='))
        self.ldtpoolheight.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ViewMl2DDcnn', 'width='))
        self.ldtpoolwidth.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ViewMl2DDcnn', 'Pre-training parameters:'))
        self.lblnepoch.setText(_translate('ViewMl2DDcnn', 'No. of epochs:'))
        self.lblnepoch.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnepoch.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtnepoch.setEnabled(False)
        self.ldtnepoch.setAlignment(QtCore.Qt.AlignCenter)
        self.lblbatchsize.setText(_translate('ViewMl2DDcnn', 'Batch size:'))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtbatchsize.setEnabled(False)
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lbllearnrate.setText(_translate('ViewMl2DDcnn', 'Learning rate:'))
        self.lbllearnrate.setAlignment(QtCore.Qt.AlignRight)
        self.ldtlearnrate.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtlearnrate.setEnabled(False)
        self.ldtlearnrate.setAlignment(QtCore.Qt.AlignCenter)
        self.lbldropout.setText(_translate('ViewMl2DDcnn', 'Dropout rate:'))
        self.lbldropout.setAlignment(QtCore.Qt.AlignRight)
        self.ldtdropout.setText(_translate('ViewMl2DDcnn', ''))
        self.ldtdropout.setEnabled(False)
        self.ldtdropout.setAlignment(QtCore.Qt.AlignCenter)
        self.btnviewlc.setText(_translate('ViewMl2DDcnn', 'View Learning Matrix'))
        self.btnviewlc.clicked.connect(self.clickBtnViewLc)
        self.btnplotlc.setText(_translate('ViewMl2DDcnn', 'Plot Learning Curve'))
        self.btnplotlc.setDefault(True)
        self.btnplotlc.clicked.connect(self.clickBtnPlotLc)
        self.btnplotmask.setText(_translate('ViewMl2DDcnn', 'Plot Conv. Masks'))
    ...
    def clickBtnFrom(self):
        ...
        _file = _dialog.getOpenFileName(None, 'Select DCNN Network', (self.rootpath), filter='Tensorflow network files (*.meta);; All files (*.*)')
        if len(_file[0]) > 0:
    ...
    def clickBtnViewLc(self):
        ...
        if ml_tfm.checkDCNNModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in ViewMl2DDcnn: No DCNN network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'View 2D-DCNN', 'No DCNN network found')
            return
...
if __name__ == '__main__':
    ...
    ViewMl2DDcnn = QtWidgets.QWidget()
    gui = viewml2ddcnn()
    gui.setupGUI(ViewMl2DDcnn)
    ViewMl2DDcnn.show()
    sys.exit(app.exec_())