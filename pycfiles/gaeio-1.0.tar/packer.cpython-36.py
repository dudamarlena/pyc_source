...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\segpy\packer.py
...
from gaeio.src.segpy.datatypes import SEG_Y_TYPE_TO_CTYPE
from gaeio.src.segpy.util import pairwise, intervals_partially_overlap, complementary_intervals
...
class HeaderPacker:
    __doc__ = 'Packing and unpacking header instances.'
