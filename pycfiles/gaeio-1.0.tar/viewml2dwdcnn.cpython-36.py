...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\viewml2dwdcnn.py
# Compiled at: 2019-12-16 00:14:22
# Size of source mod 2**32: 26161 bytes
...
from cognitivegeo.src.gui.plotml2dwdcnnconvmask import plotml2dwdcnnconvmask as gui_plotml2dwdcnnconvmask
from cognitivegeo.src.vis.messager import messager as vis_msg
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_EnableHighDpiScaling, True)
QtWidgets.QApplication.setAttribute(QtCore.Qt.AA_UseHighDpiPixmaps, True)

class viewml2dwdcnn(object):
    rootpath = ''
    ...
    def setupGUI(self, ViewMl2DWdcnn):
        ...
        self.btnplotlc = QtWidgets.QPushButton(ViewMl2DWdcnn)
        ...
        self.btnplotmask = QtWidgets.QPushButton(ViewMl2DWdcnn)
        ...
        self.msgbox = QtWidgets.QMessageBox(ViewMl2DWdcnn)
        self.msgbox.setObjectName('msgbox')
        _center_x = ViewMl2DWdcnn.geometry().center().x()
        _center_y = ViewMl2DWdcnn.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ViewMl2DWdcnn)
        QtCore.QMetaObject.connectSlotsByName(ViewMl2DWdcnn)

    def retranslateGUI(self, ViewMl2DWdcnn):
        self.dialog = ViewMl2DWdcnn
        _translate = QtCore.QCoreApplication.translate
        ViewMl2DWdcnn.setWindowTitle(_translate('ViewMl2DWdcnn', 'View 2D-WDCNN'))
        self.lblfrom.setText(_translate('ViewMl2DWdcnn', 'Select network:'))
        self.ldtfrom.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ViewMl2DWdcnn', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ViewMl2DWdcnn', 'Training features:'))
        self.lblpatchsize.setText(_translate('ViewMl2DWdcnn', 'Image size:'))
        self.lblpatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpatchheight.setText(_translate('ViewMl2DWdcnn', 'height='))
        self.ldtpatchheight.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtpatchheight.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtpatchheight.setEnabled(False)
        self.lblpatchwidth.setText(_translate('ViewMl2DWdcnn', 'width='))
        self.ldtpatchwidth.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtpatchwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtpatchwidth.setEnabled(False)
        self.lbltarget.setText(_translate('ViewMl2DWdcnn', 'Training target:'))
        self.lblweight.setText(_translate('ViewMl2DWdcnn', 'Training weight:'))
        self.lblnetwork.setText(_translate('ViewMl2DWdcnn', 'Pre-trained WDCNN architecture:'))
        self.lblnconvblock.setText(_translate('ViewMl2DWdcnn', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ViewMl2DWdcnn', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ViewMl2DWdcnn', ''))
        ...
        self.lblmasksize.setText(_translate('ViewMl2DWdcnn', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ViewMl2DWdcnn', 'height='))
        self.ldtmaskheight.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ViewMl2DWdcnn', 'width='))
        self.ldtmaskwidth.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ViewMl2DWdcnn', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ViewMl2DWdcnn', 'height='))
        self.ldtpoolheight.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ViewMl2DWdcnn', 'width='))
        self.ldtpoolwidth.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ViewMl2DWdcnn', 'Pre-training parameters:'))
        self.lblnepoch.setText(_translate('ViewMl2DWdcnn', 'No. of epochs:'))
        self.lblnepoch.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnepoch.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtnepoch.setEnabled(False)
        self.ldtnepoch.setAlignment(QtCore.Qt.AlignCenter)
        self.lblbatchsize.setText(_translate('ViewMl2DWdcnn', 'Batch size:'))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtbatchsize.setEnabled(False)
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lbllearnrate.setText(_translate('ViewMl2DWdcnn', 'Learning rate:'))
        self.lbllearnrate.setAlignment(QtCore.Qt.AlignRight)
        self.ldtlearnrate.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtlearnrate.setEnabled(False)
        self.ldtlearnrate.setAlignment(QtCore.Qt.AlignCenter)
        self.lbldropout.setText(_translate('ViewMl2DWdcnn', 'Dropout rate:'))
        self.lbldropout.setAlignment(QtCore.Qt.AlignRight)
        self.ldtdropout.setText(_translate('ViewMl2DWdcnn', ''))
        self.ldtdropout.setEnabled(False)
        self.ldtdropout.setAlignment(QtCore.Qt.AlignCenter)
        self.btnviewlc.setText(_translate('ViewMl2DWdcnn', 'View Learning Matrix'))
        self.btnviewlc.clicked.connect(self.clickBtnViewLc)
        self.btnplotlc.setText(_translate('ViewMl2DWdcnn', 'Plot Learning Curve'))
        self.btnplotlc.setDefault(True)
        self.btnplotlc.clicked.connect(self.clickBtnPlotLc)
        self.btnplotmask.setText(_translate('ViewMl2DWdcnn', 'Plot Conv. Masks'))
    ...
    def clickBtnViewLc(self):
        ...
        if ml_tfm.checkWDCNNModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in ViewMl2DWdcnn: No WDCNN network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'View 2D-WDCNN', 'No WDCNN network found')
            return
    ...
    def clickBtnPlotMask(self):
        ...
        if ml_tfm.checkWDCNNModel(self.modelpath, self.modelname) is False:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, 'View 2D-WDCNN', 'No WDCNN network found')
            return
        _plotmldcnnconvmask = QtWidgets.QDialog()
        _gui = gui_plotml2dwdcnnconvmask()
        _gui.modelpath = self.modelpath
        _gui.modelname = self.modelname
        _gui.maskstyle = self.maskstyle
        _gui.setupGUI(_plotmldcnnconvmask)
        _plotmldcnnconvmask.exec()
        _plotmldcnnconvmask.show()
...
if __name__ == '__main__':
    ...
    ViewMl2DWdcnn = QtWidgets.QWidget()
    gui = viewml2dwdcnn()
    gui.setupGUI(ViewMl2DWdcnn)
    ViewMl2DWdcnn.show()
    sys.exit(app.exec_())