...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\gui\manageseis.py
...
class manageseis(object):
    ...
    def clickBtnEdit(self):
        ...
        for key in _gui.dataproperty.keys():
            if key != 'Inline' and key != 'Crossline' and key != 'Z' and np.shape(_gui.dataproperty[key])[0] == self.survinfo['ILNum'] * self.survinfo['XLNum'] * self.survinfo['ZNum']:
