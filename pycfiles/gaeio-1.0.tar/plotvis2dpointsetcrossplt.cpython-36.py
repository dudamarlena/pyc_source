...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\gui\plotvis2dpointsetcrossplt.py
# Compiled at: 2020-04-25 15:07:54
# Size of source mod 2**32: 16922 bytes
...
class plotvis2dpointsetcrossplt(object):
    ...
    def clickBtnPlot(self):
        ...
        if _npoint < 1:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '2D Window: PointSet Cross-plot', 'No pointset selected')
            return
        ...
        if _xmin is False or _xmax is False or _ymin is False or _ymax is False:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '2D Window: PointSet Cross-plot', 'on-float range specified for plot')
            return
        _legendon = False
        ...
        for _item in self.twgpoint.selectedItems():
            ...
            if _xfeature not in self.pointsetdata[_name].keys():
                ...
                QtWidgets.QMessageBox.critical(self.msgbox, '2-D Cross-plot', 'X-feature not found in ' + _name)
                return
            if _yfeature not in self.pointsetdata[_name].keys():
                ...
                QtWidgets.QMessageBox.critical(self.msgbox, '2-D Cross-plot', 'Y-feature not found in ' + _name)
                return
            _data = {}
        ...
        point_vis.crossplot2D(_pointdict, colorlist=_colorlist,
