...
class trainml2dcaefromscratch(object):
    ...
    def clickBtnTrainMl2DCaeFromScratch(self):
        self.refreshMsgBox()
        if len(self.lwgfeature.selectedItems()) < 1:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: No feature selected for training', type='error')
        ...
        if _image_height is False or _image_width is False or _image_height_new is False or _image_width_new is False:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-integer feature size', type='error')
        ...
        if _image_height < 2 or _image_width < 2 or _image_height_new < 2 or _image_width_new < 2:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Features are not 2D', type='error')
        ...
        if _nconvblock is False or _nconvblock <= 0:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive convolutional block number', type='error')
        ...
        for _i in _nconvlayer:
            if _i is False or _i < 1:
                vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive convolutional layer number', type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-CAE', 'Non-positive convolutional layer number')
                return

        for _i in _nconvfeature:
            if _i is False or _i < 1:
                vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive convolutional feature number', type='error')
        ...
        if _n1x1layer is False or _n1x1layer <= 0:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive 1x1 convolutional layer number', type='error')
        ...
        for _i in _n1x1feature:
            if _i is False or _i < 1:
                vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive 1x1 convolutional feature number', type='error')
        ...
        if _patch_height is False or _patch_width is False or _patch_height < 1 or _patch_width < 1:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive convolutional patch size', type='error')
        ...
        if _pool_height is False or _pool_width is False or _pool_height < 1 or _pool_width < 1:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive pooling size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-CAE', 'Non-positive pooling size')
            return
        if _nepoch is False or _nepoch <= 0:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive epoch number', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-CAE', 'Non-positive epoch number')
            return
        if _batchsize is False or _batchsize <= 0:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive batch size', type='error')
        ...
        if _learning_rate is False or _learning_rate <= 0:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Non-positive learning rate', type='error')
        ...
        if _dropout_prob is False or _dropout_prob <= 0:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: Negative dropout rate', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-CAE', 'Negative dropout rate')
            return
        if len(self.ldtsave.text()) < 1:
            vis_msg.print('ERROR in TrainMl2DCaeFromScratch: No name specified for CAE network', type='error')
        ...
        print('TrainMl2DCaeFromScratch: Step 1 - Get training samples:')
        ...
        if np.shape(_traindata)[0] <= 0:
            ...
            return
        print('TrainMl2DCaeFromScratch: Step 2 - Retrieve and interpolate images if necessary: (%d, %d) --> (%d, %d)' % (
        ...
        if self.traindataconfig['RemoveInvariantFeature_Checked']:
            for f in _features:
                ...
                if basic_mdt.maxDictConstantRow(_traindict) <= 0:
                    vis_msg.print('ERROR in TrainMl2DCaeFromScratch: No training sample found', type='error')
        ...
        print('TrainMl2DCaeFromScratch: A total of %d valid training samples' % basic_mdt.maxDictConstantRow(_traindict))
        print('TrainMl2DCaeFromScratch: Step 3 - Start training')
        ...
        _caelog = ml_cae.createCAEReconstructor(_traindict, imageheight=_image_height_new,
