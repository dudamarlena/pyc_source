...
class applyml2ddcnn4prob(object):
    ...
    def clickBtnApplyMl2DDcnn4Prob--- This code section failed: ---
 ...
 L. 472        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 474        44  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 479        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: No pre-DCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 481       100  LOAD_STR                 'Apply 2D-DCNN'

 L. 482       102  LOAD_STR                 'No pre-DCNN network found'
 ...
 L. 487       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ApplyMl2DDcnn4Prob: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 490       170  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 501       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
 ...
 L. 503       332  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 508       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
 ...
 L. 510       408  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 516       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
 ...
 L. 518       480  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 523       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: No prefix specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
 ...
 L. 525       536  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 530       568  LOAD_GLOBAL              vis_msg
              570  LOAD_ATTR                print
              572  LOAD_STR                 'ERROR in ApplyMl2DDcnn4Prob: No target class specified'
              574  LOAD_STR                 'error'
              576  LOAD_CONST               ('type',)
 ...
 L. 532       592  LOAD_STR                 'Apply 2D-DCNN'
 ...
 L. 535       604  LOAD_LISTCOMP            '<code_object <listcomp>>'
              606  LOAD_STR                 'applyml2ddcnn4prob.clickBtnApplyMl2DDcnn4Prob.<locals>.<listcomp>'
 ...
 L. 580      1072  LOAD_STR                 '\r>>> Apply 2D-DCNN, proceeding %.1f%% '
 ...
 L. 614      1530  LOAD_GLOBAL              ml_dcnn
             1532  LOAD_ATTR                probabilityFromDCNNSegmentor
 ...
 L. 619      1550  LOAD_FAST                '_batch'
             ...
             1554  LOAD_CONST               ('imageheight', 'imagewidth', 'dcnnpath', 'dcnnname', 'targetlist', 'batchsize', 'verbose')
             1556  CALL_FUNCTION_KW_8     8  '8 total positional and keyword args'
             1558  STORE_FAST               '_rst'

 L. 621      1560  LOAD_FAST                '_image_height_new'
 ...
 L. 623      1618  LOAD_GLOBAL              basic_image
             1620  LOAD_ATTR                changeImageSize
             1622  LOAD_FAST                '_rst'

 L. 624      1624  LOAD_FAST                '_image_height_new'

 L. 625      1626  LOAD_FAST                '_image_width_new'

 L. 626      1628  LOAD_FAST                '_image_height'

 L. 627      1630  LOAD_FAST                '_image_width'
 ...
 L. 634      1704  LOAD_GLOBAL              print
             1706  LOAD_STR                 'Done'
             1708  CALL_FUNCTION_1       1  '1 positional argument'
             1710  POP_TOP          

 L. 636      1712  LOAD_FAST                'self'
             1714  LOAD_ATTR                survinfo
             1716  STORE_FAST               '_info'

 L. 637      1718  LOAD_FAST                '_info'
             1720  LOAD_STR                 'ILNum'
             1722  BINARY_SUBSCR    
             1724  STORE_FAST               '_inlnum'

 L. 638      1726  LOAD_FAST                '_info'
             1728  LOAD_STR                 'XLNum'
             1730  BINARY_SUBSCR    
             1732  STORE_FAST               '_xlnum'

 L. 639      1734  LOAD_FAST                '_info'
             1736  LOAD_STR                 'ZNum'
             1738  BINARY_SUBSCR    
             1740  STORE_FAST               '_znum'

 L. 640      1742  SETUP_LOOP         1986  'to 1986'
 ...
 L. 652      1986  LOAD_GLOBAL              QtWidgets
             1988  LOAD_ATTR                QMessageBox
             1990  LOAD_METHOD              information
             1992  LOAD_FAST                'self'
             1994  LOAD_ATTR                msgbox

 L. 653      1996  LOAD_STR                 'Apply 2D-DCNN'

 L. 654      1998  LOAD_STR                 'DCNN applied successfully'
