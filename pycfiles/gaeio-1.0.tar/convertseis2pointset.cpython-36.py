...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\gui\convertseis2pointset.py
# Compiled at: 2020-04-25 14:58:02
# Size of source mod 2**32: 22782 bytes
...
class convertseis2pointset(object):
    ...
    def clickBtnApply(self):
        ...
        if self.rdbsrvpart.isChecked():
            ...
            _pts = seis_ays.retrieveSeisILSliceFrom3DMat((np.zeros([self.survinfo['ZNum'], self.survinfo['XLNum'],
             self.survinfo['ILNum']])),
              inlsls=_inl,
              verbose=False,
