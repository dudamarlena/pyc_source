...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\segpy\toolkit.py
...
import cognitivegeo.src.segpy.textual_reel_header
from cognitivegeo.src.segpy.binary_reel_header import BinaryReelHeader
from cognitivegeo.src.segpy.catalog import CatalogBuilder
from cognitivegeo.src.segpy.datatypes import SEG_Y_TYPE_TO_CTYPE, size_in_bytes, DATA_SAMPLE_FORMAT_TO_SEG_Y_TYPE, CTYPE_TO_SIZE
from cognitivegeo.src.segpy.encoding import guess_encoding, is_supported_encoding, UnsupportedEncodingError
from cognitivegeo.src.segpy.ibm_float import IBMFloat
from cognitivegeo.src.segpy.packer import HeaderPacker
from cognitivegeo.src.segpy.revisions import canonicalize_revision
from cognitivegeo.src.segpy.trace_header import TraceHeaderRev1
from cognitivegeo.src.segpy.util import file_length, batched, pad, complementary_intervals, NATIVE_ENDIANNESS, EMPTY_BYTE_STRING
HEADER_NEWLINE = '\r\n'
CARD_LENGTH = 80
CARDS_PER_HEADER = 40
