...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\segpy\writer.py
# Compiled at: 2020-04-25 14:33:32
# Size of source mod 2**32: 2802 bytes
import os, sys
sys.path.append(os.path.dirname(__file__)[:-6][:-4][:-6])
from gaeio.src.segpy.encoding import ASCII, is_supported_encoding, UnsupportedEncodingError
from gaeio.src.segpy.packer import HeaderPacker
from gaeio.src.segpy.trace_header import TraceHeaderRev1
from gaeio.src.segpy.toolkit import write_textual_reel_header, write_binary_reel_header, write_trace_header, write_trace_samples, write_extended_textual_headers
