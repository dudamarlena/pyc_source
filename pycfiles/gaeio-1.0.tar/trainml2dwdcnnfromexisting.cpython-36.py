...
class trainml2dwdcnnfromexisting(object):
    ...
    def clickBtnTrainMl2DWdcnnFromExisting(self):
        self.refreshMsgBox()
        if len(self.lwgfeature.selectedItems()) < 1:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: No feature selected for training', type='error')
        ...
        if _image_height is False or _image_width is False or _image_height_new is False or _image_width_new is False:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-integer feature size', type='error')
        ...
        if _image_height < 2 or _image_width < 2 or _image_height_new < 2 or _image_width_new < 2:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Features are not 2D', type='error')
        ...
        if _target in _features:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Target also used as features', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'Target also used as features')
            return
        if _weight in _features:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Weight also used as features', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'Weight also used as features')
            return
        if len(self.ldtexisting.text()) < 1:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: No name specified for pre-trained network', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'No name specified for pre-trained network')
            return
        ...
        if ml_tfm.getConvModelNChannel(_precnnpath, _precnnname) != len(_features):
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Feature channel number not match with pre-trained network', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'Feature channel number not match with pre-trained network')
            return
        ...
        if _nconvblock is False or _nconvblock <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive convolutional block number', type='error')
        ...
        for _i in _nconvlayer:
            if _i is False or _i < 1:
                vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive convolutional layer number', type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'Non-positive convolutional layer number')
                return

        for _i in _nconvfeature:
            if _i is False or _i < 1:
                vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive convolutional feature number', type='error')
        ...
        if _n1x1layer is False or _n1x1layer <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive 1x1 convolutional layer number', type='error')
        ...
        for _i in _n1x1feature:
            if _i is False or _i < 1:
                vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive 1x1 convolutional feature number', type='error')
        ...
        if _pool_height is False or _pool_width is False or _pool_height < 1 or _pool_width < 1:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive pooling size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'Non-positive pooling size')
            return
        if _nepoch is False or _nepoch <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive epoch number', type='error')
        ...
        if _batchsize is False or _batchsize <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive batch size', type='error')
        ...
        if _learning_rate is False or _learning_rate <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Non-positive learning rate', type='error')
        ...
        if _dropout_prob is False or _dropout_prob <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: Negative dropout rate', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'Negative dropout rate')
            return
        if len(self.ldtsave.text()) < 1:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: No name specified for new-WDCNN', type='error')
        ...
        print('TrainMl2DWdcnnFromExisting: Step 1 - Step 1 - Get training samples:')
        ...
        if np.shape(_traindata)[0] <= 0:
            vis_msg.print('ERROR in TrainMl2DWdcnnFromExisting: No training sample found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Train 2D-WDCNN', 'No training sample found')
            return
        print('TrainMl2DWdcnnFromExisting: Step 2 - Retrieve and interpolate images if necessary: (%d, %d) --> (%d, %d)' % (
        ...
        print('TrainMl2DWdcnnFromExisting: A total of %d valid training samples' % basic_mdt.maxDictConstantRow(_traindict))
        print('TrainMl2DWdcnnFromExisting: Step 3 - Start training')
        ...
        _dcnnlog = ml_wdcnn.createWDCNNSegmentorFromExisting(_traindict, imageheight=_image_height_new,
