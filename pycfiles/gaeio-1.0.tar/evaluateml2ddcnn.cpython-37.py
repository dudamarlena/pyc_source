...
class evaluateml2ddcnn(object):
    ...
    def clickBtnEvaluateMl2DDcnn--- This code section failed: ---
 ...
 L. 459        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in EvaluateMl2DDcnn: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 461        44  LOAD_STR                 'Evaluate 2D-DCNN'
 ...
 L. 466        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in EvaluateMl2DDcnn: No pre-DCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 468       100  LOAD_STR                 'Evaluate 2D-DCNN'

 L. 469       102  LOAD_STR                 'No pre-DCNN network found'
 ...
 L. 474       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in EvaluateMl2DDcnn: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 477       170  LOAD_STR                 'Evaluate 2D-DCNN'
 ...
 L. 481       216  LOAD_GLOBAL              vis_msg
              218  LOAD_ATTR                print
              220  LOAD_STR                 "ERROR in EvaluateMl2DDcnn: Target label '%s' not found in seismic data"
 ...
 L. 484       250  LOAD_STR                 'Evaluate 2D-DCNN'

 L. 485       252  LOAD_STR                 "Target label '"
              254  LOAD_FAST                'self'
 ...
 L. 498       410  LOAD_GLOBAL              vis_msg
              412  LOAD_ATTR                print
              414  LOAD_STR                 'ERROR in EvaluateMl2DDcnn: Non-integer feature size'
              416  LOAD_STR                 'error'
              418  LOAD_CONST               ('type',)
 ...
 L. 500       434  LOAD_STR                 'Evaluate 2D-DCNN'
 ...
 L. 505       486  LOAD_GLOBAL              vis_msg
              488  LOAD_ATTR                print
              490  LOAD_STR                 'ERROR in EvaluateMl2DDcnn: Features are not 2D'
              492  LOAD_STR                 'error'
              494  LOAD_CONST               ('type',)
 ...
 L. 507       510  LOAD_STR                 'Evaluate 2D-DCNN'
 ...
 L. 513       558  LOAD_GLOBAL              vis_msg
              560  LOAD_ATTR                print
              562  LOAD_STR                 'ERROR in EvaluateMl2DDcnn: Non-positive batch size'
              564  LOAD_STR                 'error'
              566  LOAD_CONST               ('type',)
 ...
 L. 515       582  LOAD_STR                 'Evaluate 2D-DCNN'
 ...
 L. 551       886  LOAD_STR                 '\r>>> Evaluate 2D-DCNN, proceeding %.1f%% '
 ...
 L. 609      1696  LOAD_GLOBAL              ml_dcnn
             1698  LOAD_ATTR                evaluateDCNNSegmentor
 ...
 L. 613      1714  LOAD_FAST                '_batch'
             ...
             1718  LOAD_CONST               ('imageheight', 'imagewidth', 'dcnnpath', 'dcnnname', 'batchsize', 'verbose')
             1720  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
             1722  STORE_FAST               '_confmatrix'

 L. 614      1724  LOAD_FAST                '_result'
 ...
 L. 618      1756  LOAD_GLOBAL              print
             1758  LOAD_STR                 'Done'
             1760  CALL_FUNCTION_1       1  '1 positional argument'
             1762  POP_TOP          

 L. 620      1764  LOAD_FAST                '_result'
             1766  LOAD_CONST               0
             1768  LOAD_CONST               1
