...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\makepytemp.py
...
PyTemp = [
 '#############################################################################################\n',
 '#                                                                                           #\n',
 '# Template for CognativeGeo python compiler                                                 #\n',
 '#                                                                                           #\n',
 '# Note:                                                                                     #\n',
 ...
 "__all__ = ['mainfunc']\n",
 '\n\n',
 'def mainfunc(survinfo=None, seisdata=None, pointsetdata=None):\n',
 '    #\n',
 ...
 "    print('Check point ...')\n",
 '    checkPointData(pointsetdata)\n',
 "    print('Call subfunc 1:')\n",
 '    subfunc1()\n',
 '    #\n',
 '    return survinfo, seisdata, pointsetdata\n',
 '\n\n',
 ...
 '    if pointsetdata is None:\n',
 "        print('No point found')\n",
 '    else:\n',
 '        print(pointsetdata.keys())']
...
class makepytemp(object):
    ...
    def clickBtnFile(self):
        ...
        _file = _dialog.getSaveFileName(None, 'Select Python Code', (self.rootpath), filter='Python file (*.py);; All files (*.*)')
        if len(_file[0]) > 0:
            self.ldtfile.setText(_file[0])

    def clickBtnMakePyTemp(self):
        self.refreshMsgBox()
        if os.path.exists(self.ldtfile.text()):
            if os.path.isfile(self.ldtfile.text()) is False:
                vis_msg.print('ERROR in MakePyTemp: Directory is selected', type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Create Template', 'Directory is selected')
                return
        ...
        _file.close()
        QtWidgets.QMessageBox.information(self.msgbox, 'Create Template', 'Template made successfully')
