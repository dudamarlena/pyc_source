...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\plotvis2dseisz.py
# Compiled at: 2020-03-18 15:05:47
# Size of source mod 2**32: 15069 bytes
...
class plotvis2dseisz(object):
    ...
    def clickBtnPlotSlice(self):
        ...
        if len(_attriblist) < 1:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '2D Window: Seismic Time/depth', 'No property selected for plot')
            return
        ...
        if _min is False or _max is False:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '2D Window: Seismic Time/depth', 'Non-float range specified for plot')
            return
        for i in range(len(_attriblist)):
            ...
            seis_vis.plotSeisZSlicePlayerFrom3DMat(_data, initzsl=_sls, seisinfo=(self.survinfo), titlesurf=(': ' + _attriblist[i].text()),
              valuemin=_min,
              valuemax=_max,
