...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\evaluateml2ddcnn.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 35236 bytes
...
class evaluateml2ddcnn(object):
    ...
    def setupGUI(self, EvaluateMl2DDcnn):
        EvaluateMl2DDcnn.setObjectName('EvaluateMl2DDcnn')
        EvaluateMl2DDcnn.setFixedSize(810, 500)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/check.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        EvaluateMl2DDcnn.setWindowIcon(icon)
        self.lblfrom = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblfrom.setObjectName('lblfrom')
        self.lblfrom.setGeometry(QtCore.QRect(10, 10, 100, 30))
        self.ldtfrom = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtfrom.setObjectName('ldtfrom')
        self.ldtfrom.setGeometry(QtCore.QRect(110, 10, 210, 30))
        self.btnfrom = QtWidgets.QPushButton(EvaluateMl2DDcnn)
        self.btnfrom.setObjectName('btnfrom')
        self.btnfrom.setGeometry(QtCore.QRect(330, 10, 60, 30))
        self.lblfeature = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblfeature.setObjectName('lblfeature')
        self.lblfeature.setGeometry(QtCore.QRect(10, 60, 100, 30))
        self.lwgfeature = QtWidgets.QListWidget(EvaluateMl2DDcnn)
        ...
        self.lblnconvblock = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(EvaluateMl2DDcnn)
        ...
        self.lblmasksize = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 360, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 360, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 360, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 400, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 400, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 360, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 360, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 360, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 400, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 400, 40, 30))
        self.lblpara = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 370, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(EvaluateMl2DDcnn)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 400, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(EvaluateMl2DDcnn)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 400, 40, 30))
        self.btnapply = QtWidgets.QPushButton(EvaluateMl2DDcnn)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 450, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/check.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(EvaluateMl2DDcnn)
        self.msgbox.setObjectName('msgbox')
        _center_x = EvaluateMl2DDcnn.geometry().center().x()
        _center_y = EvaluateMl2DDcnn.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(EvaluateMl2DDcnn)
        QtCore.QMetaObject.connectSlotsByName(EvaluateMl2DDcnn)

    def retranslateGUI(self, EvaluateMl2DDcnn):
        self.dialog = EvaluateMl2DDcnn
        _translate = QtCore.QCoreApplication.translate
        EvaluateMl2DDcnn.setWindowTitle(_translate('EvaluateMl2DDcnn', 'Evaluate 2D-DCNN'))
        self.lblfrom.setText(_translate('EvaluateMl2DDcnn', 'Select network:'))
        self.ldtfrom.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('EvaluateMl2DDcnn', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('EvaluateMl2DDcnn', 'Training features:'))
        self.lblornt.setText(_translate('EvaluateMl2DDcnn', 'Orientation:'))
        ...
        self.lbltarget.setText(_translate('EvaluateMl2DDcnn', 'Training target:'))
        self.lbloldsize.setText(_translate('EvaluateMl2DDcnn', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('EvaluateMl2DDcnn', 'height='))
        self.ldtoldheight.setText(_translate('EvaluateMl2DDcnn', '0'))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('EvaluateMl2DDcnn', 'width='))
        self.ldtoldwidth.setText(_translate('EvaluateMl2DDcnn', '0'))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtoldwidth.setEnabled(False)
        self.lblnewsize.setText(_translate('EvaluateMl2DDcnn', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('EvaluateMl2DDcnn', 'height='))
        self.ldtnewheight.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('EvaluateMl2DDcnn', 'width='))
        self.ldtnewwidth.setText(_translate('EvaluateMl2DDcnn', ''))
        ...
        self.lblnetwork.setText(_translate('EvaluateMl2DDcnn', 'Pre-trained DCNN architecture:'))
        self.btnviewnetwork.setText(_translate('EvaluateMl2DDcnn', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('EvaluateMl2DDcnn', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('EvaluateMl2DDcnn', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('EvaluateMl2DDcnn', ''))
        ...
        self.lblmasksize.setText(_translate('EvaluateMl2DDcnn', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('EvaluateMl2DDcnn', 'height='))
        self.ldtmaskheight.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('EvaluateMl2DDcnn', 'width='))
        self.ldtmaskwidth.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('EvaluateMl2DDcnn', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('EvaluateMl2DDcnn', 'height='))
        self.ldtpoolheight.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('EvaluateMl2DDcnn', 'width='))
        self.ldtpoolwidth.setText(_translate('EvaluateMl2DDcnn', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('EvaluateMl2DDcnn', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('EvaluateMl2DDcnn', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('EvaluateMl2DDcnn', '5'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.btnapply.setText(_translate('EvaluateMl2DDcnn', 'Evaluate 2D-DCNN'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnEvaluateMl2DDcnn)
    ...
    def clickBtnEvaluateMl2DDcnn(self):
        self.refreshMsgBox()
        if self.checkSurvInfo() is False:
            vis_msg.print('ERROR in EvaluateMl2DDcnn: No seismic survey available', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', 'No seismic survey available')
            return
        if ml_tfm.checkDCNNModel(self.modelpath, self.modelname) is False:
            vis_msg.print('ERROR in EvaluateMl2DDcnn: No pre-DCNN network found', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', 'No pre-DCNN network found')
            return
        for f in self.modelinfo['feature_list']:
            if self.checkSeisData(f) is False:
                vis_msg.print(("ERROR in EvaluateMl2DDcnn: Feature '%s' not found in seismic data" % f), type='error')
                QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', "Feature '" + f + "' not found in seismic data")
                return

        if self.modelinfo['target'] not in self.seisdata.keys():
            vis_msg.print(("ERROR in EvaluateMl2DDcnn: Target label '%s' not found in seismic data" % self.modelinfo['target']),
              type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', "Target label '" + self.modelinfo['target'] + ' not found in seismic data')
            return
        ...
        if _image_height is False or _image_width is False or _image_height_new is False or _image_width_new is False:
            vis_msg.print('ERROR in EvaluateMl2DDcnn: Non-integer feature size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', 'Non-integer feature size')
            return
        if _image_height < 2 or _image_width < 2 or _image_height_new < 2 or _image_width_new < 2:
            vis_msg.print('ERROR in EvaluateMl2DDcnn: Features are not 2D', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', 'Features are not 2D')
            return
        _batch = basic_data.str2int(self.ldtbatchsize.text())
        if _batch is False or _batch < 1:
            vis_msg.print('ERROR in EvaluateMl2DDcnn: Non-positive batch size', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Evaluate 2D-DCNN', 'Non-positive batch size')
            return
        ...
        _pgsdlg.setWindowTitle('Evaluate 2D-DCNN')
        ...
        for i in range(_nloop):
            ...
            sys.stdout.write('\r>>> Evaluate 2D-DCNN, proceeding %.1f%% ' % (float(i) / float(_nloop) * 100.0))
            sys.stdout.flush()
            ...
            if _target not in _features:
                ...
                if self.cbbornt.currentIndex() == 0:
                    _data = _data[idxlist, :, :]
                    _dict[_target] = np.reshape(np.transpose(_data, [0, 2, 1]), [
                     -1, _seisinfo['XLNum'] * _seisinfo['ZNum']])
                if self.cbbornt.currentIndex() == 1:
                    _data = _data[:, idxlist, :]
                    _dict[_target] = np.reshape(np.transpose(_data, [1, 2, 0]), [
                     -1, _seisinfo['ILNum'] * _seisinfo['ZNum']])
                if self.cbbornt.currentIndex() == 2:
                    _data = _data[:, :, idxlist]
                    _dict[_target] = np.reshape(np.transpose(_data, [2, 1, 0]), [
                     -1, _seisinfo['ILNum'] * _seisinfo['XLNum']])
            if _image_height_new != _image_height or _image_width_new != _image_width:
                ...
                if _target not in _features:
                    _dict[_target] = basic_image.changeImageSize((_dict[_target]), image_height=_image_height,
                      image_width=_image_width,
                      image_height_new=_image_height_new,
                      image_width_new=_image_width_new)
            _dict[_target] = np.round(_dict[_target]).astype(int)
            _confmatrix = ml_dcnn.evaluateDCNNSegmentor(_dict, imageheight=_image_height_new,
...
if __name__ == '__main__':
    ...
    EvaluateMl2DDcnn = QtWidgets.QWidget()
    gui = evaluateml2ddcnn()
    gui.setupGUI(EvaluateMl2DDcnn)
    EvaluateMl2DDcnn.show()
    sys.exit(app.exec_())