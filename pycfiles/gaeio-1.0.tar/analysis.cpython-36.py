...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\gaeio\src\seismic\analysis.py
# Compiled at: 2020-04-25 14:33:31
# Size of source mod 2**32: 94334 bytes
...
def isOutOfSurvey(ixzlist, inlstart=0, inlend=100, xlstart=0, xlend=100, zstart=0, zend=-1000):
    ...
    for i in range(nsample):
        ...
        xl = ixzlist[(i, 1)]
        z = ixzlist[(i, 2)]
        if il < inlstart or il > inlend or xl < xlstart or xl > xlend or z > zstart or z < zend:
            flags[i] = 1
        if il > inlstart and il < inlend and xl > xlstart and xl < xlend and z < zstart and z > zend:
            flags[i] = -1
