...
class extractml2dcae(object):
    ...
    def clickBtnExtractMl2DCae--- This code section failed: ---
 ...
 L. 480        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ExtractMl2DCae: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 482        44  LOAD_STR                 'Extract 2D-CAE'
 ...
 L. 487        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ExtractMl2DCae: No pre-CAE network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 489       100  LOAD_STR                 'Extract 2D-CAE'

 L. 490       102  LOAD_STR                 'No pre-CAE network found'
 ...
 L. 495       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ExtractMl2DCae: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 498       170  LOAD_STR                 'Extract 2D-CAE'
 ...
 L. 510       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ExtractMl2DCae: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
 ...
 L. 512       332  LOAD_STR                 'Extract 2D-CAE'
 ...
 L. 517       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ExtractMl2DCae: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
 ...
 L. 519       408  LOAD_STR                 'Extract 2D-CAE'
 ...
 L. 525       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ExtractMl2DCae: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
 ...
 L. 527       480  LOAD_STR                 'Extract 2D-CAE'
 ...
 L. 532       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ExtractMl2DCae: No prefix specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
 ...
 L. 534       536  LOAD_STR                 'Extract 2D-CAE'
 ...
 L. 593      1088  LOAD_STR                 '\r>>> Extract 2D-CAE, proceeding %.1f%% '
 ...
 L. 627      1546  LOAD_GLOBAL              ml_cae
             1548  LOAD_ATTR                extractCAEConvFeature
 ...
 L. 633      1570  LOAD_FAST                '_batch'
             ...
             1574  LOAD_CONST               ('imageheight', 'imagewidth', 'caepath', 'caename', 'blockidx', 'layeridx', 'location', 'batchsize', 'verbose')
