...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\applyml2dcae.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 34425 bytes
...
class applyml2dcae(object):
    ...
    def setupGUI(self, ApplyMl2DCae):
        ...
        self.lblnconvblock = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblnconvblock.setObjectName('lblnconvblock')
        self.lblnconvblock.setGeometry(QtCore.QRect(410, 100, 130, 30))
        self.ldtnconvblock = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtnconvblock.setObjectName('ldtnconvblock')
        self.ldtnconvblock.setGeometry(QtCore.QRect(550, 100, 40, 30))
        self.twgnconvblock = QtWidgets.QTableWidget(ApplyMl2DCae)
        ...
        self.lblmasksize = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblmasksize.setObjectName('lblmasksize')
        self.lblmasksize.setGeometry(QtCore.QRect(410, 350, 80, 60))
        self.lblmaskheight = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblmaskheight.setObjectName('lblmaskheight')
        self.lblmaskheight.setGeometry(QtCore.QRect(500, 350, 50, 30))
        self.ldtmaskheight = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtmaskheight.setObjectName('ldtmaskheight')
        self.ldtmaskheight.setGeometry(QtCore.QRect(550, 350, 40, 30))
        self.lblmaskwidth = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblmaskwidth.setObjectName('lblmaskwidth')
        self.lblmaskwidth.setGeometry(QtCore.QRect(500, 390, 50, 30))
        self.ldtmaskwidth = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtmaskwidth.setObjectName('ldtmaskwidth')
        self.ldtmaskwidth.setGeometry(QtCore.QRect(550, 390, 40, 30))
        self.lblpoolsize = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblpoolsize.setObjectName('lblpoolsize')
        self.lblpoolsize.setGeometry(QtCore.QRect(610, 350, 80, 60))
        self.lblpoolheight = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblpoolheight.setObjectName('lblpoolheight')
        self.lblpoolheight.setGeometry(QtCore.QRect(700, 350, 50, 30))
        self.ldtpoolheight = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtpoolheight.setObjectName('ldtpoolheight')
        self.ldtpoolheight.setGeometry(QtCore.QRect(750, 350, 40, 30))
        self.lblpoolwidth = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblpoolwidth.setObjectName('lblpoolwidth')
        self.lblpoolwidth.setGeometry(QtCore.QRect(700, 390, 50, 30))
        self.ldtpoolwidth = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtpoolwidth.setObjectName('ldtpoolwidth')
        self.ldtpoolwidth.setGeometry(QtCore.QRect(750, 390, 40, 30))
        self.lblpara = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblpara.setObjectName('lblpara')
        self.lblpara.setGeometry(QtCore.QRect(10, 320, 100, 30))
        self.lblbatchsize = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblbatchsize.setObjectName('lblbatchsize')
        self.lblbatchsize.setGeometry(QtCore.QRect(10, 350, 130, 30))
        self.ldtbatchsize = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtbatchsize.setObjectName('ldtbatchsize')
        self.ldtbatchsize.setGeometry(QtCore.QRect(150, 350, 40, 30))
        self.lblsave = QtWidgets.QLabel(ApplyMl2DCae)
        self.lblsave.setObjectName('lblsave')
        self.lblsave.setGeometry(QtCore.QRect(10, 390, 130, 30))
        self.ldtsave = QtWidgets.QLineEdit(ApplyMl2DCae)
        self.ldtsave.setObjectName('ldtsave')
        self.ldtsave.setGeometry(QtCore.QRect(150, 390, 40, 30))
        self.btnapply = QtWidgets.QPushButton(ApplyMl2DCae)
        self.btnapply.setObjectName('btnapply')
        self.btnapply.setGeometry(QtCore.QRect(320, 440, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/apply.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnapply.setIcon(icon)
        self.msgbox = QtWidgets.QMessageBox(ApplyMl2DCae)
        self.msgbox.setObjectName('msgbox')
        _center_x = ApplyMl2DCae.geometry().center().x()
        _center_y = ApplyMl2DCae.geometry().center().y()
        self.msgbox.setGeometry(QtCore.QRect(_center_x - 150, _center_y - 50, 300, 100))
        self.retranslateGUI(ApplyMl2DCae)
        QtCore.QMetaObject.connectSlotsByName(ApplyMl2DCae)

    def retranslateGUI(self, ApplyMl2DCae):
        self.dialog = ApplyMl2DCae
        _translate = QtCore.QCoreApplication.translate
        ApplyMl2DCae.setWindowTitle(_translate('ApplyMl2DCae', 'Apply 2D-CAE'))
        self.lblfrom.setText(_translate('ApplyMl2DCae', 'Select network:'))
        self.ldtfrom.setText(_translate('ApplyMl2DCae', ''))
        self.ldtfrom.textChanged.connect(self.changeLdtFrom)
        self.btnfrom.setText(_translate('ApplyMl2DCae', 'Browse'))
        self.btnfrom.clicked.connect(self.clickBtnFrom)
        self.lblfeature.setText(_translate('ApplyMl2DCae', 'Training features:'))
        self.lwgfeature.itemSelectionChanged.connect(self.changeLwgFeature)
        self.lblornt.setText(_translate('ApplyMl2DCae', 'Orientation:'))
        ...
        self.lbloldsize.setText(_translate('ApplyMl2DCae', 'Original\npatch\nsize:'))
        self.lbloldsize.setAlignment(QtCore.Qt.AlignRight)
        self.lbloldheight.setText(_translate('ApplyMl2DCae', 'height='))
        self.ldtoldheight.setText(_translate('ApplyMl2DCae', '0'))
        self.ldtoldheight.setEnabled(False)
        self.ldtoldheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lbloldwidth.setText(_translate('ApplyMl2DCae', 'width='))
        self.ldtoldwidth.setText(_translate('ApplyMl2DCae', '0'))
        self.ldtoldwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtoldwidth.setEnabled(False)
        self.lblnewsize.setText(_translate('ApplyMl2DCae', 'Interpolated\npatch\nsize:'))
        self.lblnewsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblnewheight.setText(_translate('ApplyMl2DCae', 'height='))
        self.ldtnewheight.setText(_translate('ApplyMl2DCae', ''))
        self.ldtnewheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnewwidth.setText(_translate('ApplyMl2DCae', 'width='))
        self.ldtnewwidth.setText(_translate('ApplyMl2DCae', ''))
        self.ldtnewwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblnetwork.setText(_translate('ApplyMl2DCae', 'Pre-trained CAE architecture:'))
        self.btnviewnetwork.setText(_translate('ApplyMl2DCae', 'View'))
        self.btnviewnetwork.setEnabled(False)
        self.btnviewnetwork.clicked.connect(self.clickBtnViewNetwork)
        self.lblnconvblock.setText(_translate('ApplyMl2DCae', 'No. of conv. blocks:'))
        self.lblnconvblock.setAlignment(QtCore.Qt.AlignRight)
        self.ldtnconvblock.setText(_translate('ApplyMl2DCae', ''))
        self.ldtnconvblock.setEnabled(False)
        self.ldtnconvblock.setAlignment(QtCore.Qt.AlignCenter)
        self.ldtnconvblock.textChanged.connect(self.changeLdtNconvblock)
        self.twgnconvblock.setHorizontalHeaderLabels(['Block ID', 'No. of layers', 'No. of features'])
        self.lbln1x1layer.setText(_translate('ApplyMl2DCae', 'No. of 1x1 layers:'))
        self.lbln1x1layer.setAlignment(QtCore.Qt.AlignRight)
        self.ldtn1x1layer.setText(_translate('ApplyMl2DCae', ''))
        ...
        self.lblmasksize.setText(_translate('ApplyMl2DCae', 'Convolution\nmask\nsize:'))
        self.lblmasksize.setAlignment(QtCore.Qt.AlignRight)
        self.lblmaskheight.setText(_translate('ApplyMl2DCae', 'height='))
        self.ldtmaskheight.setText(_translate('ApplyMl2DCae', ''))
        self.ldtmaskheight.setEnabled(False)
        self.ldtmaskheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblmaskwidth.setText(_translate('ApplyMl2DCae', 'width='))
        self.ldtmaskwidth.setText(_translate('ApplyMl2DCae', ''))
        self.ldtmaskwidth.setEnabled(False)
        self.ldtmaskwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolsize.setText(_translate('ApplyMl2DCae', 'Maximum\npooling\nsize:'))
        self.lblpoolsize.setAlignment(QtCore.Qt.AlignRight)
        self.lblpoolheight.setText(_translate('ApplyMl2DCae', 'height='))
        self.ldtpoolheight.setText(_translate('ApplyMl2DCae', ''))
        self.ldtpoolheight.setEnabled(False)
        self.ldtpoolheight.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpoolwidth.setText(_translate('ApplyMl2DCae', 'width='))
        self.ldtpoolwidth.setText(_translate('ApplyMl2DCae', ''))
        self.ldtpoolwidth.setEnabled(False)
        self.ldtpoolwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.lblpara.setText(_translate('ApplyMl2DCae', 'Key parameters:'))
        self.lblbatchsize.setText(_translate('ApplyMl2DCae', 'Batch size='))
        self.lblbatchsize.setAlignment(QtCore.Qt.AlignRight)
        self.ldtbatchsize.setText(_translate('ApplyMl2DCae', '5'))
        self.ldtbatchsize.setAlignment(QtCore.Qt.AlignCenter)
        self.lblsave.setText(_translate('ApplyMl2DCae', 'Output name='))
        self.lblsave.setAlignment(QtCore.Qt.AlignRight)
        self.ldtsave.setText(_translate('ApplyMl2DCae', 'cae'))
        self.ldtsave.setAlignment(QtCore.Qt.AlignCenter)
        self.btnapply.setText(_translate('ApplyMl2DCae', 'Apply 2D-CAE'))
        self.btnapply.setDefault(True)
        self.btnapply.clicked.connect(self.clickBtnApplyMl2DCae)
    ...
    def changeLwgFeature(self):
        _shape = [
         0, 0]
        if ml_tfm.checkCAEModel(self.modelpath, self.modelname):
    ...
    def clickBtnApplyMl2DCae--- This code section failed: ---
 ...
 L. 459        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ApplyMl2DCae: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 461        44  LOAD_STR                 'Apply 2D-CAE'
 ...
 L. 466        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ApplyMl2DCae: No pre-CAE network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 468       100  LOAD_STR                 'Apply 2D-CAE'

 L. 469       102  LOAD_STR                 'No pre-CAE network found'
 ...
 L. 474       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ApplyMl2DCae: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 477       170  LOAD_STR                 'Apply 2D-CAE'
 ...
 L. 489       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ApplyMl2DCae: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
 ...
 L. 491       332  LOAD_STR                 'Apply 2D-CAE'
 ...
 L. 496       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ApplyMl2DCae: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
 ...
 L. 498       408  LOAD_STR                 'Apply 2D-CAE'
 ...
 L. 504       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ApplyMl2DCae: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
 ...
 L. 506       480  LOAD_STR                 'Apply 2D-CAE'
 ...
 L. 511       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ApplyMl2DCae: No name specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
 ...
 L. 513       536  LOAD_STR                 'Apply 2D-CAE'
 ...
 L. 529       680  LOAD_FAST                '_seisinfo'
              682  LOAD_STR                 'ILNum'
              684  BINARY_SUBSCR    
              686  STORE_FAST               '_nsample'
            688_0  COME_FROM           676  '676'

 L. 530       688  LOAD_FAST                'self'
 ...
 L. 531       704  LOAD_FAST                '_seisinfo'
              706  LOAD_STR                 'XLNum'
              708  BINARY_SUBSCR    
              710  STORE_FAST               '_nsample'
            712_0  COME_FROM           700  '700'

 L. 532       712  LOAD_FAST                'self'
 ...
 L. 533       728  LOAD_FAST                '_seisinfo'
              730  LOAD_STR                 'ZNum'
              732  BINARY_SUBSCR    
              734  STORE_FAST               '_nsample'
            736_0  COME_FROM           724  '724'

 L. 535       736  LOAD_GLOBAL              int
              738  LOAD_GLOBAL              np
 ...
 L. 551       900  LOAD_CONST               0
              902  STORE_FAST               'idxstart'

 L. 552   904_906  SETUP_LOOP         1520  'to 1520'
 ...
 L. 556       936  LOAD_GLOBAL              sys
              938  LOAD_ATTR                stdout
              940  LOAD_METHOD              write

 L. 557       942  LOAD_STR                 '\r>>> Apply 2D-CAE, proceeding %.1f%% '
 ...
 L. 564      1028  LOAD_FAST                'idxend'
             1030  STORE_FAST               'idxstart'

 L. 566      1032  BUILD_MAP_0           0 
             1034  STORE_FAST               '_dict'

 L. 567  1036_1038  SETUP_LOOP         1336  'to 1336'
 ...
 L. 568      1050  LOAD_FAST                'self'
             1052  LOAD_ATTR                seisdata
             1054  LOAD_FAST                'f'
             1056  BINARY_SUBSCR    
             1058  STORE_FAST               '_data'

 L. 569      1060  LOAD_GLOBAL              np
 ...
 L. 583      1336  LOAD_FAST                '_image_height_new'
 ...
 L. 584      1356  SETUP_LOOP         1400  'to 1400'
             1358  LOAD_FAST                '_features'
             1360  GET_ITER         
             1362  FOR_ITER           1398  'to 1398'
             1364  STORE_FAST               'f'

 L. 585      1366  LOAD_GLOBAL              basic_image
             1368  LOAD_ATTR                changeImageSize
             1370  LOAD_FAST                '_dict'
             1372  LOAD_FAST                'f'
             1374  BINARY_SUBSCR    

 L. 586      1376  LOAD_FAST                '_image_height'

 L. 587      1378  LOAD_FAST                '_image_width'

 L. 588      1380  LOAD_FAST                '_image_height_new'

 L. 589      1382  LOAD_FAST                '_image_width_new'
 ...
 L. 591      1400  LOAD_GLOBAL              ml_cae
             1402  LOAD_ATTR                reconstructFromCAEReconstructor
             1404  LOAD_FAST                '_dict'

 L. 592      1406  LOAD_FAST                '_image_height_new'
             1408  LOAD_FAST                '_image_width_new'

 L. 593      1410  LOAD_FAST                'self'
             1412  LOAD_ATTR                modelpath

 L. 594      1414  LOAD_FAST                'self'
             1416  LOAD_ATTR                modelname

 L. 595      1418  LOAD_FAST                '_batch'
             1420  LOAD_CONST               True
             1422  LOAD_CONST               ('imageheight', 'imagewidth', 'caepath', 'caename', 'batchsize', 'verbose')
             1424  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
             1426  STORE_FAST               '_rst'

 L. 598      1428  LOAD_FAST                '_image_height_new'
 ...
 L. 599      1448  LOAD_GLOBAL              basic_image
             1450  LOAD_ATTR                changeImageSize
             1452  LOAD_FAST                '_rst'

 L. 600      1454  LOAD_FAST                '_image_height_new'

 L. 601      1456  LOAD_FAST                '_image_width_new'

 L. 602      1458  LOAD_FAST                '_image_height'

 L. 603      1460  LOAD_FAST                '_image_width'
 ...
 L. 611      1520  LOAD_GLOBAL              print
             1522  LOAD_STR                 'Done'
             1524  CALL_FUNCTION_1       1  '1 positional argument'
             1526  POP_TOP          

 L. 613      1528  LOAD_FAST                'self'
             1530  LOAD_ATTR                survinfo
             1532  STORE_FAST               '_info'

 L. 614      1534  LOAD_FAST                '_info'
             1536  LOAD_STR                 'ILNum'
             1538  BINARY_SUBSCR    
             1540  STORE_FAST               '_inlnum'

 L. 615      1542  LOAD_FAST                '_info'
             1544  LOAD_STR                 'XLNum'
             1546  BINARY_SUBSCR    
             1548  STORE_FAST               '_xlnum'

 L. 616      1550  LOAD_FAST                '_info'
             1552  LOAD_STR                 'ZNum'
             1554  BINARY_SUBSCR    
             1556  STORE_FAST               '_znum'

 L. 617      1558  LOAD_FAST                'self'
 ...
 L. 628      1712  LOAD_GLOBAL              QtWidgets
             1714  LOAD_ATTR                QMessageBox
             1716  LOAD_METHOD              information
             1718  LOAD_FAST                'self'
             1720  LOAD_ATTR                msgbox

 L. 629      1722  LOAD_STR                 'Apply 2D-CAE'

 L. 630      1724  LOAD_STR                 'CAE applied successfully'
...
if __name__ == '__main__':
    ...
    ApplyMl2DCae = QtWidgets.QWidget()
    gui = applyml2dcae()
    gui.setupGUI(ApplyMl2DCae)
    ApplyMl2DCae.show()
    sys.exit(app.exec_())