...
# [GCC 8.4.0]
# Embedded file name: C:\Users\HDi\Google Drive\ProgramCodes\PythonCodes\cognitivegeo\src\gui\plotvis2dseisxl.py
# Compiled at: 2020-03-18 15:05:46
# Size of source mod 2**32: 15094 bytes
...
class plotvis2dseisxl(object):
    ...
    def clickBtnPlotSlice(self):
        ...
        if len(_attriblist) < 1:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '2D Window: Seismic Crossline', 'No property selected for plot')
            return
        ...
        if _min is False or _max is False:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '2D Window: Seismic Crossline', 'Non-float range specified for plot')
            return
        for i in range(len(_attriblist)):
            ...
            seis_vis.plotSeisXLSlicePlayerFrom3DMat(_data, initxsl=_sls, seisinfo=(self.survinfo), titlesurf=(': ' + _attriblist[i].text()),
              valuemin=_min,
              valuemax=_max,
