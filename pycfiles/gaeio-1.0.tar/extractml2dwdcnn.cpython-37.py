...
class extractml2dwdcnn(object):
    ...
    def clickBtnExtractMl2DWdcnn--- This code section failed: ---
 ...
 L. 480        20  LOAD_GLOBAL              vis_msg
               22  LOAD_ATTR                print
               24  LOAD_STR                 'ERROR in ExtractMl2DWdcnn: No seismic survey available'
               26  LOAD_STR                 'error'
               28  LOAD_CONST               ('type',)
 ...
 L. 482        44  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 487        76  LOAD_GLOBAL              vis_msg
               78  LOAD_ATTR                print
               80  LOAD_STR                 'ERROR in ExtractMl2DWdcnn: No pre-WDCNN network found'
               82  LOAD_STR                 'error'
               84  LOAD_CONST               ('type',)
 ...
 L. 489       100  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 495       142  LOAD_GLOBAL              vis_msg
              144  LOAD_ATTR                print
              146  LOAD_STR                 "ERROR in ExtractMl2DWdcnn: Feature '%s' not found in seismic data"
              148  LOAD_FAST                'f'
              150  BINARY_MODULO    
 ...
 L. 498       170  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 510       308  LOAD_GLOBAL              vis_msg
              310  LOAD_ATTR                print
              312  LOAD_STR                 'ERROR in ExtractMl2DWdcnn: Non-integer feature size'
              314  LOAD_STR                 'error'
              316  LOAD_CONST               ('type',)
 ...
 L. 512       332  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 517       384  LOAD_GLOBAL              vis_msg
              386  LOAD_ATTR                print
              388  LOAD_STR                 'ERROR in ExtractMl2DWdcnn: Features are not 2D'
              390  LOAD_STR                 'error'
              392  LOAD_CONST               ('type',)
 ...
 L. 519       408  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 525       456  LOAD_GLOBAL              vis_msg
              458  LOAD_ATTR                print
              460  LOAD_STR                 'ERROR in ExtractMl2DWdcnn: Non-positive batch size'
              462  LOAD_STR                 'error'
              464  LOAD_CONST               ('type',)
 ...
 L. 527       480  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 532       512  LOAD_GLOBAL              vis_msg
              514  LOAD_ATTR                print
              516  LOAD_STR                 'ERROR in ExtractMl2DWdcnn: No prefix specified'
              518  LOAD_STR                 'error'
              520  LOAD_CONST               ('type',)
 ...
 L. 534       536  LOAD_STR                 'Extract 2D-WDCNN'
 ...
 L. 593      1088  LOAD_STR                 '\r>>> Extract 2D-WDCNN, proceeding %.1f%% '
 ...
 L. 627      1546  LOAD_GLOBAL              ml_wdcnn
             1548  LOAD_ATTR                extractWDCNNConvFeature
 ...
 L. 633      1570  LOAD_FAST                '_batch'
             ...
             1574  LOAD_CONST               ('imageheight', 'imagewidth', 'wdcnnpath', 'wdcnnname', 'blockidx', 'layeridx', 'location', 'batchsize', 'verbose')
             1576  CALL_FUNCTION_KW_10    10  '10 total positional and keyword args'
             1578  STORE_FAST               '_rst'

 L. 636      1580  LOAD_GLOBAL              np
 ...
 L. 638      1608  LOAD_FAST                '_feature_height'
 ...
 L. 640      1662  LOAD_GLOBAL              basic_image
             1664  LOAD_ATTR                changeImageSize
             1666  LOAD_FAST                '_rst'

 L. 641      1668  LOAD_FAST                '_feature_height'

 L. 642      1670  LOAD_FAST                '_feature_width'

 L. 643      1672  LOAD_FAST                '_image_height'

 L. 644      1674  LOAD_FAST                '_image_width'
 ...
 L. 652      1784  LOAD_GLOBAL              print
             1786  LOAD_STR                 'Done'
             1788  CALL_FUNCTION_1       1  '1 positional argument'
             1790  POP_TOP          

 L. 654      1792  LOAD_FAST                'self'
             1794  LOAD_ATTR                survinfo
             1796  STORE_FAST               '_info'

 L. 655      1798  LOAD_FAST                '_info'
             1800  LOAD_STR                 'ILNum'
             1802  BINARY_SUBSCR    
             1804  STORE_FAST               '_inlnum'

 L. 656      1806  LOAD_FAST                '_info'
             1808  LOAD_STR                 'XLNum'
             1810  BINARY_SUBSCR    
             1812  STORE_FAST               '_xlnum'

 L. 657      1814  LOAD_FAST                '_info'
             1816  LOAD_STR                 'ZNum'
             1818  BINARY_SUBSCR    
             1820  STORE_FAST               '_znum'

 L. 658      1822  SETUP_LOOP         2062  'to 2062'
 ...
 L. 670      2062  LOAD_GLOBAL              QtWidgets
             2064  LOAD_ATTR                QMessageBox
             2066  LOAD_METHOD              information
             2068  LOAD_FAST                'self'
             2070  LOAD_ATTR                msgbox

 L. 671      2072  LOAD_STR                 'Extract 2D-WDCNN'

 L. 672      2074  LOAD_GLOBAL              str
             2076  LOAD_FAST                '_nfeature'
             2078  CALL_FUNCTION_1       1  '1 positional argument'
             2080  LOAD_STR                 ' WDCNN features extracted successfully'
             2082  BINARY_ADD       
