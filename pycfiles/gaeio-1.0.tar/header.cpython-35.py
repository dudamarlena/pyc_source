...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Haibin\AppData\Local\Temp\pip-build-8dr99z6a\segpy\segpy\header.py
...
class FormatMeta(type):
    ...
    def __new__(mcs, name, bases, namespace):
        ...
        for attr_name, attr in namespace.items():
            if isinstance(attr, HeaderFieldDescriptor) and attr._name is None:
