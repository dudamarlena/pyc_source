...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-facebook-api/facebook_api/decorators.py
# Compiled at: 2015-11-17 07:06:10
"""
...
def reduce_data_amount(func):
    ...
    def wrapper(self, *args, **kwargs):
        try:
            ...
            if e.message == "Please reduce the amount of data you're asking for, then retry your request" and 'limit' in kwargs:
    ...
    def wrapper(self, *args, **kwargs):
        ...
        if all:
            if isinstance(instances, QuerySet):
                ...
                if paging_next_arg_name and paging_next and paging_next_arg_name in paging_next or paging_next_arg_name and paging_cursors and paging_next_arg_name in paging_cursors:
                    paging_next_arg_value = None
                    if paging_cursors:
                        paging_next_arg_value = paging_cursors.get(paging_next_arg_name, None)
