...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/core/options.py
# Compiled at: 2020-05-13 19:27:59
# Size of source mod 2**32: 8155 bytes
"""
    ...
    def get_option(self, name, group=None, default=None):
        ...
        if value is None:
            if default is not None:
                return default
            tp.logger.warning('Impossible to access option with proper format from {}'.format(self._option_settings.directory))
