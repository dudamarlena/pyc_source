...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/freegenes/logger/message.py
# Compiled at: 2019-09-02 10:58:44
# Size of source mod 2**32: 9839 bytes
import os, sys
from .spinner import Spinner
from freegenes.logger import decodeUtf8String
ABORT = -5
CRITICAL = -4
ERROR = -3
WARNING = -2
...
def get_logging_level():
    ...
    """
    level = os.environ.get('MESSAGELEVEL', '1')
    if level == 'CRITICAL':
        return CRITICAL
    if level == 'ABORT':
        return ABORT
...
FreeGenesMessage.spinner = Spinner()
bot = FreeGenesMessage()