...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/freegenes/utils/terminal.py
...
def run_command(cmd, sudo=False, capture=True, no_newline_regexp='Progess', quiet=False, sudo_options=None):
    ...
    for line in process.communicate():
        if line:
            ...
            lines.append(line)
            if re.search(no_newline_regexp, line):
                if found_match:
                    if not quiet:
