...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/freegenes/logger/progress.py
...
def bar(it, label='', width=32, hide=None, empty_char=BAR_EMPTY_CHAR, filled_char=BAR_FILLED_CHAR, expected_size=None, every=1):
    ...
    with ProgressBar(label=label, width=width, hide=hide, empty_char=BAR_EMPTY_CHAR, filled_char=BAR_FILLED_CHAR,
      expected_size=count,
      every=every) as (pbar):
