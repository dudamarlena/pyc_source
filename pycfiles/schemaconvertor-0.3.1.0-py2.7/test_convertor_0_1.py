...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/schemaconvertor/tests/test_convertor_0_1.py
# Compiled at: 2015-03-28 05:57:47
...
class TestSimple(TestCase):
    ...
    def test_base_type(self):
        ...
        schema = {'type': 'dict', 
           'properties': {'string': {'type': 'string'}, 
                          ...
                          'float': {'type': 'float'}, 
                          'number_integer': {'type': 'number'}, 
                          'number_float': {'type': 'number'}, 
                          'number_str': {'type': 'number'}, 
                          'number_asinteger': {'type': 'number'}, 
                          'boolean': {'type': 'boolean'}, 
                          'null': {'type': 'null'}}}
        cvtr = convertor.SchemaConvertor(schema)
        result = cvtr(data)
        self.assertDictEqual(result, {'string': '1', 
           'integer': 2, 
           'float': 3.4, 
           'number_integer': 5, 
           'number_float': 6.7, 
    ...
    def test_complex_type(self):
        ...
        schema = {'type': 'object', 
           'properties': {'key': 'string', 
                          'value': 'string'}}
        cvtr = convertor.SchemaConvertor(schema)
        self.assertEqual(cvtr(data), {'key': 'test', 
           'value': 'test value'})
        schema = {'type': 'array', 
           'items': 'string'}
        cvtr = convertor.SchemaConvertor(schema)
        self.assertEqual(cvtr(data), ['test', 'test value'])
        data = Pair(key=1, value={'array': [
                   Pair(key=2, value=3), Pair(key=4, value=5)], 
           'dict': {'key': 6, 'value': 7}, 'object': Pair(key=8, value=9), 
           'int': 10})
        schema = {'type': 'object', 
           'properties': {'key': 'string', 
                          'value': {'type': 'dict', 
                                    'properties': {'array': {'type': 'array', 
                                                   ...
                                                   'int': 'integer'}}}}
        cvtr = convertor.SchemaConvertor(schema)
        self.assertEqual(cvtr(data), {'key': '1', 
           'value': {'array': [{'key': '2', 'value': 3}, {'key': '4', 'value': 5}], 'dict': {'key': '6', 'value': 7}, 'object': {'key': '8', 'value': 9}, 'int': 10}})
    ...
    def test_mixing_type(self):
        data = [
         ...
         3, 4.5, '6']
        schema = {'type': 'array', 
           'items': {'typeOf': {(int, str): 'string', 
                                float: 'integer', 
                                Pair: {'type': 'object', 
                                       'properties': {'key': 'string', 
                                                      'value': 'integer'}}}}}
        cvtr = convertor.SchemaConvertor(schema)
        self.assertEqual(cvtr(data), [{'key': '1', 'value': 2},
         '3', 4, '6'])
        schema = {'type': 'array', 
           'items': {'typeOf': {'default': 'string', 
                                Pair: {'type': 'object', 
                                       'properties': {'key': 'string', 
                                                      'value': 'integer'}}}}}
        cvtr = convertor.SchemaConvertor(schema)
