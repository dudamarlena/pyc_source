...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/basecamp/basecamp.py
# Compiled at: 2012-03-12 08:51:57
import requests, elementtree.ElementTree as ET
...
class Basecamp:
    ...
    def _request(self, path, data=None, put=False, post=False, delete=False, get=False):
        ...
        if post and answer.status_code != 201 or not post and answer.status_code != 200:
    ...
    def _create_message_post_elem(self, category_id, title, body, private=False, notify=False):
    ...
    def create_message(self, project_id, category_id, title, body, private=False, notify=None, attachments=None):
        """
        ...
        req.append(self._create_message_post_elem(category_id, title, body, private))
        if notify:
    ...
    def update_message(self, message_id, category_id, title, body, private=False, notify=None):
        """
        ...
        path = '/posts/%u.xml' % message_id
        req = ET.Element('request')
        req.append(self._create_message_post_elem(category_id, title, body, private, notify))
    ...
    def update_todo_list(self, list_id, name, description, milestone_id=None, private=None, tracked=None):
        """
    ...
    def create_todo_item(self, list_id, content, party_id=None, notify=False, due_at=None):
        """
    ...
    def create_time_entry(self, description, hours, person_id, entry_date=None, project_id=None, todo_item_id=None):
        """
    ...
    def update_time_entry(self, time_entry_id, description, hours, person_id, entry_date=None, todo_item_id=None):
        """
