...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mydupfilekiller\core.py
# Compiled at: 2014-07-06 10:15:47
# Size of source mod 2**32: 4650 bytes
__all__ = [
 'find', 'find_and_delete']
import collections
...
def find_and_delete(paths, choose_callback=default_choose_callback, output=False, skip_empty_files=True, follow_links=False):
    """
