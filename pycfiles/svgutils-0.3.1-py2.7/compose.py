...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/svgutils/compose.py
# Compiled at: 2018-01-26 07:54:42
...
CONFIG = {'svg.file_path': '.', 'figure.save_path': '.', 
   'image.file_path': '.', 
   'text.position': (0, 0), 
   'text.size': 8, 
   'text.weight': 'normal', 
...
class Text(Element):
    ...
    def __init__(self, text, x=None, y=None, **kwargs):
        params = {'size': CONFIG['text.size'], 'weight': CONFIG['text.weight'], 
