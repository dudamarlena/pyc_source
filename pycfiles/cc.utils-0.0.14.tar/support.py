...
# Embedded file name: build/bdist.linux-i686/egg/cc/licenserdf/tools/support.py
# Compiled at: 2012-01-24 12:18:08
__doc__ = 'Support functions for license RDF tools.'
...
def save_graph(graph, filename):
    ...
    output_file.write(graph.serialize(format='pretty-xml', max_depth=1))
    output_file.close()
...
def gen_license_i18n_title(license_code, license_version, license_jurisdiction):
    if license_code == 'devnations':
        ...
        i18n_str = 'CC0 %s ${Universal}' % license_version
    elif license_jurisdiction:
        i18n_str = '${%s} %s ${%s}' % (
         mappers.LICENSE_NAME_MAP[license_code],
         license_version,
