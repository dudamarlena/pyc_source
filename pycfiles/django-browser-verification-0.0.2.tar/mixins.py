...
# [GCC 8.4.0]
# Embedded file name: /var/www/paparazziaccessories-com/venv-paparazzi/src/django-browser-verification/browser_verification/mixins.py
# Compiled at: 2016-06-22 17:45:05
...
class BrowserVerificationMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if request.browser_unknown:
            ...
            response = super(BrowserVerificationMixin, self).dispatch(request, *args, **kwargs)
        return response

    def _redirect_or_default(self, url):
        if url:
            return redirect(url)
        return super(BrowserVerificationMixin, self).dispatch(self.request, **self.kwargs)
