...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/futuregrid_move/rain/move/RainMoveServerSites.py
# Compiled at: 2012-07-25 14:50:58
"""
    ...
    def remove_hpc(self, hostname, forcemove):
        ...
        while not exitloop:
            ...
            if p.returncode != 0:
                ...
                exitloop = True
                success = False
            elif not re.search('^jobs', std[0].split('\n')[5].strip()):
