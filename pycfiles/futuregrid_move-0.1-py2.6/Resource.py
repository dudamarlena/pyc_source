...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/futuregrid_move/rain/move/Resource.py
# Compiled at: 2012-07-13 14:38:39
"""
...
__version__ = '0.1'
import abc, json, socket, ssl, logging, logging.handlers, sys
...
class Resource(object):
    ...
    TYPE = dict(zip(('NODE', 'VM', 'IP'), ('Node', 'VM', 'IP')))
...
class Node(Resource):
    ...
    def __init__(self, id, name='', ip='', cluster=''):
        ...
        self._type = Resource.TYPE['NODE']
        self._allocated = 'FREE'
...
class Service(object):
    ...
    def socketConnection(self):
        ...
        try:
            connection = ssl.wrap_socket(s, ca_certs=self._MoveClientca_certs, certfile=self._MoveClientcertfile, keyfile=self._MoveClientkeyfile, cert_reqs=ssl.CERT_REQUIRED, ssl_version=ssl.PROTOCOL_TLSv1)
