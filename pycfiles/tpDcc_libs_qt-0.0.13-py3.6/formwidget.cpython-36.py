...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/formwidget.py
# Compiled at: 2020-05-13 19:31:15
# Size of source mod 2**32: 38157 bytes
"""
...
class FieldWidget(QFrame, object):
    ...
    def to_title(name):
        ...
        return re.sub('([a-z0-9])([A-Z])', '\\1 \\2', s1).title()
...
class PathFieldWidget(StringFieldWidget, object):
    ...
    def set_data(self, data):
        if 'menu' not in data:
            data['menu'] = {'callback': self._on_browse}
...
FIELD_WIDGET_REGISTRY = {'int':IntFieldWidget, 
