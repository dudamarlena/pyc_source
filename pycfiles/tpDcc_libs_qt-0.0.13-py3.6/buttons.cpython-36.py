...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/buttons.py
# Compiled at: 2020-05-13 19:31:15
# Size of source mod 2**32: 45654 bytes
"""
...
class BaseButton(QPushButton, object):
    ...
    def _set_type(self, value):
        ...
        if value in [self.Types.DEFAULT, self.Types.PRIMARY, self.Types.SUCCESS, self.Types.WARNING, self.Types.DANGER]:
            ...
            raise ValueError('Given button type: "{}" is not supported. Supported types are: default, primary, success, warning and danger'.format(value))
...
class ButtonIcons(QAbstractButton):
    ...
    def set_icon(self, icon, colors=None, size=None, color_offset=None, icon_scaling=None, tint_composition=QPainter.CompositionMode_Plus, grayscale=False):
        if size is not None:
    ...
    def update_icons(self):
        if not self.icon:
            return
        hover_color = (
         255, 255, 255, self.highlightOffset)
        self.idleIcon = icon.colorize_layered_icon(icons=(self.icon),
          size=(self.iconSize().width()),
          icon_scaling=(self.iconScaling),
          tint_composition=(self.tintComposition),
          colors=(self.iconColors),
          grayscale=(self.grayscale))
        self.hoverIcon = icon.colorize_layered_icon(icons=(self.icon),
          size=(self.iconSize().width()),
          icon_scaling=(self.iconScaling),
          tint_composition=(self.tintComposition),
          tint_color=hover_color,
          grayscale=(self.grayscale))
        self.setIcon(self.idleIcon)
...
class BaseMenuButton(QPushButton, ButtonIcons):
        ...
        def keyPressEvent(self, event):
            if event.key() == self._tt_key:
                ...
                if tooltips.has_expanded_tooltips(action):
                    self._popup_tooltip = tooltips.ExpandedTooltipPopup(widget=action,
    ...
    def __init__(self, icon=None, icon_hover=None, text=None, parent=None, double_click_enabled=False, menu_padding=5, menu_align=Qt.AlignLeft):
        """
    ...
    def menu(self, mouse_menu=Qt.LeftButton, searchable=False, auto_create=True):
        ...
        :return:
        """
        if not self._click_menu[mouse_menu]:
            if auto_create:
    ...
    def addAction(self, name, mouse_menu=Qt.LeftButton, connect=None, checkable=False, checked=True, action=None, action_icon=None, data=None, icon_text=None, icon_color=None, icon_size=16):
        """
        ...
        if action is not None:
            ...
            if action_icon is not None:
                if isinstance(action_icon, QIcon):
                    ...
                    new_action.setIcon(icon.colorize_layered_icon(action_icon, colors=[icon_color], size=(qtutils.dpi_scale(icon_size))))
    ...
    def launch_context_menu(self, mouse_btn):
        ...
        if menu is not None:
            if self._menu_active[mouse_btn]:
...
class IconMenuButton(BaseMenuButton, object):
    ...
    def __init__(self, icon=None, icon_hover=None, parent=None, double_click_enabled=False, color=(255, 255, 255), icon_menu_state_str='', icon_menu_state_int=0):
        super(IconMenuButton, self).__init__(icon=icon,
