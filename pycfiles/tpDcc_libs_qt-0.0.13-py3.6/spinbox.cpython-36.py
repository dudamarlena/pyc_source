...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/spinbox.py
...
class DragDoubleSpinBoxLine(lineedit.BaseLineEdit, object):
    ...
    def paintEvent(self, event):
        ...
        if self._sup:
            ...
            p.fillRect(QRect(self.width() * 0.5, self.height() - 4, v * self.width() * 0.5, 4), self._color if v > 0 else QColor(255, 0, 0))
        p.end()
