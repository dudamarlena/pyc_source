...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/search.py
...
class SearchFindWidget(QWidget, object):
    ...
    def _popup_menu(self):
        if self._search_menu:
            ...
            y = rect.bottom() if self._search_btn.mapToGlobal(QPoint(0, rect.bottom())).y() + size_hint.height() <= screen_rect.height() else top_diff
