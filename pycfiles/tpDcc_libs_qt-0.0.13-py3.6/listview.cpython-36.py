...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/library/listview.py
# Compiled at: 2020-05-13 19:31:15
# Size of source mod 2**32: 17055 bytes
"""
...
class LibraryListView(mixin.LibraryViewWidgetMixin, QListView):
    ...
    def mousePressEvent(self, event):
        ...
        if is_left_button:
            if is_selection_empty or not is_item_draggable:
    ...
    def rubber_band_move_event(self, event):
        ...
        """
        if self.rubber_band():
            if self._rubber_band_start_pos:
