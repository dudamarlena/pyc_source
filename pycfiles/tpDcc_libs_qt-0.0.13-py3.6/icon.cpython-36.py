...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/core/icon.py
# Compiled at: 2020-05-13 19:31:15
# Size of source mod 2**32: 9446 bytes
"""
...
class Icon(QIcon, object):
    ...
    def state_icon(cls, path, **kwargs):
        ...
        valid_options = [
         ...
         'color_off_active',
         'color_off_disabled']
        default = {'on_active':kwargs.get('active', px.Pixmap(path)), 
        ...
        options = {QIcon.On: {QIcon.Normal: (kwargs['color_on'], kwargs['on']), 
         ...
         QIcon.Off: {QIcon.Normal: (kwargs['color_off'], kwargs['off']), 
...
def colorize_layered_icon(icons, size, colors=None, icon_scaling=None, tint_color=None, tint_composition=QPainter.CompositionMode_Plus, grayscale=False):
    """
