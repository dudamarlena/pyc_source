...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/library/library.py
# Compiled at: 2020-05-13 19:31:15
# Size of source mod 2**32: 19809 bytes
"""
...
class Library(QObject, object):
    ...
    def create_items(self):
        ...
        if self.is_dirty():
            data = self.read()
            paths = data.keys()
            items = self._library_window.manager().items_from_paths(paths=paths,
              library=self,
