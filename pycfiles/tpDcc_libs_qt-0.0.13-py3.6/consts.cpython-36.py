...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/library/consts.py
...
DEFAULT_SETTINGS = {'library':{'sortBy':[
   'name:asc'], 
  'groupBy':[
   'category:asc']}, 
 'paneSizes':[
 ...
 'itemsWidget':{'spacing':2, 
  'padding':6, 
  'zoomAmount':80, 
  'textVisible':True}, 
 'searchWidget':{'text': ''}, 
 'filterByMenu':{'Folder': False}, 
 'theme':{'accentColor':'rgb(0, 175, 240, 255)', 
