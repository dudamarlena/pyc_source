...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/library/viewer.py
# Compiled at: 2020-05-13 19:31:15
# Size of source mod 2**32: 34959 bytes
"""
...
class LibraryViewer(base.BaseWidget, object):
    ...
    def set_column_labels(self, labels):
        ...
        labels = [x for x in labels if x.strip() if not (x in labels_set or set_add(x))]
