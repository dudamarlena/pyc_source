...
# [GCC 8.4.0]
# Embedded file name: /Users/lbusoni/git/palpao/test/client/deformable_mirror_client_test.py
# Compiled at: 2018-10-01 17:20:21
...
class TesterRpcHandler(DummyRpcHandler):
    ...
    def wantsPickable(self, objToReturnWithReceivePickable):
        self._objToReturnWithReceivePickable = objToReturnWithReceivePickable
...
class DeformableMirrorClientTest(unittest.TestCase):
    ...
    def testSetShape(self):
        ...
        self.assertEqual(self._rpc.getLastSendRequestArguments(), (
    ...
    def testGetStatus(self):
        wantedInstrumentStatus = DeformableMirrorStatus(12, 34, 'foo', 'tux')
        self._rpc.wantsPickable(wantedInstrumentStatus)
        timeoutInSec = 22
        gotInstrumentStatus = self._client.getStatus(timeoutInSec)
        self.assertEqual(wantedInstrumentStatus, gotInstrumentStatus)
        self.assertEqual(self._rpc.getLastReceivePickableArguments(), (
