...
# [GCC 8.4.0]
# Embedded file name: C:\Users\sboon\AppData\Local\Temp\pip-install-ptdbtr91\quarchpy\quarchpy\connection_specific\serial\serialutil.py
# Compiled at: 2020-03-25 05:10:07
# Size of source mod 2**32: 21692 bytes
import io, time
try:
    memoryview
...
CR = to_bytes([13])
LF = to_bytes([10])
PARITY_NONE, PARITY_EVEN, PARITY_ODD, PARITY_MARK, PARITY_SPACE = ('N', 'E', 'O', 'M',
                                                                   'S')
