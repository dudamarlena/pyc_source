...
# [GCC 8.4.0]
# Embedded file name: C:\Users\sboon\AppData\Local\Temp\pip-install-ptdbtr91\quarchpy\quarchpy\connection_specific\serial\tools\list_ports_osx.py
...
def get_int_property(device_type, property, cf_number_type):
    ...
    if CFContainer:
        if cf_number_type == kCFNumberSInt32Type:
            ...
            if cf_number_type == kCFNumberSInt16Type:
