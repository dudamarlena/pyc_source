...
# Embedded file name: build/bdist.linux-x86_64/egg/bridgedb/schedule.py
# Compiled at: 2015-11-05 10:40:17
__doc__ = 'This module implements functions for dividing time into chunks.\n\n.. inheritance-diagram:: UnknownInterval Unscheduled ScheduledInterval\n    :parts: 1\n'
...
class ISchedule(interface.Interface):
    ...
    intervalPeriod = Attribute("The type of period which this Schedule's intervals will rotate by.")
    intervalCount = Attribute('Number of **intervalPeriod**s before rotation to the next interval')
    ...
    def _setIntervalPeriod(self, period=None):
        ...
        try:
            ...
            if period.endswith('s'):
                period = period[:-1]
            if period not in KNOWN_INTERVALS:
                raise ValueError
