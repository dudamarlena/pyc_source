...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/devproxy/tests/utils.py
...
class ProxyTestCase(TestCase):
    timeout = 1
    nokia_ua = 'Nokia3100/1.0 (02.70) Profile/MIDP-1.0 Configuration/CLDC-1.0'
    iphone_ua = 'Mozilla/5.0 (iPhone; U; CPU iPhone OS 2_2_1 like Mac OS X; en-us) AppleWebKit/525.18.1 (KHTML, like Gecko) Version/3.1.1 Mobile/5H11 Safari/525.20'
    ...
    def start_proxy(self, handlers):
        proxy = ReverseProxyResource(handlers, '/_debug', '/_health', '/_echo', self.mocked_backend.addr.host, self.mocked_backend.addr.port, '')
...
class TestHandler(BaseHandler):
    ...
    def __init__(self, header_callback=None, cookie_callback=None, debug_callback=None, echo_callback=None):
        noop = lambda _: None
