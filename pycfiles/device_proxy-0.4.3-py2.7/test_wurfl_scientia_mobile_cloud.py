...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/devproxy/tests/test_wurfl_scientia_mobile_cloud.py
# Compiled at: 2014-07-28 10:42:31
import hashlib
from twisted.internet.defer import inlineCallbacks, succeed
from devproxy.handlers.wurfl_handler.scientia_mobile_cloud_resolution import ScientiaMobileCloudResolutionTestHandler
...
class WurlfHandlerTestCase(ProxyTestCase):
    ...
    def setUp(self):
        ...
        self.patch(ScientiaMobileCloudResolutionTestHandler, 'get_device_from_smcloud', self.patch_get_device_from_smcloud)
        self.patch(ScientiaMobileCloudResolutionTestHandler, 'memcached', self.fake_memcached)
        self.patch(ScientiaMobileCloudResolutionTestHandler, 'connect_to_memcached', lambda _: succeed(True))
        self.wurfl_handlers = yield self.start_handlers([
         ScientiaMobileCloudResolutionTestHandler({'header_name': 'X-UA-header', 
            'cache_prefix': 'prefix', 
        ...
        self.mock_response(self.nokia_ua, {'capabilities': {'resolution_width': 200}})
        self.mock_response(self.iphone_ua, {'capabilities': {'resolution_width': 500}})
    ...
    def test_wurfl_nokia_lookup(self):
        ...
        response = yield http.request(url, headers={'User-Agent': self.nokia_ua})
    ...
    def test_caching_prefix(self):
        ...
        self.assertEqual(cache_key, 'prefix_%s_%s' % (
         namespace_version,
