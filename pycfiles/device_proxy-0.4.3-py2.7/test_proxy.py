...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/devproxy/tests/test_proxy.py
# Compiled at: 2014-07-28 10:42:31
from twisted.internet import defer
from twisted.internet.defer import inlineCallbacks
from devproxy.utils import http
from devproxy.tests.utils import HeaderHandler, CookieHandler, DebugHandler, EchoHandler, ProxyTestCase
