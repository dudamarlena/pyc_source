...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/django_evolution/tests/test_delete_model.py
...
class DeleteModelTests(EvolutionTestCase):
    ...
    def test_delete_model(self):
        ...
        self.perform_evolution_tests(None, [
         DeleteModel('BasicModel')], 'The model tests.BasicModel has been deleted', [
         "DeleteModel('BasicModel')"], 'BasicModel', end_sig=end_sig, end=end)
        return
    ...
    def test_delete_model_with_m2m_field(self):
        ...
        self.set_base_model(BasicWithM2MModel, name='BasicWithM2MModel', extra_models=[
         (
        ...
        self.perform_evolution_tests(None, [
         DeleteModel('BasicWithM2MModel')], 'The model tests.BasicWithM2MModel has been deleted', [
         "DeleteModel('BasicWithM2MModel')"], 'BasicWithM2MModel', end_sig=end_sig, end=end)
        return
    ...
    def test_delete_model_with_custom_table(self):
        ...
        self.perform_evolution_tests(None, [
         DeleteModel('CustomTableModel')], 'The model tests.CustomTableModel has been deleted', [
         "DeleteModel('CustomTableModel')"], 'CustomTableModel', end_sig=end_sig, end=end)
        return
    ...
    def test_delete_model_with_custom_table_and_m2m_field(self):
        ...
        self.set_base_model(CustomTableWithM2MModel, name='CustomTableWithM2MModel', extra_models=[
         (
          'DeleteModelAnchor', DeleteModelAnchor)])
        end_sig = self.copy_sig(self.start_sig)
        end = self.copy_models(self.start)
        ...
        self.perform_evolution_tests(None, [
         DeleteModel('CustomTableWithM2MModel')], 'The model tests.CustomTableWithM2MModel has been deleted', [
         "DeleteModel('CustomTableWithM2MModel')"], 'CustomTableWithM2MModel', end_sig=end_sig, end=end)
        return
    ...
    def test_delete_model_with_custom_database(self):
        ...
        self.perform_evolution_tests(None, [
         DeleteModel('BasicModel')], 'The model tests.BasicModel has been deleted', [
         "DeleteModel('BasicModel')"], 'BasicModel', end_sig=end_sig, end=end, db_name='db_multi')
        return