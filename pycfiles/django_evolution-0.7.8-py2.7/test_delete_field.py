...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/django_evolution/tests/test_delete_field.py
...
class DeleteFieldTests(EvolutionTestCase):
    ...
    def test_delete(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('TestModel', 'int_field')], "In model tests.TestModel:\n    Field 'int_field' has been deleted", [
         "DeleteField('TestModel', 'int_field')"], 'DefaultNamedColumnModel')
    ...
    def test_delete_with_custom_column_name(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('TestModel', 'int_field2')], "In model tests.TestModel:\n    Field 'int_field2' has been deleted", [
         "DeleteField('TestModel', 'int_field2')"], 'NonDefaultNamedColumnModel')
    ...
    def test_delete_with_unique(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('TestModel', 'int_field3')], "In model tests.TestModel:\n    Field 'int_field3' has been deleted", [
         "DeleteField('TestModel', 'int_field3')"], 'ConstrainedColumnModel')
    ...
    def test_delete_many_to_many_field(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('TestModel', 'm2m_field1')], "In model tests.TestModel:\n    Field 'm2m_field1' has been deleted", [
         "DeleteField('TestModel', 'm2m_field1')"], 'DefaultManyToManyModel')
    ...
    def test_delete_many_to_many_field_custom_table(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('TestModel', 'm2m_field2')], "In model tests.TestModel:\n    Field 'm2m_field2' has been deleted", [
         "DeleteField('TestModel', 'm2m_field2')"], 'NonDefaultManyToManyModel')
    ...
    def test_delete_foreign_key(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('TestModel', 'fk_field1')], "In model tests.TestModel:\n    Field 'fk_field1' has been deleted", [
         "DeleteField('TestModel', 'fk_field1')"], 'DeleteForeignKeyModel')
    ...
    def test_delete_column_from_custom_table(self):
        ...
        self.perform_evolution_tests(DestModel, [
         DeleteField('CustomTableModel', 'value')], "In model tests.CustomTableModel:\n    Field 'value' has been deleted", [
         "DeleteField('CustomTableModel', 'value')"], 'DeleteColumnCustomTableModel', model_name='CustomTableModel')