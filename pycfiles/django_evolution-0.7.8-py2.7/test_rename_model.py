...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/django_evolution/tests/test_rename_model.py
...
class RenameModelTests(EvolutionTestCase):
    ...
    def test_rename(self):
        ...
        self.perform_evolution_tests(DestModel, [
         RenameModel('TestModel', 'DestModel', db_table='tests_destmodel')], 'The model tests.TestModel has been deleted', [
         "DeleteModel('TestModel')"], 'RenameModel', model_name='DestModel')
    ...
    def test_rename_unchanged_db_table(self):
        ...
        self.perform_evolution_tests(DestModel, [
         RenameModel('TestModel', 'DestModel', db_table='tests_testmodel')], 'The model tests.TestModel has been deleted', [
         "DeleteModel('TestModel')"], 'RenameModelSameTable', model_name='DestModel')
    ...
    def test_rename_updates_foreign_key_refs(self):
        ...
        end_sig['tests']['RefModel']['fields']['my_ref']['related_model'] = 'tests.DestModel'
        self.perform_evolution_tests(DestModel, [
         RenameModel('TestModel', 'DestModel', db_table='tests_destmodel')], "The model tests.TestModel has been deleted\nIn model tests.RefModel:\n    In field 'my_ref':\n        Property 'related_model' has changed", [
         "ChangeField('RefModel', 'my_ref', initial=None, related_model='tests.DestModel')",
         "DeleteModel('TestModel')"], 'RenameModelForeignKeys', end=end, end_sig=end_sig)
    ...
    def test_rename_updates_foreign_key_refs_unchanged_db_table(self):
        ...
        self.perform_evolution_tests(DestModel, [
         RenameModel('TestModel', 'DestModel', db_table='tests_testmodel')], "The model tests.TestModel has been deleted\nIn model tests.RefModel:\n    In field 'my_ref':\n        Property 'related_model' has changed", [
         "ChangeField('RefModel', 'my_ref', initial=None, related_model='tests.DestModel')",
         "DeleteModel('TestModel')"], 'RenameModelForeignKeysSameTable', end=end, end_sig=end_sig)
    ...
    def test_rename_updates_m2m_refs(self):
        ...
        self.perform_evolution_tests(DestModel, [
         RenameModel('TestModel', 'DestModel', db_table='tests_destmodel')], "The model tests.TestModel has been deleted\nIn model tests.RefModel:\n    In field 'my_ref':\n        Property 'related_model' has changed", [
         "ChangeField('RefModel', 'my_ref', initial=None, related_model='tests.DestModel')",
         "DeleteModel('TestModel')"], 'RenameModelManyToManyField', end=end, end_sig=end_sig)
    ...
    def test_rename_updates_m2m_refs_unchanged_db_table(self):
        ...
        self.perform_evolution_tests(DestModel, [
         RenameModel('TestModel', 'DestModel', db_table='tests_testmodel')], "The model tests.TestModel has been deleted\nIn model tests.RefModel:\n    In field 'my_ref':\n        Property 'related_model' has changed", [
         "ChangeField('RefModel', 'my_ref', initial=None, related_model='tests.DestModel')",
         "DeleteModel('TestModel')"], 'RenameModelManyToManyFieldSameTable', end=end, end_sig=end_sig)