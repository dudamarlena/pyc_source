...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/django_evolution/tests/db/sqlite3.py
...
add_field = {'AddNonNullNonCallableColumnModel': ('\n').join([
   ...
   'AddManyToManySelf': ('\n').join([
                       ...
                       ')',
                       ';'])}
delete_field = {'DefaultNamedColumnModel': ('\n').join([
                             ...
                             'CREATE INDEX "%s" ON "tests_testmodel" ("fk_field1_id");' % generate_index_name('tests_testmodel', 'fk_field1_id', 'fk_field1'),
...
change_field = {'SetNotNullChangeModelWithConstant': ('\n').join([
   ...
   'DBColumnChangeModel': ('\n').join([
                         ...
                         'CREATE INDEX "%s" ON "tests_testmodel" ("int_field1");' % generate_index_name('tests_testmodel', 'int_field1'),
   ...
   'RemoveDBIndexChangeModel': 'DROP INDEX "%s";' % generate_index_name('tests_testmodel', 'int_field1'), 
...
rename_field = {'RenameColumnModel': ('\n').join([
                       ...
                       'CREATE INDEX "%s" ON "tests_testmodel" ("custom_db_col_name_indexed");' % generate_index_name('tests_testmodel', 'custom_db_col_name_indexed', 'int_field_named_indexed'),
                       'CREATE INDEX "%s" ON "tests_testmodel" ("fk_field_id");' % generate_index_name('tests_testmodel', 'fk_field_id', 'fk_field'),
   ...
   'RenameForeignKeyColumnModel': ('\n').join([
                                 ...
                                 'CREATE INDEX "%s" ON "tests_testmodel"  ("custom_db_col_name_indexed");' % generate_index_name('tests_testmodel', 'custom_db_col_name_indexed'),
                                 'CREATE INDEX "%s" ON "tests_testmodel" ("renamed_field_id");' % generate_index_name('tests_testmodel', 'renamed_field_id'),
   ...
   'RenameNonDefaultColumnNameModel': ('\n').join([
                                     'CREATE TEMPORARY TABLE "TEMP_TABLE"("int_field" integer NULL, "char_field" varchar(20) NULL, "renamed_field" integer NULL, "custom_db_col_name_indexed" integer NULL, "fk_field_id" integer NULL, "id" integer NULL UNIQUE PRIMARY KEY);',
                                     'INSERT INTO "TEMP_TABLE" ("int_field", "char_field", "renamed_field", "custom_db_col_name_indexed", "fk_field_id", "id") SELECT "int_field", "char_field", "custom_db_col_name", "custom_db_col_name_indexed", "fk_field_id", "id" FROM "tests_testmodel";',
                                     'DROP TABLE "tests_testmodel";',
   ...
   'RenameNonDefaultColumnNameToNonDefaultNameModel': ('\n').join([
                                                     'CREATE TEMPORARY TABLE "TEMP_TABLE"("int_field" integer NULL, "char_field" varchar(20) NULL, "non-default_column_name" integer NULL, "custom_db_col_name_indexed" integer NULL, "fk_field_id" integer NULL, "id" integer NULL UNIQUE PRIMARY KEY);',
                                                     'INSERT INTO "TEMP_TABLE" ("int_field", "char_field", "non-default_column_name", "custom_db_col_name_indexed", "fk_field_id", "id") SELECT "int_field", "char_field", "custom_db_col_name", "custom_db_col_name_indexed", "fk_field_id", "id" FROM "tests_testmodel";',
                                                     'DROP TABLE "tests_testmodel";',
   ...
   'RenameNonDefaultColumnNameToNonDefaultNameAndTableModel': ('\n').join([
                                                             'CREATE TEMPORARY TABLE "TEMP_TABLE"("int_field" integer NULL, "char_field" varchar(20) NULL, "non-default_column_name2" integer NULL, "custom_db_col_name_indexed" integer NULL, "fk_field_id" integer NULL, "id" integer NULL UNIQUE PRIMARY KEY);',
                                                             'INSERT INTO "TEMP_TABLE" ("int_field", "char_field", "non-default_column_name2", "custom_db_col_name_indexed", "fk_field_id", "id") SELECT "int_field", "char_field", "custom_db_col_name", "custom_db_col_name_indexed", "fk_field_id", "id" FROM "tests_testmodel";',
                                                             'DROP TABLE "tests_testmodel";',
   ...
   'RenameColumnCustomTableModel': ('\n').join([
                                  ...
                                  'DROP TABLE "TEMP_TABLE";']), 
   'RenameManyToManyTableModel': 'ALTER TABLE "tests_testmodel_m2m_field" RENAME TO "tests_testmodel_renamed_field";', 
   'RenameManyToManyTableWithColumnNameModel': 'ALTER TABLE "tests_testmodel_m2m_field" RENAME TO "tests_testmodel_renamed_field";', 
...
generics = {'DeleteColumnModel': ('\n').join([
                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("int_field" integer NULL, "content_type_id" integer NULL, "id" integer NULL UNIQUE PRIMARY KEY, "object_id" integer unsigned NULL);',
                       'INSERT INTO "TEMP_TABLE" ("int_field", "content_type_id", "id", "object_id") SELECT "int_field", "content_type_id", "id", "object_id" FROM "tests_testmodel";',
                       'DROP TABLE "tests_testmodel";',
                       ...
                       'CREATE INDEX "%s" ON "tests_testmodel" ("content_type_id");' % generate_index_name('tests_testmodel', 'content_type_id', 'content_type'),
                       'CREATE INDEX "%s" ON "tests_testmodel" ("object_id");' % generate_index_name('tests_testmodel', 'object_id'),
...
unique_together = {'setting_from_empty': ('\n').join([
                        'CREATE UNIQUE INDEX "%s" ON "tests_testmodel" ("int_field1", "char_field1");' % generate_index_name('tests_testmodel', ['int_field1', 'char_field1'], default=False)]), 
   'replace_list': ('\n').join([
                  'CREATE TEMPORARY TABLE "TEMP_TABLE"("char_field1" varchar(20) NULL, "char_field2" varchar(40) NULL, "id" integer NULL UNIQUE PRIMARY KEY, "int_field2" integer NULL, "int_field1" integer NULL);',
                  'INSERT INTO "TEMP_TABLE" ("char_field1", "char_field2", "id", "int_field2", "int_field1") SELECT "char_field1", "char_field2", "id", "int_field2", "int_field1" FROM "tests_testmodel";',
                  'DROP TABLE "tests_testmodel";',
                  'CREATE TABLE "tests_testmodel"("char_field1" varchar(20) NOT NULL, "char_field2" varchar(40) NOT NULL, "id" integer NOT NULL UNIQUE PRIMARY KEY, "int_field2" integer NOT NULL, "int_field1" integer NOT NULL);',
                  'INSERT INTO "tests_testmodel" ("char_field1", "char_field2", "id", "int_field2", "int_field1") SELECT "char_field1", "char_field2", "id", "int_field2", "int_field1" FROM "TEMP_TABLE";',
                  'DROP TABLE "TEMP_TABLE";',
...
preprocessing = {'add_change_field': ('\n').join([
                      'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "added_field" varchar(50) NULL);',
                      'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                      'UPDATE "TEMP_TABLE" SET "added_field" = \'bar\';',
                      'DROP TABLE "tests_testmodel";',
                      'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "added_field" varchar(50) NULL);',
                      'INSERT INTO "tests_testmodel" ("my_id", "char_field", "added_field") SELECT "my_id", "char_field", "added_field" FROM "TEMP_TABLE";',
                      'DROP TABLE "TEMP_TABLE";']), 
   'add_change_rename_field': ('\n').join([
                             'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "renamed_field" varchar(50) NULL);',
                             'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                             'UPDATE "TEMP_TABLE" SET "renamed_field" = \'bar\';',
                             'DROP TABLE "tests_testmodel";',
                             'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "renamed_field" varchar(50) NULL);',
                             'INSERT INTO "tests_testmodel" ("my_id", "char_field", "renamed_field") SELECT "my_id", "char_field", "renamed_field" FROM "TEMP_TABLE";',
                             'DROP TABLE "TEMP_TABLE";']), 
   'add_delete_add_field': ('\n').join([
                          'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "added_field" integer NULL);',
                          'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                          'UPDATE "TEMP_TABLE" SET "added_field" = 42;',
                          'DROP TABLE "tests_testmodel";',
                          'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "added_field" integer NOT NULL);',
                          'INSERT INTO "tests_testmodel" ("my_id", "char_field", "added_field") SELECT "my_id", "char_field", "added_field" FROM "TEMP_TABLE";',
                          'DROP TABLE "TEMP_TABLE";']), 
   'add_delete_add_rename_field': ('\n').join([
                                 'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "renamed_field" integer NULL);',
                                 'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                                 'UPDATE "TEMP_TABLE" SET "renamed_field" = 42;',
                                 'DROP TABLE "tests_testmodel";',
                                 'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "renamed_field" integer NOT NULL);',
                                 'INSERT INTO "tests_testmodel" ("my_id", "char_field", "renamed_field") SELECT "my_id", "char_field", "renamed_field" FROM "TEMP_TABLE";',
                                 'DROP TABLE "TEMP_TABLE";']), 
   ...
   'add_field_rename_model': ('\n').join([
                            'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "added_field_id" integer NULL);',
                            'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                            'DROP TABLE "tests_testmodel";',
                            'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "added_field_id" integer NULL);',
                            'INSERT INTO "tests_testmodel" ("my_id", "char_field", "added_field_id") SELECT "my_id", "char_field", "added_field_id" FROM "TEMP_TABLE";',
                            'DROP TABLE "TEMP_TABLE";',
                            'CREATE INDEX "tests_testmodel_2d9d1ab4" ON "tests_testmodel" ("added_field_id");']), 
   'add_rename_field_rename_model': ('\n').join([
                                   'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "renamed_field_id" integer NULL);',
                                   'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                                   'DROP TABLE "tests_testmodel";',
                                   'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "renamed_field_id" integer NULL);',
                                   'INSERT INTO "tests_testmodel" ("my_id", "char_field", "renamed_field_id") SELECT "my_id", "char_field", "renamed_field_id" FROM "TEMP_TABLE";',
                                   'DROP TABLE "TEMP_TABLE";',
                                   'CREATE INDEX "tests_testmodel_182b6181" ON "tests_testmodel" ("renamed_field_id");']), 
   'add_sql_delete': ('\n').join([
                    'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL, "added_field" varchar(20) NULL);',
                    'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                    'UPDATE "TEMP_TABLE" SET "added_field" = \'foo\';',
                    'DROP TABLE "tests_testmodel";',
                    'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL, "added_field" varchar(20) NOT NULL);',
                    'INSERT INTO "tests_testmodel" ("my_id", "char_field", "added_field") SELECT "my_id", "char_field", "added_field" FROM "TEMP_TABLE";',
                    'DROP TABLE "TEMP_TABLE";',
                    '-- Comment --',
                    'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL);',
                    'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                    'DROP TABLE "tests_testmodel";',
                    'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NOT NULL);',
                    'INSERT INTO "tests_testmodel" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "TEMP_TABLE";',
                    'DROP TABLE "TEMP_TABLE";']), 
   'change_rename_field': ('\n').join([
                         'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL);',
                         'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                         'DROP TABLE "tests_testmodel";',
                         'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(20) NULL);',
                         'INSERT INTO "tests_testmodel" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "TEMP_TABLE";',
                         'DROP TABLE "TEMP_TABLE";',
                         'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NULL);',
                         'INSERT INTO "TEMP_TABLE" ("my_id", "renamed_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                         'DROP TABLE "tests_testmodel";',
                         'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NULL);',
                         'INSERT INTO "tests_testmodel" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "TEMP_TABLE";',
                         'DROP TABLE "TEMP_TABLE";']), 
   'change_rename_change_rename_field': ('\n').join([
                                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(30) NULL);',
                                       'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                                       'DROP TABLE "tests_testmodel";',
                                       'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(30) NOT NULL);',
                                       'INSERT INTO "tests_testmodel" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "TEMP_TABLE";',
                                       'DROP TABLE "TEMP_TABLE";',
                                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "char_field" varchar(30) NULL);',
                                       'INSERT INTO "TEMP_TABLE" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                                       'DROP TABLE "tests_testmodel";',
                                       'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "char_field" varchar(30) NULL);',
                                       'INSERT INTO "tests_testmodel" ("my_id", "char_field") SELECT "my_id", "char_field" FROM "TEMP_TABLE";',
                                       'DROP TABLE "TEMP_TABLE";',
                                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(30) NULL);',
                                       'INSERT INTO "TEMP_TABLE" ("my_id", "renamed_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                                       'DROP TABLE "tests_testmodel";',
                                       'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(30) NULL);',
                                       'INSERT INTO "tests_testmodel" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "TEMP_TABLE";',
                                       'DROP TABLE "TEMP_TABLE";']), 
   'delete_char_field': ('\n').join([
                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY);',
                       'INSERT INTO "TEMP_TABLE" ("my_id") SELECT "my_id" FROM "tests_testmodel";',
                       'DROP TABLE "tests_testmodel";',
                       'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY);',
                       'INSERT INTO "tests_testmodel" ("my_id") SELECT "my_id" FROM "TEMP_TABLE";',
                       'DROP TABLE "TEMP_TABLE";']), 
   'rename_add_field': ('\n').join([
                      'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NULL);',
                      'INSERT INTO "TEMP_TABLE" ("my_id", "renamed_field") SELECT "my_id", "char_field" FROM "tests_testmodel";',
                      'DROP TABLE "tests_testmodel";',
                      'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NOT NULL);',
                      'INSERT INTO "tests_testmodel" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "TEMP_TABLE";',
                      'DROP TABLE "TEMP_TABLE";',
                      'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NULL, "char_field" varchar(50) NULL);',
                      'INSERT INTO "TEMP_TABLE" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "tests_testmodel";',
                      'DROP TABLE "tests_testmodel";',
                      'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NOT NULL, "char_field" varchar(50) NULL);',
                      'INSERT INTO "tests_testmodel" ("my_id", "renamed_field", "char_field") SELECT "my_id", "renamed_field", "char_field" FROM "TEMP_TABLE";',
                      'DROP TABLE "TEMP_TABLE";']), 
   'rename_change_rename_change_field': ('\n').join([
                                       ...
                                       'INSERT INTO "tests_testmodel" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "TEMP_TABLE";',
                                       'DROP TABLE "TEMP_TABLE";',
                                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(50) NULL);',
                                       'INSERT INTO "TEMP_TABLE" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "tests_testmodel";',
                                       'DROP TABLE "tests_testmodel";',
                                       'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(50) NOT NULL);',
                                       'INSERT INTO "tests_testmodel" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "TEMP_TABLE";',
                                       'DROP TABLE "TEMP_TABLE";',
                                       'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(50) NULL);',
                                       'INSERT INTO "TEMP_TABLE" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "tests_testmodel";',
                                       'DROP TABLE "tests_testmodel";',
                                       'CREATE TABLE "tests_testmodel"("my_id" integer NOT NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(50) NULL);',
                                       'INSERT INTO "tests_testmodel" ("my_id", "renamed_field") SELECT "my_id", "renamed_field" FROM "TEMP_TABLE";',
                                       'DROP TABLE "TEMP_TABLE";']), 
   'rename_rename_field': ('\n').join([
                         'CREATE TEMPORARY TABLE "TEMP_TABLE"("my_id" integer NULL UNIQUE PRIMARY KEY, "renamed_field" varchar(20) NULL);',
