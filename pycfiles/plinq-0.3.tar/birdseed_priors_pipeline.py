...
# Embedded file name: build/bdist.macosx-10.6-i386/egg/birdsuitepriors/birdseed/birdseed_priors_pipeline.py
...
import optparse, os, sys, mpgutils.utils as utils, mpgutils.filterMatrix as filterMatrix, mpgutils.fk_utils as fk_utils
...
def main(argv=None):
    ...
    if not os.path.exists(dctOptions.tempDir):
        os.makedirs(dctOptions.tempDir)
