...
# Embedded file name: build/bdist.macosx-10.6-i386/egg/hapmap3/extract_intensity_sanger_format.py
# Compiled at: 2010-07-13 12:32:46
__doc__ = '%prog [-o outputfile -m metaDataFile -s sampleMap] <allele_summary>\n\nRead the allele summary file as produced by cel2cn_allele.py, and write a sanger format intensity file.\n'
...
def main(argv=None):
    ...
    parser.add_option('-m', '--metaData', dest='metaData', help='The SNP meta data File')
    parser.add_option('-s', '--sampleMap', dest='sampleMap', help='The sample map file')
