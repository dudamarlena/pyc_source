...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pylocator/screenshot_props.py
# Compiled at: 2012-04-18 09:05:41
import gtk
...
class ScreenshotProps(gtk.VBox):
    ...
    def create_buttons(self):
        ...
        for i, st in enumerate(self._sts):
            label, button = insert_row(st.screenshot_button_label, cameraPixBuf, i + 1)
