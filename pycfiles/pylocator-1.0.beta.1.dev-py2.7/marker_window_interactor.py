...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pylocator/marker_window_interactor.py
# Compiled at: 2012-04-18 08:56:56
import gtk, vtk
...
class MarkerWindowInteractor(PyLocatorRenderWindow):
    ...
    def __init__(self):
        ...
        self.pressFuncs = {1: self._Iren.LeftButtonPressEvent, 2: self._Iren.MiddleButtonPressEvent, 
           3: self._Iren.RightButtonPressEvent}
        self.releaseFuncs = {1: self._Iren.LeftButtonReleaseEvent, 2: self._Iren.MiddleButtonReleaseEvent, 
    ...
    def set_mouse1_to_interact(self):
        ...
        try:
            del self.pressHooks[1]
        except KeyError:
            pass

        try:
            del self.releaseHooks[1]
        except KeyError:
            pass
    ...
    def set_mouse1_to_color(self):
        ...
        def button_down(*args):
            ...
            if marker is None:
                ...
                UndoRegistry().push_command(EventHandler().notify, 'color marker', marker, oldColor)
    ...
    def get_plane_points(self, pw):
        return (
         pw.GetOrigin(), pw.GetPoint1(), pw.GetPoint2())
