...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/tmsg/tmsg.py
# Compiled at: 2018-02-23 18:31:41
# Size of source mod 2**32: 6031 bytes
import sys, os, curses, time, threading, logging
    ...
    def refresh(self):
        ...
        for i in range(min(len(messages), max_messages)):
            ...
            while remaining_text != '':
                ...
                curr += 1
                if curr == 2:
                    if len(remaining_text) > max_message_width:
