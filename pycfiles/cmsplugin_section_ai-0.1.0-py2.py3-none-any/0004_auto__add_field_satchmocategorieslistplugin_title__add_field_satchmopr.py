...
# Embedded file name: /home/tomas/prace/vyvoj/cmsplugin_satchmo/cmsplugin_satchmo/migrations/0004_auto__add_field_satchmocategorieslistplugin_title__add_field_satchmopr.py
# Compiled at: 2014-06-18 11:09:26
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_satchmocategorieslistplugin', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
        db.add_column('cmsplugin_satchmoproductslistplugin', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_satchmocategorieslistplugin', 'title')
        db.delete_column('cmsplugin_satchmoproductslistplugin', 'title')
