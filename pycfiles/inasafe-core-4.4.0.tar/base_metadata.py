...
# [GCC 8.4.0]
# Embedded file name: /Users/ismailsunni/.qgis2/python/plugins/inasafe/safe/metadata/base_metadata.py
...
from safe.metadata.utilities import XML_NS, insert_xml_element, read_property_from_xml, reading_ancillary_files
...
class BaseMetadata(object):
    ...
    _standard_properties = {'organisation': 'gmd:contact/gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString', 
       ...
       'license': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints/gmd:MD_Constraints/gmd:useLimitation/gco:CharacterString', 
       'url': 'gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:linkage/gmd:URL', 
       'layer_purpose': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/layer_purpose/gco:CharacterString', 
       'layer_mode': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/layer_mode/gco:CharacterString', 
       'layer_geometry': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/layer_geometry/gco:CharacterString', 
       'keyword_version': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/keyword_version/gco:CharacterString', 
       'scale': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/scale/gco:CharacterString', 
       'source': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/source/gco:CharacterString', 
       'inasafe_fields': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/inasafe_fields/gco:Dictionary', 
       'inasafe_default_values': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/inasafe_default_values/gco:Dictionary', 
       'extra_keywords': 'gmd:identificationInfo/gmd:MD_DataIdentification/gmd:supplementalInformation/inasafe/extra_keywords/gco:Dictionary'}
    ...
    def json(self):
        ...
        :rtype: str
        """
        json_dumps = json.dumps(self.dict, indent=2, sort_keys=True, separators=(',',
                                                                                 ': '), cls=MetadataEncoder)
    ...
    def write_to_db(self, save_json=True, save_xml=True):
        ...
        self.db_io.write_metadata_for_uri(self.layer_uri, metadata_json, metadata_xml)
    ...
    def get_writable_metadata(self, file_format):
        ...
        if file_format == 'json':
            ...
            raise TypeError('The requested file type (%s) is not yet supported' % file_format)
        return metadata
