...
# [GCC 8.4.0]
# Embedded file name: /Users/ismailsunni/.qgis2/python/plugins/inasafe/safe/metadata/utilities.py
...
XML_NS = {'gmi': 'http://www.isotc211.org/2005/gmi', 
...
def prettify_xml(xml_str):
    ...
    pretty_xml = ('\n').join([ line for line in parsed_xml.toprettyxml(indent='  ', encoding='UTF-8').split('\n') if line.strip()
                             ])
