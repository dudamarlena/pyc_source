...
# [GCC 8.4.0]
# Embedded file name: /Users/ismailsunni/.qgis2/python/plugins/inasafe/safe/metadata/generic_layer_metadata.py
...
class GenericLayerMetadata(BaseMetadata):
    ...
    def __init__(self, layer_uri, xml_uri=None, json_uri=None):
        ...
        :type json_uri: str
        """
        super(GenericLayerMetadata, self).__init__(layer_uri, xml_uri, json_uri)
