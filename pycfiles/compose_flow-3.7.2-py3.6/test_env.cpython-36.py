...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_env.py
# Compiled at: 2020-05-06 10:05:57
# Size of source mod 2**32: 6437 bytes
import os, shlex
...
class EnvTestCase(BaseTestCase):
    ...
    def test_backend_from_app_config(self, *mocks):
        ...
        flow.app_config = {'remotes': {'dev': {'environment': {'backend': backend_name}}}}
