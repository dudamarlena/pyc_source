...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_docker_image.py
...
class DockerImageTestMixin:
    ...
    def _get_docker_image(self, tagged_image_name: str=None):
        ...
        return DockerImage(tagged_image_name=tagged_image_name,
          publish_callable=(mock.MagicMock()),
...
class DockerImageHappyPathTestCase(DockerImageTestMixin, TestCase):
    ...
    def test_ut_publish(self, *mocks):
        ...
        self.assertEqual(docker_image._publish_callable.call_args[0][0], docker_image._get_tagged_image_name(self._default_tag))
