...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_publish.py
...
class PublishTestCase(BaseTestCase):
    ...
    def test_publish_with_missing_env_vars(self, *mocks):
        ...
        flow.subcommand.push = mock.Mock()
        with mock.patch('compose_flow.commands.workflow.Workflow.profile',
          new_callable=(mock.PropertyMock)) as (profile_mock):
            flow.run()
