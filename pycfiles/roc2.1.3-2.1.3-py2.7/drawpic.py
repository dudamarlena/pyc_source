...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\ROC\drawpic.py
# Compiled at: 2018-08-10 08:20:40
...
def drawpic(pre_file='file', image='image', titlestr='roc'):
    ...
    plt.legend(bbox_to_anchor=(0.0, 1.08, 1.0, 0.102), loc=2, ncol=3, mode='expand', borderaxespad=0.0)
    plt.grid()
