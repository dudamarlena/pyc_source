...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/watchme/tests/test_client.py
...
class TestClient(unittest.TestCase):
    ...
    def test_watcher_task(self):
        ...
        self.cli.add_task('task-pancakes',
          'urls', params=['url@https://www.google.com'])
        ...
        print(params)
        correct = {'active':'true',  'type':'urls',  'url':'https://www.google.com'}
