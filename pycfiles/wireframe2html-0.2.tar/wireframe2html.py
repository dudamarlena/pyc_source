...
# [GCC 8.4.0]
# Embedded file name: /home/cbrun/Projets/Perso/projets/dev/wireframe2html/wireframe2html/wireframe2html.py
# Compiled at: 2014-07-29 16:25:49
import re
...
def handleWidgets(widget, env):
    ...
    if widget.getAttribute('xsi:type') == 'model:Master':
        ...
        content += subtemplate.render(attribute2param(widget), content=subcontent)
    return content
...
if __name__ == '__main__':
    parser = OptionParser()
    parser.add_option('-i', '--input', dest='inputfile', help='Screen Input File', metavar='FILE')
    parser.add_option('-s', '--screen', dest='inputscreen', help='Screen Input', metavar='Name')
    parser.add_option('-w', '--workspace', dest='workspace', help='Wireframesketcher workspace', metavar='Workspace')
    parser.add_option('-o', '--output', dest='outputDir', help='Output Dir', metavar='Directory')
