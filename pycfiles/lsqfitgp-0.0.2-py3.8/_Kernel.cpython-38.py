...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/lsqfitgp/_Kernel.py
# Compiled at: 2020-04-23 16:30:17
# Size of source mod 2**32: 18715 bytes
import sys, autograd
    ...
    def __init__(self, kernel, *, dim=None, loc=None, scale=None, forcebroadcast=False, forcekron=False, derivable=False, **kw):
        ...
        **kw :
        ...
        if isinstance(derivable, bool):
            ...
            if isinstance(derivable, (int, np.integer)):
                if not derivable >= 0:
    ...
    def diff(self, xderiv, yderiv):
        ...
        def fun(x, y):
            if x.dtype.names is not None:
                ...
                raise xderiv.implicit and yderiv.implicit or ValueError('explicit derivatives with non-structured array')
            if x.dtype.names is None:
                f = kernel
