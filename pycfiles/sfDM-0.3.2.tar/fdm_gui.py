...
# [GCC 8.4.0]
# Embedded file name: /home/rafa/Dropbox/ws_Python/VENV/FDM/DEV/sfDM/ui/fdm_gui.py
# Compiled at: 2018-03-28 11:35:43
...
class Top_Panel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        pid_label = wx.StaticText(self, -1, label='PID')
        self.pid_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        sizer.Add(pid_label, (0, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.pid_field, (0, 1), (1, 2), wx.ALIGN_LEFT, 10)
        parent_dir_label = wx.StaticText(self, -1, label='Parent Dir')
        self.parent_dir_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        parent_dir_button = wx.Button(self, -1, label='...')
        sizer.Add(parent_dir_label, (1, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.parent_dir_field, (1, 1), (1, 2), wx.EXPAND | wx.ALIGN_LEFT, 5)
        sizer.Add(parent_dir_button, (1, 3), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        self.Bind(wx.EVT_BUTTON, self.OnParDirButtonClick, parent_dir_button)
        struct_label = wx.StaticText(self, -1, label='Struct Brain')
        self.struct_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        struct_button = wx.Button(self, -1, label='...')
        tumor_center_label = wx.StaticText(self, -1, label='Tumor Center  ')
        tumor_center_x_label = wx.StaticText(self, -1, label='X ')
        self.tumor_center_x_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        tumor_center_y_label = wx.StaticText(self, -1, label=' Y ')
        self.tumor_center_y_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        tumor_center_z_label = wx.StaticText(self, -1, label=' Z ')
        self.tumor_center_z_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        sizer.Add(struct_label, (2, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.struct_field, (2, 1), (1, 2), wx.EXPAND | wx.ALIGN_LEFT, 5)
        sizer.Add(struct_button, (2, 3), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        self.Bind(wx.EVT_BUTTON, self.OnStructButtonClick, struct_button)
        coord_sizer = wx.BoxSizer(wx.HORIZONTAL)
        coord_sizer.Add(tumor_center_label, 0, wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        coord_sizer.Add(tumor_center_x_label, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        coord_sizer.Add(self.tumor_center_x_field, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        coord_sizer.Add(tumor_center_y_label, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        coord_sizer.Add(self.tumor_center_y_field, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        coord_sizer.Add(tumor_center_z_label, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        coord_sizer.Add(self.tumor_center_z_field, 0, wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(coord_sizer, (3, 1), (1, 2), wx.ALIGN_CENTER_VERTICAL, 5)
        self.treatment = wx.CheckBox(self, -1, label='Treatment', style=wx.ALIGN_RIGHT)
        vaccine_label = wx.StaticText(self, -1, label='Days post baseline', style=wx.ALIGN_LEFT)
        self.vaccine_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        threshold_label = wx.StaticText(self, -1, label='Threshold for CI (+/-)', style=wx.ALIGN_LEFT)
        self.thresh_field = wx.TextCtrl(self, -1, value='400', style=wx.TE_PROCESS_ENTER)
        self.grid = wx.CheckBox(self, -1, label='Use GridEngine', style=wx.ALIGN_RIGHT)
        self.nonlinear = wx.CheckBox(self, -1, label='Nonlinear Reg', style=wx.ALIGN_RIGHT)
        self.use_adc = wx.CheckBox(self, -1, label='Use ADC for Reg', style=wx.ALIGN_RIGHT)
        self.ref_space = wx.CheckBox(self, -1, label='ROI in Ref Space', style=wx.ALIGN_RIGHT)
        sizer.Add(self.treatment, (4, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(vaccine_label, (4, 1), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.vaccine_field, (4, 2), (1, 1), wx.ALIGN_LEFT, 5)
        sizer.Add(threshold_label, (4, 3), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.thresh_field, (4, 4), (1, 1), wx.ALIGN_LEFT, 5)
        sizer.Add(self.grid, (5, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.nonlinear, (5, 1), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.ref_space, (5, 2), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.use_adc, (5, 3), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.AddGrowableCol(1)
        box_sizer.Add(sizer, 0, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 5)
        self.SetSizer(box_sizer)

    def OnParDirButtonClick(self, event):
        dir_picker = wx.DirDialog(self, 'Choose dir', self.frame.default_dir)
    ...
    def OnStructButtonClick(self, event):
        wildcard = 'NIFTI image {*.nii}|*.nii|Compressed NIFTI {*.nii.gz}|*.nii.gz|All files {*.*}|*.*'
        file_picker = wx.FileDialog(self, 'Choose file', self.frame.default_dir, '', wildcard, wx.FD_OPEN)
...
class Scan_Panel(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent):
        scrolled.ScrolledPanel.__init__(self, parent, -1, style=wx.SIMPLE_BORDER)
        self.frame = parent
        self.number_of_scans = 2
        self.time_points = []
        self.scans_sizer = wx.BoxSizer(wx.VERTICAL)
        self.scans_sizer.Add(Time_Point(self, 'Scan 01'), 0, wx.ALIGN_LEFT | wx.LEFT | wx.RIGHT | wx.EXPAND, 10)
        self.scans_sizer.Add(Time_Point(self, 'Scan 02'), 0, wx.ALIGN_LEFT | wx.LEFT | wx.RIGHT | wx.EXPAND, 10)
    ...
    def OnAddScan(self, event):
        ...
        self.scans_sizer.Add(new_tp, 0, wx.RIGHT | wx.LEFT | wx.EXPAND, 10)
        self.frame.Layout()
...
class Scan_Buttons(wx.Panel):
    ...
    def __init__(self, parent, top_panel, scan_panel):
        ...
        self.add_scan_button = wx.Button(self, label='+ Scan')
        self.rmv_scan_button = wx.Button(self, label='- Scan')
        self.load = wx.Button(self, label='Load Config')
        self.save = wx.Button(self, label='Save Config')
    ...
    def OnLoad(self, event):
        wildcard = 'Config file {*.json}|*.json|All files {*.*}|*.*'
        file_picker = wx.FileDialog(self, 'Choose file', self.frame.default_dir, '', wildcard, wx.FD_OPEN)
        if file_picker.ShowModal() == wx.ID_OK:
            ...
            try:
                ...
                self.top.thresh_field.SetValue('400')
            ...
            if int(config['number_of_scans']) > self.scans.number_of_scans:
                ...
                for x in range(diff):
                    self.scans.scans_sizer.Add(Time_Point(self.scans, ('Scan {0:0>2d}').format(x + self.scans.number_of_scans + 1)), 0, wx.ALIGN_LEFT | wx.LEFT | wx.RIGHT | wx.EXPAND, 10)
    ...
    def OnSave(self, event):
        ...
        if os.path.isdir(parent_dir):
            ...
            if os.path.isfile(parent_dir + '/' + pid + '_config.json'):
                file_overwrite = wx.MessageDialog(self, 'Overwrite Config?', 'Config File Exists', wx.YES_NO)
                if file_overwrite.ShowModal() == wx.ID_YES:
                    with open(parent_dir + '/' + pid + '_config.json', 'w') as (f):
                        json.dump(config, f, sort_keys=True, ensure_ascii=False, indent=4, separators=(',',
                                                                                                       ': '))
            else:
                with open(parent_dir + '/' + pid + '_config.json', 'w') as (f):
                    json.dump(config, f, sort_keys=True, ensure_ascii=False, indent=4, separators=(',',
...
class Time_Point(wx.Panel):
    ...
    def __init__(self, parent, tp_name):
        ...
        self.dwi_label = wx.StaticText(self, -1, label='DWI')
        self.dwi_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        dwi_button = wx.Button(self, -1, label='...')
        sizer.Add(self.dwi_label, (0, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.dwi_field, (0, 1), (1, 1), wx.EXPAND | wx.ALIGN_RIGHT, 5)
        sizer.Add(dwi_button, (0, 2), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        self.Bind(wx.EVT_BUTTON, self.OnDWIButton, dwi_button)
        self.adc_label = wx.StaticText(self, -1, label='ADC')
        self.adc_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        adc_button = wx.Button(self, -1, label='...')
        sizer.Add(self.adc_label, (1, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.adc_field, (1, 1), (1, 1), wx.EXPAND | wx.ALIGN_RIGHT, 5)
        sizer.Add(adc_button, (1, 2), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        self.Bind(wx.EVT_BUTTON, self.OnADCButton, adc_button)
        self.ref_label = wx.StaticText(self, -1, label='REF')
        self.ref_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        ref_button = wx.Button(self, -1, label='...')
        sizer.Add(self.ref_label, (2, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.ref_field, (2, 1), (1, 1), wx.EXPAND | wx.ALIGN_RIGHT, 5)
        sizer.Add(ref_button, (2, 2), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        self.Bind(wx.EVT_BUTTON, self.OnRefButton, ref_button)
        self.roi_label = wx.StaticText(self, -1, label='ROI')
        self.roi_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        roi_button = wx.Button(self, -1, label='...')
        sizer.Add(self.roi_label, (3, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.roi_field, (3, 1), (1, 1), wx.EXPAND | wx.ALIGN_RIGHT, 5)
        sizer.Add(roi_button, (3, 2), (1, 1), wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL, 5)
        self.Bind(wx.EVT_BUTTON, self.OnROIButton, roi_button)
        time_label = wx.StaticText(self, -1, label='Time (Days)')
        self.time_field = wx.TextCtrl(self, -1, value='', style=wx.TE_PROCESS_ENTER)
        sizer.Add(time_label, (4, 0), (1, 1), wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer.Add(self.time_field, (4, 1), (1, 5), wx.ALIGN_LEFT, 5)
        sizer.AddGrowableCol(1)
    ...
    def OnDWIButton(self, event):
        wildcard = 'NIFTI image {*.nii}|*.nii|Compressed NIFTI {*.nii.gz}|*.nii.gz|All files {*.*}|*.*'
        file_picker = wx.FileDialog(self, 'Choose file', self.parent.frame.default_dir, '', wildcard, wx.FD_OPEN)
        if file_picker.ShowModal() == wx.ID_OK:
        ...
        if os.path.isfile(config_file):
            ...
            for tp1 in scan_list:
                for tp2 in scan_list:
                    if not tp1 == tp2:
                        map_list.append(('scan_{0:0>2d} - scan_{1:0>2d}').format(tp2 + 1, tp1 + 1))
...
class Time_Line_Frame(wx.Frame):
    ...
    def __init__(self, parent, map_list):
        ...
        self.add_serial_button = wx.Button(self, label='+ Serial')
        self.add_baseline_button = wx.Button(self, label='+ Baseline')
        self.remove_serial_button = wx.Button(self, label='Remove')
        self.remove_baseline_button = wx.Button(self, label='Remove')
        self.save_button = wx.Button(self, label='Save')
        self.done_button = wx.Button(self, label='Done')
        baseline_label = wx.StaticText(self, -1, label='Baseline')
        serial_label = wx.StaticText(self, -1, label='Serial')
        ...
        self.all_maps_list = wx.ListBox(choices=self.map_list, parent=self, name='All Maps', style=wx.LB_EXTENDED | wx.LB_ALWAYS_SB, size=wx.Size(225, 300))
        self.serial_list = wx.ListBox(choices=self.serial, parent=self, name='Serial List', style=wx.LB_EXTENDED | wx.LB_ALWAYS_SB, size=wx.Size(225, 300))
        self.baseline_list = wx.ListBox(choices=self.baseline, parent=self, name='Baseline List', style=wx.LB_EXTENDED | wx.LB_ALWAYS_SB, size=wx.Size(225, 300))
    ...
    def OnAddSerial(self, event):
        [ self.serial_list.Append(self.map_list[i]) for i in self.all_maps_list.GetSelections()
        ]

    def OnAddBaseline(self, event):
        [ self.baseline_list.Append(self.map_list[i]) for i in self.all_maps_list.GetSelections()
        ]
    ...
    def OnSave(self, event):
        ...
        if os.path.isdir(parent_dir):
            ...
            if os.path.isfile(parent_dir + '/timeline.json'):
                file_overwrite = wx.MessageDialog(self, 'Overwrite Time Line List?', 'Time Line List File Exists', wx.YES_NO)
                if file_overwrite.ShowModal() == wx.ID_YES:
                    with open(parent_dir + '/timeline.json', 'w') as (f):
                        json.dump(scan_list, f, sort_keys=True, ensure_ascii=False, indent=4, separators=(',',
                                                                                                          ': '))
            else:
                with open(parent_dir + '/timeline.json', 'w') as (f):
                    json.dump(scan_list, f, sort_keys=True, ensure_ascii=False, indent=4, separators=(',',
...
class View_Frame(wx.Frame):
    ...
    def __init__(self, parent, map_list):
        ...
        buttons_sizer.Add(self.done_button, 0, wx.EXPAND, 5)
        self.all_maps_list = wx.ListBox(choices=self.map_list, parent=self, name='All Maps', style=wx.LB_SINGLE | wx.LB_ALWAYS_SB, size=wx.Size(225, 300))
    ...
    def OnView(self, event):
        ...
        if self.map_list[scan_idx] == 'MergedRegs.nii.gz':
            ...
            cmd = 'fslview -m ortho ' + struct + ' -l GreyScale ' + image + ' -l "GreyScale"'
        elif self.map_list[scan_idx] == pid + '_Tumor_Mask.nii':
            image = parent_dir + '/FDM/Outputs/Maps/' + pid + '_Tumor_Mask.nii'
            cmd = 'fslview -m ortho ' + struct + ' -l GreyScale ' + image + ' -l "Hot"'
        else:
            ...
            cmd = ('fslview -m ortho {0} -l GreyScale {1} -l "Green" -b 0,1 -t 0.4').format(struct, mask) + (' {0} -l "Red" -b {1},{2} -t 0.8').format(image, thresh_fl, uthresh) + (' {0} -l "Blue" -b {1},{2} -t 0.8').format(image, n_thresh, n_uthresh)
            print cmd
        print 'VIEW ' + image
...
class SplashScreen(wx.SplashScreen):
    ...
    def __init__(self, parent=None):
        ...
        wx.SplashScreen.__init__(self, splash_bit, splash_style, splash_duration, parent)
...
class fDM_Frame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.frame_sizer.Add(top, (0, 0), wx.DefaultSpan, wx.ALL | wx.EXPAND, 5)
        self.frame_sizer.Add(scan_buttons, (1, 0), wx.DefaultSpan, wx.ALL | wx.EXPAND, 5)
        self.frame_sizer.Add(scans, (2, 0), wx.DefaultSpan, wx.ALL | wx.EXPAND, 5)
        self.frame_sizer.Add(run_buttons, (0, 1), (3, 1), wx.ALL | wx.EXPAND, 5)
