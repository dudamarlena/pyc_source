...
# [GCC 8.4.0]
# Embedded file name: D:\djangoarticle\src\djangoarticle\rest_api\api_urls.py
# Compiled at: 2020-04-03 01:16:05
# Size of source mod 2**32: 2357 bytes
import djangoarticle.rest_api as views
...
urlpatterns = [
 ...
 re_path('^category/published/$', (views.CategoryListPublishedViewset.as_view()), name='category_list_published_viewset'),
 ...
 re_path('^category/detail/(?P<slug>[\\w-]+)/$', (views.CategoryDetailArticleListViewSet.as_view()), name='category_detail_article_list_viewset'),
 re_path('^tag/detail/(?P<slug>[\\w-]+)/$', (views.TaggitDetailArticleListViewSet.as_view()), name='taggit_detail_article_list_viewset')]