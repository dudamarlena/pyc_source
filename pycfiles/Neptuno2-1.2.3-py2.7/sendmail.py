...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neptuno/sendmail.py
# Compiled at: 2013-01-23 10:43:55
...
def send_mail(from_, to_, subject, message, server, login, password, files=[], html='', cc=[], bcc=[], reply_to=None, charset='utf-8', ssl=False):
    u"""
    IN
