...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/Dallinger/Dallinger/dallinger/experiment_server/sockets.py
...
class ChatBackend(object):
    __doc__ = 'Manages subscriptions of clients to multiple channels.'
...
class Client(object):
    __doc__ = 'Represents a single websocket client.'
