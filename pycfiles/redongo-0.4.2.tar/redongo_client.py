...
# [GCC 8.4.0]
# Embedded file name: /home/mgalan/projects/redongo/redongo/redongo_client.py
# Compiled at: 2016-10-27 06:20:38
import os, utils, cipher_utils, serializer_utils, client_exceptions, general_exceptions, stoneredis, warnings
try:
...
class RedongoClient:
    ...
    def set_application_settings(self, application_name, mongo_host, mongo_port, mongo_database, mongo_collection, mongo_user, mongo_password, bulk_size=100, bulk_expiration=60, transaction_expiration=7200, serializer_type='pickle'):
        ...
        app_data['transaction_expiration'] = transaction_expiration
    ...
    def add_to_transaction(self, application_name, objects_to_update):
        self.order_to_server(application_name, objects_to_update, 'add_to_transaction')

    def end_transaction(self, application_name, objects_to_save):
        self.order_to_server(application_name, objects_to_save, 'end_transaction')
