...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/odf/odf2moinmoin.py
...
IGNORED_TAGS = [
 ...
 'office:annotation',
 'presentation:notes',
 'svg:desc'] + [ nsdict[item[0]] + ':' + item[1] for item in empty_elements ]
...
class ODF2MoinMoin(object):
    ...
    def __init__(self, filepath):
        ...
        self.elements = {'draw:page': self.textToString, 
    ...
    def listToString(self, listElement, indent=0):
        ...
        for item in listElement.childNodes:
            ...
            if props.ordered:
                ...
                buffer.append(' * ')
            subitems = [ el for el in item.childNodes if el.tagName in ('text:p', 'text:h',
                                                                        'text:list') ]
    ...
    def toString(self):
        ...
        buffer = []
        paragraphs = [ el for el in text.childNodes if el.tagName in ('draw:page',
                                                                      'text:p', 'text:h',
                                                                      'text:section',
                                                                      'text:list',
                                                                      'table:table')
