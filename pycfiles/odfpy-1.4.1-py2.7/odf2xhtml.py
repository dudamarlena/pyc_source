...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/odf/odf2xhtml.py
...
from odf.namespaces import ANIMNS, CHARTNS, CONFIGNS, DCNS, DR3DNS, DRAWNS, FONS, FORMNS, MATHNS, METANS, NUMBERNS, OFFICENS, PRESENTATIONNS, SCRIPTNS, SMILNS, STYLENS, SVGNS, TABLENS, TEXTNS, XLINKNS
...
class StyleToCSS():
    ...
    def __init__(self):
        self.fontdict = {}
        self.fillimages = {}
        self.ruleconversions = {(DRAWNS, 'fill-image-name'): self.c_drawfillimage, 
...
class ODF2XHTML(handler.ContentHandler):
    ...
    def __init__(self, generate_css=True, embedable=False):
        ...
        self.elements = {(DCNS, 'title'): (
                           self.s_processcont, self.e_dc_title), 
           (DCNS, 'language'): (
                              self.s_processcont, self.e_dc_contentlanguage), 
           (DCNS, 'creator'): (
                             self.s_processcont, self.e_dc_creator), 
           (DCNS, 'description'): (
                                 self.s_processcont, self.e_dc_metatag), 
           (DCNS, 'date'): (
                          self.s_processcont, self.e_dc_metatag), 
           (DRAWNS, 'custom-shape'): (
                                    self.s_custom_shape, self.e_custom_shape), 
           (DRAWNS, 'frame'): (
                             self.s_draw_frame, self.e_draw_frame), 
           (DRAWNS, 'image'): (
                             self.s_draw_image, None), 
           (DRAWNS, 'fill-image'): (
                                  self.s_draw_fill_image, None), 
           (DRAWNS, 'layer-set'): (
                                 self.s_ignorexml, None), 
           (DRAWNS, 'object'): (
                              self.s_draw_object, None), 
           (DRAWNS, 'object-ole'): (
                                  self.s_draw_object_ole, None), 
           (DRAWNS, 'page'): (
                            self.s_draw_page, self.e_draw_page), 
           (DRAWNS, 'text-box'): (
                                self.s_draw_textbox, self.e_draw_textbox), 
           ...
           (OFFICENS, 'automatic-styles'): (
                                          self.s_office_automatic_styles, None), 
           (OFFICENS, 'document'): (
                                  self.s_office_document_content, self.e_office_document_content), 
           (OFFICENS, 'document-content'): (
                                          self.s_office_document_content, self.e_office_document_content), 
           (OFFICENS, 'forms'): (
                               self.s_ignorexml, None), 
           (OFFICENS, 'master-styles'): (
                                       self.s_office_master_styles, None), 
           (OFFICENS, 'meta'): (
                              self.s_ignorecont, None), 
           (OFFICENS, 'presentation'): (
                                      self.s_office_presentation, self.e_office_presentation), 
           (OFFICENS, 'spreadsheet'): (
                                     self.s_office_spreadsheet, self.e_office_spreadsheet), 
           (OFFICENS, 'styles'): (
                                self.s_office_styles, None), 
           (OFFICENS, 'text'): (
                              self.s_office_text, self.e_office_text), 
           (OFFICENS, 'scripts'): (
                                 self.s_ignorexml, None), 
           (OFFICENS, 'settings'): (
                                  self.s_ignorexml, None), 
           ...
           (STYLENS, 'default-style'): (
                                      self.s_style_default_style, self.e_style_default_style), 
           (STYLENS, 'drawing-page-properties'): (
                                                self.s_style_handle_properties, None), 
           (STYLENS, 'font-face'): (
                                  self.s_style_font_face, None), 
           (STYLENS, 'graphic-properties'): (
                                           self.s_style_handle_properties, None), 
           (STYLENS, 'handout-master'): (
                                       self.s_ignorexml, None), 
           (STYLENS, 'master-page'): (
                                    self.s_style_master_page, None), 
           (STYLENS, 'page-layout-properties'): (
                                               self.s_style_handle_properties, None), 
           (STYLENS, 'page-layout'): (
                                    self.s_style_page_layout, self.e_style_page_layout), 
           (STYLENS, 'paragraph-properties'): (
                                             self.s_style_handle_properties, None), 
           (STYLENS, 'style'): (
                              self.s_style_style, self.e_style_style), 
           ...
           (TABLENS, 'covered-table-cell'): (
                                           self.s_ignorexml, None), 
           (TABLENS, 'table-cell'): (
                                   self.s_table_table_cell, self.e_table_table_cell), 
           (TABLENS, 'table-column'): (
                                     self.s_table_table_column, None), 
           (TABLENS, 'table-row'): (
                                  self.s_table_table_row, self.e_table_table_row), 
           (TABLENS, 'table'): (
                              self.s_table_table, self.e_table_table), 
           (TEXTNS, 'a'): (
                         self.s_text_a, self.e_text_a), 
           (TEXTNS, 'alphabetical-index-source'): (
                                                 self.s_text_x_source, self.e_text_x_source), 
           (TEXTNS, 'bibliography-configuration'): (
                                                  self.s_ignorexml, None), 
           (TEXTNS, 'bibliography-source'): (
                                           self.s_text_x_source, self.e_text_x_source), 
           (TEXTNS, 'bookmark'): (
                                self.s_text_bookmark, None), 
           (TEXTNS, 'bookmark-start'): (
                                      self.s_text_bookmark, None), 
           (TEXTNS, 'bookmark-ref'): (
                                    self.s_text_bookmark_ref, self.e_text_a), 
           (TEXTNS, 'bookmark-ref-start'): (
                                          self.s_text_bookmark_ref, None), 
           (TEXTNS, 'h'): (
                         self.s_text_h, self.e_text_h), 
           (TEXTNS, 'illustration-index-source'): (
                                                 self.s_text_x_source, self.e_text_x_source), 
           (TEXTNS, 'line-break'): (
                                  self.s_text_line_break, None), 
           (TEXTNS, 'linenumbering-configuration'): (
                                                   self.s_ignorexml, None), 
           (TEXTNS, 'list'): (
                            self.s_text_list, self.e_text_list), 
           (TEXTNS, 'list-item'): (
                                 self.s_text_list_item, self.e_text_list_item), 
           (TEXTNS, 'list-level-style-bullet'): (
                                               self.s_text_list_level_style_bullet, self.e_text_list_level_style_bullet), 
           (TEXTNS, 'list-level-style-number'): (
                                               self.s_text_list_level_style_number, self.e_text_list_level_style_number), 
           (TEXTNS, 'list-style'): (None, None), 
           (TEXTNS, 'note'): (
                            self.s_text_note, None), 
           (TEXTNS, 'note-body'): (
                                 self.s_text_note_body, self.e_text_note_body), 
           (TEXTNS, 'note-citation'): (
                                     None, self.e_text_note_citation), 
           (TEXTNS, 'notes-configuration'): (
                                           self.s_ignorexml, None), 
           (TEXTNS, 'object-index-source'): (
                                           self.s_text_x_source, self.e_text_x_source), 
           (TEXTNS, 'p'): (
                         self.s_text_p, self.e_text_p), 
           (TEXTNS, 's'): (
                         self.s_text_s, None), 
           (TEXTNS, 'span'): (
                            self.s_text_span, self.e_text_span), 
           (TEXTNS, 'tab'): (
                           self.s_text_tab, None), 
    ...
    def s_custom_shape(self, tag, attrs):
        ...
        if anchor_type == 'paragraph':
            ...
            style = 'position: absolute;'
        if (
         SVGNS, 'width') in attrs:
            style = style + 'width:' + attrs[(SVGNS, 'width')] + ';'
        if (
         SVGNS, 'height') in attrs:
    ...
    familymap = {'frame': 'frame', 'paragraph': 'p', 'presentation': 'presentation', 'text': 'span', 
       'section': 'div', 'table': 'table', 
       'table-cell': 'td', 'table-column': 'col', 'table-row': 'tr', 
       'graphic': 'graphic'}
    ...
    _familyshort = {'drawing-page': 'DP', 'paragraph': 'P', 'presentation': 'PR', 'text': 'S', 
       'section': 'D', 'table': 'T', 
       'table-cell': 'TD', 'table-column': 'TC', 'table-row': 'TR', 
       'graphic': 'G'}
    ...
    def load(self, odffile):
        ...
        """
        assert type(odffile) == type('') or 'rb' in repr(odffile) or 'BufferedReader' in repr(odffile) or 'BytesIO' in repr(odffile)
        self.lines = []
        self._wfunc = self._wlines
