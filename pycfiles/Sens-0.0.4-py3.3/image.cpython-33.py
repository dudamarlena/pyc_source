...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sens/image.py
# Compiled at: 2013-10-15 13:33:06
...
def build_image(twitch_status):
    ...
    if online:
        ...
        preview_img_pos = tuple(map(lambda i: i[0] - i[1], zip(img.size, preview_img.size)))
