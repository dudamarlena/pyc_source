...
# [GCC 8.4.0]
# Embedded file name: /Users/runner/runners/2.169.1/work/MetaWards/MetaWards/tests/../build/lib.macosx-10.14-x86_64-3.7/metawards/_links.py
...
class Links:
    ...
    def assert_valid_index(self, i):
        ...
        if i < 0:
            i = n + i
        if i < 0 or i >= n:
            raise IndexError(f"Invalid link index {i}. Number of links in this container equals {n}")
        return i
    ...
    def __getitem__(self, i: int):
        ...
        return Link(ifrom=(self.ifrom[i]), ito=(self.ito[i]), weight=(self.weight[i]),
          suscept=(self.suscept[i]),
