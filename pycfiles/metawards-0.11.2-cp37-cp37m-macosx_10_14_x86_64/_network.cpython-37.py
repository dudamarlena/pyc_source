...
# Size of source mod 2**32: 17128 bytes
...
class Network:
    ...
    @staticmethod
    def build(params: Parameters, max_nodes: int=16384, max_links: int=4194304, nthreads: int=1, profiler=None):
        ...
        if profiler is None:
            ...
            network = build_wards_network(params=params, profiler=p,
              max_nodes=max_nodes,
              max_links=max_links,
              nthreads=nthreads)
            p = p.stop()
            ...
            from utils._add_wards_network_distance import add_wards_network_distance
