...
# [GCC 8.4.0]
# Embedded file name: /Users/runner/runners/2.169.1/work/MetaWards/MetaWards/tests/../build/lib.macosx-10.14-x86_64-3.7/metawards/iterators/_iterate_custom.py
...
def build_custom_iterator(custom_function: _Union[(str, MetaFunction)], parent_name='__main__') -> MetaFunction:
...
def iterate_custom(custom_function: MetaFunction, stage: str, **kwargs) -> _List[MetaFunction]:
    ...
    if stage == 'infect' or accepts_stage(custom_function):
