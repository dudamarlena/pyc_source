...
# [GCC 8.4.0]
# Embedded file name: /Users/runner/runners/2.169.1/work/MetaWards/MetaWards/tests/../build/lib.macosx-10.14-x86_64-3.7/metawards/_nodes.py
...
class Nodes:
    ...
    def __init__(self, N: int=0):
        ...
        if N <= 0:
            ...
            self.x = create_double_array(N, 0.0)
            self.y = create_double_array(N, 0.0)
    ...
    def assert_valid_index(self, i):
        ...
        if i < 0:
            i = n + i
        if i < 0 or i >= n:
            raise IndexError(f"Invalid node index {i}. Number of nodes in this container equals {n}")
        return i
    ...
    def __getitem__(self, i: int):
        ...
        try:
            return Node(label=(self.label[i]), begin_to=(self.begin_to[i]),
    ...
    def scale_susceptibles(self, ratio: any=None, work_ratio: any=None, play_ratio: any=None):
        ...
        scale_node_susceptibles(nodes=self, ratio=ratio, work_ratio=work_ratio,
