...
# [GCC 8.4.0]
# Embedded file name: /Users/runner/runners/2.169.1/work/MetaWards/MetaWards/tests/../build/lib.macosx-10.14-x86_64-3.7/metawards/extractors/_output_prevalence.py
...
def output_prevalence_serial(network: Network, population: Population, output_dir: OutputFiles, workspace: Workspace, **kwargs):
...
def output_prevalence(nthreads: int=1, **kwargs):
    """This will output the number of infections per ward per timestep
       ...
       kwargs
         Extra argumentst that are ignored by this function
    """
    call_function_on_network(nthreads=1, func=output_prevalence_serial, 
