...
0 # Avoid dead code: x)
    ...
    def fit(self, approx_type='slognorm', output='agg'):
        ...
        if output == 'agg':
            ...
            return agg_str
        return {**{'name':name, 
         'note':f"frozen version of {self.name}",  'exp_en':1}, **sev, **{'freq_name': 'fixed'}}
 ...
 L.1319       478  LOAD_CONST               True
              ...
              490  CALL_FUNCTION_EX_KW     1  'keyword args'
              492  POP_TOP          
 ...
 L.1449      2032  LOAD_STR                 'nearest'
             ...
             2042  CALL_FUNCTION_EX_KW     1  'keyword args'
             2044  POP_TOP          
...
Parse error at or near `COME_FROM' instruction at offset 2250_0
    ...
    def apply_distortions--- This code section failed: ---

 L.2070         0  BUILD_LIST_0          0 
                2  STORE_FAST               'ans'

 L.2071         4  LOAD_FAST                'As'
                6  LOAD_CONST               None
                8  COMPARE_OP               is
               10  POP_JUMP_IF_FALSE    38  'to 38'

 L.2072        12  LOAD_GLOBAL              np
               14  LOAD_METHOD              array
               16  LOAD_CLOSURE             'kind'
               18  LOAD_CLOSURE             'self'
               20  BUILD_TUPLE_2         2 
               22  LOAD_LISTCOMP            '<code_object <listcomp>>'
               24  LOAD_STR                 'Portfolio.apply_distortions.<locals>.<listcomp>'
 ...
 L.2075        54  LOAD_GLOBAL              axiter_factory
               56  LOAD_CONST               None
               58  LOAD_GLOBAL              len
               60  LOAD_FAST                'dist_dict'
               62  CALL_FUNCTION_1       1  ''
               64  CALL_FUNCTION_2       2  ''
               66  STORE_FAST               'axiter'
               68  JUMP_FORWARD         98  'to 98'
             70_0  COME_FROM            52  '52'
             70_1  COME_FROM            44  '44'

 L.2076        70  LOAD_FAST                'num_plots'
               72  LOAD_CONST               3
               74  COMPARE_OP               ==
 ...
 L.2077        86  LOAD_GLOBAL              axiter_factory
               88  LOAD_CONST               None
               90  LOAD_CONST               30
               92  CALL_FUNCTION_2       2  ''
               94  STORE_FAST               'axiter'
               96  JUMP_FORWARD         98  'to 98'
             98_0  COME_FROM            96  '96'
             98_1  COME_FROM            84  '84'
             98_2  COME_FROM            76  '76'
             98_3  COME_FROM            68  '68'

 L.2081        98  SETUP_LOOP          186  'to 186'
              100  LOAD_FAST                'dist_dict'
              102  LOAD_METHOD              values
              104  CALL_METHOD_0         0  ''
              106  GET_ITER         
              108  FOR_ITER            184  'to 184'
              110  STORE_FAST               'g'

 L.2082       112  LOAD_DEREF               'self'
              114  LOAD_METHOD              apply_distortion
              116  LOAD_FAST                'g'
              118  LOAD_FAST                'axiter'
              120  LOAD_FAST                'num_plots'
              122  CALL_METHOD_3         3  ''
              124  STORE_FAST               '_x'

 L.2083       126  LOAD_FAST                '_x'
              128  LOAD_ATTR                augmented_df
              130  STORE_FAST               'df'

 L.2085       132  LOAD_FAST                'df'
              134  LOAD_ATTR                loc
              136  LOAD_FAST                'As'
              138  LOAD_CONST               None
              140  LOAD_CONST               None
              ...
              144  BUILD_TUPLE_2         2 
              146  BINARY_SUBSCR    
              148  LOAD_ATTR                filter
              150  LOAD_STR                 '^loss|^S|exa[g]?_[^η][\\.:~a-zA-Z0-9]*$|exag_sumparts|lr_'
              152  LOAD_CONST               ('regex',)
              154  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              156  LOAD_METHOD              copy
              158  CALL_METHOD_0         0  ''
              160  STORE_FAST               'temp'

 L.2088       162  LOAD_FAST                'g'
              164  LOAD_ATTR                name
              166  LOAD_FAST                'temp'
              168  LOAD_STR                 'method'
              170  STORE_SUBSCR     

 L.2089       172  LOAD_FAST                'ans'
              174  LOAD_METHOD              append
              176  LOAD_FAST                'temp'
              178  CALL_METHOD_1         1  ''
              180  POP_TOP          
              182  JUMP_BACK           108  'to 108'
              184  POP_BLOCK        
            186_0  COME_FROM_LOOP       98  '98'

 L.2091       186  LOAD_GLOBAL              pd
              188  LOAD_METHOD              concat
              190  LOAD_FAST                'ans'
              192  CALL_METHOD_1         1  ''
              194  STORE_FAST               'ans_table'

 L.2092       196  LOAD_GLOBAL              np
              198  LOAD_METHOD              round
              200  LOAD_CONST               1
              202  LOAD_FAST                'ans_table'
              204  LOAD_ATTR                S
              206  BINARY_TRUE_DIVIDE
              208  LOAD_CONST               0
              210  CALL_METHOD_2         2  ''
              212  LOAD_FAST                'ans_table'
              214  LOAD_STR                 'return'
              216  STORE_SUBSCR     

 L.2094       218  LOAD_FAST                'ans_table'
              220  LOAD_METHOD              copy
              222  CALL_METHOD_0         0  ''
              224  STORE_FAST               'df2'

 L.2095       226  LOAD_FAST                'df2'
              228  LOAD_METHOD              set_index
              230  LOAD_STR                 'loss'
              232  LOAD_STR                 'method'
              234  LOAD_STR                 'return'
              236  LOAD_STR                 'S'
 ...
 L.2096       244  LOAD_FAST                'df2'
              246  LOAD_ATTR                columns
              248  LOAD_ATTR                str
              250  LOAD_ATTR                split
              252  LOAD_STR                 '_'
              254  LOAD_CONST               True
              256  LOAD_CONST               ('expand',)
              258  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              260  LOAD_FAST                'df2'
              262  STORE_ATTR               columns

 L.2097       264  LOAD_GLOBAL              pd
              266  LOAD_METHOD              DataFrame
              268  LOAD_FAST                'df2'
              270  LOAD_METHOD              stack
              272  CALL_METHOD_0         0  ''
              274  LOAD_METHOD              stack
              276  CALL_METHOD_0         0  ''
              278  CALL_METHOD_1         1  ''
              280  LOAD_METHOD              reset_index
              282  CALL_METHOD_0         0  ''
              284  STORE_FAST               'ans_stacked'

 L.2098       286  LOAD_STR                 'assets'
              288  LOAD_STR                 'method'
              290  LOAD_STR                 'return'
              292  LOAD_STR                 'S'
              294  LOAD_STR                 'line'
              ...
              298  LOAD_STR                 'value'
              300  BUILD_LIST_7          7 
              302  LOAD_FAST                'ans_stacked'
              304  STORE_ATTR               columns

 L.2101       306  LOAD_FAST                'ans_table'
              308  LOAD_ATTR                filter
              310  LOAD_STR                 '^lr'
              312  LOAD_CONST               ('regex',)
 ...
 L.2102       326  LOAD_FAST                'mn'
              328  STORE_FAST               'mn1'

 L.2103       330  LOAD_FAST                'ans_table'
              332  LOAD_ATTR                filter
              334  LOAD_STR                 '^lr'
              336  LOAD_CONST               ('regex',)
              338  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              340  LOAD_METHOD              max
              342  CALL_METHOD_0         0  ''
              344  LOAD_METHOD              max
              346  CALL_METHOD_0         0  ''
 ...
 L.2104       350  LOAD_GLOBAL              np
              352  LOAD_METHOD              round
              354  LOAD_FAST                'mn'
              356  LOAD_CONST               20
              358  BINARY_MULTIPLY  
              360  LOAD_CONST               0
 ...
 L.2105       370  LOAD_GLOBAL              np
              372  LOAD_METHOD              round
              374  LOAD_FAST                'mx'
              376  LOAD_CONST               20
              378  BINARY_MULTIPLY  
              380  LOAD_CONST               0
 ...
 L.2106       390  LOAD_FAST                'mx'
              392  LOAD_CONST               0.9
              394  COMPARE_OP               >=
          396_398  POP_JUMP_IF_FALSE   404  'to 404'

 L.2107       400  LOAD_CONST               1
              402  STORE_FAST               'mx'
            404_0  COME_FROM           396  '396'

 L.2108       404  LOAD_FAST                'mn'
              406  LOAD_CONST               0.2
              408  COMPARE_OP               <=
          410_412  POP_JUMP_IF_FALSE   418  'to 418'

 L.2109       414  LOAD_CONST               0
              416  STORE_FAST               'mn'
            418_0  COME_FROM           410  '410'

 L.2110       418  LOAD_FAST                'mn1'
              420  LOAD_FAST                'mn'
              422  COMPARE_OP               <
          424_426  POP_JUMP_IF_FALSE   436  'to 436'

 L.2111       428  LOAD_FAST                'mn'
              430  LOAD_CONST               0.1
              432  INPLACE_SUBTRACT 
              434  STORE_FAST               'mn'
            436_0  COME_FROM           424  '424'

 L.2114       436  LOAD_FAST                'num_plots'
              438  LOAD_CONST               1
              440  COMPARE_OP               >=
          442_444  POP_JUMP_IF_FALSE   534  'to 534'

 L.2115       446  LOAD_GLOBAL              sns
              448  LOAD_ATTR                catplot
              450  LOAD_STR                 'line'
              452  LOAD_STR                 'value'
              454  LOAD_STR                 'return'
              456  LOAD_STR                 'method'
 ...
 L.2116       462  LOAD_FAST                'ans_stacked'
              464  LOAD_METHOD              query
              466  LOAD_STR                 ' stat=="lr" '
              468  CALL_METHOD_1         1  ''
              470  LOAD_CONST               ('x', 'y', 'row', 'col', 'height', 'kind', 'data')
              472  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
              474  LOAD_ATTR                set
              476  LOAD_FAST                'mn'
              478  LOAD_FAST                'mx'
              480  BUILD_TUPLE_2         2 
              482  LOAD_STR                 'LR'
              484  LOAD_CONST               ('ylim', 'ylabel')
              486  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              488  POP_TOP          

 L.2117       490  LOAD_GLOBAL              sns
              492  LOAD_ATTR                catplot
              494  LOAD_STR                 'method'
              496  LOAD_STR                 'value'
              498  LOAD_STR                 'return'
              500  LOAD_STR                 'line'
 ...
 L.2118       506  LOAD_FAST                'ans_stacked'
              508  LOAD_METHOD              query
              510  LOAD_STR                 ' stat=="lr" '
              512  CALL_METHOD_1         1  ''
              514  LOAD_CONST               ('x', 'y', 'row', 'col', 'height', 'kind', 'data')
              516  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
              518  LOAD_ATTR                set
              520  LOAD_FAST                'mn'
              522  LOAD_FAST                'mx'
              524  BUILD_TUPLE_2         2 
              526  LOAD_STR                 'LR'
              528  LOAD_CONST               ('ylim', 'ylabel')
              530  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              532  POP_TOP          
            534_0  COME_FROM           442  '442'

 L.2122       534  LOAD_FAST                'ans_table'
              536  LOAD_FAST                'ans_stacked'
              538  BUILD_TUPLE_2         2 
              540  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `RETURN_VALUE' instruction at offset 540
    ...
    def price(self, reg_g, pricing_g=None):
        ...
        a_reg_ix = 0
        a_reg = 0
        if not isinstance(reg_g, float):
            if isinstance(reg_g, int):
                if reg_g > 1:
                    a_reg = reg_g
