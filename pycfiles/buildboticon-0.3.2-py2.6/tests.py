...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\bbicon\tests.py
# Compiled at: 2011-01-22 06:17:44
...
class TestBuildbotIcon(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.settings.builds = {'test': QUrl('http://localhost:8000/test'), 'test2': QUrl('http://localhost:8000/test2')}
    ...
    def testPlayWorstSound(self):
        sounds = self._testPlaySound({'test': ('warn', 'success'), 'test2': ('fail', 'success')})
        self.assertFalse(sounds['success'].play.called)
...
class TestSettings(unittest.TestCase):
    ...
    def testLoadSoundsUnix(self):
        ...
        self.assertEqual(success_file, self.settings.sounds['success'].fileName())
