...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/buzzword/parts/helpers.py
# Compiled at: 2019-08-24 16:29:28
    ...
    if conll:
        ...
        if conc:
            ...
            if not conc:
                ...
                if conll or conc:
                    columns = [{'name':_capitalize_first(SHORT_TO_COL_NAME.get(i, i)),  'id':i,  'deletable':i not in cannot_delete and deletable} for i in df.columns]
            columns = [{'name':i.lstrip('_'),  'id':i,  'deletable':deletable and '_' + i not in names} for i in df.columns]
