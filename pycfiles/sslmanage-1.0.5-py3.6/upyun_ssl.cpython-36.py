...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sslmanage/upyun_ssl.py
# Compiled at: 2019-07-05 06:17:28
...
class HTTPClient:
    ...
    def _set_header_default():
        ...
        header_dict['User-Agent'] = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_4) AppleWebKit/537.36 (KHTML, like Gecko) 12306-electron/1.0.1 Chrome/59.0.3071.115 Electron/1.8.4 Safari/537.36'
...
class UpCertManager(BaseSsl):
    ...
    def __init__(self, session, domain, cert_file, key_file, mail_svr):
    ...
    def migrate_cert(self, old_crt_id, new_crt_id):
        ...
        resp = self.session.send(req_url, method='post', json={'old_crt_id':old_crt_id, 
    ...
    def add_bucket_domain(self, bucket_name, domain):
        ...
        certificate_info = self.session.send(req_url, method='PUT',
    ...
    def del_cert(self, certificate_id):
        req_url = URLS['add_cert']
        params = {'certificate_id': certificate_id}
        certificate_info = self.session.send(req_url, method='DELETE',
          params=params)
