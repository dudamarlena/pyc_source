...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/container/asn1.py
...
from hachoir_core.field import FieldSet, FieldError, ParserError, Bit, Bits, Bytes, UInt8, GenericInteger, String, Field, Enum, RawBytes
...
class ASN1File(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'asn1', 'category': 'container', 'file_ext': ('der', ), 'min_size': 16, 'description': 'Abstract Syntax Notation One (ASN.1)'}
    endian = BIG_ENDIAN
