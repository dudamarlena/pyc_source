...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/audio/au.py
...
class AuFile(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'sun_next_snd', 'category': 'audio', 'file_ext': ('au', 'snd'), 'mime': ('audio/basic',), 'min_size': 24 * 8, 'magic': (('.snd', 0),), 'description': 'Sun/NeXT audio'}
    endian = BIG_ENDIAN
    CODEC_INFO = {1: (8, '8-bit ISDN u-law'), 2: (8, '8-bit linear PCM'), 3: (16, '16-bit linear PCM'), 4: (24, '24-bit linear PCM'), 5: (32, '32-bit linear PCM'), 6: (32, '32-bit IEEE floating point'), 7: (64, '64-bit IEEE floating point'), 8: (None, 'Fragmented sample data'), 9: (None, 'DSP program'), 10: (8, '8-bit fixed point'), 11: (16, '16-bit fixed point'), 12: (24, '24-bit fixed point'), 13: (32, '32-bit fixed point'), 18: (16, '16-bit linear with emphasis'), 19: (16, '16-bit linear compressed'), 20: (16, '16-bit linear with emphasis and compression'), 21: (None, 'Music kit DSP commands'), 23: (None, '4-bit ISDN u-law compressed (CCITT G.721 ADPCM)'), 24: (None, 'ITU-T G.722 ADPCM'), 25: (None, 'ITU-T G.723 3-bit ADPCM'), 26: (None, 'ITU-T G.723 5-bit ADPCM'), 27: (8, '8-bit ISDN A-law')}
    ...
    def createFields(self):
        ...
        if 0 < size:
            yield String(self, 'info', size, 'Information', strip=' \x00', charset='ISO-8859-1')
