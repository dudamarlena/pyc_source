...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/program/prc.py
# Compiled at: 2010-01-20 18:02:36
"""
...
from hachoir_core.field import FieldSet, UInt16, UInt32, TimestampMac32, String, RawBytes
...
class PRCFile(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'prc', 'category': 'program', 'file_ext': ('prc', ''), 'min_size': ResourceHeader.static_size, 'mime': ('application/x-pilot-prc', 'application/x-palmpilot'), 'description': 'Palm Resource File'}
    endian = BIG_ENDIAN
