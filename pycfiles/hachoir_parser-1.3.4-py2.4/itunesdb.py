...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/audio/itunesdb.py
...
from hachoir_core.field import FieldSet, UInt8, UInt16, UInt32, UInt64, TimestampMac32, String, Float32, NullBytes, Enum
...
list_order = {1: 'playlist order (manual sort order)', 2: '???', 3: 'songtitle', 4: 'album', 5: 'artist', 6: 'bitrate', 7: 'genre', 8: 'kind', 9: 'date modified', 10: 'track number', 11: 'size', 12: 'time', 13: 'year', 14: 'sample rate', 15: 'comment', 16: 'date added', 17: 'equalizer', 18: 'composer', 19: '???', 20: 'play count', 21: 'last played', 22: 'disc number', 23: 'my rating', 24: 'release date', 25: 'BPM', 26: 'grouping', 27: 'category', 28: 'description', 29: 'show', 30: 'season', 31: 'episode number'}

class DataObject(FieldSet):
    __module__ = __name__
    type_name = {1: 'Title', 2: 'Location', 3: 'Album', 4: 'Artist', 5: 'Genre', 6: 'Filetype', 7: 'EQ Setting', 8: 'Comment', 9: 'Category', 12: 'Composer', 13: 'Grouping', 14: 'Description text', 15: 'Podcast Enclosure URL', 16: 'Podcast RSS URL', 17: 'Chapter data', 18: 'Subtitle', 19: 'Show (for TV Shows only)', 20: 'Episode', 21: 'TV Network', 50: 'Smart Playlist Data', 51: 'Smart Playlist Rules', 52: 'Library Playlist Index', 100: 'Column info'}
    mhod52_sort_index_type_name = {3: 'Title', 4: 'Album, then Disk/Tracknumber, then Title', 5: 'Artist, then Album, then Disc/Tracknumber, then Title', 7: 'Genre, then Artist, then Album, then Disc/Tracknumber, then Title', 8: 'Composer, then Title'}
...
class TrackItem(FieldSet):
    __module__ = __name__
    x1_type_name = {0: 'AAC or CBR MP3', 1: 'VBR MP3'}
    x2_type_name = {0: 'AAC', 1: 'MP3'}
    media_type_name = {0: 'Audio/Video', 1: 'Audio', 2: 'Video', 4: 'Podcast', 6: 'Video Podcast', 8: 'Audiobook', 32: 'Music Video', 64: 'TV Show', 96: 'TV Show (Music lists)'}
...
class Playlist(FieldSet):
    __module__ = __name__
    is_master_pl_name = {0: 'Regular playlist', 1: 'Master playlist'}
    is_podcast_name = {0: 'Normal Playlist List', 1: 'Podcast Playlist List'}
    list_sort_order_name = {1: 'Manual Sort Order', 2: '???', 3: 'Song Title', 4: 'Album', 5: 'Artist', 6: 'Bitrate', 7: 'Genre', 8: 'Kind', 9: 'Date Modified', 10: 'Track Number', 11: 'Size', 12: 'Time', 13: 'Year', 14: 'Sample Rate', 15: 'Comment', 16: 'Date Added', 17: 'Equalizer', 18: 'Composer', 19: '???', 20: 'Play Count', 21: 'Last Played', 22: 'Disc Number', 23: 'My Rating', 24: 'Release Date', 25: 'BPM', 26: 'Grouping', 27: 'Category', 28: 'Description', 29: 'Show', 30: 'Season', 31: 'Episode Number'}
...
class DataSet(FieldSet):
    __module__ = __name__
    type_name = {1: 'Track List', 2: 'Play List', 3: 'Podcast List'}
...
class ITunesDBFile(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'itunesdb', 'category': 'audio', 'min_size': 44 * 8, 'magic': (('mhbd', 0), ), 'description': 'iPod iTunesDB file'}
