...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/program/python.py
...
from hachoir_core.field import FieldSet, UInt8, UInt16, Int32, UInt32, Int64, ParserError, Float64, Enum, Character, Bytes, RawBytes, PascalString8, TimestampUnix32
...
def parseCode(parent):
    if 50331648 <= parent.root.getVersion():
    ...
    elif 33751040 <= parent.root.getVersion():
        yield UInt32(parent, 'arg_count', 'Argument count')
        yield UInt32(parent, 'nb_locals', 'Number of local variables')
        yield UInt32(parent, 'stack_size', 'Stack size')
        yield UInt32(parent, 'flags')
...
class Object(FieldSet):
    ...
    def createValueComplex(self):
        return complex(float(self['real'].value), float(self['complex'].value))
...
class PythonCompiledFile(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'python', 'category': 'program', 'file_ext': ('pyc', 'pyo'), 'min_size': 9 * 8, 'description': 'Compiled Python script (.pyc/.pyo files)'}
    endian = LITTLE_ENDIAN
    MAGIC = {20121: ('1.5', 17104896), 50823: ('2.0', 33554432), 60202: ('2.1', 33619968), 60717: ('2.2', 33685504), 62011: ('2.3a0', 33751040), 62021: ('2.3a0', 33751040), 62041: ('2.4a0', 33816576), 62051: ('2.4a3', 33816576), 62061: ('2.4b1', 33816576), 62071: ('2.5a0', 33882112), 62081: ('2.5a0 (ast-branch)', 33882112), 62091: ('2.5a0 (with)', 33882112), 62092: ('2.5a0 (WITH_CLEANUP opcode)', 33882112), 62101: ('2.5b3', 33882112), 62111: ('2.5b3', 33882112), 62121: ('2.5c1', 33882112), 62131: ('2.5c2', 33882112), 3000: ('3.0 (3000)', 50331648), 3010: ('3.0 (3010)', 50331648), 3020: ('3.0 (3020)', 50331648), 3030: ('3.0 (3030)', 50331648), 3040: ('3.0 (3040)', 50331648), 3050: ('3.0 (3050)', 50331648), 3060: ('3.0 (3060)', 50331648), 3070: ('3.0 (3070)', 50331648), 3080: ('3.0 (3080)', 50331648), 3090: ('3.0 (3090)', 50331648), 3100: ('3.0 (3100)', 50331648), 3102: ('3.0 (3102)', 50331648), 3110: ('3.0a4', 50331648), 3130: ('3.0a5', 50331648), 3131: ('3.0a5 unicode', 50331648)}
    STR_MAGIC = dict(((long2raw(magic | ord('\r') << 16 | ord('\n') << 24, LITTLE_ENDIAN), value[0]) for (magic, value) in MAGIC.iteritems()))
