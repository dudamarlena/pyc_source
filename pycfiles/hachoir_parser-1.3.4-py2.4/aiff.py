...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/audio/aiff.py
# Compiled at: 2010-07-23 16:44:22
"""
...
class AiffFile(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'aiff', 'category': 'audio', 'file_ext': ('aif', 'aiff', 'aifc'), 'mime': ('audio/x-aiff', ), 'magic_regex': (('FORM.{4}AIF[CF]', 0), ), 'min_size': 12 * 8, 'description': 'Audio Interchange File Format (AIFF)'}
    endian = BIG_ENDIAN
