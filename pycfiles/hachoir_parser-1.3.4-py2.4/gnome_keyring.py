...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/misc/gnome_keyring.py
# Compiled at: 2010-01-20 18:03:35
"""
...
from hachoir_core.field import FieldSet, Bit, NullBits, NullBytes, UInt8, UInt32, String, RawBytes, Enum, TimestampUnix64, CompressedField, SubFile
...
class EncryptedData(Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'gnomeencryptedkeyring', 'min_size': 16 * 8, 'description': 'Gnome encrypted keyring'}
    endian = BIG_ENDIAN
...
class GnomeKeyring(Parser):
    __module__ = __name__
    MAGIC = 'GnomeKeyring\n\r\x00\n'
    PARSER_TAGS = {'id': 'gnomekeyring', 'category': 'misc', 'magic': ((MAGIC, 0),), 'min_size': 47 * 8, 'description': 'Gnome keyring'}
    CRYPTO_NAMES = {0: 'AEL'}
    HASH_NAMES = {0: 'MD5'}
    endian = BIG_ENDIAN
