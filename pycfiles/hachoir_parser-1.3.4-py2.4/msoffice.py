...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/misc/msoffice.py
# Compiled at: 2010-01-20 18:07:21
"""
...
PROPERTY_NAME = {'\x05DocumentSummaryInformation': 'doc_summary', '\x05SummaryInformation': 'summary', 'WordDocument': 'word_doc'}

class OfficeRootEntry(HachoirParser, RootSeekableFieldSet):
    __module__ = __name__
    PARSER_TAGS = {'description': 'Microsoft Office document subfragments'}
