...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/common/win32.py
# Compiled at: 2009-09-07 17:44:28
from hachoir_core.field import FieldSet, UInt16, UInt32, Enum, String, Bytes, Bits, TimestampUUID60
...
CODEPAGE_CHARSET = {874: 'CP874', 1250: 'WINDOWS-1250', 1251: 'WINDOWS-1251', 1252: 'WINDOWS-1252', 1253: 'WINDOWS-1253', 1254: 'WINDOWS-1254', 1255: 'WINDOWS-1255', 1256: 'WINDOWS-1256', 1257: 'WINDOWS-1257', 1258: 'WINDOWS-1258', 65001: 'UTF-8'}
...
class GUID(FieldSet):
    ...
    FIELD_NAMES = {3: ('sha1_high', 'sha1_low'), 4: ('random_high', 'random_low'), 5: ('md5_high', 'md5_low')}
    VERSION_NAME = {1: 'Timestamp & MAC-48', 2: 'DCE Security version', 3: 'Name SHA-1 hash', 4: 'Randomly generated', 5: 'Name MD5 hash'}
    VARIANT_NAME = {0: 'NCS', 2: 'Leach-Salz', 6: 'Microsoft Corporation', 7: 'Reserved Future'}
    ...
    def createFields(self):
        if self.version == 1:
            ...
            (namea, nameb) = self.FIELD_NAMES.get(self.version, ('data_a', 'data_b'))
    ...
    def createRawDisplay(self):
        ...
        return str2hex(value, format='\\x%02x')
...
class BitmapInfoHeader(FieldSet):
    ...
    __module__ = __name__
    static_size = 40 * 8
    COMPRESSION_NAME = {0: 'Uncompressed (RGB)', 1: 'RLE (8 bits)', 2: 'RLE (4 bits)', 3: 'Bitfields', 4: 'JPEG', 5: 'PNG'}
    ...
    def createDescription(self):
        return 'Bitmap info header: %ux%u pixels, %u bits/pixel' % (self['width'].value, self['height'].value, self['bpp'].value)