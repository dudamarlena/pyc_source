...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/misc/word_doc.py
# Compiled at: 2010-01-20 18:04:30
"""
Documents:
...
from hachoir_core.field import FieldSet, Bit, Bits, UInt8, Int16, UInt16, UInt32, Int32, NullBytes, RawBytes, PascalString16, DateTimeMSDOS32
...
class BaseWordDocument:
    ...
    def createFields(self):
        ...
        yield PascalString16(self, 'file_creator', strip='\x00')
...
class WordDocumentParser(BaseWordDocument, Parser):
    __module__ = __name__
    PARSER_TAGS = {'id': 'word_document', 'min_size': 8, 'description': 'Microsoft Office Word document'}
