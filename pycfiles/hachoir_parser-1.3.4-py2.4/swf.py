...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_parser/container/swf.py
...
from hachoir_core.field import FieldSet, ParserError, Bit, Bits, UInt8, UInt32, UInt16, CString, Enum, Bytes, RawBytes, NullBits, String, SubFile
...
SOUND_CODEC_MP3 = 2
SOUND_CODEC = {0: 'RAW', 1: 'ADPCM', SOUND_CODEC_MP3: 'MP3', 3: 'Uncompressed', 6: 'Nellymoser'}
...
class Tag(FieldSet):
    ...
    TAG_BITS_JPEG2 = 32
    TAG_BITS_JPEG3 = 35
    TAG_INFO = {0: ('end[]', 'End', None), 1: ('show_frame[]', 'Show frame', None), 2: ('def_shape[]', 'Define shape', None), 3: ('free_char[]', 'Free character', None), 4: ('place_obj[]', 'Place object', None), 5: ('remove_obj[]', 'Remove object', None), 6: ('def_bits[]', 'Define bits', parseJpeg), 7: ('def_but[]', 'Define button', None), 8: ('jpg_table', 'JPEG tables', None), 9: ('bkgd_color[]', 'Set background color', parseBackgroundColor), 10: ('def_font[]', 'Define font', None), 11: ('def_text[]', 'Define text', None), 12: ('action[]', 'Action script', parseActionScript), 13: ('def_font_info[]', 'Define font info', None), 14: ('def_sound[]', 'Define sound', parseDefineSound), 15: ('start_sound[]', 'Start sound', parseStartSound), 16: ('stop_sound[]', 'Stop sound', None), 17: ('def_but_sound[]', 'Define button sound', None), 18: ('sound_hdr', 'Sound stream header', parseSoundHeader), 19: ('sound_blk[]', 'Sound stream block', parseSoundBlock), 20: ('def_bits_lossless[]', 'Define bits lossless', None), 21: ('def_bits_jpeg2[]', 'Define bits JPEG 2', parseJpeg), 22: ('def_shape2[]', 'Define shape 2', None), 23: ('def_but_cxform[]', 'Define button CXFORM', None), 24: ('protect', 'File is protected', None), 25: ('path_are_ps[]', 'Paths are Postscript', None), 26: ('place_obj2[]', 'Place object 2', None), 28: ('remove_obj2[]', 'Remove object 2', None), 29: ('sync_frame[]', 'Synchronize frame', None), 31: ('free_all[]', 'Free all', None), 32: ('def_shape3[]', 'Define shape 3', None), 33: ('def_text2[]', 'Define text 2', None), 34: ('def_but2[]', 'Define button2', None), 35: ('def_bits_jpeg3[]', 'Define bits JPEG 3', parseJpeg), 36: ('def_bits_lossless2[]', 'Define bits lossless 2', None), 39: ('def_sprite[]', 'Define sprite', None), 40: ('name_character[]', 'Name character', None), 41: ('serial_number', 'Serial number', None), 42: ('generator_text[]', 'Generator text', None), 43: ('frame_label[]', 'Frame label', None), 45: ('sound_hdr2[]', 'Sound stream header2', parseSoundHeader), 46: ('def_morph_shape[]', 'Define morph shape', None), 47: ('gen_frame[]', 'Generate frame', None), 48: ('def_font2[]', 'Define font 2', None), 49: ('tpl_command[]', 'Template command', None), 37: ('def_text_field[]', 'Define text field', None), 38: ('def_quicktime_movie[]', 'Define QuickTime movie', None), 50: ('def_cmd_obj[]', 'Define command object', None), 51: ('flash_generator', 'Flash generator', None), 52: ('gen_ext_font[]', 'Gen external font', None), 56: ('export[]', 'Export', parseExport), 57: ('import[]', 'Import', None), 58: ('ebnable_debug', 'Enable debug', None), 59: ('do_init_action[]', 'Do init action', None), 60: ('video_str[]', 'Video stream', None), 61: ('video_frame[]', 'Video frame', parseVideoFrame), 62: ('def_font_info2[]', 'Define font info 2', None), 63: ('mx4[]', 'MX4', None), 64: ('enable_debug2', 'Enable debugger 2', None), 65: ('script_limits[]', 'Script limits', None), 66: ('tab_index[]', 'Set tab index', None), 69: ('file_attr[]', 'File attributes', None), 70: ('place_obj3[]', 'Place object 3', None), 71: ('import2[]', 'Import a definition list from another movie', None), 73: ('def_font_align[]', 'Define font alignment zones', None), 74: ('csm_txt_set[]', 'CSM text settings', None), 75: ('def_font3[]', 'Define font text 3', None), 77: ('metadata[]', 'XML code describing the movie', None), 78: ('def_scale_grid[]', 'Define scaling factors', None), 83: ('def_shape4[]', 'Define shape 4', None), 84: ('def_morph2[]', 'Define a morphing shape 2', None)}
...
class SwfFile(Parser):
    ...
    PARSER_TAGS = {'id': 'swf', 'category': 'container', 'file_ext': ['swf'], 'mime': ('application/x-shockwave-flash', ), 'min_size': 64, 'description': 'Macromedia Flash data'}
    PARSER_TAGS['magic'] = []
