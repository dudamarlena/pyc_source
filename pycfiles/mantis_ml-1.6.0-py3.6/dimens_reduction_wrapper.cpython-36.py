...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mantis_ml/modules/unsupervised_learn/dimens_reduction_wrapper.py
...
class DimensReductionWrapper(DimensionalityReduction):
    ...
    def run_pca(self, method='PCA'):
        ...
        self.plot_embedding_w_labels(pca_df, (self.highlighted_genes), 'PC1', 'PC2', plot_title=plot_title,
    ...
    def run_tsne(self, data_type='original_data'):
        ...
        if os.path.exists(stored_Xtsne_data):
            if not self.recalc:
        ...
        self.plot_embedding_w_labels(X_tsne, (self.highlighted_genes), 'd0', 'd1', plot_title=plot_title,
          filename_prefix=method,
          figsize=(14, 12))
    ...
    def run_umap(self, data_type='original_data'):
        ...
        if os.path.exists(stored_Xumap_data):
            if not self.recalc:
        ...
        self.plot_embedding_w_labels(X_umap, (self.highlighted_genes), 'd0', 'd1', plot_title=plot_title,
          filename_prefix=method,
          figsize=(14, 12))
