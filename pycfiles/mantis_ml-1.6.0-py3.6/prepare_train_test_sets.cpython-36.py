...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mantis_ml/modules/supervised_learn/core/prepare_train_test_sets.py
# Compiled at: 2019-11-29 07:27:29
...
class PrepareTrainTestSets:
    ...
    def get_balanced_train_test_sets(self, data, stratified_kfold=True, verbose=False, random_state=None):
        ...
        bal_sample_gen = BalancedDatasetRandomGenerator((self.cfg), data, (self.cfg.Y), (self.cfg.balancing_ratio), (self.cfg.kfold), random_state,
    ...
    def prepare_train_test_tables(self, train_data, test_data):
        ...
        return (
         X_train, y_train, train_gene_names, X_test, y_test, test_gene_names)