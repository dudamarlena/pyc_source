...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mantis_ml/modules/hypergeom_enrichment/consensus_predictions.py
# Compiled at: 2019-12-17 08:32:36
# Size of source mod 2**32: 8163 bytes
import matplotlib
matplotlib.use('agg')
import matplotlib.pyplot as plt, pandas as pd, sys, os
...
class Consensus_Gene_Predictions:
    ...
    def __init__(self, config_file, output_dir, top_ratio, gene_class):
        ...
        self.color_palette = {'Stacking':'#684392', 
         'ExtraTreesClassifier':'#35A037',  'SVC':'#651124',  'DNN':'#000000', 
         'RandomForestClassifier':'#1F7AB9',  'XGBoost':'#F07E21', 
         'GradientBoostingClassifier':'#E32321'}
        self.clf_alias = {'ExtraTreesClassifier':'ET',  'SVC':'SVC',  'DNN':'DNN',  'RandomForestClassifier':'RF', 
         'XGBoost':'XGB',  'GradientBoostingClassifier':'GB', 
         'Stacking':'Stacking'}
...
if __name__ == '__main__':
    ...
    top_ratio = sys.argv[3]
    gene_class = sys.argv[4]
