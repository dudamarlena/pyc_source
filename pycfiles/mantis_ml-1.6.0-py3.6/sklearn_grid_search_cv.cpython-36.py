...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mantis_ml/modules/supervised_learn/model_selection/sklearn_grid_search_cv.py
...
def fine_tune_tree_based_models(X_train, y_train, clf_id):
    ...
    if clf_id == 'ExtraTreesClassifier':
        ...
        if clf_id == 'RandomForestClassifier':
            model = RandomForestClassifier(n_estimators=100)
        else:
            if clf_id == 'GradientBoostingClassifier':
