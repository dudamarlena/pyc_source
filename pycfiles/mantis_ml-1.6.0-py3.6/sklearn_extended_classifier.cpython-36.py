...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mantis_ml/modules/supervised_learn/classifiers/sklearn_extended_classifier.py
# Compiled at: 2019-11-19 09:10:27
# Size of source mod 2**32: 4798 bytes
import pandas as pd, numpy as np, random, sys, matplotlib.pyplot as plt, seaborn as sns
...
class SklearnExtendedClassifier(GenericClassifier):
    ...
    def __init__(self, cfg, X_train, y_train, X_test, y_test, train_gene_names, test_gene_names, clf_id, clf_params, make_plots, verbose=False):
