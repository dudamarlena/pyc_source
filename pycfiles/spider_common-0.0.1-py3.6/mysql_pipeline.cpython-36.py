...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spider_common/persistent/scrapy/pipelines/mysql_pipeline.py
...
class ShopTable(Model):
    ...
    src = CharField(verbose_name='来源渠道', max_length=32, default='')
