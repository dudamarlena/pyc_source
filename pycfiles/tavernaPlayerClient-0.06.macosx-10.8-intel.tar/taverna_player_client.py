...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/tavernaplayerclient/taverna_player_client.py
# Compiled at: 2014-04-25 12:09:26
import requests, json, time, sys, urllib2
from IPython.display import HTML, display_html
from copy import deepcopy
from zipfile import ZipFile
import StringIO
__all__ = [
 'Client', 'Workflow', 'Run', 'RunTemplate']
