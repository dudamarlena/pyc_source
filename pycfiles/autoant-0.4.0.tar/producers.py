...
# [GCC 8.4.0]
# Embedded file name: autoant/producers.py
# Compiled at: 2014-09-25 09:54:48
import logging, datetime, os, time, re
...
class FileItem(object):
    ...
    def __eq__(self, other):
        if type(other) is type(self):
            return self.full_path == other.full_path and self.size == other.size and self.mtime == other.mtime
        return False

    def __repr__(self):
        return ('{0} size:{1}').format(as_unicode(self.full_path), self.size)
