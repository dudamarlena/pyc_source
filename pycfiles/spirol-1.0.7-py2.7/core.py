...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spirol/core.py
# Compiled at: 2015-01-09 08:26:21
...
class spirol_core(object):
    ...
    def __init__(self, array, size, spirol_type=SpirolType.SPIRAL_CIRCULAR_OUTSIDE_IN, verbose=False, print_max_items=NUM_MAX_ITEMS_TO_PRINT, **kwargs):
        """
        ...
        self._iterator = iterator(array, size=size, verbose=verbose, print_max_items=print_max_items, **kwargs)
