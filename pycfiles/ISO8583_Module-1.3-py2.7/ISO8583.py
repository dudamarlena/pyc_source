...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ISO8583/ISO8583.py
# Compiled at: 2013-10-08 07:35:33
"""
...
"""
    ...
    _BIT_POSITION_8 = 1
    _TMP = [
     0, _BIT_POSITION_8, _BIT_POSITION_1, _BIT_POSITION_2, _BIT_POSITION_3, _BIT_POSITION_4, _BIT_POSITION_5, _BIT_POSITION_6, _BIT_POSITION_7]
    _BIT_DEFAULT_VALUE = 0
    _BITS_VALUE_TYPE = {}
    _BITS_VALUE_TYPE[1] = [
     'BME', 'Bit Map Extended', 'B', 16, 'b']
    ...
    def __getBitmapFromStr(self, bitmap):
        ...
        for x in range(0, 32, 2):
            if int(bitmap[0:2], 16) & self._BIT_POSITION_1 != self._BIT_POSITION_1:
                if self.DEBUG == True:
