...
# Embedded file name: pysecret/aws.py
# Compiled at: 2020-04-18 15:07:41
...
class AWSSecret(object):
    ...
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None, aws_session_token=None, region_name=None, botocore_session=None, profile_name=None):
        self.ses = boto3.Session(aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key, aws_session_token=aws_session_token, region_name=region_name, botocore_session=botocore_session, profile_name=profile_name)
    ...
    def kms_encrypt(self, kms_key_id, text):
        ...
        :rtype: str
        """
        return base64.b64encode(self.kms_client.encrypt(KeyId=kms_key_id, Plaintext=base64.b64encode(text.encode('utf-8')))['CiphertextBlob']).decode('utf-8')
    ...
    def deploy_secret(self, name, secret_data, description=None, kms_key_id=None, tags=None):
        """
    ...
    def get_parameter_value(self, parameter_name, key, with_encryption=False):
        """
        ...
        if self.parameter_cache.get(parameter_name) is None:
            response = self.ssm_client.get_parameter(Name=parameter_name, WithDecryption=with_encryption)
    ...
    def deploy_parameter(self, name, parameter_data, description=None, kms_key_id=None, policies=None, tags=None):
        """
        Update parameter.
