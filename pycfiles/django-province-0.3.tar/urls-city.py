...
# [GCC 8.4.0]
# Embedded file name: /Users/ali/ownCloud/Project/python/aghoo/Aghoo/province/api/urls-city.py
...
urlpatterns = [
 ...
 url('^(?P<city_id>\\d+)/town/', include('province.api.urls-town', namespace='town-api'))]