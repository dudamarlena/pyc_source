...
# [GCC 8.4.0]
# Embedded file name: /home/warmonger/Develop/Github/python-dateconv/dateconv/__init__.py
# Compiled at: 2015-03-01 23:12:50
    ...
    if isinstance(value, str):
        ...
        if isinstance(value, datetime.datetime):
            ...
            if isinstance(value, int):
                ...
                raise DateConvException('Exception from dateconv: not define type of value: %s' % type(value))
    ...
    if isinstance(value, str):
        ...
        if isinstance(value, datetime.datetime):
            ...
            if isinstance(value, int):
                ...
                raise DateConvException('Exception from dateconv: not define type of value: %s' % type(value))
    offset = (datetime.datetime.fromtimestamp(unix_value) - datetime.datetime.utcfromtimestamp(unix_value)).total_seconds()
