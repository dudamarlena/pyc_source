...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/truffle/filetools.py
...
def get_scan_path(directory_tree, project_index):
    ...
    while len(stack) > 0:
        ...
        if _is_commentable(node_name):
            ...
            sorted_functions = sorted(unsorted_functions, key=lambda k: file_data[k]['lineno'], reverse=True)
