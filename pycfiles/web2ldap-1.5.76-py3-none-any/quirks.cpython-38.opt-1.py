...
# Compiled at: 2020-05-10 05:34:05
...
from web2ldap.app.schema.syntaxes import syntax_registry, Audio, AuthzDN, Binary, Boolean, CountryString, DirectoryString, DistinguishedName, DomainComponent, Integer, JPEGImage, LDAPUrl, OctetString, OID, PhotoG3Fax, PostalAddress, RFC822Address, Uri, UTCTime
...
syntax_registry.reg_at(Integer.oid, [
...
class NamingContexts(DistinguishedName):
    ...
    def _additional_links(self):
        ...
        res.append(self._app.anchor('dit', 'Tree', (
         (
          'dn', self.av_u),)))
