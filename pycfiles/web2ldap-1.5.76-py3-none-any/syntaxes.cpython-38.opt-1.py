...
# Compiled at: 2020-05-06 07:02:38
# Size of source mod 2**32: 88374 bytes
"""
...
class SyntaxRegistry:
    ...
    __slots__ = ('at2syntax', 'oid2syntax')
...
class LDAPSyntax:
    ...
    __slots__ = ('_app', '_at', '_at_b', '_av', '_av_u', '_dn', '_entry', '_schema')
    oid = ''
    oid: str
...
class GeneralizedTime(IA5String):
 ...
 L. 745         0  SETUP_FINALLY        18  'to 18'

 L. 746         2  LOAD_GLOBAL              web2ldap
                4  LOAD_ATTR                utctime
...
class Integer(IA5String):
 ...
 L. 934         0  SETUP_FINALLY        14  'to 14'

 L. 935         2  LOAD_GLOBAL              int
...
Parse error at or near `RETURN_VALUE' instruction at offset 80
 ...
 L. 945         0  SETUP_FINALLY        22  'to 22'

 L. 946         2  LOAD_GLOBAL              str
                4  LOAD_GLOBAL              int
...
class OID(IA5String):
    ...
    def valueButton(self, command, row, mode, link_text=None):
        at = self._at.lower()
        if at in {'objectclass', '2.5.21.9', '2.5.4.0', 'structuralobjectclass'}:
            return ''
 ...
 L.1242         0  SETUP_FINALLY        22  'to 22'

 L.1243         2  LOAD_GLOBAL              OID_REG
                4  LOAD_FAST                'self'
                6  LOAD_ATTR                av_u
                8  BINARY_SUBSCR    
 ...
 L.1245        40  SETUP_FINALLY        66  'to 66'

 L.1246        42  LOAD_FAST                'self'
               44  LOAD_ATTR                _schema
               46  LOAD_ATTR                get_obj

 L.1247        48  LOAD_GLOBAL              ObjectClass

 L.1248        50  LOAD_FAST                'self'
               52  LOAD_ATTR                av_u

 L.1249        54  LOAD_CONST               1

 L.1246        56  LOAD_CONST               ('raise_keyerror',)
 ...
 L.1252        80  SETUP_FINALLY       106  'to 106'

 L.1253        82  LOAD_FAST                'self'
               84  LOAD_ATTR                _schema
               86  LOAD_ATTR                get_obj

 L.1254        88  LOAD_GLOBAL              AttributeType

 L.1255        90  LOAD_FAST                'self'
               92  LOAD_ATTR                av_u

 L.1256        94  LOAD_CONST               1

 L.1253        96  LOAD_CONST               ('raise_keyerror',)
 ...
 L.1259       120  LOAD_GLOBAL              IA5String
 ...
 L.1260       148  LOAD_GLOBAL              schema_anchor

 L.1261       150  LOAD_FAST                'self'
              152  LOAD_ATTR                _app

 L.1262       154  LOAD_FAST                'self'
              156  LOAD_ATTR                av_u

 L.1263       158  LOAD_GLOBAL              AttributeType

 L.1264       160  LOAD_STR                 '{name}\n{anchor}'

 L.1265       162  LOAD_STR                 '&raquo'

 L.1260       164  LOAD_CONST               ('name_template', 'link_text')
 ...
 L.1272       216  LOAD_GLOBAL              schema_anchor

 L.1273       218  LOAD_FAST                'self'
              220  LOAD_ATTR                _app

 L.1274       222  LOAD_FAST                'self'
              224  LOAD_ATTR                av_u

 L.1275       226  LOAD_GLOBAL              ObjectClass

 L.1276       228  LOAD_FAST                'name_template'

 L.1277       230  LOAD_STR                 '&raquo'

 L.1272       232  LOAD_CONST               ('name_template', 'link_text')
 ...
 L.1279       244  LOAD_STR                 '<strong>%s</strong> (%s):<br>%s (see %s)'

 L.1280       246  LOAD_FAST                'self'
              248  LOAD_ATTR                _app
              250  LOAD_ATTR                form
 ...
 L.1281       258  LOAD_GLOBAL              IA5String
...
class SecondsSinceEpoch(Integer):
 ...
 L.1679        14  SETUP_FINALLY        46  'to 46'

 L.1680        16  LOAD_STR                 '%s (%s)'

 L.1681        18  LOAD_GLOBAL              strftimeiso8601
               20  LOAD_GLOBAL              time
 ...
 L.1682        36  LOAD_FAST                'int_str'

 L.1680        38  BUILD_TUPLE_2         2 
               40  BINARY_MODULO    
               42  POP_BLOCK        
               44  RETURN_VALUE     
...
class DaysSinceEpoch(Integer):
 ...
 L.1698        14  SETUP_FINALLY        50  'to 50'

 L.1699        16  LOAD_STR                 '%s (%s)'

 L.1700        18  LOAD_GLOBAL              strftimeiso8601
               20  LOAD_GLOBAL              time
               22  LOAD_METHOD              gmtime
               24  LOAD_GLOBAL              float
               26  LOAD_FAST                'self'
 ...
 L.1701        40  LOAD_FAST                'int_str'

 L.1699        42  BUILD_TUPLE_2         2 
               44  BINARY_MODULO    
               46  POP_BLOCK        
               48  RETURN_VALUE     
...
class DynamicValueSelectList(SelectList, DirectoryString):
 ...
 L.1922        18  LOAD_FAST                'av_u'
               20  LOAD_METHOD              startswith
               22  LOAD_FAST                'self'
               24  LOAD_ATTR                valuePrefix
               26  CALL_METHOD_1         1  ''

 L.1921        28  POP_JUMP_IF_FALSE    80  'to 80'

 L.1923        30  LOAD_FAST                'av_u'
               32  LOAD_METHOD              endswith
               34  LOAD_FAST                'self'
               36  LOAD_ATTR                valueSuffix
               38  CALL_METHOD_1         1  ''

 L.1921        40  POP_JUMP_IF_FALSE    80  'to 80'

 L.1924        42  LOAD_GLOBAL              len
               44  LOAD_FAST                'av_u'
 ...
 L.1921        54  POP_JUMP_IF_TRUE     80  'to 80'

 L.1925        56  LOAD_FAST                'self'
               58  LOAD_ATTR                maxLen
               60  LOAD_CONST               None
               62  COMPARE_OP               is-not

 L.1921        64  POP_JUMP_IF_FALSE    84  'to 84'

 L.1925        66  LOAD_GLOBAL              len
               68  LOAD_FAST                'av_u'
    ...
    def _get_attr_value_dict(self):
        ...
        if search_scope == ldap0.SCOPE_BASE:
            ...
            attr_values_u = [''.join((
             self.valuePrefix,
             attr_value,
             self.valueSuffix)) for attr_value in ldap_result[0].entry_s[list_attr]]
...
class UUID(IA5String):
 ...
 L.2312         0  SETUP_FINALLY        38  'to 38'

 L.2313         2  LOAD_GLOBAL              str
                4  LOAD_GLOBAL              uuid
                6  LOAD_METHOD              UUID
                8  LOAD_FAST                'attrValue'
...
class ComposedAttribute(LDAPSyntax):
 ...
 L.2558        22  LOAD_FAST                'self'
               24  LOAD_ATTR                compose_templates
               26  GET_ITER         
               28  FOR_ITER             94  'to 94'
               30  STORE_FAST               'template'

 L.2559        32  SETUP_FINALLY        64  'to 64'

 L.2560        34  LOAD_FAST                'template'
               36  LOAD_ATTR                format
               38  BUILD_TUPLE_0         0 
               40  LOAD_FAST                'entry'
 ...
 L.2566        94  LOAD_FAST                'attrValues'
               96  RETURN_VALUE     

 L.2567        98  LOAD_FAST                'attr_values'
              100  RETURN_VALUE     
               -1  RETURN_LAST      
