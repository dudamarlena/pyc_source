...
# Compiled at: 2020-05-10 05:50:07
# Size of source mod 2**32: 29066 bytes
"""
...
class LogonHours(OctetString):
    ...
    def sanitize(self, attrValue: bytes) -> bytes:
        ...
        res = [sum(hour_flags[i * 8:(i + 1) * 8]) for i in range(21)]
        return bytes(res)
...
syntax_registry.reg_at(DomainControllerFunctionality.oid, [
