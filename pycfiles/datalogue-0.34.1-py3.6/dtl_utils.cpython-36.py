...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/datalogue/dtl_utils.py
...
def generate_key(password: str, encryption_algorithm: EncryptionAlgorithm=EncryptionAlgorithm.AES_256) -> Union[(DtlError, str)]:
    """
