...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/doapfiend/model.py
# Compiled at: 2008-05-07 13:27:08
"""
...
class Project(rdfSubject):
    ...
    svn_repository = rdfSingle(DOAP.repository, 'svn_repository', range_type=DOAP.SVNRepository)
    cvs_repository = rdfSingle(DOAP.repository, 'cvs_repository', range_type=DOAP.CVSRepository)
