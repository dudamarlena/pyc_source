...
# Embedded file name: /Users/erikvw/.venvs/ambition/lib/python3.7/site-packages/ambition_validators/tests/test_lumbar_puncture_form_validator.py
# Compiled at: 2018-09-03 09:32:59
# Size of source mod 2**32: 14241 bytes
...
class TestLumbarPunctureFormValidator(TestCase):
    ...
    def setUp(self):
        self.subject_consent = SubjectConsent.objects.create(subject_identifier='11111111',
          gender='M',
          dob=((get_utcnow() - relativedelta(years=25)).date()))
        appointment = Appointment.objects.create(subject_identifier=(self.subject_consent.subject_identifier),
    ...
    def test_pressure(self):
        cleaned_data = {'subject_visit':self.subject_visit, 
         'opening_pressure':10, 
         'closing_pressure':9}
        form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
    ...
    def test_qc_culture_requisition_not_required_if_no_result(self):
        ...
        requisition = SubjectRequisition.objects.create(subject_visit=(self.subject_visit),
          panel=panel)
        ...
        form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
          instance=(LumbarPunctureCsf()))
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('This field is not required', str(form_validator._errors.get('qc_requisition')))
    ...
    def test_qc_assay_datetime_not_required_if_no_result(self):
        ...
        form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
          instance=(LumbarPunctureCsf()))
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('This field is not required', str(form_validator._errors.get('qc_assay_datetime')))
    ...
    def test_qc_culture_requisition_required_if_value(self):
        ...
        form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
          instance=(LumbarPunctureCsf()))
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('This field is required', str(form_validator._errors.get('qc_requisition')))
    ...
    def test_qc_assay_datetime_required_if_value(self):
        ...
        form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
          instance=(LumbarPunctureCsf()))
        self.assertRaises(ValidationError, form_validator.validate)
        self.assertIn('This field is required', str(form_validator._errors.get('qc_assay_datetime')))
    ...
    def test_csf_wbc_cell_count_not_required_day3(self):
        cleaned_data = {'subject_visit':self.subject_visit_d3, 
         'csf_wbc_cell_count':None}
        form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
          instance=(LumbarPunctureCsf()))
        try:
    ...
    def test_csf_wbc_cell_count_min_max(self):
        for i in range(0, 5):
            cleaned_data = {'subject_visit':self.subject_visit_d3,  'csf_wbc_cell_count':i}
            form_validator = LumbarPunctureCsfFormValidator(cleaned_data=cleaned_data,
              instance=(LumbarPunctureCsf()))
            try:
                form_validator.validate()
    ...
    def test_differential_neutrophil_count_percent_limit_passed(self):
        ...
        self.assertIn('Cannot be greater than 100%', str(form_validator._errors.get('differential_neutrophil_count')))
    ...
    def test_differential_lymphocyte_count_percent_limit_passed(self):
        ...
        self.assertIn('Cannot be greater than 100%', str(form_validator._errors.get('differential_lymphocyte_count')))
