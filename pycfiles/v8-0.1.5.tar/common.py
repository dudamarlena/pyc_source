...
# [GCC 8.4.0]
# Embedded file name: /home/lex/projects/python-v8/libv8/build/gyp/pylib/gyp/common.py
# Compiled at: 2014-04-20 15:47:30
from __future__ import with_statement
import errno, filecmp, os.path, re, tempfile, sys
...
def RelativePath(path, relative_to):
    ...
    relative_split = [
     os.path.pardir] * (len(relative_to_split) - prefix_len) + path_split[prefix_len:]
