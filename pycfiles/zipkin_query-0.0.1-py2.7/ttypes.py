...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/zipkin_query/zipkinQuery/ttypes.py
# Compiled at: 2014-12-11 03:29:26
from thrift.Thrift import TType, TMessageType, TException, TApplicationException
import zipkinCore.ttypes, zipkinDependencies.ttypes
...
class Order:
    ...
    DURATION_DESC = 3
    NONE = 4
    _VALUES_TO_NAMES = {0: 'TIMESTAMP_DESC', 
       1: 'TIMESTAMP_ASC', 
       2: 'DURATION_ASC', 
       3: 'DURATION_DESC', 
       4: 'NONE'}
    _NAMES_TO_VALUES = {'TIMESTAMP_DESC': 0, 
       'TIMESTAMP_ASC': 1, 
       'DURATION_ASC': 2, 
       'DURATION_DESC': 3, 
       'NONE': 4}
...
class Adjust:
  ...
  """
    NOTHING = 0
    TIME_SKEW = 1
    _VALUES_TO_NAMES = {0: 'NOTHING', 
       1: 'TIME_SKEW'}
    _NAMES_TO_VALUES = {'NOTHING': 0, 
       'TIME_SKEW': 1}
...
class Trace:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'spans', (TType.STRUCT, (zipkinCore.ttypes.Span, zipkinCore.ttypes.Span.thrift_spec)), None))
...
class TraceSummary:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'trace_id', None, None),
     (
      2, TType.I64, 'start_timestamp', None, None),
     (
      3, TType.I64, 'end_timestamp', None, None),
     (
      4, TType.I32, 'duration_micro', None, None),
     (
      5, TType.MAP, 'service_counts', (TType.STRING, None, TType.I32, None), None),
     (
      6, TType.LIST, 'endpoints', (TType.STRUCT, (zipkinCore.ttypes.Endpoint, zipkinCore.ttypes.Endpoint.thrift_spec)), None))
...
class TimelineAnnotation:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'timestamp', None, None),
     (
      2, TType.STRING, 'value', None, None),
     (
      3, TType.STRUCT, 'host', (zipkinCore.ttypes.Endpoint, zipkinCore.ttypes.Endpoint.thrift_spec), None),
     (
      4, TType.I64, 'span_id', None, None),
     (
      5, TType.I64, 'parent_id', None, None),
     (
      6, TType.STRING, 'service_name', None, None),
     (
      7, TType.STRING, 'span_name', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.I64, 'trace_id', None, None),
     (
      2, TType.I64, 'root_most_span_id', None, None),
     None,
     None,
     None,
     (
      6, TType.LIST, 'annotations', (TType.STRUCT, (TimelineAnnotation, TimelineAnnotation.thrift_spec)), None),
     (
      7, TType.LIST, 'binary_annotations', (TType.STRUCT, (zipkinCore.ttypes.BinaryAnnotation, zipkinCore.ttypes.BinaryAnnotation.thrift_spec)), None))
...
class TraceCombo:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'trace', (Trace, Trace.thrift_spec), None),
     (
      2, TType.STRUCT, 'summary', (TraceSummary, TraceSummary.thrift_spec), None),
     (
      3, TType.STRUCT, 'timeline', (TraceTimeline, TraceTimeline.thrift_spec), None),
     (
      4, TType.MAP, 'span_depths', (TType.I64, None, TType.I32, None), None))
...
class QueryRequest:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'service_name', None, None),
     (
      2, TType.STRING, 'span_name', None, None),
     (
      3, TType.LIST, 'annotations', (TType.STRING, None), None),
     (
      4, TType.LIST, 'binary_annotations', (TType.STRUCT, (zipkinCore.ttypes.BinaryAnnotation, zipkinCore.ttypes.BinaryAnnotation.thrift_spec)), None),
     (
      5, TType.I64, 'end_ts', None, None),
     (
      6, TType.I32, 'limit', None, None),
     (
      7, TType.I32, 'order', None, None),
     (
      8, TType.I64, 'start_ts', None, None))

    def __init__(self, service_name=None, span_name=None, annotations=None, binary_annotations=None, end_ts=None, limit=None, order=None, start_ts=None):
        self.service_name = service_name
        self.span_name = span_name
        self.annotations = annotations
        self.binary_annotations = binary_annotations
...
class QueryResponse:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'trace_ids', (TType.I64, None), None),
     (
      2, TType.I64, 'start_ts', None, None),
     (
      3, TType.I64, 'end_ts', None, None))
