...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/zipkin_query/zipkinQuery/ZipkinQuery.py
# Compiled at: 2014-12-11 03:07:31
...
class getTraceIds_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'request', (QueryRequest, QueryRequest.thrift_spec), None))
...
class getTraceIds_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (QueryResponse, QueryResponse.thrift_spec), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class getTraceIdsBySpanName_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      4, TType.I64, 'end_ts', None, None),
     (
      5, TType.I32, 'limit', None, None),
     (
      6, TType.I32, 'order', None, None),
     (
      7, TType.I64, 'start_ts', None, 0))
...
class getTraceIdsBySpanName_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.I64, None), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class getTraceIdsByServiceName_args():
  ...
  """
    thrift_spec = (
     ...
     (
      4, TType.I32, 'limit', None, None),
     (
      5, TType.I32, 'order', None, None),
     (
      6, TType.I64, 'start_ts', None, 0))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'service_name', None, None),
     (
      2, TType.STRING, 'annotation', None, None),
     (
...
class tracesExist_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.SET, 'success', (TType.I64, None), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.LIST, 'trace_ids', (TType.I64, None), None),
     (
      2, TType.LIST, 'adjust', (TType.I32, None), None))
...
class getTracesByIds_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (Trace, Trace.thrift_spec)), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class getTraceTimelinesByIds_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (TraceTimeline, TraceTimeline.thrift_spec)), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class getTraceSummariesByIds_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (TraceSummary, TraceSummary.thrift_spec)), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class getTraceCombosByIds_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (TraceCombo, TraceCombo.thrift_spec)), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class setTraceTimeToLive_args():
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.I32, 'ttl_seconds', None, None))
...
class getDependencies_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'start_time', None, None),
     (
      2, TType.I64, 'end_time', None, None))
...
class getDependencies_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (zipkinDependencies.ttypes.Dependencies, zipkinDependencies.ttypes.Dependencies.thrift_spec), None),
     (
      1, TType.STRUCT, 'qe', (QueryException, QueryException.thrift_spec), None))
...
class getSpanDurations_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'time_stamp', None, None),
     (
      2, TType.STRING, 'service_name', None, None),
     (
      3, TType.STRING, 'rpc_name', None, None))
...
class getSpanDurations_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.MAP, 'success', (TType.STRING, None, TType.LIST, (TType.I64, None)), None),)
