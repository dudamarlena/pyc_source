...
# [GCC 8.4.0]
# Embedded file name: /home/fatfrog/Documents/backmap/.eggs/setuptools_scm-2.0.0-py3.6.egg/setuptools_scm/utils.py
...
import warnings, sys, shlex, subprocess, os, io, platform
...
def _popen_pipes(cmd, cwd):
    return subprocess.Popen(cmd,
      ...
      cwd=(str(cwd)),
      env=(_always_strings(dict((os.environ),
      LC_ALL='C',
      LANGUAGE='',
      HGPLAIN='1'))))
