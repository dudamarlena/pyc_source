...
# [GCC 8.4.0]
# Embedded file name: ./local_imports/Geometry.py
# Compiled at: 2017-12-27 22:12:18
...
class AlaGeo(Geo):
    ...
    def __init__(self):
        ...
        self.N_C_CA_CB_diangle = 122.686
        self.residue_name = 'A'


class SarGeo(Geo):
    """Geometry of Sarcosine, the first Peptoid!"""

    def __init__(self):
        self.C_N_length = numpy.float64(1.345)
        self.CA_N_length = numpy.float64(1.46)
        self.CA_C_length = numpy.float64(1.52)
        self.N_CA_C_angle = numpy.float64(111.068)
        self.N_C_length = self.C_N_length
        self.C_N_length = numpy.float64(1.345)
        self.CA_N_length = numpy.float64(1.46)
        self.CA_C_length = numpy.float64(1.52)
        self.N_CA_C_angle = numpy.float64(111.068)
        self.N_C_length = self.C_N_length
        self.C_O_length = numpy.float64(1.23)
        self.CA_C_O_angle = numpy.float64(120.5)
        self.N_CA_C_O_diangle = numpy.float64(-60.5)
        self.phi = numpy.float64(-120.0)
        self.psi_im1 = numpy.float64(140.0)
        self.omega = numpy.float64(180.0)
        self.peptide_bond = numpy.float64(1.33)
        self.CA_C_N_angle = numpy.float64(116.642992978143)
        self.C_N_CA_angle = numpy.float64(121.382215820277)
        self.N_CB_length = numpy.float64(1.43)
        self.CA_N_CB_angle = numpy.float64(120.0)
        self.CA_N_C_minus_one_angle = numpy.float64(120.0)
        self.C_minus_one_CA_N_CB_diangle = numpy.float64(180.0)
        self.C_CA_N_CB_diangle = numpy.float64(0.0)
        self.residue_name = 'SAR'
