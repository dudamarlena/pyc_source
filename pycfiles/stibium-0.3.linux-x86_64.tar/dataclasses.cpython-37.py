...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/stibium/dataclasses.py
...
@attr.s
class Thread(object):
    __doc__ = "Class for containing thread's type and id"
...
class Message(object):
    __doc__ = 'Class for received messages'
    mid = attr.ib()
    text = attr.ib()
