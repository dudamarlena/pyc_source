...
# [GCC 8.4.0]
# Embedded file name: /Users/nmadnani/work/gridmap/examples/map_reduce.py
# Compiled at: 2017-12-05 09:15:36
...
def main():
    ...
    args = [
     3, 5, 10, 20]
    intermediate_results = grid_map(computeFactorial, args, quiet=False, max_processes=4,
      queue='all.q')
