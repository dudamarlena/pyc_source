...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/rect/rect.py
# Compiled at: 2007-07-28 09:49:02
...
class Rect(object):
    ...
    def intersects(self, other):
        ...
        if self.left > other.left + other.width:
            return False
        if self.bottom > other.bottom + other.height:
            return False
        if self.left + self.width < other.left:
            return False
        if self.bottom + self.height < other.bottom:
            return False
        return True
