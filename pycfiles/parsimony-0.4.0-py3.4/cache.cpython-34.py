...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/parsimony/persistence/cache.py
# Compiled at: 2014-12-21 10:47:27
# Size of source mod 2**32: 1670 bytes
from abc import ABCMeta, abstractmethod

class Cache(metaclass=ABCMeta):
    __doc__ = "Interface of a Cache object.  Cache's are responsible for persisting parameter values\n    and determining parameter equality.\n    "
