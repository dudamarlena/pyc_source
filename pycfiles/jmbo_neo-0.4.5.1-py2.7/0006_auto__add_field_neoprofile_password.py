...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neo/migrations/0006_auto__add_field_neoprofile_password.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('neo_neoprofile', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
