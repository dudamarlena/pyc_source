...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neo/migrations/0005_add_field_neoprofile_login_alias.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('neo_neoprofile', 'login_alias', self.gf('django.db.models.fields.CharField')(null=False, unique=True, max_length=50))

    def backwards(self, orm):
        db.alter_column('neo_neoprofile', 'login_alias', self.gf('django.db.models.fields.CharField')(null=True, unique=True, max_length=50))
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'neo.neoprofile': {'Meta': {'object_name': 'NeoProfile'}, 'consumer_id': (
                                        'django.db.models.fields.PositiveIntegerField', [], {'primary_key': 'True'}), 
                          'login_alias': (
