...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neo/migrations/0008_auto__add_field_neoprofile_created.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('neo_neoprofile', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 11, 0, 0), blank=True), keep_default=False)
