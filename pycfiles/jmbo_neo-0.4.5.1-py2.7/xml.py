...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neo/xml.py
# Compiled at: 2013-05-03 05:25:56
import sys, getopt, re as re_
etree_ = None
...
class QuestionAnswerType(GeneratedsSuper):
    ...
    def insert_Answer(self, index, value):
    ...
    def hasContent_(self):
        if self.QuestionID is not None or self.Answer:
            return True
        return False
        return
...
class AnswerType(GeneratedsSuper):
    ...
    def get_ModifyFlag(self):
        return self.ModifyFlag

    def set_ModifyFlag(self, ModifyFlag):
        self.ModifyFlag = ModifyFlag
    ...
    def get_DrinkCategoryID(self):
        return self.DrinkCategoryID

    def set_DrinkCategoryID(self, DrinkCategoryID):
        self.DrinkCategoryID = DrinkCategoryID

    def validate_DrinkCategoryID(self, value):
        pass

    def get_CommunicationChannel(self):
        return self.CommunicationChannel

    def set_CommunicationChannel(self, CommunicationChannel):
        self.CommunicationChannel = CommunicationChannel
    ...
    def set_AnswerText(self, AnswerText):
        self.AnswerText = AnswerText
    ...
    def hasContent_(self):
        if self.OptionID is not None or self.ModifyFlag is not None or self.BrandID is not None or self.DrinkCategoryID is not None or self.CommunicationChannel is not None or self.AnswerText is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'OptionID':
            ...
            self.validate_ModifyFlag(self.ModifyFlag)
            ...
            self.BrandID = ival_
            self.validate_BrandID(self.BrandID)
            ...
            self.validate_DrinkCategoryID(self.DrinkCategoryID)
            ...
            self.validate_CommunicationChannel(self.CommunicationChannel)
            ...
            self.validate_AnswerText(self.AnswerText)
...
class EmailDetailsType(GeneratedsSuper):
    ...
    def get_EmailCategory(self):
        return self.EmailCategory

    def set_EmailCategory(self, EmailCategory):
        self.EmailCategory = EmailCategory

    def validate_EmailCategory(self, value):
        pass

    def get_IsDefaultFlag(self):
        return self.IsDefaultFlag

    def set_IsDefaultFlag(self, IsDefaultFlag):
        self.IsDefaultFlag = IsDefaultFlag
    ...
    def hasContent_(self):
        if self.Id is not None or self.EmailId is not None or self.EmailCategory is not None or self.IsDefaultFlag is not None or self.ModifyFlag is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Id':
            ...
            self.validate_EmailId(self.EmailId)
            ...
            self.validate_EmailCategory(self.EmailCategory)
            ...
            self.validate_IsDefaultFlagType(self.IsDefaultFlag)
        elif nodeName_ == 'ModifyFlag':
            ModifyFlag_ = child_.text
            ModifyFlag_ = self.gds_validate_string(ModifyFlag_, node, 'ModifyFlag')
            self.ModifyFlag = ModifyFlag_
...
class UserAccountType(GeneratedsSuper):
    ...
    def get_LoginCredentials(self):
        return self.LoginCredentials

    def set_LoginCredentials(self, LoginCredentials):
        self.LoginCredentials = LoginCredentials

    def get_SecretQuestions(self):
        return self.SecretQuestions

    def set_SecretQuestions(self, SecretQuestions):
        self.SecretQuestions = SecretQuestions
    ...
    def hasContent_(self):
        if self.LoginCredentials is not None or self.SecretQuestions is not None:
            return True
        return False
        return
...
class LoginCredentialsType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.LoginName is not None or self.Password is not None:
            return True
        return False
        return
...
class UserIdentificationDataType(GeneratedsSuper):
    ...
    def set_TempToken(self, TempToken):
        self.TempToken = TempToken
    ...
    def hasContent_(self):
        if self.ConsumerID is not None or self.LoginName is not None or self.EmailID is not None or self.TempToken is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ConsumerID':
            ...
            self.validate_ConsumerIDType(self.ConsumerID)
        elif nodeName_ == 'LoginName':
            LoginName_ = child_.text
            LoginName_ = self.gds_validate_string(LoginName_, node, 'LoginName')
            self.LoginName = LoginName_
            self.validate_Name(self.LoginName)
        elif nodeName_ == 'EmailID':
            EmailID_ = child_.text
            EmailID_ = self.gds_validate_string(EmailID_, node, 'EmailID')
            self.EmailID = EmailID_
            ...
            self.validate_Token(self.TempToken)
...
class ExtendedOptInPreferencesType(GeneratedsSuper):
    ...
    def get_AcquisitionSource(self):
        return self.AcquisitionSource

    def set_AcquisitionSource(self, AcquisitionSource):
        self.AcquisitionSource = AcquisitionSource

    def validate_AcquisitionSourceType(self, value):
        pass

    def get_QuestionCategory(self):
        return self.QuestionCategory

    def set_QuestionCategory(self, QuestionCategory):
        self.QuestionCategory = QuestionCategory

    def add_QuestionCategory(self, value):
        self.QuestionCategory.append(value)

    def insert_QuestionCategory(self, index, value):
        self.QuestionCategory[index] = value
    ...
    def hasContent_(self):
        if self.PromoCode is not None or self.AcquisitionSource is not None or self.QuestionCategory:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PromoCode':
            ...
            self.validate_PromoCodeDesc(self.PromoCode)
            ...
            self.validate_AcquisitionSourceType(self.AcquisitionSource)
...
class CategoryType(GeneratedsSuper):
    ...
    def get_QuestionAnswers(self):
        return self.QuestionAnswers

    def set_QuestionAnswers(self, QuestionAnswers):
        self.QuestionAnswers = QuestionAnswers

    def add_QuestionAnswers(self, value):
        self.QuestionAnswers.append(value)

    def insert_QuestionAnswers(self, index, value):
        self.QuestionAnswers[index] = value
    ...
    def hasContent_(self):
        if self.CategoryID is not None or self.QuestionAnswers:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CategoryID':
            ...
            self.validate_QuestionCategory(self.CategoryID)
...
class Emails(GeneratedsSuper):
    ...
    def insert_Email(self, index, value):
    ...
    def hasContent_(self):
        if self.Email or self.ConsumerID is not None or self.PromoCode is not None or self.AcquisitionSource is not None:
            return True
        return False
        return
...
class AttachmentType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.FileName is not None or self.FileContent is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'FileName':
            ...
            self.validate_FileContentType(self.FileContent)
...
class EmailType(GeneratedsSuper):
    ...
    def set_ToAddress(self, ToAddress):
        self.ToAddress = ToAddress

    def add_ToAddress(self, value):
        self.ToAddress.append(value)

    def insert_ToAddress(self, index, value):
        self.ToAddress[index] = value
    ...
    def set_FromAddress(self, FromAddress):
        self.FromAddress = FromAddress
    ...
    def set_EmailBody(self, EmailBody):
        self.EmailBody = EmailBody
    ...
    def insert_Attachment(self, index, value):
        self.Attachment[index] = value

    def get_UnsolicitedEmailFlag(self):
        return self.UnsolicitedEmailFlag

    def set_UnsolicitedEmailFlag(self, UnsolicitedEmailFlag):
        self.UnsolicitedEmailFlag = UnsolicitedEmailFlag
    ...
    def hasContent_(self):
        if self.ToAddress or self.FromAddress is not None or self.Subject is not None or self.EmailBody is not None or self.Attachment or self.UnsolicitedEmailFlag is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ToAddress':
            ...
            self.validate_EmailId(self.ToAddress)
            ...
            self.validate_EmailId(self.FromAddress)
            ...
            self.validate_EmailBody(self.EmailBody)
            ...
            self.validate_UnsolicitedEmailFlagType(self.UnsolicitedEmailFlag)
...
class SendToFriendType(GeneratedsSuper):
    ...
    def get_EmailDetails(self):
        return self.EmailDetails

    def set_EmailDetails(self, EmailDetails):
        self.EmailDetails = EmailDetails

    def get_ReferralDetails(self):
        return self.ReferralDetails

    def set_ReferralDetails(self, ReferralDetails):
        self.ReferralDetails = ReferralDetails
    ...
    def hasContent_(self):
        if self.EmailDetails is not None or self.ReferralDetails is not None:
            return True
        return False
        return
...
class ReferralType(GeneratedsSuper):
    ...
    def get_SenderFriendName(self):
        return self.SenderFriendName

    def set_SenderFriendName(self, SenderFriendName):
        self.SenderFriendName = SenderFriendName

    def validate_FullName(self, value):
        pass

    def get_ReferralURL(self):
        return self.ReferralURL

    def set_ReferralURL(self, ReferralURL):
        self.ReferralURL = ReferralURL
    ...
    def hasContent_(self):
        if self.SenderFriendName is not None or self.ReferralURL is not None or self.ConsumerID is not None or self.PromoCode is not None or self.AcquisitionSource is not None or self.CommunicationChannel is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'SenderFriendName':
            ...
            self.validate_FullName(self.SenderFriendName)
            ...
            self.validate_URL(self.ReferralURL)
        elif nodeName_ == 'ConsumerID':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
...
class ContactUsDetailsType(GeneratedsSuper):
    ...
    def get_ContactUsDetail(self):
        return self.ContactUsDetail

    def set_ContactUsDetail(self, ContactUsDetail):
        self.ContactUsDetail = ContactUsDetail

    def add_ContactUsDetail(self, value):
        self.ContactUsDetail.append(value)

    def insert_ContactUsDetail(self, index, value):
        self.ContactUsDetail[index] = value
...
class ContactUsDetailType(GeneratedsSuper):
    ...
    def get_ContactUsID(self):
        return self.ContactUsID

    def set_ContactUsID(self, ContactUsID):
        self.ContactUsID = ContactUsID
    ...
    def hasContent_(self):
        if self.ContactUsID is not None or self.Status is not None or self.ConsumerID is not None or self.PromoCode is not None or self.AcquisitionSource is not None or self.Email is not None or self.Remarks is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ContactUsID':
            ...
            self.validate_ConsumerIDType(self.ContactUsID)
            ...
            self.validate_RemarkType(self.Remarks)
...
class AddressDetailsType(GeneratedsSuper):
    ...
    def get_StateOther(self):
        return self.StateOther

    def set_StateOther(self, StateOther):
        self.StateOther = StateOther
    ...
    def hasContent_(self):
        if self.AddressID is not None or self.Address1 is not None or self.Address2 is not None or self.Address3 is not None or self.Address4 is not None or self.City is not None or self.State is not None or self.Country is not None or self.ZipCode is not None or self.AddressType is not None or self.StateOther is not None or self.ModifyFlag is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'AddressID':
            ...
            self.validate_Address3(self.Address3)
            ...
            self.validate_AddressType(self.AddressType)
            ...
            self.validate_StateName(self.StateOther)
        elif nodeName_ == 'ModifyFlag':
            ModifyFlag_ = child_.text
            ModifyFlag_ = self.gds_validate_string(ModifyFlag_, node, 'ModifyFlag')
            self.ModifyFlag = ModifyFlag_
...
class ConsumerProfileType(GeneratedsSuper):
    ...
    def get_AlternateFirstName(self):
        return self.AlternateFirstName

    def set_AlternateFirstName(self, AlternateFirstName):
        self.AlternateFirstName = AlternateFirstName

    def get_AlternateLastName(self):
        return self.AlternateLastName

    def set_AlternateLastName(self, AlternateLastName):
        self.AlternateLastName = AlternateLastName
    ...
    def get_AlternateMiddleName(self):
        return self.AlternateMiddleName

    def set_AlternateMiddleName(self, AlternateMiddleName):
        self.AlternateMiddleName = AlternateMiddleName

    def get_MaternalLastName(self):
        return self.MaternalLastName

    def set_MaternalLastName(self, MaternalLastName):
        self.MaternalLastName = MaternalLastName

    def get_AlternateMaternalLastName(self):
        return self.AlternateMaternalLastName

    def set_AlternateMaternalLastName(self, AlternateMaternalLastName):
        self.AlternateMaternalLastName = AlternateMaternalLastName
    ...
    def get_AlternateSuffix(self):
        return self.AlternateSuffix

    def set_AlternateSuffix(self, AlternateSuffix):
        self.AlternateSuffix = AlternateSuffix
    ...
    def insert_Address(self, index, value):
    ...
    def insert_Phone(self, index, value):
    ...
    def hasContent_(self):
        if self.Title is not None or self.FirstName is not None or self.LastName is not None or self.AlternateFirstName is not None or self.AlternateLastName is not None or self.DOB is not None or self.Gender is not None or self.MaritalStatus is not None or self.NationalID is not None or self.PassportNumber is not None or self.Education is not None or self.Profession is not None or self.Suffix is not None or self.Company is not None or self.MiddleName is not None or self.AlternateMiddleName is not None or self.MaternalLastName is not None or self.AlternateMaternalLastName is not None or self.AlternateTitle is not None or self.AlternateSuffix is not None or self.Address or self.Phone or self.PromoCode is not None or self.AcquisitionSource is not None or self.Email:
            return True
        else:
            return False
            return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Title':
            ...
            self.validate_LastName(self.LastName)
            ...
            self.validate_FirstName(self.AlternateFirstName)
            ...
            self.validate_LastName(self.AlternateLastName)
        elif nodeName_ == 'DOB':
            DOB_ = child_.text
            DOB_ = self.gds_validate_string(DOB_, node, 'DOB')
            self.DOB = DOB_
            self.validate_Date(self.DOB)
            ...
            self.validate_MaritalStatus(self.MaritalStatus)
            ...
            self.validate_NationalID(self.NationalID)
            ...
            self.validate_PassportNumber(self.PassportNumber)
            ...
            self.validate_Education(self.Education)
            ...
            self.validate_MiddleName(self.MiddleName)
            ...
            self.validate_MiddleName(self.AlternateMiddleName)
            ...
            self.validate_LastName(self.MaternalLastName)
            ...
            self.validate_LastName(self.AlternateMaternalLastName)
            ...
            self.validate_Title(self.AlternateTitle)
            ...
            self.validate_Suffix(self.AlternateSuffix)
...
class PhoneDetailsType(GeneratedsSuper):
    ...
    def set_PhoneID(self, PhoneID):
        self.PhoneID = PhoneID

    def get_InternationalCode(self):
        return self.InternationalCode

    def set_InternationalCode(self, InternationalCode):
        self.InternationalCode = InternationalCode
    ...
    def hasContent_(self):
        if self.PhoneID is not None or self.InternationalCode is not None or self.AreaCode is not None or self.PhoneNumber is not None or self.PhoneType is not None or self.Extension is not None or self.ModifyFlag is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PhoneID':
            ...
            self.validate_AreaCode(self.InternationalCode)
            ...
            self.validate_AreaCode(self.AreaCode)
            ...
            self.validate_PhoneType(self.PhoneType)
            ...
            self.validate_AreaCode(self.Extension)
        elif nodeName_ == 'ModifyFlag':
            ModifyFlag_ = child_.text
            ModifyFlag_ = self.gds_validate_string(ModifyFlag_, node, 'ModifyFlag')
            self.ModifyFlag = ModifyFlag_
...
class Consumer(GeneratedsSuper):
    ...
    def get_ConsumerProfile(self):
        return self.ConsumerProfile

    def set_ConsumerProfile(self, ConsumerProfile):
        self.ConsumerProfile = ConsumerProfile
    ...
    def set_SocialNetworks(self, SocialNetworks):
        self.SocialNetworks = SocialNetworks

    def get_ConversionLocations(self):
        return self.ConversionLocations

    def set_ConversionLocations(self, ConversionLocations):
        self.ConversionLocations = ConversionLocations

    def get_FacebookConnect(self):
        return self.FacebookConnect

    def set_FacebookConnect(self, FacebookConnect):
        self.FacebookConnect = FacebookConnect

    def get_DigitalInteractions(self):
        return self.DigitalInteractions

    def set_DigitalInteractions(self, DigitalInteractions):
        self.DigitalInteractions = DigitalInteractions

    def get_ExtendedProfile(self):
        return self.ExtendedProfile

    def set_ExtendedProfile(self, ExtendedProfile):
        self.ExtendedProfile = ExtendedProfile

    def get_ExtendedOptInPreferences(self):
        return self.ExtendedOptInPreferences

    def set_ExtendedOptInPreferences(self, ExtendedOptInPreferences):
        self.ExtendedOptInPreferences = ExtendedOptInPreferences

    def get_HubLifeStyles(self):
        return self.HubLifeStyles

    def set_HubLifeStyles(self, HubLifeStyles):
        self.HubLifeStyles = HubLifeStyles

    def get_UserAccount(self):
        return self.UserAccount

    def set_UserAccount(self, UserAccount):
        self.UserAccount = UserAccount
    ...
    def hasContent_(self):
        if self.ConsumerProfile is not None or self.Preferences is not None or self.SocialNetworks is not None or self.ConversionLocations is not None or self.FacebookConnect is not None or self.DigitalInteractions is not None or self.ExtendedProfile is not None or self.ExtendedOptInPreferences is not None or self.HubLifeStyles is not None or self.UserAccount is not None:
            return True
        return False
        return
...
class ConsumerSearchProfileType(GeneratedsSuper):
    ...
    def get_CountryOfResidence(self):
        return self.CountryOfResidence

    def set_CountryOfResidence(self, CountryOfResidence):
        self.CountryOfResidence = CountryOfResidence

    def get_SearchBy_EmailOrMobile(self):
        return self.SearchBy_EmailOrMobile

    def set_SearchBy_EmailOrMobile(self, SearchBy_EmailOrMobile):
        self.SearchBy_EmailOrMobile = SearchBy_EmailOrMobile

    def get_EmailOrMobile(self):
        return self.EmailOrMobile

    def set_EmailOrMobile(self, EmailOrMobile):
        self.EmailOrMobile = EmailOrMobile
    ...
    def hasContent_(self):
        if self.DOB is not None or self.CountryOfResidence is not None or self.SearchBy_EmailOrMobile is not None or self.EmailOrMobile is not None:
            return True
        return False
        return
...
class LoginDetails(GeneratedsSuper):
    ...
    def get_LastLoginSuccess(self):
        return self.LastLoginSuccess

    def set_LastLoginSuccess(self, LastLoginSuccess):
        self.LastLoginSuccess = LastLoginSuccess
    ...
    def hasContent_(self):
        if self.ConsumerID is not None or self.LoginName is not None or self.LastLoginSuccess is not None or self.LastLoginTime is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ConsumerID':
            ...
            self.validate_LoginSuccessFlagType(self.LastLoginSuccess)
            ...
            self.validate_LoginTimeType(self.LastLoginTime)
...
class UnsubscribePreferencesType(GeneratedsSuper):
    ...
    def get_ConsumerDetails(self):
        return self.ConsumerDetails

    def set_ConsumerDetails(self, ConsumerDetails):
        self.ConsumerDetails = ConsumerDetails
    ...
    def insert_Preference(self, index, value):
    ...
    def hasContent_(self):
        if self.ConsumerDetails is not None or self.Preference:
            return True
        return False
        return
...
class UnsubscribePreferenceType(GeneratedsSuper):
    ...
    def get_OptionDetails(self):
        return self.OptionDetails

    def set_OptionDetails(self, OptionDetails):
        self.OptionDetails = OptionDetails
    ...
    def hasContent_(self):
        if self.QuestionID is not None or self.OptionID is not None or self.OptionDetails is not None or self.BrandID is not None or self.CommunicationChannel is not None:
            return True
        return False
        return
...
class CommunicationChannelDetailsType(GeneratedsSuper):
    ...
    def add_Postal(self, value):
        self.Postal.append(value)

    def insert_Postal(self, index, value):
        self.Postal[index] = value
    ...
    def hasContent_(self):
        if self.Postal or self.Email or self.Phone:
            return True
        return False
...
class ConsumerDetailsType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.Title is not None or self.Suffix is not None or self.FirstName is not None or self.MiddleName is not None or self.LastName is not None or self.MaternalLastName is not None or self.DOB is not None or self.CountryOfResidence is not None or self.PromoCode is not None or self.AcquisitionSource is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Title':
            ...
            CountryOfResidence_ = self.gds_validate_string(CountryOfResidence_, node, 'CountryOfResidence')
            self.CountryOfResidence = CountryOfResidence_
            self.validate_CountryName(self.CountryOfResidence)
        elif nodeName_ == 'PromoCode':
            PromoCode_ = child_.text
            PromoCode_ = self.gds_validate_string(PromoCode_, node, 'PromoCode')
            self.PromoCode = PromoCode_
...
class ResponseType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.ResponseCode is not None or self.ResponseMessage is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ResponseCode':
            ...
            self.validate_ResponseMessage(self.ResponseMessage)
...
class ResponseListType(GeneratedsSuper):
    ...
    def insert_Response(self, index, value):
...
class ConsumerIDAndApplicationsType(GeneratedsSuper):
    ...
    def add_Consumer(self, value):
        self.Consumer.append(value)

    def insert_Consumer(self, index, value):
        self.Consumer[index] = value
...
class ConsumerIDAndApplicationType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.ConsumerID is not None or self.LoginName is not None or self.ApplicationName is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ConsumerID':
            ...
            self.validate_ApplicationNameType(self.ApplicationName)
...
class ProfanityCheckType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.Locale is not None or self.Language is not None or self.EmailBody is not None:
            return True
        return False
        return
...
class CountryType(GeneratedsSuper):
    ...
    def get_DefaultLanguageCode(self):
        return self.DefaultLanguageCode

    def set_DefaultLanguageCode(self, DefaultLanguageCode):
        self.DefaultLanguageCode = DefaultLanguageCode

    def validate_LanguageCode(self, value):
        pass

    def get_OtherLanguageCode(self):
        return self.OtherLanguageCode

    def set_OtherLanguageCode(self, OtherLanguageCode):
        self.OtherLanguageCode = OtherLanguageCode

    def add_OtherLanguageCode(self, value):
        self.OtherLanguageCode.append(value)

    def insert_OtherLanguageCode(self, index, value):
        self.OtherLanguageCode[index] = value
    ...
    def get_OtherTimeZones(self):
        return self.OtherTimeZones

    def set_OtherTimeZones(self, OtherTimeZones):
        self.OtherTimeZones = OtherTimeZones

    def add_OtherTimeZones(self, value):
        self.OtherTimeZones.append(value)

    def insert_OtherTimeZones(self, index, value):
        self.OtherTimeZones[index] = value
    ...
    def hasContent_(self):
        if self.CountryCode is not None or self.DefaultLanguageCode is not None or self.OtherLanguageCode or self.CurrencyCode is not None or self.DefaultTimeZone is not None or self.OtherTimeZones or self.RedirectURL is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CountryCode':
            ...
            self.validate_CountryName(self.CountryCode)
            ...
            self.validate_LanguageCode(self.DefaultLanguageCode)
            ...
            self.validate_LanguageCode(self.OtherLanguageCode)
...
class TimeZonesType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if self.TimeZone is not None or self.Offset is not None:
            return True
        return False
        return
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TimeZone':
            ...
            self.Offset = Offset_
            self.validate_OffsetType(self.Offset)
...
class SecretQuestionsType(GeneratedsSuper):
    ...
    def get_SecretQuestion(self):
        return self.SecretQuestion

    def set_SecretQuestion(self, SecretQuestion):
        self.SecretQuestion = SecretQuestion

    def add_SecretQuestion(self, value):
        self.SecretQuestion.append(value)

    def insert_SecretQuestion(self, index, value):
        self.SecretQuestion[index] = value
...
class SearchResultType(GeneratedsSuper):
    ...
    def get_ConsumerFound(self):
        return self.ConsumerFound

    def set_ConsumerFound(self, ConsumerFound):
        self.ConsumerFound = ConsumerFound
    ...
    def hasContent_(self):
        if self.ConsumerFound is not None or self.Gender is not None:
            return True
        return False
        return
