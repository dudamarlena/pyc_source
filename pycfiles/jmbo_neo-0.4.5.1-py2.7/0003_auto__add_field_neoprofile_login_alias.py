...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neo/migrations/0003_auto__add_field_neoprofile_login_alias.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('neo_neoprofile', 'login_alias', self.gf('django.db.models.fields.CharField')(null=True, unique=True, max_length=50), keep_default=False)
