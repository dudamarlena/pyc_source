...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neo/migrations/0007_reset_passwords.py
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for np in orm['neo.NeoProfile'].objects.all().iterator():
            ...
            api.change_password(np.login_alias, password, token=api.get_forgot_password_token(np.login_alias).TempToken)
