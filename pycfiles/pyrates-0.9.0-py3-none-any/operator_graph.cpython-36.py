...
class OperatorGraph(DiGraph):
    __doc__ = 'Intermediate representation for nodes and edges.'
...
class VectorizedOperatorGraph(DiGraph):
    __doc__ = 'Alternate version of `OperatorGraph` that is produced during vectorization. Contents of this version are not\n    particularly protected and the instance is not cached.'
