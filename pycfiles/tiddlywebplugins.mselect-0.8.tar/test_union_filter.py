...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.mselect/test/test_union_filter.py
# Compiled at: 2010-10-21 09:51:42
...
def test_mselect_separator():
    ...
    selected_tiddlers = test_mselect('title:1|title:c', tiddlers, {'tiddlyweb.config': {'mselect.separator': '|'}})
    assert [
