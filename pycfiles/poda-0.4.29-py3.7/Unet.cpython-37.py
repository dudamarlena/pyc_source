...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\poda\segmentation\Unet.py
# Compiled at: 2019-09-26 09:27:13
# Size of source mod 2**32: 12045 bytes
...
class UNet:
    ...
    def reducer_block(self, input_tensor):
        ...
        for i in range(4):
            ...
            out, _ = new_conv2d_layer(input, filter_shape=[
             ...
             1, 1 if i == 0 else 2, 1 if i == 0 else 2, 1],
              ...
              use_bias=True,
              use_batchnorm=True)
            out, _ = new_conv2d_layer(out, filter_shape=[
    ...
    def batch_generator(self, batch_size, batch_size_val, input_folder_path, output_folder_path):
        """[summary]
