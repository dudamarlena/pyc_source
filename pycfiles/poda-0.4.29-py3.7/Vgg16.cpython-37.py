...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\poda\transfer_learning\Vgg16.py
    ...
    def vgg_block(self, input_tensor, num_block=5, batch_normalization=True):
        with tf.compat.v1.variable_scope(self.scope, 'vgg_16', [input_tensor]):
            with tf.compat.v1.variable_scope('Block_1'):
                conv_1 = convolution_2d(input_tensor=input_tensor, number_filters=64, kernel_sizes=(3,
                                                                                                    3), stride_sizes=(1,
                                                                                                                      1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_2 = convolution_2d(input_tensor=conv_1, number_filters=64, kernel_sizes=(3,
                                                                                              3), stride_sizes=(1,
                                                                                                                1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_3 = max_pool_2d(input_tensor=conv_2, pool_sizes=(2, 2), stride_sizes=(2,
                                                                                           2), paddings='valid', names=None)
            with tf.compat.v1.variable_scope('Block_2'):
                conv_4 = convolution_2d(input_tensor=conv_3, number_filters=128, kernel_sizes=(3,
                                                                                               3), stride_sizes=(1,
                                                                                                                 1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_5 = convolution_2d(input_tensor=conv_4, number_filters=128, kernel_sizes=(3,
                                                                                               3), stride_sizes=(1,
                                                                                                                 1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_6 = max_pool_2d(input_tensor=conv_5, pool_sizes=(2, 2), stride_sizes=(2,
                                                                                           2), paddings='valid', names=None)
            with tf.compat.v1.variable_scope('Block_3'):
                conv_7 = convolution_2d(input_tensor=conv_6, number_filters=256, kernel_sizes=(3,
                                                                                               3), stride_sizes=(1,
                                                                                                                 1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_8 = convolution_2d(input_tensor=conv_7, number_filters=256, kernel_sizes=(3,
                                                                                               3), stride_sizes=(1,
                                                                                                                 1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_9 = convolution_2d(input_tensor=conv_8, number_filters=256, kernel_sizes=(3,
                                                                                               3), stride_sizes=(1,
                                                                                                                 1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_10 = max_pool_2d(input_tensor=conv_9, pool_sizes=(2, 2), stride_sizes=(2,
                                                                                            2), paddings='valid', names=None)
            with tf.compat.v1.variable_scope('Block_4'):
                conv_11 = convolution_2d(input_tensor=conv_10, number_filters=512, kernel_sizes=(3,
                                                                                                 3), stride_sizes=(1,
                                                                                                                   1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_12 = convolution_2d(input_tensor=conv_11, number_filters=512, kernel_sizes=(3,
                                                                                                 3), stride_sizes=(1,
                                                                                                                   1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_13 = convolution_2d(input_tensor=conv_12, number_filters=512, kernel_sizes=(3,
                                                                                                 3), stride_sizes=(1,
                                                                                                                   1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_14 = max_pool_2d(input_tensor=conv_13, pool_sizes=(2, 2), stride_sizes=(2,
                                                                                             2), paddings='valid', names=None)
            with tf.compat.v1.variable_scope('Block_5'):
                conv_15 = convolution_2d(input_tensor=conv_14, number_filters=512, kernel_sizes=(3,
                                                                                                 3), stride_sizes=(1,
                                                                                                                   1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_16 = convolution_2d(input_tensor=conv_15, number_filters=512, kernel_sizes=(3,
                                                                                                 3), stride_sizes=(1,
                                                                                                                   1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_17 = convolution_2d(input_tensor=conv_16, number_filters=512, kernel_sizes=(3,
                                                                                                 3), stride_sizes=(1,
                                                                                                                   1), paddings='same', activations='relu', batch_normalizations=batch_normalization, dropout_rates=None, names=None)
                conv_18 = max_pool_2d(input_tensor=conv_17, pool_sizes=(2, 2), stride_sizes=(2,
                                                                                             2), paddings='valid', names=None)
        if num_block == 1:
            vgg_16 = conv_3
        else:
        ...
        with tf.compat.v1.variable_scope(self.scope, 'vgg_16', [vgg_base]):
            if self.num_depthwise_layer != None or self.num_depthwise_layer > 0:
                for j in range(0, self.num_depthwise_layer):
                    vgg_base = depthwise_convolution_2d(input_tensor=vgg_base, number_filters=number_filter, kernel_sizes=(3,
                                                                                                                           3), stride_sizes=(1,
                                                                                                                                             1), paddings='same', activations='relu', dropout_rates=None, names=None)
