...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\poda\object_detector\utils.py
# Compiled at: 2019-09-26 09:27:13
# Size of source mod 2**32: 51757 bytes
...
class ObjectDetector(object):
 ...
 (10, 13), (16, 30), (33, 23), (30, 61), (62, 45), (59, 119), (116, 90), (156, 198), (373, 326)], dropout_rate=0.0, leaky_relu_alpha=0.1):
        """[summary]
                ...
                if network_type == 'small':
                    ...
                    if network_type == 'very_small':
                        ...
                        if network_type == 'special':
                            ...
                            filters['b'] = 32
                            filters['c'] = 32
                        elif network_type == 'special' or network_type == 'very_small':
