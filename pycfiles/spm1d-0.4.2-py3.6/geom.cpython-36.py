...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/spm1d/rft1d/geom.py
# Compiled at: 2019-08-22 04:37:04
# Size of source mod 2**32: 23473 bytes
"""
Geometry module
...
class ClusterMetricCalculatorInitialized(object):
    ...
    def get_all(self):
        ...
        return (
         extents, minima, centroids, self.L)
...
def resel_counts(R, fwhm=1, element_based=False):
    ...
    if element_based:
        resels = (
         nClusters, float(nNodes) / fwhm)
    else:
        resels = (
         nClusters, float(nNodes - nClusters) / fwhm)
    return resels
