...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/spm1d/stats/nonparam/calculators.py
...
class CalculatorHotellings21D(_CalculatorTwoSample):
    ...
    def _T2_twosample_singlenode(self, yA, yB):
