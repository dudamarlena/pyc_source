...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/spm1d/rft1d/examples/smoothness_estimation_broken.py
...
FWHMe = []
for w in FWHM:
    y = rft1d.random.randn1d(nResponses, nodes, w, pad=False)
