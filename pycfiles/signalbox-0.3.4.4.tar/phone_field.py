...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/signalbox/phone_field.py
...
international_tuple = lambda x: (
 x.country_code, x.national_number)
...
class PhoneNumberFormField(forms.fields.MultiValueField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        fields = (
         ...
         forms.fields.CharField())
        defaults = {'help_text': 'Enter a phone number (country code / number)'}
