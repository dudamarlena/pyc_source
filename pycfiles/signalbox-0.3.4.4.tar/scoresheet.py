...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/signalbox/models/scoresheet.py
...
class ScoreSheet(models.Model):
    ...
    def as_simplified_dict(self):
        return {'name': self.name, 
           ...
           'variable_names': [ i.variable_name for i in self.variables.all() ], 'function': self.function}
