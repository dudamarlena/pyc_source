...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/twiliobox/models.py
# Compiled at: 2014-08-27 19:59:27
...
class TwilioNumber(models.Model):
    ...
    phone_number = models.CharField(max_length=100, unique=True, blank=True, null=True, help_text='This must be a real twilio-provisioned number. Leave\n        blank to populate automatically from the account details')
