...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/ask/models/fields.py
# Compiled at: 2014-08-27 19:26:12
import sys, base64
from datetime import datetime, time
from string import capwords
from django.utils.functional import SimpleLazyObject
import stata_functions as stata, ask.validators as validators, ast
...
import floppyforms, magic, markdown
...
class SignalboxField(object):
    ...
    def __init__(self, question, reply, request, *args, **kwargs):
        super(SignalboxField, self).__init__(error_messages=self.error_messages, validators=self.validators, *args, **kwargs)
...
class RangeSlider(SignalboxField, floppyforms.CharField):
    ...
    widget = custom_widgets.RangeSliderInput
    has_choices = False
...
class Time(SignalboxField, floppyforms.TimeField):
    ...
    def export_processor(value):
        ...
        difference = datetime.combine(baseline, thetime) - datetime.combine(baseline, time())
...
class Integer(SignalboxField, floppyforms.IntegerField):
    ...
    has_choices = False
    error_messages = {'invalid': _('This question needs an answer in whole numbers.')}
...
class Upload(SignalboxField, floppyforms.FileField):
    """."""
    widget = floppyforms.widgets.FileInput
    has_choices = False
