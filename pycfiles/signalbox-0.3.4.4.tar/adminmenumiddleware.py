...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/signalbox/middleware/adminmenumiddleware.py
...
PER_GROUP_ITEMS = {'Researchers': list(itertools.chain(*[ [ i for i, j in l ] for k, l in ADMIN_MENU ])), 
   'SuperUsers': list(itertools.chain(*[ [ i for i, j in l ] for k, l in ADMIN_MENU ])), 
   'Assessors': [
               'followups', 'add_participant', 'observations_outstanding'], 
   'Research Assistants': [
...
PER_GROUP_MENUS = {'SuperUsers': _filtermenu(PER_GROUP_ITEMS['SuperUsers'], ADMIN_MENU), 
