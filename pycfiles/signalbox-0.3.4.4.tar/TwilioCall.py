...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/signalbox/models/observation_methods/TwilioCall.py
...
def do(self):
    ...
    try:
        call = client.calls.create(to=to_number, from_=from_number, url=self.link(), method='POST')
        self.touch()
