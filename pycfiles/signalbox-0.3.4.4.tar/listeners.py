...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/signalbox/models/listeners.py
...
from signalbox.models import Reply, Observation, Membership, UserProfile, TextMessageCallback, Alert, AlertInstance
...
def _check_alert_and_save_alertinstance(alert, reply):
    ...
    if meetscriteria:
        if alertcount > 0:
            print >> sys.stderr, ('Alert triggered for reply {} but not sending another message').format(reply.id)
            return
