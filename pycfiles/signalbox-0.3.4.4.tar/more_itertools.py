...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/signalbox/utilities/more_itertools.py
# Compiled at: 2014-08-27 19:26:12
from functools import partial, wraps
from itertools import izip_longest
__all__ = [
 'chunked', 'first', 'peekable', 'collate', 'consumer']
_marker = object()
...
def chunked(iterable, n):
    ...
    """
    for group in (list(g) for g in izip_longest(fillvalue=_marker, *([iter(iterable)] * n))):
