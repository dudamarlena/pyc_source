...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/dev/signalbox/ask/models/page.py
...
class AskPage(models.Model, Step):
    ...
    def get_absolute_url(self):
        return reverse('preview_asker', kwargs={'asker_id': self.asker.id, 'page_num': self.index()})
    ...
    def progress_pages(self):
        ...
        """
        return (
         self.page_number() + 1, self.asker.page_count())
    ...
    def _questions_to_show(self, reply):
        ...
        toshow = [ q for q in qlist if bool(q.show_conditional(answer_mapping))
                 ]
        return toshow
