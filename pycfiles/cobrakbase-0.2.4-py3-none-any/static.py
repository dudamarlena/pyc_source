...
# Embedded file name: build/bdist.macosx-10.11-intel/egg/engine/static.py
# Compiled at: 2016-08-05 05:36:21
        ...
        for rule in rules:
            ...
            try:
                if rule.regex.strip() == '':
                    ...
                    param = [
                     grep, '-n', '-r', '-P'] + filters + [rule.regex, self.directory]
