...
# Embedded file name: build/bdist.macosx-10.11-intel/egg/app/controller/route.py
# Compiled at: 2016-08-05 05:15:08
import time
...
def ext_statistic(task_id):
    ...
    exts_result = []
    for ext in exts:
        exts_result.append({'value': ext.amount, 
           'name': ext.ext, 
           'path': ext.ext})
