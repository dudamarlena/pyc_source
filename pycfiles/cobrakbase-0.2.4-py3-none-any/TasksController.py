...
# Embedded file name: build/bdist.macosx-10.11-intel/egg/app/controller/backend/TasksController.py
# Compiled at: 2016-08-05 06:57:02
import datetime
...
def edit_task(task_id):
    ...
    if request.method == 'POST':
        ...
        task = CobraTaskInfo.query.filter_by(id=task_id).first()
        return render_template('backend/task/edit_task.html', data={'task': task})