...
# Embedded file name: build/bdist.macosx-10.11-intel/egg/app/controller/backend/WhiteListsController.py
# Compiled at: 2016-08-01 01:36:58
import time
...
def add_whitelist():
    ...
    if request.method == 'POST':
        ...
        whitelist = CobraWhiteList(vc.vars.project_id, vc.vars.rule_id, vc.vars.path, vc.vars.reason, 1, current_time, current_time)
        try:
