...
# Size of source mod 2**32: 32187 bytes
...
import pyplan_core.classes.XHelpers as XHelpers
...
class BaseNode(object):
 ...
 L. 343        10  SETUP_EXCEPT        138  'to 138'

 L. 344        12  LOAD_FAST                'self'
               14  LOAD_ATTR                model
 ...
 L. 345        26  LOAD_FAST                'originalNode'
               28  LOAD_CONST               None
               30  COMPARE_OP               is-not
               32  POP_JUMP_IF_FALSE   134  'to 134'

 L. 346        34  LOAD_STR                 'choice('
