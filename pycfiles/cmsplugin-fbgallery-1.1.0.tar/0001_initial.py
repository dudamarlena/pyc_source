...
# [GCC 8.4.0]
# Embedded file name: /Users/josvanvelzen/django/cmsplugin-fbgallery/cmsplugin_fbgallery/migrations/0001_initial.py
# Compiled at: 2016-09-28 15:55:23
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)'}), 
                         'id': (
       ...
       'cms.placeholder': {'Meta': {'object_name': 'Placeholder'}, 'default_width': (
                           ...
                           'slot': (
                                  'django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'})}, 
       'cmsplugin_fbgallery.facebookgallery': {'Meta': {'object_name': 'FacebookGallery', 'db_table': "'cmsplugin_facebookgallery'", '_ormbases': ['cms.CMSPlugin']}, 'album_id': (
