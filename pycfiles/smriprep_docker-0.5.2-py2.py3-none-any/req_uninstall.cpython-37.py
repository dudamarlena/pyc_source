...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pn36swhz/pip/pip/_internal/req/req_uninstall.py
# Compiled at: 2020-02-14 17:24:54
# Size of source mod 2**32: 23609 bytes
...
class UninstallPathSet(object):
 ...
 L. 543       668  LOAD_STR                 'Egg-link %s does not match installed location of %s (at %s)'

 L. 544       670  LOAD_FAST                'link_pointer'
              672  LOAD_FAST                'dist'
              674  LOAD_ATTR                project_name
              676  LOAD_FAST                'dist'
              678  LOAD_ATTR                location
              680  BUILD_TUPLE_3         3 
              682  BINARY_MODULO    
 ...
 L. 552       736  LOAD_GLOBAL              logger
              738  LOAD_METHOD              debug

 L. 553       740  LOAD_STR                 'Not sure how to uninstall: %s - Check: %s'

 L. 554       742  LOAD_FAST                'dist'
              744  LOAD_FAST                'dist'
 ...
 L. 559       776  SETUP_LOOP          868  'to 868'
              778  LOAD_FAST                'dist'
 ...
 L. 565       832  LOAD_GLOBAL              WINDOWS
          834_836  POP_JUMP_IF_FALSE   788  'to 788'

 L. 566       838  LOAD_FAST                'paths_to_remove'
              840  LOAD_METHOD              add
              842  LOAD_GLOBAL              os
              844  LOAD_ATTR                path
 ...
 L. 569       868  BUILD_LIST_0          0 
              870  STORE_FAST               '_scripts_to_remove'

 L. 570       872  LOAD_FAST                'dist'
 ...
 L. 571       884  SETUP_LOOP          922  'to 922'
 ...
 L. 572       898  LOAD_FAST                '_scripts_to_remove'
 ...
 L. 575       934  SETUP_LOOP          972  'to 972'
 ...
 L. 576       948  LOAD_FAST                '_scripts_to_remove'
 ...
 L. 578       972  SETUP_LOOP          998  'to 998'
              974  LOAD_FAST                '_scripts_to_remove'
              976  GET_ITER         
              978  FOR_ITER            996  'to 996'
              980  STORE_FAST               's'

 L. 579       982  LOAD_FAST                'paths_to_remove'
              984  LOAD_METHOD              add
              986  LOAD_FAST                's'
 ...
 L. 581       998  LOAD_FAST                'paths_to_remove'
             1000  RETURN_VALUE     
               -1  RETURN_LAST      
