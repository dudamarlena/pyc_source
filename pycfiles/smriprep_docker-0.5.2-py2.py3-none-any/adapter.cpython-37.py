...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pn36swhz/pip/pip/_vendor/cachecontrol/adapter.py
# Compiled at: 2020-02-14 17:24:54
# Size of source mod 2**32: 4882 bytes
import types, functools, zlib
...
class CacheControlAdapter(HTTPAdapter):
    ...
    def __init__(self, cache=None, cache_etags=True, controller_class=None, serializer=None, heuristic=None, cacheable_methods=None, *args, **kw):
        ...
        self.controller = controller_factory((self.cache),
          cache_etags=cache_etags, serializer=serializer)
