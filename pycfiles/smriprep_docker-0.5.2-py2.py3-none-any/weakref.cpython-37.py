...
# [GCC 8.4.0]
# Embedded file name: /tmp/src/smriprep/wrapper/build/lib/python3.7/weakref.py
...
class finalize:
    ...
    def __init__(*args, **kwargs):
        if len(args) >= 3:
            ...
            if not args:
                raise TypeError("descriptor '__init__' of 'finalize' object needs an argument")
            else:
                if 'func' not in kwargs:
                    raise TypeError('finalize expected at least 2 positional arguments, got %d' % (len(args) - 1))
