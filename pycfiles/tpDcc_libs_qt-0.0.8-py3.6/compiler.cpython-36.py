...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/externals/pysideuic/Compiler/compiler.py
...
class UICompiler(UIParser):
    ...
    def createToplevelWidget(self, classname, widgetname):
        ...
        indenter.indent()
        w = self.factory.createQObject(classname, widgetname, (), is_attribute=False,
