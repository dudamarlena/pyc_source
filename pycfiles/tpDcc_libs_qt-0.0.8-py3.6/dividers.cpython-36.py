...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/dividers.py
...
class Divider(QWidget, object):
    _ALIGN_MAP = {Qt.AlignCenter: 50, 
     Qt.AlignLeft: 20, 
     Qt.AlignRight: 80}

    def __init__(self, text=None, shadow=True, color=(150, 150, 150), orientation=Qt.Horizontal, alignment=Qt.AlignLeft, parent=None):
        """
