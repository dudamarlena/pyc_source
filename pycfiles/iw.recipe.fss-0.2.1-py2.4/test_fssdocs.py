...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/iw/recipe/fss/tests/test_fssdocs.py
# Compiled at: 2008-06-03 10:03:49
"""
Generic Test case for 'iw.recipe.fss' doctest
"""
...
def doc_suite(test_dir, setUp=None, tearDown=None, globs=None):
    ...
    docs = []
    for path in ('docs', 'doctests'):
        doctest_dir = os.path.join(package_dir, path)
