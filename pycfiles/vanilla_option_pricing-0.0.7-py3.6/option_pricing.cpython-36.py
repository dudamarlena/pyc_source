...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\vanilla_option_pricing\option_pricing.py
# Compiled at: 2018-09-15 11:07:25
...
class OptionPricingModel:
    ...
    def price_option_black_scholes_merton(self, option, risk_free_rate: float):
        ...
        :return: the no-arbitrage price of the option
        """
        return self.price_black_scholes_merton(option.option_type, option.spot, option.strike, option.years_to_maturity, risk_free_rate, option.dividend)
