...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/betsee/util/thread/lone/guilonethread.py
# Compiled at: 2019-08-01 01:03:54
# Size of source mod 2**32: 18650 bytes
"""
...
class QBetseeLoneSingleThread(QBetseeLoneThread):
    ...
    def _die_if_worker(self) -> None:
        ...
        """
        if self.is_worker:
            raise BetseePySideThreadException(QCoreApplication.translate('QBetseeWorkerSingleThread', 'Worker already adopted by this thread.'))
    ...
    def _die_unless_worker(self) -> None:
        ...
        if not self.is_worker:
            raise BetseePySideThreadException(QCoreApplication.translate('QBetseeWorkerSingleThread', 'No worker adopted by this thread.'))
