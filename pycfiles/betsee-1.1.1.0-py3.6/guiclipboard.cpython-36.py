...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/betsee/util/io/guiclipboard.py
...
def die_unless_clipboard_text() -> None:
    ...
    if not is_clipboard_text():
        raise BetseePySideClipboardException(title=(QCoreApplication.translate('die_if_clipboard_empty', 'Clipboard Error')),
          synopsis=(QCoreApplication.translate('die_if_clipboard_empty', 'System clipboard text buffer empty.')))
