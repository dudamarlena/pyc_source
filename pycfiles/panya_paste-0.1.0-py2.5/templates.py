...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/panya_paste/templates.py
...
APP_CONFIG = {'django-ckeditor': {'module_name': 'ckeditor', 
   ...
   'django-generate': {'module_name': 'generate'}, 
   'django-gizmo': {'module_name': 'gizmo'}, 
   'django-googlesearch': {'module_name': 'googlesearch', 
                           'urlconf_additions': '%s/config/googlesearch_urlconf_additions.py' % SCRIPT_PATH}, 
   'django-likes': {'module_name': 'likes', 
   ...
   'django-preferences': {'module_name': 'preferences', 
                          'template_context_processor_additions': ('preferences.context_processors.preferences_cp', )}, 
   'django-profile': {'module_name': 'profile', 
                      'model_additions': '%s/config/profile_model_additions.py' % SCRIPT_PATH}, 
   'django-publisher': {'module_name': 'publisher'}, 
   'django-recaptcha': {'module_name': 'captcha'}, 
   'django-registration': {'module_name': 'registration', 
   ...
   'django-richcomments': {'module_name': 'richcomments', 
