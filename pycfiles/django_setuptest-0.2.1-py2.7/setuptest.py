...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/setuptest/setuptest.py
# Compiled at: 2016-01-04 04:21:07
import argparse, django, pep8, sys, time, traceback, unittest
...
class SetupTestSuite(unittest.TestSuite):
    ...
    def __init__(self, *args, **kwargs):
        ...
        parser.add_argument('-a', '--autoreload', dest='autoreload', action='store_const', const=True, default=False)
        parser.add_argument('-f', '--failfast', dest='failfast', action='store_const', const=True, default=False)
        parser.add_argument('-l', '--label', dest='label')
        self.options = vars(parser.parse_args(sys.argv[2:]))
        sys.argv = sys.argv[:2]
        runner_options = {'verbosity': 1, 
           'interactive': True, 
           'failfast': False}
