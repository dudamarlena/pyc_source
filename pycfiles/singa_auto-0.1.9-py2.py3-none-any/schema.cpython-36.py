...
# [GCC 8.4.0]
# Embedded file name: /Users/nailixing/PyProjects/nusdb_rafiki/singa_auto/meta_store/schema.py
...
from singa_auto.constants import InferenceJobStatus, ServiceStatus, TrainJobStatus, TrialStatus, ModelAccessRight
...
class Trial(Base):
    ...
    __table_args__ = (
     UniqueConstraint('sub_train_job_id', 'no', name='_sub_train_job_id_no_uc'),)
