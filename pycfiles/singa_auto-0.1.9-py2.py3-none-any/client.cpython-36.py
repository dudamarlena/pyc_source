...
# [GCC 8.4.0]
# Embedded file name: /Users/nailixing/PyProjects/nusdb_rafiki/singa_auto/client/client.py
# Compiled at: 2020-04-15 05:36:06
# Size of source mod 2**32: 28586 bytes
import requests, json, pickle, os
from functools import wraps
from typing import Type, Dict, List, Any
from singa_auto.constants import ModelAccessRight, ModelDependencies, Budget, BudgetOption, InferenceBudget, InferenceBudgetOption, UserType
...
def _deprecated(msg=None):
    ...
    def deco(func):
        ...
        def deprecated_func(*args, **kwargs):
            _warn(f"{msg}\nRefer to the updated documentation at {DOCS_URL}")
...
class Client:
    ...
    def __init__(self, admin_host: str=os.environ.get('SINGA_AUTO_ADDR', 'localhost'), admin_port: int=os.environ.get('ADMIN_EXT_PORT', 3000)):
    ...
    def create_user(self, email: str, password: str, user_type: UserType) -> Dict[(str, Any)]:
        ...
        """
        data = self._post('/users', json={'email':email, 
         'password':password, 
         'user_type':user_type})
        return data
    ...
    def create_dataset(self, name: str, task: str, dataset_path: str=None, dataset_url: str=None) -> Dict[(str, Any)]:
        ...
        dataset = dict()
        form_data = {'name':name, 
         'task':task,  'dataset_url':dataset_url}
    ...
    def create_model(self, name: str, task: str, model_file_path: str, model_class: str, model_pretrained_params_id: str=None, dependencies: ModelDependencies=None, access_right: ModelAccessRight=ModelAccessRight.PRIVATE, docker_image: str=None) -> Dict[(str, Any)]:
        """
    ...
    def create_train_job(self, app: str, task: str, train_dataset_id: str, val_dataset_id: str, budget: Budget, models: List[str]=None, train_args: Dict[(str, any)]=None) -> Dict[(str, Any)]:
        """
        ...
        **Budget Option**             **Description**
        ...
        budget = {**{BudgetOption.TIME_HOURS: 0.1, 
         BudgetOption.GPU_COUNT: 0}, **budget}
        postJSON = {'app':app, 
         'task':task, 
    ...
    def get_best_trials_of_train_job(self, app: str, app_version: int=-1, max_count: int=2) -> List[Dict[(str, Any)]]:
        ...
        """
        data = self._get(('/train_jobs/{}/{}/trials'.format(app, app_version)), params={'type':'best', 
         'max_count':max_count})
        return data
    ...
    def create_inference_job(self, app: str, app_version: int=-1, budget: InferenceBudget=None) -> Dict[(str, Any)]:
        ...
        **Budget Option**             **Description**
        ...
        data = self._post('/inference_jobs', json={'app':app, 
