...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/redis_sniffer/main.py
# Compiled at: 2015-03-19 00:53:58
import argparse
...
def main():
    ...
    parser.add_argument('-l', choices=['debug', 'event', 'full'], default='full', help='the type of log(s) you want to                         create. Default: both')
    parser.add_argument('-el', '--event-log', default='event_sniff', help='the name of the event outout file.                         Default: event_sniff')
    parser.add_argument('-fl', '--full-log', default='full_sniff', help='the name of the full sniff output file.                         Default: full_sniff')
