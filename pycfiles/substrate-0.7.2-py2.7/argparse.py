...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/substrate/data/local/substrate/lib/argparse.py
...
__all__ = [
 ...
 'SUPPRESS',
 'ZERO_OR_MORE']
import copy as _copy, os as _os, re as _re, sys as _sys, textwrap as _textwrap
...
class HelpFormatter(object):
    ...
    def _dedent--- This code section failed: ---

 L. 212         0  LOAD_FAST             0  'self'
                3  DUP_TOP          
                4  LOAD_ATTR             0  '_current_indent'
                7  LOAD_FAST             0  'self'
               10  LOAD_ATTR             1  '_indent_increment'
               13  INPLACE_SUBTRACT 
               14  ROT_TWO          
               15  STORE_ATTR            0  '_current_indent'

 L. 213        18  LOAD_FAST             0  'self'
               21  LOAD_ATTR             0  '_current_indent'
               24  LOAD_CONST               0
               27  COMPARE_OP            5  >=
               30  POP_JUMP_IF_TRUE     42  'to 42'
               33  LOAD_ASSERT              AssertionError
               36  LOAD_CONST               'Indent decreased below 0.'
               39  RAISE_VARARGS_2       2  None

 L. 214        42  LOAD_FAST             0  'self'
               45  DUP_TOP          
               46  LOAD_ATTR             3  '_level'
               49  LOAD_CONST               1
               52  INPLACE_SUBTRACT 
               53  ROT_TWO          
               54  STORE_ATTR            3  '_level'

Parse error at or near `ROT_TWO' instruction at offset 53
