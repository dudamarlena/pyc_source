...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/substrate/data/local/substrate/manage/substrate_manage/commands/rshell.py
# Compiled at: 2012-09-09 20:09:24
""" Connect to a remote datastore through an interactive console. """
from google.appengine.tools import os_compat
import logging, sys, os, traceback, getpass, getopt
logging.basicConfig(level=logging.INFO, format='%(levelname)-8s %(asctime)s %(filename)s:%(lineno)s] %(message)s')
