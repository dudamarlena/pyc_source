...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/substrate/data/lib/substrate/agar/test/base_test.py
# Compiled at: 2012-09-10 16:46:42
...
class BaseTest(unittest.TestCase):
    ...
    def assertEmailSent(self, to=None, sender=None, subject=None, body=None, html=None):
        ...
        self.assertNotEqual(0, len(messages), 'No matching email messages were sent.')
