...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/substrate/data/lib/substrate/agar/json_handlers.py
...
class CorsMultiPageHandler(MultiPageHandler):
    ...
    def options(self):
        ...
        self.response.headers['Access-Control-Allow-Credentials'] = self.request.headers.get('Access-Credentials', 'true')
        ...
        self.response.headers['Access-Control-Allow-Headers'] = self.request.headers.get('Access-Control-Request-Headers', '')
