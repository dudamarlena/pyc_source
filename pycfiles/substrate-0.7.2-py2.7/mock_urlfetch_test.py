...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/substrate/data/lib/substrate/agar/test/mock_urlfetch_test.py
...
class MockURLFetchServiceStub(apiproxy_stub.APIProxyStub):
    _responses = {}
    _method_map = {urlfetch_service_pb.URLFetchRequest.GET: 'GET', urlfetch_service_pb.URLFetchRequest.POST: 'POST', 
    ...
    def set_response(cls, url, content=None, status_code=None, headers=None, method=None):
        MockURLFetchServiceStub._responses[(url, method)] = {'content': content, 'status_code': status_code, 
           'headers': headers}
    ...
    def _decode_http_method(self, pb_method):
        ...
        if not method:
            raise apiproxy_errors.ApplicationError(urlfetch_service_pb.URLFetchServiceError.UNSPECIFIED_ERROR)
        return method
