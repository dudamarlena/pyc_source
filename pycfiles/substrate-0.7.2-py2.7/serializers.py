...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/substrate/data/lib/substrate/restler/serializers.py
# Compiled at: 2012-09-09 20:09:24
import copy, datetime, decimal, json, pprint, types
        ...
        if isinstance(new_fields, (tuple, list)):
            for name in new_fields:
                ...
                if isinstance(name, list):
                    ...
                    if name in fields or isinstance(getattr(self.model, name, None), property) or callable(getattr(self.model, name, None)) or self.model.restler_extra_types(getattr(self.model, name, None)):
