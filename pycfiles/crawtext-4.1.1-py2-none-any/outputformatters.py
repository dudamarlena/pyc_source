...
# [GCC 8.4.0]
# Embedded file name: /home/c24b/projets/crawtext/newspaper/outputformatters.py
...
class OutputFormatter(object):
    ...
    def remove_fewwords_paragraphs(self):
        ...
        for el in all_nodes:
            ...
            if (tag != 'br' or text != '\\r') and stop_words.get_stopword_count() < 3 and len(self.parser.getElementsByTag(el, tag='object')) == 0 and len(self.parser.getElementsByTag(el, tag='embed')) == 0:
