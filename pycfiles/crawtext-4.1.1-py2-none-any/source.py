...
# [GCC 8.4.0]
# Embedded file name: /home/c24b/projets/crawtext/newspaper/source.py
...
class Source(object):
    ...
    @utils.cache_disk(seconds=86400, cache_folder=ANCHOR_DIRECTORY)
    ...
    def categories_to_articles(self):
        ...
        for category in self.categories:
            ...
            for tup in url_title_tups:
                indiv_url = tup[0]
                indiv_title = tup[1]
                _article = Article(url=indiv_url, source_url=self.url, title=indiv_title, config=self.config)
    ...
    def download_articles(self, threads=1):
        ...
        if len(failed_articles) > 0:
            if self.config.verbose:
                ...
                print [ a.url for a in failed_articles ]
