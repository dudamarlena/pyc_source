...
# [GCC 8.4.0]
# Embedded file name: /home/c24b/projets/crawtext/newspaper/images.py
...
import logging, math, StringIO, urllib, urllib2
    ...
    if not url.startswith(('http://', 'https://')):
        ...
        while True:
            try:
                    ...
                    if 'image' in content_type:
                        ...
                        while not p.image and new_data:
                            try:
                                ...
                                print '***jpeg misconfiguration! check pillow or pilinstallation this machine: %s' % str(e)
                                p = None
                                break
                ...
                except (urllib2.URLError, urllib2.HTTPError, InvalidURL) as e:
                    cur_try += 1
                    if cur_try >= retries:
