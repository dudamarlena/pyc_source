...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/slow/qtgui/test_editor.py
...
class TestRunner(object):
    ...
    def run_profile(self, slosl_statements, db_attributes, init_code):
        ...
        graph = prof.runcall(self.build_graph, slosl_statements, db_attributes, init_code)
        prof.close()
...
class TestEditor(object):
    ...
    def __build_svg(self, graph, graphviz_program):
        ...
        return graph.tostring('svg', graphviz_program, overlap='false', fontsize='8', splines=use_splines)
