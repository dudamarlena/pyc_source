...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/slow/vis/dot_visual.py
...
class VisualViewGraph(ViewGraph):
    ...
    def create_visual_node(self, node):
        ...
        node.node_label = label(pos=pos, text=node.name, box=0, line=0, opacity=0, space=NODE_RADIUS, height=7, xoffset=-30, yoffset=0)
        node.node_sphere = cylinder(pos=pos, axis=(0, 0, 1000), radius=NODE_RADIUS, color=NODE_COLOUR)
