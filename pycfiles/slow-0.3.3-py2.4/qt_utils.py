...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/slow/qtgui/qt_utils.py
...
class qaction(object):
    ...
    def __init__(self, menu_text=None, accel=None, parent_attribute=None, iconset=None, pixmap=None, iconset_attribute=None, pixmap_attribute=None):
