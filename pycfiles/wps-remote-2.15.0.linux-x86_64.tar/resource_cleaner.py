...
# [GCC 8.4.0]
# Embedded file name: /home/alessio/Envs/remote-wps/lib/python2.7/site-packages/wpsremote/resource_cleaner.py
# Compiled at: 2018-09-14 04:08:14
__author__ = 'Alessio Fabiani'
__copyright__ = 'Copyright 2016 Open Source Geospatial Foundation - all rights reserved'
__license__ = 'GPL'
import configInstance, os, path, unittest, datetime, ConfigParser, psutil, json, time, logging, traceback
...
class Resource(object):
    ...
    def get_pid_files_dir():
        if isinstance(Resource.pid_files_dir, path.path):
            return Resource.pid_files_dir
        return path.path(Resource.pid_files_dir)
    ...
    def __init__(self):
        ...
        self._processbot_cmd_line = None
        self._unique_id = None
        self._sandbox_path = None
        self._processbot_pid = None
        self._spawned_process_pids = None
        self._spawned_process_cmd = None
        self._path = Resource.get_pid_files_dir()
        return
    ...
    def read_from_file(self, filepath):
        config = configInstance.create(filepath, raw=True)
    ...
    def kill_spawned_process(self):
        ...
        res = list(set(res))
        return len(res) == 0 or len(res) == 1 and res[0]
