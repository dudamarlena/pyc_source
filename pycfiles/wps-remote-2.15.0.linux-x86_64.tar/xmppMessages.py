...
# [GCC 8.4.0]
# Embedded file name: /home/alessio/Envs/remote-wps/lib/python2.7/site-packages/wpsremote/xmppMessages.py
# Compiled at: 2018-09-13 11:06:18
__author__ = 'Alessio Fabiani'
__copyright__ = 'Copyright 2016 Open Source Geospatial Foundation - all rights reserved'
__license__ = 'GPL'
import os, sys, inspect, urllib, json, logging, traceback
    ...
    def send(self):
        try:
            ...
            for out_param_name, out_param_values in self._outputs.items():
                result = dict()
                result[out_param_name + '_value'] = out_param_values[0]
                result[out_param_name + '_description'] = out_param_values[1]
                result[out_param_name + '_title'] = out_param_values[2]
                result[out_param_name + '_type'] = out_param_values[3]
                result[out_param_name + '_pub'] = out_param_values[4]
                result[out_param_name + '_layer_name'] = out_param_values[5]
                result[out_param_name + '_style'] = out_param_values[6]
                result[out_param_name + '_workspace'] = out_param_values[7]
                result[out_param_name + '_metadata'] = out_param_values[8]
