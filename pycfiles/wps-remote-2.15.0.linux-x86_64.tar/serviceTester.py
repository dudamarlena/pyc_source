...
# [GCC 8.4.0]
# Embedded file name: /home/alessio/Envs/remote-wps/lib/python2.7/site-packages/wpsremote/serviceTester.py
# Compiled at: 2016-02-23 09:08:52
__author__ = 'Alessio Fabiani'
__copyright__ = 'Copyright 2016 Open Source Geospatial Foundation - all rights reserved'
__license__ = 'GPL'
import sys, os, logging, ConfigParser, thread, subprocess, inspect, pickle, json, socket, zipfile, shutil, urllib, re, time, hashlib, urllib, base64
os.chdir(os.path.join(os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))))
sys.path.insert(0, os.getcwd())
sys.path.append(os.path.abspath('lib'))
import sleekxmpp, logging, logging.config
...
class ServiceTester(sleekxmpp.ClientXMPP):
    ...
    def request_riskmap(self):
        request = {'referenceDate': '20150115', 
           'minlon': 50.0, 
           'maxlon': 70.0, 
           'minlat': 0, 
           'maxlat': 20.0, 
