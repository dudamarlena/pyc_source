...
# [GCC 8.4.0]
# Embedded file name: /home/alessio/Envs/remote-wps/lib/python2.7/site-packages/wpsremote/path.py
# Compiled at: 2016-02-23 09:24:42
...
class path(_base):
            ...
            try:
                ...
                if errors == 'ignore':
                    ...
                    warnings.warn("Unable to access '%s': %s" % (
                     child, sys.exc_info()[1]), TreeWalkWarning)
                    isdir = False
                else:
                    raise
    ...
    def fnmatch(self, pattern):
        ...
        pattern - A filename pattern with wildcards,
            for example '*.py'.
        """
        return fnmatch.fnmatch(self.name, str(pattern))
