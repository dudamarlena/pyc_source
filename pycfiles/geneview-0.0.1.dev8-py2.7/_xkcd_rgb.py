...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/geneview/palette/_xkcd_rgb.py
# Compiled at: 2016-01-31 08:44:32
xkcd_rgb = {'acid green': '#8ffe09', 'adobe': '#bd6c48', 
   'algae': '#54ac68', 
   'algae green': '#21c36f', 
   'almost black': '#070d0d', 
   'amber': '#feb308', 
