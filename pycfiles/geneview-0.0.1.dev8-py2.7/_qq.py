...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/geneview/gwas/_qq.py
# Compiled at: 2016-02-18 21:00:01
"""
...
def qqplot(pvalues, ax=None, xlabel='Expected', ylabel='Observed', color='k', ablinecolor='r', alpha=0.8, mlog10=True, **kwargs):
    """Creat Q-Q plot.
    ...
    *CAUSION: The x-axis(expected) is created from uniform distribution 
    ...
    if ablinecolor:
        ax.plot([e.min(), e.max()], [e.min(), e.max()], color=ablinecolor, linestyle='-')
    if xlabel:
