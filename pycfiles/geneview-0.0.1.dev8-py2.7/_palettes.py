...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/geneview/palette/_palettes.py
# Compiled at: 2016-02-14 06:08:38
...
GENEVIEW_PALETTES = dict(deep=[
 '#4C72B0', '#55A868', '#C44E52',
 '#8172B2', '#CCB974', '#64B5CD'], muted=[
 '#4878CF', '#6ACC65', '#D65F5F',
 '#B47CC7', '#C4AD66', '#77BEDB'], pastel=[
 '#92C6FF', '#97F0AA', '#FF9F9A',
 '#D0BBFF', '#FFFEA3', '#B0E0E6'], bright=[
 '#003FFF', '#03ED3A', '#E8000B',
 '#8A2BE2', '#FFC400', '#00D7FF'], dark=[
 '#001C7F', '#017517', '#8C0900',
 '#7600A1', '#B8860B', '#006374'], colorblind=[
 '#0072B2', '#009E73', '#D55E00',
 '#CC79A7', '#F0E442', '#56B4E9'], colorful=[
 '#6DC066', '#FD482F', '#8A2BE2',
...
def mpl_palette(name, n_colors=6):
    ...
    """
    brewer_qual_pals = {'Accent': 8, 'Dark2': 8, 'Paired': 12, 'Pastel1': 9, 
       'Pastel2': 8, 'Set1': 9, 
       'Set2': 8, 'Set3': 12}
    if name.endswith('_d'):
        pal = [
...
def diverging_palette(h_neg, h_pos, s=75, l=50, sep=10, n=6, center='light', as_cmap=False):
    ...
    midpoint = dict(light=[(0.95, 0.95, 0.95, 1.0)], dark=[
     (0.133, 0.133, 0.133, 1.0)])[center]
    mid = midpoint * sep
...
def set_color_codes(palette='deep'):
    ...
    if palette == 'reset':
        colors = [
         (0.0, 0.0, 1.0), (0.0, 0.5, 0.0), (1.0, 0.0, 0.0), (0.75, 0.75, 0.0),
         (0.75, 0.75, 0.0), (0.0, 0.75, 0.75), (0.0, 0.0, 0.0)]
    else:
        colors = GENEVIEW_PALETTES[palette] + [(0.1, 0.1, 0.1)]
