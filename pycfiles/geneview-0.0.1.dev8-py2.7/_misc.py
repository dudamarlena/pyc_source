...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/geneview/util/_misc.py
# Compiled at: 2016-02-13 11:36:16
"""
...
def chr_id_cmp(a, b):
    ...
    try:
        ...
        if achr.isdigit() and not bchr.isdigit():
            return -1
        if bchr.isdigit() and not achr.isdigit():
            return 1
