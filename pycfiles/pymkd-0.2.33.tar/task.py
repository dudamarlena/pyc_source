...
# Embedded file name: build/bdist.linux-x86_64/egg/pymk/tests/task.py
...
class TaskTypeTest(PymkTestCase):
    ...
    def test_check_if_task_exists_fail(self):
        self.assertRaises(TaskAlreadyExists, TaskType.check_if_task_exists, 'name1')
...
class TaskNameTest(PymkTestCase):
    ...
    def test_arguments_2_tasks(self):
        ...
        self.assertEqual({'arg2': ['2']}, data)
        data = load(open('tc.out'))
        self.assertEqual({'arg': ['1']}, data)
