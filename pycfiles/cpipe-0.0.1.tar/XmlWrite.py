...
# Embedded file name: build/bdist.macosx-10.9-intel/egg/cpip/util/XmlWrite.py
# Compiled at: 2017-10-03 13:09:09
__doc__ = 'Writes XML and XHTML.'
...
class XhtmlStream(XmlStream):
    ...
    def __enter__(self):
        ...
        self.startElement('html', {'xmlns': 'http://www.w3.org/1999/xhtml', 
           'xml:lang': 'en', 
           'lang': 'en'})
        return self

    def charactersWithBr(self, sIn):
        r"""Writes the string replacing any \n characters with <br/> elements."""
        while len(sIn) > 0:
            i = sIn.find('\n')
            if i != -1:
