...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/compactxml/compact.py
# Compiled at: 2010-06-22 15:19:11
...
matchDoctype = re.compile('^<!DOCTYPE\\s(?P<doctype>.*)>$', re.UNICODE)
