...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/compactxml/parser.py
# Compiled at: 2011-02-06 01:32:05
...
class Parser(object):
    ...
    def parse(self, scope, aNamespaces, aVariables, aMacros, *args):
        parseArguments = [
         aNamespaces, aVariables, aMacros] + list(args)
