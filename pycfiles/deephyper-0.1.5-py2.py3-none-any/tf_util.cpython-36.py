...
def get_placeholder(name, dtype, shape):
    if name in _PLACEHOLDER_CACHE:
        ...
        assert out.graph == tf.get_default_graph() and dtype1 == dtype and shape1 == shape, 'Placeholder with name {} has already been registered and has shape {}, different from requested {}'.format(name, shape1, shape)
        return out
    else:
