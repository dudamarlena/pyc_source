...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/model/space/struct/cell_block_struct.py
# Compiled at: 2019-07-11 14:24:06
# Size of source mod 2**32: 9261 bytes
...
class CellBlockStructure(NxStructure):
    ...
    def __init__(self, input_shape, output_shape, output_op=None, *args, **kwargs):
        ...
        self._CellBlockStructure__output_shape = output_shape
    ...
    def add_cell(self, cell):
        ...
        for an in action_nodes:
            ...
            for o in ops:
                str_hash = str(o)
                if str_hash not in self.map_sh2int:
    ...
    def create_model(self, activation=None):
        ...
        output_tensor = keras.layers.Dense((self._CellBlockStructure__output_shape[0]),
