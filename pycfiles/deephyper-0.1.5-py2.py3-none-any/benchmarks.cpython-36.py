...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/bench/benchmarks.py
...
register_benchmark({'name':'Atari10M', 
 ...
 'tasks':[{'desc':_game,  'env_id':_game + _ATARI_SUFFIX,  'trials':6,  'num_timesteps':int(10000000.0)} for _game in _atari7]})
...
register_benchmark({'name':'Mujoco1M', 
 ...
 'tasks':[{'env_id':_envid,  'trials':6,  'num_timesteps':int(1000000.0)} for _envid in _mujocosmall]})
register_benchmark({'name':'MujocoWalkers', 
 'description':'MuJoCo forward walkers, run for 8M, humanoid 100M', 
 'tasks':[
  {'env_id':'Hopper-v1', 
   'trials':4,  'num_timesteps':8000000},
  {'env_id':'Walker2d-v1', 
   'trials':4,  'num_timesteps':8000000},
  {'env_id':'Humanoid-v1', 
   'trials':4,  'num_timesteps':100000000}]})
_bulletsmall = [
...
register_benchmark({'name':'Bullet1M', 
 'description':'6 mujoco-like tasks from bullet, 1M steps', 
 'tasks':[{'env_id':e,  'trials':6,  'num_timesteps':int(1000000.0)} for e in _bulletsmall]})
register_benchmark({'name':'Roboschool8M', 
 ...
 'tasks':[
  {'env_id':'RoboschoolReacher-v1', 
   'trials':4,  'num_timesteps':2000000},
...
register_benchmark({'name':'RoboschoolHarder', 
 ...
 'tasks':[
  ...
  {'env_id':'RoboschoolHumanoidFlagrun-v1', 
   'trials':4,  'num_timesteps':200000000},
  {'env_id':'RoboschoolHumanoidFlagrunHarder-v1', 
   'trials':4,  'num_timesteps':400000000}]})
_atari50 = [
...
_fetch_tasks = [
 'FetchReach-v1', 'FetchPush-v1', 'FetchSlide-v1']
register_benchmark({'name':'Fetch1M', 
 'description':'Fetch* benchmarks for 1M timesteps', 
 'tasks':[{'trials':6,  'env_id':env_id,  'num_timesteps':int(1000000.0)} for env_id in _fetch_tasks]})