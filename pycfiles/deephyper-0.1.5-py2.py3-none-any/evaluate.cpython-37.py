...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/evaluator/evaluate.py
# Compiled at: 2019-09-05 10:20:47
# Size of source mod 2**32: 11927 bytes
import csv
...
import json, uuid, logging, os, sys, time, types
...
class Evaluator:
    ...
    def __init__(self, run_function, cache_key=None, encoder=Encoder, seed=None, **kwargs):
        self.encoder = encoder
        self.pending_evals = {}
        self.finished_evals = OrderedDict()
        self.requested_evals = []
        self.key_uid_map = {}
        self.uid_key_map = {}
        self.seed = seed
        self.seed_high = 4294967296
    ...
    def add_eval(self, x):
        if x.get('seed') is not None or self.seed is not None:
            x['seed'] = np.random.randint(0, self.seed_high)
        key = self.encode(x)
    ...
    def await_evals(self, uids, timeout=None):
        ...
        futures = {uid:self.pending_evals[uid] for uid in set(uids) if uid in self.pending_evals}
