...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/common/mpi_moments.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 2057 bytes
from mpi4py import MPI
import numpy as np
from deephyper.search.nas.baselines.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(['mpirun', '-np', '3',
     'python', '-c',
     'from deephyper.search.nas.baselines.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()'])
