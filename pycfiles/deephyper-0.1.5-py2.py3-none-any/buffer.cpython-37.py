...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/acer/buffer.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 5881 bytes
import numpy as np
...
def _stack_obs_ref(enc_obs, dones, nsteps):
    ...
    mask[nstack - 1:] = np.reshape(1.0 - dones, [nenv, nsteps, 1, 1, 1]).swapaxes(1, 0)
    mask[:nstack - 1] = 1.0
...
def test_stack_obs():
    ...
    obs_shape = (
     2, 3, nstack)
    enc_obs_shape = (
     nenv, nsteps + nstack) + obs_shape[:-1] + (1, )
