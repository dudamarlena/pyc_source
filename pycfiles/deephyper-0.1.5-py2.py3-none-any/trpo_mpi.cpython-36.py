...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/trpo_mpi/trpo_mpi.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 15287 bytes
from deephyper.search.nas.baselines.common import explained_variance, zipsame, dataset
from deephyper.search.nas.baselines import logger
import deephyper.search.nas.baselines.common.tf_util as U, tensorflow as tf, numpy as np, time
from deephyper.search.nas.baselines.common import colorize
...
from deephyper.search.nas.baselines.common.cg import cg
from deephyper.search.nas.baselines.common.input import observation_placeholder
...
def traj_segment_generator(pi, env, horizon, stochastic):
    ...
    while True:
        ...
        if t > 0 and t % horizon == 0:
            yield {'ob':obs, 
             'rew':rews,  'vpred':vpreds,  'new':news,  'ac':acs, 
             'prevac':prevacs,  'nextvpred':vpred * 1 - new,  'ep_rets':ep_rets, 
             'ep_lens':ep_lens}
...
def learn(*, network, env, total_timesteps, timesteps_per_batch=1024, max_kl=0.001, cg_iters=10, gamma=0.99, lam=1.0, seed=None, ent_coef=0.0, cg_damping=0.01, vf_stepsize=0.0003, vf_iters=3, max_episodes=0, max_iters=0, callback=None, load_path=None, **network_kwargs):
    """
    ...
    **network_kwargs        keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    assign_old_eq_new = U.function([], [], updates=[tf.assign(oldv, newv) for oldv, newv in zipsame(get_variables('oldpi'), get_variables('pi'))])
