                ...
                for var in varlist:
                    ...
                    if fpropFactor is not None:
                        ...
                        if bpropFactor is not None:
                            if not self._blockdiag_bias and self.stats[var]['assnWeights'] or bpropFactor not in tmpStatsCache:
