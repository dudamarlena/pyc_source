...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/core/exceptions/nas/space.py
...
class WrongSequenceToSetOperations(NASError):
    __doc__ = 'Raised when a sequence of actions is not of the same lenght as the number of variable nodes of the search_space.'
...
class StructureHasACycle(NASError):
    __doc__ = 'Raised when a search_space is containing a cycle.'
...
class InputShapeOfWrongType(NASError):
    __doc__ = 'Raised when an input shape of a search_space is of a wrong type.\n    '
...
class NodeAlreadyAdded(NASError):
    __doc__ = 'Raised when a node has already been added in a search_space.\n    '
...
class WrongOutputShape(NASError):
    __doc__ = "Raised when the output shape of the model generated by a search_space doesn't\n    match the expected shape.\n    "
