...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/evaluator/_subprocess.py
...
class PopenFuture:
    ...
    def __init__(self, args, parse_fxn):
        self.proc = subprocess.Popen(args, shell=True, stdout=(subprocess.PIPE), stderr=(subprocess.STDOUT),
          encoding='utf-8')
        self._state = 'active'
        self._result = None
