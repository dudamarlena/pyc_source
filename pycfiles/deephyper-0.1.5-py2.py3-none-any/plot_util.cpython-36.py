...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/common/plot_util.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 18068 bytes
import matplotlib.pyplot as plt, os.path as osp, json, os, numpy as np, pandas
from collections import defaultdict, namedtuple
from deephyper.search.nas.baselines.bench import monitor
from deephyper.search.nas.baselines.logger import read_json, read_csv
...
def one_sided_ema(xolds, yolds, low=None, high=None, n=512, decay_steps=1.0, low_counts_threshold=1e-08):
    """
    ...
    if not xolds[0] <= low:
        raise AssertionError('low = {} < xolds[0] = {} - extrapolation not permitted!'.format(low, xolds[0]))
    else:
...
def load_results(root_dir_or_dirs, enable_progress=True, enable_monitor=True, verbose=False):
    ...
    if isinstance(root_dir_or_dirs, str):
        rootdirs = [
         osp.expanduser(root_dir_or_dirs)]
    else:
