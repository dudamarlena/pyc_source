...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/logger.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 14687 bytes
import os, sys, shutil
import os.path as osp
import json, time, datetime, tempfile
...
class Logger(object):
    ...
    def dumpkvs(self):
        if self.comm is None:
            ...
            d = mpi_util.mpi_weighted_mean(self.comm, {name:(val, self.name2cnt.get(name, 1)) for name, val in self.name2val.items()})
            if self.comm.rank != 0:
                d['dummy'] = 1
        out = d.copy()
