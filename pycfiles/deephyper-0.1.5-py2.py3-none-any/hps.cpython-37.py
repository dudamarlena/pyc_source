...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/core/plot/hps.py
...
def hps_analytics(path_to_data_file, nb_name='dh-analytics-hps'):
    ...
    editor = NbEdit((os.path.join(HERE, 'stub/hps_analytics.ipynb')), path_to_save=f"{nb_name}.ipynb")
    try:
...
def add_subparser(subparsers):
    ...
    parser_parse = subparsers.add_parser(subparser_name,
      help='Tool to generate analytics on a single HPS experiment (jupyter notebook).')
    parser_parse.add_argument('-p', '--path',
      type=str, help='A CSV file generated by the search.')
    parser_parse.add_argument('-n', '--name', type=str, default='dh-analytics-hps',
