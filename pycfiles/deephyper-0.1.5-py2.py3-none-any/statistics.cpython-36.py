...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/gail/statistics.py
    ...
    def __init__(self, scalar_keys=[], histogram_keys=[]):
        ...
        with tf.variable_scope('summary'):
            ...
            for k in histogram_keys:
                ph = tf.placeholder('float32',
                  None, name=(k + '.histogram.summary'))
