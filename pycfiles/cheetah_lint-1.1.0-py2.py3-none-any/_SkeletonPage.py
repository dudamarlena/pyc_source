...
# Embedded file name: build/lib.macosx-10.13-x86_64-2.7/Cheetah/Templates/_SkeletonPage.py
# Compiled at: 2019-09-22 10:12:27
__doc__ = 'A baseclass for the SkeletonPage template'
import os, time
    ...
    def stylesheetTags(self):
        ...
        for identifier in self._stylesheetsOrder:
            if identifier not in self._stylesheets:
                warning = '# the identifier ' + identifier + 'was in stylesheetsOrder, but not in stylesheets'
                print warning
