...
# Embedded file name: build/lib.macosx-10.13-x86_64-2.7/Cheetah/Tests/NameMapper.py
...
testNamespace = {'aStr': 'blarg', 
   ...
   'aDict': {'one': 'item1', 'two': 'item2', 
             'nestedDict': {'one': 'nestedItem1', 'two': 'nestedItem2', 
   ...
   'emptyString': '', 
   'funcThatRaises': funcThatRaises}
autoCallResults = {'aFunc': 'Scooby', 'aMeth': 'doo'}
results = testNamespace.copy()
results.update({'anObj.meth1': 'doo', 'aDict.one': 'item1', 
