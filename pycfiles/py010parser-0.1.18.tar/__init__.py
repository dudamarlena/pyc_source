...
# [GCC 8.4.0]
# Embedded file name: ../py010parser/__init__.py
# Compiled at: 2020-01-05 09:41:10
__all__ = [
 'c_lexer', 'c_parser', 'c_ast']
__version__ = '0.1.18'
...
def parse_file(filename, use_cpp=True, cpp_path='cpp', cpp_args='', parser=None, predefine_types=True, keep_scopes=False):
...
def parse_string(text, parser=None, filename='<string>', optimize=True, predefine_types=True, use_cpp=True, cpp_path='cpp', cpp_args='', keep_scopes=False):
    if use_cpp:
        tempfile_path = ''
    ...
    if parser is None:
        parser = CParser(lex_optimize=optimize, yacc_optimize=optimize)
    return parser.parse(text, filename, predefine_types=predefine_types, keep_scopes=keep_scopes)