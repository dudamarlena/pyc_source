...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/pilot-lib/pilot_lib/model.py
# Compiled at: 2015-04-19 13:42:19
        ...
        def oauth_register(cls, provider, provider_user_id=None, email=None, name=None, image_url=None, **kwargs):
            ...
            if oauthuser:
                ...
                if user:
                    ...
                    oal.create(**data)
                    return user
                user = User.new(email=email, name=name, profile_pic_url=image_url, signin_method=provider)
                data.update({'user_id': user.id})
                oal.create(**data)
                return user
