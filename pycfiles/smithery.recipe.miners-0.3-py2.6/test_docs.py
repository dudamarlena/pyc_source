...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/smithery/recipe/miners/tests/test_docs.py
# Compiled at: 2011-01-04 05:26:28
"""
Doctest runner for 'smithery.recipe.miners'.
"""
...
def setUp(test):
    ...
    zc.buildout.testing.install_develop('smithery.recipe.miners', test)
