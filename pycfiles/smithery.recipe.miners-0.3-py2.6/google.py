...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/smithery/recipe/miners/google.py
# Compiled at: 2011-02-25 06:50:18
"""
...
class BaseGoogleCalendar(Miner):
    headers = [
     'project', 'title', 'summary', 'start_time', 'end_time', 'who', 'attendee_status', 'uid']
...
class GoogleCalendar(BaseGoogleCalendar):
    ...
    def event_details(self, event):
        ...
        for event_row in event_rows:
            if len(event.when[0].start_time) == 10:
                ...
                hours = duration.seconds / 3600.0 + duration.days * 8.0
