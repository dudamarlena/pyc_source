...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/sunflower/h5cat.py
...
def parse_options(args):
    ...
    parser.add_option('-r', '--recursive', action='store_true', help='act recursively on directories')
    parser.add_option('--ignore-errors', action='store_true', help='continue to the next file on error instead of terminating')
...
def main(args=sys.argv[1:]):
    ...
    h5cat(args[:-1], args[(-1)], recursive=options.recursive, ignore_errors=options.ignore_errors)
