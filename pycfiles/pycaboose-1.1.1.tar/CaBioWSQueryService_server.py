...
# Embedded file name: build/bdist.macosx-10.6-universal/egg/cabig/cabio/CaBioWSQueryService_server.py
...
class CaBioWSQueryService(ServiceSOAPBinding):
    ...
    def soap_getAssociation(self, ps, **kw):
        ...
        return (
         request, getAssociationResponse())
    ...
    def soap_getRecordsPerQuery(self, ps, **kw):
        ...
        return (
         request, getRecordsPerQueryResponse())
    ...
    def soap_getMaximumRecordsPerQuery(self, ps, **kw):
        ...
        return (
         request, getMaximumRecordsPerQueryResponse())
    ...
    def soap_getTotalNumberOfRecords(self, ps, **kw):
        ...
        return (
         request, getTotalNumberOfRecordsResponse())
