...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/symmetry.py
# Compiled at: 2020-05-13 19:28:33
# Size of source mod 2**32: 10325 bytes
"""
Module that contains functions and classes related with symmetry
"""
from __future__ import print_function, division, absolute_import
import re, copy, tpDcc.dccs.maya as maya
    ...
    if sel_negative is None:
        ...
        for i in range(total_vertices):
            ...
            if abs(mid_offset) < tolerance:
                ...
                if mid_offset < 0 and sel_negative:
                    side_vertices.append(vtx)
                    continue
