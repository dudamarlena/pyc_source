...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/matrix.py
...
import math, tpDcc.dccs.maya as maya
...
def get_rotation(matrix, rotation_order='xyz'):
    ...
    return (
     euler_rotation.x * radian, euler_rotation.y * radian, euler_rotation.z * radian)
...
def build_rotation(aim_vector, up_vector=(0, 1, 0), aim_axis='x', up_axis='y'):
    ...
    if negative_aim:
        aim_vector = (
         -aim_vector[0], -aim_vector[1], -aim_vector[2])
    else:
