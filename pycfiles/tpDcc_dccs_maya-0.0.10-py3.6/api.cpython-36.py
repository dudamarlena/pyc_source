...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/api.py
# Compiled at: 2020-05-13 19:28:33
# Size of source mod 2**32: 43328 bytes
"""
...
class Point(ApiObject, object):
    ...
    def get(self):
        return [
         self.obj.x, self.obj.y, self.obj.z, self.obj.w]

    def get_as_vector(self):
        return [
         self.obj.x, self.obj.y, self.obj.z]
...
class MeshFunction(MayaFunction, object):
    ...
    def get_closest_intersection(self, source_vector, direction_vector):
        ...
        self.obj.closestIntersection(point_base, point_direction, None, None, False, space, 100000, False, accelerator, hit_point, hit_param_ptr, hit_face_ptr, hit_triangle_ptr, hit_bary1_ptr, hit_bary2_ptr)
        return [
    ...
    def get_closest_intersection_face(self, source_vector, direction_vector, max_distance=10000):
        ...
        hit_bary2 = maya.OpenMaya.MScriptUtil()
        hit_bary2_ptr = hit_bary2.asFloatPtr()
        self.obj.closestIntersection(point_base, point_direction, None, None, False, space, max_distance, False, accelerator, hit_point, hit_param_ptr, hit_face_ptr, hit_triangle_ptr, hit_bary1_ptr, hit_bary2_ptr)
...
class NurbsSurfaceFunction(MayaFunction, object):
    ...
    def get_closest_parameter(self, vector):
        ...
        space = maya.OpenMaya.MSpace.kWorld
        self.obj.closestPoint(point.get_api_object(), 0, u_ptr, v_ptr, 0, 1e-05, space)
...
class NurbsCurveFunction(MayaFunction, object):
    ...
    def get_closest_position(self, list_value):
        ...
        point = self.obj.closestPoint(point.get_api_object(), None, 1e-07, maya.OpenMaya.MSpace.kWorld)
        return [
