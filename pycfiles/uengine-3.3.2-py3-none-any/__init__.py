...
# [GCC 8.4.0]
# Embedded file name: /Users/p.vorobyov/PycharmProjects/exyaru/commands/__init__.py
# Compiled at: 2019-01-28 04:01:20
...
def main():
    ...
    subparsers = parser.add_subparsers(title='Commands', help='One of the following commands', description='use <command> --help to get help on particular command', metavar='<command>')
    for command_class in load_commands():
        command = command_class()
        if command.NO_ARGPARSE:
            command_parser = subparsers.add_parser(command.NAME, help=command.DESCRIPTION, add_help=False, prefix_chars=chr(0))
