...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\arcadeplus\examples\sprite_ramps.py
# Compiled at: 2020-03-29 18:10:50
...
class MyGame(arcadeplus.Window):
    ...
    def on_draw(self):
        ...
        if self.game_over:
            output = 'Game Over'
            arcadeplus.draw_text(output, self.view_left + 200, self.view_bottom + 200, arcadeplus.color.WHITE, 30)
