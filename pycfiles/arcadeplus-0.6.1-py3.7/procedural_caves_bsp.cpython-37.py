...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\arcadeplus\examples\procedural_caves_bsp.py
# Compiled at: 2020-04-07 19:50:51
# Size of source mod 2**32: 17925 bytes
"""
...
"""
import random, arcadeplus.draw_commands, timeit, math, os
...
class RLDungeonGenerator:
    ...
    def random_split(self, min_row, min_col, max_row, max_col):
        ...
        if seg_height < self.MAX and seg_width < self.MAX:
            ...
            if seg_height < self.MAX <= seg_width:
    ...
    def distance_between_rooms(room1, room2):
        ...
        centre1 = (
         room1.row + room1.height // 2, room1.col + room1.width // 2)
...
class MyGame(arcadeplus.Window):
        ...
        if not MERGE_SPRITES:
            ...
            for row in range(dg.height):
                ...
                while column < dg.width:
                    ...
                    wall = arcadeplus.Sprite(':resources:images/tiles/grassCenter.png', WALL_SPRITE_SCALING, repeat_count_x=column_count)
    ...
    def on_draw(self):
        ...
        arcadeplus.draw_text(output, self.view_left + 20, WINDOW_HEIGHT - 20 + self.view_bottom, arcadeplus.color.WHITE, 16)
        output = f"Drawing time: {self.draw_time:.3f}"
        arcadeplus.draw_text(output, self.view_left + 20, WINDOW_HEIGHT - 40 + self.view_bottom, arcadeplus.color.WHITE, 16)
        output = f"Processing time: {self.processing_time:.3f}"
        arcadeplus.draw_text(output, self.view_left + 20, WINDOW_HEIGHT - 60 + self.view_bottom, arcadeplus.color.WHITE, 16)
    ...
    def on_update(self, delta_time):
        ...
        if self.player_sprite.bottom < bottom_bndry:
            ...
            changed = True
        if changed:
            arcadeplus.set_viewport(self.view_left, WINDOW_WIDTH + self.view_left, self.view_bottom, WINDOW_HEIGHT + self.view_bottom)
