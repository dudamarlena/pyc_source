...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/powercmd/command_invoker.py
# Compiled at: 2020-03-22 14:05:52
# Size of source mod 2**32: 7596 bytes
"""
Utilities for constructing command arguments.
"""
import collections, copy, enum, inspect
...
class CommandInvoker:
    ...
    def _get_union_ctor(annotation: Union):
        ...
        ANNOTATION.
        """
        internal_types = getattr(annotation, '__args__', None) or getattr(annotation, '__union_types__', None)
        if internal_types is None:
    ...
    def get_constructor(annotation: Any) -> Callable[([str], Any)]:
        ...
        return {bytes: lambda text: bytes(text, 'ascii')}.get(annotation, ensure_callable(annotation))
    ...
    @staticmethod
    def _construct_arg(formal_param: inspect.Parameter, value: str) -> Any:
        """
    ...
    @staticmethod
    def _fill_default_args(formal: Mapping[(str, inspect.Parameter)], actual: Mapping[(str, str)]):
        """
    ...
    @staticmethod
    def _construct_args(formal: Mapping[(str, inspect.Parameter)], assigned_args: Mapping[(str, str)]) -> Mapping[(str, Any)]:
        """
    ...
    def invoke(self, *args, cmdline: CommandLine):
        """
