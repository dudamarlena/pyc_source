...
def is_generic_union(annotation: Any):
    ...
    return hasattr(annotation, '__union_params__') or getattr(annotation, '__origin__', None) in (Union,)
...
def is_generic_type(annotation: Any) -> bool:
    ...
    """
    return is_generic_list(annotation) or is_generic_tuple(annotation) or is_generic_union(annotation)