...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/httpie_ems_auth.py
# Compiled at: 2016-11-10 13:39:49
"""
EmsAuth auth plugin for HTTPie.

"""
from httpie.plugins import AuthPlugin
import escherauth, datetime
...
class EmsAuth:
    ...
    def __call__(self, r):
        ...
        headers_to_sign = [ header for header in headers_to_sign if header not in ('accept',
                                                                                   'accept-encoding',
                                                                                   'user-agent',
                                                                                   'connection',
                                                                                   'content-type',
