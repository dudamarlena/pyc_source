...
# [GCC 8.4.0]
# Embedded file name: /home/fritz/github/posterior/treecat/treecat/profile.py
...
def run_with_tool(cmd, tool, dirname):
    ...
    if tool == 'timers':
        ...
        check_call_env([PYTHON, '-m', 'cProfile', '-o', profile_path] + cmd, env)
...
def train(rows=100, cols=10, epochs=5, clusters=32, tool='timers'):
    ...
    config = make_config(learning_init_epochs=epochs, model_num_clusters=clusters, model_ensemble_size=1)
