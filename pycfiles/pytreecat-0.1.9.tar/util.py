...
# [GCC 8.4.0]
# Embedded file name: /home/fritz/github/posterior/treecat/treecat/util.py
# Compiled at: 2017-08-14 22:48:52
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import atexit, contextlib, functools, logging, multiprocessing, os
...
TREECAT_THREADS = int(os.environ.get('TREECAT_THREADS', multiprocessing.cpu_count()))
...
def get_profiling_stats():
    return {'timers': {name:{'elapsed': timer.elapsed, 'count': timer.count} for name, timer in TIMERS.items()}, 
