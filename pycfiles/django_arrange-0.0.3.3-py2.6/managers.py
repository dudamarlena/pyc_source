...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/arrange/managers.py
...
def arrange(self, field):
    ...
    extra_select = {field: '(SELECT %s from %s WHERE item_id=%s.%s)' % (field, db_table, self.model._meta.db_table, pk_name)}
