...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nettools/cli.py
# Compiled at: 2017-04-03 12:36:15
import cmd, getpass, logging, os, os.path, sys, ConfigParser
...
class NetToolsShell(cmd.Cmd):
    ...
    def printHeader(self, o_type):
        ...
        """
        if o_type == 'vpc':
            msg = '%-10s %-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s' % ('Provider',
                                                                             'Region',
                                                                             'VpcId',
                                                                             'VpcName',
                                                                             'CIDR',
