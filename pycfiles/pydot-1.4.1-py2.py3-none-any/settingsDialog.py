...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pydosh/dialogs/settingsDialog.py
...
class SettingsDialog(Ui_Settings, QtGui.QDialog):
    ...
    def deleteAccount(self):
        for index in self.view.selectionModel().selectedRows():
            ...
            if recordCount:
                QtGui.QMessageBox.critical(self, 'Account Delete ', 'Cannot delete account, %d records exist for this account' % recordCount)
                return
            if index.isValid():
