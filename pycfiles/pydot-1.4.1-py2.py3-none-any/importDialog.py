...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pydosh/dialogs/importDialog.py
...
class ImportDialog(Ui_Import, QtGui.QDialog):
    ...
    def __init__(self, files, parent=None):
        ...
        self.currencyComboBox.setCurrentIndex(self.currencyComboBox.findText(currency.defaultCurrencyCode()))
            ...
            try:
                ...
                with db.transaction():
                    ...
                    if num:
                        ...
                        if QtGui.QMessageBox.question(self, 'Import', 'Imported %d records successfully' % num, QtGui.QMessageBox.Save | QtGui.QMessageBox.Cancel) != QtGui.QMessageBox.Save:
                            raise UserCancelledException
