...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/viewport.py
...
class MayaViewport(QWidget):
    ...
    def clean(self):
        ...
        maya.cmds.modelEditor((self.model_panel_name),
          edit=True, displayAppearance='smoothShaded', lw=(self._original_line_width))
