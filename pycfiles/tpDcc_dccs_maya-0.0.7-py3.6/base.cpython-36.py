...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/data/base.py
# Compiled at: 2020-04-11 22:28:15
# Size of source mod 2**32: 10053 bytes
"""
Module that contains base classes for Maya
"""
from __future__ import print_function, division, absolute_import
import logging, traceback, tpDcc as tp, tpDcc.dccs.maya as maya
...
class MayaFileData(MayaCustomData, object):
    ...
    def _handle_unknowns(self):
        ...
        if unknown_nodes:
            value = maya.cmds.confirmDialog(title='Unknown Nodes!',
