...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/meta/metaattribute.py
# Compiled at: 2020-04-11 22:28:15
# Size of source mod 2**32: 36684 bytes
"""
Module that contains functions and classes related with meta attributes
"""
from __future__ import print_function, division, absolute_import
import copy, logging, tpDcc.dccs.maya as maya
...
class MetaAttribute(object):
    ...
    def __init__(self, obj_name=None, attr_name=None, attr_type=False, value=None, enum=None, lock=None, keyable=None, hidden=None, min_value=None, max_value=None, default_value=None, *args, **kwargs):
        """
        ...
        if attr_type:
            ...
            if enum is not None:
                ...
                if value and attr_type is False and not self.obj.has_attr(attr_name):
                ...
                if maya.cmds.objExists('{0}.{1}'.format(self.obj.meta_node, attr_name)):
                    ...
                    if not metautils.MetaAttributeUtils.validate_attr_type_match(self.attr_type, current_type):
                        if self.attr_type is not False:
    ...
    def set_alias(self, alias):
        ...
        try:
            ...
            fmt_args = [
             self.obj.short_name, self.long_name, alias, e]
    ...
    def set(self, value, *args, **kwargs):
        ...
        try:
                    ...
                    if self.get_children():
                        for i, c in enumerate(self.get_children()):
                            try:
                                ...
                                if type(value) is list:
                                    if len(self.get_children()) == len(value):
            ...
            fmt_args = [
             self.obj.short_name, self.long_name, value, e]
    ...
    def set_locked(self, lock=True):
        ...
        try:
            ...
            fmt_args = [
             self.obj.short_name, self.long_name, lock, e]
    ...
    def set_keyable(self, keyable):
        ...
        """
        keyable_types = [
         'long', 'float', 'bool', 'double', 'enum', 'double3', 'doubleAngle', 'doubleLinear']
        try:
            ...
            fmt_args = [
             self.obj.short_name, self.long_name, keyable, e]
    ...
    def set_hidden(self, hide):
        ...
        try:
            ...
            fmt_args = [
             self.obj.short_name, self.long_name, hide, e]
    ...
    def set_enum(self, enums):
        ...
        """
        fmt_args = [
         self.obj.short_name, self.long_name, enums]
    ...
    def is_dynamic(self):
        ...
        """
        if self.attr:
            if maya.cmds.listAttr((self.obj.meta_node), userDefined=True):
                return True
    ...
    def is_numeric(self):
        ...
        :return: bool
        """
        if maya.cmds.getAttr((self.combined_name), type=True) in ('string', 'message',
                                                                  'enum', 'bool'):
            return False
        else:
            return True
    ...
    def convert(self, attr_type):
        ...
        try:
            ...
            fmt_args = [
             self.obj.short_name, self.long_name, attr_type, e]
    ...
    def get_children(self, as_meta=False):
        ...
        try:
            ...
            fmt_args = [
             self.obj.short_name, self.long_name]
