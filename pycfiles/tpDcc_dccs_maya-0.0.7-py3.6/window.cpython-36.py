...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/ui/window.py
...
class MayaWindow(core_window.MainWindow, object):
    ...
    def bootstrap_widget(self):
        ...
        if self._current_docked is None:
            if bootstrap_widget is not None:
    ...
    def delete_bootstrap(self):
        ...
        if bootstrap is not None:
            self.setProperty('bootstrapWidget', None)
            bootstrap.close()
