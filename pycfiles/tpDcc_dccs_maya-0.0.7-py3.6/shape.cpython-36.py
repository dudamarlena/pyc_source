...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/shape.py
# Compiled at: 2020-04-11 22:28:15
# Size of source mod 2**32: 18532 bytes
"""
...
GEO_OUTPUT = {'mesh':[
 ...
 'nurbsSurface':[
  '.local', '.worldSpace'], 
 'lattice':[
  '.latticeOutput', '.worldLattice'], 
 'subdiv':[
  '.outSubdiv', '.worldSubdiv']}
ALL_GEO = [
 'mesh',
 'nurbsSurface',
 'subdiv']
GEO_INPUT = {'mesh':'.inMesh', 
 'nurbsCurve':'.create', 
 'nurbsSurface':'.create', 
...
def find_input_shape_1(shape):
    ...
    :return:  str
    """
    import maya.OpenMaya as OpenMaya, maya.OpenMayaAnim as OpenMayaAnim
...
def get_shapes_in_hierarchy(transform_node, shape_type='', return_parent=False, skip_first_relative=False, full_path=True, intermediate_shapes=False):
    """
