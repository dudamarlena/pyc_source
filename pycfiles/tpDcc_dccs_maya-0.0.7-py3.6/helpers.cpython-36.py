...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/helpers.py
...
def add_button_to_current_shelf(enable=True, name='tpShelfButton', width=234, height=34, manage=True, visible=True, annotation='', label='', image1='commandButton.png', style='iconAndTextCentered', command='', check_if_already_exists=True):
    """
    ...
    maya.cmds.shelfButton(parent=(gui.get_current_shelf()),
      enable=True,
      width=34,
      height=34,
      manage=True,
