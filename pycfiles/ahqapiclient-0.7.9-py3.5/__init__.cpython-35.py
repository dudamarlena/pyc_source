...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ahqapiclient/__init__.py
# Compiled at: 2017-10-26 06:54:41
...
class Client(object):
    ...
    def __init__(self, endpoint, timeout=60, session=None):
        http_client = HTTPClient(endpoint, timeout, session)
