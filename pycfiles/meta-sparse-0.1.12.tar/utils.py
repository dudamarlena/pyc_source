...
# [GCC 8.4.0]
# Embedded file name: /home/zhemin/software/SPARSE_wrapper/SPARSE/modules/utils.py
# Compiled at: 2018-04-13 07:43:03
import os, sys, subprocess, numpy as np, urllib2, pandas as pd, contextlib, time
try:
        ...
        if ref_msh is None:
            ...
            for default_db in init_dbs:
                if os.path.exists(default_db):
                    ...
                    for line in iter(msh_run.stdout.readline, ''):
