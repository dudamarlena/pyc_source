...
# [GCC 8.4.0]
# Embedded file name: /home/ubuntu/workspace/src/kotti_toolkit/kotti_toolkit/scripts/importer.py
# Compiled at: 2018-09-19 16:34:46
import os, sys, json, re, csv, uuid, time, operator, random, transaction, progress.bar, gzip, click, ConfigParser, subprocess
from pyramid.paster import bootstrap
from kotti.resources import get_root
from kotti import DBSession
from kotti.resources import Document
from kotti.security import USER_MANAGEMENT_ROLES
import sqlalchemy.orm.exc, funcs, manage_users
...
@click.option('--roles', help='User roles', type=click.Choice(USER_MANAGEMENT_ROLES), multiple=True)
