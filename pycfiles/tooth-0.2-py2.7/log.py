...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tooth/log.py
# Compiled at: 2015-05-01 17:10:07
__author__ = 'Tom James Holub'
import sys, pprint, traceback, string, os, datetime, json, thread, smtplib
...
class ThreadStdout:
    ...
    def write(self, value):
        if thread.get_ident() != self.MAIN_THREAD:
