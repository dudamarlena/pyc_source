...
# [GCC 8.4.0]
# Embedded file name: /home/leotrubach/development/django-saas-email/venv/lib/python3.7/site-packages/django_saas_email/migrations/0001_initial.py
...
import tinymce.models, uuid

class Migration(migrations.Migration):
    initial = True
    dependencies = []
    operations = [
     migrations.CreateModel(name='Mail',
       fields=[
      (
      ...
      (
       'context', JSONField(blank=True, help_text='JSON dump of context dictionary used to fill in templates', null=True, verbose_name='Data of email context')),
      (
     ...
     migrations.CreateModel(name='MailTemplate',
       fields=[
      (
