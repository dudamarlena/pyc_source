...
# [GCC 8.4.0]
# Embedded file name: /home/leotrubach/development/django-saas-email/venv/lib/python3.7/site-packages/django_saas_email/admin.py
# Compiled at: 2019-02-13 19:46:57
    ...
    def test_mail_template(self, request, queryset):
        ...
        if not settings.DJANGO_SAAS_TEST_EMAIL_ADDRESS:
            ...
            for template in queryset:
                create_and_send_mail(template_name=(template.name),
                  context={},
                  to_address=(settings.DJANGO_SAAS_TEST_EMAIL_ADDRESS))
                mails_sent += 1
...
class MailAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'time_created', 'from_address', 'to_address', 'cc_address',
    ...
    actions = [
     send_mail_now]
    readonly_fields = ('time_created', 'time_sent', 'time_delivered', 'used_backend',
                       'delivery_mail_id', 'delivery_status')