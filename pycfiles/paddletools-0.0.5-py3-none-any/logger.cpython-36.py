...
# [GCC 8.4.0]
# Embedded file name: /home/lvkun/projects/self/PaddleTools/paddletools/utils/logger.py
# Compiled at: 2020-05-10 05:06:26
# Size of source mod 2**32: 4799 bytes
import logging, math, os, colorlog
...
class Logger(object):
    ...
    def __init__(self, name='PaddleTools', level='INFO'):
        ...
        self.format = colorlog.ColoredFormatter('%(log_color)s[%(asctime)-15s] [%(levelname)8s] - %(message)s',
