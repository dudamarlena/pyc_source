...
# [GCC 8.4.0]
# Embedded file name: /var/lib/jenkins/jobs/Lucterios_Standard/workspace/lct-contacts/lucterios/contacts/migrations/0002_addon.py
...
def addon_postalcodes(apps, schema_editor):
    ...
    for pcfile in pcfile_list:
        pc_list.extend(import_file_postalcode(postalcode, join(migrat_dir, pcfile)))
    else:
        if len(pc_list) > 0:
