...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/api/uhost.py
...
class UhostManager(base.Manager):
    ...
    def create(self, region, imageid, loginmode, password=None, keypair=None, cpu=None, memory=None, diskspace=None, name=None, networkid=None, securitygroupid=None, chargetype=None, quantity=None):
        """
        boot an instance
        :param region:
        :param imageid:
    ...
    def get_price(self, region, imageid, cpu, memory, count, charge_type=None, disk_space=None):
        """
    ...
    def get_image(self, region, image_type=None, os_type=None, image_id=None, offset=None, limit=None):
        """
        get image info
        :param region:
        :param image_type:
