...
# Embedded file name: build/bdist.macosx-10.9-intel/egg/ez_setup.py
# Compiled at: 2014-05-31 17:14:04
__doc__ = "Bootstrap setuptools installation\n\nTo use setuptools in your package's setup.py, include this\nfile in the same directory and add this to the top of your setup.py::\n\n    from ez_setup import use_setuptools\n    use_setuptools()\n\nTo require a specific version of setuptools, set a download\nmirror, or use an alternate download directory, simply supply\nthe appropriate options to ``use_setuptools()``.\n\nThis file can also be run as a script to install or upgrade setuptools.\n"
import os, shutil, sys, tempfile, zipfile, optparse, subprocess, platform, textwrap, contextlib
