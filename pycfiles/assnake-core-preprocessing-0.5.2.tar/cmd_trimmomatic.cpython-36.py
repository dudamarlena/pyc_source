...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/fedor/Documents/dev/assnake-core-preprocessing/assnake_core_preprocessing/trimmomatic/cmd_trimmomatic.py
# Compiled at: 2020-01-30 12:45:52
...
@click.pass_obj
def trimmomatic_invocation(config, df, preproc, samples_to_add, params):
    ...
    click.echo(tabulate((ss.samples_pd[['fs_name', 'reads', 'preproc']].sort_values('reads')), headers='keys',
      tablefmt='fancy_grid'))
    res_list = ss.get_locs_for_result('trimmomatic', params=params)
