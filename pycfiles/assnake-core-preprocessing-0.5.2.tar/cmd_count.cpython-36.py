...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/fedor/Documents/dev/assnake-core-preprocessing/assnake_core_preprocessing/count/cmd_count.py
...
@click.option('--samples-to-add', '-s', help='Samples from dataset to process',
  ...
  type=(click.STRING))
@click.pass_obj
def count_invocation(config, df, preproc, samples_to_add):
