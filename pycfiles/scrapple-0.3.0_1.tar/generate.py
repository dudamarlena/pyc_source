...
# [GCC 8.4.0]
# Embedded file name: /home/enygma/Stuff/Project/Scraping/scrapple/docs/../scrapple/commands/generate.py
# Compiled at: 2015-03-31 12:18:22
"""
...
class GenerateCommand(command.Command):
    ...
    def execute_command(self):
        ...
        The Python script is written into <output_filename>.py - running this file         is the equivalent of using the Scrapple :ref:`run command <command-run>`. 
        ...
        try:
            ...
            with open(self.args['<output_filename>'] + '.py', 'w') as (f):
                f.write(rendered)
            print(Back.WHITE + Fore.RED + self.args['<output_filename>'], '.py has been created' + Back.RESET + Fore.RESET, sep='')
        except IOError:
