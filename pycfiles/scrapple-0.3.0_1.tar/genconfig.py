...
# [GCC 8.4.0]
# Embedded file name: /home/enygma/Stuff/Project/Scraping/scrapple/scrapple/commands/genconfig.py
# Compiled at: 2016-08-17 07:16:29
"""
...
class GenconfigCommand(command.Command):
    ...
    def execute_command(self):
        ...
        settings = {'projectname': self.args['<projectname>'], 
        ...
        print(Back.WHITE + Fore.RED + self.args['<projectname>'], '.json has been created' + Back.RESET + Fore.RESET, sep='')