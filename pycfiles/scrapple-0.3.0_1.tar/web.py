...
# [GCC 8.4.0]
# Embedded file name: /home/enygma/Stuff/Project/Scraping/scrapple/scrapple/commands/web.py
# Compiled at: 2015-04-14 17:35:30
"""
...
class WebCommand(command.Command):
    ...
    def execute_command(self):
        ...
        When the execute_command() method is called from the         :ref:`runCLI() <implementation-cli>` function, it starts of two simultaneous         processes : 
    ...
    def home():
        if request.method == 'POST':
            try:
                ...
                return render_template('complete.html', filename=request.form['project_name'])
            except Exception as e:
