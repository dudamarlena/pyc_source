...
# [GCC 8.4.0]
# Embedded file name: D:\SM\CODE\django-aops-sunteng\aops\libs\forms\field.py
    ...
    def render_options(self, choices, selected_choices):
        ...
        for option_value, option_label in choi:
            if isinstance(option_label, (list, tuple)):
                output.append('<optgroup label="%s">' % escape(force_unicode(option_value)).replace(' ', '&nbsp'))
