...
# [GCC 8.4.0]
# Embedded file name: D:\SM\CODE\sfsm\venv\lib\site-packages\spcc\forms\field.py
# Compiled at: 2018-11-04 01:40:59
...
class newSelect(Select):
    ...
    def render(self, name, value, attrs=None, choices=()):
        if value is None:
            ...
            if hasattr(self, 'd_class'):
                if hasattr(self.d_class, 'get_add_url'):
    ...
    def render_options(self, choices, selected_choices):
        ...
        for option_value, option_label in choi:
            if isinstance(option_label, (list, tuple)):
                output.append('<optgroup label="%s">' % escape(force_text(option_value)).replace(' ', '&nbsp'))
