...
# [GCC 8.4.0]
# Embedded file name: /media/jks/Root/Dev/python/jkspy/jkspy/modules/crypto.py
# Compiled at: 2016-03-02 18:48:02
# Size of source mod 2**32: 5942 bytes
""" Dependency: Crypto """
...
HASH_ALGORITHMS = {'MD5': MD5,  'SHA': SHA, 
 'SHA256': SHA256, 
 'SHA512': SHA512, 
 'HMAC': HMAC}
...
HEXBIN_MAPPING = {'0': '0000',  '1': '0001',  '2': '0010',  '3': '0011',  '4': '0100', 
...
def sencrypt(passphrase, plaintext, mode='CFB'):
    ...
    key = get_hash(passphrase, 'sha256', False)
