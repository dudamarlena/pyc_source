...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/libs/pyblish/validators/modeling/general/cleanhistory.py
                    ...
                    for shape in shapes:
                        ...
                        for history_node in shape_history:
                            if maya.cmds.nodeType(history_node) == 'groupId':
                                ...
                                if maya.cmds.nodeType(history_node) == 'shadingEngine' and maya.cmds.attributeQuery('memberWireframeColor', node=history_node, exists=True):
