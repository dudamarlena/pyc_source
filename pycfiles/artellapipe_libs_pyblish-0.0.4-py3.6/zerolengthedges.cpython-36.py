...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/libs/pyblish/validators/modeling/topology/zerolengthedges.py
...
class ValidateZeroLengthEdges(pyblish.api.InstancePlugin):
    ...
    def process(self, instance):
        ...
        if not nodes_to_check:
            ...
            assert not zero_length_edges_found, 'Zero Length Edges found in the following components: {}'.format(zero_length_edges_found)
