...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/libs/pyblish/validators/modeling/transform/uncenteredpivots.py
...
class ValidateUncenteredPivots(pyblish.api.InstancePlugin):
    ...
    def process(self, instance):
        ...
        if not nodes_to_check:
            ...
            assert not uncentered_pivots, 'Uncentered pivots found in following geometry nodes: {}'.format(uncentered_pivots)
