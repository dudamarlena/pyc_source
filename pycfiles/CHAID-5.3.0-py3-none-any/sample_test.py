...
# Embedded file name: /home/aaron/projects/chai/tests/sample_test.py
# Compiled at: 2016-02-12 14:23:08
__doc__ = '\nTests for the sample module\n'
import os, random, unittest, sys
...
class SampleBaseTest(Chai):
    ...
    def test_expect_bound_method_with_anyof_comparator(self):
        obj = SampleBase()
        expect(obj.bound_method).times(4).args(any_of(int, 3.14, 'hello', is_a(list)))
        obj.bound_method(42)
