...
# [GCC 8.4.0]
# Embedded file name: skytap/models/Interface.py
# Compiled at: 2016-12-16 14:55:45
"""Support for an interface resource in Skytap."""
import json
from skytap.framework.ApiClient import ApiClient
from skytap.models.PublishedServices import PublishedServices
...
class Interface(SkytapResource):
    ...
    def __getattr__(self, key):
        ...
        if key == 'services':
            ...
            self.services = PublishedServices(services_json['services'], self.url)
