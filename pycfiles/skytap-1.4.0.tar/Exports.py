...
# [GCC 8.4.0]
# Embedded file name: skytap/Exports.py
# Compiled at: 2017-01-03 13:20:41
...
class Exports(SkytapGroup):
    ...
    def create(self, vmid):
        ...
        Utils.warning('Trying to create new export job from VM ' + vmid + ', but got an unexpected response from Skytap. ' + 'Response:\n' + response)
        return 0
