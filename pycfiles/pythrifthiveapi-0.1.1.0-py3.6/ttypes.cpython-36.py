...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/pythrifthiveapi/TCLIService/ttypes.py
# Compiled at: 2017-06-13 11:27:15
# Size of source mod 2**32: 234326 bytes
...
class TTypeQualifiers(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.MAP, 'qualifiers', (TType.STRING, 'UTF8', TType.STRUCT, (TTypeQualifierValue, TTypeQualifierValue.thrift_spec), False), None))
...
class TTypeEntry(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'primitiveEntry', (TPrimitiveTypeEntry, TPrimitiveTypeEntry.thrift_spec), None),
     (
      2, TType.STRUCT, 'arrayEntry', (TArrayTypeEntry, TArrayTypeEntry.thrift_spec), None),
     (
      3, TType.STRUCT, 'mapEntry', (TMapTypeEntry, TMapTypeEntry.thrift_spec), None),
     (
      4, TType.STRUCT, 'structEntry', (TStructTypeEntry, TStructTypeEntry.thrift_spec), None),
     (
      5, TType.STRUCT, 'unionEntry', (TUnionTypeEntry, TUnionTypeEntry.thrift_spec), None),
     (
      6, TType.STRUCT, 'userDefinedTypeEntry', (TUserDefinedTypeEntry, TUserDefinedTypeEntry.thrift_spec), None))
...
class TTypeDesc(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'types', (TType.STRUCT, (TTypeEntry, TTypeEntry.thrift_spec), False), None))
...
class TColumnDesc(object):
    ...
    thrift_spec = (
     ...
     (
      2, TType.STRUCT, 'typeDesc', (TTypeDesc, TTypeDesc.thrift_spec), None),
     (
...
class TTableSchema(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'columns', (TType.STRUCT, (TColumnDesc, TColumnDesc.thrift_spec), False), None))
...
class TColumnValue(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'boolVal', (TBoolValue, TBoolValue.thrift_spec), None),
     (
      2, TType.STRUCT, 'byteVal', (TByteValue, TByteValue.thrift_spec), None),
     (
      3, TType.STRUCT, 'i16Val', (TI16Value, TI16Value.thrift_spec), None),
     (
      4, TType.STRUCT, 'i32Val', (TI32Value, TI32Value.thrift_spec), None),
     (
      5, TType.STRUCT, 'i64Val', (TI64Value, TI64Value.thrift_spec), None),
     (
      6, TType.STRUCT, 'doubleVal', (TDoubleValue, TDoubleValue.thrift_spec), None),
     (
      7, TType.STRUCT, 'stringVal', (TStringValue, TStringValue.thrift_spec), None))
...
class TRow(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'colVals', (TType.STRUCT, (TColumnValue, TColumnValue.thrift_spec), False), None))
...
class TColumn(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'boolVal', (TBoolColumn, TBoolColumn.thrift_spec), None),
     (
      2, TType.STRUCT, 'byteVal', (TByteColumn, TByteColumn.thrift_spec), None),
     (
      3, TType.STRUCT, 'i16Val', (TI16Column, TI16Column.thrift_spec), None),
     (
      4, TType.STRUCT, 'i32Val', (TI32Column, TI32Column.thrift_spec), None),
     (
      5, TType.STRUCT, 'i64Val', (TI64Column, TI64Column.thrift_spec), None),
     (
      6, TType.STRUCT, 'doubleVal', (TDoubleColumn, TDoubleColumn.thrift_spec), None),
     (
      7, TType.STRUCT, 'stringVal', (TStringColumn, TStringColumn.thrift_spec), None),
     (
...
class TRowSet(object):
    ...
    thrift_spec = (
     ...
     (
      2, TType.LIST, 'rows', (TType.STRUCT, (TRow, TRow.thrift_spec), False), None),
     (
      3, TType.LIST, 'columns', (TType.STRUCT, (TColumn, TColumn.thrift_spec), False), None))
...
class TSessionHandle(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'sessionId', (THandleIdentifier, THandleIdentifier.thrift_spec), None))
...
class TOperationHandle(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'operationId', (THandleIdentifier, THandleIdentifier.thrift_spec), None),
     (
...
class TOpenSessionReq(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.I32, 'client_protocol', None, 5),
     (
...
class TOpenSessionResp(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'status', (TStatus, TStatus.thrift_spec), None),
     (
      2, TType.I32, 'serverProtocolVersion', None, 5),
     (
...
class TCloseSessionReq(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'sessionHandle', (TSessionHandle, TSessionHandle.thrift_spec), None))
...
class TGetInfoResp(object):
    ...
    thrift_spec = (
     ...
     (
      1, TType.STRUCT, 'status', (TStatus, TStatus.thrift_spec), None),
     (
      2, TType.STRUCT, 'infoValue', (TGetInfoValue, TGetInfoValue.thrift_spec), None))
...
class TExecuteStatementResp(object):
    ...
    thrift_spec = (
     ...
     (
      1, TType.STRUCT, 'status', (TStatus, TStatus.thrift_spec), None),
     (
      2, TType.STRUCT, 'operationHandle', (TOperationHandle, TOperationHandle.thrift_spec), None))
...
class TGetOperationStatusReq(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'operationHandle', (TOperationHandle, TOperationHandle.thrift_spec), None))
...
class TGetResultSetMetadataResp(object):
    ...
    thrift_spec = (
     ...
     (
      1, TType.STRUCT, 'status', (TStatus, TStatus.thrift_spec), None),
     (
      2, TType.STRUCT, 'schema', (TTableSchema, TTableSchema.thrift_spec), None))
...
class TFetchResultsReq(object):
    ...
    thrift_spec = (
     ...
     (
      4, TType.I16, 'fetchType', None, None))
...
class TFetchResultsResp(object):
    ...
    thrift_spec = (
     ...
     (
      3, TType.STRUCT, 'results', (TRowSet, TRowSet.thrift_spec), None))
