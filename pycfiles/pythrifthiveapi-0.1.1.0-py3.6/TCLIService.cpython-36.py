...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/pythrifthiveapi/TCLIService/TCLIService.py
# Compiled at: 2017-06-13 11:27:15
# Size of source mod 2**32: 119441 bytes
...
class OpenSession_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TOpenSessionReq, TOpenSessionReq.thrift_spec), None))
...
class OpenSession_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TOpenSessionResp, TOpenSessionResp.thrift_spec), None),)
...
class CloseSession_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TCloseSessionReq, TCloseSessionReq.thrift_spec), None))
...
class CloseSession_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TCloseSessionResp, TCloseSessionResp.thrift_spec), None),)
...
class GetInfo_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetInfoReq, TGetInfoReq.thrift_spec), None))
...
class GetInfo_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetInfoResp, TGetInfoResp.thrift_spec), None),)
...
class ExecuteStatement_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TExecuteStatementReq, TExecuteStatementReq.thrift_spec), None))
...
class ExecuteStatement_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TExecuteStatementResp, TExecuteStatementResp.thrift_spec), None),)
...
class GetTypeInfo_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetTypeInfoReq, TGetTypeInfoReq.thrift_spec), None))
...
class GetTypeInfo_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetTypeInfoResp, TGetTypeInfoResp.thrift_spec), None),)
...
class GetCatalogs_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetCatalogsReq, TGetCatalogsReq.thrift_spec), None))
...
class GetCatalogs_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetCatalogsResp, TGetCatalogsResp.thrift_spec), None),)
...
class GetSchemas_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetSchemasReq, TGetSchemasReq.thrift_spec), None))
...
class GetSchemas_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetSchemasResp, TGetSchemasResp.thrift_spec), None),)
...
class GetTables_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetTablesReq, TGetTablesReq.thrift_spec), None))
...
class GetTables_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetTablesResp, TGetTablesResp.thrift_spec), None),)
...
class GetTableTypes_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetTableTypesReq, TGetTableTypesReq.thrift_spec), None))
...
class GetTableTypes_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetTableTypesResp, TGetTableTypesResp.thrift_spec), None),)
...
class GetColumns_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetColumnsReq, TGetColumnsReq.thrift_spec), None))
...
class GetColumns_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetColumnsResp, TGetColumnsResp.thrift_spec), None),)
...
class GetFunctions_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetFunctionsReq, TGetFunctionsReq.thrift_spec), None))
...
class GetFunctions_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetFunctionsResp, TGetFunctionsResp.thrift_spec), None),)
...
class GetOperationStatus_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetOperationStatusReq, TGetOperationStatusReq.thrift_spec), None))
...
class GetOperationStatus_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetOperationStatusResp, TGetOperationStatusResp.thrift_spec), None),)
...
class CancelOperation_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TCancelOperationReq, TCancelOperationReq.thrift_spec), None))
...
class CancelOperation_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TCancelOperationResp, TCancelOperationResp.thrift_spec), None),)
...
class CloseOperation_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TCloseOperationReq, TCloseOperationReq.thrift_spec), None))
...
class CloseOperation_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TCloseOperationResp, TCloseOperationResp.thrift_spec), None),)
...
class GetResultSetMetadata_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetResultSetMetadataReq, TGetResultSetMetadataReq.thrift_spec), None))
...
class GetResultSetMetadata_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetResultSetMetadataResp, TGetResultSetMetadataResp.thrift_spec), None),)
...
class FetchResults_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TFetchResultsReq, TFetchResultsReq.thrift_spec), None))
...
class FetchResults_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TFetchResultsResp, TFetchResultsResp.thrift_spec), None),)
...
class GetDelegationToken_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetDelegationTokenReq, TGetDelegationTokenReq.thrift_spec), None))
...
class GetDelegationToken_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetDelegationTokenResp, TGetDelegationTokenResp.thrift_spec), None),)
...
class CancelDelegationToken_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TCancelDelegationTokenReq, TCancelDelegationTokenReq.thrift_spec), None))
...
class CancelDelegationToken_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TCancelDelegationTokenResp, TCancelDelegationTokenResp.thrift_spec), None),)
...
class RenewDelegationToken_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TRenewDelegationTokenReq, TRenewDelegationTokenReq.thrift_spec), None))
...
class RenewDelegationToken_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TRenewDelegationTokenResp, TRenewDelegationTokenResp.thrift_spec), None),)
...
class GetLog_args(object):
    ...
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'req', (TGetLogReq, TGetLogReq.thrift_spec), None))
...
class GetLog_result(object):
    ...
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (TGetLogResp, TGetLogResp.thrift_spec), None),)
