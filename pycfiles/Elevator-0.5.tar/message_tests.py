...
# [GCC 8.4.0]
# Embedded file name: /home/oleiade/Dev/Sandbox/Python/Elevator/tests/message_tests.py
# Compiled at: 2012-10-23 04:08:00
from __future__ import absolute_import
import unittest2, msgpack
from nose.tools import raises
from elevator.message import Request, ResponseContent, ResponseHeader, MessageFormatError
...
class RequestTest(unittest2.TestCase):
    ...
    def test_request_with_missing_mandatory_arguments(self):
        request = msgpack.packb({'uid': '123-456-789', 
           'cmd': 'GET'})
    ...
    def test_valid_request_with_meta(self):
        request = msgpack.packb({'meta': {'test': 'test'}, 
           'uid': '123-456-789', 
           'cmd': 'PUT', 
           'args': [
                  'key', 'value']})
