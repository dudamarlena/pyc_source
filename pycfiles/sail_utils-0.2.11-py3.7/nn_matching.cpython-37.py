...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\sail_utils\cv\head\deep_sort\nn_matching.py
# Compiled at: 2020-04-22 06:51:42
# Size of source mod 2**32: 5784 bytes
import numpy as np
from sail_utils.cv.head.deep_sort.config import MAX_COSINE_DISTANCE, NN_BUDGET
