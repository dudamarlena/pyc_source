...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\sail_utils\cv\head\deep_sort\kalman_filter.py
# Compiled at: 2020-04-22 07:18:19
...
class KalmanFilter:
    ...
    def gating_distance(self, mean, covariance, measurements, only_position=False):
        ...
        z = scipy.linalg.solve_triangular(cholesky_factor,
          (d.T), lower=True, check_finite=False, overwrite_b=True)
