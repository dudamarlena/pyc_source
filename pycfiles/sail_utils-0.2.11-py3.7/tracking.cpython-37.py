...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\sail_utils\mlflow\tracking.py
# Compiled at: 2020-03-27 07:24:20
...
class MLFlowClient:
    ...
    def get_experiments(self, experiment_id: int, max_result: int=MAX_RESULTS) -> pd.DataFrame:
        ...
        :return:
        """
        runs_info = self._client.search_runs(experiment_ids=experiment_id, max_results=max_result)
        results = dict()
        column_names = set()
