...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/edsd/utils.py
# Compiled at: 2016-05-06 01:39:25
"""
...
' will be appended in the end if 'end' is True, default
    ...
    if width == 0:
        ...
        tpl = ('\r{0:.<' + unicode(width) + '}[{1}]').format(msg, status)
    if end:
        tpl += '\n'
...
def check(name=None, strict=True):
    ...
    def dec(clz):
        ...
        attributes = dict(_ch_name=ch_name, _check_id=func_id, _points=pts, _strict=strict)
