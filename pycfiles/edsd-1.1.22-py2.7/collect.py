...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/edsd/collect.py
# Compiled at: 2016-07-28 10:48:48
"""
edas-detector.collect : Collect all running information
"""
import shutil, sys, edsd.hsf
...
def address_servers(path):
    info = '====================' + 'Address Server Information' + '====================' + '\r\n'
    try:
        ...
        spec_url = 'http://%s:8080/diamond-server/config.do?group=spas_info&dataId=spas_authentication_url' % ddh
