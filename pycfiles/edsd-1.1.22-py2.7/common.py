...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/edsd/common.py
# Compiled at: 2016-10-14 01:00:30
"""
...
class DefaultEncoder(json.JSONEncoder):
    ...
    def default(self, o):
        ...
        f = lambda k: not k[0].startswith('__') and k[1] is not None and type(k[1]) not in [types.LambdaType,
         types.FunctionType,
         staticmethod,
         classmethod,
         types.MethodType]
