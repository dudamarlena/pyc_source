...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/edsd/edsdmain.py
# Compiled at: 2016-10-17 08:24:59
"""
...
try:
    ...
    if user != 'admin':
        err(colored('Warning', 'red') + ": edsd is recommended running with user 'admin'\n")
    import sys
...
def commandline():
    ...
    parser.add_option('-v', '--verbose', dest='verbose', action='store_true', default=False, help='print detail messages.')
