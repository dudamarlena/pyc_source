...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hepdata_converter/testsuite/test_csvwriter.py
...
class CSVWriterTestCase(WriterTestSuite):
    ...
    def test_csvwriter_options(self, table_1_content):
        csv_content = convert(self.submission_filepath, options={'input_format': 'yaml', 'output_format': 'csv', 
           'table': 'Table 1', 
           'pack': True, 
    ...
    def test_multiple_tables_pack(self, table_1_content, table_9_content):
        convert(self.submission_filepath, self.current_tmp, options={'input_format': 'yaml', 'output_format': 'csv', 
           'pack': True, 
           'validator_schema_version': '0.1.0'})
