...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hepdata_converter/__init__.py
# Compiled at: 2020-03-05 14:33:22
import StringIO, argparse, sys, version
...
def _main(arguments=sys.argv):
    ...
    parser = argparse.ArgumentParser(description='CLI tools for converting between HEP data formats', add_help=True, formatter_class=argparse.RawTextHelpFormatter, epilog=generate_help_epilogue())
