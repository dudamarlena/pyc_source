...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hepdata_converter/testsuite/test_yamlwriter.py
...
class YAMLWriterTestSuite(WriterTestSuite):
    ...
    def test_single_file_output(self, oldhepdata_path, oldhepdata_file, oldhepdata_yaml_file):
        data = hepdata_converter.convert(oldhepdata_file, options={'input_format': 'oldhepdata', 
           'output_format': 'yaml', 
           'single_file': True})
    ...
    def test_create_newdir(self, oldhepdata_path, yaml_path):
        ...
        hepdata_converter.convert(oldhepdata_path, new_dir, options={'input_format': 'oldhepdata', 'output_format': 'yaml'})
