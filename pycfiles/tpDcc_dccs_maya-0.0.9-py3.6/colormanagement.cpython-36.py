...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/maya/core/colormanagement.py
...
def toggle_color_management():
    ...
    """
    return maya.cmds.colorManagementPrefs(cmEnabled=(not maya.cmds.colorManagementPrefs(cmEnabled=True, query=True)),
      edit=True)
