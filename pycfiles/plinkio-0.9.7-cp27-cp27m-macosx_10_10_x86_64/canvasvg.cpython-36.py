                    ...
                    try:
                        ...
                        if float(disabledwidth) > 0:
                            ...
                            if width:
                                ...
                                if state == DISABLED:
                                    if canvas.itemcget(item, 'disableddash'):
                            ...
                            if itemtype == 'oval':
                                ...
                                if itemtype == 'rectangle':
                                    ...
                                    if itemtype == 'arc':
                                        ...
                                        element = setattribs((document.createElement('text')),
                                          x=x,
                                          y=y)
                                        elements.append(element)
...
def segment_to_line(document, coords):
    ...
    return setattribs((document.createElement('line')),
      x1=(coords[0]),
      y1=(coords[1]),
      x2=(coords[2]),
      y2=(coords[3]))
...
def segment_to_path(document, coords):
    ...
    return setattribs((document.createElement('path')),
...
def polyline(document, coords):
    ...
    return setattribs((document.createElement('polyline')),
      points=(' '.join(points)))
...
def rectangle(document, coords):
    ...
    return setattribs(element, x=(coords[0]),
      y=(coords[1]),
...
def oval(document, coords):
    ...
    x1, y1, x2, y2 = coords
    if x2 - x1 == y2 - y1:
        return setattribs((document.createElement('circle')), cx=((x1 + x2) / 2),
          cy=((y1 + y2) / 2),
          r=(abs(x2 - x1) / 2))
    else:
        return setattribs((document.createElement('ellipse')), cx=((x1 + x2) / 2),
          cy=((y1 + y2) / 2),
          rx=(abs(x2 - x1) / 2),
          ry=(abs(y2 - y1) / 2))
        return element
