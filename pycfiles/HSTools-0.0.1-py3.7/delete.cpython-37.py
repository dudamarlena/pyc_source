...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/hstools/funcs/delete.py
# Compiled at: 2019-10-23 10:31:56
...
def add_arguments(parser):
    ...
    parser.add_argument('resource_id', nargs='+',
      type=str,
      help='unique HydroShare resource identifier to be deleted')
