...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/concurrent_tree_crawler/common/threads/token_bucket.py
...
class TokenBucketFiller(threading.Thread):
    ...
    def run(self):
        try:
            ...
            logging.error(('In TokenBucketFiller, an exception was caught: "{}"').format(str(ex)))
