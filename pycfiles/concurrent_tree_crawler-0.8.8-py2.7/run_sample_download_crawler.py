...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/concurrent_tree_crawler/bin/run_sample_download_crawler.py
# Compiled at: 2011-09-28 13:52:18
import sys, os, os.path, datetime, urllib
...
def get_website_address():
    ...
    url = urllib.pathname2url(('{}/test/data/original_site/issues_1.html').format(package_path))
    return 'file:' + url
