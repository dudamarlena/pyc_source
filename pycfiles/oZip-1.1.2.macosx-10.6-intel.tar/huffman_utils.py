...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/oZip/core/Compression/huffman_utils.py
# Compiled at: 2014-08-28 13:16:46
...
def get_decoding_dict(data):
    ...
    try:
        return (
         json.loads(decode_str), data_start)
