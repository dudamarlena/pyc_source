...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/finbull/lib/redis.py
# Compiled at: 2019-08-01 07:38:56
# Size of source mod 2**32: 9021 bytes
import random, time, tornadis, tornado.gen, tornado.ioloop, finbull.error, finbull.log
...
class RedisDB(object):
    ...
    def restart_pool(self):
        ...
        self.pool = (tornadis.ClientPool)(max_size=self.MAX_CLIENT_CLIENT, 
         host=ip, 
         port=int(port), **self.client_kwargs)
    ...
    def get(self, key):
        ...
        finbull.log.service_debug({'redis_log':'redis requested', 
         'method':'GET', 
         'key':key, 
         'result':result, 
         'time':_stop})
        finbull.log.service_notice({'redis_log':'redis requested', 
         'method':'GET', 
         'key':key, 
         'time':_stop})
