...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/vagrantplaybook/compose/nodegroup.py
# Compiled at: 2016-10-31 11:23:48
    ...
    def compose(self, templar, cluster_name, cluster_node_prefix, cluster_domain, cluster_offset):
        ...
        * some "autogenerated" node properties will be computed:
        ...
        while node_index < self.instances:
            available_variables = dict(cluster_name=cluster_name, cluster_node_prefix=cluster_node_prefix, cluster_domain=cluster_domain, group_index=self.index, group_name=self.name, node_index=node_index)
