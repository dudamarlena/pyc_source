...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/fapws/contrib/cgiapp.py
...
class CGIApplication:
    ...
    def __call__(self, environ, start_response):
        ...
        proc = subprocess.Popen([
         self.script], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, env=self.cgi_environ, cwd=self.dirname)
