...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/ssb/shs/boxstream.py
# Compiled at: 2019-02-24 17:30:28
...
TERMINATION_HEADER = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
...
def get_stream_pair(reader, writer, **kwargs):
    ...
    box_args = {'key':kwargs['encrypt_key'], 
     'nonce':kwargs['encrypt_nonce']}
    unbox_args = {'key':kwargs['decrypt_key'], 
     'nonce':kwargs['decrypt_nonce']}
    return (
     UnboxStream(reader, **unbox_args), BoxStream(writer, **box_args))
...
class BoxStream(object):
    ...
    def close(self):
        self.writer.write(self.box.encrypt(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', self.nonce)[24:])