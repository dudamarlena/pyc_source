...
# Embedded file name: build/bdist.linux-x86_64/egg/aiogcd/orm/properties/jsonvalue.py
# Compiled at: 2019-09-11 07:21:09
# Size of source mod 2**32: 1933 bytes
__doc__ = 'jsonvalue.py\n\nCreated on: May 19, 2017\n    Author: Jeroen van der Heijden <jeroen@transceptor.technology>\n'
import json
...
class JsonValue(Value):
    ...
    def set_value(self, model, value):
        ...
        try:
            ...
            try:
                raise TypeError('Value for property {!r} could not be parsed: {}'.format(self.name, e))
            finally:
                e = None
                del e
    ...
    def get_value(self, model):
        ...
        if key not in model.__dict__:
            try:
                ...
                try:
                    raise Exception('Error reading property {!r} (see above exception for more info).'.format(self.name)) from e
                finally:
                    e = None
                    del e
