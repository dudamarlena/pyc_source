...
DESCRIPTOR = _descriptor.FileDescriptor(name='tensorboardX/proto/plugin_pr_curve.proto',
...
_PRCURVEPLUGINDATA = _descriptor.Descriptor(name='PrCurvePluginData',
 ...
 _descriptor.FieldDescriptor(name='version',
   full_name='tensorboardX.PrCurvePluginData.version',
   index=0,
   number=1,
   type=5,
   cpp_type=1,
 ...
 _descriptor.FieldDescriptor(name='num_thresholds',
   full_name='tensorboardX.PrCurvePluginData.num_thresholds',
   index=1,
   number=2,
   type=13,
   cpp_type=3,
