...
DESCRIPTOR = _descriptor.FileDescriptor(name='tensorboardX/proto/versions.proto',
...
_VERSIONDEF = _descriptor.Descriptor(name='VersionDef',
 ...
 _descriptor.FieldDescriptor(name='producer',
   full_name='tensorboardX.VersionDef.producer',
   index=0,
   number=1,
   type=5,
   cpp_type=1,
 ...
 _descriptor.FieldDescriptor(name='min_consumer',
   full_name='tensorboardX.VersionDef.min_consumer',
   index=1,
   number=2,
   type=5,
   cpp_type=1,
 ...
 _descriptor.FieldDescriptor(name='bad_consumers',
   full_name='tensorboardX.VersionDef.bad_consumers',
   index=2,
   number=3,
   type=5,
   cpp_type=1,
