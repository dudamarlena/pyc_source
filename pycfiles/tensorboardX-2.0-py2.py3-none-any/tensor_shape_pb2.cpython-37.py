...
DESCRIPTOR = _descriptor.FileDescriptor(name='tensorboardX/proto/tensor_shape.proto',
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(name='Dim',
 ...
 _descriptor.FieldDescriptor(name='size',
   full_name='tensorboardX.TensorShapeProto.Dim.size',
   index=0,
   number=1,
   type=3,
   cpp_type=2,
 ...
 _descriptor.FieldDescriptor(name='name',
   full_name='tensorboardX.TensorShapeProto.Dim.name',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(name='TensorShapeProto',
 ...
 _descriptor.FieldDescriptor(name='unknown_rank',
   full_name='tensorboardX.TensorShapeProto.unknown_rank',
   index=1,
   number=3,
   type=8,
   cpp_type=7,
