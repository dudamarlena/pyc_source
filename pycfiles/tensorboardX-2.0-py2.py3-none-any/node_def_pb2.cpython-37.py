...
import tensorboardX.proto as tensorboardX_dot_proto_dot_attr__value__pb2
DESCRIPTOR = _descriptor.FileDescriptor(name='tensorboardX/proto/node_def.proto',
  package='tensorboardX',
  syntax='proto3',
  serialized_options=(_b('\n\x18org.tensorflow.frameworkB\tNodeProtoP\x01ø\x01\x01')),
  serialized_pb=(_b('\n!tensorboardX/proto/node_def.proto\x12\x0ctensorboardX\x1a#tensorboardX/proto/attr_value.proto"·\x01\n\x07NodeDef\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02op\x18\x02 \x01(\t\x12\r\n\x05input\x18\x03 \x03(\t\x12\x0e\n\x06device\x18\x04 \x01(\t\x12-\n\x04attr\x18\x05 \x03(\x0b2\x1f.tensorboardX.NodeDef.AttrEntry\x1aD\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12&\n\x05value\x18\x02 \x01(\x0b2\x17.tensorboardX.AttrValue:\x028\x01B*\n\x18org.tensorflow.frameworkB\tNodeProtoP\x01ø\x01\x01b\x06proto3')),
  dependencies=[
...
_NODEDEF_ATTRENTRY = _descriptor.Descriptor(name='AttrEntry',
 ...
 _descriptor.FieldDescriptor(name='key',
   full_name='tensorboardX.NodeDef.AttrEntry.key',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='value',
   full_name='tensorboardX.NodeDef.AttrEntry.value',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
...
_NODEDEF = _descriptor.Descriptor(name='NodeDef',
 ...
 _descriptor.FieldDescriptor(name='name',
   full_name='tensorboardX.NodeDef.name',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='op',
   full_name='tensorboardX.NodeDef.op',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='input',
   full_name='tensorboardX.NodeDef.input',
   index=2,
   number=3,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='device',
   full_name='tensorboardX.NodeDef.device',
   index=3,
   number=4,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='attr',
   full_name='tensorboardX.NodeDef.attr',
   index=4,
   number=5,
   type=11,
   cpp_type=10,
