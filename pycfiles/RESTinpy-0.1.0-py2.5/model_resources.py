...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/RESTinpy/model_resources.py
...
class ModelBaseResource(Resource):
    ...
    def get_output_fields(self):
        ...
        return [ f for f in candidate_fields if f.serialize if not self.output_fields or f.name in self.output_fields ]
        ...
        for obj in queryset:
            ...
            for field in obj._meta.local_fields:
                if isinstance(field, ForeignKey):
                    ...
                    simple_fields[field.name]['objects'] = [
                     dict([('resource', getattr(obj, field.name))])]
                elif field.name != 'id':
            ...
            for field in obj._meta.many_to_many:
                ...
                m2m_field_dict['collection'] = related.model
            ...
            for field in obj._meta.get_all_related_objects():
                ...
                related_fields[name]['collection'] = related.model
...
class ModelResource(ModelBaseResource):
    ...
    def get_param_re(self):
        return '[\\w-]+' if self.slug_field else '\\d+'
