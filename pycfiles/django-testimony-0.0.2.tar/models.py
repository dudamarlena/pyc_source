...
# [GCC 8.4.0]
# Embedded file name: /home/growlf/django/apps/django-testimony/testimony/models.py
# Compiled at: 2014-01-10 19:07:57
...
LIST_TYPE_CHOICES = (('random', 'random'), )
...
class TestimonialPlugin(CMSPlugin):
    ...
    template_path = models.CharField(_('Template'), max_length=100, choices=settings.TESTIMONY_TEMPLATES, default=settings.TESTIMONY_TEMPLATES[0], help_text=_('Enter a template (i.e. "testimony/list_default.html") which will be rendered.'))
