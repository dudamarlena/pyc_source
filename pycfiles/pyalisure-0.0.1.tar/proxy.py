...
# Embedded file name: build\bdist.win32\egg\sip\proxy.py
# Compiled at: 2009-06-02 04:42:14
__doc__ = '\nCreated on 2009-5-3\n\n@author: mingqi\n'
from datetime import datetime
from decorator import iter_fetch
from sip.sipclient import TaobaoSIPClient
import simplejson as json, sip
from sip.sipclient import SIPError
import logging
logger = logging.getLogger('sip.proxy12')
...
class TaobaoProxy(object):
    ...
    def fetch_categories(self, cids=None, parent_cid=None, datetime=datetime.strptime('1970-01-01 00:00:00', '%Y-%m-%d %H:%M:%S')):
        """
    ...
    def fetch_enums(self, cid):
        ...
        Return a dict of enum valu:
            ...
            sort_order
        """
        _args = {'cid': cid, 'fields': 'cid,pid,prop_name,vid,name,is_parent,status,sort_order', 
    ...
    def fetch_items_by_category(self, cid, order_by=None, page_no=1, page_size=40, with_props=False):
        ...
        return a iterator of items collect:
            ...
            pic_path
        """
        _args = {'cid': cid, 'page_no': str(page_no), 
