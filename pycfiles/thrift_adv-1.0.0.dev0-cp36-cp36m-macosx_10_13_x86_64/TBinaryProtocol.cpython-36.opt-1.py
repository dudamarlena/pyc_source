...
# [GCC 8.4.0]
# Embedded file name: /thrift/protocol/TBinaryProtocol.py
...
class TBinaryProtocol(TProtocolBase):
    __doc__ = 'Binary implementation of the Thrift protocol driver.'
    VERSION_MASK = -65536
