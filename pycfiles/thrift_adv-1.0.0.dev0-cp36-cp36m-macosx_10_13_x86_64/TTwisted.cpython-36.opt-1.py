...
# [GCC 8.4.0]
# Embedded file name: /thrift/transport/TTwisted.py
# Compiled at: 2018-09-11 21:54:05
# Size of source mod 2**32: 10904 bytes
...
class TMessageSenderTransport(TTransport.TTransportBase):
    ...
    def __init__(self):
        self._TMessageSenderTransport__wbuf = BytesIO()

    def write(self, buf):
        self._TMessageSenderTransport__wbuf.write(buf)

    def flush(self):
        msg = self._TMessageSenderTransport__wbuf.getvalue()
        self._TMessageSenderTransport__wbuf = BytesIO()
...
class ThriftClientProtocol(basic.Int32StringReceiver):
    ...
    def connectionLost(self, reason=connectionDone):
        if self.client:
            tex = TTransport.TTransportException(type=(TTransport.TTransportException.END_OF_FILE),
...
class ThriftSASLClientProtocol(ThriftClientProtocol):
    ...
    def __init__(self, client_class, iprot_factory, oprot_factory=None, host=None, service=None, mechanism='GSSAPI', **sasl_kwargs):
        """
...
class ThriftServerProtocol(basic.Int32StringReceiver):
    ...
    def stringReceived(self, frame):
        ...
        d.addCallbacks((self.processOk), (self.processError), callbackArgs=(
         tmo,))
...
class ThriftResource(resource.Resource):
    ...
    def __init__(self, processor, inputProtocolFactory, outputProtocolFactory=None):
