...
# [GCC 8.4.0]
# Embedded file name: /thrift/protocol/TProtocol.py
# Compiled at: 2018-09-11 21:54:05
# Size of source mod 2**32: 13387 bytes
...
class TProtocolException(TException):
    __doc__ = 'Custom Protocol Exception class'
    UNKNOWN = 0
    INVALID_DATA = 1
    NEGATIVE_SIZE = 2
    SIZE_LIMIT = 3
...
class TProtocolBase(object):
    __doc__ = 'Base class for Thrift protocol driver.'
    ...
    _TTYPE_HANDLERS = ((None, None, False), (None, None, False), ('readBool', 'writeBool', False),
                       ('readByte', 'writeByte', False), ('readDouble', 'writeDouble', False),
                       (None, None, False), ('readI16', 'writeI16', False), (None, None, False),
                       ('readI32', 'writeI32', False), (None, None, False), ('readI64', 'writeI64', False),
                       ('readString', 'writeString', False), ('readContainerStruct', 'writeContainerStruct', True),
                       ('readContainerMap', 'writeContainerMap', True), ('readContainerSet', 'writeContainerSet', True),
                       ('readContainerList', 'writeContainerList', True), (None, None, False),
                       (None, None, False))
    ...
    def writeContainerMap(self, val, spec):
        ...
        for _ in zip(self._write_by_ttype(ktype, six.iterkeys(val), spec, kspec), self._write_by_ttype(vtype, six.itervalues(val), spec, vspec)):
            pass
...
def checkIntegerLimits(i, bits):
    ...
    if bits == 16 and (i < -32768 or i > 32767):
