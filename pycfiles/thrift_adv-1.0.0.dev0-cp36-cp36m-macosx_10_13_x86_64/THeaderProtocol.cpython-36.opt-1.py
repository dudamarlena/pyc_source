...
# [GCC 8.4.0]
# Embedded file name: /thrift/protocol/THeaderProtocol.py
# Compiled at: 2018-09-11 21:54:05
# Size of source mod 2**32: 7373 bytes
...
class THeaderProtocol(TProtocolBase):
    ...
    def _set_protocol(self):
        try:
            ...
            raise TApplicationException(TProtocolException.INVALID_PROTOCOL, 'Unknown protocol requested.')
...
class THeaderProtocolFactory(object):
    ...
    def __init__(self, allowed_client_types=(
