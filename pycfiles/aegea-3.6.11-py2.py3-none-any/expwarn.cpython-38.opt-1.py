...
class AEDIRPwdJob(aedir.process.AEProcess):
 ...
 L. 212       440  LOAD_FAST                'smtp_message_tmpl'
              ...
              448  CALL_FUNCTION_EX_KW     1  'keyword args'
 ...
 L. 213       452  LOAD_GLOBAL              PWD_EXPIRYWARN_MAIL_SUBJECT
              ...
              460  CALL_FUNCTION_EX_KW     1  'keyword args'
...
Parse error at or near `BEGIN_FINALLY' instruction at offset 392


def main--- This code section failed: ---

 L. 245         0  LOAD_GLOBAL              AEDIRPwdJob
                2  CALL_FUNCTION_0       0  ''
                4  SETUP_WITH           24  'to 24'
                6  STORE_FAST               'ae_process'

 L. 246         8  LOAD_FAST                'ae_process'
               10  LOAD_ATTR                run
               12  LOAD_CONST               1
