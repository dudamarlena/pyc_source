...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\ShockCalendar\test2.py
# Compiled at: 2016-12-28 23:37:14
from Tkinter import *
from tkMessageBox import showinfo
import ShockCalendar
ShockCalendar.colors = {'background': 'white', 
   'foreground': 'black', 
   'daybg': '#FFE0E0', 
   'dayfg': 'red', 
   'linescolor': '#AAAAAA', 
...
class TestApp:
    ...
    def __init__(self):
        ...
        self.calendar.SetCallback(self.printClic)

    def printClic(self):
        print 'callback clic: ' + str(self.calendar.GetSelectDay())
        if self.calendar.GetEventsSelected():
            print 'Clic: %d eventos' % len(self.calendar.GetEventsSelected())
