...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\ShockCalendar\ShockCalendar.py
# Compiled at: 2016-12-28 23:34:54
"""
...
class Calendar(Canvas):
        ...
        if event:
            ...
            if _id in idsRects:
                ...
                if index <= current.firstDayWeek:
                    ...
                    return 0
                if index > current.firstDayWeek + current.maxMonthDays:
    ...
    def GetSelectDay(self):
        ...
        month, year = self.pos.current.month, self.pos.current.year
        return (
         day, month, year)
