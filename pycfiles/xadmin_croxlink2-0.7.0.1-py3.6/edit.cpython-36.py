...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/xadmin/views/edit.py
# Compiled at: 2020-04-04 04:11:53
# Size of source mod 2**32: 20829 bytes
...
class ModelFormAdminView(ModelAdminView):
    ...
    def get_model_form(self, **kwargs):
        ...
        if defaults['fields'] is None:
            if not modelform_defines_fields(defaults['form']):
