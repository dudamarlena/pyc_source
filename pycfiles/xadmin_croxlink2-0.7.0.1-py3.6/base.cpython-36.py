...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/xadmin/views/base.py
# Compiled at: 2020-04-17 04:20:02
# Size of source mod 2**32: 21376 bytes
...
class BaseAdminObject(object):
    ...
    def get_form_params(self, new_params=None, remove=None):
        ...
        return mark_safe(''.join('<input type="hidden" name="%s" value="%s"/>' % (k, escape(v)) for k, v in p.items() if v))
