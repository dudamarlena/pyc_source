...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/xadmin/models.py
# Compiled at: 2020-02-22 02:46:57
# Size of source mod 2**32: 6674 bytes
import json, django
        ...
        if created:
            try:
                portal_pos = UserSettings.objects.get(user=(self.user),
                  key=('dashboard:%s:pos' % self.page_id))
