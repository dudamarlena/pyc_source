...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/xadmin/views/detail.py
# Compiled at: 2020-02-27 23:15:29
# Size of source mod 2**32: 11216 bytes
...
class ResultField(object):
    ...
    def init(self):
        self.label = label_for_field((self.field_name), (self.obj.__class__), model_admin=(self.admin_view),
          return_attr=False)
        try:
            ...
            if f is None:
                ...
                if boolean:
                    ...
                    if decimal and value is not None:
...
class DetailAdminView(ModelAdminView):
    ...
    def get_form_layout(self):
        ...
        if layout is None:
            layout = Layout(Container(Col('full', Fieldset('', *(self.form_obj.fields.keys()), **{'css_class': 'unsort no_title'}),
                ...
                if isinstance(layout[0], Column):
                    ...
                    if self.detail_show_all:
                        ...
                        if len(other_fieldset.fields):
                            if len(container):
                                if isinstance(container[0], Column):
