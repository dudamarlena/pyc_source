...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/ore/svn/directory.py
...
class SubversionDirectory(SubversionObject):
    ...
    def __contains__(self, name):
        ...
        return fs.check_path(ctx.root, svn_path_join(self.svn_path, name), ctx.pool) and True or False
    ...
    def mapNodes(self, func):
        ...
        resource_ctx = svn_context.getResourceContext()
        revision = svn_context.getRevision()
        entries = fs.dir_entries(resource_ctx.root, self.svn_path, resource_ctx.pool)
