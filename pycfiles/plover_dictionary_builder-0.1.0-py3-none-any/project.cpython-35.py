...
# Embedded file name: build/bdist.linux-x86_64/egg/plover_cat/project.py
# Compiled at: 2017-10-18 07:21:48
...
class Project(object):
    ...
    def save_file(self, file_name):
        with open(file_name, 'w') as (f):
            json.dump({'info': Project.FILE_INFO, 
             'version': 1, 
             'edits': self.edits, 
             'log': [stroke.rtfcre for stroke in self.log]}, f, indent=2)
