...
# Embedded file name: build/bdist.linux-x86_64/egg/plover_cat/steno_to_stroke.py
# Compiled at: 2017-10-18 06:39:17
...
def steno_to_stroke(steno):
    if steno_to_stroke.system != system.NAME:
        ...
        steno_to_stroke.numbers = {v.strip('-'):k.strip('-') for k, v in system.NUMBERS.items()}
    n = -1
    keys = set()
    for l in steno:
