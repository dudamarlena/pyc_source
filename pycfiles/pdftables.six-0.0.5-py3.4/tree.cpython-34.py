...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pdftables/tree.py
# Compiled at: 2016-07-22 05:07:51
...
class Leaf(object):
    ...
    def __getitem__(self, i):
        ...
        error = "DEPRECATED: don't use leaf[x] - use these instead: [0]: bbox, [1]: classname, [2]: text"
        raise RuntimeError(error)
        return [
         self.bbox, self.classname, self.text][i]
...
class LeafList(list):
    ...
    def populate(self, pdfpage, interested=[
