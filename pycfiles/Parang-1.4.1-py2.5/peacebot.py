...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/parang/peacebot.py
...
class PeaceBot(DumbBot):
    ...
    def friendly(self, nation):
        return nation.key in self.friends
    ...
    def handle_press_PRP(self, sender, message):
        ...
        if message[1][0] is PCE:
            ...
            self.log_debug(1, 'Setting attitude toward %s to %d.', sender, self.attitude[sender])
    ...
    def handle_press_HUH(self, sender, message):
        ...
        while ERR in flattened:
            flattened.pop(flattened.index(ERR))
