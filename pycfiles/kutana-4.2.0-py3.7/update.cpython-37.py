...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kutana/update.py
...
Message = namedtuple('Message', ('raw', 'type', 'text', 'attachments', 'sender_id',
                                 'receiver_id', 'receiver_type', 'date'))
ATTACHMENT_TYPES = ('image', 'doc', 'sticker', 'video', 'audio', 'voice')
AttachmentData = namedtuple('AttachmentData', ('id', 'type', 'title', 'file', 'file_name',
                                               'file_getter', 'raw'))
...
class Attachment(AttachmentData):
    ...
    @classmethod
    def new(cls, file, file_name='image.png', type='image', title=''):
        """
        ...
        """
        return Attachment(None, type, title, file, file_name, None, None)
    ...
    def existing(cls, id, type):
        ...
        :rtype: kutana.update.Attachment
        """
        return Attachment(id, type, None, None, None, None, 'missing')

    @classmethod
    def _existing_full(cls, id, type, title, file_name, getter, raw):
        """
        ...
        :rtype: kutana.update.Attachment
        """
        return Attachment(id, type, title, None, file_name, getter, raw)
