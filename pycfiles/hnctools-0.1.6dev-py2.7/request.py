...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\hnctools\request.py
# Compiled at: 2013-05-23 13:42:06
...
def extend_request(config):
    ...
    def dbm(request):
        return request.globals.dbm

    config.add_request_method(dbm, 'dbm', reify=True)
