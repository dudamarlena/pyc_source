...
# [GCC 8.4.0]
# Embedded file name: /Users/Robin/Do/GitHub/EditOnline/EditOnline/wsgi.py
# Compiled at: 2016-05-02 23:40:26
"""
WSGI warp
"""
import os, wsgiref.util, EditOnline
try:
...
class WSGIHandler(EditOnline.EditOnlineRequestHandler):
    ...
    response_headermap = {'Content-Type': 'text/html'}
