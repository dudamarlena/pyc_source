...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dyntftpd/server.py
# Compiled at: 2015-04-15 07:01:56
import SocketServer
...
class TFTPServer(SocketServer.UDPServer):
    ...
    def __init__(self, host='', port=69, root='/var/lib/tftpboot', handler=CleverHandler, handler_args=None):
        self.sessions = {}
        self.root = root
