...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tests/test_handler_clever.py
# Compiled at: 2015-04-14 11:08:28
...
class TestCleverHandler(TFTPServerTestCase):
    ...
    def setUp(self):
        ...
        return super(TestCleverHandler, self).setUp(handler=CleverHandler, handler_args={'http': {'cache_dir': self.cache_dir}})
