...
# [GCC 8.4.0]
# Embedded file name: /usr/local/anaconda3/lib/python3.6/site-packages/vnlp/exp/tracker.py
# Compiled at: 2018-06-22 03:10:57
# Size of source mod 2**32: 3189 bytes
import os, logging, json, re, torch
...
class Tracker:
    ...
    def find_checkpoints(cls, root, early_stop):
        ...
        score_re = re.compile('{}=([0-9.\\-]+)'.format(early_stop))
        files = []
