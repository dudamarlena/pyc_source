...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_core/field/integer.py
...
class GenericInteger(Bits):
    ...
    def createValue(self):
        return self._parent.stream.readInteger(self.absolute_address, self.signed, self._size, self._parent.endian)
