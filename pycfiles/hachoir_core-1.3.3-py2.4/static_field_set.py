...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_core/field/static_field_set.py
# Compiled at: 2009-10-30 17:23:06
...
class StaticFieldSet(FieldSet):
    ...
    def _computeItemSize(item):
        ...
        if item_class.static_size is None:
            raise ParserError('Unable to get static size of field type: %s' % item_class.__name__)
