...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_core/bits.py
...
def _createStructFormat():
    ...
    """
    format = {BIG_ENDIAN: {}, LITTLE_ENDIAN: {}}
