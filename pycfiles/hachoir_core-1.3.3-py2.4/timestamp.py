...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_core/field/timestamp.py
# Compiled at: 2009-09-07 17:44:28
from hachoir_core.tools import humanDatetime, humanDuration, timestampUNIX, timestampMac32, timestampUUID60, timestampWin64, durationWin64
...
class TimeDateMSDOS32(FieldSet):
    ...
    def createValue(self):
        return datetime(1980 + self['year'].value, self['month'].value, self['day'].value, self['hour'].value, self['minute'].value, 2 * self['second'].value)
