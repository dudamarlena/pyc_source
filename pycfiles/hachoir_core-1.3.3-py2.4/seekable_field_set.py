...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_core/field/seekable_field_set.py
# Compiled at: 2010-01-20 17:54:17
...
class RootSeekableFieldSet(BasicFieldSet):
    ...
    def _addField(self, field):
        ...
        if field._address != self._offset:
            self.warning('Set field %s address to %s (was %s)' % (field.path, self._offset // 8, field._address // 8))
