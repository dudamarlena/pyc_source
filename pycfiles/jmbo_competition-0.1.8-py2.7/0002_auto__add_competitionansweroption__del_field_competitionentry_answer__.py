...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-competition/competition/migrations/0002_auto__add_competitionansweroption__del_field_competitionentry_answer__.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('competition_competitionansweroption', (
         ...
         (
          'is_correct_answer', self.gf('django.db.models.fields.BooleanField')(default=False))))
        db.send_create_signal('competition', ['CompetitionAnswerOption'])
        db.delete_column('competition_competitionentry', 'answer')
        db.add_column('competition_competitionentry', 'answer_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
        db.add_column('competition_competitionentry', 'answer_option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.CompetitionAnswerOption'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_table('competition_competitionansweroption')
        db.add_column('competition_competitionentry', 'answer', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
        db.delete_column('competition_competitionentry', 'answer_text')
        db.delete_column('competition_competitionentry', 'answer_option_id')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'category.tag': {'Meta': {'ordering': "('title',)", 'object_name': 'Tag'}, 'categories': (
                        ...
                        'title': (
                                'django.db.models.fields.CharField', [], {'max_length': '200'})}, 
       'competition.competition': {'Meta': {'ordering': "('-created',)", 'object_name': 'Competition', '_ormbases': ['jmbo.ModelBase']}, 'content': (
       ...
       'competition.competitionentry': {'Meta': {'object_name': 'CompetitionEntry'}, 'answer_option': (
