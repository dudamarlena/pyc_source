...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/competition/generator.py
...
def generate():
    ...
    for i in range(1, COMPETITION_COUNT + 1):
        ...
        objects.append({'model': 'competition.Competition', 
           'fields': {'title': 'Competition %s Title' % i, 
