...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-competition/competition/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'competition.competition': {'Meta': {'ordering': "('-created',)", 'object_name': 'Competition', '_ormbases': ['jmbo.ModelBase']}, 'content': (
                                   ...
                                   'start_date': (
                                                'django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})}, 
       'competition.competitionentry': {'Meta': {'object_name': 'CompetitionEntry'}, 'answer': (
