...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-competition/competition/migrations/0003_auto__add_field_competition_check_in_distance__add_field_competition_a.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('competition_competition', 'check_in_distance', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True), keep_default=False)
        db.add_column('competition_competition', 'answer_type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)
        db.add_column('competition_competition', 'max_file_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
        db.add_column('competition_competition', 'max_entries_per_user', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
        ...
        db.add_column('competition_competitionentry', 'answer_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
       ...
       'category.tag': {'Meta': {'ordering': "('title',)", 'object_name': 'Tag'}, 'categories': (
                        ...
                        'title': (
                                'django.db.models.fields.CharField', [], {'max_length': '200'})}, 
       'competition.competition': {'Meta': {'ordering': "['end_date', 'start_date']", 'object_name': 'Competition', '_ormbases': ['jmbo.ModelBase']}, 'answer_type': (
                                                 'django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}), 
                                   'check_in_distance': (
                                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}), 
                                   'content': (
                                   ...
                                   'start_date': (
                                                'django.db.models.fields.DateField', [], {})}, 
       'competition.competitionansweroption': {'Meta': {'object_name': 'CompetitionAnswerOption'}, 'competition': (
                                                             'django.db.models.fields.related.ForeignKey', [], {'to': "orm['competition.Competition']"}), 
                                               'id': (
                                                    'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                               'is_correct_answer': (
                                                                   'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
       ...
       'competition.competitionentry': {'Meta': {'object_name': 'CompetitionEntry'}, 'answer_file': (
                                                      'django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}), 
                                        'answer_option': (
                                                        'django.db.models.fields.related.ForeignKey', [], {'to': "orm['competition.CompetitionAnswerOption']", 'null': 'True', 'blank': 'True'}), 
                                        'answer_text': (
                                                      'django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}), 
                                        'competition': (
                                                      'django.db.models.fields.related.ForeignKey', [], {'related_name': "'competition_entries'", 'to': "orm['competition.Competition']"}), 
                                        'id': (
                                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                        'timestamp': (
                                                    'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}), 
                                        'user': (
                                               'django.db.models.fields.related.ForeignKey', [], {'related_name': "'competition_entries_users'", 'to': "orm['auth.User']"}), 
                                        'winner': (
                                                 'django.db.models.fields.BooleanField', [], {'default': 'False'})}, 
