...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\sldap3\core\mock_dsa.py
...
from ldap3.core.exceptions import LDAPExceptionError, LDAPUnknownRequestError
from ldap3 import RESULT_OPERATIONS_ERROR, RESULT_SUCCESS, RESULT_AUTH_METHOD_NOT_SUPPORTED, RESULT_INVALID_CREDENTIALS, SIMPLE, ANONYMOUS, RESTARTABLE, RESULT_PROTOCOL_ERROR
from ldap3.operation.bind import bind_response_operation
from ldap3.strategy.base import BaseStrategy
from ldap3.utils.ciDict import CaseInsensitiveDict
from ldap3.protocol.rfc4511 import LDAPMessage, MessageID
