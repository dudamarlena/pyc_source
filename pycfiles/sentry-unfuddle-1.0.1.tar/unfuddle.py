...
# [GCC 8.4.0]
# Embedded file name: /var/sentry-unfuddle/sentry_unfuddle/unfuddle.py
# Compiled at: 2015-12-06 15:07:01
...
class UnfuddleClient(object):
    ...
    def get_priorities(self):
        ...
        response.json = [{'id': 1, 'name': 'Lowest'}, {'id': 2, 'name': 'Low'}, {'id': 3, 'name': 'Normal'}, {'id': 4, 'name': 'High'}, {'id': 5, 'name': 'Highest'}]
        return response
    ...
    def make_request(self, method, url, payload=None):
        ...
        try:
            ...
            if method == 'get':
                ...
                r = session.post(url, data=xml_payload, auth=auth, verify=False, timeout=self.HTTP_TIMEOUT)
