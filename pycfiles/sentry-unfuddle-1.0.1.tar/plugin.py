...
# [GCC 8.4.0]
# Embedded file name: /var/sentry-unfuddle/sentry_unfuddle/plugin.py
# Compiled at: 2015-12-06 15:06:39
    ...
    def create_issue(self, request, group, form_data, **kwargs):
        ...
        if issue_response.status_code == 200:
            ...
            if issue_response.status_code == 500:
                ...
                raise forms.ValidationError(_(('Something went wrong, Sounds like a configuration issue: code {0}').format(issue_response.status_code)))
            return
