...
# Embedded file name: build/bdist.linux-x86_64/egg/pynosql/clients/aws_mock.py
# Compiled at: 2019-03-17 12:07:46
...
class AWSMockResponses(object):
    ...
    def get_item_response(client):
        ...
        :return: None
        """
        response = {'Item': {'test1': {'S': 'value1'}, 'test2': {'S': 'value2'}, 'test3': {'S': 'value3'}, 'test4': {'S': 'value4'}}, 'ConsumedCapacity': {'TableName': 'TestTable', 
                                'CapacityUnits': 123.0, 
    ...
    def get_empty_item_response(client):
        ...
        :return: None
        """
        response = {'ConsumedCapacity': {'TableName': 'TestTable', 
                                'CapacityUnits': 123.0, 
                                'Table': {'CapacityUnits': 123.0}, 
                                'LocalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}, 
                                'GlobalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}}}
    ...
    def query_response(client):
        ...
        :return: None
        """
        response = {'Items': [{'test1': {'S': 'value1'}, 'test2': {'S': 'value2'}, 'test3': {'S': 'value3'}, 'test4': {'S': 'value4'}}, {'test1': {'S': 'value5'}, 'test2': {'S': 'value6'}, 'test3': {'S': 'value7'}, 'test4': {'S': 'value8'}}, {'test1': {'S': 'value9'}, 'test2': {'S': 'value10'}, 'test3': {'S': 'value11'}, 'test4': {'S': 'value12'}}, {'test1': {'S': 'value13'}, 'test2': {'S': 'value14'}, 'test3': {'S': 'value15'}, 'test4': {'S': 'value16'}}], 'ConsumedCapacity': {'TableName': 'TestTable', 
                                'CapacityUnits': 123.0, 
                                'Table': {'CapacityUnits': 123.0}, 
                                'LocalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}, 
                                'GlobalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}}}
    ...
    def empty_query_response(client):
        ...
        :return: None
        """
        response = {'Items': [], 'ConsumedCapacity': {'TableName': 'TestTable', 
                                'CapacityUnits': 123.0, 
                                'Table': {'CapacityUnits': 123.0}, 
                                'LocalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}, 
                                'GlobalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}}}
    ...
    def put_item_response(client):
        ...
        :return: None
        """
        response = {'Attributes': {'test1': {'S': 'value1'}, 'test2': {'S': 'value2'}, 'test3': {'S': 'value3'}, 'test4': {'S': 'value4'}}, 'ConsumedCapacity': {'TableName': 'string', 
                                'CapacityUnits': 123.0, 
                                'Table': {'CapacityUnits': 123.0}, 
                                'LocalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}, 
                                'GlobalSecondaryIndexes': {'string': {'CapacityUnits': 123.0}}}}
