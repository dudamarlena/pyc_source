...
# Embedded file name: build/bdist.linux-x86_64/egg/pynosql/test/credentials_test.py
# Compiled at: 2019-02-23 12:03:40
import unittest
...
class TestSetup(unittest.TestCase):
    ...
    def test_valid_aws_credentials(self):
        ...
        try:
            AWSCredentials('AKIAIOSFODNN7EXAMPLE', 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY')
    ...
    def test_invalid_aws_credentials(self):
        ...
        try:
            AWSCredentials(None, 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY')
    ...
    def test_valid_mongo_ssl_credentials(self):
        ...
        try:
            ssl_creds = MongoDBSSLCredentials('/my/cert.pem', MongoDBSSLCredentials.SSL.CERT_REQUIRED, 'my/ca.pem')
    ...
    def test_invalid_mongo_ssl_credentials(self):
        ...
        try:
            MongoDBSSLCredentials(None, MongoDBSSLCredentials.SSL.CERT_REQUIRED, 'my/ca.pem')
            self.fail('Expected MongoDBSSLCredentials exception did not occur.')
        except InvalidCredentials:
            return
