...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo_calendar/migrations/0004_auto__add_field_event_external_link.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('jmbo_calendar_event', 'external_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
