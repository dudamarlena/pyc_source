...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo_calendar/migrations/0003_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('jmbo_calendar_event', ['end'])
        db.create_index('jmbo_calendar_event', ['start'])

    def backwards(self, orm):
        db.delete_index('jmbo_calendar_event', ['start'])
        db.delete_index('jmbo_calendar_event', ['end'])
