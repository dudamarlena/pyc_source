...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo_calendar/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('jmbo_calendar', ['Calendar'])
        db.create_table('jmbo_calendar_event', (
         (
        ...
        db.create_table('jmbo_calendar_event_calendars', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'event', models.ForeignKey(orm['jmbo_calendar.event'], null=False)),
         (
          'calendar', models.ForeignKey(orm['jmbo_calendar.calendar'], null=False))))
        db.create_unique('jmbo_calendar_event_calendars', ['event_id', 'calendar_id'])
        if USE_GIS:
            db.add_column('jmbo_calendar_event', 'venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atlas.Location']), keep_default=False)

    def backwards(self, orm):
        db.delete_table('jmbo_calendar_calendar')
        db.delete_table('jmbo_calendar_event')
        db.delete_table('jmbo_calendar_event_calendars')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'jmbo_calendar.event': {'Meta': {'ordering': "('start',)", 'object_name': 'Event', '_ormbases': ['jmbo.ModelBase']}, 'calendars': (
                                           'django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'event_calendar'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['jmbo_calendar.Calendar']"}), 
                               'content': (
    ...
    if USE_GIS:
        models.update({'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
           ...
           'atlas.region': {'Meta': {'ordering': "('name',)", 'unique_together': "(('country', 'code'),)", 'object_name': 'Region'}, 'border': (
                            ...
                            'name': (
                                   'django.db.models.fields.CharField', [], {'max_length': '128'})}})
        models['jmbo_calendar.event']['venue'] = (
         'django.db.models.fields.related.ForeignKey', [], {'to': "orm['atlas.Location']"})
