...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo_calendar/migrations/0002_auto__del_field_event_venue.py
...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Event.venue' and its values cannot be restored.")
