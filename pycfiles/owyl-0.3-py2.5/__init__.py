...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/owyl/__init__.py
...
$Date: 2009-01-07 09:15:25 -0600 (Wed, 07 Jan 2009) $
"""
__author__ = '$Author: david.eyk $'[9:-2]
__revision__ = '$Rev: 26 $'[6:-2]
__date__ = '$Date: 2009-01-07 09:15:25 -0600 (Wed, 07 Jan 2009) $'[7:-2]
from core import *
