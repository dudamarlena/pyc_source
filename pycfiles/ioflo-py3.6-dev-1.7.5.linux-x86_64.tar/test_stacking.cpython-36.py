...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python3.6/site-packages/ioflo/aio/proto/test/test_stacking.py
# Compiled at: 2017-12-17 08:35:26
# Size of source mod 2**32: 11940 bytes
"""
Unittests
"""
...
class BasicTestCase(unittest.TestCase):
    ...
    def testUdpStacks(self):
        ...
        stamper = Stamper()
        alpha = stacking.UdpStack(name='alpha', port=8000)
        ...
        remote = devicing.IpRemoteDevice(stack=beta, name='AlphaRemote',
          ha=('localhost', 8000))
        self.assertEqual(remote.uid, 2)
        ...
        while alpha.txMsgs or alpha.txPkts or alpha.rxPkts or alpha.rxMsgs or beta.txMsgs or beta.txPkts or beta.rxPkts or beta.rxMsgs:
            alpha.serviceAllTx()
            beta.serviceAllTx()
            time.sleep(0.1)
            alpha.serviceAllRx()
