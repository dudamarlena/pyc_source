...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python3.6/site-packages/ioflo/base/test/test_storing.py
# Compiled at: 2017-12-17 08:35:26
# Size of source mod 2**32: 10670 bytes
"""
Unittests
"""
...
class BasicTestCase(unittest.TestCase):
    ...
    def testData(self):
        ...
        self.assertEqual(repr(data), "Data([('x', 1), ('y', 2), ('a', 3), ('z', 4), ('b', 5)])")
    ...
    def testStore(self):
        ...
        for field in ('iso', 'dt', 'year', 'month', 'day', 'hour', 'minute', 'second',
                      'micro'):
