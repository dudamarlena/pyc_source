...
# [GCC 8.4.0]
# Embedded file name: C:\repositorios\web\djmicrosip_apps\django-microsip-liquida\django-microsip-liquida\core.py
# Compiled at: 2019-10-29 16:05:01
import os, dbf
    ...
    if not errors:
        for contador, detalle_row in enumerate(detalles_rows):
            if str(detalle_row.clave) not in empresas_a_ignorar:
                detalle = [
                 detalle_row.fecha, detalle_row.kilos1, quincena2_precio, detalle_row.importe1]
