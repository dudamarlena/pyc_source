...
class AlphaVantage(object):
    ...
    def _av_api_call(self, parameters: dict, timeout: int=60, **kwargs) -> DataFrame or :
    ...
    def _save_df(self, function: str, df: DataFrame) -> None:
        ...
        elif function in self._AlphaVantage__api_indicator:
    ...
    def _simplify_dataframe_columns(self, function: str, df: DataFrame) -> DataFrame or :
    ...
    def fxrate(self, from_currency: str, to_currency: str='USD', **kwargs) -> DataFrame or :
    ...
    def fx(self, function: str, from_symbol: str='EUR', to_symbol: str='USD', **kwargs) -> DataFrame or :
        """Simple wrapper to _av_api_call method for currency requests."""
    ...
    def global_quote(self, symbol: str, **kwargs) -> DataFrame or :
    ...
    def search(self, keywords: str, **kwargs) -> DataFrame or :
    ...
    def sectors(self, **kwargs) -> DataFrame or :
    ...
    def digital(self, symbol: str, market: str='USD', function: str='CD', **kwargs) -> DataFrame or :
    ...
    def crypto_rating(self, symbol: str, function: str='CR', **kwargs) -> DataFrame or :
    ...
    def intraday(self, symbol: str, interval=5, **kwargs) -> DataFrame or :
    ...
    def data(self, function: str, symbol: str=None, **kwargs) -> DataFrame or :
