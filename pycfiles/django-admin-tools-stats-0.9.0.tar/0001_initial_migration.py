...
# [GCC 8.4.0]
# Embedded file name: /home/areski/projects/django/django-admin-tools-stats/admin_tools_stats/migrations/0001_initial_migration.py
# Compiled at: 2014-05-28 17:32:46
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('dash_stats_criteria', (
         (
        ...
        db.create_table('dashboard_stats', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
        ...
        db.create_table(m2m_table_name, (
         ...
         (
          'dashboardstats', models.ForeignKey(orm['admin_tools_stats.dashboardstats'], null=False)),
         (
          'dashboardstatscriteria', models.ForeignKey(orm['admin_tools_stats.dashboardstatscriteria'], null=False))))
