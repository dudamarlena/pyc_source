...
# Embedded file name: /home/cw12401/code/work/ampal/src/ampal/naccess.py
# Compiled at: 2018-08-03 10:53:09
# Size of source mod 2**32: 5055 bytes
__doc__ = 'This module provides an interface to the program NACCESS.'
...
def naccess_available():
    ...
    try:
        ...
        print('naccess has not been found on your path. If you have already installed naccess but are unsure how to add it to your path, check out this: https://stackoverflow.com/a/14638025')

    return available


def run_naccess(pdb, mode, path=True, include_hetatms=False, outfile=None, path_to_ex=None):
...
def extract_residue_accessibility(in_rsa, path=True, get_total=False):
    ...
    if get_total:
        all_atoms, _, _, _, _ = total_accessibility(rsa,
          path=False)
        return (
         rel_solv_acc_all_atoms, all_atoms)
    else:
        return (
         rel_solv_acc_all_atoms, None)
