...
# Embedded file name: build/bdist.linux-x86_64/egg/Products/republisher/xmltramp.py
# Compiled at: 2010-09-08 09:20:09
__doc__ = 'xmltramp: Make XML documents easily accessible.'
__version__ = '2.16'
...
class Element:
    ...
    def __setitem__(self, n, v):
        if isinstance(n, type(0)):
            ...
            if isinstance(n, slice(0).__class__):
                n = n.start
                if self._dNS and not islst(n):
                    n = (self._dNS, n)
                nv = Element(n)
...
def unittest():
    parse('<doc>a<baz>f<b>o</b>ob<b>a</b>r</baz>a</doc>').__repr__(1, 1) == '<doc>\n\ta<baz>\n\t\tf<b>o</b>ob<b>a</b>r\n\t</baz>a\n</doc>'
