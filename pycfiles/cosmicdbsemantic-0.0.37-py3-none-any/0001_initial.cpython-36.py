...
# [GCC 8.4.0]
# Embedded file name: C:\Users\david\Projects\cosmicdbsemantic\cosmicdb\migrations\0001_initial.py
# Compiled at: 2018-08-27 02:28:42
# Size of source mod 2**32: 8930 bytes
from django.conf import settings
import django.contrib.auth.models, django.contrib.auth.validators
from django.db import migrations, models
import django.db.models.deletion, django.utils.timezone, sitetree.models
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='CosmicUser',
       fields=[
      (
     ...
     migrations.CreateModel(name='CosmicDBTree',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'Site Tree', 
      'verbose_name_plural':'Site Trees', 
      'abstract':False}),
     migrations.CreateModel(name='CosmicDBTreeItem',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'Site Tree Item', 
      'verbose_name_plural':'Site Tree Items', 
      'abstract':False}),
     migrations.CreateModel(name='UserSystemNotification',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.AlterUniqueTogether(name='cosmicdbtreeitem',
       unique_together={
      ('tree', 'alias')})]