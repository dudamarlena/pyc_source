...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/flask_reqarg/base.py
...
__all__ = ('get', 'post', 'args', 'files', 'cookies', 'collection', 'RequestWrapperBase')
...
class RequestWrapperBase(object):
    ...
    def __init__(self, request):
        ...
        self._storage_dict_map = {'_request': self._request, 
           '_get': self.get_dict, 
