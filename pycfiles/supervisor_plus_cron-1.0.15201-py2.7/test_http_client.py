...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\supervisor\tests\test_http_client.py
...
class HTTPHandlerTests(unittest.TestCase):
    ...
    def _makeOne(self, listener=None, username='', password=None):
        ...
        socket_map = {}
        return self._getTargetClass()(listener, username, password, map=socket_map)
    ...
    def test_get_bad_scheme(self):
        inst = self._makeOne()
        self.assertRaises(NotImplementedError, inst.get, 'nothttp://localhost', '/abc')
    ...
    def test_handle_error(self):
        ...
        self.assertEqual(inst.listener.error_msg, 'Cannot connect, error: None (None)')
    ...
    def test_status_line_not_200(self):
        ...
        self.assertEqual(inst.listener.error_msg, 'Cannot read, status code 201')
        self.assertEqual(closed, [True])
