...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\supervisor\tests\test_supervisorctl.py
...
class TestDefaultControllerPlugin(unittest.TestCase):
    ...
    def test_avail(self):
        ...
        class FakeSupervisor(object):
            ...
            def getAllConfigInfo(self):
                return [
                 {'group': 'group1', 'name': 'process1', 'inuse': False, 
    ...
    def test_update_changed_procs(self):
        ...
        results[:] = [
         {'name': 'changed_process1', 'group': 'changed_group', 
            ...
            'description': 'blah'},
         {'name': 'changed_process2', 'group': 'changed_group', 
    ...
    def test_update_removed_procs(self):
        ...
        supervisor.reloadConfig = reloadConfig
        results = [
         {'name': 'removed_process', 'group': 'removed_group', 
            'status': xmlrpc.Faults.SUCCESS, 
            'description': 'blah'}]
