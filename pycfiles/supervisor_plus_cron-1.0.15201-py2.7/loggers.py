...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\supervisor\loggers.py
...
class RotatingFileHandler(FileHandler):
    ...
    def __init__(self, filename, mode='a', maxBytes=536870912, backupCount=10):
        """
    ...
    def asdict(self):
        if self.dictrepr is None:
            ...
            if self.kw:
                ...
                msg = self.msg
            self.dictrepr = {'message': msg, 'levelname': levelname, 'asctime': asctime}
