...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\supervisor\tests\test_supervisord.py
...
class EntryPointTests(unittest.TestCase):
    ...
    if pstats:
        ...
        def test_main_profile(self):
            ...
            output = new_stdout.getvalue()
            self.assertTrue(output.find('cumulative time, call count') != -1, output)
...
class SupervisordTests(unittest.TestCase):
    ...
    def test_handle_sigusr2(self):
        ...
        options.process_group_configs = DummyPGroupConfig(options, 'foo', pconfigs=pconfigs)
