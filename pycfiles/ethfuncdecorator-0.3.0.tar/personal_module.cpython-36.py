...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/utils/module_testing/personal_module.py
# Compiled at: 2018-05-28 04:44:24
# Size of source mod 2**32: 3251 bytes
from eth_utils import is_checksum_address, is_list_like, is_same_address
...
class PersonalModuleTest:
    ...
    def test_personal_unlockAccount_success(self, web3, unlockable_account, unlockable_account_pw):
    ...
    def test_personal_sendTransaction(self, web3, unlockable_account, unlockable_account_pw):
        if not web3.eth.getBalance(unlockable_account) > web3.toWei(1, 'ether'):
            raise AssertionError
        else:
            txn_params = {'from':unlockable_account, 
    ...
    def test_personal_sign_and_ecrecover(self, web3, unlockable_account, unlockable_account_pw):
