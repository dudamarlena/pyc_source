...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/manager.py
...
from web3.middleware import abi_middleware, attrdict_middleware, gas_price_strategy_middleware, name_to_address_middleware, normalize_errors_middleware, pythonic_middleware, validation_middleware
...
class RequestManager:
    ...
    def _make_request(self, method, params):
        for provider in self.providers:
            ...
            raise UnhandledRequest('No providers responded to the RPC request:\nmethod:{0}\nparams:{1}\n'.format(method, params))
    ...
    def request_async(self, raw_method, raw_params):
        ...
        self.pending_requests[request_id] = spawn((self.request_blocking),
