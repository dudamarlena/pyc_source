...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/utils/decorators.py
...
def deprecated_for(replace_message):
    ...
    def decorator(to_wrap):
        ...
        def wrapper(*args, **kwargs):
            warnings.warn(('%s is deprecated in favor of %s' % (to_wrap.__name__, replace_message)),
