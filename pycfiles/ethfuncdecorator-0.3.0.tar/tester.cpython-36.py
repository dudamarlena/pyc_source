...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/providers/tester.py
# Compiled at: 2018-05-28 04:44:24
# Size of source mod 2**32: 4276 bytes
from wsgiref.simple_server import make_server
from eth_utils import decode_hex, is_integer, is_string, to_text
from web3.middleware import construct_exception_handler_middleware, construct_formatting_middleware
from web3.utils.decorators import deprecated_for
from web3.utils.formatters import apply_formatter_at_index, apply_formatter_if, apply_formatters_to_dict, hex_to_integer, static_result, static_return
from web3.utils.threads import spawn
from web3.utils.toolz import complement, compose, valmap
from .base import BaseProvider
from .rpc import HTTPProvider
...
TRANSACTION_FORMATTERS = {'to': apply_formatter_if(compose(complement(bool), decode_hex), static_return(None))}
...
ethtestrpc_middleware = construct_formatting_middleware(request_formatters={'eth_uninstallFilter':apply_formatter_at_index(to_integer_if_hex, 0), 
 ...
 'eth_getFilterLogs':apply_formatter_at_index(to_integer_if_hex, 0)},
  result_formatters={'eth_newFilter':apply_formatter_if(is_integer, hex), 
...
ethtestrpc_exception_middleware = construct_exception_handler_middleware(method_handlers={'eth_getBlockByHash':(
  ValueError, static_result(None)), 
...
class TestRPCProvider(HTTPProvider):
    middlewares = [
     ethtestrpc_middleware, ethtestrpc_exception_middleware]
