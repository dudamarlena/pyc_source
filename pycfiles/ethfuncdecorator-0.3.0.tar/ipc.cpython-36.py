...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/providers/ipc.py
    ...
    if sys.platform == 'darwin':
        ...
        if sys.platform.startswith('linux'):
            ...
            if sys.platform == 'win32':
                ...
                raise ValueError("Unsupported platform '{0}'.  Only darwin/linux2/win32 are supported.  You must specify the ipc_path".format(sys.platform))
