...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/utils/formatters.py
# Compiled at: 2018-05-28 04:44:24
# Size of source mod 2**32: 3725 bytes
from collections import Iterable, Mapping
from eth_utils import is_dict, is_list_like, is_string, to_dict, to_list
from web3.utils.decorators import reject_recursive_repeats
from web3.utils.toolz import compose, curry, dissoc
...
def apply_formatter_at_index(formatter, at_index, value):
    if at_index + 1 > len(value):
        raise IndexError('Not enough values in iterable to apply formatter.  Got: {0}. Need: {1}'.format(len(value), at_index + 1))
...
def apply_formatters_to_args(*formatters):
    return compose(*(apply_formatter_at_index(formatter, index) for index, formatter in enumerate(formatters)))
