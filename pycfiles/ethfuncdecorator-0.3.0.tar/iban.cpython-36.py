...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/q3/1b9f00755fngs2554s60x4_h0000gn/T/pycharm-packaging/web3/web3/iban.py
# Compiled at: 2018-05-28 04:44:24
# Size of source mod 2**32: 5850 bytes
import functools, re
from eth_utils import is_string, to_checksum_address
...
class IsValid:
    ...
    def validate(iban_address):
        if not is_string(iban_address):
            ...
            if re.match('^XE[0-9]{2}(ETH[0-9A-Z]{13}|[0-9A-Z]{30,31})$', iban_address):
                if mod9710(iso13616Prepare(iban_address)) == 1:
                    return True
            return False
