...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/zmq_rpc/server.py
# Compiled at: 2018-08-03 03:36:37
import zmq, struct, logging, os, random, sys, time
...
class ZmqRpcServer(ZmqRpcConnector):
    ...
    def __init__(self, url):
        ...
        self.prefix = self.RESP_PREFIX.pack(os.getpid() % 65536, random.randrange(65536))
        self.running = False
