...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ZSI/generate/wsdl2dispatch.py
...
class ServiceModuleWriter():
    ...
    def setUpClassDef(self, service):
        ...
        """
        assert isinstance(service, WSDLTools.Service) is True, 'expecting WSDLTools.Service instance.'
        ...
        for bop in binding.operations:
            ...
            for ext in bop.extensions:
                ...
                if self.strict is False:
                    warnings.warn('Port(%s) operation(%s) in Binding(%s) soapAction(%s) != WS-Action(%s)' % (
