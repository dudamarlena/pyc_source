...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ZSI/wstools/Utility.py
...
class DOM():
    ...
    NS_XSD_ALL = (
     NS_XSD_99, NS_XSD_00, NS_XSD_01)
    NS_XSI_ALL = (NS_XSI_99, NS_XSI_00, NS_XSI_01)
    NS_XSD = NS_XSD_01
    NS_XSI = NS_XSI_01
    _xsd_uri_mapping = {NS_XSD_99: NS_XSI_99, 
       NS_XSD_00: NS_XSI_00, 
       NS_XSD_01: NS_XSI_01}
...
class ElementProxy(Base, MessageInterface):
    ...
    standard_ns = {_xml_prefix: _xml_nsuri, 
       _xmlns_prefix: _xmlns_nsuri}
    reserved_ns = {_soap_env_prefix: _soap_env_nsuri, 
    ...
    def createDocument(self, namespaceURI, localName, doctype=None):
        ...
        if namespaceURI == self.reserved_ns[prefix]:
            ...
            if namespaceURI is localName is None:
