...
# [GCC 8.4.0]
# Embedded file name: /Users/brentpayne/anaconda/lib/python2.7/site-packages/phrase/phrase_dictionary.py
...
class PhraseDictionary(dict):
    ...
    def generate_phrase_detection_function(cls, min_token_count, max_phrases, exclude_ngram_filter=None):
        ...
        def phrase_detector(tokens):
            ...
            collocation_finder.apply_freq_filter(min_token_count)
