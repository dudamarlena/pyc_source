...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/File/csv.py
# Compiled at: 2020-01-30 08:39:20
...
def save(data, filename, delimiter=',', fmt='%.18E'):
    ...
    with do_open(filename, 'wb') as (F):
        F.write(asbytes('# %s \n' % data.axis1.report()))
        for att in data.axis1.attributes:
