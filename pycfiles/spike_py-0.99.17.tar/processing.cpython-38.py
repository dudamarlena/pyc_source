...
def do_process2D(dinp, datatemp, doutp, parameter):
    ...
    if debug > 1:
        for f, d in (
         (
          parameter.infile, dinp), (parameter.interfile, datatemp), (parameter.outfile, doutp)):
            print('----------', f)
            print(d)
