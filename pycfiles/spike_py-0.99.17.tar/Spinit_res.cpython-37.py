...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/File/Spinit_res.py
# Compiled at: 2019-08-14 15:46:25
...
def Import_1D(filename='data.dat'):
    ...
    size = int(acqu['ACQUISITION_MATRIX_DIMENSION_1D'])
    if verbose:
...
def Export_1D(d, filename='data.dat', template='header.xml', kind=None):
    ...
    if d.dim > 1:
        ...
        if d.itype == 1:
            ...
            array = d.get_buffer() + complex(0.0, 0.0)
