...
def centroid2d--- This code section failed: ---
 ...
 L. 631   120_122  SETUP_LOOP          532  'to 532'
              124  LOAD_FAST                'npkd'
              126  LOAD_ATTR                peaks
              128  GET_ITER         
          130_132  FOR_ITER            530  'to 530'
              134  STORE_FAST               'pk'

 L. 632       136  LOAD_GLOBAL              int
 ...
 L. 633       154  LOAD_GLOBAL              int
              156  LOAD_GLOBAL              round
              158  LOAD_FAST                'pk'
              160  LOAD_ATTR                posF1
              162  LOAD_FAST                'noff1'
              164  BINARY_ADD       
 ...
 L. 634       176  LOAD_GLOBAL              int
              178  LOAD_GLOBAL              round
              180  LOAD_FAST                'pk'
              182  LOAD_ATTR                posF2
              184  LOAD_FAST                'noff2'
              186  BINARY_SUBTRACT  
 ...
 L. 635       194  LOAD_GLOBAL              int
              196  LOAD_GLOBAL              round
              198  LOAD_FAST                'pk'
              200  LOAD_ATTR                posF2
              202  LOAD_FAST                'noff2'
              204  BINARY_ADD       
              ...
              214  STORE_DEREF              'end2'

 L. 636       216  LOAD_GLOBAL              np
              218  LOAD_METHOD              array
              220  LOAD_CLOSURE             'end2'
              222  LOAD_CLOSURE             'st2'
              224  BUILD_TUPLE_2         2 
              226  LOAD_LISTCOMP            '<code_object <listcomp>>'
              228  LOAD_STR                 'centroid2d.<locals>.<listcomp>'
              ...
              246  LOAD_METHOD              ravel
              248  CALL_METHOD_0         0  '0 positional arguments'
              250  STORE_FAST               'yxdata'

 L. 639       252  LOAD_FAST                'npkd'
              254  LOAD_METHOD              get_buffer
              ...
              270  BUILD_TUPLE_2         2 
              272  BINARY_SUBSCR    
              274  LOAD_METHOD              ravel
              276  CALL_METHOD_0         0  '0 positional arguments'
              278  STORE_FAST               'zdata'

 L. 640       280  SETUP_EXCEPT        322  'to 322'

 L. 642       282  LOAD_GLOBAL              curve_fit
              284  LOAD_GLOBAL              center2d
              286  LOAD_FAST                'yxdata'
              288  LOAD_FAST                'zdata'
              290  LOAD_FAST                'pk'
              292  LOAD_ATTR                posF1
              294  LOAD_FAST                'pk'
              296  LOAD_ATTR                posF2
              298  LOAD_FAST                'pk'
              300  LOAD_ATTR                intens
              302  LOAD_CONST               1.0
              304  LOAD_CONST               1.0
              306  BUILD_LIST_5          5 
              308  LOAD_CONST               ('p0',)
              310  CALL_FUNCTION_KW_4     4  '4 total positional and keyword args'
              312  UNPACK_SEQUENCE_2     2 
              314  STORE_FAST               'popt'
              316  STORE_FAST               'pcov'
              318  POP_BLOCK        
              320  JUMP_FORWARD        364  'to 364'
            322_0  COME_FROM_EXCEPT    280  '280'

 L. 643       322  DUP_TOP          
              324  LOAD_GLOBAL              RuntimeError
 ...
 L. 644       338  LOAD_GLOBAL              print
              340  LOAD_STR                 'peak %d (label %s) centroid could not be fitted'
              342  LOAD_FAST                'pk'
              344  LOAD_ATTR                Id
              346  LOAD_FAST                'pk'
              348  LOAD_ATTR                label
            ...
            364_1  COME_FROM           320  '320'

 L. 645       364  LOAD_FAST                'popt'
              366  LOAD_CONST               0
              368  BINARY_SUBSCR    
              370  LOAD_FAST                'pk'
              372  STORE_ATTR               posF1

 L. 646       374  LOAD_FAST                'popt'
              376  LOAD_CONST               1
              378  BINARY_SUBSCR    
              380  LOAD_FAST                'pk'
              382  STORE_ATTR               posF2

 L. 647       384  LOAD_FAST                'popt'
              386  LOAD_CONST               2
              388  BINARY_SUBSCR    
              390  LOAD_FAST                'pk'
              392  STORE_ATTR               intens

 L. 648       394  LOAD_GLOBAL              np
              396  LOAD_METHOD              sqrt
              398  LOAD_CONST               2.0
              ...
              408  BINARY_MULTIPLY  
              410  LOAD_FAST                'pk'
              412  STORE_ATTR               widthF1

 L. 649       414  LOAD_GLOBAL              np
              416  LOAD_METHOD              sqrt
              418  LOAD_CONST               2.0
              ...
              428  BINARY_MULTIPLY  
              430  LOAD_FAST                'pk'
              432  STORE_ATTR               widthF2

 L. 650       434  LOAD_GLOBAL              np
              436  LOAD_METHOD              sqrt
              438  LOAD_GLOBAL              np
              440  LOAD_METHOD              diag
              442  LOAD_FAST                'pcov'
              444  CALL_METHOD_1         1  '1 positional argument'
              446  CALL_METHOD_1         1  '1 positional argument'
              448  STORE_FAST               'errors'

 L. 651       450  LOAD_GLOBAL              print
              452  LOAD_FAST                'errors'
              454  CALL_FUNCTION_1       1  '1 positional argument'
              456  POP_TOP          

 L. 652       458  LOAD_FAST                'errors'
              460  LOAD_CONST               0
              462  BINARY_SUBSCR    
              464  LOAD_FAST                'pk'
              466  STORE_ATTR               posF1_err

 L. 653       468  LOAD_FAST                'errors'
              470  LOAD_CONST               1
              472  BINARY_SUBSCR    
              474  LOAD_FAST                'pk'
              476  STORE_ATTR               posF2_err

 L. 654       478  LOAD_FAST                'errors'
              480  LOAD_CONST               2
              482  BINARY_SUBSCR    
              484  LOAD_FAST                'pk'
              486  STORE_ATTR               intens_err

 L. 655       488  LOAD_GLOBAL              np
              490  LOAD_METHOD              sqrt
              492  LOAD_CONST               2.0
              494  CALL_METHOD_1         1  '1 positional argument'
              496  LOAD_FAST                'errors'
              498  LOAD_CONST               3
              500  BINARY_SUBSCR    
              502  BINARY_MULTIPLY  
              504  LOAD_FAST                'pk'
              506  STORE_ATTR               widthF1_err

 L. 656       508  LOAD_GLOBAL              np
              510  LOAD_METHOD              sqrt
              512  LOAD_CONST               2.0
              514  CALL_METHOD_1         1  '1 positional argument'
              516  LOAD_FAST                'errors'
              518  LOAD_CONST               4
              520  BINARY_SUBSCR    
              522  BINARY_MULTIPLY  
              524  LOAD_FAST                'pk'
              526  STORE_ATTR               widthF2_err
              528  JUMP_BACK           130  'to 130'
              530  POP_BLOCK        
            532_0  COME_FROM_LOOP      120  '120'
...
def pk2pandas_ms--- This code section failed: ---
 ...
 L. 754       260  LOAD_LISTCOMP            '<code_object <listcomp>>'
              ...
              274  LOAD_CONST               ('Id', 'Label', 'm/z', 'Δm/z', 'R', 'Intensity', 'ε_m/z', 'ε_Intensity')
 ...
 L. 763       356  LOAD_FAST                'npkd'
              ...
              362  LOAD_CONST               ('Id', 'Label', 'm/z', 'Δm/z', 'R', 'Intensity')
 ...
 L. 790       796  LOAD_GLOBAL              np
              ...
              800  LOAD_FAST                'R1'
              802  LOAD_CONST               -3
              804  CALL_METHOD_2         2  '2 positional arguments'

 L. 791       806  LOAD_GLOBAL              np
              808  LOAD_METHOD              around
              810  LOAD_FAST                'R1'
              812  LOAD_CONST               -3
              814  CALL_METHOD_2         2  '2 positional arguments'
 ...
 L. 795       838  LOAD_LISTCOMP            '<code_object <listcomp>>'
              ...
              852  LOAD_CONST               ('Id', 'Label', 'm/z F1', 'm/z F2', 'Intensity', 'Δm/z F1', 'Δm/z F2', 'R1', 'R2', 'R *1E6', 'ε_m/z F1', 'ε_m/z F2', 'ε_Intensity')
 ...
 L. 807       940  LOAD_GLOBAL              np
              ...
              944  LOAD_FAST                'R1'
              946  LOAD_CONST               -3
              948  CALL_METHOD_2         2  '2 positional arguments'
 ...
 L. 808       950  LOAD_GLOBAL              np
              ...
              968  LOAD_CONST               ('Id', 'Label', 'm/z F1', 'm/z F2', 'Intensity', 'Δm/z F1', 'Δm/z F2', 'R1', 'R2', 'R *1E6')
...
def pk2pandas_nmr--- This code section failed: ---
 ...
 L. 831       196  LOAD_CLOSURE             'w_itohz'
              ...
              210  GET_ITER         
              212  CALL_FUNCTION_1       1  '1 positional argument'
              214  LOAD_CONST               ('Id', 'Label', 'Position', 'Intensity', 'Width', 'Position_err', 'Intensity_err', 'Width_err')
 ...
 L. 839       274  LOAD_CLOSURE             'w_itohz'
              ...
              292  LOAD_CONST               ('Id', 'Label', 'Position', 'Intensity', 'Width')
 ...
 L. 864       646  LOAD_CLOSURE             'w_itohz1'
              ...
              664  LOAD_CONST               ('Id', 'Label', 'Position F1', 'Position F2', 'Intensity', 'Width F1', 'Width F2', 'Position_err F1', 'Position_err F2', 'Intensity_err', 'Width_err F1', 'Width_err F2')
 ...
 L. 874       756  LOAD_CLOSURE             'w_itohz2'
              ...
              774  LOAD_CONST               ('Id', 'Label', 'Position F1', 'Position F2', 'Intensity', 'Width F1', 'Width F2')
