...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/fancyflash/__init__.py
# Compiled at: 2008-02-04 10:49:26
...
def register_flash_widget(widget='fancyflash.fancyflashwidget'):
    ...
    turbogears.config.update({'global': {'tg.include_widgets': include_widgets}})
    return widget
