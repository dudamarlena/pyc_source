...
# [GCC 8.4.0]
# Embedded file name: /Users/steve/dev/django-ios-notifications/ios_notifications/management/commands/push_ios_notification.py
# Compiled at: 2015-01-06 07:03:13
...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
     make_option('--message', help='The main message to be sent in the notification', dest='message', default=''),
     make_option('--badge', help='The badge number of the notification', dest='badge', default=None),
     make_option('--sound', help='The sound for the notification', dest='sound', default=''),
     make_option('--service', help='The id of the APN Service to send this notification through', dest='service', default=None),
     make_option('--extra', help='Custom notification payload values as a JSON dictionary', dest='extra', default=None),
     make_option('--persist', help='Save the notification in the database after pushing it.', action='store_true', dest='persist', default=None),
     make_option('--no-persist', help='Prevent saving the notification in the database after pushing it.', action='store_false', dest='persist'),
     make_option('--batch-size', help='Notifications are sent to devices in batches via the APN Service. This controls the batch size. Default is 100.', dest='chunk_size', default=100))
    ...
    def handle(self, *args, **options):
        ...
        notification = Notification(message=options['message'], badge=options['badge'], service=service, sound=options['sound'])
