...
class SanityCheckException(Exception):
    __doc__ = 'Exception thrown by sanity checks of user-supplied input'
...
class SafeVec:
    __doc__ = "A simple wrapper class for the 'vec' argument to user prior functions,\n      with nicer error messages"
...
class Scan:
    __doc__ = 'Helper object for setting up and running a scan, and\n       making some basic plots.\n    '
