...
# [GCC 8.4.0]
# Embedded file name: /Users/boby/Projects/ops-hero/code/trebuchet/trebuchet/lib/utils.py
# Compiled at: 2013-12-04 09:14:59
import os, pipes, codecs
...
def local_template(filename, destination, context=None, use_jinja=False, template_dir=None, backup=True, mirror_local_mode=False, mode=None):
    """
    ...
    if use_jinja:
        try:
            ...
            jenv = Environment(loader=loader, undefined=StrictUndefined, keep_trailing_newline=True)
