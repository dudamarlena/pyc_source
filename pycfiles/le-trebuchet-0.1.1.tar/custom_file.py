...
# [GCC 8.4.0]
# Embedded file name: /code/trebuchet/trebuchet/lib/custom_file.py
# Compiled at: 2013-11-20 09:08:17
import os
from fabric.api import local
from .utils import local_template, prepare_folder

def get_custom_file(type_, name, template, target_path=None, target_extension=None, target_is_executable=None, target_filename=None, maiden_name=None, options=None):
...
class CustomFile(object):
    ...
    def __init__(self, name, template=None, target_path=None, target_extension=None, target_is_executable=None, target_filename=None, maiden_name=None, options=None):
        self.name = name
    ...
    def build(self, base_path, options=None, extra_template_dir=None):
        ...
        local_template(self.template, full_path, context=params, use_jinja=True, backup=False, template_dir=template_dir)
    ...
    def relative_filepath(self):
        ...
        return os.path.join(self.target_path, '%s%s' % (self.name, self.extension))
