...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/imgserve/args.py
# Compiled at: 2009-07-25 14:27:02
"""
...
class ArgumentError(RuntimeError):
    """Thrown when daemon encounters a command line format error."""
    pass
...
def match(tokens, of_type=None):
    ...
    if of_type:
        if not peek(tokens, of_type):
            raise ArgumentError("Expecting '%s' type of argument not %s in tokens: %r.  Read the imgserve help." % (
