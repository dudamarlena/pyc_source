...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fstringify/api.py
# Compiled at: 2019-10-18 01:14:41
# Size of source mod 2**32: 1640 bytes
import os, sys, time, astor
...
def fstringify(file_or_path, verbose=False, quiet=False):
    ...
    if not os.path.exists(to_use):
        ...
        if os.path.isdir(to_use):
            ...
            files = (
             (
              os.path.dirname(to_use), os.path.basename(to_use)),)
