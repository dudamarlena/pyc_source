...
# [GCC 8.4.0]
# Embedded file name: /Users/zupo/work/tutorial.todoapp/src/tutorial/todoapp/tests/test_todo_view.py
# Compiled at: 2012-09-05 04:57:28
...
class TestView(IntegrationTestCase):
    ...
    def setUp(self):
        ...
        self.view = api.content.get_view(name='todo', context=self.folder, request=self.request)
    ...
    def test_listing_table(self):
        ...
        self.assertIn('>Try Brulé!</a>', output)
