...
# [GCC 8.4.0]
# Embedded file name: /Users/zupo/work/tutorial.todoapp/src/tutorial/todoapp/tests/test_workflow.py
...
class TestWorkflowServices(IntegrationTestCase):
    ...
    def setUp(self):
        ...
        self.todo = api.content.create(container=self.folder, type='todo_item', title='Try Brulé!')

    def test_complete_todo_item(self):
        self.request.form['transition'] = 'complete'
        view = api.content.get_view(name='update_workflow', context=self.todo, request=self.request)
