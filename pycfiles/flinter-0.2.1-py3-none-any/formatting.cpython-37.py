...
# [GCC 8.4.0]
# Embedded file name: /Users/dauptain/GITLAB/flint/flinter/formatting.py
# Compiled at: 2020-02-10 05:58:27
# Size of source mod 2**32: 4055 bytes
"""Module containing base functions to lint
    and dectect broken formatting rules
"""
import re, yaml, pkg_resources
...
def parse_format_line(filename, line, line_no, rules):
    """Analyse line
    ...
    msg_info = {'line_no':line_no, 
     'line':line.replace('\n', ''), 
     'filename':filename}
    format_stats = {'errors':0,  'modifs':0}
    all_errors = dict()
    for key in rules:
        rule = rules[key]
