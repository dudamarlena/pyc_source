...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/core/matcher.py
...
class Match(object):
    __doc__ = 'Class to store results from the matcher.\n\n  This class is used to store the results from the matcher. It provides\n  convenient methods to query the matching results.\n  '
    ...
    """
        return self._reshape_and_cast(self._gather_op(tf.cast((self._match_results), dtype=(tf.float32)), self.matched_column_indices()))
...
class Matcher(six.with_metaclass(abc.ABCMeta, object)):
    __doc__ = 'Abstract base class for matcher.\n  '
    ...
    """
        with tf.name_scope(scope, 'Match') as (scope):
            ...
            return Match(self._match(similarity_matrix, valid_rows), self._use_matmul_gather)
