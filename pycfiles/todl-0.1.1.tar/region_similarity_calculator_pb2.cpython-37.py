...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/protos/region_similarity_calculator_pb2.py
...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(name='RegionSimilarityCalculator',
 ...
 _descriptor.FieldDescriptor(name='neg_sq_dist_similarity',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='iou_similarity',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='ioa_similarity',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='thresholded_iou_similarity',
  ...
  extension_ranges=[],
  oneofs=[
 _descriptor.OneofDescriptor(name='region_similarity',
...
_NEGSQDISTSIMILARITY = _descriptor.Descriptor(name='NegSqDistSimilarity',
  ...
  serialized_end=461)
_IOUSIMILARITY = _descriptor.Descriptor(name='IouSimilarity',
  ...
  serialized_end=478)
_IOASIMILARITY = _descriptor.Descriptor(name='IoaSimilarity',
  ...
  serialized_end=495)
_THRESHOLDEDIOUSIMILARITY = _descriptor.Descriptor(name='ThresholdedIouSimilarity',
...
_REGIONSIMILARITYCALCULATOR.oneofs_by_name['region_similarity'].fields.append(_REGIONSIMILARITYCALCULATOR.fields_by_name['thresholded_iou_similarity'])
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), {'DESCRIPTOR':_REGIONSIMILARITYCALCULATOR, 
 '__module__':'object_detection.protos.region_similarity_calculator_pb2'})
_sym_db.RegisterMessage(RegionSimilarityCalculator)
NegSqDistSimilarity = _reflection.GeneratedProtocolMessageType('NegSqDistSimilarity', (_message.Message,), {'DESCRIPTOR':_NEGSQDISTSIMILARITY, 
 '__module__':'object_detection.protos.region_similarity_calculator_pb2'})
_sym_db.RegisterMessage(NegSqDistSimilarity)
IouSimilarity = _reflection.GeneratedProtocolMessageType('IouSimilarity', (_message.Message,), {'DESCRIPTOR':_IOUSIMILARITY, 
 '__module__':'object_detection.protos.region_similarity_calculator_pb2'})
_sym_db.RegisterMessage(IouSimilarity)
IoaSimilarity = _reflection.GeneratedProtocolMessageType('IoaSimilarity', (_message.Message,), {'DESCRIPTOR':_IOASIMILARITY, 
 '__module__':'object_detection.protos.region_similarity_calculator_pb2'})
_sym_db.RegisterMessage(IoaSimilarity)
ThresholdedIouSimilarity = _reflection.GeneratedProtocolMessageType('ThresholdedIouSimilarity', (_message.Message,), {'DESCRIPTOR':_THRESHOLDEDIOUSIMILARITY, 
 '__module__':'object_detection.protos.region_similarity_calculator_pb2'})
