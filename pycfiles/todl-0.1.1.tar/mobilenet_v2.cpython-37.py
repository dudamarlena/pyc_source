...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/slim/nets/mobilenet/mobilenet_v2.py
# Compiled at: 2020-04-05 19:50:58
# Size of source mod 2**32: 9200 bytes
...
V2_DEF = dict(defaults={(
 ...
 (
 ops.expanded_conv,): {'expansion_size':expand_input(6), 
                          'split_expansion':1, 
 ...
 op((ops.expanded_conv), expansion_size=expand_input(1, divisible_by=1),
   num_outputs=16),
...
V2_DEF_GROUP_NORM['defaults'] = {(
 ...
 contrib_slim.separable_conv2d): {'normalizer_fn':contrib_layers.group_norm, 
                                                                                         'activation_fn':tf.nn.relu6}, 
 
 (
 ops.expanded_conv,): {'expansion_size':ops.expand_input_by_factor(6), 
                          'split_expansion':1, 
                          'normalizer_fn':contrib_layers.group_norm, 
                          'residual':True}, 
 
 (
 contrib_slim.conv2d, contrib_slim.separable_conv2d): {'padding': 'SAME'}}
...
def mobilenet_base(input_tensor, depth_multiplier=1.0, **kwargs):
    ...
    return mobilenet(input_tensor, depth_multiplier=depth_multiplier, 
...
def mobilenet_base_group_norm(input_tensor, depth_multiplier=1.0, **kwargs):
 ...
 contrib_layers.group_norm,): {'groups': kwargs.pop('groups', 8)}})
    return mobilenet(
...
__all__ = [
 'training_scope', 'mobilenet_base', 'mobilenet', 'V2_DEF']