...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/matcher_builder.py
...
def build(matcher_config):
  ...
  """
    ...
    if matcher_config.WhichOneof('matcher_oneof') == 'argmax_matcher':
        ...
        return argmax_matcher.ArgMaxMatcher(matched_threshold=matched_threshold,
