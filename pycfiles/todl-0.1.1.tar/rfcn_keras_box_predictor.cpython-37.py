...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/predictors/rfcn_keras_box_predictor.py
...
class RfcnKerasBoxPredictor(box_predictor.KerasBoxPredictor):
    ...
    """
        super(RfcnKerasBoxPredictor, self).__init__(is_training,
        ...
        self._shared_conv_layers.append((tf.keras.layers.Conv2D)(
 self._depth,
 [
  1, 1], padding='SAME', 
         name='reduce_depth_conv', **self._conv_hyperparams.params()))
        self._shared_conv_layers.append(self._conv_hyperparams.build_batch_norm(training=(self._is_training and not self._freeze_batchnorm),
        ...
        self._box_encoder_layers.append((tf.keras.layers.Conv2D)(
 location_feature_map_depth,
 [
  1, 1], padding='SAME', 
         name='refined_locations_conv', **self._conv_hyperparams.params()))
        self._box_encoder_layers.append(self._conv_hyperparams.build_batch_norm(training=(self._is_training and not self._freeze_batchnorm),
        ...
        self._class_predictor_layers.append((tf.keras.layers.Conv2D)(
 class_feature_map_depth,
 [
  1, 1], padding='SAME', 
         name='class_predictions_conv', **self._conv_hyperparams.params()))
        self._class_predictor_layers.append(self._conv_hyperparams.build_batch_norm(training=(self._is_training and not self._freeze_batchnorm),
    ...
    """
        ...
        box_encodings = ops.batch_position_sensitive_crop_regions(box_net,
        ...
        class_predictions_with_background = ops.batch_position_sensitive_crop_regions(class_net,
          boxes=proposal_boxes,
          crop_size=(self._crop_size),
          num_spatial_bins=(self._num_spatial_bins),
          global_pool=True)
