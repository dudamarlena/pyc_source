...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_resnet_v1_fpn_feature_extractor.py
...
class SSDResnetV1FpnFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    __doc__ = 'SSD FPN feature extractor based on Resnet v1 architecture.'
    ...
    """
        super(SSDResnetV1FpnFeatureExtractor, self).__init__(is_training=is_training,
          ...
          reuse=(self._reuse_weights)) as (scope):
            with slim.arg_scope(resnet_v1.resnet_arg_scope()):
                with slim.arg_scope(self._conv_hyperparams_fn()) if self._override_base_feature_extractor_hyperparams else context_manager.IdentityContextManager():
                    _, image_features = self._resnet_base_fn(inputs=(ops.pad_to_multiple(preprocessed_inputs, self._pad_to_multiple)),
                      num_classes=None,
                      is_training=None,
                      global_pool=False,
                      output_stride=None,
            ...
            with slim.arg_scope(self._conv_hyperparams_fn()):
                with tf.variable_scope((self._fpn_scope_name), reuse=(self._reuse_weights)):
                    ...
                    for i in range(base_fpn_max_level, self._fpn_max_level):
                        last_feature_map = slim.conv2d(last_feature_map,
...
class SSDResnet50V1FpnFeatureExtractor(SSDResnetV1FpnFeatureExtractor):
    __doc__ = 'SSD Resnet50 V1 FPN feature extractor.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDResnet50V1FpnFeatureExtractor, self).__init__(is_training,
          depth_multiplier,
          min_depth,
          pad_to_multiple,
          conv_hyperparams_fn,
...
class SSDResnet101V1FpnFeatureExtractor(SSDResnetV1FpnFeatureExtractor):
    __doc__ = 'SSD Resnet101 V1 FPN feature extractor.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDResnet101V1FpnFeatureExtractor, self).__init__(is_training,
          depth_multiplier,
          min_depth,
          pad_to_multiple,
          conv_hyperparams_fn,
...
class SSDResnet152V1FpnFeatureExtractor(SSDResnetV1FpnFeatureExtractor):
    __doc__ = 'SSD Resnet152 V1 FPN feature extractor.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDResnet152V1FpnFeatureExtractor, self).__init__(is_training,
          depth_multiplier,
          min_depth,
          pad_to_multiple,
          conv_hyperparams_fn,
