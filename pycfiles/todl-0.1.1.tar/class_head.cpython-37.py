...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/predictors/heads/class_head.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 12838 bytes
"""Class Head.
...
class MaskRCNNClassHead(head.Head):
    ...
    """
        ...
        with slim.arg_scope(self._fc_hyperparams_fn()):
            class_predictions_with_background = slim.fully_connected(flattened_roi_pooled_features,
...
class ConvolutionalClassHead(head.Head):
    ...
    """
        ...
        if self._use_dropout:
            ...
            class_predictions_with_background = slim.separable_conv2d(net,
              None, [self._kernel_size, self._kernel_size], padding='SAME',
              depth_multiplier=1,
              stride=1,
              rate=1,
              scope=depthwise_scope)
            class_predictions_with_background = slim.conv2d(class_predictions_with_background,
            ...
            class_predictions_with_background = slim.conv2d(net,
              (num_predictions_per_location * self._num_class_slots),
              [
...
class WeightSharedConvolutionalClassHead(head.Head):
    ...
    """
        ...
        if self._use_dropout:
            class_predictions_net = slim.dropout(class_predictions_net,
              keep_prob=(self._dropout_keep_prob))
        elif self._use_depthwise:
            conv_op = functools.partial((slim.separable_conv2d), depth_multiplier=1)
        else:
            conv_op = slim.conv2d
        class_predictions_with_background = conv_op(class_predictions_net,
          (num_predictions_per_location * self._num_class_slots),
          [
         self._kernel_size, self._kernel_size],
          activation_fn=None,
