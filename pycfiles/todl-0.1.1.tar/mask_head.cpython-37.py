...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/predictors/heads/mask_head.py
    ...
    """
        ...
        with slim.arg_scope(self._conv_hyperparams_fn()):
            ...
            if self._convolve_then_upsample:
                ...
                features = ops.nearest_neighbor_upsampling(features,
            ...
            mask_predictions = slim.conv2d(features,
...
class ConvolutionalMaskHead(head.Head):
    ...
    """
        ...
        if self._use_dropout:
            ...
            mask_predictions = slim.separable_conv2d(net,
            ...
            mask_predictions = slim.conv2d(net,
              (num_predictions_per_location * num_mask_channels),
              [
...
class WeightSharedConvolutionalMaskHead(head.Head):
    __doc__ = 'Weight shared convolutional mask prediction head.'
    ...
    """
        ...
        num_mask_channels = num_masks * self._mask_height * self._mask_width
        if self._use_dropout:
            mask_predictions_net = slim.dropout(mask_predictions_net,
