...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/street/python/shapes.py
# Compiled at: 2020-04-05 19:50:58
# Size of source mod 2**32: 8866 bytes
...
def transposing_reshape(tensor, src_dim, part_a, part_b, dest_dim_a, dest_dim_b, name=None):
  ...
  """
    if dest_dim_a != src_dim:
        if dest_dim_b != src_dim:
            raise ValueError('At least one of dest_dim_a, dest_dim_b must equal src_dim!')
    elif not part_a == 0:
        if part_b == 0:
