...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/slim/nets/mobilenet_v1.py
# Compiled at: 2020-04-05 19:50:58
# Size of source mod 2**32: 22682 bytes
"""MobileNet v1.
        ...
        with slim.arg_scope([slim.conv2d, slim.separable_conv2d], padding=padding):
            ...
            for i, conv_def in enumerate(conv_defs):
                ...
                if output_stride is not None:
                    ...
                    net = slim.conv2d(net, (depth(conv_def.depth)), [1, 1], stride=1,
                      scope=end_point)
                    end_points[end_point] = net
                    if end_point == final_endpoint:
                        return (
...
def mobilenet_v1(inputs, num_classes=1000, dropout_keep_prob=0.999, is_training=True, min_depth=8, depth_multiplier=1.0, conv_defs=None, prediction_fn=contrib_layers.softmax, spatial_squeeze=True, reuse=None, scope='MobilenetV1', global_pool=False):
  ...
  """
    ...
    with tf.compat.v1.variable_scope(scope,
      'MobilenetV1', [inputs], reuse=reuse) as (scope):
...
def mobilenet_v1_arg_scope(is_training=True, weight_decay=4e-05, stddev=0.09, regularize_depthwise=False, batch_norm_decay=0.9997, batch_norm_epsilon=0.001, batch_norm_updates_collections=tf.compat.v1.GraphKeys.UPDATE_OPS, normalizer_fn=slim.batch_norm):
