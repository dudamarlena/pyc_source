...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/algorithms/linear_full_posterior_sampling.py
...
class LinearFullPosteriorSampling(BanditAlgorithm):
    __doc__ = 'Thompson Sampling with independent linear models and unknown noise var.'
