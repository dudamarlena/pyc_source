...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/data/data_sampler.py
# Compiled at: 2018-07-23 14:29:50
# Size of source mod 2**32: 13673 bytes
  ...
  """
    ...
    random_poison = np.random.choice([
     r_eat_poison_bad, r_eat_poison_good],
      p=[
     prob_poison_bad, 1 - prob_poison_bad],
      size=num_contexts)
    ...
    return (
     np.hstack((contexts, no_eat_reward, eat_reward)), opt_vals)
...
def classification_to_bandit_problem(contexts, labels, num_actions=None):
    ...
    return (
     contexts, rewards, (np.ones(num_contexts), labels))
