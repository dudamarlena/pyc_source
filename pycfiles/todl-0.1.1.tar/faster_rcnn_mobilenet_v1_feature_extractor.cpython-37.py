...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/faster_rcnn_mobilenet_v1_feature_extractor.py
...
class FasterRCNNMobilenetV1FeatureExtractor(faster_rcnn_meta_arch.FasterRCNNFeatureExtractor):
    __doc__ = 'Faster R-CNN Mobilenet V1 feature extractor implementation.'
    ...
    """
        ...
        preprocessed_inputs = shape_utils.check_min_image_dim(min_dim=33,
          image_tensor=preprocessed_inputs)
        with slim.arg_scope(mobilenet_v1.mobilenet_v1_arg_scope(is_training=(self._train_batch_norm),
 ...
 preprocessed_inputs, final_endpoint='Conv2d_11_pointwise', 
                 min_depth=self._min_depth, 
                 depth_multiplier=self._depth_multiplier, 
                 scope=scope, **params)
        return (
         activations['Conv2d_11_pointwise'], activations)
