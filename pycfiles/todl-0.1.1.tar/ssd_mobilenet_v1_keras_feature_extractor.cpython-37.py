...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_mobilenet_v1_keras_feature_extractor.py
...
class SSDMobileNetV1KerasFeatureExtractor(ssd_meta_arch.SSDKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using Keras MobilenetV1 features.'
    ...
    """
        super(SSDMobileNetV1KerasFeatureExtractor, self).__init__(is_training=is_training,
    ...
    def build(self, input_shape):
        full_mobilenet_v1 = mobilenet_v1.mobilenet_v1(batchnorm_training=(self._is_training and not self._freeze_batchnorm),
        ...
        self._mobilenet_v1 = tf.keras.Model(inputs=(full_mobilenet_v1.inputs),
          outputs=[
         conv2d_11_pointwise, conv2d_13_pointwise])
        self._feature_map_generator = feature_map_generators.KerasMultiResolutionFeatureMaps(feature_map_layout=(self._feature_map_layout),
    ...
    """
        ...
        feature_maps = self._feature_map_generator({'Conv2d_11_pointwise':image_features[0], 
