...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/metrics/offline_eval_map_corloc.py
...
"""
import csv, os, re, tensorflow as tf
...
def main(argv):
    ...
    configs = config_util.get_configs_from_multiple_files(eval_input_config_path=(FLAGS.input_config_path),
