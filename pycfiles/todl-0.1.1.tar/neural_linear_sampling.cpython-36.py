...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/algorithms/neural_linear_sampling.py
...
class NeuralLinearPosteriorSampling(BanditAlgorithm):
    __doc__ = 'Full Bayesian linear regression on the last layer of a deep neural net.'
    ...
    def __init__(self, name, hparams, optimizer='RMS'):
        ...
        self.data_h = ContextualDataset((hparams.context_dim), (hparams.num_actions),
          intercept=False)
        self.latent_h = ContextualDataset((self.latent_dim), (hparams.num_actions),
          intercept=False)
