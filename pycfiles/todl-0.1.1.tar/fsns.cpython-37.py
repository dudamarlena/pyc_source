...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/attention_ocr/python/datasets/fsns.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 6219 bytes
...
DEFAULT_CONFIG = {'name':'FSNS', 
 'splits':{'train':{'size':1044868, 
   'pattern':'train/train*'}, 
  'test':{'size':20404, 
   'pattern':'test/test*'}, 
  'validation':{'size':16150, 
 ...
 'null_code':133, 
 'items_to_descriptions':{'image':'A [150 x 600 x 3] color image.', 
...
def read_charset(filename, null_character='░'):
...
class _NumOfViewsHandler(slim.tfexample_decoder.ItemHandler):
    __doc__ = 'Convenience handler to determine number of views stored in an image.'
...
def get_split(split_name, dataset_dir=None, config=None):
  ...
  """
    ...
    items_to_handlers = {'image':slim.tfexample_decoder.Image(shape=config['image_shape'],
     ...
     'num_of_views':_NumOfViewsHandler(width_key='image/width',
