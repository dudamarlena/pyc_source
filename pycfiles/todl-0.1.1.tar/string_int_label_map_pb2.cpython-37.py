...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/protos/string_int_label_map_pb2.py
# Compiled at: 2020-04-05 21:21:43
...
DESCRIPTOR = _descriptor.FileDescriptor(name='object_detection/protos/string_int_label_map.proto',
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(name='StringIntLabelMapItem',
 ...
 _descriptor.FieldDescriptor(name='display_name',
  ...
  serialized_start=79,
  serialized_end=150)
_STRINGINTLABELMAP = _descriptor.Descriptor(name='StringIntLabelMap',
...
StringIntLabelMapItem = _reflection.GeneratedProtocolMessageType('StringIntLabelMapItem', (_message.Message,), {'DESCRIPTOR':_STRINGINTLABELMAPITEM, 
 '__module__':'object_detection.protos.string_int_label_map_pb2'})
_sym_db.RegisterMessage(StringIntLabelMapItem)
StringIntLabelMap = _reflection.GeneratedProtocolMessageType('StringIntLabelMap', (_message.Message,), {'DESCRIPTOR':_STRINGINTLABELMAP, 
 '__module__':'object_detection.protos.string_int_label_map_pb2'})
