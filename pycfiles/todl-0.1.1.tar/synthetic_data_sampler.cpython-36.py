...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/data/synthetic_data_sampler.py
...
def sample_contextual_data(num_contexts, dim_context, num_actions, sigma):
  ...
  """
    size_data = [
     num_contexts, dim_context + num_actions]
