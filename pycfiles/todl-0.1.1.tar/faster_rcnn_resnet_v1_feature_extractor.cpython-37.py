...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/faster_rcnn_resnet_v1_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 10397 bytes
...
class FasterRCNNResnetV1FeatureExtractor(faster_rcnn_meta_arch.FasterRCNNFeatureExtractor):
    __doc__ = 'Faster R-CNN Resnet V1 feature extractor implementation.'
    ...
    """
        ...
        with tf.control_dependencies([shape_assert]):
            with slim.arg_scope(resnet_utils.resnet_arg_scope(batch_norm_epsilon=1e-05,
              batch_norm_scale=True,
              activation_fn=(self._activation_fn),
              weight_decay=(self._weight_decay))):
                with tf.variable_scope((self._architecture),
                  reuse=(self._reuse_weights)) as (var_scope):
                    _, activations = self._resnet_model(preprocessed_inputs,
                      num_classes=None,
...
class FasterRCNNResnet50FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
    __doc__ = 'Faster R-CNN Resnet 50 feature extractor implementation.'
...
class FasterRCNNResnet101FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
    __doc__ = 'Faster R-CNN Resnet 101 feature extractor implementation.'
...
class FasterRCNNResnet152FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
    __doc__ = 'Faster R-CNN Resnet 152 feature extractor implementation.'
