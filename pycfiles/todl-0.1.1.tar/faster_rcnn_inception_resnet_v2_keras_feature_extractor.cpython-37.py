...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/faster_rcnn_inception_resnet_v2_keras_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 152133 bytes
...
class FasterRCNNInceptionResnetV2KerasFeatureExtractor(faster_rcnn_meta_arch.FasterRCNNKerasFeatureExtractor):
    ...
    """
        ...
        super(FasterRCNNInceptionResnetV2KerasFeatureExtractor, self).__init__(is_training, first_stage_features_stride, batch_norm_trainable, weight_decay)
    ...
    """
        with tf.name_scope(name):
            with tf.name_scope('InceptionResnetV2'):
                model = inception_resnet_v2.inception_resnet_v2((self._train_batch_norm),
                  output_stride=(self._first_stage_features_stride),
                  align_feature_maps=True,
                  weight_decay=(self._weight_decay),
                  weights=None,
                  include_top=False)
                proposal_features = model.get_layer(name='block17_20_ac').output
        ...
        with tf.name_scope(name):
            with tf.name_scope('InceptionResnetV2'):
                model = inception_resnet_v2.inception_resnet_v2((self._train_batch_norm),
                  ...
                  weights=None,
                  include_top=False)
                proposal_feature_maps = model.get_layer(name='block17_20_ac').output
                proposal_classifier_features = model.get_layer(name='conv_7b_ac').output
                return model_util.extract_submodel(model=model,
    ...
    Returns:
      ...
      the model graph.
    """
        keras_to_slim_name_mapping = {'FirstStageFeatureExtractor/InceptionResnetV2/conv2d/kernel':'InceptionResnetV2/Conv2d_1a_3x3/weights', 
