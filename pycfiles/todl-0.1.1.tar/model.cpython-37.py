...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/todl/model.py
# Compiled at: 2020-04-05 20:30:52
...
class Model:
    ...
    def inference(self, image):
        ...
        detections = self.session.run(tensor_dict,
          feed_dict={image_tensor: np.expand_dims(image, 0)})
        num_detections = int(detections['num_detections'][0])
        detections['num_detections'] = num_detections
        detections['detection_classes'] = detections['detection_classes'][0][0:num_detections].astype(np.uint8)
        detections['detection_boxes'] = detections['detection_boxes'][0][0:num_detections]
        detections['detection_scores'] = detections['detection_scores'][0][0:num_detections]
        if 'detection_masks' in detections:
            detections['detection_masks'] = detections['detection_masks'][0][0:num_detections]
        return detections
