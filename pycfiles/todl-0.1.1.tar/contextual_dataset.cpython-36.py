...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/core/contextual_dataset.py
...
class ContextualDataset(object):
    __doc__ = 'The buffer is able to append new data, and sample random minibatches.'
    ...
    def get_batch(self, batch_size):
        ...
        return (
         self.contexts[ind, :], self.rewards[ind, :])
