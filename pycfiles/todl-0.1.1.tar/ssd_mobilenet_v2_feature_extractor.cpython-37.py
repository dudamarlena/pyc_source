...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_mobilenet_v2_feature_extractor.py
...
class SSDMobileNetV2FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDMobileNetV2FeatureExtractor, self).__init__(is_training=is_training,
