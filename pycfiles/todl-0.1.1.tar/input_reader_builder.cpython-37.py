...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/input_reader_builder.py
...
def build(input_reader_config):
  ...
  """
    ...
    if input_reader_config.WhichOneof('input_reader') == 'tf_record_input_reader':
        ...
        _, string_tensor = parallel_reader.parallel_read((config.input_path[:]),
