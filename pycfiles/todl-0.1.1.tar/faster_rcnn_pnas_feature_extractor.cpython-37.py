...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/faster_rcnn_pnas_feature_extractor.py
...
class FasterRCNNPNASFeatureExtractor(faster_rcnn_meta_arch.FasterRCNNFeatureExtractor):
    __doc__ = 'Faster R-CNN with PNASNet feature extractor implementation.'
            ...
            with arg_scope([slim.conv2d,
             ...
             slim.separable_conv2d],
              reuse=(self._reuse_weights)):
                _, end_points = pnasnet.build_pnasnet_large(preprocessed_inputs,
                 ...
                 nasnet_utils.get_channel_dim],
                  data_format=(hparams.data_format)):
                    ...
                    with slim.arg_scope(pnasnet.pnasnet_large_arg_scope()):
                        net = _build_pnasnet_base(hidden_previous,
                          hidden,
