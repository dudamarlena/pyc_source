...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_resnet_v1_fpn_keras_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 20521 bytes
...
_RESNET_MODEL_OUTPUT_LAYERS = {'resnet_v1_50':[
 ...
 'resnet_v1_152':[
  'conv2_block3_out', 'conv3_block8_out',
  'conv4_block36_out', 'conv5_block3_out']}

class SSDResNetV1FpnKerasFeatureExtractor(ssd_meta_arch.SSDKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using Keras-based ResnetV1 FPN features.'
    ...
    """
        super(SSDResNetV1FpnKerasFeatureExtractor, self).__init__(is_training=is_training,
    ...
    def build(self, input_shape):
        full_resnet_v1_model = self._resnet_v1_base_model(batchnorm_training=(self._is_training and not self._freeze_batchnorm),
          conv_hyperparams=(self._conv_hyperparams if self._override_base_feature_extractor_hyperparams else None),
        ...
        self._fpn_features_generator = feature_map_generators.KerasFpnTopDownFeatureMaps(num_levels=(self._num_levels),
 ...
 [
  3, 3], padding='SAME', 
             strides=2, 
             name=layer_name + '_conv', **self._conv_hyperparams.params()))
            layers.append(self._conv_hyperparams.build_batch_norm(training=(self._is_training and not self._freeze_batchnorm),
...
class SSDResNet50V1FpnKerasFeatureExtractor(SSDResNetV1FpnKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using Keras-based ResnetV1-50 FPN features.'
    ...
    Args:
      ...
      name: a string name scope to assign to the model. If 'None', Keras
        will auto-generate one from the class name.
    """
        super(SSDResNet50V1FpnKerasFeatureExtractor, self).__init__(is_training=is_training,
          depth_multiplier=depth_multiplier,
          min_depth=min_depth,
          pad_to_multiple=pad_to_multiple,
          conv_hyperparams=conv_hyperparams,
...
class SSDResNet101V1FpnKerasFeatureExtractor(SSDResNetV1FpnKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using Keras-based ResnetV1-101 FPN features.'
    ...
    Args:
      ...
      name: a string name scope to assign to the model. If 'None', Keras
        will auto-generate one from the class name.
    """
        super(SSDResNet101V1FpnKerasFeatureExtractor, self).__init__(is_training=is_training,
          depth_multiplier=depth_multiplier,
          min_depth=min_depth,
          pad_to_multiple=pad_to_multiple,
          conv_hyperparams=conv_hyperparams,
...
class SSDResNet152V1FpnKerasFeatureExtractor(SSDResNetV1FpnKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using Keras-based ResnetV1-152 FPN features.'
    ...
    Args:
      ...
      name: a string name scope to assign to the model. If 'None', Keras
        will auto-generate one from the class name.
    """
        super(SSDResNet152V1FpnKerasFeatureExtractor, self).__init__(is_training=is_training,
          depth_multiplier=depth_multiplier,
          min_depth=min_depth,
          pad_to_multiple=pad_to_multiple,
          conv_hyperparams=conv_hyperparams,
