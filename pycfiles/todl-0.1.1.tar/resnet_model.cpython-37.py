...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/official/r1/resnet/resnet_model.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 22845 bytes
...
def fixed_padding(inputs, kernel_size, data_format):
  ...
  """
    ...
    if data_format == 'channels_first':
        padded_inputs = tf.pad(tensor=inputs, paddings=[
         [
          0, 0], [0, 0], [pad_beg, pad_end],
         [
          pad_beg, pad_end]])
    else:
        padded_inputs = tf.pad(tensor=inputs, paddings=[
...
class Model(object):
    __doc__ = 'Base class for building the Resnet Model.'
    ...
    """
        with self._model_variable_scope():
            ...
            if self.first_pool_size:
                inputs = tf.compat.v1.layers.max_pooling2d(inputs=inputs,
