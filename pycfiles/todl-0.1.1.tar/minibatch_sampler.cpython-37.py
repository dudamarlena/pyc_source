...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/core/minibatch_sampler.py
...
class MinibatchSampler(six.with_metaclass(ABCMeta, object)):
    __doc__ = 'Abstract base class for subsampling minibatches.'
