...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_mobilenet_v2_fpn_keras_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 10578 bytes
...
class SSDMobileNetV2FpnKerasFeatureExtractor(ssd_meta_arch.SSDKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using Keras-based MobilenetV2 FPN features.'
    ...
    """
        super(SSDMobileNetV2FpnKerasFeatureExtractor, self).__init__(is_training=is_training,
    ...
    def build(self, input_shape):
        full_mobilenet_v2 = mobilenet_v2.mobilenet_v2(batchnorm_training=(self._is_training and not self._freeze_batchnorm),
        ...
        self._mobilenet_v2 = tf.keras.Model(inputs=(full_mobilenet_v2.inputs),
          outputs=outputs)
        ...
        for i in range(self._base_fpn_max_level + 1, self._fpn_max_level + 1):
            ...
            if self._use_explicit_padding:
                ...
                coarse_feature_layers.append(tf.keras.layers.Lambda(fixed_padding,
                  name='fixed_padding'))
