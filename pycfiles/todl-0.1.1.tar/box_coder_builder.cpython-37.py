...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/box_coder_builder.py
...
def build(box_coder_config):
  ...
  """
    ...
    if box_coder_config.WhichOneof('box_coder_oneof') == 'keypoint_box_coder':
        return keypoint_box_coder.KeypointBoxCoder((box_coder_config.keypoint_box_coder.num_keypoints),
          scale_factors=[
