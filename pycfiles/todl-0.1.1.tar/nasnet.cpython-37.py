...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/slim/nets/nasnet/nasnet.py
# Compiled at: 2020-04-05 19:50:58
# Size of source mod 2**32: 21126 bytes
...
def build_nasnet_cifar(images, num_classes, is_training=True, config=None, current_step=None):
    ...
    if tf.test.is_gpu_available():
        if hparams.data_format == 'NHWC':
            tf.compat.v1.logging.info('A GPU is available on the machine, consider using NCHW data format for increased speed on GPU.')
