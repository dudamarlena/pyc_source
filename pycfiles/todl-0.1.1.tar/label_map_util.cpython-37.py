...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/utils/label_map_util.py
...
def get_label_map_dict(label_map_path_or_proto, use_display_name=False, fill_in_gaps_and_background=False):
  ...
  """
    ...
    if fill_in_gaps_and_background:
        ...
        if not all((isinstance(value, int) for value in values)):
            raise ValueError('The values in label map must be integers in order tofill_in_gaps_and_background.')
