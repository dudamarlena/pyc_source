...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/skip_thoughts/skip_thoughts/configuration.py
...
class _HParams(object):
    __doc__ = 'Wrapper for configuration parameters.'
...
def training_config(learning_rate=0.0008, learning_rate_decay_factor=0.5, learning_rate_decay_steps=400000, number_of_steps=500000, clip_gradient_norm=5.0, save_model_secs=600, save_summaries_secs=600):
  ...
  """
    if learning_rate_decay_factor:
        if not learning_rate_decay_steps:
