...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/lstm_object_detection/models/lstm_ssd_mobilenet_v1_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 9084 bytes
...
class LSTMSSDMobileNetV1FeatureExtractor(lstm_ssd_meta_arch.LSTMSSDFeatureExtractor):
    __doc__ = 'LSTM Feature Extractor using MobilenetV1 features.'
    ...
    """
        super(LSTMSSDMobileNetV1FeatureExtractor, self).__init__(is_training=is_training,
    ...
    Returns:
      ...
      step: the step
    """
        lstm_cell = lstm_cells.BottleneckConvLSTMCell(filter_size=(3, 3),
    ...
    """
            ...
            with slim.arg_scope(self._conv_hyperparams_fn()) if self._override_base_feature_extractor_hyperparams else context_manager.IdentityContextManager():
                with slim.arg_scope([slim.batch_norm], fused=False):
                    with tf.variable_scope(scope,
                      (self._base_network_scope), reuse=(self._reuse_weights)) as (scope):
                        net, image_features = mobilenet_v1.mobilenet_v1_base((ops.pad_to_multiple(preprocessed_inputs, self._pad_to_multiple)),
        ...
        with slim.arg_scope(self._conv_hyperparams_fn()):
            with slim.arg_scope([
             slim.batch_norm],
              fused=False, is_training=(self._is_training)):
                ...
                with tf.variable_scope('LSTM', reuse=(self._reuse_weights)) as (lstm_scope):
                    ...
                    net_seq, states_out = rnn_decoder.rnn_decoder(net_seq,
                      init_state, lstm_cell, scope=lstm_scope)
                    batcher_ops = None
