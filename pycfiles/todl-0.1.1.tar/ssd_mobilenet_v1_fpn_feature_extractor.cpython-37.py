...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_mobilenet_v1_fpn_feature_extractor.py
...
class SSDMobileNetV1FpnFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using MobilenetV1 FPN features.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDMobileNetV1FpnFeatureExtractor, self).__init__(is_training=is_training,
        ...
        with tf.variable_scope('MobilenetV1', reuse=(self._reuse_weights)) as (scope):
            ...
            with slim.arg_scope(self._conv_hyperparams_fn()):
                with tf.variable_scope('fpn', reuse=(self._reuse_weights)):
                    feature_blocks = ['Conv2d_3_pointwise', 'Conv2d_5_pointwise', 'Conv2d_11_pointwise',
                     'Conv2d_13_pointwise']
