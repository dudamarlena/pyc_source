...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_inception_v2_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 5612 bytes
...
class SSDInceptionV2FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using InceptionV2 features.'
    ...
    """
        super(SSDInceptionV2FeatureExtractor, self).__init__(is_training=is_training,
    ...
    """
        ...
        feature_map_layout = {'from_layer':[
          'Mixed_4c', 'Mixed_5c', '', '', '', ''][:self._num_layers], 
         'layer_depth':[
