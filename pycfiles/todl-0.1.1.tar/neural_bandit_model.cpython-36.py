...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/algorithms/neural_bandit_model.py
# Compiled at: 2018-07-23 14:29:50
# Size of source mod 2**32: 7588 bytes
...
class NeuralBanditModel(BayesianNN):
    __doc__ = 'Implements a neural network for bandit problems.'
    ...
    def build_layer(self, x, num_units):
        ...
        nn = tf.contrib.layers.fully_connected(x,
          num_units,
    ...
    """
        ...
        with self.graph.as_default():
            ...
            with tf.name_scope(self.name):
                ...
                self.x = tf.placeholder(shape=[
                 None, self.hparams.context_dim],
                  dtype=(tf.float32),
                ...
                self.weights = tf.placeholder(shape=[
                 None, self.hparams.num_actions],
                  dtype=(tf.float32),
