...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/utils/per_image_vrd_evaluation.py
# Compiled at: 2020-04-05 19:50:58
# Size of source mod 2**32: 10396 bytes
...
class PerImageVRDEvaluation(object):
    __doc__ = 'Evaluate vrd result of a single image.'
    ...
    Returns:
      ...
      result_mapping: A numpy array with shape [N,] with original index of each
          entry.
    """
        scores, tp_fp_labels, result_mapping = self._compute_tp_fp(detected_box_tuples=detected_box_tuples,
        ...
        return (
         scores, tp_fp_labels, result_mapping)
    ...
    """
        ...
        for unique_tuple in unique_gt_tuples:
            ...
            tp_fp_labels = self._compute_tp_fp_for_single_class(detected_box_tuples=(detection_box_per_tuple[sorted_indices]),
        ...
        sorted_indices = sorted_indices[::-1]
        return (
         result_scores[sorted_indices],
         result_tp_fp_labels[sorted_indices], result_mapping[sorted_indices])
        ...
        if min_iou.shape[1] > 0:
            ...
            for i in range(num_detected_tuples):
                ...
                if min_iou[(i, gt_id)] >= self.matching_iou_threshold:
                    tp_fp_labels[i] = is_gt_tuple_detected[gt_id] or True
