...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/deeplab/core/feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 27688 bytes
...
def _mobilenet_v3(net, depth_multiplier, output_stride, conv_defs=None, divisible_by=None, reuse=None, scope=None, final_endpoint=None):
  ...
  """
    del divisible_by
    with tf.variable_scope(scope,
      'MobilenetV3', [net], reuse=reuse) as (scope):
        if conv_defs is None:
        ...
        net, end_points = mobilenet_v3.mobilenet_base(net,
          depth_multiplier=depth_multiplier,
          conv_defs=conv_defs,
          output_stride=output_stride,
...
def mobilenet_edgetpu(net, depth_multiplier, output_stride, divisible_by=None, reuse=None, scope=None, final_endpoint=None):
...
networks_map = {'mobilenet_v2':_mobilenet_v2, 
...
def mobilenet_v2_arg_scope(is_training=True, weight_decay=4e-05, stddev=0.09, activation=tf.nn.relu6, bn_decay=0.997, bn_epsilon=None, bn_renorm=None):
  ...
  """
    ...
    if bn_epsilon is not None:
        ...
        instance_norm_params = {'center':True, 
         'scale':True, 
         'epsilon':0.001}
        if stddev < 0:
      ...
      normalizer_fn=(slim.batch_norm)):
        with slim.arg_scope([
         conv_blocks.expanded_conv],
          normalizer_fn=(slim.batch_norm)):
            with slim.arg_scope([mobilenet.apply_activation], activation_fn=activation):
                with (slim.arg_scope)([slim.batch_norm], **batch_norm_params):
                    with slim.arg_scope([mobilenet.mobilenet_base, mobilenet.mobilenet], is_training=is_training):
                        with (slim.arg_scope)([slim.dropout], **dropout_params):
                            with (slim.arg_scope)([slim.instance_norm], **instance_norm_params):
                                with slim.arg_scope([slim.conv2d], weights_regularizer=(slim.l2_regularizer(weight_decay))):
                                    with slim.arg_scope([slim.separable_conv2d], weights_regularizer=None):
                                        with slim.arg_scope([slim.conv2d, slim.separable_conv2d], padding='SAME') as (s):
                                            return s
...
networks_to_feature_maps = {'mobilenet_v2':{DECODER_END_POINTS: {4:[
                        'layer_4/depthwise_output'], 
                       8:[
                        'layer_7/depthwise_output'], 
                       16:[
                        'layer_14/depthwise_output']}}, 
 'mobilenet_v3_large_seg':{DECODER_END_POINTS: {4:[
                        'layer_4/depthwise_output'], 
                       8:[
                        'layer_7/depthwise_output'], 
                       16:[
                        'layer_13/depthwise_output']}}, 
 'mobilenet_v3_small_seg':{DECODER_END_POINTS: {4:[
                        'layer_2/depthwise_output'], 
                       8:[
                        'layer_4/depthwise_output'], 
                       16:[
                        'layer_9/depthwise_output']}}, 
 'resnet_v1_18':{DECODER_END_POINTS: {4:[
                        'block1/unit_1/lite_bottleneck_v1/conv2'], 
                       8:[
                        'block2/unit_1/lite_bottleneck_v1/conv2'], 
                       16:[
                        'block3/unit_1/lite_bottleneck_v1/conv2']}}, 
 'resnet_v1_18_beta':{DECODER_END_POINTS: {4:[
                        'block1/unit_1/lite_bottleneck_v1/conv2'], 
                       8:[
                        'block2/unit_1/lite_bottleneck_v1/conv2'], 
                       16:[
                        'block3/unit_1/lite_bottleneck_v1/conv2']}}, 
 'resnet_v1_50':{DECODER_END_POINTS: {4:[
                        'block1/unit_2/bottleneck_v1/conv3'], 
                       8:[
                        'block2/unit_3/bottleneck_v1/conv3'], 
                       16:[
                        'block3/unit_5/bottleneck_v1/conv3']}}, 
 'resnet_v1_50_beta':{DECODER_END_POINTS: {4:[
                        'block1/unit_2/bottleneck_v1/conv3'], 
                       8:[
                        'block2/unit_3/bottleneck_v1/conv3'], 
                       16:[
                        'block3/unit_5/bottleneck_v1/conv3']}}, 
 'resnet_v1_101':{DECODER_END_POINTS: {4:[
                        'block1/unit_2/bottleneck_v1/conv3'], 
                       8:[
                        'block2/unit_3/bottleneck_v1/conv3'], 
                       16:[
                        'block3/unit_22/bottleneck_v1/conv3']}}, 
 'resnet_v1_101_beta':{DECODER_END_POINTS: {4:[
                        'block1/unit_2/bottleneck_v1/conv3'], 
                       8:[
                        'block2/unit_3/bottleneck_v1/conv3'], 
                       16:[
                        'block3/unit_22/bottleneck_v1/conv3']}}, 
 'xception_41':{DECODER_END_POINTS: {4:[
                        'entry_flow/block2/unit_1/xception_module/separable_conv2_pointwise'], 
                       8:[
                        'entry_flow/block3/unit_1/xception_module/separable_conv2_pointwise'], 
                       16:[
                        'exit_flow/block1/unit_1/xception_module/separable_conv2_pointwise']}}, 
 'xception_65':{DECODER_END_POINTS: {4:[
                        'entry_flow/block2/unit_1/xception_module/separable_conv2_pointwise'], 
                       8:[
                        'entry_flow/block3/unit_1/xception_module/separable_conv2_pointwise'], 
                       16:[
                        'exit_flow/block1/unit_1/xception_module/separable_conv2_pointwise']}}, 
 'xception_71':{DECODER_END_POINTS: {4:[
                        'entry_flow/block3/unit_1/xception_module/separable_conv2_pointwise'], 
                       8:[
                        'entry_flow/block5/unit_1/xception_module/separable_conv2_pointwise'], 
                       16:[
                        'exit_flow/block1/unit_1/xception_module/separable_conv2_pointwise']}}, 
 'nas_pnasnet':{DECODER_END_POINTS: {4:[
                        'Stem'], 
                       8:[
                        'Cell_3'], 
                       16:[
                        'Cell_7']}}, 
 'nas_hnasnet':{DECODER_END_POINTS: {4:[
                        'Cell_2'], 
                       8:[
                        'Cell_5'], 
                       16:[
                        'Cell_7']}}}
name_scope = {'mobilenet_v2':'MobilenetV2', 
...
def _preprocess_subtract_imagenet_mean(inputs, dtype=tf.float32):
    ...
    mean_rgb_extended = tf.concat([
     mean_rgb, tf.zeros([1, 1, 1, num_channels - 3])],
      axis=3)
...
def _preprocess_zero_mean_unit_range(inputs, dtype=tf.float32):
    ...
    preprocessed_inputs = 0.00784313725490196 * tf.to_float(inputs) - 1.0
    return tf.cast(preprocessed_inputs, dtype=dtype)


_PREPROCESS_FN = {'mobilenet_v2':_preprocess_zero_mean_unit_range, 
...
def extract_features(images, output_stride=8, multi_grid=None, depth_multiplier=1.0, divisible_by=None, final_endpoint=None, model_variant=None, weight_decay=0.0001, reuse=None, is_training=False, fine_tune_batch_norm=False, regularize_depthwise=False, preprocess_images=True, preprocessed_images_dtype=tf.float32, num_classes=None, global_pool=False, nas_architecture_options=None, nas_training_hyper_parameters=None, use_bounded_activation=False):
  ...
  """
    if 'resnet' in model_variant:
        ...
        features, end_points = get_network(model_variant, preprocess_images, preprocessed_images_dtype, arg_scope)(inputs=images,
        ...
        if 'xception' in model_variant:
            ...
            if 'mobilenet' in model_variant or model_variant.startswith('mnas'):
                ...
                if model_variant.startswith('nas'):
                    arg_scope = arg_scopes_map[model_variant](weight_decay=weight_decay,
                      batch_norm_decay=0.9997,
                      batch_norm_epsilon=0.001)
                    features, end_points = get_network(model_variant, preprocess_images, preprocessed_images_dtype, arg_scope)(inputs=images,
