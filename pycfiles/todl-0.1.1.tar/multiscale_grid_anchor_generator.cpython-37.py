...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/anchor_generators/multiscale_grid_anchor_generator.py
...
class MultiscaleGridAnchorGenerator(anchor_generator.AnchorGenerator):
    __doc__ = 'Generate a grid of anchors for multiple CNN layers of different scale.'
    ...
    """
        ...
        for level in range(min_level, max_level + 1):
            ...
            self._anchor_grid_info.append({'level':level, 
             'info':[
              scales, aspects, base_anchor_size, anchor_stride]})
    ...
    """
        ...
        for feat_shape, grid_info in zip(feature_map_shape_list, self._anchor_grid_info):
            ...
            feat_w = feat_shape[1]
            anchor_offset = [0, 0]
            if isinstance(im_height, int):
                if isinstance(im_width, int):
            ...
            ag = grid_anchor_generator.GridAnchorGenerator(scales,
              aspect_ratios,
            ...
            if self._normalize_coordinates:
                ...
                anchor_grid = box_list_ops.to_normalized_coordinates(anchor_grid,
                  im_height, im_width, check_range=False)
