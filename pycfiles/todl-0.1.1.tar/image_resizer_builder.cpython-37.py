...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/image_resizer_builder.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 7156 bytes
...
def _tf_resize_method(resize_method):
  ...
  """
    dict_method = {image_resizer_pb2.BILINEAR: tf.image.ResizeMethod.BILINEAR, 
     
     image_resizer_pb2.NEAREST_NEIGHBOR: tf.image.ResizeMethod.NEAREST_NEIGHBOR, 
     
     image_resizer_pb2.BICUBIC: tf.image.ResizeMethod.BICUBIC, 
     
     image_resizer_pb2.AREA: tf.image.ResizeMethod.AREA}
  ...
  """
    if not isinstance(image_resizer_config, image_resizer_pb2.ImageResizer):
        ...
        if image_resizer_oneof == 'fixed_shape_resizer':
            ...
            image_resizer_fn = functools.partial((preprocessor.resize_image),
            ...
            if image_resizer_oneof == 'identity_resizer':
                ...
                return image_resizer_fn
                if image_resizer_oneof == 'conditional_shape_resizer':
                    ...
                    if conditional_shape_resize_config.condition == image_resizer_pb2.ConditionalShapeResizer.GREATER:
                        image_resizer_fn = functools.partial((preprocessor.resize_to_max_dimension),
                          max_dimension=(conditional_shape_resize_config.size_threshold),
                          method=method)
                    else:
                        if conditional_shape_resize_config.condition == image_resizer_pb2.ConditionalShapeResizer.SMALLER:
                            image_resizer_fn = functools.partial((preprocessor.resize_to_min_dimension),
