...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_resnet_v1_ppn_feature_extractor.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 12444 bytes
...
class _SSDResnetPpnFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    __doc__ = 'SSD feature extractor based on resnet architecture and PPN.'
        ...
        with tf.variable_scope((self._resnet_scope_name),
          reuse=(self._reuse_weights)) as (scope):
                    ...
                    with slim.arg_scope([
                     resnet_v1.bottleneck],
                      use_bounded_activations=(self._use_bounded_activations)):
                        _, activations = self._resnet_base_fn(inputs=(ops.pad_to_multiple(preprocessed_inputs, self._pad_to_multiple)),
                          num_classes=None,
                          is_training=None,
                          global_pool=False,
                          output_stride=None,
            ...
            with slim.arg_scope(self._conv_hyperparams_fn()):
                feature_maps = feature_map_generators.pooling_pyramid_feature_maps(base_feature_map_depth=(self._base_feature_map_depth),
                  num_layers=(self._num_layers),
                  image_features={'image_features': self._filter_features(activations)['block3']})
        return feature_maps.values()


class SSDResnet50V1PpnFeatureExtractor(_SSDResnetPpnFeatureExtractor):
    __doc__ = 'PPN Resnet50 v1 Feature Extractor.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDResnet50V1PpnFeatureExtractor, self).__init__(is_training,
          depth_multiplier, min_depth, pad_to_multiple, conv_hyperparams_fn,
          (resnet_v1.resnet_v1_50), 'resnet_v1_50', reuse_weights,
          use_explicit_padding, use_depthwise, override_base_feature_extractor_hyperparams=override_base_feature_extractor_hyperparams)


class SSDResnet101V1PpnFeatureExtractor(_SSDResnetPpnFeatureExtractor):
    __doc__ = 'PPN Resnet101 v1 Feature Extractor.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDResnet101V1PpnFeatureExtractor, self).__init__(is_training,
          depth_multiplier, min_depth, pad_to_multiple, conv_hyperparams_fn,
          (resnet_v1.resnet_v1_101), 'resnet_v1_101', reuse_weights,
          use_explicit_padding, use_depthwise, override_base_feature_extractor_hyperparams=override_base_feature_extractor_hyperparams)


class SSDResnet152V1PpnFeatureExtractor(_SSDResnetPpnFeatureExtractor):
    __doc__ = 'PPN Resnet152 v1 Feature Extractor.'
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
        super(SSDResnet152V1PpnFeatureExtractor, self).__init__(is_training,
          depth_multiplier, min_depth, pad_to_multiple, conv_hyperparams_fn,
          (resnet_v1.resnet_v1_152), 'resnet_v1_152', reuse_weights,
          use_explicit_padding, use_depthwise, override_base_feature_extractor_hyperparams=override_base_feature_extractor_hyperparams)