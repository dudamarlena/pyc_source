...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/core/anchor_generator.py
...
class AnchorGenerator(six.with_metaclass(ABCMeta, object)):
    __doc__ = 'Abstract base class for anchor generators.'
    ...
    """
        if self.check_num_anchors:
            if len(feature_map_shape_list) != len(self.num_anchors_per_location()):
        ...
        with tf.name_scope(self.name_scope()):
            ...
            if self.check_num_anchors:
                with tf.control_dependencies([
                 self._assert_correct_number_of_anchors(anchors_list, feature_map_shape_list)]):
