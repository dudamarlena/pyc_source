...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/utils/np_box_list_ops.py
# Compiled at: 2020-04-05 19:50:58
# Size of source mod 2**32: 20918 bytes
...
def multi_class_non_max_suppression(boxlist, score_thresh, iou_thresh, max_output_size):
  ...
  """
    ...
    elif not isinstance(boxlist, np_box_list.BoxList):
        raise ValueError('boxlist must be a BoxList')
    elif not boxlist.has_field('scores'):
    ...
    for class_idx in range(num_classes):
        ...
        nms_result = non_max_suppression(boxlist_filt, max_output_size=max_output_size,
...
def concatenate(boxlists, fields=None):
  ...
  """
    ...
    for field in fields:
        ...
        concatenated_field = np.concatenate([boxlist.get_field(field) for boxlist in boxlists],
          axis=0)
...
def change_coordinate_frame(boxlist, window):
  ...
  """
    ...
    boxlist_new = scale(np_box_list.BoxList(boxlist.get() - [
     window[0], window[1], window[0], window[1]]), 1.0 / win_height, 1.0 / win_width)
