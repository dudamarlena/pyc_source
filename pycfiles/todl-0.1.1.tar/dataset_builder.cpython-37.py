...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/dataset_builder.py
    ...
    if input_reader_config.WhichOneof('input_reader') == 'tf_record_input_reader':
        ...
        if not config.input_path:
            ...
            if input_reader_config.HasField('label_map_path'):
                ...
                decoder = tf_example_decoder.TfExampleDecoder(load_instance_masks=(input_reader_config.load_instance_masks),
                ...
                dataset = read_dataset(functools.partial((tf.data.TFRecordDataset), buffer_size=8000000), config.input_path[:], input_reader_config)
