...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/slim/nets/inception_v3.py
    ...
    with tf.compat.v1.variable_scope(scope, 'InceptionV3', [inputs]):
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1,
          padding='SAME'):
            ...
            with tf.compat.v1.variable_scope(end_point):
                with tf.compat.v1.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net, (depth(384)), [3, 3], stride=2, padding='VALID',
                      scope='Conv2d_1a_1x1')
                with tf.compat.v1.variable_scope('Branch_1'):
            ...
            with tf.compat.v1.variable_scope(end_point):
                ...
                with tf.compat.v1.variable_scope('Branch_2'):
                    ...
                    branch_2 = slim.conv2d(branch_2,
                      (depth(384)), [3, 3], scope='Conv2d_0b_3x3')
                ...
                with tf.compat.v1.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3,
                      (depth(192)), [1, 1], scope='Conv2d_0b_1x1')
                net = tf.concat(axis=3, values=[branch_0, branch_1, branch_2, branch_3])
            end_points[end_point] = net
            if end_point == final_endpoint:
                return (
...
def inception_v3(inputs, num_classes=1000, is_training=True, dropout_keep_prob=0.8, min_depth=16, depth_multiplier=1.0, prediction_fn=slim.softmax, spatial_squeeze=True, reuse=None, create_aux_logits=True, scope='InceptionV3', global_pool=False):
  ...
  """
    ...
    with tf.compat.v1.variable_scope(scope,
      'InceptionV3', [inputs], reuse=reuse) as (scope):
                      ...
                      padding='SAME'):
                        ...
                        with tf.compat.v1.variable_scope('AuxLogits'):
                            aux_logits = slim.avg_pool2d(aux_logits,
                              [5, 5], stride=3, padding='VALID', scope='AvgPool_1a_5x5')
                            ...
                            aux_logits = slim.conv2d(aux_logits,
                              (depth(768)), kernel_size, weights_initializer=(trunc_normal(0.01)),
                              padding='VALID',
                              scope=('Conv2d_2a_{}x{}'.format)(*kernel_size))
                            aux_logits = slim.conv2d(aux_logits,
                              num_classes, [1, 1], activation_fn=None, normalizer_fn=None,
