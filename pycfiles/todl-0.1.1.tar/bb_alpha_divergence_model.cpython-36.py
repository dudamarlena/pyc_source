...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/algorithms/bb_alpha_divergence_model.py
# Compiled at: 2018-07-23 14:29:50
# Size of source mod 2**32: 13407 bytes
...
class BBAlphaDivergence(BayesianNN):
    __doc__ = 'Implements an approximate Bayesian NN via Black-Box Alpha-Divergence.'
    ...
    def sample_neural_network(self, activation_fn=tf.nn.relu):
        ...
        with self.graph.as_default():
            ...
            log_likelihood = log_gaussian((self.y),
              output_h, (self.noise_sigma), reduce_sum=False)
    ...
    """
        ...
        self.y_pred = self.build_layer(input_x, [n_in, self.n_out], (self.total_layers - 1),
