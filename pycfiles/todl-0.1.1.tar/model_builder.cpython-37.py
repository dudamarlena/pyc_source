...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/model_builder.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 29126 bytes
...
import object_detection.builders as sim_calc
...
import object_detection.models as frcnn_inc_res
import object_detection.models as frcnn_inc_res_keras
import object_detection.models as frcnn_inc_v2
import object_detection.models as frcnn_nas
import object_detection.models as frcnn_pnas
import object_detection.models as frcnn_resnet_v1
import object_detection.models as ssd_resnet_v1_fpn
import object_detection.models as ssd_resnet_v1_fpn_keras
import object_detection.models as ssd_resnet_v1_ppn
...
SSD_FEATURE_EXTRACTOR_CLASS_MAP = {'ssd_inception_v2':SSDInceptionV2FeatureExtractor, 
 ...
 'ssd_resnet101_v1_ppn':ssd_resnet_v1_ppn.SSDResnet101V1PpnFeatureExtractor, 
 'ssd_resnet152_v1_ppn':ssd_resnet_v1_ppn.SSDResnet152V1PpnFeatureExtractor, 
 'embedded_ssd_mobilenet_v1':EmbeddedSSDMobileNetV1FeatureExtractor, 
 'ssd_pnasnet':SSDPNASNetFeatureExtractor}
SSD_KERAS_FEATURE_EXTRACTOR_CLASS_MAP = {'ssd_mobilenet_v1_keras':SSDMobileNetV1KerasFeatureExtractor, 
 ...
 'ssd_resnet50_v1_fpn_keras':ssd_resnet_v1_fpn_keras.SSDResNet50V1FpnKerasFeatureExtractor, 
 'ssd_resnet101_v1_fpn_keras':ssd_resnet_v1_fpn_keras.SSDResNet101V1FpnKerasFeatureExtractor, 
 'ssd_resnet152_v1_fpn_keras':ssd_resnet_v1_fpn_keras.SSDResNet152V1FpnKerasFeatureExtractor}
FASTER_RCNN_FEATURE_EXTRACTOR_CLASS_MAP = {'faster_rcnn_nas':frcnn_nas.FasterRCNNNASFeatureExtractor, 
 'faster_rcnn_pnas':frcnn_pnas.FasterRCNNPNASFeatureExtractor, 
...
FASTER_RCNN_KERAS_FEATURE_EXTRACTOR_CLASS_MAP = {'faster_rcnn_inception_resnet_v2_keras': frcnn_inc_res_keras.FasterRCNNInceptionResnetV2KerasFeatureExtractor}
...
def _build_ssd_feature_extractor(feature_extractor_config, is_training, freeze_batchnorm, reuse_weights=None):
  ...
  """
    ...
    if feature_type not in SSD_FEATURE_EXTRACTOR_CLASS_MAP:
        if not is_keras_extractor:
            raise ValueError('Unknown ssd feature_extractor: {}'.format(feature_type))
    elif is_keras_extractor:
    ...
    if feature_extractor_config.HasField('replace_preprocessor_with_placeholder'):
        ...
        if is_keras_extractor:
            ...
            kwargs.update({'conv_hyperparams_fn':conv_hyperparams, 
...
def _build_ssd_model(ssd_config, is_training, add_summaries):
  ...
  """
    ...
    if feature_extractor.is_keras_model:
        ssd_box_predictor = box_predictor_builder.build_keras(hyperparams_fn=(hyperparams_builder.KerasLayerHyperparams),
          freeze_batchnorm=(ssd_config.freeze_batchnorm),
          inplace_batchnorm_update=False,
    ...
    equalization_loss_config = ops.EqualizationLossConfig(weight=(ssd_config.loss.equalization_loss.weight),
    ...
    return ssd_meta_arch_fn(is_training=is_training, 
     ...
     return_raw_detections_during_predict=ssd_config.return_raw_detections_during_predict, **kwargs)
...
def _build_faster_rcnn_model(frcnn_config, is_training, add_summaries):
  ...
  """
    ...
    if is_keras:
        feature_extractor = _build_faster_rcnn_keras_feature_extractor((frcnn_config.feature_extractor),
          is_training, inplace_batchnorm_update=(frcnn_config.inplace_batchnorm_update))
    else:
        feature_extractor = _build_faster_rcnn_feature_extractor((frcnn_config.feature_extractor),
          is_training, inplace_batchnorm_update=(frcnn_config.inplace_batchnorm_update))
    ...
    first_stage_sampler = sampler.BalancedPositiveNegativeSampler(positive_fraction=(frcnn_config.first_stage_positive_balance_fraction),
      is_static=(frcnn_config.use_static_balanced_label_sampler and use_static_shapes))
    first_stage_max_proposals = frcnn_config.first_stage_max_proposals
    if frcnn_config.first_stage_nms_iou_threshold < 0 or frcnn_config.first_stage_nms_iou_threshold > 1.0:
        raise ValueError('iou_threshold not in [0, 1.0].')
    if is_training:
        if frcnn_config.second_stage_batch_size > first_stage_max_proposals:
        ...
        if is_keras:
            ...
            second_stage_box_predictor = box_predictor_builder.build((hyperparams_builder.build),
              (frcnn_config.second_stage_box_predictor),
              is_training=is_training,
              num_classes=num_classes)
    second_stage_batch_size = frcnn_config.second_stage_batch_size
    second_stage_sampler = sampler.BalancedPositiveNegativeSampler(positive_fraction=(frcnn_config.second_stage_balance_fraction),
      is_static=(frcnn_config.use_static_balanced_label_sampler and use_static_shapes))
    ...
    common_kwargs = {'is_training':is_training, 
     ...
     'return_raw_detections_during_predict':frcnn_config.return_raw_detections_during_predict}
    ...
    return (faster_rcnn_meta_arch.FasterRCNNMetaArch)(initial_crop_size=initial_crop_size, 
     maxpool_kernel_size=maxpool_kernel_size, 
     maxpool_stride=maxpool_stride, 
     second_stage_mask_rcnn_box_predictor=second_stage_box_predictor, 
     second_stage_mask_prediction_loss_weight=second_stage_mask_prediction_loss_weight, **common_kwargs)
...
META_ARCHITECURE_BUILDER_MAP = {'ssd':_build_ssd_model, 
