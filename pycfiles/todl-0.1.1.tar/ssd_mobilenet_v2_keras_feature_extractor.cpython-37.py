...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/models/ssd_mobilenet_v2_keras_feature_extractor.py
...
class SSDMobileNetV2KerasFeatureExtractor(ssd_meta_arch.SSDKerasFeatureExtractor):
    __doc__ = 'SSD Feature Extractor using MobilenetV2 features.'
    ...
    """
        super(SSDMobileNetV2KerasFeatureExtractor, self).__init__(is_training=is_training,
        ...
        self._feature_map_layout = {'from_layer':[
          'layer_15/expansion_output', 'layer_19', '', '', '', ''][:self._num_layers], 
         'layer_depth':[
    ...
    def build(self, input_shape):
        ...
        self.mobilenet_v2 = tf.keras.Model(inputs=(full_mobilenet_v2.inputs),
          outputs=[
         conv2d_11_pointwise, conv2d_13_pointwise])
        self.feature_map_generator = feature_map_generators.KerasMultiResolutionFeatureMaps(feature_map_layout=(self._feature_map_layout),
    ...
    """
        ...
        feature_maps = self.feature_map_generator({'layer_15/expansion_output':image_features[0], 
