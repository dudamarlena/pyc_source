...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/utils/metrics.py
...
def compute_average_precision(precision, recall):
  ...
  """
    if precision is None:
        ...
        return np.NAN
        if not (isinstance(precision, np.ndarray) and isinstance(recall, np.ndarray)):
