...
# [GCC 8.4.0]
# Embedded file name: /usr/local/google/home/rikel/bandits_repo/deep-bayesian-contextual-bandits/research/bandits/algorithms/posterior_bnn_sampling.py
...
class PosteriorBNNSampling(BanditAlgorithm):
    __doc__ = 'Posterior Sampling algorithm based on a Bayesian neural network.'
    ...
    """
        ...
        if bnn_model == 'Variational':
            ...
            if bnn_model == 'AlphaDiv':
                self.bnn = BBAlphaDivergence(hparams, bnn_name)
            else:
                if bnn_model == 'Variational_BF':
