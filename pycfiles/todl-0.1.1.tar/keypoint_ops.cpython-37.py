...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/core/keypoint_ops.py
# Compiled at: 2020-04-05 19:50:57
# Size of source mod 2**32: 11240 bytes
"""Keypoint operations.
    ...
    with tf.name_scope(scope, 'ToAbsoluteCoordinates'):
        ...
        if check_range:
            ...
            max_assert = tf.Assert(tf.greater_equal(1.01, max_val), [
             'maximum keypoint coordinate value is larger than 1.01: ',
             max_val])
            with tf.control_dependencies([max_assert]):
                width = tf.identity(width)
