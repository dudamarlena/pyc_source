...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/slim/nets/inception_v2.py
          ...
          data_format=data_format):
            ...
            if include_root_block:
                ...
                if use_separable_conv:
                    ...
                    net = slim.separable_conv2d(inputs,
                      (depth(64)),
                      [7, 7], depth_multiplier=depthwise_multiplier,
                      stride=2,
                      padding='SAME',
            ...
            with tf.compat.v1.variable_scope(end_point):
                ...
                with tf.compat.v1.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net,
                      (depth(64)), [1, 1], weights_initializer=(trunc_normal(0.09)),
                      scope='Conv2d_0a_1x1')
                ...
                with tf.compat.v1.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3,
                      (depth(32)), [1, 1], weights_initializer=(trunc_normal(0.1)),
                      scope='Conv2d_0b_1x1')
                net = tf.concat(axis=concat_dim,
            ...
            with tf.compat.v1.variable_scope(end_point):
                ...
                with tf.compat.v1.variable_scope('Branch_3'):
                    branch_3 = slim.avg_pool2d(net, [3, 3], scope='AvgPool_0a_3x3')
                    branch_3 = slim.conv2d(branch_3,
                      (depth(64)), [1, 1], weights_initializer=(trunc_normal(0.1)),
                      scope='Conv2d_0b_1x1')
                net = tf.concat(axis=concat_dim,
                  values=[branch_0, branch_1, branch_2, branch_3])
                end_points[end_point] = net
            ...
            with tf.compat.v1.variable_scope(end_point):
                ...
                with tf.compat.v1.variable_scope('Branch_1'):
                    ...
                    branch_1 = slim.conv2d(branch_1,
                      (depth(96)), [3, 3], scope='Conv2d_0b_3x3')
                    branch_1 = slim.conv2d(branch_1,
                      (depth(96)), [3, 3], stride=2, scope='Conv2d_1a_3x3')
                with tf.compat.v1.variable_scope('Branch_2'):
                    branch_2 = slim.max_pool2d(net,
                      [3, 3], stride=2, scope='MaxPool_1a_3x3')
            ...
            with tf.compat.v1.variable_scope(end_point):
                ...
                with tf.compat.v1.variable_scope('Branch_2'):
                    branch_2 = slim.conv2d(net,
                      (depth(96)), [1, 1], weights_initializer=(trunc_normal(0.09)),
                      scope='Conv2d_0a_1x1')
            ...
            with tf.compat.v1.variable_scope(end_point):
                ...
                with tf.compat.v1.variable_scope('Branch_3'):
                    branch_3 = slim.avg_pool2d(net, [3, 3], scope='AvgPool_0a_3x3')
                    branch_3 = slim.conv2d(branch_3,
                      (depth(96)), [1, 1], weights_initializer=(trunc_normal(0.1)),
                      scope='Conv2d_0b_1x1')
                net = tf.concat(axis=concat_dim,
                  values=[branch_0, branch_1, branch_2, branch_3])
                end_points[end_point] = net
...
def inception_v2(inputs, num_classes=1000, is_training=True, dropout_keep_prob=0.8, min_depth=16, depth_multiplier=1.0, prediction_fn=slim.softmax, spatial_squeeze=True, reuse=None, scope='InceptionV2', global_pool=False):
  ...
  """
    ...
    with tf.compat.v1.variable_scope(scope,
      'InceptionV2', [inputs], reuse=reuse) as (scope):
        with slim.arg_scope([slim.batch_norm, slim.dropout], is_training=is_training):
            net, end_points = inception_v2_base(inputs,
              scope=scope, min_depth=min_depth, depth_multiplier=depth_multiplier)
