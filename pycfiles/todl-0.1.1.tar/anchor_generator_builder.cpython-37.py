...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/builders/anchor_generator_builder.py
...
def build(anchor_generator_config):
  ...
  """
    ...
    if anchor_generator_config.WhichOneof('anchor_generator_oneof') == 'grid_anchor_generator':
        ...
        return grid_anchor_generator.GridAnchorGenerator(scales=[float(scale) for scale in grid_anchor_generator_config.scales],
    ...
    if anchor_generator_config.WhichOneof('anchor_generator_oneof') == 'ssd_anchor_generator':
        ...
        return multiple_grid_anchor_generator.create_ssd_anchors(num_layers=(ssd_anchor_generator_config.num_layers),
    ...
    if anchor_generator_config.WhichOneof('anchor_generator_oneof') == 'flexible_grid_anchor_generator':
