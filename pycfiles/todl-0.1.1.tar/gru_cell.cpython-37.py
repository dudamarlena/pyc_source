...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/skip_thoughts/skip_thoughts/ops/gru_cell.py
        ...
        with tf.variable_scope(scope or 'gru_cell'):
            with tf.variable_scope('gates'):
                w_h = tf.get_variable('w_h',
                  [num_units, 2 * num_units], initializer=(self._w_h_initializer()))
                w_x = tf.get_variable('w_x',
                  [input_dim, 2 * num_units], initializer=(self._w_x_initializer(input_dim)))
            ...
            with tf.variable_scope('candidate'):
                w = tf.get_variable('w',
                  [input_dim, num_units], initializer=(self._w_initializer))
                u = tf.get_variable('u',
                  [num_units, num_units], initializer=(self._u_initializer))
