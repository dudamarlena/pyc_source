...
# [GCC 8.4.0]
# Embedded file name: /Users/svpino/dev/tensorflow-object-detection-sagemaker/todl/tensorflow-object-detection/research/object_detection/tpu_exporters/export_saved_model_tpu_lib.py
...
model_map = {'faster_rcnn':faster_rcnn, 
 'ssd':ssd}
        ...
        with tf.Session() as (sess):
            ...
            for _ in range(repeat):
                tensor_dict_out = sess.run(result_tensor_dict,
                  feed_dict={placeholder_tensor: [inputs]})
