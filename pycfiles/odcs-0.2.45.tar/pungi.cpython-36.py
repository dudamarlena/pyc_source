...
# Size of source mod 2**32: 14256 bytes
import os, shutil, tempfile, jinja2, koji, munch, time, random, string, odcs.server.utils
...
class PungiConfig(object):
    ...
    def __init__(self, release_name, release_version, source_type, source, packages=None, arches=None, sigkeys=None, results=0):
...
class Pungi(object):
    ...
    def run_locally(self):
        ...
        try:
            ...
            odcs.server.utils.execute_cmd(pungi_cmd, cwd=td, timeout=(conf.pungi_timeout))
        finally:
            try:
                if td is not None:
                    shutil.rmtree(td)
