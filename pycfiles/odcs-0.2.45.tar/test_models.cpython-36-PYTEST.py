...
class TestModels(ModelsBaseTest):
    ...
    def test_creating_event_and_builds(self):
        ...
        expected_json = {'source_type':2, 
         'state':0,  'time_done':None,  'state_name':'wait', 
         'state_reason':None, 
...
class ComposeModel(ModelsBaseTest):
    ...
    def setUp(self):
        ...
        self.c2 = Compose.create((db.session),
          'me', (PungiSourceType.KOJI_TAG), 'f26', (COMPOSE_RESULTS['repository']),
          60, packages='pkg1')
        self.c3 = Compose.create((db.session),
          'me', (PungiSourceType.KOJI_TAG), 'f26', (COMPOSE_RESULTS['repository']),
          60, packages='pkg1')
        self.c4 = Compose.create((db.session),
          'me', (PungiSourceType.KOJI_TAG), 'f26', (COMPOSE_RESULTS['repository']),
          60, packages='pkg1')
