...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/scales/scale_x_continuous.py
...
class scale_x_continuous(scale):
    ...
    Examples
    --------
    >>> print ggplot(mtcars, aes('mpg', 'qsec')) +     ...     geom_point() +     ...     scale_x_continuous(breaks=[10,20,30],      ...     labels=["horrible", "ok", "awesome"])
