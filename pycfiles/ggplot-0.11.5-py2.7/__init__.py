...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/__init__.py
# Compiled at: 2016-09-29 12:56:32
from __future__ import absolute_import, division, print_function, unicode_literals
__version__ = b'0.11.5'

def _set_mpl_backend():
    import os, matplotlib as mpl
    env_backend = os.environ.get(b'MATPLOTLIB_BACKEND')
    if env_backend:
        mpl.use(env_backend)
