...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/geoms/geom_boxplot.py
    ...
    def plot(self, ax, data, _aes, x_levels):
        ...
        for i, xvalue in enumerate(x_levels):
            ...
            if self.params.get('box', True) == True:
                params = {'facecolor': 'white', 'edgecolor': 'black', 
                   'linewidth': 1}
                ax.add_patch(patches.Rectangle((
                 i - 0.25, bounds_25_75[0]), 0.5, (bounds_25_75[1] - bounds_25_75[0]), **params))
            else:
