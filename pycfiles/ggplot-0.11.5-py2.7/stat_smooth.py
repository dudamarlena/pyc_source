...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/stats/stat_smooth.py
# Compiled at: 2016-07-31 15:23:51
...
class stat_smooth(geom):
    ...
    DEFAULT_PARAMS = {'geom': 'smooth', 'position': 'identity', 'method': 'auto', 'se': True, 
       'n': 80, 'fullrange': False, 'level': 0.95, 'span': 2 / 3.0, 
       'window': None}
    REQUIRED_AES = {'x', 'y'}
    ...
    def plot(self, ax, data, _aes):
        ...
        span = self.params.get('span', 2 / 3.0)
        if method == 'lm':
