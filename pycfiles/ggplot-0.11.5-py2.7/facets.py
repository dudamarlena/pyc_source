...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/facets.py
# Compiled at: 2016-08-17 15:55:34
from __future__ import absolute_import, division, print_function, unicode_literals
import math, pprint as pp
...
class Facet(object):
    ...
    def calculate_ndimensions(self, data, rowvar, colvar):
        ...
        raise Exception(b'No row or column specified to facet on!')
...
class facet_wrap(object):
    ...
    def __radd__(self, gg):
        if gg.__class__.__name__ == b'ggplot':
