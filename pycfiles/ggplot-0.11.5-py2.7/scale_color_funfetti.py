...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/scales/scale_color_funfetti.py
    ...
    def __radd__(self, gg):
        color_maps = {b'confetti': [
           ...
           b'sprinkles': [
                        ...
                        b'#F9AA50',
                        b'#EDE5D9']}
        gg.manual_color_list = color_maps.get(self.type, color_maps[b'sprinkles'])
        return gg