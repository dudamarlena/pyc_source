...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/ggplot/colors/palettes.py
...
def hls_palette(n_colors=6, h=0.041666666666666664, l=0.65, s=0.9):
...
def husl_palette(n_colors=6, h=0.041666666666666664, s=0.9, l=0.65):
