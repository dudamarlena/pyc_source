...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\astrolib\coords\position.py
# Compiled at: 2014-01-13 11:58:06
import types, math, numpy as N, angsep, astrodate, pytpm, pytpm_wrapper
...
class Position(object):
    ...
    def __init__(self, input, equinox='J2000', system='celestial', units='degrees'):
        """
        Parameters
        ----------
...
class Hmsdms(Coord):
    ...
    def _calcinternal(self):
        ...
        """
        a1 = 15 * self.a1[0] + 15 * self.a1[1] / 60.0 + 15 * self.a1[2] / 3600.0
        a2 = abs(self.a2[0]) + abs(self.a2[1]) / 60.0 + abs(self.a2[2]) / 3600.0
        if self.a2sign == '-':
            a2 = a2 * -1
        return (
         a1, a2)
