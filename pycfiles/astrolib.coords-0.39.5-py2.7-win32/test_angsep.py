...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\astrolib\coords\tests\test_angsep.py
# Compiled at: 2014-01-13 11:58:06
import astrolib.coords.angsep as angsep, math, nose.tools
...
def test_approx_sep():
    ...
    assert not s1.approx(s2, 1e-05), 'approx sep failed'
