...
# Embedded file name: /home/sejo/workspace/pyatomiadns/venv/lib/python2.7/site-packages/pyatomiadns/client.py
# Compiled at: 2014-02-17 14:29:36
import json, urllib2
...
:param activated: `str` yes or no
        """
        arguments = [
         algorithm, keysize, keytype, activated]
        data = json.dumps(arguments)
...
:param nameservergroup: `str` the nameserver group that should host the zone 
        """
        arguments = [
         zonename, zonettl, mname, rname, refresh, retry, expire, minimum, nameservers, nameservergroup]
        data = json.dumps(arguments)
