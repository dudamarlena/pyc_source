...
# Embedded file name: /Users/mardochee.macxis/Projects/Python/portfoliopy/portfolio/__init__.py
# Compiled at: 2015-06-21 04:03:23
__doc__ = '\nPortfolio\n\n'
import os, datetime, inspect, utils
from werkzeug.contrib.fixers import ProxyFix
from flask import Flask, render_template, flash
from flask_classy import FlaskView, route
from flask_assets import Environment
import jinja2, warnings, pkginfo
NAME = pkginfo.NAME
...
class Portfolio(FlaskView):
    ...
    _template_paths = set()
    _static_paths = set()
    _context = dict(PORTFOLIO_NAME=NAME, PORTFOLIO_VERSION=__version__, APP_NAME='', APP_VERSION='', YEAR=datetime.datetime.now().year, GOOGLE_ANALYTICS_ID=None, LOGIN_ENABLED=False, LOGIN_OAUTH_ENABLED=False, LOGIN_OAUTH_CLIENT_IDS=[], LOGIN_OAUTH_BUTTONS=[], META_DATA=dict(title='', description='', url='', image='', site_name='', object_type='', locale='', keywords=[], use_opengraph=True, use_googleplus=True, use_twitter=True))
    ...
    @classmethod
    def register_component_template_static(cls, root_pkg=None, template='templates', static='static'):
        """
