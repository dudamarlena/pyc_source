...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\django_nav\templatetags\nav.py
# Compiled at: 2010-05-05 10:09:14
import re
...
class GetNavNode(template.Node):
    ...
    def check_conditional(self, of):
        ...
        return conditional and not conditional(self.context, *of.conditional['args'], **of.conditional['kwargs'])
...
def get_nav(parser, token):
    ...
    args = {'nav_group': next_bit_for(bits, 'get_nav'), 
