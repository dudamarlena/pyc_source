...
# [GCC 8.4.0]
# Embedded file name: /home/anders/work/python/django-likertblock/likertblock/views.py
...
class AddQuestionToQuestionnaireView(View):
    ...
    def post(self, request, pk):
        ...
        if form.is_valid():
            ...
            question.save()
        return HttpResponseRedirect(reverse('edit-questionnaire', args=[questionnaire.id]))
...
class EditQuestionView(View):
    ...
    def get(self, request, pk):
        return render(request, self.template_name, dict(question=self.get_object(pk)))
    ...
    def post(self, request, pk):
        ...
        question = form.save(commit=False)
        question.save()
        return HttpResponseRedirect(reverse('likert-edit-question', args=[
         question.id]))