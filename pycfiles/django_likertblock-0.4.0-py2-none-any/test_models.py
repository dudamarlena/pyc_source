...
# [GCC 8.4.0]
# Embedded file name: /home/anders/work/python/django-likertblock/likertblock/tests/test_models.py
# Compiled at: 2015-07-15 14:38:57
from django.test import TestCase
from django.contrib.auth.models import User
from likertblock.models import Questionnaire, Question, Submission, Response
...
class ResponseTest(TestCase):
    ...
    def test_likert_scale_label(self):
        ...
        u = User.objects.create(username='foo')
        s = Submission.objects.create(user=u, questionnaire=qn)
        r = Response.objects.create(submission=s, question=q, value=0)
