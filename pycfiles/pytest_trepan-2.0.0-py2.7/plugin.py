...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pytest_trepan/plugin.py
# Compiled at: 2018-07-28 13:13:43
...
def pytest_addoption(parser):
    ...
    group._addoption('--trepan', action='store_true', dest='usetrepan', default=False, help='start the trepan Python debugger on errors.')
