...
class Debugger:
    ...
    DEFAULT_INIT_OPTS = {'ignore_filter': tracefilter.TraceFilter([tracer.start, tracer.stop, run_eval, run_call, run_eval, run_script]), 'orig_sys_argv': None, 'save_sys_argv': True, 'activate': False, 'interface': None, 'input': None, 'output': None, 'processor': None, 'settings': Mdefault.DEBUGGER_SETTINGS, 'start_opts': Mdefault.START_OPTS, 'step_ignore': 0, 'from_ipython': False}
