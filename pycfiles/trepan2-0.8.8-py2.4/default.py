...
DEBUGGER_SETTINGS = {'annotate': 0, 'autoeval': True, 'autolist': False, 'autoipython': False, 'autopython': False, 'basename': False, 'cmdtrace': False, 'confirm': True, 'debugmacro': False, 'dbg_trepan': False, 'different': True, 'events': tracer.ALL_EVENTS, 'highlight': is_dark_background(), 'hist_save': True, 'fntrace': False, 'listsize': 10, 'maxargstrsize': 100, 'maxstring': 150, 'printset': tracer.ALL_EVENTS, 'nostartup': False, 'reload': False, 'skip': True, 'trace': False, 'width': width}
CLIENT_SOCKET_OPTS = {'HOST': '127.0.0.1', 'PORT': 1027}
SERVER_SOCKET_OPTS = {'HOST': None, 'PORT': 1027, 'reuse': 'posix' == os.name, 'skew': 0, 'search_limit': 100}
START_OPTS = {'add_hook_opts': tracer.DEFAULT_ADD_HOOK_OPTS, 'backlevel': 0, 'event_set': tracer.ALL_EVENTS, 'force': False, 'start': False}
