...
# [GCC 8.4.0]
# Embedded file name: /home/vivek/Projects/djingles/src/djingles/pagination.py
# Compiled at: 2020-02-09 13:22:06
...
class Page(DjangoPage):
    ...
    def build_links(self, request):
        for i in utils.page_number_range(self.number, self.paginator.page_limit, self.paginator.num_pages):
