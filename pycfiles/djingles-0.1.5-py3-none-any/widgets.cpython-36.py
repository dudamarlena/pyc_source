...
# [GCC 8.4.0]
# Embedded file name: /home/vivek/Projects/djingles/src/djingles/forms/widgets.py
# Compiled at: 2019-08-23 13:01:39
...
class AbstractThemedWidget(object):
    ...
    def __mutate(cls, field):
        subclasses = cls._AbstractThemedWidget__cached_subclasses()
        ...
        if hasattr(widget, 'render_field'):
            ...
            if name in subclasses:
                ...
                widget = child._AbstractThemedWidget__consume(field)
            return widget
    ...
    def widget_to_html(cls, field, **kwargs):
        widget = cls._AbstractThemedWidget__mutate(field)
