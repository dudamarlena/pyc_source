...
# [GCC 8.4.0]
# Embedded file name: /home/vivek/Projects/djingles/src/djingles/exceptions.py
# Compiled at: 2020-02-09 13:21:33
...
__all__ = [
 'PermissionRequired', 'LoginRequired', 'PageExpired']
...
class CommonHttpError(Exception):
    ...
    def to_json(self):
        ...
        return {'message':messages.get(class_name, self.description), 
         'type':class_name}
