...
# [GCC 8.4.0]
# Embedded file name: /home/vivek/Projects/djingles/src/djingles/formatters/models.py
# Compiled at: 2020-02-09 13:23:36
...
class MetaFormattedModel(MetaFormattedObject):
    ...
    def __init__(cls, name, bases, attrs):
        ...
        try:
            ...
            model = meta.model
            base_formatters = []
            for name, formatter in get_formatters_for_model(cls, model, fields=(getattr(meta, 'fields', None)), exclude=(getattr(meta, 'exclude', None)),
              options=meta):
