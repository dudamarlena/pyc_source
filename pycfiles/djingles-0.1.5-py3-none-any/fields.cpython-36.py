...
# [GCC 8.4.0]
# Embedded file name: /home/vivek/Projects/djingles/src/djingles/forms/fields.py
# Compiled at: 2020-02-09 13:24:47
...
__all__ = [
 'FileOrUrlInput', 'HeightField', 'HeightWidget', 'SortField', 'TableSortField']
...
class TableSortField(SortField):
    ...
    def bind_form(self, form):
        ...
        choices = [(name, col.label or name.title()) for name, col in column_dict.items() if col.sortable]
