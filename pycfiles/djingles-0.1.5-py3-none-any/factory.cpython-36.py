...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/djingles/src/djingles/pretenses/factory.py
# Compiled at: 2018-04-21 17:31:40
...
class DefaultProcessor(object):
    ...
    def process_positive_integer_field(self, field):
        return streams.IntegerStream(end=16777216).next(field)

    def process_small_integer_field(self, field):
        return streams.IntegerStream(end=64).next(field)

    def process_big_integer_field(self, field):
        return streams.IntegerStream(end=48).next(field)
