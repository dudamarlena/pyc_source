...
# [GCC 8.4.0]
# Embedded file name: signaturesimulator/sense/soil.py
...
class Soil(object):
    ...
    def _check(self):
        if self.acl is not None:
            ...
            if not self.s is not None:
                raise AssertionError
                assert self.eps is None and self.mv is not None, 'Either EPS or MV need to be given!'
            assert self.mv is None and self.eps is not None, 'Either EPS or MV need to be given!'
        return