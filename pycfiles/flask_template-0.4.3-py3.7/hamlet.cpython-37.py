...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/flask_template/templates/mongo/proj/hamlet.py
# Compiled at: 2020-04-01 02:43:02
# Size of source mod 2**32: 9264 bytes
import datetime, logging, time, urllib.parse, jwt, requests
...
class HamletClient(object):
    ...
    def _get(self, url, params=None, *args, **kwargs):
        return (self._request)('GET', url, *args, params=params, **kwargs)

    def _post(self, url, data=None, *args, **kwargs):
        return (self._request)('POST', url, *args, data=data, **kwargs)

    def _put(self, url, data=None, *args, **kwargs):
        return (self._request)('PUT', url, *args, data=data, **kwargs)
    ...
    def create_user(self, username, password, email=None, role=None, operator_id=None):
        ...
        :return:
        """
        return self._post('/api/users', data={'username':username, 
         'password':password, 
         'email':email, 
         'role':role, 
    ...
    def apply_bind_user(self, email, role=None, operator_id=None):
        ...
        :return: <User>
        """
        return self._post('/auth/bind/apply', data={'app_key':self.app_key, 
         'email':email, 
         'role':role, 
         'operator_id':operator_id})
    ...
    def login(self, username, password):
        params = {'username':username, 
         'password':password,  'app_key':self.app_key}
