...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/i18n/property.py
...
class I18nTextProperty(I18nProperty):
    ...
    def __init__(self, field, name=None, converters=(), value_converters=()):
        super(I18nTextProperty, self).__init__(field, name, converters=converters, value_converters=(
         uninvl,) + value_converters)
