...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/i18n/schema.py
# Compiled at: 2014-05-12 04:24:12
from zope.schema.interfaces import RequiredMissing, IChoice
from ztfy.i18n.interfaces import IDefaultValueDict, II18nField, II18nTextLineField, II18nTextField, II18nHTMLField, II18nFileField, II18nImageField, II18nCthumbImageField
...
class I18nTextLine(I18nField):
    ...
    def __init__(self, key_type=None, value_type=None, value_constraint=None, value_min_length=0, value_max_length=None, **kw):
        super(I18nTextLine, self).__init__(value_type=TextLine(constraint=value_constraint, min_length=value_min_length, max_length=value_max_length, required=False), **kw)
...
class I18nText(I18nField):
    ...
    def __init__(self, key_type=None, value_type=None, value_constraint=None, value_min_length=0, value_max_length=None, **kw):
        super(I18nText, self).__init__(value_type=Text(constraint=value_constraint, min_length=value_min_length, max_length=value_max_length, required=False), **kw)
...
class I18nFile(I18nField):
    ...
    def __init__(self, key_type=None, value_type=None, value_constraint=None, value_min_length=0, value_max_length=None, **kw):
        super(I18nFile, self).__init__(value_type=FileField(constraint=value_constraint, min_length=value_min_length, max_length=value_max_length, required=False), **kw)
...
class I18nImage(I18nFile):
    ...
    def __init__(self, key_type=None, value_type=None, value_constraint=None, value_min_length=0, value_max_length=None, **kw):
        super(I18nFile, self).__init__(value_type=ImageField(constraint=value_constraint, min_length=value_min_length, max_length=value_max_length, required=False), **kw)
...
class I18nCthumbImage(I18nImage):
    ...
    def __init__(self, key_type=None, value_type=None, value_constraint=None, value_min_length=0, value_max_length=None, **kw):
        super(I18nFile, self).__init__(value_type=CthumbImageField(constraint=value_constraint, min_length=value_min_length, max_length=value_max_length, required=False), **kw)