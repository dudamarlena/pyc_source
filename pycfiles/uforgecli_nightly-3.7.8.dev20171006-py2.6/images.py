...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uforgecli/commands/images/images.py
# Compiled at: 2017-10-05 11:13:04
    ...
    def do_list(self, args):
        try:
            ...
            for image in imagesListSorted:
                ...
                os = ' - '
                if 'appliances' in image.applianceUri:
                    for app in appliancesList:
                        if image.applianceUri == app.uri:
                            os = app.distributionName + '  ' + app.archName
                            break

                else:
                    for si in scannedInstancesList:
                        if image.applianceUri.find(si.uri) == 0:
    ...
    def do_info(self, args):
        try:
            ...
            if infoImage is None:
                ...
                compressed = infoImage.compress or 'No'
            else:
                compressed = 'Yes'
