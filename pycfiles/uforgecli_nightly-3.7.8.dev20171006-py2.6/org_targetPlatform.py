...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uforgecli/commands/org/org_targetPlatform.py
...
class Org_TargetPlatform_Cmd(Cmd, CoreGlobal):
    ...
    def arg_create(self):
        ...
        mandatory.add_argument('--type', dest='type', type=str, required=True, help='Type of the target platform to create in the organization (aws, azure, ews, google, abiquo, cloudcom, flexiant, nimbula, openstack, vclouddirector, vsphere).')
    ...
    def arg_update(self):
        ...
        optional.add_argument('--type', dest='type', type=str, required=False, help='(New Type of the target platform to update in the organization (aws, azure, ews, google, abiquo, cloudcom, flexiant, nimbula, openstack, vclouddirector, vsphere).')
