...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uforgecli/commands/template/template.py
...
class Template_Cmd(Cmd, CoreGlobal):
    ...
    def do_list(self, args):
        try:
            ...
            table = init_texttable(['Id', 'Name', 'Version', 'OS', 'Created', 'Last Modified', '# Imgs', 'Updates', 'Imp', 'Shd'], 200, [
             'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l'], [
             't', 'a', 't', 'a', 'a', 'a', 'a', 'a', 'a', 'a'])
        ...
        try:
            ...
            if not doArgs:
                ...
                if userAppliance.oasPackageUri is None:
                    ...
                    Oas.uploaded or table.add_row(['OAS Pkg Uploaded', 'no'])
            else:
    ...
    def do_images(self, args):
        try:
            ...
            table = init_texttable(['Id', 'Name', 'Version', 'Rev', 'OS', 'Format', 'Created', 'Size', 'Compressed', 'Status'], 200, [
             'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l'], [
             't', 'a', 't', 'a', 'a', 'a', 'a', 'a', 'a', 'a'])
