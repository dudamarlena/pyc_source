...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uforgecli/commands/org/org_os.py
...
class Org_Os_Cmd(Cmd, CoreGlobal):
    ...
    def do_list(self, args):
        try:
            ...
            table = init_texttable(['Id', 'Distribution', 'Version', 'Architecture', 'Access', 'Visible', 'Default', 'Release Date'], 200, [
             'l', 'l', 'l', 'l', 'l', 'l', 'l', 'l'], [
             't', 'a', 't', 'a', 'a', 'a', 'a', 'a'])
            for item in allDist:
                if item.active:
    ...
    def do_enable(self, args):
        try:
            ...
            if result is None:
                ...
                return 0
            table = init_texttable(['Distribution', 'Version', 'Architecture', 'Access', 'Visible', 'Default', 'Release Date'], 200, [
             'l', 'l', 'l', 'l', 'l', 'l', 'l'], [
             'a', 't', 'a', 'a', 'a', 'a', 'a'])
