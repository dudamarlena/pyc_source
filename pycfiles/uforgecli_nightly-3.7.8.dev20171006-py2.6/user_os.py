...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uforgecli/commands/user/user_os.py
...
class User_Os_Cmd(Cmd, CoreGlobal):
    ...
    def do_enable(self, args):
        try:
            ...
            table = init_texttable(['Distribution', 'Version', 'Architecture', 'Access', 'Visible', 'Release Date'], 200, [
             'c', 'c', 'c', 'c', 'c', 'c'], [
             'a', 't', 'a', 'a', 'a', 'a'])
