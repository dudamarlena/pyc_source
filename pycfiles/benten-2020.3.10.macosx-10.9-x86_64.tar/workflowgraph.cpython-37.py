...
# [GCC 8.4.0]
# Embedded file name: /Users/kghose/.venvs/benten/lib/python3.7/site-packages/benten/code/workflowgraph.py
...
def cwl_graph(cwl: dict):
    graph = {'nodes':[],  'edges':[],  'line-numbers':{}}
...
def _mark_step_modifiers(node_data, node):
    ...
    if code:
        node_data['icon'] = {'code':code,  'color':'#ffffff'}
    if title:
