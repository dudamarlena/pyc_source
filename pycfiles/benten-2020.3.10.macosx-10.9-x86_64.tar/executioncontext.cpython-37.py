...
# [GCC 8.4.0]
# Embedded file name: /Users/kghose/.venvs/benten/lib/python3.7/site-packages/benten/code/executioncontext.py
# Compiled at: 2019-12-09 15:39:29
...
from .sampledata import get_sample_runtime, get_sample_data, get_sample_globbed_files
...
class ExecutionContext:
    __doc__ = 'Carries the job object (sample inputs), expression lib and, if a workflow, simulated\n    outputs for each step'
    ...
    def get_sample_data_file_path(self) -> pathlib.Path:
        return self.scratch_path / (pathlib.Path)(*un_mangle_uri(self.doc_uri).with_suffix(job_inputs_ext).parts[1:])