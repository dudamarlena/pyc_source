...
# [GCC 8.4.0]
# Embedded file name: /Users/kghose/.venvs/benten/lib/python3.7/site-packages/benten/langserver/fileoperation.py
# Compiled at: 2019-11-13 14:07:17
...
class FileOperation(CWLLangServerBase):
    ...
    def serve_textDocument_didOpen(self, client_query):
        ...
        document = Document(doc_uri=doc_uri,
    ...
    def _mark_document_issues(self, doc_uri):
        ...
        self.conn.send_notification(method='textDocument/publishDiagnostics',
          params=(to_dict(PublishDiagnosticsParams(uri=doc_uri,
