...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.6/site-packages/libraw/bindings.py
# Compiled at: 2017-07-09 08:49:37
...
class LibRaw(CDLL):
    ...
    def __init__(self):
        ...
        try:
            structs = {16:structs_16,  17:structs_17, 
             18:structs_18}[self.version_number[1]]
        except KeyError:
            raise ImportError('Unsupported Libraw version: %s.%s.%s.' % self.version_number)
        ...
        self.libraw_init.argtypes = [
         c_int]
        self.libraw_strprogress.argtypes = [
         c_int]
        self.libraw_unpack_function_name.argtypes = [POINTER(libraw_data_t)]
        self.libraw_subtract_black.argtypes = [
        ...
        self.libraw_dcraw_thumb_writer.argtypes = [
         POINTER(libraw_data_t),
         c_char_p]
        self.libraw_dcraw_process.argtypes = [
         POINTER(libraw_data_t)]
        ...
        self.libraw_raw2image.argtypes = [
         POINTER(libraw_data_t)]
        ...
        self.libraw_cameraList.restype = POINTER(c_char_p * self.libraw_cameraCount())
        ...
        self.libraw_dcraw_make_mem_image.restype = POINTER(libraw_processed_image_t)
        self.libraw_dcraw_make_mem_thumb.restype = POINTER(libraw_processed_image_t)
