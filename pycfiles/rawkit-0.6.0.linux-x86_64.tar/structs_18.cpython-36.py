...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.6/site-packages/libraw/structs_18.py
# Compiled at: 2017-07-09 08:49:37
# Size of source mod 2**32: 17981 bytes
...
class ph1_t(Structure):
    __doc__ = 'Contains color data read by Phase One cameras.'
    _fields_ = [
     (
      'format', c_int),
     (
...
class libraw_iparams_t(Structure):
    __doc__ = 'The primary parameters of the image.'
    _fields_ = [
     (
      'guard', c_char * 4),
     (
...
class libraw_image_sizes_t(Structure):
    __doc__ = 'Describes the size of the image.'
    _fields_ = [
     (
      'raw_height', c_ushort),
     (
...
class libraw_colordata_t(Structure):
    __doc__ = 'Describes all color data of the image.'
    _fields_ = [
     (
      'curve', c_ushort * 65536),
     (
      'cblack', c_uint * 4102),
     (
      'black', c_uint),
...
class libraw_gps_info_t(Structure):
    __doc__ = 'GPS data for the image.'
    _fields_ = [
     (
      'latitude', c_float * 3),
     (
...
class libraw_thumbnail_t(Structure):
    __doc__ = 'Describes the thumbnail image embedded in the raw file.'
    _fields_ = [
     (
      'tformat', c_uint),
     (
...
class libraw_output_params_t(Structure):
    __doc__ = 'Output parameters for processing the image with dcraw.'
    _fields_ = [
     (
      'greybox', c_uint * 4),
     (
...
class libraw_processed_image_t(Structure):
    __doc__ = 'A container for processed image data.'
    _fields_ = [
     (
      'type', c_uint),
     (
...
class libraw_decoder_info_t(Structure):
    __doc__ = 'Describes a raw format decoder name and format.'
    _fields_ = [
     (
