...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/redturtle/maps/core/adapter.py
...
class CoreRichMarker(GeoLocation):
    ...
    def __init__(self, context):
        ...
        self.config = getMultiAdapter((self.context, self.context.REQUEST), name='maps_configuration')
    ...
    def gmapurl(self):
        ...
        return url % (urllib.quote(self.location), self.config.googlemaps_key)
