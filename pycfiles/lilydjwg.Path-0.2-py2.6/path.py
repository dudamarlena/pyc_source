...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/path.py
# Compiled at: 2011-05-04 18:20:16
"""
...
class path():
    ...
    def rename(self, newname):
        u"""Rename file，and refresh path object itself"""
        os.rename(self.value, newname)
        self.value = newname
        return self

    def copyto(self, newpath):
        u"""Copy file，and refresh object itself"""
    ...
    def moveto(self, newpath):
        u"""Move file，and refresh object itself"""
        newpath = self.__class__(newpath)
        if newpath.isdir():
            newpath.join(self.basename)
        import shutil
    ...
    def open(self, mode='r', buffering=2, encoding=None, errors=None, newline=None, closefd=True):
        """Open file"""
