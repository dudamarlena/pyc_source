...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\templatetags\xadmin_tags.py
...
class BlockcaptureNode(template.Node):
    __doc__ = 'https://chriskief.com/2013/11/06/conditional-output-of-a-django-block/'
