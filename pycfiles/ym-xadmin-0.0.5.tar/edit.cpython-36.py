...
class ModelFormAdminView(ModelAdminView):
 ...
 L. 165        26  LOAD_FAST                'exclude'
               28  LOAD_ATTR                extend
               30  LOAD_FAST                'self'
               32  LOAD_ATTR                get_readonly_fields
 ...
 L. 182       166  LOAD_GLOBAL              forms
              168  LOAD_ATTR                ALL_FIELDS
              170  LOAD_FAST                'defaults'
              172  LOAD_STR                 'fields'
              174  STORE_SUBSCR     
            176_0  COME_FROM           164  '164'
            176_1  COME_FROM           150  '150'

 L. 184       176  LOAD_GLOBAL              modelform_factory
              178  LOAD_FAST                'self'
              180  LOAD_ATTR                model
              182  BUILD_TUPLE_1         1 
              184  LOAD_FAST                'defaults'
              186  CALL_FUNCTION_EX_KW     1  'keyword and positional arguments'
              188  RETURN_VALUE     

 L. 188       190  DUP_TOP          
              192  LOAD_GLOBAL              FieldError
 ...
 L. 189       208  LOAD_GLOBAL              FieldError
              210  LOAD_STR                 '%s. Check fields/fieldsets/exclude attributes of class %s.'

 L. 190       212  LOAD_FAST                'e'
              214  LOAD_FAST                'self'
              216  LOAD_ATTR                __class__
              218  LOAD_ATTR                __name__
              220  BUILD_TUPLE_2         2 
              222  BINARY_MODULO    
              224  CALL_FUNCTION_1       1  '1 positional argument'
              226  RAISE_VARARGS_1       1  'exception'
              228  POP_BLOCK        
              230  POP_EXCEPT       
              232  LOAD_CONST               None
...
Parse error at or near `DUP_TOP' instruction at offset 190
