...
# [GCC 8.4.0]
# Embedded file name: E:\python\hhwork\extra_apps\xadmin\plugins\passwords.py
...
site.register_view('^xadmin/password_reset/$', ResetPasswordSendView, name='xadmin_password_reset')
...
site.register_view('^xadmin/password_reset/(?P<uidb36>[0-9A-Za-z]{1,13})-(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', ResetPasswordComfirmView,
...
site.register_view('^xadmin/password_reset/complete/$', ResetPasswordCompleteView, name='xadmin_password_reset_complete')