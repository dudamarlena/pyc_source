...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\views\delete.py
...
class DeleteAdminView(ModelAdminView):
    ...
    def post_response(self):
        self.message_user(_('The %(name)s "%(obj)s" was deleted successfully.') % {'name': force_text(self.opts.verbose_name), 'obj': force_text(self.obj)}, 'success')
