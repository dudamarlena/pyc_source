...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\views\base.py
    ...
    def wrap(func):
        ...
        def method(self, context, nodes, *arg, **kwargs):
            ...
            if isinstance(file_name, Template):
                t = file_name
            elif not isinstance(file_name, cls_str):
                if is_iterable(file_name):
            ...
            if getattr(model_admin, 'hidden_menu', False):
                ...
                if model_dict['url'] in had_urls:
                    ...
                    if app_key in nav_menu:
                        ...
                        nav_menu[app_key] = {'title':app_title, 
                         'menus':[
                          model_dict]}
