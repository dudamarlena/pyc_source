...
# [GCC 8.4.0]
# Embedded file name: E:\python\hhwork\extra_apps\xadmin\plugins\relate.py
...
class RelateMenuPlugin(BaseAdminPlugin):
    ...
    def _get_all_related_objects(self, local_only=False, include_hidden=False, include_proxy_eq=False):
        ...
        if include_proxy_eq:
            ...
            relations = (f.remote_field.field.remote_field.is_hidden() or f.remote_field for f in children if not include_hidden)
