...
# [GCC 8.4.0]
# Embedded file name: E:\python\hhwork\extra_apps\xadmin\plugins\export.py
...
class ExportMenuPlugin(BaseAdminPlugin):
    ...
    def init_request(self, *args, **kwargs):
        self.list_export = [f for f in self.list_export if not f != 'xlsx' if has_xlsxwriter if not f != 'xls' if has_xlwt]
...
class ExportPlugin(BaseAdminPlugin):
    ...
    def _format_value(self, o):
        if not (o.field is None and getattr(o.attr, 'boolean', False)):
            if not o.field or isinstance(o.field, (BooleanField, NullBooleanField)):
                value = o.value
            else:
