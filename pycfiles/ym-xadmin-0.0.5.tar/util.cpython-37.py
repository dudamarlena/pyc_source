...
# [GCC 8.4.0]
# Embedded file name: E:\python\3.7\hhwork\extra_apps\xadmin\util.py
# Compiled at: 2019-08-29 05:17:02
# Size of source mod 2**32: 15627 bytes
...
try:
    import django.utils.timezone as tz_localtime
except ImportError:
    import django.utils.timezone as tz_localtime
...
def lookup_needs_distinct--- This code section failed: ---

 L. 102         0  LOAD_FAST                'lookup_path'
                2  LOAD_METHOD              split
                4  LOAD_STR                 '__'
                6  LOAD_CONST               1
...
def model_format_dict(obj):
    ...
    if isinstance(obj, (models.Model, models.base.ModelBase)):
        ...
        if isinstance(obj, models.query.QuerySet):
            ...
            opts = obj
    return {'verbose_name':force_text(opts.verbose_name), 
...
def lookup_field(name, obj, model_admin=None):
    ...
    try:
        ...
        if callable(name):
            ...
            if model_admin is not None and hasattr(model_admin, name) and name not in ('__str__',
                                                                                       '__unicode__'):
...
def boolean_icon(field_val):
    return mark_safe('<i class="%s" alt="%s"></i>' % (
     {True:'fa fa-check-circle text-success', 
      False:'fa fa-times-circle text-error',  None:'fa fa-question-circle muted'}[field_val], field_val))
