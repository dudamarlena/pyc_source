...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\models.py
# Compiled at: 2019-03-08 01:41:20
import json, django
...
class Log(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL, models.CASCADE, verbose_name=_('user'))
    ...
    def __str__(self):
        ...
        if self.action_flag == 'change':
            return ugettext('Changed "%(object)s" - %(changes)s') % {'object': self.object_repr, 
               'changes': self.message}
        if self.action_flag == 'delete' and self.object_repr:
