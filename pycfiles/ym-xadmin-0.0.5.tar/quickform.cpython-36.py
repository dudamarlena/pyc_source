...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\plugins\quickform.py
                ...
                if isinstance(db_field, (models.ForeignKey, models.ManyToManyField)):
                    ...
                    if rel_model in self.admin_site._registry:
                        if self.has_model_perm(rel_model, 'add'):
                            ...
                            formfield.widget = RelatedFieldWidgetWrapper(formfield.widget, db_field.rel, add_url, self.get_model_url(self.model, 'add'))
        return formfield
