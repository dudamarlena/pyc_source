...
# [GCC 8.4.0]
# Embedded file name: E:\python\hhwork\extra_apps\xadmin\plugins\wizard.py
...
class WizardFormPlugin(BaseAdminPlugin):
    ...
    def init_request--- This code section failed: ---

 L.  69         0  LOAD_FAST                'self'
                2  LOAD_ATTR                request
                4  LOAD_METHOD              is_ajax
                6  CALL_METHOD_0         0  '0 positional arguments'
                8  POP_JUMP_IF_TRUE     44  'to 44'
               10  LOAD_STR                 '_ajax'
               12  LOAD_FAST                'self'
               14  LOAD_ATTR                request
               16  LOAD_ATTR                GET
               18  COMPARE_OP               in
               20  POP_JUMP_IF_TRUE     44  'to 44'
               22  LOAD_GLOBAL              hasattr
               24  LOAD_FAST                'self'
               ...
               38  LOAD_FAST                'self'
               40  LOAD_ATTR                wizard_for_update
               42  POP_JUMP_IF_TRUE     48  'to 48'
             44_0  COME_FROM            32  '32'
             44_1  COME_FROM            20  '20'
             44_2  COME_FROM             8  '8'

 L.  71        44  LOAD_CONST               False
               46  RETURN_VALUE     
             48_0  COME_FROM            42  '42'
             48_1  COME_FROM            36  '36'

 L.  72        48  LOAD_GLOBAL              bool
               50  LOAD_FAST                'self'
               52  LOAD_ATTR                wizard_form_list
               54  CALL_FUNCTION_1       1  '1 positional argument'
               56  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `COME_FROM' instruction at offset 48_1
    ...
    def prepare_form(self, __):
        ...
        if self.request.method == 'GET':
            ...
            if wizard_goto_step:
                if int(wizard_goto_step) < len(self.get_form_list()):
                    obj = self.get_form_list().keys()
                    if six.PY3:
                        obj = [s for s in obj]
    ...
    def get_step_form_obj(self, step=None):
        ...
        return form(prefix=(self._get_form_prefix(step)), data=(self.storage.get_step_data(step)),
