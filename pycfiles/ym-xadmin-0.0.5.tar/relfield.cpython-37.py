...
# [GCC 8.4.0]
# Embedded file name: E:\python\hhwork\extra_apps\xadmin\plugins\relfield.py
...
class RelateFieldPlugin(BaseAdminPlugin):
    ...
    def get_field_style(self, attrs, db_field, style, **kwargs):
        if style in ('fk-ajax', 'fk-select'):
            if isinstance(db_field, models.ForeignKey):
                if db_field.remote_field.to in self.admin_view.admin_site._registry:
