...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\views\form.py
...
class FormAdminView(CommAdminView):
    ...
    @filter_hook
    def get_media(self):
        return super(FormAdminView, self).get_media() + self.form_obj.media + self.vendor('xadmin.page.form.js', 'xadmin.form.css')
