...
# [GCC 8.4.0]
# Embedded file name: G:\python\hhwork\extra_apps\xadmin\plugins\themes.py
...
class ThemePlugin(BaseAdminPlugin):
    ...
    def block_top_navmenu(self, context, nodes):
        themes = [{'name': _('Default'), 'description': _('Default bootstrap theme'), 'css': self.default_theme}, {'name': _('Bootstrap2'), 'description': _('Bootstrap 2.x theme'), 'css': self.bootstrap2_theme}]
        ...
        if self.use_bootswatch:
            ...
            if ex_themes:
                ...
                try:
                    h = httplib2.Http()
                    resp, content = h.request('https://bootswatch.com/api/3.json', 'GET', '', headers={'Accept': 'application/json', 'User-Agent': self.request.META['HTTP_USER_AGENT']})
                    if six.PY3:
