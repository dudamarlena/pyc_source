...
class RelateFieldPlugin(BaseAdminPlugin):
    ...
    def get_field_style(self, attrs, db_field, style, **kwargs):
        if style in ('fk-ajax', 'fk-select') and isinstance(db_field, models.ForeignKey) and db_field.remote_field.to in self.admin_view.admin_site._registry:
            if self.has_model_perm(db_field.remote_field.to, 'view'):
                db = kwargs.get('using')
