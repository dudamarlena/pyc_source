...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/gpk_voicing/fv20071030.py
# Compiled at: 2009-09-06 10:03:59
...
def feature_vec(data, dt, DT, LF=1.0, Nsv=M.NSV, ELF=1.0, do_voicing=1, do_dissonance=True):
    ...
    (all_ectrs, all_ps, t0) = percep_spec.perceptual_spec(data, dt, DT, bmin, bmax, M.DB, do_mod=do_voicing, do_dissonance=do_dissonance, PlompBouman=True)
