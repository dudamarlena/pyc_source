...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/gpk_voicing/emphasis.py
...
def calc_ear():
    """At 68dB SPL."""
    F0 = 50.0
    app_A = [0.729, 1.33, 2.28, 2.92, 3.65, 4.47, 5.4,
     6.4, 7.48, 8.64, 8.64, 8.64, 8.64, 8.64, 8.64,
