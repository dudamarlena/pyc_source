...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/gpk_voicing/fvss.py
...
def feature_vec(data, dt, DT, LF=1.0, Nsv=M.NSV, ELF=None, do_voicing=1, do_dissonance=False, PlompBouman=True):
    ...
    (all_ectrs, all_ps, t0) = percep_spec.perceptual_spec(data, dt, DT, bmin, bmax, M.DB, do_mod=do_voicing, do_dissonance=False, PlompBouman=PlompBouman)
