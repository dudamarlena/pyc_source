...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/gpk_voicing/fv_pdur.py
...
def feature_vec(data, dt, Dt, Nsv=FVM.NSV):
    ...
    (all_ectrs, all_ps, t0) = PS.block_percep_spec(data, dt, Dt, bmin=bmin, bmax=bmax, db=FVM.DB, do_mod=0, do_dissonance=False, PlompBouman=False)
    ...
    Vl = 0.04
    w = int(round(Vl / Dt))
    (o, descr) = FVM.vowel(w, ectrs, neural, neural_now, Nsv, formant_low=FORMANT_LOW, formant_high=FORMANT_HIGH)
