...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/linseed/partition.py
# Compiled at: 2012-02-12 08:56:57
import psutil
...
class Partition:
    ...
    def __str__(self):
        return ('Partition(device={}, mount_point={}, type={}, usage={})').format(self.device, self.mount_point, self.type, self.usage)
