...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\xicam\gui\widgets\tabview.py
# Compiled at: 2018-07-06 18:13:03
# Size of source mod 2**32: 4510 bytes
...
class TabView(QTabWidget):
    ...
    def __init__(self, model=None, widgetcls=None, field=None, bindings=[], **kwargs):
        """
    ...
    def dataChanged(self, start, end):
        for i in range(self.model.rowCount()):
            ...
            self.setCurrentIndex(self.insertTab(i, newwidget, self.model.item(i).text()))
