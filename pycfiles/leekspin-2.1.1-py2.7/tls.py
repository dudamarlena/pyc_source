...
def getPublicKey(cert, fileformat='PEM'):
    ...
    publicKey = re.sub(const.OPENSSL_BEGIN_KEY, const.TOR_BEGIN_KEY, publicKey)
    publicKey = re.sub(const.OPENSSL_END_KEY, const.TOR_END_KEY, publicKey)
    return publicKey
...
def getPrivateKey(key, fileformat='PEM'):
    ...
    privateKey = re.sub(const.OPENSSL_BEGIN_KEY, const.TOR_BEGIN_SK, privateKey)
    privateKey = re.sub(const.OPENSSL_END_KEY, const.TOR_END_SK, privateKey)
    return privateKey