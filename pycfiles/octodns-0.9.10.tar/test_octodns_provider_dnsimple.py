...
class TestDnsimpleProvider(TestCase):
    ...
    def test_populate(self):
        provider = DnsimpleProvider(b'test', b'token', 42, b'true')
        self.assertTrue(b'sandbox' in provider._client.base)
        provider = DnsimpleProvider(b'test', b'token', 42)
        self.assertFalse(b'sandbox' in provider._client.base)
