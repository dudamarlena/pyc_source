...
# [GCC 8.4.0]
# Embedded file name: /Users/ross/github/octodns/tests/test_octodns_provider_edgedns.py
# Compiled at: 2020-04-02 13:27:53
...
class TestEdgeDnsProvider(TestCase):
    ...
    def test_populate(self):
        ...
        with requests_mock() as (mock):
            with open(b'tests/fixtures/edgedns-records.json') as (fh):
    ...
    def test_apply(self):
        ...
        with requests_mock() as (mock):
            with open(b'tests/fixtures/edgedns-records-prev.json') as (fh):
                mock.get(ANY, text=fh.read())
        ...
        with requests_mock() as (mock):
            with open(b'tests/fixtures/edgedns-records-prev-other.json') as (fh):
