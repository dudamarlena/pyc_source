...
# Compiled at: 2020-02-18 18:30:27
...
class TestRoute53Provider(TestCase):
    ...
    def _get_stubbed_delegation_set_provider(self):
        provider = Route53Provider(b'test', b'abc', b'123', delegation_set_id=b'ABCDEFG123456')
        stubber = Stubber(provider._conn)
        stubber.activate()
        return (
         provider, stubber)
    ...
    def test_sync_create_with_delegation_set(self):
        ...
        stubber.add_response(b'create_hosted_zone', create_hosted_zone_resp, {b'Name': got.name, 
           b'CallerReference': ANY, 
           b'DelegationSetId': b'ABCDEFG123456'})
        list_resource_record_sets_resp = {b'ResourceRecordSets': [
                                 {b'Name': b'a.unit.tests.', 
                                    b'Type': b'A', 
                                    b'GeoLocation': {b'ContinentCode': b'NA'}, 
    ...
    def test_client_max_attempts(self):
        ...
        self.assertEquals({b'mode': b'legacy', 
           b'total_max_attempts': 43}, provider._conn._client_config.retries)
