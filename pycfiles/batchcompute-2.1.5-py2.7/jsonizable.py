...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/batchcompute/utils/jsonizable.py
# Compiled at: 2019-11-25 04:45:47
import copy
from datetime import datetime
from .constants import STRING, PY2
from batchcompute.core.exceptions import FieldError, ValidationError, JsonError
from batchcompute.utils import partial, CamelCasedClass, import_json, add_metaclass
json = import_json()
...
class Jsonizable(object):
    ...
    def __init__(self, properties={}):
        ...
        if isinstance(properties, STRING):
            ...
            error = (
             type(properties), self.__class__.__name__)
    ...
    def _init_valid_type(self, valid_type, value={}):
        if valid_type is None:
            ...
            if valid_type is datetime and isinstance(value, datetime):
                return value
            else:
                if issubclass(valid_type, Jsonizable):
