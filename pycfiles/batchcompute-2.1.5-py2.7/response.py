...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/batchcompute/client/response.py
...
class Metrics(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'RunningCount': NUMBER, 
...
class TaskMetrics(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'WaitingCount': NUMBER, 
       'RunningCount': NUMBER, 
...
class Task(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'TaskName': STRING, 
       'State': STRING, 
       'StartTime': TIME, 
       'EndTime': TIME, 
       'InstanceMetrics': (
...
class Disk(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'ECSSnapshotId': STRING}
...
class Result(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'ExitCode': NUMBER, 
       'ErrorCode': STRING, 
       'ErrorMessage': STRING, 
       'Detail': STRING}
...
class Instance(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'InstanceId': NUMBER, 
       'State': STRING, 
       'StartTime': TIME, 
       'EndTime': TIME, 
       'RetryCount': NUMBER, 
...
class SynchronousInstance(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'RequestId': STRING, 
       'StartTime': TIME, 
       'EndTime': TIME, 
       'Outputs': dict, 
       'Error': (
...
class Quota(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'AvailableClusterInstanceDataDiskType': list, 
...
class AppRevision(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'Revision': NUMBER, 
       'UpdateTime': TIME}
...
class AvailableInstanceDesc(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'CpuCore': NUMBER, 
       'InstanceType': STRING, 
       'MemorySize': NUMBER, 
       'Network': (
                 AvailableNetworkType, dict)}
...
class AvailableResource(Jsonizable):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'AvailableClusterInstanceType': list, 
       'AvailableSpotInstanceType': list, 
...
class RawResponse(object):
    ...
    """
    descriptor_type = 'non data descriptor'
    descriptor_map = {'StatusCode': NUMBER, 
       'RequestId': STRING, 
       'Date': STRING}
...
class ListResponse(RawResponse):
    descriptor_type = 'non data descriptor'
    descriptor_map = {'NextMarker': STRING + NUMBER, 
       'Items': list}
    descriptor_map.update(RawResponse.descriptor_map)
