...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/batchcompute/utils/canonicalization.py
...
from .functions import partial, timestamp_datetime, import_json, timediff, str2datetime, utc2local
