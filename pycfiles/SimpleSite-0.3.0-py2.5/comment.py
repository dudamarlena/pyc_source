...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/simplesite/controllers/comment.py
# Compiled at: 2008-11-08 10:05:38
import logging
...
class NewCommentForm(formencode.Schema):
    ...
    content = formencode.validators.String(not_empty=True, messages={'empty': 'Please enter a comment.'})
...
class CommentController(BaseController):
    ...
    def edit(self, id=None):
        ...
        if comment is None:
            abort(404)
        values = {'name': comment.name, 'email': comment.email, 
    ...
    def list(self):
        ...
        c.paginator = paginate.Page(comments_q, page=int(request.params.get('page', 1)), items_per_page=10, pageid=c.pageid, controller='comment', action='list')
