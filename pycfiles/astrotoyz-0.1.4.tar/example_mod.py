...
# [GCC 8.4.0]
# Embedded file name: /media/data-beta/users/fmooleka/git_projects/astro-toyz/astrotoyz/example_mod.py
# Compiled at: 2015-08-10 18:41:53
import numpy as np
...
def main(args=None):
    ...
    parser.add_argument('-c', '--use-cython', dest='cy', action='store_true', help='Use the Cython-based Prime number generator.')
