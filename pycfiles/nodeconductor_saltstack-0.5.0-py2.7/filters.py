...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nodeconductor_saltstack/sharepoint/filters.py
...
class UserFilter(django_filters.FilterSet):
    ...
    tenant = core_filters.URLFilter(view_name='sharepoint-tenants-detail', name='tenant__uuid')
...
class SiteCollectionFilter(django_filters.FilterSet):
    ...
    type = django_filters.MultipleChoiceFilter(choices=models.SiteCollection.Types.CHOICES)
