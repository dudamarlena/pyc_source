...
# Embedded file name: /tmp/pip-build-n5kV9S/pyflux/pyflux/inference/metropolis_hastings.py
...
class MetropolisHastings(object):
    ...
    def __init__(self, posterior, scale, nsims, initials, cov_matrix=None, thinning=2, warm_up_period=True, model_object=None, quiet_progress=False):
    ...
    def sample(self):
        ...
        while acceptance < 0.234 or acceptance > 0.4 or finish == 0:
            ...
            self.phi, a_rate = metropolis_sampler(sims_to_do, self.phi, self.posterior, a_rate, rnums, crit)
