...
# Embedded file name: /tmp/pip-build-n5kV9S/pyflux/pyflux/gpnarx/kernels.py
...
class SquaredExponential(object):
    ...
    def K(self, parm):
        return SE_K_matrix(self.X, parm) + np.identity(self.X.shape[0]) * 1e-10
...
class OrnsteinUhlenbeck(object):
    ...
    def K(self, parm):
        ...
        """
        return OU_K_matrix(self.X, parm) + np.identity(self.X.shape[0]) * 1e-10
...
class ARD(object):
    ...
    def K(self, parm):
        ...
        - Gram Matrix (np.ndarray)
        """
        return ARD_K_matrix(self.X, parm) + np.identity(self.X.shape[0]) * 1e-10
...
class RationalQuadratic(object):
    ...
    def K(self, parm):
        ...
        - Gram Matrix (np.ndarray)
        """
        return RQ_K_matrix(self.X, parm) + np.identity(self.X.shape[0]) * 1e-10
...
class Periodic(object):
    ...
    def K(self, parm):
        ...
        - Gram Matrix (np.ndarray)
        """
        return Periodic_K_matrix(self.X, parm) + np.identity(self.X.shape[0]) * 1e-10
