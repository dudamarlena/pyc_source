...
# Embedded file name: /tmp/pip-build-n5kV9S/pyflux/pyflux/arma/arimax.py
    ...
    **** AUTOREGRESSIVE INTEGRATED MOVING AVERAGE EXOGENOUS (ARIMAX) MODELS ****
    ...
    def predict_is(self, h=5, fit_once=True, fit_method='MLE', intervals=False, **kwargs):
        ...
        for t in range(0, h):
            ...
            x = ARIMAX(ar=self.ar, ma=self.ma, integ=self.integ, formula=self.formula, data=data1, family=self.family)
        ...
        if intervals is True:
            predictions.rename(columns={0: self.y_name, 1: '1% Prediction Interval', 2: '5% Prediction Interval', 
