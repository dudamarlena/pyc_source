...
# Embedded file name: /tmp/pip-build-n5kV9S/pyflux/pyflux/families/poisson.py
...
class Poisson(Family):
    ...
    def __init__(self, lmd=1.0, transform=None, **kwargs):
        ...
        self.gradient_only = kwargs.get('gradient_only', False)
    ...
    def setup():
        ...
        cythonized = True
        return (
         name, link, scale, shape, skewness, mean_transform, cythonized)
