...
class ForeignAccount(Comparable):
    __doc__ = 'Models an account foreign to ABNAmro.'
...
class AccountTransaction(Transaction):
    __doc__ = 'Models a banking transaction.'
...
class ForeignAccountTransaction(AccountTransaction):
    __doc__ = 'Models a transaction foreign to ABNAmro.'
