...
# Embedded file name: build/bdist.linux-i686/egg/pyhacc/PyHaccMainWindow.py
# Compiled at: 2014-02-05 08:16:29
from qtalchemy import *
from PySide import QtCore, QtGui
from . import reports
import datetime, qtviews
...
class MainWindow(QtGui.QMainWindow, qtviews.TabbedWorkspaceMixin):
    ...
    def __init__(self, parent=None, Session=None):
        ...
        self.updateViewFactory({'TagList': lambda : TagList(Session), 
