...
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ChernMachine/ChernDatabase.py
# Compiled at: 2018-06-06 05:00:23
...
class ChernDatabase(object):
    ...
    def is_docker_started(self):
        ps = subprocess.Popen('docker ps', shell=True, stdout=(subprocess.PIPE),
