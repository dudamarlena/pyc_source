...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mercury_sdk/rpc/job.py
# Compiled at: 2018-11-19 12:27:26
...
class Job(object):
    ...
    def start(self):
        """ Start the job """
        r = self.rpc_client.post(data={'query':self.query, 
...
class SimpleJob(Job):
    __doc__ = ' Creates an instruction in the standard form '

    def __init__(self, rpc_client, query, method, job_args=None, job_kwargs=None):
        """
        ...
        super(SimpleJob, self).__init__(rpc_client, query, instruction={'method':self.method, 
         'args':self.job_args, 
         'kwargs':self.job_kw})
