...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/sg/delete_security_group_rules.py
# Compiled at: 2015-05-26 14:08:43
...
class DeleteSecurityGroupRulesAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        parser.add_argument('-r', '--security_group_rules', dest='security_group_rules', action='store', type=str, default='', help='the comma separated IDs of security group rules you want to delete. ')
