...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/lb/dissociate_eips_from_loadbalancer.py
# Compiled at: 2015-05-26 14:07:00
...
class DissociateEipsFromLoadBalancerAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        ...
        parser.add_argument('-e', '--eips', dest='eips', action='store', type=str, default='', help='the comma separated IDs of eips you want to dissociate.')
