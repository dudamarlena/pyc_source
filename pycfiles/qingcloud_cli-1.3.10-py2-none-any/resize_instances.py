...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/instance/resize_instances.py
# Compiled at: 2015-05-26 14:05:33
...
class ResizeInstancesAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        parser.add_argument('-i', '--instances', dest='instances', action='store', type=str, default='', help='the comma separated IDs of instances you want to resize.')
        parser.add_argument('-t', '--instance_type', dest='instance_type', action='store', type=str, default='', help='new instance type you want to resize to.')
        ...
        if not instances:
            ...
            if not instance_type:
                if not options.cpu or not options.memory:
                    ...
                    return None
            return {'instances': instances, 'instance_type': instance_type, 
               'cpu': options.cpu, 
