...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/alarm_policy/dissociate_alarm_policy.py
...
class DissociateAlarmPolicyAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        ...
        parser.add_argument('-r', '--resources', dest='resources', action='store', type=str, default=None, help='the ID of resources you want to dissociate with alarm policy.')
