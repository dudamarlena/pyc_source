...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/s2/poweroff_s2_servers.py
...
class PowerOffS2ServersAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        parser.add_argument('-s', '--s2-servers', dest='s2_servers', action='store', type=str, default=None, help='the IDs of s2 servers you want to power off.')
        return
