...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/sg/describe_security_group_rules.py
# Compiled at: 2015-05-26 14:08:45
...
class DescribeSecurityGroupRulesAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        ...
        parser.add_argument('-r', '--security_group_rules', dest='security_group_rules', action='store', type=str, default='', help='ID of security group rule you want to list. ')
        parser.add_argument('-d', '--direction', dest='direction', action='store', type=int, default=None, help='0 for inbound; 1 for outbound.')
        return
