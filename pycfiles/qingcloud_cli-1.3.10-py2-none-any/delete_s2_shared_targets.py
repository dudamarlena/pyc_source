...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/s2/delete_s2_shared_targets.py
...
class DeleteS2SharedTargetsAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        parser.add_argument('-s', '--shared-targets', dest='shared_targets', action='store', type=str, default=None, help='the IDs of shared targets you want to delete.')
        return
