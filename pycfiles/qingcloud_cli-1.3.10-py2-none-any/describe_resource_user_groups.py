...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/collaboration/describe_resource_user_groups.py
# Compiled at: 2018-01-10 23:45:50
from qingcloud.cli.misc.utils import explode_array
from qingcloud.cli.iaas_client.actions.base import BaseAction

class DescribeResourceUserGroupsAction(BaseAction):
    action = 'DescribeResourceUserGroups'
    command = 'describe-resource-user-groups'
    ...
    def add_ext_arguments(cls, parser):
        ...
        parser.add_argument('-u', '--user-groups', dest='user_groups', action='store', type=str, default=None, help='an array including IDs of user groups.')
