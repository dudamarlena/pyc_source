...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/collaboration/add_user_group_members.py
# Compiled at: 2018-01-10 23:45:50
from qingcloud.cli.misc.utils import explode_array
from qingcloud.cli.iaas_client.actions.base import BaseAction

class AddUserGroupMembersAction(BaseAction):
    action = 'AddUserGroupMembers'
    command = 'add-user-group-members'
    ...
    def add_ext_arguments(cls, parser):
        ...
        parser.add_argument('-u', '--users', dest='users', action='store', type=str, default='', help='an array including IDs or emails of users which you want to add.')
