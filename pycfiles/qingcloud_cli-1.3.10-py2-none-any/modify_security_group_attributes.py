...
# [GCC 8.4.0]
# Embedded file name: /Users/luoxi/Project/yunify/qingcloud-cli/qingcloud/cli/iaas_client/actions/sg/modify_security_group_attributes.py
# Compiled at: 2015-05-26 14:08:48
...
class ModifySecurityGroupAttributesAction(BaseAction):
    ...
    def add_ext_arguments(cls, parser):
        parser.add_argument('-s', '--security_group_id', dest='security_group_id', action='store', type=str, default='', help='the ID of the security group you want to update its content.')
        parser.add_argument('-N', '--security_group_name', dest='security_group_name', action='store', type=str, default=None, help='the new name for the security group you want to update.')
