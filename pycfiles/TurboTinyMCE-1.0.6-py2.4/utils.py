...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-fat/egg/tinymce/utils.py
# Compiled at: 2006-10-04 09:19:18
import os, re
...
def get_available_languages():
    locale_dir = pkg_resources.resource_filename('tinymce', 'static/javascript/langs')
    langs = filter(lambda l: len(l) > 0, [ lang.split('.')[0] for lang in os.listdir(locale_dir) ])
    return langs
...
def cache_for_request(key):
    ...
    def decorator(func):
        ...
        try:
            _cached.func_name = 'cached_' + func.func_name
        except TypeError:
            pass
