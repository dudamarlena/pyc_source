...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-92t6atcz/pip/pip/_vendor/pep517/wrappers.py
# Compiled at: 2020-04-16 14:32:20
# Size of source mod 2**32: 10599 bytes
import threading
...
class BackendUnavailable(Exception):
    __doc__ = 'Will be raised if the backend cannot be imported in the hook process.'
...
class BackendInvalid(Exception):
    __doc__ = 'Will be raised if the backend is invalid.'
...
class HookMissing(Exception):
    __doc__ = 'Will be raised on missing hooks.'
...
class UnsupportedOperation(Exception):
    __doc__ = "May be raised by build_sdist if the backend indicates that it can't."
...
class Pep517HookCaller(object):
    ...
    def prepare_metadata_for_build_wheel(self, metadata_directory, config_settings=None, _allow_fallback=True):
        ...
        False).
        """
        return self._call_hook('prepare_metadata_for_build_wheel', {'metadata_directory':abspath(metadata_directory), 
    ...
    def build_wheel(self, wheel_directory, config_settings=None, metadata_directory=None):
        ...
        return self._call_hook('build_wheel', {'wheel_directory':abspath(wheel_directory), 
         'config_settings':config_settings, 
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        ...
        """
        return self._call_hook('build_sdist', {'sdist_directory':abspath(sdist_directory), 
         'config_settings':config_settings})
    ...
    def _call_hook(self, hook_name, kwargs):
        ...
        with tempdir() as (td):
            ...
            if data.get('backend_invalid'):
                raise BackendInvalid(backend_name=(self.build_backend),
