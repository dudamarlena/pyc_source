...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-92t6atcz/pip/pip/_internal/req/req_file.py
...
class RequirementsFileParser(object):
    ...
    def _parse_and_recurse(self, filename, constraint):
        for line in self._parse_file(filename, constraint):
            if not line.args:
                if not line.opts.editables:
                    if line.opts.requirements or line.opts.constraints:
