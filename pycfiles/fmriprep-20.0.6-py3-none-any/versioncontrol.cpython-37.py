...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-92t6atcz/pip/pip/_internal/vcs/versioncontrol.py
# Compiled at: 2020-04-16 14:32:20
# Size of source mod 2**32: 22600 bytes
        ...
        try:
            ...
            try:
                if e.errno == errno.ENOENT:
                    raise BadCommand('Cannot find command %r - do you have %r installed and in your PATH?' % (
                     cls.name, cls.name))
                else:
                    raise
            finally:
