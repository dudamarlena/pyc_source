...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notework/ItemUtils.py
# Compiled at: 2019-06-25 05:47:57
# Size of source mod 2**32: 2802 bytes
import logging, demjson, urllib3
logger = logging.getLogger('ItemUtils')
__all__ = [
 'fill_item_info']

def fill_item_info(item_list=None):
    if not (item_list is None or isinstance(item_list, list)):
...
def fill_item_info_dict(item_list=None):
    ...
    for item in item_list:
        if not 'itemId' not in item.keys():
...
def test():
    items = [
     '2738806530', '2760741906', '2631178932', '2760230700', '2748823895', '2761505903', '2628266453',
