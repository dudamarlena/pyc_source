...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/color_space_converter/converter_baseclass.py
...
class ConverterBaseclass(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.validate_types()
        self.validate_img_dims() if self._arr is not None else None
        self.orig_shape = self._arr.shape if self._arr is not None else None
