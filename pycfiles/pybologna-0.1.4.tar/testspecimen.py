...
# Embedded file name: build/bdist.linux-x86_64/egg/tests/testspecimen.py
# Compiled at: 2016-03-11 22:14:59
...
import os.path, unittest, pybold.sequence, pybold.specimen, pybold.tracefile
...
class SpecimensClientTest(unittest.TestCase):
    ...
    def _test_get(self, taxon=None, ids=None, bins=None, containers=None, institutions=None, researchers=None, geo=None, timeout=5):
        specimen_list = self.specimen_client.get(taxon=taxon, ids=ids, bins=bins, containers=containers, institutions=institutions, researchers=researchers, geo=geo, timeout=timeout)
