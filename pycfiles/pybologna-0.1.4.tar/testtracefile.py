...
# Embedded file name: build/bdist.linux-x86_64/egg/tests/testtracefile.py
# Compiled at: 2016-03-11 21:04:38
...
import os.path, tarfile, unittest, pybold.sequence, pybold.specimen, pybold.tracefile
...
class TracefilesClientTest(unittest.TestCase):
    ...
    def setUp(self):
        self.process_ids = [
         'BOM1525-10', 'BOM1528-10', 'GBIR5337-13', 'KKBNA817-05', 'KKBNA820-05', 'KKBNA821-05',
        ...
        self.institutions = [
         'Biodiversity Institute of Ontario', 'Agriculture and Agri-Food Canada']
    ...
    def _test_get(self, taxon=None, ids=None, bins=None, containers=None, institutions=None, researchers=None, geo=None, marker=None, timeout=5):
        tracefile_list = self.tracefiles_client.get(taxon=taxon, ids=ids, bins=bins, containers=containers, institutions=institutions, researchers=researchers, geo=geo, marker=marker, timeout=timeout)
