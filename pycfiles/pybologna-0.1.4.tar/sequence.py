...
# Embedded file name: build/bdist.linux-x86_64/egg/pybold/sequence.py
# Compiled at: 2016-03-11 22:00:41
...
import pybold.specimen, pybold.tracefile
...
class SequencesClient(Endpoint):
    ...
    def get(self, taxon=None, ids=None, bins=None, containers=None, institutions=None, researchers=None, geo=None, marker=None, timeout=5):
        ...
        result = super(SequencesClient, self).get({'taxon': taxon, 'ids': ids, 
           'bin': bins, 
