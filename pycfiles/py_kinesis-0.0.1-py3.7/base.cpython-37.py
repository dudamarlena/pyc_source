...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kinesis/base.py
# Compiled at: 2019-05-20 19:30:35
# Size of source mod 2**32: 2522 bytes
import asyncio, aioboto3, logging
            ...
            try:
                while True:
                    ...
                    if stream_status in ('CREATING', 'UPDATING'):
                        ...
                        raise exceptions.StreamStatusInvalid("Stream '{}' is {}".format(self.stream_name, stream_status))
