...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/gse/config.py
# Compiled at: 2013-08-15 22:08:03
"""Configuration class
===================
...
class Configurator(dict):
    ...
    def __init__(self, default_cfg='[DEFAULT]\n', use_msg=None, config_files=None):
        ...
        if default_cfg:
            self.config_parser.add_file(content=default_cfg)
