...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Products/PageCacheManager/PageCacheManager.py
...
class PageCacheManager(CacheManager, SimpleItem):
    ...
    __ac_permissions__ = (('View management screens', ('getSettings', 'manage_main')), ('Change cache managers', ('manage_editProps', 'manage_invalidate', 'manage_purge'), ('Manager', )))
    manage_options = ({'label': 'Properties', 'action': 'manage_main'},) + CacheManager.manage_options + SimpleItem.manage_options
    ...
    manage_main = PageTemplateFile('www/editPCM', globals(), __name__='editPCM')
...
manage_addPageCacheManagerForm = PageTemplateFile('www/addPCM', globals(), __name__='addPCM')
