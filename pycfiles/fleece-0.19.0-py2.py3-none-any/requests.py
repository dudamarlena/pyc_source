...
# [GCC 8.4.0]
# Embedded file name: /Users/bruc5529/git/fleece/fleece/requests.py
...
def set_default_timeout(timeout=None, connect_timeout=None, read_timeout=None):
    ...
    DEFAULT_CONNECT_TIMEOUT = connect_timeout if connect_timeout is not None else timeout
    DEFAULT_READ_TIMEOUT = read_timeout if read_timeout is not None else timeout
    return
