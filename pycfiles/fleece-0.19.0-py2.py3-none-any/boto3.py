...
# [GCC 8.4.0]
# Embedded file name: /Users/bruc5529/git/fleece/fleece/boto3.py
# Compiled at: 2019-11-06 12:49:13
from __future__ import absolute_import
import boto3 as real_boto3
from boto3 import docs, exceptions, logging, resources, session
from boto3 import set_stream_logger, setup_default_session
...
def client(*args, **kwargs):
    ...
    return real_boto3.client(config=config, *args, **kwargs)
...
def resource(*args, **kwargs):
    ...
    read_timeout = kwargs.pop('read_timeout', DEFAULT_READ_TIMEOUT or timeout)
    config = Config(connect_timeout=connect_timeout, read_timeout=read_timeout)
    return real_boto3.resource(config=config, *args, **kwargs)