...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python2.7.14/lib/python2.7/site-packages/qcloud_cos/threadpool.py
...
class WorkerThread(Thread):
    ...
    def get_result(self):
        return (
         self._succ_task_num, self._fail_task_num, self._ret)
