...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python2.7.14/lib/python2.7/site-packages/qcloud_cos/cos_config.py
...
class CosRegionInfo(object):
    ...
    def __init__(self, region=None, hostname=None, download_hostname=None, *args, **kwargs):
        ...
        if region in ('sh', 'shanghai'):
        ...
        elif region in ('tj', 'tianjin', 'tianjing'):
            ...
            self._download_hostname = 'cossgp.myqcloud.com'
        ...
        elif hostname and download_hostname:
