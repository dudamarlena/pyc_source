...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/echelon/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'echelon.category': {'Meta': {'ordering': "('order',)", 'object_name': 'Category'}, 'content': (
                                      'django.db.models.fields.TextField', [], {'blank': 'True'}), 
                            'created': (
                                      'django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}), 
                            'desc': (
                                   'django.db.models.fields.TextField', [], {'max_length': '140', 'blank': 'True'}), 
                            'hide_content': (
                            ...
                            'parent': (
                                     'django.db.models.fields.related.ForeignKey', [], {'to': "orm['echelon.Category']", 'null': 'True', 'blank': 'True'}), 
                            'path': (
                                   'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '155'}), 
                            'slug': (
                                   'django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}), 
                            'title': (
                                    'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                            'updated': (
                                      'django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})}, 
       'echelon.page': {'Meta': {'ordering': "('order',)", 'object_name': 'Page'}, 'categories': (
                                     'django.db.models.fields.related.ManyToManyField', [], {'to': "orm['echelon.Category']", 'symmetrical': 'False'}), 
                        'content': (
                        ...
                        'updated': (
                                  'django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})}, 
       'echelon.sitesettings': {'Meta': {'object_name': 'SiteSettings'}, 'global_javascript': (
                                                    'django.db.models.fields.TextField', [], {'blank': 'True'}), 
                                'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'})}, 
       'echelon.sitevariable': {'Meta': {'object_name': 'SiteVariable'}, 'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                'name': (
                                       'django.db.models.fields.CharField', [], {'max_length': '20'}), 
                                'site': (
                                       'django.db.models.fields.related.ForeignKey', [], {'to': "orm['echelon.SiteSettings']"}), 
                                'value': (
