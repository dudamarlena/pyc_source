...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mousedb/animal/lookups.py
...
class AnimalLookup(object):
    ...
    def format_result(self, animal):
        ...
        return '%s <strong>Cage:</strong> %s <strong>Markings:</strong> %s' % (animal, animal.Cage, animal.Markings)
