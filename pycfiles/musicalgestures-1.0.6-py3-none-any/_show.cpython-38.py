...
def mg_show--- This code section failed: ---
 ...
 L.  52       224  LOAD_STR                 '. Try making one with .motion()'

 L.  51       226  CALL_FUNCTION_3       3  ''
              228  POP_TOP          
 ...
 L.  58       306  LOAD_STR                 '. Try making one with .history()'

 L.  57       308  CALL_FUNCTION_3       3  ''
              310  POP_TOP          
 ...
 L.  66       388  LOAD_STR                 '. Try making one with .motionhistory()'

 L.  65       390  CALL_FUNCTION_3       3  ''
              392  POP_TOP          
 ...
 L.  72       468  LOAD_STR                 '. Try making one with .flow.sparse()'

 L.  71       470  CALL_FUNCTION_3       3  ''
              472  POP_TOP          
 ...
 L.  78       548  LOAD_STR                 '. Try making one with .flow.dense()'

 L.  77       550  CALL_FUNCTION_3       3  ''
              552  POP_TOP          
 ...
 L.  99       692  LOAD_FAST                'vidcap'
              694  LOAD_METHOD              isOpened
              696  CALL_METHOD_0         0  ''
          698_700  POP_JUMP_IF_FALSE   774  'to 774'

 L. 101       702  LOAD_FAST                'vidcap'
              704  LOAD_METHOD              read
              706  CALL_METHOD_0         0  ''
              708  UNPACK_SEQUENCE_2     2 
              710  STORE_FAST               'ret'
              712  STORE_FAST               'frame'

 L. 102       714  LOAD_FAST                'ret'
              716  LOAD_CONST               True
              718  COMPARE_OP               ==
          720_722  POP_JUMP_IF_FALSE   774  'to 774'

 L. 105       724  LOAD_GLOBAL              cv2
              726  LOAD_METHOD              imshow
              728  LOAD_STR                 'Frame'
              730  LOAD_FAST                'frame'
              732  CALL_METHOD_2         2  ''
              734  POP_TOP          

 L. 108       736  LOAD_GLOBAL              cv2
              738  LOAD_METHOD              waitKey
              740  LOAD_FAST                'i'
              742  CALL_METHOD_1         1  ''
              744  LOAD_CONST               255
              746  BINARY_AND       
 ...
 L. 109   760_762  BREAK_LOOP          774  'to 774'
              764  JUMP_BACK           692  'to 692'

 L. 113   766_768  BREAK_LOOP          774  'to 774'
            770_0  COME_FROM           756  '756'
          770_772  JUMP_BACK           692  'to 692'
            774_0  COME_FROM           720  '720'
            774_1  COME_FROM           698  '698'
