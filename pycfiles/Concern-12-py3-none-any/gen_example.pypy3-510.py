...
# Compiled at: 2017-09-21 15:27:01
...
if __name__ == '__main__':
    ...
    parser.add_argument('-file', choices=['forest', 'voting', 'iris', 'mushroom', 'rb_com_11', 'rb_s_07', 'rb_s_13'], default='forest', help='which example dataset to use')
