...
# Embedded file name: /Users/chris.maclellan/Projects/concept_formation/concept_formation/data_files/generate_quadruped.py
...
def generate_random_animal():
    genfun = [
     generate_dog, generate_cat, generate_horse, generate_giraffe]
    f = choice(genfun)
    return f()
...
def generate_horse():
    ...
    horse[neck]['locationX'] = horse[torso]['height'] / 2 + neck_height / 2.828
    horse[neck]['locationY'] = 0
    horse[neck]['locationZ'] = horse[torso]['radius'] + neck_height / 2.828
    horse[neck]['axisX'] = 1
    horse[neck]['axisY'] = 0
    horse[neck]['axisZ'] = 1
...
def generate_giraffe():
    ...
    giraffe[neck]['locationX'] = giraffe[torso]['height'] / 2 + neck_height / 2.828
    giraffe[neck]['locationY'] = 0
    giraffe[neck]['locationZ'] = giraffe[torso]['radius'] + neck_height / 2.828
    ...
    giraffe[head]['locationX'] = giraffe[torso]['height'] / 2 + neck_height / 1.414
    giraffe[head]['locationY'] = 0
    giraffe[head]['locationZ'] = giraffe[torso]['radius'] + neck_height / 1.414
