...
# [GCC 8.4.0]
# Embedded file name: /home/joel/Workspace/multi-job/multi_job/main.py
# Compiled at: 2020-02-19 11:48:14
...
def entrypoint() -> None:
    ...
    if len(sys.argv) < 2:
        raise ConfigNotGiven('You must supply a configuration path e.g. dev <config_path>')
