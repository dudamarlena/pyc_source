...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/icyeye/cli.py
# Compiled at: 2011-10-06 03:11:29
...
def main():
    ...
    parser.add_option('-m', '--max-image-size', type='int', dest='max_image_size', help='The size (in bytes) which images must be under to be encoded')
