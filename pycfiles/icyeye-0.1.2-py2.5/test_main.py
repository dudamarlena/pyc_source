...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/tests/test_main.py
# Compiled at: 2011-10-02 09:34:02
...
class TestMakeCssImagesInline(_BaseFixtureTestCase):
    ...
    def test_mismatched_arguements(self):
        ...
        """
        assert_raises(CssFileError, make_css_images_inline, '/tmp/css/main.css', '/other.css')

    def test_passing_relative_url(self):
        """The css_file_url must be an absolute URL."""
        assert_raises(CssFileError, make_css_images_inline, '/tmp/css/main.css', 'main.css')
...
class TestCssImagesInlinerParsing(_BaseFixtureTestCase):
    ...
    def test_relative_urls(self):
        ...
        new_css = make_css_images_inline(self.get_fixture_file_path('relative_urls.css'))
        eq_(expected_output, new_css)

    def test_absolute_urls(self):
        """URLs relative to the CSS file are correctly identified and encoded"""
        expected_output = self.read_fixture_file('absolute/absolute_urls.expected.css')
        new_css = make_css_images_inline(self.get_fixture_file_path('absolute/absolute_urls.css'), '/absolute/absolute_urls.css')
        eq_(expected_output, new_css)
    ...
    def test_skipped_urls(self):
        ...
        new_css = make_css_images_inline(self.get_fixture_file_path('skip.css'), '/skip.css')
        eq_(expected_output, new_css)
    ...
    def test_quotes(self):
        ...
        new_css = make_css_images_inline(self.get_fixture_file_path('quotes.css'), '/quotes.css')
        eq_(expected_output, new_css)
    ...
    def test_whitespace(self):
        ...
        new_css = make_css_images_inline(self.get_fixture_file_path('whitespace.css'), '/whitespace.css')
    ...
    def test_size_limit_met(self):
        ...
        """
        expected_output = self.read_fixture_file('relative_urls.expected.css')
        new_css = make_css_images_inline(self.get_fixture_file_path('relative_urls.css'), '/relative_urls.css', image_size_limit=16965)
        eq_(expected_output, new_css)
        new_css = make_css_images_inline(self.get_fixture_file_path('relative_urls.css'), '/relative_urls.css', image_size_limit=20000)
        eq_(expected_output, new_css)
    ...
    def test_size_limit_not_met(self):
        ...
        """
        expected_output = self.read_fixture_file('image_size_not_met.expected.css')
        new_css = make_css_images_inline(self.get_fixture_file_path('relative_urls.css'), '/relative_urls.css', image_size_limit=3000)
        eq_(expected_output, new_css)
...
class TestEncodeImageToBase64(_BaseFixtureTestCase):
    ...
    def test_files(self):
        ...
        for file_name in ('red.png', 'green.gif', 'blue.jpg'):
            ...
            yield (
             self.do_encode, image_file_name)
    ...
    def test_unknown_mime_type(self):
        ...
        """
        assert_raises(AssertionError, encode_image_to_base64, self.get_fixture_file_path('foo.unknown'))