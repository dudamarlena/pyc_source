...
# Embedded file name: /Users/horn/Code/pythonprojects/py_alg_dat/testsuite/test_directed_un_weighted_graph.py
...
class TestDirectedUnWeightedGraph(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.e12 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v1_g1, self.v2_g1)
        self.e14 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v1_g1, self.v4_g1)
        self.e23 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v2_g1, self.v3_g1)
        self.e24 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v2_g1, self.v4_g1)
        self.e35 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v3_g1, self.v5_g1)
        self.e42 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v4_g1, self.v2_g1)
        self.e43 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v4_g1, self.v3_g1)
        self.e45 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v4_g1, self.v5_g1)
        self.e53 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v5_g1, self.v3_g1)
        self.e51 = graph_edge.DirectedUnWeightedGraphEdge(self.graph1, self.v5_g1, self.v1_g1)
        ...
        self.graph2.add_edge(self.v0_g2, self.v1_g2)
        self.graph2.add_edge(self.v0_g2, self.v2_g2)
        self.graph2.add_edge(self.v0_g2, self.v4_g2)
        self.graph2.add_edge(self.v1_g2, self.v3_g2)
        self.graph2.add_edge(self.v1_g2, self.v4_g2)
        self.graph2.add_edge(self.v2_g2, self.v7_g2)
        self.graph2.add_edge(self.v2_g2, self.v5_g2)
        self.graph2.add_edge(self.v3_g2, self.v6_g2)
        self.graph2.add_edge(self.v4_g2, self.v6_g2)
        self.graph2.add_edge(self.v4_g2, self.v8_g2)
        self.graph2.add_edge(self.v4_g2, self.v7_g2)
        self.graph2.add_edge(self.v5_g2, self.v7_g2)
