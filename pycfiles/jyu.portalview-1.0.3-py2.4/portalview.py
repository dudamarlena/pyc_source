...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/jyu/portalview/content/portalview.py
...
def add_default_contents(obj, event):
    ...
    widths = {2: ['80', '20'], 3: ['30', '30', '20'], 4: ['25', '25', '25', '25']}[COLUMNS]
    ids = {2: [_('left'), _('right')], 3: [_('left'), _('middle'), _('right')], 4: [_('left'), _('center-left'), _('center-right'), _('right')]}[COLUMNS]
    titles = {2: [_('Left Column'), _('Right Column')], 3: [_('Left Column'), _('Middle Column'), _('Right Column')], 4: [_('Left Column'), _('Center-Left Column'), _('Center-Right Column'), _('Right Column')]}[COLUMNS]
