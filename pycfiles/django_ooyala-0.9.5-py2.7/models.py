...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ooyala/models.py
...
class OoyalaItem(models.Model):
    ...
    def from_xml(xml):
        ...
        created = False
        item_data = {'embed_code': get_data('embedCode'), 
           ...
           'description': ''}
        try:
            item_data.update(dict(description=get_data('description')))
        except:
            pass
