...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ooyala/library.py
...
class OoyalaRequest(object):
    ...
    def url(self):
        ...
        uri = OoyalaAPI.BASE_URL + self.api_url + self.action + '?pcode=' + API_KEYS['PARTNER_CODE'] + '&' + urllib.urlencode(self.params()) + '&signature=' + signature
        return uri
