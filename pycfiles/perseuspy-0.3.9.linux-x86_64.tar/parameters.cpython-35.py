...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/perseuspy/parameters.py
...
def singleChoiceWithSubParams(parameters, name, type_converter=str):
    ...
    if value < 0:
        return (value, None)
    return (
     type_converter(values[value].text), param.findall('SubParams/Parameters')[value])
