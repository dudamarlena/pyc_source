...
# Embedded file name: build/bdist.linux-i686/egg/pylocator/controller.py
# Compiled at: 2012-04-18 08:23:08
import os, gtk
...
class PyLocatorController(object):
    ...
    def save_markers(self, *args):
        try:
            self.markersFileName
        except AttributeError:
            self.save_as(*args)
        else:
            EventHandler().save_markers_as(self.markersFileName)
    ...
    def save_markers_as(self, *args):
        ...
        def ok_clicked(w):
            ...
            shared.set_file_selection(fname)
            try:
                EventHandler().save_markers_as(fname)
            except IOError:
    ...
    def set_mouse_interact_mode(self, menuItem, *args):
        ...
        """
        commmands = {'_Mouse Interact': 'mouse1 interact', 
