...
# Embedded file name: build/bdist.linux-i686/egg/pylocator/surf_params.py
# Compiled at: 2012-04-18 09:07:31
...
class SurfParams(object):
    ...
    def __init__(self, imageData, intensity, color=None):
        ...
        self.prog = ProgressBarDialog(title='Rendering surface %s' % self.label, parent=None, msg='Marching cubes ....', size=(300,
                                                                                                                               40))
