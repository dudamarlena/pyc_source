...
# Embedded file name: build/bdist.linux-i686/egg/pylocator/roi_renderer_props.py
# Compiled at: 2012-04-18 09:04:17
from __future__ import division
import os.path, gobject, gtk
...
class RoiRendererProps(gtk.VBox):
    ...
    def _make_properties_frame(self):
        ...
        self.scrollbar_opacity.set_increments(0.05, 0.2)
        ...
        if response == gtk.RESPONSE_OK:
            ...
            try:
                try:
                    ...
                    error_msg('Could not load ROI mask from %s' % fname)
