...
# Embedded file name: build/bdist.linux-i686/egg/pylocator/surf_renderer.py
# Compiled at: 2012-04-18 09:08:53
...
class SurfRenderWindow(ThreeDimRenderWindow, PyLocatorRenderWindow):
    ...
    def key_press(self, interactor, event):
        if shared.debug:
            print 'key press event in SurfRenderWindow'
        ...
        if key.lower() == 'i':
            ...
            marker = Marker(xyz=pnt, rgb=EventHandler().get_default_color(), radius=shared.ratio * shared.marker_size)
