...
# [GCC 8.4.0]
# Embedded file name: /home/eitan/Documents/code/RITRemixerator/dorrie/../dorrie/comps/comps.py
# Compiled at: 2012-01-24 15:38:48
import types, sys
...
class Group(CompsObj):
    ...
    def _packageiter(self):
        lst = self.mandatory_packages.keys() + self.optional_packages.keys() + self.default_packages.keys() + self.conditional_packages.keys()
        return lst
