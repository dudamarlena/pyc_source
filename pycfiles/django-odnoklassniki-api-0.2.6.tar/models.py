...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-odnoklassniki-api/odnoklassniki_api/models.py
# Compiled at: 2016-02-10 07:37:10
import logging, re
...
class OdnoklassnikiManager(models.Manager):
    ...
    def get_by_url(self, url):
        ...
        try:
            ...
            except OdnoklassnikiError as e:
...
class OdnoklassnikiPKModel(OdnoklassnikiModel):
    ...
    id = models.BigIntegerField('ID', help_text='Уникальный идентификатор', primary_key=True)
