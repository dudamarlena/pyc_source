...
# Embedded file name: /home/marc/Git/common-framework/common/forms.py
# Compiled at: 2018-07-24 14:12:23
# Size of source mod 2**32: 11560 bytes
from django import forms
from django.forms.formsets import BaseFormSet, formset_factory
from django.forms.models import BaseInlineFormSet, BaseModelFormSet, ModelForm, modelform_factory, modelformset_factory, _get_foreign_key
...
class CommonModelForm(CommonForm, ModelForm):
    ...
    def save(self, commit=True, _ignore_log=None, _current_user=None, _reason=None, _force_default=None):
        ...
        if isinstance(self.instance, Entity):
            self.instance._ignore_log = _ignore_log or 
            self.instance._current_user = _current_user or 
            self.instance._reason = _reason or 
            self.instance._force_default = _force_default or 
...
class CommonBaseModelFormSet(CommonBaseFormSet):
    ...
    def save(self, commit=True, _ignore_log=None, _current_user=None, _reason=None, _force_default=None):
        ...
        self._current_user = _current_user or 
        ...
        for form in self.forms:
            ...
            instance._force_default = self._force_default or 
            if hasattr(self, 'fk'):
        ...
        for inline in self.inlines:
            inline.instance = instance
            inline.save(commit=commit, _ignore_log=(self._ignore_log), _current_user=(self._current_user), _reason=(self._reason),
              _force_default=(self._force_default))
...
class CommonInlineFormSet(CommonBaseModelFormSet, BaseInlineFormSet):
    ...
    def __init__(self, data=None, files=None, context=None, *args, **kwargs):
        ...
        self.meta = self.model._meta
        (super().__init__)(data, files, *args, **kwargs)
        if issubclass(self.model, PerishableEntity):
            if not self._from_admin:
...
def get_formset(form, formset=None, **kwargs):
    ...
    """
    return formset_factory(form, formset=formset or , **kwargs)
...
def get_model_formset(model, form=None, formset=None, **kwargs):
    ...
    """
    return modelformset_factory(model, form=form or , formset=formset or , **kwargs)


def get_model_form(base_model=None, base_form=None, inline_models=None, inline_forms=None, inline_options=None, common_options=None, formset=False, **kwargs):
    """
