...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tkcolorpicker/colorsquare.py
# Compiled at: 2017-07-13 02:41:00
"""
...
class ColorSquare(tk.Canvas):
    ...
    def _draw(self, color):
        ...
        x = v / 100.0
        y = 1 - s / 100.0
        self.create_line(0, y * height, width, y * height, tags='cross_h', fill='#C2C2C2')
        self.create_line(x * width, 0, x * width, height, tags='cross_v', fill='#C2C2C2')
