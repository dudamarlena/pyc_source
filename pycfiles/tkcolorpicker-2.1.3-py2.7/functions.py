...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tkcolorpicker/functions.py
# Compiled at: 2017-07-13 01:24:30
"""
...
import colorsys
PALETTE = ('red', 'dark red', 'orange', 'yellow', 'green', 'lightgreen', 'blue', 'royal blue',
           'sky blue', 'purple', 'magenta', 'pink', 'black', 'white', 'gray', 'saddle brown',
           'lightgray', 'wheat')
...
def create_checkered_image(width, height, c1=(154, 154, 154, 255), c2=(100, 100, 100, 255), s=6):
    """
