...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tkcolorpicker/gradientbar.py
# Compiled at: 2018-06-08 15:08:56
"""
...
class GradientBar(tk.Canvas):
    ...
    def __init__(self, parent, hue=0, height=11, width=256, variable=None, **kwargs):
        """
    ...
    def _on_click(self, event):
        ...
        self._variable.set(round2(360.0 * x / self.winfo_width()))
    ...
    def _on_move(self, event):
        ...
        self.coords('cursor', x, 0, x, self.winfo_height())
        self._variable.set(round2(360.0 * x / w))
