...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tkcolorpicker/alphabar.py
# Compiled at: 2017-07-13 03:26:00
"""
...
class AlphaBar(tk.Canvas):
    ...
    def __init__(self, parent, alpha=255, color=(255, 0, 0), height=11, width=256, variable=None, **kwargs):
        """
    ...
    def _draw_gradient(self, alpha, color):
        ...
        self.gradient = ImageTk.PhotoImage(Image.alpha_composite(bg, gradient), master=self)
        self.create_image(0, 0, anchor='nw', tags='gardient', image=self.gradient)
        self.lower('gradient')
        x = alpha / 255.0 * width
    ...
    def _on_click(self, event):
        ...
        self._variable.set(round2(255.0 * x / self.winfo_width()))
    ...
    def _on_move(self, event):
        ...
        self.coords('cursor', x, 0, x, self.winfo_height())
        self._variable.set(round2(255.0 * x / w))
    ...
    def get(self):
        ...
        return round2(255.0 * coords[0] / self.winfo_width())
