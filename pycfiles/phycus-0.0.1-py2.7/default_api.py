...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/phycus/apis/default_api.py
...
class DefaultApi(object):
    ...
    def hfc_get_with_http_info(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_get" % key)
            params[key] = val
        ...
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='HFCurationListResponse', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_population_get_with_http_info(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_population_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='PopulationResponse', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_population_population_id_get_with_http_info(self, population_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_population_population_id_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='PopulationSubmissionResponse', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_post_with_http_info(self, hf_curation_request, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_post" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'POST', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='HFCurationResponse', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_submission_id_cohort_get_with_http_info(self, submission_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_submission_id_cohort_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='CohortData', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_submission_id_get_with_http_info(self, submission_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_submission_id_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='HFCurationResponse', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_submission_id_haplotypes_get_with_http_info(self, submission_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_submission_id_haplotypes_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='HaplotypeFrequencyData', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_submission_id_labels_get_with_http_info(self, submission_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_submission_id_labels_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='LabelData', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_submission_id_population_get_with_http_info(self, submission_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_submission_id_population_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='PopulationData', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def hfc_submission_id_scope_get_with_http_info(self, submission_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method hfc_submission_id_scope_get" % key)
            params[key] = val
        ...
        header_params['Content-Type'] = self.api_client.select_header_content_type([])
        auth_settings = []
        return self.api_client.call_api(resource_path, 'GET', path_params, query_params, header_params, body=body_params, post_params=form_params, files=local_var_files, response_type='ScopeData', auth_settings=auth_settings, callback=params.get('callback'), _return_http_data_only=params.get('_return_http_data_only'))