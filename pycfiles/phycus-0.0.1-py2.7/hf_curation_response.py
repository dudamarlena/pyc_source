...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/phycus/models/hf_curation_response.py
...
class HFCurationResponse(object):
    ...
    def __init__(self, submission_id=None, population_id=None, cohort_id=None, method_set_id=None, label_id=None, haplotype_list_id=None, scope_id=None, access_id=None):
        ...
        """
        self.swagger_types = {'submission_id': 'int', 
           'population_id': 'int', 
           'cohort_id': 'int', 
           'method_set_id': 'int', 
           'label_id': 'int', 
           ...
           'scope_id': 'int', 
           'access_id': 'int'}
        self.attribute_map = {'submission_id': 'SubmissionID', 
