...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/phycus/models/method.py
...
class Method(object):
    ...
    def __init__(self, type_of_method=None, method_value=None, method_comment=None, method_reference=None):
        ...
        """
        self.swagger_types = {'type_of_method': 'str', 
           'method_value': 'str', 
           'method_comment': 'str', 
           'method_reference': 'str'}
        self.attribute_map = {'type_of_method': 'typeOfMethod', 
    ...
    def type_of_method(self, type_of_method):
        ...
        """
        allowed_values = [
         'EM_ALGORITHM', 'EM_VERSION', 'EM_ALG_REF', 'MAC_SERVICE', 'MAC_SER_REF', 'MAC_VERSION', 'ARS_SERVICE', 'ARS_SERV_REF', 'ARS_VERSION', 'HWE_METHOD', 'HWE_REF', 'LD_METHOD', 'LD_METHOD_REF']
        if type_of_method not in allowed_values:
            raise ValueError(('Invalid value for `type_of_method` ({0}), must be one of {1}').format(type_of_method, allowed_values))
        self._type_of_method = type_of_method
