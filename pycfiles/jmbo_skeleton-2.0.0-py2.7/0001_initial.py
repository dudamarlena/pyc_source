...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/skeleton/skeleton/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'sites.site': {'Meta': {'ordering': "('domain',)", 'object_name': 'Site', 'db_table': "'django_site'"}, 'domain': (
                      ...
                      'name': (
                             'django.db.models.fields.CharField', [], {'max_length': '50'})}, 
       'skeleton.trivialcontent': {'Meta': {'ordering': "('-created',)", 'object_name': 'TrivialContent', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
