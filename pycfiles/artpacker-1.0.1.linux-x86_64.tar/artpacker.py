...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/artpacker/artpacker.py
# Compiled at: 2012-05-29 14:29:44
import ImageChops, os, Image, re
...
class SpriteSheet:
    ...
    def get_metadata(self):
        ...
        for sprite in self.sprites:
            metadata[sprite['path']] = {'position': sprite['position'], 
...
class ArtPacker:
    ...
    def add_padding(self, image):
        ...
        result = Image.new('RGBA', (width, height), (255, 255, 255, 1))
