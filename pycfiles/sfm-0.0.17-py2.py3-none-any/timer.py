...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/single_file_module-project/sfm/timer.py
# Compiled at: 2019-04-21 22:02:27
"""
...
class BaseTimer(object):
    ...
    __slots__ = [
     'title', 'start_time', 'end_time', 'elapsed', 'display', 'log_msg_tpl']
    ...
    def __str__(self):
        return self.log_msg_tpl.format(start_time=self.start_time, end_time=self.end_time, elapsed=self.elapsed)
