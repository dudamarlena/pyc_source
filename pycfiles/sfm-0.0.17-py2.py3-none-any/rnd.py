...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/single_file_module-project/sfm/rnd.py
# Compiled at: 2019-04-22 00:29:16
"""
...
def rand_email():
    ...
    Usage Example::
        ...
        Z4Lljcbdw7m@npa.net
    """
    name = rand_str(random.randint(4, 14), string.ascii_lowercase) + rand_str(random.randint(1, 4), string.digits)
    ...
    for _ in range(random.randint(*num_p)):
        ...
        for _ in range(random.randint(*num_s)):
            ...
            for _ in range(random.randint(*num_w)):
                s.append(rand_str(random.randint(1, 15), string.ascii_lowercase))
