...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/single_file_module-project/sfm/exception_mate.py
# Compiled at: 2019-04-21 23:05:14
"""
This module provide extensive class and method for the built-in Exception system.
"""
import sys, traceback, attr
...
class ErrorTraceBackChain(object):
    ...
    def get_last_exc_info(cls):
        ...
        for filename, line_num, func_name, code in traceback.extract_tb(exc_tb):
            error = Error(exc_value=exc_value, filename=filename, line_num=line_num, func_name=func_name, code=code)
            errors.append(error)
