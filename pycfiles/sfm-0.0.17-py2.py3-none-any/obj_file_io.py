...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/single_file_module-project/sfm/obj_file_io.py
# Compiled at: 2019-04-21 23:14:53
"""
...
"""
import os, time, zlib, logging, inspect
...
def _dump(obj, abspath, serializer_type, dumper_func=None, compress=True, overwrite=False, verbose=False, **kwargs):
    """Dump object to file.
    ...
    if not inspect.isfunction(dumper_func):
        raise TypeError('dumper_func has to be a function take object as input and return binary!')
...
def _load(abspath, serializer_type, loader_func=None, decompress=True, verbose=False, **kwargs):
    ...
    if not inspect.isfunction(loader_func):
        raise TypeError('loader_func has to be a function take binary as input and return an object!')
...
def dump_func(serializer_type):
    ...
    def outer_wrapper(dumper_func):
        ...
        def wrapper(*args, **kwargs):
            return _dump(dumper_func=dumper_func, serializer_type=serializer_type, *args, **kwargs)
...
def load_func(serializer_type):
    ...
    def outer_wrapper(loader_func):
        ...
        def wrapper(*args, **kwargs):
            return _load(loader_func=loader_func, serializer_type=serializer_type, *args, **kwargs)
