...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/protoLib/admin/adminUserProf.py
# Compiled at: 2014-05-29 10:16:48
import django.contrib.admin

class usrProfileAdmin(django.contrib.admin.ModelAdmin):
    protoExt = {'__ptType': 'pcl', 
       ...
       'actions': [], 'detailsConfig': [
                       {'__ptType': 'detailDef', 
                          ...
                          'masterField': 'pk'}], 
       'gridConfig': {'__ptType': 'gridConfig', 
                      'listDisplay': [
                                    'user', 'userTeam'], 
                      'baseFilter': [], 'initialFilter': [], 'initialSort': [], 'searchFields': [], 'sortFields': [], 'hiddenFields': [
                                     'id'], 
                      'readOnlyFields': []}, 
       ...
       'custom': {'__ptType': 'custom', 
                  'filtersSet': [], 'listDisplaySet': [], 'sortersSet': []}, 
       'businessRules': {'__ptType': 'businessRules'}, 
