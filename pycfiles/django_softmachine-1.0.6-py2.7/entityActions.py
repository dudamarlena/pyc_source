...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/prototype/actions/entityActions.py
...
def doEttyChangeModel(request, queryset, parameters):
    ...
    dModel = Model.objects.get_or_create(project=dProject, code=newModelName, smOwningTeam=userProfile.userTeam, defaults=defValues)[0]
    for dEntity in queryset:
