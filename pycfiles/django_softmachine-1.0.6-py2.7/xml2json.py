...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/protoLib/utils/xml2json.py
...
"""
import xml.etree.cElementTree as ET, json as simplejson, optparse, sys
...
def main():
    p = optparse.OptionParser(description='Converts XML to JSON or the other way around', prog='xml2json', usage='%prog -t xml2json -o file.json file.xml')
