...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/prototype/actions/exportProto/protStructure.py
# Compiled at: 2014-06-23 11:39:29
_PROTOSTRUCTURE = {'version': '140222', 
   'Project': {'properties': [
                            'code', 'description', 'dbEngine', 'dbName', 'dbUser', 'dbPassword', 'dbHost', 'dbPort'], 
               'details': [
                         'Model']}, 
   'Model': {'properties': [
                          'code', 'category', 'modelPrefix', 'description'], 
             'references': [
                          'projet'], 
             'details': [
                       'Entity']}, 
   ...
   'Property': {'properties': [
                             ...
                             'crudType', 'dbName',
                             'description', 'notes'], 
                'where': [{'isForeign': False}], 'references': [
                             'entity'], 
                'details': []}, 
   'Relationship': {'properties': [
                    ...
                    'references': [
                                 'entity', 'refEntity'], 
                    'details': []}, 
   'PropertyModel': {'properties': [], 'references': [
                                  'model'], 
                     'details': [
                               'Property']}}
