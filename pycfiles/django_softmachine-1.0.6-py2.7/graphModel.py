...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/prototype/actions/graphModel.py
...
class GraphModel:
    ...
    def getDiagramDefinition(self, diagramSet):
        ...
        for pDiag in diagramSet:
            gDiagram = {'code': getClassName(pDiag.code), 
               'label': pDiag.code, 
            ...
            for pDiagEntity in pDiag.diagramentity_set.all():
                ...
                for pProperty in pEntity.property_set.all():
                    ...
                    if pProperty.isForeign:
                        ...
                        gEntity['relations'].append({'code': pptCode, 
                           'type': pType, 
                        ...
                        gEntity['fields'].append({'code': pptCode, 
