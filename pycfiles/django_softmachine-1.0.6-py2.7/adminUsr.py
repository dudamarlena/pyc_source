...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/protoLib/admin/adminUsr.py
# Compiled at: 2014-05-29 10:16:48
AdminUser = {'__ptType': 'pcl', 
   'viewCode': 'auth.User', 
   ...
   'actions': [], 'detailsConfig': [
                   ...
                   {'__ptType': 'detailDef', 
                      ...
                      'masterField': 'pk'}], 
   'sheetConfig': [], 'gridConfig': {'__ptType': 'gridConfig', 
                  'listDisplay': [
                                'username', 'email', 'first_name', 'last_name', 'is_staff', 'is_active', 'is_superuser'], 
                  'baseFilter': [], 'initialFilter': [], 'initialSort': [], 'searchFields': [
                                 'username', 'first_name', 'last_name', 'password', 'is_staff', 'is_active', 'is_superuser', 'last_login', 'date_joined'], 
                  'sortFields': [
                               'username', 'first_name', 'last_name', 'password', 'is_staff', 'is_active', 'is_superuser', 'last_login', 'date_joined'], 
                  'hiddenFields': [
                                 'id'], 
                  ...
                  'items': [
                          ...
                          {'__ptType': 'fieldset', 
                             ...
                             'items': [
                                     ...
                                     {'__ptType': 'formField', 
                                        'name': 'date_joined'}]}]}, 
   'custom': {'filtersSet': [], 'listDisplaySet': [], 'sortersSet': []}}