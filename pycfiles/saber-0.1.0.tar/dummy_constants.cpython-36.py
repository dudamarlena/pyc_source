...
# [GCC 8.4.0]
# Embedded file name: /Users/johngiorgi/Documents/Masters/Class/natural_language_computing/project/saber/saber/tests/resources/dummy_constants.py
# Compiled at: 2019-01-12 11:35:09
...
DUMMY_TOKEN_MAP = {'<PAD>':0, 
 '<UNK>':1,  'the':2,  'quick':3,  'brown':4,  'fox':5}
DUMMY_CHAR_MAP = {'<PAD>':0,  '<UNK>':1,  'r':2,  'u':3,  'c':4,  'f':5,  'e':6,  'o':7,  'x':8,  'h':9, 
 'b':10,  'n':11,  'w':12,  'i':13,  't':14,  'q':15,  'k':16}
DUMMY_EMBEDDINGS_INDEX = {'the':[
...
DUMMY_TAG_SEQ = np.array([
 ...
 [
  ...
  'O', 'O', 'O']])
DUMMY_WORD_TYPES = [
 'Human', 'APC2', 'maps', 'to', 'chromosome', '19p13', '.', 'The', 'absence',
...
CONFIG_SECTIONS = [
 'mode', 'data', 'model', 'training', 'advanced']
...
DUMMY_ARGS_NO_CLI_ARGS = {'model_name':'bilstm-crf-ner', 
 ...
 'decay':0.0, 
 'grad_norm':1.0, 
 'dropout_rate':{'input':0.3, 
  'output':0.3,  'recurrent':0.1}, 
 'batch_size':32, 
 'k_folds':2, 
 'epochs':50, 
 'criteria':'exact', 
...
DUMMY_ARGS_WITH_CLI_ARGS = {'model_name':'bilstm-crf-ner', 
 ...
 'decay':0.5, 
 'grad_norm':1.0, 
 'dropout_rate':{'input':0.6, 
  'output':0.6,  'recurrent':0.2}, 
 'batch_size':32, 
 'k_folds':2, 
 'epochs':50, 
 'criteria':'exact', 
