...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/turingmarkov/tests/test_turing.py
# Compiled at: 2015-06-18 05:05:06
...
class TestMachine:
    __doc__ = 'Test case for Machine class.'
    machine = None
    ...
    def test_machine_syntax(self):
        ...
        with raises(SyntaxError):
            self.machine.add_state('0  ,R,  ,R,  ,R,  a,N,!')
        with raises(SyntaxError):
            self.machine.add_state('1  R,  ,R,  ,R,  a,N,!')
        with raises(SyntaxError):
            self.machine.add_state('2  ,,R,  ,R,  ,R,  a,N,!')
        with raises(SyntaxError):
            self.machine.add_state('3  ,R, ,R,  ,R,  ,R,  a,N,!')
        with raises(SyntaxError):
            self.machine.add_state('4  ,R,  ,,  ,R,  a,N,!')
        with raises(SyntaxError):
            self.machine.add_state('5  ,R,  ,R,  a,N,!')
