...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/turingmarkov/tests/test_markov.py
# Compiled at: 2015-06-18 05:36:17
...
class TestAlgorithm:
    __doc__ = 'Test case for methods: add_rule, execute, execute_once.'
    algo = None
