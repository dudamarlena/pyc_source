...
# [GCC 8.4.0]
# Embedded file name: /home/tim/unleashed/django-smsgateway/smsgateway/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    dependencies = []
    operations = [
     migrations.CreateModel(name='QueuedSMS',
       fields=[
      (
      ...
      'verbose_name_plural':'Queued SMSes'},
       bases=(
      models.Model,)),
     migrations.CreateModel(name='SMS',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
