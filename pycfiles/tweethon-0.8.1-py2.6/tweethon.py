...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/tweethon.py
# Compiled at: 2009-09-29 20:59:30
...
import os, rfc822, sys, tempfile, textwrap, time, urllib, urllib2, urlparse, gzip, StringIO, datetime
CHARACTER_LIMIT = 140
...
class Status(object):
    ...
    def __init__(self, created_at=None, favorited=None, id=None, text=None, location=None, user=None, in_reply_to_screen_name=None, in_reply_to_user_id=None, in_reply_to_status_id=None, truncated=None, source=None, now=None):
    ...
    def GetRelativeCreatedAt(self):
        ...
        if delta < 1 * fudge:
            ...
            if delta < 3600 * (1 / fudge):
                return 'about %d minutes ago' % (delta / 60)
            if delta < 3600 * fudge:
                return 'about an hour ago'
            if delta < 86400 * (1 / fudge):
                return 'about %d hours ago' % (delta / 3600)
            if delta < 86400 * fudge:
                return 'about a day ago'
            return 'about %d days ago' % (delta / 86400)

    relative_created_at = property(GetRelativeCreatedAt, doc='Get a human readable string representingthe posting time')
    ...
    def NewFromJsonDict(data):
        ...
        if 'user' in data:
            ...
            user = None
        return Status(created_at=data.get('created_at', None), favorited=data.get('favorited', None), id=data.get('id', None), text=data.get('text', None), location=data.get('location', None), in_reply_to_screen_name=data.get('in_reply_to_screen_name', None), in_reply_to_user_id=data.get('in_reply_to_user_id', None), in_reply_to_status_id=data.get('in_reply_to_status_id', None), truncated=data.get('truncated', None), source=data.get('source', None), user=user)
...
class User(object):
    ...
    screen_name = property(GetScreenName, SetScreenName, doc='The short username of this user.')
    ...
    created_at = property(GetCreatedAt, SetCreatedAt, doc='The time this user was created.')
    ...
    created_at_in_seconds = property(GetCreatedAtInSeconds, doc='The time this user was created,in seconds since the epoch')
    ...
    relative_created_at = property(GetRelativeCreatedAt, doc='Get a human readable string representingthe creation time of this user')
    ...
    now = property(GetNow, SetNow, doc='The wallclock time for this user instance.')
...
class Api(object):
    ...
    def __init__(self, username=None, password=None, input_encoding=None, request_headers=None, base_url='http://twitter.com'):
    ...
    def GetPublicTimeline(self, since_id=None):
        ...
        return self._FetchUrlAndParse(url, Status.NewFromJsonDict, many=True, parameters=parameters)
    ...
    def GetFriendsTimeline(self, user=None, count=None, since=None, page=None, since_id=None, max_id=None):
    ...
    def GetUserTimeline(self, user=None, count=None, since=None, since_id=None, max_id=None, page=None):
    ...
    def GetStatus(self, id):
        ...
        return self._FetchUrlAndParse(url, Status.NewFromJsonDict)
    ...
    def DestroyStatus(self, id):
        ...
        return self._FetchUrlAndParse(url, Status.NewFromJsonDict, post_data={})
    ...
    def PostUpdate(self, status, in_reply_to_status_id=None):
        ...
        return self._FetchUrlAndParse(url, Status.NewFromJsonDict, post_data=data)
    ...
    def GetFriends(self, user=None, page=None):
        ...
        if page:
            parameters['page'] = page
        return self._FetchUrlAndParse(url, User.NewFromJsonDict, many=True, parameters=parameters)
    ...
    def GetFeatured(self):
        ...
        return self._FetchUrlAndParse(url, User.NewFromJsonDict, many=True)
    ...
    def GetUser(self, user):
        ...
        return self._FetchUrlAndParse(url, User.NewFromJsonDict)
    ...
    def GetDirectMessages(self, since=None, since_id=None, page=None):
        ...
        if page:
            parameters['page'] = page
        return self._FetchUrlAndParse(url, DirectMessage.NewFromJsonDict, many=True, parameters=parameters)
    ...
    def PostDirectMessage(self, user, text):
        ...
        return self._FetchUrlAndParse(url, DirectMessage.NewFromJsonDict, post_data=data)
    ...
    def DestroyDirectMessage(self, id):
        ...
        return self._FetchUrlAndParse(url, DirectMessage.NewFromJsonDict, post_data={})
    ...
    def CreateFriendship(self, user):
        ...
        return self._FetchUrlAndParse(url, User.NewFromJsonDict, post_data={})
    ...
    def _FetchUrlAndParse(self, url, factory, many=False, post_data=None, parameters=None, no_cache=None, use_gzip_compression=False):
...
class _TwistedOpener(object):
    ...
    def read(self):
        ...
        return self.getPage(self.url, headers=hdrs, method=method, postdata=self.data)
...
class TwistedApi(Api):
    ...
    def _FetchAndParseUrl(self, url, factory, many=False, post_data=None, parameters=None, no_cache=None, use_gzip_compression=False):
