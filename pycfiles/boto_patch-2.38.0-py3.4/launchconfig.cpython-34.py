...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/ec2/autoscale/launchconfig.py
...
class LaunchConfiguration(object):
    ...
    def startElement(self, name, attrs, connection):
        ...
        if name == 'ClassicLinkVPCSecurityGroups':
            return self.classic_link_vpc_security_groups
        if name == 'BlockDeviceMappings':
    ...
    def endElement(self, name, value, connection):
        if name == 'InstanceType':
            ...
            if name == 'LaunchConfigurationName':
                self.name = value
            else:
                if name == 'KeyName':
                    self.key_name = value
                        ...
                        if name == 'CreatedTime':
                            ...
                            if name == 'KernelId':
                                ...
                                if name == 'RamdiskId':
                                    ...
                                    if name == 'LaunchConfigurationARN':
                                            ...
                                            if name == 'SpotPrice':
                                                ...
                                                if name == 'IamInstanceProfile':
                                                    ...
                                                    if name == 'EbsOptimized':
                                                        ...
                                                        if name == 'AssociatePublicIpAddress':
