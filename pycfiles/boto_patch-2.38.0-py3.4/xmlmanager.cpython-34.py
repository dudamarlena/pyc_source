...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/sdb/db/manager/xmlmanager.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 18612 bytes
import boto
    ...
    def __init__(self, manager):
        ...
        self.type_map = {bool: (self.encode_bool, self.decode_bool),  int: (
         ...
         Key: (
               self.encode_reference, self.decode_reference), 
         Password: (
                    self.encode_password, self.decode_password), 
         datetime: (
