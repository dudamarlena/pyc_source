...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/ec2/cloudwatch/alarm.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 12192 bytes
...
class MetricAlarm(object):
    ...
    _cmp_map = {'>=': 'GreaterThanOrEqualToThreshold', 
    ...
    def startElement(self, name, attrs, connection):
        ...
        if name == 'InsufficientDataActions':
    ...
    def endElement(self, name, value, connection):
        if name == 'ActionsEnabled':
            ...
            if name == 'AlarmArn':
                ...
                if name == 'AlarmConfigurationUpdatedTimestamp':
                    self.last_updated = value
                else:
                    if name == 'AlarmDescription':
