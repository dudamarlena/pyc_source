...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/s3/acl.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 5716 bytes
...
class ACL(object):
    ...
    def add_email_grant(self, permission, email_address):
        grant = Grant(permission=permission, type='AmazonCustomerByEmail', email_address=email_address)
        self.grants.append(grant)
...
class Grant(object):
    ...
    def __init__(self, permission=None, type=None, id=None, display_name=None, uri=None, email_address=None):
