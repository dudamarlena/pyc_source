...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/mturk/question.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 16126 bytes
...
class List(list):
    __doc__ = 'A bulleted list suitable for OrderedContent or Overview content'
...
class Constraint(object):
    ...
    def get_attributes(self):
        ...
        attrs = ' '.join('%s="%d"' % (name, value) for name, value in pairs if value is not None)
        return attrs
...
class FileUploadAnswer(object):
    ...
    def __init__(self, min_bytes, max_bytes):
        assert 0 <= min_bytes <= max_bytes <= 2000000000
