...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/parser_test.py
# Compiled at: 2019-03-10 21:31:38
# Size of source mod 2**32: 20213 bytes
...
def test_parse_text():
    ...
    tpl_s = {'name':'tian_cdrOb', 
     'itemname':'CallRecordItem', 
     'parent':{'json_key': 'data'}, 
     'fields':[
      {'description':'客户电话', 
       'key':'customer_number', 
