...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/parser_engine/parser.py
# Compiled at: 2019-04-16 05:55:04
# Size of source mod 2**32: 7978 bytes
import json, time, jsonpath_rw as jsonpath
...
class PEParser(object):
    ...
    def __init__(self, tpl=None, **kwargs):
        ...
        self._item_cls = self.item_loader.load(self.tpl.itemname)
    ...
    def cast(o, t):
        ...
        :param t: type
                    ...
                    long
                    float
                    striped_string:  maybe very useful in html to remove '
', '
', '    '
        :return:
        """
