...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbojson\jsonify.py
# Compiled at: 2011-08-07 13:53:11
...
@jsonify_default.when('obj is None or isinstance(obj, (basestring, bool, int, long, float, list, dict))')
...
try:
    ...
    def is_sqlobject(obj):
        return isinstance(obj, SQLObject) and hasattr(obj.__class__, 'sqlmeta')
...
try:
    ...
    try:
        ...
        def is_saobject(obj):
            return hasattr(obj, 'c') and isinstance(obj.c, OrderedProperties)
