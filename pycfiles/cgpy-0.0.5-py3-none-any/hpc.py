...
# Embedded file name: build\bdist.win32\egg\cgp\examples\hpc.py
# Compiled at: 2012-02-09 07:19:51
__doc__ = 'Demo of infrastructure for large-scale cGP studies.'
import numpy as np
from cgp.examples.basic import genotypes, gt2par, par2ph, ph2agg, summarize

def hdfcaching():
    """Auto-cache/save results to HDF."""
    import os, tables as pt
