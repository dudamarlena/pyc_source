...
# Embedded file name: build\bdist.win32\egg\cgp\cvodeint\namedcvodeint.py
# Compiled at: 2013-01-14 06:47:43
__doc__ = 'Cvode wrapper with named state variables and parameters.'
...
class Namedcvodeint(Cvodeint):
    ...
    def __init__(self, f_ode=None, t=None, y=None, p=None, *args, **kwargs):
        ...
        if p is None:
            p = np.zeros(0)
        super(Namedcvodeint, self).__init__(f_ode, t, y.view(float), *args, **kwargs)
    ...
    def integrate(self, **kwargs):
        ...
        """
        assert all(self.__dict__[k] is v for k, v in self.originals.items()), self.reassignwarning
    ...
    def autorestore(self, _p=None, _y=None, **kwargs):
        ...
        for k, v in kwargs.items():
            ...
            raise TypeError('Key %s occurs in both parameter and state vectors' % k)
    ...
    def clamp(self, **kwargs):
        ...
        Namedcvodeint.__init__(clamped_model, clamped, self.t, y, self.pr, **oldkwargs)
