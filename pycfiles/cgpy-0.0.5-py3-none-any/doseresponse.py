...
# Embedded file name: build\bdist.win32\egg\cgp\sigmoidmodels\doseresponse.py
# Compiled at: 2013-01-14 06:47:43
__doc__ = 'Functions for modelling dose-response relationships in sigmoid models'
...
def R_logic(Z1, Z2, index, name=False):
    ...
    """
    if name:
        func = dict({'1': 'AND(X1,X2)', '2': 'AND(X1,NOT(X2))', 
           '3': 'AND(NOT(X1),X2)', 
           '4': 'AND(NOT(X1),NOT(X2))', 
           '5': 'X1', 
           '6': 'X2', 
