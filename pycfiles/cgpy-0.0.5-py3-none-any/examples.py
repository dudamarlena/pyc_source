...
# Embedded file name: build\bdist.win32\egg\cgp\virtexp\elphys\examples.py
...
class Tentusscher(Cellmlmodel, Paceable, Clampable):
    ...
    def __init__(self, workspace='tentusscher_noble_noble_panfilov_2004', rename={'y': {'Na_i': 'Nai', 'Ca_i': 'Cai', 'K_i': 'Ki'}, 'p': {'IstimStart': 'stim_start', 
         'IstimEnd': 'stim_end', 
         'IstimAmplitude': 'stim_amplitude', 
         'IstimPeriod': 'stim_period', 
         'IstimPulseDuration': 'stim_duration'}}, **kwargs):
...
class Bond(Cellmlmodel, Paceable, Clampable):
    ...
    * :cellml:`CellML implementation 
    ...
    def __init__(self, workspace='bondarenko_szigeti_bett_kim_rasmusson_2004', *args, **kwargs):
        ...
        for variant in self.get_variants():
            ...
            self.scenarios[name] = dict(workspace=self.workspace, exposure=self.exposure, changeset=self.changeset, variant=variant, y=self.y0r.copy(), p=self.pr.copy())
    ...
    def scenario(self, name=None, **kwargs):
        ...
        ('septal', {'changeset': '99f4fd6804311c571a7143515003691ab2e430fb', 
            ...
            'exposure': '11df840d0150d34c9716cd4cbdd164c8'})])
        """
        return self.autorestore(_y=self.scenarios[name].get('y'), _p=self.scenarios[name].get('p'), **kwargs)
...
class Fitz(Bond):
    ...
    *stim_duration* and *stim_amplitude* were copied directly from the 
    ...
    def __init__(self, localfile='fitzhugh_1961', rename={'y': {'v': 'V'}}, **kwargs):
        """
