...
# [GCC 8.4.0]
# Embedded file name: /Volumes/Ozgur/Sites/senpilic.com.tr/senpilic/slideshow/views.py
# Compiled at: 2012-09-24 09:16:21
try:
    import json
except ImportError:
...
def get_obj(content_type_id, object_id):
    obj_dict = {'content_type_id': content_type_id, 
       'object_id': object_id}
