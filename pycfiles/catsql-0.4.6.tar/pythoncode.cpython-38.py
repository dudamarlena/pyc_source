...
def _execfile--- This code section failed: ---
 ...
 L.  32         0  LOAD_FAST                'args'
                2  LOAD_CONST               0
                4  BINARY_SUBSCR    
                6  STORE_FAST               'fn'

 L.  33         8  LOAD_GLOBAL              open
               10  LOAD_FAST                'fn'
               12  CALL_FUNCTION_1       1  ''
               14  SETUP_WITH           38  'to 38'
               16  STORE_FAST               'f'

 L.  34        18  LOAD_GLOBAL              compile
               20  LOAD_FAST                'f'
               22  LOAD_METHOD              read
               24  CALL_METHOD_0         0  ''
               26  LOAD_FAST                'fn'
...
def handle_check--- This code section failed: ---
 ...
 L. 160         0  SETUP_FINALLY        44  'to 44'

 L. 161         2  LOAD_FAST                'info'
 ...
 L. 165        50  LOAD_CONST               0

 L. 166        52  LOAD_STR                 '<div class="bs-callout bs-callout-danger"><span class="text-danger"><b>Error:</b> Unable to decode the specified file.  Is this the file you intended to upload?</span></div>'

 L. 164        54  LOAD_CONST               ('score', 'msg')
 ...
 L. 169        66  LOAD_STR                 '\n\n'
               68  LOAD_METHOD              join
               70  LOAD_STR                 'import os\nos.unlink(__file__)'
               72  LOAD_FAST                'info'
               74  LOAD_STR                 'csq_code_pre'
               76  BINARY_SUBSCR    
               78  LOAD_FAST                'code'
               80  BUILD_LIST_3          3 
               82  CALL_METHOD_1         1  ''
 ...
 L. 171        86  LOAD_GLOBAL              get_sandbox
               88  LOAD_FAST                'info'
               90  CALL_FUNCTION_1       1  ''
               92  POP_TOP          

 L. 172        94  LOAD_FAST                'info'
               96  LOAD_STR                 'sandbox_run_code'
               98  BINARY_SUBSCR    
              100  LOAD_FAST                'info'
              102  LOAD_FAST                'code'
              104  LOAD_FAST                'info'
              106  LOAD_METHOD              get
              108  LOAD_STR                 'csq_sandbox_options'
              110  BUILD_MAP_0           0 
              112  CALL_METHOD_2         2  ''
              114  CALL_FUNCTION_3       3  ''
              116  STORE_FAST               'results'

 L. 174       118  LOAD_FAST                'info'
              120  LOAD_STR                 'fix_error_msg'
              122  BINARY_SUBSCR    

 L. 175       124  LOAD_FAST                'results'
              126  LOAD_STR                 'fname'
              128  BINARY_SUBSCR    

 L. 175       130  LOAD_FAST                'results'
              132  LOAD_STR                 'err'
              134  BINARY_SUBSCR    

 L. 175       136  LOAD_FAST                'info'
              138  LOAD_STR                 'csq_code_pre'
              140  BINARY_SUBSCR    
              142  LOAD_METHOD              count
              144  LOAD_STR                 '\n'
              146  CALL_METHOD_1         1  ''
              148  LOAD_CONST               2
              150  BINARY_ADD       

 L. 175       152  LOAD_FAST                'code'

 L. 174       154  CALL_FUNCTION_4       4  ''
              156  STORE_FAST               'err'

 L. 178       158  LOAD_FAST                'results'
              160  LOAD_METHOD              get
              162  LOAD_STR                 'info'
              164  BUILD_MAP_0           0 
              166  CALL_METHOD_2         2  ''
              168  LOAD_METHOD              get
              170  LOAD_STR                 'complete'
              172  LOAD_CONST               False
              174  CALL_METHOD_2         2  ''
              176  STORE_FAST               'complete'

 L. 180       178  LOAD_CONST               False
              180  STORE_FAST               'trunc'

 L. 181       182  LOAD_FAST                'results'
              184  LOAD_STR                 'out'
              186  BINARY_SUBSCR    
              188  LOAD_METHOD              split
              190  LOAD_STR                 '\n'
              192  CALL_METHOD_1         1  ''
              194  STORE_FAST               'outlines'

 L. 182       196  LOAD_GLOBAL              len
              198  LOAD_FAST                'outlines'
              200  CALL_FUNCTION_1       1  ''
              202  LOAD_CONST               10
              204  COMPARE_OP               >
              206  POP_JUMP_IF_FALSE   224  'to 224'

 L. 183       208  LOAD_CONST               True
              210  STORE_FAST               'trunc'

 L. 184       212  LOAD_FAST                'outlines'
              214  LOAD_CONST               None
              216  LOAD_CONST               10
              218  BUILD_SLICE_2         2 
              220  BINARY_SUBSCR    
              222  STORE_FAST               'outlines'
            224_0  COME_FROM           206  '206'

 L. 185       224  LOAD_STR                 '\n'
              226  LOAD_METHOD              join
              228  LOAD_FAST                'outlines'
              230  CALL_METHOD_1         1  ''
              232  STORE_FAST               'out'

 L. 186       234  LOAD_GLOBAL              len
              236  LOAD_FAST                'out'
 ...
 L. 187       248  LOAD_CONST               True
              250  STORE_FAST               'trunc'

 L. 188       252  LOAD_FAST                'out'
              254  LOAD_CONST               None
              256  LOAD_CONST               5000
              258  BUILD_SLICE_2         2 
              260  BINARY_SUBSCR    
 ...
 L. 189       264  LOAD_FAST                'trunc'
          266_268  POP_JUMP_IF_FALSE   278  'to 278'

 L. 190       270  LOAD_FAST                'out'
              272  LOAD_STR                 '\n\n...OUTPUT TRUNCATED...'
              274  INPLACE_ADD      
              276  STORE_FAST               'out'
            278_0  COME_FROM           266  '266'

 L. 192       278  LOAD_CONST               False
              280  STORE_FAST               'timeout'

 L. 193       282  LOAD_FAST                'complete'
          284_286  POP_JUMP_IF_TRUE    306  'to 306'
              288  LOAD_STR                 'SIGTERM'
              290  LOAD_FAST                'err'
              292  COMPARE_OP               in
          294_296  POP_JUMP_IF_FALSE   306  'to 306'

 L. 194       298  LOAD_CONST               True
              300  STORE_FAST               'timeout'

 L. 196       302  LOAD_STR                 'Your code did not run to completion, but no error message was returned.\nThis normally means that your code contains an infinite loop or otherwise took too long to run.'

 L. 195       304  STORE_FAST               'err'
            306_0  COME_FROM           294  '294'
            306_1  COME_FROM           284  '284'

 L. 202       306  LOAD_STR                 '<div class="response">'
              308  STORE_FAST               'msg'

 L. 203       310  LOAD_FAST                'timeout'
          312_314  POP_JUMP_IF_TRUE    356  'to 356'

 L. 204       316  LOAD_FAST                'msg'
              318  LOAD_STR                 '<p><b>'
              320  INPLACE_ADD      
              322  STORE_FAST               'msg'

 L. 205       324  LOAD_FAST                'complete'
          326_328  POP_JUMP_IF_FALSE   340  'to 340'

 L. 206       330  LOAD_FAST                'msg'
              332  LOAD_STR                 '<font color="darkgreen">Your code ran to completion.</font>'
              334  INPLACE_ADD      
              336  STORE_FAST               'msg'
              338  JUMP_FORWARD        348  'to 348'
            340_0  COME_FROM           326  '326'

 L. 208       340  LOAD_FAST                'msg'
              342  LOAD_STR                 '<font color="red">Your code did not run to completion.</font>'
              344  INPLACE_ADD      
              346  STORE_FAST               'msg'
            348_0  COME_FROM           338  '338'

 L. 209       348  LOAD_FAST                'msg'
              350  LOAD_STR                 '</b></p>'
              352  INPLACE_ADD      
              354  STORE_FAST               'msg'
            356_0  COME_FROM           312  '312'

 L. 210       356  LOAD_FAST                'out'
              358  LOAD_STR                 ''
              360  COMPARE_OP               !=
          362_364  POP_JUMP_IF_FALSE   390  'to 390'

 L. 211       366  LOAD_FAST                'msg'
              368  LOAD_STR                 '\n<p><b>Your code produced the following output:</b>'
              370  INPLACE_ADD      
              372  STORE_FAST               'msg'

 L. 212       374  LOAD_FAST                'msg'
              376  LOAD_STR                 '<br/><pre>%s</pre></p>'
              378  LOAD_GLOBAL              html_format
              380  LOAD_FAST                'out'
 ...
 L. 213       390  LOAD_FAST                'err'
              392  LOAD_STR                 ''
              394  COMPARE_OP               !=
          396_398  POP_JUMP_IF_FALSE   430  'to 430'

 L. 214       400  LOAD_FAST                'timeout'
          402_404  POP_JUMP_IF_TRUE    414  'to 414'

 L. 215       406  LOAD_FAST                'msg'
              408  LOAD_STR                 '\n<p><b>Your code produced an error:</b>'
              410  INPLACE_ADD      
              412  STORE_FAST               'msg'
            414_0  COME_FROM           402  '402'

 L. 216       414  LOAD_FAST                'msg'
              416  LOAD_STR                 "\n<br/><font color='red'><tt>%s</tt></font></p>"
              418  LOAD_GLOBAL              html_format
              420  LOAD_FAST                'err'
              422  CALL_FUNCTION_1       1  ''
              424  BINARY_MODULO    
              426  INPLACE_ADD      
              428  STORE_FAST               'msg'
            430_0  COME_FROM           396  '396'

 L. 217       430  LOAD_FAST                'msg'
              432  LOAD_STR                 '</div>'
              434  INPLACE_ADD      
              436  STORE_FAST               'msg'

 L. 219       438  LOAD_FAST                'msg'
              440  RETURN_VALUE     
               -1  RETURN_LAST      
...
def handle_submission--- This code section failed: ---
 ...
 L. 453      1936  LOAD_GLOBAL              total_test_points
             ...
             1940  LOAD_FAST                'info'
             1942  CALL_FUNCTION_EX_KW     1  'keyword args'
             1944  STORE_FAST               'tp'
...
Parse error at or near `ROT_FOUR' instruction at offset 90
    ...
    for ix, i in enumerate(show_tests):
        ...
        if i['include_soln']:
            if 'cached_result' in i:
                ...
                out_s, err_s, log_s = info['sandbox_run_test']infoinfo['csq_soln']i
