...
# Embedded file name: build/bdist.linux-x86_64/egg/cantools/db/sql/properties.py
# Compiled at: 2019-10-13 21:08:23
...
def sqlForeignKey(targetClass, **kwargs):
    return sqlalchemy.Column(sqlInteger, sqlalchemy.ForeignKey('%s.index' % (targetClass.__tablename__,)), **kwargs)