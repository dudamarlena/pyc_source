...
# [GCC 8.4.0]
# Embedded file name: /home/winkidney/.virtualenvs/side-project/lib/python2.7/site-packages/cmdtree/tree.py
# Compiled at: 2016-09-22 05:33:38
...
class CmdTree(object):
    ...
    def __init__(self, root_parser=None):
        ...
        if root_parser is not None:
            ...
            self.root = AParser()
        self.tree = {'name': 'root', 'cmd': self.root, 
           'children': {}}
        return
    ...
    def get_cmd_by_path(self, existed_cmd_path):
        ...
        for cmd_name in existed_cmd_path:
            try:
                ...
                raise ValueError('Given key [%s] in path %s does not exist in tree.' % (
