...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/fedservice/metadata_api/fs2.py
# Compiled at: 2019-12-03 15:19:02
...
class FSEntityStatementAPI(EntityStatementAPI):
    ...
    def gather_info(self, sub):
        ...
        elif sub.startswith('https%3A%2F%2F'):
        ...
        data = {}
        for name, file in (('metadata', 'metadata.json'), ('metadata_policy', 'policy.json'),
                           ('constraints', 'constraints.json'), ('authority_hints', 'authority.json')):
