...
# [GCC 8.4.0]
# Embedded file name: /Users/Larco/Documents/Github/pyvenom/framework/venom/routing/routes.py
# Compiled at: 2016-04-26 14:29:46
import Parameters, Protocols
...
class Path(str):
    ...
    def get_parameters(self, path):
        desired_path = self._traverse_path(self)
        given_path = self._traverse_path(path)
        return {desired[1:]:given for desired, given in zip(desired_path, given_path) if desired.startswith(':') if desired.startswith(':')}
