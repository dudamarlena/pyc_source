...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/djangoflash/middleware.py
# Compiled at: 2011-02-12 10:13:00
"""
...
def _should_update_flash(request):
    ...
    """
    return not _is_trailing_slash_missing(request) and not _is_request_to_serve(request)
