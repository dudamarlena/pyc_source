...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/perms/templatetags/perm_tags.py
...
def obj_perms(obj):
    ...
    if obj.allow_anonymous_view:
        ...
        if obj.allow_user_view:
            ...
            if obj.allow_member_view:
                value = t % ('members', 'Members')
            else:
                if groups_with_perms(obj):
