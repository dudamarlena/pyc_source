...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/libs/uploader/fine_uploader/views.py
# Compiled at: 2020-02-11 12:52:19
# Size of source mod 2**32: 4521 bytes
import json, logging, os, os.path, shutil
...
def handle_upload(f, fileattrs):
    ...
    if chunked:
        if fileattrs['qqtotalparts'] - 1 == fileattrs['qqpartindex']:
            ...
            utils.combine_chunks((fileattrs['qqtotalparts']), (fileattrs['qqtotalfilesize']),
