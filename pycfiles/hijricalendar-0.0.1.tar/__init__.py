...
# [GCC 8.4.0]
# Embedded file name: /home/hmtanbir/www7/python/hijricalendar/hijricalendar/__init__.py
# Compiled at: 2018-02-21 12:45:44
import bangla
from umalqurra.hijri_date import HijriDate
bangla_weekdays = bangla.python_bangla_weekdays
month_name_dict_en = {1: 'Muharram', 
   2: 'Safar', 
   3: 'Rabi-ul-Awwal', 
   4: 'Rabi-us-Sani', 
   5: 'Jamadi-ul-Awwal', 
...
month_name_dict_bn = {1: 'মহরম', 
   ...
   11: 'জিলক্বাদ', 
   12: 'জিলহাজ্জ্ব'}
weekdays_dict = {'Monday': bangla_weekdays[0], 
...
def get_date(passed_date=None, passed_month=None, passed_year=None, en=False, arabic=False):
    ...
    hijri_date_month_year_bn = {'date': bangla.convert_english_digit_to_bangla_digit(passed_date), 
    ...
    hijri_date_month_year_en = {'date': passed_date, 
       'month': passed_month, 
       'year': passed_year, 
       'weekday': passed_week}
    if en == 1:
