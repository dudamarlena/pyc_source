...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/djangosanetesting/selenium/driver.py
# Compiled at: 2010-08-20 08:39:20
"""
...
class selenium:
    ...
    *   \ **exact:**\ \ *string*:
    ...
    def do_command(self, verb, args):
        ...
        body = 'cmd=' + urllib.quote_plus(unicode(verb).encode('utf-8'))
    ...
    def capture_screenshot(self, filename):
        ...
        'filename' is the absolute path to the file to be written, e.g. "c:\x08lah\\screenshot.png"
        """
