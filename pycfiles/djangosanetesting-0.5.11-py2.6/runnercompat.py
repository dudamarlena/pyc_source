...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/djangosanetesting/runnercompat.py
# Compiled at: 2011-05-02 08:52:41
import sys, signal, unittest
...
class DjangoTestRunner(unittest.TextTestRunner):
    ...
    def _makeResult(self):
        ...
        def stoptest_override(func):
            ...
            def stoptest(test):
                if failfast and not result.wasSuccessful() or self._keyboard_interrupt_intercepted:
                    result.stop()
                func(test)
