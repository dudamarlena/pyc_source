...
# [GCC 8.4.0]
# Embedded file name: /Users/aaronrusso/Alma Mater Studiorum Università di Bologna/Andrea Zanellini - Data Analysis/Workspace/Aaron/libraries development/ubm-python-libraries/ubm/acquisition/filter.py
# Compiled at: 2018-01-07 06:35:49
# Size of source mod 2**32: 3368 bytes
import scipy.signal as signal, numpy as np
...
class Filter:
    ...
    def __init__(self):
        ...
        self.data = []
        self._diff = None
        self.PARAMETERS = {self.TYPE_SGOLAY: {self.PARAM_WINDOW_LENGTH: 31, 
                            self.PARAM_POLY_ORDER: 5}, 
         
         self.TYPE_MEDIAN: {self.PARAM_WINDOW_LENGTH: 31}}
