...
# [GCC 8.4.0]
# Embedded file name: /Users/aaronrusso/Alma Mater Studiorum Università di Bologna/Andrea Zanellini - Data Analysis/Workspace/Aaron/libraries development/ubm-python-libraries/ubm/acquisition/dataset/components/vehicle.py
# Compiled at: 2018-01-23 06:24:43
...
class Speed:
    ...
    def __init__(self, dataset):
        ...
        self.phonic_wheels = {self.FRONT_LEFT: PhonicWheel(self.dataset, self.FRONT_LEFT), 
    ...
    def get(self):
        to_average = [
         self.get_sensor(self.FRONT_LEFT).get(), self.get_sensor(self.FRONT_RIGHT).get()]
