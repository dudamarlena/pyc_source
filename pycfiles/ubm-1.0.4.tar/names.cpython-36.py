...
# [GCC 8.4.0]
# Embedded file name: /Users/aaronrusso/Alma Mater Studiorum Università di Bologna/Andrea Zanellini - Data Analysis/Workspace/Aaron/libraries development/ubm-python-libraries/ubm/acquisition/dataset/names.py
# Compiled at: 2018-01-25 10:55:23
...
class Names:
    ...
    Driver = {'SteeringAngle':'SteeringAngle', 
     'Throttle':'Throttle', 
     'Brakes':('PbrakeFrontBar', 'PbrakeRearBar')}
    Engine = {'Cylinder':{'Lambda':('Lambdacyl1', 'Lambdacyl2', 'Lambdacyl3', 'Lambdacyl4'), 
