...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\stacklesslib\wait.py
...
"""
import sys, traceback, itertools, stackless, stacklesslib.util
        ...
        if func:
            ...
            def helper(*args, **kwargs):
                try:
                    ...
                    self._error = (
                     CancelledError, CancelledError(e), sys.exc_info()[2])
                except:
