...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\stacklesslib\util.py
# Compiled at: 2017-12-11 20:29:23
import sys, stackless, contextlib, weakref, collections
from . import main
...
def tasklet_call(function, args=(), kwargs={}, dispatcher=tasklet_run, timeout=None, on_abandoned=None):
