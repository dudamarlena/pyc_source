...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\stacklesslib\test\test_wait.py
# Compiled at: 2017-12-11 20:12:50
import unittest, logging, itertools, contextlib, weakref, stackless, stacklesslib.wait, stacklesslib.app, stacklesslib.errors, stacklesslib.base, stacklesslib.main
