...
# [GCC 8.4.0]
# Embedded file name: /Users/big/ENV2/lib/python2.7/site-packages/cloudmesh_vagrant/cm_vbox.py
# Compiled at: 2016-05-26 19:47:46
...
def do_vbox(argv):
    ...
    arg.all = arg['--all']
    if arg.version:
        versions = {'vagrant': {'attribute': 'Vagrant Version', 
                       'version': vagrant.version()}, 
           'cloudmesh-vbox': {'attribute': 'cloudmesh vbox Version', 
                              'version': __version__}}
        ...
        l = vagrant.vm.list()
        _LIST_PRINT(l, arg.format, order=[
        ...
        vagrant.vm.create(name=arg.NAME, memory=arg.memory, image=arg.image, script=arg.script)
    elif arg.config:
        ...
        vagrant.vm.boot(name=arg.NAME, memory=arg.memory, image=arg.image, script=arg.script, port=arg.port)
    elif arg.delete:
