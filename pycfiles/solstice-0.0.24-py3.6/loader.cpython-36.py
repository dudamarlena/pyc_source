...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/solstice/loader.py
...
def init(do_reload=False, import_libs=True, dev=False):
    ...
    if not dev:
        ...
        class SolsticeCore(importer.Importer):
        ...
        solstice_core_importer.import_packages(only_packages=False,
