...
# [GCC 8.4.0]
# Embedded file name: /var/makina/pasteStage/pasteFunBot/Paste-1.7.2-py2.6.egg/paste/translogger.py
...
class TransLogger(object):
    ...
    def write_log(self, environ, method, req_uri, start, status, bytes):
        ...
        if offset >= 0:
            ...
            offset = '%0.4d' % offset
        d = {'REMOTE_ADDR': environ.get('REMOTE_ADDR') or '-', 'REMOTE_USER': environ.get('REMOTE_USER') or '-', 
