...
# [GCC 8.4.0]
# Embedded file name: /var/makina/pasteStage/pasteFunBot/Paste-1.7.2-py2.6.egg/paste/debug/wdg_validate.py
...
class WDGValidateMiddleware(object):
    ...
    def add_error(self, html_page, html_errors):
        ...
        if match:
            return [
             html_page[:match.start()] + add_text + html_page[match.end():]]
        else:
            return [
             html_page + add_text]
