...
# [GCC 8.4.0]
# Embedded file name: /var/makina/pasteStage/pasteFunBot/Paste-1.7.2-py2.6.egg/paste/cgiapp.py
...
class CGIApplication(object):
    ...
    def __call__(self, environ, start_response):
        if 'REQUEST_URI' not in environ:
            environ['REQUEST_URI'] = environ.get('SCRIPT_NAME', '') + environ.get('PATH_INFO', '')
