...
# [GCC 8.4.0]
# Embedded file name: /var/makina/pasteStage/pasteFunBot/Paste-1.7.2-py2.6.egg/paste/auth/auth_tkt.py
...
class AuthTKTMiddleware(object):
    ...
    def __init__(self, app, secret, cookie_name='auth_tkt', secure=False, include_ip=True, logout_path=None):
        self.app = app
        self.secret = secret
        self.cookie_name = cookie_name
        self.secure = secure
