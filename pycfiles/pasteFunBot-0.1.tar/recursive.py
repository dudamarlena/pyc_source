...
# [GCC 8.4.0]
# Embedded file name: /var/makina/pasteStage/pasteFunBot/Paste-1.7.2-py2.6.egg/paste/recursive.py
...
class CheckForRecursionMiddleware(object):
    ...
    def __call__(self, environ, start_response):
        ...
        if path_info in self.env.get('paste.recursive.old_path_info', []):
            raise AssertionError('Forwarding loop detected; %r visited twice (internal redirect path: %s)' % (
