...
# [GCC 8.4.0]
# Embedded file name: /var/makina/pasteStage/pasteFunBot/Paste-1.7.2-py2.6.egg/paste/util/mimeparse.py
...
def quality_parsed(mime_type, parsed_ranges):
    ...
    for (type, subtype, params) in parsed_ranges:
        param_matches = sum([ 1 for (key, value) in target_params.iteritems() if key != 'q' if params.has_key(key) if value == params[key]
                            ])
