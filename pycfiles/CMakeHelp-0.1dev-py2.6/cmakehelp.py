...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/cmakehelp/cmakehelp.py
# Compiled at: 2010-01-01 01:38:27
import sys, cmd
...
class CMakeHelp(cmd.Cmd):
    ...
    def display_cmake_help(self, _type, keyword):
        ...
        """
        cmd_args = (
         self.cmake_cmd, _type, keyword, self.pager_cmd)
    ...
    def get_cmake_keywords(self, _type):
        ...
        """
        if _type not in self.keywords:
            cmd_args = (
             self.cmake_cmd, _type)
    ...
    def get_cmake_completions(self, _type, text):
        ...
        if not text:
            ...
            completions = [ keyword for keyword in keywords if keyword.startswith(text) ]
        return completions
