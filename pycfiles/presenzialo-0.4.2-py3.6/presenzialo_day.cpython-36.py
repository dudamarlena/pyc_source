...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/presenzialo/presenzialo_day.py
...
def add_parser_date(parser):
    ...
    date_parser.add_argument('--from',
      dest='day_from',
      type=_date,
      default=(datetime.date.today()),
      metavar='YYYY-MM-DD',
      help='from date YYYY-MM-DD')
    date_parser.add_argument('--to',
      dest='day_to',
      type=_date,
      default=(datetime.date.today()),
      metavar='YYYY-MM-DD',
...
def main():
    parser = argparse.ArgumentParser(prog='PRday',
