...
# [GCC 8.4.0]
# Embedded file name: /Users/byroot/src/github.com/byroot/pysrt/tests/test_srttime.py
...
class TestCoercing(unittest.TestCase):
    ...
    def test_from_dict(self):
        ...
        self.assertEqual(dict(hours=1, minutes=2, seconds=3, milliseconds=4), SubRipTime(1, 2, 3, 4))
