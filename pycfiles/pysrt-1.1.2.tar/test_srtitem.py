...
# [GCC 8.4.0]
# Embedded file name: /Users/byroot/src/github.com/byroot/pysrt/tests/test_srtitem.py
# Compiled at: 2016-09-14 02:55:39
import os, sys
...
class TestCPS(unittest.TestCase):
    ...
    def test_tags(self):
        self.item.text = '<b>bold</b>, <i>italic</i>, <u>underlined</u>\n' + '<font color="#ff0000">red text</font>' + ', <b>one,<i> two,<u> three</u></i></b>'
...
class TestSerialAndParsing(unittest.TestCase):
    ...
    def test_from_string(self):
        ...
        self.assertRaises(InvalidItem, SubRipItem.from_string, self.bad_string)
