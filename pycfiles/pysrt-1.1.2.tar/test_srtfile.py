...
# [GCC 8.4.0]
# Embedded file name: /Users/byroot/src/github.com/byroot/pysrt/tests/test_srtfile.py
# Compiled at: 2016-09-14 10:32:36
...
class TestOpen(unittest.TestCase):
    ...
    def test_error_handling(self):
        self.assertRaises(pysrt.Error, pysrt.open, self.invalid_path, error_handling=SubRipFile.ERROR_RAISE)
...
class TestDuckTyping(unittest.TestCase):
    ...
    def setUp(self):
        self.duck = pysrt.open(os.path.join(file_path, 'tests', 'static', 'utf-8.srt'))
