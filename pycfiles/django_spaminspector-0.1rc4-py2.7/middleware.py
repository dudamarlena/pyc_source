...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/spaminspector/middleware.py
# Compiled at: 2011-07-22 10:11:04
...
class SpamInspectionMiddleware(object):
    ...
    def __init__(self):
        kwargs = {'key': settings.SPAMINSPECTOR_AKISMET_KEY, 
    ...
    def _is_spam(self, request, profile):
        ...
        data = {'user_ip': request.META.get('REMOTE_ADDR', '127.0.0.1'), 
