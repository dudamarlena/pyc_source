...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/twizzle/utils.py
# Compiled at: 2019-06-24 18:49:59
# Size of source mod 2**32: 2796 bytes
""" This module defines many common utility functions used in the whole project
"""
...
def list_all_images_in_directory(sDirectoryPath):
    ...
    return [sDirectoryPathEscaped + m for m in aFiles if m.lower().endswith(('.png',
                                                                             '.bmp',
                                                                             '.jpg',
                                                                             '.jpeg',
                                                                             '.tiff'))]
