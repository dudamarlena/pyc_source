...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Admin\Documents\GitHub\maintenance\django_vehicles_maintenance\maintenance\main\views.py
...
def new_vehicleView(request):
    ...
    return render_to_response('new_vehicle.html', {'vehicleForm': vehicleForm}, context_instance=RequestContext(request))
...
def services_groupInline_formset(request, id=None, template='services_groupInline.html'):
    ...
    return render_to_response(template, {'form': form, 'formset': formset}, context_instance=RequestContext(request))
...
def chassis_manageView(request, id=None, template_name='vehicle/chassis/chassis_manage.html'):
    ...
    return render_to_response(template_name, {'chassisForm': chassisForm}, context_instance=RequestContext(request))
...
def carburetion_tank_manageView(request, id=None, template_name='vehicle/carburetion_tank/carburetion_tank_manage.html'):
    ...
    return render_to_response(template_name, {'carburetion_tankForm': carburetion_tankForm}, context_instance=RequestContext(request))
...
def storage_tank_manageView(request, id=None, template_name='vehicle/storage_tank/storage_tank_manage.html'):
    ...
    return render_to_response(template_name, {'storage_tankForm': storage_tankForm}, context_instance=RequestContext(request))
...
def vehicle_manageView(request, id=None, template_name='vehicle/vehicle_manage.html'):
    ...
    return render_to_response(template_name, {'vehicleForm': vehicleForm}, context_instance=RequestContext(request))
...
def radio_manageView(request, id=None, template_name='vehicle/radio/radio_manage.html'):
    ...
    return render_to_response(template_name, {'radioForm': radioForm}, context_instance=RequestContext(request))
