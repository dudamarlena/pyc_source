...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Admin\Documents\GitHub\maintenance\django_vehicles_maintenance\maintenance\main\models.py
...
class vehicle(models.Model):
    ...
    VEHICLE_TYPE_CHOICES = (
     ...
     ('PK', 'PICK UP'),
     ('AU', 'AUTO'))
    vehicle_type = models.CharField('Tipo', max_length=10, choices=VEHICLE_TYPE_CHOICES, default='PIG')
...
class radio_maintenance(models.Model):
    ...
    def __unicode__(self):
        return '%s %s' % (self.date, self.garage)
...
class service(models.Model):
    ...
    SERVICE_TYPE_CHOICES = (
     ...
     ('R', 'RADIO'))
    service_type = models.CharField('Tipo', max_length=10, choices=SERVICE_TYPE_CHOICES, default='CH')
