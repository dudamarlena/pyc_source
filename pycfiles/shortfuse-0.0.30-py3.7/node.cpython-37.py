...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/shortfuse/node.py
...
class LinkNode(Node):
    ...
    def __init__(self, parent, name, target, attributes, fs_attributes, extra_attributes):
        Node.__init__(self,
          parent,
          name,
          attributes=attributes,
