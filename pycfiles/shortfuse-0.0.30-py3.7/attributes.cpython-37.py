...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/shortfuse/attributes.py
...
class NodeFSAttributes:
    ...
    def __init__(self, bsize=0, frsize=0, blocks=0, bfree=0, bavail=0, files=0, ffree=0, favail=0, fsid=0, flags=0, namemax=0):
        self._attributes = dict(f_bsize=bsize,
          f_frsize=frsize,
          f_blocks=blocks,
          f_bfree=bfree,
          f_bavail=bavail,
