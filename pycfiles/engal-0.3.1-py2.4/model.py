...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/engal/model.py
# Compiled at: 2006-09-20 14:59:09
...
class Tag(SQLObject):
    ...
    def createAspectRootTag(self, aspect):
        Tag(name=aspect.name, short_name=aspect.short_name, description=aspect.description, uri=aspect.uri, aspect=aspect, lft=0, rgt=1, depth=0)
