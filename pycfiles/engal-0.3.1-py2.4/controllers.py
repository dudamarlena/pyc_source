...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/engal/controllers.py
# Compiled at: 2006-09-20 14:54:52
...
class Root(controllers.RootController):
    ...
    def login(self, forward_url=None, previous_url=None, *args, **kw):
        ...
        return dict(message=msg, previous_url=previous_url, logging_in=True, original_parameters=cherrypy.request.params, forward_url=forward_url)
    ...
    def image(self, id, *args, **kw):
        import Image, cStringIO as StringIO
