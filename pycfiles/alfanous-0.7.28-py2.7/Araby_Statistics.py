...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/alfanous/Support/PyArabic/Araby_Statistics.py
...
import re, araby
__all__ = [
 'letters', 'diacritics', 'letter_count', 'hamza_count', 'words',
...
TEST_FIXTURES = {'text': ' اللّهم يضلله يً ْيسئء سبي شبيشيش شسيشسي', 'letter': 'ش', 
   'gwords': ['أبالله', 'وتالله', 'بالله']}
...
def gwords(text):
    ...
    2
    >>> gwords( "%s %s %s" % (TEST_FIXTURES['gwords'][0],        TEST_FIXTURES['gwords'][1], TEST_FIXTURES['gwords'][1]) )
    2
    >>> gwords( "%s%s %s" % (TEST_FIXTURES['gwords'][0],        TEST_FIXTURES['gwords'][1], TEST_FIXTURES['gwords'][1]) )
    1
    >>> gwords( "%s%s %s %s" % (TEST_FIXTURES['gwords'][0],        araby.DAMMA, TEST_FIXTURES['gwords'][1], TEST_FIXTURES['gwords'][1]) )
    2
    >>> gwords( "%s%s %s%s %s" % (TEST_FIXTURES['gwords'][0],        araby.DAMMA, 'abc', TEST_FIXTURES['gwords'][1], TEST_FIXTURES['gwords'][1]) )
    2
    """
