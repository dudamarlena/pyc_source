...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/alfanous/console.py
...
arg_parser = ArgumentParser(description=INFORMATION['description'], prog='alfanous-console', version='%(prog)s ' + INFORMATION['version'], usage=sys.argv[0] + ' [flags]')
Boolean_choices = [
 'true', 'false']
