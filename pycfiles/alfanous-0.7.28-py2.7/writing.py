...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/alfanous/Support/whoosh/writing.py
# Compiled at: 2015-06-30 06:52:38
import threading, time
from index import DeletionMixin
...
class IndexWriter(DeletionMixin):
    ...
    def update_document(self, **fields):
        ...
        """
        unique_fields = [ name for name, field in self.index.schema.fields() if name in fields and field.unique
                        ]
