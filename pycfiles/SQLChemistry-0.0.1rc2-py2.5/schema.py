...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/sqlchemistry/alchemy/schema.py
# Compiled at: 2008-04-18 10:51:43
...
class Schema(object):
    ...
    def get_table(self, name):
        ...
        column_details = self.conf.get_columns(name)
        details = self.process_custom_cols(**column_details)
