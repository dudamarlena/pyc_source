...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/influxable/serializers.py
...
class MeasurementPointSerializer(FlatFormattedSerieSerializer):
    ...
    def convert(self):
        ...
        timestamp_attributes_names = [ta.attribute_name for ta in timestamp_attributes]
