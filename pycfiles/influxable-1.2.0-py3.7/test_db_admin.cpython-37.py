...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_db_admin.py
# Compiled at: 2019-11-03 07:51:57
# Size of source mod 2**32: 19436 bytes
import pytest
...
class TestGenericDBAdminCommand:
    ...
    def test_get_formatted_privilege_success_2(self):
        privilege = admin.GenericDBAdminCommand._get_formatted_privilege(admin.Privileges.ALL)
        assert privilege == 'ALL'
...
class TestAlterAdminCommand:
    ...
    @classmethod
    def setup_class(cls):
        InfluxDBAdmin.create_retention_policy('test_policy',
          duration='1d',
          replication=3)

    def test_alter_retention_policy_success_1(self):
        res = InfluxDBAdmin.alter_retention_policy('test_policy',
          duration='1d')
        assert res is True
    ...
    def test_alter_retention_policy_failed(self):
        with pytest.raises(exceptions.InfluxDBError):
            InfluxDBAdmin.alter_retention_policy('test_policy')


class TestCreateAdminCommand:

    def test_create_database_success_1(self):
        res = InfluxDBAdmin.create_database('test_database_1')
        assert res is True

    def test_create_database_success_2(self):
        res = InfluxDBAdmin.create_database('test_database_2',
          duration='1d')
        assert res is True

    def test_create_database_success_3(self):
        res = InfluxDBAdmin.create_database('test_database_3',
          replication=4)
        assert res is True

    def test_create_database_success_4(self):
        res = InfluxDBAdmin.create_database('test_database_4',
          shard_duration='1h')
        assert res is True

    def test_create_database_success_5(self):
        res = InfluxDBAdmin.create_database('test_database_5',
          policy_name='test_policy_2')
        assert res is True

    def test_create_retention_policy_success_1(self):
        res = InfluxDBAdmin.create_retention_policy('test_policy_1',
          duration='1d',
          replication=3)
        assert res is True

    def test_create_retention_policy_success_2(self):
        res = InfluxDBAdmin.create_retention_policy('test_policy_22',
          duration='1d',
          replication=4)
        assert res is True

    def test_create_retention_policy_success_3(self):
        res = InfluxDBAdmin.create_retention_policy('test_policy_3',
          duration='1d',
          replication=4,
          shard_duration='1h')
        assert res is True
    ...
    def test_create_subscription_success_1(self):
        res = InfluxDBAdmin.create_subscription('test_subscription_1',
          hosts=[
         'http://localhost:5000'])
        assert res is True
    ...
    def test_create_subscription_success_2(self):
        res = InfluxDBAdmin.create_subscription('test_subscription_2',
          hosts=[
    ...
    def test_create_user_success_1(self):
        res = InfluxDBAdmin.create_user(user_name='user_test_1',
          password='password_test_1')
        assert res is True

    def test_create_user_success_2(self):
        res = InfluxDBAdmin.create_user(user_name='user_test_2',
...
class TestDeleteAdminCommand:
    ...
    def test_delete_success_1(self):
        res = InfluxDBAdmin.delete(measurements=[
         'mymeas'])
        assert res is True

    def test_delete_success_2(self):
        res = InfluxDBAdmin.delete(criteria=[
         Field('time') < 10])
        assert res is True
...
class TestShowAdminCommand:
    ...
    def test_show_field_keys_with_measurement_success(self):
        res = InfluxDBAdmin.show_field_keys(measurements=[
         'param1'])
        assert res is not None
    ...
    def test_show_series_with_measurements_success(self):
        res = InfluxDBAdmin.show_series(measurements=[
         'param1', 'param2'])
        assert res is not None

    def test_show_series_with_criteria_success(self):
        res = InfluxDBAdmin.show_series(criteria=[
         Field('phase') == 'moon'])
        assert res is not None

    def test_show_series_with_limit_success(self):
        res = InfluxDBAdmin.show_series(limit=10)
        assert res is not None
