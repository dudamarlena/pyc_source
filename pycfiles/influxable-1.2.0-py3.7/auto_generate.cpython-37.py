...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/influxable/commands/auto_generate.py
# Compiled at: 2019-11-20 15:14:44
...
FIELD_TYPE_ATTRIBUTE_MAP = {'integer':get_classname(attributes.IntegerFieldAttribute), 
...
class AutoGenerateMeasurement:
    ...
    def run(*args, **kwargs):
        ...
        rendered_template = j2_env.get_template(TEMPLATE_FILE_NAME).render(measurements_fields=measurements_fields)
