...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_serializers.py
# Compiled at: 2019-11-03 07:52:03
...
class TestSerializer:
    ...
    def test_measurement_serializer_success(self):
        ...
        points = measurement_cls.get_query().limit(10).evaluate()
