...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/influxable/db/query.py
# Compiled at: 2019-10-23 08:37:04
...
class Query(RawQuery):
    ...
    def _prepare_query(self):
        ...
        prepared_query = self.initial_query.format(select_clause=select_clause,
