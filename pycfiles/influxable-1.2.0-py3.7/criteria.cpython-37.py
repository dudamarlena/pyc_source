...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/influxable/db/criteria.py
# Compiled at: 2019-10-26 18:03:57
...
class Criteria:
    ...
    def __invert__(self):
        ...
        return Criteria(self.left_operand, self.right_operand, inverted_operator)
    ...
    def __str__(self):
        return 'CRITERIA: {} {} {}'.format(self.left_operand, EVALUATED_OPERATORS[self.operator], self.right_operand)
