...
# Embedded file name: build/bdist.linux-x86_64/egg/alman/apibits/api_method.py
...
class ApiMethod(object):
    ...
    def compose_error(self, error):
        ...
        if isinstance(error, requests.ConnectionError):
            msg = 'An unexpected error occured while trying to connect to the API. You may be seeing this message because your DNS is not working. To check, try running from the command line.'
