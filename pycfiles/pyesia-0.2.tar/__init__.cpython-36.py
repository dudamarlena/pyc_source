...
# Embedded file name: c:\users\jason\documents\python\pyesg\pyesg\datasets\__init__.py
# Compiled at: 2019-11-02 21:11:20
# Size of source mod 2**32: 1341 bytes
__doc__ = 'Useful Datasets'
import pathlib
...
def load_us_stocks(**kwargs) -> pd.DataFrame:
    ...
    """
    return _read_data('us_stocks.csv', header=0, index_col=[0], parse_dates=[0], **kwargs)