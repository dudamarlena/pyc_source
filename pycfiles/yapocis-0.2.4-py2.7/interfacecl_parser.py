...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/yapocis/rpc/interfacecl_parser.py
# Compiled at: 2011-08-30 23:33:15
from pyparsing import Literal, CaselessLiteral, Word, Upcase, OneOrMore, ZeroOrMore, Forward, NotAny, delimitedList, oneOf, Group, Optional, Combine, alphas, nums, restOfLine, cStyleComment, alphanums, printables, empty, quotedString, ParseException, ParseResults, Keyword
import pprint
bnf = None
...
def test_getinterfacecl():
    ...
    for kernel in interface.kernels():
        ...
        for param in interface.kernelparams(kernel):
            ...
            assert direction in ('in', 'out', 'inout', 'outlike', 'resident', 'sizeof',
                                 'widthof', 'heightof')
