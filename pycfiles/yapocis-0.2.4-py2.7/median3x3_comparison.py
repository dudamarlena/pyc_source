...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/yapocis/examples/median3x3_comparison.py
...
plot.fill_between(areas, np.zeros_like(yapocis_deltas), yapocisfast_deltas, color='yellow')
plot.figlegend((l1, l2, l3, l4, l5), ('numpy', 'yapocis', 'yapocis-fast', 'yapocis/numpy',
                                      'fast/numpy'), 'upper left', shadow=True)
