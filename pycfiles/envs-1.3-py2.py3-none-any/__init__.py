...
# [GCC 8.4.0]
# Embedded file name: /home/brian/workspace/envs/envs/__init__.py
# Compiled at: 2017-05-04 15:22:18
...
class Env(object):
    ...
    def __call__(self, key, default=None, var_type='string', allow_none=True):
        ...
        if var_type not in self.valid_types.keys():
            raise ValueError(('The var_type argument should be one of the following {0}').format((',').join(self.valid_types.keys())))
