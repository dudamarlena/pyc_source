...
# Python bytecode 3.6 (3378)
# Decompiled from: Python 3.6.9 (default, Apr 18 2020, 01:56:04) 
# [GCC 8.4.0]
# Embedded file name: /home/brian/workspace/envs/envs/cli.py
# Compiled at: 2017-05-04 15:25:31
# Size of source mod 2**32: 2431 bytes
import os, click, jinja2
...
from . import env
SETTINGS_TEMPLATE = jinja2.Environment(loader=(jinja2.PackageLoader('envs', 'templates'))).get_template('settings.jinja2')
...
@click.option('--settings-file', prompt=True, help='Settings Module? ex. settings or yourapp.settings')
def convert_settings(settings_file):
    ...
    new_settings_filename = raw_input('What should we name this new settings file? (DO NOT NAME IT THE SAME AS THE ORIGINAL BECAUSE THERE ARE NO IMPORTS): ')
