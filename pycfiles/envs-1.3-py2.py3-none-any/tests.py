...
# Compiled at: 2016-08-04 10:17:50
import os, unittest
...
class EnvTestCase(unittest.TestCase):
    ...
    def test_integer_invalid(self):
        ...
        self.assertEquals(str(vm.exception), "invalid literal for int() with base 10: 'seven'")

    def test_wrong_var_type(self):
        with self.assertRaises(ValueError) as (vm):
            env('INVALID_INTEGER', var_type='set')
        self.assertEquals(str(vm.exception), 'The var_type argument should be one of the following string,boolean,list,tuple,integer,float,dict')
    ...
    def test_boolean_invalid(self):
        ...
        self.assertEquals(str(vm.exception), 'This value is not a boolean value.')
    ...
    def test_list_invalid(self):
        ...
        self.assertEquals(str(vm.exception), "'int' object is not iterable")
    ...
    def test_dict_invalid(self):
        ...
        self.assertEquals(str(vm.exception), 'unexpected EOF while parsing (<unknown>, line 1)')
    ...
    def test_dict_invalid(self):
        ...
        self.assertIn(str(vm.exception), ("could not convert string to float: '[5.0]'",
