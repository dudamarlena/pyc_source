...
# [GCC 8.4.0]
# Embedded file name: /home/crito/Work/docar/tests/django_backend_tests.py
...
class when_a_django_backend_manager_gets_instantiated(unittest.TestCase):
    ...
    def it_returns_a_dict_representation_of_the_instance(self):
        ...
        mock_doc2_model = Mock(name='mock_model_instance', spec_set=[
         'name', 'choice', 'related', 'coll', 'nonexistent',
        ...
        expected = {'name': 'value', 
           'choice': 'True', 
           'related': {'name': 'related name'}, 'coll': [], 'skipped': None, 
           'overwrite': 'jaja'}
        doc = Doc2({'name': 'value'})
    ...
    def it_can_return_a_django_m2m_relationship_as_collection(self):
        ...
        mock_model.others.all.return_value = [
         mock1, mock2]
        x = [
         mock2, mock1]
    ...
    def it_applies_the_context_to_itself_and_its_foreign_documents(self):
        ...
        eq_([('objects.get', {'id': 1, 'name': 'hello'}),
         (
          'objects.get', {'id': 1, 'name': 'hello'})], Doc1Model.method_calls)
        Doc2Model.objects.get.assert_called_once_with(id=2, name='hello')
    ...
    def it_can_limit_the_choice_of_context_variables_given_to_it(self):
        ...
        doc2.fetch()
        doc2.save()
        Model2.objects.get.assert_called_with(id=2, name1='name1', name2='name2')
