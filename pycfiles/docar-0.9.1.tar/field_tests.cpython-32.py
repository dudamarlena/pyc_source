...
# [GCC 8.4.0]
# Embedded file name: /home/crito/Work/docar/tests/field_tests.py
# Compiled at: 2012-08-22 06:06:09
import unittest
...
class when_a_field_gets_instantiated(unittest.TestCase):
    ...
    def it_can_have_a_validator_function(self):
        ...
        assert_raises(exceptions.ValidationError, field.run_validators, 'string_value')
        eq_(True, v1.called)
        eq_(True, v2.called)
...
class when_a_boolean_field_gets_instantiated(unittest.TestCase):
    ...
    def it_can_turn_itself_to_the_right_datatype(self):
        assert_raises(exceptions.ValidationError, self.bool_field.to_python, 'string')
    ...
    def it_can_clean_and_validate_itself(self):
        ...
        assert_raises(exceptions.ValidationError, self.bool_field.clean, 'string')
        assert_raises(exceptions.ValidationError, self.bool_field.clean, None)
        return
...
class when_a_string_field_gets_instantiated(unittest.TestCase):
    ...
    def setUp(self):
        self.string_field = fields.StringField(default='hello world', optional=True)
...
class when_an_integer_field_gets_instantiated(unittest.TestCase):
    ...
    def it_can_turn_itself_to_the_right_datatype(self):
        ...
        assert_raises(exceptions.ValidationError, self.integer_field.to_python, 'str')
        return
...
class when_a_choices_field_gets_instantiated(unittest.TestCase):
    ...
    def it_raises_a_validation_error_if_its_not_a_valid_choice(self):
        assert_raises(exceptions.ValidationError, self.choices_field.to_python, 'C')