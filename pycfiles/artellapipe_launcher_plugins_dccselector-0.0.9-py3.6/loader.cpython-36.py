...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/launcher/plugins/dccselector/loader.py
...
import os, sys, inspect, logging.config, tpDcc as tp
...
def init(do_reload=False, dev=False):
    ...
    class DCCSelectorPlugin(importer.Importer):
