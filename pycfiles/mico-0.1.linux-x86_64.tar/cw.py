...
# [GCC 8.4.0]
# Embedded file name: /home/ajdiaz/env/mico/lib/python2.7/site-packages/mico/lib/aws/ec2/cw.py
# Compiled at: 2013-05-07 11:41:07
...
def cw_connect(region=None, *args, **kwargs):
    ...
    connection = CloudWatchConnection(os_environ.get('AWS_ACCESS_KEY_ID'), os_environ.get('AWS_SECRET_ACCESS_KEY'), region=region)
    return connection
