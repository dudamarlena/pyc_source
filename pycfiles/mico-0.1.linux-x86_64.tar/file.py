...
# [GCC 8.4.0]
# Embedded file name: /home/ajdiaz/env/mico/lib/python2.7/site-packages/mico/lib/core/file.py
# Compiled at: 2013-04-17 12:00:03
"""The file core submodule provide a useful way to create, delete and manage
files in the remote and local host."""
import os, base64, hashlib, tempfile, __builtin__
from jinja2 import Environment, FileSystemLoader
import fabric, mico.output, mico.util.storage
revision_repo = mico.util.storage.RevisionStorage(os.path.join(mico.cache_path, __name__))
...
def file_content(src, dst, env={}, mode=None, owner=None, group=None, check=True, override_mode=True, override_owner=True, override_group=True):
