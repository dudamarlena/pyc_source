...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hybrid/tests/test_convert.py
# Compiled at: 2016-01-09 00:31:15
import unittest, pb_test_pb2, simple_convert
...
class TestPb2Json(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.jsonobj = {'int1': 1, 
           'arr1': [
                  11, 33, 55, 77], 
           'arr2': [{'int2': 2, 'arr3': [{'int3': 88}, {'int3': 99}]}, {'int2': 3, 'arr3': [{'int3': 1000}, {'int3': 2000}]}]}
    ...
    def runTest(self):
        ...
        for (ind, item) in enumerate(m.arr2._values):
            ...
            for (ind2, item2) in enumerate(item.arr3._values):
                self.assertEqual(item2.int3, self.jsonobj['arr2'][ind]['arr3'][ind2]['int3'])
