...
# [GCC 8.4.0]
# Embedded file name: /Users/kyle/git/flask-xxl/flask_xxl/apps/page/models.py
# Compiled at: 2018-06-20 18:52:33
import flask, json, os, sqlalchemy as sq
...
class Page(Model):
    ...
    children = orm.relationship('Page', backref=orm.backref('parent', remote_side=[id]), lazy='dynamic', primaryjoin='Page.id==Page.parent_id', cascade='all,delete-orphan')
    ...
    template_file = sq.Column(sq.String(255), nullable=False, default=DEFAULT_TEMPLATE)
