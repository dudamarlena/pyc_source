...
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/projex/cli.py
# Compiled at: 2016-07-03 23:28:12
__doc__ = " Defines an interface for turning methods into command line interface     options using optparse.\n    \n    :usage      |# /path/to/package/cli.py\n                |\n                |from projex import cli\n                |\n                |@cli.climethod\n                |def testing():\n                |   print 'here'\n"
...
class climethod(object):
    """
    Creates a wrapper for generating command line interface methods within     a cli package.  This wrapper will allow the developer to map methods     in a module to the optparse module.
...
def command(argv, scope):
    """
    Looks up a particular command from the inputted arguments for the given     scope.
