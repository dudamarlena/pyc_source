...
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/projex/plugin.py
# Compiled at: 2016-07-03 23:28:12
__doc__ = ' Defines the Plugin class, a generic way to define Python plugins. '
import glob, os.path, logging, sys
from .text import nativestring as nstr
from xml.etree import ElementTree
import projex, projex.text
...
class Plugin(object):
    ...
    def register(cls, plugin):
        ...
        if plugin.name() in plugs:
            ...
            if isinstance(inst, PluginProxy) and not isinstance(plugin, PluginProxy) and not inst._instance:
