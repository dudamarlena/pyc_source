...
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/projex/wikitext/urlhandler.py
...
class UrlHandler(object):
    ...
    def resolve(self, key):
        """
        Resolves the inputted wiki key to a url path.  This method should         return a url and whether or not the page exists.
