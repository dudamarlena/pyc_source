...
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/projex/wikitext/styles.py
# Compiled at: 2016-07-03 23:28:12
__doc__ = ' Shell file for the projex.wikitext.commands module. '
basic = {'wiki_open': '<{tag} class="wiki">', 
   'wiki_close': '</{tag}>', 
   'newline': '<br>', 
   'spacer': '<br><br>', 
