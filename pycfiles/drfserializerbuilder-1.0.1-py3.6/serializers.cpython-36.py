...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/drf_serializer_builder/serializers.py
# Compiled at: 2018-09-03 14:16:26
...
class ModelSerializer(serializers.ModelSerializer):
    ...
    def meta_fields(cls, *fields):
        ...
        return type(cls.__name__, (cls, object), {six.text_type('Meta'): type(str('Meta'), (meta, object), {six.text_type('fields'): fields, 
    ...
    def meta_preset(cls, name):
        ...
        return type(cls.__name__, (cls,), {str('Meta'): type(str('Meta'), (meta, object), preset)})