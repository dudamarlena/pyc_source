...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/pyVC/Networks/Multicast.py
...
class Network(Base.Network):
    ...
    def __init__(self, realmachines, lanname, address='230.0.0.1', port=1102, **keywords):
