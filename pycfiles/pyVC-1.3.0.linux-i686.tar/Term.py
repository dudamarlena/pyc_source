...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/pyVC/Term.py
# Compiled at: 2007-09-12 19:35:16
    ...
    def connect(self, host=None, port=None):
        ...
        while handle:
            try:
                ...
                if errno == EIO and handle == self.pty:
                    try:
                        (pid, status) = waitpid(self.pid, 0)
                        break
                    except OSError, (errno, strerror):
