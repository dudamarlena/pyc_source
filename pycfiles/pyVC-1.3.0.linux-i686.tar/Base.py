...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/pyVC/VirtualMachines/Base.py
...
class VM(object):
    ...
    def __init__(self, realmachine, name, addrs=None, macaddrs=None, disks=None, bootdisk=None, networks=None, memory='32', vmgroup=1, kernel='', kernelargs='', initrd='', root='', **keywords):
    ...
    def _set_status(self, status):
        ...
        if status == 'stopped' or status == 'started' or status == None:
