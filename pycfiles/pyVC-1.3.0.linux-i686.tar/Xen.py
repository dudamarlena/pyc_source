...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/pyVC/VirtualMachines/Xen.py
...
class VM(Base.VM):
    ...
    def __init__(self, realmachine, name, kernel=None, graphic=False, **keywords):
    ...
    def console(self, socket=False):
        ...
        if self.pty:
            if socket:
                return (
                 self.realmachine.hostname, self.realmachine.term_socket(pty=self.pty))
            else:
