...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/named_checkconf.py
...
DNSSEC_DISABLED = re.compile('dnssec-enable\\s+no;')
DISABLE_ALGORITHMS = re.compile('disable-algorithms[^}]*};')
DISABLE_DS_DIGESTS = re.compile('disable-ds-digests[^}]*};')
INNER_VALLUES = re.compile('(?:\\"|\\\')(.*)(?:\\"|\\\')')
