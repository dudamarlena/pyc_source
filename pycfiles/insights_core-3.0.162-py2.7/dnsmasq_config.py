...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/dnsmasq_config.py
...
from insights.parsr import Char, EOF, Forward, Lift, LineEnd, Many, Number, OneLineComment, Opt, PosMarker, skip_none, String, WS, WSChar
