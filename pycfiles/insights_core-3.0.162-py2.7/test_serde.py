...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/tests/test_serde.py
# Compiled at: 2019-05-16 13:41:33
import os
from tempfile import mkdtemp
from insights import dr
from insights.core.plugins import component
from insights.core.serde import serializer, deserializer, Hydration, marshal, unmarshal
...
def test_unmarshal():
    d = {'type': 'insights.tests.test_serde.Foo', 
       'object': {'a': 1, 'b': 2}}
    foo = unmarshal(d)
...
def test_hydrate_one():
    raw = {'name': dr.get_name(thing), 
       'exec_time': 0.25, 
       'ser_time': 0.05, 
       'results': {'type': 'insights.tests.test_serde.Foo', 
                   'object': {'a': 1, 'b': 2}}}
    h = Hydration()
