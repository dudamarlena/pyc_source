...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_osa_dispatcher_log.py
...
OSA_DISPATCHER_TRUNC = '\n2015/12/27 22:48:50 -04:00 28307 0.0.0\n'

def test_get_osa_dispatcher_log():
    log = osa_dispatcher_log.OSADispatcherLog(context_wrap(OSA_DISPATCHER_LOG, path='var/log/rhn/osa-dispatcher.log'))
    ...
    trunc = osa_dispatcher_log.OSADispatcherLog(context_wrap(OSA_DISPATCHER_TRUNC, path='var/log/rhn/osa-dispatcher.log'))
    last = trunc.last()
