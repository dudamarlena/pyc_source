...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/fstab.py
...
class FSTab(Parser):
    ...
    def fsspec_of_path(self, path):
        ...
        If path contains any blank, pass it in directly or escape with ' ',
        eg: '/VM TOOLS/cache' or '/VM TOOLS/cache'
        """
