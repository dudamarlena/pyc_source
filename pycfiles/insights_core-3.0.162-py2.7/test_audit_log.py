...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_audit_log.py
...
def test_audit_log():
    ...
    assert logs[0] == {'timestamp': '1506487181.009', 'is_valid': True, 'unparsed': 'avc:  denied  { create } for', 
       'msg_ID': '32794', 
       'pid': '27960', 'raw_message': AUDIT_LOG_NORMAL, 'comm': 'mongod', 
       'scontext': 'system_u:system_r:mongod_t:s0', 'tclass': 'unix_dgram_socket', 
       'type': 'AVC', 'tcontext': 'system_u:system_r:mongod_t:s0'}
    ...
    line0 = info[0]
    assert line0.get('unparsed') is None
    assert line0 == {'timestamp': '1506487181.009', 'msg_ID': '32794', 'is_valid': True, 
       'type': 'AVC', 'raw_message': 'type=AVC msg=audit(1506487181.009:32794):'}
