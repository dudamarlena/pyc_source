...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/specs/sos_archive.py
...
class SosSpecs(Specs):
    ...
    candlepin_error_log = first_of([
     ...
     simple_file('sos_commands/foreman/foreman-debug/var/log/candlepin/error.log')])
    ...
    fdisk_l_sos = first_of([glob_file('sos_commands/filesys/fdisk_-l_*'), glob_file('sos_commands/block/fdisk_-l_*')])
    ...
    foreman_ssl_access_ssl_log = first_file(['var/log/httpd/foreman-ssl_access_ssl.log', 'sos_commands/foreman/foreman-debug/var/log/httpd/foreman-ssl_access_ssl.log'])
    ...
    var_qemu_xml = glob_file('var/run/libvirt/qemu/*.xml')
