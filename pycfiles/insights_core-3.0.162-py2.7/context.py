...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/core/context.py
...
class ExecutionContext(six.with_metaclass(ExecutionContextMeta)):
    ...
    def check_output(self, cmd, timeout=None, keep_rc=False, env=None):
        ...
        """
        return subproc.call(cmd, timeout=timeout or self.timeout, keep_rc=keep_rc, env=env)
