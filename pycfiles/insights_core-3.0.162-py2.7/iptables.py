...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/iptables.py
    ...
    def parse_content(self, content):
        ...
        for line in get_active_lines(content):
            if line.startswith('*'):
                ...
                self.chains.append({'policy': policy if policy != '-' else None, 
                   'table': current_table, 
                   'name': name, 
                ...
                if target_option:
                    ...
                    if ' ' in target:
                        ...
                        target_options = None
                    self.rules.append({'table': current_table, 
                       'chain': chain_name, 
                       'rule': rule, 
