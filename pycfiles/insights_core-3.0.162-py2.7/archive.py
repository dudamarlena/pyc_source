...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/client/archive.py
# Compiled at: 2020-03-25 13:10:41
"""
Handle adding files and preparing the archive for upload
"""
from __future__ import absolute_import
import time, os, shutil, subprocess, shlex, logging, tempfile, re, atexit
...
class InsightsArchive(object):
    ...
    def create_tar_file(self):
        ...
        return_code = subprocess.call(shlex.split('tar c%sfS %s -C %s .' % (
         ...
         tar_file_name, self.tmp_dir)), stderr=subprocess.PIPE)
