...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/tests/test_util.py
...
def test_deep_nest_list_dict():
    ...
    with pytest.raises(AssertionError):
        b[1][2] = 3
        deep_compare(a, b)
    a = [{'ip_addr': '0.0.0.0', 'process_name': 'qpidd', 'port': '5672'}, {'ip_addr': '127.0.0.1', 'process_name': 'mongod', 'port': '27017'}, {'ip_addr': '127.0.0.1', 'process_name': 'Passenger Rac', 'port': '53644'}, {'ip_addr': '0.0.0.0', 'process_name': 'qdrouterd', 'port': '5646'}]
    b = [{'ip_addr': '0.0.0.0', 'port': '5672', 'process_name': 'qpidd'}, {'ip_addr': '127.0.0.1', 'port': '27017', 'process_name': 'mongod'}, {'ip_addr': '127.0.0.1', 'port': '53644', 'process_name': 'Passenger Rac'}, {'ip_addr': '0.0.0.0', 'port': '5646', 'process_name': 'qdrouterd'}]
    deep_compare(a, b)
...
def test_case_variants():
    filter_list = [
     'Ciphers', 'MACs', 'UsePAM', 'MaxAuthTries', 'nt pipe support',
