...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_uname.py
...
def test_fixed_by():
    ...
    assert [
     '2.6.33-100.el6'] == u.fixed_by('2.6.33-100.el6')
...
def test_from_release():
    ...
    unknown_list = [
     '2.4.21-3', '2.6.9-4', '2.6.18-7', '2.6.32-70', '3.10.0-53']
    known_list = [{'version': '2.4.21-4', 'rhel_release': ['3', '0']}, {'version': '2.6.9-55', 'rhel_release': ['4', '5']}, {'version': '2.6.18-308', 'rhel_release': ['5', '8']}, {'version': '2.6.32-131.0.15', 'rhel_release': ['6', '1']}, {'version': '3.10.0-123', 'rhel_release': ['7', '0']}]
