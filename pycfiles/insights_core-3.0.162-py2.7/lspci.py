...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/lspci.py
...
class LsPci(CommandParser, LogFileOutput):
    ...
    def parse_content(self, content):
        ...
        bus_device_function_re = re.compile('[0-9a-f]+:[0-9a-f]+.[0-9a-f]+')
        fields = [
         'Subsystem', 'Kernel driver in use', 'Kernel modules']
