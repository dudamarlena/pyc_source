...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/ceph_version.py
...
community_to_release_map = {'0.94.1-15': {'version': '1.3.0', 'major': '1.3', 'minor': '0', 'downstream_release': 'NA'}, '0.94.3-3': {'version': '1.3.1', 'major': '1.3', 'minor': '1', 'downstream_release': 'NA'}, '0.94.5-9': {'version': '1.3.2', 'major': '1.3', 'minor': '2', 'downstream_release': 'NA'}, '0.94.9-3': {'version': '1.3.3', 'major': '1.3', 'minor': '3', 'downstream_release': 'NA'}, '0.94.9-9': {'version': '1.3.3', 'major': '1.3', 'minor': '3', 'downstream_release': 'async 2'}, '0.94.10-2': {'version': '1.3.4', 'major': '1.3', 'minor': '4', 'downstream_release': 'NA'}, '10.2.2-38': {'version': '2.0', 'major': '2', 'minor': '0', 'downstream_release': '0'}, '10.2.3-13': {'version': '2.1', 'major': '2', 'minor': '1', 'downstream_release': '0'}, '10.2.5': {'version': '2.2', 'major': '2', 'minor': '2', 'downstream_release': '0'}, '10.2.5-37': {'version': '2.2', 'major': '2', 'minor': '2', 'downstream_release': '0'}, '10.2.7-27': {'version': '2.3', 'major': '2', 'minor': '3', 'downstream_release': '0'}, '10.2.7-28': {'version': '2.3', 'major': '2', 'minor': '3', 'downstream_release': 'async'}, '10.2.7-48': {'version': '2.4', 'major': '2', 'minor': '4', 'downstream_release': 'async'}, '10.2.10-16': {'version': '2.5', 'major': '2', 'minor': '5', 'downstream_release': '0'}, '10.2.10-28': {'version': '2.5.1', 'major': '2', 'minor': '5', 'downstream_release': '1'}, '10.2.10-40': {'version': '2.5.2', 'major': '2', 'minor': '5', 'downstream_release': '2'}, '10.2.10-43': {'version': '2.5.3', 'major': '2', 'minor': '5', 'downstream_release': '3'}, '10.2.10-49': {'version': '2.5.4', 'major': '2', 'minor': '5', 'downstream_release': '4'}, '12.2.4-6': {'version': '3.0.2', 'major': '3', 'minor': '0', 'downstream_release': '2'}, '12.2.4-10': {'version': '3.0.3', 'major': '3', 'minor': '0', 'downstream_release': '3'}, '12.2.4-30': {'version': '3.0.4', 'major': '3', 'minor': '0', 'downstream_release': '4'}, '12.2.4-42': {'version': '3.0.5', 'major': '3', 'minor': '0', 'downstream_release': '5'}, '12.2.5-42': {'version': '3.1', 'major': '3', 'minor': '1', 'downstream_release': '0'}, '12.2.5-59': {'version': '3.1.1', 'major': '3', 'minor': '1', 'downstream_release': '1'}, '12.2.8-52': {'version': '3.2', 'major': '3', 'minor': '2', 'downstream_release': '0'}, '12.2.8-89': {'version': '3.2.1', 'major': '3', 'minor': '2', 'downstream_release': '1'}, '12.2.8-128': {'version': '3.2.2', 'major': '3', 'minor': '2', 'downstream_release': '2'}, '12.2.12-45': {'version': '3.3', 'major': '3', 'minor': '3', 'downstream_release': '0'}, '12.2.12-48': {'version': '3.3', 'major': '3', 'minor': '3', 'downstream_release': 'async'}, '12.2.12-74': {'version': '3.3.1', 'major': '3', 'minor': '3', 'downstream_release': '1'}}
...
class CephVersion(CommandParser):
    ...
    def parse_content(self, content):
        ...
        pattern_community = '((\\d{1,2})\\.(\\d{1,2})\\.((\\d{1,2})|x))((\\-(\\d+)))'
        ...
        self.upstream_version = {'release': int(community_version_mo.group(2)), 
