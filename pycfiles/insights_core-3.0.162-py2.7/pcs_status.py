...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/pcs_status.py
...
class PCSStatus(CommandParser):
    ...
    def parse_content(self, content):
        ...
        self.data = {}
        self.bad_nodes = []
        key_oneline = ('Cluster name', 'Stack', 'Current DC', 'Online', 'RemoteOnline',
                       'OFFLINE', 'RemoteOFFLINE', 'GuestOnline')
        key_nextline = ('Full list of resources', 'Failed Actions', 'PCSD Status',
                        'Daemon Status')
