...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_mdstat.py
...
MDSTAT_RESULT_1 = {'personalities': [
                   'raid1', 'raid6', 'raid5', 'raid4'], 
   'components': [{'device_name': 'md_d0', 'active': True, 'auto_read_only': False, 'raid': 'raid5', 'component_name': 'sde1', 'device_flag': '', 'role': 0, 'up': True, 'blocks': 1250241792, 'level': 5, 'chunk': '64k', 'algorithm': 2}, {'device_name': 'md_d0', 'active': True, 'auto_read_only': False, 'raid': 'raid5', 'component_name': 'sdf1', 'device_flag': '', 'role': 4, 'up': True, 'blocks': 1250241792, 'level': 5, 'chunk': '64k', 'algorithm': 2}, {'device_name': 'md_d0', 'active': True, 'auto_read_only': False, 'raid': 'raid5', 'component_name': 'sdb1', 'device_flag': '', 'role': 5, 'up': True, 'blocks': 1250241792, 'level': 5, 'chunk': '64k', 'algorithm': 2}, {'device_name': 'md_d0', 'active': True, 'auto_read_only': False, 'raid': 'raid5', 'component_name': 'sdd1', 'device_flag': '', 'role': 2, 'up': True, 'blocks': 1250241792, 'level': 5, 'chunk': '64k', 'algorithm': 2}, {'device_name': 'md_d0', 'active': True, 'auto_read_only': False, 'raid': 'raid5', 'component_name': 'cciss/c0d0p1', 'device_flag': '', 'role': 6, 'up': True, 'blocks': 1250241792, 'level': 5, 'chunk': '64k', 'algorithm': 2}, {'device_name': 'md_d0', 'active': True, 'auto_read_only': False, 'raid': 'raid5', 'component_name': 'sdc1', 'device_flag': '', 'role': 1, 'up': True, 'blocks': 1250241792, 'level': 5, 'chunk': '64k', 'algorithm': 2}]}
MDSTAT_TEST_2 = ('\nPersonalities : [raid1] [raid6] [raid5] [raid4]\nmd1 : active raid1 sdb2[1] sda2[0]\n      136448 blocks [2/2] [UU]\n\nmd2 : active raid1 sdb3[1] sda3[0]\n      129596288 blocks [2/2] [U_]\n\nmd0 : active raid1 sdb1[1](F) sda1[0]\n      16787776 blocks [2/2] [_U]\n\nunused devices: <none>\n').strip()
MDSTAT_RESULT_2 = {'personalities': [
                   'raid1', 'raid6', 'raid5', 'raid4'], 
   'components': [{'device_name': 'md1', 'active': True, 'auto_read_only': False, 'raid': 'raid1', 'component_name': 'sdb2', 'device_flag': '', 'role': 1, 'up': True, 'blocks': 136448}, {'device_name': 'md1', 'active': True, 'auto_read_only': False, 'raid': 'raid1', 'component_name': 'sda2', 'device_flag': '', 'role': 0, 'up': True, 'blocks': 136448}, {'device_name': 'md2', 'active': True, 'auto_read_only': False, 'raid': 'raid1', 'component_name': 'sdb3', 'device_flag': '', 'role': 1, 'up': True, 'blocks': 129596288}, {'device_name': 'md2', 'active': True, 'auto_read_only': False, 'raid': 'raid1', 'component_name': 'sda3', 'device_flag': '', 'role': 0, 'up': False, 'blocks': 129596288}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid1', 'component_name': 'sdb1', 'device_flag': 'F', 'role': 1, 'up': False, 'blocks': 16787776}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid1', 'component_name': 'sda1', 'device_flag': '', 'role': 0, 'up': True, 'blocks': 16787776}]}
...
MDSTAT_RESULT_4 = {'personalities': [
                   'linear', 'raid0', 'raid1'], 
   'components': [{'device_flag': 'S', 'raid': None, 'device_name': 'md0', 'role': 1, 'active': False, 'auto_read_only': False, 'component_name': 'sdb', 'blocks': 6306}, {'device_flag': 'S', 'raid': None, 'device_name': 'md0', 'role': 0, 'active': False, 'auto_read_only': False, 'component_name': 'sda', 'blocks': 6306}]}
...
MD_RESULT_1 = [{'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'sdf1', 'role': 0, 'device_flag': ''}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'sde1', 'role': 1, 'device_flag': ''}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'sdd1', 'role': 2, 'device_flag': 'F'}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'sdc1', 'role': 3, 'device_flag': ''}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'sdb1', 'role': 4, 'device_flag': 'F'}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'sda1', 'role': 5, 'device_flag': ''}, {'device_name': 'md0', 'active': True, 'auto_read_only': False, 'raid': 'raid6', 'component_name': 'hdb1', 'role': 6, 'device_flag': ''}]
MD_TEST_2 = 'md0 : active (auto-read-only) raid6 sdf1[0] sde1[1] sdd1[2](S)'
MD_RESULT_2 = [{'device_name': 'md0', 'active': True, 'auto_read_only': True, 'raid': 'raid6', 'component_name': 'sdf1', 'role': 0, 'device_flag': ''}, {'device_name': 'md0', 'active': True, 'auto_read_only': True, 'raid': 'raid6', 'component_name': 'sde1', 'role': 1, 'device_flag': ''}, {'device_name': 'md0', 'active': True, 'auto_read_only': True, 'raid': 'raid6', 'component_name': 'sdd1', 'role': 2, 'device_flag': 'S'}]
MD_FAIL = [
 ...
 'md124 : active raid5 sdh1[6] sdg1[4]junk sdf1[3] sde1[2] sdd1[1] sdc1[0]md124 : active raid5 sdh1[6] sdg1[4]junk sdf1[3] sde1[2] sdd1[1] sdc1[0]']
