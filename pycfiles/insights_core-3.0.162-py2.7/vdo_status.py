...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/vdo_status.py
...
class VDOStatus(YAMLParser):
    ...
    def volumns(self):
        ...
        if 'VDOs' in self.data:
            return sorted(self.data['VDOs'].keys())
        return []
    ...
    def get_logical_free_of_vol(self, vol):
        ...
        """
        return self.get_logical_blocks_of_vol(vol) - self.get_logical_used_of_vol(vol)
    ...
    def get_physical_free_of_vol(self, vol):
        ...
        """
        return self.get_physical_blocks_of_vol(vol) - self.get_overhead_used_of_vol(vol) - self.get_physical_used_of_vol(vol)