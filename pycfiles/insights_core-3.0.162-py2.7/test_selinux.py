...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/combiners/tests/test_selinux.py
...
SESTATUS_TEMPLATE = {'loaded_policy_name': 'targeted', 
   'selinux_root_directory': '/etc/selinux', 'selinuxfs_mount': '/sys/fs/selinux', 
   'mode_from_config_file': 'enforcing', 'policy_mls_status': 'enabled', 
...
GRUB1_OUTPUTS = [({'kernel_boot_options': ''}, {}),
...
GRUB2_OUTPUTS = [({'kernel_boot_options': ''}, {}),
 ({'kernel_boot_options': 'selinux=0'},
  {GRUB_DISABLED: [
...
TEST_CASES_1 = [
 ...
 (
  ...
  (
   False,
   {GRUB_DISABLED: ['/vmlinuz-2.6.32-642.el6.x86_64 selinux=0 ro root=/dev/mapper/VolGroup-lv_root rd_NO_LUKS LANG=en_US.UTF-8 rd_NO_MD rd_LVM_LV=VolGroup/lv_swap SYSFONT=latarcyrheb-sun16 crashkernel=auto rd_LVM_LV=VolGroup/lv_root  KEYBOARDTYPE=pc KEYTABLE=us rd_NO_DM rhgb quiet'], RUNTIME_NOT_ENFORCING: 'permissive', 
...
TEST_CASES_2 = [
 (
  ...
  (
   False,
   {GRUB_DISABLED: ['/vmlinuz-3.10.0-327.el7.x86_64 selinux=0 root=/dev/mapper/rhel-root ro crashkernel=auto rd.lvm.lv=rhel/root rd.lvm.lv=rhel/swap rhgb quiet LANG=en_US.UTF-8',
                    '/vmlinuz-0-rescue-9f20b35c9faa49aebe171f62a11b236f selinux=0 root=/dev/mapper/rhel-root ro crashkernel=auto rd.lvm.lv=rhel/root rd.lvm.lv=rhel/swap rhgb quiet']})),
 (
  (
