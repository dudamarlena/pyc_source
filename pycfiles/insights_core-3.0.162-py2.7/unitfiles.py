...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/systemd/unitfiles.py
...
class ListUnits(Parser):
    ...
    def parse_service_details(self, parts):
        ...
        service_details = {}
        if len(parts) >= 4 and any(part in valid_states for part in parts) and any(unit in parts[0] for unit in valid_units):
