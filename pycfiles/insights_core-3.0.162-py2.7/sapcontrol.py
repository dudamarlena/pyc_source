...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/sapcontrol.py
...
class SAPControlSystemUpdateList(CommandParser):
    ...
    def parse_content(self, content):
        ...
        self.data = parse_delimited_table(content, delim=',', max_splits=5, strip=True, heading_ignore=header_sp)
        if not self.data:
