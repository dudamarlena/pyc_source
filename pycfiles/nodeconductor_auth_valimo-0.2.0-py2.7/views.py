...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nodeconductor_auth_valimo/views.py
...
class AuthResultViewSet(core_mixins.CreateExecutorMixin, mixins.CreateModelMixin, viewsets.GenericViewSet):
    ...
    @decorators.list_route(methods=[b'POST'])
    def result(self, request, *args, **kwargs):
        ...
        """
        try:
            auth_result = models.AuthResult.objects.get(uuid=request.data.get(b'uuid'))
