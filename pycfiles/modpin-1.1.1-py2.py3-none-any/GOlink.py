...
# [GCC 8.4.0]
# Embedded file name: ./src/SBI/databases/GOlink.py
...
class GOlink(object):
    ...
    def __init__(self, local=None):
        ...
        self.__name__ = 'databases.GOlink'
        self._gofile = 'go.gz'
...
class GOterm(object):
    ...
    @property
    def namespace_mini(self):
        return GOnamespace[self._namespace]

    @property
    def obsolete_binary(self):
        if self.obsolete:
            return 1
        return 0
