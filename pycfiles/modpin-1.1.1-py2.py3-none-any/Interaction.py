...
# [GCC 8.4.0]
# Embedded file name: /home/boliva/sit_sbi/modppi/src/BioLib/Structure/Interaction.py
...
class Interaction(object):
    ...
    def get_structures(self):
        return (
         self.structure1, self.structure2)
    ...
    def get_signatures_by_location(self, min_coverage=0.8, c_type='CB', max_distance=12, max_pval=1):
        ...
        signatures = {'I': ([], [], len(int_loops_structure1) * len(int_loops_structure2)), 'E': ([], [], len(nonint_loops_structure1) * len(nonint_loops_structure1)), 'P': ([], [], len(int_loops_structure1) * len(nonint_loops_structure2) + len(int_loops_structure2) * len(nonint_loops_structure1))}
