...
# [GCC 8.4.0]
# Embedded file name: /home/boliva/sit_sbi/modppi/src/BioLib/Structure/Structure.py
# Compiled at: 2018-11-29 11:31:12
import math, os, sys, re, BioLib.Tools.Dssp as Dssp
...
class Structure(object):
    ...
    def get_interacting_residues(self, structure, c_type='CB', max_distance=12, uniq=True, warnings=False):
        ...
        if uniq:
            ...
            return (
             interacting_residues_self, interacting_residues_structure, interacting_distances)
    ...
    def __get_mass_center(self, residues):
        ...
        if len(residues) == 0:
            ...
            return (
             x / len(residues), y / len(residues), z / len(residues))
