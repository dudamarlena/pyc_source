...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/src/archdb/src/Drug.py
# Compiled at: 2018-02-02 06:39:02
from SBI.databases import Drug
tables = {'drg': 'drugBank', 'drg_cat': 'drugBank_category', 
...
class Drug(Drug):
    ...
    def toSQL(self):
        ...
        description = "'" + self.desc.replace("'", "\\'") + "'" if self.desc != '' else 'NULL'
