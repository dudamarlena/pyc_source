...
# [GCC 8.4.0]
# Embedded file name: /home/patri/MODPIN/modpin/config_setup.py
# Compiled at: 2020-04-28 10:16:57
...
def main():
    ...
    if configuration == 'n':
        ...
        if configuration_data == 'n' or configuration_data == 'N':
            try:
                if not os.path.isdir(os.path.join(modppi_path, 'data')):
                    os.makedirs(os.path.join(modppi_path, 'data'))
                if not os.path.isdir(os.path.join(modppi_path, 'blast')):
                    os.makedirs(os.path.join(modppi_path, 'blast'))
            except:
            ...
            if os.path.isdir(os.path.join(rosetta_path, 'database')) == True:
                ...
                if find_file(os.path.join(rosetta_path, 'source', 'bin'), 'fixbb*'):
                    ...
                    if find_file(os.path.join(rosetta_path, 'bin'), 'fixbb*'):
                        ...
                        if find_file(os.path.join(rosetta_path, 'source', 'bin'), 'relax*'):
        ...
        if configure_cluster.startswith('y') or configure_cluster.startswith('Y'):
            ...
            if not command_queue:
                command_queue = os.path.join('.', 'command_queues.txt')
