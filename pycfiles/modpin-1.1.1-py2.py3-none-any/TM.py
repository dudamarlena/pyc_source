...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/src/archdb/src/TM.py
# Compiled at: 2018-02-02 06:39:02
from SBI.databases import TM
import re
tables = {'regions': 'PDBTM_regions', 'pdbtm': 'PDBTM', 
...
class TM(TM):
    ...
    def _switch_region(self, region):
        if region != '1' and region != '2' or self.side == '':
            return region
        oposites = {'Inside': 'Outside', 'Outside': 'Inside'}
        translate = {'Inside': 'i', 'Outside': 'o'}
        if region == '1':
            return translate[self.side]
        else:
            return translate[oposites[self.side]]
