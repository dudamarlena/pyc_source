...
# [GCC 8.4.0]
# Embedded file name: /Users/alanjds/src/git/adwords-client/adwords_client/adwordsapi/batch_job_service.py
...
class BatchJobHelper(googleads.adwords.BatchJobHelper, cm.SudsFactory):
    ...
    def add_operation(self, operation):
        if operation['xsi_type'] in self.operations:
            ...
            self.operations[operation['xsi_type']] = [
             operation]
    ...
    def add_biddable_adgroup_criterion_operation(self, adgroup_id, operator, xsi_type, criteria_id=None, criterion_params={}, **kwargs):
