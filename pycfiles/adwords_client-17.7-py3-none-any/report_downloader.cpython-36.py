...
# [GCC 8.4.0]
# Embedded file name: /Users/alanjds/src/git/adwords-client/adwords_client/adwordsapi/report_downloader.py
# Compiled at: 2017-07-12 10:46:26
# Size of source mod 2**32: 2923 bytes
import csv, logging, tempfile
...
class ReportDownloader:
    ...
    def report(self, report_type, fields, client_customer_id=None, *args, **kwargs):
        ...
        report_params = {'query':awql_query,  'file_format':'GZIPPED_CSV', 
         'include_zero_impressions':kwargs['include_zero_impressions'] if 'include_zero_impressions' in kwargs else True, 
         'skip_report_header':kwargs['skip_report_header'] if 'skip_report_header' in kwargs else True, 
         'skip_column_header':kwargs['skip_column_header'] if 'skip_column_header' in kwargs else True, 
         'skip_report_summary':kwargs['skip_report_summary'] if 'skip_report_summary' in kwargs else True}
        for key in kwargs:
