...
# [GCC 8.4.0]
# Embedded file name: /Users/alanjds/src/git/adwords-client/adwords_client/sqlite.py
# Compiled at: 2017-07-12 10:46:26
# Size of source mod 2**32: 3303 bytes
import inspect, logging, os, sqlite3, tempfile, sqlalchemy
...
def get_connection(file_name=None, sqlalquemy_engine=True, connection_factory=None):
    ...
    def new_connection():
        if connection_factory:
            ...
            return sqlite_factory(db_source)
...
def execute(engine, target_name, operation, *multiparams, schema=None, **params):
    target = sqlalchemy.Table(target_name, (sqlalchemy.MetaData(engine)),
      autoload=True,
