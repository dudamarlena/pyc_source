...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/docbook2sla/tests/test_docbook2pageobject.py
...
class DocBook2PageobjectTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.outputfn = self.d2s.transform('tests/data/xml/article+id.xml', xsl_docbook2pageobject)
