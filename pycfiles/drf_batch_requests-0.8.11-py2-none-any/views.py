...
# [GCC 8.4.0]
# Embedded file name: /home/th13f/dev/drf-batch-requests/drf_batch_requests/views.py
# Compiled at: 2018-10-16 04:32:54
import json
    ...
    def post(self, request, *args, **kwargs):
        ...
        while True:
            ...
            for node in available_nodes:
                ...
                if backend.consume_request(current_request, start_callback=start_callback, success_callback=success_callback, fail_callback=fail_callback):
            ...
            for current_request, response in backend.responses.items():
                if current_request.name in responses:
                    continue
                result = {'code': response.status_code, 'headers': [ {'name': key, 'value': value} for key, value in response._headers.values()
                            ], 
