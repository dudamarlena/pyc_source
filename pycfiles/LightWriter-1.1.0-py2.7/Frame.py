...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/lightwriter/Frame.py
# Compiled at: 2014-09-02 01:39:17
import math, random, webcolors
...
class Frame(object):
    ...
    def set_color_by_name(self, name, node=None):
        ...
        self.set_color_by_rgb(node=node, *rgb)
