...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\formast\__init__.py
# Compiled at: 2012-11-09 15:52:45
...
def _swig_setattr_nondynamic(self, class_type, name, value, static=1):
    if name == 'thisown':
        ...
        if name == 'this':
            ...
            self.__dict__[name] = static or value
        else:
...
class SwigPyIterator(_object):
    ...
    def value(self):
        return _formast.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _formast.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _formast.SwigPyIterator_decr(self, n)

    def distance(self, *args):
        return _formast.SwigPyIterator_distance(self, *args)

    def equal(self, *args):
        return _formast.SwigPyIterator_equal(self, *args)

    def copy(self):
        return _formast.SwigPyIterator_copy(self)

    def next(self):
        return _formast.SwigPyIterator_next(self)

    def __next__(self):
        return _formast.SwigPyIterator___next__(self)

    def previous(self):
        return _formast.SwigPyIterator_previous(self)

    def advance(self, *args):
        return _formast.SwigPyIterator_advance(self, *args)

    def __eq__(self, *args):
        return _formast.SwigPyIterator___eq__(self, *args)

    def __ne__(self, *args):
        return _formast.SwigPyIterator___ne__(self, *args)

    def __iadd__(self, *args):
        return _formast.SwigPyIterator___iadd__(self, *args)

    def __isub__(self, *args):
        return _formast.SwigPyIterator___isub__(self, *args)

    def __add__(self, *args):
        return _formast.SwigPyIterator___add__(self, *args)

    def __sub__(self, *args):
        return _formast.SwigPyIterator___sub__(self, *args)
...
class OptionalDoc(_object):
    ...
    def get(self):
        return _formast.OptionalDoc_get(self)

    def __nonzero__(self):
        return _formast.OptionalDoc___nonzero__(self)

    def __bool__(self):
        return _formast.OptionalDoc___bool__(self)
...
class OptionalEnumStats(_object):
    ...
    def get(self):
        return _formast.OptionalEnumStats_get(self)

    def __nonzero__(self):
        return _formast.OptionalEnumStats___nonzero__(self)

    def __bool__(self):
        return _formast.OptionalEnumStats___bool__(self)
...
class OptionalExpr(_object):
    ...
    def get(self):
        return _formast.OptionalExpr_get(self)

    def __nonzero__(self):
        return _formast.OptionalExpr___nonzero__(self)

    def __bool__(self):
        return _formast.OptionalExpr___bool__(self)
...
class OptionalStats(_object):
    ...
    def get(self):
        return _formast.OptionalStats_get(self)

    def __nonzero__(self):
        return _formast.OptionalStats___nonzero__(self)

    def __bool__(self):
        return _formast.OptionalStats___bool__(self)
...
class OptionalString(_object):
    ...
    def get(self):
        return _formast.OptionalString_get(self)

    def __nonzero__(self):
        return _formast.OptionalString___nonzero__(self)

    def __bool__(self):
        return _formast.OptionalString___bool__(self)
...
class Class(_object):
    ...
    if _newclass:
        name = _swig_property(_formast.Class_name_get, _formast.Class_name_set)
    ...
    if _newclass:
        has_template = _swig_property(_formast.Class_has_template_get, _formast.Class_has_template_set)
...
class If(_object):
    ...
    if _newclass:
        expr = _swig_property(_formast.If_expr_get, _formast.If_expr_set)
    __swig_setmethods__['then'] = _formast.If_then_set
    __swig_getmethods__['then'] = _formast.If_then_get
    if _newclass:
        then = _swig_property(_formast.If_then_get, _formast.If_then_set)
    __swig_setmethods__['else_'] = _formast.If_else__set
    __swig_getmethods__['else_'] = _formast.If_else__get
    if _newclass:
        else_ = _swig_property(_formast.If_else__get, _formast.If_else__set)
...
class EnumConst(_object):
    ...
    if _newclass:
        name = _swig_property(_formast.EnumConst_name_get, _formast.EnumConst_name_set)
    __swig_setmethods__['value'] = _formast.EnumConst_value_set
    __swig_getmethods__['value'] = _formast.EnumConst_value_get
    if _newclass:
        value = _swig_property(_formast.EnumConst_value_get, _formast.EnumConst_value_set)
    __swig_setmethods__['doc'] = _formast.EnumConst_doc_set
    __swig_getmethods__['doc'] = _formast.EnumConst_doc_get
    if _newclass:
        doc = _swig_property(_formast.EnumConst_doc_get, _formast.EnumConst_doc_set)
...
class Parser(_object):
    ...
    def parse_string(self, *args):
        return _formast.Parser_parse_string(self, *args)
...
class Visitor(_object):
    ...
    def module(self, *args):
        return _formast.Visitor_module(self, *args)

    def module_class(self, *args):
        return _formast.Visitor_module_class(self, *args)

    def module_enum(self, *args):
        return _formast.Visitor_module_enum(self, *args)

    def stats(self, *args):
        return _formast.Visitor_stats(self, *args)

    def stats_field(self, *args):
        return _formast.Visitor_stats_field(self, *args)

    def stats_if(self, *args):
        return _formast.Visitor_stats_if(self, *args)

    def enum_stats(self, *args):
        return _formast.Visitor_enum_stats(self, *args)

    def enum_stats_const(self, *args):
        return _formast.Visitor_enum_stats_const(self, *args)

    def expr(self, *args):
        return _formast.Visitor_expr(self, *args)

    def expr_uint(self, *args):
        return _formast.Visitor_expr_uint(self, *args)

    def expr_id(self, *args):
        return _formast.Visitor_expr_id(self, *args)

    def expr_pos(self, *args):
        return _formast.Visitor_expr_pos(self, *args)

    def expr_neg(self, *args):
        return _formast.Visitor_expr_neg(self, *args)

    def expr_add(self, *args):
        return _formast.Visitor_expr_add(self, *args)

    def expr_sub(self, *args):
        return _formast.Visitor_expr_sub(self, *args)

    def expr_mul(self, *args):
        return _formast.Visitor_expr_mul(self, *args)

    def expr_div(self, *args):
        return _formast.Visitor_expr_div(self, *args)

    def expr_mod(self, *args):
        return _formast.Visitor_expr_mod(self, *args)

    def expr_pow(self, *args):
        return _formast.Visitor_expr_pow(self, *args)

    def expr_logical_and(self, *args):
        return _formast.Visitor_expr_logical_and(self, *args)

    def expr_logical_or(self, *args):
        return _formast.Visitor_expr_logical_or(self, *args)

    def expr_logical_not(self, *args):
        return _formast.Visitor_expr_logical_not(self, *args)

    def expr_bitwise_and(self, *args):
        return _formast.Visitor_expr_bitwise_and(self, *args)

    def expr_bitwise_or(self, *args):
        return _formast.Visitor_expr_bitwise_or(self, *args)

    def expr_bitwise_xor(self, *args):
        return _formast.Visitor_expr_bitwise_xor(self, *args)

    def expr_compare_eq(self, *args):
        return _formast.Visitor_expr_compare_eq(self, *args)

    def expr_compare_ne(self, *args):
        return _formast.Visitor_expr_compare_ne(self, *args)

    def expr_compare_gt(self, *args):
        return _formast.Visitor_expr_compare_gt(self, *args)

    def expr_compare_lt(self, *args):
        return _formast.Visitor_expr_compare_lt(self, *args)

    def expr_compare_ge(self, *args):
        return _formast.Visitor_expr_compare_ge(self, *args)

    def expr_compare_le(self, *args):
        return _formast.Visitor_expr_compare_le(self, *args)

    def expr_shift_left(self, *args):
        return _formast.Visitor_expr_shift_left(self, *args)

    def expr_shift_right(self, *args):
        return _formast.Visitor_expr_shift_right(self, *args)
