...
# [GCC 8.4.0]
# Embedded file name: /Users/f1nal/Dropbox/python/jet-bridge/src/packages/jet_bridge_base/jet_bridge_base/serializers/serializer.py
# Compiled at: 2019-10-14 13:33:44
    ...
    def _get_declared_fields(cls, bases, attrs):
        ...
        for base in reversed(bases):
            if hasattr(base, '_declared_fields'):
                fields = [ (field_name, obj) for field_name, obj in base._declared_fields.items() if field_name not in attrs
                         ] + fields
