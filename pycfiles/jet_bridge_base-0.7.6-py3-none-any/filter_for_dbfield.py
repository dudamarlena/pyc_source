...
# Compiled at: 2019-10-22 04:38:22
...
geography_lookups = [
 lookups.COVEREDBY]
FILTER_FOR_DBFIELD = {sqltypes.VARCHAR: {'filter_class': CharFilter, 'lookups': text_lookups}, sqltypes.TEXT: {'filter_class': CharFilter, 'lookups': text_lookups}, sqltypes.BOOLEAN: {'filter_class': BooleanFilter, 'lookups': boolean_lookups}, sqltypes.INTEGER: {'filter_class': IntegerFilter, 'lookups': number_lookups}, sqltypes.SMALLINT: {'filter_class': IntegerFilter, 'lookups': number_lookups}, sqltypes.NUMERIC: {'filter_class': IntegerFilter, 'lookups': number_lookups}, sqltypes.DATETIME: {'filter_class': DateTimeFilter, 'lookups': datetime_lookups}, sqltypes.TIMESTAMP: {'filter_class': DateTimeFilter, 'lookups': datetime_lookups}, sqltypes.JSON: {'filter_class': CharFilter, 'lookups': json_lookups}}
