...
# [GCC 8.4.0]
# Embedded file name: /Users/f1nal/Dropbox/python/jet-bridge/src/packages/jet_bridge_base/jet_bridge_base/fields/field.py
# Compiled at: 2019-10-31 03:08:14
...
class Field(object):
    creation_counter = 0
    field_name = None
    field_error_messages = {'required':'this field is required', 
    ...
    def get_value(self, data):
        try:
            ...
            if not getattr(self, 'many', False):
