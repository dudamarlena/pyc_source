...
data_types = [
 {'query':'VARCHAR', 
  'operator':'startswith',  'date_type':fields.CharField},
 {'query':'TEXT', 
  'operator':'equals',  'date_type':fields.CharField},
 {'query':'BOOLEAN', 
  'operator':'equals',  'date_type':fields.BooleanField},
 {'query':'INTEGER[]', 
  'operator':'startswith',  'date_type':fields.ArrayField},
 {'query':'INTEGER', 
  'operator':'equals',  'date_type':fields.IntegerField},
 {'query':'SMALLINT', 
  'operator':'equals',  'date_type':fields.IntegerField},
 {'query':'NUMERIC', 
  'operator':'startswith',  'date_type':fields.CharField},
 {'query':'VARCHAR', 
  'operator':'startswith',  'date_type':fields.CharField},
 {'query':'TIMESTAMP', 
  'operator':'startswith',  'date_type':fields.DateTimeField},
 {'query':'DATETIME', 
  'operator':'startswith',  'date_type':fields.DateTimeField},
 {'query':'JSON', 
  'operator':'startswith',  'date_type':fields.JSONField},
 {'query':'geometry', 
  'operator':'startswith',  'date_type':fields.WKTField},
 {'query':'geography', 
  'operator':'startswith',  'date_type':fields.WKTField}]
...
def get_column_data_type(column):
    ...
    for rule in data_types:
        if rule['operator'] == 'equals':
            if data_type == rule['query']:
                return rule['date_type']
            elif rule['operator'] == 'startswith':
                if data_type[:len(rule['query'])] == rule['query']:
                    return rule['date_type']
