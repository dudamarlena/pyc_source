...
# Compiled at: 2019-10-23 05:29:03
    ...
    def get_queryset(self):
        ...
        def map_relation(relation):
            ...
            if relation.direction == ONETOMANY:
                field = 'ManyToOneRel'
            return {'name': relation.key, 
               'related_model': {'model': relation.table.name}, 
               'field': field, 
        ...
        def table_m2m_relations(mapper):
            ...
            for relation in mapper.relationships:
                ...
                if len(relation.table.columns) > 5:
                    continue
                self_relationship = m2m_relationships[1] if m2m_relationships[1].table.name == name else m2m_relationships[0]
                other_relationship = m2m_relationships[0] if self_relationship == m2m_relationships[1] else m2m_relationships[1]
                result.append({'name': ('M2M {} {}').format(self_relationship.table.name, other_relationship.table.name), 
