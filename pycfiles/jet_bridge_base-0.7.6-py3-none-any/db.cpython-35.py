...
# Compiled at: 2020-03-07 17:43:48
...
def connect_database(conf):
    ...
    MappedBase.prepare(name_for_scalar_relationship=name_for_scalar_relationship, name_for_collection_relationship=name_for_collection_relationship, generate_relationship=custom_generate_relationship)
    ...
    connections[connection_id] = {'engine': engine, 
     'Session': Session, 
...
def get_settings_conf():
    return {'engine': settings.DATABASE_ENGINE, 
...
def get_request_conf(bridge_settings_encoded):
    ...
    return {'engine': bridge_settings.get('database_engine'), 
