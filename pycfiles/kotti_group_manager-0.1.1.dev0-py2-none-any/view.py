...
# [GCC 8.4.0]
# Embedded file name: /home/ubuntu/workspace/src/kotti_group_manager/kotti_group_manager/views/view.py
# Compiled at: 2018-09-19 02:07:32
"""
Created on 2018-09-19
:author: Oshane Bailey (b4.oshany@gmail.com)
"""
from kotti_toolkit.security import find_group
...
class GroupViews(BaseView):
    ...
    @view_config(route_name='find-group', renderer='kotti_group_manager:templates/group.pt')
...
class GroupPageViews(BaseView):
    ...
    @view_config(name='view', permission='view', renderer='kotti_group_manager:templates/group.page.pt')
    def default_view(self):
