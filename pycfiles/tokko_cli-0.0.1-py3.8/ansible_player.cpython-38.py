...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/src/ansible_player.py
# Compiled at: 2019-12-16 08:24:01
...
class Runner:
    ...
    def __init__(self, hostnames, playbook, private_key_file, run_data, become_pass, verbosity=0):
        ...
        self.pbex = playbook_executor.PlaybookExecutor(playbooks=[
         playbook],
