...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/Moneta/moneta/defaults.py
...
STORAGES = {'archive':{'ENGINE':'moneta.repository.storages.FlatStorage', 
  'ROOT':Directory('{MEDIA_ROOT}/archives'), 
  'PATH_LEN':1}, 
 'default':{'ENGINE':'moneta.repository.storages.FlatStorage', 
  'ROOT':Directory('{MEDIA_ROOT}/uncompressed'), 
  'PATH_LEN':1}, 
 'cache':{'ENGINE':'moneta.repository.storages.FlatStorage', 
