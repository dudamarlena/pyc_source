...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/Moneta/moneta/repository/migrations/0001_initial.py
# Compiled at: 2017-11-02 04:34:54
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='ArchiveState',
       fields=[
      (
     ...
     migrations.CreateModel(name='Element',
      ...
      'verbose_name':'file'}),
     migrations.CreateModel(name='ElementSignature',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='Repository',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.AddField(model_name='archivestate',
       name='repository',
       field=models.ForeignKey(to='repository.Repository', verbose_name='Dépôt', on_delete=(models.CASCADE)))]