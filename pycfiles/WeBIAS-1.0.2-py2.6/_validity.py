...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/webias/gnosis/xml/validity/_validity.py
...
class ValidityError(TypeError):
    pass


class LengthError(ValidityError):
    pass


class ReprError(ValidityError):
    pass
