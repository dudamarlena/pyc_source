...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/webias/gnosis/xml/pickle/test/test_rawp_sre.py
# Compiled at: 2015-04-13 16:10:48
"""Demonstrate that rawpickle works (by saving SREs as rawpickles)"""
import UserList, UserDict
from types import *
import re, StringIO, gnosis.xml.pickle.ext as xml_pickle_ext, gnosis.xml.pickle as xml_pickle
