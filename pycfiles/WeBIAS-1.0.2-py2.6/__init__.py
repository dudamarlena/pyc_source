...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/webias/__init__.py
# Compiled at: 2015-09-25 10:41:14
import cherrypy, sys, os, pkg_resources, webias.gnosis.xml.objectify as objectify
objectify.keep_containers(1)
import os, glob, field, data, auth, admin, user, application, statistics, reports, sqlalchemy
...
def main():
    ...
    mediaconf = {'tools.protect.on': False, 
    ...
    mediabaseconf = {'tools.staticdir.on': True, 
