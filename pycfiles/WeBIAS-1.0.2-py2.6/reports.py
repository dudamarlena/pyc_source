...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/webias/reports.py
# Compiled at: 2015-04-13 16:10:51
import cherrypy, time, config, template, auth, data, sqlalchemy
from util import *
report_frequencies = [
 'N', 'W', 'D', 'H', 'M']
