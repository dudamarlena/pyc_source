...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/webias/gnosis/xml/pickle/test/test_rawp_mx.py
...
from types import *
import gnosis.xml.pickle as xml_pickle, gnosis.xml.pickle.ext as xml_pickle_ext
