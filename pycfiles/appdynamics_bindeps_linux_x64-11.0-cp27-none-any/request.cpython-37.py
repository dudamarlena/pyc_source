...
class AppDynamicsClient(object):
    ...
    def _validate_time_range(self, time_range_type, duration_in_mins, start_time, end_time):
        ...
        elif time_range_type == 'BEFORE_TIME':
            raise end_time and duration_in_mins or 
        elif time_range_type == 'AFTER_TIME':
            raise start_time and duration_in_mins or 
        elif time_range_type == 'BETWEEN_TIMES':
            raise start_time and end_time or 
        return {'time-range-type':time_range_type,  'duration-in-mins':duration_in_mins, 
