...
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/appd/model/hourly_license_usage.py
...
class HourlyLicenseUsage(JsonObject):
    ...
    def __init__(self, id=0, account_id=0, max_units_used=0, min_units_used=0, avg_units_used=0, total_units_used=0, sample_count=0, avg_units_allowed=0, avg_units_provisioned=None, license_module=None, created_on_ms=0):
        self.id, self.account_id, self.max_units_used, self.min_units_used, self.avg_units_used, self.total_units_used, self.sample_count, self.avg_units_allowed, self.avg_units_provisioned, self.license_module, self.created_on_ms = (
         id, account_id, max_units_used, min_units_used, avg_units_used, total_units_used,
