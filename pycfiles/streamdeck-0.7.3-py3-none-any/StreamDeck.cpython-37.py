...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Dean\Documents\Python\python-elgato-streamdeck\src\StreamDeck\Devices\StreamDeck.py
# Compiled at: 2020-04-11 03:11:23
# Size of source mod 2**32: 10307 bytes
...
class StreamDeck(ABC):
    ...
    def _extract_string(self, data):
        ...
        """
        return str(bytes(data), 'utf-8').rstrip(' \x00')
    ...
    def key_image_format(self):
        ...
        """
        return {'size':(
          self.KEY_PIXEL_WIDTH, self.KEY_PIXEL_HEIGHT), 
