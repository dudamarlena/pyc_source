...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Dean\Documents\Python\python-elgato-streamdeck\src\StreamDeck\Transport\LibUSBHIDAPI.py
# Compiled at: 2020-04-16 19:13:08
# Size of source mod 2**32: 16373 bytes
from .Transport import Transport, TransportError
import atexit, ctypes, platform
...
class LibUSBHIDAPI(Transport):
    ...
    class Library:
        ...
        def _load_hidapi_library(self, library_search_list):
            ...
            self.HIDAPI_INSTANCE.hid_open_path.argtypes = [
             ctypes.c_char_p]
            self.HIDAPI_INSTANCE.hid_open_path.restype = ctypes.c_void_p
            self.HIDAPI_INSTANCE.hid_close.argtypes = [
             ctypes.c_void_p]
        ...
        def enumerate(self, vendor_id=None, product_id=None):
            ...
            if device_enumeration:
                ...
                while current_device:
                    device_list.append({'path':current_device.contents.path, 
