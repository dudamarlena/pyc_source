...
# Embedded file name: build\bdist.win32\egg\pykkelabels\pykkelabels.py
# Compiled at: 2015-12-10 13:50:05
# Size of source mod 2**32: 4692 bytes
__doc__ = ' Python implementation of the Pakkelabels.dk php package for interacting with the Pakkelabels.dk web service.\nFor documentation on usage and the methods, see the documentation on https://www.pakkelabels.dk/integration/api/\nand README.md\n'
try:
