...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_core_emotions_anger.py
...
class ResultJSONCoreEmotionsAnger(object):
    ...
    def __init__(self, agent=None, customer=None):
        """ResultJSONCoreEmotionsAnger - a model defined in Swagger"""
        self._agent = None
        self._customer = None
