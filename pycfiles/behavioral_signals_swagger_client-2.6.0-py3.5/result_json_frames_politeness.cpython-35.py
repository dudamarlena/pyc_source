...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_frames_politeness.py
...
class ResultJSONFramesPoliteness(object):
    ...
    def __init__(self, framelevel=None, uptonow=None):
        """ResultJSONFramesPoliteness - a model defined in Swagger"""
