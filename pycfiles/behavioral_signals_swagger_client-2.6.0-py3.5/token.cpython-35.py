...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/token.py
...
class Token(object):
    ...
    def __init__(self, token=None, role=None, cid=None, status=None):
