...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_core.py
...
class ResultJSONCore(object):
    ...
    swagger_types = {'behaviors': 'list[ResultJSONCoreBehaviors]', 
    ...
    attribute_map = {'behaviors': 'behaviors', 
    ...
    def __init__(self, behaviors=None, diarization=None, strength=None, positivity=None, emotions=None, engagement=None, politeness=None, empathy=None, soundquality=None):
