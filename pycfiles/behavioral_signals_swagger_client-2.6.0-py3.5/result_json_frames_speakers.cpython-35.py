...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_frames_speakers.py
# Compiled at: 2020-02-03 04:38:52
# Size of source mod 2**32: 18169 bytes
"""
    Oliver API
...
class ResultJSONFramesSpeakers(object):
    ...
    def __init__(self, id=None, vad=None, beep=None, ring=None, strength=None, snr=None, positivity=None, emotion=None, gender=None, language=None, age=None, engagement=None, activation=None, politeness=None, valence=None, success=None, speaking_rate=None, tone_variety=None, f0=None, escalation=None, resolution=None):
