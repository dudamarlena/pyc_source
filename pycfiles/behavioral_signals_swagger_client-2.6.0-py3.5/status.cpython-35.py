...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/status.py
...
class Status(object):
    ...
    swagger_types = {'response': 'int', 
     'detail': 'str'}
    attribute_map = {'response': 'response', 
     'detail': 'detail'}

    def __init__(self, response=None, detail=None):
