...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_frames.py
...
class ResultJSONFrames(object):
    ...
    swagger_types = {'frames': 'list[ResultJSONFramesFrames]'}
    attribute_map = {'frames': 'frames'}
