...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_frames_frames.py
...
class ResultJSONFramesFrames(object):
    ...
    def __init__(self, no=None, st=None, et=None, intensity=None, aced=None, speakers=None):
        """ResultJSONFramesFrames - a model defined in Swagger"""
        self._no = None
        self._st = None
        self._et = None
    ...
    def no(self, no):
        ...
        """
        if no is None:
            raise ValueError('Invalid value for `no`, must not be `None`')
        self._no = no
    ...
    def st(self, st):
        ...
        """
        if st is None:
            raise ValueError('Invalid value for `st`, must not be `None`')
        self._st = st
    ...
    def et(self, et):
        ...
        """
        if et is None:
            raise ValueError('Invalid value for `et`, must not be `None`')
        self._et = et
