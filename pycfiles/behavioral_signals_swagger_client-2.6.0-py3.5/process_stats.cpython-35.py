...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/process_stats.py
...
class ProcessStats(object):
    ...
    def __init__(self, cid=None, pid=None, status=None, total=None, pending=None, processing=None, retrying=None, retries=None, extended_timers=None):
