...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_kpi.py
...
class ResultJSONKpi(object):
    ...
    attribute_map = {'escalation': 'escalation', 
    ...
    def __init__(self, escalation=None, resolution=None, agentperfscore=None, satisfaction=None, propensity=None, success=None, trends=None, compliance=None):
