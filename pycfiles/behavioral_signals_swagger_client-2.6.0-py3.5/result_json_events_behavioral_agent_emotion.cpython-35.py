...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/behavioral_signals_swagger_client/models/result_json_events_behavioral_agent_emotion.py
...
class ResultJSONEventsBehavioralAgentEmotion(object):
    ...
    def __init__(self, st=None, et=None, label=None, confidence=None):
        """ResultJSONEventsBehavioralAgentEmotion - a model defined in Swagger"""
        self._st = None
        self._et = None
        self._label = None
