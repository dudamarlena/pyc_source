...
# [GCC 8.4.0]
# Embedded file name: /home/pierrey/repos/gitrepo/MQ2/test/test_xls.py
# Compiled at: 2013-05-29 05:26:13
"""
...
TEST_INPUT_PASSED = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'xls', 'rqtl_out.xls.zip')
TEST_INPUT_FAILED = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'xls', 'rqtl_out.xls.invalid.zip')
TEST_INPUT_FAILED2 = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'xls', 'rqtl_out.xls.invalid2.zip')
TEST_INPUT_FAKE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'invalid', 'fake.zip')
TEST_INPUT_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'xls', 'rqtl_out.xls')
TEST_FAKE_INPUT_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'xls', 'fake.xls')
...
class MQ2MapQTLtests(unittest.TestCase):
    ...
    def test_run_mq2_invalid_lod(self):
        ...
        """
        plugin, folder = mq2.get_plugin_and_folder(inputzip=TEST_INPUT_PASSED)
        self.assertRaises(MQ2.MQ2Exception, mq2.run_mq2, plugin, folder=folder, lod_threshold='a', session='Sheet1')
    ...
    def test_run_mq2_invalid_session(self):
        ...
        """
        plugin, folder = mq2.get_plugin_and_folder(inputzip=TEST_INPUT_PASSED)
        self.assertRaises(MQ2.MQ2NoSuchSessionException, mq2.run_mq2, plugin, folder, lod_threshold=3, session='Sheet2')
    ...
    def test_run_mq2(self):
        ...
        self.assertEqual(read_file('qtls.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'qtls.exp')))
        self.assertEqual(read_file('map.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'map.exp')))
        self.assertEqual(read_file('map_with_qtls.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'map_with_qtls.exp')))
        self.assertEqual(read_file('qtls_with_mk.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'qtls_with_mk.exp')))
    ...
    def test_run_mq2_from_file(self):
        ...
        mq2.run_mq2(plugin, folder=TEST_INPUT_FILE, lod_threshold=3, session='Sheet1')
        self.assertEqual(read_file('qtls.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'qtls.exp')))
        self.assertEqual(read_file('map.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'map.exp')))
        self.assertEqual(read_file('map_with_qtls.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'map_with_qtls.exp')))
        self.assertEqual(read_file('qtls_with_mk.csv'), read_file(os.path.join(TEST_FOLDER, 'xls', 'qtls_with_mk.exp')))
    ...
    def test_plugin_get_files(self):
        ...
        self.assertTrue(plugin.get_files(folder)[0].endswith('/rqtl_out.xls'))
    ...
    def test_plugin_get_session_identifiers_failed(self):
        ...
        """
        plugin, folder = mq2.get_plugin_and_folder(inputzip=TEST_INPUT_PASSED)
        self.assertRaises(MQ2.MQ2Exception, plugin.get_session_identifiers, folder=os.path.join(TEST_FOLDER, 'fake.xls'), inputfile=folder)
    ...
    def test_plugin_get_session_identifiers(self):
        ...
        self.assertEqual(plugin.get_session_identifiers(folder=os.path.join(TEST_FOLDER, 'fake.xls')), [])
