...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fudge/tests/test_inspector.py
...
class TestObjectlike(unittest.TestCase):
    ...
    def test_objectlike_repr_long_val(self):
        ...
        eq_(repr(o), "arg.has_attr(bytes='011110101000101010011111111110000001010100000...')")
...
class TestStringlike(unittest.TestCase):
    ...
    def test_startswith_str_long_value(self):
        p = inspector.Startswith('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA')
        eq_(str(p), "arg.startswith('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA...')")

    def test_endswith_str_long_value(self):
        p = inspector.Endswith('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA')
        eq_(str(p), "arg.endswith('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA...')")
...
class TestContains(unittest.TestCase):
    ...
    def test_str_long_val(self):
        c = inspector.Contains('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA')
