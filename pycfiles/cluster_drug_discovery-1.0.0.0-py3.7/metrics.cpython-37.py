...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cluster_drug_discovery/analysis/metrics.py
# Compiled at: 2019-06-17 06:00:42
...
def analysis_run(X, cluster_obj, range_n_clusters=[
 2, 3, 4, 5, 6]):
    silhouette_scores = []
    ...
    if hasattr(cluster_obj, 'nclust'):
        ...
        if hasattr(cluster_obj, 'epsilon'):
            range_n_clusters = [
             0.001, 0.05, 0.1, 0.11, 0.12, 0.13, 0.25, 0.5, 1, 2, 3, 4, 5]
            ...
            for n_clusters in range_n_clusters:
                ...
                if hasattr(cluster_obj, 'nclust'):
                    ...
                    print('For n_clusters =', n_clusters, 'The average silhouette_score is :', silhouette_avg, 'The david bouldin score is:', david_bouldin_score, 'The calinski_score is:', calinski_score)
