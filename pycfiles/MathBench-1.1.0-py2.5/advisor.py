...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mathbench/lab/advisor.py
# Compiled at: 2008-04-07 11:15:12
"""
The interface to chose the user's prefereed options.
"""
import sys, os, logging, wx, wx.py.dispatcher as dispatcher
