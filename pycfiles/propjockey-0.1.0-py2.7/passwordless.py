...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/passwordless/passwordless.py
...
class Passwordless(object):
    ...
    def request_token(self, user, deliver=True):
        ...
        if deliver:
            return self.delivery_method(login_url, email=user, permitted=permitted)
        else:
            return login_url
