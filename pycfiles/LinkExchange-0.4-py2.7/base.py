...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/linkexchange/clients/base.py
# Compiled at: 2011-04-11 15:13:52
import urlparse, Cookie, os, os.path
...
class PageRequest(object):
    ...
    def __init__(self, url=None, type=None, host=None, uri=None, cookies=None, remote_addr=None, meta=None):
        if url:
