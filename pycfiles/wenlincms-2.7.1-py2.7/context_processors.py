...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wenlincms/conf/context_processors.py
...
def settings(request=None):
    ...
    if settings.WLADMIN_INSTALLED:
        settings_dict[b'wenlincms_ADMIN_PREFIX'] = b'wladmin/'
    else:
        settings_dict[b'wenlincms_ADMIN_PREFIX'] = b'admin/'
