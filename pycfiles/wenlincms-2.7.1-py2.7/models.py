...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wenlincms/utils/models.py
# Compiled at: 2016-05-21 00:30:01
...
def base_concrete_model(abstract, instance):
    ...
    In actual wenlincms usage, this allows methods in the ``Displayable`` and
