...
# [GCC 8.4.0]
# Embedded file name: E:\trik\trik\yu\darknet.py
# Compiled at: 2020-04-24 02:09:03
# Size of source mod 2**32: 21416 bytes
"""
...
if os.name == 'nt':
    ...
    try:
        try:
            ...
            if 'CUDA_VISIBLE_DEVICES' in envKeys and int(os.environ['CUDA_VISIBLE_DEVICES']) < 0:
                raise ValueError('ForceCPU')
            try:
    ...
    def performDetect(imagePath=os.path.join(cwd, 'dog.jpg'), thresh=0.25, configPath=os.path.join(cwd, 'yolov4.cfg'), weightPath='yolov4.weights', metaPath='coco.data', showImage=True, makeImageOnly=False, initOnly=False):
        """
    ...
    def performBatchDetect(thresh=0.25, configPath='yolov4.cfg', weightPath='yolov4.weights', metaPath='coco.data', hier_thresh=0.5, nms=0.45, batch_size=3):
        import cv2, numpy as np
        img_samples = [
         'data/person.jpg', 'data/person.jpg', 'data/person.jpg']
