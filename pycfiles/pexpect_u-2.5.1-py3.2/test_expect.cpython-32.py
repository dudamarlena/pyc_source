...
# [GCC 8.4.0]
# Embedded file name: /home/thomas/Code/pexpect/pexpect/build/lib/pexpect/tests/test_expect.py
# Compiled at: 2011-11-02 17:02:52
import pexpect, unittest, subprocess, sys, time
...
class ExpectTestCase(PexpectTestCase.PexpectTestCase):
    ...
    def _expect_index(self, p):
        ...
        p.sendeof()
        index = p.expect(['54321', pexpect.TIMEOUT, 'abcd', 'wxyz', '1234', pexpect.EOF], timeout=5)
        assert index == 5, 'index=' + str(index)
