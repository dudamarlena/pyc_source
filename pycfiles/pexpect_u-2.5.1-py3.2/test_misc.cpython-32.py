...
# [GCC 8.4.0]
# Embedded file name: /home/thomas/Code/pexpect/pexpect/build/lib/pexpect/tests/test_misc.py
...
class TestCaseMisc(PexpectTestCase.PexpectTestCase):
    ...
    def test_which(self):
        ...
        try:
            os.defpath = ':/tmp'
            os.environ['PATH'] = ':/tmp'
            wp = pexpect.which('forwhich.sh')
            assert wp == 'forwhich.sh', 'Should return a string. Returned %s' % wp
            os.defpath = '/tmp'
            os.environ['PATH'] = '/tmp'
