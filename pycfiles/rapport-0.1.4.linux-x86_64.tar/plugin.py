...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/rapport/plugin.py
# Compiled at: 2013-07-30 09:02:25
...
import rapport.config, rapport.util
...
class Plugin(object):
    ...
    def _results(self, dict={}):
        ...
        """
        results = {'plugin': str(self), 'alias': self.alias, 
           'url': self.url, 
           'login': self.login}
        results.update(dict)
        return results
