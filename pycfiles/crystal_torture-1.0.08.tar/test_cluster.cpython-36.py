...
# [GCC 8.4.0]
# Embedded file name: /home/cor/bin/src/crystal_torture/tests/test_cluster.py
# Compiled at: 2019-04-30 06:45:45
...
class ClusterTestCase(unittest.TestCase):
    __doc__ = ' Test for Cluster Class'
    ...
    def test_return_uc_indices(self):
        graph = graph_from_file(filename='tests/STRUCTURE_FILES/POSCAR_SPINEL.vasp',
          rcut=4.0,
          elements={
         'Mg'})
        self.assertEqual(graph.clusters.pop().return_uc_indices(), {
         '0', '1', '2', '3', '4', '5', '6', '7'})
