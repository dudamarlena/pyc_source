...
# [GCC 8.4.0]
# Embedded file name: /home/cor/bin/src/crystal_torture/tests/test_pymatgen_interface.py
# Compiled at: 2019-04-30 06:46:05
...
class PymatgenTestCase(unittest.TestCase):
    ...
    def test_clusters_from_file(self):
        clusters1 = clusters_from_file(filename='tests/STRUCTURE_FILES/POSCAR_2_clusters.vasp',
          rcut=4.0,
          elements={
         'Li'})
        tort.tort_mod.tear_down()
        clusters2 = clusters_from_file(filename='tests/STRUCTURE_FILES/POSCAR_2_clusters.vasp',
          rcut=3.5,
          elements={
         'Li'})
        tort.tort_mod.tear_down()
    ...
    def test_periodic(self):
        clusters1 = clusters_from_file(filename='tests/STRUCTURE_FILES/POSCAR_periodic_1.vasp',
          rcut=4.0,
          elements={
         'Li'})
        clusters2 = clusters_from_file(filename='tests/STRUCTURE_FILES/POSCAR_periodic_2.vasp',
          rcut=4.0,
          elements={
         'Li'})
        clusters3 = clusters_from_file(filename='tests/STRUCTURE_FILES/POSCAR_periodic_3.vasp',
          rcut=4.0,
          elements={
         'Li'})
