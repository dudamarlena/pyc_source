...
# [GCC 8.4.0]
# Embedded file name: /home/cor/bin/src/crystal_torture/tests/test_pymatgen_dopinng.py
# Compiled at: 2019-04-30 06:46:01
...
class PymatgenDopingTestCase(unittest.TestCase):
    __doc__ = ' Test simple doping routines'
    ...
    def test_doping(self, value):
        ...
        for conc in (0.5, ):
            ...
            doped_conc = count_sites(structure_temp,
              species={'Li', 'Al'}, labels={'A'}) / count_sites(structure_temp, labels={'A'})
    ...
    def test_doping_by_no(self, value):
        ...
        for no_dopants in (10, 20, 30, 40):
            structure_temp = copy.deepcopy(structure)
            structure_temp.make_supercell([value, value, value])
            dope_structure_by_no(structure_temp,
              no_dopants, 'Mg', ['Li', 'Al'], label_to_remove='A')
