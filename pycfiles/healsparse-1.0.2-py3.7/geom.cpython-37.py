...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/healsparse/geom.py
...
def realize_geom(geom, smap, type='or'):
    ...
    if type != 'or':
        ...
        geom = isinstance(geom, (list, tuple)) or [
         geom]
    gdict = {}
    for g in geom:
        value = g.value
...
class GeomBase(object):
    ...
    def get_map(self, *, nside_coverage, nside_sparse, dtype, wide_mask_maxbits=None):
        ...
        if isinstance(self._value, (tuple, list, np.ndarray)):
            ...
            smap = HealSparseMap.make_empty(nside_coverage=nside_coverage,
    ...
    def get_map_like(self, sparseMap):
        ...
        return self.get_map(nside_coverage=(sparseMap.nside_coverage), nside_sparse=(sparseMap.nside_sparse),
