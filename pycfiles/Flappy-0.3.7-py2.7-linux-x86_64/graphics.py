...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/flappy/display/graphics.py
...
class Graphics(_core._Graphics):
    ...
    def beginBitmapFill(self, bitmap, m=None, repeat=True, smooth=False):
        ...
        _core._Graphics.beginBitmapFill(self, bitmap, mat, repeat, smooth)

    def beginGradientFill(self, gtype, colors, alphas, ratios, matrix=None, spread_method=SpreadMethod.PAD, interpolation_method=InterpolationMethod.RGB, focal_point_ratio=0.0):
        ...
        _core._Graphics._beginGradientFill(self, linear, colors, alphas, ratios, mat, spread, interp, focal_point_ratio, True)
