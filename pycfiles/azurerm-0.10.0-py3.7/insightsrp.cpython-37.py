...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\azurerm\insightsrp.py
# Compiled at: 2018-11-06 13:51:27
# Size of source mod 2**32: 9218 bytes
"""insightsrp.py - azurerm functions for the Microsoft.Insights resource provider"""
import json
from .restfns import do_get, do_put
from .settings import get_rm_endpoint, INSIGHTS_API, INSIGHTS_COMPONENTS_API, INSIGHTS_METRICS_API, INSIGHTS_PREVIEW_API
...
def create_autoscale_rule(subscription_id, resource_group, vmss_name, metric_name, operator, threshold, direction, change_count, time_grain='PT1M', time_window='PT5M', cool_down='PT1M'):
    ...
    metric_trigger['metricResourceUri'] = '/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group + '/providers/Microsoft.Compute/virtualMachineScaleSets/' + vmss_name
