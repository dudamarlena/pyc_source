...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\azurerm\computerp.py
# Compiled at: 2019-05-01 13:48:02
# Size of source mod 2**32: 50046 bytes
...
def create_vm(access_token, subscription_id, resource_group, vm_name, vm_size, publisher, offer, sku, version, nic_id, location, storage_type='Standard_LRS', osdisk_name=None, username='azure', password=None, public_key=None):
    ...
    image_reference = {'publisher':publisher,  'offer':offer, 
...
def create_vmss(access_token, subscription_id, resource_group, vmss_name, vm_size, capacity, publisher, offer, sku, version, subnet_id, location, be_pool_id=None, lb_pool_id=None, storage_type='Standard_LRS', username='azure', password=None, public_key=None, overprovision=True, upgrade_policy='Manual', public_ip_per_vm=False):
    ...
    os_disk['caching'] = 'ReadWrite'
    storage_profile = {'osDisk': os_disk}
    storage_profile['imageReference'] = {'publisher':publisher, 
    ...
    if be_pool_id is not None:
        ip_properties['loadBalancerBackendAddressPools'] = [
         {'id': be_pool_id}]
    if lb_pool_id is not None:
        ip_properties['loadBalancerInboundNatPools'] = [
         {'id': lb_pool_id}]
