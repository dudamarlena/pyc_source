...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/twisted_goodies/taskqueue/base.py
...
class TaskQueue(object):
    ...
    def _startup(self):
        ...
        self._d = runner()
        self._triggerID = reactor.addSystemEventTrigger('before', 'shutdown', self.shutdown)
    ...
    def call(self, func, *args, **kw):
        ...
        if not self.isRunning():
            if self.warnOnly:
                ...
                kwString = (', ').join([ '%s=%s' % (str(name), str(value)) for (name, value) in kw.iteritems() ])
                if args and kw:
                    sepString = ', '
                else:
                    sepString = ''
                ...
                raise QueueRunError('Cannot call after the queue has been shut down')
    ...
    def subscribe(self, consumer):
        ...
        if interfaces.IConsumer.providedBy(consumer):
            ...
            raise ImplementationError("Object doesn't provide the IConsumer interface")