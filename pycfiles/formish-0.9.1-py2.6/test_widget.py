...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/formish/tests/unittests/test_widget.py
# Compiled at: 2010-03-01 05:16:45
import base, unittest, formish, schemaish
...
class TestErrorRendering(base.TestCase):
    ...
    def test_simple(self):
        ...
        self._test(schemaish.Structure([
         (
          'simple', schemaish.String())]), 'simple')
    ...
    def test_structure_error(self):
        ...
        self._test(schemaish.Structure([
         (
          ...
          schemaish.Structure([
           (
            'string', schemaish.String())]))]), 'structure')

    def test_sequence_error(self):
        self._test(schemaish.Structure([
         (
          'sequence', schemaish.Sequence(schemaish.String()))]), 'sequence')
...
class TestSequenceDefault(base.TestCase):
    ...
    def _schema(self):
        return schemaish.Structure([
         (
          'seq',
          schemaish.Sequence(schemaish.Structure([
           (
...
class TestSelectChoice(base.TestCase):
    ...
    def test_default(self):
        form = formish.Form(schemaish.Structure([
         (
