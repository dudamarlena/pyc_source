...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/formish/tests/unittests/test_formdata.py
# Compiled at: 2009-06-11 12:36:07
import validatish, formish, schemaish, unittest
    ...
    schema_nested = schemaish.Structure([
     (
      ...
      schemaish.Structure([
       (
        'a',
        schemaish.String(validator=validatish.Required(), description='This is a field with name a and title A and has a Required validator')),
       (
