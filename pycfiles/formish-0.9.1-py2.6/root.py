...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/formish/tests/testish/testish/resource/root.py
...
def get_forms(ids):
    ...
    for f in ids:
        ...
        out.append({'name': f, 'title': formish.util.title_from_name(f), 
...
class Root(resource.Resource):
    ...
    def resource_child(self, request, segments):
        ...
        return (
         FormResource(segments[0]), segments[1:])
...
class FormResource(resource.Resource):
    ...
    def render_form(self, request, form=None, data=None):
        ...
        return {'title': self.title, 'description': self.description, 'form': form, 'data': pformat(data), 'rawdata': data, 'template': extract_function.extract_docstring('template_%s' % self.id), 
