...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/formish/widgets.py
# Compiled at: 2010-02-16 11:28:14
"""
Commonly needed form widgets.
"""
__all__ = [
 'Input', 'Password', 'CheckedPassword', 'CheckedInput', 'Hidden', 'TextArea',
    ...
    def from_request_data(self, field, request_data, skip_read_only_default=False):
        ...
        for f in field.fields:
            try:
                ...
                elif skip_read_only_default is False:
    ...
    def from_request_data(self, field, request_data, skip_read_only_defaults=False):
        ...
        for f in field.fields:
            try:
                ...
                elif skip_read_only_defaults is False:
...
class FileUpload(Widget):
    ...
    def __init__(self, filestore=UNSET, show_file_preview=True, show_download_link=False, show_image_thumbnail=False, url_base=None, css_class=None, image_thumbnail_default=None, show_remove_checkbox=True, url_ident_factory=None):
        """
    ...
    def from_request_data(self, field, request_data):
        ...
        if request_data['name'] == ['']:
            ...
            if request_data['name'] == request_data['default']:
...
class SelectWithOtherChoice(SelectChoice):
    ...
    def selected--- This code section failed: ---

 L. 830         0  LOAD_FAST             2  'field'
                3  LOAD_ATTR             0  'value'
                6  LOAD_CONST               'select'
                9  BINARY_SUBSCR    
               10  STORE_FAST            3  'value'

 L. 831        13  LOAD_FAST             1  'option'
               16  LOAD_CONST               0
               19  BINARY_SUBSCR    
               20  LOAD_FAST             0  'self'
               23  LOAD_ATTR             1  'other_option'
               26  LOAD_CONST               0
               29  BINARY_SUBSCR    
               30  COMPARE_OP            2  ==
               33  JUMP_IF_FALSE        64  'to 100'
             36_0  THEN                     100
               36  POP_TOP          
               37  LOAD_FAST             3  'value'
               40  LOAD_CONST               0
               43  BINARY_SUBSCR    
               44  BUILD_LIST_0          0 
               47  DUP_TOP          
               48  STORE_FAST            4  '_[1]'
               51  LOAD_FAST             0  'self'
               54  LOAD_ATTR             2  'get_options'
               57  LOAD_FAST             2  'field'
               60  CALL_FUNCTION_1       1  None
               63  GET_ITER         
               64  FOR_ITER             19  'to 86'
               67  UNPACK_SEQUENCE_2     2 
               70  STORE_FAST            3  'value'
               73  STORE_FAST            5  'label'
               76  LOAD_FAST             4  '_[1]'
               79  LOAD_FAST             3  'value'
               82  LIST_APPEND      
               83  JUMP_BACK            64  'to 64'
               86  DELETE_FAST           4  '_[1]'
               89  COMPARE_OP            7  not-in
               92  JUMP_IF_FALSE         5  'to 100'
             95_0  THEN                     100
               95  POP_TOP          

 L. 832        96  LOAD_CONST               ' selected="selected"'
               99  RETURN_END_IF    
              100  POP_TOP          

 L. 834       101  LOAD_FAST             1  'option'
              104  LOAD_CONST               0
              107  BINARY_SUBSCR    
              108  LOAD_FAST             3  'value'
              111  LOAD_CONST               0
              114  BINARY_SUBSCR    
              115  COMPARE_OP            2  ==
              118  JUMP_IF_FALSE         5  'to 126'
            121_0  THEN                     126
              121  POP_TOP          

 L. 835       122  LOAD_CONST               ' selected="selected"'
              125  RETURN_END_IF    
              126  POP_TOP          

 L. 837       127  LOAD_CONST               ''
              130  RETURN_VALUE     

Parse error at or near `LOAD_CONST' instruction at offset 127
