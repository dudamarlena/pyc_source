...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/quicli/progress.py
# Compiled at: 2011-09-10 15:07:25
import sys
...
class BarProgress(ProgressBase):
    ...
    def __init__(self, total=1):
        ...
        self.parts = [ chr(code) for code in (9612, 9608) if ON_WINDOWS else reversed(list(range(9608, 9616))) ]
        self.total = max(total, 1)
        self.current = 0
