...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/quicli/guts.py
# Compiled at: 2011-09-14 00:47:34
import os, inspect
...
class ParserAssembler(object):
    ...
    def run(self, run_on_import=False):
        ...
        """
        if self.__was_imported and not run_on_import:
            return
        ...
        if func is None:
            ...
            if hasattr(func, '_quicli_arguments'):
                for override_args, override_kwargs in func._quicli_arguments:
                    ...
                    if override_args and argument_name in arguments:
                        args, kwargs = arguments[argument_name]
