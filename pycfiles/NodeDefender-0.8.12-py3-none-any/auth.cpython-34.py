...
# [GCC 8.4.0]
# Embedded file name: /mnt/develop/NodeDefender/NodeDefender/frontend/views/auth.py
# Compiled at: 2018-01-09 06:06:44
# Size of source mod 2**32: 4663 bytes
from flask_login import login_user, logout_user
from NodeDefender.frontend.forms.auth import LoginForm, RegisterForm, RegisterTokenForm, PasswordForm
...
def authenticate():
    ...
    if NodeDefender.app.config['SELF_REGISTRATION']:
        ...
        return render_template('frontend/auth/login_and_register.html', LoginForm=login_form, RegisterForm=register_form)
...
def register_token(token):
    ...
    if request.method == 'GET':
        return render_template('frontend/auth/register.html', RegisterForm=register_form, user=user)
...
def reset_password(token):
    ...
    if request.method == 'GET':
        return render_template('frontend/auth/reset_password.html', user=user, PasswordForm=password_form)
