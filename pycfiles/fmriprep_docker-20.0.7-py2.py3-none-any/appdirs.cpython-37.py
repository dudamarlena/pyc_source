...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-aejasjrz/setuptools/pkg_resources/_vendor/appdirs.py
# Compiled at: 2020-05-05 12:41:47
# Size of source mod 2**32: 24701 bytes
...
class AppDirs(object):
    __doc__ = 'Convenience wrapper for getting application dirs.'
    ...
    def user_data_dir(self):
        return user_data_dir((self.appname), (self.appauthor), version=(self.version),
    ...
    def user_config_dir(self):
        return user_config_dir((self.appname), (self.appauthor), version=(self.version),
          roaming=(self.roaming))

    @property
    def site_config_dir(self):
        return site_config_dir((self.appname), (self.appauthor), version=(self.version),
          multipath=(self.multipath))
...
def _get_win_folder_from_registry(csidl_name):
    ...
    if PY3:
        ...
        import _winreg
    shell_folder_name = {'CSIDL_APPDATA':'AppData', 
...
if __name__ == '__main__':
    appname = 'MyApp'
    appauthor = 'MyCompany'
    props = ('user_data_dir', 'user_config_dir', 'user_cache_dir', 'user_state_dir',
