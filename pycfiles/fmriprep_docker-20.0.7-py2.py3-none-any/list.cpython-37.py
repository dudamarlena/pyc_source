...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-aejasjrz/pip/pip/_internal/commands/list.py
...
class ListCommand(IndexGroupCommand):
 ...
 L. 226         0  LOAD_GLOBAL              sorted

 L. 227         2  LOAD_FAST                'packages'

 L. 228         4  LOAD_LAMBDA              '<code_object <lambda>>'
 ...
 L. 231        30  LOAD_GLOBAL              format_for_columns
 ...
 L. 239       110  LOAD_GLOBAL              write_output
              112  LOAD_STR                 '%s==%s'
              114  LOAD_FAST                'dist'
 ...
 L. 240       132  LOAD_FAST                'options'
              134  LOAD_ATTR                list_format
              136  LOAD_STR                 'json'
              138  COMPARE_OP               ==
              140  POP_JUMP_IF_FALSE   156  'to 156'

 L. 241       142  LOAD_GLOBAL              write_output
