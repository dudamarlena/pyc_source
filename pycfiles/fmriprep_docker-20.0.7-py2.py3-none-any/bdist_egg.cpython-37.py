...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-aejasjrz/setuptools/setuptools/command/bdist_egg.py
# Compiled at: 2020-05-05 12:41:47
# Size of source mod 2**32: 18406 bytes
...
class bdist_egg(Command):
    ...
    def run(self):
        ...
        if all_outputs:
            ...
            self.dry_run or ensure_directory(native_libs)
        ...
        for base, dirs, files in walk_egg(self.bdist_dir):
            for name in files:
                ...
                if base.endswith('__pycache__'):
                    ...
                    log.info('Renaming file from [%s] to [%s]' % (
                     path_old, path_new))
                    try:
                        os.remove(path_new)
                    except OSError:
    ...
    def get_ext_outputs(self):
        ...
        if self.distribution.has_ext_modules():
            ...
            for ext in build_cmd.extensions:
                ...
                if os.path.basename(filename).startswith('dl-') or os.path.exists(os.path.join(self.bdist_dir, filename)):
