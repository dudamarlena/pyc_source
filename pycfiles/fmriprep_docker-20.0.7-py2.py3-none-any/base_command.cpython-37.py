...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-aejasjrz/pip/pip/_internal/cli/base_command.py
...
if MYPY_CHECK_RUNNING:
    ...
    import pip._internal.utils.temp_dir as TempDirRegistry
__all__ = [
 'Command']
    ...
    def _main(self, args):
        ...
        if sys.version_info[:2] == (2, 7):
            if not options.no_python_version_warning:
                message = 'pip 21.0 will drop support for Python 2.7 in January 2021. More details about Python 2 support in pip, can be found at https://pip.pypa.io/en/latest/development/release-process/#python-2-support'
