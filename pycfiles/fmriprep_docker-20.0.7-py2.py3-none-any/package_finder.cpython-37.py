...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-aejasjrz/pip/pip/_internal/index/package_finder.py
# Compiled at: 2020-05-05 12:41:47
# Size of source mod 2**32: 37676 bytes
    ...
    def evaluate_link(self, link):
        ...
        if link.egg_fragment:
            ...
            if ext not in SUPPORTED_EXTENSIONS:
                return (
                 False, 'unsupported archive format: {}'.format(ext))
