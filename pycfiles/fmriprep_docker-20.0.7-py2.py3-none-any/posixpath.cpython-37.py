...
# [GCC 8.4.0]
# Embedded file name: /tmp/src/fmriprep/wrapper/build/lib/python3.7/posixpath.py
# Compiled at: 2019-09-12 11:41:56
# Size of source mod 2**32: 15771 bytes
...
def normpath--- This code section failed: ---
 ...
 L. 342        20  LOAD_CONST               b'/'
               22  STORE_FAST               'sep'

 L. 343        24  LOAD_CONST               b''
               26  STORE_FAST               'empty'

 L. 344        28  LOAD_CONST               b'.'
               30  STORE_FAST               'dot'

 L. 345        32  LOAD_CONST               b'..'
...
def _joinrealpath--- This code section failed: ---
 ...
 L. 402        10  LOAD_CONST               b'/'
               12  STORE_FAST               'sep'

 L. 403        14  LOAD_CONST               b'.'
               16  STORE_FAST               'curdir'

 L. 404        18  LOAD_CONST               b'..'
