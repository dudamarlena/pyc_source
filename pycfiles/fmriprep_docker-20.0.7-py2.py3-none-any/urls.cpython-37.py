...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-aejasjrz/pip/pip/_internal/utils/urls.py
...
def url_to_path(url):
    ...
    if not url.startswith('file:'):
        raise AssertionError(('You can only turn file: urls into filenames (not {url!r})'.format)(**locals()))
    else:
