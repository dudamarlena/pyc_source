...
# [GCC 8.4.0]
# Embedded file name: /Users/spielmann/prog/bitchest/server/env/src/django-sparkle/sparkle/migrations/0007__del_field_version_active__del_field_version_published.py
# Compiled at: 2013-07-23 03:50:06
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('sparkle_version', 'active')
        db.delete_column('sparkle_version', 'published')

    def backwards(self, orm):
        db.add_column('sparkle_version', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('sparkle_version', 'published', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=safe_default, blank=True), keep_default=False)
