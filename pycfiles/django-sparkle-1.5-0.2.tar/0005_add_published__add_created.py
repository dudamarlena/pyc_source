...
# [GCC 8.4.0]
# Embedded file name: /Users/spielmann/prog/bitchest/server/env/src/django-sparkle/sparkle/migrations/0005_add_published__add_created.py
# Compiled at: 2013-07-23 03:49:51
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('sparkle_version', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=safe_default, blank=True), keep_default=False)
        db.add_column('sparkle_version', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(default=safe_default, blank=True, null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('sparkle_version', 'created')
        db.delete_column('sparkle_version', 'publish_date')
