...
# [GCC 8.4.0]
# Embedded file name: /Users/jace/Dropbox/projects/hasgeek/baseframe/baseframe/forms/fields.py
# Compiled at: 2017-03-08 12:17:19
...
__all__ = [
 'SANITIZE_TAGS', 'SANITIZE_ATTRIBUTES',
...
SANITIZE_TAGS = [
 'p', 'br', 'strong', 'em', 'sup', 'sub', 'h3', 'h4', 'h5', 'h6', 'ul', 'ol', 'li', 'a',
 'blockquote', 'code']
...
class TinyMce3Field(TextAreaField):
    ...
    def __init__(self, label='', validators=None, filters=(), description='', id=None, default=None, widget=None, _form=None, _name=None, _prefix='', content_css=None, linkify=True, nofollow=True, tinymce_options=None, sanitize_tags=None, sanitize_attributes=None, **kwargs):
        super(TinyMce3Field, self).__init__(label=label, validators=validators, filters=filters, description=description, id=id, default=default, widget=widget, _form=_form, _name=_name, _prefix=_prefix, **kwargs)
        ...
        tinymce_options.setdefault('theme_advanced_buttons1', 'bold,italic,|,sup,sub,|,bullist,numlist,|,link,unlink,|,blockquote,|,removeformat,code')
        ...
        tinymce_options.setdefault('valid_elements', 'p,br,strong/b,em/i,sup,sub,h3,h4,h5,h6,ul,ol,li,a[!href|title|target],blockquote,code')
    ...
    def process_formdata(self, valuelist):
        ...
        self.data = bleach.clean(self.data, strip=True, tags=self.sanitize_tags, attributes=self.sanitize_attributes)
        if self.linkify:
            if self.nofollow:
...
class TinyMce4Field(TextAreaField):
    ...
    def __init__(self, label='', validators=None, filters=(), description='', id=None, default=None, widget=None, _form=None, _name=None, _prefix='', content_css=None, linkify=True, nofollow=True, tinymce_options=None, sanitize_tags=None, sanitize_attributes=None, **kwargs):
        super(TinyMce4Field, self).__init__(label=label, validators=validators, filters=filters, description=description, id=id, default=default, widget=widget, _form=_form, _name=_name, _prefix=_prefix, **kwargs)
        if tinymce_options is None:
            tinymce_options = {}
        else:
            tinymce_options = dict(tinymce_options)
...
class DateTimeField(wtforms.fields.DateTimeField):
    ...
    def __init__(self, label=None, validators=None, format='%Y-%m-%d %H:%M', timezone=None, **kwargs):
