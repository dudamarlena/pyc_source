...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/treadmill/rrdutils.py
# Compiled at: 2017-04-03 02:32:49
# Size of source mod 2**32: 8098 bytes
"""Useful rrd utility functions."""
import errno, logging, time, os, socket
from . import fs
from . import metrics
from . import sysinfo
...
class RRDError(Exception):
    __doc__ = 'RRD protocol error.'


class RRDClient(object):
    __doc__ = 'RRD socket client.'
...
def flush_noexc(rrdfile, rrd_socket='/tmp/treadmill.rrd'):
    ...
    try:
        try:
            ...
            _LOGGER.exception('error sending command to rrdcache on %s', rrd_socket)
