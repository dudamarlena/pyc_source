...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/treadmill/cli/admin/diag.py
# Compiled at: 2017-04-03 02:32:49
# Size of source mod 2**32: 2067 bytes
"""Reports memory utilization details for given container."""
import os, prettytable, click
...
def init():
    ...
    def psmem_cmd(fast, cgroup):
        ...
        columns = [
         'name', 'count', 'private', 'shared', 'total']
        ...
        for proc, info in sorted(memusage.items()):
            table.add_row([proc, info['count']] + [readable(info[col]) for col in ['private',
             'shared',
             'total']])
