...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/treadmill/gssapiprotocol.py
# Compiled at: 2017-04-03 02:32:49
# Size of source mod 2**32: 7026 bytes
...
class GSSBase(object):
    __doc__ = 'Base class for gss operations.'
...
class GSSServer(GSSBase):
    __doc__ = 'GSSServer class, accept and authentication connections.'
...
class GSSAPILineServer(basic.LineReceiver):
    __doc__ = 'Line based GSSAPI server.'
    delimiter = '\n'
...
class GSSAPILineClient(object):
    __doc__ = 'GSSAPI line based syncrounos client.'
