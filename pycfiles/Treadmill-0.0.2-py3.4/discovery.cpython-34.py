...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/treadmill/discovery.py
# Compiled at: 2017-04-03 02:32:49
# Size of source mod 2**32: 4067 bytes
"""List Treadmill endpoints matching a given pattern."""
import queue, fnmatch, logging, kazoo
from treadmill import zknamespace as z
_LOGGER = logging.getLogger(__name__)

class Discovery(object):
    __doc__ = 'Treadmill endpoint discovery.'
    ...
    def get_endpoints_zk(self, watch_cb=None):
        ...
        try:
            endpoints = self.zkclient.get_children(endpoints_path, watch=watch_cb)
            match = set([endpoint for endpoint in endpoints if fnmatch.fnmatch(endpoint, full_pattern)])
