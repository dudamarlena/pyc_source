...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/treadmill/postmortem.py
# Compiled at: 2017-04-03 02:32:49
# Size of source mod 2**32: 4742 bytes
"""Collect Treadmill node information after a crash.
"""
import os, glob, logging, shutil, tempfile
...
def collect(approot, archive_filename):
    ...
    try:
        archive_filename = fs.tar(sources=destroot, target=archive_filename, compression='gzip').name
