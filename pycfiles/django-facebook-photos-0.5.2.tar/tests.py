...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-facebook-photos/facebook_photos/tests.py
# Compiled at: 2016-04-02 10:16:20
...
class FacebookPhotoTest(FacebookApiTestCase):
    ...
    def test_fetch_album_counts(self):
        ...
        for i in range(0, 100):
            PhotoFactory(album=album, likes_count=randint(0, 100), comments_count=randint(0, 100), shares_count=randint(0, 100))
    ...
    def test_photo_fetch_shares(self):
        ...
        self.assertGreaterEqual(users.count(), 233)
        self.assertEqual(users.count(), User.objects.count())
