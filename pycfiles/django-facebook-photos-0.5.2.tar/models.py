...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-facebook-photos/facebook_photos/models.py
# Compiled at: 2016-04-02 10:14:03
import logging
...
from facebook_api.mixins import OwnerableModelMixin, AuthorableModelMixin, LikableModelMixin, ShareableModelMixin, ActionableModelMixin
...
class Album(OwnerableModelMixin, AuthorableModelMixin, LikableModelMixin, CommentableModelMixin, ShareableModelMixin, ActionableModelMixin, FacebookGraphIntPKModel):
    ...
    place = JSONField(null=True, blank=True)
...
class Photo(AuthorableModelMixin, LikableModelMixin, CommentableModelMixin, ShareableModelMixin, ActionableModelMixin, FacebookGraphIntPKModel):
