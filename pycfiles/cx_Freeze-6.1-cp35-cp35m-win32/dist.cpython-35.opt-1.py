...
# Size of source mod 2**32: 13128 bytes
...
class build_exe(distutils.core.Command):
    ...
    user_options = [
     ...
     ('zip-include-packages=', None, 'comma-separated list of packages to include in the zip file (or * for all) [default: none]'),
     ('zip-exclude-packages=', None, 'comma-separated list of packages to exclude from the zip file and place in the file system instead (or * for all) [default: *]'),
     ('silent', 's', 'suppress all output except warnings')]
    boolean_options = [
     'no-compress', 'include_msvcr', 'silent']
    ...
    def run(self):
        ...
        constants_module = cx_Freeze.ConstantsModule(metadata.version, constants=self.constants)
