...
# [GCC 8.4.0]
# Embedded file name: /home/seda/PycharmProjects/dp-nix/tests/data/odml/odml_test_data.py
# Compiled at: 2020-04-30 16:13:15
...
GENERATED_STRUCTURE = {'experiment__experiment':{'corresponding_term':{'name':'Experiment', 
   'type':'experiment',  'parent_sections':''}, 
  'props':{'start-time':{'type':'string', 
    'example_value':"['17.12.2013, 10:08:00']", 
    'corresponding_term':{'name':'start-time', 
     'type':'string', 
     'parent_sections':'experiment__Experiment'}}, 
   'scenario-title':{'type':'string', 
    'example_value':"['AUDITORY ERP PROTOCOL IN CHILDREN WITH DEVELOPMENTAL COORDINATION DISORDER']", 
    'corresponding_term':{'name':'scenario-title', 
     'type':'string', 
     'parent_sections':'experiment__Experiment'}}, 
   'temperature':{'type':'string', 
    'example_value':"['23']", 
    'corresponding_term':{'name':'temperature', 
     'type':'string', 
     'parent_sections':'experiment__Experiment'}}}}, 
 'collection__devices':{'corresponding_term':{'name':'Devices', 
   'type':'collection', 
   'parent_sections':''}, 
  'props':{}}, 
 'hardware__response button':{'corresponding_term':{'name':'Response button', 
   'type':'hardware', 
   'parent_sections':'collection__Devices'}, 
  'props':{'description': {'type':'string', 
                   'example_value':'[\'"A response button is an electrical component that can break an electrical circuit\']', 
                   'corresponding_term':{'name':'description', 
                    'type':'string', 
                    'parent_sections':'collection__Devices___hardware__Response button'}}}}, 
 'hardware__power supply':{'corresponding_term':{'name':'Power supply', 
   'type':'hardware', 
   'parent_sections':'collection__Devices'}, 
  'props':{'type': {'type':'string', 
            'example_value':"['PS607110246wr']", 
            'corresponding_term':{'name':'type', 
             'type':'string', 
