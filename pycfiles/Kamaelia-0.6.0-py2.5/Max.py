...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Util/Max.py
...
class Max(component):
    ...
    """
    Inboxes = {'inbox': 'Lists of values', 'control': 'Shutdown signalling'}
    Outboxes = {'outbox': 'Maximum value from the lists', 'signal': 'Shutdown signalling'}
...
if __name__ == '__main__':
    ...
    Pipeline(DataSource([(1, 4, 2, 3), ('d', 'a', 'b', 'c'), ('xx', 'xxx')]), Max(), ConsoleEchoer()).run()