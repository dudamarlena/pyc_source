...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/UI/OpenGL/SimpleTranslationInteractor.py
        ...
        while self.dataReady('events'):
            ...
            if event.type == pygame.MOUSEMOTION:
                if self.grabbed == True:
                    amount = (
                     float(event.rel[0]) / self.translationfactor, -float(event.rel[1]) / self.translationfactor)
