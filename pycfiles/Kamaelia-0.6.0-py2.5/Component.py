...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Axon/Component.py
      ...
      class IncrementByN(Axon.Component.component):
          ...
          def main(self):
              while 1:
                  ...
                  yield 1
   """
    Inboxes = {'inbox': 'Default inbox for bulk data. Used in a pipeline much like stdin', 'control': 'Secondary inbox often used for signals. The closest analogy is unix signals'}
    Outboxes = {'outbox': 'Default data out outbox, used in a pipeline much like stdout', 'signal': 'The default signal based outbox - kinda like stderr, but more for sending singal type signals'}
    Usescomponents = []
