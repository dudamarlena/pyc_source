...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/XML/SimpleXMLParser.py
...
class SimpleXMLParser(component, handler.ContentHandler):
    ...
    outbox.
    """
    Inboxes = {'inbox': 'Incoming XML', 'control': 'Shutdown signalling'}
    Outboxes = {'outbox': 'XML events', 'signal': 'Shutdown signalling'}
...
if __name__ == '__main__':
    ...
    Pipeline(MaxSpeedFileReader('TestEDL.xml', chunksize=128), 1, SimpleXMLParser(), 1, SlowOutputter()).run()