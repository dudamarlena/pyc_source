...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Support/Particles/SimpleLaws.py
...
class SimpleLaws(object):
    ...
    def __init__(self, bondLength=100, maxRepelRadius=None, repulsionStrength=None, maxBondForce=None, damp=None, dampcutoff=None, maxVelocity=None):
    ...
    def unbonded(self, ptype1, ptype2, dist, distSquared):
        ...
        if distSquared < 1.0:
            ...
            return -self.maxRepulsionForce / distSquared
