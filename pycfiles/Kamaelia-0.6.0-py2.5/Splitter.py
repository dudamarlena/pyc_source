...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Util/Splitter.py
...
class Splitter(Axon.AdaptiveCommsComponent.AdaptiveCommsComponent):
   ...
   destinations.
   """
    Inboxes = {'inbox': 'Source of data items', 'control': 'NOT USED', 
...
class PlugSplitter(Axon.AdaptiveCommsComponent.AdaptiveCommsComponent):
    ...
    """
    Inboxes = {'inbox': 'Data items to be fanned out.', 'control': 'Shutdown signalling, and signalling to be fanned out.', 
       'configuration': 'addsink(...) and removesink(...) request messages', 
    ...
    Outboxes = {'outbox': "Data items received on 'inbox' inbox.", 'signal': "Shutdown signalling, and data items received on 'control' inbox."}
...
class Plug(Axon.Component.component):
    ...
    """
    Inboxes = {'inbox': 'Incoming data for child component', 'control': 'Incoming control data for child component, and shutdown signalling'}
    Outboxes = {'outbox': 'Outgoing data from child component', 'signal': 'Outgoing control data from child component, and shutdown signalling', 
