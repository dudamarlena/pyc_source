...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Visualisation/Axon/PPostbox.py
...
class PPostbox(BaseParticle):
    ...
    colours = {('inbox', 'outbox'): (0, 160, 0), ('outbox', 'inbox'): (0, 160, 0), 
    ...
    def buildLabels(self):
        ...
        self.desclabel = font.render(self.postboxtype.upper() + ' : ' + self.name, True, (0,
                                                                                          0,
                                                                                          0), (255,
                                                                                               255,
                                                                                               255))
