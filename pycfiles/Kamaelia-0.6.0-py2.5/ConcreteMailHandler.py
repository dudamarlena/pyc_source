...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Apps/Grey/ConcreteMailHandler.py
...
class ConcreteMailHandler(MailHandler):
    Inboxes = {'inbox': 'Data from the client connecting to the server comes in here', 
    ...
    Outboxes = {'outbox': 'Data sent here goes back the the client connecting to the server', 
    ...
    def handleHelo(self, command):
        ...
        self.inbox_log = self.inbox_log[-1:]
        self.seenHelo = True
