...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/File/Writing.py
...
class SimpleFileWriter(component):
    ...
    """
    Inboxes = {'inbox': 'data to write to file', 'control': 'to receive shutdown/finished messages'}
    Outboxes = {'outbox': 'not used', 'signal': 'shutdown/finished signalling'}
...
if __name__ == '__main__':
    ...
    Pipeline(RateControlledFileReader('Writing.py'), SimpleFileWriter('/tmp/tmp_Writing.py')).run()