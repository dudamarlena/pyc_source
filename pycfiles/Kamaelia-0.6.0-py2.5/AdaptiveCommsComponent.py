...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Axon/AdaptiveCommsComponent.py
...
class _AdaptiveCommsable(object):
   ...
   """
    ...
    def trackResourceInformation(self, resource, inboxes, outboxes, information):
      ...
      """
        [ self.inboxes[x] for x in inboxes ]
        [ self.outboxes[x] for x in outboxes ]
        self._resourceStore[resource] = (
         inboxes, outboxes, information)
