...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/UI/OpenGL/ProgressBar.py
...
if __name__ == '__main__':
    ...
    Graphline(BOUNCE=bouncingFloat(0.5), PROGRESS=ProgressBar(size=(3, 0.5, 0.2), position=(0,
                                                                                            0,
                                                                                            -10), progress=0.5), linkages={('BOUNCE', 'outbox'): ('PROGRESS', 'progress')}).run()