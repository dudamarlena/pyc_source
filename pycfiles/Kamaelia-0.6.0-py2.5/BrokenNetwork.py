...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Internet/Simulate/BrokenNetwork.py
...
if __name__ == '__main__':
    ...
    Pipeline(Source(), Annotator(), Duplicate(), Throwaway(), Reorder(), RecoverOrder(), ConsoleEchoer()).run()