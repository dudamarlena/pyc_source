...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Support/Data/Rationals.py
...
def limit(rational, poslimit, neglimit):
   ...
   """
    ...
    divide = max(1.0, n / poslimit, d / poslimit, n / neglimit, d / neglimit)
    if divide > 1.0:
        return (
         int(n / divide), int(d / divide))
    else:
        return rational