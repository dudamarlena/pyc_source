...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Protocol/SimpleReliableMulticast.py
...
def SRM_Sender():
    ...
    """
    return Pipeline(Annotator(), _Framer(), _DataChunker())
...
def SRM_Receiver():
    ...
    This is a Pipeline of components.
    """
    return Pipeline(_DataDeChunker(), _DeFramer(), RecoverOrder())


__kamaelia_components__ = (
 Annotator, RecoverOrder)
...
if __name__ == '__main__':
    ...
    Pipeline(Source(), SRM_Sender(), Duplicate(), Throwaway(), Reorder(), SRM_Receiver(), ConsoleEchoer()).run()