...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Device/DVB/SoftDemux.py
# Compiled at: 2008-10-19 12:19:52
from Kamaelia.Support.Optimised.MpegTsDemux import MpegTsDemux
import Axon.AdaptiveCommsComponent, time
...
if __name__ == '__main__':
    ...
    for demuxer in [NullDemuxer, DVB_Demuxer, DVB_SoftDemuxer]:
        ...
        start = time.time()
        for _ in range(3):
            Graphline(SOURCE=ReadFileAdaptor('/home/matteh/Documents/presentations/Skylife presentation/BBC TWO DVB.ts', readmode='bitrate', bitrate=600000000000, chunkrate=600000000000 / 8 / 2048), DEMUX=demuxer({18: ['_EIT_'], 20: ['_DATETIME_']}), linkages={('SOURCE', 'outbox'): ('DEMUX', 'inbox'), ('SOURCE', 'signal'): ('DEMUX', 'control')}).run()
