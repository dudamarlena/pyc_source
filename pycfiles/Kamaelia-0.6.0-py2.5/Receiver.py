...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Device/DVB/Receiver.py
...
def Receiver(frequency, feparams, card=0):
    return Graphline(TUNER=Tuner(frequency, feparams, card), DEMUX=DemuxerService(), linkages={('self', 'inbox'): ('DEMUX', 'request'), 
...
if __name__ == '__main__':
    ...
    Subscriber('MUX1', 0, 0, 17, 18, 600, 601).activate()
    Subscriber('MUX1', 25, 0, 17, 18, 600, 601).activate()
