...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Util/Comparator.py
...
class Comparator(component):
    ...
    Outboxes = {'outbox': 'Result of comparison', 'signal': 'NOT USED'}
...
comparator = Deprecate.makeClassStub(Comparator, 'Use Kamaelia.Util.Comparator:Comparator instead of Kamaelia.Util.Comparator:comparator', 'WARN')
