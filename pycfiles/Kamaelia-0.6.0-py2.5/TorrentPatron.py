...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Protocol/Torrent/TorrentPatron.py
...
class TorrentPatron(component):
    ...
    Inboxes = {'inbox': 'Commands for the TorrentClient', 
       'torrent-inbox': 'Received feedback from TorrentClient', 
       'control': 'Shut me down'}
    Outboxes = {'outbox': 'Forward feedback from TorrentClient out of', 
...
if __name__ == '__main__':
    ...
    pipeline(ConsoleReader('>>> ', ''), TriggeredFileReader(), TorrentPatron(), BasicTorrentExplainer(), ConsoleEchoer()).run()