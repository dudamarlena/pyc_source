...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Visualisation/ER/PAttribute.py
...
class PAttribute(BaseParticle):
    ...
    colours = {('attribute', 'attribute'): (224, 128, 0)}
    ...
    def buildLabels(self):
        ...
        self.desclabel = font.render(self.attributetype.upper() + ' : ' + self.name, True, (0,
                                                                                            0,
                                                                                            0), (255,
                                                                                                 255,
                                                                                                 255))
