...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Util/Console.py
...
class ConsoleReader(threadedcomponent):
   ...
   """
    ...
    Outboxes = {'outbox': 'Lines that were typed at the console', 'signal': 'NOT USED'}
...
class ConsoleEchoer(component):
   ...
   """
    Inboxes = {'inbox': 'Stuff that will be echoed to standard output', 'control': 'Shutdown signalling'}
    Outboxes = {'outbox': "Stuff forwarded from 'inbox' inbox (if enabled)", 'signal': 'Shutdown signalling'}
