...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Apps/Compose/CodeGen.py
...
if __name__ == '__main__':
       ...
       'nodes': {'1': ('COMPONENT',
                 ...
                 '4': (
                     ...
                     (
                      ...
                      ('DiracDecoder', '4'),
                      'DiracDecoder',
                      {'configuration': {'args': [], 'dictargs': None, 
    ...
    Pipeline(Source([TESTCASE]), CodeGen(), TextOutputGUI('Basic Display')).run()