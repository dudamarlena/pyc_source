...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Util/Chooser.py
...
class Chooser(Axon.Component.component):
   ...
   """
    Inboxes = {'inbox': 'receive commands', 'control': 'shutdown messages'}
    Outboxes = {'outbox': 'emits chosen items', 'signal': 'shutdown messages'}
