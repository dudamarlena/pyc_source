...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Video/CropAndScale.py
...
class CropAndScale(component):
    ...
    def processFrame(self, frame):
        ...
        newimg = img.transform(self.newsize, Image.EXTENT, self.cropbounds, Image.BICUBIC)
