...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Experimental/Services.py
...
class Subscribe(component):
    ...
    """
    Outboxes = {'outbox': '', 'signal': 'shutdown signalling', 
...
if __name__ == '__main__':
    ...
    Pipeline(Subscribe('SERVICE1', 5), ConsoleEchoer()).activate()
    Pipeline(Subscribe('SERVICE1', 1), ConsoleEchoer()).activate()
