...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Visualisation/PhysicsGraph/TopologyViewer.py
...
"""
import random, time, re, sys, pygame, Axon, Kamaelia.Support.Particles, Kamaelia.UI
...
class TopologyViewer(Kamaelia.UI.MH.PyGameApp, Axon.Component.component):
    ...
    """
    Inboxes = {'inbox': 'Topology (change) data describing an Axon system', 'control': 'Shutdown signalling', 
    ...
    Outboxes = {'signal': 'NOT USED', 'outbox': 'Notification and topology output', 
       'displaysignal': 'Requests to Pygame Display service'}

    def __init__(self, screensize=(800, 600), fullscreen=False, caption='Topology Viewer', particleTypes=None, initialTopology=None, laws=None, simCyclesPerRedraw=None, border=100, extraDrawing=None, showGrid=True, transparency=None, position=None):
        ...
        if showGrid:
            self.graphicalFurniture.append(GridRenderer(self.laws.maxInteractRadius, (200,
                                                                                      200,
                                                                                      200)))
