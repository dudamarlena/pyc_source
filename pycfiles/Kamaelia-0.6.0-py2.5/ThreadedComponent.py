...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Axon/ThreadedComponent.py
   ...
   """
    ...
    def activate(self, Scheduler=None, Tracker=None, mainmethod='main'):
       ...
       """
        ...
        self._thethread.setDaemon(True)
...
if __name__ == '__main__':
    ...
    class Container(Component.component):
        ...
        def main(self):
            ...
            a = AAThread().activate()
            start = OneShot(msg=('ADD', (out, 'inbox')), delay=0.5).activate()
            stop = OneShot(msg=('DEL', (out, 'inbox')), delay=5.5).activate()
