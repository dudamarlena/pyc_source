...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Visualisation/ER/PRelation.py
...
class PRelation(BaseParticle):
    ...
    colours = {('relation', 'relation'): (224, 128, 0)}
    ...
    def buildLabels(self):
        ...
        self.desclabel = font.render(self.relationtype.upper() + ' : ' + self.name, True, (0,
                                                                                           0,
                                                                                           0), (255,
                                                                                                255,
                                                                                                255))
