...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Apps/Whiteboard/Routers.py
...
class ConditionalSplitter(Axon.Component.component):
    Outboxes = [
     'true', 'false']
