...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/UI/OpenGL/Container.py
...
if __name__ == '__main__':
    ...
    o2 = SimpleCube(size=(1, 1, 1)).activate()
    o3 = ArrowButton(size=(1, 1, 1)).activate()
    containercontents = {o1: {'position': (0, 1, 0)}, o2: {'position': (1, -1, 0)}, o3: {'position': (-1, -1, 0)}}
    Graphline(OBJ1=o1, OBJ2=o2, OBJ3=o3, CONTAINER=Container(contents=containercontents, position=(0,
                                                                                                   0,
                                                                                                   -10)), MOVER=SimpleMover(amount=(0.01,
                                                                                                                                    0.02,
                                                                                                                                    0.03)), ROTATOR=SimpleRotator(amount=(0,
                                                                                                                                                                          0.1,
                                                                                                                                                                          0)), linkages={('MOVER', 'outbox'): ('CONTAINER', 'position'), 
       ('ROTATOR', 'outbox'): ('CONTAINER', 'rel_rotation')}).run()