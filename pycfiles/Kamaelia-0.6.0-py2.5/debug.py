...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Axon/debug.py
...
"""
import time, random, debugConfigFile, debugConfigDefaults
...
class debug(object):
   ...
   """
    ...
    def debugmessage(self, section, *message):
        r"""      Output a debug messge (never filtered)
