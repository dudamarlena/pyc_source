...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Util/PromptedTurnstile.py
...
class PromptedTurnstile(component):
    ...
    """
    Inboxes = {'inbox': 'Data items', 'next': 'Requests to send out items', 
       'control': 'Shutdown signalling'}
    Outboxes = {'outbox': 'Data items', 'signal': 'Shutdown signalling'}
