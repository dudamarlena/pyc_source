...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Audio/RawAudioMixer.py
...
class RawAudioMixer(threadedcomponent):
    ...
    def __init__(self, sample_rate=8000, channels=1, format='S16_LE', readThreshold=1.0, bufferingLimit=2.0, readInterval=0.1):
        ...
        if format == 'S16_LE':
            ...
            self.quanta = channels * 2
            self.silence = '\x00\x00'
        else:
