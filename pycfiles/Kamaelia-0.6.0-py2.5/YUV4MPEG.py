...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Kamaelia/Codec/YUV4MPEG.py
...
class YUV4MPEGToFrame(component):
    ...
    def main(self):
        ...
        while 1:
            ...
            for _ in self.readbytes(ysize):
                yield _

            if self.checkShutdown() == 'NOW' or self.checkShutdown() and self.bytesread == '':
                break
            y = self.bytesread
            for _ in self.readbytes(csize):
                yield _
            ...
            for _ in self.safesend(frame, 'outbox'):
                yield _
...
class FrameToYUV4MPEG(component):
    ...
    def write_frame(self, frame):
        ...
        """
        for _ in self.sendoutbox('FRAME\n'):
            yield _
...
__kamaelia_components__ = (
 YUV4MPEGToFrame, FrameToYUV4MPEG)
if __name__ == '__main__':
    from Kamaelia.Chassis.Pipeline import Pipeline
    from Kamaelia.File.Reading import RateControlledFileReader
    from Kamaelia.UI.Pygame.VideoOverlay import VideoOverlay
    Pipeline(RateControlledFileReader('/data/stream.yuv', readmode='bytes', rate=25 * 608384), YUV4MPEGToFrame(), FrameToYUV4MPEG(), YUV4MPEGToFrame(), VideoOverlay()).run()