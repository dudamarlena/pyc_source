...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/libel/selectionlist.py
# Compiled at: 2010-08-28 19:57:04
...
class SelectionList:
    ...
    def __init__(self, Set):
        try:
            ...
            raise TypeError('%s parameter "Set" must be an iterable!' % self.__class__.__name__)
