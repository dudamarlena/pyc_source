...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/libel/sentientobject.py
# Compiled at: 2010-08-24 22:37:31
...
class SentientObject:
    ...
    def get_lib_path(self, Force=False):
        ...
        if not self.__lib_path__ or Force:
            self.__lib_path__ = os.path.abspath(os.path.dirname(self.__lib_import__.__file__))
