...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/retort/command.py
# Compiled at: 2017-10-06 19:57:13
...
def apply(args):
    ...
    args.yes or cmd_helper.print_codes(migrations, args.sql)
