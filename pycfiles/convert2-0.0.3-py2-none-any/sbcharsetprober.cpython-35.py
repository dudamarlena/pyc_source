...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/convert2-project/convert2/pkg/chardet/sbcharsetprober.py
...
class SingleByteCharSetProber(CharSetProber):
    ...
    def feed(self, aBuf):
        ...
        if self.get_state() == constants.eDetecting and self._mTotalSeqs > SB_ENOUGH_REL_THRESHOLD:
