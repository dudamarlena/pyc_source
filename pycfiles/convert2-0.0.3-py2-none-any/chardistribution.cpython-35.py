...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/convert2-project/convert2/pkg/chardet/chardistribution.py
...
class CharDistributionAnalysis:
    ...
    def feed(self, aBuf, aCharLen):
        ...
        if order >= 0:
            self._mTotalChars += 1
            if order < self._mTableSize and 512 > self._mCharToFreqOrder[order]:
                self._mFreqChars += 1
