...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/epscApp/processPanel.py
...
class ProcessPanel(wx.Panel, SCMPanel):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.strain = 0
        self.stress = 0
        self.label_numStep = wx.StaticText(self, -1, 'Number Of Steps', size=(150,
                                                                              20))
        self.text_numStep = wx.TextCtrl(self, -1, '100', size=(100, 20))
        self.radio_temperature = wx.RadioButton(self, -1, '')
        self.label_temperature = wx.StaticText(self, -1, 'Temperature', size=(150,
                                                                              20))
        self.label_startTemp = wx.StaticText(self, -1, 'Initial Temp (K)', size=(120,
                                                                                 20))
        self.text_startTemp = wx.TextCtrl(self, -1, '', size=(100, 20))
        self.label_finalTemp = wx.StaticText(self, -1, 'Final Temp (K)', size=(100,
                                                                               20))
        ...
        self.label_strainDelta = wx.StaticText(self, -1, 'Maximum Strain', size=(120,
                                                                                 20))
        ...
        self.label_stressFinal = wx.StaticText(self, -1, 'Maximum Stress (GPa)', size=(120,
                                                                                       20))
