...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/epscApp/reportPanel.py
# Compiled at: 2009-05-29 13:49:10
import wx, wx.lib, wx.lib.hyperlink
...
class ReportPanel(wx.Dialog):
    ...
    def onSend(self, event):
        ...
        if not reporter:
            reporter = 'anonymous'
        ticketinfo = {'summary': self.text_ctrl_summary.GetValue().strip(), 'description': description, 
           'reporter': reporter, 
           'traceback': traceback}
        data_get = {}
