...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/epscApp/aboutbox.py
# Compiled at: 2009-05-29 13:49:21
import wx, wx.lib.hyperlink, random, os.path, os, epscComp.config
_acknowledgement = 'This software was developed by the Iowa State University as part of the\nDistributed Data Analysis of Neutron Scattering Experiments (DANSE)\nproject funded by the US National Science Foundation.\n\n'
...
class AboutBox(wx.Dialog):
    ...
    def __init__(self, *args, **kwds):
        ...
        if wx.VERSION >= (2, 7, 2, 0):
            size = [
             self.GetEffectiveMinSize()[0], self.GetSize()[1]]
        else:
            size = [
             self.GetBestFittingSize()[0], self.GetSize()[1]]
        self.Fit()
