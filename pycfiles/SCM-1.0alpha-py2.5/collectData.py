...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/epscApp/epscComp/collectData.py
# Compiled at: 2009-05-29 13:49:17
from scipy import *
import interpolateFunction, utility, config, string, os, sys, wx
        ...
        for i in range(self.epscData.numDiffractionData['Phase1']):
            ...
            if i < self.epscData.numDiffractionData['TransPhase1']:
                ...
                if len(self.epscData.expData.HKLExpX['LongPhase1']) > j:
                    ...
                    j += 1
            elif len(self.epscData.expData.HKLExpX['RollingPhase1']) > k:
