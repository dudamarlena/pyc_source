...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/epscApp/phase1Panel.py
# Compiled at: 2009-05-29 13:49:21
import wx, wx.grid, os, string, epscComp.config
...
class Phase1Panel(wx.Panel, SCMPanel):
    ...
    def OnOK(self, event):
        ...
        if self.crystalRadio.GetSelection() == 0:
            self.controller.epscData.matParam[self.kind].numModes = 4
        elif self.crystalRadio.GetSelection() == 1:
