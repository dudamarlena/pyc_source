...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/tools/renamer/widgets/numbersidewidget.py
# Compiled at: 2020-04-11 22:50:40
# Size of source mod 2**32: 9579 bytes
"""
...
class NumberSideWidget(base.BaseWidget, object):
    ...
    def get_rename_settings(self):
        ...
        return (
         padding, naming_method, upper, side)
