...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/tools/renamer/widgets/categorywidget.py
        ...
        for obj in nodes:
            if obj in nodes_to_discard:
                ...
                if node_type not in self._get_node_types():
                    if not self._others_btn.isChecked():
                        is_valid = False
