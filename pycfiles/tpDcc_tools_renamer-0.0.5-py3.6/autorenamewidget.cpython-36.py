...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/tools/renamer/widgets/autorenamewidget.py
    ...
    def _on_change_name_rule(self):
        ...
        for token in reversed(active_tokens):
            ...
            if token_value:
                ...
                self.add_token(token_name, qtutils.get_line_layout('', self, w, QLabel('►'), w_l))
