...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/Products/BigramSplitter/monkey.py
# Compiled at: 2010-12-06 09:11:10
"""
monkey.py
...
from Products.ZCTextIndex.QueryParser import _tokenizer_regex, _keywords, _ATOM, _EOF
...
_tokenizer_unicode_regex = re.compile(_tokenizer_regex.pattern, _tokenizer_regex.flags | re.UNICODE)
...
def parseQuery(self, query):
    ...
    self._require(_EOF)
    if tree is None:
        raise ParseTree.ParseError('Query contains only common words: %s' % repr(query))
    return tree
