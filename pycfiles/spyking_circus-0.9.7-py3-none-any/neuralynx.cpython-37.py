...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/github/spyking-circus/build/lib/circus/files/neuralynx.py
# Compiled at: 2020-03-11 06:54:20
# Size of source mod 2**32: 11886 bytes
import numpy, re, sys, os, datetime, warnings, logging
...
class NeuraLynxFile(DataFile):
    ...
    NUM_HEADER_BYTES = 16384
    SAMPLES_PER_RECORD = 512
    RECORD_SIZE = 20 + SAMPLES_PER_RECORD * 2
    OFFSET_PER_BLOCK = (10.0, 0)
    ...
    def _read_header_(self, file):
        header = {}
        f = open(file, 'rb')
        raw_hdr = f.read(self.NUM_HEADER_BYTES).strip(b'\x00')
        f.close()
