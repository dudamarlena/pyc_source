...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/github/spyking-circus/build/lib/circus/files/hdf5.py
...
class H5File(DataFile):
    ...
    def read_chunk(self, idx, chunk_size, padding=(0, 0), nodes=None):
        ...
        if not do_slice:
            if self.time_axis == 0:
                ...
                if self.time_axis == 1:
                    local_chunk = self.grid_ids or self.data[:, t_start:t_stop].T
                else:
    ...
    def write_chunk(self, time, data):
        ...
        if self.time_axis == 0:
            ...
            if self.time_axis == 1:
                self.data[:, time:time + data.shape[0]] = self.grid_ids or data.T
            else:
