...
# Compiled at: 2019-12-18 06:14:23
# Size of source mod 2**32: 42712 bytes
import warnings, logging
warnings.filterwarnings('ignore')
import os, sys, time, types, tqdm, numpy as np, scipy.sparse as sp
from math import log, sqrt
from scipy import linalg
import scipy.interpolate
from scipy.stats import gamma
import numpy, os, tempfile, scipy.linalg, scipy.optimize, pickle, socket, tempfile, shutil, scipy.ndimage.filters, scipy.signal
...
def check_is_fitted(estimator, attributes, msg=None, all_or_any=all):
    ...
    if msg is None:
        ...
        if not isinstance(attributes, (list, tuple)):
            attributes = [
             attributes]
        raise all_or_any([hasattr(estimator, attr) for attr in attributes]) or NotFittedError(msg % {'name': type(estimator).__name__})
