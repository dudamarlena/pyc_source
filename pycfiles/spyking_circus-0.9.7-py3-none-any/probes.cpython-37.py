...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/github/spyking-circus/build/lib/circus/shared/probes.py
# Compiled at: 2020-03-11 06:54:22
# Size of source mod 2**32: 5892 bytes
import ast, logging, numpy, os, sys
...
def read_probe(parser, radius_in_probe=True):
    ...
    key_flags = [
     'total_nb_channels', 'channel_groups']
    if radius_in_probe:
        key_flags += ['radius']
...
def get_nodes_and_edges(parser, validating=False, shank_with=None):
    ...
    return (
     numpy.array(nodes, dtype=(numpy.int32)), edges)
