...
# Embedded file name: build/bdist.linux-x86_64/egg/plottwist/managers/ocio.py
...
class ArtellaPlotTwistOCIOManager(ocio.ArtellaOCIOManager, object):
    ...
    def set_arnold_antialiasing(self, aa_samples=3, diffuse_samples=2, specular_samples=2, transmission_samples=2, sss_samples=2, volume_indirect_samples=2):
        """
