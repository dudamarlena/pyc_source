...
# [GCC 8.4.0]
# Embedded file name: /evtfs/home/rcarney/Dropbox/projects/dploy/master/dploy/cli.py
# Compiled at: 2017-06-12 22:37:26
# Size of source mod 2**32: 3163 bytes
"""
The command line interface
"""
import sys, argparse, dploy.linkcmd as linkcmd, dploy.stowcmd as stowcmd, dploy.version as version

def add_ignore_argument(parser):
    """
    adds the ignore argument to a subcmd parser
    """
    parser.add_argument('--ignore', dest='ignore_patterns', action='append', default=None, help='glob pattern used to ignore directories')
...
def create_parser():
    ...
    parser.add_argument('--dry-run', dest='is_dry_run', action='store_true', help='show what would be done without doing it')
...
def run(arguments=None):
    ...
    try:
        ...
        try:
            ...
            subcmd(args.source, args.dest, is_silent=args.is_silent, is_dry_run=args.is_dry_run, ignore_patterns=args.ignore_patterns)
