...
# [GCC 8.4.0]
# Embedded file name: /Users/arecarn/Dropbox/projects/dploy/master/dploy/stowcmd.py
# Compiled at: 2017-10-27 00:19:55
# Size of source mod 2**32: 12710 bytes
"""
    ...
    def _collect_folding_actions(self):
        ...
        for parent in self.actions.get_unlink_target_parents():
            ...
            if not is_normal_files_detected:
                ...
                assert other_links_parent_count == 1 and source_parent is not None
                if utils.is_same_files(utils.get_directory_contents(source_parent), other_links):
                    self._fold(source_parent, parent)
            else:
                if other_links_parent_count == 0:
                    if not utils.is_same_file(parent, self.dest_input):
