...
# [GCC 8.4.0]
# Embedded file name: /evtfs/home/rcarney/Dropbox/projects/dploy/master/tests/test_unstow.py
...
def test_unstow_dwith_basic_senario_doesnt_delete_dest_directory(source_a, dest):
    ...
    if not @py_assert6:
        @py_format8 = ('' + 'assert %(py7)s\n{%(py7)s = %(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.path\n}.exists\n}(%(py5)s)\n}') % {'py4': @pytest_ar._saferepr(@py_assert3), 'py0': @pytest_ar._saferepr(os) if 'os' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(os) else 'os', 'py2': @pytest_ar._saferepr(@py_assert1), 'py5': @pytest_ar._saferepr(dest) if 'dest' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(dest) else 'dest', 'py7': @pytest_ar._saferepr(@py_assert6)}
...
def test_unstow_with_same_directory_used_as_source_and_dest(source_a):
    ...
    if not @py_assert6:
        @py_format8 = ('' + 'assert %(py7)s\n{%(py7)s = %(py2)s\n{%(py2)s = %(py0)s.is_subcmd_error_message\n}(%(py4)s, %(py5)s)\n}') % {'py4': @pytest_ar._saferepr(@py_assert3), 'py0': @pytest_ar._saferepr(utils) if 'utils' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(utils) else 'utils', 'py2': @pytest_ar._saferepr(@py_assert1), 'py5': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py7': @pytest_ar._saferepr(@py_assert6)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format8))
    @py_assert1 = @py_assert3 = @py_assert6 = None
...
def test_unstow_folding_with_stray_symlink_in_unfolded_dest_dir(source_a, source_b, source_d, dest):
    ...
    if not @py_assert6:
        @py_format8 = ('' + 'assert %(py7)s\n{%(py7)s = %(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.path\n}.islink\n}(%(py5)s)\n}') % {'py4': @pytest_ar._saferepr(@py_assert3), 'py0': @pytest_ar._saferepr(os) if 'os' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(os) else 'os', 'py2': @pytest_ar._saferepr(@py_assert1), 'py5': @pytest_ar._saferepr(stray_path) if 'stray_path' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(stray_path) else 'stray_path', 'py7': @pytest_ar._saferepr(@py_assert6)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format8))
    @py_assert1 = @py_assert3 = @py_assert6 = None
...
def test_unstow_folding_with_existing_file_in_dest(source_a, source_b, dest):
    ...
    if not @py_assert6:
        @py_format8 = ('' + 'assert %(py7)s\n{%(py7)s = %(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.path\n}.exists\n}(%(py5)s)\n}') % {'py4': @pytest_ar._saferepr(@py_assert3), 'py0': @pytest_ar._saferepr(os) if 'os' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(os) else 'os', 'py2': @pytest_ar._saferepr(@py_assert1), 'py5': @pytest_ar._saferepr(a_file) if 'a_file' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(a_file) else 'a_file', 'py7': @pytest_ar._saferepr(@py_assert6)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format8))
    @py_assert1 = @py_assert3 = @py_assert6 = None
