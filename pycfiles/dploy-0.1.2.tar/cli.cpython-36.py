...
# [GCC 8.4.0]
# Embedded file name: /Users/arecarn/Dropbox/projects/dploy/master/dploy/cli.py
# Compiled at: 2017-10-27 00:13:34
...
def create_parser():
    ...
    stow_parser.add_argument('source',
      nargs='+', help='source directory to stow')
    ...
    unstow_parser.add_argument('source',
      nargs='+', help='source directory to unstow from')
