...
# [GCC 8.4.0]
# Embedded file name: /evtfs/home/rcarney/Dropbox/projects/dploy/master/tests/test_stow.py
# Compiled at: 2017-03-25 02:33:36
# Size of source mod 2**32: 8510 bytes
"""
...
def test_stow_with_existing_broken_link(source_a, dest):
    ...
    @py_assert10 = @py_assert8 in @py_assert15
    if not @py_assert10:
        @py_format17 = @pytest_ar._call_reprcompare(('in',), (@py_assert10,), ('%(py9)s\n{%(py9)s = %(py7)s\n{%(py7)s = %(py2)s\n{%(py2)s = %(py0)s.ConflictsWithExistingLink\n}(subcmd=%(py3)s, source=%(py4)s, dest=%(py5)s)\n}.msg\n} in %(py16)s\n{%(py16)s = %(py11)s(%(py14)s\n{%(py14)s = %(py12)s.value\n})\n}',), (@py_assert8, @py_assert15)) % {'py4': @pytest_ar._saferepr(source_file) if 'source_file' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(source_file) else 'source_file', 'py5': @pytest_ar._saferepr(conflicting_link) if 'conflicting_link' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(conflicting_link) else 'conflicting_link', 'py2': @pytest_ar._saferepr(@py_assert1), 'py16': @pytest_ar._saferepr(@py_assert15), 'py7': @pytest_ar._saferepr(@py_assert6), 'py12': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD', 'py9': @pytest_ar._saferepr(@py_assert8), 'py11': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py14': @pytest_ar._saferepr(@py_assert13)}
        @py_format19 = ('' + 'assert %(py18)s') % {'py18': @py_format17}
        raise AssertionError(@pytest_ar._format_explanation(@py_format19))
    @py_assert1 = @py_assert6 = @py_assert8 = @py_assert10 = @py_assert13 = @py_assert15 = None
...
def test_stow_with_duplicate_source(source_a, dest):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.DuplicateSource\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(source_a) if 'source_a' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(source_a) else 'source_a', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None
...
def test_stow_with_file_as_dest_and_source(file_a, file_b):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.NoSuchDirectoryToSubcmdInto\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(file_b) if 'file_b' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(file_b) else 'file_b', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None
...
def test_stow_with_same_simple_directory_used_as_source_and_dest(source_only_files):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.SourceIsSameAsDest\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(source_only_files) if 'source_only_files' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(source_only_files) else 'source_only_files', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None
...
def test_stow_with_read_only_dest(source_a, dest):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.InsufficientPermissionsToSubcmdTo\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(dest) if 'dest' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(dest) else 'dest', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None
...
def test_stow_with_source_dir_with_no_executue_permissions(source_a, source_c, dest):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.InsufficientPermissionsToSubcmdFrom\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(source_dir) if 'source_dir' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(source_dir) else 'source_dir', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None
...
def verify_unfolded_source_a_and_source_b(dest):
    ...
    if not @py_assert13:
        @py_format15 = ('' + 'assert %(py14)s\n{%(py14)s = %(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.path\n}.isdir\n}(%(py12)s\n{%(py12)s = %(py9)s\n{%(py9)s = %(py7)s\n{%(py7)s = %(py5)s.path\n}.join\n}(%(py10)s)\n})\n}') % {'py4': @pytest_ar._saferepr(@py_assert3), 'py5': @pytest_ar._saferepr(os) if 'os' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(os) else 'os', 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(common_dest_dir) if 'common_dest_dir' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(common_dest_dir) else 'common_dest_dir', 'py7': @pytest_ar._saferepr(@py_assert6), 'py12': @pytest_ar._saferepr(@py_assert11), 'py0': @pytest_ar._saferepr(os) if 'os' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(os) else 'os', 'py9': @pytest_ar._saferepr(@py_assert8), 'py14': @pytest_ar._saferepr(@py_assert13)}
    ...
    for file_map in file_maps:
        ...
        if not @py_assert7:
            @py_format10 = @pytest_ar._call_reprcompare(('==',), (@py_assert7,), ('%(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.readlink\n}(%(py4)s)\n} == %(py9)s',), (@py_assert5, @py_assert8)) % {'py4': @pytest_ar._saferepr(@py_assert3), 'py0': @pytest_ar._saferepr(os) if 'os' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(os) else 'os', 'py6': @pytest_ar._saferepr(@py_assert5), 'py2': @pytest_ar._saferepr(@py_assert1), 'py9': @pytest_ar._saferepr(@py_assert8)}
...
def test_stow_unfolding_with_first_sources_execute_permission_removed(source_a, source_b, dest):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.PermissionDenied\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(dest_dir) if 'dest_dir' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(dest_dir) else 'dest_dir', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None
...
def test_stow_unfolding_with_write_only_source_file(source_a, source_b, dest):
    ...
    @py_assert9 = @py_assert7 in @py_assert14
    if not @py_assert9:
        @py_format16 = @pytest_ar._call_reprcompare(('in',), (@py_assert9,), ('%(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.InsufficientPermissionsToSubcmdFrom\n}(subcmd=%(py3)s, file=%(py4)s)\n}.msg\n} in %(py15)s\n{%(py15)s = %(py10)s(%(py13)s\n{%(py13)s = %(py11)s.value\n})\n}',), (@py_assert7, @py_assert14)) % {'py4': @pytest_ar._saferepr(source_file) if 'source_file' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(source_file) else 'source_file', 'py11': @pytest_ar._saferepr(e) if 'e' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(e) else 'e', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py10': @pytest_ar._saferepr(str) if 'str' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(str) else 'str', 'py15': @pytest_ar._saferepr(@py_assert14), 'py0': @pytest_ar._saferepr(error) if 'error' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(error) else 'error', 'py8': @pytest_ar._saferepr(@py_assert7), 'py6': @pytest_ar._saferepr(@py_assert5), 'py3': @pytest_ar._saferepr(SUBCMD) if 'SUBCMD' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(SUBCMD) else 'SUBCMD'}
        @py_format18 = ('' + 'assert %(py17)s') % {'py17': @py_format16}
        raise AssertionError(@pytest_ar._format_explanation(@py_format18))
    @py_assert1 = @py_assert5 = @py_assert7 = @py_assert9 = @py_assert12 = @py_assert14 = None