...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/elabtui/elabtui.py
# Compiled at: 2017-11-09 10:46:46
...
import os.path, sys, elabapy, yaml
...
class ListView(Frame):
    ...
    def __init__(self, screen, model):
        super(ListView, self).__init__(screen, (screen.height),
          (screen.width),
...
class ExperimentView(Frame):
    ...
    def __init__(self, screen, model):
        super(ExperimentView, self).__init__(screen, (screen.height * 2 // 3),
          (screen.width * 2 // 3),
          hover_focus=True,
