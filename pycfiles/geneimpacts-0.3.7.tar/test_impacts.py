...
# [GCC 8.4.0]
# Embedded file name: /home/brentp/src/geneimpacts/geneimpacts/tests/test_impacts.py
# Compiled at: 2018-04-30 15:49:00
import sys, os, gzip
...
def test_eff_splice():
    ...
    e = OldSnpEff('intergenic_region(MODIFIER|||n.null_nulldelAAGGAAGG|||||||A', keys)
...
def test_vcf2db_42():
    ...
    v = VEP('-|frameshift_variant&start_lost&start_retained_variant|HIGH|HRNR|388697|Transcript|NM_001009931.2|protein_coding|2/3||NM_001009931.2:c.1del|NP_001009931.1:p.Met1?|80/9632|1/8553|1/2850|M/X|Atg/tg|rs34061715&COSM111478|1||-1||deletion|EntrezGene|HGNC:20846|YES||||NP_001009931.1||||rseq_mrna_match|RefSeq|T|T||||||||0.7337|0.8818|0.9544|0.9592|0.8875|||0.9028|0.7227|0.8276|0.9554|0.9063|0.9541|0.9411|0.9142|0.9069|0.9592|EUR||0&1|0&1||||||HC|||||||', keys=keys)
    assert v.impact_severity == 'HIGH', (v.impact_severity,)