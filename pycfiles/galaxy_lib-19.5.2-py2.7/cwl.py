...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/parser/cwl.py
...
class CwlToolSource(ToolSource):
    ...
    def parse_requirements_and_containers(self):
        ...
        return requirements.parse_requirements_from_dict(dict(requirements=list(map(lambda r: {'name': r[0], 'version': r[1], 'type': 'package'}, software_requirements)), containers=containers))
