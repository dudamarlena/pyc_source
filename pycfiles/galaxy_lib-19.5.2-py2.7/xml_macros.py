...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/util/xml_macros.py
...
def _expand_yield_statements(macro_def, expand_el):
    ...
    macro_def_parent_map = dict((c, p) for macro_def_el in macro_def for p in macro_def_el.iter() for c in p)
...
__all__ = ('imported_macro_paths', 'load', 'load_with_references', 'raw_xml_tree',
