...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/deps/mulled/mulled_build_channel.py
...
from .mulled_build import add_build_arguments, args_to_mull_targets_kwds, build_target, conda_versions, get_affected_packages, mull_targets
...
def add_channel_arguments(parser):
    ...
    parser.add_argument('--repo-data', dest='repo_data', required=True, help='Published repository data. If you want to build all containers for bioconda, this parameter needs to be set to "bioconda"')
    ...
    parser.add_argument('--force-rebuild', dest='force_rebuild', action='store_true', help='Rebuild package even if already published.')
