...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/deps/resolvers/modules.py
...
class DirectoryModuleChecker(object):
    ...
    def has_module(self, module, version):
        ...
        for directory in self.directories:
            ...
            if not version:
                has_module = has_module_directory or exists(module_directory)
            else:
...
class AvailModuleChecker(object):
    ...
    def __module_avail_output(self):
        avail_command = [
         self.module_dependency_resolver.modulecmd, 'sh', 'avail']
