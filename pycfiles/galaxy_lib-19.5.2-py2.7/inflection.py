...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/util/inflection.py
...
class Base(object):
    ...
    def underscore(self, word):
        ...
        return re.sub('[^A-Z^a-z^0-9^\\/]+', '_', re.sub('([a-z\\d])([A-Z])', '\\1_\\2', re.sub('([A-Z]+)([A-Z][a-z])', '\\1_\\2', re.sub('::', '/', word)))).lower()
