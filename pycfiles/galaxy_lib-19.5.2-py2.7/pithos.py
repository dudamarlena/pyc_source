...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/objectstore/pithos.py
...
NO_KAMAKI_ERROR_MESSAGE = 'ObjectStore configured, but no kamaki.clients dependency available.Please install and properly configure kamaki.clients or modify Object Store configuration.'
...
def parse_config_xml(config_xml):
    ...
    r = dict()
    try:
        for tag, required_attrs, optional_attrs in (('auth', ('url', 'token'), ('ca_certs', 'ignore_ssl')),
         (
