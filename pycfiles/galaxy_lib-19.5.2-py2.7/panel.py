...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/toolbox/panel.py
...
panel_item_types = bunch.Bunch(TOOL='TOOL', WORKFLOW='WORKFLOW', SECTION='SECTION', LABEL='LABEL')
...
class HasPanelItems(object):
    ...
    def panel_items_iter(self):
        ...
        for panel_key, panel_value in iteritems(self.panel_items()):
            ...
            yield (
             panel_key, panel_type, panel_value)
