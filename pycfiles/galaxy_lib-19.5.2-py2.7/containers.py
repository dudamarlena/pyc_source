...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/deps/containers.py
# Compiled at: 2019-04-28 04:54:30
import logging, os
from galaxy.util import asbool, plugin_config
from .container_classes import CONTAINER_CLASSES, DOCKER_CONTAINER_TYPE, NULL_CONTAINER, SINGULARITY_CONTAINER_TYPE
from .container_resolvers.explicit import ExplicitContainerResolver, ExplicitSingularityContainerResolver
from .container_resolvers.mulled import BuildMulledDockerContainerResolver, BuildMulledSingularityContainerResolver, CachedMulledDockerContainerResolver, CachedMulledSingularityContainerResolver, MulledDockerContainerResolver, MulledSingularityContainerResolver
...
class ContainerFinder(object):
    ...
    def find_container(self, tool_info, destination_info, job_info):
        ...
        if not enabled_container_types:
            ...
            def __destination_container(container_description=None, container_id=None, container_type=None):
                ...
                container = self.__destination_container(container_id, container_type, tool_info, destination_info, job_info, container_description)
                return container
    ...
    def __default_container_id(self, container_type, destination_info):
        if not self.__container_type_enabled(container_type, destination_info):
            ...
            if '%s_image_default' in destination_info:
...
class ContainerRegistry(object):
    ...
    def find_best_container_description(self, enabled_container_types, tool_info):
        ...
        for container_resolver in self.container_resolvers:
            ...
            if container_description:
                if not container_description.type in enabled_container_types:
