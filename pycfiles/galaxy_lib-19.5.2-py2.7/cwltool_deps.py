...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/cwl/cwltool_deps.py
...
needs_shell_quoting = re.compile('(^$|[\\s|&;()<>\\\'"$@])').search
...
__all__ = ('main', 'ref_resolver', 'load_tool', 'LoadingContext', 'workflow', 'process',
           'pathmapper', 'ensure_cwltool_available', 'schema_salad', 'shellescape',
           'needs_shell_quoting')