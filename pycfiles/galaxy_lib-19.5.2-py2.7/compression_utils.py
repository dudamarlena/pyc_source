...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/util/compression_utils.py
# Compiled at: 2019-04-28 04:54:30
from __future__ import absolute_import
import gzip, io, logging, os, tarfile, zipfile
...
def get_fileobj_raw(filename, mode='r', compressed_formats=None):
    ...
    if 'gzip' in compressed_formats and is_gzip(filename):
        ...
        if 'b' in mode:
            ...
            return (
             compressed_format, io.open(filename, mode, encoding='utf-8'))

    if 'b' not in mode:
        return (compressed_format, io.TextIOWrapper(fh, encoding='utf-8'))
    else:
        return (
         compressed_format, fh)
        return
