...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/tools/toolbox/lineages/interface.py
# Compiled at: 2018-04-20 03:19:42
import threading, packaging.version
...
class ToolLineage(object):
    ...
    def to_dict(self):
        return dict(tool_id=self.tool_id, tool_versions=list(self.tool_versions), lineage_type='stock')