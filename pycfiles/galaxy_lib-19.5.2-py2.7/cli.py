...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galaxy/jobs/metrics/collectl/cli.py
...
COMMAND_LINE_TEMPLATE = Template('$collectl_path $destination_arg $mode_arg $subsystems_arg $interval_arg $procfilt_arg $flush_arg $sep_arg')
MODE_RECORD = 'record'
