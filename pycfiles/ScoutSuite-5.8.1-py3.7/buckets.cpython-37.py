...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ScoutSuite/providers/oci/resources/objectstorage/buckets.py
...
class Buckets(OracleResources):
    ...
    async def _parse_bucket(self, raw_bucket):
        ...
        raw_bucket_details = await self.facade.objectstorage.get_bucket_details(raw_bucket.namespace, raw_bucket.name)
        ...
        bucket_dict['object_lifecycle_policy_etag'] = raw_bucket_details.object_lifecycle_policy_etag if raw_bucket_details else None
        return (
         bucket_dict['id'], bucket_dict)