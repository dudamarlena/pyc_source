...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ScoutSuite/providers/aws/resources/cloudwatch/alarms.py
...
class Alarms(AWSResources):
    ...
    def _parse_alarm(self, raw_alarm):
        ...
        for key in ('AlarmConfigurationUpdatedTimestamp', 'StateReason', 'StateReasonData',
