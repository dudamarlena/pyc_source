...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ScoutSuite/providers/azure/resources/aad/serviceprincipals.py
...
class ServicePrincipals(AzureResources):
    ...
    async def _parse_service_principal(self, raw_service_principal):
        ...
        service_principal_dict['preferred_token_signing_key_thumbprint'] = raw_service_principal.preferred_token_signing_key_thumbprint
        ...
        service_principal_dict['roles'] = []
        return (
         service_principal_dict['id'], service_principal_dict)