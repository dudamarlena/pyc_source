...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ScoutSuite/providers/azure/resources/network/virtual_networks.py
...
class VirtualNetworks(AzureResources):
    ...
    def _parse_virtual_network(self, raw_virtual_network):
        ...
        for raw_subnet in raw_virtual_network.subnets:
            ...
            subnet_dict['interface_endpoints'] = raw_subnet.interface_endpoints if hasattr(raw_subnet, 'interface_endpoints') else None
