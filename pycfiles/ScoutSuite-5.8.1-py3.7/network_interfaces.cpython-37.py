...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ScoutSuite/providers/azure/resources/network/network_interfaces.py
# Compiled at: 2020-04-02 05:37:10
# Size of source mod 2**32: 5360 bytes
...
class NetworkInterfaces(AzureResources):
    ...
    def _parse_network_interface(self, raw_network_interface):
        ...
        network_interface_dict['virtual_machine'] = get_non_provider_id(raw_network_interface.virtual_machine.id.lower()) if raw_network_interface.virtual_machine else None
        network_interface_dict['name'] = raw_network_interface.name
        network_interface_dict['tags'] = raw_network_interface.tags
        network_interface_dict['interface_endpoint'] = raw_network_interface.interface_endpoint if hasattr(raw_network_interface, 'interface_endpoint') else None
        ...
        network_interface_dict['network_security_group'] = get_non_provider_id(raw_network_interface.network_security_group.id) if raw_network_interface.network_security_group else None
        ...
        ip_configuration = raw_network_interface.ip_configurations[0]
        ...
        network_interface_dict['ip_configuration']['application_gateway_backend_address_pools'] = ip_configuration.application_gateway_backend_address_pools
        network_interface_dict['ip_configuration']['load_balancer_backend_address_pools'] = ip_configuration.load_balancer_backend_address_pools
        network_interface_dict['ip_configuration']['load_balancer_inbound_nat_rules'] = ip_configuration.load_balancer_inbound_nat_rules
        network_interface_dict['ip_configuration']['private_ip_address'] = ip_configuration.private_ip_address
        network_interface_dict['ip_configuration']['private_ip_allocation_method'] = ip_configuration.private_ip_allocation_method
        network_interface_dict['ip_configuration']['private_ip_address_version'] = ip_configuration.private_ip_address_version
        ...
        return (
         network_interface_dict['id'], network_interface_dict)