...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ScoutSuite/providers/oci/resources/kms/keyvaults.py
...
class KeyVaults(OracleCompositeResources):
    ...
    async def fetch_all(self):
        ...
        await self._fetch_children_of_all_resources(resources=self,
          scopes={keyvault_id:{'keyvault': keyvault} for keyvault_id, keyvault in self.items()})
