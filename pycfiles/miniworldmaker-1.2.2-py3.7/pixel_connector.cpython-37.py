...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\miniworldmaker\tokens\pixel_connector.py
# Compiled at: 2019-09-20 04:27:55
...
class PixelBoardConnector(board_connector.BoardConnector):
    ...
    def get_line_to(self, start, target):
        ...
        return [board_position.BoardPosition(start[0] + i * x_spacing, start[1] + i * y_spacing) for i in range(1, sampling_rate + 1)]
