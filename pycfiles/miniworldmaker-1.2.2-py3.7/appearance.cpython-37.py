...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\miniworldmaker\tools\appearance.py
# Compiled at: 2019-09-20 05:29:18
# Size of source mod 2**32: 19499 bytes
...
class Appearance(metaclass=MetaAppearance):
    ...
    def __init__(self):
        ...
        self._image_index = 0
        self.image_paths = []
        self.raw_image = pygame.Surface((1, 1))
    ...
    def reload_image(self):
        if self.dirty == 1:
            ...
            for img_action in self.image_actions_pipeline:
                if self.reload_actions[img_action[0]] is False and img_action[0] in self.cached_images.keys() and self.cached_images[img_action[0]]:
    ...
    def count_pixels_by_color(self, rect, color, threshold=(0, 0, 0, 0)):
        ...
        return pygame.transform.threshold(dest_surf=None, set_behavior=0,
          surf=surf,
          search_color=color,
          threshold=threshold)
    ...
    def image_action_coloring(self, image: pygame.Surface, parent) -> pygame.Surface:
        ...
        image.fill(new_color, None, pygame.BLEND_RGBA_ADD)
