...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\miniworldmaker\tokens\tiled_connector.py
# Compiled at: 2019-09-20 04:28:18
...
class TiledBoardConnector(board_connector.BoardConnector):
    ...
    def __init__(self, token, board):
        ...
        if token.size == (0, 0):
            token.size = (
             self.board.tile_size, self.board.tile_size)
