...
# [GCC 8.4.0]
# Embedded file name: /home/cufrancis/Develop/pelicantool/.env/lib/python3.6/site-packages/pelicantool/utils.py
# Compiled at: 2018-01-12 23:16:21
# Size of source mod 2**32: 3402 bytes
import six, urllib, random, hashlib, requests, os, toml
if six.PY3:
    str_compat = str
else:
    str_compat = unicode
...
def translation(query, appid='20161217000034172', appkey='07Qh2zEwKIx3kGwer1Uz', from_='zh', to='en'):
    ...
    url = url + urllib.parse.urlencode({'q':query, 
     'from':from_,  'to':to,  'appid':appid,  'salt':salt, 
     'sign':sign})
    r = requests.get(url)
    r.encoding = 'utf-8'
    result = r.json()
