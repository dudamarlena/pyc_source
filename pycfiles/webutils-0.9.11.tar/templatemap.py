...
# [GCC 8.4.0]
# Embedded file name: /Users/pjs/python-modules/webutils/djtools/templatemap.py
...
def render_to_mapped_string(template_name, dictionary=None, context_dict=None, vmap=None):
...
def render_to_mapped_response(*args, **kwargs):
    ...
    return HttpResponse(render_to_mapped_string(*args, **kwargs), **httpresponse_kwargs)