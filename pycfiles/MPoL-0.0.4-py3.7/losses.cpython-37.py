...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mpol/losses.py
...
def loss_fn(model_vis, data_vis):
    ...
    return torch.sum(data_weights * (data_re - model_re) ** 2) + torch.sum(data_weights * (data_im - model_im) ** 2)
