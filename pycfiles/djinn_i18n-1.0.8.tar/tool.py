...
# [GCC 8.4.0]
# Embedded file name: /home/bouma/gitprojects/provgroningen/buildout/src/djinn_i18n/djinn_i18n/tool.py
...
class TransTool(object):
    ...
    def translate(self, msgid, msgstr, locale):
        ...
        self.overrides[locale].update(msgid, msgstr, comment=orig_entry.comment, tcomment=orig_entry.tcomment)
    ...
    def list_entries(self, module, locale):
        return [ self.entries[locale][msgid] for msgid in self.module_entries[module]
               ]
