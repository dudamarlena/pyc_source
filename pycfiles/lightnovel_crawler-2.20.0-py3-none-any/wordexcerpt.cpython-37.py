...
class WordExcerptCrawler(Crawler):
    ...
    def read_novel_info(self):
        ...
        self.novel_cover = self.absolute_url(soup.select_one('div.summary_image a img')['data-src'])
        logger.info('Novel cover: %s', self.novel_cover)
        self.novel_author = 'Author : %s, Translator : %s' % (
         soup.select_one('div.author-content a').text, soup.select_one('div.artist-content a').text)
