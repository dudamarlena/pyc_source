...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/clitube/model.py
...
class Playlist(object):
    ...
    def _compute_offset(self, max_len):
        if self._iplay - self._space < self._offset:
            ...
            self._offset = min(len(self._list) - max_len, self._iplay - max_len + self._space + 1)
