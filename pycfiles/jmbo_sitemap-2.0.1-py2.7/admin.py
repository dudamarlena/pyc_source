...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo_sitemap/admin.py
# Compiled at: 2015-04-21 15:32:32
...
class HTMLSitemapAdmin(PreferencesAdmin):
    ...
    def save_model(self, request, obj, form, change):
        instance = super(HTMLSitemapAdmin, self).save_model(request, obj, form, change)
