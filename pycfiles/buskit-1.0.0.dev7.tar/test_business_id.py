...
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/business_tools/tests/test_business_id.py
# Compiled at: 2011-07-05 05:12:41
__doc__ = 'Unit tests for business_id.py.'
import unittest
...
class TestBusinessID(unittest.TestCase):
    ...
    def test_conversions(self):
        for val in ('1234567-1', 12345671):
            b = BusinessID(val)
            msg = 'While trying to convert from %s' % type(val)
    ...
    def test_validation(self):
        ...
        Test validation.
        """
        values = ('1234567-8', '13213231231233', 'Moi äiti!', 'Älöäläläöä')
        for val in values:
