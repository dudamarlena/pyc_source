...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/jmbo_facebook/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('jmbo_facebook_update', (
         (
          'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),))
        db.send_create_signal('jmbo_facebook', ['Update'])
        db.create_table('jmbo_facebook_page', (
         (
          'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
         (
          'facebook_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
         (
          'access_token', self.gf('django.db.models.fields.CharField')(max_length=255))))
        db.send_create_signal('jmbo_facebook', ['Page'])

    def backwards(self, orm):
        db.delete_table('jmbo_facebook_update')
        db.delete_table('jmbo_facebook_page')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'jmbo_facebook.page': {'Meta': {'ordering': "('-created',)", 'object_name': 'Page', '_ormbases': ['jmbo.ModelBase']}, 'access_token': (
       ...
       'jmbo_facebook.update': {'Meta': {'ordering': "('-created',)", 'object_name': 'Update', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                                'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
