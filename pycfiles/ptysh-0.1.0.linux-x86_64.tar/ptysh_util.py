...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/ptysh_util.py
...
class Encryption(object):
    _salt = 'IPOT_PTYSH'
    _default_passwd = '5b92b30b5d3e1a6f0dbe1824f4b7b1414bab66396ff0af3b2a329b40c8926146'
    ...
    def validate_passwd(self, in_passwd):
        if self._default_passwd == self.encrypt_passwd(in_passwd):
            return True
        return False
