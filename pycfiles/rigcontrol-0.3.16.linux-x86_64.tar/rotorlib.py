...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/rotorlib.py
# Compiled at: 2011-03-09 00:12:48
...
class Rotor:
    ...
    def __init__(self):
        ...
        if self.config.findtext('offset'):
            ...
            self.offset = 0
        self.ser = serial.Serial(self.device, baudrate=self.baudrate, rtscts=0)
