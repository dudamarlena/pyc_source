...
# [GCC 8.4.0]
# Embedded file name: /Users/tonra/ohm2/Clients/ohm2/Entwicklung/ohm2-dev-light/application/backend/apps/ohm2_currencies_light/migrations/0001_initial.py
# Compiled at: 2017-06-22 00:42:57
# Size of source mod 2**32: 7887 bytes
...
class Migration(migrations.Migration):
    ...
    dependencies = []
    operations = [
     migrations.CreateModel(name='ConvertionRate', fields=[
      (
      ...
      (
       'rate', models.FloatField())], options={'abstract': False}),
     migrations.CreateModel(name='Currency', fields=[
      ...
      (
       'available', models.BooleanField(default=True))], options={'abstract': False}),
     migrations.CreateModel(name='LastConvertionRate', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'identity', models.CharField(max_length=2048, unique=True)),
      ...
      (
       'output', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lcr_output_currency', to='ohm2_currencies_light.Currency'))], options={'abstract': False}),
     migrations.AddField(model_name='convertionrate', name='input', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cr_input_currency', to='ohm2_currencies_light.Currency')),
     migrations.AddField(model_name='convertionrate', name='output', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cr_output_currency', to='ohm2_currencies_light.Currency'))]