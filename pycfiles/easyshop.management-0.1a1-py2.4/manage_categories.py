...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/management/browser/manage_categories.py
...
class ManageCategoriesView(BrowserView):
    ...
    def __init__(self, context, request):
        ...
        if self.hasSelectedCategories() and 'manage-categories' in self.request.form.keys():
