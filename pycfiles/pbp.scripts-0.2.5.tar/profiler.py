...
# [GCC 8.4.0]
# Embedded file name: /Volumes/MacDev/perso/atomisator.ziade.org/packages/pbp.scripts/pbp/scripts/profiler.py
    ...
    def _profile(function):
        ...
        def __profile(*args, **kw):
            ...
            try:
                ...
                stats[name] = {'time': total, 'stones': kstones, 'memory': profiler.heap().size}
