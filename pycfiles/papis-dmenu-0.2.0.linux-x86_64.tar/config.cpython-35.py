...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/papis_dmenu/config.py
...
"""
import papis.config
configuration_settings = {'dmenu-gui': {'lines': 10, 
               ...
               'header-format': '{doc[year]:<4}| {doc[title]:<80.80}|:| {doc[author]}', 
