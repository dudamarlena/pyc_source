...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/fixture_magic/utils.py
...
def add_to_serialize_list(objs):
    for obj in objs:
        ...
        model_name = getattr(obj._meta, 'model_name', getattr(obj._meta, 'module_name', None))
