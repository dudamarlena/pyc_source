...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/personal/python/mapscookiegettercli/mapscookiegettercli/browsers/edge.py
...
LOGGER_BASENAME = 'edge'
LOGGER = logging.getLogger(LOGGER_BASENAME)
LOGGER.addHandler(logging.NullHandler())

class Edge:
    __doc__ = 'Bootstraps an edge selenium driver with the required settings'
