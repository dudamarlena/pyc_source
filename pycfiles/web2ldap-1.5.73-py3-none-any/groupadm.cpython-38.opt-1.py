...
# Compiled at: 2020-05-04 07:51:48
...
def w2l_groupadm--- This code section failed: ---
 ...
 L. 357      1474  LOAD_CONST               ('name',)
             1476  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
             1478  STORE_FAST               'group_search_root_field'

 L. 361      1480  LOAD_DEREF               'app'
             1482  LOAD_ATTR                form
             1484  LOAD_ATTR                accept_charset
             1486  LOAD_FAST                'group_search_root_field'
             1488  STORE_ATTR               charset

 L. 362      1490  LOAD_FAST                'group_search_root_field'
             1492  LOAD_METHOD              set_default
             1494  LOAD_GLOBAL              str
             1496  LOAD_FAST                'group_search_root'
             1498  CALL_FUNCTION_1       1  ''
             1500  CALL_METHOD_1         1  ''
             1502  POP_TOP          

 L. 364      1504  LOAD_FAST                'error_msg'
         1506_1508  POP_JUMP_IF_FALSE  1526  'to 1526'

 L. 365      1510  LOAD_DEREF               'app'
             1512  LOAD_ATTR                outf
             1514  LOAD_METHOD              write
             1516  LOAD_STR                 '<p class="ErrorMessage">%s</p>'
             1518  LOAD_FAST                'error_msg'
             1520  BINARY_MODULO    
             1522  CALL_METHOD_1         1  ''
             1524  POP_TOP          
           1526_0  COME_FROM          1506  '1506'

 L. 366      1526  LOAD_FAST                'info_msg'
         1528_1530  POP_JUMP_IF_FALSE  1548  'to 1548'

 L. 367      1532  LOAD_DEREF               'app'
             1534  LOAD_ATTR                outf
             1536  LOAD_METHOD              write
             1538  LOAD_STR                 '<p class="InfoMessage">%s</p>'
             1540  LOAD_FAST                'info_msg'
             1542  BINARY_MODULO    
             1544  CALL_METHOD_1         1  ''
             1546  POP_TOP          
           1548_0  COME_FROM          1528  '1528'

 L. 369      1548  LOAD_FAST                'all_groups_dict'
         1550_1552  POP_JUMP_IF_FALSE  1662  'to 1662'

 L. 371      1554  LOAD_DEREF               'app'
             1556  LOAD_METHOD              cfg_param
             1558  LOAD_STR                 'groupadm_optgroup_bounds'
             1560  LOAD_CONST               (1, None)
             1562  CALL_METHOD_2         2  ''
             1564  STORE_FAST               'optgroup_bounds'

 L. 373      1566  LOAD_DEREF               'app'
             1568  LOAD_ATTR                outf
             1570  LOAD_METHOD              write
 ...
 L. 390      1574  LOAD_DEREF               'app'
             1576  LOAD_METHOD              begin_form
             1578  LOAD_STR                 'groupadm'
             1580  LOAD_STR                 'POST'
             1582  CALL_METHOD_2         2  ''

 L. 391      1584  LOAD_DEREF               'app'
             1586  LOAD_ATTR                form
             1588  LOAD_METHOD              hiddenFieldHTML
             1590  LOAD_STR                 'dn'
             1592  LOAD_DEREF               'app'
             1594  LOAD_ATTR                dn
             1596  LOAD_STR                 ''
 ...
 L. 392      1600  LOAD_DEREF               'app'
             1602  LOAD_ATTR                form
             1604  LOAD_METHOD              hiddenFieldHTML
             1606  LOAD_STR                 'groupadm_searchroot'
             1608  LOAD_GLOBAL              str
             1610  LOAD_FAST                'group_search_root'
             1612  CALL_FUNCTION_1       1  ''
             1614  LOAD_STR                 ''
             1616  CALL_METHOD_3         3  ''

 L. 393      1618  LOAD_GLOBAL              group_select_field

 L. 394      1620  LOAD_DEREF               'app'

 L. 395      1622  LOAD_FAST                'all_groups_dict'

 L. 396      1624  LOAD_STR                 'groupadm_add'

 L. 397      1626  LOAD_STR                 'Groups to add to'

 L. 398      1628  LOAD_FAST                'group_search_root'

 L. 399      1630  LOAD_FAST                'add_groups'

 L. 400      1632  LOAD_FAST                'optgroup_bounds'

 L. 393      1634  CALL_FUNCTION_7       7  ''

 L. 402      1636  LOAD_GLOBAL              group_select_field

 L. 403      1638  LOAD_DEREF               'app'

 L. 404      1640  LOAD_DEREF               'remove_groups_dict'

 L. 405      1642  LOAD_STR                 'groupadm_remove'

 L. 406      1644  LOAD_STR                 'Groups to remove from'

 L. 407      1646  LOAD_FAST                'group_search_root'

 L. 408      1648  LOAD_FAST                'remove_groups'

 L. 409      1650  LOAD_FAST                'optgroup_bounds'

 L. 402      1652  CALL_FUNCTION_7       7  ''

 L. 388      1654  BUILD_TUPLE_5         5 

 L. 374      1656  BINARY_MODULO    

 L. 373      1658  CALL_METHOD_1         1  ''
             1660  POP_TOP          
           1662_0  COME_FROM          1550  '1550'

 L. 414      1662  LOAD_DEREF               'app'
             1664  LOAD_ATTR                outf
             1666  LOAD_METHOD              write

 L. 415      1668  LOAD_STR                 '%s\n%s\n\n          <p><input type="submit" value="List"> group entries below: %s.</p>\n          <p>where group name contains: %s</p>\n          <p>List %s groups.</p>\n        </form>\n        '

 L. 422      1670  LOAD_DEREF               'app'
             1672  LOAD_METHOD              begin_form
             1674  LOAD_STR                 'groupadm'
             1676  LOAD_STR                 'GET'
             1678  CALL_METHOD_2         2  ''

 L. 423      1680  LOAD_DEREF               'app'
             1682  LOAD_ATTR                form
             1684  LOAD_METHOD              hiddenFieldHTML
             1686  LOAD_STR                 'dn'
             1688  LOAD_DEREF               'app'
             1690  LOAD_ATTR                dn
             1692  LOAD_STR                 ''
             1694  CALL_METHOD_3         3  ''

 L. 424      1696  LOAD_FAST                'group_search_root_field'
             1698  LOAD_ATTR                input_html
             1700  LOAD_STR                 'Search root for searching group entries'
             1702  LOAD_CONST               ('title',)
             1704  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'

 L. 425      1706  LOAD_DEREF               'app'
             1708  LOAD_ATTR                form
             1710  LOAD_ATTR                field
             1712  LOAD_STR                 'groupadm_name'
             1714  BINARY_SUBSCR    
             1716  LOAD_METHOD              input_html
             1718  CALL_METHOD_0         0  ''

 L. 426      1720  LOAD_DEREF               'app'
             1722  LOAD_ATTR                form
             1724  LOAD_ATTR                field
             1726  LOAD_STR                 'groupadm_view'
             1728  BINARY_SUBSCR    
             1730  LOAD_ATTR                input_html

 L. 427      1732  LOAD_STR                 'Group entries list'

 L. 428      1734  LOAD_GLOBAL              str
             1736  LOAD_FAST                'groupadm_view'
             1738  CALL_FUNCTION_1       1  ''

 L. 426      1740  LOAD_CONST               ('title', 'default')
             1742  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'

 L. 420      1744  BUILD_TUPLE_5         5 

 L. 415      1746  BINARY_MODULO    

 L. 414      1748  CALL_METHOD_1         1  ''
             1750  POP_TOP          

 L. 433      1752  LOAD_FAST                'groupadm_view'
         1754_1756  POP_JUMP_IF_FALSE  1908  'to 1908'

 L. 434      1758  LOAD_DEREF               'app'
             1760  LOAD_ATTR                outf
             1762  LOAD_METHOD              write
             1764  LOAD_STR                 '<dl>\n'
             1766  CALL_METHOD_1         1  ''
             1768  POP_TOP          

 L. 436      1770  LOAD_FAST                'remove_groups'
             1772  LOAD_FAST                'all_group_entries'
             1774  LOAD_CONST               (1, 2)
             1776  BUILD_CONST_KEY_MAP_2     2 
             1778  LOAD_FAST                'groupadm_view'
             1780  BINARY_SUBSCR    
             1782  GET_ITER         
             1784  FOR_ITER           1896  'to 1896'
             1786  STORE_FAST               'group_dn'

 L. 437      1788  LOAD_FAST                'all_groups_dict'
             1790  LOAD_FAST                'group_dn'
             1792  BINARY_SUBSCR    
             1794  STORE_FAST               'group_entry'

 L. 438      1796  LOAD_DEREF               'app'
             1798  LOAD_ATTR                outf
             1800  LOAD_METHOD              write
             1802  LOAD_STR                 '<dt>%s | %s</dt>\n<dd>%s<br>\n(%s)<br>\n%s</dd>\n'

 L. 439      1804  LOAD_STR                 ', '
             1806  LOAD_METHOD              join
             1808  LOAD_FAST                'group_entry'
             1810  LOAD_METHOD              get
             1812  LOAD_STR                 'cn'
             1814  BUILD_LIST_0          0 
             1816  CALL_METHOD_2         2  ''
             1818  CALL_METHOD_1         1  ''

 L. 440      1820  LOAD_DEREF               'app'
             1822  LOAD_ATTR                anchor

 L. 441      1824  LOAD_STR                 'read'

 L. 441      1826  LOAD_STR                 'Read'

 L. 442      1828  LOAD_STR                 'dn'
             1830  LOAD_FAST                'group_dn'
             1832  BUILD_TUPLE_2         2 
             1834  BUILD_LIST_1          1 

 L. 443      1836  LOAD_STR                 'Display group entry'

 L. 440      1838  LOAD_CONST               ('title',)
             1840  CALL_FUNCTION_KW_4     4  '4 total positional and keyword args'

 L. 445      1842  LOAD_DEREF               'app'
             1844  LOAD_ATTR                form
             1846  LOAD_METHOD              utf2display
             1848  LOAD_FAST                'group_dn'
             1850  CALL_METHOD_1         1  ''

 L. 446      1852  LOAD_STR                 ', '
             1854  LOAD_METHOD              join
             1856  LOAD_FAST                'group_entry'
             1858  LOAD_METHOD              get
             1860  LOAD_STR                 'objectClass'
             1862  BUILD_LIST_0          0 
             1864  CALL_METHOD_2         2  ''
             1866  CALL_METHOD_1         1  ''

 L. 447      1868  LOAD_STR                 '<br>'
             1870  LOAD_METHOD              join
             1872  LOAD_FAST                'group_entry'
             1874  LOAD_METHOD              get
             1876  LOAD_STR                 'description'
             1878  BUILD_LIST_0          0 
             1880  CALL_METHOD_2         2  ''
             1882  CALL_METHOD_1         1  ''

 L. 438      1884  BUILD_TUPLE_5         5 
             1886  BINARY_MODULO    
             1888  CALL_METHOD_1         1  ''
             1890  POP_TOP          
         1892_1894  JUMP_BACK          1784  'to 1784'

 L. 449      1896  LOAD_DEREF               'app'
             1898  LOAD_ATTR                outf
             1900  LOAD_METHOD              write
             1902  LOAD_STR                 '</dl>\n'
             1904  CALL_METHOD_1         1  ''
             1906  POP_TOP          
           1908_0  COME_FROM          1754  '1754'

 L. 451      1908  LOAD_GLOBAL              web2ldap
             1910  LOAD_ATTR                app
             1912  LOAD_ATTR                gui
             1914  LOAD_METHOD              footer
             1916  LOAD_DEREF               'app'
             1918  CALL_METHOD_1         1  ''
             1920  POP_TOP          
