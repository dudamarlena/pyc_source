...
# Compiled at: 2020-05-04 07:49:40
# Size of source mod 2**32: 87651 bytes
"""
...
class OID(IA5String):
    ...
    def valueButton(self, command, row, mode, link_text=None):
        at = self._at.lower()
        if at in {'2.5.21.9', '2.5.4.0', 'objectclass', 'structuralobjectclass'}:
            return ''
...
class UUID(IA5String):
 ...
 L.2313         0  SETUP_FINALLY        38  'to 38'

 L.2314         2  LOAD_GLOBAL              str
                4  LOAD_GLOBAL              uuid
                6  LOAD_METHOD              UUID
                8  LOAD_FAST                'attrValue'
...
class ComposedAttribute(LDAPSyntax):
 ...
 L.2559        22  LOAD_FAST                'self'
               24  LOAD_ATTR                compose_templates
               26  GET_ITER         
               28  FOR_ITER             94  'to 94'
               30  STORE_FAST               'template'

 L.2560        32  SETUP_FINALLY        64  'to 64'

 L.2561        34  LOAD_FAST                'template'
               36  LOAD_ATTR                format
               38  BUILD_TUPLE_0         0 
               40  LOAD_FAST                'entry'
 ...
 L.2567        94  LOAD_FAST                'attrValues'
               96  RETURN_VALUE     

 L.2568        98  LOAD_FAST                'attr_values'
              100  RETURN_VALUE     
               -1  RETURN_LAST      
