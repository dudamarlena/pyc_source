...
# [GCC 8.4.0]
# Embedded file name: /Users/jmcarp/miniconda/envs/guardian/lib/python2.7/site-packages/guardrail/core/registry.py
# Compiled at: 2015-04-01 23:27:18
...
class _Registry(object):
    ...
    def get_permission(self, agent, target):
        ...
        try:
            ...
            raise exceptions.SchemaNotFound(('Could not find permission schema linking models {0} and {1}').format(agent.__name__, target.__name__))
