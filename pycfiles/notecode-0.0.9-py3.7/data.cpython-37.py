...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notecode/data/data.py
# Compiled at: 2019-05-23 08:35:37
# Size of source mod 2**32: 8064 bytes
import os, pickle, random, numpy as np, pandas as pd
...
def get_adult_data():
    ...
    download_file(url='https://raw.githubusercontent.com/1007530194/data/master/recommendation/data/adult.data.txt', path=train_path)
    download_file(url='https://raw.githubusercontent.com/1007530194/data/master/recommendation/data/adult.test.txt', path=test_path)
