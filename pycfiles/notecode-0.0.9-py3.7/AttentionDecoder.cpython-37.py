...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notecode/AttentionDecoder.py
# Compiled at: 2019-05-13 03:47:02
...
class AttentionDecoder(Recurrent):
    ...
    def call(self, x):
        self.x_seq = x
        self._uxpb = _time_distributed_dense((self.x_seq), (self.U_a), b=(self.b_a), input_dim=(self.input_dim),
