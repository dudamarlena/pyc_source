...
# Compiled at: 2020-04-21 23:40:05
...
def map_evaluate(image_files, gt_xml_files, model_name, weights, gt_path, dt_path, num_classes, index2label, anchors=None, input_shape=(416, 416), score_threshold=0.1, iou_threshold=0.5):
    model = single_inference_model_serving(model_name=model_name, weights=weights, num_classes=num_classes, dynamic_shape=True)
