...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taco/logger/logger.py
# Compiled at: 2019-09-05 09:49:59
import os, logging, taco.logger.consts as logger_consts
LOGS_BASE_DIR_PATH = './Output/Logs/'
...
def get_logger(name, add_file_handler=False, log_level=logger_consts.DEFAULT_LOG_LEVEL):
    ...
    if add_file_handler:
        ...
        fh = logging.FileHandler(LOGS_BASE_DIR_PATH + ('{name}.log').format(name=name))
