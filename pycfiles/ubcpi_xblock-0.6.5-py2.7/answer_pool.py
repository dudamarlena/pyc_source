...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ubcpi/answer_pool.py
# Compiled at: 2017-03-24 02:51:04
import random, persistence as sas_api
from utils import _
...
def get_other_answers(pool, seeded_answers, get_student_item_dict, algo, options):
    ...
    """
    num_responses = len(options) if 'num_responses' not in algo or algo['num_responses'] == '#' else int(algo['num_responses'])
    if algo['name'] == 'simple':
