...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/tescal/detcal/sim.py
# Compiled at: 2018-09-12 19:18:31
# Size of source mod 2**32: 27896 bytes
import numpy as np, scipy.constants as constants

def loadfromdidv(DIDVobj, G=5e-10, qetbias=0.00016, tc=0.04, tload=0.9, tbath=0.02, squiddc=2.5e-12, squidpole=0.0, squidn=1.0, noisetype='transition'):
    """
