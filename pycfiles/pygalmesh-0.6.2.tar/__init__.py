...
# Embedded file name: build/bdist.linux-x86_64/egg/pyGallerid/__init__.py
# Compiled at: 2012-02-01 08:17:47
...
def evolve_database(root, sw_version, initial_db_version=0):
    ...
    manager = ZODBEvolutionManager(root, evolve_packagename='pyGallerid.evolve', sw_version=sw_version, initial_db_version=initial_db_version)
...
def add_static_views(config):
    ...
    config.add_static_view('static', settings['static_dir'], cache_max_age=3600)
    config.add_static_view('pictures', settings['image_dir'], cache_max_age=3600)