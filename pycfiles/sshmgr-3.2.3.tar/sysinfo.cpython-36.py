...
# [GCC 8.4.0]
# Embedded file name: /Users/bugnofree/DevSpace/sshmgr/src/sysinfo.py
# Compiled at: 2019-07-24 01:57:33
...
class SysInfo:
    ...
    def __init__(self, conn):
        ...
        self._info_cmd = {'net':[
         ...
         'mem':[
          'free -b', 'dmidecode | grep "Maximum Capacity"'], 
         'disk':[
          'parted -l | grep "Disk /"']}
        self._info_tools = {'dmidecode':'sudo apt install -y dmidecode', 
