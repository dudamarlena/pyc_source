...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/beantop/beanstalkdstats.py
# Compiled at: 2013-05-23 08:51:47
HEADER_WIDTH = 25
FIELD_WIDTH = 15
...
class BeanstalkdStats:
    ...
    def _fetch_global_stats(self):
        return self._format(self._beanstalkd.yaml_data_filtered('stats', GLOBAL_STATS_FIELDS))
    ...
    def _get_filtered_tubes(self):
        ...
        for tube_name in all_tubes:
            tube = self._beanstalkd.yaml_data_filtered('stats-tube ' + tube_name, TUBE_STATS_FIELDS)
    ...
    def _tube_has_meaningful_info(tube):
        return tube['current-jobs-delayed'] + tube['current-jobs-reserved'] + tube['current-jobs-ready'] > 0
