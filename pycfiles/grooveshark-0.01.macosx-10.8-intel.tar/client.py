...
# [GCC 8.4.0]
# Embedded file name: /Users/luke/.envs/coco/lib/python2.7/site-packages/grooveshark/client.py
# Compiled at: 2012-12-22 18:31:09
import hashlib, hmac, json, urllib2, logging
...
class Grooveshark:
    ...
    def _build_request(self, method, params={}, session_id=None):
        ...
        url = '%(protocol)s://%(host)s/%(endpoint)s?sig=%(signature)s' % {'protocol': protocol, 
           'host': host, 
           'endpoint': endpoint, 
           'signature': sig}
        return (
