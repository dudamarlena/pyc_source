...
# [GCC 8.4.0]
# Embedded file name: /Users/jeff/env/slack-webhooks/lib/python2.7/site-packages/slack_webhooks/notifier.py
# Compiled at: 2015-06-16 16:17:52
    ...
    def dispatch(self, text, attach=None):
        ...
        if attach:
            if isinstance(attach, SlackAttachment):
                ...
                attach = [ a.dump_props() for a in attach if isinstance(a, SlackAttachment)
                         ]
