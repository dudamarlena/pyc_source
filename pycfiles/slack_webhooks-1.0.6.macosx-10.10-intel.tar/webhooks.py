...
# [GCC 8.4.0]
# Embedded file name: /Users/jeff/env/slack-webhooks/lib/python2.7/site-packages/slack_webhooks/webhooks.py
# Compiled at: 2015-06-17 16:16:25
...
class SlackWebhook(SlackDumpableMixin):
    ...
    def __init__(self, webhook_url, username=None, icon_url=None, icon_emoji=None, channel=None):
    ...
    def decorate(self, pre_text, failure_text, pre_attachment=None, success_text=None, success_attachment=None, failure_attachment=None):
    ...
    def send(self, text, attachment=None):
        ...
        if attachment:
            if isinstance(attachment, SlackAttachment):
                attachment = [
                 attachment.dump_props()]
            else:
                attachment = [ a.dump_props() for a in attachment if isinstance(a, SlackAttachment)
                             ]
...
class SlackAttachment(SlackDumpableMixin):
    ...
    def __init__(self, fallback, color=None, pretext=None, author_name=None, author_link=None, author_icon=None, title=None, title_link=None, text=None, fields=None, image_url=None, thumb_url=None):
        ...
        self.slack_props = ('fallback', 'color', 'pretext', 'author_name', 'author_link',
                            'author_icon', 'title', 'title_link', 'text', 'fields',
                            'image_url', 'thumb_url')
        super(self.__class__, self).__init__()