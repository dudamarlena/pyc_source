...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/arrayterator.py
# Compiled at: 2009-02-10 08:37:56
"""
...
class Arrayterator(object):
    ...
    @property
    def shape(self):
        return tuple((max(0, (stop - start - 1) // step + 1) for (start, stop, step) in zip(self.start, self.stop, self.step)))
...
class arrayterator(Arrayterator):

    def __init__(self, var, nrecs=None):
        Arrayterator.__init__(self, var, nrecs)