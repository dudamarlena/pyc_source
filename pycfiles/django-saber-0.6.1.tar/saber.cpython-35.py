...
# [GCC 8.4.0]
# Embedded file name: /Users/jvai/code/django-saber/djangosaber/saber.py
# Compiled at: 2015-10-09 09:39:45
# Size of source mod 2**32: 4905 bytes
from django.apps import apps
import operator, cachetools
...
class Memory(object):
    ...
    def model_classes(self):
        ...
        for model in apps.get_models():
            bases = (
             Traverse,) + tuple(c[model._meta.model_name])
