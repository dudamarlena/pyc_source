...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/SPARQLWrapper/SmartWrapper.py
# Compiled at: 2019-12-21 15:12:35
"""
    ...
    def __getitem__(self, key):
        ...
        def _checkKeys(keys):
            if len(keys) == 0:
                return False
            for k in keys:
                if not isinstance(k, basestring) or k not in self.variables:
                    return False
