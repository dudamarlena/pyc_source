...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/symmetry/groups.py
# Compiled at: 2014-04-10 23:28:49
"""
...
class PointGroup(SymmetryGroup):
    ...
    def __init__(self, int_symbol):
        ...
        self.generators = [ GENERATOR_MATRICES[c] for c in POINT_GROUP_ENC[int_symbol]
                          ]
...
def in_array_list(array_list, a):
    ...
    if len(array_list) == 0:
        ...
        return np.any(np.sum(np.abs(array_list - a[None, :]), axes) < 1e-05)
