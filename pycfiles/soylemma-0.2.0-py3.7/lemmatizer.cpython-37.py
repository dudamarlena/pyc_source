...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/soylemma/lemmatizer.py
# Compiled at: 2019-05-26 14:07:53
...
class Lemmatizer:
    ...
    def __init__(self, verbs=None, adjectives=None, eomis=None, lemma_rules=None, dictionary_name='default'):
        verbs, adjectives, eomis = self._check_dictionary(verbs, adjectives, eomis, dictionary_name)
        lemma_rules, conjugate_rules = self._check_rules(lemma_rules, dictionary_name)
        self.verbs = verbs
    ...
    def _check_dictionary(self, verbs, adjectives, eomis, dictionary_name):
        ...
        for morphs, tag in morphs_set:
            if morphs is None:
                morphs = self._load_dictionary('{}/soylemma/dictionary/{}/{}.txt'.format(installpath, dictionary_name, tag))
    ...
    def _check_rules(self, lemma_rules, dictionary_name):
        ...
        if lemma_rules is None:
            lemma_rules = self._load_rules('{}/soylemma/dictionary/{}/rules.txt'.format(installpath, dictionary_name))
    ...
    def analyze(self, word, debug=False):
        ...
        -----
            ...
            $ [(('차갑', 'Adjective'), ('우니까', 'Eomi'))]
        """
        return analyze_morphology(word, self.verbs, self.adjectives, self.eomis, self.lemma_rules, debug)
    ...
    def lemmatize(self, word):
        ...
        -----
            ...
            $ [('차갑다', 'Adjective')]
        """
        morphs = analyze_morphology(word, self.verbs, self.adjectives, self.eomis, self.lemma_rules)
...
def get_lemma_candidates(word, rules, debug=False):
    ...
    def debug_on(word, l, stem, eomi, r, conj):
        args = (
         word, l + stem, eomi + r, conj, stem, eomi)
