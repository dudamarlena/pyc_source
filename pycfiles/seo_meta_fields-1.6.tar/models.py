...
# [GCC 8.4.0]
# Embedded file name: /Users/himanshubansal/Desktop/meta_management/meta_fields/models.py
# Compiled at: 2017-02-23 08:55:26
...
class MetaImage(models.Model):
    ...
    class Meta:
        verbose_name = b'Meta Image'
        verbose_name_plural = b'Meta Image'
...
class SiteInformation(models.Model):
    ...
    class Meta:
        verbose_name = b'Site Information'
        verbose_name_plural = b'Site Information'
...
class OpenGraph(models.Model):
    ...
    image = models.ImageField(help_text=b'Image for OpenGraph')
    image_url = models.CharField(max_length=255)
    ...
    class Meta:
        verbose_name = b'Open Graph'
        verbose_name_plural = b'Open Graph'
...
class GoogleVerification(models.Model):
    ...
    class Meta:
        verbose_name = b'Google Verification'
        verbose_name_plural = b'Google Verification'
...
class BingVerification(models.Model):
    ...
    class Meta:
        verbose_name = b'Bing Verification'
        verbose_name_plural = b'Bing Verification'
...
class BasicTags(models.Model):
    ...
    class Meta:
        verbose_name = b'Basic Tags'
        verbose_name_plural = b'Basic Tags'
...
class AdvancedTags(models.Model):
 ...
 'Provides search engines with specific directions for what to do when this page is indexed.'))
    ...
    class Meta:
        verbose_name = b'Advanced Tags'
        verbose_name_plural = b'Advanced Tags'