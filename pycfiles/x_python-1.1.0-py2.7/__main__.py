...
# Compiled at: 2020-05-07 14:49:22
...
@click.option('-v', '--verbose', count=True, help='verbosity level in tracing.\nCan be supplied multiple times to increase verbosity.')
@click.option('-c', '--command-to-run', help='program passed in as a string', required=False)
