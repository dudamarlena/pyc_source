...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/buty_phyl/scripts/Bayers.model.py
# Compiled at: 2019-04-12 20:59:39
...
if args.p != 'FALSE':
    ...
    Traitspredicting(os.path.join(args.r, treefile + '.infertraits.txt'), os.path.join(args.r, treefile + '.infertraits.pathogen.txt'))
else:
    Traitspredicting(os.path.join(args.r, treefile + '.infertraits.txt'), args.p)