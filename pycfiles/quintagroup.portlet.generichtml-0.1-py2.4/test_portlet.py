...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/quintagroup/portlet/generichtml/tests/test_portlet.py
# Compiled at: 2009-05-19 09:23:38
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='quintagroup.portlet.generichtml.GenericHTMLPortlet')
        self.assertEquals(portlet.addview, 'quintagroup.portlet.generichtml.GenericHTMLPortlet')
...
class TestRenderer(TestCase):
    ...
    def test_render(self):
        ...
        r.update()
        output = r.render()
        self.assertEqual(output, '<div>Here can be your content</div>\n')
