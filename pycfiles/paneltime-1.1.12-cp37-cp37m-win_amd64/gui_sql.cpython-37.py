...
# [GCC 8.4.0]
# Embedded file name: b:\forskning\papers\paneltime\paneltime\paneltime\gui\gui_sql.py
# Compiled at: 2020-03-26 03:32:19
# Size of source mod 2**32: 3146 bytes
import tkinter as tk
from multiprocessing import pool
import numpy as np
from gui import gui_scrolltext
import paneltime, functions as fu
...
class sql_query(tk.Toplevel):
    ...
    def ok_pressed(self, event=None):
        ...
        if name not in self.win.locals['data']:
            return
