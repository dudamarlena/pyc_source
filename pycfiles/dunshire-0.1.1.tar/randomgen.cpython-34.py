...
# [GCC 8.4.0]
# Embedded file name: /home/mjo/src/dunshire/test/randomgen.py
# Compiled at: 2016-11-15 20:11:04
...
def random_diagonal_matrix(dims):
    ...
    """
    return matrix([[random_scalar() * int(i == j) for i in range(dims)] for j in range(dims)])
...
def random_skew_symmetric_matrix(dims):
    ...
    """
    strict_ut = [[random_scalar() * int(i < j) for i in range(dims)] for j in range(dims)]
