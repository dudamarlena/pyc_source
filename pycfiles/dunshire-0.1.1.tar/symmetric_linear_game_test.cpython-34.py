...
# [GCC 8.4.0]
# Embedded file name: /home/mjo/src/dunshire/test/symmetric_linear_game_test.py
# Compiled at: 2016-11-13 15:41:37
...
from .randomgen import random_icecream_game, random_ll_icecream_game, random_ll_orthant_game, random_nn_scaling, random_orthant_game, random_positive_orthant_game, random_translation
...
class SymmetricLinearGameTest(TestCase):
    ...
    def assert_opposite_game_works(self, G):
        ...
        soln2 = H.solution()
        modifier = G.tolerance_scale(soln1)
        self.assert_within_tol(-soln1.game_value(), soln2.game_value(), modifier)
        self.assert_within_tol(soln2.game_value(), H.payoff(y_bar, x_bar), modifier)
