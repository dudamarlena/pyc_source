...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/djweed/db_fields.py
# Compiled at: 2018-03-12 02:14:41
...
class WeedFSFieldFile(FieldFile):
    ...
    def _get_url(self):
        ...
        return reverse('weedfs_get_file', kwargs={'content_type_id':content_type.id, 
...
class WeedFSFileField(FileField):
    ...
    def __init__(self, verbose_name=None, name=None, storage=None, **kwargs):
        ...
        (super(WeedFSFileField, self).__init__)(verbose_name, name, storage=storage, **kwargs)
