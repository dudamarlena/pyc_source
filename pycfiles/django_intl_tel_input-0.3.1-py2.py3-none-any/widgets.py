...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Benjamin\Documents\GitHub\django-intl-tel-input\intl_tel_input\widgets.py
# Compiled at: 2017-07-31 00:57:56
import json
...
class IntlTelInputWidget(forms.TextInput):
    ...
    class Media:
        css = {'all': ('https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/9.0.1/css/intlTelInput.css', )}
