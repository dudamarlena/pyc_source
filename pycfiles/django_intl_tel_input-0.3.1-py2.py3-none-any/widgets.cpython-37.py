...
# [GCC 8.4.0]
# Embedded file name: G:\Benjamin\Documents\GitHub\django-intl-tel-input\intl_tel_input\widgets.py
# Compiled at: 2019-03-20 02:45:02
...
class IntlTelInputWidget(forms.TextInput):
    ...
    def __init__(self, attrs=None, allow_dropdown=True, preferred_countries=[
 'us', 'gb'], default_code='us', use_default_init=True):
    ...
    def media(self):
        js = (
         'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/{version}/js/intlTelInput-jquery.min.js'.format(version=INTL_TEL_INPUT_VERSION),)
        if self.use_default_init:
            js += ('intl_tel_input/init.js', )
        return forms.Media(css={'all': (
                 'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/{version}/css/intlTelInput.css'.format(version=INTL_TEL_INPUT_VERSION),)},
          js=js)
    ...
    def render(self, name, value, renderer=None, attrs=None):
        ...
        final_attrs['class'] = ' '.join([
         'intl-tel-input', final_attrs.get('class', '')]).strip()
