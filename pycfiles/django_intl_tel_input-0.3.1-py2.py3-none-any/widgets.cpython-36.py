...
# Compiled at: 2018-07-08 22:46:02
...
class IntlTelInputWidget(forms.TextInput):
    ...
    class Media:
        css = {'all': ('https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/12.4.0/css/intlTelInput.css', )}
        js = ('https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/12.4.0/js/intlTelInput.min.js',
              'intl_tel_input/init.js')

    def __init__(self, attrs=None, allow_dropdown=True, preferred_countries=[
 'us', 'gb'], default_code='us', auto_geo_ip=False):
        final_attrs = {'size': '2'}
        if attrs is not None:
            final_attrs.update(attrs)
        self.js_attrs = {'size':'20', 
