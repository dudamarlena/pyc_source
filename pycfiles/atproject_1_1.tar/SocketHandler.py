...
# [GCC 8.4.0]
# Embedded file name: att/Network/SocketHandler.py
...
class SocketHandler(object):
    ...
    def find_and_bind(self, minport, maxport, bind='', reuse=False, ipv6_socket_style=1, upnp=0, randomizer=False):
        ...
        if maxport - minport < 50 or not randomizer:
            ...
            for listen_port in portrange:
                try:
                    self.bind(listen_port, bind, ipv6_socket_style=ipv6_socket_style, upnp=upnp)
                    return listen_port
                except socket.error as e:
                    pass
    ...
    def get_stats(self):
        return {'interfaces': self.interfaces, 'port': self.port, 
