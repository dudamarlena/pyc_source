...
# [GCC 8.4.0]
# Embedded file name: att/Client/DownloaderFeedback.py
...
class DownloaderFeedback:
    ...
    def __init__(self, choker, httpdl, add_task, upfunc, downfunc, ratemeasure, leftfunc, file_length, finflag, sp, statistics, statusfunc=None, interval=None):
        self.choker = choker
        self.httpdl = httpdl
