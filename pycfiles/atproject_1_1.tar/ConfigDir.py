...
# [GCC 8.4.0]
# Embedded file name: /Users/Yifei/Desktop/atproject/atproject/Application/ConfigDir.py
# Compiled at: 2017-04-23 16:37:50
"""Manage application-specific configuration and caches
"""
import att, sys, os, time, shutil
...
class ConfigDir(object):
    ...
    def __init__(self, config_type=None):
        for envvar in ('APPDATA', 'HOME', 'HOMEPATH', 'USERPROFILE'):
            ...
            for icon in GetIcons():
                ...
                if not (os.path.exists(new_icon) or shutil.copyfile(old_icon, new_icon)):
    ...
    def saveConfig(self, new_config=None):
        ...
        return ini_write(self.configfile, self.config, ('Generated by {}/{}\n{}').format(att.product_name, att.version_short, time.strftime('%x %X')))
    ...
    def getTorrents(self):
        ...
        return set(unhexlify(os.path.basename(torrent).split('.')[0]) for torrent in os.listdir(self.dir_torrentcache))
