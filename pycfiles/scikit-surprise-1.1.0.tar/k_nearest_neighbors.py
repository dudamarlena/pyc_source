...
def read_item_names():
    ...
    """
    file_name = get_dataset_dir() + b'/ml-100k/ml-100k/u.item'
    rid_to_name = {}
    name_to_rid = {}
    with io.open(file_name, b'r', encoding=b'ISO-8859-1') as (f):
        for line in f:
            line = line.split(b'|')
...
sim_options = {b'name': b'pearson_baseline', b'user_based': False}
algo = KNNBaseline(sim_options=sim_options)
algo.fit(trainset)
rid_to_name, name_to_rid = read_item_names()
toy_story_raw_id = name_to_rid[b'Toy Story (1995)']
...
print()
print(b'The 10 nearest neighbors of Toy Story are:')
