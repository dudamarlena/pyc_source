...
# [GCC 8.4.0]
# Embedded file name: /home/peter/slugs/slugs/tests/unit/test_controllers.py
# Compiled at: 2019-01-17 10:41:13
# Size of source mod 2**32: 19457 bytes
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, cherrypy, mock, testtools
...
class TestMainController(testtools.TestCase):
    ...
    def test_cp_dispatch_level_one(self):
        ...
        args = [
         [
          'invalid']]
        self.assertRaisesRegex(cherrypy.HTTPError, 'Collection not found.', controller._cp_dispatch, *args)
    ...
    def test_cp_dispatch_level_three(self):
        ...
        args = [
         [
          'users', 'Adam', 'invalid']]
        self.assertRaisesRegex(cherrypy.HTTPError, 'User attribute not found.', controller._cp_dispatch, *args)
        ...
        args = [
         [
          'groups', 'Human', 'invalid']]
        self.assertRaisesRegex(cherrypy.HTTPError, 'Group attribute not found.', controller._cp_dispatch, *args)
    ...
    def test_cp_dispatch_invalid_query(self):
        ...
        args = [
         [
          'groups', 'Human', 'users', 'Adam', 'invalid']]
        self.assertRaisesRegex(cherrypy.HTTPError, 'Resource not found.', controller._cp_dispatch, *args)
...
class TestUsersController(testtools.TestCase):
    ...
    def test_index_user(self):
        ...
        controller = controllers.UsersController()
        kwargs = {'user': 'Adam'}
        self.assertRaisesRegex(cherrypy.HTTPError, 'User not found.', controller.index, **kwargs)
        controller.update(user_group_mapping=[
         ('Adam', 'Male'),
         ('Eve', 'Female'),
         ('Adam', 'Human'),
    ...
    def test_index_user_group_groups(self):
        ...
        kwargs = {'user': 'Adam', 
         'groups': True, 
         'group': 'invalid'}
        self.assertRaisesRegex(cherrypy.HTTPError, 'Group not found.', controller.index, **kwargs)
