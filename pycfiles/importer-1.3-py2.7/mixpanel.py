...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/importer/lib/mixpanel/mixpanel.py
# Compiled at: 2014-04-16 19:00:35
...
if __name__ == '__main__':
    api = Mixpanel(api_key='YOUR KEY', api_secret='YOUR SECRET')
    data = api.request(['events'], {'event': [
               'pages'], 
       'unit': 'hour', 
       'interval': 24, 
       'type': 'general'})
