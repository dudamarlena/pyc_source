...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\test_functions.py
...
class TestSplitDSN(unittest.TestCase):
    ...
    def test_sqlite(self):
        self.assertDsnEqual('sqlite://c|/mydatabase/test.db', {'protocol': 'sqlite', 'host': 'c|', 'user': None, 'path': '/mydatabase/test.db', 
           'password': None, 'port': None})
        return

    def test_ftp(self):
        self.assertDsnEqual('ftp://username@domain.com/index.html', {'protocol': 'ftp', 'host': 'domain.com', 'user': 'username', 'path': '/index.html', 
           'password': None, 'port': 21})
        return

    def test_ftp2(self):
        self.assertDsnEqual('ftp://username:password@domain.com/index.html', {'protocol': 'ftp', 'host': 'domain.com', 'user': 'username', 'path': '/index.html', 
           'password': 'password', 'port': 21})

    def test_ftp3(self):
        self.assertDsnEqual('ftp://username@domain.com:password@domain.com/index.html', {'protocol': 'ftp', 'host': 'domain.com', 'user': 'username@domain.com', 'path': '/index.html', 
           'password': 'password', 'port': 21})

    def test_ftp4(self):
        self.assertDsnEqual('ftp://username@domain.com:password@domain.com:2121/index.html', {'protocol': 'ftp', 'host': 'domain.com', 'user': 'username@domain.com', 'path': '/index.html', 
           'password': 'password', 'port': 2121})

    def test_mysql(self):
        self.assertDsnEqual('mysql://b3:password@localhost/b3', {'protocol': 'mysql', 'host': 'localhost', 'user': 'b3', 'path': '/b3', 
           'password': 'password', 'port': 3306})
        self.assertDsnEqual('mysql://b3:password@localhost:3406/b3', {'protocol': 'mysql', 'host': 'localhost', 'user': 'b3', 'path': '/b3', 
           'password': 'password', 'port': 3406})
        self.assertDsnEqual('mysql://someuser:somepasswd@somehost:3326/', {'protocol': 'mysql', 'host': 'somehost', 'user': 'someuser', 'path': '/', 
           'password': 'somepasswd', 'port': 3326})

    def test_mysql_empty_password(self):
        self.assertDsnEqual('mysql://b3:@localhost/b3', {'protocol': 'mysql', 'host': 'localhost', 'user': 'b3', 'path': '/b3', 
           'password': '', 'port': 3306})

    def test_mysql_no_password(self):
        self.assertDsnEqual('mysql://b3@localhost:3406/b3', {'protocol': 'mysql', 'host': 'localhost', 'user': 'b3', 'path': '/b3', 
           'password': '', 'port': 3406})
...
class TestTime2minutes(unittest.TestCase):
    ...
    def test_str_h(self):
        self.assertEqual(functions.time2minutes('145h'), 8700)
        self.assertEqual(functions.time2minutes('0 h'), 0)
        self.assertEqual(functions.time2minutes('0    h'), 0)
        self.assertEqual(functions.time2minutes('5h'), 300)
    ...
    def test_str_d(self):
        ...
        self.assertEqual(functions.time2minutes('0    d'), 0)
        self.assertEqual(functions.time2minutes('60d'), 86400)
        self.assertEqual(functions.time2minutes('120d'), 172800)
        self.assertEqual(functions.time2minutes('5d'), 7200)
        self.assertEqual(functions.time2minutes('90d'), 129600)

    def test_str_w(self):
        self.assertEqual(functions.time2minutes('0 w'), 0)
        self.assertEqual(functions.time2minutes('0    w'), 0)
        self.assertEqual(functions.time2minutes('60w'), 604800)
        self.assertEqual(functions.time2minutes('120w'), 1209600)
        self.assertEqual(functions.time2minutes('5w'), 50400)
        self.assertEqual(functions.time2minutes('90w'), 907200)


class Test_misc(unittest.TestCase):

    def test_minutesStr(self):
        for test_data, expected in {'3s': '3 seconds', 
           '4m': '4 minutes', 
           '41': '41 minutes', 
           '2h': '2 hours', 
           '2.5h': '2.5 hours', 
...
class Test_getStuffSoundingLike(unittest.TestCase):
    ...
    def test_substring_match(self):
        ...
        self.assertListEqual(['xxxfoOx1', 'xxxfoOx2', 'xxxfoOx3', 'xxxfoOx4', 'xxxfoOx5', 'xxxfoOx6'], functions.getStuffSoundingLike('foO', ['xxxfoOx1', 'xxxfoOx2', 'xxxfoOx3', 'xxxfoOx4', 'xxxfoOx5', 'xxxfoOx6', 'bar']))
