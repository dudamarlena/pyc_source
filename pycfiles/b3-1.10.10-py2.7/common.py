...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\storage\common.py
...
class StorageAPITest(object):
    ...
    def test_getLastPenalties(self):
        ...
        self.assertListEqual(['pH', 'pG', 'pF', 'pC', 'pB'], getLastPenalties(types=('Ban',
                                                                                     'TempBan',
                                                                                     'Kick',
                                                                                     'Warning',
                                                                                     'Notice'), num=5))
        self.assertListEqual(['pH', 'pG', 'pF', 'pC'], getLastPenalties(types=('Ban',
                                                                               'TempBan',
                                                                               'Kick',
                                                                               'Warning',
                                                                               'Notice'), num=4))
    ...
    def test_getClientPenalty(self):
        tmp = Penalty(type='Kick', clientId=54, inactive=1, adminId=4, reason='respect the rules', keyword='rules', data='foo', timeAdd=123, timeEdit=1234, timeExpire=654, duration=87)
    ...
    def test_getClientPenalties(self):
        ...
        assertPenalties(client=c1, types=('Ban', 'TempBan', 'Kick', 'Warning', 'Notice'), penalties_in=('pB',
                                                                                                        'pC'), penalties_notin=('pA',
                                                                                                                                'pD',
                                                                                                                                'pE',
                                                                                                                                'pF',
                                                                                                                                'pG'))
        assertPenalties(client=c2, types=('Ban', 'TempBan', 'Kick', 'Warning', 'Notice'), penalties_in=('pF',
                                                                                                        'pG'), penalties_notin=('pA',
                                                                                                                                'pB',
                                                                                                                                'pC',
                                                                                                                                'pD',
                                                                                                                                'pE'))
    ...
    def test_disableClientPenalties(self):
        ...
        assertPenalties(client=c1, types=('Ban', 'TempBan', 'Kick', 'Warning', 'Notice'), penalties_in=('pB',
                                                                                                        ...
                                                                                                        'pG'), penalties_notin=('pA',
                                                                                                                                'pE',
                                                                                                                                'pF'))
        assertPenalties(client=c2, types=('Ban', 'TempBan', 'Kick', 'Warning', 'Notice'), penalties_in=('pE',
                                                                                                        'pF'), penalties_notin=('pA',
                                                                                                                                'pB',
                                                                                                                                'pC',
                                                                                                                                'pD',
                                                                                                                                'pG'))
        self.storage.disableClientPenalties(client=c1)
        assertPenalties(client=c1, types=('Ban', 'TempBan', 'Kick', 'Warning', 'Notice'), penalties_in=('pC',
                                                                                                        'pD',
                                                                                                        'pG'), penalties_notin=('pA',
                                                                                                                                'pB',
                                                                                                                                'pE',
    ...
    def test_numPenalties(self):
        ...
        self.assertEqual(4, self.storage.numPenalties(client=c1, type=('Ban', 'TempBan',
                                                                       'Kick', 'Warning',
                                                                       'Notice')))
        self.assertEqual(0, self.storage.numPenalties(client=c2))
        self.assertEqual(2, self.storage.numPenalties(client=c2, type=('Ban', 'TempBan',
                                                                       'Kick', 'Warning',
                                                                       'Notice')))
