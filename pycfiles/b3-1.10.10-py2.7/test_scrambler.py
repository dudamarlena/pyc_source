...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\plugins\poweradminbf3\test_scrambler.py
...
class Test_events(Bf3TestCase):
    ...
    def assert_scrambleTeams_has_calls_on_round_change(self, scramble_mode, gamemode_blacklist, next_gamemode, expected_calls):
        self._assert_scrambleTeams_has_calls_on_level_started(scramble_mode=scramble_mode, gamemode_blacklist=gamemode_blacklist, next_gamemode=next_gamemode, next_round_number=1, expected_calls=expected_calls)

    def assert_scrambleTeams_has_calls_on_map_change(self, scramble_mode, gamemode_blacklist, next_gamemode, expected_calls):
        self._assert_scrambleTeams_has_calls_on_level_started(scramble_mode=scramble_mode, gamemode_blacklist=gamemode_blacklist, next_gamemode=next_gamemode, next_round_number=0, expected_calls=expected_calls)

    def test_auto_scramble_ignore_blacklisted_gamemodes_on_round_change(self):
        self.assert_scrambleTeams_has_calls_on_round_change(scramble_mode='round', gamemode_blacklist=[
         'SquadDeathMatch0'], next_gamemode='SquadDeathMatch0', expected_calls=[])

    def test_auto_scramble_on_round_change(self):
        self.assert_scrambleTeams_has_calls_on_round_change(scramble_mode='round', gamemode_blacklist=[
         'SquadDeathMatch0'], next_gamemode='Rush0', expected_calls=[
         call()])
        self.assert_scrambleTeams_has_calls_on_round_change(scramble_mode='off', gamemode_blacklist=[
         'SquadDeathMatch0'], next_gamemode='Rush0', expected_calls=[])

    def test_auto_scramble_ignore_blacklisted_gamemodes_on_map_change(self):
        self.assert_scrambleTeams_has_calls_on_map_change(scramble_mode='map', gamemode_blacklist=[
         'SquadDeathMatch0', 'Conquest0'], next_gamemode='SquadDeathMatch0', expected_calls=[])

    def test_auto_scramble_on_map_change(self):
        self.assert_scrambleTeams_has_calls_on_map_change(scramble_mode='map', gamemode_blacklist=[
         'SquadDeathMatch0'], next_gamemode='Rush0', expected_calls=[
         call()])
        self.assert_scrambleTeams_has_calls_on_map_change(scramble_mode='off', gamemode_blacklist=[
         'SquadDeathMatch0'], next_gamemode='Rush0', expected_calls=[])