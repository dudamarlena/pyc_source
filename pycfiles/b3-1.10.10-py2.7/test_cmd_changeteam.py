...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\plugins\poweradminbf3\test_cmd_changeteam.py
...
class Test_cmd_changeteam(Bf3TestCase):
    ...
    def test_frostbite_error(self):
        ...
        self.joe.teamId = 1
        self.joe.squad = 1
        when(self.console).write(('admin.movePlayer', 'joe', 2, 0, 'true')).thenRaise(CommandFailedError(['SetTeamFailed']))
    ...
    def test_SquadDeathMatch0(self):
        ...
        self.assertEqual(['Joe forced from team 1 to team 2', 'Joe forced from team 2 to team 3',
         'Joe forced from team 3 to team 4', 'Joe forced from team 4 to team 1'], self.superadmin.message_history)
