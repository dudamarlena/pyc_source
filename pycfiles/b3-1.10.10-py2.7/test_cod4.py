...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\parsers\test_cod4.py
...
class Test_cod4ClientAuthMethod(Cod4TestCase):
    ...
    def test_unexpected_exception(self):
        ...
        with patch.object(self.console, 'error') as (error_mock):
            joe.auth()
        error_mock.assert_called_with('Auth self.console.storage.getClient(client) - Client<@0:joe_guid|:"Joe":None>', exc_info=ANY)