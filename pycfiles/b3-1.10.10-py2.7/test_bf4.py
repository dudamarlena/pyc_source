...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\parsers\test_bf4.py
...
class Test_getServerInfo(unittest.TestCase):
    ...
    def get_test_data(self, **kwargs):
        ...
        if numTeams == '4':
            ...
            return (
             serverName, numPlayers, maxPlayers, gamemode, level, roundsPlayed, roundsTotal, numTeams, team1score,
             team2score, targetScore, onlineState, isRanked, hasPunkbuster, hasPassword,
             serverUptime, roundTime, gameIpAndPort, punkBusterVersion, joinQueueEnabled, region, closestPingSite,
             country, blazePlayerCount, blazeGameState)

    R17_RANKED_0PLAYER_DOMINATION = ('BF4 Server', '0', '16', 'Domination0', 'MP_Naval',
                                     '0', '1', '2', '600', '600', '0', '', 'true',
                                     'true', 'false', '86400', '60', '1.2.3.4:25501',
                                     'v1.880 | A1390 C2.332', 'true', 'EU', 'ams',
                                     'DE', '0', 'IN_GAME')

    def test_decodeServerinfo_R17(self):
        self.maxDiff = None
        self.assertDictEqual({'serverName': 'BF4 Server', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           ...
           'country': 'DE', 
           'blazePlayerCount': '0', 
           'blazeGameState': 'IN_GAME'}, Bf4Parser.decodeServerinfo(self.get_test_data()))
        self.assertDictEqual({'serverName': 'BF4 Server', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           'gamemode': 'Domination0', 
           ...
           'country': 'DE', 
           'blazePlayerCount': '0', 
           'blazeGameState': 'IN_GAME'}, Bf4Parser.decodeServerinfo(self.get_test_data(isRanked='false')))
        self.assertDictEqual({'serverName': 'BF4 Server', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           'gamemode': 'Domination0', 
           ...
           'country': 'DE', 
           'blazePlayerCount': '0', 
           'blazeGameState': 'IN_GAME'}, Bf4Parser.decodeServerinfo(self.get_test_data(hasPunkbuster='false')))
        self.assertDictEqual({'serverName': 'BF4 Server', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           ...
           'country': 'DE', 
           'blazePlayerCount': '0', 
           'blazeGameState': 'IN_GAME'}, Bf4Parser.decodeServerinfo(self.get_test_data(gamemode='SquadDeathMatch0', numTeams='4', team1score='0', team2score='1', team3score='23', team4score='14')))
        return
...
class Test_patch_b3_admin_plugin(BF4TestCase):
    ...
    def test_map_InvalidGameModeOnMap(self):
        ...
        when(self.parser).changeMap('MP_Siege', gamemode_id='CaptureTheFlag0', number_of_rounds=2).thenRaise(CommandFailedError(['InvalidGameModeOnMap']))
        self.joe.says('!map siege')
    ...
    def test_map_InvalidRoundsPerMap(self):
        when(self.parser).changeMap('MP_Siege', gamemode_id='Domination0', number_of_rounds=2).thenRaise(CommandFailedError(['InvalidRoundsPerMap']))
        self.joe.says('!map siege')
        self.assertListEqual(['number of rounds must be 1 or greater'], self.joe.message_history)

    def test_map_Full(self):
        when(self.parser).changeMap('MP_Siege', gamemode_id='Domination0', number_of_rounds=2).thenRaise(CommandFailedError(['Full']))
        self.joe.says('!map siege')
