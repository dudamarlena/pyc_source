...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\plugins\makeroom\test_cmd_makeroom_with_delay.py
...
def test_makeroom_called_twice_within_delay(plugin, superadmin, joe):
    ...
    superadmin.says('!makeroom')
    assert [
     'There is already a makeroom request in progress. Try again later'] == superadmin.message_history
