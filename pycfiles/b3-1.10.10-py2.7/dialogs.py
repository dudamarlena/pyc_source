...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\b3\gui\dialogs.py
# Compiled at: 2016-03-08 18:42:09
import b3, b3.config, glob, imp, json, logging, os, shutil, tempfile, urllib2
...
GEOMETRY = {'nt': {'ABOUT_DIALOG_WIDTH': 400, 
          'ABOUT_DIALOG_HEIGHT': 520, 
          'LICENSE_DIALOG_WIDTH': 400, 
          'LICENSE_DIALOG_HEIGHT': 300}, 
   'darwin': {'ABOUT_DIALOG_WIDTH': 400, 
              'ABOUT_DIALOG_HEIGHT': 520, 
              'LICENSE_DIALOG_WIDTH': 400, 
              'LICENSE_DIALOG_HEIGHT': 300}, 
   'linux': {'ABOUT_DIALOG_WIDTH': 400, 
...
class AboutDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.setFixedSize(GEOMETRY[b3.getPlatform()]['ABOUT_DIALOG_WIDTH'], GEOMETRY[b3.getPlatform()]['ABOUT_DIALOG_HEIGHT'])
        self.setStyleSheet('\n        QDialog {\n            background: #F2F2F2;\n        }\n        ')
...
class LicenseDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.setFixedSize(GEOMETRY[b3.getPlatform()]['LICENSE_DIALOG_WIDTH'], GEOMETRY[b3.getPlatform()]['LICENSE_DIALOG_HEIGHT'])
        self.setStyleSheet('\n        QDialog {\n            background: #F2F2F2;\n        }\n        ')
