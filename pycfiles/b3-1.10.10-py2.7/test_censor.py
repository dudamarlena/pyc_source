...
# [GCC 8.4.0]
# Embedded file name: H:\workspaces\workspace-python\big-brother-bot\tests\plugins\test_censor.py
...
import unittest2 as unittest, b3
...
class Detection_TestCase(CensorTestCase):
    ...
    def assert_chat_is_penalized(self, text):
        ...
        try:
            ...
            if len(self.p.penalizeClient.call_args):
                return self.p.penalizeClient.call_args[0]
            return
...
class Test_Censor_badname(Detection_TestCase):
    ...
    def test_regexp(self):
        ...
        self.p._badNames = []
        self.p._add_bad_name(rulename='ass', regexp='\\b[a@][s$]{2}\\b')
...
class Test_Censor_badword_default_config(Detection_TestCase):
    ...
    def test_shit_has_custom_penalty(self):
        ...
        self.assertEqual(1440, badword_object.penalty.duration)
