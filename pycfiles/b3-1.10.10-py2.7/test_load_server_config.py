...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\plugins\poweradminbf3\test_load_server_config.py
...
class Test_load_server_config(unittest.TestCase):
    ...
    def test_comments(self):
        ...
        self.p = self.p
        client = Mock()
        self.p.load_server_config(client, 'theConfName', ('#vars.autoBalance true',
    ...
    def test_read_cvars_no_result(self):
        ...
        self.p = self.p
        client = Mock()
        self.p.load_server_config(client, 'theConfName', ('vars.withnoarg', '   vars.withnoarg',
                                                          '   vars.withnoarg    ',
                                                          'vars.withnoarg    '))
    ...
    def test_map_item(self):
        ...
        self.console.write.assert_any_call(('mapList.add', 'MAP_001', 'gamemode1',
                                            '3'))
