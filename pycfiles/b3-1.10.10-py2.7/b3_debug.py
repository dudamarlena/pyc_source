...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\b3_debug.py
# Compiled at: 2016-03-08 18:42:10
__author__ = 'GrosBedo'
__version__ = '0.8'
import b3.run, argparse
from b3_run import *
    ...
    if args.debughelp:
        ...
        if args.diagnostic:
            ...
            if len(loadmatrix) > 0:
                ...
                prestats = [
                 diag.stats_per_second(('raw merged logs', loadmatrix))[0][1]]
                del loadmatrix
                print 'Generation completed.'
            else:
            ...
            if args.diagload or args.diagstatsload:
                ...
                mergedstats = [
                 (
                  'raw merged logs', prestats[0])]
            del prestats
            if args.diagstatssave:
                if args.diagmergeonly:
