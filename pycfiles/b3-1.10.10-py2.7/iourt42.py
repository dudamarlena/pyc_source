...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\b3\plugins\poweradminurt\iourt42.py
...
class Poweradminurt42Plugin(Poweradminurt41Plugin):
    ...
    _weapons = dict(ber='F', de='G', glo='f', colt='g', spas='H', mp5='I', ump='J', mac='h', hk='K', lr='L', g36='M', psg='N', sr8='Z', ak='a', neg='c', m4='e', he='O', smo='Q', vest='R', hel='W', sil='U', las='V', med='T', nvg='S', ammo='X')
    _weapon_aliases = {'.50': 'de', 
       'eag': 'de', 
       'mp': 'mp5', 
       'sr': 'sr8', 
       '1911': 'colt', 
    ...
    def cmd_pagear(self, data, client=None, cmd=None):
        ...
        def update_gear(gear_set, param_data):
            ...
            """
            cleaned_data = re.sub('\\s', '', param_data)
        ...
        for m in re.finditer('(all|none|reset|[+-]\\s*[\\w.]+)', data.strip().lower()):
