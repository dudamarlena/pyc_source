...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\parsers\test_bf3.py
...
class Test_getServerInfo(unittest.TestCase):
    ...
    def test_decodeServerinfo_pre_R9(self):
        self.assertDictContainsSubset({'serverName': 'BigBrotherBot #2', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           ...
           'hasPassword': 'false', 
           'serverUptime': '5148', 
           'roundTime': '455'}, Bf3Parser.decodeServerinfo(('BigBrotherBot #2', '0',
                                                            '16', 'ConquestLarge0',
                                                            'MP_012', '0', '2', '0',
                                                            '0', '', 'true', 'true',
                                                            'false', '5148', '455')))
    ...
    def test_decodeServerinfo_R9(self):
        self.maxDiff = None
        self.assertDictEqual({'serverName': 'BigBrotherBot #2', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           'gamemode': 'ConquestLarge0', 
           'level': 'MP_012', 
           ...
           'region': 'EU', 
           'closestPingSite': '45', 
           'country': 'FR'}, Bf3Parser.decodeServerinfo(('BigBrotherBot #2', '0', '16',
                                                         'ConquestLarge0', 'MP_012',
                                                         '0', '2', '0', '0', '',
                                                         'true', 'true', 'false',
                                                         '5148', '455', '1.2.3.4:5445',
                                                         '1.5', 'false', 'EU', '45',
                                                         'FR')))
        self.assertDictEqual({'serverName': 'BigBrotherBot #2', 
           'numPlayers': '0', 
        ...
        self.assertDictEqual({'serverName': 'BigBrotherBot #2', 
           ...
           'country': 'FR'}, Bf3Parser.decodeServerinfo(('BigBrotherBot #2', '0', '16',
                                                         ...
                                                         '25', '84', '0', '', 'true',
                                                         'true', 'false', '5148',
                                                         '455', '1.2.3.4:5445', '1.5',
                                                         'false', 'EU', '45', 'FR')))
        return

    def test_getServerInfo_pre_R9(self):
        self.maxDiff = None
        bf3_response = ('BigBrotherBot #2', '0', '16', 'ConquestLarge0', 'MP_012',
        ...
        self.assertEqual({'serverName': 'BigBrotherBot #2', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           'gamemode': 'ConquestLarge0', 
           'level': 'MP_012', 
           ...
           'country': None}, parser.game.serverinfo)
        return

    def test_getServerInfo_R9(self):
        bf3_response = [
         'i3D.net - BigBrotherBot #3 (FR)', '0', '16', 'SquadDeathMatch0', 'MP_013',
        ...
        self.assertEqual({'serverName': 'i3D.net - BigBrotherBot #3 (FR)', 
           'numPlayers': '0', 
           'maxPlayers': '16', 
           ...
           'region': 'EU', 
           'closestPingSite': 'ams', 
           'country': 'DE'}, parser.game.serverinfo)
...
class Test_patch_b3_admin_plugin(BF3TestCase):
    ...
    def test_map_InvalidGameModeOnMap(self):
        when(self.parser).changeMap('XP4_Rubble', gamemode_id='CaptureTheFlag0', number_of_rounds=2).thenRaise(CommandFailedError(['InvalidGameModeOnMap']))
        self.joe.says('!map talah')
        self.assertListEqual([
         'Talah market cannot be played with gamemode Capture the Flag',
         'supported gamemodes are : Conquest Assault64, Conquest Assault, Rush, Squad Rush, Squad Deathmatch, Team Deathmatch, Gun master, Scavenger'], self.joe.message_history)

    def test_map_InvalidRoundsPerMap(self):
        when(self.parser).changeMap('XP4_Rubble', gamemode_id='CaptureTheFlag0', number_of_rounds=2).thenRaise(CommandFailedError(['InvalidRoundsPerMap']))
        self.joe.says('!map talah')
        self.assertListEqual(['number of rounds must be 1 or greater'], self.joe.message_history)

    def test_map_Full(self):
        when(self.parser).changeMap('XP4_Rubble', gamemode_id='CaptureTheFlag0', number_of_rounds=2).thenRaise(CommandFailedError(['Full']))
        self.joe.says('!map talah')
