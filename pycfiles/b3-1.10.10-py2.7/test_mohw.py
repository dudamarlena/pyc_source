...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\parsers\test_mohw.py
...
class Test_getServerInfo(unittest.TestCase):
    ...
    def test_decodeServerinfo(self):
        self.assertDictEqual({'serverName': 'BigBrotherBot #1 MOHW', 
           'numPlayers': '0', 
           'maxPlayers': '20', 
           ...
           'country': 'GB'}, MohwParser.decodeServerinfo([
...
class Test_events(MohwTestCase):
    ...
    def test_cmd_rotateMap_generate_EVT_GAME_ROUND_END(self):
        ...
        when(self.parser).getFullMapRotationList().thenReturn(NewMapListBlock(['4', 'CustomPL', '3', 'MP_03', 'CombatMission', '1', 'MP_05', 'BombSquad', '1', 'MP_10',
...
class Test_getGamemodeSoundingLike(MohwTestCase):
    ...
    def test_suggestions(self):
        self.assertEqual(['Team Death Match', 'Combat Mission', 'Home Run'], self.parser.getGamemodeSoundingLike('MP_12', ''))
