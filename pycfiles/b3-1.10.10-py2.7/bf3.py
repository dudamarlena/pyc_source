...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\b3\parsers\bf3.py
# Compiled at: 2016-03-08 18:42:09
import b3, b3.clients, b3.events, threading
...
MAP_NAME_BY_ID = {'MP_001': 'Grand Bazaar', 
...
GAME_MODES_BY_MAP_ID = {'MP_001': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_003': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_007': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_011': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_012': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_013': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_017': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_018': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'MP_Subway': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0'), 
   'XP1_001': ('ConquestAssaultLarge0', 'ConquestAssaultSmall0', 'ConquestAssaultSmall1', 'RushLarge0',
 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   'XP1_002': ('ConquestLarge0', 'ConquestSmall0', 'ConquestAssaultSmall0', 'RushLarge0', 'SquadRush0',
 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   'XP1_003': ('ConquestAssaultLarge0', 'ConquestAssaultSmall0', 'ConquestAssaultSmall1', 'RushLarge0',
 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   'XP1_004': ('ConquestAssaultLarge0', 'ConquestAssaultSmall0', 'ConquestAssaultSmall1', 'RushLarge0',
 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   ...
   'XP3_Desert': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'TankSuperiority0'), 
   'XP3_Alborz': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'TankSuperiority0'), 
   'XP3_Shield': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'TankSuperiority0'), 
   'XP3_Valley': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'TankSuperiority0'), 
   'XP4_Quake': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'GunMaster0', 'Scavenger0'), 
   'XP4_FD': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'GunMaster0', 'Scavenger0'), 
   'XP4_Parl': ('ConquestLarge0', 'ConquestSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'GunMaster0', 'Scavenger0'), 
   'XP4_Rubble': ('ConquestAssaultLarge0', 'ConquestAssaultSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0',
 'TeamDeathMatch0', 'GunMaster0', 'Scavenger0'), 
   'XP5_001': ('CaptureTheFlag0', 'AirSuperiority0', 'ConquestLarge0', 'ConquestAssaultLarge0', 'ConquestSmall0',
 'ConquestAssaultSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   'XP5_002': ('CaptureTheFlag0', 'AirSuperiority0', 'ConquestLarge0', 'ConquestAssaultLarge0', 'ConquestSmall0',
 'ConquestAssaultSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   'XP5_003': ('CaptureTheFlag0', 'AirSuperiority0', 'ConquestLarge0', 'ConquestAssaultLarge0', 'ConquestSmall0',
 'ConquestAssaultSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0'), 
   'XP5_004': ('CaptureTheFlag0', 'AirSuperiority0', 'ConquestLarge0', 'ConquestAssaultLarge0', 'ConquestSmall0',
 'ConquestAssaultSmall0', 'RushLarge0', 'SquadRush0', 'SquadDeathMatch0', 'TeamDeathMatch0')}
...
class Bf3Parser(AbstractParser):
    gameName = 'bf3'
    _gameServerVars = ('3dSpotting', '3pCam', 'autoBalance', 'bannerUrl', 'bulletDamage',
                       'friendlyFire', 'gameModeCounter', 'gamePassword', 'hud',
                       'idleBanRounds', 'idleTimeout', 'killCam', 'killRotation',
                       'maxPlayers', 'minimap', 'minimapSpotting', 'nameTag', 'onlySquadLeaderSpawn',
                       'playerManDownTime', 'playerRespawnTime', 'ranked', 'regenerateHealth',
                       'roundLockdownCountdown', 'roundRestartPlayerCount', 'roundStartPlayerCount',
                       'roundsPerMap', 'serverDescription', 'serverMessage', 'serverName',
                       'soldierHealth', 'teamKillCountForKick', 'teamKillKickForBan',
                       'teamKillValueDecreasePerSecond', 'teamKillValueForKick',
                       'teamKillValueIncrease', 'unlockMode', 'vehicleSpawnAllowed',
                       'vehicleSpawnDelay', 'premiumStatus', 'gunMasterWeaponsPreset')
    ...
    def checkVersion(self):
        ...
        if int(version[1]) < BF3_REQUIRED_VERSION:
            raise Exception('the BF3 parser can only work with Battlefield 3 server version %s and above. You are trying to connect to %s v%s' % (
             BF3_REQUIRED_VERSION, version[0], version[1]))
    ...
    def getClient(self, cid, guid=None):
        ...
        if not client:
            ...
            if guid:
                ...
                p = pib[0]
                if 'guid' in p:
                    client = self.clients.newClient(p['name'], guid=p['guid'], name=p['name'], team=self.getTeam(p['teamId']), teamId=int(p['teamId']), squad=p['squadId'], data=p)
                    self.queueEvent(self.getEvent('EVT_CLIENT_JOIN', data=p, client=client))
        return client
