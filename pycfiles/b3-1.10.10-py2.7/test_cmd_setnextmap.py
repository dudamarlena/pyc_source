...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\plugins\poweradminbf3\test_cmd_setnextmap.py
...
class Test_cmd_setnextmap(Bf3TestCase):
    ...
    def test_empty_list(self):
        ...
        verify(self.console).write(('mapList.add', 'MP_Subway', 'ConquestSmall0', 2,
                                    0))
