...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\core\parsers\test_iourt41.py
...
class Test_parser_API_implementation(Iourt41TestCase):
    ...
    def test_getPlayerList(self):
        ...
        self.assertDictEqual({'10': {'ip': '192.168.1.11', 'last': '0', 
                  'name': 'snowwhite', 
                  'pbid': None, 
                  'ping': '13', 
                  'port': '51034', 
    ...
    def test_getMap(self):
        ...
        """
        when(self.output_mock).write('status').thenReturn('map: ut4_casa\nnum score ping name            lastmsg  address              qport rate\n--- ----- ---- --------------- ------- --------------------- ----- -----\n12     0   10 superman         0       192.168.1.12:53039     9993 15000\n')
...
class Test_OnClientuserinfochanged(Iourt41TestCase):
    ...
    def test_ioclient(self):
        ...
        self.assertEqual('[SNT]XLR8or', client.name)
        self.assertEqual('58D4069246865BB5A85F20FB60ED6F65', client.guid)
        infoline = "2 n\\UnnamedOne\\t\\2\\r\\2\\tl\\0\\f0\\\\f1\\\\f2\\\\a0\\200\\a1\\\\0\\a2\\20'"
...
class Test_OnKill(Iourt41TestCase):
    ...
    def test_nuke(self):
        self.assertEvent('5:19 Kill: 0 0 34: Joe killed Joe by UT_MOD_NUKED', event_type='EVT_CLIENT_KILL', event_client=self.world, event_target=self.joe, event_data=(
    ...
    def test_mr_sentry(self):
        self.assertEvent('5:19 Kill: 1022 0 14: <world> killed Joe by UT_MOD_BERETTA', event_type='EVT_SENTRY_KILL', event_client=None, event_target=self.joe, event_data=None)
        return
...
class Test_misc(Iourt41TestCase):
    ...
    def test_cvarlist(self):
        when(self.console).write('cvarlist').thenReturn('cvarlist\n        g_spskill "4"\n        _B3 "B3 v1.9.0b2 [nt]"\nS R     auth_status "public"\nS R     auth "1"\nS     C g_antilagvis "0"\n     L  g_bombPlantTime "3"\nS        Admin "Courgette"\n     L  net_ip "localhost"\n    AL  com_zoneMegs "32"\n  R     sv_cheats "1"\n\n347 total cvars\n347 cvar indexes\n')
        rv = self.console.cvarList()
        self.assertDictEqual({' admin': 'Courgette', 
           '_b3': 'B3 v1.9.0b2 [nt]', 
           'auth': '1', 
           'auth_status': 'public', 
           'com_zonemegs': '32', 
    ...
    def test_parseUserInfo(self):
        self.assertDictEqual({'cid': '7', 
           ...
           'a0': '0', 
           'a1': '0', 
           'a2': '0'}, self.console.parseUserInfo('7 n\\[SNT]^1XLR^78or\\t\\3\\r\\2\\tl\\0\\f0\\\\f1\\\\f2\\\\a0\\0\\a1\\0\\a2\\0'))