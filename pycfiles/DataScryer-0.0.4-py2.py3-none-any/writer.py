...
# [GCC 8.4.0]
# Embedded file name: D:\Programmieren\dataScryer\datascryer\influxdb\writer.py
# Compiled at: 2016-09-14 04:52:52
import logging, datascryer.helper.http
...
class InfluxDBWriter:
    ...
    def create_database(self, db):
        datascryer.helper.http.post(self.url_query, 'q=' + datascryer.helper.http.quote('CREATE DATABASE ' + db))