...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/onlinelinguisticdatabase/controllers/formbackups.py
...
class FormbackupsController(BaseController):
    ...
    def index(self):
        ...
        try:
            ...
            query = h.filter_restricted_models('FormBackup', query)
