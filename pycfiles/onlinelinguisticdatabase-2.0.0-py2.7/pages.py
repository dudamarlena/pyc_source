...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/onlinelinguisticdatabase/controllers/pages.py
...
class PagesController(BaseController):
    ...
    @h.authenticate
    def search(self):
        """Return the list of page resources matching the input
        JSON query.

        :URL: ``SEARCH /pages``
          (or ``POST /pages/search``)
    ...
    @h.authenticate
    def new_search(self):
        """Return the data necessary to search the page resources.

        :URL: ``GET /pages/new_search``
