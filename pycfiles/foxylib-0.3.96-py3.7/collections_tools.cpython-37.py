...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/collections/collections_tools.py
# Compiled at: 2019-12-06 12:48:35
# Size of source mod 2**32: 36449 bytes
...
class ListPairAlign:
    ...
    def list_pair2indexes_mother(cls, mother_list, child_list):
        n = len(mother_list)
        h = merge_dicts([{mother_list[i]: i} for i in range(n)], vwrite=vwrite_no_duplicate_key)
...
class DictToolkit:
    ...
    bn_list_h_list2v_or_f_else = VersionToolkit.deprecated(func=branchname_list2lookup_h_list_or_f_default, version_current=__version__,
      version_tos='0.3')
    ...
    bn_list_h_list2v_or_else = VersionToolkit.deprecated(func=branchname_list2lookup_h_list_or_default, version_current=__version__,
      version_tos='0.3')
    ...
    tree_func_list2RnC = VersionToolkit.deprecated(func=tree_func_list2reduced_and_cleaned, version_current=__version__,
      version_tos='0.3')
