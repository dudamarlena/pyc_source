...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/entity/calendar/hms/locale/ko/hour_entity_ko.py
# Compiled at: 2020-01-28 21:10:27
...
class HourEntityKo:
    ...
    def str2entity_list(cls, str_in, config=None):
        ...
        span_ll = [
         lmap(Entity.j2span, cardinal_entity_list),
        ...
        for j1, j2 in j_tuple_list:
            ...
            span = (
             Entity.j2span(cardinal_entity)[0], MatchTool.match2span(m_suffix)[1])
