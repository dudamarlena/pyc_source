...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/regex/regex_tool.py
# Compiled at: 2020-01-29 01:42:06
...
class RegexTool:
    ...
    def pattern_str2match_full(cls, p, str_in):
        ...
        if not m:
            ...
            return m.end() == len(str_in) or None
        return m
