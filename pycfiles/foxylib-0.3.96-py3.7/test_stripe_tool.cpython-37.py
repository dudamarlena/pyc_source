...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/finance/payment/stripe/tests/test_stripe_tool.py
# Compiled at: 2020-01-22 00:25:57
...
from foxylib.tools.finance.payment.stripe.stripe_tool import StripeCharge, StripeTool, StripeCardSample, StripeToken, StripeTokenType, StripeCard, StripeAnalysis
...
class TestFoxylibStripe(TestCase):
    ...
    def test_03(self):
        ...
        def rawprice_profitratio2final(v_rawprice, ratio_profit):
            ...
            logger.debug({'v_rawprice':v_rawprice,  'ratio_profit':ratio_profit, 
             'v_stripe':v_stripe, 
