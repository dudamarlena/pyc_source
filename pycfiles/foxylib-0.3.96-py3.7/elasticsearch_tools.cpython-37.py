...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/database/elasticsearch/elasticsearch_tools.py
# Compiled at: 2019-12-01 03:44:10
# Size of source mod 2**32: 17116 bytes
import logging, os
...
class BulkToolkit:
    ...
    def j_action2op_type(cls, j):
        return j.get('_op_type', cls.op_type_default())
