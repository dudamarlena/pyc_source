...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/auth/auth0/foxylib_auth0.py
# Compiled at: 2020-01-22 23:33:12
...
class FoxylibAuth0:
    ...
    def _load_urls2app(cls, app, auth0):
        ...
        FlaskTool.add_url2app(app, (cls.V.URL_LOGIN), (partial_n_wraps(Auth0Tool.auth0_callback_url2login, auth0, cls.abspath2url(cls.V.URL_CALLBACK))),
          methods=[
         'GET'])
    ...
    def dashboard(cls):
        data = {'userinfo':session['profile'],  'userinfo_pretty':json.dumps(session['jwt_payload'], indent=2)}
