...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/foxylib/tools/compare/minimax_tool.py
...
class MinimaxTool:
    ...
    def indexes_minimax(cls, l, cmp=None):
        if cmp is None:
            cmp = lambda a, b:             if a < b:
-1 # Avoid dead code:             if a > b:
1 # Avoid dead code: 0
        i_list_min = []
        i_list_max = []
        x0 = x1 = None
