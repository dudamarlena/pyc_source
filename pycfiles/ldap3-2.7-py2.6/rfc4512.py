...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\ldap3\protocol\rfc4512.py
# Compiled at: 2020-02-23 02:01:40
"""
"""
from os import linesep
import re, json
from .oid import CLASS_ABSTRACT, CLASS_STRUCTURAL, CLASS_AUXILIARY, ATTRIBUTE_USER_APPLICATION, ATTRIBUTE_DIRECTORY_OPERATION, ATTRIBUTE_DISTRIBUTED_OPERATION, ATTRIBUTE_DSA_OPERATION
...
def constant_to_class_kind(value):
    if value == CLASS_STRUCTURAL:
        ...
        if value == CLASS_ABSTRACT:
            return 'Abstract'
        if value == CLASS_AUXILIARY:
            return 'Auxiliary'
        return '<unknown>'
...
def constant_to_attribute_usage(value):
    if value == ATTRIBUTE_USER_APPLICATION:
        ...
        if value == ATTRIBUTE_DIRECTORY_OPERATION:
            return 'Directory operation'
        if value == ATTRIBUTE_DISTRIBUTED_OPERATION:
            return 'Distributed operation'
        if value == ATTRIBUTE_DSA_OPERATION:
...
def attribute_usage_to_constant(value):
    if value == 'userApplications':
        ...
        if value == 'directoryOperation':
            return ATTRIBUTE_DIRECTORY_OPERATION
        if value == 'distributedOperation':
            return ATTRIBUTE_DISTRIBUTED_OPERATION
        if value == 'dSAOperation':
...
class MatchingRuleUseInfo(BaseObjectInfo):
    ...
    def __init__(self, oid=None, name=None, description=None, obsolete=False, apply_to=None, extensions=None, experimental=None, definition=None):
        BaseObjectInfo.__init__(self, oid=oid, name=name, description=description, obsolete=obsolete, extensions=extensions, experimental=experimental, definition=definition)
...
class ObjectClassInfo(BaseObjectInfo):
    ...
    def __init__(self, oid=None, name=None, description=None, obsolete=False, superior=None, kind=None, must_contain=None, may_contain=None, extensions=None, experimental=None, definition=None):
        BaseObjectInfo.__init__(self, oid=oid, name=name, description=description, obsolete=obsolete, extensions=extensions, experimental=experimental, definition=definition)
...
class AttributeTypeInfo(BaseObjectInfo):
    ...
    def __init__(self, oid=None, name=None, description=None, obsolete=False, superior=None, equality=None, ordering=None, substring=None, syntax=None, min_length=None, single_value=False, collective=False, no_user_modification=False, usage=None, extensions=None, experimental=None, definition=None):
        BaseObjectInfo.__init__(self, oid=oid, name=name, description=description, obsolete=obsolete, extensions=extensions, experimental=experimental, definition=definition)
        self.superior = superior
...
class DitContentRuleInfo(BaseObjectInfo):
    ...
    def __init__(self, oid=None, name=None, description=None, obsolete=False, auxiliary_classes=None, must_contain=None, may_contain=None, not_contains=None, extensions=None, experimental=None, definition=None):
        BaseObjectInfo.__init__(self, oid=oid, name=name, description=description, obsolete=obsolete, extensions=extensions, experimental=experimental, definition=definition)
...
class DitStructureRuleInfo(BaseObjectInfo):
    ...
    def __init__(self, oid=None, name=None, description=None, obsolete=False, name_form=None, superior=None, extensions=None, experimental=None, definition=None):
        BaseObjectInfo.__init__(self, oid=oid, name=name, description=description, obsolete=obsolete, extensions=extensions, experimental=experimental, definition=definition)
        self.superior = superior
...
class NameFormInfo(BaseObjectInfo):
    ...
    def __init__(self, oid=None, name=None, description=None, obsolete=False, object_class=None, must_contain=None, may_contain=None, extensions=None, experimental=None, definition=None):
        BaseObjectInfo.__init__(self, oid=oid, name=name, description=description, obsolete=obsolete, extensions=extensions, experimental=experimental, definition=definition)
