...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\ldap3\core\results.py
...
RESULT_CODES = {RESULT_SUCCESS: 'success', 
...
DO_NOT_RAISE_EXCEPTIONS = [
 RESULT_SUCCESS, RESULT_COMPARE_FALSE, RESULT_COMPARE_TRUE, RESULT_REFERRAL, RESULT_SASL_BIND_IN_PROGRESS, RESULT_SIZE_LIMIT_EXCEEDED, RESULT_TIME_LIMIT_EXCEEDED]