...
# Compiled at: 2020-03-24 04:42:13
...
class Model:
    ...
    def import_controllers(exp_name):
        ...
        for i in range(num_families):
            ...
            families.append(Family(name=str(line[1]), special=float(line[2]), size=int(line[0]), label=str(line[5]), color=str(line[3].replace(' ', '')), alpha=float(line[4])))
...
class Family:
    ...
    def __init__(self, name='none', special=0.0, size=0, label='none', color='black', alpha=1.0):
        self.name = name
