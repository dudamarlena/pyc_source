...
# Compiled at: 2020-03-11 16:25:12
# Size of source mod 2**32: 7161 bytes
import os, math
...
class Model_xd:
    ...
    def __init__(self, name):
        ...
        self.num_families, self.family_name, self.family_special, self.family_size, self.labels, self.colors, self.alphas = self.import_controllers(name)
...
class Model_2d:
    ...
    def __init__(self, name, num_winners=0, shades=False):
        ...
        if shades:
            ...
            self.shades = [1.0 for _ in range(self.num_points)]
