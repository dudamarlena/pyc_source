...
# [GCC 8.4.0]
# Embedded file name: /media/psf/Home/Documents/workspace/rqalpha-mod-vnpy/rqalpha_mod_vnpy/mod.py
...
class VNPYMod(AbstractMod):
    ...
    def start_up(self, env, mod_config):
        ...
        self._gateway = CtpGateway(env, data_cache, mod_config.temp_path, mod_config.CTP.userID, mod_config.CTP.password, mod_config.CTP.brokerID)
