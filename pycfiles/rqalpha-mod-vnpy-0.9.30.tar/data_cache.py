...
# [GCC 8.4.0]
# Embedded file name: /media/psf/Home/Documents/workspace/rqalpha-mod-vnpy/rqalpha_mod_vnpy/ctp/data_cache.py
...
class DataCache(object):
    ...
    def cache_ins(self, ins_cache):
        ...
        self._future_info_cache = {ins_dict.underlying_symbol:{'speculation': {'long_margin_ratio': ins_dict.long_margin_ratio, 'short_margin_ratio': ins_dict.short_margin_ratio, 'margin_type': ins_dict.margin_type}} for ins_dict in self._ins_cache.values()}

    def cache_commission(self, underlying_symbol, commission_dict):
        self._future_info_cache[underlying_symbol]['speculation'].update({'open_commission_ratio': commission_dict.open_ratio, 
