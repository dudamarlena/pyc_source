...
# [GCC 8.4.0]
# Embedded file name: /media/psf/Home/Documents/workspace/rqalpha-mod-vnpy/rqalpha_mod_vnpy/ctp/gateway.py
    ...
    def on_trade(self, trade_dict):
        ...
        if self._data_update_date != date.today():
            ...
            try:
                ...
                order = Order.__from_create__(trade_dict.order_book_id, trade_dict.amount, trade_dict.side, trade_dict.style, trade_dict.position_effect)
