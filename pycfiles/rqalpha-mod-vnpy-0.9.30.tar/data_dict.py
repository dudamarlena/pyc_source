...
# [GCC 8.4.0]
# Embedded file name: /media/psf/Home/Documents/workspace/rqalpha-mod-vnpy/rqalpha_mod_vnpy/ctp/data_dict.py
...
from ..vnpy import *
SIDE_REVERSE = {defineDict['THOST_FTDC_D_Buy']: SIDE.BUY, 
...
class PositionDict(DataDict):
    ...
    def __init__(self, data, ins_dict=None):
        ...
        self.buy_transaction_cost = 0.0
        self.buy_realized_pnl = 0.0
        self.buy_avg_open_price = 0.0
        self.sell_old_quantity = 0
        self.sell_quantity = 0
        self.sell_today_quantity = 0
        self.sell_transaction_cost = 0.0
        self.sell_realized_pnl = 0.0
        self.sell_avg_open_price = 0.0
        self.prev_settle_price = 0.0
        self.buy_open_cost = 0.0
        self.sell_open_cost = 0.0
...
class OrderDict(DataDict):
    ...
    def update_data(self, data, rejected=False):
        ...
        elif data['CombOffsetFlag'] == defineDict['THOST_FTDC_OF_Open']:
            self.position_effect = POSITION_EFFECT.OPEN
        else:
            self.position_effect = POSITION_EFFECT.CLOSE
        if rejected:
    ...
    def update_data(self, data):
        ...
        if self.exchange_id == 'SHFE':
            if data['OffsetFlag'] == defineDict['THOST_FTDC_OF_Open']:
                ...
                self.position_effect = POSITION_EFFECT.CLOSE
        elif data['OffsetFlag'] == defineDict['THOST_FTDC_OF_Open']:
            self.position_effect = POSITION_EFFECT.OPEN
        else:
            self.position_effect = POSITION_EFFECT.CLOSE
