...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\rbtools\utils\commands.py
...
def get_review_request(review_request_id, api_root, **kwargs):
    ...
    try:
        review_request = api_root.get_review_request(review_request_id=review_request_id, **kwargs)
