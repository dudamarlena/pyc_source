...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\rbtools\commands\main_org.py
# Compiled at: 2017-05-08 09:56:26
...
def help(args, parser):
    if args:
        ep = pkg_resources.get_entry_info(b'rbtools', b'rbtools_commands', args[0])
        if ep:
...
def main():
    ...
    if command_name == b'help':
        ...
        ep = pkg_resources.get_entry_info(b'rbtools', b'rbtools_commands', command_name)
        if not ep:
            try:
