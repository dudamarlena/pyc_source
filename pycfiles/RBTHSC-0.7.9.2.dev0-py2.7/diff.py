...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\rbtools\commands\diff.py
...
class Diff(Command):
    ...
    def main(self, *args):
        ...
        diff_info = tool.diff(revisions=revisions, include_files=self.options.include_files or [], exclude_patterns=self.options.exclude_patterns or [], extra_args=extra_args)
