...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\rbtools\commands\patch.py
...
class Patch(Command):
    ...
    def main(self, request_id):
        ...
        if success and (self.options.commit or self.options.commit_no_edit):
            try:
            ...
            try:
                tool.create_commit(message, author, not self.options.commit_no_edit)
