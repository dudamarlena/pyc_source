...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\rbtools\api\resource.py
...
class ResourceLinkField(ResourceDictField):
    ...
    @request_method_decorator
    def get(self):
        return HttpRequest(self._fields[b'href'])
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.root'] = RootResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.diffs'] = DiffListResource
...
class DiffResource(ItemResource):
    ...
    def get_patch(self, **kwargs):
        ...
        request.headers[b'Accept'] = b'text/x-patch'
        return request


RESOURCE_MAP[b'application/vnd.reviewboard.org.diff'] = DiffResource
...
class FileDiffResource(ItemResource):
    ...
    def get_diff_data(self, **kwargs):
        ...
        request = HttpRequest(self._url, query_args=kwargs)
        request.headers[b'Accept'] = b'application/vnd.reviewboard.org.diff.data+json'
        return request


RESOURCE_MAP[b'application/vnd.reviewboard.org.file'] = FileDiffResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.file-attachments'] = FileAttachmentListResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.draft-file-attachments'] = DraftFileAttachmentListResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.screenshots'] = ScreenshotListResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.draft-screenshots'] = DraftScreenshotListResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.review-request'] = ReviewRequestResource
...
RESOURCE_MAP[b'application/vnd.reviewboard.org.diff-validation'] = ValidateDiffResource