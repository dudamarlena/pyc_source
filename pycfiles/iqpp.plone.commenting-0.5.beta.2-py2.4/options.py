...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.10.1-i386/egg/iqpp/plone/commenting/adapters/options.py
# Compiled at: 2007-10-06 12:26:56
...
class CommentingOptions(object):
    ...
    def __init__(self, context):
        ...
        if options is None:
            options = annotations[KEY] = {'options': PersistentDict(), 'overrides': PersistentList()}
