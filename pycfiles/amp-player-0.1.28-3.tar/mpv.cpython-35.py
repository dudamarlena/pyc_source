...
# Size of source mod 2**32: 23868 bytes
from ctypes import *
...
class ErrorCode:
    __doc__ = " For documentation on these, see mpv's libmpv/client.h "
    SUCCESS = 0
    EVENT_QUEUE_FULL = -1
    NOMEM = -2
    UNINITIALIZED = -3
...
class MPV:
    __doc__ = ' See man mpv(1) for the details of the implemented commands. '
...
ALL_PROPERTIES = {'osd-level': (int, 'rw'), 
 'osd-scale': (float, 'rw'), 
 'loop': (str, 'rw'), 
 'loop-file': (str, 'rw'), 
 'speed': (float, 'rw'), 
