...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/autobahntestsuite/case/case12_x_x.py
...
WS_COMPRESSION_TESTDATA = {'gutenberg_faust': {'desc': "Human readable text, Goethe's Faust I (German)", 'url': 'http://www.gutenberg.org/cache/epub/2229/pg2229.txt', 
                       'file': 'pg2229.txt', 
                       'binary': True}, 
   'lena512': {'desc': 'Lena Picture, Bitmap 512x512 bw', 'url': 'http://www.ece.rice.edu/~wakin/images/lena512.bmp', 
               'file': 'lena512.bmp', 
               'binary': True}, 
   'ooms': {'desc': 'A larger PDF', 'url': 'http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.105.5439', 
            'file': '10.1.1.105.5439.pdf', 
            'binary': True}, 
   'json_data1': {'desc': 'Large JSON data file', 'url': None, 
                  'file': 'data1.json', 
                  'binary': False}, 
   'html_data1': {'desc': 'Large HTML file', 'url': None, 
                  'file': 'data1.html', 
                  'binary': False}}
WS_COMPRESSION_TESTDATA_KEYS = [
 'json_data1', 'lena512', 'gutenberg_faust', 'html_data1', 'ooms']
