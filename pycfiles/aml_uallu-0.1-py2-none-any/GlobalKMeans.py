...
# Embedded file name: /usr/lib/python2.7/site-packages/amltlearn/cluster/GlobalKMeans.py
# Compiled at: 2016-09-16 07:18:54
...
class GlobalKMeans(BaseEstimator, ClusterMixin, TransformerMixin):
    ...
    def _fit_process(self, X):
        ...
        return (
         bestkm.cluster_centers_, bestkm.labels_, bestkm.inertia_)
