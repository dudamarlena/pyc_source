...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/gizmo/templatetags/gizmo_inclusion_tags.py
...
def gizmos(parser, token):
    ...
    try:
        ...
        raise template.TemplateSyntaxError('filter_menu tag requires 1                 argument (slot_name), %s given' % (len(token.split_contents()) - 1))
