...
# Embedded file name: /Users/sanhehu/Documents/GitHub/constant2-project/constant2/pkg/pytest.py
...
class approx(object):
    ...
    def expected(self):
        ...
        if isinstance(self._expected, Iterable):
            ...
            return [
             approx_non_iter(self._expected)]
...
class ApproxNonIterable(object):
    ...
    def tolerance(self):
        ...
        relative_tolerance = set_default(self.rel, 1e-06) * abs(self.expected)
...
if __name__ == '__main__':
    assert 1.0 == approx(1.000001, 0.001)
    assert [1.0] == approx([1.000001], 0.001)