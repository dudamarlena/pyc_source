...
# [GCC 8.4.0]
# Embedded file name: /home/aromanovich/carcade_dist/tests/environments_test.py
# Compiled at: 2013-01-23 13:10:25
...
class Jinja2EnvironmentTest(unittest.TestCase):
    ...
    def test_webassets_integration(self):
        ...
        self.assertRaises(TemplateSyntaxError, jinja2_env.from_string, template)
