...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cert_issuer/helpers.py
# Compiled at: 2018-12-05 14:02:34
# Size of source mod 2**32: 4136 bytes
import collections, logging, os, shutil, glob2
...
def prepare_issuance_batch(unsigned_certs_dir, signed_certs_dir, blockchain_certs_dir, work_dir, file_extension=JSON_EXT):
    ...
    for filename, (uid,) in sorted(matches):
        certificate_metadata = CertificateMetadata(uid=uid, unsigned_certs_dir=unsigned_certs_work_dir,
