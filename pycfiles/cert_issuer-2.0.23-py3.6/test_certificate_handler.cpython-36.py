...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_certificate_handler.py
# Compiled at: 2019-06-10 10:01:36
# Size of source mod 2**32: 9743 bytes
import unittest, mock, json, io
...
class TestCertificateHandler(unittest.TestCase):
    ...
    def _proof_helper(self, chain):
        proof = {'merkleRoot':'0932f1d2e98219f7d7452801e2b64ebd9e5c005539db12d9b1ddabe7834d9044', 
         'type':[
          'MerkleProof2017', 'Extension'], 
         'targetHash':ANY, 
         'anchors':[
          {'sourceId':ANY, 
        ...
        proof_1 = {'merkleRoot':'0932f1d2e98219f7d7452801e2b64ebd9e5c005539db12d9b1ddabe7834d9044', 
         'type':[
          'MerkleProof2017', 'Extension'], 
         'targetHash':ANY, 
         'anchors':[
         ...
         'proof':[
          ...
          {'right': '4e07408562bedb8b60ce05c1decfe3ad16b72230967de01f640b7e4729b49fce'}]}
        proof_2 = {'merkleRoot':'0932f1d2e98219f7d7452801e2b64ebd9e5c005539db12d9b1ddabe7834d9044', 
         'type':[
          'MerkleProof2017', 'Extension'], 
         'targetHash':ANY, 
         'anchors':[
    ...
    def _helper_mock_call(self, *args):
        ...
        assert args == ('/unsigned_certificates_dir', '/signed_certificates_dir', '/blockchain_certificates_dir',
                        '/work_dir')
        return helper_mock
    ...
    def _get_certificate_batch_web_handler(self):
        ...
        handler = CertificateBatchWebHandler(secret_manager=secret_manager,
          certificate_handler=(DummyCertificateHandler()),
          merkle_tree=(MerkleTreeGenerator()))
        return (
         handler, certificates_to_issue)
    ...
    def _get_certificate_batch_handler(self):
        ...
        certificates_to_issue['2'] = mock.Mock()
        certificates_to_issue['3'] = mock.Mock()
        handler = CertificateBatchHandler(secret_manager=secret_manager,
          certificate_handler=(DummyCertificateHandler()),
          merkle_tree=(MerkleTreeGenerator()))
        return (
         handler, certificates_to_issue)
    ...
    def test_batch_web_handler_finish_batch(self):
        ...
        with patch.object(DummyCertificateHandler, 'add_proof', return_value={'cert': 'cert'}) as (mock_method):
            result = certificate_batch_handler.finish_batch('5604f0c442922b5db54b69f8f363b3eac67835d36a006b98e8727f83b6a830c0', chain)
    ...
    def test_add_proof(self, mock_open):
        ...
        with patch.object(CertificateV2Handler,
          '_get_certificate_to_issue', return_value=cert_to_issue) as (mock_method):
