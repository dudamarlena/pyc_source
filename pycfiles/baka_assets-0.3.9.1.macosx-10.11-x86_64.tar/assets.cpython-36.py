...
# [GCC 8.4.0]
# Embedded file name: /Volumes/RAID1/KERJAAN/experiment/python/pyramid/framework/hachibushu/ryouma/env3/lib/python3.6/site-packages/baka_assets/assets.py
# Compiled at: 2017-05-01 00:08:47
...
def includeme(config):
    ...
    config.add_static_view((settings.get('static_assets', 'static')), '{egg}:public'.format(egg=use),
      cache_max_age=3600)
    config.add_cache_buster('public', QueryStringConstantCacheBuster(str(int(time.time()))))