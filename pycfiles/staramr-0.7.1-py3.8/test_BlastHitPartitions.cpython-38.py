...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/tests/unit/blast/results/test_BlastHitPartitions.py
...
class BlastHitPartitionsTest(unittest.TestCase):
    ...
    def testSinglePartitionIdenticalHits(self):
        ...
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
    ...
    def testSinglePartitionIdenticalHitsMinusStrand(self):
        ...
        self.assertEqual(2, len(return_list[0]), 'Should be two hits')
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([10, 10], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([1, 1], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testSinglePartitionSameLocationOppositeStrands(self):
        ...
        self.assertEqual(2, len(return_list[0]), 'Should be two hits')
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([10, 1], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([1, 10], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testSinglePartitionHitEndGreaterMinus(self):
        ...
        self.assertEqual(2, len(return_list[0]), 'Should be two hits')
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([1, 11], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([10, 1], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testSinglePartitionHitEndGreaterStartGreaterMinus(self):
        ...
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([1, 11], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([10, 2], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testSinglePartitionHitEndLesserMinus(self):
        ...
        self.assertEqual(2, len(return_list[0]), 'Should be two hits')
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([1, 9], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([10, 1], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testSinglePartitionHitEndLesserStartLesserMinus(self):
        ...
        self.assertEqual(2, len(return_list[0]), 'Should be two hits')
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([2, 9], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([10, 1], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testSinglePartitionHitEndGreaterStartLesserMinus(self):
        ...
        self.assertEqual(2, len(return_list[0]), 'Should be two hits')
        self.assertEqual(['contig1', 'contig1'], [x.get_genome_contig_id() for x in return_list[0]], 'Should have correct contig names')
        self.assertEqual([2, 11], [x.get_genome_contig_start() for x in return_list[0]], 'Should have correct contig starts')
        self.assertEqual([10, 1], [x.get_genome_contig_end() for x in return_list[0]], 'Should have correct contig ends')
    ...
    def testTwoPartitionsHit2EdgeHit1GreaterMinus(self):
        ...
        self.assertEqual(1, len(return_list[1]), 'Partition 2 should have 1 hit')
        self.assertEqual(['contig1'], [x.get_genome_contig_id() for x in return_list[1]], 'Should have correct contig names')
        self.assertEqual([15], [x.get_genome_contig_start() for x in return_list[1]], 'Should have correct contig starts')
