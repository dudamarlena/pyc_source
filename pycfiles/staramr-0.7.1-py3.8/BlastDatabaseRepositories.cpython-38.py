...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/databases/BlastDatabaseRepositories.py
...
class BlastDatabaseRepositories:
    ...
    def register_database_repository(self, database_name: str, git_repository_url: str) -> None:
        ...
        if self._is_dist:
            database_repository = BlastDatabaseRepositoryStripGitDir(self._database_dir, database_name, git_repository_url)
        elif database_name in self._database_repositories:
    ...
    def create_default_repositories(cls, root_database_dir: str, is_dist: bool=False):
        ...
        repos.register_database_repository('pointfinder', 'https://bitbucket.org/genomicepidemiology/pointfinder_db.git')
        repos.register_database_repository('plasmidfinder', 'https://bitbucket.org/genomicepidemiology/plasmidfinder_db.git')
        return repos
