...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/blast/JobHandler.py
# Compiled at: 2019-12-17 17:26:02
# Size of source mod 2**32: 10767 bytes
import logging, os, re, subprocess, math
from concurrent.futures import ThreadPoolExecutor
from os import path
from typing import Dict, List
from Bio.Blast.Applications import NcbiblastnCommandline
import staramr.blast.AbstractBlastDatabase as AbstractBlastDatabase
import staramr.exceptions.BlastProcessError as BlastProcessError
logger = logging.getLogger('JobHandler')

class JobHandler:
    BLAST_COLUMNS = [x.strip() for x in '\n    qseqid\n    sseqid\n    pident\n    length\n    qstart\n    qend\n    sstart\n    send\n    slen\n    qlen\n    sstrand\n    sseq\n    qseq\n    '.strip().split('\n')]

    def __init__(self, blast_database_objects_map: Dict[(str, AbstractBlastDatabase)], threads: int, output_directory: str) -> None:
        """
    ...
    def _schedule_blast(self, file, blast_database):
        ...
        for database_name in database_names:
            ...
            blast_out = os.path.join(self._output_directory, file_name + '.' + database_name + '.' + blast_database.get_name() + '.blast.tsv')
    ...
    def get_mlst_version(self) -> str:
        return self._get_mlst_version(self)
