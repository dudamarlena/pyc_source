...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/tests/unit/blast/pointfinder/test_PointfinderDatabaseInfo.py
    ...
    def setUp(self):
        pandas_pointfinder_table = pd.DataFrame([
         ...
         [
          ...
          columns=('#Gene_ID', 'Gene_name', 'No of mutations needed', 'Codon_pos',
                   'Ref_nuc', 'Ref_codon', 'Res_codon', 'Resistance', 'PMID'))
