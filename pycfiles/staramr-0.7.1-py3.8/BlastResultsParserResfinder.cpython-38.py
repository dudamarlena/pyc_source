...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/blast/results/resfinder/BlastResultsParserResfinder.py
...
import staramr.blast.results.resfinder.ResfinderHitHSP as ResfinderHitHSP
