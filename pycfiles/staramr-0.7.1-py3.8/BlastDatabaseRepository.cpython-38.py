...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/databases/BlastDatabaseRepository.py
# Compiled at: 2019-12-17 17:26:02
# Size of source mod 2**32: 7947 bytes
import configparser, logging, shutil, time
...
class BlastDatabaseRepository:
    ...
    def info(self) -> Dict[(str, str)]:
        ...
        try:
            ...
            data[self._get_info_name('date')] = time.strftime(self.TIME_FORMAT, time.gmtime(repo_head.committed_date))
