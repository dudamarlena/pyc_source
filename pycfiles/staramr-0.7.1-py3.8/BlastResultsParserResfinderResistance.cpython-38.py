...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/blast/results/resfinder/BlastResultsParserResfinderResistance.py
...
class BlastResultsParserResfinderResistance(BlastResultsParserResfinder):
    ...
    def _get_result_rows(self, hit, database_name):
        drug = self._arg_drug_table.get_drug(database_name, hit.get_amr_gene_name_with_variant(), hit.get_amr_gene_accession())
        if drug is None:
