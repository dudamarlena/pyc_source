...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/blast/results/pointfinder/codon/CodonMutationPosition.py
# Compiled at: 2019-12-17 17:26:02
# Size of source mod 2**32: 4041 bytes
import math, Bio.Seq
...
class CodonMutationPosition(MutationPosition):
    ...
    def get_mutation_string(self):
        return self.get_database_amr_gene_codon() + ' -> ' + self.get_input_genome_codon() + ' (' + self.get_database_amr_gene_amino_acid() + ' -> ' + self.get_input_genome_amino_acid() + ')'
    ...
    def __repr__(self):
        return ('CodonMutationPosition(_database_amr_gene_start={_database_amr_gene_start}, _nucleotide_position_amr_gene={_nucleotide_position_amr_gene}, _codon_start={_codon_start}, _database_amr_gene_codon={_database_amr_gene_codon}, _input_genome_codon={_input_genome_codon})'.format)(**self.__dict__)