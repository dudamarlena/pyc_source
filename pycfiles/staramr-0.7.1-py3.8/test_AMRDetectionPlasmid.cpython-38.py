...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/tests/integration/detection/test_AMRDetectionPlasmid.py
...
class AMRDetectionPlasmid(unittest.TestCase):
    ...
    def testPlasmidfinderNameSuccess(self):
        ...
        self.assertEqual(expected_records['IncW_1__EF633507'].seq, records['IncW_1__EF633507'].seq, "records don't match")
    ...
    def testDetailedSummary_ResPlasmid(self):
        ...
        self.assertAlmostEqual((plasmid_type['%Identity'].iloc[0]), 100.0, places=2, msg='Wrong pid')
        self.assertAlmostEqual((plasmid_type['%Overlap'].iloc[0]), 100.0, places=2, msg='Wrong overlap')
        ...
        self.assertAlmostEqual((res_type['%Identity'].iloc[0]), 100.0, places=2, msg='Wrong pid')
        self.assertAlmostEqual((res_type['%Overlap'].iloc[0]), 100.0, places=2, msg='Wrong overlap')
    ...
    def testResistancePlasmidGenesSummary(self):
        ...
        self.assertEqual(len(result.index), 1, 'Wrong number of results detected')
        self.assertEqual((result['Predicted Phenotype'].iloc[0]), 'ampicillin, amoxicillin/clavulanic acid, cefoxitin, ceftriaxone, meropenem',
