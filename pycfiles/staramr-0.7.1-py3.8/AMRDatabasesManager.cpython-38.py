...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staramr/databases/AMRDatabasesManager.py
...
class AMRDatabasesManager:
    DEFAULT_COMMITS = {'resfinder':'e8f1eb2585cd9610c4034a54ce7fc4f93aa95535', 
    ...
    def setup_default(self):
        ...
        if path.exists(self._git_strip_database_dir):
            ...
            database_repos = BlastDatabaseRepositories.create_default_repositories((self._git_strip_database_dir), is_dist=True)
