...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/formatters/excel.py
...
headstyle = Style(font=Font(name='Courier', size=11, bold=True), fill=PatternFill(fill_type=fills.FILL_SOLID, start_color=headcolor, end_color=headcolor), border=Border(top=Side(border_style=borders.BORDER_THICK), bottom=Side(border_style=borders.BORDER_THICK)))
oddstyle = Style(font=Font(name='Courier', size=11), fill=PatternFill(fill_type=fills.FILL_SOLID, start_color=oddcolor, end_color=oddcolor))
evenstyle = Style(font=Font(name='Courier', size=11), fill=PatternFill(fill_type=fills.FILL_SOLID, start_color=evencolor, end_color=evencolor))
linestyle = [
 oddstyle, evenstyle]
