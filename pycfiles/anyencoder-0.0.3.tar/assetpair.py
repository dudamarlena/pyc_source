...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/core/assetpair.py
...
class AssetPair(object):
    ...
    def to_dictionary(self):
        return {'first': self.first.to_dictionary(), 
           'second': self.second.to_dictionary()}

    @classmethod
    def from_dictionary(cls, dictionary):
        return cls(AssetAmount(dictionary['first']['amount'], dictionary['first']['type']), AssetAmount(dictionary['second']['amount'], dictionary['second']['type']))
    ...
    def proportional_downscale(self, first=None, second=None):
        ...
        """
        if first:
            return AssetPair(AssetAmount(first, self.first.asset_id), AssetAmount(long(self.price.amount * first), self.second.asset_id))
        if second:
            return AssetPair(AssetAmount(long(second / self.price.amount), self.first.asset_id), AssetAmount(second, self.second.asset_id))
