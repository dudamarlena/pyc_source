...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/../pyipv8/ipv8/attestation/wallet/bonehexact/structs.py
# Compiled at: 2019-06-07 08:10:38
from __future__ import absolute_import
import struct
from .cryptosystem.value import FP2Value
__all__ = [
 'pack_pair', 'unpack_pair', 'BonehPublicKey', 'BonehPrivateKey', 'BitPairAttestation', 'Attestation']
...
def _unpack(s):
    ...
    return (
     _str_to_num(s[1 + llen:llen + l + 1]), s[llen + l + 1:])
...
class BitPairAttestation(object):
    ...
    def serialize(self):
        return _pack(self.a.a) + _pack(self.a.b) + _pack(self.b.a) + _pack(self.b.b) + _pack(self.complement.a) + _pack(self.complement.b)
