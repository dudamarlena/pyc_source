...
# Embedded file name: /Users/martijndevos/Documents/anydex-core/anydex/../pyipv8/ipv8/attestation/wallet/bonehexact/cryptosystem/boneh.py
...
def generate_keypair(key_size=32):
    ...
    h = u.intpow(t2)
    return (
     BonehPublicKey(p, g, h), BonehPrivateKey(p, g, h, t1 * t2, t1))
