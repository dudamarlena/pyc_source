...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/minimatic/jsmin.py
# Compiled at: 2010-01-19 04:46:15
...
class JavascriptMinify(object):
 ...
 L. 101       116  LOAD_FAST             0  'self'
              119  LOAD_ATTR             0  '_get'
              122  CALL_FUNCTION_0       0  None
              125  STORE_FAST            1  'c'

 L. 102       128  SETUP_LOOP           99  'to 230'

 L. 103       131  LOAD_FAST             0  'self'
              134  LOAD_ATTR             0  '_get'
              137  CALL_FUNCTION_0       0  None
              140  STORE_FAST            1  'c'

 L. 104       143  LOAD_FAST             1  'c'
              146  LOAD_CONST               '*'
              149  COMPARE_OP            2  ==
 ...
 L. 106       175  LOAD_FAST             0  'self'
              178  LOAD_ATTR             0  '_get'
              181  CALL_FUNCTION_0       0  None
              184  POP_TOP          

 L. 107       185  LOAD_CONST               ' '
              188  RETURN_END_IF    
 ...
 L. 108       197  LOAD_FAST             1  'c'
              200  LOAD_CONST               '\x00'
              203  COMPARE_OP            2  ==
              206  JUMP_IF_FALSE        13  'to 222'
              209  POP_TOP          

 L. 109       210  LOAD_GLOBAL           2  'UnterminatedComment'
