...
# Compiled at: 2019-03-01 06:12:14
    ...
    if version:
        ...
        try:
            ...
            if size > 107374182400:
                sys.exit(('Total size: {}. Code size too large to sync, please keep it under 100GB.If you have data files in the current directory, please upload them separately using "russell data" command and remove them from here.\n').format(sizeof_fmt(size)))
