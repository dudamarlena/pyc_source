...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/russell/manager/data_config.py
...
class DataModuleConfig(BaseModel):
    ...
    def __init__(self, name, dataset_id, ignore_copy_list=None, old_module_id=None, version=1, family_id=None, data_predecessor=None):
        self.name = name
...
class DataConfigManager(object):
    ...
    def set_config(cls, data_config):
        russell_logger.debug(('Setting {} in the file {}').format(data_config.to_dict(), cls.CONFIG_FILE_PATH))
