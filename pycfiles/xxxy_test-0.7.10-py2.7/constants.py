...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/russell/constants.py
...
ENV_LIST = [
 'tensorflow', 'tensorflow:py2', 'tensorflow-1.0', 'tensorflow-1.0:py2', 'theano', 'theano:py2', 'keras',
