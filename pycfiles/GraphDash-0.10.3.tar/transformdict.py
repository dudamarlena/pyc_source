...
# [GCC 8.4.0]
# Embedded file name: graphdash/struct/transformdict.py
# Compiled at: 2019-04-25 09:26:58
"""
TransformDict recipe, straight from PEP455:
...
class TransformDict(MutableMapping):
    ...
    >>> d = TransformDict(lambda s: s.lower())
    >>> d['Foo'] = 5
    >>> d['foo'] == d['FOO'] == d['Foo'] == 5
    True
    >>> set(d.keys())
    ...
    def __getstate__(self):
        return (
         self._transform, self._data, self._original)
