...
# [GCC 8.4.0]
# Embedded file name: /Users/leland/PycharmProjects/pynndescent/pynndescent/tests/test_rank.py
...
def test_large_int():
    data = np.array([1152921504606846976, 1152921504606846977], dtype=(np.uint64))
    r = rankdata(data)
    assert_array_equal(r, [1.0, 2.0])
    data = np.array([1152921504606846976, 1152921504606846977], dtype=(np.int64))
    r = rankdata(data)
    assert_array_equal(r, [1.0, 2.0])
    data = np.array([1152921504606846976, -1152921504606846975], dtype=(np.int64))
    r = rankdata(data)
