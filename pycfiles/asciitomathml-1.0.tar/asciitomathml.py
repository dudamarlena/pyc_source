...
# [GCC 8.4.0]
# Embedded file name: /Users/cejohnsonlouisville/Dropbox/asciimathpython-asciimath/asciitomathml/asciitomathml.py
# Compiled at: 2013-05-11 09:59:54
import re, sys, copy
...
class AsciiMathML:
    ...
    def _end_elements(self):
        ...
        if self._append_el.tag == 'mover' and self._append_el.get('class') == 'stackrel' and len(self._append_el) == 2:
            self._end_stackrel()
        elif (self._append_el.tag == 'mover' or self._append_el.tag == 'munder') and self._append_el.get('class') in self.under_over_base_last and len(self._append_el) > 0:
            ...
            self._end_root()
        elif (self._append_el.tag == 'mfrac' or self._append_el.tag == 'msup' or self._append_el.tag == 'msub' or self._append_el.tag == 'munder' or self._append_el.tag == 'mover') and len(self._append_el) == 2:
            self._end_2_child()
        elif (self._append_el.tag == 'msubsup' or self._append_el.tag == 'munderover') and len(self._append_el) == 3:
