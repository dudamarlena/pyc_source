...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyramid_fullauth/views/basic/register.py
...
@view_defaults(route_name='register', permission=NO_PERMISSION_REQUIRED, renderer='pyramid_fullauth:resources/templates/register.mako')
