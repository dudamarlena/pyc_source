...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/widgets/library/manager.py
# Compiled at: 2020-01-16 21:52:29
# Size of source mod 2**32: 13626 bytes
"""
    ...
    def get_folder_data_instance(self):
        ...
        if not self.settings:
            ...
            if not self.name:
                ...
                data_type or tpQtLib.logger.warning('Impossible to instantiate Data Folder because given Data Type: {} is not valid!'.format(data_type))
                return
