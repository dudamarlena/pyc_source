...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/__init__.py
...
def init(do_reload=False, dev=False):
    ...
    class tpQtLib(importer.Importer):
        ...
        def __init__(self, *args, **kwargs):
            (super(tpQtLib, self).__init__)(args, module_name='tpQtLib', **kwargs)
    ...
    tpqtlib_importer.import_packages(only_packages=True, skip_modules=['tpQtLib.externals'], order=[
     'tpQtLib.core', 'tpQtLib.widgets'])
    if do_reload:
