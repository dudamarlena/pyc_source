...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/widgets/buttons.py
...
class ButtonIcons(QAbstractButton):
    ...
    def set_icons(self, icons, colors=None, size=None, color_offset=None, icon_scaling=None, tint_composition=QPainter.CompositionMode_Plus, grayscale=False):
        if size is not None:
    ...
    def update_icons(self):
        ...
        self.idleIcon = icon.colorize_layered_icon(icons=(self.icons),
          size=(self.iconSize().width()),
          icon_scaling=(self.iconScaling),
          tint_composition=(self.tintComposition),
          colors=(self.iconColors),
          grayscale=(self.grayscale))
        self.hoverIcon = icon.colorize_layered_icon(icons=(self.icons),
          size=(self.iconSize().width()),
          icon_scaling=(self.iconScaling),
          tint_composition=(self.tintComposition),
...
class BaseMenuButton(QPushButton, ButtonIcons):
    ...
    def get_menu(self, mouse_menu=Qt.LeftButton, searchable=False, auto_create=True):
        if self._click_menu[mouse_menu] is None:
            if auto_create:
    ...
    def addAction(self, name, mouse_menu=Qt.LeftButton, connect=None, checkable=False, checked=True, action=None, icon=None):
