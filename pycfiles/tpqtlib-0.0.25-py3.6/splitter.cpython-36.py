...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/widgets/splitter.py
# Compiled at: 2020-01-16 21:52:29
# Size of source mod 2**32: 5250 bytes
...
class CollapsibleSplitterButton(buttons.HoverButton, object):
    ...
    def __init__(self, icon=None, hover_icon=None, pressed_icon=None, parent=None):
        super(CollapsibleSplitterButton, self).__init__(icon=icon,
          hover_icon=hover_icon,
          pressed_icon=pressed_icon,
          parent=parent)
...
class CollapsibleSplitterHandle(QSplitterHandle, object):
    ...
    def __init__(self, orientation, parent):
        ...
        self.expand_btn = CollapsibleSplitterButton(icon=expand_icon,
        ...
        self.collapse_btn = CollapsibleSplitterButton(icon=collapse_icon,
