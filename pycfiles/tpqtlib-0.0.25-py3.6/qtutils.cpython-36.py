...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/core/qtutils.py
# Compiled at: 2020-01-16 21:52:29
# Size of source mod 2**32: 44892 bytes
import os, re, sys, inspect, subprocess, contextlib
    ...
    if mode == 'common':
        ...
        if mode == 'button':
            if not destroy:
                ...
                button.setStyleSheet('QPushButton{background-color: ' + bg_hex + '; color:  ' + text_hex + ' ; border: black 0px}' + 'QPushButton:hover{background-color: ' + hv_hex + '; color:  ' + text_hex + ' ; border: black 0px}' + 'QPushButton:pressed{background-color: ' + hi_hex + '; color: ' + text_hex + '; border: black 2px}')
        elif mode == 'window':
            button.setStyleSheet('color: ' + text_hex + ';' + 'background-color: ' + bg_hex + ';' + 'selection-color: ' + ht_hex + ';' + 'selection-background-color: ' + hb_hex + ';')


def change_border_style(btn):
    btn.setStyleSheet('QPushButton{border-style:solid; border-width: 2px; border-color: red ; border-radius: 1px;}QPushButton:hover{border-style:solid; border-width: 2px; border-color: red ; border-radius: 1px;}QPushButton:pressed{border-style:solid; border-width: 2px; border-color: red ; border-radius: 1px;}')
