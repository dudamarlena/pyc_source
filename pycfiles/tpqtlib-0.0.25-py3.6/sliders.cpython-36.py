...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/widgets/sliders.py
# Compiled at: 2020-01-16 21:52:29
# Size of source mod 2**32: 34345 bytes
"""
        ...
        if event.button() == Qt.MidButton:
            if not self._draggers:
                ...
                if self._is_float:
                    ...
                    self._draggers.move(self.mapToGlobal(QPoint(event.pos().x() - 1, event.pos().y() - (self._draggers.height() - self._draggers.height() / 6))))
