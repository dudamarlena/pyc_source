...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpQtLib/widgets/splitters.py
...
class Splitter(QWidget, object):
    ...
    def __init__(self, text=None, shadow=False, color=(150, 150, 150)):
        ...
        style_sheet = 'border:0px solid rgba(0,0,0,0);                       background-color: %s;                       line-height: 1px;                       %s' % (main_color, bottom_border)
