...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mongodb_tool.py
# Compiled at: 2012-12-24 17:50:55
...
def get_connection(host='localhost', port=27017, max_pool_size=10, network_timeout=None, tz_aware=False):
    return pymongo.Connection(host=host, port=port, max_pool_size=max_pool_size, network_timeout=network_timeout, document_class=dict, tz_aware=tz_aware, _connect=False)
