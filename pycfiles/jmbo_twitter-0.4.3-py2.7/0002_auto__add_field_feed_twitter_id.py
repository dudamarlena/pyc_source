...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-twitter/jmbo_twitter/migrations/0002_auto__add_field_feed_twitter_id.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('jmbo_twitter_feed', 'twitter_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

    def backwards(self, orm):
        db.delete_column('jmbo_twitter_feed', 'twitter_id')
    ...
    models = {'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
       ...
       'jmbo_twitter.feed': {'Meta': {'ordering': "('-created',)", 'object_name': 'Feed', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
       ...
       'jmbo_twitter.status': {'Meta': {'ordering': "('-created',)", 'object_name': 'Status', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                               'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
