...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-twitter/jmbo_twitter/migrations/0003_auto__add_search.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('jmbo_twitter_search', (
         (
          'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
         (
          'criteria', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))))
        db.send_create_signal('jmbo_twitter', ['Search'])

    def backwards(self, orm):
        db.delete_table('jmbo_twitter_search')
    ...
    models = {'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
       ...
       'jmbo.modelbase': {'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'ModelBase'}, 'anonymous_comments': (
                          ...
                          'vote_total': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'jmbo_twitter.feed': {'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Feed', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
       ...
       'jmbo_twitter.search': {'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Search', '_ormbases': ['jmbo.ModelBase']}, 'criteria': (
                                          'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}), 
                               'modelbase_ptr': (
                                               'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'jmbo_twitter.status': {'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Status', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                               'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
