...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pytorrent/torrent.py
# Compiled at: 2008-09-27 14:54:32
from pytorrent.connection import Command, TorrentGetCommand, TorrentGetFileCommand, TorrentCommand
import os.path
STOPPED = 'stopped'
CHECKING = 'checking'
