...
if 'djangocms_misc.autopublisher' not in settings.INSTALLED_APPS:
    ...
    @receiver(post_publish, dispatch_uid='cms_global_untranslated_placeholder_post_publish')
    ...
    @receiver(post_placeholder_operation, dispatch_uid='cms_global_untranslated_placeholder_post_placeholder_operation')
