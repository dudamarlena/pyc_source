...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\midi\containers.py
...
class Pattern(list):
    ...
    def __getitem__(self, item):
        if isinstance(item, slice):
            ...
            return Pattern(resolution=(self.resolution), format=(self.format), tracks=(super(Pattern, self).__getitem__(i) for i in range(*indices)))
        else:
