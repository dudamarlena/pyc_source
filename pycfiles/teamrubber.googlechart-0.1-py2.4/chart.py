...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/teamrubber/googlechart/chart.py
# Compiled at: 2008-04-29 12:42:49
""" Google Chart """
...
class ZGoogleChart(SimpleItem, PropertyManager):
    ...
    def get_fields(self):
        ...
        return [
         ('width', 300, 'int', 'Width', ''), ('height', 300, 'int', 'Height'), ('colours', ['FFF2CC'], 'lines', 'Colours'), ('grid_x', 0, 'int', 'Grid X Size'), ('grid_y', 0, 'int', 'Grid Y Size'), ('grid_line', 0, 'int', 'Grid Line Size'), ('grid_blank', 0, 'int', 'Grid Blank Size'), ('background_fill', 'colour_fill_values', 'selection', 'Background Fill'), ('chart_fill', 'colour_fill_values', 'selection', 'Chart Fill'), ('background_solid_fill', '', 'string', 'Background Solid Fill'), ('chart_solid_fill', '', 'string', 'Chart Solid Fill'), ('bkgd_linear_gradient_colour', '', 'lines', 'Background Linear Gradient Colour'), ('bkgd_linear_gradient_angle', 'angle_values', 'selection', 'Background Linear Gradient Angle'), ('bkgd_linear_gradient_offset', [], 'lines', 'Background Linear Gradient Offset'), ('chrt_linear_gradient_colour', '', 'lines', 'Chart Linear Gradient Colour'), ('chrt_linear_gradient_angle', 'angle_values', 'selection', 'Chart Linear Gradient Angle'), ('chrt_linear_gradient_offset', [], 'lines', 'Chart Linear Gradient Offset'), ('bar_spacing', 0, 'int', 'Bar Chart Spacing'), ('bar_width', 0, 'int', 'Bar Chart Width')]
    ...
    def colour_fill_values(self):
        """ get fill values """
        return [
         'None', 'Solid', 'Linear Gradient', 'Linear Stripes']
