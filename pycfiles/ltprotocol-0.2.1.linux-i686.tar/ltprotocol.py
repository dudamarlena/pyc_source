...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.6/dist-packages/ltprotocol/ltprotocol.py
# Compiled at: 2009-09-15 22:19:33
...
class LTTwistedClient(ReconnectingClientFactory):
    ...
    def __init__(self, lt_protocol, recv_callback, new_conn_callback=None, lost_conn_callback=None, verbose=True):
