...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/devenv/status.py
...
def parse_args(args):
    ...
    parser.add_argument('--wait', help='wait until cluster become ready (with timeout 5 min)', dest='wait', action='store_true')
