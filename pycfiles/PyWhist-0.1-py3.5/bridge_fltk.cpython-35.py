...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/bridge_fltk.py
# Compiled at: 2016-11-01 16:16:38
# Size of source mod 2**32: 12066 bytes
...
class Gui:
    ...
    def show_deal(self, hand, me, dealer):
        self.cards = [set(c for c in hand if c.suit == i) for i in range(4)]
        self.me = me
        self.dummy = None
    ...
    def _show_cards(self, hand, where, cbutts, mine):
        ...
        for i in self.suit_order:
            ...
            for j in ctemp[i]:
                ...
                c.labelcolor(sc[1])
                c.card = j
                c.callback(lambda c, x=self, y=mine: x.choose_card(c, y))
