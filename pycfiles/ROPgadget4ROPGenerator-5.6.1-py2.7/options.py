...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ropgadget/options.py
    ...
    def __removeNonCallPreceded(self):
        ...
        def __isGadgetCallPreceded(gadget):
            ...
            callPrecededExpressions = [
             ...
             b'\xff[\x00-\xff][\x00-\xff][\x00-\xff][\x00-\xff]$\xff[\x00-\xff][\x00-\xff][\x00-\xff][\x00-\xff][\x00-\xff][\x00-\xff][\x00-\xff][\x00-\xff]$']
