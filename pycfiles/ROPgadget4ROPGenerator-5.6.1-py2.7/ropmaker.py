...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ropgadget/ropchain/ropmaker.py
...
class ROPMaker(object):
    ...
    def __handlerArch(self):
        if self.__binary.getArch() == CS_ARCH_X86 and self.__binary.getArchMode() == CS_MODE_32 and self.__binary.getFormat() == 'ELF':
            ROPMakerX86(self.__binary, self.__gadgets, self.__offset)
        elif self.__binary.getArch() == CS_ARCH_X86 and self.__binary.getArchMode() == CS_MODE_64 and self.__binary.getFormat() == 'ELF':
