...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ropgadget/loaders/macho.py
...
class MACHOFlags(object):
    ...
    CPU_TYPE_MIPS = 8
    CPU_TYPE_ARM = 12
    CPU_TYPE_ARM64 = CPU_TYPE_ARM | 16777216
    CPU_TYPE_SPARC = 14
    CPU_TYPE_POWERPC = 18
...
class MACHO(object):
    ...
    def getArchMode(self):
        if self.__machHeader.magic == 4277009102:
            return CS_MODE_32
        else:
            if self.__machHeader.magic == 4277009103:
                return CS_MODE_64
            else:
