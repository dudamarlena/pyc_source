...
class Slot(comb.slot.Slot):
    ...
    @staticmethod
    def options():
        return ('Useage  comb.slot [actions] [options]', '', 'Actions', ('@act1', 'act1 flag,try set it.'),
                'Options:', ('--opt1', 'set opt1 flag'), '', ('--help', 'print help document', '-h'),
                'More:', 'Hi,This is a demo.Useage synax please refer Cliez package.')