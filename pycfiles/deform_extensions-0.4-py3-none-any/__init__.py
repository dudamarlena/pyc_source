...
# [GCC 8.4.0]
# Embedded file name: /home/gas/endi/deform_extensions/deform_extensions/__init__.py
# Compiled at: 2019-06-12 11:08:39
"""
...
custom_dates = fanstatic.Resource(library, 'date.js', depends=[
 timepicker_js, jqueryui_bootstrap_theme])
radio_choice_toggle = fanstatic.Resource(library, 'radio_choice_toggle.js', depends=[
 jquery, underscore])
checkbox_toggle = fanstatic.Resource(library, 'checkbox_toggle.js', depends=[
 jquery, underscore])
