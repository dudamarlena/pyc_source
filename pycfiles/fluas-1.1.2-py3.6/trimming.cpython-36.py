...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/fluas/trimming.py
# Compiled at: 2018-05-04 16:38:01
# Size of source mod 2**32: 3808 bytes
import os
from .utils import runcmd

def run_trimmomatic_pe(r1, r2, r1_paired, r1_orphaned, r2_paired, r2_orphaned, threads=1, phred=33, trimlog=None, illumina_clip=None, sliding_window=None, max_info=None, leading=None, trailing=None, crop=None, head_crop=None, min_len=None, avg_qual=None, to_phred33=False, to_phred64=False):
    """
    Args:
    ...
    cmd = 'java -jar {jar} PE -threads {threads} -phred{phred} {log} {r1} {r2} {r1p} {r2p} {r1o} {r2o} {trimmer}'.format(jar='',
      log=trimlog,
      threads=threads,
      phred=phred,
      trimlog=trimlog,
