...
# Compiled at: 2020-04-06 16:19:25
...
def yadcfoption(colselector, filterid, filtertype, placeholder=None, width=None, date_format='yyyy-mm-dd'):
    ...
    """
    option = {'column_selector':colselector, 
    ...
    if filtertype in ('select', 'multi_select'):
        ...
        option['select_type_options'] = {'allowClear': True}
        if placeholder:
            option['filter_default_label'] = placeholder
            option['select_type_options']['placeholder'] = {'id':-1, 
             'text':placeholder}
        if width:
