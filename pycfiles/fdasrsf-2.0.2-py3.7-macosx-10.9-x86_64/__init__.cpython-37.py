...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/fdasrsf/__init__.py
# Compiled at: 2020-03-26 11:06:00
...
"""
__all__ = [
 'time_warping', 'utility_functions', 'curve_functions', 'geometry', 'pcr_regression', 'tolerance']
__version__ = '2.0.2'
import sys
