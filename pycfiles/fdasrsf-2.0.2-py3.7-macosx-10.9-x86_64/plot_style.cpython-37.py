...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/fdasrsf/plot_style.py
...
def plot_reg_open_curve(beta1, beta2n):
    ...
    for j in range(0, int(T / 5)):
        i = j * 5
        ax.plot((array([beta1[(0, i)], beta2n[(0, i)]])), (array([beta1[(1, i)], beta2n[(1, i)]])),
          'k', linewidth=1)
...
def plot_geod_open_curve(PsiX):
    ...
    for tau in range(0, k):
        ax.plot((0.35 * tau + PsiX[0, :, tau]), (PsiX[1, :, tau]), 'k', linewidth=2)
