...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/fdasrsf/curve_functions.py
# Compiled at: 2019-08-05 10:20:19
# Size of source mod 2**32: 19962 bytes
"""
...
def optimum_reparam_curve(q1, q2, lam=0.0):
    ...
    gam = orN.coptimum_reparam_curve(ascontiguousarray(q1), time, ascontiguousarray(q2), lam)
    return gam
