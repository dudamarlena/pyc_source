...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/orlo/routes/import_.py
...
def post_import():
    ...
    **Example curl**:
    ...
    for r in request.json:
        ...
        release = Release(platforms=platforms, user=r['user'], team=r.get('team'), references=json.dumps(r.get('references')))
        ...
        for p in r['packages']:
            package = Package(release_id=release.id, name=p['name'], version=p['version'])
