...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/orlo/routes/info.py
# Compiled at: 2017-05-17 11:28:49
...
def info_package_versions():
    ...
    """
    platform = request.args.get('platform')
    exclude_partial_releases = str_to_bool(request.args.get('by_release') or config.get('behaviour', 'versions_by_release'))
    q = queries.package_versions(platform=platform, by_release=exclude_partial_releases)
    result = q.all()
    packages = {}
