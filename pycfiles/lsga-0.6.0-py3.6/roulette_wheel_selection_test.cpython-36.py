...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/lsga/tests/roulette_wheel_selection_test.py
...
from lsga.operators.selection.roulette_wheel_selection import RouletteWheelSelection
