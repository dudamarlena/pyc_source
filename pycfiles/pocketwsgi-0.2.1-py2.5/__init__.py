...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/pocketwsgi/__init__.py
# Compiled at: 2007-12-20 18:42:26
import os, re, threading, tempita, webob, selector, formencode
