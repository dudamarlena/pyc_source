...
# Embedded file name: build/bdist.linux-x86_64/egg/pyf/services/controllers/tubelayer.py
# Compiled at: 2011-05-09 04:25:40
__doc__ = 'Crud Tube Layer Controllers'
...
import operator, transaction, time, pylons
...
class TubeLayerController(SecureCrudRestController):
    ...
    class new_form_type(AddRecordForm):
        ...
        tube = SingleSelectField('tube', label_text='Tube', options=tube_select_getter(), not_empty=True)
    ...
    def get_all(self, *args, **kw):
        ...
        if pylons.request.response_type == 'application/json':
            ...
            return dict(model=self.model.__name__, value_list=query, variant_names=variant_names, tubes=tube_select_getter()(), line_formater=self.table_filler.get_value_item, kw=kw)
