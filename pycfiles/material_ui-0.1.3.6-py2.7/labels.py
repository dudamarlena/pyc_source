...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/material_ui/flatui/labels.py
# Compiled at: 2015-02-02 19:14:10
import sys
sys.path.append('..')
...
class ResizeableLabel(BindedLabel):
        ...
        if self._touched:
            ...
            if self.root_layout:
                ...
                with self.root_layout.canvas:
                    ...
                    kg.Rectangle(size=self._hover_size, pos=self._hover_pos, **self._unique_group)
            return True
    ...
    def _on_size(self, oldsize, newsize):
        print 'Size changed'
        if self.on_new_size:
            self.on_new_size(oldsize, newsize, self.meta)
