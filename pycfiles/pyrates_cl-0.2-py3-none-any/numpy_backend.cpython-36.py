...
__doc__ = 'Contains wrapper classes for different backends that are needed by the parser module.\n\nA new backend needs to implement the following methods\n\nMethods\n-------\n__init__\nrun\nadd_var\nadd_op\nadd_layer\n\nCurrently supported backends:\n- Numpy: NumpyBackend.\n- Tensorflow: TensorflowBackend.\n\n'
import time
...
class NumpyBackend(object):
    ...
    def compile(self, build_dir: Optional[str]=None, decorator: Optional[Callable]=None, **kwargs) -> tuple:
        ...
        return (
         rhs_eval, args, state_vars, var_map)
    ...
    def _process_update_args(self, var, update, idx=None):
        ...
        return (
         var, update, idx, scatter_into_first_dim)
