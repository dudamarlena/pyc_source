...
# [GCC 8.4.0]
# Embedded file name: /Users/duwei/PycharmProjects/kafkaka/kafkaka/bstruct.py
# Compiled at: 2015-01-12 06:16:40
import struct
...
class Field(object):
    ...
    def to_static(self):
        return (
         self.__class__, self.args, self.kwargs)
        ...
        for k in self._fields_order:
            ...
            for tag in ('_repeat', '_length', '_source'):
                if getattr(v, tag, None) is not None:
                    ...
                    setattr(v, tag, Link(self, relative_field_name))
                    setattr(relative, '_reflect' + tag, Link(self, k))
