...
# [GCC 8.4.0]
# Embedded file name: /home/qvit/Django/torex/color_captcha/utils.py
# Compiled at: 2013-08-20 12:53:56
...
def check_colors(COLORS):
    ...
    def check_color_option(color_option):
        try:
            if not (len(color_option) == 2 and isinstance(color_option[0], basestring) and isinstance(color_option[1], basestring)):
