...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/skypipe/satellite/server.py
# Compiled at: 2012-11-06 20:57:39
import collections, sys, os, zmq
...
while True:
    ...
    if SP_CMD_HELLO == command:
        ...
        pipe_name = msg.pop(0)
        try:
            {SP_CMD_LISTEN: cmd_listen, SP_CMD_UNLISTEN: cmd_unlisten, 
               SP_CMD_DATA: cmd_data}[command]()
        except KeyError:
