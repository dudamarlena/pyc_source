...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/dotcloud/ui/colors.py
...
class Color(object):
    ...
    def __call__(self, text):
        if self.color is None:
            ...
            return ('{color}{text}{reset}').format(color=self.color, text=text, reset=colorama.Style.RESET_ALL)