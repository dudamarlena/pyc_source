...
# Embedded file name: build/bdist.linux-x86_64/egg/proofreader/config/utils.py
# Compiled at: 2018-03-13 09:30:54
import os
from proofreader.config import DEFAULT_FLAKE8_CONFIG_PATH, DEFAULT_PYLINT_CONFIG_PATH, DEFAULT_LICENSE_CHECKER_CONFIG_PATH, FLAKE8_CONFIG_NAME, LICENSE_CHECKER_CONFIG_NAME, PYLINT_CONFIG_NAME
...
def get_flake8_options(config_dir='.'):
    ...
    return [
     ('--config={}').format(flake8_config_path)]
...
def get_pylint_options(config_dir='.'):
    ...
    return [
     ('--rcfile={}').format(pylint_config_path)]