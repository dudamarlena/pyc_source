...
# Embedded file name: build/bdist.darwin-8.10.1-i386/egg/poacheggs/__init__.py
# Compiled at: 2007-10-16 11:25:14
__doc__ = "hacked out of workingenv's underbelly"
from optparse import OptionParser
import sys, os, pkg_resources, ConfigParser, workingenv
...
def main(args=None):
    ...
    writer = workingenv.Writer(output_dir, logger, simulate=options.simulate, interactive=options.interactive, python_dir=python_dir)
    requirements = args
...
parser = OptionParser(version=str(my_package), usage='%%prog [OPTIONS] file_or_url\n\n%s' % help)
