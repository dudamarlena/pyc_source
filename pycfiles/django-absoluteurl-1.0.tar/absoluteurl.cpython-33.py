...
# [GCC 8.4.0]
# Embedded file name: /Users/bartoldi/Sites/ilike/absoluteurl/templatetags/absoluteurl.py
# Compiled at: 2014-07-16 14:37:28
...
def absoluteurl(parser, token):
    ...
    try:
        ...
        exc.args = (
         exc.args[0] + ". The syntax of 'url' changed in Django 1.5, see the docs.",)
        raise
