...
# Embedded file name: build\bdist.win-amd64\egg\poda\transfer_learning\NasNet.py
# Compiled at: 2019-09-26 09:27:13
# Size of source mod 2**32: 21454 bytes
__doc__ = 'Contains the definition for the NASNet classification networks.\nPaper: https://arxiv.org/abs/1707.07012\n'
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import copy, tensorflow as tf
from poda.transfer_learning import nasnet_utils
arg_scope = tf.contrib.framework.arg_scope
slim = tf.contrib.slim

def cifar_config():
    return tf.contrib.training.HParams(stem_multiplier=3.0,
...
def mobile_imagenet_config():
    return tf.contrib.training.HParams(stem_multiplier=1.0,
      dense_dropout_keep_prob=0.5,
      num_cells=12,
      filter_scaling_rate=2.0,
...
def _imagenet_stem(inputs, hparams, stem_cell, current_step=None):
    ...
    net = slim.conv2d(inputs,
      num_stem_filters, [3, 3], stride=2, scope='conv0', padding='VALID')
...
def _build_nasnet_base(images, normal_cell, reduction_cell, num_classes, hparams, is_training, stem_type, final_endpoint=None, current_step=None):
    ...
    return (var_list, net, end_points)