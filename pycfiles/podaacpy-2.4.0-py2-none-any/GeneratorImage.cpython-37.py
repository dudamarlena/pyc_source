...
# Embedded file name: build\bdist.win-amd64\egg\poda\preprocessing\GeneratorImage.py
# Compiled at: 2019-09-26 09:27:13
# Size of source mod 2**32: 10205 bytes
...
class GeneratorImage:
    ...
    def batch_generator(self, list_path_data, list_target_data):
        ...
        while True:
            ...
            yield (
             image_data_batch, image_target_batch)
    ...
    def generate_from_directory_manual(self, directory):
        ...
        return (
         self.batch_generator(list_path_data=list_path_image, list_target_data=list_target_image), self.get_num_data(list_path_image))
    ...
    def generate_from_directory_auto(self, directory, val_ratio=0.2):
        ...
        return (
         train_generator, val_generator, num_train_data, num_val_data)
    ...
    def get_list_image_and_label(self, path_dataset):
        ...
        return (
         list_path_dataset, list_target_dataset)
    ...
    def split_dataset(self, list_path_data, list_target_data, split_sizes=0.8):
        ...
        return (
         train_list_path_data, train_list_target_data, val_list_path_data, val_list_target_data)
