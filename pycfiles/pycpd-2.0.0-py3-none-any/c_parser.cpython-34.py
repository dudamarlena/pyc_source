...
# Size of source mod 2**32: 62212 bytes
import re
...
class CParser(PLYParser):
    ...
    def __init__(self, lex_optimize=True, lextab='pycparser.lextab', yacc_optimize=True, yacctab='pycparser.yacctab', yacc_debug=False, taboutputdir=''):
        ...
        self.cparser = yacc.yacc(module=self, start='translation_unit_or_empty', debug=yacc_debug, optimize=yacc_optimize, tabmodule=yacctab, outputdir=taboutputdir)
        self._scope_stack = [
         dict()]
    ...
    def p_function_definition_1(self, p):
        ...
        spec = dict(qual=[], storage=[], type=[
         c_ast.IdentifierType(['int'], coord=self._coord(p.lineno(1)))], function=[])
