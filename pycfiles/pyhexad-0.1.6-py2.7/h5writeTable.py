...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyhexad\h5writeTable.py
# Compiled at: 2014-12-08 16:27:22
...
@xl_func('string filename, string tablename, var[] rows, string columns: var', category='HDF5', thread_safe=False, disable_function_wizard_calc=True)
