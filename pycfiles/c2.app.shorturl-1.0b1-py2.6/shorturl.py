...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/c2/app/shorturl/content/shorturl.py
...
MAX_LEN = 5
schema = Schema((
 StringField('suffix_url', required=False, searchable=False, widget=StringWidget(description='', description_msgid='help_suffix_url', label='suffix_url', label_msgid='label_suffix_url', i18n_domain='c2.app.shortulr')),
 StringField('org_path', required=False, searchable=False, widget=StringWidget(description='', description_msgid='help_org_pathl', label='org_path', label_msgid='label_org_path', i18n_domain='c2.app.shortulr'))))
