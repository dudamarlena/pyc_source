...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/c2/app/shorturl/browser/createbox.py
# Compiled at: 2010-08-19 05:46:27
"""
createbox.py
...
class CreatePage(BrowserView):
    ...
    def create_shorturl(self):
        ...
        if not folder_obj:
            ...
            obj = _createObjectByType('ShortUrl', folder_obj, id, title=suffix_url, suffix_url=suffix_url, org_path=org_path)
