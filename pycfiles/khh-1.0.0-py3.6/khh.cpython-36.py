...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/khh/khh.py
# Compiled at: 2017-11-27 21:01:35
...
class KHeavyHitters(object):
    ...
    def __init__(self, k, eps=1e-05, confidence=0.99, k_factor=1, dtype=np.int32, random_state=0):
    ...
    """
        ...
        self._hash_vector = self._random_state.randint(low=0, high=(np.iinfo(dtype).max), size=(self._depth),
          dtype=dtype)
        self._size = 0
