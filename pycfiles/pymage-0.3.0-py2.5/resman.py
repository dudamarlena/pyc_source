...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/pymage/resman.py
# Compiled at: 2007-09-07 20:18:46
"""
...
class Resource(object):
    ...
    path = property(getPath, setPath, doc='The path to the resource file')
    ...
    def prepare(self, tag, defaultPath=None):
        ...
        :Parameters:
            ...
            defaultPath : string
                The path of the key
        """
        warnings.warn('prepare is deprecated; use ResourceManager.addResource.', DeprecationWarning, stacklevel=2)
