...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/pymage/sound.py
# Compiled at: 2007-08-10 19:47:42
"""
...
class MusicManager(resman.Submanager):
    ...
    def __init__(self, should_play=True, loop=True, *args, **kw):
        """
    ...
    def prepare(self, tag, playlist):
        ...
        :Parameters:
            ...
            playlist : list of strings
                Songs in playlist
        """
        warnings.warn('prepare is deprecated; use addPlaylist.', DeprecationWarning, stacklevel=2)
...
class SoundManager(resman.Submanager):
    ...
    def getSound(self, *args, **kw):
        ...
        """
        warnings.warn('getSound is deprecated; use load.', DeprecationWarning, stacklevel=2)
