...
# Embedded file name: /MyWork/Projects/PyCK/pyck/tests/test_admin_controller.py
# Compiled at: 2014-11-07 16:15:53
import unittest
...
class TestAdmin(unittest.TestCase):
    ...
    def setUp(self):
        ...
        add_admin_handler(self.config, db_session, [User, Category, Post, Comment], 'admin.', '/admin', AdminController)
    ...
    def test_01_crud_controller_routes(self):
        ...
        admin_routes = {'admin.admin_index': '/admin/', 'admin.UserCRUD_add': '/admin/users/add', 
