...
class CRUDController(object):
    ...
    * Once CRDUController is complete, may be put table display login in a ModelTable component??
    ...
    def add(self):
        ...
        ret_dict = {'base_template': self.base_template, 'friendly_name': self.friendly_name, 'model_record_counts': self._models_rec_count_if_needed(), 'form': f, 
           'action_type': 'add'}
        return dict(list(ret_dict.items()) + list(self.template_extra_params.items()))
    ...
    def edit(self):
        ...
        ret_dict = {'base_template': self.base_template, 'model_record_counts': self._models_rec_count_if_needed(), 'friendly_name': self.friendly_name, 
