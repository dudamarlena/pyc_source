...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dblogger/__init__.py
...
from dblogger.configure import config_name, default_config, add_arguments, runtime_keys, normalize_config
