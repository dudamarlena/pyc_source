...
# Embedded file name: build/bdist.linux-x86_64/egg/compactxml/pyparsingaddons.py
# Compiled at: 2010-03-02 19:48:29
...
def indentedBlock(blockStatementExpr, indentStack, indent=True):
    ...
    if indent:
        smExpr = Group(INDENT + OneOrMore(PEER + Group(blockStatementExpr)) + UNDENT)
    else:
        smExpr = Group(OneOrMore(PEER + Group(blockStatementExpr)))
    return smExpr
