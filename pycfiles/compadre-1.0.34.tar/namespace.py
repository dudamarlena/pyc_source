...
# Embedded file name: build/bdist.linux-x86_64/egg/compactxml/namespace.py
# Compiled at: 2010-10-25 16:59:37
import copy
...
class UndefinedPrefix(KeyError):
    ...
    def __unicode__(self):
        return 'No namespace defined for prefix "%s".' % self.prefix
...
class Namespaces(object):
    ...
    @staticmethod
    def is_namespace_name(qname):
        return not qname.namespace and qname.localname == 'xmlns'

    @staticmethod
    def is_namespace_prefix(qname):
        return qname.namespace == XML_NAMESPACE
