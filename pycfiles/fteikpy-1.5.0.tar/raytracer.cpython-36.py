...
# [GCC 8.4.0]
# Embedded file name: C:\Users\keurf\Documents\GitHub\FTeikPy\examples\raytracer\raytracer.py
# Compiled at: 2018-02-20 19:25:45
...
class Ray3D:
    ...
    def trace(self, src, rcv, vel, zint):
        ...
        self._shift()
        self._rotate()
        iopt, gfit = fminbnd((self._costfunc), 0.0, 180.0, eps=1e-16, args=(V, H))
