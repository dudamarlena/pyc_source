...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snmpclitools/cli/mibview.py
...
class MibViewProxy(object):
    ...
    def __init__(self, mibViewController):
        ...
        if self.DEFAULT_MIB_DIRS:
            mibViewController.mibBuilder.setMibSources(*(mibViewController.mibBuilder.getMibSources() + tuple([ builder.ZipMibSource(m).init() for m in self.DEFAULT_MIB_DIRS ])))
