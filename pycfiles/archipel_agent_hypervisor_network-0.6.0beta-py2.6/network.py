...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagenthypervisornetwork/network.py
# Compiled at: 2013-03-20 13:50:16
import commands, libvirt, os, xmpp
...
class TNHypervisorNetworks(TNArchipelPlugin):
    ...
    def __init__(self, configuration, entity, entry_point_group):
        ...
        if self.entity.__class__.__name__ == 'TNArchipelVirtualMachine':
            ...
            registrar_items = [
             {'commands': ['list networks'], 'parameters': [], 'method': self.message_get, 
                'permissions': [
                              'network_get'], 
                'description': 'List all networks'},
             {'commands': ['create network', 'start network'], 'parameters': [{'name': 'identifier', 'description': 'The identifer of the network, UUID or name'}], 'method': self.message_create, 
                'permissions': [
                              'network_create'], 
                'description': 'Start the given network'},
             {'commands': ['destroy network', 'stop network'], 'parameters': [{'name': 'identifier', 'description': 'The identifer of the network, UUID or name'}], 'method': self.message_destroy, 
                'permissions': [
                              'network_destroy'], 
                'description': 'Stop the given network'},
             {'commands': ['nics', 'network cards'], 'parameters': [], 'method': self.message_getnics, 
                'permissions': [
                              'network_getnics'], 
