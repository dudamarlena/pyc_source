...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagenthypervisornetwork/__init__.py
...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [
     {'info': network.TNHypervisorNetworks.plugin_info(), 'plugin': network.TNHypervisorNetworks(configuration, entity, group)}]
...
def version():
    ...
    return (
     __name__, pkg_resources.get_distribution('archipel-agent-hypervisor-network').version, [network.TNHypervisorNetworks.plugin_info()])