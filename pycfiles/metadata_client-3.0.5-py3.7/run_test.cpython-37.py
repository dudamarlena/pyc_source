...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/modules/run_test.py
# Compiled at: 2019-03-11 08:28:16
# Size of source mod 2**32: 10541 bytes
"""RunTest class"""
import unittest
...
class RunTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        _RunTest__unique_run_id_1 = Generators.generate_unique_id()
        self.run_01 = {'run_number':_RunTest__unique_run_id_1, 
         'run_alias':None, 
         'experiment_id':'-1', 
         'sample_id':'-1', 
         ...
         'description':'desc 01'}
        self.run_01_upd = {'run_number':_RunTest__unique_run_id_1, 
    ...
    def test_create_run(self):
        run_01 = Run(metadata_client=(self.mdc_client),
        ...
        result3 = Run.get_by_run_number_and_experiment_id(self.mdc_client, run_number, experiment_id)
        ...
        run_01.run_number = '__THIS_NAME_IS_1_CHARACTERS_LONGER_THAN_THE_ALLOWED_MAX_NUM__'
        run_01.flg_available = self.run_01_upd['flg_available']
        run_01.description = self.run_01_upd['description']
    ...
    def test_create_run_from_dict(self):
        ...
        expect_app_info = {'run_number': ['must be unique per proposal',
                        'has already been taken']}
        self.assert_create_error(MODULE_NAME, result2, expect_app_info)
        result3 = Run.update_from_dict(self.mdc_client, run_id, self.run_01_upd)
        self.assert_update_success(MODULE_NAME, result3, self.run_01_upd)
        run_02_upd = {'first_train':'100', 
         'last_train':'101', 
         'flg_available':'true'}
        result4 = Run.update_from_dict(self.mdc_client, run_id, run_02_upd)
        exp_run_02_upd = {'run_number':self.run_01_upd['run_number'], 
