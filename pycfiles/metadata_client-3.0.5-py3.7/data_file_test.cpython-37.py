...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/modules/data_file_test.py
# Compiled at: 2017-06-19 07:48:53
# Size of source mod 2**32: 5959 bytes
"""DataFileTest class"""
import unittest
...
class DataFileTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_file_01 = {'data_group_id':'2', 
         'files':"[{'filename': 'obj_01.h5', 'relative_path': ''}]"}
        _DataFileTest__unique_name_upd = Generators.generate_unique_name('DataGrpTypeUpd1')
        _DataFileTest__unique_identifier_upd = Generators.generate_unique_identifier(1)
        self.data_file_01_upd = {'data_group_id':'2', 
         'files':"[{'filename': 'obj_01_UPDATED.h5', 'relative_path': ''}]"}

    def test_create_data_file(self):
        data_file_01 = DataFile(metadata_client=(self.mdc_client),
        ...
        result3 = DataFile.get_all_by_data_group_id(self.mdc_client, data_file_data_group_id)
        expected_result = [
         self.data_file_01]
        ...
        expect_app_info = {'files': ["can't be blank",
    ...
    def test_create_data_file_from_dict(self):
        ...
        result3 = DataFile.update_from_dict(self.mdc_client, data_file_id, self.data_file_01_upd)
        self.assert_update_success(MODULE_NAME, result3, self.data_file_01_upd)
        data_file_02_upd = {'files': "[{'filename': 'obj_02_UPDATED.h5', 'relative_path': ''}]"}
        result4 = DataFile.update_from_dict(self.mdc_client, data_file_id, data_file_02_upd)
        exp_data_file_02_upd = {'data_group_id':self.data_file_01_upd['data_group_id'], 
