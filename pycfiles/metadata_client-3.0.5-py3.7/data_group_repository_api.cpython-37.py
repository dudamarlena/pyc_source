...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/apis/data_group_repository_api.py
# Compiled at: 2017-09-13 08:42:41
...
class DataGroupRepositoryApi(Base):
    ...
    def create_data_group_repository_api(self, data_group_repository):
        api_url = self._DataGroupRepositoryApi__get_api_url()
    ...
    def delete_data_group_repository_api(self, data_group_repository_id):
        api_url = self._DataGroupRepositoryApi__get_api_url(data_group_repository_id)
        return self.api_delete(api_url)

    def update_data_group_repository_api(self, data_group_repository_id, data_group_repository):
        api_url = self._DataGroupRepositoryApi__get_api_url(data_group_repository_id)
    ...
    def get_all_by_data_group_id_and_repository_id_api(self, data_group_id, repository_id):
        api_url = self._DataGroupRepositoryApi__get_api_url()
        return self.api_get(api_url, params={'data_group_id':data_group_id,  'repository_id':repository_id})
