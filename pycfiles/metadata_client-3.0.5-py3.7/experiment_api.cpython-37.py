...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/apis/experiment_api.py
...
class ExperimentApi(Base):
    ...
    def get_all_experiments_by_name_and_proposal_id_api(self, name, proposal_id):
        api_url = self._ExperimentApi__get_api_url()
