...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/modules/parameter_test.py
...
class ParameterTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.param_01 = {'data_source':'MID/XTD6/ATT/MOTOR/BLADE_TOP', 
         'name':'VelocityLeft', 
         'value':'15.6', 
         'minimum':'15.0', 
         'maximum':'16.0', 
        ...
        self.param_01_upd = {'data_source':'MID/XTD6/ATT/MOTOR/BLADE_TOP', 
         'name':'VelocityLeft', 
         'value':'13.6', 
         'minimum':'13.0', 
         'maximum':'14.0', 
    ...
    def test_create_parameter(self):
        param_01 = Parameter(metadata_client=(self.mdc_client),
        ...
        result3 = Parameter.get_all_by_data_source_and_name(self.mdc_client, data_source, param_name)
        exp_data = [
         self.param_01, self.param_01]
    ...
    def test_create_multiple_parameter_from_dict(self):
        ...
        parameters_list = {'parameters': [parameter_01,
                        parameter_02]}
        result1 = Parameter.create_multiple_from_dict(self.mdc_client, parameters_list)
        self.assert_create_success(MODULE_NAME, result1, parameters_list['parameters'])
