...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/modules/experiment_test.py
# Compiled at: 2017-08-14 18:23:48
...
class ExperimentTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        _ExperimentTest__unique_name1 = Generators.generate_unique_name('Experiment01')
        self.experiment_01 = {'name':_ExperimentTest__unique_name1, 
         ...
         'description':'desc 01'}
        _ExperimentTest__unique_name_upd = Generators.generate_unique_name('ExperimentUpd1')
        self.exp_01_upd = {'name':_ExperimentTest__unique_name_upd, 
    ...
    def test_create_experiment(self):
        exp_01 = Experiment(metadata_client=(self.mdc_client),
        ...
        result3 = Experiment.get_by_name_and_proposal_id(self.mdc_client, experiment_name, proposal_id)
        self.assert_find_success(MODULE_NAME, result3, self.experiment_01)
        result32 = Experiment.get_all_by_proposal_id(self.mdc_client, proposal_id)
        result32_redu = {'success':result32['success'],  'info':result32['info'], 
        ...
        exp_01.name = '__THIS_NAME_IS_1_CHARACTERS_LONGER_THAN_THE_ALLOWED_MAX_NUM__'
        exp_01.doi = self.exp_01_upd['doi']
        exp_01.experiment_type_id = self.exp_01_upd['experiment_type_id']
        exp_01.proposal_id = self.exp_01_upd['proposal_id']
        exp_01.flg_available = self.exp_01_upd['flg_available']
