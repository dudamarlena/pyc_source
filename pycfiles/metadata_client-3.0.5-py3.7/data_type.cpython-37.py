...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/modules/data_type.py
...
class DataType(DataTypeApi):
    ...
    def create(self):
        ...
        response = mdc_client.create_data_type_api(self._DataType__get_resource())
    ...
    def update(self):
        mdc_client = self.metadata_client
        response = mdc_client.update_data_type_api(self.id, self._DataType__get_resource())
    ...
    def __get_resource(self):
        data_type = {MODULE_NAME: {'name':self.name, 
