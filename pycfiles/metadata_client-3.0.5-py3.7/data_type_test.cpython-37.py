...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/modules/data_type_test.py
# Compiled at: 2017-06-19 07:48:53
# Size of source mod 2**32: 4973 bytes
"""DataTypeTest class"""
import unittest
...
class DataTypeTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        _DataTypeTest__unique_name1 = Generators.generate_unique_name('DataType01')
        _DataTypeTest__unique_identifier1 = Generators.generate_unique_identifier()
        self.exp_typ_01 = {'name':_DataTypeTest__unique_name1, 
         'identifier':_DataTypeTest__unique_identifier1, 
         'flg_available':'true', 
         'description':'desc 01'}
        _DataTypeTest__unique_name_upd = Generators.generate_unique_name('DataTypeUpd1')
        _DataTypeTest__unique_identifier_upd = Generators.generate_unique_identifier(1)
        self.exp_typ_01_upd = {'name':_DataTypeTest__unique_name_upd, 
         'identifier':_DataTypeTest__unique_identifier_upd, 
         'flg_available':'false', 
         'description':'desc 01 Updated!'}

    def test_create_data_type(self):
        exp_typ_01 = DataType(metadata_client=(self.mdc_client),
        ...
        data_type = result1['data']
        data_type_id = result1['data']['id']
        data_type_name = result1['data']['name']
        ...
        result3 = DataType.get_by_name(self.mdc_client, data_type_name)
        self.assert_find_success(MODULE_NAME, result3, self.exp_typ_01)
        result4 = DataType.get_by_id(self.mdc_client, data_type_id)
        self.assert_find_success(MODULE_NAME, result4, self.exp_typ_01)
        result5 = DataType.get_by_id(self.mdc_client, -666)
