...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/modules/data_group_repository_test.py
...
class DataGroupRepositoryTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_grp_repo_00 = {'data_group_id':'-1', 
         'repository_id':'-1', 
         'flg_available':'true'}
        self.data_grp_repo_01 = {'data_group_id':'-1', 
         'repository_id':'11', 
         'flg_available':'true'}
        self.data_grp_repo_01_upd = {'data_group_id':'-1', 
         'repository_id':'11', 
         'flg_available':'false'}

    def test_create_data_group_repository(self):
        dgrp_repo_01 = DataGroupRepository(metadata_client=(self.mdc_client),
        ...
        expect_app_info = {'data_group_id':['has already been taken'],  'repository_id':[
          'has already been taken']}
        self.assert_create_error(MODULE_NAME, result2, expect_app_info)
        result3 = DataGroupRepository.get_all_by_data_group_id(self.mdc_client, data_group_id)
        expected = [
         self.data_grp_repo_00, self.data_grp_repo_01]
        self.assert_find_success(MODULE_NAME, result3, expected)
        result4 = DataGroupRepository.get_all_by_data_group_id_and_repository_id(self.mdc_client, data_group_id, repository_id)
        self.assert_find_success(MODULE_NAME, result4, [self.data_grp_repo_01])
        result5 = DataGroupRepository.get_by_id(self.mdc_client, data_group_repository_id)
        ...
        self.assert_update_success(MODULE_NAME, result7, self.data_grp_repo_01_upd)
