...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/modules/data_file.py
# Compiled at: 2017-07-05 10:06:14
...
class DataFile(DataFileApi):
    ...
    def create(self):
        ...
        response = mdc_client.create_data_file_api(self._DataFile__get_resource())
    ...
    def update(self):
        mdc_client = self.metadata_client
        response = mdc_client.update_data_file_api(self.id, self._DataFile__get_resource())
    ...
    def create_from_dict(mdc_client, data_file):
        new_data_file = DataFile(metadata_client=mdc_client, data_group_id=(data_file['data_group_id']),
    ...
    def get_all_by_data_group_id(mdc_client, data_grp_id):
        ...
        Base.cal_debug(MODULE_NAME, 'get_all_by_data_group_id', resp)
    ...
    def search_data_files(mdc_client, run_number, proposal_number):
        ...
        Base.cal_debug(MODULE_NAME, 'search_data_files', resp)
        return Base.format_response(resp, GET, OK, MODULE_NAME)

    def __get_resource(self):
        data_file = {MODULE_NAME: {'data_group_id':self.data_group_id, 
                       'files':self.files}}
        return data_file