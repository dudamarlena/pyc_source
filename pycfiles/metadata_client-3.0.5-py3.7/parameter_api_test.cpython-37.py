...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/metadata_client/tests/apis/parameter_api_test.py
# Compiled at: 2017-06-19 07:48:53
# Size of source mod 2**32: 6815 bytes
...
class ParameterApiTest(ApiBase, unittest.TestCase):
    ...
    def test_create_parameter_api(self):
        parameter = {'parameter': {'data_source':'MID/XTD6/ATT/MOTOR/BLADE_TOP', 
                       'name':'VelocityLeft', 
                       'value':'15.6', 
                       'minimum':'15.0', 
                       'maximum':'16.0', 
        ...
        self._ParameterApiTest__get_all_entries_by_data_source_and_name_api(data_source, param_name, expect)
    ...
    def __update_entry_api(self, entry_id, expect):
        parameter_upd = {'parameter': {'data_source':'MID/XTD6/ATT/MOTOR/BLADE_DOWN', 
                       'name':'VelocityRight', 
                       'value':'13.6', 
                       'minimum':'13.0', 
                       'maximum':'14.0', 
        ...
        response = self.client_api.update_parameter_api(entry_id, parameter_upd)
    ...
    def __get_all_entries_by_data_source_and_name_api(self, data_source, name, expect):
        resp = self.client_api.get_all_parameters_by_data_source_and_name_api(data_source, name)
