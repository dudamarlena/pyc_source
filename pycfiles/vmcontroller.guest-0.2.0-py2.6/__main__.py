...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vmcontroller/guest/__main__.py
# Compiled at: 2011-03-04 15:52:41
"""
Entrypoint for starting the VMController Guest.
"""
try:
    import os, sys, logging, tempfile, inject
...
def init():
    ...
    parser.add_option('-a', '--host', dest='broker_host', help='Listen on specified address for broker.', metavar='ADDR')
    parser.add_option('-p', '--port', dest='broker_port', help='Listen on specified port for broker.', type='int', metavar='PORT')
