...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/payjp/test/test_http_client.py
...
class HttpClientTests(PayjpUnitTestCase):
    ...
    def test_new_default_http_client_requests(self):
        self.check_default((), payjp.http_client.RequestsClient)
...
class ClientTestBase:
    ...
    def test_exception(self):
        ...
        self.assertRaises(payjp.error.APIConnectionError, self.make_request, 'get', self.valid_url, {}, None)
...
class RequestsClientTests(PayjpUnitTestCase, ClientTestBase):
    ...
    def check_call(self, mock, meth, url, post_data, headers):
        mock.request.assert_called_with(meth, url, headers=headers,
          data=post_data,
          timeout=80)
