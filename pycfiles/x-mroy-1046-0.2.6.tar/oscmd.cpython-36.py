...
# [GCC 8.4.0]
# Embedded file name: /Users/dr/Documents/code/Python/Projects/ControllProxy/seed/mrpackage/oscmd.py
# Compiled at: 2018-05-22 22:17:19
# Size of source mod 2**32: 16068 bytes
import os, zlib, subprocess, base64, json, time
...
class Proxychains(Os):
    ...
    def Setup(self):
        ...
        if not os.path.exists(self.config_path):
            ...
            if not self.check('proxychains4'):
                if not self.check('proxychains'):
                    if self.o == 'c':
                        cmd = '\nyum install -y git\ncd /usr/local/src\ngit clone https://github.com/rofl0r/proxychains-ng.git\ncd proxychains-ng\n./configure && make && make install\nmake install-config'
                        with open('/tmp/proxy-install.sh', 'w') as (fp):
                            fp.write(cmd)
...
class Shadowsocks(Os):
    ...
    def Setup(self):
        ...
        self.server_config = {'server':'0.0.0.0', 
         'port_password':{'13001':'thefoolish1', 
          '13002':'thefoolish2', 
          '13003':'thefoolish3', 
          '13004':'thefoolish4', 
          '13005':'thefoolish5', 
