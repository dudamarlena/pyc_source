...
# [GCC 8.4.0]
# Embedded file name: /Users/dr/Documents/code/Python/Projects/ControllProxy/seed/mrservers/local.py
# Compiled at: 2018-06-01 22:08:52
# Size of source mod 2**32: 15381 bytes
import asyncio, socket, pickle, time, functools, random, os, sys
...
class _AServer:
    ...
    def get_handler(self, id):
        if id in self.udp_handlers:
            ...
            if id in self.tcp_handlers:
                return (
                 self.tcp_handlers[id], 'tcp')
            return (None, None)
