...
def fit_to_data(data: FitData, func: FitFunction, a0: np.ndarray=None, use_x_derivative=True, use_a_derivative=True):
    model = Model(**__get_odr_model_kwargs(func,
      use_x_derivative=use_x_derivative, use_a_derivative=use_a_derivative))
...
def __get_odr_model_kwargs(func, use_x_derivative=True, use_a_derivative=True):
