...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/api/stock_api.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 11881 bytes
...
class StockApi(object):
    ...
    def get_stocks(self, **kwargs):
        ...
        if kwargs.get('async'):
            return (self.get_stocks_with_http_info)(**kwargs)
        else:
            data = (self.get_stocks_with_http_info)(**kwargs)
            return data

    def get_stocks_with_http_info(self, **kwargs):
        """在庫情報の取得  # noqa: E501
        ...
        """
        all_params = [
         'ids', 'category_id_big', 'category_id_small', 'model_number', 'name', 'display_state', 'stocks', 'recent_zero_stocks', 'fields', 'limit', 'offset']
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_stocks" % key)
            params[key] = val
        ...
        auth_settings = [
         'OAuth2']
        return self.api_client.call_api('/v1/stocks.json',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
