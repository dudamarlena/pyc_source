...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\samplify\energy.py
# Compiled at: 2016-04-24 20:32:11
from .si import *

class Energy(NonStandard):

    def __init__(self, joules=0, watthours=0, kilowatthours=0, electronvolts=0, calories=0, btu_iso=0, btu_15=0):
