...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\samplify\test\si.py
...
class SITest(unittest.TestCase):
    ...
    def test_unit_math(self):
        G = si.Measure(9.81, unit=si.BaseUnits.m) / si.Measure(1, unit=si.BaseUnits.s) ** 2
    ...
    def test_unit_strings(self):
        ...
        self.assertEqual(si.describe_unit(si.BaseUnits._), si.find_unit_string(si.BaseUnits._))
        self.assertEqual(si.describe_unit(si.BaseUnits.m), si.find_unit_string(si.BaseUnits.m))
        self.assertEqual(si.describe_unit(si.BaseUnits.g), si.find_unit_string(si.BaseUnits.g))
        self.assertEqual(si.describe_unit(si.BaseUnits.s), si.find_unit_string(si.BaseUnits.s))
        self.assertEqual(si.describe_unit(si.BaseUnits.A), si.find_unit_string(si.BaseUnits.A))
        self.assertEqual(si.describe_unit(si.BaseUnits.K), si.find_unit_string(si.BaseUnits.K))
        self.assertEqual(si.describe_unit(si.BaseUnits.mol), si.find_unit_string(si.BaseUnits.mol))
        self.assertEqual(si.describe_unit(si.BaseUnits.cd), si.find_unit_string(si.BaseUnits.cd))
        self.assertEqual(si.describe_unit(si.BaseUnits.PF), si.find_unit_string(si.BaseUnits.PF))
