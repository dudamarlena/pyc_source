...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall-statistic/vkontakte_wall_statistic/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('vkontakte_wall_statistic_poststatistic', (
         (
         ...
         (
          'reach_subscribers', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'link_clicks', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
         ...
         (
          'reach_males_age_18', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_18_21', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_21_24', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_24_27', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_27_30', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_30_35', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_35_45', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_males_age_45', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_18', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_18_21', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_21_24', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_24_27', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_27_30', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_30_35', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_35_45', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'reach_females_age_45', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
         (
          'post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statistics', to=orm['vkontakte_wall.Post'])),
         (
          'date', self.gf('django.db.models.fields.DateField')(db_index=True)),
         (
          'period', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True))))
        db.send_create_signal('vkontakte_wall_statistic', ['PostStatistic'])
        db.create_unique('vkontakte_wall_statistic_poststatistic', ['post_id', 'date', 'period'])

    def backwards(self, orm):
        db.delete_unique('vkontakte_wall_statistic_poststatistic', ['post_id', 'date', 'period'])
        db.delete_table('vkontakte_wall_statistic_poststatistic')
