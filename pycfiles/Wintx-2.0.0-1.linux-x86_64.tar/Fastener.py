...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.6/site-packages/wintx/Fastener.py
# Compiled at: 2016-03-31 11:48:34
"""Wintx Fastener to connect interfaces to the drivers and handle configurations"""
import ConfigParser, os, pkg_resources
...
class Fastener(object):
    ...
    CONFIG_SCHEMA_MAIN = {Required('driver'): All(str, Length(min=1))}
