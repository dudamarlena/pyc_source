...
# [GCC 8.4.0]
# Embedded file name: /media/psf/Home/Documents/workspace/rqalpha-mod-ctp/rqalpha_mod_ctp/ctp/data_dict.py
# Compiled at: 2017-05-26 11:08:42
import numpy as np
...
SIDE_REVERSE = {ApiStruct.D_Buy: SIDE.BUY, 
    ...
    def update_data(self, data):
        ...
        if self.exchange_id == 'SHFE':
            if data.OffsetFlag == ApiStruct.OF_Open:
                ...
                self.position_effect = POSITION_EFFECT.CLOSE
        elif data.OffsetFlag == ApiStruct.OF_Open:
            self.position_effect = POSITION_EFFECT.OPEN
        else:
            self.position_effect = POSITION_EFFECT.CLOSE
