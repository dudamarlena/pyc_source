...
# [GCC 8.4.0]
# Embedded file name: /Users/avalaunchit/Projects/personal/django-baker/django_baker/management/commands/bake.py
# Compiled at: 2017-01-04 23:12:36
...
class Command(BaseCommand):
    ...
    help = 'Generates generic views (create, update, detail, list, and delete), urls, forms, and admin for model in anapp.  Optionally can restrict which apps are generated on a per app basis.\n\nexample: python manage.py bake bread:Sesame,Pumpkernickel donut:Glazed,Chocolate'
