...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/mdt/keys.py
...
"""
import os, platform, shutil, subprocess, sys, paramiko
...
class Keystore:
    ...
    def __init__(self):
        ...
        elif not os.path.exists(KEYSDIR):
            os.makedirs(KEYSDIR, mode=448)
        else:
