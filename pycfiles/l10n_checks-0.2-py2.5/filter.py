...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/mozilla/core/filter.py
# Compiled at: 2009-07-05 09:07:40
import os.path
...
class Filter(object):
  ...
  """
    ...
    """
        ...
        filterpath = drive + url2pathname(urlparse(urljoin(pathname2url(tail), 'filter.py'))[2])
    ...
    """
        if not os.path.exists(filterpath):
            raise IOError('The path: ' + filterpath + ' to filter.py is wrong - the file does not exist there')
        l = {}
