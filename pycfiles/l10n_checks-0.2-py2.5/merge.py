...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/mozilla/core/merge.py
# Compiled at: 2009-10-10 21:40:18
import os
...
class Merge(object):
  ...
  """
    ...
    @staticmethod
    def basic_merge(optionpack, missingentities, refentitylist, relativepath, removedentities, urituple=None, id=None):
        """
        ...
        if urituple is not None and id is None:
            ...
            for entity in missingentities.values():
                if file.has_entity(entity.id):
                    raise Exception('The file ' + urituple[0] + ' has changed. Merge aborted.')
