...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/mozilla/format/ini/parser.py
# Compiled at: 2009-07-05 09:07:42
from silme.core import EntityList, Entity
from silme.format.properties.structure import *
import re
...
class IniParser:
    ...
    def split_entities(cls, text, object, code='default', pointer=0, end=None):
        ...
        while match:
            ...
            entity.params['source'] = {'type': 'ini', 'string': match.group(0), 
