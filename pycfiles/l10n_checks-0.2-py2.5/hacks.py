...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/mozilla/playground/hacks.py
# Compiled at: 2009-11-16 19:02:32
...
silme.format.properties.parser.PropertiesParser.parse_to_entitylist = properties_parse_to_entitylist
        ...
        try:
            ...
            try:
                if object_type == 'blob':
                    ...
                    l10npackage.add_structure(cls.get_entitylist(name, source=source, parser=parser), relpath)
                else:
                    l10npackage.add_structure(cls.get_structure(name, source=source, parser=parser), relpath)
