...
# [GCC 8.4.0]
# Embedded file name: /Users/geobaldi/src/ripiu/public/github/djangocms_aoxomoxoa/ripiu/djangocms_aoxomoxoa/migrations/0001_initial.py
# Compiled at: 2018-04-03 09:24:46
# Size of source mod 2**32: 463543 bytes
from __future__ import unicode_literals
import colorfield.fields, djangocms_attributes_field.fields, django.core.validators, django.db.models.deletion
...
class Migration(migrations.Migration):
    ...
    dependencies = [
     ...
     ('cms', '0018_pagenode')]
    operations = [
     migrations.CreateModel(name='CarouselPlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Carousel plugin', 
      'verbose_name_plural':'Carousel plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='CarouselSavedUniteOptions',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Carousel unite options', 
      'verbose_name_plural':'Carousel unite options'}),
     migrations.CreateModel(name='CompactThemePlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Compact theme plugin', 
      'verbose_name_plural':'Compact theme plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='CompactThemeSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Compact theme unite options', 
      'verbose_name_plural':'Compact theme unite options'}),
     migrations.CreateModel(name='DefaultThemePlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Default theme plugin', 
      'verbose_name_plural':'Default theme plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='DefaultThemeSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Default theme unite options', 
      'verbose_name_plural':'Default theme unite options'}),
     migrations.CreateModel(name='GridThemePlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Grid theme plugin', 
      'verbose_name_plural':'Grid theme plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='GridThemeSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Grid theme unite options', 
      'verbose_name_plural':'Grid theme unite options'}),
     migrations.CreateModel(name='SliderPlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Slider plugin', 
      'verbose_name_plural':'Slider plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='SliderSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Slider unite options', 
      'verbose_name_plural':'Slider unite options'}),
     migrations.CreateModel(name='TilesColumnsPlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Tiles - Columns plugin', 
      'verbose_name_plural':'Tiles - Columns plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='TilesColumnsSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Tiles - Columns unite options', 
      'verbose_name_plural':'Tiles - Columns unite options'}),
     migrations.CreateModel(name='TilesGridPlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Tiles - Grid plugin', 
      'verbose_name_plural':'Tiles - Grid plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='TilesGridSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Tiles - Grid unite options', 
      'verbose_name_plural':'Tiles - Grid unite options'}),
     migrations.CreateModel(name='TilesJustifiedPlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Tiles - Justified plugin', 
      'verbose_name_plural':'Tiles - Justified plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='TilesJustifiedSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Tiles - Justified unite options', 
      'verbose_name_plural':'Tiles - Justified unite options'}),
     migrations.CreateModel(name='TilesNestedPlugin',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Tiles - Nested plugin', 
      'verbose_name_plural':'Tiles - Nested plugins'},
       bases=(
      'cms.cmsplugin', models.Model)),
     migrations.CreateModel(name='TilesNestedSavedUniteOptions',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'name', models.CharField(max_length=255, verbose_name='name'))],
       options={'verbose_name':'Tiles - Nested unite options', 
      'verbose_name_plural':'Tiles - Nested unite options'}),
     migrations.AddField(model_name='tilesnestedplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='tilesjustifiedplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='tilesgridplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='tilescolumnsplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='sliderplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='gridthemeplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='defaultthemeplugin',
       name='saved_conf',
     ...
     migrations.AddField(model_name='compactthemeplugin',
       name='saved_conf',
