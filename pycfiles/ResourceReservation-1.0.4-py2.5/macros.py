...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/resreservation/macros.py
# Compiled at: 2011-04-30 04:57:57
import calendar
    ...
    for (i, month) in enumerate(months):
        ...
        for day in days:
            ...
            for resource in resources:
                name = resource['name']
                if name not in markup_per_resource:
