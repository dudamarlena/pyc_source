...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/resreservation/model.py
# Compiled at: 2011-04-30 05:25:02
import time
...
class TestManagerModelProvider(Component):
    ...
    def _upgrade_db(self, db):
        ...
        try:
            ...
            db.commit()
            cursor = db.cursor()
            cursor.execute('INSERT INTO wiki (name,version,time,author,ipnr,text,comment,readonly) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)', (
