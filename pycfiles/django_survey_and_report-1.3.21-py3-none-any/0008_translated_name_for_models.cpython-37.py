...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/migrations/0008_translated_name_for_models.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterModelOptions(name='response',
       options={'verbose_name':'Set of answers to surveys', 
