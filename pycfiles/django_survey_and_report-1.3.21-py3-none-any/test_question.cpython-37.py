...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/tests/models/test_question.py
# Compiled at: 2020-01-26 10:04:59
# Size of source mod 2**32: 14039 bytes
...
class TestQuestion(BaseModelTest):
    ...
    def test_get_choices(self):
        ...
        self.assertEqual(self.questions[0].get_choices(), (('женщина', 'Женщина'),
                                                           ('мужчина', 'Мужчина')))
    ...
    def test_get_choices_with_pipe(self):
        ...
        self.assertEqual(self.questions[0].get_choices(), (('yes-i-do', 'Yes, I do'),
    ...
    def test_answers_cardinality_linked(self):
        ...
        q2 = self.questions[2]
        self.assertEqual(q1ac(other_question=q2), {'abé cé':{'dë': 1}, 
         'Abë-cè':{'dë': 1}, 
         'Abé Cé':{'dë': 1}, 
         'dé':{'Abë-cè': 1}, 
         'Dé':{'Abë-cè': 1}, 
    ...
    def test_answers_cardinality_linked_without_link(self):
        ...
        for i in range(3):
            question = Question.objects.create(text=(str(i + 1)),
              order=i,
              required=True,
              survey=survey,
