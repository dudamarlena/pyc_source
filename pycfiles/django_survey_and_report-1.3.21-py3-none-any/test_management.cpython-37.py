...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/tests/management/test_management.py
...
class TestManagement(BaseTest):
    __doc__ = ' Permit to check if export result is working as intended. '
    ...
    def create_survey(self):
        ...
        self.survey = Survey.objects.create(name=(self.test_managament_survey_name),
          is_published=True,
        ...
        self.create_answers(self.other_username, "[u'1e', u'1é', u'1ë']", "[u'2e', u'2é', u'2ë']", "[u'3e', u'3é', u'3ë']")
    ...
    def create_big_ranking_survey(self, with_user=False):
        ...
        ranking_survey = Survey.objects.create(name=ranking_survey_name,
          is_published=True,
        ...
        for i in range(number_of_question):
            question = Question.objects.create(text=('How much do you like question {} ?'.format(i + 1)),
              order=i,
              required=True,
        ...
        for j in range(number_of_participant):
            ...
            response = Response.objects.create(survey=ranking_survey, user=user)
