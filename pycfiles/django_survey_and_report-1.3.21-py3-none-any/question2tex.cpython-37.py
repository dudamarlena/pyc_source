...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/exporter/tex/question2tex.py
# Compiled at: 2020-02-24 14:43:41
...
class Question2Tex:
    ...
    def __init__(self, question, **options):
        ...
        self.cardinality = self.question.sorted_answers_cardinality(self.min_cardinality, self.group_together, self.group_by_letter_case, self.group_by_slugify, self.filter, self.sort_answer)
    ...
    def get_caption_min_cardinality(self):
        ...
        if self.min_cardinality > 0:
            caption += '{} {} '.format(_('with'), ungettext('%(min_cardinality)d respondants or more', '%(min_cardinality)d respondant or more', self.min_cardinality) % {'min_cardinality': self.min_cardinality})
        return caption
    ...
    def get_caption_group_together(self):
        ...
        if self.group_together:
            ...
            for key in loop_dict:
                ...
                if values is None:
                    continue
                standardized_values = Question.standardize_list(values, self.group_by_letter_case, self.group_by_slugify)
