...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/tests/exporter/csv/test_issue70.py
...
class TestIssue70(TestCase):
    ...
    def test_get_survey_as_csv(self):
        header = 'user,Email Address,Your Name,Date,STARTS Who? What? Where?,Donations,Books Sold,Your Total Volunteer hours for this week,Your Volunteer Activities this week.,Included in the above hours; how many of those above hours were on filing,New Hires,Charitable Donations,Events held What? Where? Products gotten?'
        content = "adminebd,user@example.com,Ed Davison,2020-02-03,Left blank,0,0,8,['Admin'; 'Calls'; 'Events'],0,Left blank,100,"
