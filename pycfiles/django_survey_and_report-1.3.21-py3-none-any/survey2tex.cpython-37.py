...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/exporter/tex/survey2tex.py
...
class Survey2Tex(Survey2X):
    ...
    def treat_question(self, question):
        ...
        for chart_title, opts in list(multiple_charts.items()):
            ...
            if tex_type == 'raw':
                ...
                msg = "{} '{}' {}".format(_('We could not render a chart because the type'), tex_type, _("is not a standard type nor the path to an importable valid Question2Tex child class. Choose between 'raw', 'sankey', 'pie', 'cloud', 'square', 'polar' or 'package.path.MyQuestion2TexCustomClass'"))
                LOGGER.error(msg)
    ...
    def compile_pdf(self):
        ...
        xelatex_command = [
         xelatex, '-interaction=batchmode', '-halt-on-error', self.filename.name]
