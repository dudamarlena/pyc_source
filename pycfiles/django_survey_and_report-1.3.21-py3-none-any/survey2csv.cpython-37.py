...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/exporter/csv/survey2csv.py
...
class Survey2Csv(Survey2X):
    ...
    def get_user_line(question_order, response):
        ...
        for answer in response.answers.all():
            Survey2Csv._Survey2Csv__get_user_line_from_answers(answer, user_answers)
