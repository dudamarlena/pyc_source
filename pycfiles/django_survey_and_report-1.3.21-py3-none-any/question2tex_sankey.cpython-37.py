...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/exporter/tex/question2tex_sankey.py
...
class Question2TexSankey(Question2Tex):
    ...
    def tex(self):
        ...
        self.cardinality = self.question.sorted_answers_cardinality((self.min_cardinality),
          (self.group_together),
