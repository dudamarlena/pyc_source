...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/exporter/tex/configuration.py
# Compiled at: 2020-02-22 13:47:33
# Size of source mod 2**32: 7161 bytes
import collections, copy, logging
...
class Configuration:
    ...
    def get(self, key=None, survey_name=None, question_text=None):
        ...
        try:
            ...
            self._Configuration__raise_get_error(conf, key, question_text, survey_name)
