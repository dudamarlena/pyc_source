...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='AnswerBase',
       fields=[
      (
     ...
     migrations.CreateModel(name='Question',
      ...
      (
       'question_type',
       models.CharField(default=b'text',
         max_length=200,
         choices=[
      ...
      (
       'choices',
       models.TextField(help_text="if the question type is 'radio', 'select', or 'select multiple' provide a comma-separated list of options for this question .",
         null=True,
         blank=True)),
      (
     ...
     migrations.CreateModel(name='Response',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
      ...
      (
       ...
       options={'verbose_name':'response', 
      'verbose_name_plural':'responses'}),
     migrations.CreateModel(name='Survey',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
     ...
     migrations.CreateModel(name='AnswerInteger',
       fields=[
      (
       'answerbase_ptr',
     ...
     migrations.CreateModel(name='AnswerRadio',
       fields=[
      (
       'answerbase_ptr',
       models.OneToOneField(parent_link=True,
      ...
      (
       ...
       bases=('survey.answerbase', )),
     migrations.CreateModel(name='AnswerSelect',
       fields=[
      (
       'answerbase_ptr',
       models.OneToOneField(parent_link=True,
      ...
      (
       'body', models.TextField(null=True, blank=True))],
       bases=('survey.answerbase', )),
     migrations.CreateModel(name='AnswerSelectMultiple',
       fields=[
      (
       'answerbase_ptr',
       models.OneToOneField(parent_link=True,
      ...
      (
       'body', models.TextField(null=True, blank=True))],
       bases=('survey.answerbase', )),
     migrations.CreateModel(name='AnswerText',
       fields=[
      (
       'answerbase_ptr',
       models.OneToOneField(parent_link=True,
      ...
      (
       'body', models.TextField(null=True, blank=True))],
       bases=('survey.answerbase', )),
     migrations.AddField(model_name='response',
       name='survey',
     ...
     migrations.AddField(model_name='category',
       name='survey',
       field=models.ForeignKey(to='survey.Survey', on_delete=(models.CASCADE))),
     migrations.AddField(model_name='answerbase',
       name='question',
