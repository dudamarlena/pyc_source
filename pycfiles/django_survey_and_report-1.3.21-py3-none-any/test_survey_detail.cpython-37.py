...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/tests/views/test_survey_detail.py
# Compiled at: 2020-02-25 03:09:18
...
class TestSurveyDetail(BaseTest):
    ...
    def test_survey_non_editable(self):
        ...
        """
        self.login()
        response = self.client.post(reverse('survey-detail', args=(1, )),
          data={'question_1':'maybe', 
         'question_2':'no', 
    ...
    def test_multipage_survey_edit(self):
        ...
        response_saved = Response.objects.filter(user__username=(settings.DEBUG_ADMIN_NAME), survey__id=5)
        self.assertEqual(len(response_saved.all()), 1)
        answer_saved = Answer.objects.filter(response__user__username=(settings.DEBUG_ADMIN_NAME),
