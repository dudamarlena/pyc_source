...
# [GCC 8.4.0]
# Embedded file name: /home/pierre/workspace/django-survey/survey/tests/exporter/tex/test_configuration.py
# Compiled at: 2020-02-09 14:11:39
...
class TestConfiguration(TestManagement):
    ...
    def setUp(self):
        ...
        self.qts_conf = self.conf.get(survey_name='Test survëy',
          question_text='Dolor sit amët, consectetur<strong>  adipiscing</strong>  elit.')
        self.qts_expected_conf = {'min_cardinality':0, 
         'type':'cloud',  'radius':1,  'text':'inside'}
        ...
        for chart in qts_charts:
            for key, expected_value in list(self.qts_expected_conf.items()):
                ...
                if chart == 'Sub Sub Section with radius=3' and key == 'radius':
                    ...
                    if chart == 'Sub Sub Section with text=pin':
                        if key == 'text':
                            expected_value = 'pin'
                self.assertEqual(value, expected_value, "Expected '{}' for '{}' in '{}' and got '{}'".format(expected_value, key, chart, value))
