...
# Embedded file name: build/bdist.linux-i686/egg/poly/cat.py
# Compiled at: 2005-12-08 10:38:38
...
class DynamicInit(object):
    ...
    def __getattribute__(self, name):
        ...
        try:
            _super.__init__(*object.__getattribute__(self, '_DynamicInit__args'), **object.__getattribute__(self, '_DynamicInit__keywds'))
            del self.__args
            del self.__keywds
