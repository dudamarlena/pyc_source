...
# Embedded file name: build/bdist.linux-i686/egg/couchish/tests/test_couchish_jsonbuilder.py
# Compiled at: 2009-04-23 06:04:07
import unittest
...
class Test(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        assert viewdata['attributes_by_viewname'] == {'customdesigndoc/author_surname': {'dvd': set(['writtenby']), 'book': set(['coauthored'])}, 
           'customdes/author_name': {'post': set(['author']), 'book': set(['writtenby'])}}
