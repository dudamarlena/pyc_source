...
# Embedded file name: build/bdist.linux-i686/egg/couchish/formish_jsonbuilder.py
# Compiled at: 2010-03-01 05:14:43
...
class FormishWidgetRegistry(object):
    ...
    def __init__(self):
        self.registry = {'Input': self.input_factory, 
        ...
        self.defaults = {'Date': self.dateparts_factory, 
    ...
    def fileupload_factory(self, spec, k):
        ...
        return formish.FileUpload(filestore.CachedTempFilestore(filestore.FileSystemHeaderedFilestore(root_dir=root_dir)), url_base=url_base, image_thumbnail_default=image_thumbnail_default, show_download_link=show_download_link, show_file_preview=show_file_preview, show_image_thumbnail=show_image_thumbnail, **k)
