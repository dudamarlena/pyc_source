...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/lbdrabbit-project/lbdrabbit/example/cf.py
# Compiled at: 2019-10-05 14:01:16
...
param_env_name = tm.Parameter('EnvironmentName',
  Type='String')
...
rest_api = apigateway.RestApi('RestApi',
 ...
 'REGIONAL']))
lambda_code = awslambda.Code(S3Bucket=(app_config.LAMBDA_CODE_S3_BUCKET.get_value()),
