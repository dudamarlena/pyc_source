...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/lbdrabbit-project/lbdrabbit/lbd_func_config/base.py
# Compiled at: 2019-10-06 12:02:17
    ...
    def absorb(self, other):
        ...
        **中文文档**
        ...
        for key, value in this_data.items():
            if isinstance(value, Sentinel) and key in other_data:
...
def config_inherit_handler(module_name: str, config_field: str, config_class: typing.Type[BaseConfig], valid_func_name_list: typing.List[str]):
    """
    ...
    **功能**
    ...
    for py_current_module, py_parent_module, py_handler_func in walk_lbd_handler(module_name, valid_func_name_list):
        current_module_config = py_current_module.__dict__.get(config_field, config_class())
        try:
            parent_module_config = py_parent_module.__dict__.get(config_field, config_class())
        except:
        ...
        if py_handler_func is not None:
            py_handler_func_config = py_handler_func.__dict__.get(config_field, config_class())
