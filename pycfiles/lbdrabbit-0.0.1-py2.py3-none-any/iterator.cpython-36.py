...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/lbdrabbit-project/lbdrabbit/config_inherit/iterator.py
# Compiled at: 2019-10-01 12:16:42
...
def walk_lbd_handler(module_name, valid_func_name_list):
    ...
    **中文文档**
    ...
    for current_module, parent_module, sub_packages, sub_modules in pkg.walk(pkg_only=False):
