...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/garmdown/backup.py
...
class Backuper(object):
    __doc__ = 'Backup the SQLite database on a periodic basis.\n\n    '
    ...
    def backup(self, force=False):
        ...
        if force:
            ...
            if backup is None:
                ...
                diff_days = diff.days
                logger.info(f"days since last backup: {diff_days} and we " + f"backup every {self.backup_params.days} days")
