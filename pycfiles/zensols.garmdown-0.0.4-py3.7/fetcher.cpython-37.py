...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/garmdown/fetcher.py
# Compiled at: 2020-03-02 18:14:59
# Size of source mod 2**32: 7250 bytes
import logging, json, re, itertools as it
...
class Fetcher(object):
    __doc__ = 'Downloads Garmin TXC files and activities (metadata).\n\n    '
    ...
    def _download_activities(self, index, chunk_size):
        ...
        params = {'index':index,  'activity_chunk_size':chunk_size}
    ...
    def get_activities(self, limit=None, start_index=0):
        ...
        al = map(lambda x: self._iterate_activities(x, activity_chunk_size), range(start_index, activity_num, activity_chunk_size))
