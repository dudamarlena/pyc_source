...
# [GCC 8.4.0]
# Embedded file name: /Users/skemper/workspace/hotcidr/venv/lib/python2.7/site-packages/hotcidr/modifydatabase.py
# Compiled at: 2014-08-29 18:27:13
...
def printSinceSpecifiedTime(fromTime, toTime):
    ...
    select_queryA = 'SELECT * FROM ADDED_RULES'
    ...
    select_queryD = 'SELECT * FROM DELETED_RULES'
...
def modifyTable(dictEntry):
    ...
    query = 'INSERT INTO ' + table + '(`modifiedGroup`, `description`, `direction`, `protocol`, `location`, `toport`, `fromport`, `justification`, `time_and_date`, `secondsAgo`)VALUES(%s,%s,%s,%s,%s,%s,%s,%s, %s, %s)'
    queryParams = (
     dictEntry['modifiedGroup'], dictEntry['description'], dictEntry['direction'], dictEntry['protocol'], dictEntry['location'], dictEntry['toport'], dictEntry['fromport'], dictEntry['justification'], dictEntry['time_and_date'], dictEntry['secondsAgo'])
