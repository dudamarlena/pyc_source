...
# [GCC 8.4.0]
# Embedded file name: /Users/skemper/workspace/hotcidr/venv/lib/python2.7/site-packages/hotcidr/test/test_validation.py
# Compiled at: 2015-05-15 12:09:08
import unittest, hotcidr.validation as validation
...
class TestFindUnusedGroups(TestCase):
    ...
    def test_all_groups_used(self):
        self.v.boxes = {'box1': {'groups': ['group1', 'group2']}, 'box2': {'groups': ['group1']}, 'box3': {'groups': ['group3']}}
...
class TestValidateGroups(TestCase):
    ...
    def test_undefined_group(self):
        self.v.boxes = {'box1': {'groups': ['dog', 'cat']}, 'box2': {'groups': ['bear']}, 'box3': {'groups': ['cat', 'bare']}}
...
class TestValidateGroupNames(TestCase):
    ...
    def test_valid(self):
        self.v.groups = {'group1': {}, 'group_2': {}, 'hotcidr': {}}

    def test_invalid(self):
        self.v.groups = {'nyan~~': {}, '^_^': {}, 'actually valid :)': {}}
...
class TestValidateAWSInstanceID(TestCase):
    ...
    def test_valid(self):
        self.v.boxes = {'i-aaaaaaaa': {}, 'i-bbbbbbbb': {}, 'i-cccccccc': {}, 'i-dddddddd': {}}

    def test_invalid(self):
        self.v.boxes = {'instance_1': {}}
...
class TestValidateAWSGroupID(TestCase):
    ...
    def test_valid(self):
        self.v.groups = {'group1': {'id': 'sg-12345678'}, 
           'group2': {'id': 'sg-23456789'}}

    def test_invalid(self):
        self.v.groups = {'group1': {'id': 'sg-34567890'}, 
           'group2': {'id': 'sg-34567890'}}
...
class TestValidateProtocols(TestCase):
    ...
    def test_valid(self):
        self.v.groups = {'group1': {'rules': [{'protocol': 'ICMP'}, {'protocol': 'TCP'}]}, 'group2': {'rules': [{'protocol': 'ICMP'}, {'protocol': 'UDP'}]}}

    def test_invalid(self):
        self.v.groups = {'group1': {'rules': [{}]}, 'group2': {'rules': [{'protocol': '-1'}]}}
...
class TestValidateGroupFields(TestCase):
    ...
    def test_valid(self):
        self.v.groups = {'group1': {'description': 'Sample group 1', 
                      'id': 'sg-567890ab', 
                      'rules': []}, 
           'group2': {'description': 'Sample group 2', 
                      'id': 'sg-67890abc', 
                      'rules': []}}
...
class TestValidateInstanceFields(TestCase):
    ...
    def test_valid(self):
        self.v.boxes = {'i-eeeeeeee': {'ip': '10.8.0.1', 
                          'domain': 'hotcidr-1.example.com', 
                          'groups': []}, 
           'i-ffffffff': {'ip': '10.8.0.2', 
                          'domain': 'hotcidr-2.example.com', 
                          'groups': []}, 
           'i-11111111': {'ip': '10.8.0.3', 
                          'domain': 'hotcidr-3.example.com', 
                          'groups': []}}

    def test_invalid(self):
        self.v.boxes = {'i-22222222': {'domain': 'hotcidr-1.example.com', 
                          'groups': []}, 
           'i-33333333': {'ip': '10.8.0.2'}, 
           'i-44444444': {}}
...
class TestValidateLocations(TestCase):
    ...
    def test_valid(self):
        self.v.groups = {'a': {'id': 'sg-55555555'}, 'b': {'rules': [{'location': 'a'}, {'location': '0.0.0.0/0'}, {'location': '10.8.0.1/32'}]}}

    def test_invalid(self):
        self.v.groups = {'a': {}, 'b': {'rules': [{'location': 'd'}, {'location': '192.168.1.1/24'}, {'location': '8.8.8.8/0'}]}}
