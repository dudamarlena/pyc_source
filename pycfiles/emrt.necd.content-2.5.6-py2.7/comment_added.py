...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/emrt/necd/content/notifications/comment_added.py
...
NOTIFY_MSE = partial(notify_role, ROLE_MSE, 'comment_to_mse.pt', 'comment_to_mse')
NOTIFY_MSA = partial(notify_role, ROLE_MSA, 'comment_to_msa.pt', 'comment_to_msa')
