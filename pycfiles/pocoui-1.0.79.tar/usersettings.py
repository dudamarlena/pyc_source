...
class UserSignatureSettings(UserSettingsPage):
    ...
    def get_settings_page(self, req):
        ...
        return (
         'settings/signature.html', {'form': form.generate(prefix='f_'), 'msg': msg, 'editor_options': options, 'editor_javascript': js})
...
class AvatarSettings(UserSettingsPage):
    ...
    def get_settings_page(self, req):
        ...
        return (
         'settings/avatar.html', {'form': form.generate(prefix='f_'), 'avatar': avatar, 'msg': msg})
...
class UserForumSettings(UserSettingsPage):
    ...
    def get_settings_page(self, req):
        ...
        return ('settings/forumsettings.html', {'form': form.generate(prefix='f_'), 'msg': msg})