...
# Embedded file name: build/bdist.linux-i686/egg/pocoo/utils/path.py
# Compiled at: 2006-12-26 17:18:07
__doc__ = '\n    pocoo.utils.path\n    ~~~~~~~~~~~~~~~~\n\n    path.py - An object representing a path to a file or directory.\n\n    :copyright: 2004 by Jason Orendorff.\n    :license: GNU GPL, see LICENSE for more details.\n'
...
class path(_base):
        ...
        for child in childList:
            ...
            try:
                ...
                if errors == 'ignore':
                    ...
                    warnings.warn("Unable to access '%s': %s" % (child, sys.exc_info()[1]), TreeWalkWarning)
                    isdir = False
                else:
                    raise
        ...
        for child in childList:
            try:
                ...
                if errors == 'ignore':
                    ...
                    warnings.warn("Unable to access '%s': %s" % (self, sys.exc_info()[1]), TreeWalkWarning)
                else:
                    raise
    ...
    def write_lines(self, lines, encoding=None, errors='strict', linesep=os.linesep, append=False):
