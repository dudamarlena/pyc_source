...
# Embedded file name: build/bdist.linux-x86_64/egg/aomi/model/aws.py
# Compiled at: 2017-11-17 12:53:02
# Size of source mod 2**32: 4574 bytes
__doc__ = 'AWS Secret Backend'
import logging, aomi.exceptions, aomi.model.resource
...
class AWS(Secret):
    ...
    def fetch(self, vault_client):
        if is_mounted(self.backend, self.mount, vault_client.list_secret_backends()):
            self.existing = True
    ...
    def obj(self):
        ...
        return {'access_key': aws_obj['access_key_id'], 
