...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\gamegridp\gamegrid_console.py
# Compiled at: 2018-09-13 05:52:42
...
class Console(object):
    ...
    def __init__(self, grid, lines):
        ...
        self.text_queue = []
        self.posy = 0
        self.width = self.grid.grid_width_in_pixels
        self.dirty = 1
    ...
    def draw(self):
        if self.dirty == 1:
            console = pygame.Surface((self.grid.grid_width_in_pixels, self.height))
