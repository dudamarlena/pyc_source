...
# [GCC 8.4.0]
# Embedded file name: /home/hasher/apps/workflow/workflowapp/createflow.py
# Compiled at: 2016-03-17 06:55:33
import imp
...
class BuildWorkflow(object):
    ...
    def get_open_task_list(self):
        ...
        for tasks in all_tasks:
            list_all_tasks.append(tasks.title)
    ...
    def visualize(self):
        ...
        result.update({'state_list': state_list, 'transition_list1': transition_list1, 'transition_list2': transition_list2, 'transition_list3': transition_list3, 
