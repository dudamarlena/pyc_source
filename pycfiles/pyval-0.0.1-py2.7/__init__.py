...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/pyval/__init__.py
# Compiled at: 2016-02-08 22:00:11
...
class Required(Validator):
    ...
    def validate(self, value):
        if value is None or isinstance(value, collections.Iterable) and len(value) == 0 or isinstance(value, basestring) and value.strip() == '':
            raise ValidationError(self.error_msg)
        return
