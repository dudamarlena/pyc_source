...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/errornot/notifier.py
# Compiled at: 2010-03-11 09:03:41
"""ErrorNot notifier.
"""
...
import traceback, urllib, httplib
API_KEY = None
API_VERSION = None
HOST = None
DATA_RECORDS = [
...
def get_error(request=None, environment=None):
  ...
  """
    ...
    error = {'raised_at': raised_at, 'message': message, 
       'backtrace': backtrace, 
       'request': request, 
...
def post_error(error):
  ...
  """
    data = {'api_key': API_KEY, 'version': API_VERSION, 
       'error': error}
