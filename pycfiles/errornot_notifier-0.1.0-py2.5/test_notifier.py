...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/errornot/tests/test_notifier.py
# Compiled at: 2010-03-09 04:53:34
import httplib, logging, sys
...
def HTTP_SUCCESS(host):
    return fudge.Fake().provides('putrequest').provides('putheader').provides('endheaders').provides('send').provides('getreply').returns([200, None, None])
    ...
    def test_process_payload(self):
        data = {'api_key': '123456', 
           ...
           'error': {'message': 'coucou', 
                     ...
                     'backtrace': [
                                 'line1', 'line2', 'line3'], 
                     'request': {'params': {'toto': 'titi'}}}}
        res = notifier.process_payload(data)
        expexted = {'api_key': '123456', 
