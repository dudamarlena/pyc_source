...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/iw/cache/tests/test_cachedocstrings.py
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        suite.append(doctest.DocTestSuite('iw.cache.%s' % test, optionflags=flags, globs=globs, setUp=cacheSetUp, tearDown=cacheTearDown))
