...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/bytecodehacks/inline.py
...
from bytecodehacks.ops import LOAD_GLOBAL, RETURN_VALUE, SET_LINENO, CALL_FUNCTION, JUMP_FORWARD, STORE_FAST
