...
# Embedded file name: build\bdist.win32\egg\PyFDP\FDP.py
# Compiled at: 2018-01-24 14:09:10
from ctypes import *
import os, re, PyFDP
FDP_REGISTER = [{'name': 'FDP_RAX_REGISTER', 'value': 0}, {'name': 'FDP_RBX_REGISTER', 'value': 1}, {'name': 'FDP_RCX_REGISTER', 'value': 2}, {'name': 'FDP_RDX_REGISTER', 'value': 3}, {'name': 'FDP_R8_REGISTER', 'value': 4}, {'name': 'FDP_R9_REGISTER', 'value': 5}, {'name': 'FDP_R10_REGISTER', 'value': 6}, {'name': 'FDP_R11_REGISTER', 'value': 7}, {'name': 'FDP_R12_REGISTER', 'value': 8}, {'name': 'FDP_R13_REGISTER', 'value': 9}, {'name': 'FDP_R14_REGISTER', 'value': 10}, {'name': 'FDP_R15_REGISTER', 'value': 11}, {'name': 'FDP_RSP_REGISTER', 'value': 12}, {'name': 'FDP_RBP_REGISTER', 'value': 13}, {'name': 'FDP_RSI_REGISTER', 'value': 14}, {'name': 'FDP_RDI_REGISTER', 'value': 15}, {'name': 'FDP_RIP_REGISTER', 'value': 16}, {'name': 'FDP_DR0_REGISTER', 'value': 17}, {'name': 'FDP_DR1_REGISTER', 'value': 18}, {'name': 'FDP_DR2_REGISTER', 'value': 19}, {'name': 'FDP_DR3_REGISTER', 'value': 20}, {'name': 'FDP_DR6_REGISTER', 'value': 21}, {'name': 'FDP_DR7_REGISTER', 'value': 22}, {'name': 'FDP_VDR0_REGISTER', 'value': 23}, {'name': 'FDP_VDR1_REGISTER', 'value': 24}, {'name': 'FDP_VDR2_REGISTER', 'value': 25}, {'name': 'FDP_VDR3_REGISTER', 'value': 26}, {'name': 'FDP_VDR6_REGISTER', 'value': 27}, {'name': 'FDP_VDR7_REGISTER', 'value': 28}, {'name': 'FDP_CS_REGISTER', 'value': 29}, {'name': 'FDP_DS_REGISTER', 'value': 30}, {'name': 'FDP_ES_REGISTER', 'value': 31}, {'name': 'FDP_FS_REGISTER', 'value': 32}, {'name': 'FDP_GS_REGISTER', 'value': 33}, {'name': 'FDP_SS_REGISTER', 'value': 34}, {'name': 'FDP_RFLAGS_REGISTER', 'value': 35}, {'name': 'FDP_MXCSR_REGISTER', 'value': 36}, {'name': 'FDP_GDTRB_REGISTER', 'value': 37}, {'name': 'FDP_GDTRL_REGISTER', 'value': 38}, {'name': 'FDP_IDTRB_REGISTER', 'value': 39}, {'name': 'FDP_IDTRL_REGISTER', 'value': 40}, {'name': 'FDP_CR0_REGISTER', 'value': 41}, {'name': 'FDP_CR2_REGISTER', 'value': 42}, {'name': 'FDP_CR3_REGISTER', 'value': 43}, {'name': 'FDP_CR4_REGISTER', 'value': 44}, {'name': 'FDP_CR8_REGISTER', 'value': 45}]
...
class FDP(object):
    ...
    FDP_CRHBP = 5
    FDP_WRONG_ADDRESS = 0
    FDP_VIRTUAL_ADDRESS = 1
    FDP_PHYSICAL_ADDRESS = 2
    FDP_WRONG_BP = 0
    FDP_EXECUTE_BP = 1
    FDP_WRITE_BP = 2
    FDP_READ_BP = 4
    FDP_INSTRUCTION_FETCH_BP = 8
    FDP_STATE_PAUSED = 1
    FDP_STATE_BREAKPOINT_HIT = 2
    FDP_STATE_DEBUGGER_ALERTED = 4
    FDP_STATE_HARD_BREAKPOINT_HIT = 8
    FDP_CPU0 = 0
    ...
    def __init__(self, Name):
        ...
        for reg in FDP_REGISTER:
            ...
            def get_property(enum):
                ...
                def read(self):
                    return self.ReadRegister(enum)

                def write(self, value):
                    self.WriteRegister(enum, value)
    ...
    def __fix_names__(self, name):
        regx = re.compile('FDP_(.*)_REGISTER')
