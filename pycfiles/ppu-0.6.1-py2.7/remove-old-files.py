...
# [GCC 8.4.0]
# Embedded file name: build/scripts-2.7/remove-old-files.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--empty-dirs', action='store_true', help='remove empty directories')
    parser.add_argument('-o', '--older', required=True, type=int, help='remove files older than this (in days)')
    ...
    print(('Removed {0:d} files/dirs, freed {1:d} bytes, {2:d} errors').format(count, size, errors))