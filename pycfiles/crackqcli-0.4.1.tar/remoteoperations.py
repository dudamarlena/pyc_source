...
# Embedded file name: /home/byt3bl33d3r/.virtualenvs/CME_old/lib/python2.7/site-packages/cme/remoteoperations.py
...
class RemoteOperations:
    ...
    def getMachineNameAndDomain(self):
        if self.__smbConnection.getServerName() == '':
            ...
            dce.disconnect()
            return (
             resp['WkstaInfo']['WkstaInfo100']['wki100_computername'][:-1], resp['WkstaInfo']['WkstaInfo100']['wki100_langroup'][:-1])
        else:
            return (
