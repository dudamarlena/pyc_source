...
# Embedded file name: /home/byt3bl33d3r/.virtualenvs/CME_old/lib/python2.7/site-packages/cme/cmedb.py
# Compiled at: 2016-12-29 01:49:52
import requests
from requests import ConnectionError
from requests.packages.urllib3.exceptions import InsecureRequestWarning
requests.packages.urllib3.disable_warnings(InsecureRequestWarning)
import cmd, sqlite3, sys, os, argparse
...
class CMEDatabaseNavigator(cmd.Cmd):
    ...
    def display_creds(self, creds):
        ...
        for cred in creds:
            ...
            print ('  {}{}{}{}{}{}').format(('{:<8}').format(credID), ('{:<13}').format(str(len(links)) + ' Host(s)'), ('{:<12}').format(credType), ('{:<17}').format(domain.decode('utf-8')), ('{:<21}').format(username.decode('utf-8')), ('{:<17}').format(password.decode('utf-8')))
    ...
    def display_hosts(self, hosts):
        ...
        for host in hosts:
            ...
            print ('  {}{}{}{}{}{}').format(('{:<8}').format(hostID), ('{:<15}').format(str(len(links)) + ' Cred(s)'), ('{:<17}').format(ip), ('{:<25}').format(hostname.decode('utf-8')), ('{:<17}').format(domain.decode('utf-8')), ('{:<17}').format(os))
    ...
    def do_import(self, line):
        ...
        if line == 'empire':
            ...
            msf = Msfrpc({'host': self.config.get('Metasploit', 'rpc_host'), 'port': self.config.get('Metasploit', 'rpc_port')})
            try:
        ...
        if filterTerm == '':
            ...
            if len(hosts) > 1:
                ...
                for host in hosts:
                    ...
                    domain = host[3]
                    os = host[4]
                    print ('  {}{}{}{}{}').format(('{:<8}').format(hostID), ('{:<17}').format(ip), ('{:<25}').format(hostname.decode('utf-8')), ('{:<17}').format(domain.decode('utf-8')), ('{:<17}').format(os))
                ...
                for hostID in hostIDList:
                    ...
                    for link in links:
                        ...
                        for cred in creds:
                            ...
                            username = cred[3]
                            password = cred[4]
                            print ('  {}{}{}{}{}').format(('{:<8}').format(credID), ('{:<12}').format(credType), ('{:<17}').format(domain.decode('utf-8')), ('{:<21}').format(username.decode('utf-8')), ('{:<17}').format(password.decode('utf-8')))
    ...
    def do_creds(self, line):
        ...
        if filterTerm == '':
            ...
            for cred in creds:
                ...
                print ('  {}{}{}{}{}{}').format(('{:<8}').format(credID), ('{:<12}').format(credType), ('{:<22}').format(pillaged_from), ('{:<17}').format(domain.decode('utf-8')), ('{:<21}').format(username.decode('utf-8')), ('{:<17}').format(password.decode('utf-8')))
