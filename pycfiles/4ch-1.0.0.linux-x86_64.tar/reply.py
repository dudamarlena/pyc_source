...
# [GCC 8.4.0]
# Embedded file name: /home/zed/venvs/4ch/lib/python2.7/site-packages/fourch/reply.py
# Compiled at: 2014-09-20 11:38:05
import fourch, base64, re
...
class Reply(object):
    ...
    def __repr__(self):
        return ('<{0}.{1} /{2}/{3}#{4}, image: {5}>').format(self.__class__.__module__, self.__class__.__name__, self._thread._board.name, self._thread.res, self.number, bool(self.has_file))
    ...
    def url(self):
        ...
        return ('{0}{1}/{2}/thread/{3}#p{4}').format(self._thread._board.proto, self._thread._board._urls['boards'], self._thread._board.name, self._thread.res, self.number)
    ...
    def file(self):
        ...
        f = {'renamed': self._json.get('tim', 0), 'name': self._json.get('filename', ''), 
           ...
           'url': '', 
           'thumb_url': ''}
        f['url'] = ('{0}{1}/{2}/{3}{4}').format(self._thread._board.proto, fourch.urls['images'], self._thread._board.name, f['renamed'], f['extension'])
        f['thumb_url'] = ('{0}{1}/{2}/{3}s.jpg').format(self._thread._board.proto, fourch.urls['thumbs'], self._thread._board.name, f['renamed'])
