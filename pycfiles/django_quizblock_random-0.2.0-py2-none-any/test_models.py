...
# [GCC 8.4.0]
# Embedded file name: /home/anders/work/python/django-quizblock-random/quizblock_random/tests/test_models.py
# Compiled at: 2015-08-05 06:26:22
from django.test import TestCase
from quizblock_random.models import QuizRandom, Submission, QuestionUserLock
from django.contrib.auth.models import User
from .factories import Dummy, QuestionUserLockFactory, CustomPagetreeModuleFactory, QuestionFactory, UserFactory, QuizRandomFactory
...
class TestBasics(TestCase):
    ...
    def test_edit(self):
        q = QuizRandom()
        q.edit(dict(description='foo', allow_redo='0', show_submit_state='on'), None)
...
class SubmissionTest(TestCase):
    ...
    def test_unicode(self):
        ...
        self.assertTrue(str(s).startswith('quiz %d submission by testuser' % quiz.id))
...
class TestQuestionUserLock(TestCase):
    ...
    def test_set_question_user_lock(self):
        ...
        self.assertIsNone(qul.set_question_user_lock(qul.question, None))
        qul.quiz = qul.question.quiz
        qul.save()
        self.assertIsNotNone(qul.set_question_user_lock(qul.question, None))
        return
