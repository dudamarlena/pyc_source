...
# Embedded file name: build/bdist.linux-x86_64/egg/pymic/net3d/demonet.py
...
class DemoNet(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.conv1 = nn.Conv3d((self.in_chns), (self.ft_chns[0]), kernel_size=(1, 3,
                                                                               3),
          padding=(0, 1, 1))
        self.conv2 = nn.Conv3d((self.ft_chns[0]), (self.ft_chns[0]), kernel_size=(1,
                                                                                  3,
                                                                                  3),
          padding=(0, 1, 1))
        self.conv = nn.Conv3d((self.ft_chns[0]), (self.n_class), kernel_size=(1, 3,
                                                                              3),
          padding=(0, 1, 1))
