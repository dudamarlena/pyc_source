...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/drink/objects/finder.py
...
def init():
    ...
    if os.path.exists(INDEX_DIR):
        ...
        os.mkdir(INDEX_DIR)
        indexer = create_in(INDEX_DIR, Schema(path=ID(stored=True, unique=True), title=TEXT(stored=True), content=TEXT))
...
def extract_obj(o):
    return {'path': unicode(o.path), 'title': unicode(o.title), 
