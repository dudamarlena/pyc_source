...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/drink/objects/tasks.py
...
class TODO(drink.Page):
    ...
    duration = 1
    start_time = '10:00'
    editable_fields = {'title': drink.types.Text('Title', group='a'), 
...
class TODOList(drink.Page):
    ...
    js = [
     '/static/fullcalendar.min.js', '/static/tasks.js']
