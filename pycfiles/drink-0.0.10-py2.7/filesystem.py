...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/drink/objects/filesystem.py
...
class PyFile(object):
    ...
    def view(self):
        if self.mime == 'folder':
            return drink.template('list.html', obj=self, css=[], js=[], classes={}, authenticated=drink.request.identity)
