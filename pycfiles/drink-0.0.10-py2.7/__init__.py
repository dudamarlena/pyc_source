...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/drink/__init__.py
...
def startup():
    ...
    if len(sys.argv) == 2 and sys.argv[1] == 'help':
        ...
        if dbg_in_env:
            ...
            if dbg_backend == 'auto':
                backends = [
                 dbg_werkzeug, dbg_repoze, dbg_weberror]
            else:
                backends = [
                 locals()[('dbg_%s' % dbg_backend)]]
