...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\plugins\exupery\insar.py
...
class InSARResourceType(Component):
    ...
    registerStylesheet('xslt' + os.sep + 'insar_displacement_metadata.xslt', 'metadata.displacement')
    registerStylesheet('xslt' + os.sep + 'insar_interferogram_metadata.xslt', 'metadata.interferogram')
    registerStylesheet('xslt' + os.sep + 'insar_differential_metadata.xslt', 'metadata.differential')
    ...
    registerIndex('upperleft_latitude', '/InSAR/range_upperleft/latitude/value', 'float')
    registerIndex('upperleft_longitude', '/InSAR/range_upperleft/longitude/value', 'float')
    registerIndex('lowerright_latitude', '/InSAR/range_lowerright/latitude/value', 'float')
    registerIndex('lowerright_longitude', '/InSAR/range_lowerright/longitude/value', 'float')
    registerIndex('local_path_image_absdphase', '/InSAR/files/file/local_path[../@id="absdphase_image"]', 'text')
    registerIndex('local_path_image_dphase', '/InSAR/files/file/local_path[../@id="dphase_image"]', 'text')
    registerIndex('local_path_image_phase', '/InSAR/files/file/local_path[../@id="phase_image"]', 'text')
    registerIndex('local_path_image_coherence', '/InSAR/files/file/local_path[../@id="coherence_image"]', 'text')
    registerIndex('local_path_image_amplitude', '/InSAR/files/file/local_path[../@id="amplitude_image"]', 'text')
    registerIndex('local_path_image_coh_absdphase', '/InSAR/files/file/local_path[../@id="coh_absdphase_image"]', 'text')
    registerIndex('local_path_image_coh_dphase', '/InSAR/files/file/local_path[../@id="coh_dphase_image"]', 'text')
    registerIndex('local_path_image_coh_phase', '/InSAR/files/file/local_path[../@id="coh_phase_image"]', 'text')
