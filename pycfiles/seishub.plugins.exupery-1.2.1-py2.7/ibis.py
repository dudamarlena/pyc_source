...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\plugins\exupery\ibis.py
...
class IBISResourceType(Component):
    ...
    registerStylesheet('xslt' + os.sep + 'ibis_metadata.xslt', 'metadata')
    registerStylesheet('xslt' + os.sep + 'ibis_displacement_metadata.xslt', 'metadata.displacement')
    ...
    registerIndex('upperleft_latitude', '/GBSAR_IBIS/image_information/range_upperleft/latitude/value', 'float')
    registerIndex('upperleft_longitude', '/GBSAR_IBIS/image_information/range_upperleft/longitude/value', 'float')
    registerIndex('lowerright_latitude', '/GBSAR_IBIS/image_information/range_lowerright/latitude/value', 'float')
    registerIndex('lowerright_longitude', '/GBSAR_IBIS/image_information/range_lowerright/longitude/value', 'float')
    registerIndex('local_path_image_quality', '/GBSAR_IBIS/files/file/local_path[../@id="coherence"]', 'text')
    registerIndex('local_path_image_displacement', '/GBSAR_IBIS/files/file/local_path[../@id="losdisplacement"]', 'text')
    registerIndex('local_path_image_phase', '/GBSAR_IBIS/files/file/local_path[../@id="phase"]', 'text')
