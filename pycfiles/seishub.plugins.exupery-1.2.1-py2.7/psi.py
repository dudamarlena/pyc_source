...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\plugins\exupery\psi.py
...
class PSIResourceType(Component):
    ...
    registerIndex('upperleft_latitude', '/PSI/range_upperleft/latitude/value', 'float')
    registerIndex('upperleft_longitude', '/PSI/range_upperleft/longitude/value', 'float')
    registerIndex('lowerright_latitude', '/PSI/range_lowerright/latitude/value', 'float')
    registerIndex('lowerright_longitude', '/PSI/range_lowerright/longitude/value', 'float')
    registerIndex('local_path_kml', '/PSI/files/file/local_path[../@id="PSI_Stack"]', 'text')
