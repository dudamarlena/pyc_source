...
# Embedded file name: /usr/local/lib/python2.7/site-packages/check_docking/stored/django/models.py
# Compiled at: 2015-02-08 00:07:23
...
class Interface(models.Model):
    ...
    class Meta:
        db_table = 'check_docking_interface'
...
class Method(models.Model):
    ...
    def natural_key(self):
        return (
         self.used_interface.def_name, self.METHODS[int(self.name_method)][1])


class DataItem(models.Model):
    u"""REST API 接口所使用的某方法参数列表.
    ...
    class Meta:
        db_table = 'check_docking_data_item'
    ...
    def natural_key(self):
        return (
         self.used_method, self.data_name)