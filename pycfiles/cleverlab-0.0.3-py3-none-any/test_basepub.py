...
# Embedded file name: build/bdist.linux-i686/egg/harold/tests/test_basepub.py
# Compiled at: 2006-08-02 05:57:50
__doc__ = ' test_basepub -> tests for everything in harold.basepub not related\n                    to parsing and view construction\n\n'
import unittest
from new import module
from os.path import basename
from harold.lib import con_type
from harold.publishers.common import Publisher, StopRecursion, TemplateMixin, magic_arg_names, publishable_items
from harold.tests.lib import test_app, wsgi_env, make_start_response, txt_template_dirs
...
class FsPublisher__Test(unittest.TestCase):
    ...
    def setUp(self):
        self.publisher = Publisher(test_app, NullTemplateType, dirs=(), layout='', defaults=(), debug=True)
...
class FsCallableMixin__Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.publisher = Publisher(test_app, FakeTemplateType, dirs=txt_template_dirs, layout='', defaults=(), debug=True)
