...
# Embedded file name: build/bdist.linux-i686/egg/harold/tests/test_cheetahpub.py
# Compiled at: 2006-08-02 05:57:50
import re, unittest
from harold.lib import con_type
from harold.publishers import cheetah_publisher
from harold.tests.lib import test_app, make_start_response, tmpl_template_dirs, layout_template, default_templates, wsgi_env
...
class CheetahTemplate__Test(unittest.TestCase):
    ...
    def setUp(self):
        self.headers = []
        self.publisher = cheetah_publisher(app=test_app, dirs=tmpl_template_dirs, debug=True)
