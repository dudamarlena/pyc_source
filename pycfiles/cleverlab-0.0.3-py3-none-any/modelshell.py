...
# Embedded file name: build/bdist.linux-i686/egg/harold/plugins/modelshell.py
# Compiled at: 2006-08-02 05:57:50
import code, os, site, sys, harold
...
try:
    ...
    ipinfo = '\nSee IPython.Revision module for IPython copyright, credits and license.'

intro = '%s %s %s\n%s on %s\nType "help", "copyright", "credits" or "license" for more information\n\nSee __builtin__ module for Python copyright, credits, and license.%s\n\nImportant:  commit your changes before you exit.  You will not be prompted.\n' % (harold.name, harold.version, harold.date, sys.version.split('\n')[1], sys.platform, ipinfo)
...
if IPython:
    ...
    class ModelInterp(IPython.Shell.IPShell):
        ...
        def __init__(self, ns):
            ...
            IPython.Shell.IPShell.__init__(self, argv=[], user_ns=user_ns, shell_class=ModelInteractive)
...
class ModelShell(HaroldCommandType):
    ...
    description = 'Run interactive interpreter preloaded with database models and connections.'
    parser = HaroldCommandType.standard_parser(quiet=True, ini_file=True, list_sections=True, models_section=True)
