...
# Embedded file name: build/bdist.linux-i686/egg/harold/tests/test_restpub.py
# Compiled at: 2006-08-02 05:57:50
import unittest
from harold.lib import con_type
from harold.publishers import rest_publisher
from harold.tests.lib import test_app, make_start_response, rst_template_dirs, layout_template, default_templates, wsgi_env
...
class FsPublisher_FsReStructuredText__Test(unittest.TestCase):
    ...
    def setUp(self):
        self.headers = []
        self.publisher = rest_publisher(app=test_app, dirs=rst_template_dirs, layout=layout_template, defaults=default_templates, debug=True)
