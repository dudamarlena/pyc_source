...
# Embedded file name: build/bdist.linux-i686/egg/harold/tests/test_reqparam.py
...
empty_args = ([], {})
static_context = dict([ (name, name[0].upper()) for name in magic_arg_names ])
...
class RequestParameterParser__Test(unittest.TestCase):
    ...
    def test__B__5(self):
        ...
        query = {'d': ('slug', 4), 'e': 4}
        self.assertRaises(TypeError, request_args, B, [1, 2, 3], query)
    ...
    def test__B__6(self):
        ...
        expected = (
         [
          1, 2, 3, 'slug', 4], {})
        self.assertEqual(request_args(B, [1, 2, 3], query, ignore_additional_args=True), expected)
    ...
    def test__C__1(self):
        ...
        expected = (
         [
          1, 4], {})
        self.assertEqual(request_args(C, [1], {'x': 3, 'y': 4}, ignore_additional_args=True), expected)
    ...
    def test__D3__2(self):
        ...
        expected = (
         [
          1, 2, 3], {})
        self.assertEqual(request_args(D3, [1], {'y': 2, 'z': 3}), expected)
    ...
    def test__D3__3(self):
        ...
        expected = (
         [
          1, 2, 3], {})
        self.assertEqual(request_args(D3, [1, 2], {'z': 3}), expected)
