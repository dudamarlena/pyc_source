...
# Embedded file name: build/bdist.linux-i686/egg/harold/plugins/factory.py
...
from harold.database import ActiveMapperProvider, DBAPIProvider, SQLAlchemyProvider, SQLObjectProvider
...
def make_publisher_filter(name):
    ...
    def factory(app, global_conf, dirs=(), layout=None, defaults=(), debug=False):
        ...
        return publisher(app, dirs=dirs, layout=layout, defaults=defaults, debug=debug)
