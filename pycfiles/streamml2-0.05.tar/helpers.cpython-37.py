...
# [GCC 8.4.0]
# Embedded file name: C:\Users\bmccs\Desktop\streamml2\streamml2\utils\helpers.py
# Compiled at: 2019-01-26 09:24:15
...
def get_feature_selection_params():
    ...
    return {**{'mixed_selection__threshold_in':0.01, 
     ...
     'mixed_selection__verbose':True}, **{'enet__alpha':np.arange(0.1, 1, 0.1), 
     ...
     'lasso__fit_intercept':[
      True, False], 
     'lasso__normalize':[
      True, False]}, **{'abc__algorithm':[
      'SAMME'], 
     'abc__n_estimators':np.arange(1, 50, 7), 
     'abc__learning_rate':np.arange(0.1, 1, 0.1), 
     'rfc__n_estimators':np.arange(1, 50, 10), 
     ...
     'mlpc__activation':[
      'identity', 'logistic', 'relu', 'tanh'], 
     'mlpc__learning_rate':[
      'constant', 'invscaling']}, **{'abr__n_estimators':np.arange(1, 50, 10), 
     'abr__learning_rate':np.arange(0.1, 1, 0.1), 
     'rfr__n_estimators':np.arange(1, 50, 10), 
     'knnr__n_neighbors':np.arange(1, 50, 10), 
