...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/gopro2gpx/main.py
# Compiled at: 2020-04-24 06:25:21
...
def extract(input_file, output_file=None, format='GPX', verbose=1, binary=False, skip=True):
    config = Config(input_file=input_file, outputfile=output_file,
      format=format,
      verbose=verbose,
      skip=skip)
