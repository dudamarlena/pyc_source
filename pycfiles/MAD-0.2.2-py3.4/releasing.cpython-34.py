...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mad\utils\releasing.py
# Compiled at: 2016-04-07 03:48:24
...
class Version:
    ...
    def __eq__(self, other):
        return other and isinstance(other, Version) and other.micro == self.micro and other.hasMajor(self.major) and other.hasMinor(self.minor)
