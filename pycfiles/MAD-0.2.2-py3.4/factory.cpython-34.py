...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mad\simulation\factory.py
# Compiled at: 2016-04-27 04:39:58
...
class Factory(SimulationFactory):
    ...
    def create_operation(self, environment, definition):
        return Operation(definition.name, definition.parameters, definition.body, environment)
    ...
    def create_backoff(self, delay):
        ...
        if delay.strategy == delay.EXPONENTIAL:
