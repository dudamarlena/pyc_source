...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mad\parsing.py
# Compiled at: 2016-04-24 15:44:20
...
reserved = {'autoscaling': 'AUTOSCALING', 
 'client': 'CLIENT', 
 'delay': 'DELAY', 
 'every': 'EVERY', 
 'fail': 'FAIL', 
...
class MADSyntaxError(BaseException):
    ...
    def __repr__(self):
        return "Syntax error at line {line:d}, around '{hint}'.".format(line=self.position[0], hint=self.hint)
