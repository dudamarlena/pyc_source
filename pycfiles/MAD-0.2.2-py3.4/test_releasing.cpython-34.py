...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\utils\test_releasing.py
# Compiled at: 2016-04-07 03:46:32
# Size of source mod 2**32: 5230 bytes
from unittest import TestCase, main
from mock import Mock, MagicMock, call, patch, ANY, mock_open
from mad.utils.releasing import Version, Release, SourceControl
...
class VersionTest(TestCase):
    ...
    def test_read_from_source_code(self):
        with patch('mad.__version__', '1.3.4'):
    ...
    def test_update_source_code(self):
        ...
        with patch('mad.utils.releasing.open', mock, create=True):
...
class ReleaseTest(TestCase):
    ...
    @patch('mad.utils.releasing.Version.from_source_code', return_value=Version(1, 3, 3))
    @patch('mad.utils.releasing.Version.update_source_code')
