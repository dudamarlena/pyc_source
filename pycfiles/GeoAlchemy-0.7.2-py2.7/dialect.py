...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/geoalchemy/dialect.py
...
from geoalchemy.base import WKTSpatialElement, WKBSpatialElement, DBSpatialElement
...
class SpatialDialect(object):
    ...
    """
    __functions = {functions.wkt: 'AsText', 
       ...
       functions._within_distance: lambda compiler, geom1, geom2, dist: func.DWithin(geom1, geom2, dist)}
...
class DialectManager(object):
    ...
    def __initialize_dialects():
        ...
        DialectManager.__dialects_mapping = {PGDialect: PGSpatialDialect, 
    ...
    def get_spatial_dialect(dialect):
        ...
        """
        possible_spatial_dialects = [ spatial_dialect for dialect_sqlalchemy, spatial_dialect in DialectManager.__dialects().iteritems() if isinstance(dialect, dialect_sqlalchemy)
                                    ]
