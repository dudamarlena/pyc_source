...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagenthypervisorhealth/__init__.py
...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [
     {'info': health.TNHypervisorHealth.plugin_info(), 'plugin': health.TNHypervisorHealth(configuration, entity, group)}]
...
def version():
    ...
    return (
     __name__, pkg_resources.get_distribution('archipel-agent-hypervisor-health').version, [health.TNHypervisorHealth.plugin_info()])