...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagenthypervisorhealth/health.py
# Compiled at: 2013-03-20 13:50:16
import commands, libvirt, xmpp, json
...
class TNHypervisorHealth(TNArchipelPlugin):
    ...
    def __init__(self, configuration, entity, entry_point_group):
        ...
        registrar_items = [
         {'commands': ['health'], 'parameters': [{'name': 'limit', 'description': 'Max number of returned entries. Equals 1 if ommited'}], 'method': self.message_health_info, 
            'permissions': [
                          'health_info'], 
            'description': 'Get my last health information'},
         {'commands': ['logs'], 'parameters': [{'name': 'limit', 'description': 'Max number of returned entries. Equals 1 if ommited'}], 'method': self.message_get_logs, 
            'permissions': [
                          'health_logs'], 
