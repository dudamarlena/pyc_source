...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/pypomelo/client.py
# Compiled at: 2019-01-03 22:45:47
__doc__ = 'A client of Pomelo\n\nHandshake :\n\n+----------+                    +----------+\n+  client  +                    +  server  +\n+----------+                    +----------+\n     |                               |\n     |        handshake reqest       |\n     |------------------------------>|\n     |                               |\n     |       handshake response      |\n     |<------------------------------|\n     |                               |\n     |             ack               |\n     |------------------------------>|\n     |                               |\n\n\nHeartbeat :\n\n+----------+                    +----------+\n+  client  +                    +  server  +\n+----------+                    +----------+\n     |                               |\n     |        heartbeat reqest       |\n     |------------------------------>|\n     |                               |\n     |       heartbeat response      |\n     |<------------------------------|\n     |                               |\n     |       wait for some times     |\n     |                               |\n     |        heartbeat reqest       |\n     |------------------------------>|\n     |                               |\n     |       heartbeat response      |\n     |<------------------------------|\n     |                               |\n'
...
class Client(object):
    ...
    def send_request(self, route, request_data, on_request=None):
        ...
        self.request_handler[self.request_id] = {'request_data': request_data, 
           'handler': on_request}
