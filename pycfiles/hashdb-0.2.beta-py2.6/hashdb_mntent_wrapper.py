...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hashdb/hashdb_mntent_wrapper.py
...
def enum_mntent(filename):
    ...
    try:
        ...
        while getmntent_r(stream, mount, ctypes.byref(buf), ctypes.sizeof(buf) - 1):
            results.append(MountEntry(mount.mnt_fsname, mount.mnt_dir, mount.mnt_type, set(mount.mnt_opts.split(',')), mount.mnt_freq, mount.mnt_passno))
