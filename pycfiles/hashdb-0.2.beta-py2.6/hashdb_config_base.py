...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hashdb/hashdb_config_base.py
# Compiled at: 2011-01-06 01:43:36
import hashdb_output as output, os, shlex
...
parse_text__verbosity = parse_text__mapping({'QUIET': output.QUIET, 
   'DEFAULT': output.DEFAULT, 
   'VERBOSE': output.VERBOSE, 
   'DEBUG': output.DEBUG})
parse_text__boolean = parse_text__mapping({'TRUE': True, 
   'YES': True, 
   'T': True, 
   'Y': True, 
   '1': True, 
