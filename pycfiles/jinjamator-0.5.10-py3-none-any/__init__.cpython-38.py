...
# Compiled at: 2020-04-29 14:45:54
...
def query--- This code section failed: ---
 ...
 L. 126        60  LOAD_GLOBAL              log
               62  LOAD_METHOD              error
               64  LOAD_FAST                'e'
               66  CALL_METHOD_1         1  ''
               68  POP_TOP          

 L. 127        70  LOAD_FAST                'session'
               72  LOAD_METHOD              close
               74  CALL_METHOD_0         0  ''
               76  POP_TOP          

 L. 128        78  BUILD_LIST_0          0 
               80  LOAD_STR                 '0'
...
def get_access_aep_name_by_vlan_id--- This code section failed: ---
 ...
 L. 313         0  SETUP_FINALLY        62  'to 62'

 L. 314         2  LOAD_GLOBAL              query

 L. 315         4  LOAD_STR                 '/api/node/class/infraRsFuncToEpg.json?query-target-filter=and(wcard(infraRsFuncToEpg.dn,"{1}"),eq(infraRsFuncToEpg.encap,"vlan-{0}"),eq(infraRsFuncToEpg.mode,"untagged"))&order-by=infraRsFuncToEpg.dn'
                6  LOAD_METHOD              format

 L. 316         8  LOAD_FAST                'vlan_id'

 L. 316        10  LOAD_FAST                'dn_filter'

 L. 315        12  CALL_METHOD_2         2  ''

 L. 314        14  CALL_FUNCTION_1       1  ''

 L. 318        16  LOAD_STR                 'imdata'

 L. 314        18  BINARY_SUBSCR    

 L. 318        20  LOAD_CONST               0

 L. 314        22  BINARY_SUBSCR    

 L. 318        24  LOAD_STR                 'infraRsFuncToEpg'

 L. 314        26  BINARY_SUBSCR    

 L. 318        28  LOAD_STR                 'attributes'

 L. 314        30  BINARY_SUBSCR    
               32  STORE_FAST               'access_aep'

 L. 319        34  LOAD_FAST                'access_aep'
               36  LOAD_STR                 'dn'
               38  BINARY_SUBSCR    
 ...
 L. 321        76  LOAD_GLOBAL              ValueError
...
def dn_has_attribute--- This code section failed: ---
 ...
 L. 357         0  LOAD_STR                 '/api/node/mo/{0}.json'
                2  LOAD_METHOD              format
                4  LOAD_FAST                'dn'
                6  CALL_METHOD_1         1  ''
                8  STORE_FAST               'url'

 L. 358        10  LOAD_GLOBAL              self
 ...
 L. 361        56  SETUP_FINALLY        92  'to 92'

 L. 362        58  LOAD_FAST                'obj'
               60  LOAD_FAST                'k'
               62  BINARY_SUBSCR    
