...
# [GCC 8.4.0]
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/mrp/protobuf/SendCommandMessage_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='pyatv/mrp/protobuf/SendCommandMessage.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=(_b('\n+pyatv/mrp/protobuf/SendCommandMessage.proto\x1a(pyatv/mrp/protobuf/ProtocolMessage.proto\x1a$pyatv/mrp/protobuf/CommandInfo.proto\x1a\'pyatv/mrp/protobuf/CommandOptions.proto\x1a#pyatv/mrp/protobuf/PlayerPath.proto"r\n\x12SendCommandMessage\x12\x19\n\x07command\x18\x01 \x01(\x0e2\x08.Command\x12 \n\x07options\x18\x02 \x01(\x0b2\x0f.CommandOptions\x12\x1f\n\nplayerPath\x18\x03 \x01(\x0b2\x0b.PlayerPath:A\n\x12sendCommandMessage\x12\x10.ProtocolMessage\x18\x06 \x01(\x0b2\x13.SendCommandMessage')),
  dependencies=[
 pyatv_dot_mrp_dot_protobuf_dot_ProtocolMessage__pb2.DESCRIPTOR, pyatv_dot_mrp_dot_protobuf_dot_CommandInfo__pb2.DESCRIPTOR, pyatv_dot_mrp_dot_protobuf_dot_CommandOptions__pb2.DESCRIPTOR, pyatv_dot_mrp_dot_protobuf_dot_PlayerPath__pb2.DESCRIPTOR])
SENDCOMMANDMESSAGE_FIELD_NUMBER = 6
sendCommandMessage = _descriptor.FieldDescriptor(name='sendCommandMessage',
  ...
  serialized_options=None,
  file=DESCRIPTOR)
_SENDCOMMANDMESSAGE = _descriptor.Descriptor(name='SendCommandMessage',
  full_name='SendCommandMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
 ...
 _descriptor.FieldDescriptor(name='command',
   full_name='SendCommandMessage.command',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
 ...
 _descriptor.FieldDescriptor(name='options',
   full_name='SendCommandMessage.options',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
 ...
 _descriptor.FieldDescriptor(name='playerPath',
   full_name='SendCommandMessage.playerPath',
   index=2,
   number=3,
   type=11,
   cpp_type=10,
...
SendCommandMessage = _reflection.GeneratedProtocolMessageType('SendCommandMessage', (_message.Message,), {'DESCRIPTOR':_SENDCOMMANDMESSAGE, 
