...
# [GCC 8.4.0]
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/mrp/pairing.py
...
class MrpPairingProcedure:
    __doc__ = 'Perform pairing and return new credentials.'
    ...
    async def start_pairing(self):
        ...
        self.srp.initialize()
        msg = messages.crypto_pairing({tlv8.TLV_METHOD: b'\x00', 
    ...
    async def finish_pairing(self, pin):
        ...
        msg = messages.crypto_pairing({tlv8.TLV_SEQ_NO: b'\x03', 
        ...
        msg = messages.crypto_pairing({tlv8.TLV_SEQ_NO: b'\x05', 
...
class MrpPairingVerifier:
    __doc__ = 'Verify credentials and derive new encryption keys.'
    ...
    async def verify_credentials(self):
        ...
        msg = messages.crypto_pairing({tlv8.TLV_SEQ_NO: b'\x01', 
    ...
    def encryption_keys(self):
        ...
        return (
         self._output_key, self._input_key)