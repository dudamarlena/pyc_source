...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/icsemantic/catalog/indexes/related.py
    ...
    def _apply_index(self, request, cid=''):
        ...
        for k in record.keys:
            for lang in user_languages:
                key = '%s@%s' % (k, lang)
                thesaurus_results += utils.get_related(portal, key, lang=user_languages, contexts=contexts)
...
def manage_addRelatedIndex(self, id, extra=None, REQUEST=None, RESPONSE=None, URL3=None):
    """Add a fake index"""
    return self.manage_addIndex(id, 'RelatedIndex', extra=extra, REQUEST=REQUEST, RESPONSE=RESPONSE, URL1=URL3)