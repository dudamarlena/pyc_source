...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/napalm_aos/utils/AlcatelOS.py
# Compiled at: 2019-06-13 23:53:04
import paramiko, re, scp, logging
try:
...
class AlcatelOS(object):
    ...
    def __init__(self, hostname, username=None, password=None, timeout=60, optional_args=None):
        ...
        if optional_args is None:
            optional_args = {}
        self.paramiko_cfg = {'hostname': hostname, 
           'username': username, 
           'password': password, 
           'timeout': timeout, 
           'port': 22, 
