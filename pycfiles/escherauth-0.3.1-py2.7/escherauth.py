...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/escherauth/escherauth.py
# Compiled at: 2018-02-05 10:16:05
import datetime, hmac, requests, urllib, re
...
class Escher:
    ...
    def sign(self, r, client, headers_to_sign=[]):
        ...
        request.add_header(self.auth_header_name, (', ').join([
         self.algo_id + ' Credential=' + client['api_key'] + '/' + self.short_date(self.current_time) + '/' + self.credential_scope,
    ...
    def authenticate(self, r, key_db):
        ...
        validator.validate_dates(self.current_time, auth_params.get_request_date(), auth_params.get_credential_date(), auth_params.get_expires(), self.clock_skew)
        ...
        calculated_signature = self.generate_signature(key_db[auth_params.get_credential_key()], request, auth_params.get_signed_headers(), auth_params.get_request_date())
