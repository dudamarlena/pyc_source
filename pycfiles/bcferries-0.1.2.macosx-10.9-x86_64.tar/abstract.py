...
# [GCC 8.4.0]
# Embedded file name: /Users/yasyf/.virtualenvs/bcferries/lib/python2.7/site-packages/bcferries/abstract.py
# Compiled at: 2014-12-29 07:29:22
...
class BCFerriesAbstractObject(object):
    ...
    def to_dict(self, fuzzy=False, json=False, shallow=True):
        ...
        operations = [
         ...
         lambda x: dict_f({k:v.to_dict(fuzzy=fuzzy, json=json, shallow=shallow) for k, v in x.items()}), lambda x: [ v.to_dict(fuzzy=fuzzy, json=json, shallow=shallow) for v in x ],
