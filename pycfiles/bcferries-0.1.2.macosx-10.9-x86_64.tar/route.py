...
# [GCC 8.4.0]
# Embedded file name: /Users/yasyf/.virtualenvs/bcferries/lib/python2.7/site-packages/bcferries/route.py
# Compiled at: 2014-12-29 09:52:32
...
class BCFerriesRoute(BCFerriesAbstractObject):
    ...
    def schedule(self):
        ...
        sailing_time = re.match('SAILING TIME: (.*)', sailing_time.strip()).group(1)
