...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyproffit/profextract.py
# Compiled at: 2019-11-19 09:29:22
# Size of source mod 2**32: 28942 bytes
...
class Profile:
    ...
    def MedianSB(self):
        ...
        for i in range(self.nbin):
            ...
            profile[i], eprof[i] = medianval(img[id], errmap[id], int(1000.0))
