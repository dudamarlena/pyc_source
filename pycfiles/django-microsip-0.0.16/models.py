...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Admin\Documents\GitHub\django-microsip\microsip\ventas\ventas_documentos\models.py
# Compiled at: 2014-11-28 08:00:34
from django.db import models
from datetime import datetime
from django.db import router
from microsip.core.db import next_id
import django_dynamic_models
from microsip.comun.impuestos.models import Impuesto
from microsip.comun.clientes.models import Cliente, ClienteDireccion, CondicionPago
from microsip.comun.articulos.models import Almacen, Articulo
from microsip.comun.listas.models import Vendedor
from microsip.comun.general.models import ViaEmbarque, Moneda
from microsip.comun.impuestos.models import Impuesto
...
VentasDocumento = type('VentasDocumento', (VentasDocumentoBase,), django_dynamic_models.change.get_model_changes('VentasDocumento', 'microsip.ventas.ventas_documentos'))
...
VentasDocumentoVencimiento = type('VentasDocumentoVencimiento', (VentasDocumentoVencimientoBase,), django_dynamic_models.change.get_model_changes('VentasDocumentoVencimiento', 'microsip.ventas.ventas_documentos'))
...
VentasDocumentoImpuesto = type('VentasDocumentoImpuesto', (VentasDocumentoImpuestoBase,), django_dynamic_models.change.get_model_changes('VentasDocumentoImpuesto', 'microsip.ventas.ventas_documentos'))
...
VentasDocumentoDetalle = type('VentasDocumentoDetalle', (VentasDocumentoDetalleBase,), django_dynamic_models.change.get_model_changes('VentasDocumentoDetalle', 'microsip.ventas.ventas_documentos'))
...
VentasDocumentoLiga = type('VentasDocumentoLiga', (VentasDocumentoLigaBase,), django_dynamic_models.change.get_model_changes('VentasDocumentoLiga', 'microsip.ventas.ventas_documentos'))
...
VentasDocumentoFacturaLibres = type('VentasDocumentoFacturaLibres', (VentasDocumentoFacturaLibresBase,), django_dynamic_models.change.get_model_changes('VentasDocumentoFacturaLibres', 'microsip.ventas.ventas_documentos'))
...
VentasDocumentoFacturaDevLibres = type('VentasDocumentoFacturaDevLibres', (VentasDocumentoFacturaDevLibresBase,), django_dynamic_models.change.get_model_changes('VentasDocumentoFacturaDevLibres', 'microsip.ventas.ventas_documentos'))