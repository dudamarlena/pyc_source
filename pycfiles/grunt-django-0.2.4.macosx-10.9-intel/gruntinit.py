...
# [GCC 8.4.0]
# Embedded file name: /Users/lucaadalbertovandro/git/crowdschool/django_grunt/management/commands/gruntinit.py
# Compiled at: 2014-07-29 08:13:18
from django.core.management.base import BaseCommand, CommandError
from django.conf import settings
import os
from os import path
import subprocess
from django_grunt.utils import GruntRootMixin, create_file_from_template
    ...
    def create_gruntfile(self):
        ...
        if create_gruntfile:
            try:
                ...
                static_root = self.get_input_data(message='Select static root (default : %s)' % default_static_root, default=default_static_root)
