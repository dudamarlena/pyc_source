...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/liveplots/liveplot.py
# Compiled at: 2019-11-08 08:28:48
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--event', help='Action to be monitored', nargs='+', choices=[
     'create', 'delete', 'close_write', 'close_nowrite', 'access', 'attrib', 'modify'],
      default='modify')
