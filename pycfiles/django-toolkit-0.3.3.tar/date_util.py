...
# [GCC 8.4.0]
# Embedded file name: /media/ahayes/data/.workspaces/juno/django-toolkit/django_toolkit/tests/date_util.py
...
class HelperGetAnniversaryPeriodsTestCase(unittest.TestCase):
    ...
    def test_single_month(self):
        self.assertEqual(get_anniversary_periods(date(2012, 11, 1), date(2012, 11, 30)), [
         (
          date(2012, 11, 1), date(2012, 11, 30))])

    def test_across_month(self):
        self.assertEqual(get_anniversary_periods(date(2012, 11, 10), date(2012, 12, 9)), [
         (
    ...
    def test_second_day_single_month(self):
        self.assertEqual(get_anniversary_periods(date(2012, 11, 2), date(2012, 12, 1), 2), [
         (
          date(2012, 11, 2), date(2012, 12, 1))])

    def test_second_day_anniversary_across_month(self):
        self.assertEqual(get_anniversary_periods(date(2012, 11, 10), date(2012, 12, 9), 2), [
         (
    ...
    def test_fifteen_day_anniversary_across_multiple_months(self):
        self.assertEqual(get_anniversary_periods(date(2012, 11, 10), date(2013, 1, 16), 15), [
         (
    ...
    def test_finish_on_anniversary(self):
        self.assertEqual(get_anniversary_periods(date(2013, 1, 16), date(2013, 2, 1), 1), [
         (
...
class DateUtilNextDateTestCase(unittest.TestCase):
    ...
    def test_start_of_month(self):
        self.assertEqual(next_date_for_day(DATE_FREQUENCY_MONTHLY, 1, date(2012, 11, 1)), date(2012, 11, 1))


class DateDayLastWeekTestCase(unittest.TestCase):

    def test_monday_last_week_mid_week(self):
        self.assertEqual(day_last_week(0, date(2013, 1, 23)), date(2013, 1, 14))

    def test_tuesday_last_week(self):
        self.assertEqual(day_last_week(1, date(2013, 1, 22)), date(2013, 1, 15))

    def test_tuesday_last_week_across_year(self):
        self.assertEqual(day_last_week(1, date(2013, 1, 2)), date(2012, 12, 25))
...
class ExactAnniversariesTestCase(unittest.TestCase):
    ...
    def test_no_anniversaries_overflow_finish(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 1, date(2012, 3, 1), date(2012, 4, 1)), False)

    def test_no_anniversaries_overflow_start(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 4, date(2012, 3, 1), date(2012, 4, 3)), False)

    def test_one_anniversary_1st_of_month(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 1, date(2012, 3, 1), date(2012, 3, 31)), 1)

    def test_one_anniversary_6th_of_month(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 6, date(2012, 3, 6), date(2012, 4, 5)), 1)

    def test_two_anniversaries_1st_of_month(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 1, date(2012, 3, 1), date(2012, 4, 30)), 2)

    def test_two_anniversaries_16th_of_month(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 16, date(2012, 10, 16), date(2012, 12, 15)), 2)

    def test_three_anniversaries_26th_of_month(self):
        self.assertEqual(exact_anniversaries(DATE_FREQUENCY_MONTHLY, 26, date(2012, 10, 26), date(2013, 1, 25)), 3)
