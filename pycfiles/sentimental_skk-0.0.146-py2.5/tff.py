...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/sskk/canossa/canossa/tff/tff.py
# Compiled at: 2014-04-25 02:25:27
...
class Session():
 ...
 L.1279         0  LOAD_CLOSURE          0  'self'
                6  LOAD_CODE                <code_object onresize>
                9  MAKE_CLOSURE_0        0  None
               12  STORE_FAST            1  'onresize'

 L.1283        15  SETUP_EXCEPT         23  'to 41'

 L.1284        18  LOAD_GLOBAL           0  'signal'
 ...
 L.1293       136  LOAD_FAST             5  'xfd'
              139  JUMP_IF_FALSE        70  'to 212'
            142_0  THEN                     213
              142  POP_TOP          

 L.1294       143  SETUP_LOOP           67  'to 213'
              146  LOAD_FAST             5  'xfd'
              149  GET_ITER         
              150  FOR_ITER             55  'to 208'
              153  STORE_FAST            6  'fd'

 L.1295       156  LOAD_FAST             6  'fd'
 ...
 L.1303       276  LOAD_FAST             3  'rfd'
              279  JUMP_IF_FALSE       270  'to 552'
              282  POP_TOP          

 L.1304       283  SETUP_LOOP          267  'to 553'
              286  LOAD_FAST             3  'rfd'
              289  GET_ITER         
              290  FOR_ITER            255  'to 548'
              293  STORE_FAST            6  'fd'

 L.1305       296  LOAD_FAST             6  'fd'
              299  LOAD_FAST             2  'stdin_fileno'
              302  COMPARE_OP            2  ==
              305  JUMP_IF_FALSE        99  'to 407'
              308  POP_TOP          

 L.1306       309  LOAD_GLOBAL          15  'os'
 ...
 L.1327       604  LOAD_GLOBAL          27  'True'
 ...
 L.1329       633  SETUP_LOOP           53  'to 689'
 ...
 L.1330       649  LOAD_DEREF            0  'self'
              652  LOAD_ATTR             9  '_process_map'
              655  LOAD_FAST             6  'fd'
              658  BINARY_SUBSCR    
              659  STORE_FAST            7  'process'

 L.1331       662  LOAD_DEREF            0  'self'
 ...
 L.1338       737  LOAD_GLOBAL          27  'True'
 ...
 L.1340       750  LOAD_FAST            13  'e'
            ...
            766_0  COME_FROM            81  '81'
              766  POP_BLOCK        
              767  JUMP_FORWARD         87  'to 857'
            770_0  COME_FROM            78  '78'

 L.1341       770  DUP_TOP          
              771  LOAD_GLOBAL          29  'OSError'
              774  COMPARE_OP           10  exception-match
              777  JUMP_IF_FALSE        75  'to 855'
              780  POP_TOP          
              781  POP_TOP          
              782  STORE_FAST           13  'e'
              785  POP_TOP          

 L.1342       786  LOAD_FAST            13  'e'
              789  UNPACK_SEQUENCE_2     2 
              792  STORE_FAST           14  'no'
              795  STORE_FAST           15  'msg'

 L.1343       798  LOAD_FAST            14  'no'
              801  LOAD_GLOBAL          25  'errno'
              804  LOAD_ATTR            30  'EIO'
              807  COMPARE_OP            2  ==
              810  JUMP_IF_FALSE         8  'to 821'
              813  POP_TOP          

 L.1344       814  LOAD_CONST               None
              817  RETURN_VALUE     
              818  JUMP_ABSOLUTE       857  'to 857'
            821_0  COME_FROM           810  '810'
              821  POP_TOP          

 L.1345       822  LOAD_FAST            14  'no'
              825  LOAD_GLOBAL          25  'errno'
              828  LOAD_ATTR            28  'EBADF'
              831  COMPARE_OP            2  ==
              834  JUMP_IF_FALSE         8  'to 845'
              837  POP_TOP          

 L.1346       838  LOAD_CONST               None
              841  RETURN_VALUE     
              842  JUMP_ABSOLUTE       857  'to 857'
            845_0  COME_FROM           834  '834'
              845  POP_TOP          

 L.1348       846  LOAD_FAST            13  'e'
              849  RAISE_VARARGS_1       1  None
              852  JUMP_FORWARD          2  'to 857'
              855  POP_TOP          
              856  END_FINALLY      
            857_0  COME_FROM           852  '852'
            857_1  COME_FROM           767  '767'
              857  POP_BLOCK        
              858  LOAD_CONST               None
            861_0  COME_FROM            75  '75'

 L.1350       861  SETUP_FINALLY        17  'to 881'

 L.1351       864  LOAD_DEREF            0  'self'
              867  LOAD_ATTR             3  '_mainprocess'
              870  LOAD_ATTR            31  'process_end'
              873  CALL_FUNCTION_0       0  None
              876  POP_TOP          
              877  POP_BLOCK        
              878  LOAD_CONST               None
            881_0  COME_FROM           861  '861'

 L.1353       881  SETUP_LOOP           50  'to 934'
              884  LOAD_DEREF            0  'self'
              887  LOAD_ATTR             9  '_process_map'
              890  GET_ITER         
              891  FOR_ITER             39  'to 933'
              894  STORE_FAST            6  'fd'

 L.1354       897  LOAD_DEREF            0  'self'
              900  LOAD_ATTR             9  '_process_map'
              903  LOAD_FAST             6  'fd'
              906  BINARY_SUBSCR    
              907  STORE_FAST            7  'process'

 L.1355       910  LOAD_FAST             7  'process'
              913  LOAD_ATTR            32  'end'
              916  CALL_FUNCTION_0       0  None
              919  POP_TOP          

 L.1356       920  LOAD_FAST             7  'process'
              923  LOAD_ATTR            33  'close'
              926  CALL_FUNCTION_0       0  None
              929  POP_TOP          
              930  JUMP_BACK           891  'to 891'
              933  POP_BLOCK        
            934_0  COME_FROM           881  '881'
              934  END_FINALLY      
              935  END_FINALLY      
