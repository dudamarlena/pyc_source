...
# [GCC 8.4.0]
# Embedded file name: /Users/wangping/svn/work/code/project/AntShell/lib/antshell/utils/lang.py
# Compiled at: 2019-10-21 23:24:19
# Size of source mod 2**32: 3333 bytes
from __future__ import absolute_import, division, print_function
__metaclass__ = type
LANG = {'default':'zh', 
 'zh':{'init':'初始化配置文件以及数据库', 
  'version':'打印版本信息并退出', 
  'help':'打印帮助信息并退出', 
  'add':'添加主机信息并登陆', 
  'commod':'主机远程执行命令', 
  ...
  'sudo':'指定sudo用户', 
  'engine':'指定引擎'}, 
 'en':{'init':'Initialize the configuration file and the database', 
