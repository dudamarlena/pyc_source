...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pdfs/Bibtex.py
# Compiled at: 2017-08-14 16:20:11
# Size of source mod 2**32: 5252 bytes
import re, unicodedata, textwrap
...
bibtexFields = [
 'author', 'title', 'booktitle', 'series', 'journal', 'edition',
...
def _bibKeyQuote(k, v):
    if k == 'month':
        ...
        if k == 'pages':
            ...
            if k in ('title', 'booktitle', 'journal', 'publisher'):
...
def makeCiteKey(meta):
    if 'author' in meta:
        ...
        if 'editor' in meta:
            ...
            firstAuth = 'Unknown'
    firstAuth = re.sub('[^a-zA-Z]', '', firstAuth)
