...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pdfs/Commands/WWW.py
...
class WWW(Command):
    ...
    def run(self, args):
        import logging, mimetypes, os, flask, jinja2
        ...
        def doSearch(tag=None, text=None, author=None, title=None):
            ...
            ctx = dict(article_dir=(os.path.basename(os.path.dirname(db.dataDir))), tags=(mkTagList(db)))
            if tag:
