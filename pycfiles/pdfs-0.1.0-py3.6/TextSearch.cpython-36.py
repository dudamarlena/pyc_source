...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pdfs/TextSearch.py
# Compiled at: 2017-08-14 16:20:11
# Size of source mod 2**32: 3037 bytes
import os, shutil, re, whoosh.highlight as highlight, whoosh.index as widx
...
class TextSearch:
    ...
    def init(dataDir):
        ...
        schema = Schema(md5=ID(stored=True), page=NUMERIC(stored=True),
