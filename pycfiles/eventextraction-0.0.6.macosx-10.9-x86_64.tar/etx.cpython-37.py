...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/site-packages/eventextraction/etx.py
# Compiled at: 2020-03-24 22:26:14
...
class EventsExtraction:
    ...
    def split_sents(self, content):
        ...
        ['虽然你做了坏事，但我觉得你是好人',
         '一旦时机成熟，就坚决推行']
        """
        return [sentence.replace('\u3000', '') for sentence in re.split('[？?！!。；;：:\\n\\r]', content) if sentence]
    ...
    def pattern_match(self, patterns, sent):
        ...
        for p in patterns:
            ...
            if ress:
                for res in ress:
                    data = {'pre_wd':res[0], 
                     'pre_part':res[1],  'post_wd':res[2],  'post_part ':res[3]}
    ...
    def extract_tuples(self, sent):
        ...
        return (
         but_tuples, condition_tuples, seq_tuples, more_tuples)
    ...
    def stats(self, datas):
        ...
        return {'but':but, 
         'condition':condition,  'seq':seq,  'more':more,  'other':other}