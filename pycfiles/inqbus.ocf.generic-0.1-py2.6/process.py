...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/inqbus/ocf/generic/process.py
# Compiled at: 2011-10-26 16:25:42
...
agent.add_parameter('ovpn_executable', longdesc='Path to the executable', shortdesc='executable', datatype=resourceagent.STRING)
agent.add_parameter('ovpn_name', longdesc='Name of the OPENVPN channel', shortdesc='VPN name', datatype=resourceagent.STRING)
agent.add_parameter('ovpn_dir', longdesc='OpenVPN config dir', shortdesc='OVPM dir', datatype=resourceagent.STRING, default='/etc/openvpn')
