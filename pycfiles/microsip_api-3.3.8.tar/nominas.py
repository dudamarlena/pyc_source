...
# [GCC 8.4.0]
# Embedded file name: C:\repositorios\web\djmicrosip_apps\django-microsip-api\microsip_api\models_base\nomina\nominas.py
...
class NominaNominaBase(models.Model):
    ...
    TIPOS = (
     ...
     ('E', 'Extraordinaria'))
    PROCESO_TIPOS = (('A', 'Automatico'), )
    id = models.AutoField(primary_key=True, db_column='nomina_id')
    frecuencia_pago = models.ForeignKey('NominaFrecuenciaPago', db_column='frepag_id')
    ...
    def __unicode__(self):
        return '%s %s' % (self.fecha, self.tipo_nomina_descripcion)
...
class NominaNominaPagoBase(models.Model):
    ...
    nomina = models.ForeignKey('NominaNomina', db_column='nomina_id')
    empleado = models.ForeignKey('NominaEmpleado', db_column='empleado_id')
...
class NominaNominaPagoDetalleBase(models.Model):
    ...
    nomina_pago = models.ForeignKey('NominaNominaPago', related_name='detalles', db_column='pago_nomina_id')
    concepto = models.ForeignKey('NominaConcepto', db_column='concepto_no_id')
    ...
    prestamo = models.ForeignKey('NominaPrestamo', blank=True, null=True, db_column='prestamo_emp_id')
