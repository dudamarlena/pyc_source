...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/datalogue/models/stream_collection.py
...
class StreamMetadata:
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(id: {self.id}, is_ready: {self.is_ready!r}, stream: {self.stream!r})"
