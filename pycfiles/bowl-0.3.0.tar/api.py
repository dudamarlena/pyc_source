...
# [GCC 8.4.0]
# Embedded file name: /Users/clewis/Desktop/old-air/github-public/bowl/bowl/api.py
# Compiled at: 2014-09-20 16:00:23
"""
...
"""
import ast, datetime, os, sys, tarfile, web
...
class main(object):
    ...
    def setup(self):
        global URLS
        urls = ('/', 'root', '/add', 'api_add', '/connect/(.*)', 'api_connect', '/delete/(.*)',
                'api_delete', '/disconnect/(.*)', 'api_disconnect', '/hosts', 'api_hosts',
                '/images', 'api_images', '/import', 'api_image_import', '/info',
                'api_info', '/kill/(.*)', 'api_kill', '/link/(.*)', 'api_link', '/list',
                'api_list', '/login', 'api_login', '/logout', 'api_logout', '/logs/(.*)',
                'api_logs', '/new', 'api_new', '/remove', 'api_remove', '/repositories',
                'api_repositories', '/repo/services', 'api_repo_services', '/services',
                'api_services', '/snapshot/(.*)', 'api_snapshot', '/snapshots', 'api_snapshots',
                '/subtract/(.*)/(.*)/(.*)/(.*)', 'api_subtract', '/test', 'api_test',
                '/unlink/(.*)', 'api_unlink', '/uptime', 'api_uptime', '/version',
                'api_version')
        URLS = urls
        return urls
