...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/unbound_ec2/server.py
...
class Server:
    ...
    def _operate_forward(self, _id, event, qstate, qdata):
        ...
        if qstate.qinfo.qtype in [RR_TYPE_PTR] and qname.endswith(self.reverse_zone):
    ...
    def __determine_address(self, instance):
        ...
        return (instance.tags.get('Address') or ordered_address).encode('ascii')
