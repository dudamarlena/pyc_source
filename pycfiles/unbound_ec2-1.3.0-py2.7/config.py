...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/unbound_ec2/config.py
# Compiled at: 2016-11-14 04:03:05
import ConfigParser, os.path, ast
...
class UnboundEc2Conf(object):
    ...
    def __init__(self, conf_file=None):
        ...
        self.conf_file = conf_file if conf_file else os.environ.get('UNBOUND_EC2_CONF', DEFAULT_CONF_FILE).encode('ascii')
        self.ec2 = {}
        self.main = {}
        self.lookup = {}
        self.lookup_filters = {}
    ...
    def set_defaults(self):
        ...
        self.main['cache_ttl'] = self.__try_type(os.environ.get('UNBOUND_CACHE_TTL', DEFAULT_CACHE_TTL).encode('ascii'))
        ...
        self.lookup['tag_name_include_domain'] = self.__try_type(os.environ.get('UNBOUND_LOOKUP_TAG_NAME_INCLUDE_DOMAIN', DEFAULT_LOOKUP_TAG_NAME_INCLUDE_DOMAIN).encode('ascii'))
        self.lookup_filters = self.__try_type(os.environ.get('UNBOUND_LOOKUP_FILTERS', DEFAULT_LOOKUP_FILTERS).encode('ascii'))
        self.main['ip_order'] = os.environ.get('UNBOUND_IP_ORDER', DEFAULT_IP_ORDER).encode('ascii')
        self.main['forwarded_zones'] = os.environ.get('UNBOUND_FORWARDED_ZONES', DEFAULT_FORWARDED_ZONES).encode('ascii')
