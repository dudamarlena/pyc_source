...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\guizero\Combo.py
...
class Combo(TextWidget):
    ...
    def __init__(self, master, options=[], selected=None, command=None, grid=None, align=None, visible=True, enabled=None, width=None, height=None):
        """
        Creates a Combo
    ...
    def select_default(self):
        ...
        if self._default is None:
            self._set_option_by_index(0) or utils.error_format(self.description + '\n' + 'Unable to select default option as the Combo is empty')
        else:
