...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\guizero\tkmixins.py
# Compiled at: 2019-10-24 09:39:32
# Size of source mod 2**32: 13196 bytes
    ...
    def _update_align(self, align):
        ...
        if align is not None:
            if align in ('top', 'bottom', 'left', 'right'):
                ...
                utils.error_format("Invalid align value ('{}') for {}\nShould be: top, bottom, left or right".format(align, self.description))
