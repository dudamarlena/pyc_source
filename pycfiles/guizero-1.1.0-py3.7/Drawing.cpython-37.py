...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\guizero\Drawing.py
# Compiled at: 2019-10-24 09:39:32
# Size of source mod 2**32: 9533 bytes
...
class Drawing(Widget):
    ...
    def line(self, x1, y1, x2, y2, color='black', width=1):
        ...
        :return:
            The id of the line.
        """
        return self.tk.create_line(x1,
          y1, x2, y2, width=width,
    ...
    def oval(self, x1, y1, x2, y2, color='black', outline=False, outline_color='black'):
        ...
        :return:
            The id of the shape.
        """
        return self.tk.create_oval(x1,
          y1, x2, y2, outline=(utils.convert_color(outline_color) if outline else ''),
          width=(int(outline)),
          fill=('' if color is None else utils.convert_color(color)))
    ...
    def rectangle(self, x1, y1, x2, y2, color='black', outline=False, outline_color='black'):
        ...
        :return:
            The id of the shape.
        """
        return self.tk.create_rectangle(x1,
          y1, x2, y2, outline=(utils.convert_color(outline_color) if outline else ''),
          width=(int(outline)),
          fill=('' if color is None else utils.convert_color(color)))
    ...
    def polygon(self, *coords, color='black', outline=False, outline_color='black'):
        ...
        :return:
            The id of the shape.
        """
        return (self.tk.create_polygon)(*coords, outline=utils.convert_color(outline_color) if outline else '', 
         width=int(outline), 
         fill='' if color is None else utils.convert_color(color))
    ...
    def triangle(self, x1, y1, x2, y2, x3, y3, color='black', outline=False, outline_color='black'):
        ...
        :return:
            The id of the shape.
        """
        return self.polygon(x1,
          y1, x2, y2, x3, y3, color=color,
          outline=outline,
