...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\guizero\CheckBox.py
...
class CheckBox(TextWidget):
    ...
    def __init__(self, master, text='', command=None, grid=None, align=None, args=None, visible=True, enabled=None, width=None, height=None):
        """
        Creates a CheckBox
