...
# [GCC 8.4.0]
# Embedded file name: /root/project/znbdownload/views.py
# Compiled at: 2019-07-04 12:31:40
...
class SecretFileView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['s3_url'] = '{}/{}'.format(getattr(settings, 'MEDIA_URL'), download.private_file.name)
        return context
