...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/poly/rcp.py
# Compiled at: 2006-09-08 05:35:20
from __future__ import division
__version__ = '$Revision: 1.2 $'
import commands, itertools, os, sys, time
...
LSLOAD_CMDLINE = str(lsf_bin_dirpath / 'lsload -E -I r1m:r15s:r15m:ut %s | awk \'/ok|busy/ { print $0 }\' | sed -e "s/*/ /g" | tr -s " " " " | sort -k 3n,6n -k 3,6 | head -n 1')
...
def sleep(try_index, r1m_str, r15s_str, max_type, rqueue_max):
    ...
    _log.info('try #%d; r1m=%s; r15s=%s; %s max=%s; retrying in %d s', try_index, r1m_str, r15s_str, max_type, rqueue_max, sleep_time)
