...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/neorg/verutils.py
# Compiled at: 2011-06-06 16:46:49
...
class NEOrgVersion(object):
    ...
    def __init__(self, verstr):
        ...
        try:
            ...
            raise ValueError(("first three parts must be integers. given version string: '{0}'").format(verstr))
        ...
        if len(verstrtuple) == 3:
            ...
            raise ValueError(("'{0}' is not valid NEOrg version string").format(verstr))
    ...
    def _cannot_compare(self, other):
        raise ValueError(('cannot compare {0} and {1}').fromat(type(self).__name__, type(other).__name__))
