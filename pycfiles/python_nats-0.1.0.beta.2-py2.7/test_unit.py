...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/test_unit.py
...
class TestCommon(unittest.TestCase):
    ...
    def test_fake_uri(self):
        ...
        self.assertRaises(NotImplementException, Common.parse_address_info, 123456)
    ...
    def test_non_nats_protocol(self):
        ...
        self.assertRaises(NotImplementException, Common.parse_address_info, non_nats_uri)
...
class TestProtocol(unittest.TestCase):
    ...
    def test_protocol_regular_in_table(self):
        ...
        with patch.dict(Protocol.PROTOCOL_TABLE, {'proto': 'content'}, clear=True):
            self.assertEqual(Protocol.protocol_regular('proto'), re.compile('content'))
    ...
    def test_connect_command(self):
        ...
        opts = {'user': 'a', 'pass': 'b'}
        self.assertEqual(Protocol.connect_command(opts), 'CONNECT {"user": "a", "pass": "b"}\r\n')
