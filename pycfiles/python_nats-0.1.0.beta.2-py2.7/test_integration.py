...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/test_integration.py
# Compiled at: 2014-08-31 04:21:17
...
class NatsClientTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.processHelper = NatsServerHelper(cls.directory, proc_name=program)
