...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/magot/accountHierarchy.py
# Compiled at: 2006-05-08 16:28:25
import sys, wx, wx.gizmos
...
class AccountTreeListCtrl(wx.gizmos.TreeListCtrl, TreeListCtrlAutoWidthMixin):
    ...
    def __init__(self, parent, ID, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.TR_DEFAULT_STYLE):
...
class AccountHierarchy(wx.Panel):
    ...
    def __init__(self, parent, accRoot):
        ...
        self.parent = parent
        self.tree = AccountTreeListCtrl(self, -1, style=wx.TR_HIDE_ROOT | wx.TR_LINES_AT_ROOT | wx.TR_ROW_LINES | wx.TR_HAS_BUTTONS)
        isz = (16, 16)
