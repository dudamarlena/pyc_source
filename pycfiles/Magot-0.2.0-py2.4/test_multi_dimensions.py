...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/magot/tests/test_multi_dimensions.py
# Compiled at: 2006-11-01 12:59:57
...
class RoomNumber(DimensionMember):
    __module__ = __name__


class Location(DimensionMember):
    __module__ = __name__


class Expense(DimensionMember):
    __module__ = __name__
