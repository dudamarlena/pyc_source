...
# [GCC 8.4.0]
# Embedded file name: C:\Users\ealesid\PycharmProjects\geekbrains_python\jimmer\jimmer\client\html_parser.py
# Compiled at: 2017-12-05 14:21:16
# Size of source mod 2**32: 1381 bytes
from html.parser import HTMLParser
tags_opened = []
formats_opened = []
text_tags = ['p', 'span']
attrs_to_tags = {'font-weight': 'b', 
 'font-style': 'i', 
 'text-decoration': 'u'}
...
class HtmlToShortTag(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        if tag == 'img':
            ...
            for attr in attrs:
                formats_opened.extend([attrs_to_tags.get(a.split(':')[0]) for a in attr[1].split() if a.split(':')[0] in attrs_to_tags.keys()])
                if formats_opened:
