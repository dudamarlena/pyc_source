...
# [GCC 8.4.0]
# Embedded file name: C:\Users\ealesid\PycharmProjects\geekbrains_python\jimmer\jimmer\config\log_config.py
# Compiled at: 2017-12-13 14:49:31
...
log_messages = {'client': {'__init__': {SUCCESSFUL_MSG_KEY: CLIENT_INIT_SUCC_MSG, 
                         UNSUCCESSFUL_MSG_KEY: CLIENT_INIT_UNSUCC_MSG}, 
            
            'start_session': {SUCCESSFUL_MSG_KEY: CLIENT_CONN_SUCC_MSG, 
                              UNSUCCESSFUL_MSG_KEY: CLIENT_CONN_UNSUCC_MSG}, 
            
            'end_session': {SUCCESSFUL_MSG_KEY: CLIENT_DISCONN_SUCC_MSG, 
                            UNSUCCESSFUL_MSG_KEY: CLIENT_DISCONN_UNSUCC_MSG}, 
            
            'send_message': {SUCCESSFUL_MSG_KEY: CLIENT_SEND_MSG_SUCC, 
                             UNSUCCESSFUL_MSG_KEY: CLIENT_SEND_MSG_UNSUCC}, 
            
            'receive_message': {SUCCESSFUL_MSG_KEY: CLIENT_RECV_MSG_SUCC, 
