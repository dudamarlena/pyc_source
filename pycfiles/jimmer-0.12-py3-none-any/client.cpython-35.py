...
# [GCC 8.4.0]
# Embedded file name: C:\Users\ealesid\PycharmProjects\geekbrains_python\jimmer\jimmer\client\client.py
# Compiled at: 2017-12-06 13:21:44
        ...
        while self.connected:
            try:
                ...
                if self.received_data:
                    ...
                    for m in [json.loads(i) for i in re.findall('{[^{}]*}', _json_string)]:
