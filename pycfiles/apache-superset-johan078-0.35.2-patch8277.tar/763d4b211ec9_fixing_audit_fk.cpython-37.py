...
# Embedded file name: /Users/bogdankyryliuk/src/oss/incubator-superset/superset/migrations/versions/763d4b211ec9_fixing_audit_fk.py
# Compiled at: 2020-01-16 13:27:41
# Size of source mod 2**32: 7039 bytes
__doc__ = 'fixing audit fk\n\nRevision ID: 763d4b211ec9\nRevises: d2424a248d63\nCreate Date: 2016-03-24 14:13:44.817723\n\n'
...
def downgrade():
    ...
    try:
        op.alter_column('url',
          'created_on', existing_type=(sa.DATETIME()), nullable=False)
        op.alter_column('url',
          'changed_on', existing_type=(sa.DATETIME()), nullable=False)
        op.alter_column('tables',
          'created_on', existing_type=(sa.DATETIME()), nullable=False)
        op.alter_column('tables',
          'changed_on', existing_type=(sa.DATETIME()), nullable=False)
        ...
        op.alter_column('datasources',
          'created_on', existing_type=(sa.DATETIME()), nullable=False)
        op.alter_column('datasources',
          'created_by_fk', existing_type=(sa.INTEGER()), nullable=False)
        op.alter_column('datasources',
          'changed_on', existing_type=(sa.DATETIME()), nullable=False)
        op.alter_column('datasources',
          'changed_by_fk', existing_type=(sa.INTEGER()), nullable=False)
        op.alter_column('dashboards',
          'created_on', existing_type=(sa.DATETIME()), nullable=False)
        op.alter_column('dashboards',
          'changed_on', existing_type=(sa.DATETIME()), nullable=False)
