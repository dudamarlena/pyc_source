...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pagingish/webpaging.py
...
class Paging(object):
    ...
    @property
    def has_range(self):
        return self._range_left is not None and self._range_center is not None and self._range_right is not None
