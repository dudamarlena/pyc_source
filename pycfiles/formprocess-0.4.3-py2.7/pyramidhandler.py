...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/formprocess/pyramidhandler.py
# Compiled at: 2011-03-29 01:44:47
...
def set_fill_encoding(handler_instance, defaults, errors, state, fill_kwargs):
    ...
    fill_kwargs.update({'encoding': getattr(request, 'charset', 'utf-8')})
    return fill_kwargs
