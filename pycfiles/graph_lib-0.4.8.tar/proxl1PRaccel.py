...
# [GCC 8.4.0]
# Embedded file name: /Users/mengliu/Dropbox/Research/graph_lib/graph_lib/wrappers/python/proxl1PRaccel.py
# Compiled at: 2017-09-07 23:25:10
"""
 * INPUT:
...
def proxl1PRaccel(ai, aj, a, ref_node, d, ds, dsinv, alpha=0.15, rho=1e-05, epsilon=0.0001, maxiter=10000, max_time=100):
    n = len(ai) - 1
