...
# [GCC 8.4.0]
# Embedded file name: /home/erwincoumans/dev/tmp/bullet3/examples/pybullet/gym/pybullet_envs/bullet/minitaur.py
# Compiled at: 2020-04-29 23:02:34
# Size of source mod 2**32: 21331 bytes
...
class Minitaur(object):
    __doc__ = 'The minitaur class that simulates a quadruped robot from Ghost Robotics.\n\n  '
    ...
    """
        ...
        if self._accurate_motor_model_enabled:
            self._kp = motor_kp
            self._kd = motor_kd
            self._motor_model = motor.MotorModel(torque_control_enabled=(self._torque_control_enabled), kp=(self._kp),
              kd=(self._kd))
        else:
    ...
    """
        if reload_urdf:
            ...
            if self._on_rack:
                self._pybullet_client.createConstraint(self.quadruped, -1, -1, -1, self._pybullet_client.JOINT_FIXED, [0, 0, 0], [
                 0, 0, 0], [0, 0, 1])
        else:
    ...
    def _SetMotorTorqueById(self, motor_id, torque):
        self._pybullet_client.setJointMotorControl2(bodyIndex=(self.quadruped), jointIndex=motor_id,
    ...
    """
        ...
        self._pybullet_client.resetJointState((self.quadruped), (self._joint_name_to_id[('motor_' + leg_position + 'L_joint')]),
          (self._motor_direction[(2 * leg_id)] * half_pi),
          targetVelocity=0)
        self._pybullet_client.resetJointState((self.quadruped), (self._joint_name_to_id[('knee_' + leg_position + 'L_link')]),
          (self._motor_direction[(2 * leg_id)] * knee_angle),
          targetVelocity=0)
        self._pybullet_client.resetJointState((self.quadruped), (self._joint_name_to_id[('motor_' + leg_position + 'R_joint')]),
          (self._motor_direction[(2 * leg_id + 1)] * half_pi),
          targetVelocity=0)
        self._pybullet_client.resetJointState((self.quadruped), (self._joint_name_to_id[('knee_' + leg_position + 'R_link')]),
