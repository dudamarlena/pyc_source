...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/config/meta.py
...
class ClassExplorer(Writable):
    ...
    def __init__(self, include_classes: Set[Type], exclude_classes: Set[Type]=frozenset(), indent=4, attr_truncate_len=80):
    ...
    def _should_explore(self, inst: object, include_classes: Set[Type], exclude_classes: Set[Type]) -> bool:
    ...
    def _get_metadata(self, inst: object, include_classes: Set[Type], exclude_classes: Set[Type]) -> dict:
        dat = None
        ...
        if any(map(lambda t: isinstance(inst, t), include_classes)):
            ...
            for attr in inst.__dir__():
                ...
                child = self._get_metadata(child_inst, include_classes, exclude_classes)
    ...
    def write(self, depth: int=0, writer: TextIOWrapper=sys.stdout, metadata: dict=None):
