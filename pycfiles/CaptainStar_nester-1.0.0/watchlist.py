...
# Embedded file name: build/bdist.linux-x86_64/egg/cptsoul/mainwindow/watchlist.py
# Compiled at: 2014-01-13 07:02:43
import gtk
...
class WatchList(gtk.TreeView, CptCommon):
    ...
    def updateLogin(self, login_name):
        ...
        if it is not None:
            self._listStore.set(it, 0, self.getStatePix(state), 2, self.getAtSchoolPix(atSchool))
        return
