...
# Embedded file name: build/bdist.linux-x86_64/egg/cptsoul/debugwindow/debugview.py
# Compiled at: 2014-01-02 09:35:06
import gtk
...
class DebugView(gtk.ScrolledWindow, CptCommon):
    ...
    def __init__(self):
        ...
        self.set_properties(border_width=0, shadow_type=gtk.SHADOW_ETCHED_IN, hscrollbar_policy=gtk.POLICY_AUTOMATIC, vscrollbar_policy=gtk.POLICY_AUTOMATIC)
        self._buffer = None
        self._createUi()
    ...
    def _createUi(self):
        ...
        textview.set_properties(cursor_visible=False, editable=False, wrap_mode=gtk.WRAP_NONE)
