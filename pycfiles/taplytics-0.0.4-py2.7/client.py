...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/taplytics/client.py
# Compiled at: 2017-07-05 14:25:53
import json, requests
from uuid import uuid4
import platform, sys, datetime, urllib
...
class Client:
    ...
    def base_request_params(self, user_id):
        ...
        get_params = {'sdk': self.sdk_version, 
           't': self.sdk_key, 
           'os': 'server', 
