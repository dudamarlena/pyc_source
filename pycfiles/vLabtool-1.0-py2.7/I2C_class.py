...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vLabtool/I2C_class.py
# Compiled at: 2015-08-17 16:37:54
...
class I2C:
    ...
    def config(self, freq, verbose=True):
        ...
        BRGVAL = int((1.0 / freq - 1.0 / 10000000.0) * 64000000.0 - 1)
        if BRGVAL > 511:
            BRGVAL = 511
            if verbose:
                print 'Frequency too low. Setting to :', 1 / ((BRGVAL + 1.0) / 64000000.0 + 1.0 / 10000000.0)
    ...
    def start(self, address, rw):
        ...
        self.H.__sendByte__((address << 1 | rw) & 255)
