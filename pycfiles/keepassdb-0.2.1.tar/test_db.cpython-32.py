...
# [GCC 8.4.0]
# Embedded file name: /home/hans/workspace/keepassdb/tests/test_db.py
# Compiled at: 2012-12-30 21:53:09
"""
...
class DatabaseTest(TestBase):
    ...
    def test_load_file(self):
        ...
        with self.assertRaisesRegexp(ValueError, 'Password and/or keyfile is required.'):
            db.load(kdb)
    ...
    def test_save(self):
        ...
        with self.assertRaisesRegexp(ValueError, 'Unable to save without target file.'):
