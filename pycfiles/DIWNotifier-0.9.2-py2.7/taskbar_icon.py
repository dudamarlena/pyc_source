...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/diwnotifier/taskbar_icon.py
# Compiled at: 2014-02-05 13:47:16
    ...
    def CreatePopupMenu(self):
        ...
        if self.update:
            ...
            if flags[0] or flags[1]:
                menu.AppendSeparator()
            self.create_menu_item(menu, 'Friends Online [' + self.friendsc + ']', None, 'data/images/icons/friends.png', Settings.FRIENDS_URL)
            if self.msgc != '0':
                spam = 'mail-mark-important.png'
            else:
                spam = 'mail-message.png'
            self.create_menu_item(menu, 'Messaggi [' + self.msgc + ']', None, 'data/images/icons/' + spam, Settings.MSG_URL)
            menu.AppendSeparator()
            self.create_menu_item(menu, self.quote_string, None, 'data/images/icons/mail-inbox.png', Settings.MSG_URL, False)
            menu.AppendSeparator()
            self.create_menu_item(menu, 'Notifiche [' + self.notifyc + ']', None, 'data/images/icons/notifications.png', Settings.NOTIFICATIONS_URL)
            self.create_menu_item(menu, 'Shoutbox [' + self.shoutboxc + ']', None, 'data/images/icons/shoutbox.png', Settings.SHOUTBOX_URL)
            menu.AppendSeparator()
