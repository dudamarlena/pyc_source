...
# [GCC 8.4.0]
# Embedded file name: /Users/meren/Desktop/MBL/Oligotyping/oligotyping/Unittests/_decomposition_threaded.py
# Compiled at: 2014-07-21 09:00:13
...
class Tests(unittest.TestCase):
    ...
    def test_02_Environment(self):
        self.assertTrue(files_are_the_same(os.path.join(my_path, 'files/reads-noisy-environment.txt'), os.path.join(self.output_directory_path, 'ENVIRONMENT.txt')))

    def test_03_MatrixPercent(self):
        self.assertTrue(files_are_the_same(os.path.join(my_path, 'files/reads-noisy-matrix-percent.txt'), os.path.join(self.output_directory_path, 'MATRIX-PERCENT.txt')))
