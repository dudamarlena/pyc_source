...
# [GCC 8.4.0]
# Embedded file name: /Users/meren/Desktop/MBL/Oligotyping/oligotyping/Unittests/_blast.py
# Compiled at: 2014-07-21 09:46:18
...
class Tests(unittest.TestCase):
    ...
    def test_01_ParallelBlast(self):
        s = blast.LocalBLAST(self.query, self.target, self.output)
        s.make_blast_db()
