...
# [GCC 8.4.0]
# Embedded file name: /Users/meren/Desktop/MBL/Oligotyping/oligotyping/Unittests/_decomposition.py
# Compiled at: 2014-07-21 08:52:05
...
class Tests(unittest.TestCase):
    ...
    def test_02_Decompose(self):
        ...
        self.assertTrue(self.decomposer.topology.nodes['root'].entropy_tpls[0:5] == [(292, 2.2031591775819033), (296, 2.1539606786564707), (293, 2.1279277605456857), (298, 2.117039467062623), (300, 2.107517097722345)])
    ...
    def test_03_Environment(self):
        self.assertTrue(files_are_the_same(os.path.join(my_path, 'files/clone43-v6v4-environment.txt'), os.path.join(self.output_directory_path, 'ENVIRONMENT.txt')))

    def test_04_MatrixPercent(self):
        self.assertTrue(files_are_the_same(os.path.join(my_path, 'files/clone43-v6v4-matrix-percent.txt'), os.path.join(self.output_directory_path, 'MATRIX-PERCENT.txt')))
