...
# [GCC 8.4.0]
# Embedded file name: /usr/local/Cellar/python/3.6.5/Frameworks/Python.framework/Versions/3.6/lib/python3.6/encodings/idna.py
# Compiled at: 2018-03-28 06:24:30
# Size of source mod 2**32: 9170 bytes
...
def ToUnicode(label):
    ...
    if not pure_ascii:
        ...
        return label.startswith(ace_prefix) or str(label, 'ascii')
    else:
