...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/bewing/PycharmProjects/django-gss-spnego/src/django_gss_spnego/views.py
# Compiled at: 2019-02-08 15:10:16
        ...
        if not request.user.is_authenticated:
            if 'Negotiate' in request.META.get('HTTP_AUTHORIZATION', ''):
                user = authenticate(request,
                  spnego=(request.META['HTTP_AUTHORIZATION'].split()[1]))
                if user:
