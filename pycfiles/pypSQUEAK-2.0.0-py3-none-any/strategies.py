...
# Embedded file name: /home/dswistowski/pso/pypso/src/pypso/strategies.py
# Compiled at: 2007-09-19 12:23:18
__doc__ = 'Moduł zawiarający strategie poruszania się agentów'
...
class Strategy(Parameters):
    ...
    def restart(self, pso):
        u"""Inicjuje pso tworząc losowe cząsteczki"""
...
class NSelekcja(Strategy):
    u"""Pamiętane jest n najlepszych globalnych, i z tego wybierany jest losowo jeden"""
...
class PSODE(SelekcjaPojedyncza):
    u"""Pso ze ściskiem wyznaczanym różnicą"""
