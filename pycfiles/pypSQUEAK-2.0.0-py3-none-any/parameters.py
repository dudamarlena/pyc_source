...
__doc__ = 'Moduł zawiera klase paramety, umiżliwiająco posiadanie przez iine obiekrty typu funkcja, strategia parametrów. Te parametry mogą być stałe, lub zmieniane w czasie działania algorytmu'
