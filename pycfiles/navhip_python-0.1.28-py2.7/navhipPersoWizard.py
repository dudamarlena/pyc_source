...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/navhip/navhipPersoWizard.py
# Compiled at: 2020-02-12 12:25:49
"""
*******************************************************************************
...
import ui.personalization00start, ui.personalization01seed, ui.personalization02security, ui.personalization03config, ui.personalization04finalize, ui.personalizationseedbackup01, ui.personalizationseedbackup02, ui.personalizationseedbackup03, ui.personalizationseedbackup04
BTCHIP_DEBUG = False
...
class StartBTChipPersoDialog(QtGui.QDialog):
    ...
    def processNext(self):
        persoData = {}
        persoData['currencyCode'] = 0
        persoData['currencyCodeP2SH'] = 5
    ...
    def processNext(self):
        ...
        if self.ui.RestoreWalletButton.isChecked():
            ...
            try:
                ...
                elif len(self.persoData['seed']) < 32 or len(self.persoData['seed']) > 64:
...
class ConfigDialog(QtGui.QDialog):
    ...
    def processNext(self):
        if self.ui.qwertyButton.isChecked():
            ...
            if self.ui.qwertzButton.isChecked():
                self.persoData['keyboard'] = navhip.QWERTZ_KEYMAP
            else:
                if self.ui.azertyButton.isChecked():
            ...
            try:
                self.persoData['client'].setup(mode, navhip.FEATURE_RFC6979, self.persoData['currencyCode'], self.persoData['currencyCodeP2SH'], self.persoData['pin'], None, self.persoData['keyboard'], self.persoData['seed'])
            except BTChipException as e:
                if e.sw == 27013:
