...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/pyphoon/utils/eda_jma.py
# Compiled at: 2018-02-06 02:41:42
...
feature_names = [
 'year', 'month', 'day', 'hour', 'class', 'latitude',
...
def plot_hist(data, feature_index, bins=100, show_fig=False, title='untitled', save_fig=False, fig_name='untitled'):
...
def plot_2feature_heatmap(data, index1, index2=4, annotation=True, linewidths=0.5, show_fig=False, title='untitled', save_fig=False, fig_name='untitled'):
    ...
    sns.heatmap(df, cmap='RdYlGn_r', linewidths=linewidths, annot=annotation, fmt='g')
