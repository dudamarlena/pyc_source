...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/haplugin/formskit/helpers.py
# Compiled at: 2015-05-19 02:32:00
...
class FormWidget(Jinja2HelperMany):
    ...
    def _input(self, input_type, name, disabled=False, autofocus=False, prefix=None, **kwargs):
    ...
    def submit(self, label='', cls='btn-success', base_cls='btn btn-lg'):
        return self.render_for('submit.jinja2', {'label': label, 
         'class': cls, 
         'base_class': base_cls})
