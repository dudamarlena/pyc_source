...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/haplugin/formskit/testing.py
# Compiled at: 2015-05-19 02:46:42
...
class FormWidgetFixture(RequestFixture):
    ...
    def _input_test(self, render_for, widget, form, name, method_name=None, external=None, **kwargs):
        ...
        data = {'name': field.get_name(), 
         ...
         'label': field.label, 
         'error': field.error, 
         'messages': form.fields.__getitem__.return_value.get_error_messages.return_value, 
         'value_messages': form.fields.__getitem__.return_value.get_value_errors.return_value, 
         'disabled': True, 
         'autofocus': False}
        data.update(external)
        self.assert_render_for(result, render_for, (name + '.jinja2'), data, **kwargs)
