...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/django/chatbot/handler.py
...
class UserMemory:
    ...
    def __getitem__(self, key):
        try:
            return Memory.objects.get(sender__messengerSenderID=(self.senderID), key__iexact=key).value
