...
# [GCC 8.4.0]
# Embedded file name: /home/mark/django_avem_theme/avem_theme/templatetags/ext.py
    ...
    for extra in [_f for _f in (extra1, extra2, extra3, extra4, extra5) if _f]:
        try:
            ...
            try:
                ...
                raise TypeError('|json filter called with incompatible arguments that could not be combined: %s and %s' % (
                 type(obj), type(extra)))
