...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/janrain/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('janrain_janrainprofile', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
         (
          'janrain_uuid', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True))))
        db.send_create_signal('janrain', ['JanrainProfile'])

    def backwards(self, orm):
        db.delete_table('janrain_janrainprofile')
