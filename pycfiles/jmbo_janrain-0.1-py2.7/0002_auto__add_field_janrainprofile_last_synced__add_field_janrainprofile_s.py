...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/janrain/migrations/0002_auto__add_field_janrainprofile_last_synced__add_field_janrainprofile_s.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('janrain_janrainprofile', 'last_synced', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)
        db.add_column('janrain_janrainprofile', 'status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        db.delete_column('janrain_janrainprofile', 'last_synced')
        db.delete_column('janrain_janrainprofile', 'status')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'janrain.janrainprofile': {'Meta': {'object_name': 'JanrainProfile'}, 'id': (
                                       'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                  'janrain_uuid': (
