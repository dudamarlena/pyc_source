...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/opentracing_utils/decorators.py
...
def trace(component=None, operation_name=None, tags=None, use_follows_from=False, pass_span=False, inspect_stack=True, ignore_parent_span=False, span_extractor=None, skip_span=None):
    """
    ...
    def trace_decorator(f):
        ...
        def wrapper(*args, **kwargs):
            ...
            span_arg_name, current_span = get_new_span(f, args, kwargs, inspect_stack=inspect_stack, ignore_parent_span=ignore_parent_span, span_extractor=span_extractor, use_follows_from=use_follows_from)
