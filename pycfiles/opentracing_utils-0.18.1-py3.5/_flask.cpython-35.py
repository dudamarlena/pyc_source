...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/opentracing_utils/libs/_flask.py
# Compiled at: 2019-02-13 08:31:21
# Size of source mod 2**32: 5306 bytes
import logging, opentracing
...
def trace_flask(app, request_attr=DEFUALT_REQUEST_ATTRIBUTES, response_attr=DEFUALT_RESPONSE_ATTRIBUTES, default_tags=None, error_on_4xx=True, mask_url_query=False, mask_url_path=False, operation_name=None, skip_span=None):
    """
            ...
            for attr in request_attr:
                if hasattr(request, attr):
                    try:
                        ...
                        tag_key = attr
                        if attr == 'url':
                            tag_value = sanitize_url(tag_value, mask_url_query=mask_url_query, mask_url_path=mask_url_path)
