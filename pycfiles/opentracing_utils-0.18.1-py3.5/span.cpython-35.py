...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/opentracing_utils/span.py
# Compiled at: 2019-02-13 08:31:21
# Size of source mod 2**32: 2904 bytes
import inspect, logging, opentracing
from opentracing import child_of, follows_from
from opentracing.ext import tags as opentracing_tags
DEFAULT_SPAN_ARG_NAME = '__OPENTRACINGUTILS_SPAN'
logger = logging.getLogger(__name__)

def get_new_span(f, func_args, func_kwargs, operation_name=None, inspect_stack=True, ignore_parent_span=False, span_extractor=None, use_follows_from=False):
    parent_span = None
