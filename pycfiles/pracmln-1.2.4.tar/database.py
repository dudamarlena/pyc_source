...
# [GCC 8.4.0]
# Embedded file name: /home/nyga/work/code/pracmln/python2/pracmln/mln/database.py
...
class Database(object):
    ...
    def isempty(self):
        ...
        """
        return not any(map(lambda x: x >= 0 and x <= 1, self._evidence.values())) and len(self.domains) == 0
