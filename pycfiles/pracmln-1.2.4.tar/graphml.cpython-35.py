...
# [GCC 8.4.0]
# Embedded file name: /home/nyga/code/pracmln/python3/pracmln/utils/graphml.py
# Compiled at: 2018-04-24 04:48:32
# Size of source mod 2**32: 5923 bytes
import sys, re, colorsys, math
randomVariableColor = '#B1CBDA'
decisionNodeColor = '#45CA46'
...
def to_html_hex(c1, c2, c3, model):
    ...
    r, g, b = int(math.floor(r * 255.0)), int(math.floor(g * 255.0)), int(math.floor(b * 255.0))
