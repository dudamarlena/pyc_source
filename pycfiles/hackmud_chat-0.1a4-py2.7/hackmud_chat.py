...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-intel/egg/hackmud_chat/hackmud_chat.py
...
class User(object):
    ...
    def update_history(self):
        self.messages = [ Message(m) for m in sorted(hackmud.get_chats(self.account.token, [
         self.name])['chats'][self.name], key=lambda msg: msg['t'])
                        ]
