...
# Size of source mod 2**32: 24234 bytes
import collections, concurrent.futures, io, json, logging, os, shutil, sys, tarfile, tempfile
from typing import IO, Dict, Iterable, List, Optional, Sequence, Set, TextIO, Tuple
...
def print_code(stencil: core.Stencil, xo_file: IO[bytes], device_info: Dict[(str, str)], jobs: Optional[int]=os.cpu_count(), rpt_file: Optional[str]=None, interface: str='m_axi') -> None:
