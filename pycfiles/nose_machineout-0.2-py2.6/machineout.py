...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/machineout.py
# Compiled at: 2010-07-23 09:04:59
"""
...
"""
import re, os.path, traceback
from nose.plugins import Plugin
__all__ = [
 'NoseMachineReadableOutput']
try:
    import doctest
...
class NoseMachineReadableOutput(Plugin):
    ...
    def add_options(self, parser, env):
        ...
        parser.add_option('--machine-output', action='store_true', dest='machine_output', default=False, help='Reports test results in easily parsable format.')
