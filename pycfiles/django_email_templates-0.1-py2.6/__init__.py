...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/email_templates/__init__.py
# Compiled at: 2011-03-20 08:42:30
from django.core.mail import EmailMultiAlternatives, EmailMessage, get_connection
from django.template.loader import get_template
from django.template import Context, TemplateDoesNotExist

def send_templated_mail(subject, from_email, to, template_name, context={}, fail_silently=False, connection=None, template_prefix='email_templates/'):
    """
    ...
    if plaintext and not html:
        ...
        msg = EmailMessage(subject, text_content, from_email, to, connection=connection)
        result = msg.send(fail_silently=fail_silently)
    if html and not plaintext:
        print 'html and not plaintext'
        msg = EmailMessage(subject, html_content, from_email, to, connection=connection)
