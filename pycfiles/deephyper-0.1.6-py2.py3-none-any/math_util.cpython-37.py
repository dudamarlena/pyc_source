...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/common/math_util.py
...
def explained_variance(ypred, y):
    ...
    """
    if not (y.ndim == 1 and ypred.ndim == 1):
        raise AssertionError
    vary = np.var(y)
    if vary == 0:
        return np.nan
    return 1 - np.var(y - ypred) / vary


def explained_variance_2d(ypred, y):
    if not (y.ndim == 2 and ypred.ndim == 2):
        raise AssertionError
