...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/her/normalizer.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 5325 bytes
import threading, numpy as np
from mpi4py import MPI
import tensorflow as tf
from deephyper.search.nas.baselines.her.util import reshape_for_broadcasting
...
class Normalizer:
    ...
    def recompute_stats(self):
        with self.lock:
            ...
            self.local_sum[...] = 0
            self.local_sumsq[...] = 0
        synced_sum, synced_sumsq, synced_count = self.synchronize(local_sum=local_sum,
          local_sumsq=local_sumsq,
          local_count=local_count)
        self.sess.run((self.update_op), feed_dict={self.count_pl: synced_count, 
