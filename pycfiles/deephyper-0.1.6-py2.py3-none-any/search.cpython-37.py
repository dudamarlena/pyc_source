...
class Search:
    ...
    def __init__(self, problem: str, run: str, evaluator: str, max_evals: int=100, seed: int=None, **kwargs):
        ...
        logger.info('Options: ' + pformat(kwargs, indent=4))
    ...
    def _base_parser(parser=None) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--problem', help='Module path to the Problem instance you want to use for the search.')
        parser.add_argument('--run', help='Module path to the run function you want to use for the search.')
        ...
        parser.add_argument('--evaluator', default='ray',
          choices=[
         'balsam',
         'ray',
         'subprocess',
        ...
        parser.add_argument('--cache-key', default='uuid',
          help='Cache policy.')
        return parser