...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/model/space/nx_search_space.py
# Compiled at: 2019-09-05 10:20:47
# Size of source mod 2**32: 6309 bytes
import networkx as nx
from collections.abc import Iterable
from deephyper.core.exceptions.nas.space import InputShapeOfWrongType, NodeAlreadyAdded, StructureHasACycle, WrongOutputShape, WrongSequenceToSetOperations
from deephyper.search.nas.model.space.node import ConstantNode, Node, VariableNode

class NxSearchSpace:
    __doc__ = 'A NxSearchSpace is an search_space based on a networkx graph.\n    '
    ...
    def connect(self, node1, node2):
        ...
        if not isinstance(node1, Node):
            ...
            assert nx.is_directed_acyclic_graph(self.graph), f"the connection between {node1} -> {node2} is creating a cycle in the search_space's graph."
