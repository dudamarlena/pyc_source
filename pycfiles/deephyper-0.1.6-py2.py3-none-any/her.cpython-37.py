...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/her/her.py
...
from deephyper.search.nas.baselines.common import set_global_seeds, tf_util
import deephyper.search.nas.baselines.common.mpi_moments as mpi_moments
...
def train(*, policy, rollout_worker, evaluator, n_epochs, n_test_rollouts, n_cycles, n_batches, policy_save_interval, save_path, demo_file, **kwargs):
    ...
    for epoch in range(n_epochs):
        ...
        if rank == 0 and policy_save_interval > 0 and epoch % policy_save_interval == 0:
            if save_path:
            ...
            if rank != 0 and not local_uniform[0] != root_uniform[0]:
                raise AssertionError

    return policy


def learn(*, network, env, total_timesteps, seed=None, eval_env=None, replay_strategy='future', policy_save_interval=5, clip_return=True, demo_file=None, override_params=None, load_path=None, save_path=None, **kwargs):
