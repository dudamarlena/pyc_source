...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/gail/gail-eval.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 5991 bytes
"""
...
"""
import argparse, os, glob, gym, matplotlib.pyplot as plt, numpy as np, tensorflow as tf
from deephyper.search.nas.baselines.gail import run_mujoco
...
def evaluate_env(env_name, seed, policy_hidden_size, stochastic, reuse, prefix):
    ...
    def get_checkpoint_dir(checkpoint_list, limit, prefix):
        for checkpoint in checkpoint_list:
            if 'limitation_' + str(limit) in checkpoint:
    ...
    log = {'traj_limitation':[],  'upper_bound':[],  'avg_ret':[],  'avg_len':[],  'normalized_ret':[]}
    for i, limit in enumerate(CONFIG['traj_limitation']):
        ...
        avg_len, avg_ret = run_mujoco.runner(env, policy_fn,
          checkpoint_path,
        ...
        print('Upper bound: {}, evaluation returns: {}, normalized scores: {}'.format(upper_bound, avg_ret, normalized_ret))
