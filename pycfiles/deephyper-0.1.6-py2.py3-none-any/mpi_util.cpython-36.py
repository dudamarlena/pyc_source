...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/baselines/common/mpi_util.py
# Compiled at: 2019-07-10 12:45:57
# Size of source mod 2**32: 4259 bytes
from collections import defaultdict
import os, numpy as np, platform, shutil, subprocess, warnings, sys
try:
    ...
    if comm is None:
        ...
        for k, li in k2li.items():
            if assert_all_have_data:
                if not len(li) == size:
                    raise AssertionError("only %i out of %i MPI workers have sent '%s'" % (len(li), size, k))
            if op == 'mean':
