...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/search/nas/optimizer/ga_optimizer.py
...
class GAOptimizer:
    ...
    def _setup(self):
        ...
        self.toolbox.register('Individual', tools.initIterate, creator.Individual, self.toolbox.uniformparams)
