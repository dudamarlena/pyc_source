...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/post/train.py
...
class Manager:
    ...
    def _base_parser():
        ...
        parser.add_argument('--problem', help='Module path to the Problem instance you want to use for the post-training (e.g. deephyper.benchmark.hps.polynome2.Problem).')
        parser.add_argument('--fbest', help="Path to the 'json' file containing the list of best architectures. ")
