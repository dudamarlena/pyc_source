...
# [GCC 8.4.0]
# Embedded file name: /Users/romainegele/Documents/Argonne/deephyper/build/lib/deephyper/evaluator/_mpiWorkerPool.py
...
class MPIWorkerPool(Evaluator):
    ...
    def wait(self, futures, timeout=None, return_when='ANY_COMPLETED'):
        ...
        return WaitResult(active=active,
          done=done,
          failed=failed,
          cancelled=cancelled)
