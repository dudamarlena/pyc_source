...
# [GCC 8.4.0]
# Embedded file name: /home/ax/Workspace/norm/norm/executable/schema/variable.py
# Compiled at: 2019-05-20 17:28:08
...
class VariableName(NormExecutable):
    ...
    def compile(self, context):
        ...
        if self.scope is None:
            ...
            if isinstance(self.scope, ColumnVariable):
                if str(self) in self.scope.lam:
...
class ColumnVariable(VariableName):
    ...
    def compile(self, context):
        if self.scope is None:
            ...
            if isinstance(self.scope, Lambda):
                self.lam = self.scope
            else:
