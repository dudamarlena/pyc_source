        ...
        try:
            try:
                ...
                if _la == normParser.WS or _la == normParser.NS:
                    self.state = 85
                    _la = self._input.LA(1)
                    _la == normParser.WS or _la == normParser.NS or self._errHandler.recoverInline(self)
                else:
                ...
                if _la == normParser.WS or _la == normParser.NS:
                    self.state = 106
                    _la = self._input.LA(1)
                    if not (_la == normParser.WS or _la == normParser.NS):
        ...
        try:
            try:
                ...
                if token in [normParser.MULTILINE]:
                    ...
                    if token in [normParser.SINGLELINE]:
                        self.enterOuterAlt(localctx, 2)
                        self.state = 207
        ...
        try:
            try:
                ...
                if token in [normParser.VARNAME]:
                    ...
                    if token in [normParser.COMMAND]:
                        self.state = 299
                        self.match(normParser.COMMAND)
                    else:
                        if token in [normParser.ARGOPT]:
                            self.state = 300
                ...
                while _alt != 2:
                    if _alt != ATN.INVALID_ALT_NUMBER:
                        if _alt == 1:
                            ...
                            self.state = 305
                            _la = self._input.LA(1)
                            _la - 16 & -64 == 0 and 1 << _la - 16 & (1 << normParser.COMMAND - 16 | 1 << normParser.ARGOPT - 16 | 1 << normParser.VARNAME - 16) != 0 or self._errHandler.recoverInline(self)
                    else:
                        self._errHandler.reportMatch(self)
                        self.consume()
                    self.state = 310
    ...
    def argumentDeclarations(self):
        ...
        try:
            try:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la & -64 == 0 and 1 << _la & (1 << normParser.WS | 1 << normParser.NS | 1 << normParser.COMMA) != 0:
                    self.state = 334
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if _la == normParser.WS or _la == normParser.NS:
    ...
    def version(self):
        ...
        try:
            try:
                ...
                self.state = 387
                _la = self._input.LA(1)
                if not (_la & -64 == 0 and 1 << _la & (1 << normParser.T__1 | 1 << normParser.T__2 | 1 << normParser.UUID) != 0):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
        ...
        try:
            try:
                ...
                if token in [normParser.NONE]:
                    ...
                    if token in [normParser.BOOLEAN]:
                        self.enterOuterAlt(localctx, 2)
                        self.state = 432
                        self.bool_c()
                    else:
                        if token in [normParser.INTEGER]:
                            self.enterOuterAlt(localctx, 3)
                            self.state = 433
                            self.integer_c()
                        else:
                            if token in [normParser.FLOAT]:
                                self.enterOuterAlt(localctx, 4)
                                self.state = 434
                                self.float_c()
                            else:
                                if token in [normParser.STRING]:
                                    self.enterOuterAlt(localctx, 5)
                                    self.state = 435
                                    self.string_c()
                                else:
                                    if token in [normParser.PATTERN]:
                                        self.enterOuterAlt(localctx, 6)
                                        self.state = 436
                                        self.pattern()
                                    else:
                                        if token in [normParser.UUID]:
                                            self.enterOuterAlt(localctx, 7)
                                            self.state = 437
                                            self.uuid()
                                        else:
                                            if token in [normParser.URL]:
                                                self.enterOuterAlt(localctx, 8)
                                                self.state = 438
                                                self.url()
                                            else:
                                                if token in [normParser.DATETIME]:
                                                    self.enterOuterAlt(localctx, 9)
                                                    self.state = 439
                                                    self.datetime()
                                                else:
                ...
                while _alt != 2:
                    if _alt != ATN.INVALID_ALT_NUMBER:
                        if _alt == 1:
                            if self._parseListeners is not None:
                                ...
                                if la_ == 1:
                                    ...
                                    self.state = 590
                                    _la = self._input.LA(1)
                                    _la == normParser.EXP or _la == normParser.MOD or self._errHandler.recoverInline(self)
                                else:
                                    self._errHandler.reportMatch(self)
                                    self.consume()
                                self.state = 592
                            ...
                            if la_ == 2:
                                ...
                                if _la == normParser.WS or _la == normParser.NS:
                                    ...
                                    self.state = 599
                                    _la = self._input.LA(1)
                                    _la == normParser.TIMES or _la == normParser.DIVIDE or self._errHandler.recoverInline(self)
                                else:
                                    self._errHandler.reportMatch(self)
                                    self.consume()
                                self.state = 601
                        ...
                        if _la == normParser.WS or _la == normParser.NS:
                            ...
                            self.state = 608
                            _la = self._input.LA(1)
                            if not (_la == normParser.MINUS or _la == normParser.PLUS):
                                self._errHandler.recoverInline(self)
                            else:
                                self._errHandler.reportMatch(self)
                                self.consume()
    ...
    def logicalOperator(self):
        ...
        try:
            try:
                ...
                self.state = 674
                _la = self._input.LA(1)
                if not (_la & -64 == 0 and 1 << _la & (1 << normParser.NOT | 1 << normParser.AND | 1 << normParser.OR | 1 << normParser.XOR | 1 << normParser.IMP | 1 << normParser.EQV) != 0):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
    ...
    def conditionOperator(self):
        ...
        try:
            try:
                ...
                self.state = 688
                _la = self._input.LA(1)
                if not (_la & -64 == 0 and 1 << _la & (1 << normParser.IN | 1 << normParser.NI | 1 << normParser.EQ | 1 << normParser.NE | 1 << normParser.GE | 1 << normParser.LE | 1 << normParser.GT | 1 << normParser.LT | 1 << normParser.LK) != 0):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
