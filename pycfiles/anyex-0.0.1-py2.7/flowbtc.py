...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/flowbtc.py
...
class flowbtc(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(flowbtc, self).describe(), {'id': 'flowbtc', 
           'name': 'flowBTC', 
           'countries': 'BR', 
           'version': 'v1', 
           'rateLimit': 1000, 
           'has': {'CORS': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/28162465-cd815d4c-67cf-11e7-8e57-438bea0523a2.jpg', 
    ...
    def fetch_markets(self):
        ...
        for p in range(0, len(markets)):
            ...
            precision = {'amount': self.safe_integer(market, 'product1DecimalPlaces'), 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        orderbook = self.publicPostGetOrderBook(self.extend({'productPair': market['id']}, params))
        return self.parse_order_book(orderbook, None, 'bids', 'asks', 'px', 'qty')

    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        market = self.market(symbol)
        ticker = self.publicPostGetTicker(self.extend({'productPair': market['id']}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicPostGetTrades(self.extend({'ins': market['id'], 
           'startIndex': -1}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        order = {'ins': self.market_id(symbol), 
           'side': side, 
           'orderType': orderType, 
           'qty': amount, 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        if 'ins' in params:
            return self.privatePostCancelOrder(self.extend({'serverOrderId': id}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            body = self.json(self.extend({'apiKey': self.apiKey, 
               'apiNonce': nonce, 
               'apiSig': signature.upper()}, params))
