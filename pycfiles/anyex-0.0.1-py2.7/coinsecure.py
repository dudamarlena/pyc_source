...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/coinsecure.py
...
class coinsecure(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(coinsecure, self).describe(), {'id': 'coinsecure', 
           'name': 'Coinsecure', 
           'countries': 'IN', 
           'rateLimit': 1000, 
           'version': 'v1', 
           'has': {'CORS': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766472-9cbd200a-5ed9-11e7-9551-2267ad7bac08.jpg', 
           ...
           'markets': {'BTC/INR': {'id': 'BTC/INR', 'symbol': 'BTC/INR', 'base': 'BTC', 'quote': 'INR'}}, 'fees': {'trading': {'maker': 0.4 / 100, 
                                'taker': 0.4 / 100}}})
    ...
    def fetch_balance(self, params={}):
        ...
        coin = {'free': balance['availableCoinBalance'], 
           'used': balance['pendingCoinBalance'], 
           'total': balance['totalCoinBalance']}
        fiat = {'free': balance['availableFiatBalance'], 
        ...
        if code == 200:
            if body[0] == '{' or body[0] == '[':
                ...
                if 'success' in response:
                    ...
                    if 'message' not in list(response.keys()):
