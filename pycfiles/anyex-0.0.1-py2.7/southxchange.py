...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/southxchange.py
...
class southxchange(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(southxchange, self).describe(), {'id': 'southxchange', 
           'name': 'SouthXchange', 
           'countries': 'AR', 
           'rateLimit': 1000, 
           'has': {'CORS': True, 
                   ...
                   'fetchTickers': True, 
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27838912-4f94ec8a-60f6-11e7-9e5d-bbf9bd50a559.jpg', 
           ...
           'fees': {'trading': {'tierBased': False, 
                                ...
                                'maker': 0.2 / 100, 
                                'taker': 0.2 / 100}}, 
           'commonCurrencies': {'SMT': 'SmartNode'}})
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetPriceSymbol(self.extend({'symbol': market['id']}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        order = {'listingCurrency': market['base'], 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        return self.privatePostCancelOrder(self.extend({'orderCode': id}, params))

    def create_deposit_address(self, code, params={}):
        self.load_markets()
        currency = self.currency(code)
        response = self.privatePostGeneratenewaddress(self.extend({'currency': currency['id']}, params))
        ...
        if numParts > 1:
            tag = parts[1]
        return {'currency': code, 'address': address, 
           'tag': tag, 
           'status': 'ok', 
           'info': response}
