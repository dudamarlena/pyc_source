...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitz.py
# Compiled at: 2018-04-27 06:36:14
...
class bitz(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitz, self).describe(), {'id': 'bitz', 
           'name': 'Bit-Z', 
           'countries': 'HK', 
           'rateLimit': 1000, 
           'version': 'v1', 
           ...
           'timeframes': {'1m': '1m', 
                          ...
                          '1h': '1h', 
                          '1d': '1d'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/35862606-4f554f14-0b5d-11e8-957d-35058c504b6f.jpg', 
           ...
           'precision': {'amount': 8, 
                         'price': 8}, 
           'options': {'lastNonceTimestamp': 0}, 
           'commonCurrencies': {'PXC': 'Pixiecoin'}})
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetTicker(self.extend({'coin': market['id']}, params))
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        response = self.publicGetDepth(self.extend({'coin': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetOrders(self.extend({'coin': market['id']}, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetKline(self.extend({'coin': market['id'], 
    ...
    def parse_order(self, order, market=None):
        ...
        return {'id': order['id'], 'datetime': iso8601, 
           'timestamp': timestamp, 
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        request = {'coin': market['id'], 'type': orderType, 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostTradeCancel(self.extend({'id': id}, params))
        return response

    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostOpenOrders(self.extend({'coin': market['id']}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            body = self.urlencode(self.keysort(self.extend({'api_key': self.apiKey, 
    ...
    def request(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if code != '0':
            ErrorClass = self.safe_value({'103': AuthenticationError, 
               ...
               '106': DDoSProtection}, code, ExchangeError)
