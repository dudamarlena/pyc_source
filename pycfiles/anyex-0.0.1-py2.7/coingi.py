...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/coingi.py
# Compiled at: 2018-04-27 06:36:01
...
class coingi(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(coingi, self).describe(), {'id': 'coingi', 
           'name': 'Coingi', 
           'rateLimit': 1000, 
           'countries': [
                       'PA', 'BG', 'CN', 'US'], 
           'has': {'CORS': False, 
                   'fetchTickers': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/28619707-5c9232a8-7212-11e7-86d6-98fe5d15cc6e.jpg', 
                    'api': {'www': 'https://coingi.com', 
    ...
    def fetch_balance(self, params={}):
        ...
        balances = self.userPostBalance({'currencies': (',').join(lowercaseCurrencies)})
    ...
    def fetch_order_book(self, symbol, limit=512, params={}):
        ...
        orderbook = self.currentGetOrderBookPairAskCountBidCountDepth(self.extend({'pair': market['id'], 
           'depth': 32, 
           'askCount': limit, 
           'bidCount': limit}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.currentGetTransactionsPairMaxCount(self.extend({'pair': market['id'], 
           'maxCount': 128}, params))
    ...
    def sign(self, path, api='current', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'current':
            ...
            nonce = self.nonce()
            request = self.extend({'token': self.apiKey, 
               'nonce': nonce}, query)
