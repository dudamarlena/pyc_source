...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/negociecoins.py
# Compiled at: 2018-04-27 06:35:37
...
class negociecoins(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(negociecoins, self).describe(), {'id': 'negociecoins', 
           'name': 'NegocieCoins', 
           'countries': 'BR', 
           'rateLimit': 1000, 
           'version': 'v3', 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/38008571-25a6246e-3258-11e8-969b-aeb691049245.jpg', 
                    'api': {'public': 'https://broker.negociecoins.com.br/api/v3', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'get': [
                               ...
                               'delete': [
                                        'user/order/{orderId}']}}, 
           'markets': {'B2X/BRL': {'id': 'b2xbrl', 'symbol': 'B2X/BRL', 'base': 'B2X', 'quote': 'BRL'}, 'BCH/BRL': {'id': 'bchbrl', 'symbol': 'BCH/BRL', 'base': 'BCH', 'quote': 'BRL'}, 'BTC/BRL': {'id': 'btcbrl', 'symbol': 'BTC/BRL', 'base': 'BTC', 'quote': 'BRL'}, 'BTG/BRL': {'id': 'btgbrl', 'symbol': 'BTG/BRL', 'base': 'BTG', 'quote': 'BRL'}, 'DASH/BRL': {'id': 'dashbrl', 'symbol': 'DASH/BRL', 'base': 'DASH', 'quote': 'BRL'}, 'LTC/BRL': {'id': 'ltcbrl', 'symbol': 'LTC/BRL', 'base': 'LTC', 'quote': 'BRL'}}, 'fees': {'trading': {'maker': 0.003, 
                                'taker': 0.004}, 
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetPARTicker(self.extend({'PAR': market['id']}, params))
        return self.parse_ticker(ticker, market)

    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetPAROrderbook(self.extend({'PAR': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        if since is None:
            since = 0
        request = {'PAR': market['id'], 'timestamp_inicial': int(since / 1000)}
    ...
    def fetch_balance(self, params={}):
        ...
        for i in range(0, len(currencies)):
            ...
            account = {'free': float(balance['total']), 
               'used': 0.0, 
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostUserOrder(self.extend({'pair': market['id'], 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        response = self.privateDeleteUserOrderOrderId(self.extend({'orderId': id}, params))
        return self.parse_order(response[0], market)

    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        order = self.privateGetUserOrderOrderId(self.extend({'orderId': id}, params))
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        return self.fetch_orders(symbol, since, limit, self.extend({'status': 'pending'}, params))

    def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        return self.fetch_orders(symbol, since, limit, self.extend({'status': 'filled'}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            headers = {'Authorization': 'amx ' + auth}
            if method == 'POST':
