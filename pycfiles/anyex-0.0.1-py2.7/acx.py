...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/acx.py
...
class acx(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(acx, self).describe(), {'id': 'acx', 
           'name': 'ACX', 
           'countries': 'AU', 
           'rateLimit': 1000, 
           'version': 'v2', 
           ...
           'timeframes': {'1m': '1', 
                          ...
                          '3d': '4320', 
                          '1w': '10080'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30247614-1fe61c74-9621-11e7-9e8c-f1a627afa279.jpg', 
                    'extension': '.json', 
    ...
    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetTickersMarket(self.extend({'market': market['id']}, params))
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privateGetOrder(self.extend({'id': int(id)}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            query = self.encode_params(self.extend({'access_key': self.apiKey, 
               'tonce': nonce}, params))
