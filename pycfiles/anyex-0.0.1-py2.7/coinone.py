...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/coinone.py
# Compiled at: 2018-04-27 06:35:59
...
class coinone(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(coinone, self).describe(), {'id': 'coinone', 
           'name': 'CoinOne', 
           'countries': 'KR', 
           'rateLimit': 667, 
           'version': 'v2', 
           'has': {'CORS': False, 
                   ...
                   'fetchTickers': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/38003300-adc12fba-323f-11e8-8525-725f53c4a659.jpg', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'post': [
                                      ...
                                      'transaction/btc/',
                                      'transaction/coin/']}}, 
           'markets': {'BCH/KRW': {'id': 'bch', 'symbol': 'BCH/KRW', 'base': 'BCH', 'quote': 'KRW', 'baseId': 'bch', 'quoteId': 'krw'}, 'BTC/KRW': {'id': 'btc', 'symbol': 'BTC/KRW', 'base': 'BTC', 'quote': 'KRW', 'baseId': 'btc', 'quoteId': 'krw'}, 'BTG/KRW': {'id': 'btg', 'symbol': 'BTG/KRW', 'base': 'BTG', 'quote': 'KRW', 'baseId': 'btg', 'quoteId': 'krw'}, 'ETC/KRW': {'id': 'etc', 'symbol': 'ETC/KRW', 'base': 'ETC', 'quote': 'KRW', 'baseId': 'etc', 'quoteId': 'krw'}, 'ETH/KRW': {'id': 'eth', 'symbol': 'ETH/KRW', 'base': 'ETH', 'quote': 'KRW', 'baseId': 'eth', 'quoteId': 'krw'}, 'IOTA/KRW': {'id': 'iota', 'symbol': 'IOTA/KRW', 'base': 'IOTA', 'quote': 'KRW', 'baseId': 'iota', 'quoteId': 'krw'}, 'LTC/KRW': {'id': 'ltc', 'symbol': 'LTC/KRW', 'base': 'LTC', 'quote': 'KRW', 'baseId': 'ltc', 'quoteId': 'krw'}, 'QTUM/KRW': {'id': 'qtum', 'symbol': 'QTUM/KRW', 'base': 'QTUM', 'quote': 'KRW', 'baseId': 'qtum', 'quoteId': 'krw'}, 'XRP/KRW': {'id': 'xrp', 'symbol': 'XRP/KRW', 'base': 'XRP', 'quote': 'KRW', 'baseId': 'xrp', 'quoteId': 'krw'}}, 'fees': {'trading': {'tierBased': True, 
                                'percentage': True, 
                                'taker': 0.001, 
                                'maker': 0.001, 
                                'tiers': {'taker': [
                                          ...
                                          'maker': [
                                                  ...
                                                  [
                                                   50000000000, 0]]}}}, 
           'exceptions': {'405': ExchangeNotAvailable}})
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = self.publicGetOrderbook(self.extend({'currency': market['id'], 
           'format': 'json'}, params))
        return self.parse_order_book(response, None, 'bid', 'ask', 'price', 'qty')

    def fetch_tickers(self, symbols=None, params={}):
        self.load_markets()
        response = self.publicGetTicker(self.extend({'currency': 'all', 
           'format': 'json'}, params))
        result = {}
        tickers = response
    ...
    def fetch_ticker(self, symbol, params={}):
        market = self.market(symbol)
        response = self.publicGetTicker(self.extend({'currency': market['id'], 
           'format': 'json'}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        market = self.market(symbol)
        response = self.publicGetTrades(self.extend({'currency': market['id'], 
           'period': 'hour', 
           'format': 'json'}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            json = self.json({'access_token': self.apiKey, 
               'nonce': nonce})
