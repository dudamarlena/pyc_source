...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/itbit.py
...
class itbit(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(itbit, self).describe(), {'id': 'itbit', 
           'name': 'itBit', 
           'countries': 'US', 
           'rateLimit': 2000, 
           'version': 'v1', 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27822159-66153620-60ad-11e7-89e7-005f6d7f3de0.jpg', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'get': [
                               ...
                               'delete': [
                                        'wallets/{walletId}/orders/{id}']}}, 
           'markets': {'BTC/USD': {'id': 'XBTUSD', 'symbol': 'BTC/USD', 'base': 'BTC', 'quote': 'USD'}, 'BTC/SGD': {'id': 'XBTSGD', 'symbol': 'BTC/SGD', 'base': 'BTC', 'quote': 'SGD'}, 'BTC/EUR': {'id': 'XBTEUR', 'symbol': 'BTC/EUR', 'base': 'BTC', 'quote': 'EUR'}}, 'fees': {'trading': {'maker': 0, 
                                'taker': 0.2 / 100}}})

    def fetch_order_book(self, symbol, limit=None, params={}):
        orderbook = self.publicGetMarketsSymbolOrderBook(self.extend({'symbol': self.market_id(symbol)}, params))
        return self.parse_order_book(orderbook)

    def fetch_ticker(self, symbol, params={}):
        ticker = self.publicGetMarketsSymbolTicker(self.extend({'symbol': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetMarketsSymbolTrades(self.extend({'symbol': market['id']}, params))
    ...
    def fetch_balance(self, params={}):
        ...
        for b in range(0, len(balances)):
            ...
            account = {'free': float(balance['availableBalance']), 
               'used': 0.0, 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        return self.privateDeleteWalletsWalletIdOrdersId(self.extend({'id': id}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            headers = {'Authorization': self.apiKey + ':' + signature, 
