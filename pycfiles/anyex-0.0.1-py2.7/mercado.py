...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/mercado.py
# Compiled at: 2018-04-27 06:35:38
...
class mercado(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(mercado, self).describe(), {'id': 'mercado', 
           ...
           'has': {'CORS': True, 
                   ...
                   'fetchOrder': True, 
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27837060-e7c58714-60ea-11e7-9192-f05e86adb83f.jpg', 
                    'api': {'public': 'https://www.mercadobitcoin.net/api', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'post': [
                                      ...
                                      'place_sell_order',
                                      'withdraw_coin']}}, 
           'markets': {'BTC/BRL': {'id': 'BRLBTC', 'symbol': 'BTC/BRL', 'base': 'BTC', 'quote': 'BRL', 'suffix': 'Bitcoin'}, 'LTC/BRL': {'id': 'BRLLTC', 'symbol': 'LTC/BRL', 'base': 'LTC', 'quote': 'BRL', 'suffix': 'Litecoin'}, 'BCH/BRL': {'id': 'BRLBCH', 'symbol': 'BCH/BRL', 'base': 'BCH', 'quote': 'BRL', 'suffix': 'BCash'}}, 'fees': {'trading': {'maker': 0.3 / 100, 
                                'taker': 0.7 / 100}}})

    def fetch_order_book(self, symbol, limit=None, params={}):
        market = self.market(symbol)
        orderbook = self.publicGetCoinOrderbook(self.extend({'coin': market['base']}, params))
        return self.parse_order_book(orderbook)

    def fetch_ticker(self, symbol, params={}):
        market = self.market(symbol)
        response = self.publicGetCoinTicker(self.extend({'coin': market['base']}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        order = {'coin_pair': self.market_id(symbol), 
           'quantity': amount, 
           'limit_price': price}
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        self.load_markets()
        market = self.market(symbol)
        return self.privatePostCancelOrder(self.extend({'coin_pair': market['id'], 
           'order_id': id}, params))
    ...
    def parse_order(self, order, market=None):
        ...
        fee = {'cost': float(order['fee']), 'currency': market['quote']}
    ...
    def fetch_order(self, id, symbol=None, params={}):
        ...
        market = self.market(symbol)
        response = None
        response = self.privatePostGetOrder(self.extend({'coin_pair': market['id'], 
           'order_id': int(id)}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            url += self.version + '/'
            nonce = self.nonce()
            body = self.urlencode(self.extend({'tapi_method': path, 
               'tapi_nonce': nonce}, params))
