...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/tidebit.py
# Compiled at: 2018-04-27 06:35:20
...
class tidebit(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(tidebit, self).describe(), {'id': 'tidebit', 
           'name': 'TideBit', 
           'countries': 'HK', 
           'rateLimit': 1000, 
           'version': 'v2', 
           ...
           'timeframes': {'1m': '1', 
                          ...
                          '3d': '4320', 
                          '1w': '10080'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/39034921-e3acf016-4480-11e8-9945-a6086a1082fe.jpg', 
           ...
           'fees': {'trading': {'tierBased': False, 
                    ...
                    'funding': {'tierBased': False, 
                                'percentage': True, 
                                'withdraw': {}}}, 
           'exceptions': {'2002': InsufficientFunds, 
                          '2003': OrderNotFound}})

    def fetch_deposit_address(self, code, params={}):
        self.load_markets()
        currency = self.currency(code)
        response = self.privateGetV2DepositAddress(self.extend({'currency': currency['id']}, params))
    ...
    def fetch_balance(self, params={}):
        ...
        for b in range(0, len(balances)):
            ...
            account = {'free': float(balance['balance']), 'used': float(balance['locked']), 
               'total': 0.0}
    ...
    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetV2TickersMarket(self.extend({'market': market['id']}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetV2Trades(self.extend({'market': market['id']}, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        if not limit:
            limit = 30
        request = {'market': market['id'], 'period': self.timeframes[timeframe], 
           'limit': limit}
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        self.load_markets()
        order = {'market': self.market_id(symbol), 
           'side': side, 
           'volume': str(amount), 
           'ord_type': type}
        if type == 'limit':
    ...
    def withdraw(self, currency, amount, address, tag=None, params={}):
        ...
        self.load_markets()
        result = self.privatePostWithdraw(self.extend({'currency': currency.lower(), 
           'sum': amount, 
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            query = self.urlencode(self.extend({'access_key': self.apiKey, 
               'tonce': nonce}, params))
