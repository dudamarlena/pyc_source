...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bl3p.py
# Compiled at: 2018-04-27 06:36:13
...
class bl3p(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bl3p, self).describe(), {'id': 'bl3p', 
           'name': 'BL3P', 
           'countries': [
                       'NL', 'EU'], 
           'rateLimit': 1000, 
           ...
           'has': {'CORS': False}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/28501752-60c21b82-6feb-11e7-818b-055ee6d0e754.jpg', 
           ...
           'markets': {'BTC/EUR': {'id': 'BTCEUR', 'symbol': 'BTC/EUR', 'base': 'BTC', 'quote': 'EUR', 'maker': 0.0025, 'taker': 0.0025}, 'LTC/EUR': {'id': 'LTCEUR', 'symbol': 'LTC/EUR', 'base': 'LTC', 'quote': 'EUR', 'maker': 0.0025, 'taker': 0.0025}}})
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = self.publicGetMarketOrderbook(self.extend({'market': market['id']}, params))
        orderbook = response['data']
        return self.parse_order_book(orderbook, None, 'bids', 'asks', 'price_int', 'amount_int')

    def fetch_ticker(self, symbol, params={}):
        ticker = self.publicGetMarketTicker(self.extend({'market': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        market = self.market(symbol)
        response = self.publicGetMarketTrades(self.extend({'market': market['id']}, params))
