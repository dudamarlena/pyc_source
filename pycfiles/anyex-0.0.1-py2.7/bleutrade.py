...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bleutrade.py
...
class bleutrade(bittrex):
    ...
    def describe(self):
        return self.deep_extend(super(bleutrade, self).describe(), {'id': 'bleutrade', 
           'name': 'Bleutrade', 
           'countries': 'BR', 
           'rateLimit': 1000, 
           'version': 'v2', 
           'has': {'CORS': True, 
                   'fetchTickers': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30303000-b602dbe6-976d-11e7-956d-36c5049c01e7.jpg', 
                    'api': {'public': 'https://bleutrade.com/api', 
                            'account': 'https://bleutrade.com/api', 
                            'market': 'https://bleutrade.com/api'}, 
                    'www': 'https://bleutrade.com', 
                    'doc': 'https://bleutrade.com/help/API', 
                    'fees': 'https://bleutrade.com/help/fees_and_deadlines'}, 
           'fees': {'funding': {'withdraw': {'ADC': 0.1, 
                                             'BTA': 0.1, 
                                             'BITB': 0.1, 
                                             'BTC': 0.001, 
                                             'BCC': 0.001, 
                                             ...
                                             'WDC': 0.001, 
                                             'ZET': 0.1}}}, 
           'exceptions': {'Insufficient fundsnot ': InsufficientFunds, 
