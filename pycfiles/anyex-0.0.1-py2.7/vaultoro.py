...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/vaultoro.py
...
class vaultoro(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(vaultoro, self).describe(), {'id': 'vaultoro', 
           'name': 'Vaultoro', 
           'countries': 'CH', 
           'rateLimit': 1000, 
           'version': '1', 
           'has': {'CORS': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766880-f205e870-5ee9-11e7-8fe2-0d5b15880752.jpg', 
                    'api': 'https://api.vaultoro.com', 
                    'www': 'https://www.vaultoro.com', 
                    'doc': 'https://api.vaultoro.com'}, 
           'commonCurrencies': {'GLD': 'Gold'}, 
           'api': {'public': {'get': [
                                    'bidandask',
                                    'buyorders',
                                    'latest',
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        orderbook = {'bids': response['data'][0]['b'], 
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = getattr(self, method)(self.extend({'symbol': market['quoteId'].lower(), 
           'type': type, 
           'gld': amount, 
           'price': price or 1}, params))
        return {'info': response, 
           'id': response['data']['Order_ID']}

    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        return self.privatePostCancelId(self.extend({'id': id}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            query = self.extend({'nonce': nonce, 
               'apikey': self.apiKey}, self.omit(params, self.extract_params(path)))
