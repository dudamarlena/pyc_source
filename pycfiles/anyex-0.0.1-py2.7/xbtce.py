...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/xbtce.py
# Compiled at: 2018-04-27 06:35:16
...
class xbtce(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(xbtce, self).describe(), {'id': 'xbtce', 
           'name': 'xBTCe', 
           'countries': 'RU', 
           'rateLimit': 2000, 
           'version': 'v1', 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/28059414-e235970c-662c-11e7-8c3a-08e31f78684b.jpg', 
    ...
    def fetch_balance(self, params={}):
        ...
        for b in range(0, len(balances)):
            ...
            if uppercase == 'DSH':
                uppercase = 'DASH'
            account = {'free': balance['FreeAmount'], 'used': balance['LockedAmount'], 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        orderbook = self.privateGetLevel2Filter(self.extend({'filter': market['id']}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        market = self.market(symbol)
        tickers = self.publicGetTickerFilter(self.extend({'filter': market['id']}, params))
        length = len(tickers)
        if length < 1:
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = self.privatePostTrade(self.extend({'pair': self.market_id(symbol), 
           'type': side, 
           'amount': amount, 
           'rate': price}, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        return self.privateDeleteTrade(self.extend({'Type': 'Cancel', 
           'Id': id}, params))
