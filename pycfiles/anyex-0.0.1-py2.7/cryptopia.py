...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/cryptopia.py
# Compiled at: 2018-04-27 06:35:57
...
class cryptopia(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(cryptopia, self).describe(), {'id': 'cryptopia', 
           'name': 'Cryptopia', 
           'rateLimit': 1500, 
           'countries': 'NZ', 
           'has': {'CORS': False, 
                   ...
                   'deposit': True, 
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/29484394-7b4ea6e2-84c6-11e7-83e5-1fccf4b2dc81.jpg', 
    ...
    def fetch_markets(self):
        ...
        for i in range(0, len(markets)):
            ...
            priceLimits = {'min': market['MinimumPrice'], 
               'max': market['MaximumPrice']}
            amountLimits = {'min': lot, 
               'max': market['MaximumTrade']}
            limits = {'amount': amountLimits, 
               'price': priceLimits, 
               'cost': {'min': priceLimits['min'] * amountLimits['min'], 
                        'max': None}}
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        response = self.publicGetGetMarketOrdersId(self.extend({'id': self.market_id(symbol)}, params))
    ...
    def fetch_order_books(self, symbols=None, params={}):
        ...
        response = self.publicGetGetMarketOrderGroupsIds(self.extend({'ids': ids}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetGetMarketId(self.extend({'id': market['id']}, params))
    ...
    def parse_trade(self, trade, market=None):
        ...
        if market:
            symbol = market['symbol']
            if 'Fee' in trade:
                fee = {'currency': market['quote'], 'cost': trade['Fee']}
        return {'id': id, 'info': trade, 
           'order': None, 
           'timestamp': timestamp, 
           'datetime': self.iso8601(timestamp), 
           'symbol': symbol, 
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        request = {'id': market['id'], 'hours': hours}
            ...
            result[code] = {'id': id, 'code': code, 
               ...
               'limits': {'amount': {'min': math.pow(10, -precision), 
                          ...
                          'price': {'min': math.pow(10, -precision), 
                                    'max': math.pow(10, precision)}, 
                          'cost': {'min': currency['MinBaseTrade'], 
                                   'max': None}, 
                          'withdraw': {'min': currency['MinWithdraw'], 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        response = None
        try:
            response = self.privatePostCancelTrade(self.extend({'Type': 'Trade', 
               'OrderId': id}, params))
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostGetOpenOrders({'TradePairId': market['id']}, params)
        orders = []
        ...
        for k in range(0, len(cachedOrderIds)):
            ...
            if id in openOrdersIndexedById:
                ...
                if order['status'] == 'open':
                    self.orders[id] = self.extend(order, {'status': 'closed', 
    ...
    def fetch_deposit_address(self, code, params={}):
        ...
        response = self.privatePostGetDepositAddress(self.extend({'Currency': currency['id']}, params))
