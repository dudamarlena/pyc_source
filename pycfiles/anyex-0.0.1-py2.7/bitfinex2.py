...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitfinex2.py
...
class bitfinex2(bitfinex):
    ...
    def describe(self):
        return self.deep_extend(super(bitfinex2, self).describe(), {'id': 'bitfinex2', 
           'name': 'Bitfinex v2', 
           'countries': 'VG', 
           'version': 'v2', 
           'has': {'CORS': True, 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetBookSymbolPrecision(self.extend({'symbol': self.market_id(symbol), 
           'precision': 'R0'}, params))
        timestamp = self.milliseconds()
        result = {'bids': [], 'asks': [], 'timestamp': timestamp, 
    ...
    def fetch_tickers(self, symbols=None, params={}):
        self.load_markets()
        tickers = self.publicGetTickers(self.extend({'symbols': (',').join(self.ids)}, params))
        result = {}
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=100, params={}):
        ...
        request = {'symbol': market['id'], 'timeframe': self.timeframes[timeframe], 
           'sort': 1, 
           'limit': limit, 
           'start': since}
