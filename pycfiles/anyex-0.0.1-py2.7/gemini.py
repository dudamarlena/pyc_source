...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/gemini.py
# Compiled at: 2018-04-27 06:35:50
...
class gemini(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(gemini, self).describe(), {'id': 'gemini', 
           'name': 'Gemini', 
           'countries': 'US', 
           'rateLimit': 1500, 
           'version': 'v1', 
           'has': {'fetchDepositAddress': False, 
                   ...
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27816857-ce7be644-6096-11e7-82d6-3c257263229c.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetBookSymbol(self.extend({'symbol': self.market_id(symbol)}, params))
    ...
    def parse_trade(self, trade, market):
        ...
        if fee is not None:
            ...
            fee = {'cost': float(trade['fee_amount']), 'currency': currency}
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        nonce = self.nonce()
        order = {'client_order_id': str(nonce), 
    ...
    def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = self.privatePostWithdrawCurrency(self.extend({'currency': currency['id'], 
           'amount': amount, 
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            nonce = self.nonce()
            request = self.extend({'request': url, 
               'nonce': nonce}, query)
    ...
    def create_deposit_address(self, code, params={}):
        self.load_markets()
        currency = self.currency(code)
        response = self.privatePostDepositCurrencyNewAddress(self.extend({'currency': currency['id']}, params))
