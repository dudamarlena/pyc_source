...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/mixcoins.py
...
class mixcoins(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(mixcoins, self).describe(), {'id': 'mixcoins', 
           'name': 'MixCoins', 
           'countries': [
                       'GB', 'HK'], 
           'rateLimit': 1500, 
           'version': 'v1', 
           'has': {'CORS': False}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30237212-ed29303c-9535-11e7-8af8-fcd381cfa20c.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        response = self.publicGetDepth(self.extend({'market': self.market_id(symbol)}, params))
        return self.parse_order_book(response['result'])

    def fetch_ticker(self, symbol, params={}):
        response = self.publicGetTicker(self.extend({'market': self.market_id(symbol)}, params))
