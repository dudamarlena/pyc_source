...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/lbank.py
# Compiled at: 2018-04-27 06:35:41
...
class lbank(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(lbank, self).describe(), {'id': 'lbank', 
           'name': 'LBank', 
           'countries': 'CN', 
           'version': 'v1', 
           ...
           'timeframes': {'1m': 'minute1', 
                          ...
                          '1d': 'day1', 
                          '1w': 'week1'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/38063602-9605e28a-3302-11e8-81be-64b1e53c4cfb.jpg', 
    ...
    def fetch_tickers(self, symbols=None, params={}):
        self.load_markets()
        tickers = self.publicGetTicker(self.extend({'symbol': 'all'}, params))
        result = {}
    ...
    def fetch_order_book(self, symbol, limit=60, params={}):
        self.load_markets()
        response = self.publicGetDepth(self.extend({'symbol': self.market_id(symbol), 
           'size': min(limit, 60)}, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostCancelOrder(self.extend({'symbol': market['id'], 
           'order_id': id}, params))
        return response
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostOrdersInfo(self.extend({'symbol': market['id'], 
           'order_id': id}, params))
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostOrdersInfoHistory(self.extend({'symbol': market['id'], 
           'current_page': 1, 
           'page_length': 100}, params))
        return self.parse_orders(response['orders'], None, since, limit)

    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        response = self.fetch_orders(self.extend({'status': 0}, params))
        return response

    def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        response = self.fetch_orders(self.extend({'status': 1}, params))
        return response
    ...
    def request(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if success == 'false':
            ...
            message = self.safe_string({'10000': 'Internal error', 
               ...
               '10020': 'less than the minimum amount of the transaction limit of 0.001'}, errorCode, self.json(response))
            ErrorClass = self.safe_value({'10002': AuthenticationError, 
               ...
               '10014': InvalidOrder, 
               '10015': InvalidOrder, 
               '10016': InvalidOrder}, errorCode, ExchangeError)
