...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitfinex.py
# Compiled at: 2018-04-27 06:36:20
...
class bitfinex(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitfinex, self).describe(), {'id': 'bitfinex', 
           'name': 'Bitfinex', 
           'countries': 'VG', 
           'version': 'v1', 
           'rateLimit': 1500, 
           ...
           'timeframes': {'1m': '1m', 
                          ...
                          '2w': '14D', 
                          '1M': '1M'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766244-e328a50c-5ed2-11e7-947b-041416579bb3.jpg', 
           ...
           'commonCurrencies': {'BCC': 'CST_BCC', 
                                ...
                                'SPK': 'SPANK', 
                                'YYW': 'YOYOW'}, 
           'exceptions': {'exact': {'temporarily_unavailable': ExchangeNotAvailable, 
                                    'Order could not be cancelled.': OrderNotFound, 
                                    'No such order found.': OrderNotFound, 
                                    'Order price must be positive.': InvalidOrder, 
                                    'Could not find a key matching the given X-BFX-APIKEY.': AuthenticationError, 
                                    'This API key does not have permission for self action': AuthenticationError, 
                          ...
                          'broad': {'Invalid order: not enough exchange balance for ': InsufficientFunds, 
    ...
    def fetch_funding_fees(self, params={}):
        ...
        return {'info': response, 'withdraw': withdraw, 
           'deposit': withdraw}
    ...
    def fetch_markets(self):
        ...
        for p in range(0, len(markets)):
            ...
            symbol = base + '/' + quote
            precision = {'price': market['price_precision'], 
               'amount': market['price_precision']}
            limits = {'amount': {'min': float(market['minimum_order_size']), 
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetPubtickerSymbol(self.extend({'symbol': market['id']}, params))
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostOrderStatus(self.extend({'order_id': int(id)}, params))
    ...
    def create_deposit_address(self, currency, params={}):
        response = self.fetch_deposit_address(currency, self.extend({'renew': 1}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'private':
            ...
            nonce = self.nonce()
            query = self.extend({'nonce': str(nonce), 
