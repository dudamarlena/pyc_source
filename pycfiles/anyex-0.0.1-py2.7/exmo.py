...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/exmo.py
...
class exmo(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(exmo, self).describe(), {'id': 'exmo', 
           'name': 'EXMO', 
           'countries': [
                       'ES', 'RU'], 
           'rateLimit': 350, 
           ...
           'has': {'CORS': False, 
                   ...
                   'fetchTickers': True, 
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766491-1b0ea956-5eda-11e7-9225-40d67b481b8d.jpg', 
           ...
           'fees': {'trading': {'maker': 0.2 / 100, 
                    ...
                    'funding': {'withdraw': {'BTC': 0.001, 
                                ...
                                'deposit': {'USDT': 15, 
                                            'KICK': 50}}}, 
           'exceptions': {'40005': AuthenticationError, 
                          '40009': InvalidNonce, 
                          '40015': ExchangeError, 
                          '40016': ExchangeNotAvailable, 
    ...
    def fetch_markets(self):
        ...
        for p in range(0, len(keys)):
            ...
            result.append({'id': id, 
               ...
               'quote': quote, 
               'active': True, 
               'limits': {'amount': {'min': self.safe_float(market, 'min_quantity'), 
                                     'max': self.safe_float(market, 'max_quantity')}, 
                          'price': {'min': self.safe_float(market, 'min_price'), 
                                    'max': self.safe_float(market, 'max_price')}, 
                          'cost': {'min': self.safe_float(market, 'min_amount'), 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        request = self.extend({'pair': market['id']}, params)
    ...
    def fetch_order_books(self, symbols=None, params={}):
        ...
        if not symbols:
            ...
            ids = (',').join(ids)
        response = self.publicGetOrderBook(self.extend({'pair': ids}, params))
        result = {}
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if type == 'market' and price is None:
            price = 0
        request = {'pair': market['id'], 'quantity': self.amount_to_string(symbol, amount), 
           'type': prefix + side, 
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        try:
            response = self.privatePostOrderTrades({'order_id': str(id)})
