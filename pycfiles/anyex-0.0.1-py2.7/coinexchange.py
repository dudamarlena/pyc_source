...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/coinexchange.py
...
class coinexchange(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(coinexchange, self).describe(), {'id': 'coinexchange', 
           'name': 'CoinExchange', 
           'countries': [
                       'IN', 'JP', 'KR', 'VN', 'US'], 
           'rateLimit': 1000, 
           'has': {'privateAPI': False, 
                   'createOrder': False, 
                   ...
                   'fetchTickers': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/34842303-29c99fca-f71c-11e7-83c1-09d900cb2334.jpg', 
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetGetmarketsummary(self.extend({'market_id': market['id']}, params))
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetGetorderbook(self.extend({'market_id': self.market_id(symbol)}, params))
