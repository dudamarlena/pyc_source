...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/luno.py
...
class luno(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(luno, self).describe(), {'id': 'luno', 
           'name': 'luno', 
           'countries': [
                       'GB', 'SG', 'ZA'], 
           'rateLimit': 10000, 
           ...
           'has': {'CORS': False, 
                   'fetchTickers': True, 
                   'fetchOrder': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766607-8c1a69d8-5ede-11e7-930c-540b5eb9be24.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetOrderbook(self.extend({'pair': self.market_id(symbol)}, params))
    ...
    def parse_order(self, order, market=None):
        ...
        if quoteFee:
            ...
            fee['side'] = 'base'
            fee['cost'] = baseFee
        return {'id': order['order_id'], 'datetime': self.iso8601(timestamp), 
           'timestamp': timestamp, 
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetTicker(self.extend({'pair': market['id']}, params))
