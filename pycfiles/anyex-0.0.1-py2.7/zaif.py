...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/zaif.py
...
class zaif(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(zaif, self).describe(), {'id': 'zaif', 
           'name': 'Zaif', 
           'countries': 'JP', 
           'rateLimit': 2000, 
           'version': '1', 
           'has': {'CORS': False, 
                   ...
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766927-39ca2ada-5eeb-11e7-972f-1b4199518ca6.jpg', 
    ...
    def fetch_markets(self):
        ...
        for p in range(0, len(markets)):
            ...
            precision = {'amount': -math.log10(market['item_unit_step']), 
            ...
            result.append({'id': id, 
               ...
               'active': True, 
               'precision': precision, 
               'limits': {'amount': {'min': float(market['item_unit_min']), 
                                     'max': None}, 
                          'price': {'min': float(market['aux_unit_min']), 
                                    'max': None}, 
                          'cost': {'min': None, 
                                   'max': None}}, 
               'info': market})
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetDepthPair(self.extend({'pair': self.market_id(symbol)}, params))
        return self.parse_order_book(orderbook)

    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        ticker = self.publicGetTickerPair(self.extend({'pair': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetTradesPair(self.extend({'pair': market['id']}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = self.privatePostTrade(self.extend({'currency_pair': self.market_id(symbol), 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        return self.privatePostCancelOrder(self.extend({'order_id': id}, params))
    ...
    def withdraw(self, currency, amount, address, tag=None, params={}):
        ...
        result = self.privatePostWithdraw(self.extend({'currency': currency, 
           'amount': amount, 
