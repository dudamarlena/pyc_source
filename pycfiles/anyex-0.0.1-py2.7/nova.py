...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/nova.py
...
class nova(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(nova, self).describe(), {'id': 'nova', 
           'name': 'Novaexchange', 
           'countries': 'TZ', 
           'rateLimit': 2000, 
           'version': 'v2', 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30518571-78ca0bca-9b8a-11e7-8840-64b83a4a94b2.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetMarketOpenordersPairBoth(self.extend({'pair': self.market_id(symbol)}, params))
        return self.parse_order_book(orderbook, None, 'buyorders', 'sellorders', 'price', 'amount')

    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        response = self.publicGetMarketInfoPair(self.extend({'pair': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetMarketOrderhistoryPair(self.extend({'pair': market['id']}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            body = self.urlencode(self.extend({'apikey': self.apiKey, 
