...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/hitbtc.py
...
class hitbtc(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(hitbtc, self).describe(), {'id': 'hitbtc', 
           'name': 'HitBTC', 
           'countries': 'UK', 
           'rateLimit': 1500, 
           'version': '1', 
    ...
    def fetch_markets(self):
        ...
        for p in range(0, len(markets['symbols'])):
            ...
            result.append({'id': id, 
               ...
               'precision': {'amount': self.precision_from_string(market['lot']), 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetSymbolOrderbook(self.extend({'symbol': self.market_id(symbol)}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetSymbolTicker(self.extend({'symbol': market['id']}, params))
    ...
    def parse_public_trade(self, trade, market=None):
        ...
        if market:
            symbol = market['symbol']
        return {'info': trade, 'id': str(trade[0]), 
           'timestamp': trade[3], 
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetSymbolTrades(self.extend({'symbol': market['id'], 
           'side': 'true'}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        order = {'clientOrderId': str(clientOrderId), 
           'symbol': market['id'], 
           'side': side, 
           'quantity': str(wholeLots), 
           'type': type}
        if type == 'limit':
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        return self.tradingPostCancelOrder(self.extend({'clientOrderId': id}, params))
    ...
    def parse_order(self, order, market=None):
        ...
        return {'id': str(order['clientOrderId']), 
           'info': order, 
           'timestamp': timestamp, 
           'datetime': self.iso8601(timestamp), 
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.tradingGetOrder(self.extend({'clientOrderId': id}, params))
    ...
    def fetch_order_trades(self, id, symbol=None, since=None, limit=None, params={}):
        ...
        if symbol is not None:
            market = self.market(symbol)
        response = self.tradingGetTradesByOrder(self.extend({'clientOrderId': id}, params))
        return self.parse_trades(response['trades'], market, since, limit)
