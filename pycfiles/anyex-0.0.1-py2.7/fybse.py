...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/fybse.py
...
class fybse(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(fybse, self).describe(), {'id': 'fybse', 
           'name': 'FYB-SE', 
           'countries': 'SE', 
           'has': {'CORS': False}, 
           'rateLimit': 1500, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766512-31019772-5edb-11e7-8241-2e675e6797f1.jpg', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'post': [
                                      ...
                                      'placeorder',
                                      'withdraw']}}, 
           'markets': {'BTC/SEK': {'id': 'SEK', 'symbol': 'BTC/SEK', 'base': 'BTC', 'quote': 'SEK'}}})
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        response = self.privatePostPlaceorder(self.extend({'qty': amount, 
           'price': price, 
           'type': side[0].upper()}, params))
