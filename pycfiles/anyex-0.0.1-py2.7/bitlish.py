...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitlish.py
...
class bitlish(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitlish, self).describe(), {'id': 'bitlish', 
           'name': 'Bitlish', 
           'countries': [
                       'GB', 'EU', 'RU'], 
           'rateLimit': 1500, 
           ...
           'has': {'CORS': False, 
                   ...
                   'withdraw': True}, 
           'timeframes': {'1h': 3600}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766275-dcfc6c30-5ed3-11e7-839d-00a846385d0b.jpg', 
    ...
    def fetch_ohlcv(self, symbol, timeframe='1h', since=None, limit=None, params={}):
        ...
        interval = [
         str(start), None]
        return self.publicPostOhlcv(self.extend({'time_range': interval}, params))

    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetTradesDepth(self.extend({'pair_id': self.market_id(symbol)}, params))
        timestamp = None
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetTradesHistory(self.extend({'pair_id': market['id']}, params))
    ...
    def sign_in(self):
        return self.privatePostSignin({'login': self.login, 
           'passwd': self.password})

    def create_order(self, symbol, type, side, amount, price=None, params={}):
        self.load_markets()
        order = {'pair_id': self.market_id(symbol), 
