...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/_1btcxe.py
# Compiled at: 2018-04-27 06:36:28
...
class _1btcxe(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(_1btcxe, self).describe(), {'id': '_1btcxe', 
           'name': '1BTCXE', 
           'countries': 'PA', 
           ...
           'has': {'CORS': True, 
                   'withdraw': True}, 
           'timeframes': {'1d': '1year'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766049-2b294408-5ecc-11e7-85cc-adaff013dc1a.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        response = self.publicGetOrderBook(self.extend({'currency': self.market_id(symbol)}, params))
        return self.parse_order_book(response['order-book'], None, 'bid', 'ask', 'price', 'order_amount')

    def fetch_ticker(self, symbol, params={}):
        response = self.publicGetStats(self.extend({'currency': self.market_id(symbol)}, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1d', since=None, limit=None, params={}):
        ...
        response = self.publicGetHistoricalPrices(self.extend({'currency': market['id'], 
           'timeframe': self.timeframes[timeframe]}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        market = self.market(symbol)
        response = self.publicGetTransactions(self.extend({'currency': market['id']}, params))
    ...
    def withdraw(self, currency, amount, address, tag=None, params={}):
        ...
        self.load_markets()
        response = self.privatePostWithdrawalsNew(self.extend({'currency': currency, 
           'amount': float(amount), 
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            query = self.extend({'api_key': self.apiKey, 
