...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/qryptos.py
# Compiled at: 2018-04-27 06:35:31
...
class qryptos(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(qryptos, self).describe(), {'id': 'qryptos', 
           'name': 'QRYPTOS', 
           'countries': [
                       'CN', 'TW'], 
           'version': '2', 
           ...
           'has': {'CORS': False, 
                   ...
                   'fetchMyTrades': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30953915-b1611dc0-a436-11e7-8947-c95bd5a42086.jpg', 
           ...
           'skipJsonOnStatusCodes': [
                                   401], 
           'exceptions': {'messages': {'API Authentication failed': AuthenticationError, 
                                       'Nonce is too small': InvalidNonce, 
                                       'Order not found': OrderNotFound, 
                                       'user': {'not_enough_free_balance': InsufficientFunds}, 
                                       'price': {'must_be_positive': InvalidOrder}, 
                                       'quantity': {'less_than_order_size': InvalidOrder}}}})
    ...
    def fetch_markets(self):
        ...
        for p in range(0, len(markets)):
            ...
            if quote == 'BTC':
                ...
                minPrice = 1e-05
            limits = {'amount': {'min': minAmount}, 'price': {'min': minPrice}, 'cost': {'min': None}}
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetProductsIdPriceLevels(self.extend({'id': self.market_id(symbol)}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetProductsId(self.extend({'id': market['id']}, params))
    ...
    def parse_trade(self, trade, market):
        ...
        return {'info': trade, 'id': str(trade['id']), 
           'order': None, 
           'timestamp': timestamp, 
           'datetime': self.iso8601(timestamp), 
           'symbol': market['symbol'], 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        result = self.privatePutOrdersIdCancel(self.extend({'id': id}, params))
    ...
    def parse_order(self, order, market=None):
        ...
        if market:
            symbol = market['symbol']
        return {'id': str(order['id']), 'timestamp': timestamp, 
           'datetime': self.iso8601(timestamp), 
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        order = self.privateGetOrdersId(self.extend({'id': id}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        headers = {'X-Quoine-API-Version': self.version, 
