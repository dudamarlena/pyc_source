    ...
    def __new__(cls, class_name, bases, class_dict):
        ...
        for field in fields:
            ...
            if key in class_dict:
                raise Exception('field key %r clashes for CoumpoundField class %r (%r)' % (
...
class CompoundField(Field):
    ...
    def set_value(self, value):
        ...
        if values:
            raise FieldValueError('Values %r not consumed from %r' % (values, value))
