...
# [GCC 8.4.0]
# Embedded file name: /Users/joekavalieri/git/redisengine/tests/trees/test_proxy_validation.py
# Compiled at: 2016-04-05 18:12:35
import sys
sys.path[0:0] = ['']
import unittest
...
class ValidatorErrorTest(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        error.errors = {'1st': exceptions.ValidationError('bad 1st', errors={'2nd': exceptions.ValidationError('bad 2nd')})}
        self.assertTrue('1st' in error.to_dict())
        self.assertTrue(isinstance(error.to_dict()['1st'], dict))
        self.assertTrue('2nd' in error.to_dict()['1st'])
        self.assertEqual(error.to_dict()['1st']['2nd'], 'bad 2nd')
        error.errors = {'1st': exceptions.ValidationError('bad 1st', errors={'2nd': exceptions.ValidationError('bad 2nd', errors={'3rd': exceptions.ValidationError('bad 3rd', errors={'4th': exceptions.ValidationError('Inception')})})})}
        self.assertTrue('1st' in error.to_dict())
        self.assertTrue('2nd' in error.to_dict()['1st'])
