...
# [GCC 8.4.0]
# Embedded file name: /Users/joekavalieri/git/redisengine/tests/trees/test_direct_tree.py
# Compiled at: 2016-04-05 18:13:29
import sys, cPickle
from functools import partial
from nose.plugins.skip import SkipTest
sys.path[0:0] = [
 '']
import time, unittest, uuid, math, re
...
class TestDirectTree(unittest.TestCase):
    ...
    def test_custom_id_field(self):
        ...
        complex_person = self.ComplexPerson(id='cmplx', name='John', height=176, addressess=['Sunset Blvd 242'])
        complex_person.save()
        ...
        self.assertRaises(exceptions.DoesNotExist, partial(self.ComplexPerson.direct_tree, 'wrong_id'))
    ...
    def test_save_list(self):
        ...
        """
        self.ComplexPerson.drop_tree()
        complex_person = self.ComplexPerson(id='cmplx', name='John', height=176)
    ...
    def test_values(self):
        ...
        self.assertEqual(sorted(dperson.values(flat=True)), sorted(data2.values()))
        self.assertEqual(sorted(dperson.values(flat=True, *field_names)), sorted(zip(*expected)[1]))
