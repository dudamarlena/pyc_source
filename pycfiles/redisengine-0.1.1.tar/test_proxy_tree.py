...
# [GCC 8.4.0]
# Embedded file name: /Users/joekavalieri/git/redisengine/tests/trees/test_proxy_tree.py
# Compiled at: 2016-04-05 18:00:28
import unittest
...
class TestProxyTree(unittest.TestCase):
    ...
    def test_custom_id_field(self):
        ...
        self.assertRaises(exceptions.InvalidTreeError, create_tree_with_wrong_pk_field_name)
    ...
    def test_update(self):
        ...
        same_person.reload()
        person.reload('age')
        records_no = len(tuple(conn.scan_iter(self.Person._meta.tree_key_prefix + '*')))
    ...
    def test_values(self):
        ...
        self.assertEqual(sorted(complex_person.values(flat=True)), sorted(data.values()))
        self.assertEqual(sorted(complex_person.values(flat=True, *field_names)), sorted(zip(*expected)[1]))
