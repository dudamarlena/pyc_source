...
# [GCC 8.4.0]
# Embedded file name: /Users/joekavalieri/git/redisengine/tests/fields/test_fields.py
# Compiled at: 2016-04-05 18:14:38
import sys
from nose.plugins.skip import SkipTest
sys.path[0:0] = [
 '']
import time, unittest, uuid, math, itertools, re
try:
    import dateutil
except ImportError:
    dateutil = None
...
class FieldTest(unittest.TestCase):
    ...
    def test_string_validation(self):
        ...
        class Person(ProxyTree):
            ...
            userid = fields.StringField('[0-9a-z_]+$')
