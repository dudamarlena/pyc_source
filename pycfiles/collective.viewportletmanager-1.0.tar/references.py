...
# Embedded file name: build/bdist.linux-x86_64/egg/collective/viewlet/references/browser/references.py
# Compiled at: 2010-12-13 10:51:28
...
class References(ViewletBase):
    render = ViewPageTemplateFile('references.pt')
