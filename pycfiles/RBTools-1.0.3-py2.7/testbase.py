...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/rbtools/utils/testbase.py
# Compiled at: 2020-04-14 20:27:46
from __future__ import unicode_literals
import contextlib, os, shutil, sys, tempfile, uuid, six
...
class RBTestBase(TestCase):
    ...
    def setUp(self):
        ...
        self.old_home = os.environ[b'HOME']
    ...
    def tearDown(self):
        ...
        cleanup_tempfiles()
        if self.old_home:
            os.environ[b'HOME'] = self.old_home
    ...
    def reviewboardrc(self, data, use_temp_dir=False):
        ...
        if use_temp_dir:
            ...
            cwd = os.getcwd()
            os.chdir(temp_dir)
        with open(b'.reviewboardrc', b'w') as (fp):
