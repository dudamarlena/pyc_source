...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/rbtools/api/factory.py
# Compiled at: 2020-04-14 20:27:46
from __future__ import unicode_literals
from rbtools.api.resource import CountResource, ItemResource, ListResource, RESOURCE_MAP
from rbtools.api.utils import rem_mime_format
SPECIAL_KEYS = set(('links', 'total_results', 'stat', 'count'))

def create_resource(transport, payload, url, mime_type=None, item_mime_type=None, guess_token=True):
    ...
    return resource_class(transport, payload, url, token=token, item_mime_type=item_mime_type)