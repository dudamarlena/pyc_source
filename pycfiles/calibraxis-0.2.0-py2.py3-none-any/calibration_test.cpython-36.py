...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/tests/modules/calibration_test.py
# Compiled at: 2018-03-12 09:48:15
# Size of source mod 2**32: 5341 bytes
__doc__ = 'CalibrationTest class'
import unittest
...
class CalibrationTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        _CalibrationTest__unique_name1 = Generators.generate_unique_name('Calibration01')
        self.cal_01 = {'name':_CalibrationTest__unique_name1, 
         'unit_id':'-1', 
         'max_value':'10.0', 
         'min_value':'1.0', 
         'allowed_deviation':'0.1', 
         'description':'desc 01'}
        _CalibrationTest__unique_name_upd = Generators.generate_unique_name('CalibrationUpd01')
        self.cal_01_upd = {'name':_CalibrationTest__unique_name_upd, 
         'unit_id':'-1', 
         'max_value':'12.0', 
         'min_value':'3.0', 
    ...
    def test_create_calibration(self):
        cal_01 = Calibration(calibration_client=(self.cal_client),
        ...
        expect_app_info = {'name':['has already been taken'],  'unit':[
        ...
        cal_01.name = '__THIS_NAME_IS_1_CHARACTERS_LONGER_THAN_THE_ALLOWED_MAX_NUM__'
        cal_01.max_value = self.cal_01_upd['max_value']
        cal_01.min_value = self.cal_01_upd['min_value']
        cal_01.allowed_deviation = self.cal_01_upd['allowed_deviation']
        cal_01.description = self.cal_01_upd['description']
