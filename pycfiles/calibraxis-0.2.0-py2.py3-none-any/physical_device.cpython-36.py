...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/modules/physical_device.py
# Compiled at: 2019-08-05 13:13:33
# Size of source mod 2**32: 3008 bytes
__doc__ = 'PhysicalDevice module class'
...
class PhysicalDevice(PhysicalDeviceApi):
    ...
    def __init__(self, calibration_client, name, device_type_id, flg_available, parent_id=None, description=''):
    ...
    def create(self):
        ...
        response = cal_client.create_physical_device_api(self._PhysicalDevice__get_resource())
    ...
    def update(self):
        cal_client = self.calibration_client
        response = cal_client.update_physical_device_api(self.id, self._PhysicalDevice__get_resource())
    ...
    def __get_resource(self):
        physical_device = {PHYSICAL_DEVICE: {'name':self.name, 
