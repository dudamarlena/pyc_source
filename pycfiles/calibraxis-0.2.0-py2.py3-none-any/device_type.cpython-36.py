...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/modules/device_type.py
# Compiled at: 2019-08-05 13:13:33
# Size of source mod 2**32: 2707 bytes
__doc__ = 'DeviceType module class'
...
class DeviceType(DeviceTypeApi):
    ...
    def __init__(self, calibration_client, name, flg_available, description=''):
    ...
    def create(self):
        ...
        response = cal_client.create_device_type_api(self._DeviceType__get_resource())
    ...
    def update(self):
        cal_client = self.calibration_client
        response = cal_client.update_device_type_api(self.id, self._DeviceType__get_resource())
    ...
    def __get_resource(self):
        device_type = {DEVICE_TYPE: {'name':self.name, 
