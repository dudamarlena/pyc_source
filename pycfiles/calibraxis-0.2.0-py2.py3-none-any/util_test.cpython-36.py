...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/tests/common/util_test.py
# Compiled at: 2018-03-12 09:48:15
# Size of source mod 2**32: 3046 bytes
__doc__ = 'UtilTest class'
import unittest
...
class UtilTest(unittest.TestCase):
    ...
    def test_int_val_to_api_bool(self):
        self.assertEqual(Util.val_to_api_bool(-1), 'false')
        self.assertEqual(Util.val_to_api_bool(0), 'false')
        self.assertEqual(Util.val_to_api_bool(1), 'true')
        self.assertEqual(Util.val_to_api_bool(2), 'false')
        self.assertEqual(Util.val_to_api_bool(3), 'false')
        self.assertEqual(Util.val_to_api_bool(99), 'false')

    def test_bool_val_to_api_bool(self):
        self.assertEqual(Util.val_to_api_bool(False), 'false')
        self.assertEqual(Util.val_to_api_bool(True), 'true')

    def test_error_val_to_api_bool(self):
        self.assertEqual(Util.val_to_api_bool('False'), "Error: Value False is of type <class 'str'>")
        self.assertEqual(Util.val_to_api_bool('True'), "Error: Value True is of type <class 'str'>")
        self.assertEqual(Util.val_to_api_bool(2.23232e-07), "Error: Value 2.23232e-07 is of type <class 'float'>")

    def test_get_opt_hash_val(self):
        h01 = {'test_01':'value_01', 
         'test_02':'value_02', 
         'test_04':''}
