...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/tests/calibration_client_test.py
# Compiled at: 2019-08-05 18:01:11
# Size of source mod 2**32: 25839 bytes
__doc__ = 'CalibrationClientTest class'
...
class CalibrationClientTest(ModuleBase, unittest.TestCase):
    ...
    def test_inject_new_calibration_constant_version(self):
        ...
        cal_inject_dict = {'detector_condition':det_cond_h, 
         'calibration_constant':cc_h, 
         'calibration_constant_version':ccv_h}
        resp = CalibrationClient.inject_new_calibration_constant_version(self.cal_client, cal_inject_dict)
        ...
        self.assert_eq_val(resp_ccv['raw_data_location'], ccv_h['raw_data_location'])
    ...
    def test_retrieve_calibration_constant_version(self):
        calibration_hash_01 = CalibrationTestHash('2016-05-26T05:00:00.757000').valid_search_01
        ...
        begin_val_at_exp = calibration_hash_01['begin_validity_at_exp']
        end_val_at_exp = calibration_hash_01['end_validity_at_exp']
        cal_name = calibration_hash_01['karabo_h']['calibration_constant']['calibration_name']
        dev_name = calibration_hash_01['karabo_h']['calibration_constant_version']['device_name']
        retrieve_h = {'calibration_hash_schema_version':'1.0', 
         'calibration_name':cal_name, 
         'device_name':dev_name, 
         'measured_at':begin_at_exp, 
         'snapshot_at':'', 
         'detector_condition':det_cond_h_exp}
        resp = CalibrationClient.retrieve_calibration_constant_version(self.cal_client, retrieve_h)
        logging.error('calibration_hash_01: {0}'.format(calibration_hash_01))
        ...
        self.assert_eq_val(resp['info'], success_info_msg)
        resp_ccv = resp['data']
        expected_return = {'id':-6, 
         'name':'CALIBRATION_CONSTANT_VERSION_TEST-6_DO_NOT_DELETE', 
         'file_name':'cal.r0001.c0002.h5', 
         'path_to_file':'/usr/local/cal_repo/', 
         'data_set_name':'exp001.cal001', 
         'flg_deployed':True,  'flg_good_quality':True, 
         'begin_validity_at':'2016-05-25T10:30:14.000+02:00', 
         'end_validity_at':'2029-06-24T00:00:00.000+02:00', 
         'begin_at':'2016-05-26T12:00:00.000+02:00', 
         'start_idx':None, 
         ...
         'raw_data_location':None, 
         'description':None, 
         'calibration_constant':{'id':-3, 
          'name':'CALIBRATION_CONSTANT_TEST-3_DO_NOT_DELETE', 
          'flg_auto_approve':True, 
          'flg_available':True, 
          'description':'Created automatically via seed:seed_tests', 
          'device_type_id':-1, 
          'calibration_id':-2,  'condition_id':-3}, 
         'physical_device':{'id':-1, 
          'name':'PHYSICAL_DEVICE-1_DO_NOT_DELETE', 
          'device_type_id':-1, 
          'flg_available':True,  'parent_id':None, 
          'description':'Created automatically via seed:seed_tests'}}
        self.assert_eq_val(resp_ccv['name'], expected_return['name'])
        self.assert_eq_val(resp_ccv['flg_good_quality'], True)
        self.assert_eq_val(resp_ccv['begin_validity_at'], expected_return['begin_validity_at'])
        self.assert_eq_val(resp_ccv['end_validity_at'], expected_return['end_validity_at'])
        self.assert_eq_val(resp_ccv['begin_at'], expected_return['begin_at'])
        self.assert_eq_val(resp_ccv['flg_deployed'], True)
        self.assert_eq_val(resp_ccv['raw_data_location'], expected_return['raw_data_location'])
        self.assert_eq_val(resp_ccv['file_name'], expected_return['file_name'])
        self.assert_eq_val(resp_ccv['path_to_file'], expected_return['path_to_file'])
        self.assert_eq_val(resp_ccv['description'], expected_return['description'])
        self.assert_eq_val(resp_ccv['data_set_name'], expected_return['data_set_name'])
        ...
        self.assert_eq_val(resp_cc['description'], expected_return_cc['description'])
        resp_pd = resp['data']['physical_device']
    ...
    def test_retrieve_all_calibration_constant_versions(self):
        ...
        retrieve_h = {'calibration_hash_schema_version':'1.0', 
         ...
         'snapshot_at':'', 
         'detector_condition':det_cond_h_exp}
        resp = CalibrationClient.retrieve_all_calibration_constant_versions(self.cal_client, retrieve_h)
        logging.error('calibration_hash_01: {0}'.format(calibration_hash_01))
        logging.error('retrieve_h: {0}'.format(retrieve_h))
        logging.error('resp: {0}'.format(resp))
        self.assert_eq_val(resp['success'], True)
        ...
        for ccv in response_data:
            logging.error("response.data[{0}]['id'] == {1}".format(index, ccv['id']))
            index += 1

        resp_ccv_0 = response_data[0]
        self.assert_eq_val(resp_ccv_0['name'], self.existing_db_06['name'])
        self.assert_eq_val(resp_ccv_0['flg_good_quality'], self.existing_db_06['flg_good_quality'])
        self.assert_eq_val(resp_ccv_0['begin_validity_at'], self.existing_db_06['begin_validity_at'])
        self.assert_eq_val(resp_ccv_0['end_validity_at'], self.existing_db_06['end_validity_at'])
        self.assert_eq_val(resp_ccv_0['begin_at'], self.existing_db_06['begin_at'])
        self.assert_eq_val(resp_ccv_0['flg_deployed'], self.existing_db_06['flg_deployed'])
        self.assert_eq_val(resp_ccv_0['raw_data_location'], self.existing_db_06['raw_data_location'])
        self.assert_eq_val(resp_ccv_0['file_name'], self.existing_db_06['file_name'])
        self.assert_eq_val(resp_ccv_0['path_to_file'], self.existing_db_06['path_to_file'])
        self.assert_eq_val(resp_ccv_0['description'], self.existing_db_06['description'])
        self.assert_eq_val(resp_ccv_0['data_set_name'], self.existing_db_06['data_set_name'])
        self.assert_eq_val(resp_ccv_0['start_idx'], self.existing_db_06['start_idx'])
        self.assert_eq_val(resp_ccv_0['end_idx'], self.existing_db_06['end_idx'])
        self.assert_eq_val(resp_ccv_0['calibration_constant']['id'], self.existing_db_06['calibration_constant_id'])
        self.assert_eq_val(resp_ccv_0['physical_device']['id'], self.existing_db_06['physical_device_id'])
        resp_ccv_1 = response_data[1]
        self.assert_eq_val(resp_ccv_1['name'], self.existing_db_05['name'])
        self.assert_eq_val(resp_ccv_1['flg_good_quality'], self.existing_db_05['flg_good_quality'])
        self.assert_eq_val(resp_ccv_1['begin_validity_at'], self.existing_db_05['begin_validity_at'])
        self.assert_eq_val(resp_ccv_1['end_validity_at'], self.existing_db_05['end_validity_at'])
        self.assert_eq_val(resp_ccv_1['begin_at'], self.existing_db_05['begin_at'])
        self.assert_eq_val(resp_ccv_1['flg_deployed'], self.existing_db_05['flg_deployed'])
        self.assert_eq_val(resp_ccv_1['raw_data_location'], self.existing_db_05['raw_data_location'])
        self.assert_eq_val(resp_ccv_1['file_name'], self.existing_db_05['file_name'])
        self.assert_eq_val(resp_ccv_1['path_to_file'], self.existing_db_05['path_to_file'])
        self.assert_eq_val(resp_ccv_1['description'], self.existing_db_05['description'])
        self.assert_eq_val(resp_ccv_1['data_set_name'], self.existing_db_05['data_set_name'])
        self.assert_eq_val(resp_ccv_1['start_idx'], self.existing_db_05['start_idx'])
        self.assert_eq_val(resp_ccv_1['end_idx'], self.existing_db_05['end_idx'])
        self.assert_eq_val(resp_ccv_1['calibration_constant']['id'], self.existing_db_05['calibration_constant_id'])
        self.assert_eq_val(resp_ccv_1['physical_device']['id'], self.existing_db_05['physical_device_id'])
    ...
    def test_create_condition_from_dict_success(self):
        _CalibrationClientTest__parameters_01 = [
         ...
         {'parameter_name':'PARAMETER_TEST-2_DO_NOT_DELETE', 
          ...
          'flg_available':'true', 
          'description':'Created automatically via seed:seed_tests'}]
        _CalibrationClientTest__unique_name = 'CONDITION_TEST-1_DO_NOT_DELETE'
        cond_dict = {'name':_CalibrationClientTest__unique_name, 
         'flg_available':'true', 
         'description':'Created automatically via seed:seed_tests', 
         'parameters':_CalibrationClientTest__parameters_01}
        resp = CalibrationClient.set_condition_from_dict(self.cal_client, cond_dict)
        expect = {'id':-1, 
         'flg_available':True, 
    ...
    def test_create_condition_from_dict_error(self):
        _CalibrationClientTest__parameters_01 = [
         {'parameter_name':'PARAMETER_TEST-1_DO_NOT_DELETE', 
          ...
          'description':'Created automatically via seed:seed_tests'}]
        _CalibrationClientTest__unique_name = 'CONDITION_TEST-1_DO_NOT_DELETE'
        expect = {'name':_CalibrationClientTest__unique_name, 
         'flg_available':'true', 
         'description':'Created automatically via seed:seed_tests', 
         'parameters':_CalibrationClientTest__parameters_01}
        resp = CalibrationClient.set_condition_from_dict(self.cal_client, expect)
    ...
    def test_update_calibration_constant_version(self):
        update_h = {'ccv_id':-1, 
         ...
         'start_idx':0, 
         'flg_deployed':False}
        resp = CalibrationClient.update_calibration_constant_version(self.cal_client, update_h)
        ...
        self.assert_eq_val(resp['info'], success_info_msg)
        resp_ccv = resp['data']
        self.assert_eq_val(resp_ccv['flg_good_quality'], update_h['flg_good_quality'])
        ...
        update_back_h = {'ccv_id':-1, 
         'flg_good_quality':True, 
         'description':None, 
         'end_idx':None, 
         'start_idx':None, 
         'flg_deployed':True}
        resp = CalibrationClient.update_calibration_constant_version(self.cal_client, update_back_h)
        self.assert_eq_val(resp['success'], True)
        self.assert_eq_val(resp['app_info'], {})
        success_info_msg = 'calibration_constant_version updated successfully'
        self.assert_eq_val(resp['info'], success_info_msg)
        resp_ccv = resp['data']
        self.assert_eq_val(resp_ccv['description'], update_back_h['description'])
        self.assert_eq_val(resp_ccv['end_idx'], update_back_h['end_idx'])
        self.assert_eq_val(resp_ccv['start_idx'], update_back_h['start_idx'])
        self.assert_eq_val(resp_ccv['flg_deployed'], update_back_h['flg_deployed'])
        update_h_failed = {'ccv_id': -100}
        resp_failed = CalibrationClient.update_calibration_constant_version(self.cal_client, update_h_failed)
