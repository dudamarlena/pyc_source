...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/apis/calibration_api.py
# Compiled at: 2019-08-05 17:28:52
# Size of source mod 2**32: 2518 bytes
__doc__ = 'CalibrationApi module class'
import json
...
class CalibrationApi(Base):
    ...
    def get_all_calibration_constants_by_conds_api(self, calibration_id, dev_type_id, cond_ids):
        api_action_name = '/get_all_calibration_constants'
        api_relative_url = '{0}{1}'.format(calibration_id, api_action_name)
        api_url = self._CalibrationApi__get_api_url(api_relative_url)
    ...
    def get_calibration_constant_by_uk_api(self, calibration_id, dev_type_id, cond_id):
