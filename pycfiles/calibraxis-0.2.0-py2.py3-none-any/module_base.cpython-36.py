...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/tests/modules/module_base.py
# Compiled at: 2018-03-12 09:48:15
# Size of source mod 2**32: 4026 bytes
__doc__ = 'BaseTest Class with helper methods common to all modules tests'
import unittest
...
class ModuleBase(Util, unittest.TestCase):
    ...
    def __assert_error(self, receive, expect):
        ...
        if type(expect_app_info) is dict:
            if len(expect_app_info) > 0:
