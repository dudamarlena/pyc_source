...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/tests/modules/physical_device_test.py
# Compiled at: 2018-03-12 09:48:15
# Size of source mod 2**32: 4960 bytes
__doc__ = 'PhysicalDeviceTest class'
import unittest
...
class PhysicalDeviceTest(ModuleBase, unittest.TestCase):
    ...
    def setUp(self):
        ...
        _PhysicalDeviceTest__unique_name1 = Generators.generate_unique_name('PhysicalDev01')
        self.pd_01 = {'name':_PhysicalDeviceTest__unique_name1, 
         'device_type_id':'-1', 
         'flg_available':'true', 
         'parent_id':None, 
         'description':'desc 01'}
        _PhysicalDeviceTest__unique_name_upd = Generators.generate_unique_name('PhysicalDevUpd01')
        self.pd_01_upd = {'name':_PhysicalDeviceTest__unique_name_upd, 
         'device_type_id':'-1', 
         'flg_available':'false', 
         'parent_id':None, 
    ...
    def test_create_physical_device(self):
        pd_01 = PhysicalDevice(calibration_client=(self.cal_client), name=(self.pd_01['name']),
        ...
        pd_01.name = '__THIS_NAME_IS_1_CHARACTERS_LONGER_THAN_THE_ALLOWED_MAX_NUM__'
        pd_01.flg_available = self.pd_01_upd['flg_available']
        pd_01.description = self.pd_01_upd['description']
