...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/calibration_client/tests/apis/condition_api_test.py
# Compiled at: 2019-08-14 11:41:29
# Size of source mod 2**32: 9171 bytes
__doc__ = 'ConditionApiTest class'
import unittest
...
class ConditionApiTest(ApiBase, unittest.TestCase):
    ...
    _ConditionApiTest__unique_name = 'CONDITION_TEST-1_DO_NOT_DELETE'
    ...
    def test_expected_condition(self):
        parameters_conditions_attr = [
         ...
         {'parameter_id':'-2', 
          ...
          'flg_available':'true', 
          'description':'Created automatically via seed:seed_tests'}]
        condition = {'condition': {'name':self._ConditionApiTest__unique_name, 
                       'flg_available':'true', 
                       'description':'Created automatically via seed:seed_tests', 
    ...
    def test_possible_conditions_exact_values(self):
        cal_client = CalibrationClientApi(client_id=(CLIENT_OAUTH2_INFO['CLIENT_ID']),
          client_secret=(CLIENT_OAUTH2_INFO['CLIENT_SECRET']),
          token_url=(CLIENT_OAUTH2_INFO['TOKEN_URL']),
          refresh_url=(CLIENT_OAUTH2_INFO['REFRESH_URL']),
          auth_url=(CLIENT_OAUTH2_INFO['AUTH_URL']),
