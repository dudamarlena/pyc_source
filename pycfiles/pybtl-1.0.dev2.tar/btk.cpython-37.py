...
class btkForcePlatformCollectionIterator(_object):
    """btkForcePlatformCollectionIterator"""
    __swig_setmethods__ = {}
...
class btkWrenchCollectionDownsampleFilter(_object):
    """btkWrenchCollectionDownsampleFilter"""
    __swig_setmethods__ = {}
...
class btkSeparateKnownVirtualMarkersFilter(_object):
    """btkSeparateKnownVirtualMarkersFilter"""
    __swig_setmethods__ = {}
