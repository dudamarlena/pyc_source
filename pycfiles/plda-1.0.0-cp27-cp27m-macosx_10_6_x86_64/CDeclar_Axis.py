...
# Embedded file name: build\bdist.win32\egg\IDE\CDeclar_Axis.py
# Compiled at: 2020-01-14 23:47:16
import wx, wx.xrc, wx.stc as stc
from CLogText import LogText

class Panel_Axis(wx.Panel):
...
class CustListCtrl(wx.ListCtrl, listmix.ListCtrlAutoWidthMixin, listmix.TextEditMixin):
    ...
    def Populate(self):
        ...
        self.InsertColumn(1, 'limit?')
        self.InsertColumn(2, 'max position')
        self.InsertColumn(3, 'min position')
        self.currentItem = 0