...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/land/copernicus/content/patches.py
# Compiled at: 2018-01-18 05:33:22
...
def enabled(self):
    ...
    if parent.portal_type in ('HelpCenterDefinition', 'HelpCenterErrorReference', 'HelpCenterFAQ',
                              'HelpCenterFAQFolder', 'HelpCenterGlossary', 'HelpCenter',
                              'HelpCenterHowTo', 'HelpCenterHowToFolder', 'HelpCenterInstructionalVideo',
                              'HelpCenterInstructionalVideoFolder', 'HelpCenterKnowledgeBase',
                              'HelpCenterLeafPage', 'HelpCenterLink', 'HelpCenterLinkFolder',
                              'HelpCenterReferenceManual', 'HelpCenterReferenceManualFolder',
                              'HelpCenterReferenceManualPage', 'HelpCenterReferenceManualSection',
                              'HelpCenterTutorial', 'HelpCenterTutorialFolder', 'HelpCenterTutorialPage'):
        return True
...
def crop(self, text):
    ...
    return plone.cropText(text, self.site_properties.search_results_description_length, self.site_properties.ellipsis)
