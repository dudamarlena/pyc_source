...
# Compiled at: 2020-04-08 04:21:36
# Size of source mod 2**32: 23351 bytes
"""
...
def get_vcard_template(app, object_classes):
    ...
    current_oc_set = set([s.lower().decode('ascii') for s in object_classes])
...
class DisplayEntry(UserDict):
 ...
 L. 193        14  LOAD_GLOBAL              web2ldap
               16  LOAD_ATTR                app
               18  LOAD_ATTR                schema
               20  LOAD_METHOD              object_class_categories

 L. 194        22  LOAD_DEREF               'self'
               24  LOAD_ATTR                entry
               26  LOAD_ATTR                _s

 L. 195        28  LOAD_FAST                'template_oc'

 L. 193        30  CALL_METHOD_2         2  ''
               32  UNPACK_SEQUENCE_3     3 
               34  STORE_FAST               'structural_oc'
               36  STORE_FAST               'abstract_oc'
               38  STORE_FAST               'auxiliary_oc'

 L. 198        40  LOAD_GLOBAL              set
               42  CALL_FUNCTION_0       0  ''
               44  STORE_FAST               'used_templates'

 L. 199        46  LOAD_GLOBAL              set
               48  CALL_FUNCTION_0       0  ''
               50  STORE_FAST               'displayed_attrs'

 L. 200        52  LOAD_CONST               None
               54  STORE_FAST               'error_msg'

 L. 201        56  LOAD_FAST                'structural_oc'
               58  LOAD_FAST                'abstract_oc'
               60  LOAD_FAST                'auxiliary_oc'
               62  BUILD_TUPLE_3         3 
               64  GET_ITER         
               66  FOR_ITER            318  'to 318'
               68  STORE_FAST               'oc_set'

 L. 202        70  LOAD_FAST                'oc_set'
               72  GET_ITER         
             74_0  COME_FROM           284  '284'
               74  FOR_ITER            316  'to 316'
               76  STORE_FAST               'oc'

 L. 203        78  SETUP_FINALLY        92  'to 92'

 L. 204        80  LOAD_FAST                'read_template_dict'
               82  LOAD_FAST                'oc'
               84  BINARY_SUBSCR    
 ...
 L. 206       106  LOAD_STR                 'Template file not found'
              108  STORE_FAST               'error_msg'

 L. 207       110  POP_EXCEPT       
 ...
 L. 208       120  LOAD_GLOBAL              web2ldap
              122  LOAD_ATTR                app
              124  LOAD_ATTR                gui
              126  LOAD_METHOD              GetVariantFilename

 L. 209       128  LOAD_FAST                'read_template_filename'

 L. 210       130  LOAD_DEREF               'self'
              132  LOAD_ATTR                _app
              134  LOAD_ATTR                form
              136  LOAD_ATTR                accept_language

 L. 208       138  CALL_METHOD_2         2  ''
              140  STORE_FAST               'read_template_filename'

 L. 212       142  LOAD_FAST                'read_template_filename'
              144  LOAD_FAST                'used_templates'
              146  COMPARE_OP               in
              148  POP_JUMP_IF_FALSE   152  'to 152'

 L. 214       150  JUMP_BACK            74  'to 74'
            152_0  COME_FROM           148  '148'

 L. 215       152  LOAD_FAST                'used_templates'
              154  LOAD_METHOD              add
              156  LOAD_FAST                'read_template_filename'
              158  CALL_METHOD_1         1  ''
              160  POP_TOP          

 L. 216       162  LOAD_FAST                'read_template_filename'
              164  POP_JUMP_IF_TRUE    172  'to 172'

 L. 217       166  LOAD_STR                 'Empty template filename'
              168  STORE_FAST               'error_msg'

 L. 218       170  JUMP_BACK            74  'to 74'
            172_0  COME_FROM           164  '164'

 L. 219       172  SETUP_FINALLY       214  'to 214'

 L. 220       174  LOAD_GLOBAL              open
 ...
 L. 221       186  LOAD_FAST                'template_file'
 ...
 L. 223       228  LOAD_STR                 'I/O error reading template file'
              230  STORE_FAST               'error_msg'

 L. 224       232  POP_EXCEPT       
 ...
 L. 225       242  LOAD_GLOBAL              set
              244  LOAD_CLOSURE             'self'
              246  BUILD_TUPLE_1         1 
              248  LOAD_LISTCOMP            '<code_object <listcomp>>'
              250  LOAD_STR                 'DisplayEntry.template_output.<locals>.<listcomp>'
              252  MAKE_FUNCTION_8          'closure'

 L. 227       254  LOAD_GLOBAL              GrabKeys
              256  LOAD_FAST                'template_str'
 ...
 L. 225       262  GET_ITER         
              ...
              268  STORE_FAST               'template_attr_oid_set'

 L. 229       270  LOAD_FAST                'display_duplicate_attrs'
          272_274  POP_JUMP_IF_TRUE    286  'to 286'
              276  LOAD_FAST                'displayed_attrs'
              278  LOAD_METHOD              intersection
              280  LOAD_FAST                'template_attr_oid_set'
              282  CALL_METHOD_1         1  ''
              284  POP_JUMP_IF_TRUE     74  'to 74'
            286_0  COME_FROM           272  '272'

 L. 230       286  LOAD_DEREF               'self'
              288  LOAD_ATTR                _app
              290  LOAD_ATTR                outf
              292  LOAD_METHOD              write
              294  LOAD_FAST                'template_str'
              296  LOAD_DEREF               'self'
              298  BINARY_MODULO    
              300  CALL_METHOD_1         1  ''
              302  POP_TOP          

 L. 231       304  LOAD_FAST                'displayed_attrs'
              306  LOAD_METHOD              update
              308  LOAD_FAST                'template_attr_oid_set'
              310  CALL_METHOD_1         1  ''
              312  POP_TOP          
              314  JUMP_BACK            74  'to 74'
              316  JUMP_BACK            66  'to 66'

 L. 232       318  LOAD_FAST                'error_msg'
          320_322  POP_JUMP_IF_FALSE   346  'to 346'

 L. 233       324  LOAD_DEREF               'self'
              326  LOAD_ATTR                _app
              328  LOAD_ATTR                outf
              330  LOAD_METHOD              write

 L. 234       332  LOAD_STR                 '<p class="ErrorMessage">%s! (object class <var>%r</var>)</p>'

 L. 235       334  LOAD_FAST                'error_msg'

 L. 236       336  LOAD_FAST                'oc'

 L. 234       338  BUILD_TUPLE_2         2 
              340  BINARY_MODULO    

 L. 233       342  CALL_METHOD_1         1  ''
              344  POP_TOP          
            346_0  COME_FROM           320  '320'

 L. 239       346  LOAD_FAST                'displayed_attrs'
              348  RETURN_VALUE     
               -1  RETURN_LAST      
...
def display_attribute_table(app, entry, attrs, comment):
    ...
    read_expandattr_set = set([at.strip().lower() for at in app.form.getInputValue('read_expandattr', []) if at])
