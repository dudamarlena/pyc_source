...
# Compiled at: 2019-12-20 17:28:56
# Size of source mod 2**32: 49376 bytes
"""
...
Parse error at or near `JUMP_BACK' instruction at offset 136
    ...
    def open(self, uri, timeout, startTLS, env, enableSessionTracking, tls_options=None):
        ...
        elif self.uri.lower().startswith('ldap:'):
    ...
    def modify(self, dn, modlist, req_ctrls=None, assertion_filter=None):
        ...
        self.l.modify_s(dn_str,
          [(
         mod_type, mod_at, mod_avs) for mod_type, mod_at, mod_avs in modlist],
          req_ctrls=req_ctrls)
