...
# Compiled at: 2020-03-20 05:23:19
...
def application--- This code section failed: ---
 ...
 L. 109         0  LOAD_FAST                'environ'
                2  LOAD_STR                 'REQUEST_METHOD'
                4  BINARY_SUBSCR    
                6  LOAD_CONST               {'GET', 'POST'}
                8  COMPARE_OP               not-in
               10  POP_JUMP_IF_FALSE    44  'to 44'

 L. 110        12  LOAD_GLOBAL              logger
 ...
 L. 115        58  LOAD_GLOBAL              os
               60  LOAD_ATTR                path
               62  LOAD_METHOD              join

 L. 116        64  LOAD_GLOBAL              web2ldapcnf
               66  LOAD_ATTR                etc_dir

 L. 117        68  LOAD_STR                 'css'

 L. 118        70  LOAD_GLOBAL              os
               72  LOAD_ATTR                path
 ...
 L. 115        84  CALL_METHOD_3         3  ''
               86  STORE_FAST               'css_filename'

 L. 120        88  SETUP_FINALLY       158  'to 158'

 L. 121        90  LOAD_GLOBAL              os
               92  LOAD_METHOD              stat
 ...
 L. 122       102  LOAD_GLOBAL              open
              104  LOAD_FAST                'css_filename'
              106  LOAD_STR                 'rb'
              108  CALL_FUNCTION_2       2  ''
              110  STORE_FAST               'css_file'

 L. 124       112  LOAD_CONST               ('Content-type', 'text/css')

 L. 125       114  LOAD_STR                 'Content-Length'
              116  LOAD_GLOBAL              str
              118  LOAD_FAST                'css_size'
              120  CALL_FUNCTION_1       1  ''
              122  BUILD_TUPLE_2         2 

 L. 123       124  BUILD_LIST_2          2 
              126  STORE_FAST               'css_http_headers'

 L. 127       128  LOAD_FAST                'css_http_headers'
 ...
 L. 128       144  LOAD_FAST                'start_response'
              146  LOAD_STR                 '200 OK'
 ...
 L. 137       264  LOAD_GLOBAL              AppResponse
              266  CALL_FUNCTION_0       0  ''
              268  STORE_FAST               'outf'

 L. 138       270  LOAD_GLOBAL              web2ldap
              272  LOAD_ATTR                app
 ...
 L. 139       286  LOAD_FAST                'app'
              288  LOAD_METHOD              run
              290  CALL_METHOD_0         0  ''
              292  POP_TOP          

 L. 140       294  LOAD_GLOBAL              logger
              296  LOAD_METHOD              debug

 L. 141       298  LOAD_STR                 'Executing %s.run() took %0.3f secs'

 L. 142       300  LOAD_FAST                'app'
              302  LOAD_ATTR                __class__
              304  LOAD_ATTR                __name__

 L. 143       306  LOAD_GLOBAL              time
 ...
 L. 140       318  CALL_METHOD_3         3  ''
              320  POP_TOP          

 L. 145       322  LOAD_FAST                'outf'
 ...
 L. 146       344  LOAD_FAST                'start_response'
              346  LOAD_STR                 '200 OK'
              348  LOAD_FAST                'outf'
