...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/oplogutils/_counter.py
...
class Counter(_core.Command):
    ...
    def get_options(self):
        opts = OptionParser()
        opts.add_option('', '--start', action='store', default=None, help='The starting time (YYYY-MM-DD HH:MM:SS, UTC time).')
        opts.add_option('', '--end', action='store', default=None, help='The ending time.')
