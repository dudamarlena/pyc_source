...
# [GCC 8.4.0]
# Embedded file name: /Users/jacob/Projects/python-hdcloud/tests/test_jobs.py
# Compiled at: 2010-04-16 11:36:49
...
def test_job_create():
    ...
    jobs = hdcloud.jobs.create(source=st, destination=st, files=[
     'hi.mpg'], profiles=[
     pr])
