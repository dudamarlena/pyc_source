...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dossier/fc/exceptions.py
...
class NonUnicodeKeyError(BaseException, TypeError):
    ...
    def __init__(self, key):
        message = 'keys in dossier.fc.{StringCounter,GeoCoords,FeatureTokens} must be unicode'
        if key is not None:
