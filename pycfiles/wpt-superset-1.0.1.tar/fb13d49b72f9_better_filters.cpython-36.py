...
# [GCC 8.4.0]
# Embedded file name: /home/leonardo/proyectos/dashboard/incubator-superset/superset/migrations/versions/fb13d49b72f9_better_filters.py
...
def upgrade():
    ...
    for slc in filter_box_slices.all():
        try:
            ...
            if cols:
                flts = [{'column':col,  'metric':metrics[0] if metrics else None,  'asc':False,  'clearable':True,  'multiple':True} for col in cols]
