...
# [GCC 8.4.0]
# Embedded file name: /home/leonardo/proyectos/dashboard/incubator-superset/superset/migrations/versions/18e88e1cc004_making_audit_nullable.py
...
def upgrade():
    try:
        op.alter_column('clusters',
          'changed_on', existing_type=(sa.DATETIME()),
          nullable=True)
        op.alter_column('clusters',
          'created_on', existing_type=(sa.DATETIME()),
          nullable=True)
        ...
        op.alter_column('datasources',
          'changed_by_fk', existing_type=(sa.INTEGER()),
          nullable=True)
        op.alter_column('datasources',
          'changed_on', existing_type=(sa.DATETIME()),
          nullable=True)
        op.alter_column('datasources',
          'created_by_fk', existing_type=(sa.INTEGER()),
          nullable=True)
        op.alter_column('datasources',
          'created_on', existing_type=(sa.DATETIME()),
          nullable=True)
