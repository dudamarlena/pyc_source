...
# [GCC 8.4.0]
# Embedded file name: /home/leonardo/proyectos/dashboard/incubator-superset/superset/migrations/versions/b4456560d4f3_change_table_unique_constraint.py
...
def upgrade():
    try:
        op.drop_constraint('tables_table_name_key',
          'tables', type_='unique')
