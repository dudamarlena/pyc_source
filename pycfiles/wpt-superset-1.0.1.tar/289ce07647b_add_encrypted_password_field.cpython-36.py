...
# [GCC 8.4.0]
# Embedded file name: /home/leonardo/proyectos/dashboard/incubator-superset/superset/migrations/versions/289ce07647b_add_encrypted_password_field.py
...
def upgrade():
    op.add_column('dbs', sa.Column('password',
