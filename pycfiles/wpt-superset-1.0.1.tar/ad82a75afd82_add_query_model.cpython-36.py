...
# [GCC 8.4.0]
# Embedded file name: /home/leonardo/proyectos/dashboard/incubator-superset/superset/migrations/versions/ad82a75afd82_add_query_model.py
...
def upgrade():
    ...
    op.create_index((op.f('ti_user_id_changed_on')),
      'query',
      ['user_id', 'changed_on'], unique=False)
