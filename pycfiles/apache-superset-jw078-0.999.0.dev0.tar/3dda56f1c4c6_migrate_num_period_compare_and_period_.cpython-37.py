...
# Embedded file name: /Users/bogdankyryliuk/src/oss/incubator-superset/superset/migrations/versions/3dda56f1c4c6_migrate_num_period_compare_and_period_.py
# Compiled at: 2020-01-16 13:27:41
# Size of source mod 2**32: 5305 bytes
__doc__ = 'Migrate num_period_compare and period_ratio_type\n\nRevision ID: 3dda56f1c4c6\nRevises: bddc498dd179\nCreate Date: 2018-07-05 15:19:14.609299\n\n'
import datetime, json, isodate
...
comparison_type_map = {'factor':'ratio', 
 'growth':'percentage',  'value':'absolute'}
db_engine_specs_map = {'second':'PT1S', 
 'minute':'PT1M', 
 '5 minute':'PT5M', 
 '10  minute':'PT10M', 
 'half hour':'PT0.5H', 
...
def upgrade():
    ...
    for chart in session.query(Slice):
        ...
        period_ratio_type = params.get('period_ratio_type') or 
