...
# [GCC 8.4.0]
# Embedded file name: /Users/stanley/PycharmProjects/horizon-python-client/src/mf_horizon_client/endpoints.py
...
class Endpoints:
    ...
    @staticmethod
    def EXPERT_BACKTEST_FOR_STAGE_AND_HORIZON(pipeline_id: int, horizon: int, first_row: int, last_row: int, n_training_rows: int, stage_id: int):
        return f"{Endpoints.SINGLE_PIPELINE(pipeline_id)}/expert/backtest?first={first_row}&last={last_row}&train={n_training_rows}&stage={stage_id}&horizon={horizon} "