...
# [GCC 8.4.0]
# Embedded file name: /Users/stanley/PycharmProjects/horizon-python-client/src/mf_horizon_client/schemas/configs.py
...
from mf_horizon_client.data_structures.configs.stage_config import BacktestStageConfig, FeatureGenerationStageConfig, FilterStageConfig, PredictionStageConfig, ProblemSpecificationConfig, RefinementStageConfig, StationarisationStageConfig
...
class FilteringConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> FilterStageConfig:
        """
...
class StationarisationConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> StationarisationStageConfig:
        """
        Marshmallow function, invoked after validating and loading json data. Converts
...
class ProblemSpecConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> ProblemSpecificationConfig:
        """
        Marshmallow function, invoked after validating and loading json data. Converts
...
class BacktestConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> BacktestStageConfig:
        """
        Marshmallow function, invoked after validating and loading json data. Converts
...
class RefinementConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> RefinementStageConfig:
        """
        Marshmallow function, invoked after validating and loading json data. Converts
...
class FeatureGenerationConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> FeatureGenerationStageConfig:
        """
        Marshmallow function, invoked after validating and loading json data. Converts
...
class PredictionConfigSchema(CamelCaseSchema):
    ...
    @post_load
    def make(self, data: Any, many: bool, partial: bool) -> PredictionStageConfig:
        """
        Marshmallow function, invoked after validating and loading json data. Converts
...
class ConfigMultiplexSchema(OneOfSchema):
    type_schemas = {StageType.filtering.name: FilteringConfigSchema, 
    ...
    config_lookup = {FilterStageConfig: StageType.filtering.name, 
    ...
    def get_obj_type(self, obj: Type[Any]) -> str:
        try:
            ...
            raise TypeError(f"Unrecognised type {type(obj)} for multiplex schema, {self.__class__}")
