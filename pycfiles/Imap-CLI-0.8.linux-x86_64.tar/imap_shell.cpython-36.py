...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/imap_cli/scripts/imap_shell.py
# Compiled at: 2018-04-21 11:53:05
# Size of source mod 2**32: 10019 bytes
"""Use IMAP CLI to gt a summary of IMAP account state."""
import argparse, cmd, datetime, logging, os, sys, tempfile, threading, time, webbrowser, docopt, imap_cli
    ...
    def do_read(self, arg):
        ...
        try:
            args = docopt.docopt('\n'.join([
             ...
             '',
             'Options:',
             '    -b, --browser     Open mail in browser']), arg)
        except SystemExit:
            return
        else:
        ...
        try:
            ...
            if args.get('--tags') is not None:
                ...
                if args['--date'] is not None:
                    ...
                    date = None
            search_criterion = search.create_search_criterion(address=(args['--address']),
              date=date,
