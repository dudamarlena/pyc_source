...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/jiracli/bridge/soap.py
...
from jiracli.errors import JiraCliError, JiraInitializationError, JiraAuthenticationError, UsageError
...
class JiraSoapBridge(JiraBridge):
    ...
    def transition_issue(self, issue, transition, resolution):
        ...
        try:
            ...
            return self.service.progressWorkflowAction(self.token, issue, transitions[transition]['id'], fields)
        except KeyError:
