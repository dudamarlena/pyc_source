...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/jiracli/cli.py
# Compiled at: 2017-07-27 23:00:52
import getpass, logging, re, os, optparse, tempfile, socket, pickle, sys
