...
# Compiled at: 2020-05-02 21:14:00
...
class Disc(Mesh):
    ...
    def __init__(self, pos=(0, 0, 0), r1=0.5, r2=1, c='coral', alpha=1, res=12):
        if len(pos) == 2:
            pos = (
             pos[0], pos[1], 0)
...
class Text(Mesh):
    ...
    def __init__(self, txt, pos=(0, 0, 0), s=1, depth=0, italic=False, justify='bottom-left', c=None, alpha=1):
...
def Text2D(txt, pos=3, s=1, c=None, alpha=1, bg=None, font='Montserrat', justify='bottom-left'):
