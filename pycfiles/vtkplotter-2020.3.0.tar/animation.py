...
# [GCC 8.4.0]
# Embedded file name: /home/musy/Projects/vtkplotter/vtkplotter/animation.py
# Compiled at: 2020-03-21 21:46:46
...
class Animation(Plotter):
    ...
    def __init__(self, totalDuration=None, timeResolution=0.02, showProgressBar=True, videoFileName='animation.mp4', videoFPS=12):
    ...
    def meshErode(self, act=None, corner=6, t=None, duration=None):
        ...
        if self.bookingMode:
            ...
            for tt in rng:
                ...
                if d > 0:
                    ids = acts[0].closestPoint(corners[corner], radius=d, returnIds=True)
                    if len(ids) <= acts[0].N():
