...
# Compiled at: 2020-05-01 18:11:26
...
class Volume(vtk.vtkVolume, ActorBase):
    ...
    def __init__(self, inputobj=None, c=('r', 'y', 'lg', 'lb', 'b'), alpha=(0.0, 0.0, 0.5, 0.8, 1.0), alphaGradient=None, mode=0, origin=None, spacing=None, shape=None, mapperType='smart'):
