...
# [GCC 8.4.0]
# Embedded file name: /elicit/commands.py
# Compiled at: 2018-11-11 22:31:41
# Size of source mod 2**32: 10898 bytes
"""
...
"""
__all__ = [
 'BaseCommands', 'ObjectCommands']
import sys, textwrap, functools, readline
...
class BaseCommands:
    ...
    def printf(self, arguments):
        r"""Print the arguments formatted.
        ...
        args, kwargs = evaluate_arguments(arguments['<args>'], self._get_namespace())
    ...
    def printenv(self, arguments):
        ...
        if not names:
            ...
            for name in names:
                ...
                if not self._ui.write('{:{maxsize}s} = {}\n'.format(name,
                  (repr(value)), maxsize=ms)):
                    break
...
class ObjectCommands(BaseCommands):
    __doc__ = 'Commands that wraps an object with methods that commands may call.\n    '
