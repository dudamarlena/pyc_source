...
# [GCC 8.4.0]
# Embedded file name: /elicit/debugger.py
# Compiled at: 2018-12-25 21:26:12
# Size of source mod 2**32: 46713 bytes
"""Debugger that can be used instead of the pdb module.
"""
import sys, os, linecache, bdb, dis, code, re, readline, inspect, traceback
...
def checkline--- This code section failed: ---
 ...
 L. 121       122  LOAD_CONST               0
              124  STORE_FAST               'brackets'

 L. 122       126  SETUP_LOOP          330  'to 330'
            128_0  COME_FROM           322  '322'
            128_1  COME_FROM           310  '310'

 L. 123       128  LOAD_CONST               0
              130  STORE_FAST               'skipone'

 L. 124       132  SETUP_LOOP          248  'to 248'
              134  LOAD_FAST                'line'
              136  GET_ITER         
 ...
 L. 138       228  LOAD_FAST                'c'
              230  LOAD_CONST               (')', '}', ']')
              232  COMPARE_OP               in
              234  POP_JUMP_IF_FALSE   138  'to 138'

 L. 139       236  LOAD_FAST                'brackets'
              238  LOAD_CONST               1
              240  BINARY_SUBTRACT  
 ...
 L. 140       248  LOAD_FAST                'lineno'
              250  LOAD_CONST               1
              252  BINARY_ADD       
              254  STORE_FAST               'lineno'

 L. 141       256  LOAD_GLOBAL              linecache
...
class Debugger(bdb.Bdb):
 ...
 L. 352        24  LOAD_FAST                'exc_traceback'
