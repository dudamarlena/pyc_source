...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/nosedbreport/base.py
# Compiled at: 2014-02-26 22:25:53
import logging, os, traceback, sys, pprint
...
class NoseDBReporterBase(Plugin):
    ...
    def startTest(self, test):
        ...
        self.test_case_results[test_id] = {'file_path': file_path, 
           'suite': suite, 
           'name': case, 
