...
# [GCC 8.4.0]
# Embedded file name: /home/timo/Desktop/projects/SBtab/pypi_installer/sbtab/sbtab2html.py
...
from . import misc
urns = [
 'obo.chebi', 'kegg.compound', 'kegg.reaction', 'obo.go', 'obo.sgd', 'biomodels.sbo', 'ec-code', 'kegg.orthology', 'uniprot']
...
def findDescriptions(def_file, def_delimiter, sbtype):
    ...
    for row in def_file.split('\n'):
        ...
        if len(splitrow) != len(columnrowspl):
            pass
        else:
            if row.startswith('!!'):
                pass
                ...
                if not string.capitalize(splitrow[2]) == string.capitalize(sbtype):
                    pass
                elif col_dsc and not splitrow[2].startswith('!'):
                    col2description[splitrow[0]] = splitrow[col_dsc]
