...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/libs/pyblish/validators/modeling/topology/nonmanifoldedges.py
...
class ValidateNonManifoldEdges(pyblish.api.InstancePlugin):
    ...
    def process(self, instance):
        ...
        if not nodes_to_check:
            ...
            assert not non_manifold_edges_found, 'Non-Manifold Edges in the following components: {}'.format(non_manifold_edges_found)
