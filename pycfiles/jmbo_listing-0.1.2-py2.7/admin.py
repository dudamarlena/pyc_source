...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/listing/admin.py
...
class ListingAdminForm(forms.ModelForm):
    ...
    class Meta:
        model = Listing
        fields = ('title', 'slug', 'subtitle', 'content_types', 'categories', 'tags',
    ...
    def __init__(self, *args, **kwargs):
        ...
        for kls in LISTING_CLASSES:
            ...
            image_markup = ''
            if image_path:
                image_markup = '<img src="%s%s" style="max-width: 128px;" />' % (
