...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/listing/templatetags/listing_tags.py
# Compiled at: 2017-08-30 08:20:30
import types
...
def listing(parser, token):
    ...
    length = len(tokens)
    if length < 2:
        raise template.TemplateSyntaxError('listing tag requires at least argument slug or queryset')
