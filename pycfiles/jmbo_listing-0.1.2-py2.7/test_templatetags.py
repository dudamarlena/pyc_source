...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/listing/tests/test_templatetags.py
...
def set_image(obj):
    obj.image.save(os.path.basename(IMAGE_PATH), ContentFile(open(IMAGE_PATH, 'rb').read()))
...
class TemplateTagsTestCase(TestCase):
    ...
    def common(self, style, category=False):
        ...
        listing.save()
        t = template.Template("{% load listing_tags %}{% listing 'listing-" + l + "' %}")
