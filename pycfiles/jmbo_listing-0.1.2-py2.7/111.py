...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/listing/tests/settings/111.py
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql_psycopg2', 
               ...
               'HOST': '', 
               'PORT': ''}}
INSTALLED_APPS = ('listing.tests', 'listing', 'jmbo', 'photologue', 'category', 'django_comments',
                  'layers', 'likes', 'pagination', 'preferences', 'rest_framework',
