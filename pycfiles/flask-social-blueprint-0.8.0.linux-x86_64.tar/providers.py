...
# [GCC 8.4.0]
# Embedded file name: /data/venvs/flask-social-blueprint/lib/python2.7/site-packages/flask_social_blueprint/providers.py
# Compiled at: 2018-09-07 10:03:22
from importlib import import_module
import logging
from flask_oauth import OAuthRemoteApp
from flask_babel import gettext as _
DEFAULT_PROPERTIES = ('user_id', 'display_name', 'first_name', 'last_name', 'email',
                      'image_url')
...
class Twitter(BaseProvider):
    ...
    def get_profile(self, raw_data):
        ...
        import twitter
        api = twitter.Api(consumer_key=self.consumer_key, consumer_secret=self.consumer_secret, access_token_key=raw_data['oauth_token'], access_token_secret=raw_data['oauth_token_secret'], cache=None)
...
class Google(BaseProvider):
    ...
    def get_profile(self, raw_data):
        ...
        import oauth2client.client as googleoauth, apiclient.discovery as googleapi, httplib2
        credentials = googleoauth.AccessTokenCredentials(access_token=access_token, user_agent='')
        http = httplib2.Http()
