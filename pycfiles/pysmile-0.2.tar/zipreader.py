...
# Embedded file name: build/bdist.linux-x86_64/egg/pysmi/reader/zipreader.py
# Compiled at: 2019-04-14 06:02:40
import os, sys, time, datetime, zipfile
    ...
    *ZipReader* class instance tries to locate ASN.1 MIB files
    ...
    def getData(self, mibname, **options):
        ...
        for (mibalias, mibfile) in self.getMibVariants(mibname, **options):
            ...
            return (
             MibInfo(path='zip://%s/%s' % (self._name, mibfile), file=mibfile, name=mibalias, mtime=mtime), decode(mibData))
