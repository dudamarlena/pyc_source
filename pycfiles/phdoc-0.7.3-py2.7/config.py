...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/phdoc/config.py
# Compiled at: 2013-09-24 11:14:27
"""Utilities for working with Markdoc configurations."""
import copy, os, os.path as p, yaml, phdoc.exc
...
class ConfigMeta(type):
    ...
    def func_default_for(cls, key):
        ...
        return lambda function: [
         cls.register_func_default(key, function),
         function][1]
...
def flatten(dictionary, keys=None, prefix=''):
    ...
    Flatten selected keys of nested dictionaries into dotted keys.
        ...
        [('a.b', 1), ('a.c.d', 2), ('a.c.e.f', 3), ('g', 4), ('h', {'i': 5})]
    """
        ...
        if not isinstance(value, dict):
            ...
            for key2 in value.keys():
                ...
                if not isinstance(value2, dict):
                    ...
                    dictionary.update(flatten(value2, prefix=prefix + key + '.' + key2 + '.'))
