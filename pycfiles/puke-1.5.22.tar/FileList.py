...
# [GCC 8.4.0]
# Embedded file name: puke/FileList.py
# Compiled at: 2012-07-05 15:21:23
import os, logging, fnmatch, re, hashlib
...
class FileList:
    ...
    def __explore(self, dir):
        ...
        for file in sorted([ file for file in os.listdir(dir) if file not in ('.',
                                                                              '..') ]):
