...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\phaseshifts\atorb.py
# Compiled at: 2014-07-07 15:47:33
"""
**atorb.py**
...
class Atorb(object):
    ...
    def replace_core_config(electron_config):
        ...
        """
        cores = {'[He]': '1s2', '[Ne]': '1s2 2s2 2p6', '[Ar]': '1s2 2s2 2p6 3s2 3p6', 
           '[Kr]': '1s2 2s2 2p6 3s2 3p6 3d10 4s2 4p6', 
           '[Xe]': '1s2 2s2 2p6 3s2 3p6 3d10 4s2 4p6 5s2 4d10 5p6', 
           '[Rn]': '1s2 2s2 2p6 3s2 3p6 3d10 4s2 4p6 5s2 4d10 5p64f14 5d10 6s2 6p6'}
    ...
    def calculate_Q_density(**kwargs):
        ...
        lines = [ line.replace('\n', '').replace('\r', '').lstrip(' ').split('!')[0].split('#')[0].rstrip(' ') for line in lines
                ]
