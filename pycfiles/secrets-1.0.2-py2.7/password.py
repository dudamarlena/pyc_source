...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/secrets/password.py
# Compiled at: 2015-12-23 04:10:11
"""
Classes to change password on LDAP servers configured
in SecretsConfig
"""
import base64, ldap, string, random
...
class PasswordService(object):
    ...
    def change_password(self, username, new, bind_password, admin=False):
        ...
        except ldap.FILTER_ERROR as emsg:
        ...
        except ldap.INVALID_CREDENTIALS as emsg:
