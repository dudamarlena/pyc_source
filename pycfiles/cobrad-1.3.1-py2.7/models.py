...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/app/models.py
# Compiled at: 2016-08-05 04:20:33
import time
...
class CobraTaskInfo(db.Model):
    ...
    def __init__(self, target, branch, scan_way, new_version, old_version, time_consume, time_start, time_end, file_count, code_number, status, created_at, updated_at):
        self.target = target
        self.branch = branch
