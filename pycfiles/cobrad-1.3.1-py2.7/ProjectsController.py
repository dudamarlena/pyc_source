...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/app/controller/backend/ProjectsController.py
# Compiled at: 2016-08-01 01:36:50
import time
...
def edit_project(project_id):
    ...
    if request.method == 'POST':
        ...
        project = CobraProjects.query.filter_by(id=project_id).first()
        return render_template('backend/project/edit_project.html', data={'project': project})