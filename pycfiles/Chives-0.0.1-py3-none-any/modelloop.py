...
# Embedded file name: build\bdist.win32\egg\chitwanabm\modelloop.py
# Compiled at: 2013-02-23 22:47:47
...
import os, time, copy, logging, numpy as np
...
def main_loop(world, results_path):
    ...
    for neg_timestep in xrange(-rcParams['model.burnin_timesteps'], 0):
        for region in world.iter_regions():
            if rcParams['submodels.migration_individual']:
                ...
                new_out_migr_indiv, new_ret_migr_indiv = zero_events, zero_events
    ...
    while model_time.in_bounds():
        ...
        if model_time.get_cur_month() == 12 or model_time.is_last_iteration() and model_time.get_cur_date() != model_time._starttime:
