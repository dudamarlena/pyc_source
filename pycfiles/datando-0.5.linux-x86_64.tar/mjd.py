...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/datando/mjd.py
# Compiled at: 2013-03-13 10:30:44
import re
...
class MJDDateTime(CalendarBase):
    ...
    def parse(cls, date_string):
        reg_expr = '^MJD \\\\ (?P<sign>\\+|\\-){0,1}(?P<day>\\d+).(?P<fraction>\\d{1,20})$'
