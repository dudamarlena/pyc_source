...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/datando/julian.py
# Compiled at: 2013-06-16 15:13:23
import re
...
class JulianDateTime(CalendarBase):
    ...
    def parse(cls, date_string):
        reg_expr = '^Julian \\\\ ((?P<style>[a-zA-Z_ ]*) \\\\)* (?P<sign>\\+|\\-){0,1}(?P<year>\\d*)\\-(?P<month>\\d{2})-(?P<day>\\d{2}) T (?P<hh>\\d{2}):(?P<mm>\\d{2}):(?P<ss>\\d{2})\\.(?P<ms>\\d{6})$'
