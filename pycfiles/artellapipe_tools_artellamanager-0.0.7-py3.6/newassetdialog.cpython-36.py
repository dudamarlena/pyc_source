...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/artellamanager/widgets/newassetdialog.py
...
class ArtellaNewAssetDialog(dialog.ArtellaDialog, object):
    ...
    def __init__(self, project, asset_path, parent=None):
        ...
        super(ArtellaNewAssetDialog, self).__init__(name='ArtellaNewAssetDialog',
    ...
    def _create_new_asset(self, data=None):
        ...
        if not asset_name:
            ...
            valid_create = self._project.create_asset_in_artella(asset_name,
              (self._asset_path), folders_to_create=folders_to_create)
            return valid_create
