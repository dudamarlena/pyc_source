...
# [GCC 8.4.0]
# Embedded file name: /home/sch/prj/pytigon/pytigon/appdata/plugins/standard/keymap/editor.py
# Compiled at: 2019-12-08 13:54:45
# Size of source mod 2**32: 4520 bytes
import wx
from pytigon_lib.schtools.tools import extend_fun_to

def init_control(ctrl):
    if 'keymap' in ctrl.param:
        if ctrl.param['keymap'] == 'standard':
