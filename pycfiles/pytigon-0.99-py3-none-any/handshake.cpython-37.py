...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-76h68wr6/websockets/websockets/handshake.py
...
"""
import base64, binascii, hashlib, random
...
def check_response(headers: Headers, key: str) -> None:
    ...
    try:
        ...
        raise InvalidHeader('Sec-WebSocket-Accept', 'more than one Sec-WebSocket-Accept header found')
