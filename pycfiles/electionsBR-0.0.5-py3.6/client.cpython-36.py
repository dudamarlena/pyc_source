...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\electionsBR\backend\client.py
# Compiled at: 2020-01-27 20:24:50
# Size of source mod 2**32: 2392 bytes
import time, io, pandas as pd, requests
...
def _request_csv(url, params):
    response = requests.get(url, params, headers={'Accept': 'text/csv'})
