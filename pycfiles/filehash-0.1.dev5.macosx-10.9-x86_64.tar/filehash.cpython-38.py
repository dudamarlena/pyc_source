...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/3.8/lib/python3.8/site-packages/filehash/filehash.py
# Compiled at: 2019-12-27 22:41:44
# Size of source mod 2**32: 11495 bytes
import abc, collections, glob, hashlib, os, os.path, zlib
...
class Adler32(ZlibHasherBase):
    ...
    def update(self, arg):
        ...
        :param arg: String to update the digest with.
        """
        self._digest = zlib.adler32(arg, self._digest) & 4294967295
...
class CRC32(ZlibHasherBase):
    ...
    def update(self, arg):
        ...
        :param arg: String to update the digest with.
        """
        self._digest = zlib.crc32(arg, self._digest) & 4294967295
...
_ALGORITHM_MAP = {'adler32':Adler32, 
 'crc32':CRC32, 
 'md5':hashlib.md5, 
 'sha1':hashlib.sha1, 
