...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/kipp/utils/concurrents.py
...
from concurrent.futures import Future, ThreadPoolExecutor as OriginThreadPoolExecutor, ProcessPoolExecutor as OriginProcessPoolExecutor
