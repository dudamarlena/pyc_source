...
class MultiEvent(Event):
    ...
    def __init__(self, n_workers=1):
        ...
        """
        try:
            assert isinstance(n_workers, int), b'MultiEvent(n_workers) should be integer'
            assert n_workers >= 1, b'MultiEvent(n_workers) should greater than 1'
