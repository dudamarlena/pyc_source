...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/distribute_setup.py
# Compiled at: 2013-12-12 18:52:25
...
"""
import os, shutil, sys, time, fnmatch, tempfile, tarfile, optparse
...
def _parse_args():
    ...
    parser.add_option('--download-base', dest='download_base', metavar='URL', default=DEFAULT_URL, help='alternative URL from where to download the distribute package')
