...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\baker\secret.py
# Compiled at: 2018-05-14 15:33:56
...
class SecretKey:
    ...
    def generate(key_pass):
        ...
        logger.log("Generated secret key '{0}' and saved at '{1}'".format(secret_store, settings.get('STORAGE_KEY_PATH')))
        return secret_store
