...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\baker\cli.py
# Compiled at: 2018-11-12 14:55:22
...
class Parser:
    ...
    def _build_cli(commands):
        ...
        subparsers = parser.add_subparsers(title='commands', metavar='<COMMAND>', help=help_commands)
        ...
        recipes.add_argument('-a', '--all', action='store_true', help='list all details of recipes locally ')
