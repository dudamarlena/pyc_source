...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/easy_kubernetes/kubernetes.py
# Compiled at: 2019-01-14 13:12:36
# Size of source mod 2**32: 16895 bytes
...
class core:
    ...
    def get_namespace(self, namespace: str=None):
        host = '{0}/api/v1/namespaces/{1}'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_namespaces(self):
        host = '{0}/api/v1/namespaces'.format(self._core__get_url())
        return (self, host, self.token, None)
    ...
    def get_pod(self, namespace: str=None, pod: str=None):
        host = '{0}/api/v1/namespaces/{1}/pods/{2}'.format(self._core__get_url(), namespace, pod)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_pods(self, namespace: str=None):
        host = '{0}/api/v1/namespaces/{1}/pods'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)
    ...
    def get_ingress(self, namespace: str=None, ingress: str=None):
        host = '{0}/apis/extensions/v1beta1/namespaces/{1}/ingresses/{2}'.format(self._core__get_url(), namespace, ingress)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_ingresses(self, namespace: str=None):
        host = '{0}/apis/extensions/v1beta1/namespaces/{1}/ingresses'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)
    ...
    def get_service(self, namespace: str=None, service: str=None):
        host = '{0}/api/v1/namespaces/{1}/services/{2}'.format(self._core__get_url(), namespace, service)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_services(self, namespace: str=None):
        host = '{0}/api/v1/namespaces/{1}/services'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)
    ...
    def get_configmap(self, namespace: str=None, configmap: str=None):
        host = '{0}/api/v1/namespaces/{1}/configmaps/{2}'.format(self._core__get_url(), namespace, configmap)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_configmaps(self, namespace: str=None):
        host = '{0}/api/v1/namespaces/{1}/configmaps'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)
    ...
    def get_secret(self, namespace: str=None, secret: str=None):
        host = '{0}/api/v1/namespaces/{1}/secrets/{2}'.format(self._core__get_url(), namespace, secret)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_secrets(self, namespace: str=None):
        host = '{0}/api/v1/namespaces/{1}/secrets'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)
    ...
    def get_deployment(self, namespace: str=None, deployment: str=None):
        host = '{0}/apis/apps/v1/namespaces/{1}/deployments/{2}'.format(self._core__get_url(), namespace, deployment)
        return (self, host, self.token, None)

    @api_comunicator('get')
    def get_deployments(self, namespace: str=None):
        host = '{0}/apis/apps/v1/namespaces/{1}/deployments'.format(self._core__get_url(), namespace)
        return (self, host, self.token, None)
    ...
    def delete_deployment(self, namespace: str=None, pod: str=None, payload: dict=None):
        host = '{0}/apis/apps/v1/namespaces/{1}/deployments/{2}'.format(self._core__get_url(), namespace, pod)
        return (self, host, self.token, payload)