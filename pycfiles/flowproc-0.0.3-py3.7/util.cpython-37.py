...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/flowproc/util.py
# Compiled at: 2019-08-04 13:46:14
...
"""
import functools, logging, socket, time
...
def stopwatch(fn):
    ...
    def wrapper(*args, **kwargs):
        ...
        if logger:
            logger.debug("{elapsed:4d} msec elapsed in '{name}'".format(elapsed=(int(round(msec, 1))),
...
def dstport_to_icmptc(dstport):
    ...
    """
    return (
     int(dstport / 256), dstport % 256)


ICMPTEXT = {(0, 0):'Echo Reply', 
 (3, 0):'Net Unreachable', 
