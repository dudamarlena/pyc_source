...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-hbx1i2h0/pip/pip/_vendor/html5lib/_ihatexml.py
# Compiled at: 2020-04-16 14:32:34
# Size of source mod 2**32: 16705 bytes
...
class InfosetFilter(object):
    ...
    def coerceAttribute(self, name, namespace=None):
        if self.dropXmlnsLocalName:
            if name.startswith('xmlns:'):
                warnings.warn('Attributes cannot begin with xmlns', DataLossWarning)
                return
        if self.dropXmlnsAttrNs:
    ...
    def coercePubid(self, data):
        ...
        if self.preventSingleQuotePubid:
            if dataOutput.find("'") >= 0:
