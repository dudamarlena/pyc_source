...
# [GCC 8.4.0]
# Embedded file name: /tmp/src/fmriprep/wrapper/build/lib/python3.7/hashlib.py
# Compiled at: 2019-09-12 11:41:56
# Size of source mod 2**32: 9534 bytes
                ...
                if name in ('SHA256', 'sha256', 'SHA224', 'sha224'):
                    ...
                    if name in ('SHA512', 'sha512', 'SHA384', 'sha384'):
                        ...
                        if name in ('blake2b', 'blake2s'):
                            ...
                            if name in {'sha3_384', 'shake_128', 'sha3_512', 'sha3_256', 'sha3_224', 'shake_256'}:
                                import _sha3
