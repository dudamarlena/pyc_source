...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/refreshbooks/transport.py
...
class TokenAuthorization(object):
    ...
    def __init__(self, token):
        ...
        base64_user_pass = base64.b64encode(token + ':').decode('US-ASCII')
        self.headers = {'Authorization': 'Basic %s' % (base64_user_pass,)}
