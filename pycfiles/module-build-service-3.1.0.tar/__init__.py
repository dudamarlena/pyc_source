...
# [GCC 8.4.0]
# Embedded file name: /home/breilly/git/fm-orchestrator/module_build_service/__init__.py
...
from module_build_service.errors import ValidationError, Unauthorized, UnprocessableEntity, Conflict, NotFound, Forbidden, json_error
...
def get_url_for(*args, **kwargs):
    ...
    with app.app_context():
        log.debug('WARNING: get_url_for() has been called without the Flask app_context. That can lead to SQLAlchemy errors caused by multiple session being used in the same time.')
        return url_for(*args, **kwargs)
