...
# [GCC 8.4.0]
# Embedded file name: /home/gyst/plonesocial.buildout/src/plonesocial.microblog/plonesocial/microblog/tests/test_statuscontainer_user.py
...
class TestStatusContainer_User(unittest.TestCase):
    ...
    def test_user_items_all(self):
        ...
        container.add(sc)
        values = [ x[1] for x in container.user_items(['arnold', 'bernard', 'cary'])
                 ]
    ...
    def test_user_items_limit(self):
        ...
        sc = StatusUpdate('test c', 'cary')
        container.add(sc)
        values = [ x[1] for x in container.user_items(['arnold', 'bernard', 'cary'], limit=2)
                 ]
    ...
    def test_user_items_some(self):
        ...
        sc = StatusUpdate('test c', 'cary')
        container.add(sc)
        values = [ x[1] for x in container.user_items(['arnold', 'bernard'])
                 ]
    ...
    def test_user_items_none(self):
        ...
        sc = StatusUpdate('test c', 'cary')
        container.add(sc)
        values = [ x for x in container.user_items(['zacharias'])
                 ]
