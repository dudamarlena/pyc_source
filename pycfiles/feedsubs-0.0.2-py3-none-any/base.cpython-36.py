...
# [GCC 8.4.0]
# Embedded file name: /home/nicolas/dev/feedpubsub/feedsubs/settings/base.py
# Compiled at: 2018-12-16 15:21:56
...
ACCOUNT_FORMS = {'signup': 'um.forms.SignupFormWithToS'}
loggers = {'': {'handlers':[
       'console'], 
      'level':'DEBUG'}}
info_loggers = ('django', 'spinach', 'PIL', 'botocore', 'boto3', 's3transfer', 'reader',
                'ddtrace')
for logger_name in info_loggers:
    if logger_name not in loggers:
        loggers[logger_name] = {'level': 'INFO'}

LOGGING = {'version':1,  'incremental':False, 
 'disable_existing_loggers':False, 
 'filters':{},  'formatters':{'default': {'format': '[%(asctime)s %(levelname)-5.5s %(threadName)s %(name)s] %(message)s'}}, 
...
SPINACH_BROKER = RedisBroker(redis=(StrictRedis.from_url)(
 config('REDIS_SPINACH_URL', default='redis://'), **recommended_socket_opts))
