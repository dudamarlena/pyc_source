...
# [GCC 8.4.0]
# Embedded file name: /home/nicolas/dev/feedpubsub/reader/html_processing.py
# Compiled at: 2018-10-04 15:12:15
# Size of source mod 2**32: 4223 bytes
from logging import getLogger
from typing import Optional, List
import urllib.parse, bleach, bs4
from . import models
...
URL_REWRITE_PAIRS = (('a', 'href'), ('img', 'src'))
logger = getLogger(__name__)

def clean_article(content: str, base_url: str=None, replace_images: bool=True) -> str:
