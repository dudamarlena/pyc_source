...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jsonfield2/managers.py
# Compiled at: 2015-06-04 13:24:19
...
class JSONAwareQuerySet(models.query.QuerySet):
    ...
    def _evaluate_json_lookup(self, item, lookup, value):
        oper = 'exact'
        evaluators = {'icontains': lambda item, value: item.lower() in value.lower(), 
