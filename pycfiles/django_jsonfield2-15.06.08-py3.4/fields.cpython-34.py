...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jsonfield2/fields.py
# Compiled at: 2015-06-04 12:44:47
...
DB_TYPE_CACHE_KEY = 'django-jsonfield2:db-type:%s' % __version__ + '%(ENGINE)s:%(HOST)s:%(PORT)s:%(NAME)s'
...
class JSONField(six.with_metaclass(models.SubfieldBase, models.Field)):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.encoder_kwargs = {'indent': kwargs.pop('indent', getattr(settings, 'JSONFIELD_INDENT', None))}
    ...
    def get_prep_lookup(self, lookup_type, value):
        ...
        if lookup_type in ('contains', 'icontains'):
            if isinstance(value, (list, tuple)):
                ...
                return self.get_prep_value(value)[1:-1].replace(', ', '%')
