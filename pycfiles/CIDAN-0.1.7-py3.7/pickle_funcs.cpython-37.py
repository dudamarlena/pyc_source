...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/CIDAN/LSSC/functions/pickle_funcs.py
# Compiled at: 2020-03-28 16:29:23
...
def pickle_save(obj, name, trial_num=0, output_directory=None):
    ...
    if output_directory:
        ...
        if not os.path.isdir(dir_name):
            ...
            os.path.isdir(dir_full_path) or os.mkdir(dir_full_path)
