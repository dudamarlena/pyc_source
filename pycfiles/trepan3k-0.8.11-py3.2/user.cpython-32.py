...
# Compiled at: 2018-07-28 14:10:38
...
class UserInterface(Minterface.TrepanInterface):
 ...
 L.  88         0  LOAD_FAST                'default'
                3  POP_JUMP_IF_FALSE    19  'to 19'

 L.  89         6  LOAD_FAST                'prompt'
                9  LOAD_STR                 '? (Y or n) '
               12  INPLACE_ADD      
 ...
 L.  91        19  LOAD_FAST                'prompt'
               22  LOAD_STR                 '? (N or y) '
               25  INPLACE_ADD      
               26  STORE_FAST               'prompt'
             29_0  COME_FROM            16  '16'

 L.  93        29  SETUP_LOOP          142  'to 142'

 L.  94        32  SETUP_EXCEPT         72  'to 72'

 L.  95        35  LOAD_FAST                'self'
               38  LOAD_ATTR                readline
               41  LOAD_FAST                'prompt'
               44  CALL_FUNCTION_1       1  '1 positional, 0 named'
               47  STORE_FAST               'reply'

 L.  96        50  LOAD_FAST                'reply'
               53  LOAD_ATTR                strip
 ...
 L.  99        94  LOAD_FAST                'reply'
               97  LOAD_CONST               ('y', 'yes')
              100  COMPARE_OP               in
              103  POP_JUMP_IF_FALSE   110  'to 110'

 L. 100       106  LOAD_CONST               True
              109  RETURN_END_IF    

 L. 101       110  LOAD_FAST                'reply'
              113  LOAD_CONST               ('n', 'no')
              116  COMPARE_OP               in
              119  POP_JUMP_IF_FALSE   126  'to 126'

 L. 102       122  LOAD_CONST               False
              125  RETURN_END_IF    

 L. 104       126  LOAD_FAST                'self'
              129  LOAD_ATTR                msg
              132  LOAD_STR                 'Please answer y or n.'
              135  CALL_FUNCTION_1       1  '1 positional, 0 named'
              138  POP_TOP          

 L. 106       139  CONTINUE             32  'to 32'
            142_0  COME_FROM_LOOP       29  '29'

 L. 107       142  LOAD_FAST                'default'
              145  RETURN_VALUE     
               -1  RETURN_LAST      
