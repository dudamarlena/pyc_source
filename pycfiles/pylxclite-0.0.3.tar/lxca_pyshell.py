...
# Size of source mod 2**32: 68683 bytes
...
@example 
    ...
    con = None
    long_short_key_map = {'uuid':'u', 
     'chassis':'c',  'status':'s',  'modify':'m',  'metrics':'x'}
    keylist = ['con', 'uuid', 'chassis', 'status', 'modify', 'metrics']
...
@example
    ...
    con = None
    long_short_key_map = {'id':'i', 
     'name':'n',  'endpoint':'e',  'restart':'r',  'powerdown':'p', 
     'force':'f'}
...
@example
    ...
    command_name = sys._getframe().f_code.co_name
    long_short_key_map = {'uuid':'u', 
     'name':'n',  'description':'d',  'type':'t',  'solutionVPD':'s',  'members':'m', 
     'criteria':'c'}
    keylist = [
    ...
    for key in keylist:
        ...
        if key in list(kwargs.keys()):
            ...
            if key in param_dict:
                ...
                if short_key:
                    if short_key in list(kwargs.keys()):
        ...
        if len(arglist) >= 1:
            ...
            if key == 'con' and key in param_dict:
...
@example
    ...
    con = None
    long_short_key_map = {'id':'i', 
     'query_solutionGroups':'q',  'solutionGroups':'s', 
