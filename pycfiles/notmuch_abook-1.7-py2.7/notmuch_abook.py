...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/notmuch_abook/notmuch_abook.py
# Compiled at: 2015-08-24 13:40:52
"""
...
import os, re, sys, docopt, notmuch, sqlite3, email.utils, email.parser
from io import open
    ...
    def create(self):
        ...
        if os.path.exists(self.__path):
            ...
            with sqlite3.connect(self.__path) as (c):
                ...
                cur.executescript('CREATE TRIGGER insert_into_ab ' + 'INSTEAD OF INSERT ON AddressBookView ' + 'BEGIN' + " SELECT RAISE(ABORT, 'column name is not unique')" + '   FROM addressbook' + '  WHERE address = new.address;' + ' INSERT INTO addressbook VALUES(new.name, new.address);' + 'END;')
