...
# Embedded file name: build/bdist.linux-x86_64/egg/comdutils/math_utils.py
# Compiled at: 2019-10-24 10:08:49
    ...
    def __init__(self, image_shape, lines, decay=0.001):
        ...
        for idx, i in enumerate(self.line_points):
            ...
            for j in range(delta):
                ...
                new_points.append([i[0], new_y])

        self.line_points = self.line_points + new_points
