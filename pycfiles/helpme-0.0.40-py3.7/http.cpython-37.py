...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/helpme/main/base/http.py
# Compiled at: 2019-12-18 16:20:38
...
import shutil, requests, tempfile, json, sys, re, os
...
def get(self, url, headers=None, token=None, data=None, return_json=True, default_headers=True, quiet=False):
...
def call(self, url, func, data=None, headers=None, return_json=True, stream=False, retry=True, default_headers=True, quiet=False):
