...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/helpme/logger/message.py
# Compiled at: 2019-12-18 16:19:36
# Size of source mod 2**32: 9694 bytes
"""
...
def get_user_color_preference():
    COLORIZE = os.environ.get('HELPME_COLORIZE', None)
    if COLORIZE is not None:
