...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/astrocalc/coords/separations.py
...
class separations(object):
    ...
    **Usage**
    ...
    def __init__(self, log, ra1, dec1, ra2, dec2, settings=False):
        self.log = log
    ...
    def get(self):
        ...
        **Return**
        ...
        for v in vals:
            thisLen = len(repr(v * 3600.0).split('.')[(-1)])
        ...
        east = -(ra1 - ra2) * math.cos((dec1 + dec2) * DEG_TO_RAD_FACTOR / 2.0) * 3600.0
