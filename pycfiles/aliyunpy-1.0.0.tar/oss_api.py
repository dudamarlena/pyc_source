...
# Embedded file name: /home/vagrant/virtualenv/oss/lib/python2.7/site-packages/oss/oss_api.py
...
class OssAPI:
    ...
    def copy_object_as_part(self, source_bucket, source_object, target_bucket, target_object, upload_id, part_number, headers=None, params=None):
        """
