...
# [GCC 8.4.0]
# Embedded file name: /home/dnavarro/repos/django-leads/leads/admin.py
# Compiled at: 2014-02-26 09:54:23
import csv
...
class RegisterAdmin(admin.ModelAdmin):
    fields = [
     'email', 'name', 'created_on', 'modified_on']
...
class NewsletterAdmin(admin.ModelAdmin):
    fields = [
     'subject', 'from_name', 'from_address', 'html_file']
    readonly_fields = ('created_on', 'modified_on')
    ...
    def send(self, request, queryset):
        ...
        for obj in queryset:
            ...
            msg = EmailMultiAlternatives(subject=obj.subject, body='', from_email=('{from_name} <{from_email}>').format(from_name=obj.from_name, from_email=obj.from_address))
