...
class AnnotatorProperties(Params):
    ...
    lazyAnnotator = Param((Params._dummy()), 'lazyAnnotator',
...
class HasEmbeddingsProperties(Params):
    dimension = Param((Params._dummy()), 'dimension',
...
class HasExcludableStorage:
    includeStorage = Param((Params._dummy()), 'includeStorage',
...
class HasStorage(HasStorageRef, HasCaseSensitiveProperties, HasExcludableStorage):
    storagePath = Param((Params._dummy()), 'storagePath',
      'path to file',
