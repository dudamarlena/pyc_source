...
# [GCC 8.4.0]
# Embedded file name: /Users/maziyar/Desktop/Work/JohnSnowLabs/spark-nlp/python/build/lib/sparknlp/base.py
# Compiled at: 2020-05-06 10:55:08
# Size of source mod 2**32: 14057 bytes
from abc import ABC
...
class LightPipeline:
    ...
    def _annotation_from_java(java_annotations):
        ...
        for annotation in java_annotations:
            annotations.append(Annotation(annotation.annotatorType(), annotation.begin(), annotation.end(), annotation.result(), annotation.metadata(), annotation.embeddings))
        ...
        for i, stage in enumerate(stages):
            if i <= indexOfLastEstimator:
                if isinstance(stage, Transformer):
                    ...
                    if isinstance(stage, RecursiveEstimator):
    ...
    def _transform(self, dataset):
        for t in self.stages:
            if isinstance(t, HasRecursiveTransform):
                ...
                if isinstance(t, AnnotatorProperties):
                    if t.getLazyAnnotator():
                        continue
...
class DocumentAssembler(AnnotatorTransformer):
    ...
    def setCleanupMode(self, value):
        if value.strip().lower() not in ('disabled', 'inplace', 'inplace_full', 'shrink',
                                         'shrink_full', 'each', 'each_full', 'delete_full'):
...
class Finisher(AnnotatorTransformer):
    ...
    def __init__(self):
        ...
        self._setDefault(cleanAnnotations=True,
...
class EmbeddingsFinisher(AnnotatorTransformer):
    ...
    def __init__(self):
        ...
        self._setDefault(cleanAnnotations=False,
