...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagentvirtualmachinevnc/__init__.py
...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [
     {'info': vnc.TNArchipelVNC.plugin_info(), 'plugin': vnc.TNArchipelVNC(configuration, entity, group)}]
...
def version():
    ...
    return (
     __name__, pkg_resources.get_distribution('archipel-agent-virtualmachine-vnc').version, [vnc.TNArchipelVNC.plugin_info()])