...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pywidl/model.py
# Compiled at: 2012-03-25 04:13:06
...
class Attribute(InterfaceMember):
    ...
    def __init__(self, stringifier=False, inherit=False, readonly=False, type=None, **kwargs):
...
class Operation(InterfaceMember):
    ...
    def __init__(self, stringifier=None, return_type=None, arguments=[], static=False, getter=False, setter=False, creator=False, deleter=False, legacycaller=False, **kwargs):
...
class OperationArgument(object):
    ...
    def __init__(self, type=None, name=None, optional=False, default=None, ellipsis=False, extended_attributes=[]):
...
class DictionaryMember(object):
    ...
    def __init__(self, type=None, name=None, default=None, extended_attributes=[]):
