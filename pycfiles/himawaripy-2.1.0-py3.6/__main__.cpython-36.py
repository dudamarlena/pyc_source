...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/himawaripy/__main__.py
# Compiled at: 2019-04-24 17:00:49
# Size of source mod 2**32: 7381 bytes
import argparse
from datetime import timedelta, datetime
import io, itertools as it, json, multiprocessing as mp, multiprocessing.dummy as mp_dummy, os, os.path as path, sys
from time import strptime, strftime, mktime
import urllib.request
from glob import iglob, glob
import threading, time, subprocess, appdirs
...
def parse_args():
    parser = argparse.ArgumentParser(description='set (near-realtime) picture of Earth as your desktop background', epilog='http://labs.boramalper.org/himawaripy')
    ...
    parser.add_argument('--output-dir', type=str, dest='output_dir', help='directory to save the temporary background image',
