...
# [GCC 8.4.0]
# Embedded file name: /home/jlopes/PycharmProjects/mcg/core/ModelGenerator.py
...
class ModelGenerator(Generator):
    ...
    def generate(self):
        ...
        model_file.write('}\n\n')
        model_file.write('export const ' + self.data['name'] + ' = new ' + self.data['name'].title() + "Collection('" + self.data['name'] + "');")
        model_file.close()