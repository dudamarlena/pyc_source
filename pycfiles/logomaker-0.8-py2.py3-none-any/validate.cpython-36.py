...
def validate_matrix(df, matrix_type=None, allow_nan=False):
    ...
    out_df = df.copy()
    check(matrix_type in frozenset({'probability', 'information', None}), 'matrix_type = %s; must be None, "probability", or "information"' % matrix_type)
