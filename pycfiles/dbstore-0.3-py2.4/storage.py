...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dbstore/storage.py
# Compiled at: 2006-10-25 13:49:45
...
class DBSessionStore(SessionStore):
    ...
    _update = "update sessions set pickle = '%s', touched = '%s'                where id = '%s'"
    ...
    def _saveSession(self, session):
        ...
        s = pickle.dumps(session, protocol=self.pickle_protocol)
        s = self._escape(s)
