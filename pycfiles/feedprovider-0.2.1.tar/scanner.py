...
# [GCC 8.4.0]
# Embedded file name: /home/bart/feedprovider/tune/console/simplejson/scanner.py
...
def py_make_scanner(context):
    ...
    def _scan_once(string, idx):
        ...
        if nextchar == '"':
            ...
            if nextchar == '{':
                return parse_object((string, idx + 1), encoding, strict, _scan_once, object_hook, object_pairs_hook, memo)
            if nextchar == '[':
