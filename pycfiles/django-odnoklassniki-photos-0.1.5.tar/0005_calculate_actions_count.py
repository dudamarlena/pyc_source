...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-odnoklassniki-photos/odnoklassniki_photos/migrations/0005_calculate_actions_count.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute('UPDATE odnoklassniki_photos_photo SET actions_count = likes_count + comments_count;')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'odnoklassniki_photos.album': {'Meta': {'object_name': 'Album'}, 'created': (
                                      ...
                                      'owner_content_type': (
                                                           'django.db.models.fields.related.ForeignKey', [], {'related_name': "'odnoklassniki_albums_owners'", 'to': "orm['contenttypes.ContentType']"}), 
                                      'owner_id': (
                                      ...
                                      'updated': (
                                                'django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'})}, 
       'odnoklassniki_photos.photo': {'Meta': {'object_name': 'Photo'}, 'actions_count': (
                                                      'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                      'album': (
                                              'django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['odnoklassniki_photos.Album']"}), 
                                      'comments_count': (
                                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                      'created': (
                                                'django.db.models.fields.DateTimeField', [], {'null': 'True'}), 
                                      ...
                                      'last_like_date': (
                                                       'django.db.models.fields.DateTimeField', [], {'null': 'True'}), 
                                      'like_users': (
                                                   'm2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'like_photos'", 'symmetrical': 'False', 'to': "orm['odnoklassniki_users.User']"}), 
                                      'likes_count': (
                                                    'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                      'owner_content_type': (
                                                           'django.db.models.fields.related.ForeignKey', [], {'related_name': "'odnoklassniki_photos_owners'", 'to': "orm['contenttypes.ContentType']"}), 
                                      'owner_id': (
                                                 'django.db.models.fields.BigIntegerField', [], {'db_index': 'True'}), 
                                      'owner_name': (
                                                   'django.db.models.fields.TextField', [], {}), 
