...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-odnoklassniki-photos/odnoklassniki_photos/models.py
# Compiled at: 2015-11-07 15:01:13
...
class Album(OdnoklassnikiPKModel):
    ...
    class Meta:
        verbose_name = 'Альбом фотографий Одноклассники'
        verbose_name_plural = 'Альбомы фотографий Одноклассники'
    ...
    remote = AlbumRemoteManager(methods={'get': 'getAlbums', 
    ...
    def parse(self, response):
        ...
        if response.get('like_summary'):
            ...
            try:
                value = datetime.utcfromtimestamp(int(summary['last_like_date_ms']) / 1000).replace(tzinfo=timezone.utc)
            except:
                value = None
...
class PhotoRemoteManager(OdnoklassnikiTimelineManager):
    ...
    def get(self, **kwargs):
        ...
        return (
         super(PhotoRemoteManager, self).get(**kwargs), self.response)
...
class Photo(OdnoklassnikiPKModel):
    ...
    class Meta:
        verbose_name = 'Фотография Одноклассники'
        verbose_name_plural = 'Фотографии Одноклассники'
    ...
    remote = PhotoRemoteManager(methods={'get': 'getPhotos', 
