...
# [GCC 8.4.0]
# Embedded file name: /home/adammck/projects/djtables/example/djtables/column.py
# Compiled at: 2011-04-01 15:59:34
import datetime
...
class Column(object):
    ...
    def bind_to(self, table, name):
        ...
        if self.bound_to is not None:
            raise AttributeError("Column is already bound to '%s' as '%s'" % self.bound_to)
...
class DateColumn(Column):
    ...
    def render(self, cell):
        return defaultfilters.date(self.value(cell), self._format)
