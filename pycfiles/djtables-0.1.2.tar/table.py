...
# [GCC 8.4.0]
# Embedded file name: /home/adammck/projects/djtables/example/djtables/table.py
# Compiled at: 2010-06-15 05:43:14
...
class Table(object):
    ...
    def __init__(self, object_list=None, request=None, **kwargs):
        ...
        if len(kwargs):
            self._meta = self._meta.fork(**kwargs)
        return
    ...
    def get_url(self, **kwargs):
        ...
        """
        return build(self._request.path, self._request.GET, self._meta.prefix, **kwargs)
    ...
    def as_html(self):
        ...
        """
        return render_to_string(self._meta.template, {'table': self})

    @property
    def paginator(self):
        if self._paginator is None:
            self._paginator = self._meta.paginator_class(self.object_list, self._meta.per_page)
    ...
    def rows(self):
        ...
        return map(lambda o: self._meta.row_class(self, o), self.paginator.page(self._meta.page).object_list)

    def cell(self, column, row):
        return self._meta.cell_class(column, row)