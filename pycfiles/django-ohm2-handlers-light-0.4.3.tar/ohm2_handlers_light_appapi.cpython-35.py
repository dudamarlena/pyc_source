...
# [GCC 8.4.0]
# Embedded file name: /Users/tonra/ohm2/clients/ohm2/entwicklung/ohm2-dev-light/webapp/backend/apps/ohm2_handlers_light/management/commands/ohm2_handlers_light_appapi.py
# Compiled at: 2017-09-22 12:23:00
...
def load_template(template, name, version):
    ...
    with open(path, 'r') as (f):
        content = f.read()
    return content.format(name.upper(), name.lower(), name.title(), h_utils.get_random_string(32), int(h_utils.random_string_hexdigits(3), 16) * 64, version)
