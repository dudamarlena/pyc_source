...
# [GCC 8.4.0]
# Embedded file name: /home/narendra/.pyenv/versions/aws/lib/python3.6/site-packages/tvarit_api/resources/user.py
...
class User(Base):
    ...
    def change_actual_user_password(self, old_password, new_password):
        ...
        change_actual_user_password_json = {'oldPassword':old_password, 
