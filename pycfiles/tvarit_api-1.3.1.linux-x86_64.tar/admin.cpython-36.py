...
# [GCC 8.4.0]
# Embedded file name: /home/narendra/.pyenv/versions/aws/lib/python3.6/site-packages/tvarit_api/resources/admin.py
...
class Admin(Base):
    ...
    def change_user_permissions(self, user_id, is_tvarit_admin):
        ...
        r = self.api.PUT(change_user_permissions,
          json={'isGrafanaAdmin': is_tvarit_admin})
        return r
