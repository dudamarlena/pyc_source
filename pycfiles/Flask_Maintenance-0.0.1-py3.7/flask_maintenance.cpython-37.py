...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\flask_maintenance.py
# Compiled at: 2019-07-07 00:44:46
    ...
    def _handler(self):
        ...
        if actx:
            ...
            if location == 'env':
                ...
                ins_path = os.path.join(current_app.instance_path, 'maintenance')
