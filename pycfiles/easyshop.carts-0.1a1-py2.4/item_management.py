...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/carts/adapters/item_management.py
...
class CartItemManagement:
    ...
    def addItem(self, product, properties, quantity=1):
        ...
        for cart_item in cart_items:
            if product == cart_item.getProduct() and properties == cart_item.getProperties():
