...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-fat64/egg/authorize/responses.py
...
aim_codes = {'1': 'Approved', 
   '2': 'Declined', 
   '3': 'Error', 
   '4': 'Held for Review'}
avs_codes = {'A': 'Address (Street) matches, ZIP does not', 
...
holder_verification_codes = {'': 'CAVV not validated', 
