...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-fat64/egg/authorize/cim.py
...
class Api(base.BaseApi):
    ...
    def create_profile(**kw):
        ...
        """
        return (
         'createCustomerProfileRequest', kw, xml.profile(**kw))
    ...
    def create_payment_profile(**kw):
        ...
        """
        return (
         'createCustomerPaymentProfileRequest', kw,
    ...
    def create_shipping_address(**kw):
        ...
        """
        return (
         'createCustomerShippingAddressRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
    ...
    def create_profile_transaction(**kw):
        ...
        """
        return (
         'createCustomerProfileTransactionRequest', kw, xml.transaction(**kw))
    ...
    def delete_profile(**kw):
        ...
        """
        return (
         'deleteCustomerProfileRequest', kw,
         x.customerProfileId(kw['customer_profile_id']))
    ...
    def delete_payment_profile(**kw):
        ...
        """
        return (
         'deleteCustomerPaymentProfileRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
    ...
    def delete_shipping_address(**kw):
        ...
        """
        return (
         'deleteCustomerShippingAddressRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
    ...
    def get_profile_ids(**kw):
        ...
        """
        return (
         'getCustomerProfileIdsRequest', kw)
    ...
    def get_payment_profile(**kw):
        ...
        """
        return (
         'getCustomerPaymentProfileRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
         x.customerPaymentProfileId(kw['customer_payment_profile_id']))
    ...
    def get_shipping_address(**kw):
        ...
        """
        return (
         'getCustomerShippingAddressRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
         x.customerAddressId(kw['customer_address_id']))
    ...
    def update_profile(**kw):
        ...
        """
        return (
         'updateCustomerProfileRequest', kw,
         x.profile(x.merchantCustomerId(kw.get('customer_id')), x.description(kw.get('description')), x.email(kw.get('email')), x.customerProfileId(kw['customer_profile_id'])))
    ...
    def update_payment_profile(**kw):
        ...
        """
        return (
         'updateCustomerPaymentProfileRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
    ...
    def update_shipping_address(**kw):
        ...
        """
        return (
         'updateCustomerShippingAddressRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
    ...
    def validate_payment_profile(**kw):
        ...
        """
        return (
         'validateCustomerPaymentProfileRequest', kw,
         x.customerProfileId(kw['customer_profile_id']),
         x.customerPaymentProfileId(kw['customer_payment_profile_id']),
