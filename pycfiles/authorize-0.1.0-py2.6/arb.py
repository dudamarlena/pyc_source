...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-fat64/egg/authorize/arb.py
...
class Api(base.BaseApi):
    ...
    def create_subscription(**kw):
        ...
        """
        return (
         'ARBCreateSubscriptionRequest', kw, xml.subscription(**kw))
    ...
    def update_subscription(**kw):
        ...
        """
        return (
         'ARBUpdateSubscriptionRequest', kw,
    ...
    def cancel_subscription(**kw):
        ...
        """
        return (
         'ARBCancelSubscriptionRequest', kw,
         x.subscriptionId(kw['subscription_id']))