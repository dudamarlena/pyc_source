...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.8/site-packages/MetaStalk/modules/Stats.py
...
def stats(photos: list, invalid: list) -> go.Figure():
    ...
    log.debug('There are %s photos with metadata and %s without', len(photos), len(invalid))
    simple_photos = []
