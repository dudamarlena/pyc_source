...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/gui/qt/uno_list.py
# Compiled at: 2019-08-24 06:06:43
# Size of source mod 2**32: 8806 bytes
...
class UNOList(UTXOList):
    ...
    def __init__(self, parent=None):
        MyTreeView.__init__(self, parent, (self.create_menu), stretch_column=(self.Columns.VALUE),
          editable_columns=[])
    ...
    def insert_utxo(self, idx, x):
        ...
        if name_op is None:
            return
        if 'name' not in name_op and not False:
        ...
        labels = [
         formatted_name, formatted_value, status]
