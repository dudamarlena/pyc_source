...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/gui/qt/password_dialog.py
# Compiled at: 2019-08-25 05:47:09
...
class PasswordLayout(object):
    titles = [
     _('Enter Password'), _('Change Password'), _('Enter Passphrase')]
    ...
    def pw_changed(self):
        ...
        if password:
            colors = {'Weak':'Red', 
             'Medium':'Blue',  'Strong':'Green',  'Very Strong':'Green'}
...
class ChangePasswordDialogForSW(ChangePasswordDialogBase):
    ...
    def run(self):
        ...
        return (
         True, self.playout.old_password(), self.playout.new_password(), self.playout.encrypt_cb.isChecked())
...
class ChangePasswordDialogForHW(ChangePasswordDialogBase):
    ...
    def run(self):
        if not self.exec_():
            return (False, None)
        return (
         True, self.playout.encrypt_cb.isChecked())
