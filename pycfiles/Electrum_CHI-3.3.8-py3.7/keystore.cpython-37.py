...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/keystore.py
# Compiled at: 2019-08-24 06:06:43
# Size of source mod 2**32: 28813 bytes
from unicodedata import normalize
import hashlib
from typing import Tuple
from . import bitcoin, ecc, constants, bip32
from .bitcoin import deserialize_privkey, serialize_privkey, public_key_to_p2pkh
from .bip32 import convert_bip32_path_to_list_of_uint32, BIP32_PRIME, is_xpub, is_xprv, BIP32Node
from .ecc import string_to_number, number_to_string
from .crypto import pw_decode, pw_encode, sha256, sha256d, PW_HASH_VERSION_LATEST, SUPPORTED_PW_HASH_VERSIONS, UnsupportedPasswordHashVersion
from .util import InvalidPassword, WalletFileException, BitcoinException, bh2u, bfh, inv_dict
...
class Imported_KeyStore(Software_KeyStore):
    ...
    def import_privkey(self, sec, password):
        ...
        serialized_privkey = serialize_privkey(privkey,
          compressed, txin_type, internal_use=True)
...
def bip39_to_seed(mnemonic, passphrase):
    ...
    return hashlib.pbkdf2_hmac('sha512', (mnemonic.encode('utf-8')), (b'mnemonic' + passphrase.encode('utf-8')),
...
PURPOSE48_SCRIPT_TYPES = {'p2wsh-p2sh':1, 
 'p2wsh':2}
...
def get_private_keys(text, *, allow_spaces_inside_key=True, raise_on_error=False):
    if allow_spaces_inside_key:
        ...
        parts = text.split()
    if bool(parts):
        if all((bitcoin.is_private_key(x, raise_on_error=raise_on_error) for x in parts)):
            return parts
