...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/gui/qt/seed_dialog.py
# Compiled at: 2019-08-25 05:48:17
# Size of source mod 2**32: 9847 bytes
from PyQt5.QtCore import Qt
from PyQt5.QtGui import QPixmap, QPalette
from PyQt5.QtWidgets import QVBoxLayout, QCheckBox, QHBoxLayout, QLineEdit, QLabel, QCompleter, QDialog, QStyledItemDelegate
from electrum.i18n import _
from electrum.mnemonic import Mnemonic, seed_type
import electrum.old_mnemonic
from .util import Buttons, OkButton, WWLabel, ButtonsTextEdit, icon_path, EnterButton, CloseButton, WindowModalDialog, ColorScheme
...
class SeedLayout(QVBoxLayout):
            ...
            if 'bip39' in self.options:
                ...
                def f(b):
                    ...
                    if b:
                        msg = ' '.join([
                         '<b>' + _('Warning') + ':</b>  ',
                         _('BIP39 seeds can be imported in Electrum-CHI, so that users can access funds locked in other wallets.'),
                         _('However, we do not generate BIP39 seeds, because they do not meet our safety standard.'),
                         _('BIP39 seeds do not include a version number, which compromises compatibility with future software.'),
                         _('We do not guarantee that BIP39 imports will always be supported in Electrum-CHI.')])
                    else:
                        msg = ''
    ...
    def initialize_completer(self):
        ...
        self.wordlist = bip39_english_list + list(only_old_list)
        self.wordlist.sort()
...
class SeedDialog(WindowModalDialog):
    ...
    def __init__(self, parent, seed, passphrase):
        WindowModalDialog.__init__(self, parent, 'Electrum-CHI - ' + _('Seed'))
