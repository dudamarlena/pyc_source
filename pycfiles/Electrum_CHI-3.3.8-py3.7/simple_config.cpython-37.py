...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/simple_config.py
# Compiled at: 2019-08-25 06:28:02
# Size of source mod 2**32: 20690 bytes
import json, threading, time, os, stat
from decimal import Decimal
from typing import Union, Optional
from numbers import Real
from copy import deepcopy
from . import util
from .util import user_dir, make_dir, NoDynamicFeeEstimates, format_fee_satoshis, quantize_feerate
from .i18n import _
...
class SimpleConfig(Logger):
    ...
    def __init__(self, options=None, read_user_config_function=None, read_user_dir_function=None):
        if options is None:
            ...
            elif read_user_dir_function is None:
            ...
            self.user_config = self.user_config or {'config_version': FINAL_CONFIG_VERSION}
    ...
    def _is_upgrade_method_needed(self, min_version, max_version):
        ...
        if cur_version > max_version:
            ...
            if cur_version < min_version:
                raise Exception('config upgrade: unexpected version %d (should be %d-%d)' % (
    ...
    def get_wallet_path(self):
        ...
        if self.get('wallet_path'):
            ...
            if os.path.exists(old_path):
                os.path.exists(new_path) or os.rename(old_path, new_path)
        return new_path
    ...
    def get_fee_text(self, pos, dyn, mempool, fee_rate):
        ...
        if dyn:
            ...
            if mempool and self.has_fee_mempool():
                ...
                if (mempool or self.has_fee_etas)():
...
def read_user_config(path):
    ...
    if not path:
        ...
        return os.path.exists(config_path) or {}
    try:
