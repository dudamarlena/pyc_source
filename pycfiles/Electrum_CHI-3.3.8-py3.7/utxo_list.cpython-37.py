...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/gui/qt/utxo_list.py
...
class UTXOList(MyTreeView):
    ...
    headers = {Columns.ADDRESS: _('Address'), 
     Columns.LABEL: _('Label'), 
     Columns.AMOUNT: _('Amount'), 
     Columns.HEIGHT: _('Height'), 
     Columns.OUTPOINT: _('Output point')}
    filter_columns = [
     Columns.ADDRESS, Columns.LABEL, Columns.OUTPOINT]
