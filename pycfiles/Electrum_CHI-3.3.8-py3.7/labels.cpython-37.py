...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/plugins/labels/labels.py
# Compiled at: 2019-08-24 06:06:43
# Size of source mod 2**32: 7299 bytes
import asyncio, hashlib, json, sys, traceback
...
class LabelsPlugin(BasePlugin):
    ...
    def set_label(self, wallet, item, label):
        ...
        bundle = {'walletId':wallet_id,  'walletNonce':nonce, 
    ...
    async def push_thread(self, wallet):
        ...
        bundle = {'labels':[],  'walletId':wallet_id, 
    ...
    async def pull_thread(self, wallet, force):
        ...
        for key, value in result.items():
            if not force:
                wallet.labels[key] = wallet.labels.get(key) or value
