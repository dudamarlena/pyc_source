...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/storage.py
# Compiled at: 2019-08-24 06:06:43
# Size of source mod 2**32: 8906 bytes
import os, threading, stat, hashlib, base64, zlib
from . import ecc
...
class WalletStorage(Logger):
    ...
    def __init__(self, path, *, manual_upgrades=False):
        ...
        if self.file_exists():
            ...
            self.db = self.is_encrypted() or DB_Class((self.raw), manual_upgrades=manual_upgrades)
            self.load_plugins()
        else:
