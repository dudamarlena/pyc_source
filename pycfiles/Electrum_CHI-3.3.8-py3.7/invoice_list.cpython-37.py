...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/gui/qt/invoice_list.py
...
from .util import MyTreeView, read_QIcon, MONOSPACE_FONT, PR_UNPAID, pr_tooltips, import_meta_gui, export_meta_gui, pr_icons
...
class InvoiceList(MyTreeView):
    ...
    headers = {Columns.DATE: _('Expires'), 
     Columns.REQUESTOR: _('Requestor'), 
     Columns.DESCRIPTION: _('Description'), 
     Columns.AMOUNT: _('Amount'), 
     Columns.STATUS: _('Status')}
    filter_columns = [
     Columns.DATE, Columns.REQUESTOR, Columns.DESCRIPTION, Columns.AMOUNT]
    ...
    def create_menu(self, position):
        ...
        return item and item_col0 or None
