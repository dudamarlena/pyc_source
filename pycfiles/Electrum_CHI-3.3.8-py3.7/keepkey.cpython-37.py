...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/electrum_chi/electrum/plugins/keepkey/keepkey.py
# Compiled at: 2019-08-25 06:14:40
...
class KeepKeyPlugin(HW_PluginBase):
    ...
    def __init__(self, parent, config, name):
        ...
        try:
            from . import client
            import keepkeylib, keepkeylib.ckd_public, keepkeylib.transport_hid, keepkeylib.transport_webusb
