...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tagbase\example_linux_settings.py
...
DATABASE_NAME = '/var/www/gutentag/tagbase/gutentagdb'
DATABASE_USER = ''
DATABASE_PASSWORD = ''
DATABASE_HOST = ''
DATABASE_PORT = ''
...
BLASTCL3 = 'C:\\PROGRA~1\\blast\\bin\\blastcl3'
EVALUE = 0.001
DBNAME = ''
STATIC_DOC_ROOT = '/var/www/gutentag/tagbase/media'
LOG_FILE = '/var/www/gutentag/tagbase/log.txt'
LANGUAGE_CODE = 'en-us'
SITE_ID = 1
USE_I18N = True
MEDIA_ROOT = ''
...
TEMPLATE_DIRS = ('/var/www/gutentag/tagbase/templates', )
