...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/harold/armor/basetypes.py
...
basetypes = {bool: _bool, buffer: _buffer, classmethod: _classmethod, complex: _complex, dict: _dict, enumerate: _enumerate, file: _file, float: _float, frozenset: _frozenset, int: _int, list: _list, long: _long, object: _object, property: _property, reversed: _reversed, set: _set, slice: _slice, staticmethod: _staticmethod, str: _str, super: _super, tuple: _tuple, type: _type, unicode: _unicode, xrange: _xrange}