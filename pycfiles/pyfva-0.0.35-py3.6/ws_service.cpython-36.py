...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyfva/receptor/ws_service.py
# Compiled at: 2019-05-15 12:55:33
...
class ResultadoDeFirma(xsd.ComplexType):
    ...
    @classmethod
    def create(cls, IdDeLaSolicitud, DocumentoFirmado, FueExitosa, CodigoDeError, IDAlgoritmoHashDocumentoFirmado, HashDocumentoFirmado=None, HashDelDocumentoFirmadoEnBytes=None):
        instance = cls()
...
def NotifiqueLaRespuesta(request, NotifiqueLaRespuesta):
    ...
    data = {'id_solicitud':result.IdDeLaSolicitud, 
