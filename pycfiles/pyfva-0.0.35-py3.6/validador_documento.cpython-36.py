...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyfva/soap/validador_documento.py
# Compiled at: 2018-11-01 16:29:23
# Size of source mod 2**32: 17318 bytes
...
Schema_c49e7 = xsd.Schema(imports=[], includes=[], targetNamespace=(settings.FVA_HOST),
 ...
 ResultadoValidacionCoFirma, ArrayOfErrorDeDocumentoCoFirma, ErrorDeDocumentoCoFirma, ArrayOfString, ArrayOfFirmante, Firmante, ResultadoValidacionContraFirma, ArrayOfErrorDeDocumentoContraFirma, ErrorDeDocumentoContraFirma, ResultadoValidacionMsOffice, ArrayOfErrorDeDocumentoMsOffice, ErrorDeDocumentoMsOffice, ResultadoValidacionOdf, ArrayOfErrorDeDocumentoOdf, ErrorDeDocumentoOdf, ResultadoValidacionPdf, ArrayOfErrorDeDocumentoPdf, ErrorDeDocumentoPdf],
  elements={'ValideElDocumentoXmlEnvelopedCoFirma':xsd.Element(ValideElDocumentoXmlEnvelopedCoFirma()), 
...
ValideElDocumentoXmlEnvelopedCoFirma_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElDocumentoXmlEnvelopedCoFirma'),
  ...
  style='document')
ValideElDocumentoXmlEnvelopedContraFirma_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElDocumentoXmlEnvelopedContraFirma'),
  ...
  style='document')
ValideElDocumentoMSOffice_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElDocumentoMSOffice'),
  ...
  style='document')
ValideElDocumentoOdf_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElDocumentoOdf'),
  ...
  style='document')
ValideElDocumentoPdf_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElDocumentoPdf'),
...
ValideElServicio_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElServicio'),
  ...
  style='document')
ValidadorDeDocumentoSoap_SERVICE = soap.Service(name='ValidadorDeDocumentoSoap',
 ...
 Schema_c49e7],
  ...
  methods=[
 ValideElDocumentoXmlEnvelopedCoFirma_method, ValideElDocumentoXmlEnvelopedContraFirma_method, ValideElDocumentoMSOffice_method, ValideElDocumentoOdf_method, ValideElDocumentoPdf_method, ValideElServicio_method])
