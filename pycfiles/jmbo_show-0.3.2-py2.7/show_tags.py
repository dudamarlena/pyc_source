...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-show/show/templatetags/show_tags.py
# Compiled at: 2013-01-15 05:02:48
...
def get_relation_by_type_list(parser, token):
    ...
    if len(tokens) == 7:
        direction = tokens[6]
    return RelationByTypeListNode(name=tokens[1], obj=tokens[3], as_var=tokens[5], direction=direction)
