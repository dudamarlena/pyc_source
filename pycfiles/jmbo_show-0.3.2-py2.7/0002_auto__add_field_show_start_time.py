...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-show/show/migrations/0002_auto__add_field_show_start_time.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('show_show', 'start_time', self.gf('django.db.models.fields.TimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 24, 0, 0), db_index=True, blank=True), keep_default=False)
        if not db.dry_run:
            for show in orm.Show.objects.all():
                show.start_time = show.start.time()
                show.save()

    def backwards(self, orm):
        db.delete_column('show_show', 'start_time')
    ...
    models = {'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
       ...
       'show.show': {'Meta': {'ordering': "('-created',)", 'object_name': 'Show', '_ormbases': ['jmbo.ModelBase']}, 'content': (
                     ...
                     'start': (
                             'django.db.models.fields.DateTimeField', [], {'db_index': 'True'}), 
                     'start_time': (
                                  'django.db.models.fields.TimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})}, 
