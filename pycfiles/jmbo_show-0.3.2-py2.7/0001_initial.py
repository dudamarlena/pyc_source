...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-show/show/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    depends_on = (('jmbo_calendar', '0004_auto__add_field_event_external_link'), )

    def forwards(self, orm):
        db.create_table('show_contributor', (
         (
        ...
        db.send_create_signal('show', ['Contributor'])
        db.create_table('show_credit', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'contributor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credits', to=orm['show.Contributor'])),
         (
          'show', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credits', to=orm['show.Show'])),
         (
          'credit_option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.CreditOption']))))
        db.send_create_signal('show', ['Credit'])
        db.create_table('show_show', (
         (
          'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
         (
         ...
         (
          'repeat', self.gf('django.db.models.fields.CharField')(default='does_not_repeat', max_length=64, db_index=True)),
         (
          'repeat_until', self.gf('django.db.models.fields.DateField')(null=True, blank=True))))
        db.send_create_signal('show', ['Show'])
        db.create_table('show_radioshow', (
         (
          'show_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['show.Show'], unique=True, primary_key=True)),))
        db.send_create_signal('show', ['RadioShow'])
        db.create_table('show_creditoption', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'show_preferences', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['preferences.ShowPreferences'])),
         (
        ...
        db.send_create_signal('show', ['CreditOption'])
        db.create_table('show_appearance', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appearances', to=orm['jmbo_calendar.Event'])),
         (
          'show_contributor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appearances', to=orm['show.Contributor']))))
        db.send_create_signal('show', ['Appearance'])

    def backwards(self, orm):
        db.delete_table('show_contributor')
        db.delete_table('show_credit')
        db.delete_table('show_show')
        db.delete_table('show_radioshow')
        db.delete_table('show_creditoption')
        db.delete_table('show_appearance')

    models = {'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
       ...
       'atlas.location': {'Meta': {'object_name': 'Location'}, 'address': (
                                    'django.db.models.fields.TextField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}), 
                          'city': (
                                 'django.db.models.fields.related.ForeignKey', [], {'to': "orm['atlas.City']"}), 
                          'coordinates': (
                                        'atlas.fields.CoordinateField', [], {'blank': 'True', 'null': 'True', 'geography': 'True'}), 
                          'country': (
                                    'django.db.models.fields.related.ForeignKey', [], {'to': "orm['atlas.Country']"}), 
       ...
       'jmbo.modelbase': {'Meta': {'ordering': "('-created',)", 'object_name': 'ModelBase'}, 'anonymous_comments': (
                          ...
                          'likes_enabled': (
                                          'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                          'location': (
                                     'django.db.models.fields.related.ForeignKey', [], {'to': "orm['atlas.Location']", 'null': 'True', 'blank': 'True'}), 
                          'modified': (
       ...
       'jmbo_calendar.calendar': {'Meta': {'ordering': "('-created',)", 'object_name': 'Calendar', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                                  'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'jmbo_calendar.event': {'Meta': {'ordering': "('start',)", 'object_name': 'Event', '_ormbases': ['jmbo.ModelBase']}, 'calendars': (
                                           'django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'event_calendars'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['jmbo_calendar.Calendar']"}), 
                               'content': (
                               ...
                               'parent_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['jmbo.ModelBase']"}), 
                               'repeat': (
                                        'django.db.models.fields.CharField', [], {'default': "'does_not_repeat'", 'max_length': '64'}), 
                               'repeat_until': (
       ...
       'preferences.preferences': {'Meta': {'object_name': 'Preferences'}, 'id': (
                                   ...
                                   'sites': (
                                           'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'})}, 
       'preferences.showpreferences': {'Meta': {'object_name': 'ShowPreferences', '_ormbases': ['preferences.Preferences']}, 'preferences_ptr': (
       ...
       'show.appearance': {'Meta': {'object_name': 'Appearance'}, 'event': (
                                   'django.db.models.fields.related.ForeignKey', [], {'related_name': "'appearances'", 'to': "orm['jmbo_calendar.Event']"}), 
                           'id': (
                                'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                           'show_contributor': (
                                              'django.db.models.fields.related.ForeignKey', [], {'related_name': "'appearances'", 'to': "orm['show.Contributor']"})}, 
       'show.contributor': {'Meta': {'ordering': "('-created',)", 'object_name': 'Contributor', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}), 
                            'profile': (
                                      'ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}), 
                            'shows': (
                                    'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'show_contributors'", 'symmetrical': 'False', 'through': "orm['show.Credit']", 'to': "orm['show.Show']"})}, 
       'show.credit': {'Meta': {'object_name': 'Credit'}, 'contributor': (
                                     'django.db.models.fields.related.ForeignKey', [], {'related_name': "'credits'", 'to': "orm['show.Contributor']"}), 
                       'credit_option': (
                                       'django.db.models.fields.related.ForeignKey', [], {'to': "orm['show.CreditOption']"}), 
                       'id': (
                            'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                       'show': (
                              'django.db.models.fields.related.ForeignKey', [], {'related_name': "'credits'", 'to': "orm['show.Show']"})}, 
       'show.creditoption': {'Meta': {'object_name': 'CreditOption'}, 'id': (
                                  'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                             'role_name': (
                             ...
                             'show_preferences': (
                                                'django.db.models.fields.related.ForeignKey', [], {'to': "orm['preferences.ShowPreferences']"})}, 
       'show.radioshow': {'Meta': {'ordering': "('-created',)", 'object_name': 'RadioShow', '_ormbases': ['show.Show']}, 'show_ptr': (
                                     'django.db.models.fields.related.OneToOneField', [], {'to': "orm['show.Show']", 'unique': 'True', 'primary_key': 'True'})}, 
       'show.show': {'Meta': {'ordering': "('-created',)", 'object_name': 'Show', '_ormbases': ['jmbo.ModelBase']}, 'content': (
                               'ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}), 
                     'contributors': (
                                    'django.db.models.fields.related.ManyToManyField', [], {'to': "orm['show.Contributor']", 'through': "orm['show.Credit']", 'symmetrical': 'False'}), 
                     'end': (
                           'django.db.models.fields.DateTimeField', [], {'db_index': 'True'}), 
                     'modelbase_ptr': (
                                     'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}), 
                     'repeat': (
                              'django.db.models.fields.CharField', [], {'default': "'does_not_repeat'", 'max_length': '64', 'db_index': 'True'}), 
                     'repeat_until': (
                                    'django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}), 
                     'start': (
                             'django.db.models.fields.DateTimeField', [], {'db_index': 'True'})}, 
