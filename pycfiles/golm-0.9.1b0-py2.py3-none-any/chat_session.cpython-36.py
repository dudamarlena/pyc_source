...
# [GCC 8.4.0]
# Embedded file name: /Users/prihodad/Documents/projects/visitor/golm/golm/core/chat_session.py
...
class ChatSession:
    ...
    def to_json(self):
        return {'interface':self.interface.prefix, 
    ...
    def from_json(data: dict):
        ...
        return ChatSession(interface=interface,
...
class Profile:
    ...
    @staticmethod
    def from_json(data: dict):
        return Profile(profile_id=(data['profile_id']),
