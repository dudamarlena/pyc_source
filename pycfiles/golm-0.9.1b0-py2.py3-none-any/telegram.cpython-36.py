...
# [GCC 8.4.0]
# Embedded file name: /Users/prihodad/Documents/projects/visitor/golm/golm/core/interfaces/telegram.py
# Compiled at: 2018-04-15 15:28:32
...
class TelegramInterface:
    ...
    def get_base_url() -> Optional[str]:
        token = settings.GOLEM_CONFIG.get('TELEGRAM_TOKEN')
        if not token:
    ...
    def persist_callback(payload) -> str:
        ...
        redis.set(key, payload, ex=604800)
        return key
