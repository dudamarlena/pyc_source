...
# [GCC 8.4.0]
# Embedded file name: /Users/prihodad/Documents/projects/visitor/golm/golm/core/tests.py
        ...
        if isinstance(action, UserButtonMessage):
            ...
            if isinstance(action, BotMessage):
                ...
                for button_qr in buttons:
                    if hasattr(button_qr, 'payload'):
                        if button_qr.payload:
