...
# [GCC 8.4.0]
# Embedded file name: /Users/prihodad/Documents/projects/visitor/golm/golm/core/nlp/utils.py
...
def get_glove():
    ...
    if _glove is None:
        ...
        if glove_dir is None or glove_prefix is None:
            raise Exception('Please set django settings NLP_CONFIG.GLOVE_DIR and GLOVE_PREFIX to point to your word embedding files to use the built-in NLP.')
