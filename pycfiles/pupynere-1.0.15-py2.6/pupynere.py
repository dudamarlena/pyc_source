...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/pupynere.py
# Compiled at: 2011-09-01 10:16:52
"""
...
class netcdf_file(object):
    ...
    def _write_var_metadata(self, name):
        ...
        if not var.isrec:
            ...
            rec_vars = len([ var for var in self.variables.values() if var.isrec
                           ])
            if rec_vars > 1:
                vsize += -vsize % 4
