...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/turkish_morphology/fst.py
# Compiled at: 2020-04-01 02:29:21
# Size of source mod 2**32: 4804 bytes
...
def extract_parses(fst: _Fst, state_index: int, label_type: str, symbol_table: Optional[_SymbolTable]=None, symbol_indices: Optional[List[int]]=[]) -> Generator[(str, None, None)]:
  ...
  """
    ...
    for arc in arcs:
        ...
        yield from extract_parses(fst, arc.nextstate, label_type, symbol_table, new_symbol_indices)