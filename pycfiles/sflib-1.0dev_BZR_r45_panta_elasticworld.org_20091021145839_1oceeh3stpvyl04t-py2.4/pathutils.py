...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/sflib/pathutils.py
# Compiled at: 2009-05-15 12:29:40
import os
...
def is_common_path(base, pathname, normalize=True):
    ...
    if len(base_components) == len(common) and base_components == common:
        return True
    return False
