...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/asdoc2dash/dash.py
# Compiled at: 2013-06-15 20:27:11
import sqlite3, os, shutil, plistlib, logging
...
class DocsetGenerator:
    ...
    def create_project(self):
        ...
        if self.orig_icon_path is not None:
...
class DocsetPlist:
    ...
    def __init__(self, CFBundleIdentifier, CFBundleName, DocSetPlatformFamily, DashDocSetFamily='dashtoc', dashIndexFilePath=None, isDashDocset=True, isJavaScriptEnabled=True):
    ...
    def writePlist(self, path):
        plist = {'CFBundleIdentifier': self.CFBundleIdentifier, 
