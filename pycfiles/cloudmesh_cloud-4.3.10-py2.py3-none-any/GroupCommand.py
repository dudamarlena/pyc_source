...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/shell/plugins/GroupCommand.py
        ...
        if arguments['list']:
            ...
            if name is None:
                ...
                if result:
                    ...
                    msg_a = ('No group found with name `{name}` found in the category `{category}`.').format(**locals())
                return ''
        else:
            if arguments['add']:
                ...
                print('MMMM', members)
                data = dotdict({'species': arguments['--type'] or 'vm', 
            ...
            if arguments['remove']:
                ...
                for member in members:
                    ...
                    if result:
                        ...
                        Console.error(('remove {} from group {}. failed.').format(group, member))
