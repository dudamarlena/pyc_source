...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/var.py
...
class Var(object):
    ...
    def get(cls, name=None, output='dict', scope='first'):
        ...
        :return:
        """
        o = cls.cm.find(kind=cls.__kind__, provider=cls.__provider__, output=output, scope=scope, name=name)
        return o
