...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/common/TableParser.py
...
class TableParser(object):
    ...
    @classmethod
    def convert(cls, table=None, output='dict', header=True, index=None, change=None, strip=True, lower=True, strip_seperator=True, seperator='|', comment_chars='+#'):
        if change is None:
            change = [
             (':', '_'), ('(', '_'), (')', ''), ('/', '_')]
        parser = TableParser(output=output, header=header, index=index, change=change, strip=strip, lower=lower, strip_seperator=strip_seperator, seperator=seperator, comment_chars=comment_chars)
    ...
    def __init__(self, output='dict', header=True, index=None, change=None, strip=True, lower=True, strip_seperator=True, seperator='|', comment_chars='+#'):
        """
