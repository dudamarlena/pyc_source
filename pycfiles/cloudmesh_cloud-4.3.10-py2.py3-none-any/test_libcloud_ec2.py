...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/tests/cm_libcloud/test_libcloud_ec2.py
...
class Test_libcloud_native(object):
    ...
    def setup(self):
        ...
        data = re.match('^http[s]?://(.+):([0-9]+)/([a-zA-Z/]*)', auth_url, re.M | re.I)
        ...
        self.driver = cls(self.credential['EC2_ACCESS_KEY'], self.credential['EC2_SECRET_KEY'], host=host, port=port, **extra_args)
