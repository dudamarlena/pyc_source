...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/shell/plugins/SelectCommand.py
    ...
    def do_select(self, args, arguments):
        ...
        if arguments['image']:
            try:
                ...
                number = menu_return_num(title='Select an Image', menu_list=image_names, tries=10, with_display=True)
                if number == 'q':
                    pass
                else:
            ...
            try:
                ...
                number = menu_return_num(title='Select a Flavor', menu_list=flavor_names, tries=10, with_display=True)
                if number == 'q':
                    pass
                else:
            ...
            try:
                ...
                number = menu_return_num(title='Select a cloud', menu_list=list(clouds), tries=10, with_display=True)
                if number == 'q':
                    pass
                else:
            ...
            try:
                ...
                number = menu_return_num(title='Select a Key', menu_list=key_names, tries=10, with_display=True)
                if number == 'q':
                    pass
                else:
