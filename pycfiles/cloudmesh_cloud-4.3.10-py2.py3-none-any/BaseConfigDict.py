...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/common/BaseConfigDict.py
# Compiled at: 2017-04-23 10:30:41
__doc__ = 'Some simple yaml file reader'
from __future__ import print_function
import ast, json, os, stat, sys
...
if __name__ == '__main__':
    config = ConfigDict({'a': '1', 'b': {'c': 3}}, prefix='cloudmesh.debug', filename='./etc/cloudmesh_debug.yaml')
    print('PPRINT')
    print(70 * '=')
    pprint(config)
    print('PRINT')
