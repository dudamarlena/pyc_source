...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/api/impl/openstack.py
...
class OpenstackProvider(Provider):
    ...
    def create_ip(self, node):
        ip = Network.find_assign_floating_ip(cloudname=self.cloud, instance_id=node.name)
