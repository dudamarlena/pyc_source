...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/cloud/iaas/provider/libcloud/CloudProviderLibcloud.py
...
class CloudProviderLibcloud(CloudProviderBase):
    ...
    def enable_ssh(self, cloud, secgroup_name='default'):
        if cloud == 'aws':
            params = {'Action': 'AuthorizeSecurityGroupIngress', 'GroupName': secgroup_name, 'IpProtocol': 'tcp', 
               'FromPort': '22', 
               'ToPort': '22', 
               'CidrIp': '0.0.0.0/0'}
            try:
