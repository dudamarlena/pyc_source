...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/common/menu.py
# Compiled at: 2017-04-23 10:30:41
__doc__ = 'Ascii menu class'
...
def dict_choice(d):
    if d is None:
        ...
        if elements != {}:
            print(Printer.write(elements, order=[
             'id',
             'name',
             'comment',
             'uri',
             'fingerprint',
             'source'], output='table', sort_keys=True))
        else:
