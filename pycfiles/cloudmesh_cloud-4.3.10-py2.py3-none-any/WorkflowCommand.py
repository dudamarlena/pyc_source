...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/shell/plugins/WorkflowCommand.py
    ...
    def do_workflow(self, args, arguments):
        ...
        if cloud is None:
            ...
            if arguments['show']:
                ...
                result = Workflow.save(cloud=cloud, name=workflow_name, str=workflow_str)
