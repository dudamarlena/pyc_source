...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/common/Printer.py
# Compiled at: 2017-04-23 10:30:41
__doc__ = 'Convenient methods and classes to print tables'
...
class Printer(object):
    ...
    def list(cls, l, order=None, header=None, output='table', sort_keys=True, show_none=''):
        ...
        return cls.dict(d, order=order, header=header, sort_keys=sort_keys, output=output, show_none=show_none)
    ...
    def dict(cls, d, order=None, header=None, output='table', sort_keys=True, show_none=''):
        ...
        if output == 'table':
            if d == {}:
                ...
                return cls.dict_table(d, order=order, header=header, sort_keys=sort_keys)

        else:
            if output == 'csv':
                return cls.csv(d, order=order, header=header, sort_keys=sort_keys)
            else:
                if output == 'json':
