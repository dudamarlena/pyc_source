...
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/common/GitInfo.py
# Compiled at: 2017-04-23 10:30:41
__doc__ = 'managing information from GIT'
...
class GitInfo(object):
    ...
    * a statistic about canged code by person
    ...
    def stat(self, email):
        ...
        sums = [
         0, 0, 0]
        for line in Shell.git('log', '--all', '--stat', ('--author={0}').format(email), _tty_in=True, _tty_out=False, _iter=True):
            line = line[:-1]
        ...
        return {'email': email, 'fileschanged': sums[0], 'inserted': sums[1], 
           'deleted': sums[2], 
    ...
    def compute(self):
        ...
        stats = {}
        sums = {'fileschanged': 0, 'inserted': 0, 
           'deleted': 0, 'lineschanged': 0}
        for email in emails:
        ...
        for email in emails:
            stats[email] = {'percentage': [stats[email]['fileschanged'] / float(sums['fileschanged']),
