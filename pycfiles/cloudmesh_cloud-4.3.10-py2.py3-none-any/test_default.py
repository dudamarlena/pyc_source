...
class Test_default(object):
    ...
    def test_008(self):
        HEADING(('cm default test=testValue --cloud={cloud}').format(**self.data))
        result = self.run('cm default test=testValue --cloud={cloud}')
        assert 'ok.' in result

    def test_009(self):
        HEADING(('cm default test --cloud={cloud}').format(**self.data))
        self.run('cm default test=testValue --cloud={cloud}')
        result = self.run('cm default test --cloud={cloud}')
        assert 'testValue' in result

    def test_010(self):
        HEADING(('cm default doesnotexist --cloud={cloud}').format(**self.data))
    ...
    def test_012(self):
        HEADING(('cm default delete doesnotexist --cloud={cloud}').format(**self.data))
