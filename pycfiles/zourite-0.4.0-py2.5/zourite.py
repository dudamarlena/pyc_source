...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/zourite/core/zourite.py
# Compiled at: 2010-04-27 15:25:54
import plugin, logging, pickle, os, os.path, dbus
from ..common import version
version.getInstance().submitRevision('$Revision: 220 $')
ZOURITE_AVAILABLE_PLUGIN = None
NOT_YET_IMPLEMENTED = 'not yet implemented'
MEMORY_CACHE_STORE = 'MEMORY_CACHE_STORE'
DISK_CACHE_STORE = 'DISK_CACHE_STORE'
AVAILABLE_CACHE_STORE = [
 MEMORY_CACHE_STORE, DISK_CACHE_STORE]
...
class Zourite(plugin.ZouritePlugin):
    ...
    def getMyConnections(self):
        connections = []
        for aPlugin in self.registered_plugin:
            connections.extend(aPlugin.getMyConnections())
...
class CachePlugin(plugin.ZouritePlugin):
    ...
    AVAILABLE_CACHE_STRATEGIES = [
     CACHE_PREFERED_STATEGY, NETWORK_DATA_PREFERED_STRATEGY]
    cacheStrategy = None
    forceRefresh = False
