...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/zourite/gui/mock.py
...
class Zourite(zourite.Zourite):
    ...
    def getFullProfile(self, contactId):
        ...
        fullProfile.summary = "I've spent a lof of time making program  mainly in financial concern " + 'but now i work in a open source company and i dare joining an innovative project dealing ' + 'with difficul subject'
