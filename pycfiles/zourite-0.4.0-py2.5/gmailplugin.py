...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/zourite/plugin/gmail/gmailplugin.py
...
import pickle, logging, gtk, gtk.gdk, datetime, atom, gdata.contacts, gdata.contacts.service
from zourite.common import version
version.getInstance().submitRevision('$Revision: 203 $')
PLUGIN_NAME = 'gmail'
...
class Person(plugin.Person):
    ...
    def __init__(self, entry):
        ...
        self.id = entry.id.text.rpartition('/')[2]
        return
