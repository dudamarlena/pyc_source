...
# [GCC 8.4.0]
# Embedded file name: \Ft\Xml\Xslt\Debugger\TerminalOutput.py
# Compiled at: 2004-04-16 01:27:48
"""
...
g_commandPrint = {DebugCommands.RUN: 'Run', DebugCommands.QUIT: 'Quit', DebugCommands.PRINT: 'Print', DebugCommands.TEMPLATE: 'Run to Template', DebugCommands.LIST_SHEET: 'List Sheet', DebugCommands.BACK_TRACE: 'Back Trace', DebugCommands.STEP: 'Step', DebugCommands.NEXT: 'Next', DebugCommands.EVAL: 'Evaluate Expression', DebugCommands.TEST: 'Test XPath', DebugCommands.MATCH: 'Match Pattern', DebugCommands.AVT: 'Attribute Value Template', DebugCommands.LIST_TEMPLATE: 'List current Template', DebugCommands.SET_BREAK: 'Set a break point in stylesheet', DebugCommands.DELETE_BREAK: 'Delete a break point in stylesheet', DebugCommands.LIST_BREAK: 'List break points', DebugCommands.HELP: 'help'}
g_help = {'run': 'Run till the next break point', 'quit': 'Exit the program', 'print': 'Print information about the context', 'template': 'Run till the next template is instantiated', 'ls': 'List the current stylesheet', 'bt': 'Print the call stack', 'step': 'Step to next element', 'next': 'Step to next element at same level', 'eval': 'Evaluate a XPath expression at the current context', 'test': 'Evaluate a XPath expression at the current context and return the boolean results', 'match': 'Evaluate a XPattern expression at the current context', 'avt': 'Evaluate a attribute value template at the current context', 'lt': 'Print the current template', 'b': 'Set a break point in stylesheet', 'db': 'Delete a break point in stylesheet', 'lb': 'List break points', 'help': 'help'}
