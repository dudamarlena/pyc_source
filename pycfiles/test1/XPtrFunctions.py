...
# [GCC 8.4.0]
# Embedded file name: \Ft\Xml\XPointer\XPtrFunctions.py
# Compiled at: 2002-01-22 16:43:15
...
CoreFunctions = {(EMPTY_NAMESPACE, 'range-to'): RangeTo, (EMPTY_NAMESPACE, 'string-range'): StringRange, (EMPTY_NAMESPACE, 'range'): Range, (EMPTY_NAMESPACE, 'range-inside'): RangeInside, (EMPTY_NAMESPACE, 'start-point'): StartPoint, (EMPTY_NAMESPACE, 'end-point'): EndPoint, (EMPTY_NAMESPACE, 'here'): Here, (EMPTY_NAMESPACE, 'origin'): Origin, (EMPTY_NAMESPACE, 'unique'): Unique}