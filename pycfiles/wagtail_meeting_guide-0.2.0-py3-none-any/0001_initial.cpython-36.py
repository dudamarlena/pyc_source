...
# [GCC 8.4.0]
# Embedded file name: /home/tallen/projects/wagtail-meeting-guide/meeting_guide/migrations/0001_initial.py
# Compiled at: 2019-12-27 18:00:05
# Size of source mod 2**32: 10375 bytes
import datetime
from django.db import migrations, models
import django.db.models.deletion, modelcluster.fields, mptt.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='GroupContribution',
       fields=[
      (
       'id',
       models.AutoField(auto_created=True,
     ...
     migrations.CreateModel(name='Meeting',
       fields=[
      (
       'page_ptr',
       models.OneToOneField(auto_created=True,
      ...
      (
       ...
       models.TextField(blank=True,
         ...
         null=True))],
       bases=('wagtailcore.page', )),
     migrations.CreateModel(name='MeetingType',
       fields=[
      (
       'id',
       models.AutoField(auto_created=True,
     ...
     migrations.CreateModel(name='Region',
       fields=[
      (
       'id',
       models.AutoField(auto_created=True,
     ...
     migrations.AddIndex(model_name='meetingtype',
       index=models.Index(fields=[
      'type_name'],
       name='meeting_gui_type_na_8f3ae8_idx')),
     migrations.AddIndex(model_name='meetingtype',
       index=models.Index(fields=[
      'intergroup_code'],
       name='meeting_gui_intergr_c031b7_idx')),
     migrations.AddIndex(model_name='meetingtype',
       index=models.Index(fields=[
      'meeting_guide_code'],
       name='meeting_gui_meeting_e22f98_idx')),
     migrations.AddField(model_name='meeting',
       name='group',
     ...
     migrations.AddField(model_name='meeting',
       name='types',
       field=modelcluster.fields.ParentalManyToManyField(limit_choices_to={'intergroup_code__isnull': False},
       related_name='meetings',
     ...
     migrations.AddField(model_name='location',
       ...
       to='meeting_guide.Region')),
     migrations.AddField(model_name='groupcontribution',
       name='group',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE),
       to='meeting_guide.Group')),
     migrations.AddIndex(model_name='meeting',
       index=models.Index(fields=[
      'meeting_location'],
     ...
     migrations.AddIndex(model_name='meeting',
       index=models.Index(fields=[
      'day_of_week'],
       name='meeting_gui_day_of__e95721_idx')),
     migrations.AddIndex(model_name='location',
       index=models.Index(fields=[
      'region'],
       name='meeting_gui_region__d7d310_idx')),
     migrations.AddIndex(model_name='location',
       index=models.Index(fields=[
      'formatted_address'],
       name='meeting_gui_formatt_18f95a_idx'))]