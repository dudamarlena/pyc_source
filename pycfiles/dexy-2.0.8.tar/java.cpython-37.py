...
# [GCC 8.4.0]
# Embedded file name: /Users/ana/dev/dexy-clean/dexy/filters/java.py
# Compiled at: 2020-03-18 15:12:33
# Size of source mod 2**32: 7245 bytes
...
class Scala(SubprocessCompileFilter):
    ...
    aliases = ['scala']
    _settings = {'executable':'scalac', 
     'tags':[
      'code', 'scala', 'compiled', 'jvm'], 
...
class JythonInteractiveFilter(PexpectReplFilter):
    __doc__ = '\n    jython in REPL\n    '
    aliases = ['jythoni']
    _settings = {'check-return-code':False, 
     'tags':[
      'code', 'jython', 'jvm', 'repl'], 
     'executable':'jython -i', 
     'initial-timeout':30, 
     'input-extensions':[
      '.py', '.txt'], 
...
class JavaFilter(SubprocessCompileFilter):
    ...
    aliases = ['java']
    _settings = {'check-return-code':True, 
     'classpath':(
      'Custom entries in classpath.', []), 
     'tags':[
      'code', 'java', 'jvm', 'compiled'], 
     'executable':'javac', 
     'input-extensions':[
      '.java'], 
     'output-extensions':[
