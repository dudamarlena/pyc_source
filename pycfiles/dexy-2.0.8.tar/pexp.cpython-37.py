...
# [GCC 8.4.0]
# Embedded file name: /Users/ana/dev/dexy-clean/dexy/filters/pexp.py
...
class PexpectReplFilter(SubprocessFilter):
    ...
    _settings = {'trim-prompt':('The closing prompt to be trimmed off.', '>>>'), 
     ...
     'prompts':(
      'List of possible prompts to match exactly.', ['>>>', '...']), 
...
class IpythonPexpectReplFilter(PexpectReplFilter):
    ...
    aliases = ['ipython']
    _settings = {'executable':'ipython --classic', 
