...
# [GCC 8.4.0]
# Embedded file name: /Users/ana/dev/dexy-clean/dexy/filters/soup.py
# Compiled at: 2020-03-18 15:12:33
# Size of source mod 2**32: 4131 bytes
from bs4 import BeautifulSoup
from dexy.filter import DexyFilter
from dexy.utils import chdir
import base64, inflection, mimetypes, re, urllib
...
class InlineAssets(DexyFilter):
    ...
    aliases = ['inliner']
    _settings = {'html-parser':('Name of html parser BeautifulSoup should use.', 'html.parser'), 
...
class SoupSections(DexyFilter):
    ...
    def append_current_section(self):
        section_dict = {'name':self.current_section_name, 
