...
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/cmsplugin_phlog/migrations/0003_v0_2_3.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_phlog_gallery', 'width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_phlog_gallery', 'height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_phlog_gallery', 'width')
        db.delete_column('cmsplugin_phlog_gallery', 'height')
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'creation_date': (
       ...
       'cms.placeholder': {'Meta': {'object_name': 'Placeholder'}, 'default_width': (
                           ...
                           'slot': (
                                  'django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'})}, 
       'cmsplugin_phlog.galleryplugin': {'Meta': {'object_name': 'GalleryPlugin', 'db_table': "'cmsplugin_phlog_gallery'", '_ormbases': ['cms.CMSPlugin']}, 'cmsplugin_ptr': (
                                         ...
                                         'width': (
                                                 'django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})}, 
       'cmsplugin_phlog.phloggalleryplugin': {'Meta': {'object_name': 'PhlogGalleryPlugin', 'db_table': "'cmsplugin_phloggalleryplugin'", '_ormbases': ['cms.CMSPlugin']}, 'cmsplugin_ptr': (
                                                              'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}), 
                                              'gallery': (
                                                        'django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.OrderedGallery']"}), 
                                              'limit': (
                                                      'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                              'order': (
                                                      'django.db.models.fields.CharField', [], {'default': "'gallery'", 'max_length': '32'}), 
                                              'public': (
                                                       'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                                              'template': (
                                                         'django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})}, 
       'cmsplugin_phlog.phlogphoto': {'Meta': {'object_name': 'PhlogPhoto', 'db_table': "'phlog_photo'"}, 'caption': (
                                      ...
                                      'effect': (
                                               'django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'phlogphoto_related'", 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}), 
                                      'id': (
                                           'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                      'image': (
                                              'django.db.models.fields.files.ImageField', [], {'max_length': '100'}), 
                                      'plugin': (
                                               'django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['cms.CMSPlugin']"}), 
                                      'title': (
                                              'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                                      'view_count': (
                                                   'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'cmsplugin_phlog.phlogphotoplugin': {'Meta': {'object_name': 'PhlogPhotoPlugin', 'db_table': "'cmsplugin_phlog_photo'", '_ormbases': ['cms.CMSPlugin']}, 'cmsplugin_ptr': (
                                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'})}, 
       'photologue.orderedgallery': {'Meta': {'ordering': "['-date_added']", 'object_name': 'OrderedGallery'}, 'date_added': (
                                                  'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}), 
                                     'description': (
                                     ...
                                     'is_public': (
                                                 'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                                     'photos': (
                                              'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'ordered_galleries'", 'to': "orm['photologue.Photo']", 'through': "orm['photologue.PhotoOrdering']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}), 
                                     'tags': (
                                            'tagging.fields.TagField', [], {}), 
                                     'title': (
                                             'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}), 
                                     'title_slug': (
                                                  'django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'})}, 
       ...
       'photologue.photoordering': {'Meta': {'object_name': 'PhotoOrdering'}, 'gallery': (
                                              'django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.OrderedGallery']"}), 
                                    'id': (
                                         'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                    'order': (
                                            'django.db.models.fields.PositiveIntegerField', [], {'default': '9999'}), 
                                    'photo': (
                                            'django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.Photo']"})}}
    complete_apps = [
     'cmsplugin_phlog']