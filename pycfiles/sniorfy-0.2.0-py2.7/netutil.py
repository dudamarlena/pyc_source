...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/sniorfy/netutil.py
# Compiled at: 2012-05-08 22:09:41
"""Miscellaneous network utility code."""
from __future__ import absolute_import, division, with_statement
import errno, logging, os, socket, stat, ssl
...
if hasattr(socket, 'AF_UNIX'):
    ...
    def bind_unix_socket(file, mode=384, backlog=128):
