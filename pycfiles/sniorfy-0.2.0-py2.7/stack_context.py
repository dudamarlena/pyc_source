...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/sniorfy/stack_context.py
# Compiled at: 2012-05-08 22:00:39
...
def wrap(fn):
    ...
    def wrapped(callback, contexts, *args, **kwargs):
        ...
        if not _state.contexts:
            ...
            new_contexts = [ cls(arg) for cls, arg in contexts[len(_state.contexts):] ]
