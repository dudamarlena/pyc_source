...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/testingbot/driver.py
# Compiled at: 2013-12-24 10:20:50
from selenium import selenium
import unittest, httplib, urllib, base64, sys, traceback, os
...
def testingbot_teardown(self):
    ...
    params = urllib.urlencode({'test[success]': success, 'test[status_message]': ('').join(traceback.format_exception(etype, value, tb, 5)).rstrip(), 'test[name]': str(self.id().split('.')[(-1)])})
