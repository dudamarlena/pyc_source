...
# [GCC 8.4.0]
# Embedded file name: /home/ryan/anaconda3/envs/wsl2/lib/python3.8/site-packages/pyEQL/elements.py
# Compiled at: 2020-04-22 00:58:25
# Size of source mod 2**32: 137341 bytes
    ...
    def __repr__(self):
        ...
        for i, j in enumerate(self.ionenergy):
            ...
            for massnum in sorted(self.isotopes):
                ...
                isotopes = ',\n              '.join(isotopes)
                description = word_wrap((self.description),
                  linelen=66, indent=0, joinstr=' "\n        "')
...
class Isotope(object):
    __doc__ = 'Isotope massnumber, relative atomic mass, and abundance.'
    __slots__ = [
    ...
    def __str__(self):
        return '%i, %.4f, %.6f%%' % (self.massnumber, self.mass, self.abundance * 100)

    def __repr__(self):
        return 'Isotope(%s, %s, %s)' % (
         repr(self.mass),
         repr(self.abundance),
         repr(self.massnumber))


class ElementsDict(object):
    __doc__ = 'Ordered dict of Elements with lookup by number, symbol, and name.'
    ...
    def __init__(self, *elements):
        ...
        for element in elements:
            ...
            elif element.number <= len(self._list):
 ...
 L. 336         0  SETUP_FINALLY        14  'to 14'

 L. 337         2  LOAD_FAST                'self'
                4  LOAD_ATTR                _dict
                6  LOAD_FAST                'key'
                8  BINARY_SUBSCR    
               10  POP_BLOCK        
 ...
 L. 338        14  DUP_TOP          
               ...
               20  POP_JUMP_IF_FALSE   104  'to 104'
               22  POP_TOP          
               24  POP_TOP          
               26  POP_TOP          

 L. 339        28  SETUP_FINALLY        84  'to 84'

 L. 340        30  LOAD_FAST                'key'
               32  LOAD_METHOD              indices
               34  LOAD_GLOBAL              len
               36  LOAD_FAST                'self'
               38  LOAD_ATTR                _list
...
ELEMENTS = ElementsDict(Element(1,
  'H',
  'Hydrogen',
  group=1,
  period=1,
 ...
 2:Isotope(2.014101778, 0.000115, 2)}), Element(2,
  'He',
  'Helium',
  group=18,
  period=1,
 ...
 4:Isotope(4.0026032497, 0.99999863, 4)}), Element(3,
  'Li',
  'Lithium',
  group=1,
  period=2,
 ...
 7:Isotope(7.016004, 0.9241, 7)}), Element(4,
  'Be',
  'Beryllium',
  group=2,
  period=2,
  ...
  isotopes={9: Isotope(9.0121821, 1.0, 9)}), Element(5,
  'B',
  'Boron',
  group=13,
  period=2,
 ...
 11:Isotope(11.0093055, 0.801, 11)}), Element(6,
  'C',
  'Carbon',
  group=14,
  period=2,
 ...
 13:Isotope(13.0033548378, 0.0107, 13)}), Element(7,
  'N',
  'Nitrogen',
  group=15,
  period=2,
 ...
 15:Isotope(15.0001088984, 0.00368, 15)}), Element(8,
  'O',
  'Oxygen',
  group=16,
  period=2,
  ...
  oxistates='-2*, -1',
  ionenergy=(13.6181, 35.116, 54.934, 54.934, 77.412, 113.896, 138.116, 739.315, 871.387),
  isotopes={16:Isotope(15.9949146221, 0.99757, 16), 
 17:Isotope(16.9991315, 0.00038, 17), 
 18:Isotope(17.9991604, 0.00205, 18)}), Element(9,
  'F',
  'Fluorine',
  group=17,
  period=2,
  ...
  isotopes={19: Isotope(18.9984032, 1.0, 19)}), Element(10,
  'Ne',
  'Neon',
  group=18,
  period=2,
 ...
 22:Isotope(21.99138551, 0.0925, 22)}), Element(11,
  'Na',
  'Sodium',
  group=1,
  period=3,
  ...
  ionenergy=(5.1391, 47.286, 71.64, 98.91, 138.39, 172.15, 208.47, 264.18, 299.87,
             1465.091, 1648.659),
  isotopes={23: Isotope(22.98976967, 1.0, 23)}), Element(12,
  'Mg',
  'Magnesium',
  group=2,
  period=3,
 ...
 26:Isotope(25.98259304, 0.1101, 26)}), Element(13,
  'Al',
  'Aluminium',
  group=13,
  period=3,
  ...
  isotopes={27: Isotope(26.98153844, 1.0, 27)}), Element(14,
  'Si',
  'Silicon',
  group=14,
  period=3,
 ...
 30:Isotope(29.97377022, 0.030871, 30)}), Element(15,
  'P',
  'Phosphorus',
  group=15,
  period=3,
  ...
  isotopes={31: Isotope(30.97376151, 1.0, 31)}), Element(16,
  'S',
  'Sulfur',
  group=16,
  period=3,
 ...
 36:Isotope(35.96708088, 0.0002, 36)}), Element(17,
  'Cl',
  'Chlorine',
  group=17,
  period=3,
 ...
 37:Isotope(36.9659026, 0.2422, 37)}), Element(18,
  'Ar',
  'Argon',
  group=18,
  period=3,
 ...
 40:Isotope(39.962383123, 0.996003, 40)}), Element(19,
  'K',
  'Potassium',
  group=1,
  period=4,
 ...
 41:Isotope(40.96182597, 0.067302, 41)}), Element(20,
  'Ca',
  'Calcium',
  group=2,
  period=4,
  ...
  ionenergy=(6.1132, 11.71, 50.908, 67.1, 84.41, 108.78, 127.7, 147.24, 188.54, 211.27,
             591.25, 656.39, 726.03, 816.61, 895.12, 974.0, 1087.0, 1157.0, 5129.045,
             5469.738),
 ...
 48:Isotope(47.952534, 0.00187, 48)}), Element(21,
  'Sc',
  'Scandium',
  group=3,
  period=4,
  ...
  eleconfig='[Ar] 3d 4s2',
  oxistates='3*',
  ionenergy=(6.5615, 12.8, 24.76, 73.47, 91.66, 11.1, 138.0, 158.7, 180.02, 225.32,
             225.32, 685.89, 755.47, 829.79, 926.0),
  isotopes={45: Isotope(44.9559102, 1.0, 45)}), Element(22,
  'Ti',
  'Titanium',
  group=4,
  period=4,
 ...
 50:Isotope(49.9447921, 0.0518, 50)}), Element(23,
  'V',
  'Vanadium',
  group=5,
  period=4,
 ...
 51:Isotope(50.9439637, 0.9975, 51)}), Element(24,
  'Cr',
  'Chromium',
  group=6,
  period=4,
  ...
  eleconfig='[Ar] 3d5 4s',
  oxistates='6, 3*, 2, 0',
  ionenergy=(6.7665, 16.5, 30.96, 49.1, 69.3, 90.56, 161.1, 184.7, 209.3, 244.4, 270.8,
             298.0, 355.0, 384.3, 1010.64),
  isotopes={50:Isotope(49.9460496, 0.04345, 50), 
 52:Isotope(51.9405119, 0.83789, 52), 
 53:Isotope(52.9406538, 0.09501, 53), 
 54:Isotope(53.9388849, 0.02365, 54)}), Element(25,
  'Mn',
  'Manganese',
  group=7,
  period=4,
  ...
  isotopes={55: Isotope(54.9380496, 1.0, 55)}), Element(26,
  'Fe',
  'Iron',
  group=8,
  period=4,
 ...
 58:Isotope(57.9332805, 0.00282, 58)}), Element(27,
  'Co',
  'Cobalt',
  group=9,
  period=4,
  ...
  oxistates='3, 2*, 0, -1',
  ionenergy=(7.881, 17.06, 33.5, 51.3, 79.5, 102.0, 129.0, 157.0, 186.13, 276.0, 305.0,
             336.0, 376.0, 411.0, 444.0, 512.0, 546.8, 1403.0),
  isotopes={59: Isotope(58.9332002, 1.0, 59)}), Element(28,
  'Ni',
  'Nickel',
  group=10,
  period=4,
 ...
 64:Isotope(63.9279696, 0.009256, 64)}), Element(29,
  'Cu',
  'Copper',
  group=11,
  period=4,
 ...
 65:Isotope(64.9277937, 0.3083, 65)}), Element(30,
  'Zn',
  'Zinc',
  group=12,
  period=4,
  ...
  ionenergy=(9.3942, 17.964, 39.722, 59.4, 82.6, 108.0, 134.0, 174.0, 203.0, 238.0,
             274.0, 310.8, 419.7, 454.0, 490.0, 542.0, 579.0, 619.0, 698.8, 738.0,
             1856.0),
 ...
 70:Isotope(69.925325, 0.0062, 70)}), Element(31,
  'Ga',
  'Gallium',
  group=13,
  period=4,
 ...
 71:Isotope(70.924705, 0.39892, 71)}), Element(32,
  'Ge',
  'Germanium',
  group=14,
  period=4,
 ...
 76:Isotope(75.9214027, 0.0761, 76)}), Element(33,
  'As',
  'Arsenic',
  group=15,
  period=4,
  ...
  isotopes={75: Isotope(74.9215964, 1.0, 75)}), Element(34,
  'Se',
  'Selenium',
  group=16,
  period=4,
 ...
 82:Isotope(81.9167, 0.0873, 82)}), Element(35,
  'Br',
  'Bromine',
  group=17,
  period=4,
 ...
 81:Isotope(80.916291, 0.4931, 81)}), Element(36,
  'Kr',
  'Krypton',
  group=18,
  period=4,
 ...
 86:Isotope(85.9106103, 0.173, 86)}), Element(37,
  'Rb',
  'Rubidium',
  group=1,
  period=5,
 ...
 87:Isotope(86.9091835, 0.2783, 87)}), Element(38,
  'Sr',
  'Strontium',
  group=2,
  period=5,
  ...
  eleconfig='[Kr] 5s2',
  oxistates='2*',
  ionenergy=(5.6949, 11.03, 43.6, 57.0, 71.6, 90.8, 106.0, 122.3, 162.0, 177.0, 324.1),
  isotopes={84:Isotope(83.913425, 0.0056, 84), 
 86:Isotope(85.9092624, 0.0986, 86), 
 87:Isotope(86.9088793, 0.07, 87), 
 88:Isotope(87.9056143, 0.8258, 88)}), Element(39,
  'Y',
  'Yttrium',
  group=3,
  period=5,
  ...
  eleconfig='[Kr] 4d 5s2',
  oxistates='3*',
  ionenergy=(6.2173, 12.24, 20.52, 61.8, 77.0, 93.0, 116.0, 129.0, 146.52, 191.0, 206.0,
             374.0),
  isotopes={89: Isotope(88.9058479, 1.0, 89)}), Element(40,
  'Zr',
  'Zirconium',
  group=4,
  period=5,
 ...
 96:Isotope(95.908276, 0.028, 96)}), Element(41,
  'Nb',
  'Niobium',
  group=5,
  period=5,
  ...
  isotopes={93: Isotope(92.9063775, 1.0, 93)}), Element(42,
  'Mo',
  'Molybdenum',
  group=6,
  period=5,
 ...
 100:Isotope(99.907477, 0.0963, 100)}), Element(43,
  'Tc',
  'Technetium',
  group=7,
  period=5,
  ...
  isotopes={98: Isotope(97.907216, 1.0, 98)}), Element(44,
  'Ru',
  'Ruthenium',
  group=8,
  period=5,
 ...
 104:Isotope(103.90543, 0.1862, 104)}), Element(45,
  'Rh',
  'Rhodium',
  group=9,
  period=5,
  ...
  isotopes={103: Isotope(102.905504, 1.0, 103)}), Element(46,
  'Pd',
  'Palladium',
  group=10,
  period=5,
 ...
 110:Isotope(109.905152, 0.1172, 110)}), Element(47,
  'Ag',
  'Silver',
  group=11,
  period=5,
 ...
 109:Isotope(108.904756, 0.48161, 109)}), Element(48,
  'Cd',
  'Cadmium',
  group=12,
  period=5,
 ...
 116:Isotope(115.904755, 0.0749, 116)}), Element(49,
  'In',
  'Indium',
  group=13,
  period=5,
 ...
 115:Isotope(114.903878, 0.9571, 115)}), Element(50,
  'Sn',
  'Tin',
  group=14,
  period=5,
 ...
 124:Isotope(123.9052746, 0.0579, 124)}), Element(51,
  'Sb',
  'Antimony',
  group=15,
  period=5,
 ...
 123:Isotope(122.9042157, 0.4279, 123)}), Element(52,
  'Te',
  'Tellurium',
  group=16,
  period=5,
 ...
 130:Isotope(129.9062228, 0.3408, 130)}), Element(53,
  'I',
  'Iodine',
  group=17,
  period=5,
  ...
  isotopes={127: Isotope(126.904468, 1.0, 127)}), Element(54,
  'Xe',
  'Xenon',
  group=18,
  period=5,
 ...
 136:Isotope(135.90722, 0.0887, 136)}), Element(55,
  'Cs',
  'Caesium',
  group=1,
  period=6,
  ...
  isotopes={133: Isotope(132.905447, 1.0, 133)}), Element(56,
  'Ba',
  'Barium',
  group=2,
  period=6,
 ...
 138:Isotope(137.905241, 0.71698, 138)}), Element(57,
  'La',
  'Lanthanum',
  group=3,
  period=6,
 ...
 139:Isotope(138.906348, 0.9991, 139)}), Element(58,
  'Ce',
  'Cerium',
  group=3,
  period=6,
 ...
 142:Isotope(141.90924, 0.11114, 142)}), Element(59,
  'Pr',
  'Praseodymium',
  group=3,
  period=6,
  ...
  isotopes={141: Isotope(140.907648, 1.0, 141)}), Element(60,
  'Nd',
  'Neodymium',
  group=3,
  period=6,
 ...
 150:Isotope(149.920887, 0.056, 150)}), Element(61,
  'Pm',
  'Promethium',
  group=3,
  period=6,
  ...
  isotopes={145: Isotope(144.912744, 1.0, 145)}), Element(62,
  'Sm',
  'Samarium',
  group=3,
  period=6,
 ...
 154:Isotope(153.922205, 0.2275, 154)}), Element(63,
  'Eu',
  'Europium',
  group=3,
  period=6,
 ...
 153:Isotope(152.921226, 0.5219, 153)}), Element(64,
  'Gd',
  'Gadolinium',
  group=3,
  period=6,
 ...
 160:Isotope(159.927051, 0.2186, 160)}), Element(65,
  'Tb',
  'Terbium',
  group=3,
  period=6,
  ...
  isotopes={159: Isotope(158.925343, 1.0, 159)}), Element(66,
  'Dy',
  'Dysprosium',
  group=3,
  period=6,
 ...
 164:Isotope(163.929171, 0.2818, 164)}), Element(67,
  'Ho',
  'Holmium',
  group=3,
  period=6,
  ...
  isotopes={165: Isotope(164.930319, 1.0, 165)}), Element(68,
  'Er',
  'Erbium',
  group=3,
  period=6,
 ...
 170:Isotope(169.93546, 0.1493, 170)}), Element(69,
  'Tm',
  'Thulium',
  group=3,
  period=6,
  ...
  isotopes={169: Isotope(168.934211, 1.0, 169)}), Element(70,
  'Yb',
  'Ytterbium',
  group=3,
  period=6,
 ...
 176:Isotope(175.942568, 0.1276, 176)}), Element(71,
  'Lu',
  'Lutetium',
  group=3,
  period=6,
 ...
 176:Isotope(175.9426824, 0.0259, 176)}), Element(72,
  'Hf',
  'Hafnium',
  group=4,
  period=6,
 ...
 180:Isotope(179.9465488, 0.3508, 180)}), Element(73,
  'Ta',
  'Tantalum',
  group=5,
  period=6,
 ...
 181:Isotope(180.947996, 0.99988, 181)}), Element(74,
  'W',
  'Tungsten',
  group=6,
  period=6,
 ...
 186:Isotope(185.954362, 0.2843, 186)}), Element(75,
  'Re',
  'Rhenium',
  group=7,
  period=6,
 ...
 187:Isotope(186.9557508, 0.626, 187)}), Element(76,
  'Os',
  'Osmium',
  group=8,
  period=6,
 ...
 192:Isotope(191.961479, 0.4078, 192)}), Element(77,
  'Ir',
  'Iridium',
  group=9,
  period=6,
 ...
 193:Isotope(192.962924, 0.627, 193)}), Element(78,
  'Pt',
  'Platinum',
  group=10,
  period=6,
 ...
 198:Isotope(197.967876, 0.07163, 198)}), Element(79,
  'Au',
  'Gold',
  group=11,
  period=6,
  ...
  isotopes={197: Isotope(196.966552, 1.0, 197)}), Element(80,
  'Hg',
  'Mercury',
  group=12,
  period=6,
 ...
 204:Isotope(203.973476, 0.0687, 204)}), Element(81,
  'Tl',
  'Thallium',
  group=13,
  period=6,
 ...
 205:Isotope(204.974412, 0.70476, 205)}), Element(82,
  'Pb',
  'Lead',
  group=14,
  period=6,
 ...
 208:Isotope(207.976636, 0.524, 208)}), Element(83,
  'Bi',
  'Bismuth',
  group=15,
  period=6,
  ...
  isotopes={209: Isotope(208.980383, 1.0, 209)}), Element(84,
  'Po',
  'Polonium',
  group=16,
  period=6,
  ...
  oxistates='6, 4*, 2',
  ionenergy=(8.414, ),
  isotopes={209: Isotope(208.982416, 1.0, 209)}), Element(85,
  'At',
  'Astatine',
  group=17,
  period=6,
  ...
  oxistates='7, 5, 3, 1, -1*',
  ionenergy=(),
  isotopes={210: Isotope(209.987131, 1.0, 210)}), Element(86,
  'Rn',
  'Radon',
  group=18,
  period=6,
  ...
  oxistates='2*',
  ionenergy=(10.7485, ),
  isotopes={222: Isotope(222.0175705, 1.0, 222)}), Element(87,
  'Fr',
  'Francium',
  group=1,
  period=7,
  ...
  oxistates='1*',
  ionenergy=(4.0727, ),
  isotopes={223: Isotope(223.0197307, 1.0, 223)}), Element(88,
  'Ra',
  'Radium',
  group=2,
  period=7,
  ...
  isotopes={226: Isotope(226.0254026, 1.0, 226)}), Element(89,
  'Ac',
  'Actinium',
  group=3,
  period=7,
  ...
  oxistates='3*',
  ionenergy=(5.17, 12.1),
  isotopes={227: Isotope(227.027747, 1.0, 227)}), Element(90,
  'Th',
  'Thorium',
  group=3,
  period=7,
  ...
  isotopes={232: Isotope(232.0380504, 1.0, 232)}), Element(91,
  'Pa',
  'Protactinium',
  group=3,
  period=7,
  ...
  oxistates='5*, 4',
  ionenergy=(5.89, ),
  isotopes={231: Isotope(231.0358789, 1.0, 231)}), Element(92,
  'U',
  'Uranium',
  group=3,
  period=7,
 ...
 238:Isotope(238.0507826, 0.992745, 238)}), Element(93,
  'Np',
  'Neptunium',
  group=3,
  period=7,
  ...
  oxistates='6, 5*, 4, 3',
  ionenergy=(6.2657, ),
  isotopes={237: Isotope(237.0481673, 1.0, 237)}), Element(94,
  'Pu',
  'Plutonium',
  group=3,
  period=7,
  ...
  oxistates='6, 5, 4*, 3',
  ionenergy=(6.026, ),
  isotopes={244: Isotope(244.064198, 1.0, 244)}), Element(95,
  'Am',
  'Americium',
  group=3,
  period=7,
  ...
  oxistates='6, 5, 4, 3*',
  ionenergy=(5.9738, ),
  isotopes={243: Isotope(243.0613727, 1.0, 243)}), Element(96,
  'Cm',
  'Curium',
  group=3,
  period=7,
  ...
  oxistates='4, 3*',
  ionenergy=(5.9914, ),
  isotopes={247: Isotope(247.070347, 1.0, 247)}), Element(97,
  'Bk',
  'Berkelium',
  group=3,
  period=7,
  ...
  oxistates='4, 3*',
  ionenergy=(6.1979, ),
  isotopes={247: Isotope(247.070299, 1.0, 247)}), Element(98,
  'Cf',
  'Californium',
  group=3,
  period=7,
  ...
  oxistates='4, 3*',
  ionenergy=(6.2817, ),
  isotopes={251: Isotope(251.07958, 1.0, 251)}), Element(99,
  'Es',
  'Einsteinium',
  group=3,
  period=7,
  ...
  oxistates='3*',
  ionenergy=(6.42, ),
  isotopes={252: Isotope(252.08297, 1.0, 252)}), Element(100,
  'Fm',
  'Fermium',
  group=3,
  period=7,
  ...
  oxistates='3*',
  ionenergy=(6.5, ),
  isotopes={257: Isotope(257.095099, 1.0, 257)}), Element(101,
  'Md',
  'Mendelevium',
  group=3,
  period=7,
  ...
  oxistates='3*',
  ionenergy=(6.58, ),
  isotopes={258: Isotope(258.098425, 1.0, 258)}), Element(102,
  'No',
  'Nobelium',
  group=3,
  period=7,
  ...
  oxistates='3, 2*',
  ionenergy=(6.65, ),
  isotopes={259: Isotope(259.10102, 1.0, 259)}), Element(103,
  'Lr',
  'Lawrencium',
  group=3,
  period=7,
  ...
  oxistates='3*',
  ionenergy=(4.9, ),
  isotopes={262: Isotope(262.10969, 1.0, 262)}), Element(104,
  'Rf',
  'Rutherfordium',
  group=4,
  period=7,
  ...
  oxistates='*',
  ionenergy=(6.0, ),
  isotopes={261: Isotope(261.10875, 1.0, 261)}), Element(105,
  'Db',
  'Dubnium',
  group=5,
  period=7,
  ...
  oxistates='*',
  ionenergy=(),
  isotopes={262: Isotope(262.11415, 1.0, 262)}), Element(106,
  'Sg',
  'Seaborgium',
  group=6,
  period=7,
  ...
  oxistates='*',
  ionenergy=(),
  isotopes={266: Isotope(266.12193, 1.0, 266)}), Element(107,
  'Bh',
  'Bohrium',
  group=7,
  period=7,
  ...
  oxistates='*',
  ionenergy=(),
  isotopes={264: Isotope(264.12473, 1.0, 264)}), Element(108,
  'Hs',
  'Hassium',
  group=8,
  period=7,
  ...
  oxistates='*',
  ionenergy=(),
  isotopes={269: Isotope(269.13411, 1.0, 269)}), Element(109,
  'Mt',
  'Meitnerium',
  group=9,
  period=7,
...
PERIODS = {1:'K', 
 2:'L',  3:'M',  4:'N',  5:'O',  6:'P',  7:'Q'}
BLOCKS = {'s':'', 
 'g':'',  'f':'',  'd':'',  'p':''}
GROUPS = {1:('IA', 'Alkali metals'), 
                ...
                for series in sorted(SERIES):
                    ...
                    for ele in ELEMENTS:
                        sql.append('\n        INSERT INTO "element" VALUES (%i, \'%s\', \'%s\', %i, %i, \'%s\', %i,\n            %.10f, %.4f, %.4f, %.4f, %.4f,\n            %.4f, %.4f, %.4f, %.8f,\n            \'%s\', \'%s\',\n            \'%s\'\n        );' % (
                         ...
                         ele.eleconfig,
                         ele.oxistates,
                         word_wrap((ele.description.replace("'", "''").replace('"', '""')),
                           linelen=74,
                           indent=0,
                           joinstr='\n ')))
                    else:
