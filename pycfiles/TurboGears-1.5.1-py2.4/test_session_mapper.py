...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\tests\test_session_mapper.py
# Compiled at: 2011-05-26 13:35:50
...
from turbogears.database import bind_metadata, metadata, session, session_mapper, set_db_uri
...
class TestSessionMapper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        bind_metadata()
        self.users_table = Table('users', metadata, Column('user_id', Integer, primary_key=True), Column('user_name', String(40)), Column('password', String(10)))
        metadata.create_all()
    ...
    def test_no_contructor(self):
        ...
        self.assertRaises(TypeError, RawUser, user_id=4, user_name='Jonny', password='Walker')
    ...
    def test_validate(self):
        ...
        self.assertRaises(TypeError, User, user_id=4, user_name='Falken', nickname='Steve')
