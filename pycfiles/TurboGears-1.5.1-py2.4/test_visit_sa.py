...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\identity\tests\test_visit_sa.py
# Compiled at: 2011-07-14 06:55:46
...
class TestVisit(TestCase):
    ...
    def setUp(self):
        ...
        config.update({'visit.on': True, 'visit.manager': 'sqlalchemy', 'visit.timeout': 50})
...
class TestSetVisitManager(TestCase):
    ...
    def test_visit_manager_from_class(self):
        ...
        config.update({'visit.manager': 'turbogears.identity.tests.test_visit_sa.MyVisitManager'})
        testutil.start_server()
