...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\tests\test_testutil.py
...
def test_unicode_response():
    ...
    assert bs.response == ('ሴ顶㑖').encode('utf-8')
    assert bs.unicode_response == 'ሴ顶㑖'
