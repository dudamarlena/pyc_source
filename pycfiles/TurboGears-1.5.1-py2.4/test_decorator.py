...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\tests\test_decorator.py
...
class TestDecorator(unittest.TestCase):
    ...
    def test_history(self):
        ...
        self.assertTrue(func_composition(foo)[:-1] == func_composition(func_composition(foo)[(-2)]))
    ...
    def test_signature(self):
        self.assertTrue(make_weak_signature(bar)[1:3] == ('_decorator__varargs', '_decorator__kwargs'))
