...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\decorator.py
# Compiled at: 2011-03-26 09:20:22
"""Decorator tools"""
__all__ = [
 'decorate', 'make_weak_signature', 'compose', 'decorator', 'weak_signature_decorator', 'simple_decorator', 'simple_weak_signature_decorator', 'func_id', 'func_eq', 'func_original', 'func_composition']
import itertools
...
def decorate(func, caller, signature=None):
    ...
    """
    (argnames, varargs, kwargs, defaults) = signature is None and getargspec(func) or signature
    if defaults is None:
        defaults = ()
