...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\i18n\data\te_IN.py
# Compiled at: 2011-03-26 09:19:59
languages = {'te': 'తెలుగు'}
countries = {'IN': 'భారత దేళ౦'}
months = [
...
numericSymbols = {'group': ',', 'nativeZeroDigit': '౦', 'exponential': 'E', 'perMille': '‰', 'nan': '�', 'decimal': '.', 'percentSign': '%', 'list': ';', 'patternDigit': '#', 'plusSign': '+', 'infinity': '∞', 'minusSign': '-'}