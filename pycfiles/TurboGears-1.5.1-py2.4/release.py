...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\release.py
# Compiled at: 2011-07-14 15:32:17
...
download_url = 'http://www.turbogears.org/%s/downloads/%s/index' % (('.').join(version.split('.', 2)[:2]), version)
dependency_links = [
 download_url]
