...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\i18n\tests\test_format.py
# Compiled at: 2011-07-14 06:01:57
from datetime import datetime
from turbogears.i18n.format import *
dt = datetime(2005, 2, 5)
...
def test_format_date():
    assert format_date(dt, 'long', 'eo') == '2005-februaro-05'
    assert format_date(dt, 'medium', 'eo') == '2005-feb-05'
    assert format_date(dt, 'short', 'eo') == '05-02-05'
    assert format_date(dt, 'full', 'eo') == 'sabato, 05-a de februaro 2005'
    assert format_date(dt, 'long', 'de') == '05. Februar 2005'
    assert format_date(dt, 'medium', 'de') == '05.02.2005'
    assert format_date(dt, 'short', 'de') == '05.02.05'
    assert format_date(dt, 'full', 'de') == 'Samstag, 05. Februar 2005'
    assert format_date(dt, 'short', 'en', date_format='day %d of %%(monthname)s') == 'day 05 of February'
