...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbogears\i18n\data\gu_IN.py
...
numericSymbols = {'group': ',', 'nativeZeroDigit': '૦', 'exponential': 'E', 'perMille': '‰', 'nan': '�', 'decimal': '.', 'percentSign': '%', 'list': ';', 'patternDigit': '#', 'plusSign': '+', 'infinity': '∞', 'minusSign': '-'}