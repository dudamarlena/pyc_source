...
# [GCC 8.4.0]
# Embedded file name: /home/mafju/current/icm/iis_cr/vipe/vipe/pipeline/pipeline_data.py
...
class PipelineData:
        ...
        for data_id, data_info in data_dict.items():
            ...
            for elem_name, addresses in data_info.items():
                ...
                for address_str in addresses:
                    ...
                    result_address = DataAddress(address_elems[0], address_elems[1])
    ...
    def get_ids(self):
        ...
        """
        return self._PipelineData__data.keys()
    ...
    def get_info(self, data_id):
        ...
        Returns:
            DataInfo
        """
        return self._PipelineData__data[data_id]
...
class DataInfo:
    __doc__ = 'Information related to a data ID'
