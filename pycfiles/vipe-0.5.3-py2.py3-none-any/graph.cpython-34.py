...
# [GCC 8.4.0]
# Embedded file name: /home/mafju/current/icm/iis_cr/vipe/vipe/oozie/graph.py
# Compiled at: 2016-02-15 13:44:30
# Size of source mod 2**32: 9162 bytes
__author__ = 'Mateusz Kobos mkobos@icm.edu.pl'
import yaml, vipe.common.serialization
from vipe.common.utils import default_eq

class OozieGraph(yaml.YAMLObject):
    __doc__ = 'A structure corresponding directly to Oozie XML file'
    yaml_tag = '!OozieGraph'
...
class OtherAction(Action):
    __doc__ = 'Action that is not recognized by the program'
...
class SubworkflowAction(Action):
    ...
    def __init__(self, ok_node, error_node, configuration, app_path, propagate_configuration):
        """
        Args:
...
class JavaAction(Action):
    ...
    def __init__(self, ok_node, error_node, configuration, main_class, args, captures_output):
        """
        Args:
...
class PigAction(Action):
    ...
    def __init__(self, ok_node, error_node, configuration, script, params, arguments):
        """
        Args:
...
class HiveAction(Action):
    ...
    def __init__(self, ok_node, error_node, configuration, script, params):
        """
        Args:
