...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/qqqfome/backend.py
# Compiled at: 2016-02-13 01:12:35
...
def calc_message(pattern, me, you, new_follower_num):
    ...
    your_name = you.name
    return pattern.format(now=china_now, my_name=my_name, follower_num=follower_num, your_name=your_name)
            ...
            try:
                for follower in me.followers:
                    ...
                    if db.is_in_db(conn, follower.id):
                        ...
                        try:
                            message = calc_message(msg, me, follower, new_follower_num)
                            new_follower_num += 1
                        except Exception as e:
                            L.exception(e)
                            message = msg
