...
# Embedded file name: build/bdist.linux-x86_64/egg/__unit_test__/ally/core/impl/processor/decoder.py
...
class TestModel(unittest.TestCase):
    ...
    def testDecode(self):
        ...
        self.assertRaises(InputError, resolve, path=deque(('ModelKey', 'Name')), value='The name', target=args, **context)
