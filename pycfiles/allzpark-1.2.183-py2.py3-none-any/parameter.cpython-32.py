...
# Embedded file name: build/bdist.linux-x86_64/egg/__unit_test__/ally/core/http/impl/processor/parameter.py
...
class IService:
    ...
    @call
    def get(self, mainId: MainModel.Id, scheme: Scheme, locale: List(Locale), another: AModel.Key=None, q: QMainModel=None,
            qa: QAModel=None, offset: int=0, limit: int=None) -> MainModel:
        """
        Nothing.
        """
        pass
...
class TestParameter(unittest.TestCase):
    ...
    def testEncode(self):
        ...
        self.assertEqual([('qa.something', 'startAndEnd'), ('qa.something.until', 'until'), ('qa.name', 'Gabriel'),
         ('offset', '20'), ('limit', '0'), ('asc', 'name'), ('desc', 'qa.name'), ('asc', 'when')], list(resolve(value=args, **context)))
