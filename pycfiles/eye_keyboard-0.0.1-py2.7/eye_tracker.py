...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/eye_keyboard/eye_tracker.py
# Compiled at: 2015-11-24 14:38:44
...
class EyeTracker(object):
    ...
    def __init__(self, camera_size):
        ...
        self.settings = {'pupilcol': (0, 0, 0), 
           ...
           'pupilpos': (-1, -1), 
           'pupilrect': pygame.Rect(self.camera_size[0] / 8 - 50, self.camera_size[1] / 8 - 25, 25, 12), 
           'pupilbounds': [
                         0, 0, 0, 0], 
           '': None}
        return
    ...
    def give_me_all(self, pupilrect=False):
        ...
        pygame.transform.threshold(thresholded, snapshot, self.settings['pupilcol'], th, self.settings['nonthresholdcol'], 1)
    ...
    def _find_pupil(self, thresholded, pupilrect=False):
        ...
        if pupilrect:
            pupilcenter = (
             pupilcenter[0] + ox, pupilcenter[1] + oy)
        ...
        return (
         self.settings['pupilpos'], pupil.count(), self.settings['pupilbounds'])