...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trec_dd/scorer/precision_at_recall.py
...
def precision_at_recall(run, label_store):
    ...
    run['scores']['precision_at_recall'] = {'scores_by_topic': scores_by_topic, 'macro_average': macro_avg}