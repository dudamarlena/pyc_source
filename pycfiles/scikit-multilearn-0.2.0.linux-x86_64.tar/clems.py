...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/skmultilearn/embedding/clems.py
# Compiled at: 2018-12-10 04:54:00
...
class CLEMS(BaseEstimator):
    ...
    def fit_transform(self, X, y):
        ...
        return (
         X, y_unique_embedded[neighboring_embeddings_indices])