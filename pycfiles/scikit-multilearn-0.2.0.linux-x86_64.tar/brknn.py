...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/skmultilearn/adapt/brknn.py
...
class BRkNNbClassifier(_BinaryRelevanceKNN):
    ...
    def _predict_variant(self, X):
        ...
        top_labels = np.argpartition(self.confidences_, kth=min(avg_labels + [len(self.confidences_[0])]), axis=1).tolist()
