...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/skmultilearn/cluster/networkx.py
# Compiled at: 2018-09-03 19:16:42
from __future__ import absolute_import
import community, networkx as nx
...
class NetworkXLabelGraphClusterer(LabelGraphClustererBase):
    ...
    def fit_predict(self, X, y):
        ...
        if self.method == 'louvain':
            ...
            return np.array(_membership_to_list_of_communities(memberships, 1 + max(memberships)))
        else:
