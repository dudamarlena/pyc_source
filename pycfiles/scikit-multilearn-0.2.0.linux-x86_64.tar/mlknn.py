...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/skmultilearn/adapt/mlknn.py
...
class MLkNN(MLClassifierBase):
    ...
    def _compute_cond(self, X, y):
        ...
        neighbors = [ a[self.ignore_first_neighbours:] for a in self.knn_.kneighbors(X, self.k + self.ignore_first_neighbours, return_distance=False)
                    ]
        ...
        return (
         cond_prob_true, cond_prob_false)
