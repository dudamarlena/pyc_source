...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/skmultilearn/embedding/classifier.py
...
class EmbeddingClassifier(ProblemTransformationBase):
    ...
    def __init__(self, embedder, regressor, classifier, regressor_per_dimension=False, require_dense=None):
        ...
        self.copyable_attrs = [
         'embedder', 'regressor', 'classifier', 'regressor_per_dimension', 'require_dense']
        return
