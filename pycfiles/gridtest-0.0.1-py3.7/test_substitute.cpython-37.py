...
# Compiled at: 2020-05-03 17:10:08
...
def test_substitute_gridtest():
    ...
    assert '{% tmp_dir %}' in runner.config['temp']['temp.create_directory'][0]['args']['dirname']
    assert '{% tmp_path %}' in runner.config['temp']['temp.write_file'][0]['args']['filename']
