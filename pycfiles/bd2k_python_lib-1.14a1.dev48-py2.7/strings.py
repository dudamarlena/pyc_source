...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bd2k/util/strings.py
...
def to_english(iterable, separator=', ', conjunction=' and ', empty='empty', wrapper=None, pair_conjunction=None):
    """
