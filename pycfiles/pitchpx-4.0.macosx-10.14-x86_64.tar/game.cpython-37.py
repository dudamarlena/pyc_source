...
# [GCC 8.4.0]
# Embedded file name: /Users/shinyorke/python_venv/pitchpx/lib/python3.7/site-packages/pitchpx/game/game.py
...
class Game(object):
    ...
    def _get_retro_id(cls, home_team_id, timestamp, game_number):
        ...
        :return: retro id
        """
        return ('{home_team_id}{year}{month}{day}{game_number}'.format)(home_team_id=home_team_id.upper(), 
         year=timestamp.year, 
