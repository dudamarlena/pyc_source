...
# [GCC 8.4.0]
# Embedded file name: /Users/shinyorke/python_venv/pitchpx/lib/python3.7/site-packages/pitchpx/mlbam.py
# Compiled at: 2019-04-11 02:01:48
# Size of source mod 2**32: 8725 bytes
import os, re, csv, yaml, click, logging
...
class MlbAm(object):
    ...
    def _download(self, timestamp):
        ...
        boxscores, actions = [], []
        timestamp_params = {'year':str(timestamp.year), 
