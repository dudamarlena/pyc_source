...
# [GCC 8.4.0]
# Embedded file name: /Users/shinyorke/python_venv/pitchpx/lib/python3.7/site-packages/pitchpx/game/inning.py
# Compiled at: 2018-12-12 04:43:08
# Size of source mod 2**32: 28624 bytes
import logging
...
class AtBat(object):
    ...
    def _get_bases(cls, ab):
        ...
        return (
         ''.join(start_bases), ''.join(end_bases))
    ...
    def pa(cls, ab, game, rosters, inning_number, inning_id, out_ct, hit_location):
        ...
        location_key = Inning.HITLOCATION_KEY_FORMAT.format(inning=inning_number,
          des=event_tx,
          pitcher=pit_mlbid,
          batter=bat_mlbid)
...
class InningAction(object):
    ...
    def action(cls, action, game, rosters, inning_number, inning_id):
        ...
        try:
            ...
            try:
                logging.error(('Attribute Error(retro_game_id:{retro_game_id} player_mlbid:{player_mlbid})'.format)(retro_game_id=game.retro_game_id, 
...
class Inning(object):
    ...
    def _read_hit_chart_data(cls, soup):
        ...
        for hip in soup.find_all('hip'):
            key = cls.HITLOCATION_KEY_FORMAT.format(inning=(MlbamUtil.get_attribute_stats(hip, 'inning', int)),
            ...
            hit_chart[key] = {'hit_x':MlbamUtil.get_attribute_stats(hip, 'x', float, None), 
