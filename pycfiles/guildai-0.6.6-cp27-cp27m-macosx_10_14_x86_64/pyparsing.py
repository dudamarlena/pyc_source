...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_vendor/pyparsing.py
    ...
    def getName(self):
        ...
        if self.__name:
            ...
            if self.__parent:
                ...
                if len(self) == 1 and len(self.__tokdict) == 1 and next(iter(self.__tokdict.values()))[0][1] in (0,
                                                                                                                 -1):
...
def oneOf(strs, caseless=False, useRegex=True):
    ...
    if isinstance(strs, basestring):
        ...
        if isinstance(strs, collections.Iterable):
            symbols = list(strs)
        else:
