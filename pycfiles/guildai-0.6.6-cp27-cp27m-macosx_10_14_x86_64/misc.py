...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_internal/utils/misc.py
# Compiled at: 2019-09-10 15:18:29
from __future__ import absolute_import
import contextlib, errno, io, locale, logging as std_logging, os, posixpath, re, shutil, stat, subprocess, sys, tarfile, zipfile
...
from pip._internal.locations import running_under_virtualenv, site_packages, user_site, virtualenv_no_global, write_delete_marker_file
if PY2:
        ...
        for info in zip.infolist():
            ...
            if fn.endswith('/') or fn.endswith('\\'):
                ...
                try:
                    ...
                    if mode and stat.S_ISREG(mode) and mode & 73:
...
def call_subprocess(cmd, show_stdout=True, cwd=None, on_returncode='raise', command_desc=None, extra_environ=None, unset_environ=None, spinner=None):
    ...
    if proc.returncode:
        if on_returncode == 'raise':
            ...
            raise InstallationError('Command "%s" failed with error code %s in %s' % (
