...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_internal/download.py
...
from pip._internal.utils.misc import ARCHIVE_EXTENSIONS, ask_path_exists, backup_dir, call_subprocess, consume, display_path, format_size, get_installed_version, rmtree, splitext, unpack_file
