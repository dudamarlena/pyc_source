...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_vendor/packaging/version.py
...
def _parse_local_version(local):
    ...
    if local is not None:
        return tuple((part.lower() if 1 else int(part)) for part in _local_version_separators.split(local) if not part.isdigit())
    else:
        return
