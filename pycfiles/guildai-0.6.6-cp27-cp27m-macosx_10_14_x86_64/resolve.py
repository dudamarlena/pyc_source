...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_internal/resolve.py
...
class Resolver(object):
    ...
    def __init__(self, preparer, session, finder, wheel_cache, use_user_site, ignore_dependencies, ignore_installed, ignore_requires_python, force_reinstall, isolated, upgrade_strategy):
    ...
    def _resolve_one(self, requirement_set, req_to_install):
        ...
        def add_req(subreq, extras_requested):
            sub_install_req = InstallRequirement.from_req(str(subreq), req_to_install, isolated=self.isolated, wheel_cache=self.wheel_cache)
