...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_internal/req/req_set.py
    ...
    def add_requirement(self, install_req, parent_req_name=None, extras_requested=None):
        ...
        if not install_req.match_markers(extras_requested):
            ...
            if not install_req.is_direct == (parent_req_name is None):
                ...
                if parent_req_name is None and existing_req and not existing_req.constraint and existing_req.extras == install_req.extras and not existing_req.req.specifier == install_req.req.specifier:
