...
# [GCC 8.4.0]
# Embedded file name: ./guild/external/pip/_internal/pep425tags.py
# Compiled at: 2019-09-10 15:18:29
"""Generate and work with PEP 425 Compatibility Tags."""
from __future__ import absolute_import
import distutils.util, logging, platform, re, sys, sysconfig, warnings
...
def get_supported(versions=None, noarch=False, platform=None, impl=None, abi=None):
    ...
    if not noarch:
        ...
        if arch.startswith('macosx'):
            ...
            if platform is None and is_manylinux1_compatible():
                arches = [
