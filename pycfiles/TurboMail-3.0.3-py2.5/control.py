...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/turbomail/control.py
# Compiled at: 2009-08-26 19:50:12
...
"""
import logging, warnings, pkg_resources
...
class ControlClass(object):
    ...
    def send(self, message):
        ...
        if isinstance(message, dict):
            ...
            text = 'Sending pre-generated messages in dicts is deprecated, ' + 'please use WrappedMessage instead.'
            warnings.warn(text, category=DeprecationWarning)
            message = WrappedMessage(message['sender'], message['recipients'], message['message'])
