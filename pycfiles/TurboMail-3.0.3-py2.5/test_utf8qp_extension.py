...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/tests/test_utf8qp_extension.py
# Compiled at: 2009-08-24 19:48:22
"""Test the TurboMail Message class."""
import email, logging, unittest
...
class TestUTF8QPExtension(unittest.TestCase):
    ...
    def build_message(self):
        msg = Message('from@example.com', 'to@example.com', subject='Test message subject.', plain='This is a test message plain text body.')
        return msg

    def setUp(self):
        self._old_config = interface.config.copy()
        self.config = {'mail.on': True}
        self.fake_setuptools = {'immediate': ImmediateManager, 'debug': DebugTransportFactory, 
