...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/tests/test_wrapped_message.py
...
class TestWrappedMessage(unittest.TestCase):
    ...
    def setUp(self):
        self.message = WrappedMessage(('Author', 'author@example.com'), ('Recipient',
                                                                         'recipient@example.com'), rfc822_msg)
