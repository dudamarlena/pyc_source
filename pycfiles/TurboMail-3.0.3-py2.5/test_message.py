...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/tests/test_message.py
# Compiled at: 2009-11-06 20:39:08
"""Test the TurboMail Message class."""
import calendar
from datetime import datetime, timedelta
import email, logging, re, time, unittest
...
class TestBasicMessage(unittest.TestCase):
    ...
    def build_message(self):
        return Message(author=('Author', 'author@example.com'), to=('Recipient', 'recipient@example.com'), subject='Test message subject.', plain='This is a test message plain text body.')
    ...
    def test_recipients_collection(self):
        ...
        self.assertEqual(['recipient@example.com', 'copied@example.com'], self.message.recipients.addresses)
