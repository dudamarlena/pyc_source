...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/tests/test_turbogears_config_compatibility.py
...
class TestTurboGearsConfigWorks(SMTPTestCase):
    ...
    def setUp(self):
        real_config = {'mail.on': True, 'mail.manager': 'immediate', 'mail.transport': 'smtp', 
           'mail.brand': False}
