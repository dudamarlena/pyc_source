...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/turbomail/transports/smtp.py
# Compiled at: 2009-08-26 21:50:17
...
class SMTPTransport(Transport):
    ...
    def __init__(self):
        ...
        self.max_number_of_messages_per_connection = self.config_get('mail.smtp.max_messages_per_connection', default=1, tm2_key='jobs')
