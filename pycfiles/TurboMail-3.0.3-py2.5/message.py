...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/turbomail/message.py
# Compiled at: 2009-11-06 20:22:01
        ...
        if name in kw:
            ...
            if value == NoDefault and old_configkey != None:
                ...
                if value != NoDefault:
                    ...
                    warnings.warn(msg % (old_configkey, configkey), category=DeprecationWarning)
            if value == NoDefault:
                value = default
        return value
...
class Message(BaseMessage):
    ...
    def __init__(self, author=None, to=None, subject=None, **kw):
        ...
        self.encoding = kwpop('encoding', default='us-ascii', old_configkey='mail.encoding')
    ...
    def mime(self):
        ...
        if not author and sender:
            msg = 'Please specify the author using the "author" property. ' + 'Using "sender" for the From header is deprecated!'
