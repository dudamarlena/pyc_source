...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/tests/exemplars_test.py
...
MAP_SIMPLE = frozendict({Keyword('a'): 1, Keyword('b'): 2, 
   Keyword('c'): 3})
MAP_MIXED = frozendict({Keyword('a'): 1, Keyword('b'): 'a string', 
   Keyword('c'): true})
...
exemplar('doubles_interesting', (-3.14159, 3.14159, 400000000000.0, 299800000.0, 6.626e-34))
...
exemplar('vector_1935_keywords_repeated_twice', tuple(array_of_symbools(1935, 3870)))
exemplar('vector_1936_keywords_repeated_twice', tuple(array_of_symbools(1936, 3872)))
exemplar('vector_1937_keywords_repeated_twice', tuple(array_of_symbools(1937, 3874)))
exemplar('map_10_items', hash_of_size(10))
exemplar('maps_two_char_sym_keys', ({Symbol('aa'): 1, Symbol('bb'): 2}, {Symbol('aa'): 3, Symbol('bb'): 4}, {Symbol('aa'): 5, Symbol('bb'): 6}))
exemplar('maps_three_char_sym_keys', ({Symbol('aaa'): 1, Symbol('bbb'): 2}, {Symbol('aaa'): 3, Symbol('bbb'): 4}, {Symbol('aaa'): 5, Symbol('bbb'): 6}))
exemplar('maps_four_char_sym_keys', ({Symbol('aaaa'): 1, Symbol('bbbb'): 2}, {Symbol('aaaa'): 3, Symbol('bbbb'): 4}, {Symbol('aaaa'): 5, Symbol('bbbb'): 6}))
