...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/transit/decoder.py
...
default_options = {'decoders': {'_': rh.NoneHandler, ':': rh.KeywordHandler, 
                '$': rh.SymbolHandler, 
                '?': rh.BooleanHandler, 
                'i': rh.IntHandler, 
                'd': rh.FloatHandler, 
...
ground_decoders = {'_': rh.NoneHandler, '?': rh.BooleanHandler, 
   'i': rh.IntHandler, 
   "'": rh.IdentityHandler}
