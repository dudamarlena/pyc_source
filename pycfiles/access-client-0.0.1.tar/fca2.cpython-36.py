...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/access/fca/fca2.py
...
def two_stage_fca(demand_df, supply_df, cost_df, max_cost=None, demand_index='geoid', demand_name='demand', supply_index='geoid', supply_name='supply', cost_origin='origin', cost_dest='dest', cost_name='cost', weight_fn=None, normalize=False):
    """
    ...
    two_stage_fca_series = weighted_catchment(supply_to_total_demand_frame, cost_df, max_cost, cost_source=cost_dest,
