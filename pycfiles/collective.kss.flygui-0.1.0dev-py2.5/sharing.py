...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/collective/kss/flygui/browser/sharing.py
...
class SharingView(BaseSharingView):
    ...
    def role_settings(self):
        ...
        existing_users = set([ u['id'] for u in existing_settings if u['type'] == 'user'
                             ])
    ...
    def selected_users(self):
        ...
        for principal_id in principal_ids:
            ...
            if principal['principal_type'] == 'user':
                ...
                info.append(dict(id=principal_id, title=user.getProperty('fullname') or user.getId() or principal_id, type='user', roles=roles))
            else:
                ...
                info.append(dict(id=principal_id, title=group.getGroupTitleOrName(), type='group', roles=roles))
