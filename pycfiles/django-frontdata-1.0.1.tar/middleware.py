...
# [GCC 8.4.0]
# Embedded file name: /home/alex/projects/vk-board/src/jsonify/middleware.py
# Compiled at: 2015-06-20 19:07:08
import re
...
class JsonifyMiddleware(object):
    ...
    def render_data(self, data):
        return render_to_string('jsonify/inject.html', {'data': dict(data)})