...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dap/util/http.py
# Compiled at: 2008-12-21 21:13:07
import re, httplib2
...
def openurl(url, cache=None, username=None, password=None):
    h = httplib2.Http(cache=cache, timeout=dap.lib.TIMEOUT, proxy_info=dap.lib.PROXY)
