...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/dccs/max/core/scene.py
...
def check_node(node_name):
    ...
    """
    if not python.is_str(node_name):
        if type(node_name) is not MaxPlus.INode:
...
def node_handle_exists(node_id):
    ...
    :return: bool
    """
    native_node = get_node_by_handle(long(node_id))
...
def get_selected_nodes():
    ...
    return (
     selected_nodes, selected_nodes_count)
