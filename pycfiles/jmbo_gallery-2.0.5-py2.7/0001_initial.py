...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gallery/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gallery_galleryimage', (
         (
          'galleryitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gallery.GalleryItem'], unique=True, primary_key=True)),))
        db.send_create_signal('gallery', ['GalleryImage'])
        db.create_table('gallery_videoembed', (
         (
          'galleryitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gallery.GalleryItem'], unique=True, primary_key=True)),
         (
          'embed', self.gf('django.db.models.fields.TextField')())))
        db.send_create_signal('gallery', ['VideoEmbed'])
        db.create_table('gallery_videofile', (
         (
          'galleryitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gallery.GalleryItem'], unique=True, primary_key=True)),
         (
          'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))))
        db.send_create_signal('gallery', ['VideoFile'])

    def backwards(self, orm):
        db.delete_table('gallery_gallery')
        db.delete_table('gallery_galleryitem')
        db.delete_table('gallery_galleryimage')
        db.delete_table('gallery_videoembed')
        db.delete_table('gallery_videofile')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'gallery.gallery': {'Meta': {'ordering': "('-created',)", 'object_name': 'Gallery', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
