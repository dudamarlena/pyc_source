...
# Embedded file name: build/bdist.macosx-10.11-intel/egg/corenlp_xml/document.py
# Compiled at: 2016-11-14 20:54:10
...
class Sentence:
    ...
    def phrase_strings(self, phrase_type):
        ...
        """
        return [ (' ').join(subtree.leaves()) for subtree in self.subtrees_for_phrase(phrase_type) ]
    ...
    def semantic_head(self):
        ...
        """
        return self.basic_dependencies.links_by_type('root')[0].dependent
