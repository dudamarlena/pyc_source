...
# [GCC 8.4.0]
# Embedded file name: /home/tonym/work/unicore/unicore.languages/unicore/languages/constants.py
# Compiled at: 2015-11-10 03:53:32
LANGUAGES = {'aar': 'Afar', 'abk': 'Abkhazian', 
   'ace': 'Achinese', 
   'ach': 'Acoli', 
   'ada': 'Adangme', 
   'afa': 'Afro-Asiatic', 
...
COUNTRIES = {'AF': 'Afghanistan', 
   ...
   'ZM': 'Zambia', 
   'ZW': 'Zimbabwe'}
COUNTRY_CHOICES = [ (code, name) for code, name in sorted(COUNTRIES.items(), key=lambda x: x[1])
                  ]