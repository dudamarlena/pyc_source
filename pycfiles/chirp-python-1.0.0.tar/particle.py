...
class smc(object):
    ...
    def __init__(self, likelihood, proposal, resample_threshold=0.5, min_loglike=-100, **kwargs):
        ...
        """
        assert likelihood.shape[1] > proposal.shape[1], 'Likelihood array must have at least 1 more row than proposal array'
