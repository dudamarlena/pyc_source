...
# Embedded file name: build\bdist.win32\egg\chirp\compare\plugins.py
...
methods = pluginset('chirp.compare.method', (('pitch_dtw', pitch_dtw),
 ...
 (
  'spcc', spcc),
 (
  'spec_dtw', spec_dtw)), 'comparison methods')
...
storage = pluginset('chirp.compare.storage', (('sqlite', sqlite_storage),
 (
  'file', file_storage)), 'storage formats')