...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/setupmeta/scm.py
# Compiled at: 2020-04-30 20:17:34
import os, re, setupmeta
RE_GIT_DESCRIBE = re.compile('^v?(.+?)(-\\d+)?(-g\\w+)?(-dirty)?$', re.IGNORECASE)
...
class Scm:
    ...
    def get_output(self, *args, **kwargs):
        ...
        return setupmeta.run_program(self.program, capture=capture, cwd=cwd, *args, **kwargs)
    ...
    def run(self, commit, *args, **kwargs):
        ...
        return self.get_output(capture=capture, fatal=fatal, dryrun=(not commit), *args, **kwargs)
