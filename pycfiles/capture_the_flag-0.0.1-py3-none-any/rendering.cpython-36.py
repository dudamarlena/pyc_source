...
# [GCC 8.4.0]
# Embedded file name: /home/christian/documented/ctf/ctf/rendering.py
# Compiled at: 2020-04-23 19:16:09
# Size of source mod 2**32: 11215 bytes
...
class Renderer(object):
    __doc__ = '`Renderer` class, handles the rendering of a `Ctf` game.'
            ...
            if isinstance(v, Unit):
                ...
                if v.team == 1:
                    ...
                    pyglet.graphics.draw(4, gl.GL_QUADS, (
                     ...
                     'c3B', unit_colors))
                    unit_label = pyglet.text.Label((str(v.idx)),
                ...
                if isinstance(v, Flag):
                    flag_coordinates = [self.x_pad + unit_x * self.box + self.unit_pad * 2,
    ...
    def draw_scoreboard_logs(self, dims, score, logs, key):
        ...
        pyglet.graphics.draw(4, gl.GL_QUADS, (
         ...
         'c3B', bar_1_colors))
        bar_2_top = self.height - self.y_pad - score_label.content_height - 18
        bar_2_bottom = self.height - self.y_pad - score_label.content_height * 2 - 18
        bar_2_coordinates = [
         score_x - 4,
         bar_2_bottom,
         score_x - 4,
        ...
        pyglet.graphics.draw(4, gl.GL_QUADS, (
         ...
         'c3B', bar_2_colors))
        score_1_label = pyglet.text.Label((str(score[1])),
          font_name='Press Start 2P',
          font_size=24,
          ...
          color=(255, 0, 0, 255))
        score_1_label.draw()
        score_2_label = pyglet.text.Label((str(score[2])),
          font_name='Press Start 2P',
          font_size=24,
          x=(score_x + score_label.content_width / 4.0),
          y=bar_2_top,
        ...
        if len(logs) > 0:
            for i, log in enumerate(reversed(logs)):
                ...
                log_label = pyglet.text.Label(('{}: {}'.format(log['unit'], log['direction'])),
                  font_name='Press Start 2P',
                  font_size=16,
                  x=score_x,
                  y=log_y,
