...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dronekit/mavlink.py
# Compiled at: 2019-03-14 01:22:55
from __future__ import print_function
import logging, time, socket, errno, sys, os, platform, copy
...
class MAVConnection(object):
    ...
    def __init__(self, ip, baud=115200, target_system=0, source_system=255, source_component=0, use_native=False):
        ...
        self.master.mav = mavutil.mavlink.MAVLink(MAVWriter(self.out_queue), srcSystem=self.master.source_system, srcComponent=self.master.source_component, use_native=use_native)
