...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/test_WS2801_RPI.py
# Compiled at: 2018-01-02 08:48:33
"""Test module for Unit Tests of WS2801_RPI."""
import unittest, sys, WS2801_RPI
...
class DataSetGetTestCase(unittest.TestCase):
    ...
    def test_set_led_colors_buffer_list_multi_call(self, mock_spi):
        ...
        expected_result = [255, 255, 255] + [0, 0, 0] * (WS2801_RPI.get_number_of_leds() - 1)
