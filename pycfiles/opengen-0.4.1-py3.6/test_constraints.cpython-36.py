...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/opengen/test/test_constraints.py
# Compiled at: 2019-10-16 17:13:36
# Size of source mod 2**32: 12009 bytes
import opengen as og, unittest, casadi.casadi as cs, numpy as np, math
...
class ConstraintsTestCase(unittest.TestCase):
    ...
    def test_ball_inf_origin(self):
        ...
        self.assertAlmostEqual(d_num, correct_squared_distance, 8, 'expected squared distance')
    ...
    def test_ball_inf_origin_inside(self):
        ...
        self.assertAlmostEqual(d_num, correct_squared_distance, 10, 'expected squared distance')
    ...
    def test_ball_euclidean_origin(self):
        ...
        self.assertAlmostEqual(d_sym, correct_squared_distance, 8, 'expected squared distance')
    ...
    def test_rectangle_semiinf_corridor(self):
        ...
        self.assertAlmostEqual(0.0, rect.distance_squared([1e+16, 1.5]), 8)
        self.assertAlmostEqual(1.0, rect.distance_squared([1e+16, 4.0]), 8)
        self.assertAlmostEqual(4.0, rect.distance_squared([1e+16, -4.0]), 8)
    ...
    def test_second_order_cone(self):
        ...
        self.assertAlmostEqual(1.3577794898144, sq_dist, 12)
    ...
    def test_cartesian(self):
        ...
        rect = og.constraints.Rectangle(xmin=[0.0, 1.0, -inf, 2.0], xmax=[
         1.0, inf, 10.0, 10.0])
    ...
    def test_finite_set_fail(self):
        with self.assertRaises(Exception) as (_ConstraintsTestCase__context):
            og.constraints.FiniteSet([[1.0, 2.0], [1.0, 2.0, 3.0]])
