...
# Size of source mod 2**32: 13695 bytes
import unittest, casadi.casadi as cs, opengen as og, subprocess, logging as lg
...
class RustBuildTestCase(unittest.TestCase):
    ...
    def setUpOnlyF1(cls):
        ...
        build_config = og.config.BuildConfiguration().with_build_directory(RustBuildTestCase.TEST_DIR).with_build_mode('debug').with_tcp_interface_config(tcp_interface_config=tcp_config).with_build_c_bindings()
