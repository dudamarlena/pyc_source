...
# [GCC 8.4.0]
# Embedded file name: /home/jiangyuanshu/thrift4p/thrift4p/gen-py/dm_operation_hub_service/DmOperationHubService.py
# Compiled at: 2018-11-20 02:58:49
...
class holdOrder_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'OrderId', None, None),
     (
      2, TType.I32, 'sysOpId', None, None),
     (
...
class holdTaxiOrder_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Result, Result.thrift_spec), None),)
...
class forbiddenUser_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'userId', None, None),
     (
      2, TType.STRING, 'reason', None, None),
     (
      3, TType.I64, 'sys_op_id', None, None),
     (
      4, TType.STRING, 'sys_op_ip', None, None),
     (
      5, TType.I32, 'days', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      4, TType.STRING, 'sys_op_ip', None, None),
     (
      5, TType.BYTE, 'group_id', None, None))
...
class forbiddenDevice_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'deviceId', None, None),
     (
      2, TType.STRING, 'reason', None, None),
     (
      3, TType.I64, 'sys_op_id', None, None),
...
class forbiddenDevice_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (DeviceResult, DeviceResult.thrift_spec), None),)
...
class taxiOrderSetTag_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'taxi_order_id', None, None),
     (
      2, TType.BYTE, 'group_id', None, None),
     (
      3, TType.STRING, 'reason', None, None),
     (
      4, TType.I64, 'sys_op_id', None, None),
     (
      5, TType.STRING, 'sys_op_ip', None, None))
...
class delPost_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'postId', None, None))
...
class delPostMulti_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'postIds', (TType.STRING, None), None))
...
class delPostMulti_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (MultiPostResult, MultiPostResult.thrift_spec), None),)
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'postId', None, None),
     (
      2, TType.BYTE, 'mask', None, None),
     (
      3, TType.STRING, 'comment', None, None),
     (
      4, TType.I64, 'sys_op_id', None, None),
     (
      5, TType.STRING, 'sys_op_ip', None, None))
...
class maskPostMulti_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'postId', (TType.STRING, None), None),
     (
      2, TType.BYTE, 'mask', None, None),
     (
      3, TType.STRING, 'comment', None, None),
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.I64, 'userId', None, None),
     (
      2, TType.STRING, 'comment', None, None),
     (
      3, TType.I64, 'sys_op_id', None, None),
     (
      4, TType.STRING, 'sys_op_ip', None, None))
