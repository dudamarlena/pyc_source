...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/known_pose_client/models/accurate_pose.py
...
class AccuratePose(object):
    ...
    openapi_types = {'inaccurate_pose':'InaccuratePose', 
     'reference_scan':'str'}
    attribute_map = {'inaccurate_pose':'inaccurate_pose', 
     'reference_scan':'reference_scan'}

    def __init__(self, inaccurate_pose=None, reference_scan=None):
        """AccuratePose - a model defined in OpenAPI"""
    ...
    def inaccurate_pose(self, inaccurate_pose):
        ...
        if inaccurate_pose is None:
            raise ValueError('Invalid value for `inaccurate_pose`, must not be `None`')
    ...
    def reference_scan(self, reference_scan):
        ...
        if reference_scan is None:
            raise ValueError('Invalid value for `reference_scan`, must not be `None`')
