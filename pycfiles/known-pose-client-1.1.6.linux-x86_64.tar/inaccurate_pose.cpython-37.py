...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/known_pose_client/models/inaccurate_pose.py
# Compiled at: 2019-10-26 08:01:19
# Size of source mod 2**32: 6461 bytes
"""
    Known Pose API
...
class InaccuratePose(object):
    ...
    def __init__(self, id=None, dns=None, basic_pose=None, is_accurate=None, taken_at=None):
        """InaccuratePose - a model defined in OpenAPI"""
        self._id = None
        self._dns = None
    ...
    def basic_pose(self, basic_pose):
        ...
        if basic_pose is None:
            raise ValueError('Invalid value for `basic_pose`, must not be `None`')
    ...
    def is_accurate(self, is_accurate):
        ...
        if is_accurate is None:
            raise ValueError('Invalid value for `is_accurate`, must not be `None`')
    ...
    def taken_at(self, taken_at):
        ...
        """
        if taken_at is None:
            raise ValueError('Invalid value for `taken_at`, must not be `None`')
