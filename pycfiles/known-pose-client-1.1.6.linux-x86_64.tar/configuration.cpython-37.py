...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/known_pose_client/configuration.py
# Compiled at: 2019-10-26 08:01:19
# Size of source mod 2**32: 10759 bytes
"""
    Known Pose API
...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host='https://virtserver.swaggerhub.com/kw90/known-pose-api/1.1.0', api_key={}, api_key_prefix={}, username='', password=''):
        """Constructor
        """
        self.host = host
    ...
    def to_debug_report(self):
        ...
        """
        return 'Python SDK Debug Report:\nOS: {env}\nPython Version: {pyversion}\nVersion of the API: 1.1.0\nSDK Package Version: 1.1.6'.format(env=(sys.platform),
    ...
    def get_host_from_settings(self, index, variables={}):
        ...
        if index < 0 or index >= len(servers):
            raise ValueError('Invalid index {} when selecting the host settings. Must be less than {}'.format(index, len(servers)))
        ...
        for variable_name in server['variables']:
            if variable_name in variables:
                if variables[variable_name] in server['variables'][variable_name]['enum_values']:
                    ...
                    raise ValueError('The variable `{}` in the host URL has invalid value {}. Must be {}.'.format(variable_name, variables[variable_name], server['variables'][variable_name]['enum_values']))
            else:
