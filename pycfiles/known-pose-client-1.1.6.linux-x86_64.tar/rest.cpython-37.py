...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/known_pose_client/rest.py
...
import urllib3
from known_pose_client.exceptions import ApiException, ApiValueError
        ...
        if configuration.assert_hostname is not None:
            ...
            if configuration.proxy:
                self.pool_manager = (urllib3.ProxyManager)(num_pools=pools_size, 
                 ...
                 proxy_headers=configuration.proxy_headers, **addition_pool_args)
            else:
