...
def find_support_reads(jxn, bam, side, tx, sub_reads, gtree, chimflag):
    ...
    for read in bam:
        ...
        if read.next_reference_name == chrom2 and read.reference_name == chrom1 and not read.flag & 2 and not read.flag & chimflag:
            if int(read.reference_start) > pos1left and int(read.reference_start) < pos1right and int(read.next_reference_start) > pos2left and int(read.next_reference_start) < pos2right:
                mymode = 'span'
        elif read.next_reference_name == read.reference_name and read.flag & 2 and not read.flag & chimflag:
            if int(read.reference_start) > pos1left and int(read.reference_start) < pos1right or int(read.next_reference_start) > pos2left and int(read.next_reference_start) < pos2right:
                mymode = 'jxn'
        elif read.next_reference_name == chrom2 and read.reference_name == chrom1 and not read.flag & 2 and read.flag & chimflag:
            if int(read.reference_start) > pos1left and int(read.reference_start) < pos1right or int(read.next_reference_start) > pos2left and int(read.next_reference_start) < pos2right:
                mymode = 'hang'
        if mymode:
