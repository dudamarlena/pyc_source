...
# [GCC 8.4.0]
# Embedded file name: /mounts/isilon/data/eahome/q804348/ea_code/STAR-SEQR/starseqr_utils/tests/test_seq.py
# Compiled at: 2017-12-07 17:16:01
# Size of source mod 2**32: 2633 bytes
import os, sys
sys.path.insert(0, '../')
import starseqr_utils as su, unittest, shutil, pandas as pd
path = os.path.dirname(__file__)
if path != '':
    os.chdir(path)

class ExonSeqTestCase(unittest.TestCase):
    __doc__ = 'Tests exon seq retrieval'
    ...
    def test_exons2seq_v1(self):
        ...
        exons = [
         [[[1, 'chr1', 1, 10, '+', 'ENST1'], [2, 'chr1', 11, 20, '+', 'ENST1'], [3, 'chr1', 21, 30, '+', 'ENST1']],
          [
           [
         ...
         [[[1, 'chr1', 1, 10, '+', 'ENST1'], [2, 'chr1', 11, 20, '+', 'ENST1'], [3, 'chr1', 21, 30, '+', 'ENST1']],
          [
           [
            1, 'chr1', 1, 10, '-', 'ENST2'], [2, 'chr1', 21, 30, '-', 'ENST2'], [3, 'chr1', 31, 40, '-', 'ENST2']]]]
        exons2 = [
         [[[1, 'chr2', 1, 10, '+', 'ENST3'], [2, 'chr2', 11, 20, '+', 'ENST3'], [3, 'chr2', 21, 30, '+', 'ENST3']],
          [
           [
