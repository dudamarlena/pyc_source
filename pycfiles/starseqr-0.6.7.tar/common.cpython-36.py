...
# [GCC 8.4.0]
# Embedded file name: z:\eahome\q804348\ea_code\STAR-SEQR\starseqr_utils\common.py
# Compiled at: 2018-01-10 18:13:26
# Size of source mod 2**32: 9450 bytes
from __future__ import absolute_import, division, print_function
from six.moves import zip
import six
from six import reraise as raise_
import os, sys, re, gzip, logging, time, errno, pandas as pd, numpy as np
from itertools import groupby, repeat
import multiprocessing as mp, signal, pysam
...
def fasta_iter(fasta_name):
    ...
    for header in faiter:
        header = six.next(header)[1:].strip()
...
class FastqRead(object):
    __doc__ = 'Represents 1 read, or 4 lines of a casava 1.8-style fastq file.'
    ...
    def __str__(self):
        return '{0}\n{1}\n+\n{2}\n+\n{3}\n'.format(self.header, self.sequence, self.quality, self.seq_len)


class FastqParser(object):
    __doc__ = 'Parses a fastq file into FastqReads.'
