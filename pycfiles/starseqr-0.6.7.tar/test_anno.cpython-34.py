...
# [GCC 8.4.0]
# Embedded file name: /mounts/isilon/data/eahome/q804348/ea_code/STAR-SEQR/starseqr_utils/tests/test_anno.py
...
class AnnoTestCase(unittest.TestCase):
    ...
    def test_get_jxnside_anno_v1(self):
        ...
        jxn_filt = pd.DataFrame({'name': 'chr1:871160:+:chr1:985950:-:0:0',  'jxn_reads': 'a1,a2,a3', 
         'jxn_counts': 3, 
         'spans': 5, 
         'spanreads': 's1,s2,s3,s4,s5', 
         'dist': 114790, 
         'ann_format': 'Symbol:Transcript:Strand:Exon_No:Dist_to_Exon:Frame:CDS_Length'}, index=pd.Series(0))
    ...
    def test_get_jxnside_anno_v2(self):
        ...
        jxn_filt = pd.DataFrame({'name': 'chr19:560462:+:chr8:560462:-:0:0',  'jxn_reads': 'a1,a2,a3', 
         'jxn_counts': 3, 
         'spans': 5, 
         'spanreads': 's1,s2,s3,s4,s5', 
         'dist': 13082084, 
    ...
    def test_get_jxnside_anno_v3(self):
        ...
        jxn_filt = pd.DataFrame({'name': 'chr12:15704606:+:chr1:11918527:-:2:1',  'jxn_reads': 'a1,a2,a3', 
         'jxn_counts': 3, 
         'spans': 5, 
         'spanreads': 's1,s2,s3,s4,s5', 
         'dist': 'NA', 
