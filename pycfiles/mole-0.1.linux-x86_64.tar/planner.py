...
# [GCC 8.4.0]
# Embedded file name: /home/ajdiaz/env/mole/lib/python2.7/site-packages/mole/planner.py
# Compiled at: 2012-10-07 05:56:59
import shlex
...
class Planner(object):
    ...
    def has_input(self):
        ...
        action).
        """
        return isinstance(self.queue[0], Input) or isinstance(self.queue[0], ActionInput)

    def has_output(self):
        """Return True if the pipeline has an output object (or output
        action).
        """
        return isinstance(self.queue[(-1)], Output) or isinstance(self.queue[(-1)], ActionOutput)
    ...
    def add_input(self, input):
        ...
        """
        if not isinstance(self.queue[0], Input) and not isinstance(self.queue[0], ActionInput):
    ...
    def add_output(self, output):
        ...
        elif not isinstance(self.queue[(-1)], Output) and not isinstance(self.queue[(-1)], ActionOutput):
            self.queue.append(output)
    ...
    def get_input(self):
        ...
        :class:`ActionInput`.
        """
        if isinstance(self.queue[0], Input) or isinstance(self.queue[0], ActionInput):
            return self.queue[0]
        raise ValueError()
    ...
    def get_output(self):
        ...
        :class:`ActionOutput`.
        """
        if isinstance(self.queue[(-1)], Output) or isinstance(self.queue[(-1)], ActionOutput):
            return self.queue[(-1)]
        raise ValueError()
