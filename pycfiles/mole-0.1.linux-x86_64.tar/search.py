...
# [GCC 8.4.0]
# Embedded file name: /home/ajdiaz/env/mole/lib/python2.7/site-packages/mole/action/search.py
# Compiled at: 2012-10-06 14:43:06
            ...
            if not self.queries:
                ...
                for field, query, func in self.queries:
                    if field == '_raw' and query == '*':
                        ret = True
                    elif field == '_raw' and (isinstance(event, str) or isinstance(event, unicode)):
