...
# [GCC 8.4.0]
# Embedded file name: /home/orient/pydpi/src/pydpi/drug/constitution.py
# Compiled at: 2012-09-23 10:56:29
"""
##############################################################################
...
_constitutional = {'Weight': CalculateMolWeight, 'AWeight': CalculateAverageMolWeight, 
...
if __name__ == '__main__':
    smis = [
     'CCCC', 'CCCCC', 'CCCCCC', 'CC(N)C(=O)O', 'CC(N)C(=O)[O-].[Na+]']
