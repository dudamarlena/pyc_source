...
# [GCC 8.4.0]
# Embedded file name: /home/scox/dev/grayson/venv/lib/python2.7/site-packages/grayson/debug/monitor.py
# Compiled at: 2012-06-30 07:29:04
import glob, logging, json, os, re, shutil, string, sys, time, traceback
    ...
    def notifyShellEvent(self, line, outputWorkflowPath):
        ...
        if workdirMarker in line:
            ...
            if len(idparts) >= 7:
                ...
                workflowId = os.path.join(idparts[(len(idparts) - 6)], workflowName).replace('.dax', '')
                self.workflowMonitorDatabase.subscribeToWorkflow(self.workflowRoot, {'username': self.username, 
