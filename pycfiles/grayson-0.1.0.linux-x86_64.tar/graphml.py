...
# [GCC 8.4.0]
# Embedded file name: /home/scox/dev/grayson/venv/lib/python2.7/site-packages/grayson/graphml.py
# Compiled at: 2012-08-02 11:06:23
import os, sys, xml.sax, urllib2, logging, traceback, re
...
class Graph:
    ...
    def addExistingNode(self, node):
        ...
        if node.getId() not in self.nodeMap:
        ...
        for edge in self.edges:
            ...
            try:
                ...
                if not source:
                    ...
                    logger.debug('--edge(id=%s)(src=(id=%s):%s, dst=(id=%s):%s), type(%s)', edge.getId(), source.getId(), source.getLabel(), target.getId(), target.getLabel(), edge.getType())
