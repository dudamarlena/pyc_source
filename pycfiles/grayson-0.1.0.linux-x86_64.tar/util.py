...
# [GCC 8.4.0]
# Embedded file name: /home/scox/dev/grayson/venv/lib/python2.7/site-packages/grayson/util.py
# Compiled at: 2012-07-20 09:09:35
...
class GraysonUtil(object):
    ...
    def ceilingString(value, maxLength=140, fromEnd=False):
        if fromEnd:
            return value[len(value) - maxLength - 1:len(value) - 1]
