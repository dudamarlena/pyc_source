...
# [GCC 8.4.0]
# Embedded file name: /home/ppoteralski/PycharmProjects/sqlalchemy-stdimage/.venv/lib/python3.6/site-packages/flask_image_alchemy/utils.py
# Compiled at: 2017-02-20 04:38:53
...
def resize_image(image_file, options):
    ...
    img.resize(height=(options.get('height')),
...
def build_filename(original_file_path, thumbnail_name):
    ...
    new_file_name = '{old_name}.{thumbnail_name}.{ext}'.format(old_name=original_file_path,
