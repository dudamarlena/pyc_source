...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\expatriate\model\xs\GMonthType.py
# Compiled at: 2018-01-18 12:30:17
...
class GMonthType(AnySimpleType):

    def parse_value(self, value):
        m = re.fullmatch('--(0[1-9]|1[0-2])(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?', value)
        if not m:
