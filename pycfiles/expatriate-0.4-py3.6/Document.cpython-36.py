...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\expatriate\Document.py
# Compiled at: 2018-01-15 10:37:43
# Size of source mod 2**32: 10515 bytes
import logging, re, xml.parsers.expat
...
class Document(Parent):
    ...
    def _end_element_handler(self, name):
        ...
        if 'xml:space' in el.attributes:
            if el.attributes['xml:space'] == 'preserve':
                self._in_space_preserve = False
