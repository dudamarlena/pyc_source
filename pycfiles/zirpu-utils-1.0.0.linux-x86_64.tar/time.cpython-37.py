...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/dist-packages/zirpu/time.py
# Compiled at: 2020-02-15 17:57:50
...
def main(argv=None):
    ...
    parser.add_argument('--base', default=10, action='store', type=int, help='base from 2-62. default 10.')
