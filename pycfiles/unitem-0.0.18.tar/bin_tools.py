...
# [GCC 8.4.0]
# Embedded file name: /srv/whitlam/home/users/uqdparks/git/unitem/unitem/bin_tools.py
# Compiled at: 2017-08-18 13:38:14
...
class BinTools:
    ...
    def compare(self, bin_files1, bin_files2, assembly_file, output_file):
        ...
        print()
        print('Assembled sequences = %d (%.2f Mbp)' % (len(seqs), total_bases / 1000000.0))
        print('  No. seqs > 1 kbp = %d (%.2f Mbp)' % (num_seq1K, total_bases1K / 1000000.0))
        print('  No. seqs > 5 kbp = %d (%.2f Mbp)' % (num_seq5K, total_bases5K / 1000000.0))
        print()
        ...
        print('  1) No. bins: %s, No. binned seqs: %d (%.2f%%), No. binned bases: %.2f Mbp (%.2f%%), No. seqs in multiple bins: %d' % (
         ...
         tota_uniq_binned_bases1 / 1000000.0,
        ...
        print('  2) No. bins: %s, No. binned seqs: %d (%.2f%%), No. binned bases: %.2f Mbp (%.2f%%), No. seqs in multiple bins: %d' % (
         ...
         tota_uniq_binned_bases2 / 1000000.0,
        ...
        for data in bin_stats2:
            fout.write('\t%.2f' % (data[1][1] / 1000000.0))
