...
# [GCC 8.4.0]
# Embedded file name: /srv/whitlam/home/users/uqdparks/git/unitem/unitem/markers.py
# Compiled at: 2017-08-18 13:23:35
...
class Markers:
    ...
    def bin_quality(self, bin):
        ...
        domain, comp, cont = self.evaluate(bac_gene_table, ar_gene_table)
        return (
         domain, comp, cont)
    ...
    def marker_gene_tables(self, profile_dir, binning_methods=None):
        ...
        for bm in os.listdir(binning_methods_dir):
            ...
            bin_dir = os.path.join(binning_methods_dir, bm, CHECKM_BAC_DIR, 'bins')
            ...
            gene_tables[bm] = (
             bac_gene_tables, ar_gene_tables)
