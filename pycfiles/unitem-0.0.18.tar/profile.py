...
# [GCC 8.4.0]
# Embedded file name: /srv/whitlam/home/users/uqdparks/git/unitem/unitem/profile.py
# Compiled at: 2017-08-18 13:24:08
...
class Profile:
    ...
    def _genome_quality(self, bac_quality_table, ar_quality_table):
        ...
        for gid in set(bac.keys()).union(ar):
            ...
            if bac_comp + bac_cont > ar_comp + ar_cont:
                gq[gid] = (
                 'Bacteria', bac_comp, bac_cont)
            else:
                gq[gid] = (
                 'Archaea', ar_comp, ar_cont)
    ...
    def _report_genome_quality(self, genome_quality, output_dir):
        ...
        for bm in genome_quality:
            ...
            for bid, (domain, comp, cont) in genome_quality[bm].items():
                ...
                total_q += quality
                summary[bm] = (
                 comp_cont_count, quality_count, total_comp, total_cont, total_q)
    ...
    def run(self, bin_dirs, output_dir):
        ...
        for method_id, (bin_dir, bin_ext) in bin_dirs.items():
            ...
            bac_quality_table = os.path.join(output_dir, BINNING_METHOD_DIR, method_id, CHECKM_BAC_DIR, GENOME_QUALITY_TABLE)
            ar_quality_table = os.path.join(output_dir, BINNING_METHOD_DIR, method_id, CHECKM_AR_DIR, GENOME_QUALITY_TABLE)
