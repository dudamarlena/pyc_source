...
# [GCC 8.4.0]
# Embedded file name: /srv/whitlam/home/users/uqdparks/git/unitem/unitem/main.py
# Compiled at: 2017-08-21 21:55:41
...
from biolib.common import make_sure_path_exists, check_dir_exists, check_file_exists, query_yes_no, remove_extension
...
class OptionsParser:
    ...
    def bin(self, options):
        ...
        bin = Bin(options.assembly_file, options.output_dir, options.min_contig_len, options.cpus)
    ...
    def profile(self, options):
        ...
        profile.run(bin_dirs, options.output_dir)
    ...
    def consensus(self, options):
        ...
        e.run(options.profile_dir, bin_dirs, options.weight, options.sel_min_quality, options.sel_min_comp, options.sel_max_cont, options.remove_perc, options.add_perc, options.add_matches, False, False, False, None, options.report_min_quality, options.simple_headers, options.output_dir)
    ...
    def greedy(self, options):
        ...
        bin_dirs = self._bin_dirs(options)
        e = Ensemble(options.bin_prefix)
        e.run(options.profile_dir, bin_dirs, options.weight, options.sel_min_quality, options.sel_min_comp, options.sel_max_cont, None, None, None, True, False, False, None, options.report_min_quality, options.simple_headers, options.output_dir)
    ...
    def unanimous(self, options):
        ...
        bin_dirs = self._bin_dirs(options)
        e = Ensemble(options.bin_prefix)
        e.run(options.profile_dir, bin_dirs, options.weight, options.sel_min_quality, options.sel_min_comp, options.sel_max_cont, None, None, None, False, True, False, None, options.report_min_quality, options.simple_headers, options.output_dir)
