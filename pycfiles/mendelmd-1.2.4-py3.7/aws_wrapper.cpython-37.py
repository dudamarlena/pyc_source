...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/helpers/aws_wrapper.py
...
class AWS:
    ...
    def launch(self, config):
        ...
        response = client.request_spot_instances(DryRun=False,
          ...
          InstanceCount=1,
          Type='one-time',
          LaunchSpecification={'ImageId':config['image_id'], 
         'KeyName':config['KeyName'], 
         'SubnetId':config['SubnetId'], 
         'InstanceType':config['instance_type'], 
         'Placement':{'AvailabilityZone': config['AvailabilityZone']}, 
         'EbsOptimized':True, 
         'SecurityGroupIds':[
