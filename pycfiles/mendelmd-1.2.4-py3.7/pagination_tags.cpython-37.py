...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pagination/templatetags/pagination_tags.py
# Compiled at: 2019-05-07 08:43:55
# Size of source mod 2**32: 9358 bytes
try:
    set
except NameError:
...
def paginate(context, window=DEFAULT_WINDOW, hashtag=''):
    ...
    try:
        ...
        to_return = {'MEDIA_URL':settings.MEDIA_URL, 
         'pages':pages, 
         'records':records, 
         'page_obj':page_obj, 
         'paginator':paginator, 
