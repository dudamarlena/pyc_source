...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/flopth/__init__.py
# Compiled at: 2019-02-21 08:54:15
...
def flopth(model, in_size=[
 3, 224, 224], dtype='float32', param_dict=settings.param_dict, extra_params=None, show_detail=False, bare_number=False):
