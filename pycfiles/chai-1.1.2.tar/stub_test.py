...
# [GCC 8.4.0]
# Embedded file name: /home/aaron/projects/chai/tests/stub_test.py
# Compiled at: 2015-01-26 13:38:33
import re, unittest, types, sys
...
class StubNewTest(unittest.TestCase):
    ...
    def test_call(self):
        ...
        class Expect(object):
            ...
            def match(self, *args, **kwargs):
                return args == ('state', ) and kwargs == {'a': 'b'}
