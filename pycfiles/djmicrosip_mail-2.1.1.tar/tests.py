...
# [GCC 8.4.0]
# Embedded file name: C:\repositorios\web\djmicrosip_apps\djmicrosip_mail\djmicrosip_mail\tests.py
...
class CargosClientesTests(TestCase):
    ...
    def test_cargos_con_monto_minimo_con_remissiones(self):
        ...
        """
        cargos = CargosClientes('email', tomar_remisiones=True, clientes_ids=['3636'], monto_minimo_mn=999999999)
    ...
    def test_cargos_con_monto_minimo_sin_remissiones(self):
        ...
        """
        cargos = CargosClientes('email', tomar_remisiones=False, clientes_ids=['4333'])
