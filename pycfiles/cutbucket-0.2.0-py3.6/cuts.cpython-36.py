...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cutbucket/cuts.py
# Compiled at: 2019-01-18 16:39:08
...
class GitError(Error):
    __doc__ = 'Raised when there is a git related issue'
