...
# [GCC 8.4.0]
# Embedded file name: /home/makism/Github/dyconnmap-public-master/docs/sphinxext/numpy_ext/docscrape_sphinx.py
...
class SphinxDocString(NumpyDocString):
    ...
    def _str_examples(self):
        examples_str = '\n'.join(self['Examples'])
        if self.use_plots:
            if 'import matplotlib' in examples_str:
                if 'plot::' not in examples_str:
                    out = []
