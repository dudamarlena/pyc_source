...
# Embedded file name: /home/sachin/random/codechef-cli/codechefcli/utils/helpers.py
...
from .constants import BCOLORS, COOKIES_FILE_PATH, INTERNET_DOWN_MSG, SERVER_DOWN_MSG, UNAUTHORIZED_MSG, USER_AGENT
try:
