...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/truverifi/__attr__.py
# Compiled at: 2019-04-30 00:39:44
...
__description__ = 'Python client library for truverifi'
__keywords__ = ['python', 'client', 'library', 'for', 'truverifi']
__url__ = 'https://github.com/achillesrasquinha/truverifi'
