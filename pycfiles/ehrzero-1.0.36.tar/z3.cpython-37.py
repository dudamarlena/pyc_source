...
# [GCC 8.4.0]
# Embedded file name: /Users/jinli/Projects/ZED/XG3_/pycode/predictor/ehrzero/z3.py
...
class Z3Classifier(object):
    ...
    def __init__(self, genesess_path=os.getcwd() + '/ehrzero' + '/bin/genESeSS', llk_path=os.getcwd() + '/ehrzero' + '/bin/llk', trainposfile='trainpos.dat', testposfile='testpos.dat', trainnegfile='trainneg.dat', testnegfile='testneg.dat', use_own_pfsa=False, posmod='POS.pfsa', negmod='NEG.pfsa', model_eps=0.2, result_path='./Z3_temp'):
        try:
