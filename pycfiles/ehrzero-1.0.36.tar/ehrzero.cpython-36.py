...
# [GCC 8.4.0]
# Embedded file name: /home/ishanu/.local/lib/python3.6/site-packages/ehrzero/ehrzero.py
# Compiled at: 2019-04-25 03:48:32
# Size of source mod 2**32: 34834 bytes
import os, numpy as np, itertools, pickle, tempfile
...
def predict_with_confidence(patients_file, out_file, separator, delimiter, n_first_weeks=[
 9999], disease_groups=None, phenotypes=None, model_path=None, pfsa_path=None, procdb=None, verbose=0, optimal_thresholds={'M':0.017379, 
 'F':0.00617}, dx_input='dx_input.dat', work_dir=None, T=1, N=2, z=1, a=5):
    if disease_groups is None:
        disease_groups = [
         'Infectious_Disease', 'Cardiovascular',
