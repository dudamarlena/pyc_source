...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-3lqd9wi4/ehrzero/ehrzero/predictor/ehrzero_/tuning.py
# Compiled at: 2019-04-24 20:13:47
# Size of source mod 2**32: 5470 bytes
import numpy as np, pandas as pd, numpy as np
...
def RUN_XG(train_set, test_set, k_splits):
    ...
    for train_index, test_index in skf.split(X, y):
        ...
        clf.fit(Xt_array, yt_array, eval_set=[
         (
          Xt_array, yt_array), (Xv_array, yv_array)],
          eval_metric='auc',
