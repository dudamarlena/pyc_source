...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-3lqd9wi4/ehrzero/ehrzero/predictor/ehrzero_/etiology.py
...
def retrieve_disease_stats(DF, codedict, patients, categories, offset=0):
    ...
    print(len(STATS.keys()))
    df = pd.DataFrame.from_dict({'code':list(STATS.keys()), 
