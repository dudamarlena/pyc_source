...
# [GCC 8.4.0]
# Embedded file name: /home/alfa/Documents/git/kivy/examples/demo/touchtracer/main.py
# Compiled at: 2016-12-10 07:11:02
...
class Touchtracer(FloatLayout):
    ...
    def on_touch_down(self, touch):
        ...
        with self.canvas:
            ...
            ud['lines'] = [
             ...
             Point(points=(touch.x, touch.y), source='particle.png', pointsize=pointsize, group=g)]
    ...
    def on_touch_move(self, touch):
        ...
        if 'pressure' in ud:
            if not 0.95 < touch.pressure / ud['pressure'] < 1.05:
                g = ud['group']
                pointsize = (touch.pressure * 100000) ** 2
                with self.canvas:
                    Color(ud['color'], 1, 1, mode='hsv', group=g)
