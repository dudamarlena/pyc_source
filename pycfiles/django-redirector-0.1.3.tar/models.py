...
# [GCC 8.4.0]
# Embedded file name: /Users/yuji/Projects/Grove/grove_project/grove/../grove/website/redirects/models.py
# Compiled at: 2012-05-30 18:35:39
"""
...
REDIRECT_CACHE_TIME = getattr(settings, 'REDIRECT_CACHE_TIME', 600)
...
class RedirectManager(models.Manager):
    ...
    def get_redirect_for_path(self, path, cached=True):
        ...
        cache.set(cache_key, redirect_url, 1)
        return redirect_url
...
class Redirect(models.Model):
    ...
    match_path = models.CharField(max_length=256, help_text='Which paths will this context be injected into?')
    ...
    def __unicode__(self):
        return ('{self.match_path}').format(self=self)
