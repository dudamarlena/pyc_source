...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/eg/theme/browser/navigation_org.py
# Compiled at: 2010-09-02 10:51:41
...
class Renderer(base.Renderer):
    ...
    def createNavTree(self):
        ...
        return self.recurse(children=data.get('x', []), level=1, bottomLevel=bottomLevel)
