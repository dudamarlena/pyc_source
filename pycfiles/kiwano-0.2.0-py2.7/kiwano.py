...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kiwano/kiwano.py
# Compiled at: 2019-07-16 02:44:05
import numpy
...
def kiwano(similarities, names, verbose=False, initial_subset=None):
    ...
    selector = FacilityLocationSelection(len(names) - n, pairwise_func='precomputed', verbose=verbose, initial_subset=initial_subset)
