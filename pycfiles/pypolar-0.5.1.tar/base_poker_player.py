...
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/players/base_poker_player.py
...
class BasePokerPlayer:
  ...
  """
    ...
    def __parse_ask_message(self, message):
        ...
        return (
         hole_card, valid_actions, round_state, action_histories)
    ...
    def __parse_game_update_message(self, message):
        ...
        action_histories = message['action_histories']
        return (
         action, round_state, action_histories)
