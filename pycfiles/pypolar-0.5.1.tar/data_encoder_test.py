...
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/pypokerengine/engine/data_encoder_test.py
...
class DataEncoderTest(BaseUnitTest):
    ...
    def test_encofe_game_information(self):
        config = {'initial_stack': 100, 'max_round': 10, 'small_blind_amount': 5, 'ante': 1, 
           'blind_structure': {1: {'ante': 3, 'small_blind': 10}}}
        seats = setup_seats()
