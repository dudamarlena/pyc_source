...
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/engine/hand_evaluator.py
...
class HandEvaluator:
    ...
    def __search_fullhouse(self, cards):
        ...
        return (
         max_(three_card_ranks), max_(two_pair_ranks))
