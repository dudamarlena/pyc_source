...
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/pypokerengine/engine/dealer_message_integration_test.py
...
class MessageIntegrationTest(BaseUnitTest):
    ...
    def __setup_config(self):
        return {'initial_stack': 100, 'max_round': 10, 'small_blind_amount': 5, 'ante': 3, 
           'blind_structure': {}}
