...
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/players/sample/simulation_player.py
# Compiled at: 2016-09-24 05:03:56
...
class PokerPlayer(BasePokerPlayer):
    ...
    def __decide_action(self, valid_actions, simulation_results):
        rewards = [ self.__research_reward(action, simulation_results[action]) for action in simulation_results.iterkeys()
                  ]
    ...
    def __simulate_all_actions(self, simulation_times, hole_info, valid_actions, original_state):
        ...
        for valid_action in valid_actions:
            ...
            simulation_results[valid_action['action']] = [ self.__simulate_action(hole_info, original_state, apply_action_info) for _ in range(simulation_times) ]
