...
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/engine/game_evaluator.py
...
class GameEvaluator:
    ...
    def __get_main_pot(self, players, sidepots):
        ...
        return {'amount': self.__get_players_pay_sum(players) - self.__get_sidepots_sum(sidepots), 
    ...
    def __create_sidepot(self, players, smaller_side_pots, allin_amount):
        return {'amount': self.__calc_sidepot_size(players, smaller_side_pots, allin_amount), 
