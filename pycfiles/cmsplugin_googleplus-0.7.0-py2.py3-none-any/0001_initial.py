...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/cmsplugin_googleform/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('cmsplugin_googleformsplugin', (
         (
        ...
        db.send_create_signal('cmsplugin_googleform', ['GoogleFormsPlugin'])

    def backwards(self, orm):
        db.delete_table('cmsplugin_googleformsplugin')
