...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/google/protobuf/service_reflection.py
  ...
  """
    ...
    """
        ...
        def _WrapCallMethod(srvc, method_descriptor, rpc_controller, request, callback):
            self._CallMethod(srvc, method_descriptor, rpc_controller, request, callback)
...
class _ServiceStubBuilder(object):
  ...
  """
    ...
    def _GenerateStubMethod(self, method):
        return lambda inst, rpc_controller, request, callback: self._StubMethod(inst, method, rpc_controller, request, callback)
    ...
    """
        stub.rpc_channel.CallMethod(method_descriptor, rpc_controller, request, method_descriptor.output_type._concrete_class, callback)