...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/google/protobuf/descriptor.py
...
class Descriptor(DescriptorBase):
  ...
  """
    ...
    def __init__(self, name, full_name, filename, containing_type, fields, nested_types, enum_types, extensions, options=None):
...
class FieldDescriptor(DescriptorBase):
  ...
  """
    ...
    def __init__(self, name, full_name, index, number, type, cpp_type, label, default_value, message_type, enum_type, containing_type, is_extension, extension_scope, options=None):
...
class EnumDescriptor(DescriptorBase):
  ...
  """
    ...
    def __init__(self, name, full_name, filename, values, containing_type=None, options=None):
