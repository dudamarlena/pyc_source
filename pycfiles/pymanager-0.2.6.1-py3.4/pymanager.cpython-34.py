...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/pymanager.py
# Compiled at: 2015-04-29 13:42:36
...
import collections, os, json, inspect, signal, sys, time
...
def clean_outfile():
    if Globals.outfile is not sys.stdout:
        if Globals.outfile is not None:
