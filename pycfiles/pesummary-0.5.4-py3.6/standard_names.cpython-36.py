...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/pesummary/gw/file/standard_names.py
# Compiled at: 2020-04-21 06:57:35
# Size of source mod 2**32: 13233 bytes
lalinference_map = {'h1_cplx_snr_amp':'H1_matched_filter_abs_snr', 
...
bilby_map = {'chirp_mass':'chirp_mass', 
...
pesummary_map = {'V1_optimal_snr':'V1_optimal_snr', 
...
descriptive_names = {'log_likelihood':'Log Likelihood', 
 'tilt_1':'the angle between the total orbital angular momentum, L, and the primary spin, S1', 
 'tilt_2':'the angle between the total orbital angular momentum, L, and the secondary spin, S2', 
 'cos_tilt_1':'the cosine of the angle between the total orbital angular momentum, L, and the primary spin, S1', 
 'cos_tilt_2':'the cosine of the angle between the total orbital angular momentum, L, and the primary spin, S2', 
 ...
 'iota':'the angle between the total orbital angular momentum, L, and the line of sight, N', 
 'cos_iota':'the cosine of the angle between the total orbital angular momentum, L , and the line of sight, N', 
 ...
 'mass_ratio':'the ratio of the binary component masses. We use the convention that the mass ratio is always less than 1', 
 ...
 'geocent_time':'', 
 'theta_jn':'the angle between the total angular momentum, J, and the line of sight, N', 
 'cos_theta_jn':'the cosine of the angle between the total angular momentum, J, and the line of sight, N', 
 'reference_frequency':'', 
 'H1_time':'', 
 'L1_time':'', 
 'V1_time':'', 
