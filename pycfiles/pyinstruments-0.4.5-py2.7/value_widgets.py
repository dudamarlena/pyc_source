...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyinstruments\curvefinder\gui\curve_search_widget\value_widgets.py
# Compiled at: 2013-10-01 12:43:19
...
class DateSelectWidget(QtGui.QWidget, object):
    ...
    @date.setter
    def date(self, date):
        self._date_edit.setDate(QtCore.QDate(date.year, date.month, date.day))
