...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyivi\ivicom\ivispecan.py
...
class ShortCutSpecAn(ShortCut):
    ...
    _fields = [ field[0] for field in _acquisition_fields ] + [ field[0] for field in _sweep_coupling_fields ] + [ field[0] for field in _frequency_fields ]
