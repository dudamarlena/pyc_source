...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyinstruments\datastore\db_dialogs.py
# Compiled at: 2013-12-18 10:06:39
...
class DialogChooseDatabase(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.button_existing = QtGui.QPushButton('Connect to an existing database...')
...
def create_super_user(login, password):
    from django.core import management
    management.call_command('createsuperuser', interactive=False, email='dummy.dummy@dummy.com', username=login)
...
def _new_database(dummy=True, cancel_allowed=True):
    ...
    create_database()
    create_super_user(dialog_new_database.login, dialog_new_database.password)
