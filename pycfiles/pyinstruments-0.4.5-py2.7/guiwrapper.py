...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyhardware\utils\guiwrappersutils\guiwrapper.py
...
class GuiWrapperWidget(QtGui.QWidget):
    ...
    def _setup_tabs_for_collection(self, collection_name, n_max=5):
        """
...
class DoubleItem(GuiItem):
    ...
    def __init__(self, label):
        ...
        self._item.setMaximum(1000000000000.0)
        self._item.setMinimum(-1000000000000.0)
...
class IntItem(GuiItem):
    ...
    def __init__(self, label):
        ...
        self._item.setMaximum(int(2000000000.0))
        self._item.setMinimum(int(-2000000000.0))
        self._lay.addWidget(self._item)
        self._item.editingFinished.connect(self.emit)
