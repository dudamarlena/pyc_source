...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/caps_lock/module.py
# Compiled at: 2015-03-03 18:01:36
import pygtk
pygtk.require('2.0')
import gtk
gtk.gdk.threads_init()
import gobject, commands, os, sys
SEP_CHAR = os.sep
...
CAPS_MAP = {True: '%s%s%s' % (CURRENT_DIR, SEP_CHAR, 'caps_on.svg'), False: '%s%s%s' % (CURRENT_DIR, SEP_CHAR, 'caps_off.svg')}
NUM_MAP = {True: '%s%s%s' % (CURRENT_DIR, SEP_CHAR, 'num_on.svg'), False: '%s%s%s' % (CURRENT_DIR, SEP_CHAR, 'num_off.svg')}
