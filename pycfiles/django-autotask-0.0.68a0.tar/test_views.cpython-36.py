...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/tests/test_views.py
# Compiled at: 2020-03-26 18:18:54
...
class TestCallBackView(TestCase):
    ...
    def post_data(self):
        ...
        return client.post((reverse('djautotask:callback')),
          body,
