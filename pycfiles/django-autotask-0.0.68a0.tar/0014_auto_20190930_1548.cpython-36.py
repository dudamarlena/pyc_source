...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/migrations/0014_auto_20190930_1548.py
# Compiled at: 2019-10-03 12:18:13
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='IssueType',
       fields=[
      (
     ...
     migrations.CreateModel(name='Source',
      ...
      (
       'is_system', models.BooleanField(default=False))],
       options={'abstract': False}),
     migrations.CreateModel(name='SubIssueType',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'is_system', models.BooleanField(default=False))],
       options={'abstract': False}),
     migrations.CreateModel(name='TicketCategory',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='TicketType',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
