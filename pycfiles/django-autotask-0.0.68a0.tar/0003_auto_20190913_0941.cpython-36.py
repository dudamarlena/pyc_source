...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/migrations/0003_auto_20190913_0941.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='TicketStatus',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Ticket status', 
