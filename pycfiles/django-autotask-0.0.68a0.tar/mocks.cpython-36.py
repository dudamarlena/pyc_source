...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/tests/mocks.py
# Compiled at: 2020-01-30 15:05:39
...
def build_batch_query(side_effect=None):
    mock_call, _patch = create_mock_call('djautotask.sync.TimeEntrySynchronizer.build_batch_queries',
