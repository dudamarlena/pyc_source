...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/tests/test_model.py
# Compiled at: 2020-02-03 17:28:59
...
class TestTimeEntry(TestCase):
    ...
    def assert_get_entered_time_date_worked(self, local_midnight):
        ...
        """
        midnight_est = timezone.localtime(timezone=(pytz.timezone(OFFSET_TIMEZONE))).replace(month=(local_midnight.month),
          day=(local_midnight.day),
          hour=0,
          minute=0,
          second=0,
          microsecond=0)
    ...
    def test_get_entered_time_date_worked_pst(self):
        local_midnight = timezone.localtime().replace(hour=0,
          minute=0,
          second=0,
          microsecond=0)
