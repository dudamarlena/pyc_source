...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/migrations/0008_auto_20190917_1454.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.AlterModelOptions(name='queue',
       options={}),
     migrations.AlterModelOptions(name='ticketpriority',
       options={'verbose_name_plural': 'Ticket priorities'}),
     migrations.AlterModelOptions(name='ticketstatus',
