...
class Random(_random.Random):
    ...
    def getstate(self):
        ...
        return (
         self.VERSION, super(Random, self).getstate(), self.gauss_next)
    ...
    def setstate(self, state):
        ...
        if version == 3:
            ...
            version, internalstate, self.gauss_next = state
            try:
                internalstate = tuple(long(x) % 4294967296 for x in internalstate)
...
class WichmannHill(Random):
    ...
    def getstate(self):
        """Return internal state; can be passed to setstate() later."""
        return (
         self.VERSION, self._seed, self.gauss_next)
