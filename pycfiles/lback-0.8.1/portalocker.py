...
# [GCC 8.4.0]
# Embedded file name: /home/mdipierro/make_web2py/web2py/gluon/portalocker.py
...
if os_locking == 'windows':
    ...
    def lock(file, flags):
        ...
        win32file.LockFileEx(hfile, flags, 0, 2147418112, __overlapped)


    def unlock(file):
        hfile = win32file._get_osfhandle(file.fileno())
        win32file.UnlockFileEx(hfile, 0, 2147418112, __overlapped)
