...
# [GCC 8.4.0]
# Embedded file name: compiler\ast.pyc
...
class AssAttr(Node):
    ...
    def getChildren(self):
        return (
         self.expr, self.attrname, self.flags)
...
class From(Node):
    ...
    def getChildren(self):
        return (
         self.modname, self.names, self.level)
...
class IfExp(Node):
    ...
    def getChildren(self):
        return (
         self.test, self.then, self.else_)
