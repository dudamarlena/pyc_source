...
# [GCC 8.4.0]
# Embedded file name: tarfile.pyc
# Compiled at: 2010-06-05 01:00:06
"""Read from and write to tar format archives.
"""
__version__ = '$Revision: 81667 $'
version = '0.9.0'
__author__ = b'Lars Gust\xe4bel (lars@gustaebel.de)'
__date__ = '$Date: 2010-06-03 14:34:14 +0200 (Do, 03 Jun 2010) $'
__cvsid__ = '$Id: tarfile.py 81667 2010-06-03 12:34:14Z lars.gustaebel $'
__credits__ = b'Gustavo Niemeyer, Niels Gust\xe4bel, Richard Townsend.'
import sys, os, shutil, stat, errno, time, struct, copy, re, operator
try:
    import grp, pwd
except ImportError:
    grp = pwd = None
...
class _Stream():
    ...
    def _init_write_gz(self):
        ...
        self.__write(b'\x1f\x8b\x08\x08%s\x02\xff' % timestamp)
