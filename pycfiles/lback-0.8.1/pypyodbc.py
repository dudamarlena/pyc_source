...
# [GCC 8.4.0]
# Embedded file name: /home/mdipierro/make_web2py/web2py/gluon/contrib/pypyodbc.py
...
aInfoTypes = {SQL_ACCESSIBLE_PROCEDURES: 'GI_YESNO', 
   SQL_ACCESSIBLE_TABLES: 'GI_YESNO', SQL_ACTIVE_ENVIRONMENTS: 'GI_USMALLINT', SQL_AGGREGATE_FUNCTIONS: 'GI_UINTEGER', 
   SQL_ALTER_DOMAIN: 'GI_UINTEGER', SQL_ALTER_TABLE: 'GI_UINTEGER', 
   SQL_ASYNC_MODE: 'GI_UINTEGER', SQL_BATCH_ROW_COUNT: 'GI_UINTEGER', SQL_BATCH_SUPPORT: 'GI_UINTEGER', 
   SQL_BOOKMARK_PERSISTENCE: 'GI_UINTEGER', SQL_CATALOG_LOCATION: 'GI_USMALLINT', SQL_CATALOG_NAME: 'GI_YESNO', 
   SQL_CATALOG_NAME_SEPARATOR: 'GI_STRING', SQL_CATALOG_TERM: 'GI_STRING', SQL_CATALOG_USAGE: 'GI_UINTEGER', 
   SQL_COLLATION_SEQ: 'GI_STRING', SQL_COLUMN_ALIAS: 'GI_YESNO', SQL_CONCAT_NULL_BEHAVIOR: 'GI_USMALLINT', 
   SQL_CONVERT_FUNCTIONS: 'GI_UINTEGER', SQL_CONVERT_VARCHAR: 'GI_UINTEGER', 
   SQL_CORRELATION_NAME: 'GI_USMALLINT', SQL_CREATE_ASSERTION: 'GI_UINTEGER', 
   SQL_CREATE_CHARACTER_SET: 'GI_UINTEGER', SQL_CREATE_COLLATION: 'GI_UINTEGER', 
   SQL_CREATE_DOMAIN: 'GI_UINTEGER', SQL_CREATE_SCHEMA: 'GI_UINTEGER', SQL_CREATE_TABLE: 'GI_UINTEGER', 
   SQL_CREATE_TRANSLATION: 'GI_UINTEGER', SQL_CREATE_VIEW: 'GI_UINTEGER', SQL_CURSOR_COMMIT_BEHAVIOR: 'GI_USMALLINT', 
   SQL_CURSOR_ROLLBACK_BEHAVIOR: 'GI_USMALLINT', SQL_DATABASE_NAME: 'GI_STRING', SQL_DATA_SOURCE_NAME: 'GI_STRING', 
   SQL_DATA_SOURCE_READ_ONLY: 'GI_YESNO', SQL_DATETIME_LITERALS: 'GI_UINTEGER', SQL_DBMS_NAME: 'GI_STRING', 
   SQL_DBMS_VER: 'GI_STRING', SQL_DDL_INDEX: 'GI_UINTEGER', SQL_DEFAULT_TXN_ISOLATION: 'GI_UINTEGER', 
   SQL_DESCRIBE_PARAMETER: 'GI_YESNO', SQL_DM_VER: 'GI_STRING', SQL_DRIVER_NAME: 'GI_STRING', 
   SQL_DRIVER_ODBC_VER: 'GI_STRING', SQL_DRIVER_VER: 'GI_STRING', SQL_DROP_ASSERTION: 'GI_UINTEGER', 
   SQL_DROP_CHARACTER_SET: 'GI_UINTEGER', SQL_DROP_COLLATION: 'GI_UINTEGER', 
   SQL_DROP_DOMAIN: 'GI_UINTEGER', SQL_DROP_SCHEMA: 'GI_UINTEGER', 
   SQL_DROP_TABLE: 'GI_UINTEGER', SQL_DROP_TRANSLATION: 'GI_UINTEGER', SQL_DROP_VIEW: 'GI_UINTEGER', 
   SQL_DYNAMIC_CURSOR_ATTRIBUTES1: 'GI_UINTEGER', SQL_DYNAMIC_CURSOR_ATTRIBUTES2: 'GI_UINTEGER', SQL_EXPRESSIONS_IN_ORDERBY: 'GI_YESNO', 
   SQL_FILE_USAGE: 'GI_USMALLINT', SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES1: 'GI_UINTEGER', 
   SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2: 'GI_UINTEGER', SQL_GETDATA_EXTENSIONS: 'GI_UINTEGER', 
   SQL_GROUP_BY: 'GI_USMALLINT', SQL_IDENTIFIER_CASE: 'GI_USMALLINT', SQL_IDENTIFIER_QUOTE_CHAR: 'GI_STRING', 
   SQL_INDEX_KEYWORDS: 'GI_UINTEGER', SQL_INFO_SCHEMA_VIEWS: 'GI_UINTEGER', SQL_INSERT_STATEMENT: 'GI_UINTEGER', 
   SQL_INTEGRITY: 'GI_YESNO', SQL_KEYSET_CURSOR_ATTRIBUTES1: 'GI_UINTEGER', SQL_KEYSET_CURSOR_ATTRIBUTES2: 'GI_UINTEGER', 
   SQL_KEYWORDS: 'GI_STRING', SQL_LIKE_ESCAPE_CLAUSE: 'GI_YESNO', 
   SQL_MAX_ASYNC_CONCURRENT_STATEMENTS: 'GI_UINTEGER', SQL_MAX_BINARY_LITERAL_LEN: 'GI_UINTEGER', 
   SQL_MAX_CATALOG_NAME_LEN: 'GI_USMALLINT', SQL_MAX_CHAR_LITERAL_LEN: 'GI_UINTEGER', 
   SQL_MAX_COLUMNS_IN_GROUP_BY: 'GI_USMALLINT', SQL_MAX_COLUMNS_IN_INDEX: 'GI_USMALLINT', 
   SQL_MAX_COLUMNS_IN_ORDER_BY: 'GI_USMALLINT', SQL_MAX_COLUMNS_IN_SELECT: 'GI_USMALLINT', 
   SQL_MAX_COLUMNS_IN_TABLE: 'GI_USMALLINT', SQL_MAX_COLUMN_NAME_LEN: 'GI_USMALLINT', 
   SQL_MAX_CONCURRENT_ACTIVITIES: 'GI_USMALLINT', SQL_MAX_CURSOR_NAME_LEN: 'GI_USMALLINT', 
   SQL_MAX_DRIVER_CONNECTIONS: 'GI_USMALLINT', SQL_MAX_IDENTIFIER_LEN: 'GI_USMALLINT', 
   SQL_MAX_INDEX_SIZE: 'GI_UINTEGER', SQL_MAX_PROCEDURE_NAME_LEN: 'GI_USMALLINT', 
   SQL_MAX_ROW_SIZE: 'GI_UINTEGER', SQL_MAX_ROW_SIZE_INCLUDES_LONG: 'GI_YESNO', 
   SQL_MAX_SCHEMA_NAME_LEN: 'GI_USMALLINT', SQL_MAX_STATEMENT_LEN: 'GI_UINTEGER', 
   SQL_MAX_TABLES_IN_SELECT: 'GI_USMALLINT', SQL_MAX_TABLE_NAME_LEN: 'GI_USMALLINT', 
   SQL_MAX_USER_NAME_LEN: 'GI_USMALLINT', SQL_MULTIPLE_ACTIVE_TXN: 'GI_YESNO', 
   SQL_MULT_RESULT_SETS: 'GI_YESNO', SQL_NEED_LONG_DATA_LEN: 'GI_YESNO', 
   SQL_NON_NULLABLE_COLUMNS: 'GI_USMALLINT', SQL_NULL_COLLATION: 'GI_USMALLINT', 
   SQL_NUMERIC_FUNCTIONS: 'GI_UINTEGER', SQL_ODBC_INTERFACE_CONFORMANCE: 'GI_UINTEGER', 
   SQL_ODBC_VER: 'GI_STRING', SQL_OJ_CAPABILITIES: 'GI_UINTEGER', SQL_ORDER_BY_COLUMNS_IN_SELECT: 'GI_YESNO', 
   SQL_PARAM_ARRAY_ROW_COUNTS: 'GI_UINTEGER', SQL_PARAM_ARRAY_SELECTS: 'GI_UINTEGER', 
   SQL_PROCEDURES: 'GI_YESNO', SQL_PROCEDURE_TERM: 'GI_STRING', SQL_QUOTED_IDENTIFIER_CASE: 'GI_USMALLINT', 
   SQL_ROW_UPDATES: 'GI_YESNO', SQL_SCHEMA_TERM: 'GI_STRING', SQL_SCHEMA_USAGE: 'GI_UINTEGER', 
   SQL_SCROLL_OPTIONS: 'GI_UINTEGER', SQL_SEARCH_PATTERN_ESCAPE: 'GI_STRING', SQL_SERVER_NAME: 'GI_STRING', 
   SQL_SPECIAL_CHARACTERS: 'GI_STRING', SQL_SQL92_DATETIME_FUNCTIONS: 'GI_UINTEGER', SQL_SQL92_FOREIGN_KEY_DELETE_RULE: 'GI_UINTEGER', 
   SQL_SQL92_FOREIGN_KEY_UPDATE_RULE: 'GI_UINTEGER', SQL_SQL92_GRANT: 'GI_UINTEGER', 
   SQL_SQL92_NUMERIC_VALUE_FUNCTIONS: 'GI_UINTEGER', SQL_SQL92_PREDICATES: 'GI_UINTEGER', 
   SQL_SQL92_RELATIONAL_JOIN_OPERATORS: 'GI_UINTEGER', SQL_SQL92_REVOKE: 'GI_UINTEGER', 
   SQL_SQL92_ROW_VALUE_CONSTRUCTOR: 'GI_UINTEGER', SQL_SQL92_STRING_FUNCTIONS: 'GI_UINTEGER', 
   SQL_SQL92_VALUE_EXPRESSIONS: 'GI_UINTEGER', SQL_SQL_CONFORMANCE: 'GI_UINTEGER', 
   SQL_STANDARD_CLI_CONFORMANCE: 'GI_UINTEGER', SQL_STATIC_CURSOR_ATTRIBUTES1: 'GI_UINTEGER', 
   SQL_STATIC_CURSOR_ATTRIBUTES2: 'GI_UINTEGER', SQL_STRING_FUNCTIONS: 'GI_UINTEGER', 
   SQL_SUBQUERIES: 'GI_UINTEGER', SQL_SYSTEM_FUNCTIONS: 'GI_UINTEGER', 
   SQL_TABLE_TERM: 'GI_STRING', SQL_TIMEDATE_ADD_INTERVALS: 'GI_UINTEGER', SQL_TIMEDATE_DIFF_INTERVALS: 'GI_UINTEGER', 
   SQL_TIMEDATE_FUNCTIONS: 'GI_UINTEGER', SQL_TXN_CAPABLE: 'GI_USMALLINT', 
   SQL_TXN_ISOLATION_OPTION: 'GI_UINTEGER', SQL_UNION: 'GI_UINTEGER', 
   SQL_USER_NAME: 'GI_STRING', SQL_XOPEN_CLI_YEAR: 'GI_STRING'}
BINARY = bytearray
Binary = bytearray
...
if UNICODE_SIZE > SQLWCHAR_SIZE:
    ...
    SQL_data_type_dict = {SQL_TYPE_NULL: (
                     None, lambda x: None, SQL_C_CHAR, create_buffer, 2), 
       SQL_CHAR: (
                str, lambda x: x, SQL_C_CHAR, create_buffer, 2048), 
       SQL_NUMERIC: (
                   Decimal, Decimal, SQL_C_CHAR, create_buffer, 150), 
       SQL_DECIMAL: (
                   Decimal, Decimal, SQL_C_CHAR, create_buffer, 150), 
       SQL_INTEGER: (
                   int, int, SQL_C_CHAR, create_buffer, 150), 
       SQL_SMALLINT: (
                    int, int, SQL_C_CHAR, create_buffer, 150), 
       SQL_FLOAT: (
                 float, float, SQL_C_CHAR, create_buffer, 150), 
       SQL_REAL: (
                float, float, SQL_C_CHAR, create_buffer, 150), 
       SQL_DOUBLE: (
                  float, float, SQL_C_CHAR, create_buffer, 200), 
       SQL_DATE: (
                datetime.date, dt_cvt, SQL_C_CHAR, create_buffer, 30), 
       SQL_TIME: (
                datetime.time, tm_cvt, SQL_C_CHAR, create_buffer, 20), 
       SQL_SS_TIME2: (
                    datetime.time, tm_cvt, SQL_C_CHAR, create_buffer, 20), 
       SQL_TIMESTAMP: (
                     datetime.datetime, dttm_cvt, SQL_C_CHAR, create_buffer, 30), 
       SQL_VARCHAR: (
                   str, lambda x: x, SQL_C_CHAR, create_buffer, 2048), 
       SQL_LONGVARCHAR: (
                       str, lambda x: x, SQL_C_CHAR, create_buffer, 20500), 
       SQL_BINARY: (
                  bytearray, bytearray, SQL_C_BINARY, create_buffer, 5120), 
       SQL_VARBINARY: (
                     bytearray, bytearray, SQL_C_BINARY, create_buffer, 5120), 
       SQL_LONGVARBINARY: (
                         bytearray, bytearray, SQL_C_BINARY, create_buffer, 20500), 
       SQL_BIGINT: (
                  long, long, SQL_C_CHAR, create_buffer, 150), 
       SQL_TINYINT: (
                   int, int, SQL_C_CHAR, create_buffer, 150), 
       SQL_BIT: (
               bool, lambda x: x == '1', SQL_C_CHAR, create_buffer, 2), 
       SQL_WCHAR: (
                 unicode, lambda x: x, SQL_C_WCHAR, create_buffer_u, 2048), 
       SQL_WVARCHAR: (
                    unicode, lambda x: x, SQL_C_WCHAR, create_buffer_u, 2048), 
       SQL_GUID: (
                str, str, SQL_C_CHAR, create_buffer, 50), 
       SQL_WLONGVARCHAR: (
                        unicode, lambda x: x, SQL_C_WCHAR, create_buffer_u, 20500), 
       SQL_TYPE_DATE: (
                     datetime.date, dt_cvt, SQL_C_CHAR, create_buffer, 30), 
       SQL_TYPE_TIME: (
                     datetime.time, tm_cvt, SQL_C_CHAR, create_buffer, 20), 
...
if sys.platform not in 'cli':
    ...
    ODBC_API.SQLNumResultCols.argtypes = [
     ctypes.c_void_p,
     ctypes.POINTER(ctypes.c_short)]
ODBC_API.SQLCloseCursor.argtypes = [
 ctypes.c_void_p]
...
ODBC_API.SQLConnect.argtypes = [
 ...
 ctypes.c_char_p,
 ctypes.c_short]
ODBC_API.SQLDisconnect.argtypes = [
 ctypes.c_void_p]
ODBC_API.SQLEndTran.argtypes = [
 ctypes.c_short,
 ctypes.c_void_p,
 ctypes.c_short]
ODBC_API.SQLExecute.argtypes = [
 ctypes.c_void_p]
...
ODBC_API.SQLGetTypeInfo.argtypes = [
 ctypes.c_void_p,
 ctypes.c_short]
ODBC_API.SQLMoreResults.argtypes = [
 ctypes.c_void_p]
...
def ctrl_err(ht, h, val_ret):
    ...
    Message = create_buffer(10240)
    Buffer_len = ctypes.c_short()
    err_list = []
    number_errors = 1
    while 1:
        ret = ODBC_API.SQLGetDiagRec(ht, h, number_errors, state, NativeError, Message, len(Message), ADDR(Buffer_len))
...
class Cursor():
    ...
    def execute(self, query_string, params=None, many_mode=False, call_mode=False):
        ...
        if params:
            if type(params) not in (tuple, list, set):
 ...
 None]):
    ...
    def _BindParams(self, param_types, pram_io_list=[]):
        ...
        for col_num in range(NumParams.value):
            ...
            if param_types[col_num] == type(None):
                ...
                ret = ODBC_API.SQLDescribeParam(self._stmt_h, ParameterNumber, ADDR(DataType), ADDR(ParameterSize), ADDR(DecimalDigits), ADDR(Nullable))
                if ret != SQL_SUCCESS:
                    validate(ret, SQL_HANDLE_STMT, self._stmt_h)
                ...
                buf_size = len(self._inputsizers) > col_num and self._inputsizers[col_num] or 20500
                ParameterBuffer = create_buffer(buf_size)
            elif type(param_types[col_num]) == tuple:
                sql_c_type = SQL_C_CHAR
                ...
                if DEBUG:
                    print param_types[col_num][0], param_types[col_num][1]
        ...
        for col_num, (sql_c_type, sql_type, buf_size, col_size, ParameterBuffer) in enumerate(temp_holder):
            ...
            ret = SQLBindParameter(self._stmt_h, col_num + 1, InputOutputType, sql_c_type, sql_type, buf_size, col_size, ADDR(ParameterBuffer), BufferLen, ADDR(LenOrIndBuf))
            if ret != SQL_SUCCESS:
                validate(ret, SQL_HANDLE_STMT, self._stmt_h)
    ...
    def _GetData(self):
        ...
        for col_name, target_type, used_buf_len, alloc_buffer, total_buf_len, buf_cvt_func in self._ColBufferList:
            blocks = []
            while True:
                ret = ODBC_API.SQLGetData(self._stmt_h, col_num + 1, target_type, ADDR(alloc_buffer), total_buf_len, ADDR(used_buf_len))
                validate(ret, SQL_HANDLE_STMT, self._stmt_h)
                if ret == SQL_SUCCESS:
                    if used_buf_len.value == SQL_NULL_DATA:
                        blocks.append(None)
                    elif target_type == SQL_C_BINARY:
    ...
    def _UpdateDesc(self):
        ...
        for col in range(1, NOC + 1):
            ret = ODBC_API.SQLColAttribute(self._stmt_h, col, SQL_DESC_DISPLAY_SIZE, ADDR(create_buffer(10)), 10, ADDR(ctypes.c_short()), ADDR(Cdisp_size))
            validate(ret, SQL_HANDLE_STMT, self._stmt_h)
            ret = ODBC_API.SQLDescribeCol(self._stmt_h, col, Cname, len(Cname), ADDR(Cname_ptr), ADDR(Ctype_code), ADDR(Csize), ADDR(CDecimalDigits), ADDR(Cnull_ok))
            validate(ret, SQL_HANDLE_STMT, self._stmt_h)
    ...
    def tables(self, table=None, catalog=None, schema=None, tableType=None):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLTables(self._stmt_h, catalog, l_catalog, schema, l_schema, table, l_table, tableType, l_tableType)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
    ...
    def columns(self, table=None, catalog=None, schema=None, column=None):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLColumns(self._stmt_h, catalog, l_catalog, schema, l_schema, table, l_table, column, l_column)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
    ...
    def primaryKeys(self, table=None, catalog=None, schema=None):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLPrimaryKeys(self._stmt_h, catalog, l_catalog, schema, l_schema, table, l_table)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
    ...
    def foreignKeys(self, table=None, catalog=None, schema=None, foreignTable=None, foreignCatalog=None, foreignSchema=None):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLForeignKeys(self._stmt_h, catalog, l_catalog, schema, l_schema, table, l_table, foreignCatalog, l_foreignCatalog, foreignSchema, l_foreignSchema, foreignTable, l_foreignTable)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
    ...
    def procedurecolumns(self, procedure=None, catalog=None, schema=None, column=None):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLProcedureColumns(self._stmt_h, catalog, l_catalog, schema, l_schema, procedure, l_procedure, column, l_column)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
    ...
    def procedures(self, procedure=None, catalog=None, schema=None):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLProcedures(self._stmt_h, catalog, l_catalog, schema, l_schema, procedure, l_procedure)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
    ...
    def statistics(self, table, catalog=None, schema=None, unique=False, quick=True):
        ...
        self._free_results('FREE_STATEMENT')
        self.statement = None
        ret = ODBC_API.SQLStatistics(self._stmt_h, catalog, l_catalog, schema, l_schema, table, l_table, Unique, Reserved)
        validate(ret, SQL_HANDLE_STMT, self._stmt_h)
        self._NumOfRows()
        self._UpdateDesc()
        return self
...
class Connection():
    ...
    def update_type_size_info(self):
        for sql_type in (
         ...
         SQL_SS_TIME2):
            ...
            if info_tuple != None:
                self.type_size_dic[sql_type] = (
                 info_tuple[2], info_tuple[14])
            cur.close()
    ...
    def getinfo(self, infotype):
        ...
        if aInfoTypes[infotype] == 'GI_UINTEGER':
            ...
            ret = ODBC_API.SQLGetInfo(self.dbc_h, infotype, ADDR(alloc_buffer), total_buf_len, ADDR(used_buf_len))
            validate(ret, SQL_HANDLE_DBC, self.dbc_h)
...
def win_create_mdb(mdb_path, sort_order='General\x00\x00'):
...
def win_compact_mdb(mdb_path, compacted_mdb_path, sort_order='General\x00\x00'):
    if sys.platform not in ('win32', 'cli'):
        raise Exception('This function is available for use in Windows only.')
...
def dataSources():
    ...
    while 1:
        ret = ODBC_API.SQLDataSources(shared_env_h, SQL_FETCH_NEXT, dsn, len(dsn), ADDR(dsn_len), desc, len(desc), ADDR(desc_len))
        if ret == SQL_NO_DATA_FOUND:
            break
        elif ret not in (SQL_SUCCESS, SQL_SUCCESS_WITH_INFO):
