...
# [GCC 8.4.0]
# Embedded file name: Tkinter.pyc
# Compiled at: 2010-06-05 00:59:48
...
class Misc():
    ...
    _subst_format = ('%#', '%b', '%f', '%h', '%k', '%s', '%t', '%w', '%x', '%y', '%A',
                     '%E', '%K', '%N', '%W', '%T', '%X', '%Y', '%D')
    ...
    def _grid_configure(self, command, index, cnf, kw):
        ...
        if not options:
            ...
            return dict
        res = self.tk.call((
         'grid', command, self._w, index) + options)
        if len(options) == 1:
            if not res:
                return
            if '.' in res:
    ...
    def event_generate(self, sequence, **kw):
        ...
        (e.g. x, y, rootx, rooty)."""
        args = (
         'event', 'generate', self._w, sequence)
        for k, v in kw.items():
            args = args + ('-%s' % k, str(v))
    ...
    def wm_colormapwindows(self, *wlist):
        ...
        if len(wlist) > 1:
            wlist = (
             wlist,)
        args = (
         'wm', 'colormapwindows', self._w) + wlist
...
class Pack():
    ...
    def pack_configure(self, cnf={}, **kw):
        ...
        """
        self.tk.call((
         'pack', 'configure', self._w) + self._options(cnf, kw))
...
class Place():
    ...
    def place_configure(self, cnf={}, **kw):
        ...
        """
        self.tk.call((
         'place', 'configure', self._w) + self._options(cnf, kw))
...
class Grid():
    ...
    def grid_configure(self, cnf={}, **kw):
        ...
        """
        self.tk.call((
         'grid', 'configure', self._w) + self._options(cnf, kw))
...
class Text(Widget, XView, YView):
    ...
    def window_create(self, index, cnf={}, **kw):
        ...
        self.tk.call((
         self._w, 'window', 'create', index) + self._options(cnf, kw))
