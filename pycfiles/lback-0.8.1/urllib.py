...
# [GCC 8.4.0]
# Embedded file name: urllib.pyc
# Compiled at: 2010-07-04 11:32:06
...
"""
import string, socket, os, time, sys
...
if os.name == 'nt':
 ...
 L. 130        48  LOAD_FAST             1  'proxies'
               51  LOAD_FAST             0  'self'
               54  STORE_ATTR            4  'proxies'

 L. 131        57  LOAD_FAST             2  'x509'
               60  LOAD_ATTR             5  'get'
               63  LOAD_CONST               'key_file'
               66  CALL_FUNCTION_1       1  None
               69  LOAD_FAST             0  'self'
               72  STORE_ATTR            6  'key_file'

 L. 132        75  LOAD_FAST             2  'x509'
               78  LOAD_ATTR             5  'get'
               81  LOAD_CONST               'cert_file'
               84  CALL_FUNCTION_1       1  None
               87  LOAD_FAST             0  'self'
               90  STORE_ATTR            7  'cert_file'

 L. 133        93  LOAD_CONST               'User-Agent'
               96  LOAD_FAST             0  'self'
               99  LOAD_ATTR             8  'version'
              102  BUILD_TUPLE_2         2 
              105  BUILD_LIST_1          1 
              108  LOAD_FAST             0  'self'
              111  STORE_ATTR            9  'addheaders'

 L. 134       114  BUILD_LIST_0          0 
              117  LOAD_FAST             0  'self'
              120  STORE_ATTR           10  '__tempfiles'

 L. 135       123  LOAD_GLOBAL          11  'os'
              126  LOAD_ATTR            12  'unlink'
              129  LOAD_FAST             0  'self'
              132  STORE_ATTR           13  '__unlink'

 L. 136       135  LOAD_CONST               None
              138  LOAD_FAST             0  'self'
              141  STORE_ATTR           14  'tempcache'

 L. 143       144  LOAD_GLOBAL          15  'ftpcache'
              147  LOAD_FAST             0  'self'
              150  STORE_ATTR           15  'ftpcache'
              153  LOAD_CONST               None
              156  RETURN_VALUE     

Parse error at or near `LOAD_CONST' instruction at offset 153
    ...
    class ftpwrapper():
        ...
        def __init__(self, user, passwd, host, port, dirs, timeout=socket._GLOBAL_DEFAULT_TIMEOUT):
            self.user = user
            self.passwd = passwd
            self.host = host
            self.port = port
        ...
        def retrfile(self, file, type):
            ...
            self.busy = 1
            return (
             addclosehook(conn[0].makefile('rb'), self.endtransfer), conn[1])
