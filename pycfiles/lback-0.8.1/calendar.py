...
# [GCC 8.4.0]
# Embedded file name: calendar.pyc
# Compiled at: 2010-03-15 17:10:22
...
def main(args):
    ...
    parser.add_option('-t', '--type', dest='type', default='text', choices=('text',
                                                                            'html'), help='output type (text or html)')
