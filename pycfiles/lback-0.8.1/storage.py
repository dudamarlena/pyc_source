...
# [GCC 8.4.0]
# Embedded file name: /home/mdipierro/make_web2py/web2py/gluon/storage.py
...
"""
import cPickle, gluon.portalocker as portalocker
__all__ = [
 'List', 'Storage', 'Settings', 'Messages',
...
PICKABLE = (
 str, int, long, float, bool, list, dict, tuple, set)
