...
# [GCC 8.4.0]
# Embedded file name: compiler\symbols.pyc
# Compiled at: 2011-03-08 12:43:14
"""Module symbol-table generator"""
from compiler import ast
from compiler.consts import SC_LOCAL, SC_GLOBAL_IMPLICIT, SC_GLOBAL_EXPLICT, SC_FREE, SC_CELL, SC_UNKNOWN
...
class SymbolVisitor:
    ...
    def visitGenExpr(self, node, parent):
        ...
        if parent.nested or isinstance(parent, FunctionScope) or isinstance(parent, GenExprScope):
            scope.nested = 1
        self.scopes[node] = scope
        self.visit(node.code, scope)
        self.handle_free_vars(scope, parent)
