...
# [GCC 8.4.0]
# Embedded file name: netbios.pyc
...
class NCBStruct:
    ...
    def _unpack--- This code section failed: ---

 L. 222         0  LOAD_GLOBAL           0  'struct'
                3  LOAD_ATTR             1  'unpack'
                6  LOAD_FAST             0  'self'
                9  LOAD_ATTR             2  '_format'
               12  LOAD_FAST             0  'self'
               15  LOAD_ATTR             3  '_buffer_'
               18  CALL_FUNCTION_2       2  None
               21  STORE_FAST            1  'items'

 L. 223        24  LOAD_GLOBAL           4  'len'
               27  LOAD_FAST             1  'items'
               30  CALL_FUNCTION_1       1  None
               33  LOAD_GLOBAL           4  'len'
               36  LOAD_FAST             0  'self'
               39  LOAD_ATTR             5  '_items'
               42  CALL_FUNCTION_1       1  None
               45  COMPARE_OP            2  ==
               48  POP_JUMP_IF_TRUE     60  'to 60'
               51  LOAD_ASSERT              AssertionError
               54  LOAD_CONST               'unexpected number of items to unpack!'
               57  RAISE_VARARGS_2       2  None

 L. 224        60  SETUP_LOOP           51  'to 114'
               63  LOAD_GLOBAL           7  'zip'
               66  LOAD_FAST             0  'self'
               69  LOAD_ATTR             5  '_items'
               72  LOAD_FAST             1  'items'
               75  CALL_FUNCTION_2       2  None
               78  GET_ITER         
               79  FOR_ITER             31  'to 113'
               82  UNPACK_SEQUENCE_2     2 
               85  UNPACK_SEQUENCE_2     2 
               88  STORE_FAST            2  'format'
               91  STORE_FAST            3  'name'
               94  STORE_FAST            4  'val'

 L. 225        97  LOAD_FAST             4  'val'
              100  LOAD_FAST             0  'self'
              103  LOAD_ATTR             8  '__dict__'
              106  LOAD_FAST             3  'name'
              109  STORE_SUBSCR     
              110  JUMP_BACK            79  'to 79'
              113  POP_BLOCK        
            114_0  COME_FROM            60  '60'

Parse error at or near `POP_BLOCK' instruction at offset 113
