...
# [GCC 8.4.0]
# Embedded file name: /home/mdipierro/make_web2py/web2py/gluon/contrib/pymysql/cursors.py
...
class SSCursor(Cursor):
    ...
    def scroll(self, value, mode='relative'):
        ...
        if mode == 'relative':
            if value < 0:
                self.errorhandler(self, NotSupportedError, 'Backwards scrolling not supported by this cursor')
