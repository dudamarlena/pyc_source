...
# [GCC 8.4.0]
# Embedded file name: doctest.pyc
# Compiled at: 2010-05-09 14:11:30
...
__all__ = [
 ...
 'debug_src',
 'debug']
import __future__, sys, traceback, inspect, linecache, os, re, unittest, difflib, pdb, tempfile, warnings
...
class DocTest():
 ...
 L. 477         0  LOAD_GLOBAL           0  'isinstance'
                3  LOAD_FAST             1  'examples'
 ...
 L. 478        19  LOAD_CONST               'DocTest no longer accepts str; use DocTestParser instead'
               22  RAISE_VARARGS_2       2  None

 L. 479        25  LOAD_FAST             1  'examples'
               28  LOAD_FAST             0  'self'
               31  STORE_ATTR            3  'examples'

 L. 480        34  LOAD_FAST             6  'docstring'
               37  LOAD_FAST             0  'self'
               40  STORE_ATTR            4  'docstring'

 L. 481        43  LOAD_FAST             2  'globs'
               46  LOAD_ATTR             5  'copy'
               49  CALL_FUNCTION_0       0  None
               52  LOAD_FAST             0  'self'
               55  STORE_ATTR            6  'globs'

 L. 482        58  LOAD_FAST             3  'name'
               61  LOAD_FAST             0  'self'
               64  STORE_ATTR            7  'name'

 L. 483        67  LOAD_FAST             4  'filename'
               70  LOAD_FAST             0  'self'
               73  STORE_ATTR            8  'filename'

 L. 484        76  LOAD_FAST             5  'lineno'
               79  LOAD_FAST             0  'self'
               82  STORE_ATTR            9  'lineno'

Parse error at or near `LOAD_FAST' instruction at offset 79
...
class OutputChecker():
    ...
    def output_difference--- This code section failed: ---

 L.1555         0  LOAD_FAST             1  'example'
                3  LOAD_ATTR             0  'want'
                6  STORE_FAST            4  'want'

 L.1558         9  LOAD_FAST             3  'optionflags'
               12  LOAD_GLOBAL           1  'DONT_ACCEPT_BLANKLINE'
               15  BINARY_AND       
               16  POP_JUMP_IF_TRUE     43  'to 43'

 L.1559        19  LOAD_GLOBAL           2  're'
               22  LOAD_ATTR             3  'sub'
               25  LOAD_CONST               '(?m)^[ ]*(?=\n)'
               28  LOAD_GLOBAL           4  'BLANKLINE_MARKER'
               31  LOAD_FAST             2  'got'
 ...
 L.1562        43  LOAD_FAST             0  'self'
               46  LOAD_ATTR             5  '_do_a_fancy_diff'
               49  LOAD_FAST             4  'want'
               52  LOAD_FAST             2  'got'
               55  LOAD_FAST             3  'optionflags'
               58  CALL_FUNCTION_3       3  None
               61  POP_JUMP_IF_FALSE   353  'to 353'

 L.1564        64  LOAD_FAST             4  'want'
               67  LOAD_ATTR             6  'splitlines'
               70  LOAD_GLOBAL           7  'True'
               73  CALL_FUNCTION_1       1  None
               76  STORE_FAST            5  'want_lines'

 L.1565        79  LOAD_FAST             2  'got'
               82  LOAD_ATTR             6  'splitlines'
               85  LOAD_GLOBAL           7  'True'
               88  CALL_FUNCTION_1       1  None
               91  STORE_FAST            6  'got_lines'

 L.1567        94  LOAD_FAST             3  'optionflags'
               97  LOAD_GLOBAL           8  'REPORT_UDIFF'
              100  BINARY_AND       
              101  POP_JUMP_IF_FALSE   153  'to 153'

 L.1568       104  LOAD_GLOBAL           9  'difflib'
              107  LOAD_ATTR            10  'unified_diff'
              110  LOAD_FAST             5  'want_lines'
              113  LOAD_FAST             6  'got_lines'
              116  LOAD_CONST               'n'
              119  LOAD_CONST               2
              122  CALL_FUNCTION_258   258  None
              125  STORE_FAST            7  'diff'

 L.1569       128  LOAD_GLOBAL          11  'list'
              131  LOAD_FAST             7  'diff'
              134  CALL_FUNCTION_1       1  None
              137  LOAD_CONST               2
              140  SLICE+1          
              141  STORE_FAST            7  'diff'

 L.1570       144  LOAD_CONST               'unified diff with -expected +actual'
              147  STORE_FAST            8  'kind'
              150  JUMP_FORWARD        138  'to 291'

 L.1571       153  LOAD_FAST             3  'optionflags'
              156  LOAD_GLOBAL          12  'REPORT_CDIFF'
              159  BINARY_AND       
              160  POP_JUMP_IF_FALSE   212  'to 212'

 L.1572       163  LOAD_GLOBAL           9  'difflib'
              166  LOAD_ATTR            13  'context_diff'
              169  LOAD_FAST             5  'want_lines'
              172  LOAD_FAST             6  'got_lines'
              175  LOAD_CONST               'n'
              178  LOAD_CONST               2
              181  CALL_FUNCTION_258   258  None
              184  STORE_FAST            7  'diff'

 L.1573       187  LOAD_GLOBAL          11  'list'
              190  LOAD_FAST             7  'diff'
              193  CALL_FUNCTION_1       1  None
              196  LOAD_CONST               2
              199  SLICE+1          
              200  STORE_FAST            7  'diff'

 L.1574       203  LOAD_CONST               'context diff with expected followed by actual'
              206  STORE_FAST            8  'kind'
              209  JUMP_FORWARD         79  'to 291'

 L.1575       212  LOAD_FAST             3  'optionflags'
              215  LOAD_GLOBAL          14  'REPORT_NDIFF'
              218  BINARY_AND       
              219  POP_JUMP_IF_FALSE   276  'to 276'

 L.1576       222  LOAD_GLOBAL           9  'difflib'
              225  LOAD_ATTR            15  'Differ'
              228  LOAD_CONST               'charjunk'
              231  LOAD_GLOBAL           9  'difflib'
              234  LOAD_ATTR            16  'IS_CHARACTER_JUNK'
              237  CALL_FUNCTION_256   256  None
              240  STORE_FAST            9  'engine'

 L.1577       243  LOAD_GLOBAL          11  'list'
              246  LOAD_FAST             9  'engine'
              249  LOAD_ATTR            17  'compare'
              252  LOAD_FAST             5  'want_lines'
              255  LOAD_FAST             6  'got_lines'
              258  CALL_FUNCTION_2       2  None
              261  CALL_FUNCTION_1       1  None
              264  STORE_FAST            7  'diff'

 L.1578       267  LOAD_CONST               'ndiff with -expected +actual'
              270  STORE_FAST            8  'kind'
              273  JUMP_FORWARD         15  'to 291'
 ...
 L.1582       291  BUILD_LIST_0          0 
              294  LOAD_FAST             7  'diff'
              297  GET_ITER         
              298  FOR_ITER             22  'to 323'
              301  STORE_FAST           10  'line'
              304  LOAD_FAST            10  'line'
              307  LOAD_ATTR            19  'rstrip'
              310  CALL_FUNCTION_0       0  None
              313  LOAD_CONST               '\n'
              316  BINARY_ADD       
              317  LIST_APPEND           2  None
              320  JUMP_BACK           298  'to 298'
              323  STORE_FAST            7  'diff'

 L.1583       326  LOAD_CONST               'Differences (%s):\n'
              329  LOAD_FAST             8  'kind'
              332  BINARY_MODULO    
              333  LOAD_GLOBAL          20  '_indent'
              336  LOAD_CONST               ''
              339  LOAD_ATTR            21  'join'
              342  LOAD_FAST             7  'diff'
              345  CALL_FUNCTION_1       1  None
              348  CALL_FUNCTION_1       1  None
              351  BINARY_ADD       
              352  RETURN_END_IF    
            353_0  COME_FROM            61  '61'

 L.1587       353  LOAD_FAST             4  'want'
              356  POP_JUMP_IF_FALSE   391  'to 391'
              359  LOAD_FAST             2  'got'
            362_0  COME_FROM           356  '356'
              362  POP_JUMP_IF_FALSE   391  'to 391'

 L.1588       365  LOAD_CONST               'Expected:\n%sGot:\n%s'
              368  LOAD_GLOBAL          20  '_indent'
              371  LOAD_FAST             4  'want'
              374  CALL_FUNCTION_1       1  None
              377  LOAD_GLOBAL          20  '_indent'
              380  LOAD_FAST             2  'got'
              383  CALL_FUNCTION_1       1  None
              386  BUILD_TUPLE_2         2 
              389  BINARY_MODULO    
              390  RETURN_END_IF    
            391_0  COME_FROM           362  '362'

 L.1589       391  LOAD_FAST             4  'want'
              394  POP_JUMP_IF_FALSE   411  'to 411'

 L.1590       397  LOAD_CONST               'Expected:\n%sGot nothing\n'
              400  LOAD_GLOBAL          20  '_indent'
              403  LOAD_FAST             4  'want'
              406  CALL_FUNCTION_1       1  None
              409  BINARY_MODULO    
              410  RETURN_END_IF    
            411_0  COME_FROM           394  '394'

 L.1591       411  LOAD_FAST             2  'got'
              414  POP_JUMP_IF_FALSE   431  'to 431'

 L.1592       417  LOAD_CONST               'Expected nothing\nGot:\n%s'
              420  LOAD_GLOBAL          20  '_indent'
              423  LOAD_FAST             2  'got'
              426  CALL_FUNCTION_1       1  None
              429  BINARY_MODULO    
              430  RETURN_END_IF    
            431_0  COME_FROM           414  '414'

 L.1594       431  LOAD_CONST               'Expected nothing\nGot nothing\n'
              434  RETURN_VALUE     

Parse error at or near `COME_FROM' instruction at offset 291_0
