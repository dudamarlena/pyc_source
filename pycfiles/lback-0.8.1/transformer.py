...
# [GCC 8.4.0]
# Embedded file name: compiler\transformer.pyc
...
def asList(nodes):
    ...
    for item in nodes:
        ...
        elif type(item) is type((None, None)):
...
class Transformer():
    ...
    def __init__(self):
        ...
        self._atom_dispatch = {token.LPAR: self.atom_lpar, token.LSQB: self.atom_lsqb, 
    ...
    def decorated(self, nodelist):
        ...
        if nodelist[1][0] == symbol.funcdef:
            n = [
             nodelist[0]] + list(nodelist[1][1:])
            return self.funcdef(n)
        if nodelist[1][0] == symbol.classdef:
    ...
    def print_stmt(self, nodelist):
        ...
        if len(nodelist) == 1:
            ...
            if nodelist[1][0] == token.RIGHTSHIFT:
    ...
    def power(self, nodelist):
        ...
        for i in range(1, len(nodelist)):
            ...
            if elt[0] == token.DOUBLESTAR:
                return Power([node, self.com_node(nodelist[(i + 1)])], lineno=elt[2])
    ...
    def com_import_as_name--- This code section failed: ---

 L. 905         0  LOAD_FAST             1  'node'
                3  LOAD_CONST               0
                6  BINARY_SUBSCR    
                7  LOAD_GLOBAL           0  'symbol'
               10  LOAD_ATTR             1  'import_as_name'
               13  COMPARE_OP            2  ==
               16  POP_JUMP_IF_TRUE     25  'to 25'
               19  LOAD_ASSERT              AssertionError
               22  RAISE_VARARGS_1       1  None

 L. 906        25  LOAD_FAST             1  'node'
               28  LOAD_CONST               1
               31  SLICE+1          
               32  STORE_FAST            1  'node'

 L. 907        35  LOAD_FAST             1  'node'
               38  LOAD_CONST               0
               41  BINARY_SUBSCR    
               42  LOAD_CONST               0
               45  BINARY_SUBSCR    
               46  LOAD_GLOBAL           3  'token'
               49  LOAD_ATTR             4  'NAME'
               52  COMPARE_OP            2  ==
               55  POP_JUMP_IF_TRUE     64  'to 64'
               58  LOAD_ASSERT              AssertionError
               61  RAISE_VARARGS_1       1  None

 L. 908        64  LOAD_GLOBAL           5  'len'
               67  LOAD_FAST             1  'node'
               70  CALL_FUNCTION_1       1  None
               73  LOAD_CONST               1
               76  COMPARE_OP            2  ==
               79  POP_JUMP_IF_FALSE   100  'to 100'

 L. 909        82  LOAD_FAST             1  'node'
               85  LOAD_CONST               0
               88  BINARY_SUBSCR    
               89  LOAD_CONST               1
               92  BINARY_SUBSCR    
               ...
               96  BUILD_TUPLE_2         2 
               99  RETURN_END_IF    
            100_0  COME_FROM            79  '79'

 L. 910       100  LOAD_FAST             1  'node'
              103  LOAD_CONST               1
              106  BINARY_SUBSCR    
              107  LOAD_CONST               1
              110  BINARY_SUBSCR    
              ...
              123  LOAD_FAST             1  'node'
              126  RAISE_VARARGS_2       2  None

 L. 911       129  LOAD_FAST             1  'node'
              132  LOAD_CONST               2
              135  BINARY_SUBSCR    
              136  LOAD_CONST               0
              139  BINARY_SUBSCR    
              140  LOAD_GLOBAL           3  'token'
              143  LOAD_ATTR             4  'NAME'
              146  COMPARE_OP            2  ==
              149  POP_JUMP_IF_TRUE    158  'to 158'
              152  LOAD_ASSERT              AssertionError
              155  RAISE_VARARGS_1       1  None

 L. 912       158  LOAD_FAST             1  'node'
              161  LOAD_CONST               0
              164  BINARY_SUBSCR    
              165  LOAD_CONST               1
              168  BINARY_SUBSCR    
              169  LOAD_FAST             1  'node'
              172  LOAD_CONST               2
              175  BINARY_SUBSCR    
              176  LOAD_CONST               1
              179  BINARY_SUBSCR    
...
Parse error at or near `BUILD_TUPLE_2' instruction at offset 180
    ...
    def com_assign_list--- This code section failed: ---

 L.1052         0  BUILD_LIST_0          0 
                3  STORE_FAST            3  'assigns'

 L.1053         6  SETUP_LOOP          169  'to 178'
               ...
               24  LOAD_CONST               2
               27  CALL_FUNCTION_3       3  None
               30  GET_ITER         
               31  FOR_ITER            143  'to 177'
               34  STORE_FAST            4  'i'

 L.1054        37  LOAD_FAST             4  'i'
               40  LOAD_CONST               1
               43  BINARY_ADD       
               ...
               53  COMPARE_OP            0  <
               56  POP_JUMP_IF_FALSE   145  'to 145'

 L.1055        59  LOAD_FAST             1  'node'
               62  LOAD_FAST             4  'i'
               65  LOAD_CONST               1
               68  BINARY_ADD       
               69  BINARY_SUBSCR    
               70  LOAD_CONST               0
               73  BINARY_SUBSCR    
               74  LOAD_GLOBAL           2  'symbol'
               77  LOAD_ATTR             3  'list_for'
               80  COMPARE_OP            2  ==
               83  POP_JUMP_IF_FALSE    98  'to 98'

 L.1056        86  LOAD_GLOBAL           4  'SyntaxError'
               89  LOAD_CONST               "can't assign to list comprehension"
               92  RAISE_VARARGS_2       2  None
               95  JUMP_FORWARD          0  'to 98'
             98_0  COME_FROM            95  '95'

 L.1057        98  LOAD_FAST             1  'node'
              101  LOAD_FAST             4  'i'
              104  LOAD_CONST               1
              107  BINARY_ADD       
              108  BINARY_SUBSCR    
              109  LOAD_CONST               0
              112  BINARY_SUBSCR    
              113  LOAD_GLOBAL           5  'token'
              116  LOAD_ATTR             6  'COMMA'
              119  COMPARE_OP            2  ==
              122  POP_JUMP_IF_TRUE    145  'to 145'
 ...
 L.1058       145  LOAD_FAST             3  'assigns'
              148  LOAD_ATTR             8  'append'
              151  LOAD_FAST             0  'self'
              154  LOAD_ATTR             9  'com_assign'
              157  LOAD_FAST             1  'node'
              160  LOAD_FAST             4  'i'
              163  BINARY_SUBSCR    
              164  LOAD_FAST             2  'assigning'
              167  CALL_FUNCTION_2       2  None
              170  CALL_FUNCTION_1       1  None
              173  POP_TOP          
              174  JUMP_BACK            31  'to 31'
              177  POP_BLOCK        
            178_0  COME_FROM             6  '6'

 L.1059       178  LOAD_GLOBAL          10  'AssList'
              181  LOAD_FAST             3  'assigns'
              184  LOAD_CONST               'lineno'
              187  LOAD_GLOBAL          11  'extractLineNo'
              190  LOAD_FAST             1  'node'
              193  CALL_FUNCTION_1       1  None
              196  CALL_FUNCTION_257   257  None
              199  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `POP_BLOCK' instruction at offset 177
    ...
    def com_comprehension(self, expr1, expr2, node, type):
        ...
        while node:
            ...
            if t == 'for':
                ...
                raise SyntaxError, 'unexpected comprehension element: %s %d' % (
                 node, lineno)
    ...
    def com_dictorsetmaker(self, nodelist):
        ...
        if len(nodelist) == 1 or nodelist[1][0] == token.COMMA:
            ...
            if nodelist[1][0] == symbol.comp_for:
                expr = self.com_node(nodelist[0])
                return self.com_comprehension(expr, None, nodelist[1], 'set')
            else:
                if len(nodelist) > 3 and nodelist[3][0] == symbol.comp_for:
    ...
    def com_call_function(self, primaryNode, nodelist):
        if nodelist[0] == token.RPAR:
            ...
            while i < len_nodelist:
                ...
                if len_nodelist != 2 and isinstance(result, GenExpr) and len(node) == 3 and node[2][0] == symbol.comp_for:
    ...
    def com_argument(self, nodelist, kw, star_node):
        if len(nodelist) == 3 and nodelist[2][0] == symbol.comp_for:
            ...
            return (
             0, self.com_generator_expression(test, nodelist[2]))
        if len(nodelist) == 2:
            if kw:
    ...
    def com_subscriptlist(self, primary, nodelist, assigning):
        if len(nodelist) == 2:
            sub = nodelist[1]
            if (sub[1][0] == token.COLON or len(sub) > 2 and sub[2][0] == token.COLON) and sub[(-1)][0] != symbol.sliceop:
