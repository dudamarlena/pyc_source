...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.8/site-packages/notifications/migrations/0001_initial.py
# Compiled at: 2020-01-31 08:32:40
# Size of source mod 2**32: 3186 bytes
from __future__ import unicode_literals
from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion, tinymce.models
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='UserNotification',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
