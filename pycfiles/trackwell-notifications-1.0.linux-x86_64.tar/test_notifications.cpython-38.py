...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.8/site-packages/notifications/tests/test_notifications.py
...
class NotificationTest(BaseClientTest):
    ...
    def setUp(self):
        ...
        self.notification = Notification.objects.create(name='test',
    ...
    def test_cookie(self):
        ...
        self.assertTrue(abs(datetime.datetime.utcfromtimestamp(unseentime) - self.created) < datetime.timedelta(seconds=5))
        self.un.seen = True
        self.un.answer = False
        self.un.save()
