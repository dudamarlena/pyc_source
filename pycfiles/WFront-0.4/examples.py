...
# [GCC 8.4.0]
# Embedded file name: /Users/jek/projects/oss/src/wfront-work/docs/source/_lib/examples.py
# Compiled at: 2008-12-26 22:21:00
import os
from docutils import io, nodes, statemachine, utils
from docutils.parsers.rst import Directive, directives, states

class DelimitedInclude(Directive):
    r"""Include a chunk of another file between matching text delimiters.
    ...
    option_spec = {'literal': directives.flag, 'encoding': directives.encoding, 
    ...
    def run(self):
        ...
        if start == -1 or start == end:
            raise self.severe('Problem with "id" option of "%s" directive:\nText "%s" not found.' % (
             self.name, marker))
