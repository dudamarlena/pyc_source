...
class _SSIP_Connection(object):
    ...
    def __init__(self, method, socket_path, host, port):
        ...
        if method == ConnectionMethod.UNIX_SOCKET:
            ...
            if method == ConnectionMethod.INET_SOCKET:
 ...
 L. 229         0  BUILD_LIST_0          0 
                3  STORE_FAST            1  'data'

 L. 230         6  LOAD_CONST               None
                9  STORE_FAST            2  'c'

 L. 231        12  SETUP_LOOP          194  'to 209'
               15  LOAD_GLOBAL           1  'True'
               18  POP_JUMP_IF_FALSE   208  'to 208'

 L. 232        21  LOAD_FAST             0  'self'
               24  LOAD_ATTR             2  '_readline'
               27  CALL_FUNCTION_0       0  None
               30  STORE_FAST            3  'line'

 L. 233        33  LOAD_GLOBAL           3  'len'
               36  LOAD_FAST             3  'line'
 ...
 L. 237       149  LOAD_FAST             5  'sep'
              152  LOAD_CONST               ' '
              155  COMPARE_OP            2  ==
              158  POP_JUMP_IF_FALSE   192  'to 192'

 L. 238       161  LOAD_FAST             6  'text'
              164  STORE_FAST            7  'msg'

 L. 239       167  LOAD_GLOBAL           6  'int'
...
class SSIPClient(object):
    ...
    def __init__(self, name, component='default', user='unknown', host=None, port=None, method=ConnectionMethod.UNIX_SOCKET, socket_path=None, autospawn=None):
        ...
        if socket_path is None:
            socket_path = os.environ.get('SPEECHD_SOCKET', os.path.expanduser(self.DEFAULT_SOCKET_PATH))
        if host is None:
        ...
        connection_args = {'method': method, 'socket_path': socket_path, 'host': host, 'port': port}
        try:
    ...
    def _server_spawn(self):
        ...
        if os.path.exists(paths.SPD_SPAWN_CMD):
            server = subprocess.Popen([paths.SPD_SPAWN_CMD, '--spawn'], stdin=None, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
            server.wait()
            return server.pid
        else:
...
Parse error at or near `CALL_FUNCTION_4' instruction at offset 75
    ...
    def list_synthesis_voices(self):
        ...
        def split(item):
            ...
            return (
             name, lang or None, dialect or None)
 ...
 L. 710         0  LOAD_GLOBAL           0  'isinstance'
                3  LOAD_FAST             1  'value'
                6  LOAD_GLOBAL           1  'int'
...
Parse error at or near `CALL_FUNCTION_4' instruction at offset 73
 ...
 L. 748         0  LOAD_FAST             1  'value'
                3  LOAD_GLOBAL           0  'PunctuationMode'
                6  LOAD_ATTR             1  'ALL'
                9  LOAD_GLOBAL           0  'PunctuationMode'
               12  LOAD_ATTR             2  'SOME'

 L. 749        15  LOAD_GLOBAL           0  'PunctuationMode'
               18  LOAD_ATTR             3  'NONE'
               21  BUILD_TUPLE_3         3 
               24  COMPARE_OP            6  in
