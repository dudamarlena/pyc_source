...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/client/utils/devices/device.py
...
class DeviceGenerator:
    ...
    def get_all_good_devices(self) -> list:
        return self.DEVICES

    def is_good_device(self, device: str) -> bool:
