...
# [GCC 8.4.0]
# Embedded file name: /Users/omer/Projects/DjangoProjects/basitapi/basitapi/tests/integration_tests/views_tests.py
# Compiled at: 2013-04-25 14:17:42
...
class SampleView(ApiView):
    ...
    def post(self, request):
        return ApiResponse({'method': 'post', 
           'data': int(request.REQUEST.get('data', 0))})

    def delete(self, request):
        return ApiResponse({'method': 'delete', 
           'data': int(request.REQUEST.get('data', 0))})

    def put(self, request):
        return ApiResponse({'method': 'put', 
           'data': int(request.REQUEST.get('data', 0))})
