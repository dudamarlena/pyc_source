...
# [GCC 8.4.0]
# Embedded file name: c:\users\landon\dropbox\documents\pycharmprojects\mezzanine-wiki\mezzanine_wiki\urls.py
# Compiled at: 2018-02-01 11:56:27
# Size of source mod 2**32: 1326 bytes
from django.conf.urls import url
from .views import *
urlpatterns = [
 url('^$', (Wiki_index.as_view()), name='wiki_index'),
