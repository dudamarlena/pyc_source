...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/aiio/think.py
# Compiled at: 2016-09-29 17:10:47
    ...
    if vmeanz:
        ...
        for mng in vmeanz:
            ...
            if opposite and mng.antonyms:
                ...
                if not opposite and mng.synonyms:
