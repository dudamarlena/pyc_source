...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dbg.py
# Compiled at: 2015-01-05 10:37:12
"""inline-debugging helper script. allows calling either pdb or winpdb in a similar fashion, from a single line of code:
    import dbg ; dbg.D()
"""
import copy, os, random, string, sys, time, threading, warnings
...
class _pydevd_args_type(object):
    ...
    def update_defaults(self):
        if pydevd_remote_set_trace is not None:
            pydevd_remote_set_trace.func_defaults = (
             self._host, True, True, self._port, True, False, False, False)
        return
