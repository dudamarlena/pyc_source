...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trytond/modules/health_ophtalmo/health_ophtalmo.py
# Compiled at: 2012-07-03 01:20:31
...
class GnuHealthPatient(ModelSQL, ModelView):
    """Add to the Medical patient_data class (gnuhealth.patient) the ophtalmologic fields."""
