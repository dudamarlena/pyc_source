...
# [GCC 8.4.0]
# Embedded file name: /home/mikhail/.virtualenvs/django-robokassa/lib/python3.5/site-packages/robokassa/tests.py
# Compiled at: 2018-04-26 06:49:17
...
class RobokassaFormTest(TestCase):
    ...
    def setUp(self):
        self.form = RobokassaForm(initial={'OutSum': 100.0, 
         'InvId': 58, 
         'Desc': 'Холодильник "Бирюса"', 
         'Email': 'vasia@example.com'})

    def testSignature(self):
        self.assertEqual(self.form._get_signature_string(), '%s:100.0:58:%s:shpparam1=None:shpparam2=None' % (LOGIN, PASSWORD1))
    ...
    def testSignatureMissingParams(self):
        ...
        self.assertEqual(form._get_signature_string(), '%s::5:%s:shpparam1=None:shpparam2=None' % (LOGIN, PASSWORD1))
...
class RobokassaFormExtraTest(TestCase):
    ...
    def testExtra(self):
        form = RobokassaForm(initial={'InvId': 58, 
         'OutSum': 100, 
         'param1': 'value1', 
         'param2': 'value2'})
...
class ResultURLTest(DjangoTestCase):
    ...
    def testFormExtra(self):
        form = ResultURLForm({'OutSum': '100', 
         'InvId': '58', 
         'SignatureValue': 'B2111A06F6B7A1E090D38367BF7032D9', 
         'shpparam1': 'Vasia', 
         'shpparam2': 'None'})
        self.assertTrue(form.is_valid())
        self.assertEqual(form._get_signature_string(), '100:58:%s:shpparam1=Vasia:shpparam2=None' % PASSWORD2)
        self.assertEqual(form.extra_params(), {'param1': 'Vasia', 'param2': 'None'})

    def testFormValid(self):
        self.assertTrue(ResultURLForm({'OutSum': '100', 
         'InvId': '58', 
         'SignatureValue': '877D3BAF8381F70E56638C3BC82580C5', 
         'shpparam1': 'None', 
         'shpparam2': 'None'}).is_valid())
        self.assertFalse(ResultURLForm({'OutSum': '101', 
         'InvId': '58', 
         'SignatureValue': '877D3BAF8381F70E56638C3BC82580C5', 
         'shpparam1': 'None', 
         'shpparam2': 'None'}).is_valid())
        self.assertFalse(ResultURLForm({'OutSum': '100', 
         'InvId': '58', 
         'SignatureValue': '877D3BAF8381F70E56638C3BC82580C5', 
         'shpparam1': 'Vasia', 
         'shpparam2': 'None'}).is_valid())
