...
# [GCC 8.4.0]
# Embedded file name: /home/mows/Scripts/ExoPlex/ExoPlex/burnman/minerals/SLB_2011.py
...
class clinopyroxene(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [
         [
          0.0, 24740.0, 26000.0, 24300.0], [24740.0, 0.0, 0.0], [60531.36, 0.0], [10000.0]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class garnet(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [
         [
          0.0, 30000.0, 21202.78, 0.0], [0.0, 0.0, 0.0], [57775.96, 0.0], [0.0]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class akimotoite(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[0.0, 66000.0], [66000.0]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class mg_fe_olivine(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[7813.22]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class orthopyroxene(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [
         [
          0.0, 0.0, 32113.52], [0.0, 0.0], [48353.16]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class plagioclase(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[26000.0]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class post_perovskite(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[0.0, 60000.0], [0.0]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class mg_fe_perovskite(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[0.0, 116000.0], [0.0]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class mg_fe_ringwoodite(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[9340.84]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class mg_fe_aluminous_spinel(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[5876.46]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class mg_fe_wadsleyite(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.energy_interaction = [[16747.18]]
        SolidSolution.__init__(self, molar_fractions=molar_fractions)
...
class anorthite(Mineral):
    ...
    def __init__(self):
        ...
        self.uncertainties = {'err_F_0': 4000.0, 
           'err_V_0': 0.0, 
...
class albite(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Albite', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 5000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 5000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 13.0, 
...
class spinel(Mineral):
    ...
    def __init__(self):
        ...
        self.uncertainties = {'err_F_0': 32000.0, 
           'err_V_0': 0.0, 
...
class hercynite(Mineral):
    ...
    def __init__(self):
        ...
        self.uncertainties = {'err_F_0': 35000.0, 
           'err_V_0': 0.0, 
...
class forsterite(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Forsterite', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 2000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 2000000000.0, 
           'err_K_prime_0': 0.2, 
           'err_Debye_0': 1.0, 
...
class fayalite(Mineral):
    ...
    def __init__(self):
        ...
        self.uncertainties = {'err_F_0': 1000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 2000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 2.0, 
...
class mg_wadsleyite(Mineral):
    ...
    def __init__(self):
        formula = 'Mg2SiO4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Mg_Wadsleyite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -2027837.0, 
           'V_0': 4.0515e-05, 
...
class fe_wadsleyite(Mineral):
    ...
    def __init__(self):
        formula = 'Fe2SiO4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Fe_Wadsleyite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1364668.0, 
           'V_0': 4.28e-05, 
        ...
        self.property_modifiers = [
         [
          'linear', {'delta_E': 0.0, 'delta_S': 26.76, 'delta_V': 0.0}]]
        self.uncertainties = {'err_F_0': 7000.0, 
           'err_V_0': 0.0, 
...
class mg_ringwoodite(Mineral):
    ...
    def __init__(self):
        formula = 'Mg2SiO4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Mg_Ringwoodite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -2017557.0, 
           'V_0': 3.9493e-05, 
...
class fe_ringwoodite(Mineral):
    ...
    def __init__(self):
        formula = 'Fe2SiO4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Fe_Ringwoodite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1362772.0, 
           'V_0': 4.186e-05, 
...
class mg_tschermaks(Mineral):
    ...
    def __init__(self):
        formula = 'MgAl2SiO6'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Mg_Tschermaks', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -3002470.0, 
           'V_0': 5.914e-05, 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 9000.0, 
           'err_V_0': 0.0, 
...
class ortho_diopside(Mineral):
    ...
    def __init__(self):
        formula = 'CaMgSi2O6'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Ortho_Diopside', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -3015827.0, 
           'V_0': 6.8054e-05, 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 3000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 10000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 9.0, 
...
class hedenbergite(Mineral):
    ...
    def __init__(self):
        ...
        self.uncertainties = {'err_F_0': 45000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 4000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 2.0, 
...
class clinoenstatite(Mineral):
    ...
    def __init__(self):
        formula = 'Mg2Si2O6'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Clinoenstatite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -2905918.0, 
           'V_0': 6.25e-05, 
...
class ca_tschermaks(Mineral):
    ...
    def __init__(self):
        formula = 'CaAl2SiO6'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Ca_Tschermaks', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -3120253.0, 
           'V_0': 6.3574e-05, 
...
class hp_clinoenstatite(Mineral):
    ...
    def __init__(self):
        formula = 'Mg2Si2O6'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'HP_Clinoenstatite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -2905788.0, 
           'V_0': 6.076e-05, 
...
class hp_clinoferrosilite(Mineral):
    ...
    def __init__(self):
        formula = 'Fe2Si2O6'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'HP_Clinoferrosilite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -2222183.0, 
           'V_0': 6.385413e-05, 
...
class ca_perovskite(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Ca_Perovskite', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 8000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 4000000000.0, 
           'err_K_prime_0': 0.2, 
           'err_Debye_0': 44.0, 
...
class mg_akimotoite(Mineral):
    ...
    def __init__(self):
        formula = 'MgSiO3'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Mg_Akimotoite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1410850.0, 
           'V_0': 2.6354e-05, 
...
class fe_akimotoite(Mineral):
    ...
    def __init__(self):
        formula = 'FeSiO3'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Fe_Akimotoite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1067598.0, 
           'V_0': 2.6854e-05, 
        ...
        self.property_modifiers = [
         [
          'linear', {'delta_E': 0.0, 'delta_S': 13.38, 'delta_V': 0.0}]]
        self.uncertainties = {'err_F_0': 21000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 10000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 120.0, 
...
class pyrope(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Pyrope', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 10000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 2000000000.0, 
           'err_K_prime_0': 0.3, 
           'err_Debye_0': 4.0, 
...
class almandine(Mineral):
    ...
    def __init__(self):
        ...
        self.uncertainties = {'err_F_0': 29000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 2000000000.0, 
           'err_K_prime_0': 0.2, 
           'err_Debye_0': 5.0, 
...
class grossular(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Grossular', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 11000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 1000000000.0, 
           'err_K_prime_0': 0.2, 
           'err_Debye_0': 2.0, 
...
class jd_majorite(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Jd_Majorite', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 14000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 7000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 18.0, 
...
class fe_perovskite(Mineral):
    ...
    def __init__(self):
        ...
        self.property_modifiers = [
         [
          'linear', {'delta_E': 0.0, 'delta_S': 13.38, 'delta_V': 0.0}]]
        self.uncertainties = {'err_F_0': 6000.0, 
           'err_V_0': 0.0, 
...
class al_perovskite(Mineral):
    ...
    def __init__(self):
        formula = 'AlAlO3'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Al_perovskite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1533878.0, 
           'V_0': 2.4944e-05, 
...
class mg_post_perovskite(Mineral):
    ...
    def __init__(self):
        formula = 'MgSiO3'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Mg_Post_Perovskite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1348641.0, 
           'V_0': 2.4419e-05, 
...
class fe_post_perovskite(Mineral):
    ...
    def __init__(self):
        formula = 'FeSiO3'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Fe_Post_Perovskite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -981806.9, 
           'V_0': 2.5459e-05, 
...
class al_post_perovskite(Mineral):
    ...
    def __init__(self):
        formula = 'AlAlO3'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Al_Post_Perovskite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1377582.0, 
           'V_0': 2.3847e-05, 
...
class periclase(Mineral):
    ...
    def __init__(self):
        ...
        self.params = {'name': 'Periclase', 
           ...
           'n': sum(formula.values()), 
           'molar_mass': formula_mass(formula, atomic_masses)}
        self.uncertainties = {'err_F_0': 0.0, 
           'err_V_0': 0.0, 
           'err_K_0': 3000000000.0, 
           'err_K_prime_0': 0.2, 
           'err_Debye_0': 9.0, 
...
class mg_ca_ferrite(Mineral):
    ...
    def __init__(self):
        formula = 'MgAl2O4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Mg_Ca_Ferrite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -2122169.0, 
           'V_0': 3.6177e-05, 
...
class fe_ca_ferrite(Mineral):
    ...
    def __init__(self):
        formula = 'FeAl2O4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Fe_Ca_Ferrite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1790284.0, 
           'V_0': 3.7258e-05, 
        ...
        self.property_modifiers = [
         [
          'linear', {'delta_E': 0.0, 'delta_S': 13.38, 'delta_V': 0.0}]]
        self.uncertainties = {'err_F_0': 25000.0, 
           'err_V_0': 0.0, 
           'err_K_0': 10000000000.0, 
           'err_K_prime_0': 1.0, 
           'err_Debye_0': 69.0, 
...
class na_ca_ferrite(Mineral):
    ...
    def __init__(self):
        formula = 'NaAlSiO4'
        formula = dictionarize_formula(formula)
        self.params = {'name': 'Na_Ca_Ferrite', 
           'formula': formula, 
           'equation_of_state': 'slb3', 
           'F_0': -1844129.0, 
           'V_0': 3.627e-05, 
