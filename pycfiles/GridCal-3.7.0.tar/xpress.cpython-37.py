...
# [GCC 8.4.0]
# Embedded file name: /home/santi/Documentos/GitHub/GridCal/src/GridCal/ThirdParty/pulp/solver_interfaces/xpress.py
...
class XPRESS(LpSolver_CMD):
    __doc__ = 'The XPRESS LP solver'

    def __init__(self, path=None, keepFiles=0, mip=1, msg=0, maxSeconds=None, targetGap=None, heurFreq=None, heurStra=None, coverCuts=None, preSolve=None, options=[]):
        """
    ...
    def actualSolve(self, lp):
        ...
        if abs(lp.infeasibilityGap(self.mip)) > 1e-05:
