...
# [GCC 8.4.0]
# Embedded file name: /home/www.django/makarthy/codenerix_email/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    dependencies = []
    operations = [
     migrations.CreateModel(name='EmailAttachment', fields=[
      (
      ...
      (
       'path', models.FileField(upload_to=b'', verbose_name='Path'))], options={'default_permissions': ('add', 'change', 'delete', 'view', 'list'), 
      'abstract': False}),
     migrations.CreateModel(name='EmailMessage', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
      ...
      (
       'log', models.TextField(blank=True, null=True, verbose_name='Log'))], options={'default_permissions': ('add', 'change', 'delete', 'view', 'list'), 
      'abstract': False}),
     migrations.CreateModel(name='EmailTemplate', fields=[
      ...
      (
       'efrom', models.TextField(blank=True, verbose_name='From'))], options={'default_permissions': ('add', 'change', 'delete', 'view', 'list'), 
      'abstract': False}),
     migrations.AddField(model_name='emailattachment', name='email', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='codenerix_email.EmailMessage'))]