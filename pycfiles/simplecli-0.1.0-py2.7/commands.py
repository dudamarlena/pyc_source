...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/simplecli/commands.py
# Compiled at: 2013-01-10 14:20:52
from __future__ import absolute_import
from __future__ import with_statement
from __future__ import print_function
import os, code, argparse
...
class Shell(Command):
    ...
    def __init__(self, banner=None, make_context=None, use_ipython=True, use_bpython=True):
