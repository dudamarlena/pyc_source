...
# [GCC 8.4.0]
# Embedded file name: /Users/twaldear/Sites/secure-headers-root/flask_secure_headers/headers.py
            ...
            if k in self.valid_opts:
                for param in self.valid_opts[k]:
                    ...
                    if type(param) is str and '+' in param:
                        if re.search('^' + param, str(input)):
                            return True
                    else:
                        if type(param) is bool and type(input) is bool:
                            return True
                        if type(param) is list and type(input) is list:
                            return True
