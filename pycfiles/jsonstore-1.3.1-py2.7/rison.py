...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/jsonstore/rison.py
# Compiled at: 2013-02-28 12:33:19
import os, sys, re
simplejson = None
...
class Parser(object):
    ...
    not_idchar = ('').join([ c for c in (chr(i) for i in range(127)) if not (c.isalnum() or c in idchar_punctuation)
                           ])
