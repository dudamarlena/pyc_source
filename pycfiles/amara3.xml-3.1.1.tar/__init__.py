...
# Embedded file name: /Users/uche/dev/amara/test/__init__.py
...
import contextlib, errno, socket, sys, os, shutil, warnings, unittest, types, operator, time
__unittest = True
...
class test_loader(unittest.TestLoader):
    ...
    def loadTestsFromModule(self, module):
        ...
        for (name, obj) in vars(module).iteritems():
            if isinstance(obj, (type, types.ClassType)) and '__unittest__' not in obj.__dict__ and '__unittest' not in sys.modules[obj.__module__].__dict__:
...
class _test_stream(object):
    ...
    def __init__(self, stream):
        ...
        if stream.isatty():
            if sys.platform == 'win32':
                ...
                self._colors = {'NORMAL': '\x1b[0m', 'RED': '\x1b[1;31m', 
                   'GREEN': '\x1b[1;32m', 
                   'YELLOW': '\x1b[1;33m', 
                   'WHITE': '\x1b[1;37m'}
    ...
    def _init_win32(self):
        ...
        self._colors = {'NORMAL': info.wAttributes, 
           'RED': 12, 
           'GREEN': 10, 
           'YELLOW': 14, 
           'WHITE': 15}
