...
# Embedded file name: /home/travis/virtualenv/python2.7.15/lib/python2.7/site-packages/coolamqp/exceptions.py
# Compiled at: 2020-05-06 12:56:42
from __future__ import absolute_import, division, print_function
from coolamqp.framing.definitions import HARD_ERRORS, RESOURCE_LOCKED
__all__ = [
 'HARD_ERRORS', 'RESOURCE_LOCKED', 'CoolAMQPError', 'ConnectionDead', 'AMQPError']
...
class AMQPError(CoolAMQPError):
    ...
    def __repr__(self):
        return 'AMQPError(' + repr(self.reply_code) + ', ' + repr(self.__get_reply_text()) + ', ' + repr(self.class_id) + ', ' + repr(self.method_id) + ')'
