...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/compliance_suite/metadata_algorithms.py
# Compiled at: 2018-10-01 09:29:31
# Size of source mod 2**32: 5623 bytes
import requests, json
METADATA_ACCEPT_HEADER = {'Accept': 'application/vnd.ga4gh.refget.v1.0.0+json'}
...
def metadata_invalid_encoding_406_error(test, runner):
    ...
    """
    base_url = str(runner.base_url)
    response = requests.get(base_url + 'sequence/' + SEQ_MD5, headers={'Accept': 'embl/some_json'})
