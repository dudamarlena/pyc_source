...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/compliance_suite/test_runner.py
# Compiled at: 2018-09-28 03:29:05
...
class TestRunner:
    ...
    def __init__(self, base_url):
        ...
        """
        self.root = None
        self.session_params = {'limit': None, 
         'trunc512': None, 
         'circular': None, 
         'redirection': None}
        self.test_data = data()
    ...
    def recurse_generate_json(self, node):
        ...
        for child in node.children:
            if child.label == label:
                test_result_object = {'name': str(child), 
                 'result': child.result, 
    ...
    def generate_final_json(self):
        ...
        report_object = {'server': self.base_url, 
         'date_time': str(now), 
