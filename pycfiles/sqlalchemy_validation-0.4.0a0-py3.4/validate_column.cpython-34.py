...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sqlalchemy_validation/validate_column.py
# Compiled at: 2015-12-31 01:46:45
# Size of source mod 2**32: 4141 bytes
import sqlalchemy
from .error import *
...
class ColumnValidator(object):
    ...
    def __init__(self, column):
        ...
        self.validates = validates
        self.has_default = column.server_default is not None and column.default is not None and column.autoincrement
    ...
    def validate_not_none(self, model, value):
        column = self.column
        if value is None:
            if not column.nullable and not self.has_default:
