...
# [GCC 8.4.0]
# Embedded file name: /Users/ogom/.pyenv/versions/2.7.6/lib/python2.7/site-packages/mcider/converter.py
...
class Slide:
    ...
    def _get_slide_io2012(self, contents=None, extensions=[]):
        """ io-2012 style """
        md = Markdown(extensions=extensions)
        splits = [{'horizon': '----', 'style': 'none'}, {'horizon': '____', 'style': 'smaller'}, {'horizon': '****', 'style': 'fill'}]
        styles = []
        for split in splits:
