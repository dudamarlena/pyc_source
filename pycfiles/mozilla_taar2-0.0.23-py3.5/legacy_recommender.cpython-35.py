...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/taar/recommenders/legacy_recommender.py
...
class LegacyRecommender(BaseRecommender):
    ...
    def recommend(self, client_data, limit, extra_data={}):
        ...
        replacements = [self.legacy_replacements[legacy_addon] for legacy_addon in legacy_addons if legacy_addon in self.legacy_replacements]
        recommendations = []
