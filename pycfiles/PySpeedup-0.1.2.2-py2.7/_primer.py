...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyspeedup/concurrent/_primer.py
...
listOfAlgorithms = [
 (
  StrongPrimeTest, 0), (BrutePrimitivityTest, 0, 1, 2), (pollard_p1, 0, 1, 2), (pollard_rho, 0, 1, 2)]
