...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyspeedup/memory/_disklist.py
# Compiled at: 2017-02-26 00:03:34
    ...
    def _load_page_from_disk(self, number):
        if self._file_base:
            try:
                ...
                if e.errno != 2:
                    raise
                raise IOError(2, 'Files got corrupted or removed, file ' + str(number) + ' no longer exists.')
