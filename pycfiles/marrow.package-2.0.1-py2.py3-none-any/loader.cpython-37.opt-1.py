...
# [GCC 8.4.0]
# Embedded file name: /marrow/package/loader.py
...
def load(target: str, namespace: str=None, default=nodefault, executable: bool=False, separators: Sequence[str]=('.', ':'), protect: bool=True):
    ...
    if target:
        return traverse(obj, (separators[0].join(parts.split(separators[0])[1:] + target.split(separators[0]))), default=default, executable=executable, protect=protect)
    return obj