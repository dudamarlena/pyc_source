...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/simplexmlapi/node.py
# Compiled at: 2008-09-12 12:40:56
...
class DotNode(object):
        ...
        def delegate(name, idx=''):
            ...
            if not idx:
                ...
                try:
                    ...
                    raise AttributeParsingError("The locator you've specified is invalid.")
    ...
    def getChildren(self, name, *args):
        ...
        if not children:
            try:
                ...
                raise NoSuchNode('No %s node found as a child of %s' % (name, self.getName()))
    ...
    def getItem(self, name, idx):
        ...
        try:
            ...
            raise NoSuchNode("There aren't that many %s nodes under %s." % (name, self.getName()))
    ...
    def getAttribute(self, name, *args):
        ...
        if not attrval:
            raise NoSuchAttribute('No %s attribute exists on %s node.' % (name, self.getName()))
