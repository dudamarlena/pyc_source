...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/time2pull/icons.py
...
def get_status_icon(has_local_changes=False, status=RemoteStatus.up_to_date, size=QtCore.QSize(64, 64), offset=(0, 0)):
    base = ':/time2pull/icons/Database.png' if not has_local_changes else ':/time2pull/icons/DatabaseDirty.png'
    icons = {RemoteStatus.up_to_date: None, 
...
def get_tray_icon(is_behind):
    if is_behind:
        ...
        icons = {TrayIconType.light: ':/time2pull/icons/Download-light.png', 
