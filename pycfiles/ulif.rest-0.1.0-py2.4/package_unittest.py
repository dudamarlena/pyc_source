...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ulif/rest/tests/package_unittest.py
...
debug = 0
verbosity = 1
USAGE = 'Usage: test_whatever [options]\n\nOptions:\n  -h, --help       Show this message\n  -v, --verbose    Verbose output\n  -q, --quiet      Minimal output\n  -d, --debug      Debug mode\n'
...
def loadTestModules(path, name='', packages=None):
    ...
    while paths:
        ...
        for filename in files:
            if filename.startswith(name):
                ...
                elif packages and os.path.isdir(fullpath) and os.path.isfile(os.path.join(fullpath, '__init__.py')):
    ...
    for mod in testModules:
        ...
        try:
            ...
            elif type(suite) == types.InstanceType and isinstance(suite, unittest.TestSuite):
                testSuite.addTest(suite)
            else:
