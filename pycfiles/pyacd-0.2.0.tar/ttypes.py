...
# Embedded file name: build/bdist.linux-x86_64/egg/pyaccumulo/proxy/ttypes.py
...
class TablePermission:
    ...
    GRANT = 6
    DROP_TABLE = 7
    _VALUES_TO_NAMES = {2: 'READ', 
       3: 'WRITE', 
       4: 'BULK_IMPORT', 
       5: 'ALTER_TABLE', 
       6: 'GRANT', 
       7: 'DROP_TABLE'}
    _NAMES_TO_VALUES = {'READ': 2, 
       'WRITE': 3, 
       'BULK_IMPORT': 4, 
       'ALTER_TABLE': 5, 
       'GRANT': 6, 
...
class ScanType:
    SINGLE = 0
    BATCH = 1
    _VALUES_TO_NAMES = {0: 'SINGLE', 
       1: 'BATCH'}
    _NAMES_TO_VALUES = {'SINGLE': 0, 
       'BATCH': 1}
...
class ScanState:
    ...
    RUNNING = 1
    QUEUED = 2
    _VALUES_TO_NAMES = {0: 'IDLE', 
       1: 'RUNNING', 
       2: 'QUEUED'}
    _NAMES_TO_VALUES = {'IDLE': 0, 
       'RUNNING': 1, 
       'QUEUED': 2}
...
class CompactionType:
    ...
    MAJOR = 2
    FULL = 3
    _VALUES_TO_NAMES = {0: 'MINOR', 
       1: 'MERGE', 
       2: 'MAJOR', 
       3: 'FULL'}
    _NAMES_TO_VALUES = {'MINOR': 0, 
       'MERGE': 1, 
       'MAJOR': 2, 
       'FULL': 3}
...
class CompactionReason:
    ...
    IDLE = 3
    CLOSE = 4
    _VALUES_TO_NAMES = {0: 'USER', 
       1: 'SYSTEM', 
       2: 'CHOP', 
       3: 'IDLE', 
       4: 'CLOSE'}
    _NAMES_TO_VALUES = {'USER': 0, 
       'SYSTEM': 1, 
       'CHOP': 2, 
       'IDLE': 3, 
       'CLOSE': 4}
...
class IteratorScope:
    ...
    MAJC = 1
    SCAN = 2
    _VALUES_TO_NAMES = {0: 'MINC', 
       1: 'MAJC', 
       2: 'SCAN'}
    _NAMES_TO_VALUES = {'MINC': 0, 
       'MAJC': 1, 
       'SCAN': 2}
...
class TimeType:
    LOGICAL = 0
    MILLIS = 1
    _VALUES_TO_NAMES = {0: 'LOGICAL', 
       1: 'MILLIS'}
    _NAMES_TO_VALUES = {'LOGICAL': 0, 
       'MILLIS': 1}
...
class Key:
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'colFamily', None, None),
     (
      3, TType.STRING, 'colQualifier', None, None),
     (
      4, TType.STRING, 'colVisibility', None, None),
     (
      5, TType.I64, 'timestamp', None, None))
...
class ColumnUpdate:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'colFamily', None, None),
     (
      2, TType.STRING, 'colQualifier', None, None),
     (
      3, TType.STRING, 'colVisibility', None, None),
     (
      4, TType.I64, 'timestamp', None, None),
     (
      5, TType.STRING, 'value', None, None),
     (
      6, TType.BOOL, 'deleteCell', None, None))
...
class KeyValue:
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'value', None, None))
...
class ScanResult:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'results', (TType.STRUCT, (KeyValue, KeyValue.thrift_spec)), None),
     (
      2, TType.BOOL, 'more', None, None))
...
class Range:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'start', (Key, Key.thrift_spec), None),
     (
      2, TType.BOOL, 'startInclusive', None, None),
     (
      3, TType.STRUCT, 'stop', (Key, Key.thrift_spec), None),
     (
      4, TType.BOOL, 'stopInclusive', None, None))
...
class IteratorSetting:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'priority', None, None),
     (
      2, TType.STRING, 'name', None, None),
     (
      3, TType.STRING, 'iteratorClass', None, None),
     (
...
class ScanOptions:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.SET, 'authorizations', (TType.STRING, None), None),
     (
      2, TType.STRUCT, 'range', (Range, Range.thrift_spec), None),
     (
      3, TType.LIST, 'columns', (TType.STRUCT, (ScanColumn, ScanColumn.thrift_spec)), None),
     (
      4, TType.LIST, 'iterators', (TType.STRUCT, (IteratorSetting, IteratorSetting.thrift_spec)), None),
     (
      5, TType.I32, 'bufferSize', None, None))
...
class KeyValueAndPeek:
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.BOOL, 'hasNext', None, None))
...
class KeyExtent:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'tableId', None, None),
     (
      2, TType.STRING, 'endRow', None, None),
     (
      3, TType.STRING, 'prevEndRow', None, None))
...
class ActiveScan:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'client', None, None),
     (
      2, TType.STRING, 'user', None, None),
     (
      3, TType.STRING, 'table', None, None),
     (
      4, TType.I64, 'age', None, None),
     (
      5, TType.I64, 'idleTime', None, None),
     (
      6, TType.I32, 'type', None, None),
     (
      7, TType.I32, 'state', None, None),
     (
      8, TType.STRUCT, 'extent', (KeyExtent, KeyExtent.thrift_spec), None),
     (
      9, TType.LIST, 'columns', (TType.STRUCT, (Column, Column.thrift_spec)), None),
     (
      10, TType.LIST, 'iterators', (TType.STRUCT, (IteratorSetting, IteratorSetting.thrift_spec)), None),
     (
      11, TType.LIST, 'authorizations', (TType.STRING, None), None))
...
class ActiveCompaction:
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.I64, 'age', None, None),
     (
      3, TType.LIST, 'inputFiles', (TType.STRING, None), None),
     (
      4, TType.STRING, 'outputFile', None, None),
     (
      5, TType.I32, 'type', None, None),
     (
      6, TType.I32, 'reason', None, None),
     (
      7, TType.STRING, 'localityGroup', None, None),
     (
      8, TType.I64, 'entriesRead', None, None),
     (
      9, TType.I64, 'entriesWritten', None, None),
     (
      10, TType.LIST, 'iterators', (TType.STRUCT, (IteratorSetting, IteratorSetting.thrift_spec)), None))
...
class WriterOptions:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'maxMemory', None, None),
     (
      2, TType.I64, 'latencyMs', None, None),
     (
      3, TType.I64, 'timeoutMs', None, None),
     (
      4, TType.I32, 'threads', None, None))
