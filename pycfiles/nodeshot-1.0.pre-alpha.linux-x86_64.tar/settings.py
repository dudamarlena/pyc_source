...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/ui/default/settings.py
# Compiled at: 2015-03-25 12:20:03
...
LEAFLET_OPTIONS = {'fillOpacity': 0.7, 
   'opacity': 1, 
   'dashArray': None, 
   'lineCap': None, 
   'lineJoin': None, 
