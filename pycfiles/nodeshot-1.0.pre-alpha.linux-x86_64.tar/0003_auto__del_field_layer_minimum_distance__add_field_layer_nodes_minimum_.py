...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/core/layers/migrations/0003_auto__del_field_layer_minimum_distance__add_field_layer_nodes_minimum_.py
# Compiled at: 2014-10-02 06:24:22
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('layers_layer', 'minimum_distance')
        db.add_column('layers_layer', 'nodes_minimum_distance', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        db.add_column('layers_layer', 'minimum_distance', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        db.delete_column('layers_layer', 'nodes_minimum_distance')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'layers.layer': {'Meta': {'object_name': 'Layer'}, 'added': (
                                'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 2, 0, 0)'}), 
                        'area': (
