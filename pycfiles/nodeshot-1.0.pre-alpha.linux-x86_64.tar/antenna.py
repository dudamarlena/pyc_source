...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/networking/hardware/models/antenna.py
# Compiled at: 2014-05-08 09:16:33
...
class Antenna(BaseDate):
    ...
    radio = models.ForeignKey(Interface, blank=True, null=True)
