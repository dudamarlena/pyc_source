...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/core/layers/migrations/0005_auto__del_field_layer_center.py
# Compiled at: 2014-10-02 11:04:19
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('layers_layer', 'center')

    def backwards(self, orm):
        db.add_column('layers_layer', 'center', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'layers.layer': {'Meta': {'object_name': 'Layer'}, 'added': (
                        ...
                        'area': (
                               'django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True'}), 
                        'data': (
