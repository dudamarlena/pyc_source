...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/core/layers/migrations/0004_auto__chg_field_layer_area.py
# Compiled at: 2014-10-02 10:28:07
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('layers_layer', 'area', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True))

    def backwards(self, orm):
        db.alter_column('layers_layer', 'area', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'layers.layer': {'Meta': {'object_name': 'Layer'}, 'added': (
                        ...
                        'area': (
                               'django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'}), 
                        'center': (
