...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/networking/net/models/interfaces/wireless.py
...
class Wireless(Interface):
    """ Wireless Interface """
    mode = models.CharField(_('wireless mode'), max_length=5, choices=WIRELESS_MODE, blank=True, null=True, default=None)
    standard = models.CharField(_('wireless standard'), max_length=7, choices=WIRELESS_STANDARDS, blank=True, null=True, default=None)
    channel = models.CharField(_('channel'), max_length=4, choices=WIRELESS_CHANNEL, blank=True, null=True, default=None)
