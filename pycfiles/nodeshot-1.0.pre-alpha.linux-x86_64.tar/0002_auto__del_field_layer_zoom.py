...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/core/layers/migrations/0002_auto__del_field_layer_zoom.py
# Compiled at: 2014-10-02 05:28:34
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('layers_layer', 'zoom')

    def backwards(self, orm):
        db.add_column('layers_layer', 'zoom', self.gf('django.db.models.fields.SmallIntegerField')(default=12), keep_default=False)
