...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/core/nodes/migrations/0002_auto__del_statusicon__del_unique_statusicon_status_layer__add_field_st.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('nodes_status', 'stroke_width', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)
        db.add_column('nodes_status', 'fill_color', self.gf('nodeshot.core.base.fields.RGBColorField')(default='', max_length=7, blank=True), keep_default=False)
        db.add_column('nodes_status', 'stroke_color', self.gf('nodeshot.core.base.fields.RGBColorField')(default='#000000', max_length=7, blank=True), keep_default=False)
        db.add_column('nodes_status', 'text_color', self.gf('nodeshot.core.base.fields.RGBColorField')(default='#FFFFFF', max_length=7, blank=True), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'layers.layer': {'Meta': {'object_name': 'Layer'}, 'added': (
                                'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 24, 0, 0)'}), 
                        'area': (
                               'django.contrib.gis.db.models.fields.PolygonField', [], {'null': 'True', 'blank': 'True'}), 
                        'center': (
                        ...
                        'zoom': (
                               'django.db.models.fields.SmallIntegerField', [], {'default': '12'})}, 
       'nodes.image': {'Meta': {'ordering': "['order']", 'object_name': 'Image'}, 'access_level': (
