...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/interop/sync/synchronizers/georss.py
# Compiled at: 2014-10-09 09:24:55
...
class GeoRss(XMLParserMixin, GenericGisSynchronizer):
    ...
    SCHEMA = [
     {'name': 'url', 
        'class': 'CharField', 
        'kwargs': {'help_text': _('URL containing geographical data'), 
                   'max_length': 128}},
     {'name': 'verify_ssl', 
        'class': 'BooleanField', 
        'kwargs': {'default': True, 
    ...
    def key_mapping(self):
        ...
        self.keys = {'name': key_map.get('name', 'title'), 
    ...
    def parse_item(self, item):
        ...
        result = {'name': self.get_text(item, self.keys['name']), 'status': None, 
           'address': '', 
           'is_published': True, 
           'user': None, 
