...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/networking/net/models/interface.py
# Compiled at: 2014-05-08 07:17:02
...
class Interface(BaseAccessLevel):
    ...
    mtu = models.IntegerField(_('MTU'), blank=True, null=True, default=1500, help_text=_('Maximum Trasmission Unit'))
    ...
    def ip_addresses(self):
        ...
        if addresses:
            return addresses.replace(' ', '').split(',')
        return []
