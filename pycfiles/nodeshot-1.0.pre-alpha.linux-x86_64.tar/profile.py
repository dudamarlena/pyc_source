...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/community/profiles/models/profile.py
...
class Profile(AbstractBaseUser, PermissionsMixin):
    ...
    """
    username = models.CharField(_('username'), max_length=254, unique=True, db_index=True, help_text=_('Required. 30 characters or fewer.                    Letters, numbers and @/./+/-/_ characters'), validators=[
    ...
    def save(self, *args, **kwargs):
        ...
        if EMAIL_CONFIRMATION and sync_emailaddress and self.email and self.email_set.filter(email=self.email).count() < 1:
