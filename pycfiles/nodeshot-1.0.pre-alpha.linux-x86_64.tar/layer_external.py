...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/interop/sync/models/layer_external.py
...
class LayerExternal(models.Model):
    ...
    config = DictionaryField(_('configuration'), help_text=_('Synchronizer specific configuration (eg: API URL, auth info, ecc)'), blank=True, null=True, editable=False, schema=None)
    _synchronizer = None
