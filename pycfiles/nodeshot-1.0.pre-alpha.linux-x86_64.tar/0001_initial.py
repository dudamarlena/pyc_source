...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nodeshot/networking/links/migrations/0001_initial.py
    ...
    def forwards(self, orm):
        if 'links_link' not in connection.introspection.table_names():
            db.create_table('links_link', (
             ...
             (
              'data', self.gf('django_hstore.fields.DictionaryField')(null=True, blank=True)),
             (
              'shortcuts', self.gf('django_hstore.fields.ReferencesField')(null=True, blank=True))))
