...
# Embedded file name: build/bdist.linux-x86_64/egg/PyreeEngine/basicObjects.py
# Compiled at: 2018-12-10 15:54:22
...
class ModelObject(GeometryObject):
    ...
    def __init__(self, pathToObj=None):
        super(ModelObject, self).__init__()
        self.vbo = None
        self.vao = None
        self.tricount = None
        self.textures = []
        self.shader = DebugShader()
