...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.8.2-i386/egg/worldcookery/mail/tests.py
...
def test_suite():
    return unittest.TestSuite((DocFileSuite('emailsubscriptions.txt', setUp=setUp, tearDown=zope.component.testing.tearDown, optionflags=ELLIPSIS),))
