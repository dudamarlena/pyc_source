...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.8.2-i386/egg/worldcookery/pdf/common.py
...
def getStyleSheet():
    fonts = {'LuxiSans': 'luxisr.ttf', 'LuxiSansOblique': 'luxisri.ttf', 'LuxiSansBold': 'luxisb.ttf', 'LuxiSansBoldOblique': 'luxisbi.ttf'}
