...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.8.2-i386/egg/worldcookery/search.py
...
class RecipeSearchableText(object):
    ...
    def getSearchableText(self):
        return self.context.name + ': ' + self.context.description
...
def setupCatalogAndIndices(event):
    ...
    fulltext = TextIndex(interface=ISearchableText, field_name='getSearchableText', field_callable=True)
