...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/soktest/tests/testcase.py
# Compiled at: 2013-12-17 01:02:52
...
class TestCaseTypeTests(unittest.TestCase):
    ...
    def test_assign_groups_new(self, TestCaseMock):
        ...
        self.assertEqual({'one': [
                 Test1], 
         'two': [
                 Test1]}, TestCaseMock._alltests_groups)
    ...
    def test_assign_groups_existing(self, TestCaseMock):
        ...
        TestCaseMock._alltests_groups = {'one': [
                 1]}
        TestCaseType.assign_groups(Test2)
        self.assertEqual({'one': [
                 1, Test2], 
         'two': [
                 Test2]}, TestCaseMock._alltests_groups)
    ...
    def test_validate_name_name_already_exists(self, TestCaseMock):
        TestCaseMock._alltests_dict = {'module.cls': None}
        self.assertRaises(NameAlreadyExists, TestCaseType.validate_name, 'module.cls')
    ...
    def test_create_without_base(self, TestCaseMock):
        ...
        self.assertEqual({'name4': test, 
         'module4.name4': test}, TestCaseMock._alltests_dict)
        self.assertEqual({'unittest': [test]}, TestCaseMock._alltests_groups)
    ...
    def test_create_with_base_false(self, TestCaseMock):
        ...
        test = MagicMock()
        test.groups = ['unittest']
        TestCaseType.init_task(test, 'name5', {'__module__': 'module5',  'base': False})
        self.assertEqual([test], TestCaseMock._alltests)
        self.assertEqual({'name5': test, 
         'module5.name5': test}, TestCaseMock._alltests_dict)
        self.assertEqual({'unittest': [test]}, TestCaseMock._alltests_groups)
    ...
    def test_create_with_base_true(self, TestCaseMock):
        ...
        test = MagicMock()
        test.groups = ['unittest']
        TestCaseType.init_task(test, 'name6', {'__module__': 'module6',  'base': True})
...
class TestCaseTest(unittest.TestCase):
    ...
    def test_class_vars(self):
        ...
        self.assertEqual({'soktest.tests.testcase.TestCaseExample': TestCaseExample, 
         'TestCaseExample': TestCaseExample}, TestCase._alltests_dict)
        self.assertEqual({'unit': [
                  TestCaseExample]}, TestCase._alltests_groups)
    ...
    def test_add_mock(self):
        ...
        with patch('soktest.base.patch') as (patch_mock):
            ...
            patch_mock.assert_called_once_with('somewhere.i.belong', 'arg1', kw='2')
    ...
    def test_add_mock_object(self):
        ...
        with patch.object(patch, 'object') as (patch_mock):
            ...
            patch_mock.assert_called_once_with(obj, 'something', kw='2')
            patcher = patch_mock.return_value
            self.assertEqual(patcher, case.patchers['something'])
            self.assertEqual(patcher.start.return_value, case.mocks['something'])
