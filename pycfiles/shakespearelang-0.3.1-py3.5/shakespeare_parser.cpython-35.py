...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/shakespearelang/shakespeare_parser.py
# Compiled at: 2019-02-05 20:16:34
# Size of source mod 2**32: 60642 bytes
...
class shakespeareBuffer(Buffer):
    ...
    def __init__(self, text, whitespace=None, nameguard=None, comments_re=None, eol_comments_re=None, ignorecase=True, namechars='', **kwargs):
        super(shakespeareBuffer, self).__init__(text, whitespace=whitespace, nameguard=nameguard, comments_re=comments_re, eol_comments_re=eol_comments_re, ignorecase=ignorecase, namechars=namechars, **kwargs)


class shakespeareParser(Parser):

    def __init__(self, whitespace=None, nameguard=None, comments_re=None, eol_comments_re=None, ignorecase=True, left_recursion=False, parseinfo=True, keywords=None, namechars='', buffer_class=shakespeareBuffer, **kwargs):
        if keywords is None:
            keywords = KEYWORDS
        super(shakespeareParser, self).__init__(whitespace=whitespace, nameguard=nameguard, comments_re=comments_re, eol_comments_re=eol_comments_re, ignorecase=ignorecase, left_recursion=left_recursion, parseinfo=parseinfo, keywords=keywords, namechars=namechars, buffer_class=buffer_class, **kwargs)
    ...
    def _roman_numeral_(self):
        self._pattern('M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})')
