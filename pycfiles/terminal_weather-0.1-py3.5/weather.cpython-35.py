...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/src/weather.py
# Compiled at: 2018-03-05 13:29:29
...
if __name__ == '__main__':
    ...
    if d != 'City not found':
        ...
        putdata1 = Row('current: ' + str(d['temp']) + '°C', 'speed: ' + str(d['wind speed']) + ' m/s', str(d['clouds']) + '%', str(d['humidity']) + '%', str(d['pressure']) + ' hPa')
