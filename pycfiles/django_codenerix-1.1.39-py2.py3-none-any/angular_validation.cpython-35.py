...
# [GCC 8.4.0]
# Embedded file name: /home/www.django/makarthy/codenerix/djng/angular_validation.py
...
class NgFormValidationMixin(NgFormBaseMixin):
    ...
    def get_field_errors(self, bound_field):
        ...
        errors.extend([SafeTuple((identifier, self.field_error_css_classes, '$dirty', pe[0], 'invalid', force_text(pe[1]))) for pe in potential_errors])
