...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_interrupts.py
...
def test_interrupts():
    ...
    for one_int in all_ints:
        assert one_int['irq'] == 'NMI:' and one_int['counts'] == ['210', '92', '179', '96', '177', '0', '0', '0']
