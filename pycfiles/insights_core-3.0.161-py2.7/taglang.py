...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/core/taglang.py
...
"""
import re, string
from insights.parsr import Char, EOF, Forward, InSet, Many, Opt, String, QuotedString, WS
