...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_nfs_exports.py
...
def test_module_documentation():
    failed, total = testmod(parsermodule, globs={'exports': NFSExports(context_wrap(EXPORTS))})
    assert failed == 0
...
def _do(nfs_exports):
    assert nfs_exports.data == {'/home/utcs/shared/ro': {'@group': [
                                         'ro', 'sync'], 
                                'ins1.example.com': [
                                                   'rw', 'sync', 'no_root_squash'], 
                                'ins2.example.com': [
                                                   'rw', 'sync', 'no_root_squash']}, 
       '/home/insights/shared/rw': {'@group': [
                                             'rw', 'sync'], 
                                    'ins1.example.com': [
                                                       'rw', 'sync', 'no_root_squash'], 
                                    'ins2.example.com': [
                                                       'ro', 'sync', 'no_root_squash']}, 
       '/home/insights/shared/special/all/mail': {'@group': [
                                                           'rw', 'sync', 'no_root_squash']}, 
       '/home/insights/ins/special/all/config': {'@group': [
                                                          'ro', 'sync', 'no_root_squash'], 
                                                 'ins1.example.com': [
                                                                    'rw', 'sync', 'no_root_squash']}, 
       '/home/example': {'@group': [
                         ...
                         'ins2.example.com': [
                                            'rw', 'sync', 'no_root_squash']}}
    assert nfs_exports.ignored_exports == {'/home/example': {'ins2.example.com': ['rw', 'sync', 'no_root_squash']}}
    assert nfs_exports.raw_lines == {'/home/utcs/shared/ro': [
                              '/home/utcs/shared/ro                    @group(ro,sync)   ins1.example.com(rw,sync,no_root_squash) ins2.example.com(rw,sync,no_root_squash)'], 
...
def test_reconstitute():
    recon = NFSExports.reconstitute('/home/utcs/shared/ro', {'@group': [
                'ro', 'sync'], 
       'ins1.example.com': [
                          'rw', 'sync', 'no_root_squash'], 
       'ins2.example.com': [
