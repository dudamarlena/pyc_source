...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/combiners/services.py
...
class Services(object):
    ...
    * ``service_line(service_name)`` returns the actual line that contained
    ...
    def is_on(self, service_name):
        ...
        """
        return self.services.get(service_name + '.service', self.services.get(service_name, False))
    ...
    def service_line(self, service_name):
        ...
        """
        return self.parsed_lines.get(service_name + '.service', self.parsed_lines.get(service_name, ''))
