...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/nscd_conf.py
...
class NscdConf(Parser):
    ...
    def filter(self, attribute, service=None):
        ...
        """
        return [ conf for conf in self.data if attribute in conf.attribute and (not service or service and service in conf.service)
               ]
