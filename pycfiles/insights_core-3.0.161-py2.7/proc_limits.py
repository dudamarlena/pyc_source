...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/proc_limits.py
...
class ProcLimits(Parser):
    ...
    def parse_content(self, content):
        ...
        for row in self.data:
            ...
            setattr(self, row['Limit'], Limits({'hard_limit': row['Hard_Limit'], 'soft_limit': row['Soft_Limit'], 
               'units': row['Units']}))
