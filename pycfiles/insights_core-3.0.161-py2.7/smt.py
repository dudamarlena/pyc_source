...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/smt.py
...
class CpuCoreOnline(Parser):
    ...
    Examples:
        ...
        True
    """
    cpu_core_path = '/sys/devices/system/cpu/cpu(\\d+)/online'
...
class CpuSiblings(Parser):
    ...
    Examples:
        ...
        [0, 2]
    """
    cpu_siblings_path = '/sys/devices/system/cpu/cpu(\\d+)/topology/thread_siblings_list'
