...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/findmnt.py
...
from insights.parsers import keyword_search, parse_fixed_table, SkipException
...
class FindmntPropagation(CommandParser):
    ...
    def parse_content(self, content):
        ...
        self.cols = parse_fixed_table(content, header_substitute=[
         ('TARGET', 'target'),
         ('SOURCE', 'source'),
         ('FSTYPE', 'fstype'),
         ('OPTIONS', 'options'),
