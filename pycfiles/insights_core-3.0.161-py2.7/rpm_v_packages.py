...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/rpm_v_packages.py
    ...
    def parse_content(self, content):
        ...
        for line in content:
            ...
            if 'package' in line_parts[0] or 'missing' in line_parts[0]:
                ...
                entry = {'line': line.strip(), 'attributes': line_parts[0], 'mark': line_parts[1], 'file': line_parts[2]}
            else:
                entry = {'line': line.strip(), 'attributes': line_parts[0], 'mark': None, 'file': line_parts[1]}
