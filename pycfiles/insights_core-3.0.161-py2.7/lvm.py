...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/lvm.py
...
class Pvs(Lvm):
    ...
    """
    KEYS = {'LVM2_PV_MDA_USED_COUNT': '#PMdaUse', 
...
class PvsHeadings(LvmHeadings):
    ...
    def parse_content(self, content):
        self.data = parse_fixed_table(content, heading_ignore=[
         'PV '], header_substitute=[
         ('PV UUID', 'PV_UUID'),
         ('1st PE', '1st_PE')], trailing_ignore=[
         'Reloading', 'Wiping'])
...
class Vgs(Lvm):
    ...
    """
    KEYS = {'LVM2_VG_EXTENDABLE': 'Extendable', 
...
class VgsHeadings(LvmHeadings):
    ...
    def parse_content(self, content):
        self.data = parse_fixed_table(content, heading_ignore=[
         'VG '], header_substitute=[
         ('VG Tags', 'VG_Tags'),
         ('VG UUID', 'VG_UUID')], trailing_ignore=[
         'Reloading', 'Wiping'])
...
class Lvs(Lvm):
    ...
    """
    KEYS = {'LVM2_POOL_LV_UUID': 'Pool_UUID', 
