...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/pcs_quorum_status.py
...
class PcsQuorumStatus(CommandParser):
    ...
    def parse_content(self, content):
        ...
        if len(content) < 21 or not ('Quorum information' in content[0] and 'Votequorum information' in content[9] and 'Membership information' in content[17]):
