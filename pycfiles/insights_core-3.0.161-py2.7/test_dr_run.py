...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/tests/test_dr_run.py
...
NEVER_FIRES_RESULT = {'rule_fqdn': 'insights.plugins.never_fires.report', 
...
def test_run_command(tmpdir):
    ...
    testargs = [
     'insights-run', '-p', 'insights.plugins']
