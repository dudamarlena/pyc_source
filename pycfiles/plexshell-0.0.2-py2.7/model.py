...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/plexshell/model.py
# Compiled at: 2011-09-18 11:47:33
...
class Directory(Node):
    ...
    def name(self):
        ...
        if self.node is not None:
            key = self.node.get('key').encode('utf8')
            name = (self.node.get('name', None) or self.node.get('title')).encode('utf8')
        return name
