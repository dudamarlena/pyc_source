...
# [GCC 8.4.0]
# Embedded file name: /Users/dan/working/eventum/eventum/models/EventSeries.py
...
from mongoengine import Document, DateTimeField, ReferenceField, IntField, ListField, StringField, BooleanField, ValidationError
...
class EventSeries(Document, BaseEventumDocument):
    ...
    def clean(self):
        ...
        if self.ends_after == self.ends_on:
            raise ValidationError('ends_on and ends_after should not share a value.')