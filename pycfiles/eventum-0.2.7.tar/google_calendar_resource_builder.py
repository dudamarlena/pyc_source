...
# [GCC 8.4.0]
# Embedded file name: /Users/dan/working/eventum/eventum/lib/google_calendar_resource_builder.py
...
class GoogleCalendarResourceBuilder:
    ...
    def event_resource(cls, event, for_update=False):
        ...
        resource['description'] = clean_markdown(event.long_description_markdown)
