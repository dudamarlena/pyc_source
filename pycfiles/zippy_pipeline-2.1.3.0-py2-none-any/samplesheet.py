...
# [GCC 8.4.0]
# Embedded file name: /home/quejebo/zippy/zippy/zippy/samplesheet.py
...
class SampleSheet(object):
    ...
    def set(self, section, attribute, new_value):
        ...
        if attribute not in self._ss[section]:
...
class Data(object):
    ...
    def __init__(self, data_header, data_i, sample_sheet, sample_sheet_i):
