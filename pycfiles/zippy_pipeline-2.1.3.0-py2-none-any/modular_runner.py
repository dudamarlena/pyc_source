...
# [GCC 8.4.0]
# Embedded file name: zippy/modular_runner.py
# Compiled at: 2018-04-11 20:07:59
import resource, glob, string, os, sys, fnmatch
...
class ModularRunner:
    ...
    def collect_dependencies(self, sample):
        ...
        for previous_stage in self.previous_stages:
            ...
            elif isinstance(new_dependencies, unicode):
...
class Bcl2FastQRunner(ModularRunner):
    ...
    def get_output--- This code section failed: ---

 L. 240         0  BUILD_MAP_0           0  None
                3  STORE_FAST            2  'sample_first_instance'

 L. 241         6  BUILD_LIST_0          0 
                9  STORE_FAST            3  'samples_to_return'

 L. 242        12  SETUP_LOOP          250  'to 265'
               15  LOAD_FAST             0  'self'
               18  LOAD_ATTR             0  'sample_sheet'
               21  LOAD_ATTR             1  'get'
               24  LOAD_CONST               'Data'
               27  CALL_FUNCTION_1       1  None
               30  GET_ITER         
               31  FOR_ITER            230  'to 264'
               34  STORE_FAST            4  'line'

 L. 243        37  LOAD_FAST             4  'line'
               40  LOAD_ATTR             1  'get'
               43  LOAD_CONST               'Sample_ID'
               46  CALL_FUNCTION_1       1  None
               49  LOAD_CONST               ''
               52  COMPARE_OP            2  ==
               55  POP_JUMP_IF_FALSE    85  'to 85'
               58  LOAD_FAST             4  'line'
               61  LOAD_ATTR             1  'get'
               64  LOAD_CONST               'Sample_Name'
               67  CALL_FUNCTION_1       1  None
               70  LOAD_CONST               ''
               73  COMPARE_OP            2  ==
             76_0  COME_FROM            55  '55'
               76  POP_JUMP_IF_FALSE    85  'to 85'

 L. 244        79  CONTINUE             31  'to 31'
               82  JUMP_FORWARD          0  'to 85'
             85_0  COME_FROM            82  '82'

 L. 245        85  LOAD_FAST             1  'sample'
               88  LOAD_ATTR             2  'id'
               91  LOAD_FAST             4  'line'
               94  LOAD_ATTR             1  'get'
               97  LOAD_CONST               'Sample_ID'
              100  CALL_FUNCTION_1       1  None
              103  COMPARE_OP            2  ==
              106  POP_JUMP_IF_FALSE    31  'to 31'

 L. 246       109  LOAD_FAST             1  'sample'
              112  LOAD_FAST             2  'sample_first_instance'
              115  COMPARE_OP            7  not-in
            118_0  COME_FROM           106  '106'
              118  POP_JUMP_IF_FALSE    31  'to 31'

 L. 247       121  LOAD_FAST             4  'line'
              124  LOAD_ATTR             3  'data_i'
              127  LOAD_FAST             2  'sample_first_instance'
              130  LOAD_FAST             1  'sample'
              133  STORE_SUBSCR     
              134  JUMP_FORWARD          3  'to 140'

 L. 249       137  CONTINUE             31  'to 31'
            140_0  COME_FROM           134  '134'

 L. 256       140  LOAD_FAST             3  'samples_to_return'
              143  LOAD_ATTR             4  'append'
              146  LOAD_CONST               '{path}/{sample_name}_S{sample_index}_R1_001.fastq.gz'
              149  LOAD_ATTR             5  'format'
              152  LOAD_CONST               'path'

 L. 257       155  LOAD_FAST             0  'self'
              158  LOAD_ATTR             6  'params'
              161  LOAD_ATTR             7  'self'
              164  LOAD_ATTR             8  'output_dir'
              167  LOAD_CONST               'sample_name'
              170  LOAD_FAST             4  'line'
              173  LOAD_ATTR             1  'get'
              176  LOAD_CONST               'Sample_Name'
              179  CALL_FUNCTION_1       1  None
              182  LOAD_CONST               'sample_index'
              185  LOAD_FAST             2  'sample_first_instance'
              188  LOAD_FAST             1  'sample'
              191  BINARY_SUBSCR    
              192  CALL_FUNCTION_768   768  None
              195  CALL_FUNCTION_1       1  None
              198  POP_TOP          

 L. 258       199  LOAD_FAST             3  'samples_to_return'
              202  LOAD_ATTR             4  'append'
              205  LOAD_CONST               '{path}/{sample_name}_S{sample_index}_R2_001.fastq.gz'
              208  LOAD_ATTR             5  'format'
              211  LOAD_CONST               'path'

 L. 259       214  LOAD_FAST             0  'self'
              217  LOAD_ATTR             6  'params'
              220  LOAD_ATTR             7  'self'
              223  LOAD_ATTR             8  'output_dir'
              226  LOAD_CONST               'sample_name'
              229  LOAD_FAST             4  'line'
              232  LOAD_ATTR             1  'get'
              235  LOAD_CONST               'Sample_Name'
              238  CALL_FUNCTION_1       1  None
              241  LOAD_CONST               'sample_index'
              244  LOAD_FAST             2  'sample_first_instance'
              247  LOAD_FAST             1  'sample'
              250  BINARY_SUBSCR    
              251  CALL_FUNCTION_768   768  None
              254  CALL_FUNCTION_1       1  None
              257  POP_TOP          
              258  JUMP_BACK            31  'to 31'
              261  JUMP_BACK            31  'to 31'
              264  POP_BLOCK        
            265_0  COME_FROM            12  '12'

 L. 260       265  LOAD_CONST               'z'
              268  PRINT_ITEM       
              269  PRINT_NEWLINE_CONT

 L. 261       270  LOAD_FAST             3  'samples_to_return'
              273  PRINT_ITEM       
              274  PRINT_NEWLINE_CONT

 L. 262       275  LOAD_CONST               'z'
              278  PRINT_ITEM       
              279  PRINT_NEWLINE_CONT

 L. 263       280  BUILD_MAP_1           1  None
              283  LOAD_FAST             3  'samples_to_return'
              286  LOAD_CONST               'fastq'
              289  STORE_MAP        
              290  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `JUMP_BACK' instruction at offset 261
...
class RSEMRunner(ModularRunner):
    ...
    def get_output(self, sample):
        return {'rsem': os.path.join(self.params.self.output_dir, sample.name + '.genes.results'), 'rsem_model': os.path.join(self.params.self.output_dir, sample.name + '.stat', sample.name + '.model'), 
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            if self.sample_sheet.is_paired_end():
                ...
                rsem_command = ('{rsem_path} --paired-end {r1} {r2} {reference} {sample_name} --star -p {cores} --star-path {star_path} --star-gzipped-read-file --temporary-folder {temp_folder}').format(rsem_path=self.params.rsem_path, r1=(',').join(fastq_files[0]), r2=(',').join(fastq_files[1]), reference=self.params.rsem_annotation, sample_name=os.path.join(self.params.self.output_dir, sample_name), star_path=self.params.star_path[:-5], genome_dir=self.params.genome, cores=cores, temp_folder=os.path.join(self.params.scratch_path, sample.id))
            else:
                rsem_command = ('{rsem_path} {r1} {reference} {sample_name} --star -p {cores} --star-path {star_path} --star-gzipped-read-file --temporary-folder {temp_folder}').format(rsem_path=self.params.rsem_path, r1=(',').join(fastq_files), reference=self.params.rsem_annotation, sample_name=os.path.join(self.params.self.output_dir, sample_name), star_path=self.params.star_path[:-5], genome_dir=self.params.genome, cores=cores, temp_folder=os.path.join(self.params.scratch_path, sample.id))
            ...
            self.task[sample].append(workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), rsem_command, dependencies=dependencies, nCores=cores, memMb=self.get_memory_count(102400)))
...
class BWARunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        mem = self.get_memory_count(130048)
        args = self.params.self.optional.args
        for sample in self.collect_samples():
            sample_name = sample.name
            dependencies = self.collect_dependencies(sample)
            ...
            if self.sample_sheet.is_paired_end():
                ...
                bwa_wf = BWAWorkflow(os.path.join(self.params.self.output_dir, sample_name), self.params.bwa_path, self.params.samtools_path, self.params.genome + '/genome.fa', cores, mem, fastq_files, sample=sample.id, args=args)
            else:
...
class CommandLineRunner(ModularRunner):
    ...
    def create_output_string(self, sample):
        sample_dict = {'sample.id': sample.id, 'sample.name': sample.name}
    ...
    def workflow(self, workflowRunner):
        ...
        mem = self.get_memory_count(32768)
        for sample in self.collect_samples():
            dependencies = self.collect_dependencies(sample)
            ...
            self.task[sample].append(workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), custom_command, dependencies=dependencies, nCores=cores, memMb=mem))
...
class SubsampleBAMRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            subsample_command = ('{4} view -s {3}{0} -b {1} > {2}').format(self.params.self.subsample_fraction, bam_file, new_bam_file, random.randint(0, 100000), self.params.samtools_path)
...
class BAMtoFASTQRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            command = ('{samtools} fastq -1 {r1} -2 {r2} {input_bam}').format(samtools=self.params.samtools_path, r1=new_r1, r2=new_r2, input_bam=bam_file)
            fastq_task = workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), command, dependencies=dependencies)
            self.task[sample].append(workflowRunner.addTask(('gzip1_{}_{}').format(self.identifier, sample.id), ('gzip -f {}').format(new_r1), dependencies=fastq_task))
            self.task[sample].append(workflowRunner.addTask(('gzip2_{}_{}').format(self.identifier, sample.id), ('gzip -f {}').format(new_r2), dependencies=fastq_task))
...
class PicardAlignStatsRunner(ModularRunner):
    ...
    def get_output(self, sample):
        return {'align_stats': os.path.join(self.params.self.output_dir, ('{}.stats.txt').format(sample.name)), 'insert_stats': os.path.join(self.params.self.output_dir, ('{}.insert.txt').format(sample.name)), 
    ...
    def workflow(self, workflowRunner):
        ...
        if not os.path.exists(self.params.self.output_dir):
            os.makedirs(self.params.self.output_dir)
        mem = self.get_memory_count(24576)
        for sample in self.collect_samples():
            ...
            bam_file = self.collect_input(sample, 'bam')
            dependencies = self.collect_dependencies(sample)
            picard_command = ('java -Xmx4G -Djava.io.tmpdir={} -jar {} CollectAlignmentSummaryMetrics R={}/genome.fa I={} O={} TMP_DIR={}').format(sample_scratch, self.params.picard, self.params.genome, bam_file, os.path.join(self.params.self.output_dir, ('{}.stats.txt').format(sample_name)), sample_scratch)
            ...
            if hasattr(self.params.self, 'target_intervals') and hasattr(self.params.self, 'bait_intervals'):
                picard_command = ('java -Xmx4G -Djava.io.tmpdir={} -jar {} CollectHsMetrics R={}/genome.fa I={} O={} TMP_DIR={} BAIT_INTERVALS={} TARGET_INTERVALS={}').format(sample_scratch, self.params.picard, self.params.genome, bam_file, os.path.join(self.params.self.output_dir, ('{}.stats.txt').format(sample_name)), sample_scratch, self.params.self.optional.bait_intervals, self.params.self.optional.target_intervals)
...
class MarkDuplicatesRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        if not os.path.exists(self.params.self.output_dir):
            os.makedirs(self.params.self.output_dir)
        mem = self.get_memory_count(51200)
        for sample in self.collect_samples():
            sample_name = sample.name
            bam_file = self.collect_input(sample, 'bam')
            dependencies = self.collect_dependencies(sample)
            ...
            picard_command = ('java -Xmx8G -Djava.io.tmpdir={} -jar {} {} I={} O={} M={} TMP_DIR={}').format(sample_scratch, self.params.picard, function, bam_file, os.path.join(self.params.self.output_dir, ('{}.dedup.bam').format(sample_name)), os.path.join(self.params.self.output_dir, ('{}.dedup.stats.txt').format(sample_name)), sample_scratch)
...
class MACSRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            bam_file = self.collect_input(sample, 'bam')
            dependencies = self.collect_dependencies(sample)
            macs_command = ('{} callpeak --name {} --treatment {} --outdir {}').format(self.params.macs_path, sample_name, bam_file, self.params.self.output_dir)
...
class IndelRealignmentRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        if not os.path.exists(self.params.self.output_dir):
            os.makedirs(self.params.self.output_dir)
        cores = self.get_core_count(6)
        mem = self.get_memory_count(12288)
        for sample in self.collect_samples():
            bam_file = self.collect_input(sample, 'bam')
            base_file_name = os.path.basename(self.collect_input(sample, 'bam'))
            dependencies = self.collect_dependencies(sample)
            realign_command = ('source {mono_source}; {mono} {RI} -bamFiles {bam} -genomeFolders {genome} -outFolder             {outFolder}').format(mono_source=self.params.mono_source, mono=self.params.mono, RI=self.params.indelRealign, bam=bam_file, genome=self.params.genome, outFolder=self.params.self.output_dir)
...
class PiscesRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        command = ('{dotnet} {pisces} -BAMFolder {input_path} -G {genome} -OutFolder {output_path} {args}').format(dotnet=self.params.dotnet, pisces=self.params.pisces_path, input_path=bam_dir, genome=self.params.genome, output_path=self.params.self.output_dir, args=args)
...
class StarRunner(ModularRunner):
    ...
    def get_output(self, sample):
        return {'bam': os.path.join(self.params.self.output_dir, ('{}.raw.bam').format(sample.name)), 'starlog': os.path.join(self.params.self.output_dir, ('{}Log.final.out').format(sample.name))}
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            dependencies = self.collect_dependencies(sample)
            star_wf = SingleStarFlow(self.params.star_path, self.params.star_index, sample.name, fastq, self.params.self.output_dir, max_job_cores=cores, tmp_path=os.path.join(self.params.scratch_path, ('star{}').format(sample.name)), command_args=args)
...
class FastQCRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            self.task[sample].append(workflowRunner.addTask(('fastqc_{}_{}').format(self.identifier, sample.id), command, dependencies=dependencies, memMb=self.get_memory_count(8192)))
...
class RNAQCRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            if starlog_path is None:
                command = ('{python} rna_stats.py {bam_path} {stat_path}/{sample_name}.summary.txt --ribosome_bed {ribosome_bed} --intron_bed {intron_bed} --temp_path {temp} ').format(python=self.params.python, bam_path=bam_path, stat_path=self.params.self.output_dir, sample_name=sample.name, ribosome_bed=self.params.ribosome_bed, intron_bed=self.params.intron_bed, temp=sample_scratch + 'a.out')
            else:
                command = ('{python} rna_stats.py {bam_path} {stat_path}/{sample_name}.summary.txt --ribosome_bed {ribosome_bed} --intron_bed {intron_bed} --starlog_path {starlog_path} --temp_path {temp}').format(python=self.params.python, bam_path=bam_path, stat_path=self.params.self.output_dir, sample_name=sample.name, ribosome_bed=self.params.ribosome_bed, intron_bed=self.params.intron_bed, starlog_path=starlog_path, temp=sample_scratch + 'a.out')
            ...
            self.task[sample].append(workflowRunner.addTask(('stats_combine_{}').format(sample.id), command, memMb=40960, dependencies=dependencies))
            workflowRunner.flowLog(command)
...
class SalmonRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        if not os.path.exists(self.params.self.output_dir):
            os.makedirs(self.params.self.output_dir)
        cores = self.get_core_count(16)
        mem = self.get_memory_count(102400)
        for sample in self.collect_samples():
            sample_name = sample.name
            fastq_files = self.collect_input(sample, 'fastq')
            if self.sample_sheet.is_paired_end():
                r1_files = [ x for x in fastq_files if '_R1_' in x ]
                r2_files = [ x for x in fastq_files if '_R2_' in x ]
                salmon_command = ('{salmon_path} quant -i {salmon_index} -l A -1 {r1} -2 {r2} -o {output_path} --numThreads {cores}').format(salmon_path=self.params.salmon_path, r1=(' ').join(r1_files), r2=(' ').join(r2_files), reference=self.params.salmon_index, output_path=self.params.self.output_dir)
            else:
                salmon_command = ('{salmon_path} quant -i {salmon_index} -l A -1 {r1} -o {output_path} --numThreads {cores}').format(salmon_path=self.params.salmon_path, r1=(' ').join(fastq_files), reference=self.params.salmon_index, output_path=self.params.self.output_dir)
            if hasattr(self.params.self, 'args'):
        ...
        for sample in self.collect_samples():
            ...
            if self.params.self.is_somatic:
                ...
                if hasattr(self.params.self, 'normal_pattern'):
                    ...
                    tumor_matches = [ x for x in bam_file if self.params.self.optional.normal_pattern not in x ]
                elif hasattr(self.params.self, 'tumor_pattern'):
                    normal_matches = [ x for x in bam_file if self.params.self.optional.tumor_pattern not in x ]
            ...
            configure_command = ('{strelka_config} {bam_string}             --referenceFasta={genome}/genome.fa --runDir={scratch_path} --callMemMb={mem} {args}').format(strelka_config=strelka_config, bam_string=bam_string, genome=self.params.genome, scratch_path=scratch_path, mem=mem, args=args)
            sub_task = workflowRunner.addTask(('configure_{}_{}').format(self.identifier, sample.id), configure_command, dependencies=dependencies, isForceLocal=True)
            strelka_command = ('{python} {scratch_path}/runWorkflow.py -m local -j {core_count}').format(python=self.params.python, scratch_path=scratch_path, core_count=cores)
            strelka_task = workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), strelka_command, dependencies=sub_task, nCores=cores)
            if self.params.self.is_somatic:
                module_dir = os.path.abspath(os.path.dirname(__file__))
                merge_path = os.path.join(module_dir, 'vcf_merge.py')
                merge_command = ('{python} {merge_path} {scratch_path}/somatic.snvs.vcf.gz {scratch_path}/somatic.indels.vcf.gz {output_dir}/{sample_name}.somatic.vcf.gz').format(python=self.params.python, scratch_path=os.path.join(scratch_path, 'results', 'variants'), output_dir=self.params.self.output_dir, sample_name=sample.name, merge_path=merge_path)
                move_task = workflowRunner.addTask(('merge_{}_{}').format(self.identifier, sample.id), merge_command, dependencies=strelka_task, nCores=1, memMb=4096)
            else:
                move_command = ('cp {scratch_path}/variants.vcf.gz {output_dir}/{sample_name}.germline.vcf.gz').format(scratch_path=os.path.join(scratch_path, 'results', 'variants'), output_dir=self.params.self.output_dir, sample_name=sample.name)
                move_task = workflowRunner.addTask(('move_{}_{}').format(self.identifier, sample.id), move_command, dependencies=strelka_task, nCores=1, memMb=4096, isForceLocal=True)
            self.task[sample].append(workflowRunner.addTask(('clean_temp_{}_{}').format(self.identifier, sample.id), ('rm -r {}').format(scratch_path), dependencies=move_task, isForceLocal=True))
...
class EdgerRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        command = ('{python} {script_path} --group1 {group1} --group2 {group2} --out_file {out_file} --temp_folder {temp_folder} --r_path {r_path}').format(group1=(' ').join(rsems_by_group[0]), group2=(' ').join(rsems_by_group[1]), out_file=output_file_path, temp_folder=temp_path, r_path=self.params.r_path, python=self.params.python, script_path=script_path)
...
class BloomSubsampleBAMRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            subsample_command = ('{python} {script_path} --bam {bam} --downsampled_pairs {count} --output {output_path} --threads {threads}').format(python=self.params.python, script_path=script_path, bam=bam_file, count=self.params.self.reads, output_path=new_bam_file, threads=cores)
            mem = self.get_memory_count(32768)
            sub_task = workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), subsample_command, dependencies=dependencies, nCores=cores, memMb=mem)
            self.task[sample].append(workflowRunner.addTask(('index_{}_{}').format(self.identifier, sample.id), ('{} index {}').format(self.params.samtools_path, os.path.join(self.params.self.output_dir, sample.name + '.sub.bam')), dependencies=sub_task))
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            if self.make_bams:
                ...
                output_command += (' && {samtools} sort -@ 32 -m 16G {unsorted} > {sorted}').format(samtools=self.params.samtools_path, unsorted=unsorted_file, sorted=sorted_file)
            ...
            command = ('{minimap2} {args} {ref} {fastq_files} {output_command}').format(minimap2=self.params.minimap2_path, args=args, ref=os.path.join(self.params.genome, genome_suffix), fastq_files=(' ').join(fastq_files), output_command=output_command)
...
class NirvanaRunner(ModularRunner):
    ...
    def get_output(self, sample):
        return {'json': os.path.join(self.params.self.output_dir, sample.name + '.json.gz'), 'json_index': os.path.join(self.params.self.output_dir, sample.name + '.json.gz.jsi'), 
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            command = ('{dotnet} {nirvana_path} -i {input_vcf} -c {nirvana_cache} -sd {nirvana_supplement} -r {nirvana_ref} -o {output_path} {args}').format(dotnet=self.params.dotnet, nirvana_path=self.params.nirvana_path, input_vcf=input_vcf, nirvana_cache=self.params.nirvana_cache, nirvana_supplement=self.params.nirvana_supplement, nirvana_ref=self.params.nirvana_ref, output_path=output_path, args=args)
            mem = self.get_memory_count(32768)
            self.task[sample].append(workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), command, dependencies=dependencies, memMb=mem))
...
class PrimerDimerMinerRunner(ModularRunner):
    ...
    def workflow(self, workflowRunner):
        ...
        for sample in self.collect_samples():
            ...
            script_path = os.path.join(zippy_dir, 'downsampling_bloom.py')
            fastq_files = self.collect_input(sample, 'fastq', as_list=True)
            pdm_command = ('{python} {script_path} --probe_list {probe_list} --kmer {kmer}').format(python=self.params.python, script_path=script_path, probe_list=self.params.self.probe_list, kmer=self.params.self.optional.kmer)
            ...
            self.task[sample].append(workflowRunner.addTask(('{}_{}').format(self.identifier, sample.id), pdm_command, dependencies=dependencies))