...
# [GCC 8.4.0]
# Embedded file name: /home/quejebo/zippy/zippy/zippy/params.py
...
import copy, commentjson as json, inspect, sys
...
def add_feedins_to_previous_stage(stage_dict, feedins):
    ...
    elif stage_dict.previous_stage != '':
        stage_dict.previous_stage = [
...
def rejsonify(params):
    ...
    if isinstance(params, ObjectDict):
        ...
        to_return = {k:v for k, v in to_return.iteritems() if k[0] != '_' if k[0] != '_'}
