...
# [GCC 8.4.0]
# Embedded file name: /home/quejebo/zippy/zippy/zippy/bcl2fastq.py
...
class Bcl2Fastq(WorkflowRunner):
    ...
    def __init__(self, bcl2fastq, runfolder_dir, output_dir, sample_sheet, args='', max_job_cores=16):
        optional_argument_defaults = {'processing-threads': 16}
        self.max_job_cores = max_job_cores
        command = ('{} --runfolder-dir {} --output-dir {} --sample-sheet {}').format(bcl2fastq, runfolder_dir, output_dir, sample_sheet)
        if args != '':
            command += (' {}').format(args)
        default_additions = []
