...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mhut/pathutils.py
# Compiled at: 2016-09-22 02:36:43
...
class Env:
    ...
    def pwrite(self):
        ...
        fname = '/tmp/source_' + os.environ['USER']
        try:
            fid = open(fname, 'w')
        except:
...
def process_options(args):
    ...
    if cmd not in subcmds:
        ...
        if os.getenv(args[0]) != None:
            ...
            env_var = 'PATH'
        elif cmd == 'add' and '/' not in args[0] and len(args) > 1:
            env_var = args.pop(0)
        else:
