...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mhut/testutils.py
# Compiled at: 2016-09-22 02:36:30
...
def print_breakdown(slist):
    ...
    print '   Name', '                    ', 'Pass/Total  Fail Error PassRate '
    for s in slist:
        n = s['Name']
        p = s['Pass']
        f = s['Failures']
