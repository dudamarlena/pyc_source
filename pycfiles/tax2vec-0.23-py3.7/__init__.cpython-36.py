...
# [GCC 8.4.0]
# Embedded file name: /home/blazs/tax2vec/tax2vec/__init__.py
# Compiled at: 2019-06-14 14:03:01
# Size of source mod 2**32: 16789 bytes
try:
...
import itertools, operator, scipy.sparse as sps
...
class tax2vec:
    ...
    def document_kernel(self, vec, idx):
        ...
        """
        document = [self.reversed_wmap[x] for x in vec.tolist() if x > 0 if x in self.reversed_wmap.keys()]
        hypernyms = []
        local_graph = []
        initial_hypernyms = []
