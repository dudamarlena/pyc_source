...
# Embedded file name: build/bdist.linux-i686/egg/commerce/old/cbasket.py
# Compiled at: 2009-03-17 14:40:41
...
class ProductBasketItemSalesOrderItemDataFactory(object):
    ...
    def _gotProduct(self, product):
        ...
        return SalesOrderItemDataImpl(code, description, self.item.quantity, self.item.unitPrice, self.item.unitPrice * self.item.quantity, self.item.productRef.product.id)
