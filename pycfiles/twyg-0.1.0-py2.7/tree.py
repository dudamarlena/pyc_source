...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/twyg/tree.py
# Compiled at: 2014-03-15 08:23:06
import sys
...
class Node(object):
    ...
    def getchildren(self, direction=None):
        if direction:
            return [ c for c in self.children if c.direction() == direction
                   ]
        else:
