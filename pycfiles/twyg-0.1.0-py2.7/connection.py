...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/twyg/connection.py
# Compiled at: 2014-03-07 19:12:10
import os
from twyg.common import createpath
from twyg.config import Properties, NumberProperty, EnumProperty, ColorProperty
    ...
    def __init__(self, config={}):
        ...
        properties = {'lineWidth': (
           ...
           'junctionXFactor': (
                             NumberProperty, {}), 
           'cornerStyle': (
                         EnumProperty, {'values': corner_styles}), 
           'cornerRadius': (
                          NumberProperty, {'min': 0.0}), 
           'cornerPad': (
                       NumberProperty, {'min': 0.0}), 
           'junctionStyle': (
                           EnumProperty, {'values': junction_styles}), 
           'junctionRadius': (
                            NumberProperty, {'min': 0.0}), 
           'junctionFillColor': (
                               ColorProperty, {}), 
           ...
           'junctionStrokeColor': (
                                 ColorProperty, {}), 
           'junctionSign': (
                          EnumProperty, {'values': junction_sign}), 
           'junctionSignSize': (
                              NumberProperty, {'min': 0.0}), 
    ...
    def _draw(self, node, direction=None):
        ...
        for i, child in enumerate(children):
            ...
            if child is firstchild:
                ...
                if corner_style == 'square' or abs(y2 - jy) < 0.001:
                    p1 = Vector2(jx, y2)
                    p2 = Vector2(jx, y2 + r1)
                ...
                if corner_style == 'square' or abs(y2 - jy) < 0.001:
                    ...
                    arc = arcpath(jx - dx2, y2 - r2 * 2, r2 * 2, r2 * 2, a1 + da, da)
...
_conndrawer_map = {'curve': CurveConnectionDrawer, 
