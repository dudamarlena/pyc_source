...
# [GCC 8.4.0]
# Embedded file name: /home/carlos/projects/rie/src/wagtail_jsonschema_forms/jsonschema_generator.py
# Compiled at: 2017-10-13 06:18:32
# Size of source mod 2**32: 3477 bytes
from collections import OrderedDict
import json

class JsonSchemaGenerator:
    FIELD_TYPES = {'singleline': 'generate_singleline', 
    ...
    def wagtail_form_to_json_schema(form):
        ...
        for field in form.form_fields.all():
            ...
            if field_type in JsonSchemaGenerator.FIELD_TYPES:
                properties[field.label] = getattr(JsonSchemaGenerator, JsonSchemaGenerator.FIELD_TYPES[field_type])(field)
                if field.required:
