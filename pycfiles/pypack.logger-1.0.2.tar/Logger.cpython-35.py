...
# Compiled at: 2018-01-12 12:33:40
...
class Logger:
    ...
    def trace(message, *args, **kwargs):
        Logger._Logger__log(Logger.TAG_TRACE, message, *args, **kwargs)

    def __log(level, message, *args, **kwargs):
        display = []
        display.append(Logger._Logger__format_date())
        display.append(Logger.BRACES_TAG[0] + Logger._Logger__align_tag(level) + Logger.BRACES_TAG[1])
