...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/githeat/__main__.py
# Compiled at: 2016-07-07 01:19:04
...
def _cmdline(argv=None):
    ...
    parser.add_argument('--gtype', action='store', choices=[
     'inline', 'block'], help='Choose how you want the graph to be displayed')
    ...
    parser.add_argument('--stat-number', dest='stat_number', type=_check_negative, help='Number of top committers to show in stat')
    parser.add_argument('--stat', '-s', dest='stat', action='store_true', help='Show commits stat')
    parser.add_argument('--separate', '-b', dest='separate', action='store_true', help='Separate each day')
