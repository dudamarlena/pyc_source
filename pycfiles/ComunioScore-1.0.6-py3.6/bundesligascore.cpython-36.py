...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ComunioScore/score/bundesligascore.py
# Compiled at: 2020-05-01 18:27:16
# Size of source mod 2**32: 13257 bytes
import logging
...
class BundesligaScore(SofaScore):
    __doc__ = ' class BundesligaScore to retrieve statistics from Bundesliga matches\n\n    USAGE:\n            buli = BundesligaScore()\n            buli.season_data()\n    '
    season_name = None
    season_year = None
    season_id = None
    ...
    def __init__(self, season_date):
        ...
        self._BundesligaScore__check_season_data()
    ...
    def __check_season_data(self):
        ...
        if BundesligaScore.season_name is None:
            self._BundesligaScore__set_current_season()
        else:
    ...
    def __set_current_season(self):
        ...
        if len(date) > 2:
            ...
            for i in range(0, 7):
                ...
                if self._BundesligaScore__get_current_season_data(date=('{}-{}-{}'.format(date_year, date_month, query_date_day))):
    ...
    def vis_lineup_with_rating(self, matchid):
        ...
        for homeplayer, awayplayer in zip(lineup['homeTeam'], lineup['awayTeam']):
            print('{}({}) :  {}({})'.format(homeplayer['player_name'], homeplayer['player_rating'], awayplayer['player_name'], awayplayer['player_rating']))
