...
# Embedded file name: build/bdist.linux-i686/egg/brightcontent/core/app.py
# Compiled at: 2006-08-27 20:37:51
...
class WSGIApplication(object):
    ...
    def day(self, environ, start_response, year, month, day):
        ...
        entries = self.store.get_entries(lower_date=lower_date, upper_date=upper_date)
