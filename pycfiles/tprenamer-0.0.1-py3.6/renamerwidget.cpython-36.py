...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpRenamer/widgets/renamerwidget.py
                ...
                if self._mid_side.isChecked():
                    ...
                    if self._left_side.isChecked():
                        if self._capital_side.isChecked():
                            ...
                            side = 'l'
                    remove_first = self._remove_first_cbx.isChecked() or 0
                else:
                    remove_first = self._remove_first_spn.value()
                remove_last = self._remove_last_cbx.isChecked() or 0
            else:
