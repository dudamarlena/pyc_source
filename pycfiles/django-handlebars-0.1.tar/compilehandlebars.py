...
# [GCC 8.4.0]
# Embedded file name: /home/sergii/eclipse-workspaces/django_handlebars/django_handlebars/management/commands/compilehandlebars.py
# Compiled at: 2012-03-12 18:04:22
...
class Command(BaseCommand):
    option_list = BaseCommand.option_list + (
     make_option('--debug', action='store_true', dest='debug', default=False, help='Set logging level to DEBUG'),
     make_option('--clean', action='store_true', dest='clean', default=False, help='Remove all previously compiled templates'),
     make_option('--watch', action='store_true', dest='watch', default=False, help='Watch changes with appsettings.TPL_DIR and compile'),
     make_option('--raw', action='store_true', dest='raw', default=False, help='Do not format output'),
     make_option('--quiet', action='store_true', dest='quiet', default=False, help='Run with no output'))
