...
# [GCC 8.4.0]
# Embedded file name: /home/sergii/eclipse-workspaces/django_handlebars/django_handlebars/management/compiler.py
# Compiled at: 2012-03-12 17:55:12
import os, re, sys, time, logging, hashlib, spidermonkey
...
class Compiler(object):
    ...
    def __init__(self, src_path=None, dest_path=None, src_mask=None, script_path=None, script_extras=None, num_threads=None, console=None):
    ...
    def build(self, src_path):
        ...
        if src_path not in self.schedule:
            self.schedule[src_path] = [
             0, Lock()]
        self.schedule[src_path][0] = time.time()
        msg = (
         src_path, dest_path, self.schedule[src_path][0])
