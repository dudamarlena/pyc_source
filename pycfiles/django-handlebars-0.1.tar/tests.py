...
# [GCC 8.4.0]
# Embedded file name: /home/sergii/eclipse-workspaces/django_handlebars/django_handlebars/tests.py
# Compiled at: 2012-03-14 12:24:47
import os, time, tempfile, shutil, urllib2
...
class TagsTest(TestCase):
    ...
    @override_settings(HANDLEBARS_TPL_DIR=src_dir, HANDLEBARS_TPL_CMPDIR=cmp_dir, HANDLEBARS_COMPILED=False)
    ...
    @override_settings(HANDLEBARS_TPL_DIR=src_dir, HANDLEBARS_TPL_CMPDIR=cmp_dir, HANDLEBARS_COMPILED=True)
