...
# [GCC 8.4.0]
# Embedded file name: /home/satoshi/dev/karakuri/env/lib/python2.7/site-packages/karakuri/project.py
# Compiled at: 2014-08-05 02:44:04
import os, sys, yaml, tarfile, re
...
class Project:
    ...
    def __init__(self, image_name):
        self.client = docker.Client(base_url=os.getenv('DOCKER_HOST', 'unix://var/run/docker.sock'), version='1.12')
