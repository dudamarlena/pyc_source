...
# Embedded file name: build/bdist.linux-x86_64/egg/advancedcaching/astral.py
# Compiled at: 2011-04-23 08:43:29
import datetime
from math import cos, sin, tan, acos, asin, atan2, floor, radians, degrees
SUN_POSITION_CACHE_DURATION = 3600
...
class Astral(object):
    ...
    def _eccentricity_earth_orbit(self, juliancentury):
        return 0.016708634 - juliancentury * (4.2037e-05 + 1.267e-07 * juliancentury)
    ...
    def _sun_eq_of_center(self, juliancentury):
        ...
        c = sinm * (1.914602 - juliancentury * (0.004817 + 1.4e-05 * juliancentury)) + sin2m * (0.019993 - 0.000101 * juliancentury) + sin3m * 0.000289
        return c
