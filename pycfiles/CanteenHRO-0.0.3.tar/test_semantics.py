...
# Embedded file name: /usr/local/lib/python2.7/site-packages/canteen_tests/test_http/test_semantics.py
...
class URLUtilTests(test.FrameworkTest):
    ...
    def test_url_wrap(self):
        ...
        out = http.url('test', '/sup', wrap=other_wrap)(wrap)
        assert out is sent is wrap
...
class HTTPSemanticsTests(test.FrameworkTest):
    ...
    def test_add_route(self):
        ...
        http.HTTPSemantics.add_route(('/never-ever', 'testing'), lambda : 'hi')
