...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yakonfig/yakonfig.py
...
import collections, contextlib, logging, os
...
def set_global_config(path_dict_or_stream):
    ...
    if isinstance(path_dict_or_stream, string_types):
        ...
        if _config_file_path and _config_file_path != path:
            raise Exception('set_global_config(%r) differs from %r, consider calling clear_global_config first' % (
