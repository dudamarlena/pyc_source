...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/fldi/tests/test_di.py
# Compiled at: 2017-06-27 08:01:53
...
class DITest(unittest.TestCase):
    ...
    def test_name_does_not_exist(self):
        ...
        self.assertTrue('Can not find' in str(context.exception), 'Di does not throw error in case of get unknown service')
