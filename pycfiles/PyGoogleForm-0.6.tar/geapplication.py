...
# Embedded file name: build\bdist.win32\egg\pygoogleearth\geapplication.py
# Compiled at: 2009-09-26 22:18:37
import time
...
class GoogleEarth(object):
    ...
    def __getattr__(self, name):
        ...
        if name == 'auto_pilot_speed':
            return self.ge.StreamingProgressPercentage
        if name == 'view_extents':
    ...
    def get_camera(self, consider_terrain=False):
        ...
        camera_dict = {'lat': camera.FocusPointLatitude, 
    ...
    def set_camera_params(self, lat, lon, alt=300000, alt_mode=AltitudeModes.RELATIVE_TO_GROUND, range=0, tilt=0, azimuth=370, speed=0.5):
        """
