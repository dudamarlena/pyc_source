...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/stxnext/log/logger.py
# Compiled at: 2009-03-26 10:08:26
...
class STXNextLogger(object):
    ...
    def log_request(self, req):
        ...
        result = {'form': {}, 'cookies': {}, 'lazy items': {}, 'other': {}, 'environ': {}}
