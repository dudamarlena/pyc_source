...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mempy\myemail.py
# Compiled at: 2016-06-15 22:10:09
# Size of source mod 2**32: 2286 bytes
"""
[myemail.py] - Mempire E-mail module
...
def runTest():
    from lib import easygui as gui
    userid = 'herokims'
    passwd = gui.passwordbox(msg='gmail계정의 비밀번호를 입력하세요', title='gmail 암호 입력')
    send_mail('herokims@gmail.com', 'herokims@hanmail.net', ['herokims@hanmail.net'], '테스트성공', '안녕하세요. 테스트 성공입니다', None)
    print('메일을 전송했습니다')
