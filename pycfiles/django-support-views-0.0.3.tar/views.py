...
# [GCC 8.4.0]
# Embedded file name: /var/www/paparazziaccessories-com/venv-paparazzi/src/support-views/support_views/views.py
# Compiled at: 2017-11-17 15:45:26
...
class SupportLogView(APIView):
    ...
    def get_support_data(self):
        ...
        data = dict(user=unicode(getattr(self.request, 'user', 'Anonymous')), browser_family=agent.browser.family, browser_version=self._dot_version(agent.browser.version), os_family=agent.os.family, os_version=self._dot_version(agent.os.version), image=image, message=self.request.POST.get('message'))
