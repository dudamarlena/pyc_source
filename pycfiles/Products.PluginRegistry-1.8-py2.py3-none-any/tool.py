...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Products/pluggablecatalog/tool.py
# Compiled at: 2008-07-23 15:36:19
import traceback
from StringIO import StringIO
from zope import component
import AccessControl, Acquisition, Globals
...
class CatalogTool(base.CatalogTool):
    ...
    def searchResults(self, REQUEST=None, **kw):
        r"""Wraps CMFPlone's CatalogTool to add default parameters
