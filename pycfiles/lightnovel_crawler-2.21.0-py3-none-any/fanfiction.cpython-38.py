...
# [GCC 8.4.0]
# Embedded file name: .\src\sources\fanfiction.py
...
class FanFictionCrawler(Crawler):
    ...
    def search_novel(self, query):
        ...
        for div in soup.select('#content_wrapper .z-list')[:25]:
            ...
            chapters = re.findall('Chapters: \\d+', info)[0]
            origin_book = re.findall('^.+Rated:', info)[0][:-9]
    ...
    def read_novel_info(self):
        ...
        if possible_image:
            ...
            self.novel_author = soup.select_one('#profile_top, #content').select_one('a[href*="/u/"]').text.strip()
