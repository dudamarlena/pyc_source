...
# Compiled at: 2020-05-04 19:02:45
# Size of source mod 2**32: 8979 bytes
"""
Crawler application
"""
import logging, re
...
class Crawler:
    ...
    @property
    def cookies(self):
        return {x.value:x.name for x in self.scraper.cookies}
    ...
    def get_response(self, url, **kargs):
        ...
        self.cookies.update({x.value:x.name for x in response.cookies})
