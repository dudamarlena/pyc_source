...
_builder = Args(group=[
 ...
 Args('--shard-id', type=int, nargs='?', default=0, help='Discord bot shard id (default: 0)'),
 Args('--shard-count', type=int, nargs='?', default=10, help='Discord bot shard counts (default: 1)'),
