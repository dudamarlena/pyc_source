...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/html/layouts.py
# Compiled at: 2015-11-27 03:19:29
...
engines = None
__all__ = [
 'get_engine', 'render_form', 'render_column',
...
class FrontendEngine(object):
    ...
    def form_field(self, context, tag):
        field = tag.field
        if field.is_hidden:
            return self.form_visible_field(context, field)
        return self.form_hidden_field(context, field)
