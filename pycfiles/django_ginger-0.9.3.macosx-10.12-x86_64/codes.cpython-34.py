...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/patch/codes.py
# Compiled at: 2015-11-20 21:59:02
# Size of source mod 2**32: 13449 bytes
import itertools, inspect, warnings
...
class Function(Block):
    ...
    def __init__(self, name, args=None, varargs=None, varkw=None, defaults=None, decorators=None):
...
class Exporter(object):
    ...
    def find_export(self, name, obj):
        ...
        if hasattr(module, name):
            ...
            if value is obj:
                return name
        for obj_name, obj_value in itertools.chain(inspect.getmembers(module, self.can_export), ((v, k) for k, v in self._exports.items())):
