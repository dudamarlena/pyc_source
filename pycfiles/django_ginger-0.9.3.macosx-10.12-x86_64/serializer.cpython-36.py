...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/serializer.py
# Compiled at: 2017-09-21 04:43:11
...
def process_page(page):
    ...
    return {'total':page.paginator.count, 
     'size':len(page), 
    ...
    if isinstance(exc, KeyboardInterrupt):
        ...
        if isinstance(exc, Http404):
            ...
            if isinstance(exc, PermissionDenied):
                ...
                if isinstance(exc, GingerHttpError):
...
def encode_collection(instance):
    if isinstance(instance, Page):
        return {'data':instance.object_list, 
         'page':instance}
    else:
        return {'data': instance}