...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/html/forms.py
# Compiled at: 2016-08-18 10:25:50
# Size of source mod 2**32: 6313 bytes
...
from . import common
__all__ = [
 'Choice', 'Link', 'form_csrf_tag', 'form_attrs', 'form_css_class',
...
def make_css_class(obj, suffix=''):
    name = utils.camel_to_hyphen(re.sub('(?i)widget|field|ginger|form|input', '', obj.__class__.__name__, 1))
    if suffix:
...
def render_field(field, layout=None, **kwargs):
    ...
    return common.div(class_=classes, data_field=field.name, **kwargs)[content]
