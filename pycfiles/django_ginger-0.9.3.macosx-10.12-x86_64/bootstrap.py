...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/scripts/bootstrap.py
# Compiled at: 2015-07-31 05:00:17
import os, sys, subprocess, shutil, contextlib, json
...
class Project(object):
    ...
    def check_installed(self, cmd, error=None, action=None, test=None):
        if not (test or which(cmd)) if 1 else can_run(test):
    ...
    def prepare_npm(self):
        values = {'name': self.name, 
           ...
           'description': '', 
           'main': 'index.js', 
           'dependencies': {}, 'devDependencies': {}, 'scripts': {'test': 'echo "Error: no test specified" && exit 1'}, 
           'author': '', 
           'license': 'ISC'}
    ...
    def prepare_bower(self):
        ...
        self.write_file(self.path(assets, 'bower.json'), {'name': self.name, 
           'version': '0.0.0', 
           'moduleType': [
                        'amd'], 
           'private': True, 
