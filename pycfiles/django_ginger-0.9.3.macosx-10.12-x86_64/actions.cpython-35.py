...
# Compiled at: 2017-01-16 14:51:39
# Size of source mod 2**32: 18048 bytes
...
class GingerFormMixin(object):
    ...
    def initial_data(self):
        ...
        for name, field in six.iteritems(fields):
            ...
            if callable(data):
                data = data()
                if isinstance(data, (datetime.datetime, datetime.time)) and not getattr(field.widget, 'supports_microseconds', True):
