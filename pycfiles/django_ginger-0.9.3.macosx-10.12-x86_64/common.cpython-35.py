...
# Compiled at: 2016-11-23 13:04:31
...
empty = Empty('none')
for name in 'html body link meta div span form section article aside main ul li ol dl dd dt p a strong i fieldset legend b em input select button label nav textarea table tbody tfoot thead tr td th figure caption'.split(' '):
    __all__.append(name)
