...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/patch/sources.py
# Compiled at: 2015-02-17 03:39:34
...
class SymbolSource(object):
    ...
    def child_indentation(self, tabwidth=4):
        if self.symbols:
            return self.symbols[0].indentation(tabwidth)
        return self.indentation(tabwidth) + tabwidth
