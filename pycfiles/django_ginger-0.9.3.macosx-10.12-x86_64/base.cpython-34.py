...
# Compiled at: 2016-08-17 02:45:19
...
__all__ = [
 'P', 'GingerView', 'GingerViewSet', 'GingerSubView']
P = pattern.Pattern
...
class GingerSubView(object):
    _GingerSubView__position = 0
    name = None

    def __init__(self, view_class, **kwargs):
        self.view_class = view_class
        self.kwargs = kwargs
        GingerSubView._GingerSubView__position += 1
        self.position = GingerSubView._GingerSubView__position
