...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/ui.py
# Compiled at: 2017-08-25 04:10:57
...
def get_link_builder(obj):
    cls = (isinstance(obj, type) or obj).__class__ if 1 else obj
...
def create_css_class(*classes):
    history = set()
    frags = re.split('\\s+', (' ').join(classes).strip())
    result = []
    for value in frags:
