...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/meta/app.py
# Compiled at: 2015-02-16 04:55:56
...
class Application(object):
    ...
    def __init__(self, app_name):
        ...
        self.template_base_file = self.ensure_file(self.path('templates', app_name, 'base.html'), templates.BASE_TEMPLATE, app_name=app_name)
