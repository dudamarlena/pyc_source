...
# Compiled at: 2016-10-25 07:06:52
# Size of source mod 2**32: 10291 bytes
...
__all__ = [
 'GingerView', 'GingerViewSetMixin', 'view']
P = pattern.Pattern
...
class GingerViewSetMixin(object):
    ...
    def as_urls(cls, **kwargs):
        ...
        for subview in get_child_views(cls):
            ...
            view_class = url(url_regex, cls.as_view(action=subview.name, url_name=url_name, url_regex=url_regex, **kwargs), name=url_name)
