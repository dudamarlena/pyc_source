...
# [GCC 8.4.0]
# Embedded file name: /Users/shodh/Projects/django_ginger/ginger/management/commands/rjs.py
# Compiled at: 2015-05-22 12:29:34
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-m', '--main', default='main.js')
        parser.add_argument('-o', '--optimize', type=str, choices=('none', 'uglify',
                                                                   'uglify2'), default='none')
