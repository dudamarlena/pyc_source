...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bauble/ui.py
# Compiled at: 2016-10-03 09:39:22
import os, traceback, gtk, logging
logger = logging.getLogger(__name__)
import bauble, bauble.db as db
from bauble.i18n import _
import bauble.paths as paths, bauble.pluginmgr as pluginmgr
from bauble.prefs import prefs
import bauble.search as search, bauble.utils as utils, bauble.utils.desktop as desktop
...
class GUI(object):
    ...
    def __init__(self):
        ...
        main_entry.add_accelerator('grab-focus', accel_group, ord('L'), gtk.gdk.CONTROL_MASK, gtk.ACCEL_VISIBLE)
        self.window.add_accel_group(accel_group)
        self.widgets.home_button.connect('clicked', self.on_home_button_clicked)
        self.widgets.prev_view_button.connect('clicked', self.on_prev_view_button_clicked)
    ...
    def show_yesno_box(self, msg):
        ...
        box = utils.add_message_box(self.widgets.msg_box_parent, utils.MESSAGE_BOX_YESNO)
        box.message = msg
        box.show()
    ...
    def on_file_menu_new(self, widget, data=None):
        msg = 'If a database already exists at this connection then creating a new database could destroy your data.\n\n<i>Are you sure this is what you want to do?</i>'
    ...
    def on_help_menu_contents(self, widget, data=None):
        desktop.open('http://ghini.readthedocs.io/en/latest/', dialog_on_error=True)

    def on_help_menu_bug(self, widget, data=None):
        desktop.open('https://github.com/Ghini/ghini.desktop/issues/new', dialog_on_error=True)
    ...
    def on_help_menu_web_wiki(self, widget, data=None):
        desktop.open('http://github.com/Ghini/ghini.desktop/wiki', dialog_on_error=True)

    def on_help_menu_web_forum(self, widget, data=None):
        desktop.open('https://groups.google.com/forum/#!forum/bauble', dialog_on_error=True)
    ...
    def on_help_menu_about(self, widget, data=None):
        ...
        import codecs
        with codecs.open(os.path.join(paths.installation_dir(), 'share', 'LICENSE.ghini')) as (f):
            license = f.read()
