...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bauble/plugins/plants/stored_queries_test.py
# Compiled at: 2016-10-03 09:39:22
from nose import SkipTest
from bauble.plugins.plants.stored_queries import StoredQueriesModel, StoredQueriesPresenter
...
class StoredQueriesTests(BaubleTestCase):
    ...
    def test_loop(self):
        ...
        self.assertEquals([ i for i in m ], ['l=1:t=1:q=1',
         'l=2:t=2:q=2',
         '::',
         '::',
         '::',
    ...
    def test_setgetitem(self):
        ...
        m[1] = 'l:t:q'
        m[4] = 'l:t:q'
        self.assertEquals([ i for i in m ], ['l:t:q',
         '::',
         '::',
         'l:t:q',
         '::',
...
class StoredQueriesPresenterTests(BaubleTestCase):
    ...
    def test_change_page(self):
        ...
        for i in range(1, 11):
            ...
            self.assertTrue(('widget_set_active', (bname, i == m.page)) in presenter.view.invoked_detailed)
            lname = 'stqr_%02d_label' % i
            self.assertTrue(('widget_set_attributes',
             (
              lname, presenter.weight[(i == m.page)])) in presenter.view.invoked_detailed)
    ...
    def test_select_page(self):
        ...
        self.assertTrue(('widget_set_active', (bname, True)) in presenter.view.invoked_detailed)
        self.assertTrue(('widget_set_active', ('stqr_01_button', False)) in presenter.view.invoked_detailed)
    ...
    def test_label_entry_change(self):
        ...
        self.assertTrue(('widget_set_text', ('stqr_04_label', 'abc')) in presenter.view.invoked_detailed)
        presenter.view.values['stqr_label_entry'] = ''
        presenter.on_label_entry_changed('stqr_label_entry')
        self.assertEquals(m.label, '')
        self.assertTrue(('widget_set_text', ('stqr_04_label', '<empty>')) in presenter.view.invoked_detailed)