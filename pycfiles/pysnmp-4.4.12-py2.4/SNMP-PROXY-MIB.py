...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/SNMP-PROXY-MIB.py
...
if mibBuilder.loadTexts:
    snmpProxyMIB.setRevisions(('1998-08-04 00:00', '1997-07-14 00:00'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    snmpProxyMIB.setDescription('This MIB module defines MIB objects which provide mechanisms to remotely configure the parameters used by a proxy forwarding application.')
...
snmpProxyEntry = MibTableRow((1, 3, 6, 1, 6, 3, 14, 1, 2, 1)).setIndexNames((1, 'SNMP-PROXY-MIB',
                                                                             'snmpProxyName'))
if mibBuilder.loadTexts:
...
snmpProxyType = MibTableColumn((1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('read',
                                                                                                                                                                                       1), ('write',
                                                                                                                                                                                            2), ('trap',
                                                                                                                                                                                                 3), ('inform',
...
snmpProxyCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 14, 3, 1, 1)).setObjects(('SNMP-TARGET-MIB',
                                                                                    'snmpTargetBasicGroup'), ('SNMP-TARGET-MIB',
                                                                                                              'snmpTargetResponseGroup'), ('SNMP-PROXY-MIB',
                                                                                                                                           'snmpProxyGroup'))
if mibBuilder.loadTexts:
...
snmpProxyGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 14, 3, 2, 3)).setObjects(('SNMP-PROXY-MIB',
                                                                          'snmpProxyType'), ('SNMP-PROXY-MIB',
                                                                                             'snmpProxyContextEngineID'), ('SNMP-PROXY-MIB',
                                                                                                                           'snmpProxyContextName'), ('SNMP-PROXY-MIB',
                                                                                                                                                     'snmpProxyTargetParamsIn'), ('SNMP-PROXY-MIB',
                                                                                                                                                                                  'snmpProxySingleTargetOut'), ('SNMP-PROXY-MIB',
                                                                                                                                                                                                                'snmpProxyMultipleTargetOut'), ('SNMP-PROXY-MIB',
                                                                                                                                                                                                                                                'snmpProxyStorageType'), ('SNMP-PROXY-MIB',
                                                                                                                                                                                                                                                                          'snmpProxyRowStatus'))
if mibBuilder.loadTexts:
