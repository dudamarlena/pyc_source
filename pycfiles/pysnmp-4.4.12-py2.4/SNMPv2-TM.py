...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/SNMPv2-TM.py
...
if mibBuilder.loadTexts:
    snmpv2tm.setRevisions(('2000-08-09 19:58', '1996-01-01 00:00', '1993-04-01 00:00'))
if mibBuilder.loadTexts:
    snmpv2tm.setLastUpdated('200008091958Z')
if mibBuilder.loadTexts:
    snmpv2tm.setOrganization('IETF SNMPv3 Working Group')
if mibBuilder.loadTexts:
    snmpv2tm.setContactInfo('WG-EMail: snmpv3@tis.com Subscribe: majordomo@tis.com In message body: subscribe snmpv3 Chair: Russ Mundy TIS Labs at Network Associates postal: 3060 Washington Rd Glenwood MD 21738 USA EMail: mundy@tislabs.com phone: +1 301 854-6889 Editor: Randy Presuhn BMC Software, Inc. postal: 2141 North First Street San Jose, CA 95131 USA EMail: randy-presuhn@bmc.com phone: +1 408 546-1006')
if mibBuilder.loadTexts:
...
class SnmpUDPAddress(TextualConvention, OctetString):
    ...
    def prettyIn(self, value):
        if isinstance(value, tuple):
            value = inet_pton(AF_INET, value[0]) + int2oct(value[1] >> 8 & 255) + int2oct(value[1] & 255)
