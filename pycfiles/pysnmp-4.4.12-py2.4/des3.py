...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/proto/secmod/eso/priv/des3.py
...
class Des3(base.AbstractEncryptionService):
    ...
    """
    __module__ = __name__
    serviceID = (1, 3, 6, 1, 6, 3, 10, 1, 2, 3)
    keySize = 32
    ...
    def __getEncryptionKey(self, privKey, snmpEngineBoots):
        ...
        if self._localInt == 4294967295:
            ...
            self._localInt += 1
        return (
         des3Key.asOctets(), univ.OctetString(salt).asOctets(),
