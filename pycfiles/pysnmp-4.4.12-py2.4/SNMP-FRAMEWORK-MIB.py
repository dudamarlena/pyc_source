...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/SNMP-FRAMEWORK-MIB.py
...
if mibBuilder.loadTexts:
    snmpFrameworkMIB.setRevisions(('2002-10-14 00:00', '1999-01-19 00:00', '1997-11-20 00:00'))
if mibBuilder.loadTexts:
...
class SnmpSecurityLevel(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noAuthNoPriv', 1), ('authNoPriv', 2), ('authPriv',
                                                                       3))
...
snmpFrameworkMIBCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 10, 3, 1, 1)).setObjects(('SNMP-FRAMEWORK-MIB',
                                                                                           'snmpEngineGroup'))
if mibBuilder.loadTexts:
...
snmpEngineGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 10, 3, 2, 1)).setObjects(('SNMP-FRAMEWORK-MIB',
                                                                           'snmpEngineID'), ('SNMP-FRAMEWORK-MIB',
                                                                                             'snmpEngineBoots'), ('SNMP-FRAMEWORK-MIB',
