...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/SNMPv2-MIB.py
...
if mibBuilder.loadTexts:
    snmpMIB.setRevisions(('2000-08-09 20:17', '1995-11-09 00:00', '1993-04-01 00:00'))
if mibBuilder.loadTexts:
    snmpMIB.setLastUpdated('200008092017Z')
if mibBuilder.loadTexts:
    snmpMIB.setOrganization('IETF SNMPv3 Working Group')
if mibBuilder.loadTexts:
    snmpMIB.setContactInfo('WG-EMail: snmpv3@tis.com Subscribe: majordomo@tis.com In message body: subscribe snmpv3 Chair: Russ Mundy TIS Labs at Network Associates postal: 3060 Washington Rd Glenwood MD 21738 USA EMail: mundy@tislabs.com phone: +1 301 854-6889 Editor: Randy Presuhn BMC Software, Inc. postal: 2141 North First Street San Jose, CA 95131 USA EMail: randy_presuhn@bmc.com phone: +1 408 546-1006')
if mibBuilder.loadTexts:
...
sysOREntry = MibTableRow((1, 3, 6, 1, 2, 1, 1, 9, 1)).setIndexNames((0, 'SNMPv2-MIB',
                                                                     'sysORIndex'))
if mibBuilder.loadTexts:
...
snmpEnableAuthenTraps = MibScalar((1, 3, 6, 1, 2, 1, 11, 30), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('enabled',
                                                                                                                                                                            1), ('disabled',
...
snmpBasicCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 1, 2, 1, 2)).setObjects(('SNMPv2-MIB',
...
snmpBasicComplianceRev2 = ModuleCompliance((1, 3, 6, 1, 6, 3, 1, 2, 1, 3)).setObjects(('SNMPv2-MIB',
                                                                                       'snmpGroup'), ('SNMPv2-MIB',
                                                                                                      'snmpSetGroup'), ('SNMPv2-MIB',
                                                                                                                        'systemGroup'), ('SNMPv2-MIB',
                                                                                                                                         'snmpBasicNotificationsGroup'), ('SNMPv2-MIB',
...
snmpGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 8)).setObjects(('SNMPv2-MIB', 'snmpInPkts'), ('SNMPv2-MIB',
                                                                                                  'snmpInBadVersions'), ('SNMPv2-MIB',
...
snmpCommunityGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 9)).setObjects(('SNMPv2-MIB',
                                                                             'snmpInBadCommunityNames'), ('SNMPv2-MIB',
...
snmpSetGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 5)).setObjects(('SNMPv2-MIB',
                                                                       'snmpSetSerialNo'))
if mibBuilder.loadTexts:
...
systemGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 6)).setObjects(('SNMPv2-MIB',
                                                                      'sysDescr'), ('SNMPv2-MIB',
...
snmpBasicNotificationsGroup = NotificationGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 7)).setObjects(('SNMPv2-MIB',
...
snmpWarmStartNotificationGroup = NotificationGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 11)).setObjects(('SNMPv2-MIB',
                                                                                                'warmStart'))
if mibBuilder.loadTexts:
...
snmpNotificationGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 12)).setObjects(('SNMPv2-MIB',
...
snmpObsoleteGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 10)).setObjects(('SNMPv2-MIB',
                                                                             'snmpOutPkts'), ('SNMPv2-MIB',
                                                                                              'snmpInTooBigs'), ('SNMPv2-MIB',
                                                                                                                 'snmpInNoSuchNames'), ('SNMPv2-MIB',
                                                                                                                                        'snmpInBadValues'), ('SNMPv2-MIB',
                                                                                                                                                             'snmpInReadOnlys'), ('SNMPv2-MIB',
                                                                                                                                                                                  'snmpInGenErrs'), ('SNMPv2-MIB',
                                                                                                                                                                                                     'snmpInTotalReqVars'), ('SNMPv2-MIB',
                                                                                                                                                                                                                             'snmpInTotalSetVars'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                     'snmpInGetRequests'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                            'snmpInGetNexts'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                'snmpInSetRequests'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                       'snmpInGetResponses'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                               'snmpInTraps'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                                                'snmpOutTooBigs'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                                                                    'snmpOutNoSuchNames'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                            'snmpOutBadValues'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                                                  'snmpOutGenErrs'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                                                                      'snmpOutGetRequests'), ('SNMPv2-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              'snmpOutGetNexts'), ('SNMPv2-MIB',
