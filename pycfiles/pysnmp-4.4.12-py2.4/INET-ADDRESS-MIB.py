...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/INET-ADDRESS-MIB.py
...
if mibBuilder.loadTexts:
    inetAddressMIB.setRevisions(('2005-02-04 00:00', '2002-05-09 00:00', '2000-06-08 00:00'))
if mibBuilder.loadTexts:
...
class InetAddress(TextualConvention, OctetString):
    ...
    typeMap = {InetAddressType.namedValues.getValue('ipv4'): InetAddressIPv4(), InetAddressType.namedValues.getValue('ipv6'): InetAddressIPv6(), InetAddressType.namedValues.getValue('ipv4z'): InetAddressIPv4z(), InetAddressType.namedValues.getValue('ipv6z'): InetAddressIPv6z(), InetAddressType.namedValues.getValue('dns'): InetAddressDNS()}
