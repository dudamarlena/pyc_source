...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/hlapi/twisted/transport.py
...
class UdpTransportTarget(AbstractTransportTarget):
    ...
    def _resolveAddr(self, transportAddr):
        try:
            return socket.getaddrinfo(transportAddr[0], transportAddr[1], socket.AF_INET, socket.SOCK_DGRAM, socket.IPPROTO_UDP)[0][4][:2]
