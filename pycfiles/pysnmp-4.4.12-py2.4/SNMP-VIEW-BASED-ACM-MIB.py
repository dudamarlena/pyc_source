...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/SNMP-VIEW-BASED-ACM-MIB.py
...
vacmContextEntry = MibTableRow((1, 3, 6, 1, 6, 3, 16, 1, 1, 1)).setIndexNames((0, 'SNMP-VIEW-BASED-ACM-MIB',
                                                                               'vacmContextName'))
if mibBuilder.loadTexts:
...
vacmSecurityToGroupEntry = MibTableRow((1, 3, 6, 1, 6, 3, 16, 1, 2, 1)).setIndexNames((0,
...
vacmAccessEntry = MibTableRow((1, 3, 6, 1, 6, 3, 16, 1, 4, 1)).setIndexNames((0, 'SNMP-VIEW-BASED-ACM-MIB',
                                                                              'vacmGroupName'), (0,
                                                                                                 'SNMP-VIEW-BASED-ACM-MIB',
                                                                                                 'vacmAccessContextPrefix'), (0,
                                                                                                                              'SNMP-VIEW-BASED-ACM-MIB',
...
vacmAccessContextMatch = MibTableColumn((1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('exact',
                                                                                                                                                                                          1), ('prefix',
                                                                                                                                                                                               2))).clone('exact')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
...
vacmViewTreeFamilyEntry = MibTableRow((1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1)).setIndexNames((0,
                                                                                         'SNMP-VIEW-BASED-ACM-MIB',
                                                                                         'vacmViewTreeFamilyViewName'), (0,
                                                                                                                         'SNMP-VIEW-BASED-ACM-MIB',
...
vacmViewTreeFamilyType = MibTableColumn((1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('included',
                                                                                                                                                                                             1), ('excluded',
...
vacmMIBCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 16, 2, 1, 1)).setObjects(('SNMP-VIEW-BASED-ACM-MIB',
                                                                                  'vacmBasicGroup'))
if mibBuilder.loadTexts:
...
vacmBasicGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 16, 2, 2, 1)).setObjects(('SNMP-VIEW-BASED-ACM-MIB',
                                                                          'vacmContextName'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                               'vacmGroupName'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                  'vacmSecurityToGroupStorageType'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                      'vacmSecurityToGroupStatus'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                     'vacmAccessContextMatch'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                 'vacmAccessReadViewName'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                             'vacmAccessWriteViewName'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                          'vacmAccessNotifyViewName'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                        'vacmAccessStorageType'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                                                   'vacmAccessStatus'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                                                                         'vacmViewSpinLock'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                                                                                               'vacmViewTreeFamilyMask'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                           'vacmViewTreeFamilyType'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                                                       'vacmViewTreeFamilyStorageType'), ('SNMP-VIEW-BASED-ACM-MIB',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          'vacmViewTreeFamilyStatus'))
if mibBuilder.loadTexts:
