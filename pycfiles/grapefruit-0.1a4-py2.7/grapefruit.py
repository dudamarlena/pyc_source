...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/grapefruit.py
# Compiled at: 2016-08-11 15:54:02
...
class Color():
  ...
  """
    WHITE_REFERENCE = {'std_A': (1.09847, 1.0, 0.35582), 
       'std_B': (0.99093, 1.0, 0.85313), 
       'std_C': (0.98071, 1.0, 1.18225), 
       'std_D50': (0.96421, 1.0, 0.82519), 
       'std_D55': (0.9568, 1.0, 0.92148), 
       'std_D65': (0.95043, 1.0, 1.0889), 
       'std_D75': (0.94972, 1.0, 1.22639), 
       'std_E': (1.0, 1.0, 1.0), 
       'std_F1': (0.92834, 1.0, 1.03665), 
       'std_F2': (0.99145, 1.0, 0.67316), 
       'std_F3': (1.03753, 1.0, 0.49861), 
       'std_F4': (1.09147, 1.0, 0.38813), 
       'std_F5': (0.90872, 1.0, 0.98723), 
       'std_F6': (0.97309, 1.0, 0.60191), 
       'std_F7': (0.95017, 1.0, 1.0863), 
       'std_F8': (0.96413, 1.0, 0.82333), 
       'std_F9': (1.00365, 1.0, 0.67868), 
       'std_F10': (0.96174, 1.0, 0.81712), 
       'std_F11': (1.00899, 1.0, 0.64262), 
       'std_F12': (1.08046, 1.0, 0.39228), 
       'sup_A': (1.11142, 1.0, 0.352), 
       'sup_B': (0.99178, 1.0, 0.84349), 
       'sup_C': (0.97286, 1.0, 1.16145), 
       'sup_D50': (0.96721, 1.0, 0.81428), 
       'sup_D55': (0.95797, 1.0, 0.90925), 
       'sup_D65': (0.9481, 1.0, 1.07305), 
       'sup_D75': (0.94417, 1.0, 1.20643), 
       'sup_E': (1.0, 1.0, 1.0), 
       'sup_F1': (0.94791, 1.0, 1.03191), 
       'sup_F2': (1.03245, 1.0, 0.6899), 
       'sup_F3': (1.08968, 1.0, 0.51965), 
       'sup_F4': (1.14961, 1.0, 0.40963), 
       'sup_F5': (0.93369, 1.0, 0.98636), 
       'sup_F6': (1.02148, 1.0, 0.62074), 
       'sup_F7': (0.9578, 1.0, 1.07618), 
       'sup_F8': (0.97115, 1.0, 0.81135), 
       'sup_F9': (1.02116, 1.0, 0.67826), 
       'sup_F10': (0.99001, 1.0, 0.83134), 
       'sup_F11': (1.0382, 1.0, 0.65555), 
       'sup_F12': (1.11428, 1.0, 0.40353)}
    NAMED_COLOR = {'aliceblue': '#f0f8ff', 
       'antiquewhite': '#faebd7', 
       'aqua': '#00ffff', 
       'aquamarine': '#7fffd4', 
       'azure': '#f0ffff', 
    ...
    def __init__(self, values, mode='rgb', alpha=1.0, wref=_DEFAULT_WREF):
        u"""Instantiate a new grapefruit.Color object.
    ...
    """
        ...
        q = r * 0.21133576 - g * 0.52263517 + b * 0.3112994
        return (y, i, q)
    ...
    """
        r = y + i * 0.9562 + q * 0.621
        g = y - i * 0.2717 - q * 0.6485
        b = y - i * 1.1053 + q * 1.702
        return (r, g, b)
    ...
    """
        r = x * 3.2406255 - y * 1.537208 - z * 0.4986286
        g = -(x * 0.9689307) + y * 1.8757561 + z * 0.0415175
        b = x * 0.0557101 - y * 0.2040211 + z * 1.0569959
        return tuple((v <= _srgbGammaCorrInv and [v * 12.92] or [1.055 * v ** 0.4166666666666667 - 0.055])[0] for v in (r, g, b))

    @staticmethod
    def XyzToLab(x, y, z, wref=_DEFAULT_WREF):
        u"""Convert the color from CIE XYZ to CIE L*a*b*.
    ...
    def LabToXyz(l, a, b, wref=_DEFAULT_WREF):
        u"""Convert the color from CIE L*a*b* to CIE 1931 XYZ.
    ...
    def NewFromRgb(r, g, b, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed RGB values.
    ...
    def NewFromHsl(h, s, l, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed HSL values.
    ...
    def NewFromHsv(h, s, v, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed HSV values.
    ...
    def NewFromYiq(y, i, q, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed YIQ values.
    ...
    def NewFromYuv(y, u, v, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed YUV values.
    ...
    def NewFromXyz(x, y, z, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed CIE-XYZ values.
    ...
    def NewFromLab(l, a, b, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed CIE-LAB values.
    ...
    def NewFromCmy(c, m, y, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed CMY values.
    ...
    def NewFromCmyk(c, m, y, k, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed CMYK values.
    ...
    def NewFromHtml(html, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed HTML color definition.
    ...
    def NewFromPil(pil, alpha=1.0, wref=_DEFAULT_WREF):
        u"""Create a new instance based on the specifed PIL color.
