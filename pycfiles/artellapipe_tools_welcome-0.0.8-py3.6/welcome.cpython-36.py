...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/welcome/welcome.py
# Compiled at: 2019-11-18 21:32:28
# Size of source mod 2**32: 17160 bytes
"""
...
import os, random, logging.config
...
class WelcomeDialog(artellapipe.Tool):
    ...
    def _get_welcome_pixmap(self):
        ...
        if not os.path.isfile(welcome_path):
            ...
            welcome_files = [f for f in os.listdir(welcome_Dir) if f.startswith('welcome') if os.path.isfile(os.path.join(welcome_Dir, f))]
            if welcome_files:
                ...
                welcome_pixmap = resource.ResourceManager().pixmap(welcome_name,
