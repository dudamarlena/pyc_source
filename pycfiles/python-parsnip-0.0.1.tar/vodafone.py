...
# [GCC 8.4.0]
# Embedded file name: /Users/pastylegs/Dropbox/GitHub/python-parsnip/parsnip/operators/vodafone.py
# Compiled at: 2012-05-02 05:37:21
from parsnip import BaseWebtexter, BaseConnection, exceptions
import urllib, urllib2, cookielib, re, time, sys, lxml.html
...
class Vodafone(BaseWebtexter):
    ...
    def login(self):
        response = self.connection.send(self.LOGIN_POST, {'username': self.phone_number, 
           'password': self.pin})
