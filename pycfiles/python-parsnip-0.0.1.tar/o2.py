...
# [GCC 8.4.0]
# Embedded file name: /Users/pastylegs/Dropbox/GitHub/python-parsnip/parsnip/operators/o2.py
...
class O2(BaseWebtexter):
    ...
    def login(self):
        response = self.connection.send(self.LOGIN_POST, data={'IDToken1': self.phone_number, 
           'IDToken2': self.pin, 
           'org': 'o2ext'})
    ...
    def _do_send(self, message_chunk, recipients_chunk):
        ...
        response = self.connection.send('http://messaging.o2online.ie/smscenter_send.osp', data={'SMSTo': (',').join(str(n) for n in recipients_chunk), 
