...
# [GCC 8.4.0]
# Embedded file name: /Users/pastylegs/Dropbox/GitHub/python-parsnip/parsnip/__init__.py
...
class BaseConnection(object):
    ...
    def send(self, url, data=None, headers=None):
        ...
        if not headers:
            headers = {'Referer': 'http://www.google.com', 'Content-type': 'application/x-www-form-urlencoded', 
...
class BaseWebtexter(object):
    ...
    def __unicode__(self):
        return '%s-%s' % (self.is_operator, self.phone_number)
