...
# Embedded file name: build/bdist.linux-x86_64/egg/pyramid_localize/request.py
# Compiled at: 2014-05-04 12:45:31
__doc__ = 'Request related code.'
import warnings
...
class LocalizeRequestMixin(object):
    ...
    def route_url(self, route_name, *elements, **kw):
        ...
        """
        return super(LocalizeRequestMixin, self).route_url(route_name, *elements, **self.default_locale(**kw))
...
def locale(request):
    ...
    :rtype: string
    """
    warnings.warn('request.locale is deprecated as of pyramid_localize 0.1. Please use request.locale_name delivered by Pyramid 1.5.', DeprecationWarning, 2)
...
def _create_locale(locale, request):
    new_locale = Language(name=text_type(locale), native_name=text_type(locale), language_code=text_type(locale))
