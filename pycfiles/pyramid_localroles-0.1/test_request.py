...
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_request.py
# Compiled at: 2014-05-04 12:45:31
__doc__ = 'Test request related code.'
...
def db_locales(db_session):
    ...
    for locale in ['pl', 'cz', 'fr']:
        locale_object = Language(name=text_type(locale), native_name=text_type(locale), language_code=text_type(locale))
