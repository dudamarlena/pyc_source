...
# Embedded file name: build/bdist.linux-x86_64/egg/camsaxs/remesh.py
...
def remesh(image, geometry, alphai, out_range=None, res=None, coord_sys='qp_qz'):
    """
    ...
    wavelen = geometry.get_wavelength() * 1000000000.0
    k0 = 2 * np.pi / wavelen
