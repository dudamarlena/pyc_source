...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/orangecontrib/modelmaps/widgets/OWModelEmbedder.py
...
"""
import sip, OWGUI, orngMisc
from OWWidget import *
from Orange import data, misc, distance, modelmaps
import OWScatterPlot, OWRadviz, OWLinProj, OWPolyviz, OWClassificationTreeGraph, OWNomogram, OWMDS
NAME = 'Model Embedder'
...
INPUTS = [
 (
  'Data', data.Table, 'setData'),
 (
  'Model', modelmaps.Model, 'setModel', Default)]
OUTPUTS = [
 (
  'Selected Data', data.Table),
 (
  'Other Data', data.Table)]
REPLACES = [
 '_modelmaps.widgets.OWModelEmbedder.OWModelEmbedder']
...
class OWModelEmbedder(OWWidget):
    ...
    def __init__(self, parent=None, signalManager=None, name='Model Embedder'):
        ...
        self.inputs = [
         (
          'Data', data.Table, self.setData),
         (
          'Model', modelmaps.Model, self.setModel, Default)]
        self.outputs = [
         (
          'Selected Data', data.Table), ('Other Data', data.Table)]
        self.ow = None
        self.data = None
        self.model = None
        self.loadSettings()
