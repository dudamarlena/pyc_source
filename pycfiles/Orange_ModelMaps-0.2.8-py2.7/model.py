...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/orangecontrib/modelmaps/model.py
# Compiled at: 2014-01-28 13:24:24
"""
.. index:: model
...
class Model(object):
    ...
    def __init__(self, type_, classifier, probabilities, class_values, attributes, instance_predictions=None, instance_classes=None, name=None, XAnchors=None, YAnchors=None):
