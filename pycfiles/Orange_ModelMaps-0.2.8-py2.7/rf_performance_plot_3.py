...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/examples/ensemble/rf_performance_plot_3.py
# Compiled at: 2014-01-26 00:07:45
import matplotlib
matplotlib.use('Agg')
import os.path, cPickle as pickle, matplotlib.pyplot as plt
