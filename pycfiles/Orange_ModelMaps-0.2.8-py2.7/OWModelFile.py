...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/orangecontrib/modelmaps/widgets/OWModelFile.py
...
"""
import os.path, cPickle as pickle, bz2, OWGUI, orngMisc
...
OUTPUTS = [
 (
  'Distances', misc.SymMatrix),
 (
  'Model Meta-data', data.Table),
 (
  'Original Data', data.Table)]
REPLACES = [
 '_modelmaps.widgets.OWModelFile.OWModelFile']
...
class OWModelFile(OWWidget):
    ...
    def browseFile(self):
        if self.files:
            ...
            lastPath = '.'
        fn = unicode(QFileDialog.getOpenFileName(self, 'Open Model Map File', lastPath, 'Model Map (*.bz2)'))
