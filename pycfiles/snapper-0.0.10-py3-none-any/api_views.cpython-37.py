...
# [GCC 8.4.0]
# Embedded file name: /Users/revisor/Documents/Snapper/snapper/api_views.py
...
class SubmitResource(Resource):
    ...
    def post(self) -> Response:
        if 'urls' not in request.json:
            return make_response(jsonify({'message': "'urls' not specified"}), 400)
...
class TaskResource(Resource):
    ...
    def get(self, task_id: str) -> Response:
        ...
        if task is None:
            return make_response(jsonify({'message': 'no such task'}), 404)
