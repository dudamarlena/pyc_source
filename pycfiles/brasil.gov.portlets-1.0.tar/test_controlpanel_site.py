...
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/tests/test_controlpanel_site.py
# Compiled at: 2018-05-21 12:49:38
...
class SiteControlPanelTest(unittest.TestCase):
    ...
    def test_controlpanel_view(self):
        ...
        view = getMultiAdapter((self.portal, self.portal.REQUEST), name='site-controlpanel')
    ...
    def test_controlpanel_view_protected(self):
        ...
        logout()
        self.assertRaises(Unauthorized, self.portal.restrictedTraverse, '@@site-controlpanel')
    ...
    def test_title(self):
        ...
        self.assertEqual(adapter.site_title, 'Portal Brasil')
        self.assertEqual(adapter.site_title, portal.title)
        adapter.site_title = 'Portal Rio Grande'
        self.assertNotEqual(adapter.site_title, 'Portal Rio Grande')

    def test_orgao(self):
        portal = self.portal
        adapter = self.adapter
        adapter.site_orgao = 'Presidencia da Republica'
    ...
    def test_description(self):
        portal = self.portal
        adapter = self.adapter
        adapter.site_description = 'Portal dos Brasileiros'
    ...
    def test_dc_metatags(self):
        ...
        viewlet = common.DublinCoreViewlet(self.portal, self.request, None, None)
        adapter = self.adapter
    ...
    def test_enable_sitemap(self):
        ...
        sitemap = getMultiAdapter((self.portal, self.request), name='sitemap.xml.gz')
        adapter = self.adapter
    ...
    def test_webstats_js(self):
        ...
        viewlet = view.AnalyticsViewlet(self.portal, self.request, None, None)
        viewlet.update()
    ...
    def test_display_pub_date_in_byline(self):
        ...
        viewlet = content.DocumentBylineViewlet(doc, self.request, None, None)
        viewlet.update()
