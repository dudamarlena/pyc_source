...
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/tests/test_views.py
...
class PaginationTestCase(BaseViewTestCase):
    ...
    def _get_pagination(self, total_items=0, current_page=1):
        pagination = Pagination(self.folder, self.request, 'Folder')
...
class GaleriaDeAlbunsTestCase(BaseViewTestCase):
    ...
    def setUp(self):
        ...
        self.view = api.content.get_view('galeria_de_albuns', self.folder, self.request)
    ...
    def test_album_date(self):
        ...
        self.assertEqual(self.view.album_date(self.folder), 'Jan 01, 2014')
        self.folder.setEffectiveDate(DateTime(2013, 1, 31, 15, 38))
        self.assertEqual(self.view.album_date(self.folder), 'Jan 31, 2013')
        self.folder.setEffectiveDate(DateTime(2014, 1, 21, 15, 38))
        self.assertEqual(self.view.album_date(self.folder), 'Jan 21, 2014')
    ...
    def test_album_thumbnail(self):
        ...
        thumb_test = {'src': 'http://nohost/plone/folder/gal_fotos/imagem', 
...
class GaleriaDeFotosTestCase(BaseViewTestCase):
    ...
    def setUp(self):
        ...
        alsoProvides(self.request, IThemeSpecific)
        self.view = api.content.get_view('galeria_de_fotos', self.folder, self.request)
...
class SummaryViewTestCase(BaseViewTestCase):
    ...
    def login_browser(self):
        u"""Autentica usuário de teste no browser"""
