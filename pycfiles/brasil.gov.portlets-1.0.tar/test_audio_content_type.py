...
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/tests/test_audio_content_type.py
...
class AudioTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.audio = api.content.create(type='Audio', container=self.folder, id='my-audio')
    ...
    def setup_content_data(self):
        ...
        self.mp3 = NamedBlobFile(mp3_audio, 'audio/mp3', 'file.mp3')
        self.ogg = NamedBlobFile(ogg_audio, 'audio/ogg', 'file.ogg')
    ...
    def test_return_mp3(self):
        ...
        mp3_file = api.content.create(type='MPEG Audio File', container=audio, id='file.mp3')
    ...
    def test_return_ogg(self):
        ...
        ogg_file = api.content.create(type='OGG Audio File', container=audio, id='file.ogg')
...
class MPEGAudioFileTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.audio = api.content.create(type='Audio', container=self.folder, id='my-audio')
        self.setup_content_data()
        self.mp3_audio = api.content.create(type='MPEG Audio File', container=self.audio, id='file.mp3')
...
class OGGAudioFileTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.audio = api.content.create(type='Audio', container=self.folder, id='my-audio')
        self.setup_content_data()
        self.ogg_audio = api.content.create(type='OGG Audio File', container=self.audio, id='file.ogg')
...
class AudioViewTestCase(unittest.TestCase):
    ...
    def setup_content_data(self):
        ...
        audio['file.mp3'].file = NamedBlobFile(mp3_audio, 'audio/mp3', 'file.mp3')
        ogg_audio = open(os.path.join(path, 'files', 'file.ogg')).read()
        audio.invokeFactory('OGG Audio File', 'file.ogg')
        audio['file.ogg'].file = NamedBlobFile(ogg_audio, 'audio/ogg', 'file.ogg')
