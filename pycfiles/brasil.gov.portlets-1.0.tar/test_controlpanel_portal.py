...
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/tests/test_controlpanel_portal.py
# Compiled at: 2018-10-18 17:35:14
__doc__ = 'Testa o controlpanel de configuração do Portal Padrão.'
...
class ControlPanelTestCase(unittest.TestCase):
    u"""Testes de configuração do Portal Padrão."""
    ...
    def test_controlpanel_has_view(self):
        ...
        view = api.content.get_view('portal-settings', self.portal, request)
