...
class SearchBoxViewlet(SearchBoxViewletBase):
    ...
    def update(self):
        ...
        self.expandable_header = getattr(self.settings, 'expandable_header', False)
