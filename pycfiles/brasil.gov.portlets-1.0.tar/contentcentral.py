...
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/browser/content/contentcentral.py
...
class ContentCentralView(BrowserView):
    ...
    def media(self):
        ...
        return OrderedDict([ (t, types_tool.getTypeInfo(t).Title()) for t in used_types ])
