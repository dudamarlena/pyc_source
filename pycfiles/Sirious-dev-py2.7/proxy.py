...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/sirious/proxy.py
# Compiled at: 2011-11-28 11:04:36
from binascii import hexlify, unhexlify
import logging, os, pprint, re, sys, zlib
...
class SiriProxy(LineReceiver):
    ...
    def inject_plist(self, plist):
        ...
        data_len = len(data)
        if data_len > 0:
            header = ('{:x}').format(8589934592 + data_len).rjust(10, '0')
