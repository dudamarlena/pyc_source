...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/pci_rport_target_disk_paths.py
...
class PciRportTargetDiskPaths(CommandParser):
    ...
    def parse_content(self, content):
        ...
        KEY_MAP = [{'key': 'host', 'chars': 'host', 'idx': 0}, {'key': 'pci_id', 'chars': 'pci', 'idx': 2}, {'key': 'rport', 'chars': 'rport-', 'idx': 0}, {'key': 'target', 'chars': 'target', 'idx': 0}, {'key': 'devnode', 'chars': 'block', 'idx': 1}, {'key': 'host_channel_id_lun', 'chars': 'block', 'idx': -1}]
        if not content:
