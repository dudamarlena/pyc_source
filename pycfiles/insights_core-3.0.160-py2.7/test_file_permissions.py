...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/tests/test_file_permissions.py
...
def test_permissions():
    for vector in PERMISSIONS_TEST_VECTORS:
        line, with_group, permissions_owner, permissions_group, permissions_other, owner, group, path, owned_by_root_user, owned_by_root_user_and_group, only_root_can_read, only_root_can_write = vector
