...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_sctp.py
...
def test_sctp_eps():
    ...
    assert sctp_info.sctp_eps_ips == {'ffff88017e0a0200': ['10.0.0.102', '10.0.0.70'], 'ffff880612e81c00': [
                          '10.0.0.102', '10.0.0.70', '172.31.1.2'], 
       'ffff88061fba9800': [
                          '10.0.0.102', '10.0.0.70'], 
       'ffff88031e6f1a00': [
                          '10.0.0.102', '10.0.0.70', '192.168.11.2', '192.168.11.12']}
...
def test_sctp_doc_examples():
    env = {'sctp_info': SCTPEps(context_wrap(SCTP_EPS_DETAILS_DOC)), 
