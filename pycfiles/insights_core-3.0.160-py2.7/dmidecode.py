...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/dmidecode.py
...
class DMIDecode(CommandParser, LegacyItemAccess):
    ...
    def system_info(self):
        ...
        if 'system_information' in self:
            return self['system_information'][0]
        else:
            return
    ...
    def bios(self):
        ...
        if 'bios_information' in self:
            return self['bios_information'][0]
        else:
            return
