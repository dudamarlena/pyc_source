...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/redhat_release.py
...
class RedhatRelease(Parser):
    ...
    def parse_content(self, content):
        ...
        code_name = version_name_split[1].strip('()') if len(version_name_split) > 1 else None
        self.parsed = {'product': product, 
