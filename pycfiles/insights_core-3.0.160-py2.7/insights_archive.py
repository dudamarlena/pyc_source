...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/specs/insights_archive.py
...
class InsightsArchiveSpecs(Specs):
    ...
    ceph_osd_df = first_file(['insights_commands/ceph_osd_df_-f_json-pretty', 'insights_commands/ceph_osd_df_-f_json'])
    ...
    ceph_osd_ec_profile_get = simple_file('insights_commands/ceph_osd_erasure-code-profile_get_s_-f_json')
    ...
    lsinitrd = simple_file('insights_commands/lsinitrd')
    ...
    sysctl_conf_initramfs = glob_file('insights_commands/lsinitrd_.boot.*_-f_.etc.sysctl.conf_.etc.sysctl.d._.conf')
