...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_fstab.py
...
FSTAB_WITH_BLANK_IN_PATH = [
 '/dev/sda2                    /                          ext4    1 1  # work',
 '/dev/sdb3                    /var/crash                 ext4    defaults        1 1',
 '/dev/sdb5                    /l\\040ok/at                ext4    defaults        1 1',
 '/dev/sdb7                    /sdb7ok/at                 ext4    defaults',
 '/dev/sdba                    /sdbal\\040ok/ab\\040ta      ext4,a,b    defaults,c,d        1 1']
...
def test_fsspec_of_path():
    ...
    path_device_map = {'/var/crash': '/dev/sdb3', '/var/some/path': '/dev/sdb2', 
