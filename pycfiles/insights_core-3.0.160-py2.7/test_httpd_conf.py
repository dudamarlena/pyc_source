...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_httpd_conf.py
...
def test_get_httpd_conf_nest_2():
    ...
    result = HttpdConf(context)
    assert result[('IfModule', '!php5_module')] == {'Testphp': [
