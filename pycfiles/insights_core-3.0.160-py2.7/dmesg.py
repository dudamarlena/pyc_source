...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/dmesg.py
...
class DmesgLineList(CommandParser, LogFileOutput):
    ...
    def has_startswith(self, prefix):
        ...
        """
        return any(self._line_re.search(line).group('message').startswith(prefix) for line in self.lines)
