...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_rhsm_releasever.py
# Compiled at: 2020-03-26 13:06:46
import doctest, pytest, insights.parsers.rhsm_releasever as rhsm_releasever_module
...
def test_doc_examples():
    env = {'rhsm_releasever': RhsmReleaseVer(context_wrap(RHEL_MAJ_MIN))}
