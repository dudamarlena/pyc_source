...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_krb5kdc_log.py
...
def test_krb5kdc_log():
    ...
    assert decrypt_failed_logs[0] == {'raw_message': 'Apr 01 03:36:33 ldap.example.com krb5kdc[24556](info): preauth (encrypted_timestamp) verify failure: Decrypt integrity check failed', 
    ...
    assert log.get('setsockopt')[0] == {'raw_message': 'krb5kdc: setsockopt(7,IPV6_V6ONLY,1) worked'}
