...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_hosts.py
...
def test_all_hosts():
    ...
    expected = set(EXPECTED['127.0.0.1']) | set(EXPECTED['::1']) | set(EXPECTED['10.0.0.1']) | set(EXPECTED['2001:db8::36']) | set(EXPECTED['192.0.2.1']) | set(EXPECTED['2001:db8::38'])
...
def test_doc():
    env = {'hosts': Hosts(context_wrap(HOSTS_DOC))}
