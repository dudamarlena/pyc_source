...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsr/examples/json_parser.py
# Compiled at: 2019-11-14 13:57:46
"""
json_parser handles primitive json parsing. It doesn't handle unicode or
numbers in scientific notation.
"""
from insights.parsr import Colon, Comma, EOF, Forward, Literal, LeftBracket, LeftCurly, Number, RightBracket, RightCurly, QuotedString, WS
