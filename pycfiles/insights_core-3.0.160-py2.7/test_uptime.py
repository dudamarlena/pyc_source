...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_uptime.py
...
UPTIME_TEST_DATA = [
 {'test_data': ' 14:28:24 up  5:55,  4 users,  load average: 0.04, 0.03, 0.05', 
    'currtime': '14:28:24', 
    'updays': '', 'uphhmm': '5:55', 'users': '4', 'loadavg': [
              '0.04', '0.03', '0.05'], 
 ...
 {'test_data': ' 10:55:22 up 40 days, 21:17,  1 user,  load average: 0.49, 0.12, 0.04', 
    'currtime': '10:55:22', 
    'updays': '40', 'uphhmm': '21:17', 'users': '1', 'loadavg': [
              '0.49', '0.12', '0.04'], 
