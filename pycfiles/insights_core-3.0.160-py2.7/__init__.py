...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/__init__.py
...
import logging, pkgutil, os, sys, yaml
from collections import defaultdict
from .core import Scannable, LogFileOutput, Parser, IniConfigFile
from .core import FileListing, LegacyItemAccess, SysconfigOptions
from .core import YAMLParser, JSONParser, XMLParser, CommandParser
from .core import AttributeDict
from .core import Syslog
from .core import taglang
from .core.archives import COMPRESSION_TYPES, extract, InvalidArchive, InvalidContentType
from .core import dr
from .core.context import ClusterArchiveContext, HostContext, HostArchiveContext, SerializedArchiveContext, ExecutionContext
from .core.dr import SkipComponent
from .core.hydration import create_context
from .core.plugins import combiner, fact, metadata, parser, rule
from .core.plugins import datasource, condition, incident
from .core.plugins import make_response, make_metadata, make_fingerprint
from .core.plugins import make_pass, make_fail, make_info
from .core.filters import add_filter, apply_filters, get_filters
...
def get_nvr():
    return ('{0}-{1}-{2}').format(package_info['NAME'], package_info['VERSION'], package_info['RELEASE'])
...
def run(component=None, root=None, print_summary=False, context=None, inventory=None, print_component=None):
    ...
    if print_summary:
        ...
        p.add_argument('-b', '--bare', help='Specify "spec=filename[,spec=filename,...]" to use the bare file for the spec', default='')
