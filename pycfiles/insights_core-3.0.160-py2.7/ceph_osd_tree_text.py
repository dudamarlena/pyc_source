...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/ceph_osd_tree_text.py
...
class CephOsdTreeText(CommandParser, LegacyItemAccess):
    ...
    def parse_content(self, content):
        ...
        for row_num, line in enumerate(content[1:]):
            node = dict((json_headers[c], line[col_index[c]:col_index[(c + 1)]].strip()) for c in range(len(col_index) - 1))
