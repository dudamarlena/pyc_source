...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/command_parser.py
...
class InsightsCli(object):
    ...
    def __init__(self):
        parser = argparse.ArgumentParser(description='Insights Core command line execution', usage=USAGE)
