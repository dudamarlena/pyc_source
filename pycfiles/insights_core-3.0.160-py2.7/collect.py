...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/collect.py
...
import argparse, logging, os, tempfile, yaml
...
def create_archive(path, remove_path=True):
    ...
    cmd = [
     [
      'tar', '-C', root_path, '-czf', archive_path, relative_path]]
