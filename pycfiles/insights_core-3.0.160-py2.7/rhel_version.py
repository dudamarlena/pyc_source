...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/components/rhel_version.py
...
class IsRhel7(object):
    """
    This component uses ``RedHatRelease`` combiner
    to determine RHEL version. It checks if RHEL7, if not     RHEL7 it raises ``SkipComponent``.
