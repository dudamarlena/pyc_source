...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\daversy\utils.py
...
def execute(cmd, cwd=None, env=None):
    command = subprocess.Popen(cmd, cwd=cwd, env=env, stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
    result = command.wait()
...
try:
    ...
    def get_uuid4():
        ...
        number &= -13835058055282163713
        number |= 9223372036854775808
        number &= -1133367955888714851287041
