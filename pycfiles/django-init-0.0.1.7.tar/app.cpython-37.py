...
# [GCC 8.4.0]
# Embedded file name: /mnt/projects/django-init/django_init/apps/app.py
# Compiled at: 2020-01-15 02:37:16
    ...
    def wrapper(*args, yes=False, **kwargs):
        ...
        if yes:
            ...
            while True:
                ...
                if query == '' or query.lower() not in ('yes', 'y', 'no', 'n'):
