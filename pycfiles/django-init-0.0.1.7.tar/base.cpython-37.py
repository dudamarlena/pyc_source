...
# [GCC 8.4.0]
# Embedded file name: /mnt/projects/django-init/django_init/db/base.py
...
class DatabaseBase(Databases):
    ...
    msg_create_db = 'Database %r created successfully'
    msg_drop_db = 'Database %r dropped successfully'
