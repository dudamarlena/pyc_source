...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Toolserver/MonitorWin32.py
# Compiled at: 2010-03-02 02:58:16
import socket, string, sys, hashlib, thread
...
def writer(lock, sock, barrel='just kidding'):
    while lock.locked():
        sock.send(sys.stdin.readline()[:-1] + '\r\n')
