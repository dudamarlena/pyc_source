...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/plink_pipeline/fawkes_to_gvar.py
# Compiled at: 2009-05-12 14:16:47
        ...
        for calls_line in CallsFile:
            ...
            if skipped_indiv > 0 and total_indiv > 0:
                if skipped_indiv / total_indiv > 0.8:
                    ...
                    print 'Please restart after you have adressed this issue'
                    sys.exit(1)
