...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/plink_pipeline/canary_to_gvar.py
# Compiled at: 2009-02-16 13:31:13
import optparse
...
def ReadConfsFiles(ConfsPaths, dctOptions, gvarFile):
    ...
    if not dctOptions.quiet and len(dctFamMissing.keys()) > 0:
        print '\t(%s) of (%s)\t\tIndividuals not in the Family Data' % (len(dctFamMissing.keys()), len(ConfFileFields))
