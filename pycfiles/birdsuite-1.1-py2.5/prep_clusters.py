...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/canarypriors/prep_clusters.py
# Compiled at: 2009-01-27 09:42:06
from __future__ import division
import sys, mpgutils.fk_utils as fk
...
for line in f:
    ...
    for genotype in unique_genotypes:
        ...
        relevant_intensities = fk.arbslice(intensities[cnv], relevant_intensities_indices)
    ...
    for genotype in unique_genotypes:
        g.write(' ' + float_format(len(cluster_intensities[genotype]) / total_genotypes))
