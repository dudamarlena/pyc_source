...
# [GCC 8.4.0]
# Embedded file name: /home/shared/idle/code/i/sitemetrics/sitemetrics/templatetags/sitemetrics.py
# Compiled at: 2018-07-04 09:21:20
...
class sitemetricsDummyNode(template.Node):
    __doc__ = 'Dummy node used on DEBUG to keep stats clean.'
...
class sitemetricsNode(template.Node):
    __doc__ = 'Renders specified site metrics counter from template.'
