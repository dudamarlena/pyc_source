...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/independentreserve.py
...
class independentreserve(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(independentreserve, self).describe(), {'id': 'independentreserve', 
           'name': 'Independent Reserve', 
           'countries': [
                       'AU', 'NZ'], 
           'rateLimit': 1000, 
           'has': {'CORS': False}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30521662-cf3f477c-9bcb-11e7-89bc-d1ac85012eda.jpg', 
                    'api': {'public': 'https://api.independentreserve.com/Public', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = self.publicGetGetOrderBook(self.extend({'primaryCurrencyCode': market['baseId'], 
           'secondaryCurrencyCode': market['quoteId']}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetGetMarketSummary(self.extend({'primaryCurrencyCode': market['baseId'], 
           'secondaryCurrencyCode': market['quoteId']}, params))
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostGetOrderDetails(self.extend({'orderGuid': id}, params))
        market = None
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=50, params={}):
        ...
        request = self.ordered({'pageIndex': pageIndex, 
           'pageSize': limit})
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetGetRecentTrades(self.extend({'primaryCurrencyCode': market['baseId'], 
           'secondaryCurrencyCode': market['quoteId'], 
           'numberOfRecentTradesToRetrieve': 50}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        order = self.ordered({'primaryCurrencyCode': market['baseId'], 
           'secondaryCurrencyCode': market['quoteId'], 
           'orderType': orderType})
        if type == 'limit':
            order['price'] = price
