...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/kraken.py
...
class kraken(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(kraken, self).describe(), {'id': 'kraken', 
           'name': 'Kraken', 
           'countries': 'US', 
           'version': '0', 
           'rateLimit': 3000, 
           'has': {'createDepositAddress': True, 
                   ...
                   'fetchMyTrades': True, 
                   'withdraw': True}, 
           'marketsByAltname': {}, 'timeframes': {'1m': '1', 
                          '5m': '5', 
                          '15m': '15', 
                          '30m': '30', 
                          '1h': '60', 
                          ...
                          '1w': '10080', 
                          '2w': '21600'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766599-22709304-5ede-11e7-9de1-9f33732e1509.jpg', 
                    'api': {'public': 'https://api.kraken.com', 
           ...
           'api': {'zendesk': {'get': [
                   ...
                   'private': {'post': [
                                      ...
                                      'WithdrawInfo',
                                      'WithdrawStatus']}}, 
           'options': {'cacheDepositMethodsOnFetchDepositAddress': True, 
                       'depositMethods': {}}})
    ...
    def fetch_markets(self):
        ...
        for i in range(0, len(keys)):
            ...
            precision = {'amount': market['lot_decimals'], 'price': market['pair_decimals']}
    ...
    def fetch_trading_fees(self, params={}):
        ...
        return {'info': response, 'maker': maker, 
           'taker': taker}
    ...
    def fetch_tickers(self, symbols=None, params={}):
        ...
        filter = (',').join(pairs)
        response = self.publicGetTicker(self.extend({'pair': filter}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        market = self.market(symbol)
        response = self.publicGetTicker(self.extend({'pair': market['id']}, params))
    ...
    def parse_trade(self, trade, market=None):
        ...
        if 'ordertxid' in trade:
            ...
            if 'fee' in trade:
                ...
                fee = {'cost': float(trade['fee']), 'currency': currency}
        else:
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        market = self.market(symbol)
        id = market['id']
        response = self.publicGetTrades(self.extend({'pair': id}, params))
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostQueryOrders(self.extend({'trades': True, 
           'txid': id}, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        response = None
        try:
            response = self.privatePostCancelOrder(self.extend({'txid': id}, params))
        except Exception as e:
    ...
    def fetch_deposit_methods(self, code, params={}):
        ...
        response = self.privatePostDepositMethods(self.extend({'asset': currency['id']}, params))
    ...
    def fetch_deposit_address(self, code, params={}):
        ...
        if method is None:
            if self.options['cacheDepositMethodsOnFetchDepositAddress']:
                if code not in list(self.options['depositMethods'].keys()):
    ...
    def withdraw(self, currency, amount, address, tag=None, params={}):
        ...
        if 'key' in params:
            self.load_markets()
            response = self.privatePostWithdraw(self.extend({'asset': currency, 
