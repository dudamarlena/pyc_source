...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/ice3x.py
# Compiled at: 2018-04-27 06:35:46
...
class ice3x(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(ice3x, self).describe(), {'id': 'ice3x', 
           'name': 'ICE3X', 
           'countries': 'ZA', 
           'rateLimit': 1000, 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/38012176-11616c32-3269-11e8-9f05-e65cf885bb15.jpg', 
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetStatsMarketdepthfull(self.extend({'pair_id': market['id']}, params))
    ...
    def fetch_order_book(self, symbol, params={}):
        self.load_markets()
        response = self.publicGetOrderbookInfo(self.extend({'pair_id': self.market_id(symbol)}, params))
    ...
    def parse_trade(self, trade, market=None):
        ...
        if fee:
            fee = {'cost': fee, 'currency': market['quote']}
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetTradeList(self.extend({'pair_id': market['id']}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.privatePostOrderNew(self.extend({'pair_id': market['id'], 
           'type': side, 
           'amount': amount, 
           'price': price}, params))
        order = self.parse_order({'order_id': response['response']['entity']['order_id'], 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        response = self.privatePostOrderCancel(self.extend({'order_id': id}, params))
        return response

    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostOrderInfo(self.extend({'order _id': id}, params))
    ...
    def fetch_deposit_address(self, code, params={}):
        ...
        response = self.privatePostBalanceInfo(self.extend({'currency_id': currency['id']}, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            body = self.urlencode(self.extend({'nonce': self.nonce()}, params))
