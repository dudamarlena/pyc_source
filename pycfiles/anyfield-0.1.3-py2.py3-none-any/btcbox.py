...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/btcbox.py
...
class btcbox(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(btcbox, self).describe(), {'id': 'btcbox', 
           'name': 'BtcBox', 
           'countries': 'JP', 
           'rateLimit': 1000, 
           'version': 'v1', 
           'has': {'CORS': False, 
                   ...
                   'fetchTickers': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/31275803-4df755a8-aaa1-11e7-9abb-11ec2fad9f2d.jpg', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'post': [
                                      ...
                                      'trade_view',
                                      'wallet']}}, 
           'markets': {'BTC/JPY': {'id': 'BTC/JPY', 'symbol': 'BTC/JPY', 'base': 'BTC', 'quote': 'JPY'}}, 'exceptions': {'104': AuthenticationError, 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        return self.privatePostTradeCancel(self.extend({'id': id}, params))

    def parse_order(self, order):
        id = self.safe_string(order, 'id')
        timestamp = self.parse8601(order['datetime'] + '+09:00')
    ...
    def fetch_order(self, id, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostTradeView(self.extend({'id': id}, params))
        return self.parse_order(response)

    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        self.load_markets()
        response = self.privatePostTradeList(self.extend({'type': 'all'}, params))
        return self.parse_orders(response)

    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        self.load_markets()
        response = self.privatePostTradeList(self.extend({'type': 'open'}, params))
