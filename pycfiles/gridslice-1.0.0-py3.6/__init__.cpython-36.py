...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\gridslice\__init__.py
# Compiled at: 2018-10-06 23:08:36
# Size of source mod 2**32: 2218 bytes
import argparse, sys, os
from PIL import Image
pil_read_write_types = ('.png', '.tiff', '.tif', '.jpg', '.jpeg', '.gif', '.bmp', '.ico',
                        '.webp')
