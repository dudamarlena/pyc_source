...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/tornado/ioloop.py
...
import datetime, errno, heapq, os, logging, select, thread, threading, time, traceback
