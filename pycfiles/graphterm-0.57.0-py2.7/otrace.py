...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/otrace.py
# Compiled at: 2014-04-14 12:07:56
...
class OShell(TraceConsole):
    ...
    def __init__(self, globals_dict={}, locals_dict={}, init_func=None, init_file=None, allow_unsafe=False, work_dir='', add_env={}, banner=DEFAULT_BANNER, no_input=False, new_thread=False, echo_callback=None, db_interface=None, web_interface=None, hold_wrapper=None, eventloop_callback=None, _stdin=sys.stdin, _stdout=sys.stdout, _stderr=sys.stderr):
        ...
        super(OShell, self).__init__(globals_dict=globals_dict, locals_dict=locals_dict, banner=banner, echo_callback=echo_callback, db_interface=db_interface, web_interface=web_interface, no_input=no_input, new_thread=new_thread, _stdin=_stdin, _stdout=_stdout, _stderr=_stderr)
        ...
        self.aliases = {'cde': [
           ...
           'dn': [
                'cd', DOWN_STACK], 
           'dv': [
                'cd', DOWN_STACK, ';', 'view', '-i'], 
           'doc': [
                 'view', '-d', '-i'], 
           'interrupt': [
                       'exec', 'import', 'os', ';', 'import', 'signal', ';', 'os.kill(os.getpid(),signal.SIGINT)'], 
           'ls': [
                'ls', '-C'], 
           'show': [
                  'view', '-i'], 
    ...
    def parse(self, line, batch=False, here_doc=None):
        ...
        if not line.strip():
            ...
            if cmd == 'pwd':
                ...
                if self.get_web_path() and cmd != 'ls':
