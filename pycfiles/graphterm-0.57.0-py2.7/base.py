...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/svgwrite/base.py
...
class BaseElement(object):
    ...
    **elements**.
    ...
    def copy(self):
        ...
        newobj.attribs = copy.copy(self.attribs)
        newobj.elements = copy.copy(self.elements)
        if 'id' in newobj.attribs:
