...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/gmatplot.py
# Compiled at: 2014-07-12 13:17:56
"""
...
def display(fig, overwrite=False, format='png', outfile='', title='', fullscreen=False, max_bytes=25000000):
    ...
    if pyplot_dict['new_cell']:
        ...
        gterm.display_data(content_type, fig_data, overwrite=overwrite, toggle=True, display='fullscreen' if fullscreen else 'block')
...
def main():
    ...
    parser.add_option('', '--animate', action='store_true', dest='animate', default=False, help='Simple animation demo')
