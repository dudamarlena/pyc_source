...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/svgwrite/validator2.py
...
class Tiny12Validator(object):
    ...
    def _check_svg_value(self, elementname, attributename, value):
        ...
        valuestr = str(value)
        if valuestr not in attribute.get_const(elementname):
