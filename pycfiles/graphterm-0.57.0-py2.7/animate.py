...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/svgwrite/animate.py
...
class Set(BaseElement, XLink):
    ...
    def set_timing(self, begin=None, end=None, dur=None, min=None, max=None, restart=None, repeatCount=None, repeatDur=None):
        """
...
class Animate(Set):
    ...
    def set_value(self, values, calcMode=None, keyTimes=None, keySplines=None, from_=None, to=None, by=None):
        """
