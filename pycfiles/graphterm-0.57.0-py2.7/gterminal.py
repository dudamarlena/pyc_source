...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/gterminal.py
# Compiled at: 2014-07-18 14:06:08
"""gterminal: GraphTerm client launcher
"""
import hashlib, hmac, logging, os, random, sys, urlparse, tornado.httpclient
try:
    import gterm
except ImportError:
