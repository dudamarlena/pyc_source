...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/bin/svgwrite/data/pyparsing_py3.py
...
import copy, sys, warnings, re, sre_constants, collections
__all__ = [
