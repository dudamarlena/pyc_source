...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/graphterm/daemon.py
# Compiled at: 2014-06-27 22:43:19
...
class Daemon(object):
    ...
    def __init__(self, pidfile, umask=18, stdin='/dev/null', stdout='/dev/null', stderr='/dev/null'):
        self.umask = umask
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
...
class ServerDaemon(Daemon):
    ...
    def __init__(self, pidfile, run_function, umask=18):
