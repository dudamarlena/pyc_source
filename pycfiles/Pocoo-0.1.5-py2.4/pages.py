    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/general.html', {'msg': msg, 'form': form.generate(prefix='f_')})
    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/cache.html', {'msg': msg, 'form': form.generate(prefix='f_')})
    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/security.html', {'msg': msg, 'form': form.generate(prefix='f_')})
    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/email.html', {'msg': msg, 'form': form.generate(prefix='f_')})
    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/avatar.html', {'msg': msg, 'form': form.generate(prefix='f_')})
    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/signature.html', {'msg': msg, 'form': form.generate(prefix='f_')})
    ...
    def get_admin_page(self, req):
        ...
        if req.method == 'POST':
            ...
            if not form.has_errors:
                ...
                msg = _('Changes saved')
        return (
         'webadmin/settings/board.html', {'msg': msg, 'form': form.generate(prefix='f_')})
        return
        ...
        if req.method == 'POST':
            if req.form.get('f_user_id'):
                ...
                try:
                    ...
                    form.update(req.form, prefix='f_')
                    return ('webadmin/settings/edituser.html', {'user': None, 'form': form.generate(prefix='f_')})
...
class AddUser(AdminPage):
    ...
    def get_admin_page(self, req):
        ...
        return (
         'webadmin/settings/adduser.html', {'form': form.generate(prefix='f_'), 'msg': msg})