...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pocoo/wrappers/standalone.py
...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    do_POST = do_HEAD = do_HEAD = do_DELETE = do_PUT = do_TRACE = do_GET = run_wsgi
