...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pocoo/pkg/core/search.py
...
class Result(LinkableMixin):
    ...
    def rendered_description(self):
        ...
        result = _highlight_re.sub('<span class="highlight">\\1</span>', self.description)
...
def search(req, rule, per_page, page):
    ...
    pagination = LazyPagination(req, page, per_page, page_count, get_page_link)
