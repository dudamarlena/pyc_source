...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/dist-packages/test/commonComplexObjects.py
...
def getSampleSequence():
    innerSampleSet = set((True, 7, 4.8, complex(1, 5), b'\x1a+<', memoryview(b'mplokij'), None))
    innerSampleFrozenset = frozenset((True, 9, 2.6, complex(3, 0), b'M^o', memoryview(b'wqaxszcd'), None))
    innerList = [False, 5, 6.7, complex(8, 9), b'\x0f\x1f/', bytearray(b'>N^'), memoryview(b'azerty'), None, SampleNonStandardObject(), innerSampleSet, innerSampleFrozenset]
    innerTuple = (False, 0, 8.5, complex(6, 4), b'\xa9\xb8\xc7', bytearray(b'm^O'), memoryview(b'ascfthn'), None, SampleNonStandardObject(), innerSampleSet, innerSampleFrozenset)
    ...
    sampleTuple = (True, 9, 8.7, complex(6, 5), b'\xa1\xb2\xc3', bytearray(b'M^o'), memoryview(b'mlkqsdg'), None, SampleNonStandardObject(), innerTuple, sampleSet, sampleFrozenset, innerSampleObject)
...
def getSampleSet():
    innerFrozenset = frozenset((True, 3, 2.6, complex(1, 9), b'>N^', memoryview(b'wqazsxc'), None))
...
def getSampleDictionnary():
    ...
    innerDictionnary = {False: True, 
     ...
     frozenset([None]): None, 
     'dateTime': SampleNonStandardObject()}
    return SampleDictionnary({True: False, 
     False: None, 
     'a': 1, 
     'b': 2.3, 
     'c': complex(4, 5), 
...
def getSampleObject():
    ...
    sampleDictionnary = {True: False, 
     ...
     'dateTime': SampleNonStandardObject()}
    sampleList = [
     True, 0, 1.2, complex(3, 4), b'\xf0\xf1\xf2', bytearray(b'\xe3\xe4\xe5'), memoryview(b'abcefg'), None, SampleNonStandardObject(),
    ...
    sampleAttributs = {'sampleBoolean':True, 
