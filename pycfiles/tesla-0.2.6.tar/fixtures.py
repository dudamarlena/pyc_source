...
# [GCC 8.4.0]
# Embedded file name: /Users/danjac/petprojects/tesla/tests/output/ProjectName/projectname/lib/fixtures.py
# Compiled at: 2007-09-06 07:54:15
import types, sys, os, simplejson
from projectname import model
VALID_FIXTURE_FILE_EXTENSIONS = [
 '.json']
