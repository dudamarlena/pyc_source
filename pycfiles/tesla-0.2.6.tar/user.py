...
# [GCC 8.4.0]
# Embedded file name: /Users/danjac/petprojects/tesla/tests/output/AuthXpProjectName/authxpprojectname/model/user.py
...
class User(Entity):
    ...
    has_and_belongs_to_many('projects', of_kind='camaro.model.Project', inverse='members', tablename='project_members')
    has_and_belongs_to_many('user_permissions', of_kind='Permission', inverse='users', tablename='user_permissions')
    has_and_belongs_to_many('groups', of_kind='Group', inverse='members', tablename='group_members')
...
__all__ = [
 'User', 'Permission', 'Group', 'NotAuthenticated']