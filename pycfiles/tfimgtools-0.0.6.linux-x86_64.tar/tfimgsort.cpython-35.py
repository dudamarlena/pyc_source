...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/tfimgsort/tfimgsort.py
# Compiled at: 2017-05-18 11:04:38
# Size of source mod 2**32: 5609 bytes
"""The driver and CLI argument parser for classifying and sorting images."""
import os, sys, argparse, logging, numpy as np, tensorflow as tf, ntpath
