...
# [GCC 8.4.0]
# Embedded file name: /Users/mgk/projects/thingpin/src/thingpin/main.py
# Compiled at: 2015-12-16 07:55:17
"""
Usage: thingpin -h
...
"""
import os, sys, time, yaml, docopt, shutil, pkg_resources, traceback, signal
...
def main():
    ...
    if args['create-config']:
        sample = pkg_resources.resource_filename('thingpin', 'thingpin-config.yml.sample')
    ...
    if args['install-service']:
        ...
        service = Thingpin(notifier, pin_mode=config['pin_mode'], things=config['things'], debug=config.get('debug', False))
