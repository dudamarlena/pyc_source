...
# [GCC 8.4.0]
# Embedded file name: /Users/mgk/projects/thingpin/src/thingpin/thingpin.py
# Compiled at: 2015-12-02 21:28:13
...
class Pin(object):
    ...
    def __init__(self, notifier, name, config):
        ...
        self.notifier = notifier
        self.watcher = Watcher(observer=self, pin=config['pin'], sleep=config.get('sleep', 0.01), debounce_delay=config.get('debounce_delay'))
