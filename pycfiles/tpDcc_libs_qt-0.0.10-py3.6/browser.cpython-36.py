...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/browser.py
# Compiled at: 2020-04-26 16:40:12
# Size of source mod 2**32: 18961 bytes
"""
    ...
    def _get_valid_file_list(self, url_list):
        ...
        for url in url_list:
            ...
            if sys.platform == 'darwin':
                sub_process = subprocess.Popen(('osascript -e \'get posix path of posix file "file://{}" -- kthxbai\''.format(file_name)),
