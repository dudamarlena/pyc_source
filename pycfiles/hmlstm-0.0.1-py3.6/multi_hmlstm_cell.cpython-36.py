...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hmlstm/multi_hmlstm_cell.py
# Compiled at: 2017-07-07 16:08:58
...
class MultiHMLSTMCell(rnn_cell_impl.RNNCell):
    __doc__ = 'HMLSTM cell composed squentially of individual HMLSTM cells.'
    ...
    def call(self, inputs, state):
        ...
        h_aboves = array_ops.split(value=raw_h_aboves, num_or_size_splits=ha_splits,
          axis=1)
