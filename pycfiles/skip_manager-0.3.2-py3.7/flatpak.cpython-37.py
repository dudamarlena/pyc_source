...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/skip/managers/flatpak.py
...
class Flatpak(PackageManager):
    ...
    def remove(cls, packages: Dict[(str, List[str])]) -> bool:
        ...
        for package, flags in packages.items():
            ...
            cmd_lst.extend(['uninstall', package])
