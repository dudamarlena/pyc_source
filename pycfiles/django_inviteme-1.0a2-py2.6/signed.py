...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/inviteme/signed.py
# Compiled at: 2012-03-12 07:01:53
"""
...
def sign(value, key=None):
    if isinstance(value, unicode):
        raise TypeError, 'sign() needs bytestring, not unicode: %s' % repr(value)
    if key is None:
