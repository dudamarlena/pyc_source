...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\evgen\core.py
# Compiled at: 2017-04-12 08:41:38
    ...
    def __getattr__(self, val):
        if val == 'Attributes':
            ...
            for attr in self.__attributes__:
                if type(self.__attributes__[attr]) == types.NoneType:
                    pass
