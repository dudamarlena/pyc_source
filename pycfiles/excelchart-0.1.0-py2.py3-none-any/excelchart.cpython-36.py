...
# [GCC 8.4.0]
# Embedded file name: E:\Jan\excelchart\excelchart\excelchart.py
# Compiled at: 2018-02-22 05:22:52
# Size of source mod 2**32: 51091 bytes
"""
@author: Jan Yang
@software: PyCharm Community Edition
"""
import pandas as pd, string, xlsxwriter

class Chart(object):
    __doc__ = ' The chart of class.\n\n    '
    ...
    def __init__(self, workbook, frame, sheet_name=None, chart_type=None, subtype=None, date_parser=False):
        ...
        for col in range(self.shape[1]):
            self.worksheet.write_column(1, col, self.data[:, col], self.date_format if (date_parser and col == 0) else None)
    ...
    def add_series(self, data_labels, overlap=0, gap=150):
        ...
        for num in range(1, self.shape[1]):
            self.chart.add_series({'name':[
              self.sheet_name, 0, num, 0, num], 
             'categories':[
              self.sheet_name, 1, 0, self.shape[0], 0], 
             'values':[
              self.sheet_name, 1, num, self.shape[0], num], 
    ...
    def set_size(self, width=480, height=350, x_scale=1, y_scale=1, x_offset=0, y_offset=0):
        ...
        :return:
        """
        self.chart.set_size({'width':width, 
         'height':height, 
         'x_scale':x_scale, 
         'y_scale':y_scale, 
         'x_offset':x_offset, 
    ...
    def set_title(self, title, font='Arial', size=16, bold=True, italic=False, underline=False, color='black', rotation=0, overlay=False, layout=None):
        """ Set the chart title.
    ...
    def set_legend(self, legend, font='Arial', font_size=10, bold=False, italic=False, underline=False, rotation=0, color='black', delete_series=None, layout=None):
        ...
        """
        if legend:
            self.chart.set_legend({'position':legend, 
             'font':{'name':font, 
              'size':font_size, 
              'bold':bold, 
              'italic':italic, 
    ...
    def set_chart_area(self, border=False, border_color='black', width=0.75, border_transparency=50, dash_type='solid', fill=False, fill_color='white', fill_transparency=0, pattern=None, gradient=None):
        """ Set the chart area.
        ...
        _ = (
         pattern, gradient)
        self.chart.set_chartarea({'border':{'color':border_color,  'width':width,  'transparency':border_transparency,  'dash_type':dash_type} if border else {'none': True}, 
         'fill':{'color':fill_color,  'transparency':fill_transparency} if fill else {'none': True}})

    def set_plot_area(self, border=False, border_color='black', width=0.75, border_transparency=50, dash_type='solid', fill=False, fill_color='white', fill_transparency=0, pattern=None, gradient=None, layout=None):
        """ Set the plot area.
        ...
        _ = (
         pattern, gradient)
        self.chart.set_plotarea({'border':{'color':border_color,  'width':width,  'transparency':border_transparency,  'dash_type':dash_type} if border else {'none': True}, 
         'fill':{'color':fill_color,  'transparency':fill_transparency} if fill else {'none': True}, 
         'layout':{'x':layout[0],  'y':layout[1],  'width':layout[2],  'height':layout[3]} if layout else None})
    ...
    def set_table(self, horizontal=True, vertical=True, outline=True, show_keys=False, font='Arial', font_size=10, bold=False, italic=False, underline=False, rotation=0, color='black'):
        """ Set data table.
        ...
        :return:
        """
        self.chart.set_table({'horizontal':horizontal, 
         'vertical':vertical, 
         'outline':outline, 
         'show_keys':show_keys, 
         'font':{'name':font, 
    ...
    def set_up_down_bars(self, up_border_color='black', up_width=0.75, up_border_transparency=50, up_dash_type='solid', up_fill_color='green', up_fill_transparency=50, down_border_color='black', down_width=0.75, down_border_transparency=50, down_dash_type='solid', down_fill_color='red', down_fill_transparency=0):
    ...
    def set_drop_lines(self, color='black', width=0.75, dash_type='solid', transparency=50):
        ...
        :return:
        """
        self.chart.set_drop_lines({'line': {'color':color, 
                  'width':width, 
                  'dash_type':dash_type, 
    ...
    def set_high_low_lines(self, color='black', width=0.75, dash_type='solid', transparency=50):
        ...
        :return:
        """
        self.chart.set_high_low_lines({'line': {'color':color, 
                  'width':width, 
                  'dash_type':dash_type, 
                  'transparency':transparency}})
    ...
    def set_x_axis(self, name=None, name_font='Arial', name_size=12, name_bold=True, name_italic=False, name_underline=False, name_rotation=0, name_color='black', name_layout=None, label_font='Arial', label_size=10, label_bold=False, label_italic=False, label_underline=False, label_rotation=0, label_color='black', num_format=None, line=True, line_color='black', width=0.75, dash_type='solid', line_transparency=50, fill=False, fill_color='white', fill_transparency=0):
        self.chart.set_x_axis({'name':name, 
         'name_font':{'name':name_font, 
          'size':name_size, 
          'bold':name_bold, 
          'italic':name_italic, 
         ...
         'line':{'color':line_color,  'width':width,  'dash_type':dash_type,  'transparency':line_transparency} if line else {'none': True}, 
         'fill':{'color':fill_color,  'transparency':fill_transparency} if fill else {'none': True}})
    ...
    def set_x_tick_mark(self, major_type=None, minor_type=None):
        ...
        :return:
        """
        self.chart.set_x_axis({'major_tick_mark':major_type or 'none', 
    ...
    def set_y_tick_mark(self, major_type=None, minor_type=None):
        ...
        :return:
        """
        self.chart.set_y_axis({'major_tick_mark':major_type or 'none', 
         'minor_tick_mark':minor_type or 'none'})

    def set_x_title(self, title, font='Arial', size=10, bold=True, italic=False, underline=False, rotation=0, color='black', layout=None):
        ...
        """
        if title:
            self.x_axis_params.update({'name':title, 
             'name_font':{'name':font, 
              'size':size, 
              'bold':bold, 
              'italic':italic, 
    ...
    def set_y_title(self, title, font='Arial', size=10, bold=True, italic=False, underline=False, rotation=0, color='black', layout=None):
        ...
        """
        if title:
            self.y_axis_params.update({'name':title, 
             'name_font':{'name':font, 
              'size':size, 
              'bold':bold, 
              'italic':italic, 
    ...
    def set_x_label(self, font='Arial', size=10, bold=False, italic=False, underline=False, rotation=0, color='black', num_format=None, interval_unit=None, position='next_to'):
        ...
        :return:
        """
        self.x_axis_params.update({'num_font':{'name':font, 
          'size':size, 
          'bold':bold, 
          'italic':italic, 
          'underline':underline or None, 
    ...
    def set_y_label(self, font='Arial', size=10, bold=False, italic=False, underline=False, rotation=0, color='black', num_format=None, interval_unit=None, position='next_to'):
        ...
        :return:
        """
        self.y_axis_params.update({'num_font':{'name':font, 
          'size':size, 
          'bold':bold, 
          'italic':italic, 
          'underline':underline or None, 
    ...
    def set_x_tick(self, interval_unit=None, major_type='outside', minor_type='none'):
        ...
        :return:
        """
        self.x_axis_params.update({'interval_tick':interval_unit, 
    ...
    def set_y_tick(self, interval_unit=None, major_type='outside', minor_type='none'):
        ...
        :return:
        """
        self.y_axis_params.update({'interval_tick':interval_unit, 
         'major_tick_mark':major_type, 
         'minor_tick_mark':minor_type})
    ...
    def set_x_unit(self, major_unit, minor_unit):
        ...
        :return:
        """
        self.x_axis_params.update({'major_unit':major_unit, 
    ...
    def set_y_unit(self, major_unit, minor_unit):
        ...
        :return:
        """
        self.chart.set_y_axis({'major_unit':major_unit, 
         'minor_unit':minor_unit})

    def set_x_grid(self, major=False, minor=False, major_color='black', major_width=0.75, major_dash_type='solid', major_transparency=50, minor_color='black', minor_width=0.75, minor_dash_type='solid', minor_transparency=50):
        ...
        :return:
        """
        self.x_axis_params.update({'major_gridlines':{'visible':major, 
          'line':{'color':major_color, 
           'width':major_width, 
           'dash_type':major_dash_type, 
           'transparency':major_transparency}}, 
         'minor_gridlines':{'visible':minor, 
          'line':{'color':minor_color, 
           'width':minor_width, 
           'dash_type':minor_dash_type, 
           'transparency':minor_transparency}}})

    def set_y_grid(self, major=False, minor=False, major_color='black', major_width=0.75, major_dash_type='solid', major_transparency=50, minor_color='black', minor_width=0.75, minor_dash_type='solid', minor_transparency=50):
        ...
        :return:
        """
        self.y_axis_params.update({'major_gridlines':{'visible':major, 
          'line':{'color':major_color, 
           'width':major_width, 
           'dash_type':major_dash_type, 
           'transparency':major_transparency}}, 
    ...
    def set_x_date_axis(self, major_unit, minor_unit, major_unit_type, minor_unit_type):
        ...
        :return:
        """
        self.x_axis_params.update({'date_axis':True, 
    ...
    def set_y_date_axis(self, major_unit, minor_unit, major_unit_type, minor_unit_type):
        """ Set x axis as a date axis.
            ...
            :return:
            """
        self.y_axis_params.update({'date_axis':True, 
         'major_unit':major_unit, 
         'minor_unit':minor_unit, 
         'major_unit_type':major_unit_type, 
         'minor_unit_type':minor_unit_type})
...
class ExcelChart(object):
    ...
    def column(self, frame, sheet_name=None, subtype=None, data_labels=False, overlap=0, gap=150, title=None, font='Arial', legend=None, x_grid=False, y_grid=False, x_limit=None, y_limit=None, x_title=None, y_title=None, x_reverse=False, y_reverse=False, table=False, size=None, chart_sheet=None):
    ...
    def bar(self, frame, sheet_name=None, subtype=None, data_labels=False, overlap=0, gap=150, title=None, font='Arial', legend=None, x_grid=False, y_grid=False, x_limit=None, y_limit=None, x_title=None, y_title=None, x_reverse=False, y_reverse=False, table=False, size=None, chart_sheet=None):
        """ Create a Bar chart.
    ...
    def line(self, frame, sheet_name=None, data_labels=False, overlap=0, gap=150, title=None, font='Arial', legend=None, x_grid=False, y_grid=False, x_limit=None, y_limit=None, x_title=None, y_title=None, x_reverse=False, y_reverse=False, table=False, size=None, chart_sheet=None):
        """ Create a Line chart.
    ...
    def pie(self, frame, sheet_name=None, data_labels=False, title=None, font='Arial', legend=None, rotation=0, size=None, chart_sheet=None):
        """ Create a Pie chart.
    ...
    def radar(self, frame, sheet_name=None, subtype=None, data_labels=False, title=None, font='Arial', legend=None, major_grid=True, minor_grid=False, size=None, chart_sheet=None):
    ...
    def scatter(self, frame, sheet_name=None, subtype=None, data_labels=False, overlap=0, gap=150, title=None, font='Arial', legend=None, x_grid=False, y_grid=False, x_limit=None, y_limit=None, x_title=None, y_title=None, x_reverse=False, y_reverse=False, table=False, size=None, chart_sheet=None):
    ...
    def area(self, frame, sheet_name=None, subtype=None, data_labels=False, overlap=0, gap=150, title=None, font='Arial', legend=None, x_grid=False, y_grid=False, x_limit=None, y_limit=None, x_title=None, y_title=None, x_reverse=False, y_reverse=False, table=False, size=None, chart_sheet=None):
        """ Create a Area chart.
    ...
    def doughnut(self, frame, sheet_name=None, data_labels=False, title=None, font='Arial', legend=None, rotation=0, size=None, chart_sheet=None):
    ...
    def stock(self, frame, sheet_name=None, data_labels=False, overlap=0, gap=150, title=None, font='Arial', legend=None, x_grid=False, y_grid=False, x_limit=None, y_limit=None, x_title=None, y_title=None, x_reverse=False, y_reverse=False, table=False, size=None, chart_sheet=None):
        """ Create a Area chart.
