...
# [GCC 8.4.0]
# Embedded file name: C:\Dev\python\django-quickview\docs\examplesite\quickview\utils.py
# Compiled at: 2013-02-26 03:19:45
...
class ViewRegistration(object):
    ...
    def register(cls, view):
        ...
        """
        if view.__name__ not in cls.registered_views:
