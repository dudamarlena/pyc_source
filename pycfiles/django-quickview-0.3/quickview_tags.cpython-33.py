...
# [GCC 8.4.0]
# Embedded file name: C:\Dev\python\tmp\qvtest\testsite\quickview\templatetags\quickview_tags.py
# Compiled at: 2013-02-27 08:25:52
...
class FormatApiNode(template.Node):
    ...
    def render(self, context):
        try:
            ...
            for model_name in self.model_names:
                html.append("           var %(model_name)sApi = new _%(model_name)sApi('%(csrf_token)s');" % {'model_name': model_name, 
