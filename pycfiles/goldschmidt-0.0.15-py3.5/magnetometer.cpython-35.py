...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goldschmidt/magnetometer.py
# Compiled at: 2017-02-01 04:48:10
# Size of source mod 2**32: 13061 bytes
"""
Read out a Lutron instrument via USB serial connection.
"""
import serial as s, numpy as np, time, pylab as p, seaborn as sb, argparse, abc
...
class LutronAbstractBaseInstrument(with_metaclass(abc.ABCMeta, object), object):
    ...
    def __init__(self, device='/dev/ttyUSB0', loglevel=20, publish=False, port=9876):
        """
