...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goldschmidt/__init__.py
# Compiled at: 2017-02-01 04:49:08
...
def install_styles(style_default=STYLE_BASEFILE_STD):
   ...
   """
    ...
    assert _exists(style_default), 'STYLEFILE {} missing... indicates a problem with some paths or corrupt packege.                                    Check source code location'.format(style_default)
