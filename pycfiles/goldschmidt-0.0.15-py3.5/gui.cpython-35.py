...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goldschmidt/gui.py
# Compiled at: 2017-02-01 04:46:32
...
"""
import tkinter, time, tkinter.messagebox, numpy as np, pylab as p
...
class LutronInstrumentGraphical(object):
    ...
    def __init__(self, master, meter, interval=2, maxpoints=200, loglevel=20):
        """
