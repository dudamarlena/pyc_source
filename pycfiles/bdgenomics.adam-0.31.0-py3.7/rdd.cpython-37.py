...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/bdgenomics/adam/rdd.py
# Compiled at: 2020-01-08 15:53:47
# Size of source mod 2**32: 69174 bytes
"""
===
rdd
===
...
class GenomicDataset(object):
    ...
    def persist(self, sl):
        ...
        """
        jsl = self.sc._jvm.org.apache.spark.api.java.StorageLevels.create(sl.useDisk, sl.useMemory, sl.useOffHeap, sl.deserialized, sl.replication)
    ...
    def union(self, datasets):
        ...
        """
        return self._replaceRdd(self._jvmRdd.union(map(lambda x: x._jvmRdd, datasets)))

    def _wrapTransformation(self, tFn):
        newDf = tFn(self.toDF())
        jvm = self.sc._jvm
    ...
    def _destClassSuffix(self, destClass):
        ...
        if destClass is FeatureDataset:
            return 'FeaturesDatasetConverter'
        if destClass is FragmentDataset:
            return 'FragmentDatasetConverter'
        if destClass is AlignmentDataset:
            return 'AlignmentDatasetConverter'
        if destClass is GenotypeDataset:
            return 'GenotypeDatasetConverter'
        if destClass is VariantDataset:
            return 'VariantDatasetConverter'
        if destClass is ReadRDD:
            return 'ReadDatasetConverter'
        if destClass is SequenceRDD:
            return 'SequenceDatasetConverter'
        if destClass is SliceRDD:
            return 'SliceDatasetConverter'
        raise ValueError('No conversion method known for %s.' % destClass)

    def pipe(self, cmd, tFormatter, xFormatter, convFn, files=None, environment=None, flankSize=0):
        """
        ...
        if environment is None:
            environment = {}
        return self._replaceRdd(self._jvmRdd.pipe(cmd, files, environment, flankSize, tFormatterClass, xFormatterInst, convFnInst))
    ...
    def broadcastRegionJoin(self, genomicDataset, flankSize=0):
        ...
        """
        return GenomicDataset(self._jvmRdd.broadcastRegionJoin(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def rightOuterBroadcastRegionJoin(self, genomicDataset, flankSize=0):
        ...
        """
        return GenomicDataset(self._jvmRdd.rightOuterBroadcastRegionJoin(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def broadcastRegionJoinAndGroupByRight(self, genomicDataset, flankSize=0):
        ...
        :return: Returns a new genomic dataset containing all pairs of keys that
          overlapped in the genomic coordinate space.
        """
        return GenomicDataset(self._jvmRdd.broadcastRegionJoinAndGroupByRight(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def rightOuterBroadcastRegionJoinAndGroupByRight(self, genomicDataset, flankSize=0):
        ...
        :return: Returns a new genomic dataset containing all pairs of keys that
          ...
          right genomic dataset that did not overlap a key in the left genomic dataset.
        """
        return GenomicDataset(self._jvmRdd.rightOuterBroadcastRegionJoinAndGroupByRight(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def shuffleRegionJoin(self, genomicDataset, flankSize=0):
        ...
        :return: Returns a new genomic dataset containing all pairs of keys that
          overlapped in the genomic coordinate space.
        """
        return GenomicDataset(self._jvmRdd.shuffleRegionJoin(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def rightOuterShuffleRegionJoin(self, genomicDataset, flankSize=0):
        ...
        :return: Returns a new genomic dataset containing all pairs of keys that
          ...
          right genomic dataset that did not overlap a key in the left genomic dataset.
        """
        return GenomicDataset(self._jvmRdd.rightOuterShuffleRegionJoin(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def leftOuterShuffleRegionJoin(self, genomicDataset, flankSize=0):
        ...
        """
        return GenomicDataset(self._jvmRdd.leftOuterShuffleRegionJoin(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def leftOuterShuffleRegionJoinAndGroupByLeft(self, genomicDataset, flankSize=0):
        ...
        :return: Returns a new genomic dataset containing all pairs of keys that
          ...
          left genomic dataset that did not overlap a key in the left genomic dataset.
        """
        return GenomicDataset(self._jvmRdd.leftOuterShuffleRegionJoinAndGroupByLeft(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def fullOuterShuffleRegionJoin(self, genomicDataset, flankSize=0):
        ...
        """
        return GenomicDataset(self._jvmRdd.fullOuterShuffleRegionJoin(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def rightOuterShuffleRegionJoinAndGroupByLeft(self, genomicDataset, flankSize=0):
        ...
        """
        return GenomicDataset(self._jvmRdd.rightOuterShuffleRegionJoinAndGroupByLeft(genomicDataset._jvmRdd, flankSize), self.sc)
    ...
    def shuffleRegionJoinAndGroupByLeft(self, genomicDataset, flankSize=0):
        ...
        """
        return GenomicDataset(self._jvmRdd.shuffleRegionJoinAndGroupByLeft(genomicDataset._jvmRdd, flankSize), self.sc)
...
class VCFSupportingGenomicDataset(GenomicDataset):
    ...
    def addFixedArrayFormatHeaderLine(self, name, count, description, lineType):
        """
        ...
        """
        return self._replaceRdd(self._jvmRdd.addFixedArrayFormatHeaderLine(name, count, self._javaType(lineType), description))

    def addScalarFormatHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addScalarFormatHeaderLine(name, description, self._javaType(lineType)))

    def addGenotypeArrayFormatHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addGenotypeArrayFormatHeaderLine(name, description, self._javaType(lineType)))

    def addAlternateAlleleArrayFormatHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addAlternateAlleleArrayFormatHeaderLine(name, description, self._javaType(lineType)))

    def addAllAlleleArrayFormatHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addAllAlleleArrayFormatHeaderLine(name, description, self._javaType(lineType)))

    def addFixedArrayInfoHeaderLine(self, name, count, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addFixedArrayInfoHeaderLine(name, count, self._javaType(lineType), description))

    def addScalarInfoHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addScalarInfoHeaderLine(name, description, self._javaType(lineType)))

    def addAlternateAlleleArrayInfoHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addAlternateAlleleArrayInfoHeaderLine(name, description, self._javaType(lineType)))

    def addAllAlleleArrayInfoHeaderLine(self, name, description, lineType):
        """
        ...
        :return: A new genomic dataset with the new header line added.
        """
        return self._replaceRdd(self._jvmRdd.addAllAlleleArrayInfoHeaderLine(name, description, self._javaType(lineType)))

    def addFilterHeaderLine(self, name, description):
        """
...
class AlignmentDataset(GenomicDataset):
    ...
    def saveAsSam(self, filePath, asType=None, isSorted=False, asSingleFile=False):
        """
    ...
    def countKmers(self, kmerLength):
        ...
        """
        return DataFrame(self._jvmRdd.countKmersAsDataset(kmerLength).toDF(), SQLContext(self.sc))
    ...
    def sortByReadName(self):
        ...
        """
        return AlignmentDataset(self._jvmRdd.sortByReadName(), self.sc)
    ...
    def sortByReferencePosition(self):
        ...
        :rtype: bdgenomics.adam.rdd.AlignmentDataset
        """
        return AlignmentDataset(self._jvmRdd.sortByReferencePosition(), self.sc)
    ...
    def sortByReferencePositionAndIndex(self):
        ...
        :rtype: bdgenomics.adam.rdd.AlignmentDataset
        """
        return AlignmentDataset(self._jvmRdd.sortByReferencePositionAndIndex(), self.sc)
    ...
    def markDuplicates(self):
        ...
        :rtype: bdgenomics.adam.rdd.AlignmentDataset
        """
        return AlignmentDataset(self._jvmRdd.markDuplicates(), self.sc)

    def recalibrateBaseQualities(self, knownSnps, validationStringency=LENIENT):
        """
        ...
        """
        return AlignmentDataset(self._jvmRdd.recalibrateBaseQualities(knownSnps._jvmRdd, _toJava(validationStringency, self.sc._jvm)))

    def realignIndels(self, isSorted=False, maxIndelSize=500, maxConsensusNumber=30, lodThreshold=5.0, maxTargetSize=3000, maxReadsPerTarget=20000, unclipReads=False):
        """
        ...
        return AlignmentDataset(self._jvmRdd.realignIndels(consensusModel, isSorted, maxIndelSize, maxConsensusNumber, lodThreshold, maxTargetSize, maxReadsPerTarget, unclipReads), self.sc)

    def realignIndelsFromKnownIndels(self, knownIndels, isSorted=False, maxIndelSize=500, maxConsensusNumber=30, lodThreshold=5.0, maxTargetSize=3000, maxReadsPerTarget=20000, unclipReads=False):
        """
    ...
    def saveAsPairedFastq(self, fileName1, fileName2, persistLevel, outputOriginalBaseQualities=False, validationStringency=LENIENT):
        """
        ...
        """
        self._jvmRdd.saveAsPairedFastq(fileName1, fileName2, outputOriginalBaseQualities, _toJava(validationStringency, self.sc._jvm), persistLevel)

    def saveAsFastq(self, fileName, validationStringency=LENIENT, sort=False, outputOriginalBaseQualities=False):
        """
        ...
        Default is false.
        """
        self._jvmRdd.saveAsFastq(fileName, outputOriginalBaseQualities, sort, _toJava(validationStringency, self.sc._jvm))
    ...
    def reassembleReadPairs(self, secondPairRdd, validationStringency=LENIENT):
        ...
        :rtype: bdgenomics.adam.rdd.AlignmentDataset
        """
        return AlignmentDataset(self._jvmRdd.reassembleReadPairs(rdd._jrdd, _toJava(validationStringency, self.sc._jvm)), self.sc)
...
class SliceDataset(GenomicDataset):
    ...
    def flankAdjacentFragments(self, flankLength):
        ...
        """
        return SliceDataset(self._jvmRdd.flankAdjacentFragments(flankLength), self.sc)
...
class VariantContextDataset(VCFSupportingGenomicDataset):
    ...
    def saveAsVcf(self, filePath, asSingleFile=True, deferMerging=False, stringency=LENIENT, disableFastConcat=False):
        """
        ...
        of the fast concatenation engine for saving to HDFS.
        """
        self._jvmRdd.saveAsVcf(filePath, asSingleFile, deferMerging, disableFastConcat, _toJava(stringency, self.sc._jvm))
