                ...
                if isinstance(modelObject, ModelObject):
                    ...
                    if ns in (XbrlConst.vercu, XbrlConst.vercb):
                        ...
                        if ns in (XbrlConst.vercd, XbrlConst.verce):
                            if ln in {'conceptFinalChange', 'conceptIDChange', 'conceptBalanceChange', 'conceptAttributeChange', 'conceptReferenceDelete', 'conceptBlockChange', 'conceptLabelDelete', 'conceptNillableChange', 'tupleContentModelChange', 'conceptSubstitutionGroupChange', 'conceptPeriodTypeChange', 'conceptAttributeDelete', 'conceptDefaultChange', 'conceptTypeChange', 'conceptLabelChange', 'conceptFixedChange', 'conceptReferenceAdd', 'conceptAbstractChange', 'conceptAttributeAdd', 'conceptReferenceChange', 'conceptLabelAdd'} and modelAction is not None:
                                modelAction.events.append(modelObject)
                        else:
