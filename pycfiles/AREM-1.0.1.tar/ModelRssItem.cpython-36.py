...
# Embedded file name: D:\ProgramData\lib\site-packages\arelle\ModelRssItem.py
# Compiled at: 2018-02-26 09:10:06
# Size of source mod 2**32: 7915 bytes
...
class ModelRssItem(ModelObject):
    ...
    def init(self, modelDocument):
        ...
        try:
            if self.modelXbrl.modelManager.rssWatchOptions.latestPubDate:
                if self.pubDate <= self.modelXbrl.modelManager.rssWatchOptions.latestPubDate:
