                    ...
                    if self.toDTS is None:
                        ...
                        if ns in (XbrlConst.vercu, XbrlConst.vercb):
                            ...
                            if ns in (XbrlConst.vercd, XbrlConst.verce):
                                if ln in {'tupleContentModelChange', 'conceptAbstractChange', 'conceptLabelAdd', 'conceptDefaultChange', 'conceptIDChange', 'conceptFinalChange', 'conceptAttributeChange', 'conceptNillableChange', 'conceptBalanceChange', 'conceptPeriodTypeChange', 'conceptReferenceAdd', 'conceptAttributeDelete', 'conceptSubstitutionGroupChange', 'conceptFixedChange', 'conceptLabelDelete', 'conceptTypeChange', 'conceptReferenceDelete', 'conceptAttributeAdd', 'conceptBlockChange', 'conceptLabelChange', 'conceptReferenceChange'} and modelAction is not None:
                                    modelAction.events.append(modelObject)
                            else:
                                if ns == XbrlConst.verrels:
                                    if ln in {'relationshipSetModelAdd', 'relationshipSetModelChange', 'relationshipSetModelDelete'}:
                                        if modelAction is not None:
                                            modelAction.events.append(modelObject)
