...
class ValidateFiling(ValidateXbrl.ValidateXbrl):
    ...
    def validate(self, modelXbrl, parameters=None):
        ...
        if disclosureSystem.deiFilerNameElement in deiItems:
            ...
            if paramFilerIdentifiers and paramFilerNames and entityIdentifierValue in paramFilerIdentifiers:
                ...
                if len(contextIDs) > 0:
                    ...
                    if disclosureSystem.GFM or disclosureSystemVersion[0] >= 27 or documentType in {'10/A', '10-Q', 'N-Q/A', '40-F', 'N-CSRS', '20-F', '10-KT/A', 'N-CSR', '10-Q/A', '10-K/A', '20-F/A', '10-QT/A', 'N-CSRS/A', '10-KT', 'N-CSR/A', '10', '10-QT', '40-F/A', '10-K', 'N-Q'}:
        ...
        if not documentPeriodEndDate:
            ...
            if documentType not in {'F-9/A', 'F-10/A', 'N-1A/A', 'S-4MEF', 'F-4EF', '40-F', 'S-20', '6-K/A', '20FR12B', 'S-3MEF', '40FR12B', '20-F', 'S-4 POS', 'F-1MEF', 'F-10EF', 'SD/A', 'SD', '10-K/A', 'F-3D', '10-QT/A', 'S-3', '10-QT', 'F-3DPOS', '8-K15D5', '40FR12G/A', '8-K', 'POS EX', 'F-4/A', 'POS462B', 'F-4', 'S-11MEF', 'Other', '10-KT/A', 'F-1', '8-K12G3/A', '8-K12G3', 'K SDR', 'S-11/A', '40FR12B/A', '485BPOS', '8-K12B', 'L SDR', 'SP 15D2', '10-Q/A', 'F-3ASR', 'S-11', 'F-6', 'F-4 POS', 'S-BMEF', 'F-3MEF', 'POSASR', 'F-9', '40-F/A', 'S-4EF', '10-12G', 'N-Q/A', 'F-4MEF', '20FR12G/A', 'F-9 POS', 'POS AM', 'S-3/A', 'F-10POS', '8-K12B/A', 'N-1A', '8-K/A', '6-K', 'S-4/A', 'S-1/A', '20FR12B/A', 'SP 15D2/A', 'S-3D', '40FR12G', 'F-3/A', 'F-9EF', '20FR12G', '10-Q', '10-12B/A', 'S-B', 'S-4', '10-12G/A', '497', 'N-CSRS', 'F-10', '8-K15D5/A', 'S-3ASR', 'N-CSR', 'F-3', 'S-1MEF', 'S-1', '20-F/A', 'N-CSRS/A', 'F-1/A', '10-KT', 'S-3DPOS', '10-12B', 'N-CSR/A', 'POS462C', '10-K', 'N-Q'}:
 ...
 'S-3MEF', 'S-BMEF'), 
            ...
            if documentType in doctypesRequired:
                for deiItem in deiItemsRequired:
                    if deiItem not in deiItems or not deiItems[deiItem]:
                        modelXbrl.log('WARNING' if validateEFMpragmatic and deiItem in {'EntityCurrentReportingStatus', 'EntityPublicFloat', 'EntityVoluntaryFilers', 'EntityFilerCategory', 'DocumentFiscalPeriodFocus', 'CurrentFiscalYearEndDate', 'DocumentFiscalYearFocus', 'EntityWellKnownSeasonedIssuer'} else 'ERROR', 'EFM.6.05.21.{0}'.format(deiItem) if validateEFMpragmatic and deiItem in {'EntityCurrentReportingStatus', 'EntityPublicFloat', 'EntityVoluntaryFilers', 'EntityCentralIndexKey', 'EntityFilerCategory', 'DocumentFiscalPeriodFocus', 'EntityRegistrantName', 'CurrentFiscalYearEndDate', 'DocumentFiscalYearFocus', 'EntityWellKnownSeasonedIssuer'} else 'EFM.6.23.36' if deiItem == 'EntityReportingCurrencyISOCode' else 'EFM.6.05.21', _("dei:%(elementName)s is required for DocumentType '%(documentType)s' of context %(contextID)s"), modelObject=documentTypeFact, contextID=documentTypeFact.contextID, documentType=documentType, elementName=deiItem, messageCodes=('EFM.6.05.21.CurrentFiscalYearEndDate',
        ...
        if documentType in {'10-Q', '20-F/A', '10-QT', '20-F', '40-F/A', '10-K/A', '10-KT/A', '10-Q/A', '40-F', '10-K', '10-QT/A', '10-KT'}:
