...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/in_limbo/in_limbo_interfaces.py
# Compiled at: 2014-11-07 07:58:24
...
class GetInLimboArea(BaseInterface):
    ...
    def _run_interface(self, runtime):
        ...
        nb.save(nb.Nifti1Image(in_limbo, z_image.get_affine()), os.path.abspath('in_limbo.nii.gz'))
        nb.save(nb.Nifti1Image(unactivated, z_image.get_affine()), os.path.abspath('in_limbo_unactivated.nii.gz'))
        return runtime
