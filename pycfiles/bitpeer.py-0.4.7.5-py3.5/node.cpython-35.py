...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bitpeer/node.py
# Compiled at: 2015-12-10 15:03:04
# Size of source mod 2**32: 9039 bytes
import binascii, shelve, socket, random
...
class Node:
    ...
    def __init__(self, chain, storagedb, lastblockhash=None, lastblockheight=None, logger=None, maxpeers=15):
        ...
        if 'lastblockheight' in self.db and self.db['lastblockheight'] > lastblockheight:
            ...
            if lastblockheight != None and lastblockhash != None:
