...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bitpeer/serializers.py
# Compiled at: 2015-11-27 11:57:37
# Size of source mod 2**32: 17608 bytes
import binascii, time, random, hashlib, struct
from io import BytesIO
from collections import OrderedDict
from . import fields, networks

class SerializerMeta(type):
    __doc__ = "The serializer meta class. This class will create an attribute\n    called '_fields' in each serializer with the ordered dict of\n    fields present on the subclasses.\n    "
    ...
    def get_fields(meta, bases, attrs, field_class):
        ...
        fields = [(field_name, attrs.pop(field_name)) for field_name, field_value in list(attrs.items()) if isinstance(field_value, field_class)]
...
class SerializerABC(object, metaclass=SerializerMeta):
    __doc__ = 'The serializer abstract base class.'


class Serializer(SerializerABC):
    __doc__ = 'The main serializer class, inherit from this class to\n    create custom serializers.\n\n    Example of use::\n\n        class VerAckSerializer(Serializer):\n            model_class = VerAck\n    '
...
class MessageHeader(object):
    __doc__ = 'The header of all bitcoin messages.'
...
class MessageHeaderSerializer(Serializer):
    __doc__ = 'Serializer for the MessageHeader.'
...
class IPv4Address(object):
    __doc__ = 'The IPv4 Address (without timestamp).'
...
class IPv4AddressSerializer(Serializer):
    __doc__ = 'Serializer for the IPv4Address.'
...
class IPv4AddressTimestamp(IPv4Address):
    __doc__ = 'The IPv4 Address with timestamp.'
...
class IPv4AddressTimestampSerializer(Serializer):
    __doc__ = 'Serializer for the IPv4AddressTimestamp.'
...
class VersionSerializer(Serializer):
    __doc__ = 'The version command serializer.'
    model_class = Version
...
class VerAck(object):
    __doc__ = 'The version acknowledge (verack) command.'
    command = 'verack'


class VerAckSerializer(Serializer):
    __doc__ = 'The serializer for the verack command.'
    model_class = VerAck


class Ping(object):
    __doc__ = 'The ping command, which should always be\n    answered with a Pong.'
    command = 'ping'
...
class PingSerializer(Serializer):
    __doc__ = 'The ping command serializer.'
    model_class = Ping
    nonce = fields.UInt64LEField()


class Pong(object):
    __doc__ = 'The pong command, usually returned when\n    a ping command arrives.'
    command = 'pong'
...
class PongSerializer(Serializer):
    __doc__ = 'The pong command serializer.'
    model_class = Pong
    nonce = fields.UInt64LEField()


class Inventory(object):
    __doc__ = 'The Inventory representation.'
...
class InventorySerializer(Serializer):
    __doc__ = 'The serializer for the Inventory.'
...
class InventoryVector(object):
    __doc__ = 'A vector of inventories.'
    command = 'inv'
...
class OutPointSerializer(Serializer):
    __doc__ = 'The OutPoint representation serializer.'
...
class TxIn(object):
    __doc__ = 'The transaction input representation.'
...
class TxInSerializer(Serializer):
    __doc__ = 'The transaction input serializer.'
    model_class = TxIn
...
class TxOut(object):
    __doc__ = 'The transaction output.'
...
class TxOutSerializer(Serializer):
    __doc__ = 'The transaction output serializer.'
    model_class = TxOut
...
class Tx(object):
    __doc__ = 'The main transaction representation, this object will\n    contain all the inputs and outputs of the transaction.'
    command = 'tx'
    ...
    def calculate_hash(self):
        ...
        hash_fields = [
         'version', 'tx_in', 'tx_out', 'lock_time']
...
class TxSerializer(Serializer):
    __doc__ = 'The transaction serializer.'
    model_class = Tx
...
class BlockHeader(object):
    __doc__ = 'The header of the block.'
...
class BlockHeaderSerializer(Serializer):
    __doc__ = 'The serializer for the block header.'
...
class Block(BlockHeader):
    __doc__ = 'The block message. This message contains all the transactions\n    present in the block.'
    command = 'block'
...
class BlockSerializer(Serializer):
    __doc__ = 'The deserializer for the blocks.'
    model_class = Block
    version = fields.UInt32LEField()
    prev_block = fields.Hash()
    merkle_root = fields.Hash()
...
class HeaderVector(object):
    __doc__ = 'The header only vector.'
    command = 'headers'
...
class HeaderVectorSerializer(Serializer):
    __doc__ = 'Serializer for the block header vector.'
    model_class = HeaderVector
    headers = fields.ListField(BlockHeaderSerializer)


class MemPool(object):
    __doc__ = 'The mempool command.'
    command = 'mempool'


class MemPoolSerializer(Serializer):
    __doc__ = 'The serializer for the mempool command.'
    model_class = MemPool


class GetAddr(object):
    __doc__ = 'The getaddr command.'
    command = 'getaddr'


class GetAddrSerializer(Serializer):
    __doc__ = 'The serializer for the getaddr command.'
    model_class = GetAddr


class GetBlocks(object):
    __doc__ = 'The getblocks command.'
    command = 'getblocks'
...
MESSAGE_MAPPING = {'version': VersionSerializer, 
