...
# [GCC 8.4.0]
# Embedded file name: /home/b3ql/.virtualenvs/SSD/lib/python3.7/site-packages/ssd/engine/trainer.py
# Compiled at: 2019-10-28 14:34:58
# Size of source mod 2**32: 5238 bytes
import collections, datetime, logging, os, time, torch
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if iteration % args.log_step == 0:
            ...
            logger.info(meters.delimiter.join([
             ...
             '{meters}',
             'eta: {eta}',
             'mem: {mem}M']).format(iter=iteration,
        ...
        if args.eval_step > 0:
            if iteration % args.eval_step == 0:
                eval_results = iteration == max_iter or do_evaluation(cfg, model, distributed=(args.distributed), iteration=iteration)
