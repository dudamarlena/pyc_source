...
# [GCC 8.4.0]
# Embedded file name: /home/b3ql/.virtualenvs/SSD/lib/python3.7/site-packages/ssd/data/datasets/coco.py
# Compiled at: 2019-10-28 14:34:58
# Size of source mod 2**32: 4039 bytes
import os, torch.utils.data, numpy as np
from PIL import Image
from ssd.structures.container import Container

class COCODataset(torch.utils.data.Dataset):
    class_names = ('__background__', 'person', 'bicycle', 'car', 'motorcycle', 'airplane',
    ...
    def _get_annotation(self, image_id):
        ...
        boxes = np.array([self._xywh2xyxy(obj['bbox']) for obj in ann], np.float32).reshape((-1,
                                                                                             4))
