...
# [GCC 8.4.0]
# Embedded file name: /home/b3ql/.virtualenvs/SSD/lib/python3.7/site-packages/ssd/data/datasets/evaluation/voc/eval_detection_voc.py
# Compiled at: 2019-10-28 14:34:58
# Size of source mod 2**32: 14357 bytes
from __future__ import division
from collections import defaultdict
import itertools, numpy as np, six
...
def eval_detection_voc(pred_bboxes, pred_labels, pred_scores, gt_bboxes, gt_labels, gt_difficults=None, iou_thresh=0.5, use_07_metric=False):
    ...
    """
    prec, rec = calc_detection_voc_prec_rec(pred_bboxes, pred_labels,
      pred_scores,
      gt_bboxes,
      gt_labels,
      gt_difficults,
...
def calc_detection_voc_prec_rec(pred_bboxes, pred_labels, pred_scores, gt_bboxes, gt_labels, gt_difficults=None, iou_thresh=0.5):
    ...
    for pred_bbox, pred_label, pred_score, gt_bbox, gt_label, gt_difficult in six.moves.zip(pred_bboxes, pred_labels, pred_scores, gt_bboxes, gt_labels, gt_difficults):
