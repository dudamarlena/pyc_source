...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/portkey/portkey.py
# Compiled at: 2018-03-28 08:14:09
# Size of source mod 2**32: 3468 bytes
import asyncio, functools, logging, sys, types, websockets
...
def _start_app(log_level, **ws_options):
    ...
    async def socket_handler(ws, path):
        try:
            ...
            client_register_info = jsonify({'command':'register', 
