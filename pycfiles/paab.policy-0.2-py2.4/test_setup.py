...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/paab/policy/tests/test_setup.py
...
class TestSetup(PaabPolicyTestCase):
    ...
    def test_homeCriteria(self):
        ...
        self.assertEquals('Type', criteria.field)
        self.assertEquals(('Blog Post', ), criteria.value)
    ...
    def test_homeNewsWorkflow(self):
        ...
        self.assertEquals('published', criteria.value)
    ...
    def test_homeNewsSortOrder(self):
        ...
        self.assertEquals('effective', criteria.field)
