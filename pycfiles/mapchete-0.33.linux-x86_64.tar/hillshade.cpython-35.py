...
# [GCC 8.4.0]
# Embedded file name: /home/ungarj/virtualenvs/mapchete/lib/python3.5/site-packages/mapchete/processes/hillshade.py
# Compiled at: 2020-03-23 15:53:29
# Size of source mod 2**32: 3466 bytes
import logging
logger = logging.getLogger(__name__)

def execute(mp, resampling='nearest', azimuth=315.0, altitude=45.0, z=1.0, scale=1.0, td_matching_method='gdal', td_matching_max_zoom=None, td_matching_precision=8, td_fallback_to_higher_zoom=False, clip_pixelbuffer=0, **kwargs):
    """
    ...
    hillshade = mp.hillshade(dem_data, azimuth=azimuth, altitude=altitude, z=z, scale=scale)
    if clip_geom:
