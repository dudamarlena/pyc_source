...
# [GCC 8.4.0]
# Embedded file name: /home/ungarj/virtualenvs/mapchete/lib/python3.5/site-packages/mapchete/formats/default/geojson.py
# Compiled at: 2019-10-02 07:42:12
...
class OutputDataReader(base.TileDirectoryOutputReader):
    ...
    def is_valid_with_config(self, config):
        ...
        if config['schema']['geometry'] not in ('Geometry', 'Point', 'MultiPoint',
...
class OutputDataWriter(base.TileDirectoryOutputWriter, OutputDataReader):
    ...
    def write(self, process_tile, data):
        ...
        if not isinstance(data, (list, types.GeneratorType)):
            raise TypeError('GeoJSON driver data has to be a list or generator of GeoJSON objects')
        data = list(data)
        if not len(data):
            ...
            for tile in self.pyramid.intersecting(process_tile):
                ...
                write_vector_window(in_data=data, out_schema=self.output_params['schema'], out_tile=out_tile, out_path=out_path, bucket_resource=bucket_resource)
