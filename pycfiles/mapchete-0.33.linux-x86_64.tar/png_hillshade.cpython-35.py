...
# [GCC 8.4.0]
# Embedded file name: /home/ungarj/virtualenvs/mapchete/lib/python3.5/site-packages/mapchete/formats/default/png_hillshade.py
# Compiled at: 2020-03-05 08:05:21
# Size of source mod 2**32: 6620 bytes
"""
...
METADATA = {'driver_name': 'PNG_hillshade', 
 'data_type': 'raster', 
 'mode': 'w'}
...
class OutputDataReader(base.TileDirectoryOutputReader):
    ...
    def read(self, output_tile, **kwargs):
        ...
        """
        try:
            return ma.masked_values(read_raster_no_crs(self.get_path(output_tile), indexes=4 if self.old_band_num else 2), 0)
    ...
    def profile(self, tile=None):
        ...
        if tile is not None:
            dst_metadata.update(width=tile.width, height=tile.height, affine=tile.affine, driver='PNG', crs=tile.crs)
        return dst_metadata
