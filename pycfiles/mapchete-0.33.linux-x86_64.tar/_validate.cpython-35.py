...
# [GCC 8.4.0]
# Embedded file name: /home/ungarj/virtualenvs/mapchete/lib/python3.5/site-packages/mapchete/_validate.py
# Compiled at: 2019-06-17 09:54:41
...
def deprecated_kwargs(func):
    ...
    def func_wrapper(*args, **kwargs):
        if kwargs:
            warnings.warn('Using kwargs such in open() is deprecated and will have no effect.')
        if 'resampling' in kwargs:
            raise DeprecationWarning("'resampling' argument has no effect here and must be provided in read() function.")
