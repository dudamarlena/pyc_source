...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/papyro/designer.py
...
BANDAS_DISPONIBLES = {TIPO_PAGE: {BTN_PAGEHEADER: True, 
               BTN_PAGEFOOTER: True, 
               BTN_MASTER: False, 
               BTN_DETAIL: False, 
...
class Designer(object):
    ...
    def window_delete_event(self, widget, event, data=None):
        dlg = gtk.MessageDialog(self.window, gtk.DIALOG_DESTROY_WITH_PARENT, gtk.MESSAGE_QUESTION, gtk.BUTTONS_YES_NO, '¿Seguro que desea salir de la aplicación?')
