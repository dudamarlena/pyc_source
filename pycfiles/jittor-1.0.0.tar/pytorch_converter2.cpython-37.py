...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/utils/pytorch_converter2.py
...
def dfs(a):
    if isinstance(a, ast.Import):
        if a.names[0].name == 'torch.nn':
            if a.names[0].asname == 'nn':
