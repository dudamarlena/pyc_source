...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/test/test_scope.py
...
class TestScope(unittest.TestCase):
    ...
    def test_var(self):
        ...
        for i in range(2):
            ...
            assert names == [
             ...
             'model/linear_2/var_0'], str(names)
    ...
    def test_record_scope(self):
        ...
        if not (len(recs) == 2 and rec_names == ['func_0/b', 'func_0/output']):
