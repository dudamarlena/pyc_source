...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/test/test_resize_and_crop.py
# Compiled at: 2020-03-20 04:44:53
# Size of source mod 2**32: 2872 bytes
import unittest, jittor as jt, random, os
mid = 0
...
def test_case(box_num, out_size, time_limit):
    ...
    for i in range(1, len(rep)):
        ...
        name = rep[i][0]
        if name.startswith('[') and '[graph:]' not in name:
            fused_op_num += 1
