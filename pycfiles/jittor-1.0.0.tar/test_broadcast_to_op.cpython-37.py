...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/test/test_broadcast_to_op.py
...
class TestBroadcastToOpForward(unittest.TestCase):
    ...
    def test_forward(self):
        ...
        def check(bop_num):
            ...
            bop = [node for node in graph.nodes_info if node.startswith('Op') if 'broadcast_to' in node]
