...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/models/resnet.py
...
class ResNet(Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(nn.Conv((self.inplanes), (planes * block.expansion), kernel_size=1,
              stride=stride,
