...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/test/test_cutt_transpose_op.py
...
class TestCuttTransposeOp(unittest.TestCase):
    ...
    def test_with_np(self):
        ...
        ia = [
         gen_data([5, 7]), gen_data([2, 2, 2]), gen_data([2, 3, 4, 5]), gen_data([5, 3]), gen_data([3, 1, 5, 3, 1])]
        for a in ia:
            check(a)
    ...
    def test_grad(self):
        ...
        ia = [
         gen_data([2, 2, 2]), gen_data([2, 3, 4, 5]), gen_data([5, 3]), gen_data([3, 1, 5, 3, 1])]
        for a in ia:
            check(a)
