...
# [GCC 8.4.0]
# Embedded file name: /home/cjld/new_jittor/jittor/python/jittor/test/test_ring_buffer.py
# Compiled at: 2020-03-29 05:04:57
...
def test_ring_buffer():
    ...
    def test_send_recv(data):
        ...
        buffer.send(data)
        recv = buffer.recv()
        if isinstance(recv, np.ndarray) and not (recv == data).all():
