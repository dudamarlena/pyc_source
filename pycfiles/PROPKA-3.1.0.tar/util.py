...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/propjockey/util.py
# Compiled at: 2017-11-22 16:02:35
__doc__ = 'Collection of helper utilities for the main propjockey application.'
import uuid
...
def set_requesters_aliases(votes_collection, requesters_field, alias_map):
    for d in list(votes_collection.find({}, {requesters_field: 1})):
        ...
        votes_collection.update_one({'_id': d['_id']}, {'$set': {requesters_field: aliased}})