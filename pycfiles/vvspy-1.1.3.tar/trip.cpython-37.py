...
# Compiled at: 2019-12-15 05:36:49
...
def get_trips(origin_station_id: Union[(str, int)], destination_station_id: Union[(str, int)], check_time: datetime=None, limit: int=100, debug: bool=False, request_params: dict=None, **kwargs) -> Union[(List[Trip], None)]:
    """
    ...
    if request_params is None:
        request_params = dict()
    params = {'SpEncId':kwargs.get('SpEncId', '0'), 
    ...
    try:
        ...
        try:
            r.encoding = 'UTF-8'
            return _parse_response((r.json()), limit=limit)
