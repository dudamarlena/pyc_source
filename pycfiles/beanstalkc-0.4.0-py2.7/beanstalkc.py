...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/beanstalkc.py
# Compiled at: 2014-01-21 06:34:27
...
class Connection(object):
    ...
    def __init__(self, host=DEFAULT_HOST, port=DEFAULT_PORT, parse_yaml=True, connect_timeout=socket.getdefaulttimeout()):
    ...
    def _read_body(self, size):
        ...
        SocketError.wrap(self._socket_file.read, 2)
