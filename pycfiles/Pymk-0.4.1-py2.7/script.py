...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pymk/tests/script.py
# Compiled at: 2013-11-06 16:48:37
...
class _GetTaskTest(PymkTestCase):
    ...
    def test_parse_task_name(self):
        ...
        name, args = _GetTask('/something/elo/?elo=10&zbychu=12,10&zbychu=ccc').parse_url()
        self.assertEqual('/something/elo/', name)
    ...
    def test_check_if_task_name_exists_fail(self):
        ...
        self.assertRaises(BadTaskPath, data.check_if_task_name_exists, '/something/elo')
