...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/BioClients/monarch/Biolink.py
# Compiled at: 2020-04-22 17:14:06
...
def GetDisease(base_url, ids, args, fout):
    ...
    url_params = {}
    if args.nmax:
        url_params['rows'] = args.nmax
    if args.use_compact_associations:
        url_params['use_compact_associations'] = True
    if args.exclude_automatic_assertions:
        url_params['exclude_automatic_assertions'] = True
    if args.unselect_evidence:
        url_params['unselect_evidence'] = True
