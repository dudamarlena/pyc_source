...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pypoly/_config.py
# Compiled at: 2011-10-28 19:36:30
...
class Config(object):
    ...
    def __init__(self):
        ...
        """
        self.__config = {'pypoly.component.components': [], 'pypoly.component.path': 'components', 
           ...
           'pypoly.menu.file': '', 
           'pypoly.module.modules': [], 'pypoly.module.path': 'modules', 
           'pypoly.plugin.plugins': [], 'pypoly.server.baseurl': '/', 
           ...
           'pypoly.template.templates': [], 'pypoly.tool.tools': []}
