...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pypoly/content/webpage/tab.py
# Compiled at: 2011-11-24 14:09:13
import os, types, sys, pypoly, pypoly.http
        ...
        for (index, tab_item) in enumerate(self):
            for item in tab_item:
                if Form == item.__class__:
                    item.append(HiddenInput('tab', value=index))
