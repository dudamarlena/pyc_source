...
# [GCC 8.4.0]
# Embedded file name: c:\anaconda\lib\site-packages\pysam-0.5-py2.7-win-amd64.egg\pysam\__init__.py
# Compiled at: 2015-09-03 00:58:51
from csamtools import *
from ctabix import *
import csamtools, ctabix
from cvcf import *
import cvcf, Pileup, sys, os
...
__all__ = csamtools.__all__ + ctabix.__all__ + cvcf.__all__ + ['SamtoolsError', 'SamtoolsDispatcher'] + list(SAMTOOLS_DISPATCH) + [
 'Pileup']
