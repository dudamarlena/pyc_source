...
# [GCC 8.4.0]
# Embedded file name: /home/jsmiejczak/.virtualenvs/opendev/lib/python2.7/site-packages/pytest_moto/plugin.py
# Compiled at: 2015-08-28 04:19:27
"""Module contains code for all moto fixtures and their generator."""
import importlib, pytest
from mirakuru import TCPExecutor
CONNECTION_MAP = {'autoscaling': 'boto.ec2.autoscale:AutoScaleConnection', 
...
def moto_fixture(service, host='127.0.0.1', port=7000, timeout=30, connection_params=None):
    ...
    def moto_service():
        executor = TCPExecutor((
         'moto_server', '-H', host, '-p', str(port), service), host=host, port=port, timeout=timeout)
