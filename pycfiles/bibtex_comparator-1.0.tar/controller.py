...
# [GCC 8.4.0]
# Embedded file name: /Users/Ziauddin/Documents/LiClipse Workspace/Bibtex-File-Comparison-and-Update/docs/source/controller.py
# Compiled at: 2015-12-13 17:47:24
import model, pymongo
        ...
        if cursor.count() > 0:
            ...
            for idx, val in enumerate(b):
                ...
                if value != None:
                    if b[idx][1] != value:
                        e = (
                         element['ID'], (b[idx][0], value, idx, IntVar()), (b[idx][0], b[idx][1], idx, IntVar()))
