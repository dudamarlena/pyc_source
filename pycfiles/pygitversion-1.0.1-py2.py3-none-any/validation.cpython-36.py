...
# Embedded file name: /Users/sanhehu/Documents/GitHub/pygitrepo-project/pygitrepo/validation.py
# Compiled at: 2018-09-13 12:38:18
...
def validate_package_name(package_name):
    ...
    if len(invalid_charset):
        msg = "`package_name` can only contains '{}'!".format(_package_name_charset)
        raise ValueError(msg)
...
def validate_github_username(github_username):
    ...
    if len(invalid_charset):
        msg = "`github_username` can only contains '{}'!".format(_github_username_charset)
        raise ValueError(msg)
