...
# [GCC 8.4.0]
# Embedded file name: /home/user/feldbauer/PycharmProjects/hubness/skhubness/neighbors/approximate_neighbors.py
# Compiled at: 2019-10-29 09:36:35
...
class ApproximateNearestNeighbor(ABC):
    __doc__ = ' Abstract base class for approximate nearest neighbor search methods.\n\n    Parameters\n    ----------\n    n_candidates: int, default = 5\n        Number of neighbors to retrieve\n    metric: str, default = \'euclidean\'\n        Distance metric, allowed are "angular", "euclidean", "manhattan", "hamming", "dot"\n    n_jobs: int, default = 1\n        Number of parallel jobs\n    verbose: int, default = 0\n        Verbosity level. If verbose > 0, show tqdm progress bar on indexing and querying.\n    '

    def __init__(self, n_candidates: int=5, metric: str='sqeuclidean', n_jobs: int=1, verbose: int=0, *args, **kwargs):
...
class UnavailableANN(ApproximateNearestNeighbor):
    __doc__ = ' Placeholder for ANN methods that are not available on specific platforms. '
