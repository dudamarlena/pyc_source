...
# [GCC 8.4.0]
# Embedded file name: /home/user/feldbauer/PycharmProjects/hubness/skhubness/reduction/tests/test_dis_sim.py
...
def test_fit_sorted_and_fit_transform(squared, k):
    ...
    nd_sorted, ni_sorted = hr.fit(neigh_dist, neigh_ind, X, assume_sorted=True).transform(neigh_dist,
      neigh_ind, X, assume_sorted=True)
    nd_unsort, ni_unsort = hr.fit(neigh_dist, neigh_ind, X, assume_sorted=False).transform(neigh_dist,
