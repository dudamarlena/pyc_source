...
# [GCC 8.4.0]
# Embedded file name: /home/user/feldbauer/PycharmProjects/hubness/skhubness/neighbors/graph.py
...
def _check_params(X, metric, p, metric_params):
    ...
    for param_name, func_param in params:
        if func_param != est_params[param_name]:
            raise ValueError('Got %s for %s, while the estimator has %s for the same parameter.' % (
...
def kneighbors_graph(X, n_neighbors, mode='connectivity', algorithm: str='auto', algorithm_params: dict=None, hubness: str=None, hubness_params: dict=None, metric='minkowski', p=2, metric_params=None, include_self=False, n_jobs=None):
    ...
    if not isinstance(X, KNeighborsMixin):
        knn = NearestNeighbors(n_neighbors, algorithm=algorithm,
...
def radius_neighbors_graph(X, radius, mode='connectivity', algorithm: str='auto', algorithm_params: dict=None, hubness: str=None, hubness_params: dict=None, metric='minkowski', p=2, metric_params=None, include_self=False, n_jobs=None):
    ...
    if not isinstance(X, RadiusNeighborsMixin):
        X = NearestNeighbors(radius=radius, algorithm=algorithm,
          algorithm_params=algorithm_params,
          hubness=hubness,
          hubness_params=hubness_params,
          metric=metric,
