...
# Embedded file name: build/bdist.linux-x86_64/egg/cob_arcgis_geocoder/geocode.py
# Compiled at: 2018-12-06 10:13:34
# Size of source mod 2**32: 10078 bytes
import pandas as pd, urllib.parse, json
from pandas.io.json import json_normalize
import psycopg2, subprocess, os, codecs
        ...
        for index, row in df.iterrows():
            if row[self.address_field] is None:
                ...
                if matched_address_df is not None and matched_address_df[['flag']][0] == 'Able to geocode to a SAM address.':
                    ...
                    df.at[(index, 'location_x')] = 0.0
                    df.at[(index, 'location_y')] = 0.0
