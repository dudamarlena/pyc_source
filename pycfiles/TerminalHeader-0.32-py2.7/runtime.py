...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\theader\jinja2\runtime.py
...
from jinja2.utils import Markup, soft_unicode, escape, missing, concat, internalcode, object_type_repr
from jinja2.exceptions import UndefinedError, TemplateRuntimeError, TemplateNotFound
from jinja2._compat import imap, text_type, iteritems, implements_iterator, implements_to_string, string_types, PY2
__all__ = [
...
class Context(object):
    r"""The template context holds the variables of a template.  It stores the
    ...
    """
    __slots__ = ('parent', 'vars', 'environment', 'eval_ctx', 'exported_vars', 'name',
                 'blocks', '__weakref__')
    ...
    def call(_Context__self, _Context__obj, *args, **kwargs):
        ...
        if isinstance(__obj, _context_function_types):
            if getattr(__obj, 'contextfunction', 0):
                ...
                args = (
                 __self.eval_ctx,) + args
            elif getattr(__obj, 'environmentfunction', 0):
                args = (
                 __self.environment,) + args
        try:
