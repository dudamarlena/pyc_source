...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\theader\jinja2\ext.py
    ...
    def _parse_block(self, parser, allow_pluralize):
        ...
        while 1:
            if parser.stream.current.type == 'data':
                ...
                raise AssertionError('internal parser error')
