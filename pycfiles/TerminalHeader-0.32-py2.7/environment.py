...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\theader\jinja2\environment.py
...
from jinja2.defaults import BLOCK_START_STRING, BLOCK_END_STRING, VARIABLE_START_STRING, VARIABLE_END_STRING, COMMENT_START_STRING, COMMENT_END_STRING, LINE_STATEMENT_PREFIX, LINE_COMMENT_PREFIX, TRIM_BLOCKS, NEWLINE_SEQUENCE, DEFAULT_FILTERS, DEFAULT_TESTS, DEFAULT_NAMESPACE, KEEP_TRAILING_NEWLINE, LSTRIP_BLOCKS
...
from jinja2.utils import import_string, LRUCache, Markup, missing, concat, consume, internalcode
from jinja2._compat import imap, ifilter, string_types, iteritems, text_type, reraise, implements_iterator, implements_to_string, get_next, encode_filename, PY2, PYPY
...
class Template(object):
    ...
    def __new__(cls, source, block_start_string=BLOCK_START_STRING, block_end_string=BLOCK_END_STRING, variable_start_string=VARIABLE_START_STRING, variable_end_string=VARIABLE_END_STRING, comment_start_string=COMMENT_START_STRING, comment_end_string=COMMENT_END_STRING, line_statement_prefix=LINE_STATEMENT_PREFIX, line_comment_prefix=LINE_COMMENT_PREFIX, trim_blocks=TRIM_BLOCKS, lstrip_blocks=LSTRIP_BLOCKS, newline_sequence=NEWLINE_SEQUENCE, keep_trailing_newline=KEEP_TRAILING_NEWLINE, extensions=(), optimized=True, undefined=Undefined, finalize=None, autoescape=False):
