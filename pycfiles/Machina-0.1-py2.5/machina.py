...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/machina/machina.py
# Compiled at: 2009-01-23 14:38:14
__version__ = '0.1'
import logging
...
class TaskNameAlreadyUsed(TaskException):
    pass


class TaskAlreadyRegistered(TaskException):
    pass


class UnresolvedTaskDependenciesFound(TaskException):
    pass
