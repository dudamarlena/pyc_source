...
# [GCC 8.4.0]
# Embedded file name: /Users/dan/dev/pyCast/shakecast/sc/ui.py
# Compiled at: 2017-04-26 05:25:27
import socket, time, select as select_, sys
...
class UI(object):
        ...
        while sent is False:
            try:
                if msg == 'shutdown' and self.port != 80 and self.port != 5000:
                    ...
                    msg = msg.split(' ')
                    to_server = "{'stop_task(%s)':                                         {'func': self.stop_task,                                          'args_in': {'task_name': '%s'}}}" % (msg[1],
                     msg[1])
                elif msg == 'start':
    ...
    def get_message(self):
        ...
        self.conns = [ conn for conn in self.conns if conn not in closed_conns
                     ]
        return messages
