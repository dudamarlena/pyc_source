...
# Embedded file name: ./vendor/urllib3/util/ssl_.py
...
try:
    ...
    :rtype: SSLContext
    """
            context = SSLContext(ssl_version or )
            context.set_ciphers(ciphers or )
 ...
 L. 335        34  SETUP_FINALLY        52  'to 52'
 ...
 L. 343       120  LOAD_GLOBAL              SSLError
              ...
              126  RAISE_VARARGS_1       1  ''
            128_0  COME_FROM           118  '118'

 L. 344       128  RAISE_VARARGS_0       0  ''
              130  POP_BLOCK        
              132  BEGIN_FINALLY    
 ...
 L. 366   250_252  POP_JUMP_IF_FALSE   264  'to 264'

 L. 367       254  LOAD_GLOBAL              is_ipaddress
              256  LOAD_FAST                'server_hostname'
              258  CALL_FUNCTION_1       1  ''

 L. 366   260_262  POP_JUMP_IF_FALSE   270  'to 270'
            264_0  COME_FROM           250  '250'

 L. 368       264  LOAD_GLOBAL              IS_SECURETRANSPORT

 L. 366   266_268  POP_JUMP_IF_FALSE   312  'to 312'
...
Parse error at or near `COME_FROM_EXCEPT_CLAUSE' instruction at offset 176_0
    ...
    """
            ...
            return bool(IPV4_RE.match(hostname) or )


        def _is_key_file_encrypted--- This code section failed: ---

 L. 401         0  LOAD_GLOBAL              open
 ...
 L. 402        12  LOAD_FAST                'f'
               14  GET_ITER         
             16_0  COME_FROM            26  '26'
               16  FOR_ITER             46  'to 46'
               18  STORE_FAST               'line'

 L. 404        20  LOAD_STR                 'ENCRYPTED'
               22  LOAD_FAST                'line'
               24  COMPARE_OP               in
