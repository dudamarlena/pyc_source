...
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/requests/requests/utils.py
...
def should_bypass_proxies(url, no_proxy):
    ...
    :rtype: bool
    """
    get_proxy = lambda k: os.environ.get(k) or 
...
_CLEAN_HEADER_REGEX_BYTE = re.compile('^\\S[^\\r\\n]*$|^$')
