...
# Embedded file name: ./vendor/requests/sessions.py
# Compiled at: 2019-11-10 08:27:46
# Size of source mod 2**32: 29332 bytes
...
def merge_setting(request_setting, session_setting, dict_class=OrderedDict):
    ...
    if session_setting is None:
        ...
        return isinstance(session_setting, Mapping) and isinstance(request_setting, Mapping) or 
        ...
        while url:
            ...
            if parsed.fragment == '':
                ...
                try:
                    ...
                    rewindable = prepared_request._body_position is not None and ('Content-Length' in headers or )
                    if rewindable:
...
class Session(SessionRedirectMixin):
 ...
 L. 750         0  LOAD_CLOSURE             'self'
                2  BUILD_TUPLE_1         1 
                4  LOAD_DICTCOMP            '<code_object <dictcomp>>'
                6  LOAD_STR                 'Session.__getstate__.<locals>.<dictcomp>'
