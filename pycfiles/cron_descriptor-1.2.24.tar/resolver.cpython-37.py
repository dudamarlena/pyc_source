...
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-target-g7omgaxk/lib/python/yaml/resolver.py
...
class BaseResolver:
    ...
    def check_resolver_prefix(self, depth, path, kind, current_node, current_index):
        ...
        if isinstance(index_check, str):
            return isinstance(current_index, ScalarNode) and index_check == current_index.value or 
        elif isinstance(index_check, int):
            if not isinstance(index_check, bool):
