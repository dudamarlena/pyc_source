...
# Embedded file name: ./vendor/urllib3/fields.py
...
_HTML5_REPLACEMENTS = {'"':'%22', 
 '\\':'\\\\', 
 '\\':'\\\\'}
_HTML5_REPLACEMENTS.update({'%{:02X}'.format(cc):six.unichr(cc) for cc in range(0, 32) if cc not in (27, ) if cc not in (27, )})
...
class RequestField(object):
    ...
    def make_multipart(self, content_disposition=None, content_type=None, content_location=None):
        ...
        """
        self.headers['Content-Disposition'] = content_disposition or 
