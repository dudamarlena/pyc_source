...
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/requests/requests/help.py
# Compiled at: 2019-11-10 08:27:46
# Size of source mod 2**32: 3515 bytes
__doc__ = 'Module containing bug report helper(s).'
from __future__ import print_function
import json, platform, sys, ssl, idna, urllib3, chardet
...
def info():
    ...
    pyopenssl_info = {'version':None, 
     'openssl_version':''}
    if OpenSSL:
        pyopenssl_info = {'version':OpenSSL.__version__,  'openssl_version':'%x' % OpenSSL.SSL.OPENSSL_VERSION_NUMBER}
