...
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/urllib3/urllib3/contrib/_securetransport/bindings.py
...
try:
    ...
    Security.SSLSetConnection.argtypes = [
     SSLContextRef, SSLConnectionRef]
    ...
    Security.SSLCopyPeerTrust.argtypes = [
     SSLContextRef, POINTER(SecTrustRef)]
    ...
    CoreFoundation.CFDataCreate.argtypes = [
     CFAllocatorRef, c_char_p, CFIndex]
