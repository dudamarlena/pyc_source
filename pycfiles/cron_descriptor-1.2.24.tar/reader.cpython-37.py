...
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-target-g7omgaxk/lib/python/yaml/reader.py
...
class Reader(object):
    ...
    def forward(self, length=1):
        ...
        while length:
            ...
            self.index += 1
            if not ch in '\n\x85\u2028\u2029':
                if not ch == '\r' or self.buffer[self.pointer] != '\n':
                    self.line += 1
                    self.column = 0
            elif ch != '\ufeff':
                self.column += 1
