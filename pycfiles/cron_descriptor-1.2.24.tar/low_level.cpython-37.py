...
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/urllib3/urllib3/contrib/_securetransport/low_level.py
# Compiled at: 2019-11-10 08:27:46
# Size of source mod 2**32: 11956 bytes
__doc__ = '\nLow-level helpers for the SecureTransport bindings.\n\nThese are Python functions that are not directly related to the high-level APIs\nbut are necessary to get them to work. They include a whole bunch of low-level\nCoreFoundation messing about and memory management. The concerns in this module\nare almost entirely about trying to avoid memory leaks and providing\nappropriate and useful assistance to the higher-level code.\n'
import base64, ctypes, itertools, re, os, ssl, tempfile
from .bindings import Security, CoreFoundation, CFConst
_PEM_CERTS_RE = re.compile('-----BEGIN CERTIFICATE-----\n(.*?)\n-----END CERTIFICATE-----', re.DOTALL)
