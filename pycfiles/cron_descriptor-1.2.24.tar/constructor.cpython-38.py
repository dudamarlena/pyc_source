...
# Embedded file name: ./vendor/yaml/constructor.py
...
class SafeConstructor(BaseConstructor):
    ...
    def construct_yaml_binary--- This code section failed: ---

 L. 287         0  SETUP_FINALLY        22  'to 22'

 L. 288         2  LOAD_FAST                'self'
                4  LOAD_METHOD              construct_scalar
                6  LOAD_FAST                'node'
                8  CALL_METHOD_1         1  ''
               10  LOAD_METHOD              encode
               12  LOAD_STR                 'ascii'
               14  CALL_METHOD_1         1  ''
               16  STORE_FAST               'value'
               18  POP_BLOCK        
               20  JUMP_FORWARD         76  'to 76'
 ...
 L. 289        22  DUP_TOP          
               ...
               32  STORE_FAST               'exc'
               34  POP_TOP          
               36  SETUP_FINALLY        62  'to 62'

 L. 290        38  LOAD_GLOBAL              ConstructorError
               40  LOAD_CONST               None
               42  LOAD_CONST               None

 L. 291        44  LOAD_STR                 'failed to convert base64 data into ascii: %s'
               46  LOAD_FAST                'exc'
               48  BINARY_MODULO    

 L. 292        50  LOAD_FAST                'node'
               52  LOAD_ATTR                start_mark

 L. 290        54  CALL_FUNCTION_4       4  ''
 ...
 L. 293        76  SETUP_FINALLY       116  'to 116'

 L. 294        78  LOAD_GLOBAL              hasattr
               80  LOAD_GLOBAL              base64
               82  LOAD_STR                 'decodebytes'
               84  CALL_FUNCTION_2       2  ''
               86  POP_JUMP_IF_FALSE   100  'to 100'

 L. 295        88  LOAD_GLOBAL              base64
               90  LOAD_METHOD              decodebytes
               92  LOAD_FAST                'value'
               94  CALL_METHOD_1         1  ''
               96  POP_BLOCK        
               98  RETURN_VALUE     
 ...
 L. 297       100  LOAD_GLOBAL              base64
              102  LOAD_METHOD              decodestring
              104  LOAD_FAST                'value'
              106  CALL_METHOD_1         1  ''
              108  POP_BLOCK        
              110  RETURN_VALUE     
            ...
            116_0  COME_FROM_FINALLY    76  '76'

 L. 298       116  DUP_TOP          
              118  LOAD_GLOBAL              binascii
              120  LOAD_ATTR                Error
 ...
 L. 299       134  LOAD_GLOBAL              ConstructorError
              136  LOAD_CONST               None
              138  LOAD_CONST               None

 L. 300       140  LOAD_STR                 'failed to decode base64 data: %s'
              142  LOAD_FAST                'exc'
              144  BINARY_MODULO    

 L. 300       146  LOAD_FAST                'node'
              148  LOAD_ATTR                start_mark

 L. 299       150  CALL_FUNCTION_4       4  ''
              152  RAISE_VARARGS_1       1  ''
              154  POP_BLOCK        
              156  BEGIN_FINALLY    
...
Parse error at or near `RETURN_VALUE' instruction at offset 98
    ...
    def construct_yaml_timestamp(self, node):
        ...
        if values['tz_sign']:
            ...
            tz_minute = int(values['tz_minute'] or )
...
class FullConstructor(SafeConstructor):
    ...
    def construct_python_bytes--- This code section failed: ---

 L. 482         0  SETUP_FINALLY        22  'to 22'

 L. 483         2  LOAD_FAST                'self'
                4  LOAD_METHOD              construct_scalar
                6  LOAD_FAST                'node'
                8  CALL_METHOD_1         1  ''
               10  LOAD_METHOD              encode
 ...
 L. 485        38  LOAD_GLOBAL              ConstructorError
               40  LOAD_CONST               None
               42  LOAD_CONST               None

 L. 486        44  LOAD_STR                 'failed to convert base64 data into ascii: %s'
               46  LOAD_FAST                'exc'
               48  BINARY_MODULO    

 L. 487        50  LOAD_FAST                'node'
               52  LOAD_ATTR                start_mark

 L. 485        54  CALL_FUNCTION_4       4  ''
               56  RAISE_VARARGS_1       1  ''
               58  POP_BLOCK        
               60  BEGIN_FINALLY    
             62_0  COME_FROM_FINALLY    36  '36'
 ...
 L. 488        76  SETUP_FINALLY       116  'to 116'

 L. 489        78  LOAD_GLOBAL              hasattr
               80  LOAD_GLOBAL              base64
               82  LOAD_STR                 'decodebytes'
               84  CALL_FUNCTION_2       2  ''
               86  POP_JUMP_IF_FALSE   100  'to 100'

 L. 490        88  LOAD_GLOBAL              base64
               90  LOAD_METHOD              decodebytes
               92  LOAD_FAST                'value'
               94  CALL_METHOD_1         1  ''
               96  POP_BLOCK        
 ...
 L. 494       134  LOAD_GLOBAL              ConstructorError
              136  LOAD_CONST               None
              138  LOAD_CONST               None

 L. 495       140  LOAD_STR                 'failed to decode base64 data: %s'
              142  LOAD_FAST                'exc'
              144  BINARY_MODULO    

 L. 495       146  LOAD_FAST                'node'
              148  LOAD_ATTR                start_mark

 L. 494       150  CALL_FUNCTION_4       4  ''
              152  RAISE_VARARGS_1       1  ''
              154  POP_BLOCK        
              156  BEGIN_FINALLY    
            158_0  COME_FROM_FINALLY   132  '132'
