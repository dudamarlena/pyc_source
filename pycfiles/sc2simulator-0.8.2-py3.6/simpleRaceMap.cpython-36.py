...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\sc2simulator\setup\simpleRaceMap.py
# Compiled at: 2018-10-07 20:12:02
# Size of source mod 2**32: 7520 bytes
"""
...
"""
codeMap = {'protoss':{'ground':{4:'Colossus', 
   73:'Zealot', 
   74:'Stalker', 
   75:'HighTemplar', 
   76:'DarkTemplar', 
  ...
  'air':{78:'Phoenix', 
   ...
   495:'Oracle', 
   496:'Tempest'}, 
  'defense':{66:'PhotonCannon', 
   1910:'ShieldBattery'}, 
  'detection':{82: 'Observer'}, 
  'upgrades':{4:'CarrierLaunchSpeedUpgrade', 
 ...
 'terran':{'ground':{33:'SiegeTank', 
   ...
   498:'WidowMine', 
   692:'Cyclone'}, 
  'air':{35:'VikingFighter', 
   54:'Medivac', 
   55:'Banshee', 
   57:'Battlecruiser', 
   689:'Liberator'}, 
  'defense':{23:'MissileTurret', 
   24:'Bunker', 
   25:'SensorTower'}, 
  'detection':{56: 'Raven'}, 
  'upgrades':{8:'HiSecAutoTracking', 
 ...
 'zerg':{'ground':{9:'Baneling', 
  ...
  'defense':{98:'SpineCrawler', 
   99:'SporeCrawler'}, 
  'detection':{129: 'Overseer'}, 
  'upgrades':{5:'GlialReconstitution', 
   6:'TunnelingClaws', 
   7:'ChitinousPlating', 
