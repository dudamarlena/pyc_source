...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pydbgr/bwprocessor/main.py
# Compiled at: 2013-03-17 11:51:47
import inspect, linecache, os, sys, tempfile, traceback, types, pyficache
    ...
    def ok_for_running(self, cmd_obj, name, cmd_hash):
        ...
        if hasattr(cmd_obj, 'execution_set'):
            if self.core.execution_status not in cmd_obj.execution_set:
                ...
                Mmsgs.errmsg(self, Mmisc.wrapped_lines(part1, self.core.execution_status, self.debugger.settings['width']))
                return False
