...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/solo/configurator/config/views.py
# Compiled at: 2016-03-29 18:42:49
...
class ViewsConfiguratorMixin(object):
    ...
    @viewdefaults
    def add_view(self, view=None, route_name=None, request_method=None, attr=None, decorator=None, renderer=None, **predicates):
        """
        ...
        try:
            ...
            raise ConfigurationError('No route named {route_name} found for view registration'.format(route_name=route_name))
        ...
        if renderer is None:
            renderer = 'string'
        route_item = RouteItem(view=view, attr=attr, renderer=self.get_renderer(renderer), predicates=preds)
        route.viewlist.append(route_item)

    def add_view_predicate(self, name, factory, weighs_more_than=None, weighs_less_than=None):
        """
        ...
        """
        self._add_predicate('view', name, factory, weighs_more_than=weighs_more_than, weighs_less_than=weighs_less_than)
