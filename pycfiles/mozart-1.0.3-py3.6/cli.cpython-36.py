...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/mozart/cli.py
# Compiled at: 2019-05-08 21:48:13
...
def main(origin_args):
    ...
    """
    parser = argparse.ArgumentParser(description='mozart - ♪ Nice API for developers who like musics',
      usage='python -m mozart [-h] [-v] [-l LINK] [-n NAME] [-m MUSIC_ID]')
    parser.add_argument('-v',
      '--version', action='version', version=('%(prog)s - version {}'.format(__version__)))
    parser.add_argument('-l',
      '--link', dest='link', type=str, default='', help='print out all info about this music from link.')
    parser.add_argument('-n',
      '--name', dest='name', type=str, default='', help=('name of music site. avaliable are: {}'.format(', '.join(music_map.keys()))))
    parser.add_argument('-m',
      '--music', dest='music_id', type=str, default='', help='print out all info about this music from music id.')
