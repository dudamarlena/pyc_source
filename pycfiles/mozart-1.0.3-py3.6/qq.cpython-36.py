...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/mozart/music/qq.py
# Compiled at: 2019-05-07 04:27:58
...
def operate_vkey(guid):
    ...
    s.headers.update({'referer':'http://y.qq.com', 
     'User-Agent':config.ios_ua})
...
class QQ(Music):
    ...
    def _get_music_info(self):
        ...
        params = {'format':'json', 
         'inCharset':'utf8', 
         'outCharset':'utf-8', 
         'data':'%7b%22songinfo%22%3a%7b%22method%22%3a%22get_song_detail_yqq%22%2c%22param%22%3a%7b%22song_type%22%3a0%2c%22song_mid%22%3a%22{}%22%7d%2c%22module%22%3a%22music.pf_song_detail_svr%22%7d%7d'.format(self.music_id)}
    ...
    def get_music_id_from_url(cls, url):
        music_ids = re.findall('songmid=(.+?)&', url)
        if music_ids:
            return music_ids[0]
        else:
            return ''