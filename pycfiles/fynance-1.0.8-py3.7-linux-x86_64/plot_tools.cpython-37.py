...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fynance/backtest/plot_tools.py
# Compiled at: 2019-03-21 06:26:30
# Size of source mod 2**32: 6954 bytes
import numpy as np
...
def display_perf(y_idx, y_est, period=252, title='', params_iv={}, plot_drawdown=True, plot_roll_sharpe=True, x_axis=None, underlying='Underlying', win=252, fees=0):
    ...
    if x_axis is None:
        ...
        txt = set_text_stats(y_idx,
          period=period, Strategy=y_est,
