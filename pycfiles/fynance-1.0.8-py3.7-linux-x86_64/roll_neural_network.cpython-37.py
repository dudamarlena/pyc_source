...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fynance/neural_networks/roll_neural_network.py
# Compiled at: 2019-05-24 06:05:01
# Size of source mod 2**32: 12014 bytes
...
class RollNeuralNet:
    ...
    def plot_loss(self, f, ax):
        ...
        dpbt = DynaPlotBackTest(fig=f,
          ...
          tick_params={'axis':'x', 
         'labelsize':10})
        dpbt.plot((self.loss_estim[:k]),
          names='Estim NN', col='BuGn', lw=2.0)
        dpbt.plot((self.loss_train[:k]),
          names='Train NN', col='YlOrBr', lw=1.5)
