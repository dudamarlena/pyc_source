...
# [GCC 8.4.0]
# Embedded file name: D:\pycharm_project\ecd\ecd\password_manage\app\handle_data.py
# Compiled at: 2019-05-07 11:28:55
...
class HandleData(object):
    ...
    def __init__(self, cache_file=None):
        self.cache_file = cache_file or 'D:\\tmp\\password_infos.xlsx'
    ...
    def search(self, input_word=None, pre_count=10):
        ...
        sim_seq = list(filter(lambda x: x[1] > 0.2, sim_seq))
