...
# [GCC 8.4.0]
# Embedded file name: /home/kylin/pyenvs/kylins-flask/lib/python2.7/site-packages/test_service/debugger.py
# Compiled at: 2015-02-14 10:29:21
"""接口测试, 控制台只输出状态码和SQL语句, 不输出错误行.
        ...
        def returned_wrapper(request, *args, **kwargs):
            try:
                ...
                if exec_time_print:
                    ...
                    line = '%-25s at %.2f %s => %s ms\n' % (func.__name__, now_time, '        ', t.seconds)
