...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/sotabench/core/results.py
# Compiled at: 2019-07-25 07:46:07
...
class BenchmarkResult:
    ...
    def __init__(self, model: str, task: str, dataset: str, results: dict, config: dict=None, benchmark=None, arxiv_id: str=None, pwc_id: str=None, pytorch_hub_id: str=None):
        """
        CORE INPUTS
