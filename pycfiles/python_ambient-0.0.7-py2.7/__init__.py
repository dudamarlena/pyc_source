...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ambient/__init__.py
# Compiled at: 2012-05-22 04:05:08
import urllib2
...
ERROR_CODES = {0: 'Message successfully submitted. Success', 
...
def dictFromXml(xmlString):
    """
    Returns the a dictionary from the XML string.
    """
...
class AmbientSMS(object):
    ...
    def sendmsg(self, message, recipient_mobiles=[], url='http://services.ambientmobile.co.za/sms', concatenate_message=True, message_id=str(time()).replace('.', ''), reply_path=None, allow_duplicates=True, allow_invalid_numbers=True):
        """
