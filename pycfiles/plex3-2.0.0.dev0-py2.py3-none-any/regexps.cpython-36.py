...
# [GCC 8.4.0]
# Embedded file name: c:\users\geoffrey\workspace\python-plex\build\lib\plex\regexps.py
# Compiled at: 2018-02-04 13:39:36
...
class RE:
    __doc__ = 'RE is the base class for regular expression constructors.\n    The following operators are defined on REs:\n\n         re1 + re2\t\t is an RE which matches |re1| followed by |re2|\n         re1 | re2\t\t is an RE which matches either |re1| or |re2|\n    '
    nullable = 1
    match_nl = 1
    str = None
    ...
    def build_machine(self, machine, initial_state, final_state, match_bol, nocase):
        ...
        """
        raise exceptions.UnimplementedMethod('%s.build_machine not implemented' % self.__class__.__name__)
    ...
    def check_char(self, num, value):
        ...
        if len(value) != 1:
            raise errors.PlexValueError('Invalid value for argument %d of Plex.%s.Expected a string of length 1, got: %s' % (
    ...
    def wrong_type(self, num, value, expected):
        ...
        raise errors.PlexTypeError('Invalid type for argument %d of Plex.%s (expected %s, got %s' % (
...
class Seq(RE):
    __doc__ = 'Seq(re1, re2, re3...) is an RE which matches |re1| followed by\n    |re2| followed by |re3|...'
...
class Alt(RE):
    __doc__ = 'Alt(re1, re2, re3...) is an RE which matches either |re1| or\n    |re2| or |re3|...'
...
class Rep1(RE):
    __doc__ = 'Rep1(re) is an RE which matches one or more repetitions of |re|.'
