...
# [GCC 8.4.0]
# Embedded file name: c:\users\geoffrey\workspace\python-plex\build\lib\plex\machines.py
# Compiled at: 2018-02-04 13:36:46
# Size of source mod 2**32: 10836 bytes
"""
...
class Machine:
    __doc__ = 'A collection of Nodes representing an NFA or DFA.'
    states = None
    next_state_number = 1
    initial_states = None
...
class Node:
    __doc__ = 'A state of an NFA or DFA.'
    transitions = None
    action = None
...
class FastMachine:
    ...
    states = None
    next_number = 1
    new_state_template = {'':None, 
     'bol':None,  'eol':None,  'eof':None,  'else':None}
