...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/show/forms.py
...
class ShowContributorContactForm(forms.Form):
    first_name = forms.CharField(max_length=50, widget=forms.TextInput(attrs={'class': 'required'}), error_messages={'required': 'Please enter your first name.'})
    last_name = forms.CharField(max_length=50, widget=forms.TextInput(attrs={'class': 'required'}), error_messages={'required': 'Please enter your surname.'})
    email = forms.CharField(max_length=150, widget=forms.TextInput(attrs={'class': 'required'}), error_messages={'required': 'Please enter your email address.'})
    message = forms.CharField(max_length=1500, widget=forms.Textarea(attrs={'class': 'required'}), error_messages={'required': 'Please enter your message.'})
    honeypot = forms.CharField(max_length=50, required=False)
