...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mindmeister/auth.py
# Compiled at: 2012-05-17 15:48:42
"""
...
by MindMeister.
"""
import common, webbrowser, parser, diagnostic
...
class AuthToken:
    ...
    def getTokenBegin(self, perms):
        ...
        """
        frob = self.getFrob()
        authUrl = common.createUrl('auth', self.secret, api_key=self.api_key, perms=perms, frob=frob)
