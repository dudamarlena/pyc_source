...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/content.py
...
class RiakContent(object):
    ...
    def __init__(self, robject, data=None, encoded_data=None, charset=None, content_type='application/json', content_encoding=None, last_modified=None, etag=None, usermeta=None, links=None, indexes=None, exists=False):
    ...
    def _serialize(self, value):
        ...
        if isinstance(value, string_types):
            return value.encode()
        raise TypeError(('No encoder for non-string data with content type "{0}"').format(self.content_type))
    ...
    def _deserialize(self, value):
        ...
        raise TypeError(('No decoder for content type "{0}"').format(self.content_type))
