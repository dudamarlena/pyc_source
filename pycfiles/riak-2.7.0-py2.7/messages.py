...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/pb/messages.py
# Compiled at: 2016-12-06 18:54:22
"""
Constants and mappings between Riak protocol codes and messages.
"""
import riak.pb.riak_dt_pb2, riak.pb.riak_kv_pb2, riak.pb.riak_pb2, riak.pb.riak_search_pb2, riak.pb.riak_ts_pb2, riak.pb.riak_yokozuna_pb2
...
MESSAGE_CLASSES = {MSG_CODE_ERROR_RESP: riak.pb.riak_pb2.RpbErrorResp, 
   ...
   MSG_CODE_GET_BUCKET_KEY_PREFLIST_REQ: riak.pb.riak_kv_pb2.RpbGetBucketKeyPreflistReq, 
   MSG_CODE_GET_BUCKET_KEY_PREFLIST_RESP: riak.pb.riak_kv_pb2.RpbGetBucketKeyPreflistResp, 
   ...
   MSG_CODE_YOKOZUNA_INDEX_GET_REQ: riak.pb.riak_yokozuna_pb2.RpbYokozunaIndexGetReq, 
   MSG_CODE_YOKOZUNA_INDEX_GET_RESP: riak.pb.riak_yokozuna_pb2.RpbYokozunaIndexGetResp, 
   MSG_CODE_YOKOZUNA_INDEX_PUT_REQ: riak.pb.riak_yokozuna_pb2.RpbYokozunaIndexPutReq, 
   MSG_CODE_YOKOZUNA_INDEX_DELETE_REQ: riak.pb.riak_yokozuna_pb2.RpbYokozunaIndexDeleteReq, 
   MSG_CODE_YOKOZUNA_SCHEMA_GET_REQ: riak.pb.riak_yokozuna_pb2.RpbYokozunaSchemaGetReq, 
   MSG_CODE_YOKOZUNA_SCHEMA_GET_RESP: riak.pb.riak_yokozuna_pb2.RpbYokozunaSchemaGetResp, 
   MSG_CODE_YOKOZUNA_SCHEMA_PUT_REQ: riak.pb.riak_yokozuna_pb2.RpbYokozunaSchemaPutReq, 
