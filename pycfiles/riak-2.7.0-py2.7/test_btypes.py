...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/tests/test_btypes.py
...
class BucketTypeTests(IntegrationTestBase, unittest.TestCase, Comparison):
    ...
    def test_btype_get_bucket(self):
        ...
        self.assertIs(bucket, self.client.bucket_type('foo').bucket(self.bucket_name))
