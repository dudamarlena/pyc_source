...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/client/multi.py
...
if PY2:
    ...
    from queue import Queue, Empty
__all__ = [
 'multiget', 'multiput', 'MultiGetPool', 'MultiPutPool']
try:
    POOL_SIZE = cpu_count()
        ...
        while not self._should_quit():
            ...
            try:
                try:
                    ...
                    errdata = (
                     task.bucket_type, task.bucket, task.key, err)
