...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/bucket.py
...
class RiakBucket(object):
    ...
    def get(self, key, r=None, pr=None, timeout=None, include_context=None, basic_quorum=None, notfound_ok=None, head_only=False):
        """
        ...
        from riak import RiakObject
        if self.bucket_type.datatype:
            return self._client.fetch_datatype(self, key, r=r, pr=pr, timeout=timeout, include_context=include_context, basic_quorum=basic_quorum, notfound_ok=notfound_ok)
        else:
            obj = RiakObject(self._client, self, key)
            return obj.reload(r=r, pr=pr, timeout=timeout, basic_quorum=basic_quorum, notfound_ok=notfound_ok, head_only=head_only)
    ...
    def multiget(self, keys, r=None, pr=None, timeout=None, basic_quorum=None, notfound_ok=None, head_only=False):
        ...
        return self._client.multiget(bkeys, r=r, pr=pr, timeout=timeout, basic_quorum=basic_quorum, notfound_ok=notfound_ok, head_only=head_only)
    ...
    def get_index(self, index, startkey, endkey=None, return_terms=None, max_results=None, continuation=None, timeout=None, term_regex=None):
        """
        ...
        """
        return self._client.get_index(self, index, startkey, endkey, return_terms=return_terms, max_results=max_results, continuation=continuation, timeout=timeout, term_regex=term_regex)

    def paginate_index(self, index, startkey, endkey=None, return_terms=None, max_results=1000, continuation=None, timeout=None, term_regex=None):
        """
        ...
        """
        return self._client.paginate_index(self, index, startkey, endkey, return_terms=return_terms, max_results=max_results, continuation=continuation, timeout=timeout, term_regex=term_regex)

    def stream_index(self, index, startkey, endkey=None, return_terms=None, max_results=None, continuation=None, timeout=None, term_regex=None):
        """
        Queries a secondary index over objects in this bucket,
        ...
        """
        return self._client.stream_index(self, index, startkey, endkey, return_terms=return_terms, max_results=max_results, continuation=continuation, timeout=timeout, term_regex=term_regex)

    def paginate_stream_index(self, index, startkey, endkey=None, return_terms=None, max_results=1000, continuation=None, timeout=None, term_regex=None):
        """
        Paginates through a secondary index over objects in this bucket,
        ...
        """
        return self._client.paginate_stream_index(self, index, startkey, endkey, return_terms=return_terms, max_results=max_results, continuation=continuation, timeout=timeout, term_regex=term_regex)
    ...
    def __str__(self):
        if self.bucket_type.is_default():
            ...
            return ('<RiakBucket {0!r}/{1!r}>').format(self.bucket_type.name, self.name)
