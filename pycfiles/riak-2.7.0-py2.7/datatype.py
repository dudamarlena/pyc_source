...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/datatypes/datatype.py
...
class Datatype(object):
    ...
    def reload(self, **params):
        ...
        if not dtype == self.type_name:
            raise TypeError(('Expected datatype {} but got datatype {}').format(self.__class__, TYPES[dtype]))
        self.clear()
        self._context = context
        self._set_value(value)
        return self
