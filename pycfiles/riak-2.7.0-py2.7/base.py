...
# [GCC 8.4.0]
# Embedded file name: py-build/2.7/bdist.linux-x86_64/egg/riak/tests/base.py
...
class IntegrationTestBase(object):
    ...
    @classmethod
    def create_client(cls, host=None, http_port=None, pb_port=None, protocol=None, credentials=None, **kwargs):
        host = host or HOST
        ...
        logger.debug("RiakClient(protocol='%s', host='%s', pb_port='%d', http_port='%d', credentials='%s', kwargs='%s')", protocol, host, pb_port, http_port, credentials, kwargs)
        return RiakClient(protocol=protocol, host=host, http_port=http_port, credentials=credentials, pb_port=pb_port, **kwargs)
