...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1_modules/rfc6664.py
...
class RSAKeyCapabilities(univ.Sequence):
    __module__ = __name__
    componentType = namedtype.NamedTypes(namedtype.NamedType('minKeySize', RSAKeySize()), namedtype.OptionalNamedType('maxKeySize', RSAKeySize()))
...
_smimeCapabilityMapUpdate = {rsaEncryption: RSAKeyCapabilities(), id_RSASSA_PSS: RSAKeyCapabilities(), id_RSAES_OAEP: RSAKeyCapabilities(), id_dsa: DSAKeyCapabilities(), dhpublicnumber: DSAKeyCapabilities(), id_ecPublicKey: EC_SMimeCaps(), id_ecDH: EC_SMimeCaps(), id_ecMQV: EC_SMimeCaps(), id_mgf1: AlgorithmIdentifier()}
