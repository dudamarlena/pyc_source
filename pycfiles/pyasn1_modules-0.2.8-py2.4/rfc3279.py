...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1_modules/rfc3279.py
...
class DomainParameters(univ.Sequence):
    __module__ = __name__
    componentType = namedtype.NamedTypes(namedtype.NamedType('p', univ.Integer()), namedtype.NamedType('g', univ.Integer()), namedtype.NamedType('q', univ.Integer()), namedtype.OptionalNamedType('j', univ.Integer()), namedtype.OptionalNamedType('validationParms', ValidationParms()))
...
class Curve(univ.Sequence):
    __module__ = __name__
    componentType = namedtype.NamedTypes(namedtype.NamedType('a', FieldElement()), namedtype.NamedType('b', FieldElement()), namedtype.OptionalNamedType('seed', univ.BitString()))
...
_algorithmIdentifierMapUpdate = {md2: univ.Null(''), md5: univ.Null(''), id_sha1: univ.Null(''), id_dsa: Dss_Parms(), rsaEncryption: univ.Null(''), md2WithRSAEncryption: univ.Null(''), md5WithRSAEncryption: univ.Null(''), sha1WithRSAEncryption: univ.Null(''), dhpublicnumber: DomainParameters(), id_keyExchangeAlgorithm: KEA_Parms_Id(), id_ecPublicKey: EcpkParameters()}
