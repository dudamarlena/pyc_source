...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1_modules/rfc4210.py
...
class PKIStatus(univ.Integer):
    ...
    """
    __module__ = __name__
    namedValues = namedval.NamedValues(('accepted', 0), ('grantedWithMods', 1), ('rejection',
                                                                                 2), ('waiting',
                                                                                      3), ('revocationWarning',
...
class PKIFailureInfo(univ.BitString):
    ...
    """
    __module__ = __name__
    namedValues = namedval.NamedValues(('badAlg', 0), ('badMessageCheck', 1), ('badRequest',
                                                                               2), ('badTime',
                                                                                    3), ('badCertId',
                                                                                         4), ('badDataFormat',
                                                                                              5), ('wrongAuthority',
