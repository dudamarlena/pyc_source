...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1_modules/rfc6031.py
...
FriendlyName.componentType = namedtype.NamedTypes(namedtype.NamedType('friendlyName', char.UTF8String()), namedtype.OptionalNamedType('friendlyNameLangTag', char.UTF8String()))
...
Encoding.namedValues = namedval.NamedValues(('dec', 'DECIMAL'), ('hex', 'HEXADECIMAL'), ('alpha',
                                                                                         'ALPHANUMERIC'), ('b64',
                                                                                                           'BASE64'), ('bin',
                                                                                                                       'BINARY'))
Encoding.subtypeSpec = constraint.SingleValueConstraint('DECIMAL', 'HEXADECIMAL', 'ALPHANUMERIC', 'BASE64', 'BINARY')

class ChallengeFormat(univ.Sequence):
    __module__ = __name__


ChallengeFormat.componentType = namedtype.NamedTypes(namedtype.NamedType('encoding', Encoding()), namedtype.DefaultedNamedType('checkDigit', univ.Boolean().subtype(value=0)), namedtype.NamedType('min', univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))), namedtype.NamedType('max', univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))))

class ResponseFormat(univ.Sequence):
    __module__ = __name__


ResponseFormat.componentType = namedtype.NamedTypes(namedtype.NamedType('encoding', Encoding()), namedtype.NamedType('length', univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))), namedtype.DefaultedNamedType('checkDigit', univ.Boolean().subtype(value=0)))

class PSKCAlgorithmParameters(univ.Choice):
    __module__ = __name__


PSKCAlgorithmParameters.componentType = namedtype.NamedTypes(namedtype.NamedType('suite', char.UTF8String()), namedtype.NamedType('challengeFormat', ChallengeFormat().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))), namedtype.NamedType('responseFormat', ResponseFormat().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))))
...
ValueMac.componentType = namedtype.NamedTypes(namedtype.NamedType('macAlgorithm', char.UTF8String()), namedtype.NamedType('mac', char.UTF8String()))
...
PSKCKeyUsage.namedValues = namedval.NamedValues(('otp', 'OTP'), ('cr', 'CR'), ('encrypt',
                                                                               'Encrypt'), ('integrity',
                                                                                            'Integrity'), ('verify',
                                                                                                           'Verify'), ('unlock',
                                                                                                                       'Unlock'), ('decrypt',
                                                                                                                                   'Decrypt'), ('keywrap',
                                                                                                                                                'KeyWrap'), ('unwrap',
                                                                                                                                                             'Unwrap'), ('derive',
                                                                                                                                                                         'Derive'), ('generate',
                                                                                                                                                                                     'Generate'))
PSKCKeyUsage.subtypeSpec = constraint.SingleValueConstraint('OTP', 'CR', 'Encrypt', 'Integrity', 'Verify', 'Unlock', 'Decrypt', 'KeyWrap', 'Unwrap', 'Derive', 'Generate')
...
SKeyAttribute.componentType = namedtype.NamedTypes(namedtype.NamedType('attrType', AttributeType()), namedtype.NamedType('attrValues', univ.SetOf(componentType=AttributeValue()), openType=opentype.OpenType('attrType', sKeyAttributesMap)))

class SKeyPkgAttribute(univ.Sequence):
    __module__ = __name__


SKeyPkgAttribute.componentType = namedtype.NamedTypes(namedtype.NamedType('attrType', AttributeType()), namedtype.NamedType('attrValues', univ.SetOf(componentType=AttributeValue()), openType=opentype.OpenType('attrType', sKeyPkgAttributesMap)))
...
KeyPkgVersion.namedValues = namedval.NamedValues(('v1', 1))

class OneSymmetricKey(univ.Sequence):
    __module__ = __name__


OneSymmetricKey.componentType = namedtype.NamedTypes(namedtype.OptionalNamedType('sKeyAttrs', univ.SequenceOf(componentType=SKeyAttribute()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))), namedtype.OptionalNamedType('sKey', univ.OctetString()))
...
SymmetricKeyPackage.componentType = namedtype.NamedTypes(namedtype.DefaultedNamedType('version', KeyPkgVersion().subtype(value='v1')), namedtype.OptionalNamedType('sKeyPkgAttrs', univ.SequenceOf(componentType=SKeyPkgAttribute()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX), implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))), namedtype.NamedType('sKeys', SymmetricKeys()))
_cmsContentTypesMapUpdate = {id_ct_KP_sKeyPackage: SymmetricKeyPackage()}
