...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\core\xmldb\tests\test_xpath.py
...
from seishub.core.xmldb.xpath import XPathQuery, RestrictedXPathQueryParser
import unittest
...
class XPathQueryParserTest(SeisHubEnvironmentTestCase):
    ...
    def testInvalid(self):
        queries = [
         ...
         '[/rootnode/child]']
        _ = [ self.assertRaises(InvalidParameterError, self.parser.parse, q) for q in queries
            ]
    ...
    def testKeyLessQuery(self):
        queries = [
         ...
         '/pid/rid[rn/./@attr]',
         '/pid/rid[rn/./node/@attr]',
         '/seismology/station[xseed/volume_index_control_header/' + 'volume_identifier/beginning_time]',
         '/seismology/station[*/volume_index_control_header/' + 'volume_identifier/beginning_time]']
        results = [
         [
          [
           'pid', 'rid', 'rn/attr']],
         ...
         [
          [
           'seismology', 'station',
           'xseed/volume_index_control_header/volume_identifier/' + 'beginning_time']],
         [
          [
           'seismology', 'station',
           '*/volume_index_control_header/volume_identifier/' + 'beginning_time']]]
    ...
    def testRelationalOperators(self):
        queries = {'/pid/rid[rn/attr1 = "blah"]': '=', '/pid/rid[rn/attr1 == "blah"]': '=', 
    ...
    def testMultipleKeyQuery(self):
        queries = [
         '/pid/rid[rn/attr1 = "blah" and rn/attr2 = "bluh"]',
         '/pid/rid[rn/attr1 = "blah" and (rn/attr2 = "bluh" or' + ' rn/attr2 = "bloh")]',
         '/pid/rid[(rn/attr1 = "blah" and rn/attr2 = "bluh") or ' + 'rn/attr2 = "bloh"]',
         '/pid/rid[(rn/attr1 = "blah" and rn/attr2 = "bluh") or ' + 'rn/attr2 = "bloh"]',
         '/pid/rid[rn/attr1 = "blah" and (rn/attr2 = "bluh" and ' + '(rn/attr2 = "bloh" or rn/attr3 = "moep"))]',
         '/package/rt[station/lat>49 and station/lat<56 and ' + 'station/lon=22.51200]']
        results = [
         [
          [
           [
    ...
    def testOrderByLimitOffsetQuery(self):
        queries = ['/pid/rid order by rn/node1',
         ...
         '/pid/rid[rn/node1 = "blah"] order by rn/node2, ' + 'rn/node3/@id desc limit 5,10']
        results = [
         [
          [
           [
...
class XPathQueryTest(SeisHubEnvironmentTestCase):
    ...
    def testXPathQuery(self):
        q = "/testpackage/testtype[./rootnode/element1/element2 = 'blub' " + 'and rootnode/./element1/@id <= 5] ' + 'order by rootnode/element1/element2 desc, rootnode/element3 asc' + ' limit 10,20'
        query = XPathQuery(q)
        self.assertEqual(query.getLocationPath(), ['testpackage', 'testtype'])
        self.assertEqual(query.getOrderBy(), [
         [
