...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\core\processor\tests\test_rest_DELETE.py
...
from seishub.core.processor import Processor, POST, PUT, DELETE, GET
