...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\core\services\manhole.py
# Compiled at: 2010-12-23 17:42:43
"""
A Manhole server.
"""
from seishub.core.config import IntOption, Option, BoolOption
from seishub.core.defaults import MANHOLE_PORT, MANHOLE_PRIVATE_KEY, MANHOLE_PUBLIC_KEY, MANHOLE_AUTOSTART
...
class ManholeService(TCPServer):
    ...
    """
    service_id = 'manhole'
    BoolOption('manhole', 'autostart', MANHOLE_AUTOSTART, 'Run service on start-up.')
    IntOption('manhole', 'port', MANHOLE_PORT, 'Manhole port number.')
    Option('manhole', 'public_key_file', MANHOLE_PUBLIC_KEY, 'Public RSA key.')
    Option('manhole', 'private_key_file', MANHOLE_PRIVATE_KEY, 'Private RSA key.')
