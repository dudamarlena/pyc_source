...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/pypi_rankings/crawlers/bitbucket.py
...
def crawl(conn, crawl_count=1):
    ...
    for package_name, bitbucket_uri in bitbucket_list:
        try:
            ...
            save_data(conn, package_name, dict(open_issues=open_issues, html_url=meta_info['links']['html']['href'], pushed_at=meta_info['updated_on'], scm_type=('Bitbucket - {}').format(meta_info['scm'])))
        except:
            pass
