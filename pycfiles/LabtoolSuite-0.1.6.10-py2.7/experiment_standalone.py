...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/Labtools/experiment_standalone.py
# Compiled at: 2015-04-23 01:57:25
import os
...
import PyQt4.QtGui as Widgets, sys, functools, random, scipy.optimize as optimize, scipy.fftpack as fftpack
from Labtools.templates import template_exp_standalone
import time, sys
from Labtools.customui_rc import *
import numpy as np, pyqtgraph as pg, pyqtgraph.opengl as gl, sys

class Experiment(QMainWindow, template_exp_standalone.Ui_MainWindow):
