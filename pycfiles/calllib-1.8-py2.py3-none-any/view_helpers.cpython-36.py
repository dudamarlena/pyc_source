...
# Embedded file name: /Users/Ari/src/callisto-core/callisto_core/wizard_builder/view_helpers.py
...
class StepsHelper(object):
    ...
    def url(self, step):
        return reverse((self.view.request.resolver_match.view_name),
          kwargs={'step': step})
...
class StorageHelper(object):
    ...
    def cleaned_form_data(self):
        ...
        return self.data_manager.get_zipped_data(data=(storage[self.storage_data_key]),
    ...
    def get_form_models(self, data=None):
        if not data:
            data = self.current_data_from_storage()
        return self.form_manager.get_form_models(form_data=(data[self.storage_form_key]),
    ...
    def current_data_from_storage(self):
        return {self.storage_data_key: self.session.get(self.storage_data_key, {}), 
