...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/metaimage/utils/openanything.py
# Compiled at: 2010-07-14 15:46:58
...
USER_AGENT = 'Test'
FETCH_RETRY_NUM = 5
FETCH_RETRY_DELAY = 1.2
FETCH_MAX_SIZE = 1048576
timeout = 5
