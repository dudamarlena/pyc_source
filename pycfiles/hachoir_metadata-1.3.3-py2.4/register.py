...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hachoir_metadata/register.py
# Compiled at: 2010-01-20 18:12:39
from hachoir_core.i18n import _
from hachoir_core.tools import humanDuration, humanBitRate, humanFrequency, humanBitSize, humanFilesize, humanDatetime
...
from hachoir_metadata.formatter import humanAudioChannel, humanFrameRate, humanComprRate, humanAltitude, humanPixelSize, humanDPI
from hachoir_metadata.setter import setDatetime, setTrackNumber, setTrackTotal, setLanguage
from hachoir_metadata.metadata_item import Data
MIN_SAMPLE_RATE = 1000
MAX_SAMPLE_RATE = 192000
MAX_NB_CHANNEL = 8
MAX_WIDTH = 20000
MAX_BIT_RATE = 500 * 1024 * 1024
MAX_HEIGHT = MAX_WIDTH
MAX_DPI_WIDTH = 10000
MAX_DPI_HEIGHT = MAX_DPI_WIDTH
MAX_NB_COLOR = 2 ** 24
MAX_BITS_PER_PIXEL = 256
MAX_FRAME_RATE = 150
MAX_NB_PAGE = 20000
...
def registerAllItems(meta):
    ...
    meta.register(Data('duration', 201, _('Duration'), type=timedelta, text_handler=humanDuration, filter=DURATION_FILTER))
    ...
    meta.register(Data('track_number', 205, _('Track number'), conversion=setTrackNumber, filter=NumberFilter(1, MAX_TRACK), type=(int, long)))
    meta.register(Data('track_total', 206, _('Track total'), conversion=setTrackTotal, filter=NumberFilter(1, MAX_TRACK), type=(int, long)))
    ...
    meta.register(Data('creation_date', 500, _('Creation date'), text_handler=humanDatetime, filter=DATETIME_FILTER, type=(datetime, date), conversion=setDatetime))
    meta.register(Data('last_modification', 501, _('Last modification'), text_handler=humanDatetime, filter=DATETIME_FILTER, type=(datetime, date), conversion=setDatetime))
    ...
    meta.register(Data('frame_rate', 603, _('Frame rate'), text_handler=humanFrameRate, filter=NumberFilter(1, MAX_FRAME_RATE), type=(int, long, float)))
    meta.register(Data('bit_rate', 604, _('Bit rate'), text_handler=humanBitRate, filter=NumberFilter(1, MAX_BIT_RATE), type=(int, long, float)))
