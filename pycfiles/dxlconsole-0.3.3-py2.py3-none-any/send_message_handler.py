...
# [GCC 8.4.0]
# Embedded file name: /opendxl/viji/opendxl-console/dxlconsole/modules/monitor/send_message_handler.py
# Compiled at: 2019-06-07 18:26:01
from __future__ import absolute_import
import traceback, logging, tornado
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            if 'payload' in request_params:
                ...
                message_payload = ''
            logger.debug('Sending ' + message_type + ' on topic ' + message_topic + ' with payload: ' + message_payload)
            message_id = None
            if message_type == 'Event':
                ...
                if 'serviceId' in request_params and request_params['serviceId'] is not None:
                    if request_params['serviceId'] != '':
            ...
            logger.error('Exception while processing send message request. %s', ex)
