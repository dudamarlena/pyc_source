...
# [GCC 8.4.0]
# Embedded file name: /Users/rstuart/.pyenv/versions/gcloudoem/lib/python2.7/site-packages/gcloudoem/django/gcloud_auth/models.py
...
__all__ = ('get_user_document', )
GCLOUDOEM_USER_ENTITY = getattr(settings, 'GCLOUDOEM_USER_DOCUMENT', 'gcloudoem.django.auth.User')
