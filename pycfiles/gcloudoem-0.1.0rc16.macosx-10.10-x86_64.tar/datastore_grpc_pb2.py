...
# [GCC 8.4.0]
# Embedded file name: /Users/rstuart/.pyenv/versions/gcloudoem/lib/python2.7/site-packages/gcloudoem/datastore/_generated/datastore_grpc_pb2.py
# Compiled at: 2016-10-03 23:56:38
...
class DatastoreStub(object):
  ...
  """
    ...
    """
        self.Lookup = channel.unary_unary('/google.datastore.v1.Datastore/Lookup', request_serializer=LookupRequest.SerializeToString, response_deserializer=LookupResponse.FromString)
        self.RunQuery = channel.unary_unary('/google.datastore.v1.Datastore/RunQuery', request_serializer=RunQueryRequest.SerializeToString, response_deserializer=RunQueryResponse.FromString)
        self.BeginTransaction = channel.unary_unary('/google.datastore.v1.Datastore/BeginTransaction', request_serializer=BeginTransactionRequest.SerializeToString, response_deserializer=BeginTransactionResponse.FromString)
        self.Commit = channel.unary_unary('/google.datastore.v1.Datastore/Commit', request_serializer=CommitRequest.SerializeToString, response_deserializer=CommitResponse.FromString)
        self.Rollback = channel.unary_unary('/google.datastore.v1.Datastore/Rollback', request_serializer=RollbackRequest.SerializeToString, response_deserializer=RollbackResponse.FromString)
        self.AllocateIds = channel.unary_unary('/google.datastore.v1.Datastore/AllocateIds', request_serializer=AllocateIdsRequest.SerializeToString, response_deserializer=AllocateIdsResponse.FromString)
...
def add_DatastoreServicer_to_server(servicer, server):
    rpc_method_handlers = {'Lookup': grpc.unary_unary_rpc_method_handler(servicer.Lookup, request_deserializer=LookupRequest.FromString, response_serializer=LookupResponse.SerializeToString), 
       'RunQuery': grpc.unary_unary_rpc_method_handler(servicer.RunQuery, request_deserializer=RunQueryRequest.FromString, response_serializer=RunQueryResponse.SerializeToString), 
       'BeginTransaction': grpc.unary_unary_rpc_method_handler(servicer.BeginTransaction, request_deserializer=BeginTransactionRequest.FromString, response_serializer=BeginTransactionResponse.SerializeToString), 
       'Commit': grpc.unary_unary_rpc_method_handler(servicer.Commit, request_deserializer=CommitRequest.FromString, response_serializer=CommitResponse.SerializeToString), 
       'Rollback': grpc.unary_unary_rpc_method_handler(servicer.Rollback, request_deserializer=RollbackRequest.FromString, response_serializer=RollbackResponse.SerializeToString), 
       'AllocateIds': grpc.unary_unary_rpc_method_handler(servicer.AllocateIds, request_deserializer=AllocateIdsRequest.FromString, response_serializer=AllocateIdsResponse.SerializeToString)}
    generic_handler = grpc.method_handlers_generic_handler('google.datastore.v1.Datastore', rpc_method_handlers)
...
def beta_create_Datastore_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    request_deserializers = {('google.datastore.v1.Datastore', 'AllocateIds'): AllocateIdsRequest.FromString, 
    ...
    response_serializers = {('google.datastore.v1.Datastore', 'AllocateIds'): AllocateIdsResponse.SerializeToString, 
    ...
    method_implementations = {('google.datastore.v1.Datastore', 'AllocateIds'): face_utilities.unary_unary_inline(servicer.AllocateIds), 
...
def beta_create_Datastore_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    request_serializers = {('google.datastore.v1.Datastore', 'AllocateIds'): AllocateIdsRequest.SerializeToString, 
    ...
    response_deserializers = {('google.datastore.v1.Datastore', 'AllocateIds'): AllocateIdsResponse.FromString, 
    ...
    cardinalities = {'AllocateIds': cardinality.Cardinality.UNARY_UNARY, 
