...
# [GCC 8.4.0]
# Embedded file name: /Users/rstuart/.pyenv/versions/gcloudoem/lib/python2.7/site-packages/gcloudoem/datastore/connection.py
# Compiled at: 2016-10-04 04:12:58
"""
...
class Connection(BaseConnection):
    ...
    def _request(self, method, data):
        ...
        while 1:
            if True:
                headers, content = self.http.request(uri=self.build_api_url(method=method), method='POST', headers=headers, body=data)
    ...
    def build_api_url(self, method, base_url=None, api_version=None):
        ...
        """
        return self.API_URL_TEMPLATE.format(api_base=base_url or self.api_base_url, api_version=api_version or self.API_VERSION, dataset_id=self.dataset, method=method)
    ...
    def lookup(self, key_pbs, eventual=False, transaction_id=None):
        ...
        return (
         results, missing, list(lookup_response.deferred))
    ...
    def run_query(self, query_pb, namespace=None, eventual=False, transaction_id=None):
        ...
        return ([ e.entity for e in response.batch.entity_results ],
