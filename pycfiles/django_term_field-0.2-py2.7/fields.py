...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ex/django/fields.py
# Compiled at: 2015-02-01 23:57:17
...
class EndDateTimeField(forms.SplitDateTimeField):
    ...
    def __init__(self, alt_time_value=DEFAULT_TIME_VALUE, input_date_formats=None, input_time_formats=None, *args, **kwargs):
        u"""終了日時を扱うためのフィールド。
        ...
        fields = (
         forms.DateField(input_formats=input_date_formats, error_messages={'invalid': errors['invalid_date']}, localize=localize, required=False),
         EndTimeField(alt_time_value=alt_time_value, input_formats=input_time_formats, error_messages={'invalid': errors['invalid_time']}, localize=localize, required=False))
