...
# Compiled at: 2020-04-21 05:52:10
# Size of source mod 2**32: 25522 bytes
...
import os, sys, uuid, json, urllib, pathlib, hashlib, logging, datetime, threading, boto3, botocore, requests
...
class HeadStat:
    ...
    def __repr__(self):
        values = ', '.join([f"{k}={getattr(self, k)}" for k in ('mtime', 'size', 'etag',
                                                                'type', 'meta')])
...
class KiwixStorage:
 ...
 L. 319         0  LOAD_FAST                'list_buckets'
 ...
 L. 320        16  LOAD_GLOBAL              ValueError
 ...
 L. 321        24  SETUP_FINALLY       148  'to 148'

 L. 322        26  LOAD_FAST                'list_buckets'
               28  POP_JUMP_IF_FALSE    38  'to 38'

 L. 323        30  LOAD_FAST                'self'
               32  LOAD_METHOD              test_access_list_buckets
               34  CALL_METHOD_0         0  ''
               36  POP_TOP          
             38_0  COME_FROM            28  '28'

 L. 325        38  LOAD_GLOBAL              isinstance
               40  LOAD_FAST                'bucket'
               42  LOAD_GLOBAL              str
             ...
             54_0  COME_FROM            50  '50'
               54  STORE_FAST               'bucket_name'

 L. 327        56  LOAD_FAST                'bucket'
               58  POP_JUMP_IF_FALSE    72  'to 72'

 L. 328        60  LOAD_FAST                'self'
               62  LOAD_ATTR                test_access_bucket
               64  LOAD_FAST                'bucket_name'
               66  LOAD_CONST               ('bucket_name',)
               68  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
               70  POP_TOP          
             72_0  COME_FROM            58  '58'

 L. 330        72  LOAD_FAST                'write'
               74  POP_JUMP_IF_FALSE   110  'to 110'

 L. 331        76  LOAD_FAST                'self'
               78  LOAD_ATTR                test_access_write

 L. 332        80  LOAD_GLOBAL              isinstance
               82  LOAD_FAST                'write'
               84  LOAD_GLOBAL              str
 ...
 L. 333        96  LOAD_FAST                'bucket_name'

 L. 334        98  LOAD_FAST                'read'
              100  LOAD_CONST               True
              102  COMPARE_OP               is

 L. 331       104  LOAD_CONST               ('key', 'bucket_name', 'check_read')
              106  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
              108  POP_TOP          
            110_0  COME_FROM            74  '74'

 L. 337       110  LOAD_FAST                'read'
 ...
 L. 338       126  LOAD_FAST                'self'
              128  LOAD_ATTR                test_access_read

 L. 339       130  LOAD_GLOBAL              str
              132  LOAD_FAST                'read'
              134  CALL_FUNCTION_1       1  ''

 L. 339       136  LOAD_FAST                'bucket_name'

 L. 338       138  LOAD_CONST               ('key', 'bucket_name')
              140  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              142  POP_TOP          
            144_0  COME_FROM           124  '124'
            144_1  COME_FROM           112  '112'
              144  POP_BLOCK        
              146  JUMP_FORWARD        210  'to 210'
            148_0  COME_FROM_FINALLY    24  '24'

 L. 341       148  DUP_TOP          
              150  LOAD_GLOBAL              AuthenticationError
              152  LOAD_FAST                'self'
              154  LOAD_ATTR                client
              156  LOAD_ATTR                exceptions
              158  LOAD_ATTR                NoSuchBucket
              160  BUILD_TUPLE_2         2 
 ...
 L. 342       174  LOAD_FAST                'failsafe'
              176  POP_JUMP_IF_FALSE   188  'to 188'

 L. 343       178  POP_BLOCK        
              180  POP_EXCEPT       
              182  CALL_FINALLY        196  'to 196'
              184  LOAD_CONST               False
              186  RETURN_VALUE     
            188_0  COME_FROM           176  '176'

 L. 344       188  LOAD_FAST                'exc'
            ...
            210_1  COME_FROM           146  '146'

 L. 345       210  LOAD_CONST               True
              212  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `POP_EXCEPT' instruction at offset 180
 ...
 L. 391        10  SETUP_FINALLY        28  'to 28'
 ...
 L. 393        28  DUP_TOP          
               ...
               42  STORE_FAST               'exc'
               44  POP_TOP          
               46  SETUP_FINALLY       110  'to 110'

 L. 394        48  LOAD_GLOBAL              int
               50  LOAD_FAST                'exc'
 ...
 L. 395        66  LOAD_FAST                'error_code'
               68  LOAD_CONST               403
               70  COMPARE_OP               ==
               72  POP_JUMP_IF_FALSE    88  'to 88'

 L. 396        74  LOAD_GLOBAL              AuthenticationError
 ...
 L. 398        96  POP_BLOCK        
            ...
            124_1  COME_FROM            26  '26'

 L. 399       124  LOAD_CONST               True
              126  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `POP_EXCEPT' instruction at offset 98
 ...
 L. 402         0  LOAD_FAST                'self'
                2  LOAD_METHOD              _bucket_name_param
                4  LOAD_FAST                'bucket_name'
                6  CALL_METHOD_1         1  ''
                8  STORE_FAST               'bucket_name'

 L. 403        10  SETUP_FINALLY        28  'to 28'

 L. 404        12  LOAD_FAST                'self'
 ...
 L. 407        66  LOAD_FAST                'error_code'
               68  LOAD_CONST               403
               70  COMPARE_OP               ==
               72  POP_JUMP_IF_FALSE    88  'to 88'

 L. 408        74  LOAD_GLOBAL              AuthenticationError
               76  LOAD_STR                 'Authorization Error testing key='
               78  LOAD_FAST                'key'
               80  FORMAT_VALUE          0  ''
               82  BUILD_STRING_2        2 
 ...
 L. 411       124  LOAD_FAST                'etag'
              126  LOAD_FAST                's3_etag'
              128  COMPARE_OP               ==
              130  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `POP_EXCEPT' instruction at offset 98
 ...
 L. 415        10  SETUP_FINALLY        38  'to 38'

 L. 416        12  LOAD_FAST                'self'
 ...
 L. 417        38  DUP_TOP          
               ...
               48  POP_JUMP_IF_FALSE   132  'to 132'
               50  POP_TOP          
               52  STORE_FAST               'exc'
               54  POP_TOP          
               56  SETUP_FINALLY       120  'to 120'

 L. 418        58  LOAD_GLOBAL              int
               60  LOAD_FAST                'exc'
 ...
 L. 419        76  LOAD_FAST                'error_code'
               78  LOAD_CONST               403
               80  COMPARE_OP               ==
               82  POP_JUMP_IF_FALSE    98  'to 98'

 L. 420        84  LOAD_GLOBAL              AuthenticationError
 ...
 L. 422       106  POP_BLOCK        
            ...
            132_0  COME_FROM            48  '48'
              132  END_FINALLY      
            134_0  COME_FROM           130  '130'
            134_1  COME_FROM            36  '36'

 L. 424       134  LOAD_FAST                'meta'
              136  LOAD_METHOD              get
              138  LOAD_FAST                'tag'
              140  CALL_METHOD_1         1  ''
              142  LOAD_FAST                'value'
    ...
    def validate_file_etag(cls, fpath: pathlib.Path, etag: str):
        ...
        def calc_etag(fpath, partsize):
            ...
            with open(fpath, 'rb') as (fh):
                for chunk in iter(lambda : fh.read(partsize), ''):
        ...
        def md5sum(fpath):
            digest = hashlib.md5()
            with open(fpath, 'rb') as (fh):
                for chunk in iter(lambda : fh.read(8388608), ''):
                    digest.update(chunk)
