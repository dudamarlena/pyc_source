...
# [GCC 8.4.0]
# Embedded file name: /home/joel/Workspace/docker-droplet/docker_droplet/terraform/template.py
# Compiled at: 2020-02-15 08:37:11
...
def create_config(droplet_name, ssh_key, project, domain) -> str:
    ...
    resources_config = resources_template.render(droplet_name=droplet_name,
      ssh_key=ssh_key,
      project=project,
      domain=domain)
