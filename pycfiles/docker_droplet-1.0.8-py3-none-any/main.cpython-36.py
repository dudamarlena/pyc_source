...
# [GCC 8.4.0]
# Embedded file name: /home/joel/Workspace/docker-droplet/docker_droplet/main.py
# Compiled at: 2020-02-15 05:48:49
...
def main() -> None:
    ...
    if arguments['up']:
        ...
        set_up(droplet_name.value, ssh_key.value, token.value, project.value, domain.value, config_path.value)
    if arguments['down']:
