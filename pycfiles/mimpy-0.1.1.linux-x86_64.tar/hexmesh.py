...
# [GCC 8.4.0]
# Embedded file name: /opt/apps/ossw/applications/python/python-2.7.11/c7/lib/python2.7/site-packages/mimpy/mesh/hexmesh.py
# Compiled at: 2016-03-31 16:42:47
from __future__ import absolute_import
import numpy as np, mimpy.mesh.mesh as mesh, mimpy.mesh.hexmesh_cython as hexmesh_cython
...
class HexMesh(mesh.Mesh):
    ...
    def _populate_face_areas(self):
        ...
        """
        hexmesh_cython.all_face_areas(self.faces.pointers, len(self.faces), self.faces.data, self.points, self.face_areas)
    ...
    def _populate_face_normals(self):
        ...
        """
        hexmesh_cython.all_face_normals(self.faces.pointers, len(self.faces), self.faces.data, self.points, self.face_normals)
    ...
    def build_mesh(self, ni, nj, nk, dim_x, dim_y, dim_z, K, modification_function=None):
