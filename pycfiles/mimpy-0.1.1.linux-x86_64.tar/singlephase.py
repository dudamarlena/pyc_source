...
# [GCC 8.4.0]
# Embedded file name: /opt/apps/ossw/applications/python/python-2.7.11/c7/lib/python2.7/site-packages/mimpy/models/singlephase.py
...
import itertools, mimpy.mfd.mfd as mfd
from six.moves import range

class SinglePhase:
    r""" The class relies on the Mesh and MFD libraries
    ...
    def start_solving(self):
        ...
        for time_step in range(1, self.number_of_time_steps + 1):
            ...
            for cell_index in range(self.mesh.get_number_of_cells()):
                ...
                rhs_current[(self.mfd.flux_dof + cell_index)] += c_entry * self.current_pressure[cell_index]
                self.lhs_coo.data[self.c_start + cell_index] = c_entry

            for index, cell_index in enumerate(self.rate_wells):
                rhs_current[(self.mfd.flux_dof + cell_index)] += self.rate_wells_rate[index]
