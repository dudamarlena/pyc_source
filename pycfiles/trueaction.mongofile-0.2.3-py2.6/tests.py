...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/trueaction/mongofile/tests.py
# Compiled at: 2012-07-02 00:15:37
"""
tests.py
...
CSV_DATA = (
 ('2012-07-02T04:02:48+00:00', '', '', 'cs_svanbrug', '100000238', '53', '1113', '',
 '', '', '', 'Webstore', '', '1.0', '599.99', '6.66666666667', '49.5', '599.99',
 '', '', ''),
 ('2012-07-02T04:02:48+00:00', '', '', 'cs_svanbrug', '100000238', '51', '1111', '',
 '', '', '', 'Webstore', '', '2.0', '599.98', '6.66666666667', '49.5', '599.98',
 '', '', ''),
 ('2012-07-02T04:02:48+00:00', '', '', 'cs_svanbrug', '100000238', '52', '1112', '',
 '', '', '', 'Webstore', '', '1.0', '129.99', '6.66666666667', '10.72', '129.99',
 '', '', ''))
DB_ARGS = {'collection_name': 'test', 
   'db_name': 'test'}
...
class MongoFileTest(TestCase):
    ...
    def setUp(self):
        ...
        chdir(self.tmp_dir)
        MongoFile('empty', mode='w', **DB_ARGS).close()
        with MongoFile('full', mode='w', **DB_ARGS) as (full):
            full.write(DATA)
        open('empty', mode='w').close()
