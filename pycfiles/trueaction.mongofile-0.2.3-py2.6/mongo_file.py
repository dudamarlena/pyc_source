...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/trueaction/mongofile/mongo_file.py
# Compiled at: 2012-07-02 00:36:38
"""
file.py
...
def rename(old_name, new_name, collection_name, db_name='', connection_args=None):
    ...
    db_name = valid_name(db_name, connection_args)
    with closing(Connection(**connection_args)) as (conn):
        conn[db_name][collection_name].update(spec={'name': old_name}, document={'$set': {'name': new_name}}, multi=True)
