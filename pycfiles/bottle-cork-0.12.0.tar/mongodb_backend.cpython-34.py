...
class MongoTable(Table):
    __doc__ = 'Abstract MongoDB Table.\n    Allow dictionary-like access.\n    '
...
class MongoSingleValueTable(MongoTable):
    __doc__ = 'MongoDB table accessible as a simple key -> value dictionary.\n    Used to store roles.\n    '
...
class MongoMutableDict(dict):
    __doc__ = 'Represent an item from a Table. Acts as a dictionary.\n    '
...
class MongoMultiValueTable(MongoTable):
    __doc__ = 'MongoDB table accessible as a dictionary.\n    '
