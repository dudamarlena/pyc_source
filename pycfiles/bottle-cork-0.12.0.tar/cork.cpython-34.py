...
# Size of source mod 2**32: 33686 bytes
...
class AAAException(Exception):
    __doc__ = 'Generic Authentication/Authorization Exception'


class AuthException(AAAException):
    __doc__ = 'Authentication Exception: incorrect username/password pair'


class BaseCork(object):
    __doc__ = 'Abstract class'
    ...
    def reset_password(self, reset_code, password):
        ...
        try:
            ...
            assert isinstance(email_addr, type(''))
