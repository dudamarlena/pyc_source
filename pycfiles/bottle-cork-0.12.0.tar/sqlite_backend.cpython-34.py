...
# [GCC 8.4.0]
# Embedded file name: /home/fede/newhome/projects/bottle-cork/tests/cork/sqlite_backend.py
# Compiled at: 2015-07-17 17:30:22
...
class Table(base_backend.Table):
    ...
    def __setitem__(self, key, value):
        ...
        col_values = [
         key] + [value[k] for k in self._column_names[1:]]
...
class SQLiteBackend(base_backend.Backend):
    ...
    def __init__(self, filename, users_tname='users', roles_tname='roles', pending_reg_tname='register', initialize=False):
