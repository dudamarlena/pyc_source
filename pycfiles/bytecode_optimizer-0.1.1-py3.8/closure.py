...
def scan_for_STORE(func, name):
    for i in func.func_code.co_code:
        if i.__class__ in [STORE_FAST, STORE_NAME, STORE_GLOBAL] and i.name == name:
            return 1
