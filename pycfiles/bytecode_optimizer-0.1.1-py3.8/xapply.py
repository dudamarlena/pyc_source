...
cannot be bound (this may change). """
    ...
    if not callable(func):
        ...
        if func_type is types.FunctionType:
            ...
            if func_type is types.UnboundMethodType:
                return _xapply_meth(func, args, kw)
            if func_type is types.InstanceType:
