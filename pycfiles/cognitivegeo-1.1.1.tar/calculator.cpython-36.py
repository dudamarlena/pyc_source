...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\calculator.py
# Compiled at: 2019-12-15 18:54:42
# Size of source mod 2**32: 7067 bytes
...
class calculator(object):
    ...
    def clickBtnApply(self):
        ...
        if type(self.data) is not np.ndarray or np.shape(self.data)[0] < 1:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, 'Calculator', 'No NumPy data added into calculator')
            return
        if self.cbboperator.currentIndex() < 4:
            ...
            if _value is False:
                ...
                QtWidgets.QMessageBox.critical(self.msgbox, 'Calculator', 'Non-float value')
                return
