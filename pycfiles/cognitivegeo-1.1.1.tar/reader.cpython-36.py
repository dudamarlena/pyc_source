...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\segpy\reader.py
# Compiled at: 2019-12-13 22:18:27
# Size of source mod 2**32: 25878 bytes
from __future__ import print_function
import os, sys
sys.path.append(os.path.dirname(__file__)[:-6][:-4][:-13])
from cognitivegeo.src.segpy.encoding import ASCII
from cognitivegeo.src.segpy.packer import HeaderPacker
from cognitivegeo.src.segpy.trace_header import TraceHeaderRev1
from cognitivegeo.src.segpy.util import file_length, filename_from_handle
from cognitivegeo.src.segpy.datatypes import DATA_SAMPLE_FORMAT_TO_SEG_Y_TYPE, SEG_Y_TYPE_DESCRIPTION, SEG_Y_TYPE_TO_CTYPE, size_in_bytes
from cognitivegeo.src.segpy.toolkit import extract_revision, bytes_per_sample, read_binary_reel_header, read_trace_header, catalog_traces, read_binary_values, REEL_HEADER_NUM_BYTES, TRACE_HEADER_NUM_BYTES, read_textual_reel_header, read_extended_textual_headers, guess_textual_header_encoding
