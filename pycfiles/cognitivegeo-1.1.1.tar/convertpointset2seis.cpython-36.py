...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\convertpointset2seis.py
# Compiled at: 2020-01-04 15:56:14
# Size of source mod 2**32: 12985 bytes
...
class convertpointset2seis(object):
    ...
    def clickBtnApply(self):
        ...
        if basic_data.str2float(self.ldtvalue.text()) is False:
            vis_msg.print('ERROR in ConvertPointSet2Seis: Non-float undefined value', type='error')
            QtWidgets.QMessageBox.critical(self.msgbox, 'Convert PointSet to Seismic', 'Non-float undefined value')
            return
