...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\managesurvey.py
...
from cognitivegeo.src.gui.editsurvey import editsurvey as gui_editsurvey
from cognitivegeo.src.gui.cropsurvey import cropsurvey as gui_cropsurvey
...
class managesurvey(object):
    ...
    def setupGUI(self, ManageSurvey):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/crop.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
