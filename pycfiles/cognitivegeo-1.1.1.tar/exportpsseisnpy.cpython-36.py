...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\exportpsseisnpy.py
# Compiled at: 2019-12-15 21:49:30
# Size of source mod 2**32: 9251 bytes
...
class exportpsseisnpy(object):
    ...
    def clickBtnExportPsSeisNpy(self):
        ...
        if self.cbbtype.currentIndex() == 1:
            reply = QtWidgets.QMessageBox.question(self.msgbox, 'Export Pre-stack Seismic Numpy', 'Warning: shots separately saved as numpy matrix & shot information lost. Continue?', QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No, QtWidgets.QMessageBox.No)
            if reply == QtWidgets.QMessageBox.No:
                return
