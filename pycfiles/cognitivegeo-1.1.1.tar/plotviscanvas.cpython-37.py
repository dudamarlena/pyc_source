...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\plotviscanvas.py
# Compiled at: 2020-01-04 15:56:14
# Size of source mod 2**32: 36205 bytes
...
import cognitivegeo.src.gui.configseisvis as gui_configseisvis
...
class plotviscanvas(object):
    ...
    def retranslateGUI(self, PlotVisCanvas):
        ...
        self.canvas = scene.SceneCanvas(keys='interactive', title='Canvas', bgcolor=[0.5, 0.5, 0.5], size=(1080,
                                                                                                           920),
          app='pyqt5',
    ...
    def clickBtnAddSeis2Canvas(self):
        if len(self.seisdata.keys()) > 0:
            if self.checkSeisData(list(self.seisdata.keys())[self.cbblistseis.currentIndex()]):
                _seis = {}
                _seis['Visible'] = False
