...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\settingsgui.py
# Compiled at: 2019-12-13 23:25:59
# Size of source mod 2**32: 7405 bytes
...
class settingsgui(object):
    ...
    def retranslateGUI(self, SettingsGUI):
        ...
        SettingsGUI.setWindowTitle(_translate('SettingsGUI', 'Interface Settings'))
    ...
    def changeCbxToolbarLeft(self):
        ...
        if self.mainwindow is None:
            QtWidgets.QMessageBox.critical(self.msgbox, 'GeoPy', 'No GeoPy found')
            return
        elif self.cbxtoolbarleft.isChecked():
    ...
    def changeCbxToolbarRight(self):
        ...
        if self.mainwindow is None:
            QtWidgets.QMessageBox.critical(self.msgbox, 'GeoPy', 'No GeoPy found')
            return
        elif self.cbxtoolbarright.isChecked():
    ...
    def changeCbxToolbarTop(self):
        ...
        if self.mainwindow is None:
            QtWidgets.QMessageBox.critical(self.msgbox, 'GeoPy', 'No GeoPy found')
            return
        elif self.cbxtoolbartop.isChecked():
    ...
    def changeCbxToolbarBottom(self):
        ...
        if self.mainwindow is None:
            QtWidgets.QMessageBox.critical(self.msgbox, 'GeoPy', 'No GeoPy found')
            return
        elif self.cbxtoolbarbottom.isChecked():
