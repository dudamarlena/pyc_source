...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\settingsvisual.py
...
class settingsvisual(object):
    ...
    def setupGUI(self, SettingsVisual):
        ...
        SettingsVisual.setFixedSize(840, 320)
        icon = QtGui.QIcon()
        ...
        self.btnapply.setGeometry(QtCore.QRect(370, 270, 100, 30))
        icon = QtGui.QIcon()
    ...
    def retranslateGUI(self, SettingsVisual):
        ...
        for _i in range(len(vis_font.FontColorList)):
            self.cbbfontcolor.setItemIcon(_i, QtGui.QIcon(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/color_' + vis_font.FontColorList[_i] + '.png')).scaled(80, 40)))
        ...
        for _i in range(len(vis_line.LineColorList)):
            self.cbblinecolor.setItemIcon(_i, QtGui.QIcon(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/color_' + vis_line.LineColorList[_i] + '.png')).scaled(80, 40)))
        ...
        for _i in range(len(vis_line.LineStyleList)):
            self.cbblinestyle.setItemIcon(_i, QtGui.QIcon(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/line_' + vis_line.LineStyleList[_i] + '.png')).scaled(80, 40)))
        ...
        for _i in range(len(vis_cmap.ColorMapList)):
            self.cbbcmap.setItemIcon(_i, QtGui.QIcon(QtGui.QPixmap(os.path.join(self.iconpath, 'icons/cmap_' + vis_cmap.ColorMapList[_i] + '.png')).scaled(80, 40)))
