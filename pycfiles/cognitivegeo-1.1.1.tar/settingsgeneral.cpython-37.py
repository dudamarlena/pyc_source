...
# [GCC 8.4.0]
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\settingsgeneral.py
# Compiled at: 2019-12-13 23:26:00
# Size of source mod 2**32: 4107 bytes
...
class settingsgeneral(object):
    ...
    def clickBtnRootpath(self):
        ...
        _file = _dialog.getExistingDirectory(None, 'Select Root Path', (self.settings['RootPath']), options=(QtWidgets.QFileDialog.DontUseNativeDialog))
        if len(_file) > 0:
