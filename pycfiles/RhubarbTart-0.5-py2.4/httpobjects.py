...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/rhubarbtart/httpobjects.py
# Compiled at: 2006-02-01 21:20:48
...
class Request(object):
    ...
    def request_line__get(self):
        return '%(REQUEST_METHOD)s %(SCRIPT_NAME)s%(PATH_INFO)s %(SERVER_PROTOCOL)s' % self.environ
