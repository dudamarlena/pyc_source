...
# Embedded file name: C:\Users\dsx.AD3\Code\amaptor\amaptor\classes\map.py
# Compiled at: 2017-03-17 20:49:53
...
class Map(object):
    ...
    def set_extent(self, extent_object, set_frame='ALL', add_buffer=True):
        """
                ...
                """
        if add_buffer:
            x_buf = (extent_object.XMax - extent_object.XMin) * 0.05
            y_buf = (extent_object.YMax - extent_object.YMin) * 0.05
