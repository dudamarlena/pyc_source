...
# Embedded file name: C:\Users\dsx\Code\amaptor\amaptor\classes\project.py
# Compiled at: 2017-06-27 18:47:23
# Size of source mod 2**32: 15040 bytes
import os, logging
...
class Project(object):
    ...
    def new_map(self, name, template_map=os.path.join(_TEMPLATES, 'arcmap', 'pro_import_map_template.mxd'), template_df_name='_rename_template_amaptor'):
        ...
        for l_map in self.primary_document.listMaps():
            ...
            raise MapNotFoundError(template_df_name, 'Map was inserted, but could not be found after insertion. If you provided a customtemplate, check that the name you provided for template_df_name matches the name of the data frame you want to use from the map document.')
