...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sensirionbt/smartgadget.py
# Compiled at: 2019-07-11 16:37:24
# Size of source mod 2**32: 3415 bytes
import logging, struct
from .connection import BTLEConnection
from .constants import SHT3X_TEMPERATURE_NOTIFICATIONS_UUID, SHT3X_HUMIDITY_NOTIFICATIONS_UUID, BATTERY_LEVEL_CHARACTERISTIC_UUID, MANUFACTURER_NAME_CHARACTERISTIC_UUID, MODEL_NUMBER_CHARACTERISTIC_UUID, FIRMWARE_REVISION_CHARACTERISTIC_UUID
...
class SmartGadget:
    ...
    def get_values(self, init_static=False, round_digits=2) -> dict:
        ...
        return {'temperature':round(temperature, round_digits),  'humidity':round(humidity, round_digits), 
