...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.4/dist-packages/pynetics/ga_bin.py
# Compiled at: 2016-03-13 14:10:59
...
class BinaryIndividualSpawningPool(SpawningPool):
    __doc__ = ' Defines the methods for creating binary individuals. '
    ...
    def create(self):
        ...
        individual.genes = array('B', [random.getrandbits(1) for _ in range(self.individual_size)])
        return individual


class MomentOfInertia(Diversity):
    __doc__ = ' A diversity implementation based on centroids and inertia.\n\n    Extracted from paper "Measurement of Population Diversity" of R.W. Morrison\n    et. al.\n    '
...
class AverageHamming(Diversity):
    __doc__ = ' Diversity implementation of the average of each hamming loci distances.\n\n    Predicting Convergence Time for Genetic Algorithms Sushil J. Louis and\n    Gregory J. E. Rawlins\n    '
...
class BinaryIndividual(Individual, abc.MutableSequence):
    __doc__ = ' An individual represented by a binary chromosome. '
