...
class BestIndividual(Selection):
    __doc__ = ' Selects the best individuals among the population. '
...
class ProportionalToPosition(Selection):
    __doc__ = ' Selects individuals randomly proportionally to their position. '
...
class Tournament(Selection):
    __doc__ = ' Selects best individuals of a random sample of the whole population. '
...
class Uniform(Selection):
    __doc__ = ' Selects individuals randomly from the population. '
