...
# [GCC 8.4.0]
# Embedded file name: /home/ake/projects/python/lingua-franca/lingua_franca/lang/format_sv.py
# Compiled at: 2019-12-13 05:19:40
...
def pronounce_ordinal_sv(num):
    ordinals = [
     'noll', 'första', 'andra', 'tredje', 'fjärde', 'femte',
            ...
            if dt.minute != 5:
                ...
                if dt.minute > 30:
                    ...
                    if dt.minute == 1:
                        ...
                        if dt.minute != 50 and dt.minute != 55 and dt.minute != 45:
                            speak += ' minuter i '
                        else:
                            speak += ' i '
                    hour = (hour + 1) % 12
        ...
        if word[-1:] == '.':
            if word[:-1].isdecimal():
                if wordNext.lower() in months:
                    ...
                    if wordPrev.lower() in ('om', 'den', 'från', 'till', '(från', '(om',
                                            'till'):
                        word += 'n'
                    else:
