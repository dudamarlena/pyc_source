...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0008_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('vkontakte_photos_photo_like_users', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'photo', models.ForeignKey(orm['vkontakte_photos.photo'], null=False)),
         (
          'user', models.ForeignKey(orm['vkontakte_users.user'], null=False))))
        db.create_unique('vkontakte_photos_photo_like_users', ['photo_id', 'user_id'])

    def backwards(self, orm):
        db.delete_table('vkontakte_photos_photo_like_users')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_photos.photo': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Photo'}, 'album': (
                                  ...
                                  'id': (
                                       'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                  'like_users': (
                                               'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'like_photos'", 'blank': 'True', 'to': "orm['vkontakte_users.User']"}), 
                                  'likes': (
                                          'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                  'owner': (
