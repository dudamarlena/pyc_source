...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0012_auto__chg_field_album_created.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('vkontakte_photos_album', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Album.created' and its values cannot be restored.")
        db.alter_column('vkontakte_photos_album', 'created', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_photos.comment': {'Meta': {'object_name': 'Comment'}, 'archived': (
                                    ...
                                    'text': (
                                           'django.db.models.fields.TextField', [], {})}, 
       'vkontakte_photos.photo': {'Meta': {'object_name': 'Photo'}, 'album': (
