...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0009_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('vkontakte_photos_album', ['updated'])
        db.create_index('vkontakte_photos_album', ['created'])
        db.create_index('vkontakte_photos_photo', ['created'])

    def backwards(self, orm):
        db.delete_index('vkontakte_photos_photo', ['created'])
        db.delete_index('vkontakte_photos_album', ['created'])
        db.delete_index('vkontakte_photos_album', ['updated'])
