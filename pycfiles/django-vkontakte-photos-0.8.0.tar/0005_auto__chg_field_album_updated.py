...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0005_auto__chg_field_album_updated.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('vkontakte_photos_album', 'updated', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        db.alter_column('vkontakte_photos_album', 'updated', self.gf('django.db.models.fields.DateTimeField')(default=None))
        return
