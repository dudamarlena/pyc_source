...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0007_auto__chg_field_photo_user.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('vkontakte_photos_photo', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vkontakte_users.User']))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Photo.user' and its values cannot be restored.")
