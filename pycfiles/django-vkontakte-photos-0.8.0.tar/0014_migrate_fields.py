...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0014_migrate_fields.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute('UPDATE vkontakte_photos_photo SET likes_count = likes;')
        cursor.execute('UPDATE vkontakte_photos_photo SET comments_count = comments;')
        cursor.execute('UPDATE vkontakte_photos_photo SET tags_count = tags;')
        cursor.execute('UPDATE vkontakte_photos_photo SET actions_count = likes_count + comments_count;')
