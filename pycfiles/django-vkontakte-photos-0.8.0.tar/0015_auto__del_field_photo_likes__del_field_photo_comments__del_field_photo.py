...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0015_auto__del_field_photo_likes__del_field_photo_comments__del_field_photo.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('vkontakte_photos_photo', 'likes')
        db.delete_column('vkontakte_photos_photo', 'comments')
        db.delete_column('vkontakte_photos_photo', 'tags')

    def backwards(self, orm):
        db.add_column('vkontakte_photos_photo', 'likes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
        db.add_column('vkontakte_photos_photo', 'comments', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
        db.add_column('vkontakte_photos_photo', 'tags', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_photos.comment': {'Meta': {'object_name': 'Comment'}, 'archived': (
                                    ...
                                    'id': (
                                         'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                    'photo': (
                                            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': "orm['vkontakte_photos.Photo']"}), 
                                    'remote_id': (
                                                'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': "'20'"}), 
                                    'text': (
                                           'django.db.models.fields.TextField', [], {})}, 
