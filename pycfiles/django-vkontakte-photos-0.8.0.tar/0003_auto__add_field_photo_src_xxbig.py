...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0003_auto__add_field_photo_src_xxbig.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_photos_photo', 'src_xxbig', self.gf('django.db.models.fields.CharField')(default='', max_length='200'), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_photos_photo', 'src_xxbig')
