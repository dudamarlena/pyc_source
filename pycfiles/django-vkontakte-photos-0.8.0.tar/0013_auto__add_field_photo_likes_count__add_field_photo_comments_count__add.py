...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0013_auto__add_field_photo_likes_count__add_field_photo_comments_count__add.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_photos_photo', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
        db.add_column('vkontakte_photos_photo', 'comments_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
        db.add_column('vkontakte_photos_photo', 'actions_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
        db.add_column('vkontakte_photos_photo', 'tags_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_photos_photo', 'likes_count')
        db.delete_column('vkontakte_photos_photo', 'comments_count')
        db.delete_column('vkontakte_photos_photo', 'actions_count')
        db.delete_column('vkontakte_photos_photo', 'tags_count')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'vkontakte_groups.group': {'Meta': {'object_name': 'Group'}, 'fetched': (
       ...
       'vkontakte_photos.album': {'Meta': {'object_name': 'Album'}, 'created': (
                                  ...
                                  'updated': (
                                            'django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'})}, 
       'vkontakte_photos.comment': {'Meta': {'object_name': 'Comment'}, 'archived': (
                                               'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                    'author_content_type': (
                                                          'django.db.models.fields.related.ForeignKey', [], {'related_name': "'photo_comments'", 'to': "orm['contenttypes.ContentType']"}), 
                                    'author_id': (
                                    ...
                                    'id': (
                                         'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                    'photo': (
                                            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'wall_comments'", 'to': "orm['vkontakte_photos.Photo']"}), 
                                    'remote_id': (
                                                'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': "'20'"}), 
                                    'text': (
                                           'django.db.models.fields.TextField', [], {})}, 
       'vkontakte_photos.photo': {'Meta': {'object_name': 'Photo'}, 'actions_count': (
                                  ...
                                  'id': (
                                       'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                  'like_users': (
                                               'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'like_photos'", 'symmetrical': 'False', 'to': "orm['vkontakte_users.User']"}), 
                                  'likes': (
                                          'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                  'likes_count': (
                                                'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                  ...
                                  'text': (
                                         'django.db.models.fields.TextField', [], {}), 
                                  'user': (
                                         'django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos_author'", 'null': 'True', 'to': "orm['vkontakte_users.User']"}), 
                                  'width': (
                                          'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})}, 
       ...
       'vkontakte_wall.post': {'Meta': {'object_name': 'Post'}, 'archived': (
                               ...
                               'reply_count': (
                                             'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                               'repost_users': (
                                              'm2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'repost_posts'", 'symmetrical': 'False', 'to': "orm['vkontakte_users.User']"}), 
                               'reposts': (
                                         'django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_index': 'True'}), 
                               'signer_id': (
                                           'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
