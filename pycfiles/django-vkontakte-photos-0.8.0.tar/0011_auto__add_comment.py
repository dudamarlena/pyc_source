...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-photos/vkontakte_photos/migrations/0011_auto__add_comment.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('vkontakte_photos_comment', (
         (
         ...
         (
          'photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wall_comments', to=orm['vkontakte_photos.Photo'])),
         (
        ...
        db.send_create_signal('vkontakte_photos', ['Comment'])

    def backwards(self, orm):
        db.delete_table('vkontakte_photos_comment')
