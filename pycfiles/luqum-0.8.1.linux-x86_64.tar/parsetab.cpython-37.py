...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/dist-packages/luqum/parsetab.py
# Compiled at: 2018-03-14 18:15:12
...
_lr_goto_items = {'expression':(
  [
   0, 1, 6, 11, 12, 13, 18, 25, 26], [1, 11, 18, 11, 25, 26, 11, 11, 11]), 
 'unary_expression':([0, 1, 3, 4, 5, 6, 11, 12, 13, 18, 22, 25, 26], [2, 2, 15, 16, 17, 2, 2, 2, 2, 2, 29, 2, 2]),  'phrase_or_term':([7, 28], [19, 30])}
_lr_goto = {}
...
_lr_productions = [
 ...
 ('expression -> expression OR_OP expression', 'expression', 3, 'p_expression_or', 'parser.py',
 155),
 ('expression -> expression AND_OP expression', 'expression', 3, 'p_expression_and',
 'parser.py', 160),
 ('expression -> expression expression', 'expression', 2, 'p_expression_implicit', 'parser.py',
 165),
 ('unary_expression -> PLUS unary_expression', 'unary_expression', 2, 'p_expression_plus',
 'parser.py', 170),
 ('unary_expression -> MINUS unary_expression', 'unary_expression', 2, 'p_expression_minus',
 'parser.py', 175),
 ('unary_expression -> NOT unary_expression', 'unary_expression', 2, 'p_expression_not',
 'parser.py', 180),
 ('expression -> unary_expression', 'expression', 1, 'p_expression_unary', 'parser.py',
 185),
 ('unary_expression -> LPAREN expression RPAREN', 'unary_expression', 3, 'p_grouping',
 'parser.py', 190),
 ('unary_expression -> LBRACKET phrase_or_term TO phrase_or_term RBRACKET', 'unary_expression',
 5, 'p_range', 'parser.py', 195),
 ('unary_expression -> TERM COLUMN unary_expression', 'unary_expression', 3, 'p_field_search',
 'parser.py', 202),
 ('unary_expression -> PHRASE', 'unary_expression', 1, 'p_quoting', 'parser.py', 210),
 ('unary_expression -> PHRASE APPROX', 'unary_expression', 2, 'p_proximity', 'parser.py',
 215),
 ...
 ('unary_expression -> TERM APPROX', 'unary_expression', 2, 'p_fuzzy', 'parser.py',
 230),
 ...
 ('phrase_or_term -> PHRASE', 'phrase_or_term', 1, 'p_phrase_or_term', 'parser.py',
 242)]