...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/flask-pilot/pylot/__init__.py
# Compiled at: 2015-05-19 23:44:48
"""
Pylot
...
from flask import Flask, abort, redirect, request, render_template, flash, url_for, jsonify, session
from flask_assets import Environment
import utils, pkginfo
NAME = pkginfo.NAME
...
class Pylot(FlaskView):
    ...
    def bind(cls, kls):
        ...
        if not hasattr(kls, '__call__'):
            raise TypeError("From Pylot.bind: '%s' is not callable" % kls)
        cls._bind.add(kls)
        return kls
    ...
    def set_meta__(cls, **kwargs):
        ...
        for k, v in kwargs.items():
            if (k.endswith('__prepend') or k.endswith('__append')) and isinstance(v, str):
