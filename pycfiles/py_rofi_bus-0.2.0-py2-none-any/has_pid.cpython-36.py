...
# [GCC 8.4.0]
# Embedded file name: /home/cjharries/Code/@wizardsoftheweb/py-rofi-bus/py_rofi_bus/components/mixins/has_pid.py
...
class HasPid(HasConfig):
    ...
    def get_pid_file_name(self):
        return join(self.config.config_dir, self.config['pid_folder'] if self.pid_name else '', '{}.pid'.format(self.pid_name))
