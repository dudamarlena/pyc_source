...
# [GCC 8.4.0]
# Embedded file name: /home/cjharries/Code/@wizardsoftheweb/py-rofi-bus/py_rofi_bus/components/script.py
...
class Script(object):
    ...
    def bootstrap(cls, process_args=None, *args, **kwargs):
        ...
        (script.parse_args)(args, process_args=loaded_args, **kwargs)
