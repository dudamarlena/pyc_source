...
# [GCC 8.4.0]
# Embedded file name: /Users/erwin/Django/iprir/iprir/management/commands/loadregistry.py
# Compiled at: 2015-06-19 06:11:13
...
def build_inetnum():
    teller = 0
    ipBlocks = get_ipblocks()
    for ipLine in ipBlocks:
        try:
            tmp_registry, tmp_country, tmp_protocol, tmp_ipstart, tmp_iprange, _, tmp_status = ipLine.split('|', 6)
