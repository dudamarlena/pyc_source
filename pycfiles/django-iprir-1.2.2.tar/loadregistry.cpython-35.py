...
# [GCC 8.4.0]
# Embedded file name: /Users/erwin/Django/jingoloba/iprir/management/commands/loadregistry.py
# Compiled at: 2016-12-28 04:42:50
...
def build_inetnum():
    ...
    for ip_line in ip_blocks:
        try:
            tmp_registry, tmp_country, tmp_protocol, tmp_ipstart, tmp_iprange, _, tmp_status = ip_line.split('|', 6)
            if tmp_protocol == 'ipv4':
                ...
                if tld.pk and registry.pk and tld.registry_id != registry.pk:
