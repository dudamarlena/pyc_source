...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/draftsdeobfuscator/__init__.py
# Compiled at: 2017-09-05 01:09:35
import boto3, sys
from datetime import datetime
from datetime import timedelta
import json, argparse, os, math, draftsutils
...
def main():
    ...
    for region in regions:
        ...
        for instance_type in instance_types:
            ...
            params = {'EndTime': month_ago_string, 'StartTime': month_ago_minus_hour_string, 'InstanceTypes': [
                               instance_type], 
