...
# [GCC 8.4.0]
# Embedded file name: C:\Users\esuka\PycharmProjects\HeurisPy\heurispy\heuristicas\busqueda_armonica.py
# Compiled at: 2019-10-11 09:23:09
# Size of source mod 2**32: 11672 bytes
"""
...
class BusquedaArmonica(Heuristica):
    ...
    def __init__(self, problema_optimizacion, max_iteraciones=1000000):
        super().__init__(problema_optimizacion, lista_nombres_parametros=[
         'espacio_memoria', 'max_busqueda_sin_mejoras',
        ...
        def modifica_memoria_armonica(memoria_armonica, f_memoria_armonica, solucion, busqueda_sin_mejora, contador_iteraciones):
            f = self.funcion_objetivo
            ...
            return (
             memoria_armonica, f_memoria_armonica, busqueda_sin_mejora, iteracion_mejor_sol)
        ...
        def busqueda_armonica(parametros):
            ...
            if self.comprobar_parametros(parametros):
                ...
                while busquedas_sin_mejora < max_busqueda_sin_mejoras and contador_iteraciones < max_iteraciones:
                    nueva_solucion = obten_nueva_sol(memoria_armonica_actual, rcma_actual, raa_actual)
                    memoria_armonica_actual, f_memoria_armonica_actual, busquedas_sin_mejora, valor_iter = modifica_memoria_arm(memoria_armonica_actual, f_memoria_armonica_actual, nueva_solucion, busquedas_sin_mejora, contador_iteraciones)
                    if valor_iter is not None:
                        iteracion_mejor_sol = valor_iter
                    contador_iteraciones = contador_iteraciones + 1
                    dataframe_resultados = dataframe_resultados.append(dict(iter=contador_iteraciones, f_sol=(f(obten_solucion_minima(memoria_armonica_actual, f_memoria_armonica_actual)))),
                      ignore_index=True)
                ...
                resultados_finales = dict(mejor_solucion=mejor_solucion, f_mejor_solucion=(f(mejor_solucion)),
        ...
        def genera_pdf_final(recolector_resultados, ruta, fecha_hora):
            ...
            for parametro in recolector_resultados.diccionario_mejores_f.keys():
                ...
                pdf.guardar_grafica(titulo_grafica='Recorridos de la función objetivo', nombre_parametro='f_sol', funcion_ayudante_grafico=(ayudante_graficas.crear_grafica_parametro))
                pdf.guardar_grafica(titulo_grafica='Mejores soluciones por recorrido', nombre_parametro='f_sol', funcion_ayudante_grafico=(ayudante_graficas.crear_grafica_mejores_f))
                pdf.guardar_grafica(titulo_grafica='Promedio de los recorridos de la función objetivo', nombre_parametro='f_sol',
        ...
        self.funciones_utilizadas_pdf = [
         'solucion_minima', 'solucion_maxima', 'calcula_media', 'calcula_desv_estandar',
         'calcula_desv_minima']