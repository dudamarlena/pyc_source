...
# [GCC 8.4.0]
# Embedded file name: C:\Users\esuka\PycharmProjects\HeurisPy\heurispy\heuristicas\recocido_simulado.py
# Compiled at: 2019-11-11 19:01:06
# Size of source mod 2**32: 10046 bytes
"""
...
class RecocidoSimulado(Heuristica):
    ...
    def __init__(self, problema_optimizacion, alpha=0.9, eps=0.01, max_iteraciones=1000000):
        super().__init__(problema_optimizacion, lista_nombres_parametros=[
         'temperatura', 'iteraciones_inyeccion_temperatura',
        ...
        def busqueda_recocido(parametros):
            ...
            if self.comprobar_parametros(parametros):
                ...
                while temperatura > self.eps and cantidad_inyecciones_temperatura < maximo_inyecciones_temperatura and contador_iteraciones < maximo_iteraciones:
                    ...
                    if delta > 0:
                        ...
                        dataframe_resultados = dataframe_resultados.append(dict(iter=contador_iteraciones, f_sol=(f(mejor_solucion)), temp=temperatura),
                          ignore_index=True)

                if temperatura < self.eps:
                    condicion_parada = 'Fin de temperatura'
                else:
                    if contador_repeticiones_temperatura >= maximo_inyecciones_temperatura:
            ...
            return (
             parametros, resultados_finales, dataframe_resultados)
        ...
        def genera_pdf_final(recolector_resultados, ruta, fecha_hora):
            ...
            for parametro in recolector_resultados.diccionario_mejores_f.keys():
                ...
                pdf.guardar_grafica(titulo_grafica='Temperaturas alcanzadas', nombre_parametro='temp', funcion_ayudante_grafico=(ayudante_graficas.crear_grafica_parametro))
