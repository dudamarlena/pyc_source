...
# [GCC 8.4.0]
# Embedded file name: C:\Users\esuka\PycharmProjects\HeurisPy\heurispy\heuristicas\busqueda_local_iterada.py
# Compiled at: 2019-07-01 02:04:07
# Size of source mod 2**32: 9332 bytes
...
class BusquedaLocalIterada(Heuristica):
    ...
    def __init__(self, problema_optimizacion, max_iteraciones=1000000):
        super().__init__(problema_optimizacion, lista_nombres_parametros=[
         'busqueda_local_sin_minimo_global', 'rango_perturbacion',
        ...
        def busqueda_local(solucion_inicial, iteraciones_minimo_local, iteraciones_maximas=100):
            ...
            return (
             mejor_solucion, contador_iteraciones)
        ...
        def busqueda_local_iterada(parametros):
            ...
            if self.comprobar_parametros(parametros):
                ...
                while contador_bus_iterada_sin_mejora < busqueda_iterada_sin_mejora and contador_iteraciones < max_iteraciones:
                    ...
                    contador_iteraciones = contador_iteraciones + 1
                    dataframe_resultados = dataframe_resultados.append(dict(iter=contador_iteraciones, f_sol=f_mejor_solucion),
                      ignore_index=True)
                ...
                resultados_finales = dict(mejor_solucion=mejor_solucion, f_mejor_solucion=f_mejor_solucion,
