...
# [GCC 8.4.0]
# Embedded file name: C:\Users\esuka\PycharmProjects\HeurisPy\heurispy\framework.py
# Compiled at: 2019-08-01 11:33:38
# Size of source mod 2**32: 7622 bytes
"""
...
class RecopiladorInformacion:
    ...
    def transformar_archivo_json(self, ruta):
        import json
        diccionario = {'nombre_heuristica':self.nombre_heuristica, 
         'lista_parametros':self.lista_parametros,  'lista_nombres_parametros_dataframes':list(set(self.lista_nombres_parametros_dataframe)), 
         'fecha_hora':self.fecha_hora, 
         'funciones_utilizadas_pdf':self.funciones_utilizadas_pdf}
...
def inicia_exploracion_heuristica(heuristica, parametros_heuristica, nucleos_cpu=cpu_count(), modo_consola='parlante'):
    import pathos
    ...
    resultados_heuristica = list(tqdm((servidor.imap(heuristica.iniciar_busqueda, parametros_heuristica)), total=(len(parametros_heuristica))))
    print('------------------------------------------------------------------------')
    if modo_consola is not 'silencioso':
    ...
    recopilador_informacion.lista_nombres_parametros_dataframe = recolector_resultados.obtener_nombre_parametros_dataframe()
