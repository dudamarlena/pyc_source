...
# [GCC 8.4.0]
# Embedded file name: C:\Users\esuka\PycharmProjects\HeurisPy\heurispy\heuristicas\busqueda_tabu.py
# Compiled at: 2020-03-16 16:53:09
...
class BusquedaTabu(Heuristica):
    ...
    def __init__(self, problema_optimizacion, max_iteraciones=1000000):
        super().__init__(problema_optimizacion, lista_nombres_parametros=[
         'espacio_memoria', 'max_busquedas_sin_mejora'])
        ...
        def busqueda_tabu(parametros):
            ...
            if self.comprobar_parametros(parametros):
                ...
                while busquedas_sin_mejora < max_busquedas_sin_mejora and contador_iteraciones < maximo_iteraciones:
                    ...
                    dataframe_resultados = dataframe_resultados.append(dict(iter=contador_iteraciones, f_sol=(f(solucion_busqueda))),
                      ignore_index=True)
