...
# [GCC 8.4.0]
# Embedded file name: /home/msoucy/.virtualenv/fuf/lib/python2.7/site-packages/fuf/constraints.py
...
def constraint(func):
    ...
    """
    return update_wrapper(lambda *args, **kwargs: lambda arg: func(arg, *args, **kwargs), func)
