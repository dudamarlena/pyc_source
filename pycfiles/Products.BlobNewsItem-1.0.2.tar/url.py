...
# [GCC 8.4.0]
# Embedded file name: /usr/local/plone-production-nbf-1/zeocluster/src/Products.BlobNewsItem/Paste-1.7.5.1-py2.6.egg/paste/url.py
    ...
    def _html_attrs(self):
        ...
        if self.params.get('confirm'):
            attrs.append(('onclick',
             'return confirm(%s)' % js_repr(self.params['confirm'])))
        return attrs
