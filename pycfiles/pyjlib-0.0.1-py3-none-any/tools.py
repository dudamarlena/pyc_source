...
# Embedded file name: /home/jldupont/workspace/pyjld/trunk/pyjld.os/trunk/src/pyjld/os/tools.py
# Compiled at: 2009-10-13 16:50:48
__doc__ = '\npyjld.os.tools\n\nVarious OS utilities\n\n@author: Jean-Lou Dupont\n'
__author__ = 'Jean-Lou Dupont'
__email = 'python (at) jldupont.com'
__fileid = '$Id: tools.py 76 2009-04-25 02:35:24Z jeanlou.dupont $'
__all__ = [
 'safe_mkdir', 'psyspaths', 'safe_oneup', 'safe_walkup', 'versa_copy',
...
def safe_copytree(src, dst, symlinks=False, dir_mode=511, skip_dirs=[], make_dirs=False):
    """
    ...
    for name in names:
        ...
        try:
            if symlinks and os.path.islink(srcname):
                ...
                if base_srcname not in skip_dirs:
                    safe_copytree(srcname, dstname, symlinks=symlinks, dir_mode=dir_mode, skip_dirs=skip_dirs, make_dirs=make_dirs)
            else:
...
def recursive_chmod(path, mode=509, do_files=True, do_dirs=True, skip_files=[], skip_dirs=[]):
    """
    Recursive ``chmod``
