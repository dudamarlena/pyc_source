...
# [GCC 8.4.0]
# Embedded file name: D:\dev\scrapgo\scrapgo\utils\datecuts.py
...
def slice_date_range(start_date, end_date, by='year', fmt=DATESTR_FMT, **kwargs):
    ...
    date_list = list(rrule(freq=freq, dtstart=ini_start_date, until=fin_end_date,
      interval=1))
    ...
    for i, d in enumerate(date_list):
        ...
        if e >= end_date:
            e = end_date
        yield (
         parse_date(s, fmt), parse_date(e, fmt))
