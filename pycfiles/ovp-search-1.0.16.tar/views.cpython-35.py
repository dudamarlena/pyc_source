...
# [GCC 8.4.0]
# Embedded file name: /home/arroyo/ovp/suzano-ovp/django-ovp-search/ovp_search/views.py
# Compiled at: 2017-06-22 10:25:03
# Size of source mod 2**32: 7492 bytes
...
class OrganizationSearchResource(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    ordering_fields = ('slug', 'name', 'website', 'facebook_page', 'details', 'description',
                       'type', 'hidden_address')
...
class ProjectSearchResource(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    ordering_fields = ('name', 'slug', 'details', 'description', 'highlighted', 'published_date',
                       'created_date', 'max_applies', 'minimum_age', 'hidden_address',
                       'crowdfunding', 'public_project', 'relevance')
