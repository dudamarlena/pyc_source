...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/maegen/gui/hildon/maegenGui.py
...
@author: maemo
"""
import gtk, hildon, gobject, logging, os.path, logging, threading, time, datetime
from Queue import *
import pango, mock
...
class IndividualView(MaegenStackableWindow):
    ...
    def _on_save_clicked_event(self, widget, data):
        if self.edit_father and self.edit_mother:
            ...
            elif not self.father_enabled.get_active() and not self.mother_enabled.get_active():
                self.zcore.remove_parents(self.individual)
            elif self.father_enabled.get_active():
        ...
        elif self.edit_father is None and self.edit_mother is None:
    ...
    def create_header(self, individual):
        ...
        elif individual.nickname and individual.nickname != '':
        ...
        elif individual.occupation and individual.occupation != '':
