...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/lcdk/lcdk.py
# Compiled at: 2019-10-02 11:11:38
# Size of source mod 2**32: 8514 bytes
import os, sys, time, json, logging, inspect, traceback
...
class StyleAdapter(logging.LoggerAdapter):
    ...
    def __init__(self, logger, extra=None):
        ...
        self.color = {'Red':'\x1b[1;31m',  'Black':'\x1b[0;30m', 
         'Dark Gray':'\x1b[1;30m', 
         'Light_Red':'\x1b[1;31m', 
         'Green':'\x1b[0;32m', 
...
class lcdk:
    ...
    def _getCaller(self, frame):
        ...
        if 'self' in caller_frame.f_locals:
            ...
            if '__name__' in caller_frame.f_locals:
