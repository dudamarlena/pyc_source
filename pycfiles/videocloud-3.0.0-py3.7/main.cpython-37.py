...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\videocloud\main.py
# Compiled at: 2019-07-23 13:15:12
# Size of source mod 2**32: 3203 bytes
import logging, os, sys, urllib.request, click, numpy as np
...
def wordcloud(words: str, font: str, mask: str, color: str) -> Image.Image:
    ...
    try:
        try:
            ...
            print('There was an unknown error generating the videocloud.')
            sys.exit(1)
...
@click.option('--font', default='https://github.com/paramt/videocloud/blob/master/assets/fonts/NotoSans/NotoSans.ttf?raw=true',
  help='Link to a TTF font file')
@click.option('--mask', default='https://github.com/paramt/videocloud/blob/master/assets/masks/cloud.png?raw=true',
...
def videocloud(url: str, filepath: str, language: str, color: str, font: str, mask: str):
    try:
        ...
        print('There was an error saving the videocloud. For more help visit https://www.param.me/videocloud#usage')
        sys.exit(1)
