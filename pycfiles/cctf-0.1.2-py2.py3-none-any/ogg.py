...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/cctagutils/handler/ogg.py
# Compiled at: 2007-03-15 10:29:40
__doc__ = 'Classes and functions to support embedding metadata in a music file;\ncontains the abstract class which allows extensions to be implemented for\nOGG, etc.\n'
__id__ = '$Id: ogg.py 701 2007-02-13 13:15:23Z nyergler $'
__version__ = '$Revision: 701 $'
