...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/workon/contrib/tracker/utils.py
# Compiled at: 2018-08-10 08:13:32
...
if 'workon.contrib.tracker' not in settings.INSTALLED_APPS:
    ...
    def track(*fields, save=True):
        ...
        def inner(cls):
            ...
            cls.add_to_class('generic_tracked_events', GenericRelation(TrackEvent,
