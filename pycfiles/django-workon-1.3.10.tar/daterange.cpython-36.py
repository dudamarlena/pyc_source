...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/workon/forms/daterange.py
# Compiled at: 2018-08-24 03:56:18
...
class DateRangeInput(forms.DateInput):
    ...
    def __init__(self, date_ranges, allow_custom, attrs=None, options=None, format=None):
        ...
        self.options.update({'locale': {'format':'DD/MM/YYYY', 
                    'daysOfWeek':[
