...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/workon/templatetags/workon_assets.py
# Compiled at: 2018-08-20 08:28:25
...
def lazy_register(register):
    ...
    def javascripts(*names, **kwargs):
        ...
        return {'externals':mark_safe(externals),  'internals':mark_safe(internals)}

    PACKAGES_CSS = {'workon':'workon/css/workon.css', 
     'materialize-icons':[
