...
# [GCC 8.4.0]
# Embedded file name: /home/dalou/www/LEPOLE/workon/views/select2.py
# Compiled at: 2018-01-04 23:48:15
...
import workon.utils, workon.conf as settings
...
class AutoResponseView(BaseListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return JsonResponse({'results':[{'text':self.widget.label_from_instance(obj),  'id':obj.pk} for obj in context['object_list']], 
         'more':context['page_obj'].has_next()})

    def get_queryset(self):
        """Get QuerySet from cached widget."""
        kwargs = {model_field_name:self.request.GET.get(form_field_name) for form_field_name, model_field_name in self.widget.dependent_fields.items() if self.request.GET.get(form_field_name, '') != ''}
