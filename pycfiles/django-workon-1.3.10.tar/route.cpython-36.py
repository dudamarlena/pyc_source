...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/workon/utils/route.py
# Compiled at: 2018-12-11 12:29:29
...
def route(pattern, name=None, attach=HttpRequest, attach_attr=None, view=None, view_kwargs={}, args=(), kwargs={}, fail_as_previous=False, login_required=False, staff_required=False, superuser_required=False, custom_required=None, csrf_exempt=None):
