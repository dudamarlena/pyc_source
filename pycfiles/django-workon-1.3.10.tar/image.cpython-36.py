...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/workon/utils/image.py
# Compiled at: 2018-09-18 08:51:54
...
__all__ = [
 'base64image_iter', 'base64image', 'thumbnail', 'thumbnail_static', 'static']
base64img_finder = re.compile('(data\\:image\\/(\\w+)\\;base64\\,([\\w\\+\\/\\d\\=\\n]+))')
