...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/workon/forms/tree.py
# Compiled at: 2018-08-29 05:37:57
# Size of source mod 2**32: 2546 bytes
from django import forms
__all__ = [
 'TreeSelect', 'TreeSelectMultiple', 'TreeModelChoiceField', 'TreeModelMultipleChoiceField']
    ...
    def get_context(self, name, value, attrs):
        ...
        for choice in self.choices:
            if self.label_from_instance:
                ...
                label = choice[1]
            by_ids[choice[0]] = {'items':[],  'is_selected':test_selected(choice[0]), 
             'label':label, 
             'parent_id':choice[2], 
             'level':choice[3], 
             'value':choice[0]}
        ...
        context = {'tree':tree.values(),  'is_hidden':self.is_hidden, 
         'name':name, 
