...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/lazydiff/regression.py
# Compiled at: 2018-12-11 21:11:30
# Size of source mod 2**32: 5589 bytes
...
@timer
def iterative_regression(X, y, m, b, loss_function, lr=0.1, epochs=100, earlyStop=0, forward=True, plot=False):
    """
