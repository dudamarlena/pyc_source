...
# [GCC 8.4.0]
# Embedded file name: /home/chaws/linaro/src/linaro/squad_client/squad_client/shortcuts.py
# Compiled at: 2020-04-14 09:10:31
...
def submit_results(group_project_slug=None, build_version=None, env_slug=None, tests={}, metrics={}, log=None, metadata=None, attachments=None):
    ...
    for test_name in tests.keys():
        ...
        if type(tests[test_name]) is dict:
            test.status = tests[test_name].get('result')
