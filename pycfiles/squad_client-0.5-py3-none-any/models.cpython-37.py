...
# [GCC 8.4.0]
# Embedded file name: /app/squad_client/core/models.py
# Compiled at: 2020-02-22 16:35:54
...
class SquadObject:
    ...
    def get_type(cls, _type):
        if SquadObject.types is None:
            SquadObject.types = {c.__name__:c for c in SquadObject.__subclasses__() if c is not Squad if c is not Squad}
