...
# Embedded file name: build/bdist.linux-i686/egg/csci/tweetsite/browser/lib/twitter.py
# Compiled at: 2009-11-12 05:32:28
__doc__ = 'A library that provides a python interface to the Twitter API'
__author__ = 'dewitt@google.com'
__version__ = '0.6-devel'
import base64, calendar, os, rfc822, simplejson, sys, tempfile, textwrap, time, urllib, urllib2, urlparse
try:
...
class Status(object):
  ...
  """
    ...
    def __init__(self, created_at=None, favorited=None, id=None, text=None, user=None, in_reply_to_screen_name=None, in_reply_to_user_id=None, in_reply_to_status_id=None, truncated=None, source=None, now=None):
   ...
   """
    ...
    """
        if 'user' in data:
            ...
            user = None
        return Status(created_at=data.get('created_at', None), favorited=data.get('favorited', None), id=data.get('id', None), text=data.get('text', None), in_reply_to_screen_name=data.get('in_reply_to_screen_name', None), in_reply_to_user_id=data.get('in_reply_to_user_id', None), in_reply_to_status_id=data.get('in_reply_to_status_id', None), truncated=data.get('truncated', None), source=data.get('source', None), user=user)
...
class Api(object):
  ...
  """
    ...
    def GetFriendsTimeline(self, user=None, count=None, since=None, since_id=None):
