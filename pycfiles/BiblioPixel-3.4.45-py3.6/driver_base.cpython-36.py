...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/drivers/driver_base.py
# Compiled at: 2019-08-11 12:22:47
# Size of source mod 2**32: 6105 bytes
...
class DriverBase(object):
    ...
    def __init__(self, num=0, width=0, height=0, c_order='RGB', gamma=None, maker=data_maker.MAKER, **kwds):
    ...
    def update_colors(self):
        ...
        with self.brightness_lock:
            brightness, self._waiting_brightness = self._waiting_brightness, None
