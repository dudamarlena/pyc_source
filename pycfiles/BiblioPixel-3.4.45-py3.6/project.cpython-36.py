...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/project/project.py
# Compiled at: 2019-08-11 12:22:47
# Size of source mod 2**32: 5562 bytes
import atexit, os, queue, threading, time, traceback, weakref
from . import attributes, clock, construct, edit_queue, fill, load, merge, recurse
...
class Project:
    ...
    def construct_child(self, section_name, datatype=None, typename=None, **kwds):
        if not datatype:
    ...
    def __init__(self, *, drivers, layout, maker, path, animation, controls, edit_queue_maxsize=EDIT_QUEUE_MAXSIZE, **kwds):
        """
