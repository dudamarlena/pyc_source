...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/util/image/extract_gif_lines.py
# Compiled at: 2019-08-11 12:22:47
# Size of source mod 2**32: 1735 bytes
import os
from .. import data_file, log
CODE_BLOCK = '.. code-block:: '
IMAGE = '.. image:: https://raw.githubusercontent.com/ManiacalLabs/DocsFiles/master/BiblioPixel/'
LANGS = ('json', 'yaml')
