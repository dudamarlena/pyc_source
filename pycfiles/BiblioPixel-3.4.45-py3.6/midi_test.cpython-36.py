...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/bibliopixel/control/midi_test.py
...
PB = Namespace(type='pitchwheel', channel=2, pitch=1024)
...
class MidiTest(unittest.TestCase):
    routing = {'note_on':'.note_on', 
     'note_off':'.note_off', 
     'control_change':{'1':'.cc1', 
      '2':'.cc2'}, 
     'pitchwheel':'.pitch'}
