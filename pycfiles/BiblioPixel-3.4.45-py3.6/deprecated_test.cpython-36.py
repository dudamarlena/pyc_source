...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/bibliopixel/util/deprecated_test.py
...
class DeprecatedTest(unittest.TestCase):
    ...
    def test_bp(self):
        all_test.TestAll._test(self, all_test.BP_ROOT, all_test.BP_NAME, BP_BLACKLIST)