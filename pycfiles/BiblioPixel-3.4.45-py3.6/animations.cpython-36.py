...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/commands/animations.py
...
from bibliopixel.animation import animation, circle, collection, cube, game, indexed, indexed, matrix, parallel, receiver, strip, wrapper
...
_BLACKLIST = set(('bibliopixel.animation.off.OffAnim', 'bibliopixel.animation.remote.control.Off',
                  'bibliopixel.main.demo_table.Sequence', 'bibliopixel.main.all_pixel_test.StripChannelTest',
                  'bibliopixel.animation.failed.Failed', 'BiblioPixelAnimations.simple.Fill.Fill'))