...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/bibliopixel/util/color_list_test.py
# Compiled at: 2019-08-11 12:22:47
# Size of source mod 2**32: 6036 bytes
import numpy, numpy.testing, unittest
from bibliopixel.util import color_list, log
...
class ColorListTest(unittest.TestCase, TestBase):
    ...
    def test_sum_list(self):
        self.assertEqual(ListMath.sum(COLORS1), 1530)

    def test_sum_numpy(self):
        self.assertEqual(NumpyMath.sum(make_numpy(COLORS1)), 1530)
...
class MixerTest(unittest.TestCase, TestBase):
    ...
    def test_numpy(self):
        mixer = color_list.Mixer(make_numpy(COLORS1), [
