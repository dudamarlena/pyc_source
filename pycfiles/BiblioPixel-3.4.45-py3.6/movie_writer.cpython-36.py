...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/util/image/movie_writer.py
...
DEFAULT_RENDER = {'color':COLORS.Black, 
 'pixel_width':12, 
 'pixel_height':None, 
 'ellipse':True, 
 'vertical':False, 
...
class MovieWriter:
    __doc__ = 'Write an animated GIF given frames from an animation.'

    def __init__(self, filename='output.gif', render=None, divide=1, frames=128, time=10, speed=1.0, options=None, gif_dir=None, duration=None, fps=None):
