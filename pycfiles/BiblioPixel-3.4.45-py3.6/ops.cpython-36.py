...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/control/ops.py
...
COMMUTATIVE = ('add', 'mul')
ONE_OPERATORS = ('acos', 'acosh', 'asin', 'asinh', 'atan', 'atanh', 'ceil', 'cos',
                 'cosh', 'degrees', 'erf', 'erfc', 'exp', 'expm1', 'fabs', 'floor',
                 'gamma', 'lgamma', 'log', 'log10', 'log1p', 'log2', 'radians', 'sin',
                 'sinh', 'sqrt', 'tan', 'tanh', 'trunc')
OPS = [
 {k:getattr(math, k) for k in ONE_OPERATORS}, _two_ops()]
OPS_ERROR = 'Do not understand operator {0}.\n\nOne argument operators are:\n   %s\n\nTwo argument operators are:\n   %s\n' % tuple(_join(sorted(o)) for o in OPS)