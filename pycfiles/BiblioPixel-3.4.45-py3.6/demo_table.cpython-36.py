...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/main/demo_table.py
...
BLOOM = {'driver':{'typename':'simpixel', 
  'num':0}, 
 'layout':{'typename':'matrix', 
  'width':0, 
  'height':0}, 
 'animation':{'typename': 'BiblioPixelAnimations.matrix.bloom.Bloom'}, 
 'run':{'amt':6, 
  'fps':30}}
MATRIX_PROJECT = {'driver':{'typename':'simpixel', 
  'num':0}, 
 'layout':{'typename':'matrix', 
  'width':0, 
  'height':0}, 
 'animation':{'typename':'sequence', 
  'animations':[
   {'animation':'BiblioPixelAnimations.matrix.MatrixRain.MatrixRainBow', 
    'run':{'amt':1, 
     'fps':20, 
     'seconds':8}},
   {'animation':{'typename':'BiblioPixelAnimations.matrix.Text.ScrollText', 
     'xPos':16, 
     'font_scale':2, 
   ...
   {'animation':'BiblioPixelAnimations.matrix.circlepop.CirclePop', 
    'run':{'amt':1, 
     'fps':15, 
     'seconds':8}}]}}
CUBE_PROJECT = {'driver':{'typename':'simpixel', 
  'num':0}, 
 'layout':{'typename':'cube', 
  'x':0, 
  'y':0, 
  'z':0}, 
 'animation':{'typename':'sequence', 
  'animations':[
   {'animation':{'typename':'BiblioPixelAnimations.cube.wave_spiral.WaveSpiral', 
     'dir':False, 
     'offset':6}, 
    'run':{'amt':1, 
     'fps':15, 
...
_POINTS = geometry.make_circle_coord_map_positions(_RINGS,
  origin=(200, 200, 0), z_diff=16)
CIRCLE_PROJECT = {'driver':{'typename':'simpixel', 
  'num':sum(_PIXELS_PER), 
  'pixel_positions':_POINTS}, 
 'layout':{'typename':'circle', 
  'rings':_RINGS, 
  'maxAngleDiff':0}, 
 'animation':{'typename':'sequence', 
  'length':8, 
...
def circle(args):
    ...
    points = geometry.make_circle_coord_map_positions(rings,
      origin=(200, 200, 0), z_diff=16)
