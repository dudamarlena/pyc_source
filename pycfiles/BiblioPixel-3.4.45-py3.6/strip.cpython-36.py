...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/layout/strip.py
...
class Strip(MultiLayout):
    ...
    def __init__(self, drivers, threadedUpdate=False, brightness=255, pixelWidth=1, **kwargs):
