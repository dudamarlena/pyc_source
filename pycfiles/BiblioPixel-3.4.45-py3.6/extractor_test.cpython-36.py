...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/bibliopixel/control/extractor_test.py
# Compiled at: 2019-08-11 12:22:47
# Size of source mod 2**32: 1912 bytes
import collections, fractions, unittest
from bibliopixel.control import extractor
KEYS_BY_TYPE = {'note_on':('channel', 'type', 'note', 'velocity'), 
...
C3 = {'type':'note_on', 
 'note':32,  'channel':1,  'velocity':96}
C3_OFF = {'type':'note_off',  'note':32,  'channel':1,  'velocity':0,  'x':47}
BC = {'type':'control_change', 
 'channel':2,  'control':2,  'value':10}
...
OTHER = {'type':'other', 
 'channel':32,  'thing':'stuff'}

class ExtractorTest(unittest.TestCase):

    def run_test(self, msg, expected, **kwds):
        md = (extractor.Extractor)(keys_by_type=KEYS_BY_TYPE, 
