...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/control/control.py
...
class Control(runnable.Runnable):
    ...
    def __init__(self, routing=None, default=None, errors='raise', python_path='bibliopixel.control', verbose=False, pre_routing=None):
        """
    ...
    def _receive(self, msg):
        ...
        if receiver:
            ...
            if self.verbose:
                log.info('Routed message %s (%s) to %s', str_msg[:128], msg, repr(receiver))
...
class ControlLoop:
    __doc__ = 'Mixin class for looping controls'
