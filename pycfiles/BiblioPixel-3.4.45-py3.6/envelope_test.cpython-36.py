...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/bibliopixel/control/envelope/envelope_test.py
...
class EnvelopeTest(unittest.TestCase):
    ...
    def test_symmetry(self):
        ...
        expected = [0.0, 0.1875, 0.375, 0.53125, 0.625,
         0.71875, 0.8125, 0.90625, 0.0]
        function_tester(env, self, expected)
    ...
    def _random(self, env, min_mean, max_mean, min_stdev, max_stdev, test_count=3, sample_count=300):
