...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/control/serial_gamepad.py
...
class SerialGamePad(BaseGamePad):
    ...
    def _printError(error):
        ...
        if error == RETURN_CODES.ERROR_SIZE:
            ...
            if error == RETURN_CODES.ERROR_UNSUPPORTED:
                msg = 'Unsupported configuration attempted.'
            else:
                if error == RETURN_CODES.ERROR_BAD_CMD:
