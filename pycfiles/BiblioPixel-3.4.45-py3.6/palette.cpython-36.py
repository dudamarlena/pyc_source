...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/colors/palette.py
...
class Palette(list):
    ...
    def __init__(self, colors=(), continuous=False, serpentine=False, scale=1, offset=0, autoscale=False, length=None):
        """
        Arguments:
    ...
    def get(self, position=0):
        ...
        if not self.continuous:
            ...
            return (
             r1 + fade * dr, g1 + fade * dg, b1 + fade * db)
    ...
    def __eq__(self, other):
        return isinstance(other, Palette) and super().__eq__(other) and vars(self) == vars(other)
