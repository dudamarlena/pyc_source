...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bibliopixel/animation/reprocess/reprocess.py
...
class Reprocess(wrapper.Wrapper):
    ...
    def __init__(self, *args, process=None, **kwds):
        ...
        datatype = importer.import_symbol(typename, 'bibliopixel.animation.reprocess')
