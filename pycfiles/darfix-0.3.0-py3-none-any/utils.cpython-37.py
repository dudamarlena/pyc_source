...
# [GCC 8.4.0]
# Embedded file name: /users/garrigaf/Documents/git/darfix/build/lib/darfix/io/utils.py
...
def write_components(h5_file, entry, dimensions, W, data, processing_order, data_path='/', overwrite=True):
    """
    ...
    def save_key(path_name, key_path, value, overwrite=True):
        ...
        if isinstance(value, dict):
            ...
            dicttoh5(value, h5file=h5_file, h5path=h5_path, overwrite_data=True,
              mode='a')
        else:
