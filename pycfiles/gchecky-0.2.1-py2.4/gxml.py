...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/gchecky/test/gxml.py
# Compiled at: 2007-10-31 07:25:26
import unittest
...
class XmlFieldTestCase(unittest.TestCase):
    ...
    def testAnyFieldXml(self):
        ...
        src = any_field_test_t(any1=None, any2='string', any3='unicode_str', any4=('tupe',
                                                                                   'with',
                                                                                   'values',
                                                                                   11,
                                                                                   1.5), any5=('tuple', ('of', (('nested',), 'tuples'))), any6={'some': 'dictionary', 'with': 'values', 'aa': 17})
    ...
    def testZipFieldXml(self):
        ...
        from xml.dom.Document import Node as XmlNode
        src = zip_field_test_t(any1='10014-3433', any2='10014-34*', any3='10014-*', any4='1001*', any5='10014-34', any6='75001')
        result = gxml.Document.fromxml(src.toxml())
        self.ensure_result_equals_source(result, src)
        return True
    ...
    def ensure_result_equals_source(self, result, source):
        for fname in vars(source):
            ...
            assert equals, 'Field %s content does not match: "%s" vs "%s"' % (fname, getattr(source, fname), getattr(source, fname, None))
