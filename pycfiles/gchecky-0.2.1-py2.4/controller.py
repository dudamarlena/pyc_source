...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/gchecky/test/controller.py
# Compiled at: 2008-01-26 21:25:36
import unittest, gchecky.controller as gcontroller
...
class ControllerTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.controller = gcontroller.Controller(GCHECKOUT_VENDOR_ID, GCHECKOUT_MERCHANT_KEY, True)
    ...
    def testTrackingData(self):
        self.controller.add_tracking_data('457164429557231', 'UPS', 'ARGHHH-UPS-NUMBER123456')

    def testChargeOrder(self):
        self.controller.charge_order('920492774454564', 1599)

    def testRefundOrder(self):
        self.controller.refund_order('457164429557231', 0.04, 'Test refunding mechanism', 'Oh la la!')

    def testAuthorizeOrder(self):
        self.controller.authorize_order('457164429557231')

    def testCancelOrder(self):
        self.controller.cancel_order('566018579274459', 'Test order cancelling', 'Oh al al!')
