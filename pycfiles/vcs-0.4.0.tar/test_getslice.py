...
# [GCC 8.4.0]
# Embedded file name: /Users/lukasz/develop/workspace/.pythonpath/vcs/tests/test_getslice.py
...
class GetsliceTestCaseMixin(BackendTestMixin):
    ...
    def test__getslice__respects_start_index(self):
        self.assertEqual(list(self.repo[2:]), [ self.repo.get_changeset(rev) for rev in self.repo.revisions[2:] ])
