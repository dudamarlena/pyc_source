...
# [GCC 8.4.0]
# Embedded file name: /Users/lukasz/develop/workspace/.pythonpath/vcs/tests/test_hg.py
...
from vcs.tests.conf import PACKAGE_DIR, TEST_HG_REPO, TEST_HG_REPO_CLONE, TEST_HG_REPO_PULL
