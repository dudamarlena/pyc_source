...
# [GCC 8.4.0]
# Embedded file name: /Users/lukasz/develop/workspace/.pythonpath/vcs/commands/log.py
# Compiled at: 2013-04-28 19:17:53
import string
...
class LogCommand(ChangesetCommand):
    TEMPLATE = '$raw_id | $date | $message'
    option_list = ChangesetCommand.option_list + (
     make_option('-t', '--template', action='store', dest='template', default=TEMPLATE, help='Specify own template. Default is: "%s"' % TEMPLATE),
     make_option('-p', '--patch', action='store_true', dest='show_patches', default=False, help='Show patches'))
