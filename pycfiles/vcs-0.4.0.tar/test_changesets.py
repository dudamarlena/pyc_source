...
# [GCC 8.4.0]
# Embedded file name: /Users/lukasz/develop/workspace/.pythonpath/vcs/tests/test_changesets.py
...
from vcs.nodes import FileNode, AddedFileNodesGenerator, ChangedFileNodesGenerator, RemovedFileNodesGenerator
from vcs.exceptions import BranchDoesNotExistError, ChangesetDoesNotExistError, RepositoryError
...
class ChangesetsWithCommitsTestCaseixin(BackendTestMixin):
    ...
    def test_new_branch(self):
        self.imc.add(vcs.nodes.FileNode('docs/index.txt', content='Documentation\n'))
    ...
    def test_new_head_in_default_branch(self):
        ...
        foobar_tip = self.imc.commit(message='New branch: foobar', author='joe', branch='foobar', parents=[
         tip])
        self.imc.change(vcs.nodes.FileNode('docs/index.txt', content='Documentation\nand more...\n'))
