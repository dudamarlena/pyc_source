...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/fftool/firefox_env_handler.py
# Compiled at: 2016-05-05 14:55:43
import os, platform, re, sys, ConfigParser as configparser
