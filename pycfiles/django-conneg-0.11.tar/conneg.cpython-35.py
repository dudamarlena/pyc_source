...
# [GCC 8.4.0]
# Embedded file name: /home/kebl2765/Projects/django-conneg/django_conneg/conneg.py
...
class Renderer(object):
    ...
    def __repr__(self):
        if self.is_bound:
            return '<bound renderer {0}.{1} of {2}>'.format(self.func.im_class.__name__ or '?', self.func.__name__, self.func.__self__)
        else:
...
class Conneg(object):
    ...
    def get_renderers(self, request, context=None, template_name=None, accept_header=None, formats=None, default_format=None, fallback_formats=None, early=False):
        """
