...
# [GCC 8.4.0]
# Embedded file name: /Users/nicp/nyaruka/smartmin/smartmin/management/tests.py
    ...
    def test_command(self, mock_write_dump, mock_load_migrations):
        ...
        mock_write_dump.assert_has_calls([
         call('indexes', [
          ...
          SqlObjectOperation('CREATE INDEX test_1 ON foo(bar);', SqlType.INDEX, 'test_1', True)], 'sql'),
         call('triggers', [
          SqlObjectOperation('CREATE TRIGGER test_1 AFTER TRUNCATE ON flows_flowstep EXECUTE PROCEDURE foo();', SqlType.TRIGGER, 'test_1', True)], 'sql')])