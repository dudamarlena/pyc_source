...
# [GCC 8.4.0]
# Embedded file name: /Users/nicp/nyaruka/smartmin/smartmin/templatetags/smartmin.py
# Compiled at: 2020-03-23 16:28:57
# Size of source mod 2**32: 8473 bytes
import json, pytz, re
...
def render_field(context, field):
    ...
    inclusion_context = dict(field=field, form=(context['form']),
      view=(context['view']),
