...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/SimpleRequests.py
# Compiled at: 2016-09-21 04:27:38
__version__ = '0.2'
...
class Requests:
    ...
    def _url_split(self, url):
        if isinstance(url, (str, unicode)):
            ...
            return (
             _url.scheme, _url.netloc, _url.path, _url.query)
    ...
    def get(self, url=None, headers=None, timeout=None):
        ...
        try:
            ...
            data = self.jsonde.decode(content)
            httpClient.close()
