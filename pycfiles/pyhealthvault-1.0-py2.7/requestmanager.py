...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/healthvaultlib/helpers/requestmanager.py
# Compiled at: 2016-01-06 13:41:56
import pytz, hmac, base64, socket, hashlib, httplib, datetime, urlparse
...
class RequestManager:
    ...
    def construct_request(self):
        ...
        if self.connection.shared_secret is not None:
            hashedheader = hmac.new(base64.b64decode(self.connection.shared_secret), etree.tostring(self.header), hashlib.sha1)
