...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/FeatureServer/Service/JSON.py
# Compiled at: 2008-01-01 03:15:59
__author__ = 'MetaCarta'
__copyright__ = 'Copyright (c) 2006-2008 MetaCarta'
__license__ = 'Clear BSD'
__version__ = '$Id: JSON.py 412 2008-01-01 08:15:59Z crschmidt $'
...
class JSON(Request):
    ...
    def encode_metadata(self, action):
        ...
        for key in layers.keys():
            metadata.append({'name': key, 'url': '%s/%s' % (self.host, key)})
