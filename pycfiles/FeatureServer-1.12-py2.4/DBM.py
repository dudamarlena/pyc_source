...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/FeatureServer/DataSource/DBM.py
# Compiled at: 2008-03-18 21:35:35
            ...
            for id in self:
                ...
                if action.attributes:
                    ...
                    for (key, val) in action.attributes.items():
                        if key not in props and val is not None or key in props and str(props[key]) != val:
                            skip = True
                            break
