...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/FeatureServer/DataSource/Flickr.py
# Compiled at: 2008-01-15 18:46:53
__author__ = 'MetaCarta'
__copyright__ = 'Copyright (c) 2006-2008 MetaCarta'
__license__ = 'Clear BSD'
__version__ = '$Id: Flickr.py 423 2008-01-15 23:46:53Z crschmidt $'
from FeatureServer.DataSource import DataSource
from FeatureServer.Feature import Feature
import md5, urllib, xml.dom.minidom as minidom
...
class Flickr(DataSource):
    ...
    def __init__(self, name, api_key=None, secret=None, maxpages=1, maxfeatures=100, **args):
        ...
        self.attributes = [
         'user_id', 'tags', 'tag_mode', 'text', 'min_upload_date', 'max_upload_date', 'min_taken_date', 'max_taken_date', 'license', 'sort', 'privacy_filter', 'accuracy', 'machine_tags', 'machine_tag_mode', 'group_id', 'per_page']
    ...
    def convert_photo_xml_to_feature(self, xml):
        ...
        coordinates = [
         float(props['longitude']), float(props['latitude'])]
...
class API:
    ...
    def get_token(self):
        params = {'method': 'flickr.auth.getToken', 'frob': self.frob}
