...
# [GCC 8.4.0]
# Embedded file name: /home/rahul/.pyenv/versions/py3.6.2/lib/python3.6/site-packages/pwmodel/buildmodel.py
# Compiled at: 2018-02-24 18:00:27
# Size of source mod 2**32: 2138 bytes
from collections import defaultdict
import helper, dawg, models
MIN_PROB = 1e-06
...
def prob(nDawg, w, modelfunc):
    ...
    return helper.prod(nDawg.get(ng, MIN_PROB) / t for ng in modelfunc(w))
...
def create_ngram_model(fname='', listw=[], outfname='', n=3):
    ...
    """
    return create_model(fname=fame, listw=listw, outfname=outfname, modelfunc=(lambda w: models.ngramsofw(n=3)))


if __name__ == '__main__':
    import sys
    w = 'password@123'
    T = create_model(fname=(sys.argv[1]), listw=[], outfname='', modelfunc=(models.pcfgtokensofw))
