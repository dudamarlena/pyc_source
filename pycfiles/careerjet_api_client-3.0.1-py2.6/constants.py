...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/careerjet_api_client/constants.py
...
class Constants(object):
    ...
    ALLOWED_FIELDS = [
     'keywords', 'location', 'sort', 'start_num', 'pagesize', 'page', 'contracttype', 'contractperiod', 'locale_code', 'affid', 'user_ip', 'user_agent', 'url']
    MANDATORY_FIELDS = [
     'affid', 'user_ip', 'user_agent', 'url']
    LOCALES = {'cs_CZ': 'http://www.careerjet.cz', 
