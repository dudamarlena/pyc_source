...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-vkontakte-api/vkontakte_api/mixins.py
# Compiled at: 2015-11-01 17:29:11
import logging
...
class LikableModelMixin(models.Model):
    ...
    likes_count = models.PositiveIntegerField('Likes', null=True, db_index=True)
