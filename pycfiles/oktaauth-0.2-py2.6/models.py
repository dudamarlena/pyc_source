...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/oktaauth/models.py
# Compiled at: 2016-02-08 11:14:19
import requests, base64, urlparse, logging
...
class OktaAPIAuth(object):
    ...
    def okta_req(self, path, data):
        ...
        resp = requests.post(url=url, headers={'Accept': 'application/json', 'Content-Type': 'application/json'}, json=data)
        return resp.json()
