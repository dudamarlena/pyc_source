...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/flask-marcopolo/flask_marcopolo/__init__.py
# Compiled at: 2014-12-24 05:41:11
...
class MarcoPolo(FlaskView):
    ...
    def bind(cls, app):
        ...
        if not hasattr(app, '__call__'):
            raise TypeError("From MarcoPolo.bind: '%s' is not callable" % app)
        cls._bind_app.add(app)

    @classmethod
    def init(cls, app, config=None, project_dir='./app', proxyfix=True):
        """
        ...
        def utility_processor():
            ...
            return dict(set_page_info=set_page_info, get_page_info=get_page_info)
    ...
    @classmethod
    def set_view_context(cls, **kwargs):
        """
