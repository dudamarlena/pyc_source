...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/restin/config/routing.py
...
def make_map(global_conf={}, app_conf={}):
    ...
    _app_resource = dict(_member_name='application', _collection_name='applications')
    app_resource = dict(member_name='application', collection_name='applications')
    map.connect('applications/:application_id/model', controller='model', action='index', _member_name='model', _collection_name='model', _parent_resource=app_resource)
