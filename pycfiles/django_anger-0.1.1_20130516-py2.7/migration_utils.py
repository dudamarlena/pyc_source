...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/django_anger/migration_utils.py
# Compiled at: 2013-05-16 15:00:43
import ast, re
...
def is_related(field):
    ...
    True
    """
    return field[0] in ('django.db.models.fields.related.ForeignKey', 'django.db.models.fields.related.OneToOneField',
