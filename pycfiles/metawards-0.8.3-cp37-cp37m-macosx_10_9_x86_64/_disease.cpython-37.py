...
# [GCC 8.4.0]
# Embedded file name: /Users/chris/GitHub/MetaWards/build/lib.macosx-10.9-x86_64-3.7/metawards/_disease.py
...
class Disease:
    ...
    def __eq__(self, other):
        return self.beta == other.beta and self.progress == other.progress and self.too_ill_to_move == other.too_ill_to_move and self.contrib_foi == other.contrib_foi
    ...
    def load(disease: str='ncov', repository: str=None, folder: str=_default_folder_name, filename: str=None):
        ...
        disease = Disease(beta=(data['beta']), progress=(data['progress']),
