...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/sciann/utils/validations.py
...
def validate_functional(f):
    ...
    if isinstance(f, (sciann.Functional, sciann.functionals.RNNFunctional)):
        return True
    raise ValueError('These operations can only be applied to the `functional` object. Use `Keras` or `TensorFlow` functions when applying to tensors.')
...
def validate_constraint(f):
    ...
    if isinstance(f, sciann.Constraint):
        return True
    raise ValueError('These operations can only be applied to the `Constraint` object. Use `Keras` or `TensorFlow` functions when applying to tensors or layers. ')
...
def validate_parameter(f):
    ...
    if isinstance(f, sciann.Parameter):
        return True
    raise ValueError('These operations can only be applied to the `parameter` object. Use `Keras` or `TensorFlow` functions when applying to tensors.')
...
def validate_field(f):
    ...
    if isinstance(f, (sciann.Field, sciann.functionals.RNNField)):
        return True
    raise ValueError('These operations can only be applied to the `Field` object. Use `Keras` or `TensorFlow` functions when applying to tensors or layers. ')
...
def validate_variable(f):
    ...
    if isinstance(f, (sciann.Variable, sciann.functionals.RadialBasis, sciann.functionals.RNNVariable)):
        return True
    raise ValueError('These operations can only be applied to the `Variable` object. Use `Keras` or `TensorFlow` functions when applying to tensors or layers. ')
...
def validate_scimodel(f):
    ...
    if isinstance(f, sciann.SciModel):
        return True
    raise ValueError('These operations can only be applied to the `SciModel` object. Use `Keras` or `TensorFlow` functions when applying to tensors or layers. ')