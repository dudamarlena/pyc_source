...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/sciann/functionals/field.py
...
class Field(Dense):
    ...
    def __init__(self, name=None, units=1, activation=linear, kernel_initializer=default_kernel_initializer(), bias_initializer=default_bias_initializer(), trainable=True, dtype=None):
        ...
        super(Field, self).__init__(units=units,
