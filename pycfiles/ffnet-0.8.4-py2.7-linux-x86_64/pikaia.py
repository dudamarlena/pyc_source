...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ffnet/pikaia.py
...
def pikaia(ff, n, ff_extra_args=(), individuals=100, generations=500, digits=6, crossover=0.85, mutation=2, initrate=0.005, minrate=0.0005, maxrate=0.25, fitnessdiff=1.0, reproduction=3, elitism=0, verbosity=0):
    """
    ...
    del randint
    ctrl = [
     individuals, generations, digits, crossover, mutation, initrate,
