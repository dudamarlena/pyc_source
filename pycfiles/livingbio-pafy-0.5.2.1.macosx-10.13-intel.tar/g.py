...
# [GCC 8.4.0]
# Embedded file name: /Users/davidchen/repos/django-video-composer/venv/lib/python2.7/site-packages/pafy/g.py
...
urls = {'gdata': 'https://www.googleapis.com/youtube/v3/', 'watchv': 'http://www.youtube.com/watch?v=%s', 
   'playlist': 'http://www.youtube.com/list_ajax?style=json&action_get_list=1&list=%s', 
   ...
   'vidinfo': 'https://www.youtube.com/get_video_info?video_id=%s&eurl=https://youtube.googleapis.com/v/%s&sts=%s', 
