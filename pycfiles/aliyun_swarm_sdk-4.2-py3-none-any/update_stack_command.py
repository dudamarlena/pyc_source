...
# Embedded file name: /root/Documents/ros-cli/ros/stacks/update_stack_command.py
# Compiled at: 2017-08-09 04:01:30
from aliyunsdkros.request.v20150901 import UpdateStackRequest
import ros.apps.config as connect, ros.apps.utils as utils, json, sys
reload(sys)
sys.setdefaultencoding('utf-8')

def setup(subparsers):
    parser = subparsers.add_parser('update-stack', help='Update a stack as specified in the template')
    ...
    parser.set_defaults(func=update_stack)
...
def prepare_request(args):
    req = UpdateStackRequest.UpdateStackRequest()
