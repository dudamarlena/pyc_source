...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/web2py_utils/email_sms/carriers.py
# Compiled at: 2010-05-09 22:17:01
CARRIERS = [
 {'pk': 1, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Speakout (USA GSM)', 
               'gateway': '%(phone_number)s@cingularme.com'}},
 {'pk': 2, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Airtel (Karnataka, India)', 
               'gateway': '%(phone_number)s@airtelkk.com'}},
 {'pk': 3, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Airtel Wireless (Montana, USA)', 
               'gateway': '%(phone_number)s@sms.airtelmontana.com'}},
 {'pk': 4, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Alaska Communications Systems', 
               'gateway': '%(phone_number)s@msg.acsalaska.com'}},
 {'pk': 5, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Alltel Wireless', 
 ...
 {'pk': 7, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'AT&T Wireless', 
               'gateway': '%(phone_number)s@txt.att.net'}},
 {'pk': 8, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'AT&T Mobility (formerly Cingular)', 
               'gateway': '%(phone_number)s@txt.att.net'}},
 {'pk': 9, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'AT&T Enterprise Paging', 
               'gateway': '%(phone_number)s@page.att.net'}},
 {'pk': 10, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Bell Mobility & Solo Mobile (Canada)', 
               'gateway': '%(phone_number)s@txt.bell.ca or'}},
 {'pk': 11, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Boost Mobile', 
               'gateway': '%(phone_number)s@myboostmobile.com'}},
 {'pk': 12, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'BPL Mobile (Mumbai, India)', 
               'gateway': '%(phone_number)s@bplmobile.com'}},
 {'pk': 13, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Cellular One (Dobson)', 
               'gateway': '%(phone_number)s@mobile.celloneusa.com'}},
 {'pk': 14, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Cingular (Postpaid)', 
               'gateway': '%(phone_number)s@cingularme.com'}},
 {'pk': 15, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Centennial Wireless', 
               'gateway': '%(phone_number)s@cwemail.com'}},
 {'pk': 16, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Cingular (GoPhone prepaid)', 
               'gateway': '%(phone_number)s@cingularme.com'}},
 {'pk': 17, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Claro (Brasil)', 
               'gateway': '%(phone_number)s@clarotorpedo.com.br'}},
 {'pk': 18, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Claro (Nicaragua)', 
 ...
 {'pk': 22, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Emtel (Mauritius)', 
               'gateway': '%(phone_number)s@emtelworld.net'}},
 {'pk': 23, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Fido(Canada)', 
               'gateway': '%(phone_number)s@fido.ca'}},
 {'pk': 24, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'General Communications Inc.', 
               'gateway': '%(phone_number)s@msg.gci.net'}},
 {'pk': 25, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Globalstar (satellite)', 
 ...
 {'pk': 60, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Virgin Mobile (Canada)', 
               'gateway': '%(phone_number)s@vmobile.ca'}},
 {'pk': 61, 
    'model': 'sms.Carrier', 
    'fields': {'name': 'Virgin Mobile (USA)', 
