...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/assimulo/examples/glimda_vanderpol.py
...
def run_example(with_plots=True):
    ...
    y0 = [
     2.0, -0.6]
    yd0 = [-0.6, -200000.0]
    imp_mod = Implicit_Problem(f, y0, yd0, name='Glimbda Example: Van der Pol (implicit)')
    imp_sim = GLIMDA(imp_mod)
    imp_sim.atol = 0.0001
    imp_sim.rtol = 0.0001
