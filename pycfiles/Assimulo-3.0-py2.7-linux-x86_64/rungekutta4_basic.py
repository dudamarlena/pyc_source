...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/assimulo/examples/rungekutta4_basic.py
...
def run_example(with_plots=True):
    ...
    exp_mod = Explicit_Problem(f, 4.0, name='RK4 Example: $\\dot y = - y$')
    exp_sim = RungeKutta4(exp_mod)
    t, y = exp_sim.simulate(5, 100)
