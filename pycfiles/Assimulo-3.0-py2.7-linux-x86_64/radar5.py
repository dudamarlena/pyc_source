...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/assimulo/solvers/radar5.py
# Compiled at: 2017-12-28 04:09:42
import numpy as N, scipy as S, scipy.linalg as LIN, copy
...
class Radar5ODE(Explicit_ODE):
    ...
    def __init__(self, problem):
        ...
        self.options['tckbp'] = 5.0
        self.options['ieflag'] = 0
        self.options['mxst'] = 100
        ...
        self.statistics['nfcn'] = 0
        self.statistics['njac'] = 0
        self.statistics['njacfcn'] = 0
        self.statistics['errfail'] = 0
        self.statistics['nlu'] = 0
        self.statistics['nstepstotal'] = 0
    ...
    def integrate(self, t, y, tf, opts):
        ...
        self._opts = opts
        a = (
         radar5.assimulo_radar5(self.F, self.problem.phi, self.arglag, t, y.copy(), tf, self.inith, self.rtol * N.ones(self.problem_info['dim']), self.atol, ITOL, jac_dummy, IJAC, MLJAC, MUJAC, jaclag_dummy, nlags, njacl, IMAS, self._solout, IOUT, WORK, IWORK, self.grid.tolist() + [0.0], self._ipast, mas_dummy, MLMAS, MUMAS, past),)
