...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/assimulo/examples/lsodar_with_disc.py
...
class Extended_Problem(Explicit_Problem):
    ...
    def init_mode(self, solver):
        """
        Initialize the ODE with the new conditions.
        """
