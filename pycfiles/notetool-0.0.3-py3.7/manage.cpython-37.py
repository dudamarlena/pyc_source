...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notetool/secret/manage.py
# Compiled at: 2020-02-10 06:07:49
# Size of source mod 2**32: 3173 bytes
import hashlib, logging, os
from cryptography.fernet import Fernet
__all__ = [
 'encrypt', 'decrypt', 'SecretManage', 'get_file_md5', 'local_secret_path',
 'set_secret_path']
...
def get_file_md5(path, chunk=4096):
    m = hashlib.md5()
