...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notetool/pathtool.py
# Compiled at: 2019-12-29 22:51:37
# Size of source mod 2**32: 7671 bytes
import logging, os
logger = logging.getLogger(__name__)
__all__ = [
 'exists', 'exist_and_create', 'exists_file', 'exists_path', 'meta', 'list_file', 'LocalPath',
