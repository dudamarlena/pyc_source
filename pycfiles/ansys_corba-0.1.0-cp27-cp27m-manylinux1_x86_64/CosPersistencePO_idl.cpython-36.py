...
# [GCC 8.4.0]
# Embedded file name: ./CosPersistencePO_idl.py
...
_0_CosPersistencePO = omniORB.openModule('CosPersistencePO', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistencePO.idl')
_0_CosPersistencePO__POA = omniORB.openModule('CosPersistencePO__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistencePO.idl')
_0_CosPersistencePO._d_PO = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePO/PO:1.0', 'PO')
...
PO._d__set_p = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistencePID/PID:1.0'],), (), None)
...
class PO(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_p':_0_CosPersistencePO.PO._d__get_p, 
     '_set_p':_0_CosPersistencePO.PO._d__set_p,  'connect':_0_CosPersistencePO.PO._d_connect,  'disconnect':_0_CosPersistencePO.PO._d_disconnect,  'store':_0_CosPersistencePO.PO._d_store,  'restore':_0_CosPersistencePO.PO._d_restore,  'delete':_0_CosPersistencePO.PO._d_delete}
...
del PO
__name__ = 'CosPersistencePO'
_0_CosPersistencePO._d_SD = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePO/SD:1.0', 'SD')
...
class SD(PortableServer.Servant):
    ...
    _omni_op_d = {'pre_store':_0_CosPersistencePO.SD._d_pre_store, 
     'post_restore':_0_CosPersistencePO.SD._d_post_restore}
