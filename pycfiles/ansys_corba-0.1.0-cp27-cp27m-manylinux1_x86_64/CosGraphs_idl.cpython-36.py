...
# [GCC 8.4.0]
# Embedded file name: ./CosGraphs_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 36584 bytes
...
__name__ = 'CosGraphs'
_0_CosGraphs = omniORB.openModule('CosGraphs', '/tmp/corba/omni/share/idl/omniORB/COS/CosGraphs.idl')
_0_CosGraphs__POA = omniORB.openModule('CosGraphs__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosGraphs.idl')
_0_CosGraphs._d_TraversalFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/TraversalFactory:1.0', 'TraversalFactory')
omniORB.typeMapping['IDL:omg.org/CosGraphs/TraversalFactory:1.0'] = _0_CosGraphs._d_TraversalFactory
_0_CosGraphs._d_Traversal = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/Traversal:1.0', 'Traversal')
omniORB.typeMapping['IDL:omg.org/CosGraphs/Traversal:1.0'] = _0_CosGraphs._d_Traversal
_0_CosGraphs._d_TraversalCriteria = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/TraversalCriteria:1.0', 'TraversalCriteria')
omniORB.typeMapping['IDL:omg.org/CosGraphs/TraversalCriteria:1.0'] = _0_CosGraphs._d_TraversalCriteria
_0_CosGraphs._d_Node = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/Node:1.0', 'Node')
omniORB.typeMapping['IDL:omg.org/CosGraphs/Node:1.0'] = _0_CosGraphs._d_Node
_0_CosGraphs._d_NodeFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/NodeFactory:1.0', 'NodeFactory')
omniORB.typeMapping['IDL:omg.org/CosGraphs/NodeFactory:1.0'] = _0_CosGraphs._d_NodeFactory
_0_CosGraphs._d_Role = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/Role:1.0', 'Role')
omniORB.typeMapping['IDL:omg.org/CosGraphs/Role:1.0'] = _0_CosGraphs._d_Role
_0_CosGraphs._d_EdgeIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosGraphs/EdgeIterator:1.0', 'EdgeIterator')
...
_0_CosGraphs._d_PropagationValue = (
 omniORB.tcInternal.tv_enum, _0_CosGraphs.PropagationValue._NP_RepositoryId, 'PropagationValue', _0_CosGraphs.PropagationValue._items)
...
_0_CosGraphs._d_Mode = (
 omniORB.tcInternal.tv_enum, _0_CosGraphs.Mode._NP_RepositoryId, 'Mode', _0_CosGraphs.Mode._items)
...
TraversalFactory._d_create_traversal_on = (
 (
  omniORB.typeMapping['IDL:omg.org/CosGraphs/NodeHandle:1.0'], omniORB.typeMapping['IDL:omg.org/CosGraphs/TraversalCriteria:1.0'], omniORB.typeMapping['IDL:omg.org/CosGraphs/Mode:1.0']), (omniORB.typeMapping['IDL:omg.org/CosGraphs/Traversal:1.0'],), None)
...
class Traversal:
    ...
    _d_ScopedEndPoint = _0_CosGraphs.Traversal._d_ScopedEndPoint = (
     omniORB.tcInternal.tv_struct, ScopedEndPoint, ScopedEndPoint._NP_RepositoryId, 'ScopedEndPoint', 'point', omniORB.typeMapping['IDL:omg.org/CosGraphs/EndPoint:1.0'], 'id', omniORB.typeMapping['IDL:omg.org/CosGraphs/Traversal/TraversalScopedId:1.0'])
    ...
    _d_ScopedRelationship = _0_CosGraphs.Traversal._d_ScopedRelationship = (
     omniORB.tcInternal.tv_struct, ScopedRelationship, ScopedRelationship._NP_RepositoryId, 'ScopedRelationship', 'scoped_relationship', omniORB.typeMapping['IDL:omg.org/CosRelationships/RelationshipHandle:1.0'], 'id', omniORB.typeMapping['IDL:omg.org/CosGraphs/Traversal/TraversalScopedId:1.0'])
...
Traversal._d_next_n = (
 (
  omniORB.tcInternal.tv_short,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosGraphs/Traversal/ScopedEdges:1.0']), None)
...
del Traversal
del _objref_Traversal
__name__ = 'CosGraphs__POA'

class Traversal(PortableServer.Servant):
    _NP_RepositoryId = _0_CosGraphs.Traversal._NP_RepositoryId
    _omni_op_d = {'next_one':_0_CosGraphs.Traversal._d_next_one, 
     'next_n':_0_CosGraphs.Traversal._d_next_n,  'destroy':_0_CosGraphs.Traversal._d_destroy}
...
class TraversalCriteria:
    ...
    _d_WeightedEdge = _0_CosGraphs.TraversalCriteria._d_WeightedEdge = (
     omniORB.tcInternal.tv_struct, WeightedEdge, WeightedEdge._NP_RepositoryId, 'WeightedEdge', 'the_edge', omniORB.typeMapping['IDL:omg.org/CosGraphs/Edge:1.0'], 'weight', omniORB.tcInternal.tv_ulong, 'next_nodes', (omniORB.tcInternal.tv_sequence, omniORB.typeMapping['IDL:omg.org/CosGraphs/NodeHandle:1.0'], 0))
...
TraversalCriteria._d_visit_node = (
 (
  omniORB.typeMapping['IDL:omg.org/CosGraphs/NodeHandle:1.0'], omniORB.typeMapping['IDL:omg.org/CosGraphs/Mode:1.0']), (), None)
...
del _objref_TraversalCriteria
__name__ = 'CosGraphs__POA'

class TraversalCriteria(PortableServer.Servant):
    _NP_RepositoryId = _0_CosGraphs.TraversalCriteria._NP_RepositoryId
    _omni_op_d = {'visit_node':_0_CosGraphs.TraversalCriteria._d_visit_node, 
     'next_one':_0_CosGraphs.TraversalCriteria._d_next_one,  'next_n':_0_CosGraphs.TraversalCriteria._d_next_n,  'destroy':_0_CosGraphs.TraversalCriteria._d_destroy}
...
class Node(_0_CosObjectIdentity.IdentifiableObject):
    ...
    _d_NoSuchRole = (
     omniORB.tcInternal.tv_except, NoSuchRole, NoSuchRole._NP_RepositoryId, 'NoSuchRole')
    ...
    _d_DuplicateRoleType = (
     omniORB.tcInternal.tv_except, DuplicateRoleType, DuplicateRoleType._NP_RepositoryId, 'DuplicateRoleType')
...
Node._d_roles_of_type = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/InterfaceDef:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosGraphs/Node/Roles:1.0'],), None)
...
class Node(_0_CosObjectIdentity__POA.IdentifiableObject):
    ...
    _omni_op_d = {'_get_related_object':_0_CosGraphs.Node._d__get_related_object, 
     '_get_roles_of_node':_0_CosGraphs.Node._d__get_roles_of_node,  'roles_of_type':_0_CosGraphs.Node._d_roles_of_type,  'add_role':_0_CosGraphs.Node._d_add_role,  'remove_role':_0_CosGraphs.Node._d_remove_role}
...
NodeFactory._d_create_node = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/Object:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosGraphs/Node:1.0'],), None)
...
Role._d_get_edges = (
 (
  omniORB.tcInternal.tv_long,), (omniORB.typeMapping['IDL:omg.org/CosGraphs/Edges:1.0'], omniORB.typeMapping['IDL:omg.org/CosGraphs/EdgeIterator:1.0']), None)
...
EdgeIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosGraphs/Edges:1.0']), None)
...
del EdgeIterator
del _objref_EdgeIterator
__name__ = 'CosGraphs__POA'

class EdgeIterator(PortableServer.Servant):
    _NP_RepositoryId = _0_CosGraphs.EdgeIterator._NP_RepositoryId
    _omni_op_d = {'next_one':_0_CosGraphs.EdgeIterator._d_next_one, 
     'next_n':_0_CosGraphs.EdgeIterator._d_next_n,  'destroy':_0_CosGraphs.EdgeIterator._d_destroy}
