...
# [GCC 8.4.0]
# Embedded file name: ./CosStream_idl.py
...
__name__ = 'CosStream'
_0_CosStream = omniORB.openModule('CosStream', '/tmp/corba/omni/share/idl/omniORB/COS/CosStream.idl')
_0_CosStream__POA = omniORB.openModule('CosStream__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosStream.idl')
...
_0_CosStream._d_StreamIO = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/StreamIO:1.0', 'StreamIO')
omniORB.typeMapping['IDL:omg.org/CosStream/StreamIO:1.0'] = _0_CosStream._d_StreamIO
_0_CosStream._d_Node = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/Node:1.0', 'Node')
omniORB.typeMapping['IDL:omg.org/CosStream/Node:1.0'] = _0_CosStream._d_Node
_0_CosStream._d_Role = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/Role:1.0', 'Role')
omniORB.typeMapping['IDL:omg.org/CosStream/Role:1.0'] = _0_CosStream._d_Role
_0_CosStream._d_Relationship = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/Relationship:1.0', 'Relationship')
omniORB.typeMapping['IDL:omg.org/CosStream/Relationship:1.0'] = _0_CosStream._d_Relationship
_0_CosStream._d_Streamable = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/Streamable:1.0', 'Streamable')
...
Streamable._d_externalize_to_stream = (
 (
  omniORB.typeMapping['IDL:omg.org/CosStream/StreamIO:1.0'],), (), None)
...
class Streamable(_0_CosObjectIdentity__POA.IdentifiableObject):
    ...
    _omni_op_d = {'_get_external_form_id':_0_CosStream.Streamable._d__get_external_form_id, 
     'externalize_to_stream':_0_CosStream.Streamable._d_externalize_to_stream,  'internalize_from_stream':_0_CosStream.Streamable._d_internalize_from_stream}
...
del Streamable
__name__ = 'CosStream'
_0_CosStream._d_StreamableFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/StreamableFactory:1.0', 'StreamableFactory')
...
class Node(_0_CosGraphs__POA.Node, _0_CosStream__POA.Streamable):
    ...
    _omni_op_d = {'externalize_node':_0_CosStream.Node._d_externalize_node, 
     'internalize_node':_0_CosStream.Node._d_internalize_node}
...
class Role(_0_CosGraphs__POA.Role):
    ...
    _omni_op_d = {'externalize_role':_0_CosStream.Role._d_externalize_role, 
     'internalize_role':_0_CosStream.Role._d_internalize_role,  'externalize_propagation':_0_CosStream.Role._d_externalize_propagation}
...
Relationship._d_externalize_relationship = (
 (
  omniORB.typeMapping['IDL:omg.org/CosStream/StreamIO:1.0'],), (), None)
...
class Relationship(_0_CosRelationships__POA.Relationship):
    ...
    _omni_op_d = {'externalize_relationship':_0_CosStream.Relationship._d_externalize_relationship, 
     'internalize_relationship':_0_CosStream.Relationship._d_internalize_relationship,  'externalize_propagation':_0_CosStream.Relationship._d_externalize_propagation}
...
del Relationship
__name__ = 'CosStream'
_0_CosStream._d_PropagationCriteriaFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosStream/PropagationCriteriaFactory:1.0', 'PropagationCriteriaFactory')
