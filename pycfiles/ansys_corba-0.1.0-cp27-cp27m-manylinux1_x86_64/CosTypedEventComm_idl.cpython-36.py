...
# [GCC 8.4.0]
# Embedded file name: ./CosTypedEventComm_idl.py
...
_0_CosTypedEventComm = omniORB.openModule('CosTypedEventComm', '/tmp/corba/omni/share/idl/omniORB/COS/CosTypedEventComm.idl')
_0_CosTypedEventComm__POA = omniORB.openModule('CosTypedEventComm__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosTypedEventComm.idl')
_0_CosTypedEventComm._d_TypedPushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTypedEventComm/TypedPushConsumer:1.0', 'TypedPushConsumer')
...
del TypedPushConsumer
__name__ = 'CosTypedEventComm'
_0_CosTypedEventComm._d_TypedPullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTypedEventComm/TypedPullSupplier:1.0', 'TypedPullSupplier')
