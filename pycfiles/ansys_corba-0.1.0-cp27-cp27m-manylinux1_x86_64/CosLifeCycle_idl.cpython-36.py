...
# [GCC 8.4.0]
# Embedded file name: ./CosLifeCycle_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 18074 bytes
...
_0_CosLifeCycle = omniORB.openModule('CosLifeCycle', '/tmp/corba/omni/share/idl/omniORB/COS/CosLifeCycle.idl')
_0_CosLifeCycle__POA = omniORB.openModule('CosLifeCycle__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosLifeCycle.idl')
...
_0_CosLifeCycle._d_FactoryFinder = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosLifeCycle/FactoryFinder:1.0', 'FactoryFinder')
...
FactoryFinder._d_find_factories = (
 (
  omniORB.typeMapping['IDL:omg.org/CosLifeCycle/Key:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosLifeCycle/Factories:1.0'],), {_0_CosLifeCycle.NoFactory._NP_RepositoryId: _0_CosLifeCycle._d_NoFactory})
...
del FactoryFinder
__name__ = 'CosLifeCycle'
_0_CosLifeCycle._d_LifeCycleObject = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosLifeCycle/LifeCycleObject:1.0', 'LifeCycleObject')
...
del LifeCycleObject
del _objref_LifeCycleObject
__name__ = 'CosLifeCycle__POA'

class LifeCycleObject(PortableServer.Servant):
    _NP_RepositoryId = _0_CosLifeCycle.LifeCycleObject._NP_RepositoryId
    _omni_op_d = {'copy':_0_CosLifeCycle.LifeCycleObject._d_copy, 
     'move':_0_CosLifeCycle.LifeCycleObject._d_move,  'remove':_0_CosLifeCycle.LifeCycleObject._d_remove}
...
del LifeCycleObject
__name__ = 'CosLifeCycle'
_0_CosLifeCycle._d_GenericFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosLifeCycle/GenericFactory:1.0', 'GenericFactory')
...
GenericFactory._d_supports = (
 (
  omniORB.typeMapping['IDL:omg.org/CosLifeCycle/Key:1.0'],), (omniORB.tcInternal.tv_boolean,), None)
...
del GenericFactory
del _objref_GenericFactory
__name__ = 'CosLifeCycle__POA'

class GenericFactory(PortableServer.Servant):
    _NP_RepositoryId = _0_CosLifeCycle.GenericFactory._NP_RepositoryId
    _omni_op_d = {'supports':_0_CosLifeCycle.GenericFactory._d_supports, 
     'create_object':_0_CosLifeCycle.GenericFactory._d_create_object}
