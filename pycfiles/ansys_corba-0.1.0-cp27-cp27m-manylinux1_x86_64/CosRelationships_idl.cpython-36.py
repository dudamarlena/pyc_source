...
# [GCC 8.4.0]
# Embedded file name: ./CosRelationships_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 42499 bytes
...
_0_CosRelationships = omniORB.openModule('CosRelationships', '/tmp/corba/omni/share/idl/omniORB/COS/CosRelationships.idl')
_0_CosRelationships__POA = omniORB.openModule('CosRelationships__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosRelationships.idl')
_0_CosRelationships._d_RoleFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosRelationships/RoleFactory:1.0', 'RoleFactory')
omniORB.typeMapping['IDL:omg.org/CosRelationships/RoleFactory:1.0'] = _0_CosRelationships._d_RoleFactory
_0_CosRelationships._d_RelationshipFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosRelationships/RelationshipFactory:1.0', 'RelationshipFactory')
omniORB.typeMapping['IDL:omg.org/CosRelationships/RelationshipFactory:1.0'] = _0_CosRelationships._d_RelationshipFactory
_0_CosRelationships._d_Relationship = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosRelationships/Relationship:1.0', 'Relationship')
omniORB.typeMapping['IDL:omg.org/CosRelationships/Relationship:1.0'] = _0_CosRelationships._d_Relationship
_0_CosRelationships._d_Role = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosRelationships/Role:1.0', 'Role')
omniORB.typeMapping['IDL:omg.org/CosRelationships/Role:1.0'] = _0_CosRelationships._d_Role
_0_CosRelationships._d_RelationshipIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosRelationships/RelationshipIterator:1.0', 'RelationshipIterator')
...
class RelationshipFactory:
    ...
    _d_NamedRoleType = _0_CosRelationships.RelationshipFactory._d_NamedRoleType = (
     omniORB.tcInternal.tv_struct, NamedRoleType, NamedRoleType._NP_RepositoryId, 'NamedRoleType', 'name', omniORB.typeMapping['IDL:omg.org/CosRelationships/RoleName:1.0'], 'named_role_type', omniORB.typeMapping['IDL:omg.org/CORBA/InterfaceDef:1.0'])
    ...
    _d_RoleTypeError = (
     omniORB.tcInternal.tv_except, RoleTypeError, RoleTypeError._NP_RepositoryId, 'RoleTypeError', 'culprits', omniORB.typeMapping['IDL:omg.org/CosRelationships/NamedRoles:1.0'])
    ...
    _d_MaxCardinalityExceeded = (
     omniORB.tcInternal.tv_except, MaxCardinalityExceeded, MaxCardinalityExceeded._NP_RepositoryId, 'MaxCardinalityExceeded', 'culprits', omniORB.typeMapping['IDL:omg.org/CosRelationships/NamedRoles:1.0'])
    ...
    _d_DegreeError = (
     omniORB.tcInternal.tv_except, DegreeError, DegreeError._NP_RepositoryId, 'DegreeError', 'required_degree', omniORB.tcInternal.tv_ushort)
    ...
    _d_DuplicateRoleName = (
     omniORB.tcInternal.tv_except, DuplicateRoleName, DuplicateRoleName._NP_RepositoryId, 'DuplicateRoleName', 'culprits', omniORB.typeMapping['IDL:omg.org/CosRelationships/NamedRoles:1.0'])
    ...
    _d_UnknownRoleName = (
     omniORB.tcInternal.tv_except, UnknownRoleName, UnknownRoleName._NP_RepositoryId, 'UnknownRoleName', 'culprits', omniORB.typeMapping['IDL:omg.org/CosRelationships/NamedRoles:1.0'])
...
del _objref_RelationshipFactory
...
class RelationshipFactory(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_relationship_type':_0_CosRelationships.RelationshipFactory._d__get_relationship_type, 
     '_get_degree':_0_CosRelationships.RelationshipFactory._d__get_degree,  '_get_named_role_types':_0_CosRelationships.RelationshipFactory._d__get_named_role_types,  'create':_0_CosRelationships.RelationshipFactory._d_create}
...
class Relationship(_0_CosObjectIdentity.IdentifiableObject):
    ...
    _d_CannotUnlink = (
     omniORB.tcInternal.tv_except, CannotUnlink, CannotUnlink._NP_RepositoryId, 'CannotUnlink', 'offending_roles', omniORB.typeMapping['IDL:omg.org/CosRelationships/Roles:1.0'])
...
class Relationship(_0_CosObjectIdentity__POA.IdentifiableObject):
    ...
    _omni_op_d = {'_get_named_roles':_0_CosRelationships.Relationship._d__get_named_roles, 
     'destroy':_0_CosRelationships.Relationship._d_destroy}
...
class Role:
    ...
    _d_UnknownRoleName = (
     omniORB.tcInternal.tv_except, UnknownRoleName, UnknownRoleName._NP_RepositoryId, 'UnknownRoleName')
    _tc_UnknownRoleName = omniORB.tcInternal.createTypeCode(_d_UnknownRoleName)
    omniORB.registerType(UnknownRoleName._NP_RepositoryId, _d_UnknownRoleName, _tc_UnknownRoleName)
    ...
    _d_RelationshipTypeError = (
     omniORB.tcInternal.tv_except, RelationshipTypeError, RelationshipTypeError._NP_RepositoryId, 'RelationshipTypeError')
    ...
    _d_CannotDestroyRelationship = (
     omniORB.tcInternal.tv_except, CannotDestroyRelationship, CannotDestroyRelationship._NP_RepositoryId, 'CannotDestroyRelationship', 'offenders', omniORB.typeMapping['IDL:omg.org/CosRelationships/RelationshipHandles:1.0'])
    ...
    _d_ParticipatingInRelationship = (
     omniORB.tcInternal.tv_except, ParticipatingInRelationship, ParticipatingInRelationship._NP_RepositoryId, 'ParticipatingInRelationship', 'the_relationships', omniORB.typeMapping['IDL:omg.org/CosRelationships/RelationshipHandles:1.0'])
...
Role._d_get_other_related_object = (
 (
  omniORB.typeMapping['IDL:omg.org/CosRelationships/RelationshipHandle:1.0'], omniORB.typeMapping['IDL:omg.org/CosRelationships/RoleName:1.0']), (omniORB.typeMapping['IDL:omg.org/CosRelationships/RelatedObject:1.0'],), {_0_CosRelationships.Role.UnknownRoleName._NP_RepositoryId: _0_CosRelationships.Role._d_UnknownRoleName, _0_CosRelationships.Role.UnknownRelationship._NP_RepositoryId: _0_CosRelationships.Role._d_UnknownRelationship})
...
class Role(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_related_object':_0_CosRelationships.Role._d__get_related_object, 
     'get_other_related_object':_0_CosRelationships.Role._d_get_other_related_object,  'get_other_role':_0_CosRelationships.Role._d_get_other_role,  'get_relationships':_0_CosRelationships.Role._d_get_relationships,  'destroy_relationships':_0_CosRelationships.Role._d_destroy_relationships,  'destroy':_0_CosRelationships.Role._d_destroy,  'check_minimum_cardinality':_0_CosRelationships.Role._d_check_minimum_cardinality,  'link':_0_CosRelationships.Role._d_link,  'unlink':_0_CosRelationships.Role._d_unlink}
...
class RoleFactory:
    ...
    _d_NilRelatedObject = (
     omniORB.tcInternal.tv_except, NilRelatedObject, NilRelatedObject._NP_RepositoryId, 'NilRelatedObject')
    ...
    _d_RelatedObjectTypeError = (
     omniORB.tcInternal.tv_except, RelatedObjectTypeError, RelatedObjectTypeError._NP_RepositoryId, 'RelatedObjectTypeError')
...
del RoleFactory
del _objref_RoleFactory
__name__ = 'CosRelationships__POA'

class RoleFactory(PortableServer.Servant):
    _NP_RepositoryId = _0_CosRelationships.RoleFactory._NP_RepositoryId
    _omni_op_d = {'_get_role_type':_0_CosRelationships.RoleFactory._d__get_role_type, 
     '_get_max_cardinality':_0_CosRelationships.RoleFactory._d__get_max_cardinality,  '_get_min_cardinality':_0_CosRelationships.RoleFactory._d__get_min_cardinality,  '_get_related_object_types':_0_CosRelationships.RoleFactory._d__get_related_object_types,  'create_role':_0_CosRelationships.RoleFactory._d_create_role}
...
RelationshipIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosRelationships/RelationshipHandles:1.0']), None)
...
del _objref_RelationshipIterator
__name__ = 'CosRelationships__POA'
...
class RelationshipIterator(PortableServer.Servant):
    ...
    _omni_op_d = {'next_one':_0_CosRelationships.RelationshipIterator._d_next_one, 
     'next_n':_0_CosRelationships.RelationshipIterator._d_next_n,  'destroy':_0_CosRelationships.RelationshipIterator._d_destroy}
