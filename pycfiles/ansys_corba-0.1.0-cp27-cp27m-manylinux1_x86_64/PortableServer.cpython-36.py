...
# [GCC 8.4.0]
# Embedded file name: ./PortableServer.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 31960 bytes
import _omnipy, omniORB
...
class Servant(object):
    ...
    def _get_interface(self):
        ...
        if ir is None:
            raise CORBA.INTF_REPOS(omniORB.INTF_REPOS_NotAvailable, CORBA.COMPLETED_NO)
...
class POAManager(CORBA.Object):
    ...
    _d_AdapterInactive = (
     omniORB.tcInternal.tv_except, AdapterInactive,
     AdapterInactive._NP_RepositoryId, 'AdapterInactive')
    _tc_AdapterInactive = omniORB.tcInternal.createTypeCode(_d_AdapterInactive)
    omniORB.registerType(AdapterInactive._NP_RepositoryId, _d_AdapterInactive, _tc_AdapterInactive)
    ...
    _d_State = (
     omniORB.tcInternal.tv_enum, State._NP_RepositoryId,
     'State', State._items)
...
class POA(CORBA.Object):
    ...
    def _get_the_POAManager(self):
        try:
            return self._POA__manager
        except AttributeError:
            self._POA__manager = self._obj._get_the_POAManager()
            return self._POA__manager
    ...
    omniORB.registerType(AdapterAlreadyExists._NP_RepositoryId, _d_AdapterAlreadyExists, _tc_AdapterAlreadyExists)
    ...
    omniORB.registerType(AdapterNonExistent._NP_RepositoryId, _d_AdapterNonExistent, _tc_AdapterNonExistent)
    ...
    _d_InvalidPolicy = (
     omniORB.tcInternal.tv_except, InvalidPolicy,
    ...
    omniORB.registerType(InvalidPolicy._NP_RepositoryId, _d_InvalidPolicy, _tc_InvalidPolicy)

    class NoServant(CORBA.UserException):
        _NP_RepositoryId = 'IDL:omg.org/PortableServer/POA/NoServant:1.0'

    _d_NoServant = (
     omniORB.tcInternal.tv_except, NoServant,
     NoServant._NP_RepositoryId, 'NoServant')
    _tc_NoServant = omniORB.tcInternal.createTypeCode(_d_NoServant)
    omniORB.registerType(NoServant._NP_RepositoryId, _d_NoServant, _tc_NoServant)
    ...
    omniORB.registerType(ObjectAlreadyActive._NP_RepositoryId, _d_ObjectAlreadyActive, _tc_ObjectAlreadyActive)

    class ObjectNotActive(CORBA.UserException):
        _NP_RepositoryId = 'IDL:omg.org/PortableServer/POA/ObjectNotActive:1.0'

    _d_ObjectNotActive = (
     omniORB.tcInternal.tv_except, ObjectNotActive,
     ObjectNotActive._NP_RepositoryId, 'ObjectNotActive')
    _tc_ObjectNotActive = omniORB.tcInternal.createTypeCode(_d_ObjectNotActive)
    omniORB.registerType(ObjectNotActive._NP_RepositoryId, _d_ObjectNotActive, _tc_ObjectNotActive)
...
class Current(CORBA.Object):
    ...
    _d_NoContext = (
     omniORB.tcInternal.tv_except, NoContext,
     NoContext._NP_RepositoryId, 'NoContext')
    _tc_NoContext = omniORB.tcInternal.createTypeCode(_d_NoContext)
    omniORB.registerType(NoContext._NP_RepositoryId, _d_NoContext, _tc_NoContext)
...
_d_ForwardRequest = (
 omniORB.tcInternal.tv_except, ForwardRequest,
...
omniORB.registerType(ForwardRequest._NP_RepositoryId, _d_ForwardRequest, _tc_ForwardRequest)
...
ThreadPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/ThreadPolicyValue:1.0', (
 ORB_CTRL_MODEL, SINGLE_THREAD_MODEL, MAIN_THREAD_MODEL))
_d_ThreadPolicyValue = (
...
omniORB.registerType(ThreadPolicyValue._NP_RepositoryId, _d_ThreadPolicyValue, _tc_ThreadPolicyValue)
TRANSIENT = omniORB.EnumItem('TRANSIENT', 0)
PERSISTENT = omniORB.EnumItem('PERSISTENT', 1)
LifespanPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/LifespanPolicyValue:1.0', (
 TRANSIENT, PERSISTENT))
_d_LifespanPolicyValue = (
 omniORB.tcInternal.tv_enum,
...
omniORB.registerType(LifespanPolicyValue._NP_RepositoryId, _d_LifespanPolicyValue, _tc_LifespanPolicyValue)
UNIQUE_ID = omniORB.EnumItem('UNIQUE_ID', 0)
MULTIPLE_ID = omniORB.EnumItem('MULTIPLE_ID', 1)
IdUniquenessPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/IdUniquenessPolicyValue:1.0', (
 UNIQUE_ID, MULTIPLE_ID))
_d_IdUniquenessPolicyValue = (
 omniORB.tcInternal.tv_enum,
...
omniORB.registerType(IdUniquenessPolicyValue._NP_RepositoryId, _d_IdUniquenessPolicyValue, _tc_IdUniquenessPolicyValue)
USER_ID = omniORB.EnumItem('USER_ID', 0)
SYSTEM_ID = omniORB.EnumItem('SYSTEM_ID', 1)
IdAssignmentPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/IdAssignmentPolicyValue:1.0', (
 USER_ID, SYSTEM_ID))
_d_IdAssignmentPolicyValue = (
 omniORB.tcInternal.tv_enum,
...
omniORB.registerType(IdAssignmentPolicyValue._NP_RepositoryId, _d_IdAssignmentPolicyValue, _tc_IdAssignmentPolicyValue)
...
ImplicitActivationPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/ImplicitActivationPolicyValue:1.0', (
...
omniORB.registerType(ImplicitActivationPolicyValue._NP_RepositoryId, _d_ImplicitActivationPolicyValue, _tc_ImplicitActivationPolicyValue)
RETAIN = omniORB.EnumItem('RETAIN', 0)
NON_RETAIN = omniORB.EnumItem('NON_RETAIN', 1)
ServantRetentionPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/ServantRetentionPolicyValue:1.0', (
 RETAIN, NON_RETAIN))
...
omniORB.registerType(ServantRetentionPolicyValue._NP_RepositoryId, _d_ServantRetentionPolicyValue, _tc_ServantRetentionPolicyValue)
...
RequestProcessingPolicyValue = omniORB.Enum('IDL:omg.org/PortableServer/RequestProcessingPolicyValue:1.0', (
...
omniORB.registerType(RequestProcessingPolicyValue._NP_RepositoryId, _d_RequestProcessingPolicyValue, _tc_RequestProcessingPolicyValue)
_d_ServantManager = (
...
omniORB.registerType(ServantManager._NP_RepositoryId, _d_ServantManager, _tc_ServantManager)
...
class ServantActivator(ServantManager):
    ...
    def incarnate(self, oid, adapter):
        raise CORBA.NO_IMPLEMENT(omniORB.NO_IMPLEMENT_NoPythonMethod, CORBA.COMPLETED_NO)

    def etherialize(self, oid, adapter, serv, cleanup_in_progress, remaining_activations):
        raise CORBA.NO_IMPLEMENT(omniORB.NO_IMPLEMENT_NoPythonMethod, CORBA.COMPLETED_NO)


_tc_ServantActivator = omniORB.tcInternal.createTypeCode(_d_ServantActivator)
omniORB.registerType(ServantActivator._NP_RepositoryId, _d_ServantActivator, _tc_ServantActivator)
ServantActivator._d_incarnate = (
 (
  _d_ObjectId, _d_POA), (_d_Servant,),
 {ForwardRequest._NP_RepositoryId: _d_ForwardRequest})
ServantActivator._d_etherealize = (
 (
  _d_ObjectId, _d_POA, _d_Servant,
...
class _objref_ServantActivator(_objref_ServantManager):
    ...
    def incarnate(self, oid, adapter):
        return self._obj.invoke('incarnate', ServantActivator._d_incarnate, (
         oid, adapter))

    def etherealize(self, oid, adapter, serv, cleanup_in_progress, remaining_activations):
        return self._obj.invoke('etherialize', ServantActivator._d_etherialize, (
         oid, adapter, serv, cleanup_in_progress,
         remaining_activations))


omniORB.registerObjref(ServantActivator._NP_RepositoryId, _objref_ServantActivator)
_d_ServantLocator = (
 omniORB.tcInternal.tv_local_interface,
...
omniORB.registerType(ServantLocator._NP_RepositoryId, _d_ServantLocator, _tc_ServantLocator)
ServantLocator._d_preinvoke = (
 (
  _d_ObjectId, _d_POA, CORBA._d_Identifier),
 (
...
class _objref_ServantLocator(_objref_ServantManager):
    ...
    def preinvoke(self, oid, adapter, operation):
        return self._obj.invoke('preinvoke', ServantLocator._d_preinvoke, (
         oid, adapter, operation))

    def postinvoke(self, oid, adapter, operation, the_cookie, the_servant):
        return self._obj.invoke('postinvoke', ServantLocator._d_postinvoke, (
         oid, adapter, operation,
...
omniORB.registerType(AdapterActivator._NP_RepositoryId, _d_AdapterActivator, _tc_AdapterActivator)
...
class _objref_AdapterActivator(CORBA.Object):
    ...
    def unknown_adapter(self, parent, name):
        return self._obj.invoke('unknown_adapter', AdapterActivator._d_unknown_adapter, (
         parent, name))


omniORB.registerObjref(AdapterActivator._NP_RepositoryId, _objref_AdapterActivator)