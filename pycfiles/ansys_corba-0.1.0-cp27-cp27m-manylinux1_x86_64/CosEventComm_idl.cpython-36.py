...
# Size of source mod 2**32: 10041 bytes
...
_0_CosEventComm = omniORB.openModule('CosEventComm', '/tmp/corba/omni/share/idl/omniORB/COS/CosEventComm.idl')
_0_CosEventComm__POA = omniORB.openModule('CosEventComm__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosEventComm.idl')
...
_0_CosEventComm._d_PushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventComm/PushConsumer:1.0', 'PushConsumer')
...
PushConsumer._d_push = (
 (
  omniORB.tcInternal.tv_any,), (), {_0_CosEventComm.Disconnected._NP_RepositoryId: _0_CosEventComm._d_Disconnected})
...
class PushConsumer(PortableServer.Servant):
    ...
    _omni_op_d = {'push':_0_CosEventComm.PushConsumer._d_push, 
...
_0_CosEventComm._d_PushSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventComm/PushSupplier:1.0', 'PushSupplier')
...
del PushSupplier
__name__ = 'CosEventComm'
_0_CosEventComm._d_PullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventComm/PullSupplier:1.0', 'PullSupplier')
...
class PullSupplier(PortableServer.Servant):
    ...
    _omni_op_d = {'pull':_0_CosEventComm.PullSupplier._d_pull, 
     'try_pull':_0_CosEventComm.PullSupplier._d_try_pull,  'disconnect_pull_supplier':_0_CosEventComm.PullSupplier._d_disconnect_pull_supplier}
...
del PullSupplier
__name__ = 'CosEventComm'
_0_CosEventComm._d_PullConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventComm/PullConsumer:1.0', 'PullConsumer')
