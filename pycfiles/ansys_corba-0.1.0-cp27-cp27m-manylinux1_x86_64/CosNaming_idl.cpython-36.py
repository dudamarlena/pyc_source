...
# [GCC 8.4.0]
# Embedded file name: ./CosNaming_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 25957 bytes
...
__name__ = 'CosNaming'
_0_CosNaming = omniORB.openModule('CosNaming', '/tmp/corba/omni/share/idl/omniORB/COS/CosNaming.idl')
_0_CosNaming__POA = omniORB.openModule('CosNaming__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosNaming.idl')
...
_0_CosNaming._d_BindingType = (
 omniORB.tcInternal.tv_enum, _0_CosNaming.BindingType._NP_RepositoryId, 'BindingType', _0_CosNaming.BindingType._items)
...
del BindingList
_0_CosNaming._d_BindingIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNaming/BindingIterator:1.0', 'BindingIterator')
omniORB.typeMapping['IDL:omg.org/CosNaming/BindingIterator:1.0'] = _0_CosNaming._d_BindingIterator
_0_CosNaming._d_NamingContext = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNaming/NamingContext:1.0', 'NamingContext')
...
class NamingContext:
    ...
    _d_NotFoundReason = (
     omniORB.tcInternal.tv_enum, NotFoundReason._NP_RepositoryId, 'NotFoundReason', NotFoundReason._items)
    ...
    _d_NotFound = (
     omniORB.tcInternal.tv_except, NotFound, NotFound._NP_RepositoryId, 'NotFound', 'why', omniORB.typeMapping['IDL:omg.org/CosNaming/NamingContext/NotFoundReason:1.0'], 'rest_of_name', omniORB.typeMapping['IDL:omg.org/CosNaming/Name:1.0'])
    ...
    _d_CannotProceed = (
     omniORB.tcInternal.tv_except, CannotProceed, CannotProceed._NP_RepositoryId, 'CannotProceed', 'cxt', omniORB.typeMapping['IDL:omg.org/CosNaming/NamingContext:1.0'], 'rest_of_name', omniORB.typeMapping['IDL:omg.org/CosNaming/Name:1.0'])
    ...
    _d_InvalidName = (
     omniORB.tcInternal.tv_except, InvalidName, InvalidName._NP_RepositoryId, 'InvalidName')
    ...
    _d_AlreadyBound = (
     omniORB.tcInternal.tv_except, AlreadyBound, AlreadyBound._NP_RepositoryId, 'AlreadyBound')
    ...
    _d_NotEmpty = (
     omniORB.tcInternal.tv_except, NotEmpty, NotEmpty._NP_RepositoryId, 'NotEmpty')
...
class NamingContext(PortableServer.Servant):
    ...
    _omni_op_d = {'bind':_0_CosNaming.NamingContext._d_bind, 
     'rebind':_0_CosNaming.NamingContext._d_rebind,  'bind_context':_0_CosNaming.NamingContext._d_bind_context,  'rebind_context':_0_CosNaming.NamingContext._d_rebind_context,  'resolve':_0_CosNaming.NamingContext._d_resolve,  'unbind':_0_CosNaming.NamingContext._d_unbind,  'new_context':_0_CosNaming.NamingContext._d_new_context,  'bind_new_context':_0_CosNaming.NamingContext._d_bind_new_context,  'destroy':_0_CosNaming.NamingContext._d_destroy,  'list':_0_CosNaming.NamingContext._d_list}
...
BindingIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosNaming/BindingList:1.0']), None)
...
del BindingIterator
del _objref_BindingIterator
__name__ = 'CosNaming__POA'

class BindingIterator(PortableServer.Servant):
    _NP_RepositoryId = _0_CosNaming.BindingIterator._NP_RepositoryId
    _omni_op_d = {'next_one':_0_CosNaming.BindingIterator._d_next_one, 
     'next_n':_0_CosNaming.BindingIterator._d_next_n,  'destroy':_0_CosNaming.BindingIterator._d_destroy}
...
del BindingIterator
__name__ = 'CosNaming'
_0_CosNaming._d_NamingContextExt = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNaming/NamingContextExt:1.0', 'NamingContextExt')
...
class NamingContextExt(_0_CosNaming.NamingContext):
    ...
    _d_InvalidAddress = (
     omniORB.tcInternal.tv_except, InvalidAddress, InvalidAddress._NP_RepositoryId, 'InvalidAddress')
...
NamingContextExt._d_to_string = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNaming/Name:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosNaming/NamingContextExt/StringName:1.0'],), {_0_CosNaming.NamingContext.InvalidName._NP_RepositoryId: _0_CosNaming.NamingContext._d_InvalidName})
...
del _objref_NamingContextExt
__name__ = 'CosNaming__POA'

class NamingContextExt(_0_CosNaming__POA.NamingContext):
    _NP_RepositoryId = _0_CosNaming.NamingContextExt._NP_RepositoryId
    _omni_op_d = {'to_string':_0_CosNaming.NamingContextExt._d_to_string, 
     'to_name':_0_CosNaming.NamingContextExt._d_to_name,  'to_url':_0_CosNaming.NamingContextExt._d_to_url,  'resolve_str':_0_CosNaming.NamingContextExt._d_resolve_str}
