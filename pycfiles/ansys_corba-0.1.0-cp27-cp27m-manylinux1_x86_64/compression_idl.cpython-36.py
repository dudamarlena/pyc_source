...
# [GCC 8.4.0]
# Embedded file name: ./compression_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 22106 bytes
...
_0_Compression = omniORB.openModule('omniORB.Compression', '/tmp/corba/omni/share/idl/omniORB/compression.idl')
_0_Compression__POA = omniORB.openModule('omniORB.Compression__POA', '/tmp/corba/omni/share/idl/omniORB/compression.idl')
...
del Buffer
_0_Compression._d_CompressorFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/Compression/CompressorFactory:1.0', 'CompressorFactory')
omniORB.typeMapping['IDL:omg.org/Compression/CompressorFactory:1.0'] = _0_Compression._d_CompressorFactory
_0_Compression._d_Compressor = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/Compression/Compressor:1.0', 'Compressor')
...
Compressor._d_compress = (
 (
  omniORB.typeMapping['IDL:omg.org/Compression/Buffer:1.0'], omniORB.typeMapping['IDL:omg.org/Compression/Buffer:1.0']), (omniORB.typeMapping['IDL:omg.org/Compression/Buffer:1.0'],), {_0_Compression.CompressionException._NP_RepositoryId: _0_Compression._d_CompressionException})
...
class Compressor(PortableServer.Servant):
    ...
    _omni_op_d = {'compress':_0_Compression.Compressor._d_compress, 
     'decompress':_0_Compression.Compressor._d_decompress,  '_get_compressor_factory':_0_Compression.Compressor._d__get_compressor_factory,  '_get_compression_level':_0_Compression.Compressor._d__get_compression_level,  '_get_compressed_bytes':_0_Compression.Compressor._d__get_compressed_bytes,  '_get_uncompressed_bytes':_0_Compression.Compressor._d__get_uncompressed_bytes,  '_get_compression_ratio':_0_Compression.Compressor._d__get_compression_ratio}
...
CompressorFactory._d_get_compressor = (
 (
  omniORB.typeMapping['IDL:omg.org/Compression/CompressionLevel:1.0'],), (omniORB.typeMapping['IDL:omg.org/Compression/Compressor:1.0'],), None)
...
del _objref_CompressorFactory
__name__ = 'omniORB.Compression__POA'

class CompressorFactory(PortableServer.Servant):
    _NP_RepositoryId = _0_Compression.CompressorFactory._NP_RepositoryId
    _omni_op_d = {'_get_compressor_id':_0_Compression.CompressorFactory._d__get_compressor_id, 
     'get_compressor':_0_Compression.CompressorFactory._d_get_compressor}
...
_0_Compression._d_CompressionManager = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/Compression/CompressionManager:1.0', 'CompressionManager')
...
CompressionManager._d_register_factory = (
 (
  omniORB.typeMapping['IDL:omg.org/Compression/CompressorFactory:1.0'],), (), {_0_Compression.FactoryAlreadyRegistered._NP_RepositoryId: _0_Compression._d_FactoryAlreadyRegistered})
...
del _objref_CompressionManager
__name__ = 'omniORB.Compression__POA'

class CompressionManager(PortableServer.Servant):
    _NP_RepositoryId = _0_Compression.CompressionManager._NP_RepositoryId
    _omni_op_d = {'register_factory':_0_Compression.CompressionManager._d_register_factory, 
     'unregister_factory':_0_Compression.CompressionManager._d_unregister_factory,  'get_factory':_0_Compression.CompressionManager._d_get_factory,  'get_compressor':_0_Compression.CompressionManager._d_get_compressor,  'get_factories':_0_Compression.CompressionManager._d_get_factories}
