...
# [GCC 8.4.0]
# Embedded file name: ./CosPersistencePID_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 3107 bytes
...
_0_CosPersistencePID = omniORB.openModule('CosPersistencePID', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistencePID.idl')
_0_CosPersistencePID__POA = omniORB.openModule('CosPersistencePID__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistencePID.idl')
_0_CosPersistencePID._d_PID = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePID/PID:1.0', 'PID')
...
class PID(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_datastore_type':_0_CosPersistencePID.PID._d__get_datastore_type, 
     '_set_datastore_type':_0_CosPersistencePID.PID._d__set_datastore_type,  'get_PIDString':_0_CosPersistencePID.PID._d_get_PIDString}
