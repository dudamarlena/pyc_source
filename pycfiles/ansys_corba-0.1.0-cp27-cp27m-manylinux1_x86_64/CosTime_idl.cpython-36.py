...
# [GCC 8.4.0]
# Embedded file name: ./CosTime_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 13442 bytes
...
__name__ = 'CosTime'
_0_CosTime = omniORB.openModule('CosTime', '/tmp/corba/omni/share/idl/omniORB/COS/CosTime.idl')
_0_CosTime__POA = omniORB.openModule('CosTime__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosTime.idl')
...
_0_CosTime._d_TimeComparison = (
 omniORB.tcInternal.tv_enum, _0_CosTime.TimeComparison._NP_RepositoryId, 'TimeComparison', _0_CosTime.TimeComparison._items)
...
_0_CosTime._d_ComparisonType = (
 omniORB.tcInternal.tv_enum, _0_CosTime.ComparisonType._NP_RepositoryId, 'ComparisonType', _0_CosTime.ComparisonType._items)
...
_0_CosTime._d_OverlapType = (
 omniORB.tcInternal.tv_enum, _0_CosTime.OverlapType._NP_RepositoryId, 'OverlapType', _0_CosTime.OverlapType._items)
...
del TimeUnavailable
_0_CosTime._d_TIO = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTime/TIO:1.0', 'TIO')
omniORB.typeMapping['IDL:omg.org/CosTime/TIO:1.0'] = _0_CosTime._d_TIO
_0_CosTime._d_UTO = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTime/UTO:1.0', 'UTO')
...
UTO._d_compare_time = (
 (
  omniORB.typeMapping['IDL:omg.org/CosTime/ComparisonType:1.0'], omniORB.typeMapping['IDL:omg.org/CosTime/UTO:1.0']), (omniORB.typeMapping['IDL:omg.org/CosTime/TimeComparison:1.0'],), None)
...
class UTO(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_time':_0_CosTime.UTO._d__get_time, 
     '_get_inaccuracy':_0_CosTime.UTO._d__get_inaccuracy,  '_get_tdf':_0_CosTime.UTO._d__get_tdf,  '_get_utc_time':_0_CosTime.UTO._d__get_utc_time,  'absolute_time':_0_CosTime.UTO._d_absolute_time,  'compare_time':_0_CosTime.UTO._d_compare_time,  'time_to_interval':_0_CosTime.UTO._d_time_to_interval,  'interval':_0_CosTime.UTO._d_interval}
...
TIO._d_spans = (
 (
  omniORB.typeMapping['IDL:omg.org/CosTime/UTO:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosTime/OverlapType:1.0'], omniORB.typeMapping['IDL:omg.org/CosTime/TIO:1.0']), None)
...
class TIO(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_time_interval':_0_CosTime.TIO._d__get_time_interval, 
     'spans':_0_CosTime.TIO._d_spans,  'overlaps':_0_CosTime.TIO._d_overlaps,  'time':_0_CosTime.TIO._d_time}
...
del TIO
__name__ = 'CosTime'
_0_CosTime._d_TimeService = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTime/TimeService:1.0', 'TimeService')
...
TimeService._d_new_universal_time = (
 (
  omniORB.typeMapping['IDL:omg.org/TimeBase/TimeT:1.0'], omniORB.typeMapping['IDL:omg.org/TimeBase/InaccuracyT:1.0'], omniORB.typeMapping['IDL:omg.org/TimeBase/TdfT:1.0']), (omniORB.typeMapping['IDL:omg.org/CosTime/UTO:1.0'],), None)
...
del TimeService
del _objref_TimeService
__name__ = 'CosTime__POA'

class TimeService(PortableServer.Servant):
    _NP_RepositoryId = _0_CosTime.TimeService._NP_RepositoryId
    _omni_op_d = {'universal_time':_0_CosTime.TimeService._d_universal_time, 
     'secure_universal_time':_0_CosTime.TimeService._d_secure_universal_time,  'new_universal_time':_0_CosTime.TimeService._d_new_universal_time,  'uto_from_utc':_0_CosTime.TimeService._d_uto_from_utc,  'new_interval':_0_CosTime.TimeService._d_new_interval}
