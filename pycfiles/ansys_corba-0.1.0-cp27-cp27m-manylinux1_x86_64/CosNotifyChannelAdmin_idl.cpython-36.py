...
# [GCC 8.4.0]
# Embedded file name: ./CosNotifyChannelAdmin_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 100641 bytes
...
_0_CosNotifyChannelAdmin = omniORB.openModule('CosNotifyChannelAdmin', '/tmp/corba/omni/share/idl/omniORB/COS/CosNotifyChannelAdmin.idl')
_0_CosNotifyChannelAdmin__POA = omniORB.openModule('CosNotifyChannelAdmin__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosNotifyChannelAdmin.idl')
...
del NotConnected
_0_CosNotifyChannelAdmin._d_ConsumerAdmin = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ConsumerAdmin:1.0', 'ConsumerAdmin')
omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/ConsumerAdmin:1.0'] = _0_CosNotifyChannelAdmin._d_ConsumerAdmin
_0_CosNotifyChannelAdmin._d_SupplierAdmin = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/SupplierAdmin:1.0', 'SupplierAdmin')
omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/SupplierAdmin:1.0'] = _0_CosNotifyChannelAdmin._d_SupplierAdmin
_0_CosNotifyChannelAdmin._d_EventChannel = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/EventChannel:1.0', 'EventChannel')
omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/EventChannel:1.0'] = _0_CosNotifyChannelAdmin._d_EventChannel
_0_CosNotifyChannelAdmin._d_EventChannelFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/EventChannelFactory:1.0', 'EventChannelFactory')
...
_0_CosNotifyChannelAdmin._d_ProxyType = (
 omniORB.tcInternal.tv_enum, _0_CosNotifyChannelAdmin.ProxyType._NP_RepositoryId, 'ProxyType', _0_CosNotifyChannelAdmin.ProxyType._items)
...
_0_CosNotifyChannelAdmin._d_ObtainInfoMode = (
 omniORB.tcInternal.tv_enum, _0_CosNotifyChannelAdmin.ObtainInfoMode._NP_RepositoryId, 'ObtainInfoMode', _0_CosNotifyChannelAdmin.ObtainInfoMode._items)
...
_0_CosNotifyChannelAdmin._d_ProxyConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ProxyConsumer:1.0', 'ProxyConsumer')
...
ProxyConsumer._d_obtain_subscription_types = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/ObtainInfoMode:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosNotification/EventTypeSeq:1.0'],), None)
...
class ProxyConsumer(_0_CosNotification__POA.QoSAdmin, _0_CosNotifyFilter__POA.FilterAdmin):
    ...
    _omni_op_d = {'_get_MyType':_0_CosNotifyChannelAdmin.ProxyConsumer._d__get_MyType, 
     '_get_MyAdmin':_0_CosNotifyChannelAdmin.ProxyConsumer._d__get_MyAdmin,  'obtain_subscription_types':_0_CosNotifyChannelAdmin.ProxyConsumer._d_obtain_subscription_types,  'validate_event_qos':_0_CosNotifyChannelAdmin.ProxyConsumer._d_validate_event_qos}
...
del ProxyConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_ProxySupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0', 'ProxySupplier')
...
ProxySupplier._d__set_priority_filter = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyFilter/MappingFilter:1.0'],), (), None)
...
del ProxySupplier
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_ProxyPushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ProxyPushConsumer:1.0', 'ProxyPushConsumer')
...
ProxyPushConsumer._d_connect_any_push_supplier = (
 (
  omniORB.typeMapping['IDL:omg.org/CosEventComm/PushSupplier:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected})
...
del ProxyPushConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_StructuredProxyPushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPushConsumer:1.0', 'StructuredProxyPushConsumer')
...
StructuredProxyPushConsumer._d_connect_structured_push_supplier = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/StructuredPushSupplier:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected})
...
del _objref_StructuredProxyPushConsumer
__name__ = 'CosNotifyChannelAdmin__POA'
...
del StructuredProxyPushConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_SequenceProxyPushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushConsumer:1.0', 'SequenceProxyPushConsumer')
...
SequenceProxyPushConsumer._d_connect_sequence_push_supplier = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/SequencePushSupplier:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected})
...
del _objref_SequenceProxyPushConsumer
__name__ = 'CosNotifyChannelAdmin__POA'
...
del SequenceProxyPushConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_ProxyPullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ProxyPullSupplier:1.0', 'ProxyPullSupplier')
...
ProxyPullSupplier._d_connect_any_pull_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosEventComm/PullConsumer:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected})
...
del ProxyPullSupplier
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_StructuredProxyPullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0', 'StructuredProxyPullSupplier')
...
StructuredProxyPullSupplier._d_connect_structured_pull_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/StructuredPullConsumer:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected})
...
del _objref_StructuredProxyPullSupplier
__name__ = 'CosNotifyChannelAdmin__POA'
...
del StructuredProxyPullSupplier
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_SequenceProxyPullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPullSupplier:1.0', 'SequenceProxyPullSupplier')
...
SequenceProxyPullSupplier._d_connect_sequence_pull_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/SequencePullConsumer:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected})
...
del _objref_SequenceProxyPullSupplier
__name__ = 'CosNotifyChannelAdmin__POA'
...
del SequenceProxyPullSupplier
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_ProxyPullConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ProxyPullConsumer:1.0', 'ProxyPullConsumer')
...
ProxyPullConsumer._d_connect_any_pull_supplier = (
 (
  omniORB.typeMapping['IDL:omg.org/CosEventComm/PullSupplier:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected, _0_CosEventChannelAdmin.TypeError._NP_RepositoryId: _0_CosEventChannelAdmin._d_TypeError})
...
class ProxyPullConsumer(_0_CosNotifyChannelAdmin__POA.ProxyConsumer, _0_CosNotifyComm__POA.PullConsumer):
    ...
    _omni_op_d = {'connect_any_pull_supplier':_0_CosNotifyChannelAdmin.ProxyPullConsumer._d_connect_any_pull_supplier, 
     'suspend_connection':_0_CosNotifyChannelAdmin.ProxyPullConsumer._d_suspend_connection,  'resume_connection':_0_CosNotifyChannelAdmin.ProxyPullConsumer._d_resume_connection}
    _omni_op_d.update(_0_CosNotifyChannelAdmin__POA.ProxyConsumer._omni_op_d)
...
del ProxyPullConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_StructuredProxyPullConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0', 'StructuredProxyPullConsumer')
...
StructuredProxyPullConsumer._d_connect_structured_pull_supplier = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/StructuredPullSupplier:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected, _0_CosEventChannelAdmin.TypeError._NP_RepositoryId: _0_CosEventChannelAdmin._d_TypeError})
...
del _objref_StructuredProxyPullConsumer
__name__ = 'CosNotifyChannelAdmin__POA'
...
del StructuredProxyPullConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_SequenceProxyPullConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPullConsumer:1.0', 'SequenceProxyPullConsumer')
...
SequenceProxyPullConsumer._d_connect_sequence_pull_supplier = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/SequencePullSupplier:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected, _0_CosEventChannelAdmin.TypeError._NP_RepositoryId: _0_CosEventChannelAdmin._d_TypeError})
...
del _objref_SequenceProxyPullConsumer
__name__ = 'CosNotifyChannelAdmin__POA'
...
class SequenceProxyPullConsumer(_0_CosNotifyChannelAdmin__POA.ProxyConsumer, _0_CosNotifyComm__POA.SequencePullConsumer):
    ...
    _omni_op_d = {'connect_sequence_pull_supplier':_0_CosNotifyChannelAdmin.SequenceProxyPullConsumer._d_connect_sequence_pull_supplier, 
     'suspend_connection':_0_CosNotifyChannelAdmin.SequenceProxyPullConsumer._d_suspend_connection,  'resume_connection':_0_CosNotifyChannelAdmin.SequenceProxyPullConsumer._d_resume_connection}
    _omni_op_d.update(_0_CosNotifyChannelAdmin__POA.ProxyConsumer._omni_op_d)
...
del SequenceProxyPullConsumer
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_ProxyPushSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0', 'ProxyPushSupplier')
...
ProxyPushSupplier._d_connect_any_push_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosEventComm/PushConsumer:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected, _0_CosEventChannelAdmin.TypeError._NP_RepositoryId: _0_CosEventChannelAdmin._d_TypeError})
...
class ProxyPushSupplier(_0_CosNotifyChannelAdmin__POA.ProxySupplier, _0_CosNotifyComm__POA.PushSupplier):
    ...
    _omni_op_d = {'connect_any_push_consumer':_0_CosNotifyChannelAdmin.ProxyPushSupplier._d_connect_any_push_consumer, 
     'suspend_connection':_0_CosNotifyChannelAdmin.ProxyPushSupplier._d_suspend_connection,  'resume_connection':_0_CosNotifyChannelAdmin.ProxyPushSupplier._d_resume_connection}
    _omni_op_d.update(_0_CosNotifyChannelAdmin__POA.ProxySupplier._omni_op_d)
...
del ProxyPushSupplier
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_StructuredProxyPushSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPushSupplier:1.0', 'StructuredProxyPushSupplier')
...
StructuredProxyPushSupplier._d_connect_structured_push_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/StructuredPushConsumer:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected, _0_CosEventChannelAdmin.TypeError._NP_RepositoryId: _0_CosEventChannelAdmin._d_TypeError})
...
del _objref_StructuredProxyPushSupplier
__name__ = 'CosNotifyChannelAdmin__POA'
...
class StructuredProxyPushSupplier(_0_CosNotifyChannelAdmin__POA.ProxySupplier, _0_CosNotifyComm__POA.StructuredPushSupplier):
    ...
    _omni_op_d = {'connect_structured_push_consumer':_0_CosNotifyChannelAdmin.StructuredProxyPushSupplier._d_connect_structured_push_consumer, 
     'suspend_connection':_0_CosNotifyChannelAdmin.StructuredProxyPushSupplier._d_suspend_connection,  'resume_connection':_0_CosNotifyChannelAdmin.StructuredProxyPushSupplier._d_resume_connection}
    _omni_op_d.update(_0_CosNotifyChannelAdmin__POA.ProxySupplier._omni_op_d)
...
del StructuredProxyPushSupplier
__name__ = 'CosNotifyChannelAdmin'
_0_CosNotifyChannelAdmin._d_SequenceProxyPushSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0', 'SequenceProxyPushSupplier')
...
SequenceProxyPushSupplier._d_connect_sequence_push_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyComm/SequencePushConsumer:1.0'],), (), {_0_CosEventChannelAdmin.AlreadyConnected._NP_RepositoryId: _0_CosEventChannelAdmin._d_AlreadyConnected, _0_CosEventChannelAdmin.TypeError._NP_RepositoryId: _0_CosEventChannelAdmin._d_TypeError})
...
del _objref_SequenceProxyPushSupplier
__name__ = 'CosNotifyChannelAdmin__POA'
...
class SequenceProxyPushSupplier(_0_CosNotifyChannelAdmin__POA.ProxySupplier, _0_CosNotifyComm__POA.SequencePushSupplier):
    ...
    _omni_op_d = {'connect_sequence_push_consumer':_0_CosNotifyChannelAdmin.SequenceProxyPushSupplier._d_connect_sequence_push_consumer, 
     'suspend_connection':_0_CosNotifyChannelAdmin.SequenceProxyPushSupplier._d_suspend_connection,  'resume_connection':_0_CosNotifyChannelAdmin.SequenceProxyPushSupplier._d_resume_connection}
    _omni_op_d.update(_0_CosNotifyChannelAdmin__POA.ProxySupplier._omni_op_d)
...
_0_CosNotifyChannelAdmin._d_ClientType = (
 omniORB.tcInternal.tv_enum, _0_CosNotifyChannelAdmin.ClientType._NP_RepositoryId, 'ClientType', _0_CosNotifyChannelAdmin.ClientType._items)
...
_0_CosNotifyChannelAdmin._d_InterFilterGroupOperator = (
 omniORB.tcInternal.tv_enum, _0_CosNotifyChannelAdmin.InterFilterGroupOperator._NP_RepositoryId, 'InterFilterGroupOperator', _0_CosNotifyChannelAdmin.InterFilterGroupOperator._items)
...
ConsumerAdmin._d__set_priority_filter = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyFilter/MappingFilter:1.0'],), (), None)
...
SupplierAdmin._d_get_proxy_consumer = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/ProxyID:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/ProxyConsumer:1.0'],), {_0_CosNotifyChannelAdmin.ProxyNotFound._NP_RepositoryId: _0_CosNotifyChannelAdmin._d_ProxyNotFound})
...
class SupplierAdmin(_0_CosNotification__POA.QoSAdmin, _0_CosNotifyComm__POA.NotifyPublish, _0_CosNotifyFilter__POA.FilterAdmin, _0_CosEventChannelAdmin__POA.SupplierAdmin):
    ...
    _omni_op_d = {'_get_MyID':_0_CosNotifyChannelAdmin.SupplierAdmin._d__get_MyID, 
...
EventChannel._d_new_for_consumers = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/InterFilterGroupOperator:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/ConsumerAdmin:1.0'], omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/AdminID:1.0']), None)
...
EventChannelFactory._d_create_channel = (
 (
  omniORB.typeMapping['IDL:omg.org/CosNotification/QoSProperties:1.0'], omniORB.typeMapping['IDL:omg.org/CosNotification/AdminProperties:1.0']), (omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/EventChannel:1.0'], omniORB.typeMapping['IDL:omg.org/CosNotifyChannelAdmin/ChannelID:1.0']), {_0_CosNotification.UnsupportedQoS._NP_RepositoryId: _0_CosNotification._d_UnsupportedQoS, _0_CosNotification.UnsupportedAdmin._NP_RepositoryId: _0_CosNotification._d_UnsupportedAdmin})
...
class EventChannelFactory(PortableServer.Servant):
    ...
    _omni_op_d = {'create_channel':_0_CosNotifyChannelAdmin.EventChannelFactory._d_create_channel, 
     'get_all_channels':_0_CosNotifyChannelAdmin.EventChannelFactory._d_get_all_channels,  'get_event_channel':_0_CosNotifyChannelAdmin.EventChannelFactory._d_get_event_channel}
