...
# [GCC 8.4.0]
# Embedded file name: ./CosTrading_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 105858 bytes
...
__name__ = 'CosTrading'
_0_CosTrading = omniORB.openModule('CosTrading', '/tmp/corba/omni/share/idl/omniORB/COS/CosTrading.idl')
_0_CosTrading__POA = omniORB.openModule('CosTrading__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosTrading.idl')
_0_CosTrading._d_Lookup = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/Lookup:1.0', 'Lookup')
omniORB.typeMapping['IDL:omg.org/CosTrading/Lookup:1.0'] = _0_CosTrading._d_Lookup
_0_CosTrading._d_Register = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/Register:1.0', 'Register')
omniORB.typeMapping['IDL:omg.org/CosTrading/Register:1.0'] = _0_CosTrading._d_Register
_0_CosTrading._d_Link = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/Link:1.0', 'Link')
omniORB.typeMapping['IDL:omg.org/CosTrading/Link:1.0'] = _0_CosTrading._d_Link
_0_CosTrading._d_Proxy = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/Proxy:1.0', 'Proxy')
omniORB.typeMapping['IDL:omg.org/CosTrading/Proxy:1.0'] = _0_CosTrading._d_Proxy
_0_CosTrading._d_Admin = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/Admin:1.0', 'Admin')
omniORB.typeMapping['IDL:omg.org/CosTrading/Admin:1.0'] = _0_CosTrading._d_Admin
_0_CosTrading._d_OfferIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/OfferIterator:1.0', 'OfferIterator')
omniORB.typeMapping['IDL:omg.org/CosTrading/OfferIterator:1.0'] = _0_CosTrading._d_OfferIterator
_0_CosTrading._d_OfferIdIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/OfferIdIterator:1.0', 'OfferIdIterator')
...
_0_CosTrading._d_FollowOption = (
 omniORB.tcInternal.tv_enum, _0_CosTrading.FollowOption._NP_RepositoryId, 'FollowOption', _0_CosTrading.FollowOption._items)
...
_0_CosTrading._d_TraderComponents = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/TraderComponents:1.0', 'TraderComponents')
...
class TraderComponents(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_lookup_if':_0_CosTrading.TraderComponents._d__get_lookup_if, 
     '_get_register_if':_0_CosTrading.TraderComponents._d__get_register_if,  '_get_link_if':_0_CosTrading.TraderComponents._d__get_link_if,  '_get_proxy_if':_0_CosTrading.TraderComponents._d__get_proxy_if,  '_get_admin_if':_0_CosTrading.TraderComponents._d__get_admin_if}
...
del TraderComponents
__name__ = 'CosTrading'
_0_CosTrading._d_SupportAttributes = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/SupportAttributes:1.0', 'SupportAttributes')
...
del _objref_SupportAttributes
__name__ = 'CosTrading__POA'

class SupportAttributes(PortableServer.Servant):
    _NP_RepositoryId = _0_CosTrading.SupportAttributes._NP_RepositoryId
    _omni_op_d = {'_get_supports_modifiable_properties':_0_CosTrading.SupportAttributes._d__get_supports_modifiable_properties, 
     '_get_supports_dynamic_properties':_0_CosTrading.SupportAttributes._d__get_supports_dynamic_properties,  '_get_supports_proxy_offers':_0_CosTrading.SupportAttributes._d__get_supports_proxy_offers,  '_get_type_repos':_0_CosTrading.SupportAttributes._d__get_type_repos}
...
del SupportAttributes
__name__ = 'CosTrading'
_0_CosTrading._d_ImportAttributes = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/ImportAttributes:1.0', 'ImportAttributes')
...
del ImportAttributes
__name__ = 'CosTrading'
_0_CosTrading._d_LinkAttributes = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTrading/LinkAttributes:1.0', 'LinkAttributes')
...
class Lookup(_0_CosTrading.TraderComponents, _0_CosTrading.SupportAttributes, _0_CosTrading.ImportAttributes):
    ...
    _d_HowManyProps = (
     omniORB.tcInternal.tv_enum, HowManyProps._NP_RepositoryId, 'HowManyProps', HowManyProps._items)
    ...
    _m_SpecifiedProps = (
     (
      some, 'prop_names', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertyNameSeq:1.0']),)
    ...
    _d_IllegalPreference = (
     omniORB.tcInternal.tv_except, IllegalPreference, IllegalPreference._NP_RepositoryId, 'IllegalPreference', 'pref', omniORB.typeMapping['IDL:omg.org/CosTrading/Lookup/Preference:1.0'])
    ...
    _d_IllegalPolicyName = (
     omniORB.tcInternal.tv_except, IllegalPolicyName, IllegalPolicyName._NP_RepositoryId, 'IllegalPolicyName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/PolicyName:1.0'])
    ...
    _d_PolicyTypeMismatch = (
     omniORB.tcInternal.tv_except, PolicyTypeMismatch, PolicyTypeMismatch._NP_RepositoryId, 'PolicyTypeMismatch', 'the_policy', omniORB.typeMapping['IDL:omg.org/CosTrading/Policy:1.0'])
    ...
    _d_InvalidPolicyValue = (
     omniORB.tcInternal.tv_except, InvalidPolicyValue, InvalidPolicyValue._NP_RepositoryId, 'InvalidPolicyValue', 'the_policy', omniORB.typeMapping['IDL:omg.org/CosTrading/Policy:1.0'])
...
Lookup._d_query = (
 (
  omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], omniORB.typeMapping['IDL:omg.org/CosTrading/Constraint:1.0'], omniORB.typeMapping['IDL:omg.org/CosTrading/Lookup/Preference:1.0'], omniORB.typeMapping['IDL:omg.org/CosTrading/PolicySeq:1.0'], omniORB.typeMapping['IDL:omg.org/CosTrading/Lookup/SpecifiedProps:1.0'], omniORB.tcInternal.tv_ulong), (omniORB.typeMapping['IDL:omg.org/CosTrading/OfferSeq:1.0'], omniORB.typeMapping['IDL:omg.org/CosTrading/OfferIterator:1.0'], omniORB.typeMapping['IDL:omg.org/CosTrading/PolicyNameSeq:1.0']), {_0_CosTrading.IllegalServiceType._NP_RepositoryId: _0_CosTrading._d_IllegalServiceType, _0_CosTrading.UnknownServiceType._NP_RepositoryId: _0_CosTrading._d_UnknownServiceType, _0_CosTrading.IllegalConstraint._NP_RepositoryId: _0_CosTrading._d_IllegalConstraint, _0_CosTrading.Lookup.IllegalPreference._NP_RepositoryId: _0_CosTrading.Lookup._d_IllegalPreference, _0_CosTrading.Lookup.IllegalPolicyName._NP_RepositoryId: _0_CosTrading.Lookup._d_IllegalPolicyName, _0_CosTrading.Lookup.PolicyTypeMismatch._NP_RepositoryId: _0_CosTrading.Lookup._d_PolicyTypeMismatch, _0_CosTrading.Lookup.InvalidPolicyValue._NP_RepositoryId: _0_CosTrading.Lookup._d_InvalidPolicyValue, _0_CosTrading.IllegalPropertyName._NP_RepositoryId: _0_CosTrading._d_IllegalPropertyName, _0_CosTrading.DuplicatePropertyName._NP_RepositoryId: _0_CosTrading._d_DuplicatePropertyName, _0_CosTrading.DuplicatePolicyName._NP_RepositoryId: _0_CosTrading._d_DuplicatePolicyName})
...
class Register(_0_CosTrading.TraderComponents, _0_CosTrading.SupportAttributes):
    ...
    _d_OfferInfo = _0_CosTrading.Register._d_OfferInfo = (
     omniORB.tcInternal.tv_struct, OfferInfo, OfferInfo._NP_RepositoryId, 'OfferInfo', 'reference', omniORB.typeMapping['IDL:omg.org/CORBA/Object:1.0'], 'type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'properties', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertySeq:1.0'])
    ...
    _d_InvalidObjectRef = (
     omniORB.tcInternal.tv_except, InvalidObjectRef, InvalidObjectRef._NP_RepositoryId, 'InvalidObjectRef', 'ref', omniORB.typeMapping['IDL:omg.org/CORBA/Object:1.0'])
    ...
    _d_UnknownPropertyName = (
     omniORB.tcInternal.tv_except, UnknownPropertyName, UnknownPropertyName._NP_RepositoryId, 'UnknownPropertyName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertyName:1.0'])
    ...
    _d_InterfaceTypeMismatch = (
     omniORB.tcInternal.tv_except, InterfaceTypeMismatch, InterfaceTypeMismatch._NP_RepositoryId, 'InterfaceTypeMismatch', 'type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'reference', omniORB.typeMapping['IDL:omg.org/CORBA/Object:1.0'])
    ...
    _d_ProxyOfferId = (
     omniORB.tcInternal.tv_except, ProxyOfferId, ProxyOfferId._NP_RepositoryId, 'ProxyOfferId', 'id', omniORB.typeMapping['IDL:omg.org/CosTrading/OfferId:1.0'])
    ...
    _d_MandatoryProperty = (
     omniORB.tcInternal.tv_except, MandatoryProperty, MandatoryProperty._NP_RepositoryId, 'MandatoryProperty', 'type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertyName:1.0'])
    ...
    _d_ReadonlyProperty = (
     omniORB.tcInternal.tv_except, ReadonlyProperty, ReadonlyProperty._NP_RepositoryId, 'ReadonlyProperty', 'type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertyName:1.0'])
    ...
    _d_NoMatchingOffers = (
     omniORB.tcInternal.tv_except, NoMatchingOffers, NoMatchingOffers._NP_RepositoryId, 'NoMatchingOffers', 'constr', omniORB.typeMapping['IDL:omg.org/CosTrading/Constraint:1.0'])
    ...
    _d_IllegalTraderName = (
     omniORB.tcInternal.tv_except, IllegalTraderName, IllegalTraderName._NP_RepositoryId, 'IllegalTraderName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/TraderName:1.0'])
    ...
    _d_UnknownTraderName = (
     omniORB.tcInternal.tv_except, UnknownTraderName, UnknownTraderName._NP_RepositoryId, 'UnknownTraderName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/TraderName:1.0'])
    ...
    _d_RegisterNotSupported = (
     omniORB.tcInternal.tv_except, RegisterNotSupported, RegisterNotSupported._NP_RepositoryId, 'RegisterNotSupported', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/TraderName:1.0'])
...
class Register(_0_CosTrading__POA.TraderComponents, _0_CosTrading__POA.SupportAttributes):
    ...
    _omni_op_d = {'export':_0_CosTrading.Register._d_export, 
     'withdraw':_0_CosTrading.Register._d_withdraw,  'describe':_0_CosTrading.Register._d_describe,  'modify':_0_CosTrading.Register._d_modify,  'withdraw_using_constraint':_0_CosTrading.Register._d_withdraw_using_constraint,  'resolve':_0_CosTrading.Register._d_resolve}
    _omni_op_d.update(_0_CosTrading__POA.TraderComponents._omni_op_d)
    _omni_op_d.update(_0_CosTrading__POA.SupportAttributes._omni_op_d)
...
class Link(_0_CosTrading.TraderComponents, _0_CosTrading.SupportAttributes, _0_CosTrading.LinkAttributes):
    ...
    _d_LinkInfo = _0_CosTrading.Link._d_LinkInfo = (
     omniORB.tcInternal.tv_struct, LinkInfo, LinkInfo._NP_RepositoryId, 'LinkInfo', 'target', omniORB.typeMapping['IDL:omg.org/CosTrading/Lookup:1.0'], 'target_reg', omniORB.typeMapping['IDL:omg.org/CosTrading/Register:1.0'], 'def_pass_on_follow_rule', omniORB.typeMapping['IDL:omg.org/CosTrading/FollowOption:1.0'], 'limiting_follow_rule', omniORB.typeMapping['IDL:omg.org/CosTrading/FollowOption:1.0'])
    ...
    _d_IllegalLinkName = (
     omniORB.tcInternal.tv_except, IllegalLinkName, IllegalLinkName._NP_RepositoryId, 'IllegalLinkName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/LinkName:1.0'])
    ...
    _d_UnknownLinkName = (
     omniORB.tcInternal.tv_except, UnknownLinkName, UnknownLinkName._NP_RepositoryId, 'UnknownLinkName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/LinkName:1.0'])
    ...
    _d_DuplicateLinkName = (
     omniORB.tcInternal.tv_except, DuplicateLinkName, DuplicateLinkName._NP_RepositoryId, 'DuplicateLinkName', 'name', omniORB.typeMapping['IDL:omg.org/CosTrading/LinkName:1.0'])
    ...
    _d_DefaultFollowTooPermissive = (
     omniORB.tcInternal.tv_except, DefaultFollowTooPermissive, DefaultFollowTooPermissive._NP_RepositoryId, 'DefaultFollowTooPermissive', 'def_pass_on_follow_rule', omniORB.typeMapping['IDL:omg.org/CosTrading/FollowOption:1.0'], 'limiting_follow_rule', omniORB.typeMapping['IDL:omg.org/CosTrading/FollowOption:1.0'])
    ...
    _d_LimitingFollowTooPermissive = (
     omniORB.tcInternal.tv_except, LimitingFollowTooPermissive, LimitingFollowTooPermissive._NP_RepositoryId, 'LimitingFollowTooPermissive', 'limiting_follow_rule', omniORB.typeMapping['IDL:omg.org/CosTrading/FollowOption:1.0'], 'max_link_follow_policy', omniORB.typeMapping['IDL:omg.org/CosTrading/FollowOption:1.0'])
...
class Link(_0_CosTrading__POA.TraderComponents, _0_CosTrading__POA.SupportAttributes, _0_CosTrading__POA.LinkAttributes):
    ...
    _omni_op_d = {'add_link':_0_CosTrading.Link._d_add_link, 
     'remove_link':_0_CosTrading.Link._d_remove_link,  'describe_link':_0_CosTrading.Link._d_describe_link,  'list_links':_0_CosTrading.Link._d_list_links,  'modify_link':_0_CosTrading.Link._d_modify_link}
    _omni_op_d.update(_0_CosTrading__POA.TraderComponents._omni_op_d)
    _omni_op_d.update(_0_CosTrading__POA.SupportAttributes._omni_op_d)
...
class Proxy(_0_CosTrading.TraderComponents, _0_CosTrading.SupportAttributes):
    ...
    _d_ProxyInfo = _0_CosTrading.Proxy._d_ProxyInfo = (
     omniORB.tcInternal.tv_struct, ProxyInfo, ProxyInfo._NP_RepositoryId, 'ProxyInfo', 'type', omniORB.typeMapping['IDL:omg.org/CosTrading/ServiceTypeName:1.0'], 'target', omniORB.typeMapping['IDL:omg.org/CosTrading/Lookup:1.0'], 'properties', omniORB.typeMapping['IDL:omg.org/CosTrading/PropertySeq:1.0'], 'if_match_all', omniORB.tcInternal.tv_boolean, 'recipe', omniORB.typeMapping['IDL:omg.org/CosTrading/Proxy/ConstraintRecipe:1.0'], 'policies_to_pass_on', omniORB.typeMapping['IDL:omg.org/CosTrading/PolicySeq:1.0'])
    ...
    _d_IllegalRecipe = (
     omniORB.tcInternal.tv_except, IllegalRecipe, IllegalRecipe._NP_RepositoryId, 'IllegalRecipe', 'recipe', omniORB.typeMapping['IDL:omg.org/CosTrading/Proxy/ConstraintRecipe:1.0'])
    ...
    _d_NotProxyOfferId = (
     omniORB.tcInternal.tv_except, NotProxyOfferId, NotProxyOfferId._NP_RepositoryId, 'NotProxyOfferId', 'id', omniORB.typeMapping['IDL:omg.org/CosTrading/OfferId:1.0'])
...
class Proxy(_0_CosTrading__POA.TraderComponents, _0_CosTrading__POA.SupportAttributes):
    ...
    _omni_op_d = {'export_proxy':_0_CosTrading.Proxy._d_export_proxy, 
     'withdraw_proxy':_0_CosTrading.Proxy._d_withdraw_proxy,  'describe_proxy':_0_CosTrading.Proxy._d_describe_proxy}
    _omni_op_d.update(_0_CosTrading__POA.TraderComponents._omni_op_d)
    _omni_op_d.update(_0_CosTrading__POA.SupportAttributes._omni_op_d)
...
OfferIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosTrading/OfferSeq:1.0']), None)
...
del OfferIterator
del _objref_OfferIterator
__name__ = 'CosTrading__POA'

class OfferIterator(PortableServer.Servant):
    _NP_RepositoryId = _0_CosTrading.OfferIterator._NP_RepositoryId
    _omni_op_d = {'max_left':_0_CosTrading.OfferIterator._d_max_left, 
     'next_n':_0_CosTrading.OfferIterator._d_next_n,  'destroy':_0_CosTrading.OfferIterator._d_destroy}
...
OfferIdIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosTrading/OfferIdSeq:1.0']), None)
...
del OfferIdIterator
del _objref_OfferIdIterator
__name__ = 'CosTrading__POA'

class OfferIdIterator(PortableServer.Servant):
    _NP_RepositoryId = _0_CosTrading.OfferIdIterator._NP_RepositoryId
    _omni_op_d = {'max_left':_0_CosTrading.OfferIdIterator._d_max_left, 
     'next_n':_0_CosTrading.OfferIdIterator._d_next_n,  'destroy':_0_CosTrading.OfferIdIterator._d_destroy}
