...
# [GCC 8.4.0]
# Embedded file name: ./CosCompoundLifeCycle_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 26779 bytes
...
_0_CosCompoundLifeCycle = omniORB.openModule('CosCompoundLifeCycle', '/tmp/corba/omni/share/idl/omniORB/COS/CosCompoundLifeCycle.idl')
_0_CosCompoundLifeCycle__POA = omniORB.openModule('CosCompoundLifeCycle__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosCompoundLifeCycle.idl')
_0_CosCompoundLifeCycle._d_OperationsFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosCompoundLifeCycle/OperationsFactory:1.0', 'OperationsFactory')
omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/OperationsFactory:1.0'] = _0_CosCompoundLifeCycle._d_OperationsFactory
_0_CosCompoundLifeCycle._d_Operations = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosCompoundLifeCycle/Operations:1.0', 'Operations')
omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Operations:1.0'] = _0_CosCompoundLifeCycle._d_Operations
_0_CosCompoundLifeCycle._d_Node = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosCompoundLifeCycle/Node:1.0', 'Node')
omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Node:1.0'] = _0_CosCompoundLifeCycle._d_Node
_0_CosCompoundLifeCycle._d_Role = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosCompoundLifeCycle/Role:1.0', 'Role')
omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Role:1.0'] = _0_CosCompoundLifeCycle._d_Role
_0_CosCompoundLifeCycle._d_Relationship = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosCompoundLifeCycle/Relationship:1.0', 'Relationship')
omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Relationship:1.0'] = _0_CosCompoundLifeCycle._d_Relationship
_0_CosCompoundLifeCycle._d_PropagationCriteriaFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosCompoundLifeCycle/PropagationCriteriaFactory:1.0', 'PropagationCriteriaFactory')
...
_0_CosCompoundLifeCycle._d_Operation = (
 omniORB.tcInternal.tv_enum, _0_CosCompoundLifeCycle.Operation._NP_RepositoryId, 'Operation', _0_CosCompoundLifeCycle.Operation._items)
...
class Operations(PortableServer.Servant):
    ...
    _omni_op_d = {'copy':_0_CosCompoundLifeCycle.Operations._d_copy, 
     'move':_0_CosCompoundLifeCycle.Operations._d_move,  'remove':_0_CosCompoundLifeCycle.Operations._d_remove,  'destroy':_0_CosCompoundLifeCycle.Operations._d_destroy}
...
class Node(_0_CosGraphs.Node):
    ...
    _d_NotLifeCycleObject = (
     omniORB.tcInternal.tv_except, NotLifeCycleObject, NotLifeCycleObject._NP_RepositoryId, 'NotLifeCycleObject')
...
Node._d_copy_node = (
 (
  omniORB.typeMapping['IDL:omg.org/CosLifeCycle/FactoryFinder:1.0'], omniORB.typeMapping['IDL:omg.org/CosLifeCycle/Criteria:1.0']), (omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Node:1.0'], omniORB.typeMapping['IDL:omg.org/CosGraphs/Node/Roles:1.0']), {_0_CosLifeCycle.NoFactory._NP_RepositoryId: _0_CosLifeCycle._d_NoFactory, _0_CosLifeCycle.NotCopyable._NP_RepositoryId: _0_CosLifeCycle._d_NotCopyable, _0_CosLifeCycle.InvalidCriteria._NP_RepositoryId: _0_CosLifeCycle._d_InvalidCriteria, _0_CosLifeCycle.CannotMeetCriteria._NP_RepositoryId: _0_CosLifeCycle._d_CannotMeetCriteria})
...
class Node(_0_CosGraphs__POA.Node):
    ...
    _omni_op_d = {'copy_node':_0_CosCompoundLifeCycle.Node._d_copy_node, 
     'move_node':_0_CosCompoundLifeCycle.Node._d_move_node,  'remove_node':_0_CosCompoundLifeCycle.Node._d_remove_node,  'get_life_cycle_object':_0_CosCompoundLifeCycle.Node._d_get_life_cycle_object}
...
class Role(_0_CosGraphs__POA.Role):
    ...
    _omni_op_d = {'copy_role':_0_CosCompoundLifeCycle.Role._d_copy_role, 
     'move_role':_0_CosCompoundLifeCycle.Role._d_move_role,  'life_cycle_propagation':_0_CosCompoundLifeCycle.Role._d_life_cycle_propagation}
...
Relationship._d_copy_relationship = (
 (
  omniORB.typeMapping['IDL:omg.org/CosLifeCycle/FactoryFinder:1.0'], omniORB.typeMapping['IDL:omg.org/CosLifeCycle/Criteria:1.0'], omniORB.typeMapping['IDL:omg.org/CosGraphs/NamedRoles:1.0']), (omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Relationship:1.0'],), {_0_CosLifeCycle.NoFactory._NP_RepositoryId: _0_CosLifeCycle._d_NoFactory, _0_CosLifeCycle.NotCopyable._NP_RepositoryId: _0_CosLifeCycle._d_NotCopyable, _0_CosLifeCycle.InvalidCriteria._NP_RepositoryId: _0_CosLifeCycle._d_InvalidCriteria, _0_CosLifeCycle.CannotMeetCriteria._NP_RepositoryId: _0_CosLifeCycle._d_CannotMeetCriteria})
...
class Relationship(_0_CosRelationships__POA.Relationship):
    ...
    _omni_op_d = {'copy_relationship':_0_CosCompoundLifeCycle.Relationship._d_copy_relationship, 
     'move_relationship':_0_CosCompoundLifeCycle.Relationship._d_move_relationship,  'life_cycle_propagation':_0_CosCompoundLifeCycle.Relationship._d_life_cycle_propagation}
...
PropagationCriteriaFactory._d_create = (
 (
  omniORB.typeMapping['IDL:omg.org/CosCompoundLifeCycle/Operation:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosGraphs/TraversalCriteria:1.0'],), None)
...
del _objref_PropagationCriteriaFactory
__name__ = 'CosCompoundLifeCycle__POA'
