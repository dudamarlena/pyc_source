...
# [GCC 8.4.0]
# Embedded file name: ./CosTypedNotifyComm_idl.py
...
_0_CosTypedNotifyComm = omniORB.openModule('CosTypedNotifyComm', '/tmp/corba/omni/share/idl/omniORB/COS/CosTypedNotifyComm.idl')
_0_CosTypedNotifyComm__POA = omniORB.openModule('CosTypedNotifyComm__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosTypedNotifyComm.idl')
_0_CosTypedNotifyComm._d_TypedPushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTypedNotifyComm/TypedPushConsumer:1.0', 'TypedPushConsumer')
...
del TypedPushConsumer
__name__ = 'CosTypedNotifyComm'
_0_CosTypedNotifyComm._d_TypedPullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosTypedNotifyComm/TypedPullSupplier:1.0', 'TypedPullSupplier')
