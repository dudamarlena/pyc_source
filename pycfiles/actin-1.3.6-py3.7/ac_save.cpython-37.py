...
# [GCC 8.4.0]
# Embedded file name: /Users/jgsilva/Astrophysics/Packages/ACTIN/actin/actin_files/ac_save.py
# Compiled at: 2019-10-18 09:29:23
# Size of source mod 2**32: 5874 bytes
from __future__ import print_function
from __future__ import division
import sys, os, pylab as plt, numpy as np, datetime, ac_tools, ac_settings as ac_set
...
def check_duplicate(obj, date, instr, file_type, out_dir):
    ...
    if obj is None or date is None or out_dir is None:
        return
...
def save_log(info, options, n_files, out_dir):
    ...
    if type(files) is list and len(files) > 1:
        ...
        source_path = os.path.split(files)[0]
    log = {}
