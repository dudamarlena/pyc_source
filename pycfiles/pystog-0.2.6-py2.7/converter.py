...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pystog/converter.py
...
class Converter:
    ...
    def F_to_S(self, q, fq, **kwargs):
        ...
        :rtype: numpy.array
        """
        return self._safe_divide(fq, q) + 1.0
    ...
    def F_to_DCS(self, q, fq, **kwargs):
        r"""Converts from :math:`Q[S(Q)-1]` to :math:`\frac{d \sigma}{d \Omega}(Q)`
    ...
    def S_to_DCS(self, q, sq, **kwargs):
        r"""Convert :math:`S(Q)` to :math:`\frac{d \sigma}{d \Omega}(Q)`
    ...
    def FK_to_DCS(self, q, fq, **kwargs):
        r"""Convert :math:`F(Q)` to :math:`\frac{d \sigma}{d \Omega}(Q)`
    ...
    def DCS_to_F(self, q, dcs, **kwargs):
        r"""Convert :math:`\frac{d \sigma}{d \Omega}(Q)` to :math:`Q[S(Q)-1]`
    ...
    def DCS_to_S(self, q, dcs, **kwargs):
        r"""Convert :math:`\frac{d \sigma}{d \Omega}(Q)` to :math:`S(Q)`
    ...
    def DCS_to_FK(self, q, dcs, **kwargs):
        r"""Convert :math:`\frac{d \sigma}{d \Omega}(Q)` to :math:`F(Q)`
    ...
    def G_to_g(self, r, gr, **kwargs):
        ...
        return self._safe_divide(gr, factor * r) + 1.0
