...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pystog/fourier_filter.py
...
class FourierFilter:
    ...
    def g_using_DCS(self, r, gr, q, dcs, cutoff, **kwargs):
        r"""Fourier filters real space :math:`g(r)`
    ...
    def G_using_DCS(self, r, gr, q, dcs, cutoff, **kwargs):
        r"""Fourier filters real space :math:`G_{PDFFIT}(r)`
        using the reciprocal space
        :math:`\frac{d \sigma}{d \Omega}(Q)`
    ...
    def GK_using_DCS(self, r, gr, q, dcs, cutoff, **kwargs):
        r"""Fourier filters real space :math:`G_{Keen Version}(r)`
        using the reciprocal space
        :math:`\frac{d \sigma}{d \Omega}(Q)`
