...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pystog/transformer.py
...
class Transformer:
    ...
    def _low_x_correction(self, xin, yin, xout, yout, **kwargs):
        ...
        for i, x in enumerate(xout):
            ...
            if lorch_flag:
                ...
                F2 = (np.sin(vm) / (x - PiOverXmax) - np.sin(vp) / (x + PiOverXmax)) / (2.0 * PiOverXmax)
            else:
    ...
    def DCS_to_G(self, q, dcs, r, **kwargs):
        r"""Transforms from reciprocal space
    ...
    def G_to_DCS(self, r, gr, q, **kwargs):
        r"""Transforms from real space :math:`G_{PDFFIT}(r)`
        to reciprocal space
        :math:`\frac{d \sigma}{d \Omega}(Q)`
    ...
    def GK_to_DCS(self, r, gr, q, **kwargs):
        r"""Transforms from real space :math:`G_{Keen Version}(r)`
    ...
    def g_to_DCS(self, r, gr, q, **kwargs):
        r"""Transforms from real space :math:`g(r)`
        to reciprocal space :math:`\frac{d \sigma}{d \Omega}(Q)`
