...
# [GCC 8.4.0]
# Embedded file name: /home/hugoruscitti/Aptana Studio 3 Workspace/quickdiagrams/quickdiagrams/gtkclient/test.py
# Compiled at: 2011-01-24 12:02:35
import os, gtk, re, sys, gtk.glade, quickdiagrams, dialogs, gtkcodebuffer, drawing_thread, gobject, pango, lifoqueue
...
class Application:
    ...
    def _create_buffer(self):
        emph = gtkcodebuffer.String('\\*', '\\*', style='datatype')
        emph2 = gtkcodebuffer.String('\\*\\*', '\\*\\*', style='datatype')
        list1 = gtkcodebuffer.Pattern('^(- ).+$', style='comment', group=1)
        list2 = gtkcodebuffer.Pattern('^\\s*-+', style='comment')
        head = gtkcodebuffer.Pattern('^\\s*[A-Z][a-z]*', style='keyword')
        ...
        pl = self.view.textview.create_pango_layout('    ')
