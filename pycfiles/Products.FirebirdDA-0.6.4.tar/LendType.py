...
# Embedded file name: build/bdist.linux-x86_64/egg/Products/FinisAfricae/content/LendType.py
# Compiled at: 2008-05-02 15:45:04
__doc__ = '\n\n\n\n'
...
class LendType(ATCTFolder):
    ...
    def deleteCondition(self, condition_id):
        ...
        """
        if type(condition_id) is StringType:
    ...
    def getConditionUniqueWidgetAttr(self, attr):
        ...
        for cond in conditions:
            ...
            for f in fields:
                ...
                if helper:
                    [ order.append(item) for item in helper if item not in order ]
    ...
    def listCriteriaTypes(self):
        ...
        """
        return [ {'name': ctype, 'description': _criterionRegistry[ctype].shortDesc} for ctype in self.listCriteriaMetaTypes()
               ]
    ...
    def listSortFields(self):
        ...
        fields = [ field for field in self.listFields() if self.validateAddCriterion(field[0], 'ATSortCriterion')
                 ]
        return fields
