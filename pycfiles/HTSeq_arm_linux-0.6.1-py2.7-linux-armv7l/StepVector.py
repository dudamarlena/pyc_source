...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/HTSeq/StepVector.py
# Compiled at: 2013-10-02 08:03:52
...
class _StepVector_float(_object):
    ...
    def set_value(self, *args):
        return _StepVector._StepVector_float_set_value(self, *args)

    def add_value(self, *args):
        return _StepVector._StepVector_float_add_value(self, *args)

    def get_all_values_pystyle(self):
        return _StepVector._StepVector_float_get_all_values_pystyle(self)

    def get_values_pystyle(self, *args):
        return _StepVector._StepVector_float_get_values_pystyle(self, *args)
...
class _StepVector_int(_object):
    ...
    def set_value(self, *args):
        return _StepVector._StepVector_int_set_value(self, *args)

    def add_value(self, *args):
        return _StepVector._StepVector_int_add_value(self, *args)

    def get_all_values_pystyle(self):
        return _StepVector._StepVector_int_get_all_values_pystyle(self)

    def get_values_pystyle(self, *args):
        return _StepVector._StepVector_int_get_values_pystyle(self, *args)
...
class _StepVector_bool(_object):
    ...
    def set_value(self, *args):
        return _StepVector._StepVector_bool_set_value(self, *args)

    def add_value(self, *args):
        return _StepVector._StepVector_bool_add_value(self, *args)

    def get_all_values_pystyle(self):
        return _StepVector._StepVector_bool_get_all_values_pystyle(self)

    def get_values_pystyle(self, *args):
        return _StepVector._StepVector_bool_get_values_pystyle(self, *args)
...
class _StepVector_obj(_object):
    ...
    def set_value(self, *args):
        return _StepVector._StepVector_obj_set_value(self, *args)

    def add_value(self, *args):
        return _StepVector._StepVector_obj_add_value(self, *args)

    def get_all_values_pystyle(self):
        return _StepVector._StepVector_obj_get_all_values_pystyle(self)

    def get_values_pystyle(self, *args):
        return _StepVector._StepVector_obj_get_values_pystyle(self, *args)
...
class StepVector(object):
   ...
   """
    ...
    def __setitem__(self, index, value):
      ...
      """
        if isinstance(value, StepVector):
            if self._swigobj is value._swigobj and value.start == index.start and value.stop == index.stop:
                return
      ...
      """
        ...
        for pair in startvals:
            ...
            if self.stop is not None and stepstart >= self.stop:
                if not values_only:
                    yield (
                     prevstart, self.stop, prevval)
                else:
                    yield prevval
                return
            if not values_only:
                yield (
                 prevstart, stepstart, prevval)
            else:
                yield prevval
            ...
            if not values_only:
                yield (
                 prevstart, min(self.stop, self._swigobj.max_index + 1), prevval)
            else:
                yield prevval
            return
    ...
    def __eq__(self, other):
      ...
      """
        if self.start_index() != other.start_index() or len(self) != len(other) or self.typecode() != other.typecode():
            print 'Mark A'
            return False
        ...
        while selfstop < self.start_index() + len(self) and othrstop < other.start_index() + len(other):
            if not (selfstart < othrstop and othrstart < selfstop):
                raise AssertionError
                return selfval == othrval or False
    ...
    def __reduce__(self):
        ...
        return (_StepVector_unpickle,
         (
          self.stop - self.start, self._typecode, self.start),
         None,
         None, ((slice(start, stop), val) for start, stop, val in self.get_steps()))
