...
# Embedded file name: build/bdist.linux-x86_64/egg/pyjon/descriptors/input.py
# Compiled at: 2015-01-27 14:42:54
__doc__ = 'InputItems are yielded by the descriptor\nan InputItem instance has an arbitrary number\nof attributes that are described in the schema.\n'
    ...
    def update(self, *args, **kwargs):
        if len(args):
            ...
            if len(kwargs):
                ...
                raise ValueError('Please provide an iterator, a dictionnary, or keyword arguments to update function')
