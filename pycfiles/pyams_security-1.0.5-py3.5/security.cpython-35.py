...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyams_security/security.py
...
from pyams_security.interfaces import ADMIN_USER_ID, GrantedRoleEvent, IDefaultProtectionPolicy, IProtectedObject, IRoleProtectedObject, RevokedRoleEvent
...
class RoleProtectedObject(Persistent, Contained):
    __doc__ = 'Base class for object protected by roles'
        ...
        for principal_id in principal_ids.copy():
            ...
            if principal_id in role_principals:
                ...
                if role_principals:
                    ...
                    if role_id in self._principals_by_role:
