...
# [GCC 8.4.0]
# Embedded file name: /Users/kelvin.liu/Code/OSS/kforce/tests/unit/test_commands.py
# Compiled at: 2018-02-25 01:47:17
...
class TestCommand(BaseCommandClient):
    ...
    def test_pre_run(self):
        ...
        ensure_func_names = [i for i in dir(c) if i.startswith('ensure') if callable(getattr(c, i))]
