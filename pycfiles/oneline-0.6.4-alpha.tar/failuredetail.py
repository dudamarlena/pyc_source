...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/plugins/failuredetail.py
...
class FailureDetail(Plugin):
    ...
    def options(self, parser, env):
        ...
        """
        parser.add_option('-d', '--detailed-errors', '--failure-detail', action='store_true', default=env.get('NOSE_DETAILED_ERRORS'), dest='detailedErrors', help='Add detail to error output by attempting to evaluate failed asserts [NOSE_DETAILED_ERRORS]')
