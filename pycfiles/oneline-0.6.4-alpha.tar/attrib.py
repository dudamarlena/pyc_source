...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/plugins/attrib.py
...
class AttributeSelector(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option('-a', '--attr', dest='attr', action='append', default=env.get('NOSE_ATTR'), metavar='ATTR', help='Run only tests that have attributes specified by ATTR [NOSE_ATTR]')
        if compat_24:
            parser.add_option('-A', '--eval-attr', dest='eval_attr', metavar='EXPR', action='append', default=env.get('NOSE_EVAL_ATTR'), help='Run only tests for whose attributes the Python expression EXPR evaluates to True [NOSE_EVAL_ATTR]')
