...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/result.py
...
def ln(*arg, **kw):
    ...
    warn('ln() has moved to nose.util from nose.result and will be removed from nose.result in a future release. Please update your imports ', DeprecationWarning)
    return _ln(*arg, **kw)