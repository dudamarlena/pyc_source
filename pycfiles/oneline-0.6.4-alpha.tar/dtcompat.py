...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/ext/dtcompat.py
        ...
        if self._exclude_empty and not docstring:
            ...
            if module is None:
                ...
                if filename[-4:] in ('.pyc', '.pyo'):
                    filename = filename[:-1]
                elif sys.platform.startswith('java') and filename.endswith('$py.class'):
