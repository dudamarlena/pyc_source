...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/proxy.py
...
class ResultProxy(object):
    ...
    def assertMyTest(self, test):
        ...
        assert test is self.test or test is case or test is getattr(case, '_nose_case', None), 'ResultProxy for %r (%s) was called with test %r (%s)' % (
    ...
    shouldStop = proxied_attribute('result', 'shouldStop', 'Should the test run stop?')
