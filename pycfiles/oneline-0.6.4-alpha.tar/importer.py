...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/importer.py
...
try:
    ...
    def _samefile(src, dst):
        return os.path.normcase(os.path.realpath(src)) == os.path.normcase(os.path.realpath(dst))
            ...
            for part in parts:
                ...
                try:
                    ...
                    if old is not None:
                        ...
                        if self.sameModule(old, filename) or self.config.firstPackageWins and getattr(old, '__path__', None):
                            mod = old
                        else:
