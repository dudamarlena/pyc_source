...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/plugins/base.py
    ...
    * The plugin will not be enabled unless this option is selected by
    ...
    def add_options(self, parser, env=None):
        ...
        try:
            ...
            warn('Plugin %s has conflicting option string: %s and will be disabled' % (
             self, e), RuntimeWarning)
            self.enabled = False
    ...
    def tolist(self, val):
        warn('Plugin.tolist is deprecated. Use nose.util.tolist instead', DeprecationWarning)
        return tolist(val)
