...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/database/sqlite3/cross_bdist_wininst.py
# Compiled at: 2013-10-18 04:32:34
...
class bdist_wininst(Command):
    ...
    def run(self):
        if 0 and sys.platform != 'win32' and (self.distribution.has_ext_modules() or self.distribution.has_c_libraries()):
    ...
    def get_installer_filename(self, fullname):
        if self.target_version:
            installer_name = os.path.join(self.dist_dir, '%s.win32-py%s.exe' % (
