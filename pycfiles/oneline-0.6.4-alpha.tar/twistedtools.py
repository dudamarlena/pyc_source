...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/twistedtools.py
    ...
    def decorate(func):
        ...
        def wrapper(*args, **kargs):
            ...
            def g():
                try:
                    ...
                    try:
                        ...
                        raise TypeError('you must return a twisted Deferred from your test case!')
            ...
            try:
                ...
                raise TimeExpired('timeout expired before end of test (%f s.)' % timeout)
