...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/plugins/allmodules.py
...
class AllModules(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option('--all-modules', action='store_true', dest=self.enableOpt, default=env.get(env_opt), help='Enable plugin %s: %s [%s]' % (
