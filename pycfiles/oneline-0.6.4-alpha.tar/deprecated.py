...
# [GCC 8.4.0]
# Embedded file name: /cygdrive/c/Users/Nad/oneline/oneline/lib/lz4/nose-1.3.4-py2.7.egg/nose/plugins/deprecated.py
...
class Deprecated(ErrorClassPlugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option('--no-deprecated', action='store_true', dest='noDeprecated', default=env.get(env_opt, False), help='Disable special handling of DeprecatedTest exceptions.')
