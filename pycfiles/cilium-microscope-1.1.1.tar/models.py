...
# Embedded file name: build/bdist.macosx-10.9-intel/egg/cili/models.py
# Compiled at: 2014-05-07 13:43:18
import pandas as pd, pandas.io.pytables as pt
...
class Events(object):
    ...
    def _local_dir(self):
        ...
        return [ c for c in self.dframes.keys() if isinstance(c, string_types) and isidentifier(c)
               ]
