...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/atlas/migrations/0005_auto__add_field_country_coordinates__add_field_region_coordinates.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if db_engine.rfind('mysql') == -1:
            db.add_column('atlas_country', 'coordinates', self.gf('atlas.fields.CoordinateField')(blank=True, null=True, geography=True), keep_default=False)
            db.add_column('atlas_region', 'coordinates', self.gf('atlas.fields.CoordinateField')(blank=True, null=True, geography=True), keep_default=False)
        elif not db.dry_run:
            db.execute('ALTER TABLE atlas_country ADD COLUMN `coordinates` POINT NULL;')
            db.execute('ALTER TABLE atlas_region ADD COLUMN `coordinates` POINT NULL;')

    def backwards(self, orm):
        db.delete_column('atlas_country', 'coordinates')
        db.delete_column('atlas_region', 'coordinates')
