...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/atlas/migrations/0002_auto__del_field_location_category__add_field_location_address.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('atlas_location', 'address', self.gf('django.db.models.fields.TextField')(max_length=512, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.add_column('atlas_location', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['category.Category'], null=True, blank=True), keep_default=False)
