...
# [GCC 8.4.0]
# Embedded file name: C:\Users\david\Projects\cosmicdb\cosmicdb\forms.py
# Compiled at: 2018-06-24 08:41:12
...
class CosmicFormHelper(FormHelper):
    ...
    def __init__(self, form, no_submit_row=False, submit_row=None, submit_value=None, submit_classes=None, submit_div_classes=None, field_layout=(), *args, **kwargs):
...
class CosmicSignupUserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {'password': help_text_html}
