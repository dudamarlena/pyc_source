...
# [GCC 8.4.0]
# Embedded file name: C:\Users\david\Projects\cosmicdb\cosmicdb\models.py
# Compiled at: 2018-06-24 02:08:08
...
class UserSystemMessage(models.Model):
    ...
    def __str__(self):
        return '%s - %s %s' % (self.user, self.subject, self.short_message())
