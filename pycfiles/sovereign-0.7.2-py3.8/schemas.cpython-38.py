...
class DiscoveryRequest(BaseModel):
 ...
 L. 197         0  SETUP_FINALLY        32  'to 32'

 L. 198         2  LOAD_GLOBAL              str
                4  LOAD_FAST                'self'
                6  LOAD_ATTR                node
 ...
 L. 201        46  SETUP_FINALLY        76  'to 76'

 L. 202        48  LOAD_FAST                'self'
               50  LOAD_ATTR                node
               52  LOAD_ATTR                build_version
               54  STORE_FAST               'build_version'

 L. 203        56  LOAD_FAST                'build_version'
...
class SovereignConfig(BaseModel):
    ...
    cache_strategy = load('env://SOVEREIGN_CACHE_STRATEGY', 'context')
