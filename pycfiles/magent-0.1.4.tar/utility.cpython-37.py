...
# [GCC 8.4.0]
# Embedded file name: /Users/mariojayakumar/Documents/School/2019_2020/Sem2/MAgent/python/magent/utility.py
# Compiled at: 2020-04-05 19:02:08
# Size of source mod 2**32: 8715 bytes
""" some utilities """
import math, collections, platform, numpy as np, logging, collections, os
from magent.builtin.rule_model import RandomActor

class EpisodesBufferEntry:
    __doc__ = 'Entry for episode buffer'
...
class EpisodesBuffer:
    __doc__ = 'Replay buffer to store a whole episode for all agents\n       one entry for one agent\n    '
...
def sample_observation(env, handles, n_obs=-1, step=-1):
    ...
    for i in range(n):
        ...
        features[i] = np.array((features[i]), dtype=(np.float32)).reshape((-1, ) + env.get_feature_space(handles[i]))
...
def check_model(name):
    ...
    infos = {'against':(('data/battle_model/battle/tfdqn_0.index',), 'https://raw.githubusercontent.com/merrymercy/merrymercy.github.io/master/_data/magent/against-0.tar.gz'), 
     'battle-game':(('data/battle_model/trusty-battle-game-l/tfdqn_0.index', 'data/battle_model/trusty-battle-game-r/tfdqn_0.index'),
 'https://raw.githubusercontent.com/merrymercy/merrymercy.github.io/master/_data/magent/battle_model.tar.gz'), 
     'arrange':(('data/arrange_model/arrange/tfdqn_10.index',), 'https://raw.githubusercontent.com/merrymercy/merrymercy.github.io/master/_data/magent/arrange_game.tar.gz')}
