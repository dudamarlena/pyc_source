...
# [GCC 8.4.0]
# Embedded file name: /Users/mariojayakumar/Documents/School/2019_2020/Sem2/MAgent/python/magent/model.py
# Compiled at: 2020-04-02 21:26:17
# Size of source mod 2**32: 10411 bytes
""" base model classes"""
try:
    import thread
except ImportError:
...
import multiprocessing, multiprocessing.connection, sys, numpy as np
...
class NDArrayPackage:
    __doc__ = 'wrapper for transferring numpy arrays by bytes'
...
class ProcessingModel(BaseModel):
    ...
    def __init__(self, env, handle, name, port, sample_buffer_capacity=1000, RLModel=None, **kwargs):
        """
        Parameters
        ----------
        env: environment
        ...
        kwargs['name'] = name
        addr = 'magent-pipe-' + str(port)
        proc = multiprocessing.Process(target=model_client,
          args=(
         addr, sample_buffer_capacity, RLModel, kwargs))
