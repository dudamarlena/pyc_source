...
# [GCC 8.4.0]
# Embedded file name: /home/gyst/plonesocial.buildout/src/plonesocial.activitystream/plonesocial/activitystream/browser/activitystream_portal.py
...
class PortletManagerViewlet(BrowserView):
    ...
    render = ViewPageTemplateFile('templates/activitystream_portletmanager_viewlet.pt')
...
class Assignment(base.Assignment):
    ...
    def __init__(self, title='Activity Stream', count=5, compact=True, show_microblog=True, show_content=True, show_discussion=True):
        self.title = title
        self.count = count
...
class Renderer(base.Renderer):
    ...
    def stream_provider(self):
        provider = getMultiAdapter((
         self.context, self.request, self.view), name='plonesocial.activitystream.stream_provider')
