...
# [GCC 8.4.0]
# Embedded file name: /Users/dj/workspace/dyson-py/lib/dyson/constants.py
# Compiled at: 2016-11-11 00:45:13
...
DEFAULT_SELENIUM_HUB = get_config(p, SELENIUM, 'hub', 'DYSON_SELENIUM_HUB', 'http://127.0.0.1:4444/wd/hub', value_type='string')
...
DEFAULT_SELENIUM_IMPLICIT_WAIT = get_config(p, SELENIUM, 'implicit_wait', 'DYSON_SELENIUM_IMPLICIT_WAIT', 0, value_type='int')
