...
# [GCC 8.4.0]
# Embedded file name: /Users/dj/workspace/dyson-py/lib/dyson/modules/core/waits/wait_for.py
# Compiled at: 2016-11-11 04:07:09
# Size of source mod 2**32: 11065 bytes
...
class WaitForModule(DysonModule):
    ...
    def run(self, webdriver, params):
        ...
        if isinstance(params, dict):
            ...
            if 'title_to_be' in params:
                ...
                return WebDriverWait(webdriver, timeout).until(expected_conditions.title_is(title))
            if 'title_to_contain' in params:
                ...
                return WebDriverWait(webdriver, timeout).until(expected_conditions.title_contains(title))
            if 'alert' in params:
                timeout = int(constants.DEFAULT_TIMEOUT)
                if 'timeout' in params['alert']:
                    timeout = int(params['alert']['timeout'])
                return WebDriverWait(webdriver, timeout).until(expected_conditions.alert_is_present())
            if 'text_to_be_present' in params:
                ...
                if 'in_element' in params['text_to_be_present']:
                    ...
                    if 'text' in params['text_to_be_present']:
                        ...
                        return WebDriverWait(webdriver, timeout).until(expected_conditions.text_to_be_present_in_element((
                ...
                if 'clickable' in params:
                    ...
                    return self._wait_for(params['clickable']['element'], expected_conditions.element_to_be_clickable, timeout, webdriver)
            ...
            if 'in_element' in params['value_to_be']:
                ...
                if 'value' in params['value_to_be']:
                    ...
                    strategy, selector = translate_selector_to_by(in_element)
                    return WebDriverWait(webdriver, timeout).until(expected_conditions.text_to_be_present_in_element_value((
            ...
            if 'presence_of_all' in params:
                ...
                if 'elements' in params['presence_of_all']:
                    ...
                    return self._wait_for(elements, expected_conditions.presence_of_all_elements_located, timeout, webdriver)
            ...
            if 'element_to_be_selected' in params:
                ...
                if 'element' in params['element_to_be_selected']:
                    ...
                    return self._wait_for(element, expected_conditions.element_located_to_be_selected, timeout, webdriver)
                raise DysonError('Key "element" is required')
        if 'selection_state_to_be' in params:
            ...
            if 'in_element' in params['selection_state_to_be']:
                ...
                if 'state' in params['selection_state_to_be']:
                    ...
                    strategy, selector = translate_selector_to_by(in_element)
                    return WebDriverWait(webdriver, timeout).until(expected_conditions.element_located_selection_state_to_be((
            ...
            if 'frame_and_switch' in params:
                ...
                if 'frame' in params['frame_and_switch']:
                    ...
                    return self._wait_for(frame, expected_conditions.frame_to_be_available_and_switch_to_it, timeout, webdriver)
    ...
    def _wait_for(self, element, expected_condition, timeout, webdriver):
        ...
        return WebDriverWait(webdriver, timeout).until(expected_condition((strategy, selector)))