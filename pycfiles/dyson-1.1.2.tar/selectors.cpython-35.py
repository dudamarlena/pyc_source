...
# [GCC 8.4.0]
# Embedded file name: /Users/dj/workspace/dyson-py/lib/dyson/utils/selectors.py
# Compiled at: 2016-11-10 23:42:05
# Size of source mod 2**32: 3599 bytes
...
def translate_selector_to_by(selector):
    ...
    """
    valid_selectors = {'CSS': 'CSS_SELECTOR', 
     'NAME': 'NAME', 
     'XPATH': 'XPATH', 
     'LINK': 'LINK_TEXT', 
    ...
    if isinstance(selector, dict):
        ...
        raise DysonError('%s is not a valid selector. Valid selectors are %s', the_strategy, ','.join([key for key, _ in valid_selectors.items()]))