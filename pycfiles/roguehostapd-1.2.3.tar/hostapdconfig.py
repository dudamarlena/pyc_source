...
# [GCC 8.4.0]
# Embedded file name: /root/toupload/roguehostapd/roguehostapd/config/hostapdconfig.py
# Compiled at: 2018-03-19 15:08:05
"""
...
class HostapdConfig(object):
    ...
    def __init__(self):
        ...
        self.custom_action = {'wpspbc': self.update_wps_configuration, 
    ...
    def update_options(self, options):
        ...
        for key in self.options:
            if key in options and not options[key]:
                self.options[key] = ''
            elif key in self.options and self.options[key] or key in options and options[key]:
