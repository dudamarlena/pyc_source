...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/utils.py
# Compiled at: 2019-12-30 09:57:39
...
def create_limit_table(table_name, index_name='idx'):
    ...
    provisioned_throughput = {'ReadCapacityUnits':123, 
     'WriteCapacityUnits':123}
    mock_client.create_table(TableName=table_name, KeySchema=key_schema,
