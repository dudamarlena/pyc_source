...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/config/_version.py
# Compiled at: 2020-04-11 22:35:11
# Size of source mod 2**32: 18449 bytes
...
def get_config():
    ...
    cfg.versionfile_source = 'tpDcc/config/_version.py'
    cfg.verbose = False
    return cfg
