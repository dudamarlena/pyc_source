...
# [GCC 8.4.0]
# Embedded file name: /Users/freedev/Code/OpenSource/paydunya-python/paydunya/invoice.py
# Compiled at: 2017-08-18 23:11:32
# Size of source mod 2**32: 4446 bytes
"""PAYDUNYA Invoice"""
from . import Payment
from collections import namedtuple
InvoiceItem = namedtuple('InvoiceItem', 'name quantity unit_price                              total_price description')

class Invoice(Payment):
    __doc__ = 'Payment invoice'
    ...
    def _prepare_data(self):
        ...
        self._data = {'invoice':{'items':self._Invoice__encode_items(self.items), 
          'taxes':self.taxes, 
