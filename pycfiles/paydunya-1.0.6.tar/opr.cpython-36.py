...
# [GCC 8.4.0]
# Embedded file name: /Users/freedev/Code/OpenSource/paydunya-python/paydunya/opr.py
...
class OPR(Payment):
    __doc__ = 'Onsite Payment Request'
    ...
    def _build_opr_data(self, data, store):
        ...
        return {'invoice_data':{'invoice':{'total_amount':data.get('total_amount'), 
