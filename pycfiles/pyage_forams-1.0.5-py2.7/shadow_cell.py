...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyage_forams/solutions/agent/shadow_cell.py
...
class ShadowCell(object):
    ...
    def export_foram(self, foram):
        ...
        self.request_dispatcher.submit_request(MigrateRequest(self.agent_address, self.address, foram))
