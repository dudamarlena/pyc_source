...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyage_forams/conf/distributed3d/lowerleftback.py
...
neighbours = lambda : {'right': 'lowerrightback', 'upper': 'upperleftback', 'front': 'lowerleftfront'}