...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyage_forams/solutions/test_environment.py
# Compiled at: 2014-10-24 17:48:51
...
class TestEnvironment(TestCase):
    ...
    def _get_environments(self):
        return [
         Environment2d(0.2), Environment3d(0.2)]