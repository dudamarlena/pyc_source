...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/nport/tool.py
...
def main():
    ...
    parser.add_option('-f', '--format', action='store', type='string', dest='format', metavar='FORMAT', default='tstone', help='set output format (tstone or citi)')
    parser.add_option('-r', '--recombine', action='store', type='string', dest='recombine', metavar='PORTLIST', help='recombine ports')
