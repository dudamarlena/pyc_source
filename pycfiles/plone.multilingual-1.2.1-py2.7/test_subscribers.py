...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/plone/multilingual/tests/test_subscribers.py
...
import transaction, unittest2 as unittest
...
class TestSubscribers(unittest.TestCase):
    ...
    def test_created_event_on_portal(self):
        ...
        self.assertEqual(ILanguage(folder_1).get_language(), language_tool.getPreferredLanguage())
