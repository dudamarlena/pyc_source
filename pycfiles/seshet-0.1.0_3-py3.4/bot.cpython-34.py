...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/seshet/bot.py
# Compiled at: 2015-07-16 08:41:12
# Size of source mod 2**32: 7260 bytes
...
class SeshetBot(bot.SimpleBot):
    ...
    def log(self, etype, source, msg='', target='', hostmask='', parms=''):
        ...
        """
        self.db.event_log.insert(event_type=etype, event_time=datetime.utcnow(), source=source, target=target, message=msg, host=hostmask, parms=parms)
        self.db.commit()
