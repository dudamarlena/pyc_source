...
# [GCC 8.4.0]
# Embedded file name: /Users/reg/src/youtube/youtube2zim/entrypoint.py
# Compiled at: 2020-04-17 11:27:05
...
def main():
    ...
    parser.add_argument('--type',
      ...
      choices=[
     CHANNEL, PLAYLIST, USER],
      required=True,
      dest='collection_type')
    parser.add_argument('--id',
      help='Youtube ID of the collection', required=True, dest='youtube_id')
    ...
    parser.add_argument('--format',
     ...
     'mp4', 'webm'],
      default='webm',
      dest='video_format')
    parser.add_argument('--low-quality',
      help='Re-encode video using stronger compression',
      action='store_true',
      default=False)
    parser.add_argument('--all-subtitles',
    ...
    parser.add_argument('--output',
      ...
      default='/output',
      dest='output_dir')
    parser.add_argument('--no-zim',
      help="Don't produce a ZIM file, create HTML folder only.",
      action='store_true',
      default=False)
    parser.add_argument('--zim-file',
      help='ZIM file name (based on --name if not provided)',
      dest='fname')
    parser.add_argument('--language',
      help='ISO-639-3 (3 chars) language code of content', default='eng')
    ...
    parser.add_argument('--publisher',
      help='Custom publisher name (ZIM metadata)', default='Kiwix')
    ...
    parser.add_argument('--debug',
      help='Enable verbose output', action='store_true', default=False)
    ...
    parser.add_argument('--concurrency',
      ...
      default=1)
    parser.add_argument('--only_test_branding',
