...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/huskarl/agent/dqn.py
# Compiled at: 2019-06-13 12:59:36
# Size of source mod 2**32: 7563 bytes
            ...
            if self.dueling_type == 'avg':
                ...
                if self.dueling_type == 'max':
                    ...
                    if self.dueling_type == 'naive':
                        ...
                        raise HkException("dueling_type must be one of {'avg','max','naive'}")
