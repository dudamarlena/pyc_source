...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/tornask/manager.py
# Compiled at: 2016-01-08 10:32:37
"""
    ...
    def task_register(self, task_name, callback, interval=1, call_at=(), endtime=None):
        ...
        if callable(callback):
            try:
                ...
                self._task_pool.update({task_name: DiligentPeriodicCallback(call, 60000 * float(interval))})
            except Exception as ex:
