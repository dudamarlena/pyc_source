...
# [GCC 8.4.0]
# Embedded file name: /Users/hannu/soft/anaconda/envs/p36/lib/python3.6/site-packages/ldtk/client.py
# Compiled at: 2017-05-15 05:39:40
...
class Client(object):
    ...
    def __init__(self, limits=None, verbosity=1, offline_mode=False, update_server_file_list=False, cache=None):
        ...
        elif exists(self._server_file_list) and not update_server_file_list:
