...
# [GCC 8.4.0]
# Embedded file name: /home/kalimaha/Development/git-repositories/Geobricks/pgeo/pgeo/dataproviders/modis.py
# Compiled at: 2014-09-01 07:34:23
...
def get_modis_product_table():
    ...
    products = []
    keys = [
     'code', 'platform', 'modis_data_product', 'raster_type', 'spatial_resolution', 'temporal_resolution']
    for tr in trs:
        p = {}
        counter = 0
        tds = tr.findAll('td')
        ...
        if conf['source']['type'] == 'FTP':
            ...
            for line in ls:
                try:
                    ...
                    out.append({'file_name': file_name, 
                       'file_path': file_path, 
                       'label': label, 
                       'size': size})
                except:
