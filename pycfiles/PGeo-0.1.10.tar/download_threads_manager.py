...
# [GCC 8.4.0]
# Embedded file name: /home/kalimaha/Development/git-repositories/Geobricks/pgeo/pgeo/thread/download_threads_manager.py
# Compiled at: 2014-09-01 07:56:12
...
class Manager(Thread):
    ...
    def start_manager(self):
        ...
        for thread_name in thread_list:
            ...
            thread.start()
            if threads_map_key not in thread_manager_processes:
