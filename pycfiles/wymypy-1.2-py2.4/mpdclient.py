...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/wymypy/libs/mpdclient.py
# Compiled at: 2007-01-13 08:08:39
"""
...
_playerStates = {'unknown': 0, 'stop': 1, 'play': 2, 'pause': 3, 0: 'unknown', 1: 'stop', 2: 'play', 3: 'pause'}
_searchTables = {'artist': 0, 'album': 1, 'title': 2, 'filename': 3, 0: 'artist', 1: 'album', 2: 'title', 3: 'filename'}
...
class MpdConnection(object):
  ...
  """
    ...
    def getStatus(self):
        ...
        tocheck = {'volume': -9, 'repeat': 0, 'random': 0, 'playlist': 0, 'playlistLength': 0, 'state': 0}
