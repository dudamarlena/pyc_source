...
# Size of source mod 2**32: 28302 bytes
...
class SingleMachineBatchSystem(BatchSystemSupport):
    ...
    def issueBatchJob(self, jobNode):
        ...
        self.checkResourceRequest((jobNode.memory), cores, (jobNode.disk), name=(jobNode.jobName), detail=('Scale is set to {}.'.format(self.scale)))
