...
# Size of source mod 2**32: 72204 bytes
...
import re, time, uuid, base64, hashlib, itertools, reprlib, urllib.parse, urllib.request, urllib.parse, urllib.error
        ...
        def downloadStream(self, verifyChecksum=True):
            ...
            class HashingPipe(ReadableTransformingPipe):
                ...
                def transform(self, readable, writable):
                    ...
                    contents = readable.read(1048576)
                    while contents != b'':
