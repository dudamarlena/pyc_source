...
# Size of source mod 2**32: 72959 bytes
"""Implemented support for Common Workflow Language (CWL) for Toil."""
import argparse, os, tempfile, json, sys, stat, logging, copy, functools, uuid, urllib, datetime
...
from cwltool.pathmapper import PathMapper, adjustDirObjs, adjustFileObjs, get_listing, MapperEnt, visit_class, normalizeFilesDirs, downloadHttpFile
        ...
        if obj['location'] in self._pathmap:
            ...
            if obj['class'] == 'Directory':
                ...
                if 'contents' in obj and path.startswith('_:'):
                    ...
                    with SourceLine(obj, 'location', validate.ValidationException, cwllogger.isEnabledFor(logging.DEBUG)):
                        ...
                        if urllib.parse.urlsplit(deref).scheme in ('http', 'https'):
                            ...
                            if urllib.parse.urlsplit(deref).scheme != 'toilfs':
                                st = os.lstat(deref)
