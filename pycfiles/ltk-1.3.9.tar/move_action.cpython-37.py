...
# [GCC 8.4.0]
# Embedded file name: /home/hectorlopez/.virtualenvs/lingotek/lib/python3.7/site-packages/ltk/actions/move_action.py
    ...
    def mv_file(self, source, destination):
        ...
        try:
            ...
            while repo_directory and repo_directory != '':
                repo_directory = os.path.isdir(repo_directory + os.sep + '.ltk') or repo_directory.split(self.path_sep)[:-1]
                repo_directory = self.path_sep.join(repo_directory)

            if not repo_directory not in self.path_to_source:
                if repo_directory not in self.path_to_destination:
                ...
                if os.path.isdir(source):
                    if os.path.isdir(destination):
                        ...
                        if self.mv_file(source, destination):
                            ...
                            logger.error('Failed to move folder ' + source)
