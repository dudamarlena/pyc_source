...
# [GCC 8.4.0]
# Embedded file name: /home/hectorlopez/.virtualenvs/lingotek36/lib/python3.6/site-packages/ltk/utils.py
...
def is_valid_locale(api, locale):
    ...
    if remote_check and check_locale not in valid_locales or not remote_check and check_locale not in locale_list:
        return False
    else:
        return True
