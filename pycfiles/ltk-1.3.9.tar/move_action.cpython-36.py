...
# [GCC 8.4.0]
# Embedded file name: /home/hectorlopez/.virtualenvs/lingotek36/lib/python3.6/site-packages/ltk/actions/move_action.py
...
class MoveAction(Action):
    ...
    def _do_move(self):
        try:
            if self.rename:
                if self.source_type == 'file':
                    if self.path_to_source.rstrip(self.path_sep).rstrip(self.doc['name']) != self.path_to_source.rstrip(self.path_sep):
