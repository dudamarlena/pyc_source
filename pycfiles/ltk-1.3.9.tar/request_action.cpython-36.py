...
# [GCC 8.4.0]
# Embedded file name: /home/hectorlopez/.virtualenvs/lingotek36/lib/python3.6/site-packages/ltk/actions/request_action.py
...
class RequestAction(Action):
    ...
    def _handleEntryRequest(self, entry, locales):
        ...
        if self.change_db_entry:
            if self.to_delete or self.to_cancel:
                if self.entered_locales:
