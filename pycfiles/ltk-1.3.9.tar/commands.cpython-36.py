...
# [GCC 8.4.0]
# Embedded file name: /home/hectorlopez/.virtualenvs/lingotek36/lib/python3.6/site-packages/ltk/commands.py
...
def rm(file_names, **kwargs):
    ...
    try:
        ...
        init_logger(action.path)
        if not file_names:
            if not ('all' in kwargs and kwargs['all'] or 'local' in kwargs and kwargs['local']):
