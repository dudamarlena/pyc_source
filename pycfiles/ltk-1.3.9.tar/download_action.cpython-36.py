...
# [GCC 8.4.0]
# Embedded file name: /home/hectorlopez/.virtualenvs/lingotek36/lib/python3.6/site-packages/ltk/actions/download_action.py
        ...
        if len(name_parts) > 1:
            for p in name_parts:
                if p.lower() == self.locale.lower():
                    ...
                    if p.replace('_', '-').lower() == self.locale.lower():
                        loc_check = self.locale_check(p)
