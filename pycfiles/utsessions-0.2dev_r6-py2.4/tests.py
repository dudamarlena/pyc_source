...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/utsessions/tests.py
# Compiled at: 2008-12-23 17:10:02
"""Test for utsessions"""
import unittest
...
class SessionCollectorTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user('TestUser', 'test@test.com', 'testtest')
