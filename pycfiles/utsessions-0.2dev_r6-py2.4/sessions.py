...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/utsessions/sessions.py
# Compiled at: 2008-12-23 16:16:38
...
class SessionCollector(object):
    ...
    def register(self, request):
        ...
        if request.session.session_key not in self._sessions.keys():
            self._sessions[request.session.session_key] = (
