...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.6/dist-packages/diffval/log.py
# Compiled at: 2010-10-25 15:48:08
import datetime, sys, xml.sax.saxutils, xml.sax.xmlreader
...
class log:
    ...
    def closeElement(self, *args, **kwargs):
        ...
        if not tag:
            ...
            print 'attempting to end element ' + tag + ' but ' + last + ' should be next'
...
class xmllog(log):
    ...
    def openElement(self, tag, attributes={}, pretty=True):
        ...
        self._logger.startElementNS((None, tag), tag, self._createAttributes(dict=attributes))
        self._file.flush()
        return
