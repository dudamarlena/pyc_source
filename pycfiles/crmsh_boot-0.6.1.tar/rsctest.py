...
# Embedded file name: /usr/lib/python2.7/site-packages/crmsh/rsctest.py
...
class RADriver(object):
    ...
    """
    pfx = {'instance_attributes': 'OCF_RESKEY_', 
...
def check_test_support(resources):
    ...
    for r in resources:
        ...
        if not ra_class:
            ...
            common_warn('testing of class %s resources not supported' % ra_class)
            rc = False
