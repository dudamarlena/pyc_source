...
# Embedded file name: /usr/lib/python2.7/site-packages/crmsh/cibstatus.py
...
class CibStatus(object):
    ...
    def run(self, nograph, scores, utilization, actions, verbosity):
        return self._crm_simulate(self.cmd_run, nograph, scores, utilization, verbosity)

    def simulate(self, nograph, scores, utilization, actions, verbosity):
        return self._crm_simulate(self.cmd_simulate, nograph, scores, utilization, verbosity)
