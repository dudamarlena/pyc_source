...
# Embedded file name: /usr/lib/python2.7/site-packages/crmsh/msg.py
# Compiled at: 2016-05-26 00:35:28
import sys
...
class ErrorBuffer(object):
    ...
    def one_warning(self, s):
        if s not in self.written:
            self.written[s] = 1
            self.writemsg(self._render(clidisplay.warn('WARNING')) + ': %s' % self.add_lineno(s))
