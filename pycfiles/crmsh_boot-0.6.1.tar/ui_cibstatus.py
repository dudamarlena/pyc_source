...
# Embedded file name: /usr/lib/python2.7/site-packages/crmsh/ui_cibstatus.py
...
class CibStatusUI(command.UI):
    ...
    @command.skill_level('expert')
    @command.completers(compl.choice(constants.ra_operations), compl.call(cib_status.status_rsc_list), compl.choice(constants.lrm_exit_codes.keys()), compl.choice(constants.lrm_status_codes.keys()), compl.choice(constants.node_states))
