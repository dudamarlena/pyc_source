...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/stringify/util.py
# Compiled at: 2017-10-24 19:10:48
...
def _bin_to_py_file(source_file_path, destination_file='binary.py', overwrite=True):
    """
