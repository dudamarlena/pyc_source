...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/PythonConfluenceAPI/api.py
...
class ConfluenceAPI(object):
    ...
    def _service_request(self, request_type, sub_uri, params=None, callback=None, raise_for_status=True, raw=False, **kwargs):
        """
        ...
        if callback:
            ...
            if not response.text and not raw:
                return
            else:
                if raw:
    ...
    def get_content(self, content_type=None, space_key=None, title=None, status=None, posting_day=None, expand=None, start=None, limit=None, callback=None):
        """
    ...
    def get_content_by_id(self, content_id, status=None, version=None, expand=None, callback=None):
        ...
        if expand:
            params['expand'] = expand
        return self._service_get_request(('rest/api/content/{id}').format(id=content_id), params=params, callback=callback)
    ...
    def get_content_history_by_id(self, content_id, expand=None, callback=None):
        ...
        if expand:
            params['expand'] = expand
        return self._service_get_request(('rest/api/content/{id}/history').format(id=content_id), params=params, callback=callback)
    ...
    def get_content_macro_by_hash(self, content_id, version, macro_hash, callback=None):
        ...
        :return: The JSON data returned from the endpoint, or the results of the callback.
                 Will raise requests.HTTPError on bad input, potentially.
        """
        return self._service_get_request(('rest/api/content/{id}/history/{version}/macro/hash/{hash}').format(id=content_id, version=version, hash=macro_hash), callback=callback)
    ...
    def get_content_children(self, content_id, expand=None, parent_version=None, callback=None):
        ...
        return self._service_get_request(('rest/api/content/{id}/child').format(id=content_id), params=params, callback=callback)

    def get_content_children_by_type(self, content_id, child_type, expand=None, parent_version=None, start=None, limit=None, callback=None):
        """
        ...
        if limit is not None:
            params['limit'] = int(limit)
        return self._service_get_request(('rest/api/content/{id}/child/{type}').format(id=content_id, type=child_type), params=params, callback=callback)
    ...
    def get_content_descendants(self, content_id, expand=None, callback=None):
        ...
        if expand:
            params['expand'] = expand
        return self._service_get_request(('rest/api/content/{id}/descendant').format(id=content_id), params=params, callback=callback)
    ...
    def get_content_labels(self, content_id, prefix=None, start=None, limit=None, callback=None):
        ...
        if limit is not None:
            params['limit'] = int(limit)
        return self._service_get_request(('rest/api/content/{id}/label').format(id=content_id), params=params, callback=callback)

    def get_content_comments(self, content_id, expand=None, parent_version=None, start=None, limit=None, location=None, depth=None, callback=None):
        """
        ...
        if depth:
            assert depth in {'', 'all'}
            params['depth'] = depth
        return self._service_get_request(('rest/api/content/{id}/child/comment').format(id=content_id), params=params, callback=callback)

    def get_content_attachments(self, content_id, expand=None, start=None, limit=None, filename=None, media_type=None, callback=None):
        """
        ...
        return self._service_get_request(('rest/api/content/{id}/child/attachment').format(id=content_id), params=params, callback=callback)
    ...
    def get_content_properties(self, content_id, expand=None, start=None, limit=None, callback=None):
        ...
        if limit is not None:
            params['limit'] = int(limit)
        return self._service_get_request(('rest/api/content/{id}/property').format(id=content_id), params=params, callback=callback)
    ...
    def get_content_property_by_key(self, content_id, property_key, expand=None, callback=None):
        ...
        if expand:
            params['expand'] = expand
        return self._service_get_request(('rest/api/content/{id}/property/{key}').format(id=content_id, key=property_key), params=params, callback=callback)
    ...
    def get_op_restrictions_for_content_id(self, content_id, expand=None, callback=None):
        ...
        if expand:
            params['expand'] = expand
        return self._service_get_request(('rest/api/content/{id}/restriction/byOperation').format(id=content_id), params=params, callback=callback)
    ...
    def get_space_information(self, space_key, expand=None, callback=None):
        ...
        if expand:
            params['expand'] = expand
        return self._service_get_request(('rest/api/space/{key}').format(key=space_key), params=params, callback=callback)
    ...
    def get_space_content(self, space_key, depth=None, expand=None, start=None, limit=None, callback=None):
        ...
        if limit is not None:
            params['limit'] = int(limit)
        return self._service_get_request(('rest/api/space/{key}/content').format(key=space_key), params=params, callback=callback)
    ...
    def get_space_content_by_type(self, space_key, content_type, depth=None, expand=None, start=None, limit=None, callback=None):
        ...
        if limit is not None:
            params['limit'] = int(limit)
        return self._service_get_request(('rest/api/space/{key}/content/{type}').format(key=space_key, type=content_type), params=params, callback=callback)
    ...
    def create_new_content(self, content_data, callback=None):
        ...
        return self._service_post_request('rest/api/content', data=json.dumps(content_data), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def create_new_attachment_by_content_id(self, content_id, attachments, callback=None):
        ...
        if isinstance(attachments, list):
            ...
            assert False
        return self._service_post_request(('rest/api/content/{id}/child/attachment').format(id=content_id), headers={'X-Atlassian-Token': 'nocheck'}, files=attachments, callback=callback)
    ...
    def create_new_label_by_content_id(self, content_id, label_names, callback=None):
        ...
        return self._service_post_request(('rest/api/content/{id}/label').format(id=content_id), data=json.dumps(label_names), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def create_new_property(self, content_id, property_key, new_property_data, callback=None):
        ...
        return self._service_post_request(('rest/api/content/{id}/property/{key}').format(id=content_id, key=property_key), data=json.dumps(new_property_data), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def create_new_content_property(self, content_id, content_property, callback=None):
        ...
        return self._service_post_request(('rest/api/content/{id}/property').format(id=content_id), data=json.dumps(content_property), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def create_new_space(self, space_definition, callback=None):
        ...
        return self._service_post_request('rest/api/space', data=json.dumps(space_definition), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def create_new_private_space(self, space_definition, callback=None):
        ...
        """
        assert isinstance(space_definition, dict) and {'key', 'name', 'description'} <= set(space_definition.keys())
        return self._service_post_request('rest/api/space/_private', data=json.dumps(space_definition), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def update_content_by_id(self, content_data, content_id, callback=None):
        ...
        return self._service_put_request(('rest/api/content/{id}').format(id=content_id), data=json.dumps(content_data), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def update_attachment_metadata(self, content_id, attachment_id, new_metadata, callback=None):
        ...
        return self._service_put_request(('rest/api/content/{id}/child/attachment/{attachment_id}').format(id=content_id, attachment_id=attachment_id), data=json.dumps(new_metadata), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def update_attachment(self, content_id, attachment_id, attachment, callback=None):
        ...
        if isinstance(attachment, dict):
            ...
            assert False
        return self._service_post_request(('rest/api/content/{content_id}/child/attachment/{attachment_id}/data').format(content_id=content_id, attachment_id=attachment_id), headers={'X-Atlassian-Token': 'nocheck'}, files=attachment, callback=callback)
    ...
    def update_property(self, content_id, property_key, new_property_data, callback=None):
        ...
        return self._service_put_request(('rest/api/content/{id}/property/{key}').format(id=content_id, key=property_key), data=json.dumps(new_property_data), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def update_space(self, space_key, space_definition, callback=None):
        ...
        """
        assert isinstance(space_definition, dict) and {'key', 'name', 'description'} <= set(space_definition.keys())
        return self._service_put_request(('rest/api/space/{key}').format(key=space_key), data=json.dumps(space_definition), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def convert_contentbody_to_new_type(self, content_data, old_representation, new_representation, callback=None):
        ...
        """
        assert {
         old_representation, new_representation} < {'storage', 'editor', 'view', 'export_view'}
        request_data = {'value': str(content_data), 'representation': old_representation}
        return self._service_post_request(('rest/api/contentbody/convert/{to}').format(to=new_representation), data=json.dumps(request_data), headers={'Content-Type': 'application/json'}, callback=callback)
    ...
    def delete_content_by_id(self, content_id, status=None, callback=None):
        ...
        if status:
            params['status'] = status
        return self._service_delete_request(('rest/api/content/{id}').format(id=content_id), params=params, callback=callback)
    ...
    def delete_label_by_id(self, content_id, label_name, callback=None):
        ...
        return self._service_delete_request(('rest/api/content/{id}/label').format(id=content_id), params=params, callback=callback)
    ...
    def delete_property(self, content_id, property_key, callback=None):
        ...
        :return: Empty if successful, or the results of the callback.
                 Will raise requests.HTTPError on bad input, potentially.
        """
        return self._service_delete_request(('rest/api/content/{id}/property/{key}').format(id=content_id, key=property_key), callback=callback)
