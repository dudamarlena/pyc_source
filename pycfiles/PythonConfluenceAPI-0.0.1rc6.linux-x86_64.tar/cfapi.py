...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/PythonConfluenceAPI/cfapi.py
...
class ConfluenceFuturesAPI(ConfluenceAPI):
    ...
    def __init__(self, username, password, uri_base, user_agent=ConfluenceAPI.DEFAULT_USER_AGENT, executor=None, max_workers=10):
        """
