...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/oort/sitebase.py
# Compiled at: 2007-09-30 15:55:19
...
class ResourceViewerBase:
    ...
    @classmethod
    def app_factory(cls, global_conf=None, graph_factory=None, **cfg):
    ...
    def __init__(self, graph, cfg={}):
        ...
        self.displays = dict(((name, dispCls(cfg=cfg)) for (name, dispCls) in self.displayClasses.items()))
    ...
    def __call__(self, environ, start_response):
        ...
        (get_result, contentType) = self.prepared_display(URIRef(uri), lang, displayArg, req)
        headerMap = {}
        if contentType:
    ...
    def _default_redirect(self, lang, environ, start_response):
        redirect = HTTPTemporaryRedirect(self.app_url_for(lang or self.langOrder[0], self.defaultDisplay))
    ...
    def prepared_display(self, resource, lang, displayArg, req):
        ...
        return (
         get_result, display.contentType)
