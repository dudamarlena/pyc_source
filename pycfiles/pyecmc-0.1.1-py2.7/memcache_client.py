...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ecmc/memcache_client.py
# Compiled at: 2016-04-15 12:57:32
...
class Cluster(object):
    ...
    def refresh(self, endpoint, timeout):
        ...
        elasticache_logger.debug('cluster: %s %s %s %s %s %s', str(host), str(type(host)), str(port), str(type(port)), str(timeout), str(type(timeout)))
