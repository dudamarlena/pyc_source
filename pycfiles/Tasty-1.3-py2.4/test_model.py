...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tasty/tests/test_model.py
# Compiled at: 2007-05-08 14:16:53
...
class TestModel(unittest.TestCase):
    ...
    def test_unicode(self):
        s = Service(name='王菲')
        assert s.name == '王菲'
        u = User(username='王菲', service=s)
        assert u.username == '王菲'
        i = Item(name='王菲', service=s)
        assert i.name == '王菲'
        t = Tag(name='王菲', service=s)
        assert t.name == '王菲'
