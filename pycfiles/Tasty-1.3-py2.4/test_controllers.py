...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tasty/tests/test_controllers.py
# Compiled at: 2007-05-08 14:18:52
...
class TestService(TastyTest):
    ...
    def test_index(self):
        ...
        assert {'item': 'testitem'} in r['items']
        assert {'user': 'anders'} in r['users']
        assert {'tag': 'swedish'} in r['tags']
