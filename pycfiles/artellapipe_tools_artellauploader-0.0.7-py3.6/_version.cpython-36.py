...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/artellauploader/_version.py
# Compiled at: 2020-04-15 10:43:54
# Size of source mod 2**32: 18470 bytes
...
def get_config():
    ...
    cfg.versionfile_source = 'artellapipe/tools/artellauploader/_version.py'
    cfg.verbose = False
    return cfg
