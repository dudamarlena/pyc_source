...
# [GCC 8.4.0]
# Embedded file name: /Users/dominicmonn/Documents/Private/cms-sample/dev_packages/djangocms-career/djangocms_career/tests.py
# Compiled at: 2016-04-18 09:40:29
...
class ModelFunctionTestCase(TestCase):
    ...
    def setUp(self):
        Post.objects.create(title='Some Job I had', company='Google', start_date=datetime.datetime.now() - datetime.timedelta(days=730), end_date=datetime.datetime.now() - datetime.timedelta(days=365), active_post=False)
        Post.objects.create(title='Some Job I have right now', company='Alphabet', start_date=datetime.datetime.now() - datetime.timedelta(days=731), active_post=True)
        Post.objects.create(title='Some Job I where I got fired', company='Microsoft', start_date=datetime.datetime.now() - datetime.timedelta(days=365), end_date=datetime.datetime.now() - datetime.timedelta(days=320), active_post=False)
