...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/pathlib_mate-project/pathlib_mate/mate_mutate_methods.py
# Compiled at: 2020-03-14 13:53:09
# Size of source mod 2**32: 5660 bytes
"""
...
class MutateMethods(object):
    ...
    def change(self, new_abspath=None, new_dirpath=None, new_dirname=None, new_basename=None, new_fname=None, new_ext=None):
        """
        ...
        if new_abspath is not None:
            ...
            if new_dirpath is None:
                if new_dirname is not None:
                    ...
                    if new_dirpath is None and new_dirname is None:
                        new_dirpath = self.dirpath
                    elif new_dirpath is not None:
                        if new_dirname is not None:
                ...
                elif new_fname is not None or new_ext is not None:
                    raise ValueError('Cannot having both new_basename, new_fname, new_ext!')
    ...
    def moveto(self, new_abspath=None, new_dirpath=None, new_dirname=None, new_basename=None, new_fname=None, new_ext=None, overwrite=False, makedirs=False):
        """
        ...
        **中文文档**
        ...
        """
        self.assert_exists()
        p = self.change(new_abspath=new_abspath,
          new_dirpath=new_dirpath,
    ...
    def copyto(self, new_abspath=None, new_dirpath=None, new_dirname=None, new_basename=None, new_fname=None, new_ext=None, overwrite=False, makedirs=False):
        """
