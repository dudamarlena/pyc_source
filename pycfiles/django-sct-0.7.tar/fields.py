...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/community/fields.py
...
class TagField(forms.CharField):
    ...
    def __init__(self, model=None, *args, **kwargs):
        if 'help_text' not in kwargs:
            kwargs['help_text'] = _('Comma separated list of tags.')
        widget = TagWidget
