...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/sphwiki/wikimacros.py
...
class AttachmentListMacro(object):
    ...
    def handleMacroCall(self, doc, params):
        ...
        res = object_list(request=get_current_request(), queryset=attachments, template_name=templateName, extra_context={'snip': self.snip}, allow_empty=True, template_object_name='attachment')
...
class AttachmentMacro(object):
    ...
    def handleMacroCall(self, doc, params):
        ...
        c = template.Context({'attachment': attachment, 'params': params})
    ...
    def handleMacroCall(self, doc, params):
        if params.has_key('id'):
            try:
                ...
                if 'nolink' not in params or not params['nolink']:
