...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/community/templatetags/sph_pagination.py
...
def sph_pagination(context, pages, page, url='', getparam='page', compress=0):
    ...
    if compress:
        ...
        first = None
        last = None
    to_return = {'page_range': page_range, 'page': page, 
       'pages': pages, 
       'has_next': has_next, 
       'has_prev': has_prev, 
       'next': page + 1, 
