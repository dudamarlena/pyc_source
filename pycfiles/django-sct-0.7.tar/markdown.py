...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/contrib/libs/markdown/markdown.py
    ...
    def registerExtensions(self, extensions, configs):
        ...
        for ext in extensions:
            ...
            try:
                ...
                message(CRITICAL, "couldn't load extension %s (looking for %s module)" % (
                ...
                if len(paragraph) and paragraph[0].startswith('#'):
                    ...
                    if m:
                        ...
                        if self.number_headings:
                            ...
                            if level not in header_numbers:
                                header_numbers[level] = 0
                            header_numbers[level + 1] = 0
                            header_numbers[level] += 1
                            for lvl in range(1, level + 1):
                                if lvl not in header_numbers:
                                    header_numbers[lvl] = 1
