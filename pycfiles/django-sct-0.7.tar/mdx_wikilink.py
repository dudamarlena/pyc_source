...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/contrib/libs/markdown/mdx_wikilink.py
...
class WikiLinkExtension(markdown.Extension):
    ...
    def __init__(self, configs):
        self.config = {'base_url': [
           ...
           'html_class': [
                        'wikilink', 'CSS hook. Leave blank for none.'], 
           'callback': [
                      None, 'Callback method which is called when creating a link.']}
...
class WikiLinks(markdown.BasePattern):
    ...
    def handleMatch(self, m, doc):
        ...
        if 'href' not in wikilink:
            return doc.createTextNode(wikilink['label'])
