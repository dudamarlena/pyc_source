...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/generic/advanced_object_list/list.py
...
class BaseAdvancedObjectList(object):
    ...
    def __init__(self, object_provider, template_name='sphene/community/generic/advanced_list.html', state=None, object_name=ugettext_lazy('Items'), prefix='objlist', session=None, requestvars=None, defaultcolconfig=None, defaultsortby=None, defaultsortorder=None, cssclass=None):
    ...
    def prepare(self):
        ...
        self.columns = instance_columns
        self._prepared = True

    def get_sorting(self):
        return (
         self.state.get('sortby', self.defaultsortby),
    ...
    def __unicode__(self):
        ...
        return render_to_string(self.template_name, {'columns': self.columns, 'content': self.get_content(), 
           'list': self, 
    ...
    def get_content(self):
        ...
        for object in self.object_provider.get_page(paging['first'], paging['last']):
            ...
            for subcolumns in self.columns:
                columns.append([ (cid, column, column.get_value(object)) for (cid, column) in subcolumns
                               ])
