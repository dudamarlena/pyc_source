...
# [GCC 8.4.0]
# Embedded file name: /Users/herbert/dev/python/sctdev/simpleproject/simpleproject/../../communitytools/sphenecoll/sphene/sphboard/signals.py
            ...
            if isinstance(instance, Post):
                try:
                    ...
                    if instance.thread is None:
                        ...
                        thr = instance.thread
                    if thr and (original.thread != instance.thread or original.is_hidden != instance.is_hidden or original.category != instance.category):
...
def mark_thread_moved_deleted(sender, instance, *args, **kwargs):
    ...
    if instance.pk:
        ...
        try:
            old_post = Post.objects.get(pk=instance.pk)
            if old_post.thread is None and (old_post.category_id != instance.category_id or old_post.is_hidden != instance.is_hidden):
...
def update_category_last_visit_cache(sender, instance, *args, **kwargs):
    ...
    cache.set(instance.category._cache_key_lastvisit_date(instance.user), last_visit_date)