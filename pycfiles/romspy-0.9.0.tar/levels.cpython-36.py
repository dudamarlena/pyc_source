...
# [GCC 8.4.0]
# Embedded file name: /home/nicomuen/PycharmProjects/roms_tools/romspy/interpolation/vertical/levels.py
# Compiled at: 2019-09-04 06:51:53
...
def z_levels(h: np.ndarray, sc: np.ndarray, cs: np.ndarray, hc: int, zeta: np.ndarray=None, sigma_type=3, verbose=False) -> np.ndarray:
    """
...
def get_z_levels(h: np.ndarray, sc: np.ndarray, cs: np.ndarray, hc: int, zeta: np.ndarray=None, sigma_type=3, verbose=False) -> dict:
    """
    Compute the depth of each point in a 3D grid
    :param h: 2D array of seafloor height at each point
    :param sc: s-coord level locations
