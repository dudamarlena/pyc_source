...
# [GCC 8.4.0]
# Embedded file name: /home/nicomuen/PycharmProjects/roms_tools/romspy/interpolation/shift_grid.py
# Compiled at: 2019-09-04 06:14:07
    ...
    with netCDF4.Dataset(in_file, mode='r') as (_in):
        with netCDF4.Dataset(temp_out_path, mode='w') as (_out):
            ...
            for u, v in variables:
                ...
                new_u = _out.createVariable(u, 'f', tuple(u_dims))
                new_v = _out.createVariable(v, 'f', tuple(v_dims))
