...
# [GCC 8.4.0]
# Embedded file name: /home/nicomuen/PycharmProjects/roms_tools/romspy/verification.py
# Compiled at: 2019-09-03 09:33:09
...
def test_cdo(my_cdo):
    ...
    def cdo_handler(signum, frame):
        raise IOError("CDO likely does not exist! Either that or it is running far too slowly for use. Try 'module load cdo' or switching to a different computer. Make sure CDO is installed!")
