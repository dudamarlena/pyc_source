...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\henrio\queue.py
# Compiled at: 2017-12-13 20:38:32
...
__all__ = [
 'Queue', 'HeapQueue', 'QueueWouldBlock']
...
class Queue:
    ...
    def __repr__(self):
        return '{3}({0}, lifo={1}, size={2})'.format(repr(self._queue)[6:-1], self._lifo, self.size, self.__class__.__name__)
