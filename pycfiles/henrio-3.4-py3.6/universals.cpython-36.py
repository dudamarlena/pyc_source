...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\henrio\universals.py
# Compiled at: 2017-12-19 23:23:12
...
import errno
__all__ = [
 'Future', 'Task', 'Conditional', 'Queue', 'HeapQueue', 'sleepinf', 'sleep', 'timeout', 'AsyncFile',
