...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\henrio\futures.py
# Compiled at: 2017-12-18 21:45:19
...
class Task:
    ...
    def __repr__(self):
        fmt = '{0} {1} {2} {3}'.format(self._result if self._data is not self else 'self', self._error, self._data if self._data is not self else 'self', self._task.__class__.__name__)
        if self.cancelled:
