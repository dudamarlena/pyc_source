...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\henrio\__init__.py
...
from .yields import sleep, get_loop, unwrap_file, create_reader, create_writer, remove_reader, remove_writer, spawn, wrap_file, wrap_socket, current_task, sleepinf, unwrap_socket, postpone, spawn_after, wait_readable, wait_writable, call_after, schedule_after, TaskGroup
from .selector import SelectorLoop
from .io import async_connect, threaded_bind, threaded_connect, getaddrinfo, create_socketpair, AsyncSocket, open_connection, aopen, AsyncFile, ssl_do_handshake, ssl_wrap_socket
...
try:
    try:
        ...
        def _open_connection(host, port, timeout=None, *, ssl=False, source_addr=None, server_hostname=None, alpn_protocols=None):
            return open_connection((host, port), timeout=timeout,
              ssl=ssl,
