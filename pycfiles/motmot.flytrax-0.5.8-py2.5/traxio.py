...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/motmot/flytrax/traxio.py
# Compiled at: 2009-05-14 18:43:46
import motmot.FlyMovieFormat.FlyMovieFormat as FlyMovieFormat, numpy as np
from numpy import nan
import sys, struct, unittest, os, tempfile, shutil, warnings
header_fmt = 'iii'
chunk_fmt_v1 = 'dddddd'
...
class TraxDataWriter:
    ...
    def __init__(self, fname_prefix, bgimage, version=2, save_fmf=True):
        ...
        self.data_fd.write(struct.pack(header_fmt, self.version, bgimage.shape[0], bgimage.shape[1]))
    ...
    def write_data(self, roi_img=None, posx=nan, posy=nan, orientation=None, windowx=nan, windowy=nan, timestamp=nan, area=nan, slope=None):
        if self.save_fmf:
