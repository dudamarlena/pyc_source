...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/snipsskillscore/server.py
# Compiled at: 2017-10-30 12:17:17
""" Snips core server. """
import json, time
...
class Server:
    ...
    def __init__(self, mqtt_hostname, mqtt_port, tts_service_id, locale, registry, handle_intent, logger=None):
        """ Initialisation.
        ...
        if tts_service_id == 'google':
            ...
            self.tts_service = SnipsTTS(self.thread_handler, mqtt_hostname, mqtt_port, 'hermes/tts/say', locale, logger=self.logger)
