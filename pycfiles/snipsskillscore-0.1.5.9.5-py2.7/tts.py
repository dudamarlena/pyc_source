...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/snipsskillscore/tts.py
# Compiled at: 2017-10-06 07:48:54
...
class SnipsTTS:
    ...
    def speak(self, sentence):
        ...
        if self.mqtt_client is None:
            ...
            self.mqtt_client.publish(self.mqtt_topic, payload=json.dumps({'text': sentence}), qos=0, retain=False)
            return
