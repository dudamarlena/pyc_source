...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/snipsskillscore/intent_parser.py
# Compiled at: 2017-09-14 11:11:34
...
class IntentParser:
    ...
    def get_slot_value(payload, slot_name):
        ...
        if 'slots' not in payload:
            ...
            return IntentParser.get_dict_value(slot, ['value', 'value', 'value']) or IntentParser.get_dict_value(slot, ['value', 'value'])
    ...
    def parse_instant_time(slot):
        ...
        if not date:
            ...
            if not date:
                return None
            grain = InstantTime.parse_grain(IntentParser.get_dict_value(slot, [
             'value', 'grain']))
    ...
    def parse_time_interval(slot):
        ...
        """
        start = IntentParser.get_dict_value(slot, ['value', 'from'])
