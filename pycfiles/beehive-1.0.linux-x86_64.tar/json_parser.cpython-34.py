...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.4/site-packages/beehive/json_parser.py
# Compiled at: 2014-10-30 08:03:31
# Size of source mod 2**32: 9023 bytes
"""
Read beehive's JSON output files and store retrieved information in
:mod:`beehive.model` elements.

Utility to retrieve runtime information from beehive's JSON output.
...
def parse(json_filename, encoding='UTF-8'):
    """
    Reads beehive JSON output file back in and stores information in
    beehive model elements.
