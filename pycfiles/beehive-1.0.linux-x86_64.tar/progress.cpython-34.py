...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.4/site-packages/beehive/formatter/progress.py
...
class StepProgressFormatter(ProgressFormatterBase):
    ...
    def report_step_progress(self, result):
        ...
        if result.status == 'failed':
            if result.exception:
                if not isinstance(result.exception, AssertionError):
