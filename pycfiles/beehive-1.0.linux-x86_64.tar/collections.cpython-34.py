...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.4/site-packages/beehive/compat/collections.py
# Compiled at: 2014-10-30 09:03:06
# Size of source mod 2**32: 7480 bytes
"""
...
try:
    ...
    class Counter(dict):
        __doc__ = "Dict subclass for counting hashable objects.  Sometimes called a bag\n        or multiset.  Elements are stored as dictionary keys and their counts\n        are stored as dictionary values.\n\n        >>> Counter('zyzygy')\n        Counter({'y': 3, 'z': 2, 'g': 1})\n\n        "
