...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.4/site-packages/beehive/formatter/pretty.py
# Compiled at: 2014-11-03 05:47:13
# Size of source mod 2**32: 12319 bytes
...
def get_terminal_size():
    ...
    try:
        ...
        return (
         w or DEFAULT_WIDTH, h or DEFAULT_HEIGHT)
    except:
        return (
         DEFAULT_WIDTH, DEFAULT_HEIGHT)
...
class PrettyFormatter(Formatter):
    ...
    def match(self, match):
        self._match = match
        self.print_statement()
        self.print_step('executing', self._match.arguments, self._match.location, self.monochrome)
        self.stream.flush()
