...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/emencia/django/links/tests.py
# Compiled at: 2010-01-14 11:31:51
...
class LinksTest(TestCase):
    ...
    def test_create_link(self):
        ...
        data = {'title': 'My link', 'language': 'en', 
    ...
    def test_published(self):
        ...
        link5.site = Site.objects.create(domain='new.domain', name='new name')
        link5.save()
    ...
    def test_get_latest_links_tag(self):
        ...
        """
        datas = (
         {'title': 'My link', 'language': 'en', 
            'site': Site.objects.get_current(), 
            'url': 'http://www.emencia.fr'},
         {'title': 'My link 2', 'language': 'en', 
            'site': Site.objects.get_current(), 
            'url': 'http://www.emencia.fr'},
         {'title': 'Mon lien', 'language': 'fr', 
            'site': Site.objects.get_current(), 
            'url': 'http://www.emencia.fr'},
         {'title': 'My link 3', 'language': 'en', 
            'site': Site.objects.get_current(), 
            'url': 'http://www.emencia.fr'})
        for data in datas:
            link = Link.objects.create(**data)
