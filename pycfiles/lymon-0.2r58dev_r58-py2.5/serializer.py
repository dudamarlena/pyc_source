...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/lymon/core/serializer.py
# Compiled at: 2008-06-29 14:04:26
__all__ = [
 'Serialize']
serializer_defaults = dict(instantation_sintax="${%s['%s'](%s)}", widget_params={'displays_on': 'genshi'}, engine_name='genshi', force_id=True)
