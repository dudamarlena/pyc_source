...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/paddle/data.py
# Compiled at: 2010-12-21 06:34:17
import os, glob, gzip, cPickle, scipy as sp
...
def draw_sample(path, W, N):
    ...
    print 'Total size about %d MB' % (bytesize / 1048576)
...
def draw_patches(traindir, W, N):
    patchesfn = 'BSD_patches_%dx%d_%dk.npz' % (W, W, N / 1000.0)
