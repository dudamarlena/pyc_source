...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/silme/io/jar.py
...
class JarClient(FileFormatClient):
 ...
 'CVS', '.svn', '.DS_Store', '.hg']):
    ...
    def write_structure(cls, object, path, encoding=None):
        ...
        cls.write_source(string, path, object.id, format_parser.encoding)
        return True
