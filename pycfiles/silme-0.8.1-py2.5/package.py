...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/silme/diff/package.py
...
class PackageDiff(object):
    ...
    def get(self, path):
        ...
        if len(elems) == 1:
            ...
            elif elems[0] in self._structures:
                elem = self._structures[elems[0]]['struct']
            return elem
        elif elems[0] in self._packages:
