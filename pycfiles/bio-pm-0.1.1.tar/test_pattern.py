...
# [GCC 8.4.0]
# Embedded file name: /Users/ekeyme/git/bio-pm/tests/test_pattern.py
# Compiled at: 2017-08-19 21:13:23
...
class RoutineTestForFuncs(unittest.TestCase):
    ...
    def test_parse_with_translate_is_True(self):
        ...
        ex_nt_dict = {2: ('T', 'C'), 4: ('A', 'C'), 15: ('G', 'A'), 18: ('G', 'C'), 
           19: ('T', '-'), 21: ('C', '-'), 22: ('C', 'A'), 
           24: ('T', 'A')}
        ex_aa_dict = {1: ('M', 'T'), 2: ('T', 'P'), 5: ('L', 'L'), 6: ('*', 'Y'), 
           7: ('Y', '-'), 8: ('R', 'R')}
