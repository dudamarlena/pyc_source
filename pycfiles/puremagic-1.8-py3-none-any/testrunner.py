...
# Embedded file name: /home/alex/envs/purelyjs/lib/python2.7/site-packages/purelyjs/testrunner.py
# Compiled at: 2014-05-22 14:55:25
import logging, os, re, shutil, tempfile, time
logging.basicConfig()
...
class TestRunner(object):
    ...
    def __init__(self, libs=None, tests=None, interpreters=None, test_name_filter=None, collect_only=False, keep_modules=False, verbose=False):
    ...
    def apply_name_filter(self, test_cases):
        if self.test_name_filter:
            test_cases = [ case for case in test_cases if re.search(self.test_name_filter, case) ]
        return test_cases
    ...
    def run_tests(self, testdir):
        ...
        for i, test_case in enumerate(test_cases, 1):
            module = TestModule(testdir, self.interpreter, self.libs + self.tests, test_case, keep_module=self.keep_modules)
