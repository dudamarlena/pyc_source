...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bunny1/b1_example.py
# Compiled at: 2009-02-23 22:26:11
__author__ = 'ccheever'
__doc__ = '\nAn example bunny1 server with some common commands that you might want to use.\n'
__version__ = '1.1'
import urlparse, subprocess, bunny1
...
class ExampleCommands(bunny1.Bunny1Commands):
    ...
    def _help_html(self, examples=None, name='bunny1'):
        ...
        if not examples:
            examples = [
             'g phpsh', 'fbpbz 1737', 'wikinvest 2008 Financial Crisis', 'popular', 'ya what is the meaning of life?', 'list Facebook', 'fbs john', 'php array_merge', 'wp FBML', 'fb mark zuckerberg', 'gmaps 285 Hamilton Ave, Palo Alto, CA 94301', 'gimg bisu', 'rickroll', "yt i'm cool sushi654 yeah", 'y osteria palo alto', 'live james harrison']
