...
# Embedded file name: build/bdist.macosx-10.6-universal/egg/cabig/cacore/generate/cacore2python.py
...
def generate(services, settings, baseDir):
    ...
    for nsdef in nsdefs:
        ...
        dict = {'serviceName': serviceName, 'prefix': settings.ROOT_PACKAGE, 
           'ns': ns, 
    ...
    dict = {'ZSI_serviceName': serviceName, 'ZSI_portName': portName, 
