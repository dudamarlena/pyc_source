...
class KVTest(unittest.TestCase):
    ...
    async def test_put_get(self):
        ...
        self.assertEqual(value_list[0][1], '8')
        self.assertEqual(value_list[1][1], '9')
        ...
        self.assertEqual(value_list[0][0], '/test8')
        self.assertEqual(value_list[0][1], '8')
    ...
    async def test_transaction(self):
        ...
        is_success, response = await self.client.txn(compare=[
         transaction.Value('/trans1') == 'trans1',
         transaction.Value('/trans2') == 'trans2'],
          success=[
         KV.get.txn('/trans1'),
         KV.range.txn('/trans2')],
          fail=[
        ...
        self.assertEqual(response[0][0], 'trans1')
        self.assertEqual(response[1][0][:2], ('/trans2', 'trans2'))
        is_success, response = await self.client.txn(compare=[
         transaction.Value('/trans1') == 'trans1',
         transaction.Value('/trans2') == 'trans2'],
          success=[
        ...
        self.assertEqual(put_response[0], 'trans2')
        put_response = response[2]
        self.assertIsNone(put_response[0])
        is_success, response = await self.client.txn(compare=[
         transaction.Value('/trans3') != 'trans3',
        ...
        self.assertEqual(response[0][0][:2], ('/trans3', 'trans3'))
