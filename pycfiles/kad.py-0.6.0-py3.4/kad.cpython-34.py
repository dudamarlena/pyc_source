...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kad/kad.py
# Compiled at: 2017-12-29 11:36:17
# Size of source mod 2**32: 7026 bytes
import json, random, socket, socketserver, threading, time
            ...
            if message_type == 'ping':
                ...
                if message_type == 'pong':
                    ...
                    if message_type == 'find_node':
                        ...
                        if message_type == 'find_value':
                            self.handle_find(message, find_value=True)
                        else:
                            if message_type == 'found_nodes':
                                self.handle_found_nodes(message)
                            else:
                                if message_type == 'found_value':
