...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\pyabsorb\__init__.py
# Compiled at: 2019-10-25 11:36:15
# Size of source mod 2**32: 13266 bytes
...
class Database:
    ...
    def gimme(self, atom, z, elims):
        ...
        self.bren = [i for i in self.lines[inifin[0]:inifin[1]] if i.startswith('#') == False]
...
def console():
    ...
    parser.add_argument('-e', type=float, help='X-ray energy in eV. Single value or <start> <step> <end>.',
      nargs='+')
