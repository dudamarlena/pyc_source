...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\sewergraph\tests\accumulation_test.py
# Compiled at: 2019-07-31 15:07:19
...
def test_relative_outfall_contribution():
    ...
    H = sg.accumulate_downstream(H, accum_attr='local_area', cumu_attr_name='cumulative_area')
