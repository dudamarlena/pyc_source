...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/buttersink/ioctl.py
# Compiled at: 2018-05-28 12:06:50
__doc__ = ' Utilities for working with fnctl.ioctl. '
import array, collections, fcntl, itertools, logging, os, struct
...
class Structure:
    ...
    defaults = dict(itertools.chain(*[ [ (fmtChar, defaultValue) for fmtChar in s ] for s, defaultValue in [
     ('sp', ''),
     ('bBhHiIlLqQfdP', 0),
     (
      '?', False),
