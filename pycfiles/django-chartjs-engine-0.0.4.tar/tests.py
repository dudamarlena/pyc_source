...
# [GCC 8.4.0]
# Embedded file name: /Users/Jeff/Development/python/chartjs_engine/chartjs_engine/tests.py
# Compiled at: 2016-12-29 18:33:15
...
class ChartTests(TestCase):
    ...
    def setUp(self):
        ...
        self.chart = Chart(chart_type='line', chart_name='this', options={'options': 'options'}, chart_labels=[
         'the', 'labels'], datasets={'data': (1, 2), 'data2': (3, 4)})
...
class LineChartTests(TestCase):
    ...
    def setUp(self):
        ...
        self.chart = LineChart(chart_type='line', chart_name='the_chart', chart_labels=[
         'the', 'labels'], datasets={'data': (1, 2), 'data2': (3, 4)})
...
class BarChartTests(TestCase):
    ...
    def setUp(self):
        ...
        self.chart = BarChart(chart_type=self.chart_type, chart_name=self.chart_name, chart_labels=self.chart_labels, datasets=self.datasets)
        self.single_dataset_chart = BarChart(chart_type=self.chart_type, chart_name=self.chart_name, chart_labels=self.chart_labels, datasets=self.datasets2)
...
class PieDoughnutChartTests(TestCase):
    ...
    def setUp(self):
        ...
        self.chart = PieDoughnutChart(chart_type='pie', chart_name='the_chart', chart_labels=[
         'the', 'labels'], datasets={'data': (1, 2), 'data2': (3, 4)})
        self.doughnut_chart = PieDoughnutChart(chart_type='doughnut', chart_name='the_chart', chart_labels=[
         'the', 'labels'], datasets={'data': (1, 2)})
        self.single_dataset_chart = PieDoughnutChart(chart_type='pie', chart_name='the_chart', chart_labels=[
         'the', 'labels'], datasets={'data': (1, 2)})
...
class ChartEngineTests(TestCase):
    ...
    def setUp(self):
        ...
        self.chart_setup = {'chart_name': 'testchart', 
           'chart_type': 'line', 
           'chart_labels': [
                          'the', 'labels'], 
           'options': 'options', 
