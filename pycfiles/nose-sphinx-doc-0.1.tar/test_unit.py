...
# [GCC 8.4.0]
# Embedded file name: /home/fiedzia/soft/NoseSphinxDoc/tests/test_unit.py
# Compiled at: 2011-10-14 00:40:57
import copy, unittest, errno, nose
...
def test_sphinx_doc_plugin__test_to_dict():
    ...
    """
    plugin = SphinxDocPlugin()
    test_info = {'module': 'sample', 
       'name': 'test_sample', 
       'test': None, 
       'type': 'FunctionTestCase'}
    expected_info = copy.deepcopy(test_info)
    expected_dict = {'sample': {'__tests__': [
                              expected_info]}}
    test_dict = {}
...
def test_sphinx_doc_plugin__process_tests__empty_list(extractTestInfo, testToDict):
    """
...
@patch('nose_sphinx_doc.SphinxDocPlugin.testToDict')
@patch('nose_sphinx_doc.SphinxDocPlugin.extractTestInfo')
def test_sphinx_doc_plugin__process_tests__single_test(extractTestInfo, testToDict):
    """
...
@patch('nose_sphinx_doc.SphinxDocPlugin.testToDict')
@patch('nose_sphinx_doc.SphinxDocPlugin.extractTestInfo')
def test_sphinx_doc_plugin__process_tests__several_tests(extractTestInfo, testToDict):
    """
