...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/marketplacecli/commands/vendorcmds/vendorcmds.py
...
class VendorCmds(Cmd, CoreGlobal):
    ...
    def arg_list(self):
        do_parser = ArgumentParser(prog=self.cmd_name + ' list', add_help=True, description='List the vendors that are part of the Marketplace. Also indicates whether the vendors are active or not.')
