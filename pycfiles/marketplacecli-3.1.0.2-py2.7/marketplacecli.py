...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/marketplacecli/marketplacecli.py
...
import getpass, base64, sys, argparse, httplib2
...
class Mycli(Cmd):
    ...
    def arg_batch(self):
        do_parser = ArgumentParser('batch', add_help=True, description='Execute marketplacecli batch command from a file (for scripting)')
...
mainParser.add_argument('-v', action='version', help='displays the current version of the marketplacecli tool', version="%(prog)s version '" + constants.VERSION + "'")
