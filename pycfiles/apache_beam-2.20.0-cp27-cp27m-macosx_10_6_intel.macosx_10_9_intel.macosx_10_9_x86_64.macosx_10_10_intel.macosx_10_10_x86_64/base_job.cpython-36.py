...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/jobs/base_job.py
...
class BaseJob(Base, LoggingMixin):
    ...
    __mapper_args__ = {'polymorphic_on':job_type, 
    ...
    def __init__(self, executor=executors.get_default_executor(), heartrate=None, *args, **kwargs):
    ...
    def is_alive(self, grace_multiplier=2.1):
        ...
        :rtype: boolean
        """
        return (timezone.utcnow() - self.latest_heartbeat).seconds < conf.getint('scheduler', 'JOB_HEARTBEAT_SEC') * 2.1
