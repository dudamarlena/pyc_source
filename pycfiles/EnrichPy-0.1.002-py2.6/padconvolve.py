...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/enrichpy/padconvolve.py
...
def pad(x, klength, origin=0, value=0.0):
...
def padded_convolve(x, kernel, origin=0, value=0.0):
    ...
    """
    return numpy.convolve(pad(x, len(kernel), origin, value), kernel, mode='valid')