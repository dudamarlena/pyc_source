...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/c2/search/customdescription/browser/customview.py
# Compiled at: 2010-02-24 03:02:34
...
def _cut_text(text, target, length, position):
    ...
    t_withclass = _ins_hightlight_class(t, target, position - pre_len)
    return (
     t_withclass, is_pre_cut, is_suf_cut)
...
class Plone(BrowserView):
    ...
    def cropText(self, text, target, length, ellipsis='...'):
