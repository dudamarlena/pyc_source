...
# [GCC 8.4.0]
# Embedded file name: /home/powellc/devel/cfm/beehve/beehve/apps/workers/migrations/0001_initial.py
# Compiled at: 2016-08-07 14:40:15
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Position', fields=[
      (
      ...
      (
       'brigade', models.ForeignKey(to='homepage.Brigade'))], options={'abstract': False}, bases=(
      models.Model,)),
     migrations.CreateModel(name='Worker', fields=[
      ...
      (
       'user', models.ForeignKey(to=settings.AUTH_USER_MODEL))], options={'ordering': ('-modified', '-created'), 
      'abstract': False, 
