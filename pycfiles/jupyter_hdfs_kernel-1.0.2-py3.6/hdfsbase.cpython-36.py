...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/hdfs_kernel/kernels/wrapperkernel/hdfsbase.py
...
class HdfsKernelBase(Kernel):
    ...
    def __init__(self, implementation, implementation_version, language, language_version, language_info, **kwargs):
    ...
    def do_execute(self, code, silent, store_history=True, user_expressions=None, allow_stdin=False):
        try:
            ...
            assert isinstance(result, CommandResult), 'Wrong type of command execute result, should be isinstance of  CommandResult '
    ...
    def send_info(self, contents):
        self.send_response(self.iopub_socket, 'stream', {'name':'stdout', 
         'text':str(contents)})
    ...
    def send_result(self, result):
        ...
        self.send_response(self.iopub_socket, 'execute_result', {'execution_count':self.execution_count, 
         'data':{'text/html': response}, 
