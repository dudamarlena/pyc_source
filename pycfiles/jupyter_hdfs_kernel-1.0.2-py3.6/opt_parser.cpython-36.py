...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/hdfs_kernel/parsers/opt_parser.py
...
class OptionParserProxy(object):
    ...
    def __init__(self, sub_command, options_list):
        ...
        assert sub_command in self.mapper.keys(), '%s option parser not found' % sub_command
