...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/httphmac/request.py
# Compiled at: 2016-04-12 22:27:37
try:
...
import sys, base64, collections, hashlib, requests, json, time
