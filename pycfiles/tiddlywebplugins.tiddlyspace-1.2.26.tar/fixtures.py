...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlyspace/test/fixtures.py
# Compiled at: 2013-08-20 13:22:51
import os, sys, shutil, httplib2, Cookie
...
def get_auth(username, password):
    http = httplib2.Http()
    response, _ = http.request('http://0.0.0.0:8080/challenge/tiddlywebplugins.tiddlyspace.cookie_form', body='user=%s&password=%s' % (username, password), method='POST', headers={'Content-Type': 'application/x-www-form-urlencoded'})
...
def make_test_env(module, hsearch=False):
    ...
    if SESSION_COUNT > 1:
        ...
        import tiddlywebplugins.tiddlyspace.store, tiddlywebplugins.mysql3, tiddlywebplugins.sqlalchemy3
