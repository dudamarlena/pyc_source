...
# [GCC 8.4.0]
# Embedded file name: /Users/mghantous/workspace/AgainFaster/country_block/migrations/0005_auto__add_errorlog_and_settings.py
# Compiled at: 2014-06-05 14:39:38
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('country_block_settings', 'free_geo_ip_error_window', self.gf('django.db.models.fields.FloatField')(default=3600.0), keep_default=False)
        db.add_column('country_block_settings', 'free_geo_ip_error_threshold', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)
        db.add_column('country_block_settings', 'free_geo_ip_error_sleep', self.gf('django.db.models.fields.FloatField')(default=3600.0), keep_default=False)
    ...
    models = {'country_block.country': {'Meta': {'object_name': 'Country'}, 'country_code': (
       ...
       'country_block.errorlog': {'Meta': {'object_name': 'ErrorLog'}, 'created': (
       ...
       'country_block.settings': {'Meta': {'object_name': 'Settings'}, 'allowed_countries': (
                                  ...
                                  'free_geo_ip_error_sleep': (
                                                            'django.db.models.fields.FloatField', [], {'default': '3600.0'}), 
                                  'free_geo_ip_error_threshold': (
                                                                'django.db.models.fields.IntegerField', [], {'default': '10'}), 
                                  'free_geo_ip_error_window': (
                                                             'django.db.models.fields.FloatField', [], {'default': '3600.0'}), 
                                  'free_geo_ip_timeout': (
                                  ...
                                  'maxmind_timeout': (
                                                    'django.db.models.fields.FloatField', [], {'default': '6.0'}), 
                                  'staff_user_country': (
