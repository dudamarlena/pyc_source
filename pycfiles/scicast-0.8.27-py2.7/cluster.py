...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/scicast/cluster.py
# Compiled at: 2017-01-19 15:15:02
from __future__ import absolute_import, division, print_function
import matplotlib
matplotlib.use('TkAgg')
import numpy as np, pandas as pd, os, sys, collections, datetime
...
def main():
    ...
    if ',' not in args.kmeans_cluster_range and '-' not in args.kmeans_cluster_range and args.kmeans_cluster_range == '0':
        ...
        kmeans_range = [
         int(args.kmeans_cluster_range), int(args.kmeans_cluster_range)]
