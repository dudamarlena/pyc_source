...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/scicast/stability_test.py
# Compiled at: 2017-01-19 15:15:02
import os, seaborn as sns, matplotlib
matplotlib.use('TkAgg')
import matplotlib.pyplot as plt, difflib
