...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/hep_spt/math_aux.py
# Compiled at: 2019-11-15 13:29:51
"""
...
def gcd(a, b, *args):
    ...
    :raises TyperError: If the arrays do not contain integers or if     the shapes do not coincide.
    """
    if len(args) == 0:
...
def ibinary_repr(arg):
    ...
    .. warning::
       Note that the binary representation of any number turn very large. For        example, for a number like 10000, the binary representation is        10011100010000. No error/warning will be raised if the maximum value        for a :class:`numpy.int64` is reached.
    """
...
def next_power_2(arg):
    ...
    .. note: If the input number is a power of two, it will return the     same number.
    """
