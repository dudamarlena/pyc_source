...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gfa_logging/core.py
# Compiled at: 2018-10-26 03:36:59
...
class MsgLogger:
    ...
    def __init__(self, name='msg_logger', debug_mode=False, logging_to_console=False, log_path='logs', file_name='msg_log', max_bytes=262144, backup_count=30, when='D', interval=1, header='', date_formatter=False):
        self.name = name
    ...
    def setup(self):
        if self.logging_to_console:
            ...
            self.msg_handler = CustomTimeRotatingFileHandler((self.file_path), header=(self.header), when=(self.when), interval=(self.interval))
...
if __name__ == '__main__':
    ...
    data_logger = MsgLogger(name='data_logger', file_name='data', log_path='data', when='H', header='sensorID,value,timestamp')
