...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/subicpos/controllers/returns.py
...
class ReturnsController(TransactionController):
    ...
    def render_edit(self):
        return render('/returns/edit.mako')
