...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/commerce/old/basket.py
# Compiled at: 2009-03-17 14:39:37
"""
        ...
        for rule in self.rules:
            try:
                ...
                if rule.func_code.co_argcount != 1:
                    raise
                import warnings
                warnings.warn('[0.12.1] Basket rules now take two args. Please update %s.' % rule, DeprecationWarning)
                items = rule(items)
