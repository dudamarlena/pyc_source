...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/autoself/__init__.py
# Compiled at: 2007-09-17 22:19:14
"""
...
import types, dis, os, sys, unittest
...
def _makeArg0(f, nm):
    ...
    c = types.CodeType(fc.co_argcount + 1, fc.co_nlocals + 1, fc.co_stacksize + 1, fc.co_flags, newCode, fc.co_consts, fc.co_names, newVars, fc.co_filename, fc.co_name, fc.co_firstlineno, fc.co_lnotab, fc.co_freevars, fc.co_cellvars)
    withArg0 = types.FunctionType(c, f.func_globals, f.func_name, f.func_defaults, f.func_closure)
    return withArg0


_name2local = {'STORE_NAME': 'STORE_FAST', 'DELETE_NAME': 'DELETE_FAST', 'STORE_GLOBAL': 'STORE_FAST', 'DELETE_GLOBAL': 'DELETE_FAST', 'LOAD_NAME': 'LOAD_FAST', 'LOAD_GLOBAL': 'LOAD_FAST', 'LOAD_DEREF': 'LOAD_FAST', 'STORE_DEREF': 'STORE_FAST'}
