...
# Embedded file name: /usr/local/lib/python2.7/site-packages/pycrunchbase/pycrunchbase.py
# Compiled at: 2017-02-09 03:05:49
import requests, six
from six.moves import urllib
from .resource import Acquisition, FundingRound, Fund, IPO, Organization, Page, Person, Product
...
class CrunchBase(object):
    ...
    def _build_url(self, base_url, params=None):
        ...
        params_string = ('&').join('%s=%s' % (k, urllib.parse.quote(v)) for k, v in six.iteritems(params or {}))
        if params_string:
