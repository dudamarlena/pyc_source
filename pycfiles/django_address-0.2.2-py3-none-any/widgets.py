...
# [GCC 8.4.0]
# Embedded file name: /Users/robertbanagale/code/opensource/django-address/django-address/example_site/address/widgets.py
# Compiled at: 2020-05-10 01:24:38
import sys
...
class AddressWidget(forms.TextInput):
    components = [
     ('country', 'country'), ('country_code', 'country_short'),
    ...
    def render(self, name, value, attrs=None, **kwargs):
        if value in (None, ''):
            ...
            if isinstance(value, dict):
                ...
                ad = value.as_dict()
            elems = [
             super(AddressWidget, self).render(name, escape(ad.get('formatted', '')), attrs, **kwargs)]
