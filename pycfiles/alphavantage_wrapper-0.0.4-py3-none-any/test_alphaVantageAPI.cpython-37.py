...
# Embedded file name: C:\Users\appli\Documents\GitHub\alphaVantageAPI Project\tests\test_alphaVantageAPI.py
# Compiled at: 2020-04-20 00:10:50
# Size of source mod 2**32: 17751 bytes
...
class TestAlphaVantageAPI(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.fx_parameters = {'function':'CURRENCY_EXCHANGE_RATE', 
