...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/webdb/interface/db_interface.py
# Compiled at: 2018-02-14 07:21:57
    ...
    try:
        if not isinstance(request['database'], str):
            ...
            if not isinstance(request['request']['parameters'], (list, dict)):
                ...
                return False
            if request['request']['operation'] not in ('INSERT', 'UPDATE', 'DELETE',
                                                       'SELECT'):
