...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DeepBrainSeg/radiomics/radiomics.py
# Compiled at: 2019-11-11 08:44:10
# Size of source mod 2**32: 5500 bytes
import os, numpy as np, pandas as pd, SimpleITK as sitk, six, radiomics
...
class ExtractRadiomicFeatures:
    ...
    def __init__(self, input_image, input_mask=None, save_path=None, seq='Flair', class_='ET', all_=True):
