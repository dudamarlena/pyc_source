...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DeepBrainSeg/tumor/models/modelTir2D.py
...
def FCDenseNet57(n_classes):
    return FCDenseNet(in_channels=3, down_blocks=(4, 4, 4, 4, 4), up_blocks=(4, 4,
                                                                             4, 4,
                                                                             4), bottleneck_layers=4, growth_rate=6, out_chans_first_conv=24, n_classes=n_classes)


def FCDenseNet67(n_classes):
    return FCDenseNet(in_channels=3, down_blocks=(5, 5, 5, 5, 5), up_blocks=(5, 5,
                                                                             5, 5,
...
def FCDenseNet103(n_classes):
    return FCDenseNet(in_channels=4, down_blocks=(4, 5, 7, 10, 12), up_blocks=(12,
                                                                               ...
                                                                               7,
                                                                               5,
                                                                               4), bottleneck_layers=15, growth_rate=16, out_chans_first_conv=48, n_classes=n_classes)


if __name__ == '__main__':
    net = FCDenseNet103(4)
    a = Variable(torch.rand(4, 3, 240, 240))
    b = net(a)
    print(b.size())