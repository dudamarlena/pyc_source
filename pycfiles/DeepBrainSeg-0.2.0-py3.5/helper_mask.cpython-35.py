...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DeepBrainSeg/helpers/helper_mask.py
...
parser.add_argument('--ants_path', type=str, default='antsbin/bin/', help='path where the ants is installed, typically antsbin/bin/')
parser.add_argument('--input_path', type=str, default='./data/Test', help='location of the data')
