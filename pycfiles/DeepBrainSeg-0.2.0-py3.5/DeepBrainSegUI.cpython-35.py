...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ui/DeepBrainSegUI.py
# Compiled at: 2019-11-11 08:44:12
# Size of source mod 2**32: 26215 bytes
import sys, nibabel as nib, PIL
...
import numpy as np, DeepBrainSegUI_support
from helpers import *
...
class DeepBrainSegUI:
    ...
    def __init__(self, top=None):
        ...
        self.Frame9.place(relx=0.007, rely=0.021, relheight=0.918, relwidth=0.985)
        self.Frame9.configure(relief='groove')
        self.Frame9.configure(borderwidth='2')
        self.Frame9.configure(relief='groove')
        self.Frame10 = tk.Frame(self.Frame9)
        self.Frame10.place(relx=0.008, rely=0.022, relheight=0.955, relwidth=0.321)
        self.Frame10.configure(relief='groove')
        self.Frame10.configure(borderwidth='2')
        self.Frame10.configure(relief='groove')
        self.AxialCanvas = tk.Canvas(self.Frame10)
        self.AxialCanvas.place(relx=0.024, rely=0.024, relheight=0.944, relwidth=0.873)
        ...
        self.Frame11.place(relx=0.34, rely=0.022, relheight=0.955, relwidth=0.321)
        self.Frame11.configure(relief='groove')
        self.Frame11.configure(borderwidth='2')
        self.Frame11.configure(relief='groove')
        self.SagitalCanvas = tk.Canvas(self.Frame11)
        self.SagitalCanvas.place(relx=0.024, rely=0.024, relheight=0.944, relwidth=0.873)
        ...
        self.Frame12.place(relx=0.672, rely=0.022, relheight=0.955, relwidth=0.321)
        self.Frame12.configure(relief='groove')
        self.Frame12.configure(borderwidth='2')
        self.Frame12.configure(relief='groove')
        self.CorronalCanvas = tk.Canvas(self.Frame12)
        self.CorronalCanvas.place(relx=0.024, rely=0.024, relheight=0.944, relwidth=0.873)
        ...
        self.LoadFrame.place(relx=0.007, rely=0.621, relheight=0.366, relwidth=0.985)
        self.LoadFrame.configure(relief='groove')
        self.LoadFrame.configure(borderwidth='2')
        self.LoadFrame.configure(relief='groove')
        self.Flair_Frame = tk.Frame(self.LoadFrame)
        self.Flair_Frame.place(relx=0.007, rely=0.034, relheight=0.932, relwidth=0.175)
        ...
        self.Flair_canvas.place(relx=0.043, rely=0.036, relheight=0.767, relwidth=0.898)
        ...
        self.T1Frame.place(relx=0.201, rely=0.034, relheight=0.932, relwidth=0.182)
        ...
        self.T1_canvas.place(relx=0.041, rely=0.036, relheight=0.767, relwidth=0.902)
        ...
        self.T1ceFrame.place(relx=0.401, rely=0.034, relheight=0.932, relwidth=0.19)
        ...
        self.T1ce_canvas.place(relx=0.039, rely=0.036, relheight=0.767, relwidth=0.906)
        ...
        self.T2Frame.place(relx=0.61, rely=0.034, relheight=0.932, relwidth=0.182)
        ...
        self.T2_canvas.place(relx=0.041, rely=0.036, relheight=0.767, relwidth=0.902)
        ...
        self.SegFrame.place(relx=0.81, rely=0.034, relheight=0.932, relwidth=0.175)
        ...
        self.seg_canvas.place(relx=0.043, rely=0.036, relheight=0.767, relwidth=0.898)
        ...
        self.LogoCanvas.place(relx=0.007, rely=0.011, relheight=0.117, relwidth=0.983)
        ...
        self.Button10.place(relx=0.803, rely=0.0, height=25, width=161)
    ...
    def init_scales(self, vol):
        ...
        self.Scale1.place(relx=0.871, rely=0.025, relwidth=0.0, relheight=0.942, width=46, bordermode='ignore')
        ...
        self.Scale2.place(relx=0.871, rely=0.025, relwidth=0.0, relheight=0.942, width=46, bordermode='ignore')
        ...
        self.Scale3.place(relx=0.871, rely=0.025, relwidth=0.0, relheight=0.942, width=46, bordermode='ignore')
        ...
        self.TProgressbar1.place(relx=0.007, rely=0.948, relwidth=0.981, relheight=0.0, height=19)
    ...
    def Get_Segmentation(self, event=None):
        ...
        self.prediction = get_brainsegmentation.get_segmentation(self.T1filename, self.T2filename, self.T1cefilename, self.Flairfilename)
