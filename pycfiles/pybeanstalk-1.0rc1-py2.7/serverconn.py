...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/beanstalk/serverconn.py
# Compiled at: 2015-07-11 09:52:37
import socket, select, protohandler, logging
_debug = False
...
class ServerConn(object):
    ...
    def __getattribute__(self, attr):
        ...
        def caller(*args, **kw):
            logger.info('Calling %s with: args(%s), kwargs(%s)', res.__name__, args, kw)
