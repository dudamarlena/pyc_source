...
# [GCC 8.4.0]
# Embedded file name: /Users/egoruni/Desktop/BA/Code/zas-rep-tools/zas_rep_tools/src/classes/exporter.py
# Compiled at: 2018-10-19 12:24:41
from __future__ import absolute_import
import os, sys, logging, csv, codecs
from lxml import etree as ET
import json, inspect, traceback, re, gc
...
class Exporter(BaseContent):
    ...
    def _get_new_file(self, path_to_dir, fname, file_extention, encoding='utf-8', file_flag='w', open_file_with_codecs=False):
        ...
        elif count_of_existing_files == 0:
    ...
    def _eval_input_data(self):
        import types
        check = (
         isinstance(self._inpdata, list), isinstance(self._inpdata, LenGen), isinstance(self._inpdata, types.GeneratorType))
