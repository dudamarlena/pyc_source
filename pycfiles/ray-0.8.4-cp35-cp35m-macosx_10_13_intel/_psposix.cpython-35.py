...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/nz/vv4_9tw56nv9k3tkvyszvwg80000gn/T/pip-unpacked-wheel-_x_fz5x6/psutil/_psposix.py
...
def wait_pid(pid, timeout=None, proc_name=None):
    ...
    def check_timeout(delay):
        if timeout is not None and timer() >= stop_at:
