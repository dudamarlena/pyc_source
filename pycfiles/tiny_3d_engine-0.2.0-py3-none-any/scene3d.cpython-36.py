...
# Compiled at: 2020-05-05 18:17:26
# Size of source mod 2**32: 14770 bytes
"""
...
"""
import os, numpy as np, warnings as warn
...
class Scene3D:
    ...
    def add_axes(self):
        ...
        start = [
         ...
         self.min[1] - shift[1],
         self.min[2] - shift[2]]
        title = 'axis.x_' + str_fmt.format(self.min[0]) + '_' + str_fmt.format(self.max[0])
        ax_x.add_line(start, end, 10)
        self.update(title,
          (ax_x.points), (ax_x.conn), color='#ff0000')
        ax_y = Part3D()
        start = [
         self.min[0] - shift[0],
         self.min[1],
         ...
         self.max[1],
         self.min[2] - shift[2]]
        title = 'axis.y_' + str_fmt.format(self.min[1]) + '_' + str_fmt.format(self.max[1])
        ax_y.add_line(start, end, 10)
        self.update(title,
          (ax_y.points), (ax_y.conn), color='#00ff00')
        start = [
         self.min[0] - shift[0],
         self.min[1] - shift[1],
         self.min[2]]
         ...
         self.min[1] - shift[1],
         self.max[2]]
        title = 'axis.z_' + str_fmt.format(self.min[2]) + '_|_' + str_fmt.format(self.max[2])
        ax_z = Part3D()
        ax_z.add_line(start, end, 10)
        self.update(title,
          (ax_z.points), (ax_z.conn), color='#0000ff')
