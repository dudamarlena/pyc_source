...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mcorr/fit.py
# Compiled at: 2018-03-18 13:36:33
...
class CorrRes(object):
    __doc__ = 'One correlation result'
...
def fit_model(xvalues, yvalues, d_sample):
    ...
    params1.add('theta_clonal', value=1e-05, min=0, max=d_sample)
...
def plot_fit(fitdata, fitres, plot_file):
    ...
    markerline, _, _ = ax2.stem(xvalues, (fitres.residual),
      linefmt='k-',
      basefmt='r-',
      markerfmt='ko')
    ax2.set_xlabel('$l$')
