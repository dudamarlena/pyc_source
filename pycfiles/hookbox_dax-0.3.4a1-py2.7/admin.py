...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/hookbox/admin/admin.py
# Compiled at: 2012-07-04 04:55:04
import os
from paste import urlmap, urlparser
import csp_eventlet as csp, rtjp_eventlet, eventlet, logging
from hookbox.errors import ExpectedException
import hookbox, cgi, datetime, eventlet
...
class AdminProtocol(object):
    ...
    def loop_overview(self, args):
        while True:
            self.send_frame('OVERVIEW', {'num_users': len(self.hookbox.users), 
    ...
    def loop_console_logs(self, args):
        ...
        self.send_frame('CONSOLE_OUTPUT', {'data': self._admin_app._highlight(self._admin_app.console_buffer)})
        try:
            while True:
                eventlet.sleep(100)
    ...
    def _run(self):
        while True:
            ...
            except rtjp_eventlet.errors.ConnectionLost as e:
                break
            except:
