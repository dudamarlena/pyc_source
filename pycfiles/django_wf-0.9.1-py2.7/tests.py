...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/django_workflow/tests.py
# Compiled at: 2017-08-29 10:49:52
import time
...
class WorkflowTest(TestCase):
    ...
    def setUp(self):
        ...
        t4 = Transition.objects.create(name='auto_slow', initial_state=s1, final_state=s3, automatic=True, automatic_delay=1.0 / 24.0, priority=1)
        ...
        f1 = Function.objects.create(function_name='object_attribute_value', function_module='django_workflow.conditions', condition=c1)
