...
# Embedded file name: build\bdist.win32\egg\Products\PloneBooking\BookingTool.py
...
class BookingTool(DateManager, UniqueObject, SimpleItem, ActionProviderBase):
    ...
    __implements__ = (
     ActionProviderBase.__implements__, SimpleItem.__implements__)
    ...
    def getWeekGroupKeys(self, start_date, end_date):
        ...
        new_start_dt = DateTime(start_date.year(), start_date.month(), start_date.day()) - (start_date.dow() - 1) % 7
