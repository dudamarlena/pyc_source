...
# [GCC 8.4.0]
# Embedded file name: pifx/core.py
# Compiled at: 2018-02-03 16:39:21
...
class PIFX:
    ...
    def list_lights(self, selector='all'):
        ...
        """
        return self.client.perform_request(method='get', endpoint='lights/{}', endpoint_args=[
         selector], parse_data=False)

    def set_state(self, selector='all', power=None, color=None, brightness=None, duration=None):
        ...
        argument_tuples = [
         ...
         (
          'duration', duration)]
        return self.client.perform_request(method='put', endpoint='lights/{}/state', endpoint_args=[
    ...
    def state_delta(self, selector='all', power=None, duration=1.0, infrared=None, hue=None, saturation=None, brightness=None, kelvin=None):
        u"""Given a state delta, apply the modifications to lights' state
        ...
        argument_tuples = [
         ...
         (
          'kelvin', kelvin)]
        return self.client.perform_request(method='post', endpoint='lights/{}/state/delta', endpoint_args=[
         selector], argument_tuples=argument_tuples)
    ...
    def toggle_power(self, selector='all', duration=1.0):
        ...
        argument_tuples = [
         (
          'duration', duration)]
        return self.client.perform_request(method='post', endpoint='lights/{}/toggle', endpoint_args=[
         selector], argument_tuples=argument_tuples)
    ...
    def breathe_lights(self, color, selector='all', from_color=None, period=1.0, cycles=1.0, persist=False, power_on=True, peak=0.5):
        ...
        argument_tuples = [
         ...
         (
          'peak', peak)]
        return self.client.perform_request(method='post', endpoint='lights/{}/effects/breathe', endpoint_args=[
         selector], argument_tuples=argument_tuples)

    def pulse_lights(self, color, selector='all', from_color=None, period=1.0, cycles=1.0, persist=False, power_on=True):
        ...
        argument_tuples = [
         ...
         (
          'power_on', power_on)]
        return self.client.perform_request(method='post', endpoint='lights/{}/effects/pulse', endpoint_args=[
         selector], argument_tuples=argument_tuples)

    def cycle_lights(self, states, defaults, direction='forward', selector='all'):
        ...
        argument_tuples = [
         ...
         (
          'direction', direction)]
        return self.client.perform_request(method='post', endpoint='lights/{}/cycle', endpoint_args=[selector], argument_tuples=argument_tuples, json_body=True)

    def list_scenes(self):
        """Return a list of scenes.
        See http://api.developer.lifx.com/docs/list-scenes
        """
        return self.client.perform_request(method='get', endpoint='scenes', parse_data=False)
    ...
    def activate_scene(self, scene_uuid, duration=1.0):
        ...
        argument_tuples = [
         (
          'duration', duration)]
        return self.client.perform_request(method='put', endpoint='scenes/scene_id:{}/activate', endpoint_args=[
         scene_uuid], argument_tuples=argument_tuples)