...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/gopage/crawler.py
# Compiled at: 2017-03-23 04:03:04
...
def download_page(url, useproxy=True, verbose=True, maxtry=2, timeout=5):
    ...
    try:
        ...
        header = {'user-agent': 'Mozilla/5.0 (Windows NT 6.1 WOW64 rv:23.0) Gecko/20130406 Firefox/23.0'}
        proxy = {'http': proxy_ip}
