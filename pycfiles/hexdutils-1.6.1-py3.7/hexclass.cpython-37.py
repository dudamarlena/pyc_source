...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hexdutils/hexclass.py
# Compiled at: 2019-09-13 18:58:49
# Size of source mod 2**32: 4503 bytes
from os import path
import sys
sys.path.insert(0, path.abspath(path.join(path.dirname(__file__), '.')))
from __hex_constants__ import __hex_letters, __alphabet
import intohex, hextoint, hexabc, hexops
...
class hexobj:
    ...
    def __init__(self, hex_initializer):
        if isinstance(hex_initializer, str):
            ...
            if isinstance(hex_initializer, int):
