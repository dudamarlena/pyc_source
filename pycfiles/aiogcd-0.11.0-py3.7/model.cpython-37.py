...
class _PropertyClass(dict):
    __doc__ = 'Custom dictionary for a GcdModel.'
...
class _ModelClass(type):
    __doc__ = 'Used as a meta class and uses the __preprare__ method to return a custom\n    class dictionary object.\n    '
...
class GcdModel(Entity, metaclass=_ModelClass):
    ...
    def set_property(self, prop, value):
        if prop in self.model_props:
            ...
            if not self.ALLOW_NEW_PROPERTIES:
