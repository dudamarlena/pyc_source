...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-discussions/odnoklassniki_discussions/migrations/0005_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        m2m_table_name = db.shorten_name('odnoklassniki_discussions_discussion_like_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'discussion', models.ForeignKey(orm['odnoklassniki_discussions.discussion'], null=False)),
         (
          'user', models.ForeignKey(orm['odnoklassniki_users.user'], null=False))))
        db.create_unique(m2m_table_name, ['discussion_id', 'user_id'])
        m2m_table_name = db.shorten_name('odnoklassniki_discussions_comment_like_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'comment', models.ForeignKey(orm['odnoklassniki_discussions.comment'], null=False)),
         (
          'user', models.ForeignKey(orm['odnoklassniki_users.user'], null=False))))
        db.create_unique(m2m_table_name, ['comment_id', 'user_id'])
        db.add_column('odnoklassniki_discussions_discussion_like_users', 'time_from', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
        db.add_column('odnoklassniki_discussions_discussion_like_users', 'time_to', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
        db.add_column('odnoklassniki_discussions_comment_like_users', 'time_from', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
        db.add_column('odnoklassniki_discussions_comment_like_users', 'time_to', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)

    def backwards(self, orm):
        db.delete_table(db.shorten_name('odnoklassniki_discussions_discussion_like_users'))
        db.delete_table(db.shorten_name('odnoklassniki_discussions_comment_like_users'))
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'odnoklassniki_discussions.comment': {'Meta': {'object_name': 'Comment'}, 'attrs': (
                                             ...
                                             'like_users': (
                                                          'm2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'like_comments'", 'symmetrical': 'False', 'to': "orm['odnoklassniki_users.User']"}), 
                                             'liked_it': (
       ...
       'odnoklassniki_discussions.discussion': {'Meta': {'object_name': 'Discussion'}, 'attrs': (
                                                ...
                                                'last_user_access_date': (
                                                                        'django.db.models.fields.DateTimeField', [], {'null': 'True'}), 
                                                'like_users': (
                                                             'm2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'like_discussions'", 'symmetrical': 'False', 'to': "orm['odnoklassniki_users.User']"}), 
                                                'liked_it': (
                                                           'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                                'likes_count': (
                                                              'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                                ...
                                                'title': (
                                                        'django.db.models.fields.TextField', [], {})}, 
       'odnoklassniki_users.user': {'Meta': {'object_name': 'User'}, 'allows_anonym_access': (
