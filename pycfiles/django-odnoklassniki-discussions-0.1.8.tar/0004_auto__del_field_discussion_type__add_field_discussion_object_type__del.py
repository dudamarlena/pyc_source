...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-discussions/odnoklassniki_discussions/migrations/0004_auto__del_field_discussion_type__add_field_discussion_object_type__del.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('odnoklassniki_discussions_discussion', 'type')
        db.add_column('odnoklassniki_discussions_discussion', 'object_type', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
        db.delete_column('odnoklassniki_discussions_comment', 'type')
        db.add_column('odnoklassniki_discussions_comment', 'object_type', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

    def backwards(self, orm):
        db.add_column('odnoklassniki_discussions_discussion', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
        db.delete_column('odnoklassniki_discussions_discussion', 'object_type')
        db.add_column('odnoklassniki_discussions_comment', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
        db.delete_column('odnoklassniki_discussions_comment', 'object_type')
