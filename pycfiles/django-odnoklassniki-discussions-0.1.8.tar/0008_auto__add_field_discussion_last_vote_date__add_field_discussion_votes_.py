...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-discussions/odnoklassniki_discussions/migrations/0008_auto__add_field_discussion_last_vote_date__add_field_discussion_votes_.py
# Compiled at: 2015-10-27 19:39:11
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('odnoklassniki_discussions_discussion', 'last_vote_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
        db.add_column('odnoklassniki_discussions_discussion', 'votes_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
        db.add_column('odnoklassniki_discussions_discussion', 'question', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

    def backwards(self, orm):
        db.delete_column('odnoklassniki_discussions_discussion', 'last_vote_date')
        db.delete_column('odnoklassniki_discussions_discussion', 'votes_count')
        db.delete_column('odnoklassniki_discussions_discussion', 'question')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'odnoklassniki_discussions.discussion': {'Meta': {'object_name': 'Discussion'}, 'attrs': (
                                                ...
                                                'new_comments_count': (
                                                                     'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                                'object_type': (
                                                              'django.db.models.fields.CharField', [], {'default': "'GROUP_TOPIC'", 'max_length': '20'}), 
                                                'owner_content_type': (
