...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-discussions/odnoklassniki_discussions/migrations/0003_auto__chg_field_discussion_new_comments_count__chg_field_discussion_co.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('odnoklassniki_discussions_discussion', 'new_comments_count', self.gf('django.db.models.fields.PositiveIntegerField')())
        db.alter_column('odnoklassniki_discussions_discussion', 'comments_count', self.gf('django.db.models.fields.PositiveIntegerField')())
        db.alter_column('odnoklassniki_discussions_discussion', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')())
        db.alter_column('odnoklassniki_discussions_comment', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        db.alter_column('odnoklassniki_discussions_discussion', 'new_comments_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        db.alter_column('odnoklassniki_discussions_discussion', 'comments_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        db.alter_column('odnoklassniki_discussions_discussion', 'likes_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        db.alter_column('odnoklassniki_discussions_comment', 'likes_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
