...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-discussions/odnoklassniki_discussions/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('odnoklassniki_discussions_discussion', (
         (
        ...
        db.send_create_signal('odnoklassniki_discussions', ['Discussion'])
        db.create_table('odnoklassniki_discussions_comment', (
         (
          'fetched', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
         (
         ...
         (
          'attrs', self.gf('annoying.fields.JSONField')(null=True))))
        db.send_create_signal('odnoklassniki_discussions', ['Comment'])

    def backwards(self, orm):
        db.delete_table('odnoklassniki_discussions_discussion')
        db.delete_table('odnoklassniki_discussions_comment')
