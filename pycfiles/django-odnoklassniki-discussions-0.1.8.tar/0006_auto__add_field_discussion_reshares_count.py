...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-discussions/odnoklassniki_discussions/migrations/0006_auto__add_field_discussion_reshares_count.py
# Compiled at: 2015-10-04 18:52:50
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('odnoklassniki_discussions_discussion', 'reshares_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        db.delete_column('odnoklassniki_discussions_discussion', 'reshares_count')
