...
# [GCC 8.4.0]
# Embedded file name: /Users/jerry_luan/codebase/private/simple_ml/simple_ml/logistic_regression/logistic_regression.py
# Compiled at: 2016-09-14 23:59:57
...
class LogisticRegression(object):
    ...
    def __init__(self, C=1.0, learning_rate=1.0, tol=0.0001, labels=[], verbose=False, print_every=100):
        self.C_ = C
...
if __name__ == '__main__':
    ...
    lr = LogisticRegression(C=50, learning_rate=0.5, verbose=True, labels=[
     0, 1])
    idx = range(len(X))
    import random
    for _ in xrange(100):
