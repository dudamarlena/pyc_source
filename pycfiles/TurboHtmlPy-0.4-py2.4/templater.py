...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/turbohtmlpy/templater.py
# Compiled at: 2006-02-18 04:17:17
import logging
...
class TurboHtmlPy:
    ...
    def transform(self, info, template, isLocation=True):
        ...
        if self.get_extra_vars:
            locals['xtra'] = Context('xtra', self.get_extra_vars())
            if hasattr(locals['xtra'], 'std'):
                locals['std'] = Context('std', locals['xtra'].std)
                locals['std'].std = locals['std']
