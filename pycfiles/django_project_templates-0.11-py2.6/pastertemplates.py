...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/django_project_templates/pastertemplates.py
# Compiled at: 2010-03-28 09:06:55
...
def append_secret_key(vars):
    ...
    vars.append(var('secret_key', 'Secret key', default=default_key))
...
class NewsAppsProjectTemplate(DjangoTemplate):
    ...
    vars = [
     var('staging_domain', 'Parent domain for your staging site.', default='beta.example.com'),
     var('production_domain', 'Parent domain for your production site.', default='example.com'),
     var('repository_url', 'Git repo where your project will be deployed from.', default='git@git.example.com:example/project_name.git')]
