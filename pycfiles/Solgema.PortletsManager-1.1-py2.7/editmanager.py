...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/Solgema/PortletsManager/portlets/editmanager.py
# Compiled at: 2016-06-03 03:09:48
import logging
...
class ManagePortletAssignments(newManagePortletAssignments):
    ...
    def spm_stop_portlet(self, name):
        ...
        assignments = aq_inner(self.context)
        portlet = IPortletAssignmentSettings(assignments[name])
        IPortletPermissionChecker(assignments)()
        if len(portlet.get('stopUrls', [])) > 0:
