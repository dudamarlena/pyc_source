...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/Solgema/PortletsManager/portlets/manager.py
# Compiled at: 2016-06-03 03:10:27
import sys, logging
    ...
    def getManagedPortlets(self):
        ...
        if pcontext is None:
            ...
            for category, key, assignment in categories:
                ...
                try:
                    assignments.append({'category': category, 'key': key, 
