...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\jobspider\spider.py
# Compiled at: 2016-04-18 20:51:49
"""
...
class Spider:
    spiders = {'byr': BYR_Spider('byr', 'X-Requested-With', 'Host', 'Referer'), 
