...
@override_settings(OIDC_OP_AUTHORIZATION_ENDPOINT='http://example/oidc/authorization', OIDC_OP_TOKEN_ENDPOINT='http://example/oidc/token', OIDC_OP_USER_ENDPOINT='http://example/oidc/user', OIDC_RP_CLIENT_ID='clientid', OIDC_RP_CLIENT_SECRET='client_secret')
