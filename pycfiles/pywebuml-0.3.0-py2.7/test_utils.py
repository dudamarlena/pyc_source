...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pywebuml\tests\parsers\test_utils.py
# Compiled at: 2011-04-02 14:18:44
"""
Some tests for `pywebuml.parsers.utils.`
"""
from unittest2 import TestCase
from pywebuml.models import Class, Enum
from pywebuml.parsers.utils import has_any_keyword, remove_comments, remove_keywords, get_visibility, get_type_and_name
...
class UtilsTest(TestCase):
    ...
    def test_enums_get_type_and_name(self):
        ...
        class_model = Enum('global.Foo.Days', 'Days', './foo.java', 'Java', owner_model)
