...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pywebuml\parsers\exceptions.py
# Compiled at: 2011-02-12 09:11:28
"""
...
class MissingClosingParenthesis(BadMethodDefinition):
    ...
    def __str__(self):
        return "Can't find closing ')'for method definition " + 'that started at line: %s' % self.line
