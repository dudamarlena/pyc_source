...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pywebuml\tests\parsers\test_base.py
# Compiled at: 2011-03-15 07:23:14
"""
...
class BaseParserTest(TestCase):
    ...
    def test_clear_content(self):
        ...
        expected = [
         ...
         '123ThirdLine',
         'LastLine']
        self.assertEquals(self.parser.clear_content(content), expected)
