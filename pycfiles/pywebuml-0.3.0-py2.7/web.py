...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pywebuml\web.py
# Compiled at: 2011-04-02 16:44:16
"""
...
def search():
    ...
    for i in range(0, number_of_levels):
        query = Class.query.options(db.joinedload(Class.attributes, Class.methods, Class.inner_classes, Class.base_classes, Class.implemented_interfaces))
        ...
        for klass in classes:
            ...
            for inner in klass.inner_classes:
                if inner.package not in searched_packages:
    ...
    final_dot_info = render_template('classes.dot', classes=res, class_packages=class_packages, should_show_methods=should_show_methods, should_show_attributes=should_show_attributes)
