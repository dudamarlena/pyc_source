...
# [GCC 8.4.0]
# Embedded file name: /Users/unno/.pyenv/versions/2.7.8/lib/python2.7/site-packages/rstserv/core.py
# Compiled at: 2014-11-01 23:03:59
import argparse, imp, os, socket, sys
...
def rst2html(file_path):
    ...
    overrides = {'stylesheet': os.path.join(path, 'default.css'), 
...
def parse_args():
    p = argparse.ArgumentParser(description='rst server')
    p.add_argument('-p', '--port', default=8080, type=int, help='port number')
