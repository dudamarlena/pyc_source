...
# [GCC 8.4.0]
# Embedded file name: /root/singa_auto/worker/inference.py
...
from singa_auto.model import load_model_class, BaseModel
from singa_auto.advisor import Proposal
