...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.4/dist-packages/pynhost/matching.py
# Compiled at: 2015-07-18 17:09:36
...
def get_rule_match(rule, words, filter_list=None):
    ...
    if regex_match is not None:
        ...
        remaining_words = utilities.reinsert_filtered_words(remaining_words, filtered_positions)
