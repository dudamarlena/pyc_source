...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/friends/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    depends_on = (('foundry', '0001_initial'), )

    def forwards(self, orm):
        db.create_table('friends_memberfriend', (
         (
        ...
        db.send_create_signal('friends', ['MemberFriend'])
        db.create_table('friends_directmessage', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
         ...
         (
          'reply_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='replies', null=True, to=orm['friends.DirectMessage'])),
         (
          'state', self.gf('django.db.models.fields.CharField')(default='sent', max_length=32, db_index=True)),
         (
          'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))))
        db.send_create_signal('friends', ['DirectMessage'])

    def backwards(self, orm):
        db.delete_table('friends_memberfriend')
        db.delete_table('friends_directmessage')
