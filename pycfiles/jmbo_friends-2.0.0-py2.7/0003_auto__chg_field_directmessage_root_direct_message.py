...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/friends/migrations/0003_auto__chg_field_directmessage_root_direct_message.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('friends_directmessage', 'root_direct_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friends.DirectMessage'], null=True))

    def backwards(self, orm):
        db.alter_column('friends_directmessage', 'root_direct_message_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['friends.DirectMessage']))
        return
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'friends.memberfriend': {'Meta': {'object_name': 'MemberFriend'}, 'friend': (
