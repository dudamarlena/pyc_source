...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/friends/migrations/0002_auto__add_field_directmessage_root_direct_message.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('friends_directmessage', 'root_direct_message', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['friends.DirectMessage']), keep_default=False)

    def backwards(self, orm):
        db.delete_column('friends_directmessage', 'root_direct_message_id')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'friends.directmessage': {'Meta': {'object_name': 'DirectMessage'}, 'created': (
                                 ...
                                 'root_direct_message': (
                                                       'django.db.models.fields.related.ForeignKey', [], {'to': "orm['friends.DirectMessage']"}), 
                                 'state': (
