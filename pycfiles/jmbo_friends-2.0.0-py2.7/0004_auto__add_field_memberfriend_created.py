...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/friends/migrations/0004_auto__add_field_memberfriend_created.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('friends_memberfriend', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('friends_memberfriend', 'created')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'friends.directmessage': {'Meta': {'object_name': 'DirectMessage'}, 'created': (
                                 ...
                                 'reply_to': (
                                            'django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'replies'", 'null': 'True', 'to': "orm['friends.DirectMessage']"}), 
                                 'root_direct_message': (
                                                       'django.db.models.fields.related.ForeignKey', [], {'to': "orm['friends.DirectMessage']", 'null': 'True', 'blank': 'True'}), 
                                 'state': (
       ...
       'friends.memberfriend': {'Meta': {'object_name': 'MemberFriend'}, 'created': (
