...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mautrix/appservice/state_store/abstract.py
# Compiled at: 2019-11-21 01:01:47
# Size of source mod 2**32: 4124 bytes
from typing import Dict, Tuple, Union, Optional
from abc import ABC, abstractmethod
import time
from ...types import StateEvent, EventType, PowerLevelStateEventContent, EventID, MemberStateEventContent, Member, Membership, RoomID, UserID
...
class StateStore(ABC):
    ...
    @abstractmethod
    def set_member(self, room_id: RoomID, user_id: UserID, member: Union[(Member, MemberStateEventContent)]) -> None:
        pass
    ...
    def set_typing(self, room_id: RoomID, user_id: UserID, is_typing: bool, timeout: int=0) -> None:
        if is_typing:
