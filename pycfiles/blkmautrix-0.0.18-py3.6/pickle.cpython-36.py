...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mautrix/appservice/state_store/pickle.py
...
class PickleStateStore(StateStore):
    ...
    def save(self, file: str) -> None:
        if isinstance(file, str):
            ...
            output = file
        pickle.dump({'registrations':self.registrations, 
         'members':self.members, 
         'power_levels':self.power_levels}, output)
        if isinstance(file, str):
            output.close()
