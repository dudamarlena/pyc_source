...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mautrix/bridge/db/sqlstatestore.py
...
class SQLStateStore(StateStore):
    ...
    def _get_user_profile(self, room_id: RoomID, user_id: UserID, create: bool=True) -> UserProfile:
        if not room_id:
    ...
    def set_member(self, room_id: RoomID, user_id: UserID, member: Member) -> None:
        ...
        profile.edit(membership=(member.membership), displayname=(member.displayname or profile.displayname),
