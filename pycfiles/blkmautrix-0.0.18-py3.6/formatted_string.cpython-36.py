...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mautrix/util/formatter/formatted_string.py
...
class EntityType(Enum):
    __doc__ = 'EntityType is a Matrix formatting entity type.'
    BOLD = auto()
    ITALIC = auto()
    STRIKETHROUGH = auto()
    UNDERLINE = auto()
...
class FormattedString(ABC):
    __doc__ = 'FormattedString is an abstract HTML parsing target.'
    ...
    @classmethod
    @abstractmethod
    def join(cls, items: Sequence[Union[(str, 'FormattedString')]], separator: str=' ') -> 'FormattedString':
        """
