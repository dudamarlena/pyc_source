...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tests/base_tests.py
# Compiled at: 2009-03-16 12:35:10
"""
...
from repoze.what.plugins.pylonshq.utils import booleanize_predicates, debooleanize_predicates
...
class ActionDecoratorTestCase(object):
    ...
    def test_authorization_denied_with_custom_denial_handler(self):
        ...
        resp = self.app.get('/leave_comment', extra_environ=environ, status=403)
