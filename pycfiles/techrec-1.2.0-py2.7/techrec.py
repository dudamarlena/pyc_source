...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/techrec/techrec.py
# Compiled at: 2014-04-23 14:13:58
"""
...
class RecDB:
    ...
    def _search(self, _id=None, name=None, starttime=None, endtime=None, page=0, page_size=PAGESIZE):
        self.log.debug('DB: Search => id:%s name:%s starttime:%s endtime=%s' % (
