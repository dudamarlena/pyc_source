...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/techrec/config_manager.py
# Compiled at: 2013-12-01 12:47:14
    ...
    def from_pyfile(self, filename, silent=False):
        ...
        try:
            with open(filename) as (config_file):
                exec compile(config_file.read(), filename, 'exec') in d.__dict__
        except IOError as e:
