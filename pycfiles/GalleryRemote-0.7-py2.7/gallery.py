...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/galleryremote/gallery.py
# Compiled at: 2011-06-09 15:15:13
__version__ = '0.7'
...
class Gallery:
    ...
    def __init__(self, url, version=2):
        ...
        if self.secured:
            ...
            self.ssl_context.set_verify(SSL.verify_peer | SSL.verify_fail_if_no_peer_cert | SSL.verify_client_once, 20)
    ...
    def _do_request(self, request, file_info=None):
        ...
        headers = {'User-agent': USER_AGENT, 'Content-type': 'multipart/form-data; boundary=%s' % boundary, 
           'Accept': 'text/plain'}
        ...
        elif 'debug_exception' in response:
    ...
    def login(self, username, password):
        ...
        """
        if self.version == 1:
            request = {'protocol_version': self.protocol_version, 'cmd': 'login', 
               'uname': username, 
               'password': password}
        else:
            request = {'g2_controller': 'remote:GalleryRemote', 'g2_form[protocol_version]': self.protocol_version, 
               'g2_form[cmd]': 'login', 
    ...
    def fetch_albums(self):
        ...
        """
        if self.version == 1:
            request = {'protocol_version': self.protocol_version, 'cmd': 'fetch-albums'}
        else:
            request = {'g2_controller': 'remote:GalleryRemote', 'g2_form[protocol_version]': self.protocol_version, 
    ...
    def fetch_albums_prune(self):
        ...
        """
        if self.version == 1:
            request = {'protocol_version': self.protocol_version, 'cmd': 'fetch-albums-prune'}
        else:
            request = {'g2_controller': 'remote:GalleryRemote', 'g2_form[protocol_version]': self.protocol_version, 
    ...
    def add_item(self, album, filename, caption, description):
        ...
        """
        if self.version == 1:
            request = {'protocol_version': self.protocol_version, 'cmd': 'add-item', 
               'set_albumName': album, 
            ...
            request = {'g2_controller': 'remote:GalleryRemote', 
    ...
    def album_properties(self, album):
        ...
        """
        if self.version == 1:
            request = {'protocol_version': self.protocol_version, 'cmd': 'album-properties', 
               'set_albumName': album}
        else:
            request = {'g2_controller': 'remote:GalleryRemote', 'g2_form[protocol_version]': self.protocol_version, 
    ...
    def new_album(self, parent, name=None, title=None, description=None):
        ...
        """
        if self.version == 1:
            request = {'g2_controller': 'remote:GalleryRemote', 'protocol_version': self.protocol_version, 
               'cmd': 'new-album', 
    ...
    def fetch_album_images(self, album):
        ...
        """
        if self.version == 1:
            request = {'protocol_version': self.protocol_version, 'cmd': 'fetch-album-images', 
               'set_albumName': album, 
               'albums_too': 'no', 
               'extrafields': 'yes'}
        else:
