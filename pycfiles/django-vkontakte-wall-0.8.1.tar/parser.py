...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/parser.py
    ...
    def parse_post(self, content, owner):
        ...
        if owner and owner.screen_name == owner_slug:
            ...
            try:
                ...
                instance.copy_post = Post.objects.get_or_create(remote_id=content.find('a', {'class': 'published_by_date'})['href'][5:], defaults={'owner': instance.copy_owner, 
                   'date': self.parse_date(post_link.text)})[0]
            except:
                pass
