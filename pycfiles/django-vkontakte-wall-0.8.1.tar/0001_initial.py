...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'vkontakte_places.city': {'Meta': {'ordering': "['name']", 'object_name': 'City'}, 'area': (
       ...
       'vkontakte_wall.post': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Post'}, 'attachments': (
                                             'django.db.models.fields.TextField', [], {}), 
                               'author': (
                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'posts'", 'to': "orm['vkontakte_users.User']"}), 
                               'comments': (
                                          'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                               'copy_owner_id': (
                                               'django.db.models.fields.IntegerField', [], {'null': 'True'}), 
                               ...
                               'owner': (
                                       'django.db.models.fields.related.ForeignKey', [], {'related_name': "'wall'", 'to': "orm['vkontakte_users.User']"}), 
                               'post_source': (
                                             'django.db.models.fields.TextField', [], {}), 
                               'remote_id': (
                                           'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': "'20'"}), 
