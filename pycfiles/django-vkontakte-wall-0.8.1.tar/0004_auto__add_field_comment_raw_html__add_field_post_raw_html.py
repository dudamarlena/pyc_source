...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0004_auto__add_field_comment_raw_html__add_field_post_raw_html.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_wall_comment', 'raw_html', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
        db.add_column('vkontakte_wall_post', 'raw_html', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
