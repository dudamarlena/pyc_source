...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0011_auto__chg_field_post_reply_count.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('vkontakte_wall_post', 'reply_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        db.alter_column('vkontakte_wall_post', 'reply_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
