...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0005_auto__add_field_comment_wall_owner_content_type__add_field_comment_wal.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_wall_comment', 'wall_owner_content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=ContentType.objects.all()[0].id, related_name='vkontakte_wall_comments', to=orm['contenttypes.ContentType']), keep_default=False)
        db.add_column('vkontakte_wall_comment', 'wall_owner_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_wall_comment', 'wall_owner_content_type_id')
        db.delete_column('vkontakte_wall_comment', 'wall_owner_id')
