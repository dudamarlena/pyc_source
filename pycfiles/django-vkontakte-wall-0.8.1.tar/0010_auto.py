...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0010_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('vkontakte_wall_comment', ['fetched'])
        db.create_index('vkontakte_wall_post', ['fetched'])

    def backwards(self, orm):
        db.delete_index('vkontakte_wall_post', ['fetched'])
        db.delete_index('vkontakte_wall_comment', ['fetched'])
