...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0008_auto__add_field_comment_raw_json__add_field_post_raw_json__chg_field_p.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_wall_comment', 'raw_json', self.gf('annoying.fields.JSONField')(default={}, null=True), keep_default=False)
        ...
        db.add_column('vkontakte_wall_post', 'raw_json', self.gf('annoying.fields.JSONField')(default={}, null=True), keep_default=False)
