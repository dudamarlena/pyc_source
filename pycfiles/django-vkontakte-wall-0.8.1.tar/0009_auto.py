...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0009_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('vkontakte_wall_comment', ['wall_owner_id'])
        db.create_index('vkontakte_wall_comment', ['reply_for_id'])
        db.create_index('vkontakte_wall_comment', ['likes'])
        db.create_index('vkontakte_wall_comment', ['author_id'])
        db.create_index('vkontakte_wall_post', ['likes'])
        db.create_index('vkontakte_wall_post', ['copy_owner_id'])
        db.create_index('vkontakte_wall_post', ['comments'])
        db.create_index('vkontakte_wall_post', ['author_id'])
        db.create_index('vkontakte_wall_post', ['wall_owner_id'])
        db.create_index('vkontakte_wall_post', ['reposts'])

    def backwards(self, orm):
        db.delete_index('vkontakte_wall_post', ['reposts'])
        db.delete_index('vkontakte_wall_post', ['wall_owner_id'])
        db.delete_index('vkontakte_wall_post', ['author_id'])
        db.delete_index('vkontakte_wall_post', ['comments'])
        db.delete_index('vkontakte_wall_post', ['copy_owner_id'])
        db.delete_index('vkontakte_wall_post', ['likes'])
        db.delete_index('vkontakte_wall_comment', ['author_id'])
        db.delete_index('vkontakte_wall_comment', ['likes'])
        db.delete_index('vkontakte_wall_comment', ['reply_for_id'])
        db.delete_index('vkontakte_wall_comment', ['wall_owner_id'])
