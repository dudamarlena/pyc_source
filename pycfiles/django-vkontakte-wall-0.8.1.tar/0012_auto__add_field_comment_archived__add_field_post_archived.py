...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0012_auto__add_field_comment_archived__add_field_post_archived.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_wall_comment', 'archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('vkontakte_wall_post', 'archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_wall_comment', 'archived')
        db.delete_column('vkontakte_wall_post', 'archived')
