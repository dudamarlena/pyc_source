...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0015_auto__del_comment__del_field_post_likes__del_field_post_comments__del_.py
# Compiled at: 2015-03-06 07:14:12
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name('vkontakte_wall_comment_like_users'))
        db.delete_column('vkontakte_wall_post', 'likes')
        db.delete_column('vkontakte_wall_post', 'comments')
        db.delete_column('vkontakte_wall_post', 'wall_owner_content_type_id')
        db.delete_column('vkontakte_wall_post', 'wall_owner_id')
        db.delete_column('vkontakte_wall_post', 'reposts')
        db.add_column('vkontakte_wall_post', 'owner_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_owners_vkontakte_wall_posts', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
        db.add_column('vkontakte_wall_post', 'owner_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True), keep_default=False)
        db.add_column('vkontakte_wall_post', 'likes_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_index=True), keep_default=False)
        db.add_column('vkontakte_wall_post', 'comments_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
        db.add_column('vkontakte_wall_post', 'reposts_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_index=True), keep_default=False)
        db.delete_table(db.shorten_name('vkontakte_wall_post_repost_users'))
        db.delete_table(db.shorten_name('vkontakte_wall_post_like_users'))
        m2m_table_name = db.shorten_name('vkontakte_wall_post_likes_users')
        ...
        m2m_table_name = db.shorten_name('vkontakte_wall_post_reposts_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
         ...
         (
          'user', models.ForeignKey(orm['vkontakte_users.user'], null=False))))
        db.create_unique(m2m_table_name, ['post_id', 'user_id'])
        db.alter_column('vkontakte_wall_post', 'remote_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))
        db.alter_column('vkontakte_wall_post', 'author_content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contenttypes.ContentType']))
        db.alter_column('vkontakte_wall_post', 'author_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    def backwards(self, orm):
        db.create_table('vkontakte_wall_comment', (
         ...
         (
          'post',
          self.gf('django.db.models.fields.related.ForeignKey')(related_name='wall_comments', to=orm['vkontakte_wall.Post'])),
         (
         ...
         (
          'author_content_type',
          self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['contenttypes.ContentType'])),
         (
         ...
         (
          ...
          self.gf('django.db.models.fields.related.ForeignKey')(related_name='vkontakte_wall_comments', to=orm['contenttypes.ContentType'])),
         (
        ...
        m2m_table_name = db.shorten_name('vkontakte_wall_comment_like_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
        ...
        db.add_column('vkontakte_wall_post', 'likes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
        db.add_column('vkontakte_wall_post', 'comments', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
        raise RuntimeError("Cannot reverse this migration. 'Post.wall_owner_content_type' and its values cannot be restored.")
        db.add_column('vkontakte_wall_post', 'wall_owner_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vkontakte_wall_posts', to=orm['contenttypes.ContentType']), keep_default=False)
        raise RuntimeError("Cannot reverse this migration. 'Post.wall_owner_id' and its values cannot be restored.")
        db.add_column('vkontakte_wall_post', 'wall_owner_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True), keep_default=False)
        db.add_column('vkontakte_wall_post', 'reposts', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
        db.delete_column('vkontakte_wall_post', 'owner_content_type_id')
        db.delete_column('vkontakte_wall_post', 'owner_id')
        db.delete_column('vkontakte_wall_post', 'likes_count')
        db.delete_column('vkontakte_wall_post', 'comments_count')
        db.delete_column('vkontakte_wall_post', 'reposts_count')
        m2m_table_name = db.shorten_name('vkontakte_wall_post_repost_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
         ...
         (
          'user', models.ForeignKey(orm['vkontakte_users.user'], null=False))))
        db.create_unique(m2m_table_name, ['post_id', 'user_id'])
        m2m_table_name = db.shorten_name('vkontakte_wall_post_like_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
         ...
         (
          'user', models.ForeignKey(orm['vkontakte_users.user'], null=False))))
        db.create_unique(m2m_table_name, ['post_id', 'user_id'])
        db.delete_table(db.shorten_name('vkontakte_wall_post_likes_users'))
        db.delete_table(db.shorten_name('vkontakte_wall_post_reposts_users'))
        db.alter_column('vkontakte_wall_post', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length='20', unique=True))
        raise RuntimeError("Cannot reverse this migration. 'Post.author_content_type' and its values cannot be restored.")
        db.alter_column('vkontakte_wall_post', 'author_content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
        raise RuntimeError("Cannot reverse this migration. 'Post.author_id' and its values cannot be restored.")
        db.alter_column('vkontakte_wall_post', 'author_id', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_places.city': {'Meta': {'object_name': 'City'}, 'area': ('django.db.models.fields.CharField', [], {'max_length': '100'}), 'country': (
