...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0002_auto__del_field_comment_reply_to_uid__del_field_comment_reply_to_cid__.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vkontakte_wall_comment', 'reply_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vkontakte_wall.Comment'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        db.add_column('vkontakte_wall_comment', 'reply_to_uid', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
        db.add_column('vkontakte_wall_comment', 'reply_to_cid', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    models = {'vkontakte_groups.group': {'Meta': {'ordering': "['name']", 'object_name': 'Group'}, 'fetched': (
       ...
       'vkontakte_users.user': {'Meta': {'ordering': "['remote_id']", 'object_name': 'User'}, 'activity': (
                                ...
                                'wall_comments': (
                                                'django.db.models.fields.BooleanField', [], {'default': 'False'})}, 
       'vkontakte_wall.comment': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Comment'}, 'date': (
                                  ...
                                  'reply_for': (
                                              'django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_users.User']", 'null': 'True'}), 
                                  'reply_to': (
                                             'django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_wall.Comment']", 'null': 'True'}), 
                                  'text': (
                                         'django.db.models.fields.TextField', [], {}), 
                                  'user': (
                                         'django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': "orm['vkontakte_users.User']"})}, 
       'vkontakte_wall.post': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Post'}, 'attachments': (
                                             'django.db.models.fields.TextField', [], {}), 
                               'author': (
                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'posts'", 'null': 'True', 'to': "orm['vkontakte_users.User']"}), 
                               'comments': (
                                          'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                               'copy_owner_id': (
                                               'django.db.models.fields.IntegerField', [], {'null': 'True'}), 
                               ...
                               'geo': (
                                     'django.db.models.fields.TextField', [], {}), 
                               'group': (
                                       'django.db.models.fields.related.ForeignKey', [], {'related_name': "'posts'", 'null': 'True', 'to': "orm['vkontakte_groups.Group']"}), 
                               'id': (
                                    'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                               'like_users': (
                               ...
                               'owner': (
                                       'django.db.models.fields.related.ForeignKey', [], {'related_name': "'wall'", 'null': 'True', 'to': "orm['vkontakte_users.User']"}), 
                               'post_source': (
                                             'django.db.models.fields.TextField', [], {}), 
                               'remote_id': (
                                           'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': "'20'"}), 
