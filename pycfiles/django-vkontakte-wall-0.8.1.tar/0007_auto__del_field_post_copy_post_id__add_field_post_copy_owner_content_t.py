...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0007_auto__del_field_post_copy_post_id__add_field_post_copy_owner_content_t.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_wall_post', 'copy_owner_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vkontakte_wall_copy_posts', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
    ...
    def backwards(self, orm):
        db.add_column('vkontakte_wall_post', 'copy_post_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
        db.delete_column('vkontakte_wall_post', 'copy_owner_content_type_id')
        db.delete_column('vkontakte_wall_post', 'copy_post_id')
        db.alter_column('vkontakte_wall_post', 'copy_owner_id', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_wall.post': {'Meta': {'ordering': "['wall_owner_id', '-date']", 'object_name': 'Post'}, 'attachments': (
                               ...
                               'copy_owner_id': (
                                               'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                               'copy_post': (
                                           'django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_wall.Post']"}), 
                               'copy_text': (
                                           'django.db.models.fields.TextField', [], {}), 
                               'date': (
                                      'django.db.models.fields.DateTimeField', [], {'db_index': 'True'}), 
