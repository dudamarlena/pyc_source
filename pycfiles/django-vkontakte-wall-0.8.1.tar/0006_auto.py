...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-wall/vkontakte_wall/migrations/0006_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('vkontakte_wall_comment', ['date'])
        db.create_index('vkontakte_wall_post', ['date'])

    def backwards(self, orm):
        db.delete_index('vkontakte_wall_post', ['date'])
        db.delete_index('vkontakte_wall_comment', ['date'])
