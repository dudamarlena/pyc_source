...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/quebert/mediator.py
...
class Mediator(object):
    ...
    def __init__(self, decode=json.loads, encode=json.dumps, defaulturl='http://localhost:8000/', reactor=reactor, getPage=client.getPage):
    ...
    def makeRequest(self, url, task):
        ...
        return self.getPage(url, method='POST', postdata=data, timeout=timeout, headers={'Content-Length': str(len(data))}).addCallback(self.decode)
