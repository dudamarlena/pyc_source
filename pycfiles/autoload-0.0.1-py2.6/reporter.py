...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/autoload/reporter.py
# Compiled at: 2011-08-04 05:09:32
import os, autoload
...
class Reporter(object):
    fonts = {'Cicle': os.path.join(os.path.dirname(autoload.__file__), 'fonts', 'cicle.ttf'), 
    ...
    def __init__(self, output):
        ...
        self.doc = SimpleDocTemplate(output, pagesize=landscape(letter), rightMargin=52, leftMargin=52, topMargin=25, bottomMargin=25)
