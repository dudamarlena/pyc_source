...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/autoload/tester.py
# Compiled at: 2011-08-03 08:08:28
import math, re, signal, subprocess, time
COOLDOWN_TIME = 30
ERROR_FACTOR = 30
...
class Tester(object):
    ...
    def run(self, test):
        if test.has_key('breaking_point'):
            ...
            print '-' * len(start_msg)
            TEST_COUNT = 8
            rate_step = breaking_point / float(TEST_COUNT)
            results = {}
            rate = 0
