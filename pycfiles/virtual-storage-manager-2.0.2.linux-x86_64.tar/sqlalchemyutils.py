...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsm/common/sqlalchemyutils.py
...
def paginate_query(query, model, limit, sort_keys, marker=None, sort_dir=None, sort_dirs=None):
    ...
    for current_sort_key, current_sort_dir in zip(sort_keys, sort_dirs):
        sort_dir_func = {'asc': sqlalchemy.asc, 
           'desc': sqlalchemy.desc}[current_sort_dir]
        try:
