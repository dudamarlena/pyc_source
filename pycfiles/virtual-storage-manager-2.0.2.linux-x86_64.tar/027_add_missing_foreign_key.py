...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsm/db/sqlalchemy/migrate_repo/versions/027_add_missing_foreign_key.py
...
def upgrade(migrate_engine):
    ...
    if migrate_engine.name == 'mysql':
        params['name'] = ('_').join(('storage_pools', 'primary_storage_group_ids',
                                     'fkey'))
