...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsm/agent/crushmap_parser.py
        ...
        for rule in rules:
            ...
            for i in range(steps_len):
                ...
                if op == 'take':
                    ...
                    values = {'name': rule['rule_name'], 'choose_num': next_step.get('num', None) or 0, 
