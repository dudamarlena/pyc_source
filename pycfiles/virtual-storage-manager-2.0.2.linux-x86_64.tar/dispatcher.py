...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsm/openstack/common/rpc/dispatcher.py
    ...
    def dispatch(self, ctxt, version, method, **kwargs):
        ...
        for proxyobj in self.callbacks:
            if hasattr(proxyobj, 'RPC_API_VERSION'):
                ...
                rpc_api_version = '1.0'
            is_compatible = rpc_common.version_is_compatible(rpc_api_version, version)
