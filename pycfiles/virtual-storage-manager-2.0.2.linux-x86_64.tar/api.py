...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsm/scheduler/api.py
...
class API(object):
    ...
    def rgw_create(self, context, server_name, rgw_instance_name, is_ssl, uid, display_name, email, sub_user, access, key_type):
        return self.scheduler_rpcapi.rgw_create(context, server_name, rgw_instance_name, is_ssl, uid, display_name, email, sub_user, access, key_type)