...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DigiPathAI/models/densenet.py
...
def dense_conv_block(x, growth_rate, name):
    ...
    """
    bn_axis = 3
    x1 = BatchNormalization(axis=bn_axis, epsilon=1.001e-05, name=name + '_0_bn')(x)
    x1 = Activation('relu', name=name + '_0_relu')(x1)
    x1 = Conv2D(4 * growth_rate, 1, use_bias=False, name=name + '_1_conv')(x1)
    x1 = BatchNormalization(axis=bn_axis, epsilon=1.001e-05, name=name + '_1_bn')(x1)
...
def transition_block(x, reduction, name):
    ...
    """
    bn_axis = 3
    x = BatchNormalization(axis=bn_axis, epsilon=1.001e-05, name=name + '_bn')(x)
...
def unet_densenet121(input_shape, weights='imagenet'):
    ...
    x = BatchNormalization(axis=bn_axis, epsilon=1.001e-05, name='conv1/bn')(x)
    ...
    x = BatchNormalization(axis=bn_axis, epsilon=1.001e-05, name='bn')(x)
    conv5 = x
