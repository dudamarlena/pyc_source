...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DigiPathAI/loaders/inference_data_loader.py
# Compiled at: 2019-12-05 07:10:21
# Size of source mod 2**32: 10132 bytes
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import os, sys, glob, random, time, imgaug
from imgaug import augmenters as iaa
from PIL import Image
from tqdm import tqdm
import numpy as np
from six.moves import range
import openslide, tensorflow as tf
...
if __name__ == '__main__':
    ...
    dataset_obj = WSIStridedPatchDataset(wsi_path_image, mask_path_image, label_path_image, image_size=512, normalize=True, flip='FLIP_LEFT_RIGHT', rotate='ROTATE_90', level=5, stride_factor=16, roi_masking=True)
