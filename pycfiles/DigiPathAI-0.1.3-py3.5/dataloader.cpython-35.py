...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DigiPathAI/loaders/dataloader.py
...
import matplotlib.pyplot as plt, sklearn.metrics, io, itertools
...
class WSIStridedPatchDatasetOld(Dataset):
    ...
    def __init__(self, wsi_path, mask_path, label_path=None, image_size=256, normalize=True, flip='NONE', rotate='NONE', sampling_stride=16, roi_masking=True):
        """
