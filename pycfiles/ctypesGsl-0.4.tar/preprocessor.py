...
__doc__ = 'Preprocess a C source file using gcc and convert the result into\n   a token stream\n\nReference is C99:\n  * http://www.open-std.org/JTC1/SC22/WG14/www/docs/n1124.pdf\n\n'
...
class PreprocessorParser(object):
    ...
    def __init__(self, options, cparser):
        ...
        self.lexer = lex.lex(cls=PreprocessorLexer, optimize=optimize, lextab='lextab', outputdir=os.path.dirname(__file__), module=pplexer)
    ...
    def parse(self, filename):
        ...
        pp = subprocess.Popen(cmd, shell=True, universal_newlines=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
