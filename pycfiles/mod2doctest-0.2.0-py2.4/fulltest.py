...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mod2doctest\tests\fulltest.py
# Compiled at: 2009-11-10 01:46:50
r"""
================================================================================
...
file = '\nimport sys\nimport os\nprint "Current dir is \'%s\'" % os.getcwd()\n\n'
print fix_output(mod2doctest.convert(src=file, target=None, run_doctest=False, add_testmod=False, fn_title_docstr=get_title))
...
if __name__ == '__main__':
    import mod2doctest
    mod2doctest.convert(src=None, target=True, run_doctest=True, add_testmod=True)