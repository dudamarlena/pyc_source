...
# [GCC 8.4.0]
# Embedded file name: /gpfs/data01/glasslab/home/dskola/workspace/PEAS/peas/utilities.py
# Compiled at: 2018-10-08 21:12:13
# Size of source mod 2**32: 2945 bytes
import datetime, sys, numpy, pandas, scipy.stats
...
def validate_param(param_name, value_received, allowable_values):
    ...
    assert result, "Received invalid value '{}' for parameter {}. Allowable values: {}".format(value_received, param_name, ', '.join(allowable_values))
    return result
