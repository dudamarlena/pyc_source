...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/binance/request.py
# Compiled at: 2017-11-02 09:31:36
import logging, requests, websocket, simplejson, ssl, six
...
class Request(object):
    ...
    def _get_base_path(self, path):
        if self._is_wapi(path):
            return self.api.wapi_base_path
