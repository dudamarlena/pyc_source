...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/quantmind/pulsar-odm/tests/test_utils.py
...
table = Model.create_table('bla', Column('id', Integer, primary_key=True), Column('name', String))
...
class TestUtils(unittest.TestCase):
    ...
    def test_model_base(self):
        ...
        self.assertEqual(Model.__table_args__[0]['info'], {'bind_label': 'foooo'})
