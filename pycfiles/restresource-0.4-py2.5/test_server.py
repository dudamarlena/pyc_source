...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/restresource/tests/test_server.py
# Compiled at: 2007-08-16 11:04:05
"""
...
def start_server():
    ...
    cherrypy.config.update({'global': {'server.socketPort': 9080, 'server.environment': 'production'}})
