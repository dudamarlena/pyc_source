...
# [GCC 8.4.0]
# Embedded file name: /home/luke/PycharmProjects/untitled/NearBeach/models.py
# Compiled at: 2020-05-06 19:16:40
# Size of source mod 2**32: 99343 bytes
...
class document_permission(models.Model):
    ...
    opportunity_id = models.ForeignKey('opportunity',
      ...
      null=True,
      on_delete=(models.CASCADE))
    whiteboard_id = models.ForeignKey('whiteboard',
      blank=True,
      null=True,
      on_delete=(models.CASCADE))
    requirement = models.ForeignKey('requirement',
