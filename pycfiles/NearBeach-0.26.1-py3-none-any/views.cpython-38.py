...
# [GCC 8.4.0]
# Embedded file name: /home/luke/PycharmProjects/untitled/NearBeach/views.py
# Compiled at: 2020-05-09 20:29:46
# Size of source mod 2**32: 398787 bytes
from .forms import *
from .models import *
...
@login_required(login_url='login', redirect_field_name='')
def bug_client_information--- This code section failed: ---

 L.1202         0  LOAD_GLOBAL              return_user_permission_level
                2  LOAD_FAST                'request'
                4  LOAD_CONST               None
                6  LOAD_STR                 'bug_client'
                8  CALL_FUNCTION_3       3  ''
               10  STORE_FAST               'permission_results'

 L.1204        12  LOAD_FAST                'permission_results'
               14  LOAD_STR                 'bug_client'
               16  BINARY_SUBSCR    
               18  LOAD_CONST               3
               20  COMPARE_OP               <
               22  POP_JUMP_IF_FALSE    36  'to 36'

 L.1205        24  LOAD_GLOBAL              HttpResponseRedirect
               26  LOAD_GLOBAL              reverse
               28  LOAD_STR                 'permission_denied'
 ...
 L.1206        36  LOAD_STR                 ''
               38  STORE_FAST               'form_errors'

 L.1207        40  LOAD_FAST                'request'
               42  LOAD_ATTR                method
               44  LOAD_STR                 'POST'
               46  COMPARE_OP               ==
            48_50  POP_JUMP_IF_FALSE   294  'to 294'

 L.1208        52  LOAD_GLOBAL              bug_client_form
               54  LOAD_FAST                'request'
               56  LOAD_ATTR                POST
               58  CALL_FUNCTION_1       1  ''
               60  STORE_FAST               'form'

 L.1209        62  LOAD_FAST                'form'
               64  LOAD_METHOD              is_valid
               66  CALL_METHOD_0         0  ''
            68_70  POP_JUMP_IF_FALSE   274  'to 274'

 L.1211        72  LOAD_FAST                'form'
               74  LOAD_ATTR                cleaned_data
               76  LOAD_STR                 'bug_client_name'
               78  BINARY_SUBSCR    
               80  STORE_FAST               'bug_client_name'

 L.1212        82  LOAD_FAST                'form'
               84  LOAD_ATTR                cleaned_data
               86  LOAD_STR                 'list_of_bug_client'
               88  BINARY_SUBSCR    
               90  STORE_FAST               'list_of_bug_client'

 L.1213        92  LOAD_FAST                'form'
               94  LOAD_ATTR                cleaned_data
               96  LOAD_STR                 'bug_client_url'
               98  BINARY_SUBSCR    
              100  STORE_FAST               'bug_client_url'

 L.1216       102  SETUP_FINALLY       248  'to 248'

 L.1217       104  LOAD_FAST                'bug_client_url'
              106  LOAD_FAST                'list_of_bug_client'
              108  LOAD_ATTR                bug_client_api_url
              110  BINARY_ADD       
              112  LOAD_STR                 'version'
              114  BINARY_ADD       
              116  STORE_FAST               'url'

 L.1228       118  LOAD_FAST                'url'
              120  LOAD_METHOD              lower
              122  CALL_METHOD_0         0  ''
 ...
 L.1229       132  LOAD_GLOBAL              urllib
              134  LOAD_ATTR                request
              136  LOAD_METHOD              Request
              138  LOAD_FAST                'url'
              140  CALL_METHOD_1         1  ''
              142  STORE_FAST               'req'
 ...
 L.1231       146  LOAD_GLOBAL              ValueError
              148  LOAD_CONST               None
              150  RAISE_VARARGS_2       2  'exception instance with __cause__'
            152_0  COME_FROM           144  '144'

 L.1233       152  LOAD_GLOBAL              urllib
              154  LOAD_ATTR                request
              156  LOAD_METHOD              urlopen
              158  LOAD_FAST                'req'
              160  CALL_METHOD_1         1  ''
              162  SETUP_WITH          180  'to 180'
              164  STORE_FAST               'response'

 L.1234       166  LOAD_GLOBAL              json
              168  LOAD_METHOD              load
              170  LOAD_FAST                'response'
              172  CALL_METHOD_1         1  ''
              174  STORE_FAST               'data'
              176  POP_BLOCK        
              178  BEGIN_FINALLY    
            180_0  COME_FROM_WITH      162  '162'
              180  WITH_CLEANUP_START
              182  WITH_CLEANUP_FINISH
              184  END_FINALLY      

 L.1236       186  LOAD_GLOBAL              bug_client
              188  LOAD_ATTR                objects
              190  LOAD_ATTR                get
              192  LOAD_FAST                'bug_client_id'
              194  LOAD_CONST               ('bug_client_id',)
              196  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              198  STORE_FAST               'bug_client_save'

 L.1237       200  LOAD_FAST                'bug_client_name'
              202  LOAD_FAST                'bug_client_save'
              204  STORE_ATTR               bug_client_name

 L.1238       206  LOAD_FAST                'list_of_bug_client'
              208  LOAD_FAST                'bug_client_save'
              210  STORE_ATTR               list_of_bug_client

 L.1239       212  LOAD_FAST                'bug_client_url'
              214  LOAD_FAST                'bug_client_save'
              216  STORE_ATTR               bug_client_url

 L.1240       218  LOAD_FAST                'request'
              220  LOAD_ATTR                user
              222  LOAD_FAST                'bug_client_save'
              224  STORE_ATTR               change_user

 L.1242       226  LOAD_FAST                'bug_client_save'
              228  LOAD_METHOD              save
              230  CALL_METHOD_0         0  ''
              232  POP_TOP          

 L.1243       234  LOAD_GLOBAL              HttpResponseRedirect
              236  LOAD_GLOBAL              reverse
              238  LOAD_STR                 'bug_client_list'
              240  CALL_FUNCTION_1       1  ''
              242  CALL_FUNCTION_1       1  ''
              244  POP_BLOCK        
              246  RETURN_VALUE     
            248_0  COME_FROM_FINALLY   102  '102'

 L.1244       248  POP_TOP          
              250  POP_TOP          
              252  POP_TOP          

 L.1245       254  LOAD_STR                 'Could not connect to the API'
              256  STORE_FAST               'form_errors'

 L.1246       258  LOAD_GLOBAL              print
              260  LOAD_STR                 'There was an error'
            ...
            274_0  COME_FROM            68  '68'

 L.1250       274  LOAD_GLOBAL              print
              276  LOAD_FAST                'form'
              278  LOAD_ATTR                errors
              280  CALL_FUNCTION_1       1  ''
              282  POP_TOP          

 L.1251       284  LOAD_FAST                'form_errors'
              286  LOAD_FAST                'form'
              288  LOAD_ATTR                errors
              290  CALL_FUNCTION_1       1  ''
              292  POP_TOP          
            294_0  COME_FROM           272  '272'
            294_1  COME_FROM            48  '48'

 L.1256       294  LOAD_GLOBAL              bug_client
              296  LOAD_ATTR                objects
              298  LOAD_ATTR                get
              300  LOAD_FAST                'bug_client_id'
              302  LOAD_CONST               ('bug_client_id',)
              304  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              306  STORE_FAST               'bug_client_results'

 L.1258       308  LOAD_FAST                'bug_client_results'
              310  LOAD_ATTR                bug_client_name

 L.1259       312  LOAD_FAST                'bug_client_results'
              314  LOAD_ATTR                list_of_bug_client

 L.1260       316  LOAD_FAST                'bug_client_results'
              318  LOAD_ATTR                bug_client_url

 L.1257       320  LOAD_CONST               ('bug_client_name', 'list_of_bug_client', 'bug_client_url')
              322  BUILD_CONST_KEY_MAP_3     3 
              324  STORE_FAST               'bug_client_initial'

 L.1263       326  LOAD_GLOBAL              loader
              328  LOAD_METHOD              get_template
              330  LOAD_STR                 'NearBeach/bug_client_information.html'
              332  CALL_METHOD_1         1  ''
              334  STORE_FAST               't'

 L.1267       336  LOAD_GLOBAL              bug_client_form
              338  LOAD_FAST                'bug_client_initial'
              340  LOAD_CONST               ('initial',)
              342  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'

 L.1268       344  LOAD_FAST                'bug_client_id'

 L.1269       346  LOAD_FAST                'permission_results'
              348  LOAD_STR                 'new_item'
              350  BINARY_SUBSCR    

 L.1270       352  LOAD_FAST                'permission_results'
              354  LOAD_STR                 'administration'
              356  BINARY_SUBSCR    

 L.1271       358  LOAD_FAST                'form_errors'

 L.1266       360  LOAD_CONST               ('bug_client_form', 'bug_client_id', 'new_item_permission', 'administration_permission', 'form_errors')
              362  BUILD_CONST_KEY_MAP_5     5 
              364  STORE_FAST               'c'

 L.1274       366  LOAD_GLOBAL              HttpResponse
              368  LOAD_FAST                't'
              370  LOAD_METHOD              render
              372  LOAD_FAST                'c'
              374  LOAD_FAST                'request'
              376  CALL_METHOD_2         2  ''
              378  CALL_FUNCTION_1       1  ''
              380  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `STORE_FAST' instruction at offset 256
...
@login_required(login_url='login', redirect_field_name='')
def diagnostic_test_location_services--- This code section failed: ---

 L.3406         0  SETUP_FINALLY       186  'to 186'

 L.3407         2  LOAD_GLOBAL              settings
                4  LOAD_ATTR                MAPBOX_API_TOKEN
                6  STORE_FAST               'MAPBOX_API_TOKEN'

 L.3409         8  SETUP_FINALLY       160  'to 160'

 L.3410        10  LOAD_GLOBAL              urllib
               12  LOAD_ATTR                parse
               14  LOAD_METHOD              quote_plus
               16  LOAD_STR                 'Flinders Street Melbourne'
               18  CALL_METHOD_1         1  ''
               20  STORE_FAST               'address_coded'

 L.3411        22  LOAD_GLOBAL              print
               24  LOAD_FAST                'address_coded'
               26  CALL_FUNCTION_1       1  ''
               28  POP_TOP          

 L.3413        30  LOAD_STR                 'https://api.mapbox.com/geocoding/v5/mapbox.places/'
               32  LOAD_FAST                'address_coded'
               34  BINARY_ADD       
               36  LOAD_STR                 '.json?access_token='
               38  BINARY_ADD       
               40  LOAD_GLOBAL              settings
               42  LOAD_ATTR                MAPBOX_API_TOKEN
               44  BINARY_ADD       
               46  STORE_FAST               'url'

 L.3423        48  LOAD_FAST                'url'
 ...
 L.3424        62  LOAD_GLOBAL              urllib
               64  LOAD_ATTR                request
               66  LOAD_METHOD              Request
               68  LOAD_FAST                'url'
               70  CALL_METHOD_1         1  ''
               72  STORE_FAST               'req'
 ...
 L.3426        76  LOAD_GLOBAL              ValueError
               78  LOAD_CONST               None
               80  RAISE_VARARGS_2       2  'exception instance with __cause__'
             82_0  COME_FROM            74  '74'

 L.3428        82  LOAD_GLOBAL              urllib
               84  LOAD_ATTR                request
               86  LOAD_METHOD              urlopen
               88  LOAD_FAST                'req'
               90  CALL_METHOD_1         1  ''
               92  SETUP_WITH          110  'to 110'
               94  STORE_FAST               'response'

 L.3429        96  LOAD_GLOBAL              json
               98  LOAD_METHOD              load
 ...
 L.3432       116  LOAD_FAST                'data'
              118  LOAD_STR                 'features'
              120  BINARY_SUBSCR    
              122  LOAD_CONST               0
              124  BINARY_SUBSCR    
              126  LOAD_STR                 'center'
              ...
              130  LOAD_CONST               0
              132  BINARY_SUBSCR    
              134  STORE_FAST               'longatude'

 L.3433       136  LOAD_FAST                'data'
              138  LOAD_STR                 'features'
              140  BINARY_SUBSCR    
              142  LOAD_CONST               0
              144  BINARY_SUBSCR    
              146  LOAD_STR                 'center'
              ...
              150  LOAD_CONST               1
              152  BINARY_SUBSCR    
              154  STORE_FAST               'latitude'
              156  POP_BLOCK        
              158  JUMP_FORWARD        182  'to 182'
            160_0  COME_FROM_FINALLY     8  '8'

 L.3435       160  POP_TOP          
              162  POP_TOP          
              164  POP_TOP          

 L.3436       166  LOAD_GLOBAL              HttpResponseBadRequest
              168  LOAD_STR                 'Sorry, could not contact Mapbox'
            ...
            182_0  COME_FROM           158  '158'
              182  POP_BLOCK        
              184  JUMP_FORWARD        272  'to 272'
            186_0  COME_FROM_FINALLY     0  '0'

 L.3437       186  POP_TOP          
              188  POP_TOP          
              190  POP_TOP          

 L.3438       192  SETUP_FINALLY       242  'to 242'

 L.3439       194  LOAD_GLOBAL              GoogleMaps
              196  LOAD_GLOBAL              settings
              198  LOAD_ATTR                GOOGLE_MAP_API_TOKEN
              200  LOAD_CONST               ('api_key',)
              202  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              204  STORE_FAST               'google_maps'

 L.3440       206  LOAD_FAST                'google_maps'
              208  LOAD_ATTR                search
              210  LOAD_STR                 'Flinders Street Melbourne'
              212  LOAD_CONST               ('location',)
              214  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              216  STORE_FAST               'location'

 L.3441       218  LOAD_FAST                'location'
              220  LOAD_METHOD              first
              222  CALL_METHOD_0         0  ''
              224  STORE_FAST               'first_location'

 L.3444       226  LOAD_FAST                'first_location'
              228  LOAD_ATTR                lng
              230  STORE_FAST               'ongitude'

 L.3445       232  LOAD_FAST                'first_location'
              234  LOAD_ATTR                lat
              236  STORE_FAST               'latitude'
              238  POP_BLOCK        
              240  JUMP_FORWARD        266  'to 266'
            242_0  COME_FROM_FINALLY   192  '192'

 L.3446       242  POP_TOP          
              244  POP_TOP          
              246  POP_TOP          

 L.3447       248  LOAD_GLOBAL              HttpResponseBadRequest
              250  LOAD_STR                 'Could not contact Google Server'
            ...
            266_0  COME_FROM           240  '240'
              ...
              270  END_FINALLY      
            272_0  COME_FROM           268  '268'
            272_1  COME_FROM           184  '184'

 L.3449       272  LOAD_GLOBAL              loader
              274  LOAD_METHOD              get_template
              276  LOAD_STR                 'NearBeach/blank.html'
              278  CALL_METHOD_1         1  ''
              280  STORE_FAST               't'

 L.3451       282  BUILD_MAP_0           0 
              284  STORE_FAST               'c'

 L.3453       286  LOAD_GLOBAL              HttpResponse
              288  LOAD_FAST                't'
              290  LOAD_METHOD              render
              292  LOAD_FAST                'c'
              294  LOAD_FAST                'request'
              296  CALL_METHOD_2         2  ''
...
def diagnostic_test_recaptcha(request):
    if request.method == 'POST':
        ...
        return result['success'] or HttpResponseBadRequest('Failed recaptcha!\n' + str(result))
    t = loader.get_template('NearBeach/blank.html')
    c = {}
    return HttpResponse(t.render(c, request))
...
def kanban_new_link(request, kanban_board_id, location_id='', destination=''):
    ...
    if request.method == 'POST':
        ...
        if not (form.is_valid()):
            if not (kanban_card.objects.filter(task_id=location_id, is_deleted='FALSE') and destination == 'task'):
...
@login_required(login_url='login', redirect_field_name='')
def new_bug_client--- This code section failed: ---

 L.5220         0  LOAD_GLOBAL              return_user_permission_level
                2  LOAD_FAST                'request'
                4  LOAD_CONST               None
                6  LOAD_STR                 'bug_client'
                8  CALL_FUNCTION_3       3  ''
 ...
 L.5222        12  LOAD_FAST                'permission_results'
               14  LOAD_STR                 'bug_client'
               16  BINARY_SUBSCR    
               18  LOAD_CONST               3
               20  COMPARE_OP               <
 ...
 L.5223        24  LOAD_GLOBAL              HttpResponseRedirect
               26  LOAD_GLOBAL              reverse
               28  LOAD_STR                 'permission_denied'
               30  CALL_FUNCTION_1       1  ''
               32  CALL_FUNCTION_1       1  ''
 ...
 L.5225        40  LOAD_GLOBAL              bug_client_form
               42  LOAD_CONST               None
 ...
 L.5226        54  LOAD_FAST                'request'
               56  LOAD_ATTR                method
               58  LOAD_STR                 'POST'
               60  COMPARE_OP               ==
            62_64  POP_JUMP_IF_FALSE   262  'to 262'

 L.5227        66  LOAD_FAST                'form'
               68  LOAD_METHOD              is_valid
               70  CALL_METHOD_0         0  ''
               72  POP_JUMP_IF_FALSE   246  'to 246'

 L.5229        74  LOAD_FAST                'form'
               76  LOAD_ATTR                cleaned_data
               78  LOAD_STR                 'bug_client_name'
               80  BINARY_SUBSCR    
               82  STORE_FAST               'bug_client_name'

 L.5230        84  LOAD_FAST                'form'
               86  LOAD_ATTR                cleaned_data
               88  LOAD_STR                 'list_of_bug_client'
               90  BINARY_SUBSCR    
               92  STORE_FAST               'list_of_bug_client'

 L.5231        94  LOAD_FAST                'form'
               96  LOAD_ATTR                cleaned_data
               98  LOAD_STR                 'bug_client_url'
              100  BINARY_SUBSCR    
              102  STORE_FAST               'bug_client_url'

 L.5234       104  SETUP_FINALLY       228  'to 228'

 L.5235       106  LOAD_FAST                'bug_client_url'
              108  LOAD_FAST                'list_of_bug_client'
              110  LOAD_ATTR                bug_client_api_url
              112  BINARY_ADD       
              114  LOAD_STR                 'version'
              116  BINARY_ADD       
              118  STORE_FAST               'url'

 L.5246       120  LOAD_FAST                'url'
              122  LOAD_METHOD              lower
              124  CALL_METHOD_0         0  ''
 ...
 L.5247       134  LOAD_GLOBAL              urllib
              136  LOAD_ATTR                request
              138  LOAD_METHOD              Request
              140  LOAD_FAST                'url'
              142  CALL_METHOD_1         1  ''
              144  STORE_FAST               'req'
 ...
 L.5249       148  LOAD_GLOBAL              ValueError
              150  LOAD_CONST               None
              152  RAISE_VARARGS_2       2  'exception instance with __cause__'
            154_0  COME_FROM           146  '146'

 L.5251       154  LOAD_GLOBAL              urllib
              156  LOAD_ATTR                request
              158  LOAD_METHOD              urlopen
              160  LOAD_FAST                'req'
              162  CALL_METHOD_1         1  ''
              164  SETUP_WITH          182  'to 182'
              166  STORE_FAST               'response'

 L.5252       168  LOAD_GLOBAL              json
              170  LOAD_METHOD              load
              172  LOAD_FAST                'response'
              174  CALL_METHOD_1         1  ''
              176  STORE_FAST               'data'
              178  POP_BLOCK        
              180  BEGIN_FINALLY    
 ...
 L.5254       188  LOAD_GLOBAL              bug_client

 L.5255       190  LOAD_FAST                'bug_client_name'

 L.5256       192  LOAD_FAST                'list_of_bug_client'

 L.5257       194  LOAD_FAST                'bug_client_url'

 L.5258       196  LOAD_FAST                'request'
              198  LOAD_ATTR                user

 L.5254       200  LOAD_CONST               ('bug_client_name', 'list_of_bug_client', 'bug_client_url', 'change_user')
              202  CALL_FUNCTION_KW_4     4  '4 total positional and keyword args'
              204  STORE_FAST               'bug_client_submit'

 L.5260       206  LOAD_FAST                'bug_client_submit'
              208  LOAD_METHOD              save
              210  CALL_METHOD_0         0  ''
              212  POP_TOP          

 L.5261       214  LOAD_GLOBAL              HttpResponseRedirect
              216  LOAD_GLOBAL              reverse
              218  LOAD_STR                 'bug_client_list'
              220  CALL_FUNCTION_1       1  ''
              222  CALL_FUNCTION_1       1  ''
              224  POP_BLOCK        
              226  RETURN_VALUE     
            228_0  COME_FROM_FINALLY   104  '104'

 L.5262       228  POP_TOP          
              230  POP_TOP          
              232  POP_TOP          

 L.5263       234  LOAD_STR                 'Could not connect to the API'
              236  STORE_FAST               'form_errors'
              238  POP_EXCEPT       
 ...
 L.5267       246  LOAD_GLOBAL              print
              248  LOAD_FAST                'form'
              250  LOAD_ATTR                errors
              252  CALL_FUNCTION_1       1  ''
              254  POP_TOP          

 L.5268       256  LOAD_FAST                'form'
              258  LOAD_ATTR                errors
              260  STORE_FAST               'form_errors'
            262_0  COME_FROM           244  '244'
            262_1  COME_FROM            62  '62'

 L.5271       262  LOAD_GLOBAL              loader
              264  LOAD_METHOD              get_template
              266  LOAD_STR                 'NearBeach/new_bug_client.html'
              268  CALL_METHOD_1         1  ''
              270  STORE_FAST               't'

 L.5275       272  LOAD_FAST                'form'

 L.5276       274  LOAD_FAST                'form_errors'

 L.5277       276  LOAD_FAST                'permission_results'
              278  LOAD_STR                 'new_item'
              280  BINARY_SUBSCR    

 L.5278       282  LOAD_FAST                'permission_results'
              284  LOAD_STR                 'administration'
              286  BINARY_SUBSCR    

 L.5274       288  LOAD_CONST               ('bug_client_form', 'form_errors', 'new_item_permission', 'administration_permission')
              290  BUILD_CONST_KEY_MAP_4     4 
              292  STORE_FAST               'c'

 L.5281       294  LOAD_GLOBAL              HttpResponse
              296  LOAD_FAST                't'
              298  LOAD_METHOD              render
              300  LOAD_FAST                'c'
              302  LOAD_FAST                'request'
              304  CALL_METHOD_2         2  ''
              306  CALL_FUNCTION_1       1  ''
              308  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `STORE_FAST' instruction at offset 236
...
@login_required(login_url='login', redirect_field_name='')
def new_kudos--- This code section failed: ---

 L.5678         0  LOAD_GLOBAL              return_user_permission_level
                2  LOAD_FAST                'request'
                4  LOAD_CONST               None
                6  LOAD_STR                 'project'
                8  CALL_FUNCTION_3       3  ''
 ...
 L.5682        12  LOAD_GLOBAL              print
               14  LOAD_STR                 'REQUEST PATH: '
 ...
 L.5683        26  LOAD_GLOBAL              print
               28  LOAD_STR                 'REQUEST PATH INFO: '
               30  LOAD_FAST                'request'
               32  LOAD_ATTR                path_info
               34  BINARY_ADD       
               36  CALL_FUNCTION_1       1  ''
               38  POP_TOP          

 L.5684        40  LOAD_GLOBAL              print
               42  LOAD_STR                 'REQUEST FULL PATH: '
               44  LOAD_FAST                'request'
               46  LOAD_METHOD              get_full_path
               48  CALL_METHOD_0         0  ''
               50  BINARY_ADD       
               52  CALL_FUNCTION_1       1  ''
               54  POP_TOP          

 L.5685        56  LOAD_GLOBAL              print
               58  LOAD_STR                 'RAW URI: '
               60  LOAD_FAST                'request'
               62  LOAD_METHOD              get_raw_uri
               64  CALL_METHOD_0         0  ''
               66  BINARY_ADD       
               68  CALL_FUNCTION_1       1  ''
               70  POP_TOP          

 L.5686        72  LOAD_GLOBAL              print
               74  LOAD_STR                 'RAW get_host'
               76  LOAD_FAST                'request'
               78  LOAD_METHOD              get_host
               80  CALL_METHOD_0         0  ''
               82  BINARY_ADD       
               84  CALL_FUNCTION_1       1  ''
               86  POP_TOP          

 L.5689        88  LOAD_FAST                'permission_results'
               90  LOAD_STR                 'project'
               92  BINARY_SUBSCR    
               94  LOAD_CONST               4
               96  COMPARE_OP               <
 ...
 L.5690       100  LOAD_GLOBAL              HttpResponseRedirect
              102  LOAD_GLOBAL              reverse
              104  LOAD_STR                 'permission_denied'
              106  CALL_FUNCTION_1       1  ''
              108  CALL_FUNCTION_1       1  ''
              110  RETURN_VALUE     
            112_0  COME_FROM            98  '98'

 L.5692       112  LOAD_FAST                'request'
              114  LOAD_ATTR                method
              116  LOAD_STR                 'POST'
              118  COMPARE_OP               ==
          120_122  POP_JUMP_IF_FALSE   392  'to 392'

 L.5695       124  LOAD_GLOBAL              project_customer
              126  LOAD_ATTR                objects
              128  LOAD_ATTR                filter

 L.5696       130  LOAD_STR                 'FALSE'

 L.5697       132  LOAD_FAST                'project_id'

 L.5695       134  LOAD_CONST               ('is_deleted', 'project_id')
              136  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              138  STORE_FAST               'project_customer_results'

 L.5700       140  LOAD_FAST                'project_customer_results'
              142  GET_ITER         
              144  FOR_ITER            374  'to 374'
              146  STORE_FAST               'customer_line'

 L.5701       148  LOAD_GLOBAL              kudos

 L.5702       150  LOAD_CONST               2

 L.5703       152  LOAD_FAST                'customer_line'
              154  LOAD_ATTR                customer_id

 L.5704       156  LOAD_FAST                'project_id'

 L.5705       158  LOAD_FAST                'request'
              160  LOAD_ATTR                user

 L.5701       162  LOAD_CONST               ('kudos_rating', 'customer', 'project_id', 'change_user')
              164  CALL_FUNCTION_KW_4     4  '4 total positional and keyword args'
              166  STORE_FAST               'kudos_submit'

 L.5707       168  LOAD_FAST                'kudos_submit'
              170  LOAD_METHOD              save
              172  CALL_METHOD_0         0  ''
              174  POP_TOP          

 L.5710       176  SETUP_FINALLY       352  'to 352'

 L.5712       178  LOAD_GLOBAL              settings
              180  LOAD_ATTR                EMAIL_HOST_USER
              182  STORE_FAST               'EMAIL_HOST_USER'

 L.5713       184  LOAD_GLOBAL              settings
              186  LOAD_ATTR                EMAIL_BACKEND
              188  STORE_FAST               'EMAIL_BACKEND'

 L.5714       190  LOAD_GLOBAL              settings
              192  LOAD_ATTR                EMAIL_USE_TLS
              194  STORE_FAST               'EMAIL_USE_TLS'

 L.5715       196  LOAD_GLOBAL              settings
              198  LOAD_ATTR                EMAIL_HOST
              200  STORE_FAST               'EMAIL_HOST'

 L.5716       202  LOAD_GLOBAL              settings
              204  LOAD_ATTR                EMAIL_PORT
              206  STORE_FAST               'EMAIL_PORT'

 L.5717       208  LOAD_GLOBAL              settings
              210  LOAD_ATTR                EMAIL_HOST_USER
              212  STORE_FAST               'EMAIL_HOST_USER'

 L.5718       214  LOAD_GLOBAL              settings
              216  LOAD_ATTR                EMAIL_HOST_PASSWORD
              218  STORE_FAST               'EMAIL_HOST_PASSWORD'

 L.5720       220  LOAD_STR                 'Hello '

 L.5721       222  LOAD_GLOBAL              str
              224  LOAD_FAST                'customer_line'
              226  LOAD_ATTR                customer_id
              228  LOAD_ATTR                customer_first_name
              230  CALL_FUNCTION_1       1  ''

 L.5720       232  BINARY_ADD       

 L.5722       234  LOAD_STR                 '<br/>We have recently finished working on your project. Can you please evaluate our work at: <a href="'

 L.5720       236  BINARY_ADD       

 L.5723       238  LOAD_FAST                'request'
              240  LOAD_METHOD              get_host
              242  CALL_METHOD_0         0  ''

 L.5720       244  BINARY_ADD       

 L.5723       246  LOAD_STR                 '/kudos_rating/'

 L.5720       248  BINARY_ADD       

 L.5723       250  LOAD_GLOBAL              str
              252  LOAD_FAST                'kudos_submit'
              254  LOAD_ATTR                kudos_key
              256  CALL_FUNCTION_1       1  ''

 L.5720       258  BINARY_ADD       

 L.5723       260  LOAD_STR                 '">'

 L.5720       262  BINARY_ADD       

 L.5724       264  LOAD_FAST                'request'
              266  LOAD_METHOD              get_host
              268  CALL_METHOD_0         0  ''

 L.5720       270  BINARY_ADD       

 L.5724       272  LOAD_STR                 '/kudos_rating/'

 L.5720       274  BINARY_ADD       

 L.5724       276  LOAD_GLOBAL              str
              278  LOAD_FAST                'kudos_submit'
              280  LOAD_ATTR                kudos_key
              282  CALL_FUNCTION_1       1  ''

 L.5720       284  BINARY_ADD       

 L.5724       286  LOAD_STR                 '/</a><br/>Regards<br/>Project Team'

 L.5720       288  BINARY_ADD       
              290  STORE_FAST               'email_content'

 L.5726       292  LOAD_GLOBAL              EmailMultiAlternatives

 L.5727       294  LOAD_STR                 'Kudos Evaluation form'

 L.5728       296  LOAD_FAST                'email_content'

 L.5729       298  LOAD_STR                 'donotreply@nearbeach.org'

 L.5730       300  LOAD_FAST                'customer_line'
              302  LOAD_ATTR                customer_id
              304  LOAD_ATTR                customer_email
              306  BUILD_LIST_1          1 

 L.5726       308  CALL_FUNCTION_4       4  ''
              310  STORE_FAST               'email'

 L.5732       312  LOAD_FAST                'email'
              314  LOAD_METHOD              attach_alternative
              316  LOAD_FAST                'email_content'
              318  LOAD_STR                 'text/html'
              320  CALL_METHOD_2         2  ''
              322  POP_TOP          

 L.5733       324  LOAD_FAST                'email'
              326  LOAD_METHOD              send
              328  CALL_METHOD_0         0  ''
          330_332  POP_JUMP_IF_TRUE    348  'to 348'

 L.5734       334  LOAD_GLOBAL              HttpResponseBadRequest
              336  LOAD_STR                 'Email did not send correctly.'
            ...
            348_0  COME_FROM           330  '330'
              348  POP_BLOCK        
              350  JUMP_BACK           144  'to 144'
            352_0  COME_FROM_FINALLY   176  '176'

 L.5735       352  POP_TOP          
              354  POP_TOP          
              356  POP_TOP          

 L.5736       358  LOAD_GLOBAL              print
              360  LOAD_STR                 'Email not sent'
              362  CALL_FUNCTION_1       1  ''
              364  POP_TOP          
              366  POP_EXCEPT       
              368  JUMP_BACK           144  'to 144'
              370  END_FINALLY      
              372  JUMP_BACK           144  'to 144'

 L.5740       374  LOAD_GLOBAL              HttpResponseRedirect

 L.5741       376  LOAD_GLOBAL              reverse

 L.5742       378  LOAD_STR                 'project_readonly'

 L.5743       380  LOAD_FAST                'project_id'
              382  BUILD_SET_1           1 

 L.5741       384  LOAD_CONST               ('args',)
              386  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'

 L.5740       388  CALL_FUNCTION_1       1  ''
              390  RETURN_VALUE     
            392_0  COME_FROM           120  '120'

 L.5747       392  LOAD_GLOBAL              HttpResponseBadRequest
              394  LOAD_STR                 'Sorry, can only do this request through post'
              396  CALL_FUNCTION_1       1  ''
              398  RETURN_VALUE     

Parse error at or near `ROT_TWO' instruction at offset 342
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            document_permission_submit = document_permission(document_key=document_submit,
              change_user=(request.user))
            object_assignment_submit = object_assignment(whiteboard=whiteboard_submit,
              change_user=(request.user))
            if destination == 'project':
                project_instance = project.objects.get(project_id=location_id)
...
def organisation_information(request, organisation_id):
    ...
    try:
        ...
        c = {'organisation_results':organisation_results,  'campus_results':campus_results, 
         'customer_results':customer_results, 
...
def search_customer(request):
    ...
    for split_row in search_customer_results.split(' '):
        customer_results = customer_results.filter(Q(customer_first_name__icontains=split_row) | Q(customer_last_name__icontains=split_row))
    else:
        ...
        if form.is_valid():
            ...
            if object_type == 'Project':
                json_results = serializers.serialize('json',
                  (project.objects.filter(Q(is_deleted='FALSE') & Q(Q(project_start_date__lte=start_date,
                  project_end_date__gte=end_date) | Q(project_start_date__gte=start_date,
                  project_start_date__lte=end_date) | Q(project_end_date__gte=start_date,
                ...
                if object_type == 'Task':
                    json_results = serializers.serialize('json',
                      (task.objects.filter(Q(is_deleted='FALSE') & Q(Q(task_start_date__lte=start_date,
                      task_end_date__gte=end_date) | Q(task_start_date__gte=start_date,
                      task_start_date__lte=end_date) | Q(task_end_date__gte=start_date,
