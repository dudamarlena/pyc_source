...
# [GCC 8.4.0]
# Embedded file name: /home/luke/PycharmProjects/untitled/NearBeach/views_requirements.py
# Compiled at: 2020-05-09 19:50:11
# Size of source mod 2**32: 36006 bytes
...
def new_requirement_item_link(request, requirement_item_id, location_id='', destination=''):
    ...
    if request.method == 'POST':
        if location_id == '' or destination == '':
            ...
            requirement_item_link_submit = object_assignment(change_user=(request.user),
...
def requirement_link_list(request, requirement_id):
    ...
    requirement_item_results = object_assignment.objects.filter(is_deleted='FALSE',
