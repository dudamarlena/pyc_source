...
class AllResourcesRemoved(Exception):
    __doc__ = ' Raised when all recources in the pool have been removed.\n    '


class ObjectAlreadyInPool(Exception):
    __doc__ = ' Raised when adding an object that is already in the pool.\n    '


class ObjectNotInPool(Exception):
    __doc__ = ' Raise when operations are performed for an object that is\n    not part of the resource pool.\n    '
