...
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/swf/layer1.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 63928 bytes
import time, boto
...
class Layer1(AWSAuthConnection):
    ...
    _fault_excp = {'com.amazonaws.swf.base.model#DomainAlreadyExistsFault': swf_exceptions.SWFDomainAlreadyExistsError, 
     'com.amazonaws.swf.base.model#LimitExceededFault': swf_exceptions.SWFLimitExceededError, 
     'com.amazonaws.swf.base.model#OperationNotPermittedFault': swf_exceptions.SWFOperationNotPermittedError, 
     'com.amazonaws.swf.base.model#TypeAlreadyExistsFault': swf_exceptions.SWFTypeAlreadyExistsError, 
    ...
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None, is_secure=True, port=None, proxy=None, proxy_port=None, debug=0, session_token=None, region=None, profile_name=None):
        if not region:
            region_name = boto.config.get('SWF', 'region', self.DefaultRegionName)
        ...
        self.region = region
        super(Layer1, self).__init__(self.region.endpoint, aws_access_key_id, aws_secret_access_key, is_secure, port, proxy, proxy_port, debug, session_token, profile_name=profile_name)
    ...
    def make_request(self, action, body='', object_hook=None):
        ...
        """
        headers = {'X-Amz-Target': '%s.%s' % (self.ServiceName, action),  'Host': self.region.endpoint, 
    ...
    def poll_for_activity_task(self, domain, task_list, identity=None):
        ...
        """
        return self.json_request('PollForActivityTask', {'domain': domain, 
         'taskList': {'name': task_list},  'identity': identity})
    ...
    def respond_activity_task_completed(self, task_token, result=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RespondActivityTaskCompleted', {'taskToken': task_token, 
         'result': result})
    ...
    def respond_activity_task_failed(self, task_token, details=None, reason=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RespondActivityTaskFailed', {'taskToken': task_token, 
         'details': details, 
         'reason': reason})
    ...
    def respond_activity_task_canceled(self, task_token, details=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RespondActivityTaskCanceled', {'taskToken': task_token, 
         'details': details})
    ...
    def record_activity_task_heartbeat(self, task_token, details=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RecordActivityTaskHeartbeat', {'taskToken': task_token, 
         'details': details})
    ...
    def poll_for_decision_task(self, domain, task_list, identity=None, maximum_page_size=None, next_page_token=None, reverse_order=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('PollForDecisionTask', {'domain': domain, 
         'taskList': {'name': task_list},  'identity': identity, 
    ...
    def respond_decision_task_completed(self, task_token, decisions=None, execution_context=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RespondDecisionTaskCompleted', {'taskToken': task_token, 
         'decisions': decisions, 
    ...
    def request_cancel_workflow_execution(self, domain, workflow_id, run_id=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RequestCancelWorkflowExecution', {'domain': domain, 
    ...
    def start_workflow_execution(self, domain, workflow_id, workflow_name, workflow_version, task_list=None, child_policy=None, execution_start_to_close_timeout=None, input=None, tag_list=None, task_start_to_close_timeout=None):
        ...
        """
        return self.json_request('StartWorkflowExecution', {'domain': domain, 
         'workflowId': workflow_id, 
         'workflowType': {'name': workflow_name,  'version': workflow_version}, 
         'taskList': {'name': task_list},  'childPolicy': child_policy, 
    ...
    def signal_workflow_execution(self, domain, signal_name, workflow_id, input=None, run_id=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('SignalWorkflowExecution', {'domain': domain, 
    ...
    def terminate_workflow_execution(self, domain, workflow_id, child_policy=None, details=None, reason=None, run_id=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('TerminateWorkflowExecution', {'domain': domain, 
         'workflowId': workflow_id, 
    ...
    def register_activity_type(self, domain, name, version, task_list=None, default_task_heartbeat_timeout=None, default_task_schedule_to_close_timeout=None, default_task_schedule_to_start_timeout=None, default_task_start_to_close_timeout=None, description=None):
        ...
        """
        return self.json_request('RegisterActivityType', {'domain': domain, 
         'name': name, 
         'version': version, 
         'defaultTaskList': {'name': task_list},  'defaultTaskHeartbeatTimeout': default_task_heartbeat_timeout, 
    ...
    def deprecate_activity_type(self, domain, activity_name, activity_version):
        ...
        """
        return self.json_request('DeprecateActivityType', {'domain': domain, 
    ...
    def register_workflow_type(self, domain, name, version, task_list=None, default_child_policy=None, default_execution_start_to_close_timeout=None, default_task_start_to_close_timeout=None, description=None):
        ...
        :raises: SWFTypeAlreadyExistsError, SWFLimitExceededError,
            UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('RegisterWorkflowType', {'domain': domain, 
         'name': name, 
         'version': version, 
         'defaultTaskList': {'name': task_list},  'defaultChildPolicy': default_child_policy, 
    ...
    def deprecate_workflow_type(self, domain, workflow_name, workflow_version):
        ...
        :raises: UnknownResourceFault, TypeDeprecatedFault,
            SWFOperationNotPermittedError
        """
        return self.json_request('DeprecateWorkflowType', {'domain': domain, 
         'workflowType': {'name': workflow_name,  'version': workflow_version}})
    ...
    def register_domain(self, name, workflow_execution_retention_period_in_days, description=None):
        ...
        :raises: SWFDomainAlreadyExistsError, SWFLimitExceededError,
            SWFOperationNotPermittedError
        """
        return self.json_request('RegisterDomain', {'name': name, 
    ...
    def list_activity_types(self, domain, registration_status, name=None, maximum_page_size=None, next_page_token=None, reverse_order=None):
        ...
        """
        return self.json_request('ListActivityTypes', {'domain': domain, 
         'name': name, 
    ...
    def describe_activity_type(self, domain, activity_name, activity_version):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('DescribeActivityType', {'domain': domain, 
         'activityType': {'name': activity_name,  'version': activity_version}})
    ...
    def list_workflow_types(self, domain, registration_status, maximum_page_size=None, name=None, next_page_token=None, reverse_order=None):
        ...
        :raises: SWFOperationNotPermittedError, UnknownResourceFault
        """
        return self.json_request('ListWorkflowTypes', {'domain': domain, 
         'name': name, 
         'registrationStatus': registration_status, 
         'maximumPageSize': maximum_page_size, 
         'nextPageToken': next_page_token, 
    ...
    def describe_workflow_type(self, domain, workflow_name, workflow_version):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('DescribeWorkflowType', {'domain': domain, 
         'workflowType': {'name': workflow_name,  'version': workflow_version}})
    ...
    def describe_workflow_execution(self, domain, run_id, workflow_id):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('DescribeWorkflowExecution', {'domain': domain, 
         'execution': {'runId': run_id,  'workflowId': workflow_id}})
    ...
    def get_workflow_execution_history(self, domain, run_id, workflow_id, maximum_page_size=None, next_page_token=None, reverse_order=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('GetWorkflowExecutionHistory', {'domain': domain, 
         'execution': {'runId': run_id,  'workflowId': workflow_id}, 
         'maximumPageSize': maximum_page_size, 
         'nextPageToken': next_page_token, 
         'reverseOrder': reverse_order})
    ...
    def count_open_workflow_executions(self, domain, latest_date, oldest_date, tag=None, workflow_id=None, workflow_name=None, workflow_version=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('CountOpenWorkflowExecutions', {'domain': domain, 
         'startTimeFilter': {'oldestDate': oldest_date,  'latestDate': latest_date}, 
         'typeFilter': {'name': workflow_name,  'version': workflow_version}, 
         'executionFilter': {'workflowId': workflow_id},  'tagFilter': {'tag': tag}})
    ...
    def list_open_workflow_executions(self, domain, oldest_date, latest_date=None, tag=None, workflow_id=None, workflow_name=None, workflow_version=None, maximum_page_size=None, next_page_token=None, reverse_order=None):
        ...
        """
        return self.json_request('ListOpenWorkflowExecutions', {'domain': domain, 
         'startTimeFilter': {'oldestDate': oldest_date,  'latestDate': latest_date}, 
         'tagFilter': {'tag': tag},  'typeFilter': {'name': workflow_name,  'version': workflow_version}, 
         'executionFilter': {'workflowId': workflow_id},  'maximumPageSize': maximum_page_size, 
         'nextPageToken': next_page_token, 
         'reverseOrder': reverse_order})
    ...
    def count_closed_workflow_executions(self, domain, start_latest_date=None, start_oldest_date=None, close_latest_date=None, close_oldest_date=None, close_status=None, tag=None, workflow_id=None, workflow_name=None, workflow_version=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('CountClosedWorkflowExecutions', {'domain': domain, 
         'startTimeFilter': {'oldestDate': start_oldest_date,  'latestDate': start_latest_date}, 
         'closeTimeFilter': {'oldestDate': close_oldest_date,  'latestDate': close_latest_date}, 
         'closeStatusFilter': {'status': close_status},  'tagFilter': {'tag': tag},  'typeFilter': {'name': workflow_name,  'version': workflow_version}, 
    ...
    def list_closed_workflow_executions(self, domain, start_latest_date=None, start_oldest_date=None, close_latest_date=None, close_oldest_date=None, close_status=None, tag=None, workflow_id=None, workflow_name=None, workflow_version=None, maximum_page_size=None, next_page_token=None, reverse_order=None):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('ListClosedWorkflowExecutions', {'domain': domain, 
         'startTimeFilter': {'oldestDate': start_oldest_date,  'latestDate': start_latest_date}, 
         'closeTimeFilter': {'oldestDate': close_oldest_date,  'latestDate': close_latest_date}, 
         'executionFilter': {'workflowId': workflow_id},  'closeStatusFilter': {'status': close_status},  'tagFilter': {'tag': tag},  'typeFilter': {'name': workflow_name,  'version': workflow_version}, 
         'maximumPageSize': maximum_page_size, 
         'nextPageToken': next_page_token, 
         'reverseOrder': reverse_order})
    ...
    def list_domains(self, registration_status, maximum_page_size=None, next_page_token=None, reverse_order=None):
        ...
        """
        return self.json_request('ListDomains', {'registrationStatus': registration_status, 
         'maximumPageSize': maximum_page_size, 
         'nextPageToken': next_page_token, 
         'reverseOrder': reverse_order})
    ...
    def count_pending_decision_tasks(self, domain, task_list):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('CountPendingDecisionTasks', {'domain': domain, 
    ...
    def count_pending_activity_tasks(self, domain, task_list):
        ...
        :raises: UnknownResourceFault, SWFOperationNotPermittedError
        """
        return self.json_request('CountPendingActivityTasks', {'domain': domain, 
         'taskList': {'name': task_list}})