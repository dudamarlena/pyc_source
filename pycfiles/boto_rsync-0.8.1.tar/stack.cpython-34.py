...
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/cloudformation/stack.py
...
class StackEvent(object):
    valid_states = ('CREATE_IN_PROGRESS', 'CREATE_FAILED', 'CREATE_COMPLETE', 'DELETE_IN_PROGRESS',
