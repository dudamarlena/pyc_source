...
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/manage/cmdshell.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 14739 bytes
...
import boto, os, time, shutil, paramiko, socket, subprocess
from boto.compat import StringIO

class SSHClient(object):
    """SSHClient"""

    def __init__(self, server, host_key_file='~/.ssh/known_hosts', uname='root', timeout=None, ssh_pwd=None):
        self.server = server
        self.host_key_file = host_key_file
        self.uname = uname
        self._timeout = timeout
        self._pkey = paramiko.RSAKey.from_private_key_file(server.ssh_key_file, password=ssh_pwd)
...
class LocalClient(object):
    ...
    def run(self):
        ...
        return (
         process.returncode, log_fp.getvalue())
