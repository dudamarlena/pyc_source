...
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/boto/dynamodb2/items.py
# Compiled at: 2015-11-24 05:02:18
# Size of source mod 2**32: 14658 bytes
...
class Item(object):
    ...
    def _determine_alterations(self):
        ...
        """
        alterations = {'adds': {},  'changes': {},  'deletes': []}
    ...
    def build_expects(self, fields=None):
        ...
        for key in fields:
            ...
            value = None
            if key not in self._orig_data and key not in self._data:
