    ...
    def initialize(cls):
        ...
        for callback_name in tpDcc.callbacks():
            ...
            if not callback_class:
                ...
                LOGGER.warning('Dcc {} does not provides an ICallback for {}Callback. Using {} instead'.format(tpDcc.Dcc.get_name(), callback_name, callback_class.__name__))
