...
# [GCC 8.4.0]
# Embedded file name: /home/nikhila/mp_projs/pj/pj/django_web_profiler/management/commands/logging_urls.py
# Compiled at: 2017-06-05 09:20:54
    ...
    def handle(self, *args, **options):
        ...
        for url in settings.URLS:
            ...
            if settings.DEBUG:
                ...
                ProfileLogRecord.objects.create(profile_log=profile_log, request_path=statistics['path'], ip_address=statistics['ip_address'], device=statistics['device'], timer_utime=statistics['user_cpu_time'], timer_stime=statistics['system_cpu_time'], timer_cputime=statistics['total_cpu_time'], sql_num_queries=statistics['num_queries'], sql_time=statistics['sql_total_time'], sql_queries=statistics['num_queries'], cache_num_calls=statistics['cache_total_calls'], cache_time=statistics['cache_total_time'], cache_hits=statistics['cache_hits'], cache_misses=statistics['cache_misses'], cache_sets=cache_calls['set'], cache_gets=cache_calls['get'], cache_get_many=cache_calls['get_many'], cache_deletes=cache_calls['delete'], cache_calls=statistics['cache_total_calls'])
            else:
                ...
                ProfileLogRecord.objects.create(profile_log=profile_log, request_path=statistics['path'], ip_address=statistics['ip_address'], device=statistics['device'], timer_utime=statistics['user_cpu_time'], timer_stime=statistics['system_cpu_time'], timer_cputime=statistics['total_cpu_time'])
