...
# Embedded file name: build/bdist.linux-x86_64/egg/columnize.py
# Compiled at: 2020-04-16 20:43:19
__doc__ = 'Return compact set of columns as a string with newlines for an\narray of strings.\n\nAdapted from the routine of the same name inside cmd.py'
import os
try:
...
default_opts = {'arrange_array': False, 
...
if __name__ == '__main__':
    ...
    data = ('one', 'two', 'three', 'for', 'five', 'six', 'seven', 'eight', 'nine',
    ...
    print columnize(data, displaywidth=39, ljust=False, arrange_vertical=False, colsep=', ')
    print columnize(data, displaywidth=39, ljust=False, arrange_vertical=False, colsep=', ', lineprefix='    ')
    import sys
    try:
        print columnize(5)
    except TypeError:
