...
# [GCC 8.4.0]
# Embedded file name: /Users/eytan/Envs/docstring/lib/python2.7/site-packages/docstring/djangodoc.py
# Compiled at: 2012-11-05 10:34:24
...
class document(object):
    ...
    def __call__(self, fn):
        ...
        def wrapped_f(*args, **kwargs):
            request = args[0]
            if self._param and request.GET.get(self._param, None) or not self._param and not request.GET.keys():
