...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/progrid/demo.py
# Compiled at: 2015-03-09 18:13:26
import sys
...
SIZE = [
 Config.getint('graphics', 'width'), Config.getint('graphics', 'height')]
...
class TestApp(App):
    ...
    def build(self):
        ...
        columns = [
         'surname', 'name', 'birth', 'sample']
        row_filters = {'name': lambda n: n.startswith('M')}
        row_filters_names = {'name': "Nomi che iniziano con la 'M'"}
        row_sorting = [['surname', 'asc']]
        grid = ProGrid(headers=headers, data=data, columns=columns, row_filters=row_filters, row_sorting=row_sorting, size_hint=(1,
                                                                                                                                 1), pos=(0,
                                                                                                                                          0))
