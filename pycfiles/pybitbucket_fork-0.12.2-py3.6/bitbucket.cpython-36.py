...
class BitbucketError(HTTPError):
    __doc__ = 'Raise when Bitbucket has an HTTP error.'
...
class BadRequestError(BitbucketError):
    __doc__ = 'Raise when Bitbucket complains about a bad request.'
...
class ServerError(BitbucketError):
    __doc__ = 'Raise when Bitbucket complains about a server error.'
