...
class TimeoutError(Exception):
    __doc__ = 'Py3 shim, represents no response from a syscall.\n    '


class NoMessage(Exception):
    __doc__ = 'Exception for a lack of message from a Node.\n    '


class NoNode(Exception):
    __doc__ = 'A node was expected, but could not be found in time.\n    '
...
class MockPublisher(object):
    __doc__ = 'Mock of a node object for testing.\n    '
...
class MockSubscriber(object):
    __doc__ = 'Wrapper around a node used for testing.\n    '
