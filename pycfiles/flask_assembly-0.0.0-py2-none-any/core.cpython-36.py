...
# Compiled at: 2019-10-27 01:08:27
# Size of source mod 2**32: 32669 bytes
"""
core.py
...
class Flasik(object):
    ...
    assets = None
    _ext = set()
    _Flasik__special_methods = ['get', 'put', 'patch', 'post', 'delete', 'index']
    _app = None
    _init_apps = set()
    _template_paths = set()
    _static_paths = set()
            ...
            for name, value in get_interesting_members(Flasik, cls):
                ...
                try:
                    if hasattr(value, '_rule_cache') and name in value._rule_cache:
                        ...
                        if name in cls._Flasik__special_methods:
