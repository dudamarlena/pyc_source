...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/harambe/harambe/extras/harambe_db.py
# Compiled at: 2017-03-18 19:01:28
"""
...
import sqlalchemy_utils as sa_utils, flask_cloudy

class HarambeDB(active_alchemy.ActiveAlchemy):
    """
...
class StorageObject(dict):
    ...
    def __getattr__(self, item):
        ...
        if not self._storage_loaded:
            from harambe.ext import storage
