...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/Flasik/flasik/response.py
...
import flask_cors
from .core import Flasik, apply_function_to_members, build_endpoint_route_name
...
def cors(*args, **kwargs):
    ...
    **An extra note about cors, a response must be available before the
    ...
    def decorator(fn):
        cors_fn = (flask_cors.cross_origin)(args, automatic_options=True, **kwargs)
