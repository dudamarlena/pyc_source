...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/Flasik/flasik/ext.py
# Compiled at: 2019-08-23 13:46:55
"""
Extensions
"""
...
from . import Flasik, init_app, utils, exceptions, g, config, signals
    ...
    def send(self, to, subject=None, body=None, reply_to=None, template=None, **kwargs):
        ...
        if not isinstance(to, list):
            ...
            kwargs.update({'subject': subject, 
               'body': body, 
               'reply_to': reply_to})
            raise (self.validated or exceptions.FlasikError)('Mail configuration error')
