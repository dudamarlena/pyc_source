...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/pyogp/apps/examples/object_create_upload_via_caps.py
...
def login():
    ...
    script = matches.pop()
    client.inventory.create_new_item(folder, 'TestNote', 'created by PyOGP', AssetType.Notecard, InventoryType.Notecard, WearablesIndex.WT_SHAPE, 0, lambda item: client.asset_manager.upload_notecard_via_caps(item.ItemID, 'This is a test of the emergency notecard system.'))
