...
# [GCC 8.4.0]
# Embedded file name: /home/jmc/projects/django-monkey-team/tests/test_project/settings.py
# Compiled at: 2013-03-07 07:10:35
import os
...
INSTALLED_APPS = ('django.contrib.auth', 'django.contrib.contenttypes', 'django.contrib.sessions',
                  ...
                  'django.contrib.admin', 'django.contrib.admindocs', 'monkey_team')
SITE_ID = 1
...
LOGGING = {'version': 1, 
   ...
   'formatters': {'verbose': {'format': '[%(asctime)s: %(levelname)s/%(processName)s/%(process)s] %(name)s - %(message)s \t\t\t in %(funcName)s@%(pathname)s:%(lineno)d'}}, 
