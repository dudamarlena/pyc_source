...
# [GCC 8.4.0]
# Embedded file name: /Users/asyncee/github/django-easy-select2/easy_select2/widgets.py
# Compiled at: 2018-04-13 12:07:09
# Size of source mod 2**32: 3719 bytes
import json, django
from django import forms
from django.conf import settings
from django.utils.safestring import mark_safe
SELECT2_JS = getattr(settings, 'SELECT2_JS', 'easy_select2/vendor/select2/js/select2.min.js')
SELECT2_CSS = getattr(settings, 'SELECT2_CSS', 'easy_select2/vendor/select2/css/select2.min.css')
...
class Select2Mixin(object):
    ...
    def __init__(self, select2attrs=None, *args, **kwargs):
        ...
        assert isinstance(self.select2attrs, dict), assert_msg.format(self.select2attrs.__class__.__name__)
    ...
    def render_select2_options_code(self, options, id_):
        ...
        for key, value in options.items():
            ...
            output.append("data-{name}='{value}'".format(name=key,
...
class Select2(Select2Mixin, forms.Select):
    __doc__ = 'Implement single-valued select widget with Select2.'


class Select2Multiple(Select2Mixin, forms.SelectMultiple):
    __doc__ = 'Implement multiple select widget with Select2.'