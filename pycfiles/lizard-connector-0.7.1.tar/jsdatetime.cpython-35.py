...
# [GCC 8.4.0]
# Embedded file name: /home/roel.vandenberg/dev/lizard-connector/lizard_connector/jsdatetime.py
...
def round_js_to_date(js_datetime):
    ...
    round_datetime = dt.datetime.combine(date_time.date(), dt.datetime.min.time())
