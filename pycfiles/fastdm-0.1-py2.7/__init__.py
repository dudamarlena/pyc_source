...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fastdm/__init__.py
# Compiled at: 2014-11-12 07:46:28
import subprocess, os, logging, glob, pandas
...
class FastDM:
    ...
    def __init__(self, dataframe, zr=0.5, data_file_template='data_%s.csv', config_file_template='experiment_%s.ctl', parameter_file_template='parameter_%s.lst', method='ks', depends_on={}, verbose=logging.INFO):
    ...
    def get_parameters(self):
        ...
        return FastDMResult.from_parameter_files(parameter_files, self.dataframe, self.depends_on)


class FastDMResult:

    def __init__(self, parameters, dataframe, depends_on={}):
        self.parameters = parameters
        self.dataframe = dataframe
        self.depends_on = depends_on

    @classmethod
    def from_parameter_files(self, parameter_files, dataframe, depends_on={}):
    ...
    def melted_parameters(self, parameter):
        ...
        melted_pars = pandas.melt(self.parameters, id_vars='subj_idx', value_vars=columns, value_name=parameter)
