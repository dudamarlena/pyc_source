...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/site-packages/stock/signals.py
# Compiled at: 2017-01-29 10:06:25
...
def get_signals():
    return [
     'rolling_mean', 'rsi', 'min_low', 'macd_signal']
