...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/site-packages/stock/simulate.py
# Compiled at: 2017-01-29 09:16:57
...
class Simulator(object):
    ...
    def __init__(self, series, timing, lostcut=3):
        self.series = series
        self.timing = timing
...
class RollingMean(SignalLine):
    ...
    @property
    def df(self):
        return pd.concat({'series': self.series, 
...
class MACD(SignalLine):
    ...
    def df(self):
        return pd.concat({'series': self.series, 
         'macd': self.macd, 
         'signal': self.signal_line}, axis=1)
