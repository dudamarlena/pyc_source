...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/site-packages/stock/cli/import_company.py
# Compiled at: 2017-01-29 03:37:15
...
class Reader(object):
    ...
    def iter(self):
        for d in self.sheet.T.to_dict().values():
            yield {k:v for k, v in d.items() if k in models.Company.__dict__ if k in models.Company.__dict__}
