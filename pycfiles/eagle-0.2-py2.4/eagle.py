...
# Compiled at: 2006-01-07 10:22:11
...
__all__ = [
 'run', 'quit', 'get_value', 'set_value', 'get_app_by_id', 'get_widget_by_id', 'show', 'hide', 'set_active', 'set_inactive', 'close', 'App', 'Entry', 'Password', 'Spin', 'IntSpin', 'UIntSpin', 'CheckBox', 'Progress', 'Color', 'Font', 'Button', 'AboutButton', 'CloseButton', 'QuitButton', 'HelpButton', 'OpenFileButton', 'SelectFolderButton', 'SaveFileButton', 'PreferencesButton', 'Selection', 'Group', 'HSeparator', 'VSeparator', 'Label', 'Canvas', 'Image', 'information', 'info', 'error', 'err', 'warning', 'warn', 'yesno', 'confirm']
import os, sys, gc, cPickle as pickle
try:
    import pygtk
    pygtk.require('2.0')
...
class App(_EGObject, AutoGenId):
    ...
    def __init__(self, title, id=None, center=None, left=None, right=None, top=None, bottom=None, preferences=None, quit_callback=None, data_changed_callback=None, author=None, description=None, help=None, version=None, license=None, copyright=None, statusbar=False):
        """App Constructor.
    ...
    def __setup_gui__(self):
        ...
        if self._top.__get_widgets__():
            ...
            if self._center.__get_widgets__() or self._bottom.__get_widgets__():
                self._vbox.pack_start(gtk.HSeparator(), expand=False, fill=True)
        ...
        if self._left.__get_widgets__():
            ...
            if self._center.__get_widgets__() or self._top.__get_widgets__() or self._bottom.__get_widgets__() or self._right.__get_widgets__():
                self._hbox.pack_start(gtk.VSeparator(), expand=False, fill=False)
        self._hbox.pack_start(self._vbox, expand=True, fill=True)
        if self._right.__get_widgets__():
            if self._center.__get_widgets__() or self._top.__get_widgets__() or self._bottom.__get_widgets__():
                self._hbox.pack_start(gtk.VSeparator(), expand=False, fill=False)
...
class Canvas(_EGWidget):
    ...
    def __init__(self, id, width, height, label='', bgcolor=None, callback=None):
        """Canvas Constructor.
...
class Entry(_EGWidLabelEntry):
    ...
    def __init__(self, id, label='', value='', callback=None, persistent=False, multiline=False):
        """Entry constructor.
    ...
    def __get_resize_mode__(self):
        ...
        if self.multiline:
            return (
             (
              gtk.FILL, gtk.FILL | gtk.EXPAND), (gtk.FILL, gtk.FILL | gtk.EXPAND))
        else:
            return (
             (
              gtk.FILL, gtk.FILL | gtk.EXPAND), (gtk.FILL, gtk.FILL))
...
class Password(Entry):
    ...
    def __init__(self, id, label='', value='', callback=None, persistent=False):
...
class Spin(_EGWidLabelEntry):
    ...
    def __init__(self, id, label='', value=None, min=None, max=None, step=None, digits=3, callback=None, persistent=False):
        """Spin constructor.
...
class IntSpin(Spin):
    ...
    def __init__(self, id, label='', value=None, min=None, max=None, step=None, callback=None, persistent=False):
        ...
        if step is not None:
            step = int(step)
        Spin.__init__(self, id, label, value, min, max, step, 0, callback, persistent)
        return
...
class UIntSpin(IntSpin):
    ...
    def __init__(self, id, label='', value=None, min=0, max=None, step=None, callback=None, persistent=False):
...
class Color(_EGWidLabelEntry):
    ...
    def __init__(self, id, label='', color=0, use_alpha=False, callback=None, persistent=False):
...
class Font(_EGWidLabelEntry):
    ...
    def __init__(self, id, label='', font='sans 12', callback=None, persistent=False):
...
class Selection(_EGWidLabelEntry):
    ...
    def __init__(self, id, label='', options=None, active=None, callback=None, persistent=False):
...
class CheckBox(_EGDataWidget):
    ...
    def __init__(self, id, label='', state=False, callback=None, persistent=False):
...
class Group(_EGWidget):
    ...
    def __setup_gui__(self):
        ...
        self._contents = _Table(id='%s-contents' % self.id, children=self.children)
...
class AboutButton(Button, AutoGenId):
    ...
    def __init__(self, id=None):
        ...
        Button.__init__(self, id or self.__get_id__(), stock='about', callback=show_about)
...
class CloseButton(Button, AutoGenId):
    ...
    def __init__(self, id=None):
        ...
        Button.__init__(self, id or self.__get_id__(), stock='close', callback=close)
...
class QuitButton(Button, AutoGenId):
    ...
    def __init__(self, id=None):
        ...
        Button.__init__(self, id or self.__get_id__(), stock='quit', callback=c)
...
class HelpButton(Button, AutoGenId):
    ...
    def __init__(self, id=None):
        ...
        Button.__init__(self, id or self.__get_id__(), stock='help', callback=c)
...
class OpenFileButton(Button, AutoGenId):
    ...
    def __init__(self, id=None, filter=None, multiple=False, callback=None):
        """Constructor.
        ...
        Button.__init__(self, id or self.__get_id__(), stock='open', callback=c)
...
class SaveFileButton(Button, AutoGenId):
    ...
    def __init__(self, id=None, filename=None, filter=None, callback=None):
        """Constructor.
        ...
        Button.__init__(self, id or self.__get_id__(), stock='save', callback=c)
...
class Label(_EGDataWidget, AutoGenId):
    ...
    def __init__(self, id=None, label='', halignment=LEFT, valignment=MIDDLE):
        """Label constructor.
