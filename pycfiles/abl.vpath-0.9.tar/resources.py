...
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/abl/jquery/ui/resources.py
...
CSS_NAMES = [
 'base', 'accordion', 'core', 'datepicker', 'dialog', 'progressbar', 'resizable',
...
ui_core_js = JSLink(filename=collect_variants('jquery.ui.core.js'), javascript=[
 jquery_js], css=[
 ui_theme_css, ui_base_css, ui_core_css], modname=modname)
ui_accordion_js = JSLink(filename=collect_variants('jquery.ui.accordion.js'), javascript=[ui_core_js], modname=modname, css=[
 ui_accordion_css])
ui_datepicker_js = JSLink(filename=collect_variants('jquery.ui.datepicker.js'), javascript=[ui_core_js], modname=modname, css=[ui_datepicker_css])
...
ui_button_js = JSLink(filename=collect_variants('jquery.ui.button.js'), javascript=[
 ui_core_js,
 ui_widget_js], css=[
 ui_dialog_css], modname=modname)
ui_mouse_js = JSLink(filename=collect_variants('jquery.ui.mouse.js'), javascript=[
 ui_core_js,
 ui_widget_js], css=[
 ui_dialog_css], modname=modname)
ui_draggable_js = JSLink(filename=collect_variants('jquery.ui.draggable.js'), javascript=[
 ui_core_js,
 ui_mouse_js], modname=modname)
ui_resizable_js = JSLink(filename=collect_variants('jquery.ui.resizable.js'), javascript=[
 ui_core_js,
 ui_mouse_js], modname=modname, css=[ui_resizable_css])
ui_dialog_js = JSLink(filename=collect_variants('jquery.ui.dialog.js'), javascript=[
 ui_core_js,
 ui_button_js,
 ui_draggable_js,
 ui_position_js,
 ui_resizable_js], css=[
 ui_dialog_css], modname=modname)
ui_autocomplete_js = JSLink(filename=collect_variants('jquery.ui.autocomplete.js'), javascript=[
 ui_core_js,
 ui_widget_js,
 ui_position_js], css=[
 ui_autocomplete_css], modname=modname)
ui_autocomplete_callbacks_js = JSLink(filename='static/javascript/ui.autocomplete.callbacks.js', javascript=[
 ui_autocomplete_js], modname=modname)
