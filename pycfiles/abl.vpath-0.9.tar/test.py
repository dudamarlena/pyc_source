...
# Embedded file name: build/bdist.linux-i686/egg/abl/robot/test.py
# Compiled at: 2012-09-17 04:19:07
...
class RobotTestCase(unittest.TestCase):
    ...
    def get_messages(cls):
        if interface and interface.manager and interface.manager.transport:
            return interface.manager.transport.get_sent_mails()
        else:
            return []
    ...
    def start_robot(self, opts={}, threaded=False, nomail=False, norun=False, config=None, commands=None, robot_class=None):
        """
