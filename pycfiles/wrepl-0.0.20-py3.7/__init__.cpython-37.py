...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wrepl/__init__.py
# Compiled at: 2019-11-05 22:53:50
...
def parse() -> int:
    ...
    parser.add_argument('file', metavar='file', type=str, nargs=1, help='watcing this')
    parser.add_argument('--filetype', metavar='filetype', type=str, nargs=1, help='only python3 is supported now')
