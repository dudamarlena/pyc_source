...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wrepl/watcher.py
# Compiled at: 2019-11-05 22:24:37
...
class Watcher(PatternMatchingEventHandler):
    ...
    def on_modified(self, evt):
        ...
        text = y + normalizeText(startLabel) + normalizeText(sout, '{}1 '.format(self.ft['comment'])) + normalizeText(serr, '{}2 '.format(self.ft['comment'])) + normalizeText(finishLabel)
    ...
    def run(self, y):
        ...
        repl = subprocess.Popen((self.ft['executable']), shell=True, stdin=(subprocess.PIPE),
