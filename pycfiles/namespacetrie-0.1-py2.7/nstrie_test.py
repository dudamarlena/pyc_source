...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/nstrie_test.py
# Compiled at: 2012-05-06 16:35:00
...
class StringTestCase(unittest.TestCase):
    ...
    def test_weakrefable(self):
        ...
        try:
            ...
            self.fail('Creating a weak reference of String should not throw a TypeError')
...
class NsTrieTestCase(unittest.TestCase):
    ...
    def test_add(self):
        ...
        expected = {'com': {'example': {'foo': 'com.example.foo'}}}
    ...
    def test_iter(self):
        ...
        self.assertListEqual(actual, expected, msg='iteration should be in insertion order and depth first')
    ...
    def test_iterdepth(self):
        ...
        self.assertListEqual(actual, expected, msg='iterdepth should behave exactly the same as default iteration')
    ...
    def test_iterbreadth(self):
        ...
        self.assertListEqual(actual, expected, msg='breadth first iteration should be level-wise and respect insertion order')
    ...
    def test_child_nodes(self):
        ...
        self.assertSetEqual(expected, trie.child_nodes, msg='Manipulating the returnvalue of child_nodes must not alter the underlying object from NsTrie')
    ...
    def test_to_dict(self):
        trie = NsTrie(('com.example.foo', 'org.example.foo', 'org.example.bar', 'com.foo.Baz'))
        expected = {'com': {'example': {'foo': 'com.example.foo'}, 
                   'foo': {'Baz': 'com.foo.Baz'}}, 
    ...
    def test_sorted(self):
        ...
        expected = [
         ...
         'com.example.foo.Bar',
         'com.example.baz.Boo']
        sorted_by_depth_with_depth = sorted(trie.iterdepth(), key=lambda s: s.count('.'))
        sorted_by_depth_with_breadth = sorted(trie.iterbreadth(), key=lambda s: s.count('.'))
        self.assertEqual(expected, sorted_by_depth_with_depth)
        self.assertListEqual(sorted_by_depth_with_depth, sorted_by_depth_with_breadth)
        expected = [
         'com',
         'com.example',
         'com.example.Baz',
