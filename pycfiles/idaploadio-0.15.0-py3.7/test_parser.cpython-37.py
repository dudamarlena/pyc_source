...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/idapload/test/test_parser.py
# Compiled at: 2020-04-13 02:37:12
# Size of source mod 2**32: 5191 bytes
import unittest, os, tempfile, mock
...
class TestParser(unittest.TestCase):
    ...
    def test_parameter_parsing(self):
        ...
        self.assertEqual(options.host, 'host_from_args')
