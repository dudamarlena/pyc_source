...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/idapload/test/test_client.py
# Compiled at: 2020-04-13 02:37:12
# Size of source mod 2**32: 4538 bytes
...
class TestHttpSession(WebserverTestCase):
    ...
    def get_client(self, base_url=None):
        ...
        return HttpSession(base_url=base_url,
    ...
    def test_options(self):
        ...
        self.assertEqual(200, r.status_code)
        self.assertEqual('', r.content.decode())
        self.assertEqual(set(['OPTIONS', 'DELETE', 'PUT', 'GET', 'POST', 'HEAD', 'PATCH']), set(r.headers['allow'].split(', ')))
