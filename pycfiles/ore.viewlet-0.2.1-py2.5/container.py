...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/ore/viewlet/container.py
...
class ContainerViewlet(ComponentViewlet, BaseFormViewlet):
    ...
    def listing(self):
        ...
        formatter = self.formatter_factory(self.container, self.request, self.container.values(), prefix='form', visible_column_names=[ c.name for c in columns ], columns=columns)
