...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snmpresponder/daemon.py
...
if sys.platform[:3] == 'win':
    ...
    def daemonize(pidfile):
        ...
        try:
            ...
            raise error.SnmpResponderError('Failed to create PID file %s: %s' % (pidfile, sys.exc_info()[1]))
    ...
    class PrivilegesOf(object):
        ...
        def __enter__(self):
            ...
            try:
                ...
                raise error.SnmpResponderError('getpwnam()/getgrnam() failed for %s/%s: %s' % (
            ...
            try:
                ...
                raise error.SnmpResponderError('%s failed for %s/%s: %s' % (
        ...
        def __exit__(self, *args):
            if self._olduid is None or self._oldgid is None:
                ...
                try:
                    ...
                    raise error.SnmpResponderError('setegid()/seteuid() failed for %s/%s: %s' % (
