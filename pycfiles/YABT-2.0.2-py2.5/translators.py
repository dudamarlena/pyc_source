...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/YABT/translators.py
...
class Translator(BaseTranslator):
    ...
    def translate(self, text, state, bfcontext=' ', afcontext=' '):
        ...
        fullText = ('').join([bfcontext, text, afcontext])
...
class BufferedTranslator(Translator):
    ...
    def translate(self, text, state, bfcontext=' ', afcontext=' '):
        ...
        for afterContext in inputList[2:]:
            output.fromunicode(super(BufferedTranslator, self).translate(translateText, self.state, beforeContext, afterContext))
