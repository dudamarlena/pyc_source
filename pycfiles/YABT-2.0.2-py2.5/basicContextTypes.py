...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/YABT/basicContextTypes.py
...
class ContextFactory:
    ...
    def __init__(self):
        ...
        self._contextTypes = {'^a': (ContextA, ContextA), '^c': (
                ContextCBefore, ContextCAfter), 
           '^t': (
                ContextTBefore, ContextTAfter), 
           '^r': (
                ContextRBefore, ContextRAfter)}
