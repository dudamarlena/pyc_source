...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\lquery\expr\utils.py
# Compiled at: 2018-08-03 16:09:58
# Size of source mod 2**32: 2065 bytes
from typing import Union
from .core import IExpr, ParameterExpr, ConstExpr, ReferenceExpr, AttrExpr, IndexExpr, BinaryExpr, CallExpr, FuncExpr, ValueExpr
...
def get_deep_names(expr: Union[(AttrExpr, IndexExpr)]):
    ...
    while isinstance(cur_expr, (AttrExpr, IndexExpr)):
        if isinstance(cur_expr, AttrExpr):
            ...
            if isinstance(cur_expr.key, ValueExpr):
