...
# [GCC 8.4.0]
# Embedded file name: /home/fraoustin/Workspace/sphinx_fontawesome/sphinx_fontawesome/__init__.py
# Compiled at: 2017-09-24 06:14:58
"""
...
import docutils.parsers.rst.directives as directives, sphinx_fontawesome.constant
__version_info__ = (0, 0, 5)
__version__ = ('.').join([ str(val) for val in __version_info__ ])
sub_special = [{'id': 'o', 'key': 'square-o'}, {'id': 'x', 'key': 'check-square-o'}, {'id': 'smile', 'key': 'smile-o'}, {'id': 'mail', 'key': 'envelope'}, {'id': 'note', 'key': 'info-circle'}]
