...
# [GCC 8.4.0]
# Embedded file name: /Users/amandeep/Github/dig-sandpaper/test/coarse/generate/test_generating.py
...
class TestCoarseGenerating(unittest.TestCase):
    ...
    def _test_helper(self, config_file, queries):
        ...
        generated_queries = [ generator.generate(q) for q in parameterized_queries
                            ]
    ...
    def test_basic_coarse_generating(self):
        ...
        self.assertEqual(where0['clauses'][1]['fields'][0]['name'], 'extractors.content_strict.data_extractors.city.result.value')
        self.assertEqual(where0['clauses'][1]['fields'][0]['weight'], 4)
        self.assertEqual(where1['clauses'][1]['fields'][1]['name'], 'extractors.content_relaxed.data_extractors.city.result.value')
    ...
    def test_basic_coarse_generating_elasticsearch_compiler_no_type_mapping(self):
        ...
        self.assertIn('url', gq['ELASTICSEARCH']['search']['_source']['includes'])
    ...
    def test_basic_coarse_aggregation_step_two(self):
        ...
        self.assertEqual(5, generated_queries[0]['ELASTICSEARCH']['search']['aggs']['?ethnicity']['terms']['size'])
    ...
    def test_basic_coarse_order_by(self):
        self._test_helper('9_config.json', '9_query.json')

    def test_basic_coarse_order_by_step_two(self):
        self._test_helper('9_config_step_two.json', '9_query_step_two.json')

    def test_basic_coarse_rank_scoring_coefficient(self):
        self._test_helper('10_config.json', '10_query.json')

    def test_basic_coarse_rank_scoring_coefficient_step_two(self):
        self._test_helper('10_config_step_two.json', '10_query_step_two.json')
