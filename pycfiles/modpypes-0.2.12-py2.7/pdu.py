...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modpypes/pdu.py
# Compiled at: 2017-05-15 23:51:33
"""
Protocol Data Units
===================
"""
...
class ROCReal(_Struct):
    ...
    def unpack(self, registers):
        ...
        r0, r1 = registers
        r0 = (r0 & 65280) >> 8 | (r0 & 255) << 8
        r1 = (r1 & 65280) >> 8 | (r1 & 255) << 8
...
class MPCI(PCI, DebugContents):
    ...
    """
    _debug_contents = ('mpduTransactionID', 'mpduProtocolID', 'mpduLength', 'mpduUnitID',
                       'mpduFunctionCode')
    readCoils = 1
    ...
    def __init__(self, *args, **kwargs):
        if _debug:
            MPCI._debug('__init__ %r %r', args, kwargs)
...
class ReadBitsRequestBase(MPCI, DebugContents):
    ...
    def encode(self, pdu):
        if _debug:
            ReadBitsRequestBase._debug('encode %r', pdu)
...
class ReadBitsResponseBase(MPCI, DebugContents):
    ...
    def __init__(self, values=None, **kwargs):
        if _debug:
            ReadBitsResponseBase._debug('__init__ %r %r', values, kwargs)
        MPCI.__init__(self, **kwargs)
    ...
    def encode(self, pdu):
        if _debug:
            ReadBitsResponseBase._debug('encode %r', pdu)
        MPCI.update(pdu, self)
...
class ReadRegistersRequestBase(MPCI, DebugContents):
    ...
    def encode(self, pdu):
        if _debug:
            ReadRegistersRequestBase._debug('encode %r', pdu)
        MPCI.update(pdu, self)
        pdu.put_short(self.address)
        pdu.put_short(self.count)
        pdu.mpduLength = len(pdu.pduData) + 2
...
class ReadRegistersResponseBase(MPCI, DebugContents):
    ...
    def __init__(self, values=None, **kwargs):
        if _debug:
            ReadRegistersResponseBase._debug('__init__ %r %r', values, kwargs)
        MPCI.__init__(self, **kwargs)
        if values is not None:
    ...
    def encode(self, pdu):
        if _debug:
            ReadRegistersResponseBase._debug('encode %r', pdu)
        MPCI.update(pdu, self)
...
class ReadWriteValueBase(MPCI, DebugContents):
    ...
    def encode(self, pdu):
        if _debug:
            ReadWriteValueBase._debug('encode %r', pdu)
        MPCI.update(pdu, self)
        pdu.put_short(self.address)
...
class ReadDiscreteInputsRequest(ReadBitsRequestBase):
    ...
    def __init__(self, address=None, count=None, **kwargs):
        if _debug:
            ReadDiscreteInputsRequest._debug('__init__ %r %r %r', address, count, kwargs)
        ReadBitsRequestBase.__init__(self, address, count, **kwargs)
...
class ReadMultipleRegistersRequest(ReadRegistersRequestBase):
    ...
    def __init__(self, address=None, count=None, **kwargs):
        if _debug:
            ReadMultipleRegistersRequest._debug('__init__ %r %r %r', address, count, kwargs)
...
class ReadMultipleRegistersResponse(ReadRegistersResponseBase):
    ...
    def __init__(self, values=None, **kwargs):
        if _debug:
            ReadMultipleRegistersResponse._debug('__init__ %r %r', values, kwargs)
...
class ReadInputRegistersRequest(ReadRegistersRequestBase):
    ...
    def __init__(self, address=None, count=None, **kwargs):
        if _debug:
            ReadInputRegistersRequest._debug('__init__ %r %r %r', address, count, kwargs)
        ReadRegistersRequestBase.__init__(self, address, count, **kwargs)
...
class ReadInputRegistersResponse(ReadRegistersResponseBase):
    ...
    def __init__(self, values=None, **kwargs):
        if _debug:
            ReadInputRegistersResponse._debug('__init__ %r %r', values, kwargs)
        ReadRegistersResponseBase.__init__(self, values, **kwargs)
...
class WriteSingleRegisterRequest(ReadWriteValueBase):
    ...
    def __init__(self, address=None, value=None, **kwargs):
        if _debug:
            WriteSingleRegisterRequest._debug('__init__ %r %r %r', address, value, kwargs)
        ReadWriteValueBase.__init__(self, address, value, **kwargs)
...
class WriteSingleRegisterResponse(ReadWriteValueBase):
    ...
    def __init__(self, address=None, value=None, **kwargs):
        if _debug:
            WriteSingleRegisterResponse._debug('__init__ %r %r %r', address, value, kwargs)
        ReadWriteValueBase.__init__(self, address, value, **kwargs)
...
class WriteMultipleCoilsRequest(MPCI, DebugContents):
    ...
    def __init__(self, address=None, count=None, coils=None, **kwargs):
        if _debug:
            WriteMultipleCoilsRequest._debug('__init__ %r %r %r %r', address, count, coils, kwargs)
        MPCI.__init__(self, **kwargs)
...
class WriteMultipleCoilsResponse(MPCI, DebugContents):
    ...
    def __init__(self, address=None, count=None, **kwargs):
        if _debug:
            WriteMultipleCoilsResponse._debug('__init__ %r %r %r', address, count, kwargs)
        MPCI.__init__(self, **kwargs)
...
class WriteMultipleRegistersRequest(MPCI, DebugContents):
    ...
    def __init__(self, address=None, count=None, registers=None, **kwargs):
        if _debug:
            WriteMultipleRegistersRequest._debug('__init__ %r %r %r %r', address, count, registers, kwargs)
        MPCI.__init__(self, **kwargs)
...
class WriteMultipleRegistersResponse(MPCI, DebugContents):
    ...
    def __init__(self, address=None, count=None, **kwargs):
        if _debug:
            WriteMultipleRegistersResponse._debug('__init__ %r %r %r', address, count, kwargs)
        MPCI.__init__(self, **kwargs)
...
class ReadWriteMultipleRegistersRequest(MPCI, DebugContents):
    ...
    def __init__(self, raddress=None, rcount=None, waddress=None, wcount=None, registers=None, **kwargs):
        if _debug:
            ReadWriteMultipleRegistersRequest._debug('__init__ %r %r %r %r %r %r', raddress, rcount, waddress, wcount, registers, kwargs)
        MPCI.__init__(self, **kwargs)
...
class ReadWriteMultipleRegistersResponse(MPCI, DebugContents):
    ...
    def __init__(self, registers=None, **kwargs):
        if _debug:
            ReadWriteMultipleRegistersResponse._debug('__init__ %r %r', registers, kwargs)
        MPCI.__init__(self, **kwargs)
...
class ExceptionResponse(MPCI, DebugContents):
    ...
    def __init__(self, function=None, exceptionCode=None, **kwargs):
        if _debug:
            ExceptionResponse._debug('__init__ %r %r %r', function, exceptionCode, kwargs)
        MPCI.__init__(self, **kwargs)
    ...
    def encode(self, pdu):
        if _debug:
            ExceptionResponse._debug('encode %r', pdu)
        MPCI.update(pdu, self)
    ...
    def decode(self, pdu):
        if _debug:
            ExceptionResponse._debug('decode %r', pdu)
        MPCI.update(self, pdu)
