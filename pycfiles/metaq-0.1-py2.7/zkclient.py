...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/metaq/zkclient.py
# Compiled at: 2012-04-28 14:01:46
import zookeeper, time, threading
from collections import namedtuple
DEFAULT_TIMEOUT = 30000
VERBOSE = True
ZOO_OPEN_ACL_UNSAFE = {'perms': 31, 'scheme': 'world', 'id': 'anyone'}
STATE_NAME_MAPPING = {zookeeper.ASSOCIATING_STATE: 'associating', 
...
TYPE_NAME_MAPPING = {zookeeper.NOTWATCHING_EVENT: 'not-watching', 
...
class Callback(object):
    ...
    def waitForSuccess(self):
        ...
        if not self.callback_flag == True:
            raise ZKClientError('asynchronous operation timed out on handle %d' % self.handle)
