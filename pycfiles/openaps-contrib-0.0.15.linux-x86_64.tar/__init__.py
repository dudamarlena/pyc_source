...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/openapscontrib/timezones/__init__.py
# Compiled at: 2016-06-06 22:07:24
"""
...
class lsgaps(Use):
    ...
    def get_params(self, args):
        return dict(input=args.input, minutes=args.minutes, date=args.date, before=args.before, after=args.after, timezone=args.timezone, no_timezone=args.no_timezone)
...
class select(Use):
  ...
  """
    ...
    def get_params(self, args):
        return dict(input=args.input, timezone=args.timezone, no_timezone=args.no_timezone, date=args.date, gaps=args.gaps, current=args.current, prev=args.prev)
