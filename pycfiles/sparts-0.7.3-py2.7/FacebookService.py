...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparts/gen/fb303/FacebookService.py
# Compiled at: 2015-08-19 13:55:26
...
class getCpuProfile_args(object):
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'profileDurationInSec', None, None))
    ...
    def __hash__(self):
        value = 17
        value = value * 31 ^ hash(self.profileDurationInSec)
        return value
