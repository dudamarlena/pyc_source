...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparts/sparts.py
...
class option(_Nameable):
    ...
    def __init__(self, name=None, type=None, default=None, help=None, action=None, metavar=None, required=False, choices=None, nargs=None):
    ...
    def _prepareForArgumentParser(self, task_cls):
        ...
        kwargs = dict(default=default, help=self.help, action=self.action, required=self.required)
