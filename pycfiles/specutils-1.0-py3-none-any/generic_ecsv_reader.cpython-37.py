...
# [GCC 8.4.0]
# Embedded file name: /Users/nearl/projects/specutils/build/lib/specutils/io/default_loaders/generic_ecsv_reader.py
...
def identify_ecsv(origin, *args, **kwargs):
    ...
    return isinstance(args[0], str) and os.path.splitext(args[0].lower())[1] == '.ecsv'
