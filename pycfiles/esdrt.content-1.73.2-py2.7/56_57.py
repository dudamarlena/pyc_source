...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/esdrt/content/upgrades/56_57.py
...
WFS = dict(ESDRTFile='esd-file-workflow', Comment='esd-comment-workflow', Question='esd-question-review-workflow')
