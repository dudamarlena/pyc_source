...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/esdrt/content/crons.py
...
class UpdateLDAPUsersVocabulariesCron(BrowserView):
    ...
    def __call__(self):
        logger = logging.getLogger('esdrt.content - update vocabularies cron: ')
