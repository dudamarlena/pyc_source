...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\Products\PloneBooking\content\BookingCenter.py
...
from Products.PloneBooking.content.vocabulary import REQUIRED_FILTERS, CALENDAR_VIEWS, VIEW_MODES, LISTING_VIEWS, GLOBAL_BOOKING_REVIEW_MODES, CALENDAR_REFRESH_MODES
...
BookingCenterSchema = ATFolderSchema.copy() + Schema((LinesField('types', required=True, widget=LinesWidget(label='Types', description='You can define here a list of bookable object types (1 by line)', description_msgid='help_bookingcenter_types', label_msgid='label_bookingcenter_types', i18n_domain=I18N_DOMAIN)), LinesField('categories', required=False, widget=LinesWidget(label='Categories', description=' ', description_msgid='help_bookingcenter_categories', label_msgid='label_bookingcenter_categories', i18n_domain=I18N_DOMAIN)), LinesField('bookableObjectStates', default=('published',), widget=LinesWidget(label='Bookable object allowed states for book', description='Define here the workflow states of bookable objects you can book. If a bookable object is in a workflow                         state that is not in this list, it will not appear in available bookable objects.', label_msgid='label_bookable_object_states', description_msgid='help_bookable_object_states', i18n_domain=I18N_DOMAIN)), LinesField('requiredFilters', vocabulary=REQUIRED_FILTERS, widget=MultiSelectionWidget(default=tuple(), format='select', label='Required filters', description='', label_msgid='label_required_filters', description_msgid='', i18n_domain=I18N_DOMAIN)), StringField('calendarRefreshMode', default='auto', vocabulary=CALENDAR_REFRESH_MODES, widget=SelectionWidget(default=False, label='Refresh mode', description='', label_msgid='label_refresh_mode', description_msgid='', i18n_domain=I18N_DOMAIN)), StringField('bookingReviewMode', default='review', vocabulary=GLOBAL_BOOKING_REVIEW_MODES, widget=SelectionWidget(label='Booking review mode', description='', label_msgid='label_booking_review_mode', description_msgid='', i18n_domain=I18N_DOMAIN)), StringField('defaultViewMode', schemata=DISPLAY_SCHEMATA, required=True, default='calendar', vocabulary=VIEW_MODES, widget=SelectionWidget(format='radio', label='Default view mode', label_msgid='label_bookingcenter_default_view_mode', i18n_domain=I18N_DOMAIN)), LinesField('availableViewModes', schemata=DISPLAY_SCHEMATA, required=True, default=('listing', 'calendar'), vocabulary=VIEW_MODES, widget=MultiSelectionWidget(format='select', label='Available view modes', label_msgid='label_bookingcenter_available_view_modes', i18n_domain=I18N_DOMAIN)), StringField('defaultListingView', schemata=DISPLAY_SCHEMATA, required=True, default='day', vocabulary=LISTING_VIEWS, widget=SelectionWidget(format='select', label='Default listing view', label_msgid='label_bookingcenter_default_listing_view', i18n_domain=I18N_DOMAIN)), LinesField('availableListingViews', schemata=DISPLAY_SCHEMATA, required=True, default=('day', 'week', 'month', 'year'), vocabulary=LISTING_VIEWS, widget=MultiSelectionWidget(format='select', label='Available listing views', label_msgid='label_bookingcenter_available_listing_views', i18n_domain=I18N_DOMAIN)), StringField('defaultCalendarView', schemata=DISPLAY_SCHEMATA, required=True, default='day', vocabulary=CALENDAR_VIEWS, widget=SelectionWidget(format='select', label='Default calendar view', label_msgid='label_bookingcenter_default_calendar_view', i18n_domain=I18N_DOMAIN)), LinesField('availableCalendarViews', schemata=DISPLAY_SCHEMATA, required=True, default=('day', 'week', 'month'), vocabulary=CALENDAR_VIEWS, widget=MultiSelectionWidget(format='select', label='Available calendar views', label_msgid='label_bookingcenter_available_calendar_views', i18n_domain=I18N_DOMAIN)), IntegerField('calendarStartingHour', schemata=DISPLAY_SCHEMATA, required=True, default=8, widget=IntegerWidget(label='Starting hour', description='This is used in day and week calendar views', label_msgid='label_bookingcenter_calendar_starting_hour', description_msgid='help_bookingcenter_calendar_starting_hour', i18n_domain=I18N_DOMAIN)), IntegerField('calendarEndingHour', schemata=DISPLAY_SCHEMATA, required=True, default=19, widget=IntegerWidget(label='Ending hour', description='This is used in day and week calendar views', label_msgid='label_bookingcenter_calendar_ending_hour', description_msgid='help_bookingcenter_calendar_ending_hour', i18n_domain=I18N_DOMAIN))))
...
class BookingCenter(ATFolder):
    ...
    def groupBookingsByIntervalOfMinutes(self, start_date, end_date, interval=30, **kwargs):
        ...
        """
        if interval < 60 and 60 / interval * interval != 60 or interval > 60 and interval / 60 * interval != 60:
