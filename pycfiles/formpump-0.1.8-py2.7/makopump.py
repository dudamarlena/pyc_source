...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/formpump/makopump.py
# Compiled at: 2012-05-16 19:36:00
...
def form(context, **kwargs):
    ...
    form, _mako_settings.form = _mako_settings.form, Form(name, _mako_settings.name_key, _mako_settings.ctx_key, kwargs, _mako_settings.default_form_action, context.get(_mako_settings.value_dict_name, {}), context.get(_mako_settings.error_dict_name, {}))
