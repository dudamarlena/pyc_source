...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\vbox\vm\base.py
...
class VirtualMachinePart(VmElement):
    ...
    def control(self, params, quiet=False):
        newParams = dict((self.getPropName(name), value) for name, value in params.iteritems())
...
class PartGroup(VmElement):
    ...
    def create(self, name, type):
        ...
        self.cli.manage.storagectl(self.vm.id, name, add=type)
