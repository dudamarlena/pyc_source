...
# Size of source mod 2**32: 10505 bytes
""" Meta-analysis tools """
...
def analyze_features(dataset, features=None, image_type='specificity_z', threshold=0.001, q=0.01, output_dir=None, prefix=None):
    ...
    Args:
        ...
        image_type: The type of image to return. Specify one of the extensions
            generated by the MetaAnalysis procedure--e.g., sensitivity_z,
            consistency_z, etc.  By default, will use sensitivity_z (i.e.,
