...
# [GCC 8.4.0]
# Embedded file name: /Users/tal/Dropbox/Code/neurosynth/neurosynth/analysis/meta.py
# Compiled at: 2018-11-26 10:11:25
# Size of source mod 2**32: 10715 bytes
""" Meta-analysis tools """
...
def analyze_features(dataset, features=None, image_type='association-test_z', threshold=0.001, q=0.01, output_dir=None, prefix=None):
...
class MetaAnalysis(object):
    ...
    def __init__(self, dataset, ids, ids2=None, q=0.01, prior=0.5, min_studies=1):
        ...
        unselected_id_indices = ~self.selected_id_indices if ids2 is None else np.in1d(mt.ids, ids2)
        ...
        pAgF_z_FDR = imageutils.threshold_img(pAgF_z,
          fdr_thresh, p_vals, mask_out='above')
        ...
        if min_studies > 0:
            if isinstance(min_studies, int):
                min_studies = float(min_studies) / n_mappables
            vox_to_exclude = np.where(pA < min_studies)[0]
