...
# Compiled at: 2017-06-22 19:21:42
# Size of source mod 2**32: 12071 bytes
""" Decoding tools"""
import numpy as np
...
class Decoder:
    ...
    def __init__(self, dataset=None, method='pearson', features=None, mask=None, image_type='specificity_z', threshold=0.001):
    ...
    def plot_polar(self, data, n_top=3, overplot=False, labels=None, palette='husl'):
        ...
        for i in range(n_panels):
            ...
            ax.fill(theta, d, color=colors[i], alpha=alpha, ec='k', linewidth=0)
            ax.fill(theta, d, alpha=1.0, ec=colors[i], linewidth=2, fill=False)
            ax.set_xticks(theta)
