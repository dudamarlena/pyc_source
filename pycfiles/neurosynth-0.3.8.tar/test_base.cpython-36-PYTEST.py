...
# Compiled at: 2018-05-04 12:26:17
# Size of source mod 2**32: 14405 bytes
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, unittest, numpy as np, pandas as pd, tempfile, os, shutil
...
class TestBase(unittest.TestCase):
    ...
    def test_selection_by_expression(self):
        ...
        if have_ply:
            ...
            ids = self.dataset.get_studies(expression='f* > 0.005',
              func=(np.mean),
    ...
    def test_get_features_by_ids(self):
        ...
        features = self.dataset.feature_table.get_features_by_ids([
         'study2', 'study5'],
          func=(np.sum), threshold=0.0, get_weights=True)
