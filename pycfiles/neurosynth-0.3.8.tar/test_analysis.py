...
# Compiled at: 2015-09-01 11:08:50
import unittest, numpy as np, tempfile, os, shutil
...
class TestAnalysis(unittest.TestCase):
    ...
    def test_coactivation(self):
        ...
        network.coactivation(self.dataset, seed_img, output_dir=tempdir, prefix='test', r=20)
    ...
    def test_clustering(self):
        ...
        clusters = cluster.magic(self.real_dataset, roi_mask=roi_mask, reduce_reference='pca', n_components=5, min_studies_per_voxel=1, n_clusters=3)
        ...
        clust = KMeans(3)
        cluster.magic(self.real_dataset, method='studies', roi_mask=roi_mask, features=[
         'emotion', 'pain'], feature_threshold=0.0, reduce_reference=pca, clustering_algorithm=clust, distance_metric='jaccard', output_dir=d, filename='test.nii.gz')
