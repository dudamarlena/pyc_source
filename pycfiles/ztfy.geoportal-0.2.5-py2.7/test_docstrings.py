...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/geoportal/tests/test_docstrings.py
# Compiled at: 2012-06-20 05:59:36
"""
Generic Test case for 'ztfy.geoportal' doc strings
"""
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        location = 'ztfy.geoportal.%s' % test
