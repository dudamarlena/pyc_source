...
# [GCC 8.4.0]
# Embedded file name: /home/dalou/www/DOCKER/docker-emperor/docker_emperor/commands/remove.py
# Compiled at: 2018-09-11 08:14:52
...
def run(root, *args, **kwargs):
    ...
    if not mounting.is_localhost:
        ...
        cmd = root.bash(mounting.docker_machine_bin, 'rm', mounting.docker_machine_name, is_system=True, *args)
    else:
