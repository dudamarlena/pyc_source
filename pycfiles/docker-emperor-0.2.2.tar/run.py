...
# [GCC 8.4.0]
# Embedded file name: /home/dalou/www/DOCKER/docker-emperor/docker_emperor/commands/run.py
...
def run(root, *args, **kwargs):
    ...
    cmd = root.bash(root.compose.bin, 'run', compose=root.compose, is_system=True, *args)
    if cmd.is_success:
