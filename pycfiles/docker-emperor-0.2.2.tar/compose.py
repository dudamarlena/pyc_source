...
# [GCC 8.4.0]
# Embedded file name: /home/dalou/www/DOCKER/docker-emperor/docker_emperor/nodes/compose.py
# Compiled at: 2019-02-04 02:11:59
import six, os
...
class Compose(dict):
    ...
    def __init__(self, root, docker_compose_bin='docker-compose'):
        ...
        self.environment['DOCKER_EMPEROR_HOSTS'] = (' ').join([ host.strip() for host in self.mounting['hosts'] ])
