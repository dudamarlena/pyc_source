...
# [GCC 8.4.0]
# Embedded file name: /home/dalou/www/DOCKER/docker-emperor/docker_emperor/nodes/mounting.py
# Compiled at: 2018-09-05 01:43:12
import six
...
class Mounting(dict):
    ...
    def exists(self):
        ...
        for line in cmd.lines:
            if line == self.docker_machine_name:
                return True
