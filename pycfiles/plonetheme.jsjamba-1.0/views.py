...
# Embedded file name: /Users/AG/Projects/intk/Plone3/intk/src/plonetheme.INTKmodern/plonetheme/intkModern/browser/views.py
# Compiled at: 2014-09-25 09:12:16
...
class CommonBrowserView(BrowserView):
    ...
    def cacheNextPrev(self):
        ...
        results = catalog.queryCatalog({'portal_type': 'Media Event', 'sort_on': 'start', 
           'hasMedia': True, 
