...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/microcsound/tests.py
# Compiled at: 2017-11-27 13:44:26
...
def sanity_tests():
    ...
    if not len(PARSER_PATTERN.findall(test_string_2)) == 28:
