...
# [GCC 8.4.0]
# Embedded file name: /Users/x/code/OONI/ooni-probe/docs/source/../../ooni/nettests/manipulation/http_invalid_request_line.py
...
class UsageOptions(usage.Options):
    optParameters = [
     ...
     [
      'backendport', 'p', 80,
      'Specify the port that the TCP echo server is running (should only be set for debugging).']]
...
class HTTPInvalidRequestLine(tcpt.TCPTest):
    ...
    description = 'Performs out of spec HTTP requests in an attempt to trigger a proxy error message.'
    version = '0.2'
