...
# [GCC 8.4.0]
# Embedded file name: /Users/x/code/OONI/ooni-probe/ooni/nettests/blocking/facebook_messenger.py
...
FB_HOSTNAMES = {'stun': 'stun.fbsbx.com', 
...
class FacebookMessengerTest(httpt.HTTPTest, dnst.DNSTest):
    ...
    description = 'This test examines the reachability of Facebook Messenger in your network.'
