...
# [GCC 8.4.0]
# Embedded file name: /Users/x/code/OONI/ooni-probe/ooni/nettests/blocking/whatsapp.py
...
class UsageOptions(usage.Options):
    optFlags = [
     [
      'all-endpoints', 'e', 'Should we attempt to connect to all whatsapp endpoints?']]


class WhatsappTest(httpt.HTTPTest, dnst.DNSTest):
    name = 'Whatsapp'
    description = "This test examines the reachability of WhatsApp  and WhatsApp's web interface (web.whatsapp.com) in your network."
