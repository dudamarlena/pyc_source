...
# [GCC 8.4.0]
# Embedded file name: /Users/x/code/OONI/ooni-probe/ooni/nettests/manipulation/daphne.py
# Compiled at: 2016-03-30 08:23:41
...
class daphn3Args(usage.Options):
    ...
    optFlags = [
     [
      'pcap', 'c', 'Specify that the input file is a pcap file'],
     [
