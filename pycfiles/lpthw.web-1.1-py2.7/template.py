...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/web/template.py
...
class Parser():
    ...
    def read_text(self, text):
        ...
        if index < 0:
            ...
            return (
             TextNode(text[:index]), text[index:])
