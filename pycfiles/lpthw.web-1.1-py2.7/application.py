...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/web/application.py
# Compiled at: 2011-06-21 16:54:55
"""
Web application
(from web.py)
"""
import webapi as web, webapi, wsgi, utils, debugerror
from utils import lstrips, safeunicode
import sys, urllib, traceback, itertools, os, re, types
...
class application():
    ...
    def load(self, env):
        ...
        if env.get('wsgi.url_scheme') in ('http', 'https'):
            ...
            if env.get('HTTPS', '').lower() in ('on', 'true', '1'):
                ctx.protocol = 'https'
            else:
                ctx.protocol = 'http'
