...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/web/session.py
# Compiled at: 2011-06-21 16:54:55
"""
Session Management
(from web.py)
"""
import os, time, datetime, random, base64, os.path
try:
...
import utils, webapi as web
__all__ = [
 'Session', 'SessionExpired',
 'Store', 'DiskStore', 'DBStore']
web.config.session_parameters = utils.storage({'cookie_name': 'webpy_session_id', 
   'cookie_domain': None, 
   'timeout': 86400, 
   'ignore_expiry': True, 
...
class DBStore(Store):
    ...
    def cleanup(self, timeout):
        timeout = datetime.timedelta(timeout / 86400.0)
