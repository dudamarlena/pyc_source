...
class CommandLineInterface(object):
    __doc__ = '\n    Wrapper around all the other classes, tying everything together.\n\n    Typical usage::\n\n        application = Application(...)\n        cli = CommandLineInterface(application, eventloop)\n        result = cli.run()\n        print(result)\n\n    :param application: :class:`~prompt_tool_kit.application.Application` instance.\n    :param eventloop: The :class:`~prompt_tool_kit.eventloop.base.EventLoop` to\n                      be used when `run` is called. The easiest way to create\n                      an eventloop is by calling\n                      :meth:`~prompt_tool_kit.shortcuts.create_eventloop`.\n    :param input: :class:`~prompt_tool_kit.input.Input` instance.\n    :param output: :class:`~prompt_tool_kit.output.Output` instance. (Probably\n                   Vt100_Output or Win32Output.)\n    '
