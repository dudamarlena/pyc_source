...
class TokenListControl(UIControl):
    ...
    def create_content(self, cli, width, height):
        ...
        def process_line(line):
            ...
            return [
             (
              default_char.token, default_char.char * padding)] + line
