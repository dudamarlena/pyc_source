...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/lumpy/mail.py
# Compiled at: 2016-07-22 19:41:43
import errno, getpass, logging, re, smtplib
...
class Mail(object):
    ...
    def __init__(self, recipient, sender=('{}@example.com').format(getpass.getuser()), subject='Sir! My sir!', body='A message from their majesty.', content_type='plain', port=smtplib.SMTP_PORT, mxrecords=None):
