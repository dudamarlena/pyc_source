...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/elixir/ext/perform_ddl.py
# Compiled at: 2009-11-13 14:46:32
"""
...
class PreloadDataEntityBuilder(EntityBuilder):
    ...
    def after_table(self):
        ...
        def onload(event, schema_item, connection):
            ...
            connection.execute(insert, [ dict(zip(columns, values)) for values in data ])
            return
