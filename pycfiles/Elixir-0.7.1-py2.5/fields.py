...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/elixir/fields.py
...
class Field(Property):
    ...
    def create_col(self):
        self.column = Column(self.colname, self.type, *self.args, **self.kwargs)
...
def has_field_handler(entity, name, *args, **kwargs):
    if 'through' in kwargs:
        setattr(entity, name, association_proxy(kwargs.pop('through'), kwargs.pop('attribute', name), **kwargs))
        return
