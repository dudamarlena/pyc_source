...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/elixir/options.py
# Compiled at: 2009-11-13 09:48:07
"""
...
options_defaults = dict(abstract=False, autosetup=False, inheritance='single', polymorphic=True, identity=None, autoload=False, tablename=None, shortnames=False, auto_primarykey=True, version_id_col=False, allowcoloverride=False, order_by=None, resolve_root=None, mapper_options={}, table_options={})
...
def using_options_defaults_handler(entity, **kwargs):
    for kwarg in kwargs:
        if kwarg not in valid_options:
            raise Exception("'%s' is not a valid option for Elixir entities." % kwarg)
