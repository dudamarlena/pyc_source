...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pgp/commands/gpg/trustdb_helper.py
# Compiled at: 2015-08-31 08:17:33
import os.path

class TrustDBHelper(object):

    def __init__(self, homedir, trustdb_file, min_cert_level, trusted_keys, trust_model, completes_needed, marginals_needed, max_cert_depth, auto_check_trustdb, lock_count, require_cross_certification, io_helper):
        if not trustdb_file:
            pass
    ...
    def check_permissions(self):
        ...
        mode = 511
        self.io_helper.permissions_warning(self.trustdb_file, mode, 448)
