...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pgp/commands/gpg/sign.py
...
class Command(SignCommand):
    ...
    def __init__(self, formatter, io_helper, keyring_helper, algorithm_helper, faked_system_time, force_v3_sigs, force_v4_certs, signature_notations, certification_notations, notations, sig_policy_url, cert_policy_url, policy_url, preferred_keyserver, default_keyserver_url, message_filename, set_filesize, escape_from_lines, for_your_eyes_only):
        SignCommand.__init__(self, io_helper, force_v3_sigs, force_v4_certs, signature_notations, certification_notations, notations, sig_policy_url, cert_policy_url, policy_url, preferred_keyserver, default_keyserver_url, message_filename, set_filesize, escape_from_lines, for_your_eyes_only)
    ...
    def sign_message(self, msg, signature_type=None, one_pass=True):
        ...
        if self.force_v3_sigs:
            signature_version = 3
        msg.sign(secret_key, signature_version, signature_type, self.algorithm_helper.get_signature_digest_algorithm(), one_pass=one_pass)
        return
    ...
    def output(self, message, filename):
        ...
        self.io_helper.write_output(self.formatter.format_message(message), output_filename=output_filename)