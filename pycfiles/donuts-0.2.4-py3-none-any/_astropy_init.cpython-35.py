...
# [GCC 8.4.0]
# Embedded file name: /Users/jmcc/Dropbox/PythonScripts/astropy/Donuts/build/lib.macosx-10.12-x86_64-3.5/donuts/_astropy_init.py
# Compiled at: 2017-10-23 11:59:15
# Size of source mod 2**32: 5270 bytes
__all__ = [
 '__version__', '__githash__', 'test']
try:
    _ASTROPY_SETUP_
except NameError:
...
def test(package=None, test_path=None, args=None, plugins=None, verbose=False, pastebin=None, remote_data=False, pep8=False, pdb=False, coverage=False, open_files=False, **kwargs):
    """
    ...
    return test_runner.run_tests(package=package, test_path=test_path, args=args, plugins=plugins, verbose=verbose, pastebin=pastebin, remote_data=remote_data, pep8=pep8, pdb=pdb, coverage=coverage, open_files=open_files, **kwargs)
