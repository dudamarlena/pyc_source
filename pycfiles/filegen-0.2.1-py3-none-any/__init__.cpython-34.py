...
# [GCC 8.4.0]
# Embedded file name: /Users/nao/vboxshare/venvs/django/filegen/filegen/__init__.py
# Compiled at: 2016-05-21 05:47:07
# Size of source mod 2**32: 6014 bytes
import sys, contextlib, os.path
...
class FilegenApplication(object):
    ...
    def run(self, fg, *args, **kwargs):
        ...
        if args.action == 'python':
            ...
            if args.action == 'file' or args.action == 'default':
                if callable(fg):
                    fg = fg()
                fg.change(args.root)
    ...
    def closure():
        ...
        with fg.dir('foo'):
            ...
            with fg.file('readme.txt') as (wf):
                ...
                wf.write('いろはにほへと\u3000ちりぬるを わかよたれそ\u3000つねならむ うゐのおくやま\u3000けふこえて あさきゆめみし\u3000ゑひもせす')
        return fg
