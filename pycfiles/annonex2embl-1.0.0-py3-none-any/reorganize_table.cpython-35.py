...
# Embedded file name: /usr/local/lib/python3.5/dist-packages/annogesiclib/reorganize_table.py
...
def get_lib_name(libs):
    ...
    for lib1 in libs:
        for lib2 in libs:
            if lib1['cond'] == lib2['cond'] and lib1['type'] == lib2['type'] and lib1['rep'] == lib2['rep'] and lib1['strand'] != lib2['strand']:
