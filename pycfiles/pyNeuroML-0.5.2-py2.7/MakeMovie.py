...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyneuroml/povray/MakeMovie.py
# Compiled at: 2016-07-21 13:07:13
import cv2, cv, colorsys, argparse, sys, os.path
...
def process_args():
    ...
    parser.add_argument('-activity', action='store_true', default=False, help='If this is specified, overlay network activity (not tested!!)')
    ...
    parser.add_argument('-title', type=str, metavar='<title>', default='Movie generated from neuroConstruct simulation', help='Title for movie')
    parser.add_argument('-left', type=str, metavar='<left info>', default='', help='Text on left')
    parser.add_argument('-frames', type=int, metavar='<frames>', default=100, help='Number of frames')
    parser.add_argument('-name', type=str, metavar='<Movie name>', default='output', help='Movie name')
