...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyneuroml/analysis/ChannelDensityPlot.py
# Compiled at: 2017-07-07 12:30:23
from pyneuroml.pynml import print_comment, get_value_in_si, print_comment_v, read_neuroml2_file
...
def generate_channel_density_plots(nml2_file, text_densities=False, passives_erevs=False, target_directory=None):
    ...
    for cell in cell_elements:
        ...
        if isinstance(cell, Cell2CaPools):
            cds = cell.biophysical_properties2_ca_pools.membrane_properties2_ca_pools.channel_densities + cell.biophysical_properties2_ca_pools.membrane_properties2_ca_pools.channel_density_nernsts
        else:
            if isinstance(cell, Cell):
                cds = cell.biophysical_properties.membrane_properties.channel_densities + cell.biophysical_properties.membrane_properties.channel_density_nernsts
            epas = None
            ena = None
            ek = None
            eh = None
