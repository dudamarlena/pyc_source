...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyneuroml/lems/LEMSSimulation.py
# Compiled at: 2018-09-10 05:44:50
"""
Helper class for generating LEMS xml files for simulations
"""
import airspeed, os.path
...
class LEMSSimulation:
    ...
    def __init__(self, sim_id, duration, dt, target=None, comment='\n\n        This LEMS file has been automatically generated using PyNeuroML v%s (libNeuroML v%s)\n\n    ' % (pynml_ver, libnml_ver), lems_file_generate_seed=None, simulation_seed=12345):
        ...
        if lems_file_generate_seed:
            self.my_random.seed(lems_file_generate_seed)
        else:
