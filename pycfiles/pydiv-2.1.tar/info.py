...
# Embedded file name: build/bdist.linux-x86_64/egg/ditz/command/info.py
...
def show_todo(cmd, arg, claimed=False):
    ...
    text = display.show_todo(cmd.db, relname=release, closed=allflag, claimed=claimed)
    cmd.write(text)
