...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.6.0-Power_Macintosh/egg/sprinkles.py
# Compiled at: 2006-04-18 08:07:39
...
class Manager(object):
    ...
    def __init__(self, packages=[], parent=None, filter=IManagedSprinkle.implementedBy):
    ...
    for sub in fromlist:
        ...
        if sub != '*':
            if not hasattr(m, sub):
                ...
                raise submod or ImportError, 'No module named ' + subname
