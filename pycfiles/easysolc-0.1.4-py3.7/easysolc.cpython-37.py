...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/easysolc/easysolc.py
# Compiled at: 2019-01-12 16:42:20
...
class Solc:
    ...
    def get_contract_instance(self, contract_dict=None, w3=None, source=None, contract_name=None, address=None, abi_file=None, bytecode_file=None):
        if w3 == None:
            w3 = Web3()
        else:
            contract = None
    ...
    def compile(self, source='*.sol', args=None, optimize=False, optimize_runs=200, pretty_json=False, libraries=None, output_dir=None, overwrite=True, combined_json=None, gas=False, standard_json=False, assemble=False, yul=False, strict_assembly=False, machine=None, link=False, metadata_literal=False, allow_paths=None, ignore_missing=False, ast=False, ast_json=False, ast_compact_json=False, asm=False, asm_json=False, opcodes=False, bin_=True, bin_runtime=False, abi=True, hashes=False, userdoc=False, devdoc=False, metadata=False):
            ...
            if output[i][0] == '=':
                ...
                while i < len(output) and output[i] and output[i][0] != '=':
                    if output[i][:7] == 'Binary:':
                        ...
                        if output[i][:17] == 'Contract JSON ABI':
                            i += 1
