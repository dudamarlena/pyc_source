...
# Embedded file name: /usr/lib/python2.5/site-packages/pyjamas/JSONService.py
# Compiled at: 2008-09-03 13:52:52
__doc__ = ' JSONService is a module providing JSON RPC Client side proxying.\n'
...
class ServiceProxy(object):
    ...
    def __call__(self, *params):
        if hasattr(params[(-1)], 'onRemoteResponse'):
            handler = params[(-1)]
            return self._sendRequest(self.__serviceName, params[:-1], handler)
        else:
