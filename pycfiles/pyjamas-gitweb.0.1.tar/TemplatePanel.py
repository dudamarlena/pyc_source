...
# Embedded file name: /usr/lib/python2.5/site-packages/pyjamas/TemplatePanel.py
# Compiled at: 2008-09-03 09:02:13
from pyjamas.__pyjamas__ import unescape
from RichTextEditor import RichTextEditor
import Window
from pyjamas.__pyjamas__ import encodeURIComponent
...
class TemplatePanel(ComplexPanel):
    ...
    def saveTemplateText(self, html):
        ...
        processing there.
        """
        HTTPRequest().asyncPost(self.getTemplateSaveUrl(self.templateName), 'content=' + encodeURIComponent(html), ContentSaveHandler(self))
