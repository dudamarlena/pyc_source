...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mbe/features/environment.py
...
def before_feature(context, feature):
    ...
    """
    context.db_access = init_database('test_MBE', _data_files=[os.path.abspath(os.path.join(script_dir, 'data/init_data.json'))], _json_schema_folders=[
     os.path.abspath(os.path.join(script_dir, 'schemas'))])
    context.auth = init_authentication(context.db_access)
    context.schema_tools = context.db_access.schema_tools
