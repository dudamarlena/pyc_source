...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mbe/features/resources.py
# Compiled at: 2015-03-19 17:09:36
...
test_hashed_user_data = {'name': 'TestUser', 
 ...
 'groups': [
            '000000010000010001e64d02']}
test_find_user_query = {'conditions': test_hashed_user_data, 
 'collection': 'node'}
test_node = {'name': 'test_node', 
 ...
 'canRead': [
             '000000010000010001e64c28', '000000010000010001e64d02'], 
 'canWrite': [
              '000000010000010001e64c28', '000000010000010001e64d02']}
test_find_node_query = {'conditions': test_node, 
 'collection': 'node'}
test_find_node_log_query = {'conditions': {'name': 'test_node'},  'collection': 'event'}
