...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/filebrowser/fields.py
# Compiled at: 2016-01-24 17:12:36
import os
...
class FileBrowseFormField(forms.CharField):
    ...
    default_error_messages = {'extension': _('Extension %(ext)s is not allowed. Only %(allowed)s is allowed.')}
