...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mtrax/draw.py
# Compiled at: 2008-02-05 17:28:27
import matplotlib
matplotlib.interactive(True)
import matplotlib.backends.backend_wxagg, matplotlib.figure, matplotlib.cm, numpy as num, os, wx
from wx import xrc
import imagesk, motmot.wxvalidatedtext.wxvalidatedtext as wxvt
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            if this_ext in allowed_ext:
                try:
                    ...
                    wx.MessageBox('Miscellaneous write error', 'Write error', wx.ICON_ERROR)
...
class DrawSettingsDialog:
    ...
    def __init__(self, parent=None):
        ...
        self.frame = rsrc.LoadFrame(parent, 'frame_mtrax_settings')
