...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mtrax/imagesk.py
# Compiled at: 2008-02-12 17:49:23
...
def draw_annotated_image(img, pointlists=None, linelists=None, circlelists=None, windowsize=None, zoomaxes=None, pointcolors=None, linecolors=None, circlecolors=None, pointsizes=None, linewidths=None, circlewidths=None):
    if zoomaxes is None:
        zoomaxes = [
         0, img.shape[1] - 1, 0, img.shape[0] - 1]
    if int(zoomaxes[3]) < int(zoomaxes[2]) or int(zoomaxes[1]) < int(zoomaxes[0]):
...
def add_annotations(bmp, resize, pointlists=None, linelists=None, zoomaxes=[
 0, 10, 0, 10], pointcolors=None, linecolors=None, pointsizes=None, linewidths=None):
