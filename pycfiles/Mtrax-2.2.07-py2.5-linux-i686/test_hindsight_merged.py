...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mtrax/test_hindsight_merged.py
...
tracks_true[0][0] = ell.Ellipse(37.0, 70.0, 2.0, 4.0, num.pi / 3, 0.0, 0)
tracks_true[0][0].compute_area()
tracks_true[0][1] = ell.Ellipse(60.0, 70.0, 2.0, 4.0, num.pi / 3, 0.0, 1)
tracks_true[0][1].compute_area()
tracks_true.append(ell.TargetList())
tracks_true[1][0] = ell.Ellipse(37.0, 62.0, 2.0, 4.0, num.pi / 3, 0.0, 0)
tracks_true[1][0].compute_area()
tracks_true[1][1] = ell.Ellipse(53.0, 62.0, 2.0, 4.0, num.pi / 3, 0.0, 1)
