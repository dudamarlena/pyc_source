...
# [GCC 8.4.0]
# Embedded file name: /home/ranjeet/pythonProjects/evironments2/venv/lib/python3.5/site-packages/myproject4/skeleton.py
...
entry_points section in setup.py:
    ...
    [console_scripts]
    fibonacci = myproject4.skeleton:run
...
from myproject4 import __version__
__author__ = 'rksin8'
...
def parse_args(args):
    ...
    parser.add_argument('--version', action='version', version='myproject4 {ver}'.format(ver=__version__))
