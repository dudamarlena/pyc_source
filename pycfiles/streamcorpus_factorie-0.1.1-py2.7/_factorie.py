...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/streamcorpus_factorie/_factorie.py
# Compiled at: 2014-06-26 14:39:28
"""
transform chunks using factorie grammar tagger
"""
import glob, logging, os, random, subprocess, time
    ...
    def call_factorie(self, inpath, outpath):
        ...
        if False:
            self.process = subprocess.Popen([
             os.path.join(self.cwd, 'factorie.sh'), inpath, outpath], cwd=self.cwd)
            return
        else:
