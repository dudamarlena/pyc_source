...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/crwy/utils/sql/mysql.py
...
try:
    ...
    raise CrwyImportException('You should install pymysql first! try: pip install pymysql')
