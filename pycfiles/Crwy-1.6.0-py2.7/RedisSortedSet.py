...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/crwy/utils/filter/RedisSortedSet.py
...
class RedisSortedSet(object):
    ...
    def __init__(self, name, namespace='deduplicate_sorted', server=None, **redis_kwargs):
        """
