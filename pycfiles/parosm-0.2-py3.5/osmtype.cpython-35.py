...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/parosm/types/osmtype.py
...
class OSMBaseType:
    ...
    def __init__(self, identifier, user=None, uid=None, timestamp=None, visible=None, version=0, changeset=0, tags=None, **kwargs):
        self._id = identifier
...
class OSM:
    ...
    def set_bounds(self, minlat=None, minlon=None, maxlat=None, maxlon=None):
        """
        Set bounding box
        :param minlat: Y-min
        :param minlon: X-min
