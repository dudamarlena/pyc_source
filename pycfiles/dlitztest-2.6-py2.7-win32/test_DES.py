...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\Crypto\SelfTest\Cipher\test_DES.py
...
class RonRivestTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertEqual(b2a_hex(X[16]), b2a_hex(b(b'\x1b\x1a-\xdbLd$8')))
