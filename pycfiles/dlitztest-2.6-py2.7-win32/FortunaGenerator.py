...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\Crypto\Random\Fortuna\FortunaGenerator.py
...
class AESGenerator(object):
    ...
    def _pseudo_random_data(self, bytes):
        assert 0 <= bytes <= self.max_bytes_per_request, 'You cannot ask for more than 1 MiB of data per request'
