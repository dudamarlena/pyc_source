...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\Crypto\SelfTest\PublicKey\test_DSA.py
...
class DSATest(unittest.TestCase):
    ...
    def _check_public_key(self, dsaObj):
        ...
        self.assertEqual(dsaObj.publickey() == dsaObj.publickey(), True)
        self.assertEqual(dsaObj.publickey() != dsaObj.publickey(), False)
    ...
    def _test_verification(self, dsaObj):
        ...
        self.assertEqual(0, dsaObj.verify(m_hash + b('\x00'), (r, s)))
