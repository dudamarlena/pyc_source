...
# Embedded file name: build/bdist.linux-x86_64/egg/sputnik/__init__.py
...
rcon = redis.Redis(host=REDIS_HOST, port=REDIS_PORT, db=REDIS_DB, password=REDIS_PASSWORD)
