...
import socket, decimal, errno, threading
...
class Redis(object):
    ...
    def __init__(self, host=None, port=None, timeout=None, db=None, nodelay=None, charset='utf8', errors='strict', retry_connection=True, float_fn=decimal.Decimal):
