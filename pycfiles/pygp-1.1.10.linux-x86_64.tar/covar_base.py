...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pygp/covar/covar_base.py
# Compiled at: 2013-07-02 10:20:24
"""
...
class CovarianceFunction(object):
    ...
    def Kdiag(self, theta, x1):
        ...
        *Default*: Return the diagonal of the fully
        ...
        return self.K(theta, x1).diagonal().copy()
    ...
    def _filter_input_dimensions(self, x1, x2):
        ...
        if x2 == None:
            ...
            return (
             self._filter_x(x1), self._filter_x(x2))
