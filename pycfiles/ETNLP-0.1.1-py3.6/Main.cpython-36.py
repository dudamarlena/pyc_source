...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/visualizer/Main.py
# Compiled at: 2019-04-04 11:13:28
...
def search():
    ...
    return render_template('search.html', embedding_names_arr=embedding_names_arr,
...
if __name__ == '__main__':
    ...
    for model in model_files:
        if os.path.isfile(model):
            ...
            print('Download word2vec model and put into ../data/. File: https://github.com/vietnlp/etnlp')
