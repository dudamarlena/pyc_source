...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/xwot1/REST-Server-Skeleton/Hardware_Monitor.py
# Compiled at: 2015-01-22 13:22:24
"""
...
class SerialData(object):
    ...
    def __init__(self, port='/dev/ttyACM1'):
        ...
        try:
            self.ser = serial.Serial(port=port, baudrate=9600, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=0.1, xonxoff=0, rtscts=0, interCharTimeout=None)
