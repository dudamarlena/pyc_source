...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/lilcom/lilcom.py
# Compiled at: 2019-08-13 02:33:03
# Size of source mod 2**32: 6727 bytes
import numpy as np
from . import lilcommodule
from ctypes import *
...
def compress--- This code section failed: ---
 ...
 L. 125        68  LOAD_FAST                'intMode'
               70  POP_JUMP_IF_FALSE    74  'to 74'

 L. 126        72  JUMP_FORWARD         74  'to 74'
...
def decompress--- This code section failed: ---
 ...
 L. 149         0  LOAD_CONST               True
                2  STORE_FAST               'intMode'

 L. 150         4  LOAD_FAST                'inputSignal'
                6  LOAD_ATTR                dtype
                8  LOAD_CONST               ('float64', 'float32', 'float16')
               10  COMPARE_OP               in
               12  POP_JUMP_IF_FALSE    18  'to 18'

 L. 151        14  LOAD_CONST               False
               16  STORE_FAST               'intMode'
             18_0  COME_FROM            12  '12'

 L. 153        18  LOAD_FAST                'inputSignal'
               20  LOAD_METHOD              flatten
               22  CALL_METHOD_0         0  '0 positional arguments'
               24  STORE_FAST               'inputSignal_vectorized'

 L. 154        26  LOAD_FAST                'inputSignal'
               28  LOAD_ATTR                shape
               30  LOAD_CONST               0
               32  BINARY_SUBSCR    
               34  STORE_FAST               'numSamples'

 L. 155        36  SETUP_EXCEPT         52  'to 52'

 L. 156        38  LOAD_FAST                'inputSignal'
               40  LOAD_ATTR                shape
               42  LOAD_CONST               1
               44  BINARY_SUBSCR    
               46  STORE_FAST               'inputStride'
 ...
 L. 164        68  LOAD_FAST                'intMode'
               70  POP_JUMP_IF_FALSE    74  'to 74'

 L. 165        72  JUMP_FORWARD         74  'to 74'
             74_0  COME_FROM            72  '72'
             74_1  COME_FROM            70  '70'
