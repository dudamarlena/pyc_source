...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/notify/client.py
# Compiled at: 2018-03-14 02:05:17
import os, six, json, requests
...
class NotifyClient(object):
    ...
    def __init__(self, message=None, audio_file=None, audio_file_url=None, phone_numbers=None, delay=None, answers=None, auth_token=None, handler_url=None, handler_token=None, handler_data=None):
        """
    ...
    def create_call(self, message=None, answers=None, phone_numbers=None, delay=None, audio_file=None, audio_file_url=None, handler_token=None, handler_url=None, handler_data=None):
        """
            Make call
        """
        ...
        files = {}
        notify_data = {'type': consts.CALL_TYPE, 
        ...
        data = self.preparation_data(data=notify_data, files=files)
    ...
    def create_message(self, message=None, phone_numbers=None, handler_token=None, handler_url=None, handler_data=None):
        ...
        assert handler_url is None or isinstance(handler_url, six.string_types)
        assert handler_data is None or isinstance(handler_data, self.JSON_DUMP_TYPES)
        data = self.preparation_data(data={'type': consts.MESSAGE_TYPE, 
           'message': message, 
           'phones': phones, 
