...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/superdir/superdir.py
# Compiled at: 2016-08-25 14:46:25
import os, sys, click
from tree import Tree
from validator import Validator
import callbacks as cbs, utils
...
def main(schema=None, OUTPUT_DIR=None, CONFIG_PATH=None):
    ...
    if not validator.validate():
        ...
        sys.exit(1)
    directory_tree = Tree(INDENT_SIZE=validator.INDENT_SIZE, OUTPUT_DIR=OUTPUT_DIR, base_path=os.path.abspath(os.curdir))
...
@click.option('-o', '--outfile', nargs=1, type=str, help="Directory name to contain your superdir'd files. If none issupplied, your schema file must have exactly one top-level directoryand no sibling regular files. That top-level directory will be theparent of your new file tree. If an output directory is suppliedthen any validly-indented schema file is allowed.")
