...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/superdir/utils.py
# Compiled at: 2016-08-24 14:51:56
"""  
...
def clean(lines):
    ...
    return [ line.rstrip() for line in lines if not (is_empty(line) or is_comment(line))
           ]
