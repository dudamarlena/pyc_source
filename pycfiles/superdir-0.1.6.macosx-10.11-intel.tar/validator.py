...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/superdir/validator.py
# Compiled at: 2016-08-24 15:46:49
import sys, utils
...
class Validator:
    ...
    def _line_is_valid(self, this_line, prev_line, this_indent, prev_indent):
        ...
        return difference == 0 or difference == self.INDENT_SIZE and utils.is_dir(prev_line) or difference < 0 and utils.is_multiple_of_indent(this_indent, self.INDENT_SIZE)
