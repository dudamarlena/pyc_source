...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scrumtools/data.py
...
class UserRepository:
    ...
    def __read(self):
        with open(self.__file, 'rb') as (f):
            reader = UnicodeReader(f, encoding='utf-8', delimiter=self.__file_delimiter, quoting=(self.__file_quotechar or csv).QUOTE_NONE if 1 else csv.QUOTE_MINIMAL, quotechar=self.__file_quotechar, skipinitialspace=True)
