...
# [GCC 8.4.0]
# Embedded file name: /home/paulina/pangtree/pangtreebuild/tests/tests_pangenome/builders/tests_dagmaf2poagraph_ConstSymbolProvider.py
# Compiled at: 2019-12-30 15:48:57
# Size of source mod 2**32: 19005 bytes
import unittest
...
class DAGMaf2PoagraphConstSymbolProviderTests(unittest.TestCase):
    ...
    def test_1_missing_sequence_start(self):
        ...
        actual_poagraph, _ = builder.build_from_dagmaf(msa.Maf(pathtools.get_file_content_stringio(maf_path), maf_path), missings.ConstBaseProvider(self.missing_n), self.metadatacsv)
