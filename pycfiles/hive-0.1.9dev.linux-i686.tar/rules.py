...
# [GCC 8.4.0]
# Embedded file name: /home/git/lib/python2.5/site-packages/hive/controllers/rules.py
...
class RulesController(BaseController):
    ...
    def index(self, repo_id, format='html'):
        ...
        rule_list = [ url('rule', id=rule, repo_id=repo_id) for rule in rule_list ]
    ...
    def create(self, repo_id):
        ...
        try:
            rule = Rule.create(repo_id, params['permission'], params['refex_list'], params['member_list'])
