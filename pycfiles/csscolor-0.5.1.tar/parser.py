...
# Embedded file name: /Users/bore/Projects/ThesisCode/Source/csscoco/css/parser.py
# Compiled at: 2015-07-24 16:30:18
import os
...
, tab, space, indent
    ...
    def _is_descendant_selector(self, s_expr, child, index):
        return s_expr[0] == 'simpleselector' and child[0] == 's' and ' ' in child[1] and 1 < index < len(s_expr) - 1 and s_expr[(index - 1)][0] != 'combinator' and s_expr[(index + 1)][0] != 'combinator'
