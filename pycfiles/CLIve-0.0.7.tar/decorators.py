...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/cliutils/decorators.py
# Compiled at: 2008-10-03 23:48:45
import os, sys
...
def logged(fobj):
    ...
    """
    import warnings
    warnings.warn('The logged decorator is deprecated. Please use redirect instead.', DeprecationWarning, stacklevel=2)
