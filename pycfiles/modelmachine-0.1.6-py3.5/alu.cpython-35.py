...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modelmachine/alu.py
# Compiled at: 2016-01-12 04:11:02
# Size of source mod 2**32: 11249 bytes
...
class ArithmeticLogicUnit:
    ...
    def add(self):
        ...
        self.registers.put(self.register_names['S'], summator.get_data(), self.operand_size)
    ...
    def sdivmod(self):
        ...
        self.registers.put(self.register_names['RES'], mod.get_data(), self.operand_size)
