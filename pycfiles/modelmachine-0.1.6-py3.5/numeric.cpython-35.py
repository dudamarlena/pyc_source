...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modelmachine/numeric.py
...
class Integer(Number):
    __doc__ = 'Integer type with fixed length.'
    ...
    def check_compatibility(self, other):
        ...
        if not isinstance(other, type(self)) or self.size != other.size or self.signed != other.signed:
