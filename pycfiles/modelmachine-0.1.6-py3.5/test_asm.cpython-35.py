...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modelmachine/tests/test_asm.py
...
class TestASM:
    __doc__ = 'Tast case for modelmachine.asm.'
    code = None
    tokens = None
    ...
    def test_lexer(self):
        ...
        for tok in lexems:
            ...
            if not eq_token(tok, ground_truth[0], ground_truth[1]):
