...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modelmachine/tests/test_numeric.py
...
class TestNumeric:
    __doc__ = 'Case test for Integer class.'
    ...
    def test_init(self):
        ...
        self.first = Integer(4294967295, 32, True)
        assert self.first.get_value() == -1
        self.first = Integer(4294967295, 32, False)
        assert self.first.get_value() == 4294967295
        for size in (8, 16, 32, 64):
            for signed in (True, False):
                ...
                assert self.first.size == size
                assert self.first.signed == signed
                if not self.first.get_value() == 10:
    ...
    def test_get_value(self):
        ...
        assert Integer(4294967295, 32, True).get_value() == -1
        assert Integer(4294967295, 32, False).get_value() == 4294967295
    ...
    def test_add(self):
        ...
        result = Integer(2147483647, 32, True) + Integer(2147483647, 32, True)
    ...
    def test_sub(self):
        ...
        assert result.get_value() == 4294967294
        result = self.second - self.first
        assert isinstance(result, Integer)
        assert result.size == 32
        assert result.signed is False
    ...
    def test_get_data(self):
        ...
        assert self.first.get_data() == 4294967291
        assert self.first.get_value() == -5
        self.first = Integer(-5, 32, signed=False)
        assert self.first.get_data() == 4294967291
        assert self.first.get_value() == 4294967291
    ...
    def test_getitem(self):
        ...
        assert self.first[3:] == Integer(1, 29, False)