...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modelmachine/tests/test_cpu.py
# Compiled at: 2016-02-27 14:22:55
# Size of source mod 2**32: 10519 bytes
...
class TestAbstractCPU:
    __doc__ = 'Test case for Abstract CPU.'
    cpu = None
    source = None
    ...
    def test_load_program(self):
        ...
        self.cpu.io_unit.load_data.assert_called_once_with([64, 257, 102], [
         '0o123', '0x456', '789'])
