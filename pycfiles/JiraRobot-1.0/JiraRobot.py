...
# [GCC 8.4.0]
# Embedded file name: JiraRobot\JiraRobot.py
...
class JiraRobot:
    ...
    def connect_to_jira(self, JIRAUsername=None, JIRAPassword=None, options=None):
        """
    ...
    def create_issue_link(self, link_type, inwardissue, outwardissue, comment=None):
        """
        ...
        """
        self.jira.create_issue_link(type=link_type, inwardIssue=str(inwardissue), outwardIssue=str(outwardissue))
