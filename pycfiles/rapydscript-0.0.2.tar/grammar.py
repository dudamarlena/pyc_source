...
# [GCC 8.4.0]
# Embedded file name: /home/user/host/inst/rapydscript/rapydscript/grammar.py
# Compiled at: 2013-02-27 22:50:31
...
class Grammar(OMeta.makeGrammar(pyva_grammar, {'p': p})):
    keywords = set(('and', 'as', 'break', 'case', 'catch', 'class', 'continue', 'def',
                    'default', 'del', 'delete', 'do', 'elif', 'else', 'except', 'finally',
                    'for', 'function', 'if', 'in', 'instanceof', 'new', 'not', 'or',
                    'pass', 'raise', 'return', 'switch', 'throw', 'til', 'to', 'try',
...
class Translator(OMeta.makeGrammar(pyva_translator, {'p': p, 'json': json})):
    ...
    def __register_var(self, var):
        if self.is_pure_var_name(var) and var not in self.global_vars and var not in self.nonlocal_vars:
