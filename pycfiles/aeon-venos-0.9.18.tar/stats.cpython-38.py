...
# Embedded file name: build/bdist.linux-x86_64/egg/aeolus/calc/stats.py
# Compiled at: 2020-04-28 06:33:47
# Size of source mod 2**32: 6299 bytes
__doc__ = 'Statistical functions.'
...
__all__ = ('spatial', 'spatial_quartiles', 'meridional_mean', 'minmaxdiff', 'region_mean_diff',
           'zonal_mean', 'last_year_mean', 'vertical_cumsum', 'vertical_mean')
...
def vertical_mean(cube, coord=UM_HGT, weight_by=None):
    ...
    elif isinstance(weight_by, (str, iris.coords.Coord)):
        vmean = cube.collapsed(UM_HGT,
          (iris.analysis.MEAN), weights=(cube.coord(weight_by).points.squeeze()))
