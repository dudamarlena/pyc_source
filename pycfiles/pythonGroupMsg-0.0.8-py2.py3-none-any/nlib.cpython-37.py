...
# [GCC 8.4.0]
# Embedded file name: /home/free/src/sgmq/pythonGroupMsg/nlib.py
# Compiled at: 2018-12-06 00:50:51
# Size of source mod 2**32: 9022 bytes
import os
...
class GnuQueue(QueueInstantiate):
    ...
    def __init__(self, name='', dir=None, loglevel=logging.ERROR):
        ...
        self.log = logging
        self.log.basicConfig(level=loglevel, format=(self.__class__.__name__ + ' %(asctime)s - %(levelname)s - - %(message)s'),
