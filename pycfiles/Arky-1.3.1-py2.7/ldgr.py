...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\arky\ldgr.py
# Compiled at: 2018-01-10 15:00:25
...
from . import util
from . import cfg
import io, os, arky, struct
pack = (lambda f, v: struct.pack(f, v)) if __PY3__ else (lambda f, v: bytes(struct.pack(f, v)))
...
def parseBip32Path(path):
    ...
    for pathElement in elements:
        ...
        if len(element) == 1:
            ...
            result = result + pack('>I', 2147483648 | int(element[0]))
