...
# [GCC 8.4.0]
# Embedded file name: D:\djangoarticle\src\djangoarticle\migrations\0001_initial.py
# Compiled at: 2019-05-27 09:30:05
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='ArticleModelScheme',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Djangoarticle article', 
      'verbose_name_plural':'Djangoarticle articles', 
      'ordering':[
       'serial', 'pk']}),
     migrations.CreateModel(name='CategoryModelScheme',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'author', models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to=(settings.AUTH_USER_MODEL)))],
       options={'verbose_name':'Djangoarticle category', 
