...
# [GCC 8.4.0]
# Embedded file name: /Users/guillem.cabrera/pyvtt/build/lib/pyvtt/vtttime.py
# Compiled at: 2018-03-05 07:18:39
# Size of source mod 2**32: 5290 bytes
"""
...
from pyvtt.compat import str, str
...
class WebVTTTime(ComparableMixin):
    ...
    RE_TIMECODE = re.compile('^(\\d+):([0-5][0-9]):([0-5][0-9])(?:$|[\\.\\,](\\d+))')
    SECONDS_RATIO = 1000
    ...
    def from_time(cls, source):
        ...
        """
        return cls(hours=(source.hour), minutes=(source.minute), seconds=(source.second),
