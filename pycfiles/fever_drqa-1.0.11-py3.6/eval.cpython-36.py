...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/drqascripts/retriever/eval.py
# Compiled at: 2019-08-29 06:03:42
# Size of source mod 2**32: 5599 bytes
"""Evaluate the accuracy of the DrQA retriever module."""
import regex as re, logging, argparse, json, time, os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--match', type=str, default='string', choices=[
     'regex', 'string'])
    ...
    processes = ProcessPool(processes=(args.num_workers),
      initializer=init,
      initargs=(
     tok_class, tok_opts, db_class, db_opts))
