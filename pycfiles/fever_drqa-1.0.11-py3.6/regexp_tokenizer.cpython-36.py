...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/drqa/tokenizers/regexp_tokenizer.py
...
class RegexpTokenizer(Tokenizer):
    ...
    def __init__(self, **kwargs):
        ...
        """
        self._regexp = regex.compile(('(?P<digit>%s)|(?P<title>%s)|(?P<abbr>%s)|(?P<neg>%s)|(?P<hyph>%s)|(?P<contr1>%s)|(?P<alphanum>%s)|(?P<contr2>%s)|(?P<sdquote>%s)|(?P<edquote>%s)|(?P<ssquote>%s)|(?P<esquote>%s)|(?P<dash>%s)|(?<ellipses>%s)|(?P<punct>%s)|(?P<nonws>%s)' % (
