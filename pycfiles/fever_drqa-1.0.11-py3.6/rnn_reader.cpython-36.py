...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/drqa/reader/rnn_reader.py
...
class RnnDocReader(nn.Module):
    ...
    def __init__(self, args, normalize=True):
        ...
        self.question_rnn = layers.StackedBRNN(input_size=(args.embedding_dim),
          hidden_size=(args.hidden_size),
    ...
    def forward(self, x1, x1_f, x1_mask, x2, x2_mask):
        ...
        if self.args.question_merge == 'avg':
            ...
            if self.args.question_merge == 'self_attn':
