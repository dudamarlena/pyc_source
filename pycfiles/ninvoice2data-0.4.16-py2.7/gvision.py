...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/ninvoice2data/input/gvision.py
...
def to_text(path, bucket_name='cloud-vision-84893', language='fr'):
    ...
    Before using ninvoice2data, make sure you have the auth json path set as
    ...
    if result_blob is None:
        ...
        async_request = vision.types.AsyncAnnotateFileRequest(features=[
         feature], input_config=input_config, output_config=output_config)
