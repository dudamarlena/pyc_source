...
class VintageCrispyTestCase(BaseCrispyTestCase):
    ...
    def setUp(self):
        ...
        self.__overriden_settings = override_settings(**{'TEMPLATE_LOADERS': template_loaders, 
...
class ModernCrispyTestCase(BaseCrispyTestCase):
    ...
    def setUp(self):
        ...
        django_template_setting = [ s for s in template_settings if s['BACKEND'] == 'django.template.backends.django.DjangoTemplates'
                                  ][0]
        django_template_setting['DIRS'].insert(0, os.path.join(os.path.dirname(__file__), 'templates'))
        self.__overriden_settings = override_settings(TEMPLATES=[
