...
# [GCC 8.4.0]
# Embedded file name: /Users/uranusjr/Documents/programming/python/django-crispy-forms/django-crispy-forms-ng/crispy_forms/tests/forms.py
# Compiled at: 2015-04-08 04:25:53
...
class CheckboxesTestForm(forms.Form):
    checkboxes = forms.MultipleChoiceField(choices=((1, 'Option one'), (2, 'Option two'),
                                                    (3, 'Option three')), initial=(1, ), widget=forms.CheckboxSelectMultiple)
    alphacheckboxes = forms.MultipleChoiceField(choices=(('option_one', 'Option one'),
                                                         ('option_two', 'Option two'),
                                                         ('option_three', 'Option three')), initial=('option_two',
                                                                                                     'option_three'), widget=forms.CheckboxSelectMultiple)
    numeric_multiple_checkboxes = forms.MultipleChoiceField(choices=((1, 'Option one'),
                                                                     (2, 'Option two'),
                                                                     (3, 'Option three')), initial=(1,
                                                                                                    2), widget=forms.CheckboxSelectMultiple)
    inline_radios = forms.ChoiceField(choices=(('option_one', 'Option one'), ('option_two', 'Option two')), widget=forms.RadioSelect, initial='option_two')
