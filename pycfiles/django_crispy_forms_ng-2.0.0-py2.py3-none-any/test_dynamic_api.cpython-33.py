...
# [GCC 8.4.0]
# Embedded file name: /Users/uranusjr/Documents/programming/python/django-crispy-forms/django-crispy-forms-ng/crispy_forms/tests/test_dynamic_api.py
# Compiled at: 2015-04-08 03:54:55
# Size of source mod 2**32: 17157 bytes
...
from crispy_forms.layout import Layout, Fieldset, MultiField, HTML, Div, Field
...
class TestDynamicLayouts(CrispyTestCase):
    ...
    def setUp(self):
        ...
        self.advanced_layout = Layout(Div(Div(Div('email')), Div(Field('password1')), Submit('save', 'save'), Fieldset('legend', 'first_name', HTML('extra text')), Layout('password2')), 'last_name')
