...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/solstice/core/tray.py
...
class SolsticeTray(tray.ArtellaTray, object):
    ...
    def create_menu(self):
        ...
        doc_action = QAction(documentation_icon,
        ...
        email_action = QAction(email_icon,
          'Send Email',
          self,
