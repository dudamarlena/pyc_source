...
class Solstice(artella_project.ArtellaProject):
    ...
    def get_project_config_path(self):
        ...
        :return: str
        """
        return path_utils.clean_path(os.path.join(self.get_configurations_folder(), artella_defines.ARTELLA_PROJECT_CONFIG_FILE_NAME))
    ...
    def get_project_changelog_path(self):
        ...
        :return: str
        """
        return path_utils.clean_path(os.path.join(self.get_configurations_folder(), artella_defines.ARTELLA_PROJECT_CHANGELOG_FILE_NAME))
    ...
    def get_project_shelf_path(self):
        ...
        :return: str
        """
        return path_utils.clean_path(os.path.join(self.get_configurations_folder(), artella_defines.ARTELLA_PROJECT_SHELF_FILE_NAME))
    ...
    def get_project_version_path(self):
        ...
        :return: str
        """
        return path_utils.clean_path(os.path.join(self.get_configurations_folder(), artella_defines.ARTELLA_PROJECT_DEFAULT_VERSION_FILE_NAME))
    ...
    def get_publisher_plugin_paths(self):
        ...
        publisher_plugin_paths.append(path_utils.clean_path(os.path.join(self.get_project_path(), 'pipeline', 'tools', 'publisher', 'plugins')))
