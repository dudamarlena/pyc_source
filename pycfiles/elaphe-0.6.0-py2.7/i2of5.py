...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/i2of5.py
...
class Interleaved2of5(Barcode):
    ...
    aliases = ('interleaved_2_of_5', 'interleaved 2of5', 'interleaved_2of5', 'interleaved 2 of 5',
               'interleaved-2of5', 'i2of5', 'i-2of5')

    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, includecheck=False, includetext=False, textsize=10, textyoffset=-7, height=1)
