...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/plessey.py
...
class Plessey(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, dontdraw=False, includetext=False, validatecheck=False, includecheckintext=False, unidirectional=False, textsize=10, textyoffset=-7, height=1)
