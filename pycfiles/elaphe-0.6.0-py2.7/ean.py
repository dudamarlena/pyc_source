...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/ean.py
...
class Ean13(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, includetext=False, textsize=12, textyoffset=-4, height=1)
        code_bbox = [0, 0, 95, DPI]
        ...
        def text_bbox(self):
            ...
            if self.lookup_option('includetext'):
                return [-10, textyoffset, 85 + textsize * 0.5, textmaxh]
            else:
...
class ISBN(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        ...
        def text_bbox(self):
            ...
            textmaxh = textyoffset + textsize
            if self.lookup_option('includetext'):
                return [-10, textyoffset - textsize / 2.0, 85 + textsize * 0.5, textmaxh]
            else:
                return self.code_bbox
...
class Ean8(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        ...
        def text_bbox(self):
            ...
            textmaxh = textyoffset + textsize
            if self.lookup_option('includetext'):
                return [4, textyoffset, 57 + textsize * 0.5, textmaxh]
            else:
                return self.code_bbox
...
class Ean5(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, includetext=False, textsize=12, height=0.7)
        default_options.pop('textyoffset', None)

        @property
        def code_bbox(self):
            height = self.lookup_option('height')
            return [0, 0, 35, height * DPI]
        ...
        def text_bbox(self):
            ...
            if self.lookup_option('includetext'):
                return [4, textminy, 40 + textsize * 0.5, textmaxy]
            else:
                return self.code_bbox
...
class Ean2(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        ...
        def text_bbox(self):
            ...
            textmaxy = textyoffset + textsize
            if self.lookup_option('includetext'):
                return [4, textminy, 13 + textsize * 0.5, textmaxy]
            else:
                return self.code_bbox
