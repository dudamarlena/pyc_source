...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/bases.py
# Compiled at: 2013-06-16 19:12:31
try:
...
import utils
__all__ = [
 'DPI', 'Renderer', 'LinearCodeRenderer', 'MatrixCodeRenderer', 'Barcode']
DPI = 72.0
...
class LinearCodeRenderer(Renderer):
    default_options = dict(Renderer.default_options, barcolor=None, includetext=False, textcolor=None, textxalign=None, textyalign=None, textfont='Courier', textsize=10, textxoffset=0, textyoffset=0, bordercolor=None, backgroundcolor=None, inkspread=0.15, width=0, barratio=1, spaceratio=1, showborder=False, borderleft=10, borderright=10, bordertop=1, borderbottom=1, borderwidth=0.5, guardwhitespace=False, guardleftpos=0, guardrightpos=0, guardwidth=6, guardheight=7)


class MatrixCodeRenderer(Renderer):
    default_options = dict(Renderer.default_options, color=None, backgrroundcolor=None, height=1, width=1)
