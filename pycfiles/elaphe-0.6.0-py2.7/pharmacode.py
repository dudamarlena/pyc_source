...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/pharmacode.py
...
class Phamacode(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, height=22.68, nwidth=1.4175, wwidth=4.2524999999999995, swidth=2.835, textyoffset=-7, textsize=10)
        ...
        def _code_bbox(self, codestring):
            ...
            """
            return [
             0, 0, int(math.log(int(codestring), 2)) * 2 * 2.835,
