...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/royalmail.py
...
class RoyalMail(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, includetext=False, includecheckintext=False, textsize=10, textyoffset=-7, height=0.175)
        ...
        def _code_bbox(self, codestring):
            ...
            return [0, 0, 1.44 + codelen * 3.3120000000000003, height * DPI]
        ...
        def _text_bbox(self, codestring):
            ...
            if self.lookup_option('includetext'):
                ...
                return [
                 cminx, cminy - textsize, cmaxx, cmaxy]
            else:
