...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/postnet.py
...
class PostNet(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, includetext=False, includecheckintext=False, textsize=10, textyoffset=-7, height=0.125)
        ...
        def _code_bbox(self, codestring):
            ...
            return [0, 0, codelen * 3.3120000000000003 + 1.44, height * DPI]
