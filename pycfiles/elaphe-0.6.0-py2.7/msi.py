...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/msi.py
...
class MsiModifiedPlessey(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, height=1, includecheck=False, includecheckintext=False, includetext=False, textyoffset=-7, textsize=10)
        ...
        def _code_bbox(self, codestring):
            ...
            if self.lookup_option('includecheck'):
                ...
                return [
                 0, 0, 3 + len(codestring) * 12 + 4, height * DPI]
