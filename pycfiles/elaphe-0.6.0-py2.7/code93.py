...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/code93.py
# Compiled at: 2013-12-05 09:10:25
import re
from base import Barcode, LinearCodeRenderer, DPI
CODE93_ESCAPE_RE = re.compile('\\^\\d{3}')
...
class Code93(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, height=1, includecheck=False, includetext=False, textyoffset=-7, textsize=10)
