...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/code39.py
# Compiled at: 2013-12-05 09:10:25
import re
from base import Barcode, LinearCodeRenderer, DPI
CODE39_ESCAPE_RE = re.compile('\\^\\d{3}')
...
class Code39(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, height=1, hidestars=False, includecheck=False, includetext=False, includecheckintext=False, textyoffset=-7, textsize=10)
        ...
        def _text_bbox(self, codestring):
            ...
            return [
             0, textyoffset, textmaxx, textmaxy]
