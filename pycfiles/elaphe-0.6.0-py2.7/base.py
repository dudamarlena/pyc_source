...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/base.py
...
class Renderer(object):
    ...
    """
    default_options = dict(parse=False, parsefnc=False, raw=False, height=0, width=0)
...
class LinearCodeRenderer(Renderer):
    default_options = dict(Renderer.default_options, includecheck=False, includecheckintext=False, inkspread=0.15, includetext=False, textfont='Courier', textsize=10, textgaps=0, textxalign=None, textyalign=None, textxoffset=0, textyoffset=0, showborder=False, borderwidth=0.5, borderleft=10, borderright=10, bordertop=1, borderbottom=1, barcolor=None, backgroundcolor=None, textcolor=None, bordercolor=None, addontextfont='Courier', addontextsize=10, addontextxoffset=0, addontextyoffset=0, guardwhitespace=False, guardwidth=6, guardheight=7, guardleftpos=0, guardrightpos=0, guardleftypos=0, guardrightypos=0, barratio=1, spaceratio=1)


class MatrixCodeRenderer(Renderer):
    default_options = dict(Renderer.default_options, color=None, backgrroundcolor=None)
    ...
    def update_codetype_registry(cls):
        for subclass in cls.__subclasses__():
            ...
            if hasattr(subclass, 'aliases'):
                cls.registry.update(dict((alias.lower(), subclass) for alias in subclass.aliases))
