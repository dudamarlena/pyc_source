...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/maxicode.py
...
class MaxiCode(Barcode):
    ...
    class _Renderer(MatrixCodeRenderer):
        default_options = dict(MatrixCodeRenderer.default_options, mode=4, sam=-1)

        @property
        def code_bbox(self):
            col, row = [ v * 2.4945 for v in (29 + 1.0, 27.7152 + 1.1548) ]
            return (0, 0, col, row)
