...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/japanpost.py
...
class JapanPost(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, height=0.175, includetext=False, includecheckintext=False, textyoffset=-7, textsize=10)

        @property
        def code_bbox(self):
            height = self.lookup_option('height')
            return [0, 0, 67 * 3.3120000000000003 + 1.44, height * DPI]
