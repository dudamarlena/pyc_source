...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/elaphe/auspost.py
...
class AusPost(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
        default_options = dict(LinearCodeRenderer.default_options, height=0.175, includetext=False, textyoffset=-7, textsize=10, custinfoenc='character')
        ...
        def _code_bbox(self, codestring):
            ...
            """
            return [
             0, 0, self._code_length(codestring) * 3.3120000000000003 + 1.44,
