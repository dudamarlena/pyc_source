...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nodeconductor_zabbix/admin.py
...
class HostAdmin(structure_admin.ResourceAdmin):
    ...
    def pull_sla(self, request, queryset):
        ...
        message = ungettext('SLA pulling has been scheduled for one host', 'SLA pulling has been scheduled for %(tasks_scheduled)d hosts', tasks_scheduled)
