...
# [GCC 8.4.0]
# Embedded file name: /Users/robin/DO/GitHub/pbus/pbus/bus.py
# Compiled at: 2019-09-29 09:14:08
    ...
    def subscriber_with_handler(self, channel, handler):
        ...
        with self.lock:
            if ful_channel not in self.subscriber_map:
                ...
                self.subscriber_map[ful_channel] = {'mpss': []}
...
class RabbitMQBus(BaseBus):
    ...
    def publish(self, channel, data):
        ...
        self._pubchannel.basic_publish(exchange=self.exchange, routing_key=ful_channel, body=encode_data(data))
