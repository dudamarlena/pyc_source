...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/legaul/venv36/lib/python3.6/site-packages/minegauler/frontend/panel.py
# Compiled at: 2020-01-26 13:45:44
# Size of source mod 2**32: 7218 bytes
"""
...
class PanelWidget(QWidget):
    ...
    def __init__(self, parent, state_):
        """
        :param parent:
            Parent widget.
        :param state_:
    ...
    def set_face(self, state: Union[(FaceState, GameState, str)]) -> None:
        ...
        self._face_button.setPixmap(pixmap.scaled(26, 26, transformMode=(Qt.SmoothTransformation)))
...
class _CounterWidget(QLabel):
    __doc__ = 'A widget template for the counters.'
