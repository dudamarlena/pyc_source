...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/alembicmanager/widgets/alembicmanager.py
...
import artellapipe, artellapipe.tools.alembicmanager
