...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/simple_tensor/segmentation/deeplab.py
...
class DeepLab:
    ...
    def __init__(self, num_classes, input_tensor=None, input_shape=(None, 300, 300, 3), model_path='/home/model/resnet_v2_101/resnet_v2_101.ckpt', base_architecture='resnet_v2_101', output_stride=16, learning_rate=0.0001, is_training=True):
        """[summary]
