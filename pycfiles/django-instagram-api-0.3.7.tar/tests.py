...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-instagram-api/instagram_api/tests.py
# Compiled at: 2016-03-14 16:24:48
...
USER_ID_2 = 775667951
USER_ID_3 = 1741896487
MEDIA_ID = '934625295371059186_205828054'
MEDIA_ID_2 = '806703315661297054_190931988'
LOCATION_ID = 1
TAG_NAME = 'snowyday'
...
class UserTest(InstagramApiTestCase):
    ...
    def test_fetch_user_by_name(self):
        ...
        self.assertEqual(u.full_name, 'Телеканал ТНТ')
    ...
    def test_fetch_bad_string(self):
        ...
        self.assertEqual(u.full_name, 'I Am A Girl ¿And What?💁🏻✨👑💋')
    ...
    def test_fetch_users_with_full_name_overlength(self):
        ...
        self.assertEqual(user.full_name, 'Stas from Ishim Ишим Тюмень Ty')
        user = User.remote.fetch(2057367004)
        self.assertEqual(user.full_name, 'Кератин, Ботокс в Краснодаре ')
...
class MediaTest(InstagramApiTestCase):
    ...
    def test_fetch_user_media(self):
        ...
        self.assertEqual(media.count(), 53)
        self.assertEqual(media.count(), u.media_feed.count())
