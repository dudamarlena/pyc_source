...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/collective/collection/alphabetic/browser/topic_alphabetic.py
# Compiled at: 2009-06-10 19:16:37
...
class TopicAlphabeticView(BrowserView):
    ...
    def characters(self):
        ...
        return [ {'character': character, 'url_bit': '%s%s' % ('?character=', character), 'has_contents': self.has_contents(character), 'selected': self.selected_character() == character} for character in characters ]