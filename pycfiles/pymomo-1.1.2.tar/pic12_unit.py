...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/WellDone/pymomo/pymomo/config/site_scons/pic12_unit.py
# Compiled at: 2015-03-19 14:45:48
from SCons.Script import *
from SCons.Environment import Environment
import os, os.path, utilities, pic12
...
def build_unittest(test, arch, summary_env, cmds=None):
    ...
    if type.startswith('executive'):
        ...
        raw_results = env.gpsim_run(raw_log_path, [outscript, outhex])
        formatted_log = env.Command([build_formatted_log_name(env), build_status_name(env)], [raw_results, symtab], action=env.Action(process_unittest_log, 'Processing test log'))
