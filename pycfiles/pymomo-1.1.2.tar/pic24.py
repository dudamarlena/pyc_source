...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/WellDone/pymomo/pymomo/config/site_scons/pic24.py
...
def build_moduletest(test, arch):
    ...
    unit_env.Command(outlog, elffile, action=unit_env.Action("momo-picunit %s '%s' '%s'" % (arch.property('simulator_model'), elffile[1:], outlog[1:]), 'Running unit test'))
