...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/drcsterm/tff/tff.py
...
class Session():
    ...
    def add_subtty(self, term, lang, command, row, col, termenc, inputhandler=DefaultHandler(), outputhandler=DefaultHandler()):
        ...
        tty.resize(row, col)
        process = Process(tty)
        self._init_process(process, termenc, inputhandler, outputhandler, DefaultParser(), DefaultParser(), DefaultScanner(), DefaultScanner(), buffering=False)
 ...
 L.1235         0  LOAD_CLOSURE          0  'self'
                6  LOAD_CODE                <code_object onresize>
                9  MAKE_CLOSURE_0        0  None
               12  STORE_FAST            1  'onresize'

 L.1239        15  SETUP_EXCEPT         23  'to 41'

 L.1240        18  LOAD_GLOBAL           0  'signal'
 ...
 L.1249       136  LOAD_FAST             5  'xfd'
              139  JUMP_IF_FALSE        70  'to 212'
            142_0  THEN                     213
              142  POP_TOP          

 L.1250       143  SETUP_LOOP           67  'to 213'
              146  LOAD_FAST             5  'xfd'
              149  GET_ITER         
              150  FOR_ITER             55  'to 208'
              153  STORE_FAST            6  'fd'

 L.1251       156  LOAD_FAST             6  'fd'
 ...
 L.1259       276  LOAD_FAST             3  'rfd'
              279  JUMP_IF_FALSE       270  'to 552'
              282  POP_TOP          

 L.1260       283  SETUP_LOOP          267  'to 553'
              286  LOAD_FAST             3  'rfd'
              289  GET_ITER         
              290  FOR_ITER            255  'to 548'
              293  STORE_FAST            6  'fd'

 L.1261       296  LOAD_FAST             6  'fd'
              299  LOAD_FAST             2  'stdin_fileno'
              302  COMPARE_OP            2  ==
              305  JUMP_IF_FALSE        99  'to 407'
              308  POP_TOP          

 L.1262       309  LOAD_GLOBAL          15  'os'
 ...
 L.1283       604  LOAD_GLOBAL          27  'True'
 ...
 L.1285       633  SETUP_LOOP           53  'to 689'
 ...
 L.1286       649  LOAD_DEREF            0  'self'
              652  LOAD_ATTR             9  '_process_map'
              655  LOAD_FAST             6  'fd'
              658  BINARY_SUBSCR    
              659  STORE_FAST            7  'process'

 L.1287       662  LOAD_DEREF            0  'self'
 ...
 L.1294       737  LOAD_GLOBAL          27  'True'
 ...
 L.1300       814  LOAD_CONST               None
              817  RETURN_END_IF    
              818  POP_TOP          

 L.1301       819  LOAD_FAST            14  'no'
 ...
 L.1302       835  LOAD_CONST               None
              838  RETURN_END_IF    
              839  POP_TOP          

 L.1304       840  LOAD_FAST            13  'e'
 ...
 L.1306       855  SETUP_FINALLY        17  'to 875'

 L.1307       858  LOAD_DEREF            0  'self'
 ...
 L.1309       875  SETUP_LOOP           50  'to 928'
