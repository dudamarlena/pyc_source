...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/elseql/elseql.py
# Compiled at: 2018-02-06 20:57:15
...
import os, os.path, shlex, traceback
if False:
...
class ElseShell(Cmd):
    ...
    def __init__(self, port, debug):
        Cmd.__init__(self)
        self.settable.update({'prompt': 'Set command prompt', 
