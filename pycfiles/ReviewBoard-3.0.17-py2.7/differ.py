...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/diffviewer/differ.py
    ...
    def add_interesting_lines_for_headers(self, filename):
        ...
        if filename in HEADER_REGEX_ALIASES:
            ...
            for regex in regexes:
                self.add_interesting_line_regex(b'header', regex)
...
def get_differ(a, b, ignore_space=False, compat_version=DiffCompatVersion.DEFAULT):
    ...
    if compat_version in DiffCompatVersion.MYERS_VERSIONS:
        ...
        raise DiffCompatError(b'Invalid diff compatibility version (%s) passed to Differ' % compat_version)
