...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/repository_info.py
...
class RepositoryInfoResource(WebAPIResource):
    ...
    """
    name = b'info'
    policy_id = b'repository_info'
    singleton = True
    allowed_methods = ('GET', )
    mimetype_item_resource_name = b'repository-info'
