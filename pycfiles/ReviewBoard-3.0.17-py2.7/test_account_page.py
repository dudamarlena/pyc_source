...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/accounts/tests/test_account_page.py
...
from reviewboard.accounts.pages import AccountPage, get_page_classes, register_account_page_class, unregister_account_page_class
...
class AccountPageTests(TestCase):
    ...
    def test_register_account_page_class(self):
        ...
        class MyPage(AccountPage):
            page_id = b'test-page'
            page_title = b'Test Page'

        register_account_page_class(MyPage)
        self.assertEqual(set(get_page_classes()), self.builtin_pages | {MyPage})
