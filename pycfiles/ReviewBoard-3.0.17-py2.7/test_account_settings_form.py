...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/accounts/tests/test_account_settings_form.py
...
class AccountSettingsFormTests(TestCase):
    ...
    def test_save_syntax_highlighting_disabled(self):
        ...
        settings = {b'diffviewer_syntax_highlighting': False}
        with self.siteconfig_settings(settings):
            form = AccountSettingsForm(page, request, user, data={b'syntax_highlighting': False, 
               b'timezone': profile.timezone})
