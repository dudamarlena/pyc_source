...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/draft_screenshot.py
...
class DraftScreenshotResource(BaseScreenshotResource):
    ...
    draft is published.
    """
    name = b'draft_screenshot'
    uri_name = b'screenshots'
    ...
    def get_queryset(self, request, review_request_id, *args, **kwargs):
        try:
            ...
            inactive_ids = draft.inactive_screenshots.values_list(b'pk', flat=True)
