...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/root.py
...
class RootResource(WebAPIResource, DjbletsRootResource):
    ...
    """
    mimetype_vendor = b'reviewboard.org'
    ...
    def serialize_root(self, request, *args, **kwargs):
        root = super(RootResource, self).serialize_root(request, *args, **kwargs)
