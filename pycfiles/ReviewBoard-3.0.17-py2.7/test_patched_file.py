...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/tests/test_patched_file.py
...
class ResourceTests(ReviewRequestChildItemMixin, BaseWebAPITestCase):
    ...
    sample_api_url = b'review-requests/<id>/diffs/<id>/files/<id>/patched-file/'
    ...
    def setup_basic_get_test(self, user, with_local_site, local_site_name):
        ...
        filediff = self.create_filediff(diffset)
        return (
         get_patched_file_url(review_request, diffset, filediff, local_site_name=local_site_name),
         patched_file_mimetype,
         filediff)
    ...
    def test_with_deleted_file(self):
        ...
        rsp = self.api_get(get_patched_file_url(review_request, diffset, filediff), expected_status=404)
