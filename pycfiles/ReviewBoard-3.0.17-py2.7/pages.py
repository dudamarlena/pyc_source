...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/accounts/pages.py
...
from reviewboard.accounts.forms.pages import AccountSettingsForm, APITokensForm, AvatarSettingsForm, ChangePasswordForm, PrivacyForm, GroupsForm, OAuthApplicationsForm, OAuthTokensForm, ProfileForm
...
class AccountPageRegistry(ExceptionFreeGetterMixin, ConfigPageRegistry):
    ...
    def get_defaults(self):
        ...
        """
        return (
         PrivacyPage, ProfilePage, AccountSettingsPage, GroupsPage,
...
class AccountPage(DynamicConfigPageMixin, ConfigPage):
    ...
    def get_absolute_url(cls):
        ...
        assert cls.page_id
        return b'%s#%s' % (
         build_server_url(reverse(b'user-preferences')),
         cls.page_id)
...
class AuthenticationPage(AccountPage):
    ...
    """
    page_id = b'authentication'
    page_title = _(b'Authentication')
...
class OAuth2Page(AccountPage):
    ...
    page_id = b'oauth2'
    page_title = b'OAuth2 Applications'
...
class PrivacyPage(AccountPage):
    ...
    page_id = b'privacy'
    page_title = _(b'My Privacy Rights')
...
def register_account_page_class(cls):
    ...
    """
    warn(b'register_account_page_class is deprecated in Review Board 3.0 and will be removed; use AccountPage.registry.register instead.', RemovedInReviewBoard40Warning)
...
def unregister_account_page_class(page_cls):
    ...
    Args:
        page_cls (type):
            ...
            :py:class:`AccountPage`.
    """
    warn(b'unregister_account_page_class is deprecated in Review Board 3.0 and will be removed; use AccountPage.registry.unregister instead.', RemovedInReviewBoard40Warning)
...
def get_page_class(page_id):
    ...
    Returns:
        ...
        found.
    """
    warn(b'get_page_class is deprecated in Review Board 3.0 and will be removed; use AccountPage.registry.get instead.', RemovedInReviewBoard40Warning)
    return AccountPage.registry.get(b'page_id', page_id)
...
def get_page_classes():
    ...
    Yields:
        ...
        :py:class:`AccountPage`.
    """
    warn(b'get_page_classes is deprecated in Review Board 3.0 and will be removed; iterate through AccountPage.registry instead.', RemovedInReviewBoard40Warning)
