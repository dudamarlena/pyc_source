...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/avatars/services.py
# Compiled at: 2020-02-11 04:03:56
"""Review Board-specific specializations of avatar services."""
from __future__ import unicode_literals
from django.utils import six
from django.utils.six.moves.urllib.parse import urlparse
from djblets.avatars.services import FileUploadService as DjbletsFileUploadService
...
class FileUploadService(DjbletsFileUploadService):
    ...
    def get_avatar_urls_uncached(self, user, size):
        ...
        Returns
            ...
            and high-DPI.
        """
        urls = super(FileUploadService, self).get_avatar_urls_uncached(user, size)
        return {resolution:self._ensure_absolute(url) for resolution, url in six.iteritems(urls)}
