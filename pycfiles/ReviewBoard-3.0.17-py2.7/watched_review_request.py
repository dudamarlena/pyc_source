...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/watched_review_request.py
# Compiled at: 2020-02-11 04:03:57
from __future__ import unicode_literals
from djblets.util.decorators import augment_method_from
from reviewboard.webapi.decorators import webapi_check_local_site
from reviewboard.webapi.resources import resources
from reviewboard.webapi.resources.base_watched_object import BaseWatchedObjectResource
...
class WatchedReviewRequestResource(BaseWatchedObjectResource):
    ...
    """
    name = b'watched_review_request'
    uri_name = b'review-requests'
    profile_field = b'starred_review_requests'
    star_function = b'star_review_request'
    unstar_function = b'unstar_review_request'
    ...
    def serialize_object(self, obj, *args, **kwargs):
        return {b'id': obj.display_id, 
           self.item_result_key: obj}

    def get_watched_object(self, queryset, obj_id, local_site_name=None, *args, **kwargs):
        if local_site_name:
