...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/file_attachment.py
...
class FileAttachmentResource(BaseReviewRequestFileAttachmentResource):
    ...
    mimetype_list_resource_name = b'file-attachments'
    mimetype_item_resource_name = b'file-attachment'
