...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/review_reply_draft.py
...
class ReviewReplyDraftResource(WebAPIResource):
    ...
    """
    name = b'reply_draft'
    policy_id = b'review_reply_draft'
    singleton = True
    uri_name = b'draft'
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not reply:
            return DOES_NOT_EXIST
        return (302, {},
         {b'Location': self._build_redirect_with_args(request, resources.review_reply.get_href(reply, request, *args, **kwargs))})
