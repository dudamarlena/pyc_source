...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/hostingsvcs/tests/test_trac.py
...
class TracTests(ServiceTests):
    ...
    def test_get_bug_tracker_field(self):
        ...
        self.assertEqual(self.service_class.get_bug_tracker_field(None, {b'trac_url': b'http://trac.example.com'}), b'http://trac.example.com/ticket/%s')
        return