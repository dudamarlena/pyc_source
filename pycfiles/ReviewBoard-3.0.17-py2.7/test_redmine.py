...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/hostingsvcs/tests/test_redmine.py
...
class RedmineTests(ServiceTests):
    ...
    def test_get_bug_tracker_field(self):
        ...
        self.assertEqual(self.service_class.get_bug_tracker_field(None, {b'redmine_url': b'http://redmine.example.com'}), b'http://redmine.example.com/issues/%s')
        return