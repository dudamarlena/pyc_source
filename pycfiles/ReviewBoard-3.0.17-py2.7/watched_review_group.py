...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/watched_review_group.py
...
class WatchedReviewGroupResource(BaseWatchedObjectResource):
    ...
    """
    name = b'watched_review_group'
    uri_name = b'review-groups'
    profile_field = b'starred_groups'
    star_function = b'star_review_group'
    unstar_function = b'unstar_review_group'
