...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/resources/filediff_comment.py
...
class FileDiffCommentResource(BaseDiffCommentResource):
    ...
    """
    allowed_methods = ('GET', )
    policy_id = b'diff_comment'
    model_parent_key = b'filediff'
    uri_object_key = None
    mimetype_list_resource_name = b'file-diff-comments'
    mimetype_item_resource_name = b'file-diff-comment'
    ...
    def get_queryset(self, request, diff_revision, filediff_id, *args, **kwargs):
        ...
        """
        q = super(FileDiffCommentResource, self).get_queryset(request, *args, **kwargs)
        return q.filter(filediff__diffset__revision=diff_revision, filediff=filediff_id)
