...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/reviewboard/webapi/tests/test_draft_patched_file.py
...
class ResourceTests(BaseWebAPITestCase):
    ...
    sample_api_url = b'review-requests/<id>/draft/diffs/<id>/files/<id>/patched-file/'
    resource = resources.draft_patched_file
    ...
    def setup_http_not_allowed_list_test(self, user):
        ...
        return get_draft_patched_file_url(review_request, diffset, filediff)
    ...
    def setup_basic_get_test(self, user, with_local_site, local_site_name):
        ...
        filediff = self.create_filediff(diffset)
        return (
         get_draft_patched_file_url(review_request, diffset, filediff, local_site_name=local_site_name),
         patched_file_mimetype,
         filediff)

    def test_get_not_owner(self):
        """Testing the
        GET review-requests/<id>/draft/diffs/<id>/files/<id>/patched-file/ API
        without owner
        """
    ...
    def test_with_deleted_file(self):
        ...
        rsp = self.api_get(get_draft_patched_file_url(review_request, diffset, filediff), expected_status=404)
        self.assertEqual(rsp[b'stat'], b'fail')
