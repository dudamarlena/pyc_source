...
# [GCC 8.4.0]
# Embedded file name: ..\pycker\wiggle.py
# Compiled at: 2017-09-12 10:26:29
...
def wiggle(X, perc=1.0, taxis=None, norm=True, fill=True, axes=None, figsize=(12, 8)):
    """
    Wiggle plot.
    ...
    if not isinstance(perc, (int, float)) or perc < 0.0 or perc > 1.0:
    ...
    if norm and perc < 1.0:
        clip = np.percentile(np.abs(X.ravel()), perc * 100.0)
