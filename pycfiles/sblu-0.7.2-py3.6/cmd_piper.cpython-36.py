...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sblu/cli/docking/cmd_piper.py
...
FFTW_PLAN_TYPES = ('FFTW_ESTIMATE', 'FFTW_MEASURE', 'FFTW_PATIENT', 'FFTW_EXHAUSTIVE')
OPTIONS = ()
DEFAULTS = [
 '-c', '1.0',
 '--msur_k', '1.0',
...
def cli(rec, lig, piper_path, atmprm, coeffs, rotprm, n_rotations, n_eigenvectors, n_translations_per_rotation, fftw_plan_type, print_grids, output_dir):
