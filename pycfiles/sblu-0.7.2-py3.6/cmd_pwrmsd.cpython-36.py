...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sblu/cli/measure/cmd_pwrmsd.py
...
@click.option('--sort-ftresults', is_flag=True,
...
def cli(pdb_file, ftfile, rotprm, sort_ftresults, nftresults, only_ca, only_backbone, only_interface, interface_radius, rec, output):
    if only_interface:
        if rec is None:
