...
# [GCC 8.4.0]
# Embedded file name: /home/lkrajice/Redhat/metaxor/python-lightblue/src/tests/test_service.py
# Compiled at: 2020-04-20 06:25:19
...
class TestLightBlueService(TestCase):
    ...
    def setUp(self):
        ...
        self.service = LightBlueService(self.data_url, self.metadata_url, ssl_certificate='path/to/cert')

    def test_custom_session(self):
        session = requests.session()
        service = LightBlueService(self.data_url, self.metadata_url, ssl_certificate='path/to/cert', custom_session=session)
    ...
    def test_insert_data(self, mock_put):
        ...
        self.assertEqual(call_args[0][0], ('{}/insert/entity/version').format(self.data_url))
    ...
    def test_delete_data(self, mock_post):
        ...
        self.assertEqual(call_args[0][0], ('{}/delete/entity/version').format(self.data_url))
        self.assertEqual(call_args[1], {'json': data})
        self.assertEqual(result, resp_data)
    ...
    def test_update_data(self, mock_post):
        ...
        call_args = mock_post.call_args
        self.assertEqual(call_args[0][0], ('{}/update/entity/version').format(self.data_url))
        self.assertEqual(call_args[1], {'json': data})
        self.assertEqual(result, resp_data)
    ...
    def test_find_data(self, mock_post):
        ...
        call_args = mock_post.call_args
        self.assertEqual(call_args[0][0], ('{}/find/entity/version').format(self.data_url))
        self.assertEqual(call_args[1], {'json': data})
        self.assertEqual(result, resp_data)
