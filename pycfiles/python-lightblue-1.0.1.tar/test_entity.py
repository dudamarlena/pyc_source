...
# [GCC 8.4.0]
# Embedded file name: /home/lkrajice/Redhat/metaxor/python-lightblue/src/tests/test_entity.py
# Compiled at: 2020-03-23 08:29:53
...
class TestLightBlueEntity(TestCase):
    ...
    def setUp(self):
        ...
        self.lb_entity = LightBlueEntity(self.fake_lightblue_service, 'fake-name', 'fake_version')
    ...
    def test_get_schema_class_version(self):
        ...
        """
        self.lb_entity.get_schema()
        self.fake_lightblue_service.get_schema.assert_called_once_with(self.lb_entity.entity_name, self.lb_entity.version)
    ...
    def test_get_schema_given_version(self):
        ...
        self.fake_lightblue_service.get_schema.assert_called_once_with(self.lb_entity.entity_name, 'my_version')

    def test_insert_data(self):
        """
        Test insert new data
        """
        expected_data = {'objectType': self.lb_entity.entity_name, 
           'data': 'fake_data', 
        ...
        self.fake_lightblue_service.insert_data.assert_called_once_with(self.lb_entity.entity_name, self.lb_entity.version, expected_data)
    ...
    def test_delete_all(self):
        ...
        expected_data = {'objectType': self.lb_entity.entity_name, 
           'version': self.lb_entity.version, 
           'query': {'field': 'objectType', 
                     'op': '=', 
                     'rvalue': self.lb_entity.entity_name}}
        self.lb_entity.delete_all()
        self.fake_lightblue_service.delete_data.assert_called_once_with(self.lb_entity.entity_name, self.lb_entity.version, expected_data)
    ...
    def test_update_item(self):
        ...
        self.fake_lightblue_service.update_data.assert_called_once_with(self.lb_entity.entity_name, self.lb_entity.version, expected_data)
    ...
    def test_find_item(self):
        ...
        self.fake_lightblue_service.find_data.assert_called_once_with(self.lb_entity.entity_name, self.lb_entity.version, expected_data)
    ...
    def test_find_paginated(self, mock_check_response):
        ...
        result = self.lb_entity.find_paginated(200, find_func, 'a', 'b', 'c', d='e')
        self.assertEqual(result, ['value 1', 'value 2', 'value 3'])
        self.assertEqual(find_func.call_args_list, [
    ...
    def test_find_paginated_one_page(self, mock_check_response):
        ...
        find_func.side_effect = [
         {'processed': [
                        'value 1', 'value 2']}, {'processed': []}]
        mock_check_response.return_value = True
        result = self.lb_entity.find_paginated(100, find_func, 'a', 'b', 'c', d='e')
    ...
    def test_find_paginated_no_results(self, mock_check_response):
        find_func = Mock()
        find_func.side_effect = [{'processed': []}]
        mock_check_response.return_value = True
        result = self.lb_entity.find_paginated(100, find_func, 'a', 'b', 'c', d='e')
    ...
    def test_find_paginated_invalid_response(self, mock_check_response):
        ...
        find_func.side_effect = [
         ...
         {'processed': [
                        'value 3']}]
        mock_check_response.side_effect = [
         True, False, True]
        result = self.lb_entity.find_paginated(100, find_func, 'a', 'b', 'c', d='e')
