...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/eagle_automation/pea.py
# Compiled at: 2015-08-23 07:20:43
...
import pkg_resources, sys, docopt, logging
...
def main():
    args = docopt.docopt(__doc__.format(base=sys.argv[0], version=__version__), version=__version__, options_first=True)
    if args['--verbose']:
    ...
    sys.argv = [
     sys.argv[0]] + [args['<command>']] + args['<args>']
