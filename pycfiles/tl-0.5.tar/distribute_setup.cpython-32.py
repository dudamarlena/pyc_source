...
# [GCC 8.4.0]
# Embedded file name: /home/bart/test/first/bootstrap/distribute_setup.py
# Compiled at: 2012-11-09 13:50:49
...
"""
import os, sys, time, fnmatch, tempfile, tarfile
...
def use_setuptools(version=DEFAULT_VERSION, download_base=DEFAULT_URL, to_dir=os.getcwd(), download_delay=15, no_fake=True):
...
def _remove_flat_installation(placeholder):
    if not os.path.isdir(placeholder):
        ...
        patched or log.warn('%s already patched.', pkg_info)
        return False
