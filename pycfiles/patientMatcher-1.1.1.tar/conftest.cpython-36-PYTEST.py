...
# [GCC 8.4.0]
# Embedded file name: /Users/chiararasi/Documents/work/GITs/patientMatcher/tests/conftest.py
# Compiled at: 2019-04-23 03:57:58
# Size of source mod 2**32: 8223 bytes
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, os, pytest, mongomock
...
def match_objs():
    ...
    matches = [
     ...
     {'_id':'match_3', 
      'has_matches':True, 
      'data':{'patient': {'id':'external_patient_1', 
                   'contact':{'href': 'mailto:test_contact@email.com'}}}, 
      'results':[
       {'node':{'id':'test_node1', 
         'label':'Test Node 1'}, 
...
def json_patients():
    ...
    fakey_patients = [
     {'contact':{'href':'mailto:contact_email@email.com', 
...
def async_response_obj(test_node, json_patients):
    ...
    an async server"""
    async_response = {'_id':'async_obj_id', 
     'query_id':'test_query_id', 
     'node':{'id':test_node['_id'], 
