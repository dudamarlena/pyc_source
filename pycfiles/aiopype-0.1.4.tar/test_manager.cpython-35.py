...
# [GCC 8.4.0]
# Embedded file name: /Users/jorgeramos/Projects/uphold/aiopype/tests/test_manager.py
...
class TestDescriptiveManager(TestCase):
    ...
    def test_init(self, registry_mock):
        ...
        registry_mock.REGISTRY = {'mocksource': mocksource}

        class MockDescriptiveManager(DescriptiveManager):
            name = 'mockmanager'
            processors = {'source': {'cls': 'mocksource', 
                        'args': ['a', 'b'], 
                        'kwargs': {'c': 1}}}
            flows = [
             {'event': 'mockevent', 
