...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/kpages/utility.py
# Compiled at: 2019-08-12 20:21:24
"""
    author comger@gmail.com
"""
import os, sys, imp, datetime, builtins
...
def refresh_config(*args):
    ...
    for py in pys:
        if os.path.exists(py):
            exec compile(open(py, 'rb').read(), py, 'exec') in dct
...
__all__ = [
 'app_path', 'not_empty', 'refresh_config', 'reflesh_config', 'mongo_conv',
