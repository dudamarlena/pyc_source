...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/kpages/kpages_service.py
# Compiled at: 2019-01-22 20:15:43
"""
    系统队列处理服务
...
def main():
    ...
    Service(host=__conf__.CACHE_HOST or opts.host, channel=__conf__.SERVICE_CHANNEL or opts.channel, callback=_show_info).run()
    return
