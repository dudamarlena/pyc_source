...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/kpages/service.py
# Compiled at: 2019-08-12 20:18:57
"""
    Reids MQ Service
...
"""
import time, copy, datetime, json, traceback, pkgutil, time, sched, threading
...
class Service(object):
    ...
    def __init__(self, host=None, channel=None, callback=None):
        ...
        if callback:
            kwargs = dict(host=self._host, channel=self._channel, processes=self._processes, services=self._services, debug=__conf__.DEBUG)
            callback(**kwargs)
...
__all__ = [
 'Service', 'srvcmd', 'service_async', 'srvtimer', 'service_async_queue']