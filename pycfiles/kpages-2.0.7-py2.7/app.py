...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/kpages/app.py
# Compiled at: 2019-08-13 01:36:19
"""
    author comger@gmail.com
"""
import tornado.web, tornado.ioloop, tornado.options
...
class WebApp(object):
    ...
    def _get_webapp(self):
        settings = {'debug': __conf__.DEBUG, 'static_path': app_path(__conf__.STATIC_DIR_NAME), 
...
__all__ = [
 'run', 'WebApp', 'get_ui_modules', 'get_ui_methods']