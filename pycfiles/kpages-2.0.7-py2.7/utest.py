...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/kpages/utest.py
# Compiled at: 2019-08-14 20:48:15
"""
    auto test tools
...
def load_testcase(module=None):
    ...
    testcases = _get_members(__conf__.UTEST_DIR, member_filter=_filter, in_module=module)
    return testcases
