...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pg_python2/_update.py
...
def make_postgres_update_multiple_statement(table, column_to_update, columns_to_query_lst, query_values_dict_lst, print_debug_log=True):
    """
