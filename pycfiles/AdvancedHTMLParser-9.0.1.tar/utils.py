...
# Embedded file name: /Users/moul/Git/moul/advanced-ssh-config/venv2.6/lib/python2.6/site-packages/advanced_ssh_config/utils.py
# Compiled at: 2015-07-22 04:04:35
import logging, re, os, errno, subprocess, psutil
...
def validate_host(host):
    if type(host).__name__ not in ('str', 'unicode'):
    ...
    if type(value) == int:
        ...
        if matches:
            ...
            if val:
                ...
                new_value = re.sub(('\\${}').format(var), val, value)
...
LOGGING_LEVELS = {'crit': logging.CRITICAL, 
