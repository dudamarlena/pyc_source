...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/easyapi/tests/test_extract_params.py
# Compiled at: 2014-07-14 17:18:25
...
def test_extract_model(api_request_factory):
    ...
    param_types = {'company': model_param(Company)}
...
def test_extract_list(api_request_factory, list_str, result):
    param_types = {'my_list': list_param}
