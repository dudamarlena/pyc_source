...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fpga_i2c_bridge/net/error.py
# Compiled at: 2020-01-14 10:32:53
...
class I2CException(BaseException):
    __doc__ = 'Base I2C exception. This gets thrown when a generic I2C communication error occurs.'
...
class I2CUnknownOpcodeException(I2CException):
    __doc__ = 'Exception that gets thrown when the FPGA reported an unknown opcode.'
...
class I2CNoSuchDeviceException(I2CException):
    __doc__ = 'Exception that gets thrown when the FPGA reported that an unknown device has been addressed.'
...
class I2CNoDataException(I2CException):
    __doc__ = 'Exception that gets thrown when no data is available for  a polling request.'
...
class I2CSendCRCFailureException(I2CException):
    __doc__ = 'Exception that gets thrown when the API encountered erroneous CRC data from the FPGA.'
...
class I2CRecvCRCFailureException(I2CException):
    __doc__ = 'Exception that gets thrown when the FPGA reported a CRC error in a transmission from the API.'
...
class I2CCommunicationError(I2CException):
    __doc__ = 'Exception that gets thrown when too many CRC errors happened in a row, aborting the communication.'
