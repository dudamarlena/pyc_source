...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fpga_i2c_bridge/__main__.py
# Compiled at: 2020-04-15 07:12:05
...
class WriteCommand(Command):
    ...
    def __init__(self, raw=False, *args, **kwargs):
...
class Shell:
    ...
    def register_command(self, names, command, help_text='', hide_in_help=False):
        if isinstance(names, tuple):
            ...
            self.commands[names] = (
             command, help_text, hide_in_help)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--dummy-appliances', default='1,2,3,4', help='Comma-separated list of dummy appliance IDs. Use with --dummy.')
    argparser.add_argument('--dummy-sensors', default='1,2,3,4,5', help='Comma-separated list of dummy sensor IDs. Use with --dummy.')
    argparser.add_argument('--dummy-error-ratio', default=0.0, type=float, help='Bit error ratio for dummy device communication (0..1). Defaults to 0.0. Use with --dummy.')
