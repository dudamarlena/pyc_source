...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv5tel/egg/autoextractor/autoextractor.py
# Compiled at: 2012-01-14 12:51:25
import os, re, subprocess, logging, logging.handlers, shutil, sys, argparse, cPickle as pickle, atexit, settings
