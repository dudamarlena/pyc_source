...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\cube\preferences.py
# Compiled at: 2007-04-06 03:37:36
from Tkinter import *
...
class ScrolledFrame(Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.canvas = Canvas(self, yscrollcommand=self.vscrollbar.set, xscrollcommand=self.hscrollbar.set, width=width, height=height)
