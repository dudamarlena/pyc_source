...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/assignment_test.py
# Compiled at: 2020-04-27 11:46:09
...
class AssignmentTest(unittest.TestCase):
    ...
    def test_assignment_to_keyword(self):
        ...
        expected_message = get_formatted_message('invalid_assignment',
          statement='None = 1', line_start=1, line_end=1)
