...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\Compiler\test_Compiler.py
# Compiled at: 2019-06-09 09:36:58
...
class TestCompiler(unittest.TestCase):
    ...
    def test_compile_single_file(self):
        ...
        self.expected_command = [
         test_compiler_exe_path, config['compile_flag'], config['define_flag'] + defines[0], config['define_flag'] + defines[1],
        ...
        self.expected_command = [
         test_compiler_exe_path, config['compile_flag'], config['define_flag'] + defines[0],
