...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\Linker\test_Linker.py
# Compiled at: 2019-06-09 09:35:17
# Size of source mod 2**32: 2336 bytes
import os, time, shutil, subprocess, unittest
...
config = {'comand_line_file':'@', 
 'output_flag':'-o'}
flags = [
 '-lgtest']
files_to_link = [
 'test1.o', 'test2.o', 'test3.o', 'test4.o', 'test5.o', 'test6.o']
output_file = 'output'
time_value = 10
...
class TestLinker(unittest.TestCase):
    ...
    def test_compile_single_file(self):
        ...
        self.expected_command = [
         test_linker_exe_path, flags[0], config['comand_line_file'] + str(time_value) + 'linker_file', config['output_flag'] + output_file]
