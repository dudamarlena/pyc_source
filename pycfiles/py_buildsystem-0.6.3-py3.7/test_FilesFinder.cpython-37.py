...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\FilesFinder\test_FilesFinder.py
...
test_files_names = [
 'test.c', 'test.h', 'test.o', 'test_test.c', 'test_test.h', 'test_test.o', 'test_c_test.c',
 'test_h_test.h', 'test_o_test.o', 'testc']
test_files_in_directories = [
 '/tes1/test1.c', '/test1/test1.h', '/test1/test1.o', '/tes2/test2.c', '/test2/test2.h', '/test2/test2.o']
...
class TestFileFinder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for file in self.all_files:
            if not '/test1/' in file:
                '/test2/' in file or self.excludeded_paths.append(file)
