...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/eztemplate/engines/string_formatter_engine.py
# Compiled at: 2016-02-29 01:53:09
...
class FormatterWrapper(string.Formatter):
    ...
    def get_value(self, key, args, kwargs):
        ...
        if self.tolerant and not isinstance(key, basestring) and key not in kwargs:
            key = str(key)
        return kwargs[key]
    ...
    def get_field(self, field_name, args, kwargs):
        ...
        try:
            obj, arg_used = super(FormatterWrapper, self).get_field(field_name, args, kwargs)
