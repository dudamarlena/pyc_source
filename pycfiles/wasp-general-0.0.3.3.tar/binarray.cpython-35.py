...
# [GCC 8.4.0]
# Embedded file name: /home/ale/progr/github/wasp-general/wasp_general/types/binarray.py
# Compiled at: 2016-09-22 06:23:51
...
class WBinArray:
    ...
    def __init__(self, value=0, size=None):
        ...
        self._WBinArray__value = int(value)
        self._WBinArray__size = size
        if self._WBinArray__size is not None and self._WBinArray__value > 2 ** self._WBinArray__size - 1:
    ...
    def __len__(self):
        """ Return size if array has fixed size, otherwise return bits count
                ...
                :return: int
                """
        if self._WBinArray__size is not None:
            return self._WBinArray__size
        else:
            if self._WBinArray__value == 0:
                return 1
            return self._WBinArray__value.bit_length()
    ...
    def __getitem__(self, item):
        ...
        if isinstance(item, int):
            ...
            if self._WBinArray__value & mask > 0:
                return 1
            return 0
        else:
    ...
    def __setitem__(self, key, value):
        ...
        if self._WBinArray__size is not None:
            ...
            if value == 0:
                ...
                self._WBinArray__value = self._WBinArray__value & mask
        else:
            mask = 1 << len(self) - key - 1
            self._WBinArray__value = self._WBinArray__value | mask
    ...
    def __int__(self):
        """ Convert to integer
                ...
                :return: int
                """
        if self._WBinArray__size is None:
            return self._WBinArray__value
        else:
            mask = 2 ** self._WBinArray__size - 1
            return self._WBinArray__value & mask
    ...
    def resize(self, size):
        """ Resize current array. If size is None, then array became nonfixed-length array. If new size is
                ...
                """
        if size is not None:
            self._WBinArray__value = int(WBinArray(self._WBinArray__value)[:size])
        self._WBinArray__size = size
    ...
    def split(self, bits_count):
        """ Split array into smaller parts. Each small array is fixed-length WBinArray (length of that array is
                ...
                """
        result = []
        array = WBinArray(self._WBinArray__value, self._WBinArray__size)
