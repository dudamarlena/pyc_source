...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/dame/utils.py
# Compiled at: 2020-05-04 18:06:59
# Size of source mod 2**32: 2787 bytes
import os, tempfile
from pathlib import Path
from zipfile import ZipFile
import click, requests, validators, yaml
...
def url_validation(url):
    if validators.url(url):
        return True
    if Path.is_file(Path(url).expanduser().resolve()):
        return True
