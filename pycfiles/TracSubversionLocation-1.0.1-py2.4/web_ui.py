...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/subversionlocation/web_ui.py
# Compiled at: 2009-02-09 15:17:50
...
class BrowserLinkAdder(Component):
    ...
    svn_base_url = Option('svn', 'repository_url', doc='base URL of svn repository')
    pattern = re.compile('/browser(/.*|$)')

    def url(self, path):
        return ('/').join((self.svn_base_url.rstrip('/'), path.lstrip('/')))
