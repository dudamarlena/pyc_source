...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\ev3dev\ev3.py
# Compiled at: 2017-10-13 09:54:43
...
class EV3_TACHO(_object):
    ...
    if _newclass:
        type_inx = _swig_property(_ev3.EV3_TACHO_type_inx_get, _ev3.EV3_TACHO_type_inx_set)
    __swig_setmethods__['port'] = _ev3.EV3_TACHO_port_set
    __swig_getmethods__['port'] = _ev3.EV3_TACHO_port_get
    if _newclass:
        port = _swig_property(_ev3.EV3_TACHO_port_get, _ev3.EV3_TACHO_port_set)
    __swig_setmethods__['extport'] = _ev3.EV3_TACHO_extport_set
    __swig_getmethods__['extport'] = _ev3.EV3_TACHO_extport_get
    if _newclass:
        extport = _swig_property(_ev3.EV3_TACHO_extport_get, _ev3.EV3_TACHO_extport_set)
...
class EV3_DC(_object):
    ...
    if _newclass:
        type_inx = _swig_property(_ev3.EV3_DC_type_inx_get, _ev3.EV3_DC_type_inx_set)
    __swig_setmethods__['port'] = _ev3.EV3_DC_port_set
    __swig_getmethods__['port'] = _ev3.EV3_DC_port_get
    if _newclass:
        port = _swig_property(_ev3.EV3_DC_port_get, _ev3.EV3_DC_port_set)
    __swig_setmethods__['extport'] = _ev3.EV3_DC_extport_set
    __swig_getmethods__['extport'] = _ev3.EV3_DC_extport_get
    if _newclass:
        extport = _swig_property(_ev3.EV3_DC_extport_get, _ev3.EV3_DC_extport_set)
