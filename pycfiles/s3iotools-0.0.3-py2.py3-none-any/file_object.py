...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/s3iotools-project/s3iotools/io/file_object.py
# Compiled at: 2019-05-20 08:50:00
import boto3
...
class S3FileObject(Boto3Backed):
    bucket_name = attr.ib()
    key = attr.ib()
    aws_profile = attr.ib(default='default')
