...
# [GCC 8.4.0]
# Embedded file name: s3iotools/utils/s3_obj_filter.py
# Compiled at: 2019-05-20 08:41:56
"""
...
class FiltersConstructor(object):
    ...
    def by_extension(self, ext, case_sensitive=False, is_classmethod=False, is_staticmethod=False, is_regularmethod=False):
        self.validate_method_type_args(is_classmethod, is_staticmethod, is_regularmethod)
        if case_sensitive:
            if is_classmethod:
    ...
    def by_basename(self, basename, case_sensitive=False, is_classmethod=False, is_staticmethod=False, is_regularmethod=False):
        self.validate_method_type_args(is_classmethod, is_staticmethod, is_regularmethod)
        if case_sensitive:
            if is_classmethod:
