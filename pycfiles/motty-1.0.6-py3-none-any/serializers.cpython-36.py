...
# [GCC 8.4.0]
# Embedded file name: /Users/idohyeon/Projects/motty/motty/app/serializers.py
# Compiled at: 2017-11-24 22:21:47
...
class ActionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Action
        fields = ('id', 'resource', 'name', 'url', 'method', 'contentType', 'body',
                  'created_at')
