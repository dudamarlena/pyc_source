...
class ValidateFiling(ValidateXbrl.ValidateXbrl):
    ...
    def validate(self, modelXbrl, parameters=None):
        ...
        if disclosureSystem.deiFilerNameElement in deiItems:
            ...
            if paramFilerIdentifiers and paramFilerNames and entityIdentifierValue in paramFilerIdentifiers:
                ...
                if len(contextIDs) > 0:
                    ...
                    if disclosureSystem.GFM or disclosureSystemVersion[0] >= 27 or documentType in {'N-CSRS/A', '10-K', 'N-CSRS', '10-KT', 'N-Q', '10-Q/A', '40-F', '10-Q', 'N-Q/A', '20-F', '10/A', 'N-CSR', 'N-CSR/A', '40-F/A', '10', '20-F/A', '10-QT', '10-QT/A', '10-KT/A', '10-K/A'}:
        ...
        if not documentPeriodEndDate:
            ...
            if documentType not in {'8-K12B/A', 'F-10', 'SP 15D2', 'F-4EF', 'S-4MEF', 'F-10/A', '20-F', '20FR12B/A', 'F-4 POS', '40FR12B/A', 'L SDR', '10-12B/A', '497', '6-K/A', 'SD/A', 'S-4EF', 'N-CSRS/A', '8-K15D5', '10-K', 'F-4MEF', 'S-1MEF', '40FR12G/A', 'F-9/A', 'F-6', '10-12B', 'POSASR', '8-K12G3/A', 'N-Q/A', 'N-CSR', 'F-4', 'S-4/A', '20FR12B', '8-K15D5/A', 'F-3MEF', 'F-3', 'S-3', 'S-11/A', '40FR12B', '8-K', 'POS AM', 'S-3MEF', 'F-1MEF', 'S-1/A', '485BPOS', 'F-3ASR', 'S-BMEF', 'S-3/A', 'N-Q', 'N-1A/A', 'SD', '20FR12G/A', 'POS EX', 'S-B', 'S-20', '10-12G', 'N-CSR/A', 'S-4 POS', '20-F/A', '8-K12G3', 'F-4/A', 'S-4', '8-K/A', '20FR12G', 'SP 15D2/A', 'F-3DPOS', 'S-1', 'POS462B', 'F-10POS', '10-KT/A', '10-K/A', '40FR12G', 'N-CSRS', '10-KT', 'S-3D', '10-Q/A', '40-F', 'POS462C', 'F-9', 'F-10EF', 'Other', '8-K12B', 'F-9 POS', '10-Q', 'N-1A', '40-F/A', '6-K', 'S-3DPOS', 'S-11', 'S-11MEF', 'S-3ASR', '10-12G/A', 'K SDR', '10-QT', 'F-1', 'F-3D', 'F-1/A', '10-QT/A', 'F-3/A', 'F-9EF'}:
 ...
 'S-3MEF', 'S-BMEF'), 
            ...
            if documentType in doctypesRequired:
                for deiItem in deiItemsRequired:
                    if deiItem not in deiItems or not deiItems[deiItem]:
                        modelXbrl.log('WARNING' if validateEFMpragmatic and deiItem in {'EntityPublicFloat', 'CurrentFiscalYearEndDate', 'DocumentFiscalYearFocus', 'EntityFilerCategory', 'EntityWellKnownSeasonedIssuer', 'EntityCurrentReportingStatus', 'EntityVoluntaryFilers', 'DocumentFiscalPeriodFocus'} else 'ERROR', 'EFM.6.05.21.{0}'.format(deiItem) if validateEFMpragmatic and deiItem in {'EntityCurrentReportingStatus', 'EntityPublicFloat', 'CurrentFiscalYearEndDate', 'DocumentFiscalYearFocus', 'EntityFilerCategory', 'EntityWellKnownSeasonedIssuer', 'EntityRegistrantName', 'EntityCentralIndexKey', 'EntityVoluntaryFilers', 'DocumentFiscalPeriodFocus'} else 'EFM.6.23.36' if deiItem == 'EntityReportingCurrencyISOCode' else 'EFM.6.05.21', _("dei:%(elementName)s is required for DocumentType '%(documentType)s' of context %(contextID)s"), modelObject=documentTypeFact, contextID=documentTypeFact.contextID, documentType=documentType, elementName=deiItem, messageCodes=('EFM.6.05.21.CurrentFiscalYearEndDate',
        ...
        if documentType in {'20-F/A', '10-K', '10-Q', '10-KT', '10-KT/A', '10-K/A', '20-F', '40-F', '10-Q/A', '40-F/A', '10-QT', '10-QT/A'}:
