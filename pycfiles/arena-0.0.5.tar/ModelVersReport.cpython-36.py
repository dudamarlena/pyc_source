                    ...
                    if self.toDTS is None:
                        ...
                        if ns in (XbrlConst.vercu, XbrlConst.vercb):
                            ...
                            if ns in (XbrlConst.vercd, XbrlConst.verce):
                                if ln in {'conceptAbstractChange', 'conceptBalanceChange', 'conceptFixedChange', 'conceptBlockChange', 'conceptNillableChange', 'conceptLabelChange', 'conceptLabelDelete', 'conceptFinalChange', 'tupleContentModelChange', 'conceptAttributeChange', 'conceptReferenceChange', 'conceptAttributeAdd', 'conceptDefaultChange', 'conceptPeriodTypeChange', 'conceptAttributeDelete', 'conceptTypeChange', 'conceptIDChange', 'conceptSubstitutionGroupChange', 'conceptReferenceAdd', 'conceptLabelAdd', 'conceptReferenceDelete'} and modelAction is not None:
                                    modelAction.events.append(modelObject)
                            else:
