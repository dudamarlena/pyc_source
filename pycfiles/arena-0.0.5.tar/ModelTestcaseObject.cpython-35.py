...
# Embedded file name: /tmp/pip-install-ncu5lfw4/arelle/arelle/ModelTestcaseObject.py
...
class ModelTestcaseVariation(ModelObject):
    ...
    def readMeFirstUris(self):
        try:
            ...
            if not any(pluginXbrlMethod(self) for pluginXbrlMethod in pluginClassMethods('ModelTestcaseVariation.ReadMeFirstUris')):
                if self.localName == 'testGroup':
