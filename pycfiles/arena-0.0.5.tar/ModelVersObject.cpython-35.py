...
# Embedded file name: /tmp/pip-install-ncu5lfw4/arelle/arelle/ModelVersObject.py
# Compiled at: 2018-08-09 04:11:41
# Size of source mod 2**32: 26610 bytes
...
class ModelConceptChange(ModelVersObject):
    ...
    def viewText(self, labelrole=XbrlConst.conceptNameLabelRole, lang=None):
        ...
        toConcept = self.toConcept
        if labelrole != XbrlConst.conceptNameLabelRole and (fromConceptQname is None or fromConceptQname is not None and fromConcept is not None) and (toConceptQname is None or toConceptQname is not None and toConcept is not None):
