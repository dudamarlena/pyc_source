...
# [GCC 8.4.0]
# Embedded file name: ./../tablets/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Template',
      ...
      (
       'parent', models.ForeignKey(related_name='children', blank=True, to='tablets.Template', help_text='Select another template this template should extend.', null=True, on_delete=(models.CASCADE)))],
