...
# [GCC 8.4.0]
# Embedded file name: /Users/craiglabenz/Sites/tablets/tablets/admin.py
# Compiled at: 2017-05-30 14:02:07
...
class AceWidgetMixin(object):
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        if getattr(settings, 'USE_ACE_WIDGET', True) and db_field.name == 'content':
            kwargs['widget'] = AceWidget(mode=getattr(settings, 'ACE_MODE', 'twig'), theme=getattr(settings, 'ACE_THEME', 'chrome'), width=getattr(settings, 'ACE_WIDTH', '100%'), height=getattr(settings, 'ACE_HEIGHT', '300px'))
