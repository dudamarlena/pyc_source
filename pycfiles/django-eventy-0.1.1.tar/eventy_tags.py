...
# [GCC 8.4.0]
# Embedded file name: /home/powellc/projects/uucastine/build/uucastine_org/eventy/templatetags/eventy_tags.py
# Compiled at: 2011-04-11 23:41:52
...
def do_get_next_events(parser, token):
    ...
    if argc == 6:
        (t, limit, f, cal_slug, a, varname) = args
    elif argc == 8:
        (t, limit, f, cal_slug, b, excluded_cals, a, varname) = args
