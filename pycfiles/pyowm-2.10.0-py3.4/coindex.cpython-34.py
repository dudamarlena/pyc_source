...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/pollutionapi30/coindex.py
...
class COIndex(object):
    ...
    def __init__(self, reference_time, location, interval, co_samples, reception_time):
        if reference_time < 0:
    ...
    def _to_DOM(self):
        ...
        for smpl in self._co_samples:
            ...
            xmlutils.create_DOM_node_from_dict(s, 'co_sample', co_samples_node)
