...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/weatherapi25/historian.py
...
class Historian(object):
    ...
    def max_temperature(self, unit='kelvin'):
        ...
        if unit not in ('kelvin', 'celsius', 'fahrenheit'):
            raise ValueError("Invalid value for parameter 'unit'")
        maximum = max(self._purge_none_samples(self.temperature_series()), key=itemgetter(1))
        if unit == 'kelvin':
            result = maximum
        if unit == 'celsius':
            result = (
             maximum[0], temputils.kelvin_to_celsius(maximum[1]))
        if unit == 'fahrenheit':
            result = (
             maximum[0], temputils.kelvin_to_fahrenheit(maximum[1]))
        return result
    ...
    def min_temperature(self, unit='kelvin'):
        ...
        if unit not in ('kelvin', 'celsius', 'fahrenheit'):
            raise ValueError("Invalid value for parameter 'unit'")
        minimum = min(self._purge_none_samples(self.temperature_series()), key=itemgetter(1))
        if unit == 'kelvin':
            result = minimum
        if unit == 'celsius':
            result = (
             minimum[0], temputils.kelvin_to_celsius(minimum[1]))
        if unit == 'fahrenheit':
            result = (
             minimum[0], temputils.kelvin_to_fahrenheit(minimum[1]))
        return result
    ...
    def average_temperature(self, unit='kelvin'):
        ...
        if unit not in ('kelvin', 'celsius', 'fahrenheit'):
            raise ValueError("Invalid value for parameter 'unit'")
        average = self._average(self._purge_none_samples(self.temperature_series()))
        if unit == 'kelvin':
            result = average
        if unit == 'celsius':
    ...
    def max_humidity(self):
        ...
        """
        return max(self._purge_none_samples(self.humidity_series()), key=itemgetter(1))
    ...
    def min_humidity(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return min(self._purge_none_samples(self.humidity_series()), key=itemgetter(1))
    ...
    def average_humidity(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return self._average(self._purge_none_samples(self.humidity_series()))
    ...
    def max_pressure(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return max(self._purge_none_samples(self.pressure_series()), key=itemgetter(1))
    ...
    def min_pressure(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return min(self._purge_none_samples(self.pressure_series()), key=itemgetter(1))
    ...
    def average_pressure(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return self._average(self._purge_none_samples(self.pressure_series()))
    ...
    def min_rain(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return min(self._purge_none_samples(self.rain_series()), key=itemgetter(1))
    ...
    def average_rain(self):
        ...
        :raises: ValueError when the measurement series is empty
        """
        return self._average(self._purge_none_samples(self.rain_series()))
