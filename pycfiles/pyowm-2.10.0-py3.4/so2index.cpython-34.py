...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/pollutionapi30/so2index.py
...
class SO2Index(object):
    ...
    def to_XML(self, xml_declaration=True, xmlns=True):
        ...
        if xmlns:
            xmlutils.annotate_with_XMLNS(root_node, SO2INDEX_XMLNS_PREFIX, SO2INDEX_XMLNS_URL)
    ...
    def _to_DOM(self):
        ...
        for smpl in self._so2_samples:
            ...
            xmlutils.create_DOM_node_from_dict(s, 'so2_sample', so2_samples_node)
