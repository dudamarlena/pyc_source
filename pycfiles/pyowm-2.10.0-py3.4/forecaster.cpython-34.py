...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/weatherapi25/forecaster.py
# Compiled at: 2018-12-21 14:52:45
# Size of source mod 2**32: 21107 bytes
"""
...
class Forecaster(object):
    ...
    def when_starts(self, timeformat='unix'):
        ...
        """
        start_coverage = min([item.get_reference_time() for item in self._forecast])
    ...
    def will_have_rain(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'rain', weather_code_registry)
    ...
    def will_have_sun(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'sun', weather_code_registry)
    ...
    def will_have_fog(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'fog', weather_code_registry)
    ...
    def will_have_clouds(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'clouds', weather_code_registry)
    ...
    def will_have_snow(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'snow', weather_code_registry)
    ...
    def will_have_storm(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'storm', weather_code_registry)
    ...
    def will_have_tornado(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'tornado', weather_code_registry)
    ...
    def will_have_hurricane(self):
        ...
        """
        return weatherutils.any_status_is(self._forecast.get_weathers(), 'hurricane', weather_code_registry)
    ...
    def when_rain(self):
        ...
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'rain', weather_code_registry)
    ...
    def when_sun(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'sun', weather_code_registry)
    ...
    def when_fog(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'fog', weather_code_registry)
    ...
    def when_clouds(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'clouds', weather_code_registry)
    ...
    def when_snow(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'snow', weather_code_registry)
    ...
    def when_storm(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'storm', weather_code_registry)
    ...
    def when_tornado(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'tornado', weather_code_registry)
    ...
    def when_hurricane(self):
        ...
        :returns: a list of *Weather* objects
        """
        return weatherutils.filter_by_status(self._forecast.get_weathers(), 'hurricane', weather_code_registry)
    ...
    def _will_be(self, timeobject, weather_condition):
        ...
        closest_weather = weatherutils.find_closest_weather(self._forecast.get_weathers(), time_value)
        return weatherutils.status_is(closest_weather, weather_condition, weather_code_registry)
