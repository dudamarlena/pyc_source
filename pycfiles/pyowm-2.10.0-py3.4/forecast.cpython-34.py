...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/weatherapi25/forecast.py
# Compiled at: 2018-12-21 14:52:45
# Size of source mod 2**32: 7186 bytes
"""
...
class Forecast(object):
    ...
    def to_JSON(self):
        ...
        """
        return json.dumps({'interval': self._interval,  'reception_time': self._reception_time, 
         'Location': json.loads(self._location.to_JSON()), 
         'weathers': json.loads('[' + ','.join([w.to_JSON() for w in self]) + ']')})
