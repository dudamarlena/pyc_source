...
# Embedded file name: build\bdist.win32\egg\pyinstruments\curvefinder\gui\curve_search_widget\curve_filter_widgets.py
# Compiled at: 2013-12-15 08:37:09
from pyinstruments.curvefinder.gui.curve_search_widget.value_widgets import DateSelectWidget, BooleanWidget, FloatWidget, CharWidget
...
class WidgetValue(QtGui.QStackedWidget, object):
    ...
    def __init__(self, parent=None):
        ...
        self.widget_value_stacked['char'] = (
         val,
         self.string_widget)
