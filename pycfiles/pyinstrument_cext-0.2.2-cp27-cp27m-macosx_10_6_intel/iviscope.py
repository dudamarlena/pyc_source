...
# Embedded file name: build\bdist.win32\egg\pyivi\ivicom\iviscope.py
...
class Measurement(object):
    ...
    def fetch_waveform(self):
        ...
        x_trace = linspace(initial_x, x_increment * len(y_trace), len(y_trace), False)
        return (
         x_trace, y_trace)
...
add_sc_fields(ShortCutScope, ShortCutScope._channel_related_fields, 'sc_active_channel')
