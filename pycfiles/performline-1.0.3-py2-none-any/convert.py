...
# [GCC 8.4.0]
# Embedded file name: /home/ghetzel/src/github.com/PerformLine/python-performline-client/build/lib.linux-x86_64-2.7/performline/embedded/stdlib/utils/convert.py
...
def convert_to(value, to_unit, full_name=False, suffix='B', numeric_format='{0:d}'):
    ...
    return (numeric_format + '{1}{2}').format(value, suffix_lead, suffix)