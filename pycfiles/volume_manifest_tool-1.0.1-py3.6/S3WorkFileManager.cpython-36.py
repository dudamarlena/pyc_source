...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/v_m_t/S3WorkFileManager.py
...
class S3WorkFileManager:
    ...
    def s3_move(self, src_object: str, dest_object: str, src_folder, dest_folder):
        ...
        self.s3.Object(self._bucket_name, dest_object).copy_from(CopySource={'Bucket':self._bucket_name, 
         'Key':src_object})
