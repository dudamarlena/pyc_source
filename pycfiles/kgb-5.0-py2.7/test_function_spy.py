...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/kgb/tests/test_function_spy.py
# Compiled at: 2020-04-10 23:22:42
from __future__ import unicode_literals
import functools, inspect, re, types
...
class FunctionSpyTests(TestCase):
    ...
    def test_construction_with_call_precedence(self):
        ...
        spy = self.agency.spy_on(something_awesome, call_fake=fake_something_awesome, call_original=True)
    ...
    def test_construction_with_call_fake(self):
        ...
        spy = self.agency.spy_on(something_awesome, call_fake=fake_something_awesome)
        self.assertTrue(hasattr(something_awesome, b'spy'))
        self.assertEqual(something_awesome.spy, spy)
        self.assertEqual(getattr(spy.func, FunctionSig.FUNC_NAME_ATTR), getattr(fake_something_awesome, FunctionSig.FUNC_NAME_ATTR))
        self.assertEqual(spy.orig_func, something_awesome)
        self.assertEqual(spy.func_name, b'something_awesome')
    ...
    def test_construction_with_call_fake_and_bound_method(self):
        ...
        self.assertFalse(hasattr(MathClass.do_math, b'spy'))
        self.assertEqual(spy.func, fake_do_math)
        self.assertEqual(spy.func_name, b'do_math')
    ...
    def test_construction_with_call_fake_and_unbound_method(self):
        ...
        self.assertTrue(hasattr(MathClass.do_math, b'spy'))
        ...
        if isinstance(orig_method, types.FunctionType):
            ...
            self.fail(b'Method has an unexpected type %r' % type(orig_method))
        obj = MathClass()
        self.assertTrue(hasattr(obj.do_math, b'spy'))
    ...
    def test_construction_with_call_fake_and_classmethod(self):
        ...
        spy = self.agency.spy_on(MathClass.class_do_math, call_fake=fake_class_do_math)
        ...
        self.assertEqual(spy.func_name, b'class_do_math')
    ...
    def test_construction_with_call_original_true(self):
        ...
        self.assertTrue(hasattr(something_awesome, b'spy'))
        self.assertEqual(something_awesome.spy, spy)
        self.assertEqual(getattr(spy.func, FunctionSig.FUNC_NAME_ATTR), getattr(something_awesome, FunctionSig.FUNC_NAME_ATTR))
        self.assertEqual(spy.orig_func, something_awesome)
        self.assertEqual(spy.func_name, b'something_awesome')
        self.assertIsInstance(something_awesome, types.FunctionType)
    ...
    def test_construction_with_function_and_owner(self):
        ...
        self.assertEqual(text_type(cm.exception), b'This function has no owner, but an owner was passed to spy_on().')
    ...
    def test_init_with_slippery_bound_method(self):
        ...
        spy = self.agency.spy_on(obj.my_func, owner=obj, call_original=True)
        self.assertTrue(hasattr(obj.my_func, b'spy'))
        self.assertIs(obj.my_func.spy, spy)
        self.assertEqual(spy.func_name, b'my_func')
        self.assertEqual(spy.func_type, spy.TYPE_BOUND_METHOD)
    ...
    def test_init_with_slippery_unbound_method(self):
        ...
        """
        with self.assertRaises(ValueError) as (cm):
            self.agency.spy_on(SlipperyFuncObject.my_func, owner=SlipperyFuncObject)
        self.assertEqual(text_type(cm.exception), b'Unable to spies on unbound slippery methods (those that return a new function on each attribute access). Please spy on an instance instead.')
    ...
    def test_construction_with_classmethod_on_parent(self):
        ...
        self.assertTrue(hasattr(MyObject.foo, b'spy'))
        self.assertFalse(hasattr(MyParent.foo, b'spy'))
        self.assertIs(MyObject.foo.spy, spy)
        self.assertEqual(spy.func_name, b'foo')
        self.assertEqual(spy.func_type, spy.TYPE_BOUND_METHOD)
    ...
    def test_construction_with_unbound_method_on_parent(self):
        ...
        self.assertTrue(hasattr(AdderSubclass.func, b'spy'))
        self.assertFalse(hasattr(AdderObject.func, b'spy'))
        self.assertIs(AdderSubclass.func.spy, spy)
        self.assertEqual(spy.func_name, b'func')
        self.assertEqual(spy.func_type, spy.TYPE_UNBOUND_METHOD)
    ...
    def test_construction_with_existing_spy(self):
        ...
        with self.assertRaises(ExistingSpyError) as (cm):
            self.agency.spy_on(do_math)
        self.assertIn(b', in setup_spy', text_type(cm.exception))
    ...
    def test_construction_with_bound_method_and_custom_setattr(self):
        ...
        self.assertTrue(hasattr(obj.foo, b'spy'))
        self.assertTrue(hasattr(obj.foo, b'called_with'))
        obj2 = MyObject()
        self.assertFalse(hasattr(obj2.foo, b'spy'))
    ...
    def test_construction_with_bound_method_and_bad_owner(self):
        ...
        self.assertEqual(text_type(cm.exception), b'The owner passed does not match the actual owner of the bound method.')
    ...
    def test_construction_with_owner_without_method(self):
        ...
        self.assertEqual(text_type(cm.exception), b'The owner passed does not contain the spied method.')

    def test_construction_with_non_function(self):
        """Testing FunctionSpy constructions with non-function"""
        with self.assertRaises(ValueError) as (cm):
            self.agency.spy_on(42)
        self.assertEqual(text_type(cm.exception), b'42 cannot be spied on. It does not appear to be a valid function or method.')
    ...
    def test_construction_with_call_fake_non_function(self):
        ...
        self.assertEqual(text_type(cm.exception), b'True cannot be used for call_fake. It does not appear to be a valid function or method.')
    ...
    def test_construction_with_call_fake_compatibility(self):
        ...
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source1, call_fake=lambda a, b, c: None)
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source1, call_fake=lambda a: None)
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source1, call_fake=lambda **kwargs: None)
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source2, call_fake=lambda a, b: None)
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source3, call_fake=lambda c=1: None)
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source4, call_fake=lambda c=1, d=2, e=3: None)
        with self.assertRaises(IncompatibleFunctionError):
            self.agency.spy_on(source4, call_fake=lambda c=1, d=2: None)
    ...
    def test_call_with_fake(self):
        ...
        self.agency.spy_on(something_awesome, call_fake=fake_something_awesome)
        result = something_awesome()
        self.assertEqual(result, b'\\o/')
    ...
    def test_call_with_fake_and_classmethod(self):
        ...
        self.agency.spy_on(MathClass.class_do_math, call_fake=fake_class_do_math)
    ...
    def test_call_with_fake_and_args_for_kwargs(self):
        ...
        self.assertEqual(obj.do_math.calls[0].kwargs, {b'a': 10, 
           b'b': 20})
    ...
    def test_call_with_original_true_and_function(self):
        ...
        result = something_awesome()
        self.assertEqual(result, b'Tada!')
        self.assertTrue(hasattr(something_awesome, b'spy'))
        self.assertEqual(len(something_awesome.spy.calls), 1)
        self.assertEqual(len(something_awesome.spy.calls[0].args), 0)
        self.assertEqual(len(something_awesome.spy.calls[0].kwargs), 0)
    ...
    def test_call_with_original_true_and_function_args_for_kwargs(self):
        ...
        self.assertEqual(do_math.spy.calls[0].kwargs, {b'a': 10, 
           b'b': 20})
    ...
    def test_call_with_original_true_and_function_kwargs(self):
        ...
        self.assertEqual(do_math.spy.calls[0].kwargs, {b'a': 20, 
           b'b': 10})
    ...
    def test_call_with_original_true_and_function_mixed(self):
        ...
        self.assertEqual(do_math_mixed.spy.calls[0].kwargs, {b'b': 20, 
           b'unused': True})
    ...
    def test_call_with_original_true_and_classmethod_args_for_kwargs(self):
        ...
        self.assertEqual(MathClass.class_do_math.calls[0].kwargs, {b'a': 10, 
           b'b': 20})
    ...
    def test_call_with_inline_function_using_closure_vars(self):
        ...
        self.assertEqual(d, {b'called': True})
    ...
    def test_call_original_with_orig_func_and_bound_method(self):
        ...
        """
        obj = AdderObject()
        self.agency.spy_on(obj.add_one, call_original=True)
    ...
    def test_call_original_with_orig_func_and_unbound_method(self):
        ...
        using call_original=True
        """
        self.agency.spy_on(AdderObject.add_one, call_original=True)
        obj = AdderObject()
    ...
    def test_call_original_with_orig_func_and_classmethod(self):
        ...
        using call_original=True
        """
        self.agency.spy_on(AdderObject.class_add_one, call_original=True)
    ...
    def test_call_original_with_fake_func_and_function(self):
        ...
        call_fake=
        """
        self.agency.spy_on(do_math, call_fake=fake_do_math)
        result = do_math.call_original(10, 20)
        self.assertEqual(result, -10)
        self.assertFalse(do_math.called)
    ...
    def test_call_original_with_unbound_method_no_instance(self):
        ...
        self.agency.spy_on(AdderObject.add_one, call_original=True)
        obj = AdderObject()
        message = re.escape(b'The first argument to add_one.call_original() must be an instance of kgb.tests.test_function_spy.AdderObject, since this is an unbound method.')
    ...
    def test_unspy(self):
        ...
        spy = self.agency.spy_on(something_awesome, call_fake=lambda : b'spy!')
        self.assertTrue(hasattr(something_awesome, b'spy'))
        self.assertEqual(something_awesome.spy, spy)
        self.assertEqual(something_awesome(), b'spy!')
        spy.unspy()
        self.assertFalse(hasattr(something_awesome, b'spy'))
        self.assertEqual(getattr(something_awesome, FunctionSig.FUNC_CODE_ATTR), orig_code)
        self.assertEqual(something_awesome(), b'Tada!')
    ...
    def test_unspy_with_slippery_bound_method(self):
        ...
        spy.unspy()
        self.assertFalse(hasattr(obj.my_func, b'spy'))
        self.assertNotIn(b'my_func', obj.__dict__)
        slippery_func.count = 0
        func1 = obj.my_func
        func2 = obj.my_func
        self.assertIsNot(func1, func2)
    ...
    def test_raised_with_message(self):
        ...
        with self.assertRaises(TypeError):
            obj.do_math(1, b'a')
        self.assertTrue(obj.do_math.raised_with_message(TypeError, b"unsupported operand type(s) for +: 'int' and '%s'" % text_type.__name__))
        self.assertFalse(obj.do_math.raised_with_message(ValueError, b"unsupported operand type(s) for +: 'int' and '%s'" % text_type.__name__))
    ...
    def test_last_raised_with_message(self):
        ...
        with self.assertRaises(TypeError):
            obj.do_math(1, b'a')
        self.assertTrue(obj.do_math.last_raised_with_message(TypeError, b"unsupported operand type(s) for +: 'int' and '%s'" % text_type.__name__))
    ...
    def test_repr(self):
        ...
        self.assertTrue(hasattr(something_awesome, b'spy'))
        self.assertTrue(repr(something_awesome.spy), b'<Spy for something_awesome (0 calls)>')

    def test_repr_and_function(self):
        """Testing FunctionSpy.__repr__ and function"""
        self.agency.spy_on(do_math)
        self.assertEqual(repr(do_math.spy), b'<Spy for function do_math (0 calls)>')
    ...
    def test_repr_and_bound_method(self):
        ...
        self.agency.spy_on(obj.do_math)
        obj.do_math()
        self.assertEqual(repr(obj.do_math.spy), b'<Spy for bound method MathClass.do_math of %r (1 call)>' % obj)

    def test_repr_and_unbound_method(self):
        """Testing FunctionSpy.__repr__ and unbound method"""
        self.agency.spy_on(MathClass.do_math)
        self.assertEqual(repr(MathClass.do_math.spy), b'<Spy for unbound method MathClass.do_math of %r (0 calls)>' % MathClass)

    def test_repr_with_classmethod(self):
        """Testing FunctionSpy.__repr__ with classmethod"""
        self.agency.spy_on(MathClass.class_do_math)
        self.assertEqual(repr(MathClass.class_do_math.spy), b'<Spy for classmethod MathClass.class_do_math of %r (0 calls)>' % MathClass)
    ...
    def test_getargspec_with_function(self):
        ...
        self.assertEqual(args, [b'a', b'b'])
        self.assertEqual(varargs, b'args')
        self.assertEqual(keywords, b'kwargs')
    ...
    def test_getargspec_with_bound_method(self):
        ...
        self.assertEqual(args, [b'self', b'a', b'b'])
        self.assertEqual(varargs, b'args')
        self.assertEqual(keywords, b'kwargs')
        self.assertEqual(defaults, (1, 2))
    ...
    def test_getargspec_with_unbound_method(self):
        ...
        self.agency.spy_on(MathClass.do_math)
        args, varargs, keywords, defaults = inspect.getargspec(MathClass.do_math)
        self.assertEqual(args, [b'self', b'a', b'b'])
        self.assertEqual(varargs, b'args')
        self.assertEqual(keywords, b'kwargs')
        self.assertEqual(defaults, (1, 2))
    ...
    def test_getargspec_with_classmethod(self):
        ...
        args, varargs, keywords, defaults = inspect.getargspec(obj.class_do_math)
        self.assertEqual(args, [b'cls', b'a', b'b'])
        self.assertEqual(varargs, b'args')
        self.assertEqual(keywords, b'kwargs')
