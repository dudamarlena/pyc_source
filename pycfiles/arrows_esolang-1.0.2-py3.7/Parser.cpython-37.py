...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/arrows_esolang/Parser.py
# Compiled at: 2019-10-31 01:50:09
         ...
         x, y, p) in visited:
            ...
            while data[y][x]:
                if U.is_at_in(data, x, y, p):
                    ...
                    U.in_bounds(x, y, data) or me.add_action(A.ActionType.END, register)
                    register = 0
                    return me
                x += p[0]
                y += p[1]
            ...
            x += p[0]
            y += p[1]
            U.in_bounds(x, y, data) or me.add_action(U.ActionType.END, register)
            register = 0
            return me
        me.add_add(register)
