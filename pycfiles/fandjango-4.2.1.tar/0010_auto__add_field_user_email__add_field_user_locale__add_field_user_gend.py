...
# [GCC 8.4.0]
# Embedded file name: /Users/jgorset/Code/python/fandjango/fandjango/migrations/0010_auto__add_field_user_email__add_field_user_locale__add_field_user_gend.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fandjango_user', 'extra_data', self.gf('jsonfield.fields.JSONField')(default={}), keep_default=False)

    def backwards(self, orm):
        db.delete_column('fandjango_user', 'email')
        db.delete_column('fandjango_user', 'locale')
        db.delete_column('fandjango_user', 'gender')
        db.delete_column('fandjango_user', 'extra_data')
