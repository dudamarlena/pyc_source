...
# Embedded file name: /home/cor/bin/src/crystal_torture/crystal_torture/graph.py
# Compiled at: 2019-04-30 06:46:27
...
class Graph:
    ...
    def set_minimal_clusters(self):
        ...
        for sites in site_sets:
            self.min_clusters.append(minimal_Cluster(site_indices=(list(sites)), size=(len(sites))))
                ...
                for site in site_list:
                    ...
                    if site.species_string == symbol:
                        cluster_structure.append(symbol,
                          (site.coords), coords_are_cartesian=True)
