...
# Embedded file name: /home/cor/bin/src/crystal_torture/tests/test_minimal_cluster.py
# Compiled at: 2018-07-19 05:55:34
...
class ClusterTestCase(unittest.TestCase):
    ...
    def test_torture_cluster(self):
        cluster = clusters_from_file(filename='tests/STRUCTURE_FILES/POSCAR_2_clusters.vasp', rcut=4.0, elements={'Li'})
