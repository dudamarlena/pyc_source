...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/__unit_test__/ally/support/sqlalchemy/complete.py
...
from ally.support.sqlalchemy.session import bindSession, endSessions, commit, setKeepAlive
...
class TestMapping(unittest.TestCase):
    ...
    def test(self):
        ...
        at = ArticleType()
        at.Name = 'Test Type 1'
        self.assertRaisesRegex(InputError, "(ArticleType.Name='Already an entry with this value')", articleTypeService.insert, at)
        at = ArticleType()
        at.Name = 'Test Type 3'
        articleTypeService.insert(at)
