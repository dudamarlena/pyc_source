...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/__unit_test__/ally/support/sqlalchemy/samples/impl/entity.py
...
class EntitySupportAlchemy(SessionSupport):
    ...
    def _getAllWithCount(self, filter=None, query=None, offset=None, limit=None, sqlQuery=None):
        ...
        if limit == 0:
            ...
            return (
             (entity for entity in sql.all()), sqlQuery.count())
