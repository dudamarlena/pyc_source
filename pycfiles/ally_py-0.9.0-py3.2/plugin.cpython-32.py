...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/admin/introspection/impl/plugin.py
...
class PluginService(IPluginService):
    ...
    def pluginFor(self, module, components=None):
        ...
        if components is None:
            try:
                c.Component = next(iter(self.componentService.getComponents(limit=1, q=QComponent(path=c.Path)))).Id
