...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ally/container/_impl/_entity.py
...
class Initializer:
    ...
    def initialize(cls, entity):
        ...
        if initializer is not None:
            ...
            if entity.__class__ == initializer._entityClazz:
                if entity.__dict__.get('_ally_ioc_initialized', False):
                    return
    ...
    def __call__(self, entity, *args, **keyargs):
        ...
        if entity.__dict__.get('_ally_ioc_initialized'):
            self._entityInit(entity, *args, **keyargs)
        else:
            if entity.__dict__.get('_ally_ioc_arguments') is None:
                entity._ally_ioc_arguments = (
                 args, keyargs)
            else:
    ...
    def __get__(self, entity, owner=None):
        ...
        if entity is not None:
            return partial(self.__call__, entity)
        else:
            return self
...
class Wiring:
    ...
    def wiringFor(cls, register):
        ...
        if wiring is None:
            ...
            if '__init__' not in register:
                register['__init__'] = validateWiring
        return wiring
    ...
    def wiringOf(cls, clazz):
        ...
        if compiled is None:
            wirings = []
            try:
                wirings.append(clazz.__ally_wiring__)
            ...
            if wirings:
                ...
                clazz.__ally_wiring_compiled__ = False
...
class Advent:
    ...
    def adventFor(cls, register):
        ...
        if advent is None:
            advent = register['__ally_advent__'] = Advent()
        return advent
    ...
    def adventOf(cls, clazz):
        ...
        if compiled is None:
            advents = []
            try:
                advents.append(clazz.__ally_advent__)
            except AttributeError:
                pass
            ...
            if advents:
                ...
                clazz.__ally_advent_compiled__ = False
        elif compiled is False:
            compiled = None
        return compiled
