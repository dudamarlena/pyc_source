...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ally/http/impl/processor/asyncore_content.py
...
class AsyncoreContentHandler(HandlerProcessor):
    ...
    def __init__(self):
        ...
        assert isdir(self.dumpRequestsPath) and os.access(self.dumpRequestsPath, os.W_OK), 'Unable to access the dump directory %s' % self.dumpRequestsPath
        super().__init__()
        self._count = 0
