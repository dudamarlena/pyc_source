...
# Embedded file name: build\bdist.win32\egg\pyhexad\__init__.py
# Compiled at: 2014-12-08 16:25:23
from .config import Limits, h5py_is_installed, h5py_version, numpy_version
