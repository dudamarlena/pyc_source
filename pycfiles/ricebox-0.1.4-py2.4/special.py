...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/ricebox/special.py
# Compiled at: 2009-01-06 08:24:43
"""
        Ricebox daily special getter :)
        by Alan & Matt
"""
import httplib, sgmllib, time
...
def getParsedBody():
    body = get_url('http://freespace.virgin.net/rice.box/page3.html')
    p = RbParser()
    p.feed(body)
    return p
