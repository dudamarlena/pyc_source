...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\pyhapi\hdata.py
# Compiled at: 2020-03-17 09:55:00
# Size of source mod 2**32: 23093 bytes
"""Houdini Engine's internal data types
Author  : Maajor
Email   : info@ma-yidong.com
"""
from ctypes import Structure, Array, c_int, c_int32, c_int64, c_float, c_bool
import enum, numpy as np

class StructureWithEnums(Structure):
    __doc__ = 'Add missing enum feature to ctypes Structures.\n    ref:  https://gist.github.com/christoph2/9c390e5c094796903097\n    '
    _map = {}
    ...
    def __str__(self):
        ...
        for field in self._fields_:
            ...
            result.append('    {0} [{1}] = {2!r}'.format(attr, attr_type.__name__, value))
...
class LicenseType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_License\n    "
    NONE = 0
    HOUDINI_ENGINE = 1
    HOUDINI = 2
    HOUDINI_FX = 3
...
class StatusType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_StatusType\n    "
    CALL_RESULT = 0
    COOK_RESULT = 1
    COOK_STATE = 2
    MAX = 3
...
class StatusVerbosity(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_StatusVerbosity\n    "
    ALL = 2
    ERRORS = 0
    WARNINGS = 1
    MESSAGES = 2
...
class Result(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_Result\n    "
    SUCCESS = 0
    FAILURE = 1
...
class ErrorCode(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_ErrorCode\n    "
    ASSET_DEF_NOT_FOUND = 1
    PYTHON_NODE_ERROR = 2


class SessionType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_SessionType\n    "
    INPROCESS = 0
    THRIFT = 1
    CUSTOM1 = 2
    CUSTOM2 = 3
...
class State(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_State\n    "
    READY = 0
...
class PackedPrimInstancingMode(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_PackedPrimInstancingMode\n    "
    INVALID = -1
    DISABLED = 0
    HIERARCHY = 1
    FLAT = 2
...
class Permissions(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_Permissions\n    "
    NON_APPLICABLE = 0
    READ_WRITE = 1
    READ_ONLY = 2
    WRITE_ONLY = 3
...
class RampType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_RampType\n    "
    INVALID = -1
    FLOAT = 0
    COLOR = 1
    MAX = 2
...
class ParmType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_ParmType\n    "
    INT = 0
    MULTIPARMLIST = 1
    TOGGLE = 2
    BUTTON = 3
...
class PrmScriptType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_PrmScriptType\n    "
    INT = 0
    FLOAT = 1
    ANGLE = 2
    STRING = 3
...
class ChoiceListType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_ChoiceListType\n    "
    NONE = 0
    NORMAL = 1
    MINI = 2
    REPLACE = 3
...
class PresetType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_PresetType\n    "
    INVALID = -1
    BINARY = 0
    IDX = 1
    MAX = 2
...
class NodeType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_NodeType\n    "
    ANY = -1
    NONE = 0
    OBJ = 1
    SOP = 2
...
class NodeFlags(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_NodeFlags\n    "
    ANY = -1
    NONE = 0
    DISPLAY = 1
    RENDER = 2
...
class GroupType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_GroupType\n    "
    INVALID = -1
    POINT = 0
    PRIM = 1
    MAX = 2
...
class AttributeOwner(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_AttributeOwner\n    "
    INVALID = -1
    VERTEX = 0
    POINT = 1
    PRIM = 2
...
class CurveType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_CurveType\n    "
    INVALID = -1
    LINEAR = 0
    NURBS = 1
    BEZIER = 2
...
class VolumeType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_VolumeType\n    "
    INVALID = -1
    HOUDINI = 0
    VDB = 1
    MAX = 2
...
class StorageType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_StorageType\n    "
    INVALID = -1
    INT = 0
    INT64 = 1
    FLOAT = 2
...
class AttributeTypeInfo(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_AttributeTypeInfo\n    "
    INVALID = -1
    NONE = 0
    POINT = 1
    HPOINT = 2
...
class HGeoType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_GeoType\n    "
    INVALID = -1
    DEFAULT = 0
    INTERMEDIATE = 1
    INPUT = 2
...
class PartType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_PartType\n    "
    INVALID = -1
    MESH = 0
    CURVE = 1
    VOLUME = 2
...
class InputType(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_InputType\n    "
    INVALID = -1
    TRANSFORM = 0
    GEOMETRY = 1
    MAX = 2
...
class RSTOrder(enum.IntEnum):
    __doc__ = "Equivalent of HAPI's HAPI_RSTOrder\n    "
    HAPI_TRS = 0
    HAPI_TSR = 1
    HAPI_RTS = 2
    HAPI_RST = 3
...
NP_TYPE_TO_HSTORAGE_TYPE = {np.dtype('int32'): StorageType.INT, 
...
class PartInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_PartInfo\n    "
    _fields_ = [('id', c_int32),
     (
      'nameSH', c_int32),
     (
...
class CurveInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_CurveInfo\n    "
    _fields_ = [('curveType', c_int32),
     ...
     (
      'hasKnots', c_bool)]
    _map = {'curveType': CurveType}


class Transform(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_Transform\n    "
...
class VolumeTileInfo(Structure):
    __doc__ = "Equivalent of HAPI's HAPI_VolumeTileInfo\n    "
...
class VolumeInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_VolumeInfo\n    "
    _fields_ = [('nameSH', c_int32),
     ...
     (
      'yTaper', c_float)]
    _map = {'type':VolumeType, 
     'storage':StorageType}


class AttributeInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_AttributeInfo\n    "
...
class ThriftServerOptions(Structure):
    __doc__ = "Equivalent of HAPI's HAPI_ThriftServerOptions\n    "
...
class Session(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_Session\n    "
    _fields_ = [('type', c_int),
     (
      'id', c_int64)]
    _map = {'type': SessionType}


class AssetInfo(Structure):
    __doc__ = "Equivalent of HAPI's HAPI_AssetInfo\n    "
...
class ObjectInfo(Structure):
    __doc__ = "Equivalent of HAPI's HAPI_ObjectInfo\n    "
    _fields_ = [('nameSH', c_int32),
     (
...
class GeoInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_GeoInfo\n    "
...
class CookOptions(Structure):
    __doc__ = "Equivalent of HAPI's HAPI_CookOptions\n    "
...
class NodeInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_NodeInfo\n    "
    _fields_ = [('id', c_int32),
     (
      'parentId', c_int32),
     (
...
class ParmInfo(StructureWithEnums):
    __doc__ = "Equivalent of HAPI's HAPI_ParmInfo\n    "
    _fields_ = [('id', c_int32),
     (
      'parentId', c_int32),
     (
    ...
    def is_int(self):
        ...
        """
        return self.type >= ParmType.INT_START and self.type <= ParmType.INT_END or self.type == ParmType.MULTIPARMLIST or self.type == ParmType.FOLDERLIST_RADIO
    ...
    def is_float(self):
        ...
        """
        return self.type >= ParmType.FLOAT_START and self.type <= ParmType.FLOAT_END
    ...
    def is_string(self):
        ...
        """
        return self.type >= ParmType.STRING_START and self.type <= ParmType.STRING_END or self.type == ParmType.LABEL or self.type == ParmType.PATH_FILE_DIR
    ...
    def is_path(self):
        ...
        """
        return self.type >= ParmType.PATH_START and self.type <= ParmType.PATH_END or self.type == ParmType.PATH_FILE_DIR
    ...
    def is_node(self):
        ...
        """
        return self.type >= ParmType.NODE_START and self.type <= ParmType.NODE_END
    ...
    def is_non_value(self):
        ...
        """
        return self.type >= ParmType.NONVALUE_START and self.type <= ParmType.NONVALUE_END