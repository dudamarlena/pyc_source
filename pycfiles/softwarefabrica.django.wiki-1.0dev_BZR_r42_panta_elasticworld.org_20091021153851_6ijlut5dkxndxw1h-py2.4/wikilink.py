...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/softwarefabrica/django/wiki/templatetags/wikilink.py
...
def wikilink(wiki, no_terminal='n'):
    ...
    chain.reverse()
    return {'chain': chain, 'no_terminal': no_terminal, 'do_terminal': not no_terminal}