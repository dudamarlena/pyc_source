...
class GcpFieldValidationException(AirflowException):
    __doc__ = 'Thrown when validation finds dictionary field not valid according to specification.\n    '
