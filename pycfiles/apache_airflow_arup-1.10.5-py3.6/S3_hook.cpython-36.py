...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/hooks/S3_hook.py
# Compiled at: 2019-09-11 03:47:34
# Size of source mod 2**32: 20240 bytes
...
class S3Hook(AwsHook):
    ...
    def select_key(self, key, bucket_name=None, expression='SELECT * FROM S3Object', expression_type='SQL', input_serialization=None, output_serialization=None):
        ...
        if input_serialization is None:
            ...
            bucket_name, key = bucket_name or self.parse_s3_url(key)
        response = self.get_conn().select_object_content(Bucket=bucket_name,
          Key=key,
    ...
    def check_for_wildcard_key(self, wildcard_key, bucket_name=None, delimiter=''):
        ...
        :type delimiter: str
        """
        return self.get_wildcard_key(wildcard_key=wildcard_key, bucket_name=bucket_name,
    ...
    def load_string(self, string_data, key, bucket_name=None, replace=False, encrypt=False, encoding='utf-8'):
        ...
        :type encrypt: bool
        """
        self.load_bytes((string_data.encode(encoding)), key=key,
    ...
    def copy_object(self, source_bucket_key, dest_bucket_key, source_bucket_name=None, dest_bucket_name=None, source_version_id=None):
        ...
        response = self.get_conn().copy_object(Bucket=dest_bucket_name, Key=dest_bucket_key,
