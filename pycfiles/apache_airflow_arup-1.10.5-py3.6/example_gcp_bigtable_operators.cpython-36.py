...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/contrib/example_dags/example_gcp_bigtable_operators.py
# Compiled at: 2019-09-11 03:47:34
# Size of source mod 2**32: 8313 bytes
"""
...
from airflow.contrib.operators.gcp_bigtable_operator import BigtableInstanceCreateOperator, BigtableInstanceDeleteOperator, BigtableClusterUpdateOperator, BigtableTableCreateOperator, BigtableTableWaitForReplicationSensor, BigtableTableDeleteOperator
...
with models.DAG('example_gcp_bigtable_operators',
  default_args=default_args,
  schedule_interval=None) as (dag):
    create_instance_task = BigtableInstanceCreateOperator(project_id=GCP_PROJECT_ID,
    ...
    create_instance_task2 = BigtableInstanceCreateOperator(instance_id=CBT_INSTANCE_ID,
      main_cluster_id=CBT_CLUSTER_ID,
      main_cluster_zone=CBT_CLUSTER_ZONE,
      instance_display_name=CBT_INSTANCE_DISPLAY_NAME,
      instance_type=(int(CBT_INSTANCE_TYPE)),
    ...
    cluster_update_task = BigtableClusterUpdateOperator(project_id=GCP_PROJECT_ID,
      instance_id=CBT_INSTANCE_ID,
      cluster_id=CBT_CLUSTER_ID,
      nodes=(int(CBT_CLUSTER_NODES_UPDATED)),
      task_id='update_cluster_task')
    cluster_update_task2 = BigtableClusterUpdateOperator(instance_id=CBT_INSTANCE_ID,
      cluster_id=CBT_CLUSTER_ID,
      nodes=(int(CBT_CLUSTER_NODES_UPDATED)),
      task_id='update_cluster_task2')
    cluster_update_task >> cluster_update_task2
    delete_instance_task = BigtableInstanceDeleteOperator(project_id=GCP_PROJECT_ID,
      instance_id=CBT_INSTANCE_ID,
      task_id='delete_instance_task')
    delete_instance_task2 = BigtableInstanceDeleteOperator(instance_id=CBT_INSTANCE_ID,
      task_id='delete_instance_task2')
    create_table_task = BigtableTableCreateOperator(project_id=GCP_PROJECT_ID,
      instance_id=CBT_INSTANCE_ID,
      table_id=CBT_TABLE_ID,
      task_id='create_table')
    create_table_task2 = BigtableTableCreateOperator(instance_id=CBT_INSTANCE_ID,
      table_id=CBT_TABLE_ID,
      task_id='create_table_task2')
    create_table_task >> create_table_task2
    wait_for_table_replication_task = BigtableTableWaitForReplicationSensor(project_id=GCP_PROJECT_ID,
      instance_id=CBT_INSTANCE_ID,
      table_id=CBT_TABLE_ID,
      poke_interval=(int(CBT_POKE_INTERVAL)),
      timeout=180,
      task_id='wait_for_table_replication_task')
    wait_for_table_replication_task2 = BigtableTableWaitForReplicationSensor(instance_id=CBT_INSTANCE_ID,
      table_id=CBT_TABLE_ID,
      poke_interval=(int(CBT_POKE_INTERVAL)),
      timeout=180,
      task_id='wait_for_table_replication_task2')
    delete_table_task = BigtableTableDeleteOperator(project_id=GCP_PROJECT_ID,
      instance_id=CBT_INSTANCE_ID,
      table_id=CBT_TABLE_ID,
      task_id='delete_table_task')
    delete_table_task2 = BigtableTableDeleteOperator(instance_id=CBT_INSTANCE_ID,
      table_id=CBT_TABLE_ID,
    ...
    create_instance_task >> create_table_task >> cluster_update_task >> delete_table_task
