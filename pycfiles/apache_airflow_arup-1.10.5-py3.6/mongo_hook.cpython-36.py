...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/contrib/hooks/mongo_hook.py
...
class MongoHook(BaseHook):
    ...
    def __init__(self, conn_id='mongo_default', *args, **kwargs):
        ...
        self.uri = '{scheme}://{creds}{host}{port}/{database}'.format(scheme=scheme,
          creds=('{}:{}@'.format(self.connection.login, self.connection.password) if self.connection.login else ''),
