...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/contrib/hooks/aws_glue_catalog_hook.py
...
class AwsGlueCatalogHook(AwsHook):
    ...
    def __init__(self, aws_conn_id='aws_default', region_name=None, *args, **kwargs):
        ...
        (super(AwsGlueCatalogHook, self).__init__)(args, aws_conn_id=aws_conn_id, **kwargs)
    ...
    def get_partitions(self, database_name, table_name, expression='', page_size=None, max_items=None):
        ...
        response = paginator.paginate(DatabaseName=database_name,
