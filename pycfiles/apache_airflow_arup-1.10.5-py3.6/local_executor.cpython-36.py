...
class LocalWorker(multiprocessing.Process, LoggingMixin):
    __doc__ = 'LocalWorker Process implementation to run airflow commands. Executes the given\n    command and puts the result into a result queue when done, terminating execution.'
...
class LocalExecutor(BaseExecutor):
    ...
    class _UnlimitedParallelism(object):
        __doc__ = 'Implements LocalExecutor with unlimited parallelism, starting one process\n        per each command to execute.'
    ...
    class _LimitedParallelism(object):
        __doc__ = 'Implements LocalExecutor with limited parallelism using a task queue to\n        coordinate work distribution.'
