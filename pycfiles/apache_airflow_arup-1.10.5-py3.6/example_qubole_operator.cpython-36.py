...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/contrib/example_dags/example_qubole_operator.py
...
t1 = QuboleOperator(task_id='hive_show_table',
...
t2 = QuboleOperator(task_id='hive_s3_location',
  command_type='hivecmd',
...
t3.set_upstream(t2)
options = [
 'hadoop_jar_cmd', 'presto_cmd', 'db_query', 'spark_cmd']
...
join = DummyOperator(task_id='join',
  ...
  dag=dag)
t4 = QuboleOperator(task_id='hadoop_jar_cmd',
  ...
  dag=dag,
  params={'cluster_label': 'default'})
t5 = QuboleOperator(task_id='pig_cmd',
  command_type='pigcmd',
...
t6 = QuboleOperator(task_id='presto_cmd',
  command_type='prestocmd',
  query='show tables',
  dag=dag)
t7 = QuboleOperator(task_id='shell_cmd',
...
t8 = QuboleOperator(task_id='db_query',
  command_type='dbtapquerycmd',
  query='show tables',
  db_tap_id=2064,
  dag=dag)
t9 = QuboleOperator(task_id='db_export',
...
t10 = QuboleOperator(task_id='db_import',
...
t11 = QuboleOperator(task_id='spark_cmd',
