...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DeepJetCore/bin/predict.py
# Compiled at: 2018-08-02 09:42:02
import imp
...
td.makePrediction(model, testd, args.outputDir, store_labels=args.labels, monkey_class=args.monkey_class)
