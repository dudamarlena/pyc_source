...
# [GCC 8.4.0]
# Embedded file name: /Users/lukas/work/development/gridcells/external/sphinx_rtd_theme/demo_docs/source/test_py_module/test.py
...
class Foo:
    ...
    def another_function(self, a, b, **kwargs):
        ...
        """
        return (
         sum(kwargs.values()) / len(kwargs), a + b)