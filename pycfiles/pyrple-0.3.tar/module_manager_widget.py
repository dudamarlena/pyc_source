...
# Embedded file name: build/bdist.linux-x86_64/egg/pyrpl/widgets/module_widgets/module_manager_widget.py
...
class ModuleManagerWidget(ModuleWidget):
    ...
    def create_title_bar(self):
        ...
        """
        self.setStyleSheet('ModuleManagerWidget{border:0;color:transparent;}')
...
class IqManagerWidget(ModuleManagerWidget):
    ...
    def button_hide_clicked(self):
        if str(self.button_hide.text()) == 'v':
            ...
            for widget in self.module_widgets:
                self.main_layout.setStretchFactor(widget, 1.0)
    ...
    def make_drawing(self):
        ...
        self.high_pass = MyImage('acbandwidth', row_center, 'high_pass.bmp', 'acbandwidth', parent=self, x_offset=-30)
        self.low_pass1 = MyImage('bandwidth', row_up, 'low_pass.bmp', 'bandwidth', parent=self, x_offset=-50)
        self.low_pass2 = MyImage('bandwidth', row_down, 'low_pass.bmp', 'bandwidth', parent=self, x_offset=-50)
        self.x_sin1 = MyLabel('frequency', row_center_up, 'sin(wt + phi)', parent=self, x_offset=-20)
        self.x_cos1 = MyLabel('frequency', row_center_down, 'cos(wt + phi)', parent=self, x_offset=-20)
        ...
        self.quad_fact = MyLabel('quadrature_factor', row_top, 'quadrature_factor', parent=self, x_offset=-40)
