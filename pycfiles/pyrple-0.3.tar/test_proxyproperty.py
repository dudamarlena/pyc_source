...
# Embedded file name: build/bdist.linux-x86_64/egg/pyrpl/test/test_proxyproperty.py
...
class MySubModule(Module):
    myfloat = FloatProperty(min=-10000000000.0, max=10000000000.0, default=12.3)
