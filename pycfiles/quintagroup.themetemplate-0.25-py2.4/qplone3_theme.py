...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/quintagroup/themetemplate/qplone3_theme.py
...
class qPlone3Theme(Plone3Theme):
    ...
    vars.insert(1, StringVar('namespace_package2', 'Nested namespace package (like theme)', default='theme'))
