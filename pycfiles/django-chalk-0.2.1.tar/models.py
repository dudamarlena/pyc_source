...
# [GCC 8.4.0]
# Embedded file name: /home/kevin/virtualenvs/kd/src/chalk/chalk/models.py
# Compiled at: 2013-08-27 18:46:13
...
class Article(models.Model):
    ...
    protect_html = models.BooleanField(help_text='If checked, Content HTML and Excerpt HTML will not be overwritten by generated HTML')
    content_html = models.TextField('content HTML', blank=True)
    excerpt_html = models.TextField('excerpt HTML', blank=True)
    publication_date = models.DateField(default=date.today())
    meta_description = models.TextField(blank=True, help_text='If this is blank the get_meta_description method returns a plaintext version of excerpt_html')
    ...
    def generate_html(self):
        ...
        content_html = publish_parts(content, writer_name='html', settings_overrides=DOCUTILS_OVERRIDES)['fragment']
        excerpt_html = publish_parts(excerpt, writer_name='html', settings_overrides=DOCUTILS_OVERRIDES)['fragment']
        return (
