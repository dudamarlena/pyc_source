...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-twitter-relations-history/twitter_relations_history/migrations/0002_auto__add_relationshistorydelta__add_unique_relationshistorydelta_hist.py
# Compiled at: 2013-05-14 12:35:03
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'twitter_api.user': {'Meta': {'object_name': 'User'}, 'contributors_enabled': (
                            ...
                            'follow_request_sent': (
                                                  'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                            'followers': (
                                        'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'followings'", 'symmetrical': 'False', 'to': "orm['twitter_api.User']"}), 
                            'followers_count': (
                                              'django.db.models.fields.PositiveIntegerField', [], {}), 
                            'following': (
                                        'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                            ...
                            'statuses_count': (
                                             'django.db.models.fields.PositiveIntegerField', [], {}), 
                            'time_zone': (
                                        'django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}), 
                            'url': (
                                  'django.db.models.fields.URLField', [], {'max_length': '300', 'null': 'True'}), 
                            'utc_offset': (
                                         'django.db.models.fields.IntegerField', [], {'null': 'True'}), 
                            'verified': (
                                       'django.db.models.fields.BooleanField', [], {'default': 'False'})}, 
       'twitter_relations_history.relationshistory': {'Meta': {'ordering': "('user', 'time', '-id')", 'unique_together': "(('user', 'time'),)", 'object_name': 'RelationsHistory'}, 'followers_count': (
                                                      ...
                                                      'user': (
                                                             'django.db.models.fields.related.ForeignKey', [], {'related_name': "'relations_history'", 'to': "orm['twitter_api.User']"})}, 
       'twitter_relations_history.relationshistorydelta': {'Meta': {'unique_together': "(('history_from', 'history_to'),)", 'object_name': 'RelationsHistoryDelta'}, 'followers_entered_count': (
                                                                                     'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                                           'followers_entered_ids': (
                                                                                   'picklefield.fields.PickledObjectField', [], {'default': '[]'}), 
                                                           'followers_left_count': (
                                                                                  'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                                           'followers_left_ids': (
                                                                                'picklefield.fields.PickledObjectField', [], {'default': '[]'}), 
                                                           'history_from': (
                                                                          'django.db.models.fields.related.ForeignKey', [], {'related_name': "'deltas_from'", 'to': "orm['twitter_relations_history.RelationsHistory']"}), 
                                                           'history_to': (
                                                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'deltas_to'", 'to': "orm['twitter_relations_history.RelationsHistory']"}), 
                                                           'id': (
                                                                'django.db.models.fields.AutoField', [], {'primary_key': 'True'})}}
    complete_apps = [
     'twitter_relations_history']