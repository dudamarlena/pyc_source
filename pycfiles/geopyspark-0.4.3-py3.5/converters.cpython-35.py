...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/geopyspark/geotrellis/converters.py
# Compiled at: 2018-11-28 11:44:02
# Size of source mod 2**32: 6810 bytes
from py4j.java_gateway import JavaClass
from py4j.protocol import register_input_converter
from geopyspark.geotrellis import RasterizerOptions, GlobalLayout, LocalLayout, CellType, LayoutDefinition, HashPartitionStrategy, SpatialPartitionStrategy, SpaceTimePartitionStrategy
...
class RasterizerOptionsConverter(object):
    ...
    def convert(self, object, gateway_client):
        ...
        if object.sampleType == 'PixelIsPoint':
            ...
            if object.sampleType == 'PixelIsArea':
...
class LayoutDefinitionConverter:
    ...
    def convert(self, obj, gateway_client):
        ...
        tile_layout = ScalaTileLayout(python_tile_layout.layoutCols, python_tile_layout.layoutRows, python_tile_layout.tileCols, python_tile_layout.tileRows)
