...
# [GCC 8.4.0]
# Embedded file name: /Users/lukas/Code/yadagedev/cap-schemas/capschemas/__init__.py
# Compiled at: 2016-10-31 17:30:26
import json, os, jsonschema, jsonref, requests, yaml, urllib2, logging
    ...
    def set_defaults(validator, properties, instance, schema):
        if schema.get('title', None) == 'Yadage Stage':
            if 'dependencies' in instance and type(instance['dependencies']) == list:
                ...
                instance['dependencies'] = {'dependency_type': 'jsonpath_ready', 
