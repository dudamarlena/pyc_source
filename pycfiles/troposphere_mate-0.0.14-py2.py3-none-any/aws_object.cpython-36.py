...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/troposphere_mate-project/troposphere_mate/core/aws_object.py
# Compiled at: 2020-03-14 00:03:54
# Size of source mod 2**32: 20163 bytes
...
try:
    from troposphere import AWSObject, iam, s3, sqs, sns, awslambda, apigateway, ec2, elasticloadbalancing, elasticloadbalancingv2, applicationautoscaling, ecr, ecs, ssm, kms, secretsmanager, kinesis, firehose, kinesisanalyticsv2, events, servicecatalog, glue, dynamodb, rds, redshift, elasticache, elasticsearch
...
class MixinReturnValues(object):
    ...
    def apigw_restapi_endpoint(self):
        validate_resource_type(self, apigateway.RestApi)
        return Sub('https://${RestApiId}.execute-api.${AwsRegion}.amazonaws.com', {'RestApiId':self.apigw_restapi_id, 
