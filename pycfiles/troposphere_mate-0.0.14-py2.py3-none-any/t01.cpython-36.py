...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/troposphere_mate-project/troposphere_mate/orch_example/t01.py
        ...
        policy_doc = {'Version':'2012-10-17', 
         'Statement':[
          {'Sid':'VisualEditor0', 
           ...
           'Resource':'*'}]}
        tpl = Template()
        policy = iam.ManagedPolicy('IamPolicy1',
          template=tpl,
          ManagedPolicyName=('{}-policy1'.format(self.ENVIRONMENT_NAME.get_value())),
