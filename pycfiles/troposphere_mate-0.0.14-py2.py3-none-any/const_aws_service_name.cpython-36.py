...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/troposphere_mate-project/troposphere_mate/canned/iam/const_aws_service_name.py
# Compiled at: 2019-10-29 17:26:22
...
def create_assume_role_policy_document(trusted_entity_list):
    ...
    return {'Version':'2012-10-17', 
     'Statement':[{'Effect':'Allow',  'Principal':{'Service': '{}.amazonaws.com'.format(service)},  'Action':'sts:AssumeRole'} for service in trusted_entity_list]}
