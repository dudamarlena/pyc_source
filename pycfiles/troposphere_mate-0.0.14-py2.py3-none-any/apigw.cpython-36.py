...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/troposphere_mate-project/troposphere_mate/associate/apigw.py
# Compiled at: 2020-02-12 21:45:29
...
from ..core.metadata import TROPOSPHERE_METADATA_FIELD_NAME, ResourceLevelField, initiate_default_resource_metadata
...
class LinkerApi(LinkerApi_):
    ...
    class ApiResourceWithRestApi(Linker):
        ...
        def associate(self, api_resource, rest_api, has_parent_resource=True, **kwargs):
            ...
            if has_parent_resource is False:
                ...
                metadata[TROPOSPHERE_METADATA_FIELD_NAME][ResourceLevelField.ApiResource.FULL_PATH] = api_resource.PathPart
    ...
    class ApiResourceWithParentApiResource(Linker):
        ...
        def associate(self, api_resource1, api_resource2, **kwargs):
            ...
            try:
                metadata[TROPOSPHERE_METADATA_FIELD_NAME][ResourceLevelField.ApiResource.FULL_PATH] = '{}/{}'.format(api_resource2.Metadata[TROPOSPHERE_METADATA_FIELD_NAME][ResourceLevelField.ApiResource.FULL_PATH], api_resource1.PathPart)
            except:
                pass
    ...
    class ApiMethodWithApiResource(Linker):
        ...
        def associate(self, api_method, api_resource, **kwargs):
            ...
            try:
                metadata[TROPOSPHERE_METADATA_FIELD_NAME][ResourceLevelField.ApiResource.FULL_PATH] = api_resource.Metadata[TROPOSPHERE_METADATA_FIELD_NAME][ResourceLevelField.ApiResource.FULL_PATH]
            except:
                pass
    ...
    class ApiMethodWithLambdFunction(Linker):
        ...
        def associate(self, api_method, lbd_func, **kwargs):
            try:
                ...
                api_method.Integration.Uri = Sub('arn:aws:apigateway:${Region}:lambda:path/2015-03-31/functions/${LambdaArn}/invocations', {'Region':{'Ref': 'AWS::Region'}, 
