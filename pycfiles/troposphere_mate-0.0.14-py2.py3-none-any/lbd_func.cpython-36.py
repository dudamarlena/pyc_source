...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/troposphere_mate-project/troposphere_mate/associate/lbd_func.py
# Compiled at: 2020-02-12 21:45:48
...
class LinkerApi(LinkerApi_):
    ...
    class AwsLambdaFunctionWithEc2Subnet(Linker):
        ...
        def associate(self, lbd_func, subnet, *args, **kwargs):
            ...
            try:
                ...
                lbd_func.VpcConfig = awslambda.VPCConfig(SubnetIds=[
                 Ref(subnet)],
                  SecurityGroupIds=[])
    ...
    class AwsLambdaFunctionWithEc2SecurityGroup(Linker):
        ...
        def associate(self, lbd_func, sg, *args, **kwargs):
            ...
            try:
                ...
                lbd_func.VpcConfig = awslambda.VPCConfig(SubnetIds=[], SecurityGroupIds=[
                 Ref(sg)])
    ...
    class AwsLambdaFunctionWithSQSQueue(Linker):
        ...
        def associate(self, lbd_func, sqs_queue, *args, **kwargs):
            ...
            """
            lbd_func.DeadLetterConfig = awslambda.DeadLetterConfig(TargetArn=(GetAtt(sqs_queue, 'Arn')))
