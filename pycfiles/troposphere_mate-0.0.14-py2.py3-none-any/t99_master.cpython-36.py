...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/troposphere_mate-project/troposphere_mate/orch_example/t99_master.py
...
class Canned(BaseConfig):
    ...
    def do_create_template(self):
        tpl = Template()
        stack1 = cloudformation.Stack('T1',
          template=tpl,
          TemplateURL='./01-tier.json',
          Metadata=dict(tag=(self.STAGE.get_value())))
        stack2 = cloudformation.Stack('T2',
          template=tpl,
          TemplateURL='./02-tier.json',
          Metadata=dict(tag=(self.STAGE.get_value())))
        stack3 = cloudformation.Stack('T3',
          template=tpl,
