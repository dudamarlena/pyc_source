...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/tgbotapi/types.py
# Compiled at: 2020-03-01 10:07:30
# Size of source mod 2**32: 132172 bytes
import json, six
...
class JsonDeserializable(object):
    ...
    def check_json(json_type):
        ...
        if type(json_type) == dict:
            return json_type
        if type(json_type) in str_types:
...
class WebhookInfo(JsonDeserializable):
    __doc__ = ' Contains information about the current status of a webhook '
...
class User(JsonDeserializable):
    __doc__ = ' This object represents a Telegram user or bot '
...
class Chat(JsonDeserializable):
    __doc__ = ' This object represents a chat '
    ...
    def de_json(cls, json_string):
        ...
        return cls(id, type, title, username, first_name, last_name, photo, description, invite_link, pinned_message, permissions, slow_mode_delay, sticker_set_name, can_set_sticker_set)

    def __init__(self, id, type, title=None, username=None, first_name=None, last_name=None, photo=None, description=None, invite_link=None, pinned_message=None, permissions=None, slow_mode_delay=None, sticker_set_name=None, can_set_sticker_set=None):
        self.id = id
        self.type = type
        self.title = title
        self.username = username
...
class Message(JsonDeserializable):
    __doc__ = 'This object represents a message'
    ...
    def de_json(cls, json_string):
        ...
        if 'new_chat_members' in obj:
            opts['new_chat_members'] = Message.parse_chat_members(obj['new_chat_members'])
    ...
    @property
    def html_text(self):
        return self._Message__html_text(self.text, self.entities)

    @property
    def html_caption(self):
        return self._Message__html_text(self.caption, self.caption_entities)


class MessageEntity(JsonDeserializable):
    __doc__ = ' This object represents one special entity in a text message. For example, hashtags, usernames, URLs, etc '
...
class PhotoSize(JsonDeserializable):
    __doc__ = ' This object represents one size of a photo or a file / sticker thumbnail '
...
class Document(JsonDeserializable):
    __doc__ = ' This object represents a general file (as opposed to photos, voice messages and audio files) '
...
class Video(JsonDeserializable):
    __doc__ = ' This object represents a video file '
...
class Animation(JsonDeserializable):
    __doc__ = ' This object represents an animation file (GIF or H.264/MPEG-4 AVC video without sound) '
...
class Voice(JsonDeserializable):
    __doc__ = ' This object represents a voice note '
...
class VideoNote(JsonDeserializable):
    __doc__ = ' This object represents a video message '
...
class Contact(JsonDeserializable):
    __doc__ = ' This object represents a phone contact '
...
class Location(JsonDeserializable):
    __doc__ = ' This object represents a point on the map '
...
class Venue(JsonDeserializable):
    __doc__ = ' This object represents a venue '
...
class PollOption(JsonDeserializable):
    __doc__ = ' This object contains information about one answer option in a poll '
...
class PollAnswer(JsonDeserializable):
    __doc__ = ' This object represents an answer of a user in a non-anonymous poll '
...
class Poll(JsonDeserializable):
    __doc__ = ' This object contains information about a poll '
...
class ReplyKeyboardMarkup(JsonSerializable):
    __doc__ = ' This object represents a custom keyboard with reply options (see Introduction to bots for details and examples) '
...
class InlineKeyboardMarkup(Dictionaryable, JsonSerializable):
    __doc__ = ' This object represents an inline keyboard that appears right next to the message it belongs to. '
...
class InlineKeyboardButton(JsonSerializable):
    ...
    def __init__(self, text, url=None, callback_data=None, switch_inline_query=None, switch_inline_query_current_chat=None, callback_game=None, pay=None, login_url=None):
        self.text = text
        self.url = url
...
class ChatPhoto(JsonDeserializable):
    __doc__ = ' This object represents a chat photo '
...
class ChatMember(JsonDeserializable):
    __doc__ = ' This object contains information about one member of a chat '
    ...
    def de_json(cls, json_type):
        ...
        return cls(user, status, custom_title, until_date, can_be_edited, can_change_info, can_post_messages, can_edit_messages, can_delete_messages, can_invite_users, can_restrict_members, is_member, can_pin_messages, can_promote_members, can_send_messages, can_send_media_messages, can_send_other_messages, can_add_web_page_previews, can_send_polls)

    def __init__(self, user, status, custom_title, until_date, can_be_edited, can_change_info, can_post_messages, can_edit_messages, can_delete_messages, can_invite_users, can_restrict_members, is_member, can_pin_messages, can_promote_members, can_send_messages, can_send_media_messages, can_send_polls, can_send_other_messages, can_add_web_page_previews):
        self.user = user
        self.status = status
...
class ChatPermissions(JsonDeserializable):
    __doc__ = ' Describes actions that a non-administrator user is allowed to take in a chat '
...
class ResponseParameters(JsonDeserializable):
    __doc__ = ' Contains information about why a request was unsuccessful '
...
class InputMedia(JsonSerializable):
    ...
    def _convert_input_media(self):
        if is_string(self.media):
            ...
            return (
             self.to_json(), {self._media_name: self.media})


class InputMediaPhoto(InputMedia):
    __doc__ = ' Represents a photo to be sent '
...
class InputMediaVideo(InputMedia):
    __doc__ = ' Represents a video to be sent '
...
class InputMediaAnimation(InputMedia):
    __doc__ = ' Represents an animation file (GIF or H.264/MPEG-4 AVC video without sound) to be sent '
...
class InputMediaAudio(InputMedia):
    __doc__ = ' Represents an audio file to be treated as music to be sent '
...
class InputMediaDocument(InputMedia):
    __doc__ = ' Represents a general file to be sent '
...
class Sticker(JsonDeserializable):
    __doc__ = ' This object represents a sticker '
...
class StickerSet(JsonDeserializable):
    __doc__ = ' This object represents a sticker set '
...
class MaskPosition(JsonDeserializable, JsonSerializable):
    __doc__ = ' This object describes the position on faces where a mask should be placed by default '
    ...
    def to_dic(self):
        return {'point':self.point, 
         'x_shift':self.x_shift,  'y_shift':self.y_shift,  'scale':self.scale}
...
class InlineQueryResultArticle(JsonSerializable):
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'title':self.title,  'input_message_content':self.input_message_content}
...
class InlineQueryResultAudio(JsonSerializable):
    __doc__ = ' Represents a link to an MP3 audio file. \n        By default, this audio file will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the audio.\n    '

    def __init__(self, id, audio_url, title, caption=None, parse_mode=None, performer=None, audio_duration=None, reply_markup=None, input_message_content=None):
        self.type = 'audio'
        self.id = id
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'audio_url':self.audio_url, 
         'title':self.title}
        if self.caption:
...
class InlineQueryResultCachedAudio(JsonSerializable):
    __doc__ = ' Represents a link to an MP3 audio file stored on the Telegram servers. \n        By default, this audio file will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the audio.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'audio_file_id':self.audio_file_id}
        if self.title:
...
class InlineQueryResultCachedDocument(JsonSerializable):
    __doc__ = ' Represents a link to a file stored on the Telegram servers. \n        By default, this file will be sent by the user with an optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the file.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'document_file_id':self.document_file_id}
        if self.title:
            json_dict['title'] = self.title
        if self.description:
            json_dict['description'] = self.description
...
class InlineQueryResultCachedGif(JsonSerializable):
    __doc__ = ' Represents a link to an animated GIF file stored on the Telegram servers. \n        By default, this animated GIF file will be sent by the user with an optional caption. \n        Alternatively, you can use input_message_content to send a message with specified content instead of the animation.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'gif_file_id':self.gif_file_id}
        if self.title:
            json_dict['title'] = self.title
        if self.caption:
            json_dict['caption'] = self.caption
...
class InlineQueryResultCachedMpeg4Gif(JsonSerializable):
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'mpeg4_file_id':self.mpeg4_file_id}
        if self.title:
            json_dict['title'] = self.title
        if self.caption:
            json_dict['caption'] = self.caption
...
class InlineQueryResultCachedPhoto(JsonSerializable):
    __doc__ = ' Represents a link to a photo. By default, this photo will be sent by the user with optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the photo.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'photo_url':self.photo_url, 
...
class InlineQueryResultCachedSticker(JsonSerializable):
    __doc__ = ' Represents a link to a sticker stored on the Telegram servers. \n        By default, this sticker will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the sticker.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'sticker_file_id':self.sticker_file_id}
        if self.reply_markup:
            json_dict['reply_markup'] = self.reply_markup
        if self.input_message_content:
            json_dict['input_message_content'] = self.input_message_content
...
class InlineQueryResultCachedVideo(JsonSerializable):
    __doc__ = ' Represents a link to a video file stored on the Telegram servers. \n        By default, this video file will be sent by the user with an optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the video.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'video_file_id':self.video_file_id}
        if self.title:
            json_dict['title'] = self.title
        if self.description:
            json_dict['description'] = self.description
...
class InlineQueryResultCachedVoice(JsonSerializable):
    __doc__ = ' Represents a link to a voice message stored on the Telegram servers. \n        By default, this voice message will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the voice message.\n    '
    ...
    def to_dict(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'voice_file_id':self.voice_file_id}
        if self.title:
            json_dict['title'] = self.title
        if self.description:
            json_dict['description'] = self.description
...
class InlineQueryResultContact(JsonSerializable):
    __doc__ = ' Represents a contact with a phone number. \n        By default, this contact will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the contact.\n    '
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'phone_number':self.phone_number, 
...
class InlineQueryResultGame(JsonSerializable):
    ...
    def to_json(self):
        json_dic = {'type':self.type, 
         'id':self.id,  'game_short_name':self.game_short_name}
        if self.reply_markup:
...
class InlineQueryResultDocument(JsonSerializable):
    __doc__ = ' Represents a link to a file. \n        By default, this file will be sent by the user with an optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the file. \n        Currently, only .PDF and .ZIP files can be sent using this method.\n    '

    def __init__(self, id, title, document_url, mime_type, caption=None, parse_mode=None, description=None, reply_markup=None, input_message_content=None, thumb_url=None, thumb_width=None, thumb_height=None):
        self.type = 'document'
        self.id = id
        self.title = title
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'title':self.title,  'document_url':self.document_url,  'mime_type':self.mime_type}
        if self.caption:
            json_dict['caption'] = self.caption
        if self.parse_mode:
            json_dict['parse_mode'] = self.parse_mode
...
class InlineQueryResultGif(JsonSerializable):
    __doc__ = ' Represents a link to an animated GIF file. \n        By default, this animated GIF file will be sent by the user with optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the animation.\n    '

    def __init__(self, id, gif_url, thumb_url, gif_width=None, gif_height=None, title=None, caption=None, reply_markup=None, input_message_content=None, gif_duration=None):
        """
        :param id: Unique identifier for this result, 1-64 bytes.
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'gif_url':self.gif_url, 
         'thumb_url':self.thumb_url}
        if self.gif_height:
...
class InlineQueryResultLocation(JsonSerializable):
    __doc__ = ' Represents a location on a map. \n        By default, the location will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the location.\n    '

    def __init__(self, id, title, latitude, longitude, live_period=None, reply_markup=None, input_message_content=None, thumb_url=None, thumb_width=None, thumb_height=None):
        self.type = 'location'
        self.id = id
        self.title = title
        self.latitude = latitude
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'title':self.title,  'latitude':self.latitude, 
...
class InlineQueryResultMpeg4Gif(JsonSerializable):
    __doc__ = ' Represents a link to a video animation (H.264/MPEG-4 AVC video without sound). \n        By default, this animated MPEG-4 file will be sent by the user with optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the animation.\n    '

    def __init__(self, id, mpeg4_url, thumb_url, mpeg4_width=None, mpeg4_height=None, title=None, caption=None, parse_mode=None, reply_markup=None, input_message_content=None, mpeg4_duration=None):
        """
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'mpeg4_url':self.mpeg4_url, 
         'thumb_url':self.thumb_url}
        if self.mpeg4_width:
...
class InlineQueryResultPhoto(JsonSerializable):
    __doc__ = ' Represents a link to a photo. \n        By default, this photo will be sent by the user with optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the photo.\n    '

    def __init__(self, id, photo_url, thumb_url, photo_width=None, photo_height=None, title=None, description=None, caption=None, parse_mode=None, reply_markup=None, input_message_content=None):
        """
...
class InlineQueryResultVenue(JsonSerializable):
    __doc__ = ' Represents a venue. \n        By default, the venue will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the venue.\n    '

    def __init__(self, id, title, latitude, longitude, address, foursquare_id=None, reply_markup=None, input_message_content=None, thumb_url=None, thumb_width=None, thumb_height=None):
        self.type = 'venue'
        self.id = id
        self.title = title
        self.latitude = latitude
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'title':self.title,  'latitude':self.latitude,  'longitude':self.longitude, 
...
class InlineQueryResultVideo(JsonSerializable):
    __doc__ = ' Represents a link to a page containing an embedded video player or a video file. \n        By default, this video file will be sent by the user with an optional caption. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the video.\n\n        If an InlineQueryResultVideo message contains an embedded video (e.g., YouTube), \n        you must replace its content using input_message_content.\n    '

    def __init__(self, id, video_url, mime_type, thumb_url, title, caption=None, parse_mode=None, video_width=None, video_height=None, video_duration=None, description=None, reply_markup=None, input_message_content=None):
        """
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'video_url':self.video_url,  'mime_type':self.mime_type,  'thumb_url':self.thumb_url, 
         'title':self.title}
        if self.video_width:
...
class InlineQueryResultVoice(JsonSerializable):
    __doc__ = ' Represents a link to a voice recording in an .ogg container encoded with OPUS. \n        By default, this voice recording will be sent by the user. \n        Alternatively, you can use input_message_content to send a message with the specified content instead of the the voice message.\n    '

    def __init__(self, id, voice_url, title, caption=None, parse_mode=None, performer=None, voice_duration=None, reply_markup=None, input_message_content=None):
        self.type = 'voice'
        self.id = id
    ...
    def to_json(self):
        json_dict = {'type':self.type, 
         'id':self.id,  'voice_url':self.voice_url, 
         'title':self.title}
        if self.caption:
            json_dict['caption'] = self.caption
        if self.parse_mode:
...
class InputLocationMessageContent(Dictionaryable):
    __doc__ = ' Represents the content of a location message to be sent as the result of an inline query '
    ...
    def to_dic(self):
        json_dic = {'latitude':self.latitude, 
         'longitude':self.longitude}
        if self.live_period:
...
class InputVenueMessageContent(Dictionaryable):
    __doc__ = ' Represents the content of a venue message to be sent as the result of an inline query '
    ...
    def to_dic(self):
        json_dic = {'latitude':self.latitude, 
         'longitude':self.longitude,  'title':self.title,  'address':self.address}
        if self.foursquare_id:
...
class InputContactMessageContent(Dictionaryable):
    __doc__ = ' Represents a result of an inline query that was chosen by the user and sent to their chat partner '
...
class LabeledPrice(JsonSerializable):
    __doc__ = ' This object represents a portion of the price for goods or services '
...
class Invoice(JsonDeserializable):
    __doc__ = ' This object contains basic information about an invoice '
...
class ShippingAddress(JsonDeserializable):
    __doc__ = ' This object represents a shipping address '
...
class OrderInfo(JsonDeserializable):
    __doc__ = ' This object represents information about an order '
...
class ShippingOption(JsonSerializable):
    __doc__ = ' This object represents one shipping option '
    ...
    def to_json(self):
        ...
        json_dict = json.dumps({'id':self.id, 
         'title':self.title,  'prices':price_list})
        return json_dict


class SuccessfulPayment(JsonDeserializable):
    __doc__ = ' This object contains basic information about a successful payment '
    ...
    def de_json(cls, json_string):
        ...
        return cls(currency, total_amount, invoice_payload, shipping_option_id, order_info, telegram_payment_charge_id, provider_payment_charge_id)

    def __init__(self, currency, total_amount, invoice_payload, shipping_option_id, order_info, telegram_payment_charge_id, provider_payment_charge_id):
        self.currency = currency
        self.total_amount = total_amount
...
class ShippingQuery(JsonDeserializable):
    __doc__ = ' This object contains information about an incoming shipping query '
...
class PreCheckoutQuery(JsonDeserializable):
    __doc__ = ' This object contains information about an incoming pre-checkout query '
...
class PassportData(JsonDeserializable):
    __doc__ = ' Contains information about Telegram Passport data shared with the bot by the user '
...
class PassportFile(JsonDeserializable):
    __doc__ = "This object represents a file uploaded to Telegram Passport,\n    Currently all Telegram Passport files are in JPEG format when decrypted and don't exceed 10MB."
...
class EncryptedPassportElement(JsonDeserializable):
    __doc__ = ' Contains information about documents or other Telegram Passport elements shared with the bot by the user '
    ...
    def de_json(cls, json_string):
        ...
        if 'translation' in obj:
            translation = EncryptedPassportElement.parse_translation(obj['translation'])
        hash = obj.get('hash')
...
class EncryptedCredentials(JsonDeserializable):
    __doc__ = 'Contains data required for decrypting and authenticating EncryptedPassportElement. \n    See the Telegram Passport Documentation for a complete description of the data decryption and authentication processes.'
...
class PassportElementErrorDataField(JsonDeserializable):
    __doc__ = " Represents an issue in one of the data fields that was provided by the user. \n    The error is considered resolved when the field's value changes "
...
class PassportElementErrorFrontSide(JsonDeserializable):
    __doc__ = ' Represents an issue with the front side of a document,\n    The error is considered resolved when the file with the front side of the document changes.\n    '
...
class PassportElementErrorFile(JsonDeserializable):
    __doc__ = ' Represents an issue with a document scan. \n    The error is considered resolved when the file with the document scan changes.\n    '
...
class PassportElementErrorFiles(JsonDeserializable):
    __doc__ = ' Represents an issue with a list of scans. \n    The error is considered resolved when the list of files containing the scans changes.\n    '
...
class PassportElementErrorReverseSide(JsonDeserializable):
    __doc__ = ' Represents an issue with the reverse side of a document,\n    The error is considered resolved when the file with reverse side of the document changes.\n    '
...
class PassportElementErrorSelfie(JsonDeserializable):
    __doc__ = ' Represents an issue with the selfie with a document. \n    The error is considered resolved when the file with the selfie changes.\n    '
...
class PassportElementErrorTranslationFile(JsonDeserializable):
    __doc__ = ' Represents an issue with one of the files that constitute the translation of a document,\n    The error is considered resolved when the file changes.\n    '
...
class PassportElementErrorTranslationFiles(JsonDeserializable):
    __doc__ = ' Represents an issue with the translated version of a document. \n    The error is considered resolved when a file with the document translation change.\n    '
...
class PassportElementErrorUnspecified(JsonDeserializable):
    __doc__ = ' Represents an issue in an unspecified place. \n    The error is considered resolved when new data is added.\n    '
...
class Game(JsonDeserializable):
    __doc__ = ' This object represents a game. Use BotFather to create and edit games, their short names will act as unique identifiers '
...
class CallbackGame:
    __doc__ = ' A placeholder, currently holds no information. Use BotFather to set up your game. '


class GameHighScore(JsonDeserializable):
    __doc__ = ' This object represents one row of the high scores table for a game '
