...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/tgbotapi/__init__.py
# Compiled at: 2020-02-29 09:52:56
# Size of source mod 2**32: 83555 bytes
...
class Saver:
    ...
    def load_handlers(self, filename, del_file_after_loading=True):
        tmp = self.return_load_handlers(filename,
          del_file_after_loading=del_file_after_loading)
        if tmp is not None:
...
class TBot:
    ...
    def __init__(self, token, threaded=True, skip_pending=False, num_threads=2):
        ...
        self._TBot__stop_polling = threading.Event()
    ...
    def __retrieve_updates(self, timeout=20):
        ...
        if self.skip_pending:
            logger.debug('Skipped {0} pending messages'.format(self._TBot__skip_updates()))
    ...
    def process_new_messages(self, new_messages):
        ...
        self._TBot__notify_update(new_messages)
    ...
    def infinity_polling(self, timeout=20, *args, **kwargs):
        while not self._TBot__stop_polling.is_set():
            try:
                (self.polling)(args, timeout=timeout, **kwargs)
    ...
    def polling(self, none_stop=False, interval=0, timeout=20):
        ...
        """
        if self.threaded:
            self._TBot__threaded_polling(none_stop, interval, timeout)
        else:
            self._TBot__non_threaded_polling(none_stop, interval, timeout)

    def __threaded_polling(self, none_stop=False, interval=0, timeout=3):
        logger.info('Started polling.')
        self._TBot__stop_polling.clear()
        error_interval = 0.25
        polling_thread = WorkerThread(name='PollingThread')
        or_event = OrEvent(polling_thread.done_event, polling_thread.exception_event, self.worker_pool.exception_event)
        while not self._TBot__stop_polling.wait(interval):
            or_event.clear()
            try:
                polling_thread.put(self._TBot__retrieve_updates, timeout)
                or_event.wait()
    ...
    def __non_threaded_polling(self, none_stop=False, interval=0, timeout=3):
        ...
        while not self._TBot__stop_polling.wait(interval):
            try:
                self._TBot__retrieve_updates(timeout)
                error_interval = 0.25
            except methods.ApiException as e:
                logger.error(e)
                if not none_stop:
    ...
    def get_file_url(self, file_id):
        return methods.get_file_url(self.token, file_id)
    ...
    def get_user_profile_photos(self, user_id, offset=None, limit=None):
        ...
        :return: API reply.
        """
        result = methods.get_user_profile_photos(self.token, user_id, offset, limit)
    ...
    def get_chat_members_count(self, chat_id):
        ...
        :return:
        """
        result = methods.get_chat_members_count(self.token, chat_id)
        return result
    ...
    def set_chat_sticker_set(self, chat_id, sticker_set_name):
        ...
        :return:
        """
        result = methods.set_chat_sticker_set(self.token, chat_id, sticker_set_name)
        return result
    ...
    def delete_chat_sticker_set(self, chat_id):
        ...
        :return:
        """
        result = methods.delete_chat_sticker_set(self.token, chat_id)
        return result
    ...
    def get_chat_member(self, chat_id, user_id):
        ...
        :return:
        """
        result = methods.get_chat_member(self.token, chat_id, user_id)
    ...
    def send_message(self, chat_id, text, disable_web_page_preview=None, reply_to_message_id=None, reply_markup=None, parse_mode=None, disable_notification=None, timeout=None):
        ...
        :return: API reply.
        """
        return types.Message.de_json(methods.send_message(self.token, chat_id, text, disable_web_page_preview, reply_to_message_id, reply_markup, parse_mode, disable_notification, timeout))
    ...
    def forward_message(self, chat_id, from_chat_id, message_id, disable_notification=None):
        ...
        :return: API reply.
        """
        return types.Message.de_json(methods.forward_message(self.token, chat_id, from_chat_id, message_id, disable_notification))
    ...
    def send_photo(self, chat_id, photo, caption=None, reply_to_message_id=None, reply_markup=None, parse_mode=None, disable_notification=None):
        """
        ...
        :return: API reply.
        """
        return types.Message.de_json(methods.send_photo(self.token, chat_id, photo, caption, reply_to_message_id, reply_markup, parse_mode, disable_notification))

    def send_audio(self, chat_id, audio, caption=None, duration=None, performer=None, title=None, reply_to_message_id=None, reply_markup=None, parse_mode=None, disable_notification=None, timeout=None):
        """
        ...
        :return: Message
        """
        return types.Message.de_json(methods.send_audio(self.token, chat_id, audio, caption, duration, performer, title, reply_to_message_id, reply_markup, parse_mode, disable_notification, timeout))
    ...
    def send_voice(self, chat_id, voice, caption=None, duration=None, reply_to_message_id=None, reply_markup=None, parse_mode=None, disable_notification=None, timeout=None):
        ...
        :return: Message
        """
        return types.Message.de_json(methods.send_voice(self.token, chat_id, voice, caption, duration, reply_to_message_id, reply_markup, parse_mode, disable_notification, timeout))

    def send_document(self, chat_id, data, reply_to_message_id=None, caption=None, reply_markup=None, parse_mode=None, disable_notification=None, timeout=None):
        """
        ...
        :return: API reply.
        """
        return types.Message.de_json(methods.send_data((self.token), chat_id, data, 'document', reply_to_message_id, reply_markup, parse_mode,
    ...
    def send_sticker(self, chat_id, data, reply_to_message_id=None, reply_markup=None, disable_notification=None, timeout=None):
        ...
        :return: API reply.
        """
        return types.Message.de_json(methods.send_data(self.token, chat_id, data, 'sticker', reply_to_message_id, reply_markup, disable_notification, timeout))

    def send_video(self, chat_id, data, duration=None, caption=None, reply_to_message_id=None, reply_markup=None, parse_mode=None, supports_streaming=None, disable_notification=None, timeout=None):
        """
        ...
        :return:
        """
        return types.Message.de_json(methods.send_video(self.token, chat_id, data, duration, caption, reply_to_message_id, reply_markup, parse_mode, supports_streaming, disable_notification, timeout))

    def send_animation(self, chat_id, animation, duration=None, caption=None, reply_to_message_id=None, reply_markup=None, parse_mode=None, disable_notification=None, timeout=None):
        """
        ...
        :return:
        """
        return types.Message.de_json(methods.send_animation(self.token, chat_id, animation, duration, caption, reply_to_message_id, reply_markup, parse_mode, disable_notification, timeout))

    def send_video_note(self, chat_id, data, duration=None, length=None, reply_to_message_id=None, reply_markup=None, disable_notification=None, timeout=None):
        """
        Use this method to send video files, Telegram clients support mp4 videos.
        :param chat_id: Integer : Unique identifier for the message recipient — User or GroupChat id
        ...
        :return:
        """
        return types.Message.de_json(methods.send_video_note(self.token, chat_id, data, duration, length, reply_to_message_id, reply_markup, disable_notification, timeout))
    ...
    def send_media_group(self, chat_id, media, disable_notification=None, reply_to_message_id=None):
        ...
        :return:
        """
        result = methods.send_media_group(self.token, chat_id, media, disable_notification, reply_to_message_id)
        ret = []
        for msg in result:
    ...
    def send_location(self, chat_id, latitude, longitude, live_period=None, reply_to_message_id=None, reply_markup=None, disable_notification=None):
        """
        ...
        :return: API reply.
        """
        return types.Message.de_json(methods.send_location(self.token, chat_id, latitude, longitude, live_period, reply_to_message_id, reply_markup, disable_notification))
    ...
    def edit_message_live_location(self, latitude, longitude, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        ...
        :return:
        """
        return types.Message.de_json(methods.edit_message_live_location(self.token, latitude, longitude, chat_id, message_id, inline_message_id, reply_markup))
    ...
    def stop_message_live_location(self, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        ...
        :return:
        """
        return types.Message.de_json(methods.stop_message_live_location(self.token, chat_id, message_id, inline_message_id, reply_markup))
    ...
    def send_venue(self, chat_id, latitude, longitude, title, address, foursquare_id=None, disable_notification=None, reply_to_message_id=None, reply_markup=None):
        ...
        :return:
        """
        return types.Message.de_json(methods.send_venue(self.token, chat_id, latitude, longitude, title, address, foursquare_id, disable_notification, reply_to_message_id, reply_markup))
    ...
    def send_contact(self, chat_id, phone_number, first_name, last_name=None, disable_notification=None, reply_to_message_id=None, reply_markup=None):
        return types.Message.de_json(methods.send_contact(self.token, chat_id, phone_number, first_name, last_name, disable_notification, reply_to_message_id, reply_markup))
    ...
    def restrict_chat_member(self, chat_id, user_id, until_date=None, can_send_messages=None, can_send_media_messages=None, can_send_polls=None, can_send_other_messages=None, can_add_web_page_previews=None, can_change_info=None, can_invite_users=None, can_pin_messages=None):
        ...
        """
        return methods.restrict_chat_member(self.token, chat_id, user_id, until_date, can_send_messages, can_send_media_messages, can_send_polls, can_send_other_messages, can_add_web_page_previews, can_change_info, can_invite_users, can_pin_messages)
    ...
    def edit_message_text(self, text, chat_id=None, message_id=None, inline_message_id=None, parse_mode=None, disable_web_page_preview=None, reply_markup=None):
        ...
        :return:
        """
        result = methods.edit_message_text(self.token, text, chat_id, message_id, inline_message_id, parse_mode, disable_web_page_preview, reply_markup)
        if type(result) == bool:
            return result
        else:
    ...
    def edit_message_media(self, media, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        ...
        :return:
        """
        result = methods.edit_message_media(self.token, media, chat_id, message_id, inline_message_id, reply_markup)
        if type(result) == bool:
            return result
        else:
            return types.Message.de_json(result)
    ...
    def edit_message_reply_markup(self, chat_id=None, message_id=None, inline_message_id=None, reply_markup=None):
        ...
        :return:
        """
        result = methods.edit_message_reply_markup(self.token, chat_id, message_id, inline_message_id, reply_markup)
        if type(result) == bool:
            return result
        else:
            return types.Message.de_json(result)
    ...
    def send_game(self, chat_id, game_short_name, disable_notification=None, reply_to_message_id=None, reply_markup=None):
        ...
        :return:
        """
        result = methods.send_game(self.token, chat_id, game_short_name, disable_notification, reply_to_message_id, reply_markup)
        return types.Message.de_json(result)
    ...
    def set_game_score(self, user_id, score, force=None, chat_id=None, message_id=None, inline_message_id=None, edit_message=None):
        ...
        :return:
        """
        result = methods.set_game_score(self.token, user_id, score, force, chat_id, message_id, inline_message_id, edit_message)
        if type(result) == bool:
            return result
        else:
            return types.Message.de_json(result)
    ...
    def send_invoice(self, chat_id, title, description, invoice_payload, provider_token, currency, prices, start_parameter, photo_url=None, photo_size=None, photo_width=None, photo_height=None, need_name=None, need_phone_number=None, need_email=None, need_shipping_address=None, is_flexible=None, disable_notification=None, reply_to_message_id=None, reply_markup=None, provider_data=None):
        """
        Sends invoice
            :param chat_id:
            :param title:
        ...
        :return:
        """
        result = methods.send_invoice(self.token, chat_id, title, description, invoice_payload, provider_token, currency, prices, start_parameter, photo_url, photo_size, photo_width, photo_height, need_name, need_phone_number, need_email, need_shipping_address, is_flexible, disable_notification, reply_to_message_id, reply_markup, provider_data)
        return types.Message.de_json(result)
    ...
    def send_poll(self, chat_id, poll, disable_notifications=False, reply_to_message=None, reply_markup=None):
        ...
        :return:
        """
        return types.Message.de_json(methods.send_poll(self.token, chat_id, poll.question, poll.options, disable_notifications, reply_to_message, reply_markup))
    ...
    def stop_poll(self, chat_id, message_id):
        ...
        :return:
        """
        return types.Poll.de_json(methods.stop_poll(self.token, chat_id, message_id))
    ...
    def edit_message_caption(self, caption, chat_id=None, message_id=None, inline_message_id=None, parse_mode=None, reply_markup=None):
        ...
        :return:
        """
        result = methods.edit_message_caption(self.token, caption, chat_id, message_id, inline_message_id, parse_mode, reply_markup)
        if type(result) == bool:
            return result
        else:
            return types.Message.de_json(result)
    ...
    def answer_inline_query(self, inline_query_id, results, cache_time=None, is_personal=None, next_offset=None, switch_pm_text=None, switch_pm_parameter=None):
        ...
        """
        return methods.answer_inline_query(self.token, inline_query_id, results, cache_time, is_personal, next_offset, switch_pm_text, switch_pm_parameter)
    ...
    def get_sticker_set(self, name):
        ...
        :return:
        """
        result = methods.get_sticker_set(self.token, name)
    ...
    def upload_sticker_file(self, user_id, png_sticker):
        ...
        :return:
        """
        result = methods.upload_sticker_file(self.token, user_id, png_sticker)
    ...
    def create_new_sticker_set(self, user_id, name, title, png_sticker, emojis, contains_masks=None, mask_position=None):
        ...
        :return:
        """
        return methods.create_new_sticker_set(self.token, user_id, name, title, png_sticker, emojis, contains_masks, mask_position)
    ...
    def add_sticker_to_set(self, user_id, name, png_sticker, emojis, mask_position=None):
        ...
        :return:
        """
        return methods.add_sticker_to_set(self.token, user_id, name, png_sticker, emojis, mask_position)
