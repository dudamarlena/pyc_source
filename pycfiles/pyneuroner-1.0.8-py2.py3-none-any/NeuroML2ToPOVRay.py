...
# Embedded file name: build/bdist.linux-x86_64/egg/pyneuroml/povray/NeuroML2ToPOVRay.py
# Compiled at: 2019-10-15 15:22:31
import random, argparse, neuroml
        ...
        for segment in segments:
            ...
            if segment.proximal is not None:
                ...
                cell_id_vs_seg_id_vs_proximal[cell.id][id] = (
                 float(proximal.x), float(proximal.y), float(proximal.z))
            else:
    ...
    if args.conns or args.conn_points:
        ...
        for projection in projections:
            ...
            if isinstance(projection, neuroml.Projection):
                ...
                if isinstance(projection, neuroml.ElectricalProjection):
