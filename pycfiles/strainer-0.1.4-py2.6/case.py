...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/strainer/case.py
...
import unittest
__all__ = [
 'STestCase', 'call_super', 'DelayedException', 'exception_raiser_generator', 'exc_raiser_gen', 'erg']
