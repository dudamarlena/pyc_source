...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/unifi/controller.py
# Compiled at: 2019-07-03 10:59:07
...
class Controller(object):
    ...
    def _request(self, endpoint, data={}, method='POST'):
        if not self.logged_in:
            ...
            url = '{}/api/s/{}/{}'.format(self._baseurl, self.site, endpoint)
        return self._jsondec(self._session.send((self._session.prepare_request(Request(method,
          url,
    ...
    def connect(self):
        ...
        try:
            self.logged_in = True
            return self._request('login', {'username':self.username, 
    ...
    def authorize_guest(self, mac, minutes, up=None, down=None, mbytes=None, ap_mac=None):
        ...
        if ap_mac is not None:
            if self.version != 'v2':
                data['ap_mac'] = ap_mac
        return self._request('cmd/stamgr', data)
    ...
    def unauthorize_guest(self, mac):
        ...
        mac: the guest MAC address
        """
        return self._request('cmd/stamgr', {'cmd':'unauthorize-guest', 
         'mac':mac})
    ...
    def reconnect_sta(self, mac):
        ...
        mac: the guest MAC address
        """
        return self._request('cmd/stamgr', {'cmd':'kick-sta', 
         'mac':mac})
    ...
    def block_sta(self, mac):
        ...
        mac: the guest MAC address
        """
        return self._request('cmd/stamgr', {'cmd':'block-sta', 
         'mac':mac})
    ...
    def unblock_sta(self, mac):
        ...
        mac: the guest MAC address
        """
        return self._request('cmd/stamgr', {'cmd':'unblock-sta', 
         'mac':mac})
