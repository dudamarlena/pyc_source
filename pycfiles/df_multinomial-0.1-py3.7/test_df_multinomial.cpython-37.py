...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\df_multinomial\test_df_multinomial.py
# Compiled at: 2019-03-28 19:06:30
...
class TestMultinomial_proportions_confint_df(TestCase):
    ...
    def test_1row(self):
        ...
        output = pd.DataFrame((np.array([[0.00886303, 0.02964269, 0.00886303, 0.38886499, 0.39820861, 0.47625034, 0.39820861, 0.90759919]])), columns=[
         'lb_1', 'lb_2', 'lb_3', 'lb_4', 'ub_1', 'ub_2', 'ub_3', 'ub_4'])
    ...
    def test_3rows(self):
        ...
        output = pd.DataFrame((np.array([
         ...
         [
          0.01654455, 0.52260908, 0.0016451, 0.16073701, 0.15872367, 0.78512666, 0.09976654, 0.40843295][(0.61930197,
                                                                                                          0.05945823,
                                                                                                          0.182921,
                                                                                                          0.01335789,
                                                                                                          0.71500309,
