...
# [GCC 8.4.0]
# Embedded file name: /home/turicas/software/pyenv/versions/rows/lib/python3.6/site-packages/rows/plugins/xls.py
# Compiled at: 2019-02-13 03:47:25
# Size of source mod 2**32: 7569 bytes
from __future__ import unicode_literals
import datetime
from io import BytesIO
import xlrd, xlwt, rows.fields as fields
from rows.plugins.utils import create_table, get_filename_and_fobj, prepare_to_export
CELL_TYPES = {xlrd.XL_CELL_BLANK: fields.TextField, 
    ...
    def convert_value(field_type, value):
        ...
        if field_type in (
         ...
         fields.TextField):
            ...
            return (
             field_type.serialize(value), data)
...
def cell_value(sheet, row, col):
    ...
    if field_type is None:
        ...
        if field_type is fields.TextField:
            ...
            if field_type is fields.BoolField:
                if value == 0:
                    return False
                if value == 1:
                    return True
...
def import_from_xls(filename_or_fobj, sheet_name=None, sheet_index=0, start_row=None, start_column=None, end_row=None, end_column=None, *args, **kwargs):
    ...
    meta = {'imported_from':'xls', 
     'filename':filename,  'sheet_name':sheet.name}
