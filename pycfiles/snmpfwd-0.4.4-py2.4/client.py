...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snmpfwd/trunking/client.py
...
class TrunkingClient(asyncore.dispatcher_with_send):
    ...
    def sendAnnouncement(self, trunkId):
        self.__announcementData = protocol.prepareAnnouncementData(trunkId, self.__secret)
