...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snmpfwd/trunking/server.py
# Compiled at: 2018-12-30 12:01:29
import socket, asyncore, traceback, sys
...
class TrunkingSuperServer(asyncore.dispatcher):
    ...
    def handle_accept(self):
        ...
        TrunkingServer(sock, self.__localEndpoint, remoteEndpoint, self.__secret, self.__dataCbFun, self.__ctlCbFun, self.__ctlCbCtx)
...
class TrunkingServer(asyncore.dispatcher_with_send):
    ...
    def __init__(self, sock, localEndpoint, remoteEndpoint, secret, dataCbFun, ctlCbFun, ctlCbCtx):
    ...
    def __repr__(self):
        return '%s(%s, %s)' % (self.__class__.__name__, self.__localEndpoint, self.__remoteEndpoint)
