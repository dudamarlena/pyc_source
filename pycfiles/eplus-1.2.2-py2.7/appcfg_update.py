...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/eplus/appcfg_update.py
# Compiled at: 2019-09-12 06:57:16
import os, sys, argparse, yaml
from random import randint

def simulate_legacy_update():
    parser = argparse.ArgumentParser(description='Deploy', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def get_target_yaml(source_yaml):
    ...
    :return: str
    """
    return ('{base}.deploy{r}.yaml').format(base=source_yaml, r=randint(1000, 9999))
