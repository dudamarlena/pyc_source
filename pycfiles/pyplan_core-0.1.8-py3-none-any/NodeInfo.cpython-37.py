...
# [GCC 8.4.0]
# Embedded file name: /home/fabian/devs/novix/python/pyplan-core/pyplan_core/classes/NodeInfo.py
...
class NodeInfo(dict):
    ...
    def __init__(self, showInputs, showOutputs, showLabel, showBorder, fill, useNodeFont):
        ...
        """
        dict.__init__(self, showInputs=showInputs, showOutputs=showOutputs, showLabel=showLabel,
          showBorder=showBorder,
          fill=fill,
          useNodeFont=useNodeFont)
