...
# [GCC 8.4.0]
# Embedded file name: build/lib.macosx-10.6-intel-2.7/spherogram/links/orthogonal.py
            ...
            for i in range(len(face_info) - 2):
                ...
                if x.turn == -1:
                    if y.turn == z.turn == 1:
                        ...
                        return [
                         (
                          a.index, b.index)] + saturate_face(remaining)
...
class OrthogonalLinkDiagram(list):
    ...
    def plink_data(self):
        ...
        * a list of crossings in the format (arrow over, arrow under)
        ...
        return (
         vertex_positions, arrows, crossings)
...
if __name__ == '__main__':
    ...
    def test(manifold_with_DT, plink_manifold=None):
        ...
        if appears_hyperbolic(PM):
            assert abs(manifold_with_DT.volume() - PM.volume()) < 1e-06
