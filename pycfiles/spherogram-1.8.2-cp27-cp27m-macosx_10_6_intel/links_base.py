...
# [GCC 8.4.0]
# Embedded file name: build/lib.macosx-10.6-intel-2.7/spherogram/links/links_base.py
...
class Crossing(object):
    ...
    * strand_components: Which element of the parent
    ...
    def DT_info(self):
        ...
        if over % 2 == 0:
            return (under, -over, flip)
        return (over, under, flip)
...
class Link(object):
        ...
        while labels:
            ...
            if c1 == c2:
                ...
                if other_labels[0] < other_labels[1]:
                    ...
                    if other_labels[1] < other_labels[0]:
    ...
    def split_link_diagram(self, destroy_original=False):
        ...
        """
        link = (destroy_original or self.copy)() if 1 else self
    ...
    def copy(self, recursively=False):
        ...
        if recursively:
            ...
            for component in self.link_components:
                ...
                component_starts.append(CrossingEntryPoint(crossing, entry_point))
    ...
    def mirror(self):
        ...
        new_link = type(self)(list(new_crossings.values()), check_planarity=False, build=False)
        component_starts = []
        for component in self.link_components:
...
def python_KLP(L):
    ...
    return [
     len(vertices), 0, len(L.link_components), [ KLPCrossing(c) for c in vertices ]]