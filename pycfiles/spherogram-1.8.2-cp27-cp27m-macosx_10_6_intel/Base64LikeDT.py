...
# [GCC 8.4.0]
# Embedded file name: build/lib.macosx-10.6-intel-2.7/spherogram/codecs/Base64LikeDT.py
...
"""
_base64LikeEncoding = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+-'
...
def _get_num_chars(code):
    ...
    """
    max_number = max([ max([ abs(crossing) for crossing in comp ]) for comp in code
                     ])
    num_chars = 1
    while max_number > 31:
        num_chars += 1
