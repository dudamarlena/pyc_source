...
# [GCC 8.4.0]
# Embedded file name: build/lib.macosx-10.6-intel-2.7/spherogram/links/planar_isotopy.py
...
def isosig(tangle, root=None, over_or_under=False):
    ...
    return (
     (
      len(tangle.crossings), tangle.n), tuple(isosig_strands), tuple(isosig_loops), tuple(isosig_orientations), tuple(isosig_over_or_under), root_isosig)
...
def all_cross_strands(tangle):
    ...
    return (
     strands_with_ends, loops, orientations, crossing_order, over_or_under)
