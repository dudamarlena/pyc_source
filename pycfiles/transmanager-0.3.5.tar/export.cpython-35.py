...
# [GCC 8.4.0]
# Embedded file name: /var/www/transmanager/transmanager/export.py
...
class ExportBo(object):
    ...
    def export_translations(tasks_ids):
        ...
        export = ExportQueryset(qs, TransTask, ('id', 'object_name', 'object_pk', 'object_field_label',
                                                'object_field_value', 'number_of_words',
...
class ImportBo(object):
    ...
    def import_translations(file):
        ...
        for row in range(init_data_row, sheet.nrows):
            ...
            if not not translation_value:
                if translation_value.strip() == '':
                    pass
                else:
                    try:
