...
# [GCC 8.4.0]
# Embedded file name: /var/www/transmanager/transmanager/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='TransApplicationLanguage', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', serialize=False, auto_created=True)),
      (
       'application', models.CharField(unique=True, verbose_name='Aplicación', max_length=100))], options={'verbose_name': 'Idiomas por aplicación', 
      'verbose_name_plural': 'Idiomas por aplicaciones'}),
     migrations.CreateModel(name='TransLanguage', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', serialize=False, auto_created=True)),
      (
      ...
      (
       'main_language', models.BooleanField(verbose_name='Idioma principal', default=False, help_text='¿Es el idioma principal?'))], options={'verbose_name': 'Idioma', 
      'verbose_name_plural': 'Idiomas'}),
     migrations.CreateModel(name='TransModelLanguage', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', serialize=False, auto_created=True)),
      (
       'model', models.CharField(unique=True, verbose_name='Modelo', max_length=100)),
      (
       'languages', models.ManyToManyField(to='transmanager.TransLanguage', verbose_name='Idiomas', help_text='Idiomas por defecto del modelo'))], options={'verbose_name': 'Idiomas por modelo', 
      'verbose_name_plural': 'Idiomas por modelos'}),
     migrations.CreateModel(name='TransTask', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', serialize=False, auto_created=True)),
      (
      ...
      (
       'language', models.ForeignKey(to='transmanager.TransLanguage', verbose_name='Idioma'))], options={'verbose_name_plural': 'Tareas', 
      'verbose_name': 'Tarea', 
      'ordering': ['-id']}),
     migrations.CreateModel(name='TransUser', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', serialize=False, auto_created=True)),
      (
      ...
      (
       'user', models.OneToOneField(related_name='translator_user', to=settings.AUTH_USER_MODEL, verbose_name='Usuario'))], options={'verbose_name': 'Traductor', 
      'verbose_name_plural': 'Traductores'}),
     migrations.AddField(model_name='transtask', name='user', field=models.ForeignKey(related_name='tasks', to='transmanager.TransUser', verbose_name='Usuario')),
     migrations.AddField(model_name='transapplicationlanguage', name='languages', field=models.ManyToManyField(to='transmanager.TransLanguage', verbose_name='Idiomas', help_text='Idiomas por defecto de la aplicación'))]