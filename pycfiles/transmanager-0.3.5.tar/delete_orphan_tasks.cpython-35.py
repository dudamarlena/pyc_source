...
# [GCC 8.4.0]
# Embedded file name: /var/www/transmanager/transmanager/management/commands/delete_orphan_tasks.py
# Compiled at: 2016-06-01 06:53:47
...
class Command(BaseCommand):
    help = 'Mark translations tasks that have a translation value as done and remove the tasks that does not have a parent anymore.'
    lock = Lock()
    queue = Queue()
    num_threads = 40
    threads = []
