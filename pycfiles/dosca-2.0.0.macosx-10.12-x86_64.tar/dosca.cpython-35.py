...
# [GCC 8.4.0]
# Embedded file name: /Users/r/prj/p/dosca/env/lib/python3.5/site-packages/dosca/dosca.py
# Compiled at: 2016-12-11 15:37:03
# Size of source mod 2**32: 4835 bytes
import collections
...
def parse_assignment(line, custom_parsers=None):
    ...
    return (raw_key.strip(),
     parse_value(raw_value, custom_parsers=custom_parsers))
...
def format_value_line(key, value, indent=None):
    return '{0}{1} = {2}\n'.format(indent if indent is not None else '', key, value if value is not None else '')
