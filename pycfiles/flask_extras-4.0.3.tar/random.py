...
# [GCC 8.4.0]
# Embedded file name: /Users/taborc/git/spog/public/flask_extras/flask_extras/filters/random.py
# Compiled at: 2016-06-30 12:48:04
...
def rand_color(alpha=100):
    ...
    """
    return ('rgba({0}, {1}, {2}, {3})').format(randrange(0, 255), randrange(0, 255), randrange(0, 255), alpha)