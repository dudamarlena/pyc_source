...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/catalyze/commands/metrics.py
# Compiled at: 2015-08-18 10:40:05
from __future__ import absolute_import
import click, sys, json, time, math, csv
...
class CSVTransformer(MetricsTransformer):
    ...
    def write_headers_maybe(self):
        if not self.headers_printed:
            base_headers = [
             'timestamp', 'type', 'job_id', 'cpu_usage', 'rx_kb', 'tx_kb', 'memory', 'disk_read', 'disk_write']
