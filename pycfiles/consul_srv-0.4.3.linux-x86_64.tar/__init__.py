...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/consul_srv/__init__.py
# Compiled at: 2017-08-15 17:15:05
import requests
from . import query
__all__ = [
 'service', 'register', 'mock', 'AGENT_URI']
AGENT_URI = '127.0.0.1'
...
class Service(object):
    ...
    def __call__(self, service_name, *args):
        ...
        """
        should_mock = self.MOCK_SERVICES.get(service_name) or self.MOCK_SERVICES['__all__']
        if should_mock:
        ...
        try:
            ...
            try:
                ...
                raise KeyError(('Service {} is not currently available. [MOCKED: {}]').format(service_name, should_mock))
