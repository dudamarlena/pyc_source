...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/order/adapters/item_management.py
...
class OrderItemManagement:
    ...
    def _addItemFromCartItem(self, id, cart_item):
        ...
        for selected_property in cart_item.getProperties():
            ...
            if titles is None:
                continue
            properties.append({'title': titles['property'], 'selected_option': titles['option'], 'price': str(property_price)})
