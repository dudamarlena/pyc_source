...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-aarch64/egg/deepstacks/stacked.py
# Compiled at: 2017-07-18 06:47:46
...
def build_network(network, a, m={}, **kwargs):
    ...
    for info in a:
        ...
        if type(inputs) == int or type(inputs) == str or type(inputs) == list:
            ...
            info = info[0:1] + deep_eval(info[1:], {curr_stacks: stacks, 
               curr_layer: network, 
               curr_flags: info[(-1)], 
