...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pumpkin/wrappers.py
# Compiled at: 2014-12-15 02:26:03
import sys, cgi, threading
...
class HttpHeaders(MutableMapping):
    ...
    def __init__(self, *args, **kwargs):
        self._dict = dict((HttpHeaders.normalize_key(k), [v]) for k, v in dict(*args, **kwargs).items())
