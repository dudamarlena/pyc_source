...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/column/callback.py
...
class AnsibleCallbackBase(callback.CallbackBase):
    ...
    def v2_runner_on_failed(self, result, ignore_errors=False):
        super(AnsibleCallbackBase, self).v2_runner_on_failed(result, ignore_errors)
    ...
    def v2_playbook_on_task_start(self, task, is_conditional):
        super(AnsibleCallbackBase, self).v2_playbook_on_task_start(task, is_conditional)
        self.run_on_playbook_task_start(task, is_conditional)

    def v2_playbook_on_cleanup_task_start(self, task):
        super(AnsibleCallbackBase, self).v2_playbook_on_cleanup_task_start(task)
        self.run_on_playbook_cleanup_task_start(task)

    def v2_playbook_on_handler_task_start(self, task):
        super(AnsibleCallbackBase, self).v2_playbook_on_handler_task_start(task)
        self.run_on_playbook_handler_task_start(task)

    def v2_playbook_on_vars_prompt(self, varname, private=True, prompt=None, encrypt=None, confirm=False, salt_size=None, salt=None, default=None):
        super(AnsibleCallbackBase, self).v2_playbook_on_vars_prompt(varname, private, prompt, encrypt, confirm, salt_size, salt, default)
        self.run_on_playbook_vars_prompt(varname, private, prompt, encrypt, confirm, salt_size, salt, default)
    ...
    def v2_playbook_on_import_for_host(self, result, imported_file):
        super(AnsibleCallbackBase, self).v2_playbook_on_import_for_host(result, imported_file)
        self.run_on_playbook_import_for_host(result, imported_file)

    def v2_playbook_on_not_import_for_host(self, result, missing_file):
        super(AnsibleCallbackBase, self).v2_playbook_on_not_import_for_host(result, missing_file)
...
class AnsibleCallback(AnsibleCallbackBase):
    ...
    def run_on_playbook_vars_prompt(self, varname, private=True, prompt=None, encrypt=None, confirm=False, salt_size=None, salt=None, default=None):
        pass
