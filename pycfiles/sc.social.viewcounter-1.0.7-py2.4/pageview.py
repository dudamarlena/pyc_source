...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-fat/egg/sc/social/viewcounter/pageview.py
...
class PageView(Base):
    ...
    def __repr__(self):
        return "<PageView ('%s','%s')>" % (self.object_path, self.user_ip, self.access_datetime.strftime('%Y/%m/%d'))
