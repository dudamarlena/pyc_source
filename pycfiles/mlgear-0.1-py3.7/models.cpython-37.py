...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/mlgear/models.py
# Compiled at: 2019-12-28 17:07:09
...
def runLGB(train_X, train_y, test_X=None, test_y=None, test_X2=None, params={}, meta=None):
    ...
    if params.get('early_stop'):
        ...
        if test_X2 is not None:
            ...
            pred_test_y2 = None
    return (
     pred_test_y, pred_test_y2, model.feature_importance(), model)
...
def get_lgb_feature_importance(train, target, params):
    ...
    feature_df = pd.DataFrame((sorted(zip(model.feature_importance(), train.columns))), columns=[
     'Value', 'Feature']).sort_values('Value', ascending=False)
    return feature_df
...
def runMLP(train_X, train_y, test_X=None, test_y=None, test_X2=None, params={}, meta=None):
    ...
    print('Fit MLP')
    model.fit(train_X, train_y, verbose=(params.get('model_verbose', 0)),
      callbacks=([
     metric] + params['lr_scheduler']()),
...
def runLR(train_X, train_y, test_X=None, test_y=None, test_X2=None, params={}, meta=None):
    ...
    if params.get('scale'):
        ...
        if test_X2 is not None:
            ...
            pred_test_y2 = None
    return (
     pred_test_y, pred_test_y2, model.coef_, model)
