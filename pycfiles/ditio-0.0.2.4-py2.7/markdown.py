...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ditio/notebook/markdown.py
# Compiled at: 2018-01-31 08:14:43
import shutil, re
...
def get_cell_commands(cell):
    ...
    directives = [
     ('EXPORT_IMAGES', ''), ('INCLUDE', str(False))]
