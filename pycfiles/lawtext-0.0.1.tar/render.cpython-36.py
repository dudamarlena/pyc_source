...
# [GCC 8.4.0]
# Embedded file name: c:\Users\m\dev\lawtext\lawtext\render.py
# Compiled at: 2017-12-13 18:27:19
        ...
        if row['tag'] != 'TableRow':
            ...
            while True:
                ...
                if rss:
                    ...
                    new_row_children.append({'tag':'TableColumnMerged', 
                     'attr':{'colspan': colspan} if colspan else {}, 
                     'children':[]})
            ...
            new_table_children.append({'tag':row['tag'], 
             'attr':row['attr'], 
...
def render_docx(law):
    ...
    s_document = t_document.render({'law':law, 
