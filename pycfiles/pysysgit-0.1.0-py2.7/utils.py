...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/sysgit/utils.py
# Compiled at: 2015-04-17 15:19:27
import os, errno, subprocess
__all__ = [
 'mkdir_p', 'touch', 'git', 'CALL', 'CHECK_CALL', 'CHECK_OUTPUT']
CALL = 'call'
CHECK_CALL = 'check_call'
CHECK_OUTPUT = 'check_output'
__sub_calls = {CALL: subprocess.call, 
   CHECK_CALL: subprocess.check_call, 
   CHECK_OUTPUT: subprocess.check_output}
__default_subprocess_kwargs = {'close_fds': True, 
   'shell': False}
