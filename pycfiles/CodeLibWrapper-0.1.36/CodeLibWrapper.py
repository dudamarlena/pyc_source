...
# [GCC 8.4.0]
# Embedded file name: C:\Python27\Lib\site-packages\CodeLibWrapper\CodeLibWrapper\CodeLibWrapper.py
# Compiled at: 2016-12-30 00:48:33
import os, sys
...
from XMLFunction.ConvertXML2Obj import parse_xml_to_object, sort_list_by_name, sort_list_by_cdata, sort_list_by_attr
from XMLFunction.EnvironmentConfig import EnvironmentConfig
from XMLFunction.XMLSortHelper import sort_xml_content, sort_xml_file
from XMLFunction.XmlUtils import parse_xml_from_string, parse_xpath_from_xml
from XMLFunction.xmlvalidatehelper import Validate_XSD
...
class CodeLibWrapper():
    ...
    def config_get_parameter_value_by_name_and_environment(config_file_path, environment_name, parameter_name):
        ...
        :return: 返回参数值（string）
        """
        return EnvironmentConfig(config_file_path).read_environment_parameter_from_config(environment_name, parameter_name)
