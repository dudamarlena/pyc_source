...
# [GCC 8.4.0]
# Embedded file name: /home/thorsten/code/django-propeller/django_propeller/propeller.py
# Compiled at: 2017-02-17 16:25:48
...
PROPELLER_DEFAULTS = {'jquery_url': '//code.jquery.com/jquery.min.js', 
 ...
 'formset_renderers': {'default': 'django_propeller.renderers.FormsetRenderer'}, 
 
 'form_renderers': {'default': 'django_propeller.renderers.FormRenderer'}, 
 
 'field_renderers': {'default': 'django_propeller.renderers.FieldRenderer', 
                     'inline': 'django_propeller.renderers.InlineFieldRenderer'}}
if PROPELLER_SET_REQUIRED_SET_DISABLED:
    PROPELLER_DEFAULTS.update({'set_required': True, 
     'set_disabled': False})
