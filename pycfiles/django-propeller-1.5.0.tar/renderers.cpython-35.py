...
# Size of source mod 2**32: 21639 bytes
...
class FormsetRenderer(BaseRenderer):
    ...
    def render_errors(self):
        ...
        if formset_errors:
            return render_template_file('propeller/form_errors.html', context={'errors': formset_errors, 
             'form': self.formset, 
             'layout': self.layout})
        return ''
...
class FormRenderer(BaseRenderer):
    ...
    def render_errors(self, _type='all'):
        ...
        if form_errors:
            return render_template_file('propeller/form_errors.html', context={'errors': form_errors, 
             'form': self.form, 
             'layout': self.layout, 
             'type': _type})
        return ''
...
class FieldRenderer(BaseRenderer):
    ...
    def append_to_field(self, html):
        ...
        if help_text_and_errors:
            help_html = render_template_file('propeller/field_help_text_and_errors.html', context={'field': self.field, 
