...
# [GCC 8.4.0]
# Embedded file name: /home/thorsten/code/django-propeller/django_propeller_demo/cards.py
# Compiled at: 2017-03-24 13:36:01
from django_propeller.card import Card, CardHeader, CardActions, CardMediaActions, CardTitle, CardSubtitle, CardMediaImage, CardBody, CardMedia
...
class DemoMedia2(CardMedia):
    content = [
     DemoTitle1(), DemoSubtitle1(), DemoMediaImage2()]


class DemoBody1(CardBody):
    text = "Cards provide context and an entry point to more robust information and views. Don't overload cards with extraneous information or actions."


class DemoHeader1(CardHeader):
    content_middle = [
     DemoHeaderTitle1(), DemoSubtitle1()]
