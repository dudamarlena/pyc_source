...
# Embedded file name: build\bdist.win32\egg\buffet.py
# Compiled at: 2006-08-12 14:23:46
from os import path
...
class TemplateFilter(object):
    ...
    def __init__(self, engine_name, template_root=None, config_section=None):
        ...
        engine_opts = cherrypy.config.configs.get(config_section, {})
