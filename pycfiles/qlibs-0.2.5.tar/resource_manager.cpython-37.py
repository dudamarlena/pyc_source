...
# [GCC 8.4.0]
# Embedded file name: /home/iquant/проекты/qlibs/qlibs/resources/resource_manager.py
# Compiled at: 2019-06-27 10:34:42
...
class PerContextStorage:
    __doc__ = 'Storage for context-specific things'
    ...
    def get_program(self, vertex_shader_name, fragment_shader_name, geometry_shader_name=None):
        identifier = (
         vertex_shader_name, fragment_shader_name, geometry_shader_name)
        ...
        gsource = get_res_data(geometry_shader_name) if geometry_shader_name is not None else None
        prog = self.ctx.program(vertex_shader=vsource,
          fragment_shader=fsource,
          geometry_shader=gsource)
