...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\processors\histogrambackprojection.py
# Compiled at: 2019-02-06 11:32:59
...
class HistogramBackprojection(ProcessorBase):
    ...
    CHANNELS = (0, 1)
    RANGES = (0, 180, 0, 256)
    RANGE_MIN = (0.0, 20.0, 22.0)
    RANGE_MAX = (180.0, 255.0, 255.0)
    BINS = (32, 32)

    def __init__(self, vision, histogram, combine_masks=False, invert=False, channels=CHANNELS, ranges=RANGES, range_min=RANGE_MIN, range_max=RANGE_MAX, *args, **kwargs):
    ...
    @staticmethod
    def calculate_histogram(image, mask=None, channels=CHANNELS, bins=BINS, ranges=RANGES, range_min=RANGE_MIN, range_max=RANGE_MAX):
