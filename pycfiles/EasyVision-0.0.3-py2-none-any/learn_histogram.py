...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\bin\learn_histogram.py
# Compiled at: 2019-02-08 03:22:08
...
class App(object):
    ...
    def run(self):
        while True:
            ...
            mask = cv2.inRange(hsv, np.array((0.0, 60.0, 32.0)), np.array((180.0, 255.0,
                                                                           255.0)))
            if self.selection:
