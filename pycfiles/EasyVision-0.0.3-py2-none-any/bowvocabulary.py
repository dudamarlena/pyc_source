...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\engine\bowvocabulary.py
# Compiled at: 2019-02-07 09:00:00
...
class BOWVocabularyBuilderEngine(EngineBase):
    ...
    def __init__(self, vision, feature_type, clusters, dbow3_trainer=dbow_available, k=10, L=5, weighting=bow.WeightingType.TF_IDF, scoring=bow.ScoringType.L1_NORM, *args, **kwargs):
        ...
        _vision = (isinstance(vision, FeatureExtraction) or FeatureExtraction)(vision, feature_type=feature_type) if 1 else vision
        if dbow3_trainer:
    ...
    def capabilities(self):
        return EngineCapability((
         ...
         Frame,), {'dictionaries': ('kmeans', 'dbow3')})
