...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\processors\calibratedcamera.py
# Compiled at: 2019-02-11 10:01:27
...
class CalibratedCamera(ProcessorBase):
    ...
    def __setup(self):
        if self._calibrate:
            ...
            self._mapx, self._mapy = cv2.initUndistortRectifyMap(self.camera.matrix, self.camera.distortion, self.camera.rectify, self.camera.projection, self.camera.size, cv2.CV_32FC1)
    ...
    def process(self, image):
        if self._calibrate:
            ...
            if self.display_results:
                ...
                cv2.putText(img, ('Samples added: {}/{}').format(self._calibration_samples, self._max_samples), (20,
