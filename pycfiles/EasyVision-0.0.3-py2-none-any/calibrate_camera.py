...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\bin\calibrate_camera.py
# Compiled at: 2019-02-06 09:36:12
...
def main():
    ...
    builder = Builder(VideoCapture, Args(camera, width=size[0], height=size[1], fps=int(args.fps)), CalibratedCamera, Args(camera_model, max_samples=args.N, grid_shape=grid, display_results=True))
    if args.test:
