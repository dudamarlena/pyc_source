...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\engine\objectrecognition.py
# Compiled at: 2019-02-07 07:06:03
...
class ObjectRecognitionEngine(FeatureMatchingMixin, EngineBase):
    ...
    def __init__(self, vision, feature_type=None, max_matches=10, *args, **kwargs):
        ...
        _vision = (feature_extractor_provided or FeatureExtraction)(vision, feature_type=feature_type) if 1 else vision
    ...
    def compute(self):
        ...
        if not frame:
            ...
            return (
             frame, self._match_models(frame))
    ...
    def capabilities(self):
        return EngineCapability((
         ...
         Frame, MatchResults), {'feature_type': ('FREAK', 'SURF', 'SIFT', 'ORB', 'KAZE', 'AKAZE')})
