...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\vision\base.py
# Compiled at: 2019-02-07 17:15:20
...
class Frame(NamedTupleExtendHelper, namedtuple('_Frame', ['timestamp', 'index', 'images', 'processor_mask'])):
    ...
    def tidy_processor_mask(processor_mask):
        ...
        if isinstance(processor_mask, tuple):
            return ('').join(i and '1' or '0' for i in processor_mask)
        else:
