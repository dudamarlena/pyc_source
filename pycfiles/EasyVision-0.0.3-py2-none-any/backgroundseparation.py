...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\processors\backgroundseparation.py
# Compiled at: 2019-02-06 10:51:52
...
class BackgroundSeparation(ProcessorBase):
    ...
    def setup(self):
        self._subtractor = {'MOG': cv2.bgsegm.createBackgroundSubtractorMOG, 
           'MOG2': cv2.createBackgroundSubtractorMOG2, 
           'GMG': cv2.bgsegm.createBackgroundSubtractorGMG}[self._algorithm](history=self._max_background_num)
    ...
    def process(self, image):
        lr = 0 if self._background_num > self._max_background_num else 0.9
