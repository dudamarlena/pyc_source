...
# [GCC 8.4.0]
# Embedded file name: d:\Projects\python\EasyVision\EasyVision\vision\pyrocapture.py
# Compiled at: 2019-02-11 10:08:29
...
class PyroCapture(VisionBase):
    ...
    def __init__(self, name, *args, **kwargs):
        ...
        self._sock = Pyro4.socketutil.createSocket(timeout=Pyro4.config.COMMTIMEOUT, nodelay=False)
