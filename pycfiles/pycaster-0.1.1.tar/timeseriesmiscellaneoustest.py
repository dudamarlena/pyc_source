...
# Embedded file name: /Library/Python/2.7/site-packages/pycast/tests/timeseriesmiscellaneoustest.py
# Compiled at: 2015-05-28 05:23:29
...
class TimeSeriesMiscellaneousTest(unittest.TestCase):
    ...
    def timeseries_iterator_test(self):
        ...
        idx = 0
        for entry in ts:
            assert entry[0] == data[idx][0]
            assert entry[1] == data[idx][1]
            idx += 1
    ...
    def normalize_test(self):
        ...
        dataOne = [
         [
          0.0, 0.0], [1.0, 1.0], [2.0, 2.0], [5.1, 5.0]]
    ...
    def normalized_method_requirement_test(self):
        ...
        data = [
         [
          0.0, 0.0], [1.1, 1.0], [2.0, 2.0], [5.0, 5.0]]
        ts = TimeSeries.from_twodim_list(data)
        mOne = BaseMethod([], hasToBeSorted=True, hasToBeNormalized=True)
    ...
    def sampling_test(self):
        ...
        for illegalValue in (-3.1, 0.0, 1.0, 1.3, 4.2):
            try:
                ...
                assert False, 'ValueError not raised. Percentage was %s.' % illegalValue
