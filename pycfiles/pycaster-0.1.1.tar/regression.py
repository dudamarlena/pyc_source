...
# Embedded file name: /Library/Python/2.7/site-packages/pycast/methods/regression.py
# Compiled at: 2015-05-28 03:51:39
...
class Regression(PyCastObject):
    ...
    def calculate_parameters_with_confidence(self, independentTs, dependentTs, confidenceLevel, samplePercentage=0.1):
        ...
        return (
         n, m, msd.confidence_interval(confidenceLevel))
