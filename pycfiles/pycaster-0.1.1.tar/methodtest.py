...
# Embedded file name: /Library/Python/2.7/site-packages/pycast/tests/methodtest.py
# Compiled at: 2015-05-28 05:24:02
...
class BaseMethodTest(unittest.TestCase):
    ...
    def initialization_test(self):
        ...
        assert b.has_to_be_sorted() == hasToBeSorted
        assert b.has_to_be_normalized() == hasToBeNormalized
    ...
    def required_parameter_test(self):
        ...
        for parameter in parameters:
            assert not parameter not in requiredParameters
    ...
    def interval_validity_test(self):
        ...
        for value in [0.3, 0.42]:
            for parameter in parameters:
                assert b._in_valid_interval(parameter, value) or False

    def get_interval_test(self):
        """Test if correct intervals are returned."""
        parameters = ['param1', 'param2', 'param3', 'param4']
        b = BaseMethod(parameters)
        parameterIntervals = {'param1': [
                    0.0, 1.0, False, False], 
           'param2': [
                    0.0, 1.0, False, True], 
           'param3': [
        ...
        for parameter in parameters:
            ...
            assert i == parameterIntervals[parameter]
    ...
    def value_error_message_test(self):
        ...
        b._parameterIntervals = {'param1': [
           ...
           'param4': [
                    0.0, 1.0, True, True]}
        assert None != b._get_value_error_message_for_invalid_prarameter('unknown', 0.0) and False
        for parameter in parameters:
            assert isinstance(b._get_value_error_message_for_invalid_prarameter(parameter, 0.4), basestring) or False
    ...
    def method_completition_test(self):
        ...
        b = BaseMethod(['param1', 'param2'])
        assert not b.can_be_executed()
        b.set_parameter('param1', 1)
        assert not b.can_be_executed()
        b.set_parameter('param2', 2)
        assert b.can_be_executed()
...
class SimpleMovingAverageTest(unittest.TestCase):
    ...
    def initialization_test(self):
        ...
        assert sm._parameters['windowsize'] == 3
    ...
    def execute_test(self):
        ...
        data = [
         [
          1.5, 0.10000000000000002], [2.5, 0.20000000000000004], [3.5, 0.3]]
...
class ExponentialSmoothingTest(unittest.TestCase):
    ...
    def smoothing_test(self):
        ...
        data = [
         [
          1.5, 10.0], [2.5, 12.4], [3.5, 17.380000000000003], [4.5, 16.666], [5.5, 20.6662], [6.5, 23.46634], [7.5, 20.026438]]
        tsDst = TimeSeries.from_twodim_list(data)
    ...
    def second_smoothing_test(self):
        ...
        data = [
         [
          0.0, 1000], [1, 1050], [2, 1120], [3, 980], [4, 110]]
        tsSrc = TimeSeries.from_twodim_list(data)
        data = [
         [
          1.5, 1000], [2.5, 1030], [3.5, 1084], [4.5, 1021.6]]
        tsDst = TimeSeries.from_twodim_list(data)
        tsSrc.normalize('second')
    ...
    def forecasting_test(self):
        ...
        data = [
         [
          0, 10.0], [1, 18.0], [2, 29.0], [3, 15.0], [4, 30.0], [5, 30.0], [6, 12.0], [7, 16.0]]
        tsSrc = TimeSeries.from_twodim_list(data)
        tsSrc.normalize('second')
...
class HoltMethodTest(unittest.TestCase):
    ...
    def smoothing_test(self):
        ...
        data = [
         [
          1.5, 0.0], [2.5, 0.12000000000000002], [3.5, 0.24080000000000004], [4.5, 0.36099200000000004]]
        tsDst = TimeSeries.from_twodim_list(data)
    ...
    def second_smoothing_test(self):
        ...
        data = [
         [
          0.0, 152], [1, 176], [2, 160], [3, 192], [4, 220]]
        tsSrc = TimeSeries.from_twodim_list(data)
        tsSrc.normalize('second')
        data = [
         [
...
class HoltWintersMethodTest(unittest.TestCase):
    ...
    def smoothing_test(self):
        ...
        data = [
         362.0, 385.0, 432.0, 341.0, 382.0, 409.0, 498.0, 387.0, 473.0, 513.0, 582.0, 474.0, 544.0, 582.0, 681.0, 557.0, 628.0, 707.0, 773.0, 592.0, 627.0, 725.0, 854.0, 661.0]
        ...
        hwm = HoltWintersMethod(0.7556, 1e-07, 0.9837, 4, valuesToForecast=0)
    ...
    def forecasting_test(self):
        ...
        hwm = HoltWintersMethod(0.7556, 1e-07, 0.9837, 4, valuesToForecast=4)
        res = tsSrc.apply(hwm)
    ...
    def preset_season_factor_test(self):
        ...
        data = [
         [
          0, 362.0], [1, 385.0], [2, 432.0], [3, 341.0], [4, 382.0], [5, 409.0], [6, 498.0], [7, 387.0], [8, 473.0], [9, 513.0], [10, 582.0], [11, 474.0]]
        tsSrc = TimeSeries.from_twodim_list(data)
        seasonValues = hwm.initSeasonFactors(tsSrc)
