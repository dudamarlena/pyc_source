...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/tests/btrdb/test_point.py
...
class TestRawPoint(object):
    ...
    def test_from_proto_list(self):
        ...
        """
        protos = [
         RawPointProto(time=1, value=10), RawPointProto(time=2, value=20)]
