...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transitionMatrix/model.py
# Compiled at: 2018-10-22 18:32:13
# Size of source mod 2**32: 26637 bytes
...
class TransitionMatrix(np.matrix):
    ...
    def validate(self, accuracy=0.001):
...
class TransitionMatrixSet(object):
    __doc__ = '  The _`TransitionMatrixSet` object stores a family of TransitionMatrix_ objects as a time ordered list. Besides\n    storate it allows a variety of simultaneous operations on the collection of matrices\n\n\n    '
    ...
    def __init__(self, dimension=2, values=None, periods=1, temporal_type=None, method=None, json_file=None, csv_file=None):
        ...
        * Cumulative: Each period matrix reflects cumulative transitions from start to that period
        ...
        if values is not None:
            ...
            if values is None and csv_file is not None:
                ...
                if values is None and json_file is not None:
...
class StateSpace(object):
    ...
    def validate_dataset(self, dataset, labels=None):
        ...
        return (
         validation_message, validation_outcome)
