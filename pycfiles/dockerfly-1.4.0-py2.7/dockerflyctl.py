...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dockerfly/bin/dockerflyctl.py
# Compiled at: 2016-07-12 20:43:35
"""dockerfly bin tool
...
import docker as dockerpy, include
    ...
    if arguments['run']:
        with open(arguments['<config_json>'], 'r') as (config):
            ...
            for container in container_json:
                container_id = Container.run(container['image_name'], container['run_cmd'], container['eths'], container['gateway'])
