...
class PrometheusSpeedtest:
    __doc__ = 'Enapsulates behavior performing and reporting results of speedtests.'
...
class SpeedtestCollector:
    __doc__ = 'Performs Speedtests when requested from Prometheus.'
...
class SpeedtestMetricsHandler(server.SimpleHTTPRequestHandler, prometheus_client.MetricsHandler):
    __doc__ = 'HTTP handler extending MetricsHandler and adding status page support.'
