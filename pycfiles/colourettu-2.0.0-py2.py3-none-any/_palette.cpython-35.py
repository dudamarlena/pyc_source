...
# [GCC 8.4.0]
# Embedded file name: S:\Documents\Code\colourettu\build\lib\colourettu\_palette.py
# Compiled at: 2016-11-27 16:58:26
...
class Palette:
    ...
    def __add__(self, other):
        ...
        if type(other) is type(colour_for_type):
            ...
            self._end = other
            return self
        if type(other) is type(palette_for_type):
