...
# [GCC 8.4.0]
# Embedded file name: S:\Documents\Code\colourettu\build\lib\colourettu\test\test_palette.py
# Compiled at: 2016-11-27 16:46:02
# Size of source mod 2**32: 4280 bytes
import os, unittest
...
class Test_Palette(unittest.TestCase):
    ...
    def test_from_list_list(self):
        my_list = [
         colourettu.Colour('#aaa'), colourettu.Colour('#123'), colourettu.Colour('#345682')]
        p1 = colourettu.Palette()
    ...
    def test_from_list_tuple(self):
        my_tuple = (
         colourettu.Colour('#111'), colourettu.Colour('#983'), colourettu.Colour('#aabcde'))
        p1 = colourettu.Palette()
