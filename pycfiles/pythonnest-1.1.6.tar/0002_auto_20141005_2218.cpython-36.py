...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/PythonNest/pythonnest/migrations/0002_auto_20141005_2218.py
# Compiled at: 2018-04-21 04:00:49
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Classifier',
       fields=[
      (
      ...
      (
       ...
       bases=(
      models.Model,)),
     migrations.CreateModel(name='Dependence',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
     ...
     migrations.CreateModel(name='Log',
      ...
      (
       ...
       bases=(
      models.Model,)),
     migrations.CreateModel(name='Package',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
      ...
      (
       'normalized_name',
       models.CharField(blank=True, verbose_name='normalized name', max_length=255, default='', db_index=True)),
      (
       'author',
      ...
      (
       'maintainer_email',
       models.CharField(blank=True, verbose_name='maintainer email', max_length=255, db_index=True, null=True)),
      (
       'home_page', models.URLField(blank=True, verbose_name='home page', default='', db_index=True)),
      (
       'license',
       models.CharField(blank=True, verbose_name='license', max_length=255, default='UNKNOWN', db_index=True)),
      (
      ...
      (
       'group',
       models.ForeignKey(blank=True, verbose_name='restrict to this group', null=True, to='auth.Group', on_delete=(models.CASCADE)))],
       options={},
       bases=(
      models.Model,)),
     migrations.CreateModel(name='PackageRole',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
       'role',
       models.IntegerField(verbose_name='role', default=1, choices=[(1, 'owner'), (2, 'maintainer')], db_index=True)),
      (
       'package',
       models.ForeignKey(to='pythonnest.Package', verbose_name='package', on_delete=(models.CASCADE))),
      (
       'user', models.ForeignKey(to=(settings.AUTH_USER_MODEL), verbose_name='user', on_delete=(models.CASCADE)))],
       options={},
       bases=(
      models.Model,)),
     migrations.CreateModel(name='PackageType',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
      ...
      (
       ...
       bases=(
      models.Model,)),
     migrations.CreateModel(name='Release',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
       'version',
       models.CharField(blank=True, verbose_name='version name', null=True, max_length=255, default='', db_index=True)),
      (
       'stable_version',
       models.CharField(blank=True, verbose_name='stable version name', null=True, max_length=255, default='', db_index=True)),
      (
       'description', models.TextField(blank=True, verbose_name='Description', default='', null=True)),
      (
       'platform',
       models.CharField(blank=True, verbose_name='platform', null=True, max_length=25, default='UNKNOWN', db_index=True)),
      (
       'keywords',
       models.CharField(blank=True, verbose_name='keywords', null=True, max_length=255, default='', db_index=True)),
      (
       'docs_url',
       models.URLField(blank=True, verbose_name='docs url', null=True, default='', db_index=True)),
      (
       'creation', models.DateTimeField(verbose_name='creation', auto_now_add=True, db_index=True)),
      (
       'modification', models.DateTimeField(verbose_name='modification', auto_now=True, db_index=True)),
      ...
      (
       'obsoletes',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_obsoletes', db_index=True,
         null=True)),
      (
       'obsoletes_dist',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_obsoletes_dist', db_index=True,
         null=True)),
      (
       'package', models.ForeignKey(to='pythonnest.Package', on_delete=(models.CASCADE))),
      (
       'provides',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_provides', db_index=True,
         null=True)),
      (
       'provides_dist',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_provides_dist', db_index=True,
         null=True)),
      (
       'requires',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_requires', db_index=True,
         null=True)),
      (
       'requires_dist',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_requires_dist', db_index=True,
         null=True)),
      (
       'requires_external',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_requires_external', db_index=True,
         null=True)),
      (
       'requires_python',
       models.ManyToManyField(blank=True, to='pythonnest.Dependence', related_name='dep_requires_python', db_index=True,
         null=True))],
       options={},
       bases=(
      models.Model,)),
     migrations.CreateModel(name='ReleaseDownload',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
      ...
      (
       'file',
       models.FileField(verbose_name='File', max_length=255, upload_to=(pythonnest.models.release_download_path),
         db_index=True)),
      (
      ...
      (
       'python_version',
       models.CharField(blank=True, verbose_name='Python version', max_length=255, default='any', db_index=True)),
      (
      ...
      (
       'package_type',
       models.ForeignKey(blank=True, null=True, to='pythonnest.PackageType', default=None, on_delete=(models.CASCADE))),
      (
       'release', models.ForeignKey(to='pythonnest.Release', on_delete=(models.CASCADE)))],
       options={},
       bases=(
      models.Model,)),
     migrations.CreateModel(name='ReleaseMiss',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
       ...
       bases=(
      models.Model,)),
     migrations.CreateModel(name='Synchronization',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
      (
      ...
      (
       'modification', models.DateTimeField(verbose_name='modification', auto_now=True, db_index=True))],
       options={'verbose_name':'Synchronization', 
      'verbose_name_plural':'Synchronizations'},
       bases=(
      models.Model,)),
     migrations.AddField(model_name='log',
       name='download',
