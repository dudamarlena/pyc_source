...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/managers/ocio.py
...
import logging, traceback, tpDcc as tp
...
class ArtellaOCIOManager(object):
    ...
    def set_project(self, project):
        ...
        self._config = tp.ConfigsMgr().get_config(config_name='artellapipe-ocio',
    ...
    def load_plugins(self):
        ...
        for ocio_plugin_name, ocio_plugin_info in ocio_plugins.items():
            ...
            if not plugin_name:
                LOGGER.warning('Impossible to load "{}" OCIO Plugin because its plugin_name is not defined!'.format(ocio_plugin_name))
            else:
