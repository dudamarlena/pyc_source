...
# [GCC 8.4.0]
# Embedded file name: scripts/load_params.py
...
"""
import dataset_class, file_manipulation as FM
...
def read_in_param_file_and_create_dataset_objects(self, paramFilePath):
    ...
    for i in paramMat:
        if i[0] == 'SETKEY':
            ...
            currentDataset = dataset_class.Dataset()
            currentDataset.setKey = i[1]
            flag = True
        if flag:
            if i[0] == 'IMAGEDIR':
                currentDataset.imageDir = i[1]
            elif i[0] == 'GENELISTFILE':
                currentDataset.geneListFile = i[1]
            elif i[0] == 'SEARCHTYPE':
                currentDataset.searchType = i[1]
            elif i[0] == 'SETNAMELONG':
                currentDataset.setNameLong = i[1]
            elif i[0] == 'BUTTONNAME':
                currentDataset.buttonName = i[1]
            elif i[0] == 'CITATION':
                currentDataset.citation = i[1]
            elif i[0] == 'CITATIONLINK':
                currentDataset.citationLink = i[1]
            elif i[0] == 'INFO':
                currentDataset.info = i[1]
