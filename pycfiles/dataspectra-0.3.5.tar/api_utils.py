...
# [GCC 8.4.0]
# Embedded file name: /Users/ryosukekita/Desktop/PROJECTS/DSVISUALIZER/aefiles/lib/cloudstorage/api_utils.py
# Compiled at: 2017-10-27 18:08:49
"""Util functions and classes for cloudstorage_api."""
__all__ = [
 'set_default_retry_params',
 'RetryParams']
import copy, httplib, logging, math, os, threading, time, urllib
try:
...
class RetryParams(object):
    ...
    def __init__(self, backoff_factor=2.0, initial_delay=0.1, max_delay=10.0, min_retries=3, max_retries=6, max_retry_period=30.0, urlfetch_timeout=None, save_access_token=False, _user_agent=None):
        """Init.
