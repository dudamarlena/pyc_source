...
# [GCC 8.4.0]
# Embedded file name: /home/e210990/bin/python26/lib/python2.6/site-packages/stashy/admin/users.py
...
class Users(ResourceBase, FilteredIterableResource):
    ...
    def add(self, name, password, displayName, emailAddress, addToDefaultGroup=True):
        ...
        """
        data = dict(name=name, password=password, displayName=displayName, emailAddress=emailAddress, addToDefaultGroup=addToDefaultGroup)
