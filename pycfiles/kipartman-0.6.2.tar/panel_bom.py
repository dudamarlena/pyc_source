...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_bom.py
...
class PanelBom(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.tool_save_bom = self.m_toolBar3.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/save.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, 'Save kipartman BOM file', wx.EmptyString, None)
        self.m_toolBar3.Realize()
        bSizer101.Add(self.m_toolBar3, 1, wx.EXPAND, 5)
        self.m_toolBar1 = wx.ToolBar(self.m_panel1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TB_HORIZONTAL)
        self.tool_refresh_brd = self.m_toolBar1.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, 'Refresh module list', wx.EmptyString, None)
        self.m_toolBar1.Realize()
        bSizer101.Add(self.m_toolBar1, 0, wx.EXPAND, 5)
        bSizer11.Add(bSizer101, 0, wx.EXPAND, 5)
        self.tree_modules = wx.dataview.DataViewCtrl(self.m_panel1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer11.Add(self.tree_modules, 1, wx.ALL | wx.EXPAND, 5)
        bSizer8.Add(bSizer11, 1, wx.EXPAND, 5)
        bSizer6 = wx.BoxSizer(wx.VERTICAL)
        self.button_add_bom_module = wx.Button(self.m_panel1, wx.ID_ANY, '>>', wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT)
        bSizer6.Add(self.button_add_bom_module, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 5)
        self.button_remove_bom_module = wx.Button(self.m_panel1, wx.ID_ANY, '<<', wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT)
        ...
        self.tool_add_bom_part = self.toolbar_bom.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None)
        self.tool_remove_bom_part = self.toolbar_bom.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None)
        ...
        self.Bind(wx.EVT_TOOL, self.onToolAddBomPartClick, id=self.tool_add_bom_part.GetId())
        self.Bind(wx.EVT_TOOL, self.onToolRemoveBomPartClick, id=self.tool_remove_bom_part.GetId())
    ...
    def onToolAddBomPartClick(self, event):
        event.Skip()

    def onToolRemoveBomPartClick(self, event):
        event.Skip()
