...
# [GCC 8.4.0]
# Embedded file name: dialogs/dialog_edit_storage.py
# Compiled at: 2017-11-14 03:50:48
import wx, wx.xrc
...
class DialogEditStorage(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText21 = wx.StaticText(self, wx.ID_ANY, 'Comment', wx.DefaultPosition, wx.DefaultSize, 0)
