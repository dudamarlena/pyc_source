...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_storages.py
...
class PanelStorages(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_add_category = wx.BitmapButton(self.panel_category, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_add_category, 0, wx.ALL, 5)
        self.button_edit_category = wx.BitmapButton(self.panel_category, wx.ID_ANY, wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_edit_category, 0, wx.ALL, 5)
        self.button_remove_category = wx.BitmapButton(self.panel_category, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_remove_category, 0, wx.ALL, 5)
        bSizer4.Add(bSizer5, 1, wx.EXPAND, 5)
        bSizer6 = wx.BoxSizer(wx.HORIZONTAL)
        self.button_refresh_categories = wx.BitmapButton(self.panel_category, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_add_storage = wx.BitmapButton(self.panel_storage_locations, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer10.Add(self.button_add_storage, 0, wx.ALL, 5)
        self.button_edit_storage = wx.BitmapButton(self.panel_storage_locations, wx.ID_ANY, wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer10.Add(self.button_edit_storage, 0, wx.ALL, 5)
        self.button_remove_storage = wx.BitmapButton(self.panel_storage_locations, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_refresh_storages = wx.BitmapButton(self.panel_storage_locations, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_add_storage_part = wx.BitmapButton(self.panel_storage_parts, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer101.Add(self.button_add_storage_part, 0, wx.ALL, 5)
        self.button_remove_storage_part = wx.BitmapButton(self.panel_storage_parts, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_add_storage_item = wx.BitmapButton(self.panel_storage_parts, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer101.Add(self.button_add_storage_item, 0, wx.ALL, 5)
        self.button_remove_storage_item = wx.BitmapButton(self.panel_storage_parts, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
