...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_manufacturers.py
...
class PanelManufacturers(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_add_manufacturer = wx.BitmapButton(self.panel_manufacturers, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_add_manufacturer, 0, wx.ALL, 5)
        self.button_edit_manufacturer = wx.BitmapButton(self.panel_manufacturers, wx.ID_ANY, wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_edit_manufacturer, 0, wx.ALL, 5)
        self.button_remove_manufacturer = wx.BitmapButton(self.panel_manufacturers, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_remove_manufacturer, 0, wx.ALL, 5)
        bSizer4.Add(bSizer5, 1, wx.EXPAND, 5)
        bSizer6 = wx.BoxSizer(wx.HORIZONTAL)
        self.button_refresh_manufacturers = wx.BitmapButton(self.panel_manufacturers, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.m_staticText3 = wx.StaticText(self.panel_edit_manufacturer, wx.ID_ANY, 'Manufacturer', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText4 = wx.StaticText(self.panel_edit_manufacturer, wx.ID_ANY, 'Address', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText6 = wx.StaticText(self.panel_edit_manufacturer, wx.ID_ANY, 'Website', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText8 = wx.StaticText(self.panel_edit_manufacturer, wx.ID_ANY, 'Email', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText9 = wx.StaticText(self.panel_edit_manufacturer, wx.ID_ANY, 'Phone', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText11 = wx.StaticText(self.panel_edit_manufacturer, wx.ID_ANY, 'Comment', wx.DefaultPosition, wx.DefaultSize, 0)
