...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_footprints.py
...
class PanelFootprints(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_refresh_categories = wx.BitmapButton(self.panel_path, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.menu_libraries_add_folder = wx.MenuItem(self.menu_libraries, wx.ID_ANY, 'Add folder', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_libraries.Append(self.menu_libraries_add_folder)
        self.menu_libraries_add_library = wx.MenuItem(self.menu_libraries, wx.ID_ANY, 'Add library', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_libraries.Append(self.menu_libraries_add_library)
        self.menu_libraries_rename = wx.MenuItem(self.menu_libraries, wx.ID_ANY, 'Rename', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_libraries.Append(self.menu_libraries_rename)
        self.menu_libraries_remove = wx.MenuItem(self.menu_libraries, wx.ID_ANY, 'Remove', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_libraries.Append(self.menu_libraries_remove)
        self.menu_libraries.AppendSeparator()
        self.menu_libraries_add_footprint = wx.MenuItem(self.menu_libraries, wx.ID_ANY, 'Add footprint', wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.m_staticText15 = wx.StaticText(self.filters_panel, wx.ID_ANY, 'Filters: ', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.toggle_footprint_path = self.toolbar_footprint.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/tree_mode.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toolbar_footprint.AddSeparator()
        self.toggle_show_both_changes = self.toolbar_footprint.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_both.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toggle_show_conflict_changes = self.toolbar_footprint.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_conf.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toggle_show_incoming_changes = self.toolbar_footprint.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_in.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toggle_show_outgoing_changes = self.toolbar_footprint.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_out.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        ...
        self.button_refresh_footprints = wx.BitmapButton(self.panel_footprints, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.menu_footprints_update = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Update', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_footprints_update.SetBitmap(wx.Bitmap('resources/update.png', wx.BITMAP_TYPE_ANY))
        self.menu_footprints.Append(self.menu_footprints_update)
        self.menu_footprints_force_update = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Force update', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_footprints_force_update.SetBitmap(wx.Bitmap('resources/update.png', wx.BITMAP_TYPE_ANY))
        self.menu_footprints.Append(self.menu_footprints_force_update)
        self.menu_footprints.AppendSeparator()
        self.menu_footprints_commit = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Commit', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_footprints_commit.SetBitmap(wx.Bitmap('resources/commit.png', wx.BITMAP_TYPE_ANY))
        self.menu_footprints.Append(self.menu_footprints_commit)
        self.menu_footprints_force_commit = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Force commit', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_footprints_force_commit.SetBitmap(wx.Bitmap('resources/commit.png', wx.BITMAP_TYPE_ANY))
        self.menu_footprints.Append(self.menu_footprints_force_commit)
        self.menu_footprints.AppendSeparator()
        self.menu_footprints_add = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Add footprint', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_footprints.Append(self.menu_footprints_add)
        self.menu_footprints_edit = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Edit footprint', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_footprints.Append(self.menu_footprints_edit)
        self.menu_footprints_delete = wx.MenuItem(self.menu_footprints, wx.ID_ANY, 'Delete footprint', wx.EmptyString, wx.ITEM_NORMAL)
