...
# [GCC 8.4.0]
# Embedded file name: /home/seb/git/kipartman/kipartman/dialogs/dialog_edit_part_parameter.py
...
class DialogEditPartParameter(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText3 = wx.StaticText(self, wx.ID_ANY, 'Name', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.button_search_parameter = wx.Button(self, wx.ID_ANY, '  ...  ', wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT)
        bSizer61.Add(self.button_search_parameter, 0, wx.ALL, 5)
        fgSizer1.Add(bSizer61, 1, wx.EXPAND, 5)
        self.m_staticText4 = wx.StaticText(self, wx.ID_ANY, 'Description', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText5 = wx.StaticText(self, wx.ID_ANY, 'Unit', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText6 = wx.StaticText(self, wx.ID_ANY, 'Value Type', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText6.Wrap(-1)
        fgSizer1.Add(self.m_staticText6, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        bSizer6 = wx.BoxSizer(wx.HORIZONTAL)
        self.radio_choice_parameter_numeric = wx.RadioButton(self, wx.ID_ANY, 'Numeric', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer6.Add(self.radio_choice_parameter_numeric, 0, wx.ALL, 5)
        self.radio_choice_parameter_text = wx.RadioButton(self, wx.ID_ANY, 'Text', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer6.Add(self.radio_choice_parameter_text, 0, wx.ALL, 5)
        fgSizer1.Add(bSizer6, 1, wx.EXPAND, 5)
        self.static_value = wx.StaticText(self, wx.ID_ANY, 'Value', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.static_min_value = wx.StaticText(self, wx.ID_ANY, 'Min Value', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.static_nom_value = wx.StaticText(self, wx.ID_ANY, 'Nominal Value', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.static_max_value = wx.StaticText(self, wx.ID_ANY, 'Max Value', wx.DefaultPosition, wx.DefaultSize, 0)
