...
# [GCC 8.4.0]
# Embedded file name: frames/edit_footprint_frame.py
# Compiled at: 2018-04-29 13:43:16
...
class EditFootprintFrame(PanelEditFootprint):
    ...
    def onSelectSnapedaFrameOk(self, event):
        ...
        try:
            ...
            download.get(part_number=snapeda.part_number(), manufacturer=snapeda.manufacturer(), uniqueid=snapeda.uniqueid(), has_symbol=snapeda.has_symbol(), has_footprint=snapeda.has_footprint())
            if download.error():
    ...
    def onButtonFootprintEditApply(self, event):
        ...
        event = EditFootprintApplyEvent(data=footprint, footprint_name=self.edit_footprint_name.Value + '.kicad_mod')
