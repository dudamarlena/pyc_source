...
# [GCC 8.4.0]
# Embedded file name: swagger_client/api_client.py
...
import os, re, json, mimetypes, tempfile, threading
...
class ApiClient(object):
    ...
    """
    PRIMITIVE_TYPES = (
     float, bool, bytes, text_type) + integer_types
    ...
    def __call_api(self, resource_path, method, path_params=None, query_params=None, header_params=None, body=None, post_params=None, files=None, response_type=None, auth_settings=None, callback=None, _return_http_data_only=None, collection_formats=None, _preload_content=True, _request_timeout=None):
        ...
        if callback:
            ...
            if _return_http_data_only:
                ...
                return (
                 return_data, response_data.status, response_data.getheaders())
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if obj is None:
            ...
            return {key:self.sanitize_for_serialization(val) for key, val in iteritems(obj_dict)}
    ...
    def call_api(self, resource_path, method, path_params=None, query_params=None, header_params=None, body=None, post_params=None, files=None, response_type=None, auth_settings=None, callback=None, _return_http_data_only=None, collection_formats=None, _preload_content=True, _request_timeout=None):
        ...
        """
        if callback is None:
            return self.__call_api(resource_path, method, path_params, query_params, header_params, body, post_params, files, response_type, auth_settings, callback, _return_http_data_only, collection_formats, _preload_content, _request_timeout)
        else:
