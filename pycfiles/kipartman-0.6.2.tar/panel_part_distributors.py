...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_part_distributors.py
# Compiled at: 2017-06-05 04:41:56
...
class PanelPartDistributors(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_edit_distributor = wx.BitmapButton(self, wx.ID_ANY, wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer10.Add(self.button_edit_distributor, 0, wx.ALL, 5)
        self.button_remove_distributor = wx.BitmapButton(self, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
