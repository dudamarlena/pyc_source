...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_edit_part.py
# Compiled at: 2018-04-27 05:54:44
import wx, wx.xrc, wx.aui
...
class PanelEditPart(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText3 = wx.StaticText(self.panel_edit_part_basic, wx.ID_ANY, 'Name', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.button_octopart = wx.Button(self.panel_edit_part_basic, wx.ID_ANY, 'Octopart', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer18.Add(self.button_octopart, 0, wx.ALL, 5)
        fgSizer1.Add(bSizer18, 1, wx.EXPAND, 5)
        self.m_staticText4 = wx.StaticText(self.panel_edit_part_basic, wx.ID_ANY, 'Description', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText5 = wx.StaticText(self.panel_edit_part_basic, wx.ID_ANY, 'Footprint', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText51 = wx.StaticText(self.panel_edit_part_basic, wx.ID_ANY, 'Symbol', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText6 = wx.StaticText(self.panel_edit_part_basic, wx.ID_ANY, 'Comment', wx.DefaultPosition, wx.DefaultSize, 0)
