...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_parts.py
...
class PanelParts(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_refresh_categories = wx.BitmapButton(self.panel_category, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW | wx.NO_BORDER)
        ...
        self.menu_category_add_category = wx.MenuItem(self.menu_category, wx.ID_ANY, 'Add new category', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_category_add_category.SetBitmap(wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY))
        self.menu_category.Append(self.menu_category_add_category)
        self.menu_category_edit_category = wx.MenuItem(self.menu_category, wx.ID_ANY, 'Edit category', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_category_edit_category.SetBitmap(wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY))
        self.menu_category.Append(self.menu_category_edit_category)
        self.menu_category_remove_category = wx.MenuItem(self.menu_category, wx.ID_ANY, 'Remove category', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_category_remove_category.SetBitmap(wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY))
        ...
        self.toggle_part_path = self.toolbar_part.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/tree_mode.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        ...
        self.button_refresh_parts = wx.BitmapButton(self.panel_parts, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW | wx.NO_BORDER)
        ...
        self.menu_parameters_add = wx.MenuItem(self.menu_parameters, wx.ID_ANY, 'Add', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_parameters.Append(self.menu_parameters_add)
        self.menu_parameters_remove = wx.MenuItem(self.menu_parameters, wx.ID_ANY, 'Remove', wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.menu_part_add_part = wx.MenuItem(self.menu_part, wx.ID_ANY, 'Add new part', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_part_add_part.SetBitmap(wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY))
        self.menu_part.Append(self.menu_part_add_part)
        self.menu_part_edit_part = wx.MenuItem(self.menu_part, wx.ID_ANY, 'Edit part', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_part_edit_part.SetBitmap(wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY))
        self.menu_part.Append(self.menu_part_edit_part)
        self.menu_part_remove_part = wx.MenuItem(self.menu_part, wx.ID_ANY, 'Remove part', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_part_remove_part.SetBitmap(wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY))
        ...
        self.menu_parts_refresh_octopart = wx.MenuItem(self.menu_parts, wx.ID_ANY, 'Refresh octopart parts', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_parts.Append(self.menu_parts_refresh_octopart)
        self.menu_parts.AppendSeparator()
        self.menu_parts_import_parts = wx.MenuItem(self.menu_parts, wx.ID_ANY, 'Import parts', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_parts.Append(self.menu_parts_import_parts)
        self.menu_parts_export_parts = wx.MenuItem(self.menu_parts, wx.ID_ANY, 'Export parts', wx.EmptyString, wx.ITEM_NORMAL)
