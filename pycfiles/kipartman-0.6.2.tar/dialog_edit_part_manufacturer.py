...
# [GCC 8.4.0]
# Embedded file name: dialogs/dialog_edit_part_manufacturer.py
# Compiled at: 2017-11-14 03:50:28
import wx, wx.xrc
...
class DialogEditPartManufacturer(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText4 = wx.StaticText(self, wx.ID_ANY, 'Name', wx.DefaultPosition, wx.DefaultSize, 0)
