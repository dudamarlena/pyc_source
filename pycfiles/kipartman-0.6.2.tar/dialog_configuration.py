...
# [GCC 8.4.0]
# Embedded file name: dialogs/dialog_configuration.py
...
class DialogConfiguration(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        sbSizer111 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, 'User'), wx.HORIZONTAL)
        self.m_staticText111 = wx.StaticText(sbSizer111.GetStaticBox(), wx.ID_ANY, 'Currency', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        sbSizer11 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, 'Parts'), wx.HORIZONTAL)
        self.m_staticText11 = wx.StaticText(sbSizer11.GetStaticBox(), wx.ID_ANY, 'Kipartbase', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText11.Wrap(-1)
        sbSizer11.Add(self.m_staticText11, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        self.edit_kipartbase = wx.TextCtrl(sbSizer11.GetStaticBox(), wx.ID_ANY, 'http://localhost:8100', wx.DefaultPosition, wx.DefaultSize, 0)
        sbSizer11.Add(self.edit_kipartbase, 1, wx.ALL, 5)
        self.button_test_kipartbase = wx.Button(sbSizer11.GetStaticBox(), wx.ID_ANY, 'Test', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        sbSizer1 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, 'Octopart'), wx.HORIZONTAL)
        self.m_staticText1 = wx.StaticText(sbSizer1.GetStaticBox(), wx.ID_ANY, 'API Key', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.button_test_octopart = wx.Button(sbSizer1.GetStaticBox(), wx.ID_ANY, 'Test', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        sbSizer2 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, 'SnapEda'), wx.VERTICAL)
        bSizer2 = wx.BoxSizer(wx.HORIZONTAL)
        fgSizer2 = wx.FlexGridSizer(0, 2, 0, 0)
        fgSizer2.AddGrowableCol(1)
        fgSizer2.SetFlexibleDirection(wx.BOTH)
        fgSizer2.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_SPECIFIED)
        self.m_staticText2 = wx.StaticText(sbSizer2.GetStaticBox(), wx.ID_ANY, 'User', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText3 = wx.StaticText(sbSizer2.GetStaticBox(), wx.ID_ANY, 'Password', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.button_test_snapeda = wx.Button(sbSizer2.GetStaticBox(), wx.ID_ANY, 'Test', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        sbSizer21 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, 'Kicad integration'), wx.VERTICAL)
        bSizer3 = wx.BoxSizer(wx.VERTICAL)
        fgSizer21 = wx.FlexGridSizer(0, 2, 0, 0)
        fgSizer21.AddGrowableCol(1)
        fgSizer21.SetFlexibleDirection(wx.BOTH)
        fgSizer21.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_SPECIFIED)
        self.m_staticText21 = wx.StaticText(sbSizer21.GetStaticBox(), wx.ID_ANY, 'Kicad path', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText21.Wrap(-1)
        fgSizer21.Add(self.m_staticText21, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        bSizer4 = wx.BoxSizer(wx.HORIZONTAL)
        self.dir_kicad_path = wx.DirPickerCtrl(sbSizer21.GetStaticBox(), wx.ID_ANY, '/home/seb', 'Select a folder', wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        bSizer4.Add(self.dir_kicad_path, 1, wx.ALL | wx.EXPAND, 5)
        self.button_kicad_path_default = wx.Button(sbSizer21.GetStaticBox(), wx.ID_ANY, 'Default', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer4.Add(self.button_kicad_path_default, 0, wx.ALL, 5)
        fgSizer21.Add(bSizer4, 1, wx.EXPAND, 5)
        self.m_staticText31 = wx.StaticText(sbSizer21.GetStaticBox(), wx.ID_ANY, 'Footprints path', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText31.Wrap(-1)
        fgSizer21.Add(self.m_staticText31, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        self.dir_footprints_path = wx.DirPickerCtrl(sbSizer21.GetStaticBox(), wx.ID_ANY, wx.EmptyString, 'Select a folder', wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        fgSizer21.Add(self.dir_footprints_path, 0, wx.ALL | wx.EXPAND, 5)
        self.m_staticText311 = wx.StaticText(sbSizer21.GetStaticBox(), wx.ID_ANY, 'Symbols path', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText311.Wrap(-1)
        fgSizer21.Add(self.m_staticText311, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        self.dir_symbols_path = wx.DirPickerCtrl(sbSizer21.GetStaticBox(), wx.ID_ANY, wx.EmptyString, 'Select a folder', wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        fgSizer21.Add(self.dir_symbols_path, 0, wx.ALL | wx.EXPAND, 5)
        self.m_staticText312 = wx.StaticText(sbSizer21.GetStaticBox(), wx.ID_ANY, '3D models path', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText312.Wrap(-1)
        fgSizer21.Add(self.m_staticText312, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        self.dir_3d_models_path = wx.DirPickerCtrl(sbSizer21.GetStaticBox(), wx.ID_ANY, wx.EmptyString, 'Select a folder', wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        fgSizer21.Add(self.dir_3d_models_path, 0, wx.ALL | wx.EXPAND, 5)
        bSizer3.Add(fgSizer21, 1, wx.EXPAND, 5)
        self.check_common_path = wx.CheckBox(sbSizer21.GetStaticBox(), wx.ID_ANY, 'Use same folder', wx.DefaultPosition, wx.DefaultSize, 0)
