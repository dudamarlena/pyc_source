...
# [GCC 8.4.0]
# Embedded file name: helper/filter.py
# Compiled at: 2017-05-27 12:06:14
import wx
...
class Filter(object):
    ...
    def add(self, name, value, value_label=''):
        button_remove_filter = wx.Button(self.filters_panel, wx.ID_ANY, 'x', wx.DefaultPosition, wx.Size(16, 16), 0 | wx.NO_BORDER, name=name)
