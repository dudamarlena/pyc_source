...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_symbols.py
...
class PanelSymbols(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.menu_libraries_add_symbol = wx.MenuItem(self.menu_libraries, wx.ID_ANY, 'Add symbol', wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.toggle_symbol_path = self.toolbar_symbol.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/tree_mode.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toolbar_symbol.AddSeparator()
        self.toggle_show_both_changes = self.toolbar_symbol.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_both.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toggle_show_conflict_changes = self.toolbar_symbol.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_conf.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toggle_show_incoming_changes = self.toolbar_symbol.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_in.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        self.toggle_show_outgoing_changes = self.toolbar_symbol.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/show_out.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None)
        ...
        self.button_refresh_symbols = wx.BitmapButton(self.panel_symbols, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.menu_symbols_update = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Update', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_symbols_update.SetBitmap(wx.Bitmap('resources/update.png', wx.BITMAP_TYPE_ANY))
        self.menu_symbols.Append(self.menu_symbols_update)
        self.menu_symbols_force_update = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Force update', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_symbols_force_update.SetBitmap(wx.Bitmap('resources/update.png', wx.BITMAP_TYPE_ANY))
        self.menu_symbols.Append(self.menu_symbols_force_update)
        self.menu_symbols.AppendSeparator()
        self.menu_symbols_commit = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Commit', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_symbols_commit.SetBitmap(wx.Bitmap('resources/commit.png', wx.BITMAP_TYPE_ANY))
        self.menu_symbols.Append(self.menu_symbols_commit)
        self.menu_symbols_force_commit = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Force commit', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_symbols_force_commit.SetBitmap(wx.Bitmap('resources/commit.png', wx.BITMAP_TYPE_ANY))
        self.menu_symbols.Append(self.menu_symbols_force_commit)
        self.menu_symbols.AppendSeparator()
        self.menu_symbols_add = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Add symbol', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_symbols.Append(self.menu_symbols_add)
        self.menu_symbols_edit = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Edit symbol', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_symbols.Append(self.menu_symbols_edit)
        self.menu_symbols_delete = wx.MenuItem(self.menu_symbols, wx.ID_ANY, 'Delete symbol', wx.EmptyString, wx.ITEM_NORMAL)
