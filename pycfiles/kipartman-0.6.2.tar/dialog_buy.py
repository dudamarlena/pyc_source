...
# [GCC 8.4.0]
# Embedded file name: dialogs/dialog_buy.py
...
class DialogBuy(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='Buy parts', pos=wx.DefaultPosition, size=wx.Size(1205, 752), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.m_staticText3111 = wx.StaticText(self.m_panel311, wx.ID_ANY, 'Boms:', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.toolbar_boms_refresh = self.toolbar_boms.AddLabelTool(wx.ID_ANY, 'Refresh', wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, 'Refresh boms', wx.EmptyString, None)
        ...
        self.m_staticText311 = wx.StaticText(self.m_panel411, wx.ID_ANY, 'Parts:', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText31 = wx.StaticText(self.m_panel41, wx.ID_ANY, 'Equivalent parts:', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.tool_distributors_view_all_prices = self.m_toolBar2.AddLabelTool(wx.ID_ANY, 'view all prices', wx.Bitmap('resources/hide.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, 'View all prices', wx.EmptyString, None)
        self.m_toolBar2.AddSeparator()
        self.tool_distributors_collapse_all = self.m_toolBar2.AddLabelTool(wx.ID_ANY, 'Collapse all', wx.Bitmap('resources/collapseall.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, 'Collapse all', wx.EmptyString, None)
        self.tool_distributors_expand_all = self.m_toolBar2.AddLabelTool(wx.ID_ANY, 'Expand all', wx.Bitmap('resources/expandall.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, 'Expand all', wx.EmptyString, None)
        ...
        self.m_staticText3 = wx.StaticText(self.m_panel4, wx.ID_ANY, 'Total:', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.static_total_price = wx.StaticText(self.m_panel4, wx.ID_ANY, 'EUR', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.menu_basket_open = wx.MenuItem(self.menu_basket, wx.ID_ANY, 'Open', 'Open a basket file', wx.ITEM_NORMAL)
        self.menu_basket.Append(self.menu_basket_open)
        self.menu_basket_save = wx.MenuItem(self.menu_basket, wx.ID_ANY, 'Save', 'Save current basket', wx.ITEM_NORMAL)
        self.menu_basket.Append(self.menu_basket_save)
        self.menu_basket_save_as = wx.MenuItem(self.menu_basket, wx.ID_ANY, 'Save basket as ...', 'Save basket in a new location ', wx.ITEM_NORMAL)
        self.menu_basket.Append(self.menu_basket_save_as)
        self.menu_main.Append(self.menu_basket, 'Basket')
        self.menu_boms = wx.Menu()
        self.menu_boms_add = wx.MenuItem(self.menu_boms, wx.ID_ANY, 'Add bom', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_boms.Append(self.menu_boms_add)
        self.menu_boms_remove = wx.MenuItem(self.menu_boms, wx.ID_ANY, 'Remove bom', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_boms.Append(self.menu_boms_remove)
        self.menu_main.Append(self.menu_boms, 'Bom')
        self.menu_prices = wx.Menu()
        self.menu_item_reference_add = wx.MenuItem(self.menu_prices, wx.ID_ANY, 'Add reference', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_prices.Append(self.menu_item_reference_add)
        self.menu_prices.AppendSeparator()
        self.menu_item_prices_select_bestprice = wx.MenuItem(self.menu_prices, wx.ID_ANY, 'Select best price', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_prices.Append(self.menu_item_prices_select_bestprice)
        self.menu_item_prices_automatic_order = wx.MenuItem(self.menu_prices, wx.ID_ANY, 'Automatic complete order', wx.EmptyString, wx.ITEM_NORMAL)
        self.menu_prices.Append(self.menu_item_prices_automatic_order)
        self.menu_main.Append(self.menu_prices, 'Prices')
        self.menu_distributors = wx.Menu()
        self.menu_distributors_refresh_prices = wx.MenuItem(self.menu_distributors, wx.ID_ANY, 'Refresh prices', 'Refresh prices', wx.ITEM_NORMAL)
        self.menu_distributors.Append(self.menu_distributors_refresh_prices)
        self.menu_main.Append(self.menu_distributors, 'Distributors')
