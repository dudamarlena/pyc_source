...
class ConfigurationFrame(DialogConfiguration):
    ...
    def onTestOctopart(self, event):
        ...
        try:
            ...
            self.data = q.results()
            print self.data
            wx.MessageBox('OCTOPART CONNECTION OK', 'OCTOPART CONNECTION OK', wx.OK)
        except Exception as e:
            print_stack()
            wx.MessageBox(format(e), 'Error', wx.OK | wx.ICON_ERROR)
    ...
    def onTestSnapeda(self, event):
        ...
        try:
            ...
            wx.MessageBox('SNAPEDA CONNECTION OK', 'SNAPEDA CONNECTION OK', wx.OK)
