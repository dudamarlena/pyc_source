...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_edit_footprint.py
...
class PanelEditFootprint(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_remove_url_snapeda = wx.BitmapButton(self.m_panel7, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW | wx.SIMPLE_BORDER)
        ...
        self.menu_rebuild_footprints = wx.MenuItem(self.menu_kicad, wx.ID_ANY, 'Rebuild footprints', wx.EmptyString, wx.ITEM_NORMAL)
