...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_part_preview_data.py
...
class PanelPartPreviewData(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText1 = wx.StaticText(self, wx.ID_ANY, 'Symbol', wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE | wx.ST_ELLIPSIZE_MIDDLE)
        ...
        self.m_staticText11 = wx.StaticText(self, wx.ID_ANY, 'Footprint', wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE | wx.ST_ELLIPSIZE_MIDDLE)
        ...
        self.m_staticText12 = wx.StaticText(self, wx.ID_ANY, '3D Model', wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE | wx.ST_ELLIPSIZE_MIDDLE)
