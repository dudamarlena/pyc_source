...
# [GCC 8.4.0]
# Embedded file name: /home/seb/git/kipartman/kipartman/dialogs/panel_buy.py
# Compiled at: 2017-11-14 11:28:16
# Size of source mod 2**32: 13661 bytes
...
class PanelBuy(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_add_bom = wx.BitmapButton(self.m_panel311, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer18.Add(self.button_add_bom, 0, wx.ALL, 5)
        self.button_remove_bom = wx.BitmapButton(self.m_panel311, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_refresh = wx.BitmapButton(self.m_panel311, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.tool_save_basket = self.m_toolBar1.AddLabelTool(wx.ID_ANY, 'tool', wx.Bitmap('resources/save-32x32.png', wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, 'Save basket file', wx.EmptyString, None)
        ...
        self.button_add_wish_parts = wx.BitmapButton(self.m_panel3, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_edit_wish = wx.BitmapButton(self.m_panel4, wx.ID_ANY, wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer13.Add(self.button_edit_wish, 0, wx.ALL, 5)
        self.button_delete_wish = wx.BitmapButton(self.m_panel4, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.menu_item_prices_view_all = wx.MenuItem(self.menu_prices, wx.ID_ANY, 'View all prices', wx.EmptyString, wx.ITEM_CHECK)
