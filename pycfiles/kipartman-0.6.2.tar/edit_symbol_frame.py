...
# [GCC 8.4.0]
# Embedded file name: frames/edit_symbol_frame.py
# Compiled at: 2018-04-29 13:45:11
...
class EditSymbolFrame(PanelEditSymbol):
    ...
    def onSelectSnapedaFrameOk(self, event):
        ...
        try:
            ...
            download.get(part_number=snapeda.part_number(), manufacturer=snapeda.manufacturer(), uniqueid=snapeda.uniqueid(), has_symbol='True', has_footprint='False')
            if download.error():
    ...
    def onButtonSymbolEditApply(self, event):
        ...
        event = EditSymbolApplyEvent(data=symbol, symbol_name=self.edit_symbol_name.Value + '.mod')
