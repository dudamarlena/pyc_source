...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_distributors.py
...
class PanelDistributors(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.button_add_distributor = wx.BitmapButton(self.panel_distributors, wx.ID_ANY, wx.Bitmap('resources/add.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_add_distributor, 0, wx.ALL, 5)
        self.button_edit_distributor = wx.BitmapButton(self.panel_distributors, wx.ID_ANY, wx.Bitmap('resources/edit.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_edit_distributor, 0, wx.ALL, 5)
        self.button_remove_distributor = wx.BitmapButton(self.panel_distributors, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        bSizer5.Add(self.button_remove_distributor, 0, wx.ALL, 5)
        bSizer4.Add(bSizer5, 1, wx.EXPAND, 5)
        bSizer6 = wx.BoxSizer(wx.HORIZONTAL)
        self.button_refresh_distributors = wx.BitmapButton(self.panel_distributors, wx.ID_ANY, wx.Bitmap('resources/refresh.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.m_staticText3 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'Distributor', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText4 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'Address', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText6 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'Website', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText7 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'SKU URL', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText8 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'Email', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText9 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'Phone', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText11 = wx.StaticText(self.panel_edit_distributor, wx.ID_ANY, 'Comment', wx.DefaultPosition, wx.DefaultSize, 0)
