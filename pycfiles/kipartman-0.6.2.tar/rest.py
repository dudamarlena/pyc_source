...
# [GCC 8.4.0]
# Embedded file name: swagger_client/rest.py
...
import io, json, ssl, certifi, logging, re
from six import PY3
...
class RESTClientObject(object):
    ...
    def __init__(self, pools_size=4, maxsize=4):
        ...
        if proxy:
            self.pool_manager = urllib3.ProxyManager(num_pools=pools_size, maxsize=maxsize, cert_reqs=cert_reqs, ca_certs=ca_certs, cert_file=cert_file, key_file=key_file, proxy_url=proxy)
        else:
            self.pool_manager = urllib3.PoolManager(num_pools=pools_size, maxsize=maxsize, cert_reqs=cert_reqs, ca_certs=ca_certs, cert_file=cert_file, key_file=key_file)
