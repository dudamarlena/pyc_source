...
# [GCC 8.4.0]
# Embedded file name: dialogs/panel_edit_symbol.py
...
class PanelEditSymbol(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText1 = wx.StaticText(self.m_panel7, wx.ID_ANY, 'Name', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.button_snapeda = wx.Button(self.m_panel7, wx.ID_ANY, 'SnapEDA', wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer162.Add(self.button_snapeda, 0, wx.ALL, 5)
        fgSizer1.Add(bSizer162, 1, wx.EXPAND, 5)
        self.m_staticText2 = wx.StaticText(self.m_panel7, wx.ID_ANY, 'Description', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText3 = wx.StaticText(self.m_panel7, wx.ID_ANY, 'Comment', wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText42 = wx.StaticText(self.m_panel7, wx.ID_ANY, 'Snapeda', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText42.Wrap(-1)
        fgSizer1.Add(self.m_staticText42, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        bSizer172 = wx.BoxSizer(wx.HORIZONTAL)
        self.button_open_url_snapeda = wx.Button(self.m_panel7, wx.ID_ANY, '<None>', wx.DefaultPosition, wx.DefaultSize, wx.BU_LEFT | wx.NO_BORDER)
        bSizer172.Add(self.button_open_url_snapeda, 1, wx.ALL | wx.EXPAND, 5)
        self.button_remove_url_snapeda = wx.BitmapButton(self.m_panel7, wx.ID_ANY, wx.Bitmap('resources/remove.png', wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW)
        ...
        self.button_edit_ = wx.Button(self.panel_image_symbol, wx.ID_ANY, 'MyButton', wx.DefaultPosition, wx.DefaultSize, 0)
        self.button_edit_.Hide()
        bSizer6.Add(self.button_edit_, 0, wx.ALL, 5)
        self.m_button4 = wx.Button(self.panel_image_symbol, wx.ID_ANY, 'MyButton', wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_button4.Hide()
        ...
        self.menu_rebuild_symbols = wx.MenuItem(self.menu_kicad, wx.ID_ANY, 'Rebuild symbols', wx.EmptyString, wx.ITEM_NORMAL)
