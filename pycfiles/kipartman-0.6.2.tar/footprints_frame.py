...
# [GCC 8.4.0]
# Embedded file name: frames/footprints_frame.py
# Compiled at: 2018-04-29 13:45:40
...
import rest, helper.tree, os
from helper.tree import TreeImageList
from helper.exception import print_stack
import wx, re, sync.version_manager, json
...
class DataModelLibraryPath(helper.tree.TreeContainerItem):
    ...
    def GetValue(self, col):
        vMap = {0: os.path.basename(self.path)}
        return vMap[col]
...
class DataModelFootprint(helper.tree.TreeItem):
    ...
    def GetValue(self, col):
        ...
        vMap = {0: self.imagelist.GetBitmap(self.footprint.state), 1: str(version), 
           2: name}
        return vMap[col]
