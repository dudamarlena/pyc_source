...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/twoup/skeleton.py
# Compiled at: 2019-04-09 16:02:50
...
def parse_args(args):
    ...
    """
    parser = argparse.ArgumentParser(description='List page number sequence to print a small folded double sided booklet')
