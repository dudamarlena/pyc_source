...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/EasyMIDI/midiutil/MidiFile.py
# Compiled at: 2017-09-27 14:33:02
# Size of source mod 2**32: 64914 bytes
...
class MIDIFile(object):
    ...
    def __init__(self, numTracks=1, removeDuplicates=True, deinterleave=True, adjust_origin=False, file_format=1):
        """
...
def frequencyTransform(freq):
    ...
    if thirdByte == 127:
        if secondByte == 127 and firstByte == 127:
            thirdByte = 126
