...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\vis2048\game.py
# Compiled at: 2018-10-28 10:39:25
        ...
        if None in self.mat:
            ...
            for x in range(self.width):
                for y in range(self.width):
                    ...
                    if 0 < x and value == self.mat[Vec2(x - 1, y)] or 0 < y and value == self.mat[Vec2(x, y - 1)] or x < self.width - 1 and value == self.mat[Vec2(x + 1, y)] or y < self.width - 1 and value == self.mat[Vec2(x, y + 1)]:
                        return False
