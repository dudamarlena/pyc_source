...
# [GCC 8.4.0]
# Embedded file name: /mnt/DATA-LINUX/Cycloid/Cyclosible/cyclosible/playbook/models.py
# Compiled at: 2015-12-09 09:22:44
...
class Playbook(models.Model):
    ...
    class Meta:
        app_label = 'playbook'
        permissions = (('view_playbook', 'Can view the playbook'), ('can_override_skip_tags', 'Can override skip_tags'),
...
class PlaybookRunHistory(models.Model):
    ...
    STATUS = (('SUCCESS', 'Success'), ('RUNNING', 'Running'), ('FAILURE', 'Failure'))
