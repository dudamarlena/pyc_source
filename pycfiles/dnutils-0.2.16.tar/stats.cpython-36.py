...
# [GCC 8.4.0]
# Embedded file name: /data/code/dnutils/python3.5/dnutils/stats.py
# Compiled at: 2019-05-09 07:17:25
# Size of source mod 2**32: 8328 bytes
"""
...
class Gaussian(object):
    ...
    def kldiv(self, g2):
        ...
        if all([d < 1e-12 for d in (det1, det2)]):
            ...
            if any([d < 1e-12 for d in (det1, det2)]):
                return float('inf')
...
class StopWatch:
    ...
    def tojson(self):
        return {'name':self.name, 
         'avg':self.avg,  'std':self.std,  'calls':self.calls}