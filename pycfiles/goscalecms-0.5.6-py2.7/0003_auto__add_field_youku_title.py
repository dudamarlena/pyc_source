...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/videos/migrations/0003_auto__add_field_youku_title.py
# Compiled at: 2013-01-04 01:48:15
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_youku', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_youku', 'title')
