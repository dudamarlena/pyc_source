...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/themes/site_middleware.py
# Compiled at: 2013-02-05 03:23:12
...
class SiteOnFlyDetectionMiddleware:
    ...
    def lookup(self):
        ...
        if not self.site:
            ...
            cache.set(cache_key, SITE_ID.value, 300)
            return
        ...
        if theme:
            ...
            if hasattr(self.site, 'themes'):
                try:
                    ...
                    cache.set(cache_key, THEME.value, 300)
                except:
                    return False
