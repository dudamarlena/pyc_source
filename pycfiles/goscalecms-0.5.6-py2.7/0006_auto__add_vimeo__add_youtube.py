...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/videos/migrations/0006_auto__add_vimeo__add_youtube.py
# Compiled at: 2013-01-28 03:42:55
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('cmsplugin_vimeo', (
         ...
         (
          'playlist', self.gf('django.db.models.fields.CharField')(max_length=250)),
         (
          'lightbox', self.gf('django.db.models.fields.BooleanField')(default=False)),
         (
          'user', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True))))
        db.send_create_signal('videos', ['Vimeo'])
        db.create_table('videos_vimeo_posts', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'vimeo', models.ForeignKey(orm['videos.vimeo'], null=False)),
         (
          'post', models.ForeignKey(orm['goscale.post'], null=False))))
        db.create_unique('videos_vimeo_posts', ['vimeo_id', 'post_id'])
        db.create_table('cmsplugin_youtube', (
         ...
         (
          'lightbox', self.gf('django.db.models.fields.BooleanField')(default=False)),
         (
          'channel', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True))))
        db.send_create_signal('videos', ['Youtube'])
        db.create_table('videos_youtube_posts', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'youtube', models.ForeignKey(orm['videos.youtube'], null=False)),
         (
          'post', models.ForeignKey(orm['goscale.post'], null=False))))
        db.create_unique('videos_youtube_posts', ['youtube_id', 'post_id'])

    def backwards(self, orm):
        db.delete_table('cmsplugin_vimeo')
        db.delete_table('videos_vimeo_posts')
        db.delete_table('cmsplugin_youtube')
        db.delete_table('videos_youtube_posts')
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 28, 0, 0)'}), 
                         'id': (
       ...
       'goscale.post': {'Meta': {'object_name': 'Post'}, 'attributes': (
                        ...
                        'updated': (
                                  'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})}, 
       'videos.vimeo': {'Meta': {'object_name': 'Vimeo', 'db_table': "'cmsplugin_vimeo'"}, 'cmsplugin_ptr': (
                        ...
                        'user': (
                               'django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'})}, 
       'videos.youku': {'Meta': {'object_name': 'YouKu', 'db_table': "'cmsplugin_youku'"}, 'cmsplugin_ptr': (
                                        'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}), 
                        'lightbox': (
                                   'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                        'playlist': (
                        ...
                        'updated': (
                                  'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})}, 
       'videos.youtube': {'Meta': {'object_name': 'Youtube', 'db_table': "'cmsplugin_youtube'"}, 'channel': (
                                    'django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}), 
                          'cmsplugin_ptr': (
                                          'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}), 
                          'lightbox': (
