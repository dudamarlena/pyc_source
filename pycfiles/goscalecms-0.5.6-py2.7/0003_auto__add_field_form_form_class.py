...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/forms/migrations/0003_auto__add_field_form_form_class.py
# Compiled at: 2013-03-18 01:20:09
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_form', 'form_class', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_form', 'form_class')
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 18, 0, 0)'}), 
                         'id': (
       ...
       'cms.placeholder': {'Meta': {'object_name': 'Placeholder'}, 'default_width': (
                           ...
                           'slot': (
                                  'django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'})}, 
       'forms.form': {'Meta': {'object_name': 'Form', 'db_table': "'cmsplugin_form'"}, 'cmsplugin_ptr': (
