...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/calendar/migrations/0004_auto__add_field_calendar_updated.py
# Compiled at: 2013-01-14 22:46:58
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_calendar', 'updated', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_calendar', 'updated')
    ...
    models = {'calendar.calendar': {'Meta': {'object_name': 'Calendar', 'db_table': "'cmsplugin_calendar'"}, 'cmsplugin_ptr': (
       ...
       'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}), 
                         'id': (
