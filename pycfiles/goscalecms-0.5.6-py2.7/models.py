...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/themes/models.py
# Compiled at: 2013-03-18 00:33:09
import tarfile, StringIO, shutil, os
...
class Theme(models.Model):
    ...
    name = models.CharField(max_length=255, blank=True, help_text=_('Only set name if no theme file provided (should be consistent with directory name).'))
