...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/presentations/migrations/0002_auto__chg_field_speakerdeck_ratio__chg_field_googlepresentation_ratio_.py
# Compiled at: 2013-02-18 23:10:50
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 0, 0)'}), 
                         'id': (
       ...
       'goscale.post': {'Meta': {'object_name': 'Post'}, 'attributes': (
                        ...
                        'updated': (
                                  'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})}, 
       'presentations.googlepresentation': {'Meta': {'object_name': 'GooglePresentation', 'db_table': "'cmsplugin_googlepresentation'"}, 'autoplay': (
                                                       'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                            'cmsplugin_ptr': (
                                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}), 
                                            'delay': (
                                                    'django.db.models.fields.SmallIntegerField', [], {'default': '3000'}), 
                                            'embed': (
                                            ...
                                            'ratio': (
                                                    'django.db.models.fields.CharField', [], {'default': "'4:3'", 'max_length': '50'}), 
                                            'template': (
                                            ...
                                            'width': (
                                                    'django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})}, 
       'presentations.slideshare': {'Meta': {'object_name': 'Slideshare', 'db_table': "'cmsplugin_slideshare'"}, 'cmsplugin_ptr': (
                                                    'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}), 
                                    'embed': (
                                            'django.db.models.fields.TextField', [], {}), 
                                    'embed_as_is': (
                                    ...
                                    'width': (
                                            'django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                                    'without_related_content': (
                                                              'django.db.models.fields.BooleanField', [], {'default': 'True'})}, 
       'presentations.speakerdeck': {'Meta': {'object_name': 'Speakerdeck', 'db_table': "'cmsplugin_speakerdeck'"}, 'cmsplugin_ptr': (
                                                     'django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}), 
                                     'embed': (
                                             'django.db.models.fields.TextField', [], {}), 
                                     'embed_as_is': (
