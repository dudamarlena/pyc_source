...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/feeds/migrations/0007_auto__add_field_tumblr_disqus__add_field_blogger_disqus__add_field_fee.py
# Compiled at: 2013-01-15 03:48:32
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_tumblr', 'disqus', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_blogger', 'disqus', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_feed', 'disqus', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
