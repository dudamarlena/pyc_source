...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/pictures/migrations/0004_auto__add_field_picasa_updated.py
# Compiled at: 2013-01-14 22:47:22
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_picasa', 'updated', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_picasa', 'updated')
