...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/decorators.py
# Compiled at: 2013-01-08 01:25:59
import hashlib
...
def get_cache_key(cache_key, alternative_cache_key, *func_args, **func_kwargs):
    ...
    """
    if not cache_key:
        key = hashlib.sha1('%s.%s.%s' % (alternative_cache_key, func_args, func_kwargs)).hexdigest()
