...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/pictures/migrations/0002_auto__del_field_picasa_user__add_field_picasa_url.py
# Compiled at: 2013-01-08 02:32:44
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('cmsplugin_picasa', 'user')
        db.add_column('cmsplugin_picasa', 'url', self.gf('django.db.models.fields.CharField')(default='https://plus.google.com/photos/114610201247248895941/albums/5319044261264143137', max_length=250), keep_default=False)

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Picasa.user' and its values cannot be restored.")
        db.delete_column('cmsplugin_picasa', 'url')
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 8, 0, 0)'}), 
                         'id': (
       ...
       'goscale.post': {'Meta': {'object_name': 'Post'}, 'attributes': (
                        ...
                        'updated': (
                                  'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})}, 
       'pictures.picasa': {'Meta': {'object_name': 'Picasa', 'db_table': "'cmsplugin_picasa'"}, 'cmsplugin_ptr': (
