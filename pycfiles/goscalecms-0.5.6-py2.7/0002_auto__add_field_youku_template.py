...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/videos/migrations/0002_auto__add_field_youku_template.py
# Compiled at: 2013-01-03 23:55:56
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_youku', 'template', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_youku', 'template')
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 3, 0, 0)'}), 
                         'id': (
       ...
       'videos.youku': {'Meta': {'object_name': 'YouKu', 'db_table': "'cmsplugin_youku'"}, 'cmsplugin_ptr': (
                        ...
                        'posts': (
                                'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'plugins'", 'symmetrical': 'False', 'to': "orm['goscale.Post']"}), 
                        'template': (
