...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/feeds/migrations/0003_auto__add_field_feed_external_links.py
# Compiled at: 2013-01-09 03:17:24
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_feed', 'external_links', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_feed', 'external_links')
