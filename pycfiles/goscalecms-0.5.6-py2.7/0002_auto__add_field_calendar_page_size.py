...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/calendar/migrations/0002_auto__add_field_calendar_page_size.py
# Compiled at: 2013-01-11 03:02:38
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_calendar', 'page_size', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_calendar', 'page_size')
    ...
    models = {'calendar.calendar': {'Meta': {'object_name': 'Calendar', 'db_table': "'cmsplugin_calendar'"}, 'cmsplugin_ptr': (
       ...
       'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 0, 0)'}), 
                         'id': (
