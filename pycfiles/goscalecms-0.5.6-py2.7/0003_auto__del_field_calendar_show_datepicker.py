...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/calendar/migrations/0003_auto__del_field_calendar_show_datepicker.py
# Compiled at: 2013-01-13 21:29:29
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('cmsplugin_calendar', 'show_datepicker')

    def backwards(self, orm):
        db.add_column('cmsplugin_calendar', 'show_datepicker', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    models = {'calendar.calendar': {'Meta': {'object_name': 'Calendar', 'db_table': "'cmsplugin_calendar'"}, 'cmsplugin_ptr': (
       ...
       'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 13, 0, 0)'}), 
                         'id': (
