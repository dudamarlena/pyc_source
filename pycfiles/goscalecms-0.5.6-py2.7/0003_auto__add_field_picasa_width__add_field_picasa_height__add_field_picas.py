...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/goscale/plugins/pictures/migrations/0003_auto__add_field_picasa_width__add_field_picasa_height__add_field_picas.py
# Compiled at: 2013-01-09 22:55:38
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_picasa', 'width', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_picasa', 'height', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_picasa', 'thumbnail_width', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_picasa', 'thumbnail_height', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)
        db.add_column('cmsplugin_picasa', 'autoplay', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        db.delete_column('cmsplugin_picasa', 'width')
        db.delete_column('cmsplugin_picasa', 'height')
        db.delete_column('cmsplugin_picasa', 'thumbnail_width')
        db.delete_column('cmsplugin_picasa', 'thumbnail_height')
        db.delete_column('cmsplugin_picasa', 'autoplay')
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
                         ...
                         'creation_date': (
                                         'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 9, 0, 0)'}), 
                         'id': (
       ...
       'goscale.post': {'Meta': {'object_name': 'Post'}, 'attributes': (
                        ...
                        'updated': (
                                  'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})}, 
       'pictures.picasa': {'Meta': {'object_name': 'Picasa', 'db_table': "'cmsplugin_picasa'"}, 'autoplay': (
