...
# Embedded file name: build/bdist.linux-x86_64/egg/kong/client.py
# Compiled at: 2019-08-12 17:48:16
# Size of source mod 2**32: 3048 bytes
import copy, os, typing, aiohttp
...
__all__ = [
 'Kong', 'KongError', 'KongResponseError']
...
class Kong:
    ...
    async def execute(self, url, method=None, headers=None, callback=None, wrap=None, timeout=None, **kw):
        if not self.session:
