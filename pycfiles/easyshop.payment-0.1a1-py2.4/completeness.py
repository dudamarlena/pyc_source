...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/payment/adapters/completeness.py
...
class DirectDebitPaymentMethodCompleteness:
    ...
    def isComplete(self):
        ...
        if IBankAccount.providedBy(bank_account) == False or ICompleteness(bank_account) == False:
            return False
        else:
            return True
