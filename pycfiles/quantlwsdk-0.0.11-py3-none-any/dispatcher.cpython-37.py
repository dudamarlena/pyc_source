    ...
    def addSubject(self, subject):
        ...
        if subject.getDispatchPriority() is dispatchprio.LAST:
            ...
            for s in self._Dispatcher__subjects:
                if not s.getDispatchPriority() is dispatchprio.LAST:
                    if subject.getDispatchPriority() < s.getDispatchPriority():
                        break
                    pos += 1
        ...
        try:
            ...
            while not self._Dispatcher__stop:
                ...
                if eof:
                    ...
                    eventsDispatched or self._Dispatcher__idleEvent.emit()
