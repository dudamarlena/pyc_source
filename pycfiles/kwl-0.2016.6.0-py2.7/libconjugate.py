...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/kwl2text/libconjugate.py
# Compiled at: 2016-05-03 18:17:56
"""Conjugate verbs"""
...
class VerbGenerator:
    ...
    TENSES = {'oromo': {'VERB1PS_TDY': 'ani VERBaa jiraa', 
    ...
    def stem(self, word):
        stemmed = word
        AFFIX = {'amarinya': {'prefix': 'መ', 'suffix': ''}, 'chewa': {'prefix': 'ku', 'suffix': 'a'}, 'english': {'prefix': 'to ', 'suffix': ''}, 'deutsch': {'prefix': '', 'suffix': 'en'}, 'gikuyu': {'prefix': 'gũ', 'suffix': 'a'}, 'kongo': {'prefix': 'ku ', 'suffix': 'a'}, 'luganda': {'prefix': 'oku', 'suffix': 'a'}, 'malagasy': {'prefix': 'm', 'suffix': ''}, 'espanyol': {'prefix': '', 'suffix': 'ar'}, 'zulu': {'prefix': 'uku', 'suffix': 'a'}}
        try:
