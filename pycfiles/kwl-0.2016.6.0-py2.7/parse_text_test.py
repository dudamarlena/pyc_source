...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/text2kwl/parse_text_test.py
# Compiled at: 2016-03-08 18:44:34
import parse_text as p, unittest

class ParserTest(unittest.TestCase):

    def setUp(self):
        self.td = {'and-conjunction': '', 
           'am-verb je tdy': 'be', 
