...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/asciicanvas/asciicanvas.py
# Compiled at: 2017-11-06 16:34:21
"""ASCII canvas"""
...
class AsciiCanvas(object):
    ...
    def __init__(self, cols, lines, style=None):
        ...
        self.style = style
        self.canvas = [ [style] * cols for _ in range(lines) ]
        return
