...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/asciicanvas/colors.py
# Compiled at: 2017-11-06 16:33:23
import sys
...
if sys.platform == 'win32':
    ...
    def print_color_text(text, fg_color, bg_color=None, font_style=0):
        if fg_color is not None and fg_color != default and bg_color is not None and bg_color != default:
            ...
            set_color(handle, bg_color * 16 + (default_attributes & 15))
