...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/policytool/atlas.py
# Compiled at: 2019-05-23 11:08:11
import requests, urlutil
...
class Client:
    ...
    def _create_qualifiedname_query(self, type_name, *values):
        ...
        n = 0
        for v in values:
            criteria = {'attributeName': 'qualifiedName', 'operator': 'STARTSWITH' if n == 0 else 'CONTAINS', 
               'attributeValue': v}
            n += 1
    ...
    def add_hdfs_path(self, hdfs_path):
        ...
        entity = {'entity': {'typeName': 'hdfs_path', 
                      'attributes': {'description': 'Created/Updated by cobra-policytool.', 
                                     'name': name, 
