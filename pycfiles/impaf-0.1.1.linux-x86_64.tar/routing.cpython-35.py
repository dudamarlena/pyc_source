...
# [GCC 8.4.0]
# Embedded file name: /home/socek/projects/impaf/core/build/lib/impaf/routing.py
# Compiled at: 2015-08-05 13:43:58
...
class Routing(object):
    ...
    def read_from_dotted(self, path):
        self.read_from_file(self.paths.get_path_dotted(path))

    def add(self, controller, route, url, *args, **kwargs):
        self.config.add_route(route, url, *args, **kwargs)
