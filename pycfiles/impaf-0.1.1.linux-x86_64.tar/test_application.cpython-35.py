...
# [GCC 8.4.0]
# Embedded file name: /home/socek/projects/impaf/example/venv_impex/lib/python3.5/site-packages/impaf/tests/test_application.py
...
class TestApplication(object):
    ...
    def test_create_app(self, app, mSettingsFactory, mConfigurator, mimport_module):
        ...
        assert mConfigurator.return_value.registry == {'settings': settings, 
         'paths': paths}
