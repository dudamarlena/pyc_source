...
# [GCC 8.4.0]
# Embedded file name: /home/socek/projects/impaf/example/venv_impex/lib/python3.5/site-packages/impaf/testing/case.py
# Compiled at: 2015-12-03 08:19:54
...
class RequestCase(TestCase):
    ...
    @cache
    def mregistry(self):
        self.mrequest().registry = MockedDict({'settings': {}, 
         'paths': {}})
...
class ControllerCase(RequestCase):
    ...
    def object(self):
        ...
        return self._prepere_testable(cls, self.mroot_factory(), self.mrequest(), self.context())
    ...
    def madd_widget(self):
        return self.pobject(self.object(), 'add_widget')