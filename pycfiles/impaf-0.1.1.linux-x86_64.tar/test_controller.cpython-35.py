...
# [GCC 8.4.0]
# Embedded file name: /home/socek/projects/impaf/example/venv_impex/lib/python3.5/site-packages/impaf/controller/tests/test_controller.py
...
class TestController(ControllerFixtures):
    ...
    def test_normaln_run(self, controller, mrequest, mroot_factory):
        response = controller()
        assert controller.context == {'request': mrequest, 
        ...
        assert controller.runned == {'_before_context': True, 
         '_before_make': True, 
         '_after_make': True, 
...
class TestControllerUtils(ControllerFixtures):
    ...
    def test_add_widget(self, controller, mrequest):
        ...
        assert controller.context == {'myname': mwidget}
