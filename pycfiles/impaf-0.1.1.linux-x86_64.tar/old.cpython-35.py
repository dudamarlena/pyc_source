...
# [GCC 8.4.0]
# Embedded file name: /home/socek/projects/impaf/core/build/lib/impaf/testing/old.py
# Compiled at: 2015-08-04 15:35:21
...
class RequestFixture(BaseFixture):
    ...
    def registry(self, mrequest):
        mrequest.registry = MockedDict({'settings': {}, 
         'paths': {}})
...
class ControllerFixture(RequestFixture):
    ...
    def testable(self, mroot_factory, mrequest, context):
        ...
        return self._prepere_testable(cls, mroot_factory, mrequest, context)
