...
# [GCC 8.4.0]
# Embedded file name: /Users/mdiazmel/code/aramis/clinica/clinica/iotools/converters/nifd_to_bids/nifd_utils.py
...
def csv_to_path(csv_line, source_dir):
    ...
    if split[10] != 'Original':
        if split[9] == 'MT1; GradWarp; N3m <- Sag 3D MP-RAGE':
    ...
    try:
        ...
        if split[0] == '1_S_0005':
            if date == '2011-06-13':
                if split[9] in ('NIFD_DTI_b=1000_2.7mm3', 'dti_b=2000_64dir', 'dti_b=0_scans'):
                    date = '2011-06-15'
        if split[0] == '1_S_0084':
            if date == '2012-02-13':
                if split[9] in ('NIFD_DTI_b1000_2.7mm3', 'dti_WIP_b2000_64dir', 'DTI_64_2.2iso_full_ky_fov220',
                                'DTI_b=0_2.2iso_full_ky_-_10_acqs', 'dti_WIP_b0_scans_aah'):
                    date = '2012-02-15'
        if split[0] == '1_S_0316':
            if date == '2013-10-30':
                if split[9] in ('NIFD_DTI_b1000_2.7mm3_511E', 'ep2d-advdiff-511E_b2000_64dir',
