...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/torngas/cache/backends/rediscache.py
...
class CacheConnectionPool(object):
    ...
    def get_connection_pool(self, host='127.0.0.1', port=6379, db=1, password=None, parser_class=None, unix_socket_path=None, connection_pool_class=None, connection_pool_class_kwargs=None):
        connection_identifier = (
         host, port, db, parser_class, unix_socket_path, connection_pool_class)
...
class RedisClient(CacheClient):
    ...
    def _init(self, server, params):
        ...
        connection_pool = pool.get_connection_pool(parser_class=self.parser_class, connection_pool_class=self.connection_pool_class, connection_pool_class_kwargs=self.connection_pool_class_kwargs, **kwargs)
        self._client = redis.StrictRedis(connection_pool=connection_pool, **kwargs)
        return
    ...
    def connection_pool_class_kwargs(self):
        default = {'retry_on_timeout': False, 
