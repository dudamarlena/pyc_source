...
# [GCC 8.4.0]
# Embedded file name: /home/edill/mc/lib/python3.5/site-packages/skxray/core/fitting/base/parameter_data.py
# Compiled at: 2016-03-04 05:19:32
# Size of source mod 2**32: 13839 bytes
...
para_dict = {'coherent_sct_amplitude': {'bound_type': 'none', 'min': 7.0, 'max': 8.0, 'value': 6.0}, 
 ...
 'pileup0': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup1': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup2': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup3': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup4': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup5': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup6': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup7': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
 'pileup8': {'bound_type': 'none', 'min': -10.0, 'max': 1.1, 'value': 1e-10}, 
...
default_param = {'coherent_sct_amplitude': {'bound_type': 'none', 
 ...
 'non_fitting_values': {'element_list': 'Ar, Fe, Ce_L, Pt_M', 
                        'energy_bound_low': {'value': 1.5, 
                                             'default_value': 1.5, 
                                             'description': 'E low [keV]'}, 
                        
                        'energy_bound_high': {'value': 13.5, 
                                              'default_value': 13.5, 
