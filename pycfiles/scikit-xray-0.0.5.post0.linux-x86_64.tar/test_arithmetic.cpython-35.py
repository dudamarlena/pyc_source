...
# [GCC 8.4.0]
# Embedded file name: /home/edill/mc/lib/python3.5/site-packages/skxray/core/tests/test_arithmetic.py
...
def test_logical_nor():
    ...
    assert_equal(arithmetic.logical_nor(test_array_1, test_array_2).sum(), np.ones((30,
                                                                                    30,
                                                                                    30), dtype=int).sum() - np.logical_or(test_array_1, test_array_2).sum())
