...
# Embedded file name: build/bdist.linux-x86_64/egg/cnfformula/families/subsetcardinality.py
# Compiled at: 2019-10-28 05:33:57
# Size of source mod 2**32: 4418 bytes
__doc__ = 'Implementation of subset cardinality formulas\n'
...
class SCCmdHelper(object):
    ...
    def setup_command_line(parser):
        parser.add_argument('--equal', '-e', default=False, action='store_true', help='encode cardinality constraints as equations')
