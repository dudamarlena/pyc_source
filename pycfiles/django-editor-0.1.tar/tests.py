...
# [GCC 8.4.0]
# Embedded file name: /home/slam/workspace/django-editor/editor/tests.py
# Compiled at: 2013-03-19 04:56:22
...
class EditorTestBase(unittest.TestCase):
    ...
    def test_admin(self, expected_widget=None, expected_admin=None, expected_inline=None):
...
class EditorTinyMCETest(EditorTestBase):
    ...
    def test_rich_text_module(self, **kwargs):
        super(EditorTinyMCETest, self).test_rich_text_module(expected='tinymce')
...
class EditorImperaviTest(EditorTestBase):
    ...
    def test_rich_text_module(self, **kwargs):
        super(EditorImperaviTest, self).test_rich_text_module(expected='imperavi')

    @override_settings(INSTALLED_APPS=settings.INSTALLED_APPS + ('imperavi', ))
    def test_admin(self, **kwargs):
        from imperavi.admin import ImperaviAdmin, ImperaviStackedInlineAdmin, ImperaviWidget
        super(EditorImperaviTest, self).test_admin(expected_widget=ImperaviWidget, expected_admin=ImperaviAdmin, expected_inline=ImperaviStackedInlineAdmin)