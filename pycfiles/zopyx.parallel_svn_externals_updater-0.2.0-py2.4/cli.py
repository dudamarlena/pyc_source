...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/zopyx/parallel_svn_externals_updater/cli.py
# Compiled at: 2008-07-06 02:08:33
"""
Parallel update of svn:externals within a SVN checkout
"""
import os, re, sys, commands, processing
...
def main():
    ...
    parser.add_option('-r', '--recursive', dest='recursive', action='store_true', default=False, help='Recursive update')
    parser.add_option('-p', '--pool-size', dest='pool_size', action='store', type='int', default=10, help='Number of parallel update operations')
