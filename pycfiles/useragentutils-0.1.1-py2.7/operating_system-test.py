...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/useragentutils/operating_system-test.py
# Compiled at: 2013-01-06 22:42:09
...
palmOsDevices = [
 'Mozilla/4.0 (compatible MSIE 6.0 Windows 98 PalmSource/Palm-TunX Blazer/4.3) 16320x320',
 'Mozilla/4.0 (compatible MSIE 6.0 Windows 98 PalmSource/Palm-D050 Blazer/4.3) 16320x320)',
...
class OperatingSystemTest(unittest.TestCase):
    ...
    def testGroupRecursion(self):
        self.assertEquals(OperatingSystem.ANDROID2_TABLET.group, OperatingSystem.ANDROID)
        self.assertEquals(OperatingSystem.BLACKBERRY6.group, OperatingSystem.BLACKBERRY)
        self.assertEquals(OperatingSystem.MAC_OS.group, OperatingSystem.MAC_OS)
