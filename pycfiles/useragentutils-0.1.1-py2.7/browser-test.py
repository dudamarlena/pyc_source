...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/useragentutils/browser-test.py
# Compiled at: 2013-01-07 19:03:43
...
class BrowserTest(unittest.TestCase):
    ...
    def test_version_detection(self):
        ...
        self.versionTest('Mozilla/4.0 (compatible; MSIE 7.0b; Windows NT 6.0 ; .NET CLR 2.0.50215; SL Commerce Client v1.0; Tablet PC 2.0', Version('7.0b', '7', '0b'))
        ...
        self.versionTest('Mozilla/5.0 (compatible; Googlebot/2.1; http:#www.google.com/bot.html)', None)
