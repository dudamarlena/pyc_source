...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipyplot/plot/trajectory.py
...
import itertools, scipy.stats, seaborn.apionly as sns
from scipyplot.plot.utils.niceFigure import niceFigure

def trajectory(x, y, z=None, interpolate=None, mark_init=True, mark_end=True, force_color_init=None, force_color_end=None, cmap=cm.coolwarm, linewidth=2):
    """
    ...
    :return:
    """
    color_over_time(x=x, y=y, z=z, interpolate=interpolate, mark_init=mark_init, mark_end=mark_end, force_color_init=force_color_init, force_color_end=force_color_end, cmap=cmap)
...
def color_over_time(x, y, z=None, interpolate=None, mark_init=True, mark_end=True, force_color_init=None, force_color_end=None, cmap=cm.coolwarm, linewidth=2):
    """
