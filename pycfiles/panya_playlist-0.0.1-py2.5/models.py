...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/playlist/models.py
# Compiled at: 2011-01-06 04:39:39
...
class PlaylistEntry(models.Model):
    ...
    start = models.DateTimeField(verbose_name='Starting Date & Time', help_text='Date and time at which this entry starts.')
    end = models.DateTimeField(verbose_name='Ending Date & Time', help_text='Date and time at which this entry ends.')
...
class ScheduledPlaylist(models.Model):
    ...
    playlist = models.ForeignKey('playlist.Playlist', related_name='playlist_content_playlist_set')
