...
# [GCC 8.4.0]
# Embedded file name: /Users/rd/Work/Edgy/workflow/.virtualenv-python/lib/python2.7/site-packages/edgy/workflow/workflow.py
# Compiled at: 2016-02-21 07:40:18
...
class Workflow(object):
    ...
    def add_transition(self, transition):
        ...
        for source_state in transition.source:
            if source_state not in self._transitions_by_source:
