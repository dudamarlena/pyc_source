...
# [GCC 8.4.0]
# Embedded file name: /media/martin/windows/Desarrollo/Python/django-endless-pagination-vue/bin/django-endless-pagination-vue/tests/endless_pagination/models.py
...
class EndlessPage(utils.UnicodeMixin):
    ...
    def __unicode__(self):
        ...
        context = {'add_nofollow': settings.ADD_NOFOLLOW, 
         'page': self, 
        ...
        template = _template_cache.setdefault(template_name, loader.get_template(template_name))
        return template.render(RequestContext(self._request, context))


class PageList(utils.UnicodeMixin):
    __doc__ = 'A sequence of endless pages.'
