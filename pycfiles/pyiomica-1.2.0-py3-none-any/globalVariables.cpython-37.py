...
# [GCC 8.4.0]
# Embedded file name: D:\Projects\A_MSU_NASA\VS\TimeSeriesAnalysis\pyiomica\globalVariables.py
# Compiled at: 2019-10-26 16:29:45
...
import os, types, appdirs, gzip, copy, shutil, zipfile, numpy as np
np.random.seed(0)
