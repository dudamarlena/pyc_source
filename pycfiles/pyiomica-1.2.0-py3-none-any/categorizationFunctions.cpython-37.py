...
# [GCC 8.4.0]
# Embedded file name: D:\Projects\A_MSU_NASA\VS\pyiomica\pyiomica\categorizationFunctions.py
# Compiled at: 2020-02-28 11:09:49
# Size of source mod 2**32: 15253 bytes
"""Categorization functions"""
from .globalVariables import *
from . import utilityFunctions, visualizationFunctions, extendedDataFrame, clusteringFunctions, coreFunctions, dataStorage
...
def calculateTimeSeriesCategorization(df_data, dataName, saveDir, hdf5fileName=None, p_cutoff=0.05, fraction=0.75, constantSignalsCutoff=0.0, lowValuesToTag=1.0, lowValuesToTagWith=1.0, NumberOfRandomSamples=100000, NumberOfCPUs=4, referencePoint=0, autocorrelationBased=True, calculateAutocorrelations=False, calculatePeriodograms=False, preProcessData=True):
    ...
    calculateAutocorrelations = autocorrelationBased or False
    df_dataPeriodograms = calculatePeriodograms or dataStorage.read((saveDir + dataName + '_dataPeriodograms'), hdf5fileName=hdf5fileName)
...
def clusterTimeSeriesCategorization(dataName, saveDir, numberOfLagsToDraw=3, hdf5fileName=None, exportClusteringObjects=False, writeClusteringObjectToBinaries=True, autocorrelationBased=True, method='weighted', metric='correlation', significance='Elbow'):
