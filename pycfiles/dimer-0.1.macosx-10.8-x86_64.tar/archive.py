...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/dimer/archive.py
...
"""
import logging, datetime, os, pandas as pd, filelock
...
__HDF_SUFFIX__ = 'h5'
__SPEC_SEP__ = ':'
DSPEC_MSG = 'dataset specification; of the form <hdf_archive_path>%s<dataset_name>' % __SPEC_SEP__
