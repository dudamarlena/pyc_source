...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/dimer/genome/bedops.py
# Compiled at: 2013-08-03 19:56:07
"""
...
def bedmap(refdata, mapdata, ops=('--echo', '--echo-map'), parsePatt='([01])[|](.+)[|](.*)', onlyOverlapping=True):
...
def overlap_as_array(anchor, feat_lst, bin=1, dtype=np.float64, parseFeature=partial(parseBED, use_score=True), respect_strand=True):
