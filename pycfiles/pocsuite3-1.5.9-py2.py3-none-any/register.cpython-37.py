...
# [GCC 8.4.0]
# Embedded file name: /Users/boyhack/programs/pocsuite3/pocsuite3/lib/core/register.py
# Compiled at: 2019-10-17 04:56:24
# Size of source mod 2**32: 4282 bytes
import importlib.machinery, importlib.util
from importlib.abc import Loader
from pocsuite3.lib.core.common import multiple_replace, get_filename, get_md5, is_pocsuite3_poc, get_poc_requires, get_poc_name
...
class PocLoader(Loader):
    ...
    def get_data(self, filename):
        if filename.startswith('pocsuite://'):
            if self.data:
                ...
                with open(filename, encoding='utf-8') as (f):
                    code = f.read()
                data = is_pocsuite3_poc(code) or multiple_replace(code, POC_IMPORTDICT)
        else:
            data = code
        return data
