...
class Option(object):
    __doc__ = ' Exploit attribute that is set by the end user '
...
class OptInteger(Option):
    __doc__ = ' Option Integer attribute '
...
class OptFloat(Option):
    __doc__ = ' Option Float attribute '
...
class OptString(Option):
    __doc__ = ' Option String attribute '
