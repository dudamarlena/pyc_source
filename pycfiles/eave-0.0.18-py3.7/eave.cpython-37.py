...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\eave\eave.py
# Compiled at: 2020-03-03 22:38:38
# Size of source mod 2**32: 8488 bytes
import os, json, cgi, mistune, yaml
from step import Template
__all__ = [
 'Doc', 'Note', 'Api', 'Param', 'UriParam', 'QueryParam', 'BodyParam', 'UP', 'QP', 'BP', 'readf']
...
RESOURCE = {'style':open((os.path.join(BASE_DIR, 'resource/style.css')), encoding='utf8').read(), 
...
class Doc(Base):
    ...
    def build(self, target=None, language='en'):
        ...
        html = Template(template, strip=False).expand(doc=self,
