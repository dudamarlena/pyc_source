...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/net6mon/config.py
# Compiled at: 2006-06-07 10:35:33
import sys, os, time, string
from ConfigParser import ConfigParser, SafeConfigParser
__all__ = [
 'Config', 'DaemonConfig']
_daemon_valid_keys = [
 'host', 'port', 'debug', 'database_dir', 'plugins', 'logfile', 'plugin_dir', 'enable_docserv', 'docserv_port', 'enable_ssl', 'pem_file', 'ssl_version', 'ssl_depth', 'ssl_identifier']
