...
# [GCC 8.4.0]
# Embedded file name: /home/underdog/github/api-pagination/api_pagination/test/test.py
# Compiled at: 2015-04-24 21:26:23
...
class ApiPaginationTestCase(TestCase):
    ...
    def test_single_page(self):
        ...
        Pagination info for a single page
            ...
            under page
                ...
                it has no next page
        """
        page_info = Paginator.page_info(page=1, total=45, items_per_page=100)
        self.assertEqual(page_info, {'overall': {'pages': 1, 
                       'total': 45, 
                       'first_page': 1, 
                       'last_page': 1}, 
           'page': {'current_page': 1, 
    ...
    def test_multiple_pages(self):
        ...
        self.assertEqual(page_info, {'overall': {'first_page': 1, 
                       'last_page': 5, 
                       'pages': 5, 
                       'total': 45}, 
           'page': {'current_page': 2, 
    ...
    def test_first_page(self):
        ...
        Pagination info for the first page of multiple pages
            under page
                ...
                it lists next page
        """
        page_info = Paginator.page_info(page=1, total=45, items_per_page=10)
        self.assertEqual(page_info['page'], {'current_page': 1, 
           'previous_page': None, 
           'next_page': 2})
        return
    ...
    def test_last_page(self):
        ...
        Pagination info for the last page of multiple pages
            under page
                ...
                it has no next page
        """
        page_info = Paginator.page_info(page=5, total=45, items_per_page=10)
        self.assertEqual(page_info['page'], {'current_page': 5, 
           'previous_page': 4, 
           'next_page': None})
        return
    ...
    def test_under_first_page(self):
        ...
        """
        page_info = Paginator.page_info(page=6, total=45, items_per_page=10)
        self.assertEqual(page_info['page'], {'current_page': 6, 
           'previous_page': 5, 
           'next_page': None})
        return
    ...
    def test_over_last_page(self):
        ...
        Pagination info for the a page after the last page of multiple pages
            under page
                ...
                it has no next page
        """
        page_info = Paginator.page_info(page=0, total=45, items_per_page=10)
        self.assertEqual(page_info['page'], {'current_page': 0, 
           'previous_page': None, 
           'next_page': 1})
        return
