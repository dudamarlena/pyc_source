...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/instancemanager/uninstaller.py
    ...
    def uninstall(self):
        ...
        try:
            ...
            if self.qi.isProductInstalled(self.product):
                ...
                print '%s is not installed so I have nothing to uninstall.' % self.product
        except:
