...
def add_keys(apps, schema_editor):
    ...
    try:
        ...
        Setting.objects.create(title='ارزش تومانی هر بن',
          key=key,
          value='100',
          value_type='i',
          is_show=True,
    ...
    try:
        ...
        Setting.objects.create(title='مقدار بن پیش فرضی برای هر محصول پس از خرید که به کاربر باز گردانده می شود. ',
          key=key,
          value='0',
          value_type='i',
          is_show=True,
    ...
    try:
        ...
        Setting.objects.create(title='کاربر تا چه زمانی می تواند از بن بدست آمده از خرید یک محصول استفاده کند. عدد ۰ به معنای عدم محدودیت است. واحد ساعت است.',
          key=key,
          value='0',
          value_type='i',
          is_show=True,
    ...
    try:
        ...
        Setting.objects.create(title='مقدار پیش فرض استفاده بن برای خرید هر کالا',
          key=key,
          value='-2',
          value_type='i',
          is_show=True,
    ...
    try:
        ...
        Setting.objects.create(title='مقدار پیش فرض اجازه پرداخت با کیف پول در هر کالا',
          key=key,
          value='True',
          value_type='b',
          is_show=True,
