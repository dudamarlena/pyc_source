...
class Migration(migrations.Migration):
    dependencies = [
     ('hastexo', '0003_blanks')]
    operations = [
     migrations.RemoveField(model_name='stacklog', name='stack'),
     migrations.AddField(model_name='stacklog', name='stack_id', field=models.IntegerField(db_index=True, null=True))]