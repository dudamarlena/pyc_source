...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterField(model_name='stack', name='hook_events', field=jsonfield.fields.JSONField(default=dict)),
     ...
     migrations.AlterField(model_name='stack', name='providers', field=jsonfield.fields.JSONField(default=list)),
     ...
     migrations.AlterField(model_name='stacklog', name='hook_events', field=jsonfield.fields.JSONField(default=dict)),
     migrations.AlterField(model_name='stacklog', name='providers', field=jsonfield.fields.JSONField(default=list))]