...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/takeover/web.py
# Compiled at: 2013-12-09 06:41:17
"""
Copyright (c) 2006-2013 sqlmap developers (http://sqlmap.org/)
See the file 'doc/COPYING' for copying permission
"""
import os, posixpath, re, StringIO
...
class Web:
    ...
    def _webFileStreamUpload(self, stream, destFileName, directory):
        ...
        if self.webApi in getPublicTypeMembers(WEB_API, True):
            multipartParams = {'upload': '1', 'file': stream, 
               'uploadDir': directory}
