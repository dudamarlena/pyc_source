...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/takeover/metasploit.py
...
class Metasploit:
    ...
    def _initVars(self):
        ...
        self._msfPayloadsList = {'windows': {1: ('Meterpreter (default)', 'windows/meterpreter'), 
                       2: ('Shell', 'windows/shell'), 
                       3: ('VNC', 'windows/vncinject')}, 
           'linux': {1: ('Shell (default)', 'linux/x86/shell'), 
                     2: ('Meterpreter (beta)', 'linux/x86/meterpreter')}}
        self._msfConnectionsList = {'windows': {1: ('Reverse TCP: Connect back from the database host to this machine (default)', 'reverse_tcp'), 
 ...
 'reverse_https'), 
           ...
           'linux': {1: ('Reverse TCP: Connect back from the database host to this machine (default)', 'reverse_tcp'), 
                     2: ('Bind TCP: Listen on the database host for a connection', 'bind_tcp')}}
        self._msfEncodersList = {'windows': {1: ('No Encoder', 'generic/none'), 
        ...
        self._msfSMBPortsList = {'windows': {1: ('139/TCP', '139'), 
                       2: ('445/TCP (default)', '445')}}
        self._portData = {'bind': 'remote port number', 
    ...
    def _skeletonSelection(self, msg, lst=None, maxValue=1, default=1):
        ...
        if not choice:
            ...
            if int(choice) > maxValue or int(choice) < 1:
                ...
                while True:
                    ...
                    if not choice or choice == '2':
                        ...
                        if Backend.isDbms(DBMS.PGSQL):
                            ...
                            break
                        elif Backend.isDbms(DBMS.MSSQL) and Backend.isVersionWithin(('2005',
                                                                                     '2008')):
                            break
