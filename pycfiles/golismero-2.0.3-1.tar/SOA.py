...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/dns/rdtypes/ANY/SOA.py
# Compiled at: 2013-08-26 10:52:44
import struct, dns.exception, dns.rdata, dns.name
...
class SOA(dns.rdata.Rdata):
    ...
    def _cmp(self, other):
        ...
        if v == 0:
            ...
            if v == 0:
                self_ints = struct.pack('!IIIII', self.serial, self.refresh, self.retry, self.expire, self.minimum)
                other_ints = struct.pack('!IIIII', other.serial, other.refresh, other.retry, other.expire, other.minimum)
