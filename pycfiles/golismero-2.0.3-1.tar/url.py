...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/golismero/api/data/vulnerability/suspicious/url.py
# Compiled at: 2014-02-05 05:50:02
...
__all__ = [
 'SuspiciousURL', 'SuspiciousURLPath']
...
class SuspiciousURL(UrlVulnerability):
    ...
    def __init__(self, url, **kwargs):
        ...
        """
        super(SuspiciousURL, self).__init__(url, **kwargs)
...
class SuspiciousURLPath(SuspiciousURL):
    ...
    def __init__(self, url, substring, **kwargs):
        """
        :param url: URL where the vulnerability was found.
        :type url: Url
        ...
        super(SuspiciousURLPath, self).__init__(url, **kwargs)
