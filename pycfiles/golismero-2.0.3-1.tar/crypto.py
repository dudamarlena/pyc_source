...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/golismero/api/crypto.py
...
__all__ = [
 'guess_hash', 'validate_hash', 'calculate_shannon_entropy']
...
HASH_SIGNATURES = {'ADLER32': (
             8, True, False, False, None, None, None), 
   'CRC16': (
           4, True, False, None, None, None, None), 
   'CRC32': (
           8, True, False, False, None, None, None), 
   'DESUnix': (
             13, None, False, False, None, None, None), 
   'DomainCachedCredentials': (
                             32, True, False, False, None, None, None), 
   'FCS16': (
           4, True, False, False, None, None, None), 
   'GHash323': (
              8, True, False, True, None, None, None), 
   'GHash325': (
              8, True, False, True, None, None, None), 
   'GOSTR341194': (
                 64, True, False, False, None, None, None), 
   'Haval128': (
              32, True, False, False, None, None, None), 
   'Haval160': (
              40, True, False, False, None, None, None), 
   'Haval192': (
              48, True, False, False, None, None, None), 
   'Haval224': (
              56, True, False, False, None, None, None), 
   'Haval256': (
              64, True, False, False, None, None, None), 
   'LineageIIC4': (
                 34, True, False, False, None, None, (0, 2, '0x')), 
   'MD2': (
         32, True, False, False, None, None, None), 
   'MD4': (
         32, True, False, False, None, None, None), 
   'MD5': (
         32, True, False, False, None, None, None), 
   'MD5APR': (
            37, None, False, False, None, None, (0, 4, '$apr')), 
   'MD5Half': (
             16, True, False, False, None, None, None), 
   'MD5Unix': (
             34, False, False, False, None, None, (0, 3, '$1$')), 
   'MD5Wordpress': (
                  34, False, False, False, None, None, (0, 3, '$P$')), 
   'MD5passsaltjoomla1': (
                        49, False, False, False, None, None, (32, 33, ':')), 
   'MD5passsaltjoomla2': (
                        65, False, False, False, None, None, (32, 33, ':')), 
   'MD5phpBB3': (
               34, False, False, False, None, None, (0, 3, '$H$')), 
   'MySQL': (
           16, True, False, False, None, None, None), 
   'MySQL160bit': (
                 41, False, False, False, None, None, (0, 1, '*')), 
   'MySQL5': (
            40, True, False, False, None, None, None), 
   'NTLM': (
          32, True, False, False, None, None, None), 
   ...
   'RipeMD256': (
               64, True, False, False, None, None, None), 
   'RipeMD320': (
               80, True, False, False, None, None, None), 
   'SAM': (
         65, False, False, False, False, None, (32, 33, ':')), 
   'SHA1': (
          40, True, False, False, None, None, None), 
   'SHA1Django': (
                52, False, False, False, None, None, (0, 5, 'sha1$')), 
   'SHA1MaNGOS': (
                40, True, False, False, None, None, None), 
   'SHA1MaNGOS2': (
                 40, True, False, False, None, None, None), 
   ...
   'SHA256': (
            64, True, False, False, None, None, None), 
   'SHA256Django': (
                  78, False, False, False, None, None, (0, 6, 'sha256')), 
   'SHA256s': (
             98, False, False, False, None, None, (0, 3, '$6$')), 
   'SHA384': (
            96, True, False, False, None, None, None), 
   'SHA384Django': (
                  110, False, False, False, None, None, (0, 6, 'sha384')), 
   'SHA512': (
            128, True, False, False, None, None, None), 
   'SNEFRU128': (
               32, True, False, False, None, None, None), 
   'SNEFRU256': (
               64, True, False, False, None, None, None), 
