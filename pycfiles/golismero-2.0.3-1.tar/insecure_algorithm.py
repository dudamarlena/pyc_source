...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/golismero/api/data/vulnerability/ssl/insecure_algorithm.py
# Compiled at: 2014-02-05 05:58:00
        ...
        if isinstance(algorithms, basestring):
            ...
            for x in algorithms:
                if not isinstance(x, basestring):
                    raise TypeError('Expected string, got %r instead' % type(x))
