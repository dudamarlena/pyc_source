...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/geopy/geocoders/googlev3.py
...
class GoogleV3(Geocoder):
    ...
    def __init__(self, domain='maps.googleapis.com', protocol='http', client_id=None, secret_key=None):
    ...
    def get_signed_url(self, params):
        ...
        return '%(protocol)s://%(domain)s%(url_part)s&signature=%(signature)s' % url_params
    ...
    def geocode(self, string, bounds=None, region=None, language=None, sensor=False, exactly_one=True):
        """Geocode an address.
...
def check_status(status):
    ...
    if status == 'ZERO_RESULTS':
        raise GQueryError('The geocode was successful but returned no results. This may occur if the geocode was passed a non-existent address or a latlng in a remote location.')
        ...
        raise GQueryError('Your request was denied, probably because of lack of a sensor parameter.')
