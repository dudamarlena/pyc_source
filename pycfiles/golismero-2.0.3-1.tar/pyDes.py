...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/thirdparty/pydes/pyDes.py
...
class des(_baseDes):
    ...
    def __String_to_BitList(self, data):
        ...
        pos = 0
        for ch in data:
            result[pos + 0] = ch & 128 != 0
            result[pos + 1] = ch & 64 != 0
            result[pos + 2] = ch & 32 != 0
            result[pos + 3] = ch & 16 != 0
            result[pos + 4] = ch & 8 != 0
            result[pos + 5] = ch & 4 != 0
            result[pos + 6] = ch & 2 != 0
            result[pos + 7] = ch & 1 != 0
