...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/core/bigarray.py
...
class BigArray(list):
    ...
    def index(self, value):
        ...
        return (
         ValueError, '%s is not in list' % value)
    ...
    def __len__(self):
        ...
        return (len(self.chunks) - 1) * BIGARRAY_CHUNK_LENGTH + len(self.chunks[(-1)])
