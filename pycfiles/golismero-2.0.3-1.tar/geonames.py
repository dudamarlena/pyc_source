...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/geopy/geocoders/geonames.py
...
class GeoNames(Geocoder):
    ...
    def __init__(self, format_string=None, output_format=None, country_bias=None):
        if format_string != None:
            ...
            warn('geopy.geocoders.geonames.GeoNames: The `format_string` parameter is deprecated.' + ' (It has always been ignored for GeoNames.)', DeprecationWarning)
        if output_format != None:
            from warnings import warn
            warn('geopy.geocoders.geonames.GeoNames: The `output_format` parameter is deprecated ' + 'and now ignored.', DeprecationWarning)
    ...
    def parse_json(self, page, exactly_one):
        ...
        if not places:
            ...
            if exactly_one and len(places) != 1:
                raise ValueError("Didn't find exactly one code! (Found %d.)" % len(places))
