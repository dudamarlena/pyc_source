...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/utils/pivotdumptable.py
...
def pivotDumpTable(table, colList, count=None, blind=True):
    ...
    if count == 0:
        ...
        if conf.pivotColumn:
            if any(re.search('(.+\\.)?%s' % conf.pivotColumn, _, re.I) for _ in colList):
