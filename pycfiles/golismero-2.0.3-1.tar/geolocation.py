...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/golismero/api/data/information/geolocation.py
...
class Geolocation(Fingerprint):
    ...
    def __init__(self, latitude, longitude, country_code=None, country_name=None, region_code=None, region_name=None, city=None, zipcode=None, metro_code=None, areacode=None, street_addr=None, accuracy=None):
        """
        ...
        if accuracy is not None:
            try:
                ...
                raise TypeError('Expected float, got %r instead' % type(accuracy))

            if accuracy < 0.0:
                raise ValueError('Accuracy cannot be a negative distance: %r' % accuracy)
    ...
    def __repr__(self):
        return '<%s latitude=%f, longitude=%f, country_code=%r, country_name=%r, region_code=%r, region_name=%r, city=%r, zipcode=%r, metro_code=%r, areacode=%r, street_addr=%r, accuracy=%s>' % (
