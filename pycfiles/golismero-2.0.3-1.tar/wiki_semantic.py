...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/geopy/geocoders/wiki_semantic.py
...
try:
    ...
    util.logger.warn('BeautifulSoup was not found. The SemanticMediaWiki geocoder will not work.')
...
class SemanticMediaWiki(Geocoder):
    ...
    def __init__(self, format_url, attributes=None, relations=None, prefer_semantic=False, transform_string=None):
