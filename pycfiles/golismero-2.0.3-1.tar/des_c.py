...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/requests_ntlm/ntlm/des_c.py
...
def D_ENCRYPT(tup, u, t, s):
    ...
    t = R ^ s[(S + 1)]
    t = (t >> 4) + (t << 28)
    L = L ^ (des_SPtrans[1][int(t & U32(63))] | des_SPtrans[3][int(t >> 8 & U32(63))] | des_SPtrans[5][int(t >> 16 & U32(63))] | des_SPtrans[7][int(t >> 24 & U32(63))] | des_SPtrans[0][int(u & U32(63))] | des_SPtrans[2][int(u >> 8 & U32(63))] | des_SPtrans[4][int(u >> 16 & U32(63))] | des_SPtrans[6][int(u >> 24 & U32(63))])
    return (
     (
      L, R, S), u, t, s)
...
def des_set_key(key):
    ...
    d, c, t = PERM_OP((d, c, t), 1, U32(1431655765))
    d = (d & U32(255)) << 16 | d & U32(65280) | (d & U32(16711680)) >> 16 | (c & U32(4026531840)) >> 4
    c = c & U32(268435455)
    for i in range(16):
        if shifts2[i]:
            c = c >> 2 | c << 26
        ...
        c = c & U32(268435455)
        d = d & U32(268435455)
        s = des_skb[0][int(c & U32(63))] | des_skb[1][int(c >> 6 & U32(3) | c >> 7 & U32(60))] | des_skb[2][int(c >> 13 & U32(15) | c >> 14 & U32(48))] | des_skb[3][int(c >> 20 & U32(1) | c >> 21 & U32(6) | c >> 22 & U32(56))]
        t = des_skb[4][int(d & U32(63))] | des_skb[5][int(d >> 7 & U32(3) | d >> 8 & U32(60))] | des_skb[6][int(d >> 15 & U32(63))] | des_skb[7][int(d >> 21 & U32(15) | d >> 22 & U32(48))]
