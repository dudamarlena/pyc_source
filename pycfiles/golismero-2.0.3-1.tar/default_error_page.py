...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/plugins/testing/recon/default_error_page.py
# Compiled at: 2014-01-14 19:01:45
...
class DefaultErrorPagePlugin(TestingPlugin):
    ...
    def recv_info(self, info):
        ...
        for step, (server_name, server_page) in enumerate(signatures.iteritems()):
            ...
            Logger.log(level)
            if level > 0.55:
                vulnerability = DefaultErrorPage(url, server_name, title="Default error page for server '%s'" % server_name)
