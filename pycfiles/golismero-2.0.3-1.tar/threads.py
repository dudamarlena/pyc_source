...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/core/threads.py
# Compiled at: 2013-12-09 06:41:17
"""
Copyright (c) 2006-2013 sqlmap developers (http://sqlmap.org/)
See the file 'doc/COPYING' for copying permission
"""
import difflib, threading, time, traceback
...
def runThreads(numThreads, threadFunction, cleanupFunction=None, forwardException=True, threadChoice=False, startThreadMsg=True):
    ...
    try:
        try:
            ...
            if forwardException:
                raise
        except (SqlmapConnectionException, SqlmapValueException) as errMsg:
            print
            kb.threadException = True
            logger.error('thread %s: %s' % (threading.currentThread().getName(), errMsg))
        except:
