...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/dns/tsig.py
# Compiled at: 2013-08-26 10:52:44
"""DNS TSIG support."""
import hmac, struct, sys, dns.exception, dns.hash, dns.rdataclass, dns.name
...
def sign(wire, keyname, secret, time, fudge, original_id, error, other_data, request_mac, ctx=None, multi=False, first=True, algorithm=default_algorithm):
    ...
    long_time = time + 0
    upper_time = long_time >> 32 & 65535
    lower_time = long_time & 4294967295
...
def get_algorithm(algorithm):
    ...
    if sys.hexversion < 33882624 and (algorithm == HMAC_SHA384 or algorithm == HMAC_SHA512):
        raise NotImplementedError('TSIG algorithm ' + str(algorithm) + ' requires Python 2.5.2 or later')
    try:
        return (
         algorithm.to_digestable(), _hashes[algorithm])
    except KeyError:
