...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/yaml/representer.py
# Compiled at: 2013-08-26 10:52:44
__all__ = ['BaseRepresenter', 'SafeRepresenter', 'Representer',
 'RepresenterError']
from error import *
from nodes import *
import datetime, sys, copy_reg, types
...
class SafeRepresenter(BaseRepresenter):
    ...
    def represent_int(self, data):
        return self.represent_scalar('tag:yaml.org,2002:int', unicode(data))
