...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/theHarvester/discovery/DNS/Lib.py
...
"""
import string, types, Type, Class, Opcode, Status
...
class Qunpacker(Unpacker):
    ...
    def getQuestion(self):
        return (
         self.getname(), self.get16bit(), self.get16bit())
