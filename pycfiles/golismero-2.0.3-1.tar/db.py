...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/golismero/api/data/db.py
...
class Database(Singleton):
    ...
    def add(data):
        ...
        :rtype: bool
        """
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_ADD, data)
    ...
    def async_add(data):
        ...
        :type data: Data
        """
        Config._context.async_remote_call(MessageCode.MSG_RPC_DATA_ADD, data)
    ...
    def async_add_many(dataset):
        ...
        """
        Config._context.async_remote_call(MessageCode.MSG_RPC_DATA_ADD_MANY, dataset)
    ...
    def remove(identity, data_type=None):
        ...
        :rtype: bool
        """
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_REMOVE, identity, data_type)
    ...
    def async_remove(identity, data_type=None):
        ...
        :type data_type: int
        """
        Config._context.async_remote_call(MessageCode.MSG_RPC_DATA_REMOVE, identity, data_type)
    ...
    def async_remove_many(identities, data_type=None):
        ...
        :type data_type: int
        """
        Config._context.async_remote_call(MessageCode.MSG_RPC_DATA_REMOVE_MANY, identities, data_type)
    ...
    def has_key(identity, data_type=None):
        ...
        :rtype: bool
        """
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_CHECK, identity, data_type)
    ...
    def get(identity, data_type=None):
        ...
        :rtype: Data | None
        """
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_GET, identity, data_type)
    ...
    def get_many(identities, data_type=None):
        ...
        :rtype: list(Data)
        """
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_GET_MANY, identities, data_type)
    ...
    def keys(data_type=None, data_subtype=None):
        ...
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_KEYS, data_type, data_subtype)
    ...
    def count(data_type=None, data_subtype=None):
        ...
        if data_type is None:
            if data_subtype is not None:
                raise NotImplementedError("Can't filter by subtype for all types")
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_COUNT, data_type, data_subtype)
    ...
    def get_plugin_history(identity):
        ...
        :rtype: set(str)
        """
        return Config._context.remote_call(MessageCode.MSG_RPC_DATA_PLUGINS, identity)
