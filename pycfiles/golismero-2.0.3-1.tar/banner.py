...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/parse/banner.py
    ...
    def endElement(self, name):
        if name == 'signature':
            for version in (self._version, self._versionAlt):
                if version and re.search(' %s[\\.\\ ]+' % version, self._banner):
            ...
            match = re.search('\\A(?P<major>\\d+)\\.00\\.(?P<build>\\d+)\\Z', self._version)
