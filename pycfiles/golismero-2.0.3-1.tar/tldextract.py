...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/tldextract/tldextract.py
...
class TLDExtract(object):
    ...
    def __init__(self, fetch=True, cache_file=''):
        ...
        """
        self.fetch = fetch
        self.cache_file = os.path.expanduser(cache_file or os.environ.get('TLDEXTRACT_CACHE', os.path.join(os.path.dirname(__file__), '.tld_set')))
...
def main():
    ...
    parser = argparse.ArgumentParser(version='%(prog)s ' + distribution.version, description='Parse hostname from a url or fqdn')
