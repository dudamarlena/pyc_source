...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/golismero/api/data/vulnerability/vuln_utils.py
...
TAXONOMY_NAMES = {'bid': 'Bugtraq', 
   ...
   'xf': 'ISS X-Force'}
_vuln_id_regex = {'bid': [
         re.compile('\\b(?:BID\\-|BID\\: ?|BUGTRAQ\\-|BUGTRAQ\\: ?|BUGTRAQ ID: ?)([0-9]+)\\b')], 
   'ca': [
        re.compile('\\bCA\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9])\\b')], 
   'capec': [
           re.compile('\\bCAPEC(?:\\-|\\: ?)([0-9]+)\\b')], 
   'cisco': [
           re.compile('\\bcisco\\-(sa\\-[0-9]+\\-[a-z]+)\\b')], 
   'cve': [
         re.compile('\\bCVE\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9][0-9]?)\\b')], 
   'cwe': [
         re.compile('\\bCWE(?:\\-|\\: ?)([0-9]+)\\b')], 
   'dsa': [
         re.compile('\\bDSA\\-[0-9][0-9][0-9][0-9]?\\b')], 
   'edb': [
         re.compile('\\bEDB\\-ID\\: ?([0-9]+)\\b'),
         re.compile('\\bEDB(?:\\-|\\: ?)([0-9]+)\\b')], 
   'glsa': [
          re.compile('\\b(?:GLSA|glsa)(?:\\-|\\: ?)([0-9]+\\-[0-9]+)\\b')], 
   'mdvsa': [
           re.compile('\\bMDVSA\\-([0-9][0-9][0-9][0-9]\\:[0-9][0-9][0-9][0-9]?)\\b')], 
   'ms': [
        re.compile('\\bMS([0-9][0-9]\\-[0-9][0-9][0-9])\\b')], 
   'mskb': [
          re.compile('\\b(?:MS)?KB(?:\\-|\\: ?)([0-9]+)\\b')], 
   'nessus': [
            re.compile('\\bNESSUS(?:\\-|\\: ?)([0-9]+)\\b')], 
   'osvdb': [
           re.compile('\\b(?:OSVDB\\-|OSVDB\\: ?|OSVDB ID\\: ?)([0-9]+)\\b')], 
   'rhsa': [
          re.compile('\\bRHSA(?: |\\-|\\: ?)([0-9][0-9][0-9][0-9][\\-\\:][0-9][0-9][0-9][0-9]?)\\b')], 
   'sa': [
        re.compile('\\b(?:SECUNIA|SA)(?:\\-|\\: ?)([0-9]+)\\b'),
        re.compile('\\bSA([0-9]+)\\b')], 
   'sectrack': [
              re.compile('\\b(?:SECTRACK\\-|SECTRACK\\: ?|SECTRACK ID\\: ?)([0-9]+)\\b')], 
   'usn': [
         re.compile('\\bUSN(?:\\-|\\: ?)([0-9]+\\-[0-9]+)\\b')], 
   'vmsa': [
          re.compile('\\bVMSA\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9])\\b')], 
   'vu': [
        re.compile('\\bVU[\\#\\-]([0-9]+)\\b')], 
   'xf': [
        re.compile('\\bXF\\: ?[a-z0-9\\-]* ?\\(([0-9]+)\\)(?:[^\\w]|$)'),
        re.compile('\\bXF\\-([0-9]+)\\b')]}
_vuln_ref_regex = {'bid': [
         re.compile('^https?\\:\\/\\/(?:www\\.)?securityfocus\\.com\\/bid\\/([0-9]+)$')], 
   'ca': [
        re.compile('^https?\\:\\/\\/(?:www\\.)?cert\\.org\\/advisories\\/CA\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9])\\.html$')], 
   'capec': [
           re.compile('^https?\\:\\/\\/capec\\.mitre\\.org\\/data\\/definitions\\/([0-9]+)\\.html$'),
           re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/capec\\.php\\?name\\=CAPEC-([0-9]+)$')], 
   'cisco': [
           re.compile('^https?\\:\\/\\/tools\\.cisco\\.com\\/security\\/center\\/content\\/CiscoSecurityAdvisory\\/cisco\\-(sa\\-[^\\?]+)$'),
           re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=cisco\\-(sa\\-[^\\?]+)$')], 
   'cve': [
         re.compile('^https?\\:\\/\\/cve\\.mitre\\.org\\/cgi\\-bin\\/cvename\\.cgi\\?name\\=(?:CVE\\-)?([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9][0-9]?)$'),
         re.compile('^https?\\:\\/\\/nvd\\.nist\\.gov\\/nvd\\.cfm\\?cvename\\=(?:CVE\\-)?([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9][0-9]?)$'),
         re.compile('^https?\\:\\/\\/web\\.nvd\\.nist\\.gov\\/view\\/vuln\\/detail\\?vulnId\\=(?:CVE\\-)?([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9][0-9]?)$'),
         re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=CVE\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9][0-9]?)$')], 
   'cwe': [
         re.compile('^https?\\:\\/\\/cwe\\.mitre\\.org\\/data\\/definitions\\/([0-9]+)\\.html$'),
         re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/cwe\\.php\\?name\\=CWE-([0-9]+)$')], 
   'dsa': [
         re.compile('^https?\\:\\/\\/www\\.debian\\.org\\/security\\/2000\\/(2000[0-9][0-9][0-9][0-9][a-z]?)$'),
         re.compile('^https?\\:\\/\\/www\\.debian\\.org\\/security\\/dsa\\-([0-9][0-9][0-9][0-9]?)$'),
         re.compile('^https?\\:\\/\\/www\\.debian\\.org\\/security\\/20[0-9][0-9]\\/dsa\\-([0-9][0-9][0-9][0-9]?)$'),
         re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=DSA\\-([0-9][0-9][0-9][0-9]?)$')], 
   'edb': [
         re.compile('^https?\\:\\/\\/www\\.exploit\\-db\\.com\\/exploits\\/([0-9]+)/?$')], 
   'glsa': [
          re.compile('^https?\\:\\/\\/security\\.gentoo\\.org\\/glsa\\/glsa\\-([0-9]+\\-[0-9]+)\\.xml$'),
          re.compile('^https?\\:\\/\\/www\\.gentoo\\.org\\/security\\/[a-z]+\\/glsa\\/glsa\\-([0-9]+\\-[0-9]+)\\.xml$'),
          re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=GLSA\\-([0-9]+\\-[0-9]+)$')], 
   'mdvsa': [
           re.compile('^https?\\:\\/\\/www\\.mandriva\\.com\\/security\\/advisories\\?name\\=MDVSA\\-([0-9][0-9][0-9][0-9]\\:[0-9][0-9][0-9][0-9]?)$'),
           re.compile('^https?\\:\\/\\/www\\.mandriva\\.com\\/(?:[a-z][a-z]\\/)?support\\/security\\/advisories\\/advisory\\/MDVSA\\-([0-9][0-9][0-9][0-9]\\:[0-9][0-9][0-9][0-9]?)/?(?:\\?.*)?$'),
           re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=MDVSA\\-([0-9][0-9][0-9][0-9]\\:[0-9][0-9][0-9][0-9]?)$')], 
   'ms': [
        re.compile('^https?\\:\\/\\/technet\\.microsoft\\.com\\/[A-Za-z][A-Za-z]\\-[A-Za-z][A-Za-z]\\/security\\/bulletin\\/[Mm][Ss]([0-9][0-9]\\-[0-9][0-9][0-9])$'),
        re.compile('^https?\\:\\/\\/(?:www\\.)?microsoft\\.com\\/technet\\/security\\/bulletin\\/[Mm][Ss]([0-9][0-9]\\-[0-9][0-9][0-9])\\.(?:asp|mspx)$'),
        re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=MS([0-9][0-9]\\-[0-9][0-9][0-9])$')], 
   'mskb': [
          re.compile('^https?\\:\\/\\/support\\.microsoft\\.com\\/kb\\/([0-9]+)(?:\\/[A-Za-z][A-Za-z]\\-[A-Za-z][A-Za-z])?$'),
          re.compile('^https?\\:\\/\\/support\\.microsoft\\.com\\/default\\.aspx\\?scid\\=kb\\;[A-Z][A-Z]\\-[A-Z][A-Z]\\;([0-9]+)$'),
          re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=KB([0-9]+)$')], 
   'nessus': [
            re.compile('^https?\\:\\/\\/(?:www\\.)?tenable.com\\/plugins\\/index\\.php\\?id\\=([0-9]+)\\&view\\=single$'),
            re.compile('^https?\\:\\/\\/(?:www\\.)?tenable.com\\/plugins\\/index\\.php\\?view\\=single\\&id\\=([0-9]+)$')], 
   'osvdb': [
           re.compile('^https?\\:\\/\\/(?:www\\.)?osvdb\\.org\\/show\\/osvdb\\/([0-9]+)$')], 
   'rhsa': [
          re.compile('^https?\\:\\/\\/rhn\\.redhat\\.com\\/errata\\/RHSA\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9]?).html$'),
          re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=RHSA\\-([0-9][0-9][0-9][0-9]\\:[0-9][0-9][0-9][0-9]?)$')], 
   'sa': [
        re.compile('^https?\\:\\/\\/(?:www\\.)?secunia\\.com\\/advisories\\/([0-9]+)$')], 
   'sectrack': [
              re.compile('^https?\\:\\/\\/(?:www\\.)?securitytracker\\.com\\/id(?:\\?|\\/)([0-9]+)$'),
              re.compile('^https?\\:\\/\\/(?:www\\.)?securitytracker\\.com\\/alerts\\/[0-9]+\\/[A-Za-z]+\\/([0-9]+)\\.html$')], 
   'vmsa': [
          re.compile('^https?\\:\\/\\/www\\.vmware\\.com\\/security\\/advisories\\/VMSA\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9])\\.html$'),
          re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=VMSA\\-([0-9][0-9][0-9][0-9]\\-[0-9][0-9][0-9][0-9])$')], 
   'vu': [
        re.compile('^https?\\:\\/\\/(?:www\\.)?kb\\.cert\\.org\\/vuls\\/id\\/([0-9]+)$'),
        re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=VU([0-9]+)$')], 
   'usn': [
         re.compile('^https?\\:\\/\\/www\\.ubuntu\\.com\\/usn\\/USN\\-([0-9]+\\-[0-9]+)/?$'),
         re.compile('^https?\\:\\/\\/www\\.security\\-database\\.com\\/(?:detail|cvss)\\.php\\?alert\\=USN\\-([0-9]+\\-[0-9]+)$')], 
   'xf': [
        re.compile('^https?\\:\\/\\/xforce\\.iss\\.net\\/xforce\\/xfdb\\/([0-9]+)$')]}
_vuln_ref_tpl = {'bid': 'http://www.securityfocus.com/bid/%s', 
   'ca': 'https://www.cert.org/advisories/CA-%s.html', 
   'capec': 'https://capec.mitre.org/data/definitions/%s.html', 
   'cisco': 'http://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-%s', 
...
_vuln_conversion_dsa = {'001': '20001129', 
   '002': '20001130', 
   '003': '20001201', 
   '004': '20001217', 
   '005': '20001217a', 
...
_vuln_ref_tpl_sdb = {'capec': 'https://www.security-database.com/capec.php?name=CAPEC-%s', 
...
assert set(_vuln_id_regex.iterkeys()) == set(_vuln_ref_regex.iterkeys()) == set(_vuln_ref_tpl.iterkeys())
assert set(_vuln_ref_tpl.iterkeys()).intersection(_vuln_ref_tpl_sdb.iterkeys()) == set(_vuln_ref_tpl_sdb.iterkeys())
...
def extract_vuln_ids(text):
    ...
    for vuln_type, vuln_re_list in _vuln_id_regex.iteritems():
        ...
        if found:
            ...
            if prefix != 'MS':
                prefix += '-'
            d[vuln_type] = sorted(prefix + vuln_id for vuln_id in found)
...
def convert_references_to_vuln_ids(urls):
    ...
    for vuln_type, vuln_re_list in _vuln_ref_regex.iteritems():
        ...
        if found:
            if vuln_type == 'rhsa':
                found = {vuln_id.replace(':', '-') for vuln_id in found}
            elif vuln_type == 'dsa':
                found = {_vuln_conversion_dsa_back.get(vuln_id, vuln_id) for vuln_id in found}
            prefix = vuln_type
            if prefix != 'cisco':
                prefix = prefix.upper()
            if prefix != 'MS':
...
convert_references_to_vuln_ids.__doc__ += extract_vuln_ids.__doc__[extract_vuln_ids.__doc__.rfind(':returns:'):]
...
def cpe22_unquote(s):
    ...
    while i < len(s) - 1:
        ...
        if len(h) > 0 and h[0] == '%':
            ...
            i += 1
            continue
        if len(h) != 2 or h[0] not in '0123456789abcdefABCDEF' or h[1] not in '0123456789abcdefABCDEF':
            r.append(c)
            continue
        r.append('\\')
...
def unparse_cpe23(parsed):
    ...
    :rtype: str
    """
    return 'cpe:2.3:' + (':').join(x.replace(':', '\\:') for x in parsed)
...
class CVSS_Base(object):
    ...
    PARTIAL = 'P'
    SINGLE = 'S'
    AV_SCORE = {LOCAL: 0.395, 
       ADJACENT_NETWORK: 0.646, 
       NETWORK: 1.0}
    AC_SCORE = {HIGH: 0.35, 
       MEDIUM: 0.61, 
       LOW: 0.71}
    Au_SCORE = {MULTIPLE: 0.45, 
       SINGLE: 0.56, 
       NONE: 0.704}
    C_SCORE = {NONE: 0.0, 
       PARTIAL: 0.275, 
    ...
    @property
    def base_score(self):
        return '%.1f' % (self.f_impact * (0.6 * self.impact + 0.4 * self.base_exploitability - 1.5))
...
class CVSS(CVSS_Base):
    """CVSS Calculator."""
    METRICS = CVSS_Base.METRICS + ('E', 'RL', 'RC', 'CDP', 'TD', 'CR', 'IR', 'AR')
    HIGH = CVSS_Base.HIGH
    LOW = CVSS_Base.LOW
    ...
    UNPROVEN = 'U'
    WORKAROUND = 'W'
    E_SCORE = {UNPROVEN: 0.85, 
       PROOF_OF_CONCEPT: 0.9, 
       FUNCTIONAL: 0.95, 
       HIGH: 1.0, 
       NOT_DEFINED: 1.0}
    RL_SCORE = {OFFICIAL_FIX: 0.87, 
       TEMPORARY_FIX: 0.9, 
       WORKAROUND: 0.95, 
       UNAVAILABLE: 1.0, 
       NOT_DEFINED: 1.0}
    RC_SCORE = {UNCONFIRMED: 0.9, 
       UNCORROBORATED: 0.95, 
       CONFIRMED: 1.0, 
       NOT_DEFINED: 1.0}
    CDP_SCORE = {NONE: 0.0, 
    ...
    def temporal_score(self):
        return '%.1f' % (float(self.base_score) * self.E * self.RL * self.RC)

    @property
    def adjusted_impact(self):
        return min(10, 10.41 * (1 - (1 - self.C * self.CR) * (1 - self.I * self.IR) * (1 - self.A * self.AR)))

    @property
    def adjusted_base_score(self):
        return '%.1f' % (self.f_impact * (0.6 * self.adjusted_impact + 0.4 * self.base_exploitability - 1.5))

    @property
    def adjusted_temporal_score(self):
        return '%.1f' % (float(self.adjusted_base_score) * self.E * self.RL * self.RC)

    @property
    def environmental_score(self):
        adjusted_temporal = float(self.adjusted_temporal_score)
        return '%.1f' % ((adjusted_temporal + (10 - adjusted_temporal) * self.CDP) * self.TD)
