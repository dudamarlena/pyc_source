...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/plugins/generic/databases.py
...
class Databases:
    ...
    def getSchema(self):
        ...
        infoMsg += (', ').join([ '%s' % (', ').join('%s%s%s' % (unsafeSQLIdentificatorNaming(db), '..' if Backend.isDbms(DBMS.MSSQL) or Backend.isDbms(DBMS.SYBASE) else '.', unsafeSQLIdentificatorNaming(t)) for t in tbl)
