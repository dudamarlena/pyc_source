...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/plugins/generic/takeover.py
            ...
            if tunnel == 1:
                if Backend.getIdentifiedDbms() in (DBMS.MYSQL, DBMS.PGSQL):
                    ...
                    while True:
                        ...
                        if isinstance(choice, basestring) and choice.isdigit() and int(choice) in (1,
                                                                                                   2):
                            choice = int(choice)
                            break
