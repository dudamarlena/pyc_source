...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/geopy/geocoders/bing.py
...
class Bing(Geocoder):
    ...
    def geocode(self, string, exactly_one=True):
        ...
        params = {'query': self.format_string % string, 'key': self.api_key}
