...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/yaml/parser.py
        ...
        while self.check_token(DirectiveToken):
            ...
            if token.name == 'YAML':
                ...
                if handle in self.tag_handles:
                    raise ParserError(None, None, 'duplicate tag handle %r' % handle.encode('utf-8'), token.start_mark)
            ...
            if tag is not None:
                ...
                if handle is not None:
                    if handle not in self.tag_handles:
                        raise ParserError('while parsing a node', start_mark, 'found undefined tag handle %r' % handle.encode('utf-8'), tag_mark)
