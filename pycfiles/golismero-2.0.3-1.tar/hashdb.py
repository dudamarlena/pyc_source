...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/tools/sqlmap/lib/utils/hashdb.py
...
class HashDB(object):
    ...
    def retrieve(self, key, unserialize=False):
        ...
        if not unserialize:
            ...
            return unserializeObject(retVal)

    def write(self, key, value, serialize=False):
        if key:
            hash_ = HashDB.hashKey(key)
            self._cache_lock.acquire()
            self._write_cache[hash_] = (serialize or getUnicode)(value) if 1 else serializeObject(value)
