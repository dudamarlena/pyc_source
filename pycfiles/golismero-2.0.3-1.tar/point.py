...
# [GCC 8.4.0]
# Embedded file name: /Users/Dani/Documents/Projects/Golismero_2.0/src_github/thirdparty_libs/geopy/point.py
...
class Point(object):
    ...
    """
    UTIL_PATTERNS = dict(FLOAT='\\d+(?:\\.\\d+)?', DEGREE=format.DEGREE, PRIME=format.PRIME, DOUBLE_PRIME=format.DOUBLE_PRIME, SEP='\\s*[,;\\s]\\s*')
    ...
    def __getitem__(self, index):
        return (
         self.latitude, self.longitude, self.altitude)[index]
    ...
    def __unicode__(self):
        return self.format(None, format.DEGREE, format.PRIME, format.DOUBLE_PRIME)
    ...
    def from_string(cls, string):
        ...
        if match:
            ...
            longitude = cls.parse_degrees(match.group('longitude_degrees'), match.group('longitude_arcminutes'), match.group('longitude_arcseconds'), match.group('longitude_direction'))
