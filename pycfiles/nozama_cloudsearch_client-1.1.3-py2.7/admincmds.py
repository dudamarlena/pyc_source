...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nozama/cloudsearch/client/admintool/admincmds.py
# Compiled at: 2013-12-03 06:00:21
"""
"""
import os, logging, ConfigParser, cmdln, requests
...
class AdminCmds(cmdln.Cmdln):
    ...
    def get_optparser(self):
        ...
        optparser.add_option('-c', '--config', action='store', dest='config_filename', default='admin.ini', help='The global config file %default')
        return optparser
    ...
    def config(self):
        ...
        if os.path.isfile(cfg_filename):
            ...
            self.log.warn('confg: file not found <%s> using defaults.' % cfg_filename)
        if 'url' not in rc:
