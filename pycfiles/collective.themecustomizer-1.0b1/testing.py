...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/collective/themecustomizer/src/collective/themecustomizer/testing.py
...
INTEGRATION_TESTING = IntegrationTesting(bases=(
 FIXTURE,), name='collective.themecustomizer:Integration')
FUNCTIONAL_TESTING = FunctionalTesting(bases=(
 FIXTURE,), name='collective.themecustomizer:Functional')
ROBOT_TESTING = FunctionalTesting(bases=(
 FIXTURE, AUTOLOGIN_LIBRARY_FIXTURE, z2.ZSERVER_FIXTURE), name='collective.themecustomizer:Robot')