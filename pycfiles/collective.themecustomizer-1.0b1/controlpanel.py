...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/collective/themecustomizer/src/collective/themecustomizer/controlpanel.py
...
class SiteControlPanelAdapter(SchemaAdapterBase):
    ...
    def get_display_pub_date_in_byline(self):
        return getattr(self.context.site_properties, 'displayPublicationDateInByline', False)
