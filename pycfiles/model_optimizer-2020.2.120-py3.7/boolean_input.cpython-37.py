...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/analysis/boolean_input.py
...
class TrainingPhaseAnalysis(AnalyzeAction):
    ...
    def analyze(self, graph: Graph):
        ...
        message = message + 'If this input node is as switch between the training and an inference mode, then you need to freeze this input with value True or False.\nIn order to do this run the Model Optimizer with the command line parameter:\n' + params
