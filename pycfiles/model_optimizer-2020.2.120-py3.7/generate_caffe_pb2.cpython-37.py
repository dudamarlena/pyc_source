...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mo/front/caffe/proto/generate_caffe_pb2.py
...
def get_cli_parser():
    ...
    parser.add_argument('--output', help='Directory where output file are generated', default=(os.path.dirname(os.path.realpath(__file__))))
    return parser
