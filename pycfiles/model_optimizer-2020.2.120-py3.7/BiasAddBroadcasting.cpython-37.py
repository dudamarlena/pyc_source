...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/middle/BiasAddBroadcasting.py
...
class BiasAddInputBroadcasting(MiddleReplacementPattern):
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        unsqueeze_dims_node = Const(graph, {'name':new_add.id + '/Dims',  'value':unsqueeze_dims}).create_node()
