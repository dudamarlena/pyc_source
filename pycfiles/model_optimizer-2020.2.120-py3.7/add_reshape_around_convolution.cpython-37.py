...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/kaldi/add_reshape_around_convolution.py
# Compiled at: 2020-05-01 08:37:19
# Size of source mod 2**32: 3999 bytes
"""
...
class ReplaceConvolutionReshape(FrontReplacementPattern):
    ...
    def run_before(self):
        ...
        return [
         ReplaceConvolutionTranspose]

    def pattern(self):
        return dict(nodes=[('conv', dict(op='Convolution'))], edges=[])
