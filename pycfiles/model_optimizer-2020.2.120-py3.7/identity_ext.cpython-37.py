...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/identity_ext.py
...
class IdentityFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node: Node):
        IdentityOp.update_node_stat(node, {'data_type': tf_dtype_extractor(node.pb.attr['T'].type)})
        return cls.enabled
