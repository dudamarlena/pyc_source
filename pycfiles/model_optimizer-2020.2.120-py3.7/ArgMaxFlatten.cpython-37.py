...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/caffe/ArgMaxFlatten.py
...
class ArgMaxFlatten(FrontReplacementOp):
    ...
    def replace_sub_graph(self, graph: Graph, match: dict):
        ...
        if not argmax_node.has_valid('axis'):
            flatten_node = create_op_node_with_second_input(graph, Reshape, int64_array([0, 1, -1]), dict(name=(argmax_node.name + '/Flatten')))
