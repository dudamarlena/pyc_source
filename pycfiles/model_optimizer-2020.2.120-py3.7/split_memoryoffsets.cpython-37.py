...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/kaldi/split_memoryoffsets.py
...
class SplitMemoryOffsets(FrontReplacementPattern):
    ...
    def replace_pattern(graph: Graph, match: dict):
        ...
        paired_node = MemoryOffset(graph, {'name':offset_node.pair_name,  'splitted':True,  'pair_name':offset_node.id,  't':offset_node.t, 
