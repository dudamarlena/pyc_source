...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/pad_tf_to_pad.py
    ...
    def find_and_replace_pattern(self, graph: Graph):
        for tfpad in graph.get_op_nodes(op='TFPad'):
            ...
            for port_ind in range(2):
                ...
                new_pad.in_port(port_ind + 1).get_connection().insert_node(create_op_with_const_inputs(graph, Squeeze, {1: int64_array([0])}))
