...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mo/front/mxnet/nd_to_params.py
...
def add_pretrained_model(pretrained_params: dict, args: dict, pretrained_model: str, iteration_number: int, input_names: str):
    if input_names:
...
def build_params_file(nd_prefix_name: str='', pretrained_model: str='', input_names: str=''):
    ...
    nd_args = add_pretrained_model(pretrained_params, nd_args, pretrained_model_name, iteration_number, input_names)
