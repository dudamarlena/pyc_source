...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/caffe/eltwise_add_normalize.py
        ...
        for eltwise_node in graph.get_op_nodes(op='EltwiseN', operation='sum') + graph.get_op_nodes(op='Add'):
            if eltwise_node.has_valid('coeff') and len(eltwise_node.coeff):
                ...
                for i in range(len(coeff)):
                    __class__._EltwiseAddNormalize__insert_mul_node_with_coeff(eltwise_node, i, coeff[i])
