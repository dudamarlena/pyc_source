...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/analysis/tf_retinanet.py
...
class TensorFlowRetinaNet(AnalyzeAction):
    ...
    def analyze(self, graph: Graph):
        ...
        if pattern_instance_counter.counter > 0:
            result = dict()
            result['mandatory_parameters'] = {'tensorflow_use_custom_operations_config': 'extensions/front/tf/retinanet.json'}
            ...
            return (
             {'model_type': {'TF_RetinaNet': result}}, message)
        return (None, None)