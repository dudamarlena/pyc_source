...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mo/utils/simple_proto_parser.py
...
class SimpleProtoParser(object):
    ...
    @staticmethod
    def _convert_values_to_correct_datatypes(d):
        """
