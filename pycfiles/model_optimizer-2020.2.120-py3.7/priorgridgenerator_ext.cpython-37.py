...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/onnx/priorgridgenerator_ext.py
...
class ExperimentalDetectronPriorGridGeneratorFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        attrs = dict(h=(onnx_attr(node, 'h', 'i', 0)), w=(onnx_attr(node, 'w', 'i', 0)),
