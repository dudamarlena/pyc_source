...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/middle/DeleteNotExecutable.py
...
class DeleteNotExecutable(MiddleReplacementPattern):
    ...
    def find_and_replace_pattern(self, graph: Graph):
        ...
        for node_name, node_attrs in list(graph.nodes(data=True)):
            if node_attrs['kind'] == 'data' and 'executable' in node_attrs:
                node_attrs['executable'] or [nodes_to_remove.add(op) for op, _ in graph.in_edges(node_name)]
