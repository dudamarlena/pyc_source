...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/ops/activation_ops.py
...
activation_ops = [
 'Sigmoid', 'Tanh', 'ReLU6', 'Exp', 'Elu', 'LogicalNot', 'Floor', 'Ceiling']
...
class LeakyReLU(Op):
    ...
    @staticmethod
    def infer(node: Node):
        return eltwise_infer(node, (lambda x, negative_slope: LeakyReLU.leaky_relu(x, negative_slope)), negative_slope=(node.negative_slope))
