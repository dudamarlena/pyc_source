...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/middle/ReverseV2ToReverseSequence.py
...
class ReverseToReverseSequence(MiddleReplacementPattern):
    ...
    def run_after(self):
        import extensions.middle.PartialInfer as PartialInfer
        return [
         PartialInfer]
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        reverse_sequence = ReverseSequence(graph, {'name':reverse.name + '/ReverseSequence/',  'seq_axis':seq_axis, 
