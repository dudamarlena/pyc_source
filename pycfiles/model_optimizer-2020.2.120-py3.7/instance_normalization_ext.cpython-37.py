...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/onnx/instance_normalization_ext.py
...
class InstanceNormalizationExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        epsilon = onnx_attr(node, 'epsilon', 'f', default=(float(1e-05)))
