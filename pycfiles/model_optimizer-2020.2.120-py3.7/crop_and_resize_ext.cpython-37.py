...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/crop_and_resize_ext.py
...
class CropAndResizeFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        ...
        if method != 'bilinear':
            log.warning('The crop and resize method "{}" for node "{}" is not supported.'.format(method, node.soft_get('name')))
            return False
