...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mo/front/kaldi/extractors/max_pooling_ext.py
...
from mo.front.kaldi.loader.utils import read_token_value, collect_until_whitespace, collect_until_token, read_binary_integer32_token, find_next_tag, read_placeholder
...
class MaxPoolingComponentFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        ...
        mapping_rule = {'window':np.array([1, 1, 1, kernel], dtype=np.int64),  'stride':np.array([1, 1, stride, stride], dtype=np.int64), 
