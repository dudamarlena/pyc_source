...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/FakeQuantWithMinMaxVars_ext.py
...
class FakeQuantWithMinMaxVarsExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        ...
        Op.update_node_stat(node, {'op':'FakeQuantWithMinMaxVars',  'levels':levels,  'narrow_range':narrow_range, 
         'num_bits':num_bits})
        return cls.enabled