...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/GNMT_DynamicSequenceLengths.py
...
class GNMT_sequence_lengths(FrontReplacementPattern):
    ...
    def replace_pattern(graph: Graph, match: dict):
        ...
        encoder_sequence_lengths = looking_for_op_in_list([port.node for port in input_sequence_lengths.out_port(0).get_destinations()], 'Identity')
        check_seq_len = looking_for_op_in_list([port.node for port in encoder_sequence_lengths.out_port(0).get_destinations()], 'Identity')
