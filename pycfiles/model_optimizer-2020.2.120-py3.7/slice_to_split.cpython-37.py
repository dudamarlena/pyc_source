...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/caffe/slice_to_split.py
...
class SliceToVariadicSplit(FrontReplacementOp):
    ...
    def replace_sub_graph(self, graph: Graph, match: dict):
        ...
        if slice_point.size == 0:
            ...
            split_node = create_op_with_const_inputs(graph, op=Split, port_value_dict={1: axis},
              op_attrs={'name':name, 
            ...
            split_node = create_op_with_const_inputs(graph, op=VariadicSplit, port_value_dict={1:axis, 
