...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/middle/UnsqueezeTileReshapeBlockToInterpolate.py
...
import extensions.middle.InterpolateSequenceToInterpolate as InterpolateSequenceToInterpolate
...
class UnsqueezeTileReshapeBlockToInterpolate(MiddleReplacementPattern):
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        if not second_input_of_unsqueeze.has_valid('value'):
            ...
            return second_input_of_tile.has_valid('value') or None
        ...
        strided_slice_node = StridedSlice(graph, {'name':unsqueeze_name + '/StridedSlice_', 
        ...
        interp_node = Interpolate(graph, dict(name=(unsqueeze_name + '/Interpolate_'), axes=(int64_array([axis])),
