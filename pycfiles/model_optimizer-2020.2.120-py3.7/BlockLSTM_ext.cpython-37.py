...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/BlockLSTM_ext.py
...
"""
import extensions.ops.BlockLSTM as BlockLSTM
...
class BlockLSTMExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        attrs = {'use_peephole':node.pb.attr['use_peephole'].b, 
