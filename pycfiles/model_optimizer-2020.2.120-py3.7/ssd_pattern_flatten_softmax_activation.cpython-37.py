...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/mxnet/ssd_pattern_flatten_softmax_activation.py
...
class SsdPatternFlattenSoftmaxActivation(FrontReplacementSubgraph):
    ...
    def run_before(self):
        return [
         SsdPatternRemoveFlatten, SsdPatternRemoveReshape]
    ...
    def replace_sub_graph(self, graph: Graph, match: dict):
        ...
        new_reshape_node = create_op_node_with_second_input(graph, Reshape, int64_array([0, -1]), dict(op='Reshape', name=(multi_box_detection.name + '/Reshape_')), softmax_activation)
