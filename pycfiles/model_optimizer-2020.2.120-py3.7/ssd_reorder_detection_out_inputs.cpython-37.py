...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/mxnet/ssd_reorder_detection_out_inputs.py
...
class SsdReorderDetectionOutInputs(FrontReplacementPattern):
    ...
    def run_before(self):
        return [
         SsdPatternFlattenSoftmaxActivation, SsdPatternRemoveTranspose]
