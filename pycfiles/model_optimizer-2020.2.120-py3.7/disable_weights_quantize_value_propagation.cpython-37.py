...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/disable_weights_quantize_value_propagation.py
...
class DisableQuantizeValuePropagation(FrontReplacementPattern):
    enabled = True
    graph_condition = [
     lambda graph: graph.graph['cmd_params'].keep_quantize_ops_in_IR and graph.graph['cmd_params'].blobs_as_inputs or graph.graph['cmd_params'].generate_experimental_IR_V10]
