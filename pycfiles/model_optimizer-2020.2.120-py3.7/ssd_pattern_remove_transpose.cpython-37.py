...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/mxnet/ssd_pattern_remove_transpose.py
...
class SsdPatternRemoveTranspose(FrontReplacementSubgraph):
    ...
    def run_before(self):
        return [
         SsdPatternFlattenSoftmaxActivation, SsdPatternRemoveFlatten, SsdPatternRemoveReshape]
