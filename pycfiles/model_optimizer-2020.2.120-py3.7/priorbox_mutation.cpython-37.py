...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/back/priorbox_mutation.py
# Compiled at: 2020-05-01 08:37:19
# Size of source mod 2**32: 4636 bytes
"""
...
class PriorboxMutation(BackReplacementPattern):
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        ss_1 = StridedSlice(graph, {'name':node.name + '/ss_1_port',  'begin_mask':np.array([1], dtype=np.int32), 
         'end_mask':np.array([0], dtype=np.int32), 
         'new_axis_mask':np.array([0], dtype=np.int32), 
         'shrink_axis_mask':np.array([0], dtype=np.int32), 
         'ellipsis_mask':np.array([0], dtype=np.int32)}).create_node()
        ...
        ss_0['force_precision_in_ports'] = {1:'int64', 
         2:'int64',  3:'int64'}
