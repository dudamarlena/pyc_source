...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/onnx/proposal_ext.py
...
class ExperimentalDetectronGenerateProposalsSingleImageFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        attrs = dict(min_size=(onnx_attr(node, 'min_size', 'f', 0.0)), nms_threshold=(onnx_attr(node, 'nms_threshold', 'f', 0.7)),
