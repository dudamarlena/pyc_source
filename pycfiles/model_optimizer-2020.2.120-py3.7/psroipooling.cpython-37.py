...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/ops/psroipooling.py
...
class PSROIPoolingOp(Op):
    ...
    def psroipooling_infer(node: Node):
        ...
        node.out_node().shape = shape_for_layout(layout, batch=(shapes[1][get_batch_dim(layout, 4)]),
...
class DeformablePSROIPoolingOp(PSROIPoolingOp):
    ...
    def __init__(self, graph, attrs):
        updated_attrs = {'type':__class__.op, 
         'op':__class__.op, 
