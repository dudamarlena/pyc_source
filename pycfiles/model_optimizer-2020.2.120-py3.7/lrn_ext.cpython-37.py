...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/lrn_ext.py
...
class LRNExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        pb = node.pb
        AttributedLRN.update_node_stat(node, {'alpha':pb.attr['alpha'].f * 2.0 * pb.attr['depth_radius'].i + 1.0, 
         'beta':pb.attr['beta'].f, 
         'bias':pb.attr['bias'].f, 
