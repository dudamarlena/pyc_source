...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/middle/ssd_anchors_to_const.py
...
class SsdAnchorsMiddleReplacer(MiddleReplacementPattern):
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        val_node = Const(graph, {'name':concat_node.name + '/const_',  'value':concat_value}).create_node_with_data()
