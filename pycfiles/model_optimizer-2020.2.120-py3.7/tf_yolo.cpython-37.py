...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/analysis/tf_yolo.py
# Compiled at: 2020-05-01 08:37:19
# Size of source mod 2**32: 5252 bytes
"""
...
YOLO_CONFIGS = {'YOLOV2Full':[
  'extensions/front/tf/yolo_v2.json', 'extensions/front/tf/yolo_v2_voc.json'], 
 'YOLOV3Full':[
  'extensions/front/tf/yolo_v3.json', 'extensions/front/tf/yolo_v3_voc.json'], 
 'YOLOV2Tiny':[
  'extensions/front/tf/yolo_v2_tiny.json', 'extensions/front/tf/yolo_v2_tiny_voc.json'], 
 'YOLOV3Tiny':[
  'extensions/front/tf/yolo_v3_tiny.json', 'extensions/front/tf/yolo_v3_tiny_voc.json']}
    ...
    def analyze(self, graph: Graph):
        ...
        if pattern_instance_counter.counter > 0:
            if pattern_instance_counter.counter == 22:
                ...
                if pattern_instance_counter.counter == 8:
                    flavor = 'YOLOV2Tiny'
        if flavor is not None:
            ...
            return (
             {'model_type': {'YOLO': get_YOLO_params_by_flavor(flavor)}}, message)
        return (None, None)
...
class TensorFlowYOLOV3Analysis(AnalyzeAction):
    ...
    def analyze(self, graph: Graph):
        ...
        if graph_contains_scope(graph, 'detector/yolo-v3') and graph_contains_scope(graph, 'detector/darknet-53'):
            ...
            if graph_contains_scope(graph, 'detector/yolo-v3-tiny'):
                flavor = 'YOLOV3Tiny'
        if flavor is not None:
