...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/back/LSTMCellNormalizer.py
...
class LSTMCellNormalizer(BackReplacementPattern):
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        reshape = create_op_node_with_second_input(graph, Reshape, int64_array([4 * hidden_size, hidden_size + input_size]), {'name': lstm_cell_name + '/Dims'})
