...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/middle/LayoutChangeForConstantShapePaths.py
...
from extensions.middle.InsertLayoutPropagationTransposes import is_output_data_in_correct_layout, InsertLayoutPropagationTranspose
    ...
    def find_and_replace_pattern(self, graph: Graph):
        ...
        for shape in shape_ops:
            ...
            if is_output_data_in_correct_layout(source_port.node, source_port.idx):
                ...
                if rank in (4, 5):
                    ...
                    continue
            gather = create_op_with_const_inputs(graph, op=Gather, port_value_dict={1:index,  2:int64_array(0)}, op_attrs={'name': name + '/GatherNCHWtoNHWC'})
        ...
        for in_port in shape_sub_graph_end_points:
            ...
            if should_insert_gather:
                ...
                continue
            gather = create_op_with_const_inputs(graph, op=Gather, port_value_dict={1:index,  2:int64_array(0)}, op_attrs={'name': name + '/GatherNHWCtoNCHW'})
