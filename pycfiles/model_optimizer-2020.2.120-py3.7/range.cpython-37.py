...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/ops/range.py
...
class Range(Op):
    ...
    def infer(node: Node):
        ...
        if not (start.has_valid('value') and limit.has_valid('value') and delta.has_valid('value')):
