...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/nearest_neighbor_upsampling.py
...
class NearestNeighborUpsampling(FrontReplacementSubgraph):
    ...
    def replace_sub_graph(self, graph: Graph, match: dict):
        ...
        const = Const(graph, {'value': np.array([input_height * height_scale, input_width * width_scale])}).create_node()
