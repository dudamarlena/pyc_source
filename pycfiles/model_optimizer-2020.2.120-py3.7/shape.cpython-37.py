...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mo/utils/shape.py
# Compiled at: 2020-05-01 08:37:22
# Size of source mod 2**32: 8442 bytes
"""
...
def get_range_node_of_idxs(rank: Node, begin: int, end: int, include_begin: bool=True, include_end: bool=False) -> Node:
    """
...
def get_shape_values_by_range_idxs(shape: Node, rank: Node, begin: int, end: int, include_begin: bool=True, include_end: bool=False):
    """
