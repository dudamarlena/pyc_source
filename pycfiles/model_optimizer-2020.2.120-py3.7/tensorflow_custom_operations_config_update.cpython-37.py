...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/tensorflow_custom_operations_config_update.py
...
class TensorflowCustomOperationsConfigUpdate(FrontReplacementPattern):
    ...
    def save_custom_replacement_config_file(descriptions: list, file_name: str):
        ...
        """
        try:
            json.dump([replacement_desc.get_config_file_representation() for replacement_desc in descriptions], (open(file_name, 'w')),
