...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/onnx/mean_variance_normalization_ext.py
...
class MeanVarianceNormalizationExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        ...
        axes = onnx_attr(node, 'axes', 'ints', default=np.array([0, 2, 3], dtype=(np.int64)),
