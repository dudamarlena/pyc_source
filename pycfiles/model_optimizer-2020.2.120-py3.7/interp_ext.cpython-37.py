...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/caffe/interp_ext.py
...
class InterpFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        ...
        update_attrs = {'height':param.height, 
         'width':param.width, 
         'zoom_factor':param.zoom_factor, 
         'shrink_factor':param.shrink_factor}
        mapping_rule = merge_attrs(param, update_attrs)
        mapping_rule.update({'fw':'caffe',  'mode':'linear',  'axes':int64_array([2, 3]),  'pads_begin':param.pad_beg, 
         'pads_end':param.pad_end,  'align_corners':1})
