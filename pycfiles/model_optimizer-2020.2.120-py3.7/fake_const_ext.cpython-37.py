...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/tf/fake_const_ext.py
...
class FakeConstToConst(FrontReplacementOp):
    ...
    def replace_sub_graph(self, graph: Graph, match: dict):
        ...
        extracted_attrs = {'data_type':tf_dtype_extractor(node.pb.attr['dtype'].type), 
