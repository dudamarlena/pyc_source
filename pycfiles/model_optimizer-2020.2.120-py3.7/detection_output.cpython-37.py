...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/onnx/detection_output.py
...
class DetectionOutputFrontExtractor(FrontExtractorOp):
    ...
    def extract(cls, node):
        ...
        code_type_values = {b'CORNER':'caffe.PriorBoxParameter.CORNER', 
        ...
        attrs = {'num_classes':onnx_attr(node, 'num_classes', 'i', default=0), 
