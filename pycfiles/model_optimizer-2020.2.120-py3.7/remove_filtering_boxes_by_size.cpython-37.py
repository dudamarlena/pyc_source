...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extensions/front/onnx/remove_filtering_boxes_by_size.py
...
class RemoveFilteringBoxesBySize(FrontReplacementSubgraph):
    ...
    def run_after(self):
        return [
         AttributedVariadicSplitToVariadicSplit]
    ...
    def replace_sub_graph(self, graph: Graph, match: dict):
        ...
        limit_node = create_op_node_with_second_input(graph, Squeeze, int64_array([0]), {'name': source_node.id + '/batch_0D_value'}, limit_node_1D)
