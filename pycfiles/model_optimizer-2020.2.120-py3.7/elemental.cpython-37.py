...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mo/front/common/partial_infer/elemental.py
...
def copy_value(node):
    if node.in_node().value is None:
        return
    return node.in_node().value.copy()