...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_lib/tools/quantifiers.py
...
def run_kallisto(job, r1_id, r2_id, kallisto_index_url):
    ...
    docker_call(tool='quay.io/ucsc_cgl/kallisto:0.43.1--355c19b1fb6fbb85f7f8293e95fb8a1e9d0da163', work_dir=work_dir, parameters=parameters)
...
def run_rsem(job, bam_id, rsem_ref_url, paired=True):
    ...
    docker_call(tool='quay.io/ucsc_cgl/rsem:1.2.25--d4275175cc8df36967db460b06337a14f40d2f21', parameters=parameters, work_dir=work_dir)
...
def run_rsem_postprocess(job, rsem_gene_id, rsem_isoform_id):
    ...
    command = [
     '-g', 'rsem_genes.results', '-i', 'rsem_isoforms.results']
    docker_call(tool='quay.io/ucsc_cgl/gencode_hugo_mapping:1.0--cb4865d02f9199462e66410f515c4dabbd061e4d', parameters=command, work_dir=work_dir)
