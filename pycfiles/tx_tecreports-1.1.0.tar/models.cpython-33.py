...
# [GCC 8.4.0]
# Embedded file name: /Users/travis/Dropbox/work/texas/tx_tecreports/tx_tecreports/tests/fetcher/models.py
# Compiled at: 2014-01-16 18:38:23
# Size of source mod 2**32: 19891 bytes
import datetime, decimal, os, random, unittest
try:
...
class ContributionTest(unittest.TestCase):
    ...
    def test_amount_is_a_float(self):
        c = models.Contribution('20000101', '20.00', '')
        self.assertEqual(20.0, c.amount)
...
class ParsingReportTestCase(unittest.TestCase):
    ...
    def test_total_receipts(self):
        self.assertEqual(8275.0, self.report.total_receipts)
...
class ReportWithJustSummary(unittest.TestCase):
    ...
    def test_has_total_expenditures(self):
        self.assertEqual(decimal.Decimal('750.00'), self.report.total_expenditures)
...
class FindingReceiptsInReportTestCase(unittest.TestCase):
    ...
    def test_can_find_receipt_by_id(self):
        ...
        self.assertEqual(25.0, receipt.contribution.amount)
...
class BasicFilingListTestCase(unittest.TestCase):
    ...
    def test_find_returns_all_matches(self):
        self.assertEqual(len(self.filing_list), len(self.filing_list.find(filer_name='Wendy R. Davis')))
