...
# [GCC 8.4.0]
# Embedded file name: /Users/justin/Projects/python-socialtext/tests/test_workspaces/test_manager.py
...
def test_create_with_cloned_pages():
    ...
    expected = {'clone_pages_from': clone.name}
    assert_ws_created(expected, clone_pages_from=clone)
    clone = 'marketing'
    expected = {'clone_pages_from': clone}
    assert_ws_created(expected, clone_pages_from=clone)
...
def test_create_with_show_title_below_logo():
    show = True
    expected = {'show_title_below_logo': 1}
...
def test_create_with_show_welcome_message_below_logo():
    show = True
    expected = {'show_welcome_message_below_logo': 1}
