...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/wsgiprofile/middleware.py
# Compiled at: 2008-08-07 07:47:15
"""
Middleware that profiles the request and displays profiling
information at the bottom of each page.
"""
import sys, os, hotshot, hotshot.stats, threading, time, itertools
...
__all__ = [
 'ProfileMiddleware', 'profile_decorator']
...
class ProfileMiddleware:
    ...
    def __init__(self, app, global_conf=None, log_filename='profile.log.tmp', limit=40):
        ...
        self.controllers = {'calls': CallsController(), 'static': StaticController()}
