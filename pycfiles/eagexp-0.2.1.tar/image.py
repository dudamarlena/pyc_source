...
# [GCC 8.4.0]
# Embedded file name: /home/titi/aha/workspace/eagexp/eagexp/image.py
# Compiled at: 2012-12-04 02:33:21
...
def export_image(input, output, timeout=20, palette='white', resolution=150, layers=None, command=None, mirror=False, showgui=False):
    ...
    if mirror:
        ...
        fout = output
    commands = export_command(output=fout, output_type='image', commands=cmds, resolution=resolution)
