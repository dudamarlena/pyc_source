...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python2.7/site-packages/f4py/test_try.py
# Compiled at: 2016-03-06 18:54:34
...
class TestTry(TestCase):
    ...
    def setUp(self):
        ...
        self.handler = lambda e: self.closure(self.check_error(e), self.fallback())
        self.fail_handler = lambda e: self.closure(self.check_error(e), self.fail_fallback())
        self.flat_handler = lambda e: self.closure(self.check_error(e), self.flat_fallback())
        self.flat_fail_handler = lambda e: self.closure(self.check_error(e), self.fail_flat_fallback())
