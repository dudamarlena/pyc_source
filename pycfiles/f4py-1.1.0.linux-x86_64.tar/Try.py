...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python2.7/site-packages/f4py/Try.py
...
class Try(Monad):
    ...
    def as_either(self):
        return either((self._get_result(), self._get_error()))

    def get_error(self):
        return maybe(self._get_error())

    def get_result(self):
        return maybe(self._get_result())
