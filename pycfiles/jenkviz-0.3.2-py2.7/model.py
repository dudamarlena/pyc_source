...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jenkviz/model.py
# Compiled at: 2012-01-31 04:18:26
...
class Build(Base):
    ...
    def __init__(self, url, host, name, build_number, start, duration, status, downstream, base_url, trigger, upstream):
        self.url = url
        self.host = host
        self.name = name
