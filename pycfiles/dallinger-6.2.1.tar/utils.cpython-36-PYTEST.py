...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/Dallinger/Dallinger/dallinger/utils.py
# Compiled at: 2020-04-26 19:37:24
# Size of source mod 2**32: 6782 bytes
from __future__ import unicode_literals
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, functools, io, locale, os, random, shutil, string, subprocess, sys, tempfile
...
class CommandError(Exception):
    __doc__ = 'Something went wrong executing a subprocess command'


class GitError(Exception):
    __doc__ = 'Something went wrong calling a Git command'


class GitClient(object):
    __doc__ = 'Minimal wrapper, mostly for mocking'
    ...
    def files(self):
        ...
        try:
            ...
            result = {item for item in raw.split('\x00') if item if item}
            return result
