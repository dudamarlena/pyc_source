...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/Dallinger/Dallinger/dallinger/config.py
# Compiled at: 2020-04-26 19:37:24
# Size of source mod 2**32: 9782 bytes
from __future__ import unicode_literals
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar
from collections import deque
from contextlib import contextmanager
from six.moves import configparser
import distutils.util, logging, os, six, sys
...
class Configuration(object):
    SUPPORTED_TYPES = {
     six.binary_type, six.text_type, int, float, bool}
        ...
        for key, value in mapping.items():
            ...
            if key not in self.types:
                ...
                if not isinstance(value, expected_type):
                    raise TypeError('Got {value} for {key}, expected {expected_type}'.format(value=(repr(value)),
                      key=key,
    ...
    def register_extra_parameters(self):
        ...
        if extra_parameters is not None:
            if getattr(extra_parameters, 'loaded', None) is None:
                extra_parameters()
