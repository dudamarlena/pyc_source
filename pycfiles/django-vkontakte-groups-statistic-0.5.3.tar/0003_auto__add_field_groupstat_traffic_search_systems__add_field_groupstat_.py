...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0003_auto__add_field_groupstat_traffic_search_systems__add_field_groupstat_.py
# Compiled at: 2013-06-01 15:10:47
import datetime
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_statistic.groupstat': {'Meta': {'ordering': "('group', 'date')", 'unique_together': "(('group', 'date'),)", 'object_name': 'GroupStat', 'db_table': "'vkontakte_groups_groupstat'"}, 'act_members': (
                                                ...
                                                'traffic_applications': (
                                                                       'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_bookmarklets': (
                                                                       'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_external_sites': (
                                                                         'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_groups': (
                                                                 'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_my_groups': (
                                                ...
                                                'traffic_news': (
                                                               'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_search_results': (
                                                                         'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_search_systems': (
                                                                         'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_top': (
                                                              'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                'traffic_users': (
