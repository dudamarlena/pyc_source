...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0009_auto__del_unique_groupstat_date_group__add_unique_groupstat_date_group.py
# Compiled at: 2013-12-19 04:53:56
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique('vkontakte_groups_groupstat', ['date', 'group_id'])
        db.create_unique('vkontakte_groups_groupstat', ['date', 'group_id', 'period'])

    def backwards(self, orm):
        db.delete_unique('vkontakte_groups_groupstat', ['date', 'group_id', 'period'])
        db.create_unique('vkontakte_groups_groupstat', ['date', 'group_id'])
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_statistic.groupstat': {'Meta': {'ordering': "('group', 'period', 'date')", 'unique_together': "(('group', 'date', 'period'),)", 'object_name': 'GroupStat', 'db_table': "'vkontakte_groups_groupstat'"}, 'act_members': (
