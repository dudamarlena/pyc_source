...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0012_auto__add_field_groupstat_sources_links.py
# Compiled at: 2014-09-29 08:02:19
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_groups_groupstat', 'sources_links', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_groups_groupstat', 'sources_links')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_statistic.groupstat': {'Meta': {'unique_together': "(('group', 'date', 'period'),)", 'object_name': 'GroupStat', 'db_table': "'vkontakte_groups_groupstat'"}, 'act_members': (
                                                ...
                                                'widget_users_views': (
                                                                     'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})}, 
       'vkontakte_groups_statistic.groupstatistic': {'Meta': {'unique_together': "(('group', 'date'),)", 'object_name': 'GroupStatistic', 'db_table': "'vkontakte_groups_groupstatistic'"}, 'age_18': (
                                                              'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                     'age_18_21': (
                                                                 'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}), 
                                                     'age_21_24': (
                                                     ...
                                                     'visitors': (
                                                                'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})}, 
       'vkontakte_groups_statistic.groupstatpercentage': {'Meta': {'unique_together': "(('group', 'type', 'value_type'),)", 'object_name': 'GroupStatPercentage', 'db_table': "'vkontakte_groups_groupstatpercentage'"}, 'group': (
