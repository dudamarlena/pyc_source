...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0008_auto__add_field_groupstat_period.py
# Compiled at: 2013-12-19 04:43:02
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_groups_groupstat', 'period', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True), keep_default=False)
        db.create_index('vkontakte_groups_groupstatistic', ['fetched'])

    def backwards(self, orm):
        db.delete_index('vkontakte_groups_groupstatistic', ['fetched'])
        db.delete_column('vkontakte_groups_groupstat', 'period')
