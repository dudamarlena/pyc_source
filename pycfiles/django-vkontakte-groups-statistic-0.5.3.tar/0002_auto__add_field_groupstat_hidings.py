...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0002_auto__add_field_groupstat_hidings.py
# Compiled at: 2013-06-01 14:39:02
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_groups_groupstat', 'hidings', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_groups_groupstat', 'hidings')
