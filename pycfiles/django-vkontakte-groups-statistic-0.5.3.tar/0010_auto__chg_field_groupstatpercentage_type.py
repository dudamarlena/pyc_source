...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0010_auto__chg_field_groupstatpercentage_type.py
# Compiled at: 2014-01-14 23:15:12
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('vkontakte_groups_groupstatpercentage', 'type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        db.alter_column('vkontakte_groups_groupstatpercentage', 'type', self.gf('django.db.models.fields.CharField')(max_length=15))
