...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-statistic/vkontakte_groups_statistic/migrations/0006_auto__add_field_groupstat_sources_audio.py
# Compiled at: 2013-07-11 19:03:30
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_groups_groupstat', 'sources_audio', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('vkontakte_groups_groupstat', 'sources_audio')
