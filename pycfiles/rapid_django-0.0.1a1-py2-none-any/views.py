...
# [GCC 8.4.0]
# Embedded file name: /home/marcos/rapid-django/src/rapid/views.py
# Compiled at: 2015-09-04 15:04:27
...
class ListView(generic.list.ListView):
    ...
    def get(self, request, **kwargs):
        ...
        p = self.Pagination(request, page, self.number_of_edge_pages, self.number_of_middle_pages, self.registers_per_page, total_pages)
        context['pages'] = p
