...
# [GCC 8.4.0]
# Embedded file name: /home/marcos/rapid-django/src/rapid/widgets.py
# Compiled at: 2015-09-18 17:07:19
...
class RapidSelector(widgets.Select):
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        if self.allow_multiple_selected:
            ...
            icon = 'fa-search'
        c = Context({'id': id, 'name': name, 'value': v, 'selected': selected, 'icon': icon, 'select_url': select_url, 'multiple': self.allow_multiple_selected})
        if self.allow_multiple_selected:
