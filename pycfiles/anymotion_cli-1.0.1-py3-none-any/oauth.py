...
# Embedded file name: build/bdist.linux-x86_64/egg/anymeta/api/oauth/oauth.py
# Compiled at: 2011-02-18 11:01:03
...
class OAuthRequest(object):
    ...
    def _get_timestamp_nonce(self):
        return (
         self.get_parameter('oauth_timestamp'),
         self.get_parameter('oauth_nonce'))
