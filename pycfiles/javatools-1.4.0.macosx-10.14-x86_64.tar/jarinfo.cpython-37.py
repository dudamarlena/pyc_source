...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/jarinfo.py
# Compiled at: 2018-12-14 21:30:42
# Size of source mod 2**32: 8852 bytes
"""
...
__all__ = ('JAR_PATTERNS', 'JarInfo', 'main', 'cli', 'add_jarinfo_optgroup', 'cli_jar_classes',
           'cli_jar_manifest_info', 'cli_jar_provides', 'cli_jar_requires', 'cli_jar_zip_info',
           'cli_jarinfo', 'cli_jarinfo_json')
JAR_PATTERNS = ('*.ear', '*.jar', '*.rar', '*.sar', '*.war')
...
def add_jarinfo_optgroup(parser):
    ...
    g.add_argument('--zip', action='store_true', default=False, help='print zip information')
    g.add_argument('--manifest', action='store_true', default=False, help='print manifest information')
    g.add_argument('--jar-classes', action='store_true', default=False, help='print information about contained classes')
    g.add_argument('--jar-provides', dest='jar_provides', action='store_true',
      default=False,
      help='API provides information at the JAR level')
    g.add_argument('--jar-requires', dest='jar_requires', action='store_true',
      default=False,
...
def create_optparser(progname):
    ...
    parser.add_argument('jarfiles', nargs='+', help='JAR files to inspect')
    parser.add_argument('--json', dest='json', action='store_true', help='output in JSON mode')
