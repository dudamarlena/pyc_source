...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/cheetah/change_Removal.py
...
__CHEETAH_src__ = 'javatools/cheetah/change_Removal.tmpl'
...
class change_Removal(change_Change):

    def __init__(self, *args, **KWs):
        (super(change_Removal, self).__init__)(*args, **KWs)
    ...
    _mainCheetahMethod_for_change_Removal = 'writeBody'


if not hasattr(change_Removal, '_initCheetahAttributes'):
    templateAPIClass = getattr(change_Removal, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(change_Removal)
if __name__ == '__main__':
    from Cheetah.TemplateCmdLineIface import CmdLineIface
    CmdLineIface(templateObj=(change_Removal())).run()