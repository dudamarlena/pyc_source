...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/cheetah/change_SquashedChange.py
# Compiled at: 2019-07-05 15:01:15
# Size of source mod 2**32: 6197 bytes
...
class change_SquashedChange(change_Change):
    ...
    _mainCheetahMethod_for_change_SquashedChange = 'respond'


if not hasattr(change_SquashedChange, '_initCheetahAttributes'):
    templateAPIClass = getattr(change_SquashedChange, '_CHEETAH_templateClass', Template)
