...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/cheetah/change_Addition.py
...
__CHEETAH_src__ = 'javatools/cheetah/change_Addition.tmpl'
...
class change_Addition(change_Change):

    def __init__(self, *args, **KWs):
        (super(change_Addition, self).__init__)(*args, **KWs)
    ...
    _mainCheetahMethod_for_change_Addition = 'writeBody'


if not hasattr(change_Addition, '_initCheetahAttributes'):
    templateAPIClass = getattr(change_Addition, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(change_Addition)
if __name__ == '__main__':
    from Cheetah.TemplateCmdLineIface import CmdLineIface
    CmdLineIface(templateObj=(change_Addition())).run()