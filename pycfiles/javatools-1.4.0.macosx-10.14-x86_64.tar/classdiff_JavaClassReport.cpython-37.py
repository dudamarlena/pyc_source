...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/cheetah/classdiff_JavaClassReport.py
...
if not hasattr(classdiff_JavaClassReport, '_initCheetahAttributes'):
    templateAPIClass = getattr(classdiff_JavaClassReport, '_CHEETAH_templateClass', Template)
