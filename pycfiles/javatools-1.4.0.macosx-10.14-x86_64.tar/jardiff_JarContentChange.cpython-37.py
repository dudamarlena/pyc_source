...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/cheetah/jardiff_JarContentChange.py
# Compiled at: 2019-07-05 15:01:15
# Size of source mod 2**32: 5471 bytes
...
__CHEETAH_src__ = 'javatools/cheetah/jardiff_JarContentChange.tmpl'
...
class jardiff_JarContentChange(change_Change):

    def __init__(self, *args, **KWs):
        (super(jardiff_JarContentChange, self).__init__)(*args, **KWs)
    ...
    _mainCheetahMethod_for_jardiff_JarContentChange = 'writeBody'


if not hasattr(jardiff_JarContentChange, '_initCheetahAttributes'):
    templateAPIClass = getattr(jardiff_JarContentChange, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(jardiff_JarContentChange)
if __name__ == '__main__':
    from Cheetah.TemplateCmdLineIface import CmdLineIface
    CmdLineIface(templateObj=(jardiff_JarContentChange())).run()