...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/javatools/distinfo.py
# Compiled at: 2018-12-14 21:30:42
# Size of source mod 2**32: 7870 bytes
"""
...
def add_distinfo_optgroup(parser):
    ...
    g.add_argument('--dist-provides', dest='dist_provides', action='store_true',
      default=False,
      help='API provides information at the distribution level')
    g.add_argument('--dist-requires', dest='dist_requires', action='store_true',
      default=False,
