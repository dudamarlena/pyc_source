...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toster/manager.py
# Compiled at: 2014-08-30 18:08:37
...
class TestManager(object):
    ...
    def get_by_name(self, name):
        return [testcase for fullname, testcase in self.tests.items() if fullname.split(':')[1] == name]

    def get_by_group(self, name):
        return self.groups[name]

    def get_by_module(self, module):
        return [testcase for fullname, testcase in self.tests.items() if fullname.startswith(module)]
