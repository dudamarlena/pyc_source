...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\chirp\gui\BatchStats.py
...
class BatchStats(wx.Frame):
    ...
    def __init__(self, parent=None):
        wx.Frame.__init__(self, parent, title='Pitch Statistics', size=(400, 500), style=wx.MINIMIZE_BOX | wx.CAPTION | wx.CLOSE_BOX | wx.NO_FULL_REPAINT_ON_RESIZE)
    ...
    def create_main_panel(self):
        ...
        txt.SetFont(font)
        vbox.Add(txt, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
        self.outfile = wx.FilePickerCtrl(mainPanel, -1, message='Select output file', wildcard='CSV files (*.csv)|*.csv', style=wx.FLP_SAVE | wx.FLP_OVERWRITE_PROMPT | wx.FLP_USE_TEXTCTRL)
