...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\chirp\gui\TSViewer.py
        ...
        if value == 1 and t1:
            ...
            if prev is not None:
                ...
                if curr[0] > prev[0] and curr[1] < prev[1]:
                    ...
                    xhw = (prev[1] - prev[0]) / 2.0
                    xmid = (curr[1] - curr[0]) / 2.0 + curr[0]
...
def test():
    import numpy as nx, matplotlib.cm as cm
    ...
    class TSViewFrame(wx.Frame):
        ...
        def __init__(self, parent=None):
            super(TSViewFrame, self).__init__(parent, title='TSViewer Test App', size=(1000,
