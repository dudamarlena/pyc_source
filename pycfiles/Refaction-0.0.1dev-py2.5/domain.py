...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/refaction/controllers/domain.py
# Compiled at: 2008-09-18 08:31:55
...
class DomainController(ListController):
    table = model.Domain
    children = dict(subdomain=dict(table=model.Subdomain, columns=[
     'name']))
