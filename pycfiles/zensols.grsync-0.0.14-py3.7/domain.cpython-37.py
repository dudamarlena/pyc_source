...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/grsync/domain.py
...
class SymbolicLink(object):
    __doc__ = 'This classs represents a file system symbolic link.  The class also freezes\n    created symbol links.\n\n    '
...
class FileEntry(object):
    __doc__ = 'Represents a file based entry in the frozen version of the distribution zip.\n\n    '
...
class LinkEntry(FileEntry):
    __doc__ = 'Represents a symbolic link in the frozen version of the distribution zip.\n\n    '

    def __init__(self, dist, finfo, target_dir=None):
...
class RemoteSpec(object):
    __doc__ = 'This class represents a remote for a git repo.\n    '
