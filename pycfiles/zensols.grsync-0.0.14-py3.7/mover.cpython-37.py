...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/grsync/mover.py
        ...
        for src, obj in self._get_paths():
            if not src.exists():
                ...
                if isinstance(obj, FrozenRepo):
                    ...
                    if isinstance(obj, FileEntry) and src.is_dir():
                        if not src.is_symlink():
