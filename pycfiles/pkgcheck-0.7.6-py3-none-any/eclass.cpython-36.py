...
# [GCC 8.4.0]
# Embedded file name: /home/runner/work/pkgcheck/pkgcheck/build/lib/pkgcheck/checks/eclass.py
...
class DeprecatedEclass(results.VersionResult, results.Warning):
    __doc__ = 'Package uses an eclass that is deprecated/abandoned.'
...
class EclassUsageCheck(Check):
    __doc__ = 'Scan packages for various eclass-related issues.'
    known_results = frozenset([DeprecatedEclass, DuplicateEclassInherits])
    blacklist = ImmutableDict({'64-bit':None, 
...
class EclassBashSyntaxError(results.EclassResult, results.Error):
    __doc__ = 'Bash syntax error in the related eclass.'
...
class EclassCheck(Check):
    __doc__ = 'Scan eclasses for various issues.'
