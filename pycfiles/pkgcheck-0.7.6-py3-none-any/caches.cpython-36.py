...
# [GCC 8.4.0]
# Embedded file name: /home/runner/work/pkgcheck/pkgcheck/build/lib/pkgcheck/caches.py
# Compiled at: 2020-02-09 15:46:32
# Size of source mod 2**32: 4095 bytes
"""Base cache support."""
import concurrent.futures, errno, os, pathlib, shutil, threading
...
class Cache:
    __doc__ = 'Mixin for data caches.'
    __getattr__ = klass.GetAttrProxy('_cache')


class _RegisterCache(type):
    __doc__ = 'Metaclass for registering caches.'
...
class CachedAddon(metaclass=_RegisterCache):
    __doc__ = 'Mixin for addon classes that create/use data caches.'
    cache = None
    caches = {}
    ...
    def update_caches(options, addons):
        ...
        with concurrent.futures.ThreadPoolExecutor() as (executor):
            futures = [executor.submit(addon.update_cache, output_lock, force) for addon in addons]
