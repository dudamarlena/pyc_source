...
# [GCC 8.4.0]
# Embedded file name: /home/runner/work/pkgcheck/pkgcheck/build/lib/pkgcheck/feeds.py
...
class QueryCache(Feed):
    ...
    def mangle_argparser(parser):
        ...
        group.add_argument('--reset-caching-per',
          dest='query_caching_freq', choices=('version', 'package', 'category'),
          default='package',
...
class EvaluateDepSet(Feed):
    ...
    def _identify_common_depsets(self, pkg, depset):
        ...
        return [(depset.evaluate_depset((k[1]), tristate_filter=(k[0])), v) for k, v in collapsed.items()]
