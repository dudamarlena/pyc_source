...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/firethorn/config/firethorn_config.py
...
resource_create_name_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.resource.name', 
...
resource_create_url_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.resource.create.url', 
...
resource_create_username_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.connection.identity', 
...
resource_create_password_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.connection.pass', 
...
create_urls = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'/firethorn/jdbc/resource/create', 
...
get_urls = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/adql-service-1.0.json':'/firethorn/adql/resource/', 
...
db_select_by_name_urls = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/adql-service-1.0.json':'/firethorn/adql/resource/select?', 
...
db_select_with_text_urls = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/adql-service-1.0.json':'/firethorn/adql/resource/search?', 
...
resource_uris = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'/schemas/select', 
...
type_update_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.resource.update.name', 
...
db_select_with_text_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.resource.search.text', 
...
db_select_by_name_params = {'http://data.metagrid.co.uk/wfau/firethorn/types/entity/jdbc-resource-1.0.json':'jdbc.resource.name', 
...
types = {'service':'http://data.metagrid.co.uk/wfau/firethorn/types/entity/adql-service-1.0.json', 
