...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/firethorn/core/query_engine.py
...
class Timeout:
    __doc__ = 'Timeout class using ALARM signal.'
...
class QueryEngine(object):
    __doc__ = 'Query engine, used to drive queries through the core Firethorn service \n    '
