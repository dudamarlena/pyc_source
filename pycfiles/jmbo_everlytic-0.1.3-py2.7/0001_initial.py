...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-everlytic/everlytic/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('everlytic_everlyticprofile', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
         (
          'everlytic_id', self.gf('django.db.models.fields.PositiveIntegerField')())))
        db.send_create_signal('everlytic', ['EverlyticProfile'])

    def backwards(self, orm):
        db.delete_table('everlytic_everlyticprofile')
