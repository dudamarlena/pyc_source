...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/foundry/src/jmbo-everlytic/everlytic/migrations/0002_auto__chg_field_everlyticprofile_everlytic_id__add_unique_everlyticpro.py
# Compiled at: 2013-09-27 03:41:46
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'everlytic.everlyticprofile': {'Meta': {'object_name': 'EverlyticProfile'}, 'everlytic_id': (
                                                     'django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'null': 'True'}), 
                                      'id': (
                                           'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                      'user': (
                                             'django.db.models.fields.related.OneToOneField', [], {'to': "orm['foundry.Member']", 'unique': 'True'})}, 
