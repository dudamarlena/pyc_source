...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/authkit/authenticate/forward.py
...
def make_forward_handler(app, auth_conf, app_conf=None, global_conf=None, prefix='authkit.forward'):
    signin_path = None
    if auth_conf.has_key('internalpath'):
        warnings.warn('The %sinternalpath key is deprecated. Please use %ssigninpath.' % (
         prefix, prefix), DeprecationWarning, 2)
