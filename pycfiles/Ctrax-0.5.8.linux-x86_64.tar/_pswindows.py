...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/psutil/_pswindows.py
# Compiled at: 2016-09-17 16:22:08
"""Windows platform implementation."""
import contextlib, errno, functools, os, sys
...
ntpinfo = namedtuple('ntpinfo', ['num_handles', 'ctx_switches', 'user_time', 'kernel_time',
...
class WindowsService(object):
    ...
    def _query_config(self):
        ...
        return dict(display_name=display_name, binpath=binpath, username=username, start_type=start_type)
    ...
    def _wrap_exceptions(self):
        ...
        try:
            ...
            elif err.errno in NO_SUCH_SERVICE_SET or err.winerror in NO_SUCH_SERVICE_SET:
...
class Process(object):
    ...
    if hasattr(cext, 'proc_io_priority_get'):
        ...
        def ionice_set(self, value, _):
            if _:
                raise TypeError('set_proc_ionice() on Windows takes only 1 argument (2 given)')
