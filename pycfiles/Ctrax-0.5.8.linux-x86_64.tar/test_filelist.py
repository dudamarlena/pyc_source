...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/Ctrax/test_filelist.py
# Compiled at: 2013-09-24 00:57:41
import os, shutil, stat, tempfile, time
DO_SHORT_TEST = False
    ...
    def __init__(self, use_datatypes=None):
        ...
        if use_datatypes is None:
            if DO_SHORT_TEST:
                ...
                use_datatypes = [
                 'roach_fmf', 'sample_sbfmf1', 'sample_sbfmf2',
        ...
        sample_sbfmf1_dir = os.path.join('samples-distributed', 'example-sbfmfvideo-ann-mat-5M5F5min-20071009_163231')
        sample_sbfmf1 = ['movie20071009_163231.sbfmf']
        sample_sbfmf2_dir = os.path.join('samples-distributed', 'example-sbfmfvideo-ann-mat-25M25F5min-20071009_164618')
        ...
        for fname, annname, matname in zip(self.files, self.ann_files(), self.mat_files()):
