...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kvndb/router.py
# Compiled at: 2016-11-18 11:21:16
...
class RouterProtocol(IntNStringReceiver):
    ...
    def stringReceived(self, msg):
        ...
        if self.mode == data.MODE_VERSION:
            ...
            elif self.factory.pswd is not None:
            ...
            if msg != self.factory.pswd:
                yield utils.dsleep(self.factory.reactor, data.INVALID_PASSWORD_SLEEP_INTERVAL)
