...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/epitome/iio.py
# Compiled at: 2019-08-13 14:27:18
# Size of source mod 2**32: 2225 bytes
import numpy as np, tensorflow as tf, threading
...
def write_tfrecords(examples, filename, num_shards=100, options=None):
    ...
    for i, example in enumerate(examples):
        t = threading.Thread(target=(writers[(i % num_shards)].write),
          args=(
