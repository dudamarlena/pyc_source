...
# [GCC 8.4.0]
# Embedded file name: /Users/daniel/workarea/preset/Flask-AppBuilder/flask_appbuilder/tests/test_menu.py
...
class FlaskTestCase(FABTestCase):
    ...
    def test_menu_api_limited(self):
        ...
        self.appbuilder.sm.add_permission_role(role, pvm)
        self.appbuilder.sm.add_user(limited_user, 'user1', 'user1', 'user1@fab.org', role, limited_password)
        uri = '/api/v1/menu/'
        client = self.app.test_client()
        ...
        self.appbuilder.get_session.delete(self.appbuilder.sm.find_user(username=limited_user))
