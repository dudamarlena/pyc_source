...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/faamtools/core.py
# Compiled at: 2016-02-08 12:50:46
...
def read_core_nc(fname, flds=None, time2datetime=False, calc_wspd=True, calc_wdir=True):
    ...
    """
    if flds == None:
        flds = dict(time='Time', hgt='HGT_RADR', lon='LON_GPS', lat='LAT_GPS', ang='TRCK_GIN', uturb='U_C', vturb='V_C', wturb='W_C', u='U_NOTURB', v='V_NOTURB', pres='PS_RVSM', temp='TAT_DI_R')
