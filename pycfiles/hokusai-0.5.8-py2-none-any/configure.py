...
# [GCC 8.4.0]
# Embedded file name: /Users/isacpetruzzi/Code/artsy/hokusai/hokusai/commands/configure.py
# Compiled at: 2020-02-20 09:58:21
import os, platform, urllib, shutil, tempfile
...
def configure(kubectl_version, bucket_name, key_name, config_file, install_to, install_config_to):
    ...
    os.chmod(os.path.join(tmpdir, 'kubectl'), 493)
