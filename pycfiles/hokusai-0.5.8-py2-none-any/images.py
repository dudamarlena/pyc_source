...
# [GCC 8.4.0]
# Embedded file name: /Users/isacpetruzzi/Code/artsy/hokusai/hokusai/commands/images.py
...
def images(tag_exists, reverse_sort, limit, filter_tags, digests):
    ...
    print_yellow('%d more images available' % (len(filtered_images) - len(filtered_images[:limit])), newline_before=True, newline_after=True)