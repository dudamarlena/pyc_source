...
# [GCC 8.4.0]
# Embedded file name: /Users/isacpetruzzi/Code/artsy/hokusai/hokusai/commands/kubernetes.py
...
@command()
def k8s_update(context, namespace=None, filename=None, check_branch='master', check_remote=None, skip_checks=False, dry_run=False):
    if filename is None:
        kubernetes_yml = os.path.join(CWD, HOKUSAI_CONFIG_DIR, '%s.yml' % context)
    else:
        kubernetes_yml = filename
