...
# [GCC 8.4.0]
# Embedded file name: /Users/isacpetruzzi/Code/artsy/hokusai/hokusai/commands/setup.py
# Compiled at: 2020-04-09 11:50:23
import os, sys, time, urllib, tempfile
...
def setup(project_name, template_remote, template_dir, template_vars, allow_missing_vars):
    ...
    if scratch_dir and template_dir:
        ...
        required_templates = ['Dockerfile.j2',
         '.dockerignore.j2',
        ...
        template_context = {'project_name': config.project_name, 
