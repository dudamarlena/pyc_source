...
# [GCC 8.4.0]
# Embedded file name: /Users/isacpetruzzi/Code/artsy/hokusai/hokusai/cli/review_app.py
# Compiled at: 2019-10-09 12:07:43
import os, click, hokusai
...
def deploy(app_name, tag, migration, constraint, git_remote, timeout, update_config, verbose):
    ...
    set_verbosity(verbose)
    hokusai.update(KUBE_CONTEXT, tag, migration, constraint, git_remote, timeout, namespace=clean_string(app_name), update_config=update_config, filename=os.path.join(CWD, HOKUSAI_CONFIG_DIR, '%s.yml' % app_name))
