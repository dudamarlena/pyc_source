...
# [GCC 8.4.0]
# Embedded file name: /Users/isacpetruzzi/Code/artsy/hokusai/hokusai/cli/production.py
...
def update(check_branch, check_remote, skip_checks, filename, dry_run, verbose):
    ...
    set_verbosity(verbose)
    hokusai.k8s_update(KUBE_CONTEXT, check_branch=check_branch, check_remote=check_remote, skip_checks=skip_checks, filename=filename, dry_run=dry_run)
