...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/credstuffer/account.py
...
class Account(ABC):
    __doc__ = ' Abstract Base Class Account to provide basic methods for account specific attributes\n\n    '
    ...
    def __init__(self):
        ...
        self.proxy_test_headers = {'Accept-Encoding':'gzip, deflate, br', 
    ...
    def is_proxy_alive(self, proxy):
        ...
        """
        try:
            proxy_test_response = self.proxy_test_session.get((self.proxy_test_url), headers=(self.proxy_test_headers), timeout=(self.proxy_test_timeout),
