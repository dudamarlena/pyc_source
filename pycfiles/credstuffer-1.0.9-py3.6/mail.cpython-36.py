...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/credstuffer/notification/mail.py
# Compiled at: 2020-03-04 14:28:47
# Size of source mod 2**32: 3814 bytes
import ssl, logging, smtplib
from email.message import EmailMessage
from credstuffer.exceptions import MailMessageError

class Mail:
    __doc__ = ' class Mail to provide sending credentials to specific email address\n\n    USAGE:\n            mail = Mail(smtp_server="smtp.web.de", port=587, debug=False)\n            mail.login(username=\'\', password=\'\')\n            mail.send(username, password, receiver)\n    '
