...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDccLib/core/data.py
...
class FileData(Data, object):
    ...
    def get_sub_folder(self):
        ...
        if self.directory:
            path.is_dir(path.join_path(self.directory, '.sub/{}'.format(folder_name))) or self.set_sub_folder('')
            return
        else:
