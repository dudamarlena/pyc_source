...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDccLib/__init__.py
...
import os, sys, inspect, logging.config
...
def init(do_reload=False, dev=False):
    ...
    class tpDccLib(importer.Importer):

        def __init__(self, *args, **kwargs):
            (super(tpDccLib, self).__init__)(args, module_name='tpDccLib', **kwargs)
