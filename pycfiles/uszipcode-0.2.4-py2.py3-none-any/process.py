...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/uszipcode-project/uszipcode/pkg/fuzzywuzzy/process.py
...
def extractWithoutOrder(query, choices, processor=default_processor, scorer=default_scorer, score_cutoff=0):
    ...
    if scorer in [fuzz.WRatio, fuzz.QRatio,
     ...
     fuzz.UWRatio, fuzz.UQRatio] and processor == utils.full_process:
        processor = no_process
