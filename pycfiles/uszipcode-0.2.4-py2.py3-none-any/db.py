...
# Compiled at: 2019-10-16 17:07:19
"""
...
def connect_to_simple_zipcode_db(db_file_dir):
    return engine_creator.create_sqlite(path=get_simple_db_file_path(db_file_dir).abspath)


def connect_to_zipcode_db(db_file_dir):
    return engine_creator.create_sqlite(path=get_db_file_path(db_file_dir).abspath)
