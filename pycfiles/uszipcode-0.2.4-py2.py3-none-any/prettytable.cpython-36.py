...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/uszipcode-project/uszipcode/pkg/sqlalchemy_mate/pkg/prettytable/prettytable.py
# Compiled at: 2018-09-29 23:45:55
# Size of source mod 2**32: 55730 bytes
import copy, math, random, re, textwrap, unicodedata
...
class PrettyTable(object):
    ...
    def get_string(self, **kwargs):
        ...
        lines = []
        if self.rowcount == 0:
            if not options['print_empty'] or not options['border']:
                return ''
    ...
    def _stringify_header(self, options):
        ...
        if options['border']:
            ...
            if options['vrules'] in (ALL, FRAME):
                ...
                bits.append(' ')
            if self._field_names or options['vrules'] in (ALL, FRAME):
                bits.append(options['vertical_char'])
        else:
            bits.append(' ')
        for field, width in zip(self._field_names, self._widths):
