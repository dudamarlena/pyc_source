...
# Embedded file name: build/bdist.macosx-10.3-fat/egg/pycommunity/package.py
# Compiled at: 2007-02-27 03:37:26
__doc__ = ' package doc builder\n'
import os, logging
...
class PackageIndexView(object):
    ...
    def __init__(self, templatefile, folder, options):
        ...
        self._template = Template(open(templatefile).read(), searchList=[
         {'docs': otherdocs, 'main': indexdoc[1], 
            'title': indexdoc[0], 
            'options': options}])
...
class PackageTask(object):
    ...
    def _makeAPIs(self, package, folder):
        ...
        try:
            docindex = build_doc_index(names, True, True, add_submodules=True)
