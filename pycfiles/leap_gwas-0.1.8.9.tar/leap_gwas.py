...
# [GCC 8.4.0]
# Embedded file name: /home/omerw/git/leap/leap/leap_gwas.py
# Compiled at: 2015-02-17 10:43:40
import numpy as np, time, sys, argparse, leapUtils, leapMain, fastlmm.association
...
if __name__ == '__main__':
    ...
    if args.bfile is None:
        raise Exception('bfile must be supplied')
    ...
    if args.h2 is None:
        raise Exception('h2 must be supplied')
