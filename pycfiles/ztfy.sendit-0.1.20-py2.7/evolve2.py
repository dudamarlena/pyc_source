...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/sendit/generations/evolve2.py
# Compiled at: 2017-11-15 04:14:35
import logging
...
def evolve(context):
    ...
    for site in root_folder.values():
        if ISenditApplication(site, None) is not None:
            ...
            catalog = queryUtility(ICatalog, name='Catalog')
            if catalog is not None:
                params = [
                 Eq(('Catalog', 'content_type'), 'IPacket')]
