...
# [GCC 8.4.0]
# Embedded file name: /home/Okada/github/paplot/scripts/paplot/signature.py
...
def convert_tojs(params, config):
    ...
    if sig_num == 0:
        ...
        sub_di = [{'name': 'C > A', 'ref': 'C', 'color': tools.config_getstr(config, 'signature', 'alt_color_CtoA')}, {'name': 'C > G', 'ref': 'C', 'color': tools.config_getstr(config, 'signature', 'alt_color_CtoG')}, {'name': 'C > T', 'ref': 'C', 'color': tools.config_getstr(config, 'signature', 'alt_color_CtoT')}, {'name': 'T > A', 'ref': 'T', 'color': tools.config_getstr(config, 'signature', 'alt_color_TtoA')}, {'name': 'T > C', 'ref': 'T', 'color': tools.config_getstr(config, 'signature', 'alt_color_TtoC')}, {'name': 'T > G', 'ref': 'T', 'color': tools.config_getstr(config, 'signature', 'alt_color_TtoG')}]
        substruction = ''
        for sub in sub_di:
            route = []
            for r in route_list:
