...
# [GCC 8.4.0]
# Embedded file name: c:\cygwin\home\okada\github\paplot\scripts\paplot\convert.py
...
def pyformat_to_jstooltip_text(positions, config, section_fmt, section_col, item_startwith):
    ...
    import re
    re_compile = re.compile('\\{[0-9a-zA-Z\\+\\-\\*\\/\\#\\:\\,\\.\\_\\ ]+\\}')
    re_compile2 = re.compile('[\\+\\-\\*\\/\\:]')
    keys_list = []
    tooltip_fomat_text = ''
