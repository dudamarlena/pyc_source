...
# [GCC 8.4.0]
# Embedded file name: /Users/alireza/Projects/Mac/TelegramBotFramework/project/django_tgbot/management/commands/createtgbot.py
# Compiled at: 2020-02-01 21:18:30
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open(os.path.join(dst, '__init__.py'), 'w') as (f):
            f.write("bot_token = '{}'".format(bot_token))
