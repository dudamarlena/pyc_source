...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mappyfile\cli.py
# Compiled at: 2020-01-11 08:01:06
import sys, os, codecs, glob, logging, mappyfile, click
...
def format(ctx, input_mapfile, output_mapfile, indent, spacer, quote, newlinechar, expand, comments):
    ...
    """
    quote = codecs.decode(quote, 'unicode_escape')
    spacer = codecs.decode(spacer, 'unicode_escape')
    newlinechar = codecs.decode(newlinechar, 'unicode_escape')
