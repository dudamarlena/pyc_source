...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/webstarts/wflask.py
# Compiled at: 2017-07-17 16:20:11
...
class FlaskApp(Flask):
    __doc__ = 'Inherit from this in usage application'
...
class SentryClient(Client):
    __doc__ = 'Subclass for more control over what is sent to sentry'

    def __init__(self, *args, **kwargs):
        kwargs['include_paths'] = {
         'socialclime'}
        (super().__init__)(*args, **kwargs)
...
class RavenMiddleware(middleware.Sentry):
    __doc__ = 'Clear context before request starts'
