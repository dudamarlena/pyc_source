...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/webstarts/types.py
# Compiled at: 2017-08-10 13:12:30
...
class LogFactory(stdlib.LoggerFactory):
    __doc__ = 'LoggerFactory for structlog'
...
class WebstartsLogger(_FixedFindCallerLogger):
    __doc__ = 'Root logger who will handle end result from structlog'
...
class WebstartsFormatter(logging.Formatter):
    __doc__ = 'End logging formatter for all'
...
class ExtrasProcessor(KeyValueRenderer):
    __doc__ = 'Replace ConsoleRenderer for final output'
