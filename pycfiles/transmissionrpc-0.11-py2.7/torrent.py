...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmissionrpc/torrent.py
# Compiled at: 2013-08-31 12:51:26
import sys, datetime
...
class Torrent(object):
    ...
    def files(self):
        ...
        if 'files' in self._fields:
            ...
            for item in zip(indices, files, priorities, wanted):
                ...
                result[item[0]] = {'selected': selected, 
                   'priority': priority, 
                   'size': item[1]['length'], 
                   'name': item[1]['name'], 
    ...
    priority = property(_get_priority, _set_priority, None, "Bandwidth priority as string. Can be one of 'low', 'normal', 'high'. This is a mutator.")
    ...
    seed_idle_limit = property(_get_seed_idle_limit, _set_seed_idle_limit, None, 'Torrent seed idle limit in minutes. Also see seed_idle_mode. This is a mutator.')
    ...
    seed_ratio_limit = property(_get_seed_ratio_limit, _set_seed_ratio_limit, None, 'Torrent seed ratio limit as float. Also see seed_ratio_mode. This is a mutator.')
