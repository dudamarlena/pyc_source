...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmissionrpc/constants.py
# Compiled at: 2013-08-31 14:17:04
import logging
...
IDLE_LIMIT = mirror_dict({'global': TR_RATIOLIMIT_GLOBAL, 
   'single': TR_RATIOLIMIT_SINGLE, 
   'unlimited': TR_RATIOLIMIT_UNLIMITED})
TORRENT_ARGS = {'get': {'activityDate': ('number', 1, None, None, None, 'Last time of upload or download activity.'), 
   ...
   'set': {'bandwidthPriority': ('number', 5, None, None, None, 'Priority for this transfer.'), 
   ...
   'add': {'bandwidthPriority': ('number', 8, None, None, None, 'Priority for this transfer.'), 
...
SESSION_ARGS = {'get': {'alt-speed-down': ('number', 5, None, None, None, 'Alternate session download speed limit (in Kib/s).'), 
   ...
   'set': {'alt-speed-down': ('number', 5, None, None, None, 'Alternate session download speed limit (in Kib/s).'), 
