...
# [GCC 8.4.0]
# Embedded file name: /Users/darko/dev/ba-pip/bitcoinaverage/clients/websocket_client.py
# Compiled at: 2018-08-30 06:21:30
...
class TickerWebsocketClient(BitcoinAverageWsClient, WebSocketClient):
    ...
    def __init__(self, public_key, secret_key, url='wss://apiv2.bitcoinaverage.com/websocket/ticker', subscription=None):
...
class TickerWebsocketClientV2(BitcoinAverageWsClient, WebSocketClient):
    ...
    def __init__(self, public_key, secret_key, url='wss://apiv2.bitcoinaverage.com/websocket/v2/ticker', subscription=None):
...
class ExchangeWebsocketClient(BitcoinAverageWsClient, WebSocketClient):
    ...
    def __init__(self, public_key, secret_key, url='wss://apiv2.bitcoinaverage.com/websocket/exchanges', subscription=None):
    ...
    def exchange_data(self, exchange_name):
        ...
        ticket = RestfulClient(self.secret_key, self.public_key).get_ticket()['ticket']
        self.url = self.construct_url(ticket)
        self.subscription = {'event':'message',  'data':{'operation':'subscribe', 
          'options':{'exchange': exchange_name}}}
        self.__init__(self.public_key, self.secret_key, self.url, self.subscription)
        self.connect_to_websocket()
...
class ExchangeWebsocketClientV2(BitcoinAverageWsClient, WebSocketClient):
    ...
    def __init__(self, public_key, secret_key, url='wss://apiv2.bitcoinaverage.com/websocket/v2/exchanges', subscription=None):
    ...
    def exchange_data(self, exchange_list):
        ...
        self.url = self.construct_url(ticket)
        self.subscription = {'event':'message',  'data':{'operation':'subscribe', 
          'options':{'exchange_list': exchange_list}}}
        self.__init__(self.public_key, self.secret_key, self.url, self.subscription)
        self.connect_to_websocket()