...
# [GCC 8.4.0]
# Embedded file name: C:\projects\pm\src\epcpm\__main__.py
# Compiled at: 2020-04-21 13:23:39
# Size of source mod 2**32: 2561 bytes
import faulthandler
faulthandler.enable()
import logging, os.path, sys, click
from PyQt5 import QtCore, QtGui, QtWidgets
import epyqlib.utils.qt, epcpm.mainwindow, epcpm.cli.utils
__copyright__ = 'Copyright 2017, EPC Power Corp.'
__license__ = 'GPLv2+'

def main(project, verbosity, logger):
    app = QtWidgets.QApplication(sys.argv)
    epyqlib.utils.qt.exception_message_box_register_versions(version_tag=(epcpm.__version_tag__),
    ...
    app.setStyleSheet('QMessageBox {{ messagebox-text-interaction-flags: {}; }}'.format(QtCore.Qt.TextBrowserInteraction))
    ...
    window = epcpm.mainwindow.Window(title='EPC Parameter Manager',
      icon_path='icon.ico')
    epyqlib.utils.qt.exception_message_box_register_parent(parent=(window.main_window))
