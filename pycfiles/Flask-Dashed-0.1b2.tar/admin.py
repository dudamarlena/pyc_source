...
# [GCC 8.4.0]
# Embedded file name: /home/jeanphix/.virtualenvs/bb_api_dev/lib/python2.7/site-packages/flask_dashed/admin.py
# Compiled at: 2012-10-27 12:37:10
...
class AdminNode(object):
    ...
    def __init__(self, admin, url_prefix, endpoint, short_title, title=None, parent=None):
        self.admin = admin
        self.parent = parent
...
class Admin(object):
    ...
    def register_node(self, url_prefix, endpoint, short_title, title=None, parent=None, node_class=AdminNode):
        ...
        """
        return self._add_node(node_class, url_prefix, endpoint, short_title, title=title, parent=parent)

    def register_module(self, module_class, url_prefix, endpoint, short_title, title=None, parent=None):
        """Registers new module to current admin.
        """
        return self._add_node(module_class, url_prefix, endpoint, short_title, title=title, parent=parent)

    def _add_node(self, node_class, url_prefix, endpoint, short_title, title=None, parent=None):
        ...
        new_node = node_class(self, url_prefix, endpoint, short_title, title=title, parent=parent)
        if parent:
...
class AdminModule(AdminNode):
    ...
    def _register_rules(self):
        ...
        if not hasattr(self, 'default_rules'):
            raise NotImplementedError('Admin module class must provide' + ' default_rules')
    ...
    def _secure_enpoint(self, endpoint, secure_function, http_code):
        ...
        view_func.view_class.dispatch_request = secure(endpoint, secure_function, http_code)(view_func.view_class.dispatch_request)
...
class ObjectAdminModule(AdminModule):
    ...
    def get_object_list(self, search=None, order_by_field=None, order_by_direction=None, offset=None, limit=None):
