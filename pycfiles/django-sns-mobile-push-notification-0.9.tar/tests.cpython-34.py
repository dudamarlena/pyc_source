...
# [GCC 8.4.0]
# Embedded file name: /Users/rvaziri/django_mobile_push/sns_mobile_push_notification/tests.py
# Compiled at: 2018-04-29 13:22:49
# Size of source mod 2**32: 5465 bytes
...
class TestNotificationTasks(TestCase):
    ...
    def test_publish_to_android(self, mock_Client):
        ...
        device = Device.objects.create(token=token, os=Device.ANDROID_OS, arn='arn')
        mock_response = (
         'message', {'EndpointArn': 'arn',  'ResponseMetadata': {'RetryAttempts': 0,  'HTTPHeaders': {'x-amzn-requestid': 'e08722bb-4218-5b6a-8e55-71fa82e9ffc3',  'content-length': '424',  'date': 'Fri, 06 Apr 2018 18:38:40 GMT',  'content-type': 'text/xml'},  'HTTPStatusCode': 200,  'RequestId': 'e08722bb-4218-5b6a-8e55-71fa82e9ffc3'}})
        mock_Client().publish_to_android.return_value = mock_response
        response = send_sns_mobile_push_notification_to_device(device=device, notification_type='type', text='text', data={'a': 'b'}, title='title')
