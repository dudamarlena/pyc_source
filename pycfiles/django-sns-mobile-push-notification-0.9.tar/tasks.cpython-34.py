...
# [GCC 8.4.0]
# Embedded file name: /Users/rvaziri/django_mobile_push/sns_notification/tasks.py
# Compiled at: 2018-04-29 12:56:59
...
def send_sns_mobile_push_notification_to_device(device, notification_type, text, data, title):
    ...
    :return: response from SNS
    """
    return device.send(notification_type=notification_type, text=text, data=data, title=title)