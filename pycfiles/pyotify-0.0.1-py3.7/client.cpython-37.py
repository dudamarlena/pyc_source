...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyotify\client.py
# Compiled at: 2020-02-21 17:48:56
# Size of source mod 2**32: 14473 bytes
import json, requests
import pyotify.utils as utils
import pyotify.auth as auth

class Spotify:
    __doc__ = 'Web API Reference\n\n    https://developer.spotify.com/documentation/web-api/reference/\n    '
    _api_prefix = 'https://api.spotify.com/v1/'
    max_retries = 10
    api_call_timeout = None

    def __init__(self, client_id, client_secret, redirect_uri=None, state=None, scope=None, show_dialog=False, cached_token_path=None):
    ...
    def search(self, q, type, market=None, limit=None, offset=None, include_external=None):
        params = {'q':q, 
         'type':type,  'market':market,  'limit':limit,  'offset':offset,  'include_external':include_external}
    ...
    def categories(self, category_id=None, country=None, locale=None, limit=None, offset=None):
        if category_id is None:
            ...
            return self._get('browse/categories', params=params)
        params = {'country':country, 
         'locale':locale}
    ...
    def featured_playlists(self, locale=None, country=None, timestamp=None, limit=None, offset=None):
        ...
        return self._get('browse/featured-playlists', params=params)

    def new_releases(self, country=None, limit=None, offset=None):
        params = {'country':country, 
         'limit':limit,  'offset':offset}
        return self._get('browse/new-releases', params=params)
    ...
    def recommendations(self, limit=None, market=None, seed_artists=None, seed_genres=None, seed_tracks=None, **kwargs):
        params = {**{'limit':limit, 
         ...
         'seed_tracks':seed_tracks}, **kwargs}
    ...
    def audio_features(self, ids):
        return self._get('audio-features', ids=ids)
