...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mplotlab\models\Container.py
...
class Container(object):
    MODELCLASSES = [
     Source, Variable, Collection, Projection, Slide]
    REGCLASSES = {}
    ...
    def flush(self):
        self.__modelsByClass.update({modelClass:[] for modelClass in self.MODELCLASSES})
        self.__modelsById = {}
