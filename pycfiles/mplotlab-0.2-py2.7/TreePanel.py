...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mplotlab\graphics\TreePanel.py
...
class TreePanel(wx.TreeCtrl):
    ...
    def __init__(self, parent, configPanel):
        wx.TreeCtrl.__init__(self, parent, -1, wx.Point(0, 0), wx.Size(160, 250), wx.TR_DEFAULT_STYLE | wx.NO_BORDER)
        ...
        for slide in App().mainWin.getContainer().getSlides():
            ...
            for projection in slide.get_projections():
                ...
                for collection in projection.get_collections():
                    ...
                    if collection == self.__modelSel:
                        self.SelectItem(ittt)
