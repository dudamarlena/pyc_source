...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mplotlab\mpl_builders\mpl_figures.py
# Compiled at: 2016-02-07 12:02:58
...
def buildFigure(figure, slide):
    ...
    for i, projection in enumerate(projections):
        ...
        for collection in collections:
            ...
            pL = ['color', 'linestyle']
            kw = {k:collection.getAttr(k) for k in pL}
    ...
    if len(animatedArtists) > 0:
        if hasattr(figure, 'ani'):
            figure.ani._stop()
        figure.ani = MPL_ArtistAnimation(figure, [animatedArtists], interval=100, blit=True, repeat_delay=0)