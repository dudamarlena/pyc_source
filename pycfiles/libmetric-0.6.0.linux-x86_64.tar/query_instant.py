...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/libmetric/query_instant.py
# Compiled at: 2017-11-20 07:39:59
...
class PrometheusInstantQuery(InstantQuery):
    ...
    def _process(self, response):
        ...
        np_data = [ (('{}_{}').format(series['metric']['__name__'], series['metric']['instance']), np.array([series['value']])) for series in data ]
        series = []
