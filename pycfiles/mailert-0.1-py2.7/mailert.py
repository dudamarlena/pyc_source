...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mailert/mailert.py
# Compiled at: 2011-08-13 07:37:53
import smtplib
from email.MIMEText import MIMEText

class MailertException(Exception):
    pass


class RequiredParameterMissingException(MailertException):
    pass


class InvalidConnectionStringFormat(MailertException):
    pass


class Mailert(object):
    OBLIGATORY_PARAMETERS = [
     'host', 'user', 'password', 'service', 'receivers']
