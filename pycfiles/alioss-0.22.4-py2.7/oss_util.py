...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\oss\oss_util.py
# Compiled at: 2013-10-29 21:09:23
import urllib, base64, hmac, time
from hashlib import sha1 as sha
import os, sys, md5, StringIO
from threading import Thread
import threading, ConfigParser, logging
...
def split_large_file(file_path, object_prefix='', max_part_num=1000, part_size=10485760, buffer_size=10240):
    parts_list = []
    if os.path.isfile(file_path):
        ...
        for i in xrange(0, part_num):
            ...
            part_msg = (
             part_order, file_name, md5sum, real_part_size, offset)
