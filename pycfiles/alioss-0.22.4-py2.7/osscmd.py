...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\oss\osscmd.py
# Compiled at: 2013-10-28 22:53:36
from oss.oss_api import *
from oss.oss_util import *
from oss.oss_xml_handler import *
import signal, ConfigParser
from optparse import OptionParser
import os, re, time, Queue, sys
reload(sys)
...
def split_path(path):
    if not path.lower().startswith(OSS_PREFIX):
        print '%s parameter %s invalid, must be start with %s' % (
...
if __name__ == '__main__':
    ...
    parser.add_option('-c', '--content-type', dest='content_type', help='content type for the file, will return in GET')
