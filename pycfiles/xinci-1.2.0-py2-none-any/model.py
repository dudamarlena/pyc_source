...
# [GCC 8.4.0]
# Embedded file name: /Users/lapis-hong/Documents/Sina/Project/xinci/xinci/model.py
# Compiled at: 2018-06-18 09:00:09
...
class EntropyJudger:
    ...
    def _get_solid_rate(self, candidate):
        if len(candidate) < 2:
            return 1.0
        cnt = self._indexer.count(candidate)
        if cnt < self._least_cnt_threshold:
            return 0.0
        rate = 1.0
        for c in candidate:
            rate *= cnt / self._indexer.char_cnt_map[c]
