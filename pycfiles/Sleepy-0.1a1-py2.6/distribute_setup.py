...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-i386/egg/sleepy/templates/default_project/distribute_setup.py
# Compiled at: 2011-05-11 23:19:19
...
def _fake_setuptools():
    ...
    if setuptools_dist is None:
        ...
        if not _under_prefix(setuptools_location):
            ...
            return
            setuptools_location.endswith('.egg') or log.warn('Non-egg installation')
