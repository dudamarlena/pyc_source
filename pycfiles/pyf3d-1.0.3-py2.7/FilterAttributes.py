...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyF3D/FilterAttributes.py
# Compiled at: 2017-03-15 18:07:02
import numpy as np, pyopencl as cl, re
    ...
    def parseImage(self, inputString, maskL, images):
        if len(inputString) == 0:
            ...
            if inputString.startswith('StructuredElementL'):
                ...
                return True
            if re.match('Diagonal\\d{1,2}x\\d{1,2}x\\d{1,2}', inputString):
