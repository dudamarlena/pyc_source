...
# Embedded file name: build/bdist.linux-x86_64/egg/prompt_tool_kit/key_binding/bindings/emacs.py
# Compiled at: 2019-08-15 23:53:38
# Size of source mod 2**32: 15477 bytes
from __future__ import unicode_literals
from prompt_tool_kit.buffer import SelectionType, indent, unindent
...
from prompt_tool_kit.filters import Condition, EmacsMode, HasSelection, EmacsInsertMode, HasFocus, HasArg
from prompt_tool_kit.completion import CompleteEvent
from .scroll import scroll_page_up, scroll_page_down
from .named_commands import get_by_name
from ..registry import Registry, ConditionalRegistry
__all__ = ('load_emacs_bindings', 'load_emacs_search_bindings', 'load_emacs_system_bindings',
...
def load_emacs_bindings():
    ...
    handle((Keys.ControlUnderscore), save_before=(lambda e: False), filter=insert_mode)(get_by_name('undo'))
    handle((Keys.ControlX), (Keys.ControlU), save_before=(lambda e: False), filter=insert_mode)(get_by_name('undo'))
    ...
    handle((Keys.Escape), (Keys.ControlJ), filter=(insert_mode & is_returnable))(get_by_name('accept-line'))
