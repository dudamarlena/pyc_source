...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Alias', fields=[
      ...
      (
       'site', models.ForeignKey(related_name='aliases', to='sites.Site', on_delete=models.CASCADE))], options={'verbose_name_plural': 'aliases'}),
     migrations.AlterUniqueTogether(name='alias', unique_together=set([('is_canonical', 'site')]))]