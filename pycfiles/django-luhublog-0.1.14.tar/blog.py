...
# [GCC 8.4.0]
# Embedded file name: /home/johsanca/Projects/luhu-blog-app/luhublog/models/blog.py
...
class Blog(TimeStampedModel):
    title = models.CharField(verbose_name='Nombre del blog', max_length=60)
    tag_line = models.CharField(verbose_name='Descripción del blog', max_length=140)
    entries_per_page = models.IntegerField(verbose_name='Entradas por pagina', default=10)
    recents = models.IntegerField(verbose_name='Numero de entradas recientes a mostrar', default=5)
