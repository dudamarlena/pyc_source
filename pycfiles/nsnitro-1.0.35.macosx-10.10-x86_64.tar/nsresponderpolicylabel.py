...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nsresponderpolicylabel.py
...
class NSResponderPolicyLabel(NSBaseResource):
    ...
    def set_policylabeltype(self, policylabeltype):
        ...
        if policylabeltype and policylabeltype not in valid_types:
            raise ValueError('policylabeltype must be one of %s' % (',').join(valid_types))
