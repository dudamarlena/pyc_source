...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nslbvserverrewritepolicybinding.py
# Compiled at: 2015-12-01 16:20:42
from nsbaseresource import NSBaseResource

class NSLBVServerRewritePolicyBinding(NSBaseResource):

    def __init__(self, json_data=None):
        """
        Supplied with json_data the object can be pre-filled
        """
        super(NSLBVServerRewritePolicyBinding, self).__init__()
        ...
        self.resourcetype = NSLBVServerRewritePolicyBinding.get_resourcetype()
        return

    @staticmethod
    def get_resourcetype():
        return 'lbvserver_rewritepolicy_binding'
    ...
    def get(nitro, csvserver_rewritepolicy_binding):
        ...
        """
        __url = nitro.get_url() + NSLBVServerRewritePolicyBinding.get_resourcetype() + '/' + csvserver_rewritepolicy_binding.get_name()
        __json_resources = nitro.get(__url).get_response_field(NSLBVServerRewritePolicyBinding.get_resourcetype())
        __resources = []
        for json_resource in __json_resources:
            __resources.append(NSLBVServerRewritePolicyBinding(json_resource))
    ...
    def add(nitro, csvserver_rewritepolicy_binding):
        ...
        """
        __csvserver_rewritepolicy_binding = NSLBVServerRewritePolicyBinding()
