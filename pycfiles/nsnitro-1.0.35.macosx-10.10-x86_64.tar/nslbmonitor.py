...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nslbmonitor.py
...
class NSLBMonitor(NSBaseResource):
    ...
    def __init__(self, json_data=None):
        ...
        self.options = {'monitorname': '', 'alertretries': '', 
           'destip': '', 
           'destport': '', 
           'deviation': '', 
           'dispatcherip': '', 
    ...
    def get_all(nitro):
        ...
        __json_monitors = nitro.get(__url).get_response_field(NSLBMonitor.get_resourcetype())
        __monitors = []
    ...
    def add(nitro, resource):
        ...
        __resource.set_dynamicresponsetimeout(resource.get_dynamicresponsetimeout())
        __resource.set_failureretries(resource.get_failureretries())
        __resource.set_firmwarerevision(resource.get_firmwarerevision())
        __resource.set_httprequest(resource.get_httprequest())
        __resource.set_inbandsecurityid(resource.get_inbandsecurityid())
        ...
        __resource.set_resptimeoutthresh(resource.get_resptimeoutthresh())
        ...
        __resource.set_storefrontacctservice(resource.get_storefrontacctservice())
