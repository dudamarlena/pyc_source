...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nssslvserversslpolicybinding.py
...
class NSSSLVServerSSLPolicyBinding(NSBaseResource):
    ...
    def get(nitro, resource):
        ...
        """
        __url = nitro.get_url() + NSSSLVServerSSLPolicyBinding.get_resourcetype() + '/' + resource.get_vservername()
        __json_resources = nitro.get(__url).get_response_field(NSSSLVServerSSLPolicyBinding.get_resourcetype())
        __resources = []
