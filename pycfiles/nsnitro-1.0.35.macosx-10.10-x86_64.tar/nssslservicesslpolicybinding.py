...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nssslservicesslpolicybinding.py
...
class NSSSLServiceSSLPolicyBinding(NSBaseResource):
    ...
    def get(nitro, resource):
        ...
        """
        __url = nitro.get_url() + NSSSLServiceSSLPolicyBinding.get_resourcetype() + '/' + resource.get_servicename()
        __json_resources = nitro.get(__url).get_response_field(NSSSLServiceSSLPolicyBinding.get_resourcetype())
        __resources = []
