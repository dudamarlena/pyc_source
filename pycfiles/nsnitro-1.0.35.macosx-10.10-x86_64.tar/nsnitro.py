...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsnitro.py
...
class NSNitro:
    ...
    __postheaders = {'Cookie': 'sessionid=' + __sessionid, 
    ...
    def login(self):
        ...
        try:
            ...
            self.__postheaders = {'Cookie': 'sessionid=' + self.__sessionid, 
    ...
    def logout(self):
        payload = {'object': json.dumps({'logout': {}})}
        try:
            nsresponse = self.post(payload)
