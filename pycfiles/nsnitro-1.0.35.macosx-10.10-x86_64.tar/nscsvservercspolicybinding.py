...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nscsvservercspolicybinding.py
...
class NSCSVServerCSPolicyBinding(NSBaseResource):
    ...
    def __init__(self, json_data=None):
        ...
        self.options = {'targetvserver': '', 'policyname': '', 
           'priority': '', 
    ...
    def add(nitro, csvserver_cspolicy_binding):
        ...
        """
        __csvserver_cspolicy_binding = NSCSVServerCSPolicyBinding()
