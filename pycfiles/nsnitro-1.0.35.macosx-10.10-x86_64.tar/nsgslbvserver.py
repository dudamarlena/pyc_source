...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nsgslbvserver.py
...
class NSGSLBVServer(NSBaseResource):
    ...
    def get_all(nitro):
        ...
        __json_gslbvservers = nitro.get(__url).get_response_field(NSGSLBVServer.get_resourcetype())
        __gslbvservers = []
