...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/nscspolicycspolicylabelbinding.py
...
class NSCSPolicyCSPolicylabelBinding(NSBaseResource):
    ...
    def __init__(self, json_data=None):
        ...
        self.options = {'policyname': '', 'priority': 0, 
           'targetvserver': '', 
    ...
    def get(nitro, csvserver_cspolicy_binding):
        ...
        """
        __url = nitro.get_url() + NSCSPolicyCSPolicylabelBinding.get_resourcetype() + '/' + csvserver_cspolicy_binding.get_name()
