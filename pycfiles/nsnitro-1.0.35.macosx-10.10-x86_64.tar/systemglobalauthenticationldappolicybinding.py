...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/nsnitro/nsresources/systemglobalauthenticationldappolicybinding.py
...
class SystemGlobalAuthLdapPolicyBinding(NSBaseResource):
    ...
    def __init__(self, json_data=None):
        ...
        self.options = {'policyname': '', 'builtin': '', 
           'priority': ''}
