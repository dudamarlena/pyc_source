...
# [GCC 8.4.0]
# Embedded file name: build/bdist.cygwin-2.6.0-x86_64/egg/bcTesting/testBase.py
# Compiled at: 2016-09-26 02:11:44
""" Module contains the base class for the testing of core python modules/functions.
"""
import fixtures, mox, testtools
...
class TestCase(testtools.TestCase):
    ...
    def assertType(self, obj, cls):
        """ Method to compare the type of the object and given class
                ...
                """
        assert isinstance(obj, cls), 'Object (%r) is not a type of %r' % (obj, cls)