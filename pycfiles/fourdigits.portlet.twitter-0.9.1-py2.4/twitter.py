...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/fourdigits/portlet/twitter/twitter.py
# Compiled at: 2011-10-24 09:38:37
"""A library that provides a Python interface to the Twitter API"""
__author__ = 'python-twitter@googlegroups.com'
__version__ = '0.8.2'
import base64, calendar, datetime, httplib, os, rfc822, sys, tempfile, textwrap, time, calendar, urllib, urllib2, urlparse, gzip, StringIO
try:
...
class Status(object):
  ...
  """
    ...
    def __init__(self, created_at=None, favorited=None, id=None, text=None, location=None, user=None, in_reply_to_screen_name=None, in_reply_to_user_id=None, in_reply_to_status_id=None, truncated=None, source=None, now=None, urls=None, user_mentions=None, hashtags=None, geo=None, place=None, coordinates=None, contributors=None, retweeted=None, retweeted_status=None, retweet_count=None):
    ...
    created_at = property(GetCreatedAt, SetCreatedAt, doc='The time this status message was posted.')
    ...
    created_at_in_seconds = property(GetCreatedAtInSeconds, doc='The time this status message was posted, in seconds since the epoch')
    ...
    favorited = property(GetFavorited, SetFavorited, doc='The favorited state of this status message.')
    ...
    in_reply_to_screen_name = property(GetInReplyToScreenName, SetInReplyToScreenName, doc='')
    ...
    in_reply_to_user_id = property(GetInReplyToUserId, SetInReplyToUserId, doc='')
    ...
    in_reply_to_status_id = property(GetInReplyToStatusId, SetInReplyToStatusId, doc='')
    ...
    text = property(GetText, SetText, doc='The text of this status message')
    ...
    location = property(GetLocation, SetLocation, doc='The geolocation string of this status message')
    ...
    relative_created_at = property(GetRelativeCreatedAt, doc='Get a human readable string representing the posting time')
    ...
    user = property(GetUser, SetUser, doc='A twitter.User reprenting the entity posting this status message')
    ...
    retweeted_status = property(GetRetweeted_status, SetRetweeted_status, doc='')
    ...
    retweet_count = property(GetRetweetCount, SetRetweetCount, doc='')
   ...
   """
    ...
    """
        ...
        return Status(created_at=data.get('created_at', None), favorited=data.get('favorited', None), id=data.get('id', None), text=data.get('text', None), location=data.get('location', None), in_reply_to_screen_name=data.get('in_reply_to_screen_name', None), in_reply_to_user_id=data.get('in_reply_to_user_id', None), in_reply_to_status_id=data.get('in_reply_to_status_id', None), truncated=data.get('truncated', None), retweeted=data.get('retweeted', None), source=data.get('source', None), user=user, urls=urls, user_mentions=user_mentions, hashtags=hashtags, geo=data.get('geo', None), place=data.get('place', None), coordinates=data.get('coordinates', None), contributors=data.get('contributors', None), retweeted_status=retweeted_status, retweet_count=data.get('retweet_count', None))
...
class User(object):
  ...
  """
    ...
    id = property(GetId, SetId, doc='The unique id of this user.')
    ...
    name = property(GetName, SetName, doc='The real name of this user.')
    ...
    screen_name = property(GetScreenName, SetScreenName, doc='The short twitter name of this user.')
    ...
    location = property(GetLocation, SetLocation, doc='The geographic location of this user.')
    ...
    description = property(GetDescription, SetDescription, doc='The short text description of this user.')
    ...
    url = property(GetUrl, SetUrl, doc='The homepage url of this user.')
    ...
    profile_image_url = property(GetProfileImageUrl, SetProfileImageUrl, doc='The url of the thumbnail of this user.')
    ...
    profile_background_tile = property(GetProfileBackgroundTile, SetProfileBackgroundTile, doc='Boolean for whether to tile the background image.')
    ...
    profile_background_image_url = property(GetProfileBackgroundImageUrl, SetProfileBackgroundImageUrl, doc='The url of the profile background of this user.')
    ...
    status = property(GetStatus, SetStatus, doc='The latest twitter.Status of this user.')
    ...
    friends_count = property(GetFriendsCount, SetFriendsCount, doc='The number of friends for this user.')
    ...
    listed_count = property(GetListedCount, SetListedCount, doc='The number of lists this user belongs to.')
    ...
    followers_count = property(GetFollowersCount, SetFollowersCount, doc='The number of users following this user.')
    ...
    statuses_count = property(GetStatusesCount, SetStatusesCount, doc='The number of updates for this user.')
    ...
    favourites_count = property(GetFavouritesCount, SetFavouritesCount, doc='The number of favourites for this user.')
    ...
    geo_enabled = property(GetGeoEnabled, SetGeoEnabled, doc='The value of twitter.geo_enabled for this user.')
    ...
    verified = property(GetVerified, SetVerified, doc='The value of twitter.verified for this user.')
    ...
    lang = property(GetLang, SetLang, doc='The value of twitter.lang for this user.')
    ...
    notifications = property(GetNotifications, SetNotifications, doc='The value of twitter.notifications for this user.')
    ...
    contributors_enabled = property(GetContributorsEnabled, SetContributorsEnabled, doc='The value of twitter.contributors_enabled for this user.')
    ...
    created_at = property(GetCreatedAt, SetCreatedAt, doc='The value of twitter.created_at for this user.')
...
class List(object):
  ...
  """
    ...
    def __init__(self, id=None, name=None, slug=None, description=None, full_name=None, mode=None, uri=None, member_count=None, subscriber_count=None, following=None, user=None):
        self.id = id
        self.name = name
        self.slug = slug
        self.description = description
    ...
    id = property(GetId, SetId, doc='The unique id of this list.')
    ...
    name = property(GetName, SetName, doc='The real name of this list.')
    ...
    slug = property(GetSlug, SetSlug, doc='The slug of this list.')
    ...
    description = property(GetDescription, SetDescription, doc='The description of this list.')
    ...
    full_name = property(GetFull_name, SetFull_name, doc='The full_name of this list.')
    ...
    mode = property(GetMode, SetMode, doc='The mode of this list.')
    ...
    member_count = property(GetMember_count, SetMember_count, doc='The member_count of this list.')
    ...
    subscriber_count = property(GetSubscriber_count, SetSubscriber_count, doc='The subscriber_count of this list.')
    ...
    following = property(GetFollowing, SetFollowing, doc='The following status of this list.')
   ...
   """
    ...
    """
        if 'user' in data:
            ...
            user = None
        return List(id=data.get('id', None), name=data.get('name', None), slug=data.get('slug', None), description=data.get('description', None), full_name=data.get('full_name', None), mode=data.get('mode', None), uri=data.get('uri', None), member_count=data.get('member_count', None), subscriber_count=data.get('subscriber_count', None), following=data.get('following', None), user=user)
...
class DirectMessage(object):
  ...
  """
    ...
    created_at = property(GetCreatedAt, SetCreatedAt, doc='The time this direct message was posted.')
    ...
    created_at_in_seconds = property(GetCreatedAtInSeconds, doc='The time this direct message was posted, in seconds since the epoch')
    ...
    sender_id = property(GetSenderId, SetSenderId, doc='The unique sender id of this direct message.')
    ...
    sender_screen_name = property(GetSenderScreenName, SetSenderScreenName, doc='The unique sender screen name of this direct message.')
    ...
    recipient_id = property(GetRecipientId, SetRecipientId, doc='The unique recipient id of this direct message.')
    ...
    recipient_screen_name = property(GetRecipientScreenName, SetRecipientScreenName, doc='The unique recipient screen name of this direct message.')
    ...
    def __eq__(self, other):
        try:
            return other and self.id == other.id and self.created_at == other.created_at and self.sender_id == other.sender_id and self.sender_screen_name == other.sender_screen_name and self.recipient_id == other.recipient_id and self.recipient_screen_name == other.recipient_screen_name and self.text == other.text
        except AttributeError:
            return False
...
class Trend(object):
  ...
  """
    ...
    """
        return Trend(name=data.get('name', None), query=data.get('query', None), timestamp=timestamp)
...
class Api(object):
  ...
  """
    ...
    """
        ...
        if consumer_key is not None and (access_token_key is None or access_token_secret is None):
    ...
    """
        ...
        self._oauth_consumer = None
        if consumer_key is not None and consumer_secret is not None and access_token_key is not None and access_token_secret is not None:
    ...
    def GetPublicTimeline(self, since_id=None, include_rts=None, include_entities=None):
    ...
    def GetSearch(self, term=None, geocode=None, since_id=None, per_page=15, page=1, lang='', show_user='true', query_users=False):
    ...
    """
        ...
        for x in data['results']:
            lang_ok = False
            if lang:
                if 'iso_language_code' in x.keys():
                    if x['iso_language_code'] == lang:
                        lang_ok = True
            else:
                lang_ok = True
            if lang_ok == True:
    ...
    """
        ...
        for t in data['trends']:
            ...
            trends[idx] = [ Trend.NewFromJsonDict(x, timestamp=t) for x in data['trends'][t] ]
    ...
    """
        ...
        times = dict([ (calendar.timegm(time.strptime(t, '%Y-%m-%d')), t) for t in data['trends'] ])
        cnt = 0
        for e in sorted(times.keys()):
            trends[cnt] = [ Trend.NewFromJsonDict(x, timestamp=times[e]) for x in data['trends'][times[e]] ]
            cnt += 1

        return trends

    def GetFriendsTimeline(self, user=None, count=None, page=None, since_id=None, retweets=None, include_entities=None):
    ...
    def GetUserTimeline(self, id=None, user_id=None, screen_name=None, since_id=None, max_id=None, count=None, page=None, include_rts=None, include_entities=None):
    ...
    """
        ...
        if id:
            ...
            url = '%s/statuses/user_timeline.json?screen_name=%s' % (self.base_url, screen_name)
    ...
    """
        ...
        if len(u_status) > CHARACTER_LIMIT:
            raise TwitterError('Text must be less than or equal to %d characters. Consider using PostUpdates.' % CHARACTER_LIMIT)
        data = {'status': status}
    ...
    def PostUpdates(self, status, continuation=None, **kwargs):
        r"""Post one or more twitter status messages from the authenticated user.
    ...
    def _InitializeUserAgent(self):
        user_agent = 'Python-urllib/%s (python-twitter/%s)' % (self._urllib.__version__, __version__)
    ...
    """
        ...
        if self._oauth_consumer is not None:
            ...
            req = oauth.Request.from_consumer_and_token(self._oauth_consumer, token=self._oauth_token, http_method=http_method, http_url=url, parameters=parameters)
...
class _FileCache(object):
    ...
    def _InitializeRootDirectory(self, root_directory):
        ...
        if not os.path.isdir(root_directory):
            raise _FileCacheError('%s exists but is not a directory' % root_directory)
