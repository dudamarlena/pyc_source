...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/captcha/conf/settings.py
# Compiled at: 2019-05-05 11:33:18
import os, warnings
...
CAPTCHA_NOISE_FUNCTIONS = getattr(settings, 'CAPTCHA_NOISE_FUNCTIONS', ('captcha.helpers.noise_arcs',
...
CAPTCHA_LENGTH = int(getattr(settings, 'CAPTCHA_LENGTH', 4))
