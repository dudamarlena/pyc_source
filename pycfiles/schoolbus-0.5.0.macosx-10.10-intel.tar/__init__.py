...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/schoolbus/__init__.py
# Compiled at: 2015-07-29 20:32:57
from publicsuffix import PublicSuffixList
from schoolbus.data import UNIVERSITY_DOMAINS
from schoolbus.research_orgs import RESEARCH_ORG_DOMAINS
_psl = PublicSuffixList()
ACADEMIC_TLDS = {'ac.ae': True, 
   'ac.at': True, 
   'ac.bd': True, 
   'ac.be': True, 
   'ac.cr': True, 
   ...
   'edu.zm': True, 
   'vic.edu.au': True}
BLACKLIST_DOMAINS = {'america.edu': True, 
   'academia.edu': True, 
   'si.edu': True}
