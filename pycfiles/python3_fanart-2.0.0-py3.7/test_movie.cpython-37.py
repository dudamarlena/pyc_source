...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fanart/tests/test_movie.py
...
class TvItemTestCase(unittest.TestCase):
    ...
    def test_get(self):
        ...
        HTTPretty.register_uri((HTTPretty.GET),
          ('http://webservice.fanart.tv/v3/movies/70160?api_key={}'.format(os.environ['FANART_APIKEY'])),
          body=body)
