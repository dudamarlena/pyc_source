...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fanart/tests/test_tv.py
...
class TvItemTestCase(unittest.TestCase):
    ...
    def test_get_wilfred(self):
        ...
        HTTPretty.register_uri((HTTPretty.GET),
          ('http://webservice.fanart.tv/v3/tv/239761?api_key={}'.format(os.environ['FANART_APIKEY'])),
          body=body)
    ...
    def test_get_dexter(self):
        with open(os.path.join(LOCALDIR, 'response/tv_79349.json')) as (fp):
            body = fp.read()
        HTTPretty.register_uri((HTTPretty.GET),
          ('http://webservice.fanart.tv/v3/tv/79349?api_key={}'.format(os.environ['FANART_APIKEY'])),
          body=body)
