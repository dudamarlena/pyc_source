...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/repoze/what/plugins/quickstart/config.py
...
__all__ = ('add_auth_from_config', 'BadConfigurationException', 'MissingOptionError',
           'BadOptionError')
_SUPPORTED_TRANSLATIONS = ('validate_password', 'dummy_validate_password', 'users',
                           'user_name', 'groups', 'group_name', 'permissions', 'permission_name')
