...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/casbin_peewee_adapter/adapter.py
# Compiled at: 2019-07-01 04:22:56
# Size of source mod 2**32: 2795 bytes
import casbin, peewee as pw
...
class CasbinRule(pw.Model):
    ...
    def __str__(self):
        return reduce(lambda x, y:         if y:
str(x) + ', ' + str(y) # Avoid dead code: x, [
