...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.2/dist-packages/ulvl.py
# Compiled at: 2014-09-29 19:11:55
"""
...
"""
__version__ = '0.4'
import json, xml.etree.ElementTree as ET, warnings
__all__ = [
 'ASCL', 'JSL', 'ULX', 'LevelObject']
...
class JSL(object):
    ...
    def save(self, f):
        """Save the object to the indicated file."""
        data = {'size': [self.width, self.height],  'meta': self.meta,  'objects': {}}
        for obj in self.objects:
