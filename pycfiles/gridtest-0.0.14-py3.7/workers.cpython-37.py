...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gridtest/main/workers.py
# Compiled at: 2020-05-03 07:49:46
    ...
    def run(self, tests, cleanup=True):
        ...
        try:
            ...
            for name, task in tests.items():
                ...
                params = {'funcname':task.get_funcname(), 
                 'module':task.module, 
                ...
                result = pool.apply_async(multi_wrapper, multi_package(test_basic, [params]))
