...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/core/tests/test_adapter_criteria.py
...
class TestValidity(EasyShopTestCase):
    ...
    def testCountry(self):
        ...
        customer.address_1.country = 'USA'
        self.assertEqual(v.isValid(), True)
        customer.address_1.country = 'Germany'
    ...
    def testPaymentMethod(self):
        ...
        cm = ICustomerManagement(self.shop)
        customer = cm.getAuthenticatedCustomer()
        customer.selected_payment_method = 'cash-on-delivery'
        self.assertEqual(v.isValid(), False)
        customer.selected_payment_method = 'prepayment'
        self.assertEqual(v.isValid(), False)
