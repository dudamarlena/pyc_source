...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/core/tests/test_adapter_order_item.py
...
class TestOrderItemManagement(EasyShopTestCase):
    ...
    def testAddItemFromCartItem(self):
        ...
        cm = ICartManagement(self.shop)
        cart = cm.createCart()
        properties = ({'id': 'color', 'selected_option': 'Red'}, {'id': 'material', 'selected_option': 'Wood'}, {'id': 'quality', 'selected_option': 'High'})
