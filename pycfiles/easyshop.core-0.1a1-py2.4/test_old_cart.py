...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/core/tests/test_old_cart.py
...
class TestCart(EasyShopTestCase):
    ...
    def afterSetUp(self):
        ...
        self.folder.invokeFactory('EasyShop', id='myshop', title='MyShop', description='My test shop')
