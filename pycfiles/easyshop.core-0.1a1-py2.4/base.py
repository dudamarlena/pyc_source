...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/easyshop/core/tests/base.py
# Compiled at: 2008-08-07 13:06:23
...
PloneTestCase.setupPloneSite(products=['easyshop.core', 'easyshop.shop', 'easyshop.catalog', 'easyshop.carts', 'easyshop.criteria', 'easyshop.customers', 'easyshop.discounts', 'easyshop.groups', 'easyshop.information', 'easyshop.kss', 'easyshop.login', 'easyshop.management', 'easyshop.order', 'easyshop.payment', 'easyshop.shipping', 'easyshop.stocks', 'easyshop.taxes'])
