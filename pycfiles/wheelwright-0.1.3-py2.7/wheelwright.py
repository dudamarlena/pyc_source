...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/wheelwright/wheelwright.py
# Compiled at: 2012-01-16 15:25:02
...
__license__ = 'GPLv3'
__version__ = '0.1.3'
import sys, os, numpy as np, pylab, pickle
...
class Wheelwright(QtGui.QMainWindow):
    ...
    def save(self):
        ...
        data = {'code': self.code.currentIndex(), 'target': self.target.value(), 
