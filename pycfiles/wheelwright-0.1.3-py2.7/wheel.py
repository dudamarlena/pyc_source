...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/wheelwright/wheel.py
...
def plot_valid_range(axes, target, accuracy):
    ...
    :Parameters:
      ...
      - `accuracy`: Target accuracy [0.0, 1.0]
    """
    axes.bar(0.0, 2.0 * accuracy * target, width=2.0 * np.pi, bottom=target * (1.0 - accuracy), color='g', alpha=0.25)
