...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/info/gianlucacosta/iris/tests/test_versioning.py
# Compiled at: 2017-10-18 21:02:23
...
class VersionDirectoryTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._inexistentVersionDirectory = VersionDirectory(os.path.join(os.path.dirname(__file__), 'INEXISTENT_VERSION_DIR'))
