...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/info/gianlucacosta/iris/tests/test_vars.py
# Compiled at: 2017-10-18 21:13:48
...
class FlagTests(VariablesTestCase):
    ...
    def testGetPathAfterRetrievingTheInexistentFlag(self):
        self.assertEquals(self._flagPath, self._flag.getPath())
