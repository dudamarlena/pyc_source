...
# [GCC 8.4.0]
# Embedded file name: /home/user/code/pyutil/pyutil/_version.py
# Compiled at: 2018-01-10 06:21:17
...
def get_config():
    ...
    cfg.style = 'pep440'
    cfg.tag_prefix = ''
    cfg.parentdir_prefix = 'pyutil-'
    cfg.versionfile_source = 'pyutil/_version.py'
    cfg.verbose = False
    return cfg
