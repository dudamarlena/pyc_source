...
_tool_map = {'linux': (
           _linux_path, (), _linux_re), 
   'win32': (
           _win32_path, _win32_args, _win32_re), 
   'cygwin': (
            _win32_path, _win32_args, _win32_re), 
   'bsd': (
         _netbsd_path, _netbsd_args, _netbsd_re), 
   'irix': (
          _irix_path, _netbsd_args, _netbsd_re), 
   'sunos': (
           _sunos_path, _netbsd_args, _netbsd_re)}
