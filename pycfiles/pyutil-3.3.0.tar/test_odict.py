...
# [GCC 8.4.0]
# Embedded file name: /home/user/code/pyutil/pyutil/test/out_of_shape/test_odict.py
...
def quick_bench():
    Bencher(odict.LRUCache, MAXTIME=2).bench(BSIZES=(128, 4096, 16384, 32768, 65536))
    Bencher(odict.LinkedListLRUCache, MAXTIME=2).bench(BSIZES=(128, 4096, 16384, 32768))
    Bencher(odict.SmallLRUCache, MAXTIME=2).bench(BSIZES=(128, 4096, 16384, 32768))
...
class Testy(unittest.TestCase):
    ...
    def _test_mem_leakage_much_adding_some_removing(self):
        memutil.measure_mem_leakage(self._mem_test_much_adding_some_removing, SAMPLES, iterspersample=1)
        slope = memutil.measure_mem_leakage(self._mem_test_much_adding_some_removing, SAMPLES, iterspersample=1)
    ...
    def _test_obj_leakage_much_adding_some_removing(self):
        memutil.measure_obj_leakage(self._mem_test_much_adding_some_removing, SAMPLES, iterspersample=1)
        slope = memutil.measure_obj_leakage(self._mem_test_much_adding_some_removing, SAMPLES, iterspersample=1)
