...
# [GCC 8.4.0]
# Embedded file name: /home/user/code/pyutil/pyutil/test/current/test_verlib.py
...
class VersionTestCase(unittest.TestCase):
    ...
    def test_irrational_versions(self):
        irrational = ('1', '1.2a', '1.2.3b', '1.02', '1.2a03', '1.2a3.04', '1.2.dev.2',
                      '1.2dev', '1.2.dev', '1.2.dev2.post2', '1.2.post2.dev3.post4')
        for s in irrational:
    ...
    def test_comparison(self):
        ...
        True
        """
        doctest.run_docstring_examples(self.test_comparison, globals(), name='test_comparison')
