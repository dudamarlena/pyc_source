...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/pycmdliner/pycmdliner.py
# Compiled at: 2012-08-30 11:23:10
import sys, inspect
...
class Pycmdliner(object):
    ...
    def __init__(self, configuration, businessObject):
        ...
        if configuration == None or businessObject == None:
            raise Exception('Configuration and Business Object cannot be' + ' null to instantiate a PyCmdLiner')
    ...
    def __extractMethod__(self, inputParameters, businessObject):
        if 'commandMapping' not in self.configuration and 'defaultCommand' not in self.configuration:
            ...
            self.__checkParameters__(inputParameters[offset:], mapping, businessObject)
            return mapping
        return
