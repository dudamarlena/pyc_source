...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelcore/scriptutils.py
...
def success(msg):
    ...
    """
    print '\x1b[32mSUCCESS: %s\x1b[0m' % msg
...
def error(msg, exit=True, code=1):
    ...
    """
    print '\x1b[31mERROR: %s\x1b[0m' % msg
    if exit:
        sys.exit(code)
...
def msg(msg, exit=True):
    ...
    @param exit: if True, exit after print
    """
    print '\x1b[35mMESSAGE: %s\x1b[0m' % msg
...
def warn(msg):
    ...
    @param msg: the message to print
    """
    print '\x1b[33mWARNING: %s\x1b[0m' % msg
