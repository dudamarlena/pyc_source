...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/smtphealth/__init__.py
# Compiled at: 2013-09-09 15:04:57
...
import sys, re, socket, ssl, time, signal, traceback
...
class SmtpHealthCheck(object):
    ...
    """
    banner_pattern = re.compile('^(\\d{3})(?:\\s+|-)(.*?)\\r?\\n$')

    def __init__(self, dns_timeout=None, connect_timeout=None, ssl_timeout=None, banner_timeout=None):
