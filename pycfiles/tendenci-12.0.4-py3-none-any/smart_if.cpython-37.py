...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/base/templatetags/smart_if.py
# Compiled at: 2020-02-26 14:48:40
# Size of source mod 2**32: 12848 bytes
"""
    ...
    def get_bool_var(self):
        ...
        if not self.at_end():
            ...
            if isinstance(op_token, str):
                if op_token not in BOOL_OPERATORS:
                    op, negate = self.get_operator()
                    return op(var, (self.get_var()), negate=negate)
        return var

    def get_var(self):
        token, negate = self.get_token('Reached end of statement, still expecting a variable.')
