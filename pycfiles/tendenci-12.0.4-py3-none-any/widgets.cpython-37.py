...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/libs/tinymce/widgets.py
...
class TinyMCE(forms.Textarea):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        if tinymce_settings.USE_COMPRESSOR:
            compressor_config = {'plugins':mce_config.get('plugins', ''),  'themes':mce_config.get('theme', 'advanced'), 
