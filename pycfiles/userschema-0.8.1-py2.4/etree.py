...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/userschema/etree.py
# Compiled at: 2007-06-25 17:29:16
...
def fromXML(xml_text, name=None, element_name=None, module_name=None, bases=None, swallow_exceptions=False):
    node = ElementTree.XML(xml_text)
    return fromNode(node, name, element_name, module_name, bases, swallow_exceptions)


def fromNode(node, name=None, element_name=None, module_name=None, bases=None, swallow_exceptions=False):
    ...
    return InterfaceClass(name=name, bases=tuple(bases), attrs=attrs, __doc__='Generated from XML', __module__=module_name)
...
_ELEMENT_CONVERTERS = {'title': unicode, 'description': unicode, 'required': _bool, 'readonly': _bool, 'min_length': int, 'max_length': int, 'default': None, 'min': None, 'max': None}
