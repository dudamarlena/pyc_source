...
# [GCC 8.4.0]
# Embedded file name: /Users/idm/Work/situation/situation/tests.py
# Compiled at: 2017-11-28 15:23:58
...
def simple_situation():
    ...
    resource1 = Resource.create(name='Headline news for November 23',
      publisher='Big Paper Post',
      author='John Doe',
      url='http://example.com/1')
    place1 = Place.create(name="Rob's House",
      address='200 Road St',
      lat=43,
      lon=(-79))
    excerpt1 = Excerpt.create(content='Snippet 1',
      resource=resource1)
    Event.create(name='Incident', place=place1,
    ...
    item1 = Item.create(name='Video', owners=[
     person1])
    assert item1
