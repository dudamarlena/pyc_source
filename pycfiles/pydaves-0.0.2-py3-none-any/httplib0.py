...
class HTTP:
    ...
    def __init__(self, host='', port=0):
        ...
        to connect.  By default, httplib0.HTTP_PORT is used.
...
class HTTPS(HTTP):
    ...
    def __init__(self, host='', port=0, key_file=None, cert_file=None):
