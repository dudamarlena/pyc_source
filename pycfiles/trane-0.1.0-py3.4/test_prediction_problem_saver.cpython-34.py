...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/tests/core/test_prediction_problem_saver.py
...
def test_write_then_read():
    ...
    prediction_problems_from_json, table_meta_from_json, entity_id_column_from_json, label_generating_column_from_json, time_column_from_json = prediction_problems_from_json_file(filename)
