...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/tests/core/test_labeler.py
...
def test_labeler_apply():
    ...
    entity_id_to_data_and_cutoff_dict = trane.ConstantCutoffTime(0, 0).generate_cutoffs(entity_to_data_dict, time_column)
    ...
    is_valid_prediction_problem, filter_column_order_of_types, label_generating_column_order_of_types = prediction_problem.is_valid_prediction_problem(table_meta, filter_column, label_generating_column)
