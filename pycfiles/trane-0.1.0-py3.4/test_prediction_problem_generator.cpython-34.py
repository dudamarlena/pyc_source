...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/tests/core/test_prediction_problem_generator.py
...
def test_order_of_operations():
    ...
    for problem in problems:
        ...
        if not issubclass(fourth_op.__class__, AggregationOpBase):
            raise AssertionError