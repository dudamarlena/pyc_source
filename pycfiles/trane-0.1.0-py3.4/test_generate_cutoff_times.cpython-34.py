...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/tests/utils/test_generate_cutoff_times.py
...
def test_fixed_cutoff_time():
    ...
    data = {'entity1': DataFrame({'col1': [1, 2, 3]}), 
...
def test_dynamic_cutoff_time():
    ...
    data = {'entity1': DataFrame({'col1': [1, 1, 1, 2, 3]}), 
