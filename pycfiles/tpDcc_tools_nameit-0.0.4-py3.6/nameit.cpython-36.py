...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/tools/nameit/widgets/nameit.py
# Compiled at: 2020-04-11 22:34:33
# Size of source mod 2**32: 49862 bytes
"""
...
class NameIt(base.BaseWidget, object):
    ...
    def _load_template_tokens(self):
        ...
        try:
            ...
            logger.error('Error while loading template tokens from: {} | {} | {}'.format(self.DATA_FILE, e, traceback.format_exc()))
