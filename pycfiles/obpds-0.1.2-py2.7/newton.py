...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/obpds/newton.py
# Compiled at: 2015-11-15 13:26:56
import logging
...
def scalar_newton(G, A, u0, rtol=0, atol=1e-06, tau=0.5, max_iter=100):
    """
...
def newton(G, A, u0, rtol=0, atol=1e-06, tau=0.5, max_iter=100):
    """
