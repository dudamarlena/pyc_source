...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/fourlth/loader.py
# Compiled at: 2013-07-12 01:32:24
"""Fourlth Loader
--------------
...
def loader(infile, prompt_str=None, interp=None):
    ...
    while True:
        ...
        for w in tups:
            if string_acc is None and w in ('."', 'ABORT"'):
                string_acc = list()
