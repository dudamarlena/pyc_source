...
# [GCC 8.4.0]
# Embedded file name: lib/python2.7/site-packages/openturns/dist_bundle3.py
# Compiled at: 2019-11-13 10:37:28
...
class Poisson(openturns.model_copula.DiscreteDistribution):
    ...
    It is evaluated using  Loader's algorithm, the *fast* and *accurate* method described in [loader2000]_, with the further improvements mentioned in [dimitriadis2016]_, see :class:`~openturns.DistFunc.dPoisson`.
    ...
    The sampling is done using the rejection algorithm described in [devroye1986]_ and [stadlober1990]_, see :class:`~openturns.DistFunc.rPoisson`.
...
class WeibullMinFactory(openturns.model_copula.DistributionFactoryImplementation):
    ...
    **Maximum likelihood based estimator:**
    ...
    def buildAsWeibull(self, *args):
        return _dist_bundle3.WeibullMinFactory_buildAsWeibull(self, *args)
