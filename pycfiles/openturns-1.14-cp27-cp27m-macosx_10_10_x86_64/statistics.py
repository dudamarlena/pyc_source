...
# [GCC 8.4.0]
# Embedded file name: lib/python2.7/site-packages/openturns/statistics.py
# Compiled at: 2019-11-13 10:36:50
"""Statistical classes."""
...
import openturns.common, openturns.typ, openturns.graph, openturns.func, openturns.geom
...
class ProductCovarianceModel(CovarianceModelImplementation):
    ...
    Notes
    -----
    The *product* covariance function is a covariance function with dimension :math:`d=1`. It defines a covariance model from the given collection as follows.
