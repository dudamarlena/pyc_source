...
# [GCC 8.4.0]
# Embedded file name: lib/python2.7/site-packages/openturns/graph.py
# Compiled at: 2019-11-13 10:37:13
"""Graphical output."""
...
class Pairs(DrawableImplementation):
    ...
    def setLabels(self, labels):
        ...
        labels : sequence of str
            Describes the data within the drawable element.
        """
        return _graph.Pairs_setLabels(self, labels)
    ...
    def setTitle(self, title):
        ...
        title : str
            Title of the Pairs.
        """
        return _graph.Pairs_setTitle(self, title)
    ...
    def getBoundingBox(self):
        ...
        boundingBox : :class:`~openturns.Interval` of dimension 2
            Bounding box of the drawable element
        """
        return _graph.Pairs_getBoundingBox(self)
    ...
    def __init__(self, *args):
        _graph.Pairs_swiginit(self, _graph.new_Pairs(*args))

    __swig_destroy__ = _graph.delete_Pairs


_graph.Pairs_swigregister(Pairs)
