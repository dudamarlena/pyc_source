...
# [GCC 8.4.0]
# Embedded file name: lib/python2.7/site-packages/openturns/typ.py
# Compiled at: 2019-11-13 10:37:06
"""Internal data types."""
...
class IndicesCollectionImplementationTypedInterfaceObject(openturns.common.InterfaceObject):
    ...
    def getImplementation(self, *args):
        ...
        """
        return _typ.IndicesCollectionImplementationTypedInterfaceObject_getImplementation(self, *args)
...
def Matrix___getattribute__(self, name):
    ...
    if name == '__array_interface__':
        self.__dict__['__array_interface__'] = {'shape': (self.getNbRows(), self.getNbColumns()), 'typestr': '|f' + str(self.__elementsize__()), 'data': (
                  int(self.__baseaddress__()), True), 
           'strides': (
                     self.__stride__(0), self.__stride__(1)), 
           'version': 3}
...
def Tensor___getattribute__(self, name):
    """Implement attribute accesses."""
    if name == '__array_interface__':
        self.__dict__['__array_interface__'] = {'shape': (self.getNbRows(), self.getNbColumns(), self.getNbSheets()), 'typestr': '|f' + str(self.__elementsize__()), 'data': (
                  int(self.__baseaddress__()), True), 
           'strides': (
                     self.__stride__(0), self.__stride__(1), self.__stride__(2)), 
           'version': 3}
...
def ComplexMatrix___getattribute__(self, name):
    """Implement attribute accesses."""
    if name == '__array_interface__':
        self.__dict__['__array_interface__'] = {'shape': (self.getNbRows(), self.getNbColumns()), 'typestr': '|c' + str(self.__elementsize__()), 'data': (
                  int(self.__baseaddress__()), True), 
           'strides': (
                     self.__stride__(0), self.__stride__(1)), 
           'version': 3}
...
def ComplexTensor___getattribute__(self, name):
    """Implement attribute accesses."""
    if name == '__array_interface__':
        self.__dict__['__array_interface__'] = {'shape': (self.getNbRows(), self.getNbColumns(), self.getNbSheets()), 'typestr': '|c' + str(self.__elementsize__()), 'data': (
                  int(self.__baseaddress__()), True), 
           'strides': (
                     self.__stride__(0), self.__stride__(1), self.__stride__(2)), 
           'version': 3}
...
def Sample___getattribute__(self, name):
    """Implement attribute accesses."""
    if name == '__array_interface__':
        self.__dict__['__array_interface__'] = {'shape': (self.getSize(), self.getDimension()), 'typestr': '|f' + str(self.__elementsize__()), 'data': (
                  int(self.__baseaddress__()), True), 
           'version': 3}
    ...
    for i in range(sampleSize):
        if ellipsis and sampleSize > 2 * printEllipsisSize:
            if i == printEllipsisSize:
                ...
                continue
            elif i > printEllipsisSize and i < sampleSize - printEllipsisSize:
                continue
