...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='phantompeakqualtools', anchor='phantompeakqualtools', href='https://www.encodeproject.org/software/phantompeakqualtools', info='computes informative enrichment and quality measures for ChIP-seq/DNase-seq/FAIRE-seq/MNase-seq data.')
