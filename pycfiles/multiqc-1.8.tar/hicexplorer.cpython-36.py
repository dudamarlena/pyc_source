...
# Size of source mod 2**32: 10700 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='HiCExplorer', anchor='hicexplorer', href='https://hicexplorer.readthedocs.io',
        ...
        self.add_section(name='Mapping statistics',
        ...
        self.add_section(name='Read filtering',
          ...
          description='This figure contains the number of reads that were finally used to build the Hi-C matrix along with the reads that where filtered out.',
        ...
        self.add_section(name='Contact distance',
        ...
        self.add_section(name='Read orientation',
            ...
            if len(l) == 0:
                ...
                if len(data_) == 0:
                    ...
                    if s[0].startswith('short range'):
                        ...
                        if s[0].startswith('same fragment'):
                            s[0] = 'same fragment'
                    s[0] = s[0].capitalize()
                    data[s[0]] = data_
    ...
    def hicexplorer_basic_statistics(self):
        ...
        for file in self.mod_data:
            ...
            data_ = {'Pairs considered': self.mod_data[file]['Pairs considered'][0], 
