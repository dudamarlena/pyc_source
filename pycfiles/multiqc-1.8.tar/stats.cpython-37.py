...
# Size of source mod 2**32: 9558 bytes
...
class StatsReportMixin:
    __doc__ = ' Mixin class, loaded by main samtools MuliqcModule class. '
    ...
    def parse_samtools_stats(self):
        ...
        if len(self.samtools_stats) > 0:
            ...
            self.add_section(name='Alignment metrics',
    ...
    def alignment_section(self, samples_data):
        ...
        self.add_section(name='Percent Mapped',
