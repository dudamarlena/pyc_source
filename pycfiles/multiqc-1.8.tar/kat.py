...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='K-mer Analysis Toolkit', anchor='kat', href='https://github.com/TGAC/KAT', info='is an toolkit for analysing sequencing data via its k-mer spectra.')
        self.kat_data = dict()
        ...
        self.add_section(name='KAT Distribution Analysis', anchor='kat-first', description='Table showing k-mer coverage distributions and if available GC distributions', helptext='This table can give a quick idea of potential contaminants that can be identified via unexpected numbers of k-mer or gc peaks in the data', plot=table.plot(self.kat_data, headers, kat_config))
