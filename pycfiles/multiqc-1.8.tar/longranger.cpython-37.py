...
# Size of source mod 2**32: 18511 bytes
...
class MultiqcModule(BaseMultiqcModule):
    __doc__ = ' Longranger module '

    def __init__(self):
        super(MultiqcModule, self).__init__(name='Long Ranger', anchor='longranger', href='https://www.10xgenomics.com/',
          info='A set of analysis pipelines that perform sample demultiplexing, barcode processing, alignment, quality control, variant calling, phasing, and structural variant calling.')
        ...
        self.add_section(name='Run stats',
          anchor='longranger-run-stats',
          description=('Statistics gathered from Longranger reports. There are more columns available but they are hidden by default.' + version_str),
        ...
        if len(phase_pdata) > 0:
            self.add_section(name='Phasing',
             ...
             'data_labels':[
              ...
              {'name':'% SNPs Phased', 
               'ylab':'% SNPs Phased',  'ymax':100},
              {'name':'% Genes Phased', 
               'ylab':'% Genes Phased',  'ymax':100}], 
             'cpswitch':False, 
             'stacking':None, 
             'ylab':'N50 of called phase blocks (bp)'})))
        mapping_counts_data = {}
        ...
        mapping_counts_cats['unmapped_reads'] = {'name':'Unaligned Reads', 
         'color':'#7f0000'}
        self.add_section(name='Alignment',
          ...
          plot=(bargraph.plot(mapping_counts_data, mapping_counts_cats, {'id':'longranger-alignment-plot', 
