...
# Compiled at: 2018-05-30 06:24:45
...
class MultiqcModule(BaseMultiqcModule):
    __doc__ = ' Kallisto module '

    def __init__(self):
        super(MultiqcModule, self).__init__(name='Kallisto', anchor='kallisto', href='http://pachterlab.github.io/kallisto/',
