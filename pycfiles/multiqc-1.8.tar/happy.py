...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/happy/happy.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        ...
        super(MultiqcModule, self).__init__(name='hap.py', anchor='happy', href='https://github.com/Illumina/hap.py', info=' is a set of programs based on htslib to benchmark variant calls against gold standard truth datasets. ' + 'The default shown fields should give the best overview of quality, but there are many other hidden ' + 'fields available. No plots are generated, as hap.py is generally run on single control samples (NA12878, etc.)' + '<br/><br/>' + 'Ideally, precision, recall and F1 Score should all be as close to 1 as possible.')
        self.happy_seen = set()
        ...
        if len(self.happy_data) > 0:
            ...
            self.add_section(name='hap.py', anchor='happy-plot', plot=table.plot(self.happy_data, gen_headers()))
