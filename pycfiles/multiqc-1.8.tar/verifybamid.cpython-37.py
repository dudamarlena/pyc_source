...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='VerifyBAMID', anchor='verifybamid', href='https://genome.sph.umich.edu/wiki/VerifyBamID',
        ...
        self.col_config_defaults = {'max':100, 
         ...
         'suffix':'%', 
         'format':'{:,.3f}', 
         'modify':lambda x:          if x != 'NA':
x * 100.0 # Avoid dead code: x, 
         'scale':'OrRd'}
    ...
    def verifybamid_table(self):
        ...
        headers['#READS'] = {'title':'{} Reads'.format(config.read_count_prefix), 
         ...
         'format':'{:,.1f}', 
         'modify':lambda x:          if x != 'NA':
x * config.read_count_multiplier # Avoid dead code: x, 
        ...
        self.add_section(anchor='verifybamid-table',
