...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Picard', anchor='picard', href='http://broadinstitute.github.io/picard/', info='is a set of Java command line tools for manipulating high-throughput sequencing data.')
