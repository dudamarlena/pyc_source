...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='HISAT2', anchor='hisat2', href='https://ccb.jhu.edu/software/hisat2/', info='is a fast and sensitive alignment program for mapping NGS reads (both DNA and RNA) against a reference genome or population of reference genomes.')
    ...
    def hisat2_alignment_plot(self):
        ...
        if len(pedata) > 0:
            ...
            pconfig = {'id': 'hisat2_pe_plot', 
               ...
               'ylab': '# Reads', 
               'cpswitch_counts_label': 'Number of Reads'}
            self.add_section(description='<em>Please note that single mate alignment counts are halved to tally with pair counts properly.</em>', plot=bargraph.plot(pedata, pekeys, pconfig))