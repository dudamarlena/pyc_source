...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='HTSeq Count', anchor='htseq',
          target='HTSeq Count',
          href='http://www-huber.embl.de/HTSeq/doc/count.html',
          info=' is part of the HTSeq Python package - it takes a file with aligned sequencing reads, plus a list of genomic features and counts how many reads map to each feature.')
