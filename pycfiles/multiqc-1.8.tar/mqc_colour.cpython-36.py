...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/utils/mqc_colour.py
...
import spectra, numpy as np, re, logging
logger = logging.getLogger(__name__)

class mqc_colour_scale(object):
    __doc__ = ' Class to hold a colour scheme. '
