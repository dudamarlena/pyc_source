...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='QUAST', anchor='quast', href='http://quast.bioinf.spbau.ru/',
        ...
        self.add_section(name='Number of Contigs',
        ...
        if ng_pdata:
            self.add_section(name='Number of Predicted Genes',
              anchor='quast-genes',
        ...
        if ng_pdata:
            self.add_section(name='Number of Partially Predicted Genes',
    ...
    def quast_predicted_genes_barplot(self, partial=False):
        ...
        if len(all_categories) > 0:
            return bargraph.plot(data, all_categories, {'id':'quast_' + ('partially_' if partial else '') + 'predicted_genes', 
