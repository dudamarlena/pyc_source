...
class MultiqcModule(BaseMultiqcModule, GroupReadsByUmiMixin):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='fgbio', anchor='fgbio', target='fgbio', href='http://fulcrumgenomics.github.io/fgbio/', info='  is a command line toolkit for working with genomic and particularly next generation sequencing data..')
        n = dict()
