...
class MultiqcModule(BaseMultiqcModule, BaseRecalibratorMixin, VariantEvalMixin):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='GATK', anchor='gatk', target='GATK', href='https://www.broadinstitute.org/gatk/', info=' is a toolkit offering a wide variety of tools with a primary focus on variant discovery and genotyping.')
