...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Flexbar', anchor='flexbar', href='https://github.com/seqan/flexbar',
    ...
    def parse_flexbar(self, f):
        ...
        def _save_data(parsed_data):
            if len(parsed_data) > 0:
                if 'processed_bases' in parsed_data:
                    if 'remaining_bases' in parsed_data:
