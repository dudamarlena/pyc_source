...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='RNA-SeQC', anchor='rna_seqc', href='https://software.broadinstitute.org/cancer/cga/rna-seqc', info='is a java program which computes a series of quality control metrics for RNA-seq data.')
    ...
    def coverage_lineplot(self):
        ...
        if len(data) > 0:
            self.add_section(name='Gene Body Coverage', anchor='rseqc-rna_seqc_mean_coverage', helptext='The metrics are calculated across the transcripts with tiered expression levels.', plot=linegraph.plot(data, pconfig))
    ...
    def plot_correlation_heatmap(self):
        ...
        if data is not None:
            ...
            self.add_section(name=('{} Correlation').format(corr_type), anchor='rseqc-rna_seqc_correlation', plot=heatmap.plot(data[1], data[0], data[0], pconfig))
        return