...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/damageprofiler/damageprofiler.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        ...
        """
        super(MultiqcModule, self).__init__(name='DamageProfiler:', anchor='damageprofiler', href='https://github.com/Integrative-Transcriptomics/DamageProfiler', info='a tool to determine damage patterns on ancient DNA.')
    ...
    def dmgprof_misinc_stats(self, dict_to_plot, readend, substitution):
        ...
        headers = OrderedDict()
        headers[('{}1').format(readend)] = {'id': ('misinc-stats-1st-{}-{}').format(readend, substitution), 
        ...
        headers[('{}2').format(readend)] = {'id': ('misinc-stats-2nd-{}-{}').format(readend, substitution), 
    ...
    def addSummaryMetrics(self, dict_to_plot):
        ...
        basic stats table at the top of the report """
        headers = OrderedDict()
        headers['std'] = {'title': 'Read length std. dev.', 
           ...
           'hidden': True}
        headers['median'] = {'title': 'Median read length', 
           'description': 'Median read length', 
           'suffix': 'bp', 
           'scale': 'YlGnBu', 
           'format': '{:,.2f}', 
           'shared_key': 'read_length'}
        headers['mean_readlength'] = {'title': 'Mean read length', 
    ...
    def lgdistplot(self, dict_to_use, orientation):
        ...
        if len(data) == 0:
            ...
            config = {'id': ('length-distribution-{}').format(orientation), 
    ...
    def threeprime_plot(self):
        ...
        config = {'id': 'threeprime_misinc_plot', 
    ...
    def fiveprime_plot(self):
        ...
        config = {'id': 'fiveprime_misinc_plot', 
