...
def parse_reports(self):
    ...
    if len(self.picard_RnaSeqMetrics_data) > 0:
        ...
        self.add_section(name='RnaSeqMetrics Assignment',
        ...
        if len(pdata) > 0:
            ...
            self.add_section(name='RnaSeqMetrics Strand Mapping',
        ...
        if len(self.picard_RnaSeqMetrics_histogram) > 0:
            pconfig = {'smooth_points':500, 
             ...
             'ymin':0}
            self.add_section(name='Gene Coverage',
