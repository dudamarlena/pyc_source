...
# Compiled at: 2017-10-05 10:01:20
# Size of source mod 2**32: 22044 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Bismark', anchor='bismark', href='http://www.bioinformatics.babraham.ac.uk/projects/bismark/',
    ...
    def bismark_alignment_chart(self):
        ...
        self.add_section(name='Alignment Rates',
    ...
    def bismark_strand_chart(self):
        ...
        config = {'id':'bismark_strand_alignment', 
         ...
         'cpswitch_counts_label':'Number of Reads'}
        self.add_section(name='Strand Alignment',
    ...
    def bismark_dedup_chart(self):
        ...
        config = {'id':'bismark_deduplication', 
         ...
         'cpswitch_c_active':False, 
         'cpswitch_counts_label':'Number of Reads'}
        self.add_section(name='Deduplication',
    ...
    def bismark_methlyation_chart(self):
        ...
        self.add_section(name='Cytosine Methylation',
