...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/bbmap/plot_indelhist.py
# Compiled at: 2017-12-06 12:59:18
...
def plot_indelhist(samples, file_type, **plot_args):
    ...
    columns_to_plot = {'Deletions': {0: 'Count'}, 
       'Insertions': {1: 'Count'}}
    plot_data = []
    ...
    plot_params = {'id': 'bbmap-' + file_type + '_plot', 
       ...
       'xlab': 'Indel size', 
       'data_labels': [{'name': 'Insertions', 'ylab': 'Insertion count'}, {'name': 'Deletions', 'ylab': 'Deletion count'}]}
