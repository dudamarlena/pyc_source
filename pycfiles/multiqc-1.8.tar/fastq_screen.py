...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='FastQ Screen', anchor='fastq_screen', href='http://www.bioinformatics.babraham.ac.uk/projects/fastq_screen/', info='allows you to screen a library of sequences in FastQ format against a set of sequence databases so you can see if the composition of the library matches with what you expect.')
