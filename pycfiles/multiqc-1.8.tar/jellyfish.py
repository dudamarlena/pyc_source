...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/jellyfish/jellyfish.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Jellyfish', anchor='jellyfish', href='http://www.cbcb.umd.edu/software/jellyfish/', info='is a tool for fast, memory-efficient counting of k-mers in DNA.')
    ...
    def frequencies_plot(self, xmin=0, xmax=200):
        ...
        pconfig = {'id': 'Jellyfish_kmer_plot', 
           ...
           'xmin': xmin, 
           'xmax': xmax}
        self.add_section(anchor='jellyfish_kmer_plot', description='The K-mer plot lets you estimate library complexity and coverage from k-mer content.', helptext=helptext, plot=linegraph.plot(self.jellyfish_data, pconfig))