...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Trimmomatic', anchor='trimmomatic', href='http://www.usadellab.org/cms/?page=trimmomatic', info='is a flexible read trimming tool for Illumina NGS data.')
