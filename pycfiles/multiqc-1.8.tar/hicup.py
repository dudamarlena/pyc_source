...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='HiCUP', anchor='hicup', href='http://www.bioinformatics.babraham.ac.uk/projects/hicup/', info='(Hi-C User Pipeline) is a tool for mapping and performing quality control on Hi-C data.')
        ...
        self.add_section(name='De-Duplication &amp; Di-Tag Separation', anchor='hicup-deduplication', plot=self.hicup_dedup_chart())
