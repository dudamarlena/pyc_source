...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/deeptools/plotFingerprint.py
# Compiled at: 2019-11-20 06:01:14
...
class plotFingerprintMixin:
    ...
    def parse_plotFingerprint(self):
        ...
        if len(self.deeptools_plotFingerprintOutRawCounts) > 0:
            self.add_section(name='Fingerprint plot', anchor='deeptools_fingerprint', description='Signal fingerprint according to plotFingerprint', plot=linegraph.plot(self.deeptools_plotFingerprintOutRawCounts, {'id': 'deeptools_fingerprint_plot', 
        ...
        if len(self.deeptools_plotFingerprintOutQualityMetrics) > 0:
            self.add_section(name='Fingerprint quality metrics', anchor='plotFingerprint', description='Various quality metrics returned by plotFingerprint', plot=linegraph.plot(self.deeptools_plotFingerprintOutQualityMetrics, {'id': 'plotFingerprint_quality_metrics', 
        ...
        return (
         len(self.deeptools_plotFingerprintOutQualityMetrics), len(self.deeptools_plotFingerprintOutRawCounts))
    ...
    def parsePlotFingerprintOutRawCounts(self, f):
        ...
        x = np.linspace(0, len(d[samples[0]]) - 1, endpoint=True, num=100, dtype=int)
