...
class FlagstatReportMixin:
    ...
    def parse_samtools_flagstats(self):
        ...
        if len(self.samtools_flagstat) > 0:
            ...
            self.add_section(name='Samtools Flagstat', anchor='samtools-flagstat', description='This module parses the output from <code>samtools flagstat</code>. All numbers in millions.', plot=beeswarm.plot(self.samtools_flagstat, keys, {'id': 'samtools-flagstat-dp'}))
