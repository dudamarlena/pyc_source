...
# Size of source mod 2**32: 48789 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='FastQC', anchor='fastqc', href='http://www.bioinformatics.babraham.ac.uk/projects/fastqc/',
          info='is a quality control tool for high throughput sequence data, written by Simon Andrews at the Babraham Institute in Cambridge.')
        ...
        self.status_colours = {'pass':'#5cb85c', 
         'warn':'#f0ad4e',  'fail':'#d9534f',  'default':'#999'}
    ...
    def read_count_plot(self):
        ...
        self.add_section(name='Sequence Counts',
    ...
    def sequence_quality_plot(self):
        ...
        if len(data) == 0:
            ...
            return
        pconfig = {'id':'fastqc_per_base_sequence_quality_plot', 
         ...
         'yPlotBands':[
          ...
          {'from':0, 
           'to':20,  'color':'#e6c3c3'}]}
        self.add_section(name='Sequence Quality Histograms',
    ...
    def per_seq_quality_plot(self):
        ...
        if len(data) == 0:
            ...
            return
        pconfig = {'id':'fastqc_per_sequence_quality_scores_plot', 
         ...
         'xPlotBands':[
          ...
          {'from':0, 
           'to':20,  'color':'#e6c3c3'}]}
        self.add_section(name='Per Sequence Quality Scores',
    ...
    def gc_content_plot(self):
        ...
        if len(data) == 0:
            ...
            return
        pconfig = {'id':'fastqc_per_sequence_gc_content_plot', 
        ...
        self.add_section(name='Per Sequence GC Content',
    ...
    def n_content_plot(self):
        ...
        if len(data) == 0:
            ...
            return
        pconfig = {'id':'fastqc_per_base_n_content_plot', 
         ...
         'yPlotBands':[
          ...
          {'from':0, 
           'to':5,  'color':'#c3e6c3'}]}
        self.add_section(name='Per Base N Content',
    ...
    def seq_length_dist_plot(self):
        ...
        if len(data) == 0:
            ...
            if not multiple_lenths:
                ...
                self.add_section(name='Sequence Length Distribution',
    ...
    def seq_dup_levels_plot(self):
        ...
        if len(data) == 0:
            log.debug('sequence_length_distribution not found in FastQC reports')
            return
        pconfig = {'id':'fastqc_sequence_duplication_levels_plot',  'title':'FastQC: Sequence Duplication Levels', 
         'categories':True, 
         'ylab':'% of Library', 
        ...
        self.add_section(name='Sequence Duplication Levels',
    ...
    def overrepresented_sequences(self):
        ...
        self.add_section(name='Overrepresented sequences',
    ...
    def adapter_content_plot(self):
        ...
        self.add_section(name='Adapter Content',
    ...
    def status_heatmap(self):
        ...
        pconfig = {'id':'fastqc-status-check-heatmap', 
         ...
         'legend':False, 
         'datalabels':False}
        self.add_section(name='Status Checks',
