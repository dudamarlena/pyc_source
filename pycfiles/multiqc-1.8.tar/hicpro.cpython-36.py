...
# Size of source mod 2**32: 18323 bytes
...
class MultiqcModule(BaseMultiqcModule):
    __doc__ = ' HiC-Pro module, parses log and stats files saved by HiC-Pro. '

    def __init__(self):
        super(MultiqcModule, self).__init__(name='HiC-Pro', anchor='hicpro', href='https://github.com/nservant/HiC-Pro',
        ...
        self.add_section(name='Read Mapping',
        ...
        self.add_section(name='Read Pairing',
        ...
        self.add_section(name='Read Pair Filtering',
        ...
        self.add_section(name='Contact Statistics',
          anchor='hicpro-rmdup',
        ...
        if allele_plot:
            self.add_section(name='Allele-specific analysis',
              anchor='hicpro-asan',
        ...
        if capture_plot:
            self.add_section(name='Capture analysis',
              anchor='hicpro-cap',
    ...
    def hicpro_as_chart(self):
        ...
        if num_samples == 0:
            ...
            config = {'id':'hicpro_asan_plot',  'title':'HiC-Pro: Allele-specific Statistics', 
             'ylab':'# Pairs', 
             'cpswitch_counts_label':'Number of Pairs'}
            return bargraph.plot(self.hicpro_data, keys, config)
    ...
    def hicpro_capture_chart(self):
        ...
        if num_samples == 0:
            ...
            config = {'id':'hicpro_cap_plot',  'title':'HiC-Pro: Capture Statistics', 
             'ylab':'# Pairs', 
             'cpswitch_counts_label':'Number of Pairs'}
            return bargraph.plot(self.hicpro_data, keys, config)