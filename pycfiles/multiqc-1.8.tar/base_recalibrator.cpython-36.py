...
# Size of source mod 2**32: 6012 bytes
...
class BaseRecalibratorMixin:
    ...
    def add_quality_score_vs_no_of_observations_section(self):
        ...
        plot = linegraph.plot(sample_data,
          pconfig={'title':'Observed Quality Score Counts', 
         'id':'gatk-base-recalibrator-quality-scores-plot', 
         'xlab':'Observed Quality Score', 
         'ylab':'Count', 
         'xDecimals':False, 
         'data_labels':data_labels})
        self.add_section(name='Observed Quality Scores',
          anchor='gatk-base-recalibrator-quality-scores',
          description='This plot shows the distribution of base quality scores in each sample before and after base quality score recalibration (BQSR). Applying BQSR should broaden the distribution of base quality scores.',
          helptext="For more information see [the Broad's description of BQSR](https://gatkforums.broadinstitute.org/gatk/discussion/44/base-quality-score-recalibration-bqsr).",
          plot=plot)
