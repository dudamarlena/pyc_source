...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Adapter Removal', anchor='adapterRemoval', target='Adapter Removal', href='https://github.com/MikkelSchubert/adapterremoval', info=' rapid adapter trimming, identification, and read merging ')
    ...
    def adapter_removal_retained_chart(self):
        ...
        self.add_section(name='Retained and Discarded Paired-End Collapsed', anchor='adapter_removal_retained_plot', description='The number of retained and discarded reads.', plot=bargraph.plot(self.adapter_removal_data, cats_pec, pconfig))
    ...
    def adapter_removal_length_dist_plot(self):
        ...
        if self.__any_paired:
            ...
            if self.__any_collapsed:
                ...
                data_labels.extend([{'name': 'Collapsed', 'ylab': 'Count'}, {'name': 'Collapsed Truncated', 'ylab': 'Count'}])
        ...
        self.add_section(name='Length Distribution Paired End Collapsed', anchor='ar_length_count', description='The length distribution of reads after processing adapter alignment.', plot=linegraph.plot(lineplot_data, pconfig))
        return