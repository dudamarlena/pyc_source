...
# Compiled at: 2017-12-14 11:41:44
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='sargasso', anchor='sargasso',
          href='http://statbio.github.io/Sargasso/',
          info='is a tool to separate mixed-species RNA-seq readsaccording to their species of origin.')
