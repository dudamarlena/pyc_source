...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='ClipAndMerge', anchor='clipandmerge', href='http://www.github.com/apeltzer/ClipAndMerge', info='is a tool for adapter clipping and read merging for ancient DNA data.')
