...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/bbmap/plot_qahist.py
# Compiled at: 2017-12-06 12:59:08
...
def plot_qahist(samples, file_type, **plot_args):
    ...
    plot_params = {'id': 'bbmap-' + file_type + '_plot', 
       ...
       'xlab': 'Quality score', 
       'data_labels': [{'name': 'Match', 'ylab': 'Match count'}, {'name': 'Substitution', 'ylab': 'Substitution count'}, {'name': 'Insertion', 'ylab': 'Insertion count'}, {'name': 'Deletion', 'ylab': 'Deletion count'}, {'name': 'TrueQuality', 'ylab': 'Count'}, {'name': 'TrueQualitySubtitution', 'ylab': 'Count'}]}
