...
class MultiqcModule(BaseMultiqcModule):
    __doc__ = ' This module is super weird. The output from this tools is essentially\n    identical to Picard MarkDuplicates, so we just hijack that module instead'

    def __init__(self):
        super(MultiqcModule, self).__init__(name='biobambam2', anchor='biobambam2', href='https://github.com/gt1/biobambam2',
          info='provides tools for early stage alignment file processing')
        self.general_stats_headers = OrderedDict()
        self.general_stats_data = dict()
        n = dict()
        n['bamsormadup'] = MarkDuplicates.parse_reports(self, log_key='biobambam2/bamsormadup',
