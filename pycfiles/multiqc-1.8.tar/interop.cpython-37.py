...
# Size of source mod 2**32: 17006 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Illumina InterOp Statistics', anchor='interop', href='http://illumina.github.io/interop/index.html',
        ...
        if len(self.runSummary) > 0:
            self.add_section(name='Read Metrics Summary',
        ...
        if len(self.indexSummary) > 0:
            ...
            self.add_section(name='Indexing QC Metrics details',
        ...
        for line in f:
            ...
            if line.startswith('Level,Yield,Projected Yield,Aligned,Error Rate,Intensity C1,%>=Q30'):
                ...
                if line.startswith('Total'):
                    section = None
            elif not line.startswith('Read') or section is None or section == 'details':
                section = 'details'
                read = line
            elif line.startswith('Lane,Surface,Tiles,Density,Cluster'):
                if section == 'details':
                    header = line.split(',')
            if section == 'details':
