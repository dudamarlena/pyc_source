...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='mtnucratio', anchor='mtnucratio', href='http://www.github.com/apeltzer/MTNucRatioCalculator', info='is a tool to compute mt/nuc ratios for NGS datasets.')
