...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Salmon', anchor='salmon', href='http://combine-lab.github.io/salmon/', info='is a tool for quantifying the expression of transcripts using RNA-seq data.')
