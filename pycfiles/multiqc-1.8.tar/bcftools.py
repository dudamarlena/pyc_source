...
class MultiqcModule(BaseMultiqcModule, StatsReportMixin):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Bcftools', anchor='bcftools', target='Bcftools', href='https://samtools.github.io/bcftools/', info=' contains utilities for variant calling and manipulating VCFs and BCFs.')
