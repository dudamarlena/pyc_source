...
# Size of source mod 2**32: 10890 bytes
...
def parse_reports(self):
    ...
    if len(self.qualimap_rnaseq_cov_hist) > 0:
        ...
        self.add_section(name='Gene Coverage Profile',
          ...
          plot=(linegraph.plot(self.qualimap_rnaseq_cov_hist, {'id':'qualimap_gene_coverage_profile', 
