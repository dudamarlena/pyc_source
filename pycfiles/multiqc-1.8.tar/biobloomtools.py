...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='BioBloom Tools', anchor='biobloomtools', href='https://github.com/bcgsc/biobloom/', info='creates filters for a genome reference and categorises sequences. This is faster than alignment and can be used for pre-processing and QC applications such as contamination detection.')
        self.bbt_data = dict()
        self.num_orgs = 0
