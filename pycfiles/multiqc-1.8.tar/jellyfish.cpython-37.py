...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Jellyfish', anchor='jellyfish', href='http://www.cbcb.umd.edu/software/jellyfish/',
    ...
    def frequencies_plot(self, xmin=0, xmax=200):
        ...
        pconfig = {'id':'Jellyfish_kmer_plot', 
         ...
         'xmin':xmin, 
         'xmax':xmax}
        self.add_section(anchor='jellyfish_kmer_plot',
