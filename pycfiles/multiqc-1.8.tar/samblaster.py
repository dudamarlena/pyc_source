...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Samblaster', anchor='samblaster', href='https://github.com/GregoryFaust/samblaster', info='is a tool to mark duplicates and extract discordant and split reads from sam files.')
