...
def custom_module_classes():
    ...
    sorted_modules.extend([parsed_mod for mod_id in mod_order if parsed_mod.anchor == mod_id for parsed_mod in parsed_modules])
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self, c_id, mod):
        ...
        if modname == '' or modname is None:
            ...
            super(MultiqcModule, self).__init__(name=modname,
