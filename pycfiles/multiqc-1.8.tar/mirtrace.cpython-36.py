...
# Size of source mod 2**32: 13975 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def mirtrace_length_plot(self):
        ...
        if len(data) == 0:
            ...
            config = {'id':'mirtrace_length_plot',  'title':'miRTrace: Read Length Distribution', 
             'ylab':'Read Count', 
             'xlab':'Read Lenth (bp)', 
             'ymin':0, 
             'xmin':0, 
    ...
    def mirtrace_contamination_check(self):
        ...
        for clade in self.contamination_data[list(self.contamination_data.keys())[0]]:
            keys[clade] = {'color':color_lib[idx], 
             'name':clade}
            if idx < 23:
                idx += 1
            else:
    ...
    def mirtrace_complexity_plot(self):
        ...
        if len(data) == 0:
            ...
            config = {'id':'mirtrace_complexity_plot',  'title':'miRTrace: miRNA Complexity Plot', 
