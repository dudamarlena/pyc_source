...
# Size of source mod 2**32: 27631 bytes
...
def parse_gc_dist(self, f):
    ...
    if reference_species:
        if reference_species not in self.qualimap_bamqc_gc_by_species:
...
def report_sections(self):
    ...
    if len(self.qualimap_bamqc_coverage_hist) > 0:
        ...
        self.add_section(name='Coverage histogram',
          ...
          plot=(linegraph.plot(self.qualimap_bamqc_coverage_hist, {'id':'qualimap_coverage_histogram', 
        ...
        self.add_section(name='Cumulative genome coverage',
          ...
          plot=(linegraph.plot(rates_within_threshs, {'id':'qualimap_genome_fraction', 
    ...
    if len(self.qualimap_bamqc_insert_size_hist) > 0:
        ...
        self.add_section(name='Insert size histogram',
          ...
          plot=(linegraph.plot(self.qualimap_bamqc_insert_size_hist, {'id':'qualimap_insert_size', 
    ...
    if len(self.qualimap_bamqc_gc_content_dist) > 0:
        ...
        if len(extra_series) == 1:
            ...
            if len(extra_series) > 1:
                ...
                lg_config['extra_series'] = extra_series
            self.add_section(name='GC content distribution',
