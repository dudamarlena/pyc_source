...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/deeptools/bamPEFragmentSizeDistribution.py
...
class bamPEFragmentSizeDistributionMixin:
    ...
    def parse_bamPEFragmentSizeDistribution(self):
        ...
        if len(self.deeptools_bamPEFragmentSizeDistribution) > 0:
            config = {'id': 'fragment_size_distribution_plot', 'title': 'deeptools: Fragment Size Distribution Plot', 
               'ylab': 'Occurrence', 
            ...
            self.add_section(name='Fragment size distribution', anchor='fragment_size_distribution', description='Distribution of paired-end fragment sizes', plot=linegraph.plot(self.deeptools_bamPEFragmentSizeDistribution, config))
