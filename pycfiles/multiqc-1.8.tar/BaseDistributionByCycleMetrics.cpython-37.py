...
def read_base_distrib_data(line_iter):
    ...
    try:
        ...
        while row:
            ...
            cycle = int(cycle)
            if not read_end == 1.0 or max_cycle_r1 is None or cycle > max_cycle_r1:
                max_cycle_r1 = cycle
            else:
                if max_cycle_r1 is not None:
...
def parse_reports(self):
    ...
    if len(self.picard_baseDistributionByCycle_data) > 0:
        ...
        self.add_section(name='Base Distribution',
