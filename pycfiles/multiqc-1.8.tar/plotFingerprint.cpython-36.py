...
# Size of source mod 2**32: 6754 bytes
...
class plotFingerprintMixin:
    ...
    def parse_plotFingerprint(self):
        ...
        if len(self.deeptools_plotFingerprintOutRawCounts) > 0:
            self.add_section(name='Fingerprint plot', anchor='deeptools_fingerprint',
              description='Signal fingerprint according to plotFingerprint',
              plot=(linegraph.plot(self.deeptools_plotFingerprintOutRawCounts, {'id':'deeptools_fingerprint_plot', 
        ...
        if len(self.deeptools_plotFingerprintOutQualityMetrics) > 0:
            self.add_section(name='Fingerprint quality metrics', anchor='plotFingerprint',
              description='Various quality metrics returned by plotFingerprint',
              plot=(linegraph.plot(self.deeptools_plotFingerprintOutQualityMetrics, {'id':'plotFingerprint_quality_metrics', 
