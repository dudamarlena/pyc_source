...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='BUSCO', anchor='busco', href='http://busco.ezlab.org/', info='assesses genome assembly and annotation completeness with Benchmarking Universal Single-Copy Orthologs.')
        ...
        for lin in lineages:
            self.add_section(name='Lineage Assessment' if lin is None else ('Lineage: {}').format(lin), anchor=('busco-lineage-{}').format(re.sub('\\W+', '_', str(lin))), plot=self.busco_plot(lin))
