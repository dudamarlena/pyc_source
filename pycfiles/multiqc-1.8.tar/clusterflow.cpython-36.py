...
# Size of source mod 2**32: 14221 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Cluster Flow', anchor='clusterflow', href='http://clusterflow.io',
    ...
    def clusterflow_commands_table(self):
        ...
        table_config = {'namespace':'Cluster Flow', 
         ...
         'sortRows':False, 
         'no_beeswarm':True}
        self.add_section(name='Commands',
        ...
        if not cf_file:
            ...
            if 'pipeline_id' not in data:
                if 'pipeline_name' in data:
                    if 'pipeline_start_dateparts' in data:
    ...
    def clusterflow_pipelines_section(self):
        ...
        table_config = {'namespace':'Cluster Flow', 
         ...
         'no_beeswarm':True, 
         'save_file':True}
        self.add_section(name='Pipelines',
