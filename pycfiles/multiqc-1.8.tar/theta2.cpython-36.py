...
# Size of source mod 2**32: 3682 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='THetA2', anchor='theta2', href='http://compbio.cs.brown.edu/projects/theta/',
          info='<em>(Tumor Heterogeneity Analysis)</em> estimates tumour purity and clonal / subclonal copy number.')
        ...
        self.add_section(name='Tumour Subclone Purities',
