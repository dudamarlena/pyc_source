...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/peddy/peddy.py
# Compiled at: 2019-11-13 08:47:00
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Peddy', anchor='peddy', href='https://github.com/brentp/peddy', info='calculates genotype :: pedigree correspondence checks, ancestry checks and sex checks using VCF files.')
        ...
        for f in self.find_log_files('peddy/background_pca'):
            ...
            self.peddy_data['background_pca'] = {'PC1': PC1, 
               'PC2': PC2, 'ancestry': ancestry}
            break
    ...
    def parse_peddy_csv(self, f, pattern):
        ...
        for l in f['f'].splitlines():
            ...
            if headers is None:
                ...
                try:
                    s_name_idx = [
                     headers.index('sample_id')]
                except ValueError:
                    try:
                        s_name_idx = [
                         headers.index('sample_a'), headers.index('sample_b')]
                    except ValueError:
    ...
    def peddy_pca_plot(self):
        ...
        if d:
            background = [ {'x': pc1, 'y': pc2, 'color': default_background_color, 'name': ancestry, 'marker_size': 1} for pc1, pc2, ancestry in zip(d['PC1'], d['PC2'], d['ancestry'])
                         ]
        ...
        pconfig = {'id': 'peddy_pca_plot', 'title': 'Peddy: PCA Plot', 
           'xlab': 'PC1', 
           'ylab': 'PC2', 
           'marker_size': 5, 
           'marker_line_width': 0}
    ...
    def peddy_relatedness_plot(self):
        ...
        pconfig = {'id': 'peddy_relatedness_plot', 
           'title': 'Peddy: Relatedness Plot', 
           'xlab': 'IBS0 (no alleles shared)', 
           'ylab': 'IBS2 (both alleles shared)'}
        if len(data) > 0:
            self.add_section(name='Relatedness', anchor='peddy-relatedness-plot', description='Shared allele rates between sample pairs. Points are coloured by degree of relatedness:\n                <span style="color: #6DA4CA;">less than 0.25</span>,\n                <span style="color: #FAA051;">0.25 - 0.5</span>,\n                <span style="color: #2B9F2B;">greather than 0.5</span>.', plot=scatter.plot(data, pconfig))
    ...
    def peddy_sex_check_plot(self):
        ...
        pconfig = {'id': 'peddy_sex_check_plot', 
