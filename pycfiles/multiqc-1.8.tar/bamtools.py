...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Bamtools', anchor='bamtools', href='https://github.com/pezmaster31/bamtools', info="provides both a programmer's API and an end-user's toolkit for handling BAM files.")
