...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.add_section(name='Read combination statistics',
        ...
        if not (self.flash_data or self.flash_hist):
            raise UserWarning
    ...
    def freqpoly_plot(data):
        ...
        fplotconfig = {'data_labels':[
          {'name':'Absolute', 
           'ylab':'Frequency',  'xlab':'Merged Read Length'},
          {'name':'Relative', 
           'ylab':'Relative Frequency',  'xlab':'Merged Read Length'}], 
    ...
    def hist_results(self):
        ...
        try:
            ...
            self.add_section(name='Frequency polygons of merged read lengths',
