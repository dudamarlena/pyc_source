...
# Size of source mod 2**32: 34626 bytes
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='BISCUIT', anchor='biscuit', href='https://github.com/zwdzwd/biscuit',
    ...
    def chart_align_mapq(self):
        ...
        self.add_section(name='Mapping Summary',
         ...
         (
          'UAligned', {'name': 'Unaligned Reads'})]), {'id':'biscuit_mapping_summary', 
        ...
        self.add_section(name='Mapping Quality Distribution',
          anchor='biscuit-mapq',
          description='This plot shows the distribution of primary mapping quality.',
          plot=(linegraph.plot(pd_mapping, {'id':'biscuit_mapping', 
    ...
    def chart_align_strand(self):
        ...
        self.add_section(name='Mapping Strand Distribution',
         ...
         OrderedDict([
          ...
          (
           '-+', {'name':'-+: Crick-Aligned, Waston-Bisulfite Conversion',  'color':'#46B29D'}),
          (
           '--', {'name':'--: Crick-Aligned, Crick-Bisulfite Conversion',  'color':'#324D5C'})])], {'id':'biscuit_strands', 
    ...
    def chart_align_isize(self):
        ...
        self.add_section(name='Insert Size Distribution',
          anchor='biscuit-isize',
          description='This plot shows the distribution of insert size.',
          plot=(linegraph.plot(pd_isize, {'id':'biscuit_isize', 
         'title':'BISCUIT: Insert Size Distribution',  'ymin':0, 
    ...
    def chart_covdist(self):
        ...
        self.add_section(name='Cumulative Base Coverage',
          ...
          plot=(linegraph.plot(mdata, {'id':'biscuit_coverage_base',  'title':'BISCUIT: Cumulative Base Coverage', 
         ...
         'data_labels':[
          {'name':'All', 
           'ylab':'Million Bases'},
          {'name':'Q40', 
           'ylab':'Million Bases (Q40)'},
          {'name':'Q40 low GC', 
           'ylab':'Million Low-GC Bases (Q40)'},
          {'name':'Q40 high GC', 
           'ylab':'Million High-GC Bases (Q40)'},
          {'name':'CpG (all)', 
           'ylab':'Million CpGs'},
          {'name':'CpG Q40', 
           'ylab':'Million CpGs (Q40)'},
          {'name':'CpG Q40 low GC', 
           'ylab':'Million Low-GC CpGs (Q40)'},
          {'name':'CpG Q40 high GC', 
           'ylab':'Million High-GC CpGs (Q40)'}]})))
        ...
        if len(basecov) == 0:
            return
        self.add_section(name='Coverage by At Least One Read',
          anchor='biscuit-coverage-base-table',
          description='The fraction of genome/genomic CpGs covered by at least one read.',
          plot=(table.plot(basecov, {'all':{'title':'Genome (All)', 
          'max':100,  'min':0,  'suffix':'%'}, 
         'uniq':{'title':'Genome (Unique)', 
          'max':100,  'min':0,  'suffix':'%'}, 
         'cpg_all':{'title':'CpG (All)', 
          'max':100,  'min':0,  'suffix':'%'}, 
         'cpg_uniq':{'title':'CpG (Unique)', 
          'max':100,  'min':0,  'suffix':'%'}})))
    ...
    def chart_qc_cv(self):
        ...
        self.add_section(name='Sequencing Depth',
    ...
    def chart_qc_cpg_dist(self):
        ...
        self.add_section(name='CpG Coverage vs Genomic Features',
        ...
        self.add_section(name='CpG Island Coverage',
 ...
 'botGC-q40')]
    ...
    def chart_retention_dist(self):
        ...
        self.add_section(name='Number of Retention Distribution',
          ...
          plot=(linegraph.plot(pd, {'id':'biscuit_retention_read_cpa', 
         'xlab':'Number of Retention within Read', 
         'title':'BISCUIT: Retention Distribution', 
         'data_labels':[
          {'name':'CpG retention', 
           'ylab':'Fraction of cytosine in CpG context',  'xlab':'Retention Level (%)'},
          {'name':'Within-read CpA', 
           'ylab':'Number of Reads'},
          {'name':'Within-read CpC', 
           'ylab':'Number of Reads'},
          {'name':'Within-read CpG', 
           'ylab':'Number of Reads'},
          {'name':'Within-read CpT', 
           'ylab':'Number of Reads'}]})))
    ...
    def chart_retention_cpg_readpos(self):
        ...
        self.add_section(name='Retention vs. Base Position in Read',
          ...
          plot=(linegraph.plot(mdata, {'id':'biscuit_retention_cytosine', 
         'xlab':'Position in Read', 
         'ymin':0,  'ymax':100,  'yMinRange':0,  'yFloor':0,  'title':'BISCUIT: Retention vs. Base Position in Read', 
         'data_labels':[
          {'name':'CpH Read 1', 
           'ylab':'CpH Retention Rate (%)',  'ymin':0,  'ymax':100},
          {'name':'CpH Read 2', 
           'ylab':'CpH Retention Rate (%)',  'ymin':0,  'ymax':100},
          {'name':'CpG Read 1', 
           'ylab':'CpG Retention Rate (%)',  'ymin':0,  'ymax':100},
          {'name':'CpG Read 2', 
           'ylab':'CpG Retention Rate (%)',  'ymin':0,  'ymax':100}]})))
