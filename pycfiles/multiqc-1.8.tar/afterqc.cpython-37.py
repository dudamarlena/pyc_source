...
# Compiled at: 2017-10-05 09:59:58
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='AfterQC', anchor='afterqc', href='https://github.com/OpenGene/AfterQC',
        ...
        self.add_section(name='Bad Reads',
          anchor='after_qc',
