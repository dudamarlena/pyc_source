...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/sargasso/sargasso.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='sargasso', anchor='sargasso', href='http://statbio.github.io/Sargasso/', info='is a tool to separate mixed-species RNA-seq readsaccording to their species of origin.')
    ...
    def parse_sargasso_logs(self, f):
        ...
        for idx, f_name in enumerate(self.sargasso_data.keys()):
            ...
            for key, value in list(self.sargasso_data[f_name].items()):
    ...
    def sargasso_stats_table(self):
        ...
        headers['sargasso_percent_assigned'] = {'title': '% Assigned', 
           ...
           'suffix': '%', 
           'scale': 'RdYlGn'}
        headers['Assigned-Reads'] = {'title': ('{} Assigned').format(config.read_count_prefix), 
    ...
    def sargasso_chart(self):
        ...
        config = {'id': 'sargasso_assignment_plot', 
