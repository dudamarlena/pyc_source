...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Prokka', anchor='prokka', href='http://www.vicbioinformatics.com/software.prokka.shtml', info='is a software tool for the rapid annotation of prokaryotic genomes.')
        self.prokka = dict()
