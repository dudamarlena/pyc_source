...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/bbmap/plot_aqhist.py
...
def plot_aqhist(samples, file_type, **plot_args):
    ...
    columns_to_plot = {'Counts': {0: 'Read1', 
                  2: 'Read2'}, 
       'Proportions': {1: 'Read1', 
                       3: 'Read2'}}
    plot_data = []
    ...
    plot_params = {'id': 'bbmap-' + file_type + '_plot', 
       ...
       'xmax': xmax, 
       'xlab': 'Quality score', 
       'data_labels': [{'name': 'Count data', 'ylab': 'Read count'}, {'name': 'Proportion data', 'ylab': 'Proportion of reads'}]}
