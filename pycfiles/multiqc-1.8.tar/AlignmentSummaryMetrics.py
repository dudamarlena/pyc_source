...
def parse_reports(self):
    ...
    if len(self.picard_alignment_metrics) > 0:
        ...
        self.add_section(name='Alignment Summary', anchor='picard-alignmentsummary', description="Plase note that Picard's read counts are divided by two for paired-end data.", plot=bargraph.plot(pdata, keys, pconfig))
