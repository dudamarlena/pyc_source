...
class MultiqcModule(BaseMultiqcModule):
    __doc__ = ' DeDup module '

    def __init__(self):
        super(MultiqcModule, self).__init__(name='DeDup', anchor='dedup', href='http://www.github.com/apeltzer/DeDup',
        ...
        self.add_section(description='This plot shows read categories that were either not removed (unique reads) or removed (duplicates).',
