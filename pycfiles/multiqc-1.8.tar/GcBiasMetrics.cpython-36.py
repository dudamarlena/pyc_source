...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/picard/GcBiasMetrics.py
# Compiled at: 2018-02-21 12:07:41
# Size of source mod 2**32: 4936 bytes
...
def parse_reports(self):
    ...
    if len(self.picard_GCbias_data) > 0:
        pconfig = {'id':'picard_gcbias_plot', 
         ...
         'yPlotLines':[
          {'value':1, 
           'color':'#999999',  'width':2,  'dashStyle':'LongDash'}]}
        self.add_section(name='GC Coverage Bias',
          anchor='picard-gcbias',
          description='This plot shows bias in coverage across regions of the genome with varying GC content. A perfect library would be a flat line at <code>y = 1</code>.',
