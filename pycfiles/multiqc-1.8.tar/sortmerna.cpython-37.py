...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/sortmerna/sortmerna.py
# Compiled at: 2017-10-05 10:06:14
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='SortMeRNA', anchor='sortmerna', href='http://bioinfo.lifl.fr/RNA/sortmerna/',
        ...
        headers = OrderedDict()
        headers['rRNA_pct'] = {'title':tab_header, 
                ...
                if 'Total reads =' in l:
                    ...
                    if 'Total reads failing' in l:
                        ...
                        if m:
                            ...
                            err = True
                    if 'By database:' in l:
                        post_database_start = post_database_start or True
    ...
    def sortmerna_detailed_barplot(self):
        ...
        pconfig = {'id':'sortmerna-detailed-plot', 
