...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='SeqyClean', anchor='seqyclean', href='https://github.com/ibest/seqyclean', info='is a pre-processing tool for NGS data that filters adapters, vectors, and contaminants while quality trimming.')
        ...
        self.add_section(name='Summary', anchor='seqyclean-summary', description='This plot shows the number of reads that were kept and discarded.', plot=self.seqyclean_summary())
        self.add_section(name='Annotations', anchor='seqyclean-annotation', description='This plot shows how reads were annotated.', plot=self.seqyclean_analysis())
        self.add_section(name='Discarded', anchor='seqyclean-discarded', description='This plot shows the breakdown of reasons for why reads were discarded.', plot=self.seqyclean_discarded())
