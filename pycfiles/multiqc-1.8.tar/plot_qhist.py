...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/bbmap/plot_qhist.py
...
def plot_qhist(samples, file_type, **plot_args):
    ...
    columns_to_plot = {'Linear': {0: 'Read1', 
                  3: 'Read2'}, 
       'Logarithmic': {1: 'Read1', 
                       4: 'Read2'}, 
       'Measured': {2: 'Read1', 
    ...
    plot_params = {'id': 'bbmap-' + file_type + '_plot', 
       ...
       'data_labels': [{'name': 'Linear', 'ylab': 'Quality score'}, {'name': 'Logarithmic', 'ylab': 'Log score'}, {'name': 'Measured', 'ylab': 'Measured quality value'}]}
