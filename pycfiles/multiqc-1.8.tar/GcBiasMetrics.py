...
def parse_reports(self):
    ...
    if len(self.picard_GCbias_data) > 0:
        ...
        self.add_section(name='GC Coverage Bias', anchor='picard-gcbias', description='This plot shows bias in coverage across regions of the genome with varying GC content. A perfect library would be a flat line at <code>y = 1</code>.', plot=linegraph.plot(self.picard_GCbias_data, pconfig))
