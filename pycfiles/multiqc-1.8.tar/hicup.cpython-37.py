...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/hicup/hicup.py
# Compiled at: 2017-12-07 02:01:26
...
class MultiqcModule(BaseMultiqcModule):
    __doc__ = ' HiCUP module, parses log files saved by HiCUP. '

    def __init__(self):
        super(MultiqcModule, self).__init__(name='HiCUP', anchor='hicup', href='http://www.bioinformatics.babraham.ac.uk/projects/hicup/',
        ...
        self.add_section(name='Read Truncation',
        ...
        self.add_section(name='De-Duplication &amp; Di-Tag Separation',
    ...
    def hicup_stats_table(self):
        ...
        headers = OrderedDict()
        headers['Percentage_Ditags_Passed_Through_HiCUP'] = {'title':'% Passed', 
         'description':'Percentage Di-Tags Passed Through HiCUP', 
         'max':100, 
         'min':0, 
         'suffix':'%', 
         'scale':'YlGn'}
        headers['Deduplication_Read_Pairs_Uniques'] = {'title':'{} Unique'.format(config.read_count_prefix), 
         'description':'Unique Di-Tags ({})'.format(config.read_count_desc), 
         'min':0, 
         'scale':'PuRd', 
         'modify':lambda x: x * config.read_count_multiplier, 
         'shared_key':'read_count'}
        headers['Percentage_Uniques'] = {'title':'% Duplicates', 
        ...
        headers['Valid_Pairs'] = {'title':'{} Valid'.format(config.read_count_prefix), 
         'description':'Valid Pairs ({})'.format(config.read_count_desc), 
         'min':0, 
         'scale':'PuRd', 
         'modify':lambda x: x * config.read_count_multiplier, 
         'shared_key':'read_count'}
        headers['Percentage_Valid'] = {'title':'% Valid', 
         'description':'Percent Valid Pairs', 
         'max':100, 
         'min':0, 
         'suffix':'%', 
         'scale':'YlGn'}
        headers['Paired_Read_1'] = {'title':'{} Pairs Aligned'.format(config.read_count_prefix), 
         'description':'Paired Alignments ({})'.format(config.read_count_desc), 
         'min':0, 
         'scale':'PuRd', 
         'modify':lambda x: x * config.read_count_multiplier, 
         'shared_key':'read_count'}
        headers['Percentage_Mapped'] = {'title':'% Aligned', 
    ...
    def hicup_truncating_chart(self):
        ...
        config = {'id':'hicup_truncated_reads_plot', 
    ...
    def hicup_alignment_chart(self):
        ...
        config = {'id':'hicup_mapping_stats_plot', 
    ...
    def hicup_filtering_chart(self):
        ...
        config = {'id':'hicup_filtering_plot', 
