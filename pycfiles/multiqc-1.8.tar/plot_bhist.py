...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/bbmap/plot_bhist.py
# Compiled at: 2017-12-06 12:59:21
...
def plot_bhist(samples, file_type, **plot_args):
    ...
    plot_params = {'id': 'bbmap-' + file_type + '_plot', 
       ...
       'ymin': 0, 
       'ymax': 100, 
       'data_labels': [{'name': 'Percentage of G+C bases'}, {'name': 'Percentage of A+T bases'}, {'name': 'Percentage of N bases'}]}
