...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='QoRTs', anchor='qorts', href='http://hartleys.github.io/QoRTs/', info='is toolkit for analysis, QC and data management of RNA-Seq datasets.')
