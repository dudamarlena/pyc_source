...
def parse_reports(self):
    ...
    if len(self.read_dist) > 0:
        ...
        self.add_section(name='Read Distribution',
          anchor='rseqc-read_distribution',
          description='<a href="http://rseqc.sourceforge.net/#read-distribution-py" target="_blank">Read Distribution</a> calculates how mapped reads are distributed over genome features.',
