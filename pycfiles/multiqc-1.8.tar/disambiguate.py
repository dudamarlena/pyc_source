...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/disambiguate/disambiguate.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Disambiguate', anchor='disambiguate', href='https://github.com/AstraZeneca-NGS/disambiguate', info='is an algorithm for disambiguating reads aligned to two different species (e.g. human and mouse).')
        self.data = {}
    ...
    def parse_summary(self, contents):
        ...
        for row in lines[1:]:
            ...
            sample = split[0]
            data[sample] = {'species_a': int(split[1]), 
    ...
    def add_stats_table(self):
        ...
        percentages = {sample:{k:v / totals[sample] * 100 for k, v in counts.items()} for sample, counts in self.data.items()}
        headers = {'species_a': {'title': '% Species a', 
    ...
    def add_stats_plot(self):
        ...
        plot_config = {'id': 'disambiguated_alignments', 
