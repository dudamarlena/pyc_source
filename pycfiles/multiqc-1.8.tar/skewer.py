...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/skewer/skewer.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Skewer', anchor='skewer', href='https://github.com/relipmoc/skewer', info='is an adapter trimming tool specially designed for processing next-generation sequencing (NGS) paired-end sequences.')
        ...
        if len(self.skewer_data) == 0:
            raise UserWarning
        headers = OrderedDict()
        headers['pct_trimmed'] = {'title': '% Trimmed', 
    ...
    def add_readlen_dist_plot(self):
        ...
        pconfig = {'id': 'skewer_read_length_histogram', 
    ...
    def add_skewer_data(self, s_name, data, f):
        stats = [
         'r_processed', 'r_short_filtered', 'r_empty_filtered', 'r_avail', 'r_trimmed', 'r_untrimmed']
