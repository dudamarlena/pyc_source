...
# Compiled at: 2018-01-23 12:04:16
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='Slamdunk', anchor='slamdunk', href='http://t-neumann.github.io/slamdunk/',
    ...
    def slamdunkFilterStatsTable(self):
        ...
        pconfig = {'id':'slamdunk_filtering_table', 
         'min':0}
        self.add_section(name='Filter statistics',
    ...
    def slamdunkOverallRatesPlot(self):
        ...
        self.add_section(name='Conversion rates per read',
    ...
    def slamdunkUtrRatesPlot(self):
        ...
        pconfig = {'id':'slamdunk_utrratesplot', 
         ...
         'tt_percentages':False, 
         'hide_zero_cats':False}
        self.add_section(name='Conversion rates per UTR',
    ...
    def slamdunkPCAPlot(self):
        ...
        self.add_section(name='PCA (T&gt;C based)',
          anchor='slamdunk_PCA',
    ...
    def slamdunkTcPerReadPosPlot(self):
        ...
        pconfig_tc = {'id':'slamdunk_tcperreadpos_plot', 
         ...
         'data_labels':[
          ...
          {'name':'Reverse reads -', 
           'ylab':'Percent converted %'}]}
        self.add_section(name='Non T&gt;C mismatches over read positions',
        ...
        self.add_section(name='T&gt;C conversions over read positions',
    ...
    def slamdunkTcPerUTRPosPlot(self):
        ...
        pconfig_nontc = {'id':'slamdunk_slamdunk_nontcperutrpos_plot', 
         ...
         'tt_label':'<b>Pos {point.x}</b>: {point.y:.2f} %', 
         'data_labels':[
          {'name':'UTRs on plus strand', 
           'ylab':'Percent mismatches %'},
          {'name':'UTRs on minus strand', 
           'ylab':'Percent mismatches %'}]}
        pconfig_tc = {'id':'slamdunk_slamdunk_tcperutrpos_plot', 
         ...
         'data_labels':[
          ...
          {'name':'UTRs on minus strand', 
           'ylab':'Percent converted %'}]}
        self.add_section(name='Non T&gt;C mismatches over UTR positions',
        ...
        self.add_section(name='T&gt;C conversions over UTR positions',
          anchor='tcperutrpos',
