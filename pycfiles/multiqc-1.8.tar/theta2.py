...
# [GCC 8.4.0]
# Embedded file name: /Users/philewels/GitHub/MultiQC/multiqc/modules/theta2/theta2.py
...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='THetA2', anchor='theta2', href='http://compbio.cs.brown.edu/projects/theta/', info='<em>(Tumor Heterogeneity Analysis)</em> estimates tumour purity and clonal / subclonal copy number.')
        ...
        self.add_section(name='Tumour Subclone Purities', anchor='theta2-purities', description='Purities of tumour subclones. <em>NB:</em> Only first maximum likelihood solution for each sample shown.', plot=self.theta2_purities_chart())
