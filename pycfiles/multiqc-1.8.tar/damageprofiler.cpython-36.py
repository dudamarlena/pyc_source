...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        super(MultiqcModule, self).__init__(name='DamageProfiler:', anchor='damageprofiler',
        ...
        if len(self.threepGtoAfreq_data) > 0:
            self.add_section(name='3P misincorporation plot',
        ...
        if len(self.fivepCtoTfreq_data) > 0:
            self.add_section(name='5P misincorporation plot',
        ...
        if len(self.lgdist_fw_data) > 0:
            if len(self.lgdist_rv_data) > 0:
                self.add_section(name='Forward read length distribution',
                ...
                self.add_section(name='Reverse read length distribution',
    ...
    def lgdistplot(self, dict_to_use, orientation):
        ...
        if len(data) == 0:
            ...
            config = {'id':'length-distribution-{}'.format(orientation),  'title':'DamageProfiler: Read length distribution: {} '.format(orientation), 
