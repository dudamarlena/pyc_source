...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/sisua/data/data_loader/cbmc_CITEseq.py
# Compiled at: 2019-09-16 07:13:56
...
_CITEseq_CBMC_PREPROCESSED = os.path.join(PREPROCESSED_BASE_DIR, 'CBMC_preprocessed')
