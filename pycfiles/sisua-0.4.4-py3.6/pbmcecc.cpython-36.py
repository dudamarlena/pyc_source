...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/sisua/data/data_loader/pbmcecc.py
# Compiled at: 2019-09-16 06:37:35
# Size of source mod 2**32: 2963 bytes
from __future__ import absolute_import, division, print_function
import base64, os, pickle, shutil, numpy as np
...
def read_PBMCeec(subset, override=False, verbose=False, filtered_genes=False):
    ...
    preprocessed_path = os.path.join(PREPROCESSED_BASE_DIR, 'PBMCecc_%s_preprocessed' % (subset + ('' if filtered_genes else 'full')))
    if override:
