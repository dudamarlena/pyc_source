...
# [GCC 8.4.0]
# Embedded file name: /home/vagrant/envs/conversocial/lib/python2.7/site-packages/shardmonster/tests/base.py
# Compiled at: 2016-08-05 04:34:07
import pymongo, unittest, test_settings
...
class ShardingTestCase(unittest.TestCase):
    ...
    def _prepare_connections(self):
        ...
        self.conn1, self.db1 = self._create_connection(test_settings.CONN1)
        self.conn2, self.db2 = self._create_connection(test_settings.CONN2)
        api.connect_to_controller(test_settings.CONTROLLER['uri'], test_settings.CONTROLLER['db_name'])
