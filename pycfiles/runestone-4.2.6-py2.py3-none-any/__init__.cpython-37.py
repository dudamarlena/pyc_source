...
# [GCC 8.4.0]
# Embedded file name: /srv/RunestoneComponents/runestone/__init__.py
...
def runestone_static_dirs():
    ...
    return module_static_js + module_static_css + module_static_image + module_static_bootstrap + [os.path.join(basedir, 'common/project_template/_static')]
...
def get_master_url():
    if socket.gethostname() in ('runestone-deploy', 'rsbuilder'):
        ...
        if 'RUNESTONE_HOST' in os.environ:
