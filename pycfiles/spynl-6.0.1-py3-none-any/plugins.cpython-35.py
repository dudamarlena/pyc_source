...
# [GCC 8.4.0]
# Embedded file name: /home/nicolas/workspace/spynl-git/venv/src/spynl/spynl/main/plugins.py
...
def find(config):
    ...
    if 'enable_plugins' in settings:
        ...
        enable_plugins = [e.name for e in iter_entry_points('spynl.plugins')]
...
class PluginsLoaded(object):
    __doc__ = ' Event to signal that all plugins have been loaded'
