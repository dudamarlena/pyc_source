...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/onepassword_local_search/OnePassword.py
...
class OnePassword:
    ...
    def mapping_update(self):
        ...
        for item in self.storageService.list(self.accountService.get_available_accounts_id()):
            ...
            if custom_uuid:
                self.storageService.add_uuid_mapping(custom_uuid=custom_uuid, op_uuid=(decrypted_item.uuid), lpass_uuid=lastpass_uuid)
    ...
    def is_authenticated(self, user_uuids=None):
        ...
        if user_uuids is None:
            user_uuids = [
             self.configFileService.get_user_uuid_from_latest_signin()]
