...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/onepassword_local_search/CliSimple.py
# Compiled at: 2019-05-24 16:38:48
# Size of source mod 2**32: 4172 bytes
...
class CliSimple:
    ...
    def __init__(self, *args):
        ...
        parser.add_argument('--disable-session-caching', help='disable session caching. The session caching is required for multi accounts setups.', nargs='?', default=False, const=True)
    ...
    def run(self):
        try:
            ...
            if hasattr(self.args, 'use_custom_uuid') and self.args.use_custom_uuid:
                ...
                if hasattr(self.args, 'use_lastpass_uuid'):
                    if self.args.use_lastpass_uuid:
