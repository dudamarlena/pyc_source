...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/onepassword_local_search/services/StorageService.py
...
class StorageService:
    ...
    con: Connection
    cur: Cursor
    uuid_mapping_table_name = 'uuid_mapping'
    uuid_mapping_table_name: str
    custom_uuid_mapping = None
    custom_uuid_mapping: str
    ...
    def get_item_by_uuid(self, uuid, custom_uuid_mapping=None):
        if self.custom_uuid_mapping is None:
