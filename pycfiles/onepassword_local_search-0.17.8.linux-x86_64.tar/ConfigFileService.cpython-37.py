...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/onepassword_local_search/services/ConfigFileService.py
...
class ConfigFileService:
    ...
    def _get_local_config():
        ...
        if op_config_path and not os_path.isfile(op_config_path):
    ...
    def get_latest_signin(self):
        if hasattr(self, 'latest_signin'):
            if self.latest_signin:
