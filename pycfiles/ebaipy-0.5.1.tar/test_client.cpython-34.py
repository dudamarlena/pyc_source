...
# [GCC 8.4.0]
# Embedded file name: /Users/bruce/project/ebaipy_project/trunk/tests/test_client.py
# Compiled at: 2019-07-12 02:23:38
...
class EbaiClientTestCase(unittest.TestCase):
    ...
    def test_sku_create(self):
        res = self.client.sku.create(shop_id=1096, upc='123456755444', name='香蕉300g', status=0, left_num=100, sale_price=1220, photos=[
         {'is_master': 1, 
