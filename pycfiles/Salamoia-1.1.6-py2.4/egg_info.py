...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/setuptools/egg_info.py
# Compiled at: 2007-12-02 16:26:53
"""
...
__all__ = [
 'check_salamoia_bundle', 'write_salamoia_bundle']
...
def check_salamoia_bundle(dist, attr, value):
    ...
    if not check():
        raise DistutilsSetupError('%r must be a dictionary of lists of strings or dicts (got %r)' % (attr, value))
