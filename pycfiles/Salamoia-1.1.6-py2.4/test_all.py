...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/tests/test_all.py
...
class UnitFinder(object):
    ...
    def isPackage(self, pack, x):
        return resource_isdir(pack, x) and x not in self.excludePackages and resource_exists(pack, x + '/__init__.py')
