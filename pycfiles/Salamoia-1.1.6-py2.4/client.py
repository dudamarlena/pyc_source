...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/frontends/client.py
...
class Client(object):
    ...
    def __init__(self, user='', password=''):
        ...
        self._baseUri = cfg.get('general', 'baseUri', 'hostello')
        self._username = user
    ...
    def connect(self):
        ...
        try:
            ...
            self._client = salamoia.h2o.xmlclient.Client(hostname, port, -1, username, password, base=self._baseUri, interfacePair=self._interfacePair)
        except:
            Ione.setLogMode('stderr')
            raise ConnectionError, 'error connecting %s %s %s' % (hostname, port, username)
