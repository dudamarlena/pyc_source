...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/nacl/ldap/fetchpattern.py
...
class LDAPFetchPatternService(object):
    ...
    def fetchPattern(self, searchSpec, attributes=None):
        ...
        res = c.search(search.filter(), attributes=mappedAttributes, scope=ldap.SCOPE_BASE)
