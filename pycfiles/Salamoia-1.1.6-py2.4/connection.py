...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/nacl/ldap/connection.py
...
class Connection:
    ...
    def __init__(self, user='', password=''):
        ...
        self.ldap_url.applyDefaults({'who': user, 'cred': password, 'scope': ldap.SCOPE_SUBTREE})
