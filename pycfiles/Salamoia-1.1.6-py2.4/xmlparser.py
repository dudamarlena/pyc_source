...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/h2o/xmlparser.py
...
class Element(object):
    ...
    def getAttribute(self, name, tal=False):
...
class RootElement(Element):
    ...
    def validate(self):
        ...
        """
        sio = StringIO()
        print >> sio, '<?xml version="1.0" encoding="utf-8"?><!DOCTYPE %s SYSTEM "%s">' % (self.rootElementName or self.__class__.__name__.lower(), resource_filename(self.__class__.__module__, self.dtd))
