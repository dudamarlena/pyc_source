...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/h2o/xmltal.py
...
class ConfigExpr(object):
    ...
    """
    __module__ = __name__
    accessorMap = {'string': Config.get, 'int': Config.getint, 'boolean': Config.getboolean, 'path': Config.getpath, 'paths': Config.getpaths}
