...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/salamoia/h2o/logioni.py
...
__all__ = [
 'Ione', 'LOG_INFO', 'LOG_WARNING', 'LOG_ERR', 'LOG_CRIT', 'LOG_ALERT', 'LOG_EMERG']
YELLOW = '\x1b[01;33m'
GREEN = '\x1b[01;32m'
BLUE = '\x1b[01;34m'
RED = '\x1b[01;31m'
...
class Ione(object):
    ...
    __module__ = __name__
    LOGlevel = LEVEL[0]
    logTypes = {LOG_INFO: 'Info', LOG_ERR: 'Error', LOG_WARNING: 'Warning', LOG_CRIT: 'Critical', LOG_ALERT: 'Alert', LOG_EMERG: 'Emergency'}
    ...
    def _log(self, *messages, **keywords):
        ...
        if percentCount:
            messages = (
             messages[0] % messages[1:percentCount + 1],) + messages[percentCount + 1:]
    ...
    def exception(cls, msg, *args, **keywords):
        ...
        if Config.defaultConfig().getboolean('debug', 'useDebugger', 'no'):
            import pdb
