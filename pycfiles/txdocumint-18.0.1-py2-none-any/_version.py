...
# [GCC 8.4.0]
# Embedded file name: /Users/jonathan/Coding/txdocumint/txdocumint/_version.py
# Compiled at: 2018-07-02 07:14:43
...
def get_config():
    ...
    cfg.style = 'pep440'
    cfg.tag_prefix = ''
    cfg.parentdir_prefix = 'txdocumint-'
    cfg.versionfile_source = 'txdocumint/_version.py'
    cfg.verbose = False
    return cfg
...
def git_versions_from_keywords(keywords, tag_prefix, verbose):
    ...
    return {'version': '0+unknown', 'full-revisionid': keywords['full'].strip(), 'dirty': False, 
...
def render(pieces, style):
    ...
    if pieces['error']:
        ...
        return {'version': rendered, 'full-revisionid': pieces['long'], 'dirty': pieces['dirty'], 
