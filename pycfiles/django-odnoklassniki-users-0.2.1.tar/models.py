...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-users/odnoklassniki_users/models.py
...
class User(OdnoklassnikiPKModel):
    ...
    photo_fields = [
     'pic1024x768', 'pic128max', 'pic128x128', 'pic180min',
    ...
    objects = UserManager()
    remote = UserRemoteManager(methods={'get': 'getInfo'})
