...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-users/odnoklassniki_users/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('odnoklassniki_users_user', (
         (
        ...
        db.send_create_signal('odnoklassniki_users', ['User'])

    def backwards(self, orm):
        db.delete_table('odnoklassniki_users_user')

    models = {'odnoklassniki_users.user': {'Meta': {'object_name': 'User'}, 'allows_anonym_access': (
