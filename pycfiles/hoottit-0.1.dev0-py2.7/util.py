...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/hoottit/util.py
# Compiled at: 2017-08-09 12:15:19
...
def make_user_agent(version, sitename):
    ...
    """
    return ('{sitename}-{system}:com.hootsuite.hoottit:v{version} (by /u/owlree)').format(sitename=sitename, version=version, system=platform.system())
