...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tagfs/__main__.py
# Compiled at: 2018-02-19 07:07:16
...
class DatabaseElementCli(click.MultiCommand):
    ...
    def _commands(self):
        if self._commands_lz is None:
            ...
            self._commands_lz = {i:getattr(self._obj.__class__, i) for i in dir(self._obj.__class__) if i.islower()}
...
class DatabaseCli(click.MultiCommand):
    ...
    def get_command(self, ctx, cmd_name):
        ...
        return DatabaseElementCli(getattr(self._obj, cmd_name)), *(self._args, name=cmd_name, **self._kwargs)
