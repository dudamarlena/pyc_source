...
# [GCC 8.4.0]
# Embedded file name: /home/cufrancis/Develop/BeautifulDebug/.env/lib/python3.6/site-packages/BeautifulDebug/utils.py
# Compiled at: 2017-10-23 08:10:21
...
import pprint, parser, cProfile, pstats, tracemalloc
init(autoreset=True)
...
class Dump(object):
    ...
    def run(self, obj, *args, **kw):
        ...
        if self.content is not None:
            if self.setting.content is True:
    ...
    def call_stack(self):
        ...
        for index, stack in enumerate(update):
            print(Fore.YELLOW + '\t{}: filename = {}, lineno = {}, function = {}'.format(index, stack['filename'], stack['lineno'], stack['function']))
