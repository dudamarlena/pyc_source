...
# [GCC 8.4.0]
# Embedded file name: /Users/Jvivian/Dropbox/School/PhD/Projects/rnaseq-lib/src/rnaseq_lib/data/__init__.py
# Compiled at: 2017-10-30 15:24:51
...
def load_gene_tissue_drug_map():
    ...
    return {k:{'tissue': set(g['tissue'].tolist()), 'drug': set(g['generic_name'].tolist())} for k, g in df.groupby('gene')}
