...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ChernMachine/kernel/VJob.py
# Compiled at: 2018-06-06 05:58:10
...
class VJob(object):
    __doc__ = ' Virtual class of the objects, including VVolume, VImage, VContainer\n    '
