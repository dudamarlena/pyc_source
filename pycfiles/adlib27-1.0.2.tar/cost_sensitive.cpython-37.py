...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/adlib/adversaries/cost_sensitive.py
...
class CostSensitive(Adversary):
    ...
    def __init__(self, Ua=None, Vi=None, Uc=None, Wi=None, learn_model=None, binary=False, scenario='synonym', Xdomain=None, training_instances=None, cost=None):
        """
    ...
    def get_available_params(self) -> Dict:
        params = {'measuring_cost':self.Vi,  'adversary_utility':self.Ua, 
