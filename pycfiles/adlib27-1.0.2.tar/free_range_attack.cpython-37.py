...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/adlib/adversaries/free_range_attack.py
...
class FreeRange(Adversary):
    ...
    def __init__(self, f_attack=0.2, manual_bound=False, xj_min=0.0, xj_max=1.0, binary=False, learn_model=None, distribution='uniform'):
        """
    ...
    def get_available_params(self) -> Dict:
        params = {'xj_min':self.xj_min,  'xj_max':self.xj_max, 
