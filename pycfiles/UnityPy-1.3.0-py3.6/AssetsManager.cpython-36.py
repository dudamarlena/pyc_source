...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\UnityPy\AssetsManager.py
...
class AssetsManager:
    ...
    def load_assets_from_memory(self, full_name: str, reader: EndianBinaryReader, original_path: str, unity_version=None):
        file_name = os.path.basename(full_name)
