...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\UnityPy\classes\AudioClip.py
...
class AudioClip(NamedObject):
    ...
    def __init__(self, reader):
        ...
        if version[0] < 5:
            ...
            reader.align_stream()
            if version[0] >= 4 or version[0] == 3 and version[1] >= 2:
            ...
            if self.m_Source:
                self.m_AudioData = get_resource_data(self.m_Source, self.assets_file, m_Offset, m_Size)
            else:
