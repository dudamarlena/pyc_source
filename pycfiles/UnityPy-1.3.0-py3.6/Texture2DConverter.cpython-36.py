...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\UnityPy\export\Texture2DConverter.py
# Compiled at: 2020-03-30 16:40:06
# Size of source mod 2**32: 10156 bytes
...
def swap_bytes_for_xbox(image_data: bytes, build_target: BuildTarget) -> bytes:
    ...
    :rtype: bytes
    """
    if build_target == BuildTarget.XBOX360:
...
XBOX_SWAP_FORMATS = [
 TF.RGB565, TF.DXT1, TF.DXT1Crunched, TF.DXT5, TF.DXT5Crunched]