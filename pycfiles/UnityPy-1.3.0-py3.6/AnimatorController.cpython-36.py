...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\UnityPy\classes\AnimatorController.py
...
class TransitionConstant:
    ...
    def __init__(self, reader):
        ...
        self.m_ConditionConstantArray = [ConditionConstant(reader) for _ in range(numConditions)]
...
class Blend2dDataConstant:
    ...
    def __init__(self, reader):
        ...
        self.m_ChildNeighborListArray = [MotionNeighborList(reader) for _ in range(numNeighbours)]
...
class BlendTreeNodeConstant:
    ...
    def __init__(self, reader):
        version = reader.version
        if version[0] > 4 or version[0] == 4 and version[1] >= 1:
        ...
        if version[0] > 4 or version[0] == 4 and version[1] > 1 or version[0] == 4 and version[1] == 1 and version[2] >= 3:
...
class StateConstant:
    ...
    def __init__(self, reader):
        ...
        self.m_TransitionConstantArray = [TransitionConstant(reader) for _ in range(numTransistions)]
        ...
        self.m_BlendTreeConstantArray = [BlendTreeConstant(reader) for _ in range(numBlends)]
        ...
        if version[0] > 2017 or version[0] == 2017 and version[1] >= 2:
...
class SelectorStateConstant:
    ...
    def __init__(self, reader):
        ...
        self.m_TransitionConstantArray = [SelectorTransitionConstant(reader) for _ in range(numTransitions)]
        self.m_FullPathID = reader.read_u_int()
...
class StateMachineConstant:
    ...
    def __init__(self, reader):
        ...
        self.m_AnyStateTransitionConstantArray = [TransitionConstant(reader) for _ in range(numAnyStates)]
        if version[0] >= 5:
            numSelectors = reader.read_int()
            self.m_SelectorStateConstantArray = [SelectorStateConstant(reader) for _ in range(numSelectors)]
...
class ValueArray:
    ...
    def __init__(self, reader):
        ...
        if version[0] < 4 or version[0] == 4 and version[1] < 3:
            ...
            self.m_PositionValues = [reader.read_vector3() if version[0] > 5 or version[0] == 5 and version[1] >= 4 else Vector3(reader.read_vector4()) for _ in range(numPosValues)]
            self.m_QuaternionValues = reader.read_vector4_array()
            numScaleValues = reader.read_int()
            self.m_ScaleValues = [reader.read_vector3() if version[0] > 5 or version[0] == 5 and version[1] >= 4 else Vector3(reader.read_vector4()) for _ in range(numScaleValues)]
        if version[0] > 5 or version[0] == 5 and version[1] >= 5:
            self.m_FloatValues = reader.read_float_array()
            self.m_IntValues = reader.read_int_array()
            self.m_BoolValues = reader.read_boolean_array()
...
class ControllerConstant:
    ...
    def __init__(self, reader):
        ...
        numStates = reader.read_int()
        self.m_StateMachineArray = [StateMachineConstant(reader) for _ in range(numStates)]
