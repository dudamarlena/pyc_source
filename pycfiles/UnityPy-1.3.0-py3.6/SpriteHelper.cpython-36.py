...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\UnityPy\export\SpriteHelper.py
...
def get_image(sprite, texture, alpha_texture) -> Image:
    if alpha_texture and getattr(alpha_texture, 'type', '') == 'Texture2D':
        cache_id = (
         texture.path_id, alpha_texture.path_id)
