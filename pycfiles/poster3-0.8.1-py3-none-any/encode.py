...
# Embedded file name: build/bdist.linux-x86_64/egg/poster/encode.py
# Compiled at: 2010-12-03 00:25:52
__doc__ = 'multipart/form-data encoding module\n\nThis module provides functions that faciliate encoding name/value pairs\nas multipart/form-data suitable for a HTTP POST or PUT request.\n\nmultipart/form-data is the standard way to upload files over HTTP'
__all__ = [
 'gen_boundary', 'encode_and_quote', 'MultipartParam', 'encode_string', 'encode_file_header', 'get_body_size', 'get_headers', 'multipart_encode']
try:
    import uuid
...
class MultipartParam(object):
    ...
    def __init__(self, name, value=None, filename=None, filetype=None, filesize=None, fileobj=None, cb=None):
...
def multipart_encode(params, boundary=None, cb=None):
    ...
    return (
     multipart_yielder(params, boundary, cb), headers)