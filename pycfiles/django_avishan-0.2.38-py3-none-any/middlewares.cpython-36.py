...
# Size of source mod 2**32: 9121 bytes
...
class Wrapper:
    ...
    def __init__(self, get_response):
        ...
        OpenApi('0.0.0', 'Documentation').export_json()
    ...
    def __call__(self, request: WSGIRequest):
        ...
        if current_request['messages']['debug'] or current_request['messages']['info'] or current_request['messages']['success'] or current_request['messages']['warning'] or current_request['messages']['error']:
