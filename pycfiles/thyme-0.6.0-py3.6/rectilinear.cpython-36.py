...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/thyme/model/rectilinear.py
# Compiled at: 2020-04-06 09:21:33
# Size of source mod 2**32: 8899 bytes
"""
...
class RectilinearFile(model.ModelFile):
    __doc__ = 'Read/process data from a rectilinear model NetCDF file.\n\n    Attributes:\n        path: Path (relative or absolute) of the file.\n    '
