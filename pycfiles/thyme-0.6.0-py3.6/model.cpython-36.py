...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/thyme/model/model.py
# Compiled at: 2020-04-06 09:21:33
# Size of source mod 2**32: 31109 bytes
"""
...
class ModelIndexFile:
    ...
    def init_nc(self, model_file, target_cellsize_meters, ofs_model, shoreline_shp=None, subset_grid_shp=None, subset_grid_field_name=None):
        ...
        if shoreline_shp is not None:
        ...
        elif subset_grid_shp is not None:
            ...
            if subset_grid_shp is None:
                ...
                if subset_grid_field_name is None:
