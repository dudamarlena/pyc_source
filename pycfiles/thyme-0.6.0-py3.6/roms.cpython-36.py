...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/thyme/model/roms.py
# Compiled at: 2020-04-06 09:21:33
# Size of source mod 2**32: 19483 bytes
"""
...
class ROMSFile(model.ModelFile):
    __doc__ = 'Read/process data from a ROMS model NetCDF file.\n\n    Attributes:\n        path: Path (relative or absolute) of the file.\n    '
    ...
    def uv_to_regular_grid(self, model_index, time_index, target_depth, interp_method=interp.INTERP_METHOD_SCIPY):
        ...
        u_target_depth, v_target_depth = vertical_interpolation(self.var_u, self.var_v, self.var_s_rho, self.var_mask_rho, self.var_mask_u, self.var_mask_v, self.var_zeta, self.var_h, self.var_hc, self.var_cs_r, self.var_vtransform, self.num_eta, self.num_xi, self.num_sigma, time_index, target_depth)
