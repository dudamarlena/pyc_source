...
# [GCC 8.4.0]
# Embedded file name: /home/sbo/lib/python3.4/site-packages/vaitk/gui/VPalette.py
...
class VPalette:
    ...
    class ColorRole:
        WindowText, Button, Light, Midlight, Dark, Mid, Text, BrightText, ButtonText, Base, Window, Shadow, Highlight, HighlightedText, Link, LinkVisited, AlternateBase, NoRole, ToolTipBase, ToolTipText = list(range(20))
    ...
    def setDefaults(self):
        self._colors = {(VPalette.ColorGroup.Active, VPalette.ColorRole.WindowText): VColor.VColor(rgb=(170, 170, 170)), 
         ...
         (VPalette.ColorGroup.Active, VPalette.ColorRole.Window): None, 
         ...
         (VPalette.ColorGroup.Active, VPalette.ColorRole.ToolTipBase): VColor.VColor(rgb=(170, 0, 170)), 
         (VPalette.ColorGroup.Active, VPalette.ColorRole.ToolTipText): VColor.VColor(rgb=(255, 255, 0)), 
         ...
         (VPalette.ColorGroup.Disabled, VPalette.ColorRole.Window): None, 
         ...
         (VPalette.ColorGroup.Inactive, VPalette.ColorRole.Window): None, 
