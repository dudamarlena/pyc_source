...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/juliart/client.py
# Compiled at: 2019-12-29 15:28:58
...
import juliart, argparse, sys, os
    ...
    for subparser in [generate, animate]:
        ...
        subparser.add_argument('--color',
         ...
         'random', 'pattern', 'glow'],
          ...
          type=str,
          default='random')
        subparser.add_argument('--rgb',
          dest='rgb',
          help='a specific rbg color, in format R,G,B',
          type=str,
          default=None)
        subparser.add_argument('--theme',
          dest='theme',
          choices=[
         'christmas',
         'easter',
...
def main():
    ...
    if args.version:
        ...
        sys.exit(0)
    elif hasattr(args, 'font'):
        font = args.font
        if not args.font.endswith('.ttf'):
            font = '%s.ttf' % font
    elif args.command == 'generate':
        juliaset = JuliaSet(resolution=(args.res),
          color=(args.color),
          ca=(args.ca),
          cb=(args.cb),
          theme=(args.theme),
        ...
        juliaset.write_text((args.text),
          fontsize=(args.fontsize),
          xcoord=(args.xcoord),
          ycoord=(args.ycoord),
          font=font,
          rgb=(
         255, 255, 255, args.font_alpha))
        juliaset.save_image(args.outfile)
    else:
        if args.command == 'animate':
            juliaset = JuliaSetAnimation(resolution=(args.res),
              color=(args.color),
              theme=(args.theme),
              rgb=(args.rgb),
              ca=(args.ca),
            ...
            juliaset.generate_animation(zoom=(args.zoom),
