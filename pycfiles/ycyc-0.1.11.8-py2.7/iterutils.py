...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/base/iterutils.py
...
def get_single_item(obj, default=None, logger=logger):
    ...
    if obj and len(obj) > 1:
        logger.warning('iterable object has more than 1 items, %s actually.', len(obj))
