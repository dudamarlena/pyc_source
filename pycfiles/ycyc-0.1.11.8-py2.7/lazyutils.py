...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/base/lazyutils.py
# Compiled at: 2016-02-25 04:17:16
import types, functools, importlib, sys
...
def lazy_import(module_name):
    ...
    return type(FakeModule.__name__, (
     FakeModule,), {'__getattribute__': getattribute})()
