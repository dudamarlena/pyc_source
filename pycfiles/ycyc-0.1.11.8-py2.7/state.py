...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/libs/statelib/state.py
...
class SequenceState(FreeState):
    ...
    def processing(self, allow_states=None):
        ...
        return self.base.processing(allow_states, self.next_state, self.__FailState__)
