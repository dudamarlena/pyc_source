...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/tools/jsonkit.py
...
class RichTypeJSONEncoder(object):
    ...
    def default_type_mapping(cls):
        import datetime, decimal, collections, types
        return {(set, frozenset, types.GeneratorType, types.XRangeType, collections.deque): list, 
           (collections.Mapping, collections.defaultdict, collections.Counter, collections.OrderedDict): dict, 
