...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/libs/process/deamon.py
# Compiled at: 2016-05-27 22:28:45
import os, sys
...
class DeamonProcess(object):
    ...
    def __init__(self, target=None, pidfile=None, stdin=None, stdout=None, stderr=None):
        self.target = target
        self._pid = None
