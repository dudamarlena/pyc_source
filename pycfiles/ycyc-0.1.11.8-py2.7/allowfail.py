...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/base/allowfail.py
        ...
        def protect(*args, **kwg):
            ...
            if exception:
                ...
                if hasattr(func, '__name__'):
                    ...
                    f_name = str(func)
                with AllowFail('On error handler %s' % f_name, logger=self.logger, exc_info=self.exc_info):
