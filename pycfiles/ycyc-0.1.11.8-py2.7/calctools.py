...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/base/calctools.py
...
class SafeCalc(ast.NodeTransformer):
    ...
    """
    globals = {'locals': None, 
       'globals': None, '__name__': None, '__file__': None, 
...
def select(dct_object, *args, **kwg):
    ...
    """
    return {k:getitems(dct_object, i) for k, i in chain(enumerate(args), kwg.iteritems())}