...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/tools/email_tools.py
# Compiled at: 2016-07-20 04:40:09
...
class EMail(object):
    SubType = constants(Plain='plain', HTML='html')

    def __init__(self, server, sender=None, receiver=None, subject='', content='', subtype='plain', charset='utf-8'):
    ...
    def mail(self):
        ...
        for i in self.attachment_paths:
            ...
            attachment.add_header('Content-Disposition', 'attachment', filename=i.name.strip())
