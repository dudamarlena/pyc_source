...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/tests/ycollections/test_heap.py
...
class TestHeap(TestCase):
    ...
    def test_headn(self):
        ...
        self.assertListEqual(heap.headn(3), [
         1, 3, 17])
    ...
    def test_tailn(self):
        heap = Heap([3, 1, 17, 25, 19])
        self.assertListEqual(heap.tailn(3), [
         17, 19, 25])
        heap = Heap([3, 1, 17, 25, 19], reverse=True)
        self.assertListEqual(heap.tailn(3), [
         17, 3, 1])
    ...
    def test_cmp_attrs(self):
        ...
        self.assertListEqual([ i.value for i in heap ], [
         2, 3, 0, 1, 4])
