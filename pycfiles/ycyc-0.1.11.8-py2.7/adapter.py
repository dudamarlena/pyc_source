...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/base/adapter.py
# Compiled at: 2016-02-25 04:48:00
"""
A adapter tool module
"""
import collections, sys, functools, types
...
def main_entry(main):
    ...
    if main.__module__ == '__main__':
        sys.exit(wraped_main() if main.func_code.co_argcount == 0 else wraped_main(sys.argv))
    return wraped_main
...
def proxy(obj):
    ...
    """
    return type('ProxyObject', (object,), {'__getattribute__': lambda _, k: getattr(obj, k)})()
