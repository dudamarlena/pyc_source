...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/ycyc/tests/base/test_filetools.py
...
class TestDirHelper(TestCase):
    ...
    def test_make_sure_dir_exists(self):
        with mock_patches('ycyc.base.filetools.os.path.exists', 'ycyc.base.filetools.os.makedirs') as (patches):
    ...
    def test_remove_dir(self):
        with mock_patches('ycyc.base.filetools.shutil.rmtree', 'ycyc.base.filetools.os.removedirs') as (patches):
    ...
    def test_make_sure_dir_empty(self):
        with mock_patches('ycyc.base.filetools.os.path.exists', 'ycyc.base.filetools.make_sure_dir_exists') as (patches):
            patches.exists.return_value = False
        ...
        with mock_patches('ycyc.base.filetools.os.path.exists', 'ycyc.base.filetools.os.listdir', 'ycyc.base.filetools.os.path.isdir', 'ycyc.base.filetools.remove_dir', 'ycyc.base.filetools.os.remove') as (patches):
            patches.exists.return_value = True
    ...
    def test_make_sure_not_exists(self):
        with mock_patches('ycyc.base.filetools.os.path.exists') as (patches):
            patches.exists.return_value = False
            filetools.make_sure_not_exists(self.Path)
            patches.exists.assert_called_once_with(self.Path)
        with mock_patches('ycyc.base.filetools.os.path.exists', 'ycyc.base.filetools.os.path.isdir', 'ycyc.base.filetools.remove_dir') as (patches):
            patches.exists.return_value = True
        ...
        with mock_patches('ycyc.base.filetools.os.path.exists', 'ycyc.base.filetools.os.path.isdir', 'ycyc.base.filetools.os.remove') as (patches):
            patches.exists.return_value = True
...
class TestChangeDir(TestCase):
    ...
    def test_usage(self):
        with mock_patches('ycyc.base.filetools.os.chdir') as (patches):
