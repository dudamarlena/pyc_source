...
# [GCC 8.4.0]
# Embedded file name: /home/edward/github/ImageDataExtractor/imagedataextractor/img_utils.py
# Compiled at: 2019-06-06 11:59:56
# Size of source mod 2**32: 5211 bytes
import cv2, numpy as np, keras.backend as K, os
...
"""
    ...
    for i in range(len(filteredvertices)):
        ...
        if annotate == True:
            ...
            cv2.putText(drawing_img, str(i + 1), (xcom + 3, ycom + 3), cv2.FONT_HERSHEY_COMPLEX, 0.4, (0,
                                                                                                       0,
                                                                                                       255), thickness=1)
