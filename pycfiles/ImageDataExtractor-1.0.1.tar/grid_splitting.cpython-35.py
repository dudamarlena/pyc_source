...
# [GCC 8.4.0]
# Embedded file name: /home/edward/github/ImageDataExtractor/imagedataextractor/grid_splitting.py
# Compiled at: 2019-05-20 06:43:25
# Size of source mod 2**32: 30415 bytes
...
def line_detection_and_split(gimg, show=False, eval_img=True):
    ...
    if horizontally_in_four > horizontally_in_half > 0:
        ...
        if eval_img == True:
            cv2.line(evaluation_img, (0, closest_from_top_1st), (cols, closest_from_top_1st), (0,
                                                                                               0,
                                                                                               255), 1)
            cv2.line(evaluation_img, (0, closest_from_bottom_1st), (cols, closest_from_bottom_1st), (0,
                                                                                                     0,
                                                                                                     255), 1)
            cv2.line(evaluation_img, (0, closest_from_top_2nd), (cols, closest_from_top_2nd), (0,
                                                                                               0,
                                                                                               255), 1)
            cv2.line(evaluation_img, (0, closest_from_bottom_2nd), (cols, closest_from_bottom_2nd), (0,
                                                                                                     0,
                                                                                                     255), 1)
            cv2.line(evaluation_img, (0, closest_from_top_3rd), (cols, closest_from_top_3rd), (0,
                                                                                               0,
                                                                                               255), 1)
            cv2.line(evaluation_img, (0, closest_from_bottom_3rd), (cols, closest_from_bottom_3rd), (0,
                                                                                                     0,
                                                                                                     255), 1)
    else:
        if horizontally_in_half > 0:
            ...
            if eval_img == True:
                cv2.line(evaluation_img, (0, closest_from_top), (cols, closest_from_top), (0,
                                                                                           0,
                                                                                           255), 1)
                cv2.line(evaluation_img, (0, closest_from_bottom), (cols, closest_from_bottom), (0,
                                                                                                 0,
                                                                                                 255), 1)
        else:
            if horizontally_in_thirds > 1:
            ...
            if vertically_in_four > vertically_in_half > 0:
                ...
                if eval_img == True:
                    cv2.line(evaluation_img, (closest_from_left_1st, 0), (closest_from_left_1st, rows), (0,
                                                                                                         0,
                                                                                                         255), 1)
                    cv2.line(evaluation_img, (closest_from_right_1st, 0), (closest_from_right_1st, rows), (0,
                                                                                                           0,
                                                                                                           255), 1)
                    cv2.line(evaluation_img, (closest_from_left_2nd, 0), (closest_from_left_2nd, rows), (0,
                                                                                                         0,
                                                                                                         255), 1)
                    cv2.line(evaluation_img, (closest_from_right_2nd, 0), (closest_from_right_2nd, rows), (0,
                                                                                                           0,
                                                                                                           255), 1)
                    cv2.line(evaluation_img, (closest_from_left_3rd, 0), (closest_from_left_3rd, rows), (0,
                                                                                                         0,
                                                                                                         255), 1)
                    cv2.line(evaluation_img, (closest_from_right_3rd, 0), (closest_from_right_3rd, rows), (0,
                                                                                                           0,
                                                                                                           255), 1)
            else:
                if vertically_in_half > 0:
                    ...
                    if len(img_split_horizontally) == 4:
                        ...
                        img_split_vertically.append(img_3_1)
                    if eval_img == True:
                        cv2.line(evaluation_img, (closest_from_left, 0), (closest_from_left, rows), (0,
                                                                                                     0,
                                                                                                     255), 1)
                        cv2.line(evaluation_img, (closest_from_right, 0), (closest_from_right, rows), (0,
                                                                                                       0,
                                                                                                       255), 1)
                else:
                    if vertically_in_thirds > 1:
    ...
    return (
     img_split_vertically, evaluation_img)