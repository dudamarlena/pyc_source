...
# [GCC 8.4.0]
# Embedded file name: imagedataextractor/scale_reading.py
...
def find_text_and_bar(thresholdedimg, gimg, rows, cols, show=False, printer=False, black_text=False):
    ...
    for i in boundingrectanglecoords:
        if printer == True:
            print (
             area_index, ' out of ', len(boundingrectanglecoords))
        is_box_in_box = False
        ...
        if region_size > rows * cols / 100:
            ...
            if conversion != None and scalevalue != None:
                ...
                if printer == True:
                    print (
                     'worked at pixel_value ', str(pixel_value + 5))
