...
# [GCC 8.4.0]
# Embedded file name: /home/edward/github/ImageDataExtractor/imagedataextractor/particle_identification.py
...
def particle_identification(img, inlaycoords, testing=False, blocksize=151, blursize=3, invert=False):
    ...
    if len(filteredvertices) > 0:
        ...
        filteredvertices, arealist = false_positive_correction(filteredvertices, arealist, colorlist, avgcolormean, avgcolorstdev,
          testing=testing, gimg=gimg)
        ...
        filteredvertices, particlediscreteness = discreteness_index_and_ellipse_fitting(filteredvertices, img, rows, cols,
          imgstdev, testing=testing)
