...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/flipy/solvers/cbc_solver.py
# Compiled at: 2020-03-05 00:26:40
...
class SolverError(Exception):
    __doc__ = ' Exception raised when a solver error is encountered '


class CBCSolver:
    __doc__ = ' A class for interfacing with cbc to solve LPs'
    STATUS_MAPPING = {'Optimal':SolutionStatus.Optimal, 
    ...
    CBC_BIN_PATH = {('Linux', '32bit'):'bin/cbc-linux64/cbc', 
    ...
    def _find_cbc_binary(cls) -> str:
        ...
        try:
            ...
            raise SolverError(f"no CBC solver found for system {system} {arch}, please set the solver path manually with environment variable 'CBC_SOLVER_BIN'")
