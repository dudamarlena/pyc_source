...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/tests/test_lp_constraint.py
# Compiled at: 2020-03-05 00:34:12
...
def lp_constraint_with_slack(lhs, rhs):
    return LpConstraint(lhs, 'leq', rhs, 'test_constraint', True, 10.0)


@pytest.mark.usefixtures('lhs', 'rhs', 'lp_constraint', 'lp_constraint_with_slack', 'x', 'y')
