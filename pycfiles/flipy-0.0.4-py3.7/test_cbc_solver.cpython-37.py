...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/tests/test_solvers/test_cbc_solver.py
...
class TestCBCSolver:
    ...
    def test_unknown_sys(self, mock_arch, mock_system, cbc_solver):
        ...
        assert str(e.value) == "no CBC solver found for system Plan9 32bit, please set the solver path manually with environment variable 'CBC_SOLVER_BIN'"
