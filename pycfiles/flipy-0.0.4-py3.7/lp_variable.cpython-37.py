...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/flipy/lp_variable.py
...
class VarType(Enum):
    __doc__ = ' Variable types for LpVariable '
    Continuous = 1
    Integer = 2
    Binary = 3
...
class LpVariable:
    __doc__ = ' A class representing a linear variable '

    def __init__(self, name: str, var_type: VarType=VarType.Continuous, up_bound: Optional[Numeric]=None, low_bound: Optional[Numeric]=None) -> None:
    ...
    def to_lp_str(self) -> str:
        ...
        if self.low_bound is None:
            ...
            elif self.up_bound is not None:
