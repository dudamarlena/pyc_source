...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/flipy/lp_expression.py
# Compiled at: 2020-03-05 23:47:07
...
class LpExpression:
    __doc__ = ' A class representing a linear expression '

    def __init__(self, name: str='', expression: Optional[Mapping[(LpVariable, Numeric)]]=None, constant: Numeric=0) -> None:
    ...
    def __eq__(self, other: 'LpExpression') -> bool:
        ...
        """
        return isinstance(other, LpExpression) and math.isclose(self.const, other.const) or False
