...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ccb/Clearcheckbook.py
...
class Clearcheckbook:
    ...
    def createTransact(self, date, amount, transaction_type, account, category, description):
        ...
        transact = Transaction(self.auth, self.cache, {'date': date, 'transaction_type': transaction_type, 'account_id': account_id, 
