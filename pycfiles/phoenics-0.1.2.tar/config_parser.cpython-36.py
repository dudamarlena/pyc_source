...
# [GCC 8.4.0]
# Embedded file name: /home/flo/Phoenics/master/src/phoenics/utilities/config_parser.py
...
from utilities import ParserJSON
...
class ConfigParser(Logger):
    TYPE_ATTRIBUTES = {'continuous': ['low', 'high']}
    ...
    def _parse_objectives(self, provided_settings):
        ...
        for hier_index in range(len(sort_indices)):
            if np.abs(hier_index - obj_configs['hierarchy'][sort_indices[hier_index]]) > 0.0001:
