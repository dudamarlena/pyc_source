...
# [GCC 8.4.0]
# Embedded file name: /home/flo/Phoenics/master/src/phoenics/utilities/logger.py
...
class Logger(object):
    ...
    WRITER = {'DEBUG':sys.stdout, 
     'INFO':sys.stdout,  'WARNING':sys.stderr, 
     'ERROR':sys.stderr,  'FATAL':sys.stderr}
    GREY = '0;37'
    WHITE = '1;37'
    YELLOW = ('1;33', )
    LIGHT_RED = ('1;31', )
    RED = '0;31'
    COLORS = {'DEBUG':WHITE, 
     'INFO':GREY,  'WARNING':YELLOW,  'ERROR':LIGHT_RED,  'FATAL':RED}
