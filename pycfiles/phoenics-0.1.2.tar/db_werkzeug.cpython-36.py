...
# [GCC 8.4.0]
# Embedded file name: /home/flo/Phoenics/master/src/phoenics/DatabaseHandler/db_werkzeug.py
# Compiled at: 2019-11-24 14:22:37
# Size of source mod 2**32: 4367 bytes
"""
...
class DB_Werkzeug(Logger):
    ...
    def _check_existance_cache(self, condition):
        for attr, value in condition.items():
            if value not in self.cache[attr]:
                return False
