...
# [GCC 8.4.0]
# Embedded file name: /home/flo/Phoenics/master/src/phoenics/BayesianNetwork/EdwardInterface/numpy_graph.py
...
class NumpyGraph(object):
    ...
    def compute_kernels(self, posteriors):
        ...
        activations = [
         np.tanh, np.tanh, lambda x: x]
        post_layer_outputs = [
         np.array([self.features for _ in range(self._num_draws)])]
