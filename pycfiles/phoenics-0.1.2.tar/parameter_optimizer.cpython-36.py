...
# [GCC 8.4.0]
# Embedded file name: /home/flo/Phoenics/master/src/phoenics/Acquisition/parameter_optimizer.py
...
class ParameterOptimizer(Logger):
    ...
    def optimize(self, kernel, sample, max_iter=10):
        ...
        for num_iter in range(max_iter):
            ...
            if np.any(self.pos_continuous) and np.linalg.norm(sample_copy - optimized) < 1e-07:
                break
            else:
