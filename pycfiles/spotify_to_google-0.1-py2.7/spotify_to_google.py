...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spotify_to_google/spotify_to_google.py
# Compiled at: 2017-07-09 09:04:21
""" Simple python script

Imports Spotify playlists into your Google Play Music account
"""
import sys, spotipy, spotipy.oauth2 as oauth2
...
def generate_token():
    ...
    credentials = oauth2.SpotifyClientCredentials(client_id='e003d5914588476f95a135976de0ab16', client_secret='3c7b3f8f1ccc4a81a8f86792b6efeb3e')
    ...
    if playlists:
        for playlist in playlists['items']:
            if playlist['owner']['id'] == spotify_user:
                logger.info('Current playlist:', playlist['name'], 'total tracks:', playlist['tracks']['total'])
                results = spotify.user_playlist(spotify_user, playlist['id'], fields='tracks,next')
