...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/repoze/what/predicates.py
...
__all__ = [
 'Predicate', 'CompoundPredicate', 'All', 'Any',
...
class Predicate(object):
    ...
    def eval_with_environ(self, environ):
        ...
        msg = 'Predicate._eval_with_environ(environ) is deprecated for forward compatibility with repoze.what v2; define Predicate.evaluate(environ, credentials) instead'
