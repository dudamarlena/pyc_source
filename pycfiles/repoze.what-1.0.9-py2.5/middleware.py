...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/repoze/what/middleware.py
...
class AuthorizationMetadata(object):
    ...
    def _find_groups(self, identity):
        ...
        return (
         tuple(groups), tuple(permissions))
    ...
    def add_metadata(self, environ, identity):
        ...
        environ['repoze.what.adapters'] = {'groups': self.group_adapters, 
           'permissions': self.permission_adapters}
        logger and logger.info('User belongs to the following groups: %s' % str(groups))
        logger and logger.info('User has the following permissions: %s' % str(permissions))
