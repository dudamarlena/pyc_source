...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp/smi/mibs/SNMP-COMMUNITY-MIB.py
...
snmpCommunityEntry = MibTableRow((1, 3, 6, 1, 6, 3, 18, 1, 1, 1)).setIndexNames((1,
                                                                                 'SNMP-COMMUNITY-MIB',
                                                                                 'snmpCommunityIndex'))
if mibBuilder.loadTexts:
...
snmpCommunityMIBCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 18, 2, 1, 1)).setObjects(('SNMP-COMMUNITY-MIB',
...
snmpProxyTrapForwardCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 18, 2, 1, 2)).setObjects(('SNMP-COMMUNITY-MIB',
...
snmpCommunityMIBFullCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 18, 2, 1, 3)).setObjects(('SNMP-COMMUNITY-MIB',
                                                                                               'snmpCommunityTableGroup'))
if mibBuilder.loadTexts:
...
snmpCommunityTableGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 18, 2, 2, 1)).setObjects(('SNMP-COMMUNITY-MIB',
                                                                                   'snmpCommunityName'), ('SNMP-COMMUNITY-MIB',
                                                                                                          'snmpCommunitySecurityName'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                         'snmpCommunityContextEngineID'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                                                           'snmpCommunityContextName'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                                                                                         'snmpCommunityTransportTag'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                                                                                                                        'snmpCommunityStorageType'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                                                                                                                                                      'snmpCommunityStatus'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                                                                                                                                                                               'snmpTargetAddrTMask'), ('SNMP-COMMUNITY-MIB',
                                                                                                                                                                                                                                                                                                                        'snmpTargetAddrMMS'))
if mibBuilder.loadTexts:
...
snmpProxyTrapForwardGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 18, 2, 2, 3)).setObjects(('SNMP-COMMUNITY-MIB',
                                                                                     'snmpTrapAddress'), ('SNMP-COMMUNITY-MIB',
                                                                                                          'snmpTrapCommunity'))
if mibBuilder.loadTexts:
