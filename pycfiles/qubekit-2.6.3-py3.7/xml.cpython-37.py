...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/QUBEKit/parametrisation/xml.py
...
class XML(Parametrisation):
    __doc__ = 'Read in the parameters for a molecule from an XML file and store them into the molecule.'
