...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/QUBEKit/engines/rdkit.py
# Compiled at: 2019-09-20 10:07:20
# Size of source mod 2**32: 7481 bytes
...
class RDKit:
    __doc__ = 'Class for controlling useful RDKit functions.'
    ...
    def mm_optimise(self, filename, ff='MMF'):
        ...
        {'MMF':MMFFOptimizeMolecule, 
         'UFF':UFFOptimizeMolecule}[ff](mol)
