...
# Embedded file name: build/bdist.macosx-10.6-intel/egg/breinify/brein_exception.py
# Compiled at: 2017-04-17 20:39:20
...
class invalidArgumentException(ValueError):
    ...
    def __init__(self, value, expected):
        super(invalidArgumentException, self).__init__("Got '" + str(value) + "' expected one of " + str(expected), value)
