...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/papis_rofi/config.py
# Compiled at: 2019-03-18 20:33:14
...
"""
import papis.config
configuration_settings = {'rofi-gui': {'key-quit': 'Alt+q', 
              'key-query': 'Alt+y', 
              'key-refresh': 'Alt+r', 
              'key-edit': 'Alt+e', 
              'key-delete': 'Alt+d', 
