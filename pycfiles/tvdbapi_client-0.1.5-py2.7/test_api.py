...
# [GCC 8.4.0]
# Embedded file name: build/bdist.cygwin-2.6.0-i686/egg/tvdbapi_client/tests/test_api.py
# Compiled at: 2015-09-06 18:32:17
import datetime, os, testtools
...
def disabled():
    return not os.environ.get('TEST_API_KEY') or not os.environ.get('TEST_API_USER') or not os.environ.get('TEST_API_PASSWORD')
...
class ApiTest(base.BaseTest):
    ...
    def setUp(self):
        ...
        self.client = api.TVDBClient(apikey=os.environ.get('TEST_API_KEY'), username=os.environ.get('TEST_API_USER'), userpass=os.environ.get('TEST_API_PASSWORD'))
    ...
    def test_get_episodes(self):
        ...
        episodes = self.client.get_episodes(80379, airedSeason=3, airedEpisode=7)
        self.assertEqual(len(episodes), 1)
        self.assertEqual(episodes[0].get('episodeName'), 'The Guitarist Amplification')
...
class SimpleApiTest(base.BaseTest):
    ...
    def test_get_configured_client(self):
        client = tvdbapi_client.get_client(apikey=os.environ.get('TEST_API_KEY'), username=os.environ.get('TEST_API_USER'), userpass=os.environ.get('TEST_API_PASSWORD'), service_url='https://api-dev.thetvdb.com', verify_ssl_certs=True, select_first=False)
        self.assertIsInstance(client, api.TVDBClient)
        client.authenticate()
