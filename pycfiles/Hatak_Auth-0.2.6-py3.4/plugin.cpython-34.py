...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/haplugin/auth/plugin.py
# Compiled at: 2015-04-19 16:44:40
...
class AuthPlugin(Plugin):
    ...
    def append_routes(self):
        ...
        self.route.add('auth.controllers.LoginController', 'auth:login', '/login')
        self.route.add('auth.controllers.LogoutController', 'auth:logout', '/logout')
        self.route.add_view('auth.controllers.ForbiddenController', context=Forbidden)
