...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/haplugin/auth/tests/test_plugin.py
# Compiled at: 2014-10-08 05:22:20
...
class AuthPluginTests(TestCase):
    ...
    def test_add_request_plugins(self):
        ...
        self.mocks['add_request_plugin'].assert_any_call(UserClassRequestPlugin)
    ...
    def test_add_controller_plugins(self):
        ...
        self.mocks['add_controller_plugin'].assert_called_once_with(AuthControllerPlugin)
...
class UserRequestPluginTests(TestCase):
    ...
    def test_get_user(self):
        ...
        the same id"""
        self.request.session = {'user_id': 100}
        self.parent.User.get_by_id.reset_mock()
        result = self.plugin.return_once()
        self.assertEqual(self.parent.User.get_by_id.return_value, result)
...
class AuthControllerPluginTests(ControllerPluginTests):
    ...
    def test_before_filter(self):
        ...
        self.plugin.user.has_access_to_controller.assert_called_once_with(self.controller)
    ...
    def test_generate_default_data(self):
        ...
        self.plugin.user.assign_request.assert_called_once_with(self.controller.request)