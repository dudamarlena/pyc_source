...
# [GCC 8.4.0]
# Embedded file name: C:\Users\scars\Desktop\soscikit_github\soscikit\stats_tools\tools.py
# Compiled at: 2019-11-11 09:10:33
# Size of source mod 2**32: 9518 bytes
...
def plot_dist_frequenza(distribuzione, tipo='categoriale', Y='Percentuale', x_label='Valori', y_label='Percentuale', figsize=(12, 8), missing=None):
    ...
    for index, row in distribuzione.iterrows():
        ...
        g.text(x, (row[Y] - row[Y] * 0.5), stringa, color='black', ha='center')
        x = x + 1
