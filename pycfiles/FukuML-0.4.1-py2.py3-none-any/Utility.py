...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/Utility.py
# Compiled at: 2016-12-10 12:07:28
from __future__ import division
import numpy as np, pickle, math, random, itertools
...
class DatasetLoader(object):
    ...
    def modify_XY(X, Y, class_item):
        ...
        return (
         np.array(modify_X), np.array(modify_Y))
