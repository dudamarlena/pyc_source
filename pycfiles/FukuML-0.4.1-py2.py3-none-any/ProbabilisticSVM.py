...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/ProbabilisticSVM.py
# Compiled at: 2016-12-10 12:07:28
import os, numpy as np, FukuML.Utility as utility, FukuML.SupportVectorMachine as svm, FukuML.LogisticRegression as logistic_regression, FukuML.MLBase as ml
...
class ProbabilisticSVM(ml.Learner):
    ...
    def set_param(self, feed_mode='batch', step_eta=0.126, updates=2000, C=0.1):
        ...
        self.C = C
        return (
         self.feed_mode, self.step_eta, self.updates, self.C)
