...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/L2RLogisticRegression.py
# Compiled at: 2016-12-10 12:07:28
import numpy as np, FukuML.LogisticRegression as logistic_regression
...
class L2RLogisticRegression(logistic_regression.LogisticRegression):
    ...
    def set_param(self, feed_mode='batch', step_eta=0.126, updates=2000, lambda_p=0.0001):
        ...
        return (
         self.feed_mode, self.step_eta, self.updates, self.lambda_p)
