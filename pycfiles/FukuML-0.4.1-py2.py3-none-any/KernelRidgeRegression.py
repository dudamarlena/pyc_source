...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/KernelRidgeRegression.py
# Compiled at: 2016-12-10 12:07:28
import os, itertools, numpy as np, FukuML.Utility as utility, FukuML.RidgeRegression as ridge_regression
...
class KernelRidgeRegression(ridge_regression.RidgeRegression):
    ...
    def set_param(self, lambda_p=0.0001, gamma=1, C=0.1):
        ...
        self.C = C
        return (
         self.lambda_p, self.gamma, self.C)
