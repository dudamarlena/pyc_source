...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/LogisticRegression.py
# Compiled at: 2016-12-10 12:07:28
import os, random, operator, itertools, numpy as np, FukuML.Utility as utility, FukuML.MLBase as ml, FukuML.LinearRegression as linear_regression
random.seed(1)
...
class LogisticRegression(ml.Learner):
    ...
    def set_param(self, feed_mode='batch', step_eta=0.126, updates=2000):
        ...
        return (
         self.feed_mode, self.step_eta, self.updates)
