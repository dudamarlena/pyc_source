...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/PLA.py
# Compiled at: 2016-12-10 12:07:28
import os, random, itertools, numpy as np, FukuML.Utility as utility, FukuML.MLBase as ml, FukuML.LinearRegression as linear_regression
random.seed(1)
...
class BinaryClassifier(ml.Learner):
    ...
    def set_param(self, loop_mode='naive_cycle', step_alpha=1):
        self.loop_mode = loop_mode
        self.step_alpha = step_alpha
        return (
         self.loop_mode, self.step_alpha)
...
class MultiClassifier(BinaryClassifier):
    ...
    def set_param(self, loop_mode='naive_cycle', step_alpha=1):
        return super(MultiClassifier, self).set_param(loop_mode, step_alpha)
    ...
    def prediction(self, input_data='', mode='test_data'):
        ...
        return {'input_data_x': prediction['input_data_x'], 
