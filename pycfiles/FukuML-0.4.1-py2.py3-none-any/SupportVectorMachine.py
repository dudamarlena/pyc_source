...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/SupportVectorMachine.py
# Compiled at: 2016-12-10 12:07:28
import os, itertools, numpy as np, cvxopt, cvxopt.solvers, FukuML.Utility as utility, FukuML.MLBase as ml, FukuML.LinearRegression as linear_regression
...
class BinaryClassifier(ml.Learner):
    ...
    def train(self):
        ...
        if self.svm_kernel == 'soft_polynomial_kernel' or self.svm_kernel == 'soft_gaussian_kernel':
            ...
            free_sv = np.logical_and(a > 1e-05, a < self.C)
