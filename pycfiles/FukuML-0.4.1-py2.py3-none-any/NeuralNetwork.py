...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/NeuralNetwork.py
# Compiled at: 2016-12-10 12:07:28
import os, random, numpy as np, FukuML.Utility as utility, FukuML.MLBase as ml
random.seed(1)
...
class NeuralNetwork(ml.Learner):
    ...
    def set_param(self, network_structure=[
 8, 3, 1], w_range_high=0.1, w_range_low=-0.1, feed_mode='stochastic', step_eta=0.01, updates=50000):
        ...
        return (
         self.network_structure, self.w_range_high, self.w_range_low, self.feed_mode, self.step_eta, self.updates)
