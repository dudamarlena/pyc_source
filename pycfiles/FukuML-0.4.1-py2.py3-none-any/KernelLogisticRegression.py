...
# [GCC 8.4.0]
# Embedded file name: /Users/fukuball/Projects/fuku-ml/FukuML/KernelLogisticRegression.py
# Compiled at: 2016-12-10 12:07:28
import random, numpy as np, FukuML.Utility as utility, FukuML.L2RLogisticRegression as l2r_logistic_regression
random.seed(1)
...
class KernelLogisticRegression(l2r_logistic_regression.L2RLogisticRegression):
    ...
    def set_param(self, feed_mode='batch', step_eta=0.126, updates=2000, lambda_p=0.0001, gamma=1, C=0.1):
        ...
        self.C = C
        return (
         self.feed_mode, self.step_eta, self.updates, self.lambda_p, self.gamma, self.C)
