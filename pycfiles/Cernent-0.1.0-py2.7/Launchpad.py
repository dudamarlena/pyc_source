...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/gui/cGui/main/Launchpad.py
# Compiled at: 2012-04-22 16:14:00
"""
.. module:: Launchpad
   :platform: Unix
...
class Launchpad(object):
    ...
    def _initScanEditButton(self):
        self.edit = CButton(master=self.masterFrame, text='Edit Scan Event', command=self._scanEditPressed)
    ...
    def _initScanNewButton(self):
        self.new = CButton(master=self.masterFrame, text='New Scan Event', command=self._scanNewPressed)
    ...
    def _initReportButton(self):
        self.report = CButton(master=self.masterFrame, text='Reports', command=self._reportPressed)
