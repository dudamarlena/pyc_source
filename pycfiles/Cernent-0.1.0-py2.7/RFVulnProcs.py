...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ReportFramework/RFVulnProcs.py
# Compiled at: 2012-04-20 01:24:42
import re
...
def commonOffenders(rpt, tgt, vuln):
    ...
    -- In general follow the report.x (e.g. report.microsoft) variable to see where and how
       it is referenced.
    """
    COMMONOFFENDERS = {'microsoft': '^MS|microsoft', 'office': 'Office|Excel|Word|Works|PowerPoint', 
