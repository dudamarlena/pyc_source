...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_vendor/pep517/wrappers.py
    ...
    def _call_hook(self, hook_name, kwargs):
        ...
        with tempdir() as (td):
            ...
            self._subprocess_runner([
             sys.executable, _in_proc_script, hook_name, td], cwd=self.source_dir, extra_environ={'PEP517_BUILD_BACKEND': build_backend})
