...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/requests/requests/auth.py
...
def _basic_auth_str(username, password):
    ...
    if not isinstance(password, basestring):
        warnings.warn(("Non-string passwords will no longer be supported in Requests 3.0.0. Please convert the object you've passed in ({!r}) to a string or bytes object in the near future to avoid problems.").format(password), category=DeprecationWarning)
