...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_internal/build_env.py
...
class _Prefix:
    ...
    def __init__(self, path):
        self.path = path
        self.setup = False
        self.bin_dir = get_paths('nt' if os.name == 'nt' else 'posix_prefix', vars={'base': path, 'platbase': path})['scripts']
...
class BuildEnvironment(object):
    ...
    def __init__(self):
        ...
        self._prefixes = OrderedDict((name, _Prefix(os.path.join(self._temp_dir.path, name))) for name in ('normal',
                                                                                                           'overlay'))
        self._bin_dirs = []
        self._lib_dirs = []
