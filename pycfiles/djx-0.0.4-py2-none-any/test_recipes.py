...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/more-itertools/more_itertools/tests/test_recipes.py
...
class AccumulateTests(TestCase):
    ...
    def test_custom_function(self):
        ...
        self.assertEqual(list(mi.accumulate((1, 2, 3, 2, 1), func=max)), [1, 2, 3, 3, 3])
...
class TailTests(TestCase):
    ...
    def test_equal(self):
        ...
        self.assertEqual(list(mi.tail(7, 'ABCDEFG')), ['A', 'B', 'C', 'D', 'E', 'F', 'G'])

    def test_less(self):
        """Length of iterable is less than requested tail"""
        self.assertEqual(list(mi.tail(8, 'ABCDEFG')), ['A', 'B', 'C', 'D', 'E', 'F', 'G'])
...
class GrouperTests(TestCase):
    ...
    def test_even(self):
        ...
        """
        self.assertEqual(list(mi.grouper(3, 'ABCDEF')), [('A', 'B', 'C'), ('D', 'E', 'F')])
    ...
    def test_odd(self):
        ...
        """
        self.assertEqual(list(mi.grouper(3, 'ABCDE')), [('A', 'B', 'C'), ('D', 'E', None)])
        return

    def test_fill_value(self):
        """Test that the fill value is used to pad the final group"""
        self.assertEqual(list(mi.grouper(3, 'ABCDE', 'x')), [
         ('A', 'B', 'C'), ('D', 'E', 'x')])
...
class RandomCombinationTests(TestCase):
    ...
    def test_no_replacement(self):
        ...
        self.assertRaises(ValueError, lambda : mi.random_combination(items, len(items) + 1))
