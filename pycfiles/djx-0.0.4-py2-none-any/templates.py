...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/core/management/templates.py
# Compiled at: 2019-02-14 00:35:17
import cgi, errno, io, mimetypes, os, posixpath, re, shutil, stat, sys, tempfile
from os import path
import django
...
class TemplateCommand(BaseCommand):
    ...
    def validate_name(self, name, app_or_project):
        ...
        if six.PY2:
            ...
            raise CommandError('%r is not a valid %s name. Please make sure the name is a valid identifier.' % (
             name, app_or_project))
        return
