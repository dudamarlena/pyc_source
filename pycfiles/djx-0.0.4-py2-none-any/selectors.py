...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/gunicorn/gunicorn/selectors.py
...
class SelectSelector(_BaseSelectorImpl):
    ...
    def select(self, timeout=None):
        ...
        ready = []
        try:
            r, w, _ = wrap_error(self._select, self._readers, self._writers, [], timeout)
...
if hasattr(select, 'kqueue'):
    ...
    class KqueueSelector(_BaseSelectorImpl):
        ...
        def select(self, timeout=None):
            ...
            ready = []
            try:
                kev_list = wrap_error(self._kqueue.control, None, max_ev, timeout)
            except InterruptedError:
                return ready
