...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/py/py/_io/terminalwriter.py
...
def ansi_print(text, esc, file=None, newline=True, flush=False):
    ...
    if esc and win32_and_ctypes and file.isatty():
        if 1 in esc:
            ...
            bold = False
        esctable = {(): FOREGROUND_WHITE, (31, ): FOREGROUND_RED, (32, ): FOREGROUND_GREEN, 
...
class TerminalWriter(object):
    ...
    def __init__(self, file=None, stringio=False, encoding=None):
        ...
        elif py.builtin.callable(file) and not (hasattr(file, 'write') and hasattr(file, 'flush')):
