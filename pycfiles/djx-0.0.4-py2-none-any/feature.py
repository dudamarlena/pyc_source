...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/contrib/gis/gdal/feature.py
...
class Feature(GDALBase):
    ...
    def fields(self):
        ...
        return [ capi.get_field_name(capi.get_field_defn(self._layer._ldefn, i)) for i in range(self.num_fields)
               ]
