...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_internal/req/req_install.py
# Compiled at: 2019-02-14 00:35:06
from __future__ import absolute_import
import logging, os, shutil, sys, sysconfig, zipfile
...
from pip._internal.utils.misc import _make_build_dir, ask_path_exists, backup_dir, call_subprocess, display_path, dist_in_site_packages, dist_in_usersite, ensure_dir, get_installed_version, redact_password_from_url, rmtree
...
if MYPY_CHECK_RUNNING:
    from typing import Optional, Iterable, List, Union, Any, Text, Sequence, Dict
...
class InstallRequirement(object):
    ...
    def __init__(self, req, comes_from, source_dir=None, editable=False, link=None, update=True, markers=None, use_pep517=None, isolated=False, options=None, wheel_cache=None, constraint=False, extras=()):
    ...
    def _correct_build_location(self):
        ...
        if self.source_dir is not None:
            ...
            assert self._ideal_build_dir is not None and self._ideal_build_dir.path
    ...
    def load_pyproject_toml(self):
        ...
        """
        pep517_data = load_pyproject_toml(self.use_pep517, self.pyproject_toml, self.setup_py, str(self))
        if pep517_data is None:
            ...
            def runner(cmd, cwd=None, extra_environ=None):
                with open_spinner(self.spin_message) as (spinner):
                    call_subprocess(cmd, cwd=cwd, extra_environ=extra_environ, show_stdout=False, spinner=spinner)
                self.spin_message = ''
        ...
        if not self.source_dir:
            ...
            with indent_log():
                if self.use_pep517:
                    ...
                    self.run_egg_info()
            if self.req or isinstance(parse_version(self.metadata['Version']), Version):
                op = '=='
            else:
                op = '==='
