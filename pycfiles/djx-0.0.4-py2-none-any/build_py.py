...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-QtVhoA/setuptools/setuptools/command/build_py.py
# Compiled at: 2019-02-06 16:42:30
from glob import glob
from distutils.util import convert_path
import distutils.command.build_py as orig, os, fnmatch, textwrap, io, distutils.errors, itertools
...
class build_py(orig.build_py, Mixin2to3):
    ...
    def check_package(self, package, package_dir):
        ...
        with io.open(init_py, 'rb') as (f):
            contents = f.read()
        if 'declare_namespace' not in contents:
