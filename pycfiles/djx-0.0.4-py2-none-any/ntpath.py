...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/ant/code/djx/build/lib/python2.7/ntpath.py
...
if 'ce' in sys.builtin_module_names:
    ...
    if 'os2' in sys.builtin_module_names:
        altsep = '/'
    devnull = 'nul'
    ...
    def _abspath_split(path):
        ...
        return (
         is_unc, prefix, [ x for x in rest.split(sep) if x ])
