...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-QtVhoA/setuptools/setuptools/build_meta.py
...
"""
import os, sys, tokenize, shutil, contextlib, setuptools, distutils
__all__ = [
...
class _BuildMetaBackend(object):
    ...
    def run_setup(self, setup_script='setup.py'):
        ...
        code = f.read().replace('\\r\\n', '\\n')
        f.close()
        exec compile(code, __file__, 'exec') in locals()
    ...
    def prepare_metadata_for_build_wheel(self, metadata_directory, config_settings=None):
        ...
        while True:
            ...
            if len(dist_infos) == 0 and len(_get_immediate_subdirectories(dist_info_directory)) == 1:
    ...
    def build_wheel(self, wheel_directory, config_settings=None, metadata_directory=None):
        ...
        sys.argv = sys.argv[:1] + ['bdist_wheel'] + config_settings['--global-option']
        self.run_setup()
