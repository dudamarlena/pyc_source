...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/contrib/postgres/forms/array.py
        ...
        if isinstance(value, list):
            ...
            for index, item in enumerate(items):
                try:
                    ...
                    errors.append(prefix_validation_error(error, prefix=self.error_messages['item_invalid'], code='item_invalid', params={'nth': index}))
...
class SplitArrayWidget(forms.Widget):
    ...
    def get_context(self, name, value, attrs=None):
        ...
        for i in range(max(len(value), self.size)):
            ...
            context['widget']['subwidgets'].append(self.widget.get_context(name + '_%s' % i, widget_value, final_attrs)['widget'])
    ...
    def clean(self, value):
        ...
        for index in range(max_size):
            ...
            try:
                ...
                errors.append(prefix_validation_error(error, self.error_messages['item_invalid'], code='item_invalid', params={'nth': index}))
