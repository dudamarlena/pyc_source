...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pluggy/pluggy/callers.py
            ...
            try:
                ...
                for argname in hook_impl.argnames:
                    if argname not in caller_kwargs:
                        raise HookCallError('hook call must provide argument %r' % (argname,))
...
def _legacymulticall(hook_impls, caller_kwargs, firstresult=False):
    return _LegacyMultiCall(hook_impls, caller_kwargs, firstresult=firstresult).execute()
