...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_internal/commands/list.py
...
class ListCommand(Command):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option('--format', action='store', dest='list_format', default='columns', choices=('columns',
                                                                                                        'freeze',
                                                                                                        'json'), help='Select the output format among: columns (default), freeze, or json')
    ...
    def _build_package_finder(self, options, index_urls, session):
        ...
        """
        return PackageFinder(find_links=options.find_links, index_urls=index_urls, allow_all_prereleases=options.pre, trusted_hosts=options.trusted_hosts, session=session)
