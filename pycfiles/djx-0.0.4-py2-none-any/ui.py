...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_internal/utils/ui.py
# Compiled at: 2019-02-14 00:35:06
from __future__ import absolute_import, division
import contextlib, itertools, logging, sys, time
from signal import SIGINT, default_int_handler, signal
from pip._vendor import six
from pip._vendor.progress.bar import Bar, ChargingBar, FillingCirclesBar, FillingSquaresBar, IncrementalBar, ShadyBar
...
class DownloadProgressSpinner(WindowsMixin, InterruptibleMixin, DownloadProgressMixin, WritelnMixin, Spinner):
    file = sys.stdout
...
BAR_TYPES = {'off': (
   ...
   'ascii': (
           DownloadIncrementalBar, DownloadProgressSpinner), 
   'pretty': (
