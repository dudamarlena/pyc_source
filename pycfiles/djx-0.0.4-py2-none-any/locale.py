...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/middleware/locale.py
...
class LocaleMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request, response):
        ...
        if response.status_code == 404 and not language_from_path and i18n_patterns_used and prefixed_default_language:
            ...
            path_needs_slash = not path_valid and settings.APPEND_SLASH and not language_path.endswith('/') and is_valid_path('%s/' % language_path, urlconf)
