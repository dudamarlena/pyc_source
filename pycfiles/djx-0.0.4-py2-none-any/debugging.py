...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pytest/_pytest/debugging.py
...
def pytest_addoption(parser):
    ...
    group._addoption('--pdbcls', dest='usepdb_cls', metavar='modulename:classname', help='start a custom interactive Python debugger on errors. For example: --pdbcls=IPython.terminal.debugger:TerminalPdb')
...
def pytest_configure(config):
    ...
    def fin():
        pdb.set_trace, pytestPDB._pluginmanager, pytestPDB._config, pytestPDB._pdb_cls = pytestPDB._saved.pop()
