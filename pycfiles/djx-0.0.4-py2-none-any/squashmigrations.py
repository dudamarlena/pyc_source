...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/core/management/commands/squashmigrations.py
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('start_migration_name', default=None, nargs='?', help='Migrations will be squashed starting from and including this migration.')
    ...
    def handle(self, **options):
        ...
        if no_optimize:
            ...
            if self.verbosity > 0:
                if len(new_operations) == len(operations):
                    ...
                    self.stdout.write('  Optimized from %s operations to %s operations.' % (
        ...
        subclass = type('Migration', (migrations.Migration,), {'dependencies': dependencies, 
