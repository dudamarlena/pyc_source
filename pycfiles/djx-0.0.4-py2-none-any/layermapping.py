...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/contrib/gis/utils/layermapping.py
...
class LayerMapping(object):
    ...
    def verify_fk(self, feat, rel_model, rel_mapping):
        ...
        try:
            ...
            raise MissingForeignKey('No ForeignKey %s model found with keyword arguments: %s' % (
