...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-QtVhoA/setuptools/setuptools/command/build_clib.py
    ...
    def build_libraries(self, libraries):
        for lib_name, build_info in libraries:
            ...
            if newer_pairwise_group(dependencies, expected_objects) != ([], []):
                ...
                objects = self.compiler.compile(sources, output_dir=self.build_temp, macros=macros, include_dirs=include_dirs, extra_postargs=cflags, debug=self.debug)
