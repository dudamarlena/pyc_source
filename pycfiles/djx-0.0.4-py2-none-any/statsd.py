...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/gunicorn/gunicorn/instrument/statsd.py
...
class Statsd(Logger):
    ...
    def access(self, resp, req, environ, request_time):
        ...
        duration_in_ms = request_time.seconds * 1000 + float(request_time.microseconds) / 1000
        status = resp.status
