...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/requests/requests/sessions.py
...
class SessionRedirectMixin(object):
    ...
    def should_strip_auth(self, old_url, new_url):
        ...
        if old_parsed.hostname != new_parsed.hostname:
            ...
            if old_parsed.scheme == 'http' and old_parsed.port in (80, None) and new_parsed.scheme == 'https' and new_parsed.port in (443,
                                                                                                                                      None):
                return False
