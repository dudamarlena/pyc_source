...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/more-itertools/more_itertools/more.py
# Compiled at: 2019-02-14 00:35:48
from __future__ import print_function
from collections import Counter, defaultdict, deque
from functools import partial, wraps
from heapq import merge
from itertools import chain, compress, count, cycle, dropwhile, groupby, islice, repeat, starmap, takewhile, tee
...
def one--- This code section failed: ---
 ...
 L. 526         0  LOAD_GLOBAL           0  'iter'
                3  LOAD_FAST             0  'iterable'
                6  CALL_FUNCTION_1       1  None
                9  STORE_FAST            3  'it'

 L. 528        12  SETUP_EXCEPT         16  'to 31'

 L. 529        15  LOAD_GLOBAL           1  'next'
               18  LOAD_FAST             3  'it'
 ...
 L. 530        31  DUP_TOP          
               ...
               38  POP_JUMP_IF_FALSE    65  'to 65'
               41  POP_TOP          
               42  POP_TOP          
               43  POP_TOP          

 L. 531        44  LOAD_FAST             1  'too_short'
               47  JUMP_IF_TRUE_OR_POP    59  'to 59'
               50  LOAD_GLOBAL           3  'ValueError'
               53  LOAD_CONST               'too few items in iterable (expected 1)'
               56  CALL_FUNCTION_1       1  None
             59_0  COME_FROM            47  '47'
               59  RAISE_VARARGS_1       1  None
               62  JUMP_FORWARD          1  'to 66'
               65  END_FINALLY      
             66_0  COME_FROM            65  '65'
             66_1  COME_FROM            28  '28'

 L. 533        66  SETUP_EXCEPT         14  'to 83'

 L. 534        69  LOAD_GLOBAL           1  'next'
               72  LOAD_FAST             3  'it'
               75  CALL_FUNCTION_1       1  None
               78  POP_TOP          
               79  POP_BLOCK        
               80  JUMP_FORWARD         17  'to 100'
             83_0  COME_FROM            66  '66'

 L. 535        83  DUP_TOP          
               84  LOAD_GLOBAL           2  'StopIteration'
               87  COMPARE_OP           10  exception-match
               90  POP_JUMP_IF_FALSE    99  'to 99'
               93  POP_TOP          
               94  POP_TOP          
               95  POP_TOP          

 L. 536        96  JUMP_FORWARD         19  'to 118'
               99  END_FINALLY      
            100_0  COME_FROM            80  '80'

 L. 538       100  LOAD_FAST             2  'too_long'
              103  JUMP_IF_TRUE_OR_POP   115  'to 115'
              106  LOAD_GLOBAL           3  'ValueError'
              109  LOAD_CONST               'too many items in iterable (expected 1)'
              112  CALL_FUNCTION_1       1  None
            115_0  COME_FROM           103  '103'
              115  RAISE_VARARGS_1       1  None
            118_0  COME_FROM            99  '99'

 L. 540       118  LOAD_FAST             4  'value'
              121  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `RAISE_VARARGS_1' instruction at offset 59
...
def interleave_longest(*iterables):
    ...
    """
    i = chain.from_iterable(zip_longest(fillvalue=_marker, *iterables))
...
def collapse(iterable, base_type=None, levels=None):
    ...
    def walk(node, level):
        if levels is not None and level > levels or isinstance(node, string_types) or base_type is not None and isinstance(node, base_type):
            yield node
            return
        else:
            try:
...
def stagger(iterable, offsets=(-1, 0, 1), longest=False, fillvalue=None):
    ...
    return zip_offset(offsets=offsets, longest=longest, fillvalue=fillvalue, *children)
...
def zip_offset(*iterables, **kwargs):
    ...
    if longest:
        return zip_longest(fillvalue=fillvalue, *staggered)
    else:
