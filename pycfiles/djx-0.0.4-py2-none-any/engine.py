...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/template/engine.py
...
class Engine(object):
    ...
    def get_default():
        ...
        if len(django_engines) == 0:
            ...
            raise ImproperlyConfigured('Several DjangoTemplates backends are configured. You must select one explicitly.')
    ...
    def find_template(self, name, dirs=None, skip=None):
        ...
        for loader in self.template_loaders:
            if loader.supports_recursion:
                try:
                    template = loader.get_template(name, template_dirs=dirs, skip=skip)
                    return (
