...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pytest/_pytest/outcomes.py
    ...
    if minversion is None:
        ...
        if minversion is not None:
            try:
                ...
                raise Skipped('we have a required version for %r but can not import pkg_resources to parse version strings.' % (
                 modname,), allow_module_level=True)
