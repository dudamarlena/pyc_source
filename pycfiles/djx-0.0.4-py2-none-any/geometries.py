...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/contrib/gis/gdal/geometries.py
...
class Point(OGRGeometry):
    ...
    def _geos_ptr(self):
        ...
        if self.empty:
            return geos.Point._create_empty()
        return super(Point, self)._geos_ptr()
...
GEO_CLASSES = {1: Point, 2: LineString, 
   3: Polygon, 
   4: MultiPoint, 
   5: MultiLineString, 
   6: MultiPolygon, 
