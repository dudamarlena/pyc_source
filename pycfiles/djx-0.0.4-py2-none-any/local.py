...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/py/py/_path/local.py
    ...
    def remove(self, rec=1, ignore_errors=False):
        ...
        if self.check(dir=1, link=0):
            if rec:
                ...
                import shutil
                py.error.checked_call(shutil.rmtree, self.strpath, ignore_errors=ignore_errors)
            else:
