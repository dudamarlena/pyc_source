...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pytest/_pytest/_code/code.py
# Compiled at: 2019-02-14 00:35:47
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import inspect, pprint, re, sys, traceback
from inspect import CO_VARARGS
from inspect import CO_VARKEYWORDS
from weakref import ref
import attr, pluggy, py, six
...
class ExceptionInfo(object):
    ...
    def match(self, regexp):
        ...
        assert re.search(regexp, str(self.value)) or 0, ("Pattern '{!s}' not found in '{!s}'").format(regexp, self.value)
        return True
...
class FormattedExcinfo(object):
    ...
    def repr_traceback_entry(self, entry, excinfo=None):
        ...
        if style in ('short', 'long'):
            short = style == 'short'
            if not short:
                reprargs = self.repr_args(entry) if 1 else None
                ...
                localsrepr = None
                localsrepr = short or self.repr_locals(entry.locals)
    ...
    def _truncate_recursive_traceback(self, traceback):
        ...
        try:
            ...
            max_frames = 10
            extraline = ('!!! Recursion error detected, but an error occurred locating the origin of recursion.\n  The following exception happened when comparing locals in the stack frame:\n    {exc_type}: {exc_msg}\n  Displaying first and last {max_frames} stack frames out of {total}.').format(exc_type=type(e).__name__, exc_msg=safe_str(e), max_frames=max_frames, total=len(traceback))
...
if PY35:
    ...
    def is_recursion_error(excinfo):
        return excinfo.errisinstance(RecursionError)
