...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/gunicorn/gunicorn/app/pasterapp.py
...
class PasterBaseApplication(Application):
    ...
    def app_config(self):
        return paste_config(self.cfg, self.cfgurl, self.relpath, global_conf=self.gcfg)
