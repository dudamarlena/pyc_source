...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/py/py/_log/warning.py
...
def warn(msg, stacklevel=1, function=None):
    ...
    import warnings
    warnings.warn_explicit(warning, category=Warning, filename=str(warning.path), lineno=warning.lineno, registry=warnings.__dict__.setdefault('__warningsregistry__', {}))
    return