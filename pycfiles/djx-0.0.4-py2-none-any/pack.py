...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-QtVhoA/wheel/wheel/cli/pack.py
...
def pack(directory, dest_dir):
    ...
    """
    dist_info_dirs = [ fn for fn in os.listdir(directory) if os.path.isdir(os.path.join(directory, fn)) and DIST_INFO_RE.match(fn)
                     ]
