...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_internal/utils/outdated.py
        ...
        try:
            ...
            if pypi_version is None:
                finder = PackageFinder(find_links=options.find_links, index_urls=[
                 options.index_url] + options.extra_index_urls, allow_all_prereleases=False, trusted_hosts=options.trusted_hosts, session=session)
