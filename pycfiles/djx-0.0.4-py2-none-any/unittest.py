...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pytest/_pytest/unittest.py
# Compiled at: 2019-02-14 00:35:47
""" discovery and running of std-library "unittest" style tests. """
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import sys, traceback, _pytest._code, pytest
...
class UnitTestCase(Class):
    ...
    def _inject_setup_teardown_fixtures(self, cls):
        ...
        class_fixture = _make_xunit_fixture(cls, 'setUpClass', 'tearDownClass', scope='class', pass_self=False)
        if class_fixture:
            cls.__pytest_class_setup = class_fixture
        method_fixture = _make_xunit_fixture(cls, 'setup_method', 'teardown_method', scope='function', pass_self=True)
        if method_fixture:
...
class TestCaseFunction(Function):
    ...
    def _handle_skip(self):
        ...
        if getattr(self._testcase.__class__, '__unittest_skip__', False) or getattr(testMethod, '__unittest_skip__', False):
