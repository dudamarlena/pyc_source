...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_vendor/msgpack/fallback.py
...
from pip._vendor.msgpack.exceptions import BufferFull, OutOfData, UnpackValueError, PackValueError, PackOverflowError, ExtraData
...
def _get_data_from_buffer(obj):
    try:
        ...
        if not PY3:
            ...
            warnings.warn('using old buffer interface to unpack %s; this leads to unpacking errors if slicing is used and will be removed in a future version' % type(obj), RuntimeWarning)
        else:
            raise
...
class Unpacker(object):
    ...
    def __init__(self, file_like=None, read_size=0, use_list=True, raw=True, object_hook=None, object_pairs_hook=None, list_hook=None, encoding=None, unicode_errors=None, max_buffer_size=0, ext_hook=ExtType, max_str_len=2147483647, max_bin_len=2147483647, max_array_len=2147483647, max_map_len=2147483647, max_ext_len=2147483647):
        if encoding is not None:
            warnings.warn('encoding is deprecated, Use raw=False instead.', PendingDeprecationWarning)
