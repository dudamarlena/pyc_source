...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pytest/_pytest/tmpdir.py
# Compiled at: 2019-02-14 00:35:47
""" support for providing temporary directories to test functions.  """
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import os, re, tempfile, warnings, attr, py, six, pytest
...
class TempPathFactory(object):
    ...
    _given_basetemp = attr.ib(convert=attr.converters.optional(lambda p: Path(os.path.abspath(six.text_type(p)))))
    _trace = attr.ib()
    ...
    def from_config(cls, config):
        ...
        """
        return cls(given_basetemp=config.option.basetemp, trace=config.trace.get('tmpdir'))
