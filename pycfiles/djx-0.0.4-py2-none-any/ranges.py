...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/contrib/postgres/forms/ranges.py
...
__all__ = [
 'IntegerRangeField', 'FloatRangeField', 'DateTimeRangeField', 'DateRangeField']

class BaseRangeField(forms.MultiValueField):
    default_error_messages = {'invalid': _('Enter two valid values.'), 
    ...
    def __init__(self, **kwargs):
        ...
        if 'fields' not in kwargs:
            kwargs['fields'] = [
             self.base_field(required=False), self.base_field(required=False)]
