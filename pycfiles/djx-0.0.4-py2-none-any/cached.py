...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/template/loaders/cached.py
...
class Loader(BaseLoader):
        ...
        try:
            ...
            for loader in self.loaders:
                try:
                    ...
                    origin = Origin(name=display_name, template_name=name, loader=loader)
                    result = (
                     template, origin)
                    break
    ...
    def load_template(self, template_name, template_dirs=None):
        warnings.warn('The load_template() method is deprecated. Use get_template() instead.', RemovedInDjango20Warning)
