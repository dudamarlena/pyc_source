...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_internal/pyproject.py
...
def load_pyproject_toml(use_pep517, pyproject_toml, setup_py, req_name):
    ...
    if not use_pep517 is not None:
        ...
        if not build_system is not None:
            ...
            raise (_is_list_of_str(requires) or InstallationError)(error_template.format(package=req_name, reason="'build-system.requires' is not a list of strings."))
