...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-QtVhoA/setuptools/setuptools/command/develop.py
...
class develop(namespaces.DevelopInstaller, easy_install):
    ...
    def finalize_options(self):
        ...
        self.dist = pkg_resources.Distribution(target, pkg_resources.PathMetadata(target, os.path.abspath(ei.egg_info)), project_name=ei.egg_name)
