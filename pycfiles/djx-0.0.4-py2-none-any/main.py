...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-zr3xXj/pytest/_pytest/main.py
# Compiled at: 2019-02-14 00:35:47
""" core implementation of testing process: init, session, runtest loop. """
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import contextlib, functools, os, pkgutil, sys, warnings, attr, py, six, _pytest._code
...
def pytest_addoption(parser):
    ...
    parser.addini('testpaths', 'directories to search for tests when no files or directories are given in the command line.', type='args', default=[])
    ...
    group._addoption('--strict', action='store_true', help='marks not registered in configuration file raise errors.')
...
def pytest_configure(config):
    __import__('pytest').config = _ConfigDeprecated(config)
...
def _in_venv(path):
    ...
    if not bindir.isdir():
        return False
    activates = ('activate', 'activate.csh', 'activate.fish', 'Activate', 'Activate.bat',
                 'Activate.ps1')
