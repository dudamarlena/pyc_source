...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-HZd96S/pip/pip/_vendor/distlib/locators.py
...
class Locator(object):
    ...
    def score_url(self, url):
        ...
        return (
         t.scheme == 'https', 'pypi.python.org' in t.netloc,
...
class DistPathLocator(Locator):
    ...
    def _get_project(self, name):
        ...
        if dist is None:
            ...
            result = {dist.version: dist, 
               'urls': {dist.version: set([dist.source_url])}, 'digests': {dist.version: set([None])}}
        return result
...
default_locator = AggregatingLocator(JSONLocator(), SimpleScrapingLocator('https://pypi.python.org/simple/', timeout=3.0), scheme='legacy')
