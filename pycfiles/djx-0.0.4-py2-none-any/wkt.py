...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-n_sfyb/Django/django/contrib/gis/utils/wkt.py
...
def precision_wkt(geom, prec):
    ...
    """
    warnings.warn('precision_wkt() is deprecated in favor of the WKTWriter class.', RemovedInDjango20Warning, stacklevel=2)
