...
def set_wavefunction_convergence(inp, gnrm=0.0001):
    """
...
def apply_electric_field(inp, elecfield=[
 0, 0, 0.001]):
    """
...
def set_electronic_temperature(inp, kT=0.001, T=0):
    """
    Define the electronic temperature, in AU (``kT``) or K (``T``)
    """
    TtokT = 8.617343e-05 / 27.21138505
...
def set_wavefunction_iterations(inp, nit=[
 50, 1]):
    """
