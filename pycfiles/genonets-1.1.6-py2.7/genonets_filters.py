...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/genonets/genonets_filters.py
...
class WriterFilter:
    ...
    ordered_net_attrib = {'Robustness': 1, 
       'Evolvability': 2, 
    ...
    ordered_seq_attrib = {'Robustness': 1, 
       'Evolvability': 2, 
       'Evolvability_targets': 3, 
