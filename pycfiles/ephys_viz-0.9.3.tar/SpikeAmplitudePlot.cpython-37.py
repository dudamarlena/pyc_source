...
# [GCC 8.4.0]
# Embedded file name: /home/magland/src/ephys-viz/generated/ephys_viz/ephys_viz/widgets/SpikeAmplitudePlot/SpikeAmplitudePlot.py
# Compiled at: 2019-11-19 14:29:35
...
class SpikeAmplitudePlot:
    ...
    def javascript_state_changed(self, prev_state, state):
        ...
        self._set_state(num_timepoints=(self._recording.get_num_frames()),
    ...
    def on_message(self, msg):
        if msg.get('name', '') == 'requestAmplitudeData':
            ...
            self.send_message(dict(name='amplitudeData',
              unit_id=unit_id,
              blockNum=blockNum,
              blockSize=blockSize,
              times=times0,
            ...
            if arange_new[0] != self._amplitude_range[0] or arange_new[1] != self._amplitude_range[1]:
                ...
                self.send_message(dict(name='amplitudeRange',
