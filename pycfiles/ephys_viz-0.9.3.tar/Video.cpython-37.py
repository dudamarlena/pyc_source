...
# [GCC 8.4.0]
# Embedded file name: /home/magland/src/ephys-viz/generated/ephys_viz/ephys_viz/widgets/Video/Video.py
...
class Video:
    ...
    def javascript_state_changed(self, prev_state, state):
        ...
        self.set_python_state(dict(video_data_b64=video_data_b64,
          status='finished',
          status_message=''))
