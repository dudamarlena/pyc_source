...
# [GCC 8.4.0]
# Embedded file name: /home/magland/src/ephys-viz/generated/ephys_viz/ephys_viz/widgets/pycommon/autoextractors/filterrecording.py
# Compiled at: 2019-11-15 11:26:28
# Size of source mod 2**32: 2461 bytes
from abc import ABC, abstractmethod
import spikeextractors as se, numpy as np
...
class FilterRecording(se.RecordingExtractor):
    ...
    def hash(self):
        ...
        return mt.sha1OfObject(dict(name='FilterRecording',
          params=params,
