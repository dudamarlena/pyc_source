...
# [GCC 8.4.0]
# Embedded file name: /home/magland/src/ephys-viz/generated/ephys_viz/ephys_viz/widgets/SpikeRasterPlot/SpikeRasterPlot.py
# Compiled at: 2019-11-20 14:15:15
...
class SpikeRasterPlot:
    ...
    def javascript_state_changed(self, prev_state, state):
        ...
        num_timepoints = np.max([np.max(spike_trains[unit_id]) for unit_id in self._sorting.get_unit_ids()])
        self._set_state(unit_ids=(self._sorting.get_unit_ids()),
