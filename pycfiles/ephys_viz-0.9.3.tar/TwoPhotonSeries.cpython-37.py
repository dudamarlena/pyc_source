...
# [GCC 8.4.0]
# Embedded file name: /home/magland/src/ephys-viz/generated/ephys_viz/ephys_viz/widgets/TwoPhotonSeries/TwoPhotonSeries.py
# Compiled at: 2019-11-15 11:26:28
# Size of source mod 2**32: 2821 bytes
from mountaintools import client as mt
import mlprocessors as mlpr
import pycommon.nwb_to_dict as nwb_to_dict
import numpy as np, imageio, base64, tempfile
...
class TwoPhotonSeries:
    ...
    def javascript_state_changed(self, prev_state, state):
        ...
        self.set_python_state(dict(video_url=video_url,
          status='finished',
          status_message=''))
