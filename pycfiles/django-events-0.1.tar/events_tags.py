...
# [GCC 8.4.0]
# Embedded file name: /home/skylar/pinax/projects/NASA/apps/events/templatetags/events_tags.py
# Compiled at: 2009-08-18 18:19:52
...
def show_event(context, event, user, truncate):
    ...
    if event.owner == user:
        ...
        is_owner = False
    try:
        er = EventRelation.objects.get(event=event, user=user)
    except:
        er = None
