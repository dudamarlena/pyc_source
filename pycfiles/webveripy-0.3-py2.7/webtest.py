...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/webveripy/webtest.py
# Compiled at: 2012-10-14 14:58:25
import sys, unittest, warnings, httplib2, types
...
class HTTPCallAndResponse:
    ...
    def __init__(self, callInfo, callBody, responseInfo, responseBody):
        ...
        if callBody is not None:
            ...
            self.callBody = 'No request body sent\n'
    ...
    def dump(self):
        ...
        if self.callInfo['headers'] is not None:
            ...
            lines.append('No request headers sent')
        lines.append('\n')
