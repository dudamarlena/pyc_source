...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/cellulose/extra/restrictions.py
# Compiled at: 2007-06-06 18:37:18
"""
...
class RestrictedInputCell(RestrictedComputedCell, InputCell):
    ...
    def __init__(self, value=None, restriction=None):
        RestrictedComputedCell.__init__(self, lambda : self._set_value, restriction)
