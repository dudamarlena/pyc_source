...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/donno/weblog.py
# Compiled at: 2014-03-26 03:14:12
...
WeblogFile = os.path.join(note_base, 'cnblogs.weblog')
...
def publish_notes(allnotes=True):
    ...
    if allnotes:
        ...
        cmd = 'find %s -cnewer %s -name "t*.mkd"' % (repo, WeblogFile)
