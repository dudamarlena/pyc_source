...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/torsionfit/steps.py
# Compiled at: 2008-04-20 13:19:45
import os, math, Gnuplot
__revision__ = '$Rev$'
tangle = [
 [
...
def step8():
    ...
    g.plot(Gnuplot.Data(data1, title='E_{qm}'), Gnuplot.Data(data2, title='E_{mmbo}'), Gnuplot.Data(data3, title='E_{mm}'), Gnuplot.Data(data4, title='E_{mmwot}'))
