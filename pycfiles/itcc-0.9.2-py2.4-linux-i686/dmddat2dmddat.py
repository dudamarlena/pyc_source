...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/tools/dmddat2dmddat.py
...
def main():
    ...
    parser.add_option('-F', '--framefile', dest='frame_file', default=None, help='read frame from file')
    parser.add_option('-o', '--output', dest='output_fname', default=None, help='output filename')
