...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/tools/autodock_charge_bury2.py
...
def expose_area(protein, ligand, atoms, verbose=0):
    count = 200
    params = {'P': Param(r1l=3.4, r1h=4.0), 'S': Param(r1l=3.5, r1h=4.0), 'N': Param(r1l=2.6, r1h=3.2), 'CO': Param(r1l=3.5, r1h=4.0), 'CN': Param(r1l=3.5, r1h=4.0)}
