...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/molecule/molecule.py
...
class Molecule(object):
    ...
    def __getitem__(self, key):
        return (
         self.atoms[key], self.coords[key])
    ...
    def makeconnect(self):
        ...
        self._connect = numpy.zeros((len(self), len(self)), bool)
    ...
    def calctor(self, i, j, k, l):
        """return in radian"""
        coords = self.coords
        return tools.torsionangle(coords[i], coords[j], coords[k], coords[l])
