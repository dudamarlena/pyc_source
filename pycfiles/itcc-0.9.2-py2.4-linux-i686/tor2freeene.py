...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/tools/tor2freeene.py
...
def usage(ofile=sys.stderr):
    import os.path
    print >> ofile, 'Usage: %s [-n] filename [column [count [temperature]]]' % os.path.basename(sys.argv[0])
    print >> ofile
