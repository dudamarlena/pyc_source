...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/molecule/relalist.py
# Compiled at: 2008-04-20 13:19:45
__all__ = [
 'Relalist', 'genconns', 'genR', 'genA', 'genD', 'genI']
__revision__ = '$Rev$'
...
class Relalist:
    ...
    def __eq__(self, other):
        return self.bonds == other.bonds and self.angles == other.angles and self.torsions == other.torsions and self.imptors == other.imptors
