...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/torsionfit/ga2.py
...
def init():
    global limit
    param = [
     0.254, -2.794, 2.652, 1.318, -4.287, -0.119, -1.803, -1.856]
...
def eval_(param):
    wrtparam(param)
    refdata = [0.952, 0.0, 0.901, 0.649, 1.013, 0.24, 0.007, 3.429, 1.838, 4.683, 4.161, 1.146, 2.36, 2.602, 1.07, 0.282, 0.534, 2.017]
    result = []
    for i in range(1, 19):
        fname = '%02i.xyz' % i
