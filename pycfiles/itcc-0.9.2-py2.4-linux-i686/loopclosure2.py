...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/ccs2/loopclosure2.py
# Compiled at: 2008-04-20 13:19:45
import sys, os, os.path, bisect, heapq, pprint, time, random, tempfile, shutil, cPickle, logging
...
class LoopClosure(object):
    ...
    S_NONE = 0
    S_INITED = 1
    config_keys = {'DEFAULT': (('moltypekey', str, ''), ('cmptorsfile', str, ''), ('loopfile', str, ''), ('chiral_index_file', str, ''), ('molfname', str, ''), ('is_chain', bool, False), ('check_energy_before_minimization', bool, True), ('is_achiral', bool, False), ('check_minimal', bool, False), ('out_mtxyz', bool, True), ('out_mtxyz_fname', str, '%(molfname)s-out'), ('maxsteps', int, -1), ('dump_steps', int, 1000), ('np', int, 1), ('head_tail', int, -1), ('loopstep', int, -1), ('log_level', int, 1), ('keeprange', float, -1.0), ('searchrange', float, -1.0), ('eneerror', float, 0.0001), ('legal_min_ene', float, -100000), ('torerror', float, 10.0), ('minimal_invalid_energy_before_minimization', float, 100000.0), ('min_method', str, 'newton')), 'tinker': (('forcefield', str, 'mm2'), ('solvate', str, ''), ('tinker_key_file', str, ''), ('minconverge', float, 0.001))}
    ...
    def _check_tor(self, mol1, mol2):
        ...
        return tordiff.torsdiff(tors1, tors2, self.is_achiral, self.head_tail, self.loopstep) < self.torerror
