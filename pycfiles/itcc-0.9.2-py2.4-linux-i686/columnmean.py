...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/tools/columnmean.py
...
def main():
    ...
    parser.add_option('-i', '--input-header', action='store_true', dest='input_header', help='input file has header')
    parser.add_option('-o', '--output-header', action='store_true', dest='output_header', help='output header')
