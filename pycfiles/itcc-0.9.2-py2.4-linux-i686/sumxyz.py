...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/tools/sumxyz.py
...
def sumxyz(seq, filelist):
    ...
    for x in filelist:
        ...
        if len(seq) == 2:
            ...
            result.append(math.degrees(mol.calcang(seq[0], seq[1], seq[2])))
...
def sumxyz_torsion(list_, filelist):
    ...
    for x in filelist:
        ...
        mol = read.readxyz(ifile)
        print ifile.name,
        print math.degrees(mol.calctor(list_[0], list_[1], list_[2], list_[3]))
