...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/tools/mtxyzstat.py
...
def main():
    ...
    parser.add_option('-H', '--header', action='store_true', dest='print_header', help='print header')
    parser.add_option('-v', '--verbose', action='store_true', dest='verbose', help='print filename')
    parser.add_option('-I', '--idx-file', dest='idx_file', metavar='FILE', help='index file, "-" means stdin, index is 1-based')
