...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/itcc/torsionfit/process.py
...
if __name__ == '__main__':
    ...
    str_ = [
     '  113     2     3     4     5', '  122     1', '  122     1', '  122     1', '  123     1     6     7', '  125     5     8', '  124     5', '  126     6     9    10    11', '  130     8', '  130     8', '  130     8']
