...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyf/services/core/storage.py
# Compiled at: 2010-06-21 10:30:17
import shutil, datetime, os, uuid
...
class Storage(object):
    ...
    def __init_tree_arborescence(self):
        ...
        for dir_def in self.tree_arborescence_definition.split('/'):
            dirname = os.path.join(dirname, datetime.datetime.strftime(now, dir_def))
