...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/pybasic/basic_operators.py
# Compiled at: 2019-04-20 06:35:24
...
global_table.set('<OR>', lambda n: n[0].run() or )
