...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/pybasic/basic_ast.py
# Compiled at: 2019-04-20 19:46:56
...
class ASTNode:
    ...
    def run(self):
        ...
        if self.type in ASTNode.literals:
            return self.value
