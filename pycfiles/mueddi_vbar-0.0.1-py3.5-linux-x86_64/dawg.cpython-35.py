...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mueddit/dawg.py
...
class DawgState:
    ...
    def __eq__(self, other):
        assert isinstance(other, DawgState)
...
class Dawg:
    __doc__ = 'Directed acyclic word graph used by the main module.'
