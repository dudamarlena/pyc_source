...
# [GCC 8.4.0]
# Embedded file name: trytond/modules/new_mass_editing/wizard/mass_editing_wiz.py
# Compiled at: 2013-04-25 09:54:29
...
class MassEditingWizInit(ModelView, ModelSQL):
    ...
    def __init__(self):
        ...
        self._buttons.update({'cancel': {}, 'action_apply': {}})
    ...
    def fields_view_get(self, view_id=None, view_type='form', hexmd5=None):
        ...
        pool = Pool()
        ir_model_object = pool.get('ir.model')
        ir_model_ids = ir_model_object.search([('model', '=', Transaction().context.get('active_model'))])
        ir_model_data = ir_model_object.browse(ir_model_ids)[0].name
...
class MassEditingWizCreate(Wizard):
    ...
    start = StateView('mass.editing.init', 'new_mass_editing.view_mass_editing_wiz', [
