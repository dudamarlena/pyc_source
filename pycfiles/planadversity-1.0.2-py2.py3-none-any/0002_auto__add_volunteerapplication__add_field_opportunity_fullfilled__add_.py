...
# [GCC 8.4.0]
# Embedded file name: /home/powellc/projects/volunteer-coordination/volunteerhub/apps/volunteers/migrations/0002_auto__add_volunteerapplication__add_field_opportunity_fullfilled__add_.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('volunteers_volunteerapplication', (
         (
         ...
         (
          'opportunity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Opportunity'])),
         (
          'status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=15))))
        db.send_create_signal('volunteers', ['VolunteerApplication'])
        ...
        db.add_column('volunteers_opportunity', 'max_applicants', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_table('volunteers_volunteerapplication')
        db.delete_column('volunteers_opportunity', 'fullfilled')
        db.delete_column('volunteers_opportunity', 'max_applicants')
