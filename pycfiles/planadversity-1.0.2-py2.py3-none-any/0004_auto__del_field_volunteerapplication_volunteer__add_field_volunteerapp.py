...
# [GCC 8.4.0]
# Embedded file name: /home/powellc/projects/volunteer-coordination/volunteerhub/apps/volunteers/migrations/0004_auto__del_field_volunteerapplication_volunteer__add_field_volunteerapp.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('volunteers_volunteerapplication', 'volunteer_id')
        db.add_column('volunteers_volunteerapplication', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['custom_user.EmailUser']), keep_default=False)
        db.add_column('volunteers_volunteer', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom_user.EmailUser'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'VolunteerApplication.volunteer' and its values cannot be restored.")
        db.add_column('volunteers_volunteerapplication', 'volunteer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Volunteer']), keep_default=False)
        db.delete_column('volunteers_volunteerapplication', 'user_id')
        db.delete_column('volunteers_volunteer', 'user_id')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'volunteers.volunteer': {'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Volunteer'}, 'address': (
                                ...
                                'phone_number': (
                                               'localflavor.us.models.PhoneNumberField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}), 
                                'user': (
                                       'django.db.models.fields.related.ForeignKey', [], {'to': "orm['custom_user.EmailUser']", 'null': 'True', 'blank': 'True'})}, 
       'volunteers.volunteerapplication': {'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'VolunteerApplication'}, 'created': (
                                           ...
                                           'user': (
                                                  'django.db.models.fields.related.ForeignKey', [], {'to': "orm['custom_user.EmailUser']"})}}
    complete_apps = [
     'volunteers']