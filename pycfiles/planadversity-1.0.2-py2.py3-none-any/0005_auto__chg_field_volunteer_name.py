...
# [GCC 8.4.0]
# Embedded file name: /home/powellc/projects/volunteer-coordination/volunteerhub/apps/volunteers/migrations/0005_auto__chg_field_volunteer_name.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('volunteers_volunteer', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        db.alter_column('volunteers_volunteer', 'name', self.gf('django.db.models.fields.TextField')(max_length=255))
