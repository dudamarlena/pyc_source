...
# [GCC 8.4.0]
# Embedded file name: /home/powellc/projects/volunteer-coordination/volunteerhub/apps/volunteers/migrations/0006_auto__chg_field_project_image.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('volunteers_project', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Project.image' and its values cannot be restored.")
        db.alter_column('volunteers_project', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
