...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\responder3\protocols\DHCP.py
# Compiled at: 2019-08-15 18:27:11
# Size of source mod 2**32: 67727 bytes
...
class DHCPMessage:
    ...
    def from_buffer(buff):
        ...
        msg.sname = buff.read(64).decode().strip()
        msg.file = buff.read(128).decode().strip()
    ...
    def construct(tid, opcode, options, hwtype=DHCPHardwareType.ETHERNET_10MB, macaddress='AA:AA:AA:AA:AA:AA', hops=0, secs=0, flags=DHCPFlags.B, giaddr=ipaddress.ip_address('0.0.0.0'), ciaddr=ipaddress.ip_address('0.0.0.0'), yiaddr=ipaddress.ip_address('0.0.0.0'), siaddr=ipaddress.ip_address('0.0.0.0'), sname='', file=''):
        msg = DHCPMessage()
        msg.op = opcode
        msg.htype = hwtype
...
OPTCode2ClassName = {0:DHCPOptPAD, 
 1:DHCPOptSUBNETMASK, 
 2:DHCPOptTIMEOFFSET, 
 3:DHCPOptROUTERS, 
