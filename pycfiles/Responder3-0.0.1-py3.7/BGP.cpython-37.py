...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\responder3\protocols\BGP.py
...
class BGPOpen:
    ...
    def __init__(self):
        self.marker = b'\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff'
...
bgptype2class = {BGPMessageType.OPEN: BGPOpen, 
