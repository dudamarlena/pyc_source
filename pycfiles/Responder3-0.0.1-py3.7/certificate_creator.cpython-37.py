...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\responder3\tools\certificate_creator.py
...
def generate_cert_and_key(cn, filename, keysize, keytype='rsa'):
    ...
    builder = CertificateBuilder({'country_name':'US', 
     'state_or_province_name':'Massachusetts', 
     'locality_name':'Newbury', 
     'organization_name':'Codex Non Sufficit LC', 
     'common_name':cn}, root_ca_public_key)
