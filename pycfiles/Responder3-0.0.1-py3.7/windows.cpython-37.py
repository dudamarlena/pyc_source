...
# [GCC 8.4.0]
# Embedded file name: C:\Users\victim\Desktop\Responder3\responder3\core\interfaces\windows.py
# Compiled at: 2019-04-29 07:33:30
# Size of source mod 2**32: 9893 bytes
import ipaddress, socket
import responder3.core.interfaces.NetworkInterface as NetworkInterface
...
def get_win_ifaddrs():
    ...
    class SOCKADDR_STORAGE(ctypes.Union):
        _fields_ = (
         (
          'v4', LPSOCKADDR), ('v6', LPSOCKADDR_IN6))
    ...
    IF_OPER_STATUS = ctypes.c_uint
    IF_LUID = ctypes.c_uint64
    NET_IF_COMPARTMENT_ID = ctypes.c_uint32
    GUID = ctypes.c_byte * 16
    NET_IF_NETWORK_GUID = GUID
    NET_IF_CONNECTION_TYPE = ctypes.c_uint
    TUNNEL_TYPE = ctypes.c_uint
    ...
    for i in GetAdaptersAddresses():
        ...
        interface.ifindex = i.zone_indices
