...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\responder3\crypto\do_not_use\rsa.py
...
class RSA:
    ...
    def GenerateKey(self, p=0, q=0, e=0, d=0, n=0, l=0):
        ...
        if q == 0:
            while 1:
                q = self._random()
                if self._is_prime_number(q) and p != q:
                    break
