...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/lvmanager/manager.py
# Compiled at: 2020-02-15 18:26:02
# Size of source mod 2**32: 9061 bytes
import os, shutil
...
def add(file_path, name, encrypt):
    ...
    if not os.path.isfile(file_path):
        ...
        return False
    if '.' not in file_path:
        print('[Warning] No extension in file_path!')
    try:
