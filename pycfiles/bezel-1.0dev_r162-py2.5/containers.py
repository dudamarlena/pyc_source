...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/bezel/graphics/widgets/containers.py
...
class HBox(OrientedBox):
    ...
    def __init__(self, *args, **kwargs):
        super(HBox, self).__init__(HBox.ORIENTATION_HORIZONTAL, *args, **kwargs)


class VBox(OrientedBox):

    def __init__(self, *args, **kwargs):
        super(VBox, self).__init__(VBox.ORIENTATION_VERTICAL, *args, **kwargs)