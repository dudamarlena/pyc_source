...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/bezel/graphics/widgets/text.py
...
class Text(Widget):
    ...
    def __init__(self, text, font_name=None, font_size=24, colour=(255, 255, 255), x_align=ALIGN_START, y_align=ALIGN_MIDDLE, *args, **kwargs):
    ...
    def get_font(self):
        return (
         self.__font_name, self.__font_size)
