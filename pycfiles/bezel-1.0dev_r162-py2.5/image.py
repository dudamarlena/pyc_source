...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/bezel/graphics/widgets/image.py
...
class Image(Widget):
    ...
    def __init__(self, image, scaling=SCALE_ASPECT, x_align=ALIGN_MIDDLE, y_align=ALIGN_MIDDLE, *args, **kwargs):
