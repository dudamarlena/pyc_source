...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\dynn\layers\convolution_layers.py.1148f7b5b69ab1d9e5905a145b149d58.py
# Compiled at: 2018-09-17 16:21:28
...
class Conv2DLayer(ParametrizedLayer):
    __doc__ = '2D convolution\n\n    Args:\n        pc (:py:class:`dynet.ParameterCollection`): Parameter collection to\n            hold the parameters\n        num_channels (int): Number of channels in the input image\n        num_kernels (int): Number of kernels (essentially the output dimension)\n        kernel_width (int): Width of the kernels\n        kernel_height (int): Height of the kernels\n        activation (function, optional): activation function\n            (default: ``identity``)\n        dropout (float, optional):  Dropout rate (default 0)\n        nobias (bool, optional): Omit the bias (default ``False``)\n        zero_padded (bool, optional): Default padding behaviour. Pad the image\n            with zeros so that the output has the same width/height\n            (default ``True``)\n        default_strides (list, optional): Default stride along each dimension\n            (list of size 2, defaults to ``[1, 1]``).\n    '

    def __init__(self, pc, num_channels, num_kernels, kernel_width, kernel_height, activation=identity, dropout_rate=0.0, nobias=False, zero_padded=True, default_strides=1):
