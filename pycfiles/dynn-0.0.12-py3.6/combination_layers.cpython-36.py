...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\dynn\layers\combination_layers.py
# Compiled at: 2018-09-19 16:41:27
    ...
    def __init__(self, layers, default_return_last_only=True):
        ...
        for layer_idx, layer in enumerate(layers):
            if not isinstance(layer, BaseLayer):
                raise ValueError(f"Layer #{layer_idx} should be a subclass of BaseLayer, is {{layer.__class__}}")
