...
# Embedded file name: build/bdist.linux-x86_64/egg/tests/pykafka/test_cluster.py
...
class ClusterIntegrationTests(unittest.TestCase):
    ...
    def test_exclude_internal_topics(self):
        ...
        """
        topic_name = '__starts_with_underscores'
    ...
    def test_zk_connect(self):
        ...
        zk_brokers = ['{}:{}'.format(b.host, b.port) for b in itervalues(zk_client.brokers)]
        kafka_brokers = ['{}:{}'.format(b.host, b.port) for b in itervalues(kafka_client.brokers)]
