...
class TestSimpleConsumer(unittest2.TestCase):
    ...
    def test_offset_commit(self):
        ...
        with self._get_simple_consumer(consumer_group='test_offset_commit') as (consumer):
    ...
    def test_offset_resume(self):
        ...
        with self._get_simple_consumer(consumer_group='test_offset_resume') as (consumer):
            [consumer.consume() for _ in range(100)]
            offsets_committed = consumer.held_offsets
            consumer.commit_offsets()
        with self._get_simple_consumer(consumer_group='test_offset_resume') as (consumer):
    ...
    def test_consumer_lag(self):
        ...
        with self._get_simple_consumer(consumer_group='test_lag_group', consumer_timeout_ms=1000) as (consumer):
            while 1:
