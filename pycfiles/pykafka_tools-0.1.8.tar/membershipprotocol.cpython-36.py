...
RangeProtocol = GroupMembershipProtocol('consumer', 'range', ConsumerGroupProtocolMetadata(), decide_partitions_range)
...
RoundRobinProtocol = GroupMembershipProtocol('consumer', 'roundrobin', ConsumerGroupProtocolMetadata(), decide_partitions_roundrobin)