...
class MetadataRequest(Request):
    ...
    def get_versions(cls):
        return {0:MetadataRequest, 
         1:MetadataRequestV1,  2:MetadataRequestV2,  3:MetadataRequestV3, 
...
class MetadataResponse(Response):
    ...
    @classmethod
    def get_versions(cls):
        return {0:MetadataResponse, 
         1:MetadataResponseV1,  2:MetadataResponseV2,  3:MetadataResponseV3, 
