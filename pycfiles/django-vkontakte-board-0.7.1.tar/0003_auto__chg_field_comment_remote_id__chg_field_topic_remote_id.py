...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-vkontakte-board/vkontakte_board/migrations/0003_auto__chg_field_comment_remote_id__chg_field_topic_remote_id.py
# Compiled at: 2015-11-01 17:29:34
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('vkontakte_board_comment', 'remote_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length='50'))
        db.alter_column('vkontakte_board_topic', 'remote_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length='50'))

    def backwards(self, orm):
        db.alter_column('vkontakte_board_comment', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length='20', unique=True))
        db.alter_column('vkontakte_board_topic', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length='20', unique=True))
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'vkontakte_board.comment': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Comment'}, 'author': (
                                            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'topics_comments'", 'to': "orm['vkontakte_users.User']"}), 
                                   'date': (
                                   ...
                                   'topic': (
                                           'django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': "orm['vkontakte_board.Topic']"})}, 
       'vkontakte_board.topic': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Topic'}, 'comments_count': (
                                                  'django.db.models.fields.PositiveIntegerField', [], {}), 
                                 'created': (
                                           'django.db.models.fields.DateTimeField', [], {}), 
                                 'created_by': (
                                              'django.db.models.fields.related.ForeignKey', [], {'related_name': "'topics_created'", 'to': "orm['vkontakte_users.User']"}), 
                                 'fetched': (
                                           'django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}), 
                                 'first_comment': (
                                                 'django.db.models.fields.TextField', [], {}), 
                                 'group': (
                                         'django.db.models.fields.related.ForeignKey', [], {'related_name': "'topics'", 'to': "orm['vkontakte_groups.Group']"}), 
                                 'id': (
                                      'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                 'is_closed': (
                                 ...
                                 'updated_by': (
                                              'django.db.models.fields.related.ForeignKey', [], {'related_name': "'topics_updated'", 'to': "orm['vkontakte_users.User']"})}, 
