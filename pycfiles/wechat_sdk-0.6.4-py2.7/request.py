...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/wechat_sdk/lib/request.py
...
class WechatRequest(object):
    ...
    def get(self, url, access_token=None, **kwargs):
        ...
        :return: 微信服务器响应的 JSON 数据
        """
        return self.request(method='get', url=url, access_token=access_token, **kwargs)
    ...
    def post(self, url, access_token=None, **kwargs):
        ...
        :return: 微信服务器响应的 JSON 数据
        """
        return self.request(method='post', url=url, access_token=access_token, **kwargs)
