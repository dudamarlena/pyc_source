...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\pyfmpcloud\stock_time_series.py
# Compiled at: 2020-05-10 09:56:07
# Size of source mod 2**32: 10094 bytes
"""
...
def batch_request_eod_prices(tickers=None, date=None):
    ...
    if tickers is None:
        ...
        if tickers is not None and date is None:
...
def map_markets(markettype, marketPrices):
    marketToApi = {'etf':'available-etfs/', 
