...
# Compiled at: 2018-10-13 07:34:07
"""
...
class Stack(Parser):
    ...
    def __init__(self, configuration_path, naming_file_path, positioning_file_path=None, global_variables_file_path=None, file_to_skip_for_positioning=None, raise_on_missing_variable=True):
    ...
    def _is_check_skipped(self, tag_name, deprecated_tag_name=None):
        ...
        try:
            ...
            if tags.get(deprecated_tag):
                message = ('The tag "{}" is deprecated. Please use "{}". Resource: {}').format(deprecated_tag, check_tag, self.name)
