...
# Compiled at: 2018-10-03 06:05:51
"""
...
class FilenameError(object):
    ...
    def __str__(self):
        ...
        return ('Filename positioning not followed on file {filename} for resource {resource}. \n\tShould be in file : {target}.').format(filename=filename, resource=resource, target=target)