...
# Compiled at: 2019-10-22 09:42:37
# Size of source mod 2**32: 13241 bytes
"""
...
class HclView:
    __doc__ = 'Object representing the global view of hcl resources along with any global variables.'

    def __init__(self, hcl_resources, global_variables=None, raise_on_missing_variable=True, environment_variables=None):
    ...
    def get_variable_value(self, variable):
        ...
        if variable.startswith(permutations):
            ...
            if match:
                ...
                variable = self.state.get('variable', {}).get(variable_name, self._environment_variables.get(variable_name, variable))
        if variable == initial_value:
            if self._raise_on_missing_variable:
...
class Parser:
    __doc__ = 'Manages the parsing of terraform files and creating the global hcl view from them.'
    ...
    def __init__(self, configuration_path, global_variables_file_path=None, raise_on_missing_variable=True, environment_variables=None):
        ...
        self.hcl_view = HclView(file_resources, self._get_global_variables(global_variables_file_path), raise_on_missing_variable, environment_variables)
