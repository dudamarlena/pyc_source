...
# [GCC 8.4.0]
# Embedded file name: /Users/tianyu/Dev/qqweibo/qqweibo/sdk.py
# Compiled at: 2013-03-27 08:56:15
"""
qq weibo sdk
...
class Client(object):
    ...
    def __init__(self, app_key, app_secret, redirect_uri='http://www.sample.com', response_type='code', forcelogin=False):
    ...
    def get_access_token_from_code(self, code=''):
        ...
        获取access token并存入
        """
        params = {'client_id': self.app_key, 'client_secret': self.app_secret, 'grant_type': 'authorization_code', 'code': code, 
    ...
    def call(self, api_method, call_method='GET', clientip='127.0.0.1', scope='all', oauth_version='2.a'):
        params = {'access_token': self.access_token, 'openid': self.openid, 'oauth_consumer_key': self.app_key, 'clientip': clientip, 
           'scope': scope, 'oauth_version': oauth_version}
        if call_method == 'GET':
