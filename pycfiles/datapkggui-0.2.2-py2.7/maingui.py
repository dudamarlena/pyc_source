...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/datapkggui/gui/maingui.py
# Compiled at: 2011-10-28 11:02:36
__author__ = 'dgraziotin'
import threading, wx, wx.xrc, wx.lib.newevent, datapkggui.operations as operations, packagegui, shutil, os, base
...
class MainGUI(base.GUI):
    ...
    def OnOperationMessageReceived(self, operation_message):
        ...
        if operation_message.status == operations.OPERATION_STATUS_ID['error'] and self.m_killing_operations:
            ...
            return
        if operation_message.status == (operations.OPERATION_STATUS_ID['error'] and not self.m_killing_operations and operation_message.data):
