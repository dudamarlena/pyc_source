...
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/apogee/factors/discrete/operations/product.py
...
def factor_product(a, b):
    ...
    return factor_arithmetic((
     ...
     b.scope, b.cards, b.parameters, b.assignments), np.multiply)