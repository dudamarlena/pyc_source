...
# Embedded file name: build/bdist.linux-x86_64/egg/PYB11Generator/PYB11ClassAttribute.py
...
class PYB11ClassAttribute:
    ...
    def __init__(self, static, pyname, cppname, returnpolicy, doc, deftype):
        self.static = static
        self.pyname = pyname
    ...
    def __call__(self, name, klassattrs, ss):
        if self.pyname:
            pyname = self.pyname
        else:
            pyname = name
...
class PYB11readwrite(PYB11ClassAttribute):
    ...
    def __init__(self, static=False, pyname=None, cppname=None, returnpolicy=None, doc=None):
