...
# Embedded file name: build/bdist.linux-x86_64/egg/PYB11Generator/PYB11property.py
...
class PYB11property:
    ...
    def __init__(self, returnType=None, getter=None, setter=None, doc=None, getterraw=None, setterraw=None, getterconst=True, setterconst=False, static=None, returnpolicy=None):
    ...
    def __call__(self, propname, klassattrs, ss):
        ...
        elif self.setter or self.setterraw:
            proptype = ''
        else:
            proptype = '_readonly'
...
def PYB11GenerateProperty(propname, prop, klassinst, klassattrs, ss):
    getter = prop.fget
    setter = prop.fset
    doc = prop.__doc__
