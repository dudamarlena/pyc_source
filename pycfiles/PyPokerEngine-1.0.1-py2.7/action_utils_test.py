...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/pypokerengine/utils/action_utils_test.py
...
class ActionUtilsTest(BaseUnitTest):
    ...
    def test_generate_legal_actions(self):
        ...
        self.eq([{'action': 'fold', 'amount': 0}, {'action': 'call', 'amount': 10}, {'action': 'raise', 'amount': {'min': 15, 'max': 100}}], legal_actions)
