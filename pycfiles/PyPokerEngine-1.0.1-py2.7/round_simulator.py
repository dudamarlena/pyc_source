...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/players/round_simulator.py
# Compiled at: 2016-09-04 03:40:50
...
class RoundSimualtor:
    ...
    def gen_action_info(self, action, bet_amount=None):
        ...
        return (
         action, bet_amount if bet_amount else 0)

    def __read_action_info(self, action_info):
        return (
         action_info[0], action_info[1])
