...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/interface/dealer.py
# Compiled at: 2016-09-24 05:53:16
...
class Dealer:
    ...
    def __gen_config(self, max_round):
        return {'initial_stack': self.initial_stack, 
           'max_round': max_round, 
