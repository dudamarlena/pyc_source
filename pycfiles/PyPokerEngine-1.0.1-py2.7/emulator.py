...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/pypokerengine/api/emulator.py
...
class Emulator(object):
    ...
    def _generate_game_result_event(self, game_state):
        dummy_config = {'initial_stack': None, 
           'max_round': None, 
