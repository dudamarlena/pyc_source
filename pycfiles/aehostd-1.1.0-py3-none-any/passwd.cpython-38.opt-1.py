...
# Compiled at: 2020-03-29 09:42:06
...
class PasswdByNameReq(PasswdReq):
 ...
 L.  49         0  LOAD_FAST                'params'
                2  LOAD_STR                 'uid'
                4  BINARY_SUBSCR    
                6  STORE_FAST               'username'

 L.  50         8  LOAD_FAST                'username'
               10  LOAD_GLOBAL              CFG
 ...
 L.  52        34  LOAD_CONST               None
               36  RETURN_VALUE     
             38_0  COME_FROM            16  '16'

 L.  53        38  SETUP_FINALLY        56  'to 56'

 L.  54        40  LOAD_GLOBAL              PASSWD_MAP
...
class PasswdByUidReq(PasswdReq):
 ...
 L.  72         0  LOAD_FAST                'params'
                2  LOAD_STR                 'uidNumber'
                4  BINARY_SUBSCR    
                6  STORE_FAST               'userid'

 L.  73         8  LOAD_FAST                'userid'
               10  LOAD_GLOBAL              CFG
               12  LOAD_ATTR                nss_min_uid
               14  COMPARE_OP               <
               16  POP_JUMP_IF_TRUE     38  'to 38'

 L.  74        18  LOAD_FAST                'userid'
               20  LOAD_GLOBAL              CFG
               22  LOAD_ATTR                nss_max_uid
               24  COMPARE_OP               >

 L.  73        26  POP_JUMP_IF_TRUE     38  'to 38'

 L.  75        28  LOAD_FAST                'userid'
               30  LOAD_GLOBAL              CFG
               32  LOAD_ATTR                nss_ignore_uids
               34  COMPARE_OP               in

 L.  73        36  POP_JUMP_IF_FALSE    58  'to 58'
             38_0  COME_FROM            26  '26'
             38_1  COME_FROM            16  '16'

 L.  76        38  LOAD_FAST                'self'
               40  LOAD_METHOD              _log
 ...
 L.  77        54  LOAD_CONST               None
               56  RETURN_VALUE     
             58_0  COME_FROM            36  '36'

 L.  78        58  SETUP_FINALLY        72  'to 72'

 L.  79        60  LOAD_GLOBAL              PASSWD_MAP
               62  LOAD_FAST                'userid'
               64  BINARY_SUBSCR    
               66  STORE_FAST               'res'
               68  POP_BLOCK        
