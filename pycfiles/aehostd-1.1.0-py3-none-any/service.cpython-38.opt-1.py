...
# Compiled at: 2020-03-29 09:02:13
# Size of source mod 2**32: 11029 bytes
"""
...
class TIOStreamRequestHandler(socketserver.BaseRequestHandler):
 ...
 L. 246        38  LOAD_GLOBAL              TIOStream
               40  LOAD_FAST                'req_file'
               42  CALL_FUNCTION_1       1  ''
               44  STORE_FAST               'tios'

 L. 248        46  LOAD_FAST                'tios'
               48  LOAD_METHOD              read_int32
               50  CALL_METHOD_0         0  ''
               52  STORE_FAST               'nslcd_version'

 L. 249        54  LOAD_FAST                'nslcd_version'
               56  LOAD_GLOBAL              req
               58  LOAD_ATTR                PROTO_VERSION
               60  COMPARE_OP               !=
               62  POP_JUMP_IF_FALSE    84  'to 84'

 L. 250        64  LOAD_GLOBAL              logging
               66  LOAD_METHOD              error

 L. 251        68  LOAD_STR                 'Wrong protocol version: Expected %r but got %r'

 L. 252        70  LOAD_GLOBAL              req
               72  LOAD_ATTR                PROTO_VERSION

 L. 253        74  LOAD_FAST                'nslcd_version'

 L. 250        76  CALL_METHOD_3         3  ''
               78  POP_TOP          

 L. 255        80  LOAD_CONST               None
               82  RETURN_VALUE     
             84_0  COME_FROM            62  '62'

 L. 256        84  LOAD_FAST                'tios'
               86  LOAD_METHOD              read_int32
               88  CALL_METHOD_0         0  ''
               90  STORE_FAST               'req_type'

 L. 257        92  LOAD_GLOBAL              logging
 ...
 L. 258       110  SETUP_FINALLY       128  'to 128'

 L. 259       112  LOAD_FAST                'self'
 ...
 L. 265       198  SETUP_FINALLY       268  'to 268'

 L. 266       200  LOAD_FAST                'handler_class'

 L. 267       202  LOAD_FAST                'tios'

 L. 268       204  LOAD_FAST                'self'
              206  LOAD_ATTR                server

 L. 269       208  LOAD_FAST                'self'
              210  LOAD_METHOD              _get_peer_cred
              212  CALL_METHOD_0         0  ''

 L. 266       214  CALL_FUNCTION_3       3  ''
              216  STORE_FAST               'handler'

 L. 271       218  LOAD_FAST                'handler'
 ...
 L. 276       290  LOAD_GLOBAL              logging
              292  LOAD_METHOD              debug

 L. 277       294  LOAD_STR                 'Received %s exception in %s => re-raise'

 L. 278       296  LOAD_FAST                'exit_err'

 L. 279       298  LOAD_FAST                'self'
              300  LOAD_ATTR                __class__
              302  LOAD_ATTR                __name__

 L. 276       304  CALL_METHOD_3         3  ''
              306  POP_TOP          

 L. 282       308  RAISE_VARARGS_0       0  'reraise'
              310  POP_BLOCK        
              312  BEGIN_FINALLY    
