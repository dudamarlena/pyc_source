...
# Compiled at: 2020-03-29 09:30:10
# Size of source mod 2**32: 32377 bytes
"""
...
class UsersUpdater(RefreshThread):
 ...
 L. 552        36  LOAD_FAST                'self'
               38  LOAD_METHOD              _log

 L. 553        40  LOAD_GLOBAL              logging
               42  LOAD_ATTR                DEBUG

 L. 554        44  LOAD_STR                 '%d existing SSH key files found: %r'

 L. 555        46  LOAD_GLOBAL              len
               48  LOAD_FAST                'existing_ssh_key_files'
               50  CALL_FUNCTION_1       1  ''

 L. 556        52  LOAD_FAST                'existing_ssh_key_files'

 L. 552        54  CALL_METHOD_4         4  ''
               56  POP_TOP          

 L. 558        58  LOAD_CLOSURE             'path_prefix_len'
               60  BUILD_TUPLE_1         1 
 ...
 L. 560        68  LOAD_FAST                'existing_ssh_key_files'

 L. 558        70  GET_ITER         
               72  CALL_FUNCTION_1       1  ''
               74  STORE_FAST               'old_userid_set'

 L. 562        76  LOAD_FAST                'self'
               78  LOAD_METHOD              _log

 L. 563        80  LOAD_GLOBAL              logging
               82  LOAD_ATTR                DEBUG

 L. 564        84  LOAD_STR                 '%d existing user IDs: %s'

 L. 565        86  LOAD_GLOBAL              len
 ...
 L. 562       106  CALL_METHOD_4         4  ''
              108  POP_TOP          

 L. 568       110  LOAD_FAST                'old_userid_set'
              112  LOAD_FAST                'active_userid_set'
              114  BINARY_SUBTRACT  
              116  STORE_FAST               'to_be_removed'

 L. 569       118  LOAD_FAST                'to_be_removed'
              120  POP_JUMP_IF_FALSE   176  'to 176'

 L. 570       122  LOAD_FAST                'self'
              124  LOAD_METHOD              _log

 L. 571       126  LOAD_GLOBAL              logging
              128  LOAD_ATTR                INFO

 L. 572       130  LOAD_STR                 '%d existing files to be removed: %s'

 L. 573       132  LOAD_GLOBAL              len
 ...
 L. 570       152  CALL_METHOD_4         4  ''
              154  POP_TOP          

 L. 576       156  LOAD_FAST                'to_be_removed'
              158  GET_ITER         
              160  FOR_ITER            176  'to 176'
              162  STORE_FAST               'user_name'

 L. 577       164  LOAD_FAST                'self'
