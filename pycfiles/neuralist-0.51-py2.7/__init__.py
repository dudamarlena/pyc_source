...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/neuralist/__init__.py
# Compiled at: 2016-10-01 13:34:05
import redis

class NeuralNetwork:

    def __init__(self, name, type, inputs, outputs, hidden_layers, dataset_size, testset_size, normalize=True, redis_client=None, prefix='nn:', auto_create=True):
    ...
    def train(self, max_cycles=None, max_time=None, autostop=True, backtrack=True):
        args = [
         self.name]
        if max_cycles:
