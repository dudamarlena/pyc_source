...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/media/riff.py
...
class WaveForm(RIFFForm):
    _chunk_types = {'fmt ': WaveFormatChunk, 
       'data': WaveDataChunk}
