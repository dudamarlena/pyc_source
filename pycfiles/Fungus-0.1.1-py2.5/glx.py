...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/gl/glx.py
...
PFNGLXGETPROCADDRESSARBPROC = CFUNCTYPE(__GLXextFuncPtr, POINTER(GLubyte))
...
struct_anon_96._fields_ = [
 ...
 (
  'count', c_int)]
GLXPbufferClobberEvent = struct_anon_96
