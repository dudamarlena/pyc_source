...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/window/xlib/xlib.py
...
XFontSetExtents = struct_anon_76
...
XIMDontChange = 11
XIMCaretDirection = enum_anon_88
...
XIMTextType = 0
XIMBitmapType = 1
XIMStatusDataType = enum_anon_90
...
XStdICCTextStyle = 3
XUTF8StringStyle = 4
XICCEncodingStyle = enum_anon_98
...
struct_anon_102._fields_ = [
 ...
 (
  'killid', XID)]
XStandardColormap = struct_anon_102
BitmapSuccess = 0
BitmapOpenFailed = 1
BitmapFileInvalid = 2
BitmapNoMemory = 3
