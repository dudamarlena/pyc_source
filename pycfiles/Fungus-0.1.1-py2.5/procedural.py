...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/media/procedural.py
...
class ProceduralSource(Source):
    ...
    def __init__(self, duration, sample_rate=44800, sample_size=16):
        ...
        self.audio_format = AudioFormat(channels=1, sample_size=sample_size, sample_rate=sample_rate)
        self._offset = 0
