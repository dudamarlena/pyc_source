...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/font/win32.py
# Compiled at: 2009-02-18 19:37:25
"""
"""
from ctypes import *
import ctypes, math, pyglet
...
class GDIPlusGlyphRenderer(Win32GlyphRenderer):
    ...
    def render(self, text):
        ...
        gdiplus.GdipMeasureString(self._graphics, ch, len(ch) - 1, self.font._gdipfont, ctypes.byref(rect), format, ctypes.byref(bbox), 0, 0)
        lsb = 0
        ...
        gdiplus.GdipDrawString(self._graphics, ch, len(ch) - 1, self.font._gdipfont, ctypes.byref(rect), format, self._brush)
