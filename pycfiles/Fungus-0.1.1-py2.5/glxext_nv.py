...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/gl/glxext_nv.py
...
struct_anon_301._fields_ = [
 ...
 (
  'count', c_int)]
GLXBufferClobberEventSGIX = struct_anon_301
...
PFNGLXGETREFRESHRATESGIPROC = CFUNCTYPE(c_int, POINTER(c_uint))
...
struct_anon_302._fields_ = [
 ...
 (
  'networkId', c_int)]
GLXHyperpipeNetworkSGIX = struct_anon_302
...
struct_anon_303._fields_ = [
 ...
 (
  'timeSlice', c_int)]
GLXHyperpipeConfigSGIX = struct_anon_303
...
struct_anon_305._fields_ = [
 ...
 (
  'maxWidth', c_int)]
GLXPipeRectLimits = struct_anon_305
