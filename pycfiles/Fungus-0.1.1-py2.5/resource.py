...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyglet/resource.py
...
__version__ = '$Id: $'
import operator, os, weakref, sys, zipfile, StringIO, pyglet
    ...
    def reindex(self):
        ...
        for path in self.path:
            if path.startswith('@'):
                ...
                assert '\\' not in path, 'Backslashes not permitted in relative path'
