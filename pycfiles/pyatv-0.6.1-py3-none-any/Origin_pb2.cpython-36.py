...
# [GCC 8.4.0]
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/mrp/protobuf/Origin_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='pyatv/mrp/protobuf/Origin.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=(_b('\n\x1fpyatv/mrp/protobuf/Origin.proto\x1a*pyatv/mrp/protobuf/DeviceInfoMessage.proto"g\n\x06Origin\x12\x0c\n\x04type\x18\x01 \x01(\x05\x12\x13\n\x0bdisplayName\x18\x02 \x01(\t\x12\x12\n\nidentifier\x18\x03 \x01(\x05\x12&\n\ndeviceInfo\x18\x04 \x01(\x0b2\x12.DeviceInfoMessage')),
  dependencies=[
 pyatv_dot_mrp_dot_protobuf_dot_DeviceInfoMessage__pb2.DESCRIPTOR])
_ORIGIN = _descriptor.Descriptor(name='Origin',
  full_name='Origin',
  filename=None,
  file=DESCRIPTOR,
 ...
 _descriptor.FieldDescriptor(name='identifier',
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='deviceInfo',
   full_name='Origin.deviceInfo',
   index=3,
   number=4,
   type=11,
   cpp_type=10,
...
Origin = _reflection.GeneratedProtocolMessageType('Origin', (_message.Message,), {'DESCRIPTOR':_ORIGIN, 
