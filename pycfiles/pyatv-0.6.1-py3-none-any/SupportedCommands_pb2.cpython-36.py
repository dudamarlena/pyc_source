...
# [GCC 8.4.0]
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/mrp/protobuf/SupportedCommands_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='pyatv/mrp/protobuf/SupportedCommands.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=(_b('\n*pyatv/mrp/protobuf/SupportedCommands.proto\x1a$pyatv/mrp/protobuf/CommandInfo.proto"<\n\x11SupportedCommands\x12\'\n\x11supportedCommands\x18\x01 \x03(\x0b2\x0c.CommandInfo')),
  dependencies=[
 pyatv_dot_mrp_dot_protobuf_dot_CommandInfo__pb2.DESCRIPTOR])
_SUPPORTEDCOMMANDS = _descriptor.Descriptor(name='SupportedCommands',
 ...
 _descriptor.FieldDescriptor(name='supportedCommands',
   full_name='SupportedCommands.supportedCommands',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
...
SupportedCommands = _reflection.GeneratedProtocolMessageType('SupportedCommands', (_message.Message,), {'DESCRIPTOR':_SUPPORTEDCOMMANDS, 
