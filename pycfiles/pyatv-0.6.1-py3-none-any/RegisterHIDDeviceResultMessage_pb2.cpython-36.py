...
# [GCC 8.4.0]
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/mrp/protobuf/RegisterHIDDeviceResultMessage_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='pyatv/mrp/protobuf/RegisterHIDDeviceResultMessage.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=(_b('\n7pyatv/mrp/protobuf/RegisterHIDDeviceResultMessage.proto\x1a(pyatv/mrp/protobuf/ProtocolMessage.proto"M\n\x1eRegisterHIDDeviceResultMessage\x12\x11\n\terrorCode\x18\x01 \x01(\x05\x12\x18\n\x10deviceIdentifier\x18\x02 \x01(\x05:Y\n\x1eregisterHIDDeviceResultMessage\x12\x10.ProtocolMessage\x18\x0c \x01(\x0b2\x1f.RegisterHIDDeviceResultMessage')),
  dependencies=[
 pyatv_dot_mrp_dot_protobuf_dot_ProtocolMessage__pb2.DESCRIPTOR])
REGISTERHIDDEVICERESULTMESSAGE_FIELD_NUMBER = 12
registerHIDDeviceResultMessage = _descriptor.FieldDescriptor(name='registerHIDDeviceResultMessage',
  ...
  serialized_options=None,
  file=DESCRIPTOR)
_REGISTERHIDDEVICERESULTMESSAGE = _descriptor.Descriptor(name='RegisterHIDDeviceResultMessage',
  full_name='RegisterHIDDeviceResultMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
 ...
 _descriptor.FieldDescriptor(name='errorCode',
   full_name='RegisterHIDDeviceResultMessage.errorCode',
   index=0,
   number=1,
   type=5,
   cpp_type=1,
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='deviceIdentifier',
   full_name='RegisterHIDDeviceResultMessage.deviceIdentifier',
   index=1,
   number=2,
   type=5,
   cpp_type=1,
...
RegisterHIDDeviceResultMessage = _reflection.GeneratedProtocolMessageType('RegisterHIDDeviceResultMessage', (_message.Message,), {'DESCRIPTOR':_REGISTERHIDDEVICERESULTMESSAGE, 
