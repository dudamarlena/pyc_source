...
# Embedded file name: build/bdist.linux-x86_64/egg/anderssontree/anderssontree.py
# Compiled at: 2013-10-18 12:55:01
__all__ = [
    ...
    def remove(self, key):
        ...
        def _remove(t, key):
            if t is not None:
                ...
                if t == _remove.last and _remove.deleted is not None and key == _remove.deleted.key:
