...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtcore/util/emitter.py
...
class TaurusEmitterThread(Qt.QThread):
    ...
    def __init__(self, parent=None, name='', queue=None, method=None, cursor=None, sleep=5000, polling=0, loopwait=5):
        """
    ...
    def getQueue(self):
        if self.queue:
            ...
            if hasattr(self.parent(), 'getQueue'):
...
class DelayedSubscriber(Logger):
    ...
    def __init__(self, schema, parent=None, sleep=10000, pause=5, period=0):
        ...
        self._modelsThread = TaurusEmitterThread(parent=parent, queue=self._modelsQueue, method=self._modelSubscriber, sleep=sleep, loopwait=pause, polling=period)
