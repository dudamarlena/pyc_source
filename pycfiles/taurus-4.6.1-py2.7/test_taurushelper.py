...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/test/test_taurushelper.py
# Compiled at: 2019-08-19 15:09:29
"""Test for taurus.core.taurushelper"""
__docformat__ = 'restructuredtext'
import numpy, functools, unittest
from taurus.core.units import Quantity
import taurus
from taurus.test import insertTest
from taurus.core import TaurusElementType, TaurusAttribute, TaurusDevice, TaurusAuthority, DataType, TaurusAttrValue, DataFormat
isValid = functools.partial(insertTest, helper_name='isValid')
isInvalid = functools.partial(insertTest, helper_name='isValid', expected=False)
isValidAuth = functools.partial(insertTest, helper_name='isValid', elementType=TaurusElementType.Authority)
isInvalidAuth = functools.partial(insertTest, helper_name='isValid', expected=False, elementType=TaurusElementType.Authority)
isValidDev = functools.partial(insertTest, helper_name='isValid', elementType=TaurusElementType.Device)
isInvalidDev = functools.partial(insertTest, helper_name='isValid', expected=False, elementType=TaurusElementType.Device)
isValidAttr = functools.partial(insertTest, helper_name='isValid', elementType=TaurusElementType.Attribute)
isInvalidAttr = functools.partial(insertTest, helper_name='isValid', expected=False, elementType=TaurusElementType.Attribute)
...
@isValidAttr(name='implicittangoalias/attrname', skip=DEFAULT_SCHEME != 'tango')
...
@isValidAttr(name='implicit/tango/attr/name#label', skip=DEFAULT_SCHEME != 'tango')
@isValidAttr(name='implicittangoalias/attrname#label', skip=DEFAULT_SCHEME != 'tango')
...
class IsValidNameTestCase(unittest.TestCase):
    ...
    def isValid(self, name=None, expected=True, elementType=None, strict=True, skip=False, skipmsg='Test explicitly disabled'):
    ...
    def test_unsupported(self):
        ...
        msg = 'Validating unsupported schemes must return False (got %s)' % returned
...
@insertTest(helper_name='read_attr', name='eval:2*{eval:x=2;x}', expected=dict(label='2*x', data_format=DataFormat._0D, type=DataType.Integer))
@insertTest(helper_name='read_attr', name='eval:x=-1;x+{eval:x=2;x}+{eval:x=10;x}', expected=dict(data_format=DataFormat._0D, wvalue=None, w_value=None, label='x+x+x', type=DataType.Integer))
@insertTest(helper_name='read_attr', name='eval://2*{eval://1.0}+{eval://2.0}', expected=dict(data_format=DataFormat._0D, type=DataType.Float, label='2*1.0+2.0'))
@insertTest(helper_name='read_attr', name='eval:2*{tango:sys/tg_test/1/short_scalar}', expected=dict(data_format=DataFormat._0D, type=DataType.Integer, label='2*short_scalar'))
@insertTest(helper_name='read_attr', name='eval:1==1', expected=dict(data_format=DataFormat._0D, type=DataType.Boolean, label='1==1'))
@insertTest(helper_name='read_attr', name='eval:[1,2,3]', expected=dict(data_format=DataFormat._1D, type=DataType.Integer, label='[1,2,3]'))
@insertTest(helper_name='read_attr', name='eval:img={tango:sys/tg_test/1/short_image_ro};img+10*rand(*img.shape)', expected=dict(data_format=DataFormat._2D, type=DataType.Float))
@insertTest(helper_name='read_attr', name='eval:{tango:sys/tg_test/1/string_image}', expected=dict(data_format=DataFormat._2D, type=DataType.String))
@insertTest(helper_name='get_object', name='tango:a/b/c/d')
@insertTest(helper_name='read_attr', name='tango:sys/tg_test/1/short_scalar', expected=dict(data_format=DataFormat._0D, type=DataType.Integer, label='short_scalar'))
@insertTest(helper_name='read_attr', name='tango:sys/tg_test/1/float_image', expected=dict(data_format=DataFormat._2D, type=DataType.Float, label='float_image'))
@insertTest(helper_name='read_attr', name='tango:sys/tg_test/1/boolean_scalar', expected=dict(data_format=DataFormat._0D, type=DataType.Boolean, label='boolean_scalar'))
@insertTest(helper_name='read_attr', name='tango:sys/tg_test/1/double_spectrum', expected=dict(data_format=DataFormat._1D, type=DataType.Float, label='double_spectrum'))
@insertTest(helper_name='read_attr', name='eval:1.0', expected=dict(rvalue=1.0, value=1.0, wvalue=None, w_value=None, label='1.0', type=DataType.Float, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:x=3;x+1', expected=dict(rvalue=4, value=4, wvalue=None, w_value=None, label='x+1', type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:2*{eval:3}', expected=dict(rvalue=6, value=6, label='2*3', wvalue=None, w_value=None, type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:2*{eval:3*{eval:4}}', expected=dict(rvalue=24, value=24, label='2*3*4', wvalue=None, w_value=None, type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:1*{eval:2*{eval:3*{eval:4}}}', expected=dict(rvalue=24, value=24, label='1*2*3*4', wvalue=None, w_value=None, type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:{eval:1}+{eval:9}', expected=dict(rvalue=10, value=10, label='1+9', wvalue=None, w_value=None, type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:"aaa"+"bbb"', expected=dict(rvalue='aaabbb', value='aaabbb', label='"aaa"+"bbb"', wvalue=None, w_value=None, type=DataType.String, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:{eval:"aaa"}+{eval:"bbb"}', expected=dict(rvalue='aaabbb', value='aaabbb', wvalue=None, w_value=None, label='"aaa"+"bbb"', type=DataType.String, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:{eval:"a"}*3', expected=dict(rvalue='aaa', value='aaa', label='"a"*3', wvalue=None, w_value=None, type=DataType.String, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:len("abc")', expected=dict(rvalue=3, wvalue=None, value=3, w_value=None, label='len("abc")', type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:"a.b.c".split(".")', expected=dict(rvalue=['a', 'b', 'c'], value=['a', 'b', 'c'], wvalue=None, w_value=None, label='"a.b.c".split(".")', type=DataType.String, data_format=DataFormat._1D))
@insertTest(helper_name='read_attr', name='eval:[1,1,1].count(1)', expected=dict(rvalue=3, wvalue=None, value=3, w_value=None, type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:[1,2,3].reverse()', expected=dict(rvalue=None, value=None, wvalue=None, w_value=None, label='[1,2,3].reverse()'))
@insertTest(helper_name='read_attr', name='eval:[1,1,3].count(1)*{eval:[1,1,3].count(1)*{eval:2}}', expected=dict(rvalue=8, value=8, wvalue=None, w_value=None, type=DataType.Integer))
@insertTest(helper_name='read_attr', name='eval:"split.split".split("split")', expected=dict(rvalue=['', '.', ''], value=['', '.', ''], wvalue=None, w_value=None, label='"split.split".split("split")', type=DataType.String))
@insertTest(helper_name='read_attr', name='eval:Quantity(1.0)', expected=dict(rvalue=Quantity(1.0), value=1.0, w_value=None, wvalue=None, label='Quantity(1.0)', type=DataType.Float, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:Quantity("1km")', expected=dict(rvalue=Quantity(1000, 'm'), value=1, w_value=None, wvalue=None, label='Quantity("1km")', type=DataType.Integer, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:Quantity("0.1km")', expected=dict(rvalue=Quantity(100, 'm'), value=0.1, w_value=None, wvalue=None, label='Quantity("0.1km")', type=DataType.Float, data_format=DataFormat._0D))
@insertTest(helper_name='read_attr', name='eval:Q("1m")*3+{eval:Q(3,"dm")}', expected=dict(rvalue=Quantity('3.3m'), value=3.3, wvalue=None, w_value=None, label='Q("1m")*3+Q(3,"dm")', type=DataType.Float))
@insertTest(helper_name='read_attr', name='eval:Q("1km").to("mm").magnitude', expected=dict(rvalue=1000000.0, value=1000000.0, wvalue=None, w_value=None, label='Q("1km").to("mm").magnitude', type=DataType.Float))
@insertTest(helper_name='read_attr', name='eval:@d=datetime.date(1931,4,14)/d.isoformat()', expected=dict(rvalue='1931-04-14', value='1931-04-14', wvalue=None, w_value=None, label='d.isoformat()', type=DataType.String))
...
class AttributeTestCase(unittest.TestCase):
    ...
    def read_attr(self, name=None, expected=None, skip=False, skipmsg='Test explicitly disabled'):
...
class ValidatorFromName(unittest.TestCase):
    ...
    def test_getValidatorFromName(self):
        ...
        self.assertIsInstance(taurus.getValidatorFromName('eval:@foo'), taurus.core.evaluation.evalvalidator.EvaluationDeviceNameValidator)
