...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtcore/model/taurusmodel.py
...
QtQt = Qt.Qt
__all__ = [
 'TaurusBaseTreeItem', 'TaurusBaseModel', 'TaurusBaseProxyModel']
...
class TaurusBaseModel(Qt.QAbstractItemModel, Logger):
    ...
    def setupModelData(self, data):
        raise NotImplementedError('setupModelData must be implemented in %s' % self.__class__.__name__)

    def roleIcon(self, role):
        raise NotImplementedError('roleIcon must be implemented in %s' % self.__class__.__name__)

    def roleSize(self, role):
        raise NotImplementedError('roleSize must be implemented in %s' % self.__class__.__name__)

    def roleToolTip(self, role):
        raise NotImplementedError('roleToolTip must be implemented in %s' % self.__class__.__name__)
