...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/util/tauruswidgetfactory.py
# Compiled at: 2019-08-19 15:09:30
"""
tauruswidgetfactory.py:
"""
__all__ = [
 'TaurusWidgetFactory', 'getWidgetsOfType']
...
class TaurusWidgetFactory(Singleton, Logger):
    ...
    skip_modules = ('widget', 'util', 'qtdesigner', 'uic', 'resource', 'console')
    ...
    def _buildWidgets(self, module_name, path, recursive=True):
        ...
        if '__init__.py' not in elems:
            ...
            for elem in elems:
                ...
                if not elem.startswith('.') and os.path.isdir(abs_elem) and elem not in self.skip_modules:
