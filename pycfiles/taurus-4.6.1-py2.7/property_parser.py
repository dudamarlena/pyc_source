...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/util/property_parser.py
# Compiled at: 2019-08-19 15:09:29
"""This is an experimental property parser"""
from __future__ import print_function
from builtins import str
import os, ply.lex as lex, ply.yacc as yacc
from .containers import CaselessDict
from .log import Logger
reserved = CaselessDict({'true': 'true', 
   'false': 'false', 
   'yes': 'yes', 
   'no': 'no'})
tokens = [
 ...
 'NUMBER',
 'COMMA',
 'LLST', 'RLST'] + list(reserved.values())
t_EQUALS = '\\='
t_LLST = '\\['
t_RLST = '\\]'
t_COMMA = '\\,'
