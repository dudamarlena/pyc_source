...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/tango/util/tango_taurus.py
# Compiled at: 2019-08-19 15:09:29
"""Utility functions to convert between tango and Taurus types"""
import PyTango
from taurus.core.units import Quantity, UR
from pint import UndefinedUnitError
from taurus.core.taurusbasetypes import AttrQuality, DisplayLevel, TaurusAttrValue, DataType, DataFormat
__NO_STR_VALUE = (
 PyTango.constants.AlrmValueNotSpec, PyTango.constants.StatusNotSet)
FROM_TANGO_TO_TAURUS_DFORMAT = {PyTango.AttrDataFormat.SCALAR: DataFormat._0D, PyTango.AttrDataFormat.SPECTRUM: DataFormat._1D, 
   PyTango.AttrDataFormat.IMAGE: DataFormat._2D}
FROM_TANGO_TO_TAURUS_TYPE = {PyTango.CmdArgType.DevVoid: None, PyTango.CmdArgType.DevBoolean: DataType.Boolean, 
...
def quantity_from_tango_str(value_str, dtype=None, units=None, fmt=None, ignore_exception=True):
    try:
...
__NULL_DESC = (
 PyTango.constants.DescNotSet, PyTango.constants.DescNotSpec)
