...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/input/taurusspinbox.py
...
__all__ = [
 'TaurusValueSpinBox', 'TaurusValueSpinBoxEx']
...
class TaurusValueSpinBox(Qt.QAbstractSpinBox):
    ...
    singleStep = Qt.pyqtProperty('double', getSingleStep, setSingleStep, resetSingleStep)
    ...
    autoApply = Qt.pyqtProperty('bool', getAutoApply, setAutoApply, resetAutoApply)
    forcedApply = Qt.pyqtProperty('bool', getForcedApply, setForcedApply, resetForcedApply)
...
def main():
    ...
    if owns_app:
        ...
        app = Application(sys.argv, cmd_line_parser=parser, app_name='Taurus spinbox demo', app_version='1.0', org_domain='Taurus', org_name='Tango community')
