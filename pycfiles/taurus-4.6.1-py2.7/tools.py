...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/extra_guiqwt/tools.py
...
class TaurusCurveChooserTool(CommandTool):
    ...
    def __init__(self, manager, toolbar_id=DefaultToolbarID):
        super(TaurusCurveChooserTool, self).__init__(manager, 'Taurus Models...', Qt.QIcon('logos:taurus.png'), toolbar_id=toolbar_id)
...
class TaurusImageChooserTool(CommandTool):
    ...
    def __init__(self, manager, toolbar_id=DefaultToolbarID):
        super(TaurusImageChooserTool, self).__init__(manager, 'Add Taurus images...', Qt.QIcon('logos:taurus.png'), toolbar_id=toolbar_id)
...
class TaurusModelChooserTool(CommandTool):
    ...
    def __init__(self, manager, toolbar_id=DefaultToolbarID, singleModel=False):
        super(TaurusModelChooserTool, self).__init__(manager, 'Change Taurus Model...', Qt.QIcon('logos:taurus.png'), toolbar_id=toolbar_id)
...
class TimeAxisTool(CommandTool):
    ...
    def __init__(self, manager):
        super(TimeAxisTool, self).__init__(manager, 'Time Scale', icon=Qt.QIcon('status:awaiting.svg'), tip=None, toolbar_id=None)
    ...
    def create_action_menu(self, manager):
        ...
        self.scale_menu = {(False, False): y_x, (True, False): y_t, (False, True): t_x, 
           (True, True): t_t}
...
class AutoScrollTool(ToggleTool, BaseConfigurableClass):
    ...
    def __init__(self, manager, scrollFactor=0.2, toolbar_id=None):
        ToggleTool.__init__(self, manager, title='Auto Scroll', icon=None, tip='Force X scale to always show the last value', toolbar_id=toolbar_id)
        BaseConfigurableClass.__init__(self)
        self.scrollFactor = scrollFactor
        self.registerConfigProperty(self.action.isChecked, self.setChecked, 'actionChecked')
        return
...
class _BaseAutoScaleTool(ToggleTool, BaseConfigurableClass):
    ...
    def __init__(self, manager, axis, toolbar_id=None):
        ToggleTool.__init__(self, manager, title='Auto-scale %s axis' % axis, icon=None, tip='Auto-scale %s axis when data changes', toolbar_id=toolbar_id)
        BaseConfigurableClass.__init__(self)
        self.axis = axis
        self.registerConfigProperty(self.action.isChecked, self.setChecked, 'actionChecked')
        return
    ...
    def getWatchableItems(self, plot):
        return [ item for item in plot.get_items() if hasattr(item, 'dataChanged') ]
...
class AutoScaleXTool(_BaseAutoScaleTool):
    ...
    def __init__(self, manager, toolbar_id=None):
        _BaseAutoScaleTool.__init__(self, manager, axis='bottom', toolbar_id=toolbar_id)
...
class AutoScaleYTool(_BaseAutoScaleTool):
    ...
    def __init__(self, manager, toolbar_id=None):
        _BaseAutoScaleTool.__init__(self, manager, axis='left', toolbar_id=toolbar_id)
...
class AutoScaleZTool(_BaseAutoScaleTool):
    ...
    def __init__(self, manager, toolbar_id=None):
        _BaseAutoScaleTool.__init__(self, manager, axis='Z', toolbar_id=toolbar_id)
