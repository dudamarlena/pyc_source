...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/input/choicedlg.py
...
__all__ = [
 'GraphicalChoiceDlg', 'GraphicalChoiceWidget']
...
class GraphicalChoiceDlg(Qt.QDialog):
    ...
    def __init__(self, parent=None, designMode=False, choices=None, pixmaps=None, iconSize=128, defaultPixmap=None, horizontalScrollBarPolicy=Qt.Qt.ScrollBarAsNeeded, verticalScrollBarPolicy=Qt.Qt.ScrollBarAsNeeded):
        ...
        self._iconsArea = GraphicalChoiceWidget(parent=parent, designMode=designMode, choices=choices, pixmaps=pixmaps, iconSize=iconSize, defaultPixmap=defaultPixmap, horizontalScrollBarPolicy=horizontalScrollBarPolicy, verticalScrollBarPolicy=verticalScrollBarPolicy)
    ...
    def getChoice(parent=None, title='', msg='', choices=None, pixmaps=None, iconSize=128, defaultPixmap=None, horizontalScrollBarPolicy=Qt.Qt.ScrollBarAsNeeded, verticalScrollBarPolicy=Qt.Qt.ScrollBarAsNeeded):
        ...
        """
        dlg = GraphicalChoiceDlg(parent=parent, choices=choices, pixmaps=pixmaps, iconSize=iconSize, defaultPixmap=defaultPixmap, horizontalScrollBarPolicy=horizontalScrollBarPolicy, verticalScrollBarPolicy=verticalScrollBarPolicy)
...
class GraphicalChoiceWidget(Qt.QScrollArea):
    ...
    def getQtDesignerPluginInfo(cls):
        ...
        return {'module': 'taurus.qt.qtgui.input', 
           'group': 'Taurus Input', 
           'icon': 'logos:taurus.png', 
           'container': False}
...
def main():
    ...
    choices = [
     [
      'TaurusForm', 'TaurusTrend'], ['TaurusPlot', 'Qub']]
    for row in choices:
        for k in row:
