...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/console/list.py
...
class List(list):
    ...
    def __init__(self, header, header_separator=HeaderSeparator, row_separator=RowSeparator, max_col_width=MaxColumnWidth, text_alignment=TextAlignment):
