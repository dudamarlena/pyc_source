...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/tango/starter.py
...
import os, time, subprocess, PyTango
...
class Starter(object):
    ...
    def cleanDb(self, force=False):
        ...
        if (self.serverExisted or len(self._addedDevices) == 0) and not force:
            msg = ('%s was not registered by this starter. Not removing. ' + 'Use %s.cleanDb(force=True) to force cleanup') % (
