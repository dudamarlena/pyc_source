...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/container/taurusgroupwidget.py
...
def demo():
    ...
    groupwidget = TaurusGroupWidget()
    groupwidget.model = 'sys/tg_test/1'
    groupwidget.setTitleStyle({'start_color': 'rgb(255, 60, 60)', 
       'stop_color': 'rgb(200, 0, 0)', 
       'font_color': 'rgb(140, 0, 0)', 
       'border_radius': '10px'})
    groupwidget.setContentStyle({'border_radius': '0px'})
