...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/display/qled.py
# Compiled at: 2019-08-19 15:09:29
"""A pure Qt led widget"""
__all__ = [
 'LedColor', 'LedStatus', 'LedSize', 'QLed', 'QLedOld']
...
class QLed(QPixmapWidget):
    ...
    ledStatus = Qt.pyqtProperty('bool', getLedStatus, setLedStatus, resetLedStatus, doc='led status')
    ledColor = Qt.pyqtProperty('QString', getLedColor, setLedColor, resetLedColor, doc='led color')
    ledInverted = Qt.pyqtProperty('bool', getLedInverted, setLedInverted, resetLedInverted, doc='led inverted mode')
    ledPattern = Qt.pyqtProperty('QString', getLedPatternName, setLedPatternName, resetLedPatternName, doc='led pattern name')
    blinkingInterval = Qt.pyqtProperty('int', getBlinkingInterval, setBlinkingInterval, resetBlinkingInterval, doc='blinking interval')
