...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/util/log.py
...
import io, os, sys, logging.handlers, weakref, warnings, traceback, inspect, threading, functools
from .object import Object
from .wrap import wraps
from .excepthook import BaseExceptHook
from collections import defaultdict
__all__ = [
 'LogIt', 'TraceIt', 'DebugIt', 'InfoIt', 'WarnIt', 'ErrorIt',
...
class MemoryLogHandler(list, logging.handlers.BufferingHandler):
    ...
    def shouldFlush(self, record):
        ...
        """
        return len(self.buffer) >= self.capacity or record.levelno >= Logger.getLogLevel() or self._handler_list_changed
...
class Logger(Object):
    ...
    def deprecated(self, msg=None, dep=None, alt=None, rel=None, dbg_msg=None, _callerinfo=None, **kw):
        ...
        _MAX_DEPRECATIONS_LOGGED = getattr(tauruscustomsettings, '_MAX_DEPRECATIONS_LOGGED', None)
...
def deprecation_decorator(func=None, alt=None, rel=None, dbg_msg=None):
    ...
    if func is None:
        return functools.partial(deprecation_decorator, alt=alt, rel=rel, dbg_msg=dbg_msg)
    else:
