...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/tango/img/img.py
...
__all__ = [
 'ImageDevice', 'ImageCounterDevice', 'PyImageViewer', 'ImgGrabber',
...
class LimaCCDs(ImageCounterDevice):
    ...
    def __init__(self, name, image_name='video_last_image', image_ct='video_last_image_counter', **kw):
