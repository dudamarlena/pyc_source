...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/table/taurusdevicepropertytable.py
...
class TaurusPropTable(QtGui.QTableWidget, TaurusBaseWidget):
    ...
    model = QtCore.pyqtProperty('QString', TaurusBaseWidget.getModel, setModel, TaurusBaseWidget.resetModel)
...
if __name__ == '__main__':
    ...
    app = TaurusApplication(app_name='TaurusDevice property table', cmd_line_parser=None)
