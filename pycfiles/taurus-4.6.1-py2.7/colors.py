...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/util/colors.py
# Compiled at: 2019-08-19 15:09:29
"""This module contains color codes for state and quality"""
from __future__ import print_function
from builtins import object
__all__ = [
 'DEVICE_STATE_DATA', 'ATTRIBUTE_QUALITY_DATA', 'ColorPalette',
 'DEVICE_STATE_PALETTE', 'ATTRIBUTE_QUALITY_PALETTE']
DEVICE_STATE_DATA = {'TaurusDevState.Ready': ('Green', 0, 255, 0, 0), 
...
ATTRIBUTE_QUALITY_DATA = {'ATTR_INVALID': ('Gray', 128, 128, 128, 1), 
...
class ColorPalette(object):
    ...
    def rgb_pair(self, stoq):
        ...
        return (
         self.rgb(stoq), self.rgb(stoq, fg=True))
...
class _DeprecationDecoder(list):
    ...
    def get(self, i):
        ...
        deprecated(dep='Using ints for accessing elements of %s' % self.palette, alt='"%s"' % self[i], rel='4.0')
        return self[i]


_PYTANGO_DEVSTATE_INT_DECODER = _DeprecationDecoder('DEVICE_STATE_PALETTE', [
 'ON',
 'OFF',
 'CLOSE',
 'OPEN',
 ...
 'DISABLE',
 'UNKNOWN'])
_PYTANGO_ATTRQUALITY_INT_DECODER = _DeprecationDecoder('ATTRIBUTE_QUALITY_PALETTE', [
 'ATTR_VALID',
 'ATTR_INVALID',
 'ATTR_ALARM',
 'ATTR_CHANGING',
 'ATTR_WARNING'])
DEVICE_STATE_PALETTE = ColorPalette(DEVICE_STATE_DATA, _PYTANGO_DEVSTATE_INT_DECODER)
ATTRIBUTE_QUALITY_PALETTE = ColorPalette(ATTRIBUTE_QUALITY_DATA, _PYTANGO_ATTRQUALITY_INT_DECODER)
