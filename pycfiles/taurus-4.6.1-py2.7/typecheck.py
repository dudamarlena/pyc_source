...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/core/util/decorator/typecheck.py
...
def info(fname, expected, actual, flag):
    ...
    msg = "'%s' method " % fname + ('accepts', 'returns')[flag] + ' (%s), but ' % expected + ('was given',
                                                                                              'result is')[flag] + ' (%s)' % actual
    return msg