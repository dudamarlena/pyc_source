...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/extra_guiqwt/builder.py
# Compiled at: 2019-08-19 15:09:29
"""Extension of :mod:`guiqwt.builder`"""
from __future__ import absolute_import
import guiqwt.builder, numpy
from .curve import TaurusCurveItem, TaurusTrendItem
from .image import TaurusImageItem, TaurusRGBImageItem, TaurusEncodedImageItem, TaurusEncodedRGBImageItem, TaurusXYImageItem
...
class TaurusPlotItemBuilder(guiqwt.builder.PlotItemBuilder):
    ...
    def image(self, taurusmodel=None, **kwargs):
        ...
        if taurusmodel is None:
            ...
            self.set_image_param(param, title, alpha_mask, alpha, interpolation, background=background_color, colormap=colormap, xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax, xformat=xformat, yformat=yformat, zformat=zformat)
            ...
            elif Attribute(taurusmodel).getType() == DataType.DevEncoded:
    ...
    def xyimage(self, taurusmodel=None, **kwargs):
        if taurusmodel is None:
            ...
            self.set_image_param(param, title, alpha_mask, alpha, interpolation, background=background_color, colormap=colormap, xformat=xformat, yformat=yformat, zformat=zformat)
    ...
    def ttrend(self, model, taurusparam=None, title='', color=None, linestyle=None, linewidth=None, marker=None, markersize=None, markerfacecolor=None, markeredgecolor=None, shade=None, fitted=None, curvestyle=None, curvetype=None, baseline=None):
        """
        ...
        if not title:
            title = model
        self.set_param(curveparam, title, color, linestyle, linewidth, marker, markersize, markerfacecolor, markeredgecolor, shade, fitted, curvestyle, curvetype, baseline)
