...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/tree/qtree.py
...
class NavigationToolBar(BaseToolBar):
    ...
    def __init__(self, view=None, parent=None, designMode=False):
        ...
        af = ActionFactory()
        self._goIntoAction = af.createAction(self, 'Go Into', icon=Qt.QIcon.fromTheme('go-down'), tip='Go into the selected item', triggered=self.goInto)
        self._goUpAction = af.createAction(self, 'Go Up', icon=Qt.QIcon.fromTheme('go-up'), tip='Go up one level', triggered=self.goUp)
        self._goTopAction = af.createAction(self, 'Go Top', icon=Qt.QIcon.fromTheme('go-top'), tip='Go to top level', triggered=self.goTop)
...
class ExpansionBar(BaseToolBar):
    ...
    def __init__(self, view=None, parent=None, designMode=False):
        BaseToolBar.__init__(self, name='Taurus selection toolbar', view=view, parent=parent, designMode=designMode)
        af = ActionFactory()
        self._expandAllAction = af.createAction(self, 'Expand All', icon=Qt.QIcon('actions:expand.png'), tip='Expand all items', triggered=self.onExpandAll)
        self._collapseAllAction = af.createAction(self, 'Collapse All', icon=Qt.QIcon('actions:collapse.png'), tip='Collapse all items', triggered=self.onCollapseAll)
        self._expandSelectionAction = af.createAction(self, 'Expand selection', icon=Qt.QIcon('actions:expand-selection.png'), tip='Expand selection', triggered=self.onExpandSelection)
        self._collapseSelectionAction = af.createAction(self, 'Collapse All', icon=Qt.QIcon('actions:collapse-selection.png'), tip='Collapse selection', triggered=self.onCollapseSelection)
...
class QBaseTreeWidget(QBaseModelWidget):
    ...
    def __init__(self, parent=None, designMode=False, with_navigation_bar=True, with_filter_widget=True, with_selection_widget=True, with_refresh_widget=True, perspective=None, proxy=None):
        ...
        QBaseModelWidget.__init__(self, parent, with_filter_widget=with_filter_widget, with_selection_widget=with_selection_widget, with_refresh_widget=with_refresh_widget, perspective=perspective, proxy=proxy)
        return
