...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/taurus/qt/qtgui/icon/catalog.py
...
class QIconCatalogPage(GraphicalChoiceWidget):
    ...
    def __init__(self, prefix, iconSize=24, columns=10):
        ...
        GraphicalChoiceWidget.__init__(self, choices=choices, pixmaps=pixmaps, iconSize=iconSize, defaultPixmap=None)
        spacer = Qt.QSpacerItem(0, 0, Qt.QSizePolicy.Expanding, Qt.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacer, self.gridLayout.rowCount(), self.gridLayout.columnCount())
        return
...
class QIconCatalog(Qt.QTabWidget):
    ...
    def __init__(self, parent=None):
        ...
        progress = Qt.QProgressDialog('Building icon catalog...', None, 0, nprefix, self)
