...
class _Configuration(object):
    ...
    def _get_value_from_strvalue(self, key, strvalue):
        ...
        functable = {bool: lambda x: str(x).lower() not in ('0', '', 'False')}
