...
# [GCC 8.4.0]
# Embedded file name: /home/jnvilo/Projects/web/mycms/mycms/creole/shared/utils.py
...
import shlex
from mycms.creole.py3compat import TEXT_TYPE, PY3, repr2
try:
...
def get_pygments_formatter():
    if PYGMENTS:
        return HtmlFormatter(lineos=True, encoding='utf-8', style='colorful',
          outencoding='utf-8',
          cssclass='pygments')
