...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/synapseutils/monitor.py
        ...
        def with_retry_and_messaging(*args, **kwargs):
            ...
            while attempt <= retries:
                try:
                    ...
                    syn.sendMessage([destination], messageSubject, messageBody=('Call to %s completed successfully!' % func.__name__))
                    return output
                except Exception as e:
                    sys.stderr.write(traceback.format_exc())
                    syn.sendMessage([destination], messageSubject, messageBody=('Encountered a temporary Failure during upload.  Will retry %i more times. \n\n Error message was:\n%s\n\n%s' % (
