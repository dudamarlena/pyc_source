...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/synapseclient/core/version_check.py
...
"""
import json, pkg_resources, re, requests, synapseclient, sys
    ...
    try:
        if not current_version:
            ...
            if current_base_version in version_info['blacklist'] or current_version in version_info['blacklist']:
                msg = '\nPLEASE UPGRADE YOUR CLIENT\n\nUpgrading your SynapseClient is required. Please upgrade your client by typing:\n    pip install --upgrade synapseclient\n\n'
            ...
            if _version_tuple(current_version, levels=levels) < _version_tuple((version_info['latestVersion']), levels=levels):
                sys.stderr.write('\nUPGRADE AVAILABLE\n\nA more recent version of the Synapse Client (%s) is available. Your version (%s) can be upgraded by typing:\n    pip install --upgrade synapseclient\n\n' % (
