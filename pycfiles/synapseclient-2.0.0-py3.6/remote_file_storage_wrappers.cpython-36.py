...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/synapseclient/core/remote_file_storage_wrappers.py
# Compiled at: 2020-03-23 17:17:03
# Size of source mod 2**32: 7244 bytes
import os, time, multiprocessing, urllib.parse as urllib_parse
    ...
    def _create_progress_callback_func(file_size, filename, prefix=None):
        ...
        def progress_callback(bytes):
            with bytes_transferred.get_lock():
                ...
                printTransferProgress((bytes_transferred.value), file_size, prefix=prefix, postfix=filename, dt=(time.time() - t0),
