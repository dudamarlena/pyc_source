...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/pyxie/cli.py
# Compiled at: 2013-06-03 15:55:08
import os, sys, curses, traceback, curses.wrapper
...
class MultipleChoiceMenuPrompt:
    ...
    def __init__(self, menu, prompt, defaultSelections=[], headerNotice=None):
        self.menu = menu
        self.instructions = [
         'Type * to exit.', "Type # to see the items you've selected.", 'Type c to clear your selections.']
