...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\robopython\robo\motor.py
...
class Motor(object):
    ...
    def set_pwm(self, pwm, topic=None):
    ...
    def spin_distance(self, vel, distance, topic=None, wd=89):
