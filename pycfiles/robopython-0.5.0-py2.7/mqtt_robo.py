...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\robopython\mqtt_robo.py
...
class MQTT(object):
    ...
    def get_broker_address(self):
        ...
        try:
            ...
            print (
             'Could not find broker on this network: ', self.broker)
            return
    ...
    def connect(self):
        if self.broker_address is None:
            ...
            try:
                self.client.connect(self.broker_address, 1883, 30)
