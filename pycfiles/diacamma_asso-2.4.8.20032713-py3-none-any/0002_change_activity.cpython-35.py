...
# [GCC 8.4.0]
# Embedded file name: /var/lib/jenkins/jobs/Diacamma_generic/workspace/asso/diacamma/member/migrations/0002_change_activity.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.AlterField(model_name='license', name='activity', field=models.ForeignKey(default=None, on_delete=models.deletion.PROTECT, to='member.Activity', verbose_name='activity'))]