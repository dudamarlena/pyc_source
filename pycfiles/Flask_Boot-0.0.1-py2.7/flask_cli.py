...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/flask_boot/flask_cli.py
# Compiled at: 2018-09-06 06:45:51
"""
Flask Boot
Usage:
    ...
    with io.open(abs_path, 'w', encoding='utf-8') as (new_file):
        with io.open(src_file, 'r', encoding='utf-8') as (old_file):
            for line in old_file:
                new_line = line.replace('application', project_name).replace('Application', project_name.title())
