...
# [GCC 8.4.0]
# Embedded file name: /media/lxch/686e26f8-c6d4-4448-8fe4-c19802726dcb/projects/current/public/python/flacro/tests/__init__.py
# Compiled at: 2014-03-25 12:06:23
    ...
    def setUp(self):
        ...
        class TestSubclass(FlacroFor):
            ...
            def __init__(self, anything, **kwargs):
                ...
                super(TestSubclass, self).__init__(tag=kwargs.get('tag', None), mwhere='test_macros/test.html', mname='test_macro_with_attr')
                return
        ...
        ti2 = ti
        ti2['m'] = tim
        tabs_macro = TabGroupMacro(minimal=False, tag='tag_for_tab_macro', tabs_label='test_tabs', tab_groups=ti)
        minimal_tabs_macro = TabGroupMacro(minimal=True, tag='tag_for_minimal_tabs', tabs_label='minimal_test_tabs', tab_groups=ti2)
        packaged_macros = {'accordian_macro': accordian_macro, 'tabs_macro': tabs_macro, 
