...
# [GCC 8.4.0]
# Embedded file name: /home/aestrivex/anaconda3/lib/python3.7/site-packages/bct/algorithms/motifs.py
# Compiled at: 2020-04-27 14:47:22
# Size of source mod 2**32: 30829 bytes
...
def make_motif34lib():
    ...
    def motif3generate():
        ...
        _, ID = np.unique((CL.view(CL.dtype.descr * CL.shape[1])),
          return_inverse=True)
        ID += 1
    ...
    def motif4generate():
        n = 0
        M = np.zeros((3834, 12), dtype=bool)
        CL = np.zeros((3834, 16), dtype=(np.uint8))
    ...
    io.savemat(fname, mdict={'m3':m3,  'm3n':m3n,  'id3':id3,  'n3':n3,  'm4':m4, 
     'm4n':m4n,  'id4':id4,  'n4':n4})
