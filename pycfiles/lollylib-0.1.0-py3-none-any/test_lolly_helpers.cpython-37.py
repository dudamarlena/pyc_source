...
# [GCC 8.4.0]
# Embedded file name: /Volumes/WIN/ASSETS/PROG_PYTHON/2019/lollylib/lollylib/tests/test_lolly_helpers.py
# Compiled at: 2019-06-21 11:52:24
# Size of source mod 2**32: 23882 bytes
...
class TestLollyHelpers(TestCase):
    ...
    def test___init(self):
        self._TestLollyHelpers__create_test_dir_if_not_exists()
    ...
    def test_extract_substr_enclosed_in_seq(self):
        ...
        initial_seq = '[##'
        terminal_seq = '##]'
        result = lolly_helpers.extract_substr_enclosed_in_seq(data, initial_seq, terminal_seq, from_index=10, to_index=(len(data)))
        assert result == {'extracted':'two',  'remainder':'[##one##] ',  'error':''}
        data = '[##A##]\n'
        initial_seq = '[##'
        terminal_seq = '##]'
        result = lolly_helpers.extract_substr_enclosed_in_seq(data, initial_seq, terminal_seq, from_index=0, to_index=(-1),
