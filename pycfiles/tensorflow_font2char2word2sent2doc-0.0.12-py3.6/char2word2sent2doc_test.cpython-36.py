...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/font2char2word2sent2doc/char2word2sent2doc_test.py
# Compiled at: 2017-02-01 04:23:51
# Size of source mod 2**32: 1188 bytes
import sys, extenteten as ex, tensorflow as tf
from .char2word2sent2doc import char2word2sent2doc, def_char2word2sent2doc

def test_char2word2sent2doc():
    char2word2sent2doc((tf.zeros([64, 40, 20], tf.int32)), words=(tf.constant([[0, 0], [0, 1], [1, 0], [1, 1]], tf.int32)),
      char_space_size=2,
