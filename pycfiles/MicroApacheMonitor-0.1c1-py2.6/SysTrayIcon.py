...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\mapachemon\SysTrayIcon.py
# Compiled at: 2010-07-06 12:30:20
"""TODO

For now, the demo at the bottom shows how to use it..."""
import os, sys, win32api, win32con, win32gui_struct
try:
...
class SysTrayIcon(object):
    ...
    def __init__(self, icon, hover_text, menu_options, on_quit=None, default_menu_index=None, window_class_name=None):
        ...
        message_map = {win32gui.RegisterWindowMessage('TaskbarCreated'): self.restart, win32con.WM_DESTROY: self.destroy, 
