...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/codecs/test_mccdimage.py
...
class TestNormalTiffOK(unittest.TestCase):
    ...
    def test_read_openimage(self):
        ...
        self.assertEqual(obj.data.astype(int).tobytes(), self.imdata.astype(int).tobytes())
