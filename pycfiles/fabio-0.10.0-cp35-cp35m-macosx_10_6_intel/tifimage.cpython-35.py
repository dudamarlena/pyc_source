...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/tifimage.py
# Compiled at: 2020-04-03 09:02:03
# Size of source mod 2**32: 7923 bytes
"""
...
__authors__ = [
 'Jérôme Kieffer', 'Henning O. Sorensen', 'Erik Knudsen']
__date__ = '13/06/2019'
__license__ = 'MIT'
...
class TiffFrame(fabioimage.FabioFrame):
    __doc__ = 'Frame container for TIFF format'
...
class TifImage(fabioimage.FabioImage):
    ...
    def write(self, fname):
        ...
        with TiffIO.TiffIO(fname, mode='w') as (tiff_file):
            tiff_file.writeImage(self.data, info=self.header, software='fabio.tifimage', date=time.ctime())
