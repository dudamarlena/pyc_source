...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/speimage.py
...
class SpeImage(FabioImage):
    __doc__ = 'FabIO image class for Images for Princeton/SPE detector\n\n    Put some documentation here\n    '
    ...
    def _read_exposure_from_dom(self, dom):
        ...
        if len(dom.getElementsByTagName('Experiment')) != 1:
            if len(dom.getElementsByTagName('ShutterTiming')) == 1:
                exposure_time = dom.getElementsByTagName('ExposureTime')[0].childNodes[0]
                return np.float(exposure_time.toxml()) / 1000.0
            else:
                exposure_time = dom.getElementsByTagName('ReadoutControl')[0].getElementsByTagName('Time')[0].childNodes[0].nodeValue
            ...
            self._exposure_time = dom.getElementsByTagName('LegacyExperiment')[0].getElementsByTagName('Experiment')[0].getElementsByTagName('CollectionParameters')[0].getElementsByTagName('Exposure')[0].attributes['value'].value
    ...
    def _read_grating_from_dom(self, dom, infile):
        ...
        try:
            grating = dom.getElementsByTagName('Devices')[0].getElementsByTagName('Spectrometer')[0].getElementsByTagName('Grating')[0].getElementsByTagName('Selected')[0].childNodes[0].toxml()
    ...
    def _read_center_wavelength_from_dom(self, dom, infile):
        ...
        try:
            center_wavelength = dom.getElementsByTagName('Devices')[0].getElementsByTagName('Spectrometer')[0].getElementsByTagName('Grating')[0].getElementsByTagName('CenterWavelength')[0].childNodes[0].toxml()
    ...
    def _read_roi_from_dom(self, dom):
        ...
        try:
            roi_modus = str(dom.getElementsByTagName('ReadoutControl')[0].getElementsByTagName('RegionsOfInterest')[0].getElementsByTagName('Selection')[0].childNodes[0].toxml())
            if roi_modus == 'CustomRegions':
                roi_dom = dom.getElementsByTagName('ReadoutControl')[0].getElementsByTagName('RegionsOfInterest')[0].getElementsByTagName('CustomRegions')[0].getElementsByTagName('RegionOfInterest')[0]
