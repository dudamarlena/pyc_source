...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/pixiimage.py
...
class PixiImage(fabioimage.FabioImage):
    ...
    def _readdata(self, filepointer, img_num):
        ...
        data = numpy.frombuffer(filepointer.read(self._IMAGE_SIZE), numpy.uint16).copy()
