...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/codecs/test_speimage.py
...
class TestSpeImage(unittest.TestCase):
    ...
    def test_roi(self):
        ...
        self.assertEqual(len(self.v3_custom_region.header['x_calibration']), self.v3_custom_region.header['x_dim'])
