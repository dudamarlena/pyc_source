...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/codecs/test_fit2dmaskimage.py
...
class TestFaceMask(unittest.TestCase):
    __doc__ = ' test the picture of a face '
