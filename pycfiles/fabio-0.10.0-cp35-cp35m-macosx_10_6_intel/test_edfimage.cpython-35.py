...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/codecs/test_edfimage.py
# Compiled at: 2020-04-03 09:02:03
# Size of source mod 2**32: 25076 bytes
"""
# Unit tests
...
class TestBzipEdf(TestFlatEdfs):
    __doc__ = ' same for bzipped versions '
...
class TestGzipEdf(TestFlatEdfs):
    __doc__ = ' same for gzipped versions '
...
class TestSphere2SaxsSamples(unittest.TestCase):
    __doc__ = 'Test some samples from sphere2saxs'

    def setUp(self):
        unittest.TestCase.setUp(self)
        self.samples = UtilsTest.resources.getdir('sphere2saxs_output.tar.bz2')

    SAMPLES = {'multi.edf': (5, (200, 100), numpy.float32, (6.292408e-05, 0.5594252, 3.2911296, 0.82902604)), 
...
class TestEdfIterator(unittest.TestCase):
    __doc__ = 'Read different EDF files with lazy iterator\n    '
