...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/cbfimage.py
# Compiled at: 2020-04-03 09:02:03
# Size of source mod 2**32: 32828 bytes
"""
...
class CIF(dict):
    ...
    def _readCIF(cls, instream):
        ...
        if 'read' not in dir(instream):
            raise RuntimeError('CIF._readCIF(instream): I expected instream to be an opened file,             here I got %s type %s' % (instream, type(instream)))
    ...
    def _splitCIF(cls, bytes_text):
        ...
        while 1:
            if len(bytes_text) == 0:
                ...
                if bytes_text[0] == cls.SINGLE_QUOTE:
                    idx = 0
                    finished = False
                    while not finished:
                    ...
                    if bytes_text[0] == cls.DOUBLE_QUOTE:
                        idx = 0
                        finished = False
                        while not finished:
                        ...
                        if bytes_text[0] == cls.SEMICOLUMN:
    ...
    def saveCIF(self, _strFilename='test.cif', linesep=os.linesep, binary=False):
        ...
        try:
            ...
            logger.error('Error during the opening of file for write: %s', _strFilename)
            return
    ...
    def exists(self, sKey):
        ...
        """
        bExists = False
        if sKey in self and len(self[sKey]) >= 1 and self[sKey][0] not in (self.QUESTIONMARK, numpy.string_('.')):
            bExists = True
        return bExists
