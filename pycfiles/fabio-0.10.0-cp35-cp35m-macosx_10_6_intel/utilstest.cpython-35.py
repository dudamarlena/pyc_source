...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/utilstest.py
...
PACKAGE = 'fabio'
DATA_KEY = 'FABIO_DATA'
import os, sys, getpass, threading, logging, tempfile
...
class TestOptions(object):
    ...
    def __init__(self):
        ...
        self.resources = ExternalResources(PACKAGE, timeout=self.timeout, env_key=DATA_KEY, url_base=self.url_base)
