...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/testopenimage.py
...
class TestOpenMccd(unittest.TestCase):
    __doc__ = 'openimage opening mccd'
...
class TestOpenMask(unittest.TestCase):
    __doc__ = 'openimage opening fit2d msk'
...
class TestOpenBruker(unittest.TestCase):
    __doc__ = 'openimage opening bruker'
...
class TestOpenDtrek(unittest.TestCase):
    __doc__ = 'openimage opening adsc'
