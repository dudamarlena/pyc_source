...
# [GCC 8.4.0]
# Embedded file name: /Users/kieffer/workspace/fabio/build/lib.macosx-10.6-intel-3.5/fabio/test/test_frames.py
# Compiled at: 2019-03-04 08:01:16
# Size of source mod 2**32: 9298 bytes
from __future__ import print_function, with_statement, division, absolute_import
import unittest, logging, numpy, contextlib
logger = logging.getLogger(__name__)
import fabio.fabioimage, fabio.edfimage, fabio.file_series
from .utilstest import UtilsTest

class _CommonTestFrames(unittest.TestCase):
    __doc__ = 'Test generic tests which could append on frame iteration'
