...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/exif_utils/date_classifier.py
# Compiled at: 2018-10-28 03:29:08
...
def classify(directory_path, dest_directory_path='./out'):
    ...
    for filepath in filepaths:
        ...
        try:
            ...
            utils._exec('mv {} {}'.format(filepath, os.path.join(dt_path, filename)))
