...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pytestreport\api.py
...
__all__ = [
 'make_report', 'make_image', 'send_report']

def make_report(stream, data, theme=None, stylesheet=None, htmltemplate=None, javascript=None):
    test_runner = HTMLTestRunner(stream, theme=theme, stylesheet=stylesheet, htmltemplate=htmltemplate,
