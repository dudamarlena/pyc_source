...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/zotmer/commands/scan.py
# Compiled at: 2017-01-23 23:46:50
"""
Usage:
...
import array, cPickle, docopt, math, sys

def lev(x, y):
    zx = len(x)
    zy = len(y)
    buf0 = array.array('I', [ 0 ])
    buf1 = array.array('I', [ 0 ])
    v0 = buf0
    v1 = buf1
    for i in xrange(zy):
        v0[i] = i
