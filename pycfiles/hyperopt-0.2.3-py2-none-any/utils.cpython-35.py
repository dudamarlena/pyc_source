...
# [GCC 8.4.0]
# Embedded file name: /home/max/code/oss/hyperopt/hyperopt/utils.py
...
import datetime, numpy as np, logging, os, shutil, sys, uuid, numpy
from . import pyll
...
def get_most_recent_inds(obj):
    data = numpy.rec.array([(x['_id'], int(x['version'])) for x in obj], names=[
     '_id', 'version'])
