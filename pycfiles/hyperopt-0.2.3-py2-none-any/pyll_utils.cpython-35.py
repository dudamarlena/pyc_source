...
# [GCC 8.4.0]
# Embedded file name: /home/max/code/oss/hyperopt/hyperopt/pyll_utils.py
...
def validate_label(f):
    ...
    def wrapper(label, *args, **kwargs):
        ...
        is_literal_string = isinstance(label, Literal) and isinstance(label.obj, basestring)
...
def _expr_to_config(expr, conditions, hps):
    if expr.name == 'switch':
        ...
        assert idx.arg['obj'].name in ('randint', 'categorical')
