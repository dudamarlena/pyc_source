...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spatial_access/Configs.py
...
class Configs:
    ...
    DEFAULT_SPEED_LIMITS = {'road':30,  'motorway':96, 
     'motorway_link':48, 
    ...
    def __init__(self, walk_speed=5, bike_speed=15.5, default_drive_speed=40, walk_node_penalty=0, bike_node_penalty=0, drive_node_penalty=4, speed_limit_dict=None, use_meters=False, disable_area_threshold=False, require_extended_range=False, epsilon=0.05):
        """
        Args:
        ...
        self.walk_node_penalty = walk_node_penalty
        self.default_drive_speed = default_drive_speed
        self.drive_node_penalty = drive_node_penalty
        self.bike_speed = bike_speed
        self.bike_node_penalty = bike_node_penalty
    ...
    def _get_driving_cost_matrix(self):
        ...
        """
        return pd.DataFrame.from_dict((self.speed_limit_dict), orient='index',
          columns=[
         'unit_cost'])
