...
# [GCC 8.4.0]
# Embedded file name: /Users/jpadilla/Dropbox/Projects/django-websocket-request/wsrequest/__init__.py
# Compiled at: 2014-01-24 09:48:08
...
class WebSocketRequest(object):
    ...
    def is_valid(self):
        ...
        if self.is_valid_message():
            ...
            if not self.url:
                ...
                return resolver_match or False
            is_valid = True
        return is_valid
    ...
    def get_request(self, factory):
        ...
        return getattr(factory, self.method)(self.url, self.data, content_type='application/json')
