...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/ccd/files.py
# Compiled at: 2011-05-03 15:52:24
import numpy as np, time, struct
from scipy import *
from pylab import *
...
__id__ = '$Id: files.py 209 2011-05-03 19:32:58Z stuwilkins $'
...
class PrincetonSPEFile:
    ...
    def _readComments(self):
        self._comments = []
        for n in range(5):
            self._comments.append(self._readAtString(200 + n * self.TEXTCOMMENTMAX, self.TEXTCOMMENTMAX))
