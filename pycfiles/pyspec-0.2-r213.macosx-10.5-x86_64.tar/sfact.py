...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/calcs/sfact.py
# Compiled at: 2010-10-28 09:12:57
...
def getF0(element, q=0.0):
    r"""Returns the scattering factor f_0
...
def calcRealF0(params, x=0):
    ...
    """
    r = scipy.exp(-1.0 * pow(pi, 2) * outer(1.0 / params[2], pow(x, 2)))
...
def calcF0(params, k=0):
    r"""Calculate f_0 from Cromer-Mann coefficients
        ...
        for line in infile:
            if line.split()[0] == '#S':
                if len(alldata):
                    ...
                    f2 = interpolate.interp1d(alldata[:, 0], alldata[:, 2] * -1.0)
