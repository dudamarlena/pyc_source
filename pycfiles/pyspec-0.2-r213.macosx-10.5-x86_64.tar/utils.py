...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/utils.py
# Compiled at: 2011-02-18 12:46:54
"""Set of useful utilities for plotting, and life in general!"""
from __future__ import with_statement
import pylab as pl, numpy as np, pickle, pyspec, os
...
def makePanelPlot(n=3, fig=None, xlmargin=0.15, ytmargin=0.1, xrmargin=0.05, ybmargin=0.1, ylabels=True):
...
def makeNicePlot(ax, xint=5, yint=5, mxint=4, myint=4, tickcolor=None, framecolor=None, xformat=None, yformat=None):
...
def setImageRange(data, limits, bins=100):
    ...
    b = np.arange(data.min(), data.max(), (data.max() - data.min()) / bins)
