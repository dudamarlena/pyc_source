...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/ccd/transformations.py
# Compiled at: 2011-05-03 15:52:24
import os, gc, time, sys, struct, numpy as np
...
__date__ = '$LastChangedDate: 2011-05-03 15:32:58 -0400 (Tue, 03 May 2011) $'
__id__ = '$Id: transformations.py 209 2011-05-03 19:32:58Z stuwilkins $'
...
class FileProcessor():
    ...
    def __init__(self, filenames=None, darkfilenames=None, norm=None, format='SPE', spec=None, process=False):
    ...
    def process(self, dark=True, norm=True, dtype=np.float, quiet=False, crop=False, BG=False):
    ...
    def save(self, filename, compressed=False):
        ...
        obj = {'images': self.images, 'normData': self.normData}
...
class ImageProcessor():
    ...
    def __init__(self, fP=None, configfile='ccd.cfg', ccdname=None, spec=None):
        ...
        self.setDetectorProp(0.02, 0.02, 1300, 1340, 650, 670)
    ...
    def readConfigFile(self, filename):
        ...
        pixx = config.getFloat(self.ccdName, 'pixel_xsize', 0.02)
        pixy = config.getFloat(self.ccdName, 'pixel_ysize', 0.02)
    ...
    def getDetectorProp(self):
        ...
        detY0       : float
             Detector Y-coordinate of center for reference."""
        return (
         self.detPixSizeX, self.detPixSizeY, self.detSizeX, self.detSizeY, self.detX0, self.detY0)
    ...
    def _setFromSpecScan(self):
        ...
        self.energy = Diffractometer.hc_over_e / self.conScan.wavelength
    ...
    def processToQ(self):
        ...
        print '\n**** Converting to Q'
        t1 = time.time()
        self.totSet = ctrans.ccdToQ(angles=(self.settingAngles * np.pi / 180.0), mode=self.frameMode, ccd_size=(
         self.detSizeX, self.detSizeY), ccd_pixsize=(
         self.detPixSizeX, self.detPixSizeY), ccd_cen=(
         self.detX0, self.detY0), dist=self.detDis, wavelength=self.waveLen, UBinv=np.matrix(self.UBmat).I, **ccdToQkwArgs)
        t2 = time.time()
...
if __name__ == '__main__':
    ...
    sf = spec.SpecDataFile('/home/tardis/spartzsch/data/ymn2o5_oct10/ymn2o5_oct10_1', ccdpath='/mounts/davros/nasshare/images/oct10')
    scan = sf[360]
