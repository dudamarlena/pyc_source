...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/fitfuncs.py
# Compiled at: 2011-04-13 16:45:09
import numpy, time as _time
try:
    import wx as _wx
except ImportError:
    pass
...
__version__ = '$Revision: 202 $'
__author__ = 'Stuart B. Wilkins <stuwilkins@mac.com>'
__date__ = '$LastChangedDate: 2011-04-07 11:24:06 -0400 (Thu, 07 Apr 2011) $'
__id__ = '$Id: fitfuncs.py 202 2011-04-07 15:24:06Z stuwilkins $'
...
def peakguess(x, y):
    ...
    height = ty.max()
    out = [
     centre, width, integral, height, m, c]
    return out
...
def lor2(x, p, mode='eval'):
    r"""Lorentzian squared defined by amplitude
...
def lor(x, p, mode='eval'):
    r"""Lorentzian defined by amplitude
...
def gauss(x, p, mode='eval'):
    r"""Gaussian defined by amplitide
