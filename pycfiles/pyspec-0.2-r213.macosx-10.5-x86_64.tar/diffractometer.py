...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/diffractometer.py
...
__date__ = '$LastChangedDate: 2011-02-13 14:08:16 -0500 (Sun, 13 Feb 2011) $'
...
class Diffractometer:
    ...
    def setAngles(self, delta=None, theta=None, chi=None, phi=None, mu=None, gamma=None, mode='deg'):
