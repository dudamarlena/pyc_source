...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/calcs/structures.py
# Compiled at: 2010-10-28 09:13:10
import crystal
...
def Nickelate(x=0):
    ...
    c.addAtom('LaSr', 'La', '', 0, 0, 0.3618, occ=La)
    c.addAtom('LaSr', 'Sr', '', 0, 0, 0.3618, occ=Sr)
...
def SrTiO3():
    ...
    c.addAtom('Sr1', 'Sr', '', 0.0, 0.0, 0.0)
    c.addAtom('O1', 'O', '2-', 0.0, 0.5, 0.5)
    return c
