...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/EPD64.framework/Versions/7.0/lib/python2.7/site-packages/pyspec/fit.py
# Compiled at: 2011-02-18 12:46:54
...
"""
from scipy import *
import pylab, cmd, time, warnings
try:
...
__version__ = '$Revision: 183 $'
__author__ = 'Stuart B. Wilkins <stuwilkins@mac.com>'
__date__ = '$LastChangedDate: 2011-02-18 12:45:54 -0500 (Fri, 18 Feb 2011) $'
__id__ = '$Id: fit.py 183 2011-02-18 17:45:54Z stuwilkins $'
...
class fit():
    ...
    def __init__(self, x=None, y=None, e=None, funcs=None, guess=None, quiet=False, optimizer='mpfit', ifix=None, ilimited=None, ilimits=None, xlimits=None, xlimitstype='world', interactive=False, r2min=0.0, debug=0):
        self.debug = debug
    ...
    def _run_mpfit(self):
        ...
        for i in range(len(self._guess)):
            pdict = {'value': self._guess[i].copy(), 'fixed': 0, 
    ...
    def _run_levmar(self):
        ...
        result, covar, iterations, run_info = levmar.ddif(self._modelLEVMAR, self._guess, ravel(self._datay), 10000)
    ...
    def chiSquared(self, norm=True, dist='poisson'):
        r""" Return the chi-squared value for the fit
