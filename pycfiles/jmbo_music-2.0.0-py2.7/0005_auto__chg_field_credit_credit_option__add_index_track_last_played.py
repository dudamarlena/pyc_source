...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/music/migrations/0005_auto__chg_field_credit_credit_option__add_index_track_last_played.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'music.credit': {'Meta': {'object_name': 'Credit'}, 'contributor': (
                        ...
                        'credit_option': (
                                        'django.db.models.fields.related.ForeignKey', [], {'to': "orm['music.CreditOption']", 'null': 'True'}), 
                        'id': (
                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                        'track': (
