...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/music/migrations/0004_auto__del_musiccreditoption__add_creditoption__del_field_credit_role__.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('music', ['CreditOption'])
        db.delete_column('music_credit', 'role')
        db.add_column('music_credit', 'credit_option', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['music.CreditOption']), keep_default=False)
    ...
    def backwards(self, orm):
        db.create_table('music_musiccreditoption', (
         ...
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'role_type', self.gf('django.db.models.fields.CharField')(max_length=16))))
        db.send_create_signal('music', ['MusicCreditOption'])
        db.delete_table('music_creditoption')
        db.add_column('music_credit', 'role', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
        db.delete_column('music_credit', 'credit_option_id')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'music.album': {'Meta': {'ordering': "('-created',)", 'object_name': 'Album', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                       'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'music.audioembed': {'Meta': {'ordering': "('-created',)", 'object_name': 'AudioEmbed', '_ormbases': ['jmbo.ModelBase']}, 'embed': (
                                    'django.db.models.fields.TextField', [], {}), 
                            'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'music.credit': {'Meta': {'object_name': 'Credit'}, 'contributor': (
                                      'django.db.models.fields.related.ForeignKey', [], {'related_name': "'credits'", 'to': "orm['music.TrackContributor']"}), 
                        'credit_option': (
                                        'django.db.models.fields.related.ForeignKey', [], {'to': "orm['music.CreditOption']"}), 
                        'id': (
                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                        'track': (
                                'django.db.models.fields.related.ForeignKey', [], {'related_name': "'credits'", 'to': "orm['music.Track']"})}, 
       'music.creditoption': {'Meta': {'object_name': 'CreditOption'}, 'id': (
                                   'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                              'music_preferences': (
                                                  'django.db.models.fields.related.ForeignKey', [], {'to': "orm['preferences.MusicPreferences']"}), 
                              'role_name': (
                              ...
                              'role_type': (
                                          'django.db.models.fields.CharField', [], {'default': "'artist'", 'max_length': '16'})}, 
       'music.track': {'Meta': {'ordering': "('-created',)", 'object_name': 'Track', '_ormbases': ['jmbo.ModelBase']}, 'album': (
                               'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['music.Album']", 'null': 'True', 'blank': 'True'}), 
                       'audio_embed': (
                                     'django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}), 
                       'contributor': (
                                     'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'tracks'", 'symmetrical': 'False', 'through': "orm['music.Credit']", 'to': "orm['music.TrackContributor']"}), 
                       'last_played': (
                                     'django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}), 
                       'length': (
                                'django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}), 
                       ...
                       'video_embed': (
                                     'django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})}, 
       'music.trackcontributor': {'Meta': {'ordering': "('-created',)", 'object_name': 'TrackContributor', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                                  'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}), 
                                  'profile': (
                                            'ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}), 
                                  'track': (
                                          'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'contributors'", 'symmetrical': 'False', 'through': "orm['music.Credit']", 'to': "orm['music.Track']"})}, 
       ...
       'preferences.musicpreferences': {'Meta': {'object_name': 'MusicPreferences', '_ormbases': ['preferences.Preferences']}, 'preferences_ptr': (
