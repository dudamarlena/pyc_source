...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/music/migrations/0002_auto__add_field_track_audio_embed.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('music_track', 'audio_embed', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('music_track', 'audio_embed')
