...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/music/migrations/0003_auto__add_field_musiccreditoption_role_type.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('music_musiccreditoption', 'role_type', self.gf('django.db.models.fields.CharField')(default='artist', max_length=16), keep_default=False)

    def backwards(self, orm):
        db.delete_column('music_musiccreditoption', 'role_type')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'music.musiccreditoption': {'Meta': {'object_name': 'MusicCreditOption'}, 'id': (
                                        'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                   'music_preferences': (
