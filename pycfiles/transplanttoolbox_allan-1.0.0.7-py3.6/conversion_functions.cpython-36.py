...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/transplanttoolbox_allan/conversion_functions.py
# Compiled at: 2018-04-04 17:56:04
# Size of source mod 2**32: 20247 bytes
from __future__ import division, print_function, absolute_import
import argparse, sys, logging, os, re, requests, operator, glob, transplanttoolbox_allan.hla
...
def convert_allele_list_to_ags(hla_allele_list):
    ...
    allele_list_dict = {'Allele_list':hla_allele_list, 
     'UNOS antigens':ag_list,  'Bw4/6 epitopes':bw4_6_list}
