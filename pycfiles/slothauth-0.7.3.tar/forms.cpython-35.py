...
# [GCC 8.4.0]
# Embedded file name: /home/chris/workspace/slothauth/slothauth/forms.py
# Compiled at: 2017-02-06 16:04:35
...
class PasswordResetForm(forms.Form):
    error_messages = {'unknown': _("That email address doesn't have an associated user account. Are you sure you've registered?"), 
    ...
    def save(self, domain_override=None, subject=settings.ACCOUNT_EMAIL_PASSWORD_RESET_SUBJECT, text_email_template_name='password_reset_email.txt', html_email_template_name='password_reset_email.html', css_file=None, use_https=False, token_generator=default_token_generator, from_email=None, request=None):
        """
        ...
        for user in self.users_cache:
            context = {'email': user.email, 
             ...
             'protocol': 'http'}
            send_mail(subject, render_to_string(text_email_template_name, context), render_to_string(html_email_template_name, context), settings.ACCOUNT_EMAIL_FROM, user.email)