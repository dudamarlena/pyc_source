...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/minitestlib/Archive.py
# Compiled at: 2009-01-22 06:19:01
"""
...
class ArcFile(dict):
    ...
    def key(self):
        ...
        return os.path.join(self['path'], self['file'].split(ARCHIVE_FILE_SEPARATOR)[1])
        ...
        for line in db_file_content.splitlines():
            ...
            if xtype == 'FILES':
                ...
                for pair in pairs:
                    ...
                    self.files[gm_time].append(ArcFile(tc_name, journal, mtime))
...
class Archive:
    ...
    def __init__(self, arc_stat, arc_dir, tc_root_dir, gm_time, journal='journal'):
