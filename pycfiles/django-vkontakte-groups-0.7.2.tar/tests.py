...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-vkontakte-groups/vkontakte_groups/tests.py
# Compiled at: 2016-03-02 14:10:36
...
class VkontakteGroupsTest(VkontakteApiTestCase):
    ...
    def test_parse_group(self):
        ...
        self.assertEqual(instance.name, 'ВКонтакте API')
