...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-vkontakte-groups/vkontakte_groups/migrations/0007_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        m2m_table_name = db.shorten_name('vkontakte_groups_group_members')
        ...
        db.add_column('vkontakte_groups_group_members', 'time_from', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
        db.add_column('vkontakte_groups_group_members', 'time_to', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)

    def backwards(self, orm):
        db.delete_table(db.shorten_name('vkontakte_groups_group_members'))
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups.group': {'Meta': {'object_name': 'Group'}, 'fetched': (
                                  ...
                                  'is_closed': (
                                              'django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}), 
                                  'members': (
                                            'm2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'members_groups'", 'symmetrical': 'False', 'to': "orm['vkontakte_users.User']"}), 
                                  'members_count': (
