...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/sahriswiki/macros/html.py
# Compiled at: 2010-07-22 06:06:46
"""HTML Macros
...
def div(macro, environ, data, *args, **kwargs):
    ...
    **Example(s):**
    ...
    if macro.body is None:
        ...
        contents = environ.parser.generate(macro.body, context=context, environ=(
         environ, data))
        attrs = {}
        if id:
            attrs['id'] = id
...
def span(macro, environ, data, *args, **kwargs):
    ...
    **Example(s):**
    ...
    if not text:
        ...
        if style:
            style = (';').join(sanitizer.sanitize_css(style))
        contents = environ.parser.generate(text, context='inline', environ=(
         environ, data))
        attrs = {}
        if id:
            attrs['id'] = id
