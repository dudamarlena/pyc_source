...
# [GCC 8.4.0]
# Embedded file name: /Users/gman/Documents/code/Flask-Blogging/test/test_dynamodb.py
# Compiled at: 2018-02-15 00:06:52
# Size of source mod 2**32: 9131 bytes
try:
...
class TestDynamoDBStorage(FlaskBloggingTestCase):
    ...
    def test_delete_post(self):
        ...
        p = self.storage.get_post_by_id(pid)
        self.assertIsNone(p)
        pid1 = self.storage.save_post(title='Title1', text='Sample Text', user_id='testuser',
          tags=[
         'hello', 'world'],
          post_id=pid)
