...
# [GCC 8.4.0]
# Embedded file name: /home/kevin/src/cdbcli/build/lib/cdbcli/main.py
# Compiled at: 2016-07-12 23:07:51
import getpass, couchdb, click, repl
...
class Config(object):
    ...
    @property
    def url(self):
        return ('{scheme}://{cred}{host}:{port}').format(scheme=self.__scheme, cred=self._cred_string, host=self.__host, port=self.__port)
