...
# [GCC 8.4.0]
# Embedded file name: /home/kevin/src/cdbcli/build/lib/cdbcli/commands.py
# Compiled at: 2016-07-15 00:16:12
import functools, json, couchdb, pygments
...
def require_current_db(fn):
    ...
    def wrapper(*args, **kwargs):
        if not 'environment' in kwargs:
            ...
            raise (environment.current_db or RuntimeError)('No database selected.')
        return fn(*args, **kwargs)
