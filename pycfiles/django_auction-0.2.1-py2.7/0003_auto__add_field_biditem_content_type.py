...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/auction/migrations/0003_auto__add_field_biditem_content_type.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('auction_biditem', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)

    def backwards(self, orm):
        db.delete_column('auction_biditem', 'content_type_id')
