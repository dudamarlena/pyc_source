...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/auction/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('auction_auction', (
         ...
         (
          'polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_auction.auction_set', null=True, to=orm['contenttypes.ContentType'])),
         (
        ...
        db.create_table('auction_lot', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_auction.lot_set', null=True, to=orm['contenttypes.ContentType'])),
         (
          'name', self.gf('django.db.models.fields.CharField')(max_length=255)),
         (
        ...
        db.create_table('auction_bidbasket', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
         ...
         (
          'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))))
        db.send_create_signal('auction', ['BidBasket'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('auction_bidbasket')
        db.delete_table('auction_biditem')

    models = {'auction.auction': {'Meta': {'object_name': 'Auction'}, 'active': (
                           ...
                           'polymorphic_ctype': (
                                               'django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_auction.auction_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}), 
                           'slug': (
       ...
       'auction.bidbasket': {'Meta': {'object_name': 'BidBasket'}, 'date_added': (
                                          'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}), 
                             'id': (
                                  'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                             'last_modified': (
       ...
       'auction.biditem': {'Meta': {'object_name': 'BidItem'}, 'amount': (
                                    'auction.models.bases.CurrencyField', [], {'null': 'True', 'max_digits': '100', 'decimal_places': '2', 'blank': 'True'}), 
                           'bid_basket': (
                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'to': "orm['auction.BidBasket']"}), 
                           'id': (
                                'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                           'lot': (
                                 'django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'to': "orm['auction.Lot']"})}, 
       'auction.lot': {'Meta': {'object_name': 'Lot'}, 'active': (
                                'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                       'content_type': (
                       ...
                       'polymorphic_ctype': (
                                           'django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_auction.lot_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}), 
                       'slug': (
