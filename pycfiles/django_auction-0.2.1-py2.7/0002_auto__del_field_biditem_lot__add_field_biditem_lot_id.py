...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/auction/migrations/0002_auto__del_field_biditem_lot__add_field_biditem_lot_id.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('auction_biditem', 'lot_id')
        db.add_column('auction_biditem', 'lot_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'BidItem.lot' and its values cannot be restored.")
        db.delete_column('auction_biditem', 'lot_id')
    ...
    models = {'auction.auction': {'Meta': {'object_name': 'Auction'}, 'active': (
       ...
       'auction.bidbasket': {'Meta': {'object_name': 'BidBasket'}, 'date_added': (
                             ...
                             'last_modified': (
                                             'django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}), 
                             'user': (
                                    'django.db.models.fields.related.OneToOneField', [], {'related_name': "'auction_bidbasket_related'", 'unique': 'True', 'to': "orm['auth.User']"})}, 
       'auction.biditem': {'Meta': {'object_name': 'BidItem'}, 'amount': (
                           ...
                           'bid_basket': (
                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'auction_biditem_related'", 'to': "orm['auction.BidBasket']"}), 
                           'id': (
                                'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                           'lot_id': (
