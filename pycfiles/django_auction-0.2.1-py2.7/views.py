...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/auction/views.py
# Compiled at: 2013-04-22 05:31:36
...
import auction.models, auction.forms
...
class AuctionView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['object_list'] = auction.models.Lot.objects.filter(content_type__pk=object_type.pk, object_id=self.object.pk).all()
        return context
