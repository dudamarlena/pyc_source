...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yate/yate.py
# Compiled at: 2012-01-24 15:40:41
import sys, os, wx, wx.stc, wx.aui, fnmatch, ngram, syntax, config, json_theme_parser as theme
...
class Notebook(wx.aui.AuiNotebook):
    ...
    def close(self, page=None):
        ...
        if page != wx.NOT_FOUND:
            ...
            if editor:
                if editor.GetModify():
                    dialog = wx.MessageDialog(self, 'Save changes before closing?', 'Confirm Exit', wx.YES_NO | wx.CANCEL | wx.ICON_ERROR)
