...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nowandnext_tests/test_calquery_range.py
...
class test_calquery_currentevent(caltestcase):
    ...
    def testSunday(self):
        ...
        expectedevents = [
         'Middle East Panorama', 'Bonanza', 'Calling All Pensioners', 'The Rocket 88 Rock N Roll And Doo-Wop Show',
    ...
    def testSaturday(self):
        ...
        expectedevents = [
         "Max Tundra's Rotogravure", 'The Yummy Mummy School Run Show (repeat)', 'OST', 'Fillerdelphia']
        self.dotestCurrentEvents(startTime, endTime, expectedevents)
