...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nowandnext/calendar/detecterrorsinevent.py
# Compiled at: 2009-05-11 19:02:39
import re, socket, dns.resolver, urlparse, httplib, socket
...
DetectErrorsInEvent = BaseErrorDetector(DetectTitle(), DetectNoDescription(DetectInvalidChars(), DetectParsable(DetectNoWebLink(DetectBadWebLink(DetectLinkFunction())), DetectWebUnmatched(), DetectNoPresenter(), DetectNoEmail(DetectBadEmail()), DetectNoUnmatched())))
