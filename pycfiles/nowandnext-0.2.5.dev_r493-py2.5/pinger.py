...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nowandnext/applications/pinger.py
...
"""
import logging, datetime, optparse, pkg_resources, sys, os, Queue, datetime, socket, time
