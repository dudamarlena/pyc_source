...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/of/tools/setup/lib/widgets_misc.py
# Compiled at: 2016-10-23 20:53:34
# Size of source mod 2**32: 11946 bytes
"""
Created on Oct 30, 2013

@author: Nicklas Boerjesson
"""
from tkinter import Frame, SUNKEN, StringVar, IntVar, ttk, YView, XView, Scrollbar, Canvas, Variable, Text, Button
...
class Selector(Frame):
    __doc__ = 'The Selector class implements a selector, label and variable(to hold the data)\n    '
    caption = None
    ...
    def init_widgets(self):
        ...
        if self.caption_orientation == LEFT:
            ...
            if self.caption_orientation == RIGHT:
                _cb_o = LEFT
            else:
                if self.caption_orientation == TOP:
                    _cb_o = BOTTOM
...
class VerticalScrolledFrame(Frame):
    __doc__ = "A pure Tkinter scrollable frame that actually works!\n    * Use the 'interior' attribute to place widgets inside the scrollable frame\n    * Construct and pack/place/grid normally\n    * This frame only allows vertical scrolling\n\n    "
    ...
    def notify_messagebox(self, _title, _message, _kind=None):
        ...
        if self.master:
            if hasattr(self.master, 'notify_messagebox'):
                ...
                print(self.__class__.__name__ + ':Internal deficiency, ' + self.master.__class__.__name__ + ' should have a notify_messagebox function.\nTitle:' + _title + '\n' + _message)
        else:
            print('Title:' + _title + '\n' + _message)


class TextExtension(Frame):
    __doc__ = 'Extends Frame.  Intended as a container for a Text field.  Better related data handling\n    and has Y scrollbar.'
