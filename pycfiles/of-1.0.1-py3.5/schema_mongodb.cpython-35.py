...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/of/broker/lib/schema_mongodb.py
# Compiled at: 2016-09-15 19:50:18
# Size of source mod 2**32: 5421 bytes
"""
    ...
    def _set_object_ids(self, validator, properties, instance, schema):
        ...
        for _property, subschema in properties.items():
            if _property in instance:
                ...
                elif 'type' in subschema and subschema['type'] == 'array' and 'objectId' in subschema['items']:
