...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/of/common/internal.py
# Compiled at: 2016-12-12 05:27:37
...
def node_id_with_env(_node_id, _environment_id):
    ...
    """
    result = int(_node_id, 16) ^ int(_environment_id, 16)
