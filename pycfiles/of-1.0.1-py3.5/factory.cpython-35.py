...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/of/common/messaging/factory.py
...
def reply_with_error_message(_runtime_instance, _message, _error_message):
    ...
    """
    _struct = {'sourceProcessId': _runtime_instance.process_id, 
