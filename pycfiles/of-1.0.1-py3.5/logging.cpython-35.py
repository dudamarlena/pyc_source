...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/of/common/logging.py
# Compiled at: 2016-10-13 22:00:21
# Size of source mod 2**32: 12394 bytes
"""
...
if os.name == 'nt':
    import win32api, win32security, win32evtlog, win32con, win32evtlogutil
    ph = win32api.GetCurrentProcess()
    th = win32security.OpenProcessToken(ph, win32con.TOKEN_READ)
    my_sid = win32security.GetTokenInformation(th, win32security.TokenUser)[0]
    eventtype_severity = {SEV_DEBUG: win32evtlog.EVENTLOG_INFORMATION_TYPE, 
    ...
    def write_to_event_log(_data, _log_name, _category, _severity):
        ...
        _textual = [
         _strcategory[0] + _strcategory[1:] + '- severity: ' + severity_to_identifier(_severity=_severity),
         _data]
        win32evtlogutil.ReportEvent(_log_name, 1, eventType=eventtype_severity[_severity], strings=_textual, data='Raw\x00Data'.encode('ascii'), sid=my_sid)
...
def write_to_log(_data, _category=EC_NOTIFICATION, _severity=SEV_INFO, _process_id=None, _user_id=None, _occurred_when=None, _address=None, _node_id=None, _uid=None, _pid=None):
    """
    ...
    if callback is not None:
        ...
        print('Logging callback not set, print message:\n' + make_textual_log_message(_data, _category, _severity, _process_id, _user_id, _occurred_when, _address, _node_id, _uid, _pid))
    return _data


def make_event(_data, _category=None, _severity=None, _process_id=None, _user_id=None, _occurred_when=None, _address=None, _node_id=None, _uid=None, _pid=None):
    _event = {'data': _data, 
...
def make_textual_log_message(_data, _category=None, _severity=None, _process_id=None, _user_id=None, _occurred_when=None, _address=None, _node_id=None, _uid=None, _pid=None):
    """
    ...
    _result += '\nEvent category: ' + category_to_identifier(_category, 'invalid event category:') if _category is not None else ''
    _result += '\nSeverity: ' + severity_to_identifier(_severity, 'invalid severity level:') if _severity is not None else ''
...
def make_sparse_log_message(_data, _category=None, _severity=None, _process_id=None, _user_id=None, _occurred_when=None, _address=None, _node_id=None, _uid=None, _pid=None):
    """
    ...
    if _severity == SEV_DEBUG:
        ...
        if _severity in [SEV_INFO, SEV_ALERT, SEV_WARNING]:
            _prefix = '-'
        else:
            _prefix = '*'
