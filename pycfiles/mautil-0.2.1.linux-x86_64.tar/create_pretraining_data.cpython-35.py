...
# [GCC 8.4.0]
# Embedded file name: /home/tom/pyenv/py3/lib/python3.5/site-packages/mautil/tf_net/bert/create_pretraining_data.py
# Compiled at: 2019-07-15 21:40:48
# Size of source mod 2**32: 16475 bytes
"""Create masked LM/next sentence masked_lm TF examples for BERT."""
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import collections, random, tokenization, tensorflow as tf
flags = tf.flags
FLAGS = flags.FLAGS
...
class TrainingInstance(object):
    __doc__ = 'A single training instance (sentence pair).'
