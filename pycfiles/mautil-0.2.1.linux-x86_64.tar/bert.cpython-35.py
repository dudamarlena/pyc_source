...
# [GCC 8.4.0]
# Embedded file name: /home/tom/pyenv/py3/lib/python3.5/site-packages/mautil/tf_models/bert.py
# Compiled at: 2019-07-20 05:53:01
# Size of source mod 2**32: 5310 bytes
...
class BERT(TF):
    ...
    def add_bert(self, seqs, seqs_len, training):
        ...
        self._bert_model = modeling.BertModel(config=bert_config, is_training=training, input_ids=seqs, input_mask=mask, use_one_hot_embeddings=False)
    ...
    def bert_sents(self, sents, sents_id, max_len=512):
        ...
        return (
         seqs, seqs_len, ori_seqs_len, new_sents_ids, ori_to_tok_inds)