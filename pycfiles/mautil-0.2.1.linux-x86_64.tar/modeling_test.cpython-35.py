...
# [GCC 8.4.0]
# Embedded file name: /home/tom/pyenv/py3/lib/python3.5/site-packages/mautil/tf_net/bert/modeling_test.py
# Compiled at: 2019-07-15 21:40:48
# Size of source mod 2**32: 9191 bytes
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import collections, json, random, re, modeling, six, tensorflow as tf
...
class BertModelTest(tf.test.TestCase):
    ...
    class BertModelTester(object):
        ...
        def create_model(self):
            ...
            config = modeling.BertConfig(vocab_size=self.vocab_size, hidden_size=self.hidden_size, num_hidden_layers=self.num_hidden_layers, num_attention_heads=self.num_attention_heads, intermediate_size=self.intermediate_size, hidden_act=self.hidden_act, hidden_dropout_prob=self.hidden_dropout_prob, attention_probs_dropout_prob=self.attention_probs_dropout_prob, max_position_embeddings=self.max_position_embeddings, type_vocab_size=self.type_vocab_size, initializer_range=self.initializer_range)
            model = modeling.BertModel(config=config, is_training=self.is_training, input_ids=input_ids, input_mask=input_mask, token_type_ids=token_type_ids, scope=self.scope)
    ...
    def assert_all_tensors_reachable(self, sess, outputs):
        ...
        self.assertEqual(len(unreachable), 0, 'The following ops are unreachable: %s' % ' '.join([x.name for x in unreachable]))
