...
# [GCC 8.4.0]
# Embedded file name: /home/tom/pyenv/py3/lib/python3.5/site-packages/mautil/tf_util.py
# Compiled at: 2019-07-14 01:52:17
...
def ds2tfrecord(ds, input_features, filepath):
    ...
    for fea in input_features:
        if fea.dtype in [tf.int32, tf.int16, tf.int64]:
            ...
            if fea.dtype in [tf.float32, tf.float64]:
