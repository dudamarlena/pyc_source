...
# [GCC 8.4.0]
# Embedded file name: /home/tom/pyenv/py3/lib/python3.5/site-packages/mautil/dataset.py
# Compiled at: 2019-06-29 08:41:30
...
class WikiText103(RegisteredDataSet):
    _download_cmds = {'wikitext-103-v1.zip': 'wget --continue https://s3.amazonaws.com/research.metamind.io/wikitext/wikitext-103-v1.zip -O {}.zip                                    && unzip -q {}.zip -d {}'}