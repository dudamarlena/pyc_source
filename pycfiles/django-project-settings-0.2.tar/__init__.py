...
# [GCC 8.4.0]
# Embedded file name: /data/PROGETTI/saxix/django-project-settings/project_settings/__init__.py
# Compiled at: 2014-10-10 13:26:59
import subprocess, datetime, os
NAME = 'django-project-settings'
VERSION = __version__ = (0, 1, 0, 'final', 0)
__author__ = 'sax'
default_app_config = 'project_settings.apps.AppConfig'
