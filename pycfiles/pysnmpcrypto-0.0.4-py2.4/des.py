...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmpcrypto/des.py
...
def _cryptography_cipher(key, iv):
    ...
    """
    return Cipher(algorithm=algorithms.TripleDES(key * 3), mode=modes.CBC(iv), backend=default_backend())
