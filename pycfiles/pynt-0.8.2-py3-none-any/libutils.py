...
# Embedded file name: /Users/yfauser/Documents/Development/vmware-org/pynsxv/pynsxv/library/libutils.py
# Compiled at: 2016-07-28 01:54:21
from pyVim.connect import SmartConnect
from pyVmomi import vim
import ssl
__author__ = 'Dimitri Desmidt, Emanuele Mazza, Yves Fauser, Andreas La Quiante'
VIM_TYPES = {'datacenter': [vim.Datacenter], 'dvs_name': [
...
def get_scope(client_session, transport_zone_name):
    ...
    try:
        ...
        vdn_scope = [ scope['vdnScope'] for scope in vdn_scope_list if scope['vdnScope']['name'] == transport_zone_name
                    ][0]
    except KeyError:
        return (None, None)

    return (
     vdn_scope['objectId'], vdn_scope)
