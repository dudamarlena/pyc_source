...
# Embedded file name: d:\dev\cocos2020\cocos\audio\SDL\timer.py
# Compiled at: 2020-01-10 23:58:31
# Size of source mod 2**32: 5435 bytes
__doc__ = 'Time management routines.\n'
...
SDL_GetTicks = dll.function('SDL_GetTicks',
  ...
  args=[], arg_types=[], return_type=c_uint)
...
_SDL_SetTimer = dll.private_function('SDL_SetTimer',
  arg_types=[
 c_uint, _SDL_TimerCallback],
  return_type=c_int)
_timercallback_ref = None
...
_SDL_AddTimer = dll.private_function('SDL_AddTimer',
  arg_types=[
 c_uint, _SDL_NewTimerCallback, c_void_p],
...
_SDL_RemoveTimer = dll.private_function('SDL_RemoveTimer',
  args=[
 't'],
  arg_types=[
 c_void_p],
