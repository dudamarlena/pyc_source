...
# Embedded file name: d:\dev\cocos2020\cocos\particle.py
# Compiled at: 2020-01-10 23:58:31
# Size of source mod 2**32: 26227 bytes
__doc__ = 'Particle system engine'
...
class ParticleSystem(CocosNode):
    ...
    def _init_shader(self):
        ...
        self.particle_size_idx = gl.glGetAttribLocation(self.sprite_shader.program, 'particle_size')
