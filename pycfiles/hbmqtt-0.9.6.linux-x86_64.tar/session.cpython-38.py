...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.8/site-packages/hbmqtt/session.py
...
class ApplicationMessage:
    ...
    __slots__ = ('packet_id', 'topic', 'qos', 'data', 'retain', 'publish_packet', 'puback_packet',
                 'pubrec_packet', 'pubrel_packet', 'pubcomp_packet')
...
class Session:
    ...
    def next_packet_id(self):
        ...
        if self._packet_id > 65535:
            ...
            while True:
                if self._packet_id in self.inflight_in or self._packet_id in self.inflight_out:
                    self._packet_id += 1
                    if self._packet_id > 65535:
