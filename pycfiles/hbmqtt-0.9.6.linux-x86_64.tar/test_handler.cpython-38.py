...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.8/site-packages/tests/mqtt/protocol/test_handler.py
# Compiled at: 2020-01-25 09:04:28
# Size of source mod 2**32: 21364 bytes
import unittest, asyncio, logging, random
...
def adapt(reader, writer):
    return (
     StreamReaderAdapter(reader), StreamWriterAdapter(writer))
