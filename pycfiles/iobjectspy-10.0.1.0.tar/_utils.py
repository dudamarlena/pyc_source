...
__all__ = [
 ...
 'get_red', 'get_green', 'get_blue', 'get_alpha', 'get_unique_name', 'color_to_tuple',
...
def oj(obj):
    if obj is None:
        return
    if hasattr(obj, '_jobject'):
        return getattr(obj, '_jobject')
    raise RuntimeError(str(obj) + ' hava no attribute _jobject.')
