...
# [GCC 8.4.0]
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_seg_models\backbones\inception_resnet_v2.py
# Compiled at: 2019-12-31 04:09:04
# Size of source mod 2**32: 16013 bytes
...
def inception_resnet_block(x, scale, block_type, block_idx, activation='relu'):
    ...
    x = Lambda((lambda inputs, scale: inputs[0] + inputs[1] * scale), output_shape=(K.int_shape(x)[1:]),
    ...
    if not weights in {None, 'imagenet'}:
        if not os.path.exists(weights):
            ...
            if include_top:
                ...
                x = inception_resnet_block(x, scale=1.0,
                  activation=None,
                  block_type='block8',
                  block_idx=10)
            ...
            if weights == 'imagenet':
                ...
                if include_top:
                    ...
                    weights_path = get_file(fname, (BASE_WEIGHT_URL + fname),
                      cache_subdir='models',
