...
# Size of source mod 2**32: 186168 bytes
...
__all__ = [
 'FieldInfo', 'Point2D', 'Point3D', 'Rectangle', 'Geometry', 'GeoPoint', 'GeoPoint3D', 'GeoLine', 'GeoRegion',
 'TextPart', 'GeoText', 'TextStyle', 'GeoStyle3D', 'Feature', 'Geometry3D', 'GeoBox', 'GeoModel3D',
 'GeoCylinder', 'GeoCircle3D', 'GeoRegion3D', 'GeoLine3D', 'Plane', 'Matrix']
...
class Rectangle:
    ...
    def is_empty--- This code section failed: ---

 L.1123         0  LOAD_FAST                'self'
                2  LOAD_ATTR                left
                4  LOAD_CONST               None
                6  COMPARE_OP               is
 ...
 L.1124        40  LOAD_CONST               True
               42  RETURN_VALUE     
             44_0  COME_FROM            38  '38'

 L.1125        44  LOAD_CONST               -1.7976931348623157e+308
               46  LOAD_FAST                'self'
               48  LOAD_ATTR                left
               50  LOAD_FAST                'self'
               52  LOAD_ATTR                right
 ...
 L.1126        68  LOAD_CONST               True
               70  RETURN_VALUE     
             72_0  COME_FROM            66  '66'

 L.1127        72  LOAD_CONST               False
               74  RETURN_VALUE     
               -1  RETURN_LAST      
...
class GeoLine(Geometry):
    ...
    def find_point_on_line_by_distance(self, distance):
        ...
        if self._jobject is None:
            raise ObjectDisposedError(type(self).__name__)
        return self._jobject.findPointOnLineByDistance(float(distance))
...
class Feature(object):
    ...
    def set_values--- This code section failed: ---

 L.4012         0  LOAD_FAST                'values'
                2  LOAD_CONST               None
                4  COMPARE_OP               is
                6  POP_JUMP_IF_FALSE    12  'to 12'

 L.4013         8  LOAD_FAST                'self'
               10  RETURN_VALUE     
             12_0  COME_FROM             6  '6'

 L.4014        12  SETUP_EXCEPT        118  'to 118'

 L.4015        14  LOAD_GLOBAL              isinstance
               16  LOAD_FAST                'values'
               18  LOAD_GLOBAL              dict
               20  CALL_FUNCTION_2       2  '2 positional arguments'
               22  POP_JUMP_IF_FALSE    60  'to 60'

 L.4016        24  SETUP_LOOP          114  'to 114'
               26  LOAD_FAST                'values'
               28  LOAD_METHOD              items
               30  CALL_METHOD_0         0  '0 positional arguments'
               32  GET_ITER         
               34  FOR_ITER             56  'to 56'
               36  UNPACK_SEQUENCE_2     2 
               38  STORE_FAST               'name'
               40  STORE_FAST               'value'

 L.4017        42  LOAD_FAST                'self'
               44  LOAD_METHOD              set_value
               46  LOAD_FAST                'name'
               48  LOAD_FAST                'value'
               ...
               56  POP_BLOCK        
               58  JUMP_FORWARD        114  'to 114'
             60_0  COME_FROM            22  '22'

 L.4018        60  LOAD_GLOBAL              isinstance
               62  LOAD_FAST                'values'
               64  LOAD_GLOBAL              list
               66  LOAD_GLOBAL              tuple
               68  BUILD_TUPLE_2         2 
               70  CALL_FUNCTION_2       2  '2 positional arguments'
               72  POP_JUMP_IF_FALSE   114  'to 114'

 L.4019        74  SETUP_LOOP          114  'to 114'
               76  LOAD_GLOBAL              range
               78  LOAD_GLOBAL              len
               80  LOAD_FAST                'self'
               82  LOAD_ATTR                field_infos
 ...
 L.4020        94  LOAD_FAST                'self'
               96  LOAD_METHOD              set_value
               98  LOAD_FAST                'i'
              100  LOAD_FAST                'values'
              102  LOAD_FAST                'i'
              104  BINARY_SUBSCR    
            ...
            114_2  COME_FROM            58  '58'
            114_3  COME_FROM_LOOP       24  '24'
              114  POP_BLOCK        
              116  JUMP_FORWARD        160  'to 160'
            118_0  COME_FROM_EXCEPT     12  '12'
 ...
 L.4021       118  DUP_TOP          
              ...
              128  STORE_FAST               'e'
              130  POP_TOP          
              132  SETUP_FINALLY       146  'to 146'

 L.4022       134  LOAD_GLOBAL              log_error
              136  LOAD_FAST                'e'
...
class GeoLine3D(Geometry3D):
    ...
    def to_json(self):
        ...
        >>> points = [Point2D(1,2,0), Point2D(2,3,0), Point2D(1,5,0), Point2D(1,2,0)]
        >>> geo = GeoLine(points)
        >>> print(geo.to_json())
...
class Plane(JVMBase):
 ...
 L.5303         0  LOAD_FAST                'points'
                2  LOAD_CONST               None
                4  COMPARE_OP               is-not
                6  POP_JUMP_IF_FALSE   142  'to 142'

 L.5304         8  LOAD_GLOBAL              isinstance
               10  LOAD_FAST                'points'
               12  LOAD_GLOBAL              list
               14  LOAD_GLOBAL              tuple
               16  BUILD_TUPLE_2         2 
               18  CALL_FUNCTION_2       2  '2 positional arguments'
               20  POP_JUMP_IF_FALSE   108  'to 108'

 L.5305        22  LOAD_GLOBAL              len
               24  LOAD_FAST                'points'
               26  CALL_FUNCTION_1       1  '1 positional argument'
               28  LOAD_CONST               3
               30  COMPARE_OP               ==
               32  POP_JUMP_IF_FALSE   140  'to 140'

 L.5306        34  LOAD_GLOBAL              Point3D
               36  LOAD_METHOD              make
               38  LOAD_FAST                'points'
               40  LOAD_CONST               0
               42  BINARY_SUBSCR    
 ...
 L.5309        76  LOAD_GLOBAL              get_jvm
               78  CALL_FUNCTION_0       0  '0 positional arguments'
               80  LOAD_ATTR                com
               82  LOAD_ATTR                supermap
               84  LOAD_ATTR                data
               86  LOAD_METHOD              Plane
               88  LOAD_FAST                'p1'
               90  LOAD_ATTR                _jobject
               92  LOAD_FAST                'p2'
               94  LOAD_ATTR                _jobject
               96  LOAD_FAST                'p3'
               98  LOAD_ATTR                _jobject
              100  CALL_METHOD_3         3  '3 positional arguments'
              102  LOAD_FAST                'self'
              104  STORE_ATTR               _java_object
              106  JUMP_ABSOLUTE       150  'to 150'
            108_0  COME_FROM            20  '20'

 L.5310       108  LOAD_GLOBAL              isinstance
              110  LOAD_FAST                'points'
              112  LOAD_GLOBAL              PlaneType
              114  CALL_FUNCTION_2       2  '2 positional arguments'
              116  POP_JUMP_IF_FALSE   150  'to 150'

 L.5311       118  LOAD_GLOBAL              get_jvm
              120  CALL_FUNCTION_0       0  '0 positional arguments'
              122  LOAD_ATTR                com
              124  LOAD_ATTR                supermap
              126  LOAD_ATTR                data
              128  LOAD_METHOD              Plane
              130  LOAD_FAST                'points'
              132  LOAD_ATTR                _jobject
              134  CALL_METHOD_1         1  '1 positional argument'
              136  LOAD_FAST                'self'
              138  STORE_ATTR               _java_object
            140_0  COME_FROM            32  '32'
              140  JUMP_FORWARD        150  'to 150'
            142_0  COME_FROM             6  '6'

 L.5313       142  LOAD_FAST                'self'
              144  LOAD_METHOD              _create_java_object
              146  CALL_METHOD_0         0  '0 positional arguments'
              148  POP_TOP          
            150_0  COME_FROM           140  '140'
            150_1  COME_FROM           116  '116'

Parse error at or near `COME_FROM' instruction at offset 150_0
