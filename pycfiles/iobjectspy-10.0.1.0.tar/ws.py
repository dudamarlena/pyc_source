...
__all__ = [
 'WorkspaceConnectionInfo', 'Workspace', 'open_datasource', 'get_datasource', 'close_datasource',
 'list_datasources', 'create_datasource', 'list_maps', 'get_map', 'remove_map', 'add_map']
...
class Workspace(JVMBase):
    ...
    def open(cls, conn_info, save_existed=True, saved_connection_info=None):
        ...
        if conn_info is None:
            ...
            if not isinstance(conn_info, WorkspaceConnectionInfo):
