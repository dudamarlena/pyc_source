...
# [GCC 8.4.0]
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\faster_rcnn\datasets\imdb.py
# Compiled at: 2019-12-31 04:09:01
# Size of source mod 2**32: 10015 bytes
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import os
import os.path as osp
import PIL, numpy as np, scipy.sparse
from model.config import cfg
from utils.cython_bbox import bbox_overlaps

class imdb(object):
    __doc__ = 'Image database.'
    ...
    def append_flipped_images(self):
        ...
        for i in range(num_images):
            ...
            entry = {'boxes':boxes,  'gt_overlaps':self.roidb[i]['gt_overlaps'], 
    ...
    def evaluate_recall(self, candidate_boxes=None, thresholds=None, area='all', limit=None):
        ...
        """
        areas = {'all':0, 
         'small':1,  'medium':2,  'large':3,  '96-128':4, 
         '128-256':5,  '256-512':6,  '512-inf':7}
        area_ranges = [[0, 10000000000.0],
         [
          0, 1024],
         [
          1024, 9216],
        ...
        if thresholds is None:
            step = 0.05
            thresholds = np.arange(0.5, 0.9500099999999999, step)
