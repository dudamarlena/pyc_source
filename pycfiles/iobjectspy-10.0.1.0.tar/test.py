...
# [GCC 8.4.0]
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\faster_rcnn\model\test.py
...
def im_detect(sess, net, im):
    ...
    if not len(im_scales) == 1:
        raise AssertionError('Only single-image batch implemented')
    else:
        im_blob = blobs['data']
...
def test_net(sess, net, imdb, eval_path, max_per_image=100, thresh=0.0):
    ...
    imdb.evaluate_detections(all_boxes, eval_path)