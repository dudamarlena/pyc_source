...
class BinaryClassification:
    ...
    def dlinknet_tensorflow_grid(self):
        if os.path.exists(os.path.join(self.out_data, self.out_dataset_name) + '.json'):
            raise ValueError('The output file already exists!')
        DlinknetEstimationTf().estimate_img((self.model_path), (self.input_data), (self.config), (self.offset),
          (self.out_data), (self.out_dataset_name),
          out_format='pixel')
