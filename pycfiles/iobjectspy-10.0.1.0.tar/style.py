...
class Color(tuple):
    ...
    def make(value):
        ...
        if isinstance(value, str):
            value = [int(item) for item in split_input_list_from_str(value)]
    ...
    def __str__(self):
        if len(self) == 4:
            return 'Color(red={}, green={}, blue={}, alpha={})'.format(self.red, self.green, self.blue, self.alpha)
...
class GeoStyle(JVMBase):
    ...
    def fill_fore_color(self):
        ...
        return java_color_to_tuple(self._jobject.getFillForeColor())
    ...
    def set_fill_fore_color(self, value):
        ...
        """
        if value:
            self._java_object.setFillForeColor(to_java_color(value))
        return self
