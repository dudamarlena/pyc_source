...
# Size of source mod 2**32: 86130 bytes
...
from ..enums import DatasetType, EngineType, PixelFormat, EncodeType, FieldType, CursorType
from .dt import *
...
class DatasourceConnectionInfo(JVMBase):
    ...
    @property
    def server--- This code section failed: ---

 L. 268         0  LOAD_FAST                'self'
                2  LOAD_ATTR                _server
                4  LOAD_CONST               None
                6  COMPARE_OP               is-not
                8  POP_JUMP_IF_FALSE    92  'to 92'

 L. 269        10  LOAD_FAST                'self'
               12  LOAD_ATTR                _type
               14  LOAD_GLOBAL              EngineType
               16  LOAD_ATTR                UDB
               18  COMPARE_OP               ==
               20  POP_JUMP_IF_TRUE     58  'to 58'
               22  LOAD_FAST                'self'
               24  LOAD_ATTR                _type
               26  LOAD_GLOBAL              EngineType
               28  LOAD_ATTR                UDBX
               30  COMPARE_OP               ==
               32  POP_JUMP_IF_TRUE     58  'to 58'

 L. 270        34  LOAD_FAST                'self'
               36  LOAD_ATTR                _type
               38  LOAD_GLOBAL              EngineType
               40  LOAD_ATTR                VECTORFILE
               42  COMPARE_OP               ==
               44  POP_JUMP_IF_TRUE     58  'to 58'
               46  LOAD_FAST                'self'
               48  LOAD_ATTR                _type
               50  LOAD_GLOBAL              EngineType
               52  LOAD_ATTR                IMAGEPLUGINS
               54  COMPARE_OP               ==
 ...
 L. 271        58  LOAD_GLOBAL              str
               60  LOAD_FAST                'self'
               62  LOAD_ATTR                _server
               ...
               74  LOAD_FAST                'self'
               76  STORE_ATTR               _server
               78  JUMP_FORWARD         92  'to 92'
             80_0  COME_FROM            56  '56'

 L. 273        80  LOAD_GLOBAL              str
               82  LOAD_FAST                'self'
               84  LOAD_ATTR                _server
               86  CALL_FUNCTION_1       1  '1 positional argument'
               88  LOAD_FAST                'self'
               90  STORE_ATTR               _server
             92_0  COME_FROM            78  '78'
             92_1  COME_FROM             8  '8'

 L. 274        92  LOAD_FAST                'self'
               94  LOAD_ATTR                _server
               96  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `JUMP_FORWARD' instruction at offset 78

    def set_server--- This code section failed: ---

 L. 298         0  LOAD_FAST                'value'
                2  LOAD_CONST               None
                4  COMPARE_OP               is-not
                6  POP_JUMP_IF_FALSE    86  'to 86'

 L. 299         8  LOAD_FAST                'self'
               10  LOAD_ATTR                _type
               12  LOAD_GLOBAL              EngineType
               14  LOAD_ATTR                UDB
               16  COMPARE_OP               ==
               18  POP_JUMP_IF_TRUE     56  'to 56'
               20  LOAD_FAST                'self'
               22  LOAD_ATTR                _type
               24  LOAD_GLOBAL              EngineType
               26  LOAD_ATTR                UDBX
               28  COMPARE_OP               ==
               30  POP_JUMP_IF_TRUE     56  'to 56'

 L. 300        32  LOAD_FAST                'self'
               34  LOAD_ATTR                _type
               36  LOAD_GLOBAL              EngineType
               38  LOAD_ATTR                VECTORFILE
               40  COMPARE_OP               ==
               42  POP_JUMP_IF_TRUE     56  'to 56'
               44  LOAD_FAST                'self'
               46  LOAD_ATTR                _type
               48  LOAD_GLOBAL              EngineType
               50  LOAD_ATTR                IMAGEPLUGINS
               52  COMPARE_OP               ==
 ...
 L. 301        56  LOAD_GLOBAL              str
               ...
               70  LOAD_FAST                'self'
               72  STORE_ATTR               _server
               74  JUMP_FORWARD         86  'to 86'
             76_0  COME_FROM            54  '54'

 L. 303        76  LOAD_GLOBAL              str
               78  LOAD_FAST                'value'
...
Parse error at or near `JUMP_FORWARD' instruction at offset 74
    ...
    def alias(self):
        ...
        if self._alias is None:
            if self.server.lower().endswith('.udb') or self.server.lower().endswith('.udbx'):
                ...
                _alias = base_name[:base_name.index('.')]
 ...
 L. 565         0  LOAD_FAST                'value'
                2  LOAD_CONST               None
                4  COMPARE_OP               is
                6  POP_JUMP_IF_FALSE    16  'to 16'

 L. 566         8  LOAD_GLOBAL              ValueError
               10  LOAD_STR                 'value is None'
               12  CALL_FUNCTION_1       1  '1 positional argument'
               14  RAISE_VARARGS_1       1  'exception instance'
             16_0  COME_FROM             6  '6'

 L. 567        16  LOAD_GLOBAL              isinstance
               18  LOAD_FAST                'value'
               20  LOAD_GLOBAL              DatasourceConnectionInfo
               22  CALL_FUNCTION_2       2  '2 positional arguments'
               24  POP_JUMP_IF_FALSE    30  'to 30'

 L. 568        26  LOAD_FAST                'value'
               28  RETURN_VALUE     
             30_0  COME_FROM            24  '24'

 L. 569        30  LOAD_GLOBAL              isinstance
               32  LOAD_FAST                'value'
               34  LOAD_GLOBAL              dict
               36  CALL_FUNCTION_2       2  '2 positional arguments'
               38  POP_JUMP_IF_FALSE    50  'to 50'

 L. 570        40  LOAD_GLOBAL              DatasourceConnectionInfo
               42  LOAD_METHOD              make_from_dict
               44  LOAD_FAST                'value'
               46  CALL_METHOD_1         1  '1 positional argument'
               48  RETURN_VALUE     
             50_0  COME_FROM            38  '38'

 L. 571        50  LOAD_GLOBAL              isinstance
               52  LOAD_FAST                'value'
               54  LOAD_GLOBAL              str
               56  CALL_FUNCTION_2       2  '2 positional arguments'
            58_60  POP_JUMP_IF_FALSE   242  'to 242'

 L. 572        62  LOAD_FAST                'value'
               64  LOAD_METHOD              lower
               66  CALL_METHOD_0         0  '0 positional arguments'
               68  STORE_FAST               'ser'

 L. 573        70  SETUP_EXCEPT        174  'to 174'

 L. 574        72  LOAD_FAST                'ser'
               74  LOAD_STR                 ':memory:'
               76  COMPARE_OP               ==
               78  POP_JUMP_IF_TRUE    110  'to 110'
               80  LOAD_FAST                'ser'
               82  LOAD_METHOD              endswith
               84  LOAD_STR                 '.udb'
               86  CALL_METHOD_1         1  '1 positional argument'
               88  POP_JUMP_IF_TRUE    110  'to 110'
               90  LOAD_FAST                'ser'
            ...
            110_2  COME_FROM            78  '78'

 L. 575       110  LOAD_GLOBAL              DatasourceConnectionInfo
              112  LOAD_FAST                'value'
              114  CALL_FUNCTION_1       1  '1 positional argument'
              116  RETURN_VALUE     
            118_0  COME_FROM           108  '108'

 L. 576       118  LOAD_FAST                'ser'
              120  LOAD_METHOD              endswith
              122  LOAD_STR                 '.dcf'
              124  CALL_METHOD_1         1  '1 positional argument'
              126  POP_JUMP_IF_FALSE   138  'to 138'

 L. 577       128  LOAD_GLOBAL              DatasourceConnectionInfo
              130  LOAD_METHOD              load_from_dcf
              132  LOAD_FAST                'value'
              134  CALL_METHOD_1         1  '1 positional argument'
              136  RETURN_VALUE     
            138_0  COME_FROM           126  '126'

 L. 579       138  LOAD_GLOBAL              DatasourceConnectionInfo
              140  LOAD_METHOD              load_from_xml
              142  LOAD_FAST                'value'
              144  CALL_METHOD_1         1  '1 positional argument'
              146  STORE_FAST               'conn'

 L. 580       148  LOAD_FAST                'conn'
              150  LOAD_CONST               None
              152  COMPARE_OP               is
              154  POP_JUMP_IF_FALSE   166  'to 166'

 L. 581       156  LOAD_GLOBAL              DatasourceConnectionInfo
              158  LOAD_METHOD              from_json
              160  LOAD_FAST                'value'
              162  CALL_METHOD_1         1  '1 positional argument'
              164  RETURN_VALUE     
            166_0  COME_FROM           154  '154'

 L. 583       166  LOAD_FAST                'conn'
              168  RETURN_VALUE     
              170  POP_BLOCK        
              172  JUMP_FORWARD        240  'to 240'
            174_0  COME_FROM_EXCEPT     70  '70'

 L. 584       174  DUP_TOP          
              176  LOAD_GLOBAL              Exception
              178  COMPARE_OP               exception-match
          180_182  POP_JUMP_IF_FALSE   238  'to 238'
              184  POP_TOP          
              186  STORE_FAST               'e'
              188  POP_TOP          
              190  SETUP_FINALLY       226  'to 226'

 L. 585       192  LOAD_GLOBAL              log_warning
              194  LOAD_FAST                'e'
              196  CALL_FUNCTION_1       1  '1 positional argument'
              198  POP_TOP          

 L. 586       200  SETUP_EXCEPT        212  'to 212'

 L. 587       202  LOAD_GLOBAL              DatasourceConnectionInfo
              204  LOAD_METHOD              from_json
              206  LOAD_FAST                'value'
              208  CALL_METHOD_1         1  '1 positional argument'
              210  RETURN_VALUE     
            212_0  COME_FROM_EXCEPT    200  '200'

 L. 588       212  POP_TOP          
              214  POP_TOP          
              216  POP_TOP          

 L. 589       218  LOAD_CONST               None
              220  RETURN_VALUE     

 L. 590       222  LOAD_CONST               None
              224  RETURN_VALUE     
            ...
            238_0  COME_FROM           180  '180'
              238  END_FINALLY      
            240_0  COME_FROM           236  '236'
            240_1  COME_FROM           172  '172'
              240  JUMP_FORWARD        246  'to 246'
            242_0  COME_FROM            58  '58'

 L. 592       242  LOAD_CONST               None
              244  RETURN_VALUE     
...
class Datasource(JVMBase):
        ...
        try:
            ...
            for i in range(jdatasets.getCount()):
                ...
                if handle in self._dict_dt.keys():
                    ...
                    temp_dt_dict[handle] = Dataset._from_java_objectjdtself
    ...
    def open(conn_info):
        ...
        """
        from .ws import Workspace
        return Workspace().open_datasourceconn_infoTrue
    ...
    def create_vector_dataset(self, name, dataset_type, adjust_name=False):
        ...
        if name is None:
            ...
            try:
                ...
                return self.create_datasetDatasetVectorInfo(name, dataset_type)adjust_name
            except Exception as e:
                try:
                    log_error(e)
                finally:
        ...
        if template is None:
            ...
            try:
                if not self.is_available_dataset_name(name):
                    if adjust_name:
                        name = self.get_available_dataset_name(name)
                java_dataset = self._jobject.getDatasets().createFromTemplatenametemplate_dt._jobject
    ...
    def get_available_dataset_name(self, name):
        ...
        if self._jobject is None:
            ...
            if self.is_available_dataset_name(name):
                return name
            try:
    ...
    def write_attr_values(self, data, out_dataset_name=None):
        ...
        if self._jobject is None:
            ...
            try:
                ...
                resultDt = self.create_datasetDatasetVectorInfo(destName, DatasetType.TABULAR)True
                if resultDt is None:
                ...
                for i in range(select_random_count):
                    row_index = random.randint0(len(data) - 1)
                ...
                rd = resultDt.get_recordsetTrueCursorType.DYNAMIC
                rd.batch_edit()
                for i in range(len(data)):
                    ...
                    try:
                        ...
                        for j in range(len(fieldInfos)):
                            rd.set_valuefieldInfos[j].namerow_values[j]
        ...
        if self._jobject is None:
            ...
            if data is None:
                ...
                if isinstance(data, Recordset):
                    return self.write_recordsetdataout_dataset_name
                if not isinstance(data, (list, tuple)):
            ...
            try:
                if out_dataset_name is None:
                    ...
                    resultDt = self.create_datasetDatasetVectorInfo(destName, datasetType)True
                    if resultDt is None:
                        log_error('Failed to create result dataset : ' + destName)
                        return
                        resultDt.open()
                                ...
                                if row_data is not None:
                                    if not isinstance(row_data, (list, tuple)):
                                        row_data = [
                                         row_data]
                                    for j in range(len(fieldInfos)):
                                        rd.set_valuefieldInfos[j].namerow_data[j]
        ...
        if self._jobject is None:
            ...
            try:
                ...
                for i in range(len(features)):
                    try:
                        rd.addfeatures[i].geometryfeatures[i].get_valuesTrueTrue
                    except Exception as e:
                        try:
                            log_warning(e)
                        finally:
    ...
    def copy_dataset(self, source, out_dataset_name=None, encode_type=None, progress=None):
        ...
        if self._jobject is None:
            ...
            destName = self.get_available_dataset_name(out_dataset_name)
            _encodType = EncodeType._makeencode_typesource_dt.encode_type
    ...
    def change_password(self, old_password, new_password):
        ...
        if self._jobject is None:
            raise ObjectDisposedError('Datasource')
        try:
            return self._jobject.changePasswordold_passwordnew_password
        except Exception as e:
            try:
                log_error(e)
                return False
    ...
    def last_date_updated(self):
        ...
        try:
            ...
            return datetime.datetime.strptime_t'%Y-%m-%d %H:%M:%S'
        except Exception as e:
            try:
                log_error(e)
                return
    ...
    def inner_point_to_dataset(self, source_dataset, out_dataset_name=None):
        ...
        if source_dataset is None:
            ...
            try:
                ...
                java_dataset = self._jobject.innerPointToDatasetdt._jobjectdest_name
                return self._add_java_dataset(java_dataset)
            except Exception as e:
                try:
                    log_error(e)
    ...
    def from_json(value):
        ...
        from .ws import Workspace
        return Workspace().open_datasourceconnInfoTrue
    ...
    def _add_java_dataset(self, java_dataset):
        ...
        dt = Dataset._from_java_objectjava_datasetself
