...
# [GCC 8.4.0]
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_seg_models\common\functions.py
...
def transpose_shape(shape, target_format, spatial_axes):
    ...
    if target_format == 'channels_first':
        ...
        return new_values
    if target_format == 'channels_last':
        return shape
...
def resize_images(x, height_factor, width_factor, data_format, interpolation='nearest'):
    ...
    if data_format == 'channels_first':
        ...
        elif original_shape[rows] is None:
            new_height = None
        else:
    ...
    output_shape = (
     None, new_height, new_width, None)
