...
# [GCC 8.4.0]
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\faster_rcnn\utils\visualization.py
...
def draw_bounding_boxes(image, gt_boxes, im_info):
    ...
    for i in range(num_boxes):
        ...
        disp_image = _draw_single_box(disp_image, (gt_boxes_new[(i, 0)]),
          (gt_boxes_new[(i, 1)]),
          (gt_boxes_new[(i, 2)]),
          (gt_boxes_new[(i, 3)]),
