...
# Size of source mod 2**32: 223315 bytes
from enum import IntEnum, unique
from ._gateway import get_jvm
from ._logger import log_error
__all__ = ['JEnum', 'PixelFormat', 'BlockSizeOption', 'AreaUnit', 'Unit', 'EngineType', 'DatasetType', 'FieldType',
 'GeometryType', 'WorkspaceType', 'WorkspaceVersion', 'EncodeType', 'CursorType', 'Charset',
 'OverlayMode', 'SpatialIndexType', 'DissolveType', 'TextAlignment',
 'StringAlignment', 'ColorGradientType',
 'SpatialQueryMode', 'StatisticsType', 'JoinType', 'BufferEndType', 'BufferRadiusUnit',
 'StatisticMode', 'PrjCoordSysType', 'ImportMode', 'IgnoreMode', 'MultiBandImportMode',
 'CADVersion', 'TopologyRule', 'GeoSpatialRefType', 'GeoCoordSysType', 'ProjectionType',
 'GeoPrimeMeridianType', 'GeoSpheroidType', 'GeoDatumType', 'CoordSysTransMethod', 'StatisticsFieldType',
 'VectorResampleType', 'ArcAndVertexFilterMode', 'RasterResampleMode', 'ResamplingMethod',
 'AggregationType', 'ReclassPixelFormat', 'ReclassSegmentType', 'ReclassType', 'NeighbourShapeType',
 'SearchMode', 'Exponent', 'VariogramMode', 'ComputeType', 'SmoothMethod', 'ShadowMode', 'SlopeType',
 'NeighbourUnitType', 'InterpolationAlgorithmType', 'GriddingLevel', 'RegionToPointMode',
 'LineToPointMode', 'EllipseSize', 'SpatialStatisticsType', 'DistanceMethod', 'KernelFunction', 'KernelType',
 'BandWidthType', 'AggregationMethod', 'StreamOrderType', 'TerrainInterpolateType',
 'TerrainStatisticType', 'EdgeMatchMode', 'FunctionType', 'StatisticsCompareType', 'GridStatisticsMode',
 'ConceptualizationModel', 'AttributeStatisticsMode', 'VCTVersion', 'RasterJoinPixelFormat', 'RasterJoinType',
 'PlaneType', 'ChamferStyle', 'Buffer3DJoinType', 'ViewShedType', 'ImageType', 'FillGradientMode',
 'ColorSpaceType', 'ImageInterpolationMode', 'ImageDisplayMode', 'MapColorMode', 'LayerGridAggregationType']

def _to_java_enum_type(value, java_class_full_name):
    jvm = get_jvm()
    if java_class_full_name is not None:
        try:
            ...
            raise ValueError('invalid class type' + value._get_java_class_type())
...
class JEnum(IntEnum):
    ...
    @property
    def _jobject(self):
        return _to_java_enum_type(self.value, self._get_java_class_type())
