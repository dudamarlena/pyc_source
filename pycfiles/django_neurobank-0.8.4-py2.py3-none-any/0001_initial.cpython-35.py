...
class Migration(migrations.Migration):
    ...
    operations = [
     HStoreExtension(),
     migrations.CreateModel(name='DataType', fields=[
      (
     ...
     migrations.AddField(model_name='location', name='resource', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='neurobank.Resource')),
