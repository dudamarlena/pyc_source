...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/football/migrations/0002_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'football.team': {'Meta': {'ordering': "('title',)", 'object_name': 'Team', '_ormbases': ['jmbo.ModelBase']}, 'football365_teamcode': (
