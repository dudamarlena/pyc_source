...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/football/migrations/0003_auto__add_field_team_abbreviated_title.py
# Compiled at: 2013-01-16 06:49:52
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('football_team', 'abbreviated_title', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('football_team', 'abbreviated_title')
    ...
    models = {'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'football.fixture': {'Meta': {'object_name': 'Fixture'}, 'away_score': (
                                         'django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                            'away_team': (
                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'away_team'", 'to': "orm['football.Team']"}), 
                            'completed': (
                                        'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                            'datetime': (
                                       'django.db.models.fields.DateTimeField', [], {}), 
                            'group': (
                                    'django.db.models.fields.related.ForeignKey', [], {'to': "orm['football.LeagueGroup']", 'null': 'True', 'blank': 'True'}), 
                            'home_score': (
                                         'django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                            'home_team': (
                                        'django.db.models.fields.related.ForeignKey', [], {'related_name': "'home_team'", 'to': "orm['football.Team']"}), 
                            'id': (
                                 'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                            'league': (
                                     'django.db.models.fields.related.ForeignKey', [], {'to': "orm['football.League']"})}, 
       'football.league': {'Meta': {'ordering': "('-created',)", 'object_name': 'League', '_ormbases': ['jmbo.ModelBase']}, 'football365_ci': (
                                            'django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                           'football365_di': (
                                            'django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                           'groups': (
                                    'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['football.LeagueGroup']", 'null': 'True', 'blank': 'True'}), 
                           'modelbase_ptr': (
       ...
       'football.leaguegroup': {'Meta': {'object_name': 'LeagueGroup'}, 'football365_ci': (
                                                 'django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                                'football365_di': (
                                                 'django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                                'id': (
       ...
       'football.logentry': {'Meta': {'unique_together': "(('league', 'team'),)", 'object_name': 'LogEntry'}, 'drawn': (
                             ...
                             'points': (
                                      'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                             'team': (
                                    'django.db.models.fields.related.ForeignKey', [], {'to': "orm['football.Team']"}), 
                             'won': (
                                   'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'football.player': {'Meta': {'ordering': "('-created',)", 'object_name': 'Player', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                           'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}), 
                           'teams': (
                                   'django.db.models.fields.related.ManyToManyField', [], {'to': "orm['football.Team']", 'symmetrical': 'False'})}, 
       'football.team': {'Meta': {'ordering': "('title',)", 'object_name': 'Team', '_ormbases': ['jmbo.ModelBase']}, 'abbreviated_title': (
                                             'django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}), 
                         'football365_teamcode': (
                                                'django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'null': 'True', 'blank': 'True'}), 
                         'history': (
                                   'ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}), 
                         'info': (
                                'ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}), 
                         'leagues': (
                                   'django.db.models.fields.related.ManyToManyField', [], {'to': "orm['football.League']", 'symmetrical': 'False'}), 
                         'modelbase_ptr': (
                                         'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}), 
                         'statistics': (
                                      'ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'})}, 
       'football.trivia': {'Meta': {'ordering': "('-created',)", 'object_name': 'Trivia', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                           'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
