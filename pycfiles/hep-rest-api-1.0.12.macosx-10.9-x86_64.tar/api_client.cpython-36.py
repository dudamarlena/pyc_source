...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/api_client.py
# Compiled at: 2019-07-15 09:20:14
# Size of source mod 2**32: 24968 bytes
"""
    HEP REST API
...
import hep_rest_api.models
from hep_rest_api import rest
...
class ApiClient(object):
            ...
            if type(klass) == str:
                if klass.startswith('list['):
                    ...
                    if klass in self.NATIVE_TYPES_MAPPING:
                        ...
                        klass = getattr(hep_rest_api.models, klass)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not klass.swagger_types:
            if not self._ApiClient__hasattr(klass, 'get_real_child_model'):
                return data
            else:
                kwargs = {}
            ...
            if self._ApiClient__hasattr(instance, 'get_real_child_model'):
