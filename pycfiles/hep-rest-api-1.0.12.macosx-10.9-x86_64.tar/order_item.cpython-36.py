...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/models/order_item.py
...
class OrderItem(object):
    ...
    swagger_types = {'order_item_number':'str', 
     'ordered_item':'Thing', 
     'order_item_quantity':'int', 
     'price_currency':'str', 
     'price':'str'}
    attribute_map = {'order_item_number':'order_item_number', 
     'ordered_item':'ordered_item', 
     'order_item_quantity':'order_item_quantity', 
     'price_currency':'price_currency', 
     'price':'price'}

    def __init__(self, order_item_number=None, ordered_item=None, order_item_quantity=None, price_currency=None, price=None):
    ...
    def order_item_number(self, order_item_number):
        ...
        if order_item_number is None:
            ...
            if order_item_number is not None:
                if len(order_item_number) > 64:
                    raise ValueError('Invalid value for `order_item_number`, length must be less than or equal to `64`')
            if order_item_number is not None:
                if len(order_item_number) < 1:
                    raise ValueError('Invalid value for `order_item_number`, length must be greater than or equal to `1`')
    ...
    def ordered_item(self, ordered_item):
        ...
        if ordered_item is None:
            raise ValueError('Invalid value for `ordered_item`, must not be `None`')
    ...
    def price(self, price):
        ...
        if price is None:
            ...
            if price is not None:
                if len(price) > 64:
                    raise ValueError('Invalid value for `price`, length must be less than or equal to `64`')
            if price is not None:
                if len(price) < 1:
