...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/test/test_basic.py
# Compiled at: 2019-07-18 03:06:23
# Size of source mod 2**32: 7890 bytes
import sys, uuid, os, datetime
...
config_test = {'app_id':'3c7339a19b474e929683728d94be470d', 
 ...
 'chain_id':1007}
config_dev = {'app_id':'4a5557f3d7d9485591237f85f6c9a0f6', 
...
base_parameters = {'dapp_key':config['app_key'], 
...
def test_dapp_daily_stats():
    ...
    time = ''
    api_client = _get_api_client()
    res = api_client.rest_dapps_read_0('1', 'b8774f668c144aa78db2cd1b925284b2', '20190711', config['app_key'], 'HEP', '1.0', int(datetime.datetime.now().timestamp()), 'nonce', 'web', 'en', 'HMAC-MD5', 'signature')
    print(res)
