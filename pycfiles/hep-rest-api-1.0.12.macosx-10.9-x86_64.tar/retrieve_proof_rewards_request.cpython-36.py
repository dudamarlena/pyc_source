...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/models/retrieve_proof_rewards_request.py
# Compiled at: 2019-07-15 09:20:14
# Size of source mod 2**32: 14734 bytes
"""
    HEP REST API
...
class RetrieveProofRewardsRequest(object):
    ...
    def __init__(self, dapp_key=None, protocol=None, version=None, ts=None, nonce=None, os=None, language=None, dapp_signature_method=None, dapp_signature=None, proof_data=None):
        """RetrieveProofRewardsRequest - a model defined in Swagger"""
        self._dapp_key = None
        self._protocol = None
        self._version = None
        self._ts = None
    ...
    def proof_data(self, proof_data):
        ...
        if proof_data is None:
            raise ValueError('Invalid value for `proof_data`, must not be `None`')
