...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/scenarios/auth.py
# Compiled at: 2019-07-18 03:04:01
...
class AuthHelper(BaseHelper):
    ...
    def generate_auth_request(self, scope=1, expired=300, memo='', uuid=None):
        ...
        if not memo:
            memo = 'default'
        data = {'action':self.action_auth_login,  'scope':scope, 
    ...
    def get_client_login_params(self, uuid, memo=None, scope=2):
        ...
        if not memo:
            memo = 'default'
        login_params = {'action':self.action_auth_login,  'scope':2, 
         'memo':memo, 
         'uuid':uuid}
