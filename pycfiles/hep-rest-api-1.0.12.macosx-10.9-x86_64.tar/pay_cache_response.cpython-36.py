...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/models/pay_cache_response.py
# Compiled at: 2019-07-15 09:20:14
# Size of source mod 2**32: 29062 bytes
"""
    HEP REST API
...
class PayCacheResponse(object):
        ...
        if description is None:
            ...
            if description is not None:
                if len(description) > 64:
                    raise ValueError('Invalid value for `description`, length must be less than or equal to `64`')
            if description is not None:
    ...
    def price_currency(self, price_currency):
        ...
        if price_currency is None:
            raise ValueError('Invalid value for `price_currency`, must not be `None`')
        else:
            if price_currency is not None:
                if len(price_currency) > 64:
                    raise ValueError('Invalid value for `price_currency`, length must be less than or equal to `64`')
            if price_currency is not None:
                if len(price_currency) < 1:
                    raise ValueError('Invalid value for `price_currency`, length must be greater than or equal to `1`')
    ...
    def total_price(self, total_price):
        ...
        if total_price is None:
            ...
            if total_price is not None:
                if len(total_price) > 64:
                    raise ValueError('Invalid value for `total_price`, length must be less than or equal to `64`')
            if total_price is not None:
                if len(total_price) < 1:
                    raise ValueError('Invalid value for `total_price`, length must be greater than or equal to `1`')
        ...
        if order_number is None:
            ...
            if order_number is not None:
                if len(order_number) > 64:
                    raise ValueError('Invalid value for `order_number`, length must be less than or equal to `64`')
            if order_number is not None:
    ...
    def seller(self, seller):
        ...
        if seller is None:
            ...
            if seller is not None:
                if len(seller) > 64:
                    raise ValueError('Invalid value for `seller`, length must be less than or equal to `64`')
            if seller is not None:
                if len(seller) < 1:
                    raise ValueError('Invalid value for `seller`, length must be greater than or equal to `1`')
        self._seller = seller
    ...
    def customer(self, customer):
        ...
        if customer is None:
            ...
            if customer is not None:
                if len(customer) > 64:
                    raise ValueError('Invalid value for `customer`, length must be less than or equal to `64`')
            if customer is not None:
                if len(customer) < 1:
                    raise ValueError('Invalid value for `customer`, length must be greater than or equal to `1`')
    ...
    def broker(self, broker):
        ...
        if broker is not None:
            if len(broker) > 64:
                raise ValueError('Invalid value for `broker`, length must be less than or equal to `64`')
        if broker is not None:
            if len(broker) < 1:
                raise ValueError('Invalid value for `broker`, length must be greater than or equal to `1`')
        self._broker = broker
