...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/models/order.py
# Compiled at: 2019-07-15 09:20:14
# Size of source mod 2**32: 12554 bytes
"""
    HEP REST API
...
class Order(object):
    ...
    def __init__(self, description=None, price_currency=None, total_price=None, order_number=None, seller=None, customer=None, broker=None, order_items=None, chain_txid=None):
    ...
    def chain_txid(self, chain_txid):
        ...
        """
        if chain_txid is not None:
            if len(chain_txid) > 256:
                raise ValueError('Invalid value for `chain_txid`, length must be less than or equal to `256`')
