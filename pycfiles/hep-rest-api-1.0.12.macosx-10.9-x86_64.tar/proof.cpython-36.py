...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/scenarios/proof.py
# Compiled at: 2019-07-18 03:02:51
...
class Order(object):
    __doc__ = 'docstring for Order'

    def __init__(self, order_number, description, total_price, price_currency, seller, customer, broker='', chain_txid=''):
    ...
    def add_order_item(self, order_item_number, order_item_quantity, price, price_currency, thing_name, thing_id, thing_type='product'):
        self.order_items.append({'order_item_number':order_item_number, 
         'order_item_quantity':order_item_quantity, 
         'price':price, 
         'price_currency':price_currency, 
         'ordered_item':{'name':thing_name, 
          'thing_id':thing_id, 
...
class OrderProof(object):
    ...
    def __init__(self, total_price, price_currency, submitter, proof_type='order'):
        self.price_currency = price_currency
        self.total_price = total_price
    ...
    def to_dict(self):
        return {'price_currency':self.price_currency, 
         'total_price':self.total_price, 
...
class ProofHelper(BaseHelper):
    ...
    def generate_proof_request(self, content, uuid=None):
        ...
        if not content:
            raise AttributeError('content can not be None')
        data = {'action':self.action_auth_proof, 
         'uuid':uuid, 
         'content':content, 
    ...
    def get_status_of_proofs(self, proof_hashes):
        ...
        """
        params = {'proof_hashes': proof_hashes}
