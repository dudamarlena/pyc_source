...
# [GCC 8.4.0]
# Embedded file name: /Users/erhu/project/gitrepo/hep-sdk/venv/lib/python3.6/site-packages/hep_rest_api/models/newchain_transaction_response.py
...
class NewchainTransactionResponse(object):
    ...
    def __init__(self, txid=None, order_number=None, from_address=None, to_address=None, value=None, block_height=None, status=None):
        """NewchainTransactionResponse - a model defined in Swagger"""
        self._txid = None
    ...
    def txid(self, txid):
        ...
        if txid is None:
            ...
            if txid is not None:
                if len(txid) > 256:
                    raise ValueError('Invalid value for `txid`, length must be less than or equal to `256`')
            if txid is not None:
                if len(txid) < 1:
                    raise ValueError('Invalid value for `txid`, length must be greater than or equal to `1`')
        self._txid = txid
        ...
        if from_address is None:
            ...
            if from_address is not None:
                if len(from_address) > 64:
                    raise ValueError('Invalid value for `from_address`, length must be less than or equal to `64`')
            if from_address is not None:
        ...
        if to_address is None:
            ...
            if to_address is not None:
                if len(to_address) > 64:
                    raise ValueError('Invalid value for `to_address`, length must be less than or equal to `64`')
            if to_address is not None:
                if len(to_address) < 1:
                    raise ValueError('Invalid value for `to_address`, length must be greater than or equal to `1`')
    ...
    def value(self, value):
        ...
        if value is None:
            ...
            if value is not None:
                if len(value) > 64:
                    raise ValueError('Invalid value for `value`, length must be less than or equal to `64`')
            if value is not None:
                if len(value) < 1:
