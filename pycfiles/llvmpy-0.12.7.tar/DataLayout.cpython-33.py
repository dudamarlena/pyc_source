...
# [GCC 8.4.0]
# Embedded file name: ./src/DataLayout.py
...
class DataLayout:
    ...
    getPointerABIAlignment = Method(cast(Unsigned, int), cast(int, Unsigned)).require_only(0)
    getPointerPrefAlignment = Method(cast(Unsigned, int), cast(int, Unsigned)).require_only(0)
    getPointerSize = Method(cast(Unsigned, int), cast(int, Unsigned)).require_only(0)
    getPointerSizeInBits = Method(cast(Unsigned, int), cast(int, Unsigned)).require_only(0)
    ...
    _getIntPtrType = Method(ptr(IntegerType), ref(LLVMContext), cast(int, Unsigned))
    ...
    _getIndexedOffset = Method(cast(Uint64, int), ptr(Type), ref(SmallVector_Value))
