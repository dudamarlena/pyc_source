...
# [GCC 8.4.0]
# Embedded file name: ./src/Function.py
# Compiled at: 2014-08-01 13:34:49
# Size of source mod 2**32: 2690 bytes
from binding import *
...
class Function:
    ...
    Create = StaticMethod(ptr(Function), ptr(FunctionType), GlobalValue.LinkageTypes, cast(str, ConstCharPtr), ptr(Module)).require_only(2)
