...
# [GCC 8.4.0]
# Embedded file name: /home/michael/anaconda2/lib/python2.7/site-packages/superplot/super_command.py
...
import superplot.plotlib.plots as plots, superplot.data_loader as data_loader
...
def __main__():
    ...
    parser.add_argument('--plot_description', help='Type of plot', choices=PLOT_CLASS.keys(), type=str, default=None, required=False)
    parser.add_argument('--info_file', help='*.info file labelling *.txt file', type=str, default=None, required=False)
    parser.add_argument('--output_file', help='Name of output file for plot', type=str, default=None, required=False)
    parser.add_argument('--line_file', help='Add a data to be plotted as a line', type=str, default=None, required=False)
    parser.add_argument('--line_label', help='Label of line added to plot for legend', type=str, default=None, required=False)
    for attr in ATTRIBUTES:
        ...
        parser.add_argument(('--{}').format(attr), required=required, default=default_, type=guess_type, help='Superplot plot_option named tuple option')
    ...
    options = plot_options(**plot_args)
...
def save_plot(txt_file, info_file, output_file, plot_description, options, line_file, line_label):
    ...
    if line_file:
        ...
        plt.legend(prop={'size': 16}, title=options.leg_title, loc=options.leg_position)
