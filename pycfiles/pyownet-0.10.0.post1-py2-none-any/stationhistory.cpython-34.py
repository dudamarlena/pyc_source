...
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/weatherapi25/stationhistory.py
# Compiled at: 2018-12-21 14:52:45
# Size of source mod 2**32: 6336 bytes
...
class StationHistory(object):
    ...
    def to_JSON(self):
        ...
        """
        return json.dumps({'station_ID': self._station_ID,  'interval': self._interval, 
    ...
    def to_XML(self, xml_declaration=True, xmlns=True):
        ...
        if xmlns:
            xmlutils.annotate_with_XMLNS(root_node, STATION_HISTORY_XMLNS_PREFIX, STATION_HISTORY_XMLNS_URL)
    ...
    def _to_DOM(self):
        ...
        for m in self._measurements:
            ...
            d['reference_time'] = m
            xmlutils.create_DOM_node_from_dict(d, 'measurement', measurements_node)
