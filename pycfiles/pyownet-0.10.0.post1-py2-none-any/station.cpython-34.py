...
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/weatherapi25/station.py
...
from pyowm.weatherapi25.xsd.xmlnsconfig import LIST_STATION_XMLNS_PREFIX, LIST_STATION_XMLNS_URL
...
class Station(object):
    ...
    @deprecated(will_be='removed', on_version=(3, 0, 0), name='weatherapi25.station.Station')
    def __init__(self, name, station_ID, station_type, status, lat, lon, distance=None, last_weather=None):
    ...
    def to_JSON(self):
        ...
        return json.dumps({'name': self._name,  'station_ID': self._station_ID, 
    ...
    def to_XML(self, xml_declaration=True, xmlns=True):
        ...
        if xmlns:
            xmlutils.annotate_with_XMLNS(root_node, LIST_STATION_XMLNS_PREFIX, LIST_STATION_XMLNS_URL)
    ...
    def _to_DOM(self):
        ...
        """
        last_weather = None
        if self._last_weather and isinstance(self._last_weather, weather.Weather):
