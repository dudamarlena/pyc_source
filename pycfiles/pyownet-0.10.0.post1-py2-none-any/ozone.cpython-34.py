...
# Embedded file name: build/bdist.linux-x86_64/egg/pyowm/pollutionapi30/ozone.py
...
class Ozone(object):
    ...
    def to_XML(self, xml_declaration=True, xmlns=True):
        ...
        if xmlns:
            xmlutils.annotate_with_XMLNS(root_node, OZONE_XMLNS_PREFIX, OZONE_XMLNS_URL)
    ...
    def __repr__(self):
        return '<%s.%s - reference time=%s, reception time=%s, location=%s, interval=%s, value=%s>' % (
         __name__,
