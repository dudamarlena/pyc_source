...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/gerald/tests/test_postgres_schema.py
...
class TestSchemaAddTable(object):
    ...
    def test_new_table(self):
        ...
        new_table.columns['col1'] = {'sequence': 1, 'name': 'col1', 'type': 'VARCHAR', 
...
class TestNewTableParent(object):
    ...
    def setup_class(self):
        ...
        self.column = {'sequence': 1, 'name': self.column_name, 'type': 'VARCHAR', 'length': 20, 
           'nullable': False}
...
class TestTableFromDbAttributes(TableFromDbParent):
    ...
    def test_additional_columns(self):
        ...
        for column in ('varchar_col VARCHAR(255)', 'char_col CHAR(255)', 'integer_col INTEGER',
                       'date_col DATE', 'numeric_col NUMERIC(38,3)'):
            yield (
