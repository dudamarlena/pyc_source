...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\segmentation_module\segmentation_api\API_deprecated.py
# Compiled at: 2019-04-03 08:01:23
# Size of source mod 2**32: 12649 bytes
"""
...
class API(object):
    __slots__ = ('predictor', 'config_manager', 'logger')
    ...
    def predict_and_visualize_image(self, config_path, orig_image_path):
        ...
        return (
         pred_result, vis_result, pred_blob)
