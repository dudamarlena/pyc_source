...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\segmentation_module\segmentation_tools\eval_tools.py
# Compiled at: 2019-04-03 08:22:31
# Size of source mod 2**32: 3704 bytes
import glob, itertools, json, os, numpy as np, pandas as pd, PIL.Image as Image
...
def check_for_missing_class2d(img, n_classes):
    ...
    img = np.pad(img, ((left_pad, right_pad), (up_pad, bottom_pad)), 'constant', constant_values=(0,
                                                                                                  0))
    return img
