...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\segmentation_module\segmentation_api\API.py
# Compiled at: 2019-04-03 08:24:33
...
from segmentation_module.segmentation_tools.utils2 import make_folder_to_model, prepare_to_train
...
class API(object):
    __slots__ = ('predictor', 'config_manager', 'logger', 'model_path')

    def __init__(self):
        self.predictor = None
        self.config_manager = ConfigCEO()
        self.logger = Logger('temp\\segmentation_logger.log')
    ...
    def predict(self, config_path, images_path, output_folder, only_to_memory=False, with_blobs=False):
        ...
        resolution = (
         config_dict['parameters']['input_width'],
