...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/doapfiend_vcs.py
# Compiled at: 2008-06-06 15:26:24
"""
...
class VCSPlugin(Plugin):
    ...
    def add_options(self, parser, output, search):
        ...
        output.add_option('--%s' % self.name, action='store', dest=self.enable_opt, metavar='VCS_CMD', help='Run VCS command if repository is found.')
