...
# [GCC 8.4.0]
# Embedded file name: /Users/ali/ownCloud/Project/python/django-aparnik-framework-project/testandbuildprojectframework/aparnik/settings.py
# Compiled at: 2019-06-08 04:07:58
# Size of source mod 2**32: 2213 bytes
from django.conf import settings
from rest_framework.settings import APISettings
USER_SETTINGS = getattr(settings, 'APARNIK', None)
DEFAULTS = {'API_PRODUCT_MODE':False, 
 'AWS_ACTIVE':True, 
 'BANK_ACTIVE':True, 
 ...
 'IS_FCM':True}
IMPORT_STRINGS = ('AWS_ACTIVE', 'BANK_ACTIVE', 'USER_LOGIN_WITH_PASSWORD', 'USER_CREATE_SERIALIZER',
                  'USER_UPDATE_SERIALIZER', 'USER_DETAIL_SERIALIZER', 'USER_SUMMARY_LIST_SERIALIZER',
                  'USER_LOGIN_API_VIEW', 'USER_LIST_API_VIEW', 'USER_DETAIL_API_VIEW',
                  'USER_CREATE_API_VIEW', 'USER_UPDATE_API_VIEW', 'USER_INVITATION_CODE_INT',
                  'USER_IS_SHOW_ADMIN_PANEL', 'USER_REGISTER_WITH_LOGIN', 'API_PRODUCT_MODE',
                  'SEND_SMS', 'VERIFY_FAKE', 'IS_FCM')
