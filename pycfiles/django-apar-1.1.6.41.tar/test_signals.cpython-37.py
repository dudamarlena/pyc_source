...
# [GCC 8.4.0]
# Embedded file name: /Users/ali/ownCloud/Project/python/django-aparnik-framework-project/testandbuildprojectframework/aparnik/contrib/messaging/tests/test_signals.py
# Compiled at: 2019-12-27 03:51:50
...
class NotificationSignalTestCase(TestCase):
    ...
    def test_user_can_read_notifications(self):
        ...
        notification = Messaging.objects.create(source=(self.user2),
          ...
          url='http://example.com',
          is_read=False)
        read.send(sender=(self.__class__),
          notify_id=(notification.id),
          recipient=(self.user1))
    ...
    def test_silent_notification(self):
        ...
        notify.send(sender=(self.__class__),
          source=(self.user2),
          source_display_name='User 2',
          recipient=(self.user1),
          action='Notified',
