...
# [GCC 8.4.0]
# Embedded file name: /Volumes/Work/dev/cadasta/django-tutelary/tutelary/wildtree.py
# Compiled at: 2017-12-04 06:48:57
# Size of source mod 2**32: 6298 bytes
...
def dominates(p, q):
    ...
    *n* == *m* and, for all *i*, *pi* >= *qi*.
    ...
    """
    return len(p) == len(q) and all(map(lambda es: es[0] == es[1] or es[0] == '*', zip(p, q)))