...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\mapy\reader\cardtranslator.py
# Compiled at: 2017-04-20 23:24:18
# Size of source mod 2**32: 9656 bytes
import mapy
from mapy.model.grids import Grid
from mapy.model.materials.matiso import MatIso
from mapy.model.materials.matlamina import MatLamina
from mapy.model.properties.prop1d import PropRod
from mapy.model.elements.elemrod import ElemRod
from mapy.model.properties.prop1d import PropBar
from mapy.model.elements.elembar import ElemBar
from mapy.model.loads import Load
from mapy.model.properties.prop2d import PropShell
from mapy.model.elements.elemtria.elemtria3 import ElemTria3
from mapy.model.elements.elemquad4 import ElemQuad4
from mapy.model.loads import Force
from mapy.model.loads import Moment
from mapy.model.constraints import SPC
...
def translator(solvername):
    ...
    if solvername.lower() == 'nastran':
        cards = {'CORD1R': ['card', 'cida', 'g1a', 'g2a', 'g3a', 'cidb', 'g1b', 'g2b', 'g3b'], 
        ...
        trans_out = {'CORD1R': {'entryclass': mapy.model.coords.CoordR, 'card': 'card', 
