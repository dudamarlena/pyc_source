...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/atelParser/cl_utils.py
...
def main(arguments=None):
    ...
    *The main function used when `cl_utils.py` is run as a single script from the cl, or when installed as a cl command*
    """
    su = tools(arguments=arguments, docString=__doc__, logLevel='WARNING', options_first=False, projectName='atelParser', defaultSettingsFile=True)
