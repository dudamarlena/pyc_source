...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nn_wtf/mnist_data_sets.py
...
from nn_wtf.input_data import maybe_download, images_from_bytestream, read_one_image_from_file, read_one_image_from_url, read_images_from_file, read_images_from_url, read_images_from_files, read_images_from_urls
import numpy, gzip
...
class MNISTDataSets(DataSets):
    ...
    def __init__(self, train_dir, one_hot=False):
        ...
        super().__init__(ImagesLabelsDataSet(train_images, train_labels), ImagesLabelsDataSet(validation_images, validation_labels), ImagesLabelsDataSet(test_images, test_labels))
