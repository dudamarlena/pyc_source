...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nn_wtf/mnist_graph.py
...
class MNISTGraph(NeuralNetworkGraph, SaverMixin, SummaryWriterMixin):
    ...
    def __init__(self, input_size=None, layer_sizes=(128, 32, None), output_size=None):
        ...
        """
        NeuralNetworkGraph.__init__(self, self.IMAGE_PIXELS, layer_sizes, self.NUM_CLASSES)
    ...
    def train(self, data_sets, max_steps, precision=None, steps_between_checks=100, run_as_check=None, batch_size=1000):
        ...
        super().train(data_sets, max_steps, precision, steps_between_checks, run_as_check=self.write_summary, batch_size=batch_size)
