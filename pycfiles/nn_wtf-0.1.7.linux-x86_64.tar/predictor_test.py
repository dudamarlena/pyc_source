...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nn_wtf/tests/predictor_test.py
...
from nn_wtf.tests.util import create_train_data_set, train_data_input, create_vector, allow_fail, train_neural_network
import unittest
...
class PredictorTest(unittest.TestCase):
    ...
    def _check_multiple_values_get_predicted(self, graph, train_data):
        predictions = graph.get_predictor().predict_multiple(generate_train_data(train_data), len(train_data))
