...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nn_wtf/neural_network_graph_base.py
...
class NeuralNetworkGraphBase:
    ...
    def fill_feed_dict(self, data_set, batch_size):
        ...
        feed_dict = {self.input_placeholder: input_feed, 
