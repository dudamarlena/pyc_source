...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/nn_wtf/tests/images_labels_data_set_test.py
...
def create_random_image_data(min_val, max_val):
    ...
    return image_data_from_list([ randrange(min_val, max_val + 1) for _ in range(NUM_TRAINING_SAMPLES * IMAGE_WIDTH * IMAGE_HEIGHT) ])
