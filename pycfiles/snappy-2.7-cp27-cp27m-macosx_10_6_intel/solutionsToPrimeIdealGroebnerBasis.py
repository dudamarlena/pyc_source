...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/ptolemy/solutionsToPrimeIdealGroebnerBasis.py
...
def _number_field_and_ext_assignment_to_pari(number_field, ext_assignment):
    ...
    return (
     pari_number_field, pari_ext_assignment)
