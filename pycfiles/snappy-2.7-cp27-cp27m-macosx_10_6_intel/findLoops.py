...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/ptolemy/findLoops.py
...
class Vertex(tuple):
    ...
    def edges_starting_at_vertex(self):
        ...
        """
        return [
         ShortEdge(self), MiddleEdge(self), LongEdge(self)]
...
def _compute_origin(choose_generators_info):
    ...
    the dual 1-skeleton.
    """
    tet = [ info['index'] for info in choose_generators_info if info.get('generator_path', -1) == -1
          ][0]
