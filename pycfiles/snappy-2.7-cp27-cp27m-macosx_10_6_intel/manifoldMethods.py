...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/ptolemy/manifoldMethods.py
...
def get_generalized_ptolemy_obstruction_classes(manifold, N):
    ...
    for H2_element in H2_elements:
        if tuple(H2_element) not in already_seen:
...
def get_obstruction_classes(manifold, N):
    ...
    return (
     homology.homology_representatives(cochain_d2, cochain_d1, N),
     explain_columns)
...
def get_ptolemy_variety(manifold, N, obstruction_class=None, simplify=True, eliminate_fixed_ptolemys=False):
    ...
    if obstruction_class is None or isinstance(obstruction_class, PtolemyObstructionClass) or isinstance(obstruction_class, PtolemyGeneralizedObstructionClass):
        ...
        if obstruction_class == 'all_original':
            ...
            if obstruction_class == 'all_generalized':
