...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/ptolemy/geometricRep.py
# Compiled at: 2017-05-26 08:27:22


def compute_geometric_solution(M, N=2, numerical=False, engine=None, memory_limit=750000000, directory=None, prefer_rur=False, data_url=False, verbose=None):
    """
    ...
    if engine == 'retrieve':
        sols = varieties.retrieve_solutions(numerical=numerical, prefer_rur=prefer_rur, data_url=data_url, verbose=verbose)
    else:
        sols = varieties.compute_solutions(engine=engine, numerical=numerical, memory_limit=memory_limit, directory=directory, verbose=verbose)
