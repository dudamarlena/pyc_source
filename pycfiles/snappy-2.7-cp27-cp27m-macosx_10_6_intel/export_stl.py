...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/export_stl.py
...
def klein_cutout_stl(face_dicts, shrink_factor=0.9):
    ...
    for face in face_dicts:
        ...
        for i in range(len(new_vertices)):
            yield (
             new_vertices[i], new_inside_points[((i + 1) % len(new_vertices))], new_inside_points[i])
