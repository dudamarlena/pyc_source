...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/db_utilities.py
# Compiled at: 2017-05-26 08:27:21
...
def cover_hash(mfld, degrees):
    return [ repr(sorted([ (cover_type(C), C.homology()) for C in mfld.covers(degree) ])) for degree in degrees
           ]
