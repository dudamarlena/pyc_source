...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/snap/t3mlite/spun.py
...
def quad_vector_to_type_and_coeffs(quad_vector):
    ...
    return (
     quad_types, Vector(coefficients))
    ...
    def vertex_solutions(self, algorithm='FXrays'):
        ...
        if algorithm == 'regina':
            ...
            for i in range(surfaces.getNumberOfSurfaces()):
                ...
                coeff_vector = [ int(S.getQuadCoord(tet, quad).stringValue()) for tet in tets for quad in (1,
                                                                                                           2,
                                                                                                           0)
                               ]
