...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/snap/kernel_structures.py
...
class TransferKernelStructuresEngine(McomplexEngine):
    ...
    def add_shapes(self, shapes):
        ...
        for tet, z in zip(self.mcomplex.Tetrahedra, shapes):
            zp = 1 / (1 - z)
            zpp = (z - 1) / z
            tet.ShapeParameters = {simplex.E01: z, 
               simplex.E23: z, 
               simplex.E02: zp, 
               simplex.E13: zp, 
               simplex.E03: zpp, 
    ...
    def reindex_cusps_and_add_peripheral_curves(self, cusp_indices_and_peripheral_curve_data):
        ...
        for i, tet in enumerate(self.mcomplex.Tetrahedra):
            tet.PeripheralCurves = [
             [
              process_row(curves[(4 * i + 0)]),
              process_row(curves[(4 * i + 1)])],
             [
              process_row(curves[(4 * i + 2)]),
              process_row(curves[(4 * i + 3)])]]
