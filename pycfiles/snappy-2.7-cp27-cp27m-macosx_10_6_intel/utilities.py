...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/snap/utilities.py
...
class Vector2(MatrixBase):
    ...
    def __mul__(self, other):
        if isinstance(other, Matrix2x2):
            return Vector2(self.x * other.a + self.y * other.c, self.x * other.b + self.y * other.d)
