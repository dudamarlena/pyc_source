...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/snap/character_varieties.py
...
def s3(a1, a2, a3):
    ...
    """
    return mult_traceless(a1, a2, a3) + mult_traceless(a2, a3, a1) + mult_traceless(a3, a1, a2) - mult_traceless(a1, a3, a2) - mult_traceless(a3, a2, a1) - mult_traceless(a2, a1, a3)
