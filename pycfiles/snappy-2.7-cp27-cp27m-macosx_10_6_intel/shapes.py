...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/snap/shapes.py
...
def polished_tetrahedra_shapes(manifold, dec_prec=None, bits_prec=200, ignore_solution_type=False):
    ...
    if not ignore_solution_type and manifold.solution_type() not in ('all tetrahedra positively oriented',
    ...
    manifold._cache['polished_shapes'] = (
     bits_prec, shapes)
