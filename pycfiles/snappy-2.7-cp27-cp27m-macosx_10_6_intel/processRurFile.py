...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/ptolemy/processRurFile.py
...
def _parse_assignment(text, poly):
    var, expression = re.match('\\s*([_A-Za-z][_A-Za-z0-9]*)\\s*=\\s*(.*)$', text).groups()
    return (
     var,
