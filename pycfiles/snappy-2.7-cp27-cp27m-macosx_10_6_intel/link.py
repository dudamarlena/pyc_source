...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/snappy/build/lib.macosx-10.6-intel-2.7/snappy/snap/peripheral/link.py
...
TruncatedSimplexCorners = {V0: (
   ...
   V3: (
      E32, E31, E30)}
VerticesOfFace = {F0: (V1, V2, V3), F1: (V0, V3, V2), F2: (
      V0, V1, V3), 
   F3: (V0, V2, V1)}
