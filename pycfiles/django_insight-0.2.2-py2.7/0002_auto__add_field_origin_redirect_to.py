...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insight/migrations/0002_auto__add_field_origin_redirect_to.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('insight_origin', 'redirect_to', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('insight_origin', 'redirect_to')
