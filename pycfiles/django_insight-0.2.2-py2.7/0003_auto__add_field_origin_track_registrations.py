...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insight/migrations/0003_auto__add_field_origin_track_registrations.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('insight_origin', 'track_registrations', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
