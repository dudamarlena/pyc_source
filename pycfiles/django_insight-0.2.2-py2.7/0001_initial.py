...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insight/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       '%s.%s' % (User._meta.app_label, User._meta.module_name): {'Meta': {'object_name': User.__name__}, User._meta.pk.name: (
                                                                                     '%s.%s' % (User._meta.pk.__module__,
                                                                                      User._meta.pk.__class__.__name__), [], {'primary_key': 'True'})}, 
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'insight.origin': {'Meta': {'ordering': "['title']", 'object_name': 'Origin'}, 'code': (
                                 'django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '7', 'blank': 'True'}), 
                          'description': (
                          ...
                          'origin_group': (
                                         'django.db.models.fields.related.ForeignKey', [], {'to': "orm['insight.OriginGroup']", 'null': 'True', 'blank': 'True'}), 
                          'querystring_parameters': (
                                                   'django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}), 
                          'title': (
                                  'django.db.models.fields.CharField', [], {'max_length': '50'})}, 
       'insight.origingroup': {'Meta': {'object_name': 'OriginGroup'}, 'description': (
                                             'django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}), 
                               'id': (
                                    'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                               'title': (
                                       'django.db.models.fields.CharField', [], {'max_length': '50'})}, 
       'insight.querystringparameter': {'Meta': {'unique_together': "(('identifier', 'value', 'origin'),)", 'object_name': 'QuerystringParameter'}, 'id': (
                                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                        'identifier': (
                                        ...
                                        'number_of_registrations': (
                                                                  'django.db.models.fields.IntegerField', [], {'default': '0'}), 
                                        'origin': (
                                                 'django.db.models.fields.related.ForeignKey', [], {'to': "orm['insight.Origin']"}), 
                                        'value': (
                                                'django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'})}, 
       'insight.registration': {'Meta': {'ordering': "['-created']", 'object_name': 'Registration'}, 'created': (
                                ...
                                'origin': (
                                         'django.db.models.fields.related.ForeignKey', [], {'to': "orm['insight.Origin']"}), 
                                'user': (
                                       'django.db.models.fields.related.ForeignKey', [], {'to': "orm['%s']" % USER_MODEL_LABEL, 'unique': 'True'})}}
    complete_apps = [
     'insight']