...
# Embedded file name: build/bdist.linux-x86_64/egg/praekelt/recipe/spin.py
# Compiled at: 2011-06-29 04:50:07
...
class Spinner(ProgressBase):
    r"""Print 'animated' /|\ sequence to stdout in separate thread"""
