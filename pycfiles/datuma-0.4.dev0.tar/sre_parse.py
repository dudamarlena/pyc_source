...
# [GCC 8.4.0]
# Embedded file name: /Users/afreitas/dev/github/datuma/datuma.egg-info/lib/python2.7/sre_parse.py
# Compiled at: 2016-12-19 04:16:57
    ...
    try:
        ...
        if c in DIGITS:
            ...
            if group < state.groups:
                ...
                if state.lookbehind:
                    import warnings
                    warnings.warn('group references in lookbehind assertions are not supported', RuntimeWarning)
