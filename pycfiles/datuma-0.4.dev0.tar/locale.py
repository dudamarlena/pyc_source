...
# [GCC 8.4.0]
# Embedded file name: /Users/afreitas/dev/github/datuma/datuma.egg-info/lib/python2.7/locale.py
...
_ascii_lower_map = ('').join(chr(x + 32 if x >= ord('A') and x <= ord('Z') else x) for x in range(256))
