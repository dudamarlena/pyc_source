...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/fileinfo/plugins/fileinfo_inv_plugin_svn.py
# Compiled at: 2009-05-08 10:08:30
...
class SubversionInvestigator(BaseInvestigator):
    ...
    __module__ = __name__
    attrMap = {'rev': 'getRevision', 'lastchrev': 'getLastChangedRevision', 'lastchauth': 'getLastChangedAuthor', 'state': 'getState', 'numci': 'getNumCheckins'}
    totals = [
     'numci']
