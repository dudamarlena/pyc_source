...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/fileinfo/test/test_fileinfo.py
# Compiled at: 2009-05-07 08:11:42
...
class FileinfoTestCase(unittest.TestCase):
    ...
    def test5(self):
        ...
        plugins = fileinfo.plugging.loadPlugins(investigator.BaseInvestigator, 'fileinfo_inv_plugin_*.py', envVar=OSEPVN)
