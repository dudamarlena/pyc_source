...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/deeparg/abn.py
# Compiled at: 2019-04-25 18:03:39
import click
from Bio import SeqIO
import logging, gzip, json, options as gopt
...
def deeparg_abundance(prefix, deeparg, lfile, ncounts, nlength, rlength, output_file, gfilter):
    ...
    """
    logging.basicConfig(filename=output_file + '.log', level=logging.DEBUG, filemode='w', format='%(levelname)s %(asctime)s - %(message)s')
