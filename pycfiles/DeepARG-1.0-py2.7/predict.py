...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/deeparg/argdb/predict.py
...
import theano, sys, process_blast, cPickle, options as opt
from model import model
floatX = theano.config.floatX
min_prob = {'aminoglycoside': 0.17, 'macrolide-lincosamide-streptogramin': 0.15, 
   'polymyxin': 0.18, 
   'nitrofuratoin': 0.5, 
   'mupirocin': 0.5, 
   'bacitracin': 0.3, 
...
align = process_blast.make_alignments_json(fi, iden=0, eval=1e-05, len=5, BitScore=True)
