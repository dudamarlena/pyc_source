...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/pyUSID/io/hdf_utils/deprecated.py
# Compiled at: 2019-05-15 16:04:23
...
def __raise_move_warning(new_func_address):
    warn('This function has been moved to {}. This alias will be removed in a future version. Please update your import statements accordingly.'.format(new_func_address), FutureWarning)
...
def write_region_references(h5_dset, reg_ref_dict, add_labels_attr=True, verbose=False):
    ...
    return orig_func(h5_dset, reg_ref_dict, add_labels_attr=add_labels_attr, verbose=verbose)