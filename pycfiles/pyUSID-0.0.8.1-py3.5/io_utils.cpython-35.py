...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/pyUSID/io/io_utils.py
# Compiled at: 2019-11-30 21:58:33
# Size of source mod 2**32: 9575 bytes
"""
...
def recommend_cpu_cores(num_jobs, requested_cores=None, lengthy_computation=False, min_free_cores=None, verbose=False):
    ...
    return recommend_cpu_cores(num_jobs, requested_cores=requested_cores, lengthy_computation=lengthy_computation, min_free_cores=min_free_cores, verbose=verbose)