...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tests/io/test_translator.py
# Compiled at: 2019-12-12 10:45:25
...
class TestIsValidFile(unittest.TestCase):
    ...
    def test_single_ext(self):
        self.assertEqual(self.translator.is_valid_file(self.file_path, extension='txt'), self.file_path)
    ...
    def test_multi_ext(self):
        self.assertEqual(self.translator.is_valid_file(self.file_path, extension=[
         'txt',
         '.png']), self.file_path)
    ...
    def test_folder(self):
        self.assertEqual(self.translator.is_valid_file(os.path.abspath('.'), extension='.txt'), None)
