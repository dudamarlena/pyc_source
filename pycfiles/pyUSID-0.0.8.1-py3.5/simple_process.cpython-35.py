...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tests/io/simple_process.py
...
class SimpleProcess(Process):
    ...
    def __init__(self, h5_main, verbose=True, **kwargs):
        ...
        if self.verbose:
            print('Done with initializing book-keepings')
    ...
    def _create_results_datasets(self):
        ...
        if self.verbose:
            print('Results group created.')
        self.results = hdf_utils.create_empty_dataset(self.h5_main, self.h5_main.dtype, 'Filtered_Data', h5_group=self.h5_results_grp)
        if self.verbose:
            print('Empty main dataset for results written')
    ...
    def _write_results_chunk(self):
        ...
        if self.verbose:
            print('Chunk {} written.'.format(self.chunk_amount))
