...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/sparrow/base_backend.py
# Compiled at: 2009-07-20 09:57:48
from cStringIO import StringIO
import urllib2
from sparrow.utils import json_to_ntriples, dict_to_ntriples, ntriples_to_json, ntriples_to_dict
...
class BaseBackend(object):
    ...
    def _get_file(self, data):
        ...
        elif hasattr(data, 'read') and hasattr(data, 'seek') and hasattr(data, 'close'):
            return data
