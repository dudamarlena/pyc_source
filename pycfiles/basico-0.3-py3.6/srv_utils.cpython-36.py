...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/basico/services/srv_utils.py
# Compiled at: 2019-04-01 16:24:19
...
"""
import os, re, sys, subprocess, tarfile, zipfile, shutil, requests, webbrowser, feedparser
...
class Utils(Service):
    ...
    def check(self):
        ...
        """
        gtk_version = self.uif.check_gtk_version()
        gecko_driver = self.driver.check()
