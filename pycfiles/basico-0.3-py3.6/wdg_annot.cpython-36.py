...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/basico/widgets/wdg_annot.py
# Compiled at: 2019-03-31 12:04:48
# Size of source mod 2**32: 17645 bytes
"""
# File: wdg_annot.py
...
class AnnotationWidget(BasicoWidget, Gtk.VBox):
    ...
    def __setup(self):
        ...
        self._AnnotationWidget__setup_header()
        self._AnnotationWidget__setup_body()
        self._AnnotationWidget__setup_footer()
