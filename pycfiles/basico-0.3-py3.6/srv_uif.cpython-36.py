...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/basico/services/srv_uif.py
# Compiled at: 2019-03-31 12:04:48
# Size of source mod 2**32: 9345 bytes
"""
# File: srv_uif.py
...
class UIFuncs(Service):
    ...
    def warning_message_delete_annotations(self, widget, question, explanation, bag):
        ...
        icon.show_all()
        dialog = Gtk.MessageDialog(window, 0, Gtk.MessageType.QUESTION, Gtk.ButtonsType.YES_NO, question)
