...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/basico/widgets/wdg_menuview.py
# Compiled at: 2019-03-31 12:04:48
# Size of source mod 2**32: 30165 bytes
"""
                            ...
                            if self.view == 'collections':
                                ...
                                if self.view == 'tags':
                                    ...
                                    if self.view == 'category':
                                        ...
                                        if self.view == 'chronologic':
                                            self.populate_by_chronologic(sapnotes)
                                        else:
                                            if self.view == 'priority':
