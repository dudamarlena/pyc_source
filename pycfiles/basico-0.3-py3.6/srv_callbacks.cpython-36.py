...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/basico/services/srv_callbacks.py
# Compiled at: 2019-04-01 16:57:45
...
class Callback(Service):
    ...
    def gui_database_backup(self, *args):
        ...
        wdialog.destroy()
        dialog = Gtk.FileChooserDialog('Please choose target folder and backup name (without extension)', window, Gtk.FileChooserAction.SAVE, (
    ...
    def gui_database_restore(self, *args):
        visor_annotations = self.srvgui.get_widget('visor_annotations')
        window = self.srvgui.get_window()
        dialog = Gtk.FileChooserDialog('Please choose a backup file', window, Gtk.FileChooserAction.OPEN, (
    ...
    def action_collection_export_text_csv(self, *args):
        ...
        dialog = Gtk.FileChooserDialog('Save file', rootwin, Gtk.FileChooserAction.SAVE, (
         Gtk.STOCK_CANCEL, Gtk.ResponseType.CANCEL,
