...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/transforms/parts.py
        ...
        for child in node:
            if isinstance(child, nodes.section):
                ...
                generated = nodes.generated('',
                  (self.prefix + '.'.join(numbers) + self.suffix + '\xa0\xa0\xa0'),
                  classes=[
                 'sectnum'])
...
class Contents(Transform):
    ...
    def apply(self):
        ...
        if 'local' in details:
            ...
            while not isinstance(startnode, nodes.section):
                if not isinstance(startnode, nodes.document):
    ...
    def build_contents(self, node, level=0):
        ...
        for section in sections:
            ...
            reference = (nodes.reference)('', '', *entrytext, **{'refid': section['ids'][0]})
