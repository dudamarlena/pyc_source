...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/writers/manpage.py
# Compiled at: 2018-11-25 06:19:18
# Size of source mod 2**32: 35720 bytes
"""
...
class Translator(nodes.NodeVisitor):
    ...
    def __init__(self, document):
        ...
        self._list_char = []
        self._docinfo = {'title':'', 
         'title_upper':'',  'subtitle':'', 
         'manual_section':'', 
         'manual_group':'',  'author':[],  'date':'', 
         'copyright':'', 
         'version':''}
        self._docinfo_keys = []
        self._docinfo_names = {}
                ...
                if style == 'arabic':
                    ...
                    if style == 'loweralpha':
                        ...
                        if style == 'upperalpha':
                            ...
                            if style.endswith('roman'):
                                self._indent = 5

            def __next__(self):
                if self._style == 'bullet':
                    return self.enum_style[self._style]
                if self._style == 'emdash':
                    return self.enum_style[self._style]
                self._cnt += 1
    ...
    def depart_document(self, node):
        ...
        skip = ('author', 'copyright', 'date', 'manual_group', 'manual_section', 'subtitle',
    ...
    def visit_entry(self, node):
        if 'morerows' in node:
            self.document.reporter.warning('"table row spanning" not supported', base_node=node)
        if 'morecols' in node:
    ...
    def footnote_backrefs(self, node):
        self.document.reporter.warning('"footnote_backrefs" not supported', base_node=node)
    ...
    def visit_label(self, node):
        if isinstance(node.parent, nodes.footnote) or isinstance(node.parent, nodes.citation):
            raise nodes.SkipNode
    ...
    def visit_substitution_reference(self, node):
        self.document.reporter.warning('"substitution_reference" not supported', base_node=node)
