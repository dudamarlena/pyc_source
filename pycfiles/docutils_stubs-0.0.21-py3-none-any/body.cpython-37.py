...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/parsers/rst/directives/body.py
...
class BasePseudoSection(Directive):
    ...
    def run(self):
        if not self.state_machine.match_titles:
            if not isinstance(self.state_machine.node, nodes.sidebar):
