...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/core.py
# Compiled at: 2018-11-25 06:19:18
# Size of source mod 2**32: 29576 bytes
"""
...
class Publisher:
    ...
    def __init__(self, reader=None, parser=None, writer=None, source=None, source_class=io.FileInput, destination=None, destination_class=io.FileOutput, settings=None):
        ...
        for component in ('reader', 'parser', 'writer'):
            if isinstance(getattr(self, component), str):
                raise AssertionError('passed string "%s" as "%s" parameter; pass an instance, or use the "%s_name" parameter instead (in docutils.core.publish_* convenience functions).' % (
        ...
        if config_section:
            ...
            if len(parts) > 1:
                if parts[(-1)] == 'application':
                    settings_spec.config_section_dependencies = [
                     'applications']
        option_parser = OptionParser(components=(
    ...
    def set_source(self, source=None, source_path=None):
        ...
        try:
            self.source = self.source_class(source=source,
    ...
    def set_destination(self, destination=None, destination_path=None):
        ...
        self.destination = self.destination_class(destination=destination,
        ...
        try:
            if self.settings is None:
                (self.process_command_line)(
                 argv, usage, description, settings_spec, config_section, **settings_overrides or {})
            self.set_io()
    ...
    def debugging_dumps(self):
        ...
        if self.settings.dump_transforms:
            ...
            print((pprint.pformat([(priority, '%s.%s' % (xclass.__module__, xclass.__name__), pending and pending.details, kwargs) for priority, xclass, pending, kwargs in self.document.transformer.applied])),
              file=(self._stderr))
    ...
    def report_Exception(self, error):
        if isinstance(error, utils.SystemMessage):
            ...
            if isinstance(error, UnicodeEncodeError):
                ...
                if isinstance(error, io.InputError):
                    self._stderr.write('Unable to open source file for reading:\n  %s\n' % ErrorString(error))
                else:
                    if isinstance(error, io.OutputError):
...
default_description = 'Reads from <source> (default is stdin) and writes to <destination> (default is stdout).  See <http://docutils.sf.net/docs/user/config.html> for the full reference.'
...
def publish_cmdline(reader=None, reader_name='standalone', parser=None, parser_name='restructuredtext', writer=None, writer_name='pseudoxml', settings=None, settings_spec=None, settings_overrides=None, config_section=None, enable_exit_status=True, argv=None, usage=default_usage, description=default_description):
    ...
    output = pub.publish(argv,
      usage, description, settings_spec, settings_overrides, config_section=config_section,
...
def publish_file(source=None, source_path=None, destination=None, destination_path=None, reader=None, reader_name='standalone', parser=None, parser_name='restructuredtext', writer=None, writer_name='pseudoxml', settings=None, settings_spec=None, settings_overrides=None, config_section=None, enable_exit_status=False):
    ...
    """
    output, pub = publish_programmatically(source_class=(io.FileInput),
      source=source,
      source_path=source_path,
...
def publish_string(source, source_path=None, destination_path=None, reader=None, reader_name='standalone', parser=None, parser_name='restructuredtext', writer=None, writer_name='pseudoxml', settings=None, settings_spec=None, settings_overrides=None, config_section=None, enable_exit_status=False):
    ...
    Parameters: see `publish_programmatically`.
    """
    output, pub = publish_programmatically(source_class=(io.StringInput),
      source=source,
      source_path=source_path,
...
def publish_parts(source, source_path=None, source_class=io.StringInput, destination_path=None, reader=None, reader_name='standalone', parser=None, parser_name='restructuredtext', writer=None, writer_name='pseudoxml', settings=None, settings_spec=None, settings_overrides=None, config_section=None, enable_exit_status=False):
    ...
    Parameters: see `publish_programmatically`.
    """
    output, pub = publish_programmatically(source=source,
      source_path=source_path,
...
def publish_doctree(source, source_path=None, source_class=io.StringInput, reader=None, reader_name='standalone', parser=None, parser_name='restructuredtext', settings=None, settings_spec=None, settings_overrides=None, config_section=None, enable_exit_status=False):
    """
    ...
    Parameters: see `publish_programmatically`.
    """
    pub = Publisher(reader=reader, parser=parser, writer=None, settings=settings,
      source_class=source_class,
...
def publish_from_doctree(document, destination_path=None, writer=None, writer_name='pseudoxml', settings=None, settings_spec=None, settings_overrides=None, config_section=None, enable_exit_status=False):
    ...
    pub = Publisher(reader, None, writer, source=(io.DocTreeInput(document)),
      destination_class=(io.StringOutput),
      settings=settings)
    if not writer:
        if writer_name:
...
def publish_programmatically(source_class, source, source_path, destination_class, destination, destination_path, reader, reader_name, parser, parser_name, writer, writer_name, settings, settings_spec, settings_overrides, config_section, enable_exit_status):
    ...
    * `enable_exit_status`: Boolean; enable exit status at end of processing?
    """
    pub = Publisher(reader, parser, writer, settings=settings, source_class=source_class,
