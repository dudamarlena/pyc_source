...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/utils/error_reporting.py
            ...
            if self.stream is False:
                ...
                try:
                    ...
                    if isinstance(data, str):
                        self.stream.write(data.encode(self.encoding, self.encoding_errors))
                        return
                    elif self.stream in (sys.stderr, sys.stdout):
