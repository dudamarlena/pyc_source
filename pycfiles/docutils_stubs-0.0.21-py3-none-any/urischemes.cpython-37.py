...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/utils/urischemes.py
# Compiled at: 2018-11-25 06:19:18
# Size of source mod 2**32: 6275 bytes
"""
...
schemes = {'about':'provides information on Navigator', 
 ...
 'eid':'External ID; non-URL data; general escape mechanism to allow access to information for applications that are too specialized to justify their own schemes', 
 'fax':'a connection to a terminal that can handle telefaxes (facsimiles); RFC 2806', 
 ...
 'h324':'video and audio communications over low bitrate connections such as POTS modem connections', 
 ...
 'mocha':'', 
 'modem':'a connection to a terminal that can handle incoming data calls; RFC 2806', 
 ...
 'tag':'RFC 4151', 
 'tcp':'', 
 'tel':'a connection to a terminal that handles normal voice telephone calls, a voice mailbox or another voice messaging system or a service that can be operated using DTMF tones; RFC 3966.', 
 'telephone':'telephone', 
