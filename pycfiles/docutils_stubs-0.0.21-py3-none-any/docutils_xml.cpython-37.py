...
# [GCC 8.4.0]
# Embedded file name: /Users/tkomiya/work/sphinx/.tox/py37/lib/python3.7/site-packages/docutils/writers/docutils_xml.py
...
import sys, xml
if '_xmlplus' in xml.__path__[0]:
    xml.__path__.reverse()
     ...
     (
      ...
      (
       ...
       {'dest':'xml_declaration', 
        'default':1,  'action':'store_false',  'validator':frontend.validate_boolean}),
      (
    ...
    def default_visit(self, node):
        ...
        if not self.in_simple:
            ...
            if isinstance(node, self.simple_nodes):
                self.in_simple += 1
            self.in_simple or self.output.append(self.newline)
