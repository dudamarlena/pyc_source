...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/experiment/perfectclamp_base.py
# Compiled at: 2011-09-13 02:54:46
import _perfectclamp_base, new
...
class simobj_PerfectClamp(_object):
    ...
    if _newclass:
        pcName = _swig_property(_perfectclamp_base.simobj_PerfectClamp_pcName_get, _perfectclamp_base.simobj_PerfectClamp_pcName_set)
    ...
    if _newclass:
        iClampsActive = _swig_property(_perfectclamp_base.simobj_PerfectClamp_iClampsActive_get, _perfectclamp_base.simobj_PerfectClamp_iClampsActive_set)
    ...
    if _newclass:
        pdVoltage = _swig_property(_perfectclamp_base.simobj_PerfectClamp_pdVoltage_get, _perfectclamp_base.simobj_PerfectClamp_pdVoltage_set)
    ...
    if _newclass:
        dCommand = _swig_property(_perfectclamp_base.simobj_PerfectClamp_dCommand_get, _perfectclamp_base.simobj_PerfectClamp_dCommand_set)
    ...
    if _newclass:
        pcFilename = _swig_property(_perfectclamp_base.simobj_PerfectClamp_pcFilename_get, _perfectclamp_base.simobj_PerfectClamp_pcFilename_set)
    ...
    if _newclass:
        pfile = _swig_property(_perfectclamp_base.simobj_PerfectClamp_pfile_get, _perfectclamp_base.simobj_PerfectClamp_pfile_set)
