...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/experiment/pulsegen_base.py
# Compiled at: 2011-09-13 02:54:43
import _pulsegen_base, new
...
class simobj_PulseGen(_object):
    ...
    if _newclass:
        pcName = _swig_property(_pulsegen_base.simobj_PulseGen_pcName_get, _pulsegen_base.simobj_PulseGen_pcName_set)
    ...
    if _newclass:
        dLevel1 = _swig_property(_pulsegen_base.simobj_PulseGen_dLevel1_get, _pulsegen_base.simobj_PulseGen_dLevel1_set)
    ...
    if _newclass:
        dWidth1 = _swig_property(_pulsegen_base.simobj_PulseGen_dWidth1_get, _pulsegen_base.simobj_PulseGen_dWidth1_set)
    ...
    if _newclass:
        dDelay1 = _swig_property(_pulsegen_base.simobj_PulseGen_dDelay1_get, _pulsegen_base.simobj_PulseGen_dDelay1_set)
    ...
    if _newclass:
        dLevel2 = _swig_property(_pulsegen_base.simobj_PulseGen_dLevel2_get, _pulsegen_base.simobj_PulseGen_dLevel2_set)
    ...
    if _newclass:
        dWidth2 = _swig_property(_pulsegen_base.simobj_PulseGen_dWidth2_get, _pulsegen_base.simobj_PulseGen_dWidth2_set)
    ...
    if _newclass:
        dDelay2 = _swig_property(_pulsegen_base.simobj_PulseGen_dDelay2_get, _pulsegen_base.simobj_PulseGen_dDelay2_set)
    ...
    if _newclass:
        dBaseLevel = _swig_property(_pulsegen_base.simobj_PulseGen_dBaseLevel_get, _pulsegen_base.simobj_PulseGen_dBaseLevel_set)
    ...
    if _newclass:
        dTriggerTime = _swig_property(_pulsegen_base.simobj_PulseGen_dTriggerTime_get, _pulsegen_base.simobj_PulseGen_dTriggerTime_set)
    ...
    if _newclass:
        iTriggerMode = _swig_property(_pulsegen_base.simobj_PulseGen_iTriggerMode_get, _pulsegen_base.simobj_PulseGen_iTriggerMode_set)
    ...
    if _newclass:
        iPreviousInput = _swig_property(_pulsegen_base.simobj_PulseGen_iPreviousInput_get, _pulsegen_base.simobj_PulseGen_iPreviousInput_set)
    ...
    if _newclass:
        pdPulseIn = _swig_property(_pulsegen_base.simobj_PulseGen_pdPulseIn_get, _pulsegen_base.simobj_PulseGen_pdPulseIn_set)
    ...
    if _newclass:
        pdPulseOut = _swig_property(_pulsegen_base.simobj_PulseGen_pdPulseOut_get, _pulsegen_base.simobj_PulseGen_pdPulseOut_set)
