...
class PulseGen:
    ...
    def __init__(self, name='Unnamed PulseGen', level1=0, width1=0, delay1=0, level2=0, width2=0, delay2=0, base_level=0, trigger_mode=0):
        self.spg = PulseGenNew(name)
        PulseGenSetFields(self.spg, level1, width1, delay1, level2, width2, delay2, base_level, trigger_mode)
