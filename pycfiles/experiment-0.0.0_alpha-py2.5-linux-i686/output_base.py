...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/experiment/output_base.py
# Compiled at: 2011-09-13 02:54:44
import _output_base, new
...
class OutputGenerator(_object):
    ...
    if _newclass:
        iVariablesAllocated = _swig_property(_output_base.OutputGenerator_iVariablesAllocated_get, _output_base.OutputGenerator_iVariablesAllocated_set)
    ...
    if _newclass:
        iVariablesActive = _swig_property(_output_base.OutputGenerator_iVariablesActive_get, _output_base.OutputGenerator_iVariablesActive_set)
    ...
    if _newclass:
        ppdVariables = _swig_property(_output_base.OutputGenerator_ppdVariables_get, _output_base.OutputGenerator_ppdVariables_set)
    ...
    if _newclass:
        dBase = _swig_property(_output_base.OutputGenerator_dBase_get, _output_base.OutputGenerator_dBase_set)
    ...
    if _newclass:
        pcFilename = _swig_property(_output_base.OutputGenerator_pcFilename_get, _output_base.OutputGenerator_pcFilename_set)
    ...
    if _newclass:
        pfileOutput = _swig_property(_output_base.OutputGenerator_pfileOutput_get, _output_base.OutputGenerator_pfileOutput_set)
    ...
    if _newclass:
        iSteps = _swig_property(_output_base.OutputGenerator_iSteps_get, _output_base.OutputGenerator_iSteps_set)
    ...
    if _newclass:
        pcFormat = _swig_property(_output_base.OutputGenerator_pcFormat_get, _output_base.OutputGenerator_pcFormat_set)
    ...
    if _newclass:
        iResolution = _swig_property(_output_base.OutputGenerator_iResolution_get, _output_base.OutputGenerator_iResolution_set)
    ...
    if _newclass:
        iResolutionStep = _swig_property(_output_base.OutputGenerator_iResolutionStep_get, _output_base.OutputGenerator_iResolutionStep_set)
