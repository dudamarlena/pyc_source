            ...
            if not self._killSignal:
                ...
                try:
                    ...
                    if received['action'] == 'publish':
                        ...
                        if not received['action'] in ('acquire', 'release', 'publish'):
                            raise AssertionError("received dict must have 'action' key value must be either 'acquire', 'release' or 'publish'")
                        else:
                            ...
                            if received['action'] == 'acquire':
                                ...
                                if not received['timeout'] > 0:
                                    raise AssertionError('request timeout must be >0')
        ...
        if not isinstance(unique, bool):
            ...
            if not isinstance(replace, bool):
                ...
                if receivers is not None:
                    ...
                    toSelf = toSelf or self._ServerLocker__uniqueName in receivers
