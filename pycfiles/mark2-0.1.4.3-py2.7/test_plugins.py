...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mk2/test/test_plugins.py
...
class PluginTestCase(PluginTestBase, unittest.TestCase):
    ...
    def test_action_chain(self):
        ...
        act = self.plugin.action_chain('10h;10m;10s', callbackWarn, callbackAction)[1]
        act()
    ...
    def test_action_cancel(self):
        ...
        act, cancel = self.plugin.action_chain_cancellable('1s', lambda a: None, callbackAction, callbackCancel)[-2:]
        act()
