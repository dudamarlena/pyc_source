...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mk2/test/test_events.py
...
class EventsTestCase(unittest.TestCase):
    ...
    def test_prefilter_check(self):
        ...
        self.assertRaises(Exception, self.events.register, handler, PrefilterTest_1, require='foo', optional='bar', fooarg='excess argument')
        self.events.register(handler, PrefilterTest_2, require='foo', optional='bar', fooarg='excess argument')