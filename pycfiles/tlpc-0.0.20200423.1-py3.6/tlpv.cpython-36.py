...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tlp/tlpv.py
...
def main():
    parser = argparse.ArgumentParser(prog='tlpv',
      description='Task-Level Parallelization (TLP) Visualizer')
    parser.add_argument(dest='program', help='input ‘program.json’, default to stdin',
      nargs='?',
    ...
    task_fmt = '"{name}#{id}"'
    font = 'Arial'
    program = tlp.core.Program(args.program)
    output = args.output
