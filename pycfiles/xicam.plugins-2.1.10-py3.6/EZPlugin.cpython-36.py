...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\xicam\plugins\EZPlugin.py
...
class _EZPlugin(GUIPlugin):
    ...
    def __init__(self, name, toolbuttons=None, parameters=None, appendheadertest=None, centerwidget=None, bottomwidget=None):
        ...
        self.stages = {'EZPlugin': GUILayout((self.centerwidget), right=(self.rightwidget), bottom=(self.bottomwidget), top=(self.toolbar))}
...
def EZPlugin(name='TestPlugin', toolbuttons=None, parameters=None, appendheadertest=None, centerwidget=None, bottomwidget=None):
    import pyqtgraph as pg
    if centerwidget is None:
        centerwidget = pg.ImageView
    if bottomwidget is None:
        bottomwidget = pg.PlotWidget
    return type(name, (_EZPlugin,), {'__init__': lambda self: _EZPlugin.__init__(self, name, toolbuttons, parameters, appendheadertest, centerwidget, bottomwidget)})