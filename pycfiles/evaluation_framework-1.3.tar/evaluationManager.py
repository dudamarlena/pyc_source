...
# [GCC 8.4.0]
# Embedded file name: /home/marpel/Scrivania/github/Evaluation-Framework/evaluation_framework/evaluationManager.py
# Compiled at: 2020-01-21 10:16:01
                    ...
                    for model in models:
                        ...
                        for model_configuration in model_configurations:
                            ...
                            for metric in metrics:
                                ...
                                to_sort = task_dataframe[((task_dataframe['gold_standard_file'] == gold_standard_file) & (task_dataframe['model'] == model) & (task_dataframe['model_configuration'] == model_configuration) & (task_dataframe['metric'] == metric))]
                                ...
                                rating_dataframe = rating_dataframe.append({'task_name': task, 'gold_standard_file': gold_standard_file, 
                                   'model': model, 
