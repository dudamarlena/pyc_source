...
# Embedded file name: /home/waters/Pedro/ChemStruct/chemstruct/quick.py
# Compiled at: 2019-05-27 08:32:08
# Size of source mod 2**32: 3528 bytes
__doc__ = 'Quick functions for generating LAMMPS Data files.'
from constants import PACKAGE_DIR
from files.charmm import CharmmGeneral
from files.lmp import LmpDat

def write_lmpdat(xyz_file: str, lmpdat_file: str, par_file=None, periodic='', simple=False):
    """
...
def finish_lmpdat(xyz_types_file: str, lmpdat_file: str, par_file: str, periodic='', simple=False):
    """
