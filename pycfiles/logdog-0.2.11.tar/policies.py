...
# [GCC 8.4.0]
# Embedded file name: /home/miph/Development/logdog/python-logdog/logdog/core/policies.py
# Compiled at: 2015-04-04 17:37:33
...
class DefaultSleepPolicy(object):
    ...
    MAX_SLEEP_INTERVAL = 180.0
    SLEEP_REPEAT_COUNT = 10

    def __init__(self, sleep_interval=BASE_SLEEP_INTERVAL, max_sleep_interval=MAX_SLEEP_INTERVAL, sleep_repeat_count=SLEEP_REPEAT_COUNT, **kwargs):
...
class GreedyPolicy(object):
    ...
    def need_to_wait(self):
        self._count += 1
        return self._count >= self._max_count or self._time + self._timeout < time.time()
