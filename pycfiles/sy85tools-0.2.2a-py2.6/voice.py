...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\sy85\data\voice.py
...
VOICE_SYSEX_FORMAT = [
 ...
 (67, 1, 35, 'Effect LFO wave', 'b_lookup', 'tri', 'dwn', 'up', 'squ', 'sin', 'S/H',
 '1tm'),
 ...
 (
  119, 1, 87, 'Wave data bank', 'subbyte_lookup', 3, [ x[1] for x in WAVEFORM_BANKS ]),
