...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\sy85\scripts\sy85all.py
...
class SY85All(Bunch):
    ...
    def get_voice_name(self, bank, program=None, default='<unknown>', preset=False):
...
def main(args):
    ...
    optparser.add_option('-o', '--output', metavar='FILE', dest='outfile', help='Write output to FILE (default: standard out).')
