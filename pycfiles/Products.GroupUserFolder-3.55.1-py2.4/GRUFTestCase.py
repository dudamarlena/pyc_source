...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/Products/GroupUserFolder/tests/GRUFTestCase.py
...
class GRUFTestCase(ZopeTestCase.ZopeTestCase):
    ...
    def delete_created_users(self):
        self.gruf.userFolderDelUsers(['manager', 'u1', 'u2', 'u3', 'u4', 'u5', 'u6', 'u7', 'u8', 'u9', 'u10', 'u11', 'created_user', 'test_prefix', 'group_test_prefix'])
        self.gruf.userFolderDelGroups(['g1', 'g2', 'g3', 'g4', 'ng1', 'ng2', 'ng3', 'ng4', 'ng5', 'extranet', 'intranet', 'compta'])
