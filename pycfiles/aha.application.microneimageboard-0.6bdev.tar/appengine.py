...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/aha/auth/appengine.py
# Compiled at: 2011-03-22 20:04:15
__doc__ = " appengine.py - A module to provide auth handler of\n                App Engine's Google Authentication.\n\n$Id: appengine.py 638 2010-08-10 04:05:57Z ats $\n"
...
class AppEngineAuth(BaseAuth):
    ...
    def get_user(self, ins, *param, **kws):
        ...
        u = users.get_current_user()
        if u:
            return {'type': self.TYPE, 'nickname': u.nickname(), 
               'email': u.email(), 
               'userid': u.user_id(), 
               'realname': u.nickname()}
        else:
