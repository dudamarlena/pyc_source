...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/aha/widget/tests/test_forms.py
# Compiled at: 2010-10-20 23:02:07
from unittest import TestCase
import logging
log = logging.getLogger(__name__)
from formencode import validators, Invalid
from nose.tools import *
from coregae.widget.forms import FieldHolder, BaseForm, Fieldset, SelectiveFieldset, Form, RootTabbedFieldset
...
class TestBaseform(TestCase):
    ...
    def test_baseform2(self):
        ...
        assert_equal(sorted(tf.validate({'name1': 'A', 'name2': 'A'}).keys()), sorted(['name1', 'name2']))
    ...
    def test_fieldset1(self):
        ...
        class TmpForm(FieldHolder):
            name1 = TextField()
            fieldset1 = Fieldset(title='foo title 1', fields=(
             TextField(name='name1-1'),
             TextField(name='name1-2')))
            name2 = TextField()
            fieldset2 = Fieldset(title='foo title 2', fields=(
    ...
    def test_media1(self):
        ...
        class TmpForm(BaseForm):
            name1 = TextField()
            fieldset1 = Fieldset(title='foo title 1', fields=(
             TextField(name='name1-1', objects=(
              ('foo.css', 'text/css'),
    ...
    def test_selectivefieldset(self):
        ...
        class TmpForm(Form):
            name1 = TextField()
            fieldset1 = SelectiveFieldset(title='foo title 1', innerfields=(
             (
              'if1', 'innerfield1',
              (
        ...
        tf = TmpForm()
        fb = tf.render({'fieldset1': "{'_selection':'if1', 'name1-1':'1', 'name1-2':'foo'}"})
    ...
    def test_tabbedfieldset(self):
        ...
        class TmpForm(Form):
            name1 = TextField()
            fieldset1 = RootTabbedFieldset(title='foo title 1', name='foo name', innerfields=(
             (
              'tab1',
              (
               TextField(name='name1-1', validator=v.Int()),
