...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/aha/controller/decorator.py
# Compiled at: 2011-03-28 04:26:41
__doc__ = 'decorators.py - A bunch of functions that work as decorators\nfor controller methods.\n\n$Id: decorators.py 652 2010-08-23 01:58:52Z ats $\n'
...
class cache(object):
    ...
    def __call__(self, func, *args, **kws):
        ...
        def execute(me):
            ...
            out.seek(0)
            try:
                memcache.set(p, {'hdr': resp.headers, 'body': out.read()}, self.expire, namespace=namespace)
