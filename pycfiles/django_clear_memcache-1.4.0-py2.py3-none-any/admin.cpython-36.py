...
# [GCC 8.4.0]
# Embedded file name: /home/enrico/pyenv/uvena_de/django_clear_memcache/admin.py
# Compiled at: 2019-09-22 07:50:54
...
class ClearMemcacheAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        response = admin.ModelAdmin.changelist_view(self,
          request,
