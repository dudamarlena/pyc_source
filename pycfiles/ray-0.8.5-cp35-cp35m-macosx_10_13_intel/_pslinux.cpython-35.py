...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/nz/vv4_9tw56nv9k3tkvyszvwg80000gn/T/pip-unpacked-wheel-c6tqtva7/psutil/_pslinux.py
# Compiled at: 2020-05-06 17:45:43
# Size of source mod 2**32: 79806 bytes
    ...
    with open_binary('%s/cpuinfo' % get_procfs_path()) as (f):
        for line in f:
            ...
            if not line:
                ...
                current_info = {}
            elif line.startswith(b'physical id') or line.startswith(b'cpu cores'):
...
class Connections:
    ...
    def __init__(self):
        ...
        self.tmap = {'all': (tcp4, tcp6, udp4, udp6, unix), 
         'tcp': (tcp4, tcp6), 
         'tcp4': (tcp4,), 
         'tcp6': (tcp6,), 
         'udp': (udp4, udp6), 
