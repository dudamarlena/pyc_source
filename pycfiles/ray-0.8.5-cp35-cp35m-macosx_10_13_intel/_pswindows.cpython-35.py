...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/nz/vv4_9tw56nv9k3tkvyszvwg80000gn/T/pip-unpacked-wheel-c6tqtva7/psutil/_pswindows.py
# Compiled at: 2020-05-06 17:45:43
# Size of source mod 2**32: 36839 bytes
    ...
    def _wrap_exceptions(self):
        ...
        try:
            ...
            if is_permission_err(err):
                ...
                if err.winerror in (cext.ERROR_INVALID_NAME,
...
def retry_error_partial_copy(fun):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        for x in range(times):
            ...
            msg = "%s retried %s times, converted to AccessDenied as it's still returning %r" % (
             fun, times, err)
...
class Process(object):
    ...
    def send_signal(self, sig):
        if sig == signal.SIGTERM:
            ...
            if sig in (getattr(signal, 'CTRL_C_EVENT', object()),
