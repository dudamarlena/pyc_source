...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/nz/vv4_9tw56nv9k3tkvyszvwg80000gn/T/pip-unpacked-wheel-c6tqtva7/psutil/_psosx.py
# Compiled at: 2020-05-06 17:45:43
# Size of source mod 2**32: 17090 bytes
...
def disk_partitions(all=False):
    ...
    for partition in partitions:
        ...
        if device == 'none':
            device = ''
        if not all:
            if not not os.path.isabs(device):
