...
class CfnStack(object):
    ...
    def to_request_params(self):
        ...
        if self._CfnStack__params is not None:
            request_params['Parameters'] = self._CfnStack__params['Parameters'] or None
            request_params['Capabilities'] = self._CfnStack__params['Capabilities'] or None
            request_params['Tags'] = self._CfnStack__params['Tags'] or None
