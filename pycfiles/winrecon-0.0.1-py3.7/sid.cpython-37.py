...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\winrecon\cf\sid.py
# Compiled at: 2019-03-05 11:24:12
...
class SID:
    ...
    def __str__(self):
        t = 'S-1-'
        if self.IdentifierAuthority < 4294967296:
...
well_known_sids = {'NULL':SID.from_string('S-1-0-0', True), 
