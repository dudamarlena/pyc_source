...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dap/responses/wms/nanosax.py
    ...
    def _parse_into_chunks(self, xml):
        ...
        while xml:
            ...
            if xml.startswith('<![CDATA['):
                ...
                self._test(name.strip() == startname.strip(), currline, "closing tag '%s' doesn't match openingtag '%s'" % (
                 name, startname))
                offset += endpos + 1
