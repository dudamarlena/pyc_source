...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dap/responses/wms/templess.py
# Compiled at: 2006-11-16 12:21:20
"""
    ...
    def handle_exception(self, exc, e, tb):
        ...
        try:
            ...
            context = {'exception': str(exc), 
               'message': str(e), 
               'traceback': ('\n').join(tblist), 
               'tblist': [ {'line': str(l)} for l in tblist ], 'footer': __footer__}
            ret = t.render_to_string(context)
        finally:
            fp.close()
