...
# Compiled at: 2017-05-08 15:13:23
"""
...
import logging, numpy as np, pandas as pd, cobra, timeit
from sbmlutils.dfba.model import DFBAModel
from sbmlutils import fbc

def simulate_dfba(sbml_path, tstart=0.0, tend=10.0, dt=0.1, pfba=True, abs_tol=1e-06, rel_tol=1e-06, lp_solver='glpk', **kwargs):
    ...
    dfba_simulator = DFBASimulator(dfba_model, pfba=pfba, abs_tol=abs_tol, rel_tol=rel_tol, lp_solver=lp_solver)
...
class DFBASimulator(object):
    ...
    def __init__(self, dfba_model, abs_tol=1e-06, rel_tol=1e-06, lp_solver='glpk', pfba=True):
    ...
    def simulate(self, tstart=0.0, tend=10.0, dt=0.1, absTol=1e-06, relTol=1e-06, reset=True):
