...
# [GCC 8.4.0]
# Embedded file name: /home/redhat/cuemacro/chartpy/chartpy/chartconstants.py
# Compiled at: 2019-08-06 06:14:38
...
class ChartConstants(object):
    ...
    chartfactory_style_sheet = {'chartpy': root_chartpy + 'stylesheets/chartpy.mplstyle', 'chartpy-pyfolio': root_chartpy + 'stylesheets/chartpy-pyfolio.mplstyle', 
    ...
    plotly_palette = ['#E24A33',
     ...
     '#FFB5B8']
    plotly_webgl = False
    plotly_helper = 'cufflinks'
    plotly_default_username = 'abc'
    plotly_creds = {'abc': 'pass', 'xyz': 'pass'}
