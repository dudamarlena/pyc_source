...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/seafileapi/files.py
# Compiled at: 2014-11-21 04:30:36
...
class SeafDir(_SeafDirentBase):
    ...
    def _get_upload_link(self):
        ...
        return re.match('"(.*)"', resp.text).group(1)
