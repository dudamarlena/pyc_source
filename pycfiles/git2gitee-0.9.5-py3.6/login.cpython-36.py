...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/git2gitee/login.py
# Compiled at: 2020-05-03 08:14:22
...
class GiteeLogin:
    ...
    def get_crsf_token(self):
        ...
        self.public_key = json.loads(re.search('gon.encrypt=(.*?);', response.text).group(1))['password_key']
