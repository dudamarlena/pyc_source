...
# [GCC 8.4.0]
# Embedded file name: /Users/uranusjr/Documents/programming/python/django-sparkle-external/django-sparkle-external/sparkle/migrations/0001_initial.py
# Compiled at: 2014-07-03 04:04:44
# Size of source mod 2**32: 3762 bytes
from __future__ import unicode_literals
from django.db import models, migrations
import ghostdown.models.fields, django.utils.timezone
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Application', fields=[
      ...
      (
       'slug', models.SlugField(verbose_name='slug', unique=True))], options={'verbose_name_plural': 'applications', 
      'verbose_name': 'application'}, bases=(
      models.Model,)),
     migrations.CreateModel(name='SystemProfileReport', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', auto_created=True, serialize=False)),
      (
       'ip_address', models.IPAddressField(verbose_name='IP address')),
      (
       'created_at', models.DateTimeField(verbose_name='created at', auto_now_add=True))], options={}, bases=(
      models.Model,)),
     migrations.CreateModel(name='SystemProfileReportRecord', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', auto_created=True, serialize=False)),
      (
      ...
      (
       'report', models.ForeignKey(to='sparkle.SystemProfileReport', verbose_name='report'))], options={}, bases=(
      models.Model,)),
     migrations.CreateModel(name='Version', fields=[
      (
       'id', models.AutoField(primary_key=True, verbose_name='ID', auto_created=True, serialize=False)),
      (
      ...
      (
       'application', models.ForeignKey(to='sparkle.Application', verbose_name='application'))], options={'verbose_name_plural': 'versions', 
      'verbose_name': 'version', 
      'get_latest_by': 'publish_at', 
      'ordering': ('-publish_at', )}, bases=(
      models.Model,))]