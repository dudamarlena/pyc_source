...
# [GCC 8.4.0]
# Embedded file name: AppService_services.py
...
class AppServicePortSoapBindingSOAP():
    ...
    def destroy(self, request):
        ...
        if not isinstance(response, destroyResponse) and not issubclass(destroyResponse, response.__class__):
    ...
    def getAppConfig(self, request):
        ...
        @return: response from getAppConfigResponse::
            _getAppConfigOutput: ns1.AppConfigType_Def
              ...
              _parallel: boolean
        """
        if not isinstance(request, getAppConfigRequest) and not issubclass(getAppConfigRequest, request.__class__):
            raise TypeError, '%s incorrect request type' % request.__class__
        kw = {}
        ...
        if not isinstance(response, getAppConfigResponse) and not issubclass(getAppConfigResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
    ...
    def getAppMetadata(self, request):
        ...
        @return: response from getAppMetadataResponse::
            _getAppMetadataOutput: ns1.AppMetadataType_Def
              ...
              _usage: str
        """
        if not isinstance(request, getAppMetadataRequest) and not issubclass(getAppMetadataRequest, request.__class__):
            raise TypeError, '%s incorrect request type' % request.__class__
        kw = {}
        ...
        if not isinstance(response, getAppMetadataResponse) and not issubclass(getAppMetadataResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
    ...
    def getOutputAsBase64ByName(self, request):
        ...
        @return: response from getOutputAsBase64ByNameResponse::
            _item: str, optional
        """
        if not isinstance(request, getOutputAsBase64ByNameRequest) and not issubclass(getOutputAsBase64ByNameRequest, request.__class__):
            raise TypeError, '%s incorrect request type' % request.__class__
        kw = {}
        ...
        if not isinstance(response, getOutputAsBase64ByNameResponse) and not issubclass(getOutputAsBase64ByNameResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
    ...
    def getOutputs(self, request):
        ...
        if not isinstance(response, getOutputsResponse) and not issubclass(getOutputsResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
    ...
    def launchJob(self, request):
        ...
        @return: response from launchJobResponse::
            _launchJobOutput: ns1.JobSubOutputType_Def
              ...
              _status: ns1.StatusOutputType_Def
                ...
                _message: str
        """
        if not isinstance(request, launchJobRequest) and not issubclass(launchJobRequest, request.__class__):
            raise TypeError, '%s incorrect request type' % request.__class__
        kw = {}
        ...
        if not isinstance(response, launchJobResponse) and not issubclass(launchJobResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
    ...
    def launchJobBlocking(self, request):
        ...
        @return: response from launchJobBlockingResponse::
            _launchJobBlockingOutput: ns1.BlockingOutputType_Def
              ...
              _status: ns1.StatusOutputType_Def
                ...
                _message: str
        """
        if not isinstance(request, launchJobBlockingRequest) and not issubclass(launchJobBlockingRequest, request.__class__):
            raise TypeError, '%s incorrect request type' % request.__class__
        kw = {}
        ...
        if not isinstance(response, launchJobBlockingResponse) and not issubclass(launchJobBlockingResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
    ...
    def queryStatus(self, request):
        ...
        if not isinstance(response, queryStatusResponse) and not issubclass(queryStatusResponse, response.__class__):
            raise TypeError, '%s incorrect response type' % response.__class__
        return response
