...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-6brxc_kc/pyppeteer/pyppeteer/input.py
...
class Keyboard(object):
    ...
    async def down(self, key: str, options: dict=None, **kwargs: Any) -> None:
        ...
        await self._client.send('Input.dispatchKeyEvent', {'type':'keyDown' if text else 'rawKeyDown', 
    ...
    def _keyDescriptionForString(self, keyString: str) -> Dict:
        ...
        if shift:
            if definition.get('shiftKey'):
                description['key'] = definition['shiftKey']
        if 'keyCode' in definition:
            description['keyCode'] = definition['keyCode']
        if shift:
            if definition.get('shiftKeyCode'):
        ...
        if shift:
            if definition.get('shiftText'):
                description['text'] = definition['shiftText']
        if self._modifiers & -9:
            description['text'] = ''
        return description
    ...
    async def up(self, key: str) -> None:
        ...
        await self._client.send('Input.dispatchKeyEvent', {'type':'keyUp', 
         'modifiers':self._modifiers, 
         'key':description['key'], 
         'windowsVirtualKeyCode':description['keyCode'], 
         'code':description['code'], 
    ...
    async def sendCharacter(self, char: str) -> None:
        ...
        """
        await self._client.send('Input.dispatchKeyEvent', {'type':'char', 
         'modifiers':self._modifiers, 
         'text':char, 
         'key':char, 
         'unmodifiedText':char})
...
class Mouse(object):
    ...
    async def move(self, x: float, y: float, options: dict=None, **kwargs: Any) -> None:
        ...
        for i in range(1, steps + 1):
            ...
            await self._client.send('Input.dispatchMouseEvent', {'type':'mouseMoved', 
             'button':self._button, 
             'x':x, 
             'y':y, 
    ...
    async def down(self, options: dict=None, **kwargs: Any) -> None:
        ...
        * ``clickCount`` (int): defaults to 1.
        ...
        await self._client.send('Input.dispatchMouseEvent', {'type':'mousePressed', 
         'button':self._button, 
         'x':self._x, 
         'y':self._y, 
         'modifiers':self._keyboard._modifiers, 
    ...
    async def up(self, options: dict=None, **kwargs: Any) -> None:
        ...
        * ``clickCount`` (int): defaults to 1.
        ...
        options = merge_dict(options, kwargs)
        self._button = 'none'
        await self._client.send('Input.dispatchMouseEvent', {'type':'mouseReleased', 
...
class Touchscreen(object):
    ...
    async def tap(self, x: float, y: float) -> None:
        ...
        touchPoints = [
         {'x':round(x), 
          'y':round(y)}]
        await self._client.send('Input.dispatchTouchEvent', {'type':'touchStart', 
         'touchPoints':touchPoints, 
         'modifiers':self._keyboard._modifiers})
        await self._client.send('Input.dispatchTouchEvent', {'type':'touchEnd', 
         'touchPoints':[],  'modifiers':self._keyboard._modifiers})