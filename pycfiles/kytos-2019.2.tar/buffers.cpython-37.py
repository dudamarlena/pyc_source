...
# [GCC 8.4.0]
# Embedded file name: /Users/humberto/src/kytos/kytos-asyncio/kytos/core/buffers.py
# Compiled at: 2019-06-06 13:59:39
# Size of source mod 2**32: 5301 bytes
...
class KytosEventBuffer:
    __doc__ = 'KytosEventBuffer represents a queue to store a set of KytosEvents.'
    ...
    def put(self, event):
        ...
        if event.name == 'kytos/core.shutdown':
            LOG.info('[buffer: %s] Stop mode enabled. Rejecting new events.', self.name)
...
class KytosBuffers:
    __doc__ = 'Set of KytosEventBuffer used in Kytos.'
