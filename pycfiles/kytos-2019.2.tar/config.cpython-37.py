...
# [GCC 8.4.0]
# Embedded file name: /Users/humberto/src/kytos/kytos-asyncio/kytos/core/config.py
# Compiled at: 2019-12-09 19:34:21
# Size of source mod 2**32: 6399 bytes
...
class KytosConfig:
    __doc__ = 'Handle settings of Kytos.'
    ...
    def __init__(self):
        ...
        conf_parser.add_argument('-c', '--conf', help='Specify a config file',
          metavar='FILE')
        parser = ArgumentParser(prog='kytosd', parents=[
         conf_parser],
        ...
        parser.add_argument('-n', '--napps', action='store',
        ...
        parser.add_argument('-s', '--protocol_name', action='store',
          help='Specify the southbound protocol')
        parser.add_argument('-E', '--enable_entities_by_default', action='store_true',
          help='Enable all new Entities by default.')
        parser.add_argument('-C', '--create-superuser', action='store_true',
    ...
    def parse_args(self):
        ...
        defaults = {'pidfile':os.path.join(BASE_ENV, 'var/run/kytos/kytosd.pid'), 
         ...
         'installed_napps':os.path.join(BASE_ENV, 'var/lib/kytos/napps/', '.installed'), 
         ...
         'protocol_name':'', 
         'enable_entities_by_default':False, 
         'napps_pre_installed':[],  'vlan_pool':{},  'debug':False}
