...
# [GCC 8.4.0]
# Embedded file name: /home/zencity/clones/mongozen/mongozen/_version.py
# Compiled at: 2018-01-10 10:48:40
# Size of source mod 2**32: 18455 bytes
...
def get_config():
    ...
    cfg.style = 'pep440'
    cfg.tag_prefix = 'v'
    cfg.parentdir_prefix = 'mongozen-'
    cfg.versionfile_source = 'mongozen/_version.py'
    cfg.verbose = False
    return cfg
