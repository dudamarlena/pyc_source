...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/shuyucms/core/management/commands/runserver.py
# Compiled at: 2016-05-20 23:26:47
import platform, sys, django, shuyucms
...
def banner():
    ...
    lines = ("\n\n              .....\n          _d^^^^^^^^^b_\n       .d''           ``b.\n     .p'                `q.\n    .d'                   `b.\n   .d'                     `b.   * shuyucms %(shuyucms_version)s\n   ::                       ::   * Django %(django_version)s\n  ::    S H U Y U C M S    ::  * Python %(python_version)s\n   ::                       ::   * %(db_name)s %(db_version)s\n   `p.                     .q'   * %(os_name)s %(os_version)s\n    `p.                   .q'\n     `b.                 .d'\n       `q..          ..p'\n          ^q........p^\n              ''''\n\n\n" % {'shuyucms_version': shuyucms.__version__, 
