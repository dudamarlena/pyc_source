...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/shuyucms/generic/templatetags/keyword_tags.py
...
from shuyucms.generic.models import AssignedKeyword, Keyword
