...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/shuyucms/utils/device.py
# Compiled at: 2016-05-08 06:08:07
...
def templates_for_host(request, templates):
    ...
    for template in templates:
        ...
        elif b'default' in SUB_HOST:
            host_templates.append(b'%s/%s' % (SUB_HOST[b'default'], template))
