...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/shuyucms/generic/forms.py
# Compiled at: 2016-07-26 12:07:09
...
class KeywordsWidget(forms.MultiWidget):
    ...
    def __init__(self, attrs=None):
        ...
        """
        widgets = (
         forms.HiddenInput, forms.TextInput(attrs={b'class': b'vTextField'}))
        super(KeywordsWidget, self).__init__(widgets, attrs)
        self._ids = []

    def decompress(self, value):
        if value:
            the_string = re.split(b'[ ,，;；]', value)
