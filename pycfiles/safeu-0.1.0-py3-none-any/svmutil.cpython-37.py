...
# [GCC 8.4.0]
# Embedded file name: D:\文档\python\SafeU\safeu\libs\svmutil.py
...
__all__ = [
 'svm_load_model', 'svm_predict', 'svm_save_model', 'svm_train'] + svm_all + common_all
...
def svm_train(arg1, arg2=None, arg3=None, arg4=None):
    ...
    if isinstance(arg1, (list, tuple)) or scipy and isinstance(arg1, scipy.ndarray):
        if not isinstance(arg2, (list, tuple)):
            raise scipy and isinstance(arg2, (scipy.ndarray, sparse.spmatrix)) or AssertionError
        y, x, upbound, options = (
         arg1, arg2, arg3, arg4)
        param = svm_parameter(options)
        prob = svm_problem(y, x, upbound, isKernel=(param.kernel_type == PRECOMPUTED))
    else:
        if isinstance(arg1, svm_problem):
            prob = arg1
...
def svm_predict(y, x, m, options=''):
    ...
    if scipy and isinstance(x, scipy.ndarray):
        ...
        if sparse and isinstance(x, sparse.spmatrix):
            x = x.tocsr()
        else:
            if not isinstance(x, (list, tuple)):
                ...
                if scipy:
                    if not isinstance(y, scipy.ndarray):
                ...
                elif svm_type in (ONE_CLASS, EPSILON_SVR, NU_SVC):
                    nr_classifier = 1
                else:
            ...
            return (
             pred_labels, (ACC, MSE, SCC), pred_values)