...
# [GCC 8.4.0]
# Embedded file name: /Users/mikenawood/Code/shiftmanager/build/lib/shiftmanager/privileges.py
...
"""
import re
RELACL_CHARS_TO_WORDS = {'r': 'SELECT', 
   'w': 'UPDATE', 
   'a': 'INSERT', 
   'd': 'DELETE', 
   'R': 'RULE', 
   ...
   'C': 'CREATE', 
   'T': 'TEMPORARY'}
WITH_GRANT_OPTION_RE = re.compile('[arwdRxtXUCT]\\*')
