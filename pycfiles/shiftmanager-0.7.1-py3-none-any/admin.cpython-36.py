...
# [GCC 8.4.0]
# Embedded file name: /Users/mikenawood/Code/shiftmanager/build/lib/shiftmanager/mixins/admin.py
# Compiled at: 2018-08-02 14:56:31
# Size of source mod 2**32: 5356 bytes
import functools, random, string

def random_password(length=64):
    r"""Return a strong password valid for Redshift.
    ...
    * See `Redshift's CREATE USER docs
    ...
    invalid_chars = '`\\/\'"@ '
    valid_chars_set = set(string.digits + string.ascii_letters + string.punctuation) - set(invalid_chars)
...
class AdminMixin(object):
    __doc__ = 'User administration base class for `Redshift`.'
    ...
    def create_user(self, name, password, valid_until=None, createdb=False, createuser=False, groups=None, execute=False, **parameters):
    ...
    def alter_user(self, name, password=None, valid_until=None, createdb=None, createuser=None, rename=None, execute=False, **parameters):
