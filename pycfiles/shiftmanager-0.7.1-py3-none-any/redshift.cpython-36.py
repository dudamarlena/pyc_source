...
# Size of source mod 2**32: 4238 bytes
"""
...
class Redshift(AdminMixin, ReflectionMixin, PostgresMixin, S3Mixin):
    ...
    def connection(self):
        ...
        return (psycopg2.connect)(user=self.user, host=self.host, 
         port=self.port, 
         database=self.database, 
         password=self.password, **self.pgkwargs)
