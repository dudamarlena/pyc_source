...
# [GCC 8.4.0]
# Embedded file name: /home/jdunham/projects/didata_cli_jdunham/didata_cli/venv/lib/python2.7/site-packages/didata_cli/cli.py
# Compiled at: 2016-04-26 18:15:16
import click
...
class DiDataCLI(click.MultiCommand):
    ...
    def get_command(self, ctx, name):
        try:
            ...
            mod = __import__('didata_cli.commands.cmd_' + name, None, None, ['cli'])
        except ImportError:
            return
