...
# [GCC 8.4.0]
# Embedded file name: /Users/rgeda/project/repo/webbpsf/docs/exts/numfig.py
# Compiled at: 2019-11-21 17:41:08
...
def setup(app):
    ...
    app.add_node(page_ref, text=(
     skip_page_ref, None),
      html=(
     skip_page_ref, None),
      latex=(
     latex_visit_page_ref, None))
    app.add_role('page', XRefRole(nodeclass=page_ref))
    app.add_node(num_ref, latex=(
     latex_visit_num_ref, None))
