...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/restler/__init__.py
# Compiled at: 2012-10-26 16:41:55
...
class UnsupportedTypeError(Exception):
    ...
    def __init__(self, type_, msg=None):
        self.value = type_
        self.msg = "'%s' type needs to be handled explicitly.  There is no _standard_ way of handling this type. Consider using a callable that explicitly handles the field that uses this type." % self.value.__name__
