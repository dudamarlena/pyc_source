...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\datio\core.py
# Compiled at: 2012-02-12 14:57:57
"""
...
def format_values(values, atype, aformat=None):
    ...
    if atype == int:
        ...
        if aformat:
            results[:] = [ None if x is None else atype(str(x), aformat) for x in values ]
        else:
