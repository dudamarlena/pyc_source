...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/hs2client/genthrift/TCLIService/ttypes.py
...
class TProtocolVersion(object):
    ...
    _VALUES_TO_NAMES = {0: 'HIVE_CLI_SERVICE_PROTOCOL_V1', 
    ...
    _NAMES_TO_VALUES = {'HIVE_CLI_SERVICE_PROTOCOL_V1': 0, 
       'HIVE_CLI_SERVICE_PROTOCOL_V2': 1, 
       'HIVE_CLI_SERVICE_PROTOCOL_V3': 2, 
       'HIVE_CLI_SERVICE_PROTOCOL_V4': 3, 
       'HIVE_CLI_SERVICE_PROTOCOL_V5': 4, 
...
class TTypeId(object):
    ...
    _VALUES_TO_NAMES = {0: 'BOOLEAN_TYPE', 
       1: 'TINYINT_TYPE', 
       2: 'SMALLINT_TYPE', 
       3: 'INT_TYPE', 
       4: 'BIGINT_TYPE', 
    ...
    _NAMES_TO_VALUES = {'BOOLEAN_TYPE': 0, 
       'TINYINT_TYPE': 1, 
       'SMALLINT_TYPE': 2, 
       'INT_TYPE': 3, 
       'BIGINT_TYPE': 4, 
...
class TOperationState(object):
    ...
    PENDING_STATE = 7
    TIMEDOUT_STATE = 8
    _VALUES_TO_NAMES = {0: 'INITIALIZED_STATE', 
       1: 'RUNNING_STATE', 
       2: 'FINISHED_STATE', 
       3: 'CANCELED_STATE', 
       4: 'CLOSED_STATE', 
       ...
       7: 'PENDING_STATE', 
       8: 'TIMEDOUT_STATE'}
    _NAMES_TO_VALUES = {'INITIALIZED_STATE': 0, 
       'RUNNING_STATE': 1, 
       'FINISHED_STATE': 2, 
       'CANCELED_STATE': 3, 
       'CLOSED_STATE': 4, 
...
class TOperationType(object):
    ...
    GET_FUNCTIONS = 7
    UNKNOWN = 8
    _VALUES_TO_NAMES = {0: 'EXECUTE_STATEMENT', 
       1: 'GET_TYPE_INFO', 
       2: 'GET_CATALOGS', 
       3: 'GET_SCHEMAS', 
       4: 'GET_TABLES', 
       ...
       7: 'GET_FUNCTIONS', 
       8: 'UNKNOWN'}
    _NAMES_TO_VALUES = {'EXECUTE_STATEMENT': 0, 
       'GET_TYPE_INFO': 1, 
       'GET_CATALOGS': 2, 
       'GET_SCHEMAS': 3, 
       'GET_TABLES': 4, 
...
class TGetInfoType(object):
    ...
    _VALUES_TO_NAMES = {0: 'CLI_MAX_DRIVER_CONNECTIONS', 
    ...
    _NAMES_TO_VALUES = {'CLI_MAX_DRIVER_CONNECTIONS': 0, 
       'CLI_MAX_CONCURRENT_ACTIVITIES': 1, 
       'CLI_DATA_SOURCE_NAME': 2, 
       'CLI_FETCH_DIRECTION': 8, 
       'CLI_SERVER_NAME': 13, 
...
class TFetchOrientation(object):
    ...
    FETCH_FIRST = 4
    FETCH_LAST = 5
    _VALUES_TO_NAMES = {0: 'FETCH_NEXT', 
       1: 'FETCH_PRIOR', 
       2: 'FETCH_RELATIVE', 
       3: 'FETCH_ABSOLUTE', 
       4: 'FETCH_FIRST', 
       5: 'FETCH_LAST'}
    _NAMES_TO_VALUES = {'FETCH_NEXT': 0, 
       'FETCH_PRIOR': 1, 
       'FETCH_RELATIVE': 2, 
       'FETCH_ABSOLUTE': 3, 
       'FETCH_FIRST': 4, 
...
class TJobExecutionStatus(object):
    ...
    COMPLETE = 1
    NOT_AVAILABLE = 2
    _VALUES_TO_NAMES = {0: 'IN_PROGRESS', 
       1: 'COMPLETE', 
       2: 'NOT_AVAILABLE'}
    _NAMES_TO_VALUES = {'IN_PROGRESS': 0, 
       'COMPLETE': 1, 
       'NOT_AVAILABLE': 2}
...
TTypeQualifierValue.thrift_spec = (
 None,
 (
  1, TType.I32, 'i32Value', None, None),
 (
  2, TType.STRING, 'stringValue', 'UTF8', None))
all_structs.append(TTypeQualifiers)
TTypeQualifiers.thrift_spec = (
 None,
 (
  1, TType.MAP, 'qualifiers', (TType.STRING, 'UTF8', TType.STRUCT, [TTypeQualifierValue, None], False), None))
...
TPrimitiveTypeEntry.thrift_spec = (
 ...
 (
  2, TType.STRUCT, 'typeQualifiers', [TTypeQualifiers, None], None))
all_structs.append(TArrayTypeEntry)
TArrayTypeEntry.thrift_spec = (
 None,
 (
  1, TType.I32, 'objectTypePtr', None, None))
all_structs.append(TMapTypeEntry)
TMapTypeEntry.thrift_spec = (
 None,
 (
  1, TType.I32, 'keyTypePtr', None, None),
 (
  2, TType.I32, 'valueTypePtr', None, None))
all_structs.append(TStructTypeEntry)
TStructTypeEntry.thrift_spec = (
 None,
 (
  1, TType.MAP, 'nameToTypePtr', (TType.STRING, 'UTF8', TType.I32, None, False), None))
...
TUserDefinedTypeEntry.thrift_spec = (
 None,
 (
  1, TType.STRING, 'typeClassName', 'UTF8', None))
all_structs.append(TTypeEntry)
TTypeEntry.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'primitiveEntry', [TPrimitiveTypeEntry, None], None),
 (
  2, TType.STRUCT, 'arrayEntry', [TArrayTypeEntry, None], None),
 (
  3, TType.STRUCT, 'mapEntry', [TMapTypeEntry, None], None),
 (
  4, TType.STRUCT, 'structEntry', [TStructTypeEntry, None], None),
 (
  5, TType.STRUCT, 'unionEntry', [TUnionTypeEntry, None], None),
 (
  6, TType.STRUCT, 'userDefinedTypeEntry', [TUserDefinedTypeEntry, None], None))
all_structs.append(TTypeDesc)
TTypeDesc.thrift_spec = (
 None,
 (
  1, TType.LIST, 'types', (TType.STRUCT, [TTypeEntry, None], False), None))
all_structs.append(TColumnDesc)
TColumnDesc.thrift_spec = (
 None,
 (
  1, TType.STRING, 'columnName', 'UTF8', None),
 (
  2, TType.STRUCT, 'typeDesc', [TTypeDesc, None], None),
 (
  3, TType.I32, 'position', None, None),
 (
  4, TType.STRING, 'comment', 'UTF8', None))
all_structs.append(TTableSchema)
TTableSchema.thrift_spec = (
 None,
 (
  1, TType.LIST, 'columns', (TType.STRUCT, [TColumnDesc, None], False), None))
all_structs.append(TBoolValue)
TBoolValue.thrift_spec = (
 None,
 (
  1, TType.BOOL, 'value', None, None))
all_structs.append(TByteValue)
TByteValue.thrift_spec = (
 None,
 (
  1, TType.BYTE, 'value', None, None))
all_structs.append(TI16Value)
TI16Value.thrift_spec = (
 None,
 (
  1, TType.I16, 'value', None, None))
...
TDoubleValue.thrift_spec = (
 None,
 (
  1, TType.DOUBLE, 'value', None, None))
all_structs.append(TStringValue)
TStringValue.thrift_spec = (
 None,
 (
  1, TType.STRING, 'value', 'UTF8', None))
all_structs.append(TColumnValue)
TColumnValue.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'boolVal', [TBoolValue, None], None),
 (
  2, TType.STRUCT, 'byteVal', [TByteValue, None], None),
 (
  3, TType.STRUCT, 'i16Val', [TI16Value, None], None),
 (
  4, TType.STRUCT, 'i32Val', [TI32Value, None], None),
 (
  5, TType.STRUCT, 'i64Val', [TI64Value, None], None),
 (
  6, TType.STRUCT, 'doubleVal', [TDoubleValue, None], None),
 (
  7, TType.STRUCT, 'stringVal', [TStringValue, None], None))
all_structs.append(TRow)
TRow.thrift_spec = (
 None,
 (
  1, TType.LIST, 'colVals', (TType.STRUCT, [TColumnValue, None], False), None))
all_structs.append(TBoolColumn)
TBoolColumn.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.BOOL, None, False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
all_structs.append(TByteColumn)
TByteColumn.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.BYTE, None, False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TI16Column.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.I16, None, False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TI32Column.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.I32, None, False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TI64Column.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.I64, None, False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TDoubleColumn.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.DOUBLE, None, False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TStringColumn.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.STRING, 'UTF8', False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TBinaryColumn.thrift_spec = (
 None,
 (
  1, TType.LIST, 'values', (TType.STRING, 'BINARY', False), None),
 (
  2, TType.STRING, 'nulls', 'BINARY', None))
...
TColumn.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'boolVal', [TBoolColumn, None], None),
 (
  2, TType.STRUCT, 'byteVal', [TByteColumn, None], None),
 (
  3, TType.STRUCT, 'i16Val', [TI16Column, None], None),
 (
  4, TType.STRUCT, 'i32Val', [TI32Column, None], None),
 (
  5, TType.STRUCT, 'i64Val', [TI64Column, None], None),
 (
  6, TType.STRUCT, 'doubleVal', [TDoubleColumn, None], None),
 (
  7, TType.STRUCT, 'stringVal', [TStringColumn, None], None),
 (
  8, TType.STRUCT, 'binaryVal', [TBinaryColumn, None], None))
all_structs.append(TRowSet)
TRowSet.thrift_spec = (
 None,
 (
  1, TType.I64, 'startRowOffset', None, None),
 (
  2, TType.LIST, 'rows', (TType.STRUCT, [TRow, None], False), None),
 (
  3, TType.LIST, 'columns', (TType.STRUCT, [TColumn, None], False), None),
 (
  4, TType.STRING, 'binaryColumns', 'BINARY', None),
 (
  5, TType.I32, 'columnCount', None, None))
all_structs.append(TStatus)
TStatus.thrift_spec = (
 None,
 (
  1, TType.I32, 'statusCode', None, None),
 (
  2, TType.LIST, 'infoMessages', (TType.STRING, 'UTF8', False), None),
 (
  3, TType.STRING, 'sqlState', 'UTF8', None),
 (
  4, TType.I32, 'errorCode', None, None),
 (
  5, TType.STRING, 'errorMessage', 'UTF8', None))
all_structs.append(THandleIdentifier)
THandleIdentifier.thrift_spec = (
 None,
 (
  1, TType.STRING, 'guid', 'BINARY', None),
 (
  2, TType.STRING, 'secret', 'BINARY', None))
all_structs.append(TSessionHandle)
TSessionHandle.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'sessionId', [THandleIdentifier, None], None))
all_structs.append(TOperationHandle)
TOperationHandle.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'operationId', [THandleIdentifier, None], None),
 (
  2, TType.I32, 'operationType', None, None),
 (
  3, TType.BOOL, 'hasResultSet', None, None),
 (
  4, TType.DOUBLE, 'modifiedRowCount', None, None))
all_structs.append(TOpenSessionReq)
TOpenSessionReq.thrift_spec = (
 None,
 (
  1, TType.I32, 'client_protocol', None, 9),
 (
  2, TType.STRING, 'username', 'UTF8', None),
 (
  3, TType.STRING, 'password', 'UTF8', None),
 (
  4, TType.MAP, 'configuration', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None))
all_structs.append(TOpenSessionResp)
TOpenSessionResp.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.I32, 'serverProtocolVersion', None, 9),
 (
  3, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None),
 (
  4, TType.MAP, 'configuration', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None))
...
TGetInfoValue.thrift_spec = (
 None,
 (
  1, TType.STRING, 'stringValue', 'UTF8', None),
 (
  2, TType.I16, 'smallIntValue', None, None),
 (
  3, TType.I32, 'integerBitmask', None, None),
 (
  4, TType.I32, 'integerFlag', None, None),
 (
  5, TType.I32, 'binaryValue', None, None),
 (
  6, TType.I64, 'lenValue', None, None))
...
TGetInfoReq.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None),
 (
  2, TType.I32, 'infoType', None, None))
...
TGetInfoResp.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.STRUCT, 'infoValue', [TGetInfoValue, None], None))
...
TExecuteStatementReq.thrift_spec = (
 ...
 (
  3, TType.MAP, 'confOverlay', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None),
 (
  4, TType.BOOL, 'runAsync', None, False),
 (
  5, TType.I64, 'queryTimeout', None, 0))
...
TExecuteStatementResp.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None))
...
TGetSchemasReq.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None),
 (
  2, TType.STRING, 'catalogName', 'UTF8', None),
 (
  3, TType.STRING, 'schemaName', 'UTF8', None))
...
TGetTablesReq.thrift_spec = (
 ...
 (
  3, TType.STRING, 'schemaName', 'UTF8', None),
 (
  4, TType.STRING, 'tableName', 'UTF8', None),
 (
  5, TType.LIST, 'tableTypes', (TType.STRING, 'UTF8', False), None))
...
TGetColumnsReq.thrift_spec = (
 ...
 (
  4, TType.STRING, 'tableName', 'UTF8', None),
 (
  5, TType.STRING, 'columnName', 'UTF8', None))
...
TGetFunctionsReq.thrift_spec = (
 ...
 (
  3, TType.STRING, 'schemaName', 'UTF8', None),
 (
  4, TType.STRING, 'functionName', 'UTF8', None))
...
TGetCrossReferenceReq.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None),
 (
  2, TType.STRING, 'parentCatalogName', 'UTF8', None),
 (
  3, TType.STRING, 'parentSchemaName', 'UTF8', None),
 (
  4, TType.STRING, 'parentTableName', 'UTF8', None),
 (
  5, TType.STRING, 'foreignCatalogName', 'UTF8', None),
 (
  6, TType.STRING, 'foreignSchemaName', 'UTF8', None),
 (
  7, TType.STRING, 'foreignTableName', 'UTF8', None))
...
TGetOperationStatusReq.thrift_spec = (
 None,
 (
  1, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None),
 (
  2, TType.BOOL, 'getProgressUpdate', None, None))
...
TGetOperationStatusResp.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.I32, 'operationState', None, None),
 (
  3, TType.STRING, 'sqlState', 'UTF8', None),
 (
  4, TType.I32, 'errorCode', None, None),
 (
  5, TType.STRING, 'errorMessage', 'UTF8', None),
 (
  6, TType.STRING, 'taskStatus', 'UTF8', None),
 (
  7, TType.I64, 'operationStarted', None, None),
 (
  8, TType.I64, 'operationCompleted', None, None),
 (
  9, TType.BOOL, 'hasResultSet', None, None),
 (
  10, TType.STRUCT, 'progressUpdateResponse', [TProgressUpdateResp, None], None))
...
TGetResultSetMetadataResp.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.STRUCT, 'schema', [TTableSchema, None], None))
...
TFetchResultsReq.thrift_spec = (
 ...
 (
  3, TType.I64, 'maxRows', None, None),
 (
  4, TType.I16, 'fetchType', None, 0))
...
TFetchResultsResp.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.BOOL, 'hasMoreRows', None, None),
 (
  3, TType.STRUCT, 'results', [TRowSet, None], None))
...
TGetDelegationTokenReq.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None),
 (
  2, TType.STRING, 'owner', 'UTF8', None),
 (
  3, TType.STRING, 'renewer', 'UTF8', None))
...
TGetDelegationTokenResp.thrift_spec = (
 ...
 (
  1, TType.STRUCT, 'status', [TStatus, None], None),
 (
  2, TType.STRING, 'delegationToken', 'UTF8', None))
...
TProgressUpdateResp.thrift_spec = (
 None,
 (
  1, TType.LIST, 'headerNames', (TType.STRING, 'UTF8', False), None),
 (
  2, TType.LIST, 'rows', (TType.LIST, (TType.STRING, 'UTF8', False), False), None),
 (
  3, TType.DOUBLE, 'progressedPercentage', None, None),
 (
  4, TType.I32, 'status', None, None),
 (
  5, TType.STRING, 'footerSummary', 'UTF8', None),
 (
  6, TType.I64, 'startTime', None, None))
