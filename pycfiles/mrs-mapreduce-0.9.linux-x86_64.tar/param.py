...
# [GCC 8.4.0]
# Embedded file name: /home/amcnabb/python/mrs/param.py
# Compiled at: 2012-10-17 16:09:03
...
class Param(object):
    ...
    def __init__(self, default=NotSpecified, type=NotSpecified, doc=NotSpecified, shortopt=NotSpecified):
...
class _ParamMeta(type):
    ...
    def __new__(cls, classname, bases, classdict):
        ...
        docs = [ '%s: %s (default=%s)' % (name, param.doc, param.default) for name, param in params.items() ]
        docs.sort()
    ...
    def extend(self, opt_str, value, values, parser):
        ...
        if value is None:
            ...
            for base in self.search or []:
                try:
                    ...
                    if msg.startswith('No module named '):
                        ...
                        if full_name.endswith(errname) or all_but_last.endswith(errname):
                            pass
                        else:
                            raise
                ...
                try:
                    ...
                    msg = e.args[0]
                    if no_attribute_msg is None and msg.startswith('No attribute named '):
            ...
            if not issubclass(paramcls, ParamObj):
                err = 'Class %s sets _params without inheriting from ParamObj' % paramcls.__name__
...
class _Rabbit(ParamObj):
    ...
    burrows in the earth.
    """
    _params = dict(weight=Param(default=42, doc='Body Weight', type='int'), a_b_c=Param(default='hello', doc='A param with underscores'))
