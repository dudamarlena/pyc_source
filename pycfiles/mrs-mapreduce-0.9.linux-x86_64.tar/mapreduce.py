...
# [GCC 8.4.0]
# Embedded file name: /home/amcnabb/python/mrs/mapreduce.py
# Compiled at: 2012-11-12 15:22:19
...
class MapReduce(object):
    ...
    def make_reduce_data(self, job, interm_data):
        outdir = self.output_dir()
        output_data = job.reduce_data(interm_data, self.reduce, outdir=outdir, format=fileformats.TextWriter)
        return output_data
