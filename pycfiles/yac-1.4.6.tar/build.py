...
# [GCC 8.4.0]
# Embedded file name: /Users/x0ox/Dropbox/ActiveDev/yac/yac/lib/container/build.py
...
def build_image(image_tag, sources_path, connection_str='', rm='false', buildargs={}):
    print 'Getting docker client for connection_str=%s' % connection_str
    docker_client = get_docker_client(connection_str)
    for line in docker_client.build(tag=image_tag, path=sources_path, rm=rm, buildargs=buildargs):
