...
# [GCC 8.4.0]
# Embedded file name: /Users/x0ox/Dropbox/ActiveDev/yac/yac/lib/file_converter.py
...
def find_and_convert_locals_leaf(dict_leaf, local_key, local_base_path, challenge):
    if os.path.exists(os.path.join(local_base_path, str(dict_leaf))) and os.path.isfile(os.path.join(local_base_path, str(dict_leaf))) and not os.path.isabs(str(dict_leaf)):
