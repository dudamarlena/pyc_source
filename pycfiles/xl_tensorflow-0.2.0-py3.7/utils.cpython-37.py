...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\xl_tensorflow\models\yolov3\utils.py
# Compiled at: 2020-04-05 21:28:48
# Size of source mod 2**32: 11779 bytes
...
def preprocess_true_boxes(true_boxes, input_shape, anchors, num_classes):
    ...
    """
    assert (true_boxes[(Ellipsis, 4)] < num_classes).all(), 'class id must be less than num_classes'
