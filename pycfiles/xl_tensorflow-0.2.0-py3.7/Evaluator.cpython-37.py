...
# Compiled at: 2020-04-17 23:16:16
# Size of source mod 2**32: 23775 bytes
import os, sys
...
from .utils import *
from xl_tool.augmentation.image.general.annonation import get_bndbox
...
def voc2ratxt(xml_file, box_format='xywh'):
    ...
    boxes = [[box['annonation_class'], *box['coordinates']] for box in boxes]
    if box_format == 'xywh':
        for box in boxes:
            x, y = box[1:3]
