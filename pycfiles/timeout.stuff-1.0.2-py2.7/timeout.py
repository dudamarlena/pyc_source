...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/timeout.py
# Compiled at: 2016-12-07 00:18:11
...
def of(seconds):
    ...
    """
    signal.signal(signal.SIGALRM, _raise_timeout(('Maximum timeout of {}s reached').format(seconds)))
