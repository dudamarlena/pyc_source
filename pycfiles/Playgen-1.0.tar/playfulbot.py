...
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/command_line/playfulbot.py
# Compiled at: 2014-04-04 05:21:30
...
def main():
    ...
    cyan_ini = Fore.CYAN
    cyan_end = Fore.RESET
    argument_parser = argparse.ArgumentParser(description='Autoapuestas en ' + 'Playfulbet')
    argument_parser.add_argument('-m', '--tasamin', help='Realizar apuestas ' + 'menores (cantidad de coins establecidas con [coins_min](200 por defecto)) ' + ' a tasas inferiores o iguales a 1.2. Esta opción solo se activa si se ' + 'apuesta 800 o más coins.', action='store_true')
    ...
    argument_parser.add_argument('coins', nargs='?', default='200', help='Numero de monedas a apostar. Por defecto 200', type=int)
    argument_parser.add_argument('coins_min', nargs='?', default='200', help='Numero de monedas a apostar a las tasas inferiores a 1.2 ' + '(incluidas). Por defecto 200', type=int)
    ...
    try:
        ...
        mbrowser.addheaders = [
         ('User-agent', 'Mozilla/5.0 (X11; U; \t\tLinux i686; es-ES; rv:1.9.0.1) Gecko/2008071615 Fedora/3.0.1-1.fc9 Firefox/3.0.1')]
        ...
        if connected:
            try:
                ...
                if int(coins_arg > 800) and tasa_min_arg:
                    ...
                    print
                    print cyan_ini + 'Se realizarán', bet_max,
                    print 'apuestas de ' + str(coins_arg) + ' coins y', bet_min,
                    print 'apuestas de ' + str(coins_min_arg) + ' coins' + cyan_end
                    print
                else:
                    bet_num = int(coins) // int(coins_arg)
                    print
                    print cyan_ini + 'Se realizarán', bet_num,
                    print 'apuestas de ' + str(coins_arg) + ' coins' + cyan_end
                    print
                if bet_num > 0:
                    print 'Apuestas:'
                if bet_num > 0:
