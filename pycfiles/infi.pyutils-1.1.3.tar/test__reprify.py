...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/Infinidat/infi.pyutils/tests/test__reprify.py
...
class ReprifyTest(TestCase):
    ...
    def test__method_calls(self):
        for method_name in ('method', 'classmethod', 'staticmethod'):
            self.assertEquals(getattr(self.obj, method_name)(), getattr(self.original_object, method_name)(), '%r not relayed' % (method_name,))
