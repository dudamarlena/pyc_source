...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/Infinidat/infi.pyutils/tests/test__function_signature.py
...
class SignatureTest(TestCase):
    ...
    def _test_function_signature(self, func, expected_signature, has_varargs=False, has_varkwargs=False):
        ...
        for expected_arg, arg in zip(expected_signature, sig._args):
            ...
            self.assertEquals(expected_arg.name, arg.name)
            self.assertEquals(expected_arg.has_default, arg.has_default())
    ...
    def test__get_normalized_kwargs(self):
        ...
        self.assertEquals(sig.get_normalized_args((1, 2, 3), {}), dict(a=1, b=2, c=3))
