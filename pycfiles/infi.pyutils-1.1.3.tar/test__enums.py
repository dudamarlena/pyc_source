...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/Infinidat/infi.pyutils/tests/test__enums.py
...
class VersionedValueTest(TestCase):
    ...
    def versioned_value(self):
        return Value('avg', {'1.0': ['AVERAGE', 'average', 'Average'], '1.0.1': [
                   'Average', 'AVG'], 
           '2.0': [
                 'Average', 'avg']})
    ...
    def test_versioned_value(self):
        ...
        assert versioned_value.as_version('1.0') != 'avg'
...
class VersionedEnumTest(TestCase):
    ...
    def versioned_enum(self):
        return Enum(Value('one', {'1.0': ['One'], '2.0': [
                 '1', 1, 'One'], 
           '2.5': [
                 '1', 1]}), Value('two', {'2.0': ['2', 2, 'Two'], '2.5': [
                 '2', 2]}))
...
class EnumTestCase(TestCase):
    ...
    def test__get_value_name(self):
        input_values = [
         'CamelCase', 'lower_case', 'UPPER_CASE']
