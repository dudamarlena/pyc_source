...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-4yaip7h6/qcrash/qcrash/_dialogs/report.py
...
class DlgReport(QtWidgets.QDialog):
    ...
    def __init__(self, backends, window_title='Report an issue...', window_icon=None, traceback=None, issue_title='', issue_description='', include_log=True, include_sys_info=True, **kwargs):
        ...
        self.setWindowIcon(QtGui.QIcon.fromTheme('tools-report-bug') if window_icon is None else window_icon)
    ...
    def _on_button_clicked(self):
        ...
        title = backend.formatter.format_title(str(self.ui.lineEditTitle.text()))
        sys_info = None
        ...
        body = backend.formatter.format_body(str(description), sys_info, self._traceback)
        if backend.need_review:
