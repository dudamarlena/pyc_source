...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/ruby.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 22135 bytes
"""
...
class RubyLexer(ExtendedRegexLexer):
    ...
    tokens = {'root': [
       ...
       'protected', 'true', 'false', 'nil'), suffix='\\b'),
               Keyword.Pseudo),
              (
       ...
       'protected_method_defined', 'public_method_defined', 'respond_to', 'tainted'), suffix='\\?'),
               Name.Builtin),
              (
       ...
       'throw', 'to_a', 'to_s', 'trace_var', 'trap', 'untaint', 'untrace_var', 'warn'), prefix='(?<!\\.)', suffix='\\b'),
               Name.Builtin),
              (
...
class FancyLexer(RegexLexer):
    ...
    tokens = {'balanced-regex': [
     ...
     'root': [
       ...
       'Tuple', 'Symbol', 'Stack', 'Set', 'FancySpec', 'Method', 'Package', 'Range'), suffix='\\b'),
               Name.Builtin),
              (
