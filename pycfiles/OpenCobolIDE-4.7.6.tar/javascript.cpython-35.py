...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/javascript.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 57129 bytes
"""
...
class LassoLexer(RegexLexer):
    ...
    tokens = {'root': [
              ...
              (
               '\\[noprocess\\]', Comment.Preproc, ('delimiters', 'noprocess')),
              (
               '\\[', Comment.Preproc, ('delimiters', 'squarebrackets')),
              (
               '<\\?(LassoScript|lasso|=)', Comment.Preproc,
     ...
     'delimiters': [
                    ...
                    (
                     '<\\?(LassoScript|lasso|=)', Comment.Preproc, 'anglebrackets'),
                    (
                     '<(!--.*?-->)?', Other),
                    (
                     '[^[<]+', Other)], 
     ...
     'lasso': [
               ...
               (
                '#([a-z_][\\w.]*|\\d+)', Name.Variable.Instance),
               (
                "(\\.\\s*)('[a-z_][\\w.]*')",
...
class EarlGreyLexer(RegexLexer):
    ...
    tokens = {'root': [
              ...
              include('errors'),
              (
               words(('with', 'where', 'when', 'and', 'not', 'or', 'in', 'as', 'of', 'is'), prefix='(?<=\\s|\\[)', suffix='(?![\\w\\$\\-])'),
               Operator.Word),
              (
               '[\\*@]?->', Name.Function),
              (
              ...
              (
               '(?<=[\\s\\[\\{\\(,;])\\.([a-zA-Z$_](?:[a-zA-Z$0-9_-]*[a-zA-Z$0-9_])?)(?=[\\s\\]\\}\\),;])',
               String.Symbol),
              include('nested'),
              (
     ...
     'assignment': [
                    (
                     '(\\.)?([a-zA-Z$_](?:[a-zA-Z$0-9_-]*[a-zA-Z$0-9_])?)(?=\\s+[+\\-*/~^<>%&|?!@#.]*\\=\\s)',
                     bygroups(Punctuation, Name.Variable))], 
     
     'errors': [
                (
                 words(('Error', 'TypeError', 'ReferenceError'), prefix='(?<![\\w\\$\\-\\.])', suffix='(?![\\w\\$\\-\\.])'),
                 Name.Exception),
                (
                 '(?x)\n                (?<![\\w\\$])\n                E\\.[\\w\\$](?:[\\w\\$\\-]*[\\w\\$])?\n                (?:\\.[\\w\\$](?:[\\w\\$\\-]*[\\w\\$])?)*\n                (?=[\\(\\{\\[\\?\\!\\s])',
                 Name.Exception)], 
     ...
     'keywords': [
       ...
       'async', 'method', 'gen'), prefix='(?<![\\w\\$\\-\\.])', suffix='(?![\\w\\$\\-\\.])'),
                   Keyword.Pseudo),
                  (
                   words(('this', 'self', '@'), prefix='(?<![\\w\\$\\-\\.])', suffix='(?![\\w\\$\\-])'),
                   Keyword.Constant),
                  (
                   words(('Function', 'Object', 'Array', 'String', 'Number', 'Boolean', 'ErrorFactory',
       'ENode', 'Promise'), prefix='(?<![\\w\\$\\-\\.])', suffix='(?![\\w\\$\\-])'),
                   Keyword.Type)], 
     ...
     'builtins': [
       ...
       'consume', 'take', 'promisify', 'spawn', 'constructor'), prefix='(?<![\\w\\-#\\.])', suffix='(?![\\w\\-\\.])'),
                   Name.Builtin),
                  (
                   words(('true', 'false', 'null', 'undefined'), prefix='(?<![\\w\\$\\-\\.])', suffix='(?![\\w\\$\\-\\.])'),
                   Name.Constant)], 
     
     'name': [
              (
               '@([a-zA-Z$_](?:[a-zA-Z$0-9_-]*[a-zA-Z$0-9_])?)', Name.Variable.Instance),
              (
               '([a-zA-Z$_](?:[a-zA-Z$0-9_-]*[a-zA-Z$0-9_])?)(\\+\\+|\\-\\-)?',
     ...
     'numbers': [
                 ...
                 (
                  '([3-79]|[1-2][0-9]|3[0-6])r[a-zA-Z\\d]+(\\.[a-zA-Z\\d]+)?', Number.Radix),
                 (
                  '\\d+', Number.Integer)]}