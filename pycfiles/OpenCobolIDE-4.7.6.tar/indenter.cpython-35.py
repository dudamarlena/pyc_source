...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.core/pyqode/core/modes/indenter.py
# Compiled at: 2016-12-29 05:31:31
# Size of source mod 2**32: 6218 bytes
"""
...
class IndenterMode(Mode):
    ...
    def unindent_selection(self, cursor):
        ...
        while i < nb_lines:
            ...
            debug('self.editor.use_spaces_instead_of_tabs: %r', self.editor.use_spaces_instead_of_tabs)
            if self.editor.use_spaces_instead_of_tabs:
