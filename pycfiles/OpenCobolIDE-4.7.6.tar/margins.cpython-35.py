...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.cobol/pyqode/cobol/modes/margins.py
    ...
    def _paint_margins(self, event):
        ...
        for pos, pen in zip(self._positions, self._pens):
            if pos < 0:
                ...
                painter.setPen(pen)
                painter.drawLine(x_pos, 0, x_pos, 65536)

    def _on_key_pressed(self, event):
        Qt = QtCore.Qt
        modifier_match = int(event.modifiers()) == Qt.ControlModifier + Qt.AltModifier
