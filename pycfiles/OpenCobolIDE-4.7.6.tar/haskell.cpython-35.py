...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/haskell.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 31003 bytes
"""
...
"""
import re
from pygments.lexer import Lexer, RegexLexer, bygroups, do_insertions, default, include
from pygments.token import Text, Comment, Operator, Keyword, Name, String, Number, Punctuation, Generic
from pygments import unistring as uni
__all__ = [
 'HaskellLexer', 'IdrisLexer', 'AgdaLexer', 'CryptolLexer',
...
class HaskellLexer(RegexLexer):
    ...
    reserved = ('case', 'class', 'data', 'default', 'deriving', 'do', 'else', 'if',
