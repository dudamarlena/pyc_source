...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/go.py
...
class GoLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       'fallthrough', 'if', 'range', 'continue', 'for', 'return'), suffix='\\b'),
               Keyword),
              (
       ...
       'delete', 'new', 'make'), suffix='\\b(\\()'),
               bygroups(Name.Builtin, Punctuation)),
              (
               words(('uint', 'uint8', 'uint16', 'uint32', 'uint64', 'int', 'int8', 'int16', 'int32',
       'int64', 'float', 'float32', 'float64', 'complex64', 'complex128', 'byte',
       'rune', 'string', 'bool', 'error', 'uintptr'), suffix='\\b'),
               Keyword.Type),
              (
               '\\d+i', Number),
              (
