...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/j.py
...
class JLexer(RegexLexer):
    ...
    tokens = {'root': [
              ...
              (
               '\\b(([1-4]|13)\\s+:\\s*0)|((adverb|conjunction|dyad|monad|verb)\\s+define)\\b',
       ...
       'while', 'whilst'), suffix='\\.'), Name.Label),
              (
       ...
       'isatty', 'isutf8', 'items', 'leaf', 'list', 'nameclass', 'namelist', 'namelist',
       'names', 'nc', 'nl', 'on', 'pick', 'pick', 'rows', 'script', 'scriptd', 'sign',
       'sminfo', 'smoutput', 'sort', 'split', 'stderr', 'stdin', 'stdout', 'table',
       'take', 'timespacex', 'timex', 'tmoutput', 'toCRLF', 'toHOST', 'toJ', 'tolower',
       'toupper', 'type', 'ucp', 'ucpcount', 'usleep', 'utf8', 'uucp')),
               Name.Function),
              (
               '=[.:]', Operator),
              (
