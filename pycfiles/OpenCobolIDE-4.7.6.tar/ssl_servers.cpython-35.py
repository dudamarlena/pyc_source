...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.5/site-packages/future/backports/test/ssl_servers.py
...
class StatsRequestHandler(BaseHTTPRequestHandler):
    __doc__ = 'Example HTTP request handler which returns SSL statistics on GET\n    requests.\n    '
    ...
    def do_GET(self, send_body=True):
        ...
        stats = {'session_cache': context.session_stats(), 
         'cipher': sock.cipher(), 
