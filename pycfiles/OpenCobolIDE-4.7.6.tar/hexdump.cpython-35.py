...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/hexdump.py
...
class HexdumpLexer(RegexLexer):
    ...
    tokens = {'root': [
              ...
              include('offset'),
              (
               '(' + hd + '{2})(\\-)(' + hd + '{2})', bygroups(Number.Hex, Punctuation, Number.Hex)),
              (
               hd + '{2}', Number.Hex),
              (
               '(\\s{2,3})(\\>)(.{16})(\\<)$', bygroups(Text, Punctuation, String, Punctuation), 'bracket-strings'),
              (
               '(\\s{2,3})(\\|)(.{16})(\\|)$', bygroups(Text, Punctuation, String, Punctuation), 'piped-strings'),
              (
               '(\\s{2,3})(\\>)(.{1,15})(\\<)$', bygroups(Text, Punctuation, String, Punctuation)),
              (
               '(\\s{2,3})(\\|)(.{1,15})(\\|)$', bygroups(Text, Punctuation, String, Punctuation)),
              (
     ...
     'piped-strings': [
                       ...
                       (
                        hd + '{2}', Number.Hex),
                       (
                        '(\\s{2,3})(\\|)(.{1,16})(\\|)$', bygroups(Text, Punctuation, String, Punctuation)),
                       (
                        '\\s', Text),
                       (
                        '^\\*', Punctuation)], 
