...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/roboconf.py
...
class RoboconfGraphLexer(RegexLexer):
    ...
    tokens = {'root': [
              ...
              (
               words(('installer', 'extends', 'exports', 'imports', 'facets', 'children'), suffix='\\s*:?', prefix='\\b'), Name),
              (
               '#.*\\n', Comment),
              (
               '[^#]', Text),
