...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/algebra.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 7216 bytes
"""
...
class BCLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       'auto', 'print', 'read', 'length', 'scale', 'sqrt', 'limits', 'quit', 'warranty'), suffix='\\b'), Keyword),
              (
               '\\+\\+|--|\\|\\||&&|([-<>+*%\\^/!=])=?',
               Operator),
              (
