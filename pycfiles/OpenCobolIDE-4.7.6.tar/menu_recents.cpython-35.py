...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.core/pyqode/core/widgets/menu_recents.py
# Compiled at: 2016-12-29 05:31:31
# Size of source mod 2**32: 6960 bytes
"""
    ...
    def get_recent_files(self):
        ...
        for file in files:
            if file is not None and os.path.exists(file):
                if os.path.ismount(file) and sys.platform == 'win32' and not file.endswith('\\'):
                    file += '\\'
...
class MenuRecentFiles(QtWidgets.QMenu):
    ...
    def __init__(self, parent, recent_files_manager=None, title='Recent files', icon_provider=None, clear_icon=None):
        """
