...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/tcl.py
...
class TclLexer(RegexLexer):
    ...
    keyword_cmds_re = words(('after', 'apply', 'array', 'break', 'catch', 'continue',
                             ...
                             'uplevel', 'upvar', 'variable', 'vwait', 'while'), prefix='\\b', suffix='\\b')
    builtin_cmds_re = words(('append', 'bgerror', 'binary', 'cd', 'chan', 'clock',
                             ...
                             'tell', 'time', 'tm', 'unknown', 'unload'), prefix='\\b', suffix='\\b')
    name = 'Tcl'
    aliases = ['tcl']
    filenames = ['*.tcl', '*.rvt']
