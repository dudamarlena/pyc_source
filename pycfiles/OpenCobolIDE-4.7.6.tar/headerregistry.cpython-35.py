...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.5/site-packages/future/backports/email/headerregistry.py
# Compiled at: 2016-10-27 16:05:38
# Size of source mod 2**32: 20637 bytes
...
class ParameterizedMIMEHeader(object):
    ...
    def parse(cls, value, kwds):
        ...
        if parse_tree.params is None:
            ...
            kwds['params'] = dict((utils._sanitize(name).lower(), utils._sanitize(value)) for name, value in parse_tree.params)
