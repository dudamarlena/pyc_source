...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/OpenCobolIDE/open_cobol_ide/extlibs/enum.py
# Compiled at: 2016-12-30 07:02:58
...
class Enum(metaclass=EnumMeta):
    ...
    def __dir__(self):
        added_behavior = [m for cls in self.__class__.mro() if m[0] != '_' and m not in self._member_map_ for m in cls]
        return [
