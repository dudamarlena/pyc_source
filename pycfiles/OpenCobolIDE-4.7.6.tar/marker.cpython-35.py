...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.core/pyqode/core/panels/marker.py
    ...
    def icon(self):
        ...
        if isinstance(self._icon, str):
            ...
            if isinstance(self._icon, tuple):
                return QtGui.QIcon.fromTheme(self._icon[0], QtGui.QIcon(self._icon[1]))
    ...
    def mouseMoveEvent(self, event):
        ...
        if len(markers):
            if self._previous_line != line:
                top = TextHelper(self.editor).line_pos_from_number(markers[0].position)
                if top:
