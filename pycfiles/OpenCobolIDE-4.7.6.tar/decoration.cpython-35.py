...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.core/pyqode/core/api/decoration.py
...
class TextDecoration(QtWidgets.QTextEdit.ExtraSelection):
    ...
    def __init__(self, cursor_or_bloc_or_doc, start_pos=None, end_pos=None, start_line=None, end_line=None, draw_order=0, tooltip=None, full_width=False):
        """
