...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/hdl.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 18699 bytes
"""
    pygments.lexers.hdl
    ~~~~~~~~~~~~~~~~~~~
...
class VerilogLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       'remove_netnames', 'resetall', 'timescale', 'unconnected_drive', 'undef'), prefix='`', suffix='\\b'),
               Comment.Preproc),
              (
...
class SystemVerilogLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       'weak1', 'while', 'wildcard', 'wire', 'with', 'within', 'wor', 'xnor', 'xor'), suffix='\\b'),
               Keyword),
              (
       ...
       '`resetall', '`timescale', '`unconnected_drive', '`undef', '`undefineall'), suffix='\\b'),
               Comment.Preproc),
              (
       ...
       '$write', '$writeb', '$writeh', '$writememb', '$writememh', '$writeo'), suffix='\\b'),
               Name.Builtin),
              (
