...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/dsls.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 26226 bytes
"""
...
"""
import re
from pygments.lexer import RegexLexer, bygroups, words, include, default, this, using, combined
...
class ProtoBufLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       'ctype', 'extensions', 'to', 'max', 'rpc', 'returns', 'oneof'), prefix='\\b', suffix='\\b'),
               Keyword),
              (
               words(('int32', 'int64', 'uint32', 'uint64', 'sint32', 'sint64', 'fixed32', 'fixed64',
       'sfixed32', 'sfixed64', 'float', 'double', 'bool', 'string', 'bytes'), suffix='\\b'),
               Keyword.Type),
              (
...
class ThriftLexer(RegexLexer):
    ...
    tokens = {'root': [
              ...
              (
               '[:;\\,\\{\\}\\(\\)\\<>\\[\\]]', Punctuation),
              (
               '[a-zA-Z_](\\.[a-zA-Z_0-9]|[a-zA-Z_0-9])*', Name)], 
     ...
     'namespace': [
                   (
                    '[a-z\\*](\\.[a-zA-Z_0-9]|[a-zA-Z_0-9])*', Name.Namespace, '#pop'),
                   default('#pop')], 
     ...
     'keywords': [
       ...
       'xsd_nillable', 'xsd_namespace', 'xsd_attrs', 'include'), suffix='\\b'),
                   Keyword.Namespace),
                  (
                   words(('void', 'bool', 'byte', 'i16', 'i32', 'i64', 'double', 'string', 'binary', 'void',
       'map', 'list', 'set', 'slist', 'senum'), suffix='\\b'),
                   Keyword.Type),
                  (
       ...
       'when', 'while', 'with', 'xor', 'yield'), prefix='\\b', suffix='\\b'),
                   Keyword.Reserved)], 
...
class PuppetLexer(RegexLexer):
    ...
    tokens = {'root': [
     ...
     'keywords': [
       ...
       'zfs', 'zone', 'zpool'), prefix='(?i)', suffix='\\b'),
                   Keyword)], 
...
class RslLexer(RegexLexer):
    ...
    tokens = {'root': [
       ...
       '-infset', '-list', '-set'), prefix='\\b', suffix='\\b'),
               Keyword),
              (
...
class PanLexer(RegexLexer):
    ...
    tokens = {'root': [
     ...
     'basic': [
       ...
       'structure', 'extensible', 'declaration'), prefix='\\b', suffix='\\s*\\b'),
                Keyword),
               (
       ...
       'path_exists', 'if_exists', 'return', 'value'), prefix='\\b', suffix='\\s*\\b'),
                Name.Builtin),
               (
                '#.*', Comment),
               (
