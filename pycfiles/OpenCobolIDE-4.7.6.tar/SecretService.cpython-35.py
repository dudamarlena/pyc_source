...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/OpenCobolIDE/open_cobol_ide/extlibs/keyring/backends/SecretService.py
# Compiled at: 2016-12-30 07:03:10
# Size of source mod 2**32: 2893 bytes
import logging
from ..util import properties
from ..backend import KeyringBackend
from ..errors import InitError, PasswordDeleteError, ExceptionRaisedContext
try:
    import secretstorage, secretstorage.exceptions as exceptions
except ImportError:
    pass
...
class Keyring(KeyringBackend):
    __doc__ = 'Secret Service Keyring'
    ...
    def get_password(self, service, username):
        ...
        for item in items:
            if hasattr(item, 'unlock') and item.is_locked() and item.unlock()[0]:
    ...
    def set_password(self, service, username, password):
        ...
        """
        collection = self.get_default_collection()
        attributes = {'application': 'python-keyring', 
         'service': service, 
         'username': username}
