...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/fortran.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 9748 bytes
"""
...
class FortranLexer(RegexLexer):
    ...
    tokens = {'root': [
     ...
     'core': [
       ...
       'USE', 'VALUE', 'VOLATILE', 'WHERE', 'WRITE', 'WHILE'), prefix='\\b', suffix='\\s*\\b'),
               Keyword),
              (
       ...
       'C_CHAR', 'C_PTR', 'C_FUNPTR'), prefix='\\b', suffix='\\s*\\b'),
               Keyword.Type),
              (
               '(\\*\\*|\\*|\\+|-|\\/|<|>|<=|>=|==|\\/=|=)', Operator),
              (
       ...
       'XOr', 'ZAbs', 'ZCos', 'ZExp', 'ZLog', 'ZSin', 'ZSqRt'), prefix='\\b', suffix='\\s*\\b'),
               Name.Builtin),
              (
