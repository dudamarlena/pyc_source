...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/OpenCobolIDE/open_cobol_ide/extlibs/pyqode/cobol/api/keywords.py
# Compiled at: 2016-12-30 06:42:19
...
"""
INTRINSICS = [
 'ABS', 'ACOS', 'ANNUITY', 'ASIN', 'ATAN', 'BOOLEAN-OF-INTEGER', 'BYTE-LENGTH', 'CHAR', 'CHAR-NATIONAL',
...
RESERVED = [
 'ACCEPT', 'ACCESS', 'ACTIVE-CLASS', 'ADD', 'ADDRESS', 'ADVANCING', 'AFTER', 'ALIGNED', 'ALL', 'ALLOCATE',
...
MNEMONICS = [
 'SYSIN', 'SYSIPT', 'STDIN', 'SYSOUT', 'SYSLIST', 'SYSLST', 'STDOUT', 'PRINT', 'PRINTER', 'PRINTER-1',
...
SQL_COBOL_KEYWORDS = [
 'EXEC', 'SQL', 'END-EXEC', 'INSERT', 'INCLUDE']
