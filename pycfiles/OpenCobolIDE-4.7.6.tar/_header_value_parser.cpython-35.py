...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.5/site-packages/future/backports/email/_header_value_parser.py
# Compiled at: 2016-10-27 16:05:38
# Size of source mod 2**32: 104692 bytes
...
class TokenList(list):
    ...
    def __repr__(self):
        return '{}({})'.format(self.__class__.__name__, super(TokenList, self).__repr__())
        ...
        for part in self.parts:
            ...
            if folded.append_if_fits(part, tstr):
                if has_ew and not part.comments:
                    ...
                    if part.comments or part.token_type == 'quoted-string':
                        last_ew = None
                    continue
                    part._fold(folded)
...
class Terminal(str):
    ...
    def _pp(self, indent=''):
        return [
         '{}{}/{}({}){}'.format(indent, self.__class__.__name__, self.token_type, super(Terminal, self).__repr__(), '' if not self.defects else ' {}'.format(self.defects))]
