...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/praat.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 12589 bytes
"""
    ...
    tokens = {'root': [
     ...
     'operator': [
                  (
                   '([+\\/*<>=!-]=?|[&*|][&*|]?|\\^|<>)', Operator),
                  (
                   '\\b(and|or|not|div|mod)\\b', Operator.Word)], 
     
     'string_interpolated': [
                             (
                              '\\.?[_a-z][a-zA-Z0-9_.]*[\\$#]?(?:\\[[a-zA-Z0-9,]+\\])?(:[0-9]+)?',
                              String.Interpol),
                             (
                              "'", String.Interpol, '#pop')], 
