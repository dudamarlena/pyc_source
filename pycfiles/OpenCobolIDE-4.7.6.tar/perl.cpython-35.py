...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/perl.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 31601 bytes
"""
...
class PerlLexer(RegexLexer):
    ...
    tokens = {'balanced-regex': [
     ...
     'root': [
       ...
       'next', 'our', 'redo', 'reset', 'then', 'unless', 'until', 'while', 'use',
       'print', 'new', 'BEGIN', 'CHECK', 'INIT', 'END', 'return'), suffix='\\b'),
               Keyword),
              (
               '(format)(\\s+)(\\w+)(\\s*)(=)(\\s*\\n)',
       ...
       'msgget', 'msgrcv', 'msgsnd', 'my', 'next', 'no', 'oct', 'open', 'opendir',
       'ord', 'our', 'pack', 'package', 'pipe', 'pop', 'pos', 'printf', 'prototype',
       'push', 'quotemeta', 'rand', 'read', 'readdir', 'readline', 'readlink', 'readpipe',
       'recv', 'redo', 'ref', 'rename', 'require', 'reverse', 'rewinddir', 'rindex',
       ...
       'split', 'sprintf', 'sqrt', 'srand', 'stat', 'study', 'substr', 'symlink',
       ...
       'vec', 'wait', 'waitpid', 'wantarray', 'warn', 'write'), suffix='\\b'),
               Name.Builtin),
              (
