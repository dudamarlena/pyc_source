...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.core/pyqode/core/backend/server.py
# Compiled at: 2016-12-29 05:31:31
# Size of source mod 2**32: 7537 bytes
"""
This module contains the server socket definition.
"""
import argparse, inspect, logging, json, os, struct, sys, time, traceback, threading
try:
    import socketserver
    PY33 = True
except ImportError:
...
class JsonServer(socketserver.TCPServer):
                ...
                try:
                    try:
                        ...
                        try:
                            ...
                            _logger().exception('something went bad with worker %r(data=%r)', worker, data['data'])
                            ret_val = None
    ...
    def __init__(self, args=None):
        ...
        socketserver.TCPServer.__init__(self, ('127.0.0.1', int(args.port)), self._Handler)
