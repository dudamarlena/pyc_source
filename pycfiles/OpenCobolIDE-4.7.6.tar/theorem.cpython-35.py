...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/theorem.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 19030 bytes
"""
...
class LeanLexer(RegexLexer):
    ...
    keywords1 = ('import', 'abbreviation', 'opaque_hint', 'tactic_hint', 'definition',
                 ...
                 'print', 'theorem', 'axiom', 'inductive', 'structure', 'universe',
                 'alias', 'help', 'options', 'precedence', 'postfix', 'prefix', 'calc_trans',
