...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-jqog4noo/pygments/pygments/lexers/webmisc.py
# Compiled at: 2016-12-29 05:31:34
# Size of source mod 2**32: 39773 bytes
"""
    ...
    tokens = {'comment': [
     ...
     'operator': [
                  ...
                  (
                   ...
                   bygroups(Keyword, Text, Keyword), 'itemtype'),
                  (
                   '(case)(\\s+)(' + stringdouble + ')', bygroups(Keyword, Text, String.Double), 'itemtype'),
                  (
                   '(case)(\\s+)(' + stringsingle + ')', bygroups(Keyword, Text, String.Single), 'itemtype'),
                  (
     ...
     'annotationname': [
                        ...
                        (
                         '(\\,)(\\s+)(' + stringdouble + ')', bygroups(Punctuation, Text, String.Double)),
                        (
                         '(\\,)(\\s+)(' + stringsingle + ')', bygroups(Punctuation, Text, String.Single)),
                        (
                         '\\)', Punctuation),
                        (
                         '(\\s+)(\\%)', bygroups(Text, Name.Decorator), 'annotationname'),
                        (
                         '(\\s+)(variable)(\\s+)(\\$)', bygroups(Text, Keyword.Declaration, Text, Name.Variable), 'varname'),
                        (
                         '(\\s+)(function)(\\s+)', bygroups(Text, Keyword.Declaration, Text), 'root')], 
