...
# [GCC 8.4.0]
# Embedded file name: /home/colin/Projects/pyqode.core/pyqode/core/modes/wordclick.py
...
class WordClickMode(Mode, QtCore.QObject):
    ...
    def _select_word_cursor(self):
        ...
        if self._previous_cursor_start != cursor.selectionStart() and self._previous_cursor_end != cursor.selectionEnd():
