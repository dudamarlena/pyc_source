...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.5/site-packages/future/types/newstr.py
# Compiled at: 2016-10-27 16:05:38
# Size of source mod 2**32: 15190 bytes
"""
...
class newstr(with_metaclass(BaseNewStr, unicode)):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if type(args[0]) == newstr and cls == newstr:
            return args[0]
    ...
    def __contains__(self, key):
        ...
        if type(key) == newstr:
            ...
            if isinstance(key, unicode) or isinstance(key, bytes) and not isnewbytes(key):
                newkey = newstr(key)
            else:
