...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-build-4yaip7h6/qcrash/qcrash/_extlibs/github.py
# Compiled at: 2016-12-29 05:40:24
# Size of source mod 2**32: 9845 bytes
"""
...
_METHOD_MAP = dict(GET=lambda : 'GET', PUT=lambda : 'PUT', POST=lambda : 'POST', PATCH=lambda : 'PATCH', DELETE=lambda : 'DELETE')
DEFAULT_SCOPE = None
