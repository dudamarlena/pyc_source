...
# [GCC 8.4.0]
# Embedded file name: \Anaconda3\Lib\site-packages\xing\xareal.py
# Compiled at: 2016-03-01 17:24:06
...
class RealManager:
    __doc__ = '실시간 TR을 모니터링하는 작업 클래스(Real)을 관리하는 클래스\n    ::\n        manager = RealManager()\n    '
