...
# [GCC 8.4.0]
# Embedded file name: C:\Users\derek_2\Google Drive\nvda-addon-exploded\notepad++\scons-local-2.5.0\SCons\Script\SConsOptions.py
...
import optparse, re, sys, textwrap
...
_ = gettext
import SCons.Node.FS, SCons.Warnings
...
def Parser(version):
    ...
    deprecated_debug_options = {'dtree': '; please use --tree=derived instead', 
    ...
    def opt_debug(option, opt, value__, parser, debug_options=debug_options, deprecated_debug_options=deprecated_debug_options):
