...
# [GCC 8.4.0]
# Embedded file name: C:\Users\derek_2\Google Drive\nvda-addon-exploded\notepad++\scons-local-2.5.0\SCons\Tool\FortranCommon.py
...
import re, os.path, SCons.Action, SCons.Defaults, SCons.Scanner.Fortran, SCons.Tool, SCons.Util
...
def add_fortran_to_env(env):
    ...
    DialectAddToEnv(env, 'FORTRAN', FortranSuffixes, FortranPPSuffixes, support_module=1)
...
def add_f90_to_env(env):
    ...
    DialectAddToEnv(env, 'F90', F90Suffixes, F90PPSuffixes, support_module=1)
...
def add_f95_to_env(env):
    ...
    DialectAddToEnv(env, 'F95', F95Suffixes, F95PPSuffixes, support_module=1)
...
def add_f03_to_env(env):
    ...
    DialectAddToEnv(env, 'F03', F03Suffixes, F03PPSuffixes, support_module=1)
...
def add_f08_to_env(env):
    ...
    DialectAddToEnv(env, 'F08', F08Suffixes, F08PPSuffixes, support_module=1)
