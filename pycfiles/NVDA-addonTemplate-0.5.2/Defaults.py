...
# [GCC 8.4.0]
# Embedded file name: C:\Users\derek_2\Google Drive\nvda-addon-exploded\notepad++\scons-local-2.5.0\SCons\Defaults.py
...
import os, errno, shutil, stat, time, sys, SCons.Action, SCons.Builder, SCons.CacheDir, SCons.Environment, SCons.PathList, SCons.Subst, SCons.Tool
_default_env = None
...
permission_dic = {'u': {'r': stat.S_IRUSR, 
         'w': stat.S_IWUSR, 
         'x': stat.S_IXUSR}, 
   'g': {'r': stat.S_IRGRP, 
         'w': stat.S_IWGRP, 
...
ConstructionEnvironment = {'BUILDERS': {}, 'SCANNERS': [
              SCons.Tool.SourceFileScanner], 
   'CONFIGUREDIR': '#/.sconf_temp', 
   'CONFIGURELOG': '#/config.log', 
   'CPPSUFFIXES': SCons.Tool.CSuffixes, 
   'DSUFFIXES': SCons.Tool.DSuffixes, 
   'ENV': {}, 'IDLSUFFIXES': SCons.Tool.IDLSuffixes, 
   '_concat': _concat, 
   '_defines': _defines, 
