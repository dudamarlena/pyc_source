...
# [GCC 8.4.0]
# Embedded file name: C:\Users\derek_2\Google Drive\nvda-addon-exploded\notepad++\scons-local-2.5.0\SCons\Script\SConscript.py
...
import SCons, SCons.Action, SCons.Builder, SCons.Defaults, SCons.Environment, SCons.Errors, SCons.Node, SCons.Node.Alias, SCons.Node.FS, SCons.Platform, SCons.SConf, SCons.Script.Main, SCons.Tool, SCons.Util, collections, os, os.path, re, sys, traceback
        ...
        try:
            ...
            if fn == '-':
                ...
                if _file_:
                    ...
                    SCons.Warnings.warn(SCons.Warnings.MissingSConscriptWarning, "Ignoring missing SConscript '%s'" % f.get_internal_path())
        finally:
            SCons.Script.sconscript_reading = SCons.Script.sconscript_reading - 1
