...
# [GCC 8.4.0]
# Embedded file name: C:\Users\derek_2\Google Drive\nvda-addon-exploded\notepad++\scons-local-2.5.0\SCons\Tool\zip.py
...
"""
__revision__ = 'src/engine/SCons/Tool/zip.py rel_2.5.0:3543:937e55cd78f7 2016/04/09 11:29:54 bdbaddog'
import os.path, SCons.Builder, SCons.Defaults, SCons.Node.FS, SCons.Util
try:
    import zipfile
    internal_zip = 1
except ImportError:
