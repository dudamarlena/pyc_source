...
# [GCC 8.4.0]
# Embedded file name: C:\Users\derek_2\Google Drive\nvda-addon-exploded\notepad++\scons-local-2.5.0\SCons\Tool\msvs.py
...
"""
__revision__ = 'src/engine/SCons/Tool/msvs.py rel_2.5.0:3543:937e55cd78f7 2016/04/09 11:29:54 bdbaddog'
import SCons.compat, base64, hashlib, ntpath, os, pickle, re, sys, SCons.Builder, SCons.Node.FS, SCons.Platform.win32, SCons.Script.SConscript, SCons.PathList, SCons.Util, SCons.Warnings
...
V10DebugSettings = {'LocalDebuggerCommand': None, 
    ...
    def __init__(self, dspfile, source, env):
        ...
        if 'variant' not in env:
            ...
            if SCons.Util.is_String(env['variant']):
                ...
                if SCons.Util.is_List(env['variant']):
                    variants = env['variant']
                if 'buildtarget' not in env or env['buildtarget'] == None:
                    ...
                    if SCons.Util.is_String(env['buildtarget']):
                        ...
                        if SCons.Util.is_List(env['buildtarget']):
                        ...
                        for t in zip(sourcenames, self.srcargs):
                            if t[1] in self.env:
                                ...
                                elif self.env[t[1]] not in self.sources[t[0]]:
...
class _GenerateV6DSP(_DSPGenerator):
    ...
    def PrintSourceFiles(self):
        categories = {'Source Files': 'cpp|c|cxx|l|y|def|odl|idl|hpj|bat', 'Header Files': 'h|hpp|hxx|hm|inl', 
...
class _GenerateV7DSP(_DSPGenerator, _GenerateV7User):
    ...
    def PrintSourceFiles(self):
        categories = {'Source Files': 'cpp;c;cxx;l;y;def;odl;idl;hpj;bat', 'Header Files': 'h;hpp;hxx;hm;inl', 'Local Headers': 'h;hpp;hxx;hm;inl', 
           'Resource Files': 'r;rc;ico;cur;bmp;dlg;rc2;rct;bin;cnt;rtf;gif;jpg;jpeg;jpe', 
           'Other Files': ''}
...
class _GenerateV10DSP(_DSPGenerator, _GenerateV10User):
    ...
    def printSources(self, hierarchy, kind, commonprefix, filter_name):
        keywords = {'Source Files': 'ClCompile', 'Header Files': 'ClInclude', 'Local Headers': 'ClInclude', 
           'Resource Files': 'None', 
           'Other Files': 'None'}
        sorteditems = sorted(hierarchy.items(), key=lambda a: a[0].lower())
        for key, value in sorteditems:
    ...
    def __init__(self, dswfile, source, env):
        ...
        def GenerateProjectFilesInfo(self):
            for dspfile in self.dspfiles:
                ...
                dspfile_info = {'NAME': name, 'GUID': _generateGUID(dspfile, ''), 'FOLDER_PATH': dsp_folder_path, 
                   'FILE_PATH': dspfile, 
