...
# [GCC 8.4.0]
# Embedded file name: /Volumes/Ozgur/Dropbox/Sites/django-manifest/manifest/managers.py
...
class BaseUserManager(AccountActivationManager, EmailConfirmationManager, UserProfileManager):
    pass


class UserManager(BaseUserManager):
    __doc__ = ' Extra functionality for the User model. '