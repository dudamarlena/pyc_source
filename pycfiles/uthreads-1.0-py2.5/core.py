...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uthreads/core.py
# Compiled at: 2009-03-01 14:37:38
import os, sys, time, heapq, types, select, traceback, threading, weakref
        ...
        while True:
            ...
            try:
                ...
                if type(stepresult) is types.GeneratorType:
                    ...
                    sleep_d = stepresult
                elif not sleep_d and iterations > COOP_ITERS:
