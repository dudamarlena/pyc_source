...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/watcher/watcher.py
# Compiled at: 2016-06-24 00:50:40
import sys, signal, argparse, hashlib, hmac, json, os, subprocess
