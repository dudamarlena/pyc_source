...
# Embedded file name: build/bdist.macosx-10.6-universal/egg/castro/__init__.py
# Compiled at: 2011-03-28 19:23:56
import os, tempfile
from datetime import datetime, timedelta
from sys import stdout
from time import sleep
from multiprocessing import Process
import yaml, lib.messageboard as mb
...
class Castro:
    ...
    def __init__(self, filename='castro-video.swf', host='localhost', display=0, framerate=12, freq=1, clipping=None, port=None, passwd=os.path.join(os.path.expanduser('~'), '.vnc', 'passwd'), h264=False, seconds_per_keyframe=5):
