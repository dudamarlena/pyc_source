...
class DataParser():
  ...
  """
    ...
    def readrgba(self):
        return (
         self.readui8(), self.readui8(), self.readui8(), self.readui8())
...
class SWFParser(DataParser):
  ...
  """
    ...
    def readrect(self):
        ...
        self.setbuff(5, x)
        return (
         self.readbits(bits, 1), self.readbits(bits, 1), self.readbits(bits, 1), self.readbits(bits, 1))
    ...
    def readmatrix(self):
        ...
        return (
         scalex, scaley, rot0, rot1, transx, transy)
