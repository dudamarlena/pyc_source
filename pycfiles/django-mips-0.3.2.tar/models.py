...
# [GCC 8.4.0]
# Embedded file name: /home/michal/workspace/code/django-mips/mips/models.py
# Compiled at: 2015-11-17 09:57:41
""" Mip markers model. """
...
class Mip(models.Model):
    ...
    reference_gene_name = models.TextField(null=True)

    def __unicode__(self):
        return ('{}').format(self.mip_id)
...
class Instance(models.Model):
    ...
    def __unicode__(self):
        return ('mip|mip_instance: {}|{}').format(self.mip_fk, self.mip_instance)
...
class Paralog(models.Model):
    ...
    def __unicode__(self):
        return ('mip|subspecies|paralog: {}|{}|{}').format(self.mip_fk, self.subspecies_fk, self.mip_subspecies_paralog)