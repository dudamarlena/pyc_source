...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/txlb/application/service.py
...
class LoadBalancedService(service.MultiService):
    ...
    def switchPort(self, proxyName, newPort):
        ...
        newProxy = proxy.Proxy(serviceName, oldProxy.host, newPort, self.director)
        newService = self.proxyFactory(proxyName, newPort, newProxy.factory, newProxy.host)
