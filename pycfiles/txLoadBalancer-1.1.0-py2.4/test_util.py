...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/txlb/test/test_util.py
...
class UtilityTests(unittest.TestCase):
    ...
    def test_boolify(self):
        ...
        """
        trues = [
         'yes', '1', 'on', 'enable', 'true', 'yes', '1', 'on', 'enable', 'true', 'YES', 'ON', 1, True]
        falses = [
         'no', '0', 'off', 'disable', 'false', 'no', '0', 'off', 'disable', 'false', 'NO', 'OFF', 0, False, 'monkeyface']
        for true in trues:
    ...
    def test_splitHostPart(self):
        ...
        """
        hosts = [
         'localhost:8080', '127.0.0.1', '*:80', ':53']
