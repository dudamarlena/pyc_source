...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/txlb/proxy.py
...
class Sender(protocol.Protocol):
    ...
    def connectionMade(self):
        ...
        self.receiver.factory.director.setClientAddress((outSrc.host, outSrc.port), (
...
class SenderFactory(protocol.ClientFactory):
    ...
    def clientConnectionFailed(self, connector, reason):
        ...
        next = self.receiver.factory.tracker.getHost(self, self.receiver.client_addr)
        if next:
