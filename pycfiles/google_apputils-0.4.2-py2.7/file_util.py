...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/google/apputils/file_util.py
# Compiled at: 2015-02-20 20:25:16
"""Simple file system utilities."""
__author__ = ('elaforge@google.com (Evan LaForge)', 'matthewb@google.com (Matthew Blecker)')
import contextlib, errno, os, pwd, shutil, stat, tempfile
...
def Write(filename, contents, overwrite_existing=True, mode=438, gid=None):
...
def AtomicWrite(filename, contents, mode=438, gid=None):
