...
# Compiled at: 2020-01-10 03:10:55
# Size of source mod 2**32: 8336 bytes
import colorama, getpass, psutil, shutil, socket, sys, time
from . import art
...
class Neofetch:
    ...
    def colours(self, colour: str=None):
        ...
        if colour and colour in clist:
            ...
            if colour.lower() == 'magenta':
                return colorama.Fore.MAGENTA
            if colour.lower() == 'cyan':
