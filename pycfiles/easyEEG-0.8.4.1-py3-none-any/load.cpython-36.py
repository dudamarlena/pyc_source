...
# [GCC 8.4.0]
# Embedded file name: D:\Coding\py\py3\experiments\easyEEG_dist\easyEEG\io\load.py
# Compiled at: 2018-05-22 18:29:20
# Size of source mod 2**32: 31270 bytes
from ..default import *
...
def load_raw_eeg(files=[], path='', subjIDs=[], montage_path='standard-10-5-cap385', events_dict=dict(), default_reference_channels='Cz', drop_channels=[], filter_range=(0.1, 30.0), ref_channels='average', epoch_range=(-0.2, 1), samplerate=500, reject=None):
    filepaths = infer_paths(files, path)
