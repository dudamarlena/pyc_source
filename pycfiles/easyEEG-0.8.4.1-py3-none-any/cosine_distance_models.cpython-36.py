...
# [GCC 8.4.0]
# Embedded file name: D:\Coding\py\py3\experiments\easyEEG_dist\easyEEG\algorithms\cosine_distance_models.py
# Compiled at: 2018-05-15 17:48:25
...
def calc_cosD(df):
    cond_A, cond_B = [average(conditon_group_data, keep='channel') for conditon_group_id, conditon_group_data in df.groupby(level='condition_group')]
...
def tanova(self, step_size='1ms', win_size='1ms', sample='mean', shuffle=500, strategy=1, parallel=False):
    ...
    def to_tanova1(case_raw_data):
        ...
        case_raw_data.columns = case_raw_data.columns.get_level_values(1)
