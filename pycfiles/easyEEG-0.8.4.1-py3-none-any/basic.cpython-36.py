...
# [GCC 8.4.0]
# Embedded file name: D:\Coding\py\py3\experiments\easyEEG_dist\easyEEG\algorithms\basic.py
# Compiled at: 2018-05-22 18:09:20
...
def roll_on_levels(df, func, arguments_dict=dict(), levels='time', prograssbar=True, parallel=False, sequence_size=1):
    ...
    if parallel is False:
        ...
        with ProcessPoolExecutor(max_workers=parallel) as (executor):
            tasks = [(group_id, (executor.submit)(func, group_data, **arguments_dict)) for group_id, group_data in groups_to_roll]
...
def subtract(raw, between, align):
    ...
    result = groups_data[0].mean(level=align) - groups_data[1].mean(level=align)
