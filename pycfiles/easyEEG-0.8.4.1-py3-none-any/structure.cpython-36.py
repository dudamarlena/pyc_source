...
# [GCC 8.4.0]
# Embedded file name: D:\Coding\py\py3\experiments\easyEEG_dist\easyEEG\structure.py
# Compiled at: 2018-05-22 18:28:14
...
class Analyzed_data:
    ...
    def __init__(self, analysis_name, data, annotation=None, supplement=None, default_plot_params=dict()):
        if 'time_group' in data.columns.names:
            if len(data.columns.get_level_values('time_group').unique()) == 1:
