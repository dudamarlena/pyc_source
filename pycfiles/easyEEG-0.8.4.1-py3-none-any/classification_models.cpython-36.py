...
# [GCC 8.4.0]
# Embedded file name: D:\Coding\py\py3\experiments\easyEEG_dist\easyEEG\algorithms\classification_models.py
# Compiled at: 2018-05-22 20:26:10
# Size of source mod 2**32: 4801 bytes
from ..default import *
from .. import structure
from .basic import *
from ..statistics import stats_methods
import types, sklearn
...
def sklearn_model(X, Y, train_index, test_index, model):
    ...
    if hasattr(model, 'coef_'):
        ...
        weights = None
    return (
     score_train, score_test, weights)
...
def group_stats(df, reshape_X_method, reshape_Y_method, run_model, fold, test_size, extra_params=dict()):
    ...
    has_weights = True
    baselines = []
    for subject_group_id, subject_group_data in df.groupby(level='subject'):
