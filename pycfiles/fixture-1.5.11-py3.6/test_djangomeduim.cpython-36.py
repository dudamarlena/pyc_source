...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fixture/test/test_loadable/test_django/test_djangomeduim.py
...
from fixture.test.test_loadable.test_django.fixtures import InvalidNoRelationsData
...
def test_is_field_required():
    ...
    def check_field_required(fld, result):
        msg = "field '%s': null=%s, primary_key=%s, auto_now=%s, auto_now_add=%s should be %s"
