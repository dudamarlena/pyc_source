...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fixture/test/test_loadable/test_google_datastore_loadable.py
...
def setup():
    ...
    if os.path.exists(groot):
        ...
        import google.appengine, webob, yaml, django, antlr3
        from google.appengine.tools import dev_appserver
        appid = '<fixture>'
        dev_appserver.SetupStubs(appid, clear_datastore=False,
...
class TestListOfRelationships(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fixture = GoogleDatastoreFixture(env={'BookData':self.Book, 
