...
# Embedded file name: /Users/gabrielfalcao/projects/personal/carbontube/carbontube/storage/pyredis.py
# Compiled at: 2017-06-08 00:31:56
import time, json, redis, hashlib, random, dj_redis_url
...
def create_new_pool_from_uri(redis_uri):
    ...
    params = dict(map(lambda (k, v): (k.lower(), v), parts.items()))
...
class LuaBridge(object):
    scripts = {'enqueue': read_lua_script('enqueue.lua'), 
