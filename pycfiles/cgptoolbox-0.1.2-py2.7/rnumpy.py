...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\cgp\utils\rnumpy.py
...
__all__ = ('r', 'rcopy', 'rarray', 'rzeros', 'rones', 'rwrap', 'rcapture', 'rstr')
...
class RClosure(RWrapper):
    ...
    def __call__(self, *args, **kwargs):
        ...
        rcall_args += [ (_munge_py_name_to_r(key), value) for key, value in kwargs.iteritems()
                      ]
    ...
    def rcall(self, args):
        ...
        try:
            ...
            return ri2py(_sexp_rcall(converted_args, ri.globalenv), '<return value from %s>' % (self._name,))
        except ri.RRuntimeError as e:
...
class RArray(np.ndarray):
    ...
    def seal--- This code section failed: ---

 L. 569         0  LOAD_FAST             0  'self'
                3  LOAD_ATTR             0  'is_r'
                6  CALL_FUNCTION_0       0  None
                9  POP_JUMP_IF_TRUE     21  'to 21'
               12  LOAD_ASSERT              AssertionError
               15  LOAD_CONST               'Attempt to seal an RArray view'
               18  RAISE_VARARGS_2       2  None

 L. 570        21  LOAD_GLOBAL           2  'False'
               24  LOAD_FAST             0  'self'
               27  LOAD_ATTR             3  'flags'
               30  LOAD_CONST               'WRITEABLE'
               33  STORE_SUBSCR     

Parse error at or near `LOAD_CONST' instruction at offset 30

    def unseal--- This code section failed: ---

 L. 573         0  LOAD_FAST             0  'self'
                3  LOAD_ATTR             0  'is_r'
                6  CALL_FUNCTION_0       0  None
                9  POP_JUMP_IF_TRUE     21  'to 21'
               12  LOAD_ASSERT              AssertionError
               15  LOAD_CONST               'Attempt to unseal an RArray view'
               18  RAISE_VARARGS_2       2  None

 L. 574        21  LOAD_FAST             0  'self'
               24  LOAD_ATTR             2  '_sexp'
               27  LOAD_ATTR             3  'named'
               30  POP_JUMP_IF_FALSE   101  'to 101'

 L. 575        33  LOAD_FAST             0  'self'
               36  LOAD_ATTR             4  'is_sealed'
               39  CALL_FUNCTION_0       0  None
               42  POP_JUMP_IF_TRUE     51  'to 51'
               45  LOAD_ASSERT              AssertionError
               48  RAISE_VARARGS_1       1  None

 L. 576        51  LOAD_CONST               'Unsealing this RArray requires a copy'
               54  STORE_FAST            2  'msg'

 L. 577        57  LOAD_FAST             2  'msg'
               60  LOAD_CONST               'but assert_no_copy=True was given'
               63  INPLACE_ADD      
               64  STORE_FAST            2  'msg'

 L. 578        67  LOAD_FAST             1  'assert_no_copy'
               70  UNARY_NOT        
 ...
 L. 579        83  LOAD_FAST             0  'self'
               86  LOAD_ATTR             2  '_sexp'
               89  LOAD_ATTR             5  'duplicate'
               92  CALL_FUNCTION_0       0  None
               95  STORE_FAST            3  'sexp'
               98  JUMP_FORWARD          9  'to 110'

 L. 583       101  LOAD_FAST             0  'self'
              104  LOAD_ATTR             2  '_sexp'
              107  STORE_FAST            3  'sexp'
            110_0  COME_FROM            98  '98'

 L. 584       110  LOAD_FAST             0  'self'
              113  LOAD_ATTR             6  '__class__'
              116  LOAD_FAST             3  'sexp'
              119  LOAD_CONST               'sealed'
              122  LOAD_GLOBAL           7  'False'
              125  CALL_FUNCTION_257   257  None
              128  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `RETURN_VALUE' instruction at offset 128
    ...
    def _hacky_unseal--- This code section failed: ---

 L. 596         0  LOAD_FAST             0  'self'
                3  LOAD_ATTR             0  'is_r'
                6  CALL_FUNCTION_0       0  None
                9  POP_JUMP_IF_TRUE     21  'to 21'
               12  LOAD_ASSERT              AssertionError
               15  LOAD_CONST               'Cannot unseal an RArray view'
               18  RAISE_VARARGS_2       2  None

 L. 597        21  LOAD_FAST             0  'self'
               24  LOAD_ATTR             2  'is_sealed'
               27  CALL_FUNCTION_0       0  None
               30  POP_JUMP_IF_TRUE     39  'to 39'
               33  LOAD_ASSERT              AssertionError
               36  RAISE_VARARGS_1       1  None

 L. 598        39  LOAD_FAST             0  'self'
               42  LOAD_ATTR             3  '_sexp'
               45  LOAD_ATTR             4  'named'
               48  LOAD_CONST               1
               51  COMPARE_OP            4  >
               54  POP_JUMP_IF_FALSE   138  'to 138'

 L. 599        57  LOAD_CONST               'Unsealing this RArray requires a copy, '
               60  STORE_FAST            2  'msg'

 L. 600        63  LOAD_FAST             2  'msg'
               66  LOAD_CONST               'but assert_no_copy=True was given'
               69  INPLACE_ADD      
               70  STORE_FAST            2  'msg'

 L. 601        73  LOAD_FAST             1  'assert_no_copy'
               76  UNARY_NOT        
               77  POP_JUMP_IF_TRUE     89  'to 89'
               80  LOAD_ASSERT              AssertionError
               83  LOAD_FAST             2  'msg'
               86  RAISE_VARARGS_2       2  None

 L. 602        89  LOAD_FAST             0  'self'
               92  LOAD_ATTR             5  '_replace_sexp'
               95  LOAD_FAST             0  'self'
               98  LOAD_ATTR             3  '_sexp'
              101  LOAD_ATTR             6  '__deepcopy__'
              104  CALL_FUNCTION_0       0  None
              107  CALL_FUNCTION_1       1  None
              110  POP_TOP          

 L. 603       111  LOAD_FAST             0  'self'
              114  LOAD_ATTR             3  '_sexp'
              117  LOAD_ATTR             4  'named'
              120  LOAD_CONST               0
              123  COMPARE_OP            2  ==
 ...
 L. 604       138  LOAD_GLOBAL           7  '_nasty_hack_though_not_nearly_so_bad_as_that_last_one_set_writeable'

 L. 605       141  LOAD_FAST             0  'self'
              144  CALL_FUNCTION_1       1  None
              147  POP_TOP          

Parse error at or near `CALL_FUNCTION_1' instruction at offset 144
    ...
    def __as_r_sexp__--- This code section failed: ---

 L. 617         0  LOAD_FAST             0  'self'
                3  LOAD_ATTR             0  'is_r'
                6  CALL_FUNCTION_0       0  None
                9  POP_JUMP_IF_FALSE    56  'to 56'

 L. 618        12  LOAD_CONST               'Attempt to pass unsealed RArray into R; call .seal() first '
               15  STORE_FAST            1  'msg'

 L. 619        18  LOAD_FAST             1  'msg'
               21  LOAD_CONST               '(or use an ordinary array)'
               24  INPLACE_ADD      
               25  STORE_FAST            1  'msg'

 L. 620        28  LOAD_FAST             0  'self'
               31  LOAD_ATTR             1  'is_sealed'
               34  CALL_FUNCTION_0       0  None
               37  POP_JUMP_IF_TRUE     49  'to 49'
               40  LOAD_ASSERT              AssertionError
               43  LOAD_FAST             1  'msg'
               46  RAISE_VARARGS_2       2  None

 L. 621        49  LOAD_FAST             0  'self'
               52  LOAD_ATTR             3  '_sexp'
               55  RETURN_END_IF    
             56_0  COME_FROM             9  '9'

 L. 623        56  LOAD_GLOBAL           4  'rarray'
               59  LOAD_FAST             0  'self'
               62  LOAD_CONST               'seal'
               65  LOAD_GLOBAL           5  'True'
               68  CALL_FUNCTION_257   257  None
               71  LOAD_ATTR             6  '__as_r_sexp__'
               74  CALL_FUNCTION_0       0  None
               77  RETURN_VALUE     

Parse error at or near `CALL_FUNCTION_0' instruction at offset 74
...
def _arraylike_to_sexp(obj, recurse, **kwargs):
    if isinstance(obj, ri.Sexp):
        ...
        if array.dtype.kind == 'O':
            raise recurse or ValueError, 'Cannot convert object arrays without recursing'
        else:
            sexp_seq = map(py2ri, sexp_seq)
    if array.dtype.kind in _kind_to_sexp:
        sexp = ri.SexpVector(sexp_seq, _kind_to_sexp[array.dtype.kind])
...
def test__arraylike_to_sexp():
    ...
    assert s[0] == 1.0
    s = _arraylike_to_sexp(np.array([complex(1.0, 2.0)], dtype=complex), False)
    assert s.typeof == ri.CPLXSXP
    assert s[0] == complex(1.0, 2.0)
    ...
    assert _arraylike_to_sexp([complex(0.0, 1.0)], False).typeof == ri.CPLXSXP
...
def set_interactive(interactive=True, hz=10):
    ...
    elif _r_polling_thread is not None:
