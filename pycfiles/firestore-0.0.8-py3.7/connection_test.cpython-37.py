...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/tests/db/connection_test.py
...
class BaseDocumentTest(TestCase):
    ...
    def test_uniques_added_to_document(self):
        ...
        self.assertEqual(self.bd.uniques, {'name':self.bd.name, 
         'email':self.bd.email})
