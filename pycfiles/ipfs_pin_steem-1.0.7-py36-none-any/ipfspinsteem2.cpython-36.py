...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ipfspinsteem/ipfspinsteem2.py
# Compiled at: 2018-04-27 18:18:11
...
import requests, random, ipfspinsteem.strings as s
...
class IPFS:
    ...
    def createNewObject(self, hashlist, targethash):
        ...
        if targethash is None:
            targethash = 'QmUNLLsPACCz1vLxQVkXqqLX5R1X345qqfHbsf67hvA3Nn'
