...
# [GCC 8.4.0]
# Embedded file name: /home/nazrul/www/python/Contributions/apps/hybrid-access-control-system/hacs/migrations/0001_initial.py
# Compiled at: 2016-07-13 15:03:46
# Size of source mod 2**32: 6590 bytes
from __future__ import unicode_literals
from django.db import migrations, models
import django.db.models.deletion, django.utils.timezone, hacs.fields, hacs.models, hacs.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='ContentTypeRoutingRules', fields=[
      (
      ...
      (
       'content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType', validators=[hacs.validators.ContentTypeValidator()]))], options={'db_table': 'hacs_ct_routing_rules', 
      'verbose_name': 'content type routing rules', 
      'verbose_name_plural': 'content types routing rules'}, managers=[
      (
       'objects', hacs.models.ContentTypeRoutingRulesManager())]),
     migrations.CreateModel(name='RoutingTable', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'created_on', models.DateTimeField(blank=True, default=django.utils.timezone.now, verbose_name='Created On')),
      (
       'updated_on', models.DateTimeField(blank=True, null=True, verbose_name='Last updated'))], options={'db_table': 'hacs_routing_table', 
      'verbose_name': 'routing table', 
      'verbose_name_plural': 'routes table'}, managers=[
      (
       'objects', hacs.models.RoutingTableManager())]),
     migrations.CreateModel(name='SiteRoutingRules', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'allowed_method', hacs.fields.SequenceField(blank=True, null=True, verbose_name='Allowed Method')),
      ...
      (
       'site', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='hacs_site_routes', to='sites.Site'))], options={'db_table': 'hacs_sites_routing_rules', 
      'verbose_name': 'site routing rules', 
      'verbose_name_plural': 'sites routing rules'}, managers=[
      (
       'objects', hacs.models.SiteRoutingRulesManager())]),
     migrations.AddField(model_name='contenttyperoutingrules', name='route', field=models.ForeignKey(db_column='route_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='hacs_route_contenttypes', to='hacs.RoutingTable')),
     migrations.AddField(model_name='contenttyperoutingrules', name='site', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hacs_site_contenttypes_at_routing_rules', to='sites.Site')),
     migrations.AlterUniqueTogether(name='contenttyperoutingrules', unique_together=set([('site', 'content_type', 'object_id')]))]