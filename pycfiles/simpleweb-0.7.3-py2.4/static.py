...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/simpleweb/extlib/static.py
...
"""
import mimetypes, rfc822, time, string
...
class Cling(object):
    ...
    def __call__(self, environ, start_response):
        ...
        if not (path.abspath(full_path) + '/').startswith(path.abspath(self.root) + '/'):
        ...
        try:
            ...
            headers = [('Date', rfc822.formatdate(time.time())), ('Last-Modified', last_modified), ('ETag', etag)]
...
if __name__ == '__main__':
    magics = (
     StringMagic(title='String Test'), KidMagic(title='Kid Test'))
