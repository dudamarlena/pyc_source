...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tw/mootools/forms.py
# Compiled at: 2009-11-30 09:56:23
import tw.forms, tw.api
...
formcheck_js = JSLink(modname=__name__, filename='static/formcheck/formcheck.js', javascript=[])
formcheck_css = CSSLink(modname=__name__, filename='static/formcheck/theme/classic/formcheck.css', javascript=[])
twmootoolsforms_js = JSLink(modname=__name__, filename='static/forms.js', javascript=[])
...
class CustomisedForm(tw.forms.Form):
    ...
    params = {'blank_deleted': 'Blank out any deleted form fields from GrowingTable on the page. This is required for growing to function correctly - you must use GrowingTableFieldSet within a CustomisedForm with this option set.', 
    ...
    def get_form_lang_file_link(self, lang):
        ...
        return JSLink(modname=__name__, filename=fname, javascript=self.javascript)
