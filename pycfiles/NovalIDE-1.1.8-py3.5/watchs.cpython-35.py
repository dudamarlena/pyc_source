...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/python/debugger/watchs.py
# Compiled at: 2019-09-09 02:52:13
# Size of source mod 2**32: 20188 bytes
from noval import GetApp, _, NewId
import noval.util.apputils as sysutils, noval.iface as iface, noval.plugin as plugin, noval.ui_base as ui_base
from tkinter import ttk, messagebox
import tkinter as tk, noval.util.utils as utils, noval.ttkwidgets.treeviewframe as treeviewframe, noval.imageutils as imageutils, noval.editor.text as texteditor, noval.consts as consts, noval.menu as tkmenu, noval.constants as constants
from noval.python.parser.utils import py_sorted, py_cmp
import noval.ttkwidgets.messagedialog as messagedialog, bz2
...
class WatchDialog(ui_base.CommonModaldialog):
    ...
    def __init__(self, parent, title, chain, is_quick_watch=False, watch_obj=None):
        ...
        self._WatchDialog__set_properties()
