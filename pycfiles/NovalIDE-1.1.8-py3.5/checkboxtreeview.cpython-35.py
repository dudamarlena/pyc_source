...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/ttkwidgets/checkboxtreeview.py
...
import os, noval.imageutils as imageutils
...
class CheckboxTreeview(ttk.Treeview):
    ...
    def __init__(self, master=None, style_name='Checkbox.Treeview', **kw):
        ...
        style.map(style_name, fieldbackground=[
         ('disabled', '#E6E6E6')], foreground=[
         ('disabled', 'gray40')], background=[
         ('disabled', '#E6E6E6')])
        self.im_checked = imageutils.load_image('', 'checkbox/checked.png')
        self.im_unchecked = imageutils.load_image('', 'checkbox/unchecked.png')
        self.im_tristate = imageutils.load_image('', 'checkbox/tristate.png')
    ...
    def IsItemChecked(self, item):
        return not self.tag_has('unchecked', item)
