...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/syntax_themes.py
...
def default_light():
    ...
    return {'TEXT': {'foreground': default_fg, 
     ...
     'completed_focus': {'background': '#BBEDB2', 
                         'borderwidth': 1, 
                         'relief': 'flat'}, 
...
def idle_dark():
    normal_fg = 'white'
    string_fg = '#02ff02'
    return {'TEXT': {'foreground': normal_fg, 
