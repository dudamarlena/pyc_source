...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/project/variables.py
# Compiled at: 2019-08-16 02:55:35
# Size of source mod 2**32: 8670 bytes
from noval import GetApp, _
import os, noval.consts as consts, re, tkinter as tk
from tkinter import ttk, messagebox
import sys
from noval.util import utils
import noval.ui_base as ui_base, noval.ttkwidgets.treeviewframe as treeviewframe
from noval.python.parser.utils import py_sorted
import getpass, noval.project.baseviewer as baseviewer, noval.constants as constants
...
class VariablesDialog(ui_base.CommonModaldialog):
    ...
    def __init__(self, parent, title, current_project_document=None):
        ...
        columns = ['Name', 'Value']
        self.listview = treeviewframe.TreeViewFrame(self.main_frame, columns=columns, height=20, show='headings', displaycolumns=(0,
                                                                                                                                  1))
