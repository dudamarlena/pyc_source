...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/syntax/syndata.py
# Compiled at: 2019-08-20 20:31:02
# Size of source mod 2**32: 9053 bytes
import noval.syntax.syntax as syntax, zlib, noval.util.compat as compat, noval.util.utils as utils, time

class BaseLexer(object):
    __doc__ = 'Syntax data container object base class'
    SYNTAX_ITEMS = []
...
class BaseSyntaxcolorer:
    ...
    def AddTag(self, head, match_start, match_end, key, value, chars):
        self.text.tag_add(key, head + '+%dc' % match_start, head + '+%dc' % match_end)
