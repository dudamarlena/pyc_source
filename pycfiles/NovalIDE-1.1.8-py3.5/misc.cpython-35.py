...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/misc.py
# Compiled at: 2019-08-16 02:55:35
# Size of source mod 2**32: 4884 bytes
from noval import GetApp, NewId, _
from tkinter import ttk
import tkinter as tk, noval.util.strutils as strutils
from PIL import Image
from PIL import ImageTk
import noval.consts as consts
from noval.util import utils
import noval.core as core, os
...
class ToolTip:
    __doc__ = 'Taken from http://www.voidspace.org.uk/python/weblog/arch_d7_2006_07_01.shtml'
...
def get_zoomed(toplevel):
    if '-zoomed' in toplevel.wm_attributes():
