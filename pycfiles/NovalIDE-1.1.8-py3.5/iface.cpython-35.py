...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/iface.py
# Compiled at: 2019-08-16 02:55:35
# Size of source mod 2**32: 4840 bytes
import noval.plugin as plugin

class CommonPluginI(plugin.Interface):
    __doc__ = 'The Autocompletion interface.\n\n    '
...
class ShelfI(plugin.Interface):
    __doc__ = 'Interface into the L{Shelf}. All plugins wanting to be\n    placed on the L{Shelf} should implement this interface.\n\n    '
