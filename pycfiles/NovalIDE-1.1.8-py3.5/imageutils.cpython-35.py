...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/imageutils.py
# Compiled at: 2019-10-07 21:21:23
# Size of source mod 2**32: 6026 bytes
from noval import GetApp
import tkinter as tk, noval.util.appdirs as appdirs, os
...
def load_image(tk_name, image_path, scaling_factor=None):
    ...
    try:
        if scaling_factor >= 2.0:
            ...
            GetApp().tk.call(tk_img, 'copy', img.name, '-zoom', int(scaling_factor), int(scaling_factor))
        else:
