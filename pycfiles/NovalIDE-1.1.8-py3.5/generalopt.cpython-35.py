...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/generalopt.py
# Compiled at: 2019-10-17 01:45:10
# Size of source mod 2**32: 8932 bytes
from noval import _, Locale, GetApp
import tkinter as tk
from tkinter import ttk, messagebox
import noval.util.apputils as apputils, glob, os, noval.consts as consts, noval.util.utils as utils, noval.ui_lang as ui_lang, noval.ui_utils as ui_utils
...
class GeneralOptionPanel(ui_utils.BaseConfigurationPanel):
    ...
    def __init__(self, master, **kwargs):
        ...
        ttk.Label(row, text=_('Language') + ': ').pack(side=tk.LEFT, fill='x')
