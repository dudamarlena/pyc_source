...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/ui_utils.py
# Compiled at: 2019-10-17 01:45:10
# Size of source mod 2**32: 20263 bytes
...
import noval.python.parser.utils as parserutils, noval.util.fileutils as fileutils, os, noval.ui_base as ui_base, noval.util.strutils as strutils, noval.ttkwidgets.treeviewframe as treeviewframe, noval.constants as constants
...
class FullScreenDialog(ui_base.CommonDialog):
    ...
    def __init__(self, parent):
        ...
        self._FullScreenDialog__DoLayout()
