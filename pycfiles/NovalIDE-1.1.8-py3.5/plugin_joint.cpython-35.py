...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/plugin_joint.py
# Compiled at: 2019-10-17 01:45:10
# Size of source mod 2**32: 2206 bytes
import noval.plugin as plugin, noval.iface as iface, noval.util.utils as utils, time

class MainWindowAddOn(plugin.Plugin):
    __doc__ = 'Plugin that Extends the L{MainWindowI}'
