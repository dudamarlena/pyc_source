...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dummy/userdb.py
...
import noval.util.appdirs as appdirs, noval.consts as consts, getpass, noval.util.apputils as apputils, datetime, noval.python.parser.utils as parserutils, json, noval.util.utils as utils, noval.util.urlutils as urlutils, noval.util.fileutils as fileutils
...
class UserDataDb(BaseDb):
    ...
    def CheckDbVersion(self):
        ...
        if self.NeedUpdateDatabaseFile(db_ver_file) and os.path.exists(db_file):
