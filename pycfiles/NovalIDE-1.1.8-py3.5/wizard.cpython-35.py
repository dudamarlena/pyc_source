...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/project/wizard.py
# Compiled at: 2019-10-17 01:45:10
# Size of source mod 2**32: 9217 bytes
from noval import _, GetApp
import tkinter as tk
from tkinter import ttk
from noval.consts import DEFAUT_CONTRL_PAD_X, DEFAUT_CONTRL_PAD_Y
import noval.ui_base as ui_base, tkinter.font as tk_font, noval.imageutils as imageutils
...
class BitmapTitledWizardPage(TitledWizardPage):
    ...
    def __init__(self, master, title, label, bitmap):
        ...
        wizard_title_font = tk_font.Font(name='WizardFont', family=utils.profile_get(consts.EDITOR_FONT_FAMILY_KEY, GetApp().GetDefaultEditorFamily()), weight='bold', size=14)
        labels = label.split('\n')
        show_text = labels[0]
