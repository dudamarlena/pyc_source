...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/mttkinter/mtTkinter.py
...
class _Tk(object):
    __doc__ = 'Wrapper for underlying attribute tk of class Tk'
...
class _TkAttr(object):
    __doc__ = 'Thread-safe callable attribute wrapper'
...
def _Tk__init__(self, *args, **kwargs):
    ...
    new_kwargs = {kw_name:kwargs.pop(kw_name) for kw_name in new_kwnames if kwargs.get(kw_name, None) is not None}
