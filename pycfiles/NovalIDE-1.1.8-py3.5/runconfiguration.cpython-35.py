...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/python/project/runconfiguration.py
# Compiled at: 2019-10-17 01:45:10
# Size of source mod 2**32: 17765 bytes
from noval import GetApp, _
from noval.util import utils
import noval.python.interpreter.interpretermanager as interpretermanager, os, noval.project.basemodel as projectmodel, noval.project.variables as variablesutils, noval.consts as consts, noval.python.project.runconfig as runconfig
...
class StartupConfiguration(BaseConfiguration):
    ...
    def __init__(self, project_doc, main_module_file=None, startup_path_pattern=BaseConfiguration.DEFAULT_PROJECT_DIR_PATH, startup_path=''):
...
class AugumentsConfiguration(BaseConfiguration):
    ...
    def __init__(self, project_doc, main_module_file=None, interpreter_option='', program_args=''):
...
class RunConfiguration:
    ...
    def CreateNewConfiguration(cls, project_doc, default_interpreter, main_module_file=None, configuration_name=''):
        ...
        args = {StartupConfiguration.CONFIGURATION_NAME: StartupConfiguration(project_doc, main_module_file), 
    ...
    def Clone(self):
        args = {StartupConfiguration.CONFIGURATION_NAME: self.GetChildConfiguration(StartupConfiguration.CONFIGURATION_NAME), 
...
class FileConfiguration(BaseConfiguration):
    ...
    def LoadConfiguration(self, configuration_name):
        ...
        args = {StartupConfiguration.CONFIGURATION_NAME: StartupConfiguration(self.ProjectDocument, self.MainModuleFile, startup_path_pattern, startup_path), 
