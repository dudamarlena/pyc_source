...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/editor/format.py
# Compiled at: 2019-09-09 02:52:13
# Size of source mod 2**32: 5400 bytes
from noval import _
import noval.syntax.lang as lang, noval.util.utils as utils, noval.constants as constants, noval.consts as consts, noval.ui_base as ui_base, tkinter as tk
from tkinter import ttk
import noval.imageutils as imageutils, noval.ui_utils as ui_utils
...
class Formatter(object):
    ...
    def do_eol(self, command_id):
        ...
        if command_id == constants.ID_EOL_MAC:
            ...
            if command_id == constants.ID_EOL_UNIX:
