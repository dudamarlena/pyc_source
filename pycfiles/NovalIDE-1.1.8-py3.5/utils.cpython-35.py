...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/util/utils.py
# Compiled at: 2019-10-17 02:23:17
# Size of source mod 2**32: 12844 bytes
...
def create_process(command, args, shell=True, env=None, universal_newlines=True):
    ...
    if is_windows():
        ...
        startupinfo = None
        creationflags = 0
    p = subprocess.Popen(cmd, shell=shell, env=env, universal_newlines=universal_newlines, startupinfo=startupinfo, creationflags=creationflags)
    return p