...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/python/pyutils.py
# Compiled at: 2019-10-17 02:20:23
# Size of source mod 2**32: 9628 bytes
from noval import GetApp, _
import tkinter as tk
from tkinter import messagebox
import sys, os, noval.consts as consts, noval.ui_utils as ui_utils, noval.ttkwidgets.treeviewframe as treeviewframe, noval.ui_base as ui_base, noval.syntax.syntax as syntax, noval.syntax.lang as lang, noval.imageutils as imageutils, noval.util.strutils as strutils, noval.util.fileutils as fileutils
...
def get_python_version_string():
    ...
    result += ' (' + ('64' if sys.maxsize > 4294967296 else '32') + ' bit)\n'
    return result
