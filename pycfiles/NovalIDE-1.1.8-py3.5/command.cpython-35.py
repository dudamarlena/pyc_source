...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/project/command.py
# Compiled at: 2019-08-16 02:55:35
# Size of source mod 2**32: 16516 bytes
import noval.util.singleton as singleton, noval.consts as consts, os
...
class CommandProcessor(object):
    ...
    def Submit(self, command, storeIt=True):
        ...
        if self._maxCommands > -1 and len(self._commands) > self._maxCommands:
...
class ProjectAddProgressFilesCommand(Command):
    ...
    def Do(self):
        return self._projectDoc.AddProgressFiles(self._progress_ui, self._que, self._allFilePaths, self._folderPath, self._types, self._names, self._range_value)
