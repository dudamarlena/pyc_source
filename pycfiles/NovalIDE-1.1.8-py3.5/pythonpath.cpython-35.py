...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/python/project/pages/pythonpath.py
# Compiled at: 2019-08-16 02:55:35
# Size of source mod 2**32: 9273 bytes
from noval import _, NewId
import tkinter as tk
from tkinter import ttk, messagebox
import os, noval.consts as consts, noval.python.parser.utils as parserutils, noval.util.apputils as sysutils, noval.project.variables as variablesutils, noval.util.utils as utils, noval.ui_utils as ui_utils, noval.python.interpreter.pythonpathmixin as pythonpathmixin, noval.python.project.runconfiguration as runconfiguration, noval.project.property as projectproperty, noval.imageutils as imageutils, noval.ttkwidgets.treeviewframe as treeviewframe, noval.python.pyutils as pyutils, noval.constants as constants
...
class InternalPathPage(ttk.Frame):
    ...
    def AddNewFilePath(self):
        ...
        if dlg.ShowModal() == constants.ID_OK:
            main_module_path = os.path.join(variablesutils.FormatVariableName(variablesutils.PROJECT_DIR_VARIABLE), self.current_project_document.GetModel().GetRelativePath(dlg.module_file))
