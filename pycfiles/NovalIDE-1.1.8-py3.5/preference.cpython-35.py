...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/preference.py
# Compiled at: 2019-10-07 21:21:23
# Size of source mod 2**32: 6005 bytes
from noval import _
import tkinter as tk
from tkinter import ttk
import noval.util.singleton as singleton, noval.consts as consts, noval.ui_base as ui_base, noval.ttkwidgets.treeviewframe as treeviewframe
...
class PreferenceManager:
    ...
    def AddOptionsPanelClass(self, category, name, optionsPanelClass):
        if category not in self._optionsPanelClasses:
            self._optionsPanelClasses[category] = [
             (
              name, optionsPanelClass)]
