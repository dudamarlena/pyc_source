...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/noval/colorfont.py
...
import copy, noval.util.strutils as strutils, os, noval.util.appdirs as appdirs, noval.consts as consts, noval.syntax.lang as lang, json, noval.editor.text as texteditor
from noval.editor.code import CodeCtrl
from tkinter import font as tk_font
import noval.ui_utils as ui_utils, noval.ttkwidgets.textframe as textframe, noval.util.utils as utils
...
class ColorFontOptionsPanel(ui_utils.BaseConfigurationPanel):
    ...
    def __init__(self, parent):
        ...
        self._default_settings = {'size': GetApp()._guard_font_size(consts.DEFAULT_FONT_SIZE), 
