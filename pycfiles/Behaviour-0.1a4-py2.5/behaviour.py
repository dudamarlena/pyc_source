...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/src/behaviour.py
# Compiled at: 2007-12-14 02:29:46
"""
...
import decimal, math, re, sys, types, unittest
...
class Behaviour(unittest.TestCase):
    ...
    def _mustBeNumeric(self, value, calledFrom):
        ...
        if isinstance(value, int) or isinstance(value, long) or isinstance(value, float) or isinstance(value, decimal.Decimal):
            return True
        else:
    ...
    def shouldBeNone(self, actual, exceptionMsg=None):
        ...
        def _formatShouldBeNoneMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldBeNone: Actual value (%s) should be None.' % str(actual)
    ...
    def shouldNotBeNone(self, actual, exceptionMsg=None):
        ...
        def _formatShouldNotBeNoneMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldNotBeNone: Actual value (%s) should not be None.' % str(actual)
    ...
    def shouldBeZero(self, actual, exceptionMsg=None):
        ...
        def _formatShouldBeZeroMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldBeZero: Actual value (%s) should be Zero.' % str(actual)
    ...
    def shouldNotBeZero(self, actual, exceptionMsg=None):
        ...
        def _formatShouldNotBeZeroMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldNotBeZero: Actual value (%s) should not be Zero.' % str(actual)
    ...
    def shouldBeTrue(self, actual, exceptionMsg=None):
        ...
        def _formatShouldBeTrueMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldBeTrue: Actual value (%s) should be True.' % str(actual)
    ...
    def shouldBeFalse(self, actual, exceptionMsg=None):
        ...
        def _formatShouldBeFalseMessage(actual, msg=None):
            """
                        ...
                        """
            if msg == None:
                return 'Behaviour.shouldBeFalse: Actual value (%s) should be False.' % str(actual)
            else:
                return msg
            return
    ...
    def _mustBeMemberType(self, value, calledFrom):
        ...
        if self._isStringType(value) or self._isTupleType(value) or self._isListType(value) or self._isDictType(value):
            return True
        else:
    ...
    def shouldBeEmpty(self, actual, exceptionMsg=None):
        ...
        def _formatShouldBeEmptyMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldBeEmpty: Actual value (%s) should be empty.' % str(actual)

        self._mustBeMemberType(actual, 'shouldBeEmpty')
        self.failIf(actual, _formatShouldBeEmptyMessage(actual, exceptionMsg))
        return True
    ...
    def shouldNotBeEmpty(self, actual, exceptionMsg=None):
        ...
        def _formatShouldNotBeEmptyMessage(actual, msg=None):
            """
                        ...
                        """
            return msg or 'Behaviour.shouldNotBeEmpty: Actual value (%s) should be not empty.' % str(actual)
    ...
    def shouldInclude(self, collection, wanted, exceptionMsg=None):
        ...
        def _formatShouldIncludeSequenceMessage(sequence, wanted, msg=None):
            ...
            if msg != None:
                return msg
            elif self._isStringType(sequence):
    ...
    def shouldRaiseException(self, exceptionType, executable, *args, **kwargs):
        ...
        try:
            ...
            if exceptionArgs is not None:
                self.failIf(ex.args != exceptionArgs, _formatWrongArgsMessage(executable, exceptionType, exceptionArgs, ex, ex.args, exceptionMsg))
            if exceptionPattern is not None:
