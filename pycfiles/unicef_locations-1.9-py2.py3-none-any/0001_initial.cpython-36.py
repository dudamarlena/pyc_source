...
# [GCC 8.4.0]
# Embedded file name: /home/jojo/workspace/locations/src/unicef_locations/migrations/0001_initial.py
# Compiled at: 2019-04-19 21:07:17
# Size of source mod 2**32: 5764 bytes
import django.contrib.gis.db.models.fields, django.db.models.deletion, django.utils.timezone, model_utils.fields, mptt.fields
...
class Migration(migrations.Migration):
    ...
    dependencies = []
    operations = [
     migrations.CreateModel(name='CartoDBTable',
       fields=[
      (
       'id',
      ...
      (
       'color',
       models.CharField(blank=True, default=get_random_color, max_length=7,
         null=True,
         verbose_name='Color')),
      (
     ...
     migrations.CreateModel(name='GatewayType',
       fields=[
      (
     ...
     migrations.CreateModel(name='Location',
      ...
      (
       'geom',
       django.contrib.gis.db.models.fields.MultiPolygonField(blank=True,
         null=True,
         srid=4326,
         verbose_name='Geo Point')),
      (
       'point',
      ...
      (
       'gateway',
       models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='locations.GatewayType',
         verbose_name='Location Type')),
      (
       'parent',
