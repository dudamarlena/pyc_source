...
# [GCC 8.4.0]
# Embedded file name: /home/jojo/workspace/locations/src/unicef_locations/tests/test_forms.py
...
from etools.applications.locations import forms
from etools.applications.locations.tests.factories import GatewayTypeFactory

class TestCartoDBTableForm(BaseTenantTestCase):
    ...
    def _test_clean(self, form):
        with patch('etools.applications.locations.forms.SQLClient.send', self.mock_sql):
