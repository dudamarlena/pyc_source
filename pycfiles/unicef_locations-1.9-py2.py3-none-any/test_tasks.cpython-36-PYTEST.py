...
# [GCC 8.4.0]
# Embedded file name: /home/jojo/workspace/locations/src/unicef_locations/tests/test_tasks.py
...
from etools.applications.locations import tasks
from etools.applications.locations.models import CartoDBTable, Location
from etools.applications.locations.tests.factories import CartoDBTableFactory, LocationFactory
...
class TestCreateLocations(BaseTenantTestCase):
    ...
    def test_multiple_objects(self):
        ...
        LocationFactory(p_code='123')
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, 'test', {}, 0, 0, 0)
    ...
    def test_exists_no_geom(self):
        ...
        carto = CartoDBTableFactory()
        LocationFactory(p_code='123')
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, 'test', {'the_geom': False}, 0, 0, 0)
        self.assertFalse(success)
    ...
    def test_exists_point(self):
        ...
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, site_name, {'the_geom': 'Point(20 20)'}, 0, 0, 0)
    ...
    def test_exists_geom(self):
        ...
        self.assertNotEqual(location.name, site_name)
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, 'test', {'the_geom': 'MultiPolygon(((10 10, 10 20, 20 20, 20 15, 10 10)), ((10 10, 10 20, 20 20, 20 15, 10 10)))'}, 0, 0, 0)
        self.assertTrue(success)
        self.assertEqual(not_added, 0)
        self.assertEqual(created, 0)
        self.assertEqual(updated, 1)
    ...
    def test_new_invalid(self):
        ...
        name = 'Test'
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, name, {'the_geom': False}, 0, 0, 0)
        self.assertFalse(success)
        self.assertEqual(not_added, 0)
        self.assertEqual(created, 0)
        self.assertEqual(updated, 0)
    ...
    def test_new_point(self):
        ...
        self.assertFalse(Location.objects.filter(p_code='123').exists())
        name = 'Test'
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, name, {'the_geom': 'Point(20 20)'}, 0, 0, 0)
        self.assertTrue(success)
        self.assertEqual(not_added, 0)
    ...
    def test_new_geom(self):
        ...
        self.assertFalse(Location.objects.filter(p_code='123').exists())
        name = 'Test'
        success, not_added, created, updated = tasks.create_location('123', carto, None, None, name, {'the_geom': 'MultiPolygon(((10 10, 10 20, 20 20, 20 15, 10 10)), ((10 10, 10 20, 20 20, 20 15, 10 10)))'}, 0, 0, 0)
        self.assertTrue(success)
        self.assertEqual(not_added, 0)
        self.assertEqual(created, 1)
        self.assertEqual(updated, 0)
    ...
    def test_new_parent(self):
        ...
        self.assertFalse(Location.objects.filter(p_code='123').exists())
        name = 'Test'
        success, not_added, created, updated = tasks.create_location('123', carto, True, parent, name, {'the_geom': 'Point(20 20)'}, 0, 0, 0)
        self.assertTrue(success)
        self.assertEqual(not_added, 0)
        self.assertEqual(created, 1)
        self.assertEqual(updated, 0)
    ...
    def test_update_parent(self):
        ...
        success, not_added, created, updated = tasks.create_location('123', carto, True, parent2, name, {'the_geom': 'Point(20 20)'}, 0, 0, 0)
        self.assertTrue(success)
        self.assertEqual(not_added, 0)
        self.assertEqual(created, 0)
        self.assertEqual(updated, 1)
...
class TestUpdateSitesFromCartoDB(BaseTenantTestCase):
    ...
    def _assert_response(self, response, name, created, updated, not_added):
        self.assertEqual(response, 'Table name {}: {} sites created, {} sites updated, {} sites skipped'.format(name, created, updated, not_added))
    ...
    def test_add_with_parent(self):
        ...
        self.mock_sql.return_value = {'rows': [
                  {'the_geom':'Point(20 20)', 
                   ...
                   'max':1, 
                   'count':1}]}
        carto = CartoDBTableFactory(parent=carto_parent,
