...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/waferslim/examples/query_table.py
...
"""
from waferslim.converters import convert_arg, Converter, register_converter, converter_for
import datetime
...
class Employee(object):
    ...
    def as_dict(self):
        ...
        return {'employee number': self._emp_no, 'first name': self._fname, 
