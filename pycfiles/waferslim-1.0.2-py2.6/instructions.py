...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/waferslim/instructions.py
# Compiled at: 2010-02-27 12:39:02
"""
    ...
    def _invoke(self, execution_context, results, params):
        ...
        if instance is not None:
            ...
            if not target:
                ...
                target = sut and execution_context.target_for(sut, target_name) or None
        if not target:
