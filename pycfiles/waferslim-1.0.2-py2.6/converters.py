...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/waferslim/converters.py
# Compiled at: 2010-03-28 09:08:28
"""
...
class DateConverter(Converter):
    ...
    def from_string(self, value):
        ...
        return datetime.datetime.strptime(value, DateConverter.DATE_FORMAT).date()
...
class TimeConverter(Converter):
    ...
    def from_string(self, value):
        ...
        try:
            return datetime.datetime.strptime(value, TimeConverter.TIME_FORMAT_WITH_MICROSECONDS).time()
        except ValueError:
            return datetime.datetime.strptime(value, TimeConverter.TIME_FORMAT_WITHOUT_MICROSECONDS).time()
...
class DatetimeConverter(Converter):
    ...
    def from_string(self, value):
        ...
        try:
            return datetime.datetime.strptime(value, DatetimeConverter.FORMAT_WITH_MICROSECONDS)
        except ValueError:
            return datetime.datetime.strptime(value, DatetimeConverter.FORMAT_WITHOUT_MICROSECONDS)
...
class DictConverter(Converter):
    ...
    def __init__(self, item_conversion_dict=None):
        ...
        """
        Converter.__init__(self)
        self._item_conversion_dict = item_conversion_dict and item_conversion_dict or {}
    ...
    def to_string(self, a_dict):
        ...
        names.sort()
        rows = [ '<tr %s><td %s>%s</td><td %s>%s</td></tr>' % (DictConverter.TR_CLASS, DictConverter.TD_KEY_CLASS, to_string(name), DictConverter.TD_VALUE_CLASS, to_string(a_dict.get(name))) for name in names
               ]
...
def register_converter(for_type, converter_instance):
    ...
    if hasattr(converter_instance, 'from_string') and hasattr(converter_instance, 'to_string'):
        __init_converters()
...
def convert_arg(to_type=None, using=None):
    ...
    def conversion_decorator(base_fn):
        ...
        def convert_args_and_return_result(self, *args):
            ...
            _reset(len(args))
            return base_fn(self, *tuple([ _next().from_string(arg) for arg in args ]))
