...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/waferslim/examples/table_table.py
# Compiled at: 2010-02-27 15:33:08
...
class Bowling(object):
    ...
    def _score_game(self, rolls, expected_scores):
        ...
        score_differences = [ self._differs(i, expected_scores, actual_scores) for i in range(0, len(expected_scores)) ]
