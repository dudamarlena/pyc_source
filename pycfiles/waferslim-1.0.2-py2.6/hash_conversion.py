...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/waferslim/examples/hash_conversion.py
# Compiled at: 2010-02-27 17:11:11
...
class People:
    ...
    def nickname(self):
        ...
        for person in self._people:
            if person['lname'] == self._current_person['lname'] and person['fname'] == self._current_person['fname']:
                return person['nname']
