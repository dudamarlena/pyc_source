...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-video/vkontakte_video/admin.py
...
class AlbumAdmin(VkontakteModelAdmin):
    ...
    def image_preview(self, obj):
        return '<a href="%s"><img src="%s" height="30" /></a>' % (obj.photo_160, obj.photo_160)
...
class VideoAdmin(VkontakteModelAdmin):
    ...
    def image_preview(self, obj):
        return '<a href="%s"><img src="%s" height="30" /></a>' % (obj.photo_130, obj.photo_130)

    image_preview.short_description = 'Картинка'
    image_preview.allow_tags = True
    list_display = ('image_preview', 'remote_id', 'owner', 'album', 'title', 'comments_count',
                    'views_count', 'date')
