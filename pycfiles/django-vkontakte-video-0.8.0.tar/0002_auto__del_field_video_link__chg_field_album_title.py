...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-vkontakte-video/vkontakte_video/migrations/0002_auto__del_field_video_link__chg_field_album_title.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('vkontakte_video_video', 'link')
        db.alter_column('vkontakte_video_album', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Video.link' and its values cannot be restored.")
        db.add_column('vkontakte_video_video', 'link', self.gf('django.db.models.fields.URLField')(max_length=255), keep_default=False)
        db.alter_column('vkontakte_video_album', 'title', self.gf('django.db.models.fields.CharField')(max_length='200'))
