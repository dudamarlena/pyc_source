...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kds/ml.py
# Compiled at: 2020-02-19 12:58:17
# Size of source mod 2**32: 4872 bytes
import pandas as pd, matplotlib.pyplot as plt, seaborn as sns, numpy as np, itertools
...
def split_data(self, X, y, test_size=0.2):
    ...
    print("Before OverSampling, counts of label '1': {}".format(y_train[(y_train['class'] == 1)].count()))
    print("Before OverSampling, counts of label '0': {} \n".format(y_train[(y_train['class'] == 0)].count()))
...
class MLModel(object):
    ...
    def plot_confusion_matrix(self, cm, classes, normalize=True, title='Confusion matrix', cmap=plt.cm.cubehelix_r):
        if normalize:
