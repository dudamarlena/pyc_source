...
# Embedded file name: build/bdist.linux-x86_64/egg/cacheproperty/base.py
# Compiled at: 2018-02-21 03:59:28
__doc__ = "A subclass of python's builtin property class that removes boilerplate by implementing the h_hidden_attribute pattern with a single decorator call. Also afacilitates invalidation of the cached hidden attribute with a `@cacheproperty.invalidate`\ndecorator on any other methods or properties in a class."
