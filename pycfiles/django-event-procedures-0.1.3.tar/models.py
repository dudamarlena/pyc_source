...
# [GCC 8.4.0]
# Embedded file name: event_procedures/models.py
# Compiled at: 2014-09-22 14:23:44
...
class Email(models.Model):
    ...
    def call(self, **kwargs):
        ...
        with open(self.message_body) as (body):
            kwargs.update({'body': body.read()})
            context = Context(kwargs)
            message = message.render(context)
        EmailMessage(subject='subject', body=message, from_email=settings.AUTOMATED_EMAIL_ADDRESS, to=to, bcc=bcc, cc=cc).send()
        return