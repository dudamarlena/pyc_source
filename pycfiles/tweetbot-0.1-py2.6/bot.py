...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/tweetbot/bot.py
# Compiled at: 2010-02-28 13:26:35
import twitter, urllib
__all__ = [
 'TweetLengthExceeded', 'TwitterBot', 'BitlyAPIKeyNeeded',
 'BitlyException']

class TweetLengthExceeded(Exception):
    pass


class BitlyAPIKeyNeeded(Exception):
    pass
