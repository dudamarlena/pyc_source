...
# Embedded file name: /private/tmp/test/lib/python2.7/site-packages/pyrowire/validators/validators.py
# Compiled at: 2014-11-25 17:55:11
import itertools, pyrowire.config as config
...
def length(message_data):
    ...
    return (len(message_data['message']) == 0 or max_length < len(message_data['message'])) and len(message_data['message']) <= 1600
