...
# Compiled at: 2019-10-19 16:01:36
...
class Command(CommandPlugin):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--enabled-only', dest='enabled_only', action='store_true', default=False)
        parser.add_argument('--disabled-only', dest='disabled_only', action='store_true', default=False)
        parser.add_argument('--enable', type=six.u)
        parser.add_argument('--disable', type=six.u)
        parser.add_argument('--global', dest='set_global', default=False, action='store_true')
    ...
    def main(self, folder, args):
        ...
        if args.enable:
            ...
            print ('{t.red}{t.bold}Warning{t.normal}{t.red}: Disabling of macro plugins may result in you encountering problems working with folders using a macro.  If you encounter a problem, consider running `jirafs macropatch reset` to clear the currently-applied macros on a given ticket.{t.normal}').format(t=t)
        else:
