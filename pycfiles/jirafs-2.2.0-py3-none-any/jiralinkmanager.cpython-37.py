...
# [GCC 8.4.0]
# Embedded file name: /home/acoddington/Documents/Projects/jirafs/jirafs/jiralinkmanager.py
    ...
    def get_links_from_string(self, contents):
        ...
        for line in contents.split('\n'):
            ...
            try:
                ...
                raise exceptions.IssueValidationError("Remote links must have a description; format your link to {url} like '* Your Title: {url}' to continue.".format(url=(line.strip())))
...
class AutomaticJiraLinkManager(JiraLinkManager):
    ...
    def load(self):
        return self.get_links_from_string(self.get_file_contents(constants.TICKET_LINKS))
