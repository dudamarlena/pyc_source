...
class Command(DirectOutputCommandPlugin):
    ...
    def list(self, config):
        ...
        for section in config.sections():
            ...
            for key, value in parameters:
                lines = lines.add_line('{section}.{key}={value}', section=section, key=key, value=value)
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--global', dest='global_config', default=False, action='store_true')
