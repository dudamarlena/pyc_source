...
class GitRevisionReader(object):
    ...
    def get_file_contents(self, path):
        try:
            return self.folder.get_local_file_at_revision(path, self.revision, failure_ok=False)
...
class WorkingCopyReader(object):
    ...
    def get_file_contents(self, path):
        ...
        with io.open(self.folder.get_local_path(full_path), 'r', encoding='utf-8') as (_in):
