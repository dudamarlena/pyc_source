...
# [GCC 8.4.0]
# Embedded file name: /Users/shliyana/anaconda3/lib/python3.7/site-packages/tests/test_htrc_util_resolve.py
...
class TestResolve(unittest.TestCase):
    ...
    def test_volume_id_to_record_id(self, urlopen_mock):
        urlopen_mock.return_value.geturl.return_value = 'https://catalog.hathitrust.org/Record/000850926'
    ...
    def test_record_id_to_volume_ids(self, urlopen_mock):
        urlopen_mock.return_value.read.return_value = (b'{"items":[{"orig":"Harvard University","fromRecord":"000850926","htid":"hvd.hn3t2m","itemURL":"https:\\/\\/hdl.handle.net\\/2027\\/hvd.hn3t2m","rightsCode":"pd","lastUpdate":"20130803","enumcron":false,"usRightsString":"Full view"}]}').decode('utf-8')
