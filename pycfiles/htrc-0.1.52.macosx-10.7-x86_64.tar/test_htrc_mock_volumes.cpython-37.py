...
# [GCC 8.4.0]
# Embedded file name: /Users/shliyana/anaconda3/lib/python3.7/site-packages/tests/test_htrc_mock_volumes.py
...
import unittest2 as unittest, htrc.mock.volumes
...
class TestVolumes(unittest.TestCase):
    ...
    def test_credential_prompt(self, credential_prompt_mock):
        ...
        username, password = htrc.mock.volumes.credentials_from_config(self.config_path)
    ...
    def test_download_volumes(self, oauth2_mock, volumes_mock, zip_mock):
        ...
        htrc.mock.volumes.download_volumes((self.test_vols), (self.output_path), username='1234',
          password='1234')
        import shutil
        shutil.rmtree(self.output_path)
        htrc.mock.volumes.download_volumes((self.test_vols), (self.output_path), username='1234',
