...
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_tx_utils.py
...
class TestTrxUtils(unittest.TestCase):
    ...
    def test_verify_transaction(self):
        ...
        tx_input = Spendable(200, '18eKkAWyU9kvRNHPKxnZb6wwtPMrNmRRRA', b, 0)
        tx_outs = [tx_utils.create_transaction_output('mgAqW5ZCnEp7fjvpj8RUL3WxsBy8rcDcCi', 2.75e-05)]
    ...
    def test_compare_cost(self):
        ...
        :return:
        """
        tx = Tx.from_hex('')
        s = io.BytesIO()
        tx.stream(s)
    ...
    def test_calculate_tx_fee_1(self):
        cost_constants = BitcoinTransactionCostConstants(0.0001, 2.75e-05, 41)
