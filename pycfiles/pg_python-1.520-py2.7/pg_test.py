...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-intel/egg/pg_python/pg_test.py
# Compiled at: 2019-09-27 12:47:10
...
class TestTests(unittest.TestCase):
    ...
    def test_multiple_update(self):
        create_rows()
        dict_lst = [{COL_1: 'title1', UPDATE: 'updated_name1'}, {COL_1: 'title2', UPDATE: "update'd_name2"}]
    ...
    def test_multiple_insert(self):
        column_to_insert = [
         COL_1, COL_3]
        insert_dict_list = [{COL_1: 'insert1', COL_3: 1}, {COL_3: 2, COL_1: 'insert2'}, {COL_1: 'insert3', COL_3: 3}]
...
class UpdateTests(unittest.TestCase):
    ...
    def test_update_multicol(self):
        ...
        dict_lst = [{'where': {COL_1: 'title1'}, UPDATE: {COL_2: 'updated_col2a', COL_3: 33}}, {'where': {COL_1: 'title2'}, UPDATE: {COL_2: 'updated_col2b', COL_3: 34}}]
    ...
    def test_update_multicol_2testcond(self):
        ...
        dict_lst = [{'where': {COL_1: 'title1', COL_3: 76}, UPDATE: {COL_2: 'updated_col2a'}}]
