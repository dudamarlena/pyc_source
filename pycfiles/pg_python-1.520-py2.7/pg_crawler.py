...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-intel/egg/pg_python/pg_crawler.py
# Compiled at: 2019-06-12 05:31:30
...
def close():
    connection = crawler_db.get_connection()
    cursor = crawler_db.get_cursor()
    crawler_db.close_cursor(cursor)
...
def update_multiple(table, column_to_update, columns_to_query_lst, query_values_dict_lst):
    """
