...
# [GCC 8.4.0]
# Embedded file name: /Users/rsutton/workarea/env/eulxml/lib/python2.7/site-packages/eulxml/xpath/parserules.py
...
def p_filter_expr_predicate(p):
    ...
    """
    if not hasattr(p[1], b'append_predicate'):
...
def p_error(p):
    raise RuntimeError(b"Syntax error at '%s'" % repr(p))