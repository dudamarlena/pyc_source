...
# [GCC 8.4.0]
# Embedded file name: /home/siro/Space/pakages/django-seo-transformer/django_seo/django_simple_seo/templatetags/seo.py
# Compiled at: 2019-12-06 08:02:22
...
def custom_meta(attr, name, content):
    ...
    """
    return '<meta {attr}="{name}" content="{content}">'.format(attr=(escape(attr)),
      name=(escape(name)),
