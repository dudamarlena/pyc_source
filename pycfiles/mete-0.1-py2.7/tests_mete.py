...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mete/tests_mete.py
...
table7pt2 = [
 [
  4, 16, 64, '0.0459', '0.116', '5.4', '-0.037', '0.083', '0.74'],
 [
...
def test_get_beta_precise():
    ...
    for line in data:
        yield (
         check_get_beta, line[0], line[1], 'precise', line[2])
...
def test_get_beta_approx():
    ...
    for line in data:
        yield (
         check_get_beta, line[0], line[1], 'approx', line[2])
...
def test_get_lambda1():
    ...
    for line in data:
        yield (
         check_get_lambda1, line[0], line[1], line[2], line[3])
...
def test_get_lambda2():
    ...
    for line in data:
        yield (
         check_get_lambda2, line[0], line[1], line[2], line[3])
...
def test_get_lambda_spatialdistrib_precise():
    ...
    for line in data:
        yield (
         check_get_lambda_spatialdistrib, line[1], 1, line[0], line[2])
