...
# [GCC 8.4.0]
# Embedded file name: /opt/conda/lib/python3.7/site-packages/smoothnlp_api/configuration.py
...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        ...
        self.password = ''
        self.logger = {}
        self.logger['package_logger'] = logging.getLogger('client_package')
