...
# [GCC 8.4.0]
# Embedded file name: /opt/conda/lib/python3.7/site-packages/smoothnlp_api/api_client.py
# Compiled at: 2019-09-17 09:18:30
# Size of source mod 2**32: 24422 bytes
"""
    Investment
...
class ApiClient(object):
    ...
    def __call_api(self, host, resource_path, method, path_params=None, query_params=None, header_params=None, body=None, post_params=None, files=None, response_type=None, auth_settings=None, _return_http_data_only=None, collection_formats=None, _preload_content=True, _request_timeout=None):
    ...
    def __deserialize(self, data, klass):
        ...
        if data is None:
            ...
            if type(klass) == str:
                if klass.startswith('list['):
                    ...
                    return [self._ApiClient__deserialize(sub_data, sub_kls) for sub_data in data]
                if klass.startswith('dict('):
                    sub_kls = re.match('dict\\(([^,]*), (.*)\\)', klass).group(2)
                    return {k:self._ApiClient__deserialize(v, sub_kls) for k, v in six.iteritems(data)}
                if klass in self.NATIVE_TYPES_MAPPING:
                    klass = self.NATIVE_TYPES_MAPPING[klass]
        else:
            klass = getattr(smoothnlp_api.models, klass)
        ...
        if klass == datetime.datetime:
            return self._ApiClient__deserialize_datatime(data)
        return self._ApiClient__deserialize_model(data, klass)

    def call_api(self, host, resource_path, method, path_params=None, query_params=None, header_params=None, body=None, post_params=None, files=None, response_type=None, auth_settings=None, _async=None, _return_http_data_only=None, collection_formats=None, _preload_content=True, _request_timeout=None):
        ...
        """
        if not _async:
            return self._ApiClient__call_api(host, resource_path, method, path_params, query_params, header_params, body, post_params, files, response_type, auth_settings, _return_http_data_only, collection_formats, _preload_content, _request_timeout)
        thread = self.pool.apply_async(self._ApiClient__call_api, (host, resource_path,
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not klass.swagger_types:
            if not hasattr(klass, 'get_real_child_model'):
                return data
        else:
            kwargs = {}
