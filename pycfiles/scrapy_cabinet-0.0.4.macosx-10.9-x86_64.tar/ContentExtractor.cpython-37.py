...
# [GCC 8.4.0]
# Embedded file name: /Users/sogubaby/.virtualenvs/scrapy_middlewares/lib/python3.7/site-packages/scrapy_cabinet/libs/gne/extractor/ContentExtractor.py
# Compiled at: 2019-11-07 04:07:05
# Size of source mod 2**32: 4620 bytes
import re, numpy as np
from scrapy_cabinet.libs.utils import iter_node
...
class ContentExtractor:
    ...
    def extract(self, selector):
        ...
        for node in iter_node(body):
            ...
            self.node_info[node_hash] = {'ti':density_info['ti'],  'lti':density_info['lti'], 
    ...
    def calc_text_density(self, element):
        ...
        if tgi - ltgi == 0:
            return {'density':0, 
             'ti_text':ti_text,  'ti':ti,  'lti':lti,  'tgi':tgi,  'ltgi':ltgi}
    ...
    def calc_new_score(self, std):
        ...
        for node_hash, node_info in self.node_info.items():
            score = np.log(std) * node_info['density'] * np.log10(node_info['text_tag_count'] + 2) * np.log(node_info['sbdi'])
