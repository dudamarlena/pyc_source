...
# [GCC 8.4.0]
# Embedded file name: /home/machin/.virtualenvs/twine/lib/python2.7/site-packages/gerritclient/tests/unit/cli/test_project.py
# Compiled at: 2017-09-01 14:03:58
import json, mock
...
class TestProjectCommand(clibase.BaseCLITest):
    ...
    def test_project_list_all_wo_description_wo_branches(self):
        ...
        self.m_client.get_all.assert_called_once_with(is_all=True, limit=None, skip=None, pattern_dispatcher=None, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_wo_weblinkinfo_in_project_entity(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=None, skip=None, pattern_dispatcher=None, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_all_w_description_wo_branches(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=True, limit=None, skip=None, pattern_dispatcher=None, project_type=None, description=True, branches=None)
        return
    ...
    def test_project_list_all_wo_description_w_branches(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=True, limit=None, skip=None, pattern_dispatcher=None, project_type=None, description=False, branches=branches)
        return
    ...
    def test_project_list_limit(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=list_limit, skip=None, pattern_dispatcher=None, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_skip_first(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=None, skip=list_skip, pattern_dispatcher=None, project_type=None, description=False, branches=None)
        return

    def test_project_list_range(self):
        list_skip = 2
        list_limit = 2
        args = ('project list --skip {0} --limit {1}').format(list_skip, list_limit)
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=list_limit, skip=list_skip, pattern_dispatcher=None, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_w_prefix(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=None, skip=None, pattern_dispatcher=prefix, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_w_match(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=None, skip=None, pattern_dispatcher=match, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_w_regex(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=None, skip=None, pattern_dispatcher=regex, project_type=None, description=False, branches=None)
        return
    ...
    def test_project_list_w_specified_type(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_all.assert_called_once_with(is_all=False, limit=None, skip=None, pattern_dispatcher=None, project_type=prj_type, description=False, branches=None)
        return
    ...
    def test_project_create_w_parameters_from_file(self):
        project_id = 'fakes/fake-project'
        test_data = {'name': project_id, 'description': 'Fake project description', 
           'owners': [
                    'Fake Owner']}
        expected_path = '/tmp/fakes/fake-project.yaml'
        args = ('project create {0} --file {1}').format(project_id, expected_path)
    ...
    def test_project_create_w_parameters_from_bad_file_format_fail(self):
        ...
        m_open = mock.mock_open(read_data=json.dumps(test_data))
        with mock.patch('gerritclient.common.utils.open', m_open, create=True):
            self.assertRaisesRegexp(ValueError, 'Unsupported data format', self.exec_command, args)

    @mock.patch('sys.stderr')
    def test_project_create_fail(self, mocked_stderr):
        args = 'project create'
        self.assertRaises(SystemExit, self.exec_command, args)
        self.assertIn('project create: error:', mocked_stderr.write.call_args_list[(-1)][0][0])
    ...
    def test_project_delete(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.delete.assert_called_once_with(project_name, force=False, preserve=False)
    ...
    def test_project_delete_w_force(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.delete.assert_called_once_with(project_name, force=True, preserve=False)

    def test_project_delete_w_preserve_git_repository(self):
        project_name = 'fake/fake-project'
        args = ('project delete {0} --preserve-git-repository').format(project_name)
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.delete.assert_called_once_with(project_name, force=False, preserve=True)
    ...
    def test_project_description_set(self):
        ...
        args = ('project description set {0} --description "{1}" --message "{2}"').format(project_name, project_description, message)
        self.m_client.set_description.return_value = project_description
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.set_description.assert_called_once_with(project_name, description=project_description, commit_message=message)
    ...
    def test_project_parent_set(self):
        ...
        message = 'Fake commit message'
        args = ('project parent set {0} --parent "{1}" --message "{2}"').format(project_name, parent_project, message)
        self.m_client.set_parent.return_value = parent_project
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.set_parent.assert_called_once_with(project_name, parent=parent_project, commit_message=message)
    ...
    def test_project_head_set(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.set_head.assert_called_once_with(project_name, branch=branch)
    ...
    def test_project_branch_show(self):
        ...
        args = ('project branch show {0} --branch {1}').format(project_name, branch_name)
        fake_branch = fake_project.get_fake_project_branch(ref=branch_name)
        self.m_client.get_branch.return_value = fake_branch
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_branch.assert_called_once_with(project_name, branch_name=branch_name)

    def test_project_branch_create(self):
        project_name = 'fake/fake-project'
        branch_name = 'refs/heads/fake-branch'
        revision = '67ebf73496383c6777035e374d2d664009e2aa5c'
        args = ('project branch create {0} --branch {1} --revision {2}').format(project_name, branch_name, revision)
        fake_branch = fake_project.get_fake_project_branch(ref=branch_name, revision=revision)
        self.m_client.create_branch.return_value = fake_branch
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.create_branch.assert_called_once_with(project_name, branch_name=branch_name, revision=revision)

    def test_project_branch_delete(self):
        project_name = 'fake/fake-project'
        branches = ['refs/heads/fake-branch', 'refs/heads/fake-new-branch']
        args = ('project branch delete {0} --branch {1}').format(project_name, (' ').join(branches))
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.delete_branch.assert_called_once_with(project_name, branches)

    def test_project_branch_reflog_show(self):
        project_name = 'fake/fake-project'
        branch = 'fake-branch'
        args = ('project branch reflog show {0} --branch {1}').format(project_name, branch)
        fake_reflog_list = [ fake_project.get_fake_reflog() for _ in range(5) ]
        self.m_client.get_reflog.return_value = fake_reflog_list
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_reflog.assert_called_once_with(project_name, branch=branch)
    ...
    def test_project_child_list(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_children.assert_called_once_with(project_name, recursively=False)

    def test_project_child_list_recursively(self):
        project_name = 'fake/fake-project'
        args = ('project child list {0} --recursively').format(project_name)
        fake_projects = [ fake_project.get_fake_project() for _ in range(5) ]
        fake_projects.append(fake_project.get_fake_project(project_id='child-project', name='child-project', parent=project_name))
        self.m_client.get_children.return_value = fake_projects
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.get_children.assert_called_once_with(project_name, recursively=True)
    ...
    def test_project_run_garbage_collection_wo_parameters(self):
        ...
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.run_gc.assert_called_once_with(project_name, aggressive=False, show_progress=False)
    ...
    def test_project_run_garbage_collection_w_parameters(self):
        ...
        self.m_client.run_gc.return_value = msg
        args = ('project gc-run {0} --aggressive --show-progress').format(project_name)
        self.exec_command(args)
        self.m_get_client.assert_called_once_with('project', mock.ANY)
        self.m_client.run_gc.assert_called_once_with(project_name, aggressive=True, show_progress=True)