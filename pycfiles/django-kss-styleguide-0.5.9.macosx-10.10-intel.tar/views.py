...
# [GCC 8.4.0]
# Embedded file name: /Users/tim/Projects/django_kss/VENV/lib/python2.7/site-packages/django_kss/views.py
# Compiled at: 2015-02-12 01:46:06
import os.path
...
def render_prototype(request, html):
    ...
    return render(request, 'styleguide-full-content.html', {'inline_content': os.path.join(prototype_directory, html)})
