...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/lamson/testing.py
...
class TestConversation(object):
    ...
    def say(self, To, Body, expect=None, Subject=None):
        ...
        if not msg:
            raise AssertionError, "Expected %r when sending to %r with '%s:%s' message." % (expect,
