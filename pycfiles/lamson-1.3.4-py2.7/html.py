...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/lamson/html.py
...
class HtmlMail(object):
 ...
 L. 166         0  LOAD_FAST             2  'content'
                3  POP_JUMP_IF_TRUE     15  'to 15'
                6  LOAD_ASSERT              AssertionError
                9  LOAD_CONST               'You must give a contents template.'
               12  RAISE_VARARGS_2       2  None

 L. 168        15  LOAD_FAST             3  'kwd'
               18  LOAD_ATTR             1  'get'
               21  LOAD_CONST               'Body'
               24  LOAD_CONST               None
               27  CALL_FUNCTION_2       2  None
               30  LOAD_FAST             2  'content'
               33  COMPARE_OP            2  ==
               36  POP_JUMP_IF_FALSE    64  'to 64'

 L. 169        39  LOAD_GLOBAL           3  'view'
               42  LOAD_ATTR             4  'render'
               45  LOAD_FAST             1  'variables'
               48  LOAD_FAST             2  'content'
               51  CALL_FUNCTION_2       2  None
               54  LOAD_FAST             3  'kwd'
               57  LOAD_CONST               'Body'
               60  STORE_SUBSCR     
               61  JUMP_FORWARD          0  'to 64'
             64_0  COME_FROM            61  '61'

 L. 171        64  SETUP_LOOP           32  'to 99'
               67  LOAD_FAST             3  'kwd'
               70  GET_ITER         
               71  FOR_ITER             24  'to 98'
               74  STORE_FAST            4  'key'

 L. 172        77  LOAD_FAST             3  'kwd'
               80  LOAD_FAST             4  'key'
               83  BINARY_SUBSCR    
               84  LOAD_FAST             1  'variables'
               87  BINARY_MODULO    
               88  LOAD_FAST             3  'kwd'
               91  LOAD_FAST             4  'key'
               94  STORE_SUBSCR     
               95  JUMP_BACK            71  'to 71'
               98  POP_BLOCK        
             99_0  COME_FROM            64  '64'

 L. 174        99  LOAD_GLOBAL           5  'mail'
              102  LOAD_ATTR             6  'MailResponse'
              105  LOAD_FAST             3  'kwd'
              108  CALL_FUNCTION_KW_0     0  None
              111  STORE_FAST            5  'msg'

 L. 175       114  LOAD_FAST             0  'self'
              117  LOAD_ATTR             4  'render'
              120  LOAD_FAST             1  'variables'
              123  LOAD_FAST             2  'content'
              126  CALL_FUNCTION_2       2  None
              129  LOAD_FAST             5  'msg'
              132  STORE_ATTR            7  'Html'

 L. 177       135  LOAD_FAST             5  'msg'
              138  RETURN_VALUE     
