...
class resolving_logger:
    __doc__ = 'Feed (ip, message) combinations into this logger to get a\n    resolved hostname in front of the message.  The message will not\n    be logged until the PTR request finishes (or fails).'
...
class unresolving_logger:
    __doc__ = "Just in case you don't want to resolve"
...
class tail_logger:
    __doc__ = 'Keep track of the last <size> log messages'
