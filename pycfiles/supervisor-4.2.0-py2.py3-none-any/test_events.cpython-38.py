...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/supervisor/tests/test_events.py
# Compiled at: 2019-04-05 17:19:18
# Size of source mod 2**32: 20920 bytes
import sys, unittest
...
class TestSerializations(unittest.TestCase):
    ...
    def test_process_state_exited_event_expected(self):
        ...
        process1.group = DummyGroup
        process1.pid = 1
        event = events.ProcessStateExitedEvent(process1, (ProcessStates.STARTING),
          expected=True)
        headers, payload = self._deserialize(event.payload())
