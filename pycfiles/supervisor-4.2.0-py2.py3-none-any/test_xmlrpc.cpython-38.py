...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/supervisor/tests/test_xmlrpc.py
# Compiled at: 2019-04-05 17:19:18
# Size of source mod 2**32: 35803 bytes
import unittest
...
class XMLRPCHandlerTests(unittest.TestCase):
    ...
    def test_continue_request_500_if_rpcinterface_method_call_raises(self):
        ...
        logdata = supervisor.options.logger.data
        self.assertEqual(len(logdata), 2)
        self.assertEqual(logdata[0], 'XML-RPC method called: supervisor.raiseError()')
    ...
    def test_continue_request_500_if_xmlrpc_dumps_raises(self):
        ...
        self.assertEqual(logdata[0], 'XML-RPC method called: supervisor.getXmlRpcUnmarshallable()')
        self.assertEqual(logdata[1], 'XML-RPC method supervisor.getXmlRpcUnmarshallable() returned successfully')
...
class TraverseTests(unittest.TestCase):
    ...
    def test_security_disallows_underscore_methods(self):
        ...
        root = Root()
        root.a = A()
        self.assertRaises(xmlrpc.RPCError, xmlrpc.traverse, root, 'a._danger', [])
    ...
    def test_security_disallows_object_traversal(self):
        ...
        root.a = A()
        root.a.b = B()
        self.assertRaises(xmlrpc.RPCError, xmlrpc.traverse, root, 'a.b.danger', [])
    ...
    def test_namespace_name_not_found(self):
        ...
        root = Root()
        self.assertRaises(xmlrpc.RPCError, xmlrpc.traverse, root, 'notfound.hello', None)
    ...
    def test_method_name_not_found(self):
        ...
        root = Root()
        root.a = A()
        self.assertRaises(xmlrpc.RPCError, xmlrpc.traverse, root, 'a.notfound', [])
    ...
    def test_method_name_exists_but_is_not_a_method(self):
        ...
        root.a = A()
        root.a.b = B()
        self.assertRaises(xmlrpc.RPCError, xmlrpc.traverse, root, 'a.b', [])
    ...
    def test_bad_params(self):
        ...
        root = Root()
        root.a = A()
        self.assertRaises(xmlrpc.RPCError, xmlrpc.traverse, root, 'a.hello', ['there', 'extra'])
...
class TestSystemNamespaceRPCInterface(unittest.TestCase):
    ...
    def test_multicall_faults_for_recursion(self):
        ...
        self.assertEqual(results, [
         {'faultCode':Faults.INCORRECT_PARAMETERS, 
          'faultString':'INCORRECT_PARAMETERS: Recursive system.multicall forbidden'}])
    ...
    def test_multicall_catches_noncallback_exceptions(self):
        ...
        os_error = {'faultCode':Faults.FAILED,  'faultString':'FAILED: %s:2' % OSError}
    ...
    def test_multicall_catches_callback_exceptions(self):
        ...
        bad_name = {'faultCode':Faults.BAD_NAME,  'faultString':'BAD_NAME: foo'}
        os_error = {'faultCode':Faults.FAILED,  'faultString':'FAILED: %s:2' % OSError}
        self.assertEqual(results, [bad_name, os_error])
    ...
    def test_multicall_performs_callback_functions_serially(self):
        ...
        inst = self._makeOne([('ns1', ns1)])
        calls = [
         {'methodName':'ns1.stopProcess',  'params':{'name': 'foo'}},
