...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/supervisor/socket_manager.py
# Compiled at: 2019-04-05 17:19:18
# Size of source mod 2**32: 3095 bytes
import socket

class Proxy:
    __doc__ = " Class for wrapping a shared resource object and getting\n        notified when it's deleted\n    "
...
class ReferenceCounter:
    __doc__ = ' Class for tracking references to a shared resource\n    '
...
class SocketManager:
    ...
    def __init__(self, socket_config, **kwargs):
        ...
        self.ref_ctr = ReferenceCounter(on_zero=(self._close),
