...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/supervisor/tests/test_rpcinterfaces.py
# Compiled at: 2019-04-05 17:19:18
# Size of source mod 2**32: 104254 bytes
import unittest, sys, operator, os, time, errno
...
class MainXMLRPCInterfaceTests(TestBase):
    ...
    def test_traverse(self):
        ...
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.UNKNOWN_METHOD, xmlrpc.traverse, interface, 'notthere.hello', [])
        self._assertRPCError(xmlrpc.Faults.UNKNOWN_METHOD, xmlrpc.traverse, interface, 'supervisor._readFile', [])
        self._assertRPCError(xmlrpc.Faults.INCORRECT_PARAMETERS, xmlrpc.traverse, interface, 'dummy.hello', [1])
        self.assertEqual(xmlrpc.traverse(interface, 'dummy.hello', []), 'Hello!')
...
class SupervisorNamespaceXMLRPCInterfaceTests(TestBase):
    ...
    def test_update(self):
        ...
        self._assertRPCError(xmlrpc.Faults.SHUTDOWN_STATE, interface._update, 'foo')
    ...
    def test_readLog_unreadable(self):
        ...
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError((xmlrpc.Faults.NO_FILE), (interface.readLog), offset=0,
          length=1)
    ...
    def test_readLog_badargs(self):
        ...
        try:
            ...
            with open(logfile, 'w+') as (f):
                f.write('')
            self._assertRPCError((xmlrpc.Faults.BAD_ARGUMENTS), (interface.readLog),
              offset=(-1), length=1)
            self._assertRPCError((xmlrpc.Faults.BAD_ARGUMENTS), (interface.readLog),
              offset=(-1), length=(-1))
        finally:
    ...
    def test_readLog(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write('')
                f.write('')
            data = interface.readLog(offset=0, length=0)
            self.assertEqual(interface.update_text, 'readLog')
            self.assertEqual(data, '')
            data = interface.readLog(offset=2048, length=0)
            self.assertEqual(data, '')
            data = interface.readLog(offset=0, length=2048)
            self.assertEqual(data, '')
            data = interface.readLog(offset=(-4), length=0)
            self.assertEqual(data, 'yyyy')
        finally:
            os.remove(logfile)
    ...
    def test_reloadConfig(self):
        ...
        changes = [
         [
          DummyPGroupConfig(options, 'added')],
         [
    ...
    def test_addProcessGroup(self):
        ...
        self._assertRPCError(xmlrpc.Faults.ALREADY_ADDED, interface.addProcessGroup, 'group1')
        self.assertEqual(list(supervisord.process_groups.keys()), ['group1'])
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.addProcessGroup, 'asdf')
        self.assertEqual(list(supervisord.process_groups.keys()), ['group1'])
    ...
    def test_removeProcessGroup_bad_name(self):
        ...
        supervisord.options.process_group_configs = [gconfig]
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.removeProcessGroup, 'asdf')
    ...
    def test_removeProcessGroup_still_running(self):
        ...
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.STILL_RUNNING, interface.removeProcessGroup, 'group1')
    ...
    def test_startProcess_already_started(self):
        ...
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.ALREADY_STARTED, interface.startProcess, 'foo')
    ...
    def test_startProcess_bad_group_name(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.startProcess, 'group2:foo')
    ...
    def test_startProcess_bad_process_name(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.startProcess, 'group1:bar')
    ...
    def test_startProcess_file_not_found(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.NO_FILE, interface.startProcess, 'foo')
    ...
    def test_startProcess_file_not_executable(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.NOT_EXECUTABLE, interface.startProcess, 'foo')
    ...
    def test_startProcess_spawnerr(self):
        ...
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.SPAWN_ERROR, interface.startProcess, 'foo')

    def test_startProcess(self):
        options = DummyOptions()
        pconfig = DummyPConfig(options, 'foo', __file__, autostart=False, startsecs=0.01)
        from supervisor.process import ProcessStates
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        supervisord.set_procattr('foo', 'state', ProcessStates.STOPPED)
        interface = self._makeOne(supervisord)
    ...
    def test_startProcess_abnormal_term_process_not_running(self):
        ...
        process.spawn = spawn
        callback = interface.startProcess('foo', 100)
        result = callback()
    ...
    def test_startProcess_splat_calls_startProcessGroup(self):
        options = DummyOptions()
        pconfig1 = DummyPConfig(options, 'process1', __file__, autostart=False, startsecs=0.01)
        pconfig2 = DummyPConfig(options, 'process2', __file__, priority=2, startsecs=0.01)
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig1, pconfig2)
        from supervisor.process import ProcessStates
    ...
    def test_startProcessGroup(self):
        options = DummyOptions()
        pconfig1 = DummyPConfig(options, 'process1', __file__, priority=1, startsecs=0.01)
        pconfig2 = DummyPConfig(options, 'process2', __file__, priority=2, startsecs=0.01)
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig1, pconfig2)
        from supervisor.process import ProcessStates
    ...
    def test_startProcessGroup_badname(self):
        ...
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.startProcessGroup, 'foo')
    ...
    def test_stopProcess_bad_name(self):
        ...
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError(Faults.BAD_NAME, interface.stopProcess, 'foo')
    ...
    def test_stopProcessGroup_badname(self):
        ...
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.stopProcessGroup, 'foo')
    ...
    def test_signalProcess_badsignal(self):
        ...
        supervisord.set_procattr('foo', 'state', ProcessStates.RUNNING)
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_SIGNAL, interface.signalProcess, 'foo', 155)
    ...
    def test_signalProcess_notrunning(self):
        ...
        supervisord.set_procattr('foo', 'state', ProcessStates.STOPPED)
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.NOT_RUNNING, interface.signalProcess, 'foo', 10)
    ...
    def test_signalProcess_signal_returns_message(self):
        ...
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.FAILED, interface.signalProcess, 'foo', 10)
    ...
    def test_signalProcessGroup_nosuchgroup(self):
        ...
        supervisord.set_procattr('process2', 'state', ProcessStates.RUNNING)
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.signalProcessGroup, 'bar', 10)
    ...
    def test_getAllConfigInfo(self):
        ...
        pconfig1 = DummyPConfig(options, 'process1', __file__, stdout_logfile=Automatic,
          stderr_logfile=Automatic)
        pconfig2 = DummyPConfig(options, 'process2', __file__, stdout_logfile=None,
          stderr_logfile=None)
    ...
    def test_getProcessInfo(self):
        from supervisor.process import ProcessStates
        options = DummyOptions()
        config = DummyPConfig(options, 'foo', '/bin/foo', stdout_logfile='/tmp/fleeb.bar')
    ...
    def test_getProcessInfo_logfile_NONE(self):
        options = DummyOptions()
        config = DummyPConfig(options, 'foo', '/bin/foo', stdout_logfile=None)
        process = DummyProcess(config)
        process.pid = 111
        process.laststart = 10
        process.laststop = 11
    ...
    def test_getProcessInfo_bad_name_when_bad_process(self):
        ...
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.getProcessInfo, 'nonexistent')
    ...
    def test_getProcessInfo_bad_name_when_no_process(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.getProcessInfo, 'foo:')
    ...
    def test_getAllProcessInfo(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'gname', p1config, p2config)
        ...
        self.assertEqual(p2info['description'], starttime.strftime(_TIMEFORMAT))

    def test_readProcessStdoutLog_unreadable(self):
        from supervisor import xmlrpc
        options = DummyOptions()
        pconfig = DummyPConfig(options, 'process1', '/bin/process1', priority=1, stdout_logfile='/tmp/process1.log')
        supervisord = PopulatedDummySupervisor(options, 'process1', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError((xmlrpc.Faults.NO_FILE), (interface.readProcessStdoutLog),
          'process1',
          offset=0, length=1)
    ...
    def test_readProcessStdoutLog_badargs(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write('')
            self._assertRPCError((xmlrpc.Faults.BAD_ARGUMENTS), (interface.readProcessStdoutLog),
              'process1',
              offset=(-1), length=1)
            self._assertRPCError((xmlrpc.Faults.BAD_ARGUMENTS), (interface.readProcessStdoutLog),
              'process1', offset=(-1),
    ...
    def test_readProcessStdoutLog_bad_name_no_process(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError((xmlrpc.Faults.BAD_NAME), (interface.readProcessStdoutLog),
          'foo:*',
          offset=0, length=1)

    def test_readProcessStdoutLog(self):
        options = DummyOptions()
        pconfig = DummyPConfig(options, 'foo', '/bin/foo', stdout_logfile='/tmp/fooooooo')
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        process = supervisord.process_groups['foo'].processes['foo']
        logfile = process.config.stdout_logfile
    ...
    def test_readProcessLogAliasedTo_readProcessStdoutLog(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self.assertEqual(interface.readProcessLog, interface.readProcessStdoutLog)

    def test_readProcessStderrLog_unreadable(self):
        from supervisor import xmlrpc
        options = DummyOptions()
        pconfig = DummyPConfig(options, 'process1', '/bin/process1', priority=1, stderr_logfile='/tmp/process1.log')
        supervisord = PopulatedDummySupervisor(options, 'process1', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError((xmlrpc.Faults.NO_FILE), (interface.readProcessStderrLog),
          'process1',
          offset=0, length=1)
    ...
    def test_readProcessStderrLog_badargs(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write('')
            self._assertRPCError((xmlrpc.Faults.BAD_ARGUMENTS), (interface.readProcessStderrLog),
              'process1',
              offset=(-1), length=1)
            self._assertRPCError((xmlrpc.Faults.BAD_ARGUMENTS), (interface.readProcessStderrLog),
              'process1', offset=(-1),
    ...
    def test_readProcessStderrLog_bad_name_no_process(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError((xmlrpc.Faults.BAD_NAME), (interface.readProcessStderrLog),
          'foo:*',
          offset=0, length=1)

    def test_readProcessStderrLog(self):
        options = DummyOptions()
        pconfig = DummyPConfig(options, 'foo', '/bin/foo', stderr_logfile='/tmp/fooooooo')
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        process = supervisord.process_groups['foo'].processes['foo']
        logfile = process.config.stderr_logfile
    ...
    def test_tailProcessStdoutLog_bad_name(self):
        ...
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.tailProcessStdoutLog, 'BAD_NAME', 0, 10)
    ...
    def test_tailProcessStdoutLog_bad_name_no_process(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.tailProcessStdoutLog, 'foo:*', 0, 10)
    ...
    def test_tailProcessStdoutLog_all(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write(letters)
            data, offset, overflow = interface.tailProcessStdoutLog('foo', offset=0,
              length=(len(letters)))
    ...
    def test_tailProcessStdoutLog_none(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write(letters)
            data, offset, overflow = interface.tailProcessStdoutLog('foo', offset=(len(letters)),
              length=100)
            self.assertEqual(interface.update_text, 'tailProcessStdoutLog')
            self.assertEqual(overflow, False)
            self.assertEqual(offset, len(letters))
            self.assertEqual(data, '')
            data, offset, overflow = interface.tailProcessStdoutLog('foo', offset=(len(letters) + 5),
              length=100)
            self.assertEqual(interface.update_text, 'tailProcessStdoutLog')
            self.assertEqual(overflow, False)
            self.assertEqual(offset, len(letters))
    ...
    def test_tailProcessLogAliasedTo_tailProcessStdoutLog(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self.assertEqual(interface.tailProcessLog, interface.tailProcessStdoutLog)

    def test_tailProcessStderrLog_bad_name(self):
        from supervisor import xmlrpc
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.tailProcessStderrLog, 'BAD_NAME', 0, 10)
    ...
    def test_tailProcessStderrLog_bad_name_no_process(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.tailProcessStderrLog, 'foo:*', 0, 10)
    ...
    def test_tailProcessStderrLog_all(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write(letters)
            data, offset, overflow = interface.tailProcessStderrLog('foo', offset=0,
              length=(len(letters)))
    ...
    def test_tailProcessStderrLog_none(self):
        ...
        try:
            with open(logfile, 'w+') as (f):
                f.write(letters)
            data, offset, overflow = interface.tailProcessStderrLog('foo', offset=(len(letters)),
              length=100)
            self.assertEqual(interface.update_text, 'tailProcessStderrLog')
            self.assertEqual(overflow, False)
            self.assertEqual(offset, len(letters))
            self.assertEqual(data, '')
            data, offset, overflow = interface.tailProcessStderrLog('foo', offset=(len(letters) + 5),
              length=100)
            self.assertEqual(interface.update_text, 'tailProcessStderrLog')
            self.assertEqual(overflow, False)
            self.assertEqual(offset, len(letters))
    ...
    def test_clearProcessLogs_bad_name_no_group(self):
        ...
        supervisord = DummySupervisor(process_groups={'foo': pgroup})
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.clearProcessLogs, 'badgroup')
    ...
    def test_clearProcessLogs_bad_name_no_process(self):
        ...
        supervisord = DummySupervisor(process_groups={'foo': pgroup})
        interface = self._makeOne(supervisord)
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.clearProcessLogs, 'foo:*')
    ...
    def test_clearProcessLogAliasedTo_clearProcessLogs(self):
        ...
        supervisord = PopulatedDummySupervisor(options, 'foo', pconfig)
        interface = self._makeOne(supervisord)
        self.assertEqual(interface.clearProcessLog, interface.clearProcessLogs)
    ...
    def test_clearAllProcessLogs(self):
        ...
        results = callback()
        from supervisor import xmlrpc
        self.assertEqual(results[0], {'name':'process1', 
         'group':'foo', 
         'status':xmlrpc.Faults.SUCCESS, 
         'description':'OK'})
        self.assertEqual(results[1], {'name':'process2', 
         'group':'foo', 
         'status':xmlrpc.Faults.SUCCESS, 
         'description':'OK'})
        process1 = supervisord.process_groups['foo'].processes['process1']
    ...
    def test_sendProcessStdin_raises_incorrect_params_when_not_chars(self):
        ...
        thing_not_chars = 42
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.INCORRECT_PARAMETERS, interface.sendProcessStdin, 'process1', thing_not_chars)

    def test_sendProcessStdin_raises_bad_name_when_bad_process(self):
        supervisord = DummySupervisor()
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.sendProcessStdin, 'nonexistent', 'chars for stdin')
    ...
    def test_sendProcessStdin_raises_bad_name_when_no_process(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.BAD_NAME, interface.sendProcessStdin, 'foo:*', 'chars for stdin')
    ...
    def test_sendProcessStdin_raises_not_running_when_not_process_pid(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.NOT_RUNNING, interface.sendProcessStdin, 'process1', 'chars for stdin')
    ...
    def test_sendProcessStdin_raises_no_file_when_write_raises_epipe(self):
        ...
        interface = self._makeOne(supervisord)
        from supervisor import xmlrpc
        self._assertRPCError(xmlrpc.Faults.NO_FILE, interface.sendProcessStdin, 'process1', 'chars for stdin')
    ...
    def test_sendProcessStdin_reraises_other_oserrors(self):
        ...
        interface = self._makeOne(supervisord)
        self.assertRaises(OSError, interface.sendProcessStdin, 'process1', 'chars for stdin')
    ...
    def test_sendRemoteCommEvent_unicode_encoded_to_utf8(self):
        ...
        try:
            events.callbacks[:] = [(events.RemoteCommunicationEvent, callback)]
            result = interface.sendRemoteCommEvent(as_string('fií once'), as_string('fií twice'))
        finally:
            events.callbacks[:] = []
            events.clear()
        ...
        event = L[0]
        if PY2:
            self.assertEqual(event.type, 'fiÃ\xad once')
            self.assertEqual(event.data, 'fiÃ\xad twice')
        else:
...
class SystemNamespaceXMLRPCInterfaceTests(TestBase):
    ...
    def test_methodSignature(self):
        from supervisor import xmlrpc
        interface = self._makeOne()
        self._assertRPCError(xmlrpc.Faults.SIGNATURE_UNSUPPORTED, interface.methodSignature, [
         'foo.bar'])
    ...
    def test_allMethodDocs(self):
        from supervisor import xmlrpc
        _RPCTYPES = [
         'int', 'double', 'string', 'boolean', 'dateTime.iso8601',
        ...
        for k in methods.keys():
            try:
                ...
                raise AssertionError('methodSignature for %s raises RPCError (missing @return doc?)' % k)
            else:
        ...
        for thing in parsed:
            if thing[1] == 'param':
                plines.append(thing[0])
                ptypes.append(thing[2])
                pnames.append(thing[3])
                ptexts.append(thing[4])
            elif thing[1] == 'return':
                rlines.append(thing[0])
                rtypes.append(thing[2])
                rnames.append(thing[3])
                rtexts.append(thing[4])
        else:
            if thing[1] is not None:
                raise AssertionError('unknown tag type %s for %s, parsed %s' % (thing[1],
                 k,
                 parsed))
            if len(argnames) != len(pnames):
                raise AssertionError('Incorrect documentation (%s args, %s doc params) in %s' % (
            ...
            for doctype in ptypes:
                ...
                for x in range(len(pnames)):
                    ...
                    for doctext in ptexts:
                        ...
                        if len(rlines) > 1:
                            raise AssertionError('Duplicate @return values in docs for %s' % k)
    ...
    def test_multicall_recursion_guard(self):
        ...
        results = interface.multicall([
         {'methodName':'system.multicall', 
          'params':[]}])
        e = xmlrpc.RPCError(xmlrpc.Faults.INCORRECT_PARAMETERS, 'Recursive system.multicall forbidden')
    ...
    def test_methodHelp(self):
        from supervisor import xmlrpc
        interface = self._makeOne()
        self._assertRPCError(xmlrpc.Faults.SIGNATURE_UNSUPPORTED, interface.methodHelp, [
         'foo.bar'])
...
class Test_make_main_rpcinterface(unittest.TestCase):
    ...
    def test_it(self):
        ...
        self.assertEqual(inst.__class__.__name__, 'SupervisorNamespaceRPCInterface')
