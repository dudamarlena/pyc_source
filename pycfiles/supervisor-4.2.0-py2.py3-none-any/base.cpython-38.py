...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/supervisor/tests/base.py
        ...
        class DummyOptions:
            ...
            def make_pipes(self, stderr=True):
                if self.make_pipes_error:
                    ...
                    pipes = {'child_stdin':3, 
                     'stdin':4,  'stdout':5,  'child_stdout':6}
                    if stderr:
            ...
            def startProcessGroup(self, name):
                ...
                return [
                 {'name':'foo_00',  'group':'foo',  'status':xmlrpc.Faults.SUCCESS, 
                  'description':'OK'},
                 {'name':'foo_01', 
                  'group':'foo',  'status':xmlrpc.Faults.SUCCESS, 
                  'description':'OK'}]
            ...
            def startAllProcesses(self):
                ...
                return [
                 {'name':'foo', 
                  ...
                  'description':'OK'},
                 {'name':'foo2', 
                  'group':'foo2',  'status':xmlrpc.Faults.SUCCESS, 
                  'description':'OK'},
                 {'name':'failed', 
                  'group':'failed_group',  'status':xmlrpc.Faults.SPAWN_ERROR, 
            ...
            def stopAllProcesses(self):
                ...
                return [
                 ...
                 {'name':'foo2', 
                  ...
                  'description':'OK'},
                 {'name':'failed', 
                  'group':'failed_group',  'status':xmlrpc.Faults.BAD_NAME, 
                  'description':'FAILED'}]
