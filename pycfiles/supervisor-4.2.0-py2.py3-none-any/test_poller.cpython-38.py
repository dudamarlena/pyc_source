...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/supervisor/tests/test_poller.py
# Compiled at: 2019-04-05 17:19:18
# Size of source mod 2**32: 16693 bytes
...
class SelectPollerTests(unittest.TestCase):
    ...
    def test_unregister_readable(self):
        ...
        poller.unregister_readable(100)
    ...
    def test_unregister_writable(self):
        ...
        poller.unregister_writable(100)
