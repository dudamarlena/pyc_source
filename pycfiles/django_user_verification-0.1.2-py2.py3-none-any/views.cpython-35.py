...
# [GCC 8.4.0]
# Embedded file name: /Users/pauloostenrijk/WebProjects/django-user-verification/verification/views.py
# Compiled at: 2016-05-20 11:06:17
...
class VerificationRedirectorView(TemplateView):
    ...
    def get_context_data(self, code=None, verification_type=None, *args, **kwargs):
        ...
        context['redirect_url'] = '{}{}/{}'.format(service_settings.get('APP_URL'), verification_type, code)
        return context
