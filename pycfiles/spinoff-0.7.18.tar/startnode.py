...
# [GCC 8.4.0]
# Embedded file name: /Users/erik.allik/w/spinoff/twisted/plugins/startnode.py
# Compiled at: 2013-03-04 16:07:34
...
class Options(usage.Options):
    optParameters = [
     ...
     [
      'params', 'i', _EMPTY, 'Parameters to [i]nitialize the actor with.\n\nParsed as `dict(<params>)` and passed as **kwargs.\n\n\x08'],
     [
