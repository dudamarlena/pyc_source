...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-social-api/social_api/tests.py
# Compiled at: 2016-04-02 09:00:55
import mock
...
class SocialApiUnitTest(TestCase):
    ...
    def test_social_auth_user_argument(self):
        ...
        UserSocialAuth.objects.create(user=get_user_model().objects.create(), uid=2, provider='vk-oauth2', extra_data='{"access_token": "qwewekrjhshe", "expires": null, "id": null}')
        UserSocialAuth.objects.create(user=user, uid=1, provider='vk-oauth2', extra_data='{"access_token": "%s", "expires": null, "id": null}' % TOKEN)
    ...
    def test_oauth_tokens_tag_argument(self):
        ...
        UserSocialAuth.objects.create(user=get_user_model().objects.create(), uid=1, provider='vk-oauth2', extra_data='{"access_token": "qwewekrjhshe", "expires": null, "id": null}')
    ...
    def test_get_tokens(self):
        ...
        for i in range(0, 5):
            UserSocialAuth.objects.create(user=get_user_model().objects.create(username=i), uid=i, provider='vk-oauth2', extra_data='{"access_token": "qwewekrjhshe"}')
