...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-social-api/social_api/storages/social_auth.py
# Compiled at: 2016-02-14 10:25:30
from social.apps.django_app.default.models import UserSocialAuth
from django.conf import settings
from django.core.exceptions import ImproperlyConfigured
from .base import TokensStorageAbstractBase
PROVIDERS_MAP = getattr(settings, 'SOCIAL_API_SOCIAL_AUTH_PROVIDERS_MAP', {'vkontakte': 'vk-oauth2', 
   'instagram': 'instagram', 
   'facebook': 'facebook', 
...
class SocialAuthTokensStorage(TokensStorageAbstractBase):
    ...
    def get_provider(self):
        try:
            ...
            raise ImproperlyConfigured('Specify SOCIAL_API_SOCIAL_AUTH_PROVIDERS_MAP in settings with value for provider %s', self.provider)
