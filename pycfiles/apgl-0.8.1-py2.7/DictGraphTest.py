...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/apgl/graph/test/DictGraphTest.py
# Compiled at: 2013-10-17 15:21:39
...
class DictGraphTest(unittest.TestCase):
    ...
    def testOutDegreeSequence(self):
        ...
        self.assertTrue((degSeq == numpy.array([3, 2, 3, 2.0])).all())
