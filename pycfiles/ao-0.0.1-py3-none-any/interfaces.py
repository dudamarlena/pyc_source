...
# Embedded file name: build/bdist.linux-i686/egg/anz/dashboard/interfaces.py
...
class IWidgetView(Interface):
    ...
    def getWidgets(check_visibility=True, check_permissions=True, check_condition=True, retJson=True):
    ...
    def getWidget(id, check_visibility=True, check_permissions=True, check_condition=True, retJson=True):
...
class IDashboardEditView(Interface):
    ...
    def editPage(pageIndex, title='Untitled page', width=100, style='', retJson=True):
    ...
    def addWidget(widgetId, pageIndex, columnIndex, widgetIndex=0, retJson=True):
    ...
    def changeWidgetColor(pageIndex, columnIndex, widgetIndex, color, retJson=True):
    ...
    def changeWidgetOptions(pageIndex, columnIndex, widgetIndex, names=[], retJson=True, **kw):
    ...
    def collapseWidget(pageIndex, columnIndex, widgetIndex, collapse, retJson=True):
    ...
    def moveWidget(pageIndex, columnIndex, widgetIndex, toPage, toColumn, toWidget, retJson=True):
        """ Move a widget to specific position.
...
class IFolderContentsWidgetView(Interface):
    ...
    def items(paths=[], searchSub=False, portal_types=[], recentDays=0, sort_limit=0, sort_order='desc', sort_on='modified', cachetime=300, retJson=True):
