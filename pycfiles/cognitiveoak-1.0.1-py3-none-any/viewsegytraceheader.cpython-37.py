...
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\viewsegytraceheader.py
# Compiled at: 2019-12-13 23:42:45
# Size of source mod 2**32: 39303 bytes
...
class viewsegytraceheader(object):
    ...
    def retranslateGUI(self, ViewSegyTraceHeader):
        ...
        self.lblhelp.setText(_translate('ViewSegyTraceHeader', '<a href="https://seg.org/Portals/0/SEG/News%20and%20Resources/Technical%20Standards/seg_y_rev1.pdf">SEG-Y Format</a>'))
    ...
    def showTraceHeader(self, tracenum):
        ...
        _rowheader = [
         'line_sequence_num (1-4)', 'file_sequence_num (5-8)',
        ...
        if os.path.exists(self.segyfile):
            ...
            for _idx in _traceidx:
                ...
                _item = QtWidgets.QTableWidgetItem()
                _item.setText(str(_header.geophone_group_num_first_trace_original_field))
                _item.setFlags(QtCore.Qt.ItemIsEditable)
                _item.setTextAlignment(QtCore.Qt.AlignCenter)
                self.twgheader.setItem(67, _idx, _item)
                _item = QtWidgets.QTableWidgetItem()
                _item.setText(str(_header.geophone_group_num_last_trace_original_field))
                _item.setFlags(QtCore.Qt.ItemIsEditable)
                _item.setTextAlignment(QtCore.Qt.AlignCenter)
