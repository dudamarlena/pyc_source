...
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\seismic\visualization.py
# Compiled at: 2019-12-15 18:54:42
# Size of source mod 2**32: 184481 bytes
...
def plotSeisILSliceFrom2DMat(seis2dmat, inlsls=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, verbose=True):
    """
    ...
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisILSliceFrom2DMat: Not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisILSliceFrom2DMat: Not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisILSliceFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
        ...
        sys.exit()
    seisinfo = seis_ays.getSeisInfoFrom2DMat(seis2dmat, inlcol=inlcol,
      xlcol=xlcol,
      zcol=zcol)
    ...
    if inlnum == 1:
        inlstep = 1
    if inlsls is None:
        vis_msg.print('WARNING in plotSeisILSliceFrom2DMat: to plot all inline slices in 2D seismic matrix', type='warning')
        inlsls = inlrange
    if np.ndim(inlsls) != 1:
    ...
    for i in range(ninlsls):
        ...
        if idx >= 0 and idx < inlnum:
            ...
            plt.pcolormesh(x, y, seisdata, cmap=(vis_cmap.makeColorMap(colormap, flipcmap)),
              shading='gouraud',
              vmin=valuemin,
              vmax=valuemax)
...
def plotSeisILSlicePlayerFrom2DMat(seis2dmat, initinlsl=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, interpolation='bicubic', playerconfig=None, fontstyle=None, qicon=None):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisILSlicePlayerFrom2DMat: Not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisILSlicePlayerFrom2DMat: Not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisILSlicePlayerFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
        vis_msg.print('ERROR in plotSeisILSlicePlayerFrom2DMat: Not z column found in 2D seismic matrix', type='error')
        sys.exit()
    seisinfo = seis_ays.getSeisInfoFrom2DMat(seis2dmat, inlcol=inlcol,
      xlcol=xlcol,
      zcol=zcol)
    ...
    if initinlsl is None:
        vis_msg.print('WARNING in plotSeisILSlicePlayerFrom2DMat: to be initialized by the first inline slice in 2D seismic matrix', type='warning')
    ...
    def process_key(event):
        ...
        if event.key == playerconfig['First'].lower():
            first_slice(ax, pref='Inline No. ', surf=titlesurf, idxlist=inlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Previous'].lower():
            previous_slice(ax, step=(playerconfig['Interval']), pref='Inline No. ', surf=titlesurf, idxlist=inlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Next'].lower():
            next_slice(ax, step=(playerconfig['Interval']), pref='Inline No. ', surf=titlesurf, idxlist=inlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Last'].lower():
            last_slice(ax, pref='Inline No. ', surf=titlesurf, idxlist=inlrange)
            fig.canvas.draw()
    ...
    cat = ax.imshow((volume[ax.index]), aspect='auto',
      extent=[
     xlstart, xlend, zend, zstart],
...
def plotSeisILSliceFrom3DMat(seis3dmat, inlsls=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, verbose=True):
    """
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in plotSeisILSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
    ...
    if inlnum == 1:
        inlstep = 1
    if inlsls is None:
        vis_msg.print('WARNING in plotSeisILSliceFrom3DMat: to plot all inline slices in 3D seismic matrix', type='warning')
        inlsls = inlrange
    if np.ndim(inlsls) != 1:
...
def plotSeisILSlicePlayerFrom3DMat(seis3dmat, initinlsl=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, interpolation='bicubic', playerconfig=None, fontstyle=None, qicon=None):
    """
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in plotSeisILSlicePlayerFrom3DMat: SeisInfo automatically generated', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    inlrange = seisinfo['ILRange']
    xlrange = seisinfo['XLRange']
    zrange = seisinfo['ZRange']
...
def plotSeisXLSliceFrom2DMat(seis2dmat, xlsls=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, verbose=True):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisXLSliceFrom2DMat: not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisXLSliceFrom2DMat: not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisXLSliceFrom2DMat: not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
        vis_msg.print('ERROR in plotSeisXLSliceFrom2DMat: not z column found in 2D seismic matrix', type='error')
        sys.exit()
    seisinfo = seis_ays.getSeisInfoFrom2DMat(seis2dmat, inlcol=inlcol,
      xlcol=xlcol,
      zcol=zcol)
    ...
    if xlnum == 1:
        xlstep = 1
    if xlsls is None:
        vis_msg.print('WARNING in plotSeisXLSliceFrom2DMat: to plot all crossline slices in 2D seismic matrix', type='warning')
        xlsls = xlrange
    if np.ndim(xlsls) != 1:
...
def plotSeisXLSlicePlayerFrom2DMat(seis2dmat, initxsl=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, interpolation='bicubic', playerconfig=None, fontstyle=None, qicon=None):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisXLSlicePlayerFrom2DMat: not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisXLSlicePlayerFrom2DMat: not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisXLSlicePlayerFrom2DMat: not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
        vis_msg.print('ERROR in plotSeisXLSlicePlayerFrom2DMat: not z column found in 2D seismic matrix', type='error')
        sys.exit()
    seisinfo = seis_ays.getSeisInfoFrom2DMat(seis2dmat, inlcol=inlcol,
      xlcol=xlcol,
      zcol=zcol)
    ...
    if xlnum == 1:
        xlstep = 1
    if initxsl is None:
        vis_msg.print('WARNING in plotSeisXLSlicePlayerFrom2DMat: to be initialized by the first crossline slice in the 2D seismic matrix', type='warning')
        initxsl = xlrange[0]
    if playerconfig is None:
        playerconfig = {}
        playerconfig['First'] = 'A'
    ...
    def process_key(event):
        ...
        ax = fig.axes[0]
        if event.key == playerconfig['First'].lower():
            first_slice(ax, pref='Crossline No. ', surf=titlesurf, idxlist=xlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Previous'].lower():
            previous_slice(ax, step=(playerconfig['Interval']), pref='Crossline No. ', surf=titlesurf, idxlist=xlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Next'].lower():
            next_slice(ax, step=(playerconfig['Interval']), pref='Crossline No. ', surf=titlesurf, idxlist=xlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Last'].lower():
            last_slice(ax, pref='Crossline No. ', surf=titlesurf, idxlist=xlrange)
            fig.canvas.draw()
        if event.key == playerconfig['Backward'].lower():
            while True:
                previous_slice(ax, step=(playerconfig['Interval']), pref='Crossline No. ', surf=titlesurf, idxlist=xlrange)
...
def plotSeisXLSliceFrom3DMat(seis3dmat, xlsls=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, verbose=True):
    """
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in plotSeisXLFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    inlrange = seisinfo['ILRange']
    xlrange = seisinfo['XLRange']
    zrange = seisinfo['ZRange']
    ...
    if xlnum == 1:
        xlstep = 1
    if xlsls is None:
        vis_msg.print('WARNING in plotSeisXLSliceFrom3DMat: to plot all crossline slices in 3D seismic matrix', type='warning')
        xlsls = xlrange
    if np.ndim(xlsls) != 1:
...
def plotSeisXLSlicePlayerFrom3DMat(seis3dmat, initxsl=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, interpolation='bicubic', playerconfig=None, fontstyle=None, qicon=None):
    """
    ...
    if xlnum == 1:
        xlstep = 1
    if initxsl is None:
        vis_msg.print('WARNING in plotSeisXLSlicePlayerFrom3DMat: to be initialized by the first crossline slice in the 3D seismic matrix', type='warning')
        initxsl = xlrange[0]
    if playerconfig is None:
        playerconfig = {}
        playerconfig['First'] = 'A'
...
def plotSeisZSliceFrom2DMat(seis2dmat, zsls=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, verbose=True):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisZSliceFrom2DMat: Not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisZSliceFrom2DMat: Not inline column found in 2D seismic matrix', 'error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisZSliceFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
...
def plotSeisZSlicePlayerFrom2DMat(seis2dmat, initzsl=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, interpolation='bicubic', playerconfig=None, fontstyle=None, qicon=None):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisZSlicePlayerFrom2DMat: Not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisZSlicePlayerFrom2DMat: Not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisZSlicePlayerFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
        vis_msg.print('ERROR in plotSeisZSlicePlayerFrom2DMat: Not z column found in 2D seismic matrix', type='error')
        sys.exit()
    seisinfo = seis_ays.getSeisInfoFrom2DMat(seis2dmat, inlcol=inlcol,
      xlcol=xlcol,
      zcol=zcol)
    ...
    if znum == 1:
        zstep = -1
    if initzsl is None:
        vis_msg.print('WARNING in plotSeisZSlicePlayerFrom2DMat: to be initizlied with the first slice', type='warning')
        initzsl = zrange[0]
    if playerconfig is None:
        playerconfig = {}
        playerconfig['First'] = 'A'
    ...
    def process_key(event):
        ...
        ax = fig.axes[0]
        if event.key == playerconfig['First'].lower():
            first_slice(ax, pref='Depth/Time at ', surf=titlesurf, idxlist=zrange)
            fig.canvas.draw()
        if event.key == playerconfig['Previous'].lower():
            previous_slice(ax, step=(playerconfig['Interval']), pref='Depth/Time at ', surf=titlesurf, idxlist=zrange)
            fig.canvas.draw()
        if event.key == playerconfig['Next'].lower():
            next_slice(ax, step=(playerconfig['Interval']), pref='Depth/Time at ', surf=titlesurf, idxlist=zrange)
            fig.canvas.draw()
        if event.key == playerconfig['Last'].lower():
            last_slice(ax, pref='Depth/Time at ', surf=titlesurf, idxlist=zrange)
            fig.canvas.draw()
        if event.key == playerconfig['Backward'].lower():
            while True:
                previous_slice(ax, step=(playerconfig['Interval']), pref='Depth/Time at ', surf=titlesurf, idxlist=zrange)
...
def plotSeisZTracePlayerFrom2DMat(seis2dmat, initinltc=None, initxltc=None, datacol=3, inlcol=0, xlcol=1, zcol=2, valuemin=-1.0, valuemax=1.0, color='blue', marker=None, linewidth=12, linestyle='solid', titlesurf='', playerconfiginl=None, playerconfigxl=None, fontstyle=None, qicon=None):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in plotSeisZTracePlayerFrom2DMat: Not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in plotSeisZTracePlayerFrom2DMat: Not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in plotSeisZTracePlayerFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
    ...
    if initinltc is None:
        vis_msg.print('WARNING in plotSeisZTracePlayerFrom2DMat: to be initialized by the first inline trace in 2D seismic matrix', type='warning')
        initinltc = inlrange[0]
    if initxltc is None:
        vis_msg.print('WARNING in plotSeisZTracePlayerFrom2DMat: to be initialized by the first crossline trace in 2D seismic matrix', type='warning')
        initxltc = xlrange[0]
    ...
    def process_key(event):
        ...
        if event.key == playerconfiginl['First'].lower():
            first_trace_y(ax, [xlnum, inlnum], pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        if event.key == playerconfiginl['Previous'].lower():
            previous_trace_y(ax, [xlnum, inlnum], step_y=(playerconfiginl['Interval']), pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        if event.key == playerconfiginl['Next'].lower():
            next_trace_y(ax, [xlnum, inlnum], step_y=(playerconfiginl['Interval']), pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        if event.key == playerconfiginl['Last'].lower():
            last_trace_y(ax, [xlnum, inlnum], pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        ...
        if event.key == playerconfigxl['First'].lower():
            first_trace_x(ax, [xlnum, inlnum], pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        if event.key == playerconfigxl['Previous'].lower():
            previous_trace_x(ax, [xlnum, inlnum], step_x=(playerconfigxl['Interval']), pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        if event.key == playerconfigxl['Next'].lower():
            next_trace_x(ax, [xlnum, inlnum], step_x=(playerconfigxl['Interval']), pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
        if event.key == playerconfigxl['Last'].lower():
            last_trace_x(ax, [xlnum, inlnum], pref=(titlesurf + ' at '), surf='', idxlist_x=xlrange,
              idxlist_y=inlrange)
            fig.canvas.draw()
    ...
    ax.plot(zrange, (volume[:, ax.index]), color=color,
      marker=marker,
      linewidth=linewidth,
      linestyle=linestyle)
    ax.invert_xaxis()
...
def plotSeisZSliceFrom3DMat(seis3dmat, zsls=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, verbose=True):
    """
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in plotSeisZSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    inlrange = seisinfo['ILRange']
    xlrange = seisinfo['XLRange']
    zrange = seisinfo['ZRange']
    ...
    if znum == 1:
        zstep = -1
    if zsls is None:
        vis_msg.print('WARNING in plotSeisZSliceFrom3DMat: to plot all z sections in 3D seismic matrix', type='warning')
        zsls = zrange
    if np.ndim(zsls) != 1:
...
def plotSeisZSlicePlayerFrom3DMat(seis3dmat, initzsl=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, titlesurf='', colorbaron=False, interpolation='bicubic', playerconfig=None, fontstyle=None, qicon=None):
    """
...
def plotSeisZTracePlayerFrom3DMat(seis3dmat, initinltc=None, initxltc=None, seisinfo=None, valuemin=-1.0, valuemax=1.0, color='blue', markerstyle=None, markersize=12, linewidth=12, linestyle='solid', titlesurf='', playerconfiginl=None, playerconfigxl=None, fontstyle=None, qicon=None):
    """
...
def plotSeisILXLZSliceFrom3DMat(seis3dmat, inlsls=None, xlsls=None, zsls=None, seisinfo=None, colormap=None, flipcmap=False, interpolation='bicubic', zscale=1.0, valuemin=-1.0, valuemax=1.0, surveyboxon=True, viewerconfig=None, verbose=True):
    """
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in plotSeisILXLZSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    ...
    if znum == 1:
        zstep = 1
    if inlsls is None:
        vis_msg.print('WARNING in plotSeisILXLZSliceFrom3DMat: to plot the middle inline slice in 3D seismic matrix', type='warning')
        inlsls = inlrange[int(inlnum / 2):int(inlnum / 2) + 1]
    if xlsls is None:
        vis_msg.print('WARNING in plotSeisILXLZSliceFrom3DMat: to plot the middle crossline slice in 3D seismic matrix', type='warning')
        xlsls = xlrange[int(xlnum / 2):int(xlnum / 2) + 1]
    if zsls is None:
        vis_msg.print('WARNING in plotSeisILXLZSliceFrom3DMat: to plot the middle z slice in 3D seismic matrix', type='warning')
    ...
    if surveyboxon:
        for p in ([xlstart, inlstart, zend, xlend, inlstart, zend], [xlstart, inlstart, zend, xlstart, inlend, zend],
         [
    ...
    for i in range(ninlsls):
        ...
        if idx >= 0 and idx < inlnum:
            seisdata = seis3dmat[:, :, idx]
            slice_inl = scene.visuals.Image(seisdata, parent=(view.scene), grid=(zscale * znum, xlnum), cmap=cmp,
              clim=(valuemin, valuemax),
              interpolation=interpolation)
    ...
    for i in range(nxlsls):
        ...
        if idx >= 0 and idx < xlnum:
            seisdata = seis3dmat[:, idx, :]
            slice_xl = scene.visuals.Image(seisdata, parent=(view.scene), cmap=cmp,
              clim=(valuemin, valuemax),
              interpolation=interpolation)
    ...
    for i in range(nzsls):
        ...
        if idx >= 0 and idx < znum:
            seisdata = seis3dmat[idx, :, :]
            slice_z = scene.visuals.Image(seisdata, parent=(view.scene), cmap=cmp,
              clim=(valuemin, valuemax),
              interpolation=interpolation)
...
def plotSeisILXLZSlicePlayerFrom3DMat(seis3dmat, initinlsl=None, initxlsl=None, initzsl=None, seisinfo=None, colormap=None, flipcmap=False, interpolation='bicubic', zscale=1.0, valuemin=-1.0, valuemax=1.0, surveyboxon=True, viewerconfig=None, playerconfiginl=None, playerconfigxl=None, playerconfigz=None, qicon=None):
    """
    Plot seismic inline, crossline, and z slices from 3D matrix (by vispy.Image)
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        if seisinfo is None:
            vis_msg.print('WARNING in plotSeisILXLZSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
            seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
        elif viewerconfig is None:
            viewerconfig = {}
            viewerconfig['Home'] = 'U'
            viewerconfig['Inline'] = 'I'
            viewerconfig['Crossline'] = 'X'
            viewerconfig['Z'] = 'Z'
        elif playerconfiginl is None:
            playerconfiginl = {}
            playerconfiginl['First'] = 'A'
            playerconfiginl['Previous'] = 'S'
            playerconfiginl['Next'] = 'D'
            ...
            if playerconfigz is None:
                ...
                canvas = scene.SceneCanvas(keys='interactive', title='3D seismic', bgcolor=[0.5, 0.5, 0.5], size=(1000,
                                                                                                                  800),
                  app='pyqt5')
                view = canvas.central_widget.add_view()
                if surveyboxon:
                    for p in ([xlstart - 0.5 * xlstep, inlstart - 0.5 * inlstep, zend + 0.5 * zstep, xlend + 0.5 * xlstep, inlstart - 0.5 * inlstep, zend + 0.5 * zstep],
                     [
                     ...
                     [
                      ...
                      inlstart - 0.5 * inlstep, zstart - 0.5 * zstep]):
                        scene.visuals.Line(pos=(np.array([[p[0], p[1], p[2]], [p[3], p[4], p[5]]])), color='black',
                          parent=(view.scene))
                ...
                if current_inl is not None:
                    ...
                    if idx >= 0 and idx < inlnum and znum > 1:
                        if xlnum > 1:
                            seisdata = seis3dmat[:, :, idx]
                            slice_inl = scene.visuals.Image(seisdata, parent=(view.scene), cmap=cmp,
                              clim=(valuemin, valuemax),
                              interpolation=interpolation)
                            tr_inl = scene.transforms.MatrixTransform()
                ...
                if current_xl is not None:
                    ...
                    if idx >= 0 and idx < xlnum and znum > 1:
                        if inlnum > 1:
                            seisdata = seis3dmat[:, idx, :]
                            slice_xl = scene.visuals.Image(seisdata, parent=(view.scene), cmap=cmp,
                              clim=(valuemin, valuemax),
        ...
        _x0 = 0.5 * (xlstart + xlend)
        _y0 = 0.5 * (inlstart + inlend)
        _z0 = 0.5 * (zstart + zend)
        _len = np.max(np.abs(np.array([xlstep, inlstep, zstep])))
        xyzaxis = scene.visuals.XYZAxis(parent=(view.scene), pos=(np.array([[_x0, _y0, _z0], [_x0 + _len, _y0, _z0],
         [
        ...
        def press_key(event):
            if event.key == viewerconfig['Home'].lower():
                ...
                cam.set_range((xlstart, xlend), (inlstart, inlend), (zend, zstart))
                view.camera = cam
            elif event.key == viewerconfig['Inline'].lower():
                cam = scene.TurntableCamera(elevation=0, azimuth=0)
                cam.set_range((xlstart, xlend), (inlstart, inlend), (zend, zstart))
                view.camera = cam
            elif event.key == viewerconfig['Crossline'].lower():
                cam = scene.TurntableCamera(elevation=0, azimuth=90)
                cam.set_range((xlstart, xlend), (inlstart, inlend), (zend, zstart))
                view.camera = cam
            else:
                if event.key == viewerconfig['Z'].lower():
                    ...
                    cam.set_range((xlstart, xlend), (inlstart, inlend), (zend, zstart))
                    view.camera = cam
                elif event.key == playerconfiginl['First'].lower():
                    ...
                    if event.key == playerconfiginl['Previous'].lower():
                        current_inl = current_slices.inl
                        if current_inl is not None and znum > 1:
                            if xlnum > 1:
                                idx = ((current_inl - inlstart) / inlstep).astype(np.int32)
                                tr_inl.translate((0, -current_inl, 0))
                    ...
                    if event.key == playerconfigxl['First'].lower():
                        ...
                        if current_xl is not None and znum > 1:
                            if inlnum > 1:
                    ...
                    if event.key == playerconfigz['First'].lower():
                        ...
                        if current_z is not None and inlnum > 1:
                            if xlnum > 1:
                ...
                elif event.key == playerconfigz['Next'].lower():
                    current_z = current_slices.z
                    if current_z is not None:
                        if inlnum > 1 and xlnum > 1:
                            idx = ((current_z - zstart) / zstep).astype(np.int32)
                            tr_z.translate((0, 0, -current_z))
                            idx = (idx + playerconfigz['Interval']) % znum
                            slice_z.set_data(seis3dmat[idx, :, :])
        ...
        def resize_canvas(event):
            text_inlxlz.pos = (
             view.canvas.size[0] - 100, view.canvas.size[1] - 20)
...
def saveSeisILSliceFrom2DMat(seis2dmat, imagename='', inlsls=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, verbose=True, qpgsdlg=None):
    """
    ...
    if np.ndim(seis2dmat) != 2:
        ...
        sys.exit()
    if datacol < 0 or len(seis2dmat[0, :]) <= datacol:
        vis_msg.print('ERROR in saveSeisILSliceFrom2DMat: Not data column found in 2D seismic matrix', type='error')
        sys.exit()
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        vis_msg.print('ERROR in saveSeisILSliceFrom2DMat: Not inline column found in 2D seismic matrix', type='error')
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in saveSeisILSliceFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
        vis_msg.print('ERROR in saveSeisILSliceFrom2DMat: Not z column found in 2D seismic matrix', type='error')
        sys.exit()
    seisinfo = seis_ays.getSeisInfoFrom2DMat(seis2dmat, inlcol=inlcol,
      xlcol=xlcol,
      zcol=zcol)
    ...
    if inlnum == 1:
        inlstep = 1
    if inlsls is None:
        vis_msg.print('WARNING in saveSeisILSliceFrom2DMat: to save all inline slices in 2D seismic matrix', type='warning')
        inlsls = inlrange
    if np.ndim(inlsls) != 1:
...
def saveSeisILSliceFrom3DMat(seis3dmat, imagename='', inlsls=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, verbose=True, qpgsdlg=None):
    """
    Save seismic inline slices as image files (by matplotlib.pcolormesh)
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in saveSeisILSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    inlrange = seisinfo['ILRange']
    xlrange = seisinfo['XLRange']
    zrange = seisinfo['ZRange']
    ...
    if inlnum == 1:
        inlstep = 1
    if inlsls is None:
        vis_msg.print('WARNING in saveSeisILSliceFrom3DMat: to save all inline slices in 3D seismic matrix', type='warning')
        inlsls = inlrange
    if np.ndim(inlsls) != 1:
...
def saveSeisXLSliceFrom2DMat(seis2dmat, imagename='', xlsls=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, verbose=True, qpgsdlg=None):
    """
    ...
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        ...
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in saveSeisXLSliceFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
    ...
    if xlnum == 1:
        xlstep = 1
    if xlsls is None:
        vis_msg.print('WARNING in saveSeisXLSliceFrom2DMat: to save all crossline slices in 2D seismic matrix', type='warning')
        xlsls = xlrange
    if np.ndim(xlsls) != 1:
...
def saveSeisXLSliceFrom3DMat(seis3dmat, imagename='', xlsls=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, verbose=True, qpgsdlg=None):
    """
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in saveSeisXLSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    inlrange = seisinfo['ILRange']
    xlrange = seisinfo['XLRange']
    zrange = seisinfo['ZRange']
    ...
    if xlnum == 1:
        xlstep = 1
    if xlsls is None:
        vis_msg.print('WARNING in saveSeisXLSliceFrom3DMat: to save all crossline slices in 3D seismic matrix', type='warning')
        xlsls = xlrange
    if np.ndim(xlsls) != 1:
...
def saveSeisZSliceFrom2DMat(seis2dmat, imagename='', zsls=None, datacol=3, inlcol=0, xlcol=1, zcol=2, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, verbose=True, qpgsdlg=None):
    """
    ...
    if inlcol < 0 or len(seis2dmat[0, :]) <= inlcol:
        ...
        sys.exit()
    if xlcol < 0 or len(seis2dmat[0, :]) <= xlcol:
        vis_msg.print('ERROR in saveSeisZSliceFrom2DMat: Not crossline column found in 2D seismic matrix', type='error')
        sys.exit()
    if zcol < 0 or len(seis2dmat[0, :]) <= zcol:
...
def saveSeisZSliceFrom3DMat(seis3dmat, imagename='', zsls=None, seisinfo=None, colormap=None, flipcmap=False, valuemin=-1.0, valuemax=1.0, verbose=True, qpgsdlg=None):
    """
    Save seismic z slices as image files (by matplotlib.pcolormesh)
    ...
    if np.ndim(seis3dmat) != 3:
        ...
        sys.exit()
    if seisinfo is None:
        vis_msg.print('WARNING in saveSeisZSliceFrom3DMat: Survey info auto-generated from 3D seismic matrix', type='warning')
        seisinfo = seis_ays.createSeisInfoFrom3DMat(seis3dmat)
    inlrange = seisinfo['ILRange']
    xlrange = seisinfo['XLRange']
    zrange = seisinfo['ZRange']
    ...
    if znum == 1:
        zstep = -1
    if zsls is None:
        vis_msg.print('WARNING in saveSeisZSliceFrom3DMat: to save all z slices in 3D seismic matrix', type='warning')
        zsls = zrange
    if np.ndim(zsls) != 1:
...
def loadSeisILSliceTo2DMat(imagename, inlsls, ispref=True, xlstart=0, xlend=99, xlnum=100, zstart=0, zend=-99, znum=100, verbose=True, qpgsdlg=None):
    """
    ...
    for i in range(ninlsls):
        ...
        image_data = 0.2989 * data[:, :, 0] + 0.587 * data[:, :, 1] + 0.114 * data[:, :, 2]
...
def loadSeisILSliceTo3DMat(imagename, inlsls, ispref=True, xlnum=100, znum=100, verbose=True, qpgsdlg=None):
    """
...
def loadSeisXLSliceTo2DMat(imagename, xlsls, ispref=True, inlstart=0, inlend=99, inlnum=100, zstart=0, zend=-99, znum=100, verbose=True, qpgsdlg=None):
    """
...
def loadSeisXLSliceTo3DMat(imagename, xlsls, ispref=True, inlnum=100, znum=100, verbose=True, qpgsdlg=None):
    """
...
def loadSeisZSliceTo2DMat(imagename, zsls, ispref=True, inlstart=0, inlend=99, inlnum=100, xlstart=0, xlend=99, xlnum=100, verbose=True, qpgsdlg=None):
    """
...
def loadSeisZSliceTo3DMat(imagename, zsls, ispref=True, inlnum=100, xlnum=100, verbose=True, qpgsdlg=None):
    """
