...
# Embedded file name: C:/Users/HDi/Google Drive/ProgramCodes/Released/PyPI/cognitivegeo\cognitivegeo\src\gui\plotvis1dseisfreq.py
# Compiled at: 2019-12-16 00:14:22
# Size of source mod 2**32: 12429 bytes
...
from cognitivegeo.src.pointset.visualization import visualization as point_vis
...
class plotvis1dseisfreq(object):
    ...
    def clickBtnPlot(self):
        ...
        if len(_attriblist) < 1:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '1D Window: Seismic Spectrum', 'No property selected for plot')
            return
        ...
        if _freqmin is False or _freqmax is False:
            ...
            QtWidgets.QMessageBox.critical(self.msgbox, '1D Window: Seismic Spectrum', 'Non-float range specified for plot')
            return
        ...
        point_vis.crossplot2D(_freqdict, colorlist=_colorlist,
          linestylelist=_linestylelist,
          linewidthlist=_linewidthlist,
          markerstylelist=_markerstylelist,
          markersizelist=_markersizelist,
          xfeature='Frequency',
          yfeature='Power spectrum',
          xlim=[
         _freqmin, _freqmax],
          ylim=[_specmin, _specmax],
          xlabel='Frequency',
