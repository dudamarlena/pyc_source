...
# Embedded file name: build/bdist.linux-i686/egg/alfanous/Support/whoosh/searching.py
# Compiled at: 2015-06-30 06:52:38
__doc__ = 'This module contains classes and functions related to searching the index.\n'
...
class Searcher(object):
    ...
    def search(self, query, limit=5000, sortedby=None, reverse=False, minscore=0.0001):
        ...
        if sortedby is not None:
            ...
            topdocs.add_all(((docnum, final(self, docnum, score)) for docnum, score in query.doc_scores(self)), minscore)
            best = topdocs.best()
            if best:
...
class Results(object):
    ...
    def copy(self):
        ...
        return self.__class__(self.searcher, self.query, scored_list=scored_list, docvector=self.docs.copy(), scores=scores, runtime=self.runtime)
    ...
    def extend(self, results):
        ...
        """
        docs = self.docs
        self.scored_list.extend(docnum for docnum in results.scored_list if docnum not in docs)
