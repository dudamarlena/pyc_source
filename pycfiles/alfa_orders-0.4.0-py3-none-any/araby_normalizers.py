...
# Embedded file name: build/bdist.linux-i686/egg/alfanous/Support/PyArabic/araby_normalizers.py
...
def normalize_hamza(w):
    ...
    s = ''
    for letter in w:
        if letter in _ALEFAT:
            s += ALEF
        elif letter in _HAMZAT:
            s += HAMZA
        else:
            s += letter
