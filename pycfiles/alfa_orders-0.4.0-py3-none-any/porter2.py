...
# Embedded file name: build/bdist.linux-i686/egg/alfanous/Support/whoosh/lang/porter2.py
# Compiled at: 2015-06-30 06:52:38
__doc__ = 'An implementation of the Porter2 stemming algorithm.\nSee http://snowball.tartarus.org/algorithms/english/stemmer.html\n\nAdapted from pyporter2 by Michael Dirolf.\n\nThis algorithm is more correct but (at least in this implementation)\nseveral times slower than the original porter algorithm as implemented\nin whoosh.lang.porter.\n'
import re
r_exp = re.compile('[^aeiouy]*[aeiouy]+[^aeiouy](\\w*)')
ewss_exp1 = re.compile('^[aeiouy][^aeiouy]$')
ewss_exp2 = re.compile('.*[^aeiouy][aeiouy][^aeiouywxY]$')
ccy_exp = re.compile('([aeiouy])y')
s1a_exp = re.compile('[aeiouy].')
s1b_exp = re.compile('[aeiouy]')
...
exceptional_forms = {'skis': 'ski', 'skies': 'sky', 
   'dying': 'die', 
   'lying': 'lie', 
   'tying': 'tie', 
   'idly': 'idl', 
