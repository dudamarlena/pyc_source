...
# Embedded file name: C:\Users\shu\PycharmProjects\py34\cazipcode-project\cazipcode\pkg\geo_search.py
...
class GeoSearchEngine(object):
    ...
    def __init__(self, name='point', database=':memory:'):
        ...
        self.t_point = Table(name, self.metadata, Column('id', String), Column('lat', Float), Column('lng', Float), Column('data', PickleType))
...
def test_geo_search():
    ...
    search_engine.train(point_data, key_id=lambda x: x[0], key_lat=lambda x: x[1], key_lng=lambda x: x[2])
