...
# Embedded file name: build/bdist.linux-x86_64/egg/collective/customizablePersonalizeForm/tests/test_subscriptions.py
...
class ITestAdditionalDataSchema(Interface):
    ...
    extra fields.
    """
    test_field = schema.Bool(title=_('label_test_field_title', default='Test field'), description=_('label_test_field_description', default=''), required=False)
