...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/chisubmit/backend/api/helpers.py
# Compiled at: 2017-04-03 16:34:20
# Size of source mod 2**32: 3926 bytes
from django.http.response import Http404
from django.contrib.auth.models import User
from chisubmit.backend.api.models import Assignment, Team, TeamMember, Course, CourseRoles, RubricComponent, Registration, Submission, Grade
...
def get_course_person(course_obj, request_user, roles, course_user_class, username):
    try:
        if len(roles) == 1 and CourseRoles.STUDENT in roles and request_user.username != username:
            raise Http404
