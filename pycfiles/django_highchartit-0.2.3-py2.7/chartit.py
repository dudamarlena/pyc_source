...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\chartit\templatetags\chartit.py
...
CHART_LOADER_URL = posixpath.join(settings.STATIC_URL, CHARTIT_JS_REL_PATH, 'chartloader.js')
...
def load_charts(chart_list=None, render_to=''):
    ...
    if chart_list is not None:
        ...
        embed_script = embed_script % (
         simplejson.dumps(chart_list, use_decimal=True, default=date_format),
         CHART_LOADER_URL)
    else:
