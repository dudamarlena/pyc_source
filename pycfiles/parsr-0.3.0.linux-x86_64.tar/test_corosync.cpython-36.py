...
# [GCC 8.4.0]
# Embedded file name: /home/csams/git_repos/personal/parsr/lib/python3.6/site-packages/parsr/examples/tests/test_corosync.py
# Compiled at: 2019-05-28 16:55:11
...
def test_corosync_data():
    res = loads(DATA)
    if not res['totem']['version'].value == 2:
...
def test_corosync_conf():
    ...
    if not conf['totem']['token'][0].value == 10000:
        raise AssertionError
    else:
