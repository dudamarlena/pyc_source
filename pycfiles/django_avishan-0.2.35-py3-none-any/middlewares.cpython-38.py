...
# [GCC 8.4.0]
# Embedded file name: /home/afshari9978/Projects/namaki_backend/avishan/middlewares.py
...
class Wrapper:
 ...
 L.  30        90  LOAD_FAST                'discard_monitor'
 ...
 L.  34       142  LOAD_FAST                'start_time'
              144  LOAD_FAST                'current_request'
              146  LOAD_STR                 'start_time'
              148  STORE_SUBSCR     

 L.  42       150  SETUP_FINALLY       174  'to 174'

 L.  43       152  LOAD_FAST                'find_token'
              154  CALL_FUNCTION_0       0  ''
              156  POP_JUMP_IF_FALSE   170  'to 170'

 L.  44       158  LOAD_FAST                'decode_token'
              160  CALL_FUNCTION_0       0  ''
              162  POP_TOP          

 L.  45       164  LOAD_FAST                'find_and_check_user'
 ...
 L.  49       208  LOAD_GLOBAL              save_traceback
              210  CALL_FUNCTION_0       0  ''
              212  POP_TOP          

 L.  50       214  LOAD_GLOBAL              AvishanException
              216  LOAD_FAST                'e'
 ...
 L.  52       240  LOAD_FAST                'current_request'
 ...
 L.  53       254  LOAD_GLOBAL              get_avishan_config
 ...
 L.  55       266  SETUP_FINALLY       290  'to 290'

 L.  59       268  LOAD_CONST               0
 ...
 L.  60       280  LOAD_FAST                'check_request'
              282  CALL_FUNCTION_0       0  ''
              284  POP_TOP          
              286  POP_BLOCK        
              288  JUMP_FORWARD        312  'to 312'
            290_0  COME_FROM_FINALLY   266  '266'
 ...
 L.  66       312  SETUP_FINALLY       332  'to 332'

 L.  67       314  LOAD_FAST                'self'
 ...
 L.  71       370  LOAD_GLOBAL              save_traceback
              372  CALL_FUNCTION_0       0  ''
              374  POP_TOP          

 L.  72       376  LOAD_GLOBAL              AvishanException
              378  LOAD_FAST                'e'
 ...
 L.  75       402  LOAD_FAST                'current_request'
 ...
 L.  76       430  LOAD_FAST                'current_request'
              432  LOAD_STR                 'messages'
              434  BINARY_SUBSCR    
              436  LOAD_STR                 'success'
              438  BINARY_SUBSCR    

 L.  75   440_442  POP_JUMP_IF_TRUE    472  'to 472'

 L.  76       444  LOAD_FAST                'current_request'
              446  LOAD_STR                 'messages'
              448  BINARY_SUBSCR    
              450  LOAD_STR                 'warning'
              452  BINARY_SUBSCR    

 L.  75   454_456  POP_JUMP_IF_TRUE    472  'to 472'

 L.  77       458  LOAD_FAST                'current_request'
              460  LOAD_STR                 'messages'
              462  BINARY_SUBSCR    
              464  LOAD_STR                 'error'
              466  BINARY_SUBSCR    

 L.  75   468_470  POP_JUMP_IF_FALSE   510  'to 510'
            472_0  COME_FROM           454  '454'
            472_1  COME_FROM           440  '440'
            472_2  COME_FROM           426  '426'
            472_3  COME_FROM           412  '412'

 L.  80       472  LOAD_FAST                'current_request'
              474  LOAD_STR                 'is_api'
              476  BINARY_SUBSCR    
          478_480  POP_JUMP_IF_FALSE   500  'to 500'

 L.  81       482  LOAD_FAST                'current_request'
 ...
 L.  86       510  LOAD_FAST                'add_token_to_response'
              512  LOAD_FAST                'response'
              514  CALL_FUNCTION_1       1  ''
              516  POP_TOP          

 L.  87       518  LOAD_FAST                'current_request'
              520  LOAD_STR                 'status_code'
              522  BINARY_SUBSCR    
              524  STORE_FAST               'status_code'

 L.  88       526  LOAD_FAST                'current_request'
              528  LOAD_STR                 'is_api'
              530  BINARY_SUBSCR    
              532  STORE_FAST               'is_api'

 L.  89       534  LOAD_FAST                'current_request'
              536  LOAD_STR                 'json_unsafe'
              538  BINARY_SUBSCR    
              540  UNARY_NOT        
              542  STORE_FAST               'json_safe'

 L.  90       544  LOAD_FAST                'current_request'
              546  LOAD_STR                 'is_api'
              548  BINARY_SUBSCR    
          550_552  POP_JUMP_IF_FALSE   566  'to 566'

 L.  91       554  LOAD_FAST                'current_request'
 ...
 L.  95       566  LOAD_FAST                'current_request'
 ...
 L. 103       652  LOAD_FAST                'status_code'
              654  LOAD_FAST                'response'
              656  STORE_ATTR               status_code
            658_0  COME_FROM           648  '648'
            658_1  COME_FROM           638  '638'

 L. 105       658  LOAD_FAST                'response'
              660  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `RETURN_VALUE' instruction at offset 660
