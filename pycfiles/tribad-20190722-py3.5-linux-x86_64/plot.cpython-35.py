...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tribad/plot.py
# Compiled at: 2016-03-13 06:57:02
...
def segments(ax, **kw):
    ...
    for beg, end in segs:
        x0, y0 = verts[beg, :]
        x1, y1 = verts[end, :]
        ax.fill([x0, x1], [y0, y1], facecolor='none', edgecolor='r', linewidth=3, zorder=0)
...
def edges(ax, **kw):
    ...
    for beg, end in edges:
        x0, y0 = verts[beg, :]
        x1, y1 = verts[end, :]
        ax.fill([x0, x1], [y0, y1], facecolor='none', edgecolor='k', linewidth=0.5)
