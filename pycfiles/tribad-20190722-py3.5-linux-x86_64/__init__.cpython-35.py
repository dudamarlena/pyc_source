...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tribad/__init__.py
# Compiled at: 2019-07-22 18:44:07
# Size of source mod 2**32: 13430 bytes
import os, numpy as np, tribad.core as core
...
def triangulate(tri, opts=''):
    ...
    """
    fields = (('pointlist', 'vertices', 'double', 2), ('segmentlist', 'segments', 'int32', 2),
              ('holelist', 'holes', 'double', 2), ('regionlist', 'regions', 'double', 4),
              ('trianglelist', 'triangles', 'int32', 3), ('edgelist', 'edges', 'int32', 2),
              ('trianglearealist', 'triangle_max_area', 'double', 1), ('pointmarkerlist', 'vertex_markers', 'int32', 1),
...
def loads(node=None, ele=None, poly=None, area=None, edge=None, neigh=None):
    """
...
def show_data(name):
    import triangle.plot as plot, matplotlib.pyplot as plt
    d = get_data(name)
