...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/spoon/transports/spoontransport.py
# Compiled at: 2006-11-27 19:11:27
from spoon import SpoonStream
from threading import Semaphore, Thread
from transporthub import TransportException, TransportHub, LMTYPE_NETWORK, LMTYPE_NETWORK_PROTO, LinkMessage
import StringIO
...
class SpoonTransport(object):
    ...
    def __init__(self, t, network=None):
        ...
        self.active = property(fget=self.__get_active, fset=self.__set_active, doc='Will be True as long as the transport is active, will be false if it is inactive.\nTransports are made inactive if any exceptions are encountered.')
        if network:
