...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/spoon/transports/transporthub.py
# Compiled at: 2006-11-27 20:40:40
...
class TransportHub(object):
    ...
    def addTransport(t):
        ...
        if TransportHub.nodeId == None:
            raise TransportException('Cannot initialize transport until nodeId is set on TransportHub.          Use spoon.transports.TransportHub.nodeId = someint')
        hello = SpoonRPCHello()
