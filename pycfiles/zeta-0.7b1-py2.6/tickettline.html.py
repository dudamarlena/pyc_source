...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/projects/tickettline.html.py
# Compiled at: 2010-07-12 03:36:43
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278920203.602104
_template_filename = '/home/pratap/mybzr/pratap/dev/zeta/zeta/templates-dojo/derived/projects/tickettline.html'
_template_uri = '/derived/projects/tickettline.html'
...
page_tooltips = [
 [
  'Help',
  'Timeline of updates to ticket(s).']]
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer('\n    ')
        __M_writer(escape(elements.contextnav([searchbox, sel_tck, attachs], rspans=[
