...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/userpage/usertline.html.py
# Compiled at: 2010-07-12 02:07:48
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278914868.858085
_template_filename = '/home/pratap/mybzr/pratap/dev/zeta/zeta/templates-dojo/derived/userpage/usertline.html'
_template_uri = '/derived/userpage/usertline.html'
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer('\n    ')
        if c.user:
            pagebartext = '%s : Timeline' % c.user.username
        else:
            pagebartext = 'UsersTimeline'
        __M_writer('\n    ')
