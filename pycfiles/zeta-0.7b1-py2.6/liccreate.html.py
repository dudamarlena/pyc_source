...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/license/liccreate.html.py
# Compiled at: 2010-07-12 03:11:54
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278918714.537989
_template_filename = '/home/pratap/mybzr/pratap/dev/zeta/zeta/templates-dojo/derived/license/liccreate.html'
_template_uri = '/derived/license/liccreate.html'
...
page_tooltips = [
 [
  'Help',
  'License name must be <b>unique</b>']]
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer('\n    ')
        __M_writer(escape(elements.pagebar('Create a new license', spans=[
         capture(forms.form_licenselist, c.licenselist)], rspans=[
        ...
        __M_writer('        <div name="crlic" class="ml20">\n            ')
        __M_writer(escape(forms.form_createlicense(c.authuser, h.suburl_crlic)))
        __M_writer('\n        </div>\n    </div>\n')
        if c.userpanes:
