...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/accounts/forgotpass.html.py
# Compiled at: 2010-07-12 02:08:09
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278914889.9422
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer('\n    ')
        pagebartext = 'Email id to reset password'
        __M_writer('\n    ')
        __M_writer(escape(elements.pagebar(pagebartext, tooltips=page_tooltips)))
        __M_writer('\n    <div id="bdy">\n    <div class="mt20 w100" style="padding : 0 20% 0 0">\n')
        if c.errormsg:
            ...
            __M_writer('            <div class="fgblue m20" style="font-size : 120%">\n                Reset link sent to your emailid\n            </div>\n')
        __M_writer('    </div>\n    </div>\n')
        return ''
    finally:
        context.caller_stack._pop_frame()