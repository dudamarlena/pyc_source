...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/projects/projdownloads.html.py
# Compiled at: 2010-07-12 03:18:37
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278919117.465581
_template_filename = '/home/pratap/mybzr/pratap/dev/zeta/zeta/templates-dojo/derived/projects/projdownloads.html'
_template_uri = '/derived/projects/projdownloads.html'
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer('\n    ')
        __M_writer(escape(elements.contextnav([fav, searchbox, roadmap, mountpt, attachs], rspans=[
        ...
        __M_writer(escape(elements.attachdownloads(c.authuser, c.attachments)))
        __M_writer('\n                </div>\n            </div>\n')
