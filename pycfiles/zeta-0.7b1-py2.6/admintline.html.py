...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/projects/admintline.html.py
# Compiled at: 2010-07-12 03:23:11
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278919391.679823
_template_filename = '/home/pratap/mybzr/pratap/dev/zeta/zeta/templates-dojo/derived/projects/admintline.html'
_template_uri = '/derived/projects/admintline.html'
...
page_tooltips = [
 [
  'Help',
  "Only project administrator can access this page.\nTimeline of project's administrative activities.\n"]]
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer('\n    ')
        ctxt_title = c.project.projectname + ' Administration'
        ctxt_spans = [
         '<span class="fggray fntbold">%s</span>' % ctxt_title]
        __M_writer('\n    ')
        __M_writer(escape(elements.mainnav()))
        __M_writer('\n    ')
        __M_writer(escape(elements.contextnav(ctxt_spans, tooltips=page_tooltips)))
