...
# [GCC 8.4.0]
# Embedded file name: /home/pratap/mybzr/pratap/dev/zeta/defenv/data/templates/derived/projects/reviewtline.html.py
# Compiled at: 2010-07-12 03:41:14
from mako import runtime, filters, cache
UNDEFINED = runtime.UNDEFINED
__M_dict_builtin = dict
__M_locals_builtin = locals
_magic_number = 5
_modified_time = 1278920474.6269
_template_filename = '/home/pratap/mybzr/pratap/dev/zeta/zeta/templates-dojo/derived/projects/reviewtline.html'
_template_uri = '/derived/projects/reviewtline.html'
_template_cache = cache.Cache(__name__, _modified_time)
_source_encoding = 'utf-8'
from webhelpers.html import escape
_exports = ['hd_script', 'bd_body', 'hd_links', 'bd_script']
page_tooltips = [
 [
  'Help',
  'Timeline of updates to review(s).']]
...
def render_bd_body(context):
    ...
    try:
        ...
        __M_writer('\n    ')
        __M_writer(escape(elements.contextnav([searchbox, sel_revw, sel_rset, newrevw, attachs], rspans=[
