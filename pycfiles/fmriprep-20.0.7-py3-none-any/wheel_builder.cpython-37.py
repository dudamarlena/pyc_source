...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-vxs8l7gu/pip/pip/_internal/wheel_builder.py
    ...
    if req.constraint:
        ...
        if not req.use_pep517:
            if not is_wheel_installed():
                logger.info("Could not build wheels for %s, since package 'wheel' is not installed.", req.name)
                return False
        else:
