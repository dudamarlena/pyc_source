...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-vxs8l7gu/setuptools/setuptools/command/develop.py
# Compiled at: 2020-05-05 12:41:36
# Size of source mod 2**32: 8188 bytes
...
class develop(namespaces.DevelopInstaller, easy_install):
    ...
    def install_for_development(self):
        if not six.PY2:
            ...
            with self.dry_run or open(self.egg_link, 'w') as (f):
