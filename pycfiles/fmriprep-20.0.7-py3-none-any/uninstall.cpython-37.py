...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-vxs8l7gu/pip/pip/_internal/commands/uninstall.py
...
from pip._internal.req.constructors import install_req_from_line, install_req_from_parsed_requirement
...
class UninstallCommand(Command, SessionCommandMixin):
    ...
    def run(self, options, args):
        ...
        if not reqs_to_uninstall:
            raise InstallationError(('You must give at least one requirement to {self.name} (see "pip help {self.name}")'.format)(**locals()))
