...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-vxs8l7gu/pip/pip/_internal/utils/subprocess.py
        ...
        if proc_had_error:
            if on_returncode == 'raise' and not showing_subprocess:
                ...
                if on_returncode == 'warn':
                    subprocess_logger.warning('Command "{}" had error code {} in {}'.format(command_desc, proc.returncode, cwd))
                else:
