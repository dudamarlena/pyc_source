...
# [GCC 8.4.0]
# Embedded file name: /Users/val/Projects/workon/mpro/doozdev/backend/restful-backend/apps/geoware/models/base.py
# Compiled at: 2017-01-27 10:16:44
...
class AbstractBaseLocation(models.Model):
    ...
    name = models.CharField(_('Name'), db_index=True, max_length=254)
    ...
    area = models.PositiveIntegerField(_('Area (Square KM)'), default=0)
    population = models.PositiveIntegerField(_('Population'), default=0)
    elevation = models.IntegerField(_('Elevation'), default=0)
    geoname_id = models.CharField(db_index=True, unique=True, max_length=50, null=True, blank=True)
    altnames = models.ManyToManyField('Altname', verbose_name=_('Altname'), related_name='%(app_label)s_%(class)s_altnames', blank=True)
    url = models.URLField(_('URL'), max_length=254, null=True, blank=True)
    info = models.TextField(_('Details'), null=True, blank=True)
