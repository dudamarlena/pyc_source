...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/mhclovac/misc.py
# Compiled at: 2020-04-16 13:44:53
...
def get_feature_vector(seq, normed_dist=True, normed_auc=True):
    ...
    """
    prt = Proteinko()
    norm_range_options = {'hydropathy':(-1, 1), 
     'acceptors':(0, 1), 
     'donors':(0, 1), 
     'pI':(-1, 1), 
     'volume':(-1, 1)}
