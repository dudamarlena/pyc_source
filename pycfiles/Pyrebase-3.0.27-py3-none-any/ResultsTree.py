...
# Embedded file name: build\bdist.win32\egg\Pyreb\Controls\ResultsTree.py
# Compiled at: 2006-03-07 18:16:58
import wx, wx.gizmos as gizmos, wx.xrc as xrc
...
class PyrebResultsTreeXmlHandler(xrc.XmlResourceHandler):
    ...
    def DoCreateResource(self):
        ...
        widget = PyrebResultsTree(self.GetParentAsWindow(), self.GetID(), self.GetPosition(), size, style, self.GetName())
