...
# [GCC 8.4.0]
# Embedded file name: /home/arroyo/ovp/suzano-ovp/django-ovp-core/ovp_core/models/address.py
# Compiled at: 2017-06-19 13:17:04
# Size of source mod 2**32: 6053 bytes
    ...
    def get_city_state(self):
        ...
        if locality.count():
            ...
            if county.count():
                ...
                s += '{}, '.format(sublocality[0].long_name)
        if state.count():
