...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/scripts/possible_mistakes.py
# Compiled at: 2015-09-03 14:09:25
...
def main():
    res_text = '{| class="wikitable sortable"\n!Qid!!Value<br />(Wikidata)!!Value<br />(Wipedia)!!Other boring stuff'
    args = sys.argv[1:]
