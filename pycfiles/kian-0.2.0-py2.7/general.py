...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/scripts/general.py
# Compiled at: 2016-01-20 18:37:42
...
parser.add_argument('--file', '-f', nargs='?', required=True, help='name of the model to train')
...
for beta in [0.125, 0.25, 0.5, 1, 2, 3, 4]:
    ...
    print ('f{0}-score (thrashhold, precision, recall, edits to review, total edits): {1:.5}, {2:.5}, {3:.5}, {4}, {5} ({6:.5}%)').format(beta, res[0], res[1][0], res[1][1], i, total_edits, i * 100 / total_edits)