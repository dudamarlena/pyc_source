...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/scripts/parse_and_add.py
# Compiled at: 2015-11-03 05:26:17
...
def main():
    ...
    for page in generator:
        ...
        if res > second_thrashhold:
            ...
            item.addClaim(claim, summary='Bot: Adding %s:%s from %s ([[User:Ladsgroup/Kian|Powered by Kian]])' % (
