...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/scripts/initiate_model.py
# Compiled at: 2015-12-09 01:09:05
import argparse
try:
    basestring
except NameError:
...
parser.add_argument('--name', '-n', nargs='?', help='name of the model. No space character!')
parser.add_argument('--wiki', '-w', nargs='?', help='code of Wiki, e.g. enwiki, fawikivoyage')
parser.add_argument('--prop', '-p', nargs='?', help='Number or id of property, e.g. P31, P17')
parser.add_argument('--value', '-v', nargs='?', help='value of the property. e.g. Q31, Q183')
