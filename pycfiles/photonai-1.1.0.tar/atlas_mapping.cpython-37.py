...
# [GCC 8.4.0]
# Embedded file name: /home/nwinter/PycharmProjects/projects_nils/photon_core/photonai/neuro/atlas_mapping.py
# Compiled at: 2019-11-21 10:45:53
...
Parse error at or near `COME_FROM_LOOP' instruction at offset 108_2
    ...
    def fit(self, X, y=None, **kwargs):
        ...
        for roi_name, hyperpipe in self.hyperpipes_to_fit.items():
            ...
            hyperpipe_infos[roi_name] = {'hyperpipe_name':hyperpipe.name,  'model_filename':os.path.join(os.path.basename(hyperpipe.output_settings.results_folder), 'photon_best_model.photon'), 
