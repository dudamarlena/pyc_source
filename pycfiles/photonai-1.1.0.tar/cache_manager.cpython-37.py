...
# [GCC 8.4.0]
# Embedded file name: /home/nwinter/PycharmProjects/projects_nils/photon_core/photonai/base/cache_manager.py
# Compiled at: 2019-11-21 09:20:09
# Size of source mod 2**32: 5785 bytes
import os, shutil, numpy as np, joblib, glob
from dask.distributed import Lock
import photonai.photonlogger.logger as logger

class CacheManager:
    _CacheManager__LOCK_STR = 'photon_cache_manager'

    def __init__(self, _hash=None, cache_folder=None, parallel_use: bool=False, single_subject_caching: bool=False):
        self._hash = _hash
