...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/crawlib-project/crawlib/tests/dummy_site_crawler/mongo_backend/s2_music/entity_music.py
# Compiled at: 2019-12-30 17:37:33
# Size of source mod 2**32: 6301 bytes
...
class MusicPage(MusicWebsiteEntity):
    ...
    meta = dict(collection='site_music_music',
...
class ArtistPage(MusicWebsiteEntity):
    ...
    meta = dict(collection='site_music_artist',
      db_alias=(config.DB_DATABASE.get_value()))
...
class GenrePage(MusicWebsiteEntity):
    ...
    musics = fields.ListField(fields.IntField())
    n_music = fields.IntField()
    meta = dict(collection='site_music_genre',
      db_alias=(config.DB_DATABASE.get_value()))
...
class RandomMusicPage(MusicWebsiteEntity):
    ...
    musics = fields.ListField(fields.IntField())
    n_music = fields.IntField()
    meta = dict(collection='site_music_random_music',
      db_alias=(config.DB_DATABASE.get_value()))
