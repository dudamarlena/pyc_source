...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/crawlib-project/crawlib/tests/dummy_site_crawler/mongo_backend/s1_movie/entity_movie.py
# Compiled at: 2019-12-30 18:19:08
...
class MovieCoverImagePage(MoviePageBase):
    ...
    CONF_UPDATE_FIELDS = ('image_content', )
    meta = dict(collection='site_movie_movie',
