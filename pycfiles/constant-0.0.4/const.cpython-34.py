...
# [GCC 8.4.0]
# Embedded file name: C:\Users\shu\PycharmProjects\py34\constant-project\constant\const.py
...
def get_attributes(klass):
    ...
    """
    attributes = list()
    for attr, _ in inspect.getmembers(klass, lambda x: not inspect.isroutine(x)):
...
class Constant(object):
    __doc__ = 'A constant data collection.\n    '
    ...
    def get(cls, attr, value, multi=False, e=1e-06):
