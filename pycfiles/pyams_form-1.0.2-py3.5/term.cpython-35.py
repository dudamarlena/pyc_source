...
class Terms:
    __doc__ = 'Base implementation for custom ITerms.'
    terms = None
...
class SourceTerms(Terms):
    __doc__ = 'Base implementation for ITerms using a source instead of a vocabulary.'
...
class ChoiceTermsVocabulary(Terms):
    __doc__ = 'ITerms adapter for zope.schema.IChoice based implementations using\n    vocabulary.'
...
class MissingTermsBase:
    __doc__ = 'Base class for MissingTermsMixin classes.'
...
class MissingTermsMixin(MissingTermsBase):
    __doc__ = 'This can be used in case previous values/tokens get missing\n    from the vocabulary and you still need to display/keep the values'
...
class ChoiceTermsSource(SourceTerms):
    __doc__ = 'ITerms adapter for zope.schema.IChoice based implementations using source.'
...
class BoolTerms(Terms):
    __doc__ = 'Default yes and no terms are used by default for IBool fields.'
    true_label = _('yes')
    false_label = _('no')
...
class CollectionTermsVocabulary(Terms):
    __doc__ = 'ITerms adapter for zope.schema.ICollection based implementations using\n    vocabulary.'
...
class MissingCollectionTermsMixin(MissingTermsBase):
    __doc__ = '`MissingTermsMixin` adapted to collections.'
