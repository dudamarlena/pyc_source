...
class AJAXAddForm(AJAXForm):
    __doc__ = 'AJAX add form mix-in class'
...
class AJAXEditForm(AJAXForm):
    __doc__ = 'AJAX edit form mix-in class'
...
class AJAXFormRenderer:
    __doc__ = "Render an AJAX form's response into JSON format"
