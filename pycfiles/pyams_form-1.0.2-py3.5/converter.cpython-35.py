...
class BaseDataConverter:
    __doc__ = 'A base implementation of the data converter.'
    _strip_value = True
...
class FieldDataConverter(BaseDataConverter):
    __doc__ = "A data converter using the field's ``fromUnicode()`` method."
...
class FormatterValidationError(ValidationError):
    __doc__ = 'Formatter validation error'
    message = None
...
class NumberDataConverter(BaseDataConverter):
    __doc__ = 'A general data converter for numbers.'
    type = None
    error_message = None
...
class IntegerDataConverter(NumberDataConverter):
    __doc__ = 'A data converter for integers.'
    type = int
...
class CalendarDataConverter(BaseDataConverter):
    __doc__ = 'A special data converter for calendar-related values.'
    type = None
    length = 'short'
...
class SequenceDataConverter(BaseDataConverter):
    __doc__ = 'Basic data converter for ISequenceWidget.'
...
class CollectionSequenceDataConverter(BaseDataConverter):
    __doc__ = 'A special converter between collections and sequence widgets.'
...
class TextLinesConverter(BaseDataConverter):
    __doc__ = 'Data converter for ITextLinesWidget.'
...
class MultiConverter(BaseDataConverter):
    __doc__ = 'Data converter for IMultiWidget.'
...
class BoolSingleCheckboxDataConverter(BaseDataConverter):
    __doc__ = 'A special converter between boolean fields and single checkbox widgets.'
