...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/zdb/db.py
# Compiled at: 2014-10-25 15:12:53
from collections import namedtuple
import glob, json, base64, os, pandas as pd
...
class DB(object):
    ...
    def __init__(self, username=None, password=None, hostname='localhost', port=5432, dbname=None, dbtype=None, profile='default', exclude_system_tables=True):
