...
# [GCC 8.4.0]
# Embedded file name: /Users/kgulliks/.PythonModules/TelluricFitter/src/MakeTape5.py
# Compiled at: 2015-02-09 13:53:47
"""
...
def WriteTape5(pars, atmosphere=None, output='TAPE5'):
    ...
    if itype == 2 or itype == 3:
        ...
        if h2 == 0.0 and itype == 3:
            length = hspace / cos(angle * pi / 180.0)
            beta = arctan(hspace * tan(angle * pi / 180.0) / (hspace + re))
