...
# [GCC 8.4.0]
# Embedded file name: build\lib.win32-2.7\yaml\composer.py
        ...
        if self.check_event(AliasEvent):
            ...
            if anchor is not None:
                if anchor in self.anchors:
                    raise ComposerError('found duplicate anchor %r; first occurrence' % anchor.encode('utf-8'), self.anchors[anchor].start_mark, 'second occurrence', event.start_mark)
