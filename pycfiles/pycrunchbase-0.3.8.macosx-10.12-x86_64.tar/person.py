...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/pycrunchbase/resource/person.py
...
class Person(Node):
    ...
    def __str__(self):
        return ('{first} {last} ({permalink})').format(first=self.first_name, last=self.last_name, permalink=self.permalink)
