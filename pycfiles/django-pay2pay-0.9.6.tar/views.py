...
# [GCC 8.4.0]
# Embedded file name: /Users/drmartiner/projects/django-pay2pay/pay2pay/views.py
# Compiled at: 2013-07-08 12:33:24
import conf, logging, xmltodict, lxml.etree, lxml.builder
...
class Confirm(View):
    ...
    def _get_xml_response(self, error_msg_value):
        ...
        if error_msg_value:
            ...
            status_value = 'yes'
        request = request(status(status_value), error_msg(error_msg_value))
