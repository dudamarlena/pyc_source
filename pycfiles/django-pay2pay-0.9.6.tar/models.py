...
# [GCC 8.4.0]
# Embedded file name: /Users/drmartiner/projects/django-pay2pay/pay2pay/models.py
# Compiled at: 2013-07-11 07:21:36
import conf, uuid
...
class Payment(models.Model):
    ...
    STATUS_CHOICES = (
     (
      STATUS_UNCONFIRM, 'Не подтвержден'),
     (
    ...
    amount = models.DecimalField('Сумма', default=0.0)
    ...
    status = models.CharField('Статус', max_length=16, choices=STATUS_CHOICES, default=STATUS_UNCONFIRM)
    ...
    def _get_xml_data(self):
        data = {'success_url': conf.PAY2PAY_SUCCESS_URL, 
