...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-intel/egg/tumbledore/models.py
# Compiled at: 2012-09-18 19:46:34
...
THEME_PATHS = glob.glob(os.path.join(os.path.dirname(__file__), 'templates', 'tumbledore', 'themes', '*'))
...
class Tumblelog(models.Model):
    name = models.CharField(max_length=200, help_text='This will display in the header area of your tumblelog.')
    description = models.TextField(blank=True, default='', help_text='This will display below the name.')
    mount_on = models.CharField(max_length=200, blank=True, default='', unique=True, db_index=True, help_text='The root url of your tumblelog.')
    ...
    extra_styles = models.TextField(blank=True, default='', help_text='Inserted before the close of the head tag.')
    extra_scripts = models.TextField(blank=True, default='', help_text='Inserted before the close of the body tag.')
...
class TumblelogPost(models.Model):
    ...
    tumblelog = models.ForeignKey(Tumblelog, related_name='posts', verbose_name='Post in')
    author = models.CharField(max_length=200, blank=True, default='', help_text='HTML is allowed.')
    content = models.TextField(blank=True, default='')
    excerpt = models.TextField(blank=True, default='', help_text='Only needed if this post has a permalink.')
    sort_order = models.IntegerField(blank=True, default=0, help_text='Set this if your tumblelog is using custom ordering.')
    custom_data = JSONField(default='{}', blank=True, help_text='As JSON; will override context variables, e.g., permalink')
