...
# [GCC 8.4.0]
# Embedded file name: templateaddons/../templateaddons/templatetags/javascript.py
# Compiled at: 2016-10-21 19:47:31
...
class JavascriptContainer(object):
    ...
    def __str__(self):
        ...
        return b'%s' % self.separator.join(self.nodes)
...
class JavascriptRenderNode(template.Node):
    ...
    def render(self, context):
        ...
        return b'%s' % javascript_container
