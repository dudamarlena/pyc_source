...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\sphinxgen\version.py
# Compiled at: 2014-12-03 10:30:02
"""
...
The ``<suffix>`` component is the **version suffix**, which is used only for non-released
