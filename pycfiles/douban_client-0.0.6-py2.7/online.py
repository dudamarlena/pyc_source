...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/douban_client/api/online.py
...
class Online(DoubanAPIBase):
    ...
    def new(self, title, desc, begin_time, end_time, related_url='', cascade_invite='false', tags=''):
        return self._post('/v2/onlines', title=title, desc=desc, tags=tags, begin_time=begin_time, end_time=end_time, related_url=related_url, cascade_invite=cascade_invite)

    def update(self, id, title, desc, begin_time, end_time, related_url='', cascade_invite='false', tags=''):
        return self._put('/v2/online/%s' % id, title=title, desc=desc, tags=tags, begin_time=begin_time, end_time=end_time, related_url=related_url, cascade_invite=cascade_invite)
