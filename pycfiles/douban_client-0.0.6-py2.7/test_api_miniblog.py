...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/tests/test_api_miniblog.py
...
class TestApiMiniblog(DoubanClientTestBase):
    ...
    def test_miniblog_rec(self):
        ret = self.client.miniblog.rec(title=self.rec_title, url=self.rec_url, desc=self.rec_desc, image=self.rec_image)
