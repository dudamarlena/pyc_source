...
# Embedded file name: build/bdist.linux-x86_64/egg/pyF3D/filters/MaskFilter.py
...
class MaskFilter:
    ...
    def runFilter(self):
        ...
        try:
            self.kernel.set_args(self.clattr.inputBuffer, self.maskBuffer, self.clattr.outputBuffer, np.int32(self.atts.width), np.int32(self.atts.height), np.int32(self.clattr.maxSliceCount + self.atts.overlap[self.index]))
