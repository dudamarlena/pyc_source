...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/ocfl/namaste.py
# Compiled at: 2018-11-01 09:12:19
...
class NamasteException(Exception):
    __doc__ = 'Class for exceptions from Namaste.'


class Namaste(object):
    __doc__ = 'Class implementing NAMASTE specification.'
