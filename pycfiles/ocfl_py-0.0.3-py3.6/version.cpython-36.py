...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/ocfl/version.py
# Compiled at: 2020-04-15 23:12:06
...
def add_version_metadata_args(parser):
    ...
    parser.add_argument('--created', default=None, help='creation time to be used with version(s) added, else current time will be recorded')
    parser.add_argument('--message', default=None, help='message to be recorded with version(s) added')
    parser.add_argument('--name', default=None, help='name of user adding version(s) to object')
    parser.add_argument('--address', default=None, help='address of user adding version(s) to object')


class VersionMetadata(object):
    __doc__ = "Class for metadata for a version of OCFL Object's content."
