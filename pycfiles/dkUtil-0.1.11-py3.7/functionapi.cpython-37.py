...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\functionapi.py
# Compiled at: 2019-01-31 01:54:34
# Size of source mod 2**32: 4745 bytes
import sys
if sys.version > '3':
    PY3 = True
else:
...
class functionapi(object):
    ...
    def decipheringPhone(host, phonelist, pre_page_count=40):
        ...
        while total_page_count > 0:
            pagedata = phonemd5[currypage * pre_page_count:(currypage + 1) * pre_page_count]
