...
# [GCC 8.4.0]
# Embedded file name: /home/mahnve/.virtualenvs/blog/lib/python2.7/site-packages/test/test_posts.py
# Compiled at: 2015-04-13 05:01:17
...
def test_build_tags_list():
    ...
    assert_equals(3, len(posts.get_tag_dict(tag_tree, 'foo')['posts']))
    assert_equals(1, len(posts.get_tag_dict(tag_tree, 'bar')['posts']))
