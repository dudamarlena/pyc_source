...
# [GCC 8.4.0]
# Embedded file name: /Users/jamesjeffryes/Documents/NuMat/watlow/build/lib/watlow/util.py
# Compiled at: 2020-02-20 16:03:43
# Size of source mod 2**32: 5206 bytes
...
class AsyncioModbusClient(object):
    ...
    async def write_registers(self, address, values, skip_encode=False):
        ...
        """
        while len(values) > 62:
            await self._request('write_registers', address,
              values, skip_encode=skip_encode)
    ...
    async def _request(self, method, *args, **kwargs):
        ...
        if not self.open:
            ...
            if not (self.client.protocol is None or self.client.protocol.connected):
