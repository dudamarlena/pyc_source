...
class measure:
    ...
    def __init__(self, future_to_measure: tp.Optional[Future]=None, stop_on_stop: bool=True, adjust: float=0.0, time_getter_callable: tp.Callable[([], float)]=time.monotonic):
