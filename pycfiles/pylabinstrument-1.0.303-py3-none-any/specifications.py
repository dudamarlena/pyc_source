...
# Embedded file name: build/bdist.linux-x86_64/egg/labels/specifications.py
# Compiled at: 2015-11-28 23:22:04
...
class Specification(object):
    ...
    def _calculate(self):
        ...
        """
        for dimension in ('_sheet_width', '_sheet_height', '_columns', '_rows', '_label_width',
                          '_label_height'):
        ...
        for margin in ('_left_margin', '_column_gap', '_right_margin', '_top_margin',
                       '_row_gap', '_bottom_margin', '_left_padding', '_right_padding',
    ...
    def bounding_boxes(self, mode='fraction', output='dict'):
        ...
        for row in range(1, self.rows + 1):
            ...
            for column in range(1, self.columns + 1):
                ...
                if mode == 'fraction':
                    box = {'top': top / self.sheet_height, 'bottom': bottom / self.sheet_height, 
