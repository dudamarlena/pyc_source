...
class Credential(object):
    ...
    def __repr__(self):
        return "{classname}(host='{host}', port={port}, database='{database}', username={username}, password='xxxxxxxxxxxx')".format(classname=(self.__class__.__name__),
          host=(self.host),
          port=(self.port),
    ...
    def uri(self):
        ...
        """
        return self.uri_template.format(host=(self.host),
    ...
    def from_home_db_json(cls, identifier, key_mapping=None):
        ...
        """
        return cls.from_json(json_file=(cls.path_db_json),
    ...
    def from_env(cls, prefix, kms_decrypt=False, aws_profile=None):
        ...
        if len(prefix) < 1:
            ...
            if not prefix.endswith('_'):
                prefix = prefix + '_'
            data = dict(host=(os.getenv(prefix + 'HOST')),
...
if __name__ == '__main__':
    import boto3
    from base64 import b64decode
    cred = Credential.from_s3_json('sanhe-credential',
      'db/elephant-dupe-remove.json', aws_profile='sanhe')
    print(cred)