...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagentxmppserver/xmppserver_xmlrpc.py
# Compiled at: 2013-03-20 13:50:16
import xmlrpclib, xmpp
        ...
        if not only_humans:
            ...
            for user in users:
                ...
                try:
                    ...
                    if answer['content'] not in ('hypervisor', 'virtualmachine'):
                        n = n + 1
                except:
                    n = n + 1
