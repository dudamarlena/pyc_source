...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\AsyncSpider\core\base.py
# Compiled at: 2018-03-10 15:07:44
...
import concurrent.futures, asyncio, weakref
__all__ = [
 'CallbackMixin',
...
class SuperProcessorMixin:
    ...
    def remove_processor(self, processor):
        try:
            ...
            exc.args = (
             '{} is not in {}.processors'.format(processor, self),)
            raise
