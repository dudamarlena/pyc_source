...
# Embedded file name: build\bdist.win-amd64\egg\aggregate\param.py
# Compiled at: 2019-11-12 22:41:54
...
def hack_make_lines_from_csv(fn='../../../data/DIRECT_IEE.csv', do_save=False):
    ...
    """
    D = pd.read_csv(fn)
    line_to_pers_comm = {'Aggregate write-ins for Other Lines of Business':'Commercial',  'Aircraft (all perils)':'Commercial', 
