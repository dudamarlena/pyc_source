...
# [GCC 8.4.0]
# Embedded file name: /mnt/grid/mhammell/hpc/data/data/tam/TEToolkit/TEtranscripts_dev/TEToolkit/IO/ReadInputs.py
...
@version: 
"""
import sys, os, re, logging, time, gzip, collections
...
class SAM_Reader(FileOrSequence):
    ...
    def __iter__(self):
        for line in FileOrSequence.__iter__(self):
            ...
            yield (
             qname, int(flag), rname, int(pos) - 1, mapq, cigar, rnext, pnext, seq.upper())
