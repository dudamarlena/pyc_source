...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/sc/base/memberdataexport/browser/memberdata.py
...
class Exporter(BrowserView):
    ...
    def __init__(self, context, request):
        ...
        memberdataexport_properties = getattr(properties, 'memberdataexport_properties')
    ...
    def __call__(self, *args, **kwargs):
        ...
        writer = DictWriter(tmpfile, columns, extrasaction='ignore', dialect='modified_dialect')
    ...
    def _userData(self, userId):
        ...
        for m_prop in self._memberdata_properties:
            tmpUserData[m_prop] = str(member.getProperty(m_prop, '')).decode(defaultCharset).encode(mpEncoding)
