...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/litebo/config_space/util.py
...
def impute_default_values(configuration_space: ConfigurationSpace, configs_array: np.ndarray) -> np.ndarray:
