...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-facebook-posts/facebook_posts/tests.py
# Compiled at: 2015-11-29 09:15:25
"""
...
class FacebookPostsTest(TestCase):
    ...
    def test_fetch_post(self):
        ...
        self.assertEqual(post.link, 'http://developers.facebook.com/blog/post/497')
        self.assertEqual(post.name, 'Developer Roadmap Update: Moving to OAuth 2.0 + HTTPS')
    ...
    def test_post_fetch_application(self):
        ...
        application_json = {'name': 'NetworkedBlogs', 
    ...
    def test_post_fetch_authors_owners(self):
        author = {'name': 'Facebook Developers', 
    ...
    def test_post_fetch_comments_new_ids(self):
        ...
        self.assertEqual(Comment.objects.count(), 0)
        comments = post.fetch_comments(limit=1000)
    ...
    def test_page_fetch_posts_reduce_the_amount_error(self):
        ...
        self.assertEqual(posts.count(), 250)