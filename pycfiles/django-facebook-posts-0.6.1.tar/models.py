...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-facebook-posts/facebook_posts/models.py
# Compiled at: 2015-11-29 09:13:36
"""
...
if 'facebook_comments' in settings.INSTALLED_APPS:
    ...
    wall_comments = generic.GenericRelation(Comment, content_type_field='owner_content_type', object_id_field='owner_id', verbose_name='Comments')
else:
...
class Post(AuthorableModelMixin, LikableModelMixin, CommentableModelMixin, ShareableModelMixin, FacebookGraphIDModel):
    ...
    type = models.CharField(max_length=10, db_index=True, help_text='A string indicating the type for this post (including link, photo, video)')
    ...
    story = models.TextField(help_text='Text of stories not intentionally generatd by users, such as those generated when two users become friends; you must have the "Include recent activity stories" migration enabled in your app to retrieve these stories')
    ...
    story_tags = fields.JSONField(null=True, help_text='Objects (Users, Pages, etc) tagged in a non-intentional story; you must have the "Include recent activity stories" migration enabled in your app to retrieve these tags')
    with_tags = fields.JSONField(null=True, help_text='Objects (Users, Pages, etc) tagged as being with the publisher of the post ("Who are you with?" on Facebook)')
