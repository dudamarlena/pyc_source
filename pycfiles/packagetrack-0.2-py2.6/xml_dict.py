...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/packagetrack/xml_dict.py
# Compiled at: 2010-06-16 06:04:16
"""
...
def doc_to_dict(n):
    ...
    if len(n.childNodes) == 1 and first.nodeName == '#text':
        ...
        return dict((child.nodeName, doc_to_dict(child)) for child in n.childNodes if child.nodeName != '#text' or child.data.strip() != '')
