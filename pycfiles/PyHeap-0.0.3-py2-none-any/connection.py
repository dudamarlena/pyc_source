...
# Embedded file name: build/bdist.linux-x86_64/egg/healthvaultlib/helpers/connection.py
# Compiled at: 2016-01-12 13:29:23
...
class Connection:
    ...
    def set_person_and_record_from_personinfo(self):
        ...
        method.execute(self)
        self.set_person_and_record(method.response.personinfo.personid, method.response.personinfo.selected_record_id)