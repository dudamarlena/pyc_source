...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/Flasik/flasik/ext/htmlcompress.py
# Compiled at: 2019-08-24 18:38:43
...
def setup(app):
    if app.config.get('COMPRESS_HTML'):
        cls._app.jinja_env.add_extension(HTMLCompress)