...
# [GCC 8.4.0]
# Embedded file name: /home/lameiro/projects/cx_oracle_on_ctypes/cx_Oracle/variable_factory.py
...
all_variable_types = [
 vt_Float, vt_NumberAsString, vt_Boolean, vt_LongInteger, vt_String, vt_FixedNationalChar, vt_NationalCharString, vt_FixedChar, vt_Rowid, vt_Binary, vt_LongString, vt_LongBinary, vt_DateTime, vt_Date, vt_NCLOB, vt_CLOB, vt_BLOB, vt_BFILE, vt_Timestamp, vt_Interval, vt_Cursor]
if not python3_or_better():
...
vt_to_name = {vt_DateTime: 'vt_DateTime', 
...
mapping_python_type_to_variable_type = {STRING: vt_String, 
   str: vt_String, 
...
class VariableFactory(object):
    ...
    def type_by_oracle_data_type(self, oracle_data_type, charset_form):
        mapping = {oci.SQLT_LNG: vt_LongString, 
        ...
        if oracle_data_type == oci.SQLT_AFC:
            if python3_or_better() or charset_form == oci.SQLCS_NCHAR:
