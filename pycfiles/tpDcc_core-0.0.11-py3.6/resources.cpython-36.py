...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/managers/resources.py
# Compiled at: 2020-04-26 16:42:29
# Size of source mod 2**32: 7818 bytes
"""
...
class ResourcesManager(object):
    ...
    def register_resource(self, resources_path, key=None):
        ...
        if key:
            if key in self._resources:
                ...
                self._resources[key] = [
                 resource.Resource(resources_path)]
                ...
                for res_path in resources_paths:
                    ...
                    if res:
                        ...
                        if not resource_type:
                            path = res_fn(*args, **{'dirname': res_path})
                        else:
                            path = res_fn(args, dirname=res_path, **kwargs)
                        if path:
                            return path
    ...
    def gui(self, *args, **kwargs):
        ...
        :return:
        """
        return (self.get)(args, resource_type=ResourceTypes.GUI, **kwargs)
    ...
    def theme(self, *args, **kwargs):
        ...
        :return:
        """
        return (self.get)(args, resource_type=ResourceTypes.THEME, **kwargs)
    ...
    def _get_resource_function(self, res, resource_type):
        ...
        if resource_type == ResourceTypes.ICON:
            ...
            if resource_type == ResourceTypes.PIXMAP:
                res_fn = res.pixmap
            else:
                if resource_type == ResourceTypes.GUI:
                    res_fn = res.gui
                else:
                    if resource_type == ResourceTypes.THEME:
                        res_fn = res.theme
                    else:
                        res_fn = res.get
        return res_fn
