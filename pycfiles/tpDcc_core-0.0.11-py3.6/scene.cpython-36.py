...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/core/scene.py
...
class AbstractSceneWrapper(object):
    ...
    def __str__(self):
        return '<{} ({})>'.format(super(AbstractSceneWrapper, self).__str__().split()[0].split('.')[(-1)], self.display_name())
