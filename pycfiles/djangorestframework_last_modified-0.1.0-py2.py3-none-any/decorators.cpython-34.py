...
# [GCC 8.4.0]
# Embedded file name: /Users/josh/Development/django-rest-framework-last-modified/last_modified/decorators.py
# Compiled at: 2015-01-01 20:26:49
...
class LastModifiedProcessor(object):
    ...
    def __call__(self, func):
        ...
        def inner(self, request, *args, **kwargs):
            return this.process_conditional_request(view_instance=self, view_method=func, request=request, args=args, kwargs=kwargs)
    ...
    def process_conditional_request(self, view_instance, view_method, request, args, kwargs):
        ...
        res_last_modified = self.calculate_last_modified(view_instance=view_instance, view_method=view_method, request=request, args=args, kwargs=kwargs)
    ...
    def calculate_last_modified(self, view_instance, view_method, request, args, kwargs):
        ...
        if last_modified_func:
            dt = last_modified_func(view_instance=view_instance, view_method=view_method, request=request, args=args, kwargs=kwargs)
            if dt:
