...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/customBurndownChart/prefs.py
# Compiled at: 2011-09-19 06:46:35
"""
...
class BurndownChartAdminPanel(Component):
    ...
    def get_admin_panels(self, req):
        ...
        if 'TRAC_ADMIN' in req.perm:
            yield (
             'lshift', _('LShift'), 'burndownchart', _('Burndown Chart'))
    ...
    def render_admin_panel(self, req, category, page, path_info):
        ...
        if req.method == 'POST' and page == 'burndownchart':
            ...
            try:
                ...
                add_warning(req, _('Error writing to trac.ini, make sure it is writable by\n                      the web server. Your changes have not been saved.'))

            req.redirect(req.href.admin(category, page))
        return ('admin_bdc.html',
         dict((option, self.config.get(SECTION_NAME, option)) for option in options))
    ...
    def get_htdocs_dirs(self):
        ...
        return [
         (
          'prefs', resource_filename(__name__, 'htdocs'))]
