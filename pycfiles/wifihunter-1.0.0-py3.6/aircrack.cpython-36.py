...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/src/plugins/aircrack.py
# Compiled at: 2020-01-15 14:44:34
...
class Aircrack(Dependency):
    ...
    def crack_handshake(handshake, show_command=False):
        ...
        aircrack_nums_re = re.compile('(\\d+)/(\\d+) keys tested.*\\(([\\d.]+)\\s+k/s')
        aircrack_key_re = re.compile('Current passphrase:\\s*([^\\s].*[^\\s])\\s*$')
