...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/unimr/compositeindex/tests.py
# Compiled at: 2009-04-15 05:37:04
...
states = [
 'published', 'pending', 'private', 'intranet']
...
class CompositeIndexTests(ztc.ZopeTestCase):
    ...
    def beforeSetUp(self):
        ...
        zcml.load_config('configure.zcml', unimr.compositeindex)
    ...
    def testPerformance(self):
        ...
        queries = [{'portal_type': 'Document', 'review_state': 'pending'}, {'is_default_page': True, 'portal_type': 'Document', 'review_state': 'pending'}]
    ...
    def testSearch(self):
        ...
        self.cat.catalog_object(obj)
        queries = [{'review_state': 'pending', 'portal_type': 'Document'}, {'review_state': ['pending', 'visible'], 'portal_type': 'News'}, {'review_state': ['pending'], 'portal_type': ['News', 'Document']}, {'review_state': ['pending', 'visible'], 'portal_type': ['News', 'Document']}]
        for query in queries:
