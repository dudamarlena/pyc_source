...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0006_auto__add_field_modelbase_vote_total.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('jmbo_modelbase', 'vote_total', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
