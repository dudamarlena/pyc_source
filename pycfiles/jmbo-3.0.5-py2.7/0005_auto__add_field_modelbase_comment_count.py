...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0005_auto__add_field_modelbase_comment_count.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('jmbo_modelbase', 'comment_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        db.delete_column('jmbo_modelbase', 'comment_count')
