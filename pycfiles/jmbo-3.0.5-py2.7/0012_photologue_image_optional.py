...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0012_photologue_image_optional.py
...
class Migration(SchemaMigration):
    """Allow image to be null"""

    def forwards(self, orm):
        db.alter_column('photologue_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        db.alter_column('photologue_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
