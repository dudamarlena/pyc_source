...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0003_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('jmbo_modelbase', ['publish_on'])
        db.create_index('jmbo_modelbase', ['retract_on'])

    def backwards(self, orm):
        db.delete_index('jmbo_modelbase', ['retract_on'])
        db.delete_index('jmbo_modelbase', ['publish_on'])
