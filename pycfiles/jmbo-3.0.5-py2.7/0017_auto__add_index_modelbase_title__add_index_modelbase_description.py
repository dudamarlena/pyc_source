...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0017_auto__add_index_modelbase_title__add_index_modelbase_description.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('jmbo_modelbase', ['title'])
        if 'oracle' not in connection.vendor.lower():
            db.create_index('jmbo_modelbase', ['description'])

    def backwards(self, orm):
        if 'oracle' not in connection.vendor.lower():
            db.delete_index('jmbo_modelbase', ['description'])
        db.delete_index('jmbo_modelbase', ['title'])
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'jmbo.modelbase': {'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'ModelBase'}, 'anonymous_comments': (
                          ...
                          'date_taken': (
                                       'django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}), 
                          'description': (
                                        'django.db.models.fields.TextField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                          'effect': (
                          ...
                          'state': (
                                  'django.db.models.fields.CharField', [], {'default': "'unpublished'", 'max_length': '32', 'null': 'True', 'db_index': 'True', 'blank': 'True'}), 
                          'subtitle': (
                                     'django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}), 
                          'tags': (
                                 'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['category.Tag']", 'null': 'True', 'blank': 'True'}), 
                          'title': (
                                  'django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}), 
                          'view_count': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                          'vote_total': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
