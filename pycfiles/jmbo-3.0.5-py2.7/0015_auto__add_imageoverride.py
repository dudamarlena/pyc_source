...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0015_auto__add_imageoverride.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('jmbo_imageoverride', (
         (
         ...
         (
          'effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='imageoverride_related', null=True, to=orm['photologue.PhotoEffect'])),
         (
          'target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jmbo.ModelBase'])),
         (
          'photosize', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.PhotoSize']))))
        db.send_create_signal('jmbo', ['ImageOverride'])

    def backwards(self, orm):
        db.delete_table('jmbo_imageoverride')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'jmbo.imageoverride': {'Meta': {'object_name': 'ImageOverride'}, 'crop_from': (
                              ...
                              'effect': (
                                       'django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'imageoverride_related'", 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}), 
                              'id': (
                                   'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                              'image': (
                                      'django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}), 
                              'photosize': (
                                          'django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.PhotoSize']"}), 
                              'target': (
       ...
       'jmbo.modelbase': {'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'ModelBase'}, 'anonymous_comments': (
                          ...
                          'vote_total': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'jmbo.relation': {'Meta': {'unique_together': "(('source_content_type', 'source_object_id', 'target_content_type', 'target_object_id', 'name'),)", 'object_name': 'Relation'}, 'id': (
                              'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                         'name': (
       ...
       'photologue.photosize': {'Meta': {'ordering': "['width', 'height']", 'object_name': 'PhotoSize'}, 'crop': (
                                       'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                'effect': (
                                         'django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'photo_sizes'", 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}), 
                                'height': (
                                         'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                                'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                ...
                                'pre_cache': (
                                            'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                'quality': (
                                          'django.db.models.fields.PositiveIntegerField', [], {'default': '70'}), 
                                'upscale': (
                                          'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                'watermark': (
                                            'django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'photo_sizes'", 'null': 'True', 'to': "orm['photologue.Watermark']"}), 
                                'width': (
                                        'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'photologue.watermark': {'Meta': {'object_name': 'Watermark'}, 'description': (
                                              'django.db.models.fields.TextField', [], {'blank': 'True'}), 
                                'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                'image': (
                                ...
                                'name': (
                                       'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}), 
                                'opacity': (
                                          'django.db.models.fields.FloatField', [], {'default': '1'}), 
                                'style': (
                                        'django.db.models.fields.CharField', [], {'default': "'scale'", 'max_length': '5'})}, 
       ...
       'sites.site': {'Meta': {'ordering': "(u'domain',)", 'object_name': 'Site', 'db_table': "u'django_site'"}, 'domain': (
                      ...
                      'name': (
                             'django.db.models.fields.CharField', [], {'max_length': '50'})}}
    if USE_GIS:
        models.update({'atlas.city': {'Meta': {'ordering': "('name',)", 'object_name': 'City'}, 'coordinates': (
