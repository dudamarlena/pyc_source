...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0007_auto__add_field_modelbase_owner_override__add_field_modelbase_image_at.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('jmbo_modelbase', 'owner_override', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
        db.add_column('jmbo_modelbase', 'image_attribution', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
