...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0008_auto_datetime_indexes.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('jmbo_modelbase', ['created'])
        db.create_index('jmbo_modelbase', ['modified'])

    def backwards(self, orm):
        db.delete_index('jmbo_modelbase', ['modified'])
        db.delete_index('jmbo_modelbase', ['created'])
