...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0004_auto__add_field_modelbase_location.py
...
class Migration(SchemaMigration):
    if USE_GIS:
        depends_on = (('atlas', '0003_auto__chg_field_location_city'), )

    def forwards(self, orm):
        if USE_GIS:
            db.add_column('jmbo_modelbase', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atlas.Location'], null=True, blank=True), keep_default=False)
