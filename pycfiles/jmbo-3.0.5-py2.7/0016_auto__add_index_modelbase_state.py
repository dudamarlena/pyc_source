...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0016_auto__add_index_modelbase_state.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('jmbo_modelbase', ['state'])

    def backwards(self, orm):
        db.delete_index('jmbo_modelbase', ['state'])
