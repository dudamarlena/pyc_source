...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0011_increase_photologue_field_length_again.py
...
class Migration(SchemaMigration):
    """Copy of previous migration because we have a deployment using the old Photologue"""
    depends_on = (('photologue', '0009_auto__del_galleryupload'), )

    def forwards(self, orm):
        db.alter_column('photologue_photosize', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):
        db.alter_column('photologue_photosize', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'jmbo.modelbase': {'Meta': {'ordering': "('-created',)", 'object_name': 'ModelBase'}, 'anonymous_comments': (
                          ...
                          'vote_total': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'jmbo.pin': {'Meta': {'object_name': 'Pin'}, 'category': (
                               'django.db.models.fields.related.ForeignKey', [], {'to': "orm['category.Category']"}), 
                    'content': (
