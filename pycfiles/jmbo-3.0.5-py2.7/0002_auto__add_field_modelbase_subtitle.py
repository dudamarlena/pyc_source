...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jmbo/migrations/0002_auto__add_field_modelbase_subtitle.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('jmbo_modelbase', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('jmbo_modelbase', 'subtitle')
