...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/staff_info/views.py
# Compiled at: 2018-05-22 08:17:46
...
class GuiBuilder:
    ...
    def makeRefreshButton(self, filepath):
        sync_b = tkinter.Button(self.parent, command=lambda : onRefresh, justify='center', width='25', height='20')
...
gui_table_fields = [
 (
  'idEmp', Employee), ('fullname', Employee), ('dateOfEmp', Employee),
 (
