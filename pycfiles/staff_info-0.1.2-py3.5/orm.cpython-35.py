...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/db/orm.py
...
class Manager:
    ...
    def _create_objects(self, **kwargs):
        ...
        def _create_parameters(model, **kwargs):
            ...
            sql = 'INSERT INTO {} ({}) VALUES ({});'.format(model.table_name, column_list, placeholders_str)
            return (sql, values)

        sql, parameters = _create_parameters(self.model, **kwargs)
