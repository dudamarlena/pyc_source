...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/pygenesis/py_genesis_client.py
# Compiled at: 2019-11-19 13:57:26
...
class PyGenesisClient(object):
    sites = {'DESTATIS':{'webservice_url': 'https://www-genesis.destatis.de/genesisWS'}, 
     'LDNRW':{'webservice_url': 'https://www.landesdatenbank.nrw.de/ldbnrwws'}}
    endpoints = {'DownloadService':'/services/DownloadService?wsdl', 
    ...
    def __init__(self, site, username=None, password=None, language='de', drop_empty_rows_and_columns=False):
        ...
        self.base_params = {'sprache':language, 
         'kennung':'', 
         'passwort':''}
    ...
    def read(self, table_code, start_year=1900, end_year=2100, skip_header_rows=0, na_values=[
 '-', '/', 'x', '.', '...']):
        """
    ...
    def _build_download_params(self, table_code, start_year, end_year):
        return self._clone_and_update_base_params({'name':table_code, 
         'bereich':'Alle', 
