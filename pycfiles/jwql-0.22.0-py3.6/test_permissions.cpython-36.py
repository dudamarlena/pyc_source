...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jwql/tests/test_permissions.py
...
def test_file_group(test_file):
    ...
    if not has_permissions(test_file, group=test_group, owner=owner):
