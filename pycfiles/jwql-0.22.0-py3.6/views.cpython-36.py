...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jwql/website/apps/jwql/views.py
# Compiled at: 2019-08-26 11:08:03
# Size of source mod 2**32: 14237 bytes
...
def miri_data_trending(request):
    ...
    context = {'dashboard':dash, 
     'inst':'', 
     'inst_list':JWST_INSTRUMENT_NAMES_MIXEDCASE, 
     'tools':MONITORS, 
     'user':None}
...
def archive_thumbnails(request, user, inst, proposal):
    ...
    context = {'inst':inst,  'prop':proposal, 
...
def instrument(request, inst):
    ...
    url_dict = {'fgs':'http://jwst-docs.stsci.edu/display/JTI/Fine+Guidance+Sensor%2C+FGS?q=fgs',  'miri':'http://jwst-docs.stsci.edu/display/JTI/Mid+Infrared+Instrument', 
...
def view_image(request, user, inst, file_root, rewrite=False):
    ...
    context = {'inst':inst,  'file_root':file_root, 
