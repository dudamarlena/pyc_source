...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jwql/utils/permissions.py
...
DEFAULT_MODE = stat.S_IRWXU | stat.S_IRGRP | stat.S_IXGRP
...
def has_permissions(pathname, owner=DEFAULT_OWNER, mode=DEFAULT_MODE, group=DEFAULT_GROUP):
    ...
    if get_owner_string(pathname) != owner or file_statinfo.st_mode != mode or groupinfo.gr_name != group:
        return False
    else:
        return True
