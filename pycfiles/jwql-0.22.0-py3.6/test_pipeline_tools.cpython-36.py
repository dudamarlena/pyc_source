...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jwql/tests/test_pipeline_tools.py
...
def test_image_stack():
    ...
    truth[1, :, :] = 10.0
    truth[2, :, :] = 15.0
    if not np.all(image_stack == truth):
        raise AssertionError
    elif not exptimes == [[10.5], [10.5], [10.5]]:
        raise AssertionError
