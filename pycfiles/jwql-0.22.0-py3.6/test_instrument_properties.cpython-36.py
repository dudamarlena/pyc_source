...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jwql/tests/test_instrument_properties.py
...
def test_amplifier_info():
    ...
    fullframe_truth = (4,
     {'1':[(4, 4), (512, 2044)],  '2':[
      ...
      '4':[
       (1536, 4), (2044, 2044)]})
    if not fullframe == fullframe_truth:
...
def test_calc_frame_time():
    ...
    if not np.isclose(nrc_fullframe, nearir_fullframe, atol=0.001, rtol=0):
        raise AssertionError
    else:
