...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jwql/utils/plotting.py
...
def bar_chart(dataframe, groupcol, datacols=None, **kwargs):
    ...
    plt.vbar(x='x', top='counts', width=0.9, source=source, line_color='white', fill_color=factor_cmap('x', palette=(Category20c[colors]), factors=datacols,
      start=1,
      end=2))
    plt.y_range.start = 0
