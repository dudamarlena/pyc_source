...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-groups/odnoklassniki_groups/tests.py
# Compiled at: 2015-03-25 10:07:29
...
class OdnoklassnikiGroupsTest(TestCase):
    ...
    def test_get_by_url(self):
        ...
        urls = ('http://ok.ru/apiok/', 'http://ok.ru/apiok', 'http://odnoklassniki.ru/apiok',
                'http://www.odnoklassniki.ru/apiok', 'http://www.odnoklassniki.ru/group/53038939046008')
        for url in urls:
    ...
    def test_parse_group(self):
        ...
        self.assertEqual(instance.name, 'Группа для тестирования нового сервиса')
        self.assertEqual(instance.description, 'Группа для тестирования нового сервиса')
