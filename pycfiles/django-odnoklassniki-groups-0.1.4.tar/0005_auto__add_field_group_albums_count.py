...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-groups/odnoklassniki_groups/migrations/0005_auto__add_field_group_albums_count.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('odnoklassniki_groups_group', 'albums_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('odnoklassniki_groups_group', 'albums_count')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'odnoklassniki_discussions.discussion': {'Meta': {'object_name': 'Discussion'}, 'attrs': (
                                                ...
                                                'title': (
                                                        'django.db.models.fields.TextField', [], {})}, 
       'odnoklassniki_groups.group': {'Meta': {'object_name': 'Group'}, 'albums_count': (
