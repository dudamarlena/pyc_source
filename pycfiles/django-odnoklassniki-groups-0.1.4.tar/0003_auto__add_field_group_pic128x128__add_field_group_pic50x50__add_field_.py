...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-groups/odnoklassniki_groups/migrations/0003_auto__add_field_group_pic128x128__add_field_group_pic50x50__add_field_.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('odnoklassniki_groups_group', 'pic128x128', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)
        db.add_column('odnoklassniki_groups_group', 'pic50x50', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)
        db.add_column('odnoklassniki_groups_group', 'pic640x480', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)

    def backwards(self, orm):
        db.delete_column('odnoklassniki_groups_group', 'pic128x128')
        db.delete_column('odnoklassniki_groups_group', 'pic50x50')
        db.delete_column('odnoklassniki_groups_group', 'pic640x480')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'odnoklassniki_groups.group': {'Meta': {'object_name': 'Group'}, 'attrs': (
                                              'annoying.fields.JSONField', [], {'null': 'True'}), 
                                      'description': (
                                                    'django.db.models.fields.TextField', [], {}), 
                                      'discussions_count': (
