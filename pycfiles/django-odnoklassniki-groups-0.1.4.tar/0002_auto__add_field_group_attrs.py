...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-groups/odnoklassniki_groups/migrations/0002_auto__add_field_group_attrs.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('odnoklassniki_groups_group', 'attrs', self.gf('annoying.fields.JSONField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('odnoklassniki_groups_group', 'attrs')
