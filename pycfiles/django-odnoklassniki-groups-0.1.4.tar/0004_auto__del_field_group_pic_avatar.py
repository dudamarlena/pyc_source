...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-groups/odnoklassniki_groups/migrations/0004_auto__del_field_group_pic_avatar.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('odnoklassniki_groups_group', 'pic_avatar')

    def backwards(self, orm):
        db.add_column('odnoklassniki_groups_group', 'pic_avatar', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)
