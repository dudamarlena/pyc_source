...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture_old/env/src/django-odnoklassniki-groups/odnoklassniki_groups/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('odnoklassniki_groups_group', (
         (
        ...
        db.send_create_signal('odnoklassniki_groups', ['Group'])
        m2m_table_name = db.shorten_name('odnoklassniki_groups_group_users')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'group', models.ForeignKey(orm['odnoklassniki_groups.group'], null=False)),
         (
          'user', models.ForeignKey(orm['odnoklassniki_users.user'], null=False))))
        db.create_unique(m2m_table_name, ['group_id', 'user_id'])
        db.add_column('odnoklassniki_groups_group_users', 'time_from', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
        db.add_column('odnoklassniki_groups_group_users', 'time_to', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)

    def backwards(self, orm):
        db.delete_table('odnoklassniki_groups_group')
        db.delete_table(db.shorten_name('odnoklassniki_groups_group_users'))
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'odnoklassniki_groups.group': {'Meta': {'object_name': 'Group'}, 'description': (
                                                    'django.db.models.fields.TextField', [], {}), 
                                      'discussions_count': (
                                      ...
                                      'users': (
                                              'm2m_history.fields.ManyToManyHistoryField', [], {'to': "orm['odnoklassniki_users.User']", 'symmetrical': 'False'})}, 
