...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\zhihu\models\account.py
...
class Account(Model):
    ...
    def _register_validate(self, data):
        r = super(Account, self)._execute(method='post', url=(URL.register_validate()),
          data=data,
