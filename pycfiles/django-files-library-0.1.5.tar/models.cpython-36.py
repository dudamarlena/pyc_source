...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/django_files_library/models.py
# Compiled at: 2018-02-10 08:23:30
...
class Library(models.Model):
    ...
    def user_can_read(self, user):
        return self.is_public or self.permission_set.filter(Q(Q(user=user) & Q(Q(access_level='O') | Q(access_level='R')))).exists()

    def user_can_write(self, user):
        return self.permission_set.filter(Q(Q(user=user) & Q(Q(access_level='O') | Q(access_level='W')))).exists()
