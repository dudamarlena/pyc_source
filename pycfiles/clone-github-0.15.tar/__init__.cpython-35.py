...
# Embedded file name: build/bdist.linux-x86_64/egg/clone/__init__.py
# Compiled at: 2017-04-06 19:22:17
# Size of source mod 2**32: 6553 bytes
__doc__ = '\nclone\n=====\n\nClone Git repositories without installing Git.\n'
import getpass, os, sys, urllib.request, zipfile
URL_TEMPLATES = {'bitbucket': 'https://bitbucket.org/{user}/{repo}/get/master.zip', 
