...
# [GCC 8.4.0]
# Embedded file name: D:\Github-Code\weibo-preprocess-toolkit\weibo_preprocess_toolkit\lib\langconv.py
# Compiled at: 2019-06-09 21:29:52
...
class Converter(object):
    ...
    def end(self):
        self.machines = [fsm for fsm in self.machines if not fsm.state == FAIL if fsm.state == END]
        self._clean()
