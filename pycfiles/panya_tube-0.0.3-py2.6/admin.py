...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tube/admin.py
# Compiled at: 2011-01-07 07:47:27
import math, mimetypes, os, subprocess, tempfile
...
class ClipForm(forms.ModelForm):
    image_choice = forms.fields.CharField(widget=forms.RadioSelect(renderer=RadioFieldImageRenderer), required=False, help_text='Upload a media resource above to enable scraped image selection.')
