...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyosci/powersupply.py
# Compiled at: 2017-02-16 04:18:58
    ...
    def select_channel(self, channel):
        ...
        if isinstance(channel, int):
            ...
            if isinstance(channel, str):
                if not channel in (KCmd.P6, KCmd.P25, KCmd.N25):
                    raise AssertionError('Channel has to be in {}'.format(KCmd.P6, KCmd.P25, KCmd.N25))
            else:
