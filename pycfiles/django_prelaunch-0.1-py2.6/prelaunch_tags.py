...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/prelaunch/templatetags/prelaunch_tags.py
...
def prelaunch_form(context):
    ...
    if request.method == 'POST':
        form = PrelaunchForm(request.POST)
        if form.is_valid():
            referrer = None
            ...
            c = Context({'http_referer': request.META['HTTP_REFERER'], 
    ...
    return {'form_target': request.path, 'email_hash': email_hash, 
       'form': form}