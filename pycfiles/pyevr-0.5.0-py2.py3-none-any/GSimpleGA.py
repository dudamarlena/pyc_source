...
# Embedded file name: build\bdist.win32\egg\pyevolve\GSimpleGA.py
...
import Consts, Util, random, logging
from time import time
from types import BooleanType
from sys import exit as sys_exit
from sys import platform as sys_platform
import code, pyevolve
   ...
   """
    ...
    def step(self):
        ...
        for i in xrange(0, size_iterate, 2):
            ...
            elif not genomeMom.crossover.isEmpty() and Util.randomFlipCoin(self.pCrossover):
                for it in genomeMom.crossover.applyFunctions(genomeMom, mom=genomeMom, dad=genomeDad, count=2):
                    (sister, brother) = it
        ...
        if self.elitism:
            ...
            elif self.internalPop.bestRaw().score < newPop.bestRaw().score:
                    ...
                    if sys_platform[:3] == 'win':
                        if msvcrt.kbhit():
                            if ord(msvcrt.getch()) == Consts.CDefESCKey:
                                ...
                                session_locals = {'ga_engine': self, 'population': self.getPopulation(), 
                                   'pyevolve': pyevolve, 
