...
# Embedded file name: build/bdist.linux-i686/egg/alfanous/Support/whoosh/filedb/structfile.py
...
class StructFile(object):
    ...
    def get_array(self, position, typecode, length):
        return unpack('!' + typecode * length, self.map[position:position + _SIZEMAP[typecode] * length])