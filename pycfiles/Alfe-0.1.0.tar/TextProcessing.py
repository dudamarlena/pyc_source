...
# Embedded file name: build/bdist.linux-i686/egg/alfanous/TextProcessing.py
# Compiled at: 2015-06-30 06:52:38
__doc__ = '\nit contains the linguistic analyzers of Quran and Arabic...etc.\n\n\n@author: Assem Chelli\n@contact: assem.ch [at] gmail.com\n@license: AGPL\n\n'
import re
from alfanous.Support.whoosh.analysis import StopFilter, RegexTokenizer
from alfanous.Support.PyArabic.araby import strip_tashkeel, strip_tatweel, strip_shadda, normalize_spellerrors, normalize_hamza, normalize_lamalef, normalize_uthmani_symbols
...
class unicode_(unicode):
    ...
    def list_harakat(self):
        ...
        hdic = {}
        for ch in self:
            if unicode(ch) in [FATHATAN, DAMMATAN, KASRATAN, FATHA, DAMMA, KASRA, SUKUN]:
                cptH -= 1
