...
# [GCC 8.4.0]
# Embedded file name: /Users/robmoorman/Developer/moori/wagtail-speech/src/wagtailspeech/utils.py
# Compiled at: 2017-05-23 08:36:06
...
def synthesize_speech_from_page(request, page):
    ...
    if hasattr(page, 'get_speech_text'):
        ...
        response = client.synthesize_speech(OutputFormat=output_format,
