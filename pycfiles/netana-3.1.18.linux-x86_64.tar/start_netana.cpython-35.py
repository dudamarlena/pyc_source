...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/netana/start_netana.py
# Compiled at: 2017-05-29 16:39:29
# Size of source mod 2**32: 3876 bytes
from tkinter import *
from tkinter import ttk
import tkinter.filedialog as tfd, webbrowser, os
...
class NetAna(AnalizeSpec):
    ...
    def bld_menu(self, master):
        ...
        filemenu.add_command(label='SpecFile', underline=0, command=self.getspecfn)
