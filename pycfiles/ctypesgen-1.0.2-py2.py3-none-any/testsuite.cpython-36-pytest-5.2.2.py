...
class StdBoolTest(unittest.TestCase):
    __doc__ = 'Test correct parsing and generation of bool type'
...
class SimpleMacrosTest(unittest.TestCase):
    __doc__ = 'Based on simple_macros.py\n    '
...
class StructuresTest(unittest.TestCase):
    __doc__ = 'Based on structures.py\n    '
...
class MathTest(unittest.TestCase):
    __doc__ = 'Based on math_functions.py'
...
class LongDoubleTest(unittest.TestCase):
    __doc__ = "Test correct parsing and generation of 'long double' type"
...
class UncheckedTest(unittest.TestCase):
    __doc__ = 'Fixing a bug in 1.0.0 - basic type returns of function pointers get treated as pointers'
