...
# [GCC 8.4.0]
# Embedded file name: /home/alanr/monitor/ctypesgen-davidjamesca/ctypesgen/ctypesgen/version.py
...
__all__ = [
 'VERSION', 'version_tuple', 'version', 'compatible']
...
if __name__ == '__main__':
    ...
    p.add_argument('--read-file-version', action='store_true', help='Read the version stored in ' + VERSION_FILE)
    args = p.parse_args()
    v = version()
    if args.save:
