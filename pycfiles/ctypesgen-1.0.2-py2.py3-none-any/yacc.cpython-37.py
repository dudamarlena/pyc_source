                ...
                if t == None:
                    if debug:
                        ...
                        if self.errorfunc:
                            ...
                            del token
                            del restart
                            lookahead = self.errorcount or tok
                            errtoken = None
                            continue
                        else:
                            if errtoken:
                            ...
                            if r is not None:
                                if r > 0:
                                    ...
                                    if not (slevel < rlevel or slevel) == rlevel or rprec == 'left':
                                        ...
                                        actionp[(st, a)] = p
                                        slevel or rlevel or _vfc.write('shift/reduce conflict in state %d resolved as reduce.\n' % st)
                                ...
                                if r > 0:
                                    if r != j:
                                        ...
                                        if r < 0:
                                            ...
                                            sprec, slevel = Precedence.get(a, ('right',
                                                                               0))
...
def yacc--- This code section failed: ---
 ...
 L.2219       282  LOAD_GLOBAL              MiniProduction
              284  CALL_FUNCTION_0       0  '0 positional arguments'
              286  STORE_FAST               'm'
 ...
 L.2237       430  LOAD_GLOBAL              isinstance
          ...
          438_440  POP_JUMP_IF_TRUE    462  'to 462'
              ...
              448  CALL_FUNCTION_2       2  '2 positional arguments'
 ...
 L.2276       700  LOAD_GLOBAL              isinstance
          ...
          708_710  POP_JUMP_IF_TRUE    732  'to 732'
              ...
              718  CALL_FUNCTION_2       2  '2 positional arguments'
 ...
 L.2290       830  LOAD_GLOBAL              isinstance
              ...
              838  CALL_FUNCTION_2       2  '2 positional arguments'
 ...
 L.2299       900  LOAD_GLOBAL              YaccError
              ...
              914  RAISE_VARARGS_1       1  'exception instance'
 ...
 L.2335      1082  LOAD_GLOBAL              lr_init_vars
             1084  CALL_FUNCTION_0       0  '0 positional arguments'
             1086  POP_TOP          
 ...
 L.2357      1210  LOAD_DEREF               'ldict'
             ...
             1216  GET_ITER         
             1218  CALL_FUNCTION_1       1  '1 positional argument'
 ...
 L.2368      1242  LOAD_GLOBAL              compute_first1
             1244  CALL_FUNCTION_0       0  '0 positional arguments'
             1246  POP_TOP          
 ...
 L.2374      1276  LOAD_GLOBAL              YaccError
             ...
             1286  RAISE_VARARGS_1       1  'exception instance'
 ...
 L.2377      1294  LOAD_GLOBAL              lr_write_tables
             ...
             1300  CALL_FUNCTION_2       2  '2 positional arguments'
             1302  POP_TOP          
 ...
 L.2381      1312  LOAD_GLOBAL              open
             ...
             1326  LOAD_STR                 'w'
             1328  CALL_FUNCTION_2       2  '2 positional arguments'
             1330  STORE_FAST               'f'
 ...
 L.2382      1332  LOAD_FAST                'f'
             ...
             1340  CALL_METHOD_0         0  '0 positional arguments'
             1342  CALL_METHOD_1         1  '1 positional argument'
             1344  POP_TOP          
 ...
 L.2392      1432  LOAD_GLOBAL              ParserPrototype
             1434  LOAD_STR                 'xyzzy'
             1436  CALL_FUNCTION_1       1  '1 positional argument'
             1438  STORE_FAST               'g'
 ...
 L.2408      1496  LOAD_GLOBAL              yacc_cleanup
             1498  CALL_FUNCTION_0       0  '0 positional arguments'
             1500  POP_TOP          
