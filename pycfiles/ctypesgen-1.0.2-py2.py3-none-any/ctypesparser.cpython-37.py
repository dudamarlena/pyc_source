...
class CtypesParser(CParser):
    __doc__ = 'Parse a C file for declarations that can be used by ctypes.\n\n    Subclass and override the handle_ctypes_* methods.\n    '
    ...
    def get_ctypes_type(self, typ, declarator, check_qualifiers=False):
        ...
        if (t or (
         typename, signed, longs)) in self.type_map:
            ...
            if signed:
                ...
                if isinstance(t.destination, CtypesSimple) and t.destination.name == 'char' and t.destination.signed:
