...
# [GCC 8.4.0]
# Embedded file name: /Users/Leslie/workspace/ctrip/cdportal/cdportal/venv/lib/python2.7/site-packages/user_behavior/services.py
# Compiled at: 2016-11-18 01:15:26
...
def get_request_data(request):
    ...
    return {'client': {'ip': get_request_ip(request)}, 
       'server': {'host': server[0], 
                  'port': server[1]}, 
