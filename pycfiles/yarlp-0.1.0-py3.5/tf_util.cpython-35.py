...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yarlp/external/baselines/baselines/common/tf_util.py
...
def function(inputs, outputs, updates=None, givens=None):
    ...
    if isinstance(outputs, list):
        ...
        if isinstance(outputs, (dict, collections.OrderedDict)):
            ...
            return lambda *args**args: type(outputs)(zip(outputs.keys(), f(*args, **kwargs)))
        f = _Function(inputs, [outputs], updates, givens=givens)
        return lambda *args**args: f(*args, **kwargs)[0]
