...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yarlp/external/baselines/baselines/deepq/build_graph.py
...
"""
import tensorflow as tf, baselines.common.tf_util as U
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        _act = U.function(inputs=[observations_ph, stochastic_ph, update_eps_ph], outputs=output_actions, givens={update_eps_ph: -1.0, stochastic_ph: True}, updates=[
         update_eps_expr])
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        train = U.function(inputs=[
         ...
         obs_tp1_input,
         done_mask_ph,
         importance_weights_ph], outputs=td_error, updates=[
         optimize_expr])
