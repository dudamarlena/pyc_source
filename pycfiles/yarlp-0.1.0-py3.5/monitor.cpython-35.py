...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yarlp/external/baselines/baselines/bench/monitor.py
...
import csv, os.path as osp, json
...
class Monitor(Wrapper):
    ...
    def __init__(self, env, filename, allow_early_resets=False, reset_keywords=()):
        ...
        if filename is None:
            self.f = None
            self.logger = None
        elif not filename.endswith(Monitor.EXT):
