...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yarlp/external/baselines/baselines/trpo_mpi/trpo_mpi.py
...
def learn(env, policy_fn, *, timesteps_per_batch, max_kl, cg_iters, gamma, lam, entcoeff=0.0, cg_damping=0.01, vf_stepsize=0.0003, vf_iters=3, max_timesteps=0, max_episodes=0, max_iters=0, callback=None):
