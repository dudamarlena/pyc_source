...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/yarlp/external/baselines/baselines/ddpg/main.py
# Compiled at: 2018-04-01 14:21:44
# Size of source mod 2**32: 5321 bytes
import argparse, time, os, logging
...
def run(env_id, seed, noise_type, layer_norm, evaluation, **kwargs):
    ...
    memory = Memory(limit=int(1000000.0), action_shape=env.action_space.shape, observation_shape=env.observation_space.shape)
