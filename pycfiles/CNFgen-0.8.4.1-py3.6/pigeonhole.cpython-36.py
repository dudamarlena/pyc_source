...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cnfformula/families/pigeonhole.py
...
def GraphPigeonholePrinciple(graph, functional=False, onto=False):
    ...
    mapping = gphp.unary_mapping(Left, Right, sparsity_pattern=graph,
      var_name=var_name,
      injective=True,
      functional=functional,
      surjective=onto)
...
class PHPCmdHelper(object):
    __doc__ = 'Command line helper for the Pigeonhole principle CNF'
    name = 'php'
    ...
    def setup_command_line(parser):
        ...
        parser.add_argument('--functional', action='store_true', help='pigeons sit in at most one hole')
        parser.add_argument('--onto', action='store_true', help='every hole has a sitting pigeon')
    ...
    def build_cnf(args):
        ...
        """
        return PigeonholePrinciple((args.pigeons), (args.holes),
...
@cnfformula.cmdline.register_cnfgen_subcommand
class GPHPCmdHelper:
    __doc__ = 'Command line helper for the Pigeonhole principle on graphs'
    name = 'gphp'
    ...
    def build_cnf(args):
        ...
        return GraphPigeonholePrinciple(G, functional=(args.functional),
          onto=(args.onto))
