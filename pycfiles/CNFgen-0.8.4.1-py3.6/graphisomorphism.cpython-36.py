...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cnfformula/families/graphisomorphism.py
...
def GraphIsomorphism(G1, G2):
    ...
    """
    F = CNF()
    F.header = 'Graph Isomorphism problem between graphs ' + G1.name + ' and ' + G2.name + '\n' + F.header
...
class GAutoCmdHelper(object):
    __doc__ = 'Command line helper for Graph Automorphism formula\n    '
    name = 'gauto'
