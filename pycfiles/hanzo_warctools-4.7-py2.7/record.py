...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/hanzo/warctools/record.py
...
class ArchiveRecord(object):
    ...
    @classmethod
    def open_archive(cls, filename=None, file_handle=None, mode='rb+', gzip='auto', offset=None, length=None):
