...
# [GCC 8.4.0]
# Embedded file name: /Users/brocaar/Work/Projects/Brocaar/Flask/flask-views/flask_views/tests/unit/test_base.py
# Compiled at: 2012-02-23 14:54:37
...
class ViewTestCase(unittest.TestCase):
    ...
    def test_dispatch_request(self, super_mock):
        ...
        view = View()
        self.assertEqual('dispatch_request', view.dispatch_request('foo', 'bar', foo='bar'))
        self.assertEqual(('foo', 'bar'), view.args)
        self.assertEqual({'foo': 'bar'}, view.kwargs)
        super_mock.assert_called_once_with(View, view)
        super_class.dispatch_request.assert_called_once_with('foo', 'bar', foo='bar')
...
class TemplateResponseMixinTestCase(unittest.TestCase):
    ...
    def test_render_to_response(self, render_template):
        ...
        self.assertEqual('rendered-template', mixin.render_to_response({'foo': 'bar'}))
