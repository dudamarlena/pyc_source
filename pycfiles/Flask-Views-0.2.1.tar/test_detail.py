...
# [GCC 8.4.0]
# Embedded file name: /Users/brocaar/Work/Projects/Brocaar/Flask/flask-views/flask_views/tests/unit/db/mongoengine/test_detail.py
# Compiled at: 2012-02-26 08:24:57
import unittest2 as unittest
from mock import Mock
from flask_views.base import View, TemplateResponseMixin
from flask_views.db.mongoengine.detail import SingleObjectMixin, BaseDetailView, DetailView
...
class SingleObjectMixinTestCase(unittest.TestCase):
    ...
    def test_get_object(self):
        ...
        mixin.get_fields = {'db_id': 'url_id'}
        mixin.kwargs = {'url_id': '1234abc'}
    ...
    def test_get_context_data(self):
        ...
        self.assertEqual({'foo': 'bar', 
           'obj_name': mixin.object}, mixin.get_context_data(foo='bar'))
...
class DetailViewTestCase(unittest.TestCase):
    ...
    def test_inherited_classes(self):
        ...
        """
        self.assertEqual([
         TemplateResponseMixin, BaseDetailView], DetailView.mro()[1:3])