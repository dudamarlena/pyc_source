...
# [GCC 8.4.0]
# Embedded file name: /Users/brocaar/Work/Projects/Brocaar/Flask/flask-views/flask_views/tests/unit/test_edit.py
# Compiled at: 2012-02-23 14:54:44
...
class FormMixinTestCase(unittest.TestCase):
    ...
    def test_get_form_kwargs(self, request):
        ...
        self.assertEqual({'formdata': {'foo': 'bar'}, 'name': 'John'}, mixin.get_form_kwargs())
