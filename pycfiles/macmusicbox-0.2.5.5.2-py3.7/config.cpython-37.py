...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/NEMbox/config.py
# Compiled at: 2020-03-16 06:19:21
...
class Config(Singleton):
    ...
    def __init__(self):
        ...
        self.default_config = {'version':8, 
         ...
         'music_quality':{'value':0, 
          'default':0, 
          'describe':'Select the quality of the music. May be useful when network is terrible. 0 for high quality, 1 for medium and 2 for low.'}, 
         'global_play_pause':{'value':'<ctrl><alt>p', 
          'default':'<ctrl><alt>p', 
          'describe':'Global keybind for play/pause.Uses gtk notation for keybinds.'}, 
         'global_next':{'value':'<ctrl><alt>j', 
          'default':'<ctrl><alt>j', 
          'describe':'Global keybind for next song.Uses gtk notation for keybinds.'}, 
         'global_previous':{'value':'<ctrl><alt>k', 
          'default':'<ctrl><alt>k', 
          'describe':'Global keybind for previous song.Uses gtk notation for keybinds.'}, 
         'notifier':{'value':True, 
          'default':True, 
