...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/NEMbox/osdlyrics.py
# Compiled at: 2020-03-22 02:19:11
...
if pyqt_activity:
    ...
    class Lyrics(QtGui.QWidget):
        ...
        def __init__(self):
            ...
            self._Lyrics__dbusAdaptor = LyricsAdapter(self)
            self.initUI()
    ...
    class LyricsAdapter(QtDBus.QDBusAbstractAdaptor):
        ...
        QtCore.Q_CLASSINFO('D-Bus Introspection', '  <interface name="local.musicbox.Lyrics">\n    <method name="refresh_lyrics">\n      <arg direction="in" type="s" name="lyric"/>\n    </method>\n  </interface>\n')
