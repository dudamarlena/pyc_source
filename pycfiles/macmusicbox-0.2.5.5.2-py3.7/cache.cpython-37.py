...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/w3/yc8mtbd91vs80rp79zfgk8x00000gn/T/pip-install-aqb0355v/NetEase-MusicBox/NEMbox/cache.py
...
import threading, subprocess, os, signal
        ...
        while 1:
            ...
            if new_url:
                ...
                try:
                    ...
                    log.debug(para)
                    self.aria2c = subprocess.Popen(para, stdin=(subprocess.PIPE),
                    ...
                    try:
                        ...
                        para = [
                         'wget', '-O', full_path, new_url]
                        self.wget = subprocess.Popen(para, stdin=(subprocess.PIPE),
                          stdout=(subprocess.PIPE),
                          stderr=(subprocess.PIPE))
                        self.wget.wait()
                    finally:
