...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/marrow/script/core.py
# Compiled at: 2010-11-24 19:56:07
from __future__ import print_function
import os, sys, types, inspect, logging
...
class Parser(object):
    ...
    def spec(self, fn, top=True):
        ...
        if top:
            (keywords['help'], types_['help'], short['h'], descriptions['help']) = (
             None, boolean, 'help', 'Display this help and exit.')
        ...
        return Bunch(arguments=arguments, keywords=keywords, args=args, kwargs=kwargs, descriptions=descriptions, types=types_, range=args_range, short=short)
            ...
            if state:
                ...
                if not nomore and arg.startswith('--'):
                    ...
                    if not value and spec.types.get(name, None) is boolean:
                        kwargs[name] = not kwargs.get(name, False)
