...
# Compiled at: 2020-04-29 17:23:59
# Size of source mod 2**32: 27943 bytes
"""
...
class AsyncHuaweiSolar:
 ...
 L. 281        14  LOAD_FAST                'client'
               16  LOAD_ATTR                connected
               18  POP_JUMP_IF_TRUE     42  'to 42'

 L. 282        20  LOAD_STR                 'failed to connect to device, is the host correct?'
               22  STORE_FAST               'message'

 L. 283        24  LOAD_GLOBAL              LOGGER
               26  LOAD_METHOD              exception
               28  LOAD_FAST                'message'
               30  CALL_METHOD_1         1  ''
               32  POP_TOP          

 L. 284        34  LOAD_GLOBAL              ConnectionException
               36  LOAD_FAST                'message'
               38  CALL_FUNCTION_1       1  ''
               40  RAISE_VARARGS_1       1  'exception instance'
             42_0  COME_FROM            18  '18'

 L. 285        42  SETUP_FINALLY        98  'to 98'

 L. 286        44  LOAD_GLOBAL              asyncio
               46  LOAD_ATTR                wait_for

 L. 287        48  LOAD_FAST                'client'
 ...
 L. 295       144  LOAD_STR                 'could not read register value, is an other device already connected?'

 L. 294       146  STORE_FAST               'message'

 L. 298       148  LOAD_GLOBAL              LOGGER
              150  LOAD_METHOD              error
              152  LOAD_FAST                'message'
              154  CALL_METHOD_1         1  ''
              156  POP_TOP          

 L. 299       158  LOAD_GLOBAL              ReadException
 ...
 L. 302       174  LOAD_STR                 'could not read register value for unknown reason'
              176  STORE_FAST               'message'

 L. 303       178  LOAD_GLOBAL              LOGGER
              180  LOAD_METHOD              error
              182  LOAD_FAST                'message'
              184  CALL_METHOD_1         1  ''
              186  POP_TOP          

 L. 304       188  LOAD_GLOBAL              ReadException
