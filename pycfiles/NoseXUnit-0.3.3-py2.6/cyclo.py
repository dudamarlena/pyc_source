...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/nosexunit/cyclo.py
...
class PathGraphingAstVisitor(compiler.visitor.ASTVisitor):
    ...
    visitAssert = visitAssign = visitAssTuple = visitPrint = visitPrintnl = visitRaise = visitSubscript = visitDecorators = visitPass = visitDiscard = visitGlobal = visitReturn = visitSimpleStatement
