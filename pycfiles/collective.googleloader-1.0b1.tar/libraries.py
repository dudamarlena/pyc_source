...
# Embedded file name: /home/toutpt/workspace/collective.googlelibraries/collective/googlelibraries/libraries.py
# Compiled at: 2010-12-01 18:52:18
import json
...
GOOGLE_LIBRARIES['dojo']['versions'] = ('1.1.1', '1.2.0', '1.2.3', '1.3.0', '1.3.1',
                                        '1.3.2', '1.4.0', '1.4.1', '1.4.3', '1.5')
...
GOOGLE_LIBRARIES['jquery']['versions'] = ('1.2.3', '1.2.6', '1.3.0', '1.3.1', '1.3.2',
...
GOOGLE_LIBRARIES['jqueryui']['versions'] = ('1.5.2', '1.5.3', '1.6.0', '1.7.0', '1.7.1',
                                            '1.7.2', '1.7.3', '1.8.0', '1.8.1', '1.8.2',
                                            '1.8.4', '1.8.5', '1.8.6')
...
GOOGLE_LIBRARIES['mootools']['versions'] = ('1.1.1', '1.1.2', '1.2.1', '1.2.2', '1.2.3',
                                            '1.2.4', '1.2.5', '1.3.0')
...
class LibraryWidget(ASCIIWidget):
    ...
    def hasInput(self):
        return self.name + '.id' in self.request.form and self.name + '.version' in self.request.form and self.name + '.settings'
    ...
    def __call__(self):
        ...
        id += '</select>'
        version = renderElement(self.tag, type=self.type, name=self.name + '.version', id=self.name + '.version', value=value[1], cssClass=self.cssClass, size=8, extra=self.extra)
