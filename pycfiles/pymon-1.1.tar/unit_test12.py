...
# Embedded file name: /home/travis/build/WellDone/pymomo/pymomo/config/site_scons/unit_test12.py
# Compiled at: 2015-03-19 14:45:48
import unit_test, pic12_unit
from pymomo.exceptions import *
from pymomo.gpysim import i2c_log
import os.path
typemap = {'RS': i2c_log.RepeatedStartCondition, 'S': i2c_log.StartCondition, 'P': i2c_log.StopCondition, 
   'A': i2c_log.AddressByte, 'D': i2c_log.DataByte}
...
class Pic12UnitTest(unit_test.UnitTest):
    ...
    def _check_i2c_output(self, chip):
        ...
        return (
         status, analyzer.format(), self._format_i2c_sequence())
