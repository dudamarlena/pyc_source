...
# Embedded file name: /home/travis/build/WellDone/pymomo/pymomo/config/site_scons/unit_test.py
# Compiled at: 2015-03-19 14:45:48
import os.path, os
from SCons.Environment import Environment
import test_summary, fnmatch
...
def find_sources(src_dir, patterns=(
 '*.c', '*.as', '*.asm')):
    """
