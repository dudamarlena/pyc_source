...
# Embedded file name: /home/travis/build/WellDone/pymomo/pymomo/config/site_scons/site_tools/xc16_compiler.py
...
_xc16_obj = SCons.Builder.Builder(generator=xc16_generator, suffix='.o', source_scanner=SCons.Scanner.C.CScanner())
