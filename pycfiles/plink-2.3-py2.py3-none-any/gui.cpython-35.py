...
if sys.platform == 'linux2' or sys.platform == 'linux':
    ...
    """
        if sys.platform == 'darwin' and 'defaultextension' in options and 'initialfile' not in options:
    ...
    if sys.platform == 'linux2':
        ...
        def askopenfile(parent=None):
            return tkFileDialog.askopenfile(parent=parent, mode='r', title='Open SnapPea Projection File')


    else:

        def askopenfile(parent=None):
            return tkFileDialog.askopenfile(parent=parent, mode='r', title='Open SnapPea Projection File', defaultextension='.lnk', filetypes=[
