...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/toughbt/mputils.py
# Compiled at: 2016-03-20 13:19:58
...
class MP:
    ...
    def spawn(self, name, executable, args=(), env={}, path=None, uid=None, gid=None, usePTY=0, childFDs=None):
        ...
        ps.append(pp)
        reactor.spawnProcess(pp, executable, args=args, path=path, env=env, uid=uid, gid=gid, usePTY=usePTY, childFDs=childFDs)
