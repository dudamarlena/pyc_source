...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/toughbt/auth_master.py
# Compiled at: 2016-03-19 16:39:04
...
import platform, itertools, random, time
...
class BenchmarkMaster:
    ...
    def __init__(self, server, port, secret, requests, concurrency, username, password, verb=False, timeout=30, forknum=1, interval=2, rate=1000):
