...
# [GCC 8.4.0]
# Embedded file name: E:\Remote\chartpy\chartpy\canvas.py
# Compiled at: 2018-02-26 12:45:40
# Size of source mod 2**32: 16620 bytes
...
class Canvas(object):
    ...
    def generate_canvas(self, page_title='chartpy dashboard', jupyter_notebook=False, silent_display=True, output_filename=None, canvas_plotter='plain', render_pdf=False):
        ...
        canvas_plotter.render_canvas(self.elements_to_render, page_title=page_title, jupyter_notebook=jupyter_notebook, silent_display=silent_display, output_filename=output_filename, render_pdf=render_pdf)
...
class CanvasPlotterTemplate(ABC):
    ...
    @abc.abstractmethod
    def render_canvas(self, elements_to_render, jupyter_notebook=False, silent_display=True, output_filename=None, canvas_plotter=None, page_title='chartpy dashboard', render_pdf=False):
        pass
...
class CanvasPlotterPlain(CanvasPlotterTemplate):
    ...
    def render_canvas(self, elements_to_render, jupyter_notebook=False, silent_display=True, output_filename=None, page_title='chartpy dashboard', render_pdf=False):
        html = []
