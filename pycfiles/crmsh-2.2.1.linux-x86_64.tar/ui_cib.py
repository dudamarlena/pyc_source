...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/crmsh/ui_cib.py
...
class CibShadow(command.UI):
    ...
    @command.skill_level('administrator')
    @command.completers(compl.join(compl.shadows, compl.choice(['live'])), compl.choice(['withstatus']))
