...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/crmsh/ui_assist.py
...
class Assist(command.UI):
    ...
    def _template_primitives(self, context, primitives):
        ...
        if all('template' in obj.node.attrib for obj in primitives):
            ...
            shared_template = cib_factory.create_object('rsc_template', template_name, xmlutil.mk_rsc_type(node))
