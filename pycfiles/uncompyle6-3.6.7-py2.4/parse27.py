...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uncompyle6/parsers/parse27.py
# Compiled at: 2020-04-27 23:06:35
from spark_parser import DEFAULT_DEBUG as PARSER_DEFAULT_DEBUG
from xdis import next_offset
from uncompyle6.parser import PythonParserSingle, nop_func
from uncompyle6.parsers.parse2 import Python2Parser
from uncompyle6.parsers.reducecheck import or_check, ifelsestmt, tryelsestmt
...
class Python27Parser(Python2Parser):
    ...
    def customize_grammar_rules(self, tokens, customize):
        ...
        self.reduce_check_table = {'or': or_check, 'tryelsestmt': tryelsestmt, 'tryelsestmtl': tryelsestmt}
    ...
    def reduce_is_invalid(self, rule, ast, tokens, first, last):
        ...
        if rule == ('comp_if', ('expr', 'jmp_false', 'comp_iter')):
         ...
         rule[0], rule[1][0:5]) == ('if_exp', ('expr', 'jmp_false', 'expr', 'JUMP_ABSOLUTE', 'expr')):
            jmp_false = ast[1]
            if jmp_false[0] == 'POP_JUMP_IF_FALSE':
            ...
            if rule == ('iflaststmtl', ('testexpr', 'c_stmts')):
                testexpr = ast[0]
            ...
            if rule == ('list_if_not', ('expr', 'jmp_true', 'list_iter')):
                jump_inst = ast[1][0]
            ...
            elif rule[0] == 'whilestmt' and rule[1][0:-2] == ('SETUP_LOOP', 'testexpr',
