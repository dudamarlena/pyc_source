...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/uncompyle6/semantics/customize.py
    ...
    if version >= 3.0:
        ...
        if version >= 2.5:
            ...
            NAME_MODULE = SyntaxTree('stmt', [
             SyntaxTree('assign', [
              SyntaxTree('expr', [
               Token('LOAD_GLOBAL', pattr='__name__', offset=0, has_arg=True)]),
              SyntaxTree('store', [
