...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/wsgid/config.py
# Compiled at: 2009-03-01 09:11:39
"""
sensible config
~~~~~~~~~~~~~~~
...
class Option(object):
    ...
    def __init__(self, name, help, default, short_name=None, converter=unicode, **optparse_kw):
        self.name = name
...
class Config(object):
    ...
    def add_option(self, opt):
        ...
        self._parser.add_option(opt.short_opt, opt.long_opt, help=opt.help, **opt.optparse_kw)
