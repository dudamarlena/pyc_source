...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/duashttp/models.py
# Compiled at: 2015-06-05 09:27:14
import six, hashlib
...
class AssetContent(models.Model):
    ...
    version = models.ForeignKey('duashttp.AssetVersion', related_name='asset_content_version_set', db_column='assetversion', primary_key=True)
...
class AssetVersion(models.Model):
    ...
    parent = models.ForeignKey('duashttp.Asset', blank=True, null=True, db_column='parent', related_name='asset_version_parent_set')
...
class ChangeSetContent(models.Model):
    changeset = models.ForeignKey('duashttp.ChangeSet', db_column='changeset', related_name='change_set_content_set', primary_key=True)
    asset_version = models.ForeignKey('duashttp.AssetVersion', db_column='assetversion', unique=True)
...
class PersonRole(models.Model):
    person = models.ForeignKey('duashttp.Person', primary_key=True, db_column='person')
    role = models.ForeignKey('duashttp.Role', db_column='role', related_name='person_role_set')
...
class PGLargeObject(models.Model):
    ...
    stream = models.ForeignKey('duashttp.Stream', db_column='loid', related_name='lo_stream_set', primary_key=True)
...
class Variant(models.Model):
    ...
    description = models.TextField(blank=True)
    base_variant = models.ForeignKey('self', db_column='base_variant', blank=True, null=True)
...
class VariantContent(models.Model):
    variant = models.ForeignKey('duashttp.Variant', db_column='variant', primary_key=True)
...
class VariantInheritance(models.Model):
    child = models.ForeignKey('duashttp.Variant', db_column='child', related_name='inheritance_child_set')
    parent = models.ForeignKey('duashttp.Variant', db_column='parent', related_name='inheritance_parent_set')
