...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wymypy/libs/mpdclient.py
# Compiled at: 2013-12-02 17:16:18
"""
...
class MpdConnection(object):
    ...
    def getNextInfoEntity(self):
        ...
        if self.returnElement.name == 'file':
            ...
            if self.returnElement.name == 'directory':
