...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\extasy\parser.py
# Compiled at: 2010-11-20 06:10:24
import story_parser, re
...
story_parser.RegexInternationalized._all_regexes['en-us']['scenario_regex'] = 'Scenario(?: (\\d+))?: (.+)'
...
story_parser.RegexInternationalized._all_regexes['pt-br']['scenario_regex'] = 'Cenário(?: (\\d+))?: (.+)'
