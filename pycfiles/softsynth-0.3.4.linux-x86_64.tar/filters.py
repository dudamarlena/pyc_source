...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/synth/filters.py
...
class Filter(object):
    ...
    def get_amplitude(self, output_options, t):
        ...
        value_out = self.amp_in * value_in + self.amp_in_delay1 * self.delay1 + self.amp_in_delay2 * self.delay2 - self.amp_out_feedback1 * self.feedback1 - self.amp_out_feedback2 * self.feedback2
