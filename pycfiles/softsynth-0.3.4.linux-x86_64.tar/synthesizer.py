...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/synth/synthesizer.py
...
class InstrumentBank(object):
    ...
    def get_instrument(self, midi_nr, envelope):
        ...
        rel = 100
        sus = 0.5
        instrument = OvertoneInstrument(self.options, envelope, overtones=1, attack=att, decay=dec, release=rel, sustain=sus)
        return instrument
