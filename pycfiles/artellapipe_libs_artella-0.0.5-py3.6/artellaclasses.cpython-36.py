...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/libs/artella/core/artellaclasses.py
# Compiled at: 2020-03-08 12:29:02
# Size of source mod 2**32: 13887 bytes
"""
...
class ArtellaAssetMetaData(object):
    ...
    def __init__(self, metadata_path, status_dict):
        ...
        self._ArtellaAssetMetaData__latest = status_dict['data']['_latest']
    ...
    @property
    def _latest(self):
        return self._ArtellaAssetMetaData__latest
...
class ArtellaDirectoryMetaData(object):
    ...
    def __init__(self, metadata_path, status_dict):
        ...
        for ref_name, ref_data in status_dict['data'].items():
            self._references[ref_name] = ArtellaReferencesMetaData(ref_name=ref_name,
