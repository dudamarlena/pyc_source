...
# [GCC 8.4.0]
# Embedded file name: c:\test_environments\vpl_testing\py_3_6_0\Lib\site-packages\vtkplotlib\data\icons\icon_cropping.py
# Compiled at: 2019-08-04 16:53:45
...
"""
import numpy as np, matplotlib.pylab as plt, sys, os
...
for name in names:
    ...
    cropped_arr[front - back + -size:cropped_arr.shape[0] - front + back + size, right - left + -size:cropped_arr.shape[1] - right + left + size] = arr[back:front, left:right]
