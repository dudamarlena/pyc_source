...
# [GCC 8.4.0]
# Embedded file name: /src/mortoray.com/master/src/shelljob/python3/shelljob/proc.py
# Compiled at: 2020-04-20 15:22:26
# Size of source mod 2**32: 7876 bytes
"""
...
class Group:
    ...
    def _run_impl(self, cmd, shell):
        cmd = _expand_cmd(cmd)
        handle = subprocess.Popen(cmd, shell=shell,
          bufsize=1,
