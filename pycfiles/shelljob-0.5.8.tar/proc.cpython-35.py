...
# [GCC 8.4.0]
# Embedded file name: /home/src/mortoray.com/master/src/shelljob/python3/shelljob/proc.py
# Compiled at: 2017-05-12 23:37:37
...
def call(cmd, encoding='utf-8', shell=False, check_exit_code=True, timeout=None, cwd=None):
    """
        ...
        """
    cmd = _expand_cmd(cmd)
    proc = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, stdin=subprocess.PIPE, shell=shell, cwd=cwd)
