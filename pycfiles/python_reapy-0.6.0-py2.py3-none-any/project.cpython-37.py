...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\project\project.py
# Compiled at: 2020-04-18 10:53:37
# Size of source mod 2**32: 34518 bytes
"""Defines class Project."""
import pickle, codecs, reapy
from reapy import reascript_api as RPR
from reapy.core import ReapyObject
from reapy.errors import RedoError, UndoError

class Project(ReapyObject):
    __doc__ = 'REAPER project.'
    ...
    def __init__(self, id=None, index=-1):
        ...
        if isinstance(id, int):
            ...
            id = id.startswith('(ReaProject*)0x') or Project._from_name(id).id
        self.id = id
    ...
    def add_marker(self, position, name='', color=0):
        ...
        if isinstance(color, tuple):
            color = reapy.rgb_to_native(color) | 16777216
    ...
    def focused_fx(self):
        ...
        take = item.takes[(res[3] // 65536)]
        return take.fxs[(res[3] % 65536)]
    ...
    def get_ext_state(self, section, key, pickled=False):
        ...
        """
        value = RPR.GetProjExtState(self.id, section, key, '', 2147483647)[4]
        if value:
            if pickled:
    ...
    def markers(self):
        ...
        """
        ids = [RPR.EnumProjectMarkers2(self.id, i, 0, 0, 0, 0, 0) for i in range(self.n_regions + self.n_markers)]
    ...
    def selected_items(self):
        ...
        """
        return [reapy.Item(RPR.GetSelectedMediaItem(self.id, i)) for i in range(self.n_selected_items)]
    ...
    def selected_tracks(self):
        ...
        :type: list of Track
        """
        return [reapy.Track(RPR.GetSelectedTrack(self.id, i)) for i in range(self.n_selected_tracks)]
    ...
    def set_ext_state(self, section, key, value, pickled=False):
        ...
        if len(value) > 2147483646:
            message = 'Dumped value length is {:,d}. It must not be over 2**31 - 2.'
...
class _MakeCurrentProject:
    __doc__ = 'Context manager used by Project.make_current_project.'
