...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\project\region.py
...
class Region(ReapyObject):
    ...
    def _get_enum_index(self):
        ...
        """
        return next((i for i, r in enumerate(reapy.Project(self.project_id).regions) if r.index == region.index))
    ...
    def end(self, end):
        ...
        """
        args = (
         self.project_id, self.index, True, self.start, end, '')
    ...
    def rendered_tracks(self):
        ...
        while i == 0 or tracks[(-1)]._is_defined:
            track_id = RPR.EnumRegionRenderMatrix(self.project_id, self.index, i)
    ...
    def start(self):
        ...
        """
        args = (
         self.project_id, self._get_enum_index(), 0, 0, 0, 0, 0)
