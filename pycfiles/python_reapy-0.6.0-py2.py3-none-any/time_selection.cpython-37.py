...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\project\time_selection.py
...
class TimeSelection(ReapyObject):
    ...
    def _set_start_end(self, start=None, end=None):
        infos = list(RPR.GetSet_LoopTimeRange2(self.project_id, False, False, 0, 0, False))
        if start is None:
            start = infos[3]
        if end is None:
            end = infos[4]
