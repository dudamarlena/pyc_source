...
# [GCC 8.4.0]
# Embedded file name: /media/despres/MAIN/Users/despres/Desktop/reaper/scripts/reapy/reapy/core/reaper/reaper.py
# Compiled at: 2019-03-04 12:16:24
# Size of source mod 2**32: 12714 bytes
...
").
    """
    file = io.StringIO()
    _ORIGINAL_PRINT(*args, file=file)
    file.seek(0)
    txt = file.read()
