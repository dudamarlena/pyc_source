...
# [GCC 8.4.0]
# Embedded file name: /media/despres/MAIN/Users/despres/Desktop/reaper/scripts/reapy/reapy/core/reaper/defer.py
# Compiled at: 2019-03-01 15:20:34
# Size of source mod 2**32: 4244 bytes
"""Define reapy.defer and reapy.at_exit."""
import reapy, os, sys, tempfile

class Deferrer:
    __doc__ = 'Class to register and run deferred calls.'
    _next_call_id = 0
    _callbacks = {}
    _args = {}
    _kwargs = {}
    ...
    def defer(self, callback, args, kwargs, at_exit=False):
        ...
        code = 'import sys; sys.modules[{}].Deferrer().run({})'.format(repr(__name__), call_id)
...
class ReaperConsole:
    __doc__ = 'File-like wrapper around the Reaper Console.'
