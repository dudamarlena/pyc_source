...
# [GCC 8.4.0]
# Embedded file name: /media/despres/MAIN/Users/despres/Desktop/reaper/scripts/reapy/reapy/core/fx/fx.py
# Compiled at: 2019-03-03 06:00:00
# Size of source mod 2**32: 10839 bytes
...
class FX(ReapyObject):
    __doc__ = 'FX on a Track or a Take.'
    _class_name = 'FX'
    ...
    def _get_functions(self):
        if isinstance(self.parent, reapy.Track):
            ...
            prefix = 'TakeFX_'
        functions = {name.replace(prefix, ''):function for name, function in RPR.__dict__.items() if name.startswith(prefix)}
        return functions
    ...
    def copy_to_take(self, take, index=0):
        ...
        FX.move_to_take
        """
        self.functions['CopyToTake'](self.parent_id, self.index, take.id, index, False)
    ...
    def copy_to_track(self, track, index=0):
        ...
        FX.move_to_track
        """
        self.functions['CopyToTrack'](self.parent_id, self.index, track.id, index, False)
    ...
    def is_enabled(self):
        ...
        :type: bool
        """
        is_enabled = bool(self.functions['GetEnabled'](self.parent_id, self.index))
        return is_enabled
    ...
    def is_online(self):
        ...
        :type: bool
        """
        is_online = not bool(self.functions['GetOffline'](self.parent_id, self.index))
        return is_online
    ...
    def is_ui_open(self):
        ...
        :type: bool
        """
        is_ui_open = bool(self.functions['GetOpen'](self.parent_id, self.index))
        return is_ui_open
    ...
    def move_to_take(self, take, index=0):
        ...
        FX.copy_to_take
        """
        self.functions['CopyToTake'](self.parent_id, self.index, take.id, index, True)
    ...
    def move_to_track(self, track, index=0):
        ...
        FX.copy_to_track
        """
        self.functions['CopyToTrack'](self.parent_id, self.index, track.id, index, True)
    ...
    def n_presets(self):
        ...
        :type: int
        """
        n_presets = self.functions['GetPresetIndex'](self.parent_id, self.index, 0)[(-1)]
        return n_presets
    ...
    def name(self):
        ...
        :type: str
        """
        name = self.functions['GetFXName'](self.parent_id, self.index, '', 2048)[3]
        return name
    ...
    def preset(self):
        ...
        :type: str
        """
        preset = self.functions['GetPreset'](self.parent_id, self.index, '', 2048)[3]
        return preset
    ...
    def preset(self, preset):
        ...
        if isinstance(preset, str):
            ...
            self.functions['SetPresetByIndex'](self.parent_id, self.index, preset)
    ...
    def preset_index(self):
        ...
        :type: int
        """
        index = self.functions['GetPresetIndex'](self.parent_id, self.index, 0)[0]
        return index
    ...
    def preset_file(self):
        ...
        :type: str
        """
        file = self.functions['GetUserPresetFilename'](self.parent_id, self.index, '', 2048)[2]
        return file
    ...
    def window(self):
        ...
        """
        window = reapy.Window(self.functions['GetFloatingWindow'](self.parent.id, self.index))
