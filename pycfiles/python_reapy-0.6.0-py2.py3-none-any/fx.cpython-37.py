...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\fx\fx.py
# Compiled at: 2020-03-18 12:09:09
# Size of source mod 2**32: 11266 bytes
...
class FX(ReapyObject):
    ...
    _class_name = 'FX'
    functions = {prefix:{name.replace(prefix, ''):function for name, function in RPR.__dict__.items() if name.startswith(prefix)} for prefix in ('TrackFX_',
                                                                                                                                                 'TakeFX_')}
