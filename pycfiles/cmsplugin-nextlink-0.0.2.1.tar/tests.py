...
# Embedded file name: /Users/bfschott/Source/cmsplugin-newsplus/cmsplugin_newsplus/tests.py
...
class NewsTest(TestCase):
    ...
    def test_unpublished(self):
        ...
        """
        unpublished = News.objects.create(title='Unpublished News', slug='unpublished-news', is_published=False, pub_date=self.yesterday)
    ...
    def test_future_published(self):
        ...
        """
        future_published = News.objects.create(title='Future published News', slug='future-published-news', is_published=True, pub_date=self.tomorrow)
        self.assertEquals(News.published.count(), 0)
    ...
    def test_link_as_url_without_content(self):
        ...
        item = News.objects.create(title='Future published News', slug='future-published-news', is_published=True, pub_date=self.tomorrow, link='http://lala.com/')
    ...
    def test_link_as_url_with_content(self):
        ...
        settings.USE_LINK_ON_EMPTY_CONTENT_ONLY = True
        settings.LINK_AS_ABSOLUTE_URL = True
        item = News.objects.create(title='Future published News', slug='future-published-news', content='test', is_published=True, pub_date=self.tomorrow, link='http://lala.com/')
