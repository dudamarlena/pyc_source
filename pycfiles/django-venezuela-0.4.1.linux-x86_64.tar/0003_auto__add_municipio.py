...
# [GCC 8.4.0]
# Embedded file name: /home/proyectos/django_venezuela/venezuela/migrations/0003_auto__add_municipio.py
# Compiled at: 2014-01-23 10:09:07
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('venezuela_municipio', (
         (
        ...
        db.send_create_signal('venezuela', ['Municipio'])

    def backwards(self, orm):
        db.delete_table('venezuela_municipio')
