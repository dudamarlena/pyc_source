...
# [GCC 8.4.0]
# Embedded file name: /home/proyectos/django_venezuela/venezuela/migrations/0005_auto__add_field_estado_iso_3166_2.py
# Compiled at: 2014-01-23 10:48:03
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('venezuela_estado', 'iso_3166_2', self.gf('django.db.models.fields.CharField')(default='', max_length=5), keep_default=False)

    def backwards(self, orm):
        db.delete_column('venezuela_estado', 'iso_3166_2')
