...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/italianskin/templates/browser/plone/app/content/browser/foldercontents.py
...
class FolderContentsTable(OldFolderContentsTable):
    ...
    def __init__(self, context, request, contentFilter={}):
        ...
        self.table = Table(request, url, view_url, self.items, show_sort_column=self.show_sort_column, buttons=self.buttons)
