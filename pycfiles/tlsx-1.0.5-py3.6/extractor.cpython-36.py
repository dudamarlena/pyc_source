...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tlsx/extractor.py
# Compiled at: 2018-05-08 14:55:34
# Size of source mod 2**32: 4417 bytes
from collections import OrderedDict
import json as _json, pandas as pd, click
VERSIONS = {'TLS 1.0':' tls10Requests', 
...
class TlsExtractorException(Exception):
    __doc__ = 'TLSX base exception class'
