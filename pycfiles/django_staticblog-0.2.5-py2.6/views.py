...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/staticblog-bak/views.py
...
import os, sys, urllib2, hashlib, markdown
from markdown.inlinepatterns import ImagePattern, IMAGE_LINK_RE
from staticblog.app_settings import STATICBLOG_COMPILE_DIRECTORY, STATICBLOG_POST_DIRECTORY, STATICBLOG_STORAGE
...
class S3ImagePattern(ImagePattern):
    ...
    def handleMatch(self, match):
        ...
        try:
            ...
            print >> sys.stderr, '\x1b[01;31mUpload of %s failed\x1b[0m' % src
...
def render_post(request, post_name):
    ...
    return render_response(request, 'staticblog/post.html', {'post': post, 'meta': meta})
...
def archive(request):
    ...
    posts.reverse()
    return render_response(request, 'staticblog/archive.html', {'posts': posts})
