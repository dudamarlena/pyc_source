...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/staticblog-bak/management/commands/update_blog.py
...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
     make_option('--all', action='store_true', dest='all', default=False, help='Get all blog posts, regardless of date'),
     make_option('--name', action='store', dest='post_name', default=False, help='Get named blog post'))
