...
# [GCC 8.4.0]
# Embedded file name: /Users/mardochee.macxis/Projects/Python/portfoliopy/portfolio/cmd.py
# Compiled at: 2015-06-16 00:07:46
"""
Portfolio

Command line tool

portfolio -c project_name

"""
import os, argparse, pkg_resources, portfolio
PACKAGE = portfolio
CWD = os.getcwd()
...
def create_project(project_name, template='default'):
    ...
    files = [('%s/__init__.py' % APPLICATION_DIR, init_py_tpl),
     (
...
def main():
    ...
    parser.add_argument('-c', '--create', help='To create a new project. [ie: portfolio -c www]')
    parser.add_argument('-t', '--template', help='A default template to use', default='default')
    arg = parser.parse_args()
    print _description
    if arg.create:
        project_name = arg.create
        template = arg.template or 'default'
