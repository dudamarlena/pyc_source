...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.211.py
# Compiled at: 2019-02-26 15:22:18
...
def parse_args():
    ...
    parser.add_argument('--sequenceSize', type=int, default=0, help='Minimum size of a sequence (that is not an entire test) from the tests in the' + 'directory for --sequencesFromTests (default 3).')
