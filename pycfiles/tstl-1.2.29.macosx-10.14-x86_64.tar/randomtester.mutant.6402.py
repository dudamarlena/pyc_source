...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.6402.py
# Compiled at: 2019-02-26 15:26:04
            ...
            for test1 in failures:
                ...
                for test2 in failures:
                    ...
                    if j > i:
                        ...
                        for k in range(0, max(len(test - 1), len(test2))):
                            if k >= len(test1):
