...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/standalone.py
...
def main():
    ...
    for line in open(sutFile):
        ...
        if startPrelim:
            outf.write(line)
        if startCheck:
            outf.write(globalCheck(t.prettyName(line.replace('# GLOBAL ', 'global '))))
        if startReload:
