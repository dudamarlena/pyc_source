...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.334.py
# Compiled at: 2019-02-26 15:22:40
...
def parse_args():
    ...
    parsed_args = parser.parse_args(sys.argv[0:])
    return (
     parsed_args, parser)
