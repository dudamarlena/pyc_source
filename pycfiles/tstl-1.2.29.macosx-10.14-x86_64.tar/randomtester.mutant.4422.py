...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.4422.py
# Compiled at: 2019-02-26 15:25:00
        ...
        while config.maxTests == -1 or ntests < config.maxTests:
            ...
            if config.stopSaturated and ntests > 1:
                ...
                if ntests > config.sessions + 1:
                    if not sessionCountsS != lastSessionCountsS:
