...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/calibrate.py
# Compiled at: 2019-02-11 12:34:52
from __future__ import print_function
import sys, time, argparse, os, subprocess, random
...
def main():
    ...
    subprocess.call([
     'tstl_rt --timeout 180 --generateLOC .tstl_calibration_loc --noCover'], shell=True, stdout=fnull, stderr=fnull)
    classLOCVals = {}
