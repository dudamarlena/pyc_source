...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.84.py
...
def parse_args():
    ...
    parser.add_argument('-M', help='Allow multiple failures.')
