...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.3394.py
# Compiled at: 2019-02-26 15:24:27
        ...
        while config.maxTests == -1 or ntests < config.maxTests:
            ...
            for step in range(0, config.depth):
                ...
                if currentSequence is not None and R.random() < config.sequenceP:
                    ...
                    if config.highLowSwarm is None and config.probs is None and not config.LOCProbs and not config.equalProbs or not config.profileProbs:
