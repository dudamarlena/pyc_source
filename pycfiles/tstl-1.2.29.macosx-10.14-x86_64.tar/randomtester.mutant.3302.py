...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.3302.py
# Compiled at: 2019-02-26 15:24:22
    ...
    if config.swarmProbs is not None:
        ...
        while config.maxTests == -1 or ntests < config.maxTests:
            ...
            for step in range(0, config.depth):
                ...
                tTrue and (config.stutter is not None or config.greedyStutter)
