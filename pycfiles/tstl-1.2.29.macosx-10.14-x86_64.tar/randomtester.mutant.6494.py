...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.6494.py
# Compiled at: 2019-02-26 15:26:07
                    ...
                    if j > i:
                        ...
                        for k in range(0, max(len(test1), len(test2))):
                            if k >= len(test1):
                                ...
                                print('STEP', k, test1[k][(-1)], '-->', test2[k][0])
