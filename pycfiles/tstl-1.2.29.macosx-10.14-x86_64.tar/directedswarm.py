...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/directedswarm.py
...
def parse_args():
    ...
    parser.add_argument('target', metavar='str', type=str, default=None, help='Coverage target.')
    parser.add_argument('probFile', metavar='filename', type=str, default=None, help='File for output probabilities.')
    parser.add_argument('--mode', type=str, default='halfswarm', help='Mode: halfswarm/no-suppressors/triggersonly (default halfswarm).')
