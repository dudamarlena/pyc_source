...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/fpf.py
...
def parse_args():
    ...
    parser.add_argument('--ignoreLast', action='store_true', help='Do not use last action in computing ranking.')
    parser.add_argument('--useFailures', action='store_true', help='Use the failure output to help distinguish bugs.')
