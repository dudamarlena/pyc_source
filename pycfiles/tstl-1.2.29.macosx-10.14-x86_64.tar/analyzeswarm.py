...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/analyzeswarm.py
...
def parse_args():
    ...
    parser.add_argument('swarmData', metavar='filename', type=str, default=None, help='Swarm coverage data to use.')
    parser.add_argument('prefix', metavar='filename', type=str, default=None, help='Prefix for output files.')
    parser.add_argument('--confidence', type=float, default=0.95, help='Confidence level to use (default 0.95 = 95%).')
    parser.add_argument('--cutoff', type=float, default=1.0, help='Frequency at which to start ignoring targets (default = 1.0).')
    parser.add_argument('--minHits', type=int, default=0, help='Minimum number of hits before analyzing a target (default = 0).')
...
def main():
    ...
    for target in targets:
        ...
        signature = (
         tuple(sorted(triggers)), tuple(sorted(suppressors)))
