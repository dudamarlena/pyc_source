...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.1074.py
# Compiled at: 2019-02-26 15:23:05
...
def handle_failure(test, msg, checkFail, newCov=False, becauseBranchCov=False, becauseStatementCov=False):
    ...
    if not failProp(test):
        ...
        if config.failedLogging is None:
