...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.240.py
# Compiled at: 2019-02-26 15:22:20
...
def parse_args():
    ...
    parser.add_argument('--startExploitStall', type=int, default=1, help='Number of no-new-coverage tests at which exploitation starts (default 0,' + 'LOWER BOUND: this plus startExploit must hold).')
