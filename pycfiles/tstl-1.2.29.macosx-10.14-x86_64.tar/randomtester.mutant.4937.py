...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.4937.py
# Compiled at: 2019-02-26 15:25:18
            ...
            if config.quickAnalysis:
                ...
                for b in currB:
                    ...
                    r = sut.reduce(currTest, sut.coversBranches([
                     b]), keepLast=False, pruneGuards=not config.noPruneGuards)
