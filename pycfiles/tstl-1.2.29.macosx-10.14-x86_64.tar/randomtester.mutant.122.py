...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.122.py
# Compiled at: 2019-02-26 15:22:06
...
def parse_args():
    ...
    parser.add_argument('--localizeTop', type=int, help='Show top n localization results (default=20).')
