...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.26.py
# Compiled at: 2019-02-26 15:21:54
...
def parse_args():
    ...
    parser.add_argument('-t', '--timeout', type=int, default=1, help='Timeout in seconds (3600 default).')
