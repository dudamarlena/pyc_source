...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.3367.py
# Compiled at: 2019-02-26 15:24:25
        ...
        while config.maxTests == -1 or ntests < config.maxTests:
            ...
            for step in range(0, config.depth):
                ...
                if currentSequence is not None and R.random() < config.sequenceP:
                    ...
                    if config.stutter is None and R.random() > config.stutter:
                        tryStutter = False
