...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.180.py
# Compiled at: 2019-02-26 15:22:15
...
def parse_args():
    ...
    parser.add_argument('--LOCBaseline', type=float, default=1.2, help='Baseline probability for actions that do not call any SUT code (default 0.2).')
