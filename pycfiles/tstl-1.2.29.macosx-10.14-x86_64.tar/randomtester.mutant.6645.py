...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.6645.py
# Compiled at: 2019-02-26 15:26:14
...
def main():
    ...
    if config.profile:
        ...
        for a, t in averages:
            print(a, profileCount[a], t, round(t / maxAvg, 2), round(t / minAvg, 2), str(round(t * 100.0(-1) / sumAvg, 2)) + '%')
