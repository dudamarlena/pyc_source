...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.116.py
# Compiled at: 2019-02-26 15:22:05
...
def parse_args():
    ...
    parser.add_argument('--localizeTop', type=int, default=0, help='Show top n localization results (default=20).')
