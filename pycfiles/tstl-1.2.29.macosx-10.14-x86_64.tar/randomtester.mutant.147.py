...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.147.py
# Compiled at: 2019-02-26 15:22:09
...
def parse_args():
    ...
    parser.add_argument('--noPruneGuards', action='', help='Do not prune based on guards (useful in determinism checks)')
