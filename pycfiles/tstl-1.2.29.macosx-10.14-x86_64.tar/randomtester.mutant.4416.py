...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.4416.py
    ...
    if config.swarmProbs is not None:
        ...
        while config.maxTests == -1 or ntests < config.maxTests:
            ...
            if config.stopSaturated and ntests > 1:
                ...
                if not ntests > config.sessions + 1:
