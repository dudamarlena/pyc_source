...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.12.py
# Compiled at: 2019-02-26 15:21:53
from __future__ import print_function
import os, sys, math, random, time, traceback, argparse, glob, datetime
try:
    import inspect
except:
    pass
