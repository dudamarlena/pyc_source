...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/exhaust.py
...
def main():
    ...
    while count < totalPaths:
        ...
        while len(path) < depth:
            ...
            possible = sorted(possible, key=lambda act: (
