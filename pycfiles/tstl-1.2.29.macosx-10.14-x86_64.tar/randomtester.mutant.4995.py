...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/tstl/randomtester.mutant.4995.py
# Compiled at: 2019-02-26 15:25:20
            ...
            if config.quickAnalysis:
                ...
                for b in currB:
                    ...
                    for b2 in sut.currBranches():
                        if b0 not in quickAnalysisReducedB:
