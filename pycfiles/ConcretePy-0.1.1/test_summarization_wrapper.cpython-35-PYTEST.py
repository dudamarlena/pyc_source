...
# Embedded file name: /Users/charman/src/concrete-python/tests/test_summarization_wrapper.py
# Compiled at: 2017-07-27 16:16:16
...
from concrete.util import SummarizationServiceWrapper, SummarizationClientWrapper
...
def summarization_client_wrapper_triple():
    ...
    port = 2
    return (
     host, port, SummarizationClientWrapper(host, port))
...
def test_enter(mock_create_socket, mock_create_transport, mock_create_protocol, mock_client, summarization_client_wrapper_triple):
...
def test_serve(mock_create_server, summarization_service_wrapper):
    ...
    mock_create_server.assert_called_once_with(summarization_service_wrapper.processor, host, port)
