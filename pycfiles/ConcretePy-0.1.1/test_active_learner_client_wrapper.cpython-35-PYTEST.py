...
# Embedded file name: /Users/charman/src/concrete-python/tests/test_active_learner_client_wrapper.py
...
from concrete.util import ActiveLearnerClientServiceWrapper, ActiveLearnerClientClientWrapper
...
def learner_client_client_wrapper_triple():
    ...
    port = 2
    return (
     host, port, ActiveLearnerClientClientWrapper(host, port))
...
def test_enter(mock_create_socket, mock_create_transport, mock_create_protocol, mock_client, learner_client_client_wrapper_triple):
    host, port, learner_client_client_wrapper = learner_client_client_wrapper_triple
...
def test_serve(mock_create_server, learner_client_service_wrapper):
    ...
    mock_create_server.assert_called_once_with(learner_client_service_wrapper.processor, host, port)
