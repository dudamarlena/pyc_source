...
# [GCC 8.4.0]
# Embedded file name: C:\repositorios\web\djmicrosip_apps\django-microsip-api\microsip_api\models_base\ventas\documentos.py
# Compiled at: 2020-04-28 20:17:54
...
class VentasDocumentoDetalleBase(models.Model):
    ...
    def __unicode__(self):
        return '%s(%s)' % (self.id, self.documento)
