...
# [GCC 8.4.0]
# Embedded file name: /home/kat/.anaconda/envs/yaml_py2/lib/python2.7/site-packages/quickargs/tests.py
...
def test_multiple_strings_two_overwrite():
    yaml_params = {'key1': 'yaml_value_key1', 'key2': 'yaml_value_key2', 'key3': 'yaml_value_key3'}
    command_line_params = [
     '--key2=cmd_value_key2', '--key3=cmd_value_key3']
...
def test_multiple_strings_all_overwrite():
    yaml_params = {'key1': 'yaml_value_key1', 'key2': 'yaml_value_key2', 'key3': 'yaml_value_key3'}
    command_line_params = [
     '--key1=cmd_value_key1', '--key2=cmd_value_key2', '--key3=cmd_value_key3']
...
def test_nested_overwrite_deep():
    yaml_params = {'key1': {'key1_1': {'key1_1_1': 'yaml_value_key1_1_1', 'key1_1_2': 'yaml_value_key1_1_2'}, 
    ...
    expected = {'key1': {'key1_1': {'key1_1_1': 'yaml_value_key1_1_1', 'key1_1_2': 'cmd_value_key1_1_2'}, 
                'key1_2': 'yaml_value_key1_2'}, 
       'key2': 'cmd_value_key2'}
    actual = create_yaml_and_parse_arguments(yaml_params, command_line_params)
    assert_dict_equal(expected, actual)
...
def test_complex():
    yaml_params = {'key1': complex(37.0, -880.0)}
    command_line_params = [
     '--key1=44-880j']
    expected = {'key1': complex(44.0, -880.0)}
    actual = create_yaml_and_parse_arguments(yaml_params, command_line_params)
    assert_dict_equal(expected, actual)
...
def test_with_supplied_arguments():
    ...
    command_line_params = [
     '--key1=cmd_value_key1', '--key2.key2_2=7']
...
def test_flatten_dict_nested():
    dict_to_flatten = {'key1': {'key1_1': 'val11', 'key1_2': {'key1_2_1': 'val121'}}, 'key2': 'val2'}
    expected = {('key1', 'key1_1'): 'val11', ('key1', 'key1_2', 'key1_2_1'): 'val121', 
       ('key2', ): 'val2'}
    actual = flatten_dict(dict_to_flatten)
    assert_dict_equal(expected, actual)
...
def test_unflatten_dict_nested():
    dict_to_unflatten = {('key1', 'key1_1'): 'val11', ('key1', 'key1_2', 'key1_2_1'): 'val121', 
       ('key2', ): 'val2'}
    expected = {'key1': {'key1_1': 'val11', 'key1_2': {'key1_2_1': 'val121'}}, 'key2': 'val2'}
    actual = unflatten_dict(dict_to_unflatten)
    assert_dict_equal(expected, actual)
...
def test_all_types():
    ...
    command_line_params = '--an_int=4 --a_float=2.0 --a_bool=False --a_complex_number=42-111j --a_date=2017-01-01 --sequences.a_list=[c,b,c] --sequences.a_tuple=[b,a] --python.a_function=enumerate --python.a_class=yaml.parser.Parser --python.a_module=yaml --python.a_none=1234'
    command_line_params = command_line_params.split()
    expected = {'a_bool': False, 'a_complex_number': '42-111j', 
       'a_date': datetime.strptime('2017-01-01', '%Y-%m-%d').date(), 
       'a_float': 2.0, 
       'an_int': 4, 
       'python': {'a_class': yaml.parser.Parser, 'a_function': enumerate, 
                  'a_module': yaml, 
                  'a_none': None}, 
