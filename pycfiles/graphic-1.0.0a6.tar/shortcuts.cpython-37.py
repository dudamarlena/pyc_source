...
def relationship(node_from, node_to, type=None, with_direction=True, **properties) -> Relationship:
    """
 ...
 node_from,
 node_to, type=type, 
     with_direction=with_direction, **properties)
...
def link(node_from, node_to, type=None, **properties) -> Relationship:
 ...
 node_from,
 node_to, type=type, 
     with_direction=False, **properties)
