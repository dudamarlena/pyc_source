...
# [GCC 8.4.0]
# Embedded file name: e:\kanzhun\projects\graph\graphic\src\graphic\query\query_utils.py
# Compiled at: 2018-11-04 23:19:30
...
class Field:
    ...
    def __str__(self):
        ...
        return '{}.{}'.format(self._ent.alias, self._field_name)
...
class Q:
    ...
    def __eq__(self, other):
        ...
        return (
         ...
         self.negated) == (
         other.connector,
         other.negated) and self.children == other.children
