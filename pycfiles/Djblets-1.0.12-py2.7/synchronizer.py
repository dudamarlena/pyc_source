...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/cache/synchronizer.py
...
class GenerationSynchronizer(object):
    ...
    def is_expired(self):
        ...
        return sync_gen is None or type(sync_gen) is int and sync_gen != self.sync_gen
