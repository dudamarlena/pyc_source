...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/webapi/tests/test_registry.py
...
from djblets.webapi.resources.registry import get_resource_for_object, register_resource_for_model, unregister_resource_for_model
...
class ResourceRegistryTests(TestCase):
    ...
    def test_get_resource_for_object_only_fields(self):
        ...
        with register_resource_for_model_temp(Site, resource):
            config = Site.objects.only(b'domain').get()
