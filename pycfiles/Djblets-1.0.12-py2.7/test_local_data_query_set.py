...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/db/tests/test_local_data_query_set.py
...
class LocalDataQuerySetTests(TestCase):
    ...
    def test_order_by(self):
        ...
        obj1 = TestObjectsForOrder(2, b'first', b'string', 0)
        obj2 = TestObjectsForOrder(1, b'second', b'string', 0)
        obj3 = TestObjectsForOrder(4, b'test', b'string', 3)
        obj4 = TestObjectsForOrder(1, b'first', b'string', 0)
        obj5 = TestObjectsForOrder(2, b'second', b'string', 0)
        obj6 = TestObjectsForOrder(4, b'test', b'string', 0)
        obj7 = TestObjectsForOrder(2, b'third', b'string', 0)
        data = [
         obj1, obj2, obj3, obj4, obj5, obj6, obj7]
        answer = [obj2, obj4, obj7, obj5, obj1, obj3, obj6]
        queryset = LocalDataQuerySet(data).order_by(b'param1', b'-param4', b'-param2')
