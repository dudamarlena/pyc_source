...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/db/fields/base64_field.py
...
try:
    ...
    from base64 import decodestring as base64_decode, encodestring as base64_encode
...
class Base64TypeError(TypeError):
    ...
    def __init__(self, value):
        ...
        """
        super(Base64TypeError, self).__init__(_(b'The provided value must be a string type or a Base64DecodedValue, not %r.') % type(value))
...
class Base64FieldCreator(object):
    ...
    def __set__(self, obj, value):
        ...
        if value is not None:
            ...
            pk_set = pk_val is not None and smart_text(pk_val) != b''
    ...
    def __get__(self, obj, *args, **kwargs):
        ...
        """
        if obj is None:
            raise AttributeError(b'Can only be accessed via an instance.')
...
class Base64Field(models.TextField):
    ...
    * Passing a :py:class:`Base64DecodedValue` byte string will always cause
    ...
    def contribute_to_class(self, cls, name):
        ...
        setattr(cls, b'get_%s_base64' % self.name, lambda model_instance: model_instance.__dict__[self.name])
