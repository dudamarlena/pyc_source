...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/integrations/tests/test_manager.py
...
from djblets.integrations.manager import IntegrationManager, get_integration_managers, shutdown_integration_managers
...
class IntegrationManagerTests(IntegrationsTestCase):
    ...
    def test_init_without_app(self):
        ...
        msg = b'IntegrationManager requires djblets.integrations to be listed in settings.INSTALLED_APPS.'
        installed_apps = list(settings.INSTALLED_APPS)
        installed_apps.remove(b'djblets.integrations')
    ...
    def test_init_without_middleware(self):
        ...
        MIDDLEWARE_CLASSES
        """
        msg = b'IntegrationManager requires djblets.integrations.middleware.IntegrationsMiddleware to be listed in settings.MIDDLEWARE_CLASSES'
        middleware_classes = list(settings.MIDDLEWARE_CLASSES)
        middleware_classes.remove(b'djblets.integrations.middleware.IntegrationsMiddleware')
    ...
    def test_get_integration_with_invalid_id(self):
        ...
        with self.assertRaises(IntegrationNotRegisteredError):
            manager.get_integration(b'foobar')
    ...
    def test_register_integration_class(self):
        ...
        self.assertEqual(integration_id, b'djblets.integrations.tests.test_manager.DummyIntegration1')
