...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/webapi/testing/resources.py
# Compiled at: 2019-06-12 01:17:17
"""Utilities for generating resource trees for testing."""
from collections import namedtuple
from djblets.extensions.resources import ExtensionResource as BaseExtensionResource
...
ResourceTree = namedtuple('ResourceTree', ('base_resource', 'root_resource', 'resources'))

def make_resource_tree(mixins=None, extension_manager=None, allow_anonymous_access=True):
    ...
    base_resource = type('BaseResource', bases, {'has_access_permissions': has_access_permissions})
    resources = []
    ...
    return ResourceTree(base_resource=base_resource, root_resource=RootResource(resources), resources=resources)