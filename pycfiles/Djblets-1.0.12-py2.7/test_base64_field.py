...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/db/tests/test_base64_field.py
# Compiled at: 2019-06-12 01:17:17
"""Unit tests for djblets.db.fields.base64_field."""
from __future__ import unicode_literals
from django.db import models
from djblets.db.fields.base64_field import Base64DecodedValue, Base64Field, Base64TypeError
...
class Base64FieldTests(TestModelsLoaderMixin, TestCase):
    ...
    def test_create_with_decoded_unicode_value(self):
        ...
        Model.objects.create()
        """
        obj = Base64TestModel.objects.create(field=b'This is a tést')
        self.assertIs(type(obj.field), Base64DecodedValue)
        self.assertEqual(obj.field, b'This is a tést')
        encoded = obj.get_field_base64()
        self.assertIs(type(encoded), bytes)
    ...
    def test_create_with_base64_decoded_value(self):
        ...
        Model.objects.create()
        """
        obj = Base64TestModel.objects.create(field=Base64DecodedValue(b'This is a test'))
        self.assertIs(type(obj.field), Base64DecodedValue)
        self.assertEqual(obj.field, b'This is a test')
        encoded = obj.get_field_base64()
        self.assertIs(type(encoded), bytes)
    ...
    def test_saved_obj_with_decoded_unicode_value(self):
        ...
        """
        obj = Base64TestModel.objects.create()
        obj.field = b'VGhpcyBpcyBhIHTDqXN0\n'
        self.assertIs(type(obj.field), Base64DecodedValue)
        self.assertEqual(obj.field, b'This is a tést')
        encoded = obj.get_field_base64()
        self.assertIs(type(encoded), bytes)
    ...
    def test_save_form_data_with_bytes(self):
        ...
        obj._meta.get_field(b'field').save_form_data(obj, b'This is a test')
        self.assertIs(type(obj.field), Base64DecodedValue)
        self.assertEqual(obj.field, b'This is a test')
        encoded = obj.get_field_base64()
        self.assertIs(type(encoded), bytes)
    ...
    def test_save_form_data_with_unicode(self):
        ...
        obj = Base64TestModel(field=b'This is a test')
        obj._meta.get_field(b'field').save_form_data(obj, b'This is a tést')
        self.assertIs(type(obj.field), Base64DecodedValue)
        self.assertEqual(obj.field, b'This is a tést')
        encoded = obj.get_field_base64()
        self.assertIs(type(encoded), bytes)
    ...
    def test_to_python_with_bytes(self):
        ...
        obj = Base64TestModel()
        value = obj._meta.get_field(b'field').to_python(b'VGhpcyBpcyBhIHRlc3Q=\n')
    ...
    def test_to_python_with_base64_decoded_value(self):
        ...
        obj = Base64TestModel()
        value = obj._meta.get_field(b'field').to_python(Base64DecodedValue(b'This is a test'))
        self.assertIs(type(value), Base64DecodedValue)
        self.assertEqual(value, b'This is a test')
    ...
    def test_to_python_with_none(self):
        ...
        obj = Base64TestModel()
        value = obj._meta.get_field(b'field').to_python(None)
    ...
    def test_value_to_string_with_base64_decoded_value(self):
        ...
        obj = Base64TestModel(field=b'This is a test')
        value = obj._meta.get_field(b'field').value_to_string(obj)
