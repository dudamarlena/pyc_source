...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/djblets/features/feature.py
...
class Feature(object):
    ...
    def is_enabled(self, **kwargs):
        ...
        assert checker
        return self.level >= checker.min_enabled_level or checker.is_feature_enabled(self.feature_id, **kwargs)