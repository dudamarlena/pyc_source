...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysvnmanager/hooks/init/hook1.5/scripts/svn2rss.py
# Compiled at: 2010-09-24 12:39:25
import sys, getopt, os, popen2, pickle
...
class SVN2RSS:
    ...
    def make_rss_item(self):
        ...
        rss_item = PyRSS2Gen.RSSItem(title=item_title, link=item_link, description=self.make_rss_item_desc(), guid=PyRSS2Gen.Guid(item_link), pubDate=datetime.datetime.now())
        return rss_item
    ...
    def make_rss(self):
        ...
        if os.path.exists(self.pickle_file):
            ...
            rss = PyRSS2Gen.RSS2(title="Foo's SVN Commits Feed", link='http://www.foo.com/project', description='The latest SVN commits', lastBuildDate=datetime.datetime.now(), items=[
             rss_item])
        return rss
