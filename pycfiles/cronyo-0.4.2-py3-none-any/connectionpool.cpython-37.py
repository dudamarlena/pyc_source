...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/urllib3/urllib3/connectionpool.py
...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
 ...
 httplib_response, pool=self, 
            ...
            conn or log.warning("Retrying (%r) after connection broken by '%r': %s", retries, err, url)
            return (self.urlopen)(
 method,
 url,
 body,
