...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-target-g7omgaxk/lib/python/yaml/error.py
...
class Mark:
    ...
    def get_snippet(self, indent=4, max_length=75):
        ...
        head = ''
        start = self.pointer
        while start > 0 and self.buffer[(start - 1)] not in '\x00\r\n\x85\u2028\u2029':
            start -= 1
        ...
        while end < len(self.buffer) and self.buffer[end] not in '\x00\r\n\x85\u2028\u2029':
            end += 1
...
class MarkedYAMLError(YAMLError):
 ...
 L.  63        36  LOAD_FAST                'self'
               ...
               40  LOAD_CONST               None
               42  COMPARE_OP               is
               44  POP_JUMP_IF_TRUE    104  'to 104'
               46  LOAD_FAST                'self'
 ...
 L.  64        56  LOAD_FAST                'self'
               ...
               66  LOAD_ATTR                name
               68  COMPARE_OP               !=
               70  POP_JUMP_IF_TRUE    104  'to 104'
