...
class Scanner:
 ...
 L. 817       124  LOAD_FAST                'ch'
              ...
              134  CALL_FUNCTION_4       4  '4 positional arguments'
 ...
 L. 824       182  LOAD_FAST                'ch'
              ...
              192  CALL_FUNCTION_4       4  '4 positional arguments'
...
Parse error at or near `POP_BLOCK' instruction at offset 110
 ...
 L. 931       232  LOAD_FAST                'ch'
              ...
              242  CALL_FUNCTION_4       4  '4 positional arguments'
 ...
 L. 933       254  LOAD_FAST                'TokenClass'
              ...
              262  CALL_FUNCTION_3       3  '3 positional arguments'
              264  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `POP_BLOCK' instruction at offset 152
        ...
        while 1:
            ...
            if not double:
                if ch == "'":
                    ...
                    if double and not ch == "'" or double:
                        if ch in '"\\':
                            chunks.append(ch)
                            self.forward()
                    if double:
 ...
 L.1355        26  LOAD_STR                 "expected '!', but found %r"
               ...
               38  CALL_FUNCTION_4       4  '4 positional arguments'
...
Parse error at or near `POP_BLOCK' instruction at offset 160
 ...
 L.1394       222  LOAD_STR                 'expected URI, but found %r'
              ...
              234  CALL_FUNCTION_4       4  '4 positional arguments'
