...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/urllib3/urllib3/packages/six.py
# Compiled at: 2019-11-10 08:27:46
# Size of source mod 2**32: 32536 bytes
...
if sys.platform == 'win32':
    ...
    class Module_six_moves_urllib_parse(_LazyModule):
        __doc__ = 'Lazy loading of moved objects in six.moves.urllib_parse'
    ...
    class Module_six_moves_urllib_error(_LazyModule):
        __doc__ = 'Lazy loading of moved objects in six.moves.urllib_error'
    ...
    class Module_six_moves_urllib_request(_LazyModule):
        __doc__ = 'Lazy loading of moved objects in six.moves.urllib_request'
    ...
    class Module_six_moves_urllib_response(_LazyModule):
        __doc__ = 'Lazy loading of moved objects in six.moves.urllib_response'
    ...
    class Module_six_moves_urllib_robotparser(_LazyModule):
        __doc__ = 'Lazy loading of moved objects in six.moves.urllib_robotparser'
    ...
    class Module_six_moves_urllib(types.ModuleType):
        __doc__ = 'Create a six.moves.urllib namespace that resembles the Python 3 namespace'
        __path__ = []
        ...
        def __dir__(self):
            return [
             'parse', 'error', 'request', 'response', 'robotparser']
        ...
        def print_(*args, **kwargs):
            ...
            def write(data):
                if not isinstance(data, basestring):
                    ...
                    if isinstance(data, unicode) and fp.encoding is not None:
