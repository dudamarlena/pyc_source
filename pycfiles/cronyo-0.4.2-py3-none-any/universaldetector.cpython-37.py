...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/pb/598z8h910dvf2wrvwnbyl_2m0000gn/T/pip-install-65c3rg8f/chardet/chardet/universaldetector.py
    ...
    def close(self):
        ...
        if self.done:
            ...
            if self._input_state == InputState.PURE_ASCII:
                ...
                elif self.logger.getEffectiveLevel() == logging.DEBUG and self.result['encoding'] is None:
