...
# Embedded file name: build/bdist.macosx-10.13-intel/egg/tests/1001_queue_get_obj.py
...
def test_get_obj():
    assert hasattr(test_taskA, 'Image_module')
    assert hasattr(test_taskA, 'Image_id')
    assert test_taskA.Image_module != None
    assert test_taskA.Image_id != None
