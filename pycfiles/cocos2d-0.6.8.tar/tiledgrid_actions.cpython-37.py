...
# [GCC 8.4.0]
# Embedded file name: d:\dev\cocos2020\cocos\actions\tiledgrid_actions.py
...
class FadeOutTRTiles(TiledGrid3DAction):
    __doc__ = 'Fades out each tile following a diagonal Top-Right path until all the tiles are faded out.\n\n    Example::\n\n       scene.do(FadeOutTRTiles(grid=(16,12), duration=10))\n    '
...
class FadeOutBLTiles(FadeOutTRTiles):
    __doc__ = 'Fades out each tile following an Bottom-Left path until all the tiles are faded out.\n\n    Example::\n\n       scene.do(FadeOutBLTiles(grid=(16,12), duration=5))\n    '
...
class FadeOutUpTiles(FadeOutTRTiles):
    __doc__ = 'Fades out each tile following an upwards path until all the tiles are faded out.\n\n    Example::\n\n       scene.do(FadeOutUpTiles(grid=(16,12), duration=5))\n    '
...
class FadeOutDownTiles(FadeOutUpTiles):
    __doc__ = 'Fades out each tile following an downwards path until all the tiles are faded out.\n\n    Example::\n\n       scene.do(FadeOutDownTiles(grid=(16,12), duration=5))\n    '
...
class TurnOffTiles(TiledGrid3DAction):
    __doc__ = 'TurnOffTiles turns off each in random order\n\n    Example::\n\n       scene.do(TurnOffTiles(grid=(16,12), seed=1, duration=10))\n    '
...
class WavesTiles3D(TiledGrid3DAction):
    __doc__ = 'Simulates waves using the math.sin() function in the z-axis of each tile\n\n    Example::\n\n       scene.do(WavesTiles3D(waves=5, amplitude=120, grid=(16,16), duration=10))\n    '
