...
# [GCC 8.4.0]
# Embedded file name: D:\dev\cocos2020\test\test_draw_endcaps.py
...
class TestFigure(draw.Canvas):
    ...
    def render(self):
        ...
        self.move_to((xs * 2, ys))
        self.line_to((xs * 2, ye))
        self.set_endcap(draw.BUTT_CAP)
        self.move_to((xs * 3, ys))
        self.line_to((xs * 3, ye))
        self.set_stroke_width(1)
        self.set_color((255, 255, 255, 200))
        self.move_to((0, ye))
        self.line_to((x, ye))
        self.move_to((0, ye + line_width // 2))
        self.line_to((x, ye + line_width // 2))
