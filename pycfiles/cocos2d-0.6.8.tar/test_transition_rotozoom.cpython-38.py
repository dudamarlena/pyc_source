...
# [GCC 8.4.0]
# Embedded file name: D:\dev\cocos2020\test\test_transition_rotozoom.py
# Compiled at: 2020-01-10 23:58:31
# Size of source mod 2**32: 1339 bytes
from __future__ import division, print_function, unicode_literals
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))
testinfo = 't 0.1, s, t 0.45, s, t 0.71, s, t 1, s, t 1.21, s, t 1.47, s, t 1.72, s, t 2.1, s, q'
...
def main():
    ...
    director.run(RotoZoomTransition(scene1, 2, scene2))
