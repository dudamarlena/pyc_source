...
# [GCC 8.4.0]
# Embedded file name: D:\dev\cocos2020\test\test_tmx_autotest.py
...
class TestScene(cocos.scene.Scene):
    ...
    def __init__(self):
        ...
        self.add(scroller)
        template_action = CallFunc(scroller.set_focus, 0, 0) + Delay(1) + CallFunc(scroller.set_focus, 768, 0) + Delay(1) + CallFunc(scroller.set_focus, 768, 768) + Delay(1) + CallFunc(scroller.set_focus, 1500, 768) + Delay(1) + ScaleTo(0.75, 1) + Delay(1) + CallFunc(scrollable.set_debug, True) + Delay(1) + CallFunc(director.window.set_size, 800, 600)
