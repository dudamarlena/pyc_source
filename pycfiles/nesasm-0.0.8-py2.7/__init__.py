...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nesasm/__init__.py
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog='nesasm', description='NESasm - NES Assembly Compiler', epilog='')
    subparsers = parser.add_subparsers(title='subcommands', description='utilities', help='aditional help')
    asm_cmd = subparsers.add_parser('asm')
