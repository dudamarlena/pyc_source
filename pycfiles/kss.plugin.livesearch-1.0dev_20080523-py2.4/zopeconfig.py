...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kss/plugin/livesearch/demo/zopeconfig.py
...
class KSSDemos(object):
    ...
    demos = (
     KSSDemo('livesearch', '', 'kss_livesearch_demo.html', 'Autocomplete (original livesearch code)'),)
    selenium_tests = (
