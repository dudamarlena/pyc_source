...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kss/plugin/livesearch/livesearchview.py
# Compiled at: 2007-10-05 09:56:50
    ...
    def renderHtml(self):
        ...
        if not self.results:
            ...
            for result in self.results:
                ...
                b_append('<a href="%s" title="%s">%s</a>' % (itemUrl, escape(full_title, True), escape(display_title, True)))
