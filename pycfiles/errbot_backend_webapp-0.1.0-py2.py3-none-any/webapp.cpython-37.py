...
# [GCC 8.4.0]
# Embedded file name: /home/attakei/works/errbot/devel-plugins/backends/webapp/build/lib/errbot_backend_webapp/webapp.py
...
class WebappMessage(Message):
    ...
    def __init__(self, body='', frm=None, to=None, parent=None, delayed=False, partial=False, extras=None, flow=None):
        super().__init__(body, frm, to, parent, delayed, partial, flow)

    def clone(self):
        return WebappMessage(body=(self._body),
          frm=(self._from),
          to=(self._to),
          parent=(self._parent),
...
class WebappBackend(ErrBot):
    ...
    def build_message(self, text: str) -> WebappMessage:
        return WebappMessage(text)

    def change_presence(self, status: str=ONLINE, message: str=''):
        pass

    def build_reply(self, msg: WebappMessage, text: str=None, private: bool=False, threaded: bool=False) -> WebappMessage:
