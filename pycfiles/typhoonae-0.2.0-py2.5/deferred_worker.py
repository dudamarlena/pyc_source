...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/typhoonae/taskqueue/deferred_worker.py
# Compiled at: 2010-12-12 04:36:57
"""Worker implementation for deferred tasks."""
from amqplib import client_0_8 as amqp
import logging, optparse, os, simplejson, socket, sys, threading, time, typhoonae.taskqueue
...
def main(queue='deferred_tasks', exchange='deferred', routing_key='deferred_worker'):
    """The main function."""
    ...
    def recv_callback(msg):
        ...
        if not typhoonae.taskqueue.is_deferred_eta(task['eta']):
            ...
            chan.basic_publish(new_msg, exchange='immediate', routing_key='normal_worker')
