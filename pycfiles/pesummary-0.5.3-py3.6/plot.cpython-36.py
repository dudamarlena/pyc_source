...
# Size of source mod 2**32: 46149 bytes
from pesummary.utils.utils import logger, number_of_columns_for_legend, _check_latex_install, get_matplotlib_style_file
...
def _1d_histogram_plot(param, samples, latex_label, inj_value=None, kde=False, prior=None, weights=None):
