...
# Size of source mod 2**32: 92605 bytes
import numpy as np
...
class _Conversion(object):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        obj.__init__(parameters, samples, extra_kwargs, evolve_spins, NRSurrogate, waveform_fits, multi_process, regenerate, redshift_method, cosmology)
    ...
    def __init__(self, parameters, samples, extra_kwargs, evolve_spins, NRSurrogate, waveform_fits, multi_process, regenerate, redshift_method, cosmology):
