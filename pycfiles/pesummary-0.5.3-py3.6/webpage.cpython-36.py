...
# Size of source mod 2**32: 44706 bytes
import pesummary
...
class page(Base):
    ...
    def make_table_of_images(self, contents=None, rows=None, columns=None, code='modal', cli=None, autoscale=False, unique_id=None, captions=None, extra_div=False):
