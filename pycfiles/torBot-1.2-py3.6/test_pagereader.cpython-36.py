...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_pagereader.py
...
def test_run():
    urls = [
     'www.test.com', 'www.test.org', 'www.test.net', 'www.test.onion',
    ...
    with pytest.raises(HTTPError):
        for url in urls:
            ...
            if url[-4:] == '.com':
                ...
                if url[-6:] == '.onion':
                    if not page == 'This is a dot onion site.':
