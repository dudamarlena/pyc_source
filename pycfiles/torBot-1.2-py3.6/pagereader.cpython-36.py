...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/modules/pagereader.py
...
def read_first_page(site):
    ...
    if isinstance(err, ConnectionError):
        print('Got ConnectionError after three attempts... ', 'Please check if the TOR service is running or not.')
        exit(1)
