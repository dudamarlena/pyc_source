...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.7/site-packages/asyncbots/bot.py
# Compiled at: 2018-02-27 18:07:38
...
class SlackBotMeta(type):
    __doc__ = 'Metaclass for SlackBot. Used to enforce execution of handler registration after init call in subclasses.'
    ...
    def __init__(cls, name, bases, cls_dict):
        ...
        def new_init(self, *args, **kwargs):
            ...
            if not isinstance(slack, Slack):
                raise TypeError('Function __init__ of a class which inherits from SlackBotmust receive a keyword argument "slack" of type Slack.')
            ...
            for name in names:
                ...
                mapped_data = HandlerData(name=name,
                  expr=expr,
                  channels=channels,
                  doc=doc,
...
class SlackBot(metaclass=SlackBotMeta):
    __doc__ = 'Class to inherit from when making Slack bots (so no need to specify metaclass).'
