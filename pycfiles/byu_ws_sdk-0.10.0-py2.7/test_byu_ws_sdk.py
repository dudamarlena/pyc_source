...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/byu_ws_sdk/test/test_byu_ws_sdk.py
# Compiled at: 2014-03-13 18:58:29
import unittest, byu_ws_sdk as oit
...
class TestOITWebServicesLibrary(unittest.TestCase):
    ...
    def test_url_encode_body_form(self):
        testSharedSecret = 'kgBxqr5AmiPHQpN8J9VumHLJzTDHoeDbgzqawPTc'
        hmac = oit.url_encode(testSharedSecret, 'http://www.byu.edu/', 'sar=2,pau=1,sar=6', 'application/x-www-form-urlencoded', 'PUT')
        self.assertTrue(hmac and len(hmac) == 88)
    ...
    def test_nonce_encode(self):
        nonceValue = 's9dg3yRQx1rAeH7Tkvd8bn8yi6ZN8G0mKYq5LzhQE5acr4g2Z4x6qpDmcA3owf3DmsozwUtqch/F2bBG6uJNjA=='
    ...
    def test_get_http_authorization_header(self):
        ...
        sharedSecret = '98F8wh62cAt8OuufF2rY3B1MSelA8MArV_Zg4CJ9'
        headerValue1 = oit.get_http_authorization_header(apiKey, sharedSecret, 'WsSession', 'URL', 'http://www.byu.edu/', '')
        headerValue2 = oit.get_http_authorization_header(apiKey, sharedSecret, 'WsSession', 'URL', 'http://www.byu.edu/', 'test body data')
    ...
    def test_send_ws_request(self):
        _, _, _, res = oit.send_ws_request('http://www.byu.edu/', 'GET', None)
