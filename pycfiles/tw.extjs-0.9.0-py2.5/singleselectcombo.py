...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/tw/extjs/singleselectcombo.py
...
class SingleSelectCombo(SingleSelectField):
    params = [
     'typeAhead', 'triggerAction', 'width', 'forceSelection']
    typeAhead__doc = ''
    triggerAction__doc = ''
    width_doc = ''
    forceSelection_doc = ''
    ...
    def update_params(self, d):
        ...
        opts = dict(transform=d.id, typeAhead=self.typeAhead, triggerAction=self.triggerAction, width=self.width, forceSelection=self.forceSelection)
