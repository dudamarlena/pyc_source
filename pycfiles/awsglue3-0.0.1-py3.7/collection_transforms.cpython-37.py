...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/awsglue/transforms/collection_transforms.py
...
class SelectFromCollection(GlueTransform):
    ...
    def describeArgs(cls):
        arg1 = {'name':'dfc',  'type':'DynamicFrameCollection', 
    ...
    def describeReturn(cls):
        return {'type':'DynamicFrame',  'description':'Dynamic Frame corresponding to name'}
...
class MapToCollection(GlueTransform):
    ...
    @classmethod
    def describeArgs(cls):
        arg1 = {'name':'dfc',  'type':'CollectionDynamicFrame', 
    ...
    @classmethod
    def describeReturn(cls):
        return {'type':'DynamicFrameCollection',  'description':'A new DynamicFrameCollection after apply transform on each element'}
...
class FlatMap(GlueTransform):
    ...
    @classmethod
    def describeReturn(cls):
        return {'type':'DynamicFrameCollection',  'description':'A new DynamicFrameCollection after applying the transform on each element'}