...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/awsglue/transforms/field_transforms.py
# Compiled at: 2019-08-21 04:11:21
# Size of source mod 2**32: 19327 bytes
...
class RenameField(GlueTransform):
    ...
    def describeArgs(cls):
        arg1 = {'name':'frame',  'type':'DynamicFrame', 
         ...
         'optional':False, 
         'defaultValue':None}
        arg2 = {'name':'old_name',  'type':'String', 
         'description':'Full path to the node to rename', 
         'optional':False, 
         'defaultValue':None}
        arg3 = {'name':'new_name',  'type':'String', 
    ...
    def describeReturn(cls):
        return {'type':'DynamicFrame',  'description':'new DynamicFrame with indicated field renamed'}
...
class DropFields(GlueTransform):
    ...
    def describeArgs(cls):
        arg1 = {'name':'frame',  'type':'DynamicFrame', 
         ...
         'optional':False, 
         'defaultValue':None}
        arg2 = {'name':'paths',  'type':'List[String]', 
    ...
    @classmethod
    def describeReturn(cls):
        return {'type':'DynamicFrame',  'description':'new DynamicFrame without indicated fields'}
...
class SelectFields(GlueTransform):
    ...
    @classmethod
    def describeReturn(cls):
        return {'type':'DynamicFrame',  'description':'new DynamicFrame with only indicated fields'}
...
class SplitFields(GlueTransform):
    ...
    def describeArgs(cls):
        ...
        arg2 = {'name':'paths',  'type':'List[String]', 
         ...
         'optional':False, 
         'defaultValue':None}
        arg3 = {'name':'frame1',  'type':'String', 
         'description':'name for the dynamic frame to be split off', 
         'optional':True, 
         'defaultValue':'frame1'}
        arg4 = {'name':'frame2',  'type':'String', 
    ...
    def describeReturn(cls):
        ...
        return {'type':'DynamicFrameCollection',  'description':desc}
...
class SplitRows(GlueTransform):
    ...
    def describeArgs(cls):
        arg1 = {'name':'frame',  'type':'DynamicFrame', 
         ...
         'optional':False, 
         'defaultValue':None}
        arg2 = {'name':'comparison_dict',  'type':"Dictionary, {String 'path to node': {String 'operator': String or Integer 'value'}}", 
         'description':"{paths to columns: {comparators: value to which each the column will be compared.}}                 Example: {'age': {'>': 10, '<': 20}} will give back rows where age is between 10 and 20 exclusive,                  and rows where this criteria is not met", 
         'optional':False, 
         'defaultValue':None}
        arg3 = {'name':'frame1',  'type':'String', 
         'description':'name for the dynamic frame to be split off', 
...
class Join(GlueTransform):
    ...
    @classmethod
    def describeArgs(cls):
        arg1 = {'name':'frame1',  'type':'DynamicFrame', 
    ...
    @classmethod
    def describeReturn(cls):
        return {'type':'DynamicFrame',  'description':'DynamicFrame obtained by joining two frames'}
...
class Spigot(GlueTransform):
    ...
    @classmethod
    def describeReturn(cls):
        return {'type':'DynamicFrame',  'description':'DynamicFrame is the same as the infput dynamicFrame with an additional write step'}