...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\turbokid\tests\test_template.py
...
options = {'kid.assume_encoding': 'utf-8', 'kid.encoding': 'utf-8', 'kid.precompiled': False, 'kid.sitetemplate': 'turbokid.tests.site', 'dummy': 'does nothing'}
...
def test_kid():
    ...
    assert s == '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">\n<html>\n  <head>\n    <meta content="text/html; charset=utf-8" http-equiv="content-type">\n<title>Fruit Test</title>\n  </head>\n  <body>\n    <p>These are some of my favorite fruits:</p>\n    <ul>\n      <li>\n        I like apples\n      </li><li>\n        I like oranges\n      </li><li>\n        I like kiwis\n      </li><li>\n        I like M&amp;Ms\n      </li>\n    </ul>\n  </body>\n</html>'
...
def test_unicode():
    ...
    engine = get_engine()
    s = engine.render({'v': 'Käse!'}, template='turbokid.tests.simple')
    assert isinstance(s, str)
    s = s.splitlines()[(-1)]
    assert s == ('<p>Check: Käse!</p>').encode('utf-8')


def test_extend():
    """Make sure one template can inherit from another."""
    engine = get_engine()
    values = {'name': 'World', 'flash': 'flash', 'header': 'head', 'footer': 'foot'}
