...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.8.0-Power_Macintosh/egg/econ/Producer.py
...
class Producer(object):
    ...
    def profitFunction(self, price):
        ...
        return max(self.costFunction(0), price * quantity - self.costFunction(quantity))
...
class ProducerSummary(object):
    ...
    def plotProfitFunction(self):
        ...
        profitValues = [ self._producer.profitFunction(pp) for pp in priceValues ]
