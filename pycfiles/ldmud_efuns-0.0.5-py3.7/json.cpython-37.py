...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ldmudefuns/json.py
# Compiled at: 2019-10-28 05:09:47
# Size of source mod 2**32: 4069 bytes
from .common import check_arg
import ldmud, json

class LPCEncoder(json.JSONEncoder):
    __doc__ = 'Class to encode LDMud specific types.'
...
class LPCDecoder(json.JSONDecoder):
    __doc__ = 'Class to decode JSON objects and arrays to LDMud mappings and arrays'
