...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ddmonitoring/main.py
# Compiled at: 2019-12-01 08:52:39
...
class MonitoringApp(App):
    __doc__ = 'App class from cliff overriden to implement the Datadog Challenge app.'

    def __init__(self):
        self.description = 'Datadog monitoring CLI'
        self.version = '0.1'
        self.deferred_help = True
        super(MonitoringApp, self).__init__(description=(self.description),
