...
# [GCC 8.4.0]
# Embedded file name: /home/greg/work/spex/env/lib64/python2.7/site-packages/spex/artifact_server.py
# Compiled at: 2015-07-08 19:54:16
import tornado.ioloop, tornado.web, tornado.netutil, tornado.httpserver, threading
from os import path
import socket
...
class ArtifactServer(object):
    ...
    def _run(self):
        ...
        self.app = tornado.web.Application([
         (
          '/artifact/(.*)', tornado.web.StaticFileHandler, dict(path=self.root_dir))])
