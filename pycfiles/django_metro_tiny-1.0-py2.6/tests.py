...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/metro_tiny/tests.py
# Compiled at: 2012-03-14 18:22:13
import os, unittest
...
class RefreshCommandTestCase(unittest.TestCase):
    ...
    def test_command(self):
        ...
        self.assertNotEqual(City.objects.get(country__name_ascii='Russia', name_ascii='Moscow'), None)
        management.call_command('metrotinyimport', 'Russia', 'Moscow', os.path.join(os.path.dirname(__file__), 'data', 'RU', 'Moscow.ru.txt'))
