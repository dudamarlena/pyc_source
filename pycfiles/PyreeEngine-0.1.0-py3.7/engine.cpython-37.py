...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/PyreeEngine/engine.py
# Compiled at: 2018-12-11 16:13:52
# Size of source mod 2**32: 6610 bytes
from typing import Union, List, Tuple, Callable, Dict
import numpy as np, quaternion, math
from PyreeEngine.util import Vec3
from PyreeEngine.camera import *
import glfw, ctypes, time
...
import json, pythonosc.dispatcher, pythonosc.osc_server, pythonosc.udp_client, asyncio
...
class Engine:
    ...
    def __init__(self):
        ...
        self.layercontext = LayerContext()
        ...
        self.layermanager = LayerManager(self.programconfig, self.layercontext)
