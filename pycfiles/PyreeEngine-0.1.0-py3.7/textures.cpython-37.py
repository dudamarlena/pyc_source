...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/PyreeEngine/textures.py
# Compiled at: 2018-11-16 18:56:41
...
class Texture:
    ...
    def __init__(self):
        ...
        self.depth = None
        self.textures = None
        self.targetType = Texture.TexTarget.texture2D.value
