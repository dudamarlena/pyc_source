...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/models/yu.py
...
class WeightedFLRG(flrg.FLRG):
    __doc__ = 'First Order Weighted Fuzzy Logical Relationship Group'
...
class WeightedFTS(fts.FTS):
    __doc__ = 'First Order Weighted Fuzzy Time Series'
