...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/benchmarks/quantreg.py
# Compiled at: 2018-04-27 13:20:11
...
class QuantileRegression(fts.FTS):
    __doc__ = 'Façade for statsmodels.regression.quantile_regression'
