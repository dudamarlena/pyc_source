...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/models/sadaei.py
# Compiled at: 2019-04-09 15:22:00
# Size of source mod 2**32: 3769 bytes
"""
...
class ExponentialyWeightedFLRG(flrg.FLRG):
    __doc__ = 'First Order Exponentialy Weighted Fuzzy Logical Relationship Group'
...
class ExponentialyWeightedFTS(fts.FTS):
    __doc__ = 'First Order Exponentialy Weighted Fuzzy Time Series'
