...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/data/lorentz.py
...
def get_data(var, a=10.0, b=28.0, c=2.6666666666666665, dt=0.01, initial_values=[
 0.1, 0, 0], iterations=1000):
    """
...
def get_dataframe(a=10.0, b=28.0, c=2.6666666666666665, dt=0.01, initial_values=[
 0.1, 0, 0], iterations=1000):
    """
