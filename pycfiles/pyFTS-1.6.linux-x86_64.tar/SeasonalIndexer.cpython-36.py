...
class LinearSeasonalIndexer(SeasonalIndexer):
    __doc__ = 'Use the data array/list position to index the seasonality '
...
class DataFrameSeasonalIndexer(SeasonalIndexer):
    __doc__ = 'Use the Pandas.DataFrame index position to index the seasonality '
...
class DateTimeSeasonalIndexer(SeasonalIndexer):
    __doc__ = 'Use a Pandas.DataFrame date field to index the seasonality '
