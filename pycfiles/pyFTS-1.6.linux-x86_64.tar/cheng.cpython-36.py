...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/models/cheng.py
# Compiled at: 2018-04-27 11:37:06
...
class TrendWeightedFTS(yu.WeightedFTS):
    __doc__ = 'First Order Trend Weighted Fuzzy Time Series'
