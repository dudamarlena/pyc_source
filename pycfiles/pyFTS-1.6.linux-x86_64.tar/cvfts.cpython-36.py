...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/models/nonstationary/cvfts.py
# Compiled at: 2018-08-06 14:29:25
...
class ConditionalVarianceFTS(hofts.HighOrderFTS):
    ...
    def train(self, ndata, **kwargs):
        tmpdata = common.fuzzySeries(ndata, (self.sets), (self.partitioner.ordered_sets),
          method='fuzzy',
          const_t=0)
