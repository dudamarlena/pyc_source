...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/models/ismailefendi.py
...
class ImprovedWeightedFLRG(flrg.FLRG):
    __doc__ = 'First Order Improved Weighted Fuzzy Logical Relationship Group'
...
class ImprovedWeightedFTS(fts.FTS):
    __doc__ = 'First Order Improved Weighted Fuzzy Time Series'
