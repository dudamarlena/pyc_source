...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyqart/qr/ec/gf.py
# Compiled at: 2016-08-04 10:17:32
        ...
        for x in range(self.index_upper):
            if x < self._m:
                ...
                if x == self._m:
                    ...
                    if not bit_at(table[(-1)], self._m, 0):
...
class _GFItem(object):
    ...
    def __add__(self, other):
        cache_index = (
         self.gf, self.index, other.index)
