...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyqart/qr/data/data.py
# Compiled at: 2016-08-03 11:05:19
    ...
    def version_used_available(self):
        ...
        if self._changed is True:
            ...
            for i in range(1, 41):
                ...
                encode_list = [cls(data, args.cci_length_of(cls)) for cls, data in self._data_set]
                ...
                raise QrSpaceNotEnoughException(args.dcwc * BIT_PER_CW, used)
