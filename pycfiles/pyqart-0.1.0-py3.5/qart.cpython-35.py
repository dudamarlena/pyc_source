...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyqart/art/qart.py
# Compiled at: 2017-04-23 10:55:07
...
class QArtist(QrPainter):
    ...
    def __init__(self, url, img, version=None, mask=None, level=0, rotation=0, dither=False, only_data=False, rand=False, higher_first=False, dy=None, dx=None):
        ...
        self._targets = self.source.to_targets(self.canvas, args, bool(dither), rand, dy, dx)
        self.dither = dither
        print('Done.')
        self._bits = None
            ...
            for i in range(args.bc):
                ...
                if di < used:
                    ...
                    if di + dbc > upper:
                        ...
                        targets_index = sorted(targets_index, key=compare, reverse=self._higher_first)
