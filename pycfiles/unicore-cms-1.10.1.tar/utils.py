...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/universalcore/unicore-cms/cms/views/utils.py
...
class CachingRemoteStorageManager(RemoteStorageManager):
    ...
    def active_branch(self):
        if not hasattr(self, '_active_branch'):
            self._active_branch = super(CachingRemoteStorageManager, self).active_branch()
