...
# [GCC 8.4.0]
# Embedded file name: /Users/adam/Projects/crowdcomms/gb-openapi-codec/gb_openapi_codec/python-openapi-codec/openapi_codec/utils.py
...
def get_tags_from_link_description(description):
    ...
    if 'tags:' not in description:
        ...
        tags_pattern = 'tags:\\s+(?P<tags>(\\s+-\\s+[a-zA-Z][a-zA-Z ]+\\s*)+)'
        ...
        tag_pattern = '\\s+-\\s+(?P<tag>[a-zA-Z][a-zA-Z ]+)'
