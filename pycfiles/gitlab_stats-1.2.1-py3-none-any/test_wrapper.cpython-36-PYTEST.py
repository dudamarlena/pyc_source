...
# [GCC 8.4.0]
# Embedded file name: /Users/sylvain.hareng1/Documents/Github/gitlab_stats/tests/test_wrapper.py
# Compiled at: 2019-08-15 15:20:57
# Size of source mod 2**32: 3824 bytes
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, time, unittest, tests
...
class WrapperTest(unittest.TestCase):
    ...
    def test_002_get_response(self):
        ...
        self.assertEqual(response.status_code, 200, "Can't reach this url, it can be your proxy or a wrong token, set them in a .env file")

    @tests.api_call
    def test_004_wrong_token_raise_error(self):
        with self.assertRaises(ConnectionError):
            self.gaw._header = {'Content-Type':'application/json', 
             'PRIVATE-TOKEN':'{}'.format('wrong token')}
