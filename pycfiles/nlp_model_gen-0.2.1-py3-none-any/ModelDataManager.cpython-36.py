...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/modelManager/modelDataManager/ModelDataManager.py
...
from nlp_model_gen.utils.dbUtils import db_delete_item, db_delete_items, db_get_items, db_insert_item, db_update_item
...
class ModelDataManager:
    ...
    def check_existing_model(model_id):
        ...
        """
        available_model_names = list(map(lambda model: model['model_id'], db_get_items(MODEL_MANAGER_DB, MODEL_MANAGER_MODELS_COLLECTION, None, {'model_id': 1})))
    ...
    def save_model_data(model_id, model_name, description, author, path, analyser_rules_set):
        ...
        data_dict = {'model_id':model_id,  'model_name':model_name, 
    ...
    def add_analyzer_exception(model_id, base_form, token_text, enabled=True):
        ...
        """
        analyzer_exception = {'model_id':model_id, 
         'base_form':base_form, 
    ...
    def enable_analyzer_exception(model_id, base_form, token_text):
        ...
        :token_text: [String] - Texto particular del token a exceptuar.
        """
        update_count = db_update_item(MODEL_MANAGER_DB, ANALYZER_EXCEPTIONS_COLLECTION, {'model_id':model_id, 
         'base_form':base_form,  'token_text':token_text}, {'enabled': True}).modified_count
        if update_count <= 0:
    ...
    def disable_analyzer_exception(model_id, base_form, token_text):
        ...
        """
        update_count = db_update_item(MODEL_MANAGER_DB, ANALYZER_EXCEPTIONS_COLLECTION, {'model_id':model_id, 
         'base_form':base_form,  'token_text':token_text}, {'enabled': False}).modified_count
        if update_count <= 0:
