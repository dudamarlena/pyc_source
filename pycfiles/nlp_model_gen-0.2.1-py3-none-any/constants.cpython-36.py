...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/constants/constants.py
...
TOKEN_RULES_GEN_VERB_GROUP_IMP = [
 ...
 'VERB_%s_2NDPER_PLUR',
 'VERB_%s_3RDPER_PLUR']
TOKEN_RULES_GEN_VERB_GROUP_SIMPLE = [
 '%s']
TOKEN_RULES_GEN_VERB_GROUP_PART = ['%s', '%s', '%s']
TOKEN_RULES_GEN_VERB_CFG = {'inf':{'time_keys':[
   'VERB_INF'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_SIMPLE}, 
 'ger':{'time_keys':[
   'VERB_GER'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_SIMPLE}, 
 'part':{'time_keys':[
   'VERB_PART_MASC', 'VERB_PART_FEM', 'VERB_PART_MASC'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_PART}, 
 'pres':{'time_keys':[
   'PRES', 'PRES', 'PRES', 'PRES', 'PRES', 'PRES'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_COMPLEX}, 
 'pret_perf':{'time_keys':[
   'PAST', 'PAST', 'PAST', 'PAST', 'PAST', 'PAST'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_COMPLEX}, 
 'pret_imperf':{'time_keys':[
   'PAST', 'PAST', 'PAST', 'PAST', 'PAST', 'PAST'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_COMPLEX}, 
 'fut':{'time_keys':[
 ...
 'impA':{'time_keys':[
   '', 'IMP', 'IMP', 'IMP', 'IMP', 'IMP'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_IMP}, 
 'impB':{'time_keys':[
   '', 'IMP', 'IMP', 'IMP', 'IMP', 'IMP'], 
  'tag_keys':TOKEN_RULES_GEN_VERB_GROUP_IMP}, 
 'impC':{'time_keys':[
...
TRAIN_MANAGER_SCHEMAS = {'CUSTOM_ENTITY':'train_manager_entity_schema', 
...
WORD_PROCESSOR_SCHEMAS = {'CONJ_GENERAL_CFG':'conjugator_general_config_schema', 
...
WORD_PROCESSOR_DEFAULT_CFG_OBJECT = {'conjugator_active_theme':'default', 
