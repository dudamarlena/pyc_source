...
LOG_DATA = {'L-0001':{'class_name':'AdminModuleController', 
 ...
 'L-0083':{'class_name':'', 
  ...
  'type':TYPE_INFO}, 
 'L-0084':{'class_name':'ModelManagerController', 
  'method_name':'disable_analyzer_exception', 
 ...
 'L-0093':{'class_name':'', 
  ...
  'type':TYPE_INFO}, 
 'L-0094':{'class_name':'ModelManagerController', 
  'method_name':'get_analyzer_exceptions', 
  'main_text':'Obteniendo excepciones para el analizador...', 
  'type':TYPE_INFO}, 
 'L-0095':{'class_name':'AdminModuleController', 
  'method_name':'get_available_models', 
  'main_text':'El módulo no se ha inicializado correctamente.', 
  'type':TYPE_ERR}, 
 'L-0096':{'class_name':'AdminModuleController', 
  'method_name':'load_model', 
  'main_text':'El módulo no se ha inicializado correctamente.', 
  'type':TYPE_ERR}, 
 'L-0097':{'class_name':'ModelManagerController', 
  'method_name':'get_analyzer_exceptions', 
  'main_text':'El modelo no existe', 
  'type':TYPE_ERR}, 
 'L-0098':{'class_name':'ModelManagerController', 
  'method_name':'get_analyzer_exceptions', 
 ...
 'L-0099':{'class_name':'', 
  ...
  'type':TYPE_INFO}, 
 'L-0100':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conjugator_configs', 
  'main_text':'Obteniendo configuración de la base de datos...', 
  'type':TYPE_INFO}, 
 'L-0101':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conjugator_configs', 
  'main_text':'Los datos de configuración se han obtenido exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0102':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conjugator_configs', 
  'main_text':'Orgnizando datos de configuración...', 
  'type':TYPE_INFO}, 
 'L-0103':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conjugator_configs', 
  'main_text':'Datos organizados exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0104':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conjugator_configs', 
  'main_text':'Excepción al obtener los datos de configuración: %s', 
  'type':TYPE_INFO}, 
 'L-0105':{'class_name':'WordProcessorController', 
  'method_name':'get_available_fuzzy_gen_configs', 
  'main_text':'Obteniendo configuraciones de la base de datos...', 
  'type':TYPE_INFO}, 
 'L-0106':{'class_name':'WordProcessorController', 
  'method_name':'get_available_fuzzy_gen_configs', 
  'main_text':'Configuraciones obtenidas exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0107':{'class_name':'WordProcessorController', 
  'method_name':'get_available_fuzzy_gen_configs', 
  'main_text':'Excepción al obtener los datos de configuración: %s', 
  'type':TYPE_INFO}, 
 'L-0108':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conversor_configs', 
  'main_text':'Obteniendo configuraciones de la base de datos...', 
  'type':TYPE_INFO}, 
 'L-0109':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conversor_configs', 
  'main_text':'Configuraciones obtenidas exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0110':{'class_name':'WordProcessorController', 
  'method_name':'get_available_conversor_configs', 
  'main_text':'Excepción al obtener los datos de configuración: %s', 
  'type':TYPE_INFO}, 
 'L-0111':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_config', 
  'main_text':'Validando tema de configuración...', 
  'type':TYPE_INFO}, 
 'L-0112':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_config', 
  'main_text':'Tema existente o configuraciones provistas no válidas', 
  'type':TYPE_ERR}, 
 'L-0113':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_config', 
  'main_text':'Nuevo tema validado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0114':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_config', 
  'main_text':'Guardando nuevo tema...', 
  'type':TYPE_INFO}, 
 'L-0115':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_config', 
  'main_text':'Nuevo tema guardado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0116':{'class_name':'ModelManagerController', 
  'method_name':'import_model', 
  'main_text':'Importando modelo...', 
  'type':TYPE_INFO}, 
 'L-0117':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Validando tema...', 
  'type':TYPE_INFO}, 
 'L-0118':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Tema inexistente o se intenta modificar el tema por default.', 
  'type':TYPE_ERR}, 
 'L-0119':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Datos del tema validados exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0120':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Construyendo datos de las nuevas excepciones...', 
  'type':TYPE_INFO}, 
 'L-0121':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Una de las nuevas excepciones no cumple con el formato requerido', 
  'type':TYPE_ERR}, 
 'L-0122':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Una de las nuevas excepciones ya se encuentra registrada', 
  'type':TYPE_ERR}, 
 'L-0123':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Datos de las excepciones construidos exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0124':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Guardando datos...', 
  'type':TYPE_INFO}, 
 'L-0125':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Datos guardados exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0126':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Modificando excepciones del tema activo...', 
  'type':TYPE_INFO}, 
 'L-0127':{'class_name':'WordProcessorController', 
  'method_name':'add_conjugator_exceptions', 
  'main_text':'Excepciones del tema actvo modificadas exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0129':{'class_name':'WordProcessorController', 
  'method_name':'add_fuzzy_gen_config', 
  'main_text':'Validando tema...', 
  'type':TYPE_INFO}, 
 'L-0130':{'class_name':'WordProcessorController', 
  'method_name':'add_fuzzy_gen_config', 
  'main_text':'Tema existente o configuraciones provistas no válidas', 
  'type':TYPE_ERR}, 
 'L-0131':{'class_name':'WordProcessorController', 
  'method_name':'add_fuzzy_gen_config', 
  'main_text':'Tema validado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0132':{'class_name':'WordProcessorController', 
  'method_name':'add_fuzzy_gen_config', 
  'main_text':'Guardando datos...', 
  'type':TYPE_INFO}, 
 'L-0133':{'class_name':'WordProcessorController', 
  'method_name':'add_fuzzy_gen_config', 
  'main_text':'Datos guardados exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0134':{'class_name':'ModelLoader', 
  'method_name':'import_model', 
  'main_text':'Importando modelo desde repositorio remoto: %s...', 
  'type':TYPE_INFO}, 
 'L-0135':{'class_name':'WordProcessorController', 
  'method_name':'add_noun_conversor_theme', 
  'main_text':'Validando tema...', 
  'type':TYPE_INFO}, 
 'L-0136':{'class_name':'WordProcessorController', 
  'method_name':'add_noun_conversor_theme', 
  'main_text':'Tema existente o configuraciones provistas no válidas', 
  'type':TYPE_ERR}, 
 'L-0137':{'class_name':'WordProcessorController', 
  'method_name':'add_noun_conversor_theme', 
  'main_text':'Tema validado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0138':{'class_name':'WordProcessorController', 
  'method_name':'add_noun_conversor_theme', 
  'main_text':'Guardando datos...', 
  'type':TYPE_INFO}, 
 'L-0139':{'class_name':'WordProcessorController', 
  'method_name':'add_noun_conversor_theme', 
  'main_text':'Datos guardados exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0140':{'class_name':'ModelLoader', 
  'method_name':'import_model', 
  'main_text':'Importando modelo desde directorio local: %s...', 
  'type':TYPE_INFO}, 
 'L-0141':{'class_name':'WordProcessorController', 
  'method_name':'set_conjugator_active_theme', 
  'main_text':'Validando tema...', 
  'type':TYPE_INFO}, 
 'L-0142':{'class_name':'WordProcessorController', 
  'method_name':'set_conjugator_active_theme', 
  'main_text':'El tema solicitado ya es el tema activo', 
  'type':TYPE_ERR}, 
 'L-0143':{'class_name':'WordProcessorController', 
  'method_name':'set_conjugator_active_theme', 
  'main_text':'El tema solicitado no existe', 
  'type':TYPE_ERR}, 
 'L-0144':{'class_name':'WordProcessorController', 
  'method_name':'set_conjugator_active_theme', 
  'main_text':'Tema validado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0145':{'class_name':'WordProcessorController', 
  'method_name':'set_conjugator_active_theme', 
  'main_text':'Realizando cambio de tema...', 
  'type':TYPE_INFO}, 
 'L-0146':{'class_name':'WordProcessorController', 
  'method_name':'set_conjugator_active_theme', 
  'main_text':'Tema cambiado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0147':{'class_name':'ModelLoader', 
  'method_name':'import_model', 
  'main_text':'Modelo obtenido correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0148':{'class_name':'WordProcessorController', 
  'method_name':'set_fuzzy_generator_active_theme', 
  'main_text':'Validando tema...', 
  'type':TYPE_INFO}, 
 'L-0149':{'class_name':'WordProcessorController', 
  'method_name':'set_fuzzy_generator_active_theme', 
  'main_text':'El tema solicitado ya es el tema activo', 
  'type':TYPE_ERR}, 
 'L-0150':{'class_name':'WordProcessorController', 
  'method_name':'set_fuzzy_generator_active_theme', 
  'main_text':'El tema solicitado no existe', 
  'type':TYPE_ERR}, 
 'L-0151':{'class_name':'WordProcessorController', 
  'method_name':'set_fuzzy_generator_active_theme', 
  'main_text':'Tema validado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0152':{'class_name':'WordProcessorController', 
  'method_name':'set_fuzzy_generator_active_theme', 
  'main_text':'Realizando cambio de tema...', 
  'type':TYPE_INFO}, 
 'L-0153':{'class_name':'WordProcessorController', 
  'method_name':'set_fuzzy_generator_active_theme', 
  'main_text':'Tema cambiado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0154':{'class_name':'ModelLoader', 
  'method_name':'import_model', 
  'main_text':'Extrayendo modelo...', 
  'type':TYPE_INFO}, 
 'L-0155':{'class_name':'WordProcessorController', 
  'method_name':'set_noun_conversor_active_theme', 
  'main_text':'Validando tema...', 
  'type':TYPE_INFO}, 
 'L-0156':{'class_name':'WordProcessorController', 
  'method_name':'set_noun_conversor_active_theme', 
  'main_text':'El tema solicitado ya es el tema activo', 
  'type':TYPE_ERR}, 
 'L-0157':{'class_name':'WordProcessorController', 
  'method_name':'set_noun_conversor_active_theme', 
  'main_text':'El tema solicitado no existe', 
  'type':TYPE_ERR}, 
 'L-0158':{'class_name':'WordProcessorController', 
  'method_name':'set_noun_conversor_active_theme', 
  'main_text':'Tema validado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0159':{'class_name':'WordProcessorController', 
  'method_name':'set_noun_conversor_active_theme', 
  'main_text':'Realizando cambio de tema...', 
  'type':TYPE_INFO}, 
 'L-0160':{'class_name':'WordProcessorController', 
  'method_name':'set_noun_conversor_active_theme', 
  'main_text':'Tema cambiado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0161':{'class_name':'ModelLoader', 
  'method_name':'import_model', 
  'main_text':'Modelo extraído exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0162':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Validando y construyendo datos actualizados...', 
  'type':TYPE_INFO}, 
 'L-0163':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Intentando editar tema por defecto o tema con datos inconsistentes', 
  'type':TYPE_ERR}, 
 'L-0164':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Los nuevos datos no tienen una estructura válida', 
  'type':TYPE_ERR}, 
 'L-0165':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Datos validados y construidos correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0166':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Actualizando datos...', 
  'type':TYPE_INFO}, 
 'L-0167':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Datos actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0168':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Actualizando datos del modelo en uso...', 
  'type':TYPE_INFO}, 
 'L-0169':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_configs', 
  'main_text':'Datos del modelo en uso actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0170':{'class_name':'ModelLoader', 
  'method_name':'import_model', 
  'main_text':'Error al obtener modelo', 
  'type':TYPE_ERR}, 
 'L-0171':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Validando y construyendo datos actualizados...', 
  'type':TYPE_INFO}, 
 'L-0172':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Intentando editar tema por defecto o tema con datos inconsistentes', 
  'type':TYPE_ERR}, 
 'L-0173':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Los nuevos datos no tienen una estructura válida', 
  'type':TYPE_ERR}, 
 'L-0174':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Datos validados y construidos correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0175':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Actualizando datos...', 
  'type':TYPE_INFO}, 
 'L-0176':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Datos actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0177':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Actualizando datos del modelo en uso...', 
  'type':TYPE_INFO}, 
 'L-0178':{'class_name':'WordProcessorController', 
  'method_name':'update_fuzzy_gen_config', 
  'main_text':'Datos del modelo en uso actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0179':{'class_name':'ModelManagerController', 
  'method_name':'import_model', 
  'main_text':'Guardando modelo...', 
  'type':TYPE_INFO}, 
 'L-0180':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Validando y construyendo datos actualizados...', 
  'type':TYPE_INFO}, 
 'L-0181':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Intentando editar tema por defecto o tema con datos inconsistentes', 
  'type':TYPE_ERR}, 
 'L-0182':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Los nuevos datos no tienen una estructura válida', 
  'type':TYPE_ERR}, 
 'L-0183':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Datos validados y construidos correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0184':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Actualizando datos...', 
  'type':TYPE_INFO}, 
 'L-0185':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Datos actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0186':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Actualizando datos del modelo en uso...', 
  'type':TYPE_INFO}, 
 'L-0187':{'class_name':'WordProcessorController', 
  'method_name':'update_noun_conversor_config', 
  'main_text':'Datos del modelo en uso actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0188':{'class_name':'ModelManagerController', 
  'method_name':'import_model', 
  'main_text':'Modelo guardado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0189':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Validando y construyendo datos actualizados...', 
  'type':TYPE_INFO}, 
 'L-0190':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Intentando editar tema por defecto o tema con datos inconsistentes', 
  'type':TYPE_ERR}, 
 'L-0191':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Los nuevos datos no tienen una estructura válida', 
  'type':TYPE_ERR}, 
 'L-0192':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Datos validados y construidos correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0193':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Actualizando datos...', 
  'type':TYPE_INFO}, 
 'L-0194':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Datos actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0195':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Actualizando datos del modelo en uso...', 
  'type':TYPE_INFO}, 
 'L-0196':{'class_name':'WordProcessorController', 
  'method_name':'update_conjugator_exception', 
  'main_text':'Datos del modelo en uso actualizados correctamente', 
  'type':TYPE_SUCCESS}, 
 'L-0197':{'class_name':'ModelManagerController', 
  'method_name':'import_model', 
  'main_text':'Modelo importado exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0198':{'class_name':'WordProcessorController', 
  'method_name':'remove_conjugator_theme', 
  'main_text':'Validando datos del tema...', 
  'type':TYPE_INFO}, 
 'L-0199':{'class_name':'WordProcessorController', 
  'method_name':'remove_conjugator_theme', 
  'main_text':'El tema solicitado no existe o es el tema por defecto.', 
  'type':TYPE_ERR}, 
 'L-0200':{'class_name':'WordProcessorController', 
  'method_name':'remove_conjugator_theme', 
  'main_text':'Datos del tema validados exitosamente', 
  'type':TYPE_SUCCESS}, 
 'L-0201':{'class_name':'WordProcessorController', 
  'method_name':'remove_conjugator_theme', 
  'main_text':'Seleccionando tema por default como tema activo...', 
  'type':TYPE_INFO}, 
 'L-0202':{'class_name':'WordProcessorController', 
  'method_name':'remove_conjugator_theme', 
