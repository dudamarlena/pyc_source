...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/errorHandler/ErrorHandler.py
...
class ErrorHandler:
    ...
    def get_error_dict(exception):
        ...
        try:
            ...
            return {'code':UNKNOWN_ERROR['error_code'], 
    ...
    def get_error(code, log_data):
        ...
        if code in ERROR_DATA.keys():
            ...
            return {'code':GENERIC_ERROR['error_code'], 
