...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/adminModule/tokenizerRulesGenerator/TokenizerRulesGenerator.py
...
from nlp_model_gen.constants.constants import TOKEN_RULES_GEN_MODEL_SEED_FILENAME, TOKEN_RULES_GEN_TMP_ROOT_PATH, TOKEN_RULES_GEN_TYPE_NOUN, TOKEN_RULES_GEN_TYPE_VERB, TOKEN_RULES_GEN_RULES_EXT
...
class TokenizerRulesGenerator:
    ...
    def __init__(self):
        Logger.log('L-0049')
        self._TokenizerRulesGenerator__token_generator = TokenGenerator()
        Logger.log('L-0050')
    ...
    def __generate_verb_rules(self, categories, max_dist, base_path):
        ...
        for key in categories.keys():
            ...
            for verb in categories[key]['dictionary']:
                ...
                exceptions = self._TokenizerRulesGenerator__token_generator.generate_verb_rules_set(verb, max_dist)
    ...
    def __generate_noun_rules(self, categories, max_dist, base_path):
        ...
        for key in categories.keys():
            ...
            for noun in categories[key]['dictionary']:
                ...
                exceptions = self._TokenizerRulesGenerator__token_generator.generate_noun_rules_set(noun, max_dist)
    ...
    def generate_model_data(self, model_seed, path, max_dist):
        ...
        self._TokenizerRulesGenerator__save_model_seed(model_seed, base_path)
        ...
        self._TokenizerRulesGenerator__generate_noun_rules(model_seed['nouns'], max_dist, nouns_path)
        self._TokenizerRulesGenerator__generate_verb_rules(model_seed['verbs'], max_dist, verbs_path)
        Logger.log('L-0004')
