...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/wordProcessor/spanishConjugator/helpers/irregularVerbGeneratorHelper.py
...
def apply_conjugation_or_exception(exceptions, conjugation_func, verb, mode, configs):
    if exceptions is not None:
        ...
        return conjugation_func(verb, True, mode, configs)
