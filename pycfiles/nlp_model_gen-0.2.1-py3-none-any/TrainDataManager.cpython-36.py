...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/trainingModule/TrainDataManager/TrainDataManager.py
# Compiled at: 2019-06-14 18:07:58
# Size of source mod 2**32: 12806 bytes
from nlp_model_gen.constants.constants import TRAIN_DATA_EXAMPLES_COLLECTION, TRAIN_EXAMPLE_STATUS_APPLIED, TRAIN_EXAMPLE_STATUS_APPROVED, TRAIN_EXAMPLE_STATUS_REJECTED, TRAIN_EXAMPLE_STATUS_SUBMITTED, TRAIN_MANAGER_DB, TRAIN_MANAGER_SCHEMAS
...
class TrainDataManager:
    ...
    def __init__(self, available_models):
        self._TrainDataManager__custom_entity_manager = None
        self._TrainDataManager__models = list([])
        self._TrainDataManager__init_success = False
        self._TrainDataManager__init(available_models)

    def is_ready(self):
        return self._TrainDataManager__init_success
    ...
    def __find_model(self, model_id):
        ...
        """
        try:
            model = next(model_data for model_data in self._TrainDataManager__models if model_data.check_model(model_id))
            return model
        except:
            return
    ...
    def __find_example(self, example_id):
        ...
        """
        for model in self._TrainDataManager__models:
    ...
    def __init(self, available_models):
        ...
        try:
            ...
            for model in available_models:
                ...
                self._TrainDataManager__models.append(model_train_data)
            ...
            for training_example in training_examples:
                ...
                model_train_data = self._TrainDataManager__find_model(model_id)
                if model_train_data is not None:
                    model_train_data.add_training_example(training_example)

            Logger.log('L-0253')
            self._TrainDataManager__custom_entity_manager = CustomEntityTagManager()
            if self._TrainDataManager__custom_entity_manager.is_ready():
                Logger.log('L-0254')
                self._TrainDataManager__init_success = True
                return
            Logger.log('L-0255')
    ...
    def __validate_examples(self, examples):
        ...
        for example in examples:
            ...
            for tag in example['tags']:
                ...
                if not self._TrainDataManager__custom_entity_manager.validate_tag(tag_entity):
    ...
    def __create_new_example_data(self, examples, model_id):
        ...
        datos.
        """
        self._TrainDataManager__validate_examples(examples)
        examples_data = list([])
        for example in examples:
            examples_data.append({'example_id':db_get_autoincremental_id(TRAIN_DATA_EXAMPLES_COLLECTION), 
             'model_id':model_id, 
    ...
    def insert_new_model(self, new_model):
        ...
        self._TrainDataManager__models.append(new_model_train_data)
    ...
    def remove_model(self, model_id):
        ...
        :model_id: [String] - Id del modelo.
        """
        self._TrainDataManager__models = list(filter(lambda model: model.get_model_id() != model_id, self._TrainDataManager__models))
    ...
    def add_training_examples(self, model_id, examples):
        ...
        Logger.log('L-0299')
        examples_data = self._TrainDataManager__create_new_example_data(examples, model_id)
        Logger.log('L-0300')
        Logger.log('L-0301')
    ...
    def approve_example(self, example_id):
        ...
        example = self._TrainDataManager__find_example(example_id)
        if example is None:
    ...
    def get_examples_history(self, model_id):
        ...
        """
        if not self._TrainDataManager__find_model(model_id):
    ...
    def add_custom_entity(self, name, description):
        ...
        """
        self._TrainDataManager__custom_entity_manager.add_custom_entity(name, description)
    ...
    def edit_custom_entity(self, name, description):
        ...
        """
        self._TrainDataManager__custom_entity_manager.edit_custom_tag_entity(name, description)
    ...
    def get_available_entities(self):
        ...
        """
        return self._TrainDataManager__custom_entity_manager.get_available_entities()
    ...
    def set_applied_state(self, examples_list):
        ...
        updated_count = db_update_many(TRAIN_MANAGER_DB, TRAIN_DATA_EXAMPLES_COLLECTION, {'example_id': {'$in': examples_id_list}}, {'status': TRAIN_EXAMPLE_STATUS_APPLIED}).matched_count
