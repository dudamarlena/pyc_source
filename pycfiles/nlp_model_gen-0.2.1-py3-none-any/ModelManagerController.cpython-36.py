...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/modelManager/ModelManagerController.py
...
from nlp_model_gen.constants.constants import EVENT_MODEL_CREATED, EVENT_MODEL_DELETED, TOKEN_RULES_GEN_RULES_EXT
...
class ModelManagerController(ObservableSingleton):
    ...
    def __init__(self):
        ...
        self._ModelManagerController__models = list([])
        self._ModelManagerController__init_success = False
        self._ModelManagerController__initialize()
    ...
    def __initialize(self):
        ...
        try:
            ...
            for model in stored_models_data:
                ...
                self._ModelManagerController__models.append(model_object)

            Logger.log('L-0052')
            self._ModelManagerController__init_success = True
    ...
    def is_ready(self):
        return self._ModelManagerController__init_success
    ...
    def get_model(self, model_id):
        ...
        """
        for model in self._ModelManagerController__models:
    ...
    def get_available_models(self):
        ...
        """
        return self._ModelManagerController__models
    ...
    def __check_exception_existence(self, model, base_form, token_text):
        ...
        :token_text:\xa0[String] - Forma especifica en la que detectar el token.
    ...
    def create_model(self, model_id, model_name, description, author, tokenizer_exceptions_path, analyzer_rule_set):
        ...
        """
        Logger.log('L-0021')
        custom_model = self._ModelManagerController__initialize_custom_model()
        new_model = Model(model_id, model_name, description, author, model_id, analyzer_rule_set, [])
        new_model.set_reference(custom_model)
        Logger.log('L-0022')
        self._ModelManagerController__apply_tokenizer_exceptions(new_model, tokenizer_exceptions_path)
        ...
        self._ModelManagerController__models.append(new_model)
        Logger.log('L-0025')
    ...
    def remove_model(self, model_id):
        ...
        Logger.log('L-0072')
        self._ModelManagerController__models.remove(selected_model)
    ...
    def add_analyzer_exception(self, model_id, base_form, token_text, enabled=True):
        ...
        if self._ModelManagerController__check_exception_existence(model, base_form, token_text):
    ...
    def import_model(self, model_id, source=None):
        ...
        self._ModelManagerController__models.append(remote_model)
