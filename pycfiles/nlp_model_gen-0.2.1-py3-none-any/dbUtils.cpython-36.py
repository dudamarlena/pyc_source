...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/utils/dbUtils.py
...
from nlp_model_gen.constants.constants import DB_GENERAL_SETTINGS_DB, DB_AUTOINCREMENTAL_ID_COL, DB_CONNECTION_TIMEOUT, DB_OPERATION_DELETE, DB_OPERATION_DELETE_MANY, DB_OPERATION_INSERT, DB_OPERATION_INSERT_MANY, DB_OPERATION_UPDATE, DB_SERVER_URL
...
def db_get_autoincremental_id(col_name):
    try:
        ...
        next_entry = col.find_and_modify({'collection': col_name}, {'$inc': {'next_id': 1}}, True)
        if next_entry:
...
transaction_operation_types = {DB_OPERATION_INSERT: insert, 
