...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/wordProcessor/WordProcessorController.py
# Compiled at: 2019-06-14 18:07:58
# Size of source mod 2**32: 42566 bytes
import copy
from nlp_model_gen.constants.constants import DB_OPERATION_DELETE, DB_OPERATION_DELETE_MANY, DB_OPERATION_INSERT, DB_OPERATION_INSERT_MANY, DB_OPERATION_UPDATE, WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_CONJ_CFG_COLLECTION, WORD_PROCESSOR_DEFAULT_CFG_OBJECT, WORD_PROCESSOR_DEFAULT_THEME, WORD_PROCESSOR_FUZZY_GEN_CFG_COLLECTION, WORD_PROCESSOR_GENERAL_SETTING_COLLECTION, WORD_PROCESSOR_NOUN_CONV_CFG_COLLECTION, WORD_PROCESSOR_VERB_EXCEPTIONS_COLLECTION, WORD_PROCESSOR_VERB_GROUPS_COLLECTION, WORD_PROCESSOR_SCHEMAS
...
from nlp_model_gen.utils.objectUtils import update_dict, remove_object_from_list
from nlp_model_gen.utils.dbUtils import db_check_collection, db_delete_items, db_insert_item, db_get_items, db_get_item, db_drop_collection, db_batch_operation, db_update_item
...
class WordProcessorController(metaclass=Singleton):
    ...
    def __init__(self, mode=0):
        Logger.log('L-0038')
        self._WordProcessorController__init_success = False
        self._WordProcessorController__conjugator_active_theme = ''
        self._WordProcessorController__fuzzy_gen_active_theme = ''
        self._WordProcessorController__noun_conversor_active_theme = ''
        self._WordProcessorController__conjugator_general_cfg = dict({})
        self._WordProcessorController__conjugator_verb_exceptions = list([])
        self._WordProcessorController__conjugator_verb_groups = dict({})
        self._WordProcessorController__fuzzy_generator_cfg = dict({})
        self._WordProcessorController__noun_conversor_cfg = dict({})
        self._WordProcessorController__initializate_cfg(mode)
    ...
    def __initializate_cfg(self, mode):
        ...
        """
        try:
            self._WordProcessorController__initialize_controller()
            self._WordProcessorController__initialize_conjugator()
            self._WordProcessorController__initialize_fuzzy_generator()
            self._WordProcessorController__initialize_noun_conversor()
            self._WordProcessorController__conjugator = Conjugator(mode, self._WordProcessorController__conjugator_general_cfg, self._WordProcessorController__conjugator_verb_groups, self._WordProcessorController__conjugator_verb_exceptions)
            self._WordProcessorController__fuzzy_generator = FuzzyTermsGenerator(self._WordProcessorController__fuzzy_generator_cfg)
            self._WordProcessorController__conversor = Conversor(self._WordProcessorController__noun_conversor_cfg)
            Logger.log('L-0039')
            self._WordProcessorController__init_success = True
    ...
    def __initialize_controller(self):
        ...
        if not db_check_collection(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_GENERAL_SETTING_COLLECTION):
            ...
            self._WordProcessorController__conjugator_active_theme = WORD_PROCESSOR_DEFAULT_CFG_OBJECT['conjugator_active_theme']
            self._WordProcessorController__fuzzy_gen_active_theme = WORD_PROCESSOR_DEFAULT_CFG_OBJECT['fuzzy_gen_active_theme']
            self._WordProcessorController__noun_conversor_active_theme = WORD_PROCESSOR_DEFAULT_CFG_OBJECT['noun_conversor_active_theme']
        else:
            db_data = db_get_item(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_GENERAL_SETTING_COLLECTION, None, {'_id': 0})
            self._WordProcessorController__conjugator_active_theme = db_data['conjugator_active_theme']
            self._WordProcessorController__fuzzy_gen_active_theme = db_data['fuzzy_gen_active_theme']
            self._WordProcessorController__noun_conversor_active_theme = db_data['noun_conversor_active_theme']
        Logger.log('L-0042')
    ...
    def __initialize_conjugator(self):
        ...
        if not db_check_collection(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_CONJ_CFG_COLLECTION):
            self._WordProcessorController__initialize_conjugator_cfg()
        else:
            self._WordProcessorController__get_conjugator_cfg()
        Logger.log('L-0044')
    ...
    def __initialize_conjugator_cfg(self):
        ...
        conjugator_verb_exceptions = self._WordProcessorController__generate_verb_exceptions()
        db_batch_operation(WORD_PROCESSOR_CONFIG_DB, [
         {'type':DB_OPERATION_INSERT, 
          'col_name':WORD_PROCESSOR_CONJ_CFG_COLLECTION,  'data':word_processor_default_cfg['conjugator_config']},
         {'type':DB_OPERATION_INSERT_MANY, 
          'col_name':WORD_PROCESSOR_VERB_EXCEPTIONS_COLLECTION,  'data':conjugator_verb_exceptions},
         {'type':DB_OPERATION_INSERT, 
          'col_name':WORD_PROCESSOR_VERB_GROUPS_COLLECTION,  'data':word_processor_default_cfg['conjugator_irregular_groups']}])
        self._WordProcessorController__conjugator_general_cfg = word_processor_default_cfg['conjugator_config']
        self._WordProcessorController__conjugator_verb_exceptions = conjugator_verb_exceptions
        self._WordProcessorController__conjugator_verb_groups = word_processor_default_cfg['conjugator_irregular_groups']
    ...
    def __get_conjugator_cfg(self):
        ...
        tema activo.
        """
        self._WordProcessorController__conjugator_general_cfg = db_get_item(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_CONJ_CFG_COLLECTION, {'theme': self._WordProcessorController__conjugator_active_theme}, {'_id':0,  'theme':0})
        self._WordProcessorController__conjugator_verb_exceptions = []
        for exception in db_get_items(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_VERB_EXCEPTIONS_COLLECTION, {'theme': self._WordProcessorController__conjugator_active_theme}, {'_id':0,  'theme':0}):
            self._WordProcessorController__conjugator_verb_exceptions.append(exception)

        self._WordProcessorController__conjugator_verb_groups = db_get_item(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_VERB_GROUPS_COLLECTION, {'theme': self._WordProcessorController__conjugator_active_theme}, {'_id':0,  'theme':0})
    ...
    def __initialize_fuzzy_generator(self):
        ...
        if not db_check_collection(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_FUZZY_GEN_CFG_COLLECTION):
            self._WordProcessorController__initialize_fuzzy_generator_cfg()
        else:
            self._WordProcessorController__get_fuzzy_generator_cfg()
        Logger.log('L-0046')
    ...
    def __initialize_fuzzy_generator_cfg(self):
        ...
        self._WordProcessorController__fuzzy_generator_cfg = word_processor_default_cfg['fuzzy_terms_generator_config']
    ...
    def __get_fuzzy_generator_cfg(self):
        ...
        """
        self._WordProcessorController__fuzzy_generator_cfg = db_get_item(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_FUZZY_GEN_CFG_COLLECTION, {'theme': self._WordProcessorController__fuzzy_gen_active_theme}, {'_id':0,  'theme':0})
    ...
    def __initialize_noun_conversor(self):
        ...
        if not db_check_collection(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_NOUN_CONV_CFG_COLLECTION):
            self._WordProcessorController__initialize_noun_conversor_cfg()
        else:
            self._WordProcessorController__get_noun_conversor_cfg()
        Logger.log('L-0048')
    ...
    def __initialize_noun_conversor_cfg(self):
        ...
        self._WordProcessorController__noun_conversor_cfg = word_processor_default_cfg['noun_conversor_config']
    ...
    def __get_noun_conversor_cfg(self):
        ...
        el tema activo.
        """
        self._WordProcessorController__noun_conversor_cfg = db_get_item(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_NOUN_CONV_CFG_COLLECTION, {'theme': self._WordProcessorController__noun_conversor_active_theme}, {'_id':0,  'theme':0})

    def is_ready(self):
        return self._WordProcessorController__init_success

    def get_conjugator_active_theme(self):
        return self._WordProcessorController__conjugator_active_theme

    def get_fuzzy_gen_active_theme(self):
        return self._WordProcessorController__fuzzy_gen_active_theme

    def get_noun_converseor_active_theme(self):
        return self._WordProcessorController__noun_conversor_active_theme
    ...
    def get_conjugator_configs(self):
        ...
        """
        return self._WordProcessorController__conjugator_general_cfg
    ...
    def get_conjugator_exceptions(self):
        ...
        """
        return self._WordProcessorController__conjugator_verb_exceptions
    ...
    def get_conjugator_irr_groups(self):
        ...
        """
        return self._WordProcessorController__conjugator_verb_groups
    ...
    def get_noun_conversor_configs(self):
        ...
        """
        return self._WordProcessorController__noun_conversor_cfg
    ...
    def get_fuzzy_generator_configs(self):
        ...
        """
        return self._WordProcessorController__fuzzy_generator_cfg
    ...
    def add_conjugator_config(self, theme_name, theme_config, theme_irregular_groups):
        ...
        """
        Logger.log('L-0111')
        existing_theme = theme_name in self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_CONJ_CFG_COLLECTION)
        if existing_theme:
        ...
        db_batch_operation(WORD_PROCESSOR_CONFIG_DB, [
         {'type':DB_OPERATION_INSERT, 
          'col_name':WORD_PROCESSOR_CONJ_CFG_COLLECTION,  'data':updated_theme_config},
         {'type':DB_OPERATION_INSERT, 
          'col_name':WORD_PROCESSOR_VERB_GROUPS_COLLECTION,  'data':updated_irregular_groups}])
        Logger.log('L-0115')
    ...
    def add_conjugator_exceptions(self, theme_name, exceptions):
        ...
        """
        Logger.log('L-0117')
        if theme_name == WORD_PROCESSOR_DEFAULT_THEME or theme_name not in self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_CONJ_CFG_COLLECTION):
        ...
        for exception in exceptions:
            ...
            if self._WordProcessorController__check_exception_existence(theme_name, exception['key']):
        ...
        Logger.log('L-0125')
        if theme_name == self._WordProcessorController__conjugator_active_theme:
            Logger.log('L-0126')
            updated_exceptions = self.get_conjugator_exceptions()
            updated_exceptions.extend(exceptions)
            self._WordProcessorController__conjugator_verb_exceptions = updated_exceptions
            self._WordProcessorController__conjugator.set_irregular_verb_exceptions_config(self._WordProcessorController__conjugator_verb_exceptions)
            Logger.log('L-0127')
    ...
    def add_fuzzy_gen_config(self, theme_name, config):
        ...
        """
        Logger.log('L-0129')
        existing_theme = theme_name in self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_FUZZY_GEN_CFG_COLLECTION)
        if existing_theme:
    ...
    def add_noun_conversor_config(self, theme_name, config):
        ...
        """
        Logger.log('L-0135')
        existing_theme = theme_name in self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_NOUN_CONV_CFG_COLLECTION)
        if existing_theme:
    ...
    def update_conjugator_configs(self, theme_name, theme_config_mod, theme_irr_groups_mod):
        ...
        """
        Logger.log('L-0162')
        config_data = self._WordProcessorController__get_theme_data(theme_name, WORD_PROCESSOR_CONJ_CFG_COLLECTION)
        irr_groups_data = self._WordProcessorController__get_theme_data(theme_name, WORD_PROCESSOR_VERB_GROUPS_COLLECTION)
        ...
        Logger.log('L-0166')
        db_batch_operation(WORD_PROCESSOR_CONFIG_DB, [
         {'type':DB_OPERATION_UPDATE, 
          'col_name':WORD_PROCESSOR_CONJ_CFG_COLLECTION,  'data':updated_config_data,  'query':{'theme': theme_name}},
         {'type':DB_OPERATION_UPDATE, 
          'col_name':WORD_PROCESSOR_VERB_GROUPS_COLLECTION,  'data':updated_irr_groups_data,  'query':{'theme': theme_name}}])
        Logger.log('L-0167')
        if theme_name == self._WordProcessorController__conjugator_active_theme:
            Logger.log('L-0168')
            self._WordProcessorController__conjugator_general_cfg = updated_config_data
            self._WordProcessorController__conjugator_verb_groups = updated_irr_groups_data
            self._WordProcessorController__conjugator.set_general_config(updated_config_data)
            self._WordProcessorController__conjugator.set_irregular_verb_groups_config(updated_irr_groups_data)
            Logger.log('L-0169')
    ...
    def update_conjugator_exception(self, theme_name, exception_key, exception_new_data):
        ...
        """
        Logger.log('L-0189')
        if not self._WordProcessorController__check_exception_existence(theme_name, exception_key) or theme_name == WORD_PROCESSOR_DEFAULT_THEME:
        ...
        if theme_name == self._WordProcessorController__conjugator_active_theme:
            Logger.log('L-0195')
            remove_object_from_list(self._WordProcessorController__conjugator_verb_exceptions, {'theme':theme_name,  'key':exception_key})
            self._WordProcessorController__conjugator_verb_exceptions.append(updated_exception_data)
            self._WordProcessorController__conjugator.set_irregular_verb_exceptions_config(self._WordProcessorController__conjugator_verb_exceptions)
            Logger.log('L-0196')
    ...
    def update_fuzzy_gen_config(self, theme_name, theme_config_mod):
        ...
        """
        Logger.log('L-0171')
        existing_themes = self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_FUZZY_GEN_CFG_COLLECTION)
        if theme_name not in existing_themes or theme_name == WORD_PROCESSOR_DEFAULT_THEME:
        ...
        Logger.log('L-0176')
        if theme_name == self._WordProcessorController__fuzzy_gen_active_theme:
            Logger.log('L-0177')
            self._WordProcessorController__fuzzy_generator_cfg = updated_theme_data
            self._WordProcessorController__fuzzy_generator.set_config(self._WordProcessorController__fuzzy_generator_cfg)
            Logger.log('L-0178')
    ...
    def update_noun_conversor_config(self, theme_name, theme_config_mod):
        ...
        """
        Logger.log('L-0180')
        existing_themes = self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_NOUN_CONV_CFG_COLLECTION)
        if theme_name not in existing_themes or theme_name == WORD_PROCESSOR_DEFAULT_THEME:
        ...
        Logger.log('L-0185')
        if theme_name == self._WordProcessorController__noun_conversor_active_theme:
            Logger.log('L-0186')
            self._WordProcessorController__noun_conversor_cfg = updated_theme_data
            self._WordProcessorController__conversor.set_config(updated_theme_data)
            Logger.log('L-0187')
    ...
    def remove_conjugator_theme(self, theme_name):
        ...
        """
        Logger.log('L-0198')
        existing_themes = self._WordProcessorController__get_existing_themes(WORD_PROCESSOR_CONJ_CFG_COLLECTION)
        if theme_name not in existing_themes or theme_name == WORD_PROCESSOR_DEFAULT_THEME:
        ...
        Logger.log('L-0204')
        db_batch_operation(WORD_PROCESSOR_CONFIG_DB, [
         {'type':DB_OPERATION_DELETE, 
          'col_name':WORD_PROCESSOR_CONJ_CFG_COLLECTION,  'query':{'theme': theme_name}},
         {'type':DB_OPERATION_DELETE_MANY, 
          'col_name':WORD_PROCESSOR_VERB_EXCEPTIONS_COLLECTION,  'query':{'theme': theme_name}},
         {'type':DB_OPERATION_DELETE, 
          'col_name':WORD_PROCESSOR_VERB_GROUPS_COLLECTION,  'query':{'theme': theme_name}}])
        Logger.log('L-0205')
    ...
    def set_conjugator_active_theme(self, theme_name):
        ...
        self._WordProcessorController__conjugator_active_theme = theme_name
        self._WordProcessorController__conjugator_general_cfg = next_config_theme
        self._WordProcessorController__conjugator_verb_exceptions = next_verb_exceptions
        self._WordProcessorController__conjugator_verb_groups = next_verb_groups
        self._WordProcessorController__conjugator.set_general_config(next_config_theme)
        self._WordProcessorController__conjugator.set_irregular_verb_exceptions_config(next_verb_exceptions)
        self._WordProcessorController__conjugator.set_irregular_verb_groups_config(next_verb_groups)
        Logger.log('L-0146')
    ...
    def set_fuzzy_generator_active_theme(self, theme_name):
        ...
        self._WordProcessorController__fuzzy_gen_active_theme = theme_name
        self._WordProcessorController__fuzzy_generator_cfg = next_config_theme
        self._WordProcessorController__fuzzy_generator.set_config(next_config_theme)
        Logger.log('L-0153')
    ...
    def set_noun_conversor_active_theme(self, theme_name):
        ...
        db_update_item(WORD_PROCESSOR_CONFIG_DB, WORD_PROCESSOR_GENERAL_SETTING_COLLECTION, None, {'fuzzy_gen_active_theme': theme_name})
        self._WordProcessorController__noun_conversor_active_theme = theme_name
        self._WordProcessorController__noun_conversor_cfg = next_config_theme
        self._WordProcessorController__conversor.set_config(next_config_theme)
        Logger.log('L-0160')
    ...
    def conjugate_verb(self, verb=''):
        ...
        """
        if not self._WordProcessorController__init_success:
            return
        else:
            return self._WordProcessorController__conjugator.generar_conjugaciones(verb.lower())
    ...
    def conjugate_verb_table_view(self, verb=''):
        ...
        if not self._WordProcessorController__init_success:
            return
        self._WordProcessorController__conjugator.table_view(verb.lower())
    ...
    def get_fuzzy_set(self, term='', max_distance=1):
        ...
        if not self._WordProcessorController__init_success:
            ...
            return self._WordProcessorController__fuzzy_generator.get_fuzzy_tokens(term.lower(), max_distance)
    ...
    def get_plural(self, noun=''):
        ...
        if not self._WordProcessorController__init_success:
            ...
            return self._WordProcessorController__conversor.a_plural(noun.lower())