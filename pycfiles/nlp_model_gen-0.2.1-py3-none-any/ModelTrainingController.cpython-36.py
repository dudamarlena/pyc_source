...
# [GCC 8.4.0]
# Embedded file name: /home/gerardo/Projects/nlp_model_gen/nlp_model_gen/packages/trainingModule/ModelTrainingController.py
# Compiled at: 2019-06-14 18:07:58
# Size of source mod 2**32: 10016 bytes
...
class ModelTrainingController(ObserverSingleton):
    ...
    def __init__(self):
        ...
        self._ModelTrainingController__model_manager = None
        self._ModelTrainingController__model_trainer = None
        self._ModelTrainingController__train_data_manager = None
        self._ModelTrainingController__init_success = False
        self._ModelTrainingController__init()

    def is_ready(self):
        return self._ModelTrainingController__init_success

    def update(self, data):
        if data['event'] == EVENT_MODEL_CREATED:
            self._ModelTrainingController__add_model(data['payload'])
            return
        if data['event'] == EVENT_MODEL_DELETED:
            self._ModelTrainingController__remove_model(data['payload'])
            return
    ...
    def __init(self):
        ...
        Logger.log('L-0243')
        self._ModelTrainingController__init_success = False
        self._ModelTrainingController__model_trainer = ModelTrainerManager()
        self._ModelTrainingController__model_manager = ModelManagerController()
        self._ModelTrainingController__model_manager.add_observer(self)
        available_models = self._ModelTrainingController__model_manager.get_available_models()
        self._ModelTrainingController__train_data_manager = TrainDataManager(available_models)
        Logger.log('L-0245')
        self._ModelTrainingController__init_success = True
    ...
    def __add_model(self, model):
        ...
        """
        self._ModelTrainingController__train_data_manager.insert_new_model(model)
    ...
    def __remove_model(self, model_id):
        ...
        """
        self._ModelTrainingController__train_data_manager.remove_model(model_id)
    ...
    def get_pending_training_examples(self, model_id):
        ...
        """
        results = list([])
        pending_examples = self._ModelTrainingController__train_data_manager.get_pending_examples(model_id)
    ...
    def get_approved_training_examples(self, model_id):
        ...
        """
        results = list([])
        pending_examples = self._ModelTrainingController__train_data_manager.get_approved_examples(model_id)
        for pending_example in pending_examples:
            results.append(pending_example.to_dict())
    ...
    def get_training_examples_history(self, model_id):
        ...
        Logger.log('L-0323')
        results = list([])
        pending_examples = self._ModelTrainingController__train_data_manager.get_examples_history(model_id)
        for pending_example in pending_examples:
            results.append(pending_example.to_dict())
    ...
    def apply_training_approved_examples(self, model_id):
        ...
        """
        Logger.log('L-0331')
        model = self._ModelTrainingController__model_manager.get_model(model_id)
        if model is None:
            ErrorHandler.raise_error('E-0088')
        approved_examples_list = self._ModelTrainingController__train_data_manager.get_approved_examples(model_id)
        if approved_examples_list is None or not approved_examples_list:
            ErrorHandler.raise_error('E-0089')
        self._ModelTrainingController__model_trainer.train_model(model, approved_examples_list)
        Logger.log('L-0334')
        self._ModelTrainingController__train_data_manager.set_applied_state(approved_examples_list)
        Logger.log('L-0335')
        Logger.log('L-0336')
    ...
    def discard_training_examples(self, examples_id_list):
        ...
        for example_id in examples_id_list:
            ...
            try:
                try:
                    self._ModelTrainingController__train_data_manager.discard_example(example_id)
                    status = True
    ...
    def add_training_examples(self, model_id, examples_list):
        ...
        self._ModelTrainingController__train_data_manager.add_training_examples(model_id, examples_list)
        Logger.log('L-0295')
    ...
    def approve_traning_examples(self, examples_id_list):
        ...
        for example_id in examples_id_list:
            ...
            try:
                try:
                    self._ModelTrainingController__train_data_manager.approve_example(example_id)
                    status = True
                except Exception as e:
                    error = ErrorHandler.get_error_dict(e)
    ...
    def add_custom_entity(self, name, description):
        ...
        Logger.log('L-0268')
        self._ModelTrainingController__train_data_manager.add_custom_entity(name.upper(), description)
        Logger.log('L-0269')
    ...
    def edit_custom_entity(self, name, description):
        ...
        Logger.log('L-0281')
        self._ModelTrainingController__train_data_manager.edit_custom_entity(name.upper(), description)
        Logger.log('L-0282')
    ...
    def get_available_entities(self):
        ...
        if not self.is_ready():
            ...
            return self._ModelTrainingController__train_data_manager.get_available_entities()