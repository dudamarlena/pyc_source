...
mock_item = {'key1':'val1', 
 'key2':'val2'}
mock_item_updated = {'key1':'val1-modified', 
 'key2':'val2-modified', 
 'key3':'newkey'}
mock_collection = [
 mock_item, mock_item]
...
class TestAccount(unittest2.TestCase):
    ...
    def test_create_report(self):
        client = Client(api_key, api_secret)
        account = new_api_object(client, mock_account, Account)
        report = account.create_report(type='transactions',
...
mock_withdrawal = {'id':'bar', 
 'resource_path':'/v2/accounts/foo/withdrawals/bar'}
mock_withdrawal_updated = {'id':'bar', 
 'resource_path':'/v2/accounts/foo/withdrawals/bar', 
 'updated':True}
