...
# [GCC 8.4.0]
# Embedded file name: E:\MyRepository\robotframework-testcase-generator\rf_case_generator\caseProducer.py
# Compiled at: 2020-04-21 12:54:46
...
def write_case_to_rf(rf_path, excel_path, resource_file=None):
    ...
    for case_dir in case_collect:
        ...
        elif os.path.exists(suite_path):
...
if __name__ == '__main__':
    write_case_to_rf('E:\\rf_project_demo\\TestCaseSet', '../TestCase.xls', resource_file='E:\\rf_project_demo\\bases\\testResources.robot')