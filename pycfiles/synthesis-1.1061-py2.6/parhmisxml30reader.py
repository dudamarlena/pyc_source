...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/synthesis/parhmisxml30reader.py
    ...
    def parse_site_service(self, element, namespace='hmis'):
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                try:
                    self.existence_test_and_add('agency_location_index_id', self.agency_location_index_id, 'no_handling')
                except:
                    pass
    ...
    def parse_time_open(self, element):
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                try:
                    self.existence_test_and_add('languages_index_id', self.languages_index_id, 'no_handling')
                except:
                    pass
    ...
    def parse_inventory(self, element):
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                try:
                    self.existence_test_and_add('service_index_id', self.service_index_id, 'no_handling')
                except:
                    pass
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                for code in valsName:
                    ...
                    try:
                        self.existence_test_and_add('need_index_id', self.need_index_id, 'no_handling')
                    except:
                        pass
    ...
    def parse_contact(self, element):
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                try:
                    self.existence_test_and_add('resource_info_index_id', self.resource_info_index_id, 'no_handling')
                except:
                    pass
    ...
    def parse_email(self, element):
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                try:
                    self.existence_test_and_add('contact_index_id', self.contact_index_id, 'no_handling')
                except:
                    pass
