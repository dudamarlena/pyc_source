...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/synthesis/occhmisxml30reader.py
# Compiled at: 2011-01-03 14:47:14
""" 
    ...
    def parse_person_historical(self, element):
        ...
        if itemElements is not None:
            for item in itemElements:
                ...
                try:
                    hmisxml30reader.existence_test_and_add(self, 'site_service_participation_index_id', self.site_service_participation_index_id, 'no_handling')
                except:
                    pass
