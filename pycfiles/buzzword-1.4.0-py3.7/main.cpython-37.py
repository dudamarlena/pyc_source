...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/explorer/parts/main.py
# Compiled at: 2020-05-05 16:58:01
...
from .helpers import _get_corpora_meta, _get_corpus, _get_initial_table, _preprocess_corpus, register_callbacks
...
def load_layout(slug, set_and_register=True, django=True):
    ...
    """
    global CORPORA
    global CORPORA_CONFIGS
    global CORPUS_META
    global INITIAL_TABLES
    if django:
