...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bitcoin/crypto/ecdsa/calculator.py
...
def ecdsa_raw_sign(msghash, priv, curve=DEFAULT_CURVE):
    ...
    v, r, s = 27 + (y % 2 ^ (0 if s * 2 < curve.n else 1)), r, s if s * 2 < curve.n else curve.n - s
    return (
     v, r, s)