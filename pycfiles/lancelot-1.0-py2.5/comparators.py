...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/lancelot/comparators.py
# Compiled at: 2009-03-11 08:13:37
"""
...
class FloatValue(Comparator):
    ...
    def __init__(self, prototype, tolerance=None):
        ...
        super(FloatValue, self).__init__(prototype)
        if tolerance:
...
class IsComparator(Comparator):
    ...
    def __init__(self, prototype=None):
        ...
        super(IsComparator, self).__init__(prototype)
...
class NotComparator(IsComparator):
    ...
    def __init__(self, comparator_to_negate):
        ...
        super(NotComparator, self).__init__()
...
class NotNoneValue(NotComparator):
    ...
    def __init__(self):
        ...
        super(NotNoneValue, self).__init__(NoneValue())
...
class NotContain(NotComparator):
    ...
    def __init__(self, value_not_to_contain):
        ...
        super(NotContain, self).__init__(Contain(value_not_to_contain))
...
class OrComparator(IsComparator):
    ...
    def __init__(self, either_comparator, or_comparator):
        ...
        super(OrComparator, self).__init__()
...
class LessThanOrEqual(OrComparator):
    ...
    def __init__(self, prototype):
        ...
        super(LessThanOrEqual, self).__init__(LessThan(prototype), EqualsEquals(prototype))
        self._prototype = prototype
...
class GreaterThanOrEqual(OrComparator):
    ...
    def __init__(self, prototype):
        """ Specify prototype value to be >= other """
        super(GreaterThanOrEqual, self).__init__(GreaterThan(prototype), EqualsEquals(prototype))
        self._prototype = prototype
