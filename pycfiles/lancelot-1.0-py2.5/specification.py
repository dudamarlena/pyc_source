...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/lancelot/specification.py
# Compiled at: 2009-03-04 11:54:02
"""
...
from lancelot.comparators import Comparator, NotComparator, Contain, ExceptionValue, FloatValue, EqualsEquals
...
class Spec(object):
    ...
    def should_collaborate_with(self, *collaborations, **result_spec):
        ...
        constraint = CollaborateWith(*collaborations, **result_spec)
