...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.6.7/lib/python3.6/site-packages/satella/coding/sequences/iterators.py
# Compiled at: 2020-05-12 15:04:16
# Size of source mod 2**32: 7504 bytes
import itertools, typing as tp, warnings
...
def other_sequence_no_longer_than(base_sequence: IteratorOrIterable, other_sequence: IteratorOrIterable[T]) -> tp.Iterator[T]:
    """
...
def shift(iterable: IteratorOrIterable[T], shift_factor: int) -> tp.Iterator[T]:
    ...
    if shift_factor >= 0:
        ...
        iterator = iterator[shift_factor:] + iterator[:shift_factor]
        return iterator


def zip_shifted(*args: tp.Union[(IteratorOrIterable[T], tp.Tuple[(IteratorOrIterable[T], int)])]) -> tp.Iterator[tp.Tuple[(T, ...)]]:
    """
