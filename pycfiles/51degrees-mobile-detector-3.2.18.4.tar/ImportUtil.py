...
# Embedded file name: \Ft\Lib\ImportUtil.py
# Compiled at: 2006-12-10 21:49:18
__doc__ = '\nUtilites for working with Python PEP 302 import hooks.\n\nCopyright 2006 Fourthought, Inc. (USA).\nDetailed license and copyright information: http://4suite.org/COPYRIGHT\nProject home, documentation, distributions: http://4suite.org/\n'
from __future__ import generators
import os, sys, imp, time, types, cStringIO
try:
...
__all__ = ['FindLoader', 'FindImporter', 'GetImporter', 'IterModules', 'GetLastModified', 'GetSearchPath', 'OsPathToResource', 'NormalizeResource', 'GetResourceFilename', 'GetResourceString', 'GetResourceStream', 'GetResourceLastModified']
__zipsafe__ = True
...
try:
    from pkgutil import ImpImporter, ImpLoader, iter_importers, get_loader, find_loader, iter_modules, get_importer
except ImportError:
    import marshal, inspect, re
    MODULE_TYPE_INFO = {}
    for (suffix, mode, module_type) in imp.get_suffixes():
        MODULE_TYPE_INFO[module_type] = (
         suffix, mode)
...
try:
    ...
    class ZipProvider(DefaultProvider):
        ...
        def _has(self, pathname):
            ...
            return arcname in self.zipinfo or arcname in (self._dirindex or self._build_index())
    ...
    if isinstance(provider.loader, zipimporter):
        if not resource:
            ...
            try:
                ...
                timestamp = time.mktime(((dosdate >> 9 & 127) + 1980, (dosdate >> 5 & 15) - 1, dosdate >> 0 & 31, dostime >> 11 & 31, dostime >> 5 & 63, (dostime >> 0 & 31) * 2, 0, 0, -1))
    else:
