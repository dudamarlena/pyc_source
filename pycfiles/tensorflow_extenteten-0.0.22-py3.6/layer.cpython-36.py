...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/extenteten/layer.py
...
@func_scope()
def fully_connected(x, output_layer_size, *, dropout_keep_prob=None, activate=tf.nn.elu):
    ...
    if dropout_keep_prob is None:
        ...
        return tf.nn.dropout(h, dropout_keep_prob)