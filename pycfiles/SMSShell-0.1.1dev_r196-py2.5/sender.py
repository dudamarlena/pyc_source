...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/smsshell/sender.py
# Compiled at: 2008-04-22 13:03:49
...
class SendMsg(object):
    ...
    def send(self):
        ...
        self.entry = filter_message.go_thru_filters(self.entry)
        return status
...
def main():
    ...
    try:
        ...
        conf_file = '/opt/SMSShell/development.ini'
