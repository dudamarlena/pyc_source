...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/smsshell/scripts/recieve.py
# Compiled at: 2008-04-28 05:22:40
...
def save(sender, msg):
    entry = model.Message(recipient=recipient, sender=urllib.unquote_plus(sender), message=urllib.unquote_plus(msg), folder=INBOX)
