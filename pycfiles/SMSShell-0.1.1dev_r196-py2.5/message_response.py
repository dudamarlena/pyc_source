...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/smsshell/scripts/message_response.py
# Compiled at: 2008-04-28 05:40:49
...
def send_entry(recipient, entry, outputs):
    ...
    message = model.Message(folder=OUTBOX, sender=NUMBER, recipient=recipient, message=msg)
