...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/smsshell/scripts/filter_message.py
# Compiled at: 2008-04-22 11:04:39
...
def reply(received, message):
    entry = model.Message(folder=OUTBOX, message=message, sender=received.recipient, recipient=received.sender)
