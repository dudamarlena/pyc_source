...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/varys/FileWriter.py
# Compiled at: 2014-06-10 20:19:05
from util import *
import os
...
class TDF_FileWriter(FileWriter):
    ...
    def write_file(self, event_list, output_dir, idx=None, **kwargs):
        ...
        for ev in event_list:
            cols += [ k for k in ev.keys() if k not in cols ]
        ...
        with open(out_path, 'wb') as (out_file):
            dw = DictWriter(out_file, cols, restval='', extrasaction='raise', dialect=excel_tab)
