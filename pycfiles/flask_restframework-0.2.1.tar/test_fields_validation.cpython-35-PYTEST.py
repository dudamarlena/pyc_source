...
# [GCC 8.4.0]
# Embedded file name: /home/stas/workspace/partners/flask_restframework/flask_restframework/tests/test_fields_validation.py
# Compiled at: 2017-02-23 06:40:26
# Size of source mod 2**32: 2936 bytes
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, datetime, unittest
...
class TestFieldsValidation(unittest.TestCase):
    ...
    def test_model_serializer_required(self):
        ...
        self.assertEqual(serializer.errors, {'value': ['Field is required'], 
    ...
    def test_fields_validation(self):
        ...
        self.assertEqual(v.errors, {'choices': ['Field is required'], 
         'boolean': ['Field is required']})
        v = TestValidation({'choices': 'bad', 'boolean': 'bad', 'boolean_not_req': 'bad'})
        self.assertEqual(v.validate(), False)
        self.assertEqual(v.errors, {'boolean': ['Boolean is required'], 
