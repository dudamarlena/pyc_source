...
# Compiled at: 2017-07-03 05:06:37
...
def test_fetch_data_with_cursor(app, complex_doc):
    ...
    if not @py_assert5:
        @py_format8 = @pytest_ar._call_reprcompare(('==', ), (@py_assert5,), ('%(py4)s\n{%(py4)s = %(py0)s(%(py2)s)\n} == %(py7)s', ), (@py_assert3, @py_assert6)) % {'py7': @pytest_ar._saferepr(@py_assert6), 'py2': @pytest_ar._saferepr(@py_assert1), 'py0': @pytest_ar._saferepr(len) if 'len' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(len) else 'len', 'py4': @pytest_ar._saferepr(@py_assert3)}
...
def test_join_data(app, complex_doc):
    ...
    if not @py_assert1:
        @py_format23 = @pytest_ar._call_reprcompare(('==',), (@py_assert1,), ('%(py0)s == %(py22)s\n{%(py22)s = %(py20)s\n{%(py20)s = %(py18)s\n{%(py18)s = %(py2)s(%(py16)s\n{%(py16)s = %(py5)s\n{%(py5)s = %(py3)s.from_queryset\n}(%(py14)s\n{%(py14)s = %(py12)s\n{%(py12)s = %(py10)s\n{%(py10)s = %(py8)s\n{%(py8)s = %(py6)s._get_collection\n}()\n}.find\n}()\n})\n})\n}.serialize\n}()\n}',), (data, @py_assert21)) % {'py20': @pytest_ar._saferepr(@py_assert19), 'py14': @pytest_ar._saferepr(@py_assert13), 'py2': @pytest_ar._saferepr(S) if 'S' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(S) else 'S', 'py6': @pytest_ar._saferepr(Doc) if 'Doc' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(Doc) else 'Doc', 'py0': @pytest_ar._saferepr(data) if 'data' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(data) else 'data', 'py22': @pytest_ar._saferepr(@py_assert21), 'py18': @pytest_ar._saferepr(@py_assert17), 'py8': @pytest_ar._saferepr(@py_assert7), 'py5': @pytest_ar._saferepr(@py_assert4), 'py10': @pytest_ar._saferepr(@py_assert9), 'py16': @pytest_ar._saferepr(@py_assert15), 'py12': @pytest_ar._saferepr(@py_assert11), 'py3': @pytest_ar._saferepr(QuerysetWrapper) if 'QuerysetWrapper' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(QuerysetWrapper) else 'QuerysetWrapper'}
...
def test_serialize_embedded(app, complex_doc):
    ...
    if not @py_assert21:
        @py_format24 = @pytest_ar._call_reprcompare(('==',), (@py_assert21,), ('%(py20)s\n{%(py20)s = %(py18)s\n{%(py18)s = %(py16)s\n{%(py16)s = %(py0)s(%(py14)s\n{%(py14)s = %(py3)s\n{%(py3)s = %(py1)s.from_queryset\n}(%(py12)s\n{%(py12)s = %(py10)s\n{%(py10)s = %(py8)s\n{%(py8)s = %(py6)s\n{%(py6)s = %(py4)s._get_collection\n}()\n}.find\n}()\n})\n})\n}.serialize\n}()\n} == %(py23)s',), (@py_assert19, @py_assert22)) % {'py20': @pytest_ar._saferepr(@py_assert19), 'py14': @pytest_ar._saferepr(@py_assert13), 'py6': @pytest_ar._saferepr(@py_assert5), 'py1': @pytest_ar._saferepr(QuerysetWrapper) if 'QuerysetWrapper' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(QuerysetWrapper) else 'QuerysetWrapper', 'py0': @pytest_ar._saferepr(S) if 'S' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(S) else 'S', 'py18': @pytest_ar._saferepr(@py_assert17), 'py8': @pytest_ar._saferepr(@py_assert7), 'py4': @pytest_ar._saferepr(Doc) if 'Doc' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(Doc) else 'Doc', 
         'py10': @pytest_ar._saferepr(@py_assert9), 'py23': @pytest_ar._saferepr(@py_assert22), 'py16': @pytest_ar._saferepr(@py_assert15), 'py12': @pytest_ar._saferepr(@py_assert11), 'py3': @pytest_ar._saferepr(@py_assert2)}
