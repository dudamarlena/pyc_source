...
# Compiled at: 2017-12-02 15:06:29
...
class BaseField(object):
    ...
    def from_mongoengine_field(cls, mongoEngineField):
        ...
        if mongoEngineField.unique:
            ...
            validators.append(UniqueValidator(qs=lambda *a: model.objects.all()))
...
class FileField(BaseField):
    __doc__ = '\n    Represents mongoengine GridFS FileField.\n\n    TODO: Add mimetype suport\n    '
...
class DateField(object):
    ...
    def __init__(self, format_='%Y-%m-%d', **k):
        self._format = format_
        super(DateField, self).__init__(**k)
    ...
    def validate(self, value):
        try:
            ...
            raise ValidationError('Incorrect date string for {} format'.format(self._format))
...
class EmbeddedField(BaseRelatedField):
    ...
    def to_json(self, value):
        if value:
            return self.inner_serializer(value).serialize_one()
