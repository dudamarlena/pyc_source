...
# Size of source mod 2**32: 25279 bytes
...
class SimpleFlaskAppTest(unittest.TestCase):
    ...
    def testModelResource(self):
        ...
        ins = Model.objects.create(base=Base.objects.create(title='1'), f1='1', f2=True, f3='1', embedded={'value': '123'}, listf=[
         {'value': '234'}], dictf={'key': 'value'})
        Model.objects.create(base=Base.objects.create(title='2'), f1='2', f2=True, f3='2', embedded={'value': '123'}, listf=[
         {'value': '234'}])
...
class TestModelResources(SimpleFlaskAppTest):
    ...
    def test_unique_validation(self):
        ...
        self.assertEqual(s.validate(), False)
        self.assertEqual(s.errors, {'dt_value': ['Trying to save duplicate value 2000-01-01 00:00:00'], 
