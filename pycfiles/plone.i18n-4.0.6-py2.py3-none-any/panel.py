...
# Embedded file name: /home/matej/workarea/plone.hud/plone.hud1/src/plone/hud/panel.py
# Compiled at: 2013-09-14 10:49:23
__doc__ = 'HUD panel view to be extended by individual panels.'
...
class HUDPanelView(BrowserView):
    ...
    def get_panels(self):
        ...
        configlets = portal_controlpanel.enumConfiglets(group=CONFIGLET_CATEGORY)
        result = []
