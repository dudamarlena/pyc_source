...
# [GCC 8.4.0]
# Embedded file name: /home/arroyo/ovp/gpa-ovp/django-ovp-users/ovp_users/models.py
# Compiled at: 2017-05-15 11:01:19
...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, password=None, **extra_fields):
        ...
        user = self.model(email=email, is_staff=False, is_active=True, last_login=now, joined_date=now, **extra_fields)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._User__original_password = self.password
    ...
    def save(self, *args, **kwargs):
        ...
        elif self._User__original_password != self.password and not self.check_password(self._password):
            hash_password = True
        if hash_password:
