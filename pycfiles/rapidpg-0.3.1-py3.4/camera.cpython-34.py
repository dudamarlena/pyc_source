...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\rapidpg\levelmgr\camera.py
# Compiled at: 2014-06-30 16:46:14
...
class Camera:
    ...
    def __init__(self, screen_res, level_rect, x_speed=15, y_speed=15, left_threshold=10, right_threshold=75, up_threshold=10, down_threshold=75):
        """
    ...
    def update(self, player_rect):
        if player_rect.x - self.rect.x > self.right_threshold:
            ...
            if player_rect.x - self.rect.x < self.left_threshold:
                self.pan_left()
