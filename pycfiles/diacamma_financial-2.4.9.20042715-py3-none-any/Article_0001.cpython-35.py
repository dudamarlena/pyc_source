...
# [GCC 8.4.0]
# Embedded file name: /var/lib/jenkins/jobs/Diacamma_generic/workspace/financial/diacamma/invoice/printmodel/Article_0001.py
...
value = '210\n297\n10//%s//#reference\n40//%s//#designation\n10//%s//#price_txt\n15//%s//#categories\n10//%s//#stockage_total\n' % (_('reference'), _('designation'), _('price'), _('categories'), _('quantities'))