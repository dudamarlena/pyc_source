...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/core/tool.py
...
class ArtellaTool(tool.DccTool, object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        new_config = tpDcc.ConfigsMgr().get_config(config_name=config_name,
    ...
    def run_tool(self, frameless_active=True, tool_kwargs=None, attacher_class=None):
        ...
        return super(ArtellaTool, self).run_tool(frameless_active=frameless_active,
          tool_kwargs=tool_kwargs,
          attacher_class=(artellapipe.Window))
...
class ArtellaToolWidget(base.BaseWidget, object):
    ...
    def close_tool_attacher(self):
        if self.toolset:
            if hasattr(self.toolset, 'attacher'):
