...
# Size of source mod 2**32: 20174 bytes
"""
    ...
    def _check_file_path(self, file_path):
        ...
        if not file_path:
            ...
            if not file_path:
                ...
                return False
            file_path.startswith(self._project.get_path()) or LOGGER.error('Impossible to lock file that is nos located in {} Project Folder!'.format(file_path))
            return
        else:
