...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/p2v/convert_p2v.py
# Compiled at: 2012-07-09 09:49:56
...
def main():
    ...
    if H.ELIGIBILITY == True:
        ...
        if H.hote_xen.is_created_lv(H.VM_NAME) == '1' and H.hote_xen.is_created_cfg(H.VM_NAME):
            ...
            sys.exit()
    elif H.hote_xen.is_created_cfg(H.VM_NAME):
        H.P2V_PHASE_2()
    else:
        H.P2V_PHASE_1()
