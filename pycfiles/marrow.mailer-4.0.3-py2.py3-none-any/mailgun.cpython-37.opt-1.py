...
# [GCC 8.4.0]
# Embedded file name: /marrow/mailer/transport/mailgun.py
...
class MailgunTransport(object):
    ...
    def deliver(self, message):
        ...
        result = self.session.post(uri, auth=('api', self.keys[domain]), data={'from':message.author, 
         'to':list((str(i) for i in message.recipients)),  'subject':message.subject},
