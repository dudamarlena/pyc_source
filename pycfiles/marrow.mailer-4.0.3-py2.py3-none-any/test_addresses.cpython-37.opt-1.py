...
# [GCC 8.4.0]
# Embedded file name: /test/test_addresses.py
# Compiled at: 2019-09-13 21:23:39
# Size of source mod 2**32: 7968 bytes
...
class TestAddressList(object):
    __doc__ = 'Test the AddressList helper class.'
    ...
    def test_assign_list_of_named_addresses(self):
        addresses = [
         ('Test User 1', 'user1@example.com'), ('Test User 2', 'user2@example.com')]
        self.addresses = addresses
    ...
    def test_bytes(self):
        self.addresses = [
         ('User1', 'foo@exámple.test'), ('User2', 'foo@exámple.test')]
