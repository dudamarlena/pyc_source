...
# [GCC 8.4.0]
# Embedded file name: /marrow/mailer/manager/dynamic.py
# Compiled at: 2019-09-13 21:23:39
# Size of source mod 2**32: 5349 bytes
import atexit, threading, weakref, sys, math
...
class DynamicManager(object):
    ...
    def __init__(self, config, transport):
        self.workers = int(config.get('workers', 10))
        self.divisor = int(config.get('divisor', 10))
