...
# [GCC 8.4.0]
# Embedded file name: /test/test_validator.py
...
def test_common_rules():
    ...
    dataset = [
     ...
     ('', 'It cannot be empty.'),
     ('****************************************************************************************************************************************************************************************************************************************************************',
 'It cannot be longer than 255 chars.'),
...
def test_domain_lookup():
    ...
    dataset = [
     ...
     ('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.gothcandy.com',
 'a', False),
     (
      'gothcandy.com', 'mx', [(10, 'mx1.emailsrvr.com'), (20, 'mx2.emailsrvr.com')]),
     ('nx.example.com', 'a', False),
     ('xn--ls8h.la', 'a', '38.103.165.13')]
