...
# [GCC 8.4.0]
# Embedded file name: /home/cyrille/git/klustasuite/galry/galry/visuals/fontmaps/tools.py
# Compiled at: 2016-03-14 08:46:57
import sys, os, re, numpy as np
from galry import log_info, log_debug
import re
__all__ = [
 'load_png', 'load_fnt', 'get_text_map', 'load_font']
...
def find_best_size(font='segoe', size=32):
    ...
    if os.path.exists(fnt):
        ...
        files = [ file for file in os.listdir(path) if file.startswith(font) and file.endswith('.fnt') ]
        files.sort()
        newsize = 0
        for file in files:
