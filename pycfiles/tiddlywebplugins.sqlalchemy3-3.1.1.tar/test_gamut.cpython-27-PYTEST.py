...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.sqlalchemy/test/test_gamut.py
# Compiled at: 2013-08-06 08:34:56
...
def test_reuse_policy_object():
    ...
    @py_assert1 = bag1.policy
    @py_assert3 = @py_assert1.owner
    @py_assert6 = 'campy'
    @py_assert5 = @py_assert3 == @py_assert6
    if not @py_assert5:
        @py_format8 = @pytest_ar._call_reprcompare(('==', ), (@py_assert5,), ('%(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.policy\n}.owner\n} == %(py7)s', ), (@py_assert3, @py_assert6)) % {'py0': @pytest_ar._saferepr(bag1) if 'bag1' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(bag1) else 'bag1', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py7': @pytest_ar._saferepr(@py_assert6)}
        @py_format10 = 'assert %(py9)s' % {'py9': @py_format8}
        raise AssertionError(@pytest_ar._format_explanation(@py_format10))
    @py_assert1 = @py_assert3 = @py_assert5 = @py_assert6 = None
    @py_assert1 = bag2.policy
    @py_assert3 = @py_assert1.owner
    @py_assert6 = 'campy'
    @py_assert5 = @py_assert3 == @py_assert6
    if not @py_assert5:
        @py_format8 = @pytest_ar._call_reprcompare(('==', ), (@py_assert5,), ('%(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.policy\n}.owner\n} == %(py7)s', ), (@py_assert3, @py_assert6)) % {'py0': @pytest_ar._saferepr(bag2) if 'bag2' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(bag2) else 'bag2', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py7': @pytest_ar._saferepr(@py_assert6)}
        @py_format10 = 'assert %(py9)s' % {'py9': @py_format8}
        raise AssertionError(@pytest_ar._format_explanation(@py_format10))
    @py_assert1 = @py_assert3 = @py_assert5 = @py_assert6 = None
    @py_assert1 = bag1.policy
    @py_assert3 = @py_assert1.owner
    @py_assert7 = bag2.policy
    @py_assert9 = @py_assert7.owner
    @py_assert5 = @py_assert3 == @py_assert9
    if not @py_assert5:
        @py_format11 = @pytest_ar._call_reprcompare(('==', ), (@py_assert5,), ('%(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.policy\n}.owner\n} == %(py10)s\n{%(py10)s = %(py8)s\n{%(py8)s = %(py6)s.policy\n}.owner\n}', ), (@py_assert3, @py_assert9)) % {'py8': @pytest_ar._saferepr(@py_assert7), 'py0': @pytest_ar._saferepr(bag1) if 'bag1' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(bag1) else 'bag1', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py6': @pytest_ar._saferepr(bag2) if 'bag2' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(bag2) else 'bag2', 'py10': @pytest_ar._saferepr(@py_assert9)}
        @py_format13 = 'assert %(py12)s' % {'py12': @py_format11}
        raise AssertionError(@pytest_ar._format_explanation(@py_format13))
...
def test_2bag_policy():
    ...
    @py_assert1 = pone2.policy
    @py_assert3 = @py_assert1.read
    @py_assert6 = ['cdent']
    @py_assert5 = @py_assert3 == @py_assert6
    if not @py_assert5:
        @py_format8 = @pytest_ar._call_reprcompare(('==', ), (@py_assert5,), ('%(py4)s\n{%(py4)s = %(py2)s\n{%(py2)s = %(py0)s.policy\n}.read\n} == %(py7)s', ), (@py_assert3, @py_assert6)) % {'py0': @pytest_ar._saferepr(pone2) if 'pone2' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(pone2) else 'pone2', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py7': @pytest_ar._saferepr(@py_assert6)}
        @py_format10 = 'assert %(py9)s' % {'py9': @py_format8}
        raise AssertionError(@pytest_ar._format_explanation(@py_format10))
    @py_assert1 = @py_assert3 = @py_assert5 = @py_assert6 = None
    return
