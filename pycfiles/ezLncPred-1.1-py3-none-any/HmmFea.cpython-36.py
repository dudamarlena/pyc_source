...
# [GCC 8.4.0]
# Embedded file name: /mnt/zxh/ezLncPred/ezLncPred/models/LncADeep/LncADeep_lncRNA/LncADeep_partial/bin/HmmFea.py
# Compiled at: 2019-12-10 05:26:20
...
def RunHMM(fasta, output, pfam, thread=8):
    ...
    cmd = script_dir + '/hmmer-3.2.1/src/hmmsearch -o ' + out1 + ' --domtblout ' + out2 + ' --noali -E 0.1 --domE 0.1 --cpu ' + str(thread) + ' ' + pfam + ' ' + fasta
