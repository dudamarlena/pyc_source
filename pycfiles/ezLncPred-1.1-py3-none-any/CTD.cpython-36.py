...
# [GCC 8.4.0]
# Embedded file name: /mnt/zxh/ezLncPred/ezLncPred/models/PredLnc_GFStack/src/get_features_module/CTD.py
...
def distance(seq, num_A, num_T, num_G, num_C):
    ...
    dis = {'A0':A0_dis, 
     'A1':A1_dis,  'A2':A2_dis,  'A3':A3_dis,  'A4':A4_dis,  'T0':T0_dis,  'T1':T1_dis,  'T2':T2_dis,  'T3':T3_dis,  'T4':T4_dis,  'G0':G0_dis,  'G1':G1_dis,  'G2':G2_dis,  'G3':G3_dis,  'G4':G4_dis,  'C0':C0_dis,  'C1':C1_dis,  'C2':C2_dis,  'C3':C3_dis,  'C4':C4_dis}
    return dis