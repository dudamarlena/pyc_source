...
# [GCC 8.4.0]
# Embedded file name: /mnt/zxh/ezLncPred/ezLncPred/models/PredLnc_GFStack/src/get_features_module/fickett.py
# Compiled at: 2019-12-04 10:19:56
# Size of source mod 2**32: 3398 bytes
"""the python script is downloaded from https://sourceforge.net/projects/rna-cpat/files/v1.2.2/"""
position_prob = {'A':[
  0.94, 0.68, 0.84, 0.93, 0.58, 0.68, 0.45, 0.34, 0.2, 0.22], 
 'C':[
  0.8, 0.7, 0.7, 0.81, 0.66, 0.48, 0.51, 0.33, 0.3, 0.23], 
 'G':[
  0.9, 0.88, 0.74, 0.64, 0.53, 0.48, 0.27, 0.16, 0.08, 0.08], 
 'T':[
  0.97, 0.97, 0.91, 0.68, 0.69, 0.44, 0.54, 0.2, 0.09, 0.09]}
position_weight = {'A':0.26, 
 'C':0.18,  'G':0.31,  'T':0.33}
position_para = [1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 0.0]
content_prob = {'A':[
  0.28, 0.49, 0.44, 0.55, 0.62, 0.49, 0.67, 0.65, 0.81, 0.21], 
 'C':[
  0.82, 0.64, 0.51, 0.64, 0.59, 0.59, 0.43, 0.44, 0.39, 0.31], 
 'G':[
  0.4, 0.54, 0.47, 0.64, 0.64, 0.73, 0.41, 0.41, 0.33, 0.29], 
 'T':[
  0.28, 0.24, 0.39, 0.4, 0.55, 0.75, 0.56, 0.69, 0.51, 0.58]}
content_weight = {'A':0.11, 
 'C':0.12,  'G':0.15,  'T':0.14}
