...
# [GCC 8.4.0]
# Embedded file name: /mnt/zxh/LncrnaPackage/models/CPC2_beta/bin/CPC2.py
# Compiled at: 2019-09-27 11:29:25
                ...
                while True:
                    ...
                    if end_extension:
                        ...
                        if Length == self.longest and orf_start < self.result[1]:
                            self.result = [
                             direction, orf_start, orf_end, Length, integrity]
                        break
...
def calculate_potential(fasta, strand, outfile):
    ...
    data_dir = script_dir + '/models/CPC2_beta/data/'
    lib_dir = script_dir + '/models/CPC2_beta/libs/'
