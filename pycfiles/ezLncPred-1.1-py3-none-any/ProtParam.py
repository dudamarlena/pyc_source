...
# [GCC 8.4.0]
# Embedded file name: /home/lwy/LnrnaPackage/models/CPPred/bin/feamodule/ProtParam.py
...
def protein_param(putative_seqprot):
    return (
     putative_seqprot.instability_index(), putative_seqprot.isoelectric_point(), putative_seqprot.gravy())
