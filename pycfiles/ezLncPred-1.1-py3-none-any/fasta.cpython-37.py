...
# [GCC 8.4.0]
# Embedded file name: /mnt/zxh/LncrnaPackage/models/CPAT/lib/cpmodule/fasta.py
# Compiled at: 2019-09-27 12:32:59
...
class Fasta:
    __doc__ = 'manipulate fasta or fastq format file\n\t'
...
def main():
    obj = Fasta(sys.argv[1])
    obj.countBaseSlidingWindow(pattern=(sys.argv[2]))
