...
# [GCC 8.4.0]
# Embedded file name: /mnt/zxh/LncrnaPackage/models/CNCI/CNCI.py
# Compiled at: 2019-09-27 09:36:35
...
def main(arguments):
    ...
    outPutFileName = CNCIPATH + '/../../' + options.outfile
...
def mainProcess(input, codonArr, hash_matrix, output, number):
    ...
    for i in range(len(label_Arr_tmp)):
        ...
        length_precent = string.atof(M_length) / string.atof(length_total_score)
