...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\underverse\model.py
# Compiled at: 2012-02-20 14:51:30
...
.. code-block:: python
    ...
    @classmethod
    def __lim__(self, array, count=4294967296):
        c = 0
        docs = []
        for doc in array:
            if c < count:
...
.. code-block:: python
    ...
    @classmethod
    def __limskip__(self, array, _skip=0, _limit=4294967296):
        c = 0
        l = 0
        docs = []
        for doc in array:
    ...
    def __expandmap(self, mapped_results):
        ...
        for k, v in mapped_results.items():
            ...
            if hasattr(k, '__iter__'):
                tmp.extend(k)
            elif len(k) > 0 and type(k) != str and type(k) != np.string_:
                for l in k:
                    tmp.append(l)
...
if __name__ == '__main__':
    ...
    verse = uv.test
    emails = [
     'gmail.com', 'hotmail.com', 'yahoo.com', 'gmail.com', 'gmail.com']
    a = range(5)
    b = range(5)
