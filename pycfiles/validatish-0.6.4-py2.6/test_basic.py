...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/validatish/tests/test_basic.py
# Compiled at: 2009-11-09 06:13:42
import unittest
...
class Test_RequiredAndIntegerOrString(unittest.TestCase):
    ...
    fn = validator.All(validator.Required(), validator.Any(validator.String(), validator.Integer()))
