...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tornado_swirl/settings.py
...
default_settings = {'static_path':STATIC_PATH, 
 ...
 'exclude_namespaces':[],  'tags':[],  'swagger_ui_handlers_headers':[],  'swagger_spec_headers':[],  'json_mime_type':'application/json'}

class SwirlVars(object):
    __doc__ = 'Container for swirl handler vars'
    SCHEMAS = dict()
    ROUTES = []
    API_HANDLERS = []
    GLOBAL_TAGS = []
