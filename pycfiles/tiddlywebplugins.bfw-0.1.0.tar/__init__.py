...
# [GCC 8.4.0]
# Embedded file name: /home/fnd/Dev/TiddlyWeb/bfw/test/__init__.py
# Compiled at: 2014-01-18 04:42:04
import sys, os, shutil, httplib2, wsgi_intercept, mangler
...
def req(method, uri, body=None, **kwargs):
    ...
    return http.request(('http://example.org:8001%s' % uri), method=method, body=body, **kwargs)
...
def _initialize_app(tmpdir):
    ...
    merge_config(CONFIG, {}, reconfig=True)
