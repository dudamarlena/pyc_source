...
# [GCC 8.4.0]
# Embedded file name: /Users/muhammadelias/grove_core/django-sql-explorer/explorer/tests/test_utils.py
...
from explorer.utils import passes_blacklist, param, swap_params, extract_params, shared_dict_update, EXPLORER_PARAM_TOKEN, get_params_from_request, get_params_for_url
...
class TestSqlBlacklist(TestCase):
    ...
    def test_sql_whitelist_ok(self):
        app_settings.EXPLORER_SQL_WHITELIST = [
         'dropper']
