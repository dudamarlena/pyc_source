...
# [GCC 8.4.0]
# Embedded file name: /Users/muhammadelias/grove_core/django-sql-explorer/explorer/tests/test_models.py
# Compiled at: 2019-07-02 16:47:10
# Size of source mod 2**32: 7002 bytes
import six
...
class TestQueryResults(TestCase):
    ...
    def test_unicode_with_nulls(self):
        self.qr._headers = [
         ColumnHeader('num'), ColumnHeader('char')]
    ...
    def test_transform_alters_row(self):
        self.qr._headers = [
         ColumnHeader('foo'), ColumnHeader('qux')]
        self.qr._data = [[1, 2]]
        self.qr.process()
    ...
    def test_multiple_transforms(self):
        self.qr._headers = [
         ColumnHeader('foo'), ColumnHeader('bar')]
        self.qr._data = [[1, 2]]
        self.qr.process()
