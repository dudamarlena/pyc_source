...
# [GCC 8.4.0]
# Embedded file name: /Users/muhammadelias/grove_core/django-sql-explorer/explorer/tests/test_exporters.py
...
class TestExcel(TestCase):
    ...
    def test_writing_excel(self):
        ...
        """
        res = QueryResult(SimpleQueryFactory(sql='select 1 as "a", 2 as ""', title='\\/*[]:?this title is longer than 32 characters').sql, connections[CONN])
        res.execute_query()
        res.process()
        d = datetime.now()
