...
# [GCC 8.4.0]
# Embedded file name: /Users/muhammadelias/grove_core/django-sql-explorer/explorer/utils.py
# Compiled at: 2019-07-02 17:25:27
...
def _format_field(field):
    return (
     field.get_attname_column()[1], field.get_internal_type())
...
def get_valid_connection(alias=None):
    ...
    if not alias:
        ...
        if alias not in connections:
            raise InvalidExplorerConnectionException('Attempted to access connection %s, but that is not a registered Explorer connection.' % alias)
