...
# [GCC 8.4.0]
# Embedded file name: /Users/muhammadelias/grove_core/django-sql-explorer/explorer/tasks.py
# Compiled at: 2019-09-23 12:50:40
...
def execute_query(query_id, email_address):
    ...
    send_mail('[SQL Explorer] Your query is running...', '%s is running and should be in your inbox soon!' % q.title, app_settings.FROM_EMAIL, [
     email_address])
