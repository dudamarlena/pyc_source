...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/tomler/config.py
# Compiled at: 2018-10-08 18:42:01
...
class Config:
    ...
    def __init__(self, path: str, activate_hot_reload_of_the_configuration_file: bool=False):
        ...
        if not isinstance(path, str):
            raise AssertionError("The variable 'path' must be a string value.")
        else:
            assert isinstance(activate_hot_reload_of_the_configuration_file, bool), "The variable 'activate_hot_reload_of_the_configuration_file' must be a boolean value."
