...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kyoukai/wsgi.py
...
def to_wsgi_environment(headers: list, method: str, path: str, http_version: str, body: BytesIO=None) -> MultiDict:
    r"""
