...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kyoukai/blueprint.py
# Compiled at: 2017-09-29 12:38:41
# Size of source mod 2**32: 15776 bytes
"""
...
class Blueprint(object):
    ...
    def __init__(self, name: str, parent: 'Blueprint'=None, prefix: str='', *, host_matching: bool=False, host: str=None):
        """
    ...
    def finalize(self, **map_options) -> Map:
        ...
        if self.finalized is True:
            ...
            logger.info('Scanned {} route(s) in the routing tree, building routing mapping.'.format(sum(1 for x in submount.get_rules(submount))))
    ...
    def route(self, routing_url: str, methods: typing.Sequence[str]=('GET', 'HEAD'), **kwargs):
        """
    ...
    def errorhandler(self, code: int, endcode: int=None, step: int=None):
        ...
        :param endcode: The end of the error code range to handle. Error handlers will be added             for all requests between code and endcode. If this is not provided, only one code             will be handled.
    ...
    def add_errorhandler(self, cbl, startcode: int, endcode: int=None, step: int=None):
        ...
        :param endcode: The end of the error code range to handle. Error handlers will be added             for all requests between startcode and endcode.
        :param step: The step for the error handler range.
        """
        rtt = cbl
    ...
    def add_route(self, route: Route, routing_url: str, methods: typing.Sequence[str]=('GET', 'HEAD')):
        """
    ...
    def url_for(self, environment: dict, endpoint: str, *, method: str=None, **kwargs) -> str:
        r"""
    ...
    def match(self, environment: dict) -> typing.Tuple[(Route, typing.Container[typing.Any], Rule)]:
        ...
        :return: A Route object, which can be invoked to return the right response, and the             parameters to invoke it with.
        """
