...
class ConcurrentRotatingFileHandler(BaseRotatingHandler):
    ...
    def __init__(self, filename, mode='a', maxBytes=0, backupCount=0, encoding=None, debug=True, delay=0):
        """
