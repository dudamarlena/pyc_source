...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/fixedlist/__init__.py
# Compiled at: 2015-01-31 03:33:05
import types, zlib, redis
from redis import WatchError
DEFAULT_RETRIES = 5
REDIS_SYSTEMS = {}

def set_redis(system_name='default', redis_host='localhost', redis_port=6379, db=0, **kw):
    """Setup a system."""
    REDIS_SYSTEMS[system_name] = redis.Redis(host=redis_host, port=redis_port, db=db, **kw)
