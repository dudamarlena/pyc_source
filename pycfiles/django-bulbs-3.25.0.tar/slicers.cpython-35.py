...
# [GCC 8.4.0]
# Embedded file name: /webapp/bulbs/reading_list/slicers.py
...
class SearchSlicer(object):
    __doc__ = 'We want to search things like a seesaw. take that mike parent.\n    '
    ...
    def register_queryset(self, queryset, validator=None, default=False):
        ...
        if validator:
            ...
            raise ValueError('Querysets require validation logic to integrate with reading lists.')


def FirstSlotSlicer(primary_query, secondary_query, limit=30):
    """
