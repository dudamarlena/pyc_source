...
# [GCC 8.4.0]
# Embedded file name: /webapp/bulbs/instant_articles/parser.py
...
def parse_betty(tag):
    if tag.name == 'div' and 'image' in tag.get('class', {}) and tag.attrs.get('data-type') == 'image' and tag.has_attr('data-image-id') and tag.has_attr('data-format'):
        ...
        return {'betty': {'image_id': tag.attrs['data-image-id'], 
                   ...
                   'ratio': tag.attrs.get('data-crop', '16x9')}}
