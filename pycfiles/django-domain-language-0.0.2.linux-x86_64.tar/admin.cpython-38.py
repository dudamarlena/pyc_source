...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.8/site-packages/domain_lang/admin.py
...
@admin.register(DomainLanguageMapping)
class DomainLanguageMappingAdmin(admin.ModelAdmin):
    list_display = [
     'domain', 'language']