...
# [GCC 8.4.0]
# Embedded file name: /home/jmcfarlane/dev/personal/Notable/notable/app.py
# Compiled at: 2014-12-24 06:47:01
...
def getopts():
    ...
    parser.add_option('-b', '--bind', default='localhost', help='Network to bind to, default is: localhost')
