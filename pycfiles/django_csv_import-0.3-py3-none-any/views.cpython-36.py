...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Aaswaini Dev\PycharmProjects\FinanceCRM\apps\csv_importer\views.py
# Compiled at: 2020-04-22 11:56:00
...
def upload_csv(request, app_label, model_name):
    ...
    return TemplateResponse(request, 'upload_csv.html', context)