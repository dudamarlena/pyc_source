...
# Compiled at: 2020-01-18 13:35:08
# Size of source mod 2**32: 12465 bytes
from builtins import str
from django.http import HttpResponse, HttpResponseNotAllowed, HttpResponseBadRequest, Http404, HttpResponseServerError, JsonResponse
...
def list_applicable_forms(request, obj_type=None, conn=None, su_conn=None, form_master=None, **kwargs):
    ...
    return JsonResponse({'forms': list(utils.list_forms(su_conn, form_master, group_id, obj_type))})
...
def get_form_assignments(request, conn=None, su_conn=None, form_master=None, **kwargs):
    ...
    return JsonResponse({'assignments': utils.get_group_assignments(su_conn, form_master, managed_group_ids)})
