...
# [GCC 8.4.0]
# Embedded file name: /opt/hostedtoolcache/Python/3.8.2/x64/lib/python3.8/site-packages/musicbot/config.py
# Compiled at: 2020-04-15 22:39:47
# Size of source mod 2**32: 5360 bytes
import os, sys, logging, configparser, pwd, attr, click, tqdm, coloredlogs
