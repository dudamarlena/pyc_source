...
# [GCC 8.4.0]
# Embedded file name: /opt/hostedtoolcache/Python/3.8.2/x64/lib/python3.8/site-packages/musicbot/spotify.py
# Compiled at: 2020-04-15 22:39:47
# Size of source mod 2**32: 7515 bytes
import logging, os, itertools, spotipy, click
...
def sane_spotify(ctx, param, value):
    ...
    ctx.params['spotify'] = Spotify(username=username,
      client_id=client_id,
...
username_option = [
 click.option('--username', help='Spotify username', is_eager=True, callback=config_string_spotify)]
...
token_option = [
 click.option('--token', help='Spotify token', expose_value=False, callback=sane_spotify)]
...
class Spotify:
    ...
    def __init__(self, username, client_id, client_secret, cache_path, scopes, redirect_uri):
        ...
        self.token = spotipy.util.prompt_for_user_token(client_id=(self.client_id),
