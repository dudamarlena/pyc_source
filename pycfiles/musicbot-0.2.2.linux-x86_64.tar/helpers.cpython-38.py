...
# [GCC 8.4.0]
# Embedded file name: /opt/hostedtoolcache/Python/3.8.2/x64/lib/python3.8/site-packages/musicbot/helpers.py
# Compiled at: 2020-04-15 22:39:47
# Size of source mod 2**32: 5169 bytes
import time, os, logging, string, random, functools, click, click_spinner
