...
# [GCC 8.4.0]
# Embedded file name: /Users/krogager/Projects/VoigtFit/build/lib/VoigtFit/molecules.py
# Compiled at: 2020-03-26 13:56:36
# Size of source mod 2**32: 23271 bytes
"""
...
import numpy as np
CO_full_labels = {'AX(0-0)':'${\\rm CO\\ A}^1\\Pi(0) \\leftarrow {\\rm X}^1\\Sigma^+(\\nu=0)$', 
...
CO_labels = {'COJ0_1544.44':'AX(0-0)', 
 ...
 'COJ0_1543.17':'eX(1-0)', 
 'COJ0_1543.00':'eX(1-0)'}
H2_full_labels = {'BX(0-0)':'${\\rm H_2\\ B}^1\\Sigma_u^+(0) \\leftarrow {\\rm X}^1\\Sigma_g^+(\\nu=0)$', 
...
CO = {'AX(0-0)':[
  [
   'COJ0_1544.44'],
  [
   'COJ1_1544.54', 'COJ1_1544.38'],
  [
   'COJ2_1544.72', 'COJ2_1544.57', 'COJ2_1544.34'],
  [
   'COJ3_1544.84', 'COJ3_1544.61', 'COJ3_1544.31'],
  [
   'COJ4_1544.98', 'COJ4_1544.68', 'COJ4_1544.30'],
  [
   'COJ5_1545.14', 'COJ5_1544.76', 'COJ5_1544.31']], 
 'AX(1-0)':[
  [
   'COJ0_1509.74'],
  [
...
rotational_constant = {'H2':60.853, 
 'CO':1.9313, 
 'HD':45.655}
centrifugal_constant = {'H2':0.0471, 
 'CO':6.12e-06}
hc = 0.00012398
k_B = 8.6173e-05
