...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\debug_a\monitor\env_monitor.py
# Compiled at: 2018-05-12 01:04:32
# Size of source mod 2**32: 5707 bytes
"""
监控整个A股市场的交易环境
==============================
"""
...
def analyze_la(la=None):
    ...
    msg = '目前两市涨停%i家，其中一字板%i家；盘中触及涨停后打开家数为%i，封板成功率为%s；两市跌停%i家，其中一字板%i家，盘中触及跌停板%i家。' % (
