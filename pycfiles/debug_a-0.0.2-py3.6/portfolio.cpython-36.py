...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\debug_a\xueqiu\portfolio.py
# Compiled at: 2018-05-17 22:35:45
...
def get_top_portfolio(market='cn', profit='monthly_gain', count=30):
    """"""
    base_url = 'https://xueqiu.com/cubes/discover/rank/cube/list.json?category=12&count={count}&market={market}&profit={profit}&sort=best_benefit'
    ...
    top_pfs = []
    for r in res:
        pf = {'name':r['name'],  'symbol':r['symbol'], 
