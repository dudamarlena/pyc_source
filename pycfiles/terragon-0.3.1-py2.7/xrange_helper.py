...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/terragon/xrange_helper.py
# Compiled at: 2016-10-14 13:05:12
"""
...
def xrange_params(xrangeobj):
    ...
    if xrange_len == 1:
        return (start, 1, 1)
    return (
     start, xrangeobj[1] - xrangeobj[0], xrange_len)
...
def decode_xrange_list(obj):
    ...
    obj = decode_maybe_xrange(obj, allowLists=False)
    if isinstance(obj, xrange):
        return list(obj)
    outlst = []
    for elem in obj:
