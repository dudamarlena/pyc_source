...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/terragon/sparkle.py
# Compiled at: 2016-11-08 11:00:10
import base64, os, shutil, tarfile, tempfile
...
def load_pom_obj(s):
    ...
    classname, obj = decodedObjClass.split('|')
