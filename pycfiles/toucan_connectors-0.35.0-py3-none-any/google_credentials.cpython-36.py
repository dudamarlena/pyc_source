...
class GoogleCredentials(BaseModel):
    ...
    auth_uri: HttpUrl = Field('https://accounts.google.com/o/oauth2/auth',
      title='Authentication URI',
      description=CREDENTIALS_INFO_MESSAGE)
    token_uri: HttpUrl = Field('https://oauth2.googleapis.com/token',
      title='Token URI',
      description=f"{CREDENTIALS_INFO_MESSAGE}. You should not need to change the default value.")
    auth_provider_x509_cert_url: HttpUrl = Field('https://www.googleapis.com/oauth2/v1/certs',
