...
# Compiled at: 2020-05-04 10:23:55
# Size of source mod 2**32: 5653 bytes
import asyncio, os
...
class AircallConnector(ToucanConnector):
 ...
 L.  92        12  LOAD_GLOBAL              ClientSession
               ...
               24  LOAD_CONST               None
               26  YIELD_FROM       
               28  SETUP_ASYNC_WITH    222  'to 222'
 ...
 L. 105       146  LOAD_GLOBAL              len
              ...
              152  LOAD_CONST               0
              154  COMPARE_OP               >
              156  POP_JUMP_IF_FALSE   214  'to 214'

 L. 106       158  SETUP_LOOP          214  'to 214'
              160  LOAD_FAST                'variable_data'
              162  GET_ITER         
              164  FOR_ITER            212  'to 212'
              166  STORE_FAST               'data'

 L. 107       168  LOAD_GLOBAL              print
              170  LOAD_GLOBAL              DICTIONARY_OF_FORMATTERS
              172  LOAD_ATTR                get
              174  LOAD_DEREF               'dataset'
              176  LOAD_STR                 'users'
              178  CALL_FUNCTION_2       2  '2 positional arguments'
              180  CALL_FUNCTION_1       1  '1 positional argument'
              182  POP_TOP          

 L. 108       184  LOAD_FAST                'variable_response_list'

 L. 109       186  LOAD_CLOSURE             'dataset'
              188  BUILD_TUPLE_1         1 
              190  LOAD_LISTCOMP            '<code_object <listcomp>>'
              192  LOAD_STR                 'AircallConnector._get_data.<locals>.<listcomp>'
              194  MAKE_FUNCTION_8          'closure'
              196  LOAD_FAST                'data'
              198  LOAD_DEREF               'dataset'
              200  BINARY_SUBSCR    
              202  GET_ITER         
              204  CALL_FUNCTION_1       1  '1 positional argument'
              206  INPLACE_ADD      
              208  STORE_FAST               'variable_response_list'
              210  JUMP_BACK           164  'to 164'
              212  POP_BLOCK        
            214_0  COME_FROM_LOOP      158  '158'
            214_1  COME_FROM           156  '156'

 L. 111       214  LOAD_FAST                'team_response_list'
              216  LOAD_FAST                'variable_response_list'
              218  BUILD_TUPLE_2         2 
              220  RETURN_VALUE     
            222_0  COME_FROM_ASYNC_WITH    28  '28'
...
Parse error at or near `COME_FROM_ASYNC_WITH' instruction at offset 222_0

    async def _get_tags--- This code section failed: ---

 L. 115         0  LOAD_GLOBAL              BEARER_API_KEY
                2  LOAD_FAST                'self'
                4  LOAD_ATTR                bearer_auth_id
                6  LOAD_CONST               ('Authorization', 'Bearer-Auth-Id')
                8  BUILD_CONST_KEY_MAP_2     2 
 ...
 L. 116        12  LOAD_GLOBAL              ClientSession
               14  LOAD_FAST                'headers'
               16  LOAD_CONST               ('headers',)
               18  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
               20  BEFORE_ASYNC_WITH
 ...
 L. 117        32  LOAD_GLOBAL              fetch_page
 ...
 L. 118        54  BUILD_LIST_0          0 
               56  STORE_FAST               'tags_data_list'

 L. 119        58  SETUP_LOOP           84  'to 84'
               60  LOAD_FAST                'raw_data'
               62  GET_ITER         
               64  FOR_ITER             82  'to 82'
               66  STORE_FAST               'data'

 L. 120        68  LOAD_FAST                'tags_data_list'
               70  LOAD_FAST                'data'
               72  LOAD_STR                 'tags'
               74  BINARY_SUBSCR    
               76  INPLACE_ADD      
 ...
 L. 121        84  LOAD_FAST                'tags_data_list'
               86  RETURN_VALUE     
