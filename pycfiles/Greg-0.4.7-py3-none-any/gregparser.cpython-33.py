...
# [GCC 8.4.0]
# Embedded file name: ./gregparser.py
# Compiled at: 2013-11-05 15:50:55
...
parser_add.add_argument('--downloadfrom', '-d', type=from_date, help='the date from which files should be downloaded (YYYY-MM-DD)')
...
group.add_argument('--downloadfrom', '-d', type=from_date, help='the date from which files should be downloaded (YYYY-MM-DD)')
