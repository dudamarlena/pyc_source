...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/kend/model.py
# Compiled at: 2017-04-05 11:10:18
import logging
log = logging.getLogger(__name__)
VERSION = '0.7'
KEND_NS = {'uri': 'http://utopia.cs.manchester.ac.uk/kend', 
   'prefix': 'kend'}
...
class Annotation(dict):
    ...
    def __init__(self, **kwargs):
        ...
        for attr in ('author', 'concept', 'created', 'updated', 'id', 'revision', 'edit',
                     'media_edit', 'status', 'context'):
