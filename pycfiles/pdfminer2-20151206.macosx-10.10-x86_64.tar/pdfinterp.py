...
# [GCC 8.4.0]
# Embedded file name: /Users/chris/Projects/chris/various/pdfminer/venv/lib/python2.7/site-packages/pdfminer/pdfinterp.py
...
class PDFTextState(object):
    ...
    def __repr__(self):
        return '<PDFTextState: font=%r, fontsize=%r, charspace=%r, wordspace=%r,  scaling=%r, leading=%r, render=%r, rise=%r,  matrix=%r, linematrix=%r>' % (
...
class PDFGraphicState(object):
    ...
    def __repr__(self):
        return '<PDFGraphicState: linewidth=%r, linecap=%r, linejoin=%r,  miterlimit=%r, dash=%r, intent=%r, flatness=%r>' % (
...
class PDFContentParser(PSStackParser):
    ...
    def get_inline_data(self, pos, target='EI'):
        ...
        data = re.sub('(\\x0d\\x0a|[\\x0d\\x0a])$', '', data)
        return (pos, data)
