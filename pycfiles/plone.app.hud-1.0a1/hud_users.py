...
# [GCC 8.4.0]
# Embedded file name: /home/matej/workarea/plone.hud/plone.app.hud/src/plone/app/hud/hud_users.py
# Compiled at: 2013-09-17 12:38:41
...
class UsersPanelView(HUDPanelView):
    ...
    def process_all(self, days_list):
        ...
        active_list = sorted(active_list, key=lambda x: x['value'])
    ...
    def get_group_url(self, groupname):
        return ('{0}/@@usergroup-groupmembership?groupname={1}').format(api.portal.get().absolute_url(), groupname)