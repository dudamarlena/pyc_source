...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/dumpall/__init__.py
# Compiled at: 2019-10-27 07:40:55
# Size of source mod 2**32: 2298 bytes
import os, asyncio, importlib, traceback, click
from os import path
from urllib.parse import urlparse
from .__version__ import __version__, __author__
addons_map = {'.git':'gitdumper', 
 '.svn':'svndumper',  '.DS_Store':'dsdumper'}
