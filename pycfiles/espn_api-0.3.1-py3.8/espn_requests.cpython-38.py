...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/espn_api/requests/espn_requests.py
...
class EspnFantasyRequests(object):
    ...
    def get_league(self):
        ...
        params = {'view': ['mTeam', 'mRoster', 'mMatchup', 'mSettings']}
    ...
    def authentication(self, username: str, password: str):
        ...
        if data['error'] is not None:
            ...
            print('Retry the authentication or continuing without private league access')
            return None
        self.cookies = {'espn_s2':data['data']['s2'],  'swid':data['data']['profile']['swid']}