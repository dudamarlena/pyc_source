...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/espn_api/football/league.py
# Compiled at: 2020-04-25 13:44:14
# Size of source mod 2**32: 10688 bytes
...
class League(BaseLeague):
    ...
    def __init__(self, league_id, year, espn_s2=None, swid=None, username=None, password=None, debug=False):
...
x.final_standing # Avoid dead code: x.standing),
    ...
    def top_scored_week(self) -> Tuple[(Team, int)]:
        ...
        for team in self.teams:
            ...
            top_scored_tup = [(
             i, j) for i, j in zip(self.teams, top_week_points)]
    ...
    def least_scored_week(self) -> Tuple[(Team, int)]:
        ...
        for team in self.teams:
            ...
            least_scored_tup = [(
             i, j) for i, j in zip(self.teams, least_week_points)]
