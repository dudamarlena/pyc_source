...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/sequenceinfo.py
    ...
    def _create_asset_files_buttons(self):
        ...
        if not self._sequence:
            ...
            for file_type in self._sequence.FILES:
                ...
                file_btn = SequenceFileButton(self._sequence, defines.ArtellaFileStatus.WORKING, file_type, file_type_name, tpDcc.ResourcesMgr().icon(file_type))
