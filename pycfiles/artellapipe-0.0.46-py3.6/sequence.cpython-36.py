...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/sequence.py
    ...
    def _fill_sync_action_menu(self, sync_menu):
        ...
        if not sync_menu:
            ...
            for sequence_type_name in self._sequence.FILES:
                ...
                asset_type_action.triggered.connect(partial(self._on_sync, sequence_type_name, defines.ArtellaFileStatus.ALL))
