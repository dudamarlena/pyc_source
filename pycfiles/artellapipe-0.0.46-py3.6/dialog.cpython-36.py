...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/dialog.py
...
class ArtellaDialog(tpDcc.Dialog, object):
    ...
    def __init__(self, project=None, tool=None, name='ArtellaDialog', title='Artella - Dialog', show_dragger=True, size=(200, 125), fixed_size=False, parent=None):
        self._project = project
        self._tool = tool
        title_pixmap = tpDcc.ResourcesMgr().pixmap(name='artella_title', extension='png')
        super(ArtellaDialog, self).__init__(name=name,
          title=title,
          parent=parent,
