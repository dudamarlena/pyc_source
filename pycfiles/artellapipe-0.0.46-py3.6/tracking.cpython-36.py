...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/managers/tracking.py
...
class TrackingManager(QObject, object):
    ...
    def update_tracking_info(self):
        ...
        """
        raise NotImplementedError('update_tracking_info function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def is_tracking_available(self):
        ...
        :return: bool
        """
        raise NotImplementedError('is_tracking_available function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def download_preview_file_thumbnail(self, preview_id, file_path):
        ...
        """
        raise NotImplementedError('download_preview_file_thumbnail function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def get_project_name(self):
        ...
        :return: str
        """
        raise NotImplementedError('get_project_name function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def get_project_fps(self):
        ...
        :return: int
        """
        raise NotImplementedError('get_project_fps function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def get_project_resolution(self):
        ...
        :return: str
        """
        raise NotImplementedError('get_project_resolution function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_project_assets(self):
        ...
        :return: list
        """
        raise NotImplementedError('all_project_assets function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_project_sequences(self):
        ...
        :return:
        """
        raise NotImplementedError('all_project_sequences function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_project_shots(self):
        ...
        :return:
        """
        raise NotImplementedError('all_project_shots function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_assets_in_shot(self, shot):
        ...
        :return: list
        """
        raise NotImplementedError('all_assets_in_shot function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def get_tasks_in_shot(self, shot_id):
        ...
        :return: list
        """
        raise NotImplementedError('get_tasks_in_shot function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def upload_shot_task_preview(self, task_id, preview_file_path, comment='', status=None):
        ...
        :return: bool
        """
        raise NotImplementedError('upload_shot_task_preview function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_task_statuses(self):
        ...
        :return:
        """
        raise NotImplementedError('all_task_statuses function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_task_types_for_assets(self):
        ...
        :return:
        """
        raise NotImplementedError('all_task_types_for_assets function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def all_task_types_for_shots(self):
        ...
        :return:
        """
        raise NotImplementedError('all_task_types_for_shots function for {} is not implemented!'.format(self.__class__.__name__))
    ...
    def get_task_status(self, task_id):
        ...
        :return:
        """
        raise NotImplementedError('get_task_status function for {} is not implemented!'.format(self.__class__.__name__))
