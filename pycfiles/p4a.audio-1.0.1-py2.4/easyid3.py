...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/p4a/audio/ogg/thirdparty/mutagen/easyid3.py
...
class EasyID3(DictMixin, Metadata):
    ...
    """
    __module__ = __name__
    valid_keys = {'album': 'TALB', 'composer': 'TCOM', 'genre': 'TCON', 'date': 'TDRC', 'lyricist': 'TEXT', 'title': 'TIT2', 'version': 'TIT3', 'artist': 'TPE1', 'tracknumber': 'TRCK'}
    ...
    filename = property(lambda s: s.__id3.filename, lambda s, fn: setattr(s.__id3, 'filename', fn))
    ...
    __mungers = {'TCON': (__TCON_get, __TCON_set), 'TDRC': (__TDRC_get, __TDRC_set)}
    __default = (
     __text_get, __text_set)
