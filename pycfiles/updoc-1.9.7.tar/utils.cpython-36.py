...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/Updoc/updoc/utils.py
...
_directory_icons = {'Documents': 'folder-documents', 
...
def list_directory(root, path, view_name, view_arg='path', view_kwargs=None, dir_view_name=None, dir_view_arg=None, dir_view_kwargs=None, show_files=True, show_dirs=True, show_parent=True, show_hidden=False):
