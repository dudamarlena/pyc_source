...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/Updoc/updoc/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='ProxyfiedHost',
       fields=[
      (
       'id', models.AutoField(auto_created=True, serialize=False, primary_key=True, verbose_name='ID')),
      (
       'host',
       models.CharField(db_index=True, help_text='Can be a regexp on URL (like http://*.example.com:*/*) or a subnet (like 192.168.0.0/24). Leave it blank to use as default value.', default='',
         blank=True,
         max_length=255,
         verbose_name='URL to proxify')),
      (
       'proxy',
       models.CharField(db_index=True, help_text='e.g. proxy.example.com:8080. Leave it empty if direct connection. Several values can be given, separated by semi-colons (;).', default='',
         blank=True,
         max_length=255,
         verbose_name='Proxy to use')),
      (
       ...
       options={'verbose_name':'Proxyfied host', 
      'verbose_name_plural':'Proxified hosts'}),
     migrations.CreateModel(name='RewrittenUrl',
       fields=[
      (
       'id', models.AutoField(auto_created=True, serialize=False, primary_key=True, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'Rewritten URL', 
      'verbose_name_plural':'Rewritten URLs'}),
     migrations.CreateModel(name='RssItem',
       fields=[
      (
       'id', models.AutoField(auto_created=True, serialize=False, primary_key=True, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='RssRoot',
       fields=[
      (
       'id', models.AutoField(auto_created=True, serialize=False, primary_key=True, verbose_name='ID')),
      (
       'name', models.CharField(db_index=True, max_length=255, verbose_name='name'))],
       options={'verbose_name':'favorite group', 
      'verbose_name_plural':'favorite groups'}),
     migrations.CreateModel(name='UploadDoc',
       fields=[
      (
       'id', models.AutoField(auto_created=True, serialize=False, primary_key=True, verbose_name='ID')),
      (
