...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/Updoc/updoc/signals.py
    ...
    * remove it
    ...
    try:
        try:
            ...
            if doc:
                content = _('An error happened during the processing of %(name)s: %(error)s') % {'name':doc.name, 
                 'error':str(e)}
