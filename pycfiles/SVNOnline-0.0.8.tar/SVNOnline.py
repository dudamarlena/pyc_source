...
# [GCC 8.4.0]
# Embedded file name: /home/robin/git/SVNOnline/SVNOnline/SVNOnline.py
# Compiled at: 2016-06-08 12:50:12
"""
@author: sintrb
"""
__version__ = '0.0.8'
import BaseHTTPServer, SocketServer, cgi, json, mimetypes, os, posixpath, shutil, socket, sys, urllib, urlparse, svn.local, re, inspect
try:
...
class SVNOnlineRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def api_svn(self, cmd, path, args=''):
        ...
        try:
            ...
            return [
             'this path is not a svn copy:', path]
