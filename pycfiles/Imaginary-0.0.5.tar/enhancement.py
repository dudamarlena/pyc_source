...
# [GCC 8.4.0]
# Embedded file name: /tmp/Divmod-release/Imaginary/imaginary/enhancement.py
...
class Enhancement(object):
    ...
    def installed(self):
        ...
        @raise RuntimeError: to indicate that you shouldn't use this
            functionality.
        """
        raise RuntimeError('Use Enhancement.createFor, not installOn(), to apply an Enhancement to a Thing.')
