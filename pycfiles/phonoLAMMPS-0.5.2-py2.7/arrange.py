...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/phonolammps/arrange.py
...
def rebuild_connectivity_tinker(structure, supercell, matrix):
    ...
    return PhonopyAtomsTinker(positions=np.dot(positions_s, cell), symbols=symbol_s, cell=cell, connectivity=connectivity_s, atom_types=atom_types_s)