...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\py_mysql\lib\mysql\connector\django\features.py
    ...
    def mysql_storage_engine(self):
        ...
        with self.connection.cursor() as (cursor):
            ...
            if self.connection.mysql_version >= (5, 0, 0):
                ...
                cursor.execute("SHOW TABLE STATUS WHERE Name='{table}'".format(table=tblname))
