...
# [GCC 8.4.0]
# Embedded file name: /home/1qbit/qcloud/clients/oneqloud_client/qbit_pb2.py
...
_SQA_ENERGY_TYPE = _descriptor.EnumDescriptor(name='sqa_energy_type', full_name='qbit.services.sqa_energy_type', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='ALL', index=1, number=1, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8507, serialized_end=8543)
...
_SQA_SCHEDULE_TYPE = _descriptor.EnumDescriptor(name='sqa_schedule_type', full_name='qbit.services.sqa_schedule_type', filename=None, file=DESCRIPTOR, values=[
 _descriptor.EnumValueDescriptor(name='LINEAR', index=0, number=0, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8545, serialized_end=8576)
...
_PTICM_GOAL = _descriptor.EnumDescriptor(name='pticm_goal', full_name='qbit.services.pticm_goal', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='SAMPLE', index=1, number=1, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8578, serialized_end=8616)
...
_PTICM_SCALING_TYPE = _descriptor.EnumDescriptor(name='pticm_scaling_type', full_name='qbit.services.pticm_scaling_type', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='NO_SCALING', index=1, number=1, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8618, serialized_end=8666)
...
_PTICM_VAR_FIXING_TYPE = _descriptor.EnumDescriptor(name='pticm_var_fixing_type', full_name='qbit.services.pticm_var_fixing_type', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='SPVAR', index=2, number=2, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8668, serialized_end=8734)
...
_FUJ_NOISE_MODEL = _descriptor.EnumDescriptor(name='fuj_noise_model', full_name='qbit.services.fuj_noise_model', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='GIBBS', index=1, number=1, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8736, serialized_end=8780)
...
_FUJ_TEMP_MODE = _descriptor.EnumDescriptor(name='fuj_temp_mode', full_name='qbit.services.fuj_temp_mode', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='INVERSE_ROOT', index=2, number=2, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8782, serialized_end=8845)
...
_FUJ_SOL_MODE = _descriptor.EnumDescriptor(name='fuj_sol_mode', full_name='qbit.services.fuj_sol_mode', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='QUICK', index=1, number=1, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8847, serialized_end=8886)
...
_FUJ_SCALING_MODE = _descriptor.EnumDescriptor(name='fuj_scaling_mode', full_name='qbit.services.fuj_scaling_mode', filename=None, file=DESCRIPTOR, values=[
 ...
 _descriptor.EnumValueDescriptor(name='MIXED', index=2, number=2, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8888, serialized_end=8944)
...
EXPERT = 1
MIXED = 2
_QUBOSOLUTIONRESPONSE_QUBO_STATUS = _descriptor.EnumDescriptor(name='qubo_status', full_name='qbit.services.QuboSolutionResponse.qubo_status', filename=None, file=DESCRIPTOR, values=[
 _descriptor.EnumValueDescriptor(name='UNKNOWN', index=0, number=0, serialized_options=None, type=None),
 _descriptor.EnumValueDescriptor(name='FINISHED', index=1, number=1, serialized_options=None, type=None),
 _descriptor.EnumValueDescriptor(name='PROCESSING', index=2, number=2, serialized_options=None, type=None),
 _descriptor.EnumValueDescriptor(name='QUEUED', index=3, number=3, serialized_options=None, type=None),
 _descriptor.EnumValueDescriptor(name='CANCELLED', index=4, number=4, serialized_options=None, type=None),
 _descriptor.EnumValueDescriptor(name='ERROR', index=5, number=5, serialized_options=None, type=None)], containing_type=None, serialized_options=None, serialized_start=8401, serialized_end=8495)
_sym_db.RegisterEnumDescriptor(_QUBOSOLUTIONRESPONSE_QUBO_STATUS)
_AZURECREATEJOBREQUEST_INPUTPARAMSENTRY = _descriptor.Descriptor(name='InputParamsEntry', full_name='qbit.services.AzureCreateJobRequest.InputParamsEntry', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='key', full_name='qbit.services.AzureCreateJobRequest.InputParamsEntry.key', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='value', full_name='qbit.services.AzureCreateJobRequest.InputParamsEntry.value', index=1, number=2, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=_b('8\x01'), is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=414, serialized_end=464)
_AZURECREATEJOBREQUEST = _descriptor.Descriptor(name='AzureCreateJobRequest', full_name='qbit.services.AzureCreateJobRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='customer_subscription_id', full_name='qbit.services.AzureCreateJobRequest.customer_subscription_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='customer_resource_group', full_name='qbit.services.AzureCreateJobRequest.customer_resource_group', index=1, number=2, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='app_name', full_name='qbit.services.AzureCreateJobRequest.app_name', index=2, number=3, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='job_id', full_name='qbit.services.AzureCreateJobRequest.job_id', index=3, number=4, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='input_data_format', full_name='qbit.services.AzureCreateJobRequest.input_data_format', index=4, number=5, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='input_data_uri', full_name='qbit.services.AzureCreateJobRequest.input_data_uri', index=5, number=6, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_data_uri', full_name='qbit.services.AzureCreateJobRequest.output_data_uri', index=6, number=7, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='target', full_name='qbit.services.AzureCreateJobRequest.target', index=7, number=8, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='input_params', full_name='qbit.services.AzureCreateJobRequest.input_params', index=8, number=9, type=11, cpp_type=10, label=3, has_default_value=False, default_value=[], message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[
 _AZURECREATEJOBREQUEST_INPUTPARAMSENTRY], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=119, serialized_end=464)
_AZUREGETJOBREQUEST = _descriptor.Descriptor(name='AzureGetJobRequest', full_name='qbit.services.AzureGetJobRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='customer_subscription_id', full_name='qbit.services.AzureGetJobRequest.customer_subscription_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='customer_resource_group', full_name='qbit.services.AzureGetJobRequest.customer_resource_group', index=1, number=2, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='app_name', full_name='qbit.services.AzureGetJobRequest.app_name', index=2, number=3, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='job_id', full_name='qbit.services.AzureGetJobRequest.job_id', index=3, number=4, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=466, serialized_end=587)
_AZURECANCELJOBREQUEST = _descriptor.Descriptor(name='AzureCancelJobRequest', full_name='qbit.services.AzureCancelJobRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='customer_subscription_id', full_name='qbit.services.AzureCancelJobRequest.customer_subscription_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='customer_resource_group', full_name='qbit.services.AzureCancelJobRequest.customer_resource_group', index=1, number=2, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='app_name', full_name='qbit.services.AzureCancelJobRequest.app_name', index=2, number=3, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='job_id', full_name='qbit.services.AzureCancelJobRequest.job_id', index=3, number=4, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=589, serialized_end=713)
_AZUREJOBRESPONSE = _descriptor.Descriptor(name='AzureJobResponse', full_name='qbit.services.AzureJobResponse', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='job_id', full_name='qbit.services.AzureJobResponse.job_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='status', full_name='qbit.services.AzureJobResponse.status', index=1, number=2, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='output_data_format', full_name='qbit.services.AzureJobResponse.output_data_format', index=2, number=3, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='creation_time', full_name='qbit.services.AzureJobResponse.creation_time', index=3, number=4, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='begin_execution_time', full_name='qbit.services.AzureJobResponse.begin_execution_time', index=4, number=5, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='end_execution_time', full_name='qbit.services.AzureJobResponse.end_execution_time', index=5, number=6, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='cancellation_time', full_name='qbit.services.AzureJobResponse.cancellation_time', index=6, number=7, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=716, serialized_end=902)
_COMPAREREQUEST = _descriptor.Descriptor(name='CompareRequest', full_name='qbit.services.CompareRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='solver', full_name='qbit.services.CompareRequest.solver', index=0, containing_type=None, fields=[])], serialized_start=905, serialized_end=1267)
_COMPARISONRESULT = _descriptor.Descriptor(name='ComparisonResult', full_name='qbit.services.ComparisonResult', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.FieldDescriptor(name='similarity', full_name='qbit.services.ComparisonResult.similarity', index=4, number=5, type=1, cpp_type=5, label=1, has_default_value=False, default_value=float(0), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=1270, serialized_end=1417)
_QUBOROW = _descriptor.Descriptor(name='QuboRow', full_name='qbit.services.QuboRow', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='coefficients', full_name='qbit.services.QuboRow.coefficients', index=0, number=1, type=1, cpp_type=5, label=3, has_default_value=False, default_value=[], message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=1419, serialized_end=1450)
_QUBOMATRIX = _descriptor.Descriptor(name='QuboMatrix', full_name='qbit.services.QuboMatrix', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='rows', full_name='qbit.services.QuboMatrix.rows', index=0, number=1, type=11, cpp_type=10, label=3, has_default_value=False, default_value=[], message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='constant', full_name='qbit.services.QuboMatrix.constant', index=1, number=2, type=1, cpp_type=5, label=1, has_default_value=False, default_value=float(0), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=1452, serialized_end=1520)
_POLYNOMIALTERM = _descriptor.Descriptor(name='PolynomialTerm', full_name='qbit.services.PolynomialTerm', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='coefficient', full_name='qbit.services.PolynomialTerm.coefficient', index=0, number=1, type=1, cpp_type=5, label=1, has_default_value=False, default_value=float(0), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='variables', full_name='qbit.services.PolynomialTerm.variables', index=1, number=2, type=13, cpp_type=3, label=3, has_default_value=False, default_value=[], message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=1522, serialized_end=1578)
_BINARYPOLYNOMIAL = _descriptor.Descriptor(name='BinaryPolynomial', full_name='qbit.services.BinaryPolynomial', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.FieldDescriptor(name='constant', full_name='qbit.services.BinaryPolynomial.constant', index=1, number=2, type=1, cpp_type=5, label=1, has_default_value=False, default_value=float(0), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=1580, serialized_end=1662)
_SUBMITQUBOSTREAM = _descriptor.Descriptor(name='SubmitQuboStream', full_name='qbit.services.SubmitQuboStream', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='term', full_name='qbit.services.SubmitQuboStream.term', index=0, number=1, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='row', full_name='qbit.services.SubmitQuboStream.row', index=1, number=2, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='constant', full_name='qbit.services.SubmitQuboStream.constant', index=2, number=3, type=1, cpp_type=5, label=1, has_default_value=False, default_value=float(0), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[
 _descriptor.OneofDescriptor(name='qubo', full_name='qbit.services.SubmitQuboStream.qubo', index=0, containing_type=None, fields=[])], serialized_start=1665, serialized_end=1797)
_ARCHIVEDQUBOINFO = _descriptor.Descriptor(name='ArchivedQuboInfo', full_name='qbit.services.ArchivedQuboInfo', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='qubo_id', full_name='qbit.services.ArchivedQuboInfo.qubo_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=1799, serialized_end=1834)
_TABU1OPTSOLVER = _descriptor.Descriptor(name='Tabu1OptSolver', full_name='qbit.services.Tabu1OptSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v5', full_name='qbit.services.Tabu1OptSolver.v5', index=4, containing_type=None, fields=[])], serialized_start=1837, serialized_end=2020)
...
_MULTITABU1OPTSOLVER = _descriptor.Descriptor(name='MultiTabu1OptSolver', full_name='qbit.services.MultiTabu1OptSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v6', full_name='qbit.services.MultiTabu1OptSolver.v6', index=5, containing_type=None, fields=[])], serialized_start=2094, serialized_end=2366)
_PATHRELINKINGSOLVER = _descriptor.Descriptor(name='PathRelinkingSolver', full_name='qbit.services.PathRelinkingSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v4', full_name='qbit.services.PathRelinkingSolver.v4', index=2, containing_type=None, fields=[])], serialized_start=2369, serialized_end=2509)
_SQASOLVER = _descriptor.Descriptor(name='SQASolver', full_name='qbit.services.SQASolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v9', full_name='qbit.services.SQASolver.v9', index=7, containing_type=None, fields=[])], serialized_start=2512, serialized_end=2833)
_PTICMSOLVER = _descriptor.Descriptor(name='PTICMSolver', full_name='qbit.services.PTICMSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v25', full_name='qbit.services.PTICMSolver.v25', index=15, containing_type=None, fields=[])], serialized_start=2836, serialized_end=3579)
...
_FUJITSUDASOLVER = _descriptor.Descriptor(name='FujitsuDASolver', full_name='qbit.services.FujitsuDASolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v13', full_name='qbit.services.FujitsuDASolver.v13', index=8, containing_type=None, fields=[])], serialized_start=3582, serialized_end=4181)
...
_FUJITSUDAMIXEDMODESOLVER = _descriptor.Descriptor(name='FujitsuDAMixedModeSolver', full_name='qbit.services.FujitsuDAMixedModeSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v13', full_name='qbit.services.FujitsuDAMixedModeSolver.v13', index=8, containing_type=None, fields=[])], serialized_start=4184, serialized_end=4780)
...
_FUJITSUDAPTSOLVER = _descriptor.Descriptor(name='FujitsuDAPTSolver', full_name='qbit.services.FujitsuDAPTSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v7', full_name='qbit.services.FujitsuDAPTSolver.v7', index=3, containing_type=None, fields=[])], serialized_start=4783, serialized_end=5135)
...
_FUJITSUDA2SOLVER = _descriptor.Descriptor(name='FujitsuDA2Solver', full_name='qbit.services.FujitsuDA2Solver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v12', full_name='qbit.services.FujitsuDA2Solver.v12', index=7, containing_type=None, fields=[])], serialized_start=5138, serialized_end=5678)
_TEMPERATURELIST = _descriptor.Descriptor(name='TemperatureList', full_name='qbit.services.TemperatureList', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='temperatures', full_name='qbit.services.TemperatureList.temperatures', index=0, number=1, type=2, cpp_type=6, label=3, has_default_value=False, default_value=[], message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=5680, serialized_end=5719)
...
_FUJITSUDA2PTSOLVER = _descriptor.Descriptor(name='FujitsuDA2PTSolver', full_name='qbit.services.FujitsuDA2PTSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.FieldDescriptor(name='maximum_replica_temperature', full_name='qbit.services.FujitsuDA2PTSolver.maximum_replica_temperature', index=7, number=8, type=1, cpp_type=5, label=1, has_default_value=False, default_value=float(0), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='manual_replica_temperatures', full_name='qbit.services.FujitsuDA2PTSolver.manual_replica_temperatures', index=8, number=9, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[
 ...
 _descriptor.OneofDescriptor(name='v7', full_name='qbit.services.FujitsuDA2PTSolver.v7', index=3, containing_type=None, fields=[]),
 _descriptor.OneofDescriptor(name='v8', full_name='qbit.services.FujitsuDA2PTSolver.v8', index=4, containing_type=None, fields=[])], serialized_start=5722, serialized_end=6192)
...
_FUJITSUDA2MIXEDMODESOLVER = _descriptor.Descriptor(name='FujitsuDA2MixedModeSolver', full_name='qbit.services.FujitsuDA2MixedModeSolver', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.OneofDescriptor(name='v11', full_name='qbit.services.FujitsuDA2MixedModeSolver.v11', index=7, containing_type=None, fields=[])], serialized_start=6195, serialized_end=6732)
_SOLVEQUBOREQUEST = _descriptor.Descriptor(name='SolveQuboRequest', full_name='qbit.services.SolveQuboRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='qubo_id', full_name='qbit.services.SolveQuboRequest.qubo_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='binary_polynomial', full_name='qbit.services.SolveQuboRequest.binary_polynomial', index=1, number=2, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='qubo_matrix', full_name='qbit.services.SolveQuboRequest.qubo_matrix', index=2, number=3, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='tabu', full_name='qbit.services.SolveQuboRequest.tabu', index=3, number=4, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='pathrelinking', full_name='qbit.services.SolveQuboRequest.pathrelinking', index=4, number=5, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='pticm', full_name='qbit.services.SolveQuboRequest.pticm', index=5, number=6, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='fujitsuDA2', full_name='qbit.services.SolveQuboRequest.fujitsuDA2', index=6, number=7, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='fujitsuDA2PT', full_name='qbit.services.SolveQuboRequest.fujitsuDA2PT', index=7, number=8, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 ...
 _descriptor.OneofDescriptor(name='qubo', full_name='qbit.services.SolveQuboRequest.qubo', index=0, containing_type=None, fields=[]),
 _descriptor.OneofDescriptor(name='solver', full_name='qbit.services.SolveQuboRequest.solver', index=1, containing_type=None, fields=[])], serialized_start=6735, serialized_end=7242)
...
_QUBOSOLUTION = _descriptor.Descriptor(name='QuboSolution', full_name='qbit.services.QuboSolution', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _QUBOSOLUTION_CONFIGURATIONENTRY], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=7245, serialized_end=7419)
...
_SOLVERTIMING = _descriptor.Descriptor(name='SolverTiming', full_name='qbit.services.SolverTiming', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _SOLVERTIMING_DETAILEDENTRY], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=7422, serialized_end=7632)
...
_QUBORESPONSE = _descriptor.Descriptor(name='QuboResponse', full_name='qbit.services.QuboResponse', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 ...
 _descriptor.FieldDescriptor(name='archived_qubo', full_name='qbit.services.QuboResponse.archived_qubo', index=2, number=3, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[
 ...
 _descriptor.OneofDescriptor(name='response', full_name='qbit.services.QuboResponse.response', index=0, containing_type=None, fields=[])], serialized_start=7772, serialized_end=8063)
_HEALTHCHECKREQUEST = _descriptor.Descriptor(name='HealthCheckRequest', full_name='qbit.services.HealthCheckRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=8065, serialized_end=8085)
_VERSIONREQUEST = _descriptor.Descriptor(name='VersionRequest', full_name='qbit.services.VersionRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=8087, serialized_end=8103)
_VERSIONRESPONSE = _descriptor.Descriptor(name='VersionResponse', full_name='qbit.services.VersionResponse', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='version', full_name='qbit.services.VersionResponse.version', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=8105, serialized_end=8139)
_SUBMITQUBORESPONSE = _descriptor.Descriptor(name='SubmitQuboResponse', full_name='qbit.services.SubmitQuboResponse', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='request_id', full_name='qbit.services.SubmitQuboResponse.request_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=8141, serialized_end=8181)
_QUBOSOLUTIONREQUEST = _descriptor.Descriptor(name='QuboSolutionRequest', full_name='qbit.services.QuboSolutionRequest', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='request_id', full_name='qbit.services.QuboSolutionRequest.request_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[], serialized_start=8183, serialized_end=8224)
_QUBOSOLUTIONRESPONSE = _descriptor.Descriptor(name='QuboSolutionResponse', full_name='qbit.services.QuboSolutionResponse', filename=None, file=DESCRIPTOR, containing_type=None, fields=[
 _descriptor.FieldDescriptor(name='request_id', full_name='qbit.services.QuboSolutionResponse.request_id', index=0, number=1, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='solver', full_name='qbit.services.QuboSolutionResponse.solver', index=1, number=2, type=9, cpp_type=9, label=1, has_default_value=False, default_value=_b('').decode('utf-8'), message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='status', full_name='qbit.services.QuboSolutionResponse.status', index=2, number=3, type=14, cpp_type=8, label=1, has_default_value=False, default_value=0, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='response', full_name='qbit.services.QuboSolutionResponse.response', index=3, number=4, type=11, cpp_type=10, label=1, has_default_value=False, default_value=None, message_type=None, enum_type=None, containing_type=None, is_extension=False, extension_scope=None, serialized_options=None, file=DESCRIPTOR)], extensions=[], nested_types=[], enum_types=[
 _QUBOSOLUTIONRESPONSE_QUBO_STATUS], serialized_options=None, is_extendable=False, syntax='proto3', extension_ranges=[], oneofs=[
 _descriptor.OneofDescriptor(name='result', full_name='qbit.services.QuboSolutionResponse.result', index=0, containing_type=None, fields=[])], serialized_start=8227, serialized_end=8505)
...
_SUBMITQUBOSTREAM.oneofs_by_name['qubo'].fields.append(_SUBMITQUBOSTREAM.fields_by_name['term'])
_SUBMITQUBOSTREAM.fields_by_name['term'].containing_oneof = _SUBMITQUBOSTREAM.oneofs_by_name['qubo']
_SUBMITQUBOSTREAM.oneofs_by_name['qubo'].fields.append(_SUBMITQUBOSTREAM.fields_by_name['row'])
_SUBMITQUBOSTREAM.fields_by_name['row'].containing_oneof = _SUBMITQUBOSTREAM.oneofs_by_name['qubo']
_SUBMITQUBOSTREAM.oneofs_by_name['qubo'].fields.append(_SUBMITQUBOSTREAM.fields_by_name['constant'])
...
_FUJITSUDA2PTSOLVER.oneofs_by_name['v8'].fields.append(_FUJITSUDA2PTSOLVER.fields_by_name['maximum_replica_temperature'])
_FUJITSUDA2PTSOLVER.fields_by_name['maximum_replica_temperature'].containing_oneof = _FUJITSUDA2PTSOLVER.oneofs_by_name['v8']
_FUJITSUDA2PTSOLVER.oneofs_by_name['v8'].fields.append(_FUJITSUDA2PTSOLVER.fields_by_name['manual_replica_temperatures'])
...
_SOLVEQUBOREQUEST.oneofs_by_name['qubo'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['qubo_id'])
_SOLVEQUBOREQUEST.fields_by_name['qubo_id'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['qubo']
_SOLVEQUBOREQUEST.oneofs_by_name['qubo'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['binary_polynomial'])
_SOLVEQUBOREQUEST.fields_by_name['binary_polynomial'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['qubo']
_SOLVEQUBOREQUEST.oneofs_by_name['qubo'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['qubo_matrix'])
_SOLVEQUBOREQUEST.fields_by_name['qubo_matrix'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['qubo']
_SOLVEQUBOREQUEST.oneofs_by_name['solver'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['tabu'])
_SOLVEQUBOREQUEST.fields_by_name['tabu'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['solver']
_SOLVEQUBOREQUEST.oneofs_by_name['solver'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['pathrelinking'])
_SOLVEQUBOREQUEST.fields_by_name['pathrelinking'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['solver']
_SOLVEQUBOREQUEST.oneofs_by_name['solver'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['pticm'])
_SOLVEQUBOREQUEST.fields_by_name['pticm'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['solver']
_SOLVEQUBOREQUEST.oneofs_by_name['solver'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['fujitsuDA2'])
_SOLVEQUBOREQUEST.fields_by_name['fujitsuDA2'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['solver']
_SOLVEQUBOREQUEST.oneofs_by_name['solver'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['fujitsuDA2PT'])
_SOLVEQUBOREQUEST.fields_by_name['fujitsuDA2PT'].containing_oneof = _SOLVEQUBOREQUEST.oneofs_by_name['solver']
_SOLVEQUBOREQUEST.oneofs_by_name['solver'].fields.append(_SOLVEQUBOREQUEST.fields_by_name['fujitsuDA2MixedMode'])
...
_QUBOSOLUTIONRESPONSE.oneofs_by_name['result'].fields.append(_QUBOSOLUTIONRESPONSE.fields_by_name['response'])
...
AzureCreateJobRequest = _reflection.GeneratedProtocolMessageType('AzureCreateJobRequest', (_message.Message,), {'InputParamsEntry': _reflection.GeneratedProtocolMessageType('InputParamsEntry', (_message.Message,), {'DESCRIPTOR': _AZURECREATEJOBREQUEST_INPUTPARAMSENTRY, 
                        '__module__': 'qbit_pb2'}), 
...
AzureGetJobRequest = _reflection.GeneratedProtocolMessageType('AzureGetJobRequest', (_message.Message,), {'DESCRIPTOR': _AZUREGETJOBREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(AzureGetJobRequest)
AzureCancelJobRequest = _reflection.GeneratedProtocolMessageType('AzureCancelJobRequest', (_message.Message,), {'DESCRIPTOR': _AZURECANCELJOBREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(AzureCancelJobRequest)
AzureJobResponse = _reflection.GeneratedProtocolMessageType('AzureJobResponse', (_message.Message,), {'DESCRIPTOR': _AZUREJOBRESPONSE, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(AzureJobResponse)
CompareRequest = _reflection.GeneratedProtocolMessageType('CompareRequest', (_message.Message,), {'DESCRIPTOR': _COMPAREREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(CompareRequest)
ComparisonResult = _reflection.GeneratedProtocolMessageType('ComparisonResult', (_message.Message,), {'DESCRIPTOR': _COMPARISONRESULT, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(ComparisonResult)
QuboRow = _reflection.GeneratedProtocolMessageType('QuboRow', (_message.Message,), {'DESCRIPTOR': _QUBOROW, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(QuboRow)
QuboMatrix = _reflection.GeneratedProtocolMessageType('QuboMatrix', (_message.Message,), {'DESCRIPTOR': _QUBOMATRIX, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(QuboMatrix)
PolynomialTerm = _reflection.GeneratedProtocolMessageType('PolynomialTerm', (_message.Message,), {'DESCRIPTOR': _POLYNOMIALTERM, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(PolynomialTerm)
BinaryPolynomial = _reflection.GeneratedProtocolMessageType('BinaryPolynomial', (_message.Message,), {'DESCRIPTOR': _BINARYPOLYNOMIAL, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(BinaryPolynomial)
SubmitQuboStream = _reflection.GeneratedProtocolMessageType('SubmitQuboStream', (_message.Message,), {'DESCRIPTOR': _SUBMITQUBOSTREAM, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(SubmitQuboStream)
ArchivedQuboInfo = _reflection.GeneratedProtocolMessageType('ArchivedQuboInfo', (_message.Message,), {'DESCRIPTOR': _ARCHIVEDQUBOINFO, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(ArchivedQuboInfo)
Tabu1OptSolver = _reflection.GeneratedProtocolMessageType('Tabu1OptSolver', (_message.Message,), {'DESCRIPTOR': _TABU1OPTSOLVER, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(Tabu1OptSolver)
TabuSolverList = _reflection.GeneratedProtocolMessageType('TabuSolverList', (_message.Message,), {'DESCRIPTOR': _TABUSOLVERLIST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(TabuSolverList)
MultiTabu1OptSolver = _reflection.GeneratedProtocolMessageType('MultiTabu1OptSolver', (_message.Message,), {'DESCRIPTOR': _MULTITABU1OPTSOLVER, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(MultiTabu1OptSolver)
PathRelinkingSolver = _reflection.GeneratedProtocolMessageType('PathRelinkingSolver', (_message.Message,), {'DESCRIPTOR': _PATHRELINKINGSOLVER, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(PathRelinkingSolver)
SQASolver = _reflection.GeneratedProtocolMessageType('SQASolver', (_message.Message,), {'DESCRIPTOR': _SQASOLVER, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(SQASolver)
PTICMSolver = _reflection.GeneratedProtocolMessageType('PTICMSolver', (_message.Message,), {'DESCRIPTOR': _PTICMSOLVER, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(PTICMSolver)
FujitsuDASolver = _reflection.GeneratedProtocolMessageType('FujitsuDASolver', (_message.Message,), {'GuidanceConfigEntry': _reflection.GeneratedProtocolMessageType('GuidanceConfigEntry', (_message.Message,), {'DESCRIPTOR': _FUJITSUDASOLVER_GUIDANCECONFIGENTRY, 
                           '__module__': 'qbit_pb2'}), 
...
FujitsuDAMixedModeSolver = _reflection.GeneratedProtocolMessageType('FujitsuDAMixedModeSolver', (_message.Message,), {'GuidanceConfigEntry': _reflection.GeneratedProtocolMessageType('GuidanceConfigEntry', (_message.Message,), {'DESCRIPTOR': _FUJITSUDAMIXEDMODESOLVER_GUIDANCECONFIGENTRY, 
                           '__module__': 'qbit_pb2'}), 
...
FujitsuDAPTSolver = _reflection.GeneratedProtocolMessageType('FujitsuDAPTSolver', (_message.Message,), {'GuidanceConfigEntry': _reflection.GeneratedProtocolMessageType('GuidanceConfigEntry', (_message.Message,), {'DESCRIPTOR': _FUJITSUDAPTSOLVER_GUIDANCECONFIGENTRY, 
                           '__module__': 'qbit_pb2'}), 
...
FujitsuDA2Solver = _reflection.GeneratedProtocolMessageType('FujitsuDA2Solver', (_message.Message,), {'GuidanceConfigEntry': _reflection.GeneratedProtocolMessageType('GuidanceConfigEntry', (_message.Message,), {'DESCRIPTOR': _FUJITSUDA2SOLVER_GUIDANCECONFIGENTRY, 
                           '__module__': 'qbit_pb2'}), 
...
TemperatureList = _reflection.GeneratedProtocolMessageType('TemperatureList', (_message.Message,), {'DESCRIPTOR': _TEMPERATURELIST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(TemperatureList)
FujitsuDA2PTSolver = _reflection.GeneratedProtocolMessageType('FujitsuDA2PTSolver', (_message.Message,), {'GuidanceConfigEntry': _reflection.GeneratedProtocolMessageType('GuidanceConfigEntry', (_message.Message,), {'DESCRIPTOR': _FUJITSUDA2PTSOLVER_GUIDANCECONFIGENTRY, 
                           '__module__': 'qbit_pb2'}), 
...
FujitsuDA2MixedModeSolver = _reflection.GeneratedProtocolMessageType('FujitsuDA2MixedModeSolver', (_message.Message,), {'GuidanceConfigEntry': _reflection.GeneratedProtocolMessageType('GuidanceConfigEntry', (_message.Message,), {'DESCRIPTOR': _FUJITSUDA2MIXEDMODESOLVER_GUIDANCECONFIGENTRY, 
                           '__module__': 'qbit_pb2'}), 
...
SolveQuboRequest = _reflection.GeneratedProtocolMessageType('SolveQuboRequest', (_message.Message,), {'DESCRIPTOR': _SOLVEQUBOREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(SolveQuboRequest)
QuboSolution = _reflection.GeneratedProtocolMessageType('QuboSolution', (_message.Message,), {'ConfigurationEntry': _reflection.GeneratedProtocolMessageType('ConfigurationEntry', (_message.Message,), {'DESCRIPTOR': _QUBOSOLUTION_CONFIGURATIONENTRY, 
                          '__module__': 'qbit_pb2'}), 
   'DESCRIPTOR': _QUBOSOLUTION, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(QuboSolution)
_sym_db.RegisterMessage(QuboSolution.ConfigurationEntry)
SolverTiming = _reflection.GeneratedProtocolMessageType('SolverTiming', (_message.Message,), {'DetailedEntry': _reflection.GeneratedProtocolMessageType('DetailedEntry', (_message.Message,), {'DESCRIPTOR': _SOLVERTIMING_DETAILEDENTRY, 
                     '__module__': 'qbit_pb2'}), 
   'DESCRIPTOR': _SOLVERTIMING, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(SolverTiming)
_sym_db.RegisterMessage(SolverTiming.DetailedEntry)
QuboSolutionList = _reflection.GeneratedProtocolMessageType('QuboSolutionList', (_message.Message,), {'DESCRIPTOR': _QUBOSOLUTIONLIST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(QuboSolutionList)
QuboResponse = _reflection.GeneratedProtocolMessageType('QuboResponse', (_message.Message,), {'SolverInputParametersEntry': _reflection.GeneratedProtocolMessageType('SolverInputParametersEntry', (_message.Message,), {'DESCRIPTOR': _QUBORESPONSE_SOLVERINPUTPARAMETERSENTRY, 
                                  '__module__': 'qbit_pb2'}), 
...
HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), {'DESCRIPTOR': _HEALTHCHECKREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(HealthCheckRequest)
VersionRequest = _reflection.GeneratedProtocolMessageType('VersionRequest', (_message.Message,), {'DESCRIPTOR': _VERSIONREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(VersionRequest)
VersionResponse = _reflection.GeneratedProtocolMessageType('VersionResponse', (_message.Message,), {'DESCRIPTOR': _VERSIONRESPONSE, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(VersionResponse)
SubmitQuboResponse = _reflection.GeneratedProtocolMessageType('SubmitQuboResponse', (_message.Message,), {'DESCRIPTOR': _SUBMITQUBORESPONSE, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(SubmitQuboResponse)
QuboSolutionRequest = _reflection.GeneratedProtocolMessageType('QuboSolutionRequest', (_message.Message,), {'DESCRIPTOR': _QUBOSOLUTIONREQUEST, 
   '__module__': 'qbit_pb2'})
_sym_db.RegisterMessage(QuboSolutionRequest)
QuboSolutionResponse = _reflection.GeneratedProtocolMessageType('QuboSolutionResponse', (_message.Message,), {'DESCRIPTOR': _QUBOSOLUTIONRESPONSE, 
   '__module__': 'qbit_pb2'})
...
_QBIT = _descriptor.ServiceDescriptor(name='Qbit', full_name='qbit.services.Qbit', file=DESCRIPTOR, index=0, serialized_options=None, serialized_start=8947, serialized_end=11754, methods=[
 ...
 _descriptor.MethodDescriptor(name='SolveQubo', full_name='qbit.services.Qbit.SolveQubo', index=3, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_QUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x13"\x0e/v2/qubo/solve:\x01*')),
 _descriptor.MethodDescriptor(name='SolveQuboFujitsuDA2', full_name='qbit.services.Qbit.SolveQuboFujitsuDA2', index=4, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_QUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x1e"\x19/v2/qubo/solve/fujitsuda2:\x01*')),
 _descriptor.MethodDescriptor(name='SolveQuboFujitsuDA2PT', full_name='qbit.services.Qbit.SolveQuboFujitsuDA2PT', index=5, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_QUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02 "\x1b/v2/qubo/solve/fujitsuda2pt:\x01*')),
 _descriptor.MethodDescriptor(name='HealthCheck', full_name='qbit.services.Qbit.HealthCheck', index=6, containing_service=None, input_type=_HEALTHCHECKREQUEST, output_type=google_dot_protobuf_dot_empty__pb2._EMPTY, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/healthcheck')),
 _descriptor.MethodDescriptor(name='AuthCheck', full_name='qbit.services.Qbit.AuthCheck', index=7, containing_service=None, input_type=_HEALTHCHECKREQUEST, output_type=google_dot_protobuf_dot_empty__pb2._EMPTY, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/authcheck')),
 _descriptor.MethodDescriptor(name='Version', full_name='qbit.services.Qbit.Version', index=8, containing_service=None, input_type=_VERSIONREQUEST, output_type=_VERSIONRESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\r\x12\x0b/v2/version')),
 _descriptor.MethodDescriptor(name='SubmitSolveQuboTabu', full_name='qbit.services.Qbit.SubmitSolveQuboTabu', index=9, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_SUBMITQUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x19"\x14/v2/qubo/submit/tabu:\x01*')),
 _descriptor.MethodDescriptor(name='SubmitSolveQuboMultiTabu', full_name='qbit.services.Qbit.SubmitSolveQuboMultiTabu', index=10, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_SUBMITQUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x1e"\x19/v2/qubo/submit/multitabu:\x01*')),
 _descriptor.MethodDescriptor(name='SubmitSolveQuboPTICM', full_name='qbit.services.Qbit.SubmitSolveQuboPTICM', index=11, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_SUBMITQUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x1a"\x15/v2/qubo/submit/pticm:\x01*')),
 _descriptor.MethodDescriptor(name='SubmitSolveQuboPathRelinking', full_name='qbit.services.Qbit.SubmitSolveQuboPathRelinking', index=12, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_SUBMITQUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02""\x1d/v2/qubo/submit/pathrelinking:\x01*')),
 _descriptor.MethodDescriptor(name='SubmitSolveQuboFujitsuDA2', full_name='qbit.services.Qbit.SubmitSolveQuboFujitsuDA2', index=13, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_SUBMITQUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x1f"\x1a/v2/qubo/submit/fujitsuda2:\x01*')),
 _descriptor.MethodDescriptor(name='SubmitSolveQuboFujitsuDA2PT', full_name='qbit.services.Qbit.SubmitSolveQuboFujitsuDA2PT', index=14, containing_service=None, input_type=_SOLVEQUBOREQUEST, output_type=_SUBMITQUBORESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02!"\x1c/v2/qubo/submit/fujitsuda2pt:\x01*')),
 _descriptor.MethodDescriptor(name='GetQuboSolution', full_name='qbit.services.Qbit.GetQuboSolution', index=15, containing_service=None, input_type=_QUBOSOLUTIONREQUEST, output_type=_QUBOSOLUTIONRESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02%\x12#/v2/qubo/submit/result/{request_id}')),
 _descriptor.MethodDescriptor(name='SubmitQubo', full_name='qbit.services.Qbit.SubmitQubo', index=16, containing_service=None, input_type=_SUBMITQUBOSTREAM, output_type=_ARCHIVEDQUBOINFO, serialized_options=None),
 _descriptor.MethodDescriptor(name='AzureQuantumCreateJob', full_name='qbit.services.Qbit.AzureQuantumCreateJob', index=17, containing_service=None, input_type=_AZURECREATEJOBREQUEST, output_type=_AZUREJOBRESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x9f\x01\x1a\x99\x01/v1/subscriptions/{customer_subscription_id}/resourceGroups/{customer_resource_group}/providers/Microsoft.Solutions/applications/{app_name}/jobs/{job_id}:\x01*')),
 _descriptor.MethodDescriptor(name='AzureQuantumGetJob', full_name='qbit.services.Qbit.AzureQuantumGetJob', index=18, containing_service=None, input_type=_AZUREGETJOBREQUEST, output_type=_AZUREJOBRESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x9c\x01\x12\x99\x01/v1/subscriptions/{customer_subscription_id}/resourceGroups/{customer_resource_group}/providers/Microsoft.Solutions/applications/{app_name}/jobs/{job_id}')),
 _descriptor.MethodDescriptor(name='AzureQuantumCancelJob', full_name='qbit.services.Qbit.AzureQuantumCancelJob', index=19, containing_service=None, input_type=_AZURECANCELJOBREQUEST, output_type=_AZUREJOBRESPONSE, serialized_options=_b(b'\x82\xd3\xe4\x93\x02\x9c\x01*\x99\x01/v1/subscriptions/{customer_subscription_id}/resourceGroups/{customer_resource_group}/providers/Microsoft.Solutions/applications/{app_name}/jobs/{job_id}'))])
