...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\briefcase\migrations\0006_auto__chg_field_document_type.py
# Compiled at: 2010-10-13 13:44:27
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'briefcase.document': {'Meta': {'ordering': "['-added_at']", 'object_name': 'Document'}, 'added_at': (
                              ...
                              'type': (
                                     'django.db.models.fields.related.ForeignKey', [], {'to': "orm['briefcase.DocumentType']"}), 
                              'updated_at': (
       ...
       'briefcase.documenttype': {'Meta': {'ordering': "['name']", 'object_name': 'DocumentType'}, 'id': (
                                       'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                  'mimetype': (
