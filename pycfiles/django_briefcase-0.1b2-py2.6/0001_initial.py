...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\briefcase\migrations\0001_initial.py
# Compiled at: 2010-10-13 12:02:28
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('briefcase_documentstatus', (
         (
        ...
        db.send_create_signal('briefcase', ['DocumentStatus'])
        db.create_table('briefcase_document', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
         (
          'status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['briefcase.DocumentStatus'], null=True, blank=True)),
         (
        ...
        db.send_create_signal('briefcase', ['Document'])

    def backwards(self, orm):
        db.delete_table('briefcase_documentstatus')
        db.delete_table('briefcase_document')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'briefcase.document': {'Meta': {'object_name': 'Document'}, 'added_at': (
