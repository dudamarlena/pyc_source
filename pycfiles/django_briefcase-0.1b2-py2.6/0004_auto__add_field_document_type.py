...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\briefcase\migrations\0004_auto__add_field_document_type.py
# Compiled at: 2010-10-13 13:19:52
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('briefcase_document', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['briefcase.DocumentType'], null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('briefcase_document', 'type_id')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'briefcase.document': {'Meta': {'ordering': "['-added_at']", 'object_name': 'Document'}, 'added_at': (
                              ...
                              'type': (
                                     'django.db.models.fields.related.ForeignKey', [], {'to': "orm['briefcase.DocumentType']", 'null': 'True'}), 
                              'updated_at': (
