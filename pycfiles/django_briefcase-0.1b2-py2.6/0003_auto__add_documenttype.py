...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\briefcase\migrations\0003_auto__add_documenttype.py
# Compiled at: 2010-10-13 13:11:30
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('briefcase_documenttype', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'mimetype', self.gf('django.db.models.fields.CharField')(default='application/octet-stream', max_length=127)),
         (
          'name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True))))
        db.send_create_signal('briefcase', ['DocumentType'])

    def backwards(self, orm):
        db.delete_table('briefcase_documenttype')
