...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trytond/modules/lims_instrument_generic_service/tests/test_lims.py
...
class LimsTestCase(ModuleTestCase):
    __doc__ = 'Test lims_instrument_generic_service module'
