...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trytond/modules/lims_account_invoice/tests/test_lims_account_invoice.py
...
class LimsTestCase(ModuleTestCase):
    __doc__ = 'Test lims_account_invoice module'
    module = 'lims_account_invoice'
