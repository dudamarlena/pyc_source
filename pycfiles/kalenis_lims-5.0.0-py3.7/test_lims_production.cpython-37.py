...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trytond/modules/lims_production/tests/test_lims_production.py
...
class LimsTestCase(ModuleTestCase):
    __doc__ = 'Test lims_production module'
    module = 'lims_production'
