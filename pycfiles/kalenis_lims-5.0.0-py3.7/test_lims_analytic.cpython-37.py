...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trytond/modules/lims_analytic/tests/test_lims_analytic.py
...
class LimsTestCase(ModuleTestCase):
    __doc__ = 'Test lims_analytic module'
    module = 'lims_analytic'
