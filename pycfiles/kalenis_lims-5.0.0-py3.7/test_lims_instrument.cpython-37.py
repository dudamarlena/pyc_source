...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trytond/modules/lims_instrument_custom_set/tests/test_lims_instrument.py
...
class LimsTestCase(ModuleTestCase):
    __doc__ = 'Test lims_instrument_custom_set module'
