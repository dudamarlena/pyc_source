...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/qi/LiveChat/browser/LiveChatKSS.py
...
class LiveChatKSS(KSSView):
    ...
    def ping(self, message=None):
        ...
        self._updateUsers(users)
        self._updateMessages(messages)
        self.plone.issuePortalMessage(_(''))
        return self.render()

    def _connectionError(self):
        """
                """
        self.plone.issuePortalMessage(_('Error connecting to Live Chat server.'), 'error')
        return self.render()
