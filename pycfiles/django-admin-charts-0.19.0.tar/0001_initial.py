...
# [GCC 8.4.0]
# Embedded file name: /home/petr/.local/share/virtualenvs/blenderhub_server-izvs0qj4/src/django-admin-charts/admin_tools_stats/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.AddField(model_name=b'dashboardstats', name=b'criteria', field=models.ManyToManyField(blank=True, to=b'admin_tools_stats.DashboardStatsCriteria'))]