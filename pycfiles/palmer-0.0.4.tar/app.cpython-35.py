...
# [GCC 8.4.0]
# Embedded file name: /Users/loup/Workspace/Projects/personal/palmer/palmer/app.py
# Compiled at: 2016-11-16 03:38:13
...
class Palmer(Flask):
    ...
    def handle_user_exception(self, e):
        ...
        if is_flask_legacy():
            ...
            for typecheck, handler in chain(dict(blueprint_handlers).items(), dict(app_handlers).items()):
                if isinstance(e, typecheck):
                    return handler(e)
    ...
    def handle_api_exception(self, exc):
        return self.response_class(dict(message=exc.message, errors=exc.errors, code=exc.__class__.__name__), status=exc.status_code)