...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gnucash_importer/account.py
# Compiled at: 2018-11-28 19:46:12
# Size of source mod 2**32: 5741 bytes
...
class Account(object):
    __doc__ = 'Abstract class that define an account.'
    _acc_from = None
    _acc_to = None
...
class GenericAccount(Account):
    __doc__ = 'Implement Account and is used when no other account class is specified.'
...
class Nubank(Account):
    __doc__ = 'Implement Account for a specific high-level account: Nubank.'
...
class CashInWallet(Account):
    __doc__ = 'Implement Account for a specific high-level account: Cash in Wallet.'
...
class CefSavingsAccount(Account):
    __doc__ = 'Implement Account for a specific high-level account: CEF Savings Account.'
...
class ItauCheckingAccount(Account):
    __doc__ = 'Implement Account for a specific high-level account: ITAU Checking Account.'
...
class ItauSavingsAccount(Account):
    __doc__ = 'Implement Account for a specific high-level account: ITAU Savings Account.'
...
class BradescoSavingsAccount(Account):
    __doc__ = 'Implement Account for a specific high-level account: BRADESCO Savings Account.'
