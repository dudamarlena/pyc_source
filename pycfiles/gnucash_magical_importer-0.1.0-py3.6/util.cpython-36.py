...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gnucash_importer/util.py
# Compiled at: 2018-12-21 23:37:25
...
class Util:
    __doc__ = 'Helper class used to provide configuration, defaults and so on.'
