...
# [GCC 8.4.0]
# Embedded file name: \Python27\Lib\site-packages\milight\__init__.py
# Compiled at: 2015-03-19 21:46:02
...
class LightBulb:
    ...
    def wait(self, sec=0.1):
        ...
        for i in range(0, reps):
            commands.append(Command(0, wait=True))
...
class Command:
    ...
    def __init__(self, b1, b2=0, wait=False, repeat=1):
        self._b1 = b1
        self._b2 = b2
        self._wait = wait
    ...
    def message(self):
        return bytearray([self._b1, self._b2, 85])
