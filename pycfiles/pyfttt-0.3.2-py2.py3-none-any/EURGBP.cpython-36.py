...
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/data/EURGBP.py
...
def get_dataframe():
    ...
    """
    df = common.get_dataframe('EURGBP.csv', 'https://query.data.world/s/gvsaeruthnxjkwzl7z4ki7u5rduah3', sep=',')
    return df