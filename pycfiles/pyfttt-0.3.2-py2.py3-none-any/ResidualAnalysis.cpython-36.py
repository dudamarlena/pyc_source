...
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyFTS/benchmarks/ResidualAnalysis.py
# Compiled at: 2018-08-30 00:51:52
# Size of source mod 2**32: 4104 bytes
__doc__ = 'Residual Analysis methods'
import numpy as np, pandas as pd, matplotlib as plt, matplotlib.pyplot as plt
...
def compare_residuals(data, models):
    ...
    rows = []
    columns = [
     'Model', 'Order', 'AVG', 'STD', 'Box-Ljung', 'p-value']
    for mfts in models:
...
def plotResiduals(targets, models, tam=[
 8, 8], save=False, file=None):
    """
...
def single_plot_residuals(targets, forecasts, order, tam=[
 8, 8], save=False, file=None):
