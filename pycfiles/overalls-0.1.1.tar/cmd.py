...
# [GCC 8.4.0]
# Embedded file name: /home/simon/projects/repos-mine/overalls/overalls/cmd.py
# Compiled at: 2013-10-16 11:58:35
import logging, sys
...
class OverallsUploader(object):
    ...
    def create_parser(self):
        parser = ArgumentParser(version=__version__, description='Upload coverage results to coveralls.io')
