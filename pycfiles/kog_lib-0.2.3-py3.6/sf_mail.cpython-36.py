...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\kog_lib\mail\sf_mail.py
...
class Server:
    ...
    def __init__(self, host: str=None, sender: str=None, password: str=None, username: str=None, port: int=25, **para_d):
        """
        ...
        self.username = username if username else para_d.get('username') if para_d.get('username') else sender.split('@')[0]
    ...
    def _send_mail(self, to, subject=None, content=None, cc=None, a=None, email_subtype='mixed', text_subtype='plain', **kwargs):
