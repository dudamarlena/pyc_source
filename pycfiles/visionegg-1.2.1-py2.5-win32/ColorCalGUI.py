...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\VisionEgg\PyroApps\ColorCalGUI.py
...
def get_control_list():
    return [
     (
      'color_cal_server', ColorCalControlFrame, ColorCalControlFrame.title)]
...
class ColorCalControlFrame(client_utils.StimulusControlFrame):
    ...
    def __init__(self, master=None, suppress_go_buttons=0, **kw):
        client_utils.StimulusControlFrame.__init__(self, master, suppress_go_buttons, ColorCalControlFrame.title, ColorCalMetaParameters, **kw)
