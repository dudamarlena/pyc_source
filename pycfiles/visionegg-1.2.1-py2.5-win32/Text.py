...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\VisionEgg\Text.py
# Compiled at: 2009-07-07 11:29:42
"""
Text stimuli.

"""
import logging, logging.handlers, VisionEgg.Core, VisionEgg.Textures, VisionEgg.ParameterTypes as ve_types, VisionEgg.GL as gl, pygame
try:
...
class Text(VisionEgg.Textures.TextureStimulus):
    ...
    def _render_text(self):
        p = self.parameters
        rendered_surf = self.font.render(p.text, 1, (255, 255, 255))
    ...
    def draw(self):
        ...
        if p.ignore_size_parameter:
            p.size = p.texture.size
        VisionEgg.Textures.TextureStimulus.draw(self)
    ...
    class GlutTextBase(VisionEgg.Core.Stimulus):
        ...
        def __init__(self, **kw):
            if not hasattr(VisionEgg.config, '_GAVE_GLUT_TEXT_DEPRECATION'):
                ...
                logger.warning('Using GlutTextBase class.  This will be removed in a future release. Use VisionEgg.Text.Text instead.')
