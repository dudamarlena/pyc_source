...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\VisionEgg\PyroApps\FlatGratingGUI.py
...
def get_control_list():
    return [
     (
      'flat_grating_server', FlatGratingControlFrame, FlatGratingControlFrame.title)]
...
class FlatGratingControlFrame(client_utils.StimulusControlFrame):
    ...
    def __init__(self, master=None, suppress_go_buttons=0, **kw):
        client_utils.StimulusControlFrame.__init__(self, master, suppress_go_buttons, FlatGratingControlFrame.title, FlatGratingMetaParameters, **kw)
