...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\VisionEgg\qtmovie.py
# Compiled at: 2009-07-07 11:29:44
"""high level QuickTime Movie wrapper"""
import qtlowlevel, ctypes
...
def new_movie_from_filename(filename, MAX_PATH=255):
    ...
    movieFilePathRef.value = qtlowlevel.CFStringCreateWithCharacters(qtlowlevel.kCFAllocatorDefault, filename, len(filename))
    moviePropCount = 0
...
class Movie:
    ...
    def GetMovieBox(self):
        ...
        return Rect(top=movieBounds.top, left=movieBounds.left, bottom=movieBounds.bottom, right=movieBounds.right)
