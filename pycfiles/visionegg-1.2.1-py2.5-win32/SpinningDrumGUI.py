...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\VisionEgg\PyroApps\SpinningDrumGUI.py
...
def get_control_list():
    return [
     (
      'spinning_drum_server', SpinningDrumControlFrame, SpinningDrumControlFrame.title)]
...
class SpinningDrumControlFrame(client_utils.StimulusControlFrame):
    ...
    def __init__(self, master=None, suppress_go_buttons=0, **kw):
        client_utils.StimulusControlFrame.__init__(self, master, suppress_go_buttons, SpinningDrumControlFrame.title, SpinningDrumMetaParameters, **kw)
