...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\VisionEgg\PyroApps\MouseTargetGUI.py
...
def get_control_list():
    return [
     (
      'mouse_target_server', MouseTargetControlFrame, MouseTargetControlFrame.title)]
...
class MouseTargetControlFrame(client_utils.StimulusControlFrame):
    ...
    def __init__(self, master=None, suppress_go_buttons=0, **kw):
        client_utils.StimulusControlFrame.__init__(self, master, suppress_go_buttons, MouseTargetControlFrame.title, MouseTargetMetaParameters, **kw)
