...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/dbsprockets/primitives.py
# Compiled at: 2008-06-30 11:50:29
"""
primitives Module
...
class SprocketGenerator(DatabaseMixin):
    ...
    def makeForm(self, model, action, identifier='', controller='/', hiddenFields=None, disabledFields=None, requiredFields=None, omittedFields=None, additionalFields=None, limitFields=None, fieldAttrs=None, widgets=None, validators=None, formWidgetType=None, formValidator=None, checkIfUnique=False):
        """
        makeForm(model,
                 action,
                 identifier='',
        ...
        view = self.makeView(EditableRecordViewConfig, model, action, identifier, '', hiddenFields, disabledFields, requiredFields, omittedFields, additionalFields, limitFields, fieldAttrs, widgets, validators, formWidgetType, formValidator, checkIfUnique)
        return view.widget

    def makeRecordView(self, model, controller='', omittedFields=None, additionalFields=None, limitFields=None, fieldAttrs=None, widgets=None, validators=None, formWidgetType=None):
        """
        ...
        if not isinstance(fieldAttrs, types.DictType):
            raise TypeError('arg10(fieldAttrs) must be of type Dict, not %s' % type(limitFields))
        self._validateModel(model)
        view = self.makeView(RecordViewConfig, model, '', '', controller, omittedFields=omittedFields, additionalFields=additionalFields, limitFields=limitFields, fieldAttrs=fieldAttrs, widgets=widgets, widgetType=formWidgetType)
        return view.widget

    def makeView(self, viewConfigType, model, action='', identifier=None, controller='/', hiddenFields=None, disabledFields=None, requiredFields=None, omittedFields=None, additionalFields=None, limitFields=None, fieldAttrs=None, widgets=None, validators=None, widgetType=None, formValidator=None, checkIfUnique=False, makeLinks=None):
    ...
    def makeTable(self, model, controller=None, identifier='', omittedFields=None, additionalFields=None, limitFields=None, widgetType=None, makeLinks=None):
        """
        makeTable(model,
                 controller=None,
                 identifier='',
        ...
        view = self.makeView(TableViewConfig, model, controller=controller, omittedFields=omittedFields, additionalFields=additionalFields, widgetType=widgetType, makeLinks=makeLinks)
        return view.widget
