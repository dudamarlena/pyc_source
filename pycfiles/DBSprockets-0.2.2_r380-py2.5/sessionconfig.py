...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/dbsprockets/sessionconfig.py
        ...
        if len(rows) > 0:
            ...
            for row in rows:
                ...
                for key in row.keys():
                    ...
                    if key == 'password':
                        d[key] = '******'
                    if value is not None and key in foreignKeyDict and value in foreignKeyDict[key]:
