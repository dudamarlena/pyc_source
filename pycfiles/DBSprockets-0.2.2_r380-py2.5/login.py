...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/dbsprockets/dbmechanic/frameworks/tg2/test/TG2TestApp/tg2testapp/model/login.py
...
town_table = Table('town_table', metadata, Column('town_id', Integer, primary_key=True), Column('name', Unicode(255)))
...
class User(object):
    ...
    def __init__(self, user_name=None, password=None, email=None):
