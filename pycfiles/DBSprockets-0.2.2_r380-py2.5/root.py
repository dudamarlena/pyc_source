...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/dbsprockets/dbmechanic/frameworks/tg2/test/TG2TestApp/tg2testapp/controllers/root.py
# Compiled at: 2008-06-30 11:43:45
import pylons
...
additionalFields = [
 PasswordField('passwordVerification', label_text='Verify')]
...
registrationForm = makeForm(User, 'registration', requiredFields=requiredFields, limitFields=limitFields, additionalFields=additionalFields, formValidator=formValidator)
