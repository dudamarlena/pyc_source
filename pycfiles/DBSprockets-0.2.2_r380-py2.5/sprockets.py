...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/dbsprockets/sprockets.py
...
class Views(dict):
    ...
    defaultViewConfigs = {'databaseView': DatabaseViewConfig, 'editRecord': EditRecordViewConfig, 
...
class Sessions(dict):
    ...
    defaultSessionConfigs = {'databaseView': DatabaseSessionConfig, 'tableDef': SessionConfig, 
