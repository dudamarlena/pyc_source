...
# [GCC 8.4.0]
# Embedded file name: /Users/reg/src/nautilus/nautiluszim/entrypoint.py
# Compiled at: 2020-02-12 11:25:55
...
def main():
    ...
    parser.add_argument('--tags',
      help='List of comma-separated Tags for the ZIM file.', default='')
    ...
    parser.add_argument('--main-logo',
      help='Custom logo. Will be resized to 300x65px',
      dest='main_logo')
    parser.add_argument('--secondary-logo',
