...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/polyinterface/polylogger.py
...
class PolyLogger:
    ...
    def __init__(self):
        ...
        self.handler = log_handlers.TimedRotatingFileHandler((os.path.join(PolyLogger.LOGS_DIR, PolyLogger.LOG_FILE)),
