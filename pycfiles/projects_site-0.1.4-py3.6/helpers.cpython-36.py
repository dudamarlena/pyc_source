...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/projects/helpers.py
# Compiled at: 2020-04-23 05:23:01
...
def confirm_token(token, expiration=86400):
    ...
    try:
        data = serializer.loads(token,
          salt=(app.config['ONETIME_TOKEN_SALT']), max_age=expiration)
    except BadSignature:
        return False
    else:
        return data
