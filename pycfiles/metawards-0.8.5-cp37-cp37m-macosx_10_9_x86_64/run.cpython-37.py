...
# Size of source mod 2**32: 35527 bytes
"""
...
def parse_args():
    ...
    parser.add_argument('-m', '--model', type=str, default=None, help="Name of the input model data set for the network (default is '2011Data')")
    ...
    parser.add_argument('--max-nodes', type=int, default=16384, help='Maximum number of nodes that can be read')
    parser.add_argument('--max-links', type=int, default=4194304, help='Maximum number of links that can be read')
...
def cli():
    ...
    if args.no_profile:
        ...
        if args.profile:
            ...
            network = Network.build(params=params, calculate_distances=True, max_nodes=(args.max_nodes),
