...
# [GCC 8.4.0]
# Embedded file name: /Users/chris/GitHub/MetaWards/build/lib.macosx-10.9-x86_64-3.7/metawards/_network.py
# Compiled at: 2020-04-22 15:07:34
...
class Network:
    ...
    @staticmethod
    def build(params: Parameters, calculate_distances: bool=True, build_function=None, distance_function=None, max_nodes: int=16384, max_links: int=4194304, nthreads: int=1, profile: bool=True, profiler=None):
    ...
    def add_distances(self, distance_function=None, nthreads: int=1, profiler=None):
    ...
    def update(self, params: Parameters, nthreads: int=1, profile: bool=False):
    ...
    def run(self, population: Population, output_dir: OutputFiles, seed: int=None, nsteps: int=None, profile: bool=True, s: int=None, nthreads: int=None, iterator=None, extractor=None, profiler=None):
