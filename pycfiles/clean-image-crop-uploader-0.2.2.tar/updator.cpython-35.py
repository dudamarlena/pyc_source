...
# Embedded file name: /usr/local/lib/python3.5/dist-packages/clean/updates/updator.py
# Compiled at: 2018-03-25 11:55:29
# Size of source mod 2**32: 1781 bytes
__doc__ = 'Manage config file updating.'
import inspect
...
def _version_tuple_to_value(version_tuple):
    return 'V{}_{}_{}'.format(version_tuple[0], version_tuple[1], version_tuple[2])
...
def _get_version_classes():
    ...
    version_modules = [import_module('clean.updates.versions.' + x.stem) for x in version_files]
    version_classes = [inspect.getmembers(x, inspect.isclass)[0] for x in version_modules]
