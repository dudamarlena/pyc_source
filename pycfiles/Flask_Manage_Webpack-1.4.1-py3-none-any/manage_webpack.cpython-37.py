...
# [GCC 8.4.0]
# Embedded file name: /home/me/PycharmProjects/Flask-Manage-Webpack/flask_manage_webpack/manage_webpack.py
# Compiled at: 2019-11-18 04:55:19
...
class FlaskManageWebpack:
    ...
    def init_app(self, app):
        app.config.setdefault('MANAGE_WEBPACK_MANIFEST_PATH', os.path.join(app.static_folder, 'manifest.json'))
    ...
    def _get_webpack_assets(self, app):
        ...
        if external_manifest_url:
            ...
            try:
                ...
                raise RuntimeError('MANAGE_WEBPACK_MANIFEST_PATH requires a valid manifest json file.')
