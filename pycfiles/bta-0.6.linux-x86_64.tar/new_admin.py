...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/miners/new_admin.py
...
class NewAdmin(Miner):
    ...
    def newAdmin(self, year, month, day):
        ...
        req = {'$and': [{'objectCategory': self.categories.person}, {'whenCreated': {'$gt': start, '$lt': datetime.datetime.now()}}, {'$or': [{'name': {'$regex': '^adm', '$options': 'i'}}, {'name': {'$regex': '^svc-', '$options': 'i'}}]}, {'userAccountControl': {'$exists': 1}}]}
