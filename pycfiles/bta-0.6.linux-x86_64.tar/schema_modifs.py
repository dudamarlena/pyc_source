...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/miners/schema_modifs.py
...
class SchemaModifs(Miner):
    ...
    def extract_dates(self, doc, dn, the_node):
        ...
        for date in dates:
            ...
            modified_objects = self.datatable.find({'$and': [{'replPropertyMetaData.date': {'$in': [date]}}, {'Ancestors_col': {'$in': [the_node['DNT_col']]}}]}, {'replPropertyMetaData.date': 1, 'replPropertyMetaData.OID': 1, 
               'name': 1})
