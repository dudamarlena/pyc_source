...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/miners/SD_prop.py
...
class SDProp(Miner):
    ...
    def list(self):
        ...
        for r in self.datatable.find({'adminCount': {'$exists': True, '$ne': 0}}):
            if '1.2.840.113556.1.5.9' in r['objectClass']:
                user.append([r['cn'], 'User', r['objectSid']])
            elif '1.2.840.113556.1.5.8' in r['objectClass']:
