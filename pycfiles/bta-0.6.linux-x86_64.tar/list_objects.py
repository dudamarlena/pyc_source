...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/miners/list_objects.py
...
class ListObject(Miner):
    ...
    def select(self, year, month, day, category, year2=None, month2=None, day2=None, condition='whenCreated'):
        ...
        req = {'$and': [{'objectCategory': category}, {condition: {'$gt': start, '$lt': end}}]}
    ...
    def run(self, options, doc):
        ...
        if category < 0:
            ...
            end_date = options.end_date if options.end_date is not None else options.start_date
            if options.create:
