...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/manage.py
...
class Command(object):
    ...
    def create_arg_parser(cls):
        ...
        parser.add_argument('--backend-type', '-B', default='mongo', help='database backend', choices=bta.backend.Backend.backends.keys())
