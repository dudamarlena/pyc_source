...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/bta/tools/decoding.py
# Compiled at: 2014-07-11 17:28:38
import struct, bta.datatable
...
def decode_OID(OID_interger):
    return '%s%s' % (bta.datatable.OIDPrefix(OID_interger & 4294901760).to_json(), OID_interger & 65535)
...
def decode_ReplPropMeta(bin_data):
    ...
    for i in range(nb_of_prop):
        ...
        list_prop.append({'OID': decode_OID(oid), 'version': version, 
