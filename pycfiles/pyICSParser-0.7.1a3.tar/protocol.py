...
# Embedded file name: test/protocol.py
# Compiled at: 2014-01-17 10:41:19
import unittest
...
class ProtocolTest(unittest.TestCase):
    ...
    def test_ReadEncoder(self):
        self.t(ReadEncoder, '#010\r', '>0000001E\r', dict(addr=1, encoder=0), dict(value=30))
        self.t(ReadEncoder, '#011\r', '>0000001E\r', dict(addr=1, encoder=1), dict(value=30))
        self.t(ReadEncoder, '#012\r', '>0000001E\r', dict(addr=1, encoder=2), dict(value=30))
        self.t(ReadEncoder, '#010\r', '>0000901E\r', dict(addr=1, encoder=0), dict(value=36894))
        self.t(ReadEncoder, '#011\r', '>0000901E\r', dict(addr=1, encoder=1), dict(value=36894))
        self.t(ReadEncoder, '#012\r', '>0000901E\r', dict(addr=1, encoder=2), dict(value=36894))
    ...
    def test_ReadSyncEncoder(self):
        self.t(ReadSyncEncoder, '$01Z0\r', '>0000001E\r', dict(addr=1, encoder=0), dict(value=30))
        self.t(ReadSyncEncoder, '$01Z1\r', '>0000001E\r', dict(addr=1, encoder=1), dict(value=30))
        self.t(ReadSyncEncoder, '$01Z2\r', '>0000001E\r', dict(addr=1, encoder=2), dict(value=30))
        self.t(ReadSyncEncoder, '$01Z0\r', '>0000901E\r', dict(addr=1, encoder=0), dict(value=36894))
        self.t(ReadSyncEncoder, '$01Z1\r', '>0000901E\r', dict(addr=1, encoder=1), dict(value=36894))
        self.t(ReadSyncEncoder, '$01Z2\r', '>0000901E\r', dict(addr=1, encoder=2), dict(value=36894))

    def test_ReadPreset(self):
        self.t(ReadPreset, '@01G0\r', '!0100000000\r', dict(addr=1, encoder=0), dict(addr=1, value=0))
        self.t(ReadPreset, '@01G1\r', '!0100000000\r', dict(addr=1, encoder=1), dict(addr=1, value=0))
        self.t(ReadPreset, '@02G2\r', '!0200000800\r', dict(addr=2, encoder=2), dict(addr=2, value=2048))
        self.t(ReadPreset, '@02G2\r', '!0200000800\r', dict(addr=2, encoder=2), dict(addr=2, value=2048))
    ...
    def test_SetPreset(self):
        ...
        self.t(SetPreset, '@02P200000800\r', '!02\r', dict(addr=2, encoder=2, value=2048), dict(addr=2))
        self.t(SetPreset, '@02P200000800\r', '!02\r', dict(addr=2, encoder=2, value=2048), dict(addr=2))
