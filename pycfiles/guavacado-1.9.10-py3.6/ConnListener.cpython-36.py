...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/guavacado/ConnListener.py
# Compiled at: 2019-07-25 21:48:56
# Size of source mod 2**32: 7981 bytes
...
class ConnListener(object):
    ...
    def spawn_client_thread(self, clientsocket, address, sync=False):
        ...
        self.client_info[client_id] = {'socket':clientsocket, 
         'address':address, 
