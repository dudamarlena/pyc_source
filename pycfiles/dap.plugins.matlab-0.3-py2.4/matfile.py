...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dap/plugins/matlab/matfile.py
# Compiled at: 2006-11-01 12:56:38
...
"""
__author__ = [
 'Heiko Henkelmann <heiko@hhenkelmann.de>', 'Roberto De Almeida <rob@pydap.org>']
__version__ = (0, 1, 2)
import struct, array, cStringIO, numpy
__all__ = [
 'matStruct', 'matObject', 'matFile', 'read']
miINT8 = 1
miUINT8 = 2
miINT16 = 3
miUINT16 = 4
...
miMATRIX = 14
miNumbers = (
 miINT8, miUINT8, miINT16, miUINT16, miINT32, miUINT32, miSINGLE, miDOUBLE, miINT64, miUINT64)
miDataTypes = {miINT8: ('miINT8', 1, '1'), miUINT8: ('miUINT8', 1, '1'), miINT16: ('miINT16', 2, 's'), miUINT16: ('miUINT16', 2, 's'), miINT32: ('miINT32', 4, 'l'), miUINT32: ('miUINT32', 4, 'l'), miSINGLE: ('miSINGLE', 4, 'f'), miDOUBLE: ('miDOUBLE', 8, 'd'), miINT64: ('miINT64', 8, None), miUINT64: ('miUINT64', 8, None), miMATRIX: ('miMATRIX', 0, None)}
miDataTypesArray = {miINT8: ('miINT8', 1, 'b'), miUINT8: ('miUINT8', 1, 'B'), miINT16: ('miINT16', 2, 'h'), miUINT16: ('miUINT16', 2, 'H'), miINT32: ('miINT32', 4, 'l'), miUINT32: ('miUINT32', 4, 'L'), miSINGLE: ('miSINGLE', 4, 'f'), miDOUBLE: ('miDOUBLE', 8, 'd'), miINT64: ('miINT64', 8, None), miUINT64: ('miUINT64', 8, None), miMATRIX: ('miMATRIX', 0, None)}
mxCELL_CLASS = 1
mxSTRUCT_CLASS = 2
mxOBJECT_CLASS = 3
mxCHAR_CLASS = 4
...
mxUINT32_CLASS = 13
mxArrays = (
 mxCHAR_CLASS, mxDOUBLE_CLASS, mxSINGLE_CLASS, mxINT8_CLASS, mxUINT8_CLASS, mxINT16_CLASS, mxUINT16_CLASS, mxINT32_CLASS, mxUINT32_CLASS)
mxArrayTypes = {mxCELL_CLASS: 'mxCELL_CLASS', mxSTRUCT_CLASS: 'mxSTRUCT_CLASS', mxOBJECT_CLASS: 'mxOBJECT_CLASS', mxCHAR_CLASS: 'mxCHAR_CLASS', mxSPARSE_CLASS: 'mxSPARSE_CLASS', mxDOUBLE_CLASS: 'mxDOUBLE_CLASS', mxSINGLE_CLASS: 'mxSINGLE_CLASS', mxINT8_CLASS: 'mxINT8_CLASS', mxUINT8_CLASS: 'mxUINT8_CLASS', mxINT16_CLASS: 'mxINT16_CLASS', mxUINT16_CLASS: 'mxUINT16_CLASS', mxINT32_CLASS: 'mxINT32_CLASS', mxUINT32_CLASS: 'mxUINT32_CLASS'}
...
class matFile(object):
        ...
        if type in mxArrays:
            ...
            if type == mxCHAR_CLASS:
                ...
                if cmplx:
                    ...
                    result = result + complex(0.0, 1.0) * imag
            ...
            FieldNames = [ ('').join(x.astype('c')).strip('\x00') for x in FieldNames ]
            result = matStruct()
    ...
    def _parse_array_flags(self, strio):
        ...
        (Class_, Flags) = struct.unpack('BBxxxxxx', data)
        if Flags & 8:
            cmplx = 1
        else:
            cmplx = 0
