...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/nosenumpyseterr.py
# Compiled at: 2011-05-04 18:52:39
"""
...
class NumpySeterr(Plugin):
    ...
    """
    argnames = [
     'all', 'divide', 'over', 'under', 'invalid']

    def options(self, parser, env):
        for arg in self.argnames:
            parser.add_option('--npe-%s' % arg, type=str, default=None, metavar='HANDLE', help='handler for `numpy.seterr(%s=HANDLE)`' % arg)
