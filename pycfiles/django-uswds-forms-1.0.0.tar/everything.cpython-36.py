...
# [GCC 8.4.0]
# Embedded file name: /Users/atulvarma/Documents/18f/django-uswds-forms/example/app/examples/everything.py
...
class EverythingForm(uswds_forms.UswdsForm):
    ...
    president = forms.ChoiceField(label='Who is your favorite president?',
      widget=(uswds_forms.UswdsRadioSelect),
      help_text="If you don't see your favorite, just pick your favorite of the ones we've listed.",
      choices=(('washington', 'George Washington'), ('adams', 'John Adams'), ('jefferson', 'Thomas Jefferson')))
    park = forms.CharField(label='If you could choose the name of the next national park, what would it be?',
    ...
    trigger_non_field_error = forms.BooleanField(label='After submitting this form, trigger a non-field error.',
      required=False)
...
def view(request):
    if request.method == 'POST':
        ...
        form = EverythingForm()
    return render(request, 'examples/everything.html', {'form': form})