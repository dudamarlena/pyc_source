...
# [GCC 8.4.0]
# Embedded file name: /Users/paulmitchell-gears/git/django-rest-framework-serialization-spec/serialization_spec/serializer.py
# Compiled at: 2020-02-06 10:02:56
...
def serialize(queryset, serialization_spec):
    ...
    fields, fks, reverse_fks, reverse_m2ms, m2m_fields, fk_objects, reverse_fk_objects, reverse_m2m_objects, m2m_objects = validate_serialization_spec(model, serialization_spec)
            ...
            if extra_objects:
                for key, spec in extra_objects:
                    if extra_objects is reverse_fk_objects:
                        ...
                        if extra_objects is reverse_m2m_objects:
