...
class adv_dict(dict):
    __doc__ = ' This class expands on the dictionary class by adding the gettree class\n   method.\n   '
...
def sort2groups(array, gpat=['_R1', '_R2']):
    ...
    return (
     [sorted(m.list) for m in groups], sorted(unmatched))
