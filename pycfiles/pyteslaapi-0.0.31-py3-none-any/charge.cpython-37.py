...
# [GCC 8.4.0]
# Embedded file name: /Users/tamell/code/pyteslaapi/pyteslaapi/charge.py
# Compiled at: 2018-11-02 20:04:12
...
class Charge:
    ...
    def start_charging(self):
        return self.vehicle.send_command('charge_start')

    def open_charge_port(self):
        return self.vehicle.send_command('charge_port_door_open')

    def stop_charging(self):
        return self.vehicle.send_command('charge_stop')

    def set_charge_standard(self):
        return self.vehicle.send_command('charge_standard')

    def set_charge_max_range(self):
        return self.vehicle.send_command('charge_max_range')
    ...
    def set_charge_limit(self, percentage):
        ...
        return self.vehicle.send_command('set_charge_limit', {'limit_value': percentage})
