...
# [GCC 8.4.0]
# Embedded file name: /Users/tamell/code/pyteslaapi/pyteslaapi/climate.py
# Compiled at: 2018-11-02 20:07:22
...
class Climate:
    ...
    def start_climate(self):
        return self.vehicle.send_command('auto_conditioning_start')

    def stop_climate(self):
        return self.vehicle.send_command('auto_conditioning_stop')

    def set_temperature(self, driver_temperature, passenger_temperature=None):
        return self.vehicle.send_command('set_temps', {'driver_temp':driver_temperature, 
