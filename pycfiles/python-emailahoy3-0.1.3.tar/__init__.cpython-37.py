...
# [GCC 8.4.0]
# Embedded file name: /home/felix/Documentos/tmp/python-emailahoy/emailahoy3/__init__.py
# Compiled at: 2019-06-15 17:00:28
# Size of source mod 2**32: 7938 bytes
__version__ = '0.1.2'
import logging, os, re, sys, socket
...
DEBUG = False
__all__ = [
 'VerifyEmail', 'verify_email_address', 'query_mx']
...
class VerifyEmail(object):
    __doc__ = 'Verify if email exists'
    EMAIL_FOUND = 1
    EMAIL_NOT_FOUND = 0
    UNABLE_TO_VERIFY = -1
    ...
    def verify(self, email, from_host='example.com', from_email='verify@example.com'):
...
def verify_email_address(email, from_host='i3visio.com', from_email='verify@i3visio.com'):
