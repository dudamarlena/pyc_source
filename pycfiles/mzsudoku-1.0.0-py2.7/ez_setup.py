...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\ez_setup.py
# Compiled at: 2013-12-03 12:27:42
...
"""
import os, shutil, sys, tempfile, tarfile, optparse, subprocess
...
def use_setuptools(version=DEFAULT_VERSION, download_base=DEFAULT_URL, to_dir=os.curdir, download_delay=15):
    ...
    try:
        ...
        e = sys.exc_info()[1]
        if was_imported:
            sys.stderr.write("The required version of setuptools (>=%s) is not available,\nand can't be installed while this script is running. Please\ninstall a more recent version first, using\n'easy_install -U setuptools'.\n\n(Currently using %r)\n" % (
             version, e.args[0]))
            sys.exit(2)
        else:
            del pkg_resources
