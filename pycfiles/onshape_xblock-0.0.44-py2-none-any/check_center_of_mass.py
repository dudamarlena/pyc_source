...
# [GCC 8.4.0]
# Embedded file name: /Users/ethankeller/edx/xblock_development/onshape_xblock/onshape_xblock/checks/check_center_of_mass.py
# Compiled at: 2019-05-09 13:31:02
...
class CheckCenterOfMass(CheckBase):
    ...
    additional_form_properties = {'target_centroid': {'type': 'object', 
    ...
    def __init__(self, target_centroid=[
 0, 0, 0], tolerance=0.001, part_number=0, **kwargs):
        super(CheckCenterOfMass, self).__init__(name='Check Center of Mass', **kwargs)
    ...
    def execute_check(self):
        ...
        self.guess_centroid = [ quantify(x, default_units=u.m) for x in mass_properties.bodies['-all-'].centroid[0:3]
                              ]
        c = []
