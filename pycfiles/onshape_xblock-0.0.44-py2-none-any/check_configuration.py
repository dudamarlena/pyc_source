...
# [GCC 8.4.0]
# Embedded file name: /Users/ethankeller/edx/xblock_development/onshape_xblock/onshape_xblock/checks/check_configuration.py
# Compiled at: 2019-05-10 10:14:14
...
class CheckConfiguration(CheckBase):
    ...
    configuration_target_list_default = [{'configuration_type': 'List', 'row_count': 5}, {'configuration_type': 'Variable', 'params_count': 5}, {'configuration_type': 'Checkbox'}]
    additional_form_properties = {'config_target': {'type': 'array', 
                         'title': 'Target configuration definition', 
                         'items': {'type': 'object', 
                                   'title': 'Configuration Setting', 
                                   'properties': {'configuration_type': {'title': 'The configuration type of this setting', 
                                                                         'type': 'string', 
                                                                         'default': 'List', 
                                                                         'enum': [
                                                                                'List',
                                                                                ...
                                                                                'Checkbox'], 
                                                                         'uniqueItems': True}}, 
                                   'dependencies': {'configuration_type': {'oneOf': [
                                                                                   {'properties': {'configuration_type': {'enum': [
                                                                                                                                   'List']}, 
    ...
    map = {'BTMConfigurationParameterEnum': 'List', 'BTMConfigurationParameterQuantity': 'Variable', 
       'BTMConfigurationParameterBoolean': 'Checkbox'}

    def __init__(self, configuration_target_list=configuration_target_list_default, **kwargs):
    ...
    def check_config_var(config_target, config_actual):
        ...
        if config_target_type == 'List':
            ...
            raise TypeError('{} is not a proper configuration type. The acceptable types are List, Variable and Checkbox.')
        return result