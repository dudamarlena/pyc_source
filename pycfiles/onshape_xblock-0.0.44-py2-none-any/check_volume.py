...
# [GCC 8.4.0]
# Embedded file name: /Users/ethankeller/edx/xblock_development/onshape_xblock/onshape_xblock/checks/check_volume.py
# Compiled at: 2019-05-22 14:55:51
...
class CheckVolume(CheckBase):
    ...
    additional_form_properties = {'part_number': {'default': 0, 
    ...
    def __init__(self, min_volume=0 * u.m ** 3, max_volume=1 * u.m ** 3, part_number=0, **kwargs):
        super(CheckVolume, self).__init__(name='Check Volume', **kwargs)
