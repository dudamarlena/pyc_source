...
# [GCC 8.4.0]
# Embedded file name: /codes/tests/test_PMI_python3.py
# Compiled at: 2018-10-24 08:10:08
...
class TestPmiPython3(unittest.TestCase):
    ...
    def test_normal_fit_transform(self):
        ...
        scored_matrix = pmi_object.fit_transform(X=(self.csr_matrix_),
          n_jobs=1,
    ...
    def test_output_result_pmi(self):
        ...
        scored_matrix = pmi_object.fit_transform(X=(self.csr_matrix_),
          ...
          n_docs_distribution=(self.n_docs_distribution))
        assert isinstance(scored_matrix, csr_matrix)
        pmi_scored_dict = ScoredResultObject(scored_matrix=scored_matrix,
