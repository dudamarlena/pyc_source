...
class TestDataConverter(unittest.TestCase):
    ...
    def test_check_same_csr_matrix(self):
        ...
        """
        n_joblib_tasks = 2
        data_csr_matrix1 = data_converter.DataConverter().labeledMultiDocs2DocFreqMatrix(labeled_documents=self.input_dict, n_jobs=n_joblib_tasks)
        ...
        data_csr_matrix2 = data_converter.DataConverter().labeledMultiDocs2DocFreqMatrix(labeled_documents=self.input_dict, n_jobs=n_joblib_tasks)
        ...
        data_csr_matrix3 = data_converter.DataConverter().labeledMultiDocs2DocFreqMatrix(labeled_documents=self.input_dict, n_jobs=n_joblib_tasks)
    ...
    def test_basic_convert_data(self):
        ...
        :return:
        """
        csr_matrix_information = data_converter.DataConverter().labeledMultiDocs2DocFreqMatrix(labeled_documents=self.input_dict, n_jobs=5)
    ...
    def test_multi_process_convert_data(self):
        ...
        :return:
        """
        data_csr_object = data_converter.DataConverter().labeledMultiDocs2DocFreqMatrix(labeled_documents=self.input_dict, n_jobs=5)
    ...
    def test_complex_feature_convertion(self):
        """"""
        csr_matrix_information = data_converter.DataConverter().labeledMultiDocs2DocFreqMatrix(labeled_documents=self.input_dict_complex_feature, n_jobs=1)
        assert isinstance(csr_matrix_information, DataCsrMatrix)
        csr_matrix_ = csr_matrix_information.csr_matrix_
        label_group_dict = csr_matrix_information.label2id_dict
        vocabulary = csr_matrix_information.vocabulary
