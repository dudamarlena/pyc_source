...
# [GCC 8.4.0]
# Embedded file name: /codes/tests/test_bns_python3.py
# Compiled at: 2018-10-24 08:08:29
...
class TestBnsPython3(unittest.TestCase):
    ...
    def test_fit_transform(self):
        data_csr_matrix = data_converter.DataConverter().convert_multi_docs2document_frequency_matrix(labeled_documents=(self.correct_input),
          n_jobs=5)
        if not isinstance(data_csr_matrix, DataCsrMatrix):
        ...
        bns_scores_dict = ScoredResultObject(scored_matrix=bns_score_csr_matrix,
    ...
    def test_check_input_error(self):
        incorrect_input_dict = {'label_a':[
         ...
         'label_c':[
          [
           'aa', 'xx', 'cc']]}
        data_csr_matrix = data_converter.DataConverter().convert_multi_docs2document_frequency_matrix(labeled_documents=incorrect_input_dict,
          n_jobs=5)
    ...
    def test_bns_cython(self):
        incorrect_input_dict = {'label_a':[['I', 'aa', 'aa', 'aa', 'aa', 'aa'],
          [
           'bb', 'aa', 'aa', 'aa', 'aa', 'aa'],
          [
           'I', 'aa', 'hero', 'some', 'ok', 'aa']], 
        ...
        csr_matrix_ = data_csr_matrix.csr_matrix_
        n_docs_distribution = data_csr_matrix.n_docs_distribution
        result_bns = bns_python3.BNS().fit_transform(X=csr_matrix_, y=None,
          unit_distribution=n_docs_distribution,
          use_cython=True)
