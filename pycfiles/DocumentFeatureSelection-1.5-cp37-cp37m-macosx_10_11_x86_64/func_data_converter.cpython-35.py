...
def make_multi_docs2term_freq_info(labeled_documents: AvailableInputTypes, is_use_cache: bool=True,
...
def make_multi_docs2doc_freq_info(labeled_documents: AvailableInputTypes, n_jobs: int=-1,
