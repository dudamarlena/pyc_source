...
class DataConverter(object):
    ...
    def _DataConverter__make_feature_object2json_string(self, seq_feature_in_doc: List[Union[(str, List[str], Tuple[(str, ...)])]]) -> List[str]:
        ...
        for i, feature_object in enumerate(seq_feature_in_doc):
            if isinstance(feature_object, str):
                ...
                if isinstance(feature_object, (tuple, list)):
    ...
    def convert_multi_docs2term_frequency_matrix(self, labeled_documents: AvailableInputTypes, is_use_cache: bool=False,
    ...
    def convert_multi_docs2document_frequency_matrix(self, labeled_documents: AvailableInputTypes, is_use_cache: bool=False,
                                                     is_use_memmap: bool=False,
