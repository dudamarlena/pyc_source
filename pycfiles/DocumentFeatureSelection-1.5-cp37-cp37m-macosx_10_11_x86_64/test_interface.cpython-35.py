...
# [GCC 8.4.0]
# Embedded file name: /Users/kensuke-mi/Desktop/analysis_work/document-feature-selection/tests/test_interface.py
            ...
            for cython_flag in self.bool_cython:
                for cache_flag in self.is_use_cache:
                    for memmap_flag in self.is_use_memmap:
                        scored_result_persisted = interface.run_feature_selection(input_dict=shelve_obj, method=method_name, use_cython=cython_flag, is_use_cache=cache_flag, is_use_memmap=memmap_flag)
                        ...
                        scored_result_sqlite3_persisted = interface.run_feature_selection(input_dict=sqlite3_dict_obj, method=method_name, use_cython=cython_flag, is_use_cache=cache_flag)
                        ...
                        scored_result_dict = interface.run_feature_selection(input_dict=self.input_dict, method=method_name, use_cython=cython_flag, is_use_cache=cache_flag)
