...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rejester/tests/test_queue.py
...
def test_dump(rejester_queue):
    ...
    reserved = rejester_queue.reserve_items(item, 'b')
    assert reserved == ['b']
    rejester_queue.dump_queue('worker', 'available', 'priorities', 'expiration', 'workers', 'reservations_a', 'reservations_b', 'foo')