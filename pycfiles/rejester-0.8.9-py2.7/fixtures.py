...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rejester/tests/fixtures.py
...
"""
import getpass, hashlib, logging, os, re, socket, pytest, yaml
