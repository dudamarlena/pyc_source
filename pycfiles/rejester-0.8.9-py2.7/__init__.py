...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rejester/__init__.py
# Compiled at: 2015-07-08 07:32:10
r"""Redis-based distributed work manager.
...
from rejester.config import config_name, default_config, add_arguments, runtime_keys, discover_config, check_config
