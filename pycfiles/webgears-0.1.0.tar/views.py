...
# [GCC 8.4.0]
# Embedded file name: /Users/romanmogilatov/ets-labs/webgears/webgears/views.py
# Compiled at: 2016-02-18 03:34:56
"""Views module."""
import six
...
class View(object):
    ...
    def url_for(self, endpoint, values=None, method=None, force_external=False, append_unknown=True):
        ...
        return self.router_adapter.build(endpoint, values, method, force_external, append_unknown)
    ...
    def html(self, template, context=None):
        ...
        return Response(self.render_template(template, context), mimetype='text/html')
...
class CatalogMetaClass(catalogs.DeclarativeCatalogMetaClass):
    ...
    def __new__(mcs, class_name, bases, attributes):
        ...
        cls = catalogs.DeclarativeCatalogMetaClass.__new__(mcs, class_name, bases, attributes)
        cls.RulesMap = type('RulesMap', tuple([routing.RulesMap]), {'views_catalog': cls})
        return cls
...
__all__ = ('Request', 'Response', 'View', 'Provider', 'Catalog')