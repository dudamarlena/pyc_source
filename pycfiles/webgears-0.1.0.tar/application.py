...
# [GCC 8.4.0]
# Embedded file name: /Users/romanmogilatov/ets-labs/webgears/webgears/application.py
# Compiled at: 2016-02-28 10:31:27
"""Application module."""
import os, jinja2, logging, yaml
...
class Application(object):
    ...
    def __init__(self):
        ...
        self._jinja_env = self._init_templates_system(self._config['app']['templates_dir'])
    ...
    def run_simple(self):
        ...
        """
        serving.run_simple(self._app_config.get('host', '127.0.0.1'), self._app_config.get('port', 5000), self, use_debugger=True, use_reloader=True, static_files=self._app_config.get('static', {'/static': 'static/'}))
    ...
    def _init_config(self):
        ...
        main_conf_path = os.path.sep.join((conf_root,
         ('{0}.yml').format(self.__class__.__name__.lower())))
        local_conf_path = os.path.sep.join((conf_root,
         ('{0}.local.yml').format(self.__class__.__name__.lower())))
    ...
    def _init_views(self, jinja_env):
        ...
        return dict((rule.endpoint, rule.view_provider(jinja_env=jinja_env)) for rule in self._router.iter_rules())
