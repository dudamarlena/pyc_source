...
# [GCC 8.4.0]
# Embedded file name: /home/stanley/IdeaProjects/horizon-python-client/src/mf_horizon_client/client/datasets/data_interface.py
# Compiled at: 2020-05-09 11:13:01
# Size of source mod 2**32: 12945 bytes
import io, json
...
class DataInterface:
    ...
    @catch_errors
    def upload_data_long_format_as_single_data_set(self, data: pd.DataFrame, name: str, cross_section_column_name: str, date_column_name: str, replace_missing_values: bool=True, forward_fill_missing_values: bool=False, encode_categorical_data=True, max_categories=5) -> IndividualDataset:
        """
        ...
        return self.upload_data(data=df,
          name=name,
