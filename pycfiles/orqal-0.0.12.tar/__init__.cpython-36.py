...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/orqal/__init__.py
...
class Job:
    ...
    def __init__(self, id=None, app=None, input=None, params={}, use_cache=False, start=False):
        self._id = id
        self.app = app
        self.input = input
        self.params = params
