...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/fez/djangoskel/pastertemplates.py
...
class DjangoNamespaceTemplate(DjangoTemplate):
    vars = [
     ...
     var('package', 'The name of the package contained within the namespace')] + DjangoTemplate.vars
...
class DjangoBuildoutTemplate(Template):
    ...
    use_cheetah = True
    vars = [
     var('django_version', 'Django version to fetch, the default is 1.0.2', default='1.0.2'),
     var('django_project_name', 'Name of the main Django project folder', default='project')]
