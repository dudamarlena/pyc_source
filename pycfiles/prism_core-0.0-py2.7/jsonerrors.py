...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/prism_core/jsonerrors.py
...
class HTTPPreconditionFailed(httpexceptions.HTTPPreconditionFailed, BaseJsonHTTPError):
    pass