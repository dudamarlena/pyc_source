...
# [GCC 8.4.0]
# Embedded file name: /Users/germanoguerrini/Developer/github/django-bricks/djangobricks/tests.py
# Compiled at: 2015-01-27 05:27:35
# Size of source mod 2**32: 33393 bytes
...
from .models import SingleBrick, ListBrick, BaseWall, Criterion, SORTING_DESC, SORTING_ASC, BaseWallFactory, wall_factory
...
class TestNoTemplateSingleBrick(SingleBrick):
    pass


class NotABrick(object):
    pass
...
class BrickTest(SimpleTestCase):
    ...
    def _create_model_a_objects_and_bricks(self):
        objectA1 = TestModelA.objects.create(name='objectA1', popularity=5, pub_date=datetime.datetime(2010, 1, 1, 12, 0), is_sticky=False)
        objectA2 = TestModelA.objects.create(name='objectA2', popularity=4, pub_date=datetime.datetime(2011, 1, 1, 12, 0), is_sticky=False)
        objectA3 = TestModelA.objects.create(name='objectA3', popularity=3, pub_date=datetime.datetime(2012, 1, 1, 12, 0), is_sticky=True)
        objectA4 = TestModelA.objects.create(name='objectA4', popularity=2, pub_date=datetime.datetime(2013, 1, 1, 12, 0), is_sticky=False)
    ...
    def _create_model_b_objects_and_bricks(self):
        objectB1 = TestModelB.objects.create(name='objectB1', popularity=10, date_add=datetime.datetime(2006, 1, 1, 12, 0), is_sticky=False)
        objectB2 = TestModelB.objects.create(name='objectB2', popularity=9, date_add=datetime.datetime(2007, 1, 1, 12, 0), is_sticky=False)
        objectB3 = TestModelB.objects.create(name='objectB3', popularity=8, date_add=datetime.datetime(2008, 1, 1, 12, 0), is_sticky=True)
        objectB4 = TestModelB.objects.create(name='objectB4', popularity=7, date_add=datetime.datetime(2009, 1, 1, 12, 0), is_sticky=False)
    ...
    def _create_model_c_objects_and_bricks(self):
        objectC1 = TestModelC.objects.create(name='objectC1', popularity=20, pub_date=datetime.datetime(2002, 1, 1, 12, 0), is_sticky=False)
        objectC2 = TestModelC.objects.create(name='objectC2', popularity=19, pub_date=datetime.datetime(2003, 1, 1, 12, 0), is_sticky=False)
        objectC3 = TestModelC.objects.create(name='objectC3', popularity=18, pub_date=datetime.datetime(2004, 1, 1, 12, 0), is_sticky=True)
        objectC4 = TestModelC.objects.create(name='objectC4', popularity=17, pub_date=datetime.datetime(2005, 1, 1, 12, 0), is_sticky=False)
    ...
    def test_custom_callback_criterion(self):
        ...
        objectA2 = TestModelA.objects.create(name='objectA2', popularity=4, pub_date=datetime.datetime(2011, 1, 1, 12, 0), is_sticky=False)
        objectA3 = TestModelA.objects.create(name='objectA3', popularity=3, pub_date=datetime.datetime(2012, 1, 1, 12, 0), is_sticky=True)
        objectA4 = TestModelA.objects.create(name='objectA4', popularity=4, pub_date=datetime.datetime(2013, 1, 1, 12, 0), is_sticky=False)
        item_list = [objectA1, objectA2, objectA3, objectA4]
    ...
    def test_single_key_asc_sorting_single_bricks_single_models(self):
        ...
        expected = [
         self.brickA4, self.brickA3, self.brickA2, self.brickA1]
        self.assertEqual(list(wall), expected)
    ...
    def test_multi_key_1_sorting_single_bricks_single_models(self):
        ...
        wall = TestBrickWall(self.bricks, criteria=(
         ...
         (
          Criterion('popularity'), SORTING_DESC)))
        expected = [
         self.brickA3, self.brickA1, self.brickA2, self.brickA4]
        self.assertEqual(list(wall), expected)
    ...
    def test_multi_key_2_sorting_single_bricks_single_models(self):
        ...
        wall = TestBrickWall(self.bricks, criteria=(
         ...
         (
          Criterion('popularity'), SORTING_DESC)))
        expected = [
         self.brickA1, self.brickA2, self.brickA4, self.brickA3]
        self.assertEqual(list(wall), expected)
    ...
    def test_single_key_desc_sorting_single_bricks_multi_models(self):
        ...
        wall = TestBrickWall(self.bricks, criteria=(
         (
          Criterion('popularity'), SORTING_DESC),))
        expected = [
         self.brickB1, self.brickB2, self.brickB3, self.brickB4,
         self.brickA1, self.brickA2, self.brickA3, self.brickA4]
        self.assertEqual(list(wall), expected)
    ...
    def test_multi_key_1_sorting_single_bricks_multi_models(self):
        ...
        wall = TestBrickWall(self.bricks, criteria=(
         ...
         (
          Criterion('popularity'), SORTING_DESC)))
        expected = [
         self.brickB3, self.brickA3, self.brickB1, self.brickB2,
    ...
    def test_multi_key_2_sorting_single_bricks_multi_models(self):
        ...
        wall = TestBrickWall(self.bricks, criteria=(
         ...
         (
          Criterion('popularity'), SORTING_DESC)))
        expected = [
         self.brickB1, self.brickB2, self.brickB4, self.brickA1,
    ...
    def test_single_brick_context(self):
        obj = TestModelA.objects.create(name='objectA1', popularity=5, pub_date=datetime.datetime(2010, 1, 1, 12, 0), is_sticky=False)
        brick = TestSingleBrick(obj)
        self.assertEqual(brick.get_context(), {'object': obj})

    def test_list_brick_context(self):
        obj1 = TestModelC.objects.create(name='objectC1', popularity=20, pub_date=datetime.datetime(2002, 1, 1, 12, 0), is_sticky=False)
        obj2 = TestModelC.objects.create(name='objectC2', popularity=19, pub_date=datetime.datetime(2003, 1, 1, 12, 0), is_sticky=False)
    ...
    def test_factory_method_single_queryset(self):
        ...
        criteria = (
         ...
         (
          Criterion('popularity'), SORTING_DESC))
        wall = wall_factory(TestModelA.objects.all(), TestSingleBrick, criteria=criteria)
