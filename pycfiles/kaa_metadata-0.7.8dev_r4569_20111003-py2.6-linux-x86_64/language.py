...
# [GCC 8.4.0]
# Embedded file name: /net/orion/data/home/tack/projects/kaa/metadata/build/lib.linux-x86_64-2.6/kaa/metadata/language.py
# Compiled at: 2010-08-31 08:34:46
import re
__all__ = ['resolve']
...
def resolve(code):
    ...
    if not code:
        ...
        code = re.split('[^a-z]', code.lower())[0][:3]
        for spec in codes:
            if code in spec[:-1]:
                return (code, spec[(-1)])
