...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kaa/metadata/image/EXIF.py
# Compiled at: 2009-05-22 10:49:48
...
EXIF_TAGS = {256: (
   ...
   259: (
       'Compression',
       {1: 'Uncompressed TIFF', 6: 'JPEG Compressed'}), 
   262: (
   ...
   274: (
       'Orientation',
       {1: 'Horizontal (normal)', 2: 'Mirrored horizontal', 
          3: 'Rotated 180', 
          4: 'Mirrored vertical', 
   ...
   37383: (
         'MeteringMode',
         {0: 'Unidentified', 1: 'Average', 
            2: 'CenterWeightedAverage', 
            3: 'Spot', 
            4: 'MultiSpot'}), 
   37384: (
         'LightSource',
         {0: 'Unknown', 1: 'Daylight', 
            2: 'Fluorescent', 
            3: 'Tungsten', 
            10: 'Flash', 
            17: 'Standard Light A', 
...
MAKERNOTE_NIKON_NEWER_TAGS = {1: (
   ...
   12: (
      'WhiteBalanceRBCoeff',), 
   13: (
      'ProgramShift', nikon_ev_bias), 
   14: (
      'ExposureDifference', nikon_ev_bias), 
   15: (
      'ISOSelection',), 
   17: (
      'NikonPreview',), 
   18: (
      'FlashCompensation', nikon_ev_bias), 
   19: (
      'ISOSpeedRequested',), 
   22: (
      'PhotoCornerCoordinates',), 
   24: (
      'FlashBracketCompensationApplied', nikon_ev_bias), 
   25: (
      'AEBracketCompensationApplied',), 
   26: (
      'ImageProcessing',), 
   128: (
       'ImageAdjustment',), 
   ...
   137: (
       'BracketingMode',
       {0: 'Single frame, no bracketing', 1: 'Continuous, no bracketing', 
   ...
   16: (
      'DataDump',)}
MAKERNOTE_NIKON_OLDER_TAGS = {3: (
     'Quality',
     {1: 'VGA Basic', 2: 'VGA Normal', 
        3: 'VGA Fine', 
        4: 'SXGA Basic', 
        5: 'SXGA Normal', 
        6: 'SXGA Fine'}), 
...
MAKERNOTE_OLYMPUS_TAGS = {256: (
       'JPEGThumbnail',), 
   512: (
       'SpecialMode', olympus_special_mode), 
   513: (
       'JPEGQual',
       {1: 'SQ', 2: 'HQ', 
          3: 'SHQ'}), 
   ...
   12288: (
         'RawInfo ',)}
MAKERNOTE_OLYMPUS_TAG_0x2020 = {256: (
       'PreviewImageValid',
       {0: 'No', 1: 'Yes'}), 
   257: (
       'PreviewImageStart',), 
   ...
   769: (
       'FocusMode',
       {0: 'Single AF', 1: 'Sequential shooting AF', 
          2: 'Continuous AF', 
          3: 'Multi AF', 
          10: 'MF'}), 
   770: (
       'FocusProcess',
       {0: 'AF Not Used', 1: 'AF Used'}), 
   771: (
       'AFSearch',
       {0: 'Not Ready', 1: 'Ready'}), 
   772: (
   ...
   1280: (
        'WhiteBalance2',
        {0: 'Auto', 16: '7500K (Fine Weather with Shade)', 
           17: '6000K (Cloudy)', 
...
MAKERNOTE_CASIO_TAGS = {1: (
   ...
   20: (
      ...
      {64: 'Normal', 80: 'Normal', 
         ...
         244: '+3.0', 
         250: '+2.0'})}
MAKERNOTE_FUJIFILM_TAGS = {0: (
     'NoteVersion', make_string), 
   4096: (
        'Quality',), 
   4097: (
        'Sharpness',
...
MAKERNOTE_CANON_TAG_0x001 = {1: (
   ...
   5: (
     'ContinuousDriveMode',
     {0: 'Single Or Timer', 1: 'Continuous'}), 
   7: (
     'FocusMode',
     {0: 'One-Shot', 1: 'AI Servo', 
        2: 'AI Focus', 
        3: 'MF', 
        4: 'Single', 
        5: 'Continuous', 
   ...
   16: (
      'ISO',
      {0: 'See ISOSpeedRatings Tag', 15: 'Auto', 
         16: '50', 
         17: '100', 
         18: '200', 
         19: '400'}), 
   ...
   19: (
      'AFPointSelected',
      {12288: 'None (MF)', 12289: 'Auto-Selected', 
         12290: 'Right', 
         12291: 'Center', 
         12292: 'Left'}), 
   20: (
      'ExposureMode',
      {0: 'Easy Shooting', 1: 'Program', 
         2: 'Tv-priority', 
         3: 'Av-priority', 
         4: 'Manual', 
         5: 'A-DEP'}), 
   ...
   29: (
      'FlashDetails',
      {14: 'External E-TTL', 13: 'Internal Flash', 
         11: 'FP Sync Used', 
...
class EXIF_header():
    ...
    def dump_IFD(self, ifd, ifd_name, dict=EXIF_TAGS, relative=0, stop_tag='UNDEF'):
        ...
        for i in range(entries):
            ...
            field_type = not detailed and tag in IGNORE_TAGS or self.s2n(entry + 2, 2)
