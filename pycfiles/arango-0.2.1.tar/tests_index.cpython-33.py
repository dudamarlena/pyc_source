...
# [GCC 8.4.0]
# Embedded file name: /Users/maxk/Projects/OpenSource/arango-python/arango/tests/tests_index.py
...
class TestIndex(TestsBase):
    ...
    def delete_response_mock(self):
        return self.response_mock(status_code=200, text=json.dumps(dict(_rev=30967598, _id=1, error=False, code=200)), method='delete')

    def list_response_mock(self):
        self.list_ids = {'0': {'fields': [
                          '_id'], 
               'id': 0, 
               'type': 'primary'}}
        data = {'code': 200, 
        ...
        return self.response_mock(status_code=200, text=json.dumps(data), method='get')
    ...
    def test_create(self):
        index = self.c.index.create([
         'name'], index_type=self.c.index.HASH, unique=False)
    ...
    def test_create_empty_fields_wrong_type_first(self):
        self.c.index.create([], index_type='wrong')
