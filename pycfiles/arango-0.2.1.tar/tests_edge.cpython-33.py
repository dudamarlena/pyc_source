...
# [GCC 8.4.0]
# Embedded file name: /Users/maxk/Projects/OpenSource/arango-python/arango/tests/tests_edge.py
# Compiled at: 2013-03-08 13:34:55
# Size of source mod 2**32: 4187 bytes
from mock import Mock, patch
from nose.tools import assert_equal, assert_true, raises, assert_not_equal
...
class TestEdge(TestDocumentBase):
    ...
    def delete_edge_response_mock(self):
        return self.response_mock(status_code=204, text=json.dumps(dict(_from='7848004/9289796', _to='7848004/9355332', _rev=30967598, _id=1, error=False, code=204)), method='delete')

    def create_edge_response_mock(self, body=None):
        body = body if body is not None else {}
        defaults = dict(_from='7848004/9289796', _to='7848004/9355332', _rev=30967598, _id='7848004/9683012', error=False, code=201)
    ...
    def create_edge(self, from_doc, to_doc, body):
        ...
        patcher.start()
        edge = self.c.edges.create(from_doc, to_doc, body)
        patcher.stop()
        return edge
    ...
    def test_get_edge_fields(self):
        ...
        doc2 = self.create_document(234, body)
        edge = self.create_edge(doc1, doc2, body)
        assert_equal(edge.get('array', default=None), [
         1, 2, 3])
        for key in body.keys():
            assert_true(key in edge.get().keys())

        assert_equal(edge['tree']['sample1'], body['tree']['sample1'])
        return
