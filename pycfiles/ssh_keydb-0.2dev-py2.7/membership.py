...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ssh_keydb/plugins/membership.py
...
class MembershipController(Controller):
    ...
    grant.usage = {'shortdesc': 'Manage membership', 
       'usage': [
               '%(exec)s membership grant <user> <key> <role> <group> [<args>]'], 
       'options': {'help': 'displays the current help', 
                   'dbpath=': 'database path (~/.ssh-keydb.db by default)'}, 
       'shortopts': {'help': 'h', 'dbpath': 'd:'}}
    revoke.usage = {'shortdesc': 'Manage membership', 
       'usage': [
               '%(exec)s membership revoke [--group=<group>] [--role=<role>] [--key=<key>] [--user=<user>]'], 
       'options': {'help': 'displays the current help', 
                   'dbpath=': 'database path (~/.ssh-keydb.db by default)', 
                   'role=': 'filter by role', 
       ...
       'shortopts': {'help': 'h', 'dbpath': 'd:'}}
    list.usage = {'shortdesc': 'Manage membership', 
       'usage': [
               '%(exec)s membership list [--group=<group>] [--role=<role>] [--key=<key>] [--user=<user>] [--long]'], 
       'options': {'help': 'displays the current help', 
                   'dbpath=': 'database path (~/.ssh-keydb.db by default)', 
                   'role=': 'filter by role', 
                   'group=': 'filter by server group', 
