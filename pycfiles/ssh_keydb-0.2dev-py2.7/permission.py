...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ssh_keydb/plugins/permission.py
...
class PermissionController(Controller):
    ...
    set.usage = {'shortdesc': 'Manage permission', 
       'usage': [
               '%(exec)s permission set <role> <login> <location> <server> [<command>]'], 
       'options': {'help': 'displays the current help', 
                   'dbpath=': 'database path (~/.ssh-keydb.db by default)'}, 
       'shortopts': {'help': 'h', 'dbpath': 'd:'}}
    remove.usage = {'shortdesc': 'Manage permission', 
       'usage': [
               '%(exec)s permission remove [--server=<server>] [--role=<role>] [--login=<login>] [--group=<group>] [--location=<location>]'], 
       'options': {'help': 'displays the current help', 
                   'dbpath=': 'database path (~/.ssh-keydb.db by default)', 
                   'role=': 'filter by role', 
       ...
       'shortopts': {'help': 'h', 'dbpath': 'd:'}}
    list.usage = {'shortdesc': 'Manage permission', 
       'usage': [
               '%(exec)s permission list [--server=<server>] [--role=<role>] [--login=<login>] [--group=<group>] [--location=<location>] [--long]'], 
       'options': {'help': 'displays the current help', 
                   'dbpath=': 'database path (~/.ssh-keydb.db by default)', 
                   'role=': 'filter by role', 
                   'group=': 'filter by server group', 
