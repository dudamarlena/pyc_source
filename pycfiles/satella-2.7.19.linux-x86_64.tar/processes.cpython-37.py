...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/satella/processes.py
# Compiled at: 2020-04-29 12:14:00
# Size of source mod 2**32: 2387 bytes
import subprocess, typing as tp, threading, logging
...
def call_and_return_stdout(args: tp.Union[(str, tp.List[str])], timeout: tp.Optional[int]=None, encoding: tp.Optional[str]=None, expected_return_code: tp.Optional[int]=None, **kwargs) -> tp.Union[(bytes, str)]:
    """
