...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/satella/coding/structures/dictionaries.py
...
class DictObject(tp.MutableMapping[(str, T)]):
    ...
    def is_valid_schema(self, schema: tp.Optional[tp.Union[(Descriptor, tp.Dict)]]=None, **kwarg_schema) -> bool:
        ...
        if kwarg_schema:
            schema = kwarg_schema
        elif isinstance(schema, Descriptor):
            descriptor = schema
        else:
