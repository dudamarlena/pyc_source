...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/satella/instrumentation/trace_back.py
...
class GenerationPolicy:
 ...
 L.  39        36  LOAD_FAST                'enable_pickling'
               38  LOAD_FAST                'self'
               40  STORE_ATTR               enable_pickling

 L.  40        42  LOAD_FAST                'compress_at'
               44  LOAD_FAST                'self'
               46  STORE_ATTR               compress_at

 L.  41        48  LOAD_FAST                'repr_length_limit'
               50  LOAD_FAST                'self'
               52  STORE_ATTR               repr_length_limit

 L.  42        54  LOAD_FAST                'compression_level'
               56  LOAD_FAST                'self'
               58  STORE_ATTR               compression_level
