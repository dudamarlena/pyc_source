...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/satella/coding/decorators.py
...
def precondition(*t_ops: tp.Union[(tp.Callable[([T], bool)], Expression)], **kw_opts: tp.Union[(tp.Callable[([T], bool)], Expression)]):
    ...
    def outer(fun):
        ...
        def inner(*args, **kwargs):
            ...
            for kwarg in kwargs:
                if kwarg in kw_ops and not kw_ops[kwarg](kwargs[kwarg]):
