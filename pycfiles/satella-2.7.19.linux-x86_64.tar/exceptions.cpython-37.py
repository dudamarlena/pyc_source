...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/satella/exceptions.py
...
class ProcessFailed(BaseSatellaError):
    __doc__ = "A process finished with other result code that it was requested\n\n    :param rc: return code of the process\n    :param stdout_so_far: process' stdout gathered so far\n    "

    def __init__(self, rc, stdout_so_far):
