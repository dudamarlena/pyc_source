...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.7.1/lib/python3.7/site-packages/satella/configuration/sources/format.py
        ...
        with rethrow_as(tuple(cls.BASE_EXCEPTIONS + cls.EXTRA_EXCEPTIONS), ConfigurationError):
            if isinstance(self.root, bytes):
                ...
                if not isinstance(ret_val, dict):
                    raise ConfigurationError('provider was unable to generate a text volume')
                else:
                    return ret_val
