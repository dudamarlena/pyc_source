...
# Embedded file name: build/bdist.linux-x86_64/egg/aeolus/core.py
# Compiled at: 2020-03-31 12:30:22
# Size of source mod 2**32: 6867 bytes
__doc__ = 'Core submodule of aeolus package.'
...
class Run:
    """Run"""
    attr_keys = [
     'name', 'description', 'planet', 'model_type', 'timestep', 'parent', 'children']

    def __init__(self, files=None, name='', description='', planet='', const_dir=None, model_type=None, timestep=None, parent=None, children=None, processed=False):
        """
