...
# [GCC 8.4.0]
# Embedded file name: /home/wes/.virtualenvs/memorised/lib/python2.7/site-packages/memorised/tests.py
# Compiled at: 2014-08-14 13:30:05
from __future__ import unicode_literals
import unittest, uuid, memcache
...
class TestMemorise(unittest.TestCase):
    ...
    def setUp(self):
        self.mc = memcache.Client([b'localhost:11211'], debug=0)
        self.mc.flush_all()
...
def run():
    print ()
    print b'Running memorised.decorators test suite...'
    print ()
