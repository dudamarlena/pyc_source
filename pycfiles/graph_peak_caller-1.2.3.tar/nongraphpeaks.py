...
# [GCC 8.4.0]
# Embedded file name: /home/ivargry/dev/graph_peak_caller/graph_peak_caller/analysis/nongraphpeaks.py
# Compiled at: 2018-08-27 08:03:07
...
class NonGraphPeak:
    ...
    def to_file_line(self):
        object = {'chromosome': self.chromosome, 
    ...
    def from_file_line(cls, line):
        ...
        return cls(object['chromosome'], object['start'], object['end'], score=object['score'])
...
class NonGraphPeakCollection(object):
    ...
    def from_bed_file(cls, file_name, cut_around_summit=None):
        ...
        for line in f:
            ...
            if cut_around_summit is not None:
                ...
                assert end > start
            peaks.append(NonGraphPeak(chrom, start, end, score))
    ...
    def get_graph_peak_collection(self, graph, linear_interval_through_graph, graph_region=None):
        ...
        return PeakCollection.create_from_nongraph_peak_collection(graph, self, linear_interval_through_graph, graph_region)
