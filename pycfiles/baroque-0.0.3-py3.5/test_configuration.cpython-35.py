...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_configuration.py
...
from baroque.exceptions.eventtypes import UnregisteredEventTypeError, InvalidEventSchemaError
