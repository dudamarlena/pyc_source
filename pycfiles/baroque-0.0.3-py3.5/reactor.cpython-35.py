...
class Reactor:
    ...
    def __repr__(self):
        return '<{}.{} - reaction function: {}> - condition function: {} - last reaction on: {}'.format(__name__, self.__class__.__name__, self.reaction_function, self.condition_function or 'None', self.last_reacted_on() or 'Never')