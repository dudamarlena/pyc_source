...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/NMR.py
# Compiled at: 2020-02-19 16:36:38
# Size of source mod 2**32: 11870 bytes
"""
NMR.py
...
class NMRAxis(Axis):
    ...
    def __init__(self, size=64, specwidth=2000.0 * math.pi, offset=0.0, frequency=400.0, itype=0, currentunit='points'):
        ...
        self.units['sec'] = Unit(name='Hz', converter=(self.itos), bconverter=(self.stoi))
        for i in ('specwidth', 'offset', 'frequency', 'NMR'):
    ...
    def extract(self, zoom):
        ...
        """
        start, end = self.getslice(zoom)
        new_specwidth = self.itoh(start + 1) - self.itoh(end)
...
class NMRDataTests(unittest.TestCase):
    ...
    def test_unitval(self):
        ...
        self.assertAlmostEqual(F.itoh(F.size - 1), F.offset)
