...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/util/hashcheck.py
...
import hashlib, fnmatch, os, sys, json, unittest
    ...
    if rootpath is None:
        ...
        if not os.path.exists(dirhash):
            ...
            for key in hash1:
                if key in hash2:
                    if verbose:
                        print('ok for %s : %s' % (hash2[key], key))
                else:
