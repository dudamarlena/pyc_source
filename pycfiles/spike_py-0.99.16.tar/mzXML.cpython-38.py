...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/File/mzXML.py
# Compiled at: 2019-04-10 05:14:46
# Size of source mod 2**32: 3613 bytes
from __future__ import print_function, division
import numpy as np, xml.dom.minidom, base64, struct, unittest
...
class mzXML:
    ...
    def get_params(self):
        ...
        self.dic_param = {'msLevel':int,  'peaksCount':int,  'polarity':None,  'scanType':None,  'filterLine':None, 
         'retentionTime':None,  'lowMz':float,  'highMz':float,  'basePeakMz':float, 
         'basePeakIntensity':float,  'totIonCurrent':int,  'collisionEnergy':int}
    ...
    def save_mzXML(self, x, y, namefile_final):
        ...
        spec[0].childNodes[0].replaceWholeText(txt)
        self.doc.writexml(open(namefile_final, 'w'))
        print('mzXML saved')
...
class mzXML_Tests(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        dic_param = {'msLevel':2,  'peaksCount':35775,  'polarity':'+',  'scanType':'Full',  'filterLine':'FTMS + p NSI Full ms2 1499.60@cid30.00 [410.00-2000.00]', 
         'retentionTime':'PT0.0366S', 
         'lowMz':410.001,  'highMz':2069.29,  'basePeakMz':1151.69, 
         'basePeakIntensity':13452.2,  'totIonCurrent':681064,  'collisionEnergy':30}
        for p in dic_param:
