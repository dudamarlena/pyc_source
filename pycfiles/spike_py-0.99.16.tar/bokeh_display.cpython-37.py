...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/plugins/bokeh_display.py
# Compiled at: 2019-05-04 08:16:52
        ...
        if npkd.dim == 2 and image:
            ...
            if npkd.dim == 2:
                if not image:
                    ...
                    dbk['y_axis_type'] = npkd.axis1.units[npkd.axis1.currentunit].scale
                    dbk['y_range'] = (npkd.axis1.itoc(z1lo), npkd.axis1.itoc(z1up))
                    dbk['x_axis_type'] = npkd.axis2.units[npkd.axis2.currentunit].scale
                    dbk['x_range'] = (npkd.axis2.itoc(z2lo), npkd.axis2.itoc(z2up))
                    npkd.display(scale=scale, autoscalethresh=autoscalethresh, absmax=absmax, show=False, new_fig=False, axis=axis, zoom=zoom,
                      title=None,
                      figure=ax,
                      color=color,
                      mpldic=mpldic)
