...
# [GCC 8.4.0]
# Embedded file name: /Users/alex/dev/dummydata/dummydata/meta.py
# Compiled at: 2017-03-18 11:45:22
...
class Metadata(object):
    ...
    def _set_attributes(self):
        if not self.v in self.dict.keys():
            raise AssertionError('ERROR: metadata for variable ' + self.v + ' is unknown!')
        else:
            d = self.dict[self.v]
