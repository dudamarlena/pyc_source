...
# [GCC 8.4.0]
# Embedded file name: /Users/esperyong/develop/pyprojects/hwbuluo_src/hwbuluo-site/venv/lib/python2.7/site-packages/sms/tests.py
# Compiled at: 2015-05-11 05:03:59
...
class SMSTestCase(SMSTestCaseBase):
    ...
    def test_sms_send(self):
        sms.send_sms(tpl_id='416085', content='#code#=1234&#timeout#=3', recipient_list=[
         '13311102999'])
        self.assertEquals(sms.outbox[0].message(), '#code#=1234&#timeout#=3')
        sms.send_sms(tpl_id='416085', content='#code#=1234&#timeout#=3', recipient_list=[
         '13311109999', '18612589999'])
        self.assertEquals(sms.outbox[0].message(), '#code#=1234&#timeout#=3')
        rl = []
    ...
    def test_receive_sms_reply(self):
        reply_data = {'id': '2a70c6bb4f2845da816ea1bfe5732747', 
           'mobile': '15205201314', 
    ...
    def test_multiple_message(self):
        ...
        mobile = '13311101111'
        m1 = SMSMessage(tpl_id='416222', content='#code#=1234&#timeout#=3', to=(
         mobile,))
