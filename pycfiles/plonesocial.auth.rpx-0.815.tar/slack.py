...
# Embedded file name: /Users/sgiraud/WDIR/dev/plone/install/zinstance/src/plonerules.slack/plonerules/slack/actions/slack.py
# Compiled at: 2015-03-25 04:54:16
...
class SlackActionExecutor(object):
    ...
    def __call__(self):
        ...
        try:
            slack.chat.post_message(self.element.chanel, message, username=username, parse=None, link_names=None, attachments=None, unfurl_links=None, icon_url=None, icon_emoji=self.element.emoji)
        except:
            return False
...
class SlackAddForm(AddForm):
    ...
    label = 'Add Slack Action'
    description = 'An action that can post on slack channel'
