...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/DBApps/splitWorks.py
# Compiled at: 2019-04-22 11:39:38
# Size of source mod 2**32: 3982 bytes
...
def parseArgs(argNamespace):
    ...
    """
    _parser = argparse.ArgumentParser(description='Splits the output of getReadyWorks.py into separate files, named inputfile01, 02, ....', usage='%(prog)s | -n n How many works split.',
      epilog='Contents not guaranteed to be equal lengths but they will contain an equal number of works, as much as possible. ** Warning ** first line of file is the header line which this program assumes is the text of the boundary between works.')
    _parser.add_argument('-n', '--numFiles', help='how many output files to create', type=int, default=10,
      choices=(range(1, 9999999)))
