...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/star/templatetags/djangostar.py
...
class RenderDjangoStarListNode(template.Node):
    ...
    def render(self, context):
        ...
        context.push()
        html = render_to_string('star/list.html', {'content_type': content_type.pk, 
           'object_id': object.pk, 
           'api_url': reverse('star-api', args=[content_type.pk, object.pk])}, context)
        context.pop()
        return html
