...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/common_dibbs/clients/rpa_client/swagger_client/api_client.py
...
import os, re, sys, urllib, json, mimetypes, random, tempfile, threading
    ...
    def __deserialize(self, data, klass):
        ...
        if data is None:
            ...
            if type(klass) == str:
                ...
                if klass in ('int', 'long', 'float', 'str', 'bool', 'date', 'datetime',
                             'object'):
                    klass = eval(klass)
                else:
