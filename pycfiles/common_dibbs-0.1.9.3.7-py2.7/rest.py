...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/common_dibbs/clients/rpa_client/swagger_client/rest.py
...
import sys, io, json, ssl, certifi, logging, re
...
class RESTClientObject(object):
    ...
    def __init__(self, pools_size=4):
        ...
        self.pool_manager = urllib3.PoolManager(num_pools=pools_size, cert_reqs=cert_reqs, ca_certs=ca_certs, cert_file=cert_file, key_file=key_file)
    ...
    def request(self, method, url, query_params=None, headers=None, body=None, post_params=None):
        ...
        try:
            if method in ('POST', 'PUT', 'PATCH', 'OPTIONS', 'DELETE'):
                ...
                r = self.pool_manager.request(method, url, fields=query_params, headers=headers)
    ...
    def OPTIONS(self, url, headers=None, query_params=None, post_params=None, body=None):
        return self.request('OPTIONS', url, headers=headers, query_params=query_params, post_params=post_params, body=body)

    def DELETE(self, url, headers=None, query_params=None, body=None):
        return self.request('DELETE', url, headers=headers, query_params=query_params, body=body)

    def POST(self, url, headers=None, query_params=None, post_params=None, body=None):
        return self.request('POST', url, headers=headers, query_params=query_params, post_params=post_params, body=body)

    def PUT(self, url, headers=None, query_params=None, post_params=None, body=None):
        return self.request('PUT', url, headers=headers, query_params=query_params, post_params=post_params, body=body)
