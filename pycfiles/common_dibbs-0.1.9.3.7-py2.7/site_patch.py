...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/common_dibbs/clients/ar_client/models/site_patch.py
...
class SitePatch(object):
    ...
    def type(self):
        """
        Gets the type of this SitePatch.
        Type of the site (e.g. openstack)

        :return: The type of this SitePatch.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this SitePatch.
        Type of the site (e.g. openstack)

        :param type: The type of this SitePatch.
        :type: str
        """
        self._type = type
