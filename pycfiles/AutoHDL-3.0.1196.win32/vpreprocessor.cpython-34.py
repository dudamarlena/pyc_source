...
# [GCC 8.4.0]
# Embedded file name: \Python34\Lib\site-packages\autohdl\verilog\vpreprocessor.py
# Compiled at: 2015-05-16 02:37:49
...
class Preprocessor(object):
    ...
    def __init__(self, iFile):
        ...
        self.result = {'file_path': os.path.relpath(self.path), 
    ...
    def prepInclude(self, iLine):
        ...
        logging.warning('Cannot resolve {} in file: {}'.format(iLine, os.path.abspath(self.path)))
        return []
...
if __name__ == '__main__':
    print(Preprocessor('D:\\repo\\github\\autohdl\\test\\fake_repo_gold\\dsn2\\src/dspuva16.v').result)