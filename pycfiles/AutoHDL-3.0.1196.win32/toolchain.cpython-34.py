...
# [GCC 8.4.0]
# Embedded file name: \Python34\Lib\site-packages\autohdl\toolchain.py
# Compiled at: 2015-05-16 08:38:18
# Size of source mod 2**32: 5941 bytes
import ctypes, fnmatch, os, json, glob, logging
...
class Tool(object):
    ...
    def __init__(self):
        self.data = {'ise': {'gui': 'ise.exe',  'impact': 'impact.exe', 
                 'batch': 'xtclsh.exe', 
                 'xflow': 'xflow.exe', 
                 'promgen': 'promgen.exe', 
                 ...
                 'path': [
                          '/Xilinx/']}, 
         'synplify': {'gui': 'synplify_premier.exe',  'batch': 'synplify_premier.exe', 
                      'path': [
                               '/Synopsys/', '/Synplicity/']}}
