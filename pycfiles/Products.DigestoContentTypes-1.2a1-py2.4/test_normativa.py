...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Products/DigestoContentTypes/tests/test_normativa.py
...
class TestNormativa(DigestoContentTypesTestCase):
    ...
    def test_required_fields(self):
        ...
        for field in object_fields:
            self.failUnless(field.getName() in required_fields and field.required or field.getName() not in required_fields and not field.required)
