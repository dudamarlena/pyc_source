...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/indentation_test.py
# Compiled at: 2020-05-05 05:10:36
...
class IndentationTest(unittest.TestCase):
    ...
    def test_no_new_indentation(self):
        ...
        expected_message = get_formatted_message('invalid_indentation.4',
          line=4,
          error_line='pass',
    ...
    def test_higher_level_of_indent_with_no_start(self):
        ...
        expected_message = get_formatted_message('invalid_indentation.1',
          line=4,
          error_line='      pass',
          last_start_of_block='if True:')
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_no_matching_indent_level(self):
        ...
        expected_message = get_formatted_message('invalid_indentation.2',
          line=4, error_line='    pass')
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_start_of_indentation_at_eof(self):
        ...
        expected_message = get_formatted_message('invalid_indentation.3',
          line=5, error_line='else:')
        run_test_scenario(self, path, 1, expected_message)
