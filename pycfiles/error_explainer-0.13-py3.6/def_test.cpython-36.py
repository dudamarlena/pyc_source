...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/def_test.py
...
class DefTest(unittest.TestCase):
    ...
    def test_assign_to_def(self):
        ...
        expected_message = get_formatted_message('invalid_function_name.assign_to_def',
          line_end=3)
    ...
    def test_no_name_or_args_def(self):
        ...
        expected_message = get_formatted_message('missing_function_parts',
          line_start=2, line_end=3, invalid_def='def :')
        run_test_scenario(self, path, 1, expected_message)
    ...
    def test_keyword_as_function_name(self):
        ...
        expected_message = get_formatted_message('invalid_function_name',
          line_end=3, invalid_name='pass')
        run_test_scenario(self, path, 1, expected_message)
