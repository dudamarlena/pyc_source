...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/python_inquirer/prompt.py
# Compiled at: 2019-08-16 00:19:35
# Size of source mod 2**32: 3837 bytes
from __future__ import absolute_import, print_function
from prompt_tool_kit.shortcuts import run_application
...
def prompt(questions, answers=None, **kwargs):
    ...
    for question in questions:
        ...
        try:
            ...
            if when:
                if callable(question['when']):
                    try:
                        ...
                        raise ValueError("Problem in 'when' check of %s question: %s" % (
                         name, e))
            ...
            answer = run_application(application,
            ...
            if answer is not None:
                if filter:
                    try:
                        ...
                        raise ValueError("Problem processing 'filter' of %s question: %s" % (
                         name, e))
