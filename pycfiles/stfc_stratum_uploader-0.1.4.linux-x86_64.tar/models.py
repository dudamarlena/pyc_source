...
# [GCC 8.4.0]
# Embedded file name: /home/vwa13376/workspace/uploader/archer/projects/models.py
...
class FileSystem(models.Model):
    ...
    mount_point = models.CharField(max_length=2000, null=False, blank=False, unique=True, validators=[
     validator_dir_exists])

    class Meta:
        permissions = (('setup_filesystem', 'Setup file system'), )
    ...
    def validate_unique(self, *args, **kwargs):
        ...
        def validate_uniqueness_of_alias_and_mount_point(rethrow_error=None):
            uq_mount = self.__class__.objects.filter(Q(alias=self.mount_point))
            uq_alias = self.__class__.objects.filter(Q(mount_point=self.alias))
            errors = {}
