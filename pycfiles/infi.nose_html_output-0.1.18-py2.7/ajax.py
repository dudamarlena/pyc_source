...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/infi/nose_html_output/ajax.py
# Compiled at: 2014-06-19 08:13:30
...
class AjaxHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        result = REFRESH_JS.format(html_str.replace("'", "\\'").replace('\n', '\\n'))
        if not end:
            result += RELOAD_JS
