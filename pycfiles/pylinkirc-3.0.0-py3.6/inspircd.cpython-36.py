...
class InspIRCdProtocol(TS6BaseProtocol):
    ...
    def post_connect(self):
        ...
        if self.proto_ver >= 1205:
            verstr = self.version()
            for version_type in frozenset({'rawversion', 'version'}):
 ...
 L. 528       208  LOAD_FAST                'args'
              210  LOAD_CONST               0
              212  BINARY_SUBSCR    
              214  LOAD_CONST               frozenset({'USERMODES', 'CHANMODES'})
              216  COMPARE_OP               in
 ...
 L. 629       646  LOAD_GLOBAL              log
              ...
              654  LOAD_ATTR                name
              656  LOAD_FAST                'caps'
              658  CALL_FUNCTION_3       3  '3 positional arguments'
              660  POP_TOP          
 ...
 L. 639       730  LOAD_GLOBAL              log
              ...
              744  CALL_FUNCTION_3       3  '3 positional arguments'
              746  POP_TOP          
 ...
 L. 658       932  LOAD_FAST                'self'
              ...
              944  BINARY_SUBSCR    
              946  LOAD_ATTR                split
              948  CALL_FUNCTION_0       0  '0 positional arguments'
