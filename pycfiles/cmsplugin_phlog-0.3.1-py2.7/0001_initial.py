...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/cmsplugin_phlog/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    depends_on = (('photologue', '0001_initial'), )
    ...
    def forwards(self, orm):
        db.create_table('cmsplugin_phloggalleryplugin', (
         ...
         (
          'gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.OrderedGallery'])),
         (
          'order', self.gf('django.db.models.fields.CharField')(default='gallery', max_length=32)),
         (
          'limit', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
         (
          'public', self.gf('django.db.models.fields.BooleanField')(default=True)),
         (
          'template', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True))))
        db.send_create_signal('cmsplugin_phlog', ['PhlogGalleryPlugin'])
