...
# [GCC 8.4.0]
# Embedded file name: /Users/brianbruggeman/repos/mine/oogli/oogli/Window.py
# Compiled at: 2016-01-21 11:15:21
# Size of source mod 2**32: 10967 bytes
from __future__ import print_function
import logging, threading, glfw, glfw.gl as gl
log = logging.getLogger('Window')

class Window(object):
    __doc__ = "Wraps GLFW functions into a convenient package\n\n    >>> win = Window(title='Example', width=1080, height=720)\n    >>> win.loop()\n    "
    registry = {}
