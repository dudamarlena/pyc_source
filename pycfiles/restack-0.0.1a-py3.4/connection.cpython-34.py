...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/restack/connection.py
# Compiled at: 2015-02-22 07:37:32
...
class Restack(object):
    ...
    def update_device(self, device):
        ...
        resp = self.make_request(endpoint=endpoint, method=method, auth=True, body=json.dumps(body))
        if device.id:
    ...
    def get_devices(self):
        ...
        """
        return self._build_device_list(self.make_request(self.ENDPOINT_PRIVATE_DEVICES, auth=True))
    ...
    def get_public_devices(self):
        ...
        """
        return self._build_device_list(self.make_request(self.ENDPOINT_PUBLIC_DEVICES))
    ...
    def save_stack_data(self, stack, value, timestamp=None):
        ...
        resp = self.make_request(endpoint=endpoint, method='POST', auth=True, body=json.dumps(body))
