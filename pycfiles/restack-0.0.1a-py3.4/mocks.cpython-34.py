...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/restack/mocks.py
# Compiled at: 2015-02-21 17:38:58
...
def add(url, body, method=responses.GET, status=200):
    responses.add(method, BASE_URL + url, body=body, status=status, content_type='application/json')
...
def private_devices_callback(request):
    ...
    if auth_token != MOCK_TOKEN:
        ...
        return (
         200, {}, MOCK_PUBLIC_DEVICES_RESPONSE)
