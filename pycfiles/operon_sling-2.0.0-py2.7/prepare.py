...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/sling/tasks/prepare.py
# Compiled at: 2019-11-01 07:27:20
import argparse, sling

def run():
    parser = argparse.ArgumentParser(description='Prepare genomes for pipeline', usage='sling prepare [options] <id> <input_dir> [containing GFF and/or FASTA files]')
