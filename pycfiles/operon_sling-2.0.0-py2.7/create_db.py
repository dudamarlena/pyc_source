...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/sling/tasks/create_db.py
# Compiled at: 2019-11-01 07:27:20
import argparse, sling

def run():
    parser = argparse.ArgumentParser(description='Create a built-in database for SLING', usage='sling create_db [options] <name> <hmm_file>')
