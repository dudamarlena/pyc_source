...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/sling/tasks/filter.py
# Compiled at: 2019-11-01 07:27:20
import argparse, sling

def run():
    parser = argparse.ArgumentParser(description='Summarise HMMER results and search for operons in each strain', usage='sling filter [options] <id> <hmm_db>')
