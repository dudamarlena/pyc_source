...
# [GCC 8.4.0]
# Embedded file name: test/utils.py
...
class HexStringNibbleAdapterTest(unittest.TestCase):
    ...
    def setUp(self):
        self.n = ExprAdapter(BitStruct('octet', Padding(4), Nibble('value')), encoder=lambda obj, ctx: Container(value=obj), decoder=lambda obj, ctx: obj.value)
    ...
    def test_encode(self):
        ...
        self.assertEqual(c.build(31), 'f')
        self.assertEqual(c.build(15), 'f')
...
class BaudrateAdapterTest(unittest.TestCase):
    ...
    def test_encode(self):
        ...
        self.assertEqual(c.build(900000), '\n')
