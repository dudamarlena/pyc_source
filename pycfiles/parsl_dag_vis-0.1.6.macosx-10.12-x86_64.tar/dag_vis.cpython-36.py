...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/site-packages/dag_vis/dag_vis.py
# Compiled at: 2017-12-01 17:33:52
...
class DFKListener:
    ...
    def __init__(self, dfk):
        ...
        self.nodes_list = []
        self.edges_list = []
        self.color_lookup_table = {States.unsched: 'Pink', 
        ...
        self.state_lookup_table = {States.unsched: 'Unscheduled', 
    ...
    def create_nodes(self, dfke=None):
        ...
        for task in dfk.tasks:
            ...
            task = {'id':tid,  'label':'{}\n{}\n{}'.format(str(tid), fname, self.state_lookup_table[state]),  'color':self.color_lookup_table[state],  'font':{'background': 'white'}, 
             'title':self.state_lookup_table[state]}
