...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/s3-now/s3lify/cli.py
# Compiled at: 2019-09-15 18:58:10
import os, re, sys, yaml, time, json, click, pkg_resources
from . import S3lify
...
def main():
    ...
    client = S3lify(domain=domain_name, aws_access_key_id=config.get('aws_access_key_id'), aws_secret_access_key=config.get('aws_secret_access_key'), region=config.get('aws_region'))
