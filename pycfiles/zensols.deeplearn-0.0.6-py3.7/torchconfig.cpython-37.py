...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/zensols/deeplearn/torchconfig.py
...
import sys, logging, torch, numpy as np
...
class TorchConfig(object):
    ...
    def sparse(self, indicies: Tuple[int], values: Tuple[float], shape: Tuple[(int, int)]):
