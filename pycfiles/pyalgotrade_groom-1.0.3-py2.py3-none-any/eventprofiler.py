...
# Embedded file name: /home/winkidney/.virtualenvs/huobi/lib/python2.7/site-packages/pyalgotrade/eventprofiler.py
...
class Profiler(object):
    ...
    def run(self, feed, useAdjustedCloseForReturns=True):
        ...
        """
        assert useAdjustedCloseForReturns and feed.barsHaveAdjClose(), "Feed doesn't have adjusted close values"
        try:
            self.__feed = feed
            self.__rets = {}
            self.__futureRets = {}
