...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pulsedive/client.py
# Compiled at: 2019-01-10 09:49:39
# Size of source mod 2**32: 17269 bytes
import base64, shutil, requests
from .exceptions import PulsediveException
PULSEDIVE_URL = 'https://pulsedive.com/api'
CATEGORIES = [
 'general', 'abuse', 'apt', 'attack', 'botnet', 'crime',
...
class SearchClient:
    ...
    def __call__(self, value='', risk=RISKS, indicator_type=INDICATOR_TYPES, lastseen=None, latest=None, limit='hundred', properties=None, attribute=None, feed=None, threat=None, export=False, **kwargs):
        """
        Searches for indicators, an alias of the `.get()` method
        """
        return (self.indicator)(value=value, risk=risk, indicator_type=indicator_type, 
         lastseen=lastseen, 
         latest=latest, limit=limit, export=export, 
         properties=properties, attribute=attribute, 
         feed=feed, threat=threat, **kwargs)

    def indicator(self, value='', risk=RISKS, indicator_type=INDICATOR_TYPES, lastseen=None, latest=None, limit='hundred', export=False, properties=None, attribute=None, feed=None, threat=None, **kwargs):
        """
    ...
    def threat(self, value='', risk=RISKS, category=CATEGORIES, properties=None, attribute=None, splitrisk=False, **kwargs):
        """
...
class Pulsedive:
    ...
    def get(self, path, params, **kwargs):
        return (self._Pulsedive__send)('GET', path, params, **kwargs)

    def post(self, path, data, **kwargs):
        return (self._Pulsedive__send)('POST', path, data, **kwargs)