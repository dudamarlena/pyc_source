...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/flask_cqlalchemy/__init__.py
# Compiled at: 2016-08-07 06:02:19
"""
flask_cqlalchemy
...
class CQLAlchemy(object):
    ...
    def init_app(self, app):
        ...
        connection.setup(self._hosts_, self._keyspace_, consistency=consistency, lazy_connect=lazy_connect, retry_connect=retry_connect, **setup_kwargs)
