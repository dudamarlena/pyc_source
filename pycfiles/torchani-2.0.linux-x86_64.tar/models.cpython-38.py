...
# [GCC 8.4.0]
# Embedded file name: /opt/hostedtoolcache/Python/3.8.2/x64/lib/python3.8/site-packages/torchani/models.py
...
class BuiltinNet(torch.nn.Module):
    ...
    def __init__(self, info_file, periodic_table_index=False):
        ...
        self.neural_networks = neurochem.load_model_ensemble(self.species, self.ensemble_prefix, self.ensemble_size)
