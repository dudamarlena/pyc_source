...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/flask_captcha/helpers.py
# Compiled at: 2014-06-13 14:46:07
...
def noise_dots(draw, image):
    ...
    for p in range(int(size[0] * size[1] * 0.1)):
        draw.point((random.randint(0, size[0]), random.randint(0, size[1])), fill=fg_color)
