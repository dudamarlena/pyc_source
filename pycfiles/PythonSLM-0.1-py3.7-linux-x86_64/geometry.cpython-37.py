...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyslm/geometry.py
# Compiled at: 2020-05-01 12:24:35
...
class HatchGeometry(LayerGeometry):
    ...
    def __init__(self, modelId=0, buildStyleId=0, coords=None):
...
class Layer:
    ...
    def getLayerGeometry(self) -> List[Any]:
        ...
        """
        return [
         self._contours, self._hatches, self._points]
