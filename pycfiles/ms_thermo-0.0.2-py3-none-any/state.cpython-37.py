...
# [GCC 8.4.0]
# Embedded file name: /Users/rossi/gitlab/ms_thermo/src/ms_thermo/state.py
# Compiled at: 2020-02-28 04:57:44
...
from ms_thermo.constants import GAS_CST
from ms_thermo.species import build_thermo_from_avbp
__all__ = [
 'State']

class State:
    __doc__ = 'Container class to handle mixtures.'

    def __init__(self, species_db=None, temperature=300.0, pressure=101325.0, mass_fractions_dict=None):
        """
    ...
    def __repr__(self):
        ...
        for var in moco:
            infos = (
             var, moco[var], mini[var], maxi[var])
    ...
    def mix_molecular_weight(self):
        ...
        """
        y_ov_w = [np.divide(self._y_k[k], self.species[k].molecular_weight) for k in self.list_species()]
    ...
    def _default_thermo_database(self):
        ...
        """
        thermo_db_file = pkg_resources.resource_filename(__name__, '../INPUT/species_database.dat')
