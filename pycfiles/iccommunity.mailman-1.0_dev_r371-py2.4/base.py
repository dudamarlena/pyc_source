...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/iccommunity/mailman/tests/base.py
...
setup_iccommunity_mailman()
ptc.setupPloneSite(products=[PROJECTNAME])

class icCommunityTestCase(ptc.PloneTestCase):
