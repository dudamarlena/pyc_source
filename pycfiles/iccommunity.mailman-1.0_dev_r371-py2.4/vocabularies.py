...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/iccommunity/mailman/vocabularies.py
...
class MailmanploneListsVocabulary(object):
    ...
    def __call__(self, context):
        ...
        terms = []
        pcm = getUtility(IicCommunityManagementMailman, name='iccommunity.configuration')
        if pcm.host:
