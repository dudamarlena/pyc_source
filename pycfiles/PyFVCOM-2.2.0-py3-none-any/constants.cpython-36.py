...
# Embedded file name: build/bdist.linux-x86_64/egg/pyfva/constants.py
# Compiled at: 2019-08-08 02:05:08
# Size of source mod 2**32: 59365 bytes
__doc__ = '\nCreated on 30 jul. 2017\n\n@author: luis\n'
HASH_METHODS = (('Sha256', 'Sha256'), ('Sha256', 'Sha256'), ('Sha512', 'Sha512'))
TIPO_IDENTIFICACION = ((1, 'Identificación Nacional'), (2, 'DIMEX'), (3, 'DIDI'))
...
ERRORES_AL_NOTIFICAR_FIRMA = ((0, 'Solicitud completada sin errores.'), (1, 'Ha ocurrido algún problema al firmar.'),
                              ...
                              (6, 'El documento de la solicitud es inválido.'), (7, 'Error no definido en el estandar'),
                              (8, 'El hash de la solicitud es incorrecto.'), (9, 'El certificado del suscriptor está revocado.'),
                              (10, 'El certificado del suscriptor está vencido.'),
                              (11, 'Existe una solicitud de firma en proceso para el cliente.'),
                              (12, 'No se pudo notificar a la entidad.'), (13, 'El código de verificación es incorrecto'),
                              (14, 'El suscriptor bloqueo el pin de la tarjeta'),
                              (15, 'El documento no es válido para ser contrafirmado.'))
ERRORES_VALIDA_CERTIFICADO = ((0, 'Certificado válido.'), (1, 'Error interno al validar el certificado.'),
                              ...
                              (11, 'La entidad no se encuentra registrada.'), (12, 'La entidad no se encuentra en estado inactiva.'))
ERRORES_VALIDAR_XMLCOFIRMA = ((0, 'Documento válido.'), (1, 'Error interno al validar el documento.'),
                              (2, 'La entidad no se encuentra registrada.'), (3, 'La entidad se encuentra en estado inactiva.'),
                              (4, 'El documento no es un XML válido.'), (5, 'El documento XML no se encuentra firmado.'),
...
ERRORES_VALIDAR_XMLCONTRAFIRMA = ((0, 'Documento válido.'), (1, 'Error interno al validar el documento.'),
...
ERRORES_VALIDAR_MSOFFICE = ((0, 'Documento válido. '), (1, 'Error interno al validar el documento. '),
                            (2, 'La entidad enviada no se encuentra registrada. '),
                            (3, 'La entidad enviada se encuentra en estado Inactiva.'),
                            (4, 'El documento no es un XML válido'), (5, 'El documento no se encuentra firmado'),
                            ...
                            (74, 'El documento no es válido.'), (75, 'En la firma [Identificador de la firma] el formato del SignatureTime es incorrecto.'),
...
ERRORES_VALIDAR_ODF = ((0, 'Documento válido. '), (1, 'Error interno al validar el documento. '),
                       (2, 'La entidad enviada no se encuentra registrada. '), (3, 'La entidad enviada se encuentra en estado Inactiva.'),
                       (4, 'El documento no es un XML válido'), (5, 'El documento no se encuentra firmado'),
                       (6, 'La firma [Identificador de la firma] no contiene el tag QualifyingProperties o no se ha definido el prefijo Etsi [http://uri.etsi.org/01903/v1.3.2#].'),
                       (7, 'La firma con id [Identificador de la firma] contiene una estructura no valida.'),
                       (8, 'La firma con id [Identificador de la firma] contiene un certificado firmante con un formato no válido.'),
                       ...
                       (66, 'El documento no es válido.'), (67, 'En la firma con id [Identificador de la firma] el certificado contenido en la respuesta OCSP,  no coincide con el que se encuentra en el elemento CertificateValues.'),
...
ERRORES_VALIDAR_PDF = ((0, 'Documento válido.'), (1, 'Error interno al validar el documento.'),
                       (2, 'La entidad no se encuentra registrada.'), (3, 'La entidad enviada se encuentra en estado Inactiva.'),
                       (4, 'El documento no es un PDF válido.'), (5, 'El documento PDF no se encuentra firmado.'),
                       ...
                       (8, 'La secuencia de las firmas no es correcta.'), (9, 'En el documento firmado el DSS (Document Security Store) contiene [Cantidad de certificados]   certificados con un formato no válido.'),
...
ERRORES_VERIFICACION = ((0, 'Verificación recibida correctamente.'), (1, 'Ha ocurrido algún problema al verificar el estado de la firma.'),
                        (2, 'La entidad no se encuentra registrada.'), (3, 'La entidad se encuentra en estado inactiva.'))
...
def show_constants():
    __doc__ = '\nCódigos usados en pyfva\n=========================\n\n.. note:: \n    Los códigos aquí descritos son los usados por pyFVA pero no son los oficiales del FVA del BCCR ya que todavía no son públicos, aún así se intenta\n    ser 100%% compatible con los códigos oficiales, por lo que estos son una buena referencia\n\n\nHASH_METHODS\n---------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_AL_SOLICITAR_FIRMA\n----------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_AL_NOTIFICAR_FIRMA\n----------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\n\nERRORES_VALIDA_CERTIFICADO\n----------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_VALIDA_XMLCOFIRMA\n--------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_VALIDA_XMLCONTRAFIRMA\n------------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_VALIDA_MSOFFICE\n--------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_VALIDA_ODF\n--------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\nERRORES_VALIDA_PDF\n--------------------------\n\n=======\t============\nCódigo\tDescripción \n=======\t============\n%s\n=======\t============\n\n    ' % ('\n'.join(['%s\t%s' % (x, y) for x, y in HASH_METHODS]),
     ...
     '\n'.join(['%s\t%s' % (x, y) for x, y in ERRORES_VALIDAR_XMLCOFIRMA]),
     '\n'.join(['%s\t%s' % (x, y) for x, y in ERRORES_VALIDAR_XMLCONTRAFIRMA]),
     '\n'.join(['%s\t%s' % (x, y) for x, y in ERRORES_VALIDAR_MSOFFICE]),
     '\n'.join(['%s\t%s' % (x, y) for x, y in ERRORES_VALIDAR_ODF]),
     '\n'.join(['%s\t%s' % (x, y) for x, y in ERRORES_VALIDAR_PDF]))
    return __doc__