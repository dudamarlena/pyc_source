...
# Embedded file name: build/bdist.linux-x86_64/egg/pyfva/soap/firmador.py
# Compiled at: 2018-11-27 17:51:10
# Size of source mod 2**32: 14075 bytes
...
class SolicitudDeFirmaPdf(SolicitudDeFirma):
    ...
    @classmethod
    def create(cls, CodNegocio, FechaDeReferenciaDeLaEntidad, IDAlgoritmoHash, IdFuncionalidad, IdReferenciaEntidad, Lugar=None, RazonDeFirma=None):
        instance = cls()
        instance.CodNegocio = CodNegocio
        instance.FechaDeReferenciaDeLaEntidad = FechaDeReferenciaDeLaEntidad
        instance.IDAlgoritmoHash = IDAlgoritmoHash
...
Schema_c49e7 = xsd.Schema(imports=[], includes=[], targetNamespace=(settings.FVA_HOST),
 ...
 AlgoritmoDeHash],
  ...
  groups=[],
  complexTypes=[
 SolicitudDeFirma, ExtensionDataObject, RespuestaDeLaSolicitud, SolicitudDeFirmaPdf],
  elements={'RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma':xsd.Element(RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma()), 
...
RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma_method = xsd.Method(soapAction=(settings.FVA_HOST + 'RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma'),
  ...
  style='document')
RecibaLaSolicitudDeFirmaXmlEnvelopedContraFirma_method = xsd.Method(soapAction=(settings.FVA_HOST + 'RecibaLaSolicitudDeFirmaXmlEnvelopedContraFirma'),
  ...
  style='document')
RecibaLaSolicitudDeFirmaODF_method = xsd.Method(soapAction=(settings.FVA_HOST + 'RecibaLaSolicitudDeFirmaODF'),
  ...
  style='document')
RecibaLaSolicitudDeFirmaMSOffice_method = xsd.Method(soapAction=(settings.FVA_HOST + 'RecibaLaSolicitudDeFirmaMSOffice'),
  ...
  style='document')
RecibaLaSolicitudDeFirmaPdf_method = xsd.Method(soapAction=(settings.FVA_HOST + 'RecibaLaSolicitudDeFirmaPdf'),
  ...
  style='document')
ElSuscriptorEstaConectado_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ElSuscriptorEstaConectado'),
...
ValideElServicio_method = xsd.Method(soapAction=(settings.FVA_HOST + 'ValideElServicio'),
  ...
  style='document')
FirmadorSoap_SERVICE = soap.Service(name='FirmadorSoap',
 ...
 Schema_c49e7],
  ...
  methods=[
 RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma_method, RecibaLaSolicitudDeFirmaXmlEnvelopedContraFirma_method, RecibaLaSolicitudDeFirmaODF_method, RecibaLaSolicitudDeFirmaMSOffice_method, RecibaLaSolicitudDeFirmaPdf_method, ElSuscriptorEstaConectado_method, ValideElServicio_method])
