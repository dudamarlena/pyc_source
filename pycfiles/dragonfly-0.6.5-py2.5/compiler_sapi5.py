...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dragonfly\engines\compiler_sapi5.py
# Compiled at: 2009-03-16 04:05:32
"""
...
class Sapi5Compiler(CompilerBase):
    ...
    def _compile_rule(self, rule, grammar, grammar_handle):
        ...
        stack = [
         (
          collection_iter(rule_handle.InitialState.Transitions), None)]
        while stack:
