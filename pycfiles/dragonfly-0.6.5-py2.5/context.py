...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dragonfly\grammar\context.py
# Compiled at: 2009-03-19 13:26:02
"""
Context classes
============================================================================
...
class AppContext(Context):
    ...
    def __init__(self, executable=None, title=None, exclude=False):
        ...
        if isinstance(executable, str):
            ...
            raise TypeError('executable argument must be a string or None; received %r' % executable)
        if isinstance(title, str):
            self._title = title.lower()
        elif title is None:
            self._title = None
        else:
            raise TypeError('title argument must be a string or None; received %r' % title)
