...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dragonfly\actions\action_playback.py
# Compiled at: 2009-03-31 02:40:48
"""
Playback action
============================================================================
...
class Playback(ActionBase):
    ...
    speed = property(fget=_get_speed, fset=_set_speed, doc='Factor to speed up playback.')
