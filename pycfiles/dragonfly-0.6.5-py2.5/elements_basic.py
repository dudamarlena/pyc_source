...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dragonfly\grammar\elements_basic.py
...
class ElementBase(object):
    ...
    children = property(lambda self: self._get_children(), doc='Iterable of child elements.  (Read-only)')
    ...
    def compile(self, compiler):
        raise NotImplementedError('Call to virtual method compile() in base class ElementBase')
    ...
    def gstring(self):
        ...
        """
        raise NotImplementedError('Call to virtual method gstring() in base class ElementBase')
    ...
    def decode(self, state):
        ...
        """
        raise NotImplementedError('Call to virtual method decode() in base class ElementBase')
...
class Sequence(ElementBase):
    ...
    def __init__(self, children=(), name=None):
        ...
        self._children = self._copy_sequence(children, 'children', ElementBase)
    ...
    def gstring(self):
        return '(' + (' ').join(map(lambda e: e.gstring(), self._children)) + ')'
...
class Optional(ElementBase):
    ...
    def __init__(self, child, name=None):
        ...
        if not isinstance(child, ElementBase):
            raise TypeError('Child of %s object must be an ElementBase instance.' % self)
        self._child = child
        self._greedy = True
...
class Literal(ElementBase):
    ...
    def __init__(self, text, name=None, value=None):
        ...
        if not isinstance(text, (str, unicode)):
            raise TypeError('Text of %s object must be a string.' % self)
...
class RuleRef(ElementBase):
    ...
    def __init__(self, rule, name=None):
        ...
        if not isinstance(rule, Rule):
            raise TypeError('Rule object of %s object must be a Dragonfly rule.' % self)
        self._rule = rule
    ...
    def dependencies(self):
        return [
         self._rule] + self._rule.dependencies()
...
class ListRef(ElementBase):
    ...
    def __init__(self, name, list, key=None):
        ...
        if not isinstance(list, ListBase):
            raise TypeError('List object of %s object must be a Dragonfly list.' % self)
        self._list = list
        self._key = key
...
class DictListRef(ListRef):
    ...
    def __init__(self, name, dict, key=None):
        if not isinstance(dict, DictList):
            raise TypeError('Dict object of %s object must be a Dragonfly DictList.' % self)
