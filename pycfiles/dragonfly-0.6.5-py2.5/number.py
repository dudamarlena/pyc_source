...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dragonfly\language\en\number.py
# Compiled at: 2009-03-25 03:40:53
"""
This file implements Integer and Digits classes for the English language.

"""
from ..base.integer_base import MapIntBuilder, CollectionIntBuilder, MagnitudeIntBuilder, IntegerBase
from ..base.digits_base import DigitsBase
int_0 = MapIntBuilder({'zero': 0})
int_1_9 = MapIntBuilder({'one': 1, 
   'two': 2, 
   'three': 3, 
   'four': 4, 
   'five': 5, 
