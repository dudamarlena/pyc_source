...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/process_sat/map_helpers.py
...
def get_possible_cells((minRow, maxRow, minCol, maxCol), testPoly):
    ...
    function.  
    """
    tp_minRow, tp_minCol, tp_maxRow, tp_maxCol = tuple([ int(math.floor(lim)) for lim in testPoly.bounds ])
