...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/process_sat/filetypes.py
# Compiled at: 2014-11-20 12:43:27
"""
...
class OMI_NO2_KNMI_HDF_v2_0_preFeb2006_filetype:
    ...
    longitude = 'Longitude'
    pixIndXtrackAxis = 1
    outUnits = {'AirMassFactor': 'Unitless', 'AirMassFactorGeometric': 'Unitless', 
    ...
    extraDimLabel = {'AirMassFactor': 'none', 'AirMassFactorGeometric': 'none', 
    ...
    extraDimSize = {'AirMassFactor': 0, 'AirMassFactorGeometric': 0, 
...
class HDFnasaomil2_generic_filetype:
    parser = 'HDFnasaomil2'
    doutf = 'OMNO2e_netCDF_avg'
    parserParms = {'cornerFileList': ('To expedite file parsing time, the list of files containing geolocation information for the four corners (OMPIXCOR) may be passed in .  There must be one corner file for each of the input files.',
 'list'), 
       'cornerDir': ("Path to the directory containing corner files with geolocation information for the four corners (OMPIXCOR). If you do not want to use corners, set to 'none',and use nearest neighbor mapping.",
 'dirPath')}
...
class OMI_NO2_NASA_HDF_v1_2_filetype:
 ...
 'dirPath')}
    ...
    longitude = 'Longitude'
    pixIndXtrackAxis = 1
    outUnits = {'Time': 'second', 'Latitude': 'degree', 
    ...
    extraDimLabel = {'Time': 'none', 'Latitude': 'none', 
       'Longitude': 'none', 
    ...
    extraDimSize = {'Time': 0, 'Latitude': 0, 
       'Longitude': 0, 
...
class MOPITT_CO_NASA_HDF_V5_filetype:
    ...
    outUnits = {'Time': 'Seconds', 'Latitude': 'Degrees', 
       'Longitude': 'Degrees', 
    ...
    dimLabels = {'Time': [], 'Latitude': [], 'Longitude': [], 'Seconds in Day': [], 'Pressure Grid': [
                       'Layer'], 
       'Solar Zenith Angle': [], 'Satellite Zenith Angle': [], 'Surface Pressure': [], 'Retrieved Surface Temperature': [
                                       'ValueOrStandardDeviation'], 
       'Retrieved Surface Emissivity': [
                                      'ValueOrStandardDeviation'], 
       'Retrieved CO Mixing Ratio Profile': [
                                           'Layer', 'ValueOrStandardDeviation'], 
       ...
       'A Priori Surface Temperature': [
                                      'ValueOrStandardDeviation'], 
       'A Priori Surface Emissivity': [
                                     'ValueOrStandardDeviation'], 
       'A Priori CO Mixing Ratio Profile': [
                                          'Layer', 'ValueOrStandardDeviation'], 
       'A Priori CO Surface Mixing Ratio': [
                                          'ValueOrStandardDeviation'], 
       'Level 1 Radiances and Errors': [
                                      'Channel', 'Radiances/Errors'], 
       'Degrees of Freedom for Signal': [], 'Surface Index': [], 'DEM Altitude': [], 'Cloud Description': [], 'MODIS Cloud Diagnostics': [
                                 'flagIndex'], 
       'Water Vapor Climatology Content': [], 'Retrieval Iterations': [], 'Information Content Index': [], 'Signal Chi2': [], 'Swath Index ': [
                      'nthree']}
    dimSizes = {'Time': [], 'Latitude': [], 'Longitude': [], 'Seconds in Day': [], 'Pressure Grid': [
                       '9'], 
       'Solar Zenith Angle': [], 'Satellite Zenith Angle': [], 'Surface Pressure': [], 'Retrieved Surface Temperature': [
                                       '2'], 
       'Retrieved Surface Emissivity': [
...
class MODIS_AOD_NASA_Collection_5_filetype:
    ...
    longitude = 'Longitude'
    latitude = 'Latitude'
    outUnits = {'Scan_Start_Time': 'seconds', 'Solar_Zenith': 'degrees', 
    ...
    extraDimLabels = {'Scan_Start_Time': [], 'Solar_Zenith': [], 'Solar_Azimuth': [], 'Sensor_Zenith': [], 'Sensor_Azimuth': [], 'Scattering_Angle': [], 'Optical_Depth_Land_And_Ocean': [], 'Image_Optical_Depth_Land_And_Ocean': [], 'Optical_Depth_Ratio_Small_Land_And_Ocean': [], 'Mean_Reflectance_Land_All': [
                                   'Land Solution 3 (470,659,2130nm)'], 
       'Standard_Deviation_Reflectance_Land_All': [
                                                 'Land Solution 3 (470,659,2130nm)'], 
       'Path_Radiance_Land': [
                            'Land Solution 1 (470,659nm)'], 
       ...
       'QualityWeight_Critical_Reflectance_Land': [
                                                 'Land Solution 1 (470,659nm)'], 
       'Aerosol_Type_Land': [], 'Fitting_Error_Land': [], 'Surface_Reflectance_Land': [
                                  'Land Solution 2 (470,555,659nm)'], 
       'Corrected_Optical_Depth_Land': [
                                      'Land Solution 3 (470,659,2130nm)'], 
       'Corrected_Optical_Depth_Land_wav2p1': [], 'Optical_Depth_Small_Land': [
                                  'Land Solution 4 (0.47,0.55,0.66,2.13um)'], 
       'Optical_Depth_Ratio_Small_Land': [], 'Number_Pixels_Used_Land': [
                                 'Land Solution 1 (470,659nm)'], 
       'Mean_Reflectance_Land': [
                               'MODIS Band (470,555,659,865,1240,1640,2130nm)'], 
       'STD_Reflectance_Land': [
                              'MODIS Band (470,555,659,865,1240,1640,2130nm)'], 
       'Mass_Concentration_Land': [], 'Angstrom_Exponent_Land': [], 'Cloud_Fraction_Land': [], 'Aerosol_Cldmask_Byproducts_Land': [
                                         'Num_By_Products'], 
       'Solution_Index_Ocean_Small': [
                                    'Ocean Solution (best,average)'], 
       ...
       'Optical_Depth_by_models_ocean': [
                                       'Solution Index'], 
       'Cloud_Fraction_Ocean': [], 'Number_Pixels_Used_Ocean': [], 'Mean_Reflectance_Ocean': [
                                'MODIS Band (470,555,659,865,1240,1640,2130nm)'], 
       ...
       'Deep_Blue_Angstrom_Exponent_Land': [], 'Deep_Blue_Single_Scattering_Albedo_Land': [
                                                 'Num_DeepBlue_Wavelengths'], 
       ...
       'Deep_Blue_Number_Pixels_Used_Land': [
                                           'Num_DeepBlue_Wavelengths'], 
       'Deep_Blue_Aerosol_Optical_Depth_550_Land_STD': [], 'Deep_Blue_Aerosol_Optical_Depth_Land_STD': [
                                                  'Num_DeepBlue_Wavelengths']}
    extraDimSize = {'Scan_Start_Time': [], 'Solar_Zenith': [], 'Solar_Azimuth': [], 'Sensor_Zenith': [], 'Sensor_Azimuth': [], 'Scattering_Angle': [], 'Optical_Depth_Land_And_Ocean': [], 'Image_Optical_Depth_Land_And_Ocean': [], 'Optical_Depth_Ratio_Small_Land_And_Ocean': [], 'Mean_Reflectance_Land_All': [
                                   '3'], 
       'Standard_Deviation_Reflectance_Land_All': [
                                                 '3'], 
       'Path_Radiance_Land': [
...
class OMI_HCHO_NASA_HDF_v3_filetype:
...
class OMI_NO2_NASA_HDF_v3_filetype:
