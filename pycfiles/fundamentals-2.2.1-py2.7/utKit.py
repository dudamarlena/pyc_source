...
# Compiled at: 2020-05-13 05:33:41
"""
    ...
    **Usage**
    ...
    def refresh_database(self):
        ...
        *Refresh the unit test database*
        ...
        directory_script_runner(log=log, pathToScriptDirectory=packageDirectory + '/tests/input', dbConn=dbConn, successRule=None, failureRule=None)
        return
