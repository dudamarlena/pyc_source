...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/LSD/detecter/topologicsorting.py
# Compiled at: 2018-11-26 17:07:11
...
class Order:
    ...
    def __init__(self, source, sink):
        self.order = []
        self.revers = {source: -2, sink: math.inf, None: math.inf}
        self.pos = 0
