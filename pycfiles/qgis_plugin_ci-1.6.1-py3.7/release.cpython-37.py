...
# Size of source mod 2**32: 12644 bytes
...
def create_archive(parameters: Parameters, release_version: str, archive_name: str, add_translations: bool=False, allow_uncommitted_changes: bool=False, remove_debug: bool=False):
    repo = git.Repo()
