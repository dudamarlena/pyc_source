...
def main():
    ...
    package_parser.add_argument('--allow-uncommitted-changes',
      action='store_true', help='If False, uncommitted changes are not allowed before packaging. If True and some changes are detected, a hard reset on a stash create will be used to revert changes made by qgis-plugin-ci.')
