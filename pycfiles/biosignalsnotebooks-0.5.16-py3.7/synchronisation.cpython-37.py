...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\biosignalsnotebooks\synchronisation.py
# Compiled at: 2020-03-23 15:40:40
# Size of source mod 2**32: 22862 bytes
"""
...
/"""
import biosignalsnotebooks as bsnb, numpy as np
...
def synchronise_signals(in_signal_1, in_signal_2):
    ...
    mean_1, std_1, mean_2, std_2 = [
     np.mean(in_signal_1), np.std(in_signal_1), np.mean(in_signal_2),
     np.std(in_signal_2)]
    ...
    return (
     true_phase, result_signal_1, result_signal_2)
...
def create_synchronised_files(in_path=(('file1.txt', 'file2.txt'), ('file1.h5', 'file2.h5')), channels=(1, 1), file_name='sync_file'):
    """
    -----
    Brief
    -----
                            ...
                            for yet_another_key in list(file[key][other_key][another_key].keys()):
                                try:
                                    for y in list(file[key][other_key][another_key][yet_another_key].keys()):
                                        new_file.create_dataset(name=(key + '/' + other_key + '/' + another_key + '/' + yet_another_key + '/' + y),
                                          data=(file[key][other_key][another_key][yet_another_key][y]))
                                        for attribute in list(file[key][other_key][another_key][yet_another_key].attrs.items()):
                                            new_file[(key + '/' + other_key + '/' + another_key + '/' + yet_another_key + '/' + y)].attrs.__setitem__(name=(attribute[0]),
                                              value=(attribute[1]))

                                except:
                                    new_file.create_dataset(name=(key + '/' + other_key + '/' + another_key + '/' + yet_another_key),
                                      data=(file[key][other_key][another_key][yet_another_key]))
                                    for attribute in list(file[(key + '/' + other_key + '/' + another_key + '/' + yet_another_key)].attrs.items()):
                                        new_file[(key + '/' + other_key + '/' + another_key + '/' + yet_another_key)].attrs.__setitem__(name=(attribute[0]),
                                          value=(attribute[1]))

                        except:
                            new_file.create_dataset(name=(key + '/' + other_key + '/' + another_key), data=(list(file[key][other_key][another_key])))
                            for attribute in list(file[(key + '/' + other_key + '/' + another_key)].attrs.items()):
                                new_file[(key + '/' + other_key + '/' + another_key)].attrs.__setitem__(name=(attribute[0]), value=(attribute[1]))
