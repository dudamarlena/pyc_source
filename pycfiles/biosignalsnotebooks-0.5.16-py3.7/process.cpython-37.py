...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\biosignalsnotebooks\process.py
# Compiled at: 2020-03-23 15:40:40
# Size of source mod 2**32: 15822 bytes
"""
...
def poincare(data, sample_rate, signal=False, in_seconds=False):
    ...
    """
    tachogram_data = tachogram(data, sample_rate, signal=signal, in_seconds=in_seconds, out_seconds=True)[0]
