...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/wareweb/timeinterval.py
...
month = day * 30
year = day * 365
time_values = {'y': year, 'b': month, 'w': week, 'd': day, 'h': hour, 'm': minute, 's': second}
