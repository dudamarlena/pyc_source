...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/wareweb/funcs.py
# Compiled at: 2006-10-22 17:17:11
"""
General-(web-)purpose functions for use in your applications.
"""
import cgi, urllib, re, datetime
__all__ = [
 'html_quote', 'url_quote', 'html_quote_whitespace']
...
def format_date_relative(date):
    ...
    if isinstance(date, datetime.datetime):
        ...
        raise ValueError('Unknown type of date: %r' % date)
    year = date.year
    month = date.month
    day = date.day
    if now.year == year:
