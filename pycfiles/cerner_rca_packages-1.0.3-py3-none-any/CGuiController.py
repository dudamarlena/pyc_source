...
# Embedded file name: build/bdist.macosx-10.6-intel/egg/gui/cGui/controller/CGuiController.py
# Compiled at: 2012-04-22 17:09:04
...
class CGuiController(object):
    ...
    def getNessusFile(self):
        ...
        Returns:
            ...
            was cancelled.
        """
        return askopenfilename(title='Search for a .nessus file', filetypes=[
...
if __name__ == '__main__':
    app = CGuiController({'item 1': '1', 'item 2': '2', 'item 3': '3', 'item 4': '4', 
       'item 5': '5', 'item 6': '6', 'item 7': '7', 
       'item 8': '8', 'item 9': '9', 'item 10': '10', 
       'item 11': '11', 'item 12': '12', 'item 13': '13'}, None)
    app.show()