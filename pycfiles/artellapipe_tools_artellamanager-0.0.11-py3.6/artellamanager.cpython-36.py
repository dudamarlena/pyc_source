...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/artellamanager/core/artellamanager.py
...
class ArtellapipeManagerToolset(artellapipe.Toolset, object):
    ...
    def contents(self):
        ...
        artella_manager = artellamanagertool.ArtellaManager(project=(self._project),
          config=(self._config),
