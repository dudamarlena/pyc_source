...
# [GCC 8.4.0]
# Embedded file name: /home/travis/virtualenv/python3.6.7/lib/python3.6/site-packages/satella/imports.py
# Compiled at: 2020-04-25 10:46:39
# Size of source mod 2**32: 4073 bytes
import importlib, os, pkgutil, warnings, typing as tp
__all__ = [
 'import_from', 'import_class']
...
def import_from(path: tp.List[str], package_prefix: str, all_: tp.List[str], locals: tp.Dict[(str, tp.Any)], recursive: bool=True, fail_on_attributerror: bool=True, create_all: bool=True, skip_single_underscores: bool=True, skip_not_having_all: bool=False) -> None:
    """
    ...
    for importer, modname, ispkg in pkgutil.walk_packages(path, onerror=(lambda x: None)):
        if recursive and ispkg:
            ...
            (
             import_from([os.path.join(path[0], modname)], (package_prefix + '.' + modname), mod_all, (module.__dict__),
               recursive=recursive, fail_on_attributerror=fail_on_attributerror,
