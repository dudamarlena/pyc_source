...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pyvb/state.py
# Compiled at: 2008-04-30 13:25:57
...
class vbStateParser(vbParser):
    ...
    def __init__(self):
        ...
        self.attributes = {'name': VB_RE_STATE_NAME, 'date': VB_RE_STATE_DATE}
    ...
    def parse(self, file):
        ...
        for result in self._parse(file):
            found_state = vbState(name=result['name'], date=result['date'])
