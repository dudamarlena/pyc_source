...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pyvb/ostype.py
# Compiled at: 2008-04-30 13:25:18
"""
...
class vbOsTypeParser(vbParser):
    ...
    def __init__(self):
        ...
        self.attributes = {'id': VB_RE_ID, 'description': VB_RE_DESCRIPTION}
    ...
    def parse(self, file):
        ...
        for result in self._parse(file):
            found_os = vbOsType(id=result['id'], description=result['description'])
