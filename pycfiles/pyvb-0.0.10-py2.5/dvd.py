...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pyvb/dvd.py
# Compiled at: 2008-04-30 13:24:55
"""
...
class vbDvdParser(vbParser):
    ...
    def __init__(self):
        ...
        self.found_attributes = {}
        self.attributes = {'uuid': VB_RE_UUID, 'path': VB_RE_PATH, 
    ...
    def parse(self, file):
        ...
        dvds = []
        for result in self._parse(file):
            found_dvd = vbDvd(uuid=result['uuid'], path=result['path'], accessible=result['accessible'])
