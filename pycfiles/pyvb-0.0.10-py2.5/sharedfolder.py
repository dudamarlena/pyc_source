...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pyvb/sharedfolder.py
# Compiled at: 2008-04-30 13:25:39
...
class vbSharedFolderParser(vbParser):
    ...
    def __init__(self):
        ...
        self.attributes = {'name': VB_RE_SHAREDFOLDER_PATH, 'path': VB_RE_SHAREDFOLDER_PATH}
    ...
    def parse(self, file):
        ...
        for result in self._parse(file):
            found_folder = vbSharedFolder(name=result['name'], path=result['path'])
