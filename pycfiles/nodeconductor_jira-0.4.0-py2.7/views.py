...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nodeconductor_jira/views.py
...
class IssueViewSet(JiraPermissionMixin, structure_views.BaseResourcePropertyExecutorViewSet):
...
class CommentViewSet(JiraPermissionMixin, structure_views.BaseResourcePropertyExecutorViewSet):
...
class AttachmentViewSet(JiraPermissionMixin, core_mixins.CreateExecutorMixin, core_mixins.DeleteExecutorMixin, viewsets.ModelViewSet):
