...
# [GCC 8.4.0]
# Embedded file name: /home/thejoeejoee/projects/VUT-FIT-IFJ-2017-tests/ifj2017/interpreter/exceptions.py
# Compiled at: 2017-12-06 12:03:26
...
class InvalidCodeException(ValueError):
    ...
    def __str__(self):
        messages = {self.UNKNOWN_INSTRUCTION: 'Unknown instruction on line {self.line_index}: {self.line}.', 
        ...
        return messages.get(self._type, 'Invalid line {self.line_index}: {self.line}.').format(self=self)
