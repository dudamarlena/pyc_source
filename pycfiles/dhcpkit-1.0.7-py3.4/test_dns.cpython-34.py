...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/ipv6/extensions/test_dns.py
...
class RecursiveNameServersOptionTestCase(test_option.OptionTestCase):
    ...
    def setUp(self):
        self.option_bytes = bytes.fromhex('0017002020010db800000000000000000000000120010db8000000000000000000000002')
