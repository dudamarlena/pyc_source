...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/ipv6/extensions/sip_servers.py
...
class SIPServersAddressListOption(Option):
    ...
    def validate(self):
        ...
        for address in self.sip_servers:
            if not isinstance(address, IPv6Address) or address.is_link_local or address.is_loopback or address.is_multicast or address.is_unspecified:
