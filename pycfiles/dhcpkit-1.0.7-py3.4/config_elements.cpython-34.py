...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/ipv6/server/config_elements.py
# Compiled at: 2016-10-20 18:25:43
    ...
    def clean_config_section(self):
        ...
        if self.section.group is None:
            try:
                ...
                raise ValueError('User {} has a non-existent primary group {}'.format(self.section.user.pw_name, self.section.user.pw_gid))
