...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/test_protocol_element.py
# Compiled at: 2017-06-23 19:09:49
# Size of source mod 2**32: 22895 bytes
"""
...
from dhcpkit.protocol_element import ElementDataRepresentation, JSONProtocolElementEncoder, ProtocolElement, UnknownProtocolElement
...
class JSONEncodingTestCase(unittest.TestCase):
    ...
    def test_str_no_parameters(self):
        element = DemoElement()
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"DemoElement": {}}')

    def test_str_one_parameter(self):
        element = OneParameterDemoElement(DemoElement())
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": {"DemoElement": {}}}}')
        element = OneParameterDemoElement(one=DemoElement())
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": {"DemoElement": {}}}}')
        element = OneParameterDemoElement(one=TwoParameterDemoElement(1608, DemoElement()))
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": {"TwoParameterDemoElement": {"one": 1608, "two": {"DemoElement": {}}}}}}')
        element = OneParameterDemoElement(IPv6Address('2001:0db8::0001'))
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": "2001:db8::1"}}')
        element = OneParameterDemoElement(b'Printable')
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": "Printable"}}')
        element = OneParameterDemoElement(bytes.fromhex('012345'))
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": "hex:012345"}}')
        element = OneParameterDemoElement(bytes.fromhex('e0'))
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"OneParameterDemoElement": {"one": "hex:e0"}}')
    ...
    def test_str_two_parameters(self):
        element = TwoParameterDemoElement(1608, DemoElement())
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"TwoParameterDemoElement": {"one": 1608, "two": {"DemoElement": {}}}}')
    ...
    def test_str_three_parameters(self):
        element = ThreeParameterDemoElement(1608, 'Something', [
         ...
         OneParameterDemoElement(DemoElement()),
         TwoParameterDemoElement(1608, TwoParameterDemoElement(1608, DemoElement()))])
        self.assertEqual(json.dumps(element, cls=JSONProtocolElementEncoder), '{"ThreeParameterDemoElement": {"one": 1608, "two": "Something", "three": [{"DemoElement": {}}, {"OneParameterDemoElement": {"one": {"DemoElement": {}}}}, {"TwoParameterDemoElement": {"one": 1608, "two": {"TwoParameterDemoElement": {"one": 1608, "two": {"DemoElement": {}}}}}}]}}')
