...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/ipv6/extensions/test_ntp.py
# Compiled at: 2017-06-23 17:22:45
# Size of source mod 2**32: 10182 bytes
"""
Test the NTP option implementation
"""
import unittest
from ipaddress import IPv6Address
from dhcpkit.ipv6.extensions.ntp import NTPMulticastAddressSubOption, NTPServerAddressSubOption, NTPServerFQDNSubOption, NTPServersOption, NTPSubOption, UnknownNTPSubOption
from dhcpkit.tests.ipv6.options import test_option

class NTPServersOptionTestCase(test_option.OptionTestCase):

    def setUp(self):
        self.option_bytes = bytes.fromhex('0038004b0001001020010db800000000000000000000000100020010ff12000000000000000000000000abcd00030011') + b'\x03ntp\x08steffann\x02nl\x00' + bytes.fromhex('ffff000a') + b'RandomData'
