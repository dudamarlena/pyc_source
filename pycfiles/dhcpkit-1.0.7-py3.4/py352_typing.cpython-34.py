...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/typing/py352_typing.py
# Compiled at: 2016-08-11 09:08:09
# Size of source mod 2**32: 59537 bytes
import abc
...
class Final:
    __doc__ = 'Mix-in class to prevent instantiation.'
    __slots__ = ()
...
class _ForwardRef(TypingMeta):
    __doc__ = 'Wrapper to hold a forward reference.'
        ...
        for t1 in params:
            ...
            if not isinstance(t1, type):
                if not callable(t1):
                    ...
                    continue
            if any(isinstance(t2, type) and issubclass(t1, t2) for t2 in all_params - {t1} if not isinstance(t2, TypeVar)):
...
class OptionalMeta(TypingMeta):
    __doc__ = 'Metaclass for Optional.'
...
class TupleMeta(TypingMeta):
    ...
    def __eq__(self, other):
        if not isinstance(other, TupleMeta):
            return NotImplemented
        return self.__tuple_params__ == other.__tuple_params__ and self.__tuple_use_ellipsis__ == other.__tuple_use_ellipsis__
...
class CallableMeta(TypingMeta):
    __doc__ = 'Metaclass for Callable.'

    def __new__(cls, name, bases, namespace, _root=False, args=None, result=None):
...
class GenericMeta(TypingMeta, abc.ABCMeta):
    ...
    def __new__(cls, name, bases, namespace, tvars=None, args=None, origin=None, extra=None):
    ...
    def __repr__(self):
        if self.__origin__ is not None:
            ...
            r = super().__repr__()
        if self.__args__:
            r += '[%s]' % ', '.join(_type_repr(p) for p in self.__args__)
        if self.__parameters__:
    ...
    def __eq__(self, other):
        if not isinstance(other, GenericMeta):
            ...
            if self.__origin__ is not None:
                return self.__origin__ is other.__origin__ and self.__args__ == other.__args__ and self.__parameters__ == other.__parameters__
    ...
    def __getitem__(self, params):
        ...
        return self.__class__(self.__name__, (
         self,) + self.__bases__, dict(self.__dict__), tvars=tvars, args=args, origin=self, extra=self.__extra__)
 ...
 L.1044         0  LOAD_FAST                'cls'
                3  LOAD_GLOBAL              Any
                6  COMPARE_OP               is
                9  POP_JUMP_IF_FALSE    16  'to 16'

 L.1045        12  LOAD_CONST               True
               15  RETURN_END_IF    
             16_0  COME_FROM             9  '9'

 L.1046        16  LOAD_GLOBAL              isinstance
               19  LOAD_FAST                'cls'
               22  LOAD_GLOBAL              GenericMeta
               25  CALL_FUNCTION_2       2  '2 positional, 0 named'
               28  POP_JUMP_IF_FALSE   308  'to 308'

 L.1049        31  LOAD_FAST                'self'
               34  LOAD_ATTR                __origin__
               37  STORE_FAST               'origin'

 L.1050        40  LOAD_FAST                'origin'
               43  LOAD_CONST               None
               46  COMPARE_OP               is-not
               49  POP_JUMP_IF_FALSE   308  'to 308'
               52  LOAD_FAST                'origin'
               55  LOAD_FAST                'cls'
               58  LOAD_ATTR                __origin__
               61  COMPARE_OP               is
               64  POP_JUMP_IF_FALSE   308  'to 308'

 L.1051        67  LOAD_GLOBAL              len
               70  LOAD_FAST                'self'
               73  LOAD_ATTR                __args__
               76  CALL_FUNCTION_1       1  '1 positional, 0 named'
               79  LOAD_GLOBAL              len
               82  LOAD_FAST                'origin'
               85  LOAD_ATTR                __parameters__
 ...
 L.1052       103  LOAD_GLOBAL              len
              106  LOAD_FAST                'cls'
              109  LOAD_ATTR                __args__
              112  CALL_FUNCTION_1       1  '1 positional, 0 named'
              115  LOAD_GLOBAL              len
              118  LOAD_FAST                'origin'
              121  LOAD_ATTR                __parameters__
              124  CALL_FUNCTION_1       1  '1 positional, 0 named'
              127  COMPARE_OP               ==
              130  POP_JUMP_IF_TRUE    139  'to 139'
              133  LOAD_ASSERT              AssertionError
              136  RAISE_VARARGS_1       1  'exception'
            139_0  COME_FROM           130  '130'

 L.1053       139  SETUP_LOOP          305  'to 305'
              142  LOAD_GLOBAL              zip
              145  LOAD_FAST                'self'
              148  LOAD_ATTR                __args__

 L.1054       151  LOAD_FAST                'cls'
              154  LOAD_ATTR                __args__

 L.1055       157  LOAD_FAST                'origin'
              160  LOAD_ATTR                __parameters__
              163  CALL_FUNCTION_3       3  '3 positional, 0 named'
              166  GET_ITER         
              167  FOR_ITER            297  'to 297'
              170  UNPACK_SEQUENCE_3     3 
              173  STORE_FAST               'p_self'
              176  STORE_FAST               'p_cls'
              179  STORE_FAST               'p_origin'

 L.1056       182  LOAD_GLOBAL              isinstance
              185  LOAD_FAST                'p_origin'
              188  LOAD_GLOBAL              TypeVar
              191  CALL_FUNCTION_2       2  '2 positional, 0 named'
              194  POP_JUMP_IF_FALSE   278  'to 278'

 L.1057       197  LOAD_FAST                'p_origin'
              200  LOAD_ATTR                __covariant__
              203  POP_JUMP_IF_FALSE   228  'to 228'

 L.1059       206  LOAD_GLOBAL              issubclass
              209  LOAD_FAST                'p_cls'
              212  LOAD_FAST                'p_self'
              215  CALL_FUNCTION_2       2  '2 positional, 0 named'
              218  POP_JUMP_IF_TRUE    275  'to 275'

 L.1060       221  BREAK_LOOP       
              222  JUMP_ABSOLUTE       275  'to 275'
              225  JUMP_ABSOLUTE       294  'to 294'
              228  ELSE                     '275'

 L.1061       228  LOAD_FAST                'p_origin'
              231  LOAD_ATTR                __contravariant__
              234  POP_JUMP_IF_FALSE   259  'to 259'

 L.1063       237  LOAD_GLOBAL              issubclass
              240  LOAD_FAST                'p_self'
              243  LOAD_FAST                'p_cls'
              246  CALL_FUNCTION_2       2  '2 positional, 0 named'
              249  POP_JUMP_IF_TRUE    275  'to 275'

 L.1064       252  BREAK_LOOP       
              253  JUMP_ABSOLUTE       275  'to 275'
              256  JUMP_ABSOLUTE       294  'to 294'
              259  ELSE                     '275'

 L.1067       259  LOAD_FAST                'p_self'
              262  LOAD_FAST                'p_cls'
              265  COMPARE_OP               !=
              268  POP_JUMP_IF_FALSE   294  'to 294'

 L.1068       271  BREAK_LOOP       
              272  JUMP_ABSOLUTE       294  'to 294'
              275  JUMP_BACK           167  'to 167'

 L.1072       278  LOAD_FAST                'p_self'
              281  LOAD_FAST                'p_cls'
              284  COMPARE_OP               !=
              287  POP_JUMP_IF_FALSE   167  'to 167'

 L.1073       290  BREAK_LOOP       
              294  JUMP_BACK           167  'to 167'
              297  POP_BLOCK        

 L.1075       298  LOAD_CONST               True
              301  RETURN_END_IF    
            302_0  COME_FROM_LOOP      139  '139'
            302_1  COME_FROM            64  '64'
              302  JUMP_ABSOLUTE       308  'to 308'
              305  JUMP_FORWARD        308  'to 308'
            308_0  COME_FROM           305  '305'

 L.1077       308  LOAD_GLOBAL              super
              311  CALL_FUNCTION_0       0  '0 positional, 0 named'
              314  LOAD_ATTR                __subclasscheck__
              317  LOAD_FAST                'cls'
              320  CALL_FUNCTION_1       1  '1 positional, 0 named'
              323  POP_JUMP_IF_FALSE   330  'to 330'

 L.1078       326  LOAD_CONST               True
              329  RETURN_END_IF    
            330_0  COME_FROM           323  '323'

 L.1079       330  LOAD_FAST                'self'
              333  LOAD_ATTR                __extra__
              336  LOAD_CONST               None
              339  COMPARE_OP               is
              342  POP_JUMP_IF_TRUE    360  'to 360'
              345  LOAD_GLOBAL              isinstance
              348  LOAD_FAST                'cls'
              351  LOAD_GLOBAL              GenericMeta
              354  CALL_FUNCTION_2       2  '2 positional, 0 named'
            357_0  COME_FROM           342  '342'
              357  POP_JUMP_IF_FALSE   364  'to 364'

 L.1080       360  LOAD_CONST               False
              363  RETURN_END_IF    
            364_0  COME_FROM           357  '357'

 L.1081       364  LOAD_GLOBAL              issubclass
              367  LOAD_FAST                'cls'
              370  LOAD_FAST                'self'
              373  LOAD_ATTR                __extra__
              376  CALL_FUNCTION_2       2  '2 positional, 0 named'
              379  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `RETURN_END_IF' instruction at offset 301
        ...
        for base in protocol_bases:
            for attr in base.__dict__.keys():
                for c in self.__mro__:
                    ...
                    if not attr.startswith('_abc_') and attr != '__abstractmethods__' and attr != '_is_protocol' and attr != '__dict__' and attr != '__args__' and attr != '__slots__' and attr != '_get_protocol_attrs' and attr != '__next_in_mro__' and attr != '__parameters__' and attr != '__origin__' and attr != '__extra__' and attr != '__module__':
                        attrs.add(attr)
...
class DefaultDict(collections.defaultdict, MutableMapping[(KT, VT)], extra=collections.defaultdict):
    ...
    def __new__(cls, *args, **kwds):
        if _geqv(cls, DefaultDict):
            raise TypeError('Type DefaultDict cannot be instantiated; use collections.defaultdict() instead')
