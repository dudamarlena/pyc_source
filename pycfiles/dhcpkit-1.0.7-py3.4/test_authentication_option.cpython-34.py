...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/ipv6/options/test_authentication_option.py
...
class AuthenticationOptionTestCase(test_option.OptionTestCase):
    ...
    def setUp(self):
        ...
        self.option_object = AuthenticationOption(protocol=18, algorithm=52, rdm=86, replay_detection=b'x\x90\xab\xcd\xef\x13W\x9a', auth_info=b'\xe8\x9f')
        self.parse_option()
