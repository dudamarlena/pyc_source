...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/utils/test_domain_name.py
...
"""
import unittest
from dhcpkit.utils import encode_domain, encode_domain_list, parse_domain_bytes, parse_domain_list_bytes, validate_domain_label
...
class DomainNameTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.oversized_label_bytes = b'\x0410wwGsteffann-steffann-steffann-steffann-steffann-steffann-steffann-steffann\x02nl\x00'
        self.oversized_label_name = '10ww.steffann-steffann-steffann-steffann-steffann-steffann-steffann-steffann.nl'
        self.oversized_domain_bytes = b'\x0410ww>steffann-steffann-steffann-steffann-steffann-steffann-steffann>steffann-steffann-steffann-steffann-steffann-steffann-steffann>steffann-steffann-steffann-steffann-steffann-steffann-steffann>steffann-steffann-steffann-steffann-steffann-steffann-steffann\x02nl\x00'
        self.oversized_relative_domain_bytes = b'\x0410ww>steffann-steffann-steffann-steffann-steffann-steffann-steffann>steffann-steffann-steffann-steffann-steffann-steffann-steffann>steffann-steffann-steffann-steffann-steffann-steffann-steffann>steffann-steffann-steffann-steffann-steffann-steffann-steffann'
        self.oversized_domain_name = '10ww.steffann-steffann-steffann-steffann-steffann-steffann-steffann.steffann-steffann-steffann-steffann-steffann-steffann-steffann.steffann-steffann-steffann-steffann-steffann-steffann-steffann.steffann-steffann-steffann-steffann-steffann-steffann-steffann.nl'
        self.idn_domain_bytes = b'\x03www\x07example\x0bxn--j6w193g\x00'
        self.idn_domain_name = 'www.example.香港.'
        self.idn_oversized_label_bytes = b'\x0410wwCstffnn-steffann-steffann-steffann-steffann-steffann-steffann-o8e12a\x02nl\x00'
        self.idn_oversized_label_name = '10ww.stéffänn-steffann-steffann-steffann-steffann-steffann-steffann.nl'
    ...
    def test_parse_oversized_domain(self):
        self.assertRaisesRegex(ValueError, 'Domain too long', parse_domain_bytes, self.oversized_domain_bytes)

    def test_parse_oversized_relative_domain(self):
        self.assertRaisesRegex(ValueError, 'Domain too long', parse_domain_bytes, self.oversized_relative_domain_bytes, allow_relative=True)
    ...
    def test_parse_idn_oversized_label(self):
        self.assertRaisesRegex(ValueError, 'Label too long', parse_domain_bytes, self.idn_oversized_label_bytes)

    def test_encode_idn_oversized_label(self):
        self.assertRaisesRegex(ValueError, 'Label too long', encode_domain, self.idn_oversized_label_name)

    def test_parse_oversized_label(self):
        self.assertRaisesRegex(ValueError, 'Label too long', parse_domain_bytes, self.oversized_label_bytes)

    def test_encode_oversized_label(self):
        self.assertRaisesRegex(ValueError, 'Label too long', encode_domain, self.oversized_label_name)
