...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/ipv6/messages/test_reply_message.py
...
reply_message = ReplyMessage(transaction_id=bytes.fromhex('f350d6'), options=[
...
reply_packet = codecs.decode('', 'hex')
