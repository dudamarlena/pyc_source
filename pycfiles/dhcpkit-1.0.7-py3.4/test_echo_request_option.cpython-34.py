...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/ipv6/extensions/test_echo_request_option.py
...
class EchoRequestOptionTestCase(test_option.OptionTestCase):
    ...
    def test_validate_requested_options(self):
        ...
        self.option.requested_options = [
         OPTION_SUBSCRIBER_ID, -1, OPTION_REMOTE_ID]
        ...
        self.option.validate()
        self.option.requested_options = [
         OPTION_SUBSCRIBER_ID, 65536, OPTION_REMOTE_ID]
        with self.assertRaisesRegex(ValueError, 'unsigned 16 bit integer'):
            self.option.validate()
    ...
    def test_display_requested_options(self):
        ...
        self.assertRegex(representation[0], ' \\(79\\)$')
        self.assertRegex(representation[1], ' \\(38\\)$')
        self.assertRegex(representation[2], ' \\(65535\\)$')
