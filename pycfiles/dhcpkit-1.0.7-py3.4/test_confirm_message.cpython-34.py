...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit/tests/ipv6/messages/test_confirm_message.py
...
from dhcpkit.ipv6.options import ClientIdOption, ElapsedTimeOption, IAAddressOption, IANAOption, OPTION_IA_NA, OPTION_VENDOR_OPTS, OptionRequestOption, VendorClassOption
from dhcpkit.tests.ipv6.messages import test_client_server_message
confirm_message = ConfirmMessage(transaction_id=bytes.fromhex('f350d6'), options=[
...
confirm_packet = codecs.decode('', 'hex')
