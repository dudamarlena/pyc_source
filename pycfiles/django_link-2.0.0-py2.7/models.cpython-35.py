...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/django-link/link/models.py
# Compiled at: 2018-05-10 08:06:24
        ...
        if self.view_name:
            ...
            if self.target:
                ...
                if not self.url.startswith('/'):
                    ...
                    return self.url.startswith(root) or root.rstrip('/') + '/' + self.url.lstrip('/')
            return self.url