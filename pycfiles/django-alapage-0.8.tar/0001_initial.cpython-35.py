...
# [GCC 8.4.0]
# Embedded file name: /home/ggg/www/dev/mogos/mogo51/mogo/alapage/migrations/0001_initial.py
# Compiled at: 2017-06-14 08:51:59
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Page', fields=[
      ...
      (
       'users_only', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Reserved to some users'))], options={'verbose_name': 'Page', 
      'ordering': ['url'], 
