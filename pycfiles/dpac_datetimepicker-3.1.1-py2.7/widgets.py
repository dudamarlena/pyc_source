...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/bootstrap3_datetime/widgets.py
# Compiled at: 2018-10-16 17:19:01
...
class DateTimePicker(DateTimeInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        html = self.html_template % dict(div_attrs=flatatt(div_attrs), input_attrs=flatatt(input_attrs), icon_attrs=flatatt(icon_attrs))
        if self.options:
