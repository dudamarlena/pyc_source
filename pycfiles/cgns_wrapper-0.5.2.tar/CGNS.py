...
# Embedded file name: /usr/lib64/python2.6/site-packages/CGNS/CGNS.py
# Compiled at: 2009-10-30 11:38:05
import _CGNS, new
...
class intArray(_object):
    ...
    def __getitem__(*args):
        return _CGNS.intArray___getitem__(*args)

    def __setitem__(*args):
        return _CGNS.intArray___setitem__(*args)

    def cast(*args):
        return _CGNS.intArray_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.intArray_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.intArray_frompointer)
...
class floatArray(_object):
    ...
    def __getitem__(*args):
        return _CGNS.floatArray___getitem__(*args)

    def __setitem__(*args):
        return _CGNS.floatArray___setitem__(*args)

    def cast(*args):
        return _CGNS.floatArray_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.floatArray_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.floatArray_frompointer)
...
class doubleArray(_object):
    ...
    def __getitem__(*args):
        return _CGNS.doubleArray___getitem__(*args)

    def __setitem__(*args):
        return _CGNS.doubleArray___setitem__(*args)

    def cast(*args):
        return _CGNS.doubleArray_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.doubleArray_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.doubleArray_frompointer)
...
class intp(_object):
    ...
    def assign(*args):
        return _CGNS.intp_assign(*args)

    def value(*args):
        return _CGNS.intp_value(*args)

    def cast(*args):
        return _CGNS.intp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.intp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.intp_frompointer)
...
class floatp(_object):
    ...
    def assign(*args):
        return _CGNS.floatp_assign(*args)

    def value(*args):
        return _CGNS.floatp_value(*args)

    def cast(*args):
        return _CGNS.floatp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.floatp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.floatp_frompointer)
...
class doublep(_object):
    ...
    def assign(*args):
        return _CGNS.doublep_assign(*args)

    def value(*args):
        return _CGNS.doublep_value(*args)

    def cast(*args):
        return _CGNS.doublep_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.doublep_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.doublep_frompointer)
...
class charp(_object):
    ...
    def assign(*args):
        return _CGNS.charp_assign(*args)

    def value(*args):
        return _CGNS.charp_value(*args)

    def cast(*args):
        return _CGNS.charp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.charp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.charp_frompointer)
...
class ZoneType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.ZoneType_tp_assign(*args)

    def value(*args):
        return _CGNS.ZoneType_tp_value(*args)

    def cast(*args):
        return _CGNS.ZoneType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.ZoneType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.ZoneType_tp_frompointer)
...
class AngleUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.AngleUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.AngleUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.AngleUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.AngleUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.AngleUnits_tp_frompointer)
...
class MassUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.MassUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.MassUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.MassUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.MassUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.MassUnits_tp_frompointer)
...
class LengthUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.LengthUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.LengthUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.LengthUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.LengthUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.LengthUnits_tp_frompointer)
...
class TimeUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.TimeUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.TimeUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.TimeUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.TimeUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.TimeUnits_tp_frompointer)
...
class TemperatureUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.TemperatureUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.TemperatureUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.TemperatureUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.TemperatureUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.TemperatureUnits_tp_frompointer)
...
class ElectricCurrentUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.ElectricCurrentUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.ElectricCurrentUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.ElectricCurrentUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.ElectricCurrentUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.ElectricCurrentUnits_tp_frompointer)
...
class LuminousIntensityUnits_tp(_object):
    ...
    def assign(*args):
        return _CGNS.LuminousIntensityUnits_tp_assign(*args)

    def value(*args):
        return _CGNS.LuminousIntensityUnits_tp_value(*args)

    def cast(*args):
        return _CGNS.LuminousIntensityUnits_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.LuminousIntensityUnits_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.LuminousIntensityUnits_tp_frompointer)
...
class DataClass_tp(_object):
    ...
    def assign(*args):
        return _CGNS.DataClass_tp_assign(*args)

    def value(*args):
        return _CGNS.DataClass_tp_value(*args)

    def cast(*args):
        return _CGNS.DataClass_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.DataClass_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.DataClass_tp_frompointer)
...
class GridLocation_tp(_object):
    ...
    def assign(*args):
        return _CGNS.GridLocation_tp_assign(*args)

    def value(*args):
        return _CGNS.GridLocation_tp_value(*args)

    def cast(*args):
        return _CGNS.GridLocation_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.GridLocation_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.GridLocation_tp_frompointer)
...
class GridConnectivityType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.GridConnectivityType_tp_assign(*args)

    def value(*args):
        return _CGNS.GridConnectivityType_tp_value(*args)

    def cast(*args):
        return _CGNS.GridConnectivityType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.GridConnectivityType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.GridConnectivityType_tp_frompointer)
...
class BCDataType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.BCDataType_tp_assign(*args)

    def value(*args):
        return _CGNS.BCDataType_tp_value(*args)

    def cast(*args):
        return _CGNS.BCDataType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.BCDataType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.BCDataType_tp_frompointer)
...
class PointSetType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.PointSetType_tp_assign(*args)

    def value(*args):
        return _CGNS.PointSetType_tp_value(*args)

    def cast(*args):
        return _CGNS.PointSetType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.PointSetType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.PointSetType_tp_frompointer)
...
class GoverningEquationsType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.GoverningEquationsType_tp_assign(*args)

    def value(*args):
        return _CGNS.GoverningEquationsType_tp_value(*args)

    def cast(*args):
        return _CGNS.GoverningEquationsType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.GoverningEquationsType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.GoverningEquationsType_tp_frompointer)
...
class ModelType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.ModelType_tp_assign(*args)

    def value(*args):
        return _CGNS.ModelType_tp_value(*args)

    def cast(*args):
        return _CGNS.ModelType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.ModelType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.ModelType_tp_frompointer)
...
class BCType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.BCType_tp_assign(*args)

    def value(*args):
        return _CGNS.BCType_tp_value(*args)

    def cast(*args):
        return _CGNS.BCType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.BCType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.BCType_tp_frompointer)
...
class DataType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.DataType_tp_assign(*args)

    def value(*args):
        return _CGNS.DataType_tp_value(*args)

    def cast(*args):
        return _CGNS.DataType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.DataType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.DataType_tp_frompointer)
...
class ElementType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.ElementType_tp_assign(*args)

    def value(*args):
        return _CGNS.ElementType_tp_value(*args)

    def cast(*args):
        return _CGNS.ElementType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.ElementType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.ElementType_tp_frompointer)
...
class ArbitraryGridMotionType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.ArbitraryGridMotionType_tp_assign(*args)

    def value(*args):
        return _CGNS.ArbitraryGridMotionType_tp_value(*args)

    def cast(*args):
        return _CGNS.ArbitraryGridMotionType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.ArbitraryGridMotionType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.ArbitraryGridMotionType_tp_frompointer)
...
class SimulationType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.SimulationType_tp_assign(*args)

    def value(*args):
        return _CGNS.SimulationType_tp_value(*args)

    def cast(*args):
        return _CGNS.SimulationType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.SimulationType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.SimulationType_tp_frompointer)
...
class WallFunctionType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.WallFunctionType_tp_assign(*args)

    def value(*args):
        return _CGNS.WallFunctionType_tp_value(*args)

    def cast(*args):
        return _CGNS.WallFunctionType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.WallFunctionType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.WallFunctionType_tp_frompointer)
...
class AreaType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.AreaType_tp_assign(*args)

    def value(*args):
        return _CGNS.AreaType_tp_value(*args)

    def cast(*args):
        return _CGNS.AreaType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.AreaType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.AreaType_tp_frompointer)
...
class AverageInterfaceType_tp(_object):
    ...
    def assign(*args):
        return _CGNS.AverageInterfaceType_tp_assign(*args)

    def value(*args):
        return _CGNS.AverageInterfaceType_tp_value(*args)

    def cast(*args):
        return _CGNS.AverageInterfaceType_tp_cast(*args)

    __swig_getmethods__['frompointer'] = lambda x: _CGNS.AverageInterfaceType_tp_frompointer
    if _newclass:
        frompointer = staticmethod(_CGNS.AverageInterfaceType_tp_frompointer)
