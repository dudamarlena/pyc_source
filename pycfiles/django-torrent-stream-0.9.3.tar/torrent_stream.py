...
# [GCC 8.4.0]
# Embedded file name: /home/adw0rd/.virtualenvs/kinsburg_tv/local/lib/python2.7/site-packages/torrent_stream/templatetags/torrent_stream.py
# Compiled at: 2013-05-12 13:22:02
import hashlib
...
def torrent_stream_player(torrent_file):
    ...
    if hasattr(torrent_file, 'read'):
        ...
        cache.set(TORRENT_STREAM_CACHE_PREFIX + torrent_content_hash, {'content': torrent_content})
    return {'torrent_content_hash': torrent_content_hash, 
