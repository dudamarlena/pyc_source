...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/GazeboMotionCapture/__init__.py
# Compiled at: 2018-07-18 03:52:43
...
def subscribe_loop(address):
    ...
    manager.subscribe('/gazebo/default/pose/info', 'gazebo.msgs.PosesStamped', parse_data)
    while not EXIT:
