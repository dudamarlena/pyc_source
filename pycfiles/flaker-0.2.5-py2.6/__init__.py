...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/flaker/__init__.py
# Compiled at: 2009-05-24 07:56:48
"""
    >>> flak = Flaker()
...
class Flak(object):
    ...
    def __init__(self, permalink=None, time=None, timestamp=None, comments=None, source=None, link=None, video=None, photo=None, user=None, text=None, has_photo=None, data=None, id=None, **kw):
...
class Flaker(object):
    ...
    def _get_messages(self, tag=None, avatars='small', limit=20, from_=None, start=None, since=None, sort='desc', comments=False, **kw):
        if tag:
            if tag == True:
                tag = 'all'
            kw['tag'] = tag
    ...
    @flak_decoding
    def query(self, user=None, site=None, source=None, **kw):
