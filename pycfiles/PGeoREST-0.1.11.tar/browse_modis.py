...
# [GCC 8.4.0]
# Embedded file name: /home/kalimaha/Development/git-repositories/Geobricks/pgeorest/pgeorest/browse_modis.py
...
@browse_modis.route('/<product_name>/<year>/<day>/<from_h>/<to_h>/<from_v>/<to_v>')
@browse_modis.route('/<product_name>/<year>/<day>/<from_h>/<to_h>/<from_v>/<to_v>/')
@cross_origin(origins='*')
