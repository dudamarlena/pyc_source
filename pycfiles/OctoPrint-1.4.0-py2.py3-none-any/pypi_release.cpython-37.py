...
# [GCC 8.4.0]
# Embedded file name: C:\Devel\OctoPrint\OctoPrint\src\octoprint\plugins\softwareupdate\version_checks\pypi_release.py
...
import logging, pkg_resources, requests
...
def get_latest(target, check, online=True):
    ...
    return (
     information, _is_current(information))