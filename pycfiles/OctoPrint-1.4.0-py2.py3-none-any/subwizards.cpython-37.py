...
# [GCC 8.4.0]
# Embedded file name: C:\Devel\OctoPrint\OctoPrint\src\octoprint\plugins\corewizard\subwizards.py
# Compiled at: 2020-02-26 04:08:42
# Size of source mod 2**32: 5521 bytes
from __future__ import absolute_import, division, print_function, unicode_literals
__license__ = 'GNU Affero General Public License http://www.gnu.org/licenses/agpl.html'
__copyright__ = 'Copyright (C) 2015 The OctoPrint Project - Released under terms of the AGPLv3 License'
import octoprint.plugin, sys, inspect
...
class AclSubwizard(object):
    ...
    def acl_wizard_api(self):
        ...
        if data is None:
            data = request.values
        if 'ac' in data and data['ac'] in valid_boolean_trues and 'user' in data and 'pass1' in data and 'pass2' in data and data['pass1'] == data['pass2']:
            ...
            if 'ac' in data:
                if data['ac'] not in valid_boolean_trues:
...
Subwizards = type(to_native_str('Subwizards'), tuple((cls for clsname, cls in inspect.getmembers(sys.modules[__name__], inspect.isclass) if clsname.endswith('Subwizard'))), dict())