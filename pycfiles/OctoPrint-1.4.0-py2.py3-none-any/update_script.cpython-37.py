...
# [GCC 8.4.0]
# Embedded file name: C:\Devel\OctoPrint\OctoPrint\src\octoprint\plugins\softwareupdate\updaters\update_script.py
...
def perform_update(target, check, target_version, log_cb=None, online=True):
    ...
    try:
        update_command = update_script.format(python=(sys.executable), folder=folder,
