...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/statsd-tags/client.py
# Compiled at: 2019-11-08 10:41:57
# Size of source mod 2**32: 7543 bytes
from __future__ import with_statement
from collections import deque
from functools import wraps
import random, socket, time, abc
__all__ = [
 'StatsClient', 'TCPStatsClient']

class Timer(object):
    __doc__ = 'A context manager/decorator for statsd.timing().'
...
class StatsClientBase(object):
    __doc__ = 'A Base class for various statsd clients.'
...
class TCPStatsClient(StatsClientBase):
    __doc__ = 'TCP version of StatsClient.'
