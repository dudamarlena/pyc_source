...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\evasion\web\commonauth\flatauth\plain.py
...
"""
import os, csv, pprint, os.path, logging, StringIO, fcrypt
    ...
    def __init__(self, user_details):
        ...
        try:
            for row in reader:
                ...
                self.userDetails[username] = dict(username=username, password=password, firstname=firstname, lastname=lastname, email=email, name=name)
