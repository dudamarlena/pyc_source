...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bika/health/browser/drug/getdrugs.py
...
class ajaxGetDrugs(BrowserView):
    ...
    def __call__(self):
        ...
        rows = []
        brains = self.bika_setup_catalog(portal_type='Drug', inactive_state='active')
