...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bika/health/widgets/analysisspecificationwidget.py
# Compiled at: 2014-12-12 07:13:54
from AccessControl import ClassSecurityInfo
from bika.health import bikaMessageFactory as _
from bika.lims.browser.widgets.analysisspecificationwidget import AnalysisSpecificationView as BaseView, AnalysisSpecificationWidget as BaseWidget
...
class AnalysisSpecificationWidget(BaseWidget):
    ...
    def process_form(self, instance, field, form, empty_marker=None, emptyReturnsMarker=False):
        values = BaseWidget.process_form(self, instance, field, form, empty_marker, emptyReturnsMarker)
    ...
    def AnalysisSpecificationResults(self, field, allow_edit=False):
        ...
        view = AnalysisSpecificationView(self, self.REQUEST, fieldvalue=fieldvalue, allow_edit=allow_edit)
        return view.contents_table(table_only=True)


registerWidget(AnalysisSpecificationWidget, title='Analysis Specification Results', description='Analysis Specification Results')
    ...
    def __call__(self, value, *args, **kwargs):
        ...
        for uid in uids:
            ...
            try:
                ...
                return ts(_('Validation failed: Panic min value must be numeric'))
            ...
            if pmin > pmax:
                return ts(_('Validation failed: Panic max value must be greater than panic min value'))
