...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bika/health/widgets/casemenstrualstatuswidget.py
...
class CaseMenstrualStatusWidget(ATRecordsWidget):
    ...
    _properties.update({'macro': 'bika_health_widgets/casemenstrualstatuswidget', 
       'helper_js': ('bika_health_widgets/casemenstrualstatuswidget.js', 'bika_health_widgets/patientmenstrualstatuswidget.js'), 
    ...
    def process_form(self, instance, field, form, empty_marker=None, emptyReturnsMarker=False):
        ...
        for value in values:
            outvalues.append({'FirstDayOfLastMenses': value.get('FirstDayOfLastMenses', ''), 'MenstrualCycleType': value.get('MenstrualCycleType', ''), 
    ...
    def getMenstrualStatus(self):
        statuses = {'FirstDayOfLastMenses': '', 'MenstrualCycleType': MENSTRUAL_STATUSES.keys()[0], 
           'Pregnant': False, 
           'MonthOfPregnancy': 0, 
           'Hysterectomy': False, 
           'HysterectomyYear': '', 
...
registerWidget(CaseMenstrualStatusWidget, title='CaseMenstrualStatusWidget', description='Menstrual status information')