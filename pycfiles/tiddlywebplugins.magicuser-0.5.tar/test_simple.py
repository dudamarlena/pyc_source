...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.magicuser/test/test_simple.py
# Compiled at: 2011-03-16 12:00:47
import shutil
...
def test_simple_magic():
    ...
    store.put(tiddler)
    more_info = extractor.extract_more_info(environ, userinfo)
    assert sorted(more_info['tags']) == ['barney', 'hello', 'monkey']
