...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.4/dist-packages/dustmaker/MapReader.py
# Compiled at: 2015-10-18 22:36:51
...
def _read_segment(reader, map, xoffset, yoffset):
    ...
    if flags & 1:
        ...
        for i in range(layers):
            ...
            for j in range(tiles):
                ...
                if shape & 128:
                    map.add_tile(layer, xoffset + xpos, yoffset + ypos, Tile(TileShape(shape & 31), data))
                    continue
    ...
    if flags & 8:
        ...
        for i in range(props):
            ...
            map.add_prop(layer, xpos / 48, ypos / 48, Prop(layer_sub, rotation, scale_x, scale_y, prop_set, prop_group, prop_index, palette), id)
    ...
    if flags & 4:
        ...
        for i in range(entities):
            ...
            map.add_entity(xpos / 48, ypos / 48, Entity._from_raw(type, vars, rotation, unk1, unk2, unk3, unk4), id)
