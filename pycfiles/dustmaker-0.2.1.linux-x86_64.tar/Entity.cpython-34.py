...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.4/dist-packages/dustmaker/Entity.py
# Compiled at: 2015-10-28 20:55:16
...
class Entity:
    ...
    def __init__(self, vars={}, rotation=0, unk1=18, unk2=1, unk3=1, unk4=1):
...
class DeathZone(Entity):
    ...
    def __init__(self, vars, rotation=0, unk1=0, unk2=0, unk3=0, unk4=0):
