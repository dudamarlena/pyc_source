...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ventriloquist/util.py
# Compiled at: 2010-02-28 19:10:29
import os, sys
...
def safe_path_join(base_path, join_path, minimum_path=None):
    ...
    if not new_path.startswith(os.path.abspath(minimum_path)):
        raise InsecurePath('%s does not start with minimum_path %s, cannot be trusted' % (
