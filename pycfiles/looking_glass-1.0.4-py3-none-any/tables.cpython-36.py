...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/TimHe/OneDrive/Programming/LookingGlass/lib/tables.py
# Compiled at: 2019-02-26 09:19:09
# Size of source mod 2**32: 4545 bytes
import datetime
...
def setup_tables(engine):
    ...
    if session.query(ChangeLog).count() == 0:
        first_changelog_row = ChangeLog(version_number=0,
