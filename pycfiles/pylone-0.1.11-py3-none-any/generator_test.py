...
# Embedded file name: build\bdist.win32\egg\pylon\test\generator_test.py
# Compiled at: 2010-12-26 13:36:33
__doc__ = ' Defines generator test cases.\n'
import unittest
...
class OfferBidToPWLTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        g0_points = [
         (0.0, 0.0), (12.0, 240.0), (36.0, 1200.0), (60.0, 2400.0)]
        g1_points = [(0.0, 0.0), (12.0, 240.0), (36.0, 1200.0), (60.0, 2400.0)]
        g2_points = [(-30.0, 0.0), (-20.0, 1000.0), (-10.0, 2000.0), (0.0, 3000.0)]
        g3_points = [(0.0, 0.0), (12.0, 240.0), (36.0, 1200.0), (60.0, 2400.0)]
        g4_points = [(-30.0, 0.0), (-20.0, 1000.0), (-10.0, 2000.0), (0.0, 3000.0)]
        g0 = Generator(Bus(), p=10.0, q=0.0, q_max=60.0, q_min=-15.0, p_max=60.0, p_min=10.0, p_cost=g0_points)
        g1 = Generator(Bus(), p=10.0, q=0.0, q_max=60.0, q_min=-15.0, p_max=60.0, p_min=12.0, p_cost=g1_points)
        g2 = Generator(Bus(), p=-30.0, q=-15.0, q_max=0.0, q_min=-15.0, p_max=0.0, p_min=-30.0, p_cost=g2_points)
        g3 = Generator(Bus(), p=10.0, q=0.0, q_max=60.0, q_min=-15.0, p_max=60.0, p_min=12.0, p_cost=g3_points)
        g4 = Generator(Bus(), p=-30.0, q=7.5, q_max=7.5, q_min=0.0, p_max=0.0, p_min=-30.0, p_cost=g4_points)
        self.all_generators = [
         g0, g1, g2, g3, g4]
    ...
    def test_offers_and_bids(self):
        ...
        vloads = self.vloads
        offers = [
         Offer(generators[0], 25.0, 10.0),
         Offer(generators[1], 26.0, 50.0),
         Offer(generators[2], 27.0, 100.0)]
        bids = [
         Bid(vloads[0], 20.0, 100.0),
