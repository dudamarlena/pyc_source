...
# Embedded file name: build\bdist.win32\egg\pylon\test\case_test.py
# Compiled at: 2010-12-26 13:36:33
__doc__ = ' Defines the case test case.\n'
import os
...
class CaseMatrixTest(unittest.TestCase):
    ...
    def testBdc(self):
        ...
        mpPbusinj = mmread(join(DATA_DIR, self.case_name, 'Pbusinj.mtx')).flatten()
    ...
    def test_dSbus_dV(self):
        ...
        self.assertTrue(mfeq2(dSbus_dVm, mp_dSbus_dVm.tocsr(), 1e-12), self.case_name)
        self.assertTrue(mfeq2(dSbus_dVa, mp_dSbus_dVa.tocsr(), 1e-12), self.case_name)
...
class CaseReportTest(unittest.TestCase):
    ...
    def test_report(self):
        ...
        self.assertAlmostEqual(report.max_v_magnitude[0], 1.0, pl)
        ...
        self.assertAlmostEqual(report.max_q_losses[0], 2.097, pl)
