...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\hncapiclient\backend.py
# Compiled at: 2013-05-23 14:52:37
from httplib2 import Http
import simplejson, logging
from datetime import date, datetime
from hncapiclient import Mapping
...
class VersionedBackend(Backend):
    ...
    def get_full_path(self, path):
        return ('/api/{}{}').format(self.version, path)