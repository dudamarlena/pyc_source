...
# Embedded file name: build/bdist.linux-x86_64/egg/pyqart/qr/printer/image_printer.py
...
class QrImagePrinter(QrBasePrinter):
    ...
    @classmethod
    def print(cls, obj, path=None, point_width=None, border_width=None, f_color=None, bg_color=None, file_format=None):
        """
        ...
        :rtype: PIL.Image
        """
        point_width, border_width = cls._calc_point_border_width(point_width, border_width)
