...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/py3o/formats/main.py
# Compiled at: 2015-06-02 10:34:23
...
class Formats(object):
    ...
    def __init__(self):
        self._formats = {FORMAT_WORD97: Format(FORMAT_WORD97, 'MS Word 97', 'application/msword'), 
           FORMAT_WORD2003: Format(FORMAT_WORD2003, 'MS Word 2003 XML', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'), 
           ...
           FORMAT_ODT: Format(FORMAT_ODT, 'writer8', 'application/vnd.oasis.opendocument.text', native=True), 
           FORMAT_ODS: Format(FORMAT_ODS, 'calc8', 'application/vnd.oasis.opendocument.spreadsheet', native=True), 
