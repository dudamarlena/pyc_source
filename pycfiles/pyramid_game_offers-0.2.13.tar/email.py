...
# Embedded file name: build/bdist.linux-x86_64/egg/pyramid_fullauth/views/basic/profile/email.py
# Compiled at: 2017-02-24 16:57:38
__doc__ = 'Email related views.'
...
@view_defaults(route_name='email:change', permission='email_change', renderer='pyramid_fullauth:resources/templates/email_change.mako')
class EmailChangeViews(BaseView):
    ...
    def validate_email(self, user):
        ...
        try:
            ...
            return {'status': False, 'msg': self.request._('E-mail is empty', domain='pyramid_fullauth'), 
               'csrf_token': csrf_token}
...
@view_config(route_name='email:change:continue', permission=NO_PERMISSION_REQUIRED, renderer='pyramid_fullauth:resources/templates/email_change.mako')
