...
# Compiled at: 2019-12-27 02:11:08
...
def cmdLineParser():
    ...
    try:
        ...
        general.add_option('--upgrade', '-u', dest='upgrade', action='store_true', default=False,
          help='Upgrade CVE rules.')
        general.add_option('--force-update', '-f', dest='force_update', action='store_true', default=False,
          help='')
        ...
        analysis.add_option('--vuln-scan', dest='vuln_scan', action='store_true', default=False, help='Whether to enable component vulnerability scanning. The default is false.')
        analysis.add_option('--search', dest='search', help='Search for related vulnerability components, example: --search fastjson')
        try:
