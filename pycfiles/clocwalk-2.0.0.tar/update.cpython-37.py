...
# Compiled at: 2020-02-24 23:51:38
# Size of source mod 2**32: 11832 bytes
import datetime, glob, gzip, json, os, shutil, time, re, gevent, requests
...
class Upgrade(object):
    ...
    def __init__(self, proxies=None, upgrade_interval='7d', http_timeout=15):
        ...
        interval_type = re.search('(\\d+)(\\w)', upgrade_interval)
        if interval_type:
        ...
        try:
            try:
                ...
                if self.is_update:
                    ...
                    raise NoUpgradeRequiredError('No upgrade required, last update time: {0}.'.format(self.last_update_time))
