...
# [GCC 8.4.0]
# Embedded file name: D:\Documents\GitHub\luxpy\luxpy\color\cat\chromaticadaptation.py
# Compiled at: 2019-01-25 06:42:48
# Size of source mod 2**32: 28593 bytes
"""
...
=============================================================================
 ...
 :_MCATS: | default chromatic adaptation sensor spaces
          ...
          | * 'cat02': from ciecam02: `CIE159-2004, â\x80\x9cA Colour Apperance Model for Color Management System: CIECAM02,â\x80? CIE, Vienna, 2004. <http://onlinelibrary.wiley.com/doi/10.1002/col.20198/abstract>`_
          | * 'cat02-bs':  cat02 adjusted to solve yellow-blue problem (last line = [0 0 1]): `Brill MH, SÃ¼sstrunk S. Repairing gamut problems in CIECAM02: A progress report. Color Res Appl 2008;33(5), 424â\x80\x93426. <http://onlinelibrary.wiley.com/doi/10.1002/col.20432/abstract>`_
          | * 'cat02-jiang': cat02 modified to solve yb-probem + purple problem: `Jun Jiang, Zhifeng Wang,M. Ronnier Luo,Manuel Melgosa,Michael H. Brill,Changjun Li, Optimum solution of the CIECAM02 yellowâ\x80\x93blue and purple problems, Color Res Appl 2015: 40(5), 491-503. <http://onlinelibrary.wiley.com/doi/10.1002/col.21921/abstract>`_
          | * 'kries'
          ...
          | * 'bfd': bradford transform :  `G. D. Finlayson and S. Susstrunk, â\x80\x9cSpectral sharpening and the Bradford transform,â\x80? 2000, vol. Proceeding, pp. 236â\x80\x93242. <https://infoscience.epfl.ch/record/34077>`_
          | * 'sharp': sharp transform:  `S. SÃ¼sstrunk, J. Holm, and G. D. Finlayson, â\x80\x9cChromatic adaptation performance of different RGB sensors,â\x80? IS&T/SPIE Electronic Imaging 2001: Color Imaging, vol. 4300. San Jose, CA, January, pp. 172â\x80\x93183, 2001. <http://proceedings.spiedigitallibrary.org/proceeding.aspx?articleid=903890>`_
          | * 'cmc':  `C. Li, M. R. Luo, B. Rigg, and R. W. G. Hunt, â\x80\x9cCMC 2000 chromatic adaptation transform: CMCCAT2000,â\x80? Color Res. Appl., vol. 27, no. 1, pp. 49â\x80\x9358, 2002. <http://onlinelibrary.wiley.com/doi/10.1002/col.10005/abstract>`_
          | * 'ipt':  `F. Ebner and M. D. Fairchild, â\x80\x9cDevelopment and testing of a color space (IPT) with improved hue uniformity,â\x80? in IS&T 6th Color Imaging Conference, 1998, pp. 8â\x80\x9313. <http://www.ingentaconnect.com/content/ist/cic/1998/00001998/00000001/art00003?crawler=true>`_
          | * 'lms':
          | * 'bianco':  `S. Bianco and R. Schettini, â\x80\x9cTwo new von Kries based chromatic adaptation transforms found by numerical optimization,â\x80? Color Res. Appl., vol. 35, no. 3, pp. 184â\x80\x93192, 2010. <http://onlinelibrary.wiley.com/doi/10.1002/col.20573/full>`_
          | * 'bianco-pc':  `S. Bianco and R. Schettini, â\x80\x9cTwo new von Kries based chromatic adaptation transforms found by numerical optimization,â\x80? Color Res. Appl., vol. 35, no. 3, pp. 184â\x80\x93192, 2010. <http://onlinelibrary.wiley.com/doi/10.1002/col.20573/full>`_
          | * 'cat16': `C. Li, Z. Li, Z. Wang, Y. Xu, M. R. Luo, G. Cui, M. Melgosa, M. H. Brill, and M. Pointer, â\x80\x9cComprehensive color solutions: CAM16, CAT16, and CAM16-UCS,â\x80? Color Res. Appl., p. n/aâ\x80\x93n/a. <http://onlinelibrary.wiley.com/doi/10.1002/col.22131/abstract>`_
...
__all__ = [
 '_WHITE_POINT', '_LA', '_MCATS',
 'check_dimensions', 'get_transfer_function', 'get_degree_of_adaptation',
 'smet2017_D', 'parse_x1x2_parameters', 'apply']
_WHITE_POINT = np2d([100, 100, 100])
_LA = 100.0
_MCATS = {x:_CMF[x]['M'] for x in _CMF['types']}
_MCATS['hpe'] = _MCATS['1931_2']
_MCATS['cat02'] = np2d([[0.7328, 0.4296, -0.1624], [-0.7036, 1.6975, 0.0061], [0.003, 0.0136, 0.9834]])
_MCATS['cat02-bs'] = np2d([[0.7328, 0.4296, -0.1624], [-0.7036, 1.6975, 0.0061], [0.0, 0.0, 1.0]])
_MCATS['cat02-jiang-luo'] = np2d([[0.55615, 0.55615, -0.1123], [-0.507327, 1.404878, 0.102449], [0.0, 0.0, 1.0]])
_MCATS['kries'] = np2d([[0.40024, 0.7076, -0.08081], [-0.2263, 1.16532, 0.0457], [0.0, 0.0, 0.91822]])
_MCATS['judd-1945'] = np2d([[0.0, 1.0, 0.0], [-0.46, 1.36, 0.102], [0.0, 0.0, 1.0]])
_MCATS['bfd'] = np2d([[0.8951, 0.2664, -0.1614], [-0.7502, 1.7135, 0.0367], [0.0389, -0.0685, 1.0296]])
...
_MCATS['ipt'] = np2d([[0.4002, 0.7075, -0.0807], [-0.228, 1.15, 0.0612], [0.0, 0.0, 0.9184]])
_MCATS['lms'] = np2d([[0.207, 0.8655, -0.0362], [-0.4307, 1.178, 0.0949], [0.0865, -0.2197, 0.4633]])
_MCATS['bianco'] = np2d([[0.8752, 0.2787, -0.1539], [-0.8904, 1.8709, 0.0195], [-0.0061, 0.0162, 0.9899]])
_MCATS['biaco-pc'] = np2d([[0.6489, 0.3915, -0.0404], [-0.3775, 1.3055, 0.072], [-0.0271, 0.0888, 0.9383]])
...
def get_transfer_function(cattype='vonkries', catmode='1>0>2', lmsw1=None, lmsw2=None, lmsw0=_WHITE_POINT, D10=1.0, D20=1.0, La1=_LA, La2=_LA, La0=_LA):
    ...
    if (catmode is None) & (cattype == 'vonkries'):
        if (lmsw1 is not None) & (lmsw2 is not None):
            ...
            if (lmsw2 is None) & (lmsw1 is not None):
                catmode = '1>0'
            else:
                if (lmsw1 is None) & (lmsw2 is not None):
                    catmode = '0>2'
    if cattype == 'vonkries':
        if catmode == '1>0>2':
        ...
        if cattype == 'rlab':
            ...
            La1p = La1 ** 0.3333333333333333
            La2p = La2 ** 0.3333333333333333
...
def smet2017_D(xyzw, Dmax=None, cieobs='1964_10'):
    ...
    pD = 10000000.0 * np.array([0.021081326530436, 4.751255762876845, -7.1025181e-08, -6.3627042e-08, -0.146952821492957, 3.117390441655821])
    if Dmax is None:
        Dmax = 0.6539
        ...
        if Dtype is None:
            ...
            if Dtype == 'manual':
                ...
                if (Dtype == 'cat02') | (Dtype == 'cat16'):
                    ...
                    D = F * (1 - 0.2777777777777778 * np.exp((-La - 42) / 92))
                else:
                    if Dtype == 'cmc':
                        PAR = [
                         'La, La0, order']
...
def parse_x1x2_parameters(x, target_shape, catmode, expand_2d_to_3d=None, default=[1.0, 1.0]):
   ...
   """
    if x is None:
        ...
        if (catmode == '1>0>2') | (catmode == '1>2'):
            if x.shape[(-1)] == 2:
                x10 = np.ones(target_shape) * x[(Ellipsis, 0)]
                x20 = np.ones(target_shape) * x[(Ellipsis, 1)]
            else:
...
def apply(data, catmode='1>0>2', cattype='vonkries', xyzw1=None, xyzw2=None, xyzw0=None, D=None, mcat=['cat02'], normxyz0=None, outtype='xyz', La=None, F=None, Dtype=None):
    ...
    if (xyzw1 is not None) & (xyzw2 is not None):
        ...
        default_La12 = [xyzw1[(Ellipsis, 1, None)], xyzw2[(Ellipsis, 1, None)]]
    else:
        if (xyzw2 is None) & (xyzw1 is not None):
            catmode = '1>0'
            xyzw1 = xyzw1 * np.ones(target_shape)
            default_La12 = [xyzw1[(Ellipsis, 1, None)], La0]
        else:
            if (xyzw1 is None) & (xyzw2 is not None):
        ...
        for i in range(xyzc.shape[1]):
            ...
            if normxyz0 is not None:
                ...
                if (catmode == '1>0>2') | (catmode == '1>0'):
                    ...
                    D10[:, i] = get_degree_of_adaptation(Dtype=Dtype, **Dpar1)
                    lmsw2 = None
                else:
                    if catmode == '1>0>2':
                        lmsw2 = np.dot(mcati, xyzw2[:, i].T).T
                        Dpar2 = dict(D=(D20[:, i]), F=(F2[:, i]), La=(La2[:, i]), La0=(La0[:, i]), order='0>2')
                        D20[:, i] = get_degree_of_adaptation(Dtype=Dtype, **Dpar2)
                    if catmode == '1>2':
                        lmsw1 = np.dot(mcati, xyzw1[:, i].T).T
                        lmsw2 = np.dot(mcati, xyzw2[:, i].T).T
                        Dpar12 = dict(D=(D10[:, i]), F=(F1[:, i]), La=(La1[:, i]), La2=(La2[:, i]), order='1>2')
                        D10[:, i] = get_degree_of_adaptation(Dtype=Dtype, **Dpar12)
