...
# [GCC 8.4.0]
# Embedded file name: D:\Documents\GitHub\luxpy\luxpy\color\cri\utils\DE_scalers.py
# Compiled at: 2018-05-03 02:49:00
...
def linear_scale(data, scale_factor=[
 4.6], scale_max=100.0):
    """
...
def log_scale(data, scale_factor=[
 6.73], scale_max=100.0):
    """
...
def psy_scale(data, scale_factor=[
 0.01818181818181818, 1.5, 2.0], scale_max=100.0):
    """
