...
# [GCC 8.4.0]
# Embedded file name: D:\Documents\GitHub\luxpy\luxpy\color\cri\utils\init_cri_defaults_database.py
# Compiled at: 2019-09-04 12:15:51
...
__all__ = [
 '_CRI_TYPE_DEFAULT', '_CRI_DEFAULTS', 'process_cri_type_input']
...
_CRI_DEFAULTS['ciera-13.3-1995'] = {'sampleset':"_CRI_RFL['cie-13.3-1995']['8']", 
 ...
 'cieobs':{'xyz':'1931_2', 
  'cct':'1931_2'}, 
 'avg':np.mean, 
 'scale':{'fcn':linear_scale, 
  'cfactor':[4.6]}, 
 'cspace':{'type':'wuv', 
  'xyzw':None}, 
 'catf':{'xyzw':None, 
  'mcat':'judd-1945',  'D':1.0,  'La':None,  'cattype':'vonkries',  'Dtype':None,  'catmode':'1>2'}, 
 'rg_pars':{'nhbins':None, 
  'start_hue':0.0,  'normalize_gamut':False}, 
...
_CRI_DEFAULTS['cierf-224-2017'] = {'sampleset':"_CRI_RFL['cie-224-2017']['99']['5nm']", 
 ...
 'scale':{'fcn':log_scale, 
  'cfactor':[6.73]}, 
 'cspace':{'type':'jab_cam02ucs', 
  'xyzw':None,  'mcat':'cat02',  'Yw':None,  'conditions':{'La':100.0,  'surround':'avg',  'D':1.0,  'Yb':20.0,  'Dtype':None},  'yellowbluepurplecorrect':None}, 
 'catf':None, 
 'rg_pars':{'nhbins':8, 
...
_CRI_DEFAULTS['iesrf-tm30-15'] = {'sampleset':"_CRI_RFL['ies-tm30-15']['99']['5nm']", 
 ...
 'cieobs':{'xyz':'1964_10', 
  'cct':'1931_2'}, 
 'avg':np.mean, 
 'scale':{'fcn':log_scale,  'cfactor':[7.54]},  'cspace':{'type':'jab_cam02ucs', 
  'xyzw':None,  'mcat':'cat02',  'Yw':None,  'conditions':{'La':100.0,  'surround':'avg',  'D':1.0,  'Yb':20.0,  'Dtype':None},  'yellowbluepurplecorrect':None}, 
 'catf':None, 
 'rg_pars':{'nhbins':16, 
  'start_hue':0.0,  'normalize_gamut':False,  'normalized_chroma_ref':100}, 
...
_CRI_DEFAULTS['iesrf-tm30-18'] = {'sampleset':"_CRI_RFL['ies-tm30-18']['99']['5nm']", 
 ...
 'cieobs':{'xyz':'1964_10', 
  'cct':'1931_2'}, 
 'avg':np.mean, 
 'scale':{'fcn':log_scale,  'cfactor':[6.73]},  'cspace':{'type':'jab_cam02ucs', 
  'xyzw':None,  'mcat':'cat02',  'Yw':None,  'conditions':{'La':100.0,  'surround':'avg',  'D':1.0,  'Yb':20.0,  'Dtype':None},  'yellowbluepurplecorrect':None}, 
 'catf':None, 
 'rg_pars':{'nhbins':16, 
  'start_hue':0.0,  'normalize_gamut':False,  'normalized_chroma_ref':100}, 
...
_CRI_DEFAULTS['cri2012-hl17'] = {'sampleset':"_CRI_RFL['cri2012']['HL17']", 
 ...
 'avg':math.rms, 
 'scale':{'fcn':psy_scale, 
  'cfactor':[0.01818181818181818, 1.5, 2]}, 
 'cspace':{'type':'jab_cam02ucs', 
  'xyzw':None,  'mcat':'cat02',  'Yw':None,  'conditions':{'La':100.0,  'surround':'avg',  'D':1.0,  'Yb':20.0,  'Dtype':None},  'yellowbluepurplecorrect':'brill-suss'}, 
 'catf':None, 
 'rg_pars':{'nhbins':None, 
  'start_hue':0.0,  'normalize_gamut':False,  'normalized_chroma_ref':100}, 
 'cri_specific_pars':None}
_CRI_DEFAULTS['cri2012-hl1000'] = {'sampleset':"_CRI_RFL['cri2012']['HL1000']", 
 ...
 'cieobs':{'xyz':'1964_10', 
  'cct':'1931_2'}, 
 'avg':math.rms, 
 'scale':{'fcn':psy_scale,  'cfactor':[0.02, 1.5, 2]},  'cspace':{'type':'jab_cam02ucs', 
  'xyzw':None,  'mcat':'cat02',  'Yw':None,  'conditions':{'La':100.0,  'surround':'avg',  'D':1.0,  'Yb':20.0,  'Dtype':None},  'yellowbluepurplecorrect':'brill-suss'}, 
 'catf':None, 
 'rg_pars':{'nhbins':None, 
  'start_hue':0.0,  'normalize_gamut':False,  'normalized_chroma_ref':100}, 
...
_CRI_DEFAULTS['cri2012-real210'] = {'sampleset':"_CRI_RFL['cri2012']['Real210']", 
 ...
 'avg':math.rms, 
 'scale':{'fcn':psy_scale, 
  'cfactor':[0.044444444444444446, 1.5, 2]}, 
 'cspace':{'type':'jab_cam02ucs', 
  'xyzw':None,  'mcat':'cat02',  'Yw':None,  'conditions':{'La':100.0,  'surround':'avg',  'D':1.0,  'Yb':20.0,  'Dtype':None},  'yellowbluepurplecorrect':'brill-suss'}, 
 'catf':None, 
 'rg_pars':{'nhbins':None, 
...
def process_cri_type_input(cri_type, args, callerfunction=''):
    ...
    if isinstance(cri_type, str):
        ...
        if not isinstance(cri_type, dict):
