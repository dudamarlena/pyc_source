...
# Compiled at: 2020-02-06 13:32:17
# Size of source mod 2**32: 97191 bytes
"""
...
def get_optim_pars_dict(target, tar_type, cieobs, optimizer_type, spd_constructor, spd_model_pars, cspace, cspace_bwtf, cspace_fwtf, component_spds, N_components, obj_fcn, obj_fcn_pars, obj_fcn_weights, obj_tar_vals, decimals, minimize_method, minimize_opts, F_rss, peakwl, fwhm, allow_nongaussianbased_mono_spds, bw_order, wl, with_wl, strength_shoulder, strength_ph, use_piecewise_fcn, peakwl_ph1, fwhm_ph1, strength_ph1, peakwl_ph2=np2d([100, 0.3333333333333333, 0.3333333333333333])'Yxy'_CIEOBS'2mixer'NoneNone'Yuv'{}{}NoneNone[
 ...
 -2], bw_order_max=[100]):
    ...
    if len(peakwl) < N_components:
    ...
    elif allow_nongaussianbased_mono_spds == True:
        if len(bw_order) < N_components:
            ...
            if allow_nongaussianbased_mono_spds == True:
                ...
                elif len(bw_order_min) != len(bw_order):
...
def initialize_spd_optim_pars--- This code section failed: ---

 L.1654         0  BUILD_MAP_0           0 
                2  STORE_FAST               'spd_optim_pars'

 L.1655         4  LOAD_FAST                'spd_model_pars'
                6  LOAD_CONST               None
                8  COMPARE_OP               is
               10  POP_JUMP_IF_FALSE    30  'to 30'

 L.1656        12  LOAD_GLOBAL              initialize_spd_model_pars
               14  LOAD_FAST                'component_data'
               16  LOAD_FAST                'N_components'

 L.1657        18  LOAD_FAST                'optimizer_type'

 L.1658        20  LOAD_FAST                'allow_nongaussianbased_mono_spds'
               22  LOAD_FAST                'wl'
               24  LOAD_CONST               ('N_components', 'optimizer_type', 'allow_nongaussianbased_mono_spds', 'wl')
               26  CALL_FUNCTION_KW_5     5  '5 total positional and keyword args'
               28  STORE_FAST               'spd_model_pars'
             30_0  COME_FROM            10  '10'

 L.1660        30  LOAD_FAST                'spd_model_pars'
               32  LOAD_STR                 'N_components'
               34  BINARY_SUBSCR    
               36  STORE_FAST               'N'

 L.1663        38  LOAD_GLOBAL              isinstance
               40  LOAD_FAST                'component_data'
               42  LOAD_GLOBAL              int
               44  CALL_FUNCTION_2       2  '2 positional arguments'
            46_48  POP_JUMP_IF_FALSE   432  'to 432'

 L.1665        50  LOAD_GLOBAL              np
               52  LOAD_METHOD              hstack
               54  LOAD_FAST                'spd_model_pars'
               56  LOAD_STR                 'peakwl_min'
               58  BINARY_SUBSCR    
               60  LOAD_FAST                'spd_model_pars'
               62  LOAD_STR                 'fwhm_min'
               64  BINARY_SUBSCR    
               66  BUILD_TUPLE_2         2 
               68  CALL_METHOD_1         1  '1 positional argument'
               70  LOAD_FAST                'spd_optim_pars'
               72  LOAD_STR                 'LB'
               74  STORE_SUBSCR     

 L.1666        76  LOAD_GLOBAL              np
               78  LOAD_METHOD              hstack
               80  LOAD_FAST                'spd_model_pars'
               82  LOAD_STR                 'peakwl_max'
               84  BINARY_SUBSCR    
               86  LOAD_FAST                'spd_model_pars'
               88  LOAD_STR                 'fwhm_max'
               90  BINARY_SUBSCR    
               92  BUILD_TUPLE_2         2 
               94  CALL_METHOD_1         1  '1 positional argument'
               96  LOAD_FAST                'spd_optim_pars'
               98  LOAD_STR                 'UB'
              100  STORE_SUBSCR     

 L.1667       102  LOAD_GLOBAL              np
              104  LOAD_METHOD              hstack
              106  LOAD_FAST                'spd_model_pars'
              108  LOAD_STR                 'peakwl'
              110  BINARY_SUBSCR    
              112  LOAD_FAST                'spd_model_pars'
              114  LOAD_STR                 'fwhm'
              116  BINARY_SUBSCR    
              118  BUILD_TUPLE_2         2 
              120  CALL_METHOD_1         1  '1 positional argument'
              122  LOAD_FAST                'spd_optim_pars'
              124  LOAD_STR                 'x0'
              126  STORE_SUBSCR     

 L.1669       128  LOAD_FAST                'allow_nongaussianbased_mono_spds'
              130  LOAD_CONST               True
              132  COMPARE_OP               ==
              134  POP_JUMP_IF_FALSE   214  'to 214'

 L.1670       136  LOAD_GLOBAL              np
              138  LOAD_METHOD              hstack
              140  LOAD_FAST                'spd_optim_pars'
              142  LOAD_STR                 'LB'
              144  BINARY_SUBSCR    
              146  LOAD_FAST                'spd_model_pars'
              148  LOAD_STR                 'bw_order_min'
              150  BINARY_SUBSCR    
              152  BUILD_TUPLE_2         2 
              154  CALL_METHOD_1         1  '1 positional argument'
              156  LOAD_FAST                'spd_optim_pars'
              158  LOAD_STR                 'LB'
              160  STORE_SUBSCR     

 L.1671       162  LOAD_GLOBAL              np
              164  LOAD_METHOD              hstack
              166  LOAD_FAST                'spd_optim_pars'
              168  LOAD_STR                 'UB'
              170  BINARY_SUBSCR    
              172  LOAD_FAST                'spd_model_pars'
              174  LOAD_STR                 'bw_order_max'
              176  BINARY_SUBSCR    
              178  BUILD_TUPLE_2         2 
              180  CALL_METHOD_1         1  '1 positional argument'
              182  LOAD_FAST                'spd_optim_pars'
              184  LOAD_STR                 'UB'
              186  STORE_SUBSCR     

 L.1672       188  LOAD_GLOBAL              np
              190  LOAD_METHOD              hstack
              192  LOAD_FAST                'spd_optim_pars'
              194  LOAD_STR                 'x0'
              196  BINARY_SUBSCR    
              198  LOAD_FAST                'spd_model_pars'
              200  LOAD_STR                 'bw_order'
              202  BINARY_SUBSCR    
              204  BUILD_TUPLE_2         2 
              206  CALL_METHOD_1         1  '1 positional argument'
              208  LOAD_FAST                'spd_optim_pars'
              210  LOAD_STR                 'x0'
              212  STORE_SUBSCR     
            214_0  COME_FROM           134  '134'

 L.1675       214  LOAD_FAST                'optimizer_type'
              216  LOAD_STR                 '2mixer'
              218  COMPARE_OP               ==
          220_222  POP_JUMP_IF_FALSE   316  'to 316'

 L.1676       224  LOAD_GLOBAL              np
              226  LOAD_METHOD              hstack
              228  LOAD_FAST                'spd_optim_pars'
              230  LOAD_STR                 'LB'
              232  BINARY_SUBSCR    
              234  LOAD_GLOBAL              np
              236  LOAD_METHOD              zeros
              238  LOAD_FAST                'N'
              240  LOAD_CONST               3
              242  BINARY_SUBTRACT  
              ...
              250  LOAD_FAST                'spd_optim_pars'
              252  LOAD_STR                 'LB'
              254  STORE_SUBSCR     

 L.1677       256  LOAD_GLOBAL              np
              258  LOAD_METHOD              hstack
              260  LOAD_FAST                'spd_optim_pars'
              262  LOAD_STR                 'UB'
              264  BINARY_SUBSCR    
              266  LOAD_GLOBAL              np
              268  LOAD_METHOD              ones
              270  LOAD_FAST                'N'
              272  LOAD_CONST               3
              274  BINARY_SUBTRACT  
              ...
              282  LOAD_FAST                'spd_optim_pars'
              284  LOAD_STR                 'UB'
              286  STORE_SUBSCR     

 L.1678       288  LOAD_GLOBAL              np
              290  LOAD_METHOD              hstack
              292  LOAD_FAST                'spd_optim_pars'
              294  LOAD_STR                 'x0'
              296  BINARY_SUBSCR    
              298  LOAD_FAST                'spd_model_pars'
              300  LOAD_STR                 'pair_strengths'
              302  BINARY_SUBSCR    
              304  BUILD_TUPLE_2         2 
              306  CALL_METHOD_1         1  '1 positional argument'
              308  LOAD_FAST                'spd_optim_pars'
              310  LOAD_STR                 'x0'
              312  STORE_SUBSCR     
              314  JUMP_FORWARD       1214  'to 1214'
            316_0  COME_FROM           220  '220'

 L.1680       316  LOAD_FAST                'optimizer_type'
              318  LOAD_STR                 '3mixer'
              320  COMPARE_OP               ==
          322_324  POP_JUMP_IF_FALSE  1214  'to 1214'

 L.1681       326  LOAD_GLOBAL              np
              328  LOAD_METHOD              hstack
              330  LOAD_FAST                'spd_optim_pars'
              332  LOAD_STR                 'LB'
              334  BINARY_SUBSCR    
              336  LOAD_GLOBAL              np
              338  LOAD_METHOD              zeros
              340  LOAD_FAST                'spd_model_pars'
              342  LOAD_STR                 'triangle_strengths'
              344  BINARY_SUBSCR    
              346  LOAD_ATTR                shape
              348  LOAD_CONST               0
              350  BINARY_SUBSCR    
              ...
              358  LOAD_FAST                'spd_optim_pars'
              360  LOAD_STR                 'LB'
              362  STORE_SUBSCR     

 L.1682       364  LOAD_GLOBAL              np
              366  LOAD_METHOD              hstack
              368  LOAD_FAST                'spd_optim_pars'
              370  LOAD_STR                 'UB'
              372  BINARY_SUBSCR    
              374  LOAD_GLOBAL              np
              376  LOAD_METHOD              ones
              378  LOAD_FAST                'spd_model_pars'
              380  LOAD_STR                 'triangle_strengths'
              382  BINARY_SUBSCR    
              384  LOAD_ATTR                shape
              386  LOAD_CONST               0
              388  BINARY_SUBSCR    
              ...
              396  LOAD_FAST                'spd_optim_pars'
              398  LOAD_STR                 'UB'
              400  STORE_SUBSCR     

 L.1683       402  LOAD_GLOBAL              np
              404  LOAD_METHOD              hstack
              406  LOAD_FAST                'spd_optim_pars'
              408  LOAD_STR                 'x0'
              410  BINARY_SUBSCR    
              412  LOAD_FAST                'spd_model_pars'
              414  LOAD_STR                 'triangle_strengths'
              416  BINARY_SUBSCR    
              418  BUILD_TUPLE_2         2 
              420  CALL_METHOD_1         1  '1 positional argument'
              422  LOAD_FAST                'spd_optim_pars'
              424  LOAD_STR                 'x0'
              426  STORE_SUBSCR     
          428_430  JUMP_FORWARD       1214  'to 1214'
            432_0  COME_FROM            46  '46'

 L.1685       432  LOAD_GLOBAL              isinstance
              434  LOAD_FAST                'component_data'
              436  LOAD_GLOBAL              dict
              438  CALL_FUNCTION_2       2  '2 positional arguments'
          440_442  POP_JUMP_IF_FALSE  1076  'to 1076'

 L.1688       444  BUILD_LIST_0          0 
              446  LOAD_FAST                'spd_optim_pars'
              448  LOAD_STR                 'LB'
              450  STORE_SUBSCR     

 L.1689       452  BUILD_LIST_0          0 
              454  LOAD_FAST                'spd_optim_pars'
              456  LOAD_STR                 'UB'
              458  STORE_SUBSCR     

 L.1690       460  BUILD_LIST_0          0 
              462  LOAD_FAST                'spd_optim_pars'
              464  LOAD_STR                 'x0'
              466  STORE_SUBSCR     

 L.1691       468  LOAD_FAST                'component_data'
              470  LOAD_STR                 'peakwl'
              472  BINARY_SUBSCR    
              474  LOAD_CONST               None
              476  COMPARE_OP               is
          478_480  POP_JUMP_IF_FALSE   576  'to 576'

 L.1692       482  LOAD_FAST                'spd_optim_pars'
              484  LOAD_STR                 'LB'
              486  DUP_TOP_TWO      
              488  BINARY_SUBSCR    
              490  LOAD_GLOBAL              list
              492  LOAD_FAST                'spd_model_pars'
              494  LOAD_STR                 'peakwl_min'
              496  BINARY_SUBSCR    
 ...
 L.1693       506  LOAD_FAST                'spd_optim_pars'
              508  LOAD_STR                 'UB'
              510  DUP_TOP_TWO      
              512  BINARY_SUBSCR    
              514  LOAD_GLOBAL              list
              516  LOAD_FAST                'spd_model_pars'
              518  LOAD_STR                 'peakwl_max'
              520  BINARY_SUBSCR    
 ...
 L.1694       530  LOAD_FAST                'spd_optim_pars'
              532  LOAD_STR                 'x0'
              534  DUP_TOP_TWO      
              536  BINARY_SUBSCR    
              538  LOAD_GLOBAL              list
              540  LOAD_GLOBAL              np
              542  LOAD_METHOD              linspace
              544  LOAD_GLOBAL              min
              546  LOAD_FAST                'spd_model_pars'
              548  LOAD_STR                 'peakwl_min'
              550  BINARY_SUBSCR    
              552  CALL_FUNCTION_1       1  '1 positional argument'
              554  LOAD_GLOBAL              max
              556  LOAD_FAST                'spd_model_pars'
              558  LOAD_STR                 'peakwl_max'
              560  BINARY_SUBSCR    
              562  CALL_FUNCTION_1       1  '1 positional argument'
              564  LOAD_FAST                'N'
              566  CALL_METHOD_3         3  '3 positional arguments'
              568  CALL_FUNCTION_1       1  '1 positional argument'
              570  INPLACE_ADD      
              572  ROT_THREE        
              574  STORE_SUBSCR     
            576_0  COME_FROM           478  '478'

 L.1696       576  LOAD_FAST                'component_data'
              578  LOAD_STR                 'fwhm'
              580  BINARY_SUBSCR    
              582  LOAD_CONST               None
              584  COMPARE_OP               is
          586_588  POP_JUMP_IF_FALSE   736  'to 736'

 L.1697       590  LOAD_FAST                'spd_optim_pars'
              592  LOAD_STR                 'LB'
              594  DUP_TOP_TWO      
              596  BINARY_SUBSCR    
              598  LOAD_GLOBAL              list
              600  LOAD_FAST                'spd_model_pars'
              602  LOAD_STR                 'fwhm_min'
              604  BINARY_SUBSCR    
 ...
 L.1698       614  LOAD_FAST                'spd_optim_pars'
              616  LOAD_STR                 'UB'
              618  DUP_TOP_TWO      
              620  BINARY_SUBSCR    
              622  LOAD_GLOBAL              list
              624  LOAD_FAST                'spd_model_pars'
              626  LOAD_STR                 'fwhm_max'
              628  BINARY_SUBSCR    
 ...
 L.1699       638  LOAD_FAST                'wl'
              ...
              654  LOAD_CONST               1
              656  BINARY_SUBTRACT  
              658  BINARY_TRUE_DIVIDE
              660  LOAD_GLOBAL              np
              662  LOAD_METHOD              ones
              664  LOAD_FAST                'N'
              666  CALL_METHOD_1         1  '1 positional argument'
              668  BINARY_MULTIPLY  
              670  STORE_FAST               'fwhm_'

 L.1700       672  LOAD_FAST                'fwhm_'
              674  LOAD_CONST               0
              676  BINARY_SUBSCR    
              678  LOAD_GLOBAL              min
              680  LOAD_FAST                'spd_model_pars'
              682  LOAD_STR                 'fwhm_min'
              684  BINARY_SUBSCR    
              686  CALL_FUNCTION_1       1  '1 positional argument'
              688  COMPARE_OP               <
          690_692  POP_JUMP_IF_FALSE   716  'to 716'

 L.1701       694  LOAD_GLOBAL              min
              696  LOAD_FAST                'spd_model_pars'
              698  LOAD_STR                 'fwhm_min'
              700  BINARY_SUBSCR    
              702  CALL_FUNCTION_1       1  '1 positional argument'
              704  LOAD_GLOBAL              np
              706  LOAD_METHOD              ones
              708  LOAD_FAST                'N'
              710  CALL_METHOD_1         1  '1 positional argument'
              712  BINARY_MULTIPLY  
              714  STORE_FAST               'fwhm_'
            716_0  COME_FROM           690  '690'

 L.1702       716  LOAD_FAST                'spd_optim_pars'
              718  LOAD_STR                 'x0'
              720  DUP_TOP_TWO      
              722  BINARY_SUBSCR    
              724  LOAD_GLOBAL              list
              726  LOAD_FAST                'fwhm_'
              728  CALL_FUNCTION_1       1  '1 positional argument'
              730  INPLACE_ADD      
              732  ROT_THREE        
              734  STORE_SUBSCR     
            736_0  COME_FROM           586  '586'

 L.1704       736  LOAD_FAST                'allow_nongaussianbased_mono_spds'
              738  LOAD_CONST               True
              740  COMPARE_OP               ==
          742_744  POP_JUMP_IF_FALSE   818  'to 818'

 L.1705       746  LOAD_FAST                'spd_optim_pars'
              748  LOAD_STR                 'LB'
              750  DUP_TOP_TWO      
              752  BINARY_SUBSCR    
              754  LOAD_GLOBAL              list
              756  LOAD_FAST                'spd_model_pars'
              758  LOAD_STR                 'bw_order_min'
              760  BINARY_SUBSCR    
 ...
 L.1706       770  LOAD_FAST                'spd_optim_pars'
              772  LOAD_STR                 'UB'
              774  DUP_TOP_TWO      
              776  BINARY_SUBSCR    
              778  LOAD_GLOBAL              list
              780  LOAD_FAST                'spd_model_pars'
              782  LOAD_STR                 'bw_order_max'
              784  BINARY_SUBSCR    
 ...
 L.1707       794  LOAD_FAST                'spd_optim_pars'
              796  LOAD_STR                 'x0'
              798  DUP_TOP_TWO      
              800  BINARY_SUBSCR    
              802  LOAD_GLOBAL              list
              804  LOAD_FAST                'spd_model_pars'
              806  LOAD_STR                 'bw_order'
              808  BINARY_SUBSCR    
              810  CALL_FUNCTION_1       1  '1 positional argument'
              812  INPLACE_ADD      
              814  ROT_THREE        
              816  STORE_SUBSCR     
            818_0  COME_FROM           742  '742'

 L.1710       818  LOAD_FAST                'optimizer_type'
              820  LOAD_STR                 '2mixer'
              822  COMPARE_OP               ==
          824_826  POP_JUMP_IF_FALSE   914  'to 914'

 L.1711       828  LOAD_FAST                'spd_optim_pars'
              830  LOAD_STR                 'LB'
              832  DUP_TOP_TWO      
              834  BINARY_SUBSCR    
              836  LOAD_GLOBAL              list
              838  LOAD_GLOBAL              np
              840  LOAD_METHOD              zeros
              842  LOAD_FAST                'N'
              844  LOAD_CONST               3
              846  BINARY_SUBTRACT  
 ...
 L.1712       858  LOAD_FAST                'spd_optim_pars'
              860  LOAD_STR                 'UB'
              862  DUP_TOP_TWO      
              864  BINARY_SUBSCR    
              866  LOAD_GLOBAL              list
              868  LOAD_GLOBAL              np
              870  LOAD_METHOD              ones
              872  LOAD_FAST                'N'
              874  LOAD_CONST               3
              876  BINARY_SUBTRACT  
 ...
 L.1713       888  LOAD_FAST                'spd_optim_pars'
              890  LOAD_STR                 'x0'
              892  DUP_TOP_TWO      
              894  BINARY_SUBSCR    
              896  LOAD_GLOBAL              list
              898  LOAD_FAST                'spd_model_pars'
              900  LOAD_STR                 'pair_strengths'
              902  BINARY_SUBSCR    
              904  CALL_FUNCTION_1       1  '1 positional argument'
              906  INPLACE_ADD      
              908  ROT_THREE        
              910  STORE_SUBSCR     
              912  JUMP_FORWARD       1020  'to 1020'
            914_0  COME_FROM           824  '824'

 L.1715       914  LOAD_FAST                'optimizer_type'
              916  LOAD_STR                 '3mixer'
              918  COMPARE_OP               ==
          920_922  POP_JUMP_IF_FALSE  1020  'to 1020'

 L.1716       924  LOAD_FAST                'spd_optim_pars'
              926  LOAD_STR                 'LB'
              928  DUP_TOP_TWO      
              930  BINARY_SUBSCR    
              932  LOAD_GLOBAL              list
              934  LOAD_GLOBAL              np
              936  LOAD_METHOD              zeros
              938  LOAD_FAST                'spd_model_pars'
              940  LOAD_STR                 'triangle_strengths'
              942  BINARY_SUBSCR    
              944  LOAD_ATTR                shape
              946  LOAD_CONST               0
              948  BINARY_SUBSCR    
 ...
 L.1717       960  LOAD_FAST                'spd_optim_pars'
              962  LOAD_STR                 'UB'
              964  DUP_TOP_TWO      
              966  BINARY_SUBSCR    
              968  LOAD_GLOBAL              list
              970  LOAD_GLOBAL              np
              972  LOAD_METHOD              ones
              974  LOAD_FAST                'spd_model_pars'
              976  LOAD_STR                 'triangle_strengths'
              978  BINARY_SUBSCR    
              980  LOAD_ATTR                shape
              982  LOAD_CONST               0
              984  BINARY_SUBSCR    
 ...
 L.1718       996  LOAD_FAST                'spd_optim_pars'
              998  LOAD_STR                 'x0'
             1000  DUP_TOP_TWO      
             1002  BINARY_SUBSCR    
             1004  LOAD_GLOBAL              list
             1006  LOAD_FAST                'spd_model_pars'
             1008  LOAD_STR                 'triangle_strengths'
             1010  BINARY_SUBSCR    
             1012  CALL_FUNCTION_1       1  '1 positional argument'
             1014  INPLACE_ADD      
             1016  ROT_THREE        
             1018  STORE_SUBSCR     
           1020_0  COME_FROM           920  '920'
           1020_1  COME_FROM           912  '912'

 L.1720      1020  LOAD_GLOBAL              np
             1022  LOAD_METHOD              array
             1024  LOAD_FAST                'spd_optim_pars'
             1026  LOAD_STR                 'x0'
             1028  BINARY_SUBSCR    
             1030  CALL_METHOD_1         1  '1 positional argument'
             1032  LOAD_FAST                'spd_optim_pars'
             1034  LOAD_STR                 'x0'
             1036  STORE_SUBSCR     

 L.1721      1038  LOAD_GLOBAL              np
             1040  LOAD_METHOD              array
             1042  LOAD_FAST                'spd_optim_pars'
             1044  LOAD_STR                 'LB'
             1046  BINARY_SUBSCR    
             1048  CALL_METHOD_1         1  '1 positional argument'
             1050  LOAD_FAST                'spd_optim_pars'
             1052  LOAD_STR                 'LB'
             1054  STORE_SUBSCR     

 L.1722      1056  LOAD_GLOBAL              np
             1058  LOAD_METHOD              array
             1060  LOAD_FAST                'spd_optim_pars'
             1062  LOAD_STR                 'UB'
             1064  BINARY_SUBSCR    
             1066  CALL_METHOD_1         1  '1 positional argument'
             1068  LOAD_FAST                'spd_optim_pars'
             1070  LOAD_STR                 'UB'
             1072  STORE_SUBSCR     
             1074  JUMP_FORWARD       1214  'to 1214'
           1076_0  COME_FROM           440  '440'

 L.1726      1076  LOAD_FAST                'optimizer_type'
             1078  LOAD_STR                 '2mixer'
             1080  COMPARE_OP               ==
         1082_1084  POP_JUMP_IF_FALSE  1140  'to 1140'

 L.1727      1086  LOAD_GLOBAL              np
             1088  LOAD_METHOD              zeros
             1090  LOAD_FAST                'N'
             1092  LOAD_CONST               3
             1094  BINARY_SUBTRACT  
             1096  CALL_METHOD_1         1  '1 positional argument'
           1098_0  COME_FROM           314  '314'
             1098  LOAD_FAST                'spd_optim_pars'
             1100  LOAD_STR                 'LB'
             1102  STORE_SUBSCR     

 L.1728      1104  LOAD_GLOBAL              np
             1106  LOAD_METHOD              ones
             1108  LOAD_FAST                'N'
             1110  LOAD_CONST               3
             1112  BINARY_SUBTRACT  
             1114  CALL_METHOD_1         1  '1 positional argument'
             1116  LOAD_FAST                'spd_optim_pars'
             1118  LOAD_STR                 'UB'
             1120  STORE_SUBSCR     

 L.1729      1122  LOAD_FAST                'spd_model_pars'
             1124  LOAD_STR                 'pair_strengths'
             1126  BINARY_SUBSCR    
             1128  LOAD_METHOD              copy
             1130  CALL_METHOD_0         0  '0 positional arguments'
             1132  LOAD_FAST                'spd_optim_pars'
             1134  LOAD_STR                 'x0'
             1136  STORE_SUBSCR     
             1138  JUMP_FORWARD       1214  'to 1214'
           1140_0  COME_FROM          1082  '1082'

 L.1731      1140  LOAD_FAST                'optimizer_type'
             1142  LOAD_STR                 '3mixer'
             1144  COMPARE_OP               ==
         1146_1148  POP_JUMP_IF_FALSE  1214  'to 1214'

 L.1732      1150  LOAD_GLOBAL              np
             1152  LOAD_METHOD              zeros
             1154  LOAD_FAST                'spd_model_pars'
             1156  LOAD_STR                 'triangle_strengths'
             1158  BINARY_SUBSCR    
             1160  LOAD_ATTR                shape
             1162  LOAD_CONST               0
             1164  BINARY_SUBSCR    
             1166  CALL_METHOD_1         1  '1 positional argument'
             1168  LOAD_FAST                'spd_optim_pars'
             1170  LOAD_STR                 'LB'
             1172  STORE_SUBSCR     

 L.1733      1174  LOAD_GLOBAL              np
             1176  LOAD_METHOD              ones
             1178  LOAD_FAST                'spd_model_pars'
             1180  LOAD_STR                 'triangle_strengths'
             1182  BINARY_SUBSCR    
             1184  LOAD_ATTR                shape
             1186  LOAD_CONST               0
             1188  BINARY_SUBSCR    
             1190  CALL_METHOD_1         1  '1 positional argument'
             1192  LOAD_FAST                'spd_optim_pars'
             1194  LOAD_STR                 'UB'
             1196  STORE_SUBSCR     

 L.1734      1198  LOAD_FAST                'spd_model_pars'
             1200  LOAD_STR                 'triangle_strengths'
             1202  BINARY_SUBSCR    
             1204  LOAD_METHOD              copy
             1206  CALL_METHOD_0         0  '0 positional arguments'
             1208  LOAD_FAST                'spd_optim_pars'
             1210  LOAD_STR                 'x0'
             1212  STORE_SUBSCR     
           1214_0  COME_FROM          1146  '1146'
           1214_1  COME_FROM          1138  '1138'
           1214_2  COME_FROM          1074  '1074'
           1214_3  COME_FROM           428  '428'
           1214_4  COME_FROM           322  '322'

 L.1736      1214  LOAD_FAST                'spd_optim_pars'
             1216  LOAD_FAST                'spd_model_pars'
             1218  BUILD_TUPLE_2         2 
             1220  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `LOAD_FAST' instruction at offset 1098
