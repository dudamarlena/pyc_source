...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\robotframework_metrics\runner.py
# Compiled at: 2020-03-14 11:50:54
...
def parse_options():
    ...
    general.add_argument('-M',
      '--metrics-report-name', dest='metrics_report_name',
    ...
    general.add_argument('-k',
      '--ignorekeywords', dest='ignorekeywords',
      default='False',
