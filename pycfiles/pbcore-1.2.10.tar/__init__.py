...
# [GCC 8.4.0]
# Embedded file name: /Users/dalexander/Dropbox/Sources/git-pbi/pbcore/pbcore/data/datasets/__init__.py
# Compiled at: 2016-05-20 11:37:57
"""Doctest resources"""
import os
...
XML_FILES = [
 ...
 'pbalchemysim.hdfsubreadset.xml',
 'ccsaligned.dataset.xml']
BAM_FILES = [
 'pbalchemysim0.pbalign.bam',
...
def _getAbsPath(fname):
    return resource_filename(Requirement.parse('pbcore'), 'pbcore/data/datasets/%s' % fname)
