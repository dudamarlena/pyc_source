...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/SBP/python/towerlib/towerlib/towerlib.py
# Compiled at: 2019-10-18 10:51:21
# Size of source mod 2**32: 70419 bytes
"""
...
"""
import concurrent.futures, json, logging, math, sys
from cachetools import TTLCache, cached
from requests import Session
from towerlib.entities.core import validate_json
from .entities import Config, LicenseInfo, LicenseFeatures, Organization, User, Project, Team, Group, Inventory, Host, CredentialType, Credential, JobTemplate, VALID_CREDENTIAL_TYPES, JOB_TYPES, VERBOSITY_LEVELS, Cluster, ClusterInstance, EntityManager
from .towerlibexceptions import AuthFailed, InvalidOrganization, InvalidInventory, InvalidVariables, InvalidUser, InvalidTeam, InvalidCredential, InvalidHost, InvalidProject, InvalidGroup, InvalidCredentialType, InvalidPlaybook, InvalidInstanceGroup, InvalidJobType, InvalidVerbosity, InvalidJobTemplate
...
class Tower:
    __doc__ = 'Models the api of ansible tower.'
    ...
    def configuration(self):
        ...
        config = results.json()
        features = [config.get('license_info', {}).get('features', {}).get(key) for key in LicenseFeatures._fields]
        info = [config.get('license_info', {}).get(key) for key in LicenseInfo._fields]
        info[2] = LicenseFeatures(*features)
        configuration = [config.get(key) for key in Config._fields]
    ...
    def cluster(self):
        ...
        def get_instance(name, instance_list):
            node = next((instance for instance in instance_list if instance.get('node') == name), None)
        ...
        instances = [get_instance(name_, instance_list) for name_ in instance_groups.get('instances', [])]
    ...
    def organizations(self):
        ...
        """
        return EntityManager(self, entity_name='organizations',
    ...
    def _get_paginated_response(self, url, params=None):
        ...
        if page_count:
            with concurrent.futures.ThreadPoolExecutor(max_workers=30) as (executor):
                futures = [executor.submit((self.session.get), url, params={'page': index}) for index in range(page_count, 1, -1)]
    ...
    def users(self):
        ...
        """
        return EntityManager(self, entity_name='users',
          entity_object='User',
    ...
    def create_user(self, username, password, first_name='', last_name='', email='', is_superuser=False, is_system_auditor=False):
    ...
    def create_user_in_organization(self, organization, username, password, first_name, last_name, email):
    ...
    def projects(self):
        ...
        """
        return EntityManager(self, entity_name='projects',
    ...
    def create_project_in_organization(self, organization, name, description, credential, scm_url, local_path='', custom_virtualenv='', scm_branch='master', scm_type='git', scm_clean=True, scm_delete_on_update=False, scm_update_on_launch=True, scm_update_cache_timeout=0):
        ...
        if not organization_:
            raise InvalidOrganization(organization)
        return organization_.create_project(name, description, credential, scm_url, local_path, custom_virtualenv, scm_branch, scm_type, scm_clean, scm_delete_on_update, scm_update_on_launch, scm_update_cache_timeout)
    ...
    def teams(self):
        ...
        """
        return EntityManager(self, entity_name='teams',
          entity_object='Team',
          primary_match_field='name')
    ...
    def groups(self):
        ...
        """
        return EntityManager(self, entity_name='groups',
          entity_object='Group',
          primary_match_field='name')
    ...
    def inventories(self):
        ...
        """
        return EntityManager(self, entity_name='inventories',
    ...
    def create_organization_inventory(self, organization, name, description, variables='{}'):
    ...
    def hosts(self):
        ...
        """
        return EntityManager(self, entity_name='hosts',
          entity_object='Host',
          primary_match_field='name')
    ...
    def create_host_in_inventory(self, organization, inventory, name, description, variables='{}'):
    ...
    def instances(self):
        ...
        """
        return EntityManager(self, entity_name='instances',
    ...
    def instance_groups(self):
        ...
        """
        return EntityManager(self, entity_name='instance_groups',
    ...
    def credential_types(self):
        ...
        """
        return EntityManager(self, entity_name='credential_types',
    ...
    def create_credential_type(self, name, description, type_, inputs_='{}', injectors='{}'):
        ...
        if type_.lower() not in VALID_CREDENTIAL_TYPES:
            ...
            response = self.session.post(url, json=payload)
            response.ok or self._logger.error('Error creating credential type "%s", response was: "%s"', type_, response.text)
        if response.ok:
    ...
    def credentials(self):
        ...
        """
        return EntityManager(self, entity_name='credentials',
    ...
    def get_organization_credential_by_name(self, organization, name, credential_type):
        ...
        if not organization_:
            raise InvalidOrganization(organization)
        return next(self.credentials.filter({'organization':organization_.id,  'name__iexact':name, 
    ...
    def create_credential_with_credential_type_id(self, name: str, credential_type_id: int, description='', organization_id=None, user_id=None, team_id=None, inputs='{}'):
    ...
    def create_credential_in_organization(self, organization, name, description, user, team, credential_type, inputs_='{}'):
        ...
        if not validate_json(inputs_):
            raise InvalidVariables(inputs_)
        return self.create_credential_with_credential_type_id(name, (credential_type_.id),
          description=description,
          user_id=(user_.id),
          team_id=(team_.id),
    ...
    def create_credential_in_organization_with_type_id(self, organization, name, description, user, team, credential_type_id, inputs_='{}'):
        """Creates a credential under an organization.
    ...
    def delete_organization_credential_by_name(self, organization, name, credential_type):
        ...
        if not organization_:
            raise InvalidOrganization(organization)
        credential = next(self.credentials.filter({'organization':organization_.id,  'name__iexact':name, 
         'credential_type':credential_type_.id}), None)
        if not credential:
    ...
    def jobs(self):
        ...
        """
        return EntityManager(self, entity_name='jobs',
          entity_object='Job',
          primary_match_field='name')
    ...
    def unified_jobs(self):
        ...
        """
        return EntityManager(self, entity_name='unified_jobs',
          entity_object='Job',
          primary_match_field='name')
    ...
    def unified_job_templates(self):
        ...
        """
        return EntityManager(self, entity_name='unified_job_templates',
    ...
    def workflow_jobs(self):
        ...
        """
        return EntityManager(self, entity_name='workflow_jobs',
          entity_object='Job',
          primary_match_field='name')
    ...
    def workflow_job_templates(self):
        ...
        """
        return EntityManager(self, entity_name='workflow_job_templates',
          entity_object='JobTemplate',
          primary_match_field='name')
    ...
    def system_jobs(self):
        ...
        """
        return EntityManager(self, entity_name='system_jobs',
          entity_object='Job',
          primary_match_field='name')
    ...
    def job_templates(self):
        ...
        """
        return EntityManager(self, entity_name='job_templates',
          entity_object='JobTemplate',
          primary_match_field='name')
    ...
    def create_job_template(self, name, description, organization, inventory, project, playbook, credential=None, credential_type=None, instance_groups=None, host_config_key=None, job_type='run', vault_credential=None, forks=0, limit=0, verbosity=0, extra_vars='', job_tags='', force_handlers=False, skip_tags='', start_at_task='', timeout=0, use_fact_cache=False, ask_diff_mode_on_launch=False, ask_variables_on_launch=False, ask_limit_on_launch=False, ask_tags_on_launch=False, ask_skip_tags_on_launch=False, ask_job_type_on_launch=False, ask_verbosity_on_launch=False, ask_inventory_on_launch=False, ask_credential_on_launch=False, survey_enabled=False, become_enabled=False, diff_mode=False, allow_simultaneous=False):
            ...
            if any([credential, credential_type]):
                ...
                if instance_groups:
                    ...
                    for instance_group in set(instance_groups):
                        group = next((group for group in tower_instance_groups if group.name == instance_group), None)
                ...
                response = self.session.post(url, json=payload)
                response.ok or self._logger.error('Error creating job template, response was: "%s"', response.text)
            if response.ok:
                return JobTemplate(self, response.json())
    ...
    def roles(self):
        ...
        """
        return EntityManager(self, entity_name='roles',
          entity_object='Role',
          primary_match_field='name')
    ...
    def notification_templates(self):
        ...
        """
        return EntityManager(self, entity_name='notification_templates',
    ...
    def inventory_sources(self):
        ...
        """
        return EntityManager(self, entity_name='inventory_sources',
