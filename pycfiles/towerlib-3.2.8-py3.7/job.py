...
# [GCC 8.4.0]
# Embedded file name: towerlib/entities/job.py
# Compiled at: 2018-08-01 07:00:04
"""
Main code for jobs
...
class JobRun(Entity):
    ...
    def credential(self):
        ...
        return self._tower._get_object_by_url('Credential', url)
...
class JobTemplate(Entity):
    ...
    def add_extra_credentials(self, credentials):
        ...
        for credential in credentials:
            ...
            if not extra_credential:
                ...
                url = ('{api}/job_templates/{id}/extra_credentials/').format(api=self._tower.api, id=self.id)
    ...
    def object_roles(self):
        ...
        if not self._object_roles:
            ...
            self._object_roles = EntityManager(self._tower, entity_object='ObjectRole', primary_match_field='name', url=url)
    ...
    def use_fact_cache(self, value):
        ...
        """
        url = ('{api}/job_templates/{id}/').format(api=self._tower.api, id=self.id)
    ...
    def launch(self, extra_vars=None, job_tags=None, limit=None, inventory=None, credential=None):
        ...
        """
        payload = {key:value for key, value in locals().items() if value and key != 'self' if value and key != 'self'}
