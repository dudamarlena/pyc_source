...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/SBP/python/towerlib/towerlib/entities/group.py
...
"""
import logging
from towerlib.towerlibexceptions import InvalidHost, InvalidGroup, InvalidValue
...
class Group(Entity):
    __doc__ = 'Models the group entity of ansible tower.'
    ...
    def hosts(self):
        ...
        return EntityManager((self._tower), entity_object='Host',
