...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/SBP/python/towerlib/towerlib/entities/notification.py
# Compiled at: 2019-10-18 06:12:55
# Size of source mod 2**32: 15413 bytes
"""
...
class NotificationTemplate(Entity):
    __doc__ = 'Models the notification template of Ansible Tower/AWX.'
    ...
    def notification_configuration(self):
        ...
        notification_types = {'email':NotificationEmail, 
        ...
        if class_name is None:
            raise ValueError('Invalid {notification_type} notification type'.format(notification_type=(self.notification_type)))
    ...
    def recent_notifications(self):
        ...
        return EntityManager((self._tower), entity_object='Notification',
          primary_match_field='subject',
          url=url)


class Notification(Entity):
    __doc__ = 'Models the notifications of Ansible Tower/AWX.'
...
class NotificationEmail:
    __doc__ = 'Notification type configuration for email.'
...
class NotificationTwilio:
    __doc__ = 'Notification type configuration for twilio.'
...
class NotificationPagerDuty:
    __doc__ = 'Notification type configuration for pagerduty.'
...
class NotificationGrafana:
    __doc__ = 'Notification type configuration for WebHook.'
...
class NotificationHipChat:
    __doc__ = 'Notification type configuration for HipChat.'
...
class NotificationMatterMost:
    __doc__ = 'Notification type configuration for MatterMost.'
...
class NotificationIRC:
    __doc__ = 'Notification type configuration for IRC.'
...
class NotificationRocketChat:
    __doc__ = 'Notification type configuration for Rocket.Chat.'
...
class NotificationSlack:
    __doc__ = 'Notification type configuration for slack.'
