...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/SBP/python/towerlib/towerlib/entities/organization.py
# Compiled at: 2019-10-18 06:12:55
# Size of source mod 2**32: 19576 bytes
"""
...
"""
import logging
from towerlib.towerlibexceptions import InvalidTeam, InvalidVariables, InvalidInventory, InvalidCredential, InvalidProject, InvalidCredentialType, InvalidValue
...
class Organization(Entity):
    __doc__ = 'Models the organization entity of ansible tower.'
    ...
    def name(self, value):
        ...
        if all(conditions):
            ...
            raise InvalidValue('{value} is invalid. Condition max_characters must be less than or equal to {max_characters}'.format(value=value,
    ...
    def _get_object_role_id(self, name):
        ...
        """
        return next((obj.id for obj in self.object_roles if obj.name.lower() == name.lower()), None)
    ...
    def object_roles(self):
        ...
        return EntityManager((self._tower), entity_object='ObjectRole',
    ...
    def projects(self):
        ...
        return EntityManager((self._tower), entity_object='Project',
          primary_match_field='name',
          url=url)
    ...
    def create_project(self, name, description, credential, scm_url, local_path='', custom_virtualenv='', scm_branch='master', scm_type='git', scm_clean=True, scm_delete_on_update=False, scm_update_on_launch=True, scm_update_cache_timeout=0):
    ...
    def inventories(self):
        ...
        return EntityManager((self._tower), entity_object='Inventory',
          primary_match_field='name',
          url=url)
    ...
    def credentials(self):
        ...
        return EntityManager((self._tower), entity_object='Credential',
          primary_match_field='name',
          url=url)
    ...
    def get_credential_by_name(self, name, credential_type):
        ...
        return next(self.credentials.filter({'organization':self.id,  'name__iexact':name, 
