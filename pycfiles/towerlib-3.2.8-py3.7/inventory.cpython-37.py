...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/SBP/python/towerlib/towerlib/entities/inventory.py
# Compiled at: 2019-10-18 11:28:23
# Size of source mod 2**32: 16619 bytes
"""
...
"""
import logging
from towerlib.towerlibexceptions import InvalidVariables, InvalidHost, InvalidGroup, InvalidValue, InvalidOrganization, InvalidCredential, InvalidProject
...
class Inventory(Entity):
    __doc__ = 'Models the inventory entity of ansible tower.'
    ...
    def create_source(self, name, description, source='scm', source_path='', source_script=None, source_vars='', credential='', credential_type='', source_regions='', instance_filters='', group_by='', overwrite=True, overwrite_vars=True, timeout=0, verbosity=1, update_on_launch=True, update_cache_timeout=0, source_project='', update_on_project_update=False):
        """
