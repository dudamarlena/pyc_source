...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/config/_version.py
# Compiled at: 2020-04-15 09:20:39
...
def get_config():
    ...
    cfg.versionfile_source = 'artellapipe/config/_version.py'
    cfg.verbose = False
    return cfg
