...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/common/constants.py
...
Constants.MASK_HIGH_VALUE = 4294967295
Constants.MASK_LOW_VALUE = 4294967295
...
Constants.MASK_TASK_ATTR_ROOT = 1
Constants.MASK_TASK_ATTR_OPERATION = 2
Constants.MASK_TASK_ATTR_RUNTIME = 4
Constants.MASK_TASK_ATTR_FLATTENED = 8
Constants.MASK_TASK_ATTR_TEMPLATE = 24
Constants.MASK_INVOKABLE_TARGET_MANDATORY = 1
Constants.MASK_INVOKABLE_IGNORE_RESULT = 2
...
Constants.DEFAULT_SKIPKEYS = [
 '_EasySerializable__module_name', '_EasySerializable__class_name',
