...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/service/event_service.py
...
class EventManager(object):
    ...
    def register(self, key, listener):
        ...
        self._EventManager__listeners[key] = listener
    ...
    def unregister(self, key):
        self._EventManager__listeners.pop(key, None)

    @property
    def listeners(self):
        return self._EventManager__listeners
    ...
    def dispatch(self, e):
        ...
        if e.event_id == constants.EVENT_ID_BROADCAST_COMMAND:
            if e.is_command:
                ...
                return
        for i, l in self._EventManager__listeners.items():
