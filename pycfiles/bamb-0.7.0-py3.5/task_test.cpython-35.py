...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/test/task_test.py
# Compiled at: 2017-09-09 06:21:55
...
class TaskTest(TestCase):
    ...
    def test_multi_background_operation(self):
        ...
        cmd = base.Event(source_tag=None, event_id=constants.EVENT_ID_BROADCAST_COMMAND, data={'user_id': 'test', 'listener': 'service.simple.SimpleEventConsumer'})
