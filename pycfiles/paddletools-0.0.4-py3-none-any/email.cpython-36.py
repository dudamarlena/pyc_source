...
# [GCC 8.4.0]
# Embedded file name: /home/lvkun/projects/self/PaddleTools/paddletools/reminder/email.py
# Compiled at: 2020-04-29 03:03:44
...
class EmailReminder(object):
    ...
    def __init__(self, sender, receiver, password):
        ...
        if email_domain not in email_stmp_server:
            raise Exception('{} is not supported now! please change another send email'.format(email_domain))
