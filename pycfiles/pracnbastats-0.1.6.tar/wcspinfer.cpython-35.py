...
# Embedded file name: /home/nyga/work/code/pracmln/python3/pracmln/mln/inference/wcspinfer.py
...
class WCSPConverter(object):
    ...
    def _createvars(self):
        ...
        for variable in self.mrf.variables:
            if isinstance(variable, FuzzyVariable):
                pass
            elif variable.valuecount(self.mrf.evidence_dicti()) == 1:
    ...
    def _gather_constraint_tuples(self, varindices, formula):
        ...
        assignment = defaultProcedure or [
         None] * len(varindices)
        ...
        maxtruth = defaultProcedure or formula.maxtruth(self.mrf.evidence)
