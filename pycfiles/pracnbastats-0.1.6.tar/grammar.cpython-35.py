...
# Embedded file name: /home/nyga/work/code/pracmln/python3/pracmln/logic/grammar.py
# Compiled at: 2018-04-24 04:48:32
# Size of source mod 2**32: 24643 bytes
                            ...
                            if op == 'v':
                                ...
                                if op == '=>':
                                    ...
                                    if op == '<=>':
                                        ...
                                        elif op == 'count' and len(toks) in (3, 4):
...
class Grammar(object):
    ...
    def parse_domain(self, s):
        ...
        if m == None:
            return
        return (
         m.group(1), list(map(str.strip, m.group(2).split(','))))
