...
# Embedded file name: /data/code/pracmln/python3/pracmln/mln/learning/common.py
...
class AbstractLearner(object):
    ...
    def _filter_fixweights(self, v):
        ...
        v_ = []
        for val in [v[i] for i in range(len(self.mrf.formulas)) if not self.mrf.mln.fixweights[i] if self.mrf.mln.weights[i] != HARD]:
            v_.append(val)
