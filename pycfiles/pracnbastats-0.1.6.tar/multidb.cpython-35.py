...
# Embedded file name: /home/nyga/work/code/pracmln/python3/pracmln/mln/learning/multidb.py
    ...
    def _iterdbs(self, method):
        for i, db in enumerate(self.dbs):
            yield (i, self.mln, db, method,
             self._params + {'verbose': not self.multicore, 'multicore': False})
