...
# Embedded file name: /home/nyga/work/code/pracmln/python2/pracmln/mlnlearn.py
...
class MLNLearn(object):
    ...
    def run(self):
        ...
        if self.verbose:
            ...
            print tabulate(sorted(list(confg.viewitems()), key=lambda (key, v): str(key)), headers=('Parameter:',
                                                                                                    'Value:'))
        params = dict([ (k, getattr(self, k)) for k in ('multicore', 'verbose', 'profile',
