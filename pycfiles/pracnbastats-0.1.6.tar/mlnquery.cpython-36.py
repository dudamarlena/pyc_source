...
# Embedded file name: /data/code/pracmln/python3/pracmln/mlnquery.py
...
class MLNQueryGUI(object):
    ...
    def __init__(self, master, gconf, directory=None):
        ...
        self.emln_container = FileEditBar((self.frame), directory=(self.dir),
          filesettings={'extension':'.emln', 
         'ftypes':[('MLN extension files', '.emln')]},
          defaultname='*unknown{}',
        ...
        self.cb_ignore_unknown_preds = Checkbutton(option_container, text='ignore unkown predicates',
    ...
    def _got_focus(self, *_):
        if self.master.focus_get() == self.mln_container.editor:
            ...
            if self.master.focus_get() == self.db_container.editor:
                ...
                if not self.project.emlns:
                    if not self.emln_container.file_buffer:
    ...
    def infer(self, savegeometry=True, options={}, *args):
        ...
        try:
            ...
            if options.get('mlnarg') is not None:
                ...
                mlnobj = parse_mln(mln_content, searchpaths=[self.dir], projectpath=(os.path.join(self.dir, self.project.name)),
