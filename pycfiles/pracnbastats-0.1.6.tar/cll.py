...
# Embedded file name: /home/nyga/work/code/pracmln/python2/pracmln/mln/learning/cll.py
    ...
    def _compute_stat_rec(self, literals, gndliterals, var_assign, formula, f_gndlit_parts=None, processed=None, isconj=False):
        ...
        if len(literals) == 0:
            ...
            for gndlit in gndliterals:
                if isinstance(gndlit, Logic.Equality) or hasattr(self, 'qpreds') and gndlit.gndatom.predname not in self.qpreds:
                    continue
