...
# Embedded file name: /home/nyga/work/code/pracmln/python3/pracmln/mln/inference/infer.py
            ...
            for pred in self.cwpreds:
                ...
                for gndatom in self.mrf.gndatoms:
                    if gndatom.predname != pred:
                        pass
                    elif self.mrf.evidence[gndatom.idx] is None:
    ...
    def _expand_queries(self, queries):
        ...
        for query in queries:
            if type(query) == str:
                ...
                elif query not in self.mln.prednames:
