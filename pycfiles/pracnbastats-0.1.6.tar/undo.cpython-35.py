...
# Embedded file name: /home/nyga/work/code/pracmln/python3/pracmln/utils/undo.py
# Compiled at: 2018-04-24 04:48:32
# Size of source mod 2**32: 17028 bytes
...
class Number(Undoable):
    ...
    def set(self, number):
        ...
        """
        self.do(Assignment(self), Number._Number__value(number))

    def __iadd__(self, other):
        self.do(Addition(self), Number._Number__value(other))
        return self
    ...
    def __imul__(self, other):
        self.do(Multiplication(self), Number._Number__value(other))
        return self

    def __idiv__(self, other):
        self.do(Multiplication(self), 1 / Number._Number__value(other))
        return self

    def __add__(self, other):
        return self.value + Number._Number__value(other)
