...
# Embedded file name: /data/code/pracmln/python3/pracmln/mln/mrfvars.py
# Compiled at: 2019-02-27 05:10:32
# Size of source mod 2**32: 16221 bytes
...
class BinaryVariable(MRFVariable):
    ...
    def _itervalues(self, evidence=None):
        if evidence is None:
            ...
            if evidence.get(gndatom.idx) is not None:
                if evidence.get(gndatom.idx) in (0, 1):
                    yield (
