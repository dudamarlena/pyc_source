...
# Embedded file name: /data/code/pracmln/python3/pracmln/mln/grounding/default.py
    ...
    def _itergroundings(self, simplify=False, unsatfailure=False):
        ...
        for i, formula in enumerate(self.formulas):
            ...
            for gndformula in formula.itergroundings((self.mrf), simplify=simplify):
                if unsatfailure:
                    if gndformula.weight == HARD:
                        if gndformula(self.mrf.evidence) == 0:
                            print()
