...
# [GCC 8.4.0]
# Embedded file name: /home/esalazar/git/teleceptor/teleceptor/api/messages.py
    ...
    def PURGE(self, sensor_id, timeout):
        ...
        with sessionScope() as (s):
            ...
            if msgQueue is None:
                ...
                statusCode = '400'
                return json.dumps(returnData, indent=4)
            rowsDeleted = s.query(Message).filter(Message.message_queue_id == msgQueue.id, Message.timeout <= timeout).delete()
