...
# [GCC 8.4.0]
# Embedded file name: /home/tomas/prace/vyvoj/cmsplugin_satchmo/cmsplugin_satchmo/migrations/0002_auto__add_satchmositesetting.py
# Compiled at: 2014-06-18 09:46:38
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('cmsplugin_satchmo_satchmositesetting', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'site', self.gf('django.db.models.fields.related.OneToOneField')(related_name='satchmo_sites', unique=True, to=orm['sites.Site'])),
         (
          'shop_base', self.gf('django.db.models.fields.SlugField')(max_length=50)),
         (
          'product_slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
         (
          'category_slug', self.gf('django.db.models.fields.SlugField')(max_length=50))))
        db.send_create_signal('cmsplugin_satchmo', ['SatchmoSiteSetting'])

    def backwards(self, orm):
        db.delete_table('cmsplugin_satchmo_satchmositesetting')
