...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/tornpg.py
# Compiled at: 2015-03-25 03:06:37
"""A lightweight wrapper around psycopg2.
"""
from __future__ import absolute_import, division, with_statement
import copy, itertools, logging, os, time
try:
...
class Connection(object):
    ...
    def __init__(self, host, database, port=None, user=None, password=None, max_idle_time=7200, connect_timeout=0, connection_factory=None):
        self.host = host
        self.database = database
        self.max_idle_time = float(max_idle_time)
        args = dict(client_encoding='utf8', database=database, connect_timeout=connect_timeout)
        if user is not None:
            args['user'] = user
        ...
        try:
            ...
            logging.error('Cannot connect to Postgresql on %s:%s', self.host, exc_info=True)
