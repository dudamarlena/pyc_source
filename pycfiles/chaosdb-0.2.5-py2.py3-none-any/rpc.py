...
# Embedded file name: build/bdist.linux-x86_64/egg/chaos/amqp/rpc.py
# Compiled at: 2015-12-14 07:02:31
__doc__ = ' AMQP RPC type event consumer related classes and functions. '
...
class Rpc(Queue):
    ...
    def __init__(self, host, credentials, identifier=None, prefetch_count=1, exchange=None, auto_delete=True, queue=None, binds=None, confirm_delivery=False):
        ...
        rpc_queue = {'queue': self.rpc_queue_name, 
           'passive': False, 
           'durable': False, 
    ...
    def _rpc_response_callback(self, channel, method_frame, header_frame, body):
        ...
        if header_frame.correlation_id in self.responses:
            self.responses[header_frame.correlation_id] = {'method_frame': method_frame, 'header_frame': header_frame, 
               'body': body}
