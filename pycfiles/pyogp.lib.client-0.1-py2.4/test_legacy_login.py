...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyogp/lib/client/tests/test_legacy_login.py
...
class TestLegacyLogin(unittest.TestCase):
    ...
    def test_init_legacy_login_params_keys(self):
        ...
        self.assert_(self.login.login_params.has_key('read_critical') and self.login.login_params.has_key('last') and self.login.login_params.has_key('passwd') and self.login.login_params.has_key('id0') and self.login.login_params.has_key('agree_to_tos') and self.login.login_params.has_key('start') and self.login.login_params.has_key('mac') and self.login.login_params.has_key('version') and self.login.login_params.has_key('channel') and self.login.login_params.has_key('first'))
