...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyogp/lib/client/tests/base.py
...
class MockAgentDomain(object):
    ...
    def place_avatar(self, data):
        ...
        d = {'sim_ip': '127.0.0.1', 'sim_port': 12345, 'region_seed_capability': '/region_seed_cap'}
        data = llsd.format_xml(d)
        self.response.status = 200
        self.response.content_type = 'application/llsd+xml'
        self.response.body = data
