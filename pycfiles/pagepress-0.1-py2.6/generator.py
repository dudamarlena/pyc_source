...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/pagepress/generator.py
...
class Generator:
    ...
    def __init__(self, base):
        ...
        self.parsers = {'.md': Markdown()}
        self.types = {'page': Page, 
           'templated': Templated, 
           'html': HTML, 
           'blog': Blog}
        self.templates = TemplateLookup(directories=[os.path.join(base, 'source')], input_encoding='utf-8', output_encoding='utf-8', module_directory=self.data)
        ...
        for page in pages:
            if page['extension'] in self.parsers:
                ...
                try:
                    ...
                    self.pages.append(self.types[pagetype](generator=self, content=content, **metadata))
                except Exception, e:
