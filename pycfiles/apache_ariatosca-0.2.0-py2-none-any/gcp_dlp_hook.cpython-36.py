...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/contrib/hooks/gcp_dlp_hook.py
# Compiled at: 2019-09-11 03:47:34
# Size of source mod 2**32: 71606 bytes
...
class CloudDLPHook(GoogleCloudBaseHook):
    ...
    def cancel_dlp_job(self, dlp_job_id, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client.cancel_dlp_job(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)

    @GoogleCloudBaseHook.catch_http_exception
    def create_deidentify_template(self, organization_id=None, project_id=None, deidentify_template=None, template_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        return client.create_deidentify_template(parent=parent,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def create_dlp_job(self, project_id=None, inspect_job=None, risk_job=None, job_id=None, retry=None, timeout=None, metadata=None, wait_until_finished=True):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        job = client.create_dlp_job(parent=parent,
        ...
        while wait_until_finished:
            job = self.get_dlp_job(dlp_job_id=job_name,
              project_id=project_id)
            self.log.info('DLP job {} state: {}.'.format(job.name, DlpJob.JobState.Name(job.state)))
            if job.state == DlpJob.JobState.DONE:
                return job
            if job.state in [DlpJob.JobState.PENDING,
             DlpJob.JobState.RUNNING,
             DlpJob.JobState.JOB_STATE_UNSPECIFIED]:
                time.sleep(TIME_TO_SLEEP_IN_SECONDS)
            else:
                raise AirflowException('Stopped polling DLP job state. DLP job {} state: {}.'.format(job.name, DlpJob.JobState.Name(job.state)))

        return job

    @GoogleCloudBaseHook.catch_http_exception
    def create_inspect_template(self, organization_id=None, project_id=None, inspect_template=None, template_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if organization_id:
            ...
            if project_id:
                ...
                raise AirflowException('Please provide either organization_id or project_id.')
        return client.create_inspect_template(parent=parent,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def create_job_trigger(self, project_id=None, job_trigger=None, trigger_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        return client.create_job_trigger(parent=parent,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def create_stored_info_type(self, organization_id=None, project_id=None, config=None, stored_info_type_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if organization_id:
            ...
            if project_id:
                ...
                raise AirflowException('Please provide either organization_id or project_id.')
        return client.create_stored_info_type(parent=parent,
          config=config,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def deidentify_content(self, project_id=None, deidentify_config=None, inspect_config=None, item=None, inspect_template_name=None, deidentify_template_name=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        return client.deidentify_content(parent=parent,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def delete_deidentify_template(self, template_id, organization_id=None, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not template_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        client.delete_deidentify_template(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def delete_dlp_job(self, dlp_job_id, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not dlp_job_id:
            raise AirflowException('Please provide the ID of the DLP job resource to be cancelled.')
        name = DlpServiceClient.dlp_job_path(project_id, dlp_job_id)
        client.delete_dlp_job(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)

    @GoogleCloudBaseHook.catch_http_exception
    def delete_inspect_template(self, template_id, organization_id=None, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not template_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        client.delete_inspect_template(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def delete_job_trigger(self, job_trigger_id, project_id=None, retry=None, timeout=None, metadata=None):
        """
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def delete_stored_info_type(self, stored_info_type_id, organization_id=None, project_id=None, retry=None, timeout=None, metadata=None):
        """
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def get_deidentify_template(self, template_id, organization_id=None, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not template_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        return client.get_deidentify_template(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def get_dlp_job(self, dlp_job_id, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        name = DlpServiceClient.dlp_job_path(project_id, dlp_job_id)
        return client.get_dlp_job(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)

    @GoogleCloudBaseHook.catch_http_exception
    def get_inspect_template(self, template_id, organization_id=None, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not template_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        return client.get_inspect_template(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def get_job_trigger(self, job_trigger_id, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        name = DlpServiceClient.project_job_trigger_path(project_id, job_trigger_id)
        return client.get_job_trigger(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)

    @GoogleCloudBaseHook.catch_http_exception
    def get_stored_info_type(self, stored_info_type_id, organization_id=None, project_id=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not stored_info_type_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        return client.get_stored_info_type(name=name,
          retry=retry,
          timeout=timeout,
          metadata=metadata)
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def inspect_content(self, project_id=None, inspect_config=None, item=None, inspect_template_name=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        return client.inspect_content(parent=parent,
          inspect_config=inspect_config,
          item=item,
          inspect_template_name=inspect_template_name,
          retry=retry,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def list_deidentify_templates(self, organization_id=None, project_id=None, page_size=None, order_by=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if organization_id:
            ...
            if project_id:
                ...
                raise AirflowException('Please provide either organization_id or project_id.')
        results = client.list_deidentify_templates(parent=parent,
          page_size=page_size,
          order_by=order_by,
          retry=retry,
          timeout=timeout,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def list_dlp_jobs(self, project_id=None, results_filter=None, page_size=None, job_type=None, order_by=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        results = client.list_dlp_jobs(parent=parent,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def list_info_types(self, language_code=None, results_filter=None, retry=None, timeout=None, metadata=None):
        """
        ...
        """
        client = self.get_conn()
        return client.list_info_types(language_code=language_code,
          filter_=results_filter,
          retry=retry,
          timeout=timeout,
          metadata=metadata)
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def list_inspect_templates(self, organization_id=None, project_id=None, page_size=None, order_by=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if organization_id:
            ...
            if project_id:
                ...
                raise AirflowException('Please provide either organization_id or project_id.')
        results = client.list_inspect_templates(parent=parent,
          page_size=page_size,
          order_by=order_by,
          retry=retry,
          timeout=timeout,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def list_job_triggers(self, project_id=None, page_size=None, order_by=None, results_filter=None, retry=None, timeout=None, metadata=None):
        """
        Lists job triggers.
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        results = client.list_job_triggers(parent=parent,
          page_size=page_size,
          order_by=order_by,
          filter_=results_filter,
          retry=retry,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def list_stored_info_types(self, organization_id=None, project_id=None, page_size=None, order_by=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if organization_id:
            ...
            if project_id:
                ...
                raise AirflowException('Please provide either organization_id or project_id.')
        results = client.list_stored_info_types(parent=parent,
          page_size=page_size,
          order_by=order_by,
          retry=retry,
          timeout=timeout,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def redact_image(self, project_id=None, inspect_config=None, image_redaction_configs=None, include_findings=None, byte_item=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        return client.redact_image(parent=parent,
          inspect_config=inspect_config,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def reidentify_content(self, project_id=None, reidentify_config=None, inspect_config=None, item=None, inspect_template_name=None, reidentify_template_name=None, retry=None, timeout=None, metadata=None):
        """
        ...
        client = self.get_conn()
        parent = DlpServiceClient.project_path(project_id)
        return client.reidentify_content(parent=parent,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def update_deidentify_template(self, template_id, organization_id=None, project_id=None, deidentify_template=None, update_mask=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not template_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        return client.update_deidentify_template(name=name,
          deidentify_template=deidentify_template,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def update_inspect_template(self, template_id, organization_id=None, project_id=None, inspect_template=None, update_mask=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not template_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        return client.update_inspect_template(name=name,
          inspect_template=inspect_template,
          update_mask=update_mask,
          retry=retry,
          timeout=timeout,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    @GoogleCloudBaseHook.fallback_to_default_project_id
    def update_job_trigger(self, job_trigger_id, project_id=None, job_trigger=None, update_mask=None, retry=None, timeout=None, metadata=None):
        """
        ...
        name = DlpServiceClient.project_job_trigger_path(project_id, job_trigger_id)
        return client.update_job_trigger(name=name,
          job_trigger=job_trigger,
          update_mask=update_mask,
          retry=retry,
          timeout=timeout,
    ...
    @GoogleCloudBaseHook.catch_http_exception
    def update_stored_info_type(self, stored_info_type_id, organization_id=None, project_id=None, config=None, update_mask=None, retry=None, timeout=None, metadata=None):
        """
        ...
        if not stored_info_type_id:
            ...
            if organization_id:
                ...
                if project_id:
                    ...
                    raise AirflowException('Please provide either organization_id or project_id.')
        return client.update_stored_info_type(name=name,
          config=config,
          update_mask=update_mask,
          retry=retry,
          timeout=timeout,
