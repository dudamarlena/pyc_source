...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/airflow/contrib/operators/sqoop_operator.py
# Compiled at: 2019-09-11 03:47:34
# Size of source mod 2**32: 10736 bytes
...
class SqoopOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        Execute sqoop job
        """
        self.hook = SqoopHook(conn_id=(self.conn_id),
        ...
        if self.cmd_type == 'export':
            self.hook.export_table(table=(self.table),
            ...
            if self.cmd_type == 'import':
                if self.create_hcatalog_table:
                    ...
                    if self.table:
                        self.hook.import_table(table=(self.table),
                        ...
                        if self.query:
                            self.hook.import_query(query=(self.query),
                              target_dir=(self.target_dir),
                              append=(self.append),
                              file_type=(self.file_type),
                              split_by=(self.split_by),
