...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/kid/test/test_parser.py
...
def test_xml_with_entity_map():
    ...
    xml = '&nbsp;, &codswallop;!'
    entity_map = {'nbsp': 'Hello', 'codswallop': 'World'}
    assert list(XML(xml, entity_map=entity_map))[0][1] == 'Hello, World!'
...
def test_encoding():
    s = b'<?xml version="1.0" encoding="iso-8859-2"?>\n<e a="\xb5\xb9\xe8\xbb\xbe">\xb5\xb9\xe8\xbb\xbe\xfd\xe1\xed</e>'
...
def test_expand_fragments():
    ...
    t = Template('        <div xmlns:py="http://purl.org/kid/ns#">\n            <div py:for="i in range(3)">\n                <p>Hello World #$i</p>\n            </div>\n        </div>')
    ...
    assert s2 == s
    t = Template('        <div xmlns:py="http://purl.org/kid/ns#" py:for="i in range(3)">\n            <p>Hello World #$i</p>\n        </div>')
    s = t.serialize(fragment=True)
    expected = '<div>\n            <p>Hello World #0</p>\n        </div><div>\n            <p>Hello World #1</p>\n        </div><div>\n            <p>Hello World #2</p>\n        </div>'
    assert s == expected
    stream = ElementStream(t.transform()).expand()
    ...
    s2 = t2.serialize(fragment=True)
    assert s2 == s
    t = Template('        <div xmlns:py="http://purl.org/kid/ns#" py:strip="True">\n            <p>Hello World</p>\n        </div>')
