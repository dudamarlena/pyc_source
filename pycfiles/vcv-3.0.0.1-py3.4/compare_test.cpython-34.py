...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/util/protobuf/compare_test.py
# Compiled at: 2018-06-15 01:22:48
# Size of source mod 2**32: 19171 bytes
"""Tests for python.util.protobuf.compare."""
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function
import copy, re, textwrap, six
...
class ProtoEqTest(googletest.TestCase):
    ...
    def testMessage(self):
        ...
        self.assertNotEquals('small < strings: "a" strings: "b" >', 'small < strings: "a" >')
        ...
        self.assertNotEquals('string_: "a" small < strings: "a" >', 'string_: "a" small <>')
        self.assertEquals('string_: "a" small < strings: "a" >', 'string_: "a" small < strings: "a" >')
        self.assertNotEquals('string_: "a" small < strings: "a" >', 'int64_: 1 small < strings: "a" >')
        self.assertNotEquals('string_: "a" small < strings: "a" >', 'int64_: 1')
        self.assertNotEquals('string_: "a"', 'int64_: 1 small < strings: "a" >')
        self.assertNotEquals('string_: "a" int64_: 0 small < strings: "a" >', 'int64_: 1 small < strings: "a" >')
        self.assertNotEquals('string_: "a" int64_: 1 small < strings: "a" >', 'string_: "a" int64_: 0 small < strings: "a" >')
        self.assertEquals('string_: "a" int64_: 0 small < strings: "a" >', 'string_: "a" int64_: 0 small < strings: "a" >')
    ...
    def testNestedMessage(self):
        ...
        self.assertNotEquals('medium < smalls <> smalls <> >', 'medium < smalls <> >')
        self.assertEquals('medium < smalls <> smalls <> >', 'medium < smalls <> smalls <> >')
        self.assertNotEquals('medium < int32s: 0 >', 'medium < smalls <> >')
        self.assertNotEquals('medium < smalls < strings: "a"> >', 'medium < smalls <> >')
    ...
    For reference, here are the relevant tag numbers from compare_test.proto:
      ...
      optional Small small = 8;
    """
        self.assertNotEquals('string_: "a"                      ', '             int64_: 1            ')
        self.assertNotEquals('string_: "a" int64_: 2            ', '             int64_: 1            ')
        self.assertNotEquals('string_: "b" int64_: 1            ', 'string_: "a" int64_: 2            ')
        self.assertEquals('string_: "a" int64_: 1            ', 'string_: "a" int64_: 1            ')
        self.assertNotEquals('string_: "a" int64_: 1 float_: 0.0', 'string_: "a" int64_: 1            ')
        self.assertEquals('string_: "a" int64_: 1 float_: 0.0', 'string_: "a" int64_: 1 float_: 0.0')
        self.assertNotEquals('string_: "a" int64_: 1 float_: 0.1', 'string_: "a" int64_: 1 float_: 0.0')
        self.assertNotEquals('string_: "a" int64_: 2 float_: 0.0', 'string_: "a" int64_: 1 float_: 0.1')
        self.assertNotEquals('string_: "a"                      ', '             int64_: 1 float_: 0.1')
        self.assertNotEquals('string_: "a"           float_: 0.0', '             int64_: 1            ')
        self.assertNotEquals('string_: "b"           float_: 0.0', 'string_: "a" int64_: 1            ')
        self.assertNotEquals('string_: "a"', 'small < strings: "a" >')
        self.assertNotEquals('string_: "a" small < strings: "a" >', 'small < strings: "b" >')
        self.assertNotEquals('string_: "a" small < strings: "b" >', 'string_: "a" small < strings: "a" >')
        self.assertEquals('string_: "a" small < strings: "a" >', 'string_: "a" small < strings: "a" >')
        self.assertNotEquals('string_: "a" medium <>', 'string_: "a" small < strings: "a" >')
        self.assertNotEquals('string_: "a" medium < smalls <> >', 'string_: "a" small < strings: "a" >')
        ...
        self.assertNotEquals('medium < smalls < strings: "a" > >', 'small < strings: "b" >')


class NormalizeNumbersTest(googletest.TestCase):
    __doc__ = 'Tests for NormalizeNumberFields().'
...
class AssertTest(googletest.TestCase):
    __doc__ = 'Tests assertProtoEqual().'
    ...
    def assertNone(self, a, b, message, **kwargs):
        ...
        self.assertRaisesRegexp(AssertionError, message, self.assertProtoEqual, a, b, **kwargs)
    ...
    def testMsgPassdown(self):
        self.assertRaisesRegexp(AssertionError, 'test message passed down', self.assertProtoEqual, 'medium: {}', 'medium: { smalls: { strings: "x" } }', msg='test message passed down')
