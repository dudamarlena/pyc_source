...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/builders/preprocessor_builder.py
...
def build(preprocessor_step_config):
  ...
  """
    ...
    if step_type in PREPROCESSING_FUNCTION_MAP:
        ...
        return (
         preprocessing_function, function_args)
    ...
    if step_type == 'random_crop_pad_image':
        ...
        return (
         ...
         {'min_object_covered': config.min_object_covered, 
          ...
          'overlap_thresh': config.overlap_thresh, 
          'random_coef': config.random_coef, 
          'min_padded_size_ratio': min_padded_size_ratio if min_padded_size_ratio else None, 
          'max_padded_size_ratio': max_padded_size_ratio if max_padded_size_ratio else None, 
