...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils/object_detection_evaluation_test.py
...
class ObjectDetectionEvaluationTest(tf.test.TestCase):
    ...
    def setUp(self):
        ...
        self.od_eval.add_single_ground_truth_image_info(image_key2, groundtruth_boxes2, groundtruth_class_labels2, groundtruth_is_difficult_list2)
        image_key3 = 'img3'
        ...
        detected_boxes = np.array([
         [
          10, 10, 11, 11], [100, 100, 120, 120], [100, 100, 220, 220]], dtype=float)
    ...
    def test_evaluate(self):
        ...
        expected_recalls_per_class = [
         np.array([0, 0.3333333333333333], dtype=float), np.array([], dtype=float),
         np.array([0], dtype=float)]
        expected_average_precision_per_class = np.array([0.16666666666666666, 0, 0], dtype=float)
        expected_corloc_per_class = np.array([0, np.divide(0, 0), 0], dtype=float)
        expected_mean_ap = 0.05555555555555555
