...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils/test_utils.py
# Compiled at: 2018-06-15 01:29:01
# Size of source mod 2**32: 4576 bytes
...
class MockBoxCoder(box_coder.BoxCoder):
    __doc__ = 'Simple `difference` BoxCoder.'
...
class MockBoxPredictor(box_predictor.BoxPredictor):
    __doc__ = 'Simple box predictor that ignores inputs and outputs all zeros.'
    ...
    def _predict(self, image_features, num_predictions_per_location):
        ...
        return {box_predictor.BOX_ENCODINGS: box_encodings,  box_predictor.CLASS_PREDICTIONS_WITH_BACKGROUND: class_predictions_with_background}


class MockAnchorGenerator(anchor_generator.AnchorGenerator):
    __doc__ = 'Mock anchor generator.'
...
class MockMatcher(matcher.Matcher):
    __doc__ = 'Simple matcher that matches first anchor to first groundtruth box.'
