...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/builders/hyperparams_builder.py
# Compiled at: 2018-06-15 01:39:54
# Size of source mod 2**32: 6068 bytes
...
def build(hyperparams_config, is_training):
  ...
  """
    ...
    if hyperparams_config.HasField('op'):
        if hyperparams_config.op == hyperparams_pb2.Hyperparams.FC:
            affected_ops = [
