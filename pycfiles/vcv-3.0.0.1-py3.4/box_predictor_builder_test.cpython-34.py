...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/builders/box_predictor_builder_test.py
# Compiled at: 2018-06-15 01:39:54
# Size of source mod 2**32: 15071 bytes
"""Tests for box_predictor_builder."""
import mock, tensorflow as tf
...
class MaskRCNNBoxPredictorBuilderTest(tf.test.TestCase):
    ...
    def test_build_box_predictor_with_mask_branch(self):
        ...
        mock_argscope_fn.assert_has_calls([
         mock.call(box_predictor_proto.mask_rcnn_box_predictor.fc_hyperparams, True),
         mock.call(box_predictor_proto.mask_rcnn_box_predictor.conv_hyperparams, True)], any_order=True)
        self.assertFalse(box_predictor._use_dropout)
        self.assertAlmostEqual(box_predictor._dropout_keep_prob, 0.5)
        self.assertEqual(box_predictor.num_classes, 90)
        self.assertTrue(box_predictor._is_training)
