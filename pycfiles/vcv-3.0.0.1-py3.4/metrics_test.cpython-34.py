...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils/metrics_test.py
...
class MetricsTest(tf.test.TestCase):
    ...
    def test_compute_cor_loc(self):
        ...
        num_images_correctly_detected_per_class = np.array([10, 0, 1, 0, 0], dtype=int)
        corloc = metrics.compute_cor_loc(num_gt_imgs_per_class, num_images_correctly_detected_per_class)
    ...
    def test_compute_average_precision(self):
        ...
        processed_precision = np.array([0.9, 0.9, 0.9, 0.7, 0.7, 0.55, 0.55, 0], dtype=float)
