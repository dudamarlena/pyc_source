...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils/per_image_evaluation.py
...
class PerImageEvaluation(object):
    ...
    """
        ...
        scores, tp_fp_labels = self._compute_tp_fp(detected_boxes, detected_scores, detected_class_labels, groundtruth_boxes, groundtruth_class_labels, groundtruth_is_difficult_lists)
    ...
    """
        ...
        for i in range(self.num_groundtruth_classes):
            ...
            detected_scores_at_ith_class = detected_scores[(detected_class_labels == i)]
            scores, tp_fp_labels = self._compute_tp_fp_for_single_class(detected_boxes_at_ith_class, detected_scores_at_ith_class, gt_boxes_at_ith_class, groundtruth_is_difficult_list_at_ith_class)
