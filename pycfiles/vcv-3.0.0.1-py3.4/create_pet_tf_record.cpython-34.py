...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/create_pet_tf_record.py
...
"""
import hashlib, io, logging, os, random, re
from lxml import etree
import PIL.Image, tensorflow as tf
...
def dict_to_tf_example(data, label_map_dict, image_subdirectory, ignore_difficult_instances=False):
  ...
  """
    ...
    example = tf.train.Example(features=tf.train.Features(feature={'image/height': dataset_util.int64_feature(height), 
