...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/meta_architectures/ssd_meta_arch.py
# Compiled at: 2018-06-15 01:39:54
# Size of source mod 2**32: 27312 bytes
...
class SSDMetaArch(model.DetectionModel):
    ...
    """
        ...
        with tf.name_scope('Postprocessor'):
            ...
            return {'detection_boxes': nmsed_boxes,  'detection_scores': nmsed_scores, 
    ...
    """
        with tf.name_scope(scope, 'Loss', prediction_dict.values()):
            ...
            loss_dict = {'localization_loss': self._localization_loss_weight / normalizer * localization_loss, 
    ...
    """
        ...
        class_predictions = tf.reshape(tf.slice(prediction_dict['class_predictions_with_background'], [
