...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/data_decoders/tf_example_decoder.py
# Compiled at: 2018-06-15 01:39:54
# Size of source mod 2**32: 7057 bytes
...
class TfExampleDecoder(data_decoder.DataDecoder):
    ...
    def __init__(self):
        ...
        self.items_to_handlers = {fields.InputDataFields.image: slim_example_decoder.Image(image_key='image/encoded', format_key='image/format', channels=3), 
         ...
         fields.InputDataFields.groundtruth_boxes: slim_example_decoder.BoundingBox([
         ...
         fields.InputDataFields.groundtruth_instance_masks: slim_example_decoder.ItemHandlerCallback([
                                                             'image/segmentation/object', 'image/height', 'image/width'], self._reshape_instance_masks), 
         fields.InputDataFields.groundtruth_instance_classes: slim_example_decoder.Tensor('image/segmentation/object/class')}
