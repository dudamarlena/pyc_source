...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils/visualization_utils.py
# Compiled at: 2018-06-15 01:29:01
# Size of source mod 2**32: 17643 bytes
...
"""
import collections, numpy as np, PIL.Image as Image, PIL.ImageColor as ImageColor, PIL.ImageDraw as ImageDraw, PIL.ImageFont as ImageFont, six, tensorflow as tf
  ...
  """
    ...
    for keypoint_x, keypoint_y in zip(keypoints_x, keypoints_y):
        draw.ellipse([(keypoint_x - radius, keypoint_y - radius),
         (
          keypoint_x + radius, keypoint_y + radius)], outline=color, fill=color)
