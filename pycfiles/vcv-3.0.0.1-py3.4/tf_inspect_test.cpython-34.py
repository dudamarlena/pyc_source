...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/util/tf_inspect_test.py
...
class TfInspectTest(test.TestCase):
    ...
    def testGetArgSpecOnDecoratorThatChangesArgspec(self):
        argspec = tf_inspect.ArgSpec(args=[
         'a', 'b', 'c'], varargs=None, keywords=None, defaults=(1, 'hello'))
    ...
    def testGetArgSpecReturnsOutermostDecoratorThatChangesArgspec(self):
        outer_argspec = tf_inspect.ArgSpec(args=[
         'a'], varargs=None, keywords=None, defaults=None)
        inner_argspec = tf_inspect.ArgSpec(args=[
         'b'], varargs=None, keywords=None, defaults=None)
...
class TfInspectGetCallArgsTest(test.TestCase):
    ...
    def testBoundFuncWithManyParamsAndDefaults(self):
        ...
        self.assertEqual({'self': t, 
         'a': 3, 
         'b': 2, 
         'c': 'Goodbye'}, tf_inspect.getcallargs(t.bound, 3, c='Goodbye'))
    ...
    def testClassMethod(self):
        ...
        self.assertEqual({'cls': Test, 
         'a': 5, 
         'b': 3, 
         'c': 'goodbye'}, tf_inspect.getcallargs(Test.test, 5, c='goodbye'))
    ...
    def testUsesOutermostDecoratorsArgSpec(self):
        ...
        decorated = tf_decorator.make_decorator(func, wrapper, decorator_argspec=tf_inspect.ArgSpec(args=[
         'a', 'b', 'c'], varargs=None, keywords=None, defaults=(3, 'hello')))
        self.assertEqual({'a': 4, 
         'b': 3, 
         'c': 'goodbye'}, tf_inspect.getcallargs(decorated, 4, c='goodbye'))
