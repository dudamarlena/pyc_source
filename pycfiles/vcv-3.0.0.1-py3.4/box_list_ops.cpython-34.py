...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/core/box_list_ops.py
# Compiled at: 2018-06-15 01:39:54
# Size of source mod 2**32: 37111 bytes
    ...
    with tf.name_scope(scope, 'ToAbsoluteCoordinates'):
        ...
        if check_range:
            ...
            max_assert = tf.Assert(tf.greater_equal(1.01, box_maximum), [
             'maximum box coordinate value is larger than 1.01: ',
             box_maximum])
            with tf.control_dependencies([max_assert]):
                width = tf.identity(width)
