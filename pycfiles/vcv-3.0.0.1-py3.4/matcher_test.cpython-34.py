...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/core/matcher_test.py
...
class AnchorMatcherTest(tf.test.TestCase):
    ...
    def test_get_correct_counts(self):
        ...
        with self.test_session() as (sess):
            num_matched_columns_out, num_unmatched_columns_out, num_ignored_columns_out = sess.run([
