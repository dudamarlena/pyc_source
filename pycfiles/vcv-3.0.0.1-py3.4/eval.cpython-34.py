...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/eval.py
# Compiled at: 2018-06-15 01:39:54
# Size of source mod 2**32: 6044 bytes
...
def main(unused_argv):
    ...
    evaluator.evaluate(create_input_dict_fn, model_fn, eval_config, categories, FLAGS.checkpoint_dir, FLAGS.eval_dir)
