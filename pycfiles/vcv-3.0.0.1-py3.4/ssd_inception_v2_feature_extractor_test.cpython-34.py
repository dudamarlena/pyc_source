...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/object_detection/models/ssd_inception_v2_feature_extractor_test.py
...
class SsdInceptionV2FeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase, tf.test.TestCase):
    ...
    def test_extract_features_returns_correct_shapes_128(self):
        ...
        expected_feature_map_shape = [(4, 8, 8, 576), (4, 4, 4, 1024),
         (4, 2, 2, 512), (4, 1, 1, 256),
         (4, 1, 1, 256), (4, 1, 1, 128)]
        self.check_extract_features_returns_correct_shape(image_height, image_width, depth_multiplier, expected_feature_map_shape)
    ...
    def test_extract_features_returns_correct_shapes_enforcing_min_depth(self):
        image_height = 299
        image_width = 299
        depth_multiplier = 0.000244140625
    ...
    def test_extract_features_raises_error_with_invalid_image_size(self):
        ...
        image_width = 32
        depth_multiplier = 1.0
        self.check_extract_features_raises_error_with_invalid_image_size(image_height, image_width, depth_multiplier)
    ...
    def test_variables_only_created_in_scope(self):
        ...
        self.check_feature_extractor_variables_under_scope(depth_multiplier, scope_name)
