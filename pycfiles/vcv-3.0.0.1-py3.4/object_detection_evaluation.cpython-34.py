...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils/object_detection_evaluation.py
...
class ObjectDetectionEvaluation(object):
    __doc__ = 'Evaluate Object Detection Result.'

    def __init__(self, num_groundtruth_classes, matching_iou_threshold=0.5, nms_iou_threshold=1.0, nms_max_output_boxes=10000):
        self.per_image_eval = per_image_evaluation.PerImageEvaluation(num_groundtruth_classes, matching_iou_threshold, nms_iou_threshold, nms_max_output_boxes)
    ...
    """
        ...
        self._update_ground_truth_statistics(groundtruth_class_labels, groundtruth_is_difficult_list)
    ...
    """
        ...
        if image_key in self.detection_keys:
            logging.warn('image %s has already been added to the detection result database', image_key)
            return
        ...
        scores, tp_fp_labels, is_class_correctly_detected_in_image = self.per_image_eval.compute_object_detection_metrics(detected_boxes, detected_scores, detected_class_labels, groundtruth_boxes, groundtruth_class_labels, groundtruth_is_difficult_list)
    ...
    def get_eval_result(self):
        return EvalResult(self.average_precision_per_class, self.precisions_per_class, self.recalls_per_class, self.corloc_per_class)
