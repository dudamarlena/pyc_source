...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/printtable/printtable.py
# Compiled at: 2015-11-02 07:34:29
    ...
    def printTable(self, line_num=0):
        ...
        for num in xrange(self.Row_num):
            ...
            for attr in self.Attribute:
                ...
                self.StrTable += ' ' * space_num + self.table[attr][num] + ' ' * (self.AttributeLen[attr] - self.value_len(self.table[attr][num]) - space_num) + '|'
