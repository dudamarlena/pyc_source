...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\jld\backup\mindmeister_backup.py
...
import jld.registry as reg, jld.api.mindmeister as mm, jld.api.mindmeister_response as mmr, jld.backup.mindmeister_messages as msg, jld.backup.mindmeister_printer as printer, jld.backup.mindmeister_db as db, jld.tools.mos as mos
...
class Backup(BaseCmd):
    ...
    _configParams = [
     'secret', 'api_key', 'export_path', 'export_maxnum', 'db_path', 'eventmgr_path']
