...
# [GCC 8.4.0]
# Embedded file name: /dev/python/jld/cmd_g2/base_ui.py
# Compiled at: 2009-02-26 14:01:29
""" BaseCmdUI
...
__all__ = [
 'BaseCmdUI', 'BaseCmdUIConfigError']
import sys
from types import *
...
class BaseCmdUI(object):
    ...
    def handleArguments(self, usage, _options, args=None, help_params=None):
        ...
        for o in _options:
            ...
            parser.add_option(o['o1'], dest=o['var'], action=o['action'], help=help_msg, default=o['default'])
