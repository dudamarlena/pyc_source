...
# [GCC 8.4.0]
# Embedded file name: C:\Documents and Settings\Jean-Lou Dupont\My Documents\workspace_gae\jldupont\trunk\libs\python\jld\jld\api\mindmeister.py
# Compiled at: 2008-12-15 19:34:10
"""MindMeister WEB Service API
"""
__author__ = 'Jean-Lou Dupont'
__version__ = '$Id: mindmeister.py 742 2008-12-16 00:34:09Z JeanLou.Dupont $'
import binascii, md5, urllib2, jld.api as api, jld.api.mindmeister_response as mmr
...
class MM_Client(MM):
    ...
    def getMapsPage(self, page, per_page):
        """ Retrieves one page of the map list
            @raise jld.api.Error*: exception
        """
        raw = self.do(method='mm.maps.getList', auth_token=self.auth_token, page=page, per_page=per_page)
