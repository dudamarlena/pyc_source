...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\jld\backup\gliffy_backup.py
...
__msgs__ = [
 'error_init_folder', 'error_create_folder', 'frob_not_acquired', 'error_cant_write']
import sys, os, logging, datetime, urllib2
from stat import *
import jld.api as api
from jld.cmd import BaseCmd
import jld.registry as reg, jld.tools.mos as mos, jld.api.gliffy as glf, jld.backup.gliffy_messages as msg, jld.backup.gliffy_printer as printer, jld.backup.gliffy_db as glfdb, jld.backup.delicious_db as dlcdb
...
class Backup(BaseCmd):
    ...
    _regDomain = 'gliffy'
    _configParams = [
     'export_path', 'export_maxnum', 'glf_db_path', 'dlc_db_path']
    ...
    def cmd_import(self, *args):
        ...
        try:
            ...
            raise api.ErrorValidation('missing_param', {'param': 'tag'})
    ...
    def _doImport(self, list):
        ...
        """
        try:
            uris = self._extractHref(list)
        except:
            raise api.ErrorProtocol('msg:error_expecting_href')
