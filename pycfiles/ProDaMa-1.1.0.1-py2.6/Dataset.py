...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ProDaMa/Dataset.py
# Compiled at: 2009-10-12 09:46:24
"""
        ...
        for chain in self.chains:
            ...
            for (symbol, relative_frequency) in sequence_composition.items():
                if dataset_composition.has_key(symbol):
                    ...
                    dataset_composition[symbol] = [
                     (
                      chain.sequence.count(symbol), relative_frequency)]
