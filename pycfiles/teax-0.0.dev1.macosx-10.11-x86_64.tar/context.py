...
# [GCC 8.4.0]
# Embedded file name: /Users/maciejczyzewski/teax/repository/teax/engines/context.py
# Compiled at: 2016-02-03 14:19:04
...
class ContextEngine(EngineObject):
    ...
    def start(self):
        subprocess.Popen('texexec ' + os.path.basename(self.filename), stdout=subprocess.PIPE, shell=True).communicate()[0]
