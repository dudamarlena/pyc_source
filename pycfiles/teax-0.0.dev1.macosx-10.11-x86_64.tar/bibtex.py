...
# [GCC 8.4.0]
# Embedded file name: /Users/maciejczyzewski/teax/repository/teax/plugins/bibtex.py
# Compiled at: 2016-02-03 14:50:24
...
class BibtexPlugin(PluginObject):
    ...
    def start(self):
        subprocess.Popen('bibtex ' + self.basename, stdout=subprocess.PIPE, shell=True).communicate()[0]
