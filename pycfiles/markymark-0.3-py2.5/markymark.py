...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/markymark.py
# Compiled at: 2009-03-28 18:25:25
import curses, re
...
def _rainbowize(in_string, i):
    out_parts = []
    colors = (
     color_red, color_yellow, color_green, color_blue, color_magenta)
    ...
    for item in parts:
        ...
        if omo:
            ...
            if colors.has_key(tag):
                ...
                color_stack.append(tag)
            elif len(color_stack) > 0 and color_stack[(-1)] == 'rainbow':
            ...
            if len(color_stack) > 0 and color_stack[(-1)] == tag:
                ...
                if len(bg_color_stack) == 0:
                    ...
                    out_string += bg_colors[bg_color_stack[(-1)]]
            elif len(attribute_stack) > 0 and attribute_stack[(-1)] == tag:
                attribute_stack.pop()
