...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/flatlibfr/ephem/ephem.py
...
from flatlibfr.object import GenericObject, Object, House, FixedStar
from flatlibfr.lists import GenericList, ObjectList, HouseList, FixedStarList
