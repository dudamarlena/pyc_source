...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/flatlibfr/tools/planetarytime.py
...
class HourTable:
    __doc__ = ' This class represents a Planetary Hour Table\n    and includes methods to access its properties.\n    \n    '
