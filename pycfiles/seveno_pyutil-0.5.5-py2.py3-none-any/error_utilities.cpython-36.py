...
# [GCC 8.4.0]
# Embedded file name: /home/tomislav/dev/seveno_pyutil/build/lib/seveno_pyutil/error_utilities.py
# Compiled at: 2019-01-18 04:39:52
...
def add_error_to(errors_store: Union[(Mapping, object)], error: Union[(str, Sequence, object, Mapping, Exception)]):
    """
    ...
    if errors_store is None:
        raise RuntimeError("errors_store can't be None! errors_store must be a dict or object onto which dict can be attached!")
    else:
