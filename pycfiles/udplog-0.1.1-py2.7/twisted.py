...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/udplog/twisted.py
# Compiled at: 2013-09-26 18:32:40
"""
...
class UDPLogObserver(object):
    ...
    def emit(self, eventDict):
        ...
        if eventDict.get('isError', False) and 'failure' in eventDict:
            udplog.augmentWithFailure(eventDict, eventDict['failure'], eventDict['why'])
            del eventDict['why']
    ...
    def emit(self, record):
        ...
        try:
            ...
            if record.exc_info:
                ...
                eventDict['failure'] = Failure(exc_value, exc_type, exc_traceback)
...
class QueueProducer(object):
    ...
    def pauseProducing(self):
        ...
        """
        log.msg(format='Pause producing for %(callback)s.', callback=self.callback)
        self.paused = True
    ...
    def resumeProducing(self):
        ...
        """
        log.msg(format='Resume producing for %(callback)s.', callback=self.callback)
        self.paused = False
        self._processQueue()
