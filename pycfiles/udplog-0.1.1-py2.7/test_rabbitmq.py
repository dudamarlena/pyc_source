...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/udplog/test/test_rabbitmq.py
# Compiled at: 2013-09-04 05:31:44
"""
...
class RabbitMQPublisherTest(unittest.TestCase):
    ...
    def test_sendEvent(self):
        ...
        event = {'message': 'test', 'timestamp': 1340634165}
    ...
    def test_connectionLost(self):
        ...
        clock = task.Clock()
        self.publisher.producer = twisted.QueueProducer(callback=cb, clock=clock)
