...
# Embedded file name: build/bdist.linux-i686/egg/buildutils/cmd.py
# Compiled at: 2007-08-08 19:58:56
__doc__ = '\nCommand base class providing enhancements to `distutils.cmd`\n'
import sys, os, distutils.cmd
...
class Command(distutils.cmd.Command):
    ...
    def expand_options(self, options=None, **extra):
        ...
        if isinstance(options, (str, unicode)):
            ...
            assert isinstance(options, (list, tuple)), 'options must be a string or sequence type'
    ...
    def find_files(self, include=[
 '*'], exclude=[], basedir=None):
    ...
    def easy_install(self, dependencies):
        ...
        setup(cmdclass={'easy_install': easy_install}, script_args=['-q', 'easy_install', '-v'] + list(dependencies))
