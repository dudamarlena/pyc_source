...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snafulib/connectors/xmpp.py
# Compiled at: 2018-07-01 01:56:00
# Size of source mod 2**32: 3961 bytes
import nbxmpp, time, configparser, os, urllib.parse
...
class BaseXMPPBot:
    ...
    def connect(self):
        ...
        self.client.connect(self.on_connect, self.on_failure, secure_tuple=('tls',
                                                                            '', '',
                                                                            None,
                                                                            None))
