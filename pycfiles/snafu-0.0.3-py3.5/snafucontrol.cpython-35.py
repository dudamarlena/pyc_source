...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snafulib/snafucontrol.py
# Compiled at: 2018-07-01 01:56:00
# Size of source mod 2**32: 18003 bytes
import flask, json, argparse, os, base64, subprocess, glob, snafulib.snafu, logging, importlib, threading, time, shutil
