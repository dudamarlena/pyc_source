...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snafulib/snafuimport.py
# Compiled at: 2018-07-01 01:56:00
# Size of source mod 2**32: 10440 bytes
import argparse, subprocess, json, os, sys, tempfile, glob, uuid, snafulib.snafu
            ...
            if line[0] == 'actions':
                ...
                if line[0] == 'triggers':
                    ...
                    if inactions:
                        ...
                        if code['kind'] == 'python' or code['kind'] == 'python:2' or code['kind'] == 'python:3':
