...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/snafulib/snafu.py
# Compiled at: 2018-07-01 01:56:00
# Size of source mod 2**32: 15863 bytes
import argparse, os, sys, ast, importlib, importlib.machinery, types, inspect, time, json, hashlib, base64, glob, subprocess, shutil, threading
parsermapping = {'c': ['c', 'so'], 
 'java': ['java', 'class'], 
 'python': 'py', 
 'lambada': 'py', 
 'javascript': 'js'}
executormapping = {'c': 'so', 
 'docker': None, 
 'inmemory': 'py', 
 'lxc': 'py', 
 'inmemstateless': 'py', 
...
class SnafuImport:
    ...
    def importfunction(funcname, codezip, config, convert=False):
        ...
        oldcodefile = None
        if codezip and convert and config['Runtime'] == 'python2.7':
...
class Snafu:
    ...
    def executeexternal(self, funcname):
        if self.interactive:
            ...
            if self.externalexecutor == 'lambda':
                ...
                if self.externalexecutor == 'openwhisk':
    ...
    def execute(self, funcname, **kwargs):
        ...
        for executormodcandidate in self.executormods:
            ...
            if sourceinfos.source.endswith('.class'):
                ...
                if executormapping[candidatename] == 'so':
                    ...
                    if sourceinfos.source.endswith('.js') and executormapping[candidatename] == 'js':
                        executormod = executormodcandidate
