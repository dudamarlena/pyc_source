...
# Embedded file name: /Users/stf_remote/repositories/commonfate/build/lib/commonfate/model.py
...
class CFM(object):
    ...
    def __init__(self, data, nb_components, nb_iter=100, beta=1, A=None, H=None, C=None):
        self.data = data
    ...
    def fit(self):
        ...
        def MU(einsumString, Z, factors):
            ...
            return einsum(einsumString, (self.data * Zhat ** (self.beta - 2)), *factors) / einsum(einsumString, (Zhat ** (self.beta - 1)), *factors)
