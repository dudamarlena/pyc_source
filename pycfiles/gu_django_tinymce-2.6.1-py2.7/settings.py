...
# [GCC 8.4.0]
# Embedded file name: /Volumes/Bucket/projects/tinymce/gu-django-tinymce/tinymce/settings.py
# Compiled at: 2016-04-21 01:35:09
import os
from django.conf import settings
from django.contrib.staticfiles import finders
DEFAULT_CONFIG = getattr(settings, 'TINYMCE_DEFAULT_CONFIG', {'theme': 'simple', 'relative_urls': False})
