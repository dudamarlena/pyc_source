...
# [GCC 8.4.0]
# Embedded file name: /Volumes/additional/projects/tinymce/gu-django-tinymce/tinymce/views.py
# Compiled at: 2016-06-08 06:30:37
import logging
...
def filebrowser(request):
    ...
    return render_to_response('tinymce/filebrowser.js', {'fb_url': fb_url}, context_instance=RequestContext(request))
...
def filebrowserPath(request):
    ...
    return render_to_response('tinymce/defaultpath.js', {'dir': _dir}, context_instance=RequestContext(request))