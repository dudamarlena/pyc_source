...
# [GCC 8.4.0]
# Embedded file name: /Volumes/additional/projects/tinymce/gu-django-tinymce/testtinymce/admin.py
# Compiled at: 2016-04-21 01:52:52
...
class TinyMCETestInlineAdmin(admin.StackedInline):
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        if db_field.name in ('content1', 'content2'):
            return db_field.formfield(widget=TinyMCE(attrs={'cols': 80, 'rows': 30}, mce_attrs={'external_link_list_url': reverse('tinymce.views.flatpages_link_list')}))
