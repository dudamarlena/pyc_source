...
# [GCC 8.4.0]
# Embedded file name: /Users/hugo/.virtualenvs/django-jwt/lib/python2.7/site-packages/django_jwt/tests/test_decorators.py
# Compiled at: 2015-12-28 14:27:25
...
class DecoratorTests(TransactionTestCase):
    ...
    def test_decode_error(self):
        ...
        self._assertResponse(request, request_token=None, request_token_error=exceptions.DecodeError, token_used=False)
        self.assertFalse(RequestTokenLog.objects.exists())
        return
    ...
    def test_missing_token(self):
        ...
        self._assertResponse(request, request_token=None, request_token_error=RequestToken.DoesNotExist, token_used=False)
        self.assertFalse(RequestTokenLog.objects.exists())
        return
    ...
    def test_invalid_token(self):
        ...
        request = self._request('/?jwt=' + token.encode(), AnonymousUser())
        self._assertResponse(request, request_token=token, request_token_error=MaxUseError, token_used=False)
        self.assertFalse(RequestTokenLog.objects.exists())
    ...
    def test_valid_token_with_user(self):
        ...
        request = self._request('/?jwt=' + token.encode(), AnonymousUser())
        self._assertResponse(request, request_token=token, request_token_error=None, token_used=True)
    ...
    def test_valid_token_with_wrong_user(self):
        ...
        self._assertResponse(request, request_token=token, request_token_error=exceptions.InvalidAudienceError, token_used=False)
        self.assertFalse(RequestTokenLog.objects.exists())
    ...
    def test_valid_token_with_wrong_url(self):
        ...
        self._assertResponse(request, request_token=token, request_token_error=TargetUrlError, token_used=False)
        self.assertFalse(RequestTokenLog.objects.exists())