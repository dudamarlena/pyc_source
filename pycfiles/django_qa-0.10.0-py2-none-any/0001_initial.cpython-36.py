...
# [GCC 8.4.0]
# Embedded file name: /Users/cristian/projects/python/django-qa/qa/migrations/0001_initial.py
# Compiled at: 2018-03-17 15:30:10
# Size of source mod 2**32: 5805 bytes
from __future__ import unicode_literals
from django.db import migrations, models
import django_markdown.models
from django.conf import settings
import taggit.managers, annoying.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Answer',
       fields=[
      (
     ...
     migrations.CreateModel(name='AnswerComment',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
     ...
     migrations.CreateModel(name='AnswerVote',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
     ...
     migrations.CreateModel(name='QuestionComment',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='QuestionVote',
       fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
      ...
      (
       'question', models.ForeignKey(to='qa.Question', on_delete=(models.CASCADE)))]),
     migrations.CreateModel(name='UserQAProfile',
       fields=[
      (
     ...
     migrations.AddField(model_name='questionvote',
       name='user',
       field=models.ForeignKey(to=(settings.AUTH_USER_MODEL), on_delete=(models.CASCADE))),
     migrations.AddField(model_name='questioncomment',
       name='user',
       field=models.ForeignKey(to=(settings.AUTH_USER_MODEL), on_delete=(models.CASCADE))),
     migrations.AddField(model_name='question',
       name='user',
       field=models.ForeignKey(to=(settings.AUTH_USER_MODEL), on_delete=(models.CASCADE))),
     migrations.AddField(model_name='answervote',
       name='user',
       field=models.ForeignKey(to=(settings.AUTH_USER_MODEL), on_delete=(models.CASCADE))),
     migrations.AddField(model_name='answercomment',
       name='user',
       field=models.ForeignKey(to=(settings.AUTH_USER_MODEL), on_delete=(models.CASCADE))),
     ...
     migrations.AddField(model_name='answer',
       name='user',
       field=models.ForeignKey(to=(settings.AUTH_USER_MODEL), on_delete=(models.CASCADE))),
     migrations.AlterUniqueTogether(name='questionvote',
       unique_together=(set([('user', 'question')]))),
     migrations.AlterUniqueTogether(name='answervote',
