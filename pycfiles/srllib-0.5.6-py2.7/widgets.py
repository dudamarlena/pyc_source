...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\srllib\qtgui\widgets.py
...
class _LineEditUndo(QtGui.QUndoCommand):
    ...
    def __init__(self, edit, prev_text, prev_pos, cur_text, cur_pos, cmd_text, id_):
...
class _LineEditHelper(object):
    ...
    def __edited(self, text):
        ...
        if undo_stack is None:
            ...
            undo_stack.push(_LineEditUndo(self, self.__cur_text, self.__cur_pos, my_text, pos, self.__undo_txt, id_))
...
class LineEdit(_LineEditHelper, QtGui.QLineEdit):
    ...
    def __init__(self, contents=QtCore.QString(), parent=None, undo_stack=None, undo_text=None):
        """ Constructor.
...
class NumericalLineEdit(_NumericalLineEditHelper, LineEdit):
    ...
    def __init__(self, floating_point=True, contents=QtCore.QString(), minimum=None, maximum=None, parent=None, undo_stack=None, undo_text=None):
        """ Constructor.
        ...
        _NumericalLineEditHelper.__init__(self, floating_point, minimum, maximum)
    ...
    def __state_changed(self, state):
        if self.__setting_state:
            ...
            if state == Qt.Checked:
                ...
                state = Qt.Unchecked
            undo_stack.push(_CheckBoxUndo(self, self.__cur_state, state, self.__undo_txt))
            self.__cur_state = state
            return
...
class CheckBox(QtGui.QCheckBox, _CheckBoxHelper):
    ...
    def __init__(self, label=QtCore.QString(), parent=None, undo_stack=None, undo_text=None):
