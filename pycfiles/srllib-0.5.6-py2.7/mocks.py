...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\srllib\testing\qtgui\mocks.py
...
class QLineEditMock(QMock):
    ...
    def setCursorPosition(self, pos):
        ...
        self.emit(SIGNAL('cursorPositionChanged(int, int)'), old_pos, pos)
...
class QCheckBoxMock(QMock):
    ...
    def __init__(self, *args, **kwds):
        kwds.setdefault('returnValues', {}).setdefault('checkState', Qt.Unchecked)
        QMock.__init__(self, *args, **kwds)
        self.__checked = False
