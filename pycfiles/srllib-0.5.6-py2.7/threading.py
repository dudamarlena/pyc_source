...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\srllib\threading.py
...
class Thread(object):
    ...
    def __init__(self, target=None, args=[], kwds={}, name=None, daemon=False, start=False, slot_finished=util.no_op):
    ...
    def _release_locks(self, exception=None):
        if self not in _thread_specific:
            return
