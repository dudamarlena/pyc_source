...
# [GCC 8.4.0]
# Embedded file name: /Users/eric/github/local/gitberg/gitenberg/workflow.py
# Compiled at: 2019-01-01 19:03:47
"""
...
def apply_list(arg_action, id_list):
    ...
    for book_id in id_list:
        try:
            ...
            print(('{}\t{}').format(arg_action, book_id))
            book.remove()
        except Exception as e:
            print(('error\t{}').format(book_id))
            logger.error(('Error processing: {}\r{}').format(book_id, e))
