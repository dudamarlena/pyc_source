...
# Compiled at: 2018-05-09 15:07:12
...
class ConfigGenerator(object):
    ...
    def ask_password(self):
        self.ask_generic('gh_password', ('What is the GitHub password for the {0} user?').format(self.answers.get('gh_user', '[not set]')), is_password=True)
