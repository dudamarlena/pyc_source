...
# Compiled at: 2018-10-22 14:08:36
# Size of source mod 2**32: 3093 bytes
...
class LocalRepo(object):
    __doc__ = ' A class for interacting with a git repo '
    ...
    def cover_files(self):
        ...
        for root, dirs, files in os.walk(self.repo_path):
            ...
            covers = covers + [os.path.join(root, f)[len(self.repo_path) + 1:] for f in files if 'cover' in f if f.lower().split('.')[(-1)] in img_exts]
