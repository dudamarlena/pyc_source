...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/web/util.py
# Compiled at: 2011-04-23 08:56:14
"""
...
class UploadResource(resource.Resource):
    ...
    def render_POST(self, request):
        ...
        if not foundPart:
            ...
            os.write(fp, payload)
            os.close(fp)
            opts = {'filename': foundPart.get_filename(), 'mime': foundPart.get_content_type(), 
               'referer': referer}
