...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/hardware/power.py
...
class PowerService(service.Service):
    ...
    def startService(self):
        try:
            ...
            bus.add_signal_receiver(self.powerEvent, dbus_interface=hal_interface, signal_name='OnBatteryChanged')
            bus.add_signal_receiver(self.lowpowerEvent, dbus_interface=hal_interface, signal_name='LowBatteryChanged')
            ...
            try:
                ...
                bus.add_signal_receiver(self.dkPowerChanged, dbus_interface=dk_interface, signal_name='Changed')
                ...
                managerObj = bus.get_object(dk_interface, dk_udi)
                bus.add_signal_receiver(self.upPowerChanged, dbus_interface=dk_interface, signal_name='Changed')
                manager = dbus.Interface(managerObj, dk_interface)
