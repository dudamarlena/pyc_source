...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/test/test_application.py
# Compiled at: 2011-04-18 10:18:40
"""
...
class TestStateMachine(unittest.TestCase):
    ...
    def testCallbacks(self):
        ...
        class Listener:
            ...
            def enter_a(s):
                self.called.append('enter_a')

            def exit_a(s):
                self.called.append('exit_a')

            def enter_b(s):
                self.called.append('enter_b')

            def exit_b(s):
                self.called.append('exit_b')
    ...
    def testExtraListener(self):
        ...
        class Listener:
            ...
            def enter_a(s):
                self.called.append('enter_a' + s.post)

            def exit_a(s):
                self.called.append('exit_a' + s.post)

            def enter_b(s):
                self.called.append('enter_b' + s.post)

            def exit_b(s):
                self.called.append('exit_b' + s.post)
