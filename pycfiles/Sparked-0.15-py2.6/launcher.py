...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/launcher.py
# Compiled at: 2011-05-10 16:23:53
"""
...
def runInSubprocess(app, options, env, tempPath):
    ...
    while True:
        start = time.time()
        argv = [
         'twistd', '--pidfile', options['pidfile'], '-r', 'gtk2', '-n', 'sparked'] + sys.argv[1:]
