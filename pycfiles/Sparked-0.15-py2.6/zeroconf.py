...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/internet/zeroconf.py
...
class _ZeroconfService(object):
    ...
    def publishService(self, name, stype, port, domain='', host=''):
        ...
        g.AddService(avahi.IF_UNSPEC, avahi.PROTO_UNSPEC, dbus.UInt32(0), name, stype, domain, host, dbus.UInt16(port), '')
        g.Commit()
    ...
    def subscribeTo(self, serviceType):
        ...
        sbrowser = dbus.Interface(self.bus.get_object(avahi.DBUS_NAME, self.server.ServiceBrowserNew(avahi.IF_UNSPEC, avahi.PROTO_UNSPEC, serviceType, 'local', dbus.UInt32(0))), avahi.DBUS_INTERFACE_SERVICE_BROWSER)
    ...
    def _itemNew(self, iface, protocol, name, stype, domain, flags):
        ...
        self.server.ResolveService(iface, protocol, name, stype, domain, avahi.PROTO_UNSPEC, dbus.UInt32(0), reply_handler=resolveSuccess, error_handler=resolveError)
...
__all__ = [
 'zeroconfService', 'zeroconfEvents']