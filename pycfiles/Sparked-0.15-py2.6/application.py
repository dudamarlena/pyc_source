...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/application.py
# Compiled at: 2011-04-18 10:12:15
"""
The base application class.
"""
import os, signal, time, inspect
try:
    import json
except ImportError:
...
class StateMachine(object):
    ...
    def set(self, newstate, *arg, **kw):
        ...
        if self._state:
            self._call('exit_%s' % self._state, True)
        if self.verbose:
