...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sparked/graphics/stage.py
...
class Stage(clutter.Stage):
    ...
    """
    keys = {'fullscreen': gtk.keysyms.F11, 'quit': (
              clutter.CONTROL_MASK, gtk.keysyms.q)}
    debug = False
