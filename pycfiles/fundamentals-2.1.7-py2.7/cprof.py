...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fundamentals/nose2_plugins/cprof.py
...
"""
__all__ = ('Profiler', )
import logging, cProfile, pstats
...
class Profiler(nose2.events.Plugin):
    ...
    def beforeSummaryReport(self, event):
        ...
        self.prof.disable()
        stats = pstats.Stats(self.prof, stream=event.stream).sort_stats(self.sort)
