...
# [GCC 8.4.0]
# Embedded file name: /Users/ppd-03020186/PycharmProjects/cocoNLP/cocoNLP/config/phrase/rake.py
# Compiled at: 2019-02-24 22:15:48
...
class Metric(Enum):
    __doc__ = 'Different metrics that can be used for ranking.'
...
class Rake(object):
    __doc__ = 'Rapid Automatic Keyword Extraction Algorithm.'

    def __init__(self, punctuations=None, ranking_metric=Metric.DEGREE_TO_FREQUENCY_RATIO, max_length=100000, min_length=1):
        """Constructor.
