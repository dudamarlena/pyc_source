...
# [GCC 8.4.0]
# Embedded file name: /Users/ppd-03020186/PycharmProjects/cocoNLP/cocoNLP/config/basic/time_nlp/StringPreHandler.py
...
class StringPreHandler:
    ...
    def wordToNumber(cls, s):
        ...
        if s == '零' or s == '0':
            ...
            if s == '六' or s == '6':
                return 6
            if s == '七' or s == '天' or s == '日' or s == '末' or s == '7':
                return 7
            if s == '八' or s == '8':
                return 8
            if s == '九' or s == '9':
