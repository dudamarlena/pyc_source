...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyrpl/widgets/module_widgets/acquisition_module_widget.py
...
class AcquisitionModuleWidget(ModuleWidget):
    ...
    def update_running_buttons(self):
        ...
        elif self.module.running_state == 'running_single':
