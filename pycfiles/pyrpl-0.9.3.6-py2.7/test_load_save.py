...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyrpl/test/test_load_save.py
...
def scramble_values(mod, str_val='foo', num_val=12.0, bool_val=True, list_val=[
 1912], option_index=0, list_length=4):
    """
