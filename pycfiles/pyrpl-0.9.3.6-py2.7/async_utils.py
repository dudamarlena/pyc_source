...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyrpl/async_utils.py
...
try:
    from asyncio import Future, ensure_future, CancelledError, set_event_loop, TimeoutError
except ImportError:
