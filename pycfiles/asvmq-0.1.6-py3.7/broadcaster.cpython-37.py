...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/asvmq/broadcaster.py
# Compiled at: 2018-09-12 07:07:05
...
class Publisher(object):
    ...
    def publish(self, message):
        ...
        if type(message) != self.type:
            ...
            success or print('Cannot deliver message to Exchange')