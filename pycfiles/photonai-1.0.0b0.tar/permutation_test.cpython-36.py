...
# Compiled at: 2019-09-17 04:37:57
# Size of source mod 2**32: 16455 bytes
import os, queue
...
class PermutationTest:
    ...
    def fit(self, X, y):
        ...
        self.run_parallelized_hyperpipes(self.permutations, self.hyperpipe_constructor, X, self.permutation_id, perms_todo)
    ...
    def get_permutation_status(permutation_id, mongo_db_connect_url='mongodb://trap-umbriel:27017/photon_results', save_to_db=False):
        ...
        def _find_mummy(permutation_id):
            return MDBHyperpipe.objects.raw({'permutation_id':PermutationTest.get_mother_permutation_id(permutation_id),  'computation_completed':True}).first()
...
def run_parallelized_permutation(hyperpipe_constructor, X, perm_run, y_perm, permutation_id):
    ...
    po = OutputSettings(mongodb_connect_url=(perm_pipe.output_settings.mongodb_connect_url), save_predictions='None',
