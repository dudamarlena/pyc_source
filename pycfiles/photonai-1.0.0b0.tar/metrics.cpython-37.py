...
# [GCC 8.4.0]
# Embedded file name: /home/nwinter/PycharmProjects/photon_projects/photon_core/photonai/processing/metrics.py
# Compiled at: 2019-10-10 07:36:09
...
class Scorer(object):
    ...
    ELEMENT_DICTIONARY = {'matthews_corrcoef':('sklearn.metrics', 'matthews_corrcoef', 'score'), 
    ...
    def create(cls, metric):
        ...
        if metric in Scorer.ELEMENT_DICTIONARY:
            try:
                ...
                try:
                    logger.error('ValueError: Could not find according class: ' + Scorer.ELEMENT_DICTIONARY[metric])
                    raise ValueError('Could not find according class:', Scorer.ELEMENT_DICTIONARY[metric])
                finally:
                    ae = None
                    del ae
