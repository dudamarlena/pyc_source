...
# [GCC 8.4.0]
# Embedded file name: /home/nwinter/PycharmProjects/photon_projects/photon_core/photonai/neuro/nifti_transformations.py
        ...
        if isinstance(X, list):
            if len(X) == 1:
                ...
                if isinstance(X, str):
                    ...
                    smoothed_img = smooth_img(X, fwhm=(self.fwhm))
            if self.output_img or isinstance(smoothed_img, list):
