...
# Compiled at: 2019-10-11 08:19:33
# Size of source mod 2**32: 10255 bytes
import numpy as np
...
class NumberRange(PhotonHyperparam):
 ...
 L. 113        20  LOAD_STR                 'Geometric sequence cannot include zero'
               22  STORE_FAST               'error_message'

 L. 114        24  LOAD_GLOBAL              logger
               26  LOAD_METHOD              error
               28  LOAD_FAST                'error_message'
               30  CALL_METHOD_1         1  '1 positional argument'
               32  POP_TOP          

 L. 115        34  LOAD_GLOBAL              ValueError
 ...
 L. 117        64  LOAD_STR                 'NumberRange or one of its subclasses is empty cause np.arange does not deal with start greater than stop.'
               66  STORE_FAST               'warn_message'

 L. 119        68  LOAD_GLOBAL              logger
               70  LOAD_METHOD              warn
 ...
 L. 135       288  LOAD_GLOBAL              ValueError
 ...
 L. 136       296  LOAD_FAST                'self'
              298  LOAD_ATTR                num
          300_302  POP_JUMP_IF_FALSE   342  'to 342'

 L. 137       304  LOAD_GLOBAL              np
 ...
 L. 147       480  LOAD_LISTCOMP            '<code_object <listcomp>>'
 ...
 L. 149       512  LOAD_LISTCOMP            '<code_object <listcomp>>'
