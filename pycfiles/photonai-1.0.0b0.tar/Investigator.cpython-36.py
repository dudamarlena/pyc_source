...
class Investigator:
    ...
    def show(pipe: Hyperpipe):
        ...
        * 'pipe' [Hyperpipe]:
        ...
        """
        if not isinstance(pipe, Hyperpipe):
            raise AssertionError('Investigator.show needs an object of type Hyperpipe')
        else:
        ...
        url = Investigator._Investigator__build_url('a', pipe.name)
    ...
    def load_from_db(mongo_connect_url: str, pipe_name: str):
        ...
        * 'pipe_name' [str]:
        ...
        url = Investigator._Investigator__build_url('m', pipe_name)
        Logger().info('Your url is: ' + url)
        Investigator._Investigator__delayed_browser(url)
        FlaskManager().run_app()
    ...
    def load_from_file(name: str, file_url: str):
        ...
        * 'file_url' [str]:
        ...
        url = Investigator._Investigator__build_url('f', name)
        Investigator._Investigator__delayed_browser(url)
        FlaskManager().run_app()
