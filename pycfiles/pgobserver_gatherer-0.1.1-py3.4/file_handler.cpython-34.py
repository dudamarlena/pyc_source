...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pgobserver_gatherer/output_handlers/file/file_handler.py
...
class Handler(HandlerBase):
    ...
    def __init__(self, settings=None, filters=None):
        ...
        self.out_files = defaultdict(dict)
    ...
    def print_dataset_to_file(self, host_name, dataset_name, data):
        if dataset_name not in self.out_files[host_name]:
            ...
            print('\t\t'.join(sorted(data[0].keys())), file=f)
        else:
