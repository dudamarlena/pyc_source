...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pgobserver_gatherer/id_cache.py
# Compiled at: 2016-04-20 09:16:45
# Size of source mod 2**32: 2327 bytes
import logging, pgobserver_gatherer.datadb as datadb, pgobserver_gatherer.datastore_adapter as datastore_adapter
...
class IdCache(object):
    ...
    def put(self, key_column_values: tuple):
        ...
        ret_data = datastore_adapter.store_to_postgres_metrics_db([data], self.table_name, key_names, [self.id_column])
