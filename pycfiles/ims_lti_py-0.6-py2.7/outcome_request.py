...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/ims_lti_py/outcome_request.py
...
class OutcomeRequest:
    ...
    def post_outcome_request(self):
        ...
        response, content = client.request(self.lis_outcome_service_url, 'POST', body=self.generate_request_xml(), headers={'Content-Type': 'application/xml'})
    ...
    def has_required_attributes(self):
        return self.consumer_key != None and self.consumer_secret != None and self.lis_outcome_service_url != None and self.lis_result_sourcedid != None and self.operation != None
