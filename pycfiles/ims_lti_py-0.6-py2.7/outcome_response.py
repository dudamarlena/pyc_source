...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/ims_lti_py/outcome_response.py
...
class OutcomeResponse:
    ...
    def process_xml(self, xml):
        ...
        try:
            ...
            self.message_identifier = root.imsx_POXHeader.imsx_POXResponseHeaderInfo.imsx_messageIdentifier
            ...
            try:
                self.score = str(root.imsx_POXBody.readResultResponse.result.resultScore.textString)
    ...
    def generate_response_xml(self):
        ...
        """
        root = etree.Element('imsx_POXEnvelopeResponse', xmlns='http://www.imsglobal.org/lis/oms1p0/pox')
