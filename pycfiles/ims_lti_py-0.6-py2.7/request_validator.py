...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/ims_lti_py/request_validator.py
...
class DjangoRequestValidatorMixin(RequestValidatorMixin):
    ...
    def parse_request(self, request, parameters, fake_method=None):
        ...
        """
        return (
         fake_method or request.method,
         request.build_absolute_uri(),
         request.META,
         dict(request.POST.iteritems()) if request.method == 'POST' else parameters)