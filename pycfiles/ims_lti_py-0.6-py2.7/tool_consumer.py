...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/ims_lti_py/tool_consumer.py
...
class ToolConsumer(LaunchParamsMixin, RequestValidatorMixin, object):
    ...
    def has_required_params(self):
        ...
        """
        return self.consumer_key and self.consumer_secret and self.resource_link_id and self.launch_url
    ...
    def generate_launch_data(self):
        ...
        params.update({'oauth_nonce': str(generate_identifier()), 
        ...
        request = oauth2.Request(method='POST', url=self.launch_url, parameters=params)
