...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Products/slideshowfolder/tests/test_browserviews.py
# Compiled at: 2008-07-08 00:43:00
import os
...
class TestBrowserViews(SlideshowFolderTestCase):
    ...
    def afterSetUp(self):
        ...
        self.test_image.setDescription('Qu̩ linda esta flor')
    ...
    def testFolderAsSlideShow(self):
        ...
        self.assertEqual(images[0]['caption'], 'Qu̩ linda esta flor')
        settings = slideshow_view.getSlideshowSettings()
        for setting in ('duration', 'delay', 'thumbnails', 'captions', 'loop', 'linked',
                        'replace', 'width', 'height', 'paused', 'random', 'controller',
                        'fast'):
