...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/zensols/grsync/repospec.py
# Compiled at: 2019-07-10 22:08:35
# Size of source mod 2**32: 6949 bytes
import logging, sys
...
class RepoSpec(object):
    ...
    def master_remote(self):
        if not hasattr(self, '_master_remote'):
            ...
            if config.has_section(MASTER_SECTION):
                if config.has_option(MASTER_SECTION, 'remote'):
