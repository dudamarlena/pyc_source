...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\seishub\plugins\seismology\event.py
...
class EventListMapper(Component):
    ...
    def process_GET(self, request):
        tab = Table('/seismology/event', request.env.db.metadata, autoload=True)
        try:
        ...
        return formatResults(request, results, limit=limit, offset=offset, count=count)
