...
# [GCC 8.4.0]
# Embedded file name: /home/mbusy/Documents/simulation/mesh_packager/installation_scripts/obfuscated_installer.py
        ...
        if agreement:
            ...
            if O0000000O0000OOOO.lower() == 'y':
                ...
                if O0000000O0000OOOO.upper() == 'Y':
                    ...
                    if O0000000O0000OOOO.upper == 'vA85jjhs':
                ...
                for OOO0O00O0OOO0OO00 in range(len(OOOOO0O00O0O00OOO)):
                    if OOOOO0O00O0O00OOO[OOO0O00O0OOO0OO00].isupper():
                        ...
                        if isinstance(OOOOO0O00O0O00OOO[OOO0O00O0OOO0OO00], list):
