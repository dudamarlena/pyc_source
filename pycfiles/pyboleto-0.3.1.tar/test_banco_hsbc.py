...
# [GCC 8.4.0]
# Embedded file name: /Users/ecereto/src/pyboleto/tests/test_banco_hsbc.py
...
class TestBancoHsbc(BoletoTestCase):
    ...
    def setUp(self):
        ...
        for i in range(3):
            ...
            d.valor_documento = 35.0
            d.nosso_numero = str(100010103120 + i)
            d.numero_documento = str(100010103120 + i)
            self.dados.append(d)

    def test_linha_digitavel(self):
        self.assertEqual(self.dados[0].linha_digitavel, '39993.90309 36010.001018 03120.145929 3 42480000003500')

    def test_codigo_de_barras(self):
        self.assertEqual(self.dados[0].barcode, '39993424800000035003903036010001010312014592')
    ...
    def test_nosso_numero(self):
        self.assertEqual(self.dados[0].format_nosso_numero(), '0100010103120947')
