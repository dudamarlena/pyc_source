...
# [GCC 8.4.0]
# Embedded file name: /Users/ecereto/src/pyboleto/tests/test_banco_banrisul.py
# Compiled at: 2016-04-11 01:28:17
...
class TestBancoBanrisul(BoletoTestCase):
    ...
    def test_linha_digitavel(self):
        self.assertEqual(self.dados[0].linha_digitavel, '04192.11107 29000.150226 83256.340593 8 10010000055000')

    def test_tamanho_codigo_de_barras(self):
        self.assertEqual(len(self.dados[0].barcode), 44)

    def test_codigo_de_barras(self):
        self.assertEqual(self.dados[0].barcode, '04198100100000550002111029000150228325634059')
