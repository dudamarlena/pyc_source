...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/total_scattering/test_utils.py
# Compiled at: 2019-10-03 13:30:51
import unittest, total_scattering.reduction.total_scattering_reduction as ts
...
class TestUtilsForReduction(unittest.TestCase):
    ...
    def test_find_key_match_in_dict(self):
        ...
        """
        keys = [
         'Vanadium', 'Normalization', 'Normalisation']
