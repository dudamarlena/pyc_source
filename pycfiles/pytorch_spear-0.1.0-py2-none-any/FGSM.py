...
# [GCC 8.4.0]
# Embedded file name: /home/tejus/spear/spear/attacks/FGSM.py
# Compiled at: 2018-10-25 07:25:38
import torch
...
class FGSM:
    ...
    def __init__(self, eps=0.3, targeted=False, clip_min=0, clip_max=1):
        """
    ...
    def generate(self, net, images, labels=None):
        ...
        loss.backward()
        with torch.no_grad():
            return torch.clamp(images + self.eps * torch.sign(images.grad), self.clip_min, self.clip_max)
        return