...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/tabkit/awk/group.py
...
class AggregateFunction(object):
    ...
    @property
    def code(self):
        return self.code_template.format(var_name=self.var_name, *self.args, **self.kwargs)
...
class AggregateAwkNodeVisitor(AwkNodeVisitor):
    aggregate_funcs = {'sum': SumFunction, 
       'count': CountFunction, 
