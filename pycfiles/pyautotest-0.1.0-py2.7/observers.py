...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/pyautotest/observers.py
# Compiled at: 2013-05-29 20:41:21
import datetime, logging, os, platform, re, subprocess, sys, time, types, unittest
