...
# Embedded file name: build/bdist.linux-i686/egg/chimera/tests/test_chimera.py
# Compiled at: 2007-02-08 13:55:31
import unittest, chimera, os
...
class TestChimera(unittest.TestCase):
    ...
    def test_resizeTo(self):
        c = chimera.ChimeraText('Comic Sans MS 20', 'Chimera Rocks!')
    ...
    def test_blend(self):
        c = chimera.Image('logo.jpg')
        f = chimera.ChimeraText('Comic Sans MS 24', 'Chimera Rocks!')
        c.blend(f, (0, 0), 0.5)
    ...
    def test_chimeratext(self):
        c = chimera.ChimeraText('Comic Sans MS 96', 'ChimeraRocks!', 'blue', 'red')
        assert c
        c = chimera.Image('logo.jpg')
        f = chimera.ChimeraText('1942 Report 10', 'ChimeraRocks!', 'black', 'red')
        c.blend(f, (0, 0), 0.2)

    def test_width_layout(self):
        from codecs import open
        text = open('text.utf8', 'r', 'utf-8').read()
        c = chimera.ChimeraText('Sans 24', text, 'black', 'white', 512)
        c.rotate(90)
        assert c

    def test_withFontConfig(self):
        chimera.addFontDir(os.path.abspath(os.curdir))
        c = chimera.ChimeraText('Barrakuda 24', 'Chimera Rocks!', 'red', 'white')
        assert c
