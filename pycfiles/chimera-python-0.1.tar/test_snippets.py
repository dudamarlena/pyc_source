...
# Embedded file name: build/bdist.linux-i686/egg/chimera/tests/test_snippets.py
# Compiled at: 2007-02-08 13:55:31
import math, os, unittest, chimera.pangocairo as pc
...
class Test(unittest.TestCase):
    ...
    def test_gradient(self):
        ...
        cairo.fill(pat)
        pat = pc.RadialGradient(0.45, 0.4, 0.1, 0.4, 0.4, 0.5)
