...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyupnptools/http_header.py
# Compiled at: 2018-09-02 06:09:50
import os
...
class FirstLine:
    ...
    def __init__(self, line):
        if line:
            self._tokens = re.split(' |\\t', line, maxsplit=2)
