...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyupnptools/upnp_server.py
# Compiled at: 2018-09-02 18:56:47
from .upnp import *
...
class UPnPDeviceSession:
    ...
    def __init__(self, device):
        ...
        self._service_properties = {service.serviceType():UPnPServiceProperty(service) for service in device.all_services()}
        return
