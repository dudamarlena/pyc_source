...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyupnptools/ssdp.py
# Compiled at: 2018-09-02 06:01:30
...
class SsdpListener:
    ...
    def run(self):
        ...
        while not self._finishing:
            _timeout = 1
            readables, writables, exceptionals = select.select(inputs, outputs, inputs, _timeout)
