...
# Embedded file name: build\bdist.win32\egg\pyjack.py
# Compiled at: 2011-03-14 21:53:14
...
import sys as _sys, gc as _gc, types as _types, inspect as _inspect
_WRAPPER_TYPES = (
 type(object.__init__), type(object().__init__))
...
def connect(fn, proxyfn):
    ...
    elif issubclass(fn_type, (_types.BuiltinFunctionType, _types.BuiltinMethodType, type)):
...
def replace_all_refs(org_obj, new_obj):
    ...
    for referrer in _gc.get_referrers(org_obj):
        ...
        if isinstance(referrer, dict):
            ...
            localsmap = {}
            for key in ['func_code', 'func_globals', 'func_name', 'func_defaults', 'func_closure']:
