...
# [GCC 8.4.0]
# Embedded file name: /Users/zk/anaconda3/lib/python3.7/site-packages/lee/transport.py
# Compiled at: 2020-01-25 00:56:54
...
class Transport:
    ...
    def login(self, email, pwd):
        ...
        self.cache_session.set('session', (self.session.cookies), expire=604800)
    ...
    def submit(self, qid, code, language='python', retry=3):
        if retry == 0:
            print('submit fails after 3 retires, try later')
            return
    ...
    def test(self, qid, code, sampleTestCase, language):
        ...
        payload = {'data_input':sampleTestCase, 
         'lang':language, 
         'question_id':1, 
         'test_mode':True, 
         'typed_code':code}
