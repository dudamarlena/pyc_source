...
# [GCC 8.4.0]
# Embedded file name: /Users/zk/anaconda3/lib/python3.7/site-packages/lee/solution.py
# Compiled at: 2020-02-11 23:04:47
...
class Solution:
    ...
    def load_from_edge(self, qid, eng_name, raw_edge):
        ...
        self._content = solution['post']['content'].replace('\\n', ' \n').replace('\\t', ' \t').replace('```', '``` ')
