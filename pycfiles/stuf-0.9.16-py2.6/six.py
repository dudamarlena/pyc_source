...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/stuf/six.py
...
get_ident = backport('thread.get_ident', 'dummy_thread.get_ident', '_thread.get_ident')
...
_moved_attributes = [
 MovedAttribute('GeneratorContextManager', 'contextlib', 'contextlib', 'GeneratorContextManager', '_GeneratorContextManager'),
