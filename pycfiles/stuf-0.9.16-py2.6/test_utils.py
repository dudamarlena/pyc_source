...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/tests/test_utils.py
...
class TestUtils(unittest.TestCase):
    ...
    def test_iterexcept(self):
        ...
        deferred = iterexcept(partial(next, iter([1, 2, 3])), StopIteration, lambda : 1)
    ...
    def test_ascii(self):
        ...
        self.assertEqual([ tobytes(i, 'ascii') for i in [[1], True, 't', b('i'), u('g'), None, (1, )] ], [
         b('[1]'), b('True'), b('t'), b('i'), b('g'), b('None'), b('(1,)')])
        return

    def test_bytes(self):
        from stuf.six import u, b, tobytes
        self.assertEqual([ tobytes(i) for i in [[1], True, 't', b('i'), u('g'), None, (1, )] ], [
         b('[1]'), b('True'), b('t'), b('i'), b('g'), b('None'), b('(1,)')])
        return

    def test_unicode(self):
        from stuf.six import u, b, tounicode
        self.assertEqual([ tounicode(i) for i in [[1], True, 't', b('i'), u('g'), None, (1, )] ], [
