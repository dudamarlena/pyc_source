...
# Embedded file name: build/bdist.linux-x86_64/egg/plasma/models/runner.py
    ...
    while e < num_epochs - 1:
        ...
        for i, shot_sublist in enumerate(shot_sublists):
            ...
            for j, (X, y) in enumerate(zip(X_list, y_list)):
                ...
                train_model.fit(X, y, batch_size=Loader.get_batch_size(conf['training']['batch_size'], prediction_mode=False), nb_epoch=1, shuffle=False, verbose=0, validation_split=0.0, callbacks=[history])
