...
# Embedded file name: build/bdist.linux-x86_64/egg/plasma/utils/mpi_launch_tensorflow.py
...
def get_mpi_cluster_server_jobname(num_ps=1, num_workers=None):
    ...
    return (
     cluster, server, job_name, global_task_index, num_workers)
