...
# Embedded file name: /opt/PY3/CONJUGAR_/conjugar/symmtera.py
# Compiled at: 2018-11-26 10:27:19
...
class FSM:
    ...
    def modify_by_name(self, **kwargs):
        ...
        if 'next_state' in kwargs:
            ...
            next_state = None
        if (
         curr_state, trigger_checker) in self.fsm_dict:
            self.fsm_dict[(curr_state, trigger_checker)] = (
             action, next_state)
            return True
        else:
    ...
    def add(self, *args):
        if (
         args[0], args[1]) in self.fsm_dict:
            print((args[0], args[1]), end='')
    ...
    def add_by_name(self, **kwargs):
        ...
        if 'next_state' in kwargs:
            ...
            next_state = None
        if (
         curr_state, trigger_checker) in fsm_dict:
            print((curr_state, trigger_checker), end='')
            ...
            if key[0] == curr_state:
                ...
                if cond:
                    ...
                    if self.enable_debug:
                        ...
                        print('next_state: ' + next_state)
                    return (
                     action, next_state, trigger_checker)
                    continue
