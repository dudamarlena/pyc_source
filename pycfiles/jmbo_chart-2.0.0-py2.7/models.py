...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/chart/models.py
# Compiled at: 2015-04-28 16:08:50
...
class Chart(ModelBase):
    ...
    def chartentries_permitted(self):
        return self.chartentries.filter(track__in=Track.permitted.all()).order_by('current_position')
