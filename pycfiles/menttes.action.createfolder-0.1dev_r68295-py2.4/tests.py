...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/menttes/action/createfolder/tests.py
...
class TestCreatefolderaction(ptc.PloneTestCase):
    ...
    class layer(PloneSite):
        ...
        def setUp(cls):
            ...
            zcml.load_config('configure.zcml', menttes.action.createfolder)
    ...
    def testRegistered(self):
        element = getUtility(IRuleAction, name='menttes.action.createfolder.Createfolder')
        self.assertEquals('menttes.action.createfolder.Createfolder', element.addview)
    ...
    def testExecute(self):
        e = CreatefolderAction()
        e.foldername = 'foo'
        ex = getMultiAdapter((self.portal.testfolder, e, DummyEvent(self.portal.testfolder)), IExecutable)
