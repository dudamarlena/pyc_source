...
# [GCC 8.4.0]
# Embedded file name: /home/tron/dev/irc-env/lib/python3.3/site-packages/irc3_pugbot/pug.py
# Compiled at: 2014-01-04 15:25:04
...
def need_highlander(players):
    ...
    class_count = {class_:count for class_, count in class_count.items() if count > 0 if count > 0}
    return (
     captain_count, player_count, class_count)
