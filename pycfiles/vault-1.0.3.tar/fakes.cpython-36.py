...
# [GCC 8.4.0]
# Embedded file name: /Users/julio.rama/git/vault-opensource/vault/tests/fakes.py
...
def build_fake_session():
    ...
    fake_session['service_catalog'] = {'object_store':{'adminURL':'https://fake.api.globoi.com/v1/AUTH_XPTO', 
