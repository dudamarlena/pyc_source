...
# [GCC 8.4.0]
# Embedded file name: /Users/julio.rama/git/vault-opensource/identity/tests/test_ajax_views.py
...
class TestListUserRole(BaseAjaxTestCase):
    ...
    def setUp(self):
        ...
        self.mock_user_list = patch('identity.keystone.Keystone.user_list').start()
