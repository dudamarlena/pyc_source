...
# [GCC 8.4.0]
# Embedded file name: /Users/julio.rama/git/vault-opensource/vault/tests/test_views.py
# Compiled at: 2020-03-19 00:13:30
# Size of source mod 2**32: 10439 bytes
...
from vault.views import DashboardView, SetProjectView, DeleteUserTeamView, AddUserTeamView, ListUserTeamView, UpdateTeamsUsersView
...
class UpdateTeamsUsersTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.roles = {'roles': {'driver_processado':[
                    {'1751': 'qa2'},
                    {'11': 'Storm'}], 
                   'sheets':[
                    {'1754': 'Financeiro'},
    ...
    def test_manage_users_teams_flow_ensure_group_list_was_filled_up(self, mock_response):
        ...
        self.assertIn('<option value="{}">{}'.format(group.id, group.name), response.content.decode('utf-8'))
