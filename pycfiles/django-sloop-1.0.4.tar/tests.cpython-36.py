...
class SNSHandlerTests(TestCase):
    ...
    def test_create_platform_endpoint(self):
        ...
        sns_client.create_platform_endpoint.assert_called_once_with(PlatformApplicationArn=(DJANGO_SLOOP_SETTINGS['SNS_IOS_APPLICATION_ARN']),
...
class DeviceTests(TestCase):
    ...
    def test_send_ios_push_notification(self):
        ...
        self.assertEqual(push_message.sns_response, json.dumps({'MessageId': sns_test_message_id}))
    ...
    def test_invalidate_device_if_push_message_fails(self):
        sns_client = Mock()
        SNSHandler.client = sns_client
        sns_client.publish.side_effect = ClientError(error_response={'Error': {'Code': 'EndpointDisabled'}},
          operation_name='test')
        self.ios_device.sns_platform_endpoint_arn = 'test_ios_arn'
        self.ios_device.save()
        ...
        self.assertEqual(push_message.sns_response, json.dumps({'Error': {'Code': 'EndpointDisabled'}}))
