...
class SloopAdminMixin(object):
    ...
    def get_urls(self):
        ...
        return [
         url('^send-push-notification/$', (self.admin_site.admin_view(self.push_notification_view)), name=('%s_%s_send_push_notification' % (self.model._meta.app_label, self.model._meta.model_name)))] + urls
