...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/astrocalc/coords/translate.py
...
class translate(object):
    ...
    **Usage**
    ...
    def __init__(self, log, ra, dec, northArcsec, eastArcsec, settings=False):
        self.log = log
        log.debug("instansiating a new 'translate' object")
        self.settings = settings
        self.ra = ra
        self.dec = dec
        self.north = northArcsec / 3600.0
        self.east = eastArcsec / 3600.0
    ...
    def get(self):
        ...
        **Return**
        ...
        ra2 = self.ra + old_div(self.east, math.cos((self.dec + dec2) * self.DEG_TO_RAD_FACTOR / 2.0))
        while ra2 > 360.0 or ra2 < 0.0:
            while ra2 > 360.0:
                ra2 = ra2 - 360.0
