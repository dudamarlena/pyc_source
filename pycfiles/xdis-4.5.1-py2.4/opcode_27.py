...
of stack usage.
"""
from xdis.opcodes.base import compare_op, def_op, finalize_opcodes, format_CALL_FUNCTION_pos_name_encoded, format_extended_arg, init_opdata, jabs_op, jrel_op, name_op, rm_op, update_pj3, varargs_op
