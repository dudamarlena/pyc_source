...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/xdis/opcodes/base.py
...
from xdis.cross_dis import findlinestarts, findlabels, get_jump_target_maps, get_jump_targets
...
def update_sets(l):
    ...
    l['JUMP_UNCONDITONAL'] = frozenset([l['opmap']['JUMP_ABSOLUTE'], l['opmap']['JUMP_FORWARD']])
    if l['python_version'] < 3.8:
        l['LOOP_OPS'] = frozenset([l['opmap']['SETUP_LOOP']])
    else:
        l['LOOP_OPS'] = frozenset()
    l['LOCAL_OPS'] = frozenset(l['haslocal'])
    l['JUMP_OPS'] = l['JABS_OPS'] | l['JREL_OPS'] | l['LOOP_OPS'] | l['JUMP_UNCONDITONAL']
