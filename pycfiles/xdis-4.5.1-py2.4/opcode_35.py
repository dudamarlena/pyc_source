...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/xdis/opcodes/opcode_35.py
...
of stack usage.
"""
from xdis.opcodes.base import def_op, init_opdata, finalize_opcodes, format_extended_arg, jrel_op, rm_op, varargs_op, update_pj3
...
varargs_op(l, 'BUILD_MAP', 105, -1, -1)
