...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/xdis/std.py
...
class _StdApi:
    ...
    def disco(self, code, lasti=-1, file=None):
        """Disassemble a code object."""
        return _disco(self.python_version, code, timestamp=None, out=file, is_pypy=self.is_pypy, header=False)
