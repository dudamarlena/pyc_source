...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/xdis/opcodes/opcode_15.py
# Compiled at: 2020-04-26 11:11:43
"""
...
from xdis.opcodes.base import compare_op, const_op, def_op, jabs_op, jrel_op, finalize_opcodes, format_extended_arg, local_op, name_op, nargs_op, store_op, varargs_op, update_pj2
version = 1.5
...
varargs_op(l, 'UNPACK_TUPLE', 92)
def_op(l, 'UNPACK_LIST', 93)
...
varargs_op(l, 'BUILD_MAP', 104, -1, 1)
...
def_op(l, 'MAKE_FUNCTION', 132, -1, 1)
varargs_op(l, 'BUILD_SLICE', 133, -1, 1)
