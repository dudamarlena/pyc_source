...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/alpaca_trade_api_fixed/stream2.py
...
class StreamConn(object):
    ...
    async def _ensure_nats(self):
        ...
        self.polygon.register('.*', self._dispatch_nats)
    ...
    async def subscribe(self, channels):
        ...
        if len(ws_channels) > 0:
            ...
            await self._ws.send(json.dumps({'action':'listen', 
             'data':{'streams': ws_channels}}))
