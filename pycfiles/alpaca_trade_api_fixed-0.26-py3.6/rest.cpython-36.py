...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/alpaca_trade_api_fixed/rest.py
# Compiled at: 2020-02-14 14:55:34
# Size of source mod 2**32: 8769 bytes
import logging, os, requests
from requests.exceptions import HTTPError
import time
from .common import get_base_url, get_data_url, get_credentials, get_api_version
from .entity import Account, Asset, Order, Position, BarSet, Clock, Calendar
from . import polygon
...
class REST(object):
    ...
    def __init__(self, key_id=None, secret_key=None, base_url=None, api_version=None):
        ...
        self._retry_codes = [int(o) for o in os.environ.get('APCA_RETRY_CODES', '429,504').split(',')]
        self.polygon = polygon.REST(self._key_id, 'staging' in self._base_url)
    ...
    def _request(self, method, path, data=None, base_url=None):
        ...
        while retry >= 0:
            try:
                ...
                logger.warning('sleep {} seconds and retrying {} {} more time(s)...'.format(retry_wait, url, retry))
    ...
    def list_orders(self, status=None, limit=None, after=None, until=None, direction=None, params=None):
        """
    ...
    def submit_order(self, symbol, qty, side, type, time_in_force, limit_price=None, stop_price=None, client_order_id=None):
        """Request a new order"""
    ...
    def get_order_by_client_order_id(self, client_order_id):
        ...
        resp = self.get('/orders:by_client_order_id', {'client_order_id': client_order_id})
        return Order(resp)
