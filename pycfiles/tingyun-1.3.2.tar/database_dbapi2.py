...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/armoury/database_dbapi2.py
...
db_name_module = {'MySQLdb': 'MySQL', 
   'pymysql': 'MySQL', 'oursql': 'MySQL', 'cx_Oracle': 'Oracle', 
   'psycopg2': 'PostgreSQL', 
   'psycopg2ct': 'PostgreSQL', 'psycopg2cffi': 'PostgreSQL', 'pyodbc': 'ODBC'}
