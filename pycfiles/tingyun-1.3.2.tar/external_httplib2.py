...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/armoury/external_httplib2.py
...
def detect_httplib2_http(module):
    ...
    return wrap_external_trace(module, 'Http.request', 'httplib2', http_url, params=parse_params, exception_wrapper=wrap_exception)
