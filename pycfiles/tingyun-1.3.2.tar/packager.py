...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/logistics/workshop/packager.py
...
class Packager(object):
    ...
    def record_tracker(self, tracker):
        ...
        self.record_time_metrics(tracker.time_metrics())
        self.record_action_metrics(tracker.action_metrics())
        self.record_apdex_metrics(tracker.apdex_metrics())
        self.record_traced_errors(tracker.traced_error())
    ...
    def record_slow_action(self, slow_action):
        ...
        if metric_name not in self.__slow_action:
            self.__slow_action[metric_name] = [
             [
              slow_action, slow_action[1]]]
        elif len(self.__slow_action[metric_name]) <= top_n:
    ...
    def record_traced_external_trace(self, traced_errors):
        ...
        for error in traced_errors:
            ...
            if error.error_filter_key in self.__traced_external_errors:
                ...
                self.__traced_external_errors[error.error_filter_key] = {'count': 1, 'status_code': error.status_code, 'item': error.trace_data, 'tracker_type': error.tracker_type}
    ...
    def merge_metric_packets(self, snapshot):
        ...
        for key, value in six.iteritems(snapshot.__slow_sql_packets):
            ...
            elif value.slow_sql_node.duration > slow_sql.slow_sql_node.duration:
                self.__slow_sql_packets[key] = value
    ...
    def component_metrics(self, metric_name_ids):
        ...
        for key, value in six.iteritems(self.__time_packets):
            ...
            if len(extend_metrics) == 1:
                ...
                upload_key = {'name': extend_metrics[0], 'parent': key[1], 'calleeId': extend_metrics[1], 'calleeName': extend_metrics[2]}
                result.append([upload_key, value])
    ...
    def error_packets(self, metric_name_ids):
        ...
        error_count = {'Errors/Count/All': 0, 
