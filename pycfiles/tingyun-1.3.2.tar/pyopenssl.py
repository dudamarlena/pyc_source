...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/packages/requests/packages/urllib3/contrib/pyopenssl.py
...
DEFAULT_SSL_CIPHER_LIST = 'ECDH+AESGCM:DH+AESGCM:ECDH+AES256:DH+AES256:' + 'ECDH+AES128:DH+AES:ECDH+3DES:DH+3DES:RSA+AESGCM:RSA+AES:RSA+3DES:' + '!aNULL:!MD5:!DSS'
