...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/logistics/workshop/packets.py
...
class TimePackets(list):
    ...
    def __init__(self, call_count=0, total_call_time=0.0, total_exclusive_call_time=0.0, max_call_time=0.0, min_call_time=0.0, sum_of_squares=0.0):
