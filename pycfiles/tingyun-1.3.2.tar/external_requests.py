...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/armoury/external_requests.py
...
def detect_requests_request(module):
    ...
    wrap_external_trace(module, 'request', 'requests', request_url, exception_wrapper=wrap_exception)
...
def detect_requests_sessions(module):
    ...
    wrap_external_trace(module, 'Session.request', 'requests', request_url, params=parse_params, exception_wrapper=wrap_exception)