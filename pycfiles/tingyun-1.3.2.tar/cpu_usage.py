...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/armoury/sampler/cpu_usage.py
...
class CpuUsage(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        if self.__times is None:
            ...
            yield [
             TimeMetric(name=cpu_use_metric, scope=cpu_use_metric, duration=int(cpu_use_time), exclusive=int(cpu_use_time))]
            ...
            yield [
             TimeMetric(name=cpu_utilization_metric, scope=cpu_utilization_metric, duration=utilization, exclusive=utilization)]
            return
