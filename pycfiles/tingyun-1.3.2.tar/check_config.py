...
# [GCC 8.4.0]
# Embedded file name: /home/nb/publish/btw/tingyun/tingyun/commander/commands/check_config.py
...
class Command(object):
    ...
    def _process_setting(self, section, option, getter='get', mapper=None):
        ...
        try:
            ...
            return [
             -1, None, 'Section [%s] is not specified.' % section]
        except ConfigParser.NoOptionError:
            return [
             0, None, 'Option <%s> is not exist.' % option]
