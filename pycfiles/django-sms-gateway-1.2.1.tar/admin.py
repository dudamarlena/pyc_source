...
# [GCC 8.4.0]
# Embedded file name: /Users/matt/Development/django-sms-gateway/sms/admin.py
# Compiled at: 2012-11-27 00:06:21
...
class MessageAdmin(admin.ModelAdmin):
    list_display = ('recipient_number', 'status', 'sender', 'local_send_time', 'billed',
                    'gateway', 'gateway_charge', 'billee')
    list_filter = ('status', 'billed', 'gateway')
    search_fields = ('recipient_number', 'content')
