...
# [GCC 8.4.0]
# Embedded file name: /Users/matt/Zarloc/Development/trunk/project/apps/django-sms-gateway/sms/migrations/0002_auto__add_field_message_gateway_charge__chg_field_message_uuid__add_fi.py
...
class Migration(SchemaMigration):
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'sms.gateway': {'Meta': {'object_name': 'Gateway'}, 'base_url': (
                       ...
                       'uuid_keyword': (
                                      'django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})}, 
       'sms.message': {'Meta': {'object_name': 'Message'}, 'billed': (
                                'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                       'content': (
