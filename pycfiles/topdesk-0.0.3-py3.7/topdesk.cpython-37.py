...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/topdesk/topdesk.py
# Compiled at: 2020-02-10 08:06:29
# Size of source mod 2**32: 55707 bytes
"""Main topdesk module"""
import json
...
class Topdesk:
    ...
    def request(self, scheme, url, data=None, params=None, extra=None):
        ...
        if extra is None:
            ...
            headers = {'User-Agent':'topdesk Python wrapper: https://gitlab.com/wobcom/topdesk', 
            ...
            res = fn(url, headers=headers, data=json.dumps(data), params=params, verify=self.verify, **extra)
            if not res.ok:
    ...
    def login_person(self, username, password):
        ...
        Log in as a person.
        """
        token = self.get('/login/person', extra={'auth': (username, password)})
    ...
    def login_operator(self, username, password):
        ...
        """
        token = self.get('/login/operator', extra={'auth': (username, password)})
        self.token = token.decode('ascii')
    ...
    def escalate_incident(self, id_or_number, reason_id=None):
        ...
        """
        params = {'id': reason_id}
        return self._treat_incident('/incidents/id/{}/escalate', id_or_number, params=params)
    ...
    def deescalate_incident(self, id_or_number, reason_id=None):
        ...
        """
        params = {'id': reason_id}
        return self._treat_incident('/incidents/id/{}/deescalate', id_or_number, params=params)
    ...
    def archive_incident(self, id_or_number, reason_id=None):
        ...
        """
        params = {'id': reason_id}
        return self._treat_incident('/incidents/id/{}/archive', id_or_number, params=params)
    ...
    def unarchive_incident(self, id_or_number, unarchive_partials=True):
        ...
        """
        params = {'unarchive_partials': unarchive_partials}
        return self._treat_incident('/incidents/id/{}/unarchive', id_or_number, params=params)

    @logged_in
    def action_by_incident(self, incident_id_or_number, action_id, inline_images=False):
        """
        ...
        params = {'inlineimages': inline_images}
        return self.get(('/incidents/{}/actions/{}'.format(path, action_id)), params=params)

    @logged_in
    def incident_actions_by_incident(self, id_or_number, start=0, page_size=10, inline_images=False):
        """
        ...
        return self._treat_incident('/incidents/id/{}/actions', id_or_number, params=params)

    @logged_in
    def progress_trail_by_incident(self, id_or_number, start=0, page_size=10, inline_images=False):
        """
        ...
        params = {'start':start, 
         'page_size':page_size, 
         'inlineimages':inline_images}
        return self._treat_incident('/incidents/id/{}/progresstrail', id_or_number,
          params=params)
    ...
    def progress_trail_count_by_incident(self, id_or_number):
        ...
        """
        return self._treat_incident('/incidents/id/{}/progresstrail/count', id_or_number)

    @logged_in
    def requests_by_incident(self, id_or_number, start=0, page_size=10, inline_images=False):
        """
        ...
        params = {'start':start, 
         'page_size':page_size, 
         'inlineimages':inline_images}
        return self._treat_incident('/incidents/id/{}/requests', id_or_number, params=params)
    ...
    def processing_status(self):
        ...
        return self.get('/processing_status')
    ...
    def reschedule_reservation(self, id_, start_date, end_date):
        ...
        """
        data = {'plannedStartDate':start_date or '', 
    ...
    def assets(self, template_id, fields=None, include_archived=None):
        ...
        return self.get(('/assetmgmt/assets/templateId/{}'.format(template_id)), params=params)

    @logged_in
    def create_asset(self, template_id, data):
        """
        Create a new asset. A description of the model can be found in the
        topdesk documentation (https://developers.topdesk.com/explorer/?page=assets#/Asset%20Management%20Import%20API/createByImport).
        """
        return self.post(('/assetmgmt/assets/templateId/{}'.format(template_id)), data=data)

    @logged_in
    def update_assert(self, id_, template_id, data):
        """
    ...
    def asset_dropdown_options(self, dropdown_id, fields=None):
        ...
        """
        params = {'field': fields}
        return self.get(('/assetmgmt/dropdowns/{}'.format(dropdown_id)), params=params)
    ...
    @logged_in
    def link_assets(self, source_id, target_id, type_='child', capability_id=None):
        """
    ...
    def possible_asset_link_relations(self, source_id, target_id):
        ...
        params = {'sourceId':source_id, 
         'targetId':target_id}
        return self.get('/assetmgmt/assetLinks/possibleRelations', params=params)
    ...
    @logged_in
    def create_asset(self, template_id, number_field=None, text_field=None, dropdown_field=None):
        """
        Create a new asset by providing a template ID. Optional parameters:
        - number_field: an optional asset number
        - text_field: an optional asset text
        - dropdown_field: an optional dropdown value
        """
    ...
    def assign_to_asset(self, asset_id, data):
        ...
        to find out more.
        """
        return self.put(('/assetmgmt/assets/{}/assignments'.format(asset_id)), data=data)
    ...
    def my_authorizables(self, manager_actions=None):
        ...
        """
        params = {'managerAction': manager_actions}
    ...
    @logged_in
    def change_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        """
        ...
        return self.get(('/managerAuthorizableChanges/{}/requests'.format(id_)), params=params)
    ...
    @logged_in
    def update_change_status(self, id_, from_, action, reason=None, comment=None):
        """
    ...
    @logged_in
    def update_authorization_activity(self, id_, action, reason=None, comment=None):
        """
    ...
    @logged_in
    def activity_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        """
    ...
    @logged_in
    def requester_change_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        """
        Get the list of requests for a change. Optional parameters:
        - inline_images: whether inline images should be returned
        - browser_friendly_urls: whether download URLs should browser URLs
        ...
        params = {'inlineimages':inline_images, 
         'browserFriendlyUrls':browser_friendly_urls}
        return self.get(('/requesterChanges/{}/requests'.format(id_)), params=params)
    ...
    @logged_in
    def process_operator_change(self, id_, from_, action, reason=None, comment=None):
        """
    ...
    @logged_in
    def operator_change_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        """
        ...
        params = {'inlineimages':inline_images, 
         'browserFriendlyUrls':browser_friendly_urls}
        return self.get(('/operatorChanges/{}/requests'.format(id_)), params=params)
    ...
    def create_action_for_operator_change(self, id_, memo_text, type_):
        ...
        data = {'memoText':memo_text, 
         'type':type_}
        return self.post(('/operatorChanges/{}/progresstrail'.format(id_)), data=data)

    @logged_in
    def download_operator_change_attachment(self, id_, attachment_id):
        """Download an operator change attachment by ID"""
        return self.get('/operatorChanges/{}/attachments/{}'.format(id_, attachment_id))
    ...
    @logged_in
    def operator_change_activity_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        """
        ...
        params = {'inlineimages':inline_images, 
         'browserFriendlyUrls':browser_friendly_urls}
        return self.get(('/operatorChangeActivities/{}/requests'.format(id_)), params=params)

    @logged_in
    def operator_change_activity_progress_trail(self, id_, inline_images=False, browser_friendly_urls=False):
        """
    ...
    @logged_in
    def download_operator_change_activity_attachment(self, id_, attachment_id):
    ...
    @logged_in
    def change_calendar_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        """
        Get requests for this change activity.
        - inline_images: whether inline images should be returned
        - browser_friendly_urls: whether download URLs should browser URLs
        ...
        params = {'inlineimages':inline_images, 
         'browserFriendlyUrls':browser_friendly_urls}
        return self.get(('/changeCalendar/{}/requests'.format(id_)), params=params)

    @logged_in
    def change_calendar_progress_trail(self, id_, inline_images=False, browser_friendly_urls=False):
        """
        Get progress trail for an operator change activity identified by ID.
        Optional parameters:
        - inline_images: whether inline images should be returned
    ...
    def download_change_calendar_attachment(self, id_, attachment_id):
        """Download the attachment of a change identified by ID"""
        return self.get('/changeCalendar/{}/attachments/{}'.format(id_, attachment_id))
