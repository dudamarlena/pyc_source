...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/shadersmanager/widgets/assetsviewer.py
# Compiled at: 2020-03-13 14:15:56
# Size of source mod 2**32: 13342 bytes
"""
...
class ArtellaAssetShadersViewer(base.BaseWidget, object):
    ...
    def show_shaders_info(self, asset_widget):
        ...
        if not shaders_info_widget:
            LOGGER.warning('Asset {} has not an AssetShadersInfo widget associated to it. Skipping ...!'.format(asset_widget.get_name()))
            return
...
class AssetShadersStack(base.BaseWidget, object):
    ...
    def ui(self):
        ...
        self._shaders_viewer = artellapipe.ShadersViewer(project=project,
