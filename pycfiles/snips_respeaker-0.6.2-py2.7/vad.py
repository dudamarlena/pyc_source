...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/respeaker/vad.py
...
"""
import collections, sys, webrtcvad
...
class WebRTCVAD:
    ...
    def __init__(self, sample_rate=16000, level=0):
        ...
        self.frame_ms = 30
        self.frame_bytes = int(2 * self.frame_ms * self.sample_rate / 1000)
