...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/respeaker/bing_speech_api.py
...
"""
import io, os, types, uuid, wave, requests
try:
...
class BingSpeechAPI:
    ...
    def __init__(self, key=os.getenv('BING_KEY', '')):
        ...
        self.locales = {'ar-eg': {'Female': 'Microsoft Server Speech Text to Speech Voice (ar-EG, Hoda)'}, 'de-DE': {'Female': 'Microsoft Server Speech Text to Speech Voice (de-DE, Hedda)', 'Male': 'Microsoft Server Speech Text to Speech Voice (de-DE, Stefan, Apollo)'}, 
           'en-AU': {'Female': 'Microsoft Server Speech Text to Speech Voice (en-AU, Catherine)'}, 'en-CA': {'Female': 'Microsoft Server Speech Text to Speech Voice (en-CA, Linda)'}, 'en-GB': {'Female': 'Microsoft Server Speech Text to Speech Voice (en-GB, Susan, Apollo)', 'Male': 'Microsoft Server Speech Text to Speech Voice (en-GB, George, Apollo)'}, 
           'en-IN': {'Male': 'Microsoft Server Speech Text to Speech Voice (en-IN, Ravi, Apollo)'}, 'en-US': {'Female': 'Microsoft Server Speech Text to Speech Voice (en-US, ZiraRUS)', 'Male': 'Microsoft Server Speech Text to Speech Voice (en-US, BenjaminRUS)'}, 
           ...
           'es-MX': {'Male': 'Microsoft Server Speech Text to Speech Voice (es-MX, Raul, Apollo)'}, 'fr-CA': {'Female': 'Microsoft Server Speech Text to Speech Voice (fr-CA, Caroline)'}, 'fr-FR': {'Female': 'Microsoft Server Speech Text to Speech Voice (fr-FR, Julie, Apollo)', 'Male': 'Microsoft Server Speech Text to Speech Voice (fr-FR, Paul, Apollo)'}, 
           'it-IT': {'Male': 'Microsoft Server Speech Text to Speech Voice (it-IT, Cosimo, Apollo)'}, 'ja-JP': {'Female': 'Microsoft Server Speech Text to Speech Voice (ja-JP, Ayumi, Apollo)', 'Male': 'Microsoft Server Speech Text to Speech Voice (ja-JP, Ichiro, Apollo)'}, 
           'pt-BR': {'Male': 'Microsoft Server Speech Text to Speech Voice (pt-BR, Daniel, Apollo)'}, 'ru-RU': {'Female': 'Microsoft Server Speech Text to Speech Voice (pt-BR, Daniel, Apollo)', 'Male': 'Microsoft Server Speech Text to Speech Voice (ru-RU, Pavel, Apollo)'}, 
           'zh-CN': {'Female': 'Microsoft Server Speech Text to Speech Voice (zh-CN, HuihuiRUS)', 'Female2': 'Microsoft Server Speech Text to Speech Voice (zh-CN, Yaoyao, Apollo)', 
    ...
    def synthesize(self, text, language='en-US', gender='Female', stream=None, chunk_size=4096):
        ...
        body = "<speak version='1.0' xml:lang='en-us'>                <voice xml:lang='%s' xml:gender='%s' name='%s'>%s</voice>                </speak>" % (language, gender, service_name, text)
