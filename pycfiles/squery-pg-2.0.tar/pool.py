...
# [GCC 8.4.0]
# Embedded file name: /home/manish/projects/outernet/squery-pg/squery_pg/pool.py
# Compiled at: 2016-06-06 07:50:55
"""
    ...
    def connection(self, isolation_level=None):
        ...
        try:
            try:
                ...
                if conn.closed:
                    raise OperationalError('Cannot commit because connection was closed: %r' % (
                     conn,))
                conn.commit()
