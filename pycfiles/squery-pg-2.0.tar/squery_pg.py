...
# [GCC 8.4.0]
# Embedded file name: /home/manish/projects/outernet/squery-pg/squery_pg/squery_pg.py
# Compiled at: 2016-06-06 08:29:25
"""
...
import inspect, functools, re, psycopg2
from psycopg2.extras import DictCursor
from sqlize_pg import From, Where, Group, Order, Limit, Select, Update, Delete, Insert, Replace, sqlin, sqlarray
...
class Database(object):
    ...
    def command(host, port, dbname, user, password, maxsize, sql):
        pool = PostgresConnectionPool(host=host, port=port, dbname='postgres', user=user, password=password, maxsize=maxsize)
    ...
    @classmethod
    def connect(cls, host, port, database, user, password, maxsize=DEFAULT_MAX_POOL_SIZE, debug=False):
        kwargs = dict(host=host, port=port, dbname=database, user=user, password=password, maxsize=maxsize, cursor_factory=DictCursor)
