...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/PyTujian/Http.py
# Compiled at: 2020-05-01 03:36:35
# Size of source mod 2**32: 2816 bytes
from urllib import request
from urllib.request import urlretrieve
from urllib import error
from urllib import parse
import time, imghdr, mimetypes
from . import print2
import json, sys
...
def progress(done, size, total):
    ...
    if now - start > 1:
        ...
        return
        if total < 0:
            print2.print2.message('->%s \r' % format_byte(down))
    else:
