...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/clitellum_evs/repository.py
# Compiled at: 2018-02-15 09:55:55
import pymongo
...
class EvsRepository(object):
    ...
    def get_events(self, entity_id):
        ...
        """
        return self._events_col.find({'entity_id': entity_id}).sort('version', pymongo.ASCENDING)
    ...
    def save_entity(self, entity_id, entity, state, version):
        ...
        self._entity_col.update({'_id': entity_id}, entity_db, upsert=True)