...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/qtalchemy/PBSearchDialog.py
...
"""
import sqlalchemy, sqlalchemy.sql.expression as expr
...
class PBSearchDialog(PBSearchableListDialog):
    ...
    def __init__(self, ssrc, entityCls, parent=None):
        ...
        self.table.setModel(QueryTableModel(self.base_query, ssrc=ssrc, objectConverter=converter), extensionId=suffixExtId(self, 'Table'))
...
class PBTableTab(QtGui.QWidget):
    ...
    def __init__(self, parent, ssrc, entityCls, filters=None, query=None, extensionId=None, objectConverter=None):
        ...
        self.table.setModel(QueryTableModel(self.query, ssrc=ssrc, objectConverter=self.objectConverter), extensionId=suffixExtId(self, 'Table'))
        self.bindings = self.entity.itemCommands.withView(self.table, bindDefault=True)
        self.bindings.fillToolbar(self.toolbar)
