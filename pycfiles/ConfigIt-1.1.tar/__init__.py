...
# Compiled at: 2020-04-18 20:58:21
...
class Field(object):
    ...
    def set_value(self, value):
        raise DerivableSetValueError('Derivable.set_value() method should never bee called')
...
class BaseConfigClass(object):
    ...
    def to_dict(self, check_dont_dump=True, check_printable=False, ignore_na=False, prefix=''):
        ...
        for attr, value in self._declared_fields.items():
            key = prefix + attr
            try:
                dct[key] = value.get_value(check_dont_dump=check_dont_dump, check_printable=check_printable)
    ...
    def to_json(self, check_dont_dump=True, check_printable=False, ignore_na=False, prefix=''):
        ...
        :rtype: str
        """
        return json.dumps(self.to_dict(check_dont_dump=check_dont_dump, check_printable=check_printable, ignore_na=ignore_na, prefix=prefix), indent=4, sort_keys=False)
...
parser.add_subparsers('read-json-value')
