...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/fabazon/elb.py
...
class BaseLoadBalancer(object):
    ...
    def wait_until_instance_healthy(self, instance):
        ...
        print red(b'Instance %s was not healthy after 60 seconds')
        return False
    ...
    def wait_until_instance_removed(self, instance):
        ...
        print red(b'Instance %s was still registered after 60 seconds')
        return False
...
class LoadBalancer(BaseLoadBalancer):
    ...
    def is_instance_registered(self, instance):
        ...
        return health_info.description == b'Instance is not currently registered with the LoadBalancer.'
    ...
    def is_instance_healthy(self, instance):
        ...
        """
        health_info = self._get_instance_health_info(instance)
        return health_info.state == b'InService'
...
class LoadBalancerV2(BaseLoadBalancer):
    ...
    def __init__(self, target_group_arn, region):
        ...
        self._cnx = boto3.client(b'elbv2', region_name=region)
    ...
    def register_instance(self, instance):
        ...
        Args:
            instance (fabazon.ec2.EC2Instance):
                The instance to register.
        """
        self._cnx.register_targets(TargetGroupArn=self.target_group_arn, Targets=[
         {b'Id': instance.id}])
    ...
    def unregister_instance(self, instance):
        ...
        Args:
            instance (fabazon.ec2.EC2Instance):
                The instance to unregister.
        """
        self._cnx.deregister_targets(TargetGroupArn=self.target_group_arn, Targets=[
         {b'Id': instance.id}])
    ...
    def is_instance_registered(self, instance):
        ...
        """
        health_info = self._get_instance_health_info(instance)
        return health_info.get(b'Reason') != b'Target.NotRegistered'
    ...
    def is_instance_healthy(self, instance):
        ...
        """
        health_info = self._get_instance_health_info(instance)
        return health_info[b'State'] == b'healthy'
    ...
    def _get_instance_health_info(self, instance):
        ...
        Returns:
            ...
            Information on the instance's health.
        """
        rsp = self._cnx.describe_target_health(TargetGroupArn=self.target_group_arn, Targets=[
         {b'Id': instance.id}])
        health_info = rsp[b'TargetHealthDescriptions']
        assert len(health_info) == 1
        assert health_info[0][b'Target'][b'Id'] == instance.id
        return health_info[0][b'TargetHealth']