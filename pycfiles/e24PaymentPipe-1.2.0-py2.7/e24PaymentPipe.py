...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/e24PaymentPipe/e24PaymentPipe.py
# Compiled at: 2015-12-29 16:11:31
from __future__ import with_statement, print_function, absolute_import
import zipfile, os, datetime, io, xml.etree.cElementTree as et, requests
...
class Gateway(object):
    ...
    def _parse(self):
        ...
        if self.alias in temp.namelist():
            ...
            raise ValueError(('Invalid alias {0} for resource file {1}, {2}').format(self.alias, os.path.basename(self.resource_file), temp.namelist()))
        try:
