...
# Embedded file name: build\bdist.win-amd64\egg\arcadeplus\examples\shapes_buffered_2.py
# Compiled at: 2020-03-29 18:07:59
...
class MyGame(arcadeplus.Window):
    ...
    def __init__(self, width, height, title):
        ...
        for i in range(5):
            ...
            y = SCREEN_HEIGHT // 2 - random.randrange(SCREEN_HEIGHT - 50)
            points = [(px + x, py + y) for px, py in point_list]
            triangle_filled = arcadeplus.create_triangles_filled_with_colors(points, random.sample(colors, 3))
        ...
        for i in range(5):
            ...
            y = SCREEN_HEIGHT // 2 - random.randrange(SCREEN_HEIGHT - 50)
            points = [(px + x, py + y) for px, py in point_list]
            rect_filled = arcadeplus.create_rectangle_filled_with_colors(points, random.sample(colors, 4))
            self.shape_list.append(rect_filled)

        point_list = ((100, 100), (50, 150), (100, 200), (200, 200), (250, 150), (200, 100))
