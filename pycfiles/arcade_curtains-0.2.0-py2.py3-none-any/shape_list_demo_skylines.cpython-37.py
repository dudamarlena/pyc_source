...
# Embedded file name: build\bdist.win-amd64\egg\arcadeplus\examples\shape_list_demo_skylines.py
# Compiled at: 2020-03-29 18:07:47
# Size of source mod 2**32: 6191 bytes
__doc__ = '\nCity Scape Generator\n\nIf Python and arcadeplus are installed, this example can be run from the command line with:\npython -m arcadeplus.examples.shape_list_skylines\n'
import random, arcadeplus, time
SCREEN_WIDTH = 1200
SCREEN_HEIGHT = 600
...
def make_skyline(width, skyline_height, skyline_color, gap_chance=0.7, window_chance=0.3, light_on_chance=0.5, window_color=(255, 255, 200), window_margin=3, window_gap=2, cap_chance=0.2):
    """ Make a skyline """
    shape_list = arcadeplus.ShapeElementList()
