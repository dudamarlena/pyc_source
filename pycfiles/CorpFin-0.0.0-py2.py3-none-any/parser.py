...
# Embedded file name: /home/chris/workspace/corpcrawl_env/corpcrawl/corpcrawl/parser.py
# Compiled at: 2013-03-14 02:28:42
...
class Parser(object):
 ...
 2012], quarters=[1]):
    ...
    def company_found(self, text):
        return re.search(EXHIBIT21_WORDS, text, re.IGNORECASE) == None and not re.search('SUBSIDIARIES', text) and not re.search('&#160', text) and len(text) > 3
