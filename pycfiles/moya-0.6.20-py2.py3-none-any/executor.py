...
# [GCC 8.4.0]
# Embedded file name: /Users/will/projects/moya/moya/executor.py
# Compiled at: 2017-01-15 13:36:52
...
class Executor(object):
    ...
    def _create_worker(self, index):
        name = (b'ExecutorThread-{}').format(index)
...
class ExecutorWorkerThread(Thread):
    ...
    def __init__(self, executor, name):
        super(ExecutorWorkerThread, self).__init__(name=name, target=self.execute_loop, args=(
         executor,))
