...
# [GCC 8.4.0]
# Embedded file name: /Users/will/projects/moya/moya/cache/dictcache.py
...
class DictCache(Cache):
    ...
    cache_backend_name = b'dict'

    def __init__(self, name, namespace, compress=False, compress_min=1024):
        super(DictCache, self).__init__(name, namespace, compress=compress, compress_min=compress_min)
        self.values = {}
