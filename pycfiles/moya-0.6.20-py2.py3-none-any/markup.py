...
# [GCC 8.4.0]
# Embedded file name: /Users/will/projects/moya/moya/tags/markup.py
# Compiled at: 2017-06-21 17:23:32
...
class ProcessMarkup(DataSetter):
    ...
    def logic(self, context):
        ...
        if not isinstance(source_text, text_type):
            self.throw('bad-value.unsupported-type', ("the 'src' parameter should be a a string (not {})").format(context.to_expr(source_text)))
