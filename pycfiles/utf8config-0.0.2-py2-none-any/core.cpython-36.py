...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/utf8config-project/utf8config/core.py
# Compiled at: 2017-10-14 19:53:13
# Size of source mod 2**32: 8622 bytes
...
class Field(object):
    ...
    def dump(self):
        ...
        if self.upper_comment:
            lines.append('\n'.join(['# ' + l.strip() for l in self.upper_comment.split('\n')]))
        else:
