...
# Embedded file name: /usr/local/lib/python3.6/dist-packages/configfiles/__main__.py
# Compiled at: 2018-11-06 09:11:50
...
def cli(passw, user, interactive, local):
    ...
    global password
    global username
    password, username, no_interactive, local_dir = (
     passw, user, not interactive, local)
