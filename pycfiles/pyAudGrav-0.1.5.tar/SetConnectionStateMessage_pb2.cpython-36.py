...
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/mrp/protobuf/SetConnectionStateMessage_pb2.py
...
DESCRIPTOR = _descriptor.FileDescriptor(name='pyatv/mrp/protobuf/SetConnectionStateMessage.proto',
  package='',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=(_b('\n2pyatv/mrp/protobuf/SetConnectionStateMessage.proto\x1a(pyatv/mrp/protobuf/ProtocolMessage.proto"x\n\x19SetConnectionStateMessage\x129\n\x05state\x18\x01 \x01(\x0e2*.SetConnectionStateMessage.ConnectionState" \n\x0fConnectionState\x12\r\n\tConnected\x10\x02:O\n\x19setConnectionStateMessage\x12\x10.ProtocolMessage\x18* \x01(\x0b2\x1a.SetConnectionStateMessage')),
  dependencies=[
 pyatv_dot_mrp_dot_protobuf_dot_ProtocolMessage__pb2.DESCRIPTOR])
SETCONNECTIONSTATEMESSAGE_FIELD_NUMBER = 42
setConnectionStateMessage = _descriptor.FieldDescriptor(name='setConnectionStateMessage',
  ...
  serialized_options=None,
  file=DESCRIPTOR)
_SETCONNECTIONSTATEMESSAGE_CONNECTIONSTATE = _descriptor.EnumDescriptor(name='ConnectionState',
  full_name='SetConnectionStateMessage.ConnectionState',
  filename=None,
  file=DESCRIPTOR,
  values=[
 _descriptor.EnumValueDescriptor(name='Connected',
   index=0,
   number=2,
   serialized_options=None,
   type=None)],
...
_SETCONNECTIONSTATEMESSAGE = _descriptor.Descriptor(name='SetConnectionStateMessage',
  full_name='SetConnectionStateMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
 ...
 _descriptor.FieldDescriptor(name='state',
   full_name='SetConnectionStateMessage.state',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
...
SetConnectionStateMessage = _reflection.GeneratedProtocolMessageType('SetConnectionStateMessage', (_message.Message,), {'DESCRIPTOR':_SETCONNECTIONSTATEMESSAGE, 
