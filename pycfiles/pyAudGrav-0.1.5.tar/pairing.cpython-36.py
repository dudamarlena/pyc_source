...
__doc__ = 'Device pairing and derivation of encryption keys.'
import logging
...
class MrpPairingProcedure:
    ...
    async def start_pairing(self):
        ...
        self.srp.initialize()
        msg = messages.crypto_pairing({tlv8.TLV_METHOD: '\x00', 
         tlv8.TLV_SEQ_NO: '\x01'},
          is_pairing=True)
    ...
    async def finish_pairing(self, pin):
        ...
        msg = messages.crypto_pairing({tlv8.TLV_SEQ_NO: '\x03', 
        ...
        msg = messages.crypto_pairing({tlv8.TLV_SEQ_NO: '\x05', 
...
class MrpPairingVerifier:
    ...
    async def verify_credentials(self):
        ...
        msg = messages.crypto_pairing({tlv8.TLV_SEQ_NO: '\x01', 
