...
# Embedded file name: /home/postlund/pyatv_dev/pyatv/pyatv/dmap/tag_definitions.py
# Compiled at: 2019-09-26 00:19:20
# Size of source mod 2**32: 5171 bytes
__doc__ = 'Definitions of DMAP tags used by various applications.'
import logging
from .parser import DmapTag
from .tags import read_bool, read_uint, read_str, read_ignore, read_bplist
...
_TAGS = {'aeFP':DmapTag(read_uint, 'com.apple.itunes.req-fplay'), 
...
def lookup_tag(name):
    ...
    return next((_TAGS[t] for t in _TAGS if t == name), DmapTag(_read_unknown, 'unknown tag'))