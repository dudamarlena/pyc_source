...
# Compiled at: 2020-05-08 04:35:13
# Size of source mod 2**32: 65926 bytes
"""
...
def downDoadData(symbolist, sDateTime, eDateTim, filename, fre='60s', fields_='symbol,eob,open,high,low,close', adjust=1, adjust_end_time=''):
    import os
    if fre == 'tick':
        dateName = 'created_at'
    else:
...
def cancelOrder(symbol_, side, positionEffect):
    ...
    for aOrder in waitOrderS:
        orderDict = {}
        if aOrder.symbol == symbol_ and aOrder.side == side and aOrder.position_effect == positionEffect:
