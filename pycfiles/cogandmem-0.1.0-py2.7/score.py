...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/cogandmem/score.py
# Compiled at: 2018-06-23 15:27:15
"""
...
def free_recall(targets, responses):
    ...
    recall_dict = {OVERALL: copy.deepcopy(template), 
       CLOSE_MATCHES: {}, INTRUSIONS: [], ITEMS_RECALLED: []}
    targets_as_strings = []
    try:
            ...
            if len(conditions) == 1:
                ...
                for current_condition in conditions:
                    try:
                        ...
                        recall_dict[str(current_condition)] = copy.deepcopy(template)
