...
# [GCC 8.4.0]
# Embedded file name: /home/scfcli/release/tcfcli/tcfcli/cmds/native/common/invoke_context.py
# Compiled at: 2019-06-04 04:47:06
# Size of source mod 2**32: 4897 bytes
import json, sys, os, click, subprocess, threading
...
class InvokeContext(object):
    ...
    def __init__(self, template_file, function=None, namespace=None, env_file=None, debug_port=None, debug_args='', event='{}'):
