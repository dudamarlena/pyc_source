...
# [GCC 8.4.0]
# Embedded file name: /home/scfcli/release/tcfcli/tcfcli/cmds/native/common/debug_context.py
    ...
    def argv(self):
        if self.debug_port is None:
            ...
            if self.runtime == MacroRuntime.node610:
                ...
                if self.runtime == MacroRuntime.node89:
                    argv += self.debug_arg_node89
                else:
                    if self.runtime == MacroRuntime.python36:
                        argv += self.debug_arg_python36
                    else:
                        if self.runtime == MacroRuntime.python27:
