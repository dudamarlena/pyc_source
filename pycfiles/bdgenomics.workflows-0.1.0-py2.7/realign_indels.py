...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/bdgenomics/workflows/benchmarking/single_node/realign_indels.py
# Compiled at: 2017-09-18 01:42:06
import argparse, logging, os
from toil.job import Job
from bdgenomics.workflows.tools.preprocessing import run_indel_realignment, run_picard_create_sequence_dictionary, run_realigner_target_creator, run_sambamba_sort, run_samtools_faidx, run_samtools_index
...
def run_gatk3_ir(job, reads_id, bam_index, ref_id, faidx, ref_dict, g1k, mills):
    intervals = run_realigner_target_creator(job, reads_id, bam_index, ref_id, ref_dict, faidx, g1k, mills)
    run_indel_realignment(job, intervals, reads_id, bam_index, ref_id, ref_dict, faidx, g1k, mills)
...
def benchmark_realigners(job, sample, ref, g1k, mills):
    ...
    run_gatk3_ir(job, reads_id, bam_index, ref_id, faidx, ref_dict, g1k_id, mills_id)
...
def main():
    ...
    Job.Runner.startToil(Job.wrapJobFn(benchmark_realigners, args.sample, args.ref, args.g1k, args.mills), args)
