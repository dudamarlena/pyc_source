...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/chaturanga/chessboard.py
# Compiled at: 2018-07-29 03:00:42
__doc__ = 'Chessboard class'
...
class Chessboard:
    ...
    ENPASSANT_MAP = {'a': (2, 0), 'b': (2, 1), 'c': (2, 2), 'd': (2, 3), 
       'e': (2, 4), 'f': (2, 5), 'g': (2, 6), 
       'h': (2, 7), '-': None}
    PRETTY_SYMBOLS = {'K': '♔', 'Q': '♕', 'R': '♖', 'B': '♗', 
       'N': '♘', 'P': '♙', 'k': '♚', 
       'q': '♛', 'r': '♜', 'b': '♝', 
       'n': '♞', 'p': '♟'}
