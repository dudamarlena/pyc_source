...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/chaturanga/moves.py
# Compiled at: 2018-07-24 08:09:39
__doc__ = 'Helper file for move generation'
...
def get_moves(board, castling_availability, enpassant_square):
    ...
    for start, piece in board.items():
        ...
        if piece == 'K':
            ...
            moves.extend(get_king_finish(board, start, king_moves, castling_availability))
