...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyogp/lib/base/message/tests/test_template_parser.py
...
class TestTemplates(unittest.TestCase):
    ...
    def test_blacklisted(self):
        ...
        self.assertEquals(template.get_deprecation_as_string(), 'UDPBlackListed')
