...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/easyexplore/anomaly_detector.py
# Compiled at: 2020-05-04 15:36:34
...
ANOMALY_METH: dict = dict(abod='angle_based_outlier_detection', cblof='cluster_based_local_outlier_factor',
...
DETECTOR_TYPES = dict(linear=['lmdd', 'mcd', 'pca', 'ocsvm'], prox=[
 'cblof', 'cof', 'hbos', 'loci', 'lof', 'knn', 'sod'],
  prob=[
 'abod', 'sos'],
  ensamble=[
 'ftbag', 'iforest', 'lscp', 'xgbod'],
  neural=[
 'autoencoder', 'mo_gaal', 'so_gaal'])
DETECTOR_TYPES: Dict[(str, List[str])]
...
class AnomalyDetector:
    ...
    def __init__(self, df: pd.DataFrame, features: List[str]=None, meth: List[str]=None, params: dict=None, outlier_threshold: float=0.15, detector_type: Dict[(str, List[str])]=None, seed: int=1234):
        """
        Parameters
        ----------
        df: pd.DataFrame
        ...
        self.cases = []
        self.outlier_threshold = outlier_threshold if outlier_threshold > 0 else 0.15
        self.params = params
        self.meth = []
    ...
    def angle_based_outlier_detection(self) -> ABOD:
        ...
        ABOD:
        """
        return ABOD(contamination=(self.outlier_threshold), n_neighbors=5,
          method='fast')
    ...
    def cluster_based_local_outlier_factor(self) -> CBLOF:
        ...
        CBLOF:
        """
        return CBLOF(n_clusters=8, contamination=(self.outlier_threshold),
    ...
    def connectivity_based_outlier_fraction(self) -> COF:
        ...
        COF:
        """
        return COF(contamination=(self.outlier_threshold), n_neighbors=20)
    ...
    def deviation_based_outlier_detection(self) -> LMDD:
        ...
        LMDD:
        """
        return LMDD(contamination=(self.outlier_threshold), n_iter=50,
          dis_measure='aad',
          random_state=(self.seed))
    ...
    def feature_bagging(self) -> FeatureBagging:
        ...
        FeatureBagging:
        """
        return FeatureBagging(base_estimator=None, n_estimators=10,
    ...
    def histogram_based_outlier_detection(self) -> HBOS:
        ...
        HBOS:
        """
        return HBOS(n_bins=10, alpha=0.1,
          tol=0.5,
          contamination=(self.outlier_threshold))
    ...
    def isolation_forest(self) -> IForest:
        ...
        IForest:
        """
        return IForest(n_estimators=100, max_samples='auto',
          contamination=(self.outlier_threshold),
          max_features=1.0,
          bootstrap=False,
          n_jobs=1,
    ...
    def k_nearest_neighbor(self) -> KNN:
        ...
        KNN:
        """
        return KNN(contamination=(self.outlier_threshold), n_neighbors=5,
          method='largest',
          radius=1.0,
          algorithm='auto',
          leaf_size=30,
    ...
    def local_correlated_integral(self) -> LOCI:
        ...
        LOCI:
        """
        return LOCI(contamination=(self.outlier_threshold), alpha=0.5,
          k=3)
    ...
    def local_outlier_fraction(self) -> LOF:
        ...
        LOF:
        """
        return LOF(n_neighbors=20, algorithm='auto',
          leaf_size=30,
          metric='minkowski',
          p=2,
          metric_params=None,
    ...
    def locally_selective_combination_of_parallel_outlier_ensambles(self) -> LSCP:
        ...
        LSCP:
        """
        return LSCP(detector_list=None, local_region_size=30,
    ...
    def minimum_covariance_determinant(self) -> MCD:
        ...
        MCD:
        """
        return MCD(contamination=(self.outlier_threshold), store_precision=True,
    ...
    def one_class_support_vector_machine(self) -> OCSVM:
        ...
        OCSVM:
        """
        return OCSVM(kernel='rbf', degree=3,
          gamma='auto',
          coef0=0.0,
          tol=0.001,
          nu=0.5,
    ...
    def principal_component_analysis(self) -> PCA:
        ...
        PCA:
        """
        return PCA(n_components=None, n_selected_components=None,
          contamination=(self.outlier_threshold),
          copy=True,
          whiten=False,
          svd_solver='auto',
    ...
    def subspace_outlier_detection(self) -> SOD:
        ...
        SOD:
        """
        return SOD(contamination=(self.outlier_threshold), n_neighbors=20,
          ref_set=10,
          alpha=0.8)
    ...
    def stochastic_outlier_selection(self) -> SOS:
        ...
        SOS:
        """
        return SOS(contamination=(self.outlier_threshold), perplexity=4.5,
          metric='euclidean',
          eps=1e-05)
