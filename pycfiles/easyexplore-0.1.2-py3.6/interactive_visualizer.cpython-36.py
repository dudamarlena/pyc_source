...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/easyexplore/interactive_visualizer.py
# Compiled at: 2020-05-10 16:19:35
# Size of source mod 2**32: 116453 bytes
import json, plotly.figure_factory as ff, plotly.graph_objs as go
...
class PlotlyAdapter:
    ...
    def __init__(self, plot: dict, offline: bool=True, fig: go.Figure=None, title: str=None, width: int=500, height: int=500, **kwargs):
        """
        ...
        self.fig = fig
        self.width = width if width >= 50 else 500
        self.height = height if height >= 50 else 500
    ...
    def bar(self) -> go.Bar:
        ...
        """
        return go.Bar(alignmentgroup=(self.plot['kwargs'].get('alignmentgroup')), base=(self.plot['kwargs'].get('base')),
    ...
    def barpolar(self) -> go.Barpolar:
        ...
        """
        return go.Barpolar(base=(self.plot['kwargs'].get('base')), basesrc=(self.plot['kwargs'].get('basesrc')),
    ...
    def box_whisker(self) -> go.Box:
        ...
        """
        return go.Box(alignmentgroup=(self.plot['kwargs'].get('alignmentgroup')), boxmean=(self.plot['kwargs'].get('boxmean')),
    ...
    def candlestick(self) -> go.Candlestick:
        ...
        """
        return go.Candlestick(arg=(self.plot['kwargs'].get('arg')), close=(self.plot['kwargs'].get('close')),
    ...
    def choroplethmapbox(self) -> go.Choroplethmapbox:
        ...
        """
        return go.Choroplethmapbox(autocolorscale=(self.plot['kwargs'].get('autocolorscale')), below=(self.plot['kwargs'].get('below')),
    ...
    def contour(self) -> go.Contour:
        ...
        """
        return go.Contour(autocolorscale=(self.plot['kwargs'].get('autocolorscale')), autocontour=(self.plot['kwargs'].get('autocontour')),
          coloraxis=(self.plot['kwargs'].get('coloraxis')),
          colorbar=(self.plot['kwargs'].get('colorbar')),
          colorscale=(self.plot['kwargs'].get('colorscale')),
    ...
    def dendrogram(self) -> ff:
        ...
        """
        return ff.create_dendrogram(X=(self.plot['kwargs'].get('X')), orientation=(self.plot['kwargs'].get('orientation')),
    ...
    def densitymapbox(self) -> go.Densitymapbox:
        ...
        """
        return go.Densitymapbox(autocolorscale=(self.plot['kwargs'].get('autocolorscale')), below=(self.plot['kwargs'].get('below')),
          coloraxis=(self.plot['kwargs'].get('coloraxis')),
          colorbar=(self.plot['kwargs'].get('colorbar')),
          colorscale=(self.plot['kwargs'].get('colorscale')),
          customdata=(self.plot['kwargs'].get('customdata')),
    ...
    def distplot(self) -> ff:
        ...
        """
        return ff.create_distplot(hist_data=(self.plot['kwargs'].get('hist_data')), group_labels=(self.plot['kwargs'].get('group_labels')),
    ...
    def funnel(self) -> go.Funnel:
        ...
        """
        return go.Funnel(alignmentgroup=(self.plot['kwargs'].get('alignmentgroup')), cliponaxis=(self.plot['kwargs'].get('cliponaxis')),
    ...
    def funnel_area(self) -> go.Funnel:
        ...
        """
        return go.Funnelarea(aspectratio=(self.plot['kwargs'].get('aspectratio')), baseratio=(self.plot['kwargs'].get('baseratio')),
          customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
    ...
    def generate_subplots(self, subplot_titles: List[str], rows: int, cols: int) -> go.Figure:
        ...
        """
        _specs = []
        _subplot_titles = subplot_titles
        _rowspan = 1 if self.plot['kwargs'].get('rowspan') is None else self.plot['kwargs'].get('rowspan')
        _colspan = 1 if self.plot['kwargs'].get('colspan') is None else self.plot['kwargs'].get('colspan')
        ...
        _vertical_spacing = 1.0 / rows
        _horizontal_spacing = 1.0 / cols
        _fig = make_subplots(rows=rows, cols=cols,
    ...
    def heat_map(self) -> go.Heatmap:
        ...
        """
        return go.Heatmap(autocolorscale=(self.plot['kwargs'].get('autocolorscale')), coloraxis=(self.plot['kwargs'].get('coloraxis')),
          colorscale=(self.plot['kwargs'].get('colorscale')),
          connectgaps=(self.plot['kwargs'].get('connectgaps')),
          dx=(self.plot['kwargs'].get('dx')),
          dy=(self.plot['kwargs'].get('dy')),
    ...
    def heat_map_annotated(self) -> ff:
        ...
        """
        return ff.create_annotated_heatmap(z=(self.plot['kwargs'].get('z')), x=(self.plot['kwargs'].get('x')),
          y=(self.plot['kwargs'].get('y')),
    ...
    def histo(self) -> go.Histogram:
        ...
        """
        return go.Histogram(alignmentgroup=(self.plot['kwargs'].get('alignmentgroup')), autobinx=(self.plot['kwargs'].get('autobinx')),
    ...
    def histogram_2d_contour(self) -> go.Histogram2dContour:
        ...
        """
        return go.Histogram2dContour(autobinx=(self.plot['kwargs'].get('autobinx')), autobiny=(self.plot['kwargs'].get('autobiny')),
    ...
    def line(self) -> go.Scatter:
        ...
        """
        return go.Scatter(cliponaxis=(self.plot['kwargs'].get('cliponaxis')), connectgaps=(self.plot['kwargs'].get('connectgaps')),
          dx=(self.plot['kwargs'].get('dx')),
          dy=(self.plot['kwargs'].get('dy')),
    ...
    def load(self):
        ...
        """
        _fig = DataImporter(file_path=(self.file_path), as_data_frame=False).file()
        if _fig.get('data') is None:
            raise PlotlyAdapterExceptions('JSON file does not contain data for plotly figure')
        iplot(figure_or_data=go.FigureWidget(data=(_fig.get('data')), layout=(_fig.get('layout'))), show_link=(False if self.plot['kwargs'].get('show_link') is None else self.plot['kwargs'].get('show_link')),
    ...
    def parallel_category(self) -> go.Parcats:
        ...
        """
        return go.Parcats(arrangement=(self.plot['kwargs'].get('arrangement')), bundlecolors=(self.plot['kwargs'].get('bundlecolors')),
    ...
    def parallel_coordinates(self) -> go.Parcoords:
        ...
        """
        return go.Parcoords(customdata=(self.plot['kwargs'].get('customdata')), customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
          dimensiondefaults=(self.plot['kwargs'].get('dimensiondefaults')),
          dimensions=(self.plot['kwargs'].get('dimensions')),
          domain=(self.plot['kwargs'].get('domain')),
          ids=(self.plot['kwargs'].get('ids')),
    ...
    def pie(self) -> go.Pie:
        ...
        """
        return go.Pie(automargin=(self.plot['kwargs'].get('automargin')), customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
    ...
    def ridgeline(self) -> go.Violin:
        ...
        """
        return go.Violin(box_visible=(self.plot['kwargs'].get('box_visible')), legendgroup=(self.plot['kwargs'].get('legendgroup')),
    ...
    def render(self):
        ...
        """
        iplot(figure_or_data=(go.FigureWidget(self.fig)), show_link=(False if self.plot['kwargs'].get('show_link') is None else self.plot['kwargs'].get('show_link')),
          link_text=('Export to plot.ly' if self.plot['kwargs'].get('link_text') is None else self.plot['kwargs'].get('link_text')),
          validate=(True if self.plot['kwargs'].get('validate') is None else self.plot['kwargs'].get('validate')),
          image=(self.plot['kwargs'].get('image')),
          filename=None,
    ...
    def save(self):
        ...
        if self.plot.get('file_path').split('.')[(-1)] is 'json':
            ...
            if self.plot.get('file_path').split('.')[(-1)] in ('html', 'png'):
                plot(figure_or_data=(go.FigureWidget(self.fig)), show_link=(False if self.plot['kwargs'].get('show_link') is None else self.plot['kwargs'].get('show_link')),
                  link_text=('Export to plot.ly' if self.plot['kwargs'].get('link_text') is None else self.plot['kwargs'].get('link_text')),
                  validate=(True if self.plot['kwargs'].get('validate') is None else self.plot['kwargs'].get('validate')),
                  image=(self.plot['kwargs'].get('image')),
    ...
    def scatterpolar(self) -> go.Scatterpolar:
        ...
        """
        return go.Scatterpolar(cliponaxis=(self.plot['kwargs'].get('cliponaxis')), connectgaps=(self.plot['kwargs'].get('connectgaps')),
          customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
          dr=(self.plot['kwargs'].get('dr')),
          dtheta=(self.plot['kwargs'].get('dtheta')),
    ...
    def scatter3d(self) -> go.Scatter3d:
        ...
        """
        return go.Scatter3d(connectgaps=(self.plot['kwargs'].get('connectgaps')), error_x=(self.plot['kwargs'].get('error_x')),
          error_y=(self.plot['kwargs'].get('error_y')),
    ...
    def scatter_gl(self) -> go.Scattergl:
        ...
        """
        return go.Scattergl(connectgaps=(self.plot['kwargs'].get('connectgaps')), customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
          dx=(self.plot['kwargs'].get('dx')),
          dy=(self.plot['kwargs'].get('dy')),
          error_x=(self.plot['kwargs'].get('error_x')),
    ...
    def scatter_geo(self) -> go.Scattergeo:
        ...
        """
        return go.Scattergeo(connectgaps=(self.plot['kwargs'].get('connectgaps')), fill=(self.plot['kwargs'].get('fill')),
          fillcolor=(self.plot['kwargs'].get('fillcolor')),
          hoverinfo=(self.plot['kwargs'].get('hoverinfo')),
          hoverinfosrc=(self.plot['kwargs'].get('hoverinfosrc')),
          hoverlabel=(self.plot['kwargs'].get('hoverlabel')),
    ...
    def scatter_mapbox(self) -> go.Scattermapbox:
        ...
        """
        return go.Scattermapbox(below=(self.plot['kwargs'].get('below')), connectgaps=(self.plot['kwargs'].get('connectgaps')),
          customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
          fill=(self.plot['kwargs'].get('fill')),
          fillcolor=(self.plot['kwargs'].get('fillcolor')),
    ...
    def show_plotly_offline(self):
        ...
        """
        self.fig.update_layout(angularaxis=(self.plot['kwargs']['layout'].get('angularaxis')), annotations=(self.plot['kwargs']['layout'].get('annotations')),
    ...
    def sunburst(self) -> go.Sunburst:
        ...
        """
        return go.Sunburst(branchvalues=(self.plot['kwargs'].get('branchvalues')), count=(self.plot['kwargs'].get('count')),
          customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
          domain=(self.plot['kwargs'].get('domain')),
          hoverinfo=(self.plot['kwargs'].get('hoverinfo')),
    ...
    def table(self) -> go.Table:
        ...
        """
        return go.Table(cells=(self.plot['kwargs'].get('cells')), columnorder=(self.plot['kwargs'].get('columnorder')),
    ...
    def treemap(self) -> go.Treemap:
        ...
        """
        return go.Treemap(branchvalues=(self.plot['kwargs'].get('branchvalues')), count=(self.plot['kwargs'].get('count')),
          customdata=(self.plot['kwargs'].get('customdata')),
          customdatasrc=(self.plot['kwargs'].get('customdatasrc')),
          domain=(self.plot['kwargs'].get('domain')),
          hoverinfo=(self.plot['kwargs'].get('hoverinfo')),
    ...
    def violin(self) -> go.Violin:
        ...
        """
        return go.Violin(alignmentgroup=(self.plot['kwargs'].get('alignmentgroup')), bandwidth=(self.plot['kwargs'].get('bandwidth')),
    ...
    def _write_plotly_json(self):
        ...
        """
        _data = json.loads(json.dumps((self.fig.data), cls=PlotlyJSONEncoder))
        _layout = json.loads(json.dumps((self.fig.layout), cls=PlotlyJSONEncoder))
        DataExporter(obj=(json.dumps(dict(data=_data, layout=_layout))), file_path=(self.plot.get('file_path')),
          create_dir=True,
