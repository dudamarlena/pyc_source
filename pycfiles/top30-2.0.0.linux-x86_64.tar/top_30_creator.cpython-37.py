...
# [GCC 8.4.0]
# Embedded file name: /home/kyle/projects/top30/pyenv/lib/python3.7/site-packages/top30/top_30_creator.py
# Compiled at: 2019-04-09 15:05:42
...
class Top30Creator:
    ...
    def add_voice(self, voice_file, rundown):
        ...
        rundown = rundown.overlay((voice[:top30.SETTINGS.voice_start_overlap()]), position=(-top30.SETTINGS.voice_start_overlap()))
        return rundown.append((voice[top30.SETTINGS.voice_start_overlap():]), crossfade=500.0)
    ...
    def get_start(self, filename):
        ...
        return self.normalise(AudioSegment.from_file(filename, format=(top30.get_format(filename))))

    def add_end(self, filename, rundown):
        """ Adds the outro voice segment """
        outro = self.normalise(AudioSegment.from_file(filename, format=(top30.get_format(filename))))
