...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/volmdlr/mesh.py
...
class LinearElement:
    ...
    def __eq__(self, other_linear_element):
        if self.__class__ != other_linear_element.__class__:
            return False
        return self.points[0] == other_linear_element.points[0] and self.points[1] == other_linear_element.points[1] or self.points[0] == other_linear_element.points[1] and self.points[1] == other_linear_element.points[0]
