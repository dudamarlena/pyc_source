...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dockermap/map/runner/script.py
...
class ScriptMixin(object):
    ...
    def run_script(self, action, c_name, script_path=None, entrypoint=None, command_format=None, wait_timeout=None, container_script_dir='/tmp/script_run', timestamps=None, tail='all'):
        """
        ...
        created = (self.create_container)(action, c_name, entrypoint=entrypoint, command=command, volumes=volumes, **create_extra_kwargs)
        if not created:
