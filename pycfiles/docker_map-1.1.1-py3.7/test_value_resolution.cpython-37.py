...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_value_resolution.py
# Compiled at: 2019-10-19 14:38:08
# Size of source mod 2**32: 3859 bytes
...
class LazyValueResolutionTest(unittest.TestCase):
    ...
    def test_resolve_deep(self):
        res_data = {'a': lazy_once(LOOKUP_DICT.get, 'a'), 
         'b': CustomType('d', 'd2'), 
         'c': {'a':lazy_once(LOOKUP_DICT.get, 'a'), 
               'b':lazy_once(LOOKUP_DICT.get, 'b')}, 
