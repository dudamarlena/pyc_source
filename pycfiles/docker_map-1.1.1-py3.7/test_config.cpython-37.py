...
class TestConfig(unittest.TestCase):
    ...
    def test_merge_with_dict(self):
        ...
        self.assertEqual(cfg.create_options, {'mem_limit':'1g', 
         'cpu_shares':15})
        self.assertEqual(cfg.host_config, {'restart_policy': {'MaximumRetryCount':3, 
                            'Name':'always'}})
    ...
    def test_more_extended_config(self):
        ...
        self.assertEqual(cfg1.create_options, {'mem_limit':'2g', 
         'cpu_shares':10, 
         'entrypoint':'celery', 
         'command':'worker -A MyApp -Q queue1,queue2'})
        self.assertEqual(cfg1.host_config, {'restart_policy': {'MaximumRetryCount':0, 
                            'Name':'always'}})
        ...
        self.assertEqual(cfg2.create_options, {'mem_limit':'1g', 
         'cpu_shares':30, 
         'entrypoint':'celery', 
         'command':'worker -A MyApp -Q queue2'})
        self.assertEqual(cfg2.host_config, {'restart_policy': {'MaximumRetryCount':0, 
                            'Name':'always'}})
