...
# [GCC 8.4.0]
# Embedded file name: C:\symlinks\repos\boilerplate_dcc_pyside_widget\boilerplate_dcc_pyside_widget\lib\third_party\pysideuic\Compiler\qobjectcreator.py
...
class _CustomWidgetLoader(object):
    ...
    def _resolveBaseclass(self, baseClass):
        try:
            for x in range(0, 10):
                try:
                    return strict_getattr(QtGui, baseClass)
                except AttributeError:
                    pass
