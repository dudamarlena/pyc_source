...
# [GCC 8.4.0]
# Embedded file name: /tools/tmp/cmd2/thgcmd/ansi.py
...
ANSI_ESCAPE_RE = re.compile('\\x1b[^m]*m')
FG_COLORS = {'black':Fore.BLACK, 
 'red':Fore.RED, 
 'green':Fore.GREEN, 
 'yellow':Fore.YELLOW, 
 'blue':Fore.BLUE, 
...
def ansi_aware_write(fileobj: IO, msg: str) -> None:
    ...
    """
    if (allow_ansi.lower() == ANSI_NEVER.lower() or allow_ansi.lower()) == ANSI_TERMINAL.lower():
