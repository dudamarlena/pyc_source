...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/pathogenseq/files.py
# Compiled at: 2018-07-14 07:53:42
import sys, gzip, os.path, subprocess, csv
