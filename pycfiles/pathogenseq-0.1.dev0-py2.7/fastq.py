...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/pathogenseq/fastq.py
# Compiled at: 2018-07-14 18:51:53
...
class mapping:
    ...
    def __init__(self, prefix, ref_file, paired1=None, paired2=None, unpaired=None, threads=4, mapper='bwa', platform='Illumina'):
        ...
        if paired1 and filecheck(paired1):
            self.params['paired1'] = paired1
        if paired2 and filecheck(paired2):
            self.params['paired2'] = paired2
        if unpaired and filecheck(unpaired):
            self.params['unpaired'] = unpaired
        self.params['prefix'] = prefix
        self.params['threads'] = threads
