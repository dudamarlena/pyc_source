...
# [GCC 8.4.0]
# Embedded file name: D:\workspace\mine\python\haf-webmanager\hafweb\route\route_api.py
# Compiled at: 2019-05-11 01:49:53
...
def get_main_all_api() -> str:
    if request.method == 'POST':
        ...
        if date_time:
            request_data = test_name or json.loads(request.data)
