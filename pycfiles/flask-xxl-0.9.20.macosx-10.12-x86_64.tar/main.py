...
# [GCC 8.4.0]
# Embedded file name: /Users/kyle/flask-cms/venv/lib/python2.7/site-packages/flask_xxl/main.py
# Compiled at: 2017-04-06 18:26:54
"""
    main.py - where the magic happens
    ~~~~~~~~
    :license: BSD, see LICENSE for more details.
"""
import jinja2_highlight, sys, os
...
class AppFactory(object):
        ...
        for blueprint_path in self.app.config.get(bp_settings_path, []):
            ...
            for module in modules:
                if typename in module:
                    ...
                    for itm in dir(mod):
                        cls = getattr(mod, itm)
                        if self._is_public_attr(itm) and itm[0] == str(itm[0]).upper() and 'class' in str(cls) and 'view' in str(itm).lower():
    ...
    def _register_routes(self):
        ...
        elif self.app.config.get('VERBOSE', False):
            print 'skipped'
        return
