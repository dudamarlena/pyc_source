...
# [GCC 8.4.0]
# Embedded file name: /Users/kyle/flask-cms/venv/lib/python2.7/site-packages/flask_xxl/baseviews.py
# Compiled at: 2017-04-06 19:41:11
import os, json
...
class Flasher(object):
    ...
    def _set_classes(self, class_map):
        default_map = {'success': self.SUCCESS_CLASS, 
...
class PostViewAddon(object):
    ...
    def _process_post--- This code section failed: ---

 L.  59         0  LOAD_GLOBAL           0  'request'
                3  LOAD_ATTR             1  'mimetype'
                6  LOAD_CONST               'application/json'
                9  COMPARE_OP            2  ==
               12  POP_JUMP_IF_TRUE     72  'to 72'
               15  LOAD_GLOBAL           0  'request'
               18  LOAD_ATTR             2  'form'
               21  POP_JUMP_IF_TRUE     51  'to 51'
               24  LOAD_GLOBAL           0  'request'
               27  LOAD_ATTR             3  'data'
               30  JUMP_IF_FALSE_OR_POP    69  'to 69'
               33  LOAD_GLOBAL           4  'json'
               36  LOAD_ATTR             5  'loads'
               39  LOAD_GLOBAL           0  'request'
               42  LOAD_ATTR             3  'data'
               45  CALL_FUNCTION_1       1  None
             48_0  COME_FROM            30  '30'
               48  JUMP_ABSOLUTE        78  'to 78'
               51  LOAD_GLOBAL           6  'dict'
               54  LOAD_GLOBAL           0  'request'
               57  LOAD_ATTR             2  'form'
               60  LOAD_ATTR             7  'items'
               63  CALL_FUNCTION_0       0  None
               66  CALL_FUNCTION_1       1  None
               69  JUMP_FORWARD          6  'to 78'
               72  LOAD_GLOBAL           0  'request'
               75  LOAD_ATTR             4  'json'
             78_0  COME_FROM            69  '69'
               78  LOAD_FAST             0  'self'
               81  STORE_ATTR            8  'post_data'
...
class ModelAPIView(ModelView):
    ...
    def _default_view_routes(cls):
        ...
        _default_view_routes = {('/{}/list').format(name): ('{}-list').format(name), 
