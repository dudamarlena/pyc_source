...
# [GCC 8.4.0]
# Embedded file name: /home/mick/src/django-postal/src/postal/views.py
...
def address_inline(request, prefix='', country_code=None, template_name='postal/form.html'):
    ...
    return render_to_string(template_name, RequestContext(request, {'form': form, 
       'prefix': prefix}))


def changed_country(request):
    result = simplejson.dumps({'postal_address': address_inline(request)})
