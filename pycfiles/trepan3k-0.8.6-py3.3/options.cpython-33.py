...
# Compiled at: 2018-02-02 07:48:06
# Size of source mod 2**32: 13863 bytes
...
def process_options(debugger_name, pkg_version, sys_argv, option_list=None):
    ...
    optparser.add_option('--main', dest='main', action='store_true', default=True, help='First stop should be in __main__')
    optparser.add_option('--no-main', dest='main', action='store_false', default=True, help='First stop should be in __main__')
