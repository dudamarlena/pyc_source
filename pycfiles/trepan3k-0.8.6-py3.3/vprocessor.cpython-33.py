...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/trepan/vprocessor.py
...
class Processor:
    __doc__ = "A processor is the thing that handles the events that come to\n    the debugger.  It has it's own I/O mechanism and a way to handle\n    the events.\n    "
    ...
    def rst_msg(self, text, opts={}):
        ...
        text = rst_text(text, 'plain' == self.debugger.settings['highlight'], self.debugger.settings['width'])
