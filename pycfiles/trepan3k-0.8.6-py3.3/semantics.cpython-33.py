        ...
        if node[0] == 'FILENAME':
            ...
            if node[0] == 'FUNCNAME':
                ...
                if node[0] == 'NUMBER':
                    ...
                    raise AssertionError("n_location: Something's is wrong; node[0] is %s" % node[0])
            ...
            if node[1] == 'IF':
                ...
                if node[2] == 'IF':
                    ...
                    if node[3] == 'IF':
                        ...
                        raise AssertionError('location_if: Something is wrong; cannot find "if"')
...
def build_bp_expr(string, show_tokens=False, show_ast=False, show_grammar=False):
    ...
    if not location.line_number is not None:
        assert location.method
    return bp_expr
