...
# Size of source mod 2**32: 11944 bytes
    ...
    def get_breakpoint(self, i):
        if isinstance(i, str):
            try:
                ...
                return (
                 False, 'Breakpoint value %r is not a number.' % i,
                 None)
...
class Breakpoint:
    __doc__ = 'Breakpoint class implements temporary breakpoints, ignore\n    counts, disabling and (re)-enabling breakpoints and breakpoint\n    conditionals.\n    '
