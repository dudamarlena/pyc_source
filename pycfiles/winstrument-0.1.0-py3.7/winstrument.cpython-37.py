...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\winstrument\winstrument.py
# Compiled at: 2020-02-05 20:03:04
# Size of source mod 2**32: 12698 bytes
import sys, os, frida
import winstrument.utils as utils
from colorama import Fore, Back, Style
import threading
from frida_tools.application import Reactor
import importlib, pkgutil, sqlite3, json, toml
...
class Winstrument:
    ...
    def get_metadata(self, filename='metadata.toml'):
        ...
        try:
            ...
            return dict(((k.lower(), v) for k, v in metadata.items()))
    ...
    def _instrument(self, pid, path):
        ...
        for moduleclass in self._base_module.BaseInstrumentation.__subclasses__():
            if moduleclass.modulename in self._loaded_modules:
