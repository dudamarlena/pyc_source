...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sane.py
# Compiled at: 2011-08-04 15:47:31
__version__ = '2.0.1'
...
import _sane
from _sane import *
TYPE_STR = {TYPE_BOOL: 'TYPE_BOOL', TYPE_INT: 'TYPE_INT', TYPE_FIXED: 'TYPE_FIXED', 
   TYPE_STRING: 'TYPE_STRING', TYPE_BUTTON: 'TYPE_BUTTON', 
   TYPE_GROUP: 'TYPE_GROUP'}
UNIT_STR = {UNIT_NONE: 'UNIT_NONE', UNIT_PIXEL: 'UNIT_PIXEL', 
   UNIT_BIT: 'UNIT_BIT', 
   UNIT_MM: 'UNIT_MM', 
   UNIT_DPI: 'UNIT_DPI', 
...
class Option:
    ...
    def __init__(self, args, scanDev):
        ...
        if type(self.name) != type(''):
            ...
            self.py_name = string.join(map(f, self.name), '')
...
"""
    ...
    def arr_snap(self, multipleOf=1):
        ...
        if mode not in ('gray', 'red', 'green', 'blue'):
