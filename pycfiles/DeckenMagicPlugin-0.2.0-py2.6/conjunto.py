...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/deckenmagicplugin/conjunto.py
# Compiled at: 2010-06-10 10:34:50
from BeautifulSoup import BeautifulSoup as bs
import urllib2, csv, sqlite3, re, os
...
def update_sets(conn):
    ...
    for sigla in localizadas:
        ...
        for numero in conjunto_busca:
            ...
            tupla = (
             nome, sigla, numero, tipo, mana, raridade, texto_da_carta)
            print tupla
            if 'Missing!' in unicode(tupla[3]):
                tupla = (
                 nome, sigla, numero, '', mana, raridade, texto_da_carta)
            print 'cadastrando'
