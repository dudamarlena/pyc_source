...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/barrel/cooper.py
# Compiled at: 2008-06-29 03:18:08
...
def decorize(middleware):
    ...
    def metadeco(config=None, *args, **kwargs):
        ...
        stringkwargs = [ '%s=%s' % (key, repr(val)) for (key, val) in kwargs.iteritems() ]
    ...
    metadeco.__doc__ = 'Create decorator that will use %s with given attributes.' % classname
    return metadeco
