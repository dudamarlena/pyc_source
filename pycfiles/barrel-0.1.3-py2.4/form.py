...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/barrel/form.py
# Compiled at: 2008-06-29 00:02:44
...
class FormAuth(BasicAuth):
    ...
    def not_authenticated(self, environ, start_response):
        ...
        return [
         self.template.safe_substitute(user_field=self.user_field, pass_field=self.pass_field, button=self.button, username=username, message=message, **environ)]