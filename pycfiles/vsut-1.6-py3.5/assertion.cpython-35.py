...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vsut/assertion.py
# Compiled at: 2016-05-11 09:40:58
...
def assertRaises(exception, func, *args, message=''):
    ...
    try:
        func(*args)
        if message == '':
            message = '{0} did not raise {1}'.format(func.__name__, exception.__name__)
