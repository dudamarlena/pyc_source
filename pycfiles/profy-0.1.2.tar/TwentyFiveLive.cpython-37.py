...
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/profpy/apis/TwentyFiveLive.py
...
class TwentyFiveLive(Api):
    """TwentyFiveLive"""
    _TwentyFiveLive__NAMESPACE = '{http://www.collegenet.com/r25}'
    ...
    def _set_args_mapping(self):
        ...
        :return:
        """
        self.endpoint_to_args = {self.GET_RESERVATIONS: ['space_id'], 
    ...
    def _hit_endpoint(self, valid_args, endpoint_name, get_one=False, request_type='GET', **kwargs):
        ...
        if all((arg in valid_args for arg in kwargs)):
            ...
            msg = 'Invalid parameter supplied at ServiceNowTable::_hit_endpoint(). Arguments provided: {0}. Valid arguments: {1}.'.format(bad_args, good_args)
    ...
    def get_organizations(self, as_xml_text=False, **kwargs):
        ...
        if as_xml_text:
            ...
            result = []
            for organization in fromstring(data).findall(self._TwentyFiveLive__NAMESPACE + 'organization'):
    ...
    def get_organization_types(self, as_xml_text=False, **kwargs):
        ...
        if as_xml_text:
            ...
            result = []
            for org_type in fromstring(data).findall(self._TwentyFiveLive__NAMESPACE + 'type'):
    ...
    def get_reservations(self, as_xml_text=False, **kwargs):
        ...
        if as_xml_text:
            ...
            result = []
            for space in fromstring(data).findall(self._TwentyFiveLive__NAMESPACE + 'reservation'):
    ...
    def get_spaces(self, as_xml_text=False, **kwargs):
        ...
        if as_xml_text:
            ...
            result = []
            for space in fromstring(data).findall(self._TwentyFiveLive__NAMESPACE + 'space'):
...
def parse_organization_from_xml(in_xml):
    ...
    for child in in_xml:
        ...
        if tag == 'organization_type':
            ...
            result[tag] = get_text_from_element(in_xml,
              tag, NAMESPACE, is_dt=(tag == 'last_mod_dt'))
...
def parse_reservation_from_xml(in_xml):
    ...
    for child in in_xml:
        ...
        if tag == 'space_reservation':
            ...
            result[tag] = get_text_from_element(in_xml,
              tag, NAMESPACE, is_dt=(tag in dates))
