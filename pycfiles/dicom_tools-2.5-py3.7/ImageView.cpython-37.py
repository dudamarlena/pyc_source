...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/imageview/ImageView.py
# Compiled at: 2018-05-21 04:28:19
# Size of source mod 2**32: 26889 bytes
"""
...
class ImageView(QtGui.QWidget):
    ...
    def __init__(self, parent=None, name='ImageView', view=None, imageItem=None, *args):
        ...
        **Arguments** 
        ...
        self.noRepeatKeys = [
         QtCore.Qt.Key_Right, QtCore.Qt.Key_Left, QtCore.Qt.Key_Up, QtCore.Qt.Key_Down, QtCore.Qt.Key_PageUp, QtCore.Qt.Key_PageDown]
        self.roiClicked()
    ...
    def setImage(self, img, autoRange=True, autoLevels=True, levels=None, axes=None, xvals=None, pos=None, scale=None, transform=None, autoHistogramRange=True):
        ...
        **Arguments:**
        ...
        if hasattr(img, 'implements'):
            if img.implements('MetaArray'):
                img = img.asarray()
        required = isinstance(img, np.ndarray) or [
    ...
    def roiClicked(self):
        ...
        if self.hasTimeAxis():
            ...
            self.ui.roiBtn.isChecked() or self.ui.splitter.setSizes([self.height() - 35, 35])
        else:
            self.timeLine.hide()
            ...
            if self.ui.normTimeRangeCheck.isChecked():
                if image.ndim == 3:
                    ...
                    if div:
                        ...
                        norm -= n
            if self.ui.normFrameCheck.isChecked():
                if image.ndim == 3:
