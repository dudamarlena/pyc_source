...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/opengl/items/GLMeshItem.py
    ...
    def parseMeshData(self):
        if self.vertexes is not None:
            ...
            if self.opts['meshdata'] is not None:
                ...
                if self.opts['smooth']:
                    self.vertexes = md.hasFaceIndexedData() or md.vertexes()
