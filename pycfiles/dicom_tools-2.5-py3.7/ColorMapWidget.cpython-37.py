...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/widgets/ColorMapWidget.py
...
class ColorMapWidget(ptree.ParameterTree):
    ...
    def widgetGroupInterface(self):
        return (
         self.sigColorMapChanged, self.saveState, self.restoreState)
...
class EnumColorMapItem(ptree.types.GroupParameter):
    ...
    def __init__(self, name, opts):
        ...
        ptree.types.GroupParameter.__init__(self, name=name,
          autoIncrementName=True,
          removable=True,
          renamable=True,
          children=[
