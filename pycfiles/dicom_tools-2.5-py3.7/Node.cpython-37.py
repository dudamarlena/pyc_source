...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/flowchart/Node.py
# Compiled at: 2018-05-21 04:28:19
# Size of source mod 2**32: 25308 bytes
...
class Node(QtCore.QObject):
    ...
    sigTerminalAdded = QtCore.Signal(object, object)
    sigTerminalRemoved = QtCore.Signal(object, object)
    ...
    def setInput(self, **args):
        ...
        if changed:
            if '_updatesHandled_' not in args:
                self.update()
