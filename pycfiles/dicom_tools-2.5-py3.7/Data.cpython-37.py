...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/flowchart/library/Data.py
# Compiled at: 2018-05-21 04:28:19
# Size of source mod 2**32: 12746 bytes
...
import graphicsItems.LinearRegionItem as LinearRegionItem
from . import functions

class ColumnSelectNode(Node):
    __doc__ = 'Select named columns from a record array or MetaArray.'
...
class RegionSelectNode(CtrlNode):
    __doc__ = "Returns a slice from a 1-D array. Connect the 'widget' output to a plot to display a region-selection widget."
    ...
    def process(self, data=None, display=True):
        ...
        elif self['selected'].isConnected():
            if data is None:
                sliced = None
            else:
                if hasattr(data, 'implements') and data.implements('MetaArray'):
...
class ColumnJoinNode(Node):
    __doc__ = 'Concatenates record arrays and/or adds new columns'
    nodeName = 'ColumnJoin'
