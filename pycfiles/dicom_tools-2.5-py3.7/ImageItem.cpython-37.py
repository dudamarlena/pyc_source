...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/graphicsItems/ImageItem.py
# Compiled at: 2018-05-21 04:28:19
# Size of source mod 2**32: 20052 bytes
...
class ImageItem(GraphicsObject):
    ...
    def setImage(self, image=None, autoLevels=None, **kargs):
        ...
        **Arguments:**
        ...
        if not self.image.shape[0] > 32767:
            if self.image.shape[1] > 32767:
    ...
    def pixelSize(self):
        ...
        if self.image is None:
            return (1, 1)
        return (
         br.width() / self.width(), br.height() / self.height())
    ...
    def hoverEvent(self, ev):
        if (ev.isExit() or self.drawKernel) is not None and ev.acceptDrags(QtCore.Qt.LeftButton):
