...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/graphicsItems/CurvePoint.py
...
class CurvePoint(GraphicsObject):
    ...
    def event(self, ev):
        if isinstance(ev, QtCore.QDynamicPropertyChangeEvent):
...
class CurveArrow(CurvePoint):
    __doc__ = 'Provides an arrow that points to any specific sample on a PlotCurveItem.\n    Provides properties that can be animated.'
