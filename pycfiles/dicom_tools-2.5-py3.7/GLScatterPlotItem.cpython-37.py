...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/dicom_tools/pyqtgraph/opengl/items/GLScatterPlotItem.py
...
class GLScatterPlotItem(GLGraphicsItem):
    __doc__ = 'Draws points at a list of 3D positions.'
    ...
    def initializeGL(self):
        ...
        def fn(x, y):
            r = ((x - w / 2.0) ** 2 + (y - w / 2.0) ** 2) ** 0.5
            return 255 * (w / 2.0 - np.clip(r, w / 2.0 - 1.0, w / 2.0))
