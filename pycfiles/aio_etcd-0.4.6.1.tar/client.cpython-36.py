...
# Embedded file name: build/bdist.linux-x86_64/egg/aio_dprcon/client.py
# Compiled at: 2018-04-20 14:42:39
# Size of source mod 2**32: 7457 bytes
import asyncio, string, sys, time
from contextlib import contextmanager
import click
from .exceptions import RconCommandFailed
from .parser import CombinedParser, StatusItemParser, CvarParser, AproposCvarParser, AproposAliasCommandParser, CvarListParser, AliasListParser, CmdListParser
...
class RconClient:
    ...
    def __init__(self, loop, remote_host, remote_port, password=None, secure=RCON_NOSECURE, poll_status_interval=6, log_listener_ip=None):
        self.loop = loop
        ...
        self.cmd_parser = CombinedParser(self,
          parsers=[StatusItemParser, CvarParser, AproposCvarParser, AproposAliasCommandParser,
         CvarListParser])
    ...
    async def _connect(self, callback):
        ...
        return await self.loop.create_datagram_endpoint(protocol_class, remote_addr=(
