...
# Embedded file name: build/bdist.linux-x86_64/egg/aio_dprcon/shell.py
# Compiled at: 2017-11-18 13:04:02
# Size of source mod 2**32: 3154 bytes
import os, cmd, signal, sys, atexit, click, dpcolors, readline
...
class RconShell(cmd.Cmd):
    ...
    def preloop(self):
        ...
        if not self.client.connected:
            ...
            sys.exit(1)
        self.prompt = '{} > '.format(click.style((self.client.status['host']), fg='green',
          bold=True))
