...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/iw/dist/tests/test_distdocstrings.py
# Compiled at: 2008-03-20 05:18:16
"""
Generic Test case for iw.dist doc strings
"""
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        suite.append(doctest.DocTestSuite('iw.dist.%s' % test, optionflags=flags, globs=globs))
