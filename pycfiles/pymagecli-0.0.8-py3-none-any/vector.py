...
# Embedded file name: build/bdist.macosx-10.3-fat/egg/pymage/vector.py
# Compiled at: 2007-09-07 19:06:48
...
class Vector(object):
    ...
    def angleBetween(self, other):
        ...
        :ReturnType: float
        """
        radianAngle = math.acos(self * other / (self.magnitude * other.magnitude))
...
class NumericVector(Vector):
    ...
    def __mul__(self, other):
        ...
        elif isinstance(other, NumericVector):
