...
# [GCC 8.4.0]
# Embedded file name: /Users/jonathanfriedman/Dropbox/python_dev_library/PySurvey/doc/sphinxext/ipython_directive.py
...
"""
import ast, cStringIO, os, re, sys, tempfile
try:
        ...
        for (lineno, line) in enumerate(content):
            ...
            if not multiline:
                ...
                if line_stripped.endswith('\\'):
                    ...
                    continue
            self.process_input_line(unicode(line_to_process.strip()), store_history=False)
        ...
        for (lineno, line) in enumerate(content):
            ...
            if not multiline:
                ...
                try:
                    ...
                    if lineno < len(content) - 1 and _count_indent(content[multiline_start]) < _count_indent(content[(lineno + 1)]):
                        continue
...
class IpythonDirective(Directive):
    ...
    def setup(self):
        ...
        return (
         rgxin, rgxout, promptin, promptout)
    ...
    def run(self):
        ...
        for part in parts:
            ...
            if len(block):
                ...
                for row in rows:
                    lines.extend([ '   %s' % line for line in re.split('[\n]+', row)
                                 ])
