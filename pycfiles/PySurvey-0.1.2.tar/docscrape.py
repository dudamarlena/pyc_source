...
# [GCC 8.4.0]
# Embedded file name: /Users/jonathanfriedman/Dropbox/python_dev_library/PySurvey/doc/sphinxext/docscrape.py
# Compiled at: 2013-04-03 08:15:44
...
class NumpyDocString(object):
    ...
    def _parse_see_also(self, content):
        ...
        for line in content:
            ...
            if m:
                if line[m.end():].strip().startswith(':'):
    ...
    def _parse_summary(self):
        ...
        if self._is_at_section():
            ...
            if re.compile('^([\\w., ]+=)?\\s*[\\w\\.]+\\(.*\\)$').match(summary_str):
                ...
                self['Summary'] = self._is_at_section() or self._doc.read_to_next_empty_line()
        else:
