...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/neox/commons/menu_list.py
# Compiled at: 2020-02-26 23:29:02
# Size of source mod 2**32: 6238 bytes
from decimal import Decimal
from PyQt5.QtCore import Qt, pyqtSignal, QSize
from PyQt5.QtWidgets import QWidget, QHBoxLayout, QFrame, QScroller, QVBoxLayout, QPushButton, QLabel, QGridLayout, QDialog, QScrollArea
...
class TLabel(QLabel):
    ...
    def mouseDoubleClickEvent(self, qmouse_event):
        self.parent.setState({'layout_invisible':True, 
         'view':self.id})
...
class MenuWindow(QDialog):
    ...
    def create_categories(self):
        ...
        for k, values in list(self.values.items()):
            separator = Separator()
