...
# Compiled at: 2017-02-12 20:49:39
...
from .core import Shaft, init_app, apply_function_to_members, build_endpoint_route_name
from . import ext
from . import utils
    ...
    def init_app(self, app):
        ...
        def p(*args, **kwargs):
            ...
            if request.endpoint not in ('static', None):
                Shaft.g(__SITENAV__=nav_title.render())
            return
