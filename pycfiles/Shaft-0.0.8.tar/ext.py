...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/shaft/shaft/ext.py
# Compiled at: 2017-02-13 19:26:02
"""
Extensions
"""
import re, logging
...
def _setup(app):
    ...
    global_vars = app.config.get_namespace('APPLICATION_', lowercase=False, trim_namespace=False)
    Shaft.g(**global_vars)
    ...
    def send(self, to, subject=None, body=None, reply_to=None, template=None, **kwargs):
        ...
        if not isinstance(to, list):
            ...
            kwargs.update({'subject': subject, 
               'body': body, 
               'reply_to': reply_to})
            raise (self.validated or exceptions.ShaftError)('Mail configuration error')
