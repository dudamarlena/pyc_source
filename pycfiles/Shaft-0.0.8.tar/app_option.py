...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/shaft/shaft/contrib/app_option.py
# Compiled at: 2017-02-13 09:02:55
import logging, sys, inspect
from shaft import db, utils, cache, models
...
class ApplicationOption(db.Model):
    ...
    def set_key(cls, key, value, description=None, autoload=False):
        ...
        if appset:
            ...
            cls.create(key=make_key(key), value=value, description=description, autoload=autoload)
    ...
    def init(self, value, description, autoload=False):
        ...
        try:
            if not models.ApplicationOption.get_by_key(self.key):
                models.ApplicationOption.set_key(key=self.key, value=value, description=description, autoload=autoload)
