...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/flask-magic/flask_magic/cli.py
# Compiled at: 2016-07-19 20:37:34
...
________________________________________________________________________________
"""
import os, re, sys, traceback, logging, importlib, pkg_resources
from . import utils
import click, yaml, functools, multiprocessing, sh
...
def create_project(project_name, no_assets=True):
    ...
    files = [('%s/__init__.py' % APPLICATION_DIR, '# flask-Magic'),
     (
