...
# [GCC 8.4.0]
# Embedded file name: python/bdist.linux-x86_64/egg/riak_pb/messages.py
# Compiled at: 2015-12-10 20:08:52
"""
Constants and mappings between Riak protocol codes and messages.
"""
import riak_pb.riak_dt_pb2, riak_pb.riak_kv_pb2, riak_pb.riak_pb2, riak_pb.riak_search_pb2, riak_pb.riak_ts_pb2, riak_pb.riak_yokozuna_pb2
...
MESSAGE_CLASSES = {MSG_CODE_ERROR_RESP: riak_pb.riak_pb2.RpbErrorResp, 
   ...
   MSG_CODE_GET_BUCKET_KEY_PREFLIST_REQ: riak_pb.riak_kv_pb2.RpbGetBucketKeyPreflistReq, 
   MSG_CODE_GET_BUCKET_KEY_PREFLIST_RESP: riak_pb.riak_kv_pb2.RpbGetBucketKeyPreflistResp, 
   MSG_CODE_CS_BUCKET_REQ: riak_pb.riak_kv_pb2.RpbCSBucketReq, 
   MSG_CODE_CS_BUCKET_RESP: riak_pb.riak_kv_pb2.RpbCSBucketResp, 
   MSG_CODE_INDEX_BODY_RESP: riak_pb.riak_kv_pb2.RpbIndexBodyResp, 
   ...
   MSG_CODE_YOKOZUNA_INDEX_GET_REQ: riak_pb.riak_yokozuna_pb2.RpbYokozunaIndexGetReq, 
   MSG_CODE_YOKOZUNA_INDEX_GET_RESP: riak_pb.riak_yokozuna_pb2.RpbYokozunaIndexGetResp, 
   MSG_CODE_YOKOZUNA_INDEX_PUT_REQ: riak_pb.riak_yokozuna_pb2.RpbYokozunaIndexPutReq, 
   MSG_CODE_YOKOZUNA_INDEX_DELETE_REQ: riak_pb.riak_yokozuna_pb2.RpbYokozunaIndexDeleteReq, 
   MSG_CODE_YOKOZUNA_SCHEMA_GET_REQ: riak_pb.riak_yokozuna_pb2.RpbYokozunaSchemaGetReq, 
   MSG_CODE_YOKOZUNA_SCHEMA_GET_RESP: riak_pb.riak_yokozuna_pb2.RpbYokozunaSchemaGetResp, 
   MSG_CODE_YOKOZUNA_SCHEMA_PUT_REQ: riak_pb.riak_yokozuna_pb2.RpbYokozunaSchemaPutReq, 
   MSG_CODE_COVERAGE_REQ: riak_pb.riak_kv_pb2.RpbCoverageReq, 
   MSG_CODE_COVERAGE_RESP: riak_pb.riak_kv_pb2.RpbCoverageResp, 
   ...
   MSG_CODE_TS_QUERY_REQ: riak_pb.riak_ts_pb2.TsQueryReq, 
   MSG_CODE_TS_QUERY_RESP: riak_pb.riak_ts_pb2.TsQueryResp, 
   MSG_CODE_TS_PUT_REQ: riak_pb.riak_ts_pb2.TsPutReq, 
   MSG_CODE_TS_PUT_RESP: riak_pb.riak_ts_pb2.TsPutResp, 
   MSG_CODE_TS_DEL_REQ: riak_pb.riak_ts_pb2.TsDelReq, 
   MSG_CODE_TS_DEL_RESP: riak_pb.riak_ts_pb2.TsDelResp, 
   MSG_CODE_TS_GET_REQ: riak_pb.riak_ts_pb2.TsGetReq, 
   MSG_CODE_TS_GET_RESP: riak_pb.riak_ts_pb2.TsGetResp, 
   MSG_CODE_TS_LIST_KEYS_REQ: riak_pb.riak_ts_pb2.TsListKeysReq, 
   MSG_CODE_TS_LIST_KEYS_RESP: riak_pb.riak_ts_pb2.TsListKeysResp, 
   MSG_CODE_TOGGLE_ENCODING_REQ: riak_pb.riak_pb2.RpbToggleEncodingReq, 
   MSG_CODE_TOGGLE_ENCODING_RESP: riak_pb.riak_pb2.RpbToggleEncodingResp, 
