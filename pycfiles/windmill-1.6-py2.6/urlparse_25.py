...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/windmill/tools/urlparse_25.py
...
class SplitResult(BaseResult):
    ...
    def __new__(cls, scheme, netloc, path, query, fragment):
        return BaseResult.__new__(cls, (scheme, netloc, path, query, fragment))
...
class ParseResult(BaseResult):
    ...
    def __new__(cls, scheme, netloc, path, params, query, fragment):
        return BaseResult.__new__(cls, (scheme, netloc, path, params, query, fragment))
