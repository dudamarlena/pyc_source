...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/windmill/dep/_mozrunner/killableprocess.py
...
"""
import subprocess, sys, os, time, datetime, types, exceptions
try:
