...
# [GCC 8.4.0]
# Embedded file name: /Users/tonra/ohm2/clients/ohm2/entwicklung/ohm2-dev-light/webapp/backend/apps/ohm2_pushes_light/gateways/onesignal/settings.py
# Compiled at: 2017-11-07 14:44:04
...
APP = 'ONESIGNAL_'
APP_ID = getattr(settings, APP + 'APP_ID')
API_NOTIFICATIONS_URL = getattr(settings, APP + 'API_NOTIFICATIONS_URL', 'https://onesignal.com/api/v1/notifications')
