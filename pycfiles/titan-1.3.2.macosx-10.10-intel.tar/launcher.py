...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/titan/launcher.py
# Compiled at: 2014-10-16 21:41:33
"""
This is the launcher for titanOSX/Titan
"""
import logging
...
def launch_modules():
    ...
    for module in MODULES:
        ...
        if current_lang is not None and isinstance(current_lang, CtznLanguage):
            if testing_enabled:
                print log_line('titanOSX', 'Found Module: %s/%s, Lang: %s' % (basename(dirname(module)), mod_name, current_lang.execution_string))
