...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/downloads/migrations/0004_remove_do_not_list.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('downloads_download', 'do_not_list')

    def backwards(self, orm):
        db.add_column('downloads_download', 'do_not_list', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'downloads.download': {'Meta': {'ordering': "['primary_category', 'title']", 'object_name': 'Download', '_ormbases': ['jmbo.ModelBase']}, 'file': (
                              ...
                              'visible': (
                                        'django.db.models.fields.BooleanField', [], {'default': 'True'})}, 
       'downloads.textoverlaytemporarydownload': {'Meta': {'object_name': 'TextOverlayTemporaryDownload'}, 'background_image': (
