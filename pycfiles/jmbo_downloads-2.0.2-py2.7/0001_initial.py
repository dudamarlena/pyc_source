...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/downloads/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('downloads_download', (
         ...
         (
          'do_not_list', self.gf('django.db.models.fields.BooleanField')(default=False))))
        db.send_create_signal('downloads', ['Download'])
        db.create_table('downloads_textoverlayimagemod', (
         (
          'download_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['downloads.Download'], unique=True, primary_key=True)),
         (
          'unique_per_user', self.gf('django.db.models.fields.BooleanField')(default=False)),
         (
         ...
         (
          'font', self.gf('django.db.models.fields.FilePathField')(path='/usr/share/fonts/truetype/', max_length=100, recursive=True)),
         (
          'font_size', self.gf('django.db.models.fields.PositiveIntegerField')()),
         (
          'colour', self.gf('downloads.fields.ColourField')(max_length=7))))
        db.send_create_signal('downloads', ['TextOverlayImageMod'])

    def backwards(self, orm):
        db.delete_table('downloads_download')
        db.delete_table('downloads_textoverlayimagemod')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'downloads.download': {'Meta': {'ordering': "['primary_category', 'title']", 'object_name': 'Download', '_ormbases': ['jmbo.ModelBase']}, 'do_not_list': (
                                            'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                              'file': (
       ...
       'downloads.textoverlayimagemod': {'Meta': {'object_name': 'TextOverlayImageMod'}, 'background_image': (
                                                            'django.db.models.fields.files.ImageField', [], {'max_length': '100'}), 
                                         'colour': (
                                                  'downloads.fields.ColourField', [], {'max_length': '7'}), 
                                         'download_ptr': (
                                                        'django.db.models.fields.related.OneToOneField', [], {'to': "orm['downloads.Download']", 'unique': 'True', 'primary_key': 'True'}), 
                                         'font': (
                                                'django.db.models.fields.FilePathField', [], {'path': "'/usr/share/fonts/truetype/'", 'max_length': '100', 'recursive': 'True'}), 
                                         'font_size': (
