...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/downloads/migrations/0002_rename_imagemod_to_temporarydownload.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('downloads_download', 'visible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
