...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/testlinkmap/find_macho_linkmap.py
# Compiled at: 2019-02-15 10:02:53
# Size of source mod 2**32: 6077 bytes
...
def __do_exec():
    ...
    exclude_folders |= {f"{buildmode}-{x}" for x in {'watchos', 'iphonesimulator', 'watchsimulator'}}
