...
# [GCC 8.4.0]
# Embedded file name: /Users/david/Documents/dev/environments/test_sentry/lib/python2.6/site-packages/sentry_redflash/client.py
...
at rf_url using the api_key. """
    ...
    def _send(self, ctype, slug, data):
        ...
        u = urllib.urlopen(self.rf_url + '/%s/%s/' % (ctype, slug), data=urllib.urlencode(data))
        return u
