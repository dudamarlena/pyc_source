...
# [GCC 8.4.0]
# Embedded file name: /home/gufranco/Documents/PyChemia/tests/test_code_vasp.py
# Compiled at: 2020-01-17 14:31:04
# Size of source mod 2**32: 5254 bytes
import os, shutil, pychemia, tempfile, unittest
...
class MyTestCase(unittest.TestCase):
    ...
    def test_incar(self):
        ...
        self.assertEqual(iv.EDIFF, 1e-07)
        ...
        iv3 = pychemia.code.vasp.VaspInput(variables={'EDIFF': 1e-06})
        self.assertEqual(iv3['EDIFF'], 1e-06)
    ...
    def test_encut_setup(self):
        ...
        self.assertEqual(iv.EDIFFG, -0.01)
        iv.set_mit_settings()
    ...
    def test_poscar(self):
        ...
        self.assertAlmostEqual(st.volume, 584.4716192604391)
