...
class NoneCell(Column):
    __doc__ = 'None cell is used for mark a previous colspan.'
...
class GetItemColumn(Column):
    __doc__ = 'Get value from item index/key column'
    idx = None
    default_value = ''
...
class I18nGetAttrColumn(GetAttrColumn):
    __doc__ = 'GetAttrColumn which translates its content'
...
class GetAttrFormatterColumn(FormatterColumn, GetAttrColumn):
    __doc__ = 'Get attribute and formatter column.'
...
class EMailColumn(LinkColumn, GetAttrColumn):
    __doc__ = 'Column to display mailto links'
    header = _('E-Mail')
    attr_name = None
    default_value = ''
    link_content = None
...
class SelectedItemColumn(LinkColumn):
    __doc__ = 'Link which can set an item'
    selected_item = None
...
class ContentsLinkColumn(LinkColumn):
    __doc__ = 'Link pointing to contents.html.'
    link_name = 'contents.html'


class IndexLinkColumn(LinkColumn):
    __doc__ = 'Link pointing to index.html.'
    link_name = 'index.html'


class EditLinkColumn(LinkColumn):
    __doc__ = 'Link pointing to edit.html.'
    link_name = 'edit.html'