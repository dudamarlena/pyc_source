...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/urilib/__init__.py
# Compiled at: 2011-09-06 23:53:11
import re, urilib.regex, urilib.tools
...
class Query(dict):
    ...
    def __str__(self):
        ...
        pairs = [ ('=').join([param, value]) for param, values in self.iteritems() for value in values
                ]
