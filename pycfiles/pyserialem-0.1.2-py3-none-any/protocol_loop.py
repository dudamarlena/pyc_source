...
# Embedded file name: ./build/lib.linux-x86_64-2.7/serial/urlhandler/protocol_loop.py
...
class Serial(SerialBase):
    ...
    def _reconfigure_port(self):
        ...
        """
        if not isinstance(self._baudrate, numbers.Integral) or not 0 < self._baudrate < 4294967296:
