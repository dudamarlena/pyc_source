...
# [GCC 8.4.0]
# Embedded file name: /Users/sotetsuk/anaconda/lib/python2.7/site-packages/paper2tmb/manipulator.py
# Compiled at: 2016-05-21 09:36:15
import os
...
class Manipulator(object):
    ...
    def pdf2png(self, trim=None, density=None):
        ...
        if trim is not None:
            trim_command = [
             '-gravity', 'northwest', '-chop', trim, '-gravity', 'southeast', '-chop', trim]
            command += trim_command
        if density is not None:
            density_command = [
             '-density', ('{}x{}').format(density, density)]
