...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/sklearn_pmml/convert/random_forest.py
# Compiled at: 2015-10-06 17:13:26
...
class RandomForestClassifierConverter(ClassifierConverter):
    ...
    def __init__(self, estimator, context):
        ...
        assert isinstance(estimator, RandomForestClassifier), 'This converter can only process RandomForestClassifier instances'
