...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/sklearn_pmml/convert/features.py
# Compiled at: 2015-10-12 16:39:04
...
class DerivedFeature(NumericFeature):
    ...
    def __init__(self, feature, transformation, function):
        ...
        """
        super(DerivedFeature, self).__init__(name=feature.name, namespace=feature.namespace, invalid_value_treatment=feature.invalid_value_treatment)
