...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/GMPLS-LABEL-STD-MIB.py
...
gmplsLabelModuleReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 16,
                                                       2, 2, 1)).setObjects(*(('GMPLS-LABEL-STD-MIB', 'gmplsLabelTableGroup'), ('GMPLS-LABEL-STD-MIB', 'gmplsLabelPacketGroup'), ('GMPLS-LABEL-STD-MIB', 'gmplsLabelPortWavelengthGroup'), ('GMPLS-LABEL-STD-MIB', 'gmplsLabelFreeformGroup'), ('GMPLS-LABEL-STD-MIB', 'gmplsLabelSonetSdhGroup'), ('GMPLS-LABEL-STD-MIB', 'gmplsLabelWavebandGroup')))
if mibBuilder.loadTexts:
    gmplsLabelModuleReadOnlyCompliance.setDescription('Compliance requirement for implementations that only provide\n     read-only support for GMPLS-LABEL-STD-MIB.  Such devices can then\n     be monitored but cannot be configured using this MIB module.')
gmplsLabelModuleFullCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 16, 2,
                                                   2, 2)).setObjects(*(('GMPLS-LABEL-STD-MIB', 'gmplsLabelTableGroup'), ))
if mibBuilder.loadTexts:
    gmplsLabelModuleFullCompliance.setDescription('Compliance statement for agents that support the complete\n     GMPLS-LABEL-STD-MIB module.\n\n     The mandatory groups have to be implemented by GMPLS LSRs\n     claiming support for this MIB module.  This MIB module is,\n     however, not mandatory for a working implementation of a GMPLS\n     LSR with full MIB support if the GMPLS Labels in use can be\n     represented within a 32-bit quantity.')
...
if mibBuilder.loadTexts:
    gmplsLabelPortWavelengthGroup.setDescription('Object needed to implement Port and Wavelength Labels.')
gmplsLabelFreeformGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 166, 16, 2, 1, 4)).setObjects(*(('GMPLS-LABEL-STD-MIB', 'gmplsLabelFreeform'), ))
if mibBuilder.loadTexts:
    gmplsLabelFreeformGroup.setDescription('Object needed to implement Freeform Labels.')
...
if mibBuilder.loadTexts:
    gmplsLabelSonetSdhGroup.setDescription('Objects needed to implement SONET and SDH Labels.')
