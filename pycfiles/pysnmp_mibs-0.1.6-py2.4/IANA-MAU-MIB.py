...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IANA-MAU-MIB.py
# Compiled at: 2016-02-13 18:16:01
...
ianaMauMIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 154)).setRevisions(('2011-08-12 00:00',
                                                                   '2010-02-23 00:00',
                                                                   '2007-04-21 00:00'))
if mibBuilder.loadTexts:
    ianaMauMIB.setLastUpdated('201108120000Z')
if mibBuilder.loadTexts:
...
class IANAifMauTypeListBits(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('bOther', 0), ('bAUI', 1), ('b10base5', 2), ('bFoirl',
                                                                            3), ('b10base2',
                                                                                 4), ('b10baseT',
                                                                                      5), ('b10baseFP',
                                                                                           6), ('b10baseFB',
...
class IANAifMauMediaAvailable(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('available', 3), ('notAvailable',
                                                                               4), ('remoteFault',
                                                                                    5), ('invalidSignal',
                                                                                         6), ('remoteJabber',
                                                                                              7), ('remoteLinkLoss',
...
class IANAifMauAutoNegCapBits(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('bOther', 0), ('b10baseT', 1), ('b10baseTFD', 2), ('b100baseT4',
                                                                                  3), ('b100baseTX',
                                                                                       4), ('b100baseTXFD',
                                                                                            5), ('b100baseT2',
                                                                                                 6), ('b100baseT2FD',
...
class IANAifJackType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('rj45', 2), ('rj45S', 3), ('db9', 4), ('bnc',
                                                                                    5), ('fAUI',
                                                                                         6), ('mAUI',
                                                                                              7), ('fiberSC',
                                                                                                   8), ('fiberMIC',
...
if mibBuilder.loadTexts:
    dot3MauType10GbaseT.setDescription('Four-pair Category 6A or better, full duplex mode only')
dot3MauType10GbaseLRM = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 55))
if mibBuilder.loadTexts:
    dot3MauType10GbaseLRM.setDescription('R multimode fiber over 1310 nm optics')
dot3MauType1000baseKX = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 56))
if mibBuilder.loadTexts:
    dot3MauType1000baseKX.setDescription('X backplane, full duplex mode only')
dot3MauType10GbaseKX4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 57))
if mibBuilder.loadTexts:
    dot3MauType10GbaseKX4.setDescription('4 lane X backplane, full duplex mode only')
dot3MauType10GbaseKR = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 58))
if mibBuilder.loadTexts:
    dot3MauType10GbaseKR.setDescription('R backplane, full duplex mode only')
dot3MauType10G1GbasePRXD1 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 59))
if mibBuilder.loadTexts:
    dot3MauType10G1GbasePRXD1.setDescription('One single-mode fiber asymmetric-rate EPON OLT, supporting low\n                    power budget (PRX10)')
dot3MauType10G1GbasePRXD2 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 60))
if mibBuilder.loadTexts:
    dot3MauType10G1GbasePRXD2.setDescription('One single-mode fiber asymmetric-rate EPON OLT, supporting\n                   medium power budget (PRX20)')
dot3MauType10G1GbasePRXD3 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 61))
if mibBuilder.loadTexts:
    dot3MauType10G1GbasePRXD3.setDescription('One single-mode fiber asymmetric-rate EPON OLT, supporting high\n                   power budget (PRX30)')
dot3MauType10G1GbasePRXU1 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 62))
if mibBuilder.loadTexts:
    dot3MauType10G1GbasePRXU1.setDescription('One single-mode fiber asymmetric-rate EPON ONU, supporting low\n                   power budget (PRX10)')
dot3MauType10G1GbasePRXU2 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 63))
if mibBuilder.loadTexts:
    dot3MauType10G1GbasePRXU2.setDescription('One single-mode fiber asymmetric-rate EPON ONU, supporting\n                   medium power budget (PRX20)')
dot3MauType10G1GbasePRXU3 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 64))
if mibBuilder.loadTexts:
    dot3MauType10G1GbasePRXU3.setDescription('One single-mode fiber asymmetric-rate EPON ONU, supporting high\n                   power budget (PRX30)')
dot3MauType10GbasePRD1 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 65))
if mibBuilder.loadTexts:
    dot3MauType10GbasePRD1.setDescription('One single-mode fiber symmetric-rate EPON OLT, supporting low\n                   power budget (PR10)')
dot3MauType10GbasePRD2 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 66))
if mibBuilder.loadTexts:
    dot3MauType10GbasePRD2.setDescription('One single-mode fiber symmetric-rate EPON OLT, supporting\n                   medium power budget (PR20)')
dot3MauType10GbasePRD3 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 67))
if mibBuilder.loadTexts:
    dot3MauType10GbasePRD3.setDescription('One single-mode fiber symmetric-rate EPON OLT, supporting high\n                   power budget (PR30)')
dot3MauType10GbasePRU1 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 68))
if mibBuilder.loadTexts:
    dot3MauType10GbasePRU1.setDescription('One single-mode fiber symmetric-rate EPON ONU, supporting\n                   low and medium power budget (PR10 and PR20)')
dot3MauType10GbasePRU3 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 69))
if mibBuilder.loadTexts:
    dot3MauType10GbasePRU3.setDescription('One single-mode fiber symmetric-rate EPON ONU, supporting high\n                   power budget (PR30)')
dot3MauType40GbaseKR4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 70))
if mibBuilder.loadTexts:
    dot3MauType40GbaseKR4.setDescription('40GBASE-R PCS/PMA over an electrical \n                      backplane')
dot3MauType40GbaseCR4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 71))
if mibBuilder.loadTexts:
    dot3MauType40GbaseCR4.setDescription('40GBASE-R PCS/PMA over 4 lane shielded \n                      copper balanced cable')
dot3MauType40GbaseSR4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 72))
if mibBuilder.loadTexts:
    dot3MauType40GbaseSR4.setDescription('40GBASE-R PCS/PMA over 4 lane multimode \n                      fiber')
dot3MauType40GbaseFR = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 73))
if mibBuilder.loadTexts:
    dot3MauType40GbaseFR.setDescription('40GBASE-R PCS/PMA over single mode \n                      fiber')
dot3MauType40GbaseLR4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 74))
if mibBuilder.loadTexts:
    dot3MauType40GbaseLR4.setDescription('40GBASE-R PCS/PMA over 4 WDM lane \n                      single mode fiber')
dot3MauType100GbaseCR10 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 75))
if mibBuilder.loadTexts:
    dot3MauType100GbaseCR10.setDescription('100GBASE-R PCS/PMA over 10 lane \n                      shielded copper balanced cable')
dot3MauType100GbaseSR10 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 76))
if mibBuilder.loadTexts:
    dot3MauType100GbaseSR10.setDescription('100GBASE-R PCS/PMA over 10 lane \n                      multimode fiber')
dot3MauType100GbaseLR4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 77))
if mibBuilder.loadTexts:
    dot3MauType100GbaseLR4.setDescription('100GBASE-R PCS/PMA over 4 WDM lane \n                      single mode fiber, long reach')
dot3MauType100GbaseER4 = ObjectIdentity((1, 3, 6, 1, 2, 1, 26, 4, 78))
if mibBuilder.loadTexts:
    dot3MauType100GbaseER4.setDescription('100GBASE-R PCS/PMA over 4 WDM lane \n                      single mode fiber PMD, extended reach')
