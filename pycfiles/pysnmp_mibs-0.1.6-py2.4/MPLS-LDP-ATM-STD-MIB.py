...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-LDP-ATM-STD-MIB.py
# Compiled at: 2016-02-13 18:21:17
...
mplsLdpAtmSessionEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 166, 5, 1, 2, 1, 1)).setIndexNames((0,
                                                                                                ...
                                                                                                'mplsLdpEntityLdpId'), (0,
                                                                                                                        ...
                                                                                                                        'mplsLdpEntityIndex'), (0,
                                                                                                                                                ...
                                                                                                                                                'mplsLdpPeerLdpId'), (0,
                                                                                                                                                                      'MPLS-LDP-ATM-STD-MIB',
                                                                                                                                                                      'mplsLdpSessionAtmLRLowerBoundVpi'), (0,
                                                                                                                                                                                                            'MPLS-LDP-ATM-STD-MIB',
                                                                                                                                                                                                            'mplsLdpSessionAtmLRLowerBoundVci'))
if mibBuilder.loadTexts:
    mplsLdpAtmSessionEntry.setDescription('An entry in this table represents information on a\n        single label range intersection between an LDP Entity\n        and LDP Peer.\n\n        The information contained in a row is read-only.')
mplsLdpSessionAtmLRLowerBoundVpi = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 5, 1,
                                                   2, 1, 1, 1), AtmVpIdentifier())
if mibBuilder.loadTexts:
    mplsLdpSessionAtmLRLowerBoundVpi.setDescription('The minimum VPI number for this range.')
mplsLdpSessionAtmLRLowerBoundVci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 5, 1,
                                                   2, 1, 1, 2), MplsAtmVcIdentifier())
if mibBuilder.loadTexts:
    mplsLdpSessionAtmLRLowerBoundVci.setDescription('The minimum VCI number for this range.')
mplsLdpSessionAtmLRUpperBoundVpi = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 5, 1,
                                                   2, 1, 1, 3), AtmVpIdentifier()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsLdpSessionAtmLRUpperBoundVpi.setDescription('The maximum VPI number for this range.')
mplsLdpSessionAtmLRUpperBoundVci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 5, 1,
                                                   2, 1, 1, 4), MplsAtmVcIdentifier()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsLdpSessionAtmLRUpperBoundVci.setDescription('The maximum VCI number for this range.')
mplsLdpAtmGroups = MibIdentifier((1, 3, 6, 1, 2, 1, 10, 166, 5, 2, 1))
mplsLdpAtmCompliances = MibIdentifier((1, 3, 6, 1, 2, 1, 10, 166, 5, 2, 2))
mplsLdpAtmModuleFullCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 5, 2,
                                                   2, 1)).setObjects(*(('MPLS-LDP-ATM-STD-MIB', 'mplsLdpAtmGroup'), ))
if mibBuilder.loadTexts:
    mplsLdpAtmModuleFullCompliance.setDescription('The Module is implemented with support for\n        read-create and read-write.  In other words,\n        both monitoring and configuration\n        are available when using this MODULE-COMPLIANCE.')
mplsLdpAtmModuleReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 5,
                                                       2, 2, 2)).setObjects(*(('MPLS-LDP-ATM-STD-MIB', 'mplsLdpAtmGroup'), ))
if mibBuilder.loadTexts:
    mplsLdpAtmModuleReadOnlyCompliance.setDescription('The Module is implemented with support for\n        read-only.  In other words, only monitoring\n        is available by implementing this MODULE-COMPLIANCE.')
...
if mibBuilder.loadTexts:
    mplsLdpAtmGroup.setDescription('Objects that apply to all MPLS LDP implementations\n        using ATM as the Layer 2.')
