...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/FLOW-METER-MIB.py
# Compiled at: 2016-02-13 18:13:04
...
if mibBuilder.loadTexts:
    flowMIB.setLastUpdated('9910250000Z')
if mibBuilder.loadTexts:
    flowMIB.setOrganization('IETF Realtime Traffic Flow Measurement Working Group')
if mibBuilder.loadTexts:
    flowMIB.setContactInfo('Nevil Brownlee, The University of Auckland\n\n        Postal: Information Technology Sytems & Services\n                The University of Auckland\n                Private Bag 92-019\n                Auckland, New Zealand\n\n        Phone:  +64 9 373 7599 x8941\n        E-mail: n.brownlee@auckland.ac.nz')
if mibBuilder.loadTexts:
    flowMIB.setDescription('MIB for the RTFM Traffic Flow Meter.')
...
class PeerType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('ipv4', 1), ('ipv6', 2), ('nsap', 3), ('ipx', 11), ('appletalk',
                                                                                   12), ('decnet',
                                                                                         13))
...
class AdjacentType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('ip', 1), ('nsap', 3), ('ethernet', 7), ('tokenring',
                                                                        9), ('ipx',
                                                                             11), ('appletalk',
                                                                                   12), ('decnet',
                                                                                         13), ('fddi',
...
class FlowAttributeNumber(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('flowIndex', 1), ('flowStatus', 2), ('flowTimeMark',
                                                                    3), ('sourceInterface',
                                                                         4), ('sourceAdjacentType',
                                                                              5), ('sourceAdjacentAddress',
                                                                                   6), ('sourceAdjacentMask',
                                                                                        7), ('sourcePeerType',
                                                                                             8), ('sourcePeerAddress',
                                                                                                  9), ('sourcePeerMask',
                                                                                                       10), ('sourceTransType',
                                                                                                             11), ('sourceTransAddress',
                                                                                                                   12), ('sourceTransMask',
                                                                                                                         13), ('destInterface',
                                                                                                                               14), ('destAdjacentType',
                                                                                                                                     15), ('destAdjacentAddress',
                                                                                                                                           16), ('destAdjacentMask',
                                                                                                                                                 17), ('destPeerType',
                                                                                                                                                       18), ('destPeerAddress',
                                                                                                                                                             19), ('destPeerMask',
...
class RuleAttributeNumber(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('null', 0), ('sourceInterface', 4), ('sourceAdjacentType',
                                                                    5), ('sourceAdjacentAddress',
                                                                         6), ('sourcePeerType',
                                                                              8), ('sourcePeerAddress',
                                                                                   9), ('sourceTransType',
...
class ActionNumber(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('ignore', 1), ('noMatch', 2), ('count', 3), ('countPkt',
                                                                            4), ('return',
                                                                                 5), ('gosub',
                                                                                      6), ('gosubAct',
                                                                                           7), ('assign',
...
if mibBuilder.loadTexts:
    flowDataPDUScale.setDescription('The scale factor applied to this particular flow.  Indicates\n        the number of bits the PDU counter values should be moved left\n        to obtain the actual values.')
...
if mibBuilder.loadTexts:
    flowDataSourceClass.setDescription('Source class for this flow.  Determined by the rules, set by\n        a PushRule action when this flow was entered in the table.')
...
if mibBuilder.loadTexts:
    flowDataDestClass.setDescription('Destination class for this flow.  Determined by the rules, set\n        by a PushRule action when this flow was entered in the table.')
...
if mibBuilder.loadTexts:
    flowDataClass.setDescription('Class for this flow.  Determined by the rules, set by a\n        PushRule action when this flow was entered in the table.')
...
if mibBuilder.loadTexts:
    flowDataSourceKind.setDescription('Source kind for this flow.  Determined by the rules, set by\n        a PushRule action when this flow was entered in the table.')
...
if mibBuilder.loadTexts:
    flowDataDestKind.setDescription('Destination kind for this flow.  Determined by the rules, set\n        by a PushRule action when this flow was entered in the table.')
...
if mibBuilder.loadTexts:
    flowColumnActivityIndex.setDescription('Index of a flow table entry which was active at or after\n        a specified flowColumnActivityTime.')
...
if mibBuilder.loadTexts:
    flowControlGroup.setDescription('The control group defines objects which are used to control\n        an accounting meter.')
...
if mibBuilder.loadTexts:
    flowDataScaleGroup.setDescription('The flow scale group defines objects which specify scale\n        factors for counters.')
...
if mibBuilder.loadTexts:
    flowDataSubscriberGroup.setDescription('The flow subscriber group defines objects which may be used\n        to identify the end point(s) of a flow.')
...
if mibBuilder.loadTexts:
    flowRuleTableGroup.setDescription('The rule table group defines objects which hold the set(s)\n        of rules specifying which traffic flows are to be accounted\n        for.')
...
if mibBuilder.loadTexts:
    flowControlGroup2.setDescription('The control group defines objects which are used to control\n        an accounting meter.  It replaces the earlier version of\n        flowControlGroup above (now deprecated).')
...
if mibBuilder.loadTexts:
    flowMIBCompliance.setDescription('The compliance statement for a Traffic Flow Meter.')
