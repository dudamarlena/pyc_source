...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/GSMP-MIB.py
# Compiled at: 2016-02-13 18:14:33
...
class GsmpPartitionType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noPartition', 1), ('fixedPartitionRequest', 2), ('fixedPartitionAssigned',
                                                                                 3))
...
if mibBuilder.loadTexts:
    gsmpModuleCompliance.setDescription('The compliance statement for agents that support\n            the GSMP MIB.')
...
if mibBuilder.loadTexts:
    gsmpGeneralGroup.setDescription('Objects that apply to all GSMP implementations.')
...
if mibBuilder.loadTexts:
    gsmpControllerGroup.setDescription('Objects that apply GSMP implementations of\n             Switch Controllers.')
...
if mibBuilder.loadTexts:
    gsmpSwitchGroup.setDescription('Objects that apply GSMP implementations of\n             Switches.')
...
if mibBuilder.loadTexts:
    gsmpAtmEncapGroup.setDescription('Objects that apply to GSMP implementations that\n             supports ATM for GSMP encapsulation.')
...
if mibBuilder.loadTexts:
    gsmpTcpIpEncapGroup.setDescription('Objects that apply to GSMP implementations that\n             supports TCP/IP for GSMP encapsulation.')
...
if mibBuilder.loadTexts:
    gsmpNotificationObjectsGroup.setDescription('Objects that are contained in the notifications.')
...
if mibBuilder.loadTexts:
    gsmpNotificationsGroup.setDescription('The notifications which indicate specific changes\n             in the value of objects gsmpSessionTable')
