...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-LDP-FRAME-RELAY-STD-MIB.py
# Compiled at: 2016-02-13 18:21:32
...
if mibBuilder.loadTexts:
    mplsLdpEntityFrameRelayLREntry.setDescription('An entry in this table represents the Frame Relay\n        Label Range Component associated with the LDP entity.')
mplsLdpEntityFrameRelayLRMinDlci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1,
                                                   1, 2, 1, 1), DLCI())
if mibBuilder.loadTexts:
    mplsLdpEntityFrameRelayLRMinDlci.setDescription("The lower bound which is supported.  This value\n        should be the same as that in the Frame Relay Label\n        Range Component's Minimum DLCI field.  The value\n        of zero is valid for the minimum DLCI field of\n        the label.")
mplsLdpEntityFrameRelayLRMaxDlci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1,
                                                   1, 2, 1, 2), DLCI()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsLdpEntityFrameRelayLRMaxDlci.setDescription("The upper bound which is supported.  This value\n        should be the same as that in the Frame Relay Label\n        Range Component's Maximum DLCI field.")
mplsLdpEntityFrameRelayLRLen = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1, 1,
                                               2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 2))).clone(namedValues=NamedValues(('tenDlciBits',
                                                                                                                                                                       0), ('twentyThreeDlciBits',
                                                                                                                                                                            2)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsLdpEntityFrameRelayLRLen.setDescription("This object specifies the length of the DLCI bits.\n\n        This is the EXACT value for the Len field of the\n        Frame Relay Label Range Component.\n\n        The description from rfc3036.txt is:\n\n        'Len\n            This field specifies the number of bits of the DLCI.\n            The following values are supported:\n\n                 Len    DLCI bits\n\n                 0       10\n                 2       23\n\n            Len values 1 and 3 are reserved.'\n\n         Please refer to the following reference for a complete\n         description of this feature.")
mplsLdpEntityFrameRelayLRStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6,
                                                       1, 1, 2, 1, 4), StorageType().clone('nonVolatile')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsLdpEntityFrameRelayLRStorageType.setDescription("The storage type for this conceptual row.\n        Conceptual rows having the value 'permanent(4)'\n        need not allow write-access to any columnar\n        objects in the row.")
mplsLdpEntityFrameRelayLRRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6,
                                                     1, 1, 2, 1, 5), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsLdpEntityFrameRelayLRRowStatus.setDescription("The status of this conceptual row.  All writable\n         objects in this row may be modified at any time,\n         however, as described in detail in the section\n         entitled, 'Changing Values After Session\n         Establishment', and again described in the\n         DESCRIPTION clause of the\n         mplsLdpEntityAdminStatus object,\n         if a session has been initiated with a Peer,\n         changing objects in this table will\n         wreak havoc with the session and interrupt\n         traffic.  To repeat again:\n         the recommended procedure is to set the\n         mplsLdpEntityAdminStatus to down, thereby\n         explicitly causing a session to be torn down. Then,\n         change objects in this entry, then set the\n         mplsLdpEntityAdminStatus to enable which enables\n         a new session to be initiated.")
...
if mibBuilder.loadTexts:
    mplsLdpFrameRelaySessionEntry.setDescription('An entry in this table represents information on a\n        single label range intersection between an\n        LDP Entity and LDP Peer.\n\n        The information contained in a row is read-only.')
mplsLdpFrameRelaySessionMinDlci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1,
                                                  2, 1, 1, 1), DLCI())
if mibBuilder.loadTexts:
    mplsLdpFrameRelaySessionMinDlci.setDescription('The lower bound of DLCIs which are supported.\n        The value of zero is a valid value for the\n        minimum DLCI field of the label.')
mplsLdpFrameRelaySessionMaxDlci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1,
                                                  2, 1, 1, 2), DLCI()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsLdpFrameRelaySessionMaxDlci.setDescription('The upper bound of DLCIs which are supported.')
mplsLdpFrameRelaySessionLen = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1, 2, 1,
                                              1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 2))).clone(namedValues=NamedValues(('tenDlciBits',
                                                                                                                                                                   0), ('twentyThreeDlciBits',
                                                                                                                                                                        2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsLdpFrameRelaySessionLen.setDescription('This object specifies the DLCI bits.')
...
mplsLdpFrameRelayModuleFullCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166,
                                                          6, 2, 2, 1)).setObjects(*(('MPLS-LDP-FRAME-RELAY-STD-MIB', 'mplsLdpFrameRelayGroup'), ))
if mibBuilder.loadTexts:
    mplsLdpFrameRelayModuleFullCompliance.setDescription('The Module is implemented with support for\n        read-create and read-write.  In other words,\n        both monitoring and configuration\n        are available when using this MODULE-COMPLIANCE.')
mplsLdpFrameRelayModuleReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10,
                                                              166, 6, 2, 2, 2)).setObjects(*(('MPLS-LDP-FRAME-RELAY-STD-MIB', 'mplsLdpFrameRelayGroup'), ))
if mibBuilder.loadTexts:
    mplsLdpFrameRelayModuleReadOnlyCompliance.setDescription('The Module is implemented with support for\n        read-only.  In other words, only monitoring\n        is available by implementing this MODULE-COMPLIANCE.')
...
if mibBuilder.loadTexts:
    mplsLdpFrameRelayGroup.setDescription('Objects that apply to all MPLS LDP implementations\n        using Frame Relay as the Layer 2.')
