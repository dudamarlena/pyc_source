...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IF-CAP-STACK-MIB.py
# Compiled at: 2016-02-13 18:16:17
...
if mibBuilder.loadTexts:
    ifCapStackGroup.setDescription('A collection of objects providing information on the\n       cross-connect capability of multi-layer (stacked) network\n       interfaces.')
