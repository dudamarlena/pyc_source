...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/RADIUS-AUTH-SERVER-MIB.py
# Compiled at: 2016-02-13 18:25:34
...
if mibBuilder.loadTexts:
    radiusAuthServMIB.setLastUpdated('200608210000Z')
if mibBuilder.loadTexts:
    radiusAuthServMIB.setOrganization('IETF RADIUS Extensions Working Group.')
if mibBuilder.loadTexts:
    radiusAuthServMIB.setContactInfo(' Bernard Aboba\n                Microsoft\n                One Microsoft Way\n                Redmond, WA  98052\n                US\n                Phone: +1 425 936 6605\n\n                EMail: bernarda@microsoft.com')
if mibBuilder.loadTexts:
    radiusAuthServMIB.setDescription('The MIB module for entities implementing the server\n              side of the Remote Authentication Dial-In User\n              Service (RADIUS) authentication protocol.  Copyright\n              (C) The Internet Society (2006).  This version of this\n              MIB module is part of RFC 4669; see the RFC itself for\n              full legal notices.')
...
if mibBuilder.loadTexts:
    radiusAuthServTotalMalformedAccessRequests.setDescription('The number of malformed RADIUS Access-Request\n             packets received.  Bad authenticators\n             and unknown types are not included as\n             malformed Access-Requests.')
...
if mibBuilder.loadTexts:
    radiusAuthClientEntry.setDescription('An entry (conceptual row) representing a RADIUS\n              authentication client with which the server shares a\n              secret.')
...
if mibBuilder.loadTexts:
    radiusAuthServAccessRequests.setDescription('The number of packets received on the authentication\n\n              port from this client.')
...
if mibBuilder.loadTexts:
    radiusAuthServDupAccessRequests.setDescription('The number of duplicate RADIUS Access-Request\n              packets received from this client.')
...
if mibBuilder.loadTexts:
    radiusAuthServAccessAccepts.setDescription('The number of RADIUS Access-Accept packets\n              sent to this client.')
...
if mibBuilder.loadTexts:
    radiusAuthServAccessRejects.setDescription('The number of RADIUS Access-Reject packets\n              sent to this client.')
...
if mibBuilder.loadTexts:
    radiusAuthServAccessChallenges.setDescription('The number of RADIUS Access-Challenge packets\n              sent to this client.')
...
if mibBuilder.loadTexts:
    radiusAuthServMalformedAccessRequests.setDescription('The number of malformed RADIUS Access-Request\n              packets received from this client.\n              Bad authenticators and unknown types are not included\n              as malformed Access-Requests.')
...
if mibBuilder.loadTexts:
    radiusAuthServBadAuthenticators.setDescription('The number of RADIUS Authentication-Request packets\n              that contained invalid Message Authenticator\n              attributes received from this client.')
...
if mibBuilder.loadTexts:
    radiusAuthServPacketsDropped.setDescription('The number of incoming packets from this\n               client silently discarded for some reason other\n               than malformed, bad authenticators or\n               unknown types.')
...
if mibBuilder.loadTexts:
    radiusAuthServUnknownTypes.setDescription('The number of RADIUS packets of unknown type that\n              were received from this client.')
radiusAuthClientExtTable = MibTable((1, 3, 6, 1, 2, 1, 67, 1, 1, 1, 1, 16))
if mibBuilder.loadTexts:
    radiusAuthClientExtTable.setDescription('The (conceptual) table listing the RADIUS\n              authentication clients with which the server shares\n              a secret.')
...
if mibBuilder.loadTexts:
    radiusAuthClientExtEntry.setDescription('An entry (conceptual row) representing a RADIUS\n              authentication client with which the server shares a\n              secret.')
...
if mibBuilder.loadTexts:
    radiusAuthServExtAccessAccepts.setDescription('The number of RADIUS Access-Accept packets\n              sent to this client.  This counter may experience a\n              discontinuity when the RADIUS Server module within the\n              managed entity is reinitialized, as indicated by the\n              current value of radiusAuthServCounterDiscontinuity.')
...
if mibBuilder.loadTexts:
    radiusAuthServExtAccessRejects.setDescription('The number of RADIUS Access-Reject packets\n              sent to this client.  This counter may experience a\n              discontinuity when the RADIUS Server module within the\n\n              managed entity is reinitialized, as indicated by the\n              current value of radiusAuthServCounterDiscontinuity.')
...
if mibBuilder.loadTexts:
    radiusAuthServExtAccessChallenges.setDescription('The number of RADIUS Access-Challenge packets\n              sent to this client.  This counter may experience a\n              discontinuity when the RADIUS Server module within the\n              managed entity is reinitialized, as indicated by the\n              current value of radiusAuthServCounterDiscontinuity.')
...
if mibBuilder.loadTexts:
    radiusAuthServExtUnknownTypes.setDescription('The number of RADIUS packets of unknown type that\n              were received from this client.  This counter may\n              experience a discontinuity when the RADIUS Server\n              module within the managed entity is reinitialized, as\n              indicated by the current value of\n              radiusAuthServCounterDiscontinuity.')
...
if mibBuilder.loadTexts:
    radiusAuthServMIBExtCompliance.setDescription('The compliance statement for authentication\n                   servers implementing the RADIUS Authentication\n                   Server IPv6 Extensions MIB.  Implementation of\n                   this module is for entities that support IPv6,\n                   or support IPv4 and IPv6.')
...
if mibBuilder.loadTexts:
    radiusAuthServMIBGroup.setDescription('The collection of objects providing management of\n             a RADIUS Authentication Server.')
...
if mibBuilder.loadTexts:
    radiusAuthServExtMIBGroup.setDescription('The collection of objects providing management of\n             a RADIUS Authentication Server.')
