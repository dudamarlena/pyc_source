...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/UDP-MIB.py
# Compiled at: 2016-02-13 18:32:28
...
if mibBuilder.loadTexts:
    udpLocalAddress.setDescription('The local IP address for this UDP listener.  In the\n               case of a UDP listener that is willing to accept\n               datagrams for any IP interface associated with the\n               node, the value 0.0.0.0 is used.')
...
if mibBuilder.loadTexts:
    udpGroup.setDescription('The deprecated group of objects providing for\n               management of UDP over IPv4.')
...
if mibBuilder.loadTexts:
    udpBaseGroup.setDescription('The group of objects providing for counters of UDP\n               statistics.')
udpHCGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 50, 2, 2, 3)).setObjects(*(('UDP-MIB', 'udpHCInDatagrams'), ('UDP-MIB', 'udpHCOutDatagrams')))
if mibBuilder.loadTexts:
    udpHCGroup.setDescription('The group of objects providing for counters of high\n               speed UDP implementations.')
udpEndpointGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 50, 2, 2, 4)).setObjects(*(('UDP-MIB', 'udpEndpointProcess'), ))
if mibBuilder.loadTexts:
    udpEndpointGroup.setDescription("The group of objects providing for the IP version\n               independent management of UDP 'endpoints'.")
