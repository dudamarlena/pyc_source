...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/FCIP-MGMT-MIB.py
...
if mibBuilder.loadTexts:
    fcipMIB.setLastUpdated('200602060000Z')
if mibBuilder.loadTexts:
    fcipMIB.setOrganization('IETF IPFC Working Group')
if mibBuilder.loadTexts:
    fcipMIB.setContactInfo('Anil Rijhsinghani\n                  Accton Technology Corporation\n                  5 Mount Royal Ave\n                  Marlboro, MA 01752 USA.\n\n\n\n                  Ravi Natarajan\n                  F5 Networks\n                  2460 North First Street, Suite 100\n                  San Jose, CA 95131 USA.')
if mibBuilder.loadTexts:
    fcipMIB.setDescription('The module defines management information specific to\n         FCIP devices.\n\n         Copyright(C) The Internet Society (2006).  This version\n         of this MIB module is part of RFC 4404; see the RFC\n         itself for full legal notices.')
...
fcipDynIpConfType = MibScalar((1, 3, 6, 1, 2, 1, 224, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('slpv2',
                                                                                                                                                                              1), ('none',
                                                                                                                                                                                   2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    fcipDynIpConfType.setDescription('The type of discovery protocol used to discover remote\n         FCIP entities.  The value of this object is persistent\n         across system restarts.')
fcipDeviceWWN = MibScalar((1, 3, 6, 1, 2, 1, 224, 1, 1, 2), FcNameIdOrZero()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipDeviceWWN.setDescription('The World Wide Name of this FCIP device.')
fcipEntitySACKOption = MibScalar((1, 3, 6, 1, 2, 1, 224, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('enabled',
                                                                                                                                                                                 1), ('disabled',
                                                                                                                                                                                      2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipEntitySACKOption.setDescription('Indication of whether the TCP Selective Acknowledgement\n         Option is enabled at this FCIP device to let the receiver\n         acknowledge multiple lost packets in a single ACK for faster\n\n\n\n         recovery.')
fcipEntityInstanceTable = MibTable((1, 3, 6, 1, 2, 1, 224, 1, 1, 4))
if mibBuilder.loadTexts:
    fcipEntityInstanceTable.setDescription("Information about this FCIP device's existing instances of\n         FCIP entities.")
fcipEntityInstanceEntry = MibTableRow((1, 3, 6, 1, 2, 1, 224, 1, 1, 4, 1)).setIndexNames((0,
                                                                                          'FCIP-MGMT-MIB',
                                                                                          'fcipEntityId'))
if mibBuilder.loadTexts:
    fcipEntityInstanceEntry.setDescription('A conceptual row of the FCIP entity table with information\n         about a particular FCIP entity.  Once a row has been\n         created, it is non-volatile across agent restarts until it\n         is deleted.')
fcipEntityId = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 4, 1, 1), FcipEntityId())
if mibBuilder.loadTexts:
    fcipEntityId.setDescription('The FCIP entity identifier.')
...
if mibBuilder.loadTexts:
    fcipDiscoveryDomainIndex.setDescription('An integer that uniquely identifies an FCIP Discovery Domain\n         associated with this FCIP entity.')
...
if mibBuilder.loadTexts:
    fcipDiscoveryDomainName.setDescription('The name of this FCIP Discovery Domain.')
fcipLinkErrorsTable = MibTable((1, 3, 6, 1, 2, 1, 224, 1, 1, 10))
if mibBuilder.loadTexts:
    fcipLinkErrorsTable.setDescription('A list of error counters for FCIP Links.  Each counter\n         records the number of times a particular error happened that\n         caused a TCP connection to close down.')
fcipLinkErrorsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1)).setIndexNames((0,
                                                                                       'FCIP-MGMT-MIB',
                                                                                       'fcipEntityId'), (0,
                                                                                                         'FCIP-MGMT-MIB',
                                                                                                         'fcipLinkIndex'))
if mibBuilder.loadTexts:
    fcipLinkErrorsEntry.setDescription('A conceptual row of the FCIP Link Errors Table containing\n         error counters for an FCIP Link.')
fcipLinkFcipLossofFcSynchs = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipLossofFcSynchs.setDescription('The number of times FC synchronization was lost on this FCIP\n\n\n\n         Link.  The last discontinuity of this counter is indicated\n         by fcipLinkCreateTime.')
fcipLinkFcipEncapErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipEncapErrors.setDescription('The number of FCIP frames received with encapsulation errors\n         such as improper header, format, or length.  The last\n         discontinuity of this counter is indicated by\n         fcipLinkCreateTime.')
fcipLinkFcipNotReceivedSfResps = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1,
                                                 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipNotReceivedSfResps.setDescription('The number of times an FCIP Special Frame Response was\n         expected but not received on this FCIP Link.  The last\n         discontinuity of this counter is indicated by\n         fcipLinkCreateTime.')
fcipLinkFcipSfRespMismatches = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1,
                                               4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipSfRespMismatches.setDescription('The number of times FCIP Special Frame Bytes mismatch\n         happened on this FCIP Link.  The last discontinuity of this\n         counter is indicated by fcipLinkCreateTime.')
fcipLinkFcipSfInvalidNonces = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipSfInvalidNonces.setDescription('The number of times FCIP Special Frame Invalid Connection\n         Nonce happened on this FCIP Link.  The last discontinuity\n         of this counter is indicated by fcipLinkCreateTime.')
fcipLinkFcipReceivedSfDuplicates = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10,
                                                   1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipReceivedSfDuplicates.setDescription('The number of times duplicate FCIP Special Frames were\n         received on this FCIP Link.  The last discontinuity of this\n         counter is indicated by fcipLinkCreateTime.')
fcipLinkFcipSfInvalidWWNs = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipSfInvalidWWNs.setDescription('The number of times FCIP Special Frames with invalid\n         destination FC Fabric Entity WWN were received on this FCIP\n         Link.  The last discontinuity of this counter is indicated\n         by fcipLinkCreateTime.')
fcipLinkFcipBB2LkaTimeOuts = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1, 8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipBB2LkaTimeOuts.setDescription('The number of FC Keep Alive Time-outs that occurred on\n         this FCIP Link.  The last discontinuity of this counter\n         is indicated by fcipLinkCreateTime.')
fcipLinkFcipSntpExpiredTimeStamps = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10,
                                                    1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkFcipSntpExpiredTimeStamps.setDescription('The number of frames discarded due to an expired Simple\n         Network Time Protocol (SNTP) timestamp on this FCIP Link.\n         The last discontinuity of this counter is indicated by\n         fcipLinkCreateTime.')
fcipLinkTcpTooManyErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1, 10), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkTcpTooManyErrors.setDescription('The number of TCP connections that closed down on this\n         FCIP Link due to too many errors on the connection.  The\n         last discontinuity of this counter is indicated by\n\n\n\n         fcipLinkCreateTime.')
fcipLinkTcpExcessiveDroppedDatagrams = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1,
                                                       10, 1, 11), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkTcpExcessiveDroppedDatagrams.setDescription('The number of TCP connections that closed down on this\n         FCIP Link due to an excessive number of dropped FCIP\n         packets.  The last discontinuity of this counter is\n         indicated by fcipLinkCreateTime.')
fcipLinkTcpSaParamMismatches = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 10, 1,
                                               12), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcipLinkTcpSaParamMismatches.setDescription('The number of times TCP connections with Security\n         Association parameter mismatches were closed down on this\n         FCIP Link.  The last discontinuity of this counter is\n         indicated by fcipLinkCreateTime.')
...
if mibBuilder.loadTexts:
    fcipCompliance.setDescription('Compliance statement for FCIP MIB.')
...
if mibBuilder.loadTexts:
    fcipEntityScalarGroup.setDescription('Collection of scalar objects applicable to all FCIP\n         instances.')
...
if mibBuilder.loadTexts:
    fcipEntityInstanceGroup.setDescription('A collection of objects providing information about FCIP\n         instances.')
...
if mibBuilder.loadTexts:
    fcipLinkGroup.setDescription('A collection of objects providing information about FCIP\n         Links.')
...
if mibBuilder.loadTexts:
    fcipTcpConnGroup.setDescription('A collection of objects providing information about FCIP\n         TCP connections.')
fcipDiscoveryDomainGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 224, 2, 2, 5)).setObjects(*(('FCIP-MGMT-MIB', 'fcipDiscoveryDomainName'), ))
if mibBuilder.loadTexts:
    fcipDiscoveryDomainGroup.setDescription('A collection of objects providing information about FCIP\n         Discovery Domains.')
...
if mibBuilder.loadTexts:
    fcipLinkErrorsGroup.setDescription('A collection of objects providing information about FCIP\n         link errors.')
fcipDynamicRouteGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 224, 2, 2, 7)).setObjects(*(('FCIP-MGMT-MIB', 'fcipDynamicRouteLinkIndex'), ))
if mibBuilder.loadTexts:
    fcipDynamicRouteGroup.setDescription('A collection of objects providing information about FCIP\n         dynamic routes.')
...
if mibBuilder.loadTexts:
    fcipStaticRouteGroup.setDescription('A collection of objects providing information about FCIP\n         static routes.')
