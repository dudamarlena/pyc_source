...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SIP-SERVER-MIB.py
# Compiled at: 2016-02-13 18:28:12
...
if mibBuilder.loadTexts:
    sipServerRegCfgTable.setDescription('This table contains configuration objects applicable to SIP\n        Registrars.')
sipServerRegCfgEntry = MibTableRow((1, 3, 6, 1, 2, 1, 151, 1, 5, 1, 1)).setIndexNames((0,
                                                                                       'NETWORK-SERVICES-MIB',
                                                                                       'applIndex'))
if mibBuilder.loadTexts:
    sipServerRegCfgEntry.setDescription('A row of common Registrar configuration.\n\n        Each row represents those objects for a particular SIP server\n        present in this system.  applIndex is used to uniquely identify\n        these instances of SIP servers and correlate them through the\n        common framework of the NETWORK-SERVICES-MIB (RFC 2788).  The\n        same value of applIndex used in the corresponding\n        SIP-COMMON-MIB is used here.')
sipServerRegMaxContactExpiryDuration = MibTableColumn((1, 3, 6, 1, 2, 1, 151, 1, 5,
                                                       1, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295))).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipServerRegMaxContactExpiryDuration.setDescription('This object reflects the maximum expiry that may be requested\n        by a User Agent for a particular Contact.  User Agents can\n        specify expiry using either an Expiry header in a REGISTER\n        request, or using an Expires parameter in a Contact header in\n        a REGISTER request.  If the value requested by the User Agent\n        is greater than the value of this object, then the contact\n        information is given the duration specified by this object, and\n        that duration is indicated to the User Agent in the response.')
...
if mibBuilder.loadTexts:
    sipServerRegMaxUsers.setDescription('This object reflects the maximum number of users that the\n        Registrar supports.  The current number of users is reflected\n        by sipServerRegCurrentUsers.')
...
if mibBuilder.loadTexts:
    sipServerRegCurrentUsers.setDescription('This object reflects the number of users currently registered\n        with the Registrar.')
sipServerRegDfltRegActiveInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 151, 1, 5, 1,
                                                    1, 4), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4294967295))).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipServerRegDfltRegActiveInterval.setDescription("This object reflects the default time interval the Registrar\n        considers registrations to be active.  The value is used to\n        compute the Expires header in the REGISTER response.  If a user\n        agent requests a time interval shorter than specified by this\n        object, the Registrar SHOULD honor that request.  If a Contact\n        entry does not have an 'expires' parameter, the value of the\n        Expires header field is used instead.  If a Contact entry has no\n        'expires' parameter and no Expires header field is present,\n        the value of this object is used as the default value.")
sipServerRegUserTable = MibTable((1, 3, 6, 1, 2, 1, 151, 1, 5, 2))
if mibBuilder.loadTexts:
    sipServerRegUserTable.setDescription('This table contains information on all users registered to each\n        Registrar in this system.')
sipServerRegUserEntry = MibTableRow((1, 3, 6, 1, 2, 1, 151, 1, 5, 2, 1)).setIndexNames((0,
                                                                                        'NETWORK-SERVICES-MIB',
                                                                                        'applIndex'), (0,
                                                                                                       'SIP-SERVER-MIB',
                                                                                                       'sipServerRegUserIndex'))
if mibBuilder.loadTexts:
    sipServerRegUserEntry.setDescription('This entry contains information for a single user registered to\n        this Registrar.\n\n        Each row represents those objects for a particular SIP server\n        present in this system.  applIndex is used to uniquely identify\n        these instances of SIP servers and correlate them through the\n        common framework of the NETWORK-SERVICES-MIB (RFC 2788).  The\n        same value of applIndex used in the corresponding\n        SIP-COMMON-MIB is used here.')
...
if mibBuilder.loadTexts:
    sipServerProxyServerCompliance.setDescription('The compliance statement for SIP entities acting as Proxy\n        Servers.')
sipRedirectServerCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 151, 2, 1, 2)).setObjects(*(('SIP-SERVER-MIB', 'sipServerConfigGroup'), ))
if mibBuilder.loadTexts:
    sipRedirectServerCompliance.setDescription('The compliance statement for SIP entities acting as Redirect\n        Servers.')
sipServerRegistrarServerCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 151, 2, 1,
                                                       3)).setObjects(*(('SIP-SERVER-MIB', 'sipServerConfigGroup'), ('SIP-SERVER-MIB', 'sipServerRegistrarConfigGroup'), ('SIP-SERVER-MIB', 'sipServerRegistrarStatsGroup'), ('SIP-SERVER-MIB', 'sipServerRegistrarUsersGroup')))
if mibBuilder.loadTexts:
    sipServerRegistrarServerCompliance.setDescription('The compliance statement for SIP entities acting as\n        Registrars.')
...
if mibBuilder.loadTexts:
    sipServerConfigGroup.setDescription('A collection of objects providing configuration common to SIP\n        Proxy and Redirect servers.')
...
if mibBuilder.loadTexts:
    sipServerProxyConfigGroup.setDescription('A collection of objects providing configuration for SIP Proxy\n        servers.')
...
if mibBuilder.loadTexts:
    sipServerProxyStatsGroup.setDescription('A collection of objects providing statistics for SIP Proxy\n        servers.')
...
if mibBuilder.loadTexts:
    sipServerRegistrarConfigGroup.setDescription('A collection of objects providing configuration for SIP\n        Registrars.')
...
if mibBuilder.loadTexts:
    sipServerRegistrarStatsGroup.setDescription('A collection of objects providing statistics for SIP\n        Registrars.')
