...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/PPP-SEC-MIB.py
# Compiled at: 2016-02-13 18:24:35
...
if mibBuilder.loadTexts:
    pppSecurityConfigTable.setDescription('Table containing the configuration and\n                         preference parameters for PPP Security.')
pppSecurityConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 23, 2, 2, 1)).setIndexNames((0,
                                                                                         'PPP-SEC-MIB',
                                                                                         'pppSecurityConfigLink'), (0,
                                                                                                                    'PPP-SEC-MIB',
                                                                                                                    'pppSecurityConfigPreference'))
if mibBuilder.loadTexts:
    pppSecurityConfigEntry.setDescription('Security configuration information for a\n                         particular PPP link.')
...
if mibBuilder.loadTexts:
    pppSecuritySecretsSecret.setDescription('The secret of the ID/Secret pair.  The actual\n                         format, semantics, and use of\n                         pppSecuritySecretsSecret depends on the actual\n                         security protocol used.  For example, if\n                         pppSecuritySecretsProtocol is\n                         pppSecurityPapProtocol then this object will\n                         contain a PAP Password. If\n                         pppSecuritySecretsProtocol is\n                         pppSecurityChapMD5Protocol then this object\n                         would contain the CHAP MD5 Secret.')
pppSecuritySecretsStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 23, 2, 3, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('invalid',
                                                                                                                                                                                                1), ('valid',
                                                                                                                                                                                                     2))).clone('valid')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    pppSecuritySecretsStatus.setDescription('Setting this object to the value invalid(1)\n                         has the effect of invalidating the\n                         corresponding entry in the\n                         pppSecuritySecretsTable. It is an\n                         implementation-specific matter as to whether\n                         the agent removes an invalidated entry from the\n                         table.  Accordingly, management stations must\n                         be prepared to receive tabular information from\n                         agents that corresponds to entries not\n                         currently in use.  Proper interpretation of\n                         such entries requires examination of the\n                         relevant pppSecuritySecretsStatus object.')
