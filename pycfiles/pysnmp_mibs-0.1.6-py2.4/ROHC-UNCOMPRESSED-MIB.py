...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ROHC-UNCOMPRESSED-MIB.py
# Compiled at: 2016-02-13 18:27:12
...
if mibBuilder.loadTexts:
    rohcUncmprContextTable.setDescription('This table lists and describes ROHC uncompressed profile\n         specific properties of compressor contexts and\n         decompressor contexts.  It extends the rohcContextTable\n         of the ROHC-MIB module.')
rohcUncmprContextEntry = MibTableRow((1, 3, 6, 1, 2, 1, 113, 1, 1, 1)).setIndexNames((0,
                                                                                      'ROHC-MIB',
                                                                                      'rohcChannelID'), (0,
                                                                                                         'ROHC-MIB',
                                                                                                         'rohcContextCID'))
if mibBuilder.loadTexts:
    rohcUncmprContextEntry.setDescription('An entry describing a particular context.')
rohcUncmprContextState = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('initAndRefresh',
                                                                                                                                                                                                 1), ('normal',
                                                                                                                                                                                                      2), ('noContext',
                                                                                                                                                                                                           3), ('fullContext',
                                                                                                                                                                                                                4)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    rohcUncmprContextState.setDescription('State of the context. States initAndRefresh(1) and normal(2)\n         are states of compressor contexts, states noContext(3)\n         and fullContext(4) are states of decompressor contexts.')
rohcUncmprContextMode = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('unidirectional',
                                                                                                                                                                                          1), ('bidirectional',
                                                                                                                                                                                               2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    rohcUncmprContextMode.setDescription('Mode of the context.')
rohcUncmprContextACKs = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    rohcUncmprContextACKs.setDescription('The number of all positive feedbacks (ACK) sent or\n         received in this context, respectively.\n\n         Discontinuities in the value of this counter can\n         occur at re-initialization of the management\n         system, and at other times as indicated by the\n         value of ifCounterDiscontinuityTime.  For checking\n         ifCounterDiscontinuityTime, the interface index is\n         required.  It can be determined by reading the\n         rohcChannelTable of the ROHC-MIB.')
...
if mibBuilder.loadTexts:
    rohcUncmprContextGroup.setDescription('A collection of objects providing information about\n         ROHC uncompressed compressors and decompressors.')
rohcUncmprStatisticsGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 113, 2, 2, 2)).setObjects(*(('ROHC-UNCOMPRESSED-MIB', 'rohcUncmprContextACKs'), ))
if mibBuilder.loadTexts:
    rohcUncmprStatisticsGroup.setDescription('An object providing context statistics.')
