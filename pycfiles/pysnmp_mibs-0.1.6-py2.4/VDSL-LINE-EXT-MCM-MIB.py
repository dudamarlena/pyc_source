...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/VDSL-LINE-EXT-MCM-MIB.py
...
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTable.setDescription('This table contains additional information on multiple\n        carrier VDSL lines.  One entry in this table reflects a\n        profile defined by a manager which can be used to\n        configure the VDSL line.\n\n        If an entry in this table is referenced by a line which\n        does not use MCM, it has no effect on the operation of that\n        line.\n\n        All read-create-objects defined in this table SHOULD be\n        stored persistently.')
vdslLineMCMConfProfileEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 1, 1)).setIndexNames((0,
                                                                                                  'VDSL-LINE-MIB',
                                                                                                  'vdslLineConfProfileName'))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileEntry.setDescription('Each entry consists of a list of parameters that\n        represents the configuration of a multiple carrier\n        modulation VDSL modem.')
vdslLineMCMConfProfileTxWindowLength = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                       1, 1, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 255))).setUnits('samples').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxWindowLength.setDescription('Specifies the length of the transmit window, counted\n        in samples at the sampling rate corresponding to the\n        negotiated value of N.')
vdslLineMCMConfProfileRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                  1, 1, 2), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRowStatus.setDescription("This object is used to create a new row or modify or\n        delete an existing row in this table.\n\n        A profile is activated by setting this object to `active'.\n        When `active' is set, the system will validate the profile.\n\n        None of the columns in this row may be modified while the\n        row is in the 'active' state.\n\n        Before a profile can be deleted or taken out of\n        service, (by setting this object to `destroy' or\n        `notInService') it must first be unreferenced\n        from all associated lines.")
vdslLineMCMConfProfileTxBandTable = MibTable((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 2))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxBandTable.setDescription('This table contains transmit band descriptor configuration\n        information for a VDSL line.  Each entry in this table\n        reflects the configuration for one of possibly many bands\n        with a multiple carrier modulation (MCM) VDSL line.\n        These entries are defined by a manager and can be used to\n        configure the VDSL line.\n\n        If an entry in this table is referenced by a line which\n        does not use MCM, it has no effect on the operation of that\n        line.\n\n        All read-create-objects defined in this table SHOULD be\n        stored persistently.')
vdslLineMCMConfProfileTxBandEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 2,
                                                 1)).setIndexNames((0, 'VDSL-LINE-MIB',
                                                                    'vdslLineConfProfileName'), (0,
                                                                                                 'VDSL-LINE-EXT-MCM-MIB',
                                                                                                 'vdslLineMCMConfProfileTxBandNumber'))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxBandEntry.setDescription('Each entry consists of a transmit band descriptor, which\n        is defined by a start and a stop tone index.')
vdslLineMCMConfProfileTxBandNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                     1, 2, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096)))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxBandNumber.setDescription('The index for this band descriptor entry.')
vdslLineMCMConfProfileTxBandStart = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                    2, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxBandStart.setDescription('Start tone index for this band.')
vdslLineMCMConfProfileTxBandStop = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                   2, 1, 3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxBandStop.setDescription('Stop tone index for this band.')
vdslLineMCMConfProfileTxBandRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229,
                                                        1, 1, 2, 1, 4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxBandRowStatus.setDescription("This object is used to create a new row or modify or\n        delete an existing row in this table.\n        A profile is activated by setting this object to `active'.\n        When `active' is set, the system will validate the profile.\n\n\n\n\n        Each entry must be internally consistent, the Stop Tone must\n        be greater than the Start Tone.  Each entry must also be\n        externally consistent, all entries indexed by a specific\n        profile must not overlap.  Validation of the profile will\n        check both internal and external consistency.\n\n        None of the columns in this row may be modified while the\n        row is in the 'active' state.\n\n        Before a profile can be deleted or taken out of\n        service, (by setting this object to `destroy' or\n        `notInService') it must be first unreferenced\n        from all associated lines.")
vdslLineMCMConfProfileRxBandTable = MibTable((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 3))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRxBandTable.setDescription('This table contains receive band descriptor configuration\n        information for a VDSL line.  Each entry in this table\n        reflects the configuration for one of possibly many bands\n        with a multiple carrier modulation (MCM) VDSL line.\n        These entries are defined by a manager and can be used to\n        configure the VDSL line.\n\n        If an entry in this table is referenced by a line which\n        does not use MCM, it has no effect on the operation of that\n        line.\n\n        All read-create-objects defined in this table SHOULD be\n        stored persistently.')
vdslLineMCMConfProfileRxBandEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 3,
                                                 1)).setIndexNames((0, 'VDSL-LINE-MIB',
                                                                    'vdslLineConfProfileName'), (0,
                                                                                                 'VDSL-LINE-EXT-MCM-MIB',
                                                                                                 'vdslLineMCMConfProfileRxBandNumber'))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRxBandEntry.setDescription('Each entry consists of a transmit band descriptor, which\n        is defined by a start and a stop tone index.')
vdslLineMCMConfProfileRxBandNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                     1, 3, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096)))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRxBandNumber.setDescription('The index for this band descriptor entry.')
vdslLineMCMConfProfileRxBandStart = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                    3, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRxBandStart.setDescription('Start tone index for this band.')
vdslLineMCMConfProfileRxBandStop = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                   3, 1, 3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRxBandStop.setDescription('Stop tone index for this band.')
vdslLineMCMConfProfileRxBandRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229,
                                                        1, 1, 3, 1, 4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileRxBandRowStatus.setDescription("This object is used to create a new row or modify or\n        delete an existing row in this table.\n\n        A profile is activated by setting this object to `active'.\n        When `active' is set, the system will validate the profile.\n        Each entry must be internally consistent, the Stop Tone must\n        be greater than the Start Tone.  Each entry must also be\n        externally consistent, all entries indexed by a specific\n\n\n\n        profile must not overlap.  Validation of the profile will\n        check both internal and external consistency.\n\n        None of the columns in this row may be modified while the\n        row is in the 'active' state.\n\n        Before a profile can be deleted or taken out of\n        service, (by setting this object to `destroy' or\n        `notInService') it must be first unreferenced\n        from all associated lines.")
vdslLineMCMConfProfileTxPSDTable = MibTable((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 4))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxPSDTable.setDescription('This table contains transmit PSD mask descriptor\n        configuration information for a VDSL line.  Each entry in\n        this table reflects the configuration for one tone within\n        a multiple carrier modulation (MCM) VDSL line.  These\n        entries are defined by a manager and can be used to\n        configure the VDSL line.\n\n        If an entry in this table is referenced by a line which\n        does not use MCM, it has no effect on the operation of that\n        line.\n\n        All read-create-objects defined in this table SHOULD be\n        stored persistently.')
vdslLineMCMConfProfileTxPSDEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 4,
                                                1)).setIndexNames((0, 'VDSL-LINE-MIB',
                                                                   'vdslLineConfProfileName'), (0,
                                                                                                'VDSL-LINE-EXT-MCM-MIB',
                                                                                                'vdslLineMCMConfProfileTxPSDNumber'))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxPSDEntry.setDescription('Each entry consists of a transmit PSD mask descriptor,\n        which defines the power spectral density (PSD) for a tone.')
vdslLineMCMConfProfileTxPSDNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                    4, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096)))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxPSDNumber.setDescription('The index for this mask descriptor entry.')
vdslLineMCMConfProfileTxPSDTone = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                  4, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxPSDTone.setDescription('The tone index for which the PSD is being specified.')
vdslLineMCMConfProfileTxPSDPSD = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 4,
                                                 1, 3), Unsigned32()).setUnits('0.5dBm/Hz').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxPSDPSD.setDescription('Power Spectral Density level in steps of 0.5dBm/Hz with\n        an offset of -140dBm/Hz.')
vdslLineMCMConfProfileTxPSDRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                       1, 4, 1, 4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileTxPSDRowStatus.setDescription("This object is used to create a new row or modify or\n        delete an existing row in this table.\n\n        A profile is activated by setting this object to `active'.\n        When `active' is set, the system will validate the profile.\n\n        None of the columns in this row may be modified while the\n        row is in the 'active' state.\n\n        Before a profile can be deleted or taken out of\n\n\n\n        service, (by setting this object to `destroy' or\n        `notInService') it must be first unreferenced\n        from all associated lines.")
vdslLineMCMConfProfileMaxTxPSDTable = MibTable((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 5))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxTxPSDTable.setDescription('This table contains transmit maximum PSD mask descriptor\n        configuration information for a VDSL line.  Each entry in\n        this table reflects the configuration for one tone within\n        a multiple carrier modulation (MCM) VDSL modem.  These\n        entries are defined by a manager and can be used to\n        configure the VDSL line.\n\n        If an entry in this table is referenced by a line which\n        does not use MCM, it has no effect on the operation of that\n        line.\n\n        All read-create-objects defined in this table SHOULD be\n        stored persistently.')
vdslLineMCMConfProfileMaxTxPSDEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                   5, 1)).setIndexNames((0, 'VDSL-LINE-MIB',
                                                                         'vdslLineConfProfileName'), (0,
                                                                                                      'VDSL-LINE-EXT-MCM-MIB',
                                                                                                      'vdslLineMCMConfProfileMaxTxPSDNumber'))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxTxPSDEntry.setDescription('Each entry consists of a transmit PSD mask descriptor,\n        which defines the maximum power spectral density (PSD)\n        for a tone.')
vdslLineMCMConfProfileMaxTxPSDNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                       1, 5, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096)))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxTxPSDNumber.setDescription('The index for this band descriptor entry.')
vdslLineMCMConfProfileMaxTxPSDTone = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                     1, 5, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxTxPSDTone.setDescription('The tone index for which the PSD is being specified.\n         There must not be multiple rows defined, for a particular\n         profile, with the same value for this field.')
vdslLineMCMConfProfileMaxTxPSDPSD = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                    5, 1, 3), Unsigned32()).setUnits('0.5dBm/Hz').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxTxPSDPSD.setDescription('Power Spectral Density level in steps of 0.5dBm/Hz with\n        an offset of -140dBm/Hz.')
vdslLineMCMConfProfileMaxTxPSDRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229,
                                                          1, 1, 5, 1, 4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxTxPSDRowStatus.setDescription("This object is used to create a new row or modify or\n        delete an existing row in this table.\n        A profile is activated by setting this object to `active'.\n        When `active' is set, the system will validate the profile.\n        There must be only one entry in this table for each tone\n        associated with a specific profile.  This will be checked\n        during the validation process.\n\n        None of the columns in this row may be modified while the\n        row is in the 'active' state.\n\n        Before a profile can be deleted or taken out of\n        service, (by setting this object to `destroy' or\n        `notInService') it must be first unreferenced\n        from all associated lines.")
vdslLineMCMConfProfileMaxRxPSDTable = MibTable((1, 3, 6, 1, 2, 1, 10, 229, 1, 1, 6))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxRxPSDTable.setDescription('This table contains maximum receive PSD mask descriptor\n        configuration information for a VDSL line.  Each entry in\n        this table reflects the configuration for one tone within\n        a multiple carrier modulation (MCM) VDSL modem.  These\n        entries are defined by a manager and can be used to\n        configure the VDSL line.\n\n        If an entry in this table is referenced by a line which\n        does not use MCM, it has no effect on the operation of that\n        line.\n\n        All read-create-objects defined in this table SHOULD be\n        stored persistently.')
vdslLineMCMConfProfileMaxRxPSDEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                   6, 1)).setIndexNames((0, 'VDSL-LINE-MIB',
                                                                         'vdslLineConfProfileName'), (0,
                                                                                                      'VDSL-LINE-EXT-MCM-MIB',
                                                                                                      'vdslLineMCMConfProfileMaxRxPSDNumber'))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxRxPSDEntry.setDescription('Each entry consists of a transmit PSD mask descriptor,\n        which defines the power spectral density (PSD) for a\n        tone.')
vdslLineMCMConfProfileMaxRxPSDNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                       1, 6, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096)))
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxRxPSDNumber.setDescription('The index for this band descriptor entry.')
vdslLineMCMConfProfileMaxRxPSDTone = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1,
                                                     1, 6, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4096))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxRxPSDTone.setDescription('The tone index for which the PSD is being specified.\n         There must not be multiple rows defined, for a particular\n         profile, with the same value for this field.')
vdslLineMCMConfProfileMaxRxPSDPSD = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229, 1, 1,
                                                    6, 1, 3), Unsigned32()).setUnits('0.5dBm/Hz').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxRxPSDPSD.setDescription('Power Spectral Density level in steps of 0.5dBm/Hz with\n        an offset of -140dBm/Hz.')
vdslLineMCMConfProfileMaxRxPSDRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 229,
                                                          1, 1, 6, 1, 4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    vdslLineMCMConfProfileMaxRxPSDRowStatus.setDescription("This object is used to create a new row or modify or\n        delete an existing row in this table.\n\n        A profile is activated by setting this object to `active'.\n        When `active' is set, the system will validate the profile.\n        There must be only one entry in this table for each tone\n        associated with a specific profile.  This will be checked\n        during the validation process.\n\n        None of the columns in this row may be modified while the\n        row is in the 'active' state.\n\n        Before a profile can be deleted or taken out of\n        service, (by setting this object to `destroy' or\n        `notInService') it must be first unreferenced\n        from all associated lines.")
...
vdslLineExtMCMMibCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 229, 1, 2, 2,
                                                1)).setObjects(*(('VDSL-LINE-EXT-MCM-MIB', 'vdslLineExtMCMGroup'), ))
if mibBuilder.loadTexts:
    vdslLineExtMCMMibCompliance.setDescription('The compliance statement for SNMP entities which\n        manage VDSL interfaces.')
...
if mibBuilder.loadTexts:
    vdslLineExtMCMGroup.setDescription('A collection of objects providing configuration\n\n\n\n             information for a VDSL line based upon multiple\n             carrier modulation modem.')
