...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IPV6-MIB.py
# Compiled at: 2016-02-13 18:18:33
(Integer, ObjectIdentifier, OctetString) = mibBuilder.importSymbols('ASN1', 'Integer', 'ObjectIdentifier', 'OctetString')
(NamedValues,) = mibBuilder.importSymbols('ASN1-ENUMERATION', 'NamedValues')
(ValueRangeConstraint, ValueSizeConstraint, ConstraintsIntersection, SingleValueConstraint, ConstraintsUnion) = mibBuilder.importSymbols('ASN1-REFINEMENT', 'ValueRangeConstraint', 'ValueSizeConstraint', 'ConstraintsIntersection', 'SingleValueConstraint', 'ConstraintsUnion')
(Ipv6IfIndex, Ipv6Address, Ipv6IfIndexOrZero, Ipv6AddressPrefix, Ipv6AddressIfIdentifier) = mibBuilder.importSymbols('IPV6-TC', 'Ipv6IfIndex', 'Ipv6Address', 'Ipv6IfIndexOrZero', 'Ipv6AddressPrefix', 'Ipv6AddressIfIdentifier')
...
(TruthValue, PhysAddress, DisplayString, TextualConvention, VariablePointer, RowPointer, TimeStamp) = mibBuilder.importSymbols('SNMPv2-TC', 'TruthValue', 'PhysAddress', 'DisplayString', 'TextualConvention', 'VariablePointer', 'RowPointer', 'TimeStamp')
ipv6MIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 55))
if mibBuilder.loadTexts:
    ipv6MIB.setLastUpdated('9802052155Z')
if mibBuilder.loadTexts:
    ipv6MIB.setOrganization('IETF IPv6 Working Group')
if mibBuilder.loadTexts:
    ipv6MIB.setContactInfo('           Dimitry Haskin\n\n                   Postal: Bay Networks, Inc.\n                           660 Techology Park Drive.\n                           Billerica, MA  01821\n                           US\n\n                      Tel: +1-978-916-8124\n                   E-mail: dhaskin@baynetworks.com\n\n                           Steve Onishi\n\n                   Postal: Bay Networks, Inc.\n                           3 Federal Street\n                           Billerica, MA 01821\n                           US\n\n                      Tel: +1-978-916-3816\n                   E-mail: sonishi@baynetworks.com')
if mibBuilder.loadTexts:
    ipv6MIB.setDescription('The MIB module for entities implementing the IPv6\n                protocol.')
...
if mibBuilder.loadTexts:
    ipv6AddrPrefixEntry.setDescription('An interface entry containing objects of\n                 a particular IPv6 address prefix.')
ipv6AddrPrefix = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 7, 1, 1), Ipv6AddressPrefix())
if mibBuilder.loadTexts:
    ipv6AddrPrefix.setDescription('The prefix associated with the this interface.')
...
if mibBuilder.loadTexts:
    ipv6AddrPfxLength.setDescription('The length of the prefix (in bits) associated with\n              the IPv6 address of this entry.')
...
if mibBuilder.loadTexts:
    ipv6AddrType.setDescription("The type of address. Note that 'stateless(1)'\n               refers to an address that was statelessly\n               autoconfigured; 'stateful(2)' refers to a address\n               which was acquired by via a stateful protocol\n               (e.g. DHCPv6, manual configuration).")
ipv6AddrAnycastFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 8, 1, 4), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ipv6AddrAnycastFlag.setDescription("This object has the value 'true(1)', if this\n               address is an anycast address and the value\n               'false(2)' otherwise.")
...
if mibBuilder.loadTexts:
    ipv6RouteEntry.setDescription('A routing entry.')
ipv6RouteDest = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 11, 1, 1), Ipv6Address())
if mibBuilder.loadTexts:
    ipv6RouteDest.setDescription('The destination IPv6 address of this route.\n               This object may not take a Multicast address\n               value.')
...
if mibBuilder.loadTexts:
    ipv6NetToMediaEntry.setDescription("Each entry contains one IPv6 address to `physical'\n               address equivalence.")
ipv6NetToMediaNetAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 12, 1, 1), Ipv6Address())
if mibBuilder.loadTexts:
    ipv6NetToMediaNetAddress.setDescription("The IPv6 Address corresponding to\n                the media-dependent `physical' address.")
ipv6NetToMediaPhysAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 12, 1, 2), PhysAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ipv6NetToMediaPhysAddress.setDescription("The media-dependent `physical' address.")
...
if mibBuilder.loadTexts:
    ipv6Compliance.setDescription('The compliance statement for SNMPv2 entities which\n              implement ipv6 MIB.')
