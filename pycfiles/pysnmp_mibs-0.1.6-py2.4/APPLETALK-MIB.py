...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/APPLETALK-MIB.py
# Compiled at: 2016-02-13 18:05:10
...
if mibBuilder.loadTexts:
    atportNetConfig.setDescription('The status of the network information for this port.\n                  If this port is not a native AppleTalk port, this\n                  object shall have the value unconfigured(4).')
...
if mibBuilder.loadTexts:
    kipCore.setDescription('The status of kipNextHop as a core gateway.')
...
if mibBuilder.loadTexts:
    kipType.setDescription('The type of the entity that this route points to.')
...
if mibBuilder.loadTexts:
    aspConnLastReqNum.setDescription('The last request number on this ASP connection.  If\n                  this entry is in the listening mode, this object\n                  shall have a value of zero.')
...
if mibBuilder.loadTexts:
    aspConnServerEnd.setDescription('Specifies what mode the local session end is in.')
...
if mibBuilder.loadTexts:
    adspConnRemoteConnID.setDescription('The remote Connection ID of this ADSP connection.\n                  If this entry specifies an ADSP listener, this value\n                  shall be zero.')
