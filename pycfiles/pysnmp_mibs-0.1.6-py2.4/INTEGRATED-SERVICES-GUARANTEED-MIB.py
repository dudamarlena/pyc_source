...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/INTEGRATED-SERVICES-GUARANTEED-MIB.py
# Compiled at: 2016-02-13 18:17:02
...
if mibBuilder.loadTexts:
    intSrvGuaranteed.setContactInfo('       Fred Baker\n       Postal: Cisco Systems\n               519 Lado Drive\n               Santa Barbara, California 93111\n       Tel:    +1 805 681 0115\n       E-Mail: fred@cisco.com')
if mibBuilder.loadTexts:
    intSrvGuaranteed.setDescription('The MIB module to describe the Guaranteed Service of\n       the Integrated Services Protocol')
...
if mibBuilder.loadTexts:
    intSrvGuaranteedIfTable.setDescription("The attributes of the system's interfaces  ex-\n           ported by the Guaranteed Service.")
intSrvGuaranteedIfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 52, 5, 1, 1, 1)).setIndexNames((0,
                                                                                         'IF-MIB',
                                                                                         'ifIndex'))
if mibBuilder.loadTexts:
    intSrvGuaranteedIfEntry.setDescription('The reservable attributes of  a  given  inter-\n           face.')
...
if mibBuilder.loadTexts:
    intSrvGuaranteedCompliance.setDescription('The compliance statement ')
...
if mibBuilder.loadTexts:
    intSrvGuaranteedIfAttribGroup.setDescription('These objects are required  for  Systems  sup-\n           porting the Guaranteed Service of the Integrat-\n           ed Services Architecture.')
