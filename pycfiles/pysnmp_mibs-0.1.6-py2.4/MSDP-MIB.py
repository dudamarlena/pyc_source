...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MSDP-MIB.py
# Compiled at: 2016-02-13 18:22:15
...
if mibBuilder.loadTexts:
    msdpMIB.setLastUpdated('200608010000Z')
if mibBuilder.loadTexts:
    msdpMIB.setOrganization('IETF MBONED Working Group')
if mibBuilder.loadTexts:
    msdpMIB.setContactInfo('Bill Fenner\n            75 Willow Road\n            Menlo Park, CA  94025\n            Phone: +1 650 867 6073\n            E-mail: fenner@research.att.com\n\n            Dave Thaler\n            One Microsoft Way\n            Redmond, WA  98052\n            Phone: +1 425 703 8835\n            Email: dthaler@microsoft.com\n\n            MBONED Working Group: mboned@lists.uoregon.edu')
if mibBuilder.loadTexts:
    msdpMIB.setDescription('An experimental MIB module for MSDP Management and\n            Monitoring.\n            Copyright (C) The Internet Society 2006.  This version of\n            this MIB module is part of RFC 4624; see the RFC itself\n            for full legal notices.')
...
if mibBuilder.loadTexts:
    msdpPeerConnectRetryInterval.setDescription('Time interval, in seconds, for the [ConnectRetry-period]\n            for this peer.')
...
if mibBuilder.loadTexts:
    msdpPeerRemotePort.setDescription('The remote port for the TCP connection between the MSDP\n            peers.')
...
if mibBuilder.loadTexts:
    msdpPeerLocalPort.setDescription('The local port for the TCP connection between the MSDP\n            peers.')
...
if mibBuilder.loadTexts:
    msdpEstablished.setDescription('The MSDP Established event is generated when the MSDP FSM\n            enters the ESTABLISHED state.')
msdpBackwardTransition = NotificationType((1, 3, 6, 1, 3, 92, 1, 1, 0, 2)).setObjects(*(('MSDP-MIB', 'msdpPeerState'),))
if mibBuilder.loadTexts:
    msdpBackwardTransition.setDescription('The MSDPBackwardTransition Event is generated when the\n            MSDP FSM moves from a higher-numbered state to a\n            lower-numbered state.')
...
if mibBuilder.loadTexts:
    msdpMIBFullCompliance.setDescription('The compliance statement for entities that implement MSDP\n            (RFC3618).')
...
if mibBuilder.loadTexts:
    msdpMIBReadOnlyCompliance.setDescription('The compliance statement for entities that implement MSDP\n            (RFC3618), but do not permit configuration (or only permit\n            partial configuration) via SNMP.')
msdpMIBGlobalsGroup = ObjectGroup((1, 3, 6, 1, 3, 92, 1, 1, 8, 2, 1)).setObjects(*(('MSDP-MIB', 'msdpEnabled'),))
if mibBuilder.loadTexts:
    msdpMIBGlobalsGroup.setDescription('A collection of objects providing information on global MSDP\n            state.')
...
if mibBuilder.loadTexts:
    msdpMIBEncapsulationGroup.setDescription('A collection of objects for managing encapsulations if the\n            MSDP encapsulation interfaces are not given interface\n            indices.')
...
if mibBuilder.loadTexts:
    msdpMIBSACacheGroup.setDescription('A collection of objects for managing MSDP SA cache entries.')
...
if mibBuilder.loadTexts:
    msdpMIBPeerGroup2.setDescription('A collection of objects for managing MSDP peers.')
