...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/TUNNEL-MIB.py
# Compiled at: 2016-02-13 18:32:19
...
tunnelMIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 10, 131)).setRevisions(('2005-05-16 00:00',
                                                                      '1999-08-24 12:00'))
if mibBuilder.loadTexts:
    tunnelMIB.setLastUpdated('200505160000Z')
if mibBuilder.loadTexts:
    tunnelMIB.setOrganization('IETF IP Version 6 (IPv6) Working Group')
if mibBuilder.loadTexts:
    tunnelMIB.setContactInfo(' Dave Thaler\n                 Microsoft Corporation\n                 One Microsoft Way\n                 Redmond, WA  98052-6399\n                 EMail: dthaler@microsoft.com')
if mibBuilder.loadTexts:
    tunnelMIB.setDescription('The MIB module for management of IP Tunnels,\n               independent of the specific encapsulation scheme in\n               use.\n\n               Copyright (C) The Internet Society (2005).  This\n               version of this MIB module is part of RFC 4087;  see\n               the RFC itself for full legal notices.')
...
if mibBuilder.loadTexts:
    tunnelIfHopLimit.setDescription("The IPv4 TTL or IPv6 Hop Limit to use in the outer IP\n               header.  A value of 0 indicates that the value is\n               copied from the payload's header.")
tunnelIfSecurity = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 131, 1, 1, 1, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('none',
                                                                                                                                                                                               1), ('ipsec',
                                                                                                                                                                                                    2), ('other',
                                                                                                                                                                                                         3)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tunnelIfSecurity.setDescription('The method used by the tunnel to secure the outer IP\n               header.  The value ipsec indicates that IPsec is used\n               between the tunnel endpoints for authentication or\n               encryption or both.  More specific security-related\n               information may be available in a MIB module for the\n               security protocol in use.')
...
if mibBuilder.loadTexts:
    tunnelIfEncapsLimit.setDescription('The maximum number of additional encapsulations\n               permitted for packets undergoing encapsulation at this\n               node.  A value of -1 indicates that no limit is\n               present (except as a result of the packet size).')
tunnelConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 131, 1, 1, 2))
if mibBuilder.loadTexts:
    tunnelConfigTable.setDescription('The (conceptual) table containing information on\n               configured tunnels.  This table can be used to map a\n               set of tunnel endpoints to the associated ifIndex\n               value.  It can also be used for row creation.  Note\n               that every row in the tunnelIfTable with a fixed IPv4\n               destination address should have a corresponding row in\n               the tunnelConfigTable, regardless of whether it was\n               created via SNMP.\n\n               Since this table does not support IPv6, it is\n               deprecated in favor of tunnelInetConfigTable.')
tunnelConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 131, 1, 1, 2, 1)).setIndexNames((0,
                                                                                        'TUNNEL-MIB',
                                                                                        'tunnelConfigLocalAddress'), (0,
                                                                                                                      'TUNNEL-MIB',
                                                                                                                      'tunnelConfigRemoteAddress'), (0,
                                                                                                                                                     'TUNNEL-MIB',
                                                                                                                                                     'tunnelConfigEncapsMethod'), (0,
                                                                                                                                                                                   'TUNNEL-MIB',
                                                                                                                                                                                   'tunnelConfigID'))
if mibBuilder.loadTexts:
    tunnelConfigEntry.setDescription('An entry (conceptual row) containing the information\n               on a particular configured tunnel.\n\n               Since this entry does not support IPv6, it is\n               deprecated in favor of tunnelInetConfigEntry.')
tunnelConfigLocalAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 131, 1, 1, 2, 1, 1), IpAddress())
if mibBuilder.loadTexts:
    tunnelConfigLocalAddress.setDescription('The address of the local endpoint of the tunnel, or\n               0.0.0.0 if the device is free to choose any of its\n               addresses at tunnel establishment time.\n\n               Since this object does not support IPv6, it is\n               deprecated in favor of tunnelInetConfigLocalAddress.')
tunnelConfigRemoteAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 131, 1, 1, 2, 1,
                                            2), IpAddress())
if mibBuilder.loadTexts:
    tunnelConfigRemoteAddress.setDescription('The address of the remote endpoint of the tunnel.\n\n               Since this object does not support IPv6, it is\n               deprecated in favor of tunnelInetConfigRemoteAddress.')
tunnelConfigEncapsMethod = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 131, 1, 1, 2, 1, 3), IANAtunnelType())
if mibBuilder.loadTexts:
    tunnelConfigEncapsMethod.setDescription('The encapsulation method used by the tunnel.\n\n               Since this object does not support IPv6, it is\n               deprecated in favor of tunnelInetConfigEncapsMethod.')
...
if mibBuilder.loadTexts:
    tunnelMIBCompliance.setDescription('The (deprecated) IPv4-only compliance statement for\n               the IP Tunnel MIB.\n\n               This is deprecated in favor of\n               tunnelMIBInetFullCompliance and\n               tunnelMIBInetReadOnlyCompliance.')
tunnelMIBInetFullCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 131, 2, 1, 2)).setObjects(*(('TUNNEL-MIB', 'tunnelMIBInetGroup'), ))
if mibBuilder.loadTexts:
    tunnelMIBInetFullCompliance.setDescription('The full compliance statement for the IP Tunnel MIB.')
tunnelMIBInetReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 131, 2, 1,
                                                    3)).setObjects(*(('TUNNEL-MIB', 'tunnelMIBInetGroup'), ))
if mibBuilder.loadTexts:
    tunnelMIBInetReadOnlyCompliance.setDescription('The read-only compliance statement for the IP Tunnel\n               MIB.')
...
if mibBuilder.loadTexts:
    tunnelMIBBasicGroup.setDescription('A collection of objects to support basic management\n               of IPv4 Tunnels.  Since this group cannot support\n               IPv6, it is deprecated in favor of\n               tunnelMIBInetGroup.')
...
if mibBuilder.loadTexts:
    tunnelMIBInetGroup.setDescription('A collection of objects to support basic management\n               of IPv4 and IPv6 Tunnels.')
