...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/HPR-MIB.py
...
if mibBuilder.loadTexts:
    hprMIB.setContactInfo('\n\n                        Bob Clouston\n                        Cisco Systems\n                        7025 Kit Creek Road\n                        P.O. Box 14987\n                        Research Triangle Park, NC 27709, USA\n                        Tel:    1 919 472 2333\n                        E-mail: clouston@cisco.com\n\n                        Bob Moore\n                        IBM Corporation\n                        800 Park Offices Drive\n                        RHJA/664\n                        P.O. Box 12195\n                        Research Triangle Park, NC 27709, USA\n                        Tel:    1 919 254 4436\n                        E-mail: remoore@ralvm6.vnet.ibm.com\n                ')
if mibBuilder.loadTexts:
    hprMIB.setDescription('This is the MIB module for objects used to\n                 manage network devices with HPR capabilities.')

class HprNceTypes(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('controlPoint', 0), ('logicalUnit', 1), ('boundaryFunction',
                                                                        2), ('routeSetup',
                                                                             3))
...
if mibBuilder.loadTexts:
    hprRtpRemNceId.setDescription('The remote Network Connection Endpoint (NCE) of this RTP\n          connection.  NCEs identify CPs, LUs, Boundary Functions (BFs),\n          and Route Setup (RS) components.')
...
if mibBuilder.loadTexts:
    hprRtpTopic.setDescription('The topic for this RTP connection.  This is used to indicate\n          the Class of Service.')
...
if mibBuilder.loadTexts:
    hprRtpShortReqTimer.setDescription('The value of the RTP SHORT-REQ timer, in units of 1/100 of a\n          second.  This timer represents the maximum time that a sender\n          waits for a reply from a receiver.')
...
if mibBuilder.loadTexts:
    hprRtpPathSwTimer.setDescription('The length of time that RTP should attempt a path switch\n          for a connection, in units of 1/100th of a second.')
...
if mibBuilder.loadTexts:
    hprRtpPacketsDiscarded.setDescription('The count of packets received on this RTP connection and then\n          discarded.  A packet may be discarded because it is determined\n          to be a duplicate, or for other reasons.')
...
if mibBuilder.loadTexts:
    hprRtpOkErrPathSws.setDescription('The count of successful path switch attempts for this RTP\n          connection due to errors.')
...
if mibBuilder.loadTexts:
    hprRtpStatusEndTime.setDescription('The time when the path switch was ended, either successfully\n          or unsuccessfully.')
hprRtpStatusRemCpName = MibTableColumn((1, 3, 6, 1, 2, 1, 34, 6, 1, 4, 3, 1, 6), SnaControlPointName()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hprRtpStatusRemCpName.setDescription('Administratively assigned network name for the remote node of\n          this RTP connection.')
...
if mibBuilder.loadTexts:
    hprRtpStatusRemNceId.setDescription('The remote Network Connection Endpoint (NCE) of this RTP\n          connection.  NCEs identify CPs, LUs, Boundary Functions (BFs),\n          and Route Setup (RS) components.')
...
if mibBuilder.loadTexts:
    hprRtpStatusOldRscv.setDescription('The old Route Selection Control Vector for this RTP\n          connection.  A zero-length string indicates that no value is\n          available, perhaps because the implementation does not save\n          RSCVs.')
...
if mibBuilder.loadTexts:
    hprCompliance.setDescription('The compliance statement for the SNMPv2 entities that\n          implement the HPR MIB.')
...
if mibBuilder.loadTexts:
    hprGlobalConfGroup.setDescription('A collection of objects providing the instrumentation of HPR\n          general information and capabilities.')
...
if mibBuilder.loadTexts:
    hprAnrRoutingConfGroup.setDescription("A collection of objects providing instrumentation for the\n          node's ANR routing.")
...
if mibBuilder.loadTexts:
    hprTransportUserConfGroup.setDescription('A collection of objects providing information on the users of\n          the HPR transport known to the node.')
...
if mibBuilder.loadTexts:
    hprRtpConfGroup.setDescription('A collection of objects providing the instrumentation for RTP\n          connection end points.')
