...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ADSL-LINE-MIB.py
...
if mibBuilder.loadTexts:
    adslAtucInvSerialNumber.setDescription('The vendor specific string that identifies the\n                 vendor equipment.')
...
if mibBuilder.loadTexts:
    adslAtucInvVersionNumber.setDescription('The vendor specific version number sent by this ATU\n                 as part of the initialization messages.  It is a copy\n                 of the binary version number field defined by the\n                 PHY[10] and expressed as readable characters.')
...
if mibBuilder.loadTexts:
    adslAtucCurrSnrMgn.setDescription('Noise Margin as seen by this ATU with respect to its\n                 received signal in tenth dB.')
...
if mibBuilder.loadTexts:
    adslAtucCurrAtn.setDescription('Measured difference in the total power transmitted by\n                 the peer ATU and the total power received by this ATU.')
...
if mibBuilder.loadTexts:
    adslAturInvSerialNumber.setDescription('The vendor specific string that identifies the\n                 vendor equipment.')
...
if mibBuilder.loadTexts:
    adslAturInvVendorID.setDescription('The vendor ID code is a copy of the binary\n                 vendor identification field defined by the\n                 PHY[10] and expressed as readable characters.')
...
if mibBuilder.loadTexts:
    adslAturInvVersionNumber.setDescription('The vendor specific version number sent by this ATU\n                 as part of the initialization messages.  It is a copy\n                 of the binary version number field defined by the\n                 PHY[10] and expressed as readable characters.')
...
if mibBuilder.loadTexts:
    adslAturCurrSnrMgn.setDescription('Noise Margin as seen by this ATU with respect to its\n                 received signal in tenth dB.')
...
if mibBuilder.loadTexts:
    adslAturCurrAtn.setDescription('Measured difference in the total power transmitted by\n                 the peer ATU and the total power received by this ATU.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr15MinTimeElapsed.setDescription('Total elapsed seconds in this interval.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr15MinLofs.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Framing.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr15MinLoss.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Signal.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr15MinLols.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Link.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr15MinLprs.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Power.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr1DayTimeElapsed.setDescription('Number of seconds that have elapsed since the\n                 beginning of the current 1-day interval.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr1DayLofs.setDescription('Count of the number of seconds when there was Loss of\n                 Framing during the current day as measured by\n                 adslAtucPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr1DayLoss.setDescription('Count of the number of seconds when there was Loss of\n                 Signal during the current day as measured by\n                 adslAtucPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr1DayLols.setDescription('Count of the number of seconds when there was Loss of\n                 Link during the current day as measured by\n                 adslAtucPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucPerfCurr1DayLprs.setDescription('Count of the number of seconds when there was Loss of\n                 Power during the current day as measured by\n                 adslAtucPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucPerfPrev1DayLofs.setDescription('Count of seconds in the interval when there was\n                 Loss of Framing within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAtucPerfPrev1DayLoss.setDescription('Count of seconds in the interval when there was\n                 Loss of Signal within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAtucPerfPrev1DayLols.setDescription('Count of seconds in the interval when there was\n                 Loss of Link within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAtucPerfPrev1DayLprs.setDescription('Count of seconds in the interval when there was\n                 Loss of Power within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAturPerfValidIntervals.setDescription('The number of previous 15-minute intervals in the\n                 interval table for which data was collected.  Given\n                 that <n> is the maximum # of intervals supported.\n                 The value will be <n> unless the measurement was\n                 (re-)started within the last (<n>*15) minutes, in which\n                 case the value will be the number of complete 15\n                 minute intervals for which the agent has at least\n                 some data. In certain cases (e.g., in the case\n                 where the agent is a proxy) it is possible that some\n                 intervals are unavailable.  In this case, this\n                 interval is the maximum interval number for\n                 which data is available.')
...
if mibBuilder.loadTexts:
    adslAturPerfInvalidIntervals.setDescription('The number of intervals in the range from\n                 0 to the value of adslAturPerfValidIntervals\n                 for which no data is available. This object\n                 will typically be zero except in cases where\n                 the data for some intervals are not available\n                 (e.g., in proxy situations).')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr15MinTimeElapsed.setDescription('Total elapsed seconds in this interval.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr15MinLofs.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Framing.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr15MinLoss.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Signal.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr15MinLprs.setDescription('Count of seconds in the current 15 minute interval\n                 when there was Loss of Power.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr15MinESs.setDescription('Count of Errored Seconds in the current 15 minute\n                interval.  The errored second parameter is a count of\n                one-second intervals containing one or more crc\n                anomalies, or one or more los or sef defects.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr1DayTimeElapsed.setDescription('Number of seconds that have elapsed since the\n                 beginning of the current 1-day interval.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr1DayLofs.setDescription('Count of the number of seconds when there was Loss\n                 of Framing during the current day as measured by\n                 adslAturPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr1DayLoss.setDescription('Count of the number of seconds when there was Loss\n                 of Signal during the current day as measured by\n                 adslAturPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr1DayLprs.setDescription('Count of the number of seconds when there was Loss\n                 of Power during the current day as measured by\n                 adslAturPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturPerfCurr1DayESs.setDescription('Count of Errored Seconds during the current day as\n                 measured by adslAturPerfCurr1DayTimeElapsed.\n                 The errored second parameter is a count of\n                 one-second intervals containing one or more crc\n                 anomalies, or one or more los or sef defects.')
...
if mibBuilder.loadTexts:
    adslAturPerfPrev1DayMoniSecs.setDescription('The amount of time in the previous 1-day interval\n                 over which the performance monitoring information\n                 is actually counted. This value will be the same as\n                 the interval duration except in a situation where\n                 performance monitoring data could not be collected\n                 for any reason.')
...
if mibBuilder.loadTexts:
    adslAturPerfPrev1DayLofs.setDescription('Count of seconds in the interval when there was\n                 Loss of Framing within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAturPerfPrev1DayLoss.setDescription('Count of seconds in the interval when there was\n                 Loss of Signal within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAturPerfPrev1DayLprs.setDescription('Count of seconds in the interval when there was\n                 Loss of Power within the most recent previous\n                 1-day period.')
...
if mibBuilder.loadTexts:
    adslAturPerfPrev1DayESs.setDescription('Count of Errored Seconds within the most recent\n                 previous 1-day period. The errored second parameter is\n                 a count of one-second intervals containing one or more\n                 crc anomalies, or one or more los or sef defects.')
adslAtucIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 8))
if mibBuilder.loadTexts:
    adslAtucIntervalTable.setDescription('This table provides one row for each ATUC\n                 performance data collection interval.\n                 ADSL physical interfaces are\n                 those ifEntries where ifType is equal to adsl(94).')
...
if mibBuilder.loadTexts:
    adslAtucIntervalEntry.setDescription('An entry in the adslAtucIntervalTable.')
...
if mibBuilder.loadTexts:
    adslAturIntervalEntry.setDescription('An entry in the adslAturIntervalTable.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfValidIntervals.setDescription('The number of previous 15-minute intervals in the\n                 interval table for which data was collected.  Given\n                 that <n> is the maximum # of intervals supported.\n                 The value will be <n> unless the measurement was\n                 (re-)started within the last (<n>*15) minutes, in which\n                 case the value will be the number of complete 15\n                 minute intervals for which the agent has at least\n                 some data. In certain cases (e.g., in the case\n                 where the agent is a proxy) it is possible that some\n                 intervals are unavailable.  In this case, this\n                 interval is the maximum interval number for\n                 which data is available.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfInvalidIntervals.setDescription('The number of intervals in the range from\n                 0 to the value of adslAtucChanPerfValidIntervals\n                 for which no data is available. This object\n                 will typically be zero except in cases where\n                 the data for some intervals are not available\n                 (e.g., in proxy situations).')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr15MinTimeElapsed.setDescription('Total elapsed seconds in this interval.')
adslAtucChanPerfCurr15MinReceivedBlks = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 10, 1, 8), PerfCurrentCount()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr15MinReceivedBlks.setDescription('Count of all encoded blocks received on this channel\n                 within the current 15 minute interval.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr15MinTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel within the current 15 minute interval.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr15MinCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected on this channel within the current 15 minute\n                 interval.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr15MinUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors on this channel within the current 15 minute\n                 interval.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr1DayTimeElapsed.setDescription('Number of seconds that have elapsed since the\n                 beginning of the current 1-day interval.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr1DayReceivedBlks.setDescription('Count of all encoded blocks received on this\n                 channel during the current day as measured by\n                 adslAtucChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr1DayTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel during the current day as measured by\n                 adslAtucChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr1DayCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected on this channel during the current day as\n                 measured by adslAtucChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfCurr1DayUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors on this channel during the current day as\n                 measured by adslAtucChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfPrev1DayMoniSecs.setDescription('The amount of time in the previous 1-day interval\n                 over which the performance monitoring information\n                 is actually counted. This value will be the same as\n                 the interval duration except in a situation where\n                 performance monitoring data could not be collected\n                 for any reason.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfPrev1DayReceivedBlks.setDescription('Count of all encoded blocks received on this\n                 channel within the most recent previous 1-day\n                 period.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfPrev1DayTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel within the most recent previous 1-day\n                 period.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfPrev1DayCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected on this channel within the most recent\n                 previous 1-day period.')
...
if mibBuilder.loadTexts:
    adslAtucChanPerfPrev1DayUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors on this channel within the most recent previous\n                 1-day period.')
adslAturChanPerfDataTable = MibTable((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11))
if mibBuilder.loadTexts:
    adslAturChanPerfDataTable.setDescription('This table provides one row for each ATUR channel.\n                 ADSL channel interfaces are those ifEntries\n                 where ifType is equal to adslInterleave(124)\n                 or adslFast(125).')
adslAturChanPerfDataEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    adslAturChanPerfDataEntry.setDescription('An entry in adslAturChanPerfDataTable.')
adslAturChanReceivedBlks = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    adslAturChanReceivedBlks.setDescription('Count of all encoded blocks received on this channel\n                 since agent reset.')
adslAturChanTransmittedBlks = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    adslAturChanTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel since agent reset.')
adslAturChanCorrectedBlks = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    adslAturChanCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected since agent reset.  These blocks are passed\n                 on as good data.')
adslAturChanUncorrectBlks = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    adslAturChanUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors since agent reset.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfValidIntervals.setDescription('The number of previous 15-minute intervals in the\n                 interval table for which data was collected.  Given\n                 that <n> is the maximum # of intervals supported.\n                 The value will be <n> unless the measurement was\n                 (re-)started within the last (<n>*15) minutes, in which\n                 case the value will be the number of complete 15\n                 minute intervals for which the agent has at least\n                 some data. In certain cases (e.g., in the case\n                 where the agent is a proxy) it is possible that some\n                 intervals are unavailable.  In this case, this\n                 interval is the maximum interval number for\n                 which data is available.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfInvalidIntervals.setDescription('The number of intervals in the range from\n                 0 to the value of adslAturChanPerfValidIntervals\n                 for which no data is available. This object\n                 will typically be zero except in cases where\n                 the data for some intervals are not available\n                 (e.g., in proxy situations).')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr15MinTimeElapsed.setDescription('Total elapsed seconds in this interval.\n                 A full interval is 900 seconds.')
adslAturChanPerfCurr15MinReceivedBlks = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 11, 1, 8), PerfCurrentCount()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    adslAturChanPerfCurr15MinReceivedBlks.setDescription('Count of all encoded blocks received on this\n                 channel within the current 15 minute interval.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr15MinTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel within the current 15 minute interval.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr15MinCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected on this channel within the current 15 minute\n                 interval.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr15MinUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors on this channel within the current 15 minute\n                 interval.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr1DayTimeElapsed.setDescription('Number of seconds that have elapsed since the\n                 beginning of the current 1-day interval.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr1DayReceivedBlks.setDescription('Count of all encoded blocks received on this\n                 channel during the current day as measured by\n                 adslAturChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr1DayTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel during the current day as measured by\n                 adslAturChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr1DayCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected on this channel during the current day as\n                 measured by adslAturChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfCurr1DayUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors on this channel during the current day as\n                 measured by adslAturChanPerfCurr1DayTimeElapsed.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfPrev1DayMoniSecs.setDescription('The amount of time in the previous 1-day interval\n                 over which the performance monitoring information\n                 is actually counted. This value will be the same as\n                 the interval duration except in a situation where\n                 performance monitoring data could not be collected\n                 for any reason.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfPrev1DayReceivedBlks.setDescription('Count of all encoded blocks received on this\n                 channel within the most recent previous 1-day\n                 period.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfPrev1DayTransmittedBlks.setDescription('Count of all encoded blocks transmitted on this\n                 channel within the most recent previous 1-day\n                 period.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfPrev1DayCorrectedBlks.setDescription('Count of all blocks received with errors that were\n                 corrected on this channel within the most recent\n                 previous 1-day period.')
...
if mibBuilder.loadTexts:
    adslAturChanPerfPrev1DayUncorrectBlks.setDescription('Count of all blocks received with uncorrectable\n                 errors on this channel within the most recent previous\n                 1-day period.')
adslAtucChanIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 12))
if mibBuilder.loadTexts:
    adslAtucChanIntervalTable.setDescription("This table provides one row for each ATUC channel's\n                 performance data collection interval.\n                 ADSL channel interfaces are those ifEntries\n                 where ifType is equal to adslInterleave(124)\n                 or adslFast(125).")
...
if mibBuilder.loadTexts:
    adslAtucChanIntervalEntry.setDescription('An entry in the adslAtucIntervalTable.')
...
if mibBuilder.loadTexts:
    adslAturChanIntervalEntry.setDescription('An entry in the adslAturIntervalTable.')
...
if mibBuilder.loadTexts:
    adslAtucConfRateMode.setDescription('Defines what form of transmit rate adaptation is\n                 configured on this modem.  See ADSL Forum TR-005 [3]\n                 for more information.')
...
if mibBuilder.loadTexts:
    adslAtucConfTargetSnrMgn.setDescription('Configured Target Signal/Noise Margin.\n                 This is the Noise Margin the modem must achieve\n                 with a BER of 10-7 or better to successfully complete\n                 initialization.')
...
if mibBuilder.loadTexts:
    adslAtucConfDownshiftSnrMgn.setDescription("Configured Signal/Noise Margin for rate downshift.\n                 If the noise margin falls below this level, the modem\n                 should attempt to decrease its transmit rate.  In\n                 the case that RADSL mode is not present,\n                 the value will be `0'.")
...
if mibBuilder.loadTexts:
    adslAtucConfMinDownshiftTime.setDescription("Minimum time that the current margin is below\n                 DownshiftSnrMgn before a downshift occurs.\n                 In the case that RADSL mode is not present,\n                 the value will be `0'.")
...
if mibBuilder.loadTexts:
    adslAtucChanConfFastMaxTxRate.setDescription("Configured Maximum Transmit rate for `Fast' channels,\n                 in bps.  See adslAtucConfRateChanRatio for information\n                 regarding RADSL mode and see ATUR transmit rate for\n                 ATUC receive rates.")
...
if mibBuilder.loadTexts:
    adslAtucChanConfInterleaveMaxTxRate.setDescription("Configured Maximum Transmit rate for `Interleave'\n                 channels, in bps.  See adslAtucConfRateChanRatio for\n                 information regarding RADSL mode and ATUR transmit\n                 rate for ATUC receive rates.")
...
if mibBuilder.loadTexts:
    adslAturConfRateMode.setDescription('Defines what form of transmit rate adaptation is\n                 configured on this modem.  See ADSL Forum TR-005 [3]\n                 for more information.')
...
if mibBuilder.loadTexts:
    adslAturConfRateChanRatio.setDescription('Configured allocation ratio of excess transmit\n                 bandwidth between fast and interleaved channels.  Only\n                 applies when two channel mode and RADSL are supported.\n                 Distribute bandwidth on each channel in excess of the\n                 corresponding ChanConfMinTxRate so that:\n                 adslAturConfRateChanRatio =\n\n                         [Fast / (Fast + Interleaved)] * 100\n\n                 In other words this value is the fast channel\n                 percentage.')
...
if mibBuilder.loadTexts:
    adslAturConfTargetSnrMgn.setDescription('Configured Target Signal/Noise Margin.\n                 This is the Noise Margin the modem must achieve\n                 with a BER of 10-7 or better to successfully complete\n                 initialization.')
...
if mibBuilder.loadTexts:
    adslAturConfMaxSnrMgn.setDescription('Configured Maximum acceptable Signal/Noise Margin.\n                 If the Noise Margin is above this the modem should\n                 attempt to reduce its power output to optimize its\n                 operation.')
...
if mibBuilder.loadTexts:
    adslAturConfMinSnrMgn.setDescription('Configured Minimum acceptable Signal/Noise Margin.\n                 If the noise margin falls below this level, the modem\n                 should attempt to increase its power output.  If that\n                 is not possible the modem will attempt to\n                 re-initialize or shut down.')
...
if mibBuilder.loadTexts:
    adslAturConfDownshiftSnrMgn.setDescription("Configured Signal/Noise Margin for rate downshift.\n                 If the noise margin falls below this level, the modem\n                 should attempt to decrease its transmit rate.\n                 In the case that RADSL mode is not present,\n                 the value will be `0'.")
...
if mibBuilder.loadTexts:
    adslAturConfUpshiftSnrMgn.setDescription("Configured Signal/Noise Margin for rate upshift.\n                 If the noise margin rises above this level, the modem\n                 should attempt to increase its transmit rate.\n                 In the case that RADSL is not present,\n                 the value will be `0'.")
...
if mibBuilder.loadTexts:
    adslAturConfMinUpshiftTime.setDescription("Minimum time that the current margin is above\n                 UpshiftSnrMgn before an upshift occurs.\n                 In the case that RADSL is not present, the value will\n                 be `0'.")
...
if mibBuilder.loadTexts:
    adslAturConfMinDownshiftTime.setDescription("Minimum time that the current margin is below\n                 DownshiftSnrMgn before a downshift occurs.\n                 In the case that RADSL mode is not present,\n                 the value will be `0'.")
...
if mibBuilder.loadTexts:
    adslAturChanConfFastMaxTxRate.setDescription("Configured Maximum Transmit rate for `Fast' channels,\n                 in bps.  See adslAturConfRateChanRatio for information\n                 regarding RADSL mode and ATUC transmit rate\n                 for ATUR receive rates.")
...
if mibBuilder.loadTexts:
    adslAturChanConfInterleaveMaxTxRate.setDescription("Configured Maximum Transmit rate for `Interleave'\n                 channels, in bps.  See adslAturConfRateChanRatio for\n                 information regarding RADSL mode and see\n                 ATUC transmit rate for ATUR receive rates.")
...
if mibBuilder.loadTexts:
    adslLineAlarmConfProfileName.setDescription("This object is used by the line alarm configuration\n                 table in order to identify a row of this table.\n\n                 When `dynamic' profiles are implemented, the profile\n                 name is user specified.  Also, the system will always\n                 provide a default profile whose name is `DEFVAL'.\n\n                 When `static' profiles are implemented, there is an\n                 one-to-one relationship between each line and its\n                 profile.  In which case, the profile name will\n                 need to algorithmicly represent the Line's ifIndex.\n                 Therefore, the profile's name is a decimalized string\n                 of the ifIndex that is fixed-length (i.e., 10) with\n                 leading zero(s).  For example, the profile name for\n                 ifIndex which equals '15' will be '0000000015'.")
...
if mibBuilder.loadTexts:
    adslAtucThresh15MinLoss.setDescription("The number of Loss of Signal Seconds\n                 encountered by an ADSL interface within any given 15\n                 minutes performance data collection period, which\n                 causes the SNMP agent to send an\n                 adslAtucPerfLossThreshTrap.\n                 One trap will be sent per interval per interface.\n                 A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAtucThresh15MinLols.setDescription("The number of Loss of Link Seconds\n                 encountered by an ADSL interface within any given 15\n                 minutes performance data collection period, which\n                 causes the SNMP agent to send an\n                 adslAtucPerfLolsThreshTrap.\n                 One trap will be sent per interval per interface.\n                 A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAtucThresh15MinLprs.setDescription("The number of Loss of Power Seconds\n                 encountered by an ADSL interface within any given 15\n                 minutes performance data collection period, which\n                 causes the SNMP agent to send an\n                 adslAtucPerfLprsThreshTrap.\n                 One trap will be sent per interval per interface.\n                 A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAtucThreshInterleaveRateDown.setDescription("Applies to `Interleave' channels only.\n                 Configured change in rate causing an\n                 adslAtucRateChangeTrap.  A trap is produced when:\n                 ChanCurrTxRate <= ChanPrevTxRate minus the value of\n                 this object. A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAtucInitFailureTrapEnable.setDescription('Enables and disables the InitFailureTrap.  This\n                 object is defaulted disable(2).')
...
if mibBuilder.loadTexts:
    adslAturThresh15MinLofs.setDescription("The number of Loss of Frame Seconds\n                 encountered by an ADSL interface within any given 15\n                 minutes performance data collection period, which\n                 causes the SNMP agent to send an\n                 adslAturPerfLofsThreshTrap.\n                 One trap will be sent per interval per interface.\n                 A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAturThresh15MinLoss.setDescription("The number of Loss of Signal Seconds\n                 encountered by an ADSL interface within any given 15\n                 minutes performance data collection period, which\n                 causes the SNMP agent to send an\n                 adslAturPerfLossThreshTrap.\n                 One trap will be sent per interval per interface.\n                 A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAturThresh15MinLprs.setDescription("The number of Loss of Power Seconds\n                 encountered by an ADSL interface within any given 15\n                 minutes performance data collection period, which\n                 causes the SNMP agent to send an\n                 adslAturPerfLprsThreshTrap.\n                 One trap will be sent per interval per interface.\n                 A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAturThreshInterleaveRateUp.setDescription("Applies to `Interleave' channels only.\n                 configured change in rate causing an\n                 adslAturRateChangeTrap.  A trap is produced when:\n                 ChanCurrTxRate >= ChanPrevTxRate plus the value of\n                 this object. A value of `0' will disable the trap.")
adslAturThreshFastRateDown = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 15, 1, 18), Unsigned32()).setUnits('bps').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    adslAturThreshFastRateDown.setDescription("Applies to `Fast' channels only.\n                 Configured change in rate causing an\n                 adslAturRateChangeTrap.  A trap is produced when:\n                 ChanCurrTxRate <= ChanPrevTxRate minus the value of\n                 this object. A value of `0' will disable the trap.")
...
if mibBuilder.loadTexts:
    adslAturThreshInterleaveRateDown.setDescription("Applies to `Interleave' channels only.\n                 Configured change in rate causing an\n                 adslAturRateChangeTrap.  A trap is produced when:\n                 ChanCurrTxRate <= ChanPrevTxRate minus the value of\n                 this object. A value of `0' will disable the trap.")
adslLineAlarmConfProfileRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 1, 1, 15, 1, 20), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    adslLineAlarmConfProfileRowStatus.setDescription("This object is used to create a new row or modify or\n                 delete an existing row in this table.\n\n                 A profile activated by setting this object to\n                 `active'.  When `active' is set, the system\n                 will validate the profile.\n\n                 Before a profile can be deleted or taken out of\n                 service, (by setting this object to `destroy' or\n                 `outOfService') it must be first unreferenced\n                 from all associated lines.\n\n                 If the implementator of this MIB has chosen not\n                 to implement `dynamic assignment' of profiles, this\n                 object's MIN-ACCESS is read-only and its value\n                 is always to be `active'.")
...
if mibBuilder.loadTexts:
    adslAtucPerfLofsThreshTrap.setDescription('Loss of Framing 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAtucPerfLossThreshTrap.setDescription('Loss of Signal 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAtucPerfLprsThreshTrap.setDescription('Loss of Power 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAtucPerfESsThreshTrap.setDescription('Errored Second 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAtucRateChangeTrap.setDescription('The ATUCs transmit rate has changed (RADSL mode only)')
...
if mibBuilder.loadTexts:
    adslAtucPerfLolsThreshTrap.setDescription('Loss of Link 15-minute interval threshold reached.')
adslAtucInitFailureTrap = NotificationType((1, 3, 6, 1, 2, 1, 10, 94, 1, 2, 1, 0, 7)).setObjects(*(('ADSL-LINE-MIB', 'adslAtucCurrStatus'),))
if mibBuilder.loadTexts:
    adslAtucInitFailureTrap.setDescription('ATUC initialization failed. See adslAtucCurrStatus\n                 for potential reasons.')
...
if mibBuilder.loadTexts:
    adslAturPerfLofsThreshTrap.setDescription('Loss of Framing 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAturPerfLossThreshTrap.setDescription('Loss of Signal 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAturPerfLprsThreshTrap.setDescription('Loss of Power 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAturPerfESsThreshTrap.setDescription('Errored Second 15-minute interval threshold reached.')
...
if mibBuilder.loadTexts:
    adslAturRateChangeTrap.setDescription('The ATURs transmit rate has changed (RADSL mode only)')
...
if mibBuilder.loadTexts:
    adslLineMibAtucCompliance.setDescription('The compliance statement for SNMP entities\n                  which manage ADSL ATU-C interfaces.')
...
if mibBuilder.loadTexts:
    adslLineMibAturCompliance.setDescription('The compliance statement for SNMP entities\n                  which manage ADSL ATU-R interfaces.')
...
if mibBuilder.loadTexts:
    adslLineGroup.setDescription('A collection of objects providing configuration\n                 information about an ADSL Line.')
...
if mibBuilder.loadTexts:
    adslPhysicalGroup.setDescription('A collection of objects providing physical\n                 configuration information of the ADSL Line.')
...
if mibBuilder.loadTexts:
    adslChannelGroup.setDescription('A collection of objects providing configuration\n                 information about an ADSL channel.')
...
if mibBuilder.loadTexts:
    adslAtucPhysPerfRawCounterGroup.setDescription('A collection of objects providing raw performance\n                 counts on an ADSL Line (ATU-C end).')
...
if mibBuilder.loadTexts:
    adslAtucPhysPerfIntervalGroup.setDescription('A collection of objects providing current 15-minute,\n                 1-day; and previous 1-day performance counts on\n                 ADSL Line (ATU-C end) .')
...
if mibBuilder.loadTexts:
    adslAturPhysPerfRawCounterGroup.setDescription('A collection of objects providing raw performance\n                 counts on an ADSL Line (ATU-R end).')
...
if mibBuilder.loadTexts:
    adslAturPhysPerfIntervalGroup.setDescription('A collection of objects providing current 15-minute,\n                 1-day; and previous 1-day performance counts on\n                 ADSL Line (ATU-R end).')
...
if mibBuilder.loadTexts:
    adslAtucChanPerformanceGroup.setDescription('A collection of objects providing channel block\n                 performance information on an ADSL channel\n                 (ATU-C end).')
...
if mibBuilder.loadTexts:
    adslAturChanPerformanceGroup.setDescription('A collection of objects providing channel block\n                 performance information on an ADSL channel\n                 (ATU-C end).')
...
if mibBuilder.loadTexts:
    adslLineConfProfileGroup.setDescription('A collection of objects providing provisioning\n                 information about an ADSL Line.')
...
if mibBuilder.loadTexts:
    adslLineAlarmConfProfileGroup.setDescription('A collection of objects providing alarm provisioning\n                 information about an ADSL Line.')
...
if mibBuilder.loadTexts:
    adslLineConfProfileControlGroup.setDescription('A collection of objects providing profile\n                 control for the ADSL system.')
...
if mibBuilder.loadTexts:
    adslNotificationsGroup.setDescription('The collection of adsl notifications.')
adslAturLineGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 94, 1, 3, 1, 14)).setObjects(*(('ADSL-LINE-MIB', 'adslLineCoding'),))
if mibBuilder.loadTexts:
    adslAturLineGroup.setDescription('A collection of objects providing configuration\n                    information about an ADSL Line on the ATU-R side.')
...
if mibBuilder.loadTexts:
    adslAturPhysicalGroup.setDescription('A collection of objects providing physical\n                    configuration information of the ADSL Line on the\n                    ATU-R side.')
...
if mibBuilder.loadTexts:
    adslAturChannelGroup.setDescription('A collection of objects providing configuration\n                   information about an ADSL channel on the ATU-R\n                   side.')
...
if mibBuilder.loadTexts:
    adslAturAtucPhysPerfRawCounterGroup.setDescription('A collection of objects providing raw performance\n                   counts on an ADSL Line (ATU-C end) provided by the\n                   ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturAturPhysPerfRawCounterGroup.setDescription('A collection of objects providing raw performance\n                   counts on an ADSL Line (ATU-R end) provided by the\n                   ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturAturPhysPerfIntervalGroup.setDescription('A collection of objects providing current\n                   15-minute, 1-day; and previous 1-day performance\n                   counts on ADSL Line (ATU-R end) provided by the\n                   ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturAtucChanPerformanceGroup.setDescription('A collection of objects providing channel block\n                    performance information on an ADSL channel\n                    (ATU-C end) provided by the ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturAturChanPerformanceGroup.setDescription('A collection of objects providing channel block\n                    performance information on an ADSL channel\n                    (ATU-R end) provided by the ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturLineAlarmConfProfileGroup.setDescription('A collection of objects providing alarm\n   provisioning\n                    information about an ADSL Line provided by the\n                    ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturLineConfProfileControlGroup.setDescription('A collection of objects providing profile\n                    control for the ADSL system by the ATU-R agent.')
...
if mibBuilder.loadTexts:
    adslAturNotificationsGroup.setDescription('The collection of ADSL notifications implemented by\n                    the ATU-R agent.')
