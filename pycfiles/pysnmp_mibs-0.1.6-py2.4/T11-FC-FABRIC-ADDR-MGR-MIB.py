...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-FABRIC-ADDR-MGR-MIB.py
...
class T11FamDomainInterfaceRole(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('nonPrincipal', 1), ('principalUpstream', 2), ('principalDownsteam',
                                                                              3), ('isolated',
                                                                                   4), ('down',
                                                                                        5), ('unknown',
                                                                                             6))
...
class T11FamState(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('starting', 2), ('unconfigured', 3), ('principalSwitchSelection',
...
if mibBuilder.loadTexts:
    t11FamMIBCompliance.setDescription('The compliance statement for Fibre Channel switches\n           that implement Fabric Address Manager functionality.')
...
if mibBuilder.loadTexts:
    t11FamCacheGroup.setDescription('A collection of objects containing information about\n           recently-released Fibre Channel Address Identifiers.')
...
if mibBuilder.loadTexts:
    t11FamNotificationGroup.setDescription('A collection of notifications for status monitoring\n           and notification.')
