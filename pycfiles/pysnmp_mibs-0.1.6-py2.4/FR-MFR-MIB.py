...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/FR-MFR-MIB.py
# Compiled at: 2016-02-13 18:13:27
...
if mibBuilder.loadTexts:
    mfrMib.setLastUpdated('200011300000Z')
if mibBuilder.loadTexts:
    mfrMib.setOrganization('IETF Frame Relay Service MIB (frnetmib)\n                    Working Group')
if mibBuilder.loadTexts:
    mfrMib.setContactInfo('WG Charter:\n             http://www.ietf.org/html.charters/frnetmib-charter.html\n         WG-email:      frnetmib@sunroof.eng.sun.com\n         Subscribe:     frnetmib-request@sunroof.eng.sun.com\n         Email Archive: ftp://ftp.ietf.org/ietf-mail-archive/frnetmib\n\n         Chair:      Andy Malis\n                     Vivace Networks\n         Email:      Andy.Malis@vivacenetworks.com\n\n         WG editor:  Prayson Pate\n                     Overture Networks\n         Email:      prayson.pate@overturenetworks.com\n\n         Co-author:  Bob Lynch\n                     Overture Networks\n\n         EMail:      bob.lynch@overturenetworks.com\n\n         Co-author:  Kenneth Rehbehn\n                     Megisto Systems, Inc.\n         EMail:      krehbehn@megisto.com')
if mibBuilder.loadTexts:
    mfrMib.setDescription('This is the MIB used to control and monitor the multilink\n          frame relay (MFR) function described in FRF.16.')

class MfrBundleLinkState(Integer32, TextualConvention):
    __module__ = __name__
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))
    namedValues = NamedValues(('mfrBundleLinkStateAddSent', 1), ('mfrBundleLinkStateAddRx',
                                                                 2), ('mfrBundleLinkStateAddAckRx',
                                                                      3), ('mfrBundleLinkStateUp',
                                                                           4), ('mfrBundleLinkStateIdlePending',
                                                                                5), ('mfrBundleLinkStateIdle',
                                                                                     6), ('mfrBundleLinkStateDown',
                                                                                          7), ('mfrBundleLinkStateDownIdle',
                                                                                               8))
...
if mibBuilder.loadTexts:
    mfrBundleTimerHello.setDescription('The configured MFR Hello Timer value.')
...
if mibBuilder.loadTexts:
    mfrBundleTimerAck.setDescription('The configured MFR T_ACK value.')
...
if mibBuilder.loadTexts:
    mfrBundleCountMaxRetry.setDescription('The MFR N_MAX_RETRY value.')
mfrBundleActivationClass = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 2, 3, 1, 10), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('mfrBundleActivationClassA',
                                                                                                                                                                                                       1), ('mfrBundleActivationClassB',
                                                                                                                                                                                                            2), ('mfrBundleActivationClassC',
                                                                                                                                                                                                                 3), ('mfrBundleActivationClassD',
                                                                                                                                                                                                                      4))).clone('mfrBundleActivationClassA')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mfrBundleActivationClass.setDescription('Controls the conditions under which the bundle is activated.\n          The following settings are available:\n\n             mfrBundleActivationClassA(1) - at least one must link up\n             mfrBundleActivationClassB(2) - all links must be up\n             mfrBundleActivationClassC(3) - a certain number must be\n                                            up.  Refer to\n                                            mfrBundleThreshold for\n                                            the required number.\n             mfrBundleActivationClassD(4) - custom (implementation\n                                            specific).')
...
if mibBuilder.loadTexts:
    mfrBundleMaxDiffDelay.setDescription('The maximum delay difference between the bundle\n          links.\n\n          A value of -1 indicates that this object does not contain\n          a valid value')
mfrBundleSeqNumSize = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 2, 3, 1, 13), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('seqNumSize12bit',
                                                                                                                                                                                            1), ('seqNumSize24bit',
                                                                                                                                                                                                 2))).clone('seqNumSize12bit')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mfrBundleSeqNumSize.setDescription('Controls whether the standard FRF.12 12-bit\n          sequence number is used or the optional 24-bit\n          sequence number.')
...
if mibBuilder.loadTexts:
    mfrBundleMaxBundleLinks.setDescription('The maximum number of bundle links supported for\n          this bundle.')
...
if mibBuilder.loadTexts:
    mfrBundleLinksConfigured.setDescription('The number of links configured for the bundle.')
...
if mibBuilder.loadTexts:
    mfrBundleLinksActive.setDescription('The number of links that are active.')
mfrBundleBandwidth = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 2, 3, 1, 17), Integer32()).setUnits('Bits/Sec').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleBandwidth.setDescription('The amount of available bandwidth on the bundle')
mfrBundleFarEndName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 2, 3, 1, 18), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleFarEndName.setDescription('Name of the bundle received from the far end.')
...
if mibBuilder.loadTexts:
    mfrBundleLinkDelay.setDescription('Current round-trip delay for this bundle link.  The\n          value -1 is returned when an implementation does not\n          support measurement of the bundle link delay.')
mfrBundleLinkFramesControlTx = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 3, 1, 1, 8), Counter32()).setUnits('Frames').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleLinkFramesControlTx.setDescription('Number of MFR control frames sent.')
mfrBundleLinkFramesControlRx = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 3, 1, 1, 9), Counter32()).setUnits('Frames').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleLinkFramesControlRx.setDescription('Number of valid MFR control frames received.')
mfrBundleLinkFramesControlInvalid = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 3, 1,
                                                    1, 10), Counter32()).setUnits('Frames').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleLinkFramesControlInvalid.setDescription('The number of invalid MFR control frames received.')
mfrBundleLinkTimerExpiredCount = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 3, 1, 1,
                                                 11), Counter32()).setUnits('Timer Expiration Events').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleLinkTimerExpiredCount.setDescription('Number of times the T_HELLO or T_ACK timers expired.')
mfrBundleLinkLoopbackSuspected = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 3, 1, 1,
                                                 12), Counter32()).setUnits('Loopback Suspected Events').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleLinkLoopbackSuspected.setDescription('The number of times a loopback has been suspected\n          (based upon the use of magic numbers).')
mfrBundleLinkUnexpectedSequence = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 47, 3, 1, 1,
                                                  13), Counter32()).setUnits('Frames').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mfrBundleLinkUnexpectedSequence.setDescription('The number of data MFR frames discarded because the sequence\n          number of the frame for a DLCI was less than (delayed frame)\n          or equal to (duplicate frame) the one expected for that DLCI.\n\n          Example:\n          Say frames with sequence numbers 56, 58, 59 is received for\n          DLCI 100.  While waiting for sequence number 57 another frame\n          with sequence number 58 arrives.  Frame 58 is discarded and\n          the counter is incremented.')
...
if mibBuilder.loadTexts:
    mfrMibBundleGroup.setDescription('Group of objects describing bundles.')
...
if mibBuilder.loadTexts:
    mfrMibBundleLinkGroup.setDescription('Group of objects describing bundle links.')
mfrMibTrapGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 10, 47, 5, 1, 3)).setObjects(*(('FR-MFR-MIB', 'mfrMibTrapBundleLinkMismatch'), ))
if mibBuilder.loadTexts:
    mfrMibTrapGroup.setDescription('Group of objects describing notifications (traps).')
