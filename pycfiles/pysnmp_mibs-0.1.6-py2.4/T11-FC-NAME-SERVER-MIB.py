...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-NAME-SERVER-MIB.py
...
if mibBuilder.loadTexts:
    t11FcNameServerMIB.setLastUpdated('200603020000Z')
if mibBuilder.loadTexts:
    t11FcNameServerMIB.setOrganization('T11')
if mibBuilder.loadTexts:
    t11FcNameServerMIB.setContactInfo('     Claudio DeSanti\n                  Cisco Systems, Inc.\n                  170 West Tasman Drive\n                  San Jose, CA 95134 USA\n                  Phone: +1 408 853-9172\n                  EMail: cds@cisco.com\n\n                  Keith McCloghrie\n                  Cisco Systems, Inc.\n                  170 West Tasman Drive\n                  San Jose, CA USA 95134\n                  Phone: +1 408-526-5260\n                  EMail: kzm@cisco.com')
if mibBuilder.loadTexts:
    t11FcNameServerMIB.setDescription('The MIB module for the management of the functionality,\n           which realizes the FC-GS-4 requirements for Name\n           Server (NS).\n\n           Copyright (C) The Internet Society (2006).  This version of\n           this MIB module is part of RFC 4438; see the RFC itself for\n           full legal notices.')
...
class T11NsGs4RejectReasonCode(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('none', 1), ('invalidCmdCode', 2), ('invalidVerLevel',
                                                                   3), ('logicalError',
                                                                        4), ('invalidIUSize',
                                                                             5), ('logicalBusy',
                                                                                  6), ('protocolError',
                                                                                       7), ('unableToPerformCmdReq',
                                                                                            8), ('cmdNotSupported',
                                                                                                 9), ('serverNotAvailable',
                                                                                                      10), ('couldNotEstabSession',
                                                                                                            11), ('vendorError',
                                                                                                                  12))
...
class T11NsRejReasonCodeExpl(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noAdditionalExplanation', 1), ('portIdentifierNotRegistered',
                                                               2), ('portNameNotRegistered',
                                                                    3), ('nodeNameNotRegistered',
                                                                         4), ('classOfServiceNotRegistered',
                                                                              5), ('nodeIpAddressNotRegistered',
                                                                                   6), ('ipaNotRegistered',
                                                                                        7), ('fc4TypeNotRegistered',
                                                                                             8), ('symbolicPortNameNotRegistered',
                                                                                                  9), ('symbolicNodeNameNotRegistered',
                                                                                                       10), ('portTypeNotRegistered',
                                                                                                             11), ('portIpAddressNotRegistered',
                                                                                                                   12), ('fabricPortNameNotRegistered',
                                                                                                                         13), ('hardAddressNotRegistered',
                                                                                                                               14), ('fc4DescriptorNotRegistered',
                                                                                                                                     15), ('fc4FeaturesNotRegistered',
                                                                                                                                           16), ('accessDenied',
                                                                                                                                                 17), ('unacceptablePortIdentifier',
                                                                                                                                                       18), ('databaseEmpty',
                                                                                                                                                             19), ('noObjectRegInSpecifiedScope',
                                                                                                                                                                   20), ('domainIdNotPresent',
                                                                                                                                                                         21), ('portIdNotPresent',
                                                                                                                                                                               22), ('noDeviceAttached',
...
if mibBuilder.loadTexts:
    t11NsInfoSubsetTable.setDescription('This table contains one entry for each Name Server\n           Information Subset within each Fibre Channel\n           management instance.')
t11NsInfoSubsetEntry = MibTableRow((1, 3, 6, 1, 2, 1, 135, 1, 1, 1, 1)).setIndexNames((0,
                                                                                       'FC-MGMT-MIB',
                                                                                       'fcmInstanceIndex'), (0,
                                                                                                             'T11-FC-NAME-SERVER-MIB',
                                                                                                             't11NsInfoSubsetIndex'))
if mibBuilder.loadTexts:
    t11NsInfoSubsetEntry.setDescription('This entry contains information about operations\n           on a particular Name Server Information Subset\n           within the Fibre Channel management instance\n           identified by fcmInstanceIndex.')
...
if mibBuilder.loadTexts:
    t11NsRegSymbolicNodeName.setDescription("The user-defined name of the node of this port.\n\n           If no 'Symbolic Node Name' has been registered, then\n           the value of this object is the zero-length string.")
...
if mibBuilder.loadTexts:
    t11NsRejReasonVendorCode.setDescription('A registration reject vendor-specific code.  This\n           object contains the vendor-specific code of the most\n           recent Name Server Registration Request failure for the\n           particular port on the particular Fabric.')
...
if mibBuilder.loadTexts:
    t11NsMIBCompliance.setDescription('The compliance statement for entities that\n           implement the Fibre Channel Name Server.')
...
if mibBuilder.loadTexts:
    t11NsDBGroup.setDescription('A collection of objects for monitoring the information\n           registered in a Name Server Information Subset.')
...
if mibBuilder.loadTexts:
    t11NsRequestStatsGroup.setDescription('A collection of objects for displaying Name\n           Server statistics and state for Name Server requests.')
...
if mibBuilder.loadTexts:
    t11NsRscnStatsGroup.setDescription('A collection of objects for displaying Name\n           Server statistics for Name Server-related RSCNs.')
...
if mibBuilder.loadTexts:
    t11NsRejectStatsGroup.setDescription('A collection of objects for displaying Name\n           Server statistics for rejects.')
