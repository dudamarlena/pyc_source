...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ISCSI-MIB.py
# Compiled at: 2016-02-13 18:18:56
...
class IscsiDigestMethod(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('none', 1), ('other', 2), ('noDigest', 3), ('crc32c',
                                                                           4))
...
if mibBuilder.loadTexts:
    iscsiPortalAttributesEntry.setDescription('An entry (row) containing management information applicable\n        to a particular portal instance.')
...
if mibBuilder.loadTexts:
    iscsiPortalPrimaryHdrDigest.setDescription('The preferred header digest for this portal.')
...
if mibBuilder.loadTexts:
    iscsiPortalPrimaryDataDigest.setDescription('The preferred data digest method for this portal.')
...
if mibBuilder.loadTexts:
    iscsiPortalSecondaryHdrDigest.setDescription('An alternate header digest preference for this portal.')
...
if mibBuilder.loadTexts:
    iscsiIntrPortalNodeIndexOrZero.setDescription('An arbitrary integer used to uniquely identify a\n        particular node within an iSCSI instance present\n        on the local system.\n\n        For implementations where each {portal, node} tuple\n        can have a different portal tag, this value will\n        map to the iscsiNodeIndex.\n\n        For implementations where the portal tag is the\n        same for a given portal regardless of which node\n        is using the portal, the value 0 (zero) is used.')
...
if mibBuilder.loadTexts:
    iscsiNodeMaxOutstandingR2T.setDescription('Maximum number of outstanding requests-to-transmit (R2Ts)\n        allowed per iSCSI task.')
...
if mibBuilder.loadTexts:
    iscsiNodeFirstBurstLength.setDescription('The maximum length (bytes) supported for unsolicited data\n        to/from this node.')
...
if mibBuilder.loadTexts:
    iscsiNodeMaxBurstLength.setDescription('The maximum number of bytes that can be sent within\n     a single sequence of Data-In or Data-Out PDUs.')
...
if mibBuilder.loadTexts:
    iscsiTargetAttributesEntry.setDescription('An entry (row) containing management information applicable\n        to a particular node that can take on a target role.')
...
if mibBuilder.loadTexts:
    iscsiTgtLoginRedirects.setDescription('The count of Login Response PDUs with status class 0x01,\n        Redirection, transmitted by this target.\n        If this counter has suffered a discontinuity, the time of the\n        last discontinuity is indicated in iscsiNodeDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    iscsiTgtLoginAuthenticateFails.setDescription('The count of Login Response PDUs with status 0x0201,\n        Authentication Failed, transmitted by this target.\n\n        If this counter is incremented, an iscsiTgtLoginFailure\n        notification should be generated.\n\n        If this counter has suffered a discontinuity, the time of the\n        last discontinuity is indicated in iscsiNodeDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    iscsiTgtAuthAttributesEntry.setDescription("An entry (row) containing management information\n        applicable to a particular target node's authorized\n        initiator identity.")
...
if mibBuilder.loadTexts:
    iscsiInitiatorLoginStatsEntry.setDescription("An entry (row) containing counters of each result\n        of this initiator's login attempts.")
...
if mibBuilder.loadTexts:
    iscsiIntrLoginAcceptRsps.setDescription('The count of Login Response PDUs with status\n        0x0000, Accept Login, received by this initiator.\n        If this counter has suffered a discontinuity, the time of the\n\n        last discontinuity is indicated in iscsiNodeDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    iscsiIntrLoginOtherFailRsps.setDescription('The count of Login Response PDUs received by this\n        initiator with any status code not counted in the\n        objects below.\n        If this counter has suffered a discontinuity, the time of the\n        last discontinuity is indicated in iscsiNodeDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    iscsiIntrLoginRedirectRsps.setDescription('The count of Login Response PDUs with status class 0x01,\n        Redirection, received by this initiator.\n        If this counter has suffered a discontinuity, the time of the\n        last discontinuity is indicated in iscsiNodeDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    iscsiIntrLoginAuthFailRsps.setDescription('The count of Login Response PDUs with status class 0x201,\n        Authentication Failed, received by this initiator.\n        If this counter has suffered a discontinuity, the time of the\n        last discontinuity is indicated in iscsiNodeDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    iscsiIntrAuthAttributesEntry.setDescription("An entry (row) containing management information applicable\n        to a particular initiator node's authorized target identity.")
...
if mibBuilder.loadTexts:
    iscsiSsnTSIH.setDescription('The target-defined identification handle for this session.')
...
if mibBuilder.loadTexts:
    iscsiSsnMaxOutstandingR2T.setDescription('The maximum number of outstanding requests-to-transmit\n        (R2Ts) per iSCSI task within this session.')
...
if mibBuilder.loadTexts:
    iscsiSsnFirstBurstLength.setDescription('The maximum length supported for unsolicited data sent\n        within this session.')
...
if mibBuilder.loadTexts:
    iscsiSsnMaxBurstLength.setDescription('The maximum number of bytes that can be sent within\n        a single sequence of Data-In or Data-Out PDUs.')
...
if mibBuilder.loadTexts:
    iscsiCxnCid.setDescription('The iSCSI Connection ID for this connection.')
...
if mibBuilder.loadTexts:
    iscsiCxnMaxRecvDataSegLength.setDescription('The maximum data payload size supported for command\n        or data PDUs able to be received on this connection.')
...
if mibBuilder.loadTexts:
    iscsiCxnVersionActive.setDescription('Active version number of the iSCSI specification negotiated\n        on this connection.')
...
if mibBuilder.loadTexts:
    iscsiIntrLoginFailure.setDescription('Sent when a login is failed by an initiator.\n\n        To avoid sending an excessive number of notifications due\n        to multiple errors counted, an SNMP agent implementing this\n        notification SHOULD NOT send more than 3 notifications of\n        this type in any 10-second time period.')
...
if mibBuilder.loadTexts:
    iscsiInstSessionFailure.setDescription('Sent when an active session is failed by either the initiator\n        or the target.\n\n        To avoid sending an excessive number of notifications due\n        to multiple errors counted, an SNMP agent implementing this\n        notification SHOULD NOT send more than 3 notifications of\n        this type in any 10-second time period.')
...
if mibBuilder.loadTexts:
    iscsiInstanceAttributesGroup.setDescription('A collection of objects providing information about iSCSI\n        instances.')
...
if mibBuilder.loadTexts:
    iscsiInstanceSsnErrorStatsGroup.setDescription('A collection of objects providing information about\n        errors that have caused a session failure for an\n        iSCSI instance.')
...
if mibBuilder.loadTexts:
    iscsiPortalAttributesGroup.setDescription('A collection of objects providing information about\n        the transport protocol endpoints of the local targets.')
...
if mibBuilder.loadTexts:
    iscsiTgtPortalAttributesGroup.setDescription('A collection of objects providing information about\n        the transport protocol endpoints of the local targets.')
iscsiIntrPortalAttributesGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 142, 2, 2, 5)).setObjects(*(('ISCSI-MIB', 'iscsiIntrPortalTag'),))
if mibBuilder.loadTexts:
    iscsiIntrPortalAttributesGroup.setDescription('An object providing information about\n        the portal tags used by the local initiators.')
...
if mibBuilder.loadTexts:
    iscsiNodeAttributesGroup.setDescription('A collection of objects providing information about all\n        local targets.')
...
if mibBuilder.loadTexts:
    iscsiTargetAttributesGroup.setDescription('A collection of objects providing information about all\n        local targets.')
...
if mibBuilder.loadTexts:
    iscsiTargetLoginStatsGroup.setDescription('A collection of objects providing information about all\n        login attempts by remote initiators to local targets.')
...
if mibBuilder.loadTexts:
    iscsiTargetLogoutStatsGroup.setDescription('A collection of objects providing information about all\n        logout events between remote initiators and local targets.')
...
if mibBuilder.loadTexts:
    iscsiTargetAuthGroup.setDescription('A collection of objects providing information about all\n        remote initiators that are authorized to connect to local\n        targets.')
...
if mibBuilder.loadTexts:
    iscsiInitiatorAttributesGroup.setDescription('A collection of objects providing information about\n        all local initiators.')
...
if mibBuilder.loadTexts:
    iscsiInitiatorLoginStatsGroup.setDescription('A collection of objects providing information about all\n        login attempts by local initiators to remote targets.')
...
if mibBuilder.loadTexts:
    iscsiInitiatorLogoutStatsGroup.setDescription('A collection of objects providing information about all\n        logout events between local initiators and remote targets.')
...
if mibBuilder.loadTexts:
    iscsiInitiatorAuthGroup.setDescription('A collection of objects providing information about all\n        remote targets that are initiators of the local system\n        that they are authorized to access.')
...
if mibBuilder.loadTexts:
    iscsiSessionAttributesGroup.setDescription('A collection of objects providing information applicable to\n        all sessions.')
...
if mibBuilder.loadTexts:
    iscsiSessionPDUStatsGroup.setDescription('A collection of objects providing information about PDU\n        traffic for each session.')
...
if mibBuilder.loadTexts:
    iscsiSessionOctetStatsGroup.setDescription('A collection of objects providing information about octet\n        traffic for each session using a Counter64 data type.')
...
if mibBuilder.loadTexts:
    iscsiSessionLCOctetStatsGroup.setDescription('A collection of objects providing information about octet\n        traffic for each session using a Counter32 data type.')
...
if mibBuilder.loadTexts:
    iscsiSessionCxnErrorStatsGroup.setDescription('A collection of objects providing information about connection\n        errors for all sessions.')
