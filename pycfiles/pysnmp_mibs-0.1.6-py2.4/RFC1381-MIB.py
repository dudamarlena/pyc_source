...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/RFC1381-MIB.py
# Compiled at: 2016-02-13 18:26:21
...
if mibBuilder.loadTexts:
    lapbAdmnStationType.setDescription('Identifies the desired station type of this\n                          interface.')
...
if mibBuilder.loadTexts:
    lapbAdmnReceiveKWindowSize.setDescription('The default receive window size for this\n                          Interface.  This is the maximum number of\n\n\n                          unacknowledged sequenced PDUs that may be\n                          outstanding from the DCE/remote DTE at any\n                          one time.')
...
if mibBuilder.loadTexts:
    lapbAdmnActionInitiate.setDescription('This identifies the action LAPB will take\n                          to initiate link set-up.')
...
if mibBuilder.loadTexts:
    lapbXidParameterUniqueIdentifier.setDescription('The value of the parameter unique\n                          Identifier.  A zero length string indicates\n                          no Unique identifier value has been\n                          assigned.')
...
if mibBuilder.loadTexts:
    lapbXidGroupAddress.setDescription('The value of the parameter Group address.\n                          A zero length string indicates no Group\n                          address value has been assigned.')
