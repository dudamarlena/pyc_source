...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/COPS-CLIENT-MIB.py
# Compiled at: 2016-02-13 18:07:10
...
if mibBuilder.loadTexts:
    copsClientMIB.setLastUpdated('200009280000Z')
if mibBuilder.loadTexts:
    copsClientMIB.setOrganization('IETF RSVP Admission Policy Working Group')
if mibBuilder.loadTexts:
    copsClientMIB.setContactInfo('       Andrew Smith (WG co-chair)\n         Phone: +1 408 579 2821\n         Email: ah_smith@pacbell.net\n\n                Mark Stevens (WG co-chair)\n         Phone: +1 978 287 9102\n         Email: markstevens@lucent.com\n\n         Editor: Andrew Smith\n         Phone: +1 408 579 2821\n         Email: ah_smith@pacbell.net\n\n         Editor: David Partain\n         Phone: +46 13 28 41 44\n         Email: David.Partain@ericsson.com\n\n         Editor: John Seligson\n         Phone: +1 408 495 2992\n         Email: jseligso@nortelnetworks.com')
if mibBuilder.loadTexts:
    copsClientMIB.setDescription('The COPS Client MIB module')
copsClientMIBObjects = MibIdentifier((1, 3, 6, 1, 2, 1, 89, 1))

class CopsClientState(Integer32, TextualConvention):
    __module__ = __name__
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))
    namedValues = NamedValues(('copsClientInvalid', 1), ('copsClientTcpconnected',
                                                         2), ('copsClientAuthenticating',
                                                              3), ('copsClientSecAccepted',
                                                                   4), ('copsClientAccepted',
                                                                        5), ('copsClientTimingout',
                                                                             6))
...
class CopsErrorCode(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('errorOther', 0), ('errorBadHandle', 1), ('errorInvalidHandleReference',
                                                                         2), ('errorBadMessageFormat',
                                                                              3), ('errorUnableToProcess',
                                                                                   4), ('errorMandatoryClientSiMissing',
                                                                                        5), ('errorUnsupportedClientType',
                                                                                             6), ('errorMandatoryCopsObjectMissing',
                                                                                                  7), ('errorClientFailure',
                                                                                                       8), ('errorCommunicationFailure',
                                                                                                            9), ('errorUnspecified',
                                                                                                                 10), ('errorShuttingDown',
                                                                                                                       11), ('errorRedirectToPreferredServer',
                                                                                                                             12), ('errorUnknownCopsObject',
                                                                                                                                   13), ('errorAuthenticationFailure',
                                                                                                                                         14), ('errorAuthenticationMissing',
                                                                                                                                               15))
...
class CopsAuthType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('authNone', 0), ('authOther', 1), ('authIpSecAh', 2), ('authIpSecEsp',
                                                                                      3), ('authTls',
                                                                                           4), ('authCopsIntegrity',
                                                                                                5))
...
if mibBuilder.loadTexts:
    copsClientServerConfigEntry.setDescription('A set of configuration information regarding a single\n        COPS server from the point of view of a COPS client.')
copsClientServerConfigAddrType = MibTableColumn((1, 3, 6, 1, 2, 1, 89, 1, 3, 1, 1, 1), InetAddressType())
if mibBuilder.loadTexts:
    copsClientServerConfigAddrType.setDescription('The type of address in copsClientServerConfigAddress.')
copsClientServerConfigAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 89, 1, 3, 1, 1, 2), InetAddress())
if mibBuilder.loadTexts:
    copsClientServerConfigAddress.setDescription('The IPv4, IPv6 or DNS address of a COPS Server. Note that,\n        since this is an index to the table, the DNS name must be\n        short enough to fit into the maximum length of indices allowed\n        by the management protocol in use.')
...
if mibBuilder.loadTexts:
    copsDeviceStatusGroup.setDescription('A collection of objects for monitoring the status of\n        connections to COPS servers and statistics for a COPS client.')
...
if mibBuilder.loadTexts:
    copsDeviceConfigGroup.setDescription('A collection of objects for configuring COPS server\n        information.')
...
if mibBuilder.loadTexts:
    copsClientCompliance.setDescription('The compliance statement for device support of\n        management of the COPS client.')
