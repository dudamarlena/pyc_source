...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IPATM-IPMC-MIB.py
# Compiled at: 2016-02-13 18:17:37
...
if mibBuilder.loadTexts:
    marsClientFailureTimer.setDescription('A timer used to flag the failure of last MARS_MULTI\n            to arrive.  Default value = 10 seconds (recommended).')
...
if mibBuilder.loadTexts:
    marsClientRdmMulReqAddRetrTimer.setDescription('The initial random L_MULTI_RQ/ADD retransmit timer\n            which can be set between 5 and 10 seconds inclusive.')
...
if mibBuilder.loadTexts:
    marsClientRdmVcRevalidateTimer.setDescription('The random time to set VC_revalidate flag.  The\n            timer value ranges between 1 and 10 seconds\n            inclusive.')
...
if mibBuilder.loadTexts:
    marsClientJoinLeaveRetrInterval.setDescription('MARS_JOIN/LEAVE retransmit interval. The minimum\n            and recommended values are 5 and 10 seconds,\n            respectively.')
...
if mibBuilder.loadTexts:
    marsClientJoinLeaveRetrLimit.setDescription('MARS_JOIN/LEAVE retransmit limit. The maximum\n            value is 5.')
...
if mibBuilder.loadTexts:
    marsClientRegWithMarsRdmTimer.setDescription('Random time to register with MARS.')
...
if mibBuilder.loadTexts:
    marsClientForceWaitTimer.setDescription('Force wait if MARS re-registration is looping.\n            The minimum value is 1 minute.')
...
if mibBuilder.loadTexts:
    marsClientLmtToMissRedirMapTimer.setDescription('Timer limit for client to miss MARS_REDIRECT_MAPS.')
...
if mibBuilder.loadTexts:
    marsClientBackupMarsEntry.setDescription('Each entry represents an ATM address of a backup MARS.')
...
if mibBuilder.loadTexts:
    marsClientVcType.setDescription('Circuit Connection type: permanent virtual circuit or\n            switched virtual circuit.')
...
if mibBuilder.loadTexts:
    marsClientVcEncapsType.setDescription('The encapsulation type used when communicating over\n            this VC.')
...
if mibBuilder.loadTexts:
    marsServStatus.setDescription('The current status of MARS.')
...
if mibBuilder.loadTexts:
    marsServType.setDescription('Types of MARS servers: primary or backup.')
...
if mibBuilder.loadTexts:
    marsHostMapEntry.setDescription('Each entry row contains attributes associated with\n            the mapping between a multicast group block and an\n            ATM address.')
marsHostMapAtmAddr = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 3, 1, 1), AtmAddr())
if mibBuilder.loadTexts:
    marsHostMapAtmAddr.setDescription('The mapped cluster member ATM address.')
...
if mibBuilder.loadTexts:
    marsServerMapEntry.setDescription('Each entry row contains attributes associated with\n            the mapping between a multicast group block and an\n            MCS address.')
marsServerMapAtmAddr = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 4, 1, 1), AtmAddr())
if mibBuilder.loadTexts:
    marsServerMapAtmAddr.setDescription('The mapped MCS ATM address.')
...
if mibBuilder.loadTexts:
    marsVcType.setDescription('Circuit Connection type: permanent virtual circuit or\n            switched virtual circuit.')
...
if mibBuilder.loadTexts:
    marsVcIdleTimer.setDescription('The idle timer associated with this VC.  The minimum\n            suggested value is 1 minute and the recommended default\n            value is 20 minutes.')
...
if mibBuilder.loadTexts:
    marsVcEncapsType.setDescription('The encapsulation type used when communicating over\n            this VC.')
...
if mibBuilder.loadTexts:
    marsRegMcsEntry.setDescription('Each entry row contains attributes associated with one\n            registered MCS.')
marsRegMcsAtmAddr = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 7, 1, 1), AtmAddr()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsRegMcsAtmAddr.setDescription("The registered MCS's ATM address.")
marsStatTable = MibTable((1, 3, 6, 1, 2, 1, 57, 2, 8))
if mibBuilder.loadTexts:
    marsStatTable.setDescription('The table contains statistics collected at MARS.')
marsStatEntry = MibTableRow((1, 3, 6, 1, 2, 1, 57, 2, 8, 1)).setIndexNames((0, 'IPATM-IPMC-MIB', 'marsIndex'), (0, 'IPATM-IPMC-MIB', 'marsIfIndex'))
if mibBuilder.loadTexts:
    marsStatEntry.setDescription('Each entry contains statistics collected at one MARS.')
marsStatTxMultiMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxMultiMsgs.setDescription('Total number of MARS_MULTI transmitted by this MARS.')
marsStatTxGrpLstRplyMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxGrpLstRplyMsgs.setDescription('Total number of MARS_GROUPLIST_REPLY messages transmitted\n            by this MARS.')
marsStatTxRedirectMapMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxRedirectMapMsgs.setDescription('Total number of MARS_REDIRECT_MAP messages transmitted by\n            this MARS.')
marsStatTxMigrateMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxMigrateMsgs.setDescription('Total number of MARS_MIGRATE messages transmitted by\n            this MARS.')
marsStatTxNakMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxNakMsgs.setDescription('Total number of MARS_NAK messages transmitted by this MARS.')
marsStatTxJoinMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxJoinMsgs.setDescription('Total number of MARS_JOIN messages transmitted by this\n            MARS.')
marsStatTxLeaveMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxLeaveMsgs.setDescription('Total number of MARS_LEAVE messages transmitted by this\n            MARS.')
marsStatTxSjoinMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxSjoinMsgs.setDescription('Total number of MARS_SJOIN messages transmitted by this\n            MARS.')
marsStatTxSleaveMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxSleaveMsgs.setDescription('Total number of MARS_SLEAVE messages transmitted by this\n            MARS.')
marsStatTxMservMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 10), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxMservMsgs.setDescription('Total number of MARS_MSERV messages transmitted by this\n            MARS.')
marsStatTxUnservMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 11), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatTxUnservMsgs.setDescription('Total number of MARS_UNSERV messages transmitted by this\n            MARS.')
marsStatRxReqMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 12), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxReqMsgs.setDescription('Total number of MARS_REQUEST messages received by this\n            MARS.')
marsStatRxGrpLstReqMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 13), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxGrpLstReqMsgs.setDescription('Total number of MARS_GROUPLIST_REQUEST messages received\n            by this MARS.')
marsStatRxJoinMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 14), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxJoinMsgs.setDescription('Total number of MARS_JOINS messages received by this MARS.')
marsStatRxLeaveMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 15), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxLeaveMsgs.setDescription('Total number of MARS_LEAVES messages received by this MARS.')
marsStatRxMservMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 16), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxMservMsgs.setDescription('Total number of MARS_MSERV messages received by this MARS.')
marsStatRxUnservMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 17), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxUnservMsgs.setDescription('Total number of MARS_UNSERV messages received by this MARS.')
marsStatRxBlkJoinMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 18), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRxBlkJoinMsgs.setDescription('Total number of block joins messages received by this MARS.')
marsStatRegMemGroups = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 19), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRegMemGroups.setDescription('Total number of IP multicast groups with 1 or more joined\n            cluster members.')
marsStatRegMcsGroups = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 2, 8, 1, 20), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsStatRegMcsGroups.setDescription('Total number of IP multicast groups with 1 or more joined\n            MCSs.')
marsMcsObjects = MibIdentifier((1, 3, 6, 1, 2, 1, 57, 3))
marsMcsTable = MibTable((1, 3, 6, 1, 2, 1, 57, 3, 1))
if mibBuilder.loadTexts:
    marsMcsTable.setDescription('The objects defined in this table are used for\n            the management of a multicast server (MCS).')
...
if mibBuilder.loadTexts:
    marsMcsFailureTimer.setDescription('A timer used to flag the failure of last MARS_MULTI\n            to arrive.  Default value = 10 seconds (recommended).')
...
if mibBuilder.loadTexts:
    marsMcsRetranDelayTimer.setDescription('The delay timer for sending out new MARS_REQUEST\n            for the group after the MCS learned that there\n            is no other group in the cluster.  The timer must\n            be set between 5 and 10 seconds inclusive.')
...
if mibBuilder.loadTexts:
    marsMcsRdmMulReqAddRetrTimer.setDescription('The initial random L_MULTI_RQ/ADD retransmit timer\n            which can be set between 5 and 10 seconds inclusive.')
...
if mibBuilder.loadTexts:
    marsMcsRdmVcRevalidateTimer.setDescription('The random time to set VC_revalidate flag.  The\n            timer value ranges between 1 and 10 seconds\n               inclusive.')
...
if mibBuilder.loadTexts:
    marsMcsRegisterRetrInterval.setDescription('MARS_MSERV/UNSERV retransmit interval. The minimum\n            and recommended values are 5 and 10 seconds,\n            respectively.')
...
if mibBuilder.loadTexts:
    marsMcsRegisterRetrLimit.setDescription('MARS_MSERV/UNSERV retransmit limit. The maximum value\n            is 5.')
...
if mibBuilder.loadTexts:
    marsMcsRegWithMarsRdmTimer.setDescription('Random time for a MCS to register with a MARS.')
...
if mibBuilder.loadTexts:
    marsMcsForceWaitTimer.setDescription('Force wait if MARS re-registration is looping.\n            The minimum value is 1 minute.')
...
if mibBuilder.loadTexts:
    marsMcsLmtToMissRedirMapTimer.setDescription('Timer limit for MCS to miss MARS_REDIRECT_MAPS.')
...
if mibBuilder.loadTexts:
    marsMcsBackupMarsEntry.setDescription('Each entry represents an ATM address of a backup MARS.')
...
if mibBuilder.loadTexts:
    marsMcsVcType.setDescription('Circuit Connection type: permanent virtual circuit or\n            switched virtual circuit.')
...
if mibBuilder.loadTexts:
    marsMcsVcIdleTimer.setDescription('The idle timer associated with this VC. The minimum\n            suggested value is 1 minute and the recommended\n            default value is 20 minutes.')
marsMcsVcRevalidate = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 4, 1, 10), TruthValue()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    marsMcsVcRevalidate.setDescription('A flag associated with an open and active multipoint\n            VC. It is checked every time a packet is queued for\n            transmission on that VC. The object has the value of\n            true (1) if revalidate is required and the value\n            false (2) otherwise.')
...
if mibBuilder.loadTexts:
    marsMcsVcEncapsType.setDescription('The encapsulation type used when communicating over\n            this VC.')
...
if mibBuilder.loadTexts:
    marsMcsStatEntry.setDescription('Each entry contains statistics collected at one\n            MARS MCS.')
marsMcsStatTxReqMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatTxReqMsgs.setDescription('Total number of MARS_REQUEST messages transmitted\n            from this MCS.')
marsMcsStatTxMservMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatTxMservMsgs.setDescription('Total number of MARS_MSERV messages transmitted from\n            this MCS.')
marsMcsStatTxUnservMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatTxUnservMsgs.setDescription('Total number of MARS_UNSERV messages transmitted from\n            this MCS.')
marsMcsStatRxMultiMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatRxMultiMsgs.setDescription('Total number of MARS_MULTI messages received by\n            this MCS.')
marsMcsStatRxSjoinMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatRxSjoinMsgs.setDescription('Total number of MARS_SJOIN messages received by\n            this MCS.')
marsMcsStatRxSleaveMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatRxSleaveMsgs.setDescription('Total number of MARS_SLEAVE messages received\n            by this MCS.')
marsMcsStatRxNakMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatRxNakMsgs.setDescription('Total number of MARS_NAK messages received\n            by this MCS.')
marsMcsStatRxMigrateMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatRxMigrateMsgs.setDescription('Total number of MARS_MIGRATE messages received\n            by this MCS.')
marsMcsStatFailMultiMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 57, 3, 5, 1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    marsMcsStatFailMultiMsgs.setDescription('Total number of timeouts occurred indicating\n            failure of the last MARS_MULTI to arrive.')
...
if mibBuilder.loadTexts:
    marsFaultTrap.setDescription('This trap/inform is sent to the manager whenever\n            there is a fault condition occurred on a MARS.')
...
if mibBuilder.loadTexts:
    marsClientCompliance.setDescription('The compliance statement for entities that are required\n            for the management of MARS clients.')
...
if mibBuilder.loadTexts:
    marsClientGroup.setDescription('A collection of objects to be implemented in a MIB\n            for the management of MARS clients.')
...
if mibBuilder.loadTexts:
    marsServerCompliance.setDescription('The compliance statement for entities that are required\n            for the management of MARS servers.')
...
if mibBuilder.loadTexts:
    marsServerGroup.setDescription('A collection of objects to be implemented in a MIB\n            for the management of MARS servers.')
marsServerEventGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 57, 4, 2, 2, 2)).setObjects(*(('IPATM-IPMC-MIB', 'marsFaultTrap'),))
if mibBuilder.loadTexts:
    marsServerEventGroup.setDescription('A collection of events that can be generated from\n            a MARS server.')
marsMcsCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 57, 4, 3, 1, 1)).setObjects(*(('IPATM-IPMC-MIB', 'marsMcsGroup'),))
if mibBuilder.loadTexts:
    marsMcsCompliance.setDescription('The compliance statement for entities that are required\n            for the management of MARS multicast servers (MCS).')
...
if mibBuilder.loadTexts:
    marsMcsGroup.setDescription('A collection of objects to be implemented in a MIB\n            for the management of MARS multicast servers (MCS).')
