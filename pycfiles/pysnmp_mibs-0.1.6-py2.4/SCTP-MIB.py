...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SCTP-MIB.py
# Compiled at: 2016-02-13 18:27:46
...
if mibBuilder.loadTexts:
    sctpMaxAssocs.setDescription('The limit on the total number of associations the entity can\n       support. In entities where the maximum number of associations\n       is dynamic, this object should contain the value -1.')
sctpValCookieLife = MibScalar((1, 3, 6, 1, 2, 1, 104, 1, 2, 6), Unsigned32().clone(60000)).setUnits('milliseconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sctpValCookieLife.setDescription('Valid cookie life in the 4-way start-up handshake procedure.')
sctpMaxInitRetr = MibScalar((1, 3, 6, 1, 2, 1, 104, 1, 2, 7), Unsigned32().clone(8)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sctpMaxInitRetr.setDescription('The maximum number of retransmissions at the start-up phase\n       (INIT and COOKIE ECHO chunks). ')
sctpAssocTable = MibTable((1, 3, 6, 1, 2, 1, 104, 1, 3))
if mibBuilder.loadTexts:
    sctpAssocTable.setDescription('A table containing SCTP association-specific information.')
sctpAssocEntry = MibTableRow((1, 3, 6, 1, 2, 1, 104, 1, 3, 1)).setIndexNames((0, 'SCTP-MIB',
                                                                              'sctpAssocId'))
if mibBuilder.loadTexts:
    sctpAssocEntry.setDescription('General common variables and statistics for the whole\n       association.')
sctpAssocId = MibTableColumn((1, 3, 6, 1, 2, 1, 104, 1, 3, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4294967295)))
if mibBuilder.loadTexts:
    sctpAssocId.setDescription('Association Identification. Value identifying the\n       association. ')
...
if mibBuilder.loadTexts:
    sctpAssocLocalPort.setDescription('The local SCTP port number used for this association.')
...
if mibBuilder.loadTexts:
    sctpAssocHeartBeatInterval.setDescription('The current heartbeat interval..\n\n       Zero value means no HeartBeat, even when the concerned\n       sctpAssocRemAddrHBFlag object is true.')
sctpAssocState = MibTableColumn((1, 3, 6, 1, 2, 1, 104, 1, 3, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8, 9))).clone(namedValues=NamedValues(('closed',
                                                                                                                                                                                                        1), ('cookieWait',
                                                                                                                                                                                                             2), ('cookieEchoed',
                                                                                                                                                                                                                  3), ('established',
                                                                                                                                                                                                                       4), ('shutdownPending',
...
if mibBuilder.loadTexts:
    sctpAssocInStreams.setDescription('Inbound Streams according to the negotiation at association\n       start up.')
...
if mibBuilder.loadTexts:
    sctpLayerParamsGroup.setDescription('Common parameters for the SCTP layer, i.e., for all the\n       associations. They can usually be referred to as configuration\n       parameters.')
...
if mibBuilder.loadTexts:
    sctpStatsGroup.setDescription('Statistics group. It includes the objects to collect state\n       changes in the SCTP protocol local layer and flow control\n       statistics.')
...
if mibBuilder.loadTexts:
    sctpPerAssocParamsGroup.setDescription('The SCTP group of objects to manage per-association\n       parameters. These variables include all the SCTP basic\n       features.')
...
if mibBuilder.loadTexts:
    sctpPerAssocStatsGroup.setDescription('Per Association Statistics group. It includes the objects to\n       collect flow control statistics per association.')
...
if mibBuilder.loadTexts:
    sctpInverseGroup.setDescription('Objects used in the inverse lookup tables.')
