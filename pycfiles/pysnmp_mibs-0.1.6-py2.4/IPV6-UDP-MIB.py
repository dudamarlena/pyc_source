...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IPV6-UDP-MIB.py
# Compiled at: 2016-02-13 18:18:51
...
if mibBuilder.loadTexts:
    ipv6UdpCompliance.setDescription('The compliance statement for SNMPv2 entities which\n             implement UDP over IPv6.')
ipv6UdpGroup = ObjectGroup((1, 3, 6, 1, 3, 87, 2, 2, 1)).setObjects(*(('IPV6-UDP-MIB', 'ipv6UdpIfIndex'), ))
if mibBuilder.loadTexts:
    ipv6UdpGroup.setDescription('The group of objects providing management of\n             UDP over IPv6.')
