...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DNS-SERVER-MIB.py
...
dnsServConfigRecurs = MibScalar((1, 3, 6, 1, 2, 1, 32, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('available',
                                                                                                                                                                                     1), ('restricted',
                                                                                                                                                                                          2), ('unavailable',
...
dnsServConfigReset = MibScalar((1, 3, 6, 1, 2, 1, 32, 1, 1, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('other',
                                                                                                                                                                                       1), ('reset',
                                                                                                                                                                                            2), ('initializing',
                                                                                                                                                                                                 3), ('running',
...
dnsServCounterEntry = MibTableRow((1, 3, 6, 1, 2, 1, 32, 1, 1, 2, 13, 1)).setIndexNames((0,
                                                                                         'DNS-SERVER-MIB',
                                                                                         'dnsServCounterOpCode'), (0,
                                                                                                                   'DNS-SERVER-MIB',
                                                                                                                   'dnsServCounterQClass'), (0,
                                                                                                                                             'DNS-SERVER-MIB',
                                                                                                                                             'dnsServCounterQType'), (0,
                                                                                                                                                                      'DNS-SERVER-MIB',
...
dnsServCounterTransport = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 2, 13, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('udp',
                                                                                                                                                                                                     1), ('tcp',
                                                                                                                                                                                                          2), ('other',
                                                                                                                                                                                                               3))))
if mibBuilder.loadTexts:
...
dnsServOptCounterFriendsAuthNoDataResps = MibScalar((1, 3, 6, 1, 2, 1, 32, 1, 1, 3,
...
dnsServOptCounterFriendsNonAuthNoDatas = MibScalar((1, 3, 6, 1, 2, 1, 32, 1, 1, 3,
...
dnsServZoneEntry = MibTableRow((1, 3, 6, 1, 2, 1, 32, 1, 1, 4, 1, 1)).setIndexNames((0,
                                                                                     'DNS-SERVER-MIB',
                                                                                     'dnsServZoneName'), (0,
                                                                                                          'DNS-SERVER-MIB',
                                                                                                          'dnsServZoneClass'))
...
dnsServZoneLastReloadSuccess = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 4, 1, 1,
                                               3), DnsTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dnsServZoneLastReloadSuccess.setDescription('Elapsed time in seconds since last successful reload of\n               this zone.')
dnsServZoneLastReloadAttempt = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 4, 1, 1,
                                               4), DnsTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dnsServZoneLastReloadAttempt.setDescription('Elapsed time in seconds since last attempted reload of\n               this zone.')
dnsServZoneLastSourceAttempt = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 4, 1, 1,
                                               5), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
...
dnsServZoneLastSourceSuccess = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 4, 1, 1,
                                               9), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
...
dnsServZoneSrcEntry = MibTableRow((1, 3, 6, 1, 2, 1, 32, 1, 1, 4, 2, 1)).setIndexNames((0,
                                                                                        'DNS-SERVER-MIB',
                                                                                        'dnsServZoneSrcName'), (0,
                                                                                                                'DNS-SERVER-MIB',
                                                                                                                'dnsServZoneSrcClass'), (0,
                                                                                                                                         'DNS-SERVER-MIB',
                                                                                                                                         'dnsServZoneSrcAddr'))
if mibBuilder.loadTexts:
