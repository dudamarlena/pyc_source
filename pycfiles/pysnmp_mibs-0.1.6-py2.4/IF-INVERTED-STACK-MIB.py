...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IF-INVERTED-STACK-MIB.py
...
if mibBuilder.loadTexts:
    ifInvCompliance.setDescription('The compliance statement for SNMP entities which provide\n          inverted information on the layering of network interfaces.')
ifInvStackGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 77, 1, 2, 1, 1)).setObjects(*(('IF-INVERTED-STACK-MIB', 'ifInvStackStatus'), ))
if mibBuilder.loadTexts:
    ifInvStackGroup.setDescription('A collection of objects providing inverted information on\n          the layering of MIB-II interfaces.')
