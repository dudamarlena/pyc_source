...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/COFFEE-POT-MIB.py
# Compiled at: 2016-02-13 18:07:06
...
if mibBuilder.loadTexts:
    coffee.setLastUpdated('9803231700Z')
if mibBuilder.loadTexts:
    coffee.setOrganization('Networked Appliance Management Working Group')
if mibBuilder.loadTexts:
    coffee.setContactInfo('        Michael Slavitch\n                        Loran Technologies,\n                        955 Green Valley Crescent\n                        Ottawa, Ontario Canada K2A 0B6\n\n                   Tel: 613-723-7505\n                   Fax: 613-723-7209\n                E-mail: slavitch@loran.com')
if mibBuilder.loadTexts:
    coffee.setDescription('The MIB Module for coffee vending devices.')
potName = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 1), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    potName.setDescription('The vendor description of the pot under management')
potCapacity = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 2), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    potCapacity.setDescription('The number of units of beverage supported by this device\n            (regardless of its current state) .')
potType = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('automatic-drip',
                                                                                                                                                                        1), ('percolator',
                                                                                                                                                                             2), ('french-press',
                                                                                                                                                                                  3), ('espresso',
                                                                                                                                                                                       4)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    potType.setDescription('The brew type of the coffee pot.')
...
if mibBuilder.loadTexts:
    potLocation.setDescription('The physical location of the pot in question')
potMonitor = MibIdentifier((1, 3, 6, 1, 2, 1, 10, 132, 6))
potOperStatus = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 6, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(('off',
                                                                                                                                                                                    1), ('brewing',
                                                                                                                                                                                         2), ('holding',
                                                                                                                                                                                              3), ('other',
                                                                                                                                                                                                   4), ('waiting',
...
if mibBuilder.loadTexts:
    potOperStatus.setDescription('The operating status of the pot in question. Note\n                 that this is a read-only feature. Current hardware\n                 prevents us from changing the port state via SNMP.')
potLevel = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 6, 2), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    potLevel.setDescription('The number of units of coffee under management. The\n                 units of level are defined in potMetric below.')
potMetric = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 6, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(('espresso',
                                                                                                                                                                                1), ('demi-tasse',
                                                                                                                                                                                     2), ('cup',
                                                                                                                                                                                          3), ('mug',
                                                                                                                                                                                               4), ('bucket',
