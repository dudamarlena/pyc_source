...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-TE-STD-MIB.py
# Compiled at: 2016-02-13 18:14:16
...
(MplsPathIndexOrZero, TeHopAddressUnnum, MplsTunnelIndex, TeHopAddressType, TeHopAddress, MplsLSPID, mplsStdMIB, MplsBurstSize, MplsBitRate, MplsTunnelInstanceIndex, MplsOwner, MplsExtendedTunnelId, TeHopAddressAS, MplsTunnelAffinity, MplsPathIndex) = mibBuilder.importSymbols('MPLS-TC-STD-MIB', 'MplsPathIndexOrZero', 'TeHopAddressUnnum', 'MplsTunnelIndex', 'TeHopAddressType', 'TeHopAddress', 'MplsLSPID', 'mplsStdMIB', 'MplsBurstSize', 'MplsBitRate', 'MplsTunnelInstanceIndex', 'MplsOwner', 'MplsExtendedTunnelId', 'TeHopAddressAS', 'MplsTunnelAffinity', 'MplsPathIndex')
(SnmpAdminString,) = mibBuilder.importSymbols('SNMP-FRAMEWORK-MIB', 'SnmpAdminString')
(ObjectGroup, ModuleCompliance, NotificationGroup) = mibBuilder.importSymbols('SNMPv2-CONF', 'ObjectGroup', 'ModuleCompliance', 'NotificationGroup')
(ModuleIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, zeroDotZero, Gauge32, Integer32, ObjectIdentity, iso, Unsigned32, Counter64, NotificationType, Counter32, IpAddress) = mibBuilder.importSymbols('SNMPv2-SMI', 'ModuleIdentity', 'Bits', 'MibIdentifier', 'MibScalar', 'MibTable', 'MibTableRow', 'MibTableColumn', 'TimeTicks', 'zeroDotZero', 'Gauge32', 'Integer32', 'ObjectIdentity', 'iso', 'Unsigned32', 'Counter64', 'NotificationType', 'Counter32', 'IpAddress')
(RowStatus, TextualConvention, RowPointer, TimeStamp, TruthValue, StorageType, DisplayString) = mibBuilder.importSymbols('SNMPv2-TC', 'RowStatus', 'TextualConvention', 'RowPointer', 'TimeStamp', 'TruthValue', 'StorageType', 'DisplayString')
mplsTeStdMIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 10, 166, 3)).setRevisions(('2004-06-03 00:00',))
if mibBuilder.loadTexts:
    mplsTeStdMIB.setLastUpdated('200406030000Z')
if mibBuilder.loadTexts:
    mplsTeStdMIB.setOrganization('Multiprotocol Label Switching (MPLS) Working Group')
if mibBuilder.loadTexts:
    mplsTeStdMIB.setContactInfo('        Cheenu Srinivasan\n                     Bloomberg L.P.\n             Email:  cheenu@bloomberg.net\n            \n                     Arun Viswanathan\n                     Force10 Networks, Inc.\n             Email:  arunv@force10networks.com\n            \n                     Thomas D. Nadeau\n                     Cisco Systems, Inc.\n             Email:  tnadeau@cisco.com\n            \n                    Comments about this document should be emailed\n                    directly to the MPLS working group mailing list at\n                    mpls@uu.net.')
if mibBuilder.loadTexts:
    mplsTeStdMIB.setDescription("Copyright (C) The Internet Society (2004). The\n            initial version of this MIB module was published\n            in RFC 3812. For full legal notices see the RFC\n            itself or see: http://www.ietf.org/copyrights/ianamib.html\n\n            This MIB module contains managed object definitions\n             for MPLS Traffic Engineering (TE) as defined in:\n            1. Extensions to RSVP for LSP Tunnels, Awduche et\n             al, RFC 3209, December 2001\n            2. Constraint-Based LSP Setup using LDP, Jamoussi\n             (Editor), RFC 3212, January 2002\n            3. Requirements for Traffic Engineering Over MPLS,\n             Awduche, D., Malcolm, J., Agogbua, J., O'Dell, M.,\n             and J. McManus, [RFC2702], September 1999")
...
if mibBuilder.loadTexts:
    mplsTunnelSignallingProto.setDescription('The signalling protocol, if any, used to setup this\n            tunnel.')
...
if mibBuilder.loadTexts:
    mplsTunnelSetupPrio.setDescription('Indicates the setup priority of this tunnel.')
...
if mibBuilder.loadTexts:
    mplsTunnelHoldingPrio.setDescription('Indicates the holding priority for this tunnel.')
...
if mibBuilder.loadTexts:
    mplsTunnelAdminStatus.setDescription('Indicates the desired operational status of this\n            tunnel.')
...
if mibBuilder.loadTexts:
    mplsTunnelHopIpAddr.setDescription("The Tunnel Hop Address for this tunnel hop.\n\n                     The type of this address is determined by the\n                     value of the corresponding mplsTunnelHopAddrType.\n\n                     The value of this object cannot be changed\n                     if the value of the corresponding\n                     mplsTunnelHopRowStatus object is 'active'.\n                     ")
...
if mibBuilder.loadTexts:
    mplsTunnelResourceIndex.setDescription('Uniquely identifies this row.')
...
if mibBuilder.loadTexts:
    mplsTunnelResourceMaxRate.setDescription('The maximum rate in bits/second.  Note that setting\n            mplsTunnelResourceMaxRate,\n            mplsTunnelResourceMeanRate, and\n            mplsTunnelResourceMaxBurstSize to 0 indicates best-\n            effort treatment.')
...
if mibBuilder.loadTexts:
    mplsTunnelResourceMaxBurstSize.setDescription('The maximum burst size in bytes.')
...
if mibBuilder.loadTexts:
    mplsTunnelResourceExBurstSize.setDescription('The Excess burst size in bytes.  The implementations\n            which do not implement this variable must return\n            noSuchObject exception for this object and must\n            not allow a user to set this value.')
...
if mibBuilder.loadTexts:
    mplsTunnelCHopType.setDescription('Denotes whether this is tunnel hop is routed in a\n            strict or loose fashion.')
mplsTunnelPerfTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 3, 2, 9))
if mibBuilder.loadTexts:
    mplsTunnelPerfTable.setDescription('This table provides per-tunnel instance MPLS\n            performance information.')
...
if mibBuilder.loadTexts:
    mplsTunnelCRLDPResMeanBurstSize.setDescription('The mean burst size in bytes.')
...
if mibBuilder.loadTexts:
    mplsTunnelCRLDPResExBurstSize.setDescription('The Excess burst size in bytes.')
...
if mibBuilder.loadTexts:
    mplsTunnelCRLDPResFrequency.setDescription('The granularity of the availability of committed\n            rate.')
...
if mibBuilder.loadTexts:
    mplsTunnelCRLDPResWeight.setDescription('The relative weight for using excess bandwidth above\n            its committed rate.  The value of 0 means that\n            weight is not applicable for the CR-LSP.')
...
if mibBuilder.loadTexts:
    mplsTunnelDown.setDescription('This notification is generated when a\n            mplsTunnelOperStatus object for one of the\n            configured tunnels is about to enter the down state\n            from some other state (but not from the notPresent\n            state).  This other state is indicated by the\n            included value of mplsTunnelOperStatus.')
...
if mibBuilder.loadTexts:
    mplsTeModuleFullCompliance.setDescription('Compliance statement for agents that provide full\n            support the MPLS-TE-STD-MIB module.')
...
if mibBuilder.loadTexts:
    mplsTeModuleReadOnlyCompliance.setDescription('Compliance requirement for implementations that only\n            provide read-only support for MPLS-TE-STD-MIB.\n            Such devices can then be monitored but cannot be\n            configured using this MIB modules.')
...
if mibBuilder.loadTexts:
    mplsTunnelSignaledGroup.setDescription('Objects needed to implement signaled tunnels.')
...
if mibBuilder.loadTexts:
    mplsTunnelScalarGroup.setDescription('Scalar object needed to implement MPLS tunnels.')
mplsTunnelIsIntfcGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 166, 3, 3, 1, 5)).setObjects(*(('MPLS-TE-STD-MIB', 'mplsTunnelIsIf'),))
if mibBuilder.loadTexts:
    mplsTunnelIsIntfcGroup.setDescription('Objects needed to implement tunnels that are\n            interfaces.')
mplsTunnelIsNotIntfcGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 166, 3, 3, 1, 6)).setObjects(*(('MPLS-TE-STD-MIB', 'mplsTunnelIsIf'),))
if mibBuilder.loadTexts:
    mplsTunnelIsNotIntfcGroup.setDescription('Objects needed to implement tunnels that are not\n            interfaces.')
...
if mibBuilder.loadTexts:
    mplsTunnelCRLDPResOptionalGroup.setDescription('Set of objects implemented for resources applicable\n            for tunnels signaled using CR-LDP.')
