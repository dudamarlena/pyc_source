...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DLSW-MIB.py
# Compiled at: 2016-02-13 18:08:34
...
if mibBuilder.loadTexts:
    dlsw.setLastUpdated('9606040900Z')
if mibBuilder.loadTexts:
    dlsw.setOrganization('AIW DLSw MIB RIGLET and IETF DLSw MIB Working Group')
if mibBuilder.loadTexts:
    dlsw.setContactInfo('David D. Chen\n                   IBM Corporation\n                   800 Park, Highway 54\n                   Research Triangle Park, NC 27709-9990\n                   Tel:    1 919 254 6182\n                   E-mail: dchen@vnet.ibm.com')
if mibBuilder.loadTexts:
    dlsw.setDescription('This MIB module contains objects to manage Data Link\n         Switches.')
...
class EndStationLocation(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('internal', 2), ('remote', 3), ('local',
                                                                             4))
...
class DlcType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('na', 2), ('llc', 3), ('sdlc', 4), ('qllc',
                                                                                 5))
...
class LFSize(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('lfs516', 516), ('lfs635', 635), ('lfs754', 754), ('lfs873',
                                                                                  873), ('lfs993',
                                                                                         993), ('lfs1112',
                                                                                                1112), ('lfs1231',
                                                                                                        1231), ('lfs1350',
...
class DlswTCPAddress(OctetString, TextualConvention):
    __module__ = __name__
...
if mibBuilder.loadTexts:
    dlswTConnOperEntryTime.setDescription('The amount of time (in hundredths of a second) since this\n        transport connection conceptual row was created.')
...
if mibBuilder.loadTexts:
    dlswTConnOperPartnerVendorID.setDescription("This value identifies the IEEE-assigned organizationally\n        Unique Identifier (OUI) of the maker of this partner\n        DLSw.  This information is obtained from a DLSw\n        capabilities exchange message received from the partner DLSw.\n        A string of zero length is returned before a Capabilities\n        Exchange message is received, or if one is never received.\n\n        If an implementation chooses to keep dlswTConnOperEntrys in\n        the `disconnected' state, this value should remain unchanged.")
...
if mibBuilder.loadTexts:
    dlswTConnOperDiscTime.setDescription("The amount of time (in hundredths of a second) since the\n        dlswTConnOperState last entered `disconnected' state.")
...
if mibBuilder.loadTexts:
    dlswTConnTcpOperEntry.setDescription('')
...
if mibBuilder.loadTexts:
    dlswTConnTcpOperKeepAliveInt.setDescription('The time in seconds between TCP keepAlive messages when\n        no traffic is flowing.  Zero signifies no keepAlive protocol is\n        operating.')
...
if mibBuilder.loadTexts:
    dlswTConnTcpOperPrefTcpConnections.setDescription('This is the number of TCP connections preferred by this DLSw\n        partner, as received in its capabilities exchange message.')
...
if mibBuilder.loadTexts:
    dlswTConnTcpOperTcpConnections.setDescription('This is the actual current number of TCP connections within\n        this transport connection.')
dlswIfTable = MibTable((1, 3, 6, 1, 2, 1, 46, 1, 3, 1))
if mibBuilder.loadTexts:
    dlswIfTable.setDescription('The list of interfaces on which DLSw is active.')
dlswIfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 46, 1, 3, 1, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    dlswIfEntry.setDescription('')
dlswIfRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 46, 1, 3, 1, 1, 1), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    dlswIfRowStatus.setDescription('This object is used by the manager to create\n        or delete the row entry in the dlswIfTable\n        following the RowStatus textual convention.')
...
if mibBuilder.loadTexts:
    dlswDirMacEntries.setDescription('The current total number of entries in the dlswDirMacTable.')
dlswDirMacCacheHits = MibScalar((1, 3, 6, 1, 2, 1, 46, 1, 4, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dlswDirMacCacheHits.setDescription('The number of times a cache search for a particular MAC address\n        resulted in success.')
dlswDirMacCacheMisses = MibScalar((1, 3, 6, 1, 2, 1, 46, 1, 4, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dlswDirMacCacheMisses.setDescription('The number of times a cache search for a particular MAC address\n        resulted in failure.')
...
if mibBuilder.loadTexts:
    dlswDirMacMask.setDescription('The MAC address mask, together with the dlswDirMacMac,\n        specifies a set of MAC addresses that are defined or\n        discovered through an interface or partner DLSw nodes.')
...
if mibBuilder.loadTexts:
    dlswDirNBNameType.setDescription('Whether dlswDirNBName represents an (or a set of) individual\n        or group NetBIOS name(s).')
...
if mibBuilder.loadTexts:
    dlswCircuitEntry.setDescription('')
dlswCircuitS1Mac = MibTableColumn((1, 3, 6, 1, 2, 1, 46, 1, 5, 2, 1, 1), MacAddressNC())
if mibBuilder.loadTexts:
    dlswCircuitS1Mac.setDescription('The MAC Address of End Station 1 (S1) used for this circuit.')
...
if mibBuilder.loadTexts:
    dlswCircuitS1Sap.setDescription('The SAP at End Station 1 (S1) used for this circuit.')
...
if mibBuilder.loadTexts:
    dlswCircuitS1IfIndex.setDescription('The ifEntry index of the local interface through which S1\n        can be reached.')
dlswCircuitS1DlcType = MibTableColumn((1, 3, 6, 1, 2, 1, 46, 1, 5, 2, 1, 4), DlcType()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dlswCircuitS1DlcType.setDescription('The DLC protocol in use between the DLSw node and S1.')
...
if mibBuilder.loadTexts:
    dlswCircuitS2CircuitId.setDescription('The Circuit ID assigned to this circuit by the partner\n        DLSw node.  The first four octets are the DLC port Id, and\n        the second four octets are the Data Link Correlator.\n        If the DLSw SSP was not used to establish this circuit,\n        the value will be a string of zero length.')
...
if mibBuilder.loadTexts:
    dlswCircuitOrigin.setDescription('This object specifies which of the two end stations\n        initiated the establishment of this circuit.')
...
if mibBuilder.loadTexts:
    dlswCircuitEntryTime.setDescription('The amount of time (in hundredths of a second) since this\n        circuit table conceptual row was created.')
...
if mibBuilder.loadTexts:
    dlswCircuitStateTime.setDescription('The amount of time (in hundredths of a second) since this\n        circuit entered the current state.')
...
if mibBuilder.loadTexts:
    dlswSdlcLsLocalSap.setDescription('The SAP used to represent this link station.')
...
if mibBuilder.loadTexts:
    dlswSdlcLsLocalIdBlock.setDescription('The block number is the first three digits of the node_id,\n\n        if available.  These 3 hexadecimal digits identify the\n        product.')
...
if mibBuilder.loadTexts:
    dlswTrapTConnDown.setDescription("This trap is sent each time a transport connection\n        enters `disconnected' state.  The emission of this trap\n        is controlled by dlswTrapCntlTConn.")
...
if mibBuilder.loadTexts:
    dlswTrapCircuitUp.setDescription("This trap is sent each time a circuit enters `connected'\n        state.  The emission of this trap is controlled by\n        dlswTrapCntlCircuit.")
...
if mibBuilder.loadTexts:
    dlswTrapCircuitDown.setDescription("This trap is sent each time a circuit enters `disconnected'\n        state.  The emission of this trap is controlled by\n        dlswTrapCntlCircuit.")
...
if mibBuilder.loadTexts:
    dlswCoreCompliance.setDescription('The core compliance statement for all DLSw nodes.')
...
if mibBuilder.loadTexts:
    dlswTConnTcpCompliance.setDescription('Compliance for DLSw nodes that use TCP as a\n        transport connection protocol.')
dlswDirCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 46, 3, 1, 3)).setObjects(*(('DLSW-MIB', 'dlswDirGroup'), ('DLSW-MIB', 'dlswDirNBGroup')))
if mibBuilder.loadTexts:
    dlswDirCompliance.setDescription('Compliance for DLSw nodes that provide a directory\n        function.')
...
if mibBuilder.loadTexts:
    dlswDirLocateCompliance.setDescription('Compliance for DLSw nodes that provide an ordered\n        list of directory entries for a given resource.')
dlswSdlcCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 46, 3, 1, 5)).setObjects(*(('DLSW-MIB', 'dlswSdlcGroup'),))
if mibBuilder.loadTexts:
    dlswSdlcCompliance.setDescription('Compliance for DLSw nodes that support SDLC.')
...
if mibBuilder.loadTexts:
    dlswNodeGroup.setDescription('Conformance group for DLSw node general information.')
dlswNodeNBGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 46, 3, 2, 2)).setObjects(*(('DLSW-MIB', 'dlswNodeResourceNBExclusivity'),))
if mibBuilder.loadTexts:
    dlswNodeNBGroup.setDescription('Conformance group for DLSw node general information\n        specifically for nodes that support NetBIOS.')
...
if mibBuilder.loadTexts:
    dlswTConnStatGroup.setDescription('Conformance group for statistics for transport\n        connections.')
...
if mibBuilder.loadTexts:
    dlswTConnConfigGroup.setDescription('Conformance group for the configuration of\n        transport connections.')
...
if mibBuilder.loadTexts:
    dlswTConnOperGroup.setDescription('Conformance group for operation information for\n        transport connections.')
...
if mibBuilder.loadTexts:
    dlswTConnNBGroup.setDescription('Conformance group for operation information for\n        transport connections, specifically for nodes\n        that support NetBIOS.')
...
if mibBuilder.loadTexts:
    dlswTConnTcpConfigGroup.setDescription('Conformance group for configuration information for\n        transport connections using TCP.')
...
if mibBuilder.loadTexts:
    dlswTConnTcpOperGroup.setDescription('Conformance group for operation information for\n        transport connections using TCP.')
...
if mibBuilder.loadTexts:
    dlswInterfaceGroup.setDescription('Conformance group for DLSw interfaces.')
...
if mibBuilder.loadTexts:
    dlswDirGroup.setDescription('Conformance group for DLSw directory using MAC\n        addresses.')
...
if mibBuilder.loadTexts:
    dlswCircuitStatGroup.setDescription('Conformance group for statistics about circuits.')
...
if mibBuilder.loadTexts:
    dlswCircuitGroup.setDescription('Conformance group for DLSw circuits.')
...
if mibBuilder.loadTexts:
    dlswSdlcGroup.setDescription('Conformance group for DLSw SDLC support.')
