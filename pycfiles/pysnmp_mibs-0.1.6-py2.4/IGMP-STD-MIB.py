...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IGMP-STD-MIB.py
# Compiled at: 2016-02-13 18:16:53
...
if mibBuilder.loadTexts:
    igmpStdMIB.setLastUpdated('200009280000Z')
if mibBuilder.loadTexts:
    igmpStdMIB.setOrganization('IETF IDMR Working Group.')
if mibBuilder.loadTexts:
    igmpStdMIB.setContactInfo(' Dave Thaler\n              Microsoft Corporation\n              One Microsoft Way\n              Redmond, WA  98052-6399\n              US\n\n              Phone: +1 425 703 8835\n              EMail: dthaler@microsoft.com')
if mibBuilder.loadTexts:
    igmpStdMIB.setDescription('The MIB module for IGMP Management.')
igmpMIBObjects = MibIdentifier((1, 3, 6, 1, 2, 1, 85, 1))
igmpInterfaceTable = MibTable((1, 3, 6, 1, 2, 1, 85, 1, 1))
if mibBuilder.loadTexts:
    igmpInterfaceTable.setDescription('The (conceptual) table listing the interfaces on which IGMP\n            is enabled.')
igmpInterfaceEntry = MibTableRow((1, 3, 6, 1, 2, 1, 85, 1, 1, 1)).setIndexNames((0,
                                                                                 'IGMP-STD-MIB',
                                                                                 'igmpInterfaceIfIndex'))
if mibBuilder.loadTexts:
    igmpInterfaceEntry.setDescription('An entry (conceptual row) representing an interface on\n            which IGMP is enabled.')
igmpInterfaceIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 85, 1, 1, 1, 1), InterfaceIndex())
if mibBuilder.loadTexts:
    igmpInterfaceIfIndex.setDescription('The ifIndex value of the interface for which IGMP is\n            enabled.')
...
if mibBuilder.loadTexts:
    igmpInterfaceRobustness.setDescription('The Robustness Variable allows tuning for the expected\n            packet loss on a subnet.  If a subnet is expected to be\n            lossy, the Robustness Variable may be increased.  IGMP is\n            robust to (Robustness Variable-1) packet losses.')
...
if mibBuilder.loadTexts:
    igmpV1HostMIBCompliance.setDescription('The compliance statement for hosts running IGMPv1 and\n            implementing the IGMP MIB.')
...
if mibBuilder.loadTexts:
    igmpV1RouterMIBCompliance.setDescription('The compliance statement for routers running IGMPv1 and\n            implementing the IGMP MIB.')
...
if mibBuilder.loadTexts:
    igmpV2HostMIBCompliance.setDescription('The compliance statement for hosts running IGMPv2 and\n            implementing the IGMP MIB.')
...
if mibBuilder.loadTexts:
    igmpV2RouterMIBCompliance.setDescription('The compliance statement for routers running IGMPv2 and\n            implementing the IGMP MIB.')
...
if mibBuilder.loadTexts:
    igmpBaseMIBGroup.setDescription('The basic collection of objects providing management of\n            IGMP version 1 or 2.')
...
if mibBuilder.loadTexts:
    igmpRouterMIBGroup.setDescription('A collection of additional objects for management of IGMP\n            version 1 or 2 in routers.')
igmpV2HostMIBGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 85, 2, 2, 3)).setObjects(*(('IGMP-STD-MIB', 'igmpInterfaceVersion1QuerierTimer'), ))
if mibBuilder.loadTexts:
    igmpV2HostMIBGroup.setDescription('A collection of additional objects for management of IGMP\n            version 2 in hosts.')
...
if mibBuilder.loadTexts:
    igmpV2RouterMIBGroup.setDescription('A collection of additional objects for management of IGMP\n            version 2 in routers.')
igmpV2ProxyMIBGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 85, 2, 2, 6)).setObjects(*(('IGMP-STD-MIB', 'igmpInterfaceProxyIfIndex'), ))
if mibBuilder.loadTexts:
    igmpV2ProxyMIBGroup.setDescription('A collection of additional objects for management of IGMP\n            proxy devices.')
