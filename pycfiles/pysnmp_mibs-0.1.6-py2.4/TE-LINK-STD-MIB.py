...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/TE-LINK-STD-MIB.py
...
class TeLinkSwitchingCapability(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('packetSwitch1', 1), ('packetSwitch2', 2), ('packetSwitch3',
                                                                           3), ('packetSwitch4',
                                                                                4), ('layer2Switch',
                                                                                     51), ('tdm',
                                                                                           100), ('lambdaSwitch',
...
class TeLinkEncodingType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('packet', 1), ('ethernet', 2), ('ansiEtsiPdh', 3), ('sdhItuSonetAnsi',
                                                                                   5), ('digitalWrapper',
                                                                                        7), ('lambda',
                                                                                             8), ('fiber',
                                                                                                  9), ('fiberChannel',
...
if mibBuilder.loadTexts:
    teLinkDescriptorId.setDescription('This object specifies the link descriptor identifier.')
...
if mibBuilder.loadTexts:
    teLinkDescrSwitchingCapability.setDescription('This attribute specifies interface switching capability of\n        the TE link, which is derived from its component links.')
teLinkDescrEncodingType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 2, 1, 3), TeLinkEncodingType()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    teLinkDescrEncodingType.setDescription('This attribute specifies the TE link encoding type.')
...
if mibBuilder.loadTexts:
    componentLinkDescrId.setDescription('This object specifies the link descriptor identifier.')
...
if mibBuilder.loadTexts:
    componentLinkDescrSwitchingCapability.setDescription('This attribute specifies link multiplexing capabilities of\n        the component link.')
componentLinkDescrEncodingType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 6, 1, 3), TeLinkEncodingType()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    componentLinkDescrEncodingType.setDescription('This attribute specifies the component link encoding type.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMinLspBandwidth.setDescription('This attribute specifies the minimum LSP bandwidth on\n        the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio0.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 0 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio1.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 1 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio2.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 2 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio3.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 3 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio4.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 4 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio5.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 5 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio6.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 6 on the component link.')
...
if mibBuilder.loadTexts:
    componentLinkDescrMaxLspBandwidthPrio7.setDescription('This attribute specifies the maximum LSP bandwidth at\n        priority 7 on the component link.')
...
if mibBuilder.loadTexts:
    teLinkModuleFullCompliance.setDescription('Compliance statement for agents that support read-create\n        so that both configuration and monitoring of TE links can\n        be accomplished via this MIB module.')
...
if mibBuilder.loadTexts:
    teLinkModuleReadOnlyCompliance.setDescription('Compliance statement for agents that support the\n        monitoring of the TE link MIB module.')
...
if mibBuilder.loadTexts:
    teLinkGroup.setDescription('Collection of objects needed for the management of\n           resources associated with TE links.')
...
if mibBuilder.loadTexts:
    teLinkSrlgGroup.setDescription('Collection of objects needed for the management of\n           SRLG resources associated with TE links.')
...
if mibBuilder.loadTexts:
    teLinkBandwidthGroup.setDescription('Collection of objects needed for the management of\n           the bandwidth resources associated with TE links and\n           component links.')
...
if mibBuilder.loadTexts:
    componentLinkBandwidthGroup.setDescription('Collection of objects needed for the management of the\n           bandwidth parameters associated with component links.')
...
if mibBuilder.loadTexts:
    teLinkPscGroup.setDescription('Collection of objects needed for devices that are\n           packet switch capable.')
...
if mibBuilder.loadTexts:
    teLinkTdmGroup.setDescription('Collection of objects needed for devices that are\n           TDM switching capable.')
