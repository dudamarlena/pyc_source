...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/TRIP-MIB.py
...
if mibBuilder.loadTexts:
    tripCfgMaxPurgeTime.setDescription('Indicates the interval that the LS MUST maintain routes\n            marked as withdrawn in its database.')
...
if mibBuilder.loadTexts:
    tripPeerKeepAliveConfigured.setDescription('Specifies the amount of time that MUST elapse between\n            keep alive messages.')
...
if mibBuilder.loadTexts:
    tripPeerMaxPurgeTime.setDescription('Indicates the interval that the LS MUST maintain routes\n            marked as withdrawn in its database.')
...
if mibBuilder.loadTexts:
    tripRouteLocalPref.setDescription("Indicated the local LS's degree of preference for an\n            advertised route destination.")
...
if mibBuilder.loadTexts:
    tripRouteCommunityEntry.setDescription('Information about communities associated with a route.\n            An entry with a tripRouteAddress of 00 and a\n            tripRoutePeer of 0 refers to the local LS.')
tripRouteCommunityId = MibTableColumn((1, 3, 6, 1, 2, 1, 116, 1, 7, 1, 1), TripCommunityId())
if mibBuilder.loadTexts:
    tripRouteCommunityId.setDescription('The community identifier.')
tripRouteCommunityItad = MibTableColumn((1, 3, 6, 1, 2, 1, 116, 1, 7, 1, 2), TripItad()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tripRouteCommunityItad.setDescription('The ITAD associated with this community.')
tripItadTopologyTable = MibTable((1, 3, 6, 1, 2, 1, 116, 1, 8))
if mibBuilder.loadTexts:
    tripItadTopologyTable.setDescription('The sequence of link connections between peers within an\n            ITAD. The objects in this table are volatile and are\n            refreshed after a reboot.')
tripItadTopologyEntry = MibTableRow((1, 3, 6, 1, 2, 1, 116, 1, 8, 1)).setIndexNames((0,
                                                                                     'NETWORK-SERVICES-MIB',
                                                                                     'applIndex'), (0,
                                                                                                    'TRIP-MIB',
                                                                                                    'tripItadTopologyOrigId'))
if mibBuilder.loadTexts:
    tripItadTopologyEntry.setDescription('Information about a peer of the LS identified by\n            tripItadTopologyOrigId.')
tripItadTopologyOrigId = MibTableColumn((1, 3, 6, 1, 2, 1, 116, 1, 8, 1, 1), TripId())
if mibBuilder.loadTexts:
    tripItadTopologyOrigId.setDescription('Indicates the internal LS that originated the ITAD\n            topology information into the ITAD.')
...
if mibBuilder.loadTexts:
    tripNotifApplIndex.setDescription('This object contains the application Index. It is used\n             to bind this notification with a specific instance of\n             TRIP entity.')
tripNotifPeerAddrInetType = MibScalar((1, 3, 6, 1, 2, 1, 116, 3, 2), InetAddressType()).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    tripNotifPeerAddrInetType.setDescription('The type of Inet Address of the tripNotifPeerAddr.')
tripNotifPeerAddr = MibScalar((1, 3, 6, 1, 2, 1, 116, 3, 3), InetAddress()).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    tripNotifPeerAddr.setDescription("The IP address of this entry's TRIP peer LS. This object\n            contains the value of tripPeerRemoteAddr. The type of this\n            address is determined by the value of the\n            tripNotifPeerAddrInetType object.")
tripNotifPeerErrCode = MibScalar((1, 3, 6, 1, 2, 1, 116, 3, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(('messageHeader',
                                                                                                                                                                                             1), ('openMessage',
                                                                                                                                                                                                  2), ('updateMessage',
                                                                                                                                                                                                       3), ('holdTimerExpired',
...
if mibBuilder.loadTexts:
    tripConnectionEstablished.setDescription('The TRIP Connection Established event is generated when\n            the TRIP finite state machine enters the ESTABLISHED\n            state.')
...
if mibBuilder.loadTexts:
    tripConnectionDropped.setDescription('The TRIP Connection Dropped event is generated when the\n\n\n\n            TRIP finite state machine leaves the ESTABLISHED state.')
...
if mibBuilder.loadTexts:
    tripFSM.setDescription('The trip FSM Event is generated when any error is\n            detected by the TRIP Finite State Machine.')
...
if mibBuilder.loadTexts:
    tripOpenMessageError.setDescription('Errors detected while processing the OPEN message.')
...
if mibBuilder.loadTexts:
    tripUpdateMessageError.setDescription('Errors detected while processing the UPDATE message.')
...
if mibBuilder.loadTexts:
    tripHoldTimerExpired.setDescription('The system does not receive successive messages within\n            the period specified by the negotiated Hold Time.')
tripConnectionCollision = NotificationType((1, 3, 6, 1, 2, 1, 116, 0, 7)).setObjects(*(('TRIP-MIB', 'tripNotifApplIndex'), ))
if mibBuilder.loadTexts:
    tripConnectionCollision.setDescription('A pair of LSs tried to simultaneously to establish a\n            transport connection to each other.')
...
if mibBuilder.loadTexts:
    tripConfigGroup.setDescription('The global objects for configuring trip.')
...
if mibBuilder.loadTexts:
    tripPeerTableConfigGroup.setDescription('The global objects for configuring the TRIP peer\n            table.')
...
if mibBuilder.loadTexts:
    tripPeerTableStatsGroup.setDescription('The global statistics the TRIP peer table.')
...
if mibBuilder.loadTexts:
    tripRouteGroup.setDescription('The global objects for configuring route attribute.')
...
if mibBuilder.loadTexts:
    tripItadTopologyGroup.setDescription('The objects that define the TRIP ITAD topology.')
...
if mibBuilder.loadTexts:
    tripNotificationGroup.setDescription('A collection of notifications defined for TRIP.')
...
if mibBuilder.loadTexts:
    tripNotifObjectGroup.setDescription('The collection of objects that specify information for\n            TRIP notifications.')
