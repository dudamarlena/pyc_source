...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-VIRTUAL-FABRIC-MIB.py
# Compiled at: 2016-02-13 18:30:38
...
if mibBuilder.loadTexts:
    t11vfCoreSwitchTable.setDescription('A table of core switches supported by the current\n         management entity.')
t11vfCoreSwitchEntry = MibTableRow((1, 3, 6, 1, 2, 1, 147, 1, 1, 1)).setIndexNames((0,
                                                                                    'FC-MGMT-MIB',
                                                                                    'fcmInstanceIndex'), (0,
                                                                                                          'T11-FC-VIRTUAL-FABRIC-MIB',
                                                                                                          't11vfCoreSwitchSwitchName'))
if mibBuilder.loadTexts:
    t11vfCoreSwitchEntry.setDescription('Each entry represents one core switch.')
...
if mibBuilder.loadTexts:
    t11vfCoreSwitchSwitchName.setDescription('The Core Switch_Name (WWN) of this Core Switch.')
...
if mibBuilder.loadTexts:
    t11vfVirtualSwitchStorageType.setDescription("The storage type for this conceptual row.\n         Conceptual rows having the value 'permanent' need not\n         allow write-access to any columnar objects in the row.")
t11vfPortTable = MibTable((1, 3, 6, 1, 2, 1, 147, 1, 3))
if mibBuilder.loadTexts:
    t11vfPortTable.setDescription('A table of Port attributes related to Virtual Fabrics.')
...
if mibBuilder.loadTexts:
    t11vfLocallyEnabledStorageType.setDescription("The storage type for this conceptual row.\n             Conceptual rows having the value 'permanent' need not\n             allow write-access to any columnar objects in the row.")
...
if mibBuilder.loadTexts:
    t11vfMIBCompliance.setDescription('Describes the requirements for compliance to the\n         Fibre Channel Virtual Fabric MIB.')
...
if mibBuilder.loadTexts:
    t11vfGeneralGroup.setDescription('A collection of objects for monitoring and\n             configuring Virtual Fabrics in a Fibre Channel switch.')
