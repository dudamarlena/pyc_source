...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/VRRP-MIB.py
# Compiled at: 2016-02-13 18:33:05
...
vrrpMIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 68)).setRevisions(('2006-12-13 00:00',
                                                               '2000-03-03 00:00'))
if mibBuilder.loadTexts:
    vrrpMIB.setLastUpdated('200612130000Z')
if mibBuilder.loadTexts:
    vrrpMIB.setOrganization('IETF VRRP Working Group')
if mibBuilder.loadTexts:
    vrrpMIB.setContactInfo('Kalyan Tata   \n                Nokia Inc.  \n                313 Fairchild Dr.  \n                Mountain View, CA 94043')
if mibBuilder.loadTexts:
    vrrpMIB.setDescription('This MIB describes objects used for managing Virtual  \n             Router Redundancy Protocol (VRRP) over IPv4 and IPv6 \n             protocols. \n \n             This MIB supports VRRP for IPv4 and IPv6 protocols \n             simultaneously running on a given interface of a  \n             router. \n     \n             Copyright (C) The IETF Trust (2006).')
...
if mibBuilder.loadTexts:
    vrrpRouterStatisticsEntry.setDescription('An entry in the table, containing statistics  \n            information about a given virtual router.')
vrrpStatisticsMasterTransitions = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsMasterTransitions.setDescription("The total number of times that this virtual router's  \n            state has transitioned to MASTER.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.")
vrrpStatisticsRcvdAdvertisements = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsRcvdAdvertisements.setDescription('The total number of VRRP advertisements received by  \n            this virtual router.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.')
vrrpStatisticsAdvIntervalErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsAdvIntervalErrors.setDescription('The total number of VRRP advertisement packets  \n            received for which the advertisement interval is  \n            different than the one configured for the local virtual \n            router. \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.')
vrrpStatisticsIpTtlErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsIpTtlErrors.setDescription('The total number of VRRP packets received by the  \n            Virtual router with IPv4 TTL (for VRRP over IPv4) or  \n            IPv6 Hop Limit (for VRRP over IPv6) not equal to 255. \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.')
vrrpStatisticsRcvdPriZeroPackets = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsRcvdPriZeroPackets.setDescription("The total number of VRRP packets received by the  \n            virtual router with a priority of '0'.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.")
vrrpStatisticsSentPriZeroPackets = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsSentPriZeroPackets.setDescription("The total number of VRRP packets sent by the virtual  \n            router with a priority of '0'.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.")
vrrpStatisticsRcvdInvalidTypePkts = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1,
                                                    7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsRcvdInvalidTypePkts.setDescription("The number of VRRP packets received by the virtual  \n            router with an invalid value in the 'type' field.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.")
vrrpStatisticsAddressListErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsAddressListErrors.setDescription('The total number of packets received for which the  \n            address list does not match the locally configured list \n            for the virtual router.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.')
vrrpStatisticsPacketLengthErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsPacketLengthErrors.setDescription('The total number of packets received with a packet  \n            length less than the length of the VRRP header.   \n     \n            Discontinuities in the value of this counter can occur  \n            at re-initialization of the management system, and at  \n            other times as indicated by the value of  \n            vrrpStatisticsDiscontinuityTime.')
vrrpStatisticsRcvdInvalidAuthentications = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2,
                                                           5, 1, 10), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsRcvdInvalidAuthentications.setDescription('The total number of packets received with an unknown \n         authentication type.')
vrrpStatisticsDiscontinuityTime = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 11), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsDiscontinuityTime.setDescription("The value of sysUpTime on the most recent occasion at  \n            which any one or more of this entry's counters suffered \n            a discontinuity.  \n     \n            If no such discontinuities have occurred since the last \n            re-initialization of the local management subsystem,  \n            then this object contains a zero value.")
vrrpStatisticsRefreshRate = MibTableColumn((1, 3, 6, 1, 2, 1, 68, 2, 5, 1, 12), Unsigned32()).setUnits('milli-seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpStatisticsRefreshRate.setDescription('The minimum reasonable polling interval for this entry. \n            This object provides an indication of the minimum  \n            Amount of time required to update the counters in this  \n            entry.')
vrrpNotifications = MibIdentifier((1, 3, 6, 1, 2, 1, 68, 0))
vrrpNewMasterReason = MibScalar((1, 3, 6, 1, 2, 1, 68, 1, 9), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(('notmaster',
                                                                                                                                                                                  0), ('priority',
                                                                                                                                                                                       1), ('preempted',
                                                                                                                                                                                            2), ('masterNoResponse',
                                                                                                                                                                                                 3)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vrrpNewMasterReason.setDescription('This indicates the reason for vrrpNewMaster trap.  \n            Used by vrrpTrapNewMaster trap. The object can be  \n            polled if the vrrpNewMaster trap is lost to identify  \n            the reason for transmission. Backup router should  \n            return notmaster(0) when pooled. ')
vrrpTrapProtoErrReason = MibScalar((1, 3, 6, 1, 2, 1, 68, 1, 10), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(('hopLimitError',
                                                                                                                                                                                      0), ('versionError',
                                                                                                                                                                                           1), ('checksumError',
                                                                                                                                                                                                2), ('vridError',
                                                                                                                                                                                                     3)))).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    vrrpTrapProtoErrReason.setDescription('This indicates the reason for protocol error trap.  \n            Used by vrrpTrapProtoError trap.')
...
if mibBuilder.loadTexts:
    vrrpOperPriority.setDescription("This object specifies the priority to be used for the \n         virtual router master election process.  Higher values  \n         imply higher priority. \n \n         A priority of '0', although not settable, is sent by \n         the master router to indicate that this router has ceased \n         to participate in VRRP and a backup virtual router should \n         transition to become a new master. \n \n         A priority of 255 is used for the router that owns the \n         associated IP address(es). \n \n         This object is deprecated in favor of the IP Version  \n         Independent object, vrrpOperationsPriority.")
...
if mibBuilder.loadTexts:
    vrrpTrapAuthFailure.setDescription("A vrrpAuthFailure trap signifies that a packet has \n         been received from a router whose authentication key \n         or authentication type conflicts with this router's \n         authentication key or authentication type.  Implementation \n         of this trap is optional. \n \n         This object is deprecated in the IP Version MIB. ")
...
if mibBuilder.loadTexts:
    vrrpMIBCompliance.setDescription('This compliance is deprecated in favour of   \n           vrrpModuleFullCompliance.')
...
if mibBuilder.loadTexts:
    vrrpModuleFullCompliance.setDescription('The compliance statement for both VRRP for IPv4 and  \n           VRRP for IPv6 implementations.')
...
if mibBuilder.loadTexts:
    vrrpOperGroup.setDescription('Conformance group for VRRP operations.')
...
if mibBuilder.loadTexts:
    vrrpStatsGroup.setDescription('Conformance group for VRRP statistics.')
vrrpTrapGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 68, 3, 2, 3)).setObjects(*(('VRRP-MIB', 'vrrpTrapPacketSrc'), ('VRRP-MIB', 'vrrpTrapAuthErrorType')))
if mibBuilder.loadTexts:
    vrrpTrapGroup.setDescription('Conformance group for objects contained in VRRP  \n        notifications.')
...
if mibBuilder.loadTexts:
    vrrpNotificationGroup.setDescription('The VRRP MIB Notification Group.')
...
if mibBuilder.loadTexts:
    vrrpOperationsGroup.setDescription('Conformance group for VRRP over IPv4 and IPv6  \n           operations.')
...
if mibBuilder.loadTexts:
    vrrpStatisticsGroup.setDescription('Conformance group for VRRP over IPv4 and IPv6  \n           statistics.')
...
if mibBuilder.loadTexts:
    vrrpTrapInfoGroup.setDescription('Conformance group for objects contained in VRRP   \n            notifications.')
...
if mibBuilder.loadTexts:
    vrrpNotificationsGroup.setDescription('The VRRP MIB Notification Group.')
