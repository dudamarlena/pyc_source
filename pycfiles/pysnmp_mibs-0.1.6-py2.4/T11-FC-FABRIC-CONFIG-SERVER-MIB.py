...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-FABRIC-CONFIG-SERVER-MIB.py
# Compiled at: 2016-02-13 18:29:49
...
class T11FcIeType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('unknown', 1), ('other', 2), ('switch', 3), ('hub',
                                                                            4), ('bridge',
                                                                                 5))
...
class T11FcPortState(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('unknown', 1), ('other', 2), ('online', 3), ('offline',
                                                                            4), ('testing',
                                                                                 5), ('fault',
                                                                                      6))
...
class T11FcPortTxType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('unknown', 1), ('other', 2), ('shortwave850nm', 3), ('longwave1550nm',
                                                                                    4), ('longwave1310nm',
                                                                                         5), ('electrical',
                                                                                              6), ('tenGbaseSr850',
                                                                                                   7), ('tenGbaseLr1310',
...
class T11FcsRejectReasonExplanation(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noAdditionalExplanation', 1), ('invNameIdForIEOrPort',
                                                               2), ('ieListNotAvailable',
                                                                    3), ('ieTypeNotAvailable',
                                                                         4), ('domainIdNotAvailable',
                                                                              5), ('mgmtIdNotAvailable',
                                                                                   6), ('fabNameNotAvailable',
                                                                                        7), ('ielogNameNotAvailable',
                                                                                             8), ('mgmtAddrListNotAvailable',
                                                                                                  9), ('ieInfoListNotAvailable',
                                                                                                       10), ('portListNotAvailable',
                                                                                                             11), ('portTypeNotAvailable',
                                                                                                                   12), ('phyPortNumNotAvailable',
                                                                                                                         13), ('attPortNameListNotAvailable',
                                                                                                                               14), ('portStateNotAvailable',
                                                                                                                                     15), ('unableToRegIELogName',
                                                                                                                                           16), ('platformNameNoExist',
                                                                                                                                                 17), ('platformNameAlreadyExists',
                                                                                                                                                       18), ('platformNodeNameNoExists',
                                                                                                                                                             19), ('platformNodeNameAlreadyExists',
                                                                                                                                                                   20), ('resourceUnavailable',
                                                                                                                                                                         21), ('noEntriesInLunMap',
                                                                                                                                                                               22), ('invalidDeviceNameLength',
                                                                                                                                                                                     23), ('multipleAttributes',
                                                                                                                                                                                           24), ('invalidAttribBlockLength',
                                                                                                                                                                                                 25), ('attributesMissing',
                                                                                                                                                                                                       26))


t11FcsFabricDiscoveryTable = MibTable((1, 3, 6, 1, 2, 1, 162, 1, 1, 1))
if mibBuilder.loadTexts:
    t11FcsFabricDiscoveryTable.setDescription('This table contains control information for discovery\n            of Fabric configuration by switches.\n\n            Values written to objects in this table are not\n            retained over agent reboots.')
...
if mibBuilder.loadTexts:
    t11FcsFabricDiscoveryTimeOut.setDescription('The minimum interval of time for which the discovered\n            Fabric information is cached by a Fabric Configuration\n            Server.')
t11FcsDiscoveryStateTable = MibTable((1, 3, 6, 1, 2, 1, 162, 1, 1, 2))
if mibBuilder.loadTexts:
    t11FcsDiscoveryStateTable.setDescription('This table contains the status of discovery of\n            locally known Fabrics.')
...
if mibBuilder.loadTexts:
    t11FcsMgmtAddrListEntry.setDescription('Information about one management address in a\n            management address list, which is known to a\n            switch (identified by fcmInstanceIndex and\n            fcmSwitchIndex).')
t11FcsMgmtAddrListIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 162, 1, 2, 2, 1, 1), T11FcListIndex())
if mibBuilder.loadTexts:
    t11FcsMgmtAddrListIndex.setDescription('The index value of the management address list.')
...
if mibBuilder.loadTexts:
    t11FcsPortName.setDescription('The Port_Name (WWN) of the port for which this row\n            contains information.')
t11FcsPortType = MibTableColumn((1, 3, 6, 1, 2, 1, 162, 1, 2, 4, 1, 2), FcPortType()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcsPortType.setDescription('The Port Type of this port.')
t11FcsPortTxType = MibTableColumn((1, 3, 6, 1, 2, 1, 162, 1, 2, 4, 1, 3), T11FcPortTxType()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcsPortTxType.setDescription('The Port TX Type of this port.')
...
if mibBuilder.loadTexts:
    t11FcsPortSpeedCapab.setDescription('The port speed capabilities of this port.  The two octets\n            of the value are formatted as described in FC-GS-5.')
...
if mibBuilder.loadTexts:
    t11FcsPortOperSpeed.setDescription('The operating speed of this port.  The two octets\n            of the value are formatted as described in FC-GS-5.')
...
if mibBuilder.loadTexts:
    t11FcsPortZoningEnfStatus.setDescription('The zoning enforcement status of this port.  The 12\n            octets of the value are formatted as described in FC-GS-5.')
t11FcsAttachPortNameListTable = MibTable((1, 3, 6, 1, 2, 1, 162, 1, 2, 5))
if mibBuilder.loadTexts:
    t11FcsAttachPortNameListTable.setDescription('This table contains all the lists of attach port\n            names.')
...
if mibBuilder.loadTexts:
    t11FcsAttachPortNameListEntry.setDescription('Information about the name of a particular attached port,\n            which is known to a switch (identified by fcmInstanceIndex\n            and fcmSwitchIndex).')
t11FcsAttachPortNameListIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 162, 1, 2, 5, 1, 1), T11FcListIndex())
if mibBuilder.loadTexts:
    t11FcsAttachPortNameListIndex.setDescription('The index value of the attach port name list.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformIndex.setDescription('An integer value to distinguish one platform from\n            other platforms in the same Fabric.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformType.setDescription('The type(s) of this platform, encoded in 4 bytes as\n            specified in FC-GS-5.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformNodeNameListIndex.setDescription('The list of nodes for this platform.  This object points\n            to an entry in the t11FcsNodeNameListTable.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformMgmtAddrListIndex.setDescription('The list of management addresses for this platform.  This\n            object points to an entry in the t11FcsMgmtAddrListTable.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformVendorId.setDescription('The identifier of the vendor of this platform, in the\n            format specified in FC-GS-5.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformProductId.setDescription("The vendor's product and/or model identifier for this\n            platform, in the format specified in FC-GS-5.")
...
if mibBuilder.loadTexts:
    t11FcsPlatformProductRevLevel.setDescription('The product revision level for this platform, in the\n            format specified in FC-GS-5.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformLabel.setDescription('An administratively assigned symbolic name for the\n            platform, in the format specified in FC-GS-5.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformLocation.setDescription("The physical location of the platform, in the format\n            specified in FC-GS-5 (e.g., 'telephone closet, 3rd floor').")
...
if mibBuilder.loadTexts:
    t11FcsPlatformClusterMgmtAddr.setDescription('A list of management addresses for the cluster identified\n            in the corresponding instance of t11FcsPlatformClusterId.')
...
if mibBuilder.loadTexts:
    t11FcsPlatformFC4Types.setDescription('The FC-4 types supported by this platform, formatted as\n            a bit mask as specified in FC-GS-5.  If this object\n            contains the zero-length string, the types are unknown.')
t11FcsNodeNameListTable = MibTable((1, 3, 6, 1, 2, 1, 162, 1, 2, 7))
if mibBuilder.loadTexts:
    t11FcsNodeNameListTable.setDescription('This table contains all the lists of nodes.')
...
if mibBuilder.loadTexts:
    t11FcsNodeNameListEntry.setDescription('Information about a node, which is known to a\n\n\n\n            switch (identified by fcmInstanceIndex and\n            fcmSwitchIndex).')
t11FcsNodeNameListIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 162, 1, 2, 7, 1, 1), T11FcListIndex())
if mibBuilder.loadTexts:
    t11FcsNodeNameListIndex.setDescription('The index value of the node name list.')
...
if mibBuilder.loadTexts:
    t11FcsNodeName.setDescription('The name of this node.')
t11FcsStatsTable = MibTable((1, 3, 6, 1, 2, 1, 162, 1, 3, 1))
if mibBuilder.loadTexts:
    t11FcsStatsTable.setDescription('This table contains all the statistics related\n            to the Fabric Configuration Server.')
...
if mibBuilder.loadTexts:
    t11FcsMIBCompliance.setDescription('The compliance statement for entities that\n            implement the Fabric Configuration Server.')
...
if mibBuilder.loadTexts:
    t11FcsDiscoveryControlGroup.setDescription('A collection of objects for requesting a Fabric\n            Configuration Server to discover the configuration\n            of one or more Fabrics.')
...
if mibBuilder.loadTexts:
    t11FcsDiscoveryStatusGroup.setDescription('A collection of objects with which to monitor the\n            status of discovery (of Fabric configurations) by\n            Fabric Configuration Servers.')
...
if mibBuilder.loadTexts:
    t11FcsDiscoveredConfigGroup.setDescription('A collection of objects to contain the Fabric configuration\n            information discovered by Fabric Configuration Servers.')
...
if mibBuilder.loadTexts:
    t11FcsStatisticsGroup.setDescription('A collection of objects for Fabric Configuration Server\n            statistics information.')
...
if mibBuilder.loadTexts:
    t11FcsNotificationInfoGroup.setDescription('A collection of notification control and notification\n            information objects for monitoring Fabric\n            Configuration Servers.')
...
if mibBuilder.loadTexts:
    t11FcsNotificationGroup.setDescription('A collection of notifications for monitoring Fabric\n            Configuration Servers.')
