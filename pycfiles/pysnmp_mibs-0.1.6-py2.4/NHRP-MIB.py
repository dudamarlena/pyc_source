...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/NHRP-MIB.py
# Compiled at: 2016-02-13 18:22:48
...
if mibBuilder.loadTexts:
    nhrpCacheNegotiatedMtu.setDescription('The maximum transmission unit (MTU) that was negotiated\n           or registered for this entity. In other words, this is the\n           actual MTU being used.')
...
if mibBuilder.loadTexts:
    nhrpClientInitialRequestTimeout.setDescription('The number of seconds that the client will wait before\n           timing out an NHRP initial request.  This object only has\n           meaning for the initial timeout period.')
...
if mibBuilder.loadTexts:
    nhrpClientRegistrationRequestRetries.setDescription("The number of times the client will retry the\n           registration request before failure. A value of\n           0 means don't retry. A value of 65535 means\n           retry forever.")
...
if mibBuilder.loadTexts:
    nhrpClientResolutionRequestRetries.setDescription("The number of times the client will retry the resolution\n           request before failure. A value of 0 means don't retry.\n           A value of 65535 means retry forever.")
...
if mibBuilder.loadTexts:
    nhrpClientPurgeRequestRetries.setDescription("The number of times the client will retry a purge request\n           before failure. A value of 0 means don't retry. A value of\n           65535 means retry forever.")
...
if mibBuilder.loadTexts:
    nhrpClientNhsEntry.setDescription('An NHS that may be used by an NHC.')
...
if mibBuilder.loadTexts:
    nhrpServerNhcEntry.setDescription('An NHC that may be used by an NHS.')
...
if mibBuilder.loadTexts:
    nhrpServerNhcIndex.setDescription('An identifier for an NHC available to an NHS.')
...
if mibBuilder.loadTexts:
    nhrpModuleCompliance.setDescription('The compliance statement for the NHRP MIB.')
...
if mibBuilder.loadTexts:
    nhrpGeneralGroup.setDescription('Objects that apply to both NHRP clients and NHRP\n           servers.')
...
if mibBuilder.loadTexts:
    nhrpClientGroup.setDescription('Objects that apply only to NHRP clients.')
...
if mibBuilder.loadTexts:
    nhrpServerGroup.setDescription('Objects that apply only to NHRP servers.')
