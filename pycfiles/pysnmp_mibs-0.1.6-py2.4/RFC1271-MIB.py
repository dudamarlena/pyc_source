...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/RFC1271-MIB.py
...
etherStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 1, 1, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                              'etherStatsIndex'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    etherStatsPkts.setDescription('The total number of packets (including error packets)\n                  received.')
...
historyControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 2, 1, 1)).setIndexNames((0,
                                                                                  'RFC1271-MIB',
                                                                                  'historyControlIndex'))
if mibBuilder.loadTexts:
    historyControlEntry.setDescription('A list of parameters that set up a periodic\n                  sampling of statistics.')
...
etherHistoryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 2, 2, 1)).setIndexNames((0,
                                                                                'RFC1271-MIB',
                                                                                'etherHistoryIndex'), (0,
                                                                                                       'RFC1271-MIB',
                                                                                                       'etherHistorySampleIndex'))
if mibBuilder.loadTexts:
    etherHistoryEntry.setDescription('An historical sample of Ethernet statistics on a\n                  particular Ethernet interface.  This sample is\n                  associated with the historyControlEntry which set\n                  up the parameters for a regular collection of these\n                  samples.')
...
if mibBuilder.loadTexts:
    etherHistoryPkts.setDescription('The number of packets (including error packets)\n                  received during this sampling interval.')
...
alarmEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 3, 1, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                         'alarmIndex'))
if mibBuilder.loadTexts:
...
alarmStartupAlarm = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 3, 1, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('risingAlarm',
                                                                                                                                                                                        1), ('fallingAlarm',
                                                                                                                                                                                             2), ('risingOrFallingAlarm',
...
if mibBuilder.loadTexts:
    alarmOwner.setDescription('The entity that configured this entry and is\n                  therefore using the resources assigned to it.')
...
hostControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 4, 1, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                               'hostControlIndex'))
if mibBuilder.loadTexts:
    hostControlEntry.setDescription('A list of parameters that set up the discovery of\n                  hosts on a particular interface and the collection\n                  of statistics about these hosts.')
...
if mibBuilder.loadTexts:
    hostControlOwner.setDescription('The entity that configured this entry and is\n                  therefore using the resources assigned to it.')
...
hostEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 4, 2, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                        'hostIndex'), (0,
                                                                                       'RFC1271-MIB',
                                                                                       'hostAddress'))
if mibBuilder.loadTexts:
    hostEntry.setDescription('A collection of statistics for a particular host\n                  that has been discovered on an interface of this\n                  device.')
...
hostTimeEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 4, 3, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                            'hostTimeIndex'), (0,
                                                                                               'RFC1271-MIB',
                                                                                               'hostTimeCreationOrder'))
if mibBuilder.loadTexts:
    hostTimeEntry.setDescription('A collection of statistics for a particular host\n                  that has been discovered on an interface of this\n                  device.  This collection includes the relative\n                  ordering of the creation time of this object.')
...
if mibBuilder.loadTexts:
    hostTimeOutErrors.setDescription('The number of error packets transmitted by this\n                  address since this host was added to the\n                  hostTimeTable.')
...
hostTopNControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 5, 1, 1)).setIndexNames((0,
                                                                                   'RFC1271-MIB',
                                                                                   'hostTopNControlIndex'))
if mibBuilder.loadTexts:
    hostTopNControlEntry.setDescription('A set of parameters that control the creation of a\n                  report of the top N hosts according to several\n                  metrics.')
...
if mibBuilder.loadTexts:
    hostTopNHostIndex.setDescription('The host table for which a top N report will be\n                  prepared on behalf of this entry.  The host table\n                  identified by a particular value of this index is\n                  associated with the same host table as identified\n                  by the same value of hostIndex.\n\n                  This object may not be modified if the associated\n                  hostTopNStatus object is equal to valid(1).')
hostTopNRateBase = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 5, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(('hostTopNInPkts',
                                                                                                                                                                                                   1), ('hostTopNOutPkts',
                                                                                                                                                                                                        2), ('hostTopNInOctets',
                                                                                                                                                                                                             3), ('hostTopNOutOctets',
                                                                                                                                                                                                                  4), ('hostTopNOutErrors',
                                                                                                                                                                                                                       5), ('hostTopNOutBroadcastPkts',
                                                                                                                                                                                                                            6), ('hostTopNOutMulticastPkts',
...
if mibBuilder.loadTexts:
    hostTopNOwner.setDescription('The entity that configured this entry and is\n                  therefore using the resources assigned to it.')
...
hostTopNEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 5, 2, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                            'hostTopNReport'), (0,
                                                                                                'RFC1271-MIB',
                                                                                                'hostTopNIndex'))
if mibBuilder.loadTexts:
    hostTopNEntry.setDescription('A set of statistics for a host that is part of a\n                  top N report.')
...
matrixControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 6, 1, 1)).setIndexNames((0,
                                                                                 'RFC1271-MIB',
                                                                                 'matrixControlIndex'))
if mibBuilder.loadTexts:
    matrixControlEntry.setDescription('Information about a traffic matrix on a\n                  particular interface.')
...
if mibBuilder.loadTexts:
    matrixControlOwner.setDescription('The entity that configured this entry and is\n                  therefore using the resources assigned to it.')
...
matrixSDEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 6, 2, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                            'matrixSDIndex'), (0,
                                                                                               'RFC1271-MIB',
                                                                                               'matrixSDSourceAddress'), (0,
                                                                                                                          'RFC1271-MIB',
                                                                                                                          'matrixSDDestAddress'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    matrixSDErrors.setDescription('The number of error packets transmitted from\n                  the source address to the destination address.')
matrixDSTable = MibTable((1, 3, 6, 1, 2, 1, 16, 6, 3))
if mibBuilder.loadTexts:
    matrixDSTable.setDescription('A list of traffic matrix entries indexed by\n                  destination and source MAC address.')
matrixDSEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 6, 3, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                            'matrixDSIndex'), (0,
                                                                                               'RFC1271-MIB',
                                                                                               'matrixDSDestAddress'), (0,
                                                                                                                        'RFC1271-MIB',
...
if mibBuilder.loadTexts:
    matrixDSErrors.setDescription('The number of error packets transmitted from\n                  the source address to the destination address.')
filterTable = MibTable((1, 3, 6, 1, 2, 1, 16, 7, 1))
if mibBuilder.loadTexts:
    filterTable.setDescription('A list of packet filter entries.')
filterEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 7, 1, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                          'filterIndex'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    filterOwner.setDescription('The entity that configured this entry and is\n                  therefore using the resources assigned to it.')
...
channelEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 7, 2, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                           'channelIndex'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    channelIndex.setDescription('An index that uniquely identifies an entry\n                  in the channel table.  Each such\n                  entry defines one channel, a logical data\n                  and event stream.')
...
channelAcceptType = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 7, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('acceptMatched',
                                                                                                                                                                                     1), ('acceptFailed',
                                                                                                                                                                                          2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
...
channelDataControl = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 7, 2, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('on',
                                                                                                                                                                                      1), ('off',
                                                                                                                                                                                           2))).clone('off')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    channelDataControl.setDescription('This object controls the flow of data through this\n                  channel.  If this object is on(1), data, status and\n                  events flow through this channel.  If this object is\n                  off(2), data, status and events will not flow through\n                  this channel.')
...
channelEventStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 7, 2, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('eventReady',
                                                                                                                                                                                         1), ('eventFired',
                                                                                                                                                                                              2), ('eventAlwaysReady',
                                                                                                                                                                                                   3))).clone('eventReady')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
...
bufferControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 8, 1, 1)).setIndexNames((0,
                                                                                 'RFC1271-MIB',
                                                                                 'bufferControlIndex'))
if mibBuilder.loadTexts:
    bufferControlEntry.setDescription('A set of parameters that control the collection of\n                  a stream of packets that have matched filters.')
...
bufferControlFullStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 8, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('spaceAvailable',
                                                                                                                                                                                           1), ('full',
...
bufferControlFullAction = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 8, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('lockWhenFull',
                                                                                                                                                                                           1), ('wrapWhenFull',
                                                                                                                                                                                                2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
...
captureBufferEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 8, 2, 1)).setIndexNames((0,
                                                                                 'RFC1271-MIB',
                                                                                 'captureBufferControlIndex'), (0,
                                                                                                                'RFC1271-MIB',
                                                                                                                'captureBufferIndex'))
if mibBuilder.loadTexts:
    captureBufferEntry.setDescription('A packet captured off of an attached network.')
...
if mibBuilder.loadTexts:
    captureBufferPacketStatus.setDescription('A value which indicates the error status of this\n                  packet.\n\n                  The value of this object is defined in the same way as\n                  filterPacketStatus.  The value is a sum.  This sum\n                  initially takes the value zero.  Then, for each\n                  error, E, that has been discovered in this packet,\n                  2 raised to a value representing E is added to the sum.\n\n                  The errors defined for a packet captured off of an\n                  Ethernet interface are as follows:\n\n                      bit #    Error\n                          0    Packet is longer than 1518 octets\n                          1    Packet is shorter than 64 octets\n                          2    Packet experienced a CRC or Alignment\n                               error\n                          3    First packet in this capture buffer after\n                               it was detected that some packets were\n                               not processed correctly.\n\n                  For example, an Ethernet fragment would have a\n                  value of 6 (2^1 + 2^2).\n\n                  As this MIB is expanded to new media types, this object\n                  will have other media-specific errors defined.')
eventTable = MibTable((1, 3, 6, 1, 2, 1, 16, 9, 1))
if mibBuilder.loadTexts:
    eventTable.setDescription('A list of events to be generated.')
eventEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 9, 1, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                         'eventIndex'))
if mibBuilder.loadTexts:
    eventEntry.setDescription('A set of parameters that describe an event to be\n                  generated when certain conditions are met.')
...
eventType = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 9, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('none',
                                                                                                                                                                                   1), ('log',
                                                                                                                                                                                        2), ('snmp-trap',
                                                                                                                                                                                             3), ('log-and-trap',
...
logEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 9, 2, 1)).setIndexNames((0, 'RFC1271-MIB',
                                                                       'logEventIndex'), (0,
                                                                                          'RFC1271-MIB',
                                                                                          'logIndex'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    logTime.setDescription('The value of sysUpTime when this log entry was\n                  created.')
