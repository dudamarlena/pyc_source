...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/Modem-MIB.py
# Compiled at: 2016-02-13 18:20:28
...
if mibBuilder.loadTexts:
    mdmMIB.setLastUpdated('9406120000Z')
if mibBuilder.loadTexts:
    mdmMIB.setOrganization('IETF Modem Management Working Group')
if mibBuilder.loadTexts:
    mdmMIB.setContactInfo('        Steven Waldbusser\n             Postal: Carnegie Mellon University\n                     5000 Forbes Ave\n                     Pittsburgh, PA, 15213\n                     US\n\n                Tel: +1 412 268 6628\n                Fax: +1 412 268 4987\n             E-mail: waldbusser@cmu.edu')
if mibBuilder.loadTexts:
    mdmMIB.setDescription('The MIB module for management of dial-up modems.')
...
if mibBuilder.loadTexts:
    mdmIDGroup.setDescription('A collection of objects that identify the manufacturer and\n            model information for a modem.')
...
if mibBuilder.loadTexts:
    mdmLineInterfaceGroup.setDescription("A collection of objects that describe the configuration and\n            state of the modem's line interface.")
...
if mibBuilder.loadTexts:
    mdmDTEInterfaceGroup.setDescription("A collection of objects that describe the configuration and\n            state of the modem's DTE interface.")
...
if mibBuilder.loadTexts:
    mdmSignalConvertorGroup.setDescription('A collection of objects that describe the configuration and\n            state of error control on a modem.')
...
if mibBuilder.loadTexts:
    mdmLineEntry.setDescription('Entries in this table are created only by the agent. One\n            entry exists for each modem managed by the agent.')
...
if mibBuilder.loadTexts:
    mdmDTEInterfaceEntry.setDescription('Entries in this table are created only by the agent. One\n            entry exists for each modem managed by the agent.')
...
if mibBuilder.loadTexts:
    mdmCCStoredDialStringEntry.setDescription('A stored dial string.')
...
if mibBuilder.loadTexts:
    mdmCCStoredDialStringIndex.setDescription('The unique index of a particular dial string.')
...
if mibBuilder.loadTexts:
    mdmCCStoredDialString.setDescription('A dial string stored in the modem.')
mdmECTable = MibTable((1, 3, 6, 1, 2, 1, 38, 1, 1, 9))
if mibBuilder.loadTexts:
    mdmECTable.setDescription('The modem error correcting table augments the modem ID\n            table.')
...
if mibBuilder.loadTexts:
    mdmCompliance.setDescription('The compliance statement for SNMPv2 entities which\n            implement the modem MIB.')
