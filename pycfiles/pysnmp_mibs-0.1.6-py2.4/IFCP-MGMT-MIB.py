...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IFCP-MGMT-MIB.py
# Compiled at: 2016-02-13 18:16:39
...
if mibBuilder.loadTexts:
    ifcpLclGtwyInstTable.setDescription('Information about all local iFCP Gateway instances that can\n    be monitored and controlled.  This table contains an entry\n    for each local iFCP Gateway instance that is being managed.')
ifcpLclGtwyInstEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1)).setIndexNames((0,
                                                                                           'IFCP-MGMT-MIB',
                                                                                           'ifcpLclGtwyInstIndex'))
if mibBuilder.loadTexts:
    ifcpLclGtwyInstEntry.setDescription('An entry in the local iFCP Gateway Instance table.\n    Parameters and settings for the gateway are found here.')
...
if mibBuilder.loadTexts:
    ifcpLclGtwyInstIndex.setDescription('An arbitrary integer value to uniquely identify this iFCP\n    Gateway from other local Gateway instances.')
ifcpLclGtwyInstPhyIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1, 2), PhysicalIndexOrZero()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstPhyIndex.setDescription('An index indicating the location of this local gateway within\n    a larger entity, if one exists.  If supported, this is the\n    entPhysicalIndex from the Entity MIB (Version 3), for this\n    iFCP Gateway.  If not supported, or if not related to a\n    physical entity, then the value of this object is 0.')
ifcpLclGtwyInstVersionMin = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1,
                                            3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstVersionMin.setDescription('The minimum iFCP protocol version supported by the local iFCP\n    gateway instance.')
ifcpLclGtwyInstVersionMax = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1,
                                            4), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstVersionMax.setDescription('The maximum iFCP protocol version supported by the local iFCP\n    gateway instance.')
ifcpLclGtwyInstAddrTransMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1,
                                               1, 5), IfcpAddressMode().clone('addressTranslation')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstAddrTransMode.setDescription('The local iFCP gateway operating mode.  Changing this value\n    may cause existing sessions to be disrupted.')
ifcpLclGtwyInstFcBrdcstSupport = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1,
                                                 1, 6), TruthValue().clone('false')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstFcBrdcstSupport.setDescription('Whether the local iFCP gateway supports FC Broadcast.\n    Changing this value may cause existing sessions to be\n    disrupted.')
ifcpLclGtwyInstDefaultIpTOV = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1,
                                              7), IfcpIpTOVorZero().clone(6)).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstDefaultIpTOV.setDescription('The default IP_TOV used for iFCP sessions at this gateway.\n    This is the default maximum propagation delay that will be\n    used for an iFCP session.  The value can be changed on a\n    per-session basis.  The valid range is 0 - 3600 seconds.\n    A value of 0 implies that fibre channel frame lifetime limits\n    will not be enforced.')
ifcpLclGtwyInstDefaultLTInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1,
                                                   1, 1, 8), IfcpLTIorZero().clone(10)).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ifcpLclGtwyInstDefaultLTInterval.setDescription('The default Liveness Test Interval (LTI), in seconds, used\n    for iFCP sessions at this gateway.  This is the default\n    value for an iFCP session and can be changed on a\n    per-session basis.  The valid range is 0 - 65535 seconds.\n    A value of 0 implies no Liveness Test Interval will be\n    performed on a session.')
...
if mibBuilder.loadTexts:
    ifcpSessionStatsEntry.setDescription('Provides iFCP-specific statistics per session.')
ifcpSessionState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 2, 1, 1), IfcpSessionStates()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionState.setDescription('The current session operating state.')
...
if mibBuilder.loadTexts:
    ifcpSessionLcStatsEntry.setDescription('Provides iFCP-specific statistics per session.')
ifcpSessionLcTxOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3, 1, 1), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcTxOctets.setDescription('The total number of octets transmitted by the iFCP gateway\n    for this session.')
ifcpSessionLcRxOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3, 1, 2), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcRxOctets.setDescription('The total number of octets received by the iFCP gateway for\n    this session.')
ifcpSessionLcTxFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3, 1, 3), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcTxFrames.setDescription('The total number of iFCP frames transmitted by the gateway\n    for this session.')
ifcpSessionLcRxFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3, 1, 4), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcRxFrames.setDescription('The total number of iFCP frames received by the gateway\n    for this session.')
ifcpSessionLcStaleFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3, 1, 5), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcStaleFrames.setDescription('The total number of received iFCP frames that were stale and\n    discarded by the gateway for this session.')
ifcpSessionLcHeaderCRCErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3,
                                               1, 6), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcHeaderCRCErrors.setDescription('The total number of CRC errors that occurred in the frame\n    header, detected by the gateway for this session.  Usually,\n    a single Header CRC error is sufficient to terminate an\n    iFCP session.')
ifcpSessionLcFcPayloadCRCErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2,
                                                  3, 1, 7), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcFcPayloadCRCErrors.setDescription('The total number of CRC errors that occurred in the Fibre\n    Channel frame payload, detected by the gateway for this\n    session.')
ifcpSessionLcOtherErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 3, 1, 8), ZeroBasedCounter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ifcpSessionLcOtherErrors.setDescription('The total number of errors, other than errors explicitly\n    measured, detected by the gateway for this session.')
...
if mibBuilder.loadTexts:
    ifcpGatewayCompliance.setDescription('Implementation requirements for iFCP MIB compliance.')
...
if mibBuilder.loadTexts:
    ifcpLclGatewayGroup.setDescription('iFCP local device info group.  This group provides\n    information about each gateway.')
...
if mibBuilder.loadTexts:
    ifcpLclGatewaySessionGroup.setDescription('iFCP Session group.  This group provides information\n    about each iFCP session currently active between iFCP\n    gateways.')
