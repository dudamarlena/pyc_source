...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SCSI-MIB.py
# Compiled at: 2016-02-13 18:27:43
...
if mibBuilder.loadTexts:
    scsiTransportOther.setDescription('This identity identifies a transport that has no identity; it\n     might happen because the transport is unknown or might not\n     have been defined when this MIB module was created.')
scsiTransportSPI = ObjectIdentity((1, 3, 6, 1, 2, 1, 139, 1, 1, 2))
if mibBuilder.loadTexts:
    scsiTransportSPI.setDescription('This identity identifies a parallel SCSI transport.')
scsiTransportFCP = ObjectIdentity((1, 3, 6, 1, 2, 1, 139, 1, 1, 3))
if mibBuilder.loadTexts:
    scsiTransportFCP.setDescription('This identity identifies a Fibre Channel Protocol for SCSI,\n     Second Version.')
scsiTransportSRP = ObjectIdentity((1, 3, 6, 1, 2, 1, 139, 1, 1, 4))
if mibBuilder.loadTexts:
    scsiTransportSRP.setDescription('This identity identifies a protocol for transporting SCSI over\n     Remote Direct Memory Access (RDMA) interfaces, e.g., InfiniBand\n     (tm).')
scsiTransportISCSI = ObjectIdentity((1, 3, 6, 1, 2, 1, 139, 1, 1, 5))
if mibBuilder.loadTexts:
    scsiTransportISCSI.setDescription('This identity identifies an iSCSI transport.')
scsiTransportSBP = ObjectIdentity((1, 3, 6, 1, 2, 1, 139, 1, 1, 6))
if mibBuilder.loadTexts:
    scsiTransportSBP.setDescription('This identity identifies the Serial Bus Protocol 3.')
scsiTransportSAS = ObjectIdentity((1, 3, 6, 1, 2, 1, 139, 1, 1, 7))
if mibBuilder.loadTexts:
    scsiTransportSAS.setDescription('This identity identifies the Serial Attach SCSI Protocol.')
scsiInstanceTable = MibTable((1, 3, 6, 1, 2, 1, 139, 2, 1, 1))
if mibBuilder.loadTexts:
    scsiInstanceTable.setDescription('A list of SCSI instances present on the system.\n     The SCSI instance is the top-level entity, to which everything\n     else belongs.  An SNMP agent could represent more than one\n     instance if it represents either a stack of devices, or virtual\n     partitions of a larger device, or a host running multiple SCSI\n     implementations from different vendors.')
scsiInstanceEntry = MibTableRow((1, 3, 6, 1, 2, 1, 139, 2, 1, 1, 1)).setIndexNames((0,
                                                                                    'SCSI-MIB',
                                                                                    'scsiInstIndex'))
if mibBuilder.loadTexts:
    scsiInstanceEntry.setDescription('An entry (row) containing management information applicable to\n     a particular SCSI instance.')
scsiInstIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 1, 1, 1), ScsiIndexValue())
if mibBuilder.loadTexts:
    scsiInstIndex.setDescription('This object represents an arbitrary integer used to uniquely\n     identify a particular SCSI instance.')
...
if mibBuilder.loadTexts:
    scsiDeviceAlias.setDescription('This object contains an administrative name for this device.\n     If no name is assigned, the value of this object is the\n     zero-length string.\n     The StorageType of this object is specified by the instance\n     of scsiInstStorageType that is INDEXed by the same value of\n     scsiInstIndex.')
scsiDeviceRole = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 2, 1, 3), Bits().clone(namedValues=NamedValues(('target',
                                                                                                              0), ('initiator',
                                                                                                                   1)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    scsiDeviceRole.setDescription('This object determines whether this device is acting as a\n     SCSI initiator device, or as a SCSI target device, or as both.')
scsiDevicePortNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 2, 1, 4), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    scsiDevicePortNumber.setDescription('This object represents the number of ports contained in this\n     device.')
scsiPortTable = MibTable((1, 3, 6, 1, 2, 1, 139, 2, 1, 3))
if mibBuilder.loadTexts:
    scsiPortTable.setDescription('A list of SCSI ports for each SCSI device in each instance.')
scsiPortEntry = MibTableRow((1, 3, 6, 1, 2, 1, 139, 2, 1, 3, 1)).setIndexNames((0,
                                                                                'SCSI-MIB',
                                                                                'scsiInstIndex'), (0,
                                                                                                   'SCSI-MIB',
                                                                                                   'scsiDeviceIndex'), (0,
...
if mibBuilder.loadTexts:
    scsiDeviceGroup.setDescription('A collection of objects providing information about SCSI\n     instances, devices, and ports.')
...
if mibBuilder.loadTexts:
    scsiInitiatorDeviceGroup.setDescription('This group is relevant for s SCSI initiator device and port.')
...
if mibBuilder.loadTexts:
    scsiDiscoveryGroup.setDescription('This group is relevant for the discovered SCSI target devices\n     by a SCSI initiator port.')
...
if mibBuilder.loadTexts:
    scsiTargetDeviceGroup.setDescription('This group is relevant for a SCSI target device and port.')
...
if mibBuilder.loadTexts:
    scsiLunMapGroup.setDescription('This group is a collection of attributes regarding the mapping\n     between Logical Unit Number, logical unit, and target device.')
...
if mibBuilder.loadTexts:
    scsiTargetDevStatsGroup.setDescription('This group is a collection of statistics for all\n     implementations of the SCSI MIB module that contain SCSI target\n     devices.')
...
if mibBuilder.loadTexts:
    scsiTargetDevHSStatsGroup.setDescription('This group is a collection of high speed statistics for all\n     implementations of the SCSI MIB module that contain SCSI target\n     devices.')
...
if mibBuilder.loadTexts:
    scsiInitiatorDevStatsGroup.setDescription('This group is a collection of statistics for all\n     implementations of the SCSI MIB module that contain SCSI\n     initiator devices.')
scsiInitiatorDevHSStatsGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 139, 3, 2, 11)).setObjects(*(('SCSI-MIB', 'scsiIntrPortHSOutCommands'), ))
if mibBuilder.loadTexts:
    scsiInitiatorDevHSStatsGroup.setDescription('This group is a collection of high speed statistics for all\n\n\n\n     implementations of the SCSI MIB module that contain SCSI\n     initiator devices.')
...
if mibBuilder.loadTexts:
    scsiTgtDevLuNotificationsGroup.setDescription('A collection of notifications regarding status change of SCSI\n     target devices and logical units.')
