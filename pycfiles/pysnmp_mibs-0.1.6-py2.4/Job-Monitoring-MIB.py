...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/Job-Monitoring-MIB.py
# Compiled at: 2016-02-13 18:19:35
...
class JmJobSourcePlatformTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('sptUNIX', 3), ('sptOS2',
                                                                             4), ('sptPCDOS',
                                                                                  5), ('sptNT',
                                                                                       6), ('sptMVS',
                                                                                            7), ('sptVM',
...
class JmFinishingTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('none', 3), ('staple',
                                                                          4), ('punch',
                                                                               5), ('cover',
                                                                                    6), ('bind',
                                                                                         7))
...
class JmPrintQualityTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('draft', 3), ('normal',
                                                                           4), ('high',
                                                                                5))
...
class JmMediumTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('stationery', 3), ('transparency',
                                                                                4), ('envelope',
                                                                                     5), ('envelopePlain',
                                                                                          6), ('envelopeWindow',
                                                                                               7), ('continuousLong',
...
class JmJobCollationTypeTC(Integer32, TextualConvention):
    __module__ = __name__
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('uncollatedSheets', 3), ('collatedDocuments',
...
class JmJobStateTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('unknown', 2), ('pending', 3), ('pendingHeld', 4), ('processing',
                                                                                   5), ('processingStopped',
                                                                                        6), ('canceled',
                                                                                             7), ('aborted',
                                                                                                  8), ('completed',
...
class JmAttributeTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('jobStateReasons2', 3), ('jobStateReasons3',
                                                                      4), ('jobStateReasons4',
                                                                           5), ('processingMessage',
                                                                                6), ('processingMessageNaturalLangTag',
                                                                                     7), ('jobCodedCharSet',
                                                                                          8), ('jobNaturalLanguageTag',
                                                                                               9), ('jobURI',
                                                                                                    20), ('jobAccountName',
                                                                                                          21), ('serverAssignedJobName',
                                                                                                                22), ('jobName',
                                                                                                                      23), ('jobServiceTypes',
                                                                                                                            24), ('jobSourceChannelIndex',
                                                                                                                                  25), ('jobSourcePlatformType',
                                                                                                                                        26), ('submittingServerName',
                                                                                                                                              27), ('submittingApplicationName',
                                                                                                                                                    28), ('jobOriginatingHost',
                                                                                                                                                          29), ('deviceNameRequested',
                                                                                                                                                                30), ('queueNameRequested',
                                                                                                                                                                      31), ('physicalDevice',
                                                                                                                                                                            32), ('numberOfDocuments',
                                                                                                                                                                                  33), ('fileName',
                                                                                                                                                                                        34), ('documentName',
                                                                                                                                                                                              35), ('jobComment',
                                                                                                                                                                                                    36), ('documentFormatIndex',
                                                                                                                                                                                                          37), ('documentFormat',
                                                                                                                                                                                                                38), ('jobPriority',
                                                                                                                                                                                                                      50), ('jobProcessAfterDateAndTime',
                                                                                                                                                                                                                            51), ('jobHold',
                                                                                                                                                                                                                                  52), ('jobHoldUntil',
                                                                                                                                                                                                                                        53), ('outputBin',
                                                                                                                                                                                                                                              54), ('sides',
                                                                                                                                                                                                                                                    55), ('finishing',
                                                                                                                                                                                                                                                          56), ('printQualityRequested',
                                                                                                                                                                                                                                                                70), ('printQualityUsed',
                                                                                                                                                                                                                                                                      71), ('printerResolutionRequested',
                                                                                                                                                                                                                                                                            72), ('printerResolutionUsed',
                                                                                                                                                                                                                                                                                  73), ('tonerEcomonyRequested',
                                                                                                                                                                                                                                                                                        74), ('tonerEcomonyUsed',
                                                                                                                                                                                                                                                                                              75), ('tonerDensityRequested',
                                                                                                                                                                                                                                                                                                    76), ('tonerDensityUsed',
                                                                                                                                                                                                                                                                                                          77), ('jobCopiesRequested',
                                                                                                                                                                                                                                                                                                                90), ('jobCopiesCompleted',
                                                                                                                                                                                                                                                                                                                      91), ('documentCopiesRequested',
                                                                                                                                                                                                                                                                                                                            92), ('documentCopiesCompleted',
                                                                                                                                                                                                                                                                                                                                  93), ('jobKOctetsTransferred',
                                                                                                                                                                                                                                                                                                                                        94), ('sheetCompletedCopyNumber',
                                                                                                                                                                                                                                                                                                                                              95), ('sheetCompletedDocumentNumber',
                                                                                                                                                                                                                                                                                                                                                    96), ('jobCollationType',
                                                                                                                                                                                                                                                                                                                                                          97), ('impressionsSpooled',
                                                                                                                                                                                                                                                                                                                                                                110), ('impressionsSentToDevice',
                                                                                                                                                                                                                                                                                                                                                                       111), ('impressionsInterpreted',
                                                                                                                                                                                                                                                                                                                                                                              112), ('impressionsCompletedCurrentCopy',
                                                                                                                                                                                                                                                                                                                                                                                     113), ('fullColorImpressionsCompleted',
                                                                                                                                                                                                                                                                                                                                                                                            114), ('highlightColorImpressionsCompleted',
                                                                                                                                                                                                                                                                                                                                                                                                   115), ('pagesRequested',
                                                                                                                                                                                                                                                                                                                                                                                                          130), ('pagesCompleted',
                                                                                                                                                                                                                                                                                                                                                                                                                 131), ('pagesCompletedCurrentCopy',
                                                                                                                                                                                                                                                                                                                                                                                                                        132), ('sheetsRequested',
                                                                                                                                                                                                                                                                                                                                                                                                                               150), ('sheetsCompleted',
                                                                                                                                                                                                                                                                                                                                                                                                                                      151), ('sheetsCompletedCurrentCopy',
                                                                                                                                                                                                                                                                                                                                                                                                                                             152), ('mediumRequested',
                                                                                                                                                                                                                                                                                                                                                                                                                                                    170), ('mediumConsumed',
                                                                                                                                                                                                                                                                                                                                                                                                                                                           171), ('colorantRequested',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  172), ('colorantConsumed',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         173), ('mediumTypeConsumed',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                174), ('mediumSizeConsumed',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       175), ('jobSubmissionToServerTime',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              190), ('jobSubmissionTime',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     191), ('jobStartedBeingHeldTime',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            192), ('jobStartedProcessingTime',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   193), ('jobCompletionTime',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          194), ('jobProcessingCPUTime',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 195))
...
if mibBuilder.loadTexts:
    jmMIBCompliance.setDescription('The compliance statement for agents that implement the\n        job monitoring MIB.')
...
if mibBuilder.loadTexts:
    jmGeneralGroup.setDescription('The general group.')
...
if mibBuilder.loadTexts:
    jmJobIDGroup.setDescription('The job ID group.')
...
if mibBuilder.loadTexts:
    jmJobGroup.setDescription('The job group.')
...
if mibBuilder.loadTexts:
    jmAttributeGroup.setDescription('The attribute group.')
