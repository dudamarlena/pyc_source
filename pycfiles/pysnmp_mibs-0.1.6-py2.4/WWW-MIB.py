...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/WWW-MIB.py
# Compiled at: 2016-02-13 18:33:08
...
class WwwOperStatus(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('down', 1), ('running', 2), ('halted', 3), ('congested',
                                                                           4), ('restarting',
                                                                                5))
...
if mibBuilder.loadTexts:
    wwwRequestOutEntry.setDescription('Request statistics for an individual service.')
wwwRequestOutIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 65, 1, 2, 3, 1, 1), WwwRequestType())
if mibBuilder.loadTexts:
    wwwRequestOutIndex.setDescription('The particular request type the statistics apply to.')
wwwRequestOutRequests = MibTableColumn((1, 3, 6, 1, 2, 1, 65, 1, 2, 3, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    wwwRequestOutRequests.setDescription('The number of requests of this type generated by this\n            WWW service.')
wwwRequestOutBytes = MibTableColumn((1, 3, 6, 1, 2, 1, 65, 1, 2, 3, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    wwwRequestOutBytes.setDescription('The number of content bytes per requests type generated\n            by this WWW service.')
wwwRequestOutLastTime = MibTableColumn((1, 3, 6, 1, 2, 1, 65, 1, 2, 3, 1, 4), DateAndTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    wwwRequestOutLastTime.setDescription("The date and time when the first byte of the last request\n            of this type was send by this WWW service. The value SHALL\n            be '0000000000000000'H if no request of this type has been\n            send yet.")
wwwResponseInTable = MibTable((1, 3, 6, 1, 2, 1, 65, 1, 2, 4))
if mibBuilder.loadTexts:
    wwwResponseInTable.setDescription('The table providing detailed statistics for responses\n            received by WWW services on this system.')
...
if mibBuilder.loadTexts:
    wwwDocAccessTopNEntry.setDescription('An entry in the top N table sorted by document accesses.')
...
if mibBuilder.loadTexts:
    wwwDocBytesTopNEntry.setDescription('An entry in the top N table sorted by network traffic.')
...
if mibBuilder.loadTexts:
    wwwFullCompliance.setDescription('The compliance statement for SNMP agents which implement\n            the full WWW-MIB.')
...
if mibBuilder.loadTexts:
    wwwServiceGroup.setDescription('A collection of objects providing information about\n            the WWW services known by the SNMP agent.')
...
if mibBuilder.loadTexts:
    wwwSummaryGroup.setDescription('A collection of objects providing summary statistics\n            about requests and responses generated and received\n            by a WWW service.')
...
if mibBuilder.loadTexts:
    wwwRequestInGroup.setDescription('A collection of objects providing detailed statistics\n            about requests received by a WWW service.')
...
if mibBuilder.loadTexts:
    wwwRequestOutGroup.setDescription('A collection of objects providing detailed statistics\n            about requests generated by a WWW service.')
...
if mibBuilder.loadTexts:
    wwwResponseInGroup.setDescription('A collection of objects providing detailed statistics\n            about responses received by a WWW service.')
...
if mibBuilder.loadTexts:
    wwwResponseOutGroup.setDescription('A collection of objects providing detailed statistics\n            about responses generated by a WWW service.')
...
if mibBuilder.loadTexts:
    wwwDocumentGroup.setDescription('A collection of objects providing information about\n            accesses to documents.')
