...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/TOKEN-RING-RMON-MIB.py
...
if mibBuilder.loadTexts:
    tokenRingMLStatsTable.setDescription('A list of Mac-Layer Token Ring statistics\n\n\n\n\n\n                      entries.')
tokenRingMLStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 1, 2, 1)).setIndexNames((0,
                                                                                    'TOKEN-RING-RMON-MIB',
                                                                                    'tokenRingMLStatsIndex'))
if mibBuilder.loadTexts:
    tokenRingMLStatsEntry.setDescription('A collection of Mac-Layer statistics kept for a\n                      particular Token Ring interface.')
...
if mibBuilder.loadTexts:
    tokenRingPStatsIndex.setDescription('The value of this object uniquely identifies this\n                      tokenRingPStats entry.')
tokenRingPStatsDataSource = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 2), ObjectIdentifier()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    tokenRingPStatsDataSource.setDescription('This object identifies the source of the data\n                      that this tokenRingPStats entry is configured to\n                      analyze.  This source can be any tokenRing\n                      interface on this device.  In order to identify a\n                      particular interface, this object shall identify\n                      the instance of the ifIndex object, defined in\n                      MIB-II [3], for the desired interface.  For\n                      example, if an entry were to receive data from\n                      interface #1, this object would be set to\n                      ifIndex.1.\n\n                      The statistics in this group reflect all non-MAC\n                      packets on the local network segment attached to\n                      the identified interface.\n\n                      This object may not be modified if the associated\n                      tokenRingPStatsStatus object is equal to\n                      valid(1).')
tokenRingPStatsDropEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDropEvents.setDescription('The total number of events in which packets were\n                      dropped by the probe due to lack of resources.\n                      Note that this number is not necessarily the\n                      number of packets dropped; it is just the number\n                      of times this condition has been detected.  This\n                      value is the same as the corresponding\n                      tokenRingMLStatsDropEvents')
tokenRingPStatsDataOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataOctets.setDescription('The total number of octets of data in good frames\n                      received on the network (excluding framing bits\n                      but including FCS octets) in non-MAC packets.')
tokenRingPStatsDataPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts.setDescription('The total number of non-MAC packets in good\n                      frames.  received.')
tokenRingPStatsDataBroadcastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataBroadcastPkts.setDescription('The total number of good non-MAC frames received\n                      that were directed to an LLC broadcast address\n                      (0xFFFFFFFFFFFF or 0xC000FFFFFFFF).')
tokenRingPStatsDataMulticastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataMulticastPkts.setDescription('The total number of good non-MAC frames received\n                      that were directed to a local or global multicast\n                      or functional address.  Note that this number does\n                      not include packets directed to the broadcast\n                      address.')
tokenRingPStatsDataPkts18to63Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1,
                                                      8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts18to63Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 18 and 63 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts64to127Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3,
                                                       1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts64to127Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 64 and 127 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts128to255Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3,
                                                        1, 10), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts128to255Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 128 and 255 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts256to511Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3,
                                                        1, 11), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts256to511Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 256 and 511 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts512to1023Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3,
                                                         1, 12), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts512to1023Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 512 and 1023 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts1024to2047Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1,
                                                          3, 1, 13), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts1024to2047Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 1024 and 2047 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts2048to4095Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1,
                                                          3, 1, 14), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts2048to4095Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 2048 and 4095 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts4096to8191Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1,
                                                          3, 1, 15), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts4096to8191Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 4096 and 8191 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPkts8192to18000Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1,
                                                           3, 1, 16), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPkts8192to18000Octets.setDescription('The total number of good non-MAC frames received\n                      that were between 8192 and 18000 octets in length\n                      inclusive, excluding framing bits but including\n                      FCS octets.')
tokenRingPStatsDataPktsGreaterThan18000Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16,
                                                                1, 3, 1, 17), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPStatsDataPktsGreaterThan18000Octets.setDescription('The total number of good non-MAC frames received\n                      that were greater than 18000 octets in length,\n                      excluding framing bits but including FCS octets.')
tokenRingPStatsOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 18), OwnerString()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    tokenRingPStatsOwner.setDescription('The entity that configured this entry and is\n                      therefore using the resources assigned to it.')
tokenRingPStatsStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 3, 1, 19), EntryStatus()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    tokenRingPStatsStatus.setDescription('The status of this tokenRingPStats entry.')
tokenRingMLHistoryTable = MibTable((1, 3, 6, 1, 2, 1, 16, 2, 3))
if mibBuilder.loadTexts:
    tokenRingMLHistoryTable.setDescription('A list of Mac-Layer Token Ring statistics\n\n\n\n\n\n                      entries.')
tokenRingMLHistoryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 2, 3, 1)).setIndexNames((0,
                                                                                      'TOKEN-RING-RMON-MIB',
                                                                                      'tokenRingMLHistoryIndex'), (0,
                                                                                                                   'TOKEN-RING-RMON-MIB',
                                                                                                                   'tokenRingMLHistorySampleIndex'))
if mibBuilder.loadTexts:
    tokenRingMLHistoryEntry.setDescription('A collection of Mac-Layer statistics kept for a\n                      particular Token Ring interface.')
...
if mibBuilder.loadTexts:
    tokenRingPHistoryIndex.setDescription('The history of which this entry is a part.  The\n                      history identified by a particular value of this\n                      index is the same history as identified by the\n                      same value of historyControlIndex.')
tokenRingPHistorySampleIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1, 2), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistorySampleIndex.setDescription('An index that uniquely identifies the particular\n                      sample this entry represents among all samples\n                      associated with the same historyControlEntry.\n                      This index starts at 1 and increases by one as\n                      each new sample is taken.')
tokenRingPHistoryIntervalStart = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1, 3), TimeTicks()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryIntervalStart.setDescription('The value of sysUpTime at the start of the\n                      interval over which this sample was measured.  If\n                      the probe keeps track of the time of day, it\n                      should start the first sample of the history at a\n                      time such that when the next hour of the day\n                      begins, a sample is started at that instant.  Note\n                      that following this rule may require the probe to\n                      delay collecting the first sample of the history,\n                      as each sample must be of the same interval.  Also\n                      note that the sample which is currently being\n                      collected is not accessible in this table until\n                      the end of its interval.')
tokenRingPHistoryDropEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDropEvents.setDescription('The total number of events in which packets were\n                      dropped by the probe due to lack of resources\n                      during this sampling interval.  Note that this\n                      number is not necessarily the number of packets\n                      dropped, it is just the number of times this\n                      condition has been detected.')
tokenRingPHistoryDataOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataOctets.setDescription('The total number of octets of data in good frames\n                      received on the network (excluding framing bits\n                      but including FCS octets) in non-MAC packets\n                      during this sampling interval.')
tokenRingPHistoryDataPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval.')
tokenRingPHistoryDataBroadcastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1,
                                                     7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataBroadcastPkts.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were directed\n                      to an LLC broadcast address (0xFFFFFFFFFFFF or\n                      0xC000FFFFFFFF).')
tokenRingPHistoryDataMulticastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4, 1,
                                                     8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataMulticastPkts.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were directed\n                      to a local or global multicast or functional\n                      address.  Note that this number does not include\n                      packets directed to the broadcast address.')
tokenRingPHistoryDataPkts18to63Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4,
                                                        1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts18to63Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between 18\n                      and 63 octets in length inclusive, excluding\n                      framing bits but including FCS octets.')
tokenRingPHistoryDataPkts64to127Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2, 4,
                                                         1, 10), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts64to127Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between 64\n                      and 127 octets in length inclusive, excluding\n                      framing bits but including FCS octets.')
tokenRingPHistoryDataPkts128to255Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2,
                                                          4, 1, 11), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts128to255Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n                      128 and 255 octets in length inclusive, excluding\n                      framing bits but including FCS octets.')
tokenRingPHistoryDataPkts256to511Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2,
                                                          4, 1, 12), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts256to511Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n\n\n\n\n\n                      256 and 511 octets in length inclusive, excluding\n                      framing bits but including FCS octets.')
tokenRingPHistoryDataPkts512to1023Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2,
                                                           4, 1, 13), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts512to1023Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n                      512 and 1023 octets in length inclusive, excluding\n                      framing bits but including FCS octets.')
tokenRingPHistoryDataPkts1024to2047Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2,
                                                            4, 1, 14), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts1024to2047Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n                      1024 and 2047 octets in length inclusive,\n                      excluding framing bits but including FCS octets.')
tokenRingPHistoryDataPkts2048to4095Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2,
                                                            4, 1, 15), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts2048to4095Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n                      2048 and 4095 octets in length inclusive,\n                      excluding framing bits but including FCS octets.')
tokenRingPHistoryDataPkts4096to8191Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 2,
                                                            4, 1, 16), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts4096to8191Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n                      4096 and 8191 octets in length inclusive,\n                      excluding framing bits but including FCS octets.')
tokenRingPHistoryDataPkts8192to18000Octets = MibTableColumn((1, 3, 6, 1, 2, 1, 16,
                                                             2, 4, 1, 17), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPkts8192to18000Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were between\n                      8192 and 18000 octets in length inclusive,\n                      excluding framing bits but including FCS octets.')
tokenRingPHistoryDataPktsGreaterThan18000Octets = MibTableColumn((1, 3, 6, 1, 2, 1,
                                                                  16, 2, 4, 1, 18), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    tokenRingPHistoryDataPktsGreaterThan18000Octets.setDescription('The total number of good non-MAC frames received\n                      during this sampling interval that were greater\n                      than 18000 octets in length, excluding framing\n                      bits but including FCS octets.')
ringStationControlTable = MibTable((1, 3, 6, 1, 2, 1, 16, 10, 1))
if mibBuilder.loadTexts:
    ringStationControlTable.setDescription('A list of ringStation table control entries.')
ringStationControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 10, 1, 1)).setIndexNames((0,
                                                                                       'TOKEN-RING-RMON-MIB',
                                                                                       'ringStationControlIfIndex'))
if mibBuilder.loadTexts:
    ringStationControlEntry.setDescription('A list of parameters that set up the discovery of\n                      stations on a particular interface and the\n                      collection of statistics about these stations.')
...
if mibBuilder.loadTexts:
    ringStationConfigLocation.setDescription('The assigned physical location of this station.')
...
if mibBuilder.loadTexts:
    ringStationConfigMicrocode.setDescription('The microcode EC level of this station.')
