...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/Finisher-MIB.py
...
class FinAttributeTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('deviceName', 3), ('deviceVendorName',
                                                                4), ('deviceModel',
                                                                     5), ('deviceVersion',
                                                                          6), ('deviceSerialNumber',
                                                                               7), ('maximumSheets',
                                                                                    8), ('finProcessOffsetUnits',
                                                                                         9), ('finReferenceEdge',
                                                                                              10), ('finAxisOffset',
                                                                                                    11), ('finJogEdge',
                                                                                                          12), ('finHeadLocation',
                                                                                                                13), ('finOperationRestrictions',
                                                                                                                      14), ('finNumberOfPositions',
                                                                                                                            15), ('namedConfiguration',
                                                                                                                                  16), ('finMediaTypeRestriction',
                                                                                                                                        17), ('finPrinterInputTraySupported',
                                                                                                                                              18), ('finPreviousFinishingOperation',
                                                                                                                                                    19), ('finNextFinishingOperation',
                                                                                                                                                          20), ('stitchingType',
                                                                                                                                                                30), ('stitchingDirection',
                                                                                                                                                                      31), ('foldingType',
                                                                                                                                                                            40), ('bindingType',
                                                                                                                                                                                  50), ('punchHoleType',
                                                                                                                                                                                        80), ('punchHoleSizeLongDim',
                                                                                                                                                                                              81), ('punchHoleSizeShortDim',
                                                                                                                                                                                                    82), ('punchPattern',
                                                                                                                                                                                                          83), ('slittingType',
                                                                                                                                                                                                                100), ('wrappingType',
                                                                                                                                                                                                                       130), ('stackOutputType',
...
class FinEdgeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('topEdge', 3), ('bottomEdge', 4), ('leftEdge', 5), ('rightEdge',
                                                                                   6))
...
class FinStitchingTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('stapleTopLeft', 4), ('stapleBottomLeft',
                                                                                   5), ('stapleTopRight',
                                                                                        6), ('stapleBottomRight',
                                                                                             7), ('saddleStitch',
                                                                                                  8), ('edgeStitch',
...
class StitchingAngleTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('unknown', 2), ('horizontal', 3), ('vertical', 4), ('slanted',
                                                                                   5))
...
class FinFoldingTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('zFold', 3), ('halfFold',
                                                                           4), ('letterFold',
                                                                                5))
...
class FinBindingTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('tape', 4), ('plastic',
                                                                          5), ('velo',
                                                                               6), ('perfect',
                                                                                    7), ('spiral',
                                                                                         8), ('adhesive',
...
class FinPunchHoleTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('round', 3), ('oblong',
                                                                           4), ('square',
                                                                                5), ('rectangular',
                                                                                     6), ('star',
                                                                                          7))
...
class FinPunchPatternTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('twoHoleUSTop', 4), ('threeHoleUS',
                                                                                  5), ('twoHoleDIN',
                                                                                       6), ('fourHoleDIN',
                                                                                            7), ('twentyTwoHoleUS',
                                                                                                 8), ('nineteenHoleUS',
...
class FinSlittingTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('slitAndSeparate', 4), ('slitAndMerge',
                                                                                     5))
...
class FinWrappingTypeTC(Integer32, TextualConvention):
    __module__ = __name__
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 4, 5))
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('shrinkWrap', 4), ('paperWrap',
                                                                                5))
...
class FinStackOutputTypeTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('straight', 4), ('offset',
                                                                              5), ('crissCross',
                                                                                   6))
...
if mibBuilder.loadTexts:
    finSupplyDescription.setDescription('The description of this supply/receptacle in text useful\n       for operators and management applications and in the\n       localization specified by prtGeneralCurrentLocalization.')
finSupplyUnit = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 31, 1, 1, 6), PrtMarkerSuppliesSupplyUnitTC()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    finSupplyUnit.setDescription('Unit of measure of this finisher supply container or\n       receptacle.')
...
if mibBuilder.loadTexts:
    finSupplyMediaInputDeviceIndex.setDescription('The value of finDeviceIndex corresponding to the finishing\n       device subunit with which this finisher media supply is\n       associated.')
...
if mibBuilder.loadTexts:
    finSupplyMediaInputMediaName.setDescription('The name of the current media contained in this input\n       device. Examples are Engineering Manual Cover, Section A Tab\n       Divider or any ISO standard names.')
...
if mibBuilder.loadTexts:
    finSupplyMediaInputName.setDescription('The name assigned to this input subunit.')
...
if mibBuilder.loadTexts:
    finMIBCompliance.setDescription('The compliance statement for agents that implement the\n        finisher MIB.')
...
if mibBuilder.loadTexts:
    finDeviceGroup.setDescription('The finisher device group.')
...
if mibBuilder.loadTexts:
    finSupplyGroup.setDescription('The finisher supply group.')
...
if mibBuilder.loadTexts:
    finSupplyMediaInputGroup.setDescription('The finisher supply, media input group.')
...
if mibBuilder.loadTexts:
    finDeviceAttributeGroup.setDescription('The finisher device attribute group.')
