...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/NETWORK-SERVICES-MIB.py
...
application = ModuleIdentity((1, 3, 6, 1, 2, 1, 27)).setRevisions(('2000-03-03 00:00',
                                                                   '1999-05-12 00:00',
                                                                   '1997-08-17 00:00',
                                                                   '1993-11-28 00:00'))
if mibBuilder.loadTexts:
    application.setLastUpdated('200003030000Z')
if mibBuilder.loadTexts:
    application.setOrganization('IETF Mail and Directory Management Working Group')
if mibBuilder.loadTexts:
    application.setContactInfo('        Ned Freed\n\n          Postal: Innosoft International, Inc.\n                  1050 Lakes Drive\n                  West Covina, CA 91790\n                  US\n\n             Tel: +1 626 919 3600\n             Fax: +1 626 919 3614\n\n          E-Mail: ned.freed@innosoft.com')
if mibBuilder.loadTexts:
    application.setDescription('The MIB module describing network service applications')
...
if mibBuilder.loadTexts:
    applTable.setDescription('The table holding objects which apply to all different\n            kinds of applications providing network services.\n            Each network service application capable of being\n            monitored should have a single entry in this table.')
applEntry = MibTableRow((1, 3, 6, 1, 2, 1, 27, 1, 1)).setIndexNames((0, 'NETWORK-SERVICES-MIB',
                                                                     'applIndex'))
if mibBuilder.loadTexts:
    applEntry.setDescription('An entry associated with a single network service\n          application.')
applIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 2147483647)))
if mibBuilder.loadTexts:
    applIndex.setDescription('An index to uniquely identify the network service\n          application. This attribute is the index used for\n          lexicographic ordering of the table.')
applName = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 2), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    applName.setDescription('The name the network service application chooses to be\n          known by.')
applDirectoryName = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 3), DistinguishedName()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    applDirectoryName.setDescription('The Distinguished Name of the directory entry where\n          static information about this application is stored.\n          An empty string indicates that no information about\n          the application is available in the directory.')
applVersion = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 4), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    applVersion.setDescription('The version of network service application software.\n          This field is usually defined by the vendor of the\n          network service application software.')
applUptime = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 5), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    applUptime.setDescription('The value of sysUpTime at the time the network service\n          application was last initialized.  If the application was\n          last initialized prior to the last initialization of the\n          network management subsystem, then this object contains\n          a zero value.')
applOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(('up',
                                                                                                                                                                                           1), ('down',
                                                                                                                                                                                                2), ('halted',
                                                                                                                                                                                                     3), ('congested',
                                                                                                                                                                                                          4), ('restarting',
...
if mibBuilder.loadTexts:
    assocCompliance.setDescription('The compliance statement for RFC 1565 implementations\n          which support the Network Services Monitoring MIB\n          for basic monitoring of network service applications\n          and their associations.')
applRFC2248Compliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 27, 3, 2, 3)).setObjects(*(('NETWORK-SERVICES-MIB', 'applRFC2248Group'), ))
if mibBuilder.loadTexts:
    applRFC2248Compliance.setDescription('The compliance statement for RFC 2248 implementations\n          which support the Network Services Monitoring MIB\n          for basic monitoring of network service applications.')
...
if mibBuilder.loadTexts:
    assocRFC2788Compliance.setDescription('The compliance statement for RFC 2788 implementations\n          which support the Network Services Monitoring MIB for\n          basic monitoring of network service applications and\n          their associations.')
...
if mibBuilder.loadTexts:
    assocRFC2248Group.setDescription("A collection of objects providing basic monitoring of\n          network service applications' associations.  This group\n          was originally defined by RFC 2248.")
...
if mibBuilder.loadTexts:
    assocRFC2788Group.setDescription("A collection of objects providing basic monitoring of\n          network service applications' associations.  This is\n          the appropriate group for RFC 2788.")
