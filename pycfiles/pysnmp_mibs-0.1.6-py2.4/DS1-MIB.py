...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DS1-MIB.py
# Compiled at: 2016-02-13 18:10:55
...
if mibBuilder.loadTexts:
    dsx1CircuitIdentifier.setDescription("This variable contains the transmission vendor's\n            circuit identifier, for the purpose of\n            facilitating troubleshooting.")
...
if mibBuilder.loadTexts:
    dsx1LineStatusChangeTrapEnable.setDescription('Indicates whether dsx1LineStatusChange traps\n            should be generated for this interface.')
...
if mibBuilder.loadTexts:
    dsx1LineMode.setDescription('This setting puts the T1 framer into either\n            long-haul (CSU) mode or short-haul (DSU) mode.')
...
if mibBuilder.loadTexts:
    dsx1LineBuildOut.setDescription('Attenuation setting for T1 framer in long haul\n            (CSU) mode.  The optional values are -7.5dB,\n            -15dB, -22.5dB, and 0dB.')
...
if mibBuilder.loadTexts:
    dsx1IntervalEntry.setDescription('An entry in the DS1 Interval table.')
dsx1IntervalIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 18, 8, 1, 1), InterfaceIndex()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dsx1IntervalIndex.setDescription('The index value that uniquely identifies the DS1\n            interface to which this entry is applicable.  The\n            interface identified by a particular value of this\n            index is the same interface as identified by the\n            same value as a dsx1LineIndex object instance.')
...
if mibBuilder.loadTexts:
    dsx1FarEndIntervalEntry.setDescription('An entry in the DS1 Far End Interval table.')
dsx1FarEndIntervalIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 18, 11, 1, 1), InterfaceIndex()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dsx1FarEndIntervalIndex.setDescription('The index value that uniquely identifies the DS1\n            interface to which this entry is applicable.  The\n            interface identified by a particular value of this\n            index is identical to the interface identified by\n            the same value of dsx1LineIndex.')
...
if mibBuilder.loadTexts:
    dsx1FracNumber.setDescription('The channel number for this entry.')
...
if mibBuilder.loadTexts:
    ds1Compliance.setDescription('The compliance statement for T1 and E1\n            interfaces.')
...
if mibBuilder.loadTexts:
    ds1MibT1PriCompliance.setDescription('Compliance statement for using this MIB for ISDN\n            Primary Rate interfaces on T1 lines.')
...
if mibBuilder.loadTexts:
    ds1MibE1PriCompliance.setDescription('Compliance statement for using this MIB for ISDN\n            Primary Rate interfaces on E1 lines.')
ds1Ds2Compliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 18, 14, 2, 4)).setObjects(*(('DS1-MIB', 'ds1DS2Group'),))
if mibBuilder.loadTexts:
    ds1Ds2Compliance.setDescription('Compliance statement for using this MIB for DS2\n            interfaces.')
...
if mibBuilder.loadTexts:
    ds1NCompliance.setDescription('The compliance statement for T1 and E1\n            interfaces.')
...
if mibBuilder.loadTexts:
    ds1MibT1PriNCompliance.setDescription('Compliance statement for using this MIB for ISDN\n            Primary Rate interfaces on T1 lines.')
...
if mibBuilder.loadTexts:
    ds1MibE1PriNCompliance.setDescription('Compliance statement for using this MIB for ISDN\n            Primary Rate interfaces on E1 lines.')
...
if mibBuilder.loadTexts:
    ds1J1Compliance.setDescription('The compliance statement for T1, J1, and E1\n            interfaces.')
...
if mibBuilder.loadTexts:
    ds1NMibT1PriNCompliance.setDescription('Compliance statement for using this MIB for ISDN\n            Primary Rate interfaces on T1 lines.')
...
if mibBuilder.loadTexts:
    ds1NMibE1PriNCompliance.setDescription('Compliance statement for using this MIB for ISDN\n            Primary Rate interfaces on E1 lines.')
...
if mibBuilder.loadTexts:
    ds1NearEndConfigGroup.setDescription('A collection of objects providing configuration\n            information applicable to all DS1 interfaces.')
...
if mibBuilder.loadTexts:
    ds1NearEndStatisticsGroup.setDescription('A collection of objects providing statistics\n            information applicable to all DS1 interfaces.')
...
if mibBuilder.loadTexts:
    ds1FarEndGroup.setDescription('A collection of objects providing remote\n            configuration and statistics information.')
...
if mibBuilder.loadTexts:
    ds1DeprecatedGroup.setDescription('A collection of obsolete objects that may be\n            implemented for backwards compatibility.')
...
if mibBuilder.loadTexts:
    ds1NearEndOptionalConfigGroup.setDescription('A collection of objects that may be implemented\n            on DS1 and DS2 interfaces.')
...
if mibBuilder.loadTexts:
    ds1DS2Group.setDescription('A collection of objects providing information\n            about DS2 (6,312 kbps) and E2 (8,448 kbps)\n            systems.')
...
if mibBuilder.loadTexts:
    ds1NearEndConfigurationGroup.setDescription('A collection of objects providing configuration\n            information applicable to all DS1 interfaces.')
...
if mibBuilder.loadTexts:
    ds1NearEndCfgGroup.setDescription('A collection of objects providing configuration\n            information applicable to all DS1 interfaces.')
...
if mibBuilder.loadTexts:
    ds1NearEndStatGroup.setDescription('A collection of objects providing statistics\n            information applicable to all DS1 interfaces.')
...
if mibBuilder.loadTexts:
    ds1FarEndNGroup.setDescription('A collection of objects providing remote\n            configuration and statistics information.')
