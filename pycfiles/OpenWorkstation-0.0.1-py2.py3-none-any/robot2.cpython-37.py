...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/site-packages/workstation/robot2/robot2.py
# Compiled at: 2019-09-25 06:02:07
# Size of source mod 2**32: 17479 bytes
import copy, os
...
class InstrumentMotor(object):
    ...
    def move(self, value, mode='absolute'):
        ...
        (self.robot2._driver.move_plunger)(mode=mode, **kwargs)
...
class Robot2(object):
    ...
    def home(self, *args, **kwargs):
        ...
        *args :
        ...
        Examples
        --------
        >>> from workstation import robot2
        >>> robot2.connect()
        >>> robot2.home()
        """
    ...
    def prepare_for_run(self):
        ...
        if not self._driver.is_connected():
            ...
            self._commands or self.add_warning('No commands added to robot2')
