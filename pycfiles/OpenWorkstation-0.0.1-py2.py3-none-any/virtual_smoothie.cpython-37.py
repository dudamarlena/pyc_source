...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/l0/ss9rqt5j7xbg0x2bpvmjx_k40000gp/T/pip-install-n2xwwglt/workstation/workstation/drivers/smoothie_drivers/v2_0_0/virtual_smoothie.py
# Compiled at: 2019-09-24 08:15:55
# Size of source mod 2**32: 12616 bytes
import io, os, re
from workstation.drivers.smoothie_drivers import VirtualSmoothie
from workstation.util import log
...
class VirtualSmoothie_2_0_0(VirtualSmoothie):
    ...
    def __init__(self, options):
        ...
        self.speeds = {'x':4000,  'y':4000, 
         'z':3000, 
         'a':500, 
         'b':500}
        self.endstop = {'X_min':0, 
         'Y_min':0, 
         'Z_min':0, 
         'A_min':0, 
         'B_min':0}
        self.steps_per_mm = {'X':self.config.get('alpha_steps_per_mm', 80), 
        ...
        self.accelerations = {'X':self.config.get('alpha_steps_per_mm', 2000), 
    ...
    def parse_command(self, gcode):
        ...
        parse_arguments = re.compile('(([XYZABCSPabF])(\\-?[0-9\\.]*))')
        parse_command = re.compile('([GM][0-9\\.]*)')
    ...
    def process_get_endstops(self, arguments):
        ...
        res += 'pins- (XL)P1.24:0 (YL)P1.26:0 (ZL)P1.28:0 (AL)P1.25:0 (BL)P1.27:0'
        return res + '\nok\nok'
    ...
    def process_move_command(self, arguments):
        for axis in arguments.keys():
            if axis.lower() in 'xyzab':
                self.absolute or arguments[axis] += self.coordinates['target'][axis.lower()]
    ...
    def process_command(self, command):
        ...
        command_mapping = {'G':self.process_nop, 
         'M':self.process_nop, 
