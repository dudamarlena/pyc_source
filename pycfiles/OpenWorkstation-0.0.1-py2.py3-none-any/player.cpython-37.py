...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/l0/ss9rqt5j7xbg0x2bpvmjx_k40000gp/T/pip-install-n2xwwglt/workstation/workstation/drivers/smoothie_drivers/v2_0_0/player.py
...
class SmoothiePlayer_2_0_0(object):
    ...
    def wait_for_ok_response(self, timeout=20):
        ...
        raise RuntimeError('Did not get an OK from Smoothie within {} seconds'.format(timeout))
