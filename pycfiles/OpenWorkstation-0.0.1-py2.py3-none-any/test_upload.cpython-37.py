...
# [GCC 8.4.0]
# Embedded file name: /private/var/folders/l0/ss9rqt5j7xbg0x2bpvmjx_k40000gp/T/pip-install-n2xwwglt/workstation/workstation/server/tests/test_upload.py
...
class UploadTestCase(unittest.TestCase):
    ...
    def test_get_instrument_placeables(self):
        ...
        self.robot._instruments['A'].positions = {'top':0, 
         'bottom':1, 
         'blow_out':2, 
         'drop_tip':None}
        self.robot._instruments['B'].positions = {'top':None, 
         'bottom':None, 
         'blow_out':None, 
         'drop_tip':None}
