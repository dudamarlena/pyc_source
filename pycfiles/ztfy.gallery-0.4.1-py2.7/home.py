...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/gallery/skin/home.py
# Compiled at: 2013-09-22 11:00:31
...
from interfaces import IHomeBackgroundImage, IHomeBackgroundManager, IHomeBackgroundManagerContentsView, IHomeBackgroundManagerDetailMenuTarget
...
class HomeBackgroundManagerContentsView(OrderedContainerBaseView):
    ...
    implements(IHomeBackgroundManagerContentsView, IHomeBackgroundManagerDetailMenuTarget)
...
class HomeBackgroundManagerPreviewColumn(Column):
    ...
    header = ''
    weight = 5
    cssClasses = {'th': 'preview', 'td': 'preview'}
