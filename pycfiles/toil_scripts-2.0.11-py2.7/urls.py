...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_scripts/lib/urls.py
...
def download_url_job(job, url, name=None, s3_key_path=None, cghub_key_path=None):
    ...
    fpath = download_url(url, work_dir=work_dir, name=name, s3_key_path=s3_key_path, cghub_key_path=cghub_key_path)
...
def _download_with_genetorrent(url, file_path, cghub_key_path):
    ...
    docker_call(tool='quay.io/ucsc_cgl/genetorrent:3.8.7--9911761265b6f08bc3ef09f53af05f56848d805b', work_dir=work_dir, parameters=parameters)
