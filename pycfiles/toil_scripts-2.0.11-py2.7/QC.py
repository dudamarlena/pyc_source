...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_scripts/tools/QC.py
...
def run_fastqc(job, r1_id, r2_id):
    ...
    docker_call(tool='quay.io/ucsc_cgl/fastqc:0.11.5--be13567d00cd4c586edf8ae47d991815c8c72a49', work_dir=work_dir, parameters=parameters)
