...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_scripts/lib/programs.py
...
def mock_mode():
    ...
    """
    if int(os.environ.get('TOIL_SCRIPTS_MOCK_MODE', '0')):
        return True
    return False


def docker_call(tool, parameters=None, work_dir='.', rm=True, env=None, outfile=None, inputs=None, outputs=None, docker_parameters=None, check_output=False, mock=None):
    """
