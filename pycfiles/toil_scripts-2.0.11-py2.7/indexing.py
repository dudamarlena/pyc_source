...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_scripts/tools/indexing.py
...
def run_bwa_index(job, ref_id):
    ...
    docker_call(work_dir=work_dir, parameters=command, tool='quay.io/ucsc_cgl/bwa:0.7.12--256539928ea162949d8a65ca5c79a72ef557ce7c')
    ids = {}
    ...
    return (
     ids['amb'], ids['ann'], ids['bwt'], ids['pac'], ids['sa'])
