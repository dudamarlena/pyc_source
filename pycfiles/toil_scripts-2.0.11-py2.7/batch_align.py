...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_scripts/bwa_alignment/old_alignment_script/batch_align.py
...
import hashlib, os, subprocess, multiprocessing, shutil
...
def build_parser():
    ...
    parser.add_argument('-3', '--s3_dir', default=None, help='S3 Directory, starting with bucket name. e.g.: cgl-driver-projects/ckcc/rna-seq-samples/')
    return parser
...
def batch_start(job, input_args):
    ...
    """
    shared_files = [
     'ref.fa', 'ref.fa.amb', 'ref.fa.ann', 'ref.fa.bwt', 'ref.fa.pac', 'ref.fa.sa', 'ref.fa.fai']
    shared_ids = {}
...
if __name__ == '__main__':
    ...
    inputs = {'config': args.config, 'ref.fa': args.ref, 
       'ref.fa.amb': args.amb, 
       'ref.fa.ann': args.ann, 
       'ref.fa.bwt': args.bwt, 
       'ref.fa.pac': args.pac, 
