...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/aliyun_oss2_storage/backends.py
# Compiled at: 2017-05-16 23:40:26
import os, datetime, six, posixpath
try:
...
class AliyunBaseStorage(BucketOperationMixin, Storage):
    ...
    def _get_config(self, name):
        ...
        if config is not None:
            ...
            raise ImproperlyConfigured("Can't find config for '%s' either in environmentvariable or in setting.py" % name)
        return
