...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/django_reports/reports.py
# Compiled at: 2017-09-02 12:21:46
import json
...
class ReportView(View):
    ...
    def get(self, request):
        if 'report' in request.GET and 'get' in request.GET:
            ...
            return render_to_json_response([ {'name': r.name, 'title': r.title, 'style': r.style, 'description': r.description} for r in Report.objects.all()
                                           ])
