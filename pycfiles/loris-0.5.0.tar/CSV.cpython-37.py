...
# [GCC 8.4.0]
# Embedded file name: /home/gregorlenz/Development/eye-tracking/loris/source/CSV.py
# Compiled at: 2019-05-25 04:48:42
...
def parse_file(file_name):
    with open(file_name) as (csvfile):
        ...
        if event_length == 4:
            ...
            bar.close()
            return {'type':'dvs',  'width':max_x + 1,  'height':max_y + 1,  'events':np.array(events, dtype=[('t', np.uint64), ('x', np.uint16), ('y', np.uint16), ('is_increase', np.bool_)])}
