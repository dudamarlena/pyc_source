...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/simply/frontends/linux.py
# Compiled at: 2016-09-26 09:58:16
import time
from .. import utils
...
class UnixFrontend(object):
    ...
    def create_user(self, user, groups=(), home=None, shell=None):
        ...
        """
        cmd = ('useradd {}{}{}').format(user, (' -d {}').format(home) if home else '', (' -s {}').format(shell) if shell else '')
        self.execute(cmd)
