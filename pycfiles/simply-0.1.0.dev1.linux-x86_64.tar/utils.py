...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/simply/utils.py
# Compiled at: 2016-09-23 05:54:39
from contextlib import contextmanager
import cStringIO, os, random
...
def read_configuration(file, path=None):
    ...
    if ext == '.py':
        conf = ConfAttrDict()
        exec compile(data, file, 'exec') in dict(os.environ), conf
