...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0013_auto__del_unique_page_slug.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique('foundry_page', ['slug'])

    def backwards(self, orm):
        db.create_unique('foundry_page', ['slug'])
