...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0031_auto__add_field_member_country.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_member', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foundry.Country'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_member', 'country_id')
