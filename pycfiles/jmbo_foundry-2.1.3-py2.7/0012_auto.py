...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0012_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_listing_sites', (
         (
        ...
        db.create_unique('foundry_listing_sites', ['listing_id', 'site_id'])
        db.create_table('foundry_navbar_sites', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'navbar', models.ForeignKey(orm['foundry.navbar'], null=False)),
         (
          'site', models.ForeignKey(orm['sites.site'], null=False))))
        db.create_unique('foundry_navbar_sites', ['navbar_id', 'site_id'])
        db.create_table('foundry_menu_sites', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'menu', models.ForeignKey(orm['foundry.menu'], null=False)),
         (
          'site', models.ForeignKey(orm['sites.site'], null=False))))
        db.create_unique('foundry_menu_sites', ['menu_id', 'site_id'])

    def backwards(self, orm):
        db.delete_table('foundry_listing_sites')
        db.delete_table('foundry_navbar_sites')
        db.delete_table('foundry_menu_sites')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.country': {'Meta': {'ordering': "('title',)", 'object_name': 'Country'}, 'id': (
                           ...
                           'slug': (
                                  'django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '32', 'db_index': 'True'}), 
                           'title': (
