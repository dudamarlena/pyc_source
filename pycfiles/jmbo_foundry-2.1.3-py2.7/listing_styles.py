...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/templatetags/listing_styles.py
# Compiled at: 2015-12-02 04:38:17
import inspect
...
class AbstractBaseStyle(object):
    ...
    def get_context_data(self, context, as_tile=False):
        ...
        context['identifier'] = getattr(self.listing, 'id', None) or getattr(self.listing, 'identifier', '')
