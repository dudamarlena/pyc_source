...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0049_auto__add_field_row_class_name__add_field_column_class_name.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_row', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('foundry_column', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_row', 'class_name')
        db.delete_column('foundry_column', 'class_name')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.chatroom': {'Meta': {'ordering': "('-created',)", 'object_name': 'ChatRoom', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'foundry.column': {'Meta': {'object_name': 'Column'}, 'class_name': (
