...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0059_add_field_generalpreferences_partner_site_configuration.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            ...
            connection.close()
            db.add_column('preferences_generalpreferences', 'partner_site_configuration', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('preferences_generalpreferences', 'partner_site_configuration')
