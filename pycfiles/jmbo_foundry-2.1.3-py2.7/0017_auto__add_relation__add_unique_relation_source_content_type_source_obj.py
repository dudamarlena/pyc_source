...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0017_auto__add_relation__add_unique_relation_source_content_type_source_obj.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_relation', (
         (
        ...
        db.send_create_signal('foundry', ['Relation'])
        db.create_unique('foundry_relation', ['source_content_type_id', 'source_object_id', 'target_content_type_id', 'target_object_id', 'name'])
        db.create_index('foundry_row', ['has_left_or_right_column'])

    def backwards(self, orm):
        db.delete_index('foundry_row', ['has_left_or_right_column'])
        db.delete_unique('foundry_relation', ['source_content_type_id', 'source_object_id', 'target_content_type_id', 'target_object_id', 'name'])
        db.delete_table('foundry_relation')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.link': {'Meta': {'object_name': 'Link'}, 'category': (
                                   'django.db.models.fields.related.ForeignKey', [], {'to': "orm['category.Category']", 'null': 'True', 'blank': 'True'}), 
                        'id': (
                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                        'title': (
                        ...
                        'view_name': (
                                    'django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})}, 
       'foundry.listing': {'Meta': {'object_name': 'Listing'}, 'category': (
                                      'django.db.models.fields.related.ForeignKey', [], {'to': "orm['category.Category']", 'null': 'True', 'blank': 'True'}), 
                           'content': (
                           ...
                           'title': (
                                   'django.db.models.fields.CharField', [], {'max_length': '256'})}, 
       'foundry.member': {'Meta': {'object_name': 'Member', '_ormbases': ['auth.User']}, 'crop_from': (
                                      'django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}), 
                          'date_taken': (
                                       'django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}), 
                          'effect': (
                          ...
                          'view_count': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'default': '0'})}, 
       'foundry.menu': {'Meta': {'object_name': 'Menu'}, 'display_title': (
                                        'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                        'id': (
                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                        'sites': (
       ...
       'foundry.menulinkposition': {'Meta': {'ordering': "('position',)", 'object_name': 'MenuLinkPosition'}, 'condition_expression': (
                                    ...
                                    'position': (
                                               'django.db.models.fields.IntegerField', [], {})}, 
       'foundry.navbar': {'Meta': {'object_name': 'Navbar'}, 'id': (
                               'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                          'sites': (
                                  'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'}), 
                          'slug': (
                          ...
                          'title': (
                                  'django.db.models.fields.CharField', [], {'max_length': '255'})}, 
       'foundry.navbarlinkposition': {'Meta': {'ordering': "('position',)", 'object_name': 'NavbarLinkPosition'}, 'condition_expression': (
                                                             'django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}), 
                                      'id': (
                                           'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                      'link': (
       ...
       'foundry.page': {'Meta': {'object_name': 'Page'}, 'id': (
                        ...
                        'title': (
                                'django.db.models.fields.CharField', [], {'max_length': '200'})}, 
       'foundry.relation': {'Meta': {'unique_together': "(('source_content_type', 'source_object_id', 'target_content_type', 'target_object_id', 'name'),)", 'object_name': 'Relation'}, 'id': (
                                 'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                            'name': (
                                   'django.db.models.fields.CharField', [], {'max_length': '32', 'db_index': 'True'}), 
                            'source_content_type': (
                                                  'django.db.models.fields.related.ForeignKey', [], {'related_name': "'relation_source_content_type'", 'to': "orm['contenttypes.ContentType']"}), 
                            'source_object_id': (
                                               'django.db.models.fields.PositiveIntegerField', [], {}), 
                            'target_content_type': (
                                                  'django.db.models.fields.related.ForeignKey', [], {'related_name': "'relation_target_content_type'", 'to': "orm['contenttypes.ContentType']"}), 
                            'target_object_id': (
                                               'django.db.models.fields.PositiveIntegerField', [], {})}, 
