...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0030_auto__chg_field_preferences_raw_fields.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('preferences_registrationpreferences', 'raw_display_fields', self.gf('django.db.models.fields.CharField')(max_length=256))
        db.alter_column('preferences_registrationpreferences', 'raw_required_fields', self.gf('django.db.models.fields.CharField')(max_length=256))
        db.alter_column('preferences_registrationpreferences', 'raw_unique_fields', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):
        db.alter_column('preferences_registrationpreferences', 'raw_display_fields', self.gf('django.db.models.fields.CharField')(max_length=32))
        db.alter_column('preferences_registrationpreferences', 'raw_required_fields', self.gf('django.db.models.fields.CharField')(max_length=32))
        db.alter_column('preferences_registrationpreferences', 'raw_unique_fields', self.gf('django.db.models.fields.CharField')(max_length=32))
