...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0060_auto__add_viewproxy.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_viewproxy', (
         (
          'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
         (
          'view_name', self.gf('django.db.models.fields.CharField')(max_length=256))))
        db.send_create_signal('foundry', ['ViewProxy'])

    def backwards(self, orm):
        db.delete_table('foundry_viewproxy')
