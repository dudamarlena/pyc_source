...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0037_auto__add_field_country_country_code__add_unique_country_slug.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_country', 'country_code', self.gf('django.db.models.fields.CharField')(max_length=2, unique=True, null=True, db_index=True), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.country': {'Meta': {'ordering': "('title',)", 'object_name': 'Country'}, 'country_code': (
                           ...
                           'slug': (
                                  'django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '32'}), 
                           'title': (
