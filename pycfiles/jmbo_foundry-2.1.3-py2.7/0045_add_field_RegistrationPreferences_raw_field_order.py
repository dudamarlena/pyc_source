...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0045_add_field_RegistrationPreferences_raw_field_order.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            ...
            connection.close()
            db.add_column('preferences_registrationpreferences', 'raw_field_order', self.gf('django.db.models.fields.CharField')(default='{}', max_length=1024, blank=True), keep_default=False)
