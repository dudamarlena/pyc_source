...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0004_auto__del_chatroom.py
...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        db.create_table('foundry_chatroom', (
         ...
         (
          'slug', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True, db_index=True))))
