...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0042_auto__add_field_listing_enable_syndication.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_listing', 'enable_syndication', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_listing', 'enable_syndication')
