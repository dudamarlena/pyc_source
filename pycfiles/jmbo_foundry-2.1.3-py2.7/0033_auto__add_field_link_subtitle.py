...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0033_auto__add_field_link_subtitle.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_link', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_link', 'subtitle')
