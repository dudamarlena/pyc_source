...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0034_auto__add_field_member_receive_sms__add_field_member_receive_email.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_member', 'receive_sms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('foundry_member', 'receive_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_member', 'receive_sms')
        db.delete_column('foundry_member', 'receive_email')
