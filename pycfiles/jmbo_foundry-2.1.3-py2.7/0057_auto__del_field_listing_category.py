...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0057_auto__del_field_listing_category.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('foundry_listing', 'category_id')

    def backwards(self, orm):
        db.add_column('foundry_listing', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['category.Category'], null=True, blank=True), keep_default=False)
        if not db.dry_run:
