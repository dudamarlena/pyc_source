...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0043_auto__add_field_exempted_user_agents.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            cursor.execute('select exempted_user_agents from preferences_generalpreferences')
            connection.close()
        except:
            connection.close()
            db.add_column('preferences_generalpreferences', 'exempted_user_agents', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

    def backwards(self, orm):
        db.delete_column('preferences_generalpreferences', 'exempted_user_agents')
