...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0018_auto__add_pageview.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_pageview', (
         (
        ...
        db.send_create_signal('foundry', ['PageView'])

    def backwards(self, orm):
        db.delete_table('foundry_pageview')
