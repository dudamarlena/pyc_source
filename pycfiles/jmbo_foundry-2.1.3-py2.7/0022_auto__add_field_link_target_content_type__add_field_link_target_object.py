...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0022_auto__add_field_link_target_content_type__add_field_link_target_object.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_link', 'target_content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='link_target_content_type', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
        db.add_column('foundry_link', 'target_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_link', 'target_content_type_id')
        db.delete_column('foundry_link', 'target_object_id')
