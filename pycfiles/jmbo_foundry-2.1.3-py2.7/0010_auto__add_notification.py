...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0010_auto__add_notification.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_notification', (
         (
        ...
        db.send_create_signal('foundry', ['Notification'])

    def backwards(self, orm):
        db.delete_table('foundry_notification')
