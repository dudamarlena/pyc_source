...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0019_auto__add_field_navbarlinkposition_class_name__add_field_menulinkposit.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_navbarlinkposition', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('foundry_menulinkposition', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_navbarlinkposition', 'class_name')
        db.delete_column('foundry_menulinkposition', 'class_name')
