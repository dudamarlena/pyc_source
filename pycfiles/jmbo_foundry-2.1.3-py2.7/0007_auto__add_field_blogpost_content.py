...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0007_auto__add_field_blogpost_content.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_blogpost', 'content', self.gf('ckeditor.fields.RichTextField')(default=''), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_blogpost', 'content')
