...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0016_auto__add_field_row_has_left_or_right_column__chg_field_column_designa.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_row', 'has_left_or_right_column', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.alter_column('foundry_column', 'designation', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):
        db.delete_column('foundry_row', 'has_left_or_right_column')
        db.alter_column('foundry_column', 'designation', self.gf('django.db.models.fields.CharField')(max_length=32))
