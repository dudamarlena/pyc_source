...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0050_add_field_member_last_seen.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_member', 'last_seen', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_member', 'last_seen')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'comments.comment': {'Meta': {'ordering': "('submit_date',)", 'object_name': 'Comment', 'db_table': "'django_comments'"}, 'comment': (
                                      'django.db.models.fields.TextField', [], {'max_length': '256'}), 
                            'content_type': (
