...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0002_auto__del_field_listing_display_primary_category__add_field_listing_di.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('foundry_listing', 'display_primary_category')
    ...
    def backwards(self, orm):
        db.add_column('foundry_listing', 'display_primary_category', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
