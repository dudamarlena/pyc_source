...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0021_auto__add_field_navbarlinkposition_name__add_field_menulinkposition_na.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_navbarlinkposition', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
        db.add_column('foundry_menulinkposition', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_navbarlinkposition', 'name')
        db.delete_column('foundry_menulinkposition', 'name')
