...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0054_auto__add_field_row_enable_caching__add_field_row_cache_type__add_fiel.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_row', 'enable_caching', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('foundry_row', 'cache_type', self.gf('django.db.models.fields.CharField')(default='all_users', max_length=32), keep_default=False)
        db.add_column('foundry_row', 'cache_timeout', self.gf('django.db.models.fields.PositiveIntegerField')(default=60), keep_default=False)
        db.add_column('foundry_column', 'enable_caching', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('foundry_column', 'cache_type', self.gf('django.db.models.fields.CharField')(default='all_users', max_length=32), keep_default=False)
        db.add_column('foundry_column', 'cache_timeout', self.gf('django.db.models.fields.PositiveIntegerField')(default=60), keep_default=False)
        db.add_column('foundry_tile', 'enable_caching', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        db.add_column('foundry_tile', 'cache_type', self.gf('django.db.models.fields.CharField')(default='all_users', max_length=32), keep_default=False)
        db.add_column('foundry_tile', 'cache_timeout', self.gf('django.db.models.fields.PositiveIntegerField')(default=60), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'foundry.blogpost': {'Meta': {'ordering': "('-created',)", 'object_name': 'BlogPost', '_ormbases': ['jmbo.ModelBase']}, 'content': (
                                      'ckeditor.fields.RichTextField', [], {}), 
                            'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'foundry.chatroom': {'Meta': {'ordering': "('-created',)", 'object_name': 'ChatRoom', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       ...
       'foundry.link': {'Meta': {'ordering': "('title', 'subtitle')", 'object_name': 'Link'}, 'category': (
                        ...
                        'view_name': (
                                    'django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})}, 
       'foundry.listing': {'Meta': {'ordering': "('title', 'subtitle')", 'object_name': 'Listing'}, 'category': (
                                      'django.db.models.fields.related.ForeignKey', [], {'to': "orm['category.Category']", 'null': 'True', 'blank': 'True'}), 
                           'content': (
                                     'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['jmbo.ModelBase']", 'null': 'True', 'blank': 'True'}), 
                           'content_type': (
                           ...
                           'items_per_page': (
                                            'django.db.models.fields.PositiveIntegerField', [], {'default': '0'}), 
                           'pinned': (
                                    'django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'listing_pinned'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['jmbo.ModelBase']"}), 
                           'sites': (
                                   'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'}), 
                           'slug': (
       ...
       'foundry.menu': {'Meta': {'ordering': "('title', 'subtitle')", 'object_name': 'Menu'}, 'display_title': (
                                        'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                        'id': (
                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                        'sites': (
       ...
       'foundry.menulinkposition': {'Meta': {'ordering': "('position',)", 'object_name': 'MenuLinkPosition'}, 'class_name': (
                                    ...
                                    'position': (
                                               'django.db.models.fields.IntegerField', [], {})}, 
       'foundry.navbar': {'Meta': {'ordering': "('title', 'subtitle')", 'object_name': 'Navbar'}, 'id': (
                               'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                          'sites': (
                                  'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'}), 
                          'slug': (
