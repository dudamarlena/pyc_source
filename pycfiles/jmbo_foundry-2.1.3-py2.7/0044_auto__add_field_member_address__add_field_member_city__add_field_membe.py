...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0044_auto__add_field_member_address__add_field_member_city__add_field_membe.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_member', 'address', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
        db.add_column('foundry_member', 'city', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
        db.add_column('foundry_member', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)
        db.add_column('foundry_member', 'province', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
        db.add_column('foundry_member', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.chatroom': {'Meta': {'ordering': "('-created',)", 'object_name': 'ChatRoom', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'foundry.column': {'Meta': {'object_name': 'Column'}, 'designation': (
       ...
       'foundry.page': {'Meta': {'object_name': 'Page'}, 'id': (
                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                        'is_homepage': (
                                      'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                        'sites': (
       ...
       'foundry.row': {'Meta': {'object_name': 'Row'}, 'block_name': (
                       ...
                       'page': (
                              'django.db.models.fields.related.ForeignKey', [], {'to': "orm['foundry.Page']"})}, 
       'foundry.tile': {'Meta': {'object_name': 'Tile'}, 'class_name': (
                                     'django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}), 
                        'column': (
       ...
       'photologue.photoeffect': {'Meta': {'object_name': 'PhotoEffect'}, 'background_color': (
                                  ...
                                  'reflection_strength': (
                                                        'django.db.models.fields.FloatField', [], {'default': '0.59999999999999998'}), 
                                  'sharpness': (
                                              'django.db.models.fields.FloatField', [], {'default': '1.0'}), 
                                  'transpose_method': (
