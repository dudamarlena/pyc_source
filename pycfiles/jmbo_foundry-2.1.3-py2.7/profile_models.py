...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/foundry/profile_models.py
# Compiled at: 2015-05-22 09:16:41
"""
...
class AbstractSocialProfile(models.Model):
    ...
    facebook_id = models.CharField(verbose_name=_('Facebook ID'), max_length=128, blank=True, null=True)
    twitter_username = models.CharField(verbose_name=_('Twitter username'), max_length=128, blank=True, null=True)
...
class AbstractLocationProfile(models.Model):
    ...
    zipcode = models.CharField(verbose_name=_('Zipcode'), max_length=32, blank=True, null=True)
    province = models.CharField(verbose_name=_('Province'), max_length=256, blank=True, null=True)
...
class AbstractPersonalProfile(models.Model):
    ...
    gender = models.CharField(verbose_name=_('Gender'), max_length=1, blank=True, null=True, choices=(
     (
      'F', _('Female')),
     (
      'M', _('Male'))))
...
class AbstractContactProfile(models.Model):
    ...
    mobile_number = models.CharField(verbose_name=_('Mobile number'), max_length=64, blank=True, null=True)
...
class AbstractSubscriptionProfile(models.Model):
    ...
    receive_sms = models.BooleanField(verbose_name=_('Receive sms'), default=False)
    receive_email = models.BooleanField(verbose_name=_('Receive email'), default=False)
