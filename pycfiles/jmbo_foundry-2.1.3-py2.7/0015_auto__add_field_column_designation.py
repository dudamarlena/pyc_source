...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0015_auto__add_field_column_designation.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_column', 'designation', self.gf('django.db.models.fields.CharField')(default='center', max_length=32), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_column', 'designation')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.column': {'Meta': {'object_name': 'Column'}, 'designation': (
                                        'django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '32'}), 
                          'id': (
                               'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                          'index': (
