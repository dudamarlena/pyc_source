...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0035_auto__add_field_column_title__add_field_listing_display_title_tiles.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('foundry_column', 'title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
        db.add_column('foundry_listing', 'display_title_tiled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_column', 'title')
        db.delete_column('foundry_listing', 'display_title_tiled')
