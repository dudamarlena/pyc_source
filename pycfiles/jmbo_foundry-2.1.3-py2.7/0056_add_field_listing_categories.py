...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0056_add_field_listing_categories.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_listing_categories', (
         (
        ...
        db.create_unique('foundry_listing_categories', ['listing_id', 'category_id'])
        if not db.dry_run:
    ...
    def backwards(self, orm):
        db.delete_table('foundry_listing_categories')
