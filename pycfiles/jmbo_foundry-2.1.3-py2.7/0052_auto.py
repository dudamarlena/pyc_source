...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0052_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('foundry_member', ['last_seen'])

    def backwards(self, orm):
        db.delete_index('foundry_member', ['last_seen'])
