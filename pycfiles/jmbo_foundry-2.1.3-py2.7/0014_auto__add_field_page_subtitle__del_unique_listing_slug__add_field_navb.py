...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0014_auto__add_field_page_subtitle__del_unique_listing_slug__add_field_navb.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique('foundry_menu', ['slug'])
        db.delete_unique('foundry_country', ['slug'])
        db.delete_unique('foundry_navbar', ['slug'])
        db.delete_unique('foundry_listing', ['slug'])
        db.add_column('foundry_page', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
        db.add_column('foundry_navbar', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
        db.add_column('foundry_menu', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('foundry_page', 'subtitle')
        db.create_unique('foundry_listing', ['slug'])
        db.delete_column('foundry_navbar', 'subtitle')
        db.create_unique('foundry_navbar', ['slug'])
        db.create_unique('foundry_country', ['slug'])
        db.delete_column('foundry_menu', 'subtitle')
        db.create_unique('foundry_menu', ['slug'])
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'foundry.chatroom': {'Meta': {'ordering': "('-created',)", 'object_name': 'ChatRoom', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                            'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})}, 
       'foundry.column': {'Meta': {'object_name': 'Column'}, 'id': (
                               'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                          'index': (
