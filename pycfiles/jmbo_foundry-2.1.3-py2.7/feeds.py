...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/foundry/feeds.py
    ...
    def get_image_info(self, item):
        ...
        if cached is not None:
            ...
            if item.image:
                ...
                if blob:
                    info = feedgenerator.Enclosure(self.request.build_absolute_uri(item.image_detail_url), len(blob.tobytes()), 'image/%s' % blob.format.lower())
