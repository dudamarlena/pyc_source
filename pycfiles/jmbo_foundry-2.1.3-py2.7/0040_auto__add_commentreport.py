...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0040_auto__add_commentreport.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('foundry_commentreport', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foundry.FoundryComment'])),
         (
          'reporter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))))
        db.send_create_signal('foundry', ['CommentReport'])

    def backwards(self, orm):
        db.delete_table('foundry_commentreport')
