...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/jmbo-foundry/foundry/migrations/0047_fix_django_social_auth_foreign_key.py
...
class Migration(SchemaMigration):
    depends_on = (('social_auth', '0001_initial'), )

    def forwards(self, orm):
        db.alter_column('social_auth_usersocialauth', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foundry.Member'], null=False))

    def backwards(self, orm):
        db.alter_column('social_auth_usersocialauth', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=False))
