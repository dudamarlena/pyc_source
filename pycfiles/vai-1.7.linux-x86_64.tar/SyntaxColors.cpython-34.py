...
# [GCC 8.4.0]
# Embedded file name: /home/sbo/lib/python3.4/site-packages/vai/models/SyntaxColors.py
...
def defaultColorSchema(num_colors):
    ...
    if num_colors == 256:
        return {'Keyword': 'term_ffd75f', 
         ...
         'Comment': 'cyan', 
         'Name.Class': 'term_5fafd7', 
         'Name.Class.PythonPrivate': 'term_ff5f5f', 
         'Name.Builtin': 'term_5fafd7', 
         'Name.Exception': 'term_ffd75f', 
         'String': 'red', 
         'Literal': 'red', 
         'Literal.String.Doc': 'red', 
         'Number': 'red', 
         'Operator.Word': 'term_ffd75f', 
         'Name.Decorator': 'term_af87af', 
         'Name.Builtin.Pseudo': 'term_5fafd7', 
         'Name.Builtin.Pseudo.PythonSelf': 'term_ffafd7', 
