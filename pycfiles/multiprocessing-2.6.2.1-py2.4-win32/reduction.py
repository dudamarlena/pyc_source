...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\multiprocessing\reduction.py
# Compiled at: 2009-07-30 09:32:54
__all__ = []
import os, sys, socket, threading, _multiprocessing
...
def reduce_handle(handle):
    if Popen.thread_is_spawning():
        return (
         None, Popen.duplicate_for_child(handle), True)
