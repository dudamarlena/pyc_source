...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\multiprocessing\util.py
# Compiled at: 2009-07-30 09:32:54
import itertools, weakref, atexit, threading
from multiprocessing.process import current_process, active_children
__all__ = [
 'sub_debug', 'debug', 'info', 'sub_warning', 'get_logger', 'log_to_stderr', 'get_temp_dir', 'register_after_fork', 'is_exiting', 'Finalize', 'ForkAwareThreadLock', 'ForkAwareLocal', 'SUBDEBUG', 'SUBWARNING']
NOTSET = 0
SUBDEBUG = 5
DEBUG = 10
INFO = 20
