...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\onpage_hub_api_client\OnPageHubApi.py
# Compiled at: 2013-02-21 12:42:00
...
class OnPageHubApi:
    ...
    def __prepareMessages(self, messages):
        ...
        for message in messages:
            hubApiMessage = self.__createMessage(messageId=message.messageId, sender=message.sender, recipients=message.recipients, subject=message.subject, body=message.body, replyOptions=message.replyOptions, callBackUrl=message.callBackUrl)
