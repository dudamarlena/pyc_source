...
# [GCC 8.4.0]
# Embedded file name: /home/user/env/lib/python3.5/site-packages/idb/netnode.py
# Compiled at: 2018-06-14 18:11:45
# Size of source mod 2**32: 10130 bytes
...
def make_key(nodeid, tag=None, index=None, wordsize=4):
    ...
    if wordsize == 4:
        ...
        if isinstance(nodeid, six.integer_types):
            if tag is None:
...
class Netnode(object):
    ...
    def __init__(self, db, nodeid):
        ...
        if self.wordsize == 4:
            self.nodebase = 4278190080
        else:
            if self.wordsize == 8:
                self.nodebase = 18374686479671623680
            else:
