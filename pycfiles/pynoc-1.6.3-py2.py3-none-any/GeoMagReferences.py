...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/PyNOAAGeoMagIndiceHandler/GeoMagReferences.py
# Compiled at: 2012-09-18 11:49:39
    ...
    class GeoMagReferenceImpl(object):
        ...
        DictReference = {'field': {'name': 'dict', 
                     ...
                     'dict': {'name': 'position', 
                              ...
                              'localtion': {'name': 'site', 
                                            'value': [
                                                    'sk-ta3', 'ace', 'stereo-a', 'stereo-b']}, 
                              'site': {'name': 'detector', 
                                       'value': [
                                               'neutronmonitor', 'swepam', 'magnetometer'], 
                                       'detector': {'name': [
        ...
        RealTimeSolarIndiceReference = {'system': {'earth': {'sk-ta3': {'neutronmonitor': {'laps': {'1m': {'url': 'http://neutronmonitor.ta3.sk/ascii.php?filename=/data/6h.dat'}, '5m': {'url': 'http://neutronmonitor.ta3.sk/ascii.php?filename=/data/24h.dat'}, '1h': {'url': 'http://neutronmonitor.ta3.sk/ascii.php?filename=/data/30d.dat'}}}}}, 'satellite': {'ace': {'swepam': {'title': 'Solar Wind Electron Proton Alpha Monitor', 
                                                       'field': [
                                                               'UT Date YR', 'UT Date MO', 'UT Date DA', 'UT Date HHMM', 'Modified Julian Day', 'Seconds of the Day', 'S', 'Density', 'Speed', 'Temperature'], 
                                                       'laps': {'1m': {'url': 'http://www.swpc.noaa.gov/ftpdir/lists/ace/ace_swepam_1m.txt'}}}}, 
                                    'stereo-a': {'name': {'a': {'field': [
                                                                        'UT Date YR', 'UT Date MO', 'UT Date DA', 'UT Date HHMM', 'Modified Julian Day', 'Seconds of the Day', 'S', 'BR', 'BT', 'BN', 'Bt', 'Lat.', 'Long.'], 
                                                                'magnetometer': {'laps': {'1m': {'url': 'http://www.swpc.noaa.gov/ftpdir/lists/stereo/sta_mag_1m.txt'}}}}}}, 
                                    'stereo-b': {'name': {'a': {'field': [
                                                                        'UT Date YR', 'UT Date MO', 'UT Date DA', 'UT Date HHMM', 'Modified Julian Day', 'Seconds of the Day', 'S', 'BR', 'BT', 'BN', 'Bt', 'Lat.', 'Long.'], 
                                                                'magnetometer': {'laps': {'1m': {'url': 'http://www.swpc.noaa.gov/ftpdir/lists/stereo/stb_mag_1m.txt'}}}}}}}}}
        RootName = None
        ...
        def GetRoot(self):
            return (
             self.RootName, self.RootNameContent)
        ...
        def GetCollectionType(self):
            return (
             self.CollectionType, self.CollectionTypeContent)
        ...
        def GetCollectionSection(self):
            return (
             self.CollectionSection, self.CollectionSectionContent)
        ...
        def GetInstrumentName(self):
            return (
             self.InstrumentName, self.InstrumentNameContent)
