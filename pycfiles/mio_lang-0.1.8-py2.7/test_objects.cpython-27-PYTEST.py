...
# [GCC 8.4.0]
# Embedded file name: /home/prologic/work/mio/tests/test_objects.py
...
def test_setParent(mio):
    ...
    @py_assert1 = @py_assert3 = @py_assert5 = None
    @py_assert1 = mio.eval
    @py_assert3 = 'World setParent(Foo)'
    @py_assert5 = @py_assert1(@py_assert3)
    if not @py_assert5:
        @py_format7 = 'assert %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.eval\n}(%(py4)s)\n}' % {'py0': @pytest_ar._saferepr(mio) if 'mio' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(mio) else 'mio', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py6': @pytest_ar._saferepr(@py_assert5)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format7))
...
def test_hash(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'Object __hash__()'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert10 = runtime.find
    @py_assert12 = 'Object'
    @py_assert14 = @py_assert10(@py_assert12)
    @py_assert16 = hash(@py_assert14)
    @py_assert7 = @py_assert5 == @py_assert16
    if not @py_assert7:
        @py_format18 = @pytest_ar._call_reprcompare(('==',), (@py_assert7,), ('%(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.eval\n}(%(py4)s)\n} == %(py17)s\n{%(py17)s = %(py8)s(%(py15)s\n{%(py15)s = %(py11)s\n{%(py11)s = %(py9)s.find\n}(%(py13)s)\n})\n}',), (@py_assert5, @py_assert16)) % {'py8': @pytest_ar._saferepr(hash) if 'hash' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(hash) else 'hash', 'py9': @pytest_ar._saferepr(runtime) if 'runtime' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(runtime) else 'runtime', 'py0': @pytest_ar._saferepr(mio) if 'mio' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(mio) else 'mio', 'py13': @pytest_ar._saferepr(@py_assert12), 'py2': @pytest_ar._saferepr(@py_assert1), 'py11': @pytest_ar._saferepr(@py_assert10), 'py4': @pytest_ar._saferepr(@py_assert3), 'py17': @pytest_ar._saferepr(@py_assert16), 'py6': @pytest_ar._saferepr(@py_assert5), 'py15': @pytest_ar._saferepr(@py_assert14)}
...
def test_id(mio):
    @py_assert1 = mio.eval
    @py_assert3 = '(Object id) == (Object id)'
    @py_assert5 = @py_assert1(@py_assert3)
    if not @py_assert5:
        @py_format7 = 'assert %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.eval\n}(%(py4)s)\n}' % {'py0': @pytest_ar._saferepr(mio) if 'mio' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(mio) else 'mio', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py6': @pytest_ar._saferepr(@py_assert5)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format7))
...
def test_keys(mio):
    ...
    @py_assert0 = 'x'
    @py_assert2 = @py_assert0 in keys
    if not @py_assert2:
        @py_format4 = @pytest_ar._call_reprcompare(('in', ), (@py_assert2,), ('%(py1)s in %(py3)s', ), (@py_assert0, keys)) % {'py1': @pytest_ar._saferepr(@py_assert0), 'py3': @pytest_ar._saferepr(keys) if 'keys' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(keys) else 'keys'}
...
def test_parent(mio):
    mio.eval('Foo = Object clone()')
    @py_assert1 = mio.eval
    @py_assert3 = 'Foo parent is Object'
    @py_assert5 = @py_assert1(@py_assert3)
    if not @py_assert5:
        @py_format7 = 'assert %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.eval\n}(%(py4)s)\n}' % {'py0': @pytest_ar._saferepr(mio) if 'mio' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(mio) else 'mio', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py6': @pytest_ar._saferepr(@py_assert5)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format7))
...
def test_parent2(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'Object parent is Object'
    @py_assert5 = @py_assert1(@py_assert3)
    if not @py_assert5:
        @py_format7 = 'assert %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.eval\n}(%(py4)s)\n}' % {'py0': @pytest_ar._saferepr(mio) if 'mio' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(mio) else 'mio', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py6': @pytest_ar._saferepr(@py_assert5)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format7))
...
def test_value(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'Object value is None'
    @py_assert5 = @py_assert1(@py_assert3)
    if not @py_assert5:
        @py_format7 = 'assert %(py6)s\n{%(py6)s = %(py2)s\n{%(py2)s = %(py0)s.eval\n}(%(py4)s)\n}' % {'py0': @pytest_ar._saferepr(mio) if 'mio' in @py_builtins.locals() or @pytest_ar._should_repr_global_name(mio) else 'mio', 'py2': @pytest_ar._saferepr(@py_assert1), 'py4': @pytest_ar._saferepr(@py_assert3), 'py6': @pytest_ar._saferepr(@py_assert5)}
        raise AssertionError(@pytest_ar._format_explanation(@py_format7))
