...
# [GCC 8.4.0]
# Embedded file name: /home/prologic/work/mio/tests/core/test_range.py
...
def test_range_init(mio):
    ...
    @py_assert1 = mio.eval
    @py_assert3 = 'list(Range clone(*xs))'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert8 = [2, 4, 6]
    @py_assert7 = @py_assert5 == @py_assert8
    if not @py_assert7:
...
def test_range_stop(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'list(Range clone(2, 4))'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert8 = [2, 3]
    @py_assert7 = @py_assert5 == @py_assert8
    if not @py_assert7:
...
def test_range_step(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'list(Range clone(2, 8, 2))'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert8 = [2, 4, 6]
    @py_assert7 = @py_assert5 == @py_assert8
    if not @py_assert7:
...
def test_range_invalid(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'list(Range clone(10, 0, 1))'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert8 = []
    @py_assert7 = @py_assert5 == @py_assert8
    if not @py_assert7:
...
def test_range_invalid2(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'list(Range clone(0, 10, -1))'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert8 = []
    @py_assert7 = @py_assert5 == @py_assert8
    if not @py_assert7:
...
def test_range_getitem3(mio):
    @py_assert1 = mio.eval
    @py_assert3 = 'Range clone(10, 0, 1) __getitem__(0)'
    @py_assert5 = @py_assert1(@py_assert3)
    @py_assert8 = 10
    @py_assert7 = @py_assert5 == @py_assert8
    if not @py_assert7:
