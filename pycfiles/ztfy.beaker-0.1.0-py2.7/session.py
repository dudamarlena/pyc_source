...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/beaker/session.py
# Compiled at: 2014-11-26 07:08:35
...
from ztfy.beaker.metadirectives import IBeakerFileSessionConfiguration, IBeakerSessionConfiguration, IBeakerMemcachedSessionConfiguration, IBeakerSessionConfigurationInfo, IBeakerMemorySessionConfiguration, IBeakerDBMSessionConfiguration, IBeakerAlchemySessionConfiguration
...
class BeakerSessionUtility(Persistent, Contained):
    ...
    def _getSession(self):
        request = getRequest()
        config = queryUtility(IBeakerSessionConfiguration, name=self.configuration_name or '')
        if config is None:
