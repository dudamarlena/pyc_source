...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toil_rnaseq/tools/aligners.py
...
def run_star(job, r1_id, r2_id, star_index_url, wiggle=False, sort=False, save_aligned_bam=False):
    ...
    assert sort and os.stat(aligned_bam_path).st_size > 0, 'Aligned bam failed to sort. Ensure sufficient memory is free.'
    ...
    return (
     transcriptome_id, star_id, aligned_id, wiggle_id)