...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/argonaut/controllers/feed.py
...
class FeedController(BaseController):
    ...
    def posts(self):
        ...
        feed = Rss201rev2Feed(title=h.config.get('rss_title'), link=h.config.get('site_url'), description=h.config.get('rss_title'), language='en')
        for p in posts:
