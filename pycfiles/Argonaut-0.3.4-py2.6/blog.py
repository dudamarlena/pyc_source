...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/argonaut/controllers/blog.py
# Compiled at: 2011-02-18 19:15:09
import logging
from pylons import request, response, session, tmpl_context as c, url
from pylons.controllers.util import abort, redirect
from argonaut.lib.base import BaseController, render
import argonaut.lib.helpers as h, webhelpers.paginate as paginate
...
class BlogController(BaseController):
    ...
    def latest(self):
        ...
        return render('/blog/view.mako', extra_vars={'page_id': page_id, 'post_count': c.posts_count})
    ...
    def view(self, id):
        ...
        if c.post is None:
            abort(404)
        page_id = int(h.page.get_page_id_with_type('blog'))
        return render('/blog/view.mako', extra_vars={'page_id': page_id, 'post_count': 1})
    ...
    def archives(self):
        ...
        if posts is None:
            abort(404)
        c.paginator = paginate.Page(posts, page=int(request.params.get('page', 1)), items_per_page=20)
