...
# [GCC 8.4.0]
# Embedded file name: /Users/Dave/Dropbox/github_projects/dryxPython/dryxPython/randomdata.py
# Compiled at: 2013-08-06 08:59:38
"""
**randomdata**
...
def random_ra_dec():
  ...
  """
    randomRa = random.random() * 360.0
    randomDec = -90 + random.random() * 180.0
    randomRaErr = random.random() / 360.0
    randomDecErr = random.random() / 360.0
...
def random_sentence():
  ...
  """
    ...
    if randomNum == 2:
        sentence = 'consectetur adipisicing elit'
    if randomNum == 3:
        sentence = 'sed do eiusmod tempor incididunt ut labore'
    if randomNum == 4:
        sentence = 'dolore magna aliqua'
    return sentence
...
def random_filter_set():
  ...
  """
    ...
    if randomNum == 1:
        randomRefSource = 'sdss'
    if randomNum == 2:
        randomRefSource = '2MASS'
    if randomNum == 3:
        randomRefSource = 'Johnson-Cousins'
...
def random_human_name():
  ...
  """
    randomNum = random.randint(1, 7)
    if randomNum == 1:
        randomName = 'guy garvey'
    if randomNum == 2:
        randomName = 'thom yorke'
    if randomNum == 3:
        randomName = 'jack steadman'
    if randomNum == 4:
        randomName = 'gemma hayes'
    if randomNum == 5:
        randomName = 'ryan adams'
    if randomNum == 6:
        randomName = 'bon iver'
    if randomNum == 7:
        randomName = 'johnny cash'
    return randomName