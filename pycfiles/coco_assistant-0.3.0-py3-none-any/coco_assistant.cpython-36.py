...
# [GCC 8.4.0]
# Embedded file name: /home/ashwin/Desktop/Projects/COCO-Assistant/coco_assistant/coco_assistant.py
# Compiled at: 2020-04-19 12:46:15
# Size of source mod 2**32: 12899 bytes
import ast, json, logging, os, shutil
...
class COCO_Assistant:
    ...
    def __init__(self, img_dir=None, ann_dir=None):
        ...
        if os.path.exists(self.res_dir) is False:
            ...
            assert self.jsonfiles, 'Annotation files not passed'
            assert self.imgfolders, 'Image folders not passed'
    ...
    def merge(self, merge_images=True):
        ...
        cann = {'images':[],  'annotations':[],  'info':None, 
         'licenses':None, 
         'categories':None}
    ...
    def converter(self, to='TFRecord'):
        ...
        if to == 'TFRecord':
            try:
                ...
                print('Tensorflow not found. Please install tensorflow <= 1.15.0')
