...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/issue_db/issue_db.py
# Compiled at: 2011-08-15 04:52:12
"""The central pieces of code..."""
from __future__ import with_statement
from git import Repo
from git.exc import InvalidGitRepositoryError
import datetime, os, pickle, time, subprocess, sys
ISSUE_FILE = '.issues'
...
class IssueDB(object):
    ...
    def __str__(self):
        ...
        return ('\t').join(('id', 'Date', 'Commit', 'Status', 'Prio', 'Comment')) + '\n' + '-' * 70 + '\n' + ('\n').join(str(issue) for issue in sorted(self.issue_db.values())[::-1] if issue.status == 'open')
