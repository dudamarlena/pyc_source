...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.5/site-packages/vcf/utils.py
# Compiled at: 2016-03-18 12:18:30
...
def walk_together(*readers, **kwargs):
    ...
    while any([r is not None for r in nexts]):
        ...
        keys_with_prev_contig = [k for k in list(next_idx_to_k.values()) if k[0] == min_k[0]]
