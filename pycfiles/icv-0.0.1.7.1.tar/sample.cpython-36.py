...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/data/core/sample.py
# Compiled at: 2019-07-27 13:18:10
...
class Sample(object):
    ...
    def __init__(self, name, image, annos=None, meta=None):
        ...
        if not meta is None:
            if not isinstance(meta, SampleMeta):
                raise AssertionError
        elif not is_file(image):
            raise AssertionError
        self.name = name
        self.path = image
