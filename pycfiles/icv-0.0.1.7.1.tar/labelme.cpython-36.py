...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/data/labelme.py
# Compiled at: 2019-09-13 12:02:05
...
class LabelMe(IcvDataSet):
    ...
    def __init__(self, image_anno_path_list, split='trainval', keep_no_anno_image=True, categories=None, one_index=False):
    ...
    def get_sample(self, id):
        ...
        if id in self.sample_db:
            ...
            if 'shapes' in anno_data:
                ...
                for shape in shapes:
                    if not 'shape_type' not in shape:
    ...
    def _write(self, anno_sample, anno_path, img_path):
        if not isinstance(anno_sample, Sample):
            raise AssertionError
        else:
            if is_dir(anno_path):
        ...
        for anno in anno_sample.annos:
            ...
            if anno.seg_mode_polys:
                ...
                if anno.seg_mode_mask:
                    ...
                    shape['points'] = [
                     [
                      anno.bbox.xmin, anno.bbox.ymin], [anno.bbox.xmax, anno.bbox.ymax]]
