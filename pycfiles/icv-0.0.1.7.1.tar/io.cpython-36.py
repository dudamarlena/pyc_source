...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/image/io.py
# Compiled at: 2019-09-20 09:49:58
...
imread_flags = {'color':IMREAD_COLOR, 
...
def imread_topil(img_or_path):
    if is_str(img_or_path):
        ...
        if Image.isImageType(img_or_path):
            return img_or_path
