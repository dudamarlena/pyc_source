...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/detector/mmd.py
# Compiled at: 2019-11-19 02:36:04
# Size of source mod 2**32: 7111 bytes
try:
    import mmdet
except ModuleNotFoundError as e:
    raise Exception('You should install mmdetection first (https://github.com/open-mmlab/mmdetection/blob/master/INSTALL.md) . Import mmdet Error!')
...
class MmdetDetector(Detector):
    ...
    def _build_result(self, inference_result, inference_time=0, score_thr=-1):
        ...
        preds = [np.full((bbox.shape[0]), i, dtype=(np.int32)) for i, bbox in enumerate(bbox_result)]
