...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/utils/label_map_util.py
# Compiled at: 2019-08-09 01:43:17
...
def labelmap_to_categories(label_map_path, use_display_name=True):
...
def labelmap_to_category_index(label_map_path, use_display_name=True):
    ...
    """
    categories = labelmap_to_categories(label_map_path, use_display_name)
