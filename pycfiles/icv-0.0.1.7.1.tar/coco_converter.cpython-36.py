...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/data/converter/coco_converter.py
# Compiled at: 2019-10-29 08:00:03
...
class CocoConverter(object):
    ...
    def to_voc(self, voc_root, split=None, reset=False):
        ...
        setfile = os.path.join(imgset_seg_path, '%s.txt' % split) if self.coco.is_seg_mode else os.path.join(imgset_path, '%s.txt' % split)
        mkfile(setfile)
        voc = Voc(voc_root,
          split,
