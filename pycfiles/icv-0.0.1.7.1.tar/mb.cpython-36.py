...
# [GCC 8.4.0]
# Embedded file name: /Users/rensike/Workspace/icv/icv/detector/mb.py
# Compiled at: 2019-10-15 23:05:53
# Size of source mod 2**32: 8987 bytes
try:
    import maskrcnn_benchmark
except ImportError as e:
    raise Exception('You should install maskrcnn_benchmark first (https://github.com/facebookresearch/maskrcnn-benchmark/blob/master/INSTALL.md) . Import maskrcnn_benchmark Error!')
...
class MbDetector(Detector):
    ...
    def _compute_prediction_on_batch(self, original_image_list):
        ...
        predictions = [post_process(original_image, pred) for original_image, pred in list(zip(original_image_list, predictions))]
        return predictions
