...
# [GCC 8.4.0]
# Embedded file name: /Users/dauptain/GITLAB/opentea/opentea/geometry.py
...
class Shape(object):
    ...
    def is_inside(self, x):
        """Determine if x is inside the shape"""
        pass

    @abstractmethod
    def bounding_box(self):
        """Dictionary of min/max bounding box for shape"""
        pass
...
class Parallelogram(Shape2D):
    ...
    def bounding_box(self):
        ...
        return {'xmin': min(self.xref[0], top_pt[0]), 'ymin': min(self.xref[1], top_pt[1]), 
...
class Circle(Shape2D):
    ...
    def bounding_box(self):
        ...
        return {'xmin': min_point[0], 'xmax': max_point[0], 'ymin': min_point[1], 
           'ymax': max_point[1]}
...
class Sphere(Shape3D):
    ...
    def bounding_box(self):
        ...
        max_point = self.xref + self.radius
        return {'xmin': min_point[0], 'xmax': max_point[0], 'ymin': min_point[1], 
           'ymax': max_point[1], 'zmin': min_point[2], 
           'zmax': max_point[2]}
...
class Cylinder(Shape3D):
    ...
    def project(self, x):
        ...
        Get cylinder axis coord and distance to axis
        (normalized by ||vec|| and radius)
...
class rotation(object):
    ...
    TODO this raises too-few-public-methods error, should be strongly
    refactored (probably just a function in shape3d ?)
    """
