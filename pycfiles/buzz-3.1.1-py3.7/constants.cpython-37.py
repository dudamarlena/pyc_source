...
# Compiled at: 2020-04-20 07:30:29
...
BENEPAR_LANGUAGES = {k:v for k, v in LANGUAGES.items() if v in _AVAILABLE_MODELS if v in _AVAILABLE_MODELS}
SPACY_LANGUAGES = {k:v for k, v in BENEPAR_LANGUAGES.items()}
