...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/buzz/dashview.py
# Compiled at: 2020-05-03 14:21:39
# Size of source mod 2**32: 5234 bytes
from multiprocessing import Process
import dash, dash_core_components as dcc, dash_html_components as html, dash_table
import plotly.graph_objects as go
MAPPING = {'markdown':dcc, 
 'h1':html, 
 'h2':html, 
 'h3':html, 
 'h4':html, 
 ...
 'table':html}
CHART_TYPES = {
 'line', 'bar', 'heatmap', 'area', 'stacked_bar'}
    ...
    def remove(self, idx):
        if isinstance(idx, int):
            ...
            if not isinstance(idx, str):
                ...
                idx = idx.startswith('el-') or 'el-' + idx
            self.app.layout.children = [i for i in self.app.layout.children if str(getattr(i, 'id', None)) != str(idx)]
            self.reload()
