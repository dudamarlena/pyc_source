...
# Size of source mod 2**32: 17950 bytes
import os, re, shutil
...
from .constants import COLUMN_NAMES, CONLL_COLUMNS, DTYPES, LONG_NAMES, MORPH_FIELDS, SPACY_LANGUAGES
