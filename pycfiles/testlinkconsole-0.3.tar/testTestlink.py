...
# [GCC 8.4.0]
# Embedded file name: /home/cbrun/Projets/Perso/projets/dev/testlinkconsole/testlinkconsole/tests/plugins/testTestlink.py
# Compiled at: 2014-07-16 07:41:53
import unittest, mock, mox, ConfigParser
...
class TestTestlinkPlugin(unittest.TestCase):
    ...
    def test_listProjects(self):
        projectsIn = [{'id': '1', 'name': 'projet1', 'description': 'description1'}, {'id': '2', 'name': 'projet2', 'description': 'description2'}]
        projectsOut = [{'id': '1', 'name': 'projet1'}, {'id': '2', 'name': 'projet2'}]
    ...
    def test_listTestPlans(self):
        testPlansIn = [{'id': '1', 'name': 'campagne1', 'description': 'description1'}]
        testPlansOut = [{'id': '1', 'name': 'campagne1'}]
    ...
    def test_listTestCases(self):
        testCasesIn = {'test1': [{'tcase_id': '1', 'tcase_name': 'test1', 'description': 'description du test 1', 'full_external_id': '234'}]}
        testCasesOut = [{'id': '1', 'name': 'test1', 'extid': '234'}]
