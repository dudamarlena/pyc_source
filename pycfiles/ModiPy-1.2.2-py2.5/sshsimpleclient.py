...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/modipy/sshsimpleclient.py
...
class SimpleConnection(connection.SSHConnection):
    ...
    def serviceStarted(self):
        self.openChannel(TrueChannel(65536, 32768, self))
        self.openChannel(FalseChannel(65536, 32768, self))
        self.openChannel(CatChannel(65536, 32768, self))
