...
# [GCC 8.4.0]
# Embedded file name: /Users/adam/Projects/faker-e164/faker_e164/providers.py
# Compiled at: 2017-07-31 03:29:01
        ...
        while not isinstance(phone_number, PhoneNumber):
            ...
            if is_possible:
                if not phonenumbers.is_possible_number(phone_number):
                    phone_number = self.numerify(e164_numerify_pattern)
                    continue
            if not is_possible and phonenumbers.is_possible_number(phone_number):
                phone_number = self.numerify(e164_numerify_pattern)
                continue
