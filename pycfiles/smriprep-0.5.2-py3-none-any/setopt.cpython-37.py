...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pti7pv2_/setuptools/setuptools/command/setopt.py
...
class option_base(Command):
    __doc__ = 'Abstract base class for commands that mess with config files'
    user_options = [
