...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pti7pv2_/setuptools/setuptools/msvc.py
...
import sys, platform, itertools, distutils.errors
...
class SystemInfo:
    ...
    def NetFxSdkVersion(self):
        ...
        """
        if self.vs_ver >= 14.0:
            return ('4.7.2', '4.7.1', '4.7', '4.6.2', '4.6.1', '4.6', '4.5.2', '4.5.1',
                    '4.5')
        return ()
