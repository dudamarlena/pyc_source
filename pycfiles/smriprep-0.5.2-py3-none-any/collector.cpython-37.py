...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pti7pv2_/pip/pip/_internal/index/collector.py
# Compiled at: 2020-02-14 17:24:43
# Size of source mod 2**32: 17892 bytes
"""
The main purpose of this module is to expose LinkCollector.collect_links().
"""
import cgi, itertools, logging, mimetypes, os
...
if MYPY_CHECK_RUNNING:
    from typing import Callable, Iterable, List, MutableMapping, Optional, Sequence, Tuple, Union
...
def group_locations--- This code section failed: ---
 ...
 L. 381         0  BUILD_LIST_0          0 
                2  STORE_DEREF              'files'

 L. 382         4  BUILD_LIST_0          0 
                6  STORE_DEREF              'urls'

 L. 385         8  LOAD_CLOSURE             'files'
 ...
 L. 393        22  SETUP_LOOP          254  'to 254'
               24  LOAD_FAST                'locations'
               26  GET_ITER         
               28  FOR_ITER            252  'to 252'
               30  STORE_FAST               'url'

 L. 395        32  LOAD_GLOBAL              os
               34  LOAD_ATTR                path
 ...
 L. 404        92  LOAD_FAST                'expand_dir'
               94  POP_JUMP_IF_FALSE   148  'to 148'

 L. 405        96  LOAD_GLOBAL              os
               98  LOAD_ATTR                path
 ...
 L. 406       108  SETUP_LOOP          180  'to 180'
              110  LOAD_GLOBAL              os
 ...
 L. 408       148  LOAD_FAST                'is_file_url'
              150  POP_JUMP_IF_FALSE   164  'to 164'

 L. 409       152  LOAD_DEREF               'urls'
 ...
 L. 411       164  LOAD_GLOBAL              logger
              166  LOAD_METHOD              warning

 L. 412       168  LOAD_STR                 "Path '{0}' is ignored: it is a directory."
              170  LOAD_METHOD              format

 L. 413       172  LOAD_FAST                'path'
 ...
 L. 426       238  LOAD_GLOBAL              logger
              240  LOAD_METHOD              warning

 L. 427       242  LOAD_STR                 "Url '%s' is ignored. It is either a non-existing path or lacks a specific scheme."

 L. 428       244  LOAD_FAST                'url'
...
class LinkCollector(object):
    ...
    def collect_links(self, project_name):
        ...
        url_locations = [link for link in itertools.chain((Link(url) for url in index_url_loc), (Link(url) for url in fl_url_loc)) if self.session.is_secure_origin(link)]
