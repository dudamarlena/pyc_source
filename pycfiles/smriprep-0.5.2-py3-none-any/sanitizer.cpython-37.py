...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pti7pv2_/pip/pip/_vendor/html5lib/filters/sanitizer.py
# Compiled at: 2020-02-14 17:24:43
# Size of source mod 2**32: 26248 bytes
from __future__ import absolute_import, division, unicode_literals
import re
from xml.sax.saxutils import escape, unescape
import pip._vendor.six.moves as urlparse
from . import base
...
class Filter(base.Filter):
    ...
    def sanitize_token(self, token):
        ...
        if token_type in ('StartTag', 'EndTag', 'EmptyTag'):
            ...
            if ((namespace, name) in self.allowed_elements or namespace) is None:
                if (
    ...
    def sanitize_css(self, style):
        ...
        if not re.match('^([:,;#%.\\sa-zA-Z0-9!]|\\w-\\w|\'[\\s\\w]+\'|"[\\s\\w]+"|\\([\\d,\\s]+\\))*$', style):
            ...
            return re.match('^\\s*([-\\w]+\\s*:[^:;]*(;\\s*|$))*$', style) or ''
        clean = []
