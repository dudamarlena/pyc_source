...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-pti7pv2_/pip/pip/_vendor/html5lib/html5parser.py
...
class HTMLParser(object):
 ...
 L. 205     56_58  SETUP_LOOP          562  'to 562'
               60  LOAD_FAST                'self'
               62  LOAD_METHOD              normalizedTokens
               64  CALL_METHOD_0         0  '0 positional arguments'
               66  GET_ITER         
             68_0  COME_FROM           536  '536'
             68_1  COME_FROM           528  '528'
             68_2  COME_FROM           520  '520'
            68_70  FOR_ITER            560  'to 560'
               72  STORE_FAST               'token'
 ...
 L. 208     82_84  SETUP_LOOP          514  'to 514'
             86_0  COME_FROM           498  '498'
               86  LOAD_FAST                'new_token'
               88  LOAD_CONST               None
               90  COMPARE_OP               is-not
            92_94  POP_JUMP_IF_FALSE   512  'to 512'
 ...
 L. 220       198  LOAD_GLOBAL              len
              ...
              208  LOAD_CONST               0
              210  COMPARE_OP               ==
          212_214  POP_JUMP_IF_TRUE    364  'to 364'
 ...
 L. 221       216  LOAD_FAST                'currentNodeNamespace'
              ...
              224  COMPARE_OP               ==
          226_228  POP_JUMP_IF_TRUE    364  'to 364'

 L. 222       230  LOAD_FAST                'self'
              232  LOAD_METHOD              isMathMLTextIntegrationPoint
 ...
 L. 224       252  LOAD_FAST                'token'
          ...
          270_272  POP_JUMP_IF_TRUE    364  'to 364'
 ...
 L. 225       274  LOAD_FAST                'type'
              ...
              280  BUILD_TUPLE_2         2 
              282  COMPARE_OP               in
          284_286  POP_JUMP_IF_TRUE    364  'to 364'
 ...
 L. 226       288  LOAD_FAST                'currentNodeNamespace'
              ...
              294  BINARY_SUBSCR    
              296  COMPARE_OP               ==
          298_300  POP_JUMP_IF_FALSE   336  'to 336'
 ...
 L. 229       322  LOAD_FAST                'token'
              ...
              328  LOAD_STR                 'svg'
              330  COMPARE_OP               ==
          332_334  POP_JUMP_IF_TRUE    364  'to 364'
            336_0  COME_FROM           318  '318'
            336_1  COME_FROM           308  '308'
            336_2  COME_FROM           298  '298'

 L. 230       336  LOAD_FAST                'self'
              338  LOAD_METHOD              isHTMLIntegrationPoint
 ...
 L. 231       348  LOAD_FAST                'type'
          ...
          360_362  POP_JUMP_IF_FALSE   372  'to 372'
            364_0  COME_FROM           332  '332'
            364_1  COME_FROM           284  '284'
            364_2  COME_FROM           270  '270'
            364_3  COME_FROM           226  '226'
            364_4  COME_FROM           212  '212'
 ...
 L. 237       392  LOAD_FAST                'phase'
              394  LOAD_METHOD              processCharacters
 ...
 L. 239       414  LOAD_FAST                'phase'
              416  LOAD_METHOD              processSpaceCharacters
 ...
 L. 241       436  LOAD_FAST                'phase'
              438  LOAD_METHOD              processStartTag
 ...
 L. 245       480  LOAD_FAST                'phase'
              482  LOAD_METHOD              processComment
 ...
 L. 247       500  LOAD_FAST                'phase'
              502  LOAD_METHOD              processDoctype
 ...
 L. 250       530  LOAD_FAST                'prev_token'
              ...
              534  BINARY_SUBSCR    
              536  POP_JUMP_IF_TRUE     68  'to 68'

 L. 251       538  LOAD_FAST                'self'
              540  LOAD_METHOD              parseError
              542  LOAD_STR                 'non-void-element-with-trailing-solidus'

 L. 252       544  LOAD_STR                 'name'
              546  LOAD_FAST                'prev_token'
              548  LOAD_STR                 'name'
              550  BINARY_SUBSCR    
              552  BUILD_MAP_1           1 
              554  CALL_METHOD_2         2  '2 positional arguments'
              556  POP_TOP          
              558  JUMP_BACK            68  'to 68'
              560  POP_BLOCK        
            562_0  COME_FROM_LOOP       56  '56'

 L. 255       562  LOAD_CONST               True
              564  STORE_FAST               'reprocess'

 L. 256       566  BUILD_LIST_0          0 
              568  STORE_FAST               'phases'

 L. 257       570  SETUP_LOOP          628  'to 628'
            572_0  COME_FROM           614  '614'
            572_1  COME_FROM           602  '602'
              572  LOAD_FAST                'reprocess'
          574_576  POP_JUMP_IF_FALSE   626  'to 626'

 L. 258       578  LOAD_FAST                'phases'
 ...
 L. 259       590  LOAD_FAST                'self'
              592  LOAD_ATTR                phase
              594  LOAD_METHOD              processEOF
              596  CALL_METHOD_0         0  '0 positional arguments'
              598  STORE_FAST               'reprocess'

 L. 260       600  LOAD_FAST                'reprocess'
          602_604  POP_JUMP_IF_FALSE   572  'to 572'

 L. 261       606  LOAD_FAST                'self'
              608  LOAD_ATTR                phase
              610  LOAD_FAST                'phases'
              612  COMPARE_OP               not-in
          614_616  POP_JUMP_IF_TRUE    572  'to 572'
              618  LOAD_GLOBAL              AssertionError
              620  RAISE_VARARGS_1       1  'exception instance'
          622_624  JUMP_BACK           572  'to 572'
            626_0  COME_FROM           574  '574'
              626  POP_BLOCK        
            628_0  COME_FROM_LOOP      570  '570'

Parse error at or near `JUMP_FORWARD' instruction at offset 370
...
def getPhases(debug):
    ...
    def log(function):
        ...
        def wrapped(self, *args, **kwargs):
            if function.__name__.startswith('process'):
                if len(args) > 0:
                    token = args[0]
                    try:
    ...
    class Phase(with_metaclass(getMetaclass(debug, log))):
        ...
        def processComment(self, token):
            self.tree.insertCommenttokenself.tree.openElements[(-1)]
    ...
    class InitialPhase(Phase):
        ...
        def processComment(self, token):
            self.tree.insertCommenttokenself.tree.document

        def processDoctype--- This code section failed: ---

 L. 495         0  LOAD_FAST                'token'
                2  LOAD_STR                 'name'
                4  BINARY_SUBSCR    
                6  STORE_FAST               'name'

 L. 496         8  LOAD_FAST                'token'
               10  LOAD_STR                 'publicId'
               12  BINARY_SUBSCR    
               14  STORE_FAST               'publicId'

 L. 497        16  LOAD_FAST                'token'
               18  LOAD_STR                 'systemId'
               20  BINARY_SUBSCR    
               22  STORE_FAST               'systemId'

 L. 498        24  LOAD_FAST                'token'
               26  LOAD_STR                 'correct'
               28  BINARY_SUBSCR    
               30  STORE_FAST               'correct'

 L. 500        32  LOAD_FAST                'name'
               34  LOAD_STR                 'html'
               36  COMPARE_OP               !=
               38  POP_JUMP_IF_TRUE     64  'to 64'
               40  LOAD_FAST                'publicId'
               42  LOAD_CONST               None
               44  COMPARE_OP               is-not
               46  POP_JUMP_IF_TRUE     64  'to 64'

 L. 501        48  LOAD_FAST                'systemId'
               50  LOAD_CONST               None
               52  COMPARE_OP               is-not
               54  POP_JUMP_IF_FALSE    76  'to 76'
               56  LOAD_FAST                'systemId'
               58  LOAD_STR                 'about:legacy-compat'
               60  COMPARE_OP               !=
               62  POP_JUMP_IF_FALSE    76  'to 76'
             64_0  COME_FROM            46  '46'
             64_1  COME_FROM            38  '38'

 L. 502        64  LOAD_FAST                'self'
               66  LOAD_ATTR                parser
               68  LOAD_METHOD              parseError
               70  LOAD_STR                 'unknown-doctype'
               72  CALL_METHOD_1         1  '1 positional argument'
               74  POP_TOP          
             76_0  COME_FROM            62  '62'
             76_1  COME_FROM            54  '54'

 L. 504        76  LOAD_FAST                'publicId'
               78  LOAD_CONST               None
               80  COMPARE_OP               is
               82  POP_JUMP_IF_FALSE    88  'to 88'

 L. 505        84  LOAD_STR                 ''
               86  STORE_FAST               'publicId'
             88_0  COME_FROM            82  '82'

 L. 507        88  LOAD_FAST                'self'
               90  LOAD_ATTR                tree
               92  LOAD_METHOD              insertDoctype
               94  LOAD_FAST                'token'
               96  CALL_METHOD_1         1  '1 positional argument'
               98  POP_TOP          

 L. 509       100  LOAD_FAST                'publicId'
              102  LOAD_STR                 ''
              104  COMPARE_OP               !=
              106  POP_JUMP_IF_FALSE   118  'to 118'

 L. 510       108  LOAD_FAST                'publicId'
              110  LOAD_METHOD              translate
              112  LOAD_GLOBAL              asciiUpper2Lower
              114  CALL_METHOD_1         1  '1 positional argument'
              116  STORE_FAST               'publicId'
            118_0  COME_FROM           106  '106'

 L. 512       118  LOAD_FAST                'correct'
              120  POP_JUMP_IF_FALSE   186  'to 186'
              122  LOAD_FAST                'token'
              124  LOAD_STR                 'name'
              126  BINARY_SUBSCR    
              128  LOAD_STR                 'html'
              130  COMPARE_OP               !=
              132  POP_JUMP_IF_TRUE    186  'to 186'

 L. 513       134  LOAD_FAST                'publicId'
              136  LOAD_METHOD              startswith

 L. 514       138  LOAD_CONST               ('+//silmaril//dtd html pro v0r11 19970101//', '-//advasoft ltd//dtd html 3.0 aswedit + extensions//', '-//as//dtd html 3.0 aswedit + extensions//', '-//ietf//dtd html 2.0 level 1//', '-//ietf//dtd html 2.0 level 2//', '-//ietf//dtd html 2.0 strict level 1//', '-//ietf//dtd html 2.0 strict level 2//', '-//ietf//dtd html 2.0 strict//', '-//ietf//dtd html 2.0//', '-//ietf//dtd html 2.1e//', '-//ietf//dtd html 3.0//', '-//ietf//dtd html 3.2 final//', '-//ietf//dtd html 3.2//', '-//ietf//dtd html 3//', '-//ietf//dtd html level 0//', '-//ietf//dtd html level 1//', '-//ietf//dtd html level 2//', '-//ietf//dtd html level 3//', '-//ietf//dtd html strict level 0//', '-//ietf//dtd html strict level 1//', '-//ietf//dtd html strict level 2//', '-//ietf//dtd html strict level 3//', '-//ietf//dtd html strict//', '-//ietf//dtd html//', '-//metrius//dtd metrius presentational//', '-//microsoft//dtd internet explorer 2.0 html strict//', '-//microsoft//dtd internet explorer 2.0 html//', '-//microsoft//dtd internet explorer 2.0 tables//', '-//microsoft//dtd internet explorer 3.0 html strict//', '-//microsoft//dtd internet explorer 3.0 html//', '-//microsoft//dtd internet explorer 3.0 tables//', '-//netscape comm. corp.//dtd html//', '-//netscape comm. corp.//dtd strict html//', "-//o'reilly and associates//dtd html 2.0//", "-//o'reilly and associates//dtd html extended 1.0//", "-//o'reilly and associates//dtd html extended relaxed 1.0//", '-//softquad software//dtd hotmetal pro 6.0::19990601::extensions to html 4.0//', '-//softquad//dtd hotmetal pro 4.0::19971010::extensions to html 4.0//', '-//spyglass//dtd html 2.0 extended//', '-//sq//dtd html 2.0 hotmetal + extensions//', '-//sun microsystems corp.//dtd hotjava html//', '-//sun microsystems corp.//dtd hotjava strict html//', '-//w3c//dtd html 3 1995-03-24//', '-//w3c//dtd html 3.2 draft//', '-//w3c//dtd html 3.2 final//', '-//w3c//dtd html 3.2//', '-//w3c//dtd html 3.2s draft//', '-//w3c//dtd html 4.0 frameset//', '-//w3c//dtd html 4.0 transitional//', '-//w3c//dtd html experimental 19960712//', '-//w3c//dtd html experimental 970421//', '-//w3c//dtd w3 html//', '-//w3o//dtd w3 html 3.0//', '-//webtechs//dtd mozilla html 2.0//', '-//webtechs//dtd mozilla html//')
              140  CALL_METHOD_1         1  '1 positional argument'
              142  POP_JUMP_IF_TRUE    186  'to 186'

 L. 569       144  LOAD_FAST                'publicId'
              146  LOAD_CONST               ('-//w3o//dtd w3 html strict 3.0//en//', '-/w3c/dtd html 4.0 transitional/en', 'html')
              148  COMPARE_OP               in
              150  POP_JUMP_IF_TRUE    186  'to 186'

 L. 572       152  LOAD_FAST                'publicId'
              154  LOAD_METHOD              startswith

 L. 573       156  LOAD_CONST               ('-//w3c//dtd html 4.01 frameset//', '-//w3c//dtd html 4.01 transitional//')
              158  CALL_METHOD_1         1  '1 positional argument'
              160  POP_JUMP_IF_FALSE   170  'to 170'

 L. 575       162  LOAD_FAST                'systemId'
              164  LOAD_CONST               None
              166  COMPARE_OP               is
              168  POP_JUMP_IF_TRUE    186  'to 186'
            170_0  COME_FROM           160  '160'

 L. 576       170  LOAD_FAST                'systemId'
              172  POP_JUMP_IF_FALSE   196  'to 196'
              174  LOAD_FAST                'systemId'
              176  LOAD_METHOD              lower
              178  CALL_METHOD_0         0  '0 positional arguments'
              180  LOAD_STR                 'http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd'
              182  COMPARE_OP               ==
            ...
            186_4  COME_FROM           120  '120'

 L. 577       186  LOAD_STR                 'quirks'
              188  LOAD_FAST                'self'
              190  LOAD_ATTR                parser
              192  STORE_ATTR               compatMode
              194  JUMP_FORWARD        232  'to 232'
            196_0  COME_FROM           184  '184'
            196_1  COME_FROM           172  '172'

 L. 578       196  LOAD_FAST                'publicId'
              198  LOAD_METHOD              startswith

 L. 579       200  LOAD_CONST               ('-//w3c//dtd xhtml 1.0 frameset//', '-//w3c//dtd xhtml 1.0 transitional//')
              202  CALL_METHOD_1         1  '1 positional argument'
              204  POP_JUMP_IF_TRUE    224  'to 224'

 L. 581       206  LOAD_FAST                'publicId'
              208  LOAD_METHOD              startswith

 L. 582       210  LOAD_CONST               ('-//w3c//dtd html 4.01 frameset//', '-//w3c//dtd html 4.01 transitional//')
              212  CALL_METHOD_1         1  '1 positional argument'
              214  POP_JUMP_IF_FALSE   232  'to 232'

 L. 584       216  LOAD_FAST                'systemId'
              218  LOAD_CONST               None
              220  COMPARE_OP               is-not
              222  POP_JUMP_IF_FALSE   232  'to 232'
            224_0  COME_FROM           204  '204'

 L. 585       224  LOAD_STR                 'limited quirks'
              226  LOAD_FAST                'self'
              228  LOAD_ATTR                parser
              230  STORE_ATTR               compatMode
            232_0  COME_FROM           222  '222'
            232_1  COME_FROM           214  '214'
            232_2  COME_FROM           194  '194'

 L. 587       232  LOAD_FAST                'self'
              234  LOAD_ATTR                parser
              236  LOAD_ATTR                phases
              238  LOAD_STR                 'beforeHtml'
              240  BINARY_SUBSCR    
              242  LOAD_FAST                'self'
              244  LOAD_ATTR                parser
              246  STORE_ATTR               phase
...
Parse error at or near `JUMP_FORWARD' instruction at offset 194
    ...
    class InHeadPhase(Phase):
        ...
        def startTagTitle(self, token):
            self.parser.parseRCDataRawtexttoken'RCDATA'

        def startTagNoFramesStyle(self, token):
            self.parser.parseRCDataRawtexttoken'RAWTEXT'
 ...
 'tt', 'u'),
        ...
        def endTagForm(self, token):
            ...
            if not node is None:
                self.tree.elementInScope(node) or self.parser.parseError'unexpected-end-tag'{'name': 'form'}
            else:
                self.tree.generateImpliedEndTags()
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                if formattingElement:
                    if formattingElement in self.tree.openElements:
                    ...
                    if formattingElement not in self.tree.openElements:
                        ...
                        return
                    self.tree.elementInScope(formattingElement.name) or self.parser.parseError'adoption-agency-4.4'{'name': token['name']}
                    return
                if formattingElement != self.tree.openElements[(-1)]:
                    ...
                    if furthestBlock is None:
                        ...
                        if lastNode.parent:
                            lastNode.parent.removeChild(lastNode)
                        if commonAncestor.name in frozenset(('table', 'tbody', 'tfoot',
                                                             'thead', 'tr')):
                            parent, insertBefore = self.tree.getTableMisnestedNodePosition()
                            parent.insertBeforelastNodeinsertBefore
                    else:
                ...
                self.tree.activeFormattingElements.remove(formattingElement)
                self.tree.activeFormattingElements.insertbookmarkclone
 ...
 'tr'),
    ...
    class InCellPhase(Phase):
        ...
        def closeCell(self):
            if self.tree.elementInScope('td', variant='table'):
                ...
                if self.tree.elementInScope('th', variant='table'):
        ...
        def endTagOptgroup(self, token):
            if self.tree.openElements[(-1)].name == 'option':
                if self.tree.openElements[(-2)].name == 'optgroup':
                    self.tree.openElements.pop()
            elif self.tree.openElements[(-1)].name == 'optgroup':
                self.tree.openElements.pop()
            else:
        ...
        def processCharacters(self, token):
            if token['data'] == '\x00':
                ...
                if self.parser.framesetOK:
                    if any((char not in spaceCharacters for char in token['data'])):
                        self.parser.framesetOK = False
            Phase.processCharactersselftoken

        def processStartTag(self, token):
            currentNode = self.tree.openElements[(-1)]
            if not token['name'] in self.breakoutElements:
                if token['name'] == 'font':
                    if set(token['data'].keys()) & set(['color', 'face', 'size']):
                        self.parser.parseError'unexpected-html-element-in-foreign-content'{'name': token['name']}
                        while self.tree.openElements[(-1)].namespace != self.tree.defaultNamespace:
                            self.parser.isHTMLIntegrationPoint(self.tree.openElements[(-1)]) or self.parser.isMathMLTextIntegrationPoint(self.tree.openElements[(-1)]) or self.tree.openElements.pop()

                        return token
            elif currentNode.namespace == namespaces['mathml']:
                self.parser.adjustMathMLAttributes(token)
            else:
        ...
        def processEndTag(self, token):
            ...
            while True:
                if node.name.translate(asciiUpper2Lower) == token['name']:
                    ...
                    while self.tree.openElements.pop() != node and not self.tree.openElements:
                        raise AssertionError
    ...
    class AfterBodyPhase(Phase):
        ...
        def processComment(self, token):
            self.tree.insertCommenttokenself.tree.openElements[0]
...
def adjust_attributes(token, replacements):
    ...
    if needs_adjustment:
        token['data'] = OrderedDict(((replacements.getkk, v) for k, v in token['data'].items()))
