...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.4/dist-packages/bass/site.py
# Compiled at: 2015-09-13 04:06:47
...
def ignore_entry(name_rel, dirname):
    ...
    return any([fnmatch(name_rel, pattern) for pattern in setting.ignore]) or setting.follow_links and islink(join(dirname, name_rel))
