...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-MsePIp/scf/tcfcli/cmds/native/common/runtime/python3.6/bootstrap.py
# Compiled at: 2019-12-02 05:04:19
import runtime, os, sys
if sys.version_info[0] != 3 or sys.version_info[1] < 6:
    ...
    sys.exit(233)
import json, logging, traceback, importlib.util
from decimal import Decimal
init_handler_fault = 'function initialization failed'
max_ret_msg_len = 6291456
