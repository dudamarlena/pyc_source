...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-MsePIp/scf/tcfcli/cmds/native/common/start_api_context.py
# Compiled at: 2019-12-02 05:04:19
import json, sys, os, click, subprocess
...
class StartApiContext(object):
    ...
    def __init__(self, template_file, function=None, debug_port=None, debug_args='', namespace=None, env_file=None):
