...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/xcbl/widgets.py
# Compiled at: 2007-05-10 14:14:03
...
class ExtensibleCheckBoxListDesc(WidgetDescription):
    ...
    for_widget = ExtensibleCheckBoxList('your_extensible_checkbox_list', options=[(1, 'Python'), (2, 'Java'), (3, 'Pascal'), (4, 'Ruby')], default=[1, 4])