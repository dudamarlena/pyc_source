...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/zinc/shipping_method_factory.py
# Compiled at: 2014-01-23 16:10:20
    ...
    def cheapest(klass, shipping_methods_response):
        ...
        for method in shipping_methods_response['shipping_methods']:
            if minimum[0] == None or method['price'] < minimum[0]:
                minimum = (
                 method['price'], method['shipping_method_id'])
