...
# [GCC 8.4.0]
# Embedded file name: /home/oaraque/git/gsi/gsitk/gsitk/datasets/multidomain.py
# Compiled at: 2017-05-03 04:53:12
...
"""
import os, logging, codecs, pandas as pd
...
class Multidomain(Dataset):
    ...
    def read_category(self, category_path, category):
        ...
        positive_texts, positive_ratings = self.read_file(os.path.join(category_path, positive_name))
        negative_texts, negative_ratings = self.read_file(os.path.join(category_path, negative_name))
