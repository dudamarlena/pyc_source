...
# [GCC 8.4.0]
# Embedded file name: /home/www.django/makarthy/codenerix_invoicing/migrations/0004_saleslines.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='SalesLines', fields=[
      (
      ...
      (
       'ticket_rectification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lines_sales', to='codenerix_invoicing.SalesTicketRectification', verbose_name='Ticket rectification'))], options={'default_permissions': ('add', 'change', 'delete', 'view', 'list'), 
      'abstract': False})]