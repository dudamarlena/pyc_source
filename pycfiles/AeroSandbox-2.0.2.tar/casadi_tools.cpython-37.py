...
# Compiled at: 2020-04-19 13:12:19
...
def fit(model, x_data, y_data, param_guesses, param_bounds=None, weights=None, verbose=True):
    """
    ...
    opti.solver('ipopt')
    sol = opti.solve()
    params_solved = {k:sol.value(params[k]) for k in params}
    if verbose:
        print('\nFit Parameters:')
