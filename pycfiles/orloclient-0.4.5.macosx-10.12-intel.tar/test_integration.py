...
# [GCC 8.4.0]
# Embedded file name: /Users/alforbes/virtualenv/orloclien-py2/lib/python2.7/site-packages/tests/test_integration.py
# Compiled at: 2017-04-03 06:52:20
...
class OrloLiveServerTest(LiveServerTestCase):
    ...
    def setUp(self):
        self.orlo_client = OrloClient(uri='http://localhost:7767')
