...
# [GCC 8.4.0]
# Embedded file name: /Users/alforbes/virtualenv/orloclien-py2/lib/python2.7/site-packages/tests/test_orloclient.py
# Compiled at: 2017-05-10 13:00:21
...
class TestOrloBase(OrloClientTest):
    ...
    @httpretty.activate
    def test_ping(self):
        httpretty.register_uri(httpretty.GET, 'http://localhost:1337/ping', body='pong', status=200)
...
class TestGetReleases(OrloClientTest):
    ...
    RELEASE_JSON = {'releases': [{'id': str(uuid.uuid4())}]}
    ...
    def test_get_release_json_with_id(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/releases/{}').format(self.URI, self.RELEASE.release_id), body=self.DUMMY_JSON_S, status=200)
    ...
    def test_get_release(self):
        ...
        httpretty.register_uri(httpretty.GET, ('{}/releases/{}').format(self.URI, rid), body=self.RELEASE_JSON_S, status=200)
    ...
    def test_get_releases(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/releases?foo=bar').format(self.URI, self.RELEASE.release_id), body=self.RELEASE_JSON_S, status=200)
    ...
    def test_get_releases_filter(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/releases').format(self.URI), body=self.RELEASE_JSON_S, status=200)
        self.orlo.get_releases(user='test_string')
        self.assertEqual(httpretty.last_request().querystring['user'], [
         'test_string'])
...
class TestGetPackages(OrloClientTest):
    ...
    def test_get_package_json_with_id(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/packages/{}').format(self.URI, self.PACKAGE.id), body=self.DUMMY_JSON_S, status=200)
    ...
    def test_get_package(self):
        ...
        httpretty.register_uri(httpretty.GET, ('{}/packages/{}').format(self.URI, rid), body=self.PACKAGE_JSON_S, status=200)
    ...
    def test_get_packages(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/packages?foo=bar').format(self.URI, self.PACKAGE.id), body=self.PACKAGE_JSON_S, status=200)
    ...
    def test_get_packages_filter(self):
        ...
        If the argument user=foo doesn't make it into the request this test will fail
        """
        httpretty.register_uri(httpretty.GET, ('{}/packages').format(self.URI), body=self.PACKAGE_JSON_S, status=200)
...
class CreateReleaseTest(OrloClientTest):
    ...
    def test_create_release(self):
        ...
        """
        httpretty.register_uri(httpretty.POST, ('{}/releases').format(self.URI), status=200, body=('{{"id": "{}"}}').format(self.RELEASE.release_id), content_type='application/json')
        release = self.orlo.create_release(self.USER, self.PLATFORMS)
        self.assertEqual(uuid.UUID(release.release_id), self.RELEASE.uuid)
...
class ReleaseStopTest(OrloClientTest):
    ...
    def test_release_stop(self):
        ...
        httpretty.register_uri(httpretty.POST, url, status=204, content_type='application/json')
...
class WorkflowTest(OrloClientTest):
    ...
    def test_package_start(self):
        ...
        Test package_start
        """
        url = ('{}/releases/{}/packages/{}/start').format(self.URI, self.PACKAGE.release_id, self.PACKAGE.id)
        httpretty.register_uri(httpretty.POST, url, status=204, content_type='application/json')
        self.assertEqual(self.orlo.package_start(self.PACKAGE), True)
    ...
    def test_package_stop(self):
        ...
        Test package_stop
        """
        httpretty.register_uri(httpretty.POST, ('{}/releases/{}/packages/{}/stop').format(self.URI, self.PACKAGE.release_id, self.PACKAGE.id), status=204, content_type='application/json')
        self.assertEqual(self.orlo.package_stop(self.PACKAGE), True)
    ...
    def test_package_add_results(self):
        ...
        """
        httpretty.register_uri(httpretty.POST, ('{}/releases/{}/packages/{}/results').format(self.URI, self.PACKAGE.release_id, self.PACKAGE.id), status=204, content_type='application/json')
        self.assertEqual(self.orlo.package_add_results(self.PACKAGE, results='test results'), True)
...
class ErrorTest(OrloClientTest):
    ...
    def test_error_404(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/releases/{}').format(self.URI, self.RELEASE.release_id), status=404, content_type='application/json')
        self.assertRaises(ClientError, self.orlo.get_release, self.RELEASE.release_id)
    ...
    def test_error_invalid_json(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/releases/{}').format(self.URI, self.RELEASE.release_id), status=200, body='{"foo": "bar"} this is not valid json')
        self.assertRaises(ClientError, self.orlo.get_release, self.RELEASE.release_id)
...
class InfoTest(OrloClientTest):
    ...
    def test_info_users(self):
        ...
        Test info/users
        """
        httpretty.register_uri(httpretty.GET, ('{}/info/users').format(self.URI), status=200, content_type='application/json', body=json.dumps(self.DOC))
    ...
    def test_info_users_with_username(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/info/users/{}').format(self.URI, 'user_one'), status=200, content_type='application/json', body=json.dumps(self.DOC))
    ...
    def test_info_users_with_platform(self):
        ...
        """
        httpretty.register_uri(httpretty.GET, ('{}/info/users?platform={}').format(self.URI, 'platform_one'), status=200, content_type='application/json', body=json.dumps(self.DOC))
...
class StatsTest(OrloClientTest):
    ...
    """
    DOC = {'subject': {'releases': {'normal': {'failed': 1, 
                                           'successful': 2}, 
                                'rollback': {'failed': 1, 
                                             'successful': 2}, 
                                'total': {'failed': 1, 
    ...
    def test_stats(self):
        ...
        Test /stats
        """
        httpretty.register_uri(httpretty.GET, ('{}/stats').format(self.URI), status=200, content_type='application/json', body=json.dumps(self.DOC))
    ...
    def test_stats_with_field(self):
        ...
        Test /stats
        """
        httpretty.register_uri(httpretty.GET, ('{}/stats/user').format(self.URI), status=200, content_type='application/json', body=json.dumps(self.DOC))
    ...
    def test_stats_with_field_and_name(self):
        ...
        Test /stats
        """
        httpretty.register_uri(httpretty.GET, ('{}/stats/user/userOne').format(self.URI), status=200, content_type='application/json', body=json.dumps(self.DOC))
    ...
    def test_stats_with_field_and_query(self):
        ...
        Test /stats
        """
        httpretty.register_uri(httpretty.GET, ('{}/stats/user?platform=platformOne').format(self.URI), status=200, content_type='application/json', body=json.dumps(self.DOC))
...
class VersionsTest(OrloClientTest):
    ...
    def test_version(self):
        ...
        httpretty.register_uri(httpretty.GET, ('{}/info/packages/versions').format(self.URI), status=200, content_type='application/json', body=json.dumps(expected))
