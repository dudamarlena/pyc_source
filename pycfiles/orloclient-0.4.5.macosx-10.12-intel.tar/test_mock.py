...
# [GCC 8.4.0]
# Embedded file name: /Users/alforbes/virtualenv/orloclien-py2/lib/python2.7/site-packages/tests/test_mock.py
...
def get_callables(obj):
    ...
    for attribute in dir(obj):
        if attribute.startswith('_') or attribute in excluded_functions:
            continue
