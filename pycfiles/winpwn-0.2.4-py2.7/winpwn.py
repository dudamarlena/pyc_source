...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\winpwn\winpwn.py
# Compiled at: 2020-04-17 21:34:30
import platform, threading, sys, socket, time, os
...
class tube(object):
    ...
    def interactive(self):
        ...
        def recv_thread():
            try:
                while not go.is_set():
                    buf = self.read(65536, 0.125, interactive=True)
                    if buf:
