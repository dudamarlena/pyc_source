...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\bogglesolver\test\unit_tests.py
# Compiled at: 2014-08-29 23:58:05
...
class test_boggle_letters(unittest.TestCase):
    __doc__ = 'Unit tests for adding letters to the boggle board.'
...
class test_dictionary(unittest.TestCase):
    __doc__ = 'Unit tests for the dictionary.'
...
class test_SolveMultiLetterBoggle(unittest.TestCase):
    __doc__ = 'Unit tests for multi-letter solve game.'
...
class test_SolveBoggle(unittest.TestCase):
    __doc__ = 'Unit tests for solve boggle.'
