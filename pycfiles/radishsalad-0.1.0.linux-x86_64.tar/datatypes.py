...
# [GCC 8.4.0]
# Embedded file name: /home/kriskin/w/python/ve/lib/python2.6/site-packages/radishsalad/datatypes.py
# Compiled at: 2011-08-23 05:19:52
...
class List(RedisDataType):
    ...
    def __getitem__(self, key_or_slice):
        if isinstance(key_or_slice, slice):
            data = self.r_call('lrange', key_or_slice.start or 0, key_or_slice.stop or -1)
        else:
