...
# [GCC 8.4.0]
# Embedded file name: /home/kriskin/w/python/ve/lib/python2.6/site-packages/radishsalad/models.py
# Compiled at: 2011-09-06 07:56:44
...
class DataType(datatypes.RedisDataType):
    ...
    def __get__(self, instance, owner):
        new_inst = type(self)(*getattr(self, 'args', []), **getattr(self, 'kwargs', {}))
...
class Pointer(String):
    ...
    def __get__(self, instance, owner):
        return self.foreign_class(str(super(Pointer, self).__get__(instance, owner)))
