...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/commands/local/lib/local_api_service.py
# Compiled at: 2020-03-22 09:15:56
# Size of source mod 2**32: 5555 bytes
"""
...
class LocalApiService:
    ...
    def __init__(self, lambda_invoke_context, port, host, static_dir, endpoint):
        ...
        self.api_provider = ApiProvider((lambda_invoke_context.template),
          parameter_overrides=(lambda_invoke_context.parameter_overrides), cwd=(self.cwd))
