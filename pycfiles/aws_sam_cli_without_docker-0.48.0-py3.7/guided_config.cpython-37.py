...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/commands/deploy/guided_config.py
...
class GuidedConfig:
    ...
    def get_config_ctx(self):
        ...
        samconfig = SamConfig(config_dir=(samconfig_dir if samconfig_dir else SamConfig.config_dir(template_file_path=(self.template_file))))
        return (
         ctx, samconfig)
