...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/lib/intrinsic_resolver/intrinsics_symbol_table.py
# Compiled at: 2020-03-21 12:32:11
# Size of source mod 2**32: 17275 bytes
"""
...
class IntrinsicsSymbolTable:
    ...
    SUPPORTED_PSEUDO_TYPES = [
     ...
     AWS_URL_PREFIX,
     AWS_NOVALUE]
    DEFAULT_PSEUDO_PARAM_VALUES = {'AWS::AccountId':'123456789012', 
     'AWS::Partition':'aws', 
     'AWS::Region':'us-east-1', 
     'AWS::StackName':'local', 
     'AWS::StackId':'arn:aws:cloudformation:us-east-1:123456789012:stack/local/51af3dc0-da77-11e4-872e-1234567db123', 
    ...
    def get_default_pseudo_resolver(self):
        return {IntrinsicsSymbolTable.AWS_ACCOUNT_ID: self.handle_pseudo_account_id, 
    ...
    def get_default_attribute_resolver(self):
        return {'Ref':lambda logical_id: logical_id, 
         'Arn':self.arn_resolver}

    @staticmethod
    def get_default_type_resolver():
        return {'AWS::ApiGateway::RestApi':{'RootResourceId': '/'}, 
         'AWS::Lambda::LayerVersion':{IntrinsicResolver.REF: lambda logical_id: {IntrinsicResolver.REF: logical_id}}, 
         'AWS::Serverless::LayerVersion':{IntrinsicResolver.REF: lambda logical_id: {IntrinsicResolver.REF: logical_id}}}
    ...
    def arn_resolver(self, logical_id, service_name='lambda'):
        ...
        return str_format.format(partition_name=partition_name,
    ...
    def _get_function_name(self, logical_id):
        ...
        if not self._resources:
            ...
            return resource_properties or logical_id
