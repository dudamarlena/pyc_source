...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/lib/providers/sam_base_provider.py
...
class SamBaseProvider:
    ...
    def get_template(template_dict, parameter_overrides=None):
        ...
        resolver = IntrinsicResolver(template=template_dict,
    ...
    def _get_default_parameter_values(sam_template):
        ...
        if not (parameter_definition and isinstance(parameter_definition, dict)):
