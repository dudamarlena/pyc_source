...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/commands/validate/lib/sam_template_validator.py
...
import samtranslator.parser as parser
...
class SamTemplateValidator:
    ...
    def _replace_local_codeuri(self):
        ...
        for _, resource in all_resources.items():
            ...
            if resource_type == 'AWS::Serverless::Api' and 'DefinitionUri' in resource_dict:
