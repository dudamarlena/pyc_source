...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/local/events/api_event.py
...
class RequestContext:
    ...
    def __init__(self, resource_id='123456', api_id='1234567890', resource_path=None, http_method=None, request_id='c6af9ac6-7b61-11e6-9a41-93e8deadbeef', account_id='123456789012', stage=None, identity=None, extended_request_id=None, path=None):
        """
...
class ApiGatewayLambdaEvent:
    ...
    def __init__(self, http_method=None, body=None, resource=None, request_context=None, query_string_params=None, multi_value_query_string_params=None, headers=None, multi_value_headers=None, path_parameters=None, stage_variables=None, path=None, is_base_64_encoded=False):
        ...
        """
        if not isinstance(query_string_params, dict):
            if query_string_params is not None:
                raise TypeError("'query_string_params' must be of type dict or None")
            elif not isinstance(multi_value_query_string_params, dict):
            ...
            if not isinstance(stage_variables, dict):
    ...
    def to_dict(self):
        ...
        json_dict = {'httpMethod':self.http_method, 
         ...
         'multiValueQueryStringParameters':dict(self.multi_value_query_string_params) if self.multi_value_query_string_params else None, 
