...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/local/docker/container.py
# Compiled at: 2020-03-21 12:32:11
# Size of source mod 2**32: 9989 bytes
"""
Representation of a generic Docker container
"""
import logging, tarfile, tempfile, docker
...
class Container:
    ...
    def __init__(self, image, cmd, working_dir, host_dir, memory_limit_mb=None, exposed_ports=None, entrypoint=None, env_vars=None, docker_client=None, container_opts=None, additional_volumes=None):
        """
    ...
    def create(self):
        ...
        if self.is_created():
            ...
            kwargs = {'command':self._cmd, 
             'working_dir':self._working_dir, 
             'volumes':{self._host_dir: {'bind':self._working_dir, 
                               'mode':'ro,delegated'}}, 
             'tty':False, 
    ...
    def delete(self):
        ...
        if not self.is_created():
            ...
            return
        try:
            self.docker_client.containers.get(self.id).remove(force=True)
