...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/commands/local/cli_common/invoke_context.py
# Compiled at: 2020-03-21 12:32:11
# Size of source mod 2**32: 13447 bytes
"""
...
class InvokeContext:
    ...
    def __init__(self, template_file, function_identifier=None, env_vars_file=None, docker_volume_basedir=None, docker_network=None, log_file=None, skip_pull_image=None, debug_ports=None, debug_args=None, debugger_path=None, parameter_overrides=None, layer_cache_basedir=None, force_image_build=None, aws_region=None, aws_profile=None):
        """
    ...
    def function_name(self):
        ...
        raise InvokeContextException("You must provide a function identifier (function's Logical ID in the template). Possible options in your template: {}".format(all_function_names))
    ...
    def _get_env_vars_value(filename):
        ...
        try:
            ...
            try:
                raise InvokeContextException('Could not read environment variables overrides from file {}: {}'.format(filename, str(ex)))
            finally:
                ex = None
                del ex
