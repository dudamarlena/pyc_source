...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/lib/intrinsic_resolver/intrinsic_property_resolver.py
# Compiled at: 2020-03-21 12:32:11
# Size of source mod 2**32: 39429 bytes
"""
Process and simplifies CloudFormation intrinsic properties such as FN::* and Ref
"""
import copy, logging, base64, re
from collections import OrderedDict
from six import string_types
from samcli.lib.intrinsic_resolver.invalid_intrinsic_validation import verify_intrinsic_type_list, verify_non_null, verify_intrinsic_type_int, verify_in_bounds, verify_number_arguments, verify_intrinsic_type_str, verify_intrinsic_type_dict, verify_intrinsic_type_bool, verify_all_list_intrinsic_type
...
class IntrinsicResolver:
    ...
    _PSEUDO_REGEX = 'AWS::.*?'
    _ATTRIBUTE_REGEX = '[a-zA-Z0-9]*?\\.?[a-zA-Z0-9]*?'
    _REGEX_SUB_FUNCTION = '\\$\\{(' + _PSEUDO_REGEX + '||' + _ATTRIBUTE_REGEX + ')\\}'
    FN_JOIN = 'Fn::Join'
    FN_SPLIT = 'Fn::Split'
    FN_SUB = 'Fn::Sub'
    FN_SELECT = 'Fn::Select'
    ...
    CONDITIONAL_FUNCTIONS = [
     FN_AND, FN_OR, FN_IF, FN_EQUALS, FN_NOT]
    ...
    def default_intrinsic_function_map(self):
        ...
        """
        return {IntrinsicResolver.FN_JOIN: self.handle_fn_join, 
    ...
    def default_conditional_key_map(self):
        ...
        A dictionary containing the mapping from Intrinsic Function Key -> Intrinsic Resolver
        """
        return {IntrinsicResolver.FN_AND: self.handle_fn_and, 
        ...
        for key, val in intrinsic.items():
            try:
                ...
                verify_intrinsic_type_str(sanitized_key,
                  message=('The keys of the dictionary {} in {} must all resolve to a string'.format(sanitized_key, parent_function)))
            ...
            try:
                ...
                try:
                    ...
                    if ignore_errors:
                        ...
                        raise InvalidIntrinsicException('Exception with property of {}.{}'.format(key, resource_type) + ': ' + str(e.args))
                finally:
                    e = None
                    del e
    ...
    def handle_fn_join(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_JOIN))
        ...
        value_list = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_JOIN))
        verify_intrinsic_type_list(value_list,
        ...
        verify_all_list_intrinsic_type(sanitized_value_list,
          verification_func=verify_intrinsic_type_str, property_type=(IntrinsicResolver.FN_JOIN))
    ...
    def handle_fn_split(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_SPLIT))
        ...
        source_string = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_SPLIT))
    ...
    def handle_fn_base64(self, intrinsic_value, ignore_errors):
        ...
        A string with the resolved attributes
        """
        data = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_BASE64))
    ...
    def handle_fn_select(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_SELECT))
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_SELECT)
        index = self.intrinsic_property_resolver((arguments[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_SELECT))
        verify_intrinsic_type_int(index, IntrinsicResolver.FN_SELECT)
        list_of_objects = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_SELECT))
    ...
    def handle_find_in_map(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_FIND_IN_MAP))
        ...
        map_name = self.intrinsic_property_resolver((arguments[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_FIND_IN_MAP))
        top_level_key = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_FIND_IN_MAP))
        ...
        verify_intrinsic_type_dict(map_value,
        ...
        verify_intrinsic_type_dict(top_level_value,
          (IntrinsicResolver.FN_FIND_IN_MAP),
          message=('The TopLevelKey is missing in the Mappings dictionary in Fn::FindInMap for {}'.format(top_level_key)))
        second_level_value = top_level_value.get(second_level_key)
        verify_intrinsic_type_str(second_level_value,
          (IntrinsicResolver.FN_FIND_IN_MAP),
          message=('The SecondLevelKey is missing in the Mappings dictionary in Fn::FindInMap  for {}'.format(second_level_key)))
    ...
    def handle_fn_get_azs(self, intrinsic_value, ignore_errors):
        ...
        intrinsic_value = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_GET_AZS))
    ...
    def handle_fn_transform(self, intrinsic_value, ignore_errors):
        ...
        name = self.intrinsic_property_resolver(macro_name,
          ignore_errors, parent_function=(IntrinsicResolver.FN_TRANSFORM))
        ...
        verify_intrinsic_type_dict(parameters,
          (IntrinsicResolver.FN_TRANSFORM), message=' Fn::Transform requires parameters section')
    ...
    def handle_fn_getatt(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_GET_ATT))
        ...
        logical_id = self.intrinsic_property_resolver((arguments[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_GET_ATT))
        resource_type = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_GET_ATT))
    ...
    def handle_fn_ref(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.REF))
    ...
    def handle_fn_sub(self, intrinsic_value, ignore_errors):
        ...
        if isinstance(intrinsic_value, string_types):
            intrinsic_value = [
             intrinsic_value, {}]
        verify_intrinsic_type_list(intrinsic_value,
          (IntrinsicResolver.FN_SUB), message='The arguments to a Fn::Sub must be a list or a string')
        verify_number_arguments(intrinsic_value, (IntrinsicResolver.FN_SUB), num=2)
        sub_str = self.intrinsic_property_resolver((intrinsic_value[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_SUB))
        ...
        sanitized_variables = self.intrinsic_property_resolver(variables,
          ignore_errors, parent_function=(IntrinsicResolver.FN_SUB))
    ...
    def handle_fn_if(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_IF))
        ...
        condition_name = self.intrinsic_property_resolver((arguments[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_IF))
        verify_intrinsic_type_str(condition_name, IntrinsicResolver.FN_IF)
        value_if_true = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_IF))
        value_if_false = self.intrinsic_property_resolver((arguments[2]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_IF))
        condition = self._conditions.get(condition_name)
        verify_intrinsic_type_dict(condition,
        ...
        condition_evaluated = self.intrinsic_property_resolver(condition,
          ignore_errors, parent_function=(IntrinsicResolver.FN_IF))
        verify_intrinsic_type_bool(condition_evaluated,
          (IntrinsicResolver.FN_IF),
    ...
    def handle_fn_equals(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_EQUALS))
        ...
        value_1 = self.intrinsic_property_resolver((arguments[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_EQUALS))
        value_2 = self.intrinsic_property_resolver((arguments[1]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_EQUALS))
    ...
    def handle_fn_not(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_NOT))
        ...
        argument_sanitised = self.intrinsic_property_resolver((arguments[0]),
          ignore_errors, parent_function=(IntrinsicResolver.FN_NOT))
        if isinstance(argument_sanitised, dict):
            if 'Condition' in arguments[0]:
                ...
                argument_sanitised = self.intrinsic_property_resolver(condition,
                  ignore_errors, parent_function=(IntrinsicResolver.FN_NOT))
        verify_intrinsic_type_bool(argument_sanitised,
    ...
    def handle_fn_and(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_AND))
        ...
        for i, argument in enumerate(arguments):
            if isinstance(argument, dict) and 'Condition' in argument:
                ...
                verify_non_null(condition,
                  (IntrinsicResolver.FN_AND), position_in_list=(self.get_prefix_position_in_list(i)))
                condition_evaluated = self.intrinsic_property_resolver(condition,
                  ignore_errors, parent_function=(IntrinsicResolver.FN_AND))
    ...
    def handle_fn_or(self, intrinsic_value, ignore_errors):
        ...
        """
        arguments = self.intrinsic_property_resolver(intrinsic_value,
          ignore_errors, parent_function=(IntrinsicResolver.FN_OR))
        ...
        for i, argument in enumerate(arguments):
            if isinstance(argument, dict) and 'Condition' in argument:
                ...
                condition = self._conditions.get(condition_name)
                verify_non_null(condition,
                  (IntrinsicResolver.FN_OR), position_in_list=(self.get_prefix_position_in_list(i)))
                condition_evaluated = self.intrinsic_property_resolver(condition,
                  ignore_errors, parent_function=(IntrinsicResolver.FN_OR))
                ...
                condition = self.intrinsic_property_resolver(argument,
                  ignore_errors, parent_function=(IntrinsicResolver.FN_OR))
