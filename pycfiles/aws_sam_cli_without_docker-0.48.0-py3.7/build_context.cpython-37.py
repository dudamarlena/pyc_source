...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/commands/build/build_context.py
...
class BuildContext:
    _BUILD_DIR_PERMISSIONS = 493

    def __init__(self, function_identifier, template_file, base_dir, build_dir, mode, manifest_path=None, clean=False, use_container=False, parameter_overrides=None, docker_network=None, skip_pull_image=False):
    ...
    def functions_to_build(self):
        if self._function_identifier:
            ...
            if not function:
                ...
                available_function_message = '{} not found. Possible options in your template: {}'.format(self._function_identifier, all_functions)
