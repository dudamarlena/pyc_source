...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/lib/providers/cfn_api_provider.py
...
class CfnApiProvider(CfnBaseApiProvider):
    ...
    def _extract_cloud_formation_method(self, resources, logical_id, method_resource, collector):
        ...
        if content_handling == CfnApiProvider.METHOD_BINARY_TYPE:
            if content_type:
