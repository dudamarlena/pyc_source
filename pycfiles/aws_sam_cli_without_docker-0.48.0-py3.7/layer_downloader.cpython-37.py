...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/samcli/local/layers/layer_downloader.py
    ...
    def _fetch_layer_uri(self, layer):
        ...
        try:
            ...
            try:
                ...
                error_exc = {'AccessDeniedException':CredentialsRequired('Credentials provided are missing lambda:Getlayerversion policy that is needed to download the layer or you do not have permission to download the layer'), 
