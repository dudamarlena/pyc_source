...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/eddington_static/__main__.py
...
parser.add_argument('--version',
  action='version', version=__version__, help='Show version')
parser.add_argument('input', nargs='*', type=Path, help='Input path to analyze')
parser.add_argument('--format',
  action='store_true', default=False, help='Format code when possible')
parser.add_argument('--silent',
  action='store_true', default=False, help='Runs silently')
parser.add_argument('--verbose',
  action='store_true', default=False, help='Runs verbosely')
parser.add_argument('--fast',
  action='store_true', default=False, help='Include only fast actions.')
parser.add_argument('--test',
  action='store_true', default=False, help='Evaluate python test files')
parser.add_argument('-c',
  '--commands', nargs='+', type=str, help='Specify the commands to run')
parser.add_argument('-r',
  '--remove', nargs='+', type=str, help='Remove commands from running')
parser.add_argument('--commands-list',
  action='store_true',
  default=False,
...
def main() -> None:
    ...
    for command in commands:
        ...
        return_code = command.execute(input_paths,
