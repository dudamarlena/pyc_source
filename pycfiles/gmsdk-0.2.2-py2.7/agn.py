...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gmsdk/agn.py
# Compiled at: 2015-04-04 04:52:45
import json
...
class AGNAPIService(BaseConnection):
    ...
    def create(self, client_store='', fc='', data=None, version='2014.02'):
        """
                ...
                fc:\xad Name of the fulfillment center, where AGN will be processed 
    ...
    def list(self, client_store='', fc='', status='', updated_at='', source_number='', version='2014.02'):
        u"""
                Description:
                Makes a request and hit the Create AGN API endpoint.
                ...
                updated_at : date in format <yyyy\xadmm\xaddd>, AGN’s updated after given date will be
                filtered
