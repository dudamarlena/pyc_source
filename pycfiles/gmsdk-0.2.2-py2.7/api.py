...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gmsdk/api.py
...
class GMSDK(object):
    ...
    def __init__(self, **kwargs):
        self.params = kwargs
        self.custom_headers = kwargs.pop('headers', {'content-type': 'application/x-www-form-urlencoded'})
    ...
    def authenticate(self):
        ...
        if GMSDK.__authenticate_api:
            return GMSDK.__authenticate_api(headers=self.custom_headers, **self.params)
    ...
    def orders(self):
        ...
        if GMSDK.__order_api:
            return GMSDK.__order_api(headers=self.custom_headers, **self.params)
    ...
    def catalogue(self):
        ...
        if GMSDK.__product_api:
            return GMSDK.__product_api(headers=self.custom_headers, **self.params)
    ...
    def merchants(self):
        ...
        if GMSDK.__supplier_api:
            return GMSDK.__supplier_api(headers=self.custom_headers, **self.params)
    ...
    def procurements(self):
        ...
        """
        if GMSDK.__agn_api:
            return GMSDK.__agn_api(headers=self.custom_headers, **self.params)
    ...
    def inventory(self):
        ...
        """
        if GMSDK.__item_api:
            return GMSDK.__item_api(headers=self.custom_headers, **self.params)
    ...
    def request(self):
        ...
        """
        if GMSDK.__log_api:
            return GMSDK.__log_api(headers=self.custom_headers, **self.params)