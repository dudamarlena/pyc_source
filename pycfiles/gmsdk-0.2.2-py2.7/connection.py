...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gmsdk/connection.py
# Compiled at: 2015-04-06 07:01:37
import json, urllib
...
class BaseConnection(object):
    ...
    config = Config(domain=HOST, https=False, resp_format='json')

    def __init__(self, method='GET', proxy_host=None, timeout=20, proxy_port=80, **kwargs):
        self.response = None
        self.request = None
        self.method = method
    ...
    def execute(self, data=None):
        ...
        f = BaseConnection.__formator_class(self.config.resp_format, self.response)
        return f