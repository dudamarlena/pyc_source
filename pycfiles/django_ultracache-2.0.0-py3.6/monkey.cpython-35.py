...
# [GCC 8.4.0]
# Embedded file name: /home/hedley/django/instances/django-ultracache/ultracache/monkey.py
# Compiled at: 2019-05-31 04:24:10
...
def my_resolve_lookup(self, context):
    ...
    try:
        for bit in self.lookups:
            ...
            elif isinstance(current, Model) and 'request' in context and hasattr(context['request'], '_ultracache'):
    ...
    def wrapped(context, request, *args, **kwargs):
        ...
        if cached is not None:
            ...
            if do_cache:
                ...
                cache.set(cache_key, {'content': pickle.dumps(response.data), 'headers': headers}, timeout)
                return response
            return response
...
def my__getattribute__(self, name):
    if hasattr(_thread_locals, 'ultracache_recorder') and not hasattr(_thread_locals, '_ultracache_attr_marker'):
