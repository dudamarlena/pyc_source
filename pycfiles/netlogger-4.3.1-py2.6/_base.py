...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/netlogger/analysis/workflow/_base.py
# Compiled at: 2011-02-08 13:18:33
"""
...
class WorkflowBase(DoesLogging):
    ...
    def __repr__(self):
        ...
        for i in dir(self):
            if i.startswith('_') or i == 'initialize' or i == 'db' or i == 'metadata' or i == 'session' or i == 'log':
                continue
            try:
