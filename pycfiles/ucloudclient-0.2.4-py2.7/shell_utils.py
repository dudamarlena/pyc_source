...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/ucloudclient/utils/shell_utils.py
# Compiled at: 2015-11-11 06:54:58
import json, os, textwrap, time, six, prettytable
...
def add_arg(func, *args, **kwargs):
    ...
    if not hasattr(func, 'arguments'):
        func.arguments = []
    if (
     args, kwargs) not in func.arguments:
