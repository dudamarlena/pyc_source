...
# Compiled at: 2020-05-12 17:16:01
...
class BarterDude(MutableMapping):
    ...
    def consume_amqp(self, queues: Iterable[str], monitor: Monitor=Monitor(), coroutines: int=10, bulk_flush_interval: float=60.0, requeue_on_fail: bool=True, requeue_on_validation_fail: bool=False, validation_schema: Optional[dict]={}):
