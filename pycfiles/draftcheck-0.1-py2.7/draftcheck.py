...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/draftcheck/draftcheck.py
# Compiled at: 2014-08-08 22:00:15
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Check for common mistakes in LaTeX documents.')
    parser.add_argument('filenames', action='append', help='List of filenames to check')
