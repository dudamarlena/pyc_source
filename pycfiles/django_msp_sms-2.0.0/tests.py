...
# [GCC 8.4.0]
# Embedded file name: C:\BitBucket\djmicrosip_apps\django_msp_sms\django_msp_sms\tests.py
...
class FormarMensajeTests(TestCase):
    ...
    def setUp(self):
        ...
        cliente = {'total': 23900, 
           ...
           'moneda_simbolo': 'MN', 
           'documentos': []}
        cliente_cargos = {'email': cliente['email'], 
        ...
        login = {'apikey': Registry.objects.get(nombre='SIC_SMS_ApiKey').valor}
        commun = {'empresa_nombre': Registry.objects.get(nombre='SIC_SMS_NombreEmpresa').get_value()}
        self.cliente_cargos_kwargs = {'commun': commun, 
           'login': login, 
