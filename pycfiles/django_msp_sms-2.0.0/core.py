...
# [GCC 8.4.0]
# Embedded file name: C:\BitBucket\djmicrosip_apps\django_msp_sms\django_msp_sms\modulos\saldos_clientes\core.py
# Compiled at: 2017-06-15 14:41:34
...
def formar_mensaje(kwargs):
    ...
    sms_masivo.send(mensaje=mensaje, telefono=cargo['telefono'])
    return mensaje
