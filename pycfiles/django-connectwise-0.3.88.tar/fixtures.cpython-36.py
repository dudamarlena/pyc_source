...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-connectwise/djconnectwise/tests/fixtures.py
# Compiled at: 2020-04-16 16:15:52
# Size of source mod 2**32: 48636 bytes
...
API_WORK_ROLE = {'id':11, 
 ...
 'locationIds':[
  2], 
 '_info':{'lastUpdated':'2003-08-21T13:02:52Z', 
  'updatedBy':'zAdmin'}}
API_WORK_ROLE_LIST = [
 API_WORK_ROLE]
API_WORK_TYPE = {'id':4, 
 ...
 'externalIntegrationXRef':{'id':2, 
  'identifier':'Weekend After Hours', 
  'name':'Weekend and Holiday Time', 
  '_info':{'workTypeExternalIntegration_href': 'https://example.com/v4_6_release/apis/3.0'}}, 
 'inactiveFlag':False, 
 'overallDefaultFlag':False, 
 'activityDefaultFlag':False, 
 'utilizationFlag':True, 
 'costMultiplier':1, 
 '_info':{'lastUpdated':'2019-09-09T17:37:19Z', 
  'updatedBy':'User1'}}
API_WORK_TYPE_LIST = [
 API_WORK_TYPE]
API_BOARD = {'id':1, 
 ...
 'inactiveFlag':False, 
 'projectFlag':False, 
 'workRole':{'id':API_WORK_ROLE['id'], 
  'name':API_WORK_ROLE['name'], 
  '_info':{'workRole_href': 'https://example.com/v4_6_release/test'}}, 
 'workType':{'id':API_WORK_TYPE['id'], 
  'name':API_WORK_TYPE['name'], 
  '_info':{'workType_href': 'https://example.com/v4_6_release/test'}}, 
 'billTime':'NoDefault'}
API_BOARD_LIST = [
 API_BOARD]
...
API_COMPANY_TYPES_LIST = [
 {'id':5, 
  ...
  'defaultFlag':False, 
  'vendorFlag':False, 
  '_info':{'lastUpdated':'2015-08-21T20:22:06Z', 
   'updatedBy':None}}]
API_COMPANY = {'id':2, 
 ...
 'marketId':23, 
 'accountNumber':'', 
 'defaultContact':{'id':77, 
  'name':'Bob Dobbs', 
  '_info':{'contact_href': 'https://example.com/v4_6_release/apis/3.0/company/contacts/77'}}, 
 ...
 'taxCode':{'id':11, 
  'name':'State', 
  '_info':{'taxCode_href': 'https: //example.com/v4_6_release/apis/3.0/finance/taxCodes/11'}}, 
 'billingTerms':{'id':2, 
  'name':'Net 10 days', 
  '_info':None}, 
 ...
 'billToCompany':{'id':2, 
  'identifier':'YourCompany', 
  'name':'TestCompany', 
  '_info':{'company_href': 'https: //example.com/v4_6_release/apis/3.0/company/companies/2'}}, 
 'billingSite':None, 
 'billingContact':None, 
 'invoiceDeliveryMethod':{'id':1, 
  'name':'Mail', 
  '_info':None}, 
 ...
 '_info':{'lastUpdated':'2015-12-24T22: 08: 22Z', 
  'updatedBy':'omnicorp'}, 
 'customFields':None}
API_COMPANY_LIST = [
 API_COMPANY]
API_MEMBER = {'adminFlag':False, 
 ...
 'expenseApprover':{'id':176, 
  'identifier':'User1', 
  'name':'Training User1', 
  '_info':{'member_href': 'https://example.com/v4_6_release/apis/3.0/system/members/176'}}, 
 'firstName':'Training', 
 ...
 'photo':{'id':267, 
  ...
  '_info':{'filename':'pexels-photo-119705-square-resized.jpg', 
 ...
 'securityRole':{'id':63, 
  'name':'Admin', 
  '_info':None}, 
 'serviceDefaultBoard':{'id':1, 
  'name':'Tampa Office/Services', 
  '_info':{'board_href': 'https://example.com/v4_6_release/apis/3.0/service/boards/1'}}, 
 ...
 'workRole':{'id':11, 
  ...
  '_info':None}, 
 'workType':None, 
 '_info':{'lastUpdated':'2015-08-24T19:50:10Z', 
  'updatedBy':'User1'}}
API_MEMBER_LIST = [
 API_MEMBER]
API_MEMBER_COUNT = {'count': len(API_MEMBER_LIST)}
API_SERVICE_NOTE_LIST = [
 {'id':3, 
  ...
  'internalFlag':True, 
  'externalFlag':False, 
  '_info':{'lastUpdated':'2010-09-18T17:10:37Z', 
   'updatedBy':'helpdesk2'}}]
...
API_PROJECT_STATUSES = [
 {'id':1, 
  ...
  'noTimeFlag':False, 
  'closedFlag':False, 
  '_info':{'lastUpdated':'2001-01-08T18:05:13Z', 
   'updatedBy':None}},
 {'id':2, 
  'name':'Closed', 
  'defaultFlag':False, 
  ...
  'noTimeFlag':True, 
  'closedFlag':True, 
  '_info':{'lastUpdated':'2001-01-08T18:05:21Z', 
   'updatedBy':None}},
 {'id':3, 
  'name':'On-Hold', 
  'defaultFlag':False, 
  ...
  'noTimeFlag':True, 
  'closedFlag':False, 
  '_info':{'lastUpdated':'2001-01-08T18:05:40Z', 
   'updatedBy':None}},
 {'id':6, 
  'name':'>Closed', 
  'defaultFlag':False, 
  ...
  'noTimeFlag':True, 
  'closedFlag':True, 
  '_info':{'lastUpdated':'2017-08-30T19:25:43Z', 
   'updatedBy':'User1'}}]
API_PROJECT_TYPES = [
 {'id':6, 
  'name':'Network', 
 ...
 {'id':8, 
  ...
  '_info':{'lastUpdated':'2001-01-08T18:05:40Z', 
   'updatedBy':None}}]
API_PROJECT = {'id':5, 
 '_info':{'lastUpdated':'2005-05-27T17:30:19Z', 
  'updatedBy':'User10'}, 
 ...
 'contact':{'id':70, 
  'name':'Gregg Kegle', 
  '_info':{'contact_href': 'https://example.com/v4_6_release/apis/3.0/company/contacts/70'}}, 
 'customerPO':'', 
 'description':'\n', 
 'currency':{'id':7, 
  'symbol':'$', 
  'isoCode':'USD', 
  'name':'US Dollars', 
  '_info':{'currency_href': 'https://example.com/v4_6_release/apis/3.0/finance/currencies/7'}}, 
 'downpayment':0, 
 ...
 'shipToSite':{'id':28, 
  'name':'Main', 
  '_info':{'site_href': 'https://example.com/v4_6_release/apis/3.0/company/companies/24/sites/28'}}, 
 'site':{'id':28, 
  'name':'Main', 
  '_info':{'site_href': 'https://example.com/v4_6_release/apis/3.0/company/companies/24/sites/28'}}, 
...
API_PROJECT_LIST = [
 API_PROJECT]
API_PROJECT_PHASE = {'id':1, 
 'projectId':API_PROJECT['id'], 
 'description':'Project Management', 
 'board':{'id':3, 
  'name':'Windows', 
  '_info':{'board_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/service/boards/3'}}, 
 'status':{'id':1, 
  'name':'Open', 
  '_info':{'status_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/project/phaseStatuses/1'}}, 
 'wbsCode':'1', 
 'billTime':'Billable', 
 'billExpenses':'Billable', 
 'billProducts':'Billable', 
 ...
 'currency':{'id':7, 
  ...
  'isoCode':'USD', 
  'name':'US Dollars', 
  '_info':{'currency_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/finance/currencies/7'}}, 
 '_info':{'lastUpdated':'2005-05-26T14:39:26Z', 
  'updatedBy':'User10'}}
API_PROJECT_PHASE_LIST = [
 API_PROJECT_PHASE]
API_SERVICE_LOCATION = {'id':1, 
 'name':'On-Site', 
 'where':None, 
 'defaultFlag':True, 
 '_info':{'lastUpdated':'2001-06-05T16:53:55Z', 
  'updatedBy':'SumGuy'}}
API_SERVICE_LOCATION_LIST = [
 API_SERVICE_LOCATION]
API_SERVICE_PRIORITY = {'id':4, 
 'name':'Priority 3 - Normal Response', 
 'sortOrder':6, 
 'color':'blue', 
 '_info':{'priority_href':'https://example.com/v4_6_release/apis/3.0/service/priorities/4', 
  'image_href':'https://example.com/v4_6_release/apis/3.0/service/priorities/4/image?lm=2005-05-27T14:58:21Z'}}
API_SERVICE_PRIORITY_LIMITED = {'id':5, 
 'name':'Priority 2 - Quick Response'}
API_SERVICE_PRIORITY_LIST = [
 API_SERVICE_PRIORITY_LIMITED, API_SERVICE_PRIORITY]
API_SERVICE_TEAM_LIST = [
 {'_info':{'lastUpdated':'2017-02-14T18:21:15Z', 
   'updatedBy':'User1'}, 
  'boardId':1, 
  'businessUnitId':10, 
  'defaultFlag':True, 
 ...
 {'_info':{'lastUpdated':'2017-02-14T18:20:31Z', 
   'updatedBy':'User1'}, 
  'boardId':1, 
  'businessUnitId':10, 
  'defaultFlag':False, 
  ...
  'teamLeader':{'_info':{'member_href': 'https://example.com/v4_6_release/apis/3.0/system/members/186'}, 
   ...
   'identifier':'User10', 
   'name':'Training User10'}},
 {'_info':{'lastUpdated':'2017-02-14T18:20:13Z', 
   'updatedBy':'User1'}, 
  'boardId':1, 
  'businessUnitId':10, 
  'defaultFlag':False, 
...
API_SCHEDULE_HOLIDAY_LIST = {'id':1, 
 'name':'Standard Holiday List'}
API_SCHEDULE_HOLIDAY_LIST_LIST = [
 API_SCHEDULE_HOLIDAY_LIST]
API_SCHEDULE_HOLIDAY = {'id':1, 
...
API_SCHEDULE_HOLIDAY_MODEL_LIST = [
 API_SCHEDULE_HOLIDAY]
API_SCHEDULE_CALENDAR = {'id':1, 
 ...
 'sundayEndTime':None, 
 'holidayList':API_SCHEDULE_HOLIDAY_LIST}
API_SCHEDULE_CALENDAR_LIST = [
 API_SCHEDULE_CALENDAR]
API_SYSTEM_OTHER = {'id':1, 
 'defaultCalendar':API_SCHEDULE_CALENDAR}
API_SYSTEM_OTHER_LIST = [
 API_SYSTEM_OTHER]
API_SERVICE_SLA = {'id':3, 
 'name':'Standard SLA', 
 'defaultFlag':True, 
 'respondHours':5, 
 'planWithin':10, 
...
API_SERVICE_SLA_LIST = [
 API_SERVICE_SLA]
API_SERVICE_SLA_PRIORITY = {'id':5, 
 'sla':API_SERVICE_SLA, 
 'priority':API_SERVICE_PRIORITY, 
 'respondHours':5, 
 'planWithin':10, 
 'resolutionHours':24}
API_SERVICE_SLA_PRIORITY_LIST = [
...
API_TYPE = {'id':8, 
 ...
 'location':{'id':2, 
  'name':'Tampa Office', 
  '_info':{'location_href': 'https://example.com/v4_6_release/apis/3.0/system/locations/2'}}, 
 'department':{'id':13, 
  'identifier':'Admin', 
  'name':'Admin', 
  '_info':{'department_href': 'https://example.com/v4_6_release/apis/3.0/system/departments/13'}}, 
 '_info':{'lastUpdated':'2017-02-14T21:59:30Z', 
  'updatedBy':'User1'}}
API_TYPE_LIST = [
 API_TYPE]
API_SUBTYPE = {'id':1, 
 ...
 'typeAssociationIds':[
  ...
  31], 
 'board':API_BOARD, 
 '_info':{'lastUpdated':'2018-09-14T17:24:15Z', 
  'updatedBy':'User1'}}
API_SUBTYPE_LIST = [
 API_SUBTYPE]
API_ITEM = {'id':2, 
 ...
 'inactiveFlag':False, 
 'board':API_BOARD, 
 '_info':{'lastUpdated':'2018-09-14T17:29:23Z', 
  'updatedBy':'User1'}}
API_ITEM_LIST = [
 API_ITEM]
API_SERVICE_TICKET = {'id':69, 
 ...
 'status':{'id':1, 
  'name':'New', 
  '_info':{'status_href': 'https://example.com/v4_6_release/apis/3.0/service/boards/1/statuses/1'}}, 
 'wbsCode':'10.2', 
 'company':API_COMPANY, 
 'site':{'id':28, 
  'name':'Main', 
 ...
 'priority':API_SERVICE_PRIORITY, 
 'locationId':999, 
 'serviceLocation':{'id':API_SERVICE_LOCATION['id'], 
  'name':API_SERVICE_LOCATION['name']}, 
 'source':{'id':2, 
  'name':'Phone', 
  '_info':{'source_href': 'https://example.com/v4_6_release/apis/3.0/service/sources/2'}}, 
 ...
 'sla':API_SERVICE_SLA, 
 '_info':{'dateEntered':'2005-05-27T17:30:19Z', 
 ...
 'customFields':None}
API_SERVICE_TICKET_LIST = [
 API_SERVICE_TICKET]
API_SERVICE_TICKET_MAP = {t['id']:t for t in API_SERVICE_TICKET_LIST}
API_PROJECT_TICKET = {'id':47, 
 'summary':'Senior Engineer Project Planning', 
 'isIssueFlag':False, 
 'board':{'id':API_BOARD['id'], 
  'name':API_BOARD['name'], 
  '_info':{'board_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/service/boards/3'}}, 
 'status':{'id':1, 
  'name':'New', 
  '_info':{'status_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/service/boards/3/statuses/1'}}, 
 'project':API_PROJECT, 
 'phase':{'id':API_PROJECT_PHASE['id'], 
  'name':API_PROJECT_PHASE['description'], 
  '_info':{'phase_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/project/projects/4/phases/1'}}, 
 'wbsCode':'1.1', 
 'company':API_COMPANY, 
 'site':{'id':9, 
  'name':'Main', 
  '_info':{'site_href':'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/company/companies/10/sites/9', 
 ...
 'contact':{'id':26, 
  'name':'Gus Johnson', 
  '_info':{'mobileGuid':'c5221fb2-6d13-4a5b-80a1-c06d714fd93d', 
 ...
 'source':{'id':2, 
  'name':'Phone', 
  '_info':{'source_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/service/sources/2'}}, 
 'requiredDate':'2017-03-03T00:00:00Z', 
 'budgetHours':12.0, 
 'allowAllClientsPortalView':False, 
 'customerUpdatedFlag':False, 
 ...
 'location':{'id':2, 
  'name':'Tampa Office', 
  '_info':{'location_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/system/locations/2'}}, 
 'department':{'id':10, 
  'identifier':'Services', 
  'name':'Professional Services', 
  '_info':{'department_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/system/departments/10'}}, 
 ...
 'currency':{'id':7, 
  ...
  'name':'US Dollars', 
  '_info':{'currency_href': 'https://connectwise.kerkhofftech.ca/v4_6_release/apis/3.0/finance/currencies/7'}}, 
 '_info':{'lastUpdated':'2018-08-31T21:04:39Z', 
  'updatedBy':'kanban1', 
  'dateEntered':'2005-05-26T14:39:27Z', 
  'enteredBy':'User10'}}
API_PROJECT_TICKET_LIST = [
 API_PROJECT_TICKET]
API_CW_VERSION = {'version': 'v2.0'}
API_SYSTEM_CALLBACK_ENTRY = {'id':0, 
 ...
 '_info ':{'lastUpdated':'', 
  'updatedBy':''}}
API_SYSTEM_TERRITORY = {'id':1, 
 'name':'Some Territory'}
API_SYSTEM_TERRITORY_LIST = [
 API_SYSTEM_TERRITORY]
API_AGREEMENT = {'id':1, 
 'name':'Gold Rate', 
 'billTime':'Billable', 
 'company':{'id':API_COMPANY['id'], 
  'name':API_COMPANY['name'], 
  'identifier':API_COMPANY['identifier']}, 
 'cancelledFlag':False, 
 'type':{'id':5, 
  'name':'Block Time - One time', 
  '_info':{'type_href': 'https://cw.com/v4_6_release/apis/3.0/finance/agreements/types'}}, 
 'workRole':{'id':API_WORK_ROLE['id'], 
  'name':API_WORK_ROLE['name'], 
  '_info':{'workRole_href': 'https://cw.com/v4_6_release/apis/3.0/time/workRoles/18'}}, 
 'workType':{'id':API_WORK_TYPE['id'], 
  'name':API_WORK_TYPE['name'], 
  '_info':{'workType_href': 'https://cw.com/v4_6_release/apis/3.0/time/workTypes/3'}}, 
 'agreementStatus':'Active'}
API_AGREEMENT_LIST = [
 API_AGREEMENT]
API_SALES_OPPORTUNITY_TYPE = {'id':2, 
 'description':'Application Development', 
 'inactiveFlag':False, 
 '_info':{'lastUpdated':'2002-03-15T19:16:52Z', 
  'updatedBy':'Arnie'}}
API_SALES_OPPORTUNITY_TYPES = [
 API_SALES_OPPORTUNITY_TYPE]
API_SALES_PROBABILITY = {'id':5, 
 'probability':50, 
 '_info':{'lastUpdated':'2010-06-19T15:50:07Z', 
  'updatedBy':'abellini'}}
API_SALES_PROBABILITY_LIST = [
 API_SALES_PROBABILITY]
API_SALES_OPPORTUNITY_STATUSES = [
 {'_info':{'lastUpdated':'2000-12-28T19:35:17Z', 
   'updatedBy':None}, 
  'closedFlag':False, 
  ...
  'name':'Open', 
  'wonFlag':False},
 {'_info':{'lastUpdated':'2000-12-28T19:35:32Z', 
   'updatedBy':None}, 
  'closedFlag':True, 
  ...
  'name':'Won', 
  'wonFlag':True},
 {'_info':{'lastUpdated':'2000-12-28T19:35:50Z', 
   'updatedBy':None}, 
  'closedFlag':True, 
  ...
  'name':'Lost', 
  'wonFlag':False},
 {'_info':{'lastUpdated':'2003-10-06T14:48:18Z', 
   'updatedBy':'zAdmin'}, 
  'closedFlag':True, 
  ...
  'name':'No decision', 
  'wonFlag':False}]
API_SALES_OPPORTUNITY_STAGE = {'_info':None, 
 'id':8, 
 'name':'3.Quote'}
API_SALES_OPPORTUNITY_STAGES = [
...
API_SALES_OPPORTUNITY = {'_info':{'lastUpdated':'2016-10-12T19:24:07Z', 
  ...
  'updatedBy':'TaxUpdate'}, 
 'billToCompany':{'_info':{'company_href': 'https://example.com/v4_6_release/apis/3.0/company/companies/8'}, 
  'id':8, 
 ...
 'billToSite':{'_info':{'site_href': 'https://example.com/v4_6_release/apis/3.0/company/companies/8/sites/7'}, 
  'id':7, 
  'name':'Main'}, 
 'billingTerms':{'_info':None, 
  'id':2,  'name':'Net 10 days'}, 
 'businessUnitId':10, 
...
API_SALES_ACTIVITY_STATUSES = [
 {'id':1, 
  ...
  'inactiveFlag':False, 
  'closedFlag':False, 
  '_info':{'lastUpdated': '2000-12-28T22:34:26Z'}},
 {'id':2, 
  'name':'Closed', 
  'defaultFlag':False, 
  'inactiveFlag':False, 
  'closedFlag':True, 
  '_info':{'lastUpdated': '2000-12-28T22:34:35Z'}},
 {'id':8, 
  'name':'Opened', 
  'defaultFlag':False, 
  'inactiveFlag':False, 
  ...
  'closedFlag':False, 
  '_info':{'lastUpdated':'2016-05-11T00:31:06Z', 
   'updatedBy':'User1'}}]
API_SALES_ACTIVITY_TYPES = [
 {'id':1, 
  ...
  'memoFlag':False, 
  'historyFlag':False, 
  '_info':{'lastUpdated':'2003-10-31T18:52:58Z', 
   'updatedBy':'zAdmin'}},
 {'id':2, 
  'name':'Appointment', 
  'points':5, 
  ...
  'memoFlag':False, 
  'historyFlag':False, 
  '_info':{'lastUpdated':'2003-10-31T18:52:50Z', 
   'updatedBy':'zAdmin'}},
 {'id':3, 
  ...
  'memoFlag':False, 
  'historyFlag':True, 
  '_info':{'lastUpdated':'2003-10-31T18:53:45Z', 
   'updatedBy':'zAdmin'}},
 {'id':5, 
  'name':'Quote', 
  'points':5, 
  ...
  'memoFlag':False, 
  'historyFlag':False, 
  '_info':{'lastUpdated':'2003-10-31T18:54:17Z', 
   'updatedBy':'zAdmin'}},
 {'id':6, 
  'name':'Follow Up', 
  'points':1, 
  ...
  'memoFlag':False, 
  'historyFlag':False, 
  '_info':{'lastUpdated':'2003-10-31T18:53:31Z', 
   'updatedBy':'zAdmin'}},
 {'id':7, 
  'name':'Email', 
  'points':1, 
  ...
  'memoFlag':False, 
  'historyFlag':False, 
  '_info':{'lastUpdated':'2003-10-31T18:53:23Z', 
   'updatedBy':'zAdmin'}},
 {'id':8, 
  'name':'Task', 
  'points':1, 
  ...
  'memoFlag':False, 
  'historyFlag':False, 
  '_info':{'lastUpdated':'2003-10-31T18:54:27Z', 
   'updatedBy':'zAdmin'}}]
API_SALES_ACTIVITY = {'id':47, 
 'name':'Stage Change from 1.Prospect to 2.Qualification', 
 'type':API_SALES_ACTIVITY_TYPES[0], 
 'company':API_COMPANY, 
 'contact':{'id':20, 
  'name':'Flin Storts', 
  '_info':{'contact_href': 'https://example.com/v4_6_release/apis/3.0/company/contacts/20'}}, 
 ...
 'assignedBy':{'id':196, 
  ...
  '_info':{'member_href': 'https://example.com/v4_6_release/apis/3.0/system/members/196'}}, 
 'assignTo':API_MEMBER, 
 'scheduleStatus':{'id':1, 
  'name':'Tentative', 
  '_info':{'status_href': 'https://example.com/v4_6_release/apis/3.0/schedule/statuses/1'}}, 
 'reminder':{'id':1, 
  'name':'0 minutes', 
  '_info':None}, 
 'where':None, 
 '2015-11-30T19:53:52ZnotifyFlag':False, 
 'mobileGuid':'3a5828b8-a72c-4130-898b-b5aafbf98e46', 
 '_info':{'lastUpdated':'2017-08-04T20:05:52Z', 
  'updatedBy':'User1'}, 
 'customFields':None}
API_SALES_ACTIVITIES = [
 API_SALES_ACTIVITY]
API_COMPANY_INFO = {'CompanyName':'foobar', 
 'Codebase':'v2017_3/', 
 'VersionCode':'v2017.3', 
 'VersionNumber':'v4.6.47174', 
 'CompanyID':'CW', 
 'IsCloud':True}
API_SCHEDULE_SALES_TYPE = {'id':1, 
 'name':'Sales', 
 'identifier':'C', 
 'chargeCode':None, 
 'where':API_SERVICE_LOCATION, 
 'systemFlag':False, 
 '_info':{'lastUpdated':'2002-01-23T19:47:30Z', 
  'updatedBy':'JBelanger'}}
API_SCHEDULE_SERVICE_TYPE = {'id':4, 
 'name':'Service', 
 'identifier':'S', 
 'chargeCode':None, 
 'where':API_SERVICE_LOCATION, 
...
API_SCHEDULE_STATUS = {'id':2, 
 'name':'Firm', 
 'defaultFlag':True, 
 'showAsTentativeFlag':False, 
 '_info':{'lastUpdated':'2001-04-30T18:48:51Z', 
  'updatedBy':None}}
API_SCHEDULE_STATUS_LIST = [
 API_SCHEDULE_STATUS]
API_SCHEDULE_ENTRY_FOR_TICKET = {'id':11, 
 'objectId':69, 
 ...
 'hours':4, 
 '_info':{'lastUpdated':'2015-11-19T18:57:55Z', 
  'updatedBy':'kanban'}}
API_SCHEDULE_ENTRY_FOR_ACTIVITY = {'id':112, 
 'objectId':47, 
...
API_TIME_ENTRY = {'id':2, 
 ...
 'workType':{'id':3, 
  'name':'Regular', 
  '_info':{'workType_href': 'https://example.com/v4_6_release/apis/3.0/system/workTypes/3'}}, 
 'workRole':{'id':11, 
  'name':'System Engineer', 
  '_info':{'workRole_href': 'https://example.com/v4_6_release/apis/3.0/time/workRoles/11'}}, 
 'agreement':{'id':3, 
  'name':'Retainer Agreement for Big Design', 
  '_info':{'agreement_href': 'https://example.com/v4_6_release/apis/3.0/finance/agreements/3'}}, 
 ...
 'invoice':{'id':4, 
  'identifier':'3', 
  '_info':{'invoice_href': 'https://example.com/v4_6_release/apis/3.0/finance/invoices/4'}}, 
 'mobileGuid':'6fd34162-0856-4bc1-80ae-c3dccd89357a', 
 'hourlyRate':100, 
 'timeSheet':{'id':2, 
  'name':'2005-05-14 to 2005-05-20', 
  '_info':{'timeSheet_href': 'https://example.com/v4_6_release/apis/3.0/time/sheets/2'}}, 
 'status':'Billed', 
 '_info':{'lastUpdated':'2017-10-17T18:33:20Z', 
  'updatedBy':'CONVERSION', 
  'chargeToMobileGuid':'3b9552a5-e8ef-4a68-8124-bbd2c7baf112'}}
API_TIME_ENTRY_LIST = [
 API_TIME_ENTRY]
API_HOSTED_SCREENS = {'column_definitions':[
  {'Presenter_Identifier_Client_Api_RecID': {'type':'Numeric', 
                                             'isNullable':False, 
                                             'identityColumn':True}},
  {'Client_Api_ID': {'type':'Text', 
                     'isNullable':False, 
...
API_HOSTED_SETUPS = [
 {'id':2, 
  ...
  '_info':{'lastUpdated':'2017-01-27T05:44:04Z', 
   'updatedBy':'zadmin'}},
 {'id':4, 
  'screenId':5, 
  ...
  'disabledFlag':False, 
  'locationIds':[],  'locationsEnabledFlag':False, 
  'createdBy':'User1', 
  'dateCreated':'2019-02-20T20:31:30Z', 
  '_info':{'lastUpdated':'2019-04-10T23:42:24Z', 
   'updatedBy':'User1'}}]