...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-connectwise/djconnectwise/views.py
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not form.is_valid():
            ...
            if callback_type == self.CALLBACK_TICKET_TYPE:
                ...
                get_synchronizer, model_class = self.CALLBACK_TYPES[callback_type]
            ...
            try:
                ...
                logger.error('API call failed in model {} ID {} callback: {}'.format(model_class, entity_id, e))
...
class CallBackForm(forms.Form):
    ...
    callback_type = forms.ChoiceField(choices=[(c, c) for c in CallBackView.CALLBACK_TYPES.keys()])