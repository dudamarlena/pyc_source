...
# [GCC 8.4.0]
# Embedded file name: /Users/asyncee/projects/smtpdev/smtpdev/cli.py
# Compiled at: 2019-06-09 09:58:17
...
@click.option('--smtp-port',
  envvar='SMTPDEV_SMTP_PORT', default=2500, help='Smtp server port (default 2500).')
@click.option('--web-host',
  envvar='SMTPDEV_WEB_HOST',
  default='localhost',
  help='Web server host (default localhost).')
@click.option('--web-port',
  envvar='SMTPDEV_WEB_PORT', default=8080, help='Web server port (default 8080).')
@click.option('--develop',
...
def main(smtp_host, smtp_port, web_host, web_port, develop, debug, maildir):
    ...
    with dir_context() as (maildir_path):
        ...
        config = Configuration(smtp_host=smtp_host,
          smtp_port=smtp_port,
          web_host=web_host,
          web_port=web_port,
          develop=develop,
