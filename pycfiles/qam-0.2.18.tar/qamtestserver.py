...
# [GCC 8.4.0]
# Embedded file name: /home/karin/Desktop/development/qam/tests/qamtestserver.py
# Compiled at: 2009-10-27 10:49:54
import time
...
class QAMTestServer(Thread):
    ...
    def __init__(self, server_id, serializer='pickle'):
        ...
        print 'before create'
        self.server = QAMServer(hostname='localhost', port=5672, username='guest', password='guest', vhost='/', server_id=server_id, serializer=serializer, ssl=False)
        print 'after create'
