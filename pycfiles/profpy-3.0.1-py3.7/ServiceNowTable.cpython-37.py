...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/profpy/apis/ServiceNowTable.py
...
class ServiceNowTable(Api):
    ...
    def _set_endpoints(self):
        ...
        """
        self.endpoints = [
         self.GET_SINGLE_RECORD, self.GET_RECORDS]
    ...
    def _set_args_mapping(self):
        ...
        :return:
        """
        self.endpoint_to_args = {self.GET_RECORDS: [
                            'tableName',
                            'sysparm_query',
            ...
            if r_type == 'GET':
                ...
                if 300 >= status >= 200:
                    try:
                        ...
                        raise ApiException('Transaction cancelled: maximum execution time exceeded.',
                          error_code=408)
    ...
    def get_record(self, table_name, record_id, custom_id_field=None, **kwargs):
        ...
        if custom_id_field:
            ...
            valid_args = self.endpoint_to_args[endpoint]
            endpoint = endpoint.format(get_table_name=table_name,
              get_record_id=record_id)
    ...
    def load_table(self, table_name, limit=None, **kwargs):
        ...
        if 'sysparm_limit' in kwargs or 'sysparm_offset' in kwargs:
            raise ParameterException('ServiceNowTable.load_table method does not allow the use of "sysparm_limit" or "sysparm_offset" query parameters.')
        keep_going = True
        ...
        if len(results) >= request_size_limit:
            ...
            while keep_going:
                params = {**kwargs, **(dict(sysparm_offset=current_offset,
                  sysparm_limit=request_size_limit))}
