...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/lazo_index/client.py
# Compiled at: 2019-06-10 11:40:27
# Size of source mod 2**32: 2668 bytes
import grpc, os
from lazo_index.lazo_index_pb2 import ColumnIdentifier, ColumnValue, Value
from lazo_index.lazo_index_pb2_grpc import LazoIndexStub
...
class LazoIndexClient:
    ...
    def make_column_value(value, dataset_id, column_name):
        return ColumnValue(value=value,
          column_identifier=ColumnIdentifier(dataset_id=dataset_id,
    ...
    def index_data(self, column_values, dataset_id, column_name):
        ...
        """
        lazo_sketch_data = self.stub.IndexData(self.generate_stream_column_value(column_values, dataset_id, column_name))
        return (
    ...
    def query_data(self, column_values):
        ...
        """
        lazo_query_results = self.stub.QueryData(self.generate_stream_value(column_values))
        results = []
