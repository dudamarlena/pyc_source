...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/helium/helium-client-python/helium_client/_version.py
...
def get_config():
    ...
    cfg.style = 'pep440'
    cfg.tag_prefix = ''
    cfg.parentdir_prefix = 'helium-client-python'
    cfg.versionfile_source = 'helium_client/_version.py'
    cfg.verbose = False
    return cfg
