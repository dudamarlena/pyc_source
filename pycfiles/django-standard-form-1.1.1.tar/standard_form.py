...
# [GCC 8.4.0]
# Embedded file name: /Users/aleskocjancic/Sites/django-standard-form/standard_form/templatetags/standard_form.py
# Compiled at: 2013-03-21 05:28:14
...
def get_options(args):
    ...
    if args:
        args = args.split(' ')
        options = {'placeholder_from_label': 'placeholder_from_label' in args, 
...
class StandardWidget(Tag):
    ...
    options = Options(Argument('field'), Argument('options', required=False, default=None), KeywordArgument('custom_class', required=False, default=None), KeywordArgument('placeholder', required=False, default=None), KeywordArgument('input_type', required=False, default=None))
    ...
    def render_tag(self, context, field, options, custom_class, placeholder, input_type):
        ...
        if placeholder:
            ...
            if args.get('placeholder_from_label', False):
...
class StandardField(Tag):
    name = 'standard_field'
    options = Options(Argument('field'), Argument('options', required=False, default=None), KeywordArgument('custom_class', required=False, default=None), KeywordArgument('placeholder', required=False, default=None), KeywordArgument('label', required=False, default=None), KeywordArgument('input_type', required=False, default=None), 'using', Argument('template', required=False, default='standard_form/field.html'))
...
class StandardForm(Tag):
    name = 'standard_form'
    options = Options(Argument('form'), Argument('options', required=False, default=None), KeywordArgument('custom_class', required=False, default=None), 'using', Argument('template', required=False, default='standard_form/form.html'))
