...
# Embedded file name: build/bdist.macosx-10.5-i386/egg/pyncomb/ksubsetrevdoortest.py
# Compiled at: 2010-10-16 14:05:36
__doc__ = 'Unit testing for the ksubsetrevdoor module.\n\nBy Sebastian Raaphorst, 2009.'
import unittest
...
class Tester(unittest.TestCase):
    ...
    def testall(self):
        ...
        rk = 0
        for K in ksubsetrevdoor.all(self.B, self.k):
            self.assertEqual(ksubsetrevdoor.rank(self.B, K), rk)
            self.assertEqual(ksubsetrevdoor.unrank(self.B, self.k, rk), K)
            rk += 1
