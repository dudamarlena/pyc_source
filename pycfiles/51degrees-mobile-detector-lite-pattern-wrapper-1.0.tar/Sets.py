...
# Embedded file name: \Ft\Xml\Xslt\Exslt\Sets.py
# Compiled at: 2004-12-10 17:06:10
...
ExtNamespaces = {EXSL_SETS_NS: 'set'}
ExtFunctions = {(EXSL_SETS_NS, 'difference'): Difference, (EXSL_SETS_NS, 'distinct'): Distinct, (EXSL_SETS_NS, 'has-same-node'): HasSameNode, (EXSL_SETS_NS, 'intersection'): Intersection, (EXSL_SETS_NS, 'leading'): Leading, (EXSL_SETS_NS, 'trailing'): Trailing}
ExtElements = {}