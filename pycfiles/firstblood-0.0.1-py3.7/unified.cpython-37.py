...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/firstblood/unifiedIO/unified.py
# Compiled at: 2018-10-28 13:45:36
# Size of source mod 2**32: 9290 bytes
import io, os, functools as fn
...
class Unified(object):
    ...
    until = readuntil
    before = _chainWrapper(fn.partial(readuntil, keep=False, drop=False),
      name='Unified.before')
    after = _chainWrapper(fn.partial(readuntil, keep=False, drop=True),
      name='Unified.after')
