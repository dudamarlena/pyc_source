...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/firstblood/patches/iterable.py
# Compiled at: 2018-10-28 15:40:16
# Size of source mod 2**32: 6714 bytes
import itertools as it, functools as fn
...
def addMethods():
    ...
    Strs.add(str)
    Sequences = getAllSubclasses(abc.Sequence, blacklist)
    Iterables = getAllSubclasses(abc.Iterable, blacklist)
    Reversibles = getAllSubclasses(abc.Reversible, blacklist)
    for t in Iterables - Strs:
        ...
        patch(t, 'combinations_with_replacement', fn.partialmethod(it.combinations_with_replacement))
    ...
    for t in Strs:
        ...
        patch(t, 'combinations_with_replacement', wrapjoin((it.combinations_with_replacement), flatten=False))
