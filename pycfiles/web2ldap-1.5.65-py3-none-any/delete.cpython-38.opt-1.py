...
# Compiled at: 2020-04-23 16:54:13
# Size of source mod 2**32: 17248 bytes
"""
...
def w2l_delete(app):
    ...
    if delete_confirm != 'yes':
        ...
        return
    conn_server_ctrls = {server_ctrl.controlType for server_ctrl in app.ls.l._req_ctrls['**all**'] + app.ls.l._req_ctrls['**write**'] + app.ls.l._req_ctrls['delete']}
