...
# Compiled at: 2020-04-26 10:16:58
# Size of source mod 2**32: 87958 bytes
"""
...
class OID(IA5String):
 ...
 L.1241         0  SETUP_FINALLY        22  'to 22'

 L.1242         2  LOAD_GLOBAL              OID_REG
                4  LOAD_FAST                'self'
                6  LOAD_ATTR                av_u
                8  BINARY_SUBSCR    
 ...
 L.1244        40  SETUP_FINALLY        66  'to 66'

 L.1245        42  LOAD_FAST                'self'
               44  LOAD_ATTR                _schema
               46  LOAD_ATTR                get_obj

 L.1246        48  LOAD_GLOBAL              ObjectClass

 L.1247        50  LOAD_FAST                'self'
               52  LOAD_ATTR                av_u

 L.1248        54  LOAD_CONST               1

 L.1245        56  LOAD_CONST               ('raise_keyerror',)
 ...
 L.1251        80  SETUP_FINALLY       106  'to 106'

 L.1252        82  LOAD_FAST                'self'
               84  LOAD_ATTR                _schema
               86  LOAD_ATTR                get_obj

 L.1253        88  LOAD_GLOBAL              AttributeType

 L.1254        90  LOAD_FAST                'self'
               92  LOAD_ATTR                av_u

 L.1255        94  LOAD_CONST               1

 L.1252        96  LOAD_CONST               ('raise_keyerror',)
 ...
 L.1258       120  LOAD_GLOBAL              IA5String
 ...
 L.1259       148  LOAD_GLOBAL              schema_anchor

 L.1260       150  LOAD_FAST                'self'
              152  LOAD_ATTR                _app

 L.1261       154  LOAD_FAST                'self'
              156  LOAD_ATTR                av_u

 L.1262       158  LOAD_GLOBAL              AttributeType

 L.1263       160  LOAD_STR                 '{name}\n{anchor}'

 L.1264       162  LOAD_STR                 '&raquo'

 L.1259       164  LOAD_CONST               ('name_template', 'link_text')
 ...
 L.1271       216  LOAD_GLOBAL              schema_anchor

 L.1272       218  LOAD_FAST                'self'
              220  LOAD_ATTR                _app

 L.1273       222  LOAD_FAST                'self'
              224  LOAD_ATTR                av_u

 L.1274       226  LOAD_GLOBAL              ObjectClass

 L.1275       228  LOAD_FAST                'name_template'

 L.1276       230  LOAD_STR                 '&raquo'

 L.1271       232  LOAD_CONST               ('name_template', 'link_text')
 ...
 L.1278       244  LOAD_STR                 '<strong>%s</strong> (%s):<br>%s (see %s)'

 L.1279       246  LOAD_FAST                'self'
              248  LOAD_ATTR                _app
              250  LOAD_ATTR                form
 ...
 L.1280       258  LOAD_GLOBAL              IA5String
...
class SecondsSinceEpoch(Integer):
 ...
 L.1678        14  SETUP_FINALLY        52  'to 52'

 L.1679        16  LOAD_STR                 '%s (%s)'

 L.1680        18  LOAD_GLOBAL              strftimeiso8601
               20  LOAD_GLOBAL              time
 ...
 L.1681        42  LOAD_FAST                'int_str'

 L.1679        44  BUILD_TUPLE_2         2 
               46  BINARY_MODULO    
               48  POP_BLOCK        
               50  RETURN_VALUE     
...
class DaysSinceEpoch(Integer):
 ...
 L.1697        14  SETUP_FINALLY        50  'to 50'

 L.1698        16  LOAD_STR                 '%s (%s)'

 L.1699        18  LOAD_GLOBAL              strftimeiso8601
               20  LOAD_GLOBAL              time
               22  LOAD_METHOD              gmtime
               24  LOAD_GLOBAL              float
               26  LOAD_FAST                'self'
 ...
 L.1700        40  LOAD_FAST                'int_str'

 L.1698        42  BUILD_TUPLE_2         2 
               44  BINARY_MODULO    
               46  POP_BLOCK        
               48  RETURN_VALUE     
...
class DynamicValueSelectList(SelectList, DirectoryString):
 ...
 L.1921        18  LOAD_FAST                'av_u'
               20  LOAD_METHOD              startswith
               22  LOAD_FAST                'self'
               24  LOAD_ATTR                valuePrefix
               26  CALL_METHOD_1         1  ''

 L.1920        28  POP_JUMP_IF_FALSE    80  'to 80'

 L.1922        30  LOAD_FAST                'av_u'
               32  LOAD_METHOD              endswith
               34  LOAD_FAST                'self'
               36  LOAD_ATTR                valueSuffix
               38  CALL_METHOD_1         1  ''

 L.1920        40  POP_JUMP_IF_FALSE    80  'to 80'

 L.1923        42  LOAD_GLOBAL              len
               44  LOAD_FAST                'av_u'
 ...
 L.1920        54  POP_JUMP_IF_TRUE     80  'to 80'

 L.1924        56  LOAD_FAST                'self'
               58  LOAD_ATTR                maxLen
               60  LOAD_CONST               None
               62  COMPARE_OP               is-not

 L.1920        64  POP_JUMP_IF_FALSE    84  'to 84'

 L.1924        66  LOAD_GLOBAL              len
               68  LOAD_FAST                'av_u'
