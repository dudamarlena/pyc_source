...
# Size of source mod 2**32: 61578 bytes
"""
        ...
        if clearReverse:
            ...
            if symbolHolding:
                if symbolHolding['available'] > 0:
                    ...
                    clearShortOrderRes = (cls.clearShort)(symbol_, vol1_, 'cshort', dt, orderType=orderType, **kwargs)
        ...
        if clearReverse:
            ...
            if symbolHolding:
                if symbolHolding['available'] > 0:
                    ...
                    clearLongOrderRes = (cls.clearLong)(symbol_, vol1_, 'clong', dt, orderType=orderType, **kwargs)
        orderLog = kwargs.get('orderLog', None)
        if orderType == 2:
            price = 0
            if cls.aOrderConrolOBj is not None:
