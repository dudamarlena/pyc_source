...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/halicea/baseProject/controllers/cmsControllers.py
# Compiled at: 2012-01-05 21:39:42
import yaml
...
class CMSContentController(CMSBaseController):
    ...
    def edit(self, key=None, *args):
        ...
        if key:
            ...
            self.ContentForm = CMSContentForm(initial={'Title': cmsContent.Title, 'Content': cmsContent.HTMLContent, 
