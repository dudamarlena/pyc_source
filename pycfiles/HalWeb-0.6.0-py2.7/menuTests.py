...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/halicea/baseProject/tests/cms/menuTests.py
# Compiled at: 2012-01-05 03:35:16
...
class MenuControllerTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.req = webapp.Request({'wsgi.input': StringIO(), 
