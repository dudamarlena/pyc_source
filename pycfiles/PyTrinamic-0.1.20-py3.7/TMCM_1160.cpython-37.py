...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\PyTrinamic\modules\TMCM_1160.py
# Compiled at: 2020-02-03 09:24:55
...
class TMCM_1160:
    ...
    def __init__(self, connection):
        ...
        self.ENUMs = _ENUMs
        self.MOTORS = 1
        self._TMCM_1160__default_motor = 0
    ...
    def getAxisParameter(self, apType):
        return self.connection.axisParameter(apType, self._TMCM_1160__default_motor)

    def setAxisParameter(self, apType, value):
        self.connection.setAxisParameter(apType, self._TMCM_1160__default_motor, value)
