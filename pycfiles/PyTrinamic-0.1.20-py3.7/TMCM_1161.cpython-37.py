...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\PyTrinamic\modules\TMCM_1161.py
# Compiled at: 2020-02-03 09:18:48
# Size of source mod 2**32: 8307 bytes
"""
...
class TMCM_1161:
    ...
    def __init__(self, connection):
        ...
        self.ENUMs = _ENUMs
        self.MOTORS = 1
        self._TMCM_1161__default_motor = 0
    ...
    def getAxisParameter(self, apType):
        return self.connection.axisParameter(apType, self._TMCM_1161__default_motor)

    def setAxisParameter(self, apType, value):
        self.connection.setAxisParameter(apType, self._TMCM_1161__default_motor, value)
