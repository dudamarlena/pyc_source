...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\PyTrinamic\modules\TMCM_1670.py
# Compiled at: 2020-02-03 08:54:49
...
class TMCM_1670:
    ...
    def __init__(self, connection):
        ...
        self.ENUMs = _ENUMs
        self.MOTORS = 1
        self._TMCM_1670__default_motor = 0
    ...
    def axisParameter(self, apType):
        return self.connection.axisParameter(apType, self._TMCM_1670__default_motor)

    def setAxisParameter(self, apType, value):
        self.connection.setAxisParameter(apType, self._TMCM_1670__default_motor, value)
