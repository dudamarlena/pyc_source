...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\PyTrinamic\ic\TMC5161\TMC5161_fields.py
# Compiled at: 2020-01-30 03:08:29
# Size of source mod 2**32: 34857 bytes
"""
...
class TMC5161_fields(object):
    ...
    REFL_STEP = (4, 1, 0)
    REFR_DIR = (4, 2, 1)
    ENCB_DCEN_CFG4 = (4, 4, 2)
    ENCA_DCIN_CFG5 = (4, 8, 3)
    DRV_ENN_CFG6 = (4, 16, 4)
    ENC_N_DCO = (4, 32, 5)
    SD_MODE = (4, 64, 6)
    SWCOMP_IN = (4, 128, 7)
    ...
    N_EVENT = (59, 1, 0)
    DEVIATION_WARN = (59, 2, 1)
    ENC_LATCH = (60, 4294967295, 0)
    ENC_DEVIATION = (61, 1048575, 0)
    OFS0 = (96, 1, 0)
    OFS1 = (96, 2, 1)
    OFS2 = (96, 4, 2)
    OFS3 = (96, 8, 3)
