...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\PyTrinamic\modules\TMCM_1270.py
# Compiled at: 2020-02-03 09:18:00
...
class TMCM_1270:
    ...
    def __init__(self, connection):
        ...
        self.ENUMs = _ENUMs
        self.MOTORS = 1
        self._TMCM_1270__default_motor = 0
    ...
    def getAxisParameter(self, apType):
        return self.connection.axisParameter(apType, self._TMCM_1270__default_motor)

    def setAxisParameter(self, apType, value):
        self.connection.setAxisParameter(apType, self._TMCM_1270__default_motor, value)
    ...
    def moveTo(self, position, velocity=None):
        ...
        self.connection.move(0, self._TMCM_1270__default_motor, position)
