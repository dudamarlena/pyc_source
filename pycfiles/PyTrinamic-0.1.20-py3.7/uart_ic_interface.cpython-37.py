...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\PyTrinamic\connections\uart_ic_interface.py
# Compiled at: 2019-11-06 05:00:00
...
import PyTrinamic.connections.connection_interface as connection_interface
...
class uart_ic_interface(connection_interface):
    ...
    def writeRegister(self, registerAddress, value):
        return self.send(registerAddress | 128, value)
