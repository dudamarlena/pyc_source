...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tones/mixer.py
# Compiled at: 2018-11-18 03:32:32
import math, wave, tones
...
class Track(object):
    ...
    def __init__(self, wavetype=tones.SINE_WAVE, attack=None, decay=None, vibrato_frequency=None, vibrato_variance=15.0):
        """
        Initializes a Track

        :param int wavetype: initial wavetype setting for this track
        :param float attack: initial tone attack for this track, to applied to             each set of samples generated by 'append_samples'
        :param float decay: initial tone decay for this track, to applied to             each set of samples generated by 'append_samples'
...
class Mixer(object):
    ...
    def add_tone(self, trackname, frequency=440.0, duration=1.0, endfrequency=None, attack=None, decay=None, amplitude=1.0, vibrato_frequency=None, vibrato_variance=None):
        """
        ...
        :param float attack: tone attack in seconds. Overrides the track's             attack setting
        :param float decay: tone decay in seconds. Overrides the track's             decay setting
        :param float vibrato_frequency: tone vibrato frequency in Hz. Overrides            the track's vibrato frequency setting
        :param float vibrato_variance: tone vibrato variance in Hz. Overrides            the track's vibrato variance setting
        ...
        samples, track._phase, track._vphase = tone.samples(numsamples, frequency, endfrequency, attack, decay, track._phase, track._vphase, vibrato_frequency, vibrato_variance)
        track.append_samples(samples)

    def add_note(self, trackname, note='a', octave=4, duration=1.0, endnote=None, endoctave=None, attack=None, decay=None, amplitude=1.0, vibrato_frequency=None, vibrato_variance=None):
        """
        Same as 'add_tone', except the pitch can be specified as a standard
        musical note, e.g. "c#"

        :param trackname: track identifier, track to add tone to
        :param str note: musical note. Must be a single character from a-g             (non case-sensitive), followed by an optional sharp ('#') or flat             ('b') character
        :param str endnote: If not None, the tone frequency will change             between 'note' and 'endnote' in increments of 1ms over             all samples
        ...
        self.add_tone(trackname, freq, duration, endfreq, attack, decay, amplitude, vibrato_frequency, vibrato_variance)
        return
    ...
    def add_tones(self, tonelist):
        ...
        :param tonelist: list of tuples, where each tuple contains arguments             for a single Mixer.add_tone invocation
        """
    ...
    def add_notes(self, trackname, notelist):
        ...
        :param trackname: track identifier
        :param notelist: list of tuples, where each tuple contains arguments             for a single Mixer.add_note invocation
        """
