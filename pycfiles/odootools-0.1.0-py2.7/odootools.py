...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/odootools/odootools.py
# Compiled at: 2017-02-25 18:56:06
...
class DateTime(Date):
    ...
    def _apply(self, days=None, day=None, months=None, month=None, years=None, year=None, seconds=None, second=None, minutes=None, minute=None, hours=None, hour=None):
