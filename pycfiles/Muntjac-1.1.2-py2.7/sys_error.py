...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/terminal/sys_error.py
...
class SysError(RuntimeError, IErrorMessage):
    ...
    def paint(self, target):
        ...
        target.addXMLSection('div', message, 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd')
        target.endTag('error')
    ...
    def getHtmlMessage(self):
        ...
        if self._cause is not None:
            ...
            traceback.print_exception(exc_type, self._cause, exc_traceback, file=buff)
            sb.write('<pre>')
            pre = buff.getvalue()
