...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/invient/gradient.py
...
class LinearGradient(IGradient):
    ...
    def __init__(self, xStart, xStartUnit_or_yStart, yStart_or_xEnd, yStartUnit_or_yEnd, xEnd_or_colorStops, xEndUnit=None, yEnd=None, yEndUnit=None, colorStops=None):
        ...
        if xEndUnit is None:
            xStart, yStart, xEnd, yEnd, colorStops = (
             xStart,
             xStartUnit_or_yStart, yStart_or_xEnd, yStartUnit_or_yEnd,
             xEnd_or_colorStops)
        else:
            xStartUnit, yStart, yStartUnit, xEnd, xEndUnit, yEnd, yEndUnit, colorStops = (
             xStartUnit_or_yStart, yStart_or_xEnd,
    ...
    def getString(self):
        ...
        for colorStop in self._colorStops:
            if colorStop.getColor() is not None:
                stopAt = "'" + str(colorStop.getStopAt()) + colorStop.getStopAtUnit().getSymbol() + "'"
