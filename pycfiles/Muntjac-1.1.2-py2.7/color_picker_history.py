...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/colorpicker/color_picker_history.py
...
class ColorPickerHistory(CustomComponent, IColorSelector, IColorChangeListener):
    ...
    def addCallback(self, callback, eventType=None, *args):
        ...
        if issubclass(eventType, ColorChangeEvent):
            ...
            super(ColorPickerHistory, self).addCallback(callback, eventType, *args)
        return
