...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/invient/color.py
...
class RGB(Color):
    ...
    def __init__(self, red, green, blue):
        ...
        if hasError:
            raise ValueError('Color parameter outside of expected range:' + errorCompString)
        self._red = red
        self._green = green
        self._blue = blue
    ...
    def __str__(self):
        """@return: Returns string representation of this RBG."""
        return 'RGB [red=' + str(self._red) + ', green=' + str(self._green) + ', blue=' + str(self._blue) + ']'
...
class RGBA(RGB):
    ...
    def __str__(self):
        """@return: Returns string representation of this RGBA"""
        return 'RGBA [alpha=' + str(self._alpha) + ', red=' + str(self.getRed()) + ', green=' + str(self.getGreen()) + ', blue=' + str(self.getBlue()) + ']'