...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/accordions/AccordionDisabledExample.py
# Compiled at: 2013-04-04 15:36:38
from muntjac.terminal.theme_resource import ThemeResource
from muntjac.api import VerticalLayout, HorizontalLayout, Label, Accordion, Button
from muntjac.ui import tab_sheet, button

class AccordionDisabledExample(VerticalLayout, tab_sheet.ISelectedTabChangeListener, button.IClickListener):
