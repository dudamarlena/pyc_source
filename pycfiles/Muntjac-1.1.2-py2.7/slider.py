...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/slider.py
...
class Slider(AbstractField):
    ...
    def changeVariables(self, source, variables):
        ...
        if 'value' in variables:
            ...
            if newValue is not None and newValue != self.getValue() and newValue != self.getValue():
                try:
                    self.setValue(newValue, True)
                except ValueOutOfBoundsException as e:
