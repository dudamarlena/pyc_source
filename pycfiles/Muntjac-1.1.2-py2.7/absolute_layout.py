...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/absolute_layout.py
...
from muntjac.event.layout_events import LayoutClickEvent, ILayoutClickListener, ILayoutClickNotifier
...
class AbsoluteLayout(AbstractLayout, ILayoutClickNotifier):
    ...
    def getPosition(self, component):
        ...
        if component.getParent() != self:
            ...
            if component in self._componentToCoordinates:
