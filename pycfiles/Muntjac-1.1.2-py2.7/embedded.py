...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/embedded.py
...
class Embedded(AbstractComponent):
    ...
    def paintContent(self, target):
        ...
        if self._type == self.TYPE_IMAGE:
            ...
            if self._type == self.TYPE_BROWSER:
    ...
    def setCodebase(self, codebase):
        ...
        @param codebase:
                   The base path
        """
        if codebase != self._codebase or codebase is not None and codebase != self._codebase:
    ...
    def setCodetype(self, codetype):
        ...
        @param codetype:
                   the codetype to set.
        """
        if codetype != self._codetype or codetype is not None and codetype != self._codetype:
    ...
    def setMimeType(self, mimeType):
        ...
        """
        if mimeType != self._mimeType or mimeType is not None and mimeType != self._mimeType:
    ...
    def setStandby(self, standby):
        ...
        """
        if standby != self._standby or standby is not None and standby != self._standby:
    ...
    def setClassId(self, classId):
        ...
        @param classId:
                   the classId to set.
        """
        if classId != self._classId or classId is not None and classId != self._classId:
    ...
    def setType(self, typ):
        ...
        """
        if typ != self.TYPE_OBJECT and typ != self.TYPE_IMAGE and typ != self.TYPE_BROWSER:
    ...
    def setArchive(self, archive):
        ...
        @param archive:
                   ...
                   the object
        """
        if archive != self._archive or archive is not None and archive != self._archive:
