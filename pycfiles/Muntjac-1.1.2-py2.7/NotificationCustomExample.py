...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/notifications/NotificationCustomExample.py
# Compiled at: 2013-04-04 15:36:38
from muntjac.api import VerticalLayout, TextField, RichTextArea, HorizontalLayout, NativeSelect, Slider, Button, Alignment
...
class ShowListener(IClickListener):
    ...
    def buttonClick(self, event):
        n = Notification(self._caption.getValue(), self._description.getValue(), self._style.getValue())
        n.setPosition(self._position.getValue())
        d = self._delay.getValue()
        n.setDelayMsec(int(d))
