...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/windows/SubwindowModal.py
...
class SubwindowModal(Feature):
    ...
    def getRelatedResources(self):
        return [
         NamedExternalResource('Wikipedia: Modal window', 'http://en.wikipedia.org/wiki/Modal_window')]