...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/component/abstract_ordered_layout_listeners.py
...
class TestAbstractOrderedLayoutListeners(AbstractListenerMethodsTest):
    ...
    def testLayoutClickListenerAddGetRemove(self):
        self._testListenerAddGetRemove(VerticalLayout, LayoutClickEvent, ILayoutClickListener)