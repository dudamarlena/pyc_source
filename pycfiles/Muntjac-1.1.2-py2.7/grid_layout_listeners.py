...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/component/grid_layout_listeners.py
...
class GridLayoutListeners(AbstractListenerMethodsTest):
    ...
    def testLayoutClickListenerAddGetRemove(self):
        self._testListenerAddGetRemove(GridLayout, LayoutClickEvent, ILayoutClickListener)