...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/popup_view.py
...
class PopupView(AbstractComponentContainer):
    ...
    def getComponentCount(self):
        ...
        """
        if self._visibleComponent is not None:
            return 1
        else:
            return 0
    ...
    def addListener(self, listener, iface=None):
        ...
        """
        if isinstance(listener, IPopupVisibilityListener) and (iface is None or issubclass(iface, IPopupVisibilityListener)):
            self.registerListener(PopupVisibilityEvent, listener, _POPUP_VISIBILITY_METHOD)
    ...
    def removeListener(self, listener, iface=None):
        ...
        """
        if isinstance(listener, IPopupVisibilityListener) and (iface is None or issubclass(iface, IPopupVisibilityListener)):
            self.withdrawListener(PopupVisibilityEvent, listener, _POPUP_VISIBILITY_METHOD)
