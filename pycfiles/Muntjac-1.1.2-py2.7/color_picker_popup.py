...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/colorpicker/color_picker_popup.py
...
from muntjac.addon.colorpicker.color_picker import ICoordinates2Color, IColorChangeListener
...
class ColorPickerPopup(Window, IClickListener, IColorChangeListener, IColorSelector):
    ...
    def calculateHeight(self):
        ...
        return str(historyHeight + tabsHeight + contentHeight + buttonsHeight + previewHeight + 10) + 'px'
    ...
    def createRGBTab(self, color):
        ...
        self._redSlider.addListener(RedValueChangeListener(self), IValueChangeListener)
        ...
        self._greenSlider.addListener(GreenValueChangeListener(self), IValueChangeListener)
        ...
        self._blueSlider.addListener(BlueValueChangeListener(self), IValueChangeListener)
    ...
    def createHSVTab(self, color):
        ...
        self._hsvGradient = ColorPickerGradient('hsv-gradient', HSVConverter(self))
        ...
        self._hueSlider.addListener(HueValueChangeListener(self), IColorChangeListener)
        ...
        self._saturationSlider.addListener(SaturationValueChangeListener(self), IColorChangeListener)
        ...
        self._valueSlider.addListener(BrightnessValueChangeListener(self), IColorChangeListener)
    ...
    def colorChanged(self, event):
        ...
        for s in self._selectors:
            if event.getSource() != s and s is not self and s.getColor() != self._selectedColor:
    ...
    def addCallback(self, callback, eventType=None, *args):
        ...
        if issubclass(eventType, ColorChangeEvent):
            ...
            super(ColorPickerPopup, self).addCallback(callback, eventType, *args)
        return
...
class RedValueChangeListener(_ColorValueChangeListener):
    ...
    def valueChange(self, event):
        ...
        newColor = Color(int(red), self._cpp._selectedColor.getGreen(), self._cpp._selectedColor.getBlue())
...
class GreenValueChangeListener(_ColorValueChangeListener):
    ...
    def valueChange(self, event):
        ...
        newColor = Color(self._cpp._selectedColor.getRed(), int(green), self._cpp._selectedColor.getBlue())
        self._cpp.setColor(newColor)
...
class BlueValueChangeListener(_ColorValueChangeListener):
    ...
    def valueChange(self, event):
        ...
        newColor = Color(self._cpp._selectedColor.getRed(), self._cpp._selectedColor.getGreen(), int(blue))
        self._cpp.setColor(newColor)
