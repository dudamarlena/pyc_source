...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/canvas/canvas.py
...
class Canvas(AbstractComponent):
    ...
    def drawImage(self, *args):
        ...
        if nargs == 3:
            ...
            url, sourceX, sourceY, sourceWidth, sourceHeight, destX, destY, destWidth, destHeight = args
            arguments = dict()
    ...
    def addListener(self, listener, iface=None):
        ...
        elif listener not in self._upListeners:
    ...
    def removeListener(self, listener, iface=None):
        ...
        elif listener in self._upListeners:
