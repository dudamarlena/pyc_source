...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/table/TableColumnHeaders.py
...
class TableColumnHeaders(Feature):
    ...
    def getDescription(self):
        return 'A Table can have column headers, which support different modes with automatic or explicitly set caption and/or icon.'
