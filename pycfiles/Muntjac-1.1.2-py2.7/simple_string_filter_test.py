...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/data/util/filter/simple_string_filter_test.py
# Compiled at: 2013-04-04 15:36:37
from muntjac.test.server.data.util.filter.abstract_filter_test import AbstractFilterTest, TestItem, NullProperty
...
class SimpleStringFilterTest(AbstractFilterTest):
    ...
    def testNullValueForProperty(self):
        ...
        self.assertFalse(self.f('other1', 'ab', False, True).passesFilter(None, item))
        return