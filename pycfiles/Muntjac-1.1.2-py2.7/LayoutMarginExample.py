...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/layouts/LayoutMarginExample.py
...
class LayoutMarginExample(GridLayout, IClickListener):
    ...
    def __init__(self):
        ...
        self.addComponent(Label('Toggle layout margins with the checkboxes. The right side margin has a theme-specified value, while the other margins are the defaults.'), 0, 0, 2, 0)
        self.space()
    ...
    def buttonClick(self, event):
        self._marginLayout.setMargin(self._topMargin.booleanValue(), self._rightMargin.booleanValue(), self._bottomMargin.booleanValue(), self._leftMargin.booleanValue())