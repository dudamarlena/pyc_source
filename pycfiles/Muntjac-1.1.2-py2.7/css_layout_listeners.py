...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/component/css_layout_listeners.py
...
class CssLayoutListeners(AbstractListenerMethodsTest):
    ...
    def testLayoutClickListenerAddGetRemove(self):
        self._testListenerAddGetRemove(CssLayout, LayoutClickEvent, ILayoutClickListener)