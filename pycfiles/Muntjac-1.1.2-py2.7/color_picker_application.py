...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/colorpicker/color_picker_application.py
...
from muntjac.addon.colorpicker.color_picker import ColorPicker, ButtonStyle, IColorChangeListener
...
class ColorPickerApplication(Application, IColorChangeListener):
    ...
    def init(self):
        ...
        optPanel = Panel('Customize the color picker popup window', GridLayout(3, 2))
        ...
        panel1 = Panel('Button like colorpicker with current color and CSS code', HorizontalLayout())
        ...
        panel1.getContent().setComponentAlignment(self._colorpicker1, Alignment.MIDDLE_CENTER)
        ...
        panel1.getContent().setComponentAlignment(self._colorpicker2, Alignment.MIDDLE_CENTER)
        layout.addComponent(panel1)
        panel2 = Panel('Button like colorpicker with current color and custom caption', HorizontalLayout())
        ...
        panel2.getContent().setComponentAlignment(self._colorpicker3, Alignment.MIDDLE_CENTER)
        ...
        panel2.getContent().setComponentAlignment(self._colorpicker4, Alignment.MIDDLE_CENTER)
        layout.addComponent(panel2)
        panel3 = Panel('Color area color picker with caption', HorizontalLayout())
        ...
        panel3.getContent().setComponentAlignment(self._colorpicker5, Alignment.MIDDLE_CENTER)
        ...
        panel3.getContent().setComponentAlignment(self._colorpicker6, Alignment.MIDDLE_CENTER)
    ...
    def colorChanged(self, event):
        if event.getSource() == self._colorpicker1 or event.getSource() == self._colorpicker3 or event.getSource() == self._colorpicker5:
        ...
        elif event.getSource() == self._colorpicker2 or event.getSource() == self._colorpicker4 or event.getSource() == self._colorpicker6:
...
class MyImageSource(IStreamSource):
    ...
    def getStream(self):
        ...
        drawable.text((50, 100), 'r=' + str(self._fgColor.getRed()) + ',g=' + str(self._fgColor.getGreen()) + ',b=' + str(self._fgColor.getBlue()), fill=str(Color.BLACK))
        drawable.text((5, 15), 'r=' + str(self._bgColor.getRed()) + ',g=' + str(self._bgColor.getGreen()) + ',b=' + str(self._bgColor.getBlue()), fill=str(Color.BLACK))
        del drawable
        try:
