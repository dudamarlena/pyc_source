...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/tree_table.py
# Compiled at: 2013-04-04 15:36:35
import logging
from muntjac.ui.tree import ExpandEvent, IExpandListener, CollapseEvent, ICollapseListener, COLLAPSE_METHOD, EXPAND_METHOD
from muntjac.ui.treetable.hierarchical_container_ordered_wrapper import HierarchicalContainerOrderedWrapper
...
class TreeTable(Table, IHierarchical):
    ...
    def countSubNodesRecursively(self, hc, itemId):
        count = 0
        if self.getContainerStrategy().isNodeOpen(itemId) or itemId == self._toggledItemId:
