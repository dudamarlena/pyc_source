...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/abstract_ordered_layout.py
...
from muntjac.event.layout_events import ILayoutClickNotifier, ILayoutClickListener, LayoutClickEvent

class AbstractOrderedLayout(AbstractLayout, IAlignmentHandler, ISpacingHandler, ILayoutClickNotifier):
    ...
    def setComponentAlignment(self, childComponent, alignment, verticalAlignment=None):
    ...
    def addCallback(self, callback, eventType=None, *args):
        ...
        if issubclass(eventType, LayoutClickEvent):
            ...
            super(AbstractOrderedLayout, self).addCallback(callback, eventType, *args)
        return
    ...
    def removeCallback(self, callback, eventType=None):
        ...
        if issubclass(eventType, LayoutClickEvent):
            ...
            super(AbstractOrderedLayout, self).removeCallback(callback, eventType)
        return
