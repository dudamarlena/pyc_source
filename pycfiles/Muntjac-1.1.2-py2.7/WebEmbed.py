...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/embedded/WebEmbed.py
...
class WebEmbed(Feature):
    ...
    def getDescription(self):
        return 'Web pages can be embedded, allowing easy integration to older systems. Synchronization and messaging between web pages and Muntjac apps can be accomplished with Muntjac JS APIs. Just use Embedded.TYPE_BROWSER'
