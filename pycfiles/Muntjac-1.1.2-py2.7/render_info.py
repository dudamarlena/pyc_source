...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/csstools/render_info.py
...
class RenderInfo(object):
    ...
    def get(cls, c, cb, *props):
        ...
        from muntjac.addon.csstools.render_info_fetcher import RenderInfoFetcher
