...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/component/component_position.py
...
class ComponentPosition(TestCase):
    ...
    def testFullCss(self):
        ...
        self.assertEquals(ISizeable.UNITS_PIXELS, layout.getPosition(b).getTopUnits())
        self.assertEquals(ISizeable.UNITS_PICAS, layout.getPosition(b).getBottomUnits())
        self.assertEquals(ISizeable.UNITS_EM, layout.getPosition(b).getLeftUnits())
        self.assertEquals(ISizeable.UNITS_PERCENTAGE, layout.getPosition(b).getRightUnits())
    ...
    def testSetPosition(self):
        ...
        self.assertEquals(ISizeable.UNITS_CM, layout.getPosition(b).getTopUnits())
        self.assertEquals(ISizeable.UNITS_EX, layout.getPosition(b).getRightUnits())
        self.assertEquals(ISizeable.UNITS_INCH, layout.getPosition(b).getBottomUnits())
        self.assertEquals(ISizeable.UNITS_MM, layout.getPosition(b).getLeftUnits())
