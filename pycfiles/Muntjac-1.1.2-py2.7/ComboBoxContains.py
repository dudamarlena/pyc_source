...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/selects/ComboBoxContains.py
...
class ComboBoxContains(Feature):
    ...
    def getRelatedFeatures(self):
        ...
        return [
         ComboBoxPlain, ComboBoxStartsWith, ComboBoxNewItems]
