...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/data/util/container_sorting_test.py
...
class TestContainerSorting(TestCase):
    ...
    def assertArrays(self, actualObjects, expectedObjects):
        self.assertEquals(len(expectedObjects), len(actualObjects), 'Actual contains a different number of values than was expected')
