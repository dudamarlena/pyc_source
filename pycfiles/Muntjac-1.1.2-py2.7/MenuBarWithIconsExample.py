...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/menubar/MenuBarWithIconsExample.py
...
class MenuBarWithIconsExample(VerticalLayout):
    ...
    def __init__(self):
        ...
        f.addItem('Open file...', ThemeResource('../runo/icons/16/folder.png'), menuCommand)
        f.addSeparator()
        newItem.addItem('File', ThemeResource('../runo/icons/16/document.png'), menuCommand)
