...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/menubar/MenuBarItemStyles.py
...
class MenuBarItemStyles(Feature):
    ...
    def getRelatedResources(self):
        return [
         NamedExternalResource('CSS for the menubar', self.getThemeBase() + 'misc/item-styles.css')]