...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/ui/alignment_utils.py
...
class AlignmentUtils(object):
    ...
    """
    _horizontalMask = IAlignmentHandler.ALIGNMENT_LEFT | IAlignmentHandler.ALIGNMENT_HORIZONTAL_CENTER | IAlignmentHandler.ALIGNMENT_RIGHT
    _verticalMask = IAlignmentHandler.ALIGNMENT_TOP | IAlignmentHandler.ALIGNMENT_VERTICAL_CENTER | IAlignmentHandler.ALIGNMENT_BOTTOM
