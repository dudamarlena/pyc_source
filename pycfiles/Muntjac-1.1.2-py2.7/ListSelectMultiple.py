...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/selects/ListSelectMultiple.py
...
class ListSelectMultiple(Feature):
    ...
    def getDescription(self):
        return 'A simple list select component with multiple item selection. You can allow or disallow <i>null selection</i> - i.e the possibility to make an empty selection. Null selection is allowed in this example.<br/>You can select multiple items from the list by holding the CTRL of SHIFT key while clicking the items.'

    def getRelatedAPI(self):
        return [
         APIResource(ListSelect)]
