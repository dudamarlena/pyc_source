...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/addon/csstools/test_application.py
# Compiled at: 2013-04-04 15:36:36
from muntjac.api import Application, Window, Label, NativeSelect, Button, GridLayout
from muntjac.ui.themes.reindeer import Reindeer
from muntjac.ui.button import IClickListener
from muntjac.addon.csstools.render_info import RenderInfo, ICallback
from muntjac.addon.csstools.client.v_render_info_fetcher import CssProperty
...
if __name__ == '__main__':
    ...
    muntjac(CssToolsTestApplication, nogui=True, forever=True, debug=True, widgetset='org.vaadin.csstools.CssToolsWidgetset')