...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/messages.py
...
class SystemMessages(object):
    ...
    def getSessionExpiredCaption(self):
        ...
        if self.sessionExpiredNotificationEnabled:
            return self.sessionExpiredCaption
        else:
            return
    ...
    def getCommunicationErrorCaption(self):
        ...
        if self.communicationErrorNotificationEnabled:
            return self.communicationErrorCaption
        else:
            return
    ...
    def getCommunicationErrorMessage(self):
        ...
        """
        if self.communicationErrorNotificationEnabled:
            return self.communicationErrorMessage
        else:
            return
    ...
    def getAuthenticationErrorCaption(self):
        ...
        if self.authenticationErrorNotificationEnabled:
            return self.authenticationErrorCaption
        else:
            return
    ...
    def getAuthenticationErrorMessage(self):
        ...
        """
        if self.authenticationErrorNotificationEnabled:
            return self.authenticationErrorMessage
        else:
            return
    ...
    def getInternalErrorCaption(self):
        ...
        if self.internalErrorNotificationEnabled:
            return self.internalErrorCaption
        else:
            return
    ...
    def getOutOfSyncCaption(self):
        """@return: "Out of sync\""""
        if self.outOfSyncNotificationEnabled:
            return self.outOfSyncCaption
        else:
            return
    ...
    def getCookiesDisabledCaption(self):
        ...
        """
        if self.cookiesDisabledNotificationEnabled:
            return self.cookiesDisabledCaption
        else:
            return
    ...
    def getCookiesDisabledMessage(self):
        ...
        """
        if self.cookiesDisabledNotificationEnabled:
            return self.cookiesDisabledMessage
        else:
            return
