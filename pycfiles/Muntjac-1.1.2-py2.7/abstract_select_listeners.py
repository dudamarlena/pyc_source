...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/test/server/component/abstract_select_listeners.py
...
class TestAbstractSelectListeners(AbstractListenerMethodsTest):
    ...
    def testItemSetChangeListenerAddGetRemove(self):
        self._testListenerAddGetRemove(ComboBox, IItemSetChangeEvent, IItemSetChangeListener)

    def testPropertySetChangeListenerAddGetRemove(self):
        self._testListenerAddGetRemove(ComboBox, IPropertySetChangeEvent, IPropertySetChangeListener)