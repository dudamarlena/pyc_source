...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/muntjac/demo/sampler/features/dragndrop/DragDropRearrangeComponents.py
...
class DragDropRearrangeComponents(Feature):
    ...
    def getRelatedAPI(self):
        return [
         APIResource(DragAndDropWrapper), APIResource(IDropHandler)]
