...
# [GCC 8.4.0]
# Embedded file name: csrec/mem_dal.py
# Compiled at: 2017-12-01 11:39:44
...
class Database(DALBase, Singleton):
    ...
    def __init__(self):
        ...
        self.__params_dictionary = {}
        self.items_tbl = {}
        self.users_ratings_tbl = {}
        self.items_ratings_tbl = {}
        self.users_social_tbl = {}
        self.info_used = set()
        self.tot_categories_user_ratings = {}
        self.tot_categories_item_ratings = {}
        self.n_categories_user_ratings = {}
    ...
    def serialize(self, filepath):
        ...
        try:
            with open(filepath, 'wb') as (f):
                data_to_serialize = {'items': self.items_tbl, 'users_ratings': self.users_ratings_tbl, 'items_ratings': self.items_ratings_tbl, 
