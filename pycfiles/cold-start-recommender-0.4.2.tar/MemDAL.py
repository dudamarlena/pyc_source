...
# [GCC 8.4.0]
# Embedded file name: csrec/MemDAL.py
# Compiled at: 2015-08-29 20:16:40
    ...
    def serialize(self, filepath):
        ...
        try:
            with open(filepath, 'wb') as (f):
                data_to_serialize = {'items': self.items_tbl, 'item_ratings': self.users_ratings_tbl, 'user_recomms': self.users_recomm_tbl, 
