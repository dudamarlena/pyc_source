...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ngen/tid.py
...
class DateTime(datetime):
    ...
    def seconds_from_epoch(self):
        ...
        """
        return calendar.timegm(self.utctimetuple()) + self.microsecond * 1e-06
    ...
    def convert(cls, instance):
        return cls(instance.year, instance.month, instance.day, instance.hour, instance.minute, instance.second, instance.microsecond, instance.tzinfo)
