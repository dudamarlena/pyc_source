...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\wsgiform\tests\test_validators.py
# Compiled at: 2006-12-10 15:03:35
import unittest, wsgiform.validators as validators
...
class TestValidators(unittest.TestCase):
    ...
    def test_malicious(self):
        array = ('http://www.domain.com/page.asp?param=&lt;/script&gt;', 'https://www.domain.com/page.asp?param=;SELECT',
                 'https://www.domain.com/page.asp?param=;INSERT', 'https://www.domain.com/page.asp?param=RealParam',
                 'https://www.domain.com/page.asp?param=RealParam1', 'https://www.domain.com/page.asp?param=RealParam2')
        self.assertEqual(self.sixcheck(validators.malicious, array), True)

    def test_notmalicious(self):
        array = ('Normal input', 'This is a test', 'Test Test', 'http://www.domain.com/page.asp?param=&lt;/script&gt;',
                 'https://www.domain.com/page.asp?param=;SELECT', 'https://www.domain.com/page.asp?param=;INSERT')
    ...
    def test_isip4(self):
        array = ('0.0.0.0', '255.255.255.02', '192.168.0.136', '256.1.3.4', '023.44.33.22',
                 '10.57.98.23.')
    ...
    def test_isip6(self):
        array = ('::0:0:0:FFFF:129.144.52.38', 'FEDC:BA98::3210:FEDC:BA98:7654:3210',
                 '::13.1.68.3', 'FEDC:BA98:7654:3210:FEDC:BA98:7654:3210:1234', '3210:FEDC:BA98:7654:3210:1234',
                 ':FEDC:BA98:7654:3210:')
        self.assertEqual(self.sixcheck(validators.isip6, array), True)

    def test_ismacaddr(self):
        array = ('01:23:45:67:89:ab', '01:23:45:67:89:AB', 'fE:dC:bA:98:76:54', '01:23:45:67:89:ab:cd',
                 '01:23:45:67:89:Az', '01:23:45:56:')
    ...
    def test_ispassword(self):
        array = ('Passw0rd', 'assW@rd1', '1B2a345@#$%', '123123123', 'Password', 'asdf&amp;')
    ...
    def test_isdatetime(self):
        array = ('12/25/2003', '08:03:31', '02/29/2004 12 AM', '02/29/2003 1:34 PM',
                 '13:23 PM', '24:00:00')
        self.assertEqual(self.sixcheck(validators.isdatetime, array), True)

    def test_isedatetime(self):
        array = ('2003/12/25', '08:03:31', '2004/02/29 12 AM', '2003/02/29 1:34 PM',
                 '13:23 PM', '24:00:00')

    def test_iscreditcard(self):
        array = ('341-1111-1111-1111', '5431-1111-1111-1111', '30569309025904', '30-5693-0902-5904',
                 '5631-1111-1111-1111', '31169309025904')
    ...
    def test_isssn(self):
        array = ('123-45-6789', '123 45 6789', '123456789', '12345-67-890123', '1234-56-7890',
                 '123-45-78901')
        self.assertEqual(self.sixcheck(validators.isssn, array), True)

    def test_isvat(self):
        array = ('CZ-7907111883', 'ESA12345678', 'FRAB123456789', 'CZ55912', 'XY123456',
                 'FR-IB123456789')
    ...
    def test_isintlphone(self):
        array = ('+123(45)678-910', '+123-045-67 89 10', '01-234-56-78', '123(45)678 91011',
                 '(12)345-678', '+0(12)345-6789')
        self.assertEqual(self.sixcheck(validators.isintlphone, array), True)

    def test_isukphone(self):
        array = ('+447222555555', '+44 7222 555 555', '(0722) 5555555 #2222', '(+447222)555555',
                 '+44(7222)555555', '(0722) 5555555 #22')
