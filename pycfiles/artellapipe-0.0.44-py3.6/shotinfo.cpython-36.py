...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/shotinfo.py
# Compiled at: 2020-05-03 00:26:57
# Size of source mod 2**32: 17221 bytes
"""
...
class ShotInfoWidget(base.BaseWidget, object):
    ...
    def _init(self):
        ...
        self._shot_icon_lbl.setPixmap(thumb_icon.pixmap(thumb_icon.availableSizes()[(-1)]).scaled(thumb_size[0], thumb_size[1], Qt.KeepAspectRatio))
    ...
    def _create_asset_files_buttons(self):
        ...
        if not self._shot_widget:
            ...
            for file_type in self._shot_widget.shot.FILES:
                ...
                file_btn = ShotFileButton(self._shot_widget, defines.ArtellaFileStatus.WORKING, file_type, file_type_name, tpDcc.ResourcesMgr().icon(file_type))
