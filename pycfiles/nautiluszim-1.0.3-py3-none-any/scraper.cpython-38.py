...
# Compiled at: 2020-05-06 08:23:25
# Size of source mod 2**32: 13073 bytes
import os, re, json, locale, shutil, pathlib, datetime, subprocess
...
class Nautilus(object):
    ...
    def __init__(self, archive, collection, nb_items_per_page, no_random, show_description, output_dir, no_zim, fname, debug, keep_build_dir, skip_download, language, locale_name, tags, name=None, title=None, description=None, creator=None, publisher=None, favicon=None, main_logo=None, secondary_logo=None, main_color=None, secondary_color=None, about=None):
    ...
    def archive_path(self):
        ...
        return pathlib.Path(self.archive).expanduser().resolve()
