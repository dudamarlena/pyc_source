...
# [GCC 8.4.0]
# Embedded file name: /Users/linshuliang/work_baidu/tb-paddle/tb_paddle/proto/attr_value_pb2.py
# Compiled at: 2020-01-08 07:01:22
# Size of source mod 2**32: 16995 bytes
...
DESCRIPTOR = _descriptor.FileDescriptor(name='tb_paddle/proto/attr_value.proto',
  package='tb_paddle',
  syntax='proto3',
  serialized_options=b'\n\x18org.tensorflow.frameworkB\x0fAttrValueProtosP\x01\xf8\x01\x01',
  serialized_pb=b'\n tb_paddle/proto/attr_value.proto\x12\ttb_paddle\x1a\x1ctb_paddle/proto/tensor.proto\x1a"tb_paddle/proto/tensor_shape.proto\x1a\x1btb_paddle/proto/types.proto"\x9d\x04\n\tAttrValue\x12\x0b\n\x01s\x18\x02 \x01(\x0cH\x00\x12\x0b\n\x01i\x18\x03 \x01(\x03H\x00\x12\x0b\n\x01f\x18\x04 \x01(\x02H\x00\x12\x0b\n\x01b\x18\x05 \x01(\x08H\x00\x12#\n\x04type\x18\x06 \x01(\x0e2\x13.tb_paddle.DataTypeH\x00\x12,\n\x05shape\x18\x07 \x01(\x0b2\x1b.tb_paddle.TensorShapeProtoH\x00\x12(\n\x06tensor\x18\x08 \x01(\x0b2\x16.tb_paddle.TensorProtoH\x00\x12.\n\x04list\x18\x01 \x01(\x0b2\x1e.tb_paddle.AttrValue.ListValueH\x00\x12\'\n\x04func\x18\n \x01(\x0b2\x17.tb_paddle.NameAttrListH\x00\x12\x15\n\x0bplaceholder\x18\t \x01(\tH\x00\x1a\xe5\x01\n\tListValue\x12\t\n\x01s\x18\x02 \x03(\x0c\x12\r\n\x01i\x18\x03 \x03(\x03B\x02\x10\x01\x12\r\n\x01f\x18\x04 \x03(\x02B\x02\x10\x01\x12\r\n\x01b\x18\x05 \x03(\x08B\x02\x10\x01\x12%\n\x04type\x18\x06 \x03(\x0e2\x13.tb_paddle.DataTypeB\x02\x10\x01\x12*\n\x05shape\x18\x07 \x03(\x0b2\x1b.tb_paddle.TensorShapeProto\x12&\n\x06tensor\x18\x08 \x03(\x0b2\x16.tb_paddle.TensorProto\x12%\n\x04func\x18\t \x03(\x0b2\x17.tb_paddle.NameAttrListB\x07\n\x05value"\x90\x01\n\x0cNameAttrList\x12\x0c\n\x04name\x18\x01 \x01(\t\x12/\n\x04attr\x18\x02 \x03(\x0b2!.tb_paddle.NameAttrList.AttrEntry\x1aA\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12#\n\x05value\x18\x02 \x01(\x0b2\x14.tb_paddle.AttrValue:\x028\x01B0\n\x18org.tensorflow.frameworkB\x0fAttrValueProtosP\x01\xf8\x01\x01b\x06proto3',
  dependencies=[
 tb__paddle_dot_proto_dot_tensor__pb2.DESCRIPTOR, tb__paddle_dot_proto_dot_tensor__shape__pb2.DESCRIPTOR, tb__paddle_dot_proto_dot_types__pb2.DESCRIPTOR])
_ATTRVALUE_LISTVALUE = _descriptor.Descriptor(name='ListValue',
 ...
 _descriptor.FieldDescriptor(name='s',
   full_name='tb_paddle.AttrValue.ListValue.s',
   index=0,
   number=2,
   type=12,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='i',
   full_name='tb_paddle.AttrValue.ListValue.i',
   index=1,
   number=3,
   type=3,
   cpp_type=2,
 ...
 _descriptor.FieldDescriptor(name='f',
   full_name='tb_paddle.AttrValue.ListValue.f',
   index=2,
   number=4,
   type=2,
   cpp_type=6,
 ...
 _descriptor.FieldDescriptor(name='b',
   full_name='tb_paddle.AttrValue.ListValue.b',
   index=3,
   number=5,
   type=8,
   cpp_type=7,
 ...
 _descriptor.FieldDescriptor(name='type',
   full_name='tb_paddle.AttrValue.ListValue.type',
   index=4,
   number=6,
   type=14,
   cpp_type=8,
 ...
 _descriptor.FieldDescriptor(name='shape',
   full_name='tb_paddle.AttrValue.ListValue.shape',
   index=5,
   number=7,
   type=11,
   cpp_type=10,
 ...
 _descriptor.FieldDescriptor(name='tensor',
   full_name='tb_paddle.AttrValue.ListValue.tensor',
   index=6,
   number=8,
   type=11,
   cpp_type=10,
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='func',
   full_name='tb_paddle.AttrValue.ListValue.func',
   index=7,
   number=9,
   type=11,
   cpp_type=10,
  ...
  serialized_end=675)
_ATTRVALUE = _descriptor.Descriptor(name='AttrValue',
  ...
  fields=[
 _descriptor.FieldDescriptor(name='s',
   full_name='tb_paddle.AttrValue.s',
   index=0,
   number=2,
   type=12,
   cpp_type=9,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='i',
   full_name='tb_paddle.AttrValue.i',
   index=1,
   number=3,
   type=3,
   cpp_type=2,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='f',
   full_name='tb_paddle.AttrValue.f',
   index=2,
   number=4,
   type=2,
   cpp_type=6,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='b',
   full_name='tb_paddle.AttrValue.b',
   index=3,
   number=5,
   type=8,
   cpp_type=7,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='type',
   full_name='tb_paddle.AttrValue.type',
   index=4,
   number=6,
   type=14,
   cpp_type=8,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='shape',
   full_name='tb_paddle.AttrValue.shape',
   index=5,
   number=7,
   type=11,
   cpp_type=10,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='tensor',
   full_name='tb_paddle.AttrValue.tensor',
   index=6,
   number=8,
   type=11,
   cpp_type=10,
 ...
 _descriptor.FieldDescriptor(name='list',
   full_name='tb_paddle.AttrValue.list',
   index=7,
   number=1,
   type=11,
   cpp_type=10,
   ...
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='func',
   full_name='tb_paddle.AttrValue.func',
   index=8,
   number=10,
   type=11,
   cpp_type=10,
   ...
   serialized_options=None,
   file=DESCRIPTOR),
 _descriptor.FieldDescriptor(name='placeholder',
   full_name='tb_paddle.AttrValue.placeholder',
   index=9,
   number=9,
   type=9,
   cpp_type=9,
 ...
 _descriptor.OneofDescriptor(name='value',
   full_name='tb_paddle.AttrValue.value',
   index=0,
   containing_type=None,
   fields=[])],
...
_NAMEATTRLIST_ATTRENTRY = _descriptor.Descriptor(name='AttrEntry',
 ...
 _descriptor.FieldDescriptor(name='key',
   full_name='tb_paddle.NameAttrList.AttrEntry.key',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='value',
   full_name='tb_paddle.NameAttrList.AttrEntry.value',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
  ...
  serialized_end=831)
_NAMEATTRLIST = _descriptor.Descriptor(name='NameAttrList',
 ...
 _descriptor.FieldDescriptor(name='name',
   full_name='tb_paddle.NameAttrList.name',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
 ...
 _descriptor.FieldDescriptor(name='attr',
   full_name='tb_paddle.NameAttrList.attr',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
...
AttrValue = _reflection.GeneratedProtocolMessageType('AttrValue', (_message.Message,), {'ListValue':_reflection.GeneratedProtocolMessageType('ListValue', (_message.Message,), {'DESCRIPTOR':_ATTRVALUE_LISTVALUE, 
...
NameAttrList = _reflection.GeneratedProtocolMessageType('NameAttrList', (_message.Message,), {'AttrEntry':_reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), {'DESCRIPTOR':_NAMEATTRLIST_ATTRENTRY, 
  '__module__':'tb_paddle.proto.attr_value_pb2'}), 
