...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wlfilebrowser/fields.py
...
from wlfilebrowser.functions import url_to_path, get_directory
...
class FileBrowseWidget(Input):
    ...
    class Media:
        js = (
         os.path.join(URL_FILEBROWSER_MEDIA, b'js/AddWlFileBrowser.js'),)
    ...
    def render(self, name, value, attrs=None):
        ...
        final_attrs[b'search_icon'] = URL_FILEBROWSER_MEDIA + b'img/wlfilebrowser_icon_show.gif'
        ...
        return render_to_string(b'wlfilebrowser/custom_field.html', dict(locals(), MEDIA_URL=MEDIA_URL))
...
try:
    ...
    add_introspection_rules([], [b'^wlfilebrowser\\.fields\\.FileBrowseField'])
except ImportError:
    pass