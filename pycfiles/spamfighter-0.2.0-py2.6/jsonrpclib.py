...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spamfighter/txjsonrpc/jsonrpclib.py
...
def dumps(obj, **kws):
    ...
    if isinstance(obj, Exception):
        value = {'error': {'origin': obj.__class__.__name__, 'code': obj.faultCode, 'message': obj.faultString}}
...
def loads(string, **kws):
    ...
    if isinstance(unmarshalled, dict) and unmarshalled.has_key('error'):
