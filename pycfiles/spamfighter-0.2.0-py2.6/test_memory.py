...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spamfighter/core/storage/test/test_memory.py
...
class MemoryStorageTestCase(unittest.TestCase, ExpirableStorageTestMixin):
    ...
    def testCleanup(self):
        ...
        return self.s.set('key1', 'value1', 5).addCallback(lambda _: self.s.set('key2', 'value2', 15)).addCallback(checkState1).addCallback(lambda _: advanceTestTimer(12)).addCallback(lambda _: self.s._cleanup()).addCallback(checkState2)
