...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spamfighter/txjsonrpc/web/test/test_jsonrpc.py
...
class TestAuthHeader(Test):
    ...
    def jsonrpc_authinfo(self):
        return (
         self.request.getUser(), self.request.getPassword())
