...
# Embedded file name: /home/cedricmessiant/workspace/webpro/src/collective.contact.membrane/src/collective/contact/membrane/behaviors/membranegroup.py
# Compiled at: 2015-04-03 05:16:43
__doc__ = 'Turn organizations into Membrane groups.'
...
def get_active_states():
    ...
    record_name = 'collective.contact.membrane.interfaces.IContactMembraneParameters.active_held_position_states'
    try:
...
class MembraneGroup(OriginMembraneGroup):
    ...
    def getGroupHeldPositions(self):
        ...
        query = {'to_id': intid, 'from_interfaces_flattened': IHeldPosition, 
           'from_attribute': 'position'}
        for relation in catalog.findRelations(query):
            held_position = relation.from_object
            if not active_states or api.content.get_state(held_position) in active_states:
