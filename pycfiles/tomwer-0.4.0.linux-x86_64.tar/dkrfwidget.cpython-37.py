...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/tomwer_venc/lib/python3.7/site-packages/tomwer/gui/reconstruction/ftserie/reconsparamseditor/dkrfwidget.py
...
class DKRFWidget(H5StructEditor, qt.QWidget):
    ...
    def __init__(self, reconsparams, parent=None):
        ...
        self.layout().addWidget(self._DKRFWidget__buildDoWhen())
        self.layout().addWidget(self._DKRFWidget__buildDKMode())
        self.layout().addWidget(self._DKRFWidget__buildRefMode())
        self.layout().addWidget(self._DKRFWidget__buildRm())
        self.layout().addWidget(self._DKRFWidget__buildSkip())
        self.layout().addWidget(self._DKRFWidget__buildDKPattern())
        self.layout().addWidget(self._DKRFWidget__buildRefPattern())
    ...
    def setReconsParams(self, recons_params):
        if isinstance(recons_params, QReconsParams):
            ...
            if isinstance(recons_params, _QDKRFRP):
                ...
                raise ValueError('recons_params should be an instance of QReconsParam or _QDKRFRP')
    ...
    def __buildDoWhen(self):
        ...
        self.linkGroupWithH5Variable((self._qleDoWhen), 'DOWHEN', setter=(self._setWhen),
          getter=(self._getWhen))
    ...
    def __buildDKMode(self):
        ...
        self.linkGroupWithH5Variable((self._qcbDKMode), 'DARKCAL',
    ...
    def __buildRefMode(self):
        ...
        self.linkGroupWithH5Variable((self._qcbRefMode), 'REFSCAL',
    ...
    def __buildDKPattern(self):
        ...
        self._DKPatternOpt.layout().addWidget(qt.QLabel('dark file pattern', parent=(self._DKPatternOpt)))
    ...
    def __buildRefPattern(self):
        ...
        self._RefsPatternOpt.layout().addWidget(qt.QLabel('refs file pattern', parent=(self._RefsPatternOpt)))
