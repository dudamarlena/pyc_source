...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/tomwer_venc/lib/python3.7/site-packages/tomwer/core/process/test/test_recons_params.py
...
__license__ = 'MIT'
__date__ = '21/03/2019'
import unittest, tempfile, platform
from tomwer.core.process.reconstruction.ftseries.params.paganin import PaganinRP, PaganinMode
from tomwer.core.process.reconstruction.darkref.params import DKRFRP, Method as Dkrf_Method
...
class TestReconsParamSet(unittest.TestCase):
    ...
    @unittest.skipIf((platform.system() == 'Windows'), reason='No rights on conda installation')
    def testReconsParamList(self):
        ...
        for param_set in recons_list:
            ...
            with tmp_file as (tmpH5File):
                ftseriesutils.saveH5File(h5File=(tmpH5File.name), structs=param_set,
                  displayInfo=False)
...
class TestReconsParamCopy(unittest.TestCase):
    __doc__ = 'Test copy of the reconstruction parameters'
