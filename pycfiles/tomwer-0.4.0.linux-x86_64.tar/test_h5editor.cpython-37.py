...
# [GCC 8.4.0]
# Embedded file name: /users/payno/.local/share/virtualenvs/tomwer_venc/lib/python3.7/site-packages/tomwer/gui/test/test_h5editor.py
# Compiled at: 2020-02-10 09:12:42
# Size of source mod 2**32: 16113 bytes
__authors__ = [
 'H. Payno']
__license__ = 'MIT'
__date__ = '14/02/2017'
...
import tomwer.core.process.reconstruction.darkref.params as dkrf_method
...
class TestSimplifyH5EditorDisplay(TestCaseQt):
    __doc__ = 'Make sure we are displayig the correct things\n    '
...
class TestSimplifyH5EditorSave(TestCaseQt):
    __doc__ = 'test that h5editor is returning the correct H5 structures'
