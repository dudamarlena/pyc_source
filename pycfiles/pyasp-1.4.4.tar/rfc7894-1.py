...
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1_modules/rfc7894-1.py
...
_cmcControlAttributesMapUpdate = {id_aa_otpChallenge: DirectoryString(), id_aa_revocationChallenge: DirectoryString(), id_aa_estIdentityLinking: DirectoryString()}
