...
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1_modules/rfc5480.py
...
ECParameters.componentType = namedtype.NamedTypes(namedtype.NamedType('namedCurve', univ.ObjectIdentifier()))
