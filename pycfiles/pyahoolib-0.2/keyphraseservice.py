...
# Embedded file name: build\bdist.win32\egg\pyahooapis\jlp\keyphraseservice.py
# Compiled at: 2011-05-16 12:43:16
...
class KeyphraseService(Service):
    ...
    def get_results(self, sentence, json=False):
        ...
        if json and json != JSON_LIBRALY:
            ...
            resultlist = [ KeyphraseResult(self._get_text(r, 'Keyphrase'), self._get_text(r, 'Score')) for r in dom.getElementsByTagName('Result')
                         ]
