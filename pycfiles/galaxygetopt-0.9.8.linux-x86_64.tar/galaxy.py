...
# [GCC 8.4.0]
# Embedded file name: /home/users/cpt/cpt/esr/Projects/galaxy/galaxygetopt/env/lib/python2.7/site-packages/galaxygetopt/galaxy.py
...
class Galaxy(object):
 ...
 'script.py']):
    ...
    def gen(self, param_collection=None, options=[], defaults=[], outputs=[], appinfo={}, tests=[], docstring=None, argv=[]):
    ...
    def command_section(self, parent, options):
        ...
        for command in options:
            ...
            if not command._galaxy_specific and command._show_in_galaxy or command._galaxy_specific and command._show_in_galaxy:
                if addition:
