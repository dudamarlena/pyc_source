...
# [GCC 8.4.0]
# Embedded file name: /opt/anaconda3/lib/python3.7/site-packages/tests/test_gff3.py
...
class TestGff3Parser(unittest.TestCase):
    ...
    def test_entries(self):
        ...
        entry_seq_ids = [entry.seq_id for entry in self.gff3parser.entries(gff_fh)]
...
class TestGff3Entry(unittest.TestCase):
    ...
    def test_entry_creation_1(self):
        gff3entry = Gff3Entry({'seq_id':'IDfoobar2342', 
         'source':'a_prog', 
         'feature':'gene', 
         'start':'1984', 
         'end':'2001', 
        ...
        self.assertDictEqual(gff3entry.attributes, {'ID':'foo00001',  'Name':'foo'})
    ...
    def test_entry_creation_2(self):
        gff3entry = Gff3Entry({'seq_id':'accession_424', 
         'source':'make', 
         'feature':'CDS', 
         'start':'101', 
         'end':'199', 
        ...
        self.assertDictEqual(gff3entry.attributes, {'ID':'blub1',  'Name':'wow01'})
    ...
    def test_entry_creation_3(self):
        ...
        gff3entry = Gff3Entry({'seq_id':'accession_111', 
         'source':'make', 
         'feature':'CDS', 
         'start':'1000', 
         'end':'1', 
    ...
    def test_string_creation(self):
        ...
        self.assertEqual(str(gff3entry), 'accession_111\tmake\tCDS\t1\t1000\t0.5\t-\t.\tlocus_tag=boing;note=zoong')
