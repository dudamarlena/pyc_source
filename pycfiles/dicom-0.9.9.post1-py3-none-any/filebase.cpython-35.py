...
# [GCC 8.4.0]
# Embedded file name: c:\git\pydicom-clean\source\build\lib\dicom\filebase.py
...
class DicomIO(object):
    __doc__ = 'File object which holds transfer syntax info and anything else we need.'
    max_read_attempts = 3
    defer_size = None
