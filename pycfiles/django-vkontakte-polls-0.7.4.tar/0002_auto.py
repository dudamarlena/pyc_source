...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-vkontakte-polls/vkontakte_polls/migrations/0002_auto.py
# Compiled at: 2015-11-01 17:29:37
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('vkontakte_polls_poll', ['fetched'])
        db.create_index('vkontakte_polls_poll', ['votes_count'])
        db.create_index('vkontakte_polls_poll', ['owner_id'])
        db.create_index('vkontakte_polls_answer', ['fetched'])
        db.create_index('vkontakte_polls_answer', ['votes_count'])

    def backwards(self, orm):
        db.delete_index('vkontakte_polls_answer', ['votes_count'])
        db.delete_index('vkontakte_polls_answer', ['fetched'])
        db.delete_index('vkontakte_polls_poll', ['owner_id'])
        db.delete_index('vkontakte_polls_poll', ['votes_count'])
        db.delete_index('vkontakte_polls_poll', ['fetched'])
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_places.country': {'Meta': {'ordering': "['name']", 'object_name': 'Country'}, 'fetched': (
                                    ...
                                    'remote_id': (
                                                'django.db.models.fields.BigIntegerField', [], {'unique': 'True'})}, 
       'vkontakte_polls.answer': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Answer'}, 'fetched': (
                                            'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                                  'poll': (
                                         'django.db.models.fields.related.ForeignKey', [], {'related_name': "'answers'", 'to': "orm['vkontakte_polls.Poll']"}), 
                                  'rate': (
                                  ...
                                  'voters': (
                                           'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'poll_answers'", 'blank': 'True', 'to': "orm['vkontakte_users.User']"}), 
                                  'votes_count': (
                                                'django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})}, 
       'vkontakte_polls.poll': {'Meta': {'ordering': "['created']", 'object_name': 'Poll'}, 'answer_id': (
                                ...
                                'fetched': (
                                          'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                                'owner_content_type': (
                                                     'django.db.models.fields.related.ForeignKey', [], {'related_name': "'vkontakte_polls_polls'", 'to': "orm['contenttypes.ContentType']"}), 
                                'owner_id': (
                                           'django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}), 
                                'post': (
                                       'django.db.models.fields.related.OneToOneField', [], {'related_name': "'poll'", 'unique': 'True', 'to': "orm['vkontakte_wall.Post']"}), 
                                'question': (
                                           'django.db.models.fields.TextField', [], {}), 
                                'remote_id': (
                                            'django.db.models.fields.BigIntegerField', [], {'primary_key': 'True'}), 
