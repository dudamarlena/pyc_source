...
# Embedded file name: build\bdist.win32\egg\printio\tests\test_core.py
# Compiled at: 2012-08-24 13:20:48
...
class PrettyValues_TestCase(unittest.TestCase):
    ...
    def test_format_lod(self):
        ...
        values.append({'bar': 2, 'sym': 'newp', 'close': 1.0})
        results = pv.format(values)
