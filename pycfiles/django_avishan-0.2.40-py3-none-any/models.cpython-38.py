...
# Compiled at: 2020-05-04 03:47:37
# Size of source mod 2**32: 62056 bytes
import random
...
class AvishanModel(models.Model, AvishanFaker):
 ...
 L. 173         0  SETUP_FINALLY        64  'to 64'

 L. 174         2  LOAD_FAST                'cls'
                4  LOAD_ATTR                objects
                6  LOAD_ATTR                get
                8  BUILD_TUPLE_0         0 
 ...
 L. 175        16  LOAD_FAST                'new_additional_kwargs'
 ...
 L. 177        46  LOAD_FAST                'found'
               48  LOAD_METHOD              save
               50  CALL_METHOD_0         0  ''
               52  POP_TOP          

 L. 178        54  LOAD_FAST                'found'
               56  LOAD_CONST               False
               58  BUILD_TUPLE_2         2 
               60  POP_BLOCK        
               62  RETURN_VALUE     
 ...
 L. 180        80  LOAD_FAST                'cls'
               82  LOAD_ATTR                objects
               84  LOAD_ATTR                create
               86  BUILD_TUPLE_0         0 

 L. 181        88  LOAD_FAST                'fixed_kwargs'
               90  LOAD_FAST                'new_additional_kwargs'
               92  BUILD_MAP_UNPACK_2     2 

 L. 180        94  CALL_FUNCTION_EX_KW     1  'keyword and positional arguments'

 L. 182        96  LOAD_CONST               True

 L. 180        98  BUILD_TUPLE_2         2 
              100  ROT_FOUR         
              102  POP_EXCEPT       
              104  RETURN_VALUE     
...
Parse error at or near `POP_TOP' instruction at offset 76
 ...
 L. 463        20  LOAD_GLOBAL              isinstance
               22  LOAD_FAST                'field'
               24  LOAD_GLOBAL              models
               26  LOAD_ATTR                DateField
               28  CALL_FUNCTION_2       2  ''

 L. 462        30  POP_JUMP_IF_TRUE     56  'to 56'

 L. 463        32  LOAD_GLOBAL              isinstance
               34  LOAD_FAST                'field'
               36  LOAD_GLOBAL              models
               38  LOAD_ATTR                TimeField
               40  CALL_FUNCTION_2       2  ''

 L. 462        42  POP_JUMP_IF_FALSE    60  'to 60'

 L. 464        44  LOAD_FAST                'field'
               46  LOAD_ATTR                auto_now

 L. 462        48  POP_JUMP_IF_TRUE     56  'to 56'

 L. 464        50  LOAD_FAST                'field'
               52  LOAD_ATTR                auto_now_add

 L. 462        54  POP_JUMP_IF_FALSE    60  'to 60'
             56_0  COME_FROM            48  '48'
             56_1  COME_FROM            30  '30'
             56_2  COME_FROM            18  '18'
             56_3  COME_FROM             8  '8'

 L. 465        56  LOAD_CONST               False
               58  RETURN_VALUE     
             60_0  COME_FROM            54  '54'
             60_1  COME_FROM            42  '42'

 L. 466        60  LOAD_GLOBAL              isinstance
               62  LOAD_FAST                'field'
 ...
 L. 467        72  LOAD_CONST               False
               74  RETURN_VALUE     
             76_0  COME_FROM            70  '70'

 L. 469        76  LOAD_FAST                'field'
               78  LOAD_ATTR                blank
 ...
 L. 470        88  LOAD_CONST               False
               90  RETURN_VALUE     
             92_0  COME_FROM            86  '86'

 L. 472        92  LOAD_CONST               True
               94  RETURN_VALUE     
               -1  RETURN_LAST      
...
class UserGroup(AvishanModel):
 ...
 L. 640         0  SETUP_FINALLY        20  'to 20'

 L. 641         2  LOAD_GLOBAL              UserUserGroup
                4  LOAD_ATTR                objects
                6  LOAD_ATTR                get

 L. 642         8  LOAD_FAST                'base_user'

 L. 643        10  LOAD_FAST                'self'

 L. 641        12  LOAD_CONST               ('base_user', 'user_group')
 ...
 L. 646        36  LOAD_GLOBAL              UserUserGroup
               38  LOAD_ATTR                objects
               40  LOAD_ATTR                create

 L. 647        42  LOAD_FAST                'self'

 L. 648        44  LOAD_FAST                'base_user'

 L. 646        46  LOAD_CONST               ('user_group', 'base_user')
...
class Email(AvishanModel):
 ...
 L. 786         0  SETUP_FINALLY        16  'to 16'

 L. 787         2  LOAD_GLOBAL              Email
                4  LOAD_ATTR                get
...
class Phone(AvishanModel):
 ...
 L. 935         0  SETUP_FINALLY        16  'to 16'

 L. 936         2  LOAD_GLOBAL              Phone
                4  LOAD_ATTR                get
