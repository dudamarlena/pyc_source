...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/core/follicle.py
...
from tpMayaLib.core import shape, geometry, constraint as constraint_utils, transform as transform_utils, mesh as mesh_utils
