...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/meta/metautils.py
# Compiled at: 2020-01-16 21:52:40
# Size of source mod 2**32: 109401 bytes
"""
Module that contains functions and classes related with meta system
"""
import copy, pprint, logging, euclid, tpMayaLib as maya
...
class MetaAttributeUtils(object):
    ...
    def break_connection(*args):
        ...
        if MetaAttributeUtils.get_type(attr_dict) == 'message':
            ...
            source_connections = maya.cmds.listConnections(combined, skipConversionNodes=False, destination=False, source=True,
              plugs=True)
