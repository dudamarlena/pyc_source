...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/core/color.py
...
CONTROL_COLORS = []
for color in [(0.467, 0.467, 0.467), (0.0, 0.0, 0.0), (0.247, 0.247, 0.247), (0.498, 0.498, 0.498), (0.608, 0, 0.157), (0, 0.016, 0.373), (0, 0, 1), (0, 0.275, 0.094), (0.145, 0, 0.263), (0.78, 0, 0.78), (0.537, 0.278, 0.2), (0.243, 0.133, 0.122), (0.6, 0.145, 0), (1, 0, 0), (0, 1, 0), (0, 0.255, 0.6), (1, 1, 1), (1, 1, 0), (0.388, 0.863, 1), (0.263, 1, 0.635), (1, 0.686, 0.686), (0.89, 0.675, 0.475), (1, 1, 0.384), (0, 0.6, 0.325), (0.627, 0.412, 0.188), (0.62, 0.627, 0.188), (0.408, 0.627, 0.188), (0.188, 0.627, 0.365), (0.188, 0.627, 0.627), (0.188, 0.404, 0.627), (0.435, 0.188, 0.627), (0.627, 0.188, 0.404)]:
...
def get_rig_color(rig_type='fk', side='center'):
    ...
    if rig_type == 'fk' or rig_type == 'FK':
        if side == 'left' or side == 'Left' or side == 'L' or side == 'l' or side == 'Lt':
            ...
            if side == 'right' or side == 'Right' or side == 'R' or side == 'r' or side == 'Rt':
