...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/core/gui.py
# Compiled at: 2020-01-16 21:52:40
# Size of source mod 2**32: 19644 bytes
"""
        ...
        if attr_type == 'cbx':
            ...
            if attr_type == 'color':
                ...
                if attr_type == 'floatSlider':
                    ui_item = maya.cmds.attrFieldSliderGrp(label=lbl, attribute=attr, cl4=[
                     'left', 'left', 'left', 'left'],
                      cw4=size,
                      pre=2)
                ...
                if attr_type == 'floatSliderMesh':
                    ui_item = maya.cmds.attrFieldSliderGrp(label=lbl, attribute=attr, cl3=[
                     'left', 'left', 'left'],
                      cw3=size,
                      pre=2)
                    maya.cmds.attrFieldSliderGrp(ui_item, changeCommand=(lambda *args: attr_changed_fn(attr)), edit=True)
