...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/core/mathutils.py
# Compiled at: 2020-01-16 21:52:40
# Size of source mod 2**32: 9310 bytes
"""
Module that contains functions and classes related with maths
"""
from __future__ import print_function, division, absolute_import
import tpMayaLib as maya
from tpMayaLib.core import api
...
def average_position(pos1=(0.0, 0.0, 0.0), pos2=(0.0, 0.0, 0.0), weight=0.5):
    ...
    """
    return (
     pos1[0] + (pos2[0] - pos1[0]) * weight, pos1[1] + (pos2[1] - pos1[1]) * weight, pos1[2] + (pos2[2] - pos1[2]) * weight)
