...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/core/shelf.py
# Compiled at: 2020-01-16 21:52:40
# Size of source mod 2**32: 7692 bytes
"""
...
import tpDccLib, tpMayaLib as maya
...
class MayaShelf(abstract_shelf.AbstractShelf, object):
    ...
    def add_button(self, label, tooltip=None, icon='customIcon.png', command=None, double_command=None, command_type='python'):
        ...
        if not self._enable_labels:
            label = ''
        return maya.cmds.shelfButton(width=37, height=37, image=(icon or ''), label=label, command=command, doubleClickCommand=double_command,
          annotation=(tooltip or ''),
          imageOverlayLabel=label,
          overlayLabelBackColor=(self._label_background),
          overlayLabelColor=(self._label_color),
