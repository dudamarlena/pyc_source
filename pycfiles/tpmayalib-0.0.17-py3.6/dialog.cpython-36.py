...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/ui/dialog.py
# Compiled at: 2020-01-16 21:52:40
# Size of source mod 2**32: 3210 bytes
"""
...
from tpQtLib.core import dialog as core_dialog
from tpMayaLib.core import directory
...
tpQtLib.register_class('Dialog', MayaDialog)
tpQtLib.register_class('OpenFileDialog', MayaOpenFileDialog)
tpQtLib.register_class('SaveFileDialog', MayaSaveFileDialog)
tpQtLib.register_class('SelectFolderDialog', MayaSelectFolderDialog)
tpQtLib.register_class('NativeDialog', MayaNativeDialog)