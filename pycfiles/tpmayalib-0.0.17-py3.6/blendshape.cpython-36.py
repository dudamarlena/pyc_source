...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpMayaLib/core/blendshape.py
# Compiled at: 2020-01-16 21:52:40
# Size of source mod 2**32: 21830 bytes
"""
...
def add_empty_target(blend_shape, target_alias='', input_target_items=None):
    ...
    for i in out_geo:
        (maya.cmds.setAttr)('{}.inputTarget[{}].inputTargetGroup[{}].inputTargetItem[6000].inputPointsTarget'.format(blend_shape, i, next_index), *[0], **{'type': 'pointArray'})
        if input_target_items:
            for iti in input_target_items:
                (maya.cmds.setAttr)('{}.inputTarget[{}].inputTargetGroup[{}].inputTargetItem[{}].inputPointsTarget'.format(blend_shape, i, next_index, iti), *[0], **{'type': 'pointArray'})
