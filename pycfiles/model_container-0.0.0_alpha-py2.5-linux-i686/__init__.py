...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/model_container/__init__.py
...
class ModelContainer:
    ...
    def __init__(self, model=None):
        ...
        if model == None:
            ...
            if isinstance(model, ModelContainer):
                ...
                errormsg = 'Arg is of type %s, expected class type                 ModelContainer or Neurospaces.' % nmc.__class__
    ...
    def CheckEnvironment(self):
        env = [
         'NEUROSPACES_NMC_USER_MODELS', 'NEUROSPACES_NMC_PROJECT_MODELS',
