...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/model_container/model_container_base.py
# Compiled at: 2011-09-13 02:48:17
import _model_container_base, new
...
class AlgorithmInstance(_object):
    ...
    if _newclass:
        hsleLink = _swig_property(_model_container_base.AlgorithmInstance_hsleLink_get, _model_container_base.AlgorithmInstance_hsleLink_set)
    ...
    if _newclass:
        palgc = _swig_property(_model_container_base.AlgorithmInstance_palgc_get, _model_container_base.AlgorithmInstance_palgc_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.AlgorithmInstance_iFlags_get, _model_container_base.AlgorithmInstance_iFlags_set)
    ...
    if _newclass:
        pcIdentifier = _swig_property(_model_container_base.AlgorithmInstance_pcIdentifier_get, _model_container_base.AlgorithmInstance_pcIdentifier_set)
...
class AlgorithmSet(_object):
    ...
    if _newclass:
        hslClasses = _swig_property(_model_container_base.AlgorithmSet_hslClasses_get, _model_container_base.AlgorithmSet_hslClasses_set)
    ...
    if _newclass:
        iClasses = _swig_property(_model_container_base.AlgorithmSet_iClasses_get, _model_container_base.AlgorithmSet_iClasses_set)
    ...
    if _newclass:
        hslInstances = _swig_property(_model_container_base.AlgorithmSet_hslInstances_get, _model_container_base.AlgorithmSet_hslInstances_set)
    ...
    if _newclass:
        iInstances = _swig_property(_model_container_base.AlgorithmSet_iInstances_get, _model_container_base.AlgorithmSet_iInstances_set)
...
class descr_AlgorithmSymbol(_object):
    ...
    if _newclass:
        palgi = _swig_property(_model_container_base.descr_AlgorithmSymbol_palgi_get, _model_container_base.descr_AlgorithmSymbol_palgi_set)
    ...
    if _newclass:
        pidin = _swig_property(_model_container_base.descr_AlgorithmSymbol_pidin_get, _model_container_base.descr_AlgorithmSymbol_pidin_set)
...
class symtab_AlgorithmSymbol(_object):
    ...
    if _newclass:
        hsle = _swig_property(_model_container_base.symtab_AlgorithmSymbol_hsle_get, _model_container_base.symtab_AlgorithmSymbol_hsle_set)
    ...
    if _newclass:
        dealgs = _swig_property(_model_container_base.symtab_AlgorithmSymbol_dealgs_get, _model_container_base.symtab_AlgorithmSymbol_dealgs_set)
    ...
    if _newclass:
        pparc = _swig_property(_model_container_base.symtab_AlgorithmSymbol_pparc_get, _model_container_base.symtab_AlgorithmSymbol_pparc_set)
...
class descr_Attachment(_object):
    ...
    if _newclass:
        pcDataType = _swig_property(_model_container_base.descr_Attachment_pcDataType_get, _model_container_base.descr_Attachment_pcDataType_set)
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_Attachment_iType_get, _model_container_base.descr_Attachment_iType_set)
...
class symtab_Attachment(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Attachment_bio_get, _model_container_base.symtab_Attachment_bio_set)
    ...
    if _newclass:
        deatta = _swig_property(_model_container_base.symtab_Attachment_deatta_get, _model_container_base.symtab_Attachment_deatta_set)
...
class descr_AxonHillock(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_AxonHillock_iHappy_get, _model_container_base.descr_AxonHillock_iHappy_set)
...
class symtab_AxonHillock(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_AxonHillock_segr_get, _model_container_base.symtab_AxonHillock_segr_set)
    ...
    if _newclass:
        deaxhi = _swig_property(_model_container_base.symtab_AxonHillock_deaxhi_get, _model_container_base.symtab_AxonHillock_deaxhi_set)
...
class symtab_BioComponent(_object):
    ...
    if _newclass:
        ioh = _swig_property(_model_container_base.symtab_BioComponent_ioh_get, _model_container_base.symtab_BioComponent_ioh_set)
    ...
    if _newclass:
        pidinName = _swig_property(_model_container_base.symtab_BioComponent_pidinName_get, _model_container_base.symtab_BioComponent_pidinName_set)
    ...
    if _newclass:
        phslePrototype = _swig_property(_model_container_base.symtab_BioComponent_phslePrototype_get, _model_container_base.symtab_BioComponent_phslePrototype_set)
    ...
    if _newclass:
        iPrototype = _swig_property(_model_container_base.symtab_BioComponent_iPrototype_get, _model_container_base.symtab_BioComponent_iPrototype_set)
    ...
    if _newclass:
        pparc = _swig_property(_model_container_base.symtab_BioComponent_pparc_get, _model_container_base.symtab_BioComponent_pparc_set)
    ...
    if _newclass:
        iOptions = _swig_property(_model_container_base.symtab_BioComponent_iOptions_get, _model_container_base.symtab_BioComponent_iOptions_set)
    ...
    if _newclass:
        pcNamespace = _swig_property(_model_container_base.symtab_BioComponent_pcNamespace_get, _model_container_base.symtab_BioComponent_pcNamespace_set)
...
class descr_Cell(_object):
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_Cell_iType_get, _model_container_base.descr_Cell_iType_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.descr_Cell_iFlags_get, _model_container_base.descr_Cell_iFlags_set)
...
class symtab_Cell(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_Cell_segr_get, _model_container_base.symtab_Cell_segr_set)
    ...
    if _newclass:
        decell = _swig_property(_model_container_base.symtab_Cell_decell_get, _model_container_base.symtab_Cell_decell_set)
...
class descr_genesis_object(_object):
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_genesis_object_iType_get, _model_container_base.descr_genesis_object_iType_set)
    __swig_getmethods__['uElement'] = _model_container_base.descr_genesis_object_uElement_get
    if _newclass:
        uElement = _swig_property(_model_container_base.descr_genesis_object_uElement_get)
...
class descr_genesis_object_uElement(_object):
    ...
    if _newclass:
        tabchan = _swig_property(_model_container_base.descr_genesis_object_uElement_tabchan_get, _model_container_base.descr_genesis_object_uElement_tabchan_set)
    ...
    if _newclass:
        tab2chan = _swig_property(_model_container_base.descr_genesis_object_uElement_tab2chan_get, _model_container_base.descr_genesis_object_uElement_tab2chan_set)
    ...
    if _newclass:
        tabcurr = _swig_property(_model_container_base.descr_genesis_object_uElement_tabcurr_get, _model_container_base.descr_genesis_object_uElement_tabcurr_set)
...
class descr_Channel(_object):
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_Channel_iType_get, _model_container_base.descr_Channel_iType_set)
    ...
    if _newclass:
        pcFilename = _swig_property(_model_container_base.descr_Channel_pcFilename_get, _model_container_base.descr_Channel_pcFilename_set)
    ...
    if _newclass:
        genObject = _swig_property(_model_container_base.descr_Channel_genObject_get, _model_container_base.descr_Channel_genObject_set)
...
class symtab_Channel(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Channel_bio_get, _model_container_base.symtab_Channel_bio_set)
    ...
    if _newclass:
        dechan = _swig_property(_model_container_base.symtab_Channel_dechan_get, _model_container_base.symtab_Channel_dechan_set)
...
class descr_Connection(_object):
    ...
    if _newclass:
        iPreSynaptic = _swig_property(_model_container_base.descr_Connection_iPreSynaptic_get, _model_container_base.descr_Connection_iPreSynaptic_set)
    ...
    if _newclass:
        iPostSynaptic = _swig_property(_model_container_base.descr_Connection_iPostSynaptic_get, _model_container_base.descr_Connection_iPostSynaptic_set)
    ...
    if _newclass:
        dWeight = _swig_property(_model_container_base.descr_Connection_dWeight_get, _model_container_base.descr_Connection_dWeight_set)
    ...
    if _newclass:
        dDelay = _swig_property(_model_container_base.descr_Connection_dDelay_get, _model_container_base.descr_Connection_dDelay_set)
...
class symtab_Connection(_object):
    ...
    if _newclass:
        deconn = _swig_property(_model_container_base.symtab_Connection_deconn_get, _model_container_base.symtab_Connection_deconn_set)
...
class descr_ContourPoint(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_ContourPoint_iHappy_get, _model_container_base.descr_ContourPoint_iHappy_set)
...
class symtab_ContourPoint(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_ContourPoint_bio_get, _model_container_base.symtab_ContourPoint_bio_set)
    ...
    if _newclass:
        degatk = _swig_property(_model_container_base.symtab_ContourPoint_degatk_get, _model_container_base.symtab_ContourPoint_degatk_set)
...
class DependencyFile(_object):
    ...
    if _newclass:
        hsleLink = _swig_property(_model_container_base.DependencyFile_hsleLink_get, _model_container_base.DependencyFile_hsleLink_set)
    ...
    if _newclass:
        pcNamespace = _swig_property(_model_container_base.DependencyFile_pcNamespace_get, _model_container_base.DependencyFile_pcNamespace_set)
    ...
    if _newclass:
        pifSymbols = _swig_property(_model_container_base.DependencyFile_pifSymbols_get, _model_container_base.DependencyFile_pifSymbols_set)
...
class descr_EMContour(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_EMContour_iHappy_get, _model_container_base.descr_EMContour_iHappy_set)
...
class symtab_EMContour(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_EMContour_bio_get, _model_container_base.symtab_EMContour_bio_set)
    ...
    if _newclass:
        degatk = _swig_property(_model_container_base.symtab_EMContour_degatk_get, _model_container_base.symtab_EMContour_degatk_set)
...
class symtab_EquationExponential(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_EquationExponential_bio_get, _model_container_base.symtab_EquationExponential_bio_set)
...
class descr_Fiber(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_Fiber_iHappy_get, _model_container_base.descr_Fiber_iHappy_set)
...
class symtab_Fiber(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_Fiber_segr_get, _model_container_base.symtab_Fiber_segr_set)
    ...
    if _newclass:
        defibr = _swig_property(_model_container_base.symtab_Fiber_defibr_get, _model_container_base.symtab_Fiber_defibr_set)
...
class symtab_Function(_object):
    ...
    if _newclass:
        pparc = _swig_property(_model_container_base.symtab_Function_pparc_get, _model_container_base.symtab_Function_pparc_set)
    ...
    if _newclass:
        pcName = _swig_property(_model_container_base.symtab_Function_pcName_get, _model_container_base.symtab_Function_pcName_set)
...
class descr_GateKinetic(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_GateKinetic_iHappy_get, _model_container_base.descr_GateKinetic_iHappy_set)
...
class symtab_GateKinetic(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_GateKinetic_bio_get, _model_container_base.symtab_GateKinetic_bio_set)
    ...
    if _newclass:
        degatk = _swig_property(_model_container_base.symtab_GateKinetic_degatk_get, _model_container_base.symtab_GateKinetic_degatk_set)
...
class descr_Group(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_Group_iHappy_get, _model_container_base.descr_Group_iHappy_set)
...
class symtab_Group(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Group_bio_get, _model_container_base.symtab_Group_bio_set)
    ...
    if _newclass:
        degrup = _swig_property(_model_container_base.symtab_Group_degrup_get, _model_container_base.symtab_Group_degrup_set)
...
class symtab_GroupedParameters(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_GroupedParameters_bio_get, _model_container_base.symtab_GroupedParameters_bio_set)
...
class table_parameter_collector_data(_object):
    ...
    if _newclass:
        pcParameter = _swig_property(_model_container_base.table_parameter_collector_data_pcParameter_get, _model_container_base.table_parameter_collector_data_pcParameter_set)
    ...
    if _newclass:
        iValue = _swig_property(_model_container_base.table_parameter_collector_data_iValue_get, _model_container_base.table_parameter_collector_data_iValue_set)
...
class descr_HHGate(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_HHGate_iHappy_get, _model_container_base.descr_HHGate_iHappy_set)
...
class symtab_HHGate(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_HHGate_bio_get, _model_container_base.symtab_HHGate_bio_set)
    ...
    if _newclass:
        degathh = _swig_property(_model_container_base.symtab_HHGate_degathh_get, _model_container_base.symtab_HHGate_degathh_set)
...
class symtab_IdentifierIndex(_object):
    ...
    if _newclass:
        pidinNext = _swig_property(_model_container_base.symtab_IdentifierIndex_pidinNext_get, _model_container_base.symtab_IdentifierIndex_pidinNext_set)
    ...
    if _newclass:
        pidinRoot = _swig_property(_model_container_base.symtab_IdentifierIndex_pidinRoot_get, _model_container_base.symtab_IdentifierIndex_pidinRoot_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.symtab_IdentifierIndex_iFlags_get, _model_container_base.symtab_IdentifierIndex_iFlags_set)
    ...
    if _newclass:
        pcIdentifier = _swig_property(_model_container_base.symtab_IdentifierIndex_pcIdentifier_get, _model_container_base.symtab_IdentifierIndex_pcIdentifier_set)
...
class Test(_object):
    ...
    if _newclass:
        field_id = _swig_property(_model_container_base.Test_field_id_get, _model_container_base.Test_field_id_set)
    __swig_setmethods__['name'] = _model_container_base.Test_name_set
    __swig_getmethods__['name'] = _model_container_base.Test_name_get
    if _newclass:
        name = _swig_property(_model_container_base.Test_name_get, _model_container_base.Test_name_set)
    __swig_setmethods__['op'] = _model_container_base.Test_op_set
    __swig_getmethods__['op'] = _model_container_base.Test_op_get
    if _newclass:
        op = _swig_property(_model_container_base.Test_op_get, _model_container_base.Test_op_set)
    ...
    if _newclass:
        value = _swig_property(_model_container_base.Test_value_get, _model_container_base.Test_value_set)
    __swig_setmethods__['next'] = _model_container_base.Test_next_set
    __swig_getmethods__['next'] = _model_container_base.Test_next_get
    if _newclass:
        next = _swig_property(_model_container_base.Test_next_get, _model_container_base.Test_next_set)
...
class PathInfo(_object):
    ...
    if _newclass:
        path = _swig_property(_model_container_base.PathInfo_path_get, _model_container_base.PathInfo_path_set)
    ...
    if _newclass:
        test = _swig_property(_model_container_base.PathInfo_test_get, _model_container_base.PathInfo_test_set)
...
class symtab_IdentifierIndexSelector(_object):
    ...
    if _newclass:
        pidinNext = _swig_property(_model_container_base.symtab_IdentifierIndexSelector_pidinNext_get, _model_container_base.symtab_IdentifierIndexSelector_pidinNext_set)
    ...
    if _newclass:
        pidinRoot = _swig_property(_model_container_base.symtab_IdentifierIndexSelector_pidinRoot_get, _model_container_base.symtab_IdentifierIndexSelector_pidinRoot_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.symtab_IdentifierIndexSelector_iFlags_get, _model_container_base.symtab_IdentifierIndexSelector_iFlags_set)
    ...
    if _newclass:
        pcIdentifier = _swig_property(_model_container_base.symtab_IdentifierIndexSelector_pcIdentifier_get, _model_container_base.symtab_IdentifierIndexSelector_pcIdentifier_set)
    ...
    if _newclass:
        pinfo = _swig_property(_model_container_base.symtab_IdentifierIndexSelector_pinfo_get, _model_container_base.symtab_IdentifierIndexSelector_pinfo_set)
...
class ImportedFile(_object):
    ...
    if _newclass:
        hsleLink = _swig_property(_model_container_base.ImportedFile_hsleLink_get, _model_container_base.ImportedFile_hsleLink_set)
    ...
    if _newclass:
        pcQualified = _swig_property(_model_container_base.ImportedFile_pcQualified_get, _model_container_base.ImportedFile_pcQualified_set)
    ...
    if _newclass:
        pcRelative = _swig_property(_model_container_base.ImportedFile_pcRelative_get, _model_container_base.ImportedFile_pcRelative_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.ImportedFile_iFlags_get, _model_container_base.ImportedFile_iFlags_set)
    ...
    if _newclass:
        pdefsym = _swig_property(_model_container_base.ImportedFile_pdefsym_get, _model_container_base.ImportedFile_pdefsym_set)
...
class symtab_InputOutput(_object):
    ...
    if _newclass:
        pioNext = _swig_property(_model_container_base.symtab_InputOutput_pioNext_get, _model_container_base.symtab_InputOutput_pioNext_set)
    ...
    if _newclass:
        pioFirst = _swig_property(_model_container_base.symtab_InputOutput_pioFirst_get, _model_container_base.symtab_InputOutput_pioFirst_set)
    ...
    if _newclass:
        pidinField = _swig_property(_model_container_base.symtab_InputOutput_pidinField_get, _model_container_base.symtab_InputOutput_pidinField_set)
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.symtab_InputOutput_iType_get, _model_container_base.symtab_InputOutput_iType_set)
    ...
    if _newclass:
        pcType = _swig_property(_model_container_base.symtab_InputOutput_pcType_get, _model_container_base.symtab_InputOutput_pcType_set)
...
class symtab_IOContainer(_object):
    ...
    if _newclass:
        pio = _swig_property(_model_container_base.symtab_IOContainer_pio_get, _model_container_base.symtab_IOContainer_pio_set)
...
class descr_Izhikevich(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_Izhikevich_iHappy_get, _model_container_base.descr_Izhikevich_iHappy_set)
...
class symtab_Izhikevich(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_Izhikevich_segr_get, _model_container_base.symtab_Izhikevich_segr_set)
    ...
    if _newclass:
        deihzi = _swig_property(_model_container_base.symtab_Izhikevich_deihzi_get, _model_container_base.symtab_Izhikevich_deihzi_set)
...
class symtab_IOHierarchy(_object):
    ...
    if _newclass:
        iol = _swig_property(_model_container_base.symtab_IOHierarchy_iol_get, _model_container_base.symtab_IOHierarchy_iol_set)
    ...
    if _newclass:
        iohc = _swig_property(_model_container_base.symtab_IOHierarchy_iohc_get, _model_container_base.symtab_IOHierarchy_iohc_set)
...
class symtab_IOList(_object):
    ...
    if _newclass:
        hsle = _swig_property(_model_container_base.symtab_IOList_hsle_get, _model_container_base.symtab_IOList_hsle_set)
    ...
    if _newclass:
        piocBindable = _swig_property(_model_container_base.symtab_IOList_piocBindable_get, _model_container_base.symtab_IOList_piocBindable_set)
    ...
    if _newclass:
        piocInputs = _swig_property(_model_container_base.symtab_IOList_piocInputs_get, _model_container_base.symtab_IOList_piocInputs_set)
...
class descr_Network(_object):
    ...
    if _newclass:
        iDummy = _swig_property(_model_container_base.descr_Network_iDummy_get, _model_container_base.descr_Network_iDummy_set)
...
class symtab_Network(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_Network_segr_get, _model_container_base.symtab_Network_segr_set)
    ...
    if _newclass:
        denetw = _swig_property(_model_container_base.symtab_Network_denetw_get, _model_container_base.symtab_Network_denetw_set)
...
class NeurospacesOptions(_object):
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.NeurospacesOptions_iFlags_get, _model_container_base.NeurospacesOptions_iFlags_set)
    ...
    if _newclass:
        iVerbosity = _swig_property(_model_container_base.NeurospacesOptions_iVerbosity_get, _model_container_base.NeurospacesOptions_iVerbosity_set)
    ...
    if _newclass:
        pfileDebug = _swig_property(_model_container_base.NeurospacesOptions_pfileDebug_get, _model_container_base.NeurospacesOptions_pfileDebug_set)
    ...
    if _newclass:
        iTiming = _swig_property(_model_container_base.NeurospacesOptions_iTiming_get, _model_container_base.NeurospacesOptions_iTiming_set)
    ...
    if _newclass:
        tvStart = _swig_property(_model_container_base.NeurospacesOptions_tvStart_get, _model_container_base.NeurospacesOptions_tvStart_set)
    ...
    if _newclass:
        pcModelLibrary = _swig_property(_model_container_base.NeurospacesOptions_pcModelLibrary_get, _model_container_base.NeurospacesOptions_pcModelLibrary_set)
...
class NeurospacesConfig(_object):
    ...
    if _newclass:
        iArgc = _swig_property(_model_container_base.NeurospacesConfig_iArgc_get, _model_container_base.NeurospacesConfig_iArgc_set)
    ...
    if _newclass:
        ppcArgv = _swig_property(_model_container_base.NeurospacesConfig_ppcArgv_get, _model_container_base.NeurospacesConfig_ppcArgv_set)
    ...
    if _newclass:
        nso = _swig_property(_model_container_base.NeurospacesConfig_nso_get, _model_container_base.NeurospacesConfig_nso_set)
    ...
    if _newclass:
        pcFiles = _swig_property(_model_container_base.NeurospacesConfig_pcFiles_get, _model_container_base.NeurospacesConfig_pcFiles_set)
    ...
    if _newclass:
        pcQueries = _swig_property(_model_container_base.NeurospacesConfig_pcQueries_get, _model_container_base.NeurospacesConfig_pcQueries_set)
...
class Neurospaces(_object):
    ...
    if _newclass:
        psym = _swig_property(_model_container_base.Neurospaces_psym_get, _model_container_base.Neurospaces_psym_set)
    ...
    if _newclass:
        ppq = _swig_property(_model_container_base.Neurospaces_ppq_get, _model_container_base.Neurospaces_ppq_set)
    ...
    if _newclass:
        psr = _swig_property(_model_container_base.Neurospaces_psr_get, _model_container_base.Neurospaces_psr_set)
    ...
    if _newclass:
        pnsc = _swig_property(_model_container_base.Neurospaces_pnsc_get, _model_container_base.Neurospaces_pnsc_set)
    ...
    if _newclass:
        pacRootContext = _swig_property(_model_container_base.Neurospaces_pacRootContext_get, _model_container_base.Neurospaces_pacRootContext_set)
    ...
    if _newclass:
        iErrorCount = _swig_property(_model_container_base.Neurospaces_iErrorCount_get, _model_container_base.Neurospaces_iErrorCount_set)
    ...
    if _newclass:
        iFileParseCount = _swig_property(_model_container_base.Neurospaces_iFileParseCount_get, _model_container_base.Neurospaces_iFileParseCount_set)
    ...
    if _newclass:
        pcr = _swig_property(_model_container_base.Neurospaces_pcr_get, _model_container_base.Neurospaces_pcr_set)
    ...
    if _newclass:
        pifRootImport = _swig_property(_model_container_base.Neurospaces_pifRootImport_get, _model_container_base.Neurospaces_pifRootImport_set)
...
class symtab_Parameters(_object):
    ...
    if _newclass:
        pparNext = _swig_property(_model_container_base.symtab_Parameters_pparNext_get, _model_container_base.symtab_Parameters_pparNext_set)
    ...
    if _newclass:
        pparPrev = _swig_property(_model_container_base.symtab_Parameters_pparPrev_get, _model_container_base.symtab_Parameters_pparPrev_set)
    ...
    if _newclass:
        pparFirst = _swig_property(_model_container_base.symtab_Parameters_pparFirst_get, _model_container_base.symtab_Parameters_pparFirst_set)
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.symtab_Parameters_iType_get, _model_container_base.symtab_Parameters_iType_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.symtab_Parameters_iFlags_get, _model_container_base.symtab_Parameters_iFlags_set)
    ...
    if _newclass:
        pcIdentifier = _swig_property(_model_container_base.symtab_Parameters_pcIdentifier_get, _model_container_base.symtab_Parameters_pcIdentifier_set)
    __swig_getmethods__['uValue'] = _model_container_base.symtab_Parameters_uValue_get
    if _newclass:
        uValue = _swig_property(_model_container_base.symtab_Parameters_uValue_get)
...
class symtab_Parameters_uValue(_object):
    ...
    if _newclass:
        dNumber = _swig_property(_model_container_base.symtab_Parameters_uValue_dNumber_get, _model_container_base.symtab_Parameters_uValue_dNumber_set)
    ...
    if _newclass:
        pidin = _swig_property(_model_container_base.symtab_Parameters_uValue_pidin_get, _model_container_base.symtab_Parameters_uValue_pidin_set)
    ...
    if _newclass:
        pcString = _swig_property(_model_container_base.symtab_Parameters_uValue_pcString_get, _model_container_base.symtab_Parameters_uValue_pcString_set)
    ...
    if _newclass:
        pfun = _swig_property(_model_container_base.symtab_Parameters_uValue_pfun_get, _model_container_base.symtab_Parameters_uValue_pfun_set)
...
class ParserContext(_object):
    ...
    if _newclass:
        pacNext = _swig_property(_model_container_base.ParserContext_pacNext_get, _model_container_base.ParserContext_pacNext_set)
    ...
    if _newclass:
        pacPrev = _swig_property(_model_container_base.ParserContext_pacPrev_get, _model_container_base.ParserContext_pacPrev_set)
    ...
    if _newclass:
        pcFilename = _swig_property(_model_container_base.ParserContext_pcFilename_get, _model_container_base.ParserContext_pcFilename_set)
    ...
    if _newclass:
        pcDirectory = _swig_property(_model_container_base.ParserContext_pcDirectory_get, _model_container_base.ParserContext_pcDirectory_set)
    ...
    if _newclass:
        iLineNumber = _swig_property(_model_container_base.ParserContext_iLineNumber_get, _model_container_base.ParserContext_iLineNumber_set)
    ...
    if _newclass:
        iNestingLevel = _swig_property(_model_container_base.ParserContext_iNestingLevel_get, _model_container_base.ParserContext_iNestingLevel_set)
    ...
    if _newclass:
        pFILE = _swig_property(_model_container_base.ParserContext_pFILE_get, _model_container_base.ParserContext_pFILE_set)
    ...
    if _newclass:
        pyyBuffer = _swig_property(_model_container_base.ParserContext_pyyBuffer_get, _model_container_base.ParserContext_pyyBuffer_set)
    ...
    if _newclass:
        pifInParse = _swig_property(_model_container_base.ParserContext_pifInParse_get, _model_container_base.ParserContext_pifInParse_set)
    ...
    if _newclass:
        pneuro = _swig_property(_model_container_base.ParserContext_pneuro_get, _model_container_base.ParserContext_pneuro_set)
    ...
    if _newclass:
        iState = _swig_property(_model_container_base.ParserContext_iState_get, _model_container_base.ParserContext_iState_set)
    ...
    if _newclass:
        pist = _swig_property(_model_container_base.ParserContext_pist_get, _model_container_base.ParserContext_pist_set)
    ...
    if _newclass:
        phsleActual = _swig_property(_model_container_base.ParserContext_phsleActual_get, _model_container_base.ParserContext_phsleActual_set)
...
class PidinStack(_object):
    ...
    if _newclass:
        iTop = _swig_property(_model_container_base.PidinStack_iTop_get, _model_container_base.PidinStack_iTop_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.PidinStack_iFlags_get, _model_container_base.PidinStack_iFlags_set)
    ...
    if _newclass:
        ppidin = _swig_property(_model_container_base.PidinStack_ppidin_get, _model_container_base.PidinStack_ppidin_set)
    ...
    if _newclass:
        symsst = _swig_property(_model_container_base.PidinStack_symsst_get, _model_container_base.PidinStack_symsst_set)
...
class descr_Pool(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_Pool_iHappy_get, _model_container_base.descr_Pool_iHappy_set)
...
class symtab_Pool(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Pool_bio_get, _model_container_base.symtab_Pool_bio_set)
    ...
    if _newclass:
        depool = _swig_property(_model_container_base.symtab_Pool_depool_get, _model_container_base.symtab_Pool_depool_set)
...
class descr_Population(_object):
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_Population_iType_get, _model_container_base.descr_Population_iType_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.descr_Population_iFlags_get, _model_container_base.descr_Population_iFlags_set)
...
class symtab_Population(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_Population_segr_get, _model_container_base.symtab_Population_segr_set)
    ...
    if _newclass:
        depopu = _swig_property(_model_container_base.symtab_Population_depopu_get, _model_container_base.symtab_Population_depopu_set)
...
class D3Position(_object):
    ...
    if _newclass:
        dx = _swig_property(_model_container_base.D3Position_dx_get, _model_container_base.D3Position_dx_set)
    ...
    if _newclass:
        dy = _swig_property(_model_container_base.D3Position_dy_get, _model_container_base.D3Position_dy_set)
    ...
    if _newclass:
        dz = _swig_property(_model_container_base.D3Position_dz_get, _model_container_base.D3Position_dz_set)
...
class descr_Projection(_object):
    ...
    if _newclass:
        iDummy = _swig_property(_model_container_base.descr_Projection_iDummy_get, _model_container_base.descr_Projection_iDummy_set)
...
class symtab_Projection(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Projection_bio_get, _model_container_base.symtab_Projection_bio_set)
    ...
    if _newclass:
        deproj = _swig_property(_model_container_base.symtab_Projection_deproj_get, _model_container_base.symtab_Projection_deproj_set)
...
class PQ_ConnsForTarget_Result(_object):
    ...
    if _newclass:
        iConnections = _swig_property(_model_container_base.PQ_ConnsForTarget_Result_iConnections_get, _model_container_base.PQ_ConnsForTarget_Result_iConnections_set)
    ...
    if _newclass:
        pproj = _swig_property(_model_container_base.PQ_ConnsForTarget_Result_pproj_get, _model_container_base.PQ_ConnsForTarget_Result_pproj_set)
    ...
    if _newclass:
        ppistProjection = _swig_property(_model_container_base.PQ_ConnsForTarget_Result_ppistProjection_get, _model_container_base.PQ_ConnsForTarget_Result_ppistProjection_set)
    ...
    if _newclass:
        ppistTarget = _swig_property(_model_container_base.PQ_ConnsForTarget_Result_ppistTarget_get, _model_container_base.PQ_ConnsForTarget_Result_ppistTarget_set)
...
class PQ_ConnsForSpikegen_Result(_object):
    ...
    if _newclass:
        pproj = _swig_property(_model_container_base.PQ_ConnsForSpikegen_Result_pproj_get, _model_container_base.PQ_ConnsForSpikegen_Result_pproj_set)
    ...
    if _newclass:
        ppistProjection = _swig_property(_model_container_base.PQ_ConnsForSpikegen_Result_ppistProjection_get, _model_container_base.PQ_ConnsForSpikegen_Result_ppistProjection_set)
    ...
    if _newclass:
        ppistSpikegen = _swig_property(_model_container_base.PQ_ConnsForSpikegen_Result_ppistSpikegen_get, _model_container_base.PQ_ConnsForSpikegen_Result_ppistSpikegen_set)
    ...
    if _newclass:
        pfProcessor = _swig_property(_model_container_base.PQ_ConnsForSpikegen_Result_pfProcessor_get, _model_container_base.PQ_ConnsForSpikegen_Result_pfProcessor_set)
    ...
    if _newclass:
        pfFinalizer = _swig_property(_model_container_base.PQ_ConnsForSpikegen_Result_pfFinalizer_get, _model_container_base.PQ_ConnsForSpikegen_Result_pfFinalizer_set)
    ...
    if _newclass:
        pvUserdata = _swig_property(_model_container_base.PQ_ConnsForSpikegen_Result_pvUserdata_get, _model_container_base.PQ_ConnsForSpikegen_Result_pvUserdata_set)
...
class PQ_ConnsForPreSerial_Result(_object):
    ...
    if _newclass:
        pproj = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_pproj_get, _model_container_base.PQ_ConnsForPreSerial_Result_pproj_set)
    ...
    if _newclass:
        ppistProjection = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_ppistProjection_get, _model_container_base.PQ_ConnsForPreSerial_Result_ppistProjection_set)
    ...
    if _newclass:
        ppistSpikeGenerator = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_ppistSpikeGenerator_get, _model_container_base.PQ_ConnsForPreSerial_Result_ppistSpikeGenerator_set)
    ...
    if _newclass:
        iPre = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_iPre_get, _model_container_base.PQ_ConnsForPreSerial_Result_iPre_set)
    ...
    if _newclass:
        pfProcessor = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_pfProcessor_get, _model_container_base.PQ_ConnsForPreSerial_Result_pfProcessor_set)
    ...
    if _newclass:
        pfFinalizer = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_pfFinalizer_get, _model_container_base.PQ_ConnsForPreSerial_Result_pfFinalizer_set)
    ...
    if _newclass:
        pvUserdata = _swig_property(_model_container_base.PQ_ConnsForPreSerial_Result_pvUserdata_get, _model_container_base.PQ_ConnsForPreSerial_Result_pvUserdata_set)
...
class PQ_ConnsForSpikerec_Result(_object):
    ...
    if _newclass:
        pproj = _swig_property(_model_container_base.PQ_ConnsForSpikerec_Result_pproj_get, _model_container_base.PQ_ConnsForSpikerec_Result_pproj_set)
    ...
    if _newclass:
        ppistProjection = _swig_property(_model_container_base.PQ_ConnsForSpikerec_Result_ppistProjection_get, _model_container_base.PQ_ConnsForSpikerec_Result_ppistProjection_set)
    ...
    if _newclass:
        ppistSpikerec = _swig_property(_model_container_base.PQ_ConnsForSpikerec_Result_ppistSpikerec_get, _model_container_base.PQ_ConnsForSpikerec_Result_ppistSpikerec_set)
    ...
    if _newclass:
        pfProcessor = _swig_property(_model_container_base.PQ_ConnsForSpikerec_Result_pfProcessor_get, _model_container_base.PQ_ConnsForSpikerec_Result_pfProcessor_set)
    ...
    if _newclass:
        pfFinalizer = _swig_property(_model_container_base.PQ_ConnsForSpikerec_Result_pfFinalizer_get, _model_container_base.PQ_ConnsForSpikerec_Result_pfFinalizer_set)
    ...
    if _newclass:
        pvUserdata = _swig_property(_model_container_base.PQ_ConnsForSpikerec_Result_pvUserdata_get, _model_container_base.PQ_ConnsForSpikerec_Result_pvUserdata_set)
...
class PQ_ConnsForPostSerial_Result(_object):
    ...
    if _newclass:
        pproj = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_pproj_get, _model_container_base.PQ_ConnsForPostSerial_Result_pproj_set)
    ...
    if _newclass:
        ppistProjection = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_ppistProjection_get, _model_container_base.PQ_ConnsForPostSerial_Result_ppistProjection_set)
    ...
    if _newclass:
        ppistSpikeReceiver = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_ppistSpikeReceiver_get, _model_container_base.PQ_ConnsForPostSerial_Result_ppistSpikeReceiver_set)
    ...
    if _newclass:
        iPost = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_iPost_get, _model_container_base.PQ_ConnsForPostSerial_Result_iPost_set)
    ...
    if _newclass:
        pfProcessor = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_pfProcessor_get, _model_container_base.PQ_ConnsForPostSerial_Result_pfProcessor_set)
    ...
    if _newclass:
        pfFinalizer = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_pfFinalizer_get, _model_container_base.PQ_ConnsForPostSerial_Result_pfFinalizer_set)
    ...
    if _newclass:
        pvUserdata = _swig_property(_model_container_base.PQ_ConnsForPostSerial_Result_pvUserdata_get, _model_container_base.PQ_ConnsForPostSerial_Result_pvUserdata_set)
...
class descr_Randomvalue(_object):
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_Randomvalue_iType_get, _model_container_base.descr_Randomvalue_iType_set)
...
class symtab_Randomvalue(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Randomvalue_bio_get, _model_container_base.symtab_Randomvalue_bio_set)
    ...
    if _newclass:
        deranv = _swig_property(_model_container_base.symtab_Randomvalue_deranv_get, _model_container_base.symtab_Randomvalue_deranv_set)
...
class descr_Segment(_object):
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.descr_Segment_iType_get, _model_container_base.descr_Segment_iType_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.descr_Segment_iFlags_get, _model_container_base.descr_Segment_iFlags_set)
...
class symtab_Segment(_object):
    ...
    if _newclass:
        segr = _swig_property(_model_container_base.symtab_Segment_segr_get, _model_container_base.symtab_Segment_segr_set)
    ...
    if _newclass:
        desegment = _swig_property(_model_container_base.symtab_Segment_desegment_get, _model_container_base.symtab_Segment_desegment_set)
...
class cable_structure(_object):
    ...
    if _newclass:
        iSerial = _swig_property(_model_container_base.cable_structure_iSerial_get, _model_container_base.cable_structure_iSerial_set)
    ...
    if _newclass:
        iParentSerial = _swig_property(_model_container_base.cable_structure_iParentSerial_get, _model_container_base.cable_structure_iParentSerial_set)
    ...
    if _newclass:
        iParentIndex = _swig_property(_model_container_base.cable_structure_iParentIndex_get, _model_container_base.cable_structure_iParentIndex_set)
...
class descr_Segmenter(_object):
    ...
    if _newclass:
        iSegments = _swig_property(_model_container_base.descr_Segmenter_iSegments_get, _model_container_base.descr_Segmenter_iSegments_set)
    ...
    if _newclass:
        iNoParents = _swig_property(_model_container_base.descr_Segmenter_iNoParents_get, _model_container_base.descr_Segmenter_iNoParents_set)
    ...
    if _newclass:
        iTips = _swig_property(_model_container_base.descr_Segmenter_iTips_get, _model_container_base.descr_Segmenter_iTips_set)
    ...
    if _newclass:
        pcs = _swig_property(_model_container_base.descr_Segmenter_pcs_get, _model_container_base.descr_Segmenter_pcs_set)
    ...
    if _newclass:
        piChildren = _swig_property(_model_container_base.descr_Segmenter_piChildren_get, _model_container_base.descr_Segmenter_piChildren_set)
    ...
    if _newclass:
        ppiChildren = _swig_property(_model_container_base.descr_Segmenter_ppiChildren_get, _model_container_base.descr_Segmenter_ppiChildren_set)
...
class symtab_Segmenter(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Segmenter_bio_get, _model_container_base.symtab_Segmenter_bio_set)
    ...
    if _newclass:
        desegmenter = _swig_property(_model_container_base.symtab_Segmenter_desegmenter_get, _model_container_base.symtab_Segmenter_desegmenter_set)
...
class SolverInfo(_object):
    ...
    if _newclass:
        pcSolver = _swig_property(_model_container_base.SolverInfo_pcSolver_get, _model_container_base.SolverInfo_pcSolver_set)
    ...
    if _newclass:
        pvSolver = _swig_property(_model_container_base.SolverInfo_pvSolver_get, _model_container_base.SolverInfo_pvSolver_set)
    ...
    if _newclass:
        ppist = _swig_property(_model_container_base.SolverInfo_ppist_get, _model_container_base.SolverInfo_ppist_set)
...
class SolverRegistry(_object):
    ...
    if _newclass:
        ppsiRegistrations = _swig_property(_model_container_base.SolverRegistry_ppsiRegistrations_get, _model_container_base.SolverRegistry_ppsiRegistrations_set)
    ...
    if _newclass:
        iRegistrationMax = _swig_property(_model_container_base.SolverRegistry_iRegistrationMax_get, _model_container_base.SolverRegistry_iRegistrationMax_set)
    ...
    if _newclass:
        iRegistrations = _swig_property(_model_container_base.SolverRegistry_iRegistrations_get, _model_container_base.SolverRegistry_iRegistrations_set)
...
class Symbols(_object):
    ...
    if _newclass:
        hslFiles = _swig_property(_model_container_base.Symbols_hslFiles_get, _model_container_base.Symbols_hslFiles_set)
    ...
    if _newclass:
        pas = _swig_property(_model_container_base.Symbols_pas_get, _model_container_base.Symbols_pas_set)
...
class symtab_String(_object):
    ...
    if _newclass:
        pcString = _swig_property(_model_container_base.symtab_String_pcString_get, _model_container_base.symtab_String_pcString_set)
    ...
    if _newclass:
        iLength = _swig_property(_model_container_base.symtab_String_iLength_get, _model_container_base.symtab_String_iLength_set)
...
class SerialMapper(_object):
    ...
    if _newclass:
        iSuccessors = _swig_property(_model_container_base.SerialMapper_iSuccessors_get, _model_container_base.SerialMapper_iSuccessors_set)
    ...
    if _newclass:
        iParent = _swig_property(_model_container_base.SerialMapper_iParent_get, _model_container_base.SerialMapper_iParent_set)
...
class symtab_HSolveListElement(_object):
    ...
    if _newclass:
        hsleLink = _swig_property(_model_container_base.symtab_HSolveListElement_hsleLink_get, _model_container_base.symtab_HSolveListElement_hsleLink_set)
    ...
    if _newclass:
        iAllocationIdentifier = _swig_property(_model_container_base.symtab_HSolveListElement_iAllocationIdentifier_get, _model_container_base.symtab_HSolveListElement_iAllocationIdentifier_set)
    ...
    if _newclass:
        palgi = _swig_property(_model_container_base.symtab_HSolveListElement_palgi_get, _model_container_base.symtab_HSolveListElement_palgi_set)
    ...
    if _newclass:
        pparcac = _swig_property(_model_container_base.symtab_HSolveListElement_pparcac_get, _model_container_base.symtab_HSolveListElement_pparcac_set)
    ...
    if _newclass:
        pparReferences = _swig_property(_model_container_base.symtab_HSolveListElement_pparReferences_get, _model_container_base.symtab_HSolveListElement_pparReferences_set)
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.symtab_HSolveListElement_iType_get, _model_container_base.symtab_HSolveListElement_iType_set)
    ...
    if _newclass:
        smapInvisible = _swig_property(_model_container_base.symtab_HSolveListElement_smapInvisible_get, _model_container_base.symtab_HSolveListElement_smapInvisible_set)
    ...
    if _newclass:
        smapPrincipal = _swig_property(_model_container_base.symtab_HSolveListElement_smapPrincipal_get, _model_container_base.symtab_HSolveListElement_smapPrincipal_set)
...
class TreespaceTraversal(_object):
    ...
    if _newclass:
        iStatus = _swig_property(_model_container_base.TreespaceTraversal_iStatus_get, _model_container_base.TreespaceTraversal_iStatus_set)
    ...
    if _newclass:
        iFlags = _swig_property(_model_container_base.TreespaceTraversal_iFlags_get, _model_container_base.TreespaceTraversal_iFlags_set)
    ...
    if _newclass:
        iFirstEntry = _swig_property(_model_container_base.TreespaceTraversal_iFirstEntry_get, _model_container_base.TreespaceTraversal_iFirstEntry_set)
    ...
    if _newclass:
        pcrActual = _swig_property(_model_container_base.TreespaceTraversal_pcrActual_get, _model_container_base.TreespaceTraversal_pcrActual_set)
    ...
    if _newclass:
        iType = _swig_property(_model_container_base.TreespaceTraversal_iType_get, _model_container_base.TreespaceTraversal_iType_set)
    ...
    if _newclass:
        ppist = _swig_property(_model_container_base.TreespaceTraversal_ppist_get, _model_container_base.TreespaceTraversal_ppist_set)
    ...
    if _newclass:
        psymst = _swig_property(_model_container_base.TreespaceTraversal_psymst_get, _model_container_base.TreespaceTraversal_psymst_set)
    ...
    if _newclass:
        iSerialPrincipal = _swig_property(_model_container_base.TreespaceTraversal_iSerialPrincipal_get, _model_container_base.TreespaceTraversal_iSerialPrincipal_set)
    ...
    if _newclass:
        iSerialSegment = _swig_property(_model_container_base.TreespaceTraversal_iSerialSegment_get, _model_container_base.TreespaceTraversal_iSerialSegment_set)
    ...
    if _newclass:
        iSerialMechanism = _swig_property(_model_container_base.TreespaceTraversal_iSerialMechanism_get, _model_container_base.TreespaceTraversal_iSerialMechanism_set)
    ...
    if _newclass:
        pfPreSelector = _swig_property(_model_container_base.TreespaceTraversal_pfPreSelector_get, _model_container_base.TreespaceTraversal_pfPreSelector_set)
    ...
    if _newclass:
        pfProcessor = _swig_property(_model_container_base.TreespaceTraversal_pfProcessor_get, _model_container_base.TreespaceTraversal_pfProcessor_set)
    ...
    if _newclass:
        pfFinalizer = _swig_property(_model_container_base.TreespaceTraversal_pfFinalizer_get, _model_container_base.TreespaceTraversal_pfFinalizer_set)
    ...
    if _newclass:
        pvPreSelector = _swig_property(_model_container_base.TreespaceTraversal_pvPreSelector_get, _model_container_base.TreespaceTraversal_pvPreSelector_set)
    ...
    if _newclass:
        pvProcessor = _swig_property(_model_container_base.TreespaceTraversal_pvProcessor_get, _model_container_base.TreespaceTraversal_pvProcessor_set)
    ...
    if _newclass:
        pvFinalizer = _swig_property(_model_container_base.TreespaceTraversal_pvFinalizer_get, _model_container_base.TreespaceTraversal_pvFinalizer_set)
...
class descr_Vector(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_Vector_iHappy_get, _model_container_base.descr_Vector_iHappy_set)
...
class symtab_Vector(_object):
    ...
    if _newclass:
        bio = _swig_property(_model_container_base.symtab_Vector_bio_get, _model_container_base.symtab_Vector_bio_set)
    ...
    if _newclass:
        devect = _swig_property(_model_container_base.symtab_Vector_devect_get, _model_container_base.symtab_Vector_devect_set)
...
class descr_VConnectionSymbol(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_VConnectionSymbol_iHappy_get, _model_container_base.descr_VConnectionSymbol_iHappy_set)
...
class symtab_VConnectionSymbol(_object):
    ...
    if _newclass:
        vect = _swig_property(_model_container_base.symtab_VConnectionSymbol_vect_get, _model_container_base.symtab_VConnectionSymbol_vect_set)
    ...
    if _newclass:
        devconsy = _swig_property(_model_container_base.symtab_VConnectionSymbol_devconsy_get, _model_container_base.symtab_VConnectionSymbol_devconsy_set)
...
class descr_VContour(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_VContour_iHappy_get, _model_container_base.descr_VContour_iHappy_set)
...
class symtab_VContour(_object):
    ...
    if _newclass:
        vect = _swig_property(_model_container_base.symtab_VContour_vect_get, _model_container_base.symtab_VContour_vect_set)
    ...
    if _newclass:
        devcont = _swig_property(_model_container_base.symtab_VContour_devcont_get, _model_container_base.symtab_VContour_devcont_set)
...
class descr_VSegment(_object):
    ...
    if _newclass:
        iHappy = _swig_property(_model_container_base.descr_VSegment_iHappy_get, _model_container_base.descr_VSegment_iHappy_set)
...
class symtab_VSegment(_object):
    ...
    if _newclass:
        vect = _swig_property(_model_container_base.symtab_VSegment_vect_get, _model_container_base.symtab_VSegment_vect_set)
    ...
    if _newclass:
        devsegm = _swig_property(_model_container_base.symtab_VSegment_devsegm_get, _model_container_base.symtab_VSegment_devsegm_set)
