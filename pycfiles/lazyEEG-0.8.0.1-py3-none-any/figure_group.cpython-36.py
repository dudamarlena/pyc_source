...
# [GCC 8.4.0]
# Embedded file name: D:\Coding\py\IPython Notebooks\experiment\lazyEEG\graph\figure_group.py
# Compiled at: 2017-12-25 13:41:07
# Size of source mod 2**32: 7420 bytes
from ..default import *
    ...
    for idx in range(len(self.data)):
        ...
        if plot_params['plot_type'][0] == 'direct':
            ...
            if plot_params['plot_type'][0] == 'matrix':
                matrix_plot(fig, self.data[idx], self.annotation[idx], plot_params['x_title'], plot_params['y_title'], plot_params)
            else:
                if plot_params['plot_type'][0] == 'float':
                    float_plot(fig, self.data[idx], self.annotation[idx], plot_params['xy_locs'], plot_params)
                else:
