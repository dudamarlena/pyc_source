...
# Compiled at: 2020-04-24 04:38:01
...
if lib:
    ...
    def performBatchDetect(thresh=0.25, configPath='./cfg/yolov3.cfg', weightPath='yolov3.weights', metaPath='./cfg/coco.data', hier_thresh=0.5, nms=0.45, batch_size=3):
