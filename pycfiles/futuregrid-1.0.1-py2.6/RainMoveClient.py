...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/futuregrid/rain/move/RainMoveClient.py
# Compiled at: 2012-05-09 14:39:02
"""
...
class RainMoveClient(object):
    ...
    def move(self):
        ...
        try:
            rainMoveServer = ssl.wrap_socket(s, ca_certs=self._ca_certs, certfile=self._certfile, keyfile=self._keyfile, cert_reqs=ssl.CERT_REQUIRED, ssl_version=ssl.PROTOCOL_TLSv1)
...
def main():
    parser = argparse.ArgumentParser(prog='fg-move', formatter_class=argparse.RawDescriptionHelpFormatter, description='FutureGrid Rain Move Help', epilog=textwrap.dedent(extra_help()))
