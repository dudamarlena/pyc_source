...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/futuregrid/image/management/IMServerConf.py
...
class IMServerConf(object):
    ...
    def load_registerServerXcatConfig(self):
        ...
        try:
            ...
            centos_temp = ('').join(centos_temp.split())
            centos_temp1 = centos_temp.split(';')
            for i in range(len(centos_temp1)):
        ...
        try:
            ...
            ubuntu_temp = ('').join(ubuntu_temp.split())
            ubuntu_temp1 = ubuntu_temp.split(';')
            for i in range(len(ubuntu_temp1)):
        ...
        try:
            ...
            protectedimg = ('').join(protectedimg.split())
        ...
        try:
            ...
            for i in kernels:
                ...
                if len(parts) < 3:
                    ...
                    sys.exit(1)
                self._euca_auth_kernels[parts[0].strip()] = [
        ...
        try:
            ...
            for i in kernels:
                ...
                if len(parts) < 3:
                    ...
                    print 'Each kernel has three components kernel:eki:eri (Eucalyptus and OpenStack) or kernel:kernel:kernel (Nimbus) or kernel:path:path (OpenNebula)'
                    sys.exit(1)
                self._nimbus_auth_kernels[parts[0].strip()] = [
                 parts[1].strip(), parts[2].strip()]
        ...
        try:
            ...
            for i in kernels:
                ...
                if len(parts) < 3:
                    ...
                    print 'Each kernel has three components kernel:eki:eri (Eucalyptus and OpenStack) or kernel:kernel:kernel (Nimbus) or kernel:path:path (OpenNebula)'
                    sys.exit(1)
                self._openstack_auth_kernels[parts[0].strip()] = [
                 parts[1].strip(), parts[2].strip()]
        ...
        try:
            ...
            for i in kernels:
                ...
                if len(parts) < 3:
                    ...
                    print 'Each kernel has three components kernel:eki:eri (Eucalyptus and OpenStack) or kernel:kernel:kernel (Nimbus) or kernel:path:path (OpenNebula)'
                    sys.exit(1)
                self._opennebula_auth_kernels[parts[0].strip()] = [
                 parts[1].strip(), parts[2].strip()]
