...
# [GCC 8.4.0]
# Embedded file name: fido/pronomutils.py
    ...
    try:
        ...
        if type_ == 'version':
            ...
            if type_ == 'file':
                ...
                return False
            headers = {'Host': 'www.nationalarchives.gov.uk', 'User-Agent': ('PRONOM UTILS v{0} (OPF)').format(__version__), 
...
class LocalPronomVersions(object):
    ...
    """
    PROPS_MAPPING = {'pronom_version': 'pronomVersion', 
