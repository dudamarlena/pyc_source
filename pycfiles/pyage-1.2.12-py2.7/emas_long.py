...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyage_conf/emas_long.py
...
from pyage.core.stop_condition import StepLimitStopCondition, GlobalMinimumFitnessStopCondition
...
from pyage_conf.stats import NotificationStats, GlobalTimeStatistics
logger = logging.getLogger(__name__)
agents_count = 5
logger.debug('EMAS, %s agents', agents_count)
agents = unnamed_agents(agents_count, AggregateAgent)
stop_condition = lambda : GlobalMinimumFitnessStopCondition(-1)
