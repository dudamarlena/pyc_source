...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyage/conf/emas_wojtek.py
...
from pyage.core.statistics import NoStatistics, SimpleStatistics
...
stop_condition = lambda : StepLimitStopCondition(3000)
aggregated_agents = lambda : float_emas_initializer(dims=1000, energy=100, size=30, lowerbound=-10, upperbound=10)
emas = EmasService
