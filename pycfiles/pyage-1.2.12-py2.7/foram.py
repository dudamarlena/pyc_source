...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyage/solutions/forams/foram.py
# Compiled at: 2015-12-21 16:57:02
import logging
from pyage.core.address import Addressable
from pyage.core.inject import Inject
from pyage.solutions.forams.genom import Genom
...
class Foram(Addressable):
    ...
    def _move(self):
        try:
            ...
            cell = max(empty_neighbours, key=lambda c: c.available_food() + sum(s.available_food() for s in c.neighbours))
            if cell:
