...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/rolex-project/rolex/math.py
# Compiled at: 2019-01-28 15:56:21
...
def add_months(datetime_like_object, n, return_date=False):
    ...
    **中文文档**
    ...
    try:
        a_datetime = datetime(year, month, a_datetime.day, a_datetime.hour, a_datetime.minute, a_datetime.second, a_datetime.microsecond, tzinfo=a_datetime.tzinfo)
    except ValueError:
        month_from_ordinary += 1
        year, month = divmod(month_from_ordinary, 12)
        a_datetime = datetime(year, month, 1, a_datetime.hour, a_datetime.minute, a_datetime.second, a_datetime.microsecond, tzinfo=a_datetime.tzinfo)
