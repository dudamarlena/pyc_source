...
# [GCC 8.4.0]
# Embedded file name: /Users/zjshao/Documents/repos/VASPy/tests/outcar_test.py
# Compiled at: 2017-06-01 02:13:16
# Size of source mod 2**32: 9001 bytes
"""
OutCar类单元测试.
"""
import inspect, os, unittest, numpy as np, matplotlib
matplotlib.use('Agg')
...
class OutCarTest(unittest.TestCase):
    ...
    def test_construction_query(self):
        ...
        self.assertEqual(outcar.last_max_force, 0.046234)
