...
# Embedded file name: C:/Work/Python/workplace/pypsd/pypsd\tests.py
# Compiled at: 2009-08-07 14:18:04
import logging, unittest, tempfile, os.path
...
class PSDTest(unittest.TestCase):
    ...
    def test_extract_info(self):
        ...
        self.assertEquals(header.colorMode, 3)
        ...
        self.assertEquals(layer.opacity, 51.0)
        layer = layers[1]
        self.assertEquals(layer.dimensions['height'], 1)
    ...
    def _testPSDFile(self):
        ...
        defaults = {'layerType': 0, 'opacity': 255, 
           'visible': True, 
           'transpProtected': False, 
           'clipping': False, 
           'obsolete': False, 
           'blendMode': {'code': 'norm', 'label': 'normal'}, 'pixelDataIrrelevant': False}
        checklist = [{'name': 'Background', 'transpProtected': True}, {'name': 'darken', 'pixelDataIrrelevant': False, 'blendMode': {'code': 'dark', 'label': 'darken'}}, {'name': 'lockTrans', 'transpProtected': True}, {'name': 'invisible', 'visible': False},
         {'name': 'other', 'layerType': {'code': 1, 'label': 'open folder'}, 'pixelDataIrrelevant': True}, {'name': ''}]
        hierarchy = {'colors': ['blue', 'colors'], 'Insider': [
                     'cross'], 
           'Invisible': [
                       'layer'], 
           'closed': [
