...
# [GCC 8.4.0]
# Embedded file name: /home/miranda/.virtualenvs/vf_utils/lib/python3.6/site-packages/vf_createproducts_core/composers/bundle_composer.py
...
def compose_bundles(cli_args, settings):
    copy_workers = []
