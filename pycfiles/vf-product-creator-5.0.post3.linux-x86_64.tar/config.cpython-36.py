...
# [GCC 8.4.0]
# Embedded file name: /home/miranda/.virtualenvs/vf_utils/lib/python3.6/site-packages/vf_createproducts_core/config.py
...
class ConfigHelper(object):
    ...
    def __init__(self, config_object):
        self._ConfigHelper__config = config_object
        self.get_config = partial(self._ConfigHelper__config.get, 'product_creator')
        self.get_config_boolean = partial(self._ConfigHelper__config.getboolean, 'product_creator')
        self.get_config_int = partial(self._ConfigHelper__config.getint, 'product_creator')
