...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/birdsuitepriors/birdseed/stitch.py
# Compiled at: 2009-10-27 21:09:55
import sys, os, optparse, mpgutils.utils as utils
...
def main(argv=None):
    ...
    parser.add_option('-o', '--output', dest='outputFile', help='Where to write output.  Default: stdout')
    parser.add_option('-i', '--inDirectory', dest='inDirectory', help='Where the files to be stiched together reside.')
