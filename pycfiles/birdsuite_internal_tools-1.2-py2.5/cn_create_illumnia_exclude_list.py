...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/birdsuite/cn_create_illumnia_exclude_list.py
...
def main(argv=None):
    ...
    parser.add_option('-m', '--missing_value_label', dest='missingValueLabel', default='-9999', help='Label of data that is missing from the platform.  \n                      Illumina products do not always have data available for every probe/individual combination.\n                      Default is -9999')
