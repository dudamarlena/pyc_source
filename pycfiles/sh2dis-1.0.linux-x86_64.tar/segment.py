...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/sh2dis/segment.py
# Compiled at: 2017-12-04 17:32:36
"""Memory segments"""
...
class SegmentData(object):
    ...
    def __init__(self, location, width, model, comment=None, unknown_prefix='unk', extra=None, member_of=None):
    ...
    def get_instruction(self, no_cmd=False):
        ...
        raise SegmentError('concrete implementation did not define get_instruction')
...
class MemoryModel(object):
    ...
    def __init__(self, processor, segments):
        ...
        for name, start, end, phys in segments:
            self.segments.append(Segment(name=name, start=start, end=end, phys=phys, model=self))
