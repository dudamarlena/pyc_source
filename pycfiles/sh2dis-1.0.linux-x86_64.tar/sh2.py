...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/sh2dis/sh2.py
# Compiled at: 2017-12-04 17:32:49
"""SH2 disassembler"""
...
def calculate_disp_target(opcode, args, progc):
    ...
    if disp is not None:
        sign = 0
        if opcode['disp'] & 3840 != 0:
            sign = 2048
        elif opcode['disp'] & 240 != 0:
            sign = 128
        elif opcode['disp'] & 15 != 0:
            sign = 8
        else:
            sign = 0
