...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/utopia/tools/eutils.py
# Compiled at: 2017-04-05 11:10:17
import socket, time, urllib, urllib2
STOPWORDS = ('a', 'about', 'again', 'all', 'almost', 'also', 'although', 'always',
             ...
             'have', 'having', 'here', 'how', 'however', 'i', 'if', 'in', 'into',
             'is', 'it', 'its', 'itself', 'just', 'kg', 'km', 'made', 'mainly', 'make',
             'may', 'mg', 'might', 'ml', 'mm', 'most', 'mostly', 'must', 'nearly',
             'neither', 'no', 'nor', 'obtained', 'of', 'often', 'on', 'our', 'overall',
             'perhaps', 'pmid', 'quite', 'rather', 'really', 'regarding', 'seem',
             ...
             'through', 'thus', 'to', 'upon', 'use', 'used', 'using', 'various',
             'very', 'was', 'we', 'were', 'what', 'when', 'which', 'while', 'with',
             'within', 'without', 'would')

def eutils(utility, **defaultparams):
    defaultparams.update({'db': 'pubmed', 
