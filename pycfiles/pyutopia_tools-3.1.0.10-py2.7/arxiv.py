...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/utopia/tools/arxiv.py
# Compiled at: 2017-06-19 12:48:55
...
def parseXML(xml):
    ...
    if title is not None:
        title = re.sub('\\s+', ' ', etree.tostring(title, method='text', encoding=unicode, with_tail=False))
        data['title'] = title
