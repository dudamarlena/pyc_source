...
# [GCC 8.4.0]
# Embedded file name: ply/lex.py
# Compiled at: 2016-07-30 03:30:34
__version__ = '3.8'
__tabversion__ = '3.8'
...
def lex(module=None, object=None, debug=False, optimize=False, lextab='lextab', reflags=0, nowarn=False, outputdir=None, debuglog=None, errorlog=None):
    global input
    global lexer
    global token
    if lextab is None:
