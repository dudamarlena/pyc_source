...
# [GCC 8.4.0]
# Embedded file name: /home/fabian/devs/novix/python/pyplan-core/pyplan_core/cubepy/axes.py
...
def intersect(axes1, axes2):
    ...
    for axis1 in axes1:
        ...
        if axis2 is None:
            ...
            indices = np.in1d(axis1.values, axis2.values)
            axis = axis1[indices]
