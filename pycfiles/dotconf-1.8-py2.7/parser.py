...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dotconf/parser.py
# Compiled at: 2013-08-31 10:59:53
...
def default_external_opener(locator):
    ...
    for external in glob(locator):
        ...
        parser = DotconfParser(external_data, debug=False, write_tables=False, errorlog=yacc.NullLogger(), input_name=external, external_opener=default_external_opener)
