...
# [GCC 8.4.0]
# Embedded file name: /home/claeyswo/Envs/env_oe_utils/lib/python3.6/site-packages/oe_utils/utils/json_utils.py
...
class CustomizableJSONifier(object):
    ...
    def __call__(self, custom_adapter_kwargs, custom_dump_kwargs=None, *args, **kwargs):
    ...
    def dumps(self, obj, json_dump_kwargs=None, **adapter_kwargs):
        ...
        """
        custom_adapter_kwargs, custom_dump_kwargs = self._prepare_kwargs(adapter_kwargs, json_dump_kwargs)
        return json.dumps(obj, cls=self, custom_adapter_kwargs=custom_adapter_kwargs,
    ...
    def to_dict(self, obj, json_dump_kwargs=None, **adapter_kwargs):
        ...
        """
        json_string = (self.dumps)(obj, json_dump_kwargs=json_dump_kwargs, **adapter_kwargs)
    ...
    def dump(self, obj, fp, json_dump_kwargs=None, **adapter_kwargs):
        ...
        """
        custom_adapter_kwargs, custom_dump_kwargs = self._prepare_kwargs(adapter_kwargs, json_dump_kwargs)
        return json.dump(obj, fp, cls=self, custom_adapter_kwargs=custom_adapter_kwargs,
          custom_dump_kwargs=custom_dump_kwargs)
    ...
    def _prepare_kwargs(self, adapter_kwargs, json_dump_kwargs):
        ...
        return (
         custom_adapter_kwargs, custom_dump_kwargs)
