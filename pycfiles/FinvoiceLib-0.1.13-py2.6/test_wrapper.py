...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/finvoicelib/tests/test_wrapper.py
...
class TestFinvoiceWrapperWithPulliFinvoice(FinvoiceTestCase):
    ...
    def test_seller_freetext(self):
        ...
        """
        payee = self.wrapper.payee
        self.assertEqual(payee.seller_free_text, 'Meidän kanssa kannattaa tehdä kauppaa')
    ...
    def test_payee_contact_email(self):
        ...
        """
        payee = self.wrapper.payee
        self.assertEqual(payee.contact_email, 'hanna.paananen@pullinmusiikki.fi')
    ...
    def test_payee_invoice_recipient_einvoice_address(self):
        ...
        self.assertEqual(invoice_recipient.einvoice_address, 'FI2757800750155448')
    ...
    def test_payee_invoice_recipient_intermediator_address(self):
        ...
        """
        invoice_recipient = self.wrapper.invoice_recipient
        self.assertEqual(invoice_recipient.intermediator_address, 'OKOYFIHH')
    ...
    def test_payee_bank_accounts(self):
        ...
        self.assertEqual(payee.bank_accounts[0].account_number, 'FI2757800750155448')
        self.assertEqual(payee.bank_accounts[0].swift_code, 'OKOYFIHH')
        self.assertEqual(payee.bank_accounts[1].account_number, 'FI2721221222212227')
        self.assertEqual(payee.bank_accounts[1].swift_code, 'NDEAFIHH')
        self.assertEqual(payee.bank_accounts[2].account_number, 'FI2781232323312334')
    ...
    def test_payer_contact_email(self):
        ...
        """
        payer = self.wrapper.payer
        self.assertEqual(str(payer.contact_email), 'hannes.puumalainen@sensorit.fi')
    ...
    def test_invoice_free_text(self):
        ...
        """
        invoice = self.wrapper.invoice
        self.assertEqual(invoice.free_text, 'Vapaata tekstiä enintään 512 merkkiä')
    ...
    def test_invoice_overdue_freetext(self):
        ...
        """
        invoice = self.wrapper.invoice
        self.assertEqual(invoice.payment_overdue_text, 'Viivästyskorko 16%')
    ...
    def test_invoice_terms_of_payment(self):
        ...
        """
        invoice = self.wrapper.invoice
        self.assertEqual(invoice.terms_of_payment, '5 pävää ./.2%, 14 päivää netto')
    ...
    def test_invoice_typecode(self):
        ...
        """
        invoice = self.wrapper.invoice
        self.assertEqual(invoice.typecode, 'INV01')
    ...
    def test_invoice_type_text(self):
        ...
        """
        invoice = self.wrapper.invoice
        self.assertEqual(invoice.type_text, 'LASKU')
    ...
    def test_rows_0(self):
        ...
        self.assertEqual(row.freetext, 'Tuote myydään varsien ja ohjeen kanssa.\n')
    ...
    def test_delivery_party_contact_email(self):
        ...
        self.assertEqual(delivery_party.contact_email, 'maija.vilkkunen@kolumbus.fi')
    ...
    def test_delivery_party_delivery_date(self):
        ...
        """
        delivery_party = self.wrapper.delivery_party
        self.assertEqual(delivery_party.delivery_date, datetime.date(2004, 12, 5))
    ...
    def test_delivery_party_name(self):
        ...
        """
        delivery_party = self.wrapper.delivery_party
        self.assertEqual(delivery_party.name, 'Helsingin Tanssihalli')
    ...
    def test_delivery_party_name(self):
        ...
        """
        invoice_recipient = self.wrapper.invoice_recipient
        self.assertEqual(invoice_recipient.organisation_name, 'Tilitoimisto Ryynänen')
    ...
    def test_invoice_recipient_party_address(self):
        ...
        self.assertEqual(invoice_recipient.street_name, 'Mäkelänkatu 2')
