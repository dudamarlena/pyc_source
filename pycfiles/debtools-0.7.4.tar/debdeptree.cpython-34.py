...
# [GCC 8.4.0]
# Embedded file name: /Users/flanker/Developer/Github/DebTools/debtools/debdeptree.py
# Compiled at: 2015-07-28 01:46:35
# Size of source mod 2**32: 5266 bytes
"""Calculate the complete dependencies tree

"""
from __future__ import unicode_literals, print_function
import argparse, codecs, os, subprocess, sys
...
class DepTree(object):
    ...
    def find_package(package_name):
        ...
        :rtype:
        """
        present_files = [x for x in os.listdir('.') if x.startswith(package_name + '_') and os.path.isfile(x) and x.endswith('.deb')]
