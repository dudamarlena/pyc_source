...
# [GCC 8.4.0]
# Embedded file name: /home/viator/coding/code/microservices/microservices/http/resources.py
# Compiled at: 2017-03-07 11:28:22
...
class BaseResourceSchema(SmartDict):
    ...
    def __init__(self, response=None, status=None, request=None, status_code=None, headers=None, resources=None, resource=None, methods=None, ignore_for_methods=None, response_update=True, **kwargs):
        ...
        if ignore_for_methods is None:
            ignore_for_methods = []
        super(BaseResourceSchema, self).__init__(response=response, status=status, request=request, status_code=status_code, headers=headers, resources=resources, resource=resource, methods=methods, response_update=response_update, ignore_for_methods=ignore_for_methods, **kwargs)


class BrowserResourceSchema(BaseResourceSchema):

    def __init__(self, response='response', status='status', request='request', status_code='status_code', headers='headers', resources=None, resource='resource', methods='methods', ignore_for_methods=None, response_update=True, **kwargs):
        super(BrowserResourceSchema, self).__init__(response=response, status=status, request=request, status_code=status_code, headers=headers, resources=resources, resource=resource, methods=methods, response_update=response_update, ignore_for_methods=ignore_for_methods, **kwargs)


class ResourceSchema(BaseResourceSchema):

    def __init__(self, response='response', status=None, request=None, status_code=None, headers=None, resources=None, resource=None, methods=None, response_update=True, ignore_for_methods=None, browser=None, **kwargs):
        """Schema for microservices resource
        ...
        super(ResourceSchema, self).__init__(response=response, status=status, request=request, status_code=status_code, headers=headers, resources=resources, resource=resource, methods=methods, response_update=response_update, ignore_for_methods=ignore_for_methods, browser=browser, **kwargs)


class ResourceMarker(SmartDict):

    def __init__(self, schema=None, url=True, url_params=None, update=None, in_resources=None):
        ...
        super(ResourceMarker, self).__init__(schema=schema, url=url, url_params=url_params, update=update, in_resources=in_resources)
