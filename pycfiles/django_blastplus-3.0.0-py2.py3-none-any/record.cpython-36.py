...
# [GCC 8.4.0]
# Embedded file name: /home/michal/workspace/code/django-blastplus/blastplus/features/record.py
...
class Hsp(object):
    __doc__ = 'Store and process HSP object from blast local search.  '
...
class Alignment(object):
    __doc__ = 'Store and process alignment object from blast local search.  '
...
class BlastRecord(object):
    __doc__ = 'Store a single blast record from blast local search.  '
