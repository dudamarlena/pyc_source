...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kismetanalyzer/util.py
# Compiled at: 2020-01-22 14:42:39
...
def parse_loc(dev, strongest=False):
    ...
    if 'kismet.device.base.location' in dev:
        ...
        elif 'kismet.common.location.avg_loc' in dev['kismet.device.base.location']:
