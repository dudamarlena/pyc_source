...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kismetanalyzer/model.py
# Compiled at: 2019-02-08 05:19:56
# Size of source mod 2**32: 3090 bytes
from kismetanalyzer.util import parse_encryption, parse_channel, parse_loc, parse_frequency, parse_networkname, parse_manufacturer, parse_mac, parse_clientmap
...
class AccessPoint(object):
    ...
    def __init__(self, ssid='', mac='', encryption='', location=None, frequency='', channel='', manufacturer='', client_map=[]):
        self._ssid = ssid
        self._mac = mac
