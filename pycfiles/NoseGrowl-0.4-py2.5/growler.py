...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/nosegrowl/growler.py
# Compiled at: 2010-04-21 19:58:29
"""
...
__version__ = '0.1'
import atexit, logging, os, sys, re, datetime
...
class SimpleNotifier(object):
    ...
    def __init__(self, app_name='PyTest'):
        ...
        self.growl = GrowlNotifier(applicationName=app_name, notifications=[
         GROWL_NOTIFICATIONS_DEFAULT], applicationIcon=self.app_icon)
    ...
    def notify(self, title, description, icon=None, sticky=False):
        self.growl.notify(noteType=GROWL_NOTIFICATIONS_DEFAULT, title=title, description=description, icon=icon, sticky=sticky)
