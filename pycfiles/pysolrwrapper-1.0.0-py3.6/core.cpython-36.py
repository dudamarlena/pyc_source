...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysolrwrapper/core.py
# Compiled at: 2019-01-19 06:23:03
...
class SolrQuery:
    ...
    def __init__(self, zookeeper: str, collection: str):
        ...
        self.solr_cloud = SolrCloud((ZooKeeper(zookeeper)),
          collection, results_cls=dict)
        self._t = []
        self._query = None
        self._sort = []
 ...
 Filter]):
    ...
    def run(self) -> dict:
        ...
        results = (self.solr_cloud.search)(q=self._query, **self._conf)
