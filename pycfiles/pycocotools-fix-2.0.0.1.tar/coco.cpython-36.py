...
# Embedded file name: /home/kammeyer/src/cocoapi/PythonAPI/pycocotools/coco.py
# Compiled at: 2018-03-11 01:01:11
# Size of source mod 2**32: 18386 bytes
__author__ = 'tylin'
__version__ = '2.0'
...
class COCO:
    ...
    def getAnnIds(self, imgIds=[], catIds=[], areaRng=[], iscrowd=None):
        ...
        if len(imgIds) == len(catIds) == len(areaRng) == 0:
            ...
            anns = anns if len(areaRng) == 0 else [ann for ann in anns if ann['area'] > areaRng[0] if ann['area'] < areaRng[1]]
        if not iscrowd == None:
