...
# [GCC 8.4.0]
# Embedded file name: /Users/marcel/projects/quatix/django-shipping/shipping/carriers/correios.py
# Compiled at: 2013-03-16 14:41:23
from shipping.carriers import InterfaceError
import logging, urllib2, urllib, simplexml, math
...
class CorreiosInterface(object):
    ...
    _min_dimensions = {CorreiosFormat.PACOTE: (18, 5, 0, 0), 
       CorreiosFormat.ROLO: (16, 0, 2, 5)}

    def __init__(self, zip_from, company=None, password=None, service=CorreiosService.SEDEX, format=CorreiosFormat.PACOTE):
    ...
    def _get_diameter(self):
        ...
        """
        return int(math.sqrt(math.pow(self._length, 2) + math.pow(self._width, 2)))
    ...
    def _set_dimensions(self, package, weight_total):
        ...
        if self._format == CorreiosFormat.PACOTE and self._width < 11 and self._length < 25:
            self._width = 11
    ...
    def _get_parameters(self):
        params = {'nCdEmpresa': self._company, 
