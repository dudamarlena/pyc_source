...
# [GCC 8.4.0]
# Embedded file name: /Users/marcel/projects/quatix/django-shipping/shipping/packing/package.py
...
class Package(object):
    ...
    def _get_gurtmass(self):
        ...
        """
        dimensions = (
         self.heigth, self.width, self.length)
    ...
    def hat_gleiche_seiten(self, other):
        u"""Prüft, ob other mindestens eine gleich grosse Seite mit self hat."""
