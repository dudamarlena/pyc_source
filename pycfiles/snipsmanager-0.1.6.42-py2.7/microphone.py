...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/snipsmanager/commands/setup/microphone.py
# Compiled at: 2017-11-14 08:22:29
...
class MicrophoneInstaller(Base):
    ...
    def normalize_respeaker_params(params_list=None, params_dict=None):
        ...
        if params_list is not None:
            ...
            if 'vendor_id' not in params_dict and 'product_id' not in params_dict:
                raise exception
