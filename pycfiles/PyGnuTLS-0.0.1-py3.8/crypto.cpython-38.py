...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/PyGnuTLS/crypto.py
# Compiled at: 2020-04-24 11:09:28
# Size of source mod 2**32: 33969 bytes
...
__all__ = [
 ...
 'Cipher']
import math, re
from ctypes import byref, cast, c_char_p, create_string_buffer, c_size_t, c_uint, c_void_p
from PyGnuTLS.errors import CertificateError, CertificateRevokedError, RequestedDataNotAvailable
from PyGnuTLS.library.constants import GNUTLS_PK_DSA, GNUTLS_PK_ECDH_X25519, GNUTLS_PK_ECDSA, GNUTLS_PK_EDDSA_ED25519, GNUTLS_PK_RSA, GNUTLS_PK_RSA_PSS, GNUTLS_SAN_DN, GNUTLS_SAN_DNSNAME, GNUTLS_SAN_IPADDRESS, GNUTLS_SAN_OTHERNAME, GNUTLS_SAN_RFC822NAME, GNUTLS_SAN_URI, GNUTLS_X509_FMT_PEM
from PyGnuTLS.library.types import gnutls_pkcs7_signature_info_st, gnutls_x509_dn_t
from PyGnuTLS.library.functions import gnutls_aead_cipher_decrypt, gnutls_aead_cipher_deinit, gnutls_aead_cipher_encrypt, gnutls_aead_cipher_hd_t, gnutls_aead_cipher_init, gnutls_cipher_add_auth, gnutls_cipher_decrypt2, gnutls_cipher_deinit, gnutls_cipher_encrypt2, gnutls_cipher_get_block_size, gnutls_cipher_hd_t, gnutls_cipher_init, gnutls_cipher_set_iv, gnutls_cipher_tag, gnutls_datum_t, gnutls_dh_params_deinit, gnutls_dh_params_generate2, gnutls_dh_params_init, gnutls_dh_params_t, gnutls_digest_algorithm_t, gnutls_hex_encode2, gnutls_pkcs7_deinit, gnutls_pkcs7_export, gnutls_pkcs7_get_signature_count, gnutls_pkcs7_get_signature_info, gnutls_pkcs7_import, gnutls_pkcs7_init, gnutls_pkcs7_sign, gnutls_pkcs7_signature_info_deinit, gnutls_pkcs7_t, gnutls_pkcs7_verify, gnutls_pkcs7_verify_direct, gnutls_privkey_decrypt_data, gnutls_privkey_deinit, gnutls_privkey_export_dsa_raw, gnutls_privkey_export_rsa_raw, gnutls_privkey_generate, gnutls_privkey_get_pk_algorithm, gnutls_privkey_import_tpm_url, gnutls_privkey_import_url, gnutls_privkey_import_x509, gnutls_privkey_init, gnutls_privkey_sign_data, gnutls_privkey_sign_hash, gnutls_privkey_t, gnutls_pubkey_deinit, gnutls_pubkey_encrypt_data, gnutls_pubkey_export_dsa_raw, gnutls_pubkey_export_rsa_raw, gnutls_pubkey_get_pk_algorithm, gnutls_pubkey_get_preferred_hash_algorithm, gnutls_pubkey_import_dsa_raw, gnutls_pubkey_import_rsa_raw, gnutls_pubkey_import_tpm_url, gnutls_pubkey_import_url, gnutls_pubkey_import_x509, gnutls_pubkey_init, gnutls_pubkey_t, gnutls_pubkey_verify_data2, gnutls_pubkey_verify_hash2, gnutls_typed_vdata_st, gnutls_x509_crl_deinit, gnutls_x509_crl_export, gnutls_x509_crl_get_crt_count, gnutls_x509_crl_get_issuer_dn, gnutls_x509_crl_get_version, gnutls_x509_crl_import, gnutls_x509_crl_init, gnutls_x509_crl_t, gnutls_x509_crt_check_hostname, gnutls_x509_crt_check_issuer, gnutls_x509_crt_check_revocation, gnutls_x509_crt_deinit, gnutls_x509_crt_export, gnutls_x509_crt_get_activation_time, gnutls_x509_crt_get_dn, gnutls_x509_crt_get_expiration_time, gnutls_x509_crt_get_issuer_dn, gnutls_x509_crt_get_serial, gnutls_x509_crt_get_subject_alt_name, gnutls_x509_crt_get_version, gnutls_x509_crt_import, gnutls_x509_crt_init, gnutls_x509_crt_t, gnutls_x509_dn_deinit, gnutls_x509_dn_get_str2, gnutls_x509_dn_import, gnutls_x509_dn_init, gnutls_x509_privkey_deinit, gnutls_x509_privkey_export, gnutls_x509_privkey_import, gnutls_x509_privkey_init, gnutls_x509_privkey_t, gnutls_x509_trust_list_add_cas, gnutls_x509_trust_list_add_trust_mem, gnutls_x509_trust_list_deinit, gnutls_x509_trust_list_init, gnutls_x509_trust_list_t
...
class X509Name(str, metaclass=X509NameMeta):
    ...
    def __init__(self, dname):
        str.__init__(self)
        pairs = [x.replace('\\,', ',') for x in re.split('(?<!\\\\\\\\),', dname)]
        for pair in pairs:
            try:
...
class AlternativeNames(object):
    __slots__ = {'dns':GNUTLS_SAN_DNSNAME, 
...
class X509TrustList(object):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        instance._X509TrustList__deinit = gnutls_x509_trust_list_deinit
    ...
    def __del__(self):
        self._X509TrustList__deinit(self._c_object, 0)
...
def _gnutls_datum_t_hex_encode(self):
    tmp = self.data or self.size or gnutls_datum_t()
...
class Pkcs7(object):
    ...
    def __new__(cls, *args, **kwargs):
        instance = object.__new__(cls)
        instance._Pkcs7__deinit = gnutls_pkcs7_deinit
    ...
    def __del__(self):
        self._Pkcs7__deinit(self._c_object)
    ...
    def sign(self, cert, privkey, buf, hash_algo=None, flags=0):
        ...
        if isinstance(privkey, X509PrivateKey):
            ...
            privkey = pkey
        data = gnutls_datum_t(buf)
        gnutls_pkcs7_sign(self._c_object, cert._c_object, privkey._c_object, byref(data), 0, 0, hash_algo, flags)
    ...
    def verify(self, tl, buf, idx=-1, flags=0):
        ...
        if idx == -1:
            ...
            idxs = [
             idx]
        for idx in idxs:
            gnutls_pkcs7_verify(self._c_object, tl._c_object, byref(vdata), 0, idx, byref(data), flags)
...
class PrivateKey(object):
    ...
    def __del__(self):
        if self._PrivateKey__deinit:
            self._PrivateKey__deinit(self._c_object)

    def is_pkcs11(self):
        return self.uri is not None and (self.uri.startswith('tpmkey:') or self.uri.startswith('pkcs11:'))
    ...
    def import_uri(uri, flags=0, srk_password=None, key_password=None):
        ...
        if not srk_password:
            key_password or gnutls_privkey_import_url(pk._c_object, uri.encode(), flags)
        else:
            gnutls_privkey_import_tpm_url(pk._c_object, uri.encode(), srk_password.encode(), key_password.encode(), flags)
    ...
    def decrypt_data(self, flags, ciphertext):
        ...
        gnutls_privkey_decrypt_data(self._c_object, flags, gnutls_datum_t(ciphertext), plaintext)
...
class DSAPrivateKey(PrivateKey):
    ...
    def get_public_key(self):
        ...
        return DSAPublicKey.import_dsa_raw(p.get_string_and_free(), q.get_string_and_free(), g.get_string_and_free(), y.get_string_and_free())
...
class PublicKey(object):
    ...
    def __del__(self):
        if self._PublicKey__deinit:
            self._PublicKey__deinit(self._c_object)
    ...
    def get_preferred_hash_algorithm(self):
        ...
        mand = c_uint()
        gnutls_pubkey_get_preferred_hash_algorithm(self._c_object, algo, mand)
        return algo
    ...
    def verify_data2(self, sign_algo, flags, buf, signature):
        gnutls_pubkey_verify_data2(self._c_object, sign_algo, flags, gnutls_datum_t(buf), gnutls_datum_t(signature))

    def verify_hash2(self, sign_algo, flags, hashbuf, signature):
        gnutls_pubkey_verify_hash2(self._c_object, sign_algo, flags, gnutls_datum_t(hashbuf), gnutls_datum_t(signature))

    def encrypt_data(self, flags, plaintext):
        ciphertext = gnutls_datum_t()
        gnutls_pubkey_encrypt_data(self._c_object, flags, gnutls_datum_t(plaintext), ciphertext)
...
class RSAPublicKey(PublicKey):
    ...
    def import_rsa_raw(m, e):
        pubkey = PublicKey()
        gnutls_pubkey_import_rsa_raw(pubkey._c_object, gnutls_datum_t(m), gnutls_datum_t(e))
...
class DSAPublicKey(PublicKey):
    ...
    def import_dsa_raw(p, q, g, y):
        pubkey = PublicKey()
        gnutls_pubkey_import_dsa_raw(pubkey._c_object, gnutls_datum_t(p), gnutls_datum_t(q), gnutls_datum_t(g), gnutls_datum_t(y))
...
class X509Certificate(object):
    ...
    def __new__(cls, *args, **kwargs):
        instance = object.__new__(cls)
        instance._X509Certificate__deinit = gnutls_x509_crt_deinit
    ...
    def __del__(self):
        self._X509Certificate__deinit(self._c_object)
...
class X509PrivateKey(object):
    ...
    def __new__(cls, *args, **kwargs):
        instance = object.__new__(cls)
        instance._X509PrivateKey__deinit = gnutls_x509_privkey_deinit
    ...
    def __del__(self):
        self._X509PrivateKey__deinit(self._c_object)
...
class X509Identity(object):
    __doc__ = 'A X509 identity represents a X509 certificate and private key pair'
    __slots__ = ('cert', 'key')
...
class X509CRL(object):
    ...
    def __new__(cls, *args, **kwargs):
        instance = object.__new__(cls)
        instance._X509CRL__deinit = gnutls_x509_crl_deinit
    ...
    def __del__(self):
        self._X509CRL__deinit(self._c_object)
...
class DHParams(object):
    ...
    def __new__(cls, *args, **kwargs):
        instance = object.__new__(cls)
        instance._DHParams__deinit = gnutls_dh_params_deinit
    ...
    def __del__(self):
        self._DHParams__deinit(self._c_object)
...
class Cipher(CWrapper):
    ...
    def __init__(self, algo, key, iv):
        ...
        gnutls_cipher_init(byref(self._c_object), algo, gnutls_datum_t(key), gnutls_datum_t(iv))
        self.algorithm = algo
    ...
    def decrypt(self, cipher_text):
        ...
        gnutls_cipher_decrypt2(self._c_object, c_char_p(cipher_text), c_size_t(cipher_text), pt, c_size_t(len(pt)))
        return pt.value

    def encrypt(self, plain_text):
        bs = gnutls_cipher_get_block_size(self.algorithm)
        ct = create_string_buffer(int(math.ceil(len(plain_text) / float(bs)) * bs))
        gnutls_cipher_encrypt2(self._c_object, c_char_p(plain_text), c_size_t(plain_text), ct, c_size_t(len(ct)))
        return ct.value
...
class AEADCipher(CWrapper):
    ...
    def encrypt(self, nonce, auth, tag_size, plain_text):
        ...
        try:
            gnutls_aead_cipher_encrypt(self._c_object, c_char_p(nonce), c_size_t(len(nonce)), c_char_p(auth), c_size_t(len(auth)), c_size_t(tag_size), c_char_p(plain_text), c_size_t(len(plain_text)), cast(ct, c_void_p), byref(csize))
        except MemoryError:
            ct = create_string_buffer(csize.value)
            gnutls_aead_cipher_encrypt(self._c_object, c_char_p(nonce), c_size_t(len(nonce)), c_char_p(auth), c_size_t(len(auth)), c_size_t(tag_size), c_char_p(plain_text), c_size_t(len(plain_text)), cast(ct, c_void_p), byref(csize))
        else:
    ...
    def decrypt(self, nonce, auth, tag_size, cipher_text):
        ...
        try:
            gnutls_aead_cipher_decrypt(self._c_object, c_char_p(nonce), c_size_t(len(nonce)), c_char_p(auth), c_size_t(len(auth)), c_size_t(tag_size), c_char_p(cipher_text), c_size_t(len(cipher_text)), cast(pt, c_void_p), byref(psize))
        except MemoryError:
            pt = create_string_buffer(psize.value)
            gnutls_aead_cipher_decrypt(self._c_object, c_char_p(nonce), c_size_t(len(nonce)), c_char_p(auth), c_size_t(len(auth)), c_size_t(tag_size), c_char_p(cipher_text), c_size_t(len(cipher_text)), cast(pt, c_void_p), byref(psize))
        else:
