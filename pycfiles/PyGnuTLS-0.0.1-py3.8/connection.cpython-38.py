...
class _ServerNameIdentities(dict):
    __doc__ = 'Used internally by X509Credentials to map server names to X509 identities for the server name extension'
...
class Session(object):
    __doc__ = 'Abstract class representing a TLS session created from a TCP socket\n       and a Credentials object.'
    session_type = None
