...
# [GCC 8.4.0]
# Embedded file name: /Volumes/Urlugal/Users/geobaldi/src/ripiu/public/github/cmsplugin_fup/ripiu/cmsplugin_fup/migrations/0001_initial.py
# Compiled at: 2018-02-20 05:53:30
# Size of source mod 2**32: 5428 bytes
from __future__ import unicode_literals
import colorfield.fields, django.db.models.deletion
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='FUPContainerPluginModel',
       fields=[
      (
      ...
      (
       ...
       bases=('cms.cmsplugin', )),
     migrations.CreateModel(name='FUPItemAnimation',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Animation', 
      'verbose_name_plural':'Animations'}),
     migrations.CreateModel(name='FUPItemAnimationFrame',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'Animation frame', 
      'verbose_name_plural':'Animation frames'}),
     migrations.CreateModel(name='FUPItemPluginModel',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'FUP item', 
      'verbose_name_plural':'FUP items'},
       bases=('cms.cmsplugin', )),
     migrations.CreateModel(name='FUPItemPosition',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name':'FUP item position', 
      'verbose_name_plural':'FUP item positions'}),
     migrations.CreateModel(name='FUPPluginModel',
       fields=[
      (
