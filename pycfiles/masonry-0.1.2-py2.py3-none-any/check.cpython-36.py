...
# [GCC 8.4.0]
# Embedded file name: /Users/cmusselle/Mango/Workspace/masonry/package/src/masonry/check.py
...
def get_template_orders(template_collection_path):
    ...
    layers = [x.basename for x in template_collection_path.listdir() if x.isdir() if x.basename != '__pycache__']
