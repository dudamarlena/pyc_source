...
# [GCC 8.4.0]
# Embedded file name: /Users/cmusselle/Mango/Workspace/rss-miner/package/src/rss_miner/feeds.py
# Compiled at: 2017-05-14 13:45:07
...
def fetch_new_entries(source, db):
    ...
    if result:
        ...
        entries = []
        new_feed.entries or print('No new articles')
    else:
        ...
        print('{} articles filtered out as already processed. {} new articles'.format(n_filtered, len(entries)))
    if entries:
        updated, updated_parsed = get_last_updated_times(new_feed)
        data = {'name':name, 
         'updated':updated, 
