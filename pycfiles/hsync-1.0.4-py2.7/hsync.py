...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\hsync\hsync.py
# Compiled at: 2017-11-01 05:19:10
import argparse, hashlib, json, os, re, time, requests
...
def _parse_args_local():
    ...
    parser.add_argument('-c', '--conf', default=DEFAULT_CONF, help='config file default: $HOME/.hsync.json', metavar='hsync.json')
    parser.add_argument('-d', '--dir', nargs='*', default=DEFAULT_SYNC_DIR, help='need sync dir', metavar='dir')
...
class LocalDir(Dir):
    ...
    def __init__(self, conf):
        Dir.__init__(self, root_path=conf['local_path'], exclude_ext_list=conf.get('exclude_ext', ()), exclude_dir_list=conf.get('exclude_dir', ()))
...
class File:
    ...
    def from_dict(dict_data):
        return File(path=dict_data['path'], md5=dict_data['md5'], access_time=dict_data['access_time'], mod_time=dict_data['mod_time'])
