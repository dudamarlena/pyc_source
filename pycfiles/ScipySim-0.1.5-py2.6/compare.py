...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/actors/logic/compare.py
# Compiled at: 2010-04-22 07:27:16
...
class Compare(Siso):
    ...
    def __init__(self, input_channel, output_channel, threshold, boolean_output=False):
        ...
        """
        super(Compare, self).__init__(input_channel=input_channel, output_channel=output_channel, child_handles_output=True)
