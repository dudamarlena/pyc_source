...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/actors/signal/decimator.py
# Compiled at: 2010-04-22 07:31:59
"""
...
class Decimator(Siso):
    ...
    def __init__(self, input_channel, output_channel, reduction_factor=5):
        ...
        """
        super(Decimator, self).__init__(input_channel=input_channel, output_channel=output_channel, child_handles_output=True)
