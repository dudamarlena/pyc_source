...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/actors/math/dt_integrator.py
...
class DTIntegrator(Siso):
   ...
   """
    ...
    def __init__(self, input_channel, output_channel, init=0.0):
        ...
        """
        super(DTIntegrator, self).__init__(input_channel=input_channel, output_channel=output_channel)
        self.y_old = init
        self.y = init
...
class DTIntegratorTrapezoidal(DTIntegrator):
    ...
    def __init__(self, input_channel, output_channel, init=0.0):
        super(DTIntegratorTrapezoidal, self).__init__(input_channel=input_channel, output_channel=output_channel)
        self.x_old = 0.0
