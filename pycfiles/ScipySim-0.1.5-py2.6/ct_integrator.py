...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/actors/math/ct_integrator.py
# Compiled at: 2010-04-22 07:29:50
"""
...
class CTIntegrator(Siso):
   ...
   """
    ...
    def __init__(self, input_channel, output_channel, init=0.0, init_time=0.0):
        ...
        """
        super(CTIntegrator, self).__init__(input_channel=input_channel, output_channel=output_channel)
        self.y_old = init
        self.y = init
