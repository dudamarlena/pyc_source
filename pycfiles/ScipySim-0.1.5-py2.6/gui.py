...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/gui/gui.py
...
class App:
    ...
    def __init__(self, frame):
        ...
        callbacks = (
         self.write_to_win, self.set_active_block)
