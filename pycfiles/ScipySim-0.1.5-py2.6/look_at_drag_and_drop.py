...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/gui/look_at_drag_and_drop.py
# Compiled at: 2010-04-22 06:03:43
import sys, os, string, time, Tkinter
tk = Tkinter
...
class CanvasDnD(tk.Frame):
    ...
    def __init__(self, master):
        ...
        canvas = tk.Canvas(self, width=256, height=256, relief=tk.RIDGE, background='white', borderwidth=1)
        f = ('Helvetica', 14)
        self.defaultcolor = canvas.itemcget(canvas.create_text(30, 25, font=f, text='Item 1', tags='DnD'), 'fill')
        canvas.create_text(75, 75, font=f, text='Item 2', tags='DnD')
        canvas.create_text(125, 125, font=f, text='Item 3', tags='DnD')
        canvas.create_text(175, 175, font=f, text='Item 4', tags='DnD')
        canvas.create_text(225, 225, font=f, text='Item 5', tags='DnD')
