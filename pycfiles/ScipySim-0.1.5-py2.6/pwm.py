...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/scipysim/models/pwm.py
...
class Pulse_Width_Modulator(Model):
    ...
    def __init__(self, simulation_length=0.02, simulation_resolution=10000):
        ...
        wire_names = ('ramp', 'sin', 'const_offset', 'offset_sin', 'ramp_probe', 'ramp_plot',
                      'offset_sin_probe', 'sin_plot', 'diff', 'pwm_bool', 'on_value',
                      'off_value', 'pwm_value')
