...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/webf/webflib.py
# Compiled at: 2008-04-30 02:28:27
"""
...
"""
import sys, xmlrpclib, logging, os.path
...
class WebFactionXmlRpc(object):
    ...
    def create_app(self, app_name, app_type, autostart, extra_info):
        ...
        if extra_info.lower() == 'none':
            extra_info = ''
        try:
            result = self.server.create_app(self.session_id, app_name, app_type, autostart, extra_info)
    ...
    def delete_app(self, app_name):
        """Create new application"""
        try:
            result = self.server.delete_app(self.session_id, app_name)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def delete_db(self, name, db_type):
        ...
        """
        try:
            result = self.server.delete_db(self.session_id, name, db_type)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def create_db(self, name, db_type, password):
        ...
        """
        try:
            result = self.server.create_db(self.session_id, name, db_type, password)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def create_cronjob(self, line):
        ...
        """
        try:
            result = self.server.create_cronjob(self.session_id, line)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def delete_cronjob(self, line):
        ...
        """
        try:
            result = self.server.delete_cronjob(self.session_id, line)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def create_website(self, website_name, ip, https, subdomains, site_apps):
        ...
        print site_apps
        try:
            result = self.server.create_website(self.session_id, website_name, ip, https, subdomains, site_apps)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1

    def create_email(self, email_address, targets, autoresponder_on=False, autoresponder_subject='', autoresponder_message='', autoresponder_from=''):
        """
        ...
        if autoresponder_from.lower() == 'none':
            autoresponder_from = ''
        try:
            result = self.server.create_email(self.session_id, email_address, targets, autoresponder_on, autoresponder_subject, autoresponder_message, autoresponder_from)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def delete_email(self, email_address):
        ...
        """
        try:
            result = self.server.delete_email(self.session_id, email_address)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1

    def create_mailbox(self, mailbox, enable_spam_protection=True, share=False, spam_to_learn_folder='spam_to_learn', ham_to_learn_folder='ham_to_learn'):
        """
        Delete a mailbox
        ...
        if enable_spam_protection.lower() == 'true':
            ...
            return 1
        try:
            result = self.server.create_mailbox(self.session_id, mailbox, enable_spam_protection, share, spam_to_learn_folder, ham_to_learn_folder)
            self.log.debug(result)
    ...
    def delete_mailbox(self, mailbox):
        ...
        """
        try:
            result = self.server.delete_mailbox(self.session_id, mailbox)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
    ...
    def set_apache_acl(self, paths, permission='rwx', recursive=False):
        ...
        """
        try:
            result = self.server.set_apache_acl(self.session_id, paths, permission, recursive)
            self.log.debug(result)
        except xmlrpclib.Fault, errmsg:
            self.log.error(errmsg)
            return 1
