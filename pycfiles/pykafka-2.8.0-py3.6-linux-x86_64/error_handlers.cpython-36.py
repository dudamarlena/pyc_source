...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pykafka/utils/error_handlers.py
...
def handle_partition_responses(error_handlers, parts_by_error=None, success_handler=None, response=None, partitions_by_id=None):
...
def valid_int(param, allow_zero=False, allow_negative=False):
    ...
    try:
        ...
        raise TypeError("Expected integer but found argument of type '{}'".format(type(param)))
