...
class Producer(object):
 ...
 L. 482        72  LOAD_GLOBAL              len
               ...
               80  LOAD_ATTR                broker
               82  LOAD_ATTR                id
               84  CALL_FUNCTION_3       3  '3 positional arguments'
               86  POP_TOP          
 ...
 L. 496       122  LOAD_FAST                'self'
              ...
              130  LOAD_FAST                'req'
              132  CALL_FUNCTION_3       3  '3 positional arguments'
              134  POP_TOP          
 ...
 L. 509       244  LOAD_FAST                'self'
              ...
              252  LOAD_FAST                'req'
              254  CALL_FUNCTION_3       3  '3 positional arguments'
              256  POP_TOP          
 ...
 L. 519       302  LOAD_FAST                'presponse'
              304  LOAD_ATTR                err
              306  CALL_FUNCTION_5       5  '5 positional arguments'
              308  STORE_FAST               'info'
 ...
 L. 529       422  LOAD_FAST                'self'
              ...
              426  CALL_FUNCTION_0       0  '0 positional arguments'
              428  POP_TOP          
...
class _DeliveryReportQueue(threading.local):
    __doc__ = 'Helper that instantiates a new report queue on every calling thread'
...
class _DeliveryReportNone(object):
    __doc__ = 'Stand-in for when _DeliveryReportQueue has been disabled'
