...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pywechattool/__init__.py
# Compiled at: 2015-09-25 04:30:31
__version__ = '1.0.1'
import json, redis, requests, random, logging
__all__ = [
 'WAccessToken', 'WQRCodeHandler', 'WechatException']
REDIS_ACCESS_TOKEN_KEY = 'wechat:access_token'
WECHAT_GET_ACCESS_TOKEN_URL = 'https://api.weixin.qq.com/cgi-bin/token?' + 'grant_type=client_credential&appid={}&secret={}'
...
class WAccessToken(object):
    ...
    def __init__(self, app_id, app_secret, redis_access_token_key=REDIS_ACCESS_TOKEN_KEY, redis_host='127.0.0.1', redis_port=6379, redis_db=0, ahead_expires_in=900):
    ...
    def fetch_access_token_info(self):
        ...
        try:
            ...
            raise WechatException(('Get Access Token Error: {}').format(response.text))
...
class WQRCode(object):
    ...
    def __init__(self, access_token_handler, ahead_expires_in=900, temporary_expire_seconds=604800):
    ...
    def fetch_temporary_qrcode_ticket_info(self, scene_id):
        ...
        data = {'action_name': WECHAT_QRCODE_TEMPORARY_ACTION, 
        ...
        try:
            ...
            raise WechatException(('Create QRcode Ticket Error: {}').format(response.text))
...
if __name__ == '__main__':
    ...
    access_token_handler = WAccessToken(app_id='wx2689851bc3ea4c85', app_secret='bbdbb291dc6165be0cd115ac3385b002')
