...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/drdump/builder.py
# Compiled at: 2015-02-05 12:08:59
"""
Script generator
"""
...
class ScriptBuilder(object):
    ...
    def __init__(self, dumps_path, silent_key_error=False, use_echo_silencer=False, django_instance_path=None, base_template=BASE_TEMPLATE, loadder_item_template=LOADER_TEMPLATE, dumper_item_template=DUMPER_TEMPLATE, dump_other_apps=False, exclude_apps=[]):
    ...
    def get_global_context(self):
        return {'silencer': self.echo_silencer, 
...
if __name__ == '__main__':
    ...
    sb = ScriptBuilder('dumps', dump_other_apps=dump_other_apps, exclude_apps=exclude_apps)
    print '=== Dump map ==='
