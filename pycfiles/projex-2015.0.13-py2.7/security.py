...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/projex/security.py
...
the PyCrypto module.
"""
import base64, hashlib, logging, os.path, random, struct
...
try:
    ...
    warn = 'The PyCrypto module was not found.  It is highly recommended for security purposes to download and install this module for use  with the security module.'
    logger.warning(warn)
    AES = None
    Random = None
    RSA = None
...
def decryptfile(filename, key=None, outfile=None, chunk=65536):
    """
...
def encryptfile(filename, key=None, outfile=None, chunk=65536):
    """
