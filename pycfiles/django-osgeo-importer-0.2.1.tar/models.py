...
# [GCC 8.4.0]
# Embedded file name: /mnt/importer/osgeo_importer/models.py
...
DEFAULT_LAYER_CONFIGURATION = {'configureTime': False, 'editable': True, 
   'convert_to_date': [], 'index': 0}
...
class UploadFile(models.Model):
    ...
    file = models.FileField(upload_to='uploads', max_length=1000, validators=[
...
class UploadLayer(models.Model):
    ...
    def description(self):
        ...
        if self.layer:
            params['imported_layer'] = {'typename': self.layer.typename, 'name': self.layer.name, 'url': self.layer.get_absolute_url()}
        return params
