...
# [GCC 8.4.0]
# Embedded file name: /mnt/importer/osgeo_importer/handlers/geonode/publish_handler.py
...
class GeoNodePublishHandler(ImportHandlerMixin):
    ...
    def handle(self, layer, layer_config, *args, **kwargs):
        ...
        new_layer_kwargs = {'name': layer_name, 
        ...
        keep_attributes = [
         'date', 'date_as_date', 'enddate_as_date', 'time_as_date']
        ...
        if self.importer.upload_file and created:
            upload_layer = UploadLayer.objects.get(upload_file=self.importer.upload_file.pk, index=layer_config.get('index'))
