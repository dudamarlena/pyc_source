...
# [GCC 8.4.0]
# Embedded file name: /mnt/importer/osgeo_importer/inspectors.py
# Compiled at: 2016-12-22 15:59:20
import os, gdal, ogr
...
class GDALInspector(InspectorMixin):
    ...
    def describe_fields(self):
        ...
        for n in range(0, opened_file.GetLayerCount()):
            ...
            layer_description = {'layer_name': layer_name, 'feature_count': None, 
               'fields': [], 'index': n, 
        ...
        if opened_file.RasterCount > 0:
            layer_description = {'index': len(description), 'layer_name': self.file, 'path': self.file, 
               'raster': True, 
               'driver': driver}
            description.append(layer_description)
        ...
        for m in range(0, raster_list.__len__()):
            ...
            layer_description = {'index': len(description), 'subdataset_index': m, 
    ...
    def convert_field(self, layer_name, field):
        ...
        for feat in target_layer:
            ...
            if string_field:
                ...
                feat.SetField(field_index, pars.year, pars.month, pars.day, pars.hour, pars.minute, pars.second, pars.microsecond)
                target_layer.SetFeature(feat)
            feat = None
