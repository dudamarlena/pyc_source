...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sendgrid/helpers/mail/email.py
...
class Email(object):
    __doc__ = 'An email address with an optional name.'

    def __init__(self, email=None, name=None, substitutions=None, subject=None, p=0):
