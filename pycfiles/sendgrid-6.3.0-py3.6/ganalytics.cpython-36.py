...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sendgrid/helpers/mail/ganalytics.py
# Compiled at: 2020-04-29 15:57:11
# Size of source mod 2**32: 5062 bytes


class Ganalytics(object):
    __doc__ = 'Allows you to enable tracking provided by Google Analytics.'

    def __init__(self, enable=None, utm_source=None, utm_medium=None, utm_term=None, utm_content=None, utm_campaign=None):
        ...
        self._Ganalytics__set_field('enable', enable)
        self._Ganalytics__set_field('utm_source', utm_source)
        self._Ganalytics__set_field('utm_medium', utm_medium)
        self._Ganalytics__set_field('utm_term', utm_term)
        self._Ganalytics__set_field('utm_content', utm_content)
        self._Ganalytics__set_field('utm_campaign', utm_campaign)
    ...
    def get(self):
        ...
        """
        keys = [
         'enable', 'utm_source', 'utm_medium', 'utm_term',
