...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/biblio/webquery/querythrottle.py
...
class BaseQueryThrottle(impl.ReprObj):
    ...
    def check_limit(self, wquery):
        ...
        if self.within_limit(wquery):
        ...
        elif self.fail_action == FAIL_AND_RAISE:
            ...
            raise ValueError("unrecognised fail action '%s'" % self.fail_action)
