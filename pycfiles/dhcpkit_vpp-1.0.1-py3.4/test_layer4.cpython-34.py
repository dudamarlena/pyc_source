...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/dhcpkit_vpp/tests/protocols/test_layer4.py
# Compiled at: 2017-06-08 12:21:16
# Size of source mod 2**32: 3603 bytes
"""
...
class UnknownLayer4ProtocolTestCase(FrameTestCase):
    ...
    def setUp(self):
        ...
        self.message_fixture = UnknownLayer4Protocol(data=b'Demo packet')
        self.parse_packet()
...
class UDPTestCase(FrameTestCase):
    ...
    def setUp(self):
        ...
        self.message_fixture = UDP(source_port=4660, destination_port=22136, checksum=42680, payload=b'Demo UDP packet')
        self.parse_packet()

    def test_checksum_calculation(self):
        dummy_ipv6 = IPv6(source=IPv6Address('2001:9e0::3:2002'), destination=IPv6Address('2001:9e0:4:32:212:45:32:0222'))
