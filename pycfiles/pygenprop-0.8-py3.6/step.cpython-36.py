...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/pygenprop/step.py
...
class Step(object):
    __doc__ = 'A class representing a step that supports the existence of a genome property.'
