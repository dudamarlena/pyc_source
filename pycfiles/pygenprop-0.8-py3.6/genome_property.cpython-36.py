...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/pygenprop/genome_property.py
...
class GenomeProperty(object):
    ...
    def __init__(self, accession_id, name, property_type, threshold=0, parents=None, children=None, references=None, databases=None, steps=None, public=True, description=None, private_notes=None, tree=None):
        """
