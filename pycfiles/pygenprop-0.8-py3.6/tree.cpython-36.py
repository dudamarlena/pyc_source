...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/pygenprop/tree.py
...
class GenomePropertiesTree(object):
    ...
    def __contains__(self, item):
        if item in self.genome_properties_dictionary:
            return True
        else:
            return False
    ...
    def __str__(self):
        ...
        for genome_property in self:
            ...
            print('\n' + genome_property.id + ' (' + genome_property.name + ')' + ' Type: [' + genome_property.type + ']' + ' Parents: ' + str(parent_ids) + ' Children: ' + str(child_ids))
            print('=====================================================================================================')
            for step in genome_property.steps:
                print(str(step) + '\n')