...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/flawless/lib/data_structures/prefix_tree.py
# Compiled at: 2017-12-22 13:39:31
import os
...
class PrefixTree(with_metaclass(ProxyContainerMethodsMetaClass, object)):
    ...
    def __init__(self, split_key_func, join_key_func, accumulator_func=None, accumulator_intializer=None):
...
class StringPrefixTree(PrefixTree):
    ...
    def __init__(self, accumulator_func=None, accumulator_intializer=None):
        ...
        super(StringPrefixTree, self).__init__(split_key_func=split_key_func, join_key_func=join_key_func, accumulator_func=accumulator_func, accumulator_intializer=accumulator_intializer)
...
class FilePathTree(PrefixTree):
    ...
    def __init__(self, accumulator_func=None, accumulator_intializer=None, sep=os.sep):
        ...
        super(FilePathTree, self).__init__(split_key_func=split_key_func, join_key_func=join_key_func, accumulator_func=accumulator_func, accumulator_intializer=accumulator_intializer)
