...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/shabti/templates/moinmoin/data/moin/data/plugin/macro/EmbedWikiPage.py
...
def execute(macro, text):
    ...
    request.write('<HR>')
    cmd = '<a title=%(edit_url)s href=%(edit_url)s > %(edit_icon)s   %(txt)s</a>' % {'edit_url': '"' + edit_url + '"', 
       'edit_icon': edit_icon, 
