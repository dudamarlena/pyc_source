...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/shabti/template.py
# Compiled at: 2010-04-25 10:37:46
...
class ShabtiCouchdbkitTemplate(Template):
    required_templates = [
     'shabti_auth', 'shabti_auth_repozewhat', 'shabti_formalchemy']
