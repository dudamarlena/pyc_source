...
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/adlib/learners/alternating_trim_learner.py
...
class AlternatingTRIMLearner(Learner):
    ...
    def train(self):
        ...
        self.n = int((1 - self.poison_percentage) * len(self.training_instances))
        self.lnr.n = self.n
