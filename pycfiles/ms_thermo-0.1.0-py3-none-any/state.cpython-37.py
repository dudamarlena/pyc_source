...
# [GCC 8.4.0]
# Embedded file name: /Users/defontaine/Nitrox/ms_thermo/src/ms_thermo/state.py
# Compiled at: 2020-02-18 07:44:51
...
class State:
    ...
    def _default_thermo_database(self):
        ...
        """
        thermo_db_file = pkg_resources.resource_filename(__name__, '../INPUT/V7_4/species_database.dat')
