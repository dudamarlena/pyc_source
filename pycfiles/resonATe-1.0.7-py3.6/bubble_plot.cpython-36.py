...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/resonate/bubble_plot.py
...
def bubble_plot(detections, type='detections', ipython_display=True, title='Bubble Plot', height=700, width=1000, plotly_geo=None, filename=None, mapbox_token=None, marker_size=10, colorscale='Viridis'):
    """
        ...
        if mandatory_columns.issubset(detections.columns):
            ...
            data = [
             {'lon':detections.longitude.tolist(), 
              ...
              'mode':'markers', 
              'marker':{'color':detections.counts.tolist(), 
               'size':marker_size, 
               'showscale':True, 
