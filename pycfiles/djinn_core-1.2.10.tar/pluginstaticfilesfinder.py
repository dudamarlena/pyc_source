...
# [GCC 8.4.0]
# Embedded file name: /home/bouma/projects/pythonunited/provgroningen/buildout/src/djinn_core/djinn_core/pluginstaticfilesfinder.py
# Compiled at: 2015-11-12 03:48:23
...
class PluginFilesFinder(AppDirectoriesFinder):
    ...
    def __init__(self, apps=None, *args, **kwargs):
        ...
        for entrypoint in pkg_resources.iter_entry_points(group='djinn.app', name='statics'):
