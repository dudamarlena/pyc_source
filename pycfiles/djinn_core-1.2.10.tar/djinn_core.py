...
# [GCC 8.4.0]
# Embedded file name: /home/bouma/projects/pythonunited/provgroningen/buildout/src/djinn_core/djinn_core/templatetags/djinn_core.py
# Compiled at: 2016-10-03 09:24:44
...
def list_plugin_css(static_url):
    css = []
    for entrypoint in pkg_resources.iter_entry_points(group='djinn.app', name='css'):
...
def list_plugin_js(static_url):
    js = []
    for entrypoint in pkg_resources.iter_entry_points(group='djinn.app', name='js'):
