...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/scikits/bvp_solver/tests/test_solver.py
# Compiled at: 2011-07-22 15:26:36
import scikits.bvp_solver, numpy, nose
Q = 5.0
...
def test_parameterProblems():
    nose.tools.assert_raises(ValueError, scikits.bvp_solver.solve, problem, solution_guess=guess, parameter_guess=numpy.array([15.0]), method=7)
    nose.tools.assert_raises(ValueError, scikits.bvp_solver.solve, problem, solution_guess=guess, parameter_guess=numpy.array([15.0]), tolerance=-1e-08)
    solution = scikits.bvp_solver.solve(problem, solution_guess=guess, parameter_guess=numpy.array([15.0]))
    nose.tools.assert_raises(ValueError, scikits.bvp_solver.solve, problem, solution_guess=solution, parameter_guess=numpy.array([15.0]))