...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/scikits/bvp_solver/template_generator.py
...
def get_template(num_ODE, num_parameters, num_left_boundary_conditions, function_derivative=False, boundary_conditions_derivative=False, singular_term=False, default_object='None', array_space=6):
