...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/fosswallproxy0/heartbeatconf.py
# Compiled at: 2008-02-14 04:43:38
import re
...
class HeartBeatConf(object):
    _options = ('logfile', 'logfacility', 'keepalive', 'deadtime', 'warntime', 'initdead',
                'serial', 'bcast', 'auto_failback')
    ping = None
