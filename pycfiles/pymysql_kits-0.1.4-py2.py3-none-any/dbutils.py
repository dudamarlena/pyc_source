...
# Embedded file name: build/bdist.linux-x86_64/egg/pymysqlslave/dbutils.py
# Compiled at: 2015-11-14 06:09:38
import random
...
class MySQLSelector(object):
    ...
    def __init__(self, masters, slaves):
        self._all_engines = {CONST_MASTER_KEY: {}, CONST_SLAVE_KEY: {}}
        for item in masters:
