...
# [GCC 8.4.0]
# Embedded file name: /Users/erik/src/django/archivis2/source/permissions_widget/forms.py
...
def filter_permissions(queryset):
    ...
    for exclude_model in EXCLUDE_MODELS:
        ...
        exclude_models_q |= Q(content_type__app_label=app_label, content_type__model=model)
    ...
    if MODELS_ONLY is not None:
        for include_model in MODELS_ONLY:
            ...
            include_models_q |= Q(content_type__app_label=app_label, content_type__model=model)
