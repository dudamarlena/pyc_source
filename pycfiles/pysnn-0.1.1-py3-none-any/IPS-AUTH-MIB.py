...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IPS-AUTH-MIB.py
# Compiled at: 2016-02-13 18:18:17
...
if mibBuilder.loadTexts:
    ipsAuthMibModule.setLastUpdated('200605220000Z')
if mibBuilder.loadTexts:
    ipsAuthMibModule.setOrganization('IETF IPS Working Group')
if mibBuilder.loadTexts:
    ipsAuthMibModule.setContactInfo('\n    Mark Bakke\n    Postal: Cisco Systems, Inc\n    7900 International Drive, Suite 400\n    Bloomington, MN\n    USA 55425\n\n    E-mail: mbakke@cisco.com\n\n    James Muchow\n    Postal: Qlogic Corp.\n    6321 Bury Dr.\n    Eden Prairie, MN\n    USA 55346\n\n    E-Mail: james.muchow@qlogic.com')
if mibBuilder.loadTexts:
    ipsAuthMibModule.setDescription('The IP Storage Authorization MIB module.\n         Copyright (C) The Internet Society (2006).  This version of\n         this MIB module is part of RFC 4545;  see the RFC itself for\n         full legal notices.')
...
if mibBuilder.loadTexts:
    ipsAuthMethodTypes.setDescription('Registration point for Authentication Method Types.')
ipsAuthMethodNone = ObjectIdentity((1, 3, 6, 1, 2, 1, 141, 1, 1, 1, 1))
if mibBuilder.loadTexts:
    ipsAuthMethodNone.setDescription('The authoritative identifier when no authentication\n        method is used.')
ipsAuthMethodSrp = ObjectIdentity((1, 3, 6, 1, 2, 1, 141, 1, 1, 1, 2))
if mibBuilder.loadTexts:
    ipsAuthMethodSrp.setDescription('The authoritative identifier when the authentication\n        method is SRP.')
ipsAuthMethodChap = ObjectIdentity((1, 3, 6, 1, 2, 1, 141, 1, 1, 1, 3))
if mibBuilder.loadTexts:
    ipsAuthMethodChap.setDescription('The authoritative identifier when the authentication\n        method is CHAP.')
ipsAuthMethodKerberos = ObjectIdentity((1, 3, 6, 1, 2, 1, 141, 1, 1, 1, 4))
if mibBuilder.loadTexts:
    ipsAuthMethodKerberos.setDescription('The authoritative identifier when the authentication\n        method is Kerberos.')
ipsAuthInstance = MibIdentifier((1, 3, 6, 1, 2, 1, 141, 1, 2))
ipsAuthInstanceAttributesTable = MibTable((1, 3, 6, 1, 2, 1, 141, 1, 2, 2))
if mibBuilder.loadTexts:
    ipsAuthInstanceAttributesTable.setDescription('A list of Authorization instances present on the system.')
ipsAuthInstanceAttributesEntry = MibTableRow((1, 3, 6, 1, 2, 1, 141, 1, 2, 2, 1)).setIndexNames((0,
                                                                                                 'IPS-AUTH-MIB',
                                                                                                 'ipsAuthInstIndex'))
if mibBuilder.loadTexts:
    ipsAuthInstanceAttributesEntry.setDescription('An entry (row) containing management information\n        applicable to a particular Authorization instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentAddrStorageType.setDescription("The storage type for all read-create objects in this row.\n         Rows in this table that were created through an external\n         process may have a storage type of readOnly or permanent.\n         Conceptual rows having the value 'permanent' need not\n         allow write access to any columnar objects in the row.")
ipsAuthCredential = MibIdentifier((1, 3, 6, 1, 2, 1, 141, 1, 6))
ipsAuthCredentialAttributesTable = MibTable((1, 3, 6, 1, 2, 1, 141, 1, 6, 1))
if mibBuilder.loadTexts:
    ipsAuthCredentialAttributesTable.setDescription('A list of credentials related to user identities\n        that are allowed as valid authenticators of the\n        particular identity.')
ipsAuthCredentialAttributesEntry = MibTableRow((1, 3, 6, 1, 2, 1, 141, 1, 6, 1, 1)).setIndexNames((0,
                                                                                                   'IPS-AUTH-MIB',
                                                                                                   'ipsAuthInstIndex'), (0,
                                                                                                                         'IPS-AUTH-MIB',
                                                                                                                         'ipsAuthIdentIndex'), (0,
...
if mibBuilder.loadTexts:
    ipsAuthCredChapStorageType.setDescription("The storage type for all read-create objects in this row.\n         Rows in this table that were created through an external\n         process may have a storage type of readOnly or permanent.\n         Conceptual rows having the value 'permanent' need not\n         allow write access to any columnar objects in the row.")
ipsAuthCredSrp = MibIdentifier((1, 3, 6, 1, 2, 1, 141, 1, 8))
ipsAuthCredSrpAttributesTable = MibTable((1, 3, 6, 1, 2, 1, 141, 1, 8, 1))
if mibBuilder.loadTexts:
    ipsAuthCredSrpAttributesTable.setDescription("A list of SRP attributes for credentials that\n        use ipsAuthMethodSrp as its ipsAuthCredAuthMethod.\n\n        A row in this table can only exist when an instance of\n        the ipsAuthCredAuthMethod object exists (or is created\n        simultaneously) having the same instance identifiers\n        and a value of 'ipsAuthMethodSrp'.")
ipsAuthCredSrpAttributesEntry = MibTableRow((1, 3, 6, 1, 2, 1, 141, 1, 8, 1, 1)).setIndexNames((0,
                                                                                                'IPS-AUTH-MIB',
                                                                                                'ipsAuthInstIndex'), (0,
                                                                                                                      'IPS-AUTH-MIB',
                                                                                                                      'ipsAuthIdentIndex'), (0,
...
if mibBuilder.loadTexts:
    ipsAuthCredKerbStorageType.setDescription("The storage type for all read-create objects in this row.\n         Rows in this table that were created through an external\n         process may have a storage type of readOnly or permanent.\n         Conceptual rows having the value 'permanent' need not\n         allow write access to any columnar objects in the row.")
...
if mibBuilder.loadTexts:
    ipsAuthInstanceAttributesGroup.setDescription('A collection of objects providing information about\n        authorization instances.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentAttributesGroup.setDescription('A collection of objects providing information about\n        user identities within an authorization instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentNameAttributesGroup.setDescription('A collection of objects providing information about\n        user names within user identities within an authorization\n        instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentAddrAttributesGroup.setDescription('A collection of objects providing information about\n        address ranges within user identities within an\n        authorization instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentCredAttributesGroup.setDescription('A collection of objects providing information about\n        credentials within user identities within an authorization\n        instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentChapAttrGroup.setDescription('A collection of objects providing information about\n        CHAP credentials within user identities within an\n        authorization instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentSrpAttrGroup.setDescription('A collection of objects providing information about\n        SRP credentials within user identities within an\n        authorization instance.')
...
if mibBuilder.loadTexts:
    ipsAuthIdentKerberosAttrGroup.setDescription('A collection of objects providing information about\n        Kerberos credentials within user identities within an\n        authorization instance.')
