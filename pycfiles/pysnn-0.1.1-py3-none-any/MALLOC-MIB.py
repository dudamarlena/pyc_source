...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MALLOC-MIB.py
# Compiled at: 2016-02-13 18:19:58
...
if mibBuilder.loadTexts:
    mallocMIB.setLastUpdated('200306090000Z')
if mibBuilder.loadTexts:
    mallocMIB.setOrganization('IETF MALLOC Working Group')
if mibBuilder.loadTexts:
    mallocMIB.setContactInfo(' WG-EMail:   malloc@catarina.usc.edu\n              Subscribe:  malloc-request@catarina.usc.edu\n              Archive:    catarina.usc.edu/pub/multicast/malloc/\n\n              Co-chair/editor:\n              Dave Thaler\n              Microsoft Corporation\n              One Microsoft Way\n              Redmond, WA 98052\n              EMail: dthaler@microsoft.com\n\n              Co-chair:\n              Steve Hanna\n              Sun Microsystems, Inc.\n              One Network Drive\n              Burlington, MA 01803\n              EMail: steve.hanna@sun.com')
if mibBuilder.loadTexts:
    mallocMIB.setDescription('The MIB module for management of multicast address\n            allocation.\n\n            Copyright (C) The Internet Society (2003).  This version of\n            this MIB module is part of RFC 3559; see the RFC itself for\n            full legal notices.')
...
if mibBuilder.loadTexts:
    mallocScopeFirstAddress.setDescription('The first address in the multicast scope range.  The type\n            of this address is determined by the value of the\n            mallocScopeAddressType object.')
...
if mibBuilder.loadTexts:
    mallocScopeLastAddress.setDescription('The last address in the multicast scope range.  The type of\n            this address is determined by the value of the\n            mallocScopeAddressType object.')
...
if mibBuilder.loadTexts:
    mallocScopeNameEntry.setDescription('An entry (conceptual row) containing the information on a\n            particular multicast scope name.')
...
if mibBuilder.loadTexts:
    mallocAllocRangeEntry.setDescription('An entry (conceptual row) containing the information on a\n            particular allocation range.')
...
if mibBuilder.loadTexts:
    mallocAllocRangeFirstAddress.setDescription('The first address in the allocation range.  The type of\n            this address is determined by the value of the\n            mallocScopeAddressType object.')
...
if mibBuilder.loadTexts:
    mallocClientFullCompliance.setDescription('The compliance statement for hosts implementing the MALLOC\n            MIB with support for read-create.  Such clients can then be\n            both monitored and configured with this MIB.')
...
if mibBuilder.loadTexts:
    mallocBasicGroup.setDescription('The basic collection of objects providing management of IP\n            multicast address allocation.')
...
if mibBuilder.loadTexts:
    mallocServerGroup.setDescription('A collection of objects providing management of multicast\n            address allocation in servers.')
...
if mibBuilder.loadTexts:
    mallocClientGroup.setDescription('A collection of objects providing management of multicast\n            address allocation in clients.')
...
if mibBuilder.loadTexts:
    madcapServerGroup.setDescription('A collection of objects providing management of MADCAP\n            servers.')
...
if mibBuilder.loadTexts:
    madcapClientGroup.setDescription('A collection of objects providing management of MADCAP\n            clients.')
...
if mibBuilder.loadTexts:
    mallocClientScopeGroup.setDescription('A collection of objects providing management of multicast\n            scope information in clients.')
...
if mibBuilder.loadTexts:
    mallocPrefixCoordinatorGroup.setDescription('A collection of objects for managing Prefix Coordinators.')
