...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/FRAME-RELAY-DTE-MIB.py
# Compiled at: 2016-02-13 18:13:10
...
frameRelayDTE = ModuleIdentity((1, 3, 6, 1, 2, 1, 10, 32)).setRevisions(('1997-05-01 02:29',
                                                                         '1992-04-01 00:00'))
if mibBuilder.loadTexts:
    frameRelayDTE.setLastUpdated('9705010229Z')
if mibBuilder.loadTexts:
    frameRelayDTE.setOrganization('IETF IPLPDN Working Group')
if mibBuilder.loadTexts:
    frameRelayDTE.setContactInfo('       Caralyn Brown\n            Postal: Cadia Networks, Inc.\n                    1 Corporate Drive\n                    Andover, Massachusetts  01810\n            Tel:    +1 508 689 2400 x133\n            E-Mail: cbrown@cadia.com\n\n                    Fred Baker\n            Postal: Cisco Systems\n                    519 Lado Drive\n                    Santa Barbara, California 93111\n            Tel:    +1 408 526 425\n            E-Mail: fred@cisco.com')
if mibBuilder.loadTexts:
    frameRelayDTE.setDescription('The MIB module to describe the use of a Frame Relay\n            interface by a DTE.')
...
if mibBuilder.loadTexts:
    frDlcmiTable.setDescription('The Parameters for the Data Link Connection Management\n            Interface for the frame relay service on this\n            interface.')
frDlcmiEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 32, 1, 1)).setIndexNames((0, 'FRAME-RELAY-DTE-MIB',
                                                                            'frDlcmiIfIndex'))
if mibBuilder.loadTexts:
    frDlcmiEntry.setDescription('The Parameters for a particular Data Link Connection\n            Management Interface.')
frDlcmiIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 32, 1, 1, 1), InterfaceIndex()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    frDlcmiIfIndex.setDescription('The ifIndex value of the corresponding ifEntry.')
frDlcmiState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 32, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(('noLmiConfigured',
                                                                                                                                                                                             1), ('lmiRev1',
                                                                                                                                                                                                  2), ('ansiT1617D',
                                                                                                                                                                                                       3), ('ansiT1617B',
                                                                                                                                                                                                            4), ('itut933A',
...
if mibBuilder.loadTexts:
    frDlcmiState.setDescription('This variable states which Data Link Connection\n            Management scheme is active (and by implication, what\n            DLCI it uses) on the Frame Relay interface.')
frDlcmiAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 32, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('q921',
                                                                                                                                                                                         1), ('q922March90',
                                                                                                                                                                                              2), ('q922November90',
                                                                                                                                                                                                   3), ('q922',
                                                                                                                                                                                                        4)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    frDlcmiAddress.setDescription('This variable states which address format is in use on\n            the Frame Relay interface.')
frDlcmiAddressLen = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 32, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2, 3, 4))).clone(namedValues=NamedValues(('twoOctets',
                                                                                                                                                                                         2), ('threeOctets',
                                                                                                                                                                                              3), ('fourOctets',
                                                                                                                                                                                                   4)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    frDlcmiAddressLen.setDescription('This variable states the address length in octets.  In\n            the case of Q922 format, the length indicates the\n            entire length of the address including the control\n            portion.')
...
if mibBuilder.loadTexts:
    frDlcmiPollingInterval.setDescription('This is the number of seconds between successive\n            status enquiry messages.')
...
if mibBuilder.loadTexts:
    frDlcmiFullEnquiryInterval.setDescription('Number of status enquiry intervals that pass before\n            issuance of a full status enquiry message.')
...
if mibBuilder.loadTexts:
    frDlcmiErrorThreshold.setDescription('This is the maximum number of unanswered Status\n            Enquiries the equipment shall accept before declaring\n            the interface down.')
...
if mibBuilder.loadTexts:
    frCompliance.setDescription('The compliance statement ')
...
if mibBuilder.loadTexts:
    frCompliance0.setDescription('The compliance statement for objects and the trap\n            defined in RFC 1315.')
...
if mibBuilder.loadTexts:
    frCircuitGroup.setDescription('The objects necessary to control the Virtual Circuits\n            layered onto a Frame Relay Interface.')
...
if mibBuilder.loadTexts:
    frTrapGroup.setDescription("The objects necessary to control a Frame Relay\n            Interface's notification messages.")
...
if mibBuilder.loadTexts:
    frErrGroup.setDescription('Objects designed to assist in debugging Frame Relay\n            Interfaces.')
frNotificationGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 10, 32, 6, 1, 5)).setObjects(*(('FRAME-RELAY-DTE-MIB', 'frDLCIStatusChange'), ))
if mibBuilder.loadTexts:
    frNotificationGroup.setDescription('Traps which may be used to enhance event driven\n            management of the interface.')
...
if mibBuilder.loadTexts:
    frPortGroup0.setDescription('The objects necessary to control the Link Management\n            Interface for a Frame Relay Interface as well as\n            maintain the error statistics on this interface from\n            RFC 1315.')
...
if mibBuilder.loadTexts:
    frCircuitGroup0.setDescription('The objects necessary to control the Virtual Circuits\n            layered onto a Frame Relay Interface from RFC 1315.')
