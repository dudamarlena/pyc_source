...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DSA-MIB.py
# Compiled at: 2016-02-13 18:11:07
...
dsaOpsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 29, 1, 1)).setIndexNames((0, 'NETWORK-SERVICES-MIB',
                                                                       'applIndex'))
if mibBuilder.loadTexts:
...
dsaEntriesEntry = MibTableRow((1, 3, 6, 1, 2, 1, 29, 2, 1)).setIndexNames((0, 'NETWORK-SERVICES-MIB',
                                                                           'applIndex'))
if mibBuilder.loadTexts:
...
dsaIntEntry = MibTableRow((1, 3, 6, 1, 2, 1, 29, 3, 1)).setIndexNames((0, 'NETWORK-SERVICES-MIB',
                                                                       'applIndex'), (0,
                                                                                      'DSA-MIB',
                                                                                      'dsaIntIndex'))
if mibBuilder.loadTexts:
