...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-FSPF-MIB.py
# Compiled at: 2016-02-13 18:30:06
...
if mibBuilder.loadTexts:
    t11FcFspfMIB.setLastUpdated('200608140000Z')
if mibBuilder.loadTexts:
    t11FcFspfMIB.setOrganization('T11')
if mibBuilder.loadTexts:
    t11FcFspfMIB.setContactInfo('Claudio DeSanti\n                    Cisco Systems, Inc.\n                    170 West Tasman Drive\n                    San Jose, CA 95134 USA\n                    EMail: cds@cisco.com\n\n\n\n\n                    Keith McCloghrie\n                    Cisco Systems, Inc.\n                    170 West Tasman Drive\n                    San Jose, CA USA 95134\n                    Email: kzm@cisco.com')
if mibBuilder.loadTexts:
    t11FcFspfMIB.setDescription('The MIB module for managing the Fabric Shortest Path\n           First (FSPF) protocol.  FSPF is specified in FC-SW-4.\n\n           Copyright (C) The Internet Society (2006).  This version of\n           this MIB module is part of RFC 4626;  see the RFC itself for\n           full legal notices.')
...
class T11FspfInterfaceState(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('down', 1), ('init', 2), ('dbExchange', 3), ('dbAckwait',
                                                                            4), ('dbWait',
                                                                                 5), ('full',
                                                                                      6))
...
if mibBuilder.loadTexts:
    t11FspfIfNbrPortIndex.setDescription("The index, as known by the neighbor, of the neighbor's\n           interface that is connected to this interface in this\n           Fabric.")
t11FspfIfAdminStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 143, 1, 1, 2, 1, 16), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('up',
                                                                                                                                                                                             1), ('down',
                                                                                                                                                                                                  2))).clone('up')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    t11FspfIfAdminStatus.setDescription("The desired state of FSPF on this interface in this\n           Fabric, whenever 't11FspfAdminStatus' is 'up'.\n           If the value of this object is set to 'up', then FSPF is\n           enabled on this interface in this Fabric.  If set to\n           'down', then FSPF is disabled on this interface in this\n           Fabric.  Note that the operational state of FSPF on an\n           interface is given by t11FspfIfNbrState.")
t11FspfIfCreateTime = MibTableColumn((1, 3, 6, 1, 2, 1, 143, 1, 1, 2, 1, 17), T11FspfLastCreationTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FspfIfCreateTime.setDescription('The value of sysUpTime when this entry was last\n           created.')
t11FspfIfSetToDefault = MibTableColumn((1, 3, 6, 1, 2, 1, 143, 1, 1, 2, 1, 18), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('default',
                                                                                                                                                                                              1), ('noOp',
                                                                                                                                                                                                   2)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    t11FspfIfSetToDefault.setDescription("Setting this value to 'default' changes the value of each\n           and every writable object in this row to its default\n           value.\n\n           If all the configuration parameters have their default\n           values, and if the interface is down, then the row is\n           deleted automatically.\n\n           No action is taken if this object is set to 'noOp'.\n           The value of the object, when read, is always 'noOp'.")
...
if mibBuilder.loadTexts:
    t11FspfLsrAge.setDescription('The time since this LSR was inserted into the database.')
...
if mibBuilder.loadTexts:
    t11FspfLsrCheckSum.setDescription('The checksum of the LSR.')
...
if mibBuilder.loadTexts:
    t11FspfLsrLinks.setDescription('Number of entries in the t11FspfLinkTable associated with\n           this LSR.')
...
if mibBuilder.loadTexts:
    t11FspfLinkNumber.setDescription('The number of rows in the t11FspfLinkTable.')
t11FspfLinkTable = MibTable((1, 3, 6, 1, 2, 1, 143, 1, 2, 4))
if mibBuilder.loadTexts:
    t11FspfLinkTable.setDescription('This table contains the list of Inter-Switch Links and\n           their information that is part of an LSR, either\n           received or transmitted.')
t11FspfLinkEntry = MibTableRow((1, 3, 6, 1, 2, 1, 143, 1, 2, 4, 1)).setIndexNames((0,
                                                                                   'FC-MGMT-MIB',
                                                                                   'fcmInstanceIndex'), (0,
                                                                                                         'FC-MGMT-MIB',
                                                                                                         'fcmSwitchIndex'), (0,
...
if mibBuilder.loadTexts:
    t11FspfLinkIndex.setDescription('An arbitrary index of this link.')
t11FspfLinkNbrDomainId = MibTableColumn((1, 3, 6, 1, 2, 1, 143, 1, 2, 4, 1, 2), FcDomainIdOrZero()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FspfLinkNbrDomainId.setDescription('The Domain Id of the neighbor on the other end of this\n           link in this Fabric.')
...
if mibBuilder.loadTexts:
    t11FspfLinkPortIndex.setDescription("The source E_port of this link, as indicated by the index\n           value in the LSR received from the switch identified by\n           't11FspfLsrDomainId'.")
...
if mibBuilder.loadTexts:
    t11FspfMIBCompliance.setDescription('The compliance statement for entities that\n           implement the FSPF.')
...
if mibBuilder.loadTexts:
    t11FspfGeneralGroup.setDescription('A collection of objects for displaying and\n           configuring FSPF parameters.')
...
if mibBuilder.loadTexts:
    t11FspfIfGroup.setDescription('A collection of objects for displaying the FSPF\n           interface information.')
...
if mibBuilder.loadTexts:
    t11FspfIfCounterGroup.setDescription('A collection of objects for counting particular\n            FSPF-packet occurrences on an interface.')
...
if mibBuilder.loadTexts:
    t11FspfDatabaseGroup.setDescription('A collection of objects for displaying the FSPF\n           topology database information.')
t11FspfNotificationGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 143, 2, 2, 5)).setObjects(*(('T11-FC-FSPF-MIB', 't11FspfNbrStateChangNotify'), ))
if mibBuilder.loadTexts:
    t11FspfNotificationGroup.setDescription('A collection of notifications for FSPF.')
