...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DISMAN-SCHEDULE-MIB.py
# Compiled at: 2016-02-13 18:08:12
...
(DisplayString, RowStatus, DateAndTime, StorageType, TextualConvention, VariablePointer) = mibBuilder.importSymbols('SNMPv2-TC', 'DisplayString', 'RowStatus', 'DateAndTime', 'StorageType', 'TextualConvention', 'VariablePointer')
schedMIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 63)).setRevisions(('2002-01-07 00:00', '1998-11-17 18:00'))
if mibBuilder.loadTexts:
    schedMIB.setLastUpdated('200201070000Z')
if mibBuilder.loadTexts:
    schedMIB.setOrganization('IETF Distributed Management Working Group')
if mibBuilder.loadTexts:
    schedMIB.setContactInfo('WG EMail:  disman@dorothy.bmc.com\n         Subscribe: disman-request@dorothy.bmc.com\n\n         Chair:     Randy Presuhn\n                    BMC Software, Inc.\n         Postal:    Office 1-3141\n                    2141 North First Street\n                    San Jose,  California 95131\n                    USA\n         EMail:     rpresuhn@bmc.com\n         Phone:     +1 408 546-1006\n\n         Editor:    David B. Levi\n                    Nortel Networks\n         Postal:    4401 Great America Parkway\n                    Santa Clara, CA 95052-8185\n                    USA\n         EMail:     dlevi@nortelnetworks.com\n         Phone:     +1 865 686 0432\n\n\n         Editor:    Juergen Schoenwaelder\n                    TU Braunschweig\n         Postal:    Bueltenweg 74/75\n                    38106 Braunschweig\n                    Germany\n         EMail:     schoenw@ibr.cs.tu-bs.de\n         Phone:     +49 531 391-3283')
if mibBuilder.loadTexts:
    schedMIB.setDescription('This MIB module defines a MIB which provides mechanisms to\n         schedule SNMP set operations periodically or at specific\n         points in time.')
...
class SnmpPduErrorStatus(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noResponse', -1), ('noError', 0), ('tooBig', 1), ('noSuchName',
                                                                                  2), ('badValue',
                                                                                       3), ('readOnly',
                                                                                            4), ('genErr',
                                                                                                 5), ('noAccess',
...
if mibBuilder.loadTexts:
    schedLocalTime.setDescription('The local time used by the scheduler.  Schedules which\n         refer to calendar time will use the local time indicated\n         by this object.  An implementation MUST return all 11 bytes\n         of the DateAndTime textual-convention so that a manager\n         may retrieve the offset from GMT time.')
schedTable = MibTable((1, 3, 6, 1, 2, 1, 63, 1, 2))
if mibBuilder.loadTexts:
    schedTable.setDescription('This table defines scheduled actions triggered by\n         SNMP set operations.')
...
if mibBuilder.loadTexts:
    schedWeekDay.setDescription('The set of weekdays on which the scheduled action should\n         take place.  Setting multiple bits will include several\n         weekdays in the set of possible weekdays for this schedule.\n         Setting all bits will cause the scheduler to ignore the\n         weekday.\n\n         Note that implementations which maintain a list of pending\n         activations must re-calculate them when this object is\n         changed.')
...
if mibBuilder.loadTexts:
    schedMonth.setDescription('The set of months during which the scheduled action should\n         take place.  Setting multiple bits will include several\n         months in the set of possible months for this schedule.\n\n         Setting all bits will cause the scheduler to ignore the\n         month.\n\n         Note that implementations which maintain a list of pending\n         activations must re-calculate them when this object is\n         changed.')
...
if mibBuilder.loadTexts:
    schedHour.setDescription('The set of hours within a day during which the scheduled\n         action should take place.\n\n         Note that implementations which maintain a list of pending\n         activations must re-calculate them when this object is\n         changed.')
...
if mibBuilder.loadTexts:
    schedMinute.setDescription('The set of minutes within an hour when the scheduled action\n         should take place.\n\n         Note that implementations which maintain a list of pending\n         activations must re-calculate them when this object is\n         changed.')
...
if mibBuilder.loadTexts:
    schedAdminStatus.setDescription('The desired state of the schedule.')
...
if mibBuilder.loadTexts:
    schedActionFailure.setDescription('This notification is generated whenever the invocation of a\n         scheduled action fails.')
...
if mibBuilder.loadTexts:
    schedCompliance2.setDescription('The compliance statement for SNMP entities which implement\n         the scheduling MIB.')
...
if mibBuilder.loadTexts:
    schedGroup2.setDescription('A collection of objects providing scheduling capabilities.')
...
if mibBuilder.loadTexts:
    schedCalendarGroup.setDescription('A collection of objects providing calendar based schedules.')
schedNotificationsGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 63, 3, 2, 3)).setObjects(*(('DISMAN-SCHEDULE-MIB', 'schedActionFailure'),))
if mibBuilder.loadTexts:
    schedNotificationsGroup.setDescription('The notifications emitted by the scheduler.')
...
if mibBuilder.loadTexts:
    schedCompliance.setDescription('The compliance statement for SNMP entities which implement\n         the scheduling MIB.')
