...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MIP-MIB.py
# Compiled at: 2016-02-13 18:20:14
...
if mibBuilder.loadTexts:
    mipMIB.setLastUpdated('9606040000Z')
if mibBuilder.loadTexts:
    mipMIB.setOrganization('IETF Mobile IP Working Group')
if mibBuilder.loadTexts:
    mipMIB.setContactInfo('       David Cong\n                Postal: Motorola\n                        1301 E. Algonquin Rd.\n                        Schaumburg, IL 60196\n                Phone:  +1-847-576-1357\n                Email:  cong@comm.mot.com')
if mibBuilder.loadTexts:
    mipMIB.setDescription('The MIB Module for the Mobile IP.')
...
class RegistrationFlags(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('vjCompression', 0), ('gre', 1), ('minEnc', 2), ('decapsulationbyMN',
                                                                                3), ('broadcastDatagram',
                                                                                     4), ('simultaneousBindings',
                                                                                          5))
...
if mibBuilder.loadTexts:
    mipSecAlgorithmType.setDescription('Type of security algorithm.')
...
if mibBuilder.loadTexts:
    mipSecAlgorithmMode.setDescription('Security mode used by this algorithm.')
...
if mibBuilder.loadTexts:
    mipSecKey.setDescription('The shared secret key for the security\n                associations. Reading this object will always return\n                zero length value.')
...
if mibBuilder.loadTexts:
    mipSecRecentViolationReason.setDescription('Reason for the most recent security violation for\n                this peer.')
...
if mibBuilder.loadTexts:
    mnAdvMaxRegLifetime.setDescription('The longest lifetime in seconds that the agent is\n                willing to accept in any registration request.')
...
if mibBuilder.loadTexts:
    maAdvMaxInterval.setDescription('The maximum time in seconds between successive\n                transmissions of Agent Advertisements from this\n                interface.')
...
if mibBuilder.loadTexts:
    maAdvMinInterval.setDescription('The minimum time in seconds between successive\n                transmissions of Agent Advertisements from this\n                interface.')
...
if mibBuilder.loadTexts:
    mipCompliance.setDescription('The compliance statement for SNMPv2 entities which\n                implement the Mobile IP MIB.')
...
if mibBuilder.loadTexts:
    mipSystemGroup.setDescription("A collection of objects providing the basic Mobile IP\n                entity's management information.")
...
if mibBuilder.loadTexts:
    mipSecAssociationGroup.setDescription('A collection of objects providing the management\n                information for security associations of Mobile IP\n                entities.')
...
if mibBuilder.loadTexts:
    mipSecViolationGroup.setDescription('A collection of objects providing the management\n                information for security violation logging of Mobile\n                IP entities.')
...
if mibBuilder.loadTexts:
    mnSystemGroup.setDescription('A collection of objects providing the basic\n                management information for mobile nodes.')
...
if mibBuilder.loadTexts:
    mnDiscoveryGroup.setDescription('A collection of objects providing management\n                information for the Agent Discovery function within a\n                mobile node.')
...
if mibBuilder.loadTexts:
    mnRegistrationGroup.setDescription('A collection of objects providing management\n                information for the registration function within a\n                mobile node.')
...
if mibBuilder.loadTexts:
    faRegistrationGroup.setDescription('A collection of objects providing management\n                information for the registration function within a\n                foreign agent.')
...
if mibBuilder.loadTexts:
    haRegistrationGroup.setDescription('A collection of objects providing management\n                information for the registration function within a\n                home agent.')
