...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-FTN-STD-MIB.py
# Compiled at: 2016-02-13 18:20:35
...
mplsFTNMapEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1)).setIndexNames((0,
                                                                                      ...
                                                                                      'mplsFTNMapIndex'), (0,
                                                                                                           ...
                                                                                                           'mplsFTNMapPrevIndex'), (0,
                                                                                                                                    ...
                                                                                                                                    'mplsFTNMapCurrIndex'))
if mibBuilder.loadTexts:
    mplsFTNMapEntry.setDescription('Each conceptual row represents the application of an\n             FTN rule at a specific position in the list of FTN\n             rules applied on an interface. ')
mplsFTNMapIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1, 1), InterfaceIndexOrZero())
if mibBuilder.loadTexts:
    mplsFTNMapIndex.setDescription('The interface index that this FTN entry is being\n             applied to. A value of zero indicates an entry that is\n             applied all interfaces.\n    \n             Entries mapped to an interface by specifying its (non-\n             zero) interface index in mplsFTNMapIndex are applied\n             ahead of entries with mplsFTNMapIndex equal to zero.')
mplsFTNMapPrevIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1, 2), MplsFTNEntryIndexOrZero())
if mibBuilder.loadTexts:
    mplsFTNMapPrevIndex.setDescription('The index of the previous FTN entry that was applied to\n             this interface. The special value zero indicates that\n             this should be the first FTN entry in the list.')
mplsFTNMapCurrIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1, 3), MplsFTNEntryIndex())
if mibBuilder.loadTexts:
    mplsFTNMapCurrIndex.setDescription('Index of the current FTN entry that is being applied to\n             this interface.')
mplsFTNMapRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1, 4), RowStatus().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 4, 6))).clone(namedValues=NamedValues(('active',
                                                                                                                                                                                                  1), ('createAndGo',
                                                                                                                                                                                                       4), ('destroy',
                                                                                                                                                                                                            6)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsFTNMapRowStatus.setDescription('Used for controlling the creation and deletion of this\n             row.\n    \n             All writable objects in this row may be modified at any\n             time.\n    \n             If a conceptual row in mplsFTNMapTable points to a\n             conceptual row in mplsFTNTable which is subsequently\n             deleted, the corresponding conceptual row in\n             mplsFTNMapTable MUST also be deleted by the agent.')
mplsFTNMapStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1, 5), StorageType().clone('nonVolatile')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsFTNMapStorageType.setDescription("The storage type for this entry.  Conceptual rows\n             having the value 'permanent' need not allow write-\n             access to any columnar objects in this row.")
mplsFTNPerfTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6))
if mibBuilder.loadTexts:
    mplsFTNPerfTable.setDescription('This table contains performance statistics on FTN\n             entries on a per-interface basis.')
mplsFTNPerfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6, 1)).setIndexNames((0,
                                                                                       'MPLS-FTN-STD-MIB',
                                                                                       'mplsFTNPerfIndex'), (0,
                                                                                                             'MPLS-FTN-STD-MIB',
                                                                                                             'mplsFTNPerfCurrIndex'))
if mibBuilder.loadTexts:
    mplsFTNPerfEntry.setDescription('Each entry contains performance information for the\n             specified interface and an FTN entry mapped to this\n             interface.')
mplsFTNPerfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6, 1, 1), InterfaceIndexOrZero())
if mibBuilder.loadTexts:
    mplsFTNPerfIndex.setDescription('The interface index of an interface that an FTN entry\n             has been applied/mapped to.  Each instance of this\n             object corresponds to an instance of mplsFTNMapIndex.')
mplsFTNPerfCurrIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6, 1, 2), MplsFTNEntryIndex())
if mibBuilder.loadTexts:
    mplsFTNPerfCurrIndex.setDescription('Index of an FTN entry that has been applied/mapped to\n             the specified interface.  Each instance of this object\n             corresponds to an instance of mplsFTNMapCurrIndex.')
mplsFTNPerfMatchedPackets = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6, 1,
                                            3), Counter64()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsFTNPerfMatchedPackets.setDescription('Number of packets that matched the specified FTN entry\n             if it is applied/mapped to the specified interface.\n             Discontinuities in the value of this counter can occur\n             at re-initialization of the management system, and at\n             other times as indicated by the value of\n             mplsFTNDiscontinuityTime.')
mplsFTNPerfMatchedOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6, 1, 4), Counter64()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsFTNPerfMatchedOctets.setDescription('Number of octets that matched the specified FTN entry\n             if it is applied/mapped to the specified interface.\n             Discontinuities in the value of this counter can occur\n             at re-initialization of the management system, and at\n             other times as indicated by the value of\n             mplsFTNDiscontinuityTime.')
mplsFTNPerfDiscontinuityTime = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 6,
                                               1, 5), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsFTNPerfDiscontinuityTime.setDescription("The value of sysUpTime on the most recent occasion at\n             which any one or more of this entry's counters suffered\n             a discontinuity.  If no such discontinuities have\n             occurred since the last re-initialization of the local\n             management subsystem, then this object contains a zero\n             value.")
mplsFTNGroups = MibIdentifier((1, 3, 6, 1, 2, 1, 10, 166, 8, 2, 1))
mplsFTNCompliances = MibIdentifier((1, 3, 6, 1, 2, 1, 10, 166, 8, 2, 2))
mplsFTNModuleFullCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 8, 2, 2,
                                                1)).setObjects(*(('IF-MIB', 'ifGeneralInformationGroup'), ('IF-MIB', 'ifCounterDiscontinuityGroup'), ('MPLS-FTN-STD-MIB', 'mplsFTNRuleGroup'), ('MPLS-FTN-STD-MIB', 'mplsFTNMapGroup'), ('MPLS-FTN-STD-MIB', 'mplsFTNPerfGroup')))
if mibBuilder.loadTexts:
    mplsFTNModuleFullCompliance.setDescription('Compliance statement for agents that provide full\n             support for MPLS-FTN-STD-MIB.')
mplsFTNModuleReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 8, 2,
                                                    2, 2)).setObjects(*(('IF-MIB', 'ifGeneralInformationGroup'), ('IF-MIB', 'ifCounterDiscontinuityGroup'), ('MPLS-FTN-STD-MIB', 'mplsFTNRuleGroup'), ('MPLS-FTN-STD-MIB', 'mplsFTNMapGroup'), ('MPLS-FTN-STD-MIB', 'mplsFTNPerfGroup')))
if mibBuilder.loadTexts:
    mplsFTNModuleReadOnlyCompliance.setDescription('Compliance requirement for implementations that only\n             provide read-only support for MPLS-FTN-STD-MIB. Such\n             devices can then be monitored but cannot be configured\n             using this MIB module.')
...
if mibBuilder.loadTexts:
    mplsFTNRuleGroup.setDescription('Collection of objects that implement MPLS FTN rules.')
...
if mibBuilder.loadTexts:
    mplsFTNMapGroup.setDescription('Collection of objects that implement activation of MPLS\n             FTN entries on interfaces.')
...
if mibBuilder.loadTexts:
    mplsFTNPerfGroup.setDescription('Collection of objects providing MPLS FTN performance\n             information.')
