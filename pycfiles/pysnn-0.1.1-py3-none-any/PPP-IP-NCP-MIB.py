...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/PPP-IP-NCP-MIB.py
# Compiled at: 2016-02-13 18:24:21
...
if mibBuilder.loadTexts:
    pppIpTable.setDescription('Table containing the IP parameters and\n                         statistics for the local PPP entity.')
pppIpEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 23, 3, 1, 1)).setIndexNames((0, 'IF-MIB',
                                                                             'ifIndex'))
if mibBuilder.loadTexts:
    pppIpEntry.setDescription('IPCP status information for a particular PPP\n                         link.')
pppIpOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 23, 3, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('opened',
                                                                                                                                                                                       1), ('not-opened',
                                                                                                                                                                                            2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pppIpOperStatus.setDescription('The operational status of the IP network\n                         protocol. If the value of this object is up\n                         then the finite state machine for the IP\n                         network protocol has reached the Opened state.')
pppIpLocalToRemoteCompressionProtocol = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 23, 3,
                                                        1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('none',
                                                                                                                                                                                1), ('vj-tcp',
                                                                                                                                                                                     2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pppIpLocalToRemoteCompressionProtocol.setDescription('The IP compression protocol that the local\n                         PPP-IP entity uses when sending packets to the\n                         remote PPP-IP entity. The value of this object\n                         is meaningful only when the link has reached\n                         the open state (pppIpOperStatus is opened).')
pppIpRemoteToLocalCompressionProtocol = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 23, 3,
                                                        1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('none',
                                                                                                                                                                                1), ('vj-tcp',
                                                                                                                                                                                     2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pppIpRemoteToLocalCompressionProtocol.setDescription('The IP compression protocol that the remote\n                         PPP-IP entity uses when sending packets to the\n                         local PPP-IP entity. The value of this object\n                         is meaningful only when the link has reached\n                         the open state (pppIpOperStatus is opened).')
...
if mibBuilder.loadTexts:
    pppIpLocalMaxSlotId.setDescription('The Max-Slot-Id parameter that the local node\n                         has advertised and that is in use on the link.\n                         If vj-tcp header compression is not in use on\n                         the link then the value of this object shall be\n                         0. The value of this object is meaningful only\n                         when the link has reached the open state\n                         (pppIpOperStatus is opened).')
pppIpConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 23, 3, 2))
if mibBuilder.loadTexts:
    pppIpConfigTable.setDescription('Table containing configuration variables for\n                         the IPCP for the local PPP entity.')
pppIpConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 23, 3, 2, 1)).setIndexNames((0,
                                                                                   'IF-MIB',
                                                                                   'ifIndex'))
if mibBuilder.loadTexts:
    pppIpConfigEntry.setDescription('IPCP information for a particular PPP link.')
pppIpConfigAdminStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 23, 3, 2, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('open',
                                                                                                                                                                                              1), ('close',
                                                                                                                                                                                                   2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    pppIpConfigAdminStatus.setDescription("The immediate desired status of the IP network\n                         protocol. Setting this object to open will\n                         inject an administrative open event into the IP\n                         network protocol's finite state machine.\n                         Setting this object to close will inject an\n                         administrative close event into the IP network\n                         protocol's finite state machine.")
pppIpConfigCompression = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 23, 3, 2, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('none',
                                                                                                                                                                                              1), ('vj-tcp',
                                                                                                                                                                                                   2))).clone('none')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    pppIpConfigCompression.setDescription('If none(1) then the local node will not\n                         attempt to negotiate any IP Compression option.\n                         Otherwise, the local node will attempt to\n                         negotiate compression mode indicated by the\n                         enumerated value. Changing this object will\n                         have effect when the link is next restarted.')
