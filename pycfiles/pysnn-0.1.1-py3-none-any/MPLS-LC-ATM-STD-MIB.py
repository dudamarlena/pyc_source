...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-LC-ATM-STD-MIB.py
# Compiled at: 2016-02-13 18:20:52
...
if mibBuilder.loadTexts:
    mplsLcAtmStdMIB.setLastUpdated('200601120000Z')
if mibBuilder.loadTexts:
    mplsLcAtmStdMIB.setOrganization('Multiprotocol Label Switching (MPLS) Working Group')
if mibBuilder.loadTexts:
    mplsLcAtmStdMIB.setContactInfo('        Thomas D. Nadeau\n        Postal: Cisco Systems, Inc.\n                250 Apollo Drive\n                Chelmsford, MA 01824\n        Tel:    +1-978-244-3051\n        Email:  tnadeau@cisco.com\n\n                Subrahmanya Hegde\n        Postal: Cisco Systems, Inc.\n                225 East Tazman Drive\n        Tel:    +1-408-525-6562\n        Email:  subrah@cisco.com\n        General comments should be sent to mpls@uu.net\n       ')
if mibBuilder.loadTexts:
    mplsLcAtmStdMIB.setDescription('This MIB module contains managed object definitions for\n        MPLS Label-Controlled ATM interfaces as defined in\n        [RFC3035].\n\n        Copyright (C) The Internet Society (2006).  This\n        version of this MIB module is part of RFC 4368; see\n        the RFC itself for full legal notices.')
...
if mibBuilder.loadTexts:
    mplsLcAtmStdIfGroup.setDescription('Collection of objects needed for MPLS LC-ATM\n\n\n\n           interface configuration.')
