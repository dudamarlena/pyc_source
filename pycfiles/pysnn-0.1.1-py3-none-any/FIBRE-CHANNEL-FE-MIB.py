...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/FIBRE-CHANNEL-FE-MIB.py
# Compiled at: 2016-02-13 18:12:36
...
if mibBuilder.loadTexts:
    fcFeMIB.setLastUpdated('200005180000Z')
if mibBuilder.loadTexts:
    fcFeMIB.setOrganization('IETF IPFC Working Group')
if mibBuilder.loadTexts:
    fcFeMIB.setContactInfo('Kha Sin Teow\n                  Brocade Communications Systems,\n                  1901 Guadalupe Parkway,\n                  San Jose, CA 95131\n                  U.S.A\n                  Tel: +1 408 487 8180\n                  Fax: +1 408 487 8190\n                  Email: khasin@Brocade.COM\n\n                 WG Mailing list:ipfc@standards.gadzoox.com\n                 To Subscribe: ipfc-request@standards.gadzoox.com\n                 In Body: subscribe')
if mibBuilder.loadTexts:
    fcFeMIB.setDescription('The MIB module for Fibre Channel Fabric Element.')
...
if mibBuilder.loadTexts:
    fcFxPortStatusEntry.setDescription('An entry containing operational status and parameters of a\n          FxPort.')
fcFxPortID = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 2, 1, 1, 1), FcAddressId()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortID.setDescription('The address identifier by which this FxPort is identified\n          within the Fabric.  The FxPort may assign its address\n          identifier to its attached NxPort(s) during Fabric Login.')
fcFxPortBbCreditAvailable = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 2, 1, 1, 2), Gauge32()).setUnits('buffers').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortBbCreditAvailable.setDescription('The number of buffers currently available for receiving\n\n          frames from the attached port in the buffer-to-buffer flow\n          control. The value should be less than or equal to\n          fcFxPortBbCredit.')
fcFxPortOperMode = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 2, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('unknown',
                                                                                                                                                                                          1), ('fPort',
                                                                                                                                                                                               2), ('flPort',
                                                                                                                                                                                                    3)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortOperMode.setDescription('The current operational mode of the FxPort.')
fcFxPortAdminMode = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 2, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2, 3))).clone(namedValues=NamedValues(('fPort',
                                                                                                                                                                                        2), ('flPort',
                                                                                                                                                                                             3)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    fcFxPortAdminMode.setDescription('The desired operational mode of the FxPort.')
fcFxPortPhysTable = MibTable((1, 3, 6, 1, 2, 1, 75, 1, 2, 2))
if mibBuilder.loadTexts:
    fcFxPortPhysTable.setDescription('A table that contains, one entry for each FxPort in the\n          Fabric Element, physical level status and parameters of the\n          FxPorts.')
...
if mibBuilder.loadTexts:
    fcFxPortC2AccountingEntry.setDescription('An entry containing Class 2 accounting information for each\n          FxPort.')
fcFxPortC2InFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2InFrames.setDescription('The number of Class 2 frames received by this FxPort from\n          its attached NxPort.')
fcFxPortC2OutFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2OutFrames.setDescription('The number of Class 2 frames delivered through this FxPort\n          to its attached NxPort.')
fcFxPortC2InOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2InOctets.setDescription('The number of Class 2 frame octets, including the frame\n          delimiters, received by this FxPort from its attached\n          NxPort.')
fcFxPortC2OutOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2OutOctets.setDescription('The number of Class 2 frame octets, including the frame\n          delimiters, delivered through this FxPort to its attached\n          NxPort.')
fcFxPortC2Discards = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2Discards.setDescription('The number of Class 2 frames discarded by this FxPort.')
fcFxPortC2FbsyFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2FbsyFrames.setDescription('The number of F_BSY frames generated by this FxPort against\n          Class 2 frames.')
fcFxPortC2FrjtFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 2, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC2FrjtFrames.setDescription('The number of F_RJT frames generated by this FxPort against\n          Class 2 frames.')
fcFxPortC3AccountingTable = MibTable((1, 3, 6, 1, 2, 1, 75, 1, 4, 3))
if mibBuilder.loadTexts:
    fcFxPortC3AccountingTable.setDescription('A table that contains, one entry for each FxPort in the\n          Fabric Element, Class 3 accounting information recorded\n          since the management agent has re-initialized.')
...
if mibBuilder.loadTexts:
    fcFxPortC3AccountingEntry.setDescription('An entry containing Class 3 accounting information for each\n          FxPort.')
fcFxPortC3InFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 3, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC3InFrames.setDescription('The number of Class 3 frames received by this FxPort from\n          its attached NxPort.')
fcFxPortC3OutFrames = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 3, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC3OutFrames.setDescription('The number of Class 3 frames delivered through this FxPort\n          to its attached NxPort.')
fcFxPortC3InOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 3, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC3InOctets.setDescription('The number of Class 3 frame octets, including the frame\n          delimiters, received by this FxPort from its attached\n          NxPort.')
fcFxPortC3OutOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 3, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC3OutOctets.setDescription('The number of Class 3 frame octets, including the frame\n          delimiters, delivered through this FxPort to its attached\n          NxPort.')
fcFxPortC3Discards = MibTableColumn((1, 3, 6, 1, 2, 1, 75, 1, 4, 3, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    fcFxPortC3Discards.setDescription('The number of Class 3 frames discarded by this FxPort.')
fcFxPortCapTable = MibTable((1, 3, 6, 1, 2, 1, 75, 1, 5, 1))
if mibBuilder.loadTexts:
    fcFxPortCapTable.setDescription('A table that contains, one entry for each FxPort, the\n          capabilities of the port within the Fabric Element.')
...
if mibBuilder.loadTexts:
    fcFxPortCapRxDataFieldSizeMax.setDescription('The maximum size in bytes of the Data Field in a frame that\n          the FxPort is capable of receiving from its attached\n          NxPort.')
...
if mibBuilder.loadTexts:
    fcFeMIBMinimumCompliance.setDescription('The minimum compliance statement for SNMP entities\n          which implement the FIBRE-CHANNEL-FE-MIB.')
...
if mibBuilder.loadTexts:
    fcFeMIBFullCompliance.setDescription('The full compliance statement for SNMP entities\n          which implement the FIBRE-CHANNEL-FE-MIB.')
...
if mibBuilder.loadTexts:
    fcFeConfigGroup.setDescription('A collection of objects providing the configuration and service\n          parameters of the Fabric Element, the modules, and FxPorts.')
...
if mibBuilder.loadTexts:
    fcFeStatusGroup.setDescription('A collection of objects providing the operational status and\n         established service parameters for the Fabric Element and the\n         attached NxPorts.')
...
if mibBuilder.loadTexts:
    fcFeErrorGroup.setDescription('A collection of objects providing various error\n          statistics detected by the FxPorts.')
...
if mibBuilder.loadTexts:
    fcFeClass1AccountingGroup.setDescription('A collection of objects providing various class 1\n  performance statistics detected by the FxPorts.')
...
if mibBuilder.loadTexts:
    fcFeClass2AccountingGroup.setDescription('A collection of objects providing various class 2\n  performance statistics detected by the FxPorts.')
...
if mibBuilder.loadTexts:
    fcFeClass3AccountingGroup.setDescription('A collection of objects providing various class 3\n          performance statistics detected by the FxPorts.')
...
if mibBuilder.loadTexts:
    fcFeCapabilitiesGroup.setDescription('A collection of objects providing the inherent\n         capability of each FxPort within the Fabric Element.')
