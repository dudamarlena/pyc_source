...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SIP-TC-MIB.py
...
if mibBuilder.loadTexts:
    sipTC.setLastUpdated('200704200000Z')
if mibBuilder.loadTexts:
    sipTC.setOrganization('IETF Session Initiation Protocol Working Group')
if mibBuilder.loadTexts:
    sipTC.setContactInfo('SIP WG email: sip@ietf.org\n\n              Co-editor  Kevin Lingle\n                         Cisco Systems, Inc.\n              postal:    7025 Kit Creek Road\n                         P.O. Box 14987\n                         Research Triangle Park, NC 27709\n                         USA\n              email:     klingle@cisco.com\n              phone:     +1 919 476 2029\n\n              Co-editor  Joon Maeng\n              email:     jmaeng@austin.rr.com\n\n              Co-editor  Jean-Francois Mule\n                         CableLabs\n              postal:    858 Coal Creek Circle\n                         Louisville, CO 80027\n                         USA\n              email:     jf.mule@cablelabs.com\n              phone:     +1 303 661 9100\n\n              Co-editor  Dave Walker\n              email:     drwalker@rogers.com')
if mibBuilder.loadTexts:
    sipTC.setDescription('Session Initiation Protocol (SIP) MIB TEXTUAL-CONVENTION\n        module used by other SIP-related MIB Modules.\n\n        Copyright (C) The IETF Trust (2007).  This version of\n        this MIB module is part of RFC 4780; see the RFC itself for\n\n\n\n        full legal notices.')

class SipTCTransportProtocol(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('other', 0), ('udp', 1), ('tcp', 2), ('sctp', 3), ('tlsTcp',
                                                                                  4), ('tlsSctp',
                                                                                       5))
...
class SipTCEntityRole(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('other', 0), ('userAgent', 1), ('proxyServer', 2), ('redirectServer',
                                                                                   3), ('registrarServer',
                                                                                        4))
...
class SipTCOptionTagHeaders(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('require', 0), ('proxyRequire', 1), ('supported', 2), ('unsupported',
                                                                                      3))
