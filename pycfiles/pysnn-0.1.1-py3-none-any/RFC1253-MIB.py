...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/RFC1253-MIB.py
# Compiled at: 2016-02-13 18:25:56
...
if mibBuilder.loadTexts:
    ospfRouterId.setDescription("A 32-bit integer uniquely identifying the router in\n            the Autonomous System.\n\n            By convention, to ensure uniqueness, this should\n            default to the value of one of the router's IP\n            interface addresses.")
ospfAdminStat = MibScalar((1, 3, 6, 1, 2, 1, 14, 1, 2), Status()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfAdminStat.setDescription("The administrative status of OSPF in the router.  The\n            value 'enabled' denotes that the OSPF Process is active\n            on at least one interface; 'disabled' disables it on\n            all interfaces.")
ospfVersionNumber = MibScalar((1, 3, 6, 1, 2, 1, 14, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2))).clone(namedValues=NamedValues(('version2',
...
if mibBuilder.loadTexts:
    ospfAreaBdrRtrStatus.setDescription('A flag to note whether this router is an area border\n            router.')
ospfASBdrRtrStatus = MibScalar((1, 3, 6, 1, 2, 1, 14, 1, 5), TruthValue()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfASBdrRtrStatus.setDescription('A flag to note whether this router is an Autonomous\n            System border router.')
...
if mibBuilder.loadTexts:
    ospfOriginateNewLSAs.setDescription('The number of new link-state advertisements that have\n            been originated.  This number is incremented each time\n            the router originates a new LSA.')
...
ospfAreaEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 2, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                         'ospfAreaId'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    ospfAreaId.setDescription('A 32-bit integer uniquely identifying an area.  Area\n            ID 0.0.0.0 is used for the OSPF backbone.')
...
if mibBuilder.loadTexts:
    ospfLsdbAreaId.setDescription('The 32 bit identifier of the Area from which the LSA\n            was received.')
ospfLsdbType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 4, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(('routerLink',
                                                                                                                                                                                      1), ('networkLink',
                                                                                                                                                                                           2), ('summaryLink',
                                                                                                                                                                                                3), ('asSummaryLink',
                                                                                                                                                                                                     4), ('asExternalLink',
...
if mibBuilder.loadTexts:
    ospfLsdbType.setDescription('The type of the link state advertisement.  Each link\n            state type has a separate advertisement format.')
...
if mibBuilder.loadTexts:
    ospfLsdbAdvertisement.setDescription('The entire Link State Advertisement, including its\n            header.')
ospfAreaRangeTable = MibTable((1, 3, 6, 1, 2, 1, 14, 5))
if mibBuilder.loadTexts:
    ospfAreaRangeTable.setDescription('A range if IP addresses specified by an IP address/IP\n            network mask pair.  For example, class B address range\n            of X.X.X.X with a network mask of 255.255.0.0 includes\n            all IP addresses from X.X.0.0 to X.X.255.255')
ospfAreaRangeEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 5, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                              'ospfAreaRangeAreaID'), (0,
                                                                                                       'RFC1253-MIB',
                                                                                                       'ospfAreaRangeNet'))
if mibBuilder.loadTexts:
    ospfAreaRangeEntry.setDescription('A range if IP addresses specified by an IP address/IP\n            network mask pair.  For example, class B address range\n            of X.X.X.X with a network mask of 255.255.0.0 includes\n            all IP addresses from X.X.0.0 to X.X.255.255')
ospfAreaRangeAreaID = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 1), AreaID()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfAreaRangeAreaID.setDescription('The Area the Address Range is to be found within.')
ospfAreaRangeNet = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 2), IpAddress()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfAreaRangeNet.setDescription('The IP Address of the Net or Subnet indicated by the\n            range.')
ospfAreaRangeMask = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 3), IpAddress()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfAreaRangeMask.setDescription('The Subnet Mask that pertains to the Net or Subnet.')
ospfAreaRangeStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 4), Validation().clone('valid')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfAreaRangeStatus.setDescription("This variable displays the validity or invalidity of\n            the entry.  Setting it to 'invalid' has the effect of\n            rendering it inoperative.  The internal effect (row\n            removal) is implementation dependent.")
ospfHostTable = MibTable((1, 3, 6, 1, 2, 1, 14, 6))
if mibBuilder.loadTexts:
    ospfHostTable.setDescription('The list of Hosts, and their metrics, that the router\n            will advertise as host routes.')
ospfHostEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 6, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                         'ospfHostIpAddress'), (0,
                                                                                                'RFC1253-MIB',
                                                                                                'ospfHostTOS'))
if mibBuilder.loadTexts:
    ospfHostEntry.setDescription('A metric to be advertised, for a given type of service,\n            when a given host is reachable.')
...
if mibBuilder.loadTexts:
    ospfHostStatus.setDescription("This variable displays the validity or invalidity of\n            the entry.  Setting it to 'invalid' has the effect of\n            rendering it inoperative.  The internal effect (row\n            removal) is implementation dependent.")
ospfIfTable = MibTable((1, 3, 6, 1, 2, 1, 14, 7))
if mibBuilder.loadTexts:
    ospfIfTable.setDescription('The OSPF Interface Table describes the interfaces from\n            the viewpoint of OSPF.')
ospfIfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 7, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                       'ospfIfIpAddress'), (0,
                                                                                            'RFC1253-MIB',
                                                                                            'ospfAddressLessIf'))
if mibBuilder.loadTexts:
    ospfIfEntry.setDescription('The OSPF Interface Entry describes one interface from\n            the viewpoint of OSPF.')
...
if mibBuilder.loadTexts:
    ospfIfBackupDesignatedRouter.setDescription('The IP Address of the Backup Designated Router.')
ospfIfEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 15), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfIfEvents.setDescription('The number of times this OSPF interface has changed\n            its state, or an error has occurred.')
ospfIfAuthKey = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 16), OctetString().clone(hexValue='0000000000000000')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfIfAuthKey.setDescription("The Authentication Key.  If the Area's Authorization\n            Type is simplePassword, and the key length is shorter\n            than 8 octets, the agent will left adjust and zero fill\n            to 8 octets.\n\n            When read, ospfIfAuthKey always returns an Octet String\n            of length zero.")
ospfIfMetricTable = MibTable((1, 3, 6, 1, 2, 1, 14, 8))
if mibBuilder.loadTexts:
    ospfIfMetricTable.setDescription('The TOS metrics for a non-virtual interface identified\n            by the interface index.')
ospfIfMetricEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 8, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                             'ospfIfMetricIpAddress'), (0,
                                                                                                        'RFC1253-MIB',
...
ospfVirtIfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 9, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                           'ospfVirtIfAreaID'), (0,
                                                                                                 'RFC1253-MIB',
                                                                                                 'ospfVirtIfNeighbor'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    ospfVirtIfAreaID.setDescription('The Transit Area that the Virtual Link traverses.  By\n            definition, this is not 0.0.0.0')
...
if mibBuilder.loadTexts:
    ospfVirtIfTransitDelay.setDescription('The estimated number of seconds it takes to transmit a\n            link- state update packet over this interface.')
ospfVirtIfRetransInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 4), UpToMaxAge().clone(5)).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfVirtIfRetransInterval.setDescription('The number of seconds between link-state advertisement\n            retransmissions, for adjacencies belonging to this\n            interface.  This value is also used when retransmitting\n            database description and link-state request packets.\n            This value should be well over the expected round-trip\n            time.')
ospfVirtIfHelloInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 5), HelloRange().clone(10)).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfVirtIfHelloInterval.setDescription('The length of time, in seconds, between the Hello\n            packets that the router sends on the interface.  This\n            value must be the same for the virtual neighbor.')
ospfVirtIfRtrDeadInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 6), PositiveInteger().clone(60)).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfVirtIfRtrDeadInterval.setDescription("The number of seconds that a router's Hello packets\n            have not been seen before it's neighbors declare the\n            router down.  This should be some multiple of the Hello\n            interval.  This value must be the same for the virtual\n            neighbor.")
ospfVirtIfState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 4))).clone(namedValues=NamedValues(('down',
                                                                                                                                                                                1), ('pointToPoint',
                                                                                                                                                                                     4))).clone('down')).setMaxAccess('readonly')
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    ospfVirtIfEvents.setDescription('The number of state changes or error events on this\n            Virtual Link')
ospfVirtIfAuthKey = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 9), OctetString().clone(hexValue='0000000000000000')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfVirtIfAuthKey.setDescription('If Authentication Type is simplePassword, the device\n            will left adjust and zero fill to 8 octets.\n\n            When read, ospfVifAuthKey always returns a string of\n            length zero.')
ospfVirtIfStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 10), Validation().clone('valid')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfVirtIfStatus.setDescription("This variable displays the validity or invalidity of\n            the entry.  Setting it to 'invalid' has the effect of\n            rendering it inoperative.  The internal effect (row\n            removal) is implementation dependent.")
ospfNbrTable = MibTable((1, 3, 6, 1, 2, 1, 14, 10))
if mibBuilder.loadTexts:
    ospfNbrTable.setDescription('A table of non-virtual neighbor information.')
ospfNbrEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 10, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                         'ospfNbrIpAddr'), (0,
                                                                                            'RFC1253-MIB',
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          3), ('twoWay',
                                                                                                                                                                                                               4), ('exchangeStart',
                                                                                                                                                                                                                    5), ('exchange',
                                                                                                                                                                                                                         6), ('loading',
                                                                                                                                                                                                                              7), ('full',
                                                                                                                                                                                                                                   8))).clone('down')).setMaxAccess('readonly')
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    ospfNbrEvents.setDescription('The number of times this neighbor relationship has\n            changed state, or an error has occurred.')
ospfNbrLSRetransQLen = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 8), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfNbrLSRetransQLen.setDescription('The current length of the retransmission queue.')
ospfNBMANbrStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 9), Validation().clone('valid')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfNBMANbrStatus.setDescription("This variable displays the validity or invalidity of\n            the entry.  Setting it to 'invalid' has the effect of\n            rendering it inoperative.  The internal effect (row\n            removal) is implementation dependent.")
ospfVirtNbrTable = MibTable((1, 3, 6, 1, 2, 1, 14, 11))
if mibBuilder.loadTexts:
    ospfVirtNbrTable.setDescription('A table of virtual neighbor information.')
ospfVirtNbrEntry = MibTableRow((1, 3, 6, 1, 2, 1, 14, 11, 1)).setIndexNames((0, 'RFC1253-MIB',
                                                                             'ospfVirtNbrArea'), (0,
                                                                                                  'RFC1253-MIB',
                                                                                                  'ospfVirtNbrRtrId'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    ospfVirtNbrRtrId.setDescription('A 32-bit integer uniquely identifying the neighboring\n            router in the Autonomous System.')
...
if mibBuilder.loadTexts:
    ospfVirtNbrOptions.setDescription("A bit map corresponding to the neighbor's options\n            field.  Thus, Bit 1, if set, indicates that the\n            neighbor supports Type of Service Routing; if zero, no\n            metrics other than TOS 0 are in use by the neighbor.")
ospfVirtNbrState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(('down',
                                                                                                                                                                                                    1), ('attempt',
                                                                                                                                                                                                         2), ('init',
                                                                                                                                                                                                              3), ('twoWay',
                                                                                                                                                                                                                   4), ('exchangeStart',
...
if mibBuilder.loadTexts:
    ospfVirtNbrEvents.setDescription('The number of times this virtual link has changed its\n            state, or an error has occurred.')
ospfVirtNbrLSRetransQLen = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 7), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtNbrLSRetransQLen.setDescription('The current length of the retransmission queue.')
