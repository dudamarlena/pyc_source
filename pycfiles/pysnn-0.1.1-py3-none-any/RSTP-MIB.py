...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/RSTP-MIB.py
# Compiled at: 2016-02-13 18:27:26
...
if mibBuilder.loadTexts:
    rstpMIB.setContactInfo('Email: Bridge-mib@ietf.org')
if mibBuilder.loadTexts:
    rstpMIB.setDescription('The Bridge MIB Extension module for managing devices\n            that support the Rapid Spanning Tree Protocol defined\n            by IEEE 802.1w.\n\n            Copyright (C) The Internet Society (2005).  This version of\n            this MIB module is part of RFC 4318; See the RFC itself for\n            full legal notices.')
...
if mibBuilder.loadTexts:
    dot1dStpTxHoldCount.setDescription('The value used by the Port Transmit state machine to limit\n            the maximum transmission rate.\n\n            The value of this object MUST be retained across\n            reinitializations of the management system.')
dot1dStpExtPortTable = MibTable((1, 3, 6, 1, 2, 1, 17, 2, 19))
if mibBuilder.loadTexts:
    dot1dStpExtPortTable.setDescription('A table that contains port-specific Rapid Spanning Tree\n            information.')
...
if mibBuilder.loadTexts:
    rstpBridgeGroup.setDescription('Rapid Spanning Tree information for the bridge.')
