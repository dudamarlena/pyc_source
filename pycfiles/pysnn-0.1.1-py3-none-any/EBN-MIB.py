...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/EBN-MIB.py
# Compiled at: 2016-02-13 18:11:33
...
if mibBuilder.loadTexts:
    ebnMIB.setLastUpdated('9804281800Z')
if mibBuilder.loadTexts:
    ebnMIB.setOrganization('IETF SNA NAU MIB WG / AIW APPN MIBs SIG')
if mibBuilder.loadTexts:
    ebnMIB.setContactInfo('\n                          Bob Clouston\n                          Cisco Systems\n                          7025 Kit Creek Road\n                          P.O. Box 14987\n                          Research Triangle Park, NC 27709, USA\n                          Tel:    1 919 472 2333\n                          E-mail: clouston@cisco.com\n\n                          Bob Moore\n                          IBM Corporation\n                          BRQA/501\n                          P.O. Box 12195\n                          Research Triangle Park, NC 27709, USA\n                          Tel:    1 919 254 4436\n                          E-mail: remoore@us.ibm.com\n                  ')
if mibBuilder.loadTexts:
    ebnMIB.setDescription(' The MIB Module for Extended Border Node')
...
if mibBuilder.loadTexts:
    ebnIsRscvDestinationRoute.setDescription("The route selection control vector (RSCV x'2B') used in the\n            direction towards the SLU.")
...
if mibBuilder.loadTexts:
    hbnIsInPcid.setDescription('The procedure correlation identifier (PCID) of a session.\n            It is an 8-octet value.\n\n            If this object has the same value as the appnIsInPcid object\n            in the APPN MIB, and if the corresponding hbnIsInFqCpName\n            object has the same value as the corresponding\n            appnIsInFqCpName object, then the entries indexed by these\n            objects are referring to the same session.')
...
if mibBuilder.loadTexts:
    hbnIsInRtpNceId.setDescription('The HPR local Network Connection Endpoint of the session in\n            the direction of the SLU.')
...
if mibBuilder.loadTexts:
    hbnIsInRtpTcid.setDescription('The RTP connection local TCID of the session in the direction\n            of the SLU.')
...
if mibBuilder.loadTexts:
    ebnCompliance.setDescription('The compliance statement for the SNMPv2 entities which\n         implement the ebnMIB.')
ebnDirectoryGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 34, 7, 2, 2, 1)).setObjects(*(('EBN-MIB', 'ebnDirSubnetAffiliation'), ))
if mibBuilder.loadTexts:
    ebnDirectoryGroup.setDescription('The EBN-related directory objects.')
...
if mibBuilder.loadTexts:
    ebnIsRscvGroup.setDescription('Two objects representing RSCV and class of service\n            information saved by an EBN.')
...
if mibBuilder.loadTexts:
    ebnDirectoryConfigGroup.setDescription('The EBN Directory Configuration Group.')
ebnCosMappingGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 34, 7, 2, 2, 4)).setObjects(*(('EBN-MIB', 'ebnCosMapNativeCos'), ))
if mibBuilder.loadTexts:
    ebnCosMappingGroup.setDescription('The EBN COS Mapping Group.')
...
if mibBuilder.loadTexts:
    ebnSubnetRoutingListGroup.setDescription('The Subnet Routing List Group.')
hbnIsInGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 34, 7, 2, 2, 6)).setObjects(*(('EBN-MIB', 'hbnIsInRtpNceId'), ('EBN-MIB', 'hbnIsInRtpTcid')))
if mibBuilder.loadTexts:
    hbnIsInGroup.setDescription('The HBN-related Intermediate Session Objects.')
