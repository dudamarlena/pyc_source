...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SSPM-MIB.py
# Compiled at: 2016-02-13 18:29:28
...
if mibBuilder.loadTexts:
    sspmSourceProfileTOS.setDescription('Represents the TOS field in the IP packet header.  The\n        value of this object defaults to zero if not set.')
...
if mibBuilder.loadTexts:
    sspmSourceProfileTTL.setDescription('If non-zero, this specifies the value to place into\n         the TTL field on transmission.')
sspmSourceProfileNoFrag = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 28, 1, 2, 1, 1, 11), TruthValue()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    sspmSourceProfileNoFrag.setDescription("When true, the 'Don't Fragment Bit' should be set\n         on the packet header.")
...
if mibBuilder.loadTexts:
    sspmSourceControlInstance.setDescription('An arbitrary index.')
...
if mibBuilder.loadTexts:
    sspmGeneralCompliance.setDescription('A general compliance that allows all things to be optional.')
...
if mibBuilder.loadTexts:
    sspmSinkFullCompliance.setDescription('A sink-only compliance.  Use this compliance when implementing a\n     sink-only device.  This is useful for devices to receive one-way\n     measurements.')
...
if mibBuilder.loadTexts:
    sspmGeneralGroup.setDescription('The objects in the SSPM General Group.')
...
if mibBuilder.loadTexts:
    sspmSourceGroup.setDescription('The objects in the SSPM Source Group.')
...
if mibBuilder.loadTexts:
    sspmUserPassGroup.setDescription('The objects in the SSPM Username and password group.')
...
if mibBuilder.loadTexts:
    sspmSinkGroup.setDescription('The objects in the SSPM Sink Group.')
