...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IANATn3270eTC-MIB.py
# Compiled at: 2016-02-13 18:16:11
...
class IANATn3270eClientType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('none', 1), ('other', 2), ('ipv4', 3), ('ipv6', 4), ('domainName',
                                                                                    5), ('truncDomainName',
                                                                                         6), ('string',
                                                                                              7), ('certificate',
                                                                                                   8), ('userId',
...
class IANATn3270Functions(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('transmitBinary', 0), ('timemark', 1), ('endOfRecord',
                                                                       2), ('terminalType',
                                                                            3), ('tn3270Regime',
                                                                                 4), ('scsCtlCodes',
                                                                                      5), ('dataStreamCtl',
...
class IANATn3270ResourceType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('terminal', 2), ('printer', 3), ('terminalOrPrinter',
                                                                              4))
...
class IANATn3270DeviceType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('ibm3278d2', 1), ('ibm3278d2E', 2), ('ibm3278d3', 3), ('ibm3278d3E',
                                                                                      4), ('ibm3278d4',
                                                                                           5), ('ibm3278d4E',
                                                                                                6), ('ibm3278d5',
                                                                                                     7), ('ibm3278d5E',
