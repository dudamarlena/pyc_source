...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/TIME-AGGREGATE-MIB.py
# Compiled at: 2016-02-13 18:31:27
...
if mibBuilder.loadTexts:
    tAggrCtlTable.setDescription('The Time-Based aggregation control table.  It controls\n            the aggregation of the samples of MO instances.  There\n            will be a row for each TAgMO.\n           ')
tAggrCtlEntry = MibTableRow((1, 3, 6, 1, 3, 124, 1, 1)).setIndexNames((0, 'TIME-AGGREGATE-MIB',
                                                                       'tAggrCtlEntryID'))
if mibBuilder.loadTexts:
    tAggrCtlEntry.setDescription('A row of the control table that defines one Time-Based\n           aggregate MO (TAgMO).')
tAggrCtlEntryID = MibTableColumn((1, 3, 6, 1, 3, 124, 1, 1, 1), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32)))
if mibBuilder.loadTexts:
    tAggrCtlEntryID.setDescription('A locally unique, administratively assigned name\n            for this aggregated MO.  It is used as an index to\n            uniquely identify this row in the table.')
tAggrCtlMOInstance = MibTableColumn((1, 3, 6, 1, 3, 124, 1, 1, 2), ObjectIdentifier()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    tAggrCtlMOInstance.setDescription('The sampled values of this MO instance will be\n            aggregated by the TAgMO.\n            ')
...
if mibBuilder.loadTexts:
    tAggrMibCompliance.setDescription('The compliance statement for SNMP entities\n                 that implement the TIME-AGGREGATE-MIB.')
...
if mibBuilder.loadTexts:
    tAggrMibBasicGroup.setDescription('A collection of objects for Time-Based aggregation\n                  of MOs.')
