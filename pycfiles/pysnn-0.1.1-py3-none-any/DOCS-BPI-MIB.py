...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DOCS-BPI-MIB.py
# Compiled at: 2016-02-13 18:09:04
...
if mibBuilder.loadTexts:
    docsBpiCmAuthState.setDescription('The value of this object is the state of the CM authorization\nFSM.  The start state indicates that FSM is in its initial state.')
...
if mibBuilder.loadTexts:
    docsBpiCmAuthWaitTimeout.setDescription('The value of this object is the Authorize Wait Timeout.')
...
if mibBuilder.loadTexts:
    docsBpiCmReauthWaitTimeout.setDescription('The value of this object is the Reauthorize Wait Timeout in seconds.')
...
if mibBuilder.loadTexts:
    docsBpiCmOpWaitTimeout.setDescription('The value of this object is the Operational Wait Timeout in seconds.')
...
if mibBuilder.loadTexts:
    docsBpiCmRekeyWaitTimeout.setDescription('The value of this object is the Rekey Wait Timeout in seconds.')
...
if mibBuilder.loadTexts:
    docsBpiCmtsDefaultAuthLifetime.setDescription('The value of this object is the default lifetime, in seconds, the\nCMTS assigns to a new authorization key.')
...
if mibBuilder.loadTexts:
    docsBpiCmtsDefaultTEKLifetime.setDescription('The value of this object is the default lifetime, in seconds, the\nCMTS assigns to a new Traffic Encryption Key (TEK).')
...
if mibBuilder.loadTexts:
    docsBpiCmtsDefaultAuthGraceTime.setDescription('This object was obsoleted because the provisioning system, not the CMTS,\nmanages the authorization key grace time for DOCSIS CMs.')
...
if mibBuilder.loadTexts:
    docsBpiCmtsAuthCmLifetime.setDescription('The value of this object is the lifetime, in seconds, the CMTS\nassigns to an authorization key for this CM.')
...
if mibBuilder.loadTexts:
    docsBpiCmtsTEKLifetime.setDescription('The value of this object is the lifetime, in seconds, the CMTS assigns\nto keys for this TEK association.')
...
if mibBuilder.loadTexts:
    docsBpiIpMulticastMapTable.setDescription('This table describes the mapping of IP multicast address prefixes to\nmulticast SIDs on each CMTS MAC interface.')
...
if mibBuilder.loadTexts:
    docsBpiMulticastAuthEntry.setDescription('Each entry contains objects describing the key authorization of one\ncable modem for one multicast SID for one CMTS MAC interface.')
...
if mibBuilder.loadTexts:
    docsBpiBasicCompliance.setDescription('This is the compliance statement for devices which implement the\nDOCSIS Baseline Privacy Interface.')
...
if mibBuilder.loadTexts:
    docsBpiCmGroup.setDescription('This collection of objects provides CM BPI status and control.')
...
if mibBuilder.loadTexts:
    docsBpiCmtsGroup.setDescription('This collection of objects provides CMTS BPI status and control.')
...
if mibBuilder.loadTexts:
    docsBpiObsoleteObjectsGroup.setDescription('This is a collection of obsolete BPI objects.')
