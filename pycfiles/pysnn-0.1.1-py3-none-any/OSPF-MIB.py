...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/OSPF-MIB.py
# Compiled at: 2016-02-13 18:23:03
...
if mibBuilder.loadTexts:
    ospfRestartSupport.setDescription("The router's support for OSPF graceful restart.\n          Options include: no restart support, only planned\n          restarts, or both planned and unplanned restarts.\n\n          This object is persistent and when written\n          the entity SHOULD save the change to non-volatile\n          storage.")
...
if mibBuilder.loadTexts:
    ospfRestartInterval.setDescription('Configured OSPF graceful restart timeout interval.\n\n           This object is persistent and when written\n           the entity SHOULD save the change to non-volatile\n           storage.')
ospfRestartStrictLsaChecking = MibScalar((1, 3, 6, 1, 2, 1, 14, 1, 20), TruthValue()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    ospfRestartStrictLsaChecking.setDescription('Indicates if strict LSA checking is enabled for\n           graceful restart.\n\n           This object is persistent and when written\n           the entity SHOULD save the change to non-volatile\n           storage.')
...
if mibBuilder.loadTexts:
    ospfRestartStatus.setDescription('Current status of OSPF graceful restart.')
ospfRestartAge = MibScalar((1, 3, 6, 1, 2, 1, 14, 1, 22), Unsigned32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfRestartAge.setDescription('Remaining time in current OSPF graceful restart\n          interval.')
...
if mibBuilder.loadTexts:
    ospfAreaNssaTranslatorRole.setDescription("Indicates an NSSA border router's ability to\n          perform NSSA translation of type-7 LSAs into\n          type-5 LSAs.")
...
if mibBuilder.loadTexts:
    ospfStubMetricType.setDescription('This variable displays the type of metric\n          advertised as a default route.')
ospfLsdbTable = MibTable((1, 3, 6, 1, 2, 1, 14, 4))
if mibBuilder.loadTexts:
    ospfLsdbTable.setDescription("The OSPF Process's link state database (LSDB).\n           The LSDB contains the link state advertisements\n           from throughout the areas that the device is attached to.")
...
if mibBuilder.loadTexts:
    ospfLsdbEntry.setDescription('A single link state advertisement.')
ospfLsdbAreaId = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 4, 1, 1), AreaID()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfLsdbAreaId.setDescription('The 32-bit identifier of the area from which\n          the LSA was received.')
...
if mibBuilder.loadTexts:
    ospfAreaRangeEntry.setDescription('A single area address range.\n\n          Information in this table is persistent and when this object\n          is written the entity SHOULD save the change to non-volatile\n          storage.')
ospfAreaRangeAreaId = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 1), AreaID()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAreaRangeAreaId.setDescription('The area that the address range is to be found\n          within.')
ospfAreaRangeNet = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 2), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAreaRangeNet.setDescription('The IP address of the net or subnet indicated\n          by the range.')
ospfAreaRangeMask = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 3), IpAddress()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    ospfAreaRangeMask.setDescription('The subnet mask that pertains to the net or\n          subnet.')
ospfAreaRangeStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    ospfAreaRangeStatus.setDescription('This object permits management of the table by\n          facilitating actions such as row creation,\n          construction, and destruction.\n\n          The value of this object has no effect on\n          whether other objects in this conceptual row can be\n          modified.')
...
if mibBuilder.loadTexts:
    ospfIfPollInterval.setDescription('The larger time interval, in seconds, between the Hello\n          packets sent to an inactive non-broadcast multi-access\n          neighbor.')
...
if mibBuilder.loadTexts:
    ospfIfState.setDescription('The OSPF Interface State.')
ospfIfDesignatedRouter = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 13), IpAddress().clone(hexValue='00000000')).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfIfDesignatedRouter.setDescription('The IP address of the designated router.')
...
if mibBuilder.loadTexts:
    ospfIfBackupDesignatedRouter.setDescription('The IP address of the backup designated\n          router.')
ospfIfEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 15), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfIfEvents.setDescription('The number of times this OSPF interface has\n          changed its state or an error has occurred.\n\n          Discontinuities in the value of this counter can occur\n          at re-initialization of the management system, and at other\n          times as indicated by the value of ospfDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    ospfVirtIfRtrDeadInterval.setDescription("The number of seconds that a router's Hello\n          packets have not been seen before its\n          neighbors declare the router down.  This should be\n          some multiple of the Hello interval.  This\n          value must be the same for the virtual neighbor.")
...
if mibBuilder.loadTexts:
    ospfVirtIfState.setDescription('OSPF virtual interface states.')
ospfVirtIfEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtIfEvents.setDescription('The number of state changes or error events on\n          this virtual link.\n\n          Discontinuities in the value of this counter can occur\n          at re-initialization of the management system, and at other\n          times as indicated by the value of ospfDiscontinuityTime.')
...
if mibBuilder.loadTexts:
    ospfNbrState.setDescription('The state of the relationship with this neighbor.')
ospfNbrEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfNbrEvents.setDescription('The number of times this neighbor relationship\n          has changed state or an error has occurred.\n\n          Discontinuities in the value of this counter can occur\n          at re-initialization of the management system, and at other\n          times as indicated by the value of ospfDiscontinuityTime.')
ospfNbrLsRetransQLen = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 8), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfNbrLsRetransQLen.setDescription('The current length of the retransmission\n          queue.')
ospfNbmaNbrStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 9), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    ospfNbmaNbrStatus.setDescription('This object permits management of the table by\n          facilitating actions such as row creation,\n          construction, and destruction.\n\n          The value of this object has no effect on\n          whether other objects in this conceptual row can be\n          modified.')
...
if mibBuilder.loadTexts:
    ospfNbmaNbrPermanence.setDescription("This variable displays the status of the entry;\n          'dynamic' and 'permanent' refer to how the neighbor\n          became known.")
ospfNbrHelloSuppressed = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 11), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfNbrHelloSuppressed.setDescription('Indicates whether Hellos are being suppressed\n          to the neighbor.')
...
if mibBuilder.loadTexts:
    ospfNbrRestartHelperStatus.setDescription('Indicates whether the router is acting\n          as a graceful restart helper for the neighbor.')
ospfNbrRestartHelperAge = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 13), Unsigned32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfNbrRestartHelperAge.setDescription('Remaining time in current OSPF graceful restart\n          interval, if the router is acting as a restart\n          helper for the neighbor.')
...
if mibBuilder.loadTexts:
    ospfVirtNbrState.setDescription('The state of the virtual neighbor relationship.')
ospfVirtNbrEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtNbrEvents.setDescription('The number of times this virtual link has\n          changed its state or an error has occurred.\n\n          Discontinuities in the value of this counter can occur\n          at re-initialization of the management system, and at other\n          times as indicated by the value of ospfDiscontinuityTime.')
ospfVirtNbrLsRetransQLen = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 7), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtNbrLsRetransQLen.setDescription('The current length of the retransmission\n          queue.')
ospfVirtNbrHelloSuppressed = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 8), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtNbrHelloSuppressed.setDescription('Indicates whether Hellos are being suppressed\n          to the neighbor.')
...
if mibBuilder.loadTexts:
    ospfVirtNbrRestartHelperStatus.setDescription('Indicates whether the router is acting\n          as a graceful restart helper for the neighbor.')
ospfVirtNbrRestartHelperAge = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 10), Unsigned32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtNbrRestartHelperAge.setDescription('Remaining time in current OSPF graceful restart\n          interval, if the router is acting as a restart\n          helper for the neighbor.')
...
if mibBuilder.loadTexts:
    ospfVirtNbrRestartHelperExitReason.setDescription('Describes the outcome of the last attempt at acting\n           as a graceful restart helper for the neighbor.')
ospfExtLsdbTable = MibTable((1, 3, 6, 1, 2, 1, 14, 12))
if mibBuilder.loadTexts:
    ospfExtLsdbTable.setDescription("The OSPF Process's external LSA link state database.\n\n          This table is identical to the OSPF LSDB Table\n          in format, but contains only external link state\n          advertisements.  The purpose is to allow external\n          LSAs to be displayed once for the router rather\n          than once in each non-stub area.\n\n          Note that external LSAs are also in the AS-scope link state\n          database.")
...
if mibBuilder.loadTexts:
    ospfExtLsdbEntry.setDescription('A single link state advertisement.')
...
if mibBuilder.loadTexts:
    ospfExtLsdbAdvertisement.setDescription('The entire link state advertisement, including\n          its header.')
...
if mibBuilder.loadTexts:
    ospfAreaAggregateEntry.setDescription('A single area aggregate entry.\n\n          Information in this table is persistent and when this object\n          is written the entity SHOULD save the change to non-volatile\n          storage.')
ospfAreaAggregateAreaID = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 14, 1, 1), AreaID()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAreaAggregateAreaID.setDescription('The area within which the address aggregate is to be\n          found.')
...
if mibBuilder.loadTexts:
    ospfAreaAggregateLsdbType.setDescription('The type of the address aggregate.  This field\n          specifies the Lsdb type that this address\n          aggregate applies to.')
ospfAreaAggregateNet = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 14, 1, 3), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAreaAggregateNet.setDescription('The IP address of the net or subnet indicated\n          by the range.')
ospfAreaAggregateMask = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 14, 1, 4), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAreaAggregateMask.setDescription('The subnet mask that pertains to the net or\n          subnet.')
ospfAreaAggregateStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 14, 1, 5), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    ospfAreaAggregateStatus.setDescription('This object permits management of the table by\n          facilitating actions such as row creation,\n          construction, and destruction.\n\n          The value of this object has no effect on\n          whether other objects in this conceptual row can be\n          modified.')
...
if mibBuilder.loadTexts:
    ospfLocalLsdbEntry.setDescription('A single link state advertisement.')
ospfLocalLsdbIpAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 1), IpAddress())
if mibBuilder.loadTexts:
    ospfLocalLsdbIpAddress.setDescription('The IP address of the interface from\n          which the LSA was received if the interface is\n          numbered.')
ospfLocalLsdbAddressLessIf = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 2), InterfaceIndexOrZero())
if mibBuilder.loadTexts:
    ospfLocalLsdbAddressLessIf.setDescription('The interface index of the interface from\n          which the LSA was received if the interface is\n          unnumbered.')
...
if mibBuilder.loadTexts:
    ospfLocalLsdbType.setDescription('The type of the link state advertisement.\n          Each link state type has a separate\n          advertisement format.')
ospfLocalLsdbLsid = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 4), IpAddress())
if mibBuilder.loadTexts:
    ospfLocalLsdbLsid.setDescription('The Link State ID is an LS Type Specific field\n          containing a 32-bit identifier in IP address format;\n          it identifies the piece of the routing domain\n          that is being described by the advertisement.')
ospfLocalLsdbRouterId = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 5), RouterID())
if mibBuilder.loadTexts:
    ospfLocalLsdbRouterId.setDescription('The 32-bit number that uniquely identifies the\n          originating router in the Autonomous System.')
ospfLocalLsdbSequence = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 6), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfLocalLsdbSequence.setDescription("The sequence number field is a signed 32-bit\n          integer.  It starts with the value '80000001'h,\n          or -'7FFFFFFF'h, and increments until '7FFFFFFF'h.\n          Thus, a typical sequence number will be very negative.\n          It is used to detect old and duplicate link state\n          advertisements.  The space of sequence numbers is linearly\n          ordered.  The larger the sequence number, the more recent\n          the advertisement.")
ospfLocalLsdbAge = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 7), Integer32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfLocalLsdbAge.setDescription('This field is the age of the link state\n          advertisement in seconds.')
ospfLocalLsdbChecksum = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 17, 1, 8), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfLocalLsdbChecksum.setDescription("This field is the checksum of the complete\n          contents of the advertisement, excepting the\n          age field.  The age field is excepted so that\n          an advertisement's age can be incremented\n          without updating the checksum.  The checksum\n          used is the same that is used for ISO\n          connectionless datagrams; it is commonly referred\n          to as the Fletcher checksum.")
...
if mibBuilder.loadTexts:
    ospfLocalLsdbAdvertisement.setDescription('The entire link state advertisement, including\n          its header.\n\n          Note that for variable length LSAs, SNMP agents\n          may not be able to return the largest string size.')
ospfVirtLocalLsdbTable = MibTable((1, 3, 6, 1, 2, 1, 14, 18))
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbTable.setDescription("The OSPF Process's link-local link state database\n          for virtual links.\n          This table is identical to the OSPF LSDB Table\n          in format, but contains only link-local Link State\n          Advertisements for virtual links.  The purpose is to\n          allow link-local LSAs to be displayed for each virtual\n          interface.  This table is implemented to support type-9 LSAs\n          that are defined in 'The OSPF Opaque LSA Option'.")
...
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbEntry.setDescription('A single link state advertisement.')
ospfVirtLocalLsdbTransitArea = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 1), AreaID())
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbTransitArea.setDescription('The transit area that the virtual link\n          traverses.  By definition, this is not 0.0.0.0.')
ospfVirtLocalLsdbNeighbor = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 2), RouterID())
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbNeighbor.setDescription('The Router ID of the virtual neighbor.')
...
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbType.setDescription('The type of the link state advertisement.\n          Each link state type has a separate\n          advertisement format.')
ospfVirtLocalLsdbLsid = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 4), IpAddress())
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbLsid.setDescription('The Link State ID is an LS Type Specific field\n          containing a 32-bit identifier in IP address format;\n          it identifies the piece of the routing domain\n          that is being described by the advertisement.')
ospfVirtLocalLsdbRouterId = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 5), RouterID())
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbRouterId.setDescription('The 32-bit number that uniquely identifies the\n          originating router in the Autonomous System.')
ospfVirtLocalLsdbSequence = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 6), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbSequence.setDescription("The sequence number field is a signed 32-bit\n          integer.  It starts with the value '80000001'h,\n          or -'7FFFFFFF'h, and increments until '7FFFFFFF'h.\n          Thus, a typical sequence number will be very negative.\n          It is used to detect old and duplicate link state\n          advertisements.  The space of sequence numbers is linearly\n          ordered.  The larger the sequence number, the more recent\n          the advertisement.")
ospfVirtLocalLsdbAge = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 7), Integer32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbAge.setDescription('This field is the age of the link state\n          advertisement in seconds.')
ospfVirtLocalLsdbChecksum = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 18, 1, 8), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbChecksum.setDescription("This field is the checksum of the complete\n          contents of the advertisement, excepting the\n          age field.  The age field is excepted so that\n          an advertisement's age can be incremented\n          without updating the checksum.  The checksum\n          used is the same that is used for ISO\n          connectionless datagrams; it is commonly\n          referred to as the Fletcher checksum.")
...
if mibBuilder.loadTexts:
    ospfAsLsdbEntry.setDescription('A single link state advertisement.')
...
if mibBuilder.loadTexts:
    ospfAsLsdbType.setDescription('The type of the link state advertisement.\n          Each link state type has a separate\n          advertisement format.')
ospfAsLsdbLsid = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 19, 1, 2), IpAddress())
if mibBuilder.loadTexts:
    ospfAsLsdbLsid.setDescription('The Link State ID is an LS Type Specific field\n          containing either a Router ID or an IP address;\n          it identifies the piece of the routing domain\n          that is being described by the advertisement.')
ospfAsLsdbRouterId = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 19, 1, 3), RouterID())
if mibBuilder.loadTexts:
    ospfAsLsdbRouterId.setDescription('The 32-bit number that uniquely identifies the\n          originating router in the Autonomous System.')
ospfAsLsdbSequence = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 19, 1, 4), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAsLsdbSequence.setDescription("The sequence number field is a signed 32-bit\n          integer.  It starts with the value '80000001'h,\n          or -'7FFFFFFF'h, and increments until '7FFFFFFF'h.\n          Thus, a typical sequence number will be very negative.\n          It is used to detect old and duplicate link state\n          advertisements.  The space of sequence numbers is linearly\n          ordered.  The larger the sequence number, the more recent\n          the advertisement.")
ospfAsLsdbAge = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 19, 1, 5), Integer32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAsLsdbAge.setDescription('This field is the age of the link state\n          advertisement in seconds.')
ospfAsLsdbChecksum = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 19, 1, 6), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAsLsdbChecksum.setDescription("This field is the checksum of the complete\n          contents of the advertisement, excepting the\n          age field.  The age field is excepted so that\n          an advertisement's age can be incremented\n          without updating the checksum.  The checksum\n          used is the same that is used for ISO\n          connectionless datagrams; it is commonly referred\n          to as the Fletcher checksum.")
...
if mibBuilder.loadTexts:
    ospfAsLsdbAdvertisement.setDescription('The entire link state advertisement, including\n          its header.')
ospfAreaLsaCountTable = MibTable((1, 3, 6, 1, 2, 1, 14, 20))
if mibBuilder.loadTexts:
    ospfAreaLsaCountTable.setDescription('This table maintains per-area, per-LSA-type counters')
...
if mibBuilder.loadTexts:
    ospfAreaLsaCountEntry.setDescription('An entry with a number of link advertisements\n              of a given type for a given area.')
ospfAreaLsaCountAreaId = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 20, 1, 1), AreaID())
if mibBuilder.loadTexts:
    ospfAreaLsaCountAreaId.setDescription('This entry Area ID.')
...
if mibBuilder.loadTexts:
    ospfAreaLsaCountLsaType.setDescription('This entry LSA type.')
ospfAreaLsaCountNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 20, 1, 3), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    ospfAreaLsaCountNumber.setDescription('Number of LSAs of a given type for a given area.')
...
if mibBuilder.loadTexts:
    ospfCompliance.setDescription('The compliance statement for OSPF systems\n          conforming to RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfCompliance2.setDescription('The compliance statement.')
...
if mibBuilder.loadTexts:
    ospfComplianceObsolete.setDescription('Contains obsolete object groups.')
...
if mibBuilder.loadTexts:
    ospfBasicGroup.setDescription('These objects are used to monitor/manage\n          global OSPF parameters.  This object group\n          conforms to RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfAreaGroup.setDescription('These objects are used for OSPF systems\n          supporting areas per RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfStubAreaGroup.setDescription('These objects are used for OSPF systems\n          supporting stub areas.')
...
if mibBuilder.loadTexts:
    ospfLsdbGroup.setDescription('These objects are used for OSPF systems\n          that display their link state database.')
...
if mibBuilder.loadTexts:
    ospfAreaRangeGroup.setDescription('These objects are used for non-CIDR OSPF\n          systems that support multiple areas.  This\n          object group is obsolete.')
...
if mibBuilder.loadTexts:
    ospfHostGroup.setDescription('These objects are used for OSPF systems\n          that support attached hosts.')
...
if mibBuilder.loadTexts:
    ospfIfGroup.setDescription('These objects are used to monitor/manage OSPF\n          interfaces.  This object group conforms to RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfIfMetricGroup.setDescription('These objects are used for OSPF systems for supporting\n          interface metrics.')
...
if mibBuilder.loadTexts:
    ospfVirtIfGroup.setDescription('These objects are used for OSPF systems for supporting\n          virtual interfaces.  This object group conforms\n          to RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfNbrGroup.setDescription('These objects are used to monitor/manage OSPF neighbors.\n          This object group conforms to RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfVirtNbrGroup.setDescription('These objects are used to monitor/manage OSPF virtual\n          neighbors.  This object group conforms to RFC 1850.')
...
if mibBuilder.loadTexts:
    ospfAreaAggregateGroup.setDescription('These objects are used for OSPF systems to support\n          network prefix aggregation across areas.')
...
if mibBuilder.loadTexts:
    ospfLocalLsdbGroup.setDescription('These objects are used for OSPF systems\n          that display their link-local link state databases\n          for non-virtual links.')
...
if mibBuilder.loadTexts:
    ospfVirtLocalLsdbGroup.setDescription('These objects are used for OSPF systems\n           that display their link-local link state databases\n           for virtual links.')
...
if mibBuilder.loadTexts:
    ospfAsLsdbGroup.setDescription('These objects are used for OSPF systems\n           that display their AS-scope link state database.')
...
if mibBuilder.loadTexts:
    ospfBasicGroup2.setDescription('These objects are used to monitor/manage OSPF global\n          parameters.')
...
if mibBuilder.loadTexts:
    ospfAreaGroup2.setDescription('These objects are used by OSPF systems\n            to support areas.')
...
if mibBuilder.loadTexts:
    ospfIfGroup2.setDescription('These objects are used to monitor/manage OSPF interfaces.')
...
if mibBuilder.loadTexts:
    ospfVirtIfGroup2.setDescription('These objects are used to monitor/manage OSPF\n          virtual interfaces.')
...
if mibBuilder.loadTexts:
    ospfNbrGroup2.setDescription('These objects are used to monitor/manage OSPF\n          neighbors.')
...
if mibBuilder.loadTexts:
    ospfVirtNbrGroup2.setDescription('These objects are used to monitor/manage OSPF\n          virtual neighbors.')
...
if mibBuilder.loadTexts:
    ospfAreaAggregateGroup2.setDescription('These objects are used for OSPF systems to support\n          network prefix aggregation across areas.')
ospfAreaLsaCountGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 14, 15, 1, 24)).setObjects(*(('OSPF-MIB', 'ospfAreaLsaCountNumber'),))
if mibBuilder.loadTexts:
    ospfAreaLsaCountGroup.setDescription('These objects are used for OSPF systems that display\n          per-area, per-LSA-type counters.')
...
if mibBuilder.loadTexts:
    ospfHostGroup2.setDescription('These objects are used for OSPF systems\n          that support attached hosts.')
ospfObsoleteGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 14, 15, 1, 26)).setObjects(*(('OSPF-MIB', 'ospfAuthType'),))
if mibBuilder.loadTexts:
    ospfObsoleteGroup.setDescription('These objects are obsolete and are no longer required for\n          OSPF systems.  They are placed into this group for SMI\n          conformance.')
