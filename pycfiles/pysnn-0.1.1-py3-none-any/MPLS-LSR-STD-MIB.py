...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-LSR-STD-MIB.py
# Compiled at: 2016-02-13 18:14:00
...
if mibBuilder.loadTexts:
    mplsLsrStdMIB.setLastUpdated('200406030000Z')
if mibBuilder.loadTexts:
    mplsLsrStdMIB.setOrganization('Multiprotocol Label Switching (MPLS) Working Group')
if mibBuilder.loadTexts:
    mplsLsrStdMIB.setContactInfo('        Cheenu Srinivasan\n                     Bloomberg L.P.\n             Email:  cheenu@bloomberg.net\n            \n                     Arun Viswanathan\n                     Force10 Networks, Inc.\n             Email:  arunv@force10networks.com\n            \n                     Thomas D. Nadeau\n                     Cisco Systems, Inc.\n             Email:  tnadeau@cisco.com\n            \n             Comments about this document should be emailed\n             directly to the MPLS working group mailing list at\n             mpls@uu.net.')
if mibBuilder.loadTexts:
    mplsLsrStdMIB.setDescription('This MIB module contains managed object definitions for\n             the Multiprotocol Label Switching (MPLS) Router as\n             defined in: Rosen, E., Viswanathan, A., and R.\n             Callon, Multiprotocol Label Switching Architecture,\n             RFC 3031, January 2001.\n            \n             Copyright (C) The Internet Society (2004). The\n             initial version of this MIB module was published\n             in RFC 3812. For full legal notices see the RFC\n             itself or see:\n             http://www.ietf.org/copyrights/ianamib.html')
...
if mibBuilder.loadTexts:
    mplsXCOperStatus.setDescription('The actual operational status of this cross-\n             connect.')
...
if mibBuilder.loadTexts:
    mplsLsrModuleFullCompliance.setDescription('Compliance statement for agents that provide full\n                      support for MPLS-LSR-STD-MIB. Such devices can\n                      then be monitored and also be configured using\n                      this MIB module.')
mplsLsrModuleReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 2, 2,
                                                    2, 2)).setObjects(*(('IF-MIB', 'ifGeneralInformationGroup'), ('IF-MIB', 'ifCounterDiscontinuityGroup'), ('MPLS-LSR-STD-MIB', 'mplsInterfaceGroup'), ('MPLS-LSR-STD-MIB', 'mplsInSegmentGroup'), ('MPLS-LSR-STD-MIB', 'mplsOutSegmentGroup'), ('MPLS-LSR-STD-MIB', 'mplsXCGroup'), ('MPLS-LSR-STD-MIB', 'mplsPerfGroup'), ('MPLS-LSR-STD-MIB', 'mplsLabelStackGroup'), ('MPLS-LSR-STD-MIB', 'mplsHCInSegmentPerfGroup'), ('MPLS-LSR-STD-MIB', 'mplsHCOutSegmentPerfGroup'), ('MPLS-LSR-STD-MIB', 'mplsLsrNotificationGroup')))
if mibBuilder.loadTexts:
    mplsLsrModuleReadOnlyCompliance.setDescription('Compliance requirement for implementations that only\n                      provide read-only support for MPLS-LSR-STD-MIB. Such\n                      devices can then be monitored but cannot be configured\n                      using this MIB module.\n                     ')
...
if mibBuilder.loadTexts:
    mplsInterfaceGroup.setDescription('Collection of objects needed for MPLS interface\n                and interface performance information.')
...
if mibBuilder.loadTexts:
    mplsInSegmentGroup.setDescription('Collection of objects needed to implement an in-\n            segment.')
...
if mibBuilder.loadTexts:
    mplsOutSegmentGroup.setDescription('Collection of objects needed to implement an out-\n            segment.')
...
if mibBuilder.loadTexts:
    mplsXCGroup.setDescription('Collection of objects needed to implement a\n                cross-connect entry.')
...
if mibBuilder.loadTexts:
    mplsLabelStackGroup.setDescription('Objects needed to support label stacking.')
...
if mibBuilder.loadTexts:
    mplsLsrNotificationGroup.setDescription('Set of notifications implemented in this\n                module.')
