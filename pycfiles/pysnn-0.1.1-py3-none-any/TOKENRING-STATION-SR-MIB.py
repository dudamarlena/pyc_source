...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/TOKENRING-STATION-SR-MIB.py
# Compiled at: 2016-02-13 18:32:06
...
if mibBuilder.loadTexts:
    dot5SrMIB.setLastUpdated('9412161000Z')
if mibBuilder.loadTexts:
    dot5SrMIB.setOrganization('IETF Interfaces MIB Working Group')
if mibBuilder.loadTexts:
    dot5SrMIB.setContactInfo('       Keith McCloghrie\n            Postal: Cisco Systems, Inc.\n                    170 West Tasman Drive\n                    San Jose, CA  95134-1706\n                    US\n\n             Phone: +1 408 526 5260\n             Email: kzm@cisco.com')
if mibBuilder.loadTexts:
    dot5SrMIB.setDescription('The MIB module for managing source routes in\n            end-stations on IEEE 802.5 Token Ring networks.')
...
if mibBuilder.loadTexts:
    dot5SrCompliance.setDescription('The compliance statement for SNMPv2 entities\n        which implement the IEEE 802.5 Station Source Route\n        MIB.')
...
if mibBuilder.loadTexts:
    dot5SrRouteGroup.setDescription('A collection of objects providing for the management of\n        source routes in stations on IEEE 802.5 source-routing\n        networks.')
