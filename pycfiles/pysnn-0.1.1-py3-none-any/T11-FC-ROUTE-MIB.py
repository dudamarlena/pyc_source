...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-ROUTE-MIB.py
# Compiled at: 2016-02-13 18:30:21
...
if mibBuilder.loadTexts:
    t11FcRouteMIB.setLastUpdated('200608140000Z')
if mibBuilder.loadTexts:
    t11FcRouteMIB.setOrganization('T11')
if mibBuilder.loadTexts:
    t11FcRouteMIB.setContactInfo('     Claudio DeSanti\n                    Cisco Systems, Inc.\n                    170 West Tasman Drive\n                    San Jose, CA 95134 USA\n                    EMail: cds@cisco.com\n\n\n                    Keith McCloghrie\n                    Cisco Systems, Inc.\n                    170 West Tasman Drive\n                    San Jose, CA USA 95134\n                    Email: kzm@cisco.com')
if mibBuilder.loadTexts:
    t11FcRouteMIB.setDescription('The MIB module for configuring and displaying Fibre\n           Channel Route Information.\n\n           Copyright (C) The Internet Society (2006).  This version\n           of this MIB module is part of RFC 4625;  see the RFC\n           itself for full legal notices.')
...
if mibBuilder.loadTexts:
    t11FcRouteFabricTable.setDescription('The table containing Fibre Channel Routing information\n           that is specific to a Fabric.')
t11FcRouteFabricEntry = MibTableRow((1, 3, 6, 1, 2, 1, 144, 1, 1, 1)).setIndexNames((0,
                                                                                     'FC-MGMT-MIB',
                                                                                     'fcmInstanceIndex'), (0,
                                                                                                           'FC-MGMT-MIB',
                                                                                                           'fcmSwitchIndex'), (0,
...
if mibBuilder.loadTexts:
    t11FcRouteGroup.setDescription('A collection of objects for displaying and configuring\n           routes.')
