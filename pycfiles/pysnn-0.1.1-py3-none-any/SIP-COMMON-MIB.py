...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SIP-COMMON-MIB.py
# Compiled at: 2016-02-13 18:28:00
...
if mibBuilder.loadTexts:
    sipCommonCfgTimerT1.setDescription('This object reflects the T1 timer for a SIP entity.  T1 is an\n        estimate of the round-trip time (RTT) between the client and\n        server transactions.')
...
if mibBuilder.loadTexts:
    sipCommonTransCurrentactions.setDescription('This object contains the number of transactions awaiting\n        definitive (non-1xx) response.  In the case of a forked\n        request, each branch counts as a single transaction\n        corresponding to the entity identified by applIndex.')
sipCommonStatsRetryTable = MibTable((1, 3, 6, 1, 2, 1, 149, 1, 7, 1))
if mibBuilder.loadTexts:
    sipCommonStatsRetryTable.setDescription('This table contains retry statistics objects applicable to each\n        SIP entity in this system.')
sipCommonStatsRetryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 149, 1, 7, 1, 1)).setIndexNames((0,
                                                                                           'NETWORK-SERVICES-MIB',
                                                                                           'applIndex'), (0,
                                                                                                          'SIP-COMMON-MIB',
                                                                                                          'sipCommonStatsRetryMethod'))
if mibBuilder.loadTexts:
    sipCommonStatsRetryEntry.setDescription('A row of retry statistics.\n\n        Each row represents those objects for a particular SIP entity\n        present in this system.  applIndex is used to uniquely identify\n        these instances of SIP entities and correlate them through the\n        common framework of the NETWORK-SERVICES-MIB (RFC 2788).')
sipCommonStatsRetryMethod = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 7, 1, 1, 1), SipTCMethodName())
if mibBuilder.loadTexts:
    sipCommonStatsRetryMethod.setDescription('This object uniquely identifies the SIP method related to the\n        objects in a row.')
sipCommonStatsRetries = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 7, 1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonStatsRetries.setDescription('This object reflects the total number of request\n        retransmissions that have been sent by the SIP entity.  Note\n        that there could be multiple retransmissions per request.\n\n        Discontinuities in the value of this counter can occur at\n        re-initialization of the SIP entity or service.  A Management\n        Station can detect discontinuities in this counter by\n        monitoring the sipCommonStatsRetryDisconTime object in the same\n        row.')
sipCommonStatsRetryFinalResponses = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 7, 1,
                                                    1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonStatsRetryFinalResponses.setDescription('This object reflects the total number of Final Response retries\n        that have been sent by the SIP entity.  Note that there could\n        be multiple retransmissions per request.\n\n        Discontinuities in the value of this counter can occur at\n        re-initialization of the SIP entity or service.  A Management\n        Station can detect discontinuities in this counter by\n\n        monitoring the sipCommonStatsRetryDisconTime object in the same\n        row.')
sipCommonStatsRetryNonFinalResponses = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 7,
                                                       1, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonStatsRetryNonFinalResponses.setDescription('This object reflects the total number of non-Final Response\n        retries that have been sent by the SIP entity.\n\n        Discontinuities in the value of this counter can occur at\n        re-initialization of the SIP entity or service.  A Management\n        Station can detect discontinuities in this counter by\n        monitoring the sipCommonStatsRetryDisconTime object in the same\n        row.')
sipCommonStatsRetryDisconTime = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 7, 1, 1,
                                                5), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonStatsRetryDisconTime.setDescription('The value of the sysUpTime object when the counters for the\n        retry statistics objects in this row last experienced a\n        discontinuity.')
sipCommonOtherStatsTable = MibTable((1, 3, 6, 1, 2, 1, 149, 1, 8, 1))
if mibBuilder.loadTexts:
    sipCommonOtherStatsTable.setDescription('This table contains other common statistics supported by each\n        SIP entity in this system.')
sipCommonOtherStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 149, 1, 8, 1, 1)).setIndexNames((0,
                                                                                           'NETWORK-SERVICES-MIB',
                                                                                           'applIndex'))
if mibBuilder.loadTexts:
    sipCommonOtherStatsEntry.setDescription("Information on a particular SIP entity's other common\n        statistics.\n\n        Each row represents those objects for a particular SIP entity\n        present in this system.  applIndex is used to uniquely identify\n        these instances of SIP entities and correlate them through\n        the common framework of the NETWORK-SERVICES-MIB (RFC 2788).")
sipCommonOtherStatsNumUnsupportedUris = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 8,
                                                        1, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonOtherStatsNumUnsupportedUris.setDescription('Number of RequestURIs received with an unsupported scheme.\n        A server normally responds to such requests with a 400 Bad\n        Request status code.\n\n        Discontinuities in the value of this counter can occur at\n        re-initialization of the SIP entity or service.  A Management\n        Station can detect discontinuities in this counter by\n        monitoring the sipCommonOtherStatsDisconTime object in the same\n        row.')
sipCommonOtherStatsNumUnsupportedMethods = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1,
                                                           8, 1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonOtherStatsNumUnsupportedMethods.setDescription('Number of SIP requests received with unsupported methods.  A\n        server normally responds to such requests with a 501 (Not\n        Implemented) or 405 (Method Not Allowed).\n\n        Discontinuities in the value of this counter can occur at\n        re-initialization of the SIP entity or service.  A Management\n        Station can detect discontinuities in this counter by\n        monitoring the sipCommonOtherStatsDisconTime object in the same\n        row.')
sipCommonOtherStatsOtherwiseDiscardedMsgs = MibTableColumn((1, 3, 6, 1, 2, 1, 149,
                                                            1, 8, 1, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonOtherStatsOtherwiseDiscardedMsgs.setDescription('Number of SIP messages received that, for any number of\n        reasons, was discarded without a response.\n\n        Discontinuities in the value of this counter can occur at\n        re-initialization of the SIP entity or service.  A Management\n        Station can detect discontinuities in this counter by\n        monitoring the sipCommonOtherStatsDisconTime object in the same\n        row.')
sipCommonOtherStatsDisconTime = MibTableColumn((1, 3, 6, 1, 2, 1, 149, 1, 8, 1, 1,
                                                4), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipCommonOtherStatsDisconTime.setDescription('The value of the sysUpTime object when the counters for the\n        statistics objects in this row last experienced a\n        discontinuity.')
sipCommonStatusCodeNotifTo = MibScalar((1, 3, 6, 1, 2, 1, 149, 1, 9, 1), SnmpAdminString()).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    sipCommonStatusCodeNotifTo.setDescription("This object contains the value of the To header in the message\n        containing the status code that caused the notification.  The\n        header name will be part of this object value.  For example,\n        'To: Watson '.")
sipCommonStatusCodeNotifFrom = MibScalar((1, 3, 6, 1, 2, 1, 149, 1, 9, 2), SnmpAdminString()).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    sipCommonStatusCodeNotifFrom.setDescription("This object contains the value of the From header in the\n        message containing the status code that caused the\n\n        notification.  The header name will be part of this object\n        value.  For example, 'From: Watson '.")
sipCommonStatusCodeNotifCallId = MibScalar((1, 3, 6, 1, 2, 1, 149, 1, 9, 3), SnmpAdminString()).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    sipCommonStatusCodeNotifCallId.setDescription("This object contains the value of the Call-ID in the message\n        containing the status code that caused the notification.  The\n        header name will be part of this object value.  For example,\n        'Call-ID: 5551212@example.com'.")
sipCommonStatusCodeNotifCSeq = MibScalar((1, 3, 6, 1, 2, 1, 149, 1, 9, 4), Unsigned32()).setMaxAccess('accessiblefornotify')
if mibBuilder.loadTexts:
    sipCommonStatusCodeNotifCSeq.setDescription("This object contains the CSeq value in the message containing\n        the status code that caused the notification.  The header name\n        will be part of this object value.  For example, 'CSeq: 1722\n        INVITE'.")
...
if mibBuilder.loadTexts:
    sipCommonStatusCodeNotif.setDescription('Signifies that a specific status code has been sent or received\n        by the system.')
sipCommonStatusCodeThreshExceededInNotif = NotificationType((1, 3, 6, 1, 2, 1, 149,
                                                             0, 2)).setObjects(*(('SIP-COMMON-MIB', 'sipCommonNotifSequenceNumber'), ('SIP-COMMON-MIB', 'sipCommonNotifApplIndex'), ('SIP-COMMON-MIB', 'sipCommonStatusCodeIns')))
if mibBuilder.loadTexts:
    sipCommonStatusCodeThreshExceededInNotif.setDescription('Signifies that a specific status code was found to have been\n        received by the system frequently enough to exceed the\n        configured threshold.  This notification can be used as\n        an early warning mechanism in lieu of using\n        sipCommonStatusCodeNotif.')
sipCommonStatusCodeThreshExceededOutNotif = NotificationType((1, 3, 6, 1, 2, 1, 149,
                                                              0, 3)).setObjects(*(('SIP-COMMON-MIB', 'sipCommonNotifSequenceNumber'), ('SIP-COMMON-MIB', 'sipCommonNotifApplIndex'), ('SIP-COMMON-MIB', 'sipCommonStatusCodeOuts')))
if mibBuilder.loadTexts:
    sipCommonStatusCodeThreshExceededOutNotif.setDescription('Signifies that a specific status code was found to have been\n        sent by the system enough to exceed the configured threshold.\n        This notification can be used as an early warning mechanism in\n        lieu of using sipCommonStatusCodeNotif.')
...
if mibBuilder.loadTexts:
    sipCommonServiceWarmStart.setDescription("Signifies that the SIP service has reinitialized itself and is\n        restarting after an administrative 'reset'.  The configuration\n        or behavior of the service MAY be altered.")
...
if mibBuilder.loadTexts:
    sipCommonConfigGroup.setDescription('A collection of objects providing configuration common to all\n        SIP entities.')
sipCommonInformationalGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 149, 2, 2, 2)).setObjects(*(('SIP-COMMON-MIB', 'sipCommonCfgOrganization'), ))
if mibBuilder.loadTexts:
    sipCommonInformationalGroup.setDescription('A collection of objects providing configuration common to all\n        SIP entities.')
...
if mibBuilder.loadTexts:
    sipCommonConfigTimerGroup.setDescription('A collection of objects providing timer configuration common to\n        all SIP entities.')
...
if mibBuilder.loadTexts:
    sipCommonStatsGroup.setDescription('A collection of objects providing statistics common to all SIP\n        entities.')
...
if mibBuilder.loadTexts:
    sipCommonStatusCodeNotifGroup.setDescription('A collection of objects related to the control and attribution\n        of notifications common to all SIP entities.')
...
if mibBuilder.loadTexts:
    sipCommonNotifObjectsGroup.setDescription('A collection of accessible-for-notify objects related to the\n        notification defined in this MIB module.')
