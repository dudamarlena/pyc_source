...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/LMP-MIB.py
# Compiled at: 2016-02-13 18:19:51
...
if mibBuilder.loadTexts:
    lmpOperStatus.setDescription('The actual operational status of LMP on the node.')
lmpNbrTable = MibTable((1, 3, 6, 1, 2, 1, 10, 227, 1, 3))
if mibBuilder.loadTexts:
    lmpNbrTable.setDescription('This table specifies the neighbor node(s) to which control\n        channels may be established.')
lmpNbrEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 227, 1, 3, 1)).setIndexNames((0, 'LMP-MIB', 'lmpNbrNodeId'))
if mibBuilder.loadTexts:
    lmpNbrEntry.setDescription('An entry in this table is created by a LMP-enabled device for\n        every pair of nodes that can establish control channels.')
lmpNbrNodeId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 3, 1, 1), LmpNodeId())
if mibBuilder.loadTexts:
    lmpNbrNodeId.setDescription('This is a unique index for an entry in the LmpNbrTable.\n        This value represents the remote Node ID.')
...
if mibBuilder.loadTexts:
    lmpNbrAdminStatus.setDescription('The desired operational status of LMP to this remote node.')
...
if mibBuilder.loadTexts:
    lmpCcAdminStatus.setDescription('The desired operational status of this control channel.')
...
if mibBuilder.loadTexts:
    lmpLinkVerifyTransmissionRate.setDescription('This is the transmission rate of the data link over which\n        the Test messages will be transmitted and is expressed in\n        bytes per second.')
...
if mibBuilder.loadTexts:
    lmpDataLinkActiveOperStatus.setDescription('The actual operational status of this data-bearing link\n\n\n\n        (active FSM).')
...
if mibBuilder.loadTexts:
    lmpModuleFullCompliance.setDescription('Compliance statement for agents that support the\n        configuration and monitoring of LMP MIB.')
...
if mibBuilder.loadTexts:
    lmpModuleReadOnlyCompliance.setDescription('Compliance statement for agents that support the\n        monitoring of the LMP MIB.')
...
if mibBuilder.loadTexts:
    lmpNodeGroup.setDescription('Collection of objects that represent LMP node\n           configuration.')
...
if mibBuilder.loadTexts:
    lmpControlChannelGroup.setDescription('Objects that can be used to configure LMP interface.')
lmpCcIsInterfaceGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 227, 2, 2, 3)).setObjects(*(('LMP-MIB', 'lmpCcIsIf'),))
if mibBuilder.loadTexts:
    lmpCcIsInterfaceGroup.setDescription('Objects that can be used to configure control channels\n           that are interfaces.')
...
if mibBuilder.loadTexts:
    lmpCcIsNotInterfaceGroup.setDescription('Objects that can be used to configure control channels\n           that are not interfaces.')
...
if mibBuilder.loadTexts:
    lmpLinkPropertyCorrelationGroup.setDescription('Collection of objects used to configure the link\n           property correlation procedure.')
...
if mibBuilder.loadTexts:
    lmpLinkVerificationGroup.setDescription('Collection of objects that represent the link\n           verification procedure configuration.')
...
if mibBuilder.loadTexts:
    lmpPerfGroup.setDescription('Collection of objects used to provide performance\n           information about LMP interfaces and data-bearing links.')
...
if mibBuilder.loadTexts:
    lmpTeLinkGroup.setDescription('Objects that can be used to configure TE links.')
...
if mibBuilder.loadTexts:
    lmpDataLinkGroup.setDescription('Collection of objects that represent data-bearing link\n           configuration.')
...
if mibBuilder.loadTexts:
    lmpNotificationGroup.setDescription('Set of notifications defined in this module.')
