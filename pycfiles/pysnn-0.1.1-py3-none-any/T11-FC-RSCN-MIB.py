...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/T11-FC-RSCN-MIB.py
# Compiled at: 2016-02-13 18:30:30
...
if mibBuilder.loadTexts:
    t11FcRscnStatsEntry.setDescription('An entry containing statistics for a particular Fabric\n           (identified by a t11FcRscnFabricIndex value) on a particular\n           switch (identified by values of fcmInstanceIndex and\n           fcmSwitchIndex).')
t11FcRscnInScrs = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInScrs.setDescription('The number of SCRs received from Nx_Ports\n           by this switch on this Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnInRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInRscns.setDescription('The number of RSCNs received from Nx_Ports\n           by this switch on this Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnOutRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutRscns.setDescription('The number of RSCNs transmitted to Nx_Ports\n           by this switch on this Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnInSwRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInSwRscns.setDescription('The number of SW_RSCNs received by this switch from\n           other switches on this Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnOutSwRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutSwRscns.setDescription('The number of SW_RSCNs transmitted by this switch\n           from other switches on this Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnScrRejects = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnScrRejects.setDescription('The number of SCRs rejected by this switch on\n           this Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnRscnRejects = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnRscnRejects.setDescription('The number of RSCNs rejected by this switch on this\n           Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnSwRscnRejects = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnSwRscnRejects.setDescription('The number of SW_RSCN rejected by this switch on this\n           Fabric.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.')
t11FcRscnInUnspecifiedRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 9), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInUnspecifiedRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) received by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0000'b\n           meaning 'Event is not specified'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnOutUnspecifiedRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 10), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutUnspecifiedRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) sent by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0000'b\n           meaning 'Event is not specified'.\n\n\n\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnInChangedAttribRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1,
                                                11), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInChangedAttribRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) received by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0002'b\n           meaning 'Changed Port Attribute'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnOutChangedAttribRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1,
                                                 12), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutChangedAttribRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) sent by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0002'b\n           meaning 'Changed Port Attribute'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnInChangedServiceRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1,
                                                 13), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInChangedServiceRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) received by this switch on this Fabric which\n\n\n\n           contained an RSCN Event Qualifier value of '0003'b\n           meaning 'Changed Service Object'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnOutChangedServiceRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1,
                                                  14), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutChangedServiceRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) sent by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0003'b\n           meaning 'Changed Service Object'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnInChangedSwitchRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1,
                                                15), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInChangedSwitchRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) received by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0004'b\n           meaning 'Changed Switch Configuration'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnOutChangedSwitchRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1,
                                                 16), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutChangedSwitchRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) sent by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0004'b\n           meaning 'Changed Switch Configuration'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnInRemovedRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 17), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnInRemovedRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) received by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0005'b\n           meaning 'Removed Object'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnOutRemovedRscns = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 2, 1, 1, 18), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnOutRemovedRscns.setDescription("The number of Registered State Change Notifications\n           (RSCNs) sent by this switch on this Fabric which\n           contained an RSCN Event Qualifier value of '0005'b\n           meaning 'Removed Object'.\n\n           This counter has no discontinuities other than\n           those that all Counter32s have when sysUpTime=0.")
t11FcRscnNotifyControlTable = MibTable((1, 3, 6, 1, 2, 1, 161, 1, 3, 1))
if mibBuilder.loadTexts:
    t11FcRscnNotifyControlTable.setDescription('A table of control information for notifications\n           generated due to the rejection of an SCR or RSCN.')
t11FcRscnNotifyControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 161, 1, 3, 1, 1)).setIndexNames((0,
                                                                                              'FC-MGMT-MIB',
                                                                                              'fcmInstanceIndex'), (0,
                                                                                                                    'FC-MGMT-MIB',
                                                                                                                    'fcmSwitchIndex'), (0,
...
if mibBuilder.loadTexts:
    t11FcRscnRejectReasonCodeExp.setDescription('This object contains the Reason Code Explanation\n           of the most recent rejection by this switch of an\n           RSCN, SCR or SW_RSCN on this Fabric.')
t11FcRscnRejectReasonVendorCode = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 3, 1, 1,
                                                  7), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 1)).setFixedLength(1)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    t11FcRscnRejectReasonVendorCode.setDescription('This object contains the Reason Vendor Specific\n           Code of the most recent rejection by this switch\n           of an RSCN, SCR or SW_RSCN on this Fabric.')
...
if mibBuilder.loadTexts:
    t11FcRscnIlsRejectReqNotify.setDescription('This notification is generated when a switch rejects\n           an SW_RSCN.\n\n           The value of t11FcRscnRejectedRequestString indicates the\n           binary content of the rejected request if available, or\n           the zero-length string otherwise.  The source of the\n           rejected request is given by t11FcRscnRejectedRequestSource,\n           and the reason for rejection is given by the values of\n           t11FcRscnRejectReasonCode, t11FcRscnRejectReasonCodeExp\n           and t11FcRscnRejectReasonVendorCode.')
...
if mibBuilder.loadTexts:
    t11FcRscnCompliance.setDescription('The compliance statement for entities that implement\n           this MIB.')
t11FcRscnRegistrationGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 161, 2, 2, 1)).setObjects(*(('T11-FC-RSCN-MIB', 't11FcRscnRegType'), ))
if mibBuilder.loadTexts:
    t11FcRscnRegistrationGroup.setDescription('A collection of objects for monitoring RSCN\n           registrations.')
...
if mibBuilder.loadTexts:
    t11FcRscnStatsGroup.setDescription('A collection of objects for collecting RSCN-related\n           statistics.')
...
if mibBuilder.loadTexts:
    t11FcRscnNotifyControlGroup.setDescription('A collection of notification control and\n           notification information objects.')
...
if mibBuilder.loadTexts:
    t11FcRscnNotifyGroup.setDescription('A collection of notifications for monitoring\n           ILS and ELS rejections by the RSCN module.')
