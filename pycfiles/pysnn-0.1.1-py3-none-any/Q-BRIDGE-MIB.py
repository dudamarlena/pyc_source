...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/Q-BRIDGE-MIB.py
# Compiled at: 2016-02-13 18:25:16
...
dot1qVlanVersionNumber = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1))).clone(namedValues=NamedValues(('version1',
                                                                                                                                                                                  1)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanVersionNumber.setDescription('The version number of IEEE 802.1Q that this device\n        supports.')
dot1qMaxVlanId = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 1, 2), VlanId()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qMaxVlanId.setDescription('The maximum IEEE 802.1Q VLAN-ID that this device\n        supports.')
dot1qMaxSupportedVlans = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 1, 3), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qMaxSupportedVlans.setDescription('The maximum number of IEEE 802.1Q VLANs that this\n        device supports.')
dot1qNumVlans = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 1, 4), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qNumVlans.setDescription('The current number of IEEE 802.1Q VLANs that are\n        configured in this device.')
dot1qGvrpStatus = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 1, 5), EnabledStatus()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    dot1qGvrpStatus.setDescription('The administrative status requested by management for\n        GVRP.  The value enabled(1) indicates that GVRP should\n        be enabled on this device, on all ports for which it has\n        not been specifically disabled.  When disabled(2), GVRP\n        is disabled on all ports, and all GVRP packets will be\n        forwarded transparently.  This object affects all GVRP\n        Applicant and Registrar state machines.  A transition\n        from disabled(2) to enabled(1) will cause a reset of all\n        GVRP state machines on all ports.\n\n        The value of this object MUST be retained across\n        reinitializations of the management system.')
dot1qFdbTable = MibTable((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 1))
if mibBuilder.loadTexts:
    dot1qFdbTable.setDescription('A table that contains configuration and control\n        information for each Filtering Database currently\n        operating on this device.  Entries in this table appear\n        automatically when VLANs are assigned FDB IDs in the\n        dot1qVlanCurrentTable.')
dot1qFdbEntry = MibTableRow((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 1, 1)).setIndexNames((0,
                                                                                  'Q-BRIDGE-MIB',
                                                                                  'dot1qFdbId'))
if mibBuilder.loadTexts:
    dot1qFdbEntry.setDescription('Information about a specific Filtering Database.')
dot1qFdbId = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 1, 1, 1), Unsigned32())
if mibBuilder.loadTexts:
    dot1qFdbId.setDescription('The identity of this Filtering Database.')
dot1qFdbDynamicCount = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qFdbDynamicCount.setDescription('The current number of dynamic entries in this\n        Filtering Database.')
dot1qTpFdbTable = MibTable((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 2))
if mibBuilder.loadTexts:
    dot1qTpFdbTable.setDescription('A table that contains information about unicast entries\n        for which the device has forwarding and/or filtering\n        information.  This information is used by the\n        transparent bridging function in determining how to\n        propagate a received frame.')
dot1qTpFdbEntry = MibTableRow((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 2, 1)).setIndexNames((0,
                                                                                    'Q-BRIDGE-MIB',
                                                                                    'dot1qFdbId'), (0,
                                                                                                    'Q-BRIDGE-MIB',
                                                                                                    'dot1qTpFdbAddress'))
if mibBuilder.loadTexts:
    dot1qTpFdbEntry.setDescription('Information about a specific unicast MAC address for\n        which the device has some forwarding and/or filtering\n        information.')
dot1qTpFdbAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 2, 1, 1), MacAddress())
if mibBuilder.loadTexts:
    dot1qTpFdbAddress.setDescription('A unicast MAC address for which the device has\n        forwarding and/or filtering information.')
...
if mibBuilder.loadTexts:
    dot1qTpFdbPort.setDescription("Either the value '0', or the port number of the port on\n        which a frame having a source address equal to the value\n        of the corresponding instance of dot1qTpFdbAddress has\n        been seen.  A value of '0' indicates that the port\n        number has not been learned but that the device does\n        have some forwarding/filtering information about this\n        address (e.g., in the dot1qStaticUnicastTable).\n        Implementors are encouraged to assign the port value to\n        this object whenever it is learned, even for addresses\n        for which the corresponding value of dot1qTpFdbStatus is\n        not learned(3).")
dot1qTpFdbStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 2, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(('other',
                                                                                                                                                                                                   1), ('invalid',
                                                                                                                                                                                                        2), ('learned',
                                                                                                                                                                                                             3), ('self',
                                                                                                                                                                                                                  4), ('mgmt',
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  2), ('permanent',
                                                                                                                                                                                                                       3), ('deleteOnReset',
                                                                                                                                                                                                                            4), ('deleteOnTimeout',
                                                                                                                                                                                                                                 5))).clone('permanent')).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    dot1qStaticMulticastStatus.setDescription('This object indicates the status of this entry.\n            other(1) - this entry is currently in use, but\n                the conditions under which it will remain\n                so differ from the following values.\n\n            invalid(2) - writing this value to the object\n                removes the corresponding entry.\n            permanent(3) - this entry is currently in use\n                and will remain so after the next reset of\n                the bridge.\n            deleteOnReset(4) - this entry is currently in\n                use and will remain so until the next\n                reset of the bridge.\n            deleteOnTimeout(5) - this entry is currently in\n                use and will remain so until it is aged out.\n\n        The value of this object MUST be retained across\n        reinitializations of the management system.')
dot1qVlanNumDeletes = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanNumDeletes.setDescription('The number of times a VLAN entry has been deleted from\n        the dot1qVlanCurrentTable (for any reason).  If an entry\n        is deleted, then inserted, and then deleted, this\n        counter will be incremented by 2.')
dot1qVlanCurrentTable = MibTable((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2))
if mibBuilder.loadTexts:
    dot1qVlanCurrentTable.setDescription('A table containing current configuration information\n        for each VLAN currently configured into the device by\n        (local or network) management, or dynamically created\n        as a result of GVRP requests received.')
dot1qVlanCurrentEntry = MibTableRow((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1)).setIndexNames((0,
                                                                                          'Q-BRIDGE-MIB',
                                                                                          'dot1qVlanTimeMark'), (0,
                                                                                                                 'Q-BRIDGE-MIB',
                                                                                                                 'dot1qVlanIndex'))
if mibBuilder.loadTexts:
    dot1qVlanCurrentEntry.setDescription('Information for a VLAN configured into the device by\n        (local or network) management, or dynamically created\n        as a result of GVRP requests received.')
dot1qVlanTimeMark = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1, 1), TimeFilter())
if mibBuilder.loadTexts:
    dot1qVlanTimeMark.setDescription('A TimeFilter for this entry.  See the TimeFilter\n        textual convention to see how this works.')
dot1qVlanIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1, 2), VlanIndex())
if mibBuilder.loadTexts:
    dot1qVlanIndex.setDescription('The VLAN-ID or other identifier referring to this VLAN.')
dot1qVlanFdbId = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1, 3), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanFdbId.setDescription('The Filtering Database used by this VLAN.  This is one\n        of the dot1qFdbId values in the dot1qFdbTable.  This\n        value is allocated automatically by the device whenever\n        the VLAN is created: either dynamically by GVRP, or by\n        management, in dot1qVlanStaticTable.  Allocation of this\n        value follows the learning constraints defined for this\n        VLAN in dot1qLearningConstraintsTable.')
dot1qVlanCurrentEgressPorts = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1,
                                              4), PortList()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanCurrentEgressPorts.setDescription('The set of ports that are transmitting traffic for\n        this VLAN as either tagged or untagged frames.')
dot1qVlanCurrentUntaggedPorts = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1,
                                                5), PortList()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanCurrentUntaggedPorts.setDescription('The set of ports that are transmitting traffic for\n        this VLAN as untagged frames.')
dot1qVlanStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('other',
                                                                                                                                                                                            1), ('permanent',
                                                                                                                                                                                                 2), ('dynamicGvrp',
                                                                                                                                                                                                      3)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanStatus.setDescription('This object indicates the status of this entry.\n            other(1) - this entry is currently in use, but the\n                conditions under which it will remain so differ\n                from the following values.\n            permanent(2) - this entry, corresponding to an entry\n                in dot1qVlanStaticTable, is currently in use and\n                will remain so after the next reset of the\n                device.  The port lists for this entry include\n                ports from the equivalent dot1qVlanStaticTable\n                entry and ports learned dynamically.\n            dynamicGvrp(3) - this entry is currently in use\n                and will remain so until removed by GVRP.  There\n                is no static entry for this VLAN, and it will be\n                removed when the last port leaves the VLAN.')
dot1qVlanCreationTime = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 2, 1, 7), TimeTicks()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    dot1qVlanCreationTime.setDescription('The value of sysUpTime when this VLAN was created.')
dot1qVlanStaticTable = MibTable((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 3))
if mibBuilder.loadTexts:
    dot1qVlanStaticTable.setDescription('A table containing static configuration information for\n        each VLAN configured into the device by (local or\n        network) management.  All entries are permanent and will\n        be restored after the device is reset.')
dot1qVlanStaticEntry = MibTableRow((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 3, 1)).setIndexNames((0,
                                                                                         'Q-BRIDGE-MIB',
                                                                                         'dot1qVlanIndex'))
if mibBuilder.loadTexts:
    dot1qVlanStaticEntry.setDescription('Static information for a VLAN configured into the\n        device by (local or network) management.')
...
if mibBuilder.loadTexts:
    dot1qConstraintSetDefault.setDescription('The identity of the constraint set to which a VLAN\n        belongs, if there is not an explicit entry for that VLAN\n        in dot1qLearningConstraintsTable.\n\n        The value of this object MUST be retained across\n        reinitializations of the management system.')
dot1qConstraintTypeDefault = MibScalar((1, 3, 6, 1, 2, 1, 17, 7, 1, 4, 10), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('independent',
                                                                                                                                                                                          1), ('shared',
                                                                                                                                                                                               2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    dot1qConstraintTypeDefault.setDescription('The type of constraint set to which a VLAN belongs, if\n        there is not an explicit entry for that VLAN in\n        dot1qLearningConstraintsTable.  The types are as defined\n        for dot1qConstraintType.\n\n        The value of this object MUST be retained across\n        reinitializations of the management system.')
dot1vProtocolGroupTable = MibTable((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 1))
if mibBuilder.loadTexts:
    dot1vProtocolGroupTable.setDescription('A table that contains mappings from Protocol\n         Templates to Protocol Group Identifiers used for\n         Port-and-Protocol-based VLAN Classification.')
dot1vProtocolGroupEntry = MibTableRow((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 1, 1)).setIndexNames((0,
                                                                                            'Q-BRIDGE-MIB',
                                                                                            'dot1vProtocolTemplateFrameType'), (0,
                                                                                                                                'Q-BRIDGE-MIB',
                                                                                                                                'dot1vProtocolTemplateProtocolValue'))
if mibBuilder.loadTexts:
    dot1vProtocolGroupEntry.setDescription('A mapping from a Protocol Template to a Protocol\n         Group Identifier.')
dot1vProtocolTemplateFrameType = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 1,
                                                 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(('ethernet',
                                                                                                                                                                               1), ('rfc1042',
                                                                                                                                                                                    2), ('snap8021H',
                                                                                                                                                                                         3), ('snapOther',
                                                                                                                                                                                              4), ('llcOther',
...
if mibBuilder.loadTexts:
    dot1vProtocolGroupId.setDescription('Represents a group of protocols that are associated\n         together when assigning a VID to a frame.')
dot1vProtocolGroupRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 1, 1,
                                              4), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    dot1vProtocolGroupRowStatus.setDescription('This object indicates the status of this entry.')
dot1vProtocolPortTable = MibTable((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 2))
if mibBuilder.loadTexts:
    dot1vProtocolPortTable.setDescription('A table that contains VID sets used for\n         Port-and-Protocol-based VLAN Classification.')
dot1vProtocolPortEntry = MibTableRow((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 2, 1)).setIndexNames((0,
                                                                                           'BRIDGE-MIB',
                                                                                           'dot1dBasePort'), (0,
                                                                                                              'Q-BRIDGE-MIB',
                                                                                                              'dot1vProtocolPortGroupId'))
if mibBuilder.loadTexts:
    dot1vProtocolPortEntry.setDescription('A VID set for a port.')
...
if mibBuilder.loadTexts:
    dot1vProtocolPortGroupId.setDescription('Designates a group of protocols in the Protocol\n         Group Database.')
...
if mibBuilder.loadTexts:
    dot1vProtocolPortGroupVid.setDescription('The VID associated with a group of protocols for\n         each port.')
dot1vProtocolPortRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 7, 1, 5, 2, 1, 3), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    dot1vProtocolPortRowStatus.setDescription('This object indicates the status of this entry.')
...
if mibBuilder.loadTexts:
    qBridgeBaseGroup.setDescription('A collection of objects providing device-level control\n        and status information for the Virtual LAN bridge\n        services.')
...
if mibBuilder.loadTexts:
    qBridgeFdbMulticastGroup.setDescription('A collection of objects providing information about all\n        multicast addresses, learned dynamically or statically\n        configured by management, in each Filtering Database.')
...
if mibBuilder.loadTexts:
    qBridgeServiceRequirementsGroup.setDescription('A collection of objects providing information about\n        service requirements, learned dynamically or statically\n        configured by management, in each Filtering Database.')
...
if mibBuilder.loadTexts:
    qBridgeVlanGroup.setDescription('A collection of objects providing information about\n        all VLANs currently configured on this device.')
...
if mibBuilder.loadTexts:
    qBridgeVlanStaticGroup.setDescription('A collection of objects providing information about\n        VLANs statically configured by management.')
...
if mibBuilder.loadTexts:
    qBridgePortGroup.setDescription('A collection of objects providing port-level VLAN\n        control and status information for all ports.')
...
if mibBuilder.loadTexts:
    qBridgeVlanStatisticsGroup.setDescription('A collection of objects providing per-port packet\n        statistics for all VLANs currently configured on this\n        device.')
...
if mibBuilder.loadTexts:
    qBridgeVlanHCStatisticsGroup.setDescription('A collection of objects providing per-port packet\n        statistics for all VLANs currently configured on this\n        device for high-capacity interfaces, defined as those\n        that have the value of the corresponding instance of\n        ifSpeed greater than 650,000,000 bits/second.')
...
if mibBuilder.loadTexts:
    qBridgeLearningConstraintsGroup.setDescription('A collection of objects defining the Filtering Database\n        constraints all VLANs have with each other.')
qBridgeLearningConstraintDefaultGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 17, 7, 2, 1,
                                                     13)).setObjects(*(('Q-BRIDGE-MIB', 'dot1qConstraintSetDefault'), ('Q-BRIDGE-MIB', 'dot1qConstraintTypeDefault')))
if mibBuilder.loadTexts:
    qBridgeLearningConstraintDefaultGroup.setDescription('A collection of objects defining the default Filtering\n        Database constraints for VLANs that have no specific\n        constraints defined.')
...
if mibBuilder.loadTexts:
    qBridgeClassificationDeviceGroup.setDescription('VLAN classification information for the bridge.')
...
if mibBuilder.loadTexts:
    qBridgeClassificationPortGroup.setDescription('VLAN classification information for individual ports.')
...
if mibBuilder.loadTexts:
    qBridgePortGroup2.setDescription('A collection of objects providing port-level VLAN\n        control and status information for all ports.')
