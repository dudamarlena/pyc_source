...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/PINT-MIB.py
# Compiled at: 2016-02-13 18:23:46
...
class PintPerfStatPeriod(Integer32, TextualConvention):
    __module__ = __name__
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))
    namedValues = NamedValues(('last30sec', 1), ('last15min', 2), ('last24Hr', 3), ('sinceReboot',
                                                                                    4))
...
if mibBuilder.loadTexts:
    pintReleaseNumber.setDescription('An indication of version of the PINT protocol supported\n     by this agent.')
pintSysContact = MibScalar((1, 3, 6, 1, 2, 1, 93, 1, 2), SnmpAdminString()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    pintSysContact.setDescription('Contact information related to the administration of the PINT\n     services.')
pintApplInstallPkgTable = MibTable((1, 3, 6, 1, 2, 1, 93, 1, 3))
if mibBuilder.loadTexts:
    pintApplInstallPkgTable.setDescription('Table describing the PINT applications that are installed.')
...
if mibBuilder.loadTexts:
    pintApplInstallPkgEntry.setDescription('Entries per PINT Application.')
pintApplInstallPkgDescription = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 1, 3, 1, 1), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintApplInstallPkgDescription.setDescription('Textual description of the installed PINT application.')
pintRegisteredGatewayTable = MibTable((1, 3, 6, 1, 2, 1, 93, 1, 4))
if mibBuilder.loadTexts:
    pintRegisteredGatewayTable.setDescription('Table describing the registered gateway applications.')
...
if mibBuilder.loadTexts:
    pintRegisteredGatewayEntry.setDescription('Entries per Registered Gateway Application.')
pintRegisteredGatewayName = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 1, 4, 1, 1), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintRegisteredGatewayName.setDescription('Name of the registered gateway.')
pintRegisteredGatewayDescription = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 1, 4, 1, 2), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintRegisteredGatewayDescription.setDescription('Textual description of the registered gateway.')
...
if mibBuilder.loadTexts:
    pintServerGlobalStatsTable.setDescription('Table displaying the monitored global server statistics.')
pintServerGlobalStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1)).setIndexNames((0,
                                                                                            'PINT-MIB',
                                                                                            'pintServerServiceTypeIndex'), (0,
                                                                                                                            'PINT-MIB',
                                                                                                                            'pintServerPerfStatPeriodIndex'))
if mibBuilder.loadTexts:
    pintServerGlobalStatsEntry.setDescription('Entries in the global statistics table.\n     One entry is defined for each monitored service type and\n     performance statistics collection period.')
pintServerServiceTypeIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1, 1), PintServiceType())
if mibBuilder.loadTexts:
    pintServerServiceTypeIndex.setDescription('The unique identifier of the monitored service.')
pintServerPerfStatPeriodIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1, 2), PintPerfStatPeriod())
if mibBuilder.loadTexts:
    pintServerPerfStatPeriodIndex.setDescription('Time period for which the performance statistics are requested\n     from the pint server.')
pintServerGlobalCallsReceived = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGlobalCallsReceived.setDescription('Number of received global calls.')
pintServerGlobalSuccessfulCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1,
                                                  4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGlobalSuccessfulCalls.setDescription('Number of global successful calls.')
pintServerGlobalDisconnectedCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1,
                                                    1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGlobalDisconnectedCalls.setDescription('Number of global disconnected (failed) calls.')
pintServerGlobalDisCUAutFCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1,
                                                 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGlobalDisCUAutFCalls.setDescription('Number of global calls that were disconnected because of client\n    or user authorization failure.')
pintServerGlobalDisServProbCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1,
                                                   7), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGlobalDisServProbCalls.setDescription('Number of global calls that were disconnected because of\n     server problems.')
pintServerGlobalDisGatProbCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 1, 1, 1,
                                                  8), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGlobalDisGatProbCalls.setDescription('Number of global calls that were disconnected because of\n     gateway problems.')
pintServerClientStatsTable = MibTable((1, 3, 6, 1, 2, 1, 93, 2, 2, 1))
if mibBuilder.loadTexts:
    pintServerClientStatsTable.setDescription('Table displaying the monitored server client statistics.')
pintServerClientStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 93, 2, 2, 1, 1)).setIndexNames((0,
                                                                                            'PINT-MIB',
                                                                                            'pintServerClientAddress'), (0,
                                                                                                                         'PINT-MIB',
                                                                                                                         'pintServerServiceTypeIndex'), (0,
                                                                                                                                                         'PINT-MIB',
                                                                                                                                                         'pintServerPerfStatPeriodIndex'))
if mibBuilder.loadTexts:
    pintServerClientStatsEntry.setDescription('Entries in the client server statistics table.\n     One entry is defined for each client identified by name,\n     monitored service type and performance statistics collection\n     period.')
pintServerClientAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 2, 1, 1, 1), SnmpAdminString())
if mibBuilder.loadTexts:
    pintServerClientAddress.setDescription('The unique identifier of the monitored client\n     identified by its address represented as as a string.')
pintServerClientCallsReceived = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 2, 1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerClientCallsReceived.setDescription('Number of calls received from the specific client.')
pintServerClientSuccessfulCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 2, 1, 1,
                                                  3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerClientSuccessfulCalls.setDescription('Number of calls from the client successfully completed.')
pintServerClientDisconnectedCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 2, 1,
                                                    1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerClientDisconnectedCalls.setDescription('Number of calls received from the client, and that were\n     disconnected (failed).')
pintServerClientDisCAutFCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 2, 1, 1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerClientDisCAutFCalls.setDescription('Number of calls from the client that were disconnected because of\n    client authorization failure.')
pintServerClientDisEFProbCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 2, 1, 1,
                                                 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerClientDisEFProbCalls.setDescription('Number of calls from the client that were disconnected because\n     of egress facility problems.')
pintServerUserIdStatsTable = MibTable((1, 3, 6, 1, 2, 1, 93, 2, 3, 1))
if mibBuilder.loadTexts:
    pintServerUserIdStatsTable.setDescription('Table displaying the monitored Pint service user statistics.')
pintServerUserIdStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 93, 2, 3, 1, 1)).setIndexNames((0,
                                                                                            'PINT-MIB',
                                                                                            'pintServerUserIdName'), (0,
                                                                                                                      'PINT-MIB',
                                                                                                                      'pintServerServiceTypeIndex'), (0,
                                                                                                                                                      'PINT-MIB',
                                                                                                                                                      'pintServerPerfStatPeriodIndex'))
if mibBuilder.loadTexts:
    pintServerUserIdStatsEntry.setDescription('Entries in the user statistics table.\n     One entry is defined for each user identified by name,\n     each monitored service type and performance statistics collection\n     period.\n\n      It is assumed that the capabilities of the pint server\n      are enough to accommodate the number of entries in this table.\n      It is a local server implementation issue if an aging mechanism\n      Is implemented in order to avoid scalability problems.')
...
if mibBuilder.loadTexts:
    pintServerUserIdName.setDescription('The unique identifier of the monitored user\n     identified by its name.')
pintServerUserIdCallsReceived = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 3, 1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerUserIdCallsReceived.setDescription('Number of calls received from the specific user.')
pintServerUserIdSuccessfulCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 3, 1, 1,
                                                  3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerUserIdSuccessfulCalls.setDescription('Number of calls from the user successfully completed.')
pintServerUserIdDisconnectedCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 3, 1,
                                                    1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerUserIdDisconnectedCalls.setDescription('Number of calls received from the user that were\n     disconnected (failed).')
pintServerUserIdDiscUIdAFailCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 3, 1,
                                                    1, 5), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerUserIdDiscUIdAFailCalls.setDescription('Number of calls from the user that were disconnected because of\n    user authorization failure.')
pintServerUserIdEFProbCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 3, 1, 1, 6), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerUserIdEFProbCalls.setDescription('Number of calls from the user that were disconnected because of\n     egress facility problems.')
pintServerGatewayStatsTable = MibTable((1, 3, 6, 1, 2, 1, 93, 2, 4, 1))
if mibBuilder.loadTexts:
    pintServerGatewayStatsTable.setDescription('Table displaying the monitored gateway statistics.')
pintServerGatewayStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 93, 2, 4, 1, 1)).setIndexNames((0,
                                                                                             'PINT-MIB',
                                                                                             'pintRegisteredGatewayName'), (0,
                                                                                                                            'PINT-MIB',
                                                                                                                            'pintServerServiceTypeIndex'), (0,
                                                                                                                                                            'PINT-MIB',
                                                                                                                                                            'pintServerPerfStatPeriodIndex'))
if mibBuilder.loadTexts:
    pintServerGatewayStatsEntry.setDescription('Entries in the gateway table.\n     One entry is defined for each gateway identified by name,\n     each monitored service type and performance statistics collection\n     period.')
pintServerGatewayCallsReceived = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 4, 1, 1,
                                                 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGatewayCallsReceived.setDescription('Number of calls received at the specified gateway.')
pintServerGatewaySuccessfulCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 4, 1, 1,
                                                   2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGatewaySuccessfulCalls.setDescription('Number of calls successfully completed at the specified gateway.')
pintServerGatewayDisconnectedCalls = MibTableColumn((1, 3, 6, 1, 2, 1, 93, 2, 4, 1,
                                                     1, 3), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pintServerGatewayDisconnectedCalls.setDescription('Number of calls that were disconnected (failed) at the specified\n     gateway.')
...
if mibBuilder.loadTexts:
    pintMibCompliance.setDescription('Describes the requirements for conformance to the\n    PINT MIB.')
...
if mibBuilder.loadTexts:
    pintMibConfigGroup.setDescription('A collection of objects providing configuration\n    information\n    for a PINT Server.')
...
if mibBuilder.loadTexts:
    pintMibMonitorGroup.setDescription('A collection of objects providing monitoring\n    information\n    for a PINT Server.')
