...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SIP-MIB.py
# Compiled at: 2016-02-13 18:28:05
...
if mibBuilder.loadTexts:
    sipMaxTransactions.setDescription('This object indicates the maximum number of simultaneous\n             transactions that the SIP entity can manage.')
...
if mibBuilder.loadTexts:
    sipTransIndex.setDescription('This object uniquely identifies a conceptual row in the\n             table.')
sipTransTo = MibTableColumn((1, 3, 6, 1, 2, 1, 9998, 1, 1, 2, 9, 2, 1, 2), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipTransTo.setDescription('This object contains the value of the To header in request\n             message.')
sipTransFrom = MibTableColumn((1, 3, 6, 1, 2, 1, 9998, 1, 1, 2, 9, 2, 1, 3), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipTransFrom.setDescription('This object contains the value of the From header in the\n             request message.')
sipTransCallId = MibTableColumn((1, 3, 6, 1, 2, 1, 9998, 1, 1, 2, 9, 2, 1, 4), SnmpAdminString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipTransCallId.setDescription('This object contains the value of the CallId value in the\n             request message.')
sipTransCSeq = MibTableColumn((1, 3, 6, 1, 2, 1, 9998, 1, 1, 2, 9, 2, 1, 5), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    sipTransCSeq.setDescription('This object contains the CSeq value for the current\n             transaction.')
...
if mibBuilder.loadTexts:
    sipUACfgTimerExpires.setDescription('This object specifies the time a user agent will wait to\n             receive a final response to an INVITE before canceling the\n             transaction.')
...
if mibBuilder.loadTexts:
    sipUACfgTimerConnect.setDescription('This object specifies the time a user agent will wait to\n             receive an ACK confirmation indicating that a session is\n             established.')
...
if mibBuilder.loadTexts:
    sipProxyAuthPgpAlgorithm.setDescription('This object specifies the PGP algorithm the proxy uses.')
sipProxyAuthRealm = MibScalar((1, 3, 6, 1, 2, 1, 9998, 1, 4, 1, 12), SnmpAdminString()).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    sipProxyAuthRealm.setDescription('This object specifies the realm used in Proxy-Authenticate\n             headers.  Note that this may need to be stored per user.')
...
if mibBuilder.loadTexts:
    sipPgpPrivateKey.setDescription("The value of this object is the server's private PGP key,\n             used for both PGP authentication of this server and for\n             PGP-based\n             encryption.")
sipRxProxyAuthTable = MibTable((1, 3, 6, 1, 2, 1, 9998, 1, 4, 1, 15))
if mibBuilder.loadTexts:
    sipRxProxyAuthTable.setDescription('This table contains authentication data for peers of the\n             server.')
sipRxProxyAuthEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 1, 4, 1, 15, 1)).setIndexNames((0, 'SIP-MIB', 'sipRxProxyAuthIndex'))
if mibBuilder.loadTexts:
    sipRxProxyAuthEntry.setDescription('This object contains authentication data for a single\n             peer.')
...
if mibBuilder.loadTexts:
    sipRxProxyAuthIndex.setDescription('This object uniquely identifies a conceptual row in the\n             table.')
sipRxProxyAuthRealm = MibTableColumn((1, 3, 6, 1, 2, 1, 9998, 1, 4, 1, 15, 1, 2), SnmpAdminString()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    sipRxProxyAuthRealm.setDescription('This object contains the realm that is specified by\n             another server when it is authenticating this server.')
...
if mibBuilder.loadTexts:
    sipRegMaxUsers.setDescription('This object specifies the maximum number of users that the\n             registrar supports.  The current number of users is\n             reflected by sipRegCurrentUsers.')
...
if mibBuilder.loadTexts:
    sipRegCurrentUsers.setDescription('This object specifies the number of users currently\n             configured on the registrar.')
sipRegUserTable = MibTable((1, 3, 6, 1, 2, 1, 9998, 1, 6, 1, 8))
if mibBuilder.loadTexts:
    sipRegUserTable.setDescription('This table contains information on all users registered to\n             this Registrar.')
sipRegUserEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 1, 6, 1, 8, 1)).setIndexNames((0, 'SIP-MIB', 'sipUserIndex'))
if mibBuilder.loadTexts:
    sipRegUserEntry.setDescription('This entry contains information for a single user\n             registered to this Registrar.')
...
if mibBuilder.loadTexts:
    sipCompliance.setDescription('The compliance statement for SIP entities.')
...
if mibBuilder.loadTexts:
    sipCommonConfigGroup.setDescription('A collection of objects providing configuration common\n             to all SIP enities.')
...
if mibBuilder.loadTexts:
    sipCommonStatsGroup.setDescription('A collection of objects providing statistics common\n             toall SIP entities.')
...
if mibBuilder.loadTexts:
    sipServerConfigGroup.setDescription('A collection of objects providing configuration common\n             to SIP Proxy and Redirect servers.')
...
if mibBuilder.loadTexts:
    sipProxyConfigGroup.setDescription('A collection of objects providing configuration for\n             SIP Proxy servers.')
sipProxyStatsGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 9998, 3, 2, 10)).setObjects(*(('SIP-MIB', 'sipNumProxyRequireFailures'),))
if mibBuilder.loadTexts:
    sipProxyStatsGroup.setDescription('A collection of objects providing statistics for\n             SIP Proxy servers.')
...
if mibBuilder.loadTexts:
    sipRegistrarConfigGroup.setDescription('A collection of objects providing configuration for\n             SIP Registrars.')
...
if mibBuilder.loadTexts:
    sipRegistrarStatsGroup.setDescription('A collection of objects providing statistics for\n             SIP Registrars.')
