...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ENTITY-SENSOR-MIB.py
# Compiled at: 2016-02-13 18:11:46
...
if mibBuilder.loadTexts:
    entitySensorMIB.setLastUpdated('200212160000Z')
if mibBuilder.loadTexts:
    entitySensorMIB.setOrganization('IETF Entity MIB Working Group')
if mibBuilder.loadTexts:
    entitySensorMIB.setContactInfo('        Andy Bierman\n                     Cisco Systems, Inc.\n                Tel: +1 408-527-3711\n             E-mail: abierman@cisco.com\n             Postal: 170 West Tasman Drive\n                     San Jose, CA USA 95134\n\n                     Dan Romascanu\n                     Avaya Inc.\n                Tel: +972-3-645-8414\n              Email: dromasca@avaya.com\n             Postal: Atidim technology Park, Bldg. #3\n                     Tel Aviv, Israel, 61131\n\n                     K.C. Norseth\n                     L-3 Communications\n                Tel: +1 801-594-2809\n              Email: kenyon.c.norseth@L-3com.com\n             Postal: 640 N. 2200 West.\n\n                     Salt Lake City, Utah 84116-0850\n\n             Send comments to <entmib@ietf.org>\n             Mailing list subscription info:\n               http://www.ietf.org/mailman/listinfo/entmib ')
if mibBuilder.loadTexts:
    entitySensorMIB.setDescription('This module defines Entity MIB extensions for physical\n             sensors.\n\n             Copyright (C) The Internet Society (2002). This version\n             of this MIB module is part of RFC 3433; see the RFC\n             itself for full legal notices.')
...
class EntitySensorDataType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('unknown', 2), ('voltsAC', 3), ('voltsDC',
                                                                             4), ('amperes',
                                                                                  5), ('watts',
                                                                                       6), ('hertz',
                                                                                            7), ('celsius',
...
class EntitySensorDataScale(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('yocto', 1), ('zepto', 2), ('atto', 3), ('femto', 4), ('pico',
                                                                                      5), ('nano',
                                                                                           6), ('micro',
                                                                                                7), ('milli',
                                                                                                     8), ('units',
...
if mibBuilder.loadTexts:
    entitySensorCompliance.setDescription('Describes the requirements for conformance to the Entity\n            Sensor MIB module.')
...
if mibBuilder.loadTexts:
    entitySensorValueGroup.setDescription('A collection of objects representing physical entity sensor\n            information.')
