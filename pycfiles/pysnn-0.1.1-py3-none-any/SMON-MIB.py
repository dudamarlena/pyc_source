...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SMON-MIB.py
# Compiled at: 2016-02-13 18:28:37
...
if mibBuilder.loadTexts:
    switchRMON.setLastUpdated('9812160000Z')
if mibBuilder.loadTexts:
    switchRMON.setOrganization('IETF RMON MIB Working Group')
if mibBuilder.loadTexts:
    switchRMON.setContactInfo('IETF RMONMIB WG Mailing list: rmonmib@cisco.com\n\n                Rich Waterman\n                Allot Networks Inc.\n                Tel:  +1-408-559-0253\n                Email: rich@allot.com\n\n                Bill Lahaye\n                Xylan Corp.\n                Tel: +1-800-995-2612\n                Email:  lahaye@ctron.com\n\n                Dan Romascanu\n                Lucent Technologies\n                Tel:  +972-3-645-8414\n                Email: dromasca@lucent.com\n\n                Steven Waldbusser\n                International Network Services\n                Tel: +1-415-254-4251\n                Email: waldbusser@ins.com')
if mibBuilder.loadTexts:
    switchRMON.setDescription('The MIB module for managing remote monitoring device\n                 implementations for Switched Networks')
...
smonCapabilities = MibScalar((1, 3, 6, 1, 2, 1, 16, 19, 15), Bits().clone(namedValues=NamedValues(('smonVlanStats',
                                                                                                   0), ('smonPrioStats',
                                                                                                        1), ('dataSource',
                                                                                                             2), ('smonUnusedBit',
                                                                                                                  3), ('portCopy',
...
if mibBuilder.loadTexts:
    smonVlanStatsControlIndex.setDescription('A unique arbitrary index for this smonVlanStatsControlEntry.')
smonVlanStatsControlDataSource = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 1,
                                                 1, 2), DataSource()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    smonVlanStatsControlDataSource.setDescription('The source of data for this set of VLAN statistics.\n\n        This object MAY NOT be modified if the associated\n        smonVlanStatsControlStatus object is equal to active(1).')
smonVlanStatsControlCreateTime = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 1,
                                                 1, 3), LastCreateTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanStatsControlCreateTime.setDescription('The value of sysUpTime when this control entry was last\n        activated. This object allows to a management station to\n        detect deletion and recreation cycles between polls.')
smonVlanStatsControlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 1, 1, 4), OwnerString()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    smonVlanStatsControlOwner.setDescription('Administratively assigned named of the owner of this entry.\n        It usually defines the entity that created this entry and is\n        therefore using the resources assigned to it, though there is\n        no enforcement mechanism, nor assurance that rows created are\n        ever used.')
smonVlanStatsControlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 1, 1,
                                             5), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    smonVlanStatsControlStatus.setDescription('The status of this row.\n\n        An entry MAY NOT exist in the active state unless all\n        objects in the entry have an appropriate value.\n\n        If this object is not equal to active(1), all associated\n        entries in the smonVlanIdStatsTable SHALL be deleted.')
smonVlanIdStatsTable = MibTable((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2))
if mibBuilder.loadTexts:
    smonVlanIdStatsTable.setDescription('Contains the VLAN statistics data.\n         The statistics collected represent a distribution based\n         on the IEEE 802.1Q VLAN-ID (VID), for each good frame\n         attributed to the data source for the collection.\n\n         This function applies the same rules for attributing frames\n         to VLAN-based collections. RMON VLAN statistics are collected\n         after the Ingress Rules defined in section 3.13 of the VLAN\n         Specification [20] are applied.\n\n         It is possible that entries in this table will be\n         garbage-collected, based on agent resources, and VLAN\n         configuration. Agents are encouraged to support all 4094\n         index values and not garbage collect this table.')
smonVlanIdStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1)).setIndexNames((0,
                                                                                          'SMON-MIB',
                                                                                          'smonVlanStatsControlIndex'), (0,
                                                                                                                         'SMON-MIB',
                                                                                                                         'smonVlanIdStatsId'))
if mibBuilder.loadTexts:
    smonVlanIdStatsEntry.setDescription('A conceptual row in smonVlanIdStatsTable.')
smonVlanIdStatsId = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 4094)))
if mibBuilder.loadTexts:
    smonVlanIdStatsId.setDescription('The unique identifier of the VLAN monitored for\n         this specific statistics collection.\n\n        Tagged packets match the VID for the range between 1 and 4094.\n        An external RMON probe MAY detect VID=0 on an Inter Switch\n        Link, in which case the packet belongs to a VLAN determined by\n        the PVID of the ingress port. The VLAN to which such a packet\n        belongs can be determined only by a RMON probe internal to the\n        switch.')
smonVlanIdStatsTotalPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1, 2), Counter32()).setUnits('packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsTotalPkts.setDescription('The total number of packets counted on this VLAN.')
smonVlanIdStatsTotalOverflowPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2,
                                                   2, 1, 3), Counter32()).setUnits('packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsTotalOverflowPkts.setDescription('The number of times the associated smonVlanIdStatsTotalPkts\n         counter has overflowed.')
smonVlanIdStatsTotalHCPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1,
                                             4), Counter64()).setUnits('packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsTotalHCPkts.setDescription('The total number of packets counted on this VLAN.')
smonVlanIdStatsTotalOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1,
                                             5), Counter32()).setUnits('octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsTotalOctets.setDescription('The total number of octets counted on this VLAN.')
smonVlanIdStatsTotalOverflowOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2,
                                                     2, 1, 6), Counter32()).setUnits('octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsTotalOverflowOctets.setDescription('The number of times the associated smonVlanIdStatsTotalOctets\n         counter has overflowed.')
smonVlanIdStatsTotalHCOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1,
                                               7), Counter64()).setUnits('octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsTotalHCOctets.setDescription('The total number of octets counted on this VLAN.')
smonVlanIdStatsNUcastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1, 8), Counter32()).setUnits('packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsNUcastPkts.setDescription('The total number of non-unicast packets counted on this\n         VLAN.')
smonVlanIdStatsNUcastOverflowPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2,
                                                    2, 1, 9), Counter32()).setUnits('packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsNUcastOverflowPkts.setDescription('The number of times the associated smonVlanIdStatsNUcastPkts\n         counter has overflowed.')
smonVlanIdStatsNUcastHCPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1,
                                              10), Counter64()).setUnits('packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsNUcastHCPkts.setDescription('The total number of non-unicast packets counted on\n         this VLAN.')
smonVlanIdStatsNUcastOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1,
                                              11), Counter32()).setUnits('octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsNUcastOctets.setDescription('The total number of non-unicast octets counted on\n         this VLAN.')
smonVlanIdStatsNUcastOverflowOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1,
                                                      2, 2, 1, 12), Counter32()).setUnits('octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsNUcastOverflowOctets.setDescription('The number of times the associated\n         smonVlanIdStatsNUcastOctets counter has overflowed.')
smonVlanIdStatsNUcastHCOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2,
                                                1, 13), Counter64()).setUnits('octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsNUcastHCOctets.setDescription('The total number of Non-unicast octets counted on\n         this VLAN.')
smonVlanIdStatsCreateTime = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 2, 1, 14), LastCreateTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    smonVlanIdStatsCreateTime.setDescription('The value of sysUpTime when this entry was last\n        activated. This object allows to a management station to\n        detect deletion and recreation cycles between polls.')
smonPrioStatsControlTable = MibTable((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 3))
if mibBuilder.loadTexts:
    smonPrioStatsControlTable.setDescription('Controls the setup of priority statistics tables.\n\n         The smonPrioStatsControlTable allows configuration of\n         collections based on the value of the 3-bit user priority\n         field encoded in the Tag Control Information (TCI) field\n         according to [19],[20].\n\n         Note that this table merely reports priority as encoded in\n         the VLAN headers, not the priority (if any) given to the\n         frame for the actual switching purposes.')
smonPrioStatsControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 16, 22, 1, 2, 3, 1)).setIndexNames((0,
                                                                                               'SMON-MIB',
                                                                                               'smonPrioStatsControlIndex'))
if mibBuilder.loadTexts:
    smonPrioStatsControlEntry.setDescription('A conceptual row in the smonPrioStatsControlTable.')
...
if mibBuilder.loadTexts:
    smonMIBCompliance.setDescription('Describes the requirements for full conformance with the SMON\n        MIB')
...
if mibBuilder.loadTexts:
    portCopyCompliance.setDescription('Describes the requirements for conformance with the port copy\n         functionality defined by the SMON MIB')
...
if mibBuilder.loadTexts:
    dataSourceCapsGroup.setDescription('Defines the objects that describe the capabilities of RMON\n         data sources.')
...
if mibBuilder.loadTexts:
    smonVlanStatsGroup.setDescription('Defines the switch monitoring specific statistics - per VLAN\n         Id on interfaces of 10MB or less.')
...
if mibBuilder.loadTexts:
    smonPrioStatsGroup.setDescription('Defines the switch monitoring specific statistics - per VLAN\n         Id on interface.')
...
if mibBuilder.loadTexts:
    smonHcTo100mbGroup.setDescription('Defines the additional high capacity statistics needed to be\n         kept on interfaces with ifSpeed greater than 10MB/sec and\n         less than or equal to 100MB/sec.')
...
if mibBuilder.loadTexts:
    portCopyConfigGroup.setDescription('Defines the control objects for copy port operations.')
