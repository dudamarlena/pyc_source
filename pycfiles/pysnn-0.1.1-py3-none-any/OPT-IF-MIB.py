...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/OPT-IF-MIB.py
# Compiled at: 2016-02-13 18:22:58
...
if mibBuilder.loadTexts:
    optIfOTMnTable.setDescription('A table of OTMn structure information.')
optIfOTMnEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 1, 1, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOTMnEntry.setDescription('A conceptual row that contains the OTMn structure\n     information of an optical interface.')
...
if mibBuilder.loadTexts:
    optIfPerfMonCurDayTimeElapsed.setDescription("Number of seconds elapsed in the current 24-hour interval\n     performance monitoring period.\n     If, for some reason, such as an adjustment in the NE's\n     time-of-day clock, the number of seconds elapsed exceeds\n     the maximum value, then the maximum value will be returned.")
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentInputPower.setDescription('The optical power monitored at the input.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentHighInputPower.setDescription('The highest optical power monitored at the input during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentUpperInputPowerThreshold.setDescription('The upper limit threshold on input power.  If\n     optIfOTSnSinkCurrentInputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentOutputPower.setDescription('The optical power monitored at the output.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on output power.  If\n     optIfOTSnSinkCurrentOutputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on output power.  If\n     optIfOTSnSinkCurrentOutputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
optIfOTSnSinkIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 3))
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalTable.setDescription('A table of historical OTSn sink performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalEntry.setDescription('A conceptual row that contains OTSn sink performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOTSnSinkIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 3, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOTSnSinkIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 3, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalLastInputPower.setDescription('The last optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalHighInputPower.setDescription('The highest optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalLastOutputPower.setDescription('The last optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkIntervalHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     interval.')
optIfOTSnSinkCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 4))
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDayTable.setDescription('A table of OTSn sink performance monitoring information for\n     the current 24-hour interval.')
optIfOTSnSinkCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 4, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDayEntry.setDescription('A conceptual row that contains OTSn sink performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOTSnSinkCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 4, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDayLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDayHighInputPower.setDescription('The highest optical power monitored at the input during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkCurDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 24-hour interval.')
optIfOTSnSinkPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 5))
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayTable.setDescription('A table of OTSn sink performance monitoring information for\n     the previous 24-hour interval.')
optIfOTSnSinkPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 5, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayEntry.setDescription('A conceptual row that contains OTSn sink performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOTSnSinkPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 5, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayLastInputPower.setDescription('The last optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayHighInputPower.setDescription('The highest optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayLastOutputPower.setDescription('The last optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPrevDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     previous 24-hour interval.')
optIfOTSnSrcCurrentTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 6))
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentTable.setDescription('A table of OTSn source performance monitoring information for\n     the current 15-minute interval.')
optIfOTSnSrcCurrentEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 6, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentEntry.setDescription('A conceptual row that contains OTSn source performance\n     monitoring information of an interface for the current\n     15-minute interval.')
optIfOTSnSrcCurrentSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 6, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentOutputPower.setDescription('The optical power monitored at the output.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on output power.  If\n     optIfOTSnSrcCurrentOutputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on output power.  If\n     optIfOTSnSrcCurrentOutputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentInputPower.setDescription('The optical power monitored at the input.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentHighInputPower.setDescription('The highest optical power monitored at the input during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentLowerInputPowerThreshold.setDescription('The lower limit threshold on input power.  If\n     optIfOTSnSrcCurrentInputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurrentUpperInputPowerThreshold.setDescription('The upper limit threshold on input power.  If\n     optIfOTSnSrcCurrentInputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
optIfOTSnSrcIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 7))
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalTable.setDescription('A table of historical OTSn source performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalEntry.setDescription('A conceptual row that contains OTSn source performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOTSnSrcIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 7, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOTSnSrcIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 7, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalLastOutputPower.setDescription('The last optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalLastInputPower.setDescription('The last optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcIntervalHighInputPower.setDescription('The highest optical power monitored at the input during the\n     interval.')
optIfOTSnSrcCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 8))
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDayTable.setDescription('A table of OTSn source performance monitoring information for\n     the current 24-hour interval.')
optIfOTSnSrcCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 8, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDayEntry.setDescription('A conceptual row that contains OTSn source performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOTSnSrcCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 8, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDayLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcCurDayHighInputPower.setDescription('The highest optical power monitored at the input during the\n     current 24-hour interval.')
optIfOTSnSrcPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 9))
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayTable.setDescription('A table of OTSn source performance monitoring information for\n     the previous 24-hour interval.')
optIfOTSnSrcPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 9, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayEntry.setDescription('A conceptual row that contains OTSn source performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOTSnSrcPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 3, 9, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayLastOutputPower.setDescription('The last optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayLastInputPower.setDescription('The last optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTSnSrcPrevDayHighInputPower.setDescription('The highest optical power monitored at the input during the\n     previous 24-hour interval.')
optIfOMSnConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 1))
if mibBuilder.loadTexts:
    optIfOMSnConfigTable.setDescription('A table of OMSn configuration information.')
optIfOMSnConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 1, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOMSnConfigEntry.setDescription('A conceptual row that contains OMSn configuration\n     information of an interface.')
optIfOMSnDirectionality = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 1, 1, 1), OptIfDirectionality()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnDirectionality.setDescription('Indicates the directionality of the entity.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentAggregatedInputPower.setDescription('The aggregated optical power of all the DWDM input\n     channels.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentLowerInputPowerThreshold.setDescription('The lower limit threshold on aggregated input power.  If\n     optIfOMSnSinkCurrentAggregatedInputPower drops to this value\n     or below, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentOutputPower.setDescription('The optical power monitored at the output.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output\n     during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentHighOutputPower.setDescription('The highest optical power monitored at the output\n     during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on output power.  If\n     optIfOMSnSinkCurrentOutputPower drops to this value\n     or below, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on output power.  If\n     optIfOMSnSinkCurrentOutputPower reaches or exceeds\n     this value, a Threshold Crossing Alert (TCA) should be sent.')
optIfOMSnSinkIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 3))
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalTable.setDescription('A table of historical OMSn sink performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalEntry.setDescription('A conceptual row that contains OMSn sink performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOMSnSinkIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 3, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOMSnSinkIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 3, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalLastAggregatedInputPower.setDescription('The last aggregated optical power of all the DWDM input\n     channels during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalLastOutputPower.setDescription('The last optical power at the output\n     during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalLowOutputPower.setDescription('The lowest optical power at the output\n     during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkIntervalHighOutputPower.setDescription('The highest optical power at the output\n     during the interval.')
optIfOMSnSinkCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 4))
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDayTable.setDescription('A table of OMSn sink performance monitoring information for\n     the current 24-hour interval.')
optIfOMSnSinkCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 4, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDayEntry.setDescription('A conceptual row that contains OMSn sink performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOMSnSinkCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 4, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDayHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDayLowOutputPower.setDescription('The lowest optical power at the output\n     during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkCurDayHighOutputPower.setDescription('The highest  optical power at the output\n     during the current 24-hour interval.')
optIfOMSnSinkPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 5))
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayTable.setDescription('A table of OMSn sink performance monitoring information for\n     the previous 24-hour interval.')
optIfOMSnSinkPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 5, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayEntry.setDescription('A conceptual row that contains OMSn sink performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOMSnSinkPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 5, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayLastAggregatedInputPower.setDescription('The last aggregated optical power of all the DWDM input\n     channels during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayLastOutputPower.setDescription('The last  optical power at the output\n     during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayLowOutputPower.setDescription('The lowest optical power at the output\n     during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPrevDayHighOutputPower.setDescription('The highest optical power at the output\n     during the previous 24-hour interval.')
optIfOMSnSrcCurrentTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 6))
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentTable.setDescription('A table of OMSn source performance monitoring information for\n     the current 15-minute interval.')
optIfOMSnSrcCurrentEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 6, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentEntry.setDescription('A conceptual row that contains OMSn source performance\n     monitoring information of an interface for the current\n     15-minute interval.')
optIfOMSnSrcCurrentSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 6, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentOutputPower.setDescription('The optical power monitored at the output.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on output power.  If\n     optIfOMSnSrcCurrentOutputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on output power.  If\n     optIfOMSnSrcCurrentOutputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentAggregatedInputPower.setDescription('The aggregated optical power at the input.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentLowAggregatedInputPower.setDescription('The lowest aggregated optical power at the input\n     during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentHighAggregatedInputPower.setDescription('The highest aggregated optical power at the input\n     during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentLowerInputPowerThreshold.setDescription('The lower limit threshold on aggregated input power.  If\n     optIfOMSnSrcCurrentAggregatedInputPower drops to this value\n     or below, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurrentUpperInputPowerThreshold.setDescription('The upper limit threshold on aggregated input power.  If\n     optIfOMSnSrcCurrentAggregatedInputPower reaches or exceeds\n     this value, a Threshold Crossing Alert (TCA) should be sent.')
optIfOMSnSrcIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 7))
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalTable.setDescription('A table of historical OMSn source performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalEntry.setDescription('A conceptual row that contains OMSn source performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOMSnSrcIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 7, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOMSnSrcIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 7, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalLastOutputPower.setDescription('The last optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalLastAggregatedInputPower.setDescription('The last aggregated optical power at the input\n     during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalLowAggregatedInputPower.setDescription('The lowest aggregated optical power at the input\n     during the interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcIntervalHighAggregatedInputPower.setDescription('The highest aggregated optical power at the input\n     during the interval.')
optIfOMSnSrcCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 8))
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDayTable.setDescription('A table of OMSn source performance monitoring information for\n     the current 24-hour interval.')
optIfOMSnSrcCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 8, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDayEntry.setDescription('A conceptual row that contains OMSn source performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOMSnSrcCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 8, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power at the input\n     during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcCurDayHighAggregatedInputPower.setDescription('The highest aggregated optical power at the input\n     during the current 24-hour interval.')
optIfOMSnSrcPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 9))
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayTable.setDescription('A table of OMSn source performance monitoring information for\n     the previous 24-hour interval.')
optIfOMSnSrcPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 9, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayEntry.setDescription('A conceptual row that contains OMSn source performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOMSnSrcPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 4, 9, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayLastOutputPower.setDescription('The last optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayLastAggregatedInputPower.setDescription('The last aggregated optical power at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOMSnSrcPrevDayHighAggregatedInputPower.setDescription('The highest aggregated optical power at the input during the\n     previous 24-hour interval.')
optIfOChGroupConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 1))
if mibBuilder.loadTexts:
    optIfOChGroupConfigTable.setDescription('A table of OChGroup configuration information.')
optIfOChGroupConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 1, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupConfigEntry.setDescription('A conceptual row that contains OChGroup configuration\n     information of an interface.')
optIfOChGroupDirectionality = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 1, 1, 1), OptIfDirectionality()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupDirectionality.setDescription('Indicates the directionality of the entity.')
optIfOChGroupSinkCurrentTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 2))
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentTable.setDescription('A table of OChGroup sink performance monitoring information for\n     the current 15-minute interval.')
optIfOChGroupSinkCurrentEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 2, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentEntry.setDescription('A conceptual row that contains OChGroup sink performance\n     monitoring information of an interface for the current\n     15-minute interval.')
optIfOChGroupSinkCurrentSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 2, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentAggregatedInputPower.setDescription('The aggregated optical power of all the DWDM input\n     channels in the OChGroup.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentLowerInputPowerThreshold.setDescription('The lower limit threshold on aggregated input power.  If\n     optIfOChGroupSinkCurrentAggregatedInputPower drops to this value\n     or below, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentUpperInputPowerThreshold.setDescription('The upper limit threshold on aggregated input power.  If\n     optIfOChGroupSinkCurrentAggregatedInputPower reaches or exceeds\n     this value, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentOutputPower.setDescription('The optical power monitored at the output\n     in the OChGroup.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output\n     in the OChGroup during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentHighOutputPower.setDescription('The highest optical power monitored at the output\n     in the OChGroup during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on the output power.  If\n     optIfOChGroupSinkCurrentOutputPower drops to this value\n     or below, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on the output power.  If\n     optIfOChGroupSinkCurrentOutputPower reaches or exceeds\n     this value, a Threshold Crossing Alert (TCA) should be sent.')
optIfOChGroupSinkIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 3))
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalTable.setDescription('A table of historical OChGroup sink performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalEntry.setDescription('A conceptual row that contains OChGroup sink performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOChGroupSinkIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 3, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOChGroupSinkIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 3, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalLastAggregatedInputPower.setDescription('The last aggregated optical power of all the DWDM input\n     channels in the OChGroup during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalLastOutputPower.setDescription('The last optical power monitored at the output\n     in the OChGroup during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalLowOutputPower.setDescription('The lowest optical power monitored at the output\n     in the OChGroup during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkIntervalHighOutputPower.setDescription('The highest optical power monitored at the output\n     in the OChGroup during the interval.')
optIfOChGroupSinkCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 4))
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDayTable.setDescription('A table of OChGroup sink performance monitoring information for\n     the current 24-hour interval.')
optIfOChGroupSinkCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 4, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDayEntry.setDescription('A conceptual row that contains OChGroup sink performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOChGroupSinkCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 4, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDayHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDayLowOutputPower.setDescription('The lowest optical power monitored at the output\n     in the OChGroup during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkCurDayHighOutputPower.setDescription('The highest optical power monitored at the output\n     in the OChGroup during the current 24-hour interval.')
optIfOChGroupSinkPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 5))
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayTable.setDescription('A table of OChGroup sink performance monitoring information for\n     the previous 24-hour interval.')
optIfOChGroupSinkPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 5, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayEntry.setDescription('A conceptual row that contains OChGroup sink performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOChGroupSinkPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 5, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayLastAggregatedInputPower.setDescription('The last aggregated optical power of all the DWDM input\n     channels in the OChGroup during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayHighAggregatedInputPower.setDescription('The highest aggregated optical power of all the DWDM input\n     channels in the OChGroup during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayLastOutputPower.setDescription('The last optical power monitored at the output\n     in the OChGroup during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayLowOutputPower.setDescription('The lowest optical power monitored at the output\n     in the OChGroup during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPrevDayHighOutputPower.setDescription('The highest optical power monitored at the output\n     in the OChGroup during the previous 24-hour interval.')
optIfOChGroupSrcCurrentTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 6))
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentTable.setDescription('A table of OChGroup source performance monitoring information for\n     the current 15-minute interval.')
optIfOChGroupSrcCurrentEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 6, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentEntry.setDescription('A conceptual row that contains OChGroup source performance\n     monitoring information of an interface for the current\n     15-minute interval.')
optIfOChGroupSrcCurrentSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 6, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentOutputPower.setDescription('The optical power monitored at the output.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on output power.  If\n     optIfOChGroupSrcCurrentOutputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on output power.  If\n     optIfOChGroupSrcCurrentOutputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentAggregatedInputPower.setDescription('The aggregated optical power monitored at the input.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentLowAggregatedInputPower.setDescription('The lowest aggregated optical power monitored at the input\n     during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentHighAggregatedInputPower.setDescription('The highest aggregated optical power monitored at the input\n     during the current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentLowerInputPowerThreshold.setDescription('The lower limit threshold on input power.  If\n     optIfOChGroupSrcCurrentAggregatedInputPower drops to this value\n     or below, a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurrentUpperInputPowerThreshold.setDescription('The upper limit threshold on input power.  If\n     optIfOChGroupSrcCurrentAggregatedInputPower reaches or exceeds\n     this value, a Threshold Crossing Alert (TCA) should be sent.')
optIfOChGroupSrcIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 7))
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalTable.setDescription('A table of historical OChGroup source performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalEntry.setDescription('A conceptual row that contains OChGroup source performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOChGroupSrcIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 7, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOChGroupSrcIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 7, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalLastOutputPower.setDescription('The last optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalLastAggregatedInputPower.setDescription('The last aggregated optical power monitored at the input\n     during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalLowAggregatedInputPower.setDescription('The lowest aggregated optical power monitored at the input\n     during the interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcIntervalHighAggregatedInputPower.setDescription('The highest aggregated optical power monitored at the input\n     during the interval.')
optIfOChGroupSrcCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 8))
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDayTable.setDescription('A table of OChGroup source performance monitoring information for\n     the current 24-hour interval.')
optIfOChGroupSrcCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 8, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDayEntry.setDescription('A conceptual row that contains OChGroup source performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOChGroupSrcCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 8, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power monitored at the input\n     during the current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcCurDayHighAggregatedInputPower.setDescription('The highest aggregated optical power monitored at the input\n     during the current 24-hour interval.')
optIfOChGroupSrcPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 9))
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayTable.setDescription('A table of OChGroup source performance monitoring information for\n     the previous 24-hour interval.')
optIfOChGroupSrcPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 9, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayEntry.setDescription('A conceptual row that contains OChGroup source performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOChGroupSrcPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 5, 9, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayLastOutputPower.setDescription('The last optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayLastAggregatedInputPower.setDescription('The last aggregated optical power monitored at the input\n     during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayLowAggregatedInputPower.setDescription('The lowest aggregated optical power monitored at the input\n     during the previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSrcPrevDayHighAggregatedInputPower.setDescription('The highest aggregated optical power monitored at the input\n     during the previous 24-hour interval.')
optIfOChConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 1))
if mibBuilder.loadTexts:
    optIfOChConfigTable.setDescription('A table of OCh configuration information.')
optIfOChConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 1, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChConfigEntry.setDescription('A conceptual row that contains OCh configuration\n     information of an interface.')
optIfOChDirectionality = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 1, 1, 1), OptIfDirectionality()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChDirectionality.setDescription('Indicates the directionality of the entity.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurrentInputPower.setDescription('The optical power monitored at the input.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurrentLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurrentHighInputPower.setDescription('The highest optical power monitored at the input during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurrentLowerInputPowerThreshold.setDescription('The lower limit threshold on input power.  If\n     optIfOChSinkCurrentInputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurrentUpperInputPowerThreshold.setDescription('The upper limit threshold on input power.  If\n     optIfOChSinkCurrentInputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
optIfOChSinkIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 3))
if mibBuilder.loadTexts:
    optIfOChSinkIntervalTable.setDescription('A table of historical OCh sink performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOChSinkIntervalEntry.setDescription('A conceptual row that contains OCh sink performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOChSinkIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 3, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOChSinkIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOChSinkIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 3, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSinkIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSinkIntervalLastInputPower.setDescription('The last optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkIntervalLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkIntervalHighInputPower.setDescription('The highest optical power monitored at the input during the\n     interval.')
optIfOChSinkCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 4))
if mibBuilder.loadTexts:
    optIfOChSinkCurDayTable.setDescription('A table of OCh sink performance monitoring information for\n     the current 24-hour interval.')
optIfOChSinkCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 4, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChSinkCurDayEntry.setDescription('A conceptual row that contains OCh sink performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOChSinkCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 4, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSinkCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurDayLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkCurDayHighInputPower.setDescription('The highest optical power monitored at the input during the\n     current 24-hour interval.')
optIfOChSinkPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 5))
if mibBuilder.loadTexts:
    optIfOChSinkPrevDayTable.setDescription('A table of OCh sink performance monitoring information for\n     the previous 24-hour interval.')
optIfOChSinkPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 5, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChSinkPrevDayEntry.setDescription('A conceptual row that contains OCh sink performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOChSinkPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 5, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSinkPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSinkPrevDayLastInputPower.setDescription('The last optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkPrevDayLowInputPower.setDescription('The lowest optical power monitored at the input during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChSinkPrevDayHighInputPower.setDescription('The highest optical power monitored at the input during the\n     previous 24-hour interval.')
optIfOChSrcCurrentTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 6))
if mibBuilder.loadTexts:
    optIfOChSrcCurrentTable.setDescription('A table of OCh source performance monitoring information for\n     the current 15-minute interval.')
optIfOChSrcCurrentEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 6, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChSrcCurrentEntry.setDescription('A conceptual row that contains OCh source performance\n     monitoring information of an interface for the current\n     15-minute interval.')
optIfOChSrcCurrentSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 6, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSrcCurrentSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurrentOutputPower.setDescription('The optical power monitored at the output.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurrentLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurrentHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 15-minute interval.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurrentLowerOutputPowerThreshold.setDescription('The lower limit threshold on output power.  If\n     optIfOChSrcCurrentOutputPower drops to this value or below,\n     a Threshold Crossing Alert (TCA) should be sent.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurrentUpperOutputPowerThreshold.setDescription('The upper limit threshold on output power.  If\n     optIfOChSrcCurrentOutputPower reaches or exceeds this value,\n     a Threshold Crossing Alert (TCA) should be sent.')
optIfOChSrcIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 7))
if mibBuilder.loadTexts:
    optIfOChSrcIntervalTable.setDescription('A table of historical OCh source performance monitoring\n     information.')
...
if mibBuilder.loadTexts:
    optIfOChSrcIntervalEntry.setDescription('A conceptual row that contains OCh source performance\n     monitoring information of an interface during a particular\n     historical interval.')
optIfOChSrcIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 7, 1, 1), OptIfIntervalNumber())
if mibBuilder.loadTexts:
    optIfOChSrcIntervalNumber.setDescription('Uniquely identifies the interval.')
optIfOChSrcIntervalSuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 7, 1, 2), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSrcIntervalSuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSrcIntervalLastOutputPower.setDescription('The last optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChSrcIntervalLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     interval.')
...
if mibBuilder.loadTexts:
    optIfOChSrcIntervalHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     interval.')
optIfOChSrcCurDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 8))
if mibBuilder.loadTexts:
    optIfOChSrcCurDayTable.setDescription('A table of OCh source performance monitoring information for\n     the current 24-hour interval.')
optIfOChSrcCurDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 8, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChSrcCurDayEntry.setDescription('A conceptual row that contains OCh source performance\n     monitoring information of an interface for the current\n     24-hour interval.')
optIfOChSrcCurDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 8, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSrcCurDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n\n\n\n     current 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChSrcCurDayHighOutputPower.setDescription('The highest optical power monitored at the output during the\n     current 24-hour interval.')
optIfOChSrcPrevDayTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 9))
if mibBuilder.loadTexts:
    optIfOChSrcPrevDayTable.setDescription('A table of OCh source performance monitoring information for\n     the previous 24-hour interval.')
optIfOChSrcPrevDayEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 9, 1)).setIndexNames((0, 'IF-MIB', 'ifIndex'))
if mibBuilder.loadTexts:
    optIfOChSrcPrevDayEntry.setDescription('A conceptual row that contains OCh source performance\n     monitoring information of an interface for the previous\n     24-hour interval.')
optIfOChSrcPrevDaySuspectedFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 6, 9, 1, 1), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    optIfOChSrcPrevDaySuspectedFlag.setDescription('If true, the data in this entry may be unreliable.')
...
if mibBuilder.loadTexts:
    optIfOChSrcPrevDayLastOutputPower.setDescription('The last optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOChSrcPrevDayLowOutputPower.setDescription('The lowest optical power monitored at the output during the\n     previous 24-hour interval.')
...
if mibBuilder.loadTexts:
    optIfOTUkCurrentStatus.setDescription('Indicates the defect condition of the entity, if any.\n     This object is only applicable to the sink function, i.e.,\n     only when optIfOTUkDirectionality has the value sink(1)\n     or bidirectional(3).  It must not be instantiated in rows\n     where optIfOTUkDirectionality has the value source(2).')
optIfGCC0ConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 7, 2))
if mibBuilder.loadTexts:
    optIfGCC0ConfigTable.setDescription('A table of GCC0 configuration information.')
...
if mibBuilder.loadTexts:
    optIfODUkTtpCurrentStatus.setDescription('Indicates the defect condition of the entity, if any.\n     This object is only applicable to the sink function, i.e.,\n     only when optIfODUkDirectionality has the value sink(1)\n     or bidirectional(3).  It must not be instantiated in rows\n     where optIfODUkDirectionality has the value source(2).')
optIfODUkPositionSeqTable = MibTable((1, 3, 6, 1, 2, 1, 10, 133, 1, 8, 3))
if mibBuilder.loadTexts:
    optIfODUkPositionSeqTable.setDescription('A table of ODUk Position Sequence information.')
...
if mibBuilder.loadTexts:
    optIfODUkTNimConfigEntry.setDescription('A conceptual row that contains ODUkTNim configuration\n     information of an interface.  Each instance must\n     correspond to an instance of optIfODUkConfigEntry.\n     Rows in this table are mutually exclusive with rows\n     in the ODUkT config table -- in other words, this\n     row object may not be instantiated for a given pair\n     of ifIndex and TCM field values if a corresponding\n     instance of optIfODUkTConfigEntry already exists.\n\n     Instances of this conceptual row persist across\n     agent restarts, and read-create columns other\n     than the status column may be modified while the\n     row is active.')
...
if mibBuilder.loadTexts:
    optIfOTMnGroup.setDescription('A collection of OTMn structure information objects.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkGroupFull.setDescription('A collection of configuration objects\n     applicable to full-functionality/IaDI OTSn\n     interfaces that support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OTSn interfaces that\n     support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOTSnSinkPreOtnPMThresholdGroup.setDescription('A collection of pre-OTN performance monitoring\n     threshold objects applicable to OTSn interfaces\n     that support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOTSnSourcePreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OTSn interfaces that\n     support source functions.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OMSn interfaces that\n     support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOMSnSinkPreOtnPMThresholdGroup.setDescription('A collection of pre-OTN performance monitoring\n     threshold objects applicable to OMSn interfaces\n     that support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOMSnSourcePreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OMSn interfaces that\n     support source functions.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OChGroup interfaces that\n     support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSinkPreOtnPMThresholdGroup.setDescription('A collection of pre-OTN performance monitoring\n     threshold objects applicable to OChGroup interfaces\n     that support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOChGroupSourcePreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OChGroup interfaces that\n     support source functions.')
...
if mibBuilder.loadTexts:
    optIfOChSinkPreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OCh interfaces that\n     support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOChSinkPreOtnPMThresholdGroup.setDescription('A collection of pre-OTN performance monitoring\n     threshold objects applicable to OCh interfaces\n     that support sink functions.')
...
if mibBuilder.loadTexts:
    optIfOChSourcePreOtnPMGroup.setDescription('A collection of pre-OTN performance monitoring\n     objects applicable to OCh interfaces that\n     support source functions.')
...
if mibBuilder.loadTexts:
    optIfOChSourcePreOtnPMThresholdGroup.setDescription('A collection of pre-OTN performance monitoring\n     threshold objects applicable to OCh interfaces\n     that support source functions.')
...
if mibBuilder.loadTexts:
    optIfOTUkCommonGroup.setDescription('A collection of configuration objects\n     applicable to all OTUk interfaces.')
...
if mibBuilder.loadTexts:
    optIfOTUkSourceGroup.setDescription('A collection of configuration objects\n     applicable to OTUk interfaces that\n     support source functions.')
...
if mibBuilder.loadTexts:
    optIfOTUkSinkGroup.setDescription('A collection of configuration objects\n     applicable to OTUk interfaces that\n     support sink functions.')
...
if mibBuilder.loadTexts:
    optIfGCC0Group.setDescription('A collection of GCC0 configuration objects.')
...
if mibBuilder.loadTexts:
    optIfODUkGroup.setDescription('A collection of configuration objects\n     applicable to all ODUk interfaces.')
...
if mibBuilder.loadTexts:
    optIfODUkTtpSinkGroup.setDescription('A collection of ODUk configuration objects\n     applicable to all interfaces that support\n     ODUk trail termination sink functions.')
...
if mibBuilder.loadTexts:
    optIfODUkNimGroup.setDescription('A collection of ODUk Nim configuration objects.')
...
if mibBuilder.loadTexts:
    optIfGCC12Group.setDescription('A collection of GCC12 configuration objects.')
optIfODUkTCommonGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 133, 2, 1, 39)).setObjects(*(('OPT-IF-MIB', 'optIfODUkTRowStatus'),))
if mibBuilder.loadTexts:
    optIfODUkTCommonGroup.setDescription('A collection of configuration objects\n     applicable to all ODUkT instances.')
...
if mibBuilder.loadTexts:
    optIfODUkTSourceGroup.setDescription('A collection of configuration objects\n     applicable to all ODUkT instances\n     that provide source functions.')
...
if mibBuilder.loadTexts:
    optIfODUkTSinkGroup.setDescription('A collection of configuration objects\n     applicable to all ODUkT instances\n     that provide sink functions.')
...
if mibBuilder.loadTexts:
    optIfODUkTNimGroup.setDescription('A collection of ODUkT Nim configuration objects.')
...
if mibBuilder.loadTexts:
    optIfOtnConfigCompl.setDescription('Implementation requirements for the OTN configuration\n     functions defined in this MIB module.')
...
if mibBuilder.loadTexts:
    optIfPreOtnPMCompl.setDescription('Implementation requirements for Pre-OTN performance\n     monitoring functions defined in this MIB module.')
