...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/NET-SNMP-EXTEND-MIB.py
# Compiled at: 2016-02-13 18:22:34
...
netSnmpExtendMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 8072, 1, 3, 1)).setRevisions(('2010-03-17 00:00',
                                                                                   '2004-05-08 00:00'))
if mibBuilder.loadTexts:
    netSnmpExtendMIB.setLastUpdated('201003170000Z')
if mibBuilder.loadTexts:
    netSnmpExtendMIB.setOrganization('www.net-snmp.org')
if mibBuilder.loadTexts:
    netSnmpExtendMIB.setContactInfo('postal:   Wes Hardaker\n                    P.O. Box 382\n                    Davis CA  95617\n\n          email:    net-snmp-coders@lists.sourceforge.net')
if mibBuilder.loadTexts:
    netSnmpExtendMIB.setDescription('Defines a framework for scripted extensions for the Net-SNMP agent.')
...
if mibBuilder.loadTexts:
    nsExtendConfigGroup.setDescription('Objects relating to the configuration of extension commands.')
...
if mibBuilder.loadTexts:
    nsExtendOutputGroup.setDescription('Objects relating to the output of extension commands.')
