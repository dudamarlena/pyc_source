...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DISMAN-EVENT-MIB.py
# Compiled at: 2016-02-13 18:07:55
...
if mibBuilder.loadTexts:
    dismanEventMIB.setLastUpdated('200111140000Z')
if mibBuilder.loadTexts:
    dismanEventMIB.setOrganization('IETF Distributed Management Working Group')
if mibBuilder.loadTexts:
    dismanEventMIB.setContactInfo('Ramanathan Kavasseri\n                  Cisco Systems, Inc.\n                  170 West Tasman Drive,\n                  San Jose CA 95134-1706.\n                  Phone: +1 408 526 4527\n                  Email: ramk@cisco.com')
if mibBuilder.loadTexts:
    dismanEventMIB.setDescription('The MIB module for defining event triggers and actions\n     for network management purposes.')
...
class FailureReason(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('localResourceLack', -1), ('badDestination', -2), ('destinationUnreachable',
                                                                                  -3), ('noResponse',
                                                                                        -4), ('badType',
                                                                                              -5), ('sampleOverrun',
                                                                                                    -6), ('noError',
...
if mibBuilder.loadTexts:
    mteTriggerObjectsOwner.setDescription('To go with mteTriggerObjects, the mteOwner of a group of\n        objects from mteObjectsTable.')
...
if mibBuilder.loadTexts:
    mteTriggerEntryStorageType.setDescription("The storage type for this conceptual row.\n                 Conceptual rows having the value 'permanent' need not\n                 allow write-access to any columnar objects in the row,\n                 except for mteTriggerEnabled.\n                ")
mteTriggerDeltaTable = MibTable((1, 3, 6, 1, 2, 1, 88, 1, 2, 3))
if mibBuilder.loadTexts:
    mteTriggerDeltaTable.setDescription('A table of management event trigger information for delta\n        sampling.')
...
if mibBuilder.loadTexts:
    mteTriggerDeltaEntry.setDescription("Information about a single trigger's delta sampling.  Entries\n        automatically exist in this this table for each mteTriggerEntry\n        that has mteTriggerSampleType set to 'deltaValue'.")
...
if mibBuilder.loadTexts:
    mteTriggerDeltaDiscontinuityIDType.setDescription("The value 'timeTicks' indicates the\n        mteTriggerDeltaDiscontinuityID of this row is of syntax\n        TimeTicks.  The value 'timeStamp' indicates syntax TimeStamp.\n        The value 'dateAndTime' indicates syntax DateAndTime.")
mteTriggerExistenceTable = MibTable((1, 3, 6, 1, 2, 1, 88, 1, 2, 4))
if mibBuilder.loadTexts:
    mteTriggerExistenceTable.setDescription('A table of management event trigger information for existence\n        triggers.')
...
if mibBuilder.loadTexts:
    mteTriggerExistenceEntry.setDescription("Information about a single existence trigger.  Entries\n        automatically exist in this this table for each mteTriggerEntry\n        that has 'existence' set in mteTriggerTest.")
...
if mibBuilder.loadTexts:
    mteTriggerExistenceStartup.setDescription("Control for whether an event may be triggered when this entry\n        is first set to 'active' and the test specified by\n        mteTriggerExistenceTest is true.  Setting an option causes\n        that trigger to fire when its test is true.")
...
if mibBuilder.loadTexts:
    mteTriggerExistenceObjectsOwner.setDescription('To go with mteTriggerExistenceObjects, the mteOwner of a\n        group of objects from mteObjectsTable.')
...
if mibBuilder.loadTexts:
    mteTriggerExistenceObjects.setDescription('The mteObjectsName of a group of objects from\n        mteObjectsTable.  These objects are to be added to any\n        Notification resulting from the firing of this trigger for\n        this test.\n\n        A list of objects may also be added based on the overall\n        trigger, the event or other settings in mteTriggerTest.\n\n        A length of 0 indicates no additional objects.')
...
if mibBuilder.loadTexts:
    mteTriggerExistenceEventOwner.setDescription('To go with mteTriggerExistenceEvent, the mteOwner of an event\n        entry from the mteEventTable.')
...
if mibBuilder.loadTexts:
    mteTriggerExistenceEvent.setDescription("The mteEventName of the event to invoke when mteTriggerType is\n        'existence' and this trigger fires.  A length of 0 indicates no\n        event.")
mteTriggerBooleanTable = MibTable((1, 3, 6, 1, 2, 1, 88, 1, 2, 5))
if mibBuilder.loadTexts:
    mteTriggerBooleanTable.setDescription('A table of management event trigger information for boolean\n        triggers.')
...
if mibBuilder.loadTexts:
    mteTriggerBooleanEntry.setDescription("Information about a single boolean trigger.  Entries\n        automatically exist in this this table for each mteTriggerEntry\n        that has 'boolean' set in mteTriggerTest.")
...
if mibBuilder.loadTexts:
    mteTriggerBooleanObjectsOwner.setDescription('To go with mteTriggerBooleanObjects, the mteOwner of a group\n        of objects from mteObjectsTable.')
...
if mibBuilder.loadTexts:
    mteTriggerBooleanObjects.setDescription('The mteObjectsName of a group of objects from\n        mteObjectsTable.  These objects are to be added to any\n        Notification resulting from the firing of this trigger for\n        this test.\n\n        A list of objects may also be added based on the overall\n        trigger, the event or other settings in mteTriggerTest.\n\n        A length of 0 indicates no additional objects.')
...
if mibBuilder.loadTexts:
    mteTriggerBooleanEventOwner.setDescription('To go with mteTriggerBooleanEvent, the mteOwner of an event\n        entry from mteEventTable.')
...
if mibBuilder.loadTexts:
    mteTriggerBooleanEvent.setDescription("The mteEventName of the event to invoke when mteTriggerType is\n        'boolean' and this trigger fires.  A length of 0 indicates no\n        event.")
mteTriggerThresholdTable = MibTable((1, 3, 6, 1, 2, 1, 88, 1, 2, 6))
if mibBuilder.loadTexts:
    mteTriggerThresholdTable.setDescription('A table of management event trigger information for threshold\n        triggers.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdEntry.setDescription("Information about a single threshold trigger.  Entries\n        automatically exist in this table for each mteTriggerEntry\n        that has 'threshold' set in mteTriggerTest.")
...
if mibBuilder.loadTexts:
    mteTriggerThresholdObjectsOwner.setDescription('To go with mteTriggerThresholdObjects, the mteOwner of a group\n        of objects from mteObjectsTable.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdObjects.setDescription('The mteObjectsName of a group of objects from\n        mteObjectsTable.  These objects are to be added to any\n        Notification resulting from the firing of this trigger for\n        this test.\n\n        A list of objects may also be added based on the overall\n        trigger, the event or other settings in mteTriggerTest.\n\n        A length of 0 indicates no additional objects.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdRisingEventOwner.setDescription('To go with mteTriggerThresholdRisingEvent, the mteOwner of an\n        event entry from mteEventTable.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdRisingEvent.setDescription("The mteEventName of the event to invoke when mteTriggerType is\n        'threshold' and this trigger fires based on\n        mteTriggerThresholdRising.  A length of 0 indicates no event.")
...
if mibBuilder.loadTexts:
    mteTriggerThresholdFallingEventOwner.setDescription('To go with mteTriggerThresholdFallingEvent, the mteOwner of an\n        event entry from mteEventTable.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdFallingEvent.setDescription("The mteEventName of the event to invoke when mteTriggerType is\n        'threshold' and this trigger fires based on\n        mteTriggerThresholdFalling.  A length of 0 indicates no event.")
...
if mibBuilder.loadTexts:
    mteTriggerThresholdDeltaRisingEventOwner.setDescription('To go with mteTriggerThresholdDeltaRisingEvent, the mteOwner\n        of an event entry from mteEventTable.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdDeltaRisingEvent.setDescription("The mteEventName of the event to invoke when mteTriggerType is\n        'threshold' and this trigger fires based on\n        mteTriggerThresholdDeltaRising. A length of 0 indicates\n        no event.")
...
if mibBuilder.loadTexts:
    mteTriggerThresholdDeltaFallingEventOwner.setDescription('To go with mteTriggerThresholdDeltaFallingEvent, the mteOwner\n        of an event entry from mteEventTable.')
...
if mibBuilder.loadTexts:
    mteTriggerThresholdDeltaFallingEvent.setDescription("The mteEventName of the event to invoke when mteTriggerType is\n        'threshold' and this trigger fires based on\n        mteTriggerThresholdDeltaFalling.  A length of 0 indicates\n        no event.")
mteObjectsTable = MibTable((1, 3, 6, 1, 2, 1, 88, 1, 3, 1))
if mibBuilder.loadTexts:
    mteObjectsTable.setDescription('A table of objects that can be added to notifications based\n        on the trigger, trigger test, or event, as pointed to by\n        entries in those tables.')
...
if mibBuilder.loadTexts:
    mteEventEntry.setDescription('Information about a single event.  Applications create and\n        delete entries using mteEventEntryStatus.')
mteEventName = MibTableColumn((1, 3, 6, 1, 2, 1, 88, 1, 4, 2, 1, 1), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32)))
if mibBuilder.loadTexts:
    mteEventName.setDescription('A locally-unique, administratively assigned name for the\n        event.')
mteEventComment = MibTableColumn((1, 3, 6, 1, 2, 1, 88, 1, 4, 2, 1, 2), SnmpAdminString().clone(hexValue='')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mteEventComment.setDescription("A description of the event's function and use.")
...
if mibBuilder.loadTexts:
    mteEventNotificationObjectsOwner.setDescription('To go with mteEventNotificationObjects, the mteOwner of a\n        group of objects from mteObjectsTable.')
...
if mibBuilder.loadTexts:
    mteTriggerFired.setDescription("Notification that the trigger indicated by the object\n        instances has fired, for triggers with mteTriggerType\n        'boolean' or 'existence'.")
...
if mibBuilder.loadTexts:
    mteTriggerRising.setDescription("Notification that the rising threshold was met for triggers\n        with mteTriggerType 'threshold'.")
...
if mibBuilder.loadTexts:
    mteTriggerFalling.setDescription("Notification that the falling threshold was met for triggers\n        with mteTriggerType 'threshold'.")
...
if mibBuilder.loadTexts:
    mteTriggerFailure.setDescription('Notification that an attempt to check a trigger has failed.\n\n        The network manager must enable this notification only with\n        a certain fear and trembling, as it can easily crowd out more\n        important information.  It should be used only to help diagnose\n        a problem that has appeared in the error counters and can not\n        be found otherwise.')
...
if mibBuilder.loadTexts:
    mteEventSetFailure.setDescription('Notification that an attempt to do a set in response to an\n        event has failed.\n\n        The network manager must enable this notification only with\n        a certain fear and trembling, as it can easily crowd out more\n        important information.  It should be used only to help diagnose\n        a problem that has appeared in the error counters and can not\n        be found otherwise.')
...
if mibBuilder.loadTexts:
    dismanEventMIBCompliance.setDescription('The compliance statement for entities which implement\n                the Event MIB.')
...
if mibBuilder.loadTexts:
    dismanEventResourceGroup.setDescription('Event resource status and control objects.')
...
if mibBuilder.loadTexts:
    dismanEventTriggerGroup.setDescription('Event triggers.')
...
if mibBuilder.loadTexts:
    dismanEventObjectsGroup.setDescription('Supplemental objects.')
...
if mibBuilder.loadTexts:
    dismanEventEventGroup.setDescription('Events.')
...
if mibBuilder.loadTexts:
    dismanEventNotificationObjectGroup.setDescription('Notification objects.')
...
if mibBuilder.loadTexts:
    dismanEventNotificationGroup.setDescription('Notifications.')
