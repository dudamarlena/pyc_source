...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/SIP-UA-MIB.py
# Compiled at: 2016-02-13 18:28:20
...
sipUACfgTimerEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 3, 1, 1, 1, 1)).setIndexNames((0,
...
sipUACfgRetryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 3, 1, 2, 1, 1)).setIndexNames((0,
                                                                                         'NETWORK-SERVICES-MIB',
                                                                                         'applIndex'))
if mibBuilder.loadTexts:
...
sipUAStatsRetryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 3, 2, 1, 1, 1)).setIndexNames((0,
                                                                                           'NETWORK-SERVICES-MIB',
                                                                                           'applIndex'))
if mibBuilder.loadTexts:
