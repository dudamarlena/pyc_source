...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ARC-MIB.py
# Compiled at: 2016-02-13 18:06:06
...
if mibBuilder.loadTexts:
    arcMibModule.setLastUpdated('200409090000Z')
if mibBuilder.loadTexts:
    arcMibModule.setOrganization('IETF Distributed Management Working Group')
if mibBuilder.loadTexts:
    arcMibModule.setContactInfo('WG EMail:  disman@ietf.org\n              Subscribe: disman-request@ietf.org\n              http://www.ietf.org/html.charters/disman-charter.html\n\n        Chair:     Randy Presuhn\n                   E-mail: randy_presuhn@mindspring.com\n\n        Editor:    Hing-Kam Lam\n                   Lucent Technologies, 4C-616\n                   101 Crawfords Corner Road\n\n                   Holmdel, NJ 07733\n                   USA\n                   Tel: +1 732 949 8338\n                   E-mail: hklam@lucent.com')
if mibBuilder.loadTexts:
    arcMibModule.setDescription('The MIB module describes the objects for controlling a resource\n     in reporting alarm conditions that it detects.\n\n     Copyright (C) The Internet Society (2004).  This version\n     of this MIB module is part of RFC 3878;  see the RFC\n     itself for full legal notices.')
...
if mibBuilder.loadTexts:
    arcCompliance.setDescription('The compliance statement for systems supporting\n       the ARC MIB module.')
