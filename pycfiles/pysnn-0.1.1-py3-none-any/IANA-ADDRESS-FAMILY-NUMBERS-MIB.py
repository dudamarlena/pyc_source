...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IANA-ADDRESS-FAMILY-NUMBERS-MIB.py
...
ianaAddressFamilyNumbers = ModuleIdentity((1, 3, 6, 1, 2, 1, 72)).setRevisions(('2002-03-14 00:00',
                                                                                '2000-09-08 00:00',
                                                                                '2000-03-01 00:00',
                                                                                '2000-02-04 00:00',
                                                                                '1999-08-26 00:00'))
if mibBuilder.loadTexts:
    ianaAddressFamilyNumbers.setLastUpdated('200203140000Z')
if mibBuilder.loadTexts:
    ianaAddressFamilyNumbers.setOrganization('IANA')
if mibBuilder.loadTexts:
    ianaAddressFamilyNumbers.setContactInfo('Postal:    Internet Assigned Numbers Authority\n                      Internet Corporation for Assigned Names\n\t\t      and Numbers\n                      4676 Admiralty Way, Suite 330\n                      Marina del Rey, CA 90292-6601\n                      USA\n\n          Tel:    +1  310-823-9358\n          E-Mail: iana@iana.org')
if mibBuilder.loadTexts:
    ianaAddressFamilyNumbers.setDescription('The MIB module defines the AddressFamilyNumbers\n          textual convention.')
...
class AddressFamilyNumbers(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 0), ('ipV4', 1), ('ipV6', 2), ('nsap', 3), ('hdlc',
                                                                                    4), ('bbn1822',
                                                                                         5), ('all802',
                                                                                              6), ('e163',
                                                                                                   7), ('e164',
