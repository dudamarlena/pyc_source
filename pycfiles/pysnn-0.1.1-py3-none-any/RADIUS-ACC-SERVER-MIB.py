...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/RADIUS-ACC-SERVER-MIB.py
# Compiled at: 2016-02-13 18:25:27
...
if mibBuilder.loadTexts:
    radiusAccServMIB.setLastUpdated('200608210000Z')
if mibBuilder.loadTexts:
    radiusAccServMIB.setOrganization('IETF RADIUS Extensions Working Group.')
if mibBuilder.loadTexts:
    radiusAccServMIB.setContactInfo(' Bernard Aboba\n                Microsoft\n                One Microsoft Way\n                Redmond, WA  98052\n                US\n\n                Phone: +1 425 936 6605\n                EMail: bernarda@microsoft.com')
if mibBuilder.loadTexts:
    radiusAccServMIB.setDescription('The MIB module for entities implementing the server\n              side of the Remote Authentication Dial-In User\n              Service (RADIUS) accounting protocol.  Copyright (C)\n              The Internet Society (2006).  This version of this\n              MIB module is part of RFC 4671; see the RFC itself\n              for full legal notices.')
...
if mibBuilder.loadTexts:
    radiusAccServBadAuthenticators.setDescription('The number of RADIUS Accounting-Request packets\n              that contained invalid authenticators received\n              from this client.')
...
if mibBuilder.loadTexts:
    radiusAccClientExtEntry.setDescription('An entry (conceptual row) representing a RADIUS\n              accounting client with which the server shares a\n              secret.')
...
if mibBuilder.loadTexts:
    radiusAccServExtBadAuthenticators.setDescription('The number of RADIUS Accounting-Request packets\n              that contained invalid authenticators received\n              from this client.  This counter may experience a\n              discontinuity when the RADIUS Accounting Server\n              module within the managed entity is reinitialized,\n              as indicated by the current value of\n              radiusAccServerCounterDiscontinuity.')
...
if mibBuilder.loadTexts:
    radiusAccServMIBGroup.setDescription('The collection of objects providing management of\n             a RADIUS Accounting Server.')
...
if mibBuilder.loadTexts:
    radiusAccServExtMIBGroup.setDescription('The collection of objects providing management of\n             a RADIUS Accounting Server.')
