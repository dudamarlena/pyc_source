...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/NAT-MIB.py
# Compiled at: 2016-02-13 18:20:10
...
class NatTranslationEntity(Bits, TextualConvention):
    __module__ = __name__
    namedValues = NamedValues(('inboundSrcEndPoint', 0), ('outboundDstEndPoint', 1), ('inboundDstEndPoint',
                                                                                      2), ('outboundSrcEndPoint',
                                                                                           3))
...
if mibBuilder.loadTexts:
    natBindDefIdleTimeout.setDescription('The default Bind (Address Bind or Port Bind) idle\n             timeout parameter.\n\n             If the agent is capable of storing non-volatile\n             configuration, then the value of this object must be\n             restored after a re-initialization of the management\n             system.')
...
if mibBuilder.loadTexts:
    natUdpDefIdleTimeout.setDescription('The default UDP idle timeout parameter.\n\n             If the agent is capable of storing non-volatile\n             configuration, then the value of this object must be\n             restored after a re-initialization of the management\n             system.')
...
if mibBuilder.loadTexts:
    natIcmpDefIdleTimeout.setDescription('The default ICMP idle timeout parameter.\n\n             If the agent is capable of storing non-volatile\n             configuration, then the value of this object must be\n             restored after a re-initialization of the management\n             system.')
...
if mibBuilder.loadTexts:
    natOtherDefIdleTimeout.setDescription('The default idle timeout parameter for protocols\n             represented by the value other (2) in\n             NatProtocolType.\n\n             If the agent is capable of storing non-volatile\n             configuration, then the value of this object must be\n             restored after a re-initialization of the management\n             system.')
...
if mibBuilder.loadTexts:
    natInterfaceRealm.setDescription('This object identifies whether this interface is\n             connected to the private or the public realm.')
...
if mibBuilder.loadTexts:
    natConfigGroup.setDescription('A collection of configuration-related information\n             required to support management of devices supporting\n             NAT.')
...
if mibBuilder.loadTexts:
    natTranslationGroup.setDescription('A collection of BIND-related objects required to support\n             management of devices supporting NAT.')
...
if mibBuilder.loadTexts:
    natStatsProtocolGroup.setDescription('A collection of protocol specific NAT statistics,\n             to aid troubleshooting/monitoring of NAT operation.')
...
if mibBuilder.loadTexts:
    natStatsAddrMapGroup.setDescription('A collection of address map specific NAT statistics,\n             to aid troubleshooting/monitoring of NAT operation.')
natMIBNotificationGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 123, 2, 1, 6)).setObjects(*(('NAT-MIB', 'natPacketDiscard'),))
if mibBuilder.loadTexts:
    natMIBNotificationGroup.setDescription('A collection of notifications generated by\n            devices supporting this MIB.')
...
if mibBuilder.loadTexts:
    natMIBReadOnlyCompliance.setDescription('When this MIB is implemented without support for\n             read-create (i.e., in read-only mode), then such an\n             implementation can claim read-only compliance.\n             Such a device can then be monitored but cannot be\n             configured with this MIB.\n\n             The following index objects cannot be added as OBJECT\n             clauses but nevertheless have the compliance\n             requirements:\n             ')
