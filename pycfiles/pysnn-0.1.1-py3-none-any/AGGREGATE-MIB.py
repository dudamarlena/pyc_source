...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/AGGREGATE-MIB.py
...
if mibBuilder.loadTexts:
    aggrMIB.setLastUpdated('200604270000Z')
if mibBuilder.loadTexts:
    aggrMIB.setOrganization('Cyber Solutions Inc. NetMan Working Group')
if mibBuilder.loadTexts:
    aggrMIB.setContactInfo('                      Glenn Mansfield Keeni\n                     Postal: Cyber Solutions Inc.\n                             6-6-3, Minami Yoshinari\n                             Aoba-ku, Sendai, Japan 989-3204.\n                        Tel: +81-22-303-4012\n                        Fax: +81-22-303-4015\n                     E-mail: glenn@cysols.com\n\n          Support Group E-mail: mibsupport@cysols.com')
if mibBuilder.loadTexts:
    aggrMIB.setDescription('The MIB for servicing aggregate objects.\n\n                   Copyright (C) The Internet Society (2006).  This\n                   version of this MIB module is part of RFC 4498;\n                   see the RFC itself for full legal notices.\n                  ')
...
if mibBuilder.loadTexts:
    aggrCtlMOIndex.setDescription('A pointer to a group of MOs identified by aggrMOEntryID\n           in the aggrMOTable.  This is the group of MOs that will\n           be aggregated.')
...
if mibBuilder.loadTexts:
    aggrMibCompliance.setDescription('The compliance statement for SNMP entities\n                 that implement the AGGREGATE-MIB.')
...
if mibBuilder.loadTexts:
    aggrMibBasicGroup.setDescription('A collection of objects for aggregation of MOs.')
