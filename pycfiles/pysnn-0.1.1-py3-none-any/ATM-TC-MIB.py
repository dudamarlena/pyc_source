...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ATM-TC-MIB.py
# Compiled at: 2016-02-13 18:06:16
...
if mibBuilder.loadTexts:
    atmTCMIB.setLastUpdated('9810190200Z')
if mibBuilder.loadTexts:
    atmTCMIB.setOrganization('IETF AToMMIB Working Group')
if mibBuilder.loadTexts:
    atmTCMIB.setContactInfo('          Michael Noto\n              Postal:  3Com Corporation\n                       5400 Bayfront Plaza, M/S 3109\n                       Santa Clara, CA 95052\n                       USA\n              Tel:     +1 408 326 2218\n              E-mail:  mike_noto@3com.com\n            \n                       Ethan Mickey Spiegel\n            \n              Postal:  Cisco Systems\n                       170 W. Tasman Dr.\n                       San Jose, CA 95134\n                       USA\n              Tel:     +1 408 526 6408\n              E-mail:  mspiegel@cisco.com\n            \n                       Kaj Tesink\n              Postal:  Bellcore\n                       331 Newman Springs Road\n                       Red Bank, NJ 07701\n                       USA\n              Tel:     +1 732 758 5254\n              Fax:     +1 732 758 4177\n              E-mail:  kaj@bellcore.com')
if mibBuilder.loadTexts:
    atmTCMIB.setDescription('This MIB Module provides Textual Conventions\n            and OBJECT-IDENTITY Objects to be used by\n            ATM systems.')
...
class AtmConnKind(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('pvc', 1), ('svcIncoming', 2), ('svcOutgoing', 3), ('spvcInitiator',
                                                                                   4), ('spvcTarget',
                                                                                        5))
...
class AtmInterfaceType(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('autoConfig', 2), ('ituDss2', 3), ('atmfUni3Dot0',
                                                                                4), ('atmfUni3Dot1',
                                                                                     5), ('atmfUni4Dot0',
                                                                                          6), ('atmfIispUni3Dot0',
                                                                                               7), ('atmfIispUni3Dot1',
...
class AtmServiceCategory(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('cbr', 2), ('rtVbr', 3), ('nrtVbr', 4), ('abr',
                                                                                      5), ('ubr',
                                                                                           6))
