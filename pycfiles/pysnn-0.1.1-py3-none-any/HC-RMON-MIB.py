...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/HC-RMON-MIB.py
# Compiled at: 2016-02-13 18:15:01
...
if mibBuilder.loadTexts:
    mediaIndependentOutOverflowOctets.setDescription('The number of times the associated\n        mediaIndependentOutOctets counter has overflowed.')
...
if mibBuilder.loadTexts:
    mediaIndependentOutHighCapacityOctets.setDescription('The total number of octets of data (including those in bad\n        packets) received on a full-duplex link in the direction of\n        the network (excluding framing bits but including FCS\n        octets).')
mediaIndependentInNUCastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 21, 1, 1, 17), Counter32()).setUnits('Packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mediaIndependentInNUCastPkts.setDescription('The total number of non-unicast packets (including bad\n        packets) received on a half-duplex link or on the inbound\n        connection of a full-duplex link.')
...
if mibBuilder.loadTexts:
    mediaIndependentInNUCastOverflowPkts.setDescription('The number of times the associated\n        mediaIndependentInNUCastPkts counter has overflowed.')
...
if mibBuilder.loadTexts:
    mediaIndependentInNUCastHighCapacityPkts.setDescription('The total number of non-unicast packets (including bad\n        packets) received on a half-duplex link or on the inbound\n        connection of a full-duplex link.')
mediaIndependentOutNUCastPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 21, 1, 1, 20), Counter32()).setUnits('Packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mediaIndependentOutNUCastPkts.setDescription('The total number of non-unicast packets (including bad\n        packets) received on a full-duplex link in the direction of\n        the network.')
...
if mibBuilder.loadTexts:
    mediaIndependentOutNUCastOverflowPkts.setDescription('The number of times the associated\n        mediaIndependentOutNUCastPkts counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts.setDescription('The number of times the associated etherStatsPkts\n        counter has overflowed.')
etherStatsHighCapacityPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 1, 7, 1, 2), Counter64()).setUnits('Packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts.setDescription('The total number of packets (including bad packets,\n        broadcast packets, and multicast packets) received.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts64Octets.setDescription('The number of times the associated etherStatsPkts64Octets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts64Octets.setDescription('The total number of packets (including bad\n        packets) received that were 64 octets in length\n        (excluding framing bits but including FCS octets).')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts65to127Octets.setDescription('The number of times the associated etherStatsPkts65to127Octets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts65to127Octets.setDescription('The total number of packets (including bad\n        packets) received that were between\n        65 and 127 octets in length inclusive\n        (excluding framing bits but including FCS octets).')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts128to255Octets.setDescription('The number of times the associated etherStatsPkts128to255Octets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts128to255Octets.setDescription('The total number of packets (including bad\n        packets) received that were between\n        128 and 255 octets in length inclusive\n        (excluding framing bits but including FCS octets).')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts256to511Octets.setDescription('The number of times the associated etherStatsPkts256to511Octets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts256to511Octets.setDescription('The total number of packets (including bad\n        packets) received that were between\n        256 and 511 octets in length inclusive\n        (excluding framing bits but including FCS octets).')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts512to1023Octets.setDescription('The number of times the associated\n         etherStatsPkts512to1023Octets counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts512to1023Octets.setDescription('The total number of packets (including bad\n        packets) received that were between\n        512 and 1023 octets in length inclusive\n        (excluding framing bits but including FCS octets).')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityOverflowPkts1024to1518Octets.setDescription('The number of times the associated\n        etherStatsPkts1024to1518Octets counter has overflowed.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityPkts1024to1518Octets.setDescription('The total number of packets (including bad\n        packets) received that were between\n        1024 and 1518 octets in length inclusive\n        (excluding framing bits but including FCS octets).')
etherHistoryHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 2, 6))
if mibBuilder.loadTexts:
    etherHistoryHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-1\n        etherHistoryTable.')
...
if mibBuilder.loadTexts:
    etherHistoryHighCapacityOverflowPkts.setDescription('The number of times the associated etherHistoryPkts\n        Gauge overflowed during this sampling interval.')
...
if mibBuilder.loadTexts:
    etherHistoryHighCapacityPkts.setDescription('The total number of packets (including bad packets,\n        broadcast packets, and multicast packets) received during\n        this sampling interval.')
...
if mibBuilder.loadTexts:
    etherHistoryHighCapacityOverflowOctets.setDescription('The number of times the associated etherHistoryOctets\n        counter has overflowed during this sampling interval.')
...
if mibBuilder.loadTexts:
    hostTimeHighCapacityInOverflowPkts.setDescription('The number of times the associated hostTimeInPkts\n        counter has overflowed.')
hostTimeHighCapacityInPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 4, 6, 1, 2), Counter64()).setUnits('Packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hostTimeHighCapacityInPkts.setDescription('The number of good packets transmitted to this address\n        since it was added to the hostTimeHighCapacityTable.')
...
if mibBuilder.loadTexts:
    hostTimeHighCapacityOutOverflowPkts.setDescription('The number of times the associated hostTimeOutPkts\n        counter has overflowed.')
hostTimeHighCapacityOutPkts = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 4, 6, 1, 4), Counter64()).setUnits('Packets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hostTimeHighCapacityOutPkts.setDescription('The number of packets, including bad packets, transmitted\n        by this address since it was added to the\n        hostTimeHighCapacityTable.')
...
if mibBuilder.loadTexts:
    hostTimeHighCapacityInOverflowOctets.setDescription('The number of times the associated hostTimeInOctets\n        counter has overflowed.')
hostTimeHighCapacityInOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 4, 6, 1, 6), Counter64()).setUnits('Octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hostTimeHighCapacityInOctets.setDescription('The number of octets transmitted to this address\n        since it was added to the hostTimeHighCapacityTable\n        (excluding framing bits but including FCS octets),\n        except for those octets in bad packets.')
...
if mibBuilder.loadTexts:
    hostTimeHighCapacityOutOverflowOctets.setDescription('The number of times the associated hostTimeOutOctets\n        counter has overflowed.')
hostTimeHighCapacityOutOctets = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 4, 6, 1, 8), Counter64()).setUnits('Octets').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hostTimeHighCapacityOutOctets.setDescription('The number of octets transmitted by this address since\n        it was added to the hostTimeTable (excluding framing\n        bits but including FCS octets), including those\n\n        octets in bad packets.')
hostTopNHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 5, 3))
if mibBuilder.loadTexts:
    hostTopNHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-1\n        hostTopNTable when hostTopNRateBase specifies a High Capacity\n        TopN Report.')
...
if mibBuilder.loadTexts:
    protocolDistStatsHighCapacityOverflowPkts.setDescription('The number of times the associated protocolDistStatsPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    protocolDistStatsHighCapacityPkts.setDescription('The number of packets without errors received of this\n        protocol type.  Note that this is the number of link-layer\n        packets, so if a single network-layer packet is fragmented\n        into several link-layer frames, this counter is incremented\n        several times.')
...
if mibBuilder.loadTexts:
    protocolDistStatsHighCapacityOverflowOctets.setDescription('The number of times the associated protocolDistStatsOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    protocolDistStatsHighCapacityOctets.setDescription("The number of octets in packets received of this protocol\n        type since it was added to the protocolDistStatsTable\n        (excluding framing bits but including FCS octets), except for\n        those octets in packets that contained errors.\n\n        Note this doesn't count just those octets in the particular\n        protocol frames, but includes the entire packet that contained\n        the protocol.")
nlHostHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 14, 3))
if mibBuilder.loadTexts:
    nlHostHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        nlHostTable.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityInOverflowPkts.setDescription('The number of times the associated nlHostInPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityOutOverflowPkts.setDescription('The number of times the associated nlHostOutPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityOutPkts.setDescription('The number of packets without errors transmitted by\n        this address since it was added to the nlHostHighCapacityTable.\n        Note that this is the number of link-layer packets, so if a\n        single network-layer packet is fragmented into several\n        link-layer frames, this counter is incremented several times.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityInOverflowOctets.setDescription('The number of times the associated nlHostInOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityOutOverflowOctets.setDescription('The number of times the associated nlHostOutOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityOutOctets.setDescription("The number of octets transmitted by this address\n        since it was added to the nlHostHighCapacityTable\n        (excluding framing bits but including FCS octets),\n        excluding those octets in packets that contained\n        errors.\n\n        Note this doesn't count just those octets in the\n        particular protocol frames, but includes the entire\n        packet that contained the protocol.")
nlMatrixSDHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 15, 6))
if mibBuilder.loadTexts:
    nlMatrixSDHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        nlMatrixTable.')
...
if mibBuilder.loadTexts:
    nlMatrixSDHighCapacityOverflowPkts.setDescription('The number of times the associated nlMatrixSDPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlMatrixSDHighCapacityOverflowOctets.setDescription('The number of times the associated nlMatrixSDOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlMatrixSDHighCapacityOctets.setDescription("The number of octets transmitted from the source address to\n        the destination address since this entry was added to the\n\n        nlMatrixSDHighCapacityTable (excluding framing bits but\n        including FCS octets), excluding those octets in packets that\n        contained errors.\n\n        Note this doesn't count just those octets in the particular\n        protocol frames, but includes the entire packet that contained\n        the protocol.")
nlMatrixDSHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 15, 7))
if mibBuilder.loadTexts:
    nlMatrixDSHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        nlMatrixDSTable.')
...
if mibBuilder.loadTexts:
    nlMatrixDSHighCapacityOverflowPkts.setDescription('The number of times the associated nlMatrixDSPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlMatrixDSHighCapacityPkts.setDescription('The number of packets without errors transmitted from the\n        source address to the destination address since this entry was\n        added to the nlMatrixDSHighCapacityTable.  Note that this is\n        the number of link-layer packets, so if a single network-layer\n        packet is fragmented into several link-layer frames, this\n        counter is incremented several times.')
...
if mibBuilder.loadTexts:
    nlMatrixDSHighCapacityOverflowOctets.setDescription('The number of times the associated nlMatrixDSOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityProtocolDirLocalIndex.setDescription("The protocolDirLocalIndex of the network layer protocol of\n\n        this entry's network address.")
nlMatrixTopNHighCapacitySourceAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 15, 8, 1, 2), OctetString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacitySourceAddress.setDescription('The network layer address of the source host in this\n        conversation.\n\n        This is represented as an octet string with\n        specific semantics and length as identified\n        by the associated nlMatrixTopNProtocolDirLocalIndex.\n\n        For example, if the protocolDirLocalIndex indicates an\n        encapsulation of ip, this object is encoded as a length\n        octet of 4, followed by the 4 octets of the ip address,\n        in network byte order.')
nlMatrixTopNHighCapacityDestAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 15, 8, 1, 3), OctetString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityDestAddress.setDescription('The network layer address of the destination host in this\n        conversation.\n\n        This is represented as an octet string with\n        specific semantics and length as identified\n        by the associated nlMatrixTopNProtocolDirLocalIndex.\n\n        For example, if the nlMatrixTopNProtocolDirLocalIndex\n        indicates an encapsulation of ip, this object is encoded as a\n        length octet of 4, followed by the 4 octets of the ip address,\n        in network byte order.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityOverflowPktRate.setDescription('The number of packets seen from the source host\n        to the destination host during this sampling interval,\n        divided by 2^32, truncating fractions (i.e., X DIV 2^32),\n        and counted using the rules for counting the\n        nlMatrixSDPkts object.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityReverseOverflowPktRate.setDescription('The number of packets seen from the destination host to the\n        source host during this sampling interval, divided by 2^32,\n        truncating fractions (i.e., X DIV 2^32), and counted\n        using the rules for counting the nlMatrixSDPkts object (note\n        that the corresponding nlMatrixSDPkts object selected is the\n        one whose source address is equal to nlMatrixTopNDestAddress\n        and whose destination address is equal to\n        nlMatrixTopNSourceAddress.)\n\n        Note that if the value of nlMatrixTopNControlRateBase is equal\n        to nlMatrixTopNHighCapacityPkts, the sort of topN entries is\n        based entirely on nlMatrixTopNHighCapacityPktRate, and not on\n        the value of this object.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityReversePktRate.setDescription('The number of packets seen from the destination host to the\n        source host during this sampling interval, counted\n        using the rules for counting the nlMatrixSDPkts object (note\n        that the corresponding nlMatrixSDPkts object selected is the\n        one whose source address is equal to nlMatrixTopNDestAddress\n        and whose destination address is equal to\n        nlMatrixTopNSourceAddress.)\n\n        Note that if the value of nlMatrixTopNControlRateBase is equal\n        to nlMatrixTopNHighCapacityPkts, the sort of topN entries is\n        based entirely on nlMatrixTopNHighCapacityPktRate, and not on\n        the value of this object.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityOverflowOctetRate.setDescription('The number of octets seen from the source host\n        to the destination host during this sampling interval,\n        divided by 2^32, truncating fractions (i.e., X DIV 2^32),\n        and counted using the rules for counting the\n        nlMatrixSDOctets object.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityReverseOverflowOctetRate.setDescription('The number of octets seen from the destination host to the\n        source host during this sampling interval, divided by 2^32,\n        truncating fractions (i.e., X DIV 2^32), and counted\n        using the rules for counting the nlMatrixSDOctets object (note\n        that the corresponding nlMatrixSDOctets object selected is the\n        one whose source address is equal to nlMatrixTopNDestAddress\n        and whose destination address is equal to\n        nlMatrixTopNSourceAddress.)\n\n        Note that if the value of nlMatrixTopNControlRateBase is equal\n        to nlMatrixTopNHighCapacityOctets, the sort of topN entries is\n        based entirely on nlMatrixTopNHighCapacityOctetRate, and not on\n        the value of this object.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityReverseOctetRate.setDescription('The number of octets seen from the destination host to the\n        source host during this sampling interval, counted\n        using the rules for counting the nlMatrixSDOctets object (note\n        that the corresponding nlMatrixSDOctets object selected is the\n        one whose source address is equal to nlMatrixTopNDestAddress\n        and whose destination address is equal to\n        nlMatrixTopNSourceAddress.)\n\n        Note that if the value of nlMatrixTopNControlRateBase is equal\n        to nlMatrixTopNHighCapacityOctets, the sort of topN entries is\n        based entirely on nlMatrixTopNHighCapacityOctetRate, and not on\n        the value of this object.')
alHostHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 16, 2))
if mibBuilder.loadTexts:
    alHostHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        alHostTable.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityInOverflowPkts.setDescription('The number of times the associated alHostInPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityOutOverflowPkts.setDescription('The number of times the associated alHostOutPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityOutPkts.setDescription('The number of packets of this protocol type without errors\n        transmitted by this address since it was added to the\n        alHostHighCapacityTable.  Note that this is the number of\n        link-layer packets, so if a single network-layer packet\n        is fragmented into several link-layer frames, this counter\n        is incremented several times.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityInOverflowOctets.setDescription('The number of times the associated alHostInOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityOutOverflowOctets.setDescription('The number of times the associated alHostOutOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityOutOctets.setDescription("The number of octets transmitted by this address\n        of this protocol type since it was added to the\n        alHostHighCapacityTable (excluding framing bits but\n        including FCS octets), excluding those octets in\n        packets that contained errors.\n\n        Note this doesn't count just those octets in the particular\n        protocol frames, but includes the entire packet that contained\n        the protocol.")
alMatrixSDHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 17, 5))
if mibBuilder.loadTexts:
    alMatrixSDHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        alMatrixSDTable.')
...
if mibBuilder.loadTexts:
    alMatrixSDHighCapacityOverflowPkts.setDescription('The number of times the associated alMatrixSDPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alMatrixSDHighCapacityPkts.setDescription('The number of good packets of this protocol type\n        transmitted from the source address to the destination address\n        since this entry was added to the alMatrixSDHighCapacityTable.\n        Note that this is the number of link-layer packets, so if a\n        single network-layer packet is fragmented into several\n        link-layer frames, this counter is incremented several times.')
...
if mibBuilder.loadTexts:
    alMatrixSDHighCapacityOverflowOctets.setDescription('The number of times the associated alMatrixSDOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alMatrixSDHighCapacityOctets.setDescription("The number of octets in good packets of this protocol type\n        transmitted from the source address to the destination address\n        since this entry was added to the alMatrixSDHighCapacityTable\n        (excluding framing bits but including FCS octets).\n\n        Note this doesn't count just those octets in the particular\n        protocol frames, but includes the entire packet that contained\n        the protocol.")
alMatrixDSHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 17, 6))
if mibBuilder.loadTexts:
    alMatrixDSHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        alMatrixDSTable.')
...
if mibBuilder.loadTexts:
    alMatrixDSHighCapacityOverflowPkts.setDescription('The number of times the associated alMatrixDSPkts\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alMatrixDSHighCapacityPkts.setDescription('The number of good packets of this protocol type\n        transmitted from the source address to the destination address\n        since this entry was added to the alMatrixDSHighCapacityTable.\n        Note that this is the number of link-layer packets, so if a\n        single network-layer packet is fragmented into several\n        link-layer frames, this counter is incremented several times.')
...
if mibBuilder.loadTexts:
    alMatrixDSHighCapacityOverflowOctets.setDescription('The number of times the associated alMatrixDSOctets\n        counter has overflowed.')
...
if mibBuilder.loadTexts:
    alMatrixDSHighCapacityOctets.setDescription("The number of octets in good packets of this protocol type\n        transmitted from the source address to the destination address\n        since this entry was added to the alMatrixDSHighCapacityTable\n        (excluding framing bits but including FCS octets).\n\n        Note this doesn't count just those octets in the particular\n        protocol frames, but includes the entire packet that contained\n        the protocol.")
alMatrixTopNHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 17, 7))
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        alMatrixTopNTable when alMatrixTopNControlRateBase specifies\n        a High Capacity TopN Report.')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityProtocolDirLocalIndex.setDescription("The protocolDirLocalIndex of the network layer protocol of\n        this entry's network address.")
alMatrixTopNHighCapacitySourceAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 17, 7, 1, 2), OctetString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacitySourceAddress.setDescription('The network layer address of the source host in this\n        conversation.\n\n        This is represented as an octet string with\n        specific semantics and length as identified\n        by the associated alMatrixTopNProtocolDirLocalIndex.\n\n        For example, if the alMatrixTopNProtocolDirLocalIndex\n        indicates an encapsulation of ip, this object is encoded as a\n        length octet of 4, followed by the 4 octets of the ip address,\n        in network byte order.')
alMatrixTopNHighCapacityDestAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 17, 7, 1, 3), OctetString()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityDestAddress.setDescription('The network layer address of the destination host in this\n        conversation.\n\n        This is represented as an octet string with\n        specific semantics and length as identified\n        by the associated alMatrixTopNProtocolDirLocalIndex.\n\n        For example, if the alMatrixTopNProtocolDirLocalIndex\n        indicates an encapsulation of ip, this object is encoded as a\n        length octet of 4, followed by the 4 octets of the ip address,\n        in network byte order.')
alMatrixTopNHighCapacityAppProtocolDirLocalIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 17, 7, 1, 4), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityAppProtocolDirLocalIndex.setDescription('The type of the protocol counted by this entry.')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityOverflowPktRate.setDescription('The number of packets seen of this protocol from the source\n        host to the destination host during this sampling interval,\n        divided by 2^32, truncating fractions (i.e., X DIV 2^32),\n        and counted using the rules for counting the\n        alMatrixSDPkts object.')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityReverseBasePktRate.setDescription('The number of packets seen of this protocol from the\n        destination host to the source host during this sampling\n        interval, modulo 2^32, counted using the rules for counting\n        the alMatrixSDPkts object (note that the corresponding\n        alMatrixSDPkts object selected is the one whose source address\n        is equal to alMatrixTopNDestAddress and whose destination\n        address is equal to alMatrixTopNSourceAddress.)')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityReversePktRate.setDescription('The number of packets seen of this protocol from the\n        destination host to the source host during this sampling\n        interval, counted using the rules for counting the\n        alMatrixSDPkts object (note that the corresponding\n        alMatrixSDPkts object selected is the one whose source address\n        is equal to alMatrixTopNDestAddress and whose destination\n        address is equal to alMatrixTopNSourceAddress.)')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityBaseOctetRate.setDescription('The number of octets seen of this protocol from the source host\n        to the destination host during this sampling interval,\n        modulo 2^32, counted using the rules for counting the\n        alMatrixSDOctets object.')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityOverflowOctetRate.setDescription('The number of octets seen of this protocol from the source host\n        to the destination host during this sampling interval,\n        divided by 2^32, truncating fractions (i.e., X DIV 2^32),\n        and counted using the rules for counting the\n        alMatrixSDOctets object.')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityReverseOctetRate.setDescription('The number of octets seen of this protocol from the\n        destination host to the source host during this sampling\n\n        interval, counted using the rules for counting the\n        alMatrixSDOctets object (note that the corresponding\n        alMatrixSDOctets object selected is the one whose source\n        address is equal to alMatrixTopNDestAddress and whose\n        destination address is equal to alMatrixTopNSourceAddress.)')
usrHistoryHighCapacityTable = MibTable((1, 3, 6, 1, 2, 1, 16, 18, 4))
if mibBuilder.loadTexts:
    usrHistoryHighCapacityTable.setDescription('Contains the High Capacity RMON extensions to the RMON-2\n        usrHistoryTable.')
...
if mibBuilder.loadTexts:
    hcRMONCapabilities.setDescription('An indication of the High Capacity RMON MIB groups supported\n        on at least one interface by this probe.')
...
if mibBuilder.loadTexts:
    hcMediaIndependentCompliance.setDescription('Describes the requirements for conformance to the\n        High Capacity Media Independent Group.')
...
if mibBuilder.loadTexts:
    hcRmon1MIBCompliance.setDescription('Describes the requirements for conformance to the High\n        Capacity RMON-1 MIB')
...
if mibBuilder.loadTexts:
    hcRmon2MIBCompliance.setDescription('Describes the requirements for conformance to\n        the High Capacity RMON-2 MIB')
...
if mibBuilder.loadTexts:
    hcRmon2MIBApplicationLayerCompliance.setDescription('Describes the requirements for conformance to\n        the High Capacity RMON-2 MIB with Application Layer\n        Enhancements.')
...
if mibBuilder.loadTexts:
    mediaIndependentGroup.setDescription('Collects utilization statistics for any type of network.')
...
if mibBuilder.loadTexts:
    etherStatsHighCapacityGroup.setDescription('Collects utilization statistics for ethernet networks.')
...
if mibBuilder.loadTexts:
    etherHistoryHighCapacityGroup.setDescription('Collects utilization statistics for ethernet networks.')
...
if mibBuilder.loadTexts:
    hostHighCapacityGroup.setDescription('Collects utilization and error statistics per host.')
...
if mibBuilder.loadTexts:
    hostTopNHighCapacityGroup.setDescription('Prepares sorted reports of utilization and error statistics\n        per host.')
...
if mibBuilder.loadTexts:
    matrixHighCapacityGroup.setDescription('Collects utilization statistics per conversation.')
...
if mibBuilder.loadTexts:
    captureBufferHighCapacityGroup.setDescription('Provides finer granularity time stamps.')
...
if mibBuilder.loadTexts:
    protocolDistributionHighCapacityGroup.setDescription('Collects the relative amounts of octets and packets for the\n        different protocols detected on a network segment.')
...
if mibBuilder.loadTexts:
    nlHostHighCapacityGroup.setDescription('Counts the amount of traffic sent from and to each network\n        address discovered by the probe.')
...
if mibBuilder.loadTexts:
    nlMatrixHighCapacityGroup.setDescription('Counts the amount of traffic sent between each pair of\n        network addresses discovered by the probe.')
...
if mibBuilder.loadTexts:
    nlMatrixTopNHighCapacityGroup.setDescription('Prepares sorted reports of the amount of traffic sent between\n        each pair of network addresses discovered by the probe.')
...
if mibBuilder.loadTexts:
    alHostHighCapacityGroup.setDescription('Counts the amount of traffic, by protocol, sent from and to\n        each network address discovered by the probe.')
...
if mibBuilder.loadTexts:
    alMatrixHighCapacityGroup.setDescription('Counts the amount of traffic, by protocol, sent between each\n        pair of network addresses discovered by the\n        probe.')
...
if mibBuilder.loadTexts:
    alMatrixTopNHighCapacityGroup.setDescription('Prepares sorted reports of the amount of traffic per protocol\n        sent between each pair of network addresses discovered by the\n        probe.')
