...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/MPLS-L3VPN-STD-MIB.py
...
if mibBuilder.loadTexts:
    mplsL3VpnMIB.setLastUpdated('200601230000Z')
if mibBuilder.loadTexts:
    mplsL3VpnMIB.setOrganization('IETF Layer-3 Virtual Private\n                 Networks Working Group.')
if mibBuilder.loadTexts:
    mplsL3VpnMIB.setContactInfo('        Thomas D. Nadeau\n                   tnadeau@cisco.com\n\n                   Harmen van der Linde\n                   havander@cisco.com\n\n                   Comments and discussion to l3vpn@ietf.org')
if mibBuilder.loadTexts:
    mplsL3VpnMIB.setDescription('This MIB contains managed object definitions for the\n         Layer-3 Multiprotocol Label Switching Virtual\n         Private Networks.\n\n        Copyright (C) The Internet Society (2006).  This\n        version of this MIB module is part of RFC4382; see\n        the RFC itself for full legal notices.')
...
if mibBuilder.loadTexts:
    mplsL3VpnIfVpnRouteDistProtocol.setDescription('Denotes the route distribution protocol across the\n        PE-CE link.  Note that more than one routing protocol\n        may be enabled at the same time; thus, this object is\n        specified as a bitmask.  For example, static(5) and\n        ospf(2) are a typical configuration.')
mplsL3VpnIfConfStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 1,
                                             1, 4), StorageType().clone('volatile')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnIfConfStorageType.setDescription("The storage type for this VPN If entry.\n        Conceptual rows having the value 'permanent'\n        need not allow write access to any columnar\n        objects in the row.")
mplsL3VpnIfConfRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 1,
                                           1, 5), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnIfConfRowStatus.setDescription('This variable is used to create, modify, and/or\n        delete a row in this table.  Rows in this\n        table signify that the specified interface is\n        associated with this VRF.  If the row creation\n        operation succeeds, the interface will have been\n        associated with the specified VRF, otherwise the\n        agent MUST not allow the association.  If the agent\n        only allows read-only operations on this table, it\n        MUST create entries in this table as they are created\n        on the device.  When a row in this table is in\n        active(1) state, no objects in that row can be\n        modified except mplsL3VpnIfConfStorageType and\n        mplsL3VpnIfConfRowStatus.')
mplsL3VpnVrfTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2))
if mibBuilder.loadTexts:
    mplsL3VpnVrfTable.setDescription('This table specifies per-interface MPLS L3VPN\n        VRF Table capability and associated information.\n        Entries in this table define VRF routing instances\n        associated with MPLS/VPN interfaces.  Note that\n        multiple interfaces can belong to the same VRF\n        instance.  The collection of all VRF instances\n        comprises an actual VPN.')
mplsL3VpnVrfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2, 1)).setIndexNames((0,
                                                                                            'MPLS-L3VPN-STD-MIB',
                                                                                            'mplsL3VpnVrfName'))
if mibBuilder.loadTexts:
    mplsL3VpnVrfEntry.setDescription('An entry in this table is created by an LSR for\n        every VRF capable of supporting MPLS L3VPN.  The\n        indexing provides an ordering of VRFs per-VPN\n        interface.')
mplsL3VpnVrfName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2, 1, 1), MplsL3VpnName())
if mibBuilder.loadTexts:
    mplsL3VpnVrfName.setDescription('The human-readable name of this VPN.  This MAY\n        be equivalent to the [RFC2685] VPN-ID, but may\n        also vary.  If it is set to the VPN ID, it MUST\n        be equivalent to the value of mplsL3VpnVrfVpnId.\n        It is strongly recommended that all sites supporting\n        VRFs that are part of the same VPN use the same\n        naming convention for VRFs as well as the same VPN\n        ID.')
mplsL3VpnVrfVpnId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2, 1, 2), VPNIdOrZero()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfVpnId.setDescription('The VPN ID as specified in [RFC2685].  If a VPN ID\n        has not been specified for this VRF, then this\n        variable SHOULD be set to a zero-length OCTET\n        STRING.')
mplsL3VpnVrfDescription = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2, 1,
                                          3), SnmpAdminString()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfDescription.setDescription('The human-readable description of this VRF.')
mplsL3VpnVrfRD = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2, 1, 4), MplsL3VpnRouteDistinguisher()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRD.setDescription('The route distinguisher for this VRF.')
mplsL3VpnVrfCreationTime = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2,
                                           1, 5), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfCreationTime.setDescription('The time at which this VRF entry was created.')
mplsL3VpnVrfOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2, 1,
                                         6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('up',
                                                                                                                                                           1), ('down',
                                                                                                                                                                2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfOperStatus.setDescription('Denotes whether or not a VRF is operational.  A VRF is\n        up(1) when there is at least one interface associated\n        with the VRF whose ifOperStatus is up(1).  A VRF is\n        down(2) when:\n        a. There does not exist at least one interface whose\n           ifOperStatus is up(1).\n        b. There are no interfaces associated with the VRF.')
mplsL3VpnVrfActiveInterfaces = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2,
                                               2, 1, 7), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfActiveInterfaces.setDescription('Total number of interfaces connected to this VRF with\n        ifOperStatus = up(1).\n\n        This value should increase when an interface is associated\n        with the corresponding VRF and its corresponding ifOperStatus\n        is equal to up(1).  If an interface is associated whose\n        ifOperStatus is not up(1), then the value is not incremented\n        until such time as it transitions to this state.\n\n        This value should be decremented when an interface is\n        disassociated with a VRF or the corresponding ifOperStatus\n        transitions out of the up(1) state to any other state.\n       ')
mplsL3VpnVrfAssociatedInterfaces = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                   2, 2, 1, 8), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfAssociatedInterfaces.setDescription('Total number of interfaces connected to this VRF\n        (independent of ifOperStatus type).')
mplsL3VpnVrfConfMidRteThresh = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2,
                                               2, 1, 9), Unsigned32()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfMidRteThresh.setDescription('Denotes mid-level water marker for the number\n      of routes that this VRF may hold.')
mplsL3VpnVrfConfHighRteThresh = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2,
                                                2, 1, 10), Unsigned32()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfHighRteThresh.setDescription('Denotes high-level water marker for the number of\n      routes that this VRF may hold.')
mplsL3VpnVrfConfMaxRoutes = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2,
                                            1, 11), Unsigned32()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfMaxRoutes.setDescription('Denotes maximum number of routes that this VRF is\n      configured to hold.  This value MUST be less than or\n      equal to mplsL3VpnVrfConfMaxPossRts unless it is set\n      to 0.')
mplsL3VpnVrfConfLastChanged = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2,
                                              2, 1, 12), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfLastChanged.setDescription('The value of sysUpTime at the time of the last\n      change of this table entry, which includes changes of\n      VRF parameters defined in this table or addition or\n      deletion of interfaces associated with this VRF.')
mplsL3VpnVrfConfRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 2,
                                            1, 13), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfRowStatus.setDescription('This variable is used to create, modify, and/or\n        delete a row in this table.\n        When a row in this table is in active(1) state, no\n        objects in that row can be modified except\n        mplsL3VpnVrfConfAdminStatus, mplsL3VpnVrfConfRowStatus,\n        and mplsL3VpnVrfConfStorageType.')
mplsL3VpnVrfConfAdminStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2,
                                              2, 1, 14), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('up',
                                                                                                                                                                          1), ('down',
                                                                                                                                                                               2), ('testing',
                                                                                                                                                                                    3)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfAdminStatus.setDescription('Indicates the desired operational status of this\n         VRF.')
mplsL3VpnVrfConfStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2,
                                              2, 1, 15), StorageType().clone('volatile')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfConfStorageType.setDescription("The storage type for this VPN VRF entry.\n         Conceptual rows having the value 'permanent'\n         need not allow write access to any columnar\n         objects in the row.")
mplsL3VpnVrfRTTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3))
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTTable.setDescription('This table specifies per-VRF route target association.\n         Each entry identifies a connectivity policy supported\n         as part of a VPN.')
mplsL3VpnVrfRTEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3, 1)).setIndexNames((0,
                                                                                              'MPLS-L3VPN-STD-MIB',
                                                                                              'mplsL3VpnVrfName'), (0,
                                                                                                                    'MPLS-L3VPN-STD-MIB',
                                                                                                                    'mplsL3VpnVrfRTIndex'), (0,
                                                                                                                                             'MPLS-L3VPN-STD-MIB',
                                                                                                                                             'mplsL3VpnVrfRTType'))
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTEntry.setDescription('An entry in this table is created by an LSR for\n        each route target configured for a VRF supporting\n        a MPLS L3VPN instance.  The indexing provides an\n        ordering per-VRF instance.  See [RFC4364] for a\n        complete definition of a route target.')
...
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTIndex.setDescription('Auxiliary index for route targets configured for a\n        particular VRF.')
mplsL3VpnVrfRTType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3, 1, 3), MplsL3VpnRtType())
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTType.setDescription('The route target distribution type.')
mplsL3VpnVrfRT = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3, 1, 4), MplsL3VpnRouteDistinguisher()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRT.setDescription('The route target distribution policy.')
mplsL3VpnVrfRTDescr = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3, 1, 5), SnmpAdminString()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTDescr.setDescription('Description of the route target.')
mplsL3VpnVrfRTRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3, 1,
                                          6), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTRowStatus.setDescription('This variable is used to create, modify, and/or\n        delete a row in this table.  When a row in this\n        table is in active(1) state, no objects in that row\n        can be modified except mplsL3VpnVrfRTRowStatus.')
mplsL3VpnVrfRTStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 3,
                                            1, 7), StorageType().clone('volatile')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTStorageType.setDescription("The storage type for this VPN route target (RT) entry.\n         Conceptual rows having the value 'permanent'\n         need not allow write access to any columnar\n         objects in the row.")
mplsL3VpnVrfSecTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 2, 6))
if mibBuilder.loadTexts:
    mplsL3VpnVrfSecTable.setDescription('This table specifies per MPLS L3VPN VRF Table\n        security-related counters.')
...
if mibBuilder.loadTexts:
    mplsL3VpnVrfSecEntry.setDescription('An entry in this table is created by an LSR for\n        every VRF capable of supporting MPLS L3VPN.  Each\n        entry in this table is used to indicate security-related\n        information for each VRF entry.')
mplsL3VpnVrfSecIllegalLblVltns = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 2, 6, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfSecIllegalLblVltns.setDescription('Indicates the number of illegally received\n        labels on this VPN/VRF.\n\n        Discontinuities in the value of this counter can occur\n        at re-initialization of the management system, and at\n        other times as indicated by the value of\n        mplsL3VpnVrfSecDiscontinuityTime.')
mplsL3VpnVrfSecDiscontinuityTime = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                   2, 6, 1, 2), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfSecDiscontinuityTime.setDescription("The value of sysUpTime on the most recent occasion at\n        which any one or more of this entry's counters suffered\n        a discontinuity.  If no such discontinuities have\n        occurred since the last re-initialization of the local\n        management subsystem, then this object contains a zero\n        value.")
mplsL3VpnVrfPerfTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 3, 1))
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfTable.setDescription('This table specifies per MPLS L3VPN VRF Table performance\n        information.')
...
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfEntry.setDescription('An entry in this table is created by an LSR for\n        every VRF capable of supporting MPLS L3VPN.')
mplsL3VpnVrfPerfRoutesAdded = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 3,
                                              1, 1, 1), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfRoutesAdded.setDescription('Indicates the number of routes added to this VPN/VRF\n        since the last discontinuity.  Discontinuities in\n        the value of this counter can occur\n        at re-initialization of the management system, and at\n        other times as indicated by the value of\n        mplsL3VpnVrfPerfDiscTime.')
mplsL3VpnVrfPerfRoutesDeleted = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 3,
                                                1, 1, 2), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfRoutesDeleted.setDescription('Indicates the number of routes removed from this VPN/VRF.\n\n        Discontinuities in the value of this counter can occur\n        at re-initialization of the management system, and at\n        other times as indicated by the value of\n        mplsL3VpnVrfPerfDiscTime.')
mplsL3VpnVrfPerfCurrNumRoutes = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 3,
                                                1, 1, 3), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfCurrNumRoutes.setDescription('Indicates the number of routes currently used by this\n        VRF.')
mplsL3VpnVrfPerfRoutesDropped = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 3,
                                                1, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfRoutesDropped.setDescription('This counter should be incremented when the number of routes\n        contained by the specified VRF exceeds or attempts to exceed\n        the maximum allowed value as indicated by\n        mplsL3VpnVrfMaxRouteThreshold.\n\n        Discontinuities in the value of this counter can occur\n        at re-initialization of the management system, and at\n        other times as indicated by the value of\n        mplsL3VpnVrfPerfDiscTime.')
mplsL3VpnVrfPerfDiscTime = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 3, 1,
                                           1, 5), TimeStamp()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfPerfDiscTime.setDescription("The value of sysUpTime on the most recent occasion at\n        which any one or more of this entry's counters suffered\n        a discontinuity.  If no such discontinuities have\n        occurred since the last re-initialization of the local\n        management subsystem, then this object contains a zero\n        value.")
mplsL3VpnVrfRteTable = MibTable((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4, 1))
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteTable.setDescription('This table specifies per-interface MPLS L3VPN VRF Table\n        routing information.  Entries in this table define VRF routing\n        entries associated with the specified MPLS/VPN interfaces.  Note\n        that this table contains both BGP and Interior Gateway Protocol\n        IGP routes, as both may appear in the same VRF.')
mplsL3VpnVrfRteEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4, 1, 1)).setIndexNames((0,
                                                                                               'MPLS-L3VPN-STD-MIB',
                                                                                               'mplsL3VpnVrfName'), (0,
                                                                                                                     'MPLS-L3VPN-STD-MIB',
                                                                                                                     'mplsL3VpnVrfRteInetCidrDestType'), (0,
                                                                                                                                                          'MPLS-L3VPN-STD-MIB',
                                                                                                                                                          'mplsL3VpnVrfRteInetCidrDest'), (0,
                                                                                                                                                                                           'MPLS-L3VPN-STD-MIB',
                                                                                                                                                                                           'mplsL3VpnVrfRteInetCidrPfxLen'), (0,
                                                                                                                                                                                                                              'MPLS-L3VPN-STD-MIB',
                                                                                                                                                                                                                              'mplsL3VpnVrfRteInetCidrPolicy'), (0,
                                                                                                                                                                                                                                                                 'MPLS-L3VPN-STD-MIB',
                                                                                                                                                                                                                                                                 'mplsL3VpnVrfRteInetCidrNHopType'), (0,
                                                                                                                                                                                                                                                                                                      'MPLS-L3VPN-STD-MIB',
                                                                                                                                                                                                                                                                                                      'mplsL3VpnVrfRteInetCidrNextHop'))
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteEntry.setDescription('An entry in this table is created by an LSR for every route\n        present configured (either dynamically or statically) within\n        the context of a specific VRF capable of supporting MPLS/BGP\n        VPN.  The indexing provides an ordering of VRFs per-VPN\n        interface.\n\n        Implementers need to be aware that there are quite a few\n        index objects that together can exceed the size allowed\n        for an Object Identifier (OID).  So implementers must make\n        sure that OIDs of column instances in this table will have\n        no more than 128 sub-identifiers, otherwise they cannot be\n        accessed using SNMPv1, SNMPv2c, or SNMPv3.')
mplsL3VpnVrfRteInetCidrDestType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                  4, 1, 1, 1), InetAddressType())
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrDestType.setDescription('The type of the mplsL3VpnVrfRteInetCidrDest address, as\n                defined in the InetAddress MIB.\n\n                Only those address types that may appear in an actual\n                routing table are allowed as values of this object.')
mplsL3VpnVrfRteInetCidrDest = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4,
                                              1, 1, 2), InetAddress())
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrDest.setDescription('The destination IP address of this route.\n\n                The type of this address is determined by the value of\n                the mplsL3VpnVrfRteInetCidrDestType object.\n\n                The values for the index objects\n                mplsL3VpnVrfRteInetCidrDest and\n                mplsL3VpnVrfRteInetCidrPfxLen must be consistent.  When\n                the value of mplsL3VpnVrfRteInetCidrDest is x, then\n                the bitwise logical-AND of x with the value of the mask\n                formed from the corresponding index object\n                mplsL3VpnVrfRteInetCidrPfxLen MUST be\n                equal to x.  If not, then the index pair is not\n                consistent and an inconsistentName error must be\n                returned on SET or CREATE requests.')
mplsL3VpnVrfRteInetCidrPfxLen = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4,
                                                1, 1, 3), InetAddressPrefixLength().subtype(subtypeSpec=ValueRangeConstraint(0, 128)))
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrPfxLen.setDescription('Indicates the number of leading one bits that form the\n                mask to be logical-ANDed with the destination address\n                before being compared to the value in the\n                mplsL3VpnVrfRteInetCidrDest field.\n\n                The values for the index objects\n                mplsL3VpnVrfRteInetCidrDest and\n                mplsL3VpnVrfRteInetCidrPfxLen must be consistent.  When\n                the value of mplsL3VpnVrfRteInetCidrDest is x, then the\n                bitwise logical-AND of x with the value of the mask\n                formed from the corresponding index object\n                mplsL3VpnVrfRteInetCidrPfxLen MUST be\n                equal to x.  If not, then the index pair is not\n                consistent and an inconsistentName error must be\n                returned on SET or CREATE requests.')
mplsL3VpnVrfRteInetCidrPolicy = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4,
                                                1, 1, 4), ObjectIdentifier())
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrPolicy.setDescription('This object is an opaque object without any defined\n                semantics.  Its purpose is to serve as an additional\n                index that may delineate between multiple entries to\n                the same destination.  The value { 0 0 } shall be used\n                as the default value for this object.')
mplsL3VpnVrfRteInetCidrNHopType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                  4, 1, 1, 5), InetAddressType())
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrNHopType.setDescription('The type of the mplsL3VpnVrfRteInetCidrNextHop address,\n                as defined in the InetAddress MIB.\n\n                Value should be set to unknown(0) for non-remote\n                routes.\n\n                Only those address types that may appear in an actual\n                routing table are allowed as values of this object.')
mplsL3VpnVrfRteInetCidrNextHop = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 6), InetAddress())
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrNextHop.setDescription('On remote routes, the address of the next system en\n                route.  For non-remote routes, a zero-length string.\n                The type of this address is determined by the value of\n                the mplsL3VpnVrfRteInetCidrNHopType object.')
mplsL3VpnVrfRteInetCidrIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 7), InterfaceIndexOrZero()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrIfIndex.setDescription('The ifIndex value that identifies the local interface\n                through which the next hop of this route should be\n                reached.  A value of 0 is valid and represents the\n                scenario where no interface is specified.')
mplsL3VpnVrfRteInetCidrType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4,
                                              1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(('other',
                                                                                                                                                                               1), ('reject',
                                                                                                                                                                                    2), ('local',
                                                                                                                                                                                         3), ('remote',
                                                                                                                                                                                              4), ('blackhole',
                                                                                                                                                                                                   5))).clone('other')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrType.setDescription('The type of route.  Note that local(3) refers to a\n                route for which the next hop is the final destination;\n                remote(4) refers to a route for which the next hop is\n                not the final destination.\n\n                Routes that do not result in traffic forwarding or\n                rejection should not be displayed even if the\n                implementation keeps them stored internally.\n\n                reject(2) refers to a route that, if matched, discards\n                the message as unreachable and returns a notification\n                (e.g., ICMP error) to the message sender.  This is used\n                in some protocols as a means of correctly aggregating\n                routes.\n\n                blackhole(5) refers to a route that, if matched,\n                discards the message silently.')
mplsL3VpnVrfRteInetCidrProto = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4,
                                               1, 1, 9), IANAipRouteProtocol()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrProto.setDescription('The routing mechanism via which this route was learned.\n                Inclusion of values for gateway routing protocols is\n                not intended to imply that hosts should support those\n                protocols.')
mplsL3VpnVrfRteInetCidrAge = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4, 1,
                                             1, 10), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrAge.setDescription("The number of seconds since this route was last updated\n                or otherwise determined to be correct.  Note that no\n                semantics of 'too old' can be implied except through\n                knowledge of the routing protocol by which the route\n                was learned.")
mplsL3VpnVrfRteInetCidrNextHopAS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                   4, 1, 1, 11), InetAutonomousSystemNumber()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrNextHopAS.setDescription("The Autonomous System Number of the next hop.  The\n                semantics of this object are determined by the\n                routing protocol specified in the route's\n                mplsL3VpnVrfRteInetCidrProto value.  When this\n                object is unknown or not relevant, its value should\n                be set to zero.")
mplsL3VpnVrfRteInetCidrMetric1 = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 12), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(-1, -1), ValueRangeConstraint(0, 2147483647))).clone(-1)).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrMetric1.setDescription("The primary routing metric for this route.  The\n                semantics of this metric are determined by the\n                routing protocol specified in the route's\n                mplsL3VpnVrfRteInetCidrProto value.  If this\n                metric is not used, its value should be set to\n                -1.")
mplsL3VpnVrfRteInetCidrMetric2 = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 13), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(-1, -1), ValueRangeConstraint(0, 2147483647))).clone(-1)).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrMetric2.setDescription("An alternate routing metric for this route.  The\n                semantics of this metric are determined by the routing\n                protocol specified in the route's\n                mplsL3VpnVrfRteInetCidrProto\n                value.  If this metric is not used, its value should be\n                set to -1.")
mplsL3VpnVrfRteInetCidrMetric3 = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 14), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(-1, -1), ValueRangeConstraint(0, 2147483647))).clone(-1)).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrMetric3.setDescription("An alternate routing metric for this route.  The\n                semantics of this metric are determined by the routing\n                protocol specified in the route's\n                mplsL3VpnVrfRteInetCidrProto\n                value.  If this metric is not used, its value should be\n                set to -1.")
mplsL3VpnVrfRteInetCidrMetric4 = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 15), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(-1, -1), ValueRangeConstraint(0, 2147483647))).clone(-1)).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrMetric4.setDescription("An alternate routing metric for this route.  The\n                semantics of this metric are determined by the routing\n                protocol specified in the route's\n                mplsL3VpnVrfRteInetCidrProto value.  If this metric\n                is not used, its value should be set to -1.")
mplsL3VpnVrfRteInetCidrMetric5 = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1,
                                                 4, 1, 1, 16), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(-1, -1), ValueRangeConstraint(0, 2147483647))).clone(-1)).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrMetric5.setDescription("An alternate routing metric for this route.  The\n                semantics of this metric are determined by the routing\n                protocol specified in the route's\n                mplsL3VpnVrfRteInetCidrProto value.  If this metric is\n                not used, its value should be set to -1.")
mplsL3VpnVrfRteXCPointer = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4, 1,
                                           1, 17), MplsIndexType()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteXCPointer.setDescription('Index into mplsXCTable that identifies which cross-\n        connect entry is associated with this VRF route entry\n        by containing the mplsXCIndex of that cross-connect entry.\n        The string containing the single-octet 0x00 indicates that\n        a label stack is not associated with this route entry.  This\n        can be the case because the label bindings have not yet\n        been established, or because some change in the agent has\n        removed them.\n\n        When the label stack associated with this VRF route is created,\n        it MUST establish the associated cross-connect\n        entry in the mplsXCTable and then set that index to the value\n        of this object.  Changes to the cross-connect object in the\n        mplsXCTable MUST automatically be reflected in the value of\n        this object.  If this object represents a static routing entry,\n        then the manager must ensure that this entry is maintained\n        consistently in the corresponding mplsXCTable as well.')
mplsL3VpnVrfRteInetCidrStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 11, 1, 4,
                                                1, 1, 18), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteInetCidrStatus.setDescription('The row status variable, used according to row\n                installation and removal conventions.\n                A row entry cannot be modified when the status is\n                marked as active(1).')
...
if mibBuilder.loadTexts:
    mplsL3VpnModuleFullCompliance.setDescription('Compliance statement for agents that provide full support\n           for the MPLS-L3VPN-STD-MIB')
mplsL3VpnModuleReadOnlyCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 10, 166, 11,
                                                      2, 2, 2)).setObjects(*(('MPLS-L3VPN-STD-MIB', 'mplsL3VpnScalarGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnIfGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnPerfGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfRteGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfRTGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnSecGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnNotificationGroup'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnPerfRouteGroup')))
if mibBuilder.loadTexts:
    mplsL3VpnModuleReadOnlyCompliance.setDescription('Compliance requirement for implementations that only\n                   provide read-only support for MPLS-L3VPN-STD-MIB.\n                   Such devices can then be monitored but cannot be\n                   configured using this MIB module.')
...
if mibBuilder.loadTexts:
    mplsL3VpnScalarGroup.setDescription('Collection of scalar objects required for MPLS VPN\n              management.')
...
if mibBuilder.loadTexts:
    mplsL3VpnVrfGroup.setDescription('Collection of objects needed for MPLS VPN VRF\n              management.')
...
if mibBuilder.loadTexts:
    mplsL3VpnIfGroup.setDescription('Collection of objects needed for MPLS VPN interface\n              management.')
...
if mibBuilder.loadTexts:
    mplsL3VpnPerfGroup.setDescription('Collection of objects needed for MPLS VPN\n              performance information.')
...
if mibBuilder.loadTexts:
    mplsL3VpnPerfRouteGroup.setDescription('Collection of objects needed to track MPLS VPN\n              routing table dropped routes.')
...
if mibBuilder.loadTexts:
    mplsL3VpnSecGroup.setDescription('Collection of objects needed for MPLS VPN\n              security-related information.')
...
if mibBuilder.loadTexts:
    mplsL3VpnVrfRteGroup.setDescription('Objects required for VRF route table management.')
...
if mibBuilder.loadTexts:
    mplsL3VpnVrfRTGroup.setDescription('Objects required for VRF route target management.')
mplsL3VpnNotificationGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 10, 166, 11, 2, 1,
                                                10)).setObjects(*(('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfUp'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfDown'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfRouteMidThreshExceeded'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnVrfNumVrfRouteMaxThreshExceeded'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnNumVrfSecIllglLblThrshExcd'), ('MPLS-L3VPN-STD-MIB', 'mplsL3VpnNumVrfRouteMaxThreshCleared')))
if mibBuilder.loadTexts:
    mplsL3VpnNotificationGroup.setDescription('Objects required for MPLS VPN notifications.')
