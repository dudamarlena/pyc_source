...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ISDN-MIB.py
# Compiled at: 2016-02-13 18:19:03
...
if mibBuilder.loadTexts:
    isdnMib.setLastUpdated('9609231642Z')
if mibBuilder.loadTexts:
    isdnMib.setOrganization('IETF ISDN MIB Working Group')
if mibBuilder.loadTexts:
    isdnMib.setContactInfo('        Guenter Roeck\n             Postal: cisco Systems\n                     170 West Tasman Drive\n                     San Jose, CA 95134\n                     U.S.A.\n             Phone:  +1 408 527 3143\n             E-mail: groeck@cisco.com')
if mibBuilder.loadTexts:
    isdnMib.setDescription('The MIB module to describe the\n             management of ISDN interfaces.')
...
class IsdnSignalingProtocol(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('dss1', 2), ('etsi', 3), ('dass2', 4), ('ess4',
                                                                                     5), ('ess5',
                                                                                          6), ('dms100',
                                                                                               7), ('dms250',
                                                                                                    8), ('ni1',
...
if mibBuilder.loadTexts:
    isdnBasicRateTable.setDescription('Table containing configuration and operational\n             parameters for all physical Basic Rate\n             interfaces on this managed device.')
isdnBasicRateEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 20, 1, 1, 1, 1)).setIndexNames((0,
                                                                                        'IF-MIB',
                                                                                        'ifIndex'))
if mibBuilder.loadTexts:
    isdnBasicRateEntry.setDescription('An entry in the ISDN Basic Rate Table.')
isdnBasicRateIfType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 20, 1, 1, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(75, 76))).clone(namedValues=NamedValues(('isdns',
                                                                                                                                                                                                75), ('isdnu',
                                                                                                                                                                                                      76)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    isdnBasicRateIfType.setDescription("The physical interface type. For 'S/T' interfaces,\n             also called 'Four-wire Basic Access Interface',\n             the value of this object is isdns(75).\n             For 'U' interfaces, also called 'Two-wire Basic\n             Access Interface', the value of this object is\n             isdnu(76).")
isdnBasicRateLineTopology = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 20, 1, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('pointToPoint',
                                                                                                                                                                                                    1), ('pointToMultipoint',
                                                                                                                                                                                                         2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    isdnBasicRateLineTopology.setDescription('The line topology to be used for this interface.\n             Note that setting isdnBasicRateIfType to isdns(75)\n             does not necessarily mean a line topology of\n             point-to-multipoint.')
isdnBasicRateIfMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 20, 1, 1, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('te',
                                                                                                                                                                                              1), ('nt',
                                                                                                                                                                                                   2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    isdnBasicRateIfMode.setDescription('The physical interface mode. For TE mode, the value\n             of this object is te(1). For NT mode, the value\n             of this object is nt(2).')
isdnBasicRateSignalMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 20, 1, 1, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('active',
                                                                                                                                                                                                  1), ('inactive',
                                                                                                                                                                                                       2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    isdnBasicRateSignalMode.setDescription('The signaling channel operational mode for this interface.\n             If active(1) there is a signaling channel on this\n             interface. If inactive(2) a signaling channel is\n             not available.')
isdnBearerGroup = MibIdentifier((1, 3, 6, 1, 2, 1, 10, 20, 1, 2))
isdnBearerTable = MibTable((1, 3, 6, 1, 2, 1, 10, 20, 1, 2, 1))
if mibBuilder.loadTexts:
    isdnBearerTable.setDescription('This table defines port specific operational, statistics\n             and active call data for ISDN B channels. Each entry\n             in this table describes one B (bearer) channel.')
isdnBearerEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 20, 1, 2, 1, 1)).setIndexNames((0,
                                                                                     'IF-MIB',
                                                                                     'ifIndex'))
if mibBuilder.loadTexts:
    isdnBearerEntry.setDescription('Operational and statistics information relating to\n             one port. A port is a single B channel.')
isdnBearerChannelType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 20, 1, 2, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('dialup',
                                                                                                                                                                                                1), ('leased',
                                                                                                                                                                                                     2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    isdnBearerChannelType.setDescription('The B channel type. If the B channel is connected\n             to a dialup line, this object has a value of\n             dialup(1). In this case, it is controlled by\n             an associated signaling channel. If the B channel\n             is connected to a leased line, this object has\n             a value of leased(2). For leased line B channels, there\n             is no signaling channel control available.')
isdnBearerOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 20, 1, 2, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('idle',
                                                                                                                                                                                                     1), ('connecting',
                                                                                                                                                                                                          2), ('connected',
                                                                                                                                                                                                               3), ('active',
                                                                                                                                                                                                                    4)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    isdnBearerOperStatus.setDescription('The current call control state for this port.\n             idle(1):       The B channel is idle.\n                            No call or call attempt is going on.\n             connecting(2): A connection attempt (outgoing call)\n                            is being made on this interface.\n             connected(3):  An incoming call is in the process\n                            of validation.\n             active(4):     A call is active on this interface.')
...
if mibBuilder.loadTexts:
    isdnEndpointGetIndex.setDescription('The recommended procedure for selecting a new index for\n             isdnEndpointTable row creation is to GET the value of\n             this object, and then to SET the object with the same\n             value. If the SET operation succeeds, the manager can use\n             this value as an index to create a new row in this table.')
isdnEndpointTable = MibTable((1, 3, 6, 1, 2, 1, 10, 20, 1, 4, 2))
if mibBuilder.loadTexts:
    isdnEndpointTable.setDescription('Table containing configuration for Terminal\n             Endpoints.')
isdnEndpointEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 20, 1, 4, 2, 1)).setIndexNames((0,
                                                                                       'ISDN-MIB',
                                                                                       'isdnEndpointIndex'))
if mibBuilder.loadTexts:
    isdnEndpointEntry.setDescription('An entry in the Terminal Endpoint Table. The value\n             of isdnEndpointIfType must be supplied for a row\n             in this table to become active.')
...
if mibBuilder.loadTexts:
    isdnMibCompliance.setDescription('The compliance statement for entities which implement\n             the ISDN MIB.')
...
if mibBuilder.loadTexts:
    isdnMibBasicRateGroup.setDescription('A collection of objects required for ISDN Basic Rate\n             physical interface configuration and statistics.')
...
if mibBuilder.loadTexts:
    isdnMibBearerGroup.setDescription('A collection of objects required for ISDN Bearer channel\n             control and statistics.')
...
if mibBuilder.loadTexts:
    isdnMibSignalingGroup.setDescription('A collection of objects required for ISDN D channel\n             configuration and statistics.')
...
if mibBuilder.loadTexts:
    isdnMibEndpointGroup.setDescription('A collection of objects describing Terminal Endpoints.')
...
if mibBuilder.loadTexts:
    isdnMibDirectoryGroup.setDescription('A collection of objects describing directory numbers.')
