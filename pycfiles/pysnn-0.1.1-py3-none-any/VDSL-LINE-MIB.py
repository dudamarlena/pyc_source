...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/VDSL-LINE-MIB.py
# Compiled at: 2016-02-13 18:32:42
...
if mibBuilder.loadTexts:
    vdslPhysInvSerialNumber.setDescription('The vendor specific string that identifies the\n\n\n\n        vendor equipment.')
...
if mibBuilder.loadTexts:
    vdslPhysInvVendorID.setDescription('The vendor ID code is a copy of the binary vendor\n        identification field expressed as readable characters\n        in hexadecimal notation.')
...
if mibBuilder.loadTexts:
    vdslPhysCurrSnrMgn.setDescription('Noise Margin as seen by this Vtu with respect to its\n        received signal in 0.25dB.  The effective range is\n        -31.75 to +31.75 dB.')
...
if mibBuilder.loadTexts:
    vdslPerfDataValidIntervals.setDescription('Valid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
...
if mibBuilder.loadTexts:
    vdslPerfDataCurr15MinLofs.setDescription('Count of seconds during this interval that there\n        was Loss of Framing.')
...
if mibBuilder.loadTexts:
    vdslPerfDataCurr15MinLoss.setDescription('Count of seconds during this interval that there\n        was Loss of Signal.')
...
if mibBuilder.loadTexts:
    vdslPerfDataCurr15MinLprs.setDescription('Count of seconds during this interval that there\n        was Loss of Power.')
...
if mibBuilder.loadTexts:
    vdslPerfDataCurr15MinLols.setDescription('Count of seconds during this interval that there\n        was Loss of Link.')
...
if mibBuilder.loadTexts:
    vdslPerfDataCurr15MinInits.setDescription('Count of the line initialization attempts during this\n        interval.  This count includes both successful and\n        failed attempts.')
...
if mibBuilder.loadTexts:
    vdslPerfData1DayValidIntervals.setDescription('Valid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
...
if mibBuilder.loadTexts:
    vdslPerfData1DayInvalidIntervals.setDescription('Invalid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalNumber.setDescription('Performance Data Interval number 1 is the most recent\n        previous interval; interval 96 is 24 hours ago.\n        Intervals 2 to 96 are optional.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalLofs.setDescription('Count of seconds in the interval when there was Loss\n        of Framing.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalLoss.setDescription('Count of seconds in the interval when there was Loss\n        of Signal.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalLprs.setDescription('Count of seconds in the interval when there was Loss\n        of Power.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalLols.setDescription('Count of seconds in the interval when there was Loss\n        of Link.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalESs.setDescription('Count of Errored Seconds (ES) in the interval.  An Errored\n        Second is a one-second interval containing one or more CRC\n        anomalies, one or more LOS or LOF defects.')
...
if mibBuilder.loadTexts:
    vdslPerfIntervalInits.setDescription('Count of the line initialization attempts during this\n        interval.  This count includes both successful and\n        failed attempts.')
vdslPerf1DayIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 97, 1, 1, 6))
if mibBuilder.loadTexts:
    vdslPerf1DayIntervalTable.setDescription('This table provides one row for each VDSL performance\n        data collection interval.  This table contains live data\n        from equipment.  As such, it is NOT persistent.')
...
if mibBuilder.loadTexts:
    vdslPerf1DayIntervalNumber.setDescription('History Data Interval number.  Interval 1 is the most\n        recent previous day; interval 30 is 30 days ago.  Intervals\n        2 to 30 are optional.')
...
if mibBuilder.loadTexts:
    vdslChanValidIntervals.setDescription('Valid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
...
if mibBuilder.loadTexts:
    vdslChanInvalidIntervals.setDescription('Invalid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
...
if mibBuilder.loadTexts:
    vdslChanBadBlks.setDescription('Count of uncorrectable blocks since the unit was last\n        reset.')
...
if mibBuilder.loadTexts:
    vdslChan1DayValidIntervals.setDescription('Valid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
vdslChan1DayInvalidIntervals = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 97, 1, 1, 7, 1, 9), HCPerfInvalidIntervals()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    vdslChan1DayInvalidIntervals.setDescription('Invalid Intervals per definition found in\n        HC-PerfHist-TC-MIB.')
...
if mibBuilder.loadTexts:
    vdslChanCurr1DayTimeElapsed.setDescription('Number of seconds that have elapsed since the beginning\n         of the current 1-day interval.')
...
if mibBuilder.loadTexts:
    vdslChanCurr1DayFixedOctets.setDescription('Count of corrected octets since the beginning of the\n        current 1-day interval.')
...
if mibBuilder.loadTexts:
    vdslChanCurr1DayBadBlks.setDescription('Count of uncorrectable blocks since the beginning of the\n        current 1-day interval.')
vdslChanIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 97, 1, 1, 8))
if mibBuilder.loadTexts:
    vdslChanIntervalTable.setDescription('This table provides one row for each Vtu channel data\n        collection interval.  VDSL channel interfaces are those\n        ifEntries where ifType is equal to interleave(124) or\n        fast(125).')
...
if mibBuilder.loadTexts:
    vdslChanIntervalNumber.setDescription('Performance Data Interval number 1 is the most recent\n        previous interval; interval 96 is 24 hours ago.\n        Intervals 2 to 96 are optional.')
...
if mibBuilder.loadTexts:
    vdslChan1DayIntervalTable.setDescription('This table provides one row for each VDSL performance\n        data collection interval.  This table contains live data\n        from equipment.  As such, it is NOT persistent.')
...
if mibBuilder.loadTexts:
    vdslChan1DayIntervalNumber.setDescription('History Data Interval number.  Interval 1 is the most\n        recent previous day; interval 30 is 30 days ago.  Intervals\n        2 to 30 are optional.')
...
if mibBuilder.loadTexts:
    vdslChan1DayIntervalMoniSecs.setDescription('The amount of time in the 1-day interval over which the\n        performance monitoring information is actually counted.\n        This value will be the same as the interval duration except\n        in a situation where performance monitoring data could not\n        be collected for any reason.')
...
if mibBuilder.loadTexts:
    vdslLineConfProfileName.setDescription("This object identifies a row in this table.\n\n        A default profile with an index of 'DEFVAL', will\n        always exist and its parameters will be set to vendor\n        specific values, unless otherwise specified in this\n        document.")
...
if mibBuilder.loadTexts:
    vdslLineConfUpRateMode.setDescription('Specifies the rate selection behavior for the line\n        in the upstream direction.\n\n        manual(1)       forces the rate to the configured rate\n        adaptAtInit(2)  adapts the line based upon line quality.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownMaxPwr.setDescription('Specifies the maximum aggregate downstream power\n        level in the range 0 to 14.5 dBm.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpMaxPwr.setDescription('Specifies the maximum aggregate upstream power\n        level in the range 0 to 14.5 dBm.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownMaxSnrMgn.setDescription('Specifies the maximum downstream Signal/Noise Margin\n        in units of 0.25 dB, for a range of 0 to 31.75 dB.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownMinSnrMgn.setDescription('Specifies the minimum downstream Signal/Noise Margin\n        in units of 0.25 dB, for a range of 0 to 31.75 dB.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownTargetSnrMgn.setDescription('Specifies the target downstream Signal/Noise Margin\n        in units of 0.25 dB, for a range of 0 to 31.75 dB.\n        This is the Noise Margin the transceivers must achieve\n        with a BER of 10^-7 or better to successfully complete\n        initialization.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpMaxSnrMgn.setDescription('Specifies the maximum upstream Signal/Noise Margin\n        in units of 0.25 dB, for a range of 0 to 31.75 dB.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpMinSnrMgn.setDescription('Specifies the minimum upstream Signal/Noise Margin\n        in units of 0.25 dB, for a range of 0 to 31.75 dB.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownFastMaxDataRate.setDescription('Specifies the maximum downstream fast channel\n        data rate in steps of 1000 bits/second.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownFastMinDataRate.setDescription('Specifies the minimum downstream fast channel\n        data rate in steps of 1000 bits/second.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpFastMaxDataRate.setDescription('Specifies the maximum upstream fast channel\n        data rate in steps of 1000 bits/second.\n\n        The maximum aggregate upstream transmit speed\n        of the line can be derived from the sum of maximum\n        upstream fast and slow channel data rates.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpFastMinDataRate.setDescription('Specifies the minimum upstream fast channel\n        data rate in steps of 1000 bits/second.\n\n\n\n        The minimum aggregate upstream transmit speed\n        of the line can be derived from the sum of minimum\n        upstream fast and slow channel data rates.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpSlowMaxDataRate.setDescription('Specifies the maximum upstream slow channel\n        data rate in steps of 1000 bits/second.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpSlowMinDataRate.setDescription('Specifies the minimum upstream slow channel\n        data rate in steps of 1000 bits/second.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpRateRatio.setDescription('For dynamic rate adaptation at startup, the allocation\n        of data rate in excess of the minimum data rate for each\n        channel is controlled by the object.  This object specifies\n        the ratio of the allocation of the excess data rate between\n        the fast and the slow channels.  This allocation represents\n        upstream Fast Channel Allocation/Slow Channel Allocation.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownMaxInterDelay.setDescription('Specifies the maximum interleave delay for the\n        downstream slow channel.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpMaxInterDelay.setDescription('Specifies the maximum interleave delay for the\n        upstream slow channel.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpPboControl.setDescription('Upstream power backoff (PBO) control for this\n        line.  For transceivers which do not support upstream\n        PBO control, this object MUST be fixed at disabled(1).\n        If auto(2) is selected, the transceiver will automatically\n        adjust the power backoff.  If manual(3) is selected,\n        then the transceiver will use the value from\n        vdslLineConfUpPboLevel.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownPboLevel.setDescription('Specifies the downstream backoff level to be used\n        when vdslLineConfDownPboControl = manual(3).')
...
if mibBuilder.loadTexts:
    vdslLineConfUpPboLevel.setDescription('Specifies the upstream backoff level to be used\n        when vdslLineConfUpPboControl = manual(3).')
...
if mibBuilder.loadTexts:
    vdslLineConfBandPlanFx.setDescription('The frequency limit between bands D2 and U2 when\n        vdslLineConfBandPlan is set to bandPlanFx(3).')
...
if mibBuilder.loadTexts:
    vdslLineConfDownPsdTemplate.setDescription('The downstream PSD template to be used for the line.\n        Here, templateMask1(1) refers to a notched mask that\n        limits the transmitted PSD within the internationally\n        standardized HAM (Handheld Amateur Radio) radio bands,\n        while templateMask2(2) refers to an unnotched mask.\n\n        The masks themselves depend upon the applicable\n        standard being used (vdslLineConfApplicableStandard).')
...
if mibBuilder.loadTexts:
    vdslLineConfDownTargetSlowBurst.setDescription('Specifies the target level of impulse noise (burst)\n        protection for an interleaved (slow) channel.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpTargetSlowBurst.setDescription('Specifies the target level of impulse noise (burst)\n        protection for an interleaved (slow) channel.')
...
if mibBuilder.loadTexts:
    vdslLineConfDownMaxFastFec.setDescription('This parameter provisions the maximum level of Forward\n        Error Correction (FEC) redundancy related overhead to\n        be maintained for a fast channel.')
...
if mibBuilder.loadTexts:
    vdslLineConfUpMaxFastFec.setDescription('This parameter provisions the maximum level of Forward\n        Error Correction (FEC) redundancy related overhead to\n        be maintained for a fast channel.')
...
if mibBuilder.loadTexts:
    vdslLineAlarmConfProfileEntry.setDescription("Each entry consists of a list of parameters that\n        represents the configuration of a VDSL line alarm\n        profile.\n\n        A default profile with an index of 'DEFVAL', will\n        always exist and its parameters will be set to vendor\n        specific values, unless otherwise specified in this\n        document.")
...
if mibBuilder.loadTexts:
    vdslLineAlarmConfProfileName.setDescription('The name for this profile as specified by an\n        administrator.')
...
if mibBuilder.loadTexts:
    vdslPerfLofsThreshNotification.setDescription('Loss of Framing 15-minute interval threshold\n         (vdslLineAlarmConfThresh15MinLofs) reached.')
...
if mibBuilder.loadTexts:
    vdslPerfLossThreshNotification.setDescription('Loss of Signal 15-minute interval threshold\n        (vdslLineAlarmConfThresh15MinLoss) reached.')
...
if mibBuilder.loadTexts:
    vdslPerfLprsThreshNotification.setDescription('Loss of Power 15-minute interval threshold\n        (vdslLineAlarmConfThresh15MinLprs) reached.')
...
if mibBuilder.loadTexts:
    vdslPerfSESsThreshNotification.setDescription('Severely Errored Seconds 15-minute interval threshold\n        (vdslLineAlarmConfThresh15MinSESs) reached.')
...
if mibBuilder.loadTexts:
    vdslLineMibCompliance.setDescription('The compliance statement for SNMP entities which\n        manage VDSL interfaces.')
...
if mibBuilder.loadTexts:
    vdslGroup.setDescription('A collection of objects providing information about\n             a VDSL Line.')
...
if mibBuilder.loadTexts:
    vdslNotificationGroup.setDescription('This group supports notifications of significant\n             conditions associated with VDSL Lines.')
