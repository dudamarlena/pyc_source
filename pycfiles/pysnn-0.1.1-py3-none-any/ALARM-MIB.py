...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/ALARM-MIB.py
...
if mibBuilder.loadTexts:
    alarmMIB.setLastUpdated('200409090000Z')
if mibBuilder.loadTexts:
    alarmMIB.setOrganization('IETF Distributed Management Working Group')
if mibBuilder.loadTexts:
    alarmMIB.setContactInfo('WG EMail: disman@ietf.org\n           Subscribe: disman-request@ietf.org\n           http://www.ietf.org/html.charters/disman-charter.html\n\n\n\n           Chair:     Randy Presuhn\n                      randy_presuhn@mindspring.com\n\n           Editors:   Sharon Chisholm\n                      Nortel Networks\n                      PO Box 3511 Station C\n                      Ottawa, Ont.  K1Y 4H7\n                      Canada\n                      schishol@nortelnetworks.com\n\n                      Dan Romascanu\n                      Avaya\n                      Atidim Technology Park, Bldg. #3\n                      Tel Aviv, 61131\n                      Israel\n                      Tel: +972-3-645-8414\n                      Email: dromasca@avaya.com')
if mibBuilder.loadTexts:
    alarmMIB.setDescription('The MIB module describes a generic solution\n           to model alarms and to store the current list\n           of active alarms.\n\n           Copyright (C) The Internet Society (2004).  The\n           initial version of this MIB module was published\n           in RFC 3877.  For full legal notices see the RFC\n           itself.  Supplementary information may be available on:\n           http://www.ietf.org/copyrights/ianamib.html')
...
if mibBuilder.loadTexts:
    alarmModelEntry.setDescription('Entries appear in this table for each possible alarm state.\n       This table MUST be persistent across system reboots.')
...
if mibBuilder.loadTexts:
    alarmModelIndex.setDescription('An integer that acts as an alarm Id\n       to uniquely identify each alarm\n       within the named alarm list. ')
...
if mibBuilder.loadTexts:
    alarmActiveVariableValueType.setDescription('The type of the value.  One and only one of the value\n       objects that follow is used for a given row in this table,\n       based on this type.')
alarmActiveVariableCounter32Val = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 4), Counter32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableCounter32Val.setDescription("The value when alarmActiveVariableType is 'counter32'.")
alarmActiveVariableUnsigned32Val = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 5), Unsigned32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableUnsigned32Val.setDescription("The value when alarmActiveVariableType is 'unsigned32'.")
alarmActiveVariableTimeTicksVal = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 6), TimeTicks()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableTimeTicksVal.setDescription("The value when alarmActiveVariableType is 'timeTicks'.")
alarmActiveVariableInteger32Val = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 7), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableInteger32Val.setDescription("The value when alarmActiveVariableType is 'integer32'.")
...
if mibBuilder.loadTexts:
    alarmActiveVariableOctetStringVal.setDescription("The value when alarmActiveVariableType is 'octetString'.")
alarmActiveVariableIpAddressVal = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 9), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableIpAddressVal.setDescription("The value when alarmActiveVariableType is 'ipAddress'.")
alarmActiveVariableOidVal = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 10), ObjectIdentifier()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableOidVal.setDescription("The value when alarmActiveVariableType is 'objectId'.")
alarmActiveVariableCounter64Val = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 2, 3, 1, 11), Counter64()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmActiveVariableCounter64Val.setDescription("The value when alarmActiveVariableType is 'counter64'.")
...
if mibBuilder.loadTexts:
    alarmClearEntry.setDescription('Information on a cleared alarm.')
...
if mibBuilder.loadTexts:
    alarmClearContextName.setDescription("The name of the SNMP MIB context from which the alarm came.\n       For SNMPv1 traps this is the community string from the Trap.\n       Note that care needs to be taken when selecting community\n       strings to ensure that these can be represented as a\n       well-formed SnmpAdminString.  Community or Context names\n       that are not well-formed SnmpAdminStrings will be mapped\n       to zero length strings.\n\n       If the alarm's source SNMP engine is known not to support\n       multiple contexts, this object is a zero length string.")
alarmClearNotificationID = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 3, 2, 1, 7), ObjectIdentifier()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmClearNotificationID.setDescription('The NOTIFICATION-TYPE object identifier of the alarm\n       clear.')
alarmClearResourceId = MibTableColumn((1, 3, 6, 1, 2, 1, 118, 1, 3, 2, 1, 8), ResourceId()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    alarmClearResourceId.setDescription('This object identifies the resource that was under alarm.\n\n      If there is no corresponding resource, then\n      the value of this object MUST be 0.0.')
...
if mibBuilder.loadTexts:
    alarmCompliance.setDescription('The compliance statement for systems supporting\n          the Alarm MIB.')
...
if mibBuilder.loadTexts:
    alarmModelGroup.setDescription('Alarm model group.')
...
if mibBuilder.loadTexts:
    alarmActiveGroup.setDescription('Active Alarm list group.')
...
if mibBuilder.loadTexts:
    alarmActiveStatsGroup.setDescription('Active alarm summary group.')
...
if mibBuilder.loadTexts:
    alarmClearGroup.setDescription('Cleared alarm group.')
...
if mibBuilder.loadTexts:
    alarmNotificationsGroup.setDescription('The collection of notifications that can be used to\n           model alarms for faults lacking pre-existing\n           notification definitions.')
