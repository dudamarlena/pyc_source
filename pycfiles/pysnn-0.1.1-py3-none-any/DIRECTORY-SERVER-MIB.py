...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DIRECTORY-SERVER-MIB.py
# Compiled at: 2016-02-13 18:07:50
...
if mibBuilder.loadTexts:
    dsMIB.setLastUpdated('9906070000Z')
if mibBuilder.loadTexts:
    dsMIB.setOrganization('IETF Mail and Directory Management Working\n                     Group')
if mibBuilder.loadTexts:
    dsMIB.setContactInfo('                      Glenn Mansfield\n                     Postal: Cyber Solutions Inc.\n                             6-6-3, Minami Yoshinari\n                             Aoba-ku, Sendai, Japan 989-3204.\n\n                        Tel: +81-22-303-4012\n                        Fax: +81-22-303-4015\n                   E-mail: glenn@cysols.com\n       Working Group E-mail: ietf-madman@innosoft.com\n               To subscribe: ietf-madman-request@innosoft.com')
if mibBuilder.loadTexts:
    dsMIB.setDescription(' The MIB module for monitoring Directory Services.')
dsTable = MibTable((1, 3, 6, 1, 2, 1, 66, 1))
if mibBuilder.loadTexts:
    dsTable.setDescription(' The table holding information related to the Directory\n            Servers.')
dsTableEntry = MibTableRow((1, 3, 6, 1, 2, 1, 66, 1, 1)).setIndexNames((0, 'NETWORK-SERVICES-MIB', 'applIndex'))
if mibBuilder.loadTexts:
    dsTableEntry.setDescription(' Entry containing summary description for a Directory\n            Server.')
...
if mibBuilder.loadTexts:
    dsApplIfOpsEntry.setDescription(' Entry containing operations related statistics\n            for a Directory Server.')
...
if mibBuilder.loadTexts:
    dsEntryGroup.setDescription(' A collection of objects for a summary overview of the\n                  Directory Servers.')
...
if mibBuilder.loadTexts:
    dsOpsGroup.setDescription(' A collection of objects for monitoring the Directory\n                  Server operations.')
...
if mibBuilder.loadTexts:
    dsIntGroup.setDescription(" A collection of objects for monitoring the Directory\n                  Server's interaction with peer Directory Servers.")
