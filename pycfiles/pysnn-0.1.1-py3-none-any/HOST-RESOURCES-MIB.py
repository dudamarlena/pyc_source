...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/HOST-RESOURCES-MIB.py
...
if mibBuilder.loadTexts:
    hostResourcesMibModule.setLastUpdated('200003060000Z')
if mibBuilder.loadTexts:
    hostResourcesMibModule.setOrganization('IETF Host Resources MIB Working Group')
if mibBuilder.loadTexts:
    hostResourcesMibModule.setContactInfo('Steve Waldbusser\n          Postal: Lucent Technologies, Inc.\n                  1213 Innsbruck Dr.\n                  Sunnyvale, CA 94089\n                  USA\n          Phone:  650-318-1251\n          Fax:    650-318-1633\n          Email:  waldbusser@lucent.com\n\n\n          In addition, the Host Resources MIB mailing list is\n          dedicated to discussion of this MIB. To join the\n          mailing list, send a request message to\n          hostmib-request@andrew.cmu.edu. The mailing list\n          address is hostmib@andrew.cmu.edu.')
if mibBuilder.loadTexts:
    hostResourcesMibModule.setDescription("This MIB is for use in managing host systems. The term\n          `host' is construed to mean any computer that communicates\n          with other similar computers attached to the internet and\n          that is directly used by one or more human beings. Although\n          this MIB does not necessarily apply to devices whose primary\n          function is communications services (e.g., terminal servers,\n          routers, bridges, monitoring equipment), such relevance is\n          not explicitly precluded.  This MIB instruments attributes\n          common to all internet hosts including, for example, both\n          personal computers and systems that run variants of Unix.")
...
if mibBuilder.loadTexts:
    hrSystemUptime.setDescription('The amount of time since this host was last\n           initialized.  Note that this is different from\n           sysUpTime in the SNMPv2-MIB [RFC1907] because\n           sysUpTime is the uptime of the network management\n           portion of the system.')
...
if mibBuilder.loadTexts:
    hrSystemInitialLoadDevice.setDescription('The index of the hrDeviceEntry for the device from\n           which this host is configured to load its initial\n           operating system configuration (i.e., which operating\n           system code and/or boot parameters).\n\n           Note that writing to this object just changes the\n           configuration that will be used the next time the\n           operating system is loaded and does not actually cause\n           the reload to occur.')
...
if mibBuilder.loadTexts:
    hrSystemInitialLoadParameters.setDescription('This object contains the parameters (e.g. a pathname\n           and parameter) supplied to the load device when\n           requesting the initial operating system configuration\n           from that device.\n\n        Note that writing to this object just changes the\n        configuration that will be used the next time the\n        operating system is loaded and does not actually cause\n        the reload to occur.')
hrSystemNumUsers = MibScalar((1, 3, 6, 1, 2, 1, 25, 1, 5), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrSystemNumUsers.setDescription('The number of user sessions for which this host is\n           storing state information.  A session is a collection\n           of processes requiring a single act of user\n           authentication and possibly subject to collective job\n           control.')
hrSystemProcesses = MibScalar((1, 3, 6, 1, 2, 1, 25, 1, 6), Gauge32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrSystemProcesses.setDescription('The number of process contexts currently loaded or\n           running on this system.')
...
if mibBuilder.loadTexts:
    hrSystemMaxProcesses.setDescription('The maximum number of process contexts this system\n           can support.  If there is no fixed maximum, the value\n           should be zero.  On systems that have a fixed maximum,\n           this object can help diagnose failures that occur when\n           this maximum is reached.')
...
if mibBuilder.loadTexts:
    hrStorageIndex.setDescription('A unique value for each logical storage area\n           contained by the host.')
...
if mibBuilder.loadTexts:
    hrStorageDescr.setDescription('A description of the type and instance of the storage\n           described by this entry.')
...
if mibBuilder.loadTexts:
    hrStorageAllocationUnits.setDescription('The size, in bytes, of the data objects allocated\n           from this pool.  If this entry is monitoring sectors,\n           blocks, buffers, or packets, for example, this number\n           will commonly be greater than one.  Otherwise this\n           number will typically be one.')
...
if mibBuilder.loadTexts:
    hrStorageSize.setDescription('The size of the storage represented by this entry, in\n           units of hrStorageAllocationUnits. This object is\n           writable to allow remote configuration of the size of\n           the storage area in those cases where such an\n           operation makes sense and is possible on the\n           underlying system. For example, the amount of main\n           memory allocated to a buffer pool might be modified or\n           the amount of disk space allocated to virtual memory\n           might be modified.')
...
if mibBuilder.loadTexts:
    hrDeviceDescr.setDescription("A textual description of this device, including the\n           device's manufacturer and revision, and optionally,\n           its serial number.")
...
if mibBuilder.loadTexts:
    hrDiskStorageAccess.setDescription('An indication if this long-term storage device is\n           readable and writable or only readable.  This should\n           reflect the media type, any write-protect mechanism,\n           and any device configuration that affects the entire\n           device.')
...
if mibBuilder.loadTexts:
    hrDiskStorageMedia.setDescription('An indication of the type of media used in this long-\n           term storage device.')
hrDiskStorageRemoveble = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 6, 1, 3), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrDiskStorageRemoveble.setDescription('Denotes whether or not the disk media may be removed\n           from the drive.')
hrDiskStorageCapacity = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 6, 1, 4), KBytes()).setUnits('KBytes').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrDiskStorageCapacity.setDescription('The total size for this long-term storage device. If\n           the media is removable and is currently removed, this\n           value should be zero.')
hrPartitionTable = MibTable((1, 3, 6, 1, 2, 1, 25, 3, 7))
if mibBuilder.loadTexts:
    hrPartitionTable.setDescription('The (conceptual) table of partitions for long-term\n           storage devices contained by the host.  In particular,\n           partitions accessed remotely over a network are not\n           included here.')
...
if mibBuilder.loadTexts:
    hrPartitionEntry.setDescription('A (conceptual) entry for one partition.  The\n           hrDeviceIndex in the index represents the entry in the\n           hrDeviceTable that corresponds to the\n           hrPartitionEntry.\n\n           As an example of how objects in this table are named,\n           an instance of the hrPartitionSize object might be\n           named hrPartitionSize.3.1')
...
if mibBuilder.loadTexts:
    hrPartitionIndex.setDescription('A unique value for each partition on this long-term\n           storage device.  The value for each long-term storage\n           device must remain constant at least from one re-\n           initialization of the agent to the next re-\n           initialization.')
...
if mibBuilder.loadTexts:
    hrPartitionID.setDescription('A descriptor which uniquely represents this partition\n           to the responsible operating system.  On some systems,\n           this might take on a binary representation.')
...
if mibBuilder.loadTexts:
    hrFSIndex.setDescription('A unique value for each file system local to this\n           host.  The value for each file system must remain\n           constant at least from one re-initialization of the\n           agent to the next re-initialization.')
...
if mibBuilder.loadTexts:
    hrFSRemoteMountPoint.setDescription('A description of the name and/or address of the\n           server that this file system is mounted from.  This\n           may also include parameters such as the mount point on\n           the remote file system.  If this is not a remote file\n           system, this string should have a length of zero.')
hrFSType = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 4), AutonomousType()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrFSType.setDescription('The value of this object identifies the type of this\n           file system.')
...
if mibBuilder.loadTexts:
    hrFSAccess.setDescription('An indication if this file system is logically\n           configured by the operating system to be readable and\n           writable or only readable.  This does not represent\n           any local access-control policy, except one that is\n           applied to the file system as a whole.')
hrFSBootable = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 6), TruthValue()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrFSBootable.setDescription('A flag indicating whether this file system is\n           bootable.')
...
if mibBuilder.loadTexts:
    hrSWRunIndex.setDescription("A unique value for each piece of software running on\n           the host.  Wherever possible, this should be the\n           system's native, unique identification number.")
...
if mibBuilder.loadTexts:
    hrSWRunName.setDescription('A textual description of this running piece of\n           software, including the manufacturer, revision,  and\n           the name by which it is commonly known.  If this\n           software was installed locally, this should be the\n           same string as used in the corresponding\n           hrSWInstalledName.')
hrSWRunID = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 3), ProductID()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrSWRunID.setDescription('The product ID of this running piece of software.')
...
if mibBuilder.loadTexts:
    hrSWRunPath.setDescription('A description of the location on long-term storage\n           (e.g. a disk drive) from which this software was\n           loaded.')
...
if mibBuilder.loadTexts:
    hrSWRunParameters.setDescription('A description of the parameters supplied to this\n           software when it was initially loaded.')
...
if mibBuilder.loadTexts:
    hrSWRunType.setDescription('The type of this software.')
...
if mibBuilder.loadTexts:
    hrSWRunStatus.setDescription('The status of this running piece of software.\n           Setting this value to invalid(4) shall cause this\n           software to stop running and to be unloaded. Sets to\n           other values are not valid.')
hrSWRunPerfTable = MibTable((1, 3, 6, 1, 2, 1, 25, 5, 1))
if mibBuilder.loadTexts:
    hrSWRunPerfTable.setDescription('The (conceptual) table of running software\n           performance metrics.')
...
if mibBuilder.loadTexts:
    hrSWRunPerfEntry.setDescription('A (conceptual) entry containing software performance\n           metrics.  As an example, an instance of the\n           hrSWRunPerfCPU object might be named\n           hrSWRunPerfCPU.1287')
...
if mibBuilder.loadTexts:
    hrSWInstalledIndex.setDescription('A unique value for each piece of software installed\n           on the host.  This value shall be in the range from 1\n           to the number of pieces of software installed on the\n           host.')
...
if mibBuilder.loadTexts:
    hrSWInstalledName.setDescription('A textual description of this installed piece of\n           software, including the manufacturer, revision, the\n           name by which it is commonly known, and optionally,\n           its serial number.')
hrSWInstalledID = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 6, 3, 1, 3), ProductID()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrSWInstalledID.setDescription('The product ID of this installed piece of software.')
...
if mibBuilder.loadTexts:
    hrSWInstalledType.setDescription('The type of this software.')
hrSWInstalledDate = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 6, 3, 1, 5), DateAndTime()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hrSWInstalledDate.setDescription("The last-modification date of this application as it\n           would appear in a directory listing.\n\n           If this information is not known, then this variable\n           shall have the value corresponding to January 1, year\n           0000, 00:00:00.0, which is encoded as\n           (hex)'00 00 01 01 00 00 00 00'.")
...
if mibBuilder.loadTexts:
    hrMIBCompliance.setDescription('The requirements for conformance to the Host Resources MIB.')
...
if mibBuilder.loadTexts:
    hrSystemGroup.setDescription('The Host Resources System Group.')
...
if mibBuilder.loadTexts:
    hrStorageGroup.setDescription('The Host Resources Storage Group.')
...
if mibBuilder.loadTexts:
    hrDeviceGroup.setDescription('The Host Resources Device Group.')
...
if mibBuilder.loadTexts:
    hrSWRunGroup.setDescription('The Host Resources Running Software Group.')
...
if mibBuilder.loadTexts:
    hrSWRunPerfGroup.setDescription('The Host Resources Running Software\n               Performance Group.')
...
if mibBuilder.loadTexts:
    hrSWInstalledGroup.setDescription('The Host Resources Installed Software Group.')
