...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IPV6-ICMP-MIB.py
...
if mibBuilder.loadTexts:
    ipv6IcmpMIB.setLastUpdated('9801082155Z')
if mibBuilder.loadTexts:
    ipv6IcmpMIB.setOrganization('IETF IPv6 Working Group')
if mibBuilder.loadTexts:
    ipv6IcmpMIB.setContactInfo('           Dimitry Haskin\n\n              Postal: Bay Networks, Inc.\n                      660 Techology Park Drive.\n                      Billerica, MA  01821\n                      US\n\n                 Tel: +1-978-916-8124\n              E-mail: dhaskin@baynetworks.com\n\n                      Steve Onishi\n\n              Postal: Bay Networks, Inc.\n                      3 Federal Street\n                      Billerica, MA 01821\n                      US\n\n                 Tel: +1-978-916-3816\n              E-mail: sonishi@baynetworks.com')
if mibBuilder.loadTexts:
    ipv6IcmpMIB.setDescription('The MIB module for entities implementing\n             the ICMPv6.')
ipv6IcmpMIBObjects = MibIdentifier((1, 3, 6, 1, 2, 1, 56, 1))
ipv6IfIcmpTable = MibTable((1, 3, 6, 1, 2, 1, 56, 1, 1))
if mibBuilder.loadTexts:
    ipv6IfIcmpTable.setDescription('IPv6 ICMP statistics. This table contains statistics\n            of ICMPv6 messages that are received and sourced by\n            the entity.')
...
if mibBuilder.loadTexts:
    ipv6IcmpCompliance.setDescription('The compliance statement for SNMPv2 entities which\n           implement ICMPv6.')
...
if mibBuilder.loadTexts:
    ipv6IcmpGroup.setDescription('The ICMPv6 group of objects providing information\n             specific to ICMPv6.')
