...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/HDSL2-SHDSL-LINE-MIB.py
# Compiled at: 2016-02-13 18:15:07
...
class Hdsl2ShdslUnitId(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('xtuC', 1), ('xtuR', 2), ('xru1', 3), ('xru2', 4), ('xru3',
                                                                                   5), ('xru4',
                                                                                        6), ('xru5',
                                                                                             7), ('xru6',
                                                                                                  8), ('xru7',
...
class Hdsl2ShdslWirePair(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('wirePair1', 1), ('wirePair2', 2), ('wirePair3', 3), ('wirePair4',
                                                                                     4))
...
class Hdsl2ShdslClockReferenceType(Integer32, TextualConvention):
    __module__ = __name__
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))
    namedValues = NamedValues(('localClk', 1), ('networkClk', 2), ('dataOrNetworkClk',
                                                                   3), ('dataClk',
                                                                        4))
...
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfTable.setDescription('This table supports overall configuration of HDSL2/SHDSL\n        spans.  Entries in this table MUST be maintained in a\n        persistent manner.')
hdsl2ShdslSpanConfEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 1, 1)).setIndexNames((0,
                                                                                          'IF-MIB',
                                                                                          'ifIndex'))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfEntry.setDescription('An entry in the hdsl2ShdslSpanConfTable.  Each entry\n        represents the complete span in a single HDSL2/SHDSL line.\n        It is indexed by the ifIndex of the associated HDSL2/SHDSL\n        line.')
hdsl2ShdslSpanConfNumRepeaters = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 1, 1,
                                                 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 8))).setUnits('repeaters').setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfNumRepeaters.setDescription('This object provisions the number of repeaters/regenerators\n        in this HDSL2/SHDSL span.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfProfile.setDescription("This object is a pointer to a span configuration profile in\n        the hdsl2ShdslSpanConfProfileTable, which applies to this\n        span.  The value of this object is the index of the referenced\n        profile in the hdsl2ShdslSpanConfProfileTable.  Note that span\n        configuration profiles are only applicable to SHDSL lines.\n\n        HDSL2 lines MUST reference the default profile, 'DEFVAL'.\n        By default, this object will have the value 'DEFVAL'\n        (the index of the default profile).\n\n        Any attempt to set this object to a value that is not the value\n        of the index for an active entry in the profile table,\n        hdsl2ShdslSpanConfProfileTable, MUST be rejected.")
hdsl2ShdslSpanConfAlarmProfile = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 1, 1,
                                                 3), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfAlarmProfile.setDescription("This object is a pointer to an alarm configuration profile in\n        the hdsl2ShdslEndpointAlarmConfProfileTable.  The value of\n        this object is the index of the referenced profile in the\n        hdsl2ShdslEndpointAlarmConfProfileTable.  The alarm\n        threshold configuration in the referenced profile will be\n        used by default for all segment endpoints in this span.\n        Individual endpoints may override this profile by explicitly\n        specifying some other profile in the\n        hdsl2ShdslEndpointConfTable.  By default, this object will\n        have the value 'DEFVAL' (the index of the default\n        profile).\n\n        Any attempt to set this object to a value that is not the value\n        of the index for an active entry in the profile table,\n        hdsl2ShdslEndpointAlarmConfProfileTable, MUST be rejected.")
hdsl2ShdslSpanStatusTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 2))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanStatusTable.setDescription('This table provides overall status information of\n        HDSL2/SHDSL spans.  This table contains live data from\n        equipment.  As such, it is NOT persistent.')
hdsl2ShdslSpanStatusEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 2, 1)).setIndexNames((0,
                                                                                            'IF-MIB',
                                                                                            'ifIndex'))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanStatusEntry.setDescription('An entry in the hdsl2ShdslSpanStatusTable.  Each entry\n        represents the complete span in a single HDSL2/SHDSL line.\n        It is indexed by the ifIndex of the associated HDSL2/SHDSL\n        line.')
hdsl2ShdslStatusNumAvailRepeaters = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 2,
                                                    1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 8))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslStatusNumAvailRepeaters.setDescription('Contains the actual number of repeaters/regenerators\n        discovered in this HDSL2/SHDSL span.')
hdsl2ShdslStatusMaxAttainableLineRate = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                        2, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295))).setUnits('bps').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslStatusMaxAttainableLineRate.setDescription('Contains the maximum attainable line rate in this HDSL2/SHDSL\n        span.  This object provides the maximum rate the line is\n        capable of achieving.  This is based upon measurements made\n        during line probing.  This rate includes payload (user data)\n        and any applicable framing overhead.')
hdsl2ShdslStatusActualLineRate = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 2, 1,
                                                 3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295))).setUnits('bps').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslStatusActualLineRate.setDescription('Contains the actual line rate in this HDSL2/SHDSL span.  This\n        SHOULD equal ifSpeed.  This rate includes payload (user data)\n        and any applicable framing overhead')
hdsl2ShdslStatusTransmissionModeCurrent = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                          1, 2, 1, 4), Hdsl2ShdslTransmissionModeType()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslStatusTransmissionModeCurrent.setDescription('Contains the current Power Spectral Density (PSD) regional\n        setting of the HDSL2/SHDSL span.')
hdsl2ShdslStatusMaxAttainablePayloadRate = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                           1, 2, 1, 5), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295))).setUnits('bps').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslStatusMaxAttainablePayloadRate.setDescription('Contains the maximum attainable payload (user data)\n        line rate in this HDSL2/SHDSL span.  This object provides\n        the maximum rate the line is capable of achieving.  This\n        is based upon measurements made during line probing.  Any\n        framing overhead is not included.')
hdsl2ShdslStatusActualPayloadRate = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 2,
                                                    1, 6), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295))).setUnits('bps').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslStatusActualPayloadRate.setDescription('Contains the actual line rate in this HDSL2/SHDSL span.  Any\n        framing overhead is not included.')
hdsl2ShdslInventoryTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 3))
if mibBuilder.loadTexts:
    hdsl2ShdslInventoryTable.setDescription('This table supports retrieval of unit inventory information\n        available via the EOC from units in an HDSL2/SHDSL line.\n\n        Entries in this table are dynamically created during the\n        line discovery process.  The life cycle for these entries\n        is as follows:\n\n           - xtu discovers a device, either a far-end xtu or an xru\n           - an inventory table entry is created for the device\n           - the line goes down for whatever reason\n           - inventory table entries for unreachable devices are\n             destroyed\n\n        As these entries are created/destroyed dynamically, they\n        are NOT persistent.')
hdsl2ShdslInventoryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1)).setIndexNames((0,
                                                                                           'IF-MIB',
                                                                                           'ifIndex'), (0,
                                                                                                        'HDSL2-SHDSL-LINE-MIB',
                                                                                                        'hdsl2ShdslInvIndex'))
if mibBuilder.loadTexts:
    hdsl2ShdslInventoryEntry.setDescription('An entry in the hdsl2ShdslInventoryTable.  Each entry\n        represents inventory information for a single unit in an\n        HDSL2/SHDSL line.  It is indexed by the ifIndex of the\n        HDSL2/SHDSL line and the Hdsl2ShdslUnitId of the\n        associated unit.')
hdsl2ShdslInvIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1, 1), Hdsl2ShdslUnitId())
if mibBuilder.loadTexts:
    hdsl2ShdslInvIndex.setDescription('Each entry in this table corresponds to a physical element\n        in an HDSL2/SHDSL span.  It is based on the EOC unit addressing\n        scheme with reference to the xtuC.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorID.setDescription('Vendor ID as reported in an Inventory Response message.')
hdsl2ShdslInvVendorModelNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1,
                                                 3), OctetString().subtype(subtypeSpec=ValueSizeConstraint(12, 12)).setFixedLength(12)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorModelNumber.setDescription('Vendor model number as reported in an Inventory Response\n        message.')
hdsl2ShdslInvVendorSerialNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1,
                                                  4), OctetString().subtype(subtypeSpec=ValueSizeConstraint(12, 12)).setFixedLength(12)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorSerialNumber.setDescription('Vendor serial number as reported in an Inventory Response\n        message.')
hdsl2ShdslInvVendorEOCSoftwareVersion = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                        3, 1, 5), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorEOCSoftwareVersion.setDescription('Vendor EOC version as reported in a Discovery Response\n        message.')
hdsl2ShdslInvStandardVersion = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1, 6), Integer32()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvStandardVersion.setDescription('Version of the HDSL2/SHDSL standard implemented, as reported\n        in an Inventory Response message.')
hdsl2ShdslInvVendorListNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1,
                                                7), OctetString().subtype(subtypeSpec=ValueSizeConstraint(3, 3)).setFixedLength(3)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorListNumber.setDescription('Vendor list number as reported in an Inventory Response\n        message.')
hdsl2ShdslInvVendorIssueNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3, 1,
                                                 8), OctetString().subtype(subtypeSpec=ValueSizeConstraint(2, 2)).setFixedLength(2)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorIssueNumber.setDescription('Vendor issue number as reported in an Inventory Response\n        message.')
hdsl2ShdslInvVendorSoftwareVersion = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 3,
                                                     1, 9), OctetString().subtype(subtypeSpec=ValueSizeConstraint(6, 6)).setFixedLength(6)).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslInvVendorSoftwareVersion.setDescription('Vendor software version as reported in an Inventory Response\n        message.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslInvEquipmentCode.setDescription('Equipment code conforming to ANSI T1.213, Coded Identification\n        of Equipment Entities.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurrAtn.setDescription('The current loop attenuation for this endpoint as reported in\n        a Network or Customer Side Performance Status message.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurrSnrMgn.setDescription('The current SNR margin for this endpoint as reported in a\n        Status Response/SNR message.')
hdsl2ShdslEndpointCurrStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1, 3), Bits().clone(namedValues=NamedValues(('noDefect',
                                                                                                                            0), ('powerBackoff',
                                                                                                                                 1), ('deviceFault',
                                                                                                                                      2), ('dcContinuityFault',
                                                                                                                                           3), ('snrMarginAlarm',
                                                                                                                                                4), ('loopAttenuationAlarm',
                                                                                                                                                     5), ('loswFailureAlarm',
                                                                                                                                                          6), ('configInitFailure',
                                                                                                                                                               7), ('protocolInitFailure',
                                                                                                                                                                    8), ('noNeighborPresent',
                                                                                                                                                                         9), ('loopbackActive',
                                                                                                                                                                              10)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurrStatus.setDescription('Contains the current state of the endpoint.  This is a\n        bit-map of possible conditions.  The various bit positions\n        are as follows:\n\n        noDefect               There are no defects on the line.\n\n        powerBackoff           Indicates enhanced Power Backoff.\n\n        deviceFault            Indicates that a vendor-dependent\n                               diagnostic or self-test fault\n                               has been detected.\n\n        dcContinuityFault      Indicates vendor-dependent\n                               conditions that interfere with\n                               span powering such as short and\n                               open circuits.\n\n        snrMarginAlarm         Indicates that the SNR margin\n                               has dropped below the alarm threshold.\n\n        loopAttenuationAlarm   Indicates that the loop attenuation\n                               exceeds the alarm threshold.\n\n        loswFailureAlarm       Indicates a forward LOSW alarm.\n\n        configInitFailure      Endpoint failure during initialization\n                               due to paired endpoint not able to\n                               support requested configuration.\n\n        protocolInitFailure    Endpoint failure during initialization\n                               due to incompatible protocol used by\n                               the paired endpoint.\n\n        noNeighborPresent      Endpoint failure during initialization\n                               due to no activation sequence detected\n                               from paired endpoint.\n\n        loopbackActive         A loopback is currently active at this\n                               segment endpoint.\n\n        This is intended to supplement ifOperStatus.  Note that there\n        is a 1:1 relationship between the status bits defined in this\n        object and the notification thresholds defined elsewhere in\n        this MIB module.')
hdsl2ShdslEndpointES = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1, 4), Counter32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointES.setDescription('Count of Errored Seconds (ES) on this endpoint since the xU\n        was last restarted.')
hdsl2ShdslEndpointSES = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1, 5), Counter32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointSES.setDescription('Count of Severely Errored Seconds (SES) on this endpoint\n        since the xU was last restarted.')
hdsl2ShdslEndpointCRCanomalies = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                 6), Counter32()).setUnits('detected CRC Anomalies').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCRCanomalies.setDescription('Count of CRC anomalies on this endpoint since the xU was\n        last restarted.')
hdsl2ShdslEndpointLOSWS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1, 7), Counter32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointLOSWS.setDescription('Count of Loss of Sync Word (LOSW) Seconds on this endpoint\n        since the xU was last restarted.')
hdsl2ShdslEndpointUAS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1, 8), Counter32()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointUAS.setDescription('Count of Unavailable Seconds (UAS) on this endpoint since\n        the xU was last restarted.')
hdsl2ShdslEndpointCurr15MinTimeElapsed = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                         1, 5, 1, 9), Hdsl2ShdslPerfTimeElapsed()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr15MinTimeElapsed.setDescription('Total elapsed seconds in the current 15-minute interval.')
hdsl2ShdslEndpointCurr15MinES = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                10), PerfCurrentCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr15MinES.setDescription('Count of Errored Seconds (ES) in the current 15-minute\n        interval.')
hdsl2ShdslEndpointCurr15MinSES = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                 11), PerfCurrentCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr15MinSES.setDescription('Count of Severely Errored Seconds (SES) in the current\n        15-minute interval.')
hdsl2ShdslEndpointCurr15MinCRCanomalies = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                          1, 5, 1, 12), PerfCurrentCount()).setUnits('detected CRC Anomalies').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr15MinCRCanomalies.setDescription('Count of CRC anomalies in the current 15-minute interval.')
hdsl2ShdslEndpointCurr15MinLOSWS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5,
                                                   1, 13), PerfCurrentCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr15MinLOSWS.setDescription('Count of Loss of Sync Word (LOSW) Seconds in the current\n        15-minute interval.')
hdsl2ShdslEndpointCurr15MinUAS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                 14), PerfCurrentCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr15MinUAS.setDescription('Count of Unavailable Seconds (UAS) in the current 15-minute\n        interval.')
hdsl2ShdslEndpointCurr1DayTimeElapsed = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                        5, 1, 15), Hdsl2ShdslPerfTimeElapsed()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr1DayTimeElapsed.setDescription('Number of seconds that have elapsed since the beginning of\n        the current 1-day interval.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr1DayES.setDescription('Count of Errored Seconds (ES) during the current day as\n        measured by hdsl2ShdslEndpointCurr1DayTimeElapsed.')
hdsl2ShdslEndpointCurr1DaySES = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                17), Hdsl2ShdslPerfCurrDayCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr1DaySES.setDescription('Count of Severely Errored Seconds (SES) during the current\n        day as measured by hdsl2ShdslEndpointCurr1DayTimeElapsed.')
hdsl2ShdslEndpointCurr1DayCRCanomalies = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                         1, 5, 1, 18), Hdsl2ShdslPerfCurrDayCount()).setUnits('detected CRC Anomalies').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr1DayCRCanomalies.setDescription('Count of CRC anomalies during the current day as measured\n        by hdsl2ShdslEndpointCurr1DayTimeElapsed.')
hdsl2ShdslEndpointCurr1DayLOSWS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                  19), Hdsl2ShdslPerfCurrDayCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr1DayLOSWS.setDescription('Count of Loss of Sync Word (LOSW) Seconds during the current\n        day as measured by hdsl2ShdslEndpointCurr1DayTimeElapsed.')
hdsl2ShdslEndpointCurr1DayUAS = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 5, 1,
                                                20), Hdsl2ShdslPerfCurrDayCount()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurr1DayUAS.setDescription('Count of Unavailable Seconds (UAS) during the current day as\n        measured by hdsl2ShdslEndpointCurr1DayTimeElapsed.')
hdsl2ShdslEndpointCurrTipRingReversal = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                        5, 1, 21), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('normal',
                                                                                                                                                                                 1), ('reversed',
                                                                                                                                                                                      2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurrTipRingReversal.setDescription('This object indicates the state of the tip/ring for the\n        wire pair.')
hdsl2ShdslEndpointCurrActivationState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                        5, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('preActivation',
                                                                                                                                                                                    1), ('activation',
                                                                                                                                                                                         2), ('data',
                                                                                                                                                                                              3)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurrActivationState.setDescription('This object indicates the activation or training state of\n        the wire pair.')
hdsl2Shdsl15MinIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 6))
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalTable.setDescription('This table provides one row for each HDSL2/SHDSL endpoint\n        performance data collection interval.  This table contains\n        live data from equipment.  As such, it is NOT persistent.')
hdsl2Shdsl15MinIntervalEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 6, 1)).setIndexNames((0,
                                                                                               'IF-MIB',
                                                                                               'ifIndex'), (0,
                                                                                                            'HDSL2-SHDSL-LINE-MIB',
                                                                                                            'hdsl2ShdslInvIndex'), (0,
                                                                                                                                    ...
                                                                                                                                    'hdsl2ShdslEndpointSide'), (0,
                                                                                                                                                                'HDSL2-SHDSL-LINE-MIB',
                                                                                                                                                                'hdsl2ShdslEndpointWirePair'), (0,
                                                                                                                                                                                                'HDSL2-SHDSL-LINE-MIB',
                                                                                                                                                                                                'hdsl2Shdsl15MinIntervalNumber'))
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalEntry.setDescription('An entry in the hdsl2Shdsl15MinIntervalTable.')
hdsl2Shdsl15MinIntervalNumber = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 6, 1,
                                                1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 96)))
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalNumber.setDescription('Performance Data Interval number.  Interval 1 is the most\n        recent previous interval; interval 96 is 24 hours ago.\n        Intervals 2..96 are optional.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalES.setDescription('Count of Errored Seconds (ES) during the interval.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalSES.setDescription('Count of Severely Errored Seconds (SES) during the interval.')
hdsl2Shdsl15MinIntervalCRCanomalies = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                      6, 1, 4), PerfIntervalCount()).setUnits('detected CRC Anomalies').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalCRCanomalies.setDescription('Count of CRC anomalies during the interval.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalLOSWS.setDescription('Count of Loss of Sync Word (LOSW) Seconds during the\n        interval.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalUAS.setDescription('Count of Unavailable Seconds (UAS) during the interval.')
hdsl2Shdsl1DayIntervalTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 7))
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalTable.setDescription('This table provides one row for each HDSL2/SHDSL endpoint\n        performance data collection interval.  This table contains\n        live data from equipment.  As such, it is NOT persistent.')
hdsl2Shdsl1DayIntervalEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 7, 1)).setIndexNames((0,
                                                                                              'IF-MIB',
                                                                                              'ifIndex'), (0,
                                                                                                           'HDSL2-SHDSL-LINE-MIB',
                                                                                                           'hdsl2ShdslInvIndex'), (0,
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalEntry.setDescription('An entry in the hdsl2Shdsl1DayIntervalTable.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalNumber.setDescription('History Data Interval number.  Interval 1 is the most\n        recent previous day; interval 30 is 30 days ago.  Intervals\n        2..30 are optional.')
hdsl2Shdsl1DayIntervalMoniSecs = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 7, 1,
                                                 2), Hdsl2ShdslPerfTimeElapsed()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalMoniSecs.setDescription('The amount of time in the 1-day interval over which the\n        performance monitoring information is actually counted.\n        This value will be the same as the interval duration except\n        in a situation where performance monitoring data could not\n        be collected for any reason.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalES.setDescription('Count of Errored Seconds (ES) during the 1-day interval as\n        measured by hdsl2Shdsl1DayIntervalMoniSecs.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalSES.setDescription('Count of Severely Errored Seconds (SES) during the 1-day\n        interval as measured by hdsl2Shdsl1DayIntervalMoniSecs.')
hdsl2Shdsl1DayIntervalCRCanomalies = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 7,
                                                     1, 5), Hdsl2Shdsl1DayIntervalCount()).setUnits('detected CRC Anomalies').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalCRCanomalies.setDescription('Count of CRC anomalies during the 1-day interval as\n        measured by hdsl2Shdsl1DayIntervalMoniSecs.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalLOSWS.setDescription('Count of Loss of Sync Word (LOSW) Seconds during the 1-day\n        interval as measured by hdsl2Shdsl1DayIntervalMoniSecs.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalUAS.setDescription('Count of Unavailable Seconds (UAS) during the 1-day interval\n        as measured by hdsl2Shdsl1DayIntervalMoniSecs.')
hdsl2ShdslEndpointMaintTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 8))
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointMaintTable.setDescription('This table supports maintenance operations (e.g., loopbacks)\n        to be performed on HDSL2/SHDSL segment endpoints.  This table\n        contains live data from equipment.  As such, it is NOT\n        persistent.')
hdsl2ShdslEndpointMaintEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 8, 1)).setIndexNames((0,
                                                                                               'IF-MIB',
                                                                                               'ifIndex'), (0,
                                                                                                            'HDSL2-SHDSL-LINE-MIB',
                                                                                                            'hdsl2ShdslInvIndex'), (0,
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointMaintEntry.setDescription('An entry in the hdsl2ShdslEndpointMaintTable.  Each entry\n        corresponds to a single segment endpoint and is indexed by the\n        ifIndex of the HDSL2/SHDSL line, the UnitId of the associated\n        unit, and the side of the unit.')
hdsl2ShdslMaintLoopbackConfig = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 8, 1,
                                                1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('noLoopback',
                                                                                                                                                                     1), ('normalLoopback',
                                                                                                                                                                          2), ('specialLoopback',
                                                                                                                                                                               3)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    hdsl2ShdslMaintLoopbackConfig.setDescription('This object controls configuration of loopbacks for the\n        associated segment endpoint.  The status of the loopback\n        is obtained via the hdsl2ShdslEndpointCurrStatus object.')
hdsl2ShdslMaintTipRingReversal = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 8, 1,
                                                 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('normal',
                                                                                                                                                                   1), ('reversed',
                                                                                                                                                                        2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslMaintTipRingReversal.setDescription('This object indicates the state of the tip/ring pair at the\n        associated segment endpoint.')
hdsl2ShdslMaintPowerBackOff = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 8, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('default',
                                                                                                                                                                                                   1), ('enhanced',
                                                                                                                                                                                                        2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    hdsl2ShdslMaintPowerBackOff.setDescription('This object configures the receiver at the associated\n        segment endpoint to operate in default or enhanced power\n        backoff mode.')
hdsl2ShdslMaintSoftRestart = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 8, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('ready',
                                                                                                                                                                                                  1), ('restart',
                                                                                                                                                                                                       2)))).setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    hdsl2ShdslMaintSoftRestart.setDescription("This object enables the manager to trigger a soft restart\n        of the modem at the associated segment endpoint.  The\n        manager may only set this object to the 'restart(2)'\n        value, which initiates a restart.  The agent will perform a\n        restart after approximately 5 seconds.  Following the 5 second\n        period, the agent will restore the object to the 'ready(1)'\n        state.")
hdsl2ShdslUnitMaintTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 9))
if mibBuilder.loadTexts:
    hdsl2ShdslUnitMaintTable.setDescription('This table supports maintenance operations for units in a\n        HDSL2/SHDSL line.  Entries in this table MUST be maintained\n        in a persistent manner.')
hdsl2ShdslUnitMaintEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 9, 1)).setIndexNames((0,
                                                                                           'IF-MIB',
                                                                                           'ifIndex'), (0,
                                                                                                        'HDSL2-SHDSL-LINE-MIB',
                                                                                                        'hdsl2ShdslInvIndex'))
if mibBuilder.loadTexts:
    hdsl2ShdslUnitMaintEntry.setDescription('An entry in the hdsl2ShdslUnitMaintTable.  Each entry\n        corresponds to a single unit and is indexed by the\n        ifIndex of the HDSL2/SHDSL line and the UnitId of the\n        associated unit.')
hdsl2ShdslMaintLoopbackTimeout = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 9, 1,
                                                 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setUnits('minutes').setMaxAccess('readwrite')
if mibBuilder.loadTexts:
    hdsl2ShdslMaintLoopbackTimeout.setDescription('This object configures the timeout value for loopbacks\n        initiated at segments endpoints contained in the associated\n        unit.  A value of 0 disables the timeout.')
hdsl2ShdslMaintUnitPowerSource = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 9, 1,
                                                 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('local',
                                                                                                                                                                   1), ('span',
                                                                                                                                                                        2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    hdsl2ShdslMaintUnitPowerSource.setDescription('This object indicates the DC power source being used by the\n        associated unit.')
hdsl2ShdslSpanConfProfileTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 10))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfProfileTable.setDescription('This table supports definitions of span configuration\n        profiles for SHDSL lines.  HDSL2 does not support these\n        configuration options.  This table MUST be maintained\n        in a persistent manner.')
hdsl2ShdslSpanConfProfileEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1, 10, 1)).setIndexNames((1,
                                                                                                  'HDSL2-SHDSL-LINE-MIB',
                                                                                                  'hdsl2ShdslSpanConfProfileName'))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfProfileEntry.setDescription('Each entry corresponds to a single span configuration\n        profile.  Each profile contains a set of span configuration\n        parameters.  The configuration parameters in a profile are\n        applied to those lines referencing that profile (see the\n        hdsl2ShdslSpanConfProfile object).  Profiles may be\n        created/deleted using the row creation/deletion mechanism\n        via hdsl2ShdslSpanConfProfileRowStatus.  If an active\n        entry is referenced in hdsl2ShdslSpanConfProfile, the\n        entry MUST remain active until all references are removed.')
hdsl2ShdslSpanConfProfileName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10, 1,
                                                1), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32)))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfProfileName.setDescription('This object is the unique index associated with this profile.\n        Entries in this table are referenced via the object\n        hdsl2ShdslSpanConfProfile in Hdsl2ShdslSpanConfEntry.')
hdsl2ShdslSpanConfWireInterface = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10,
                                                  1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('twoWire',
                                                                                                                                                                             1), ('fourWire',
                                                                                                                                                                                  2), ('sixWire',
                                                                                                                                                                                       3), ('eightWire',
                                                                                                                                                                                            4))).clone('twoWire')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfWireInterface.setDescription('This object configures the two-wire or optional four-wire,\n        six-wire, or eight-wire operation for SHDSL lines.')
hdsl2ShdslSpanConfMinLineRate = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10, 1,
                                                3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295)).clone(1552000)).setUnits('bps').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfMinLineRate.setDescription("This object configures the minimum transmission rate for\n        the associated SHDSL Line in bits-per-second (bps) and includes\n        both payload (user data) and any applicable framing overhead.\n        If the minimum line rate equals the maximum line rate\n        (hdsl2ShdslSpanMaxLineRate), the line rate is considered\n        'fixed'.  If the minimum line rate is less than the\n        maximum line rate, the line rate is considered\n        'rate-adaptive'.")
hdsl2ShdslSpanConfMaxLineRate = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10, 1,
                                                4), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4294967295)).clone(1552000)).setUnits('bps').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfMaxLineRate.setDescription("This object configures the maximum transmission rate for\n        the associated SHDSL Line in bits-per-second (bps) and includes\n        both payload (user data) and any applicable framing overhead.\n        If the minimum line rate equals the maximum line rate\n        (hdsl2ShdslSpanMaxLineRate), the line rate is considered\n        'fixed'.  If the minimum line rate is less than the\n        maximum line rate, the line rate is considered\n        'rate-adaptive'.")
hdsl2ShdslSpanConfPSD = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('symmetric',
                                                                                                                                                                                              1), ('asymmetric',
                                                                                                                                                                                                   2))).clone('symmetric')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfPSD.setDescription('This object configures use of symmetric/asymmetric PSD (Power\n        Spectral Density) Mask for the associated SHDSL Line.  Support\n        for symmetric PSD is mandatory for all supported data rates.\n        Support for asymmetric PSD is optional.')
hdsl2ShdslSpanConfTransmissionMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10,
                                                     1, 6), Hdsl2ShdslTransmissionModeType().clone(namedValues=NamedValues(('region1',
                                                                                                                            0)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfTransmissionMode.setDescription('This object specifies the regional setting for the SHDSL\n        line.')
hdsl2ShdslSpanConfRemoteEnabled = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10,
                                                  1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('enabled',
                                                                                                                                                                       1), ('disabled',
                                                                                                                                                                            2))).clone('enabled')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfRemoteEnabled.setDescription('This object enables/disables support for remote management\n        of the units in an SHDSL line from the STU-R via the EOC.')
hdsl2ShdslSpanConfPowerFeeding = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10, 1,
                                                 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('noPower',
                                                                                                                                                                      1), ('powerFeed',
                                                                                                                                                                           2), ('wettingCurrent',
                                                                                                                                                                                3))).clone('noPower')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfPowerFeeding.setDescription('This object enables/disables support for optional power\n        feeding in an SHDSL line.')
hdsl2ShdslSpanConfCurrCondTargetMarginDown = MibTableColumn((1, 3, 6, 1, 2, 1, 10,
                                                             48, 1, 10, 1, 9), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-10, 21))).setUnits('dB').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfCurrCondTargetMarginDown.setDescription('This object specifies the downstream current condition target\n        SNR margin for an SHDSL line.  The SNR margin is the difference\n        between the desired SNR and the actual SNR.  Target SNR margin\n        is the desired SNR margin for a unit.')
hdsl2ShdslSpanConfWorstCaseTargetMarginDown = MibTableColumn((1, 3, 6, 1, 2, 1, 10,
                                                              48, 1, 10, 1, 10), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-10, 21))).setUnits('dB').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfWorstCaseTargetMarginDown.setDescription('This object specifies the downstream worst-case target SNR\n        margin for an SHDSL line.  The SNR margin is the difference\n        between the desired SNR and the actual SNR.  Target SNR\n        margin is the desired SNR margin for a unit.')
hdsl2ShdslSpanConfCurrCondTargetMarginUp = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                           1, 10, 1, 11), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-10, 21))).setUnits('dB').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfCurrCondTargetMarginUp.setDescription('This object specifies the upstream current-condition target\n        SNR margin for an SHDSL line.  The SNR margin is the difference\n        between the desired SNR and the actual SNR.  Target SNR margin\n        is the desired SNR margin for a unit.')
hdsl2ShdslSpanConfWorstCaseTargetMarginUp = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                            1, 10, 1, 12), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-10, 21))).setUnits('dB').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfWorstCaseTargetMarginUp.setDescription('This object specifies the upstream worst-case target SNR\n        margin for an SHDSL line.  The SNR margin is the difference\n        between the desired SNR and the actual SNR.  Target SNR margin\n        is the desired SNR margin for a unit.')
hdsl2ShdslSpanConfUsedTargetMargins = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                      10, 1, 13), Bits().clone(namedValues=NamedValues(('currCondDown',
                                                                                                        0), ('worstCaseDown',
                                                                                                             1), ('currCondUp',
                                                                                                                  2), ('worstCaseUp',
                                                                                                                       3))).clone(namedValues=NamedValues(('currCondDown',
                                                                                                                                                           0)))).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfUsedTargetMargins.setDescription('Indicates whether a target SNR margin is enabled or\n        disabled.  This is a bit-map of possible settings.  The\n        various bit positions are as follows:\n\n        currCondDown   - current-condition downstream target SNR\n                         margin enabled\n\n        worstCaseDown  - worst-case downstream target SNR margin\n                         enabled\n\n        currCondUp     - current-condition upstream target SNR\n                         margin enabled\n\n        worstCaseUp    - worst-case upstream target SNR margin\n                         enabled.')
hdsl2ShdslSpanConfReferenceClock = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10,
                                                   1, 14), Hdsl2ShdslClockReferenceType().clone('localClk')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfReferenceClock.setDescription('This object configures the clock reference for the STU-C\n        in an SHDSL Line.')
hdsl2ShdslSpanConfLineProbeEnable = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10,
                                                    1, 15), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('disable',
                                                                                                                                                                          1), ('enable',
                                                                                                                                                                               2))).clone('disable')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfLineProbeEnable.setDescription('This object enables/disables support for Line Probe of\n        the units in an SHDSL line.  When Line Probe is enabled, the\n        system performs Line Probing to find the best possible\n        rate.  If Line Probe is disabled, the rate adaptation phase\n        is skipped to shorten set up time.')
hdsl2ShdslSpanConfProfileRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 10,
                                                     1, 16), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfProfileRowStatus.setDescription('This object controls creation/deletion of the associated\n        entry in this table per the semantics of RowStatus.  If an\n        active entry is referenced in hdsl2ShdslSpanConfProfile, the\n        entry MUST remain active until all references are removed.')
hdsl2ShdslEndpointAlarmConfProfileTable = MibTable((1, 3, 6, 1, 2, 1, 10, 48, 1, 11))
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointAlarmConfProfileTable.setDescription('This table supports definitions of alarm configuration\n        profiles for HDSL2/SHDSL segment endpoints.  This table\n        MUST be maintained in a persistent manner.')
hdsl2ShdslEndpointAlarmConfProfileEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 48, 1,
                                                       11, 1)).setIndexNames((1, 'HDSL2-SHDSL-LINE-MIB',
                                                                              'hdsl2ShdslEndpointAlarmConfProfileName'))
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointAlarmConfProfileEntry.setDescription('Each entry corresponds to a single alarm configuration profile.\n        Each profile contains a set of parameters for setting alarm\n        thresholds for various performance attributes monitored at\n        HDSL2/SHDSL segment endpoints.  Profiles may be created/deleted\n        using the row creation/deletion mechanism via\n        hdsl2ShdslEndpointAlarmConfProfileRowStatus.  If an active\n        entry is referenced in either hdsl2ShdslSpanConfAlarmProfile\n        or hdsl2ShdslEndpointAlarmConfProfile, the entry MUST remain\n        active until all references are removed.')
hdsl2ShdslEndpointAlarmConfProfileName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                         1, 11, 1, 1), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32)))
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointAlarmConfProfileName.setDescription('This object is the unique index associated with this profile.')
hdsl2ShdslEndpointThreshLoopAttenuation = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48,
                                                          1, 11, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-127, 128))).setUnits('dB').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointThreshLoopAttenuation.setDescription('This object configures the loop attenuation alarm threshold.\n        When the current value of hdsl2ShdslEndpointCurrAtn reaches\n        or exceeds this threshold, an hdsl2ShdslLoopAttenCrossing\n        MAY be generated.')
hdsl2ShdslEndpointThreshSNRMargin = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 48, 1, 11,
                                                    1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-127, 128))).setUnits('dB').setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointThreshSNRMargin.setDescription('This object configures the SNR margin alarm threshold.\n        When the current value of hdsl2ShdslEndpointCurrSnrMgn\n        reaches or drops below this threshold, a\n        hdsl2ShdslSNRMarginCrossing MAY be generated.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslPerfCRCanomaliesThresh.setDescription('This notification indicates that the CRC anomalies threshold\n        (as per the hdsl2ShdslEndpointThreshCRCanomalies value) has\n        been reached/exceeded for the HDSL2/SHDSL segment endpoint.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslPerfLOSWSThresh.setDescription('This notification indicates that the LOSW Seconds threshold\n        (as per the hdsl2ShdslEndpointThreshLOSWS value) has been\n        reached/exceeded for the HDSL2/SHDSL segment endpoint.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslPerfUASThresh.setDescription('This notification indicates that the unavailable seconds\n        threshold (as per the hdsl2ShdslEndpointThreshUAS value) has\n        been reached/exceeded for the HDSL2/SHDSL segment endpoint.')
hdsl2ShdslSpanInvalidNumRepeaters = NotificationType((1, 3, 6, 1, 2, 1, 10, 48, 0,
                                                      8)).setObjects(*(('HDSL2-SHDSL-LINE-MIB', 'hdsl2ShdslSpanConfNumRepeaters'), ))
if mibBuilder.loadTexts:
    hdsl2ShdslSpanInvalidNumRepeaters.setDescription('This notification indicates that a mismatch has been detected\n        between the number of repeater/regenerator units configured\n        for an HDSL2/SHDSL line via the hdsl2ShdslSpanConfNumRepeaters\n        object and the actual number of repeater/regenerator units\n        discovered via the EOC.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslLoopbackFailure.setDescription('This notification indicates that an endpoint maintenance\n        loopback command failed for an HDSL2/SHDSL segment.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslpowerBackoff.setDescription('This notification indicates that the bit setting for\n        powerBackoff in the hdsl2ShdslEndpointCurrStatus object for\n        this endpoint has changed.')
...
if mibBuilder.loadTexts:
    hdsl2ShdsldeviceFault.setDescription('This notification indicates that the bit setting for\n        deviceFault in the hdsl2ShdslEndpointCurrStatus object for\n        this endpoint has changed.')
...
if mibBuilder.loadTexts:
    hdsl2ShdsldcContinuityFault.setDescription('This notification indicates that the bit setting for\n        dcContinuityFault in the hdsl2ShdslEndpointCurrStatus object\n        for this endpoint has changed.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslconfigInitFailure.setDescription('This notification indicates that the bit setting for\n        configInitFailure in the hdsl2ShdslEndpointCurrStatus object\n        for this endpoint has changed.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslprotocolInitFailure.setDescription('This notification indicates that the bit setting for\n        protocolInitFailure in the hdsl2ShdslEndpointCurrStatus\n        object for this endpoint has changed.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfGroup.setDescription('This group supports objects for configuring span-related\n        parameters for HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslSpanStatusGroup.setDescription('This group supports objects for retrieving span-related\n        status for HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslInventoryShdslGroup.setDescription('This group supports objects for retrieving SHDSL-specific\n        inventory information.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslSpanShdslStatusGroup.setDescription('This group supports objects for retrieving SHDSL-specific\n        span-related status.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslInventoryGroup.setDescription('This group supports objects that provide unit inventory\n        information about the units in HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointConfGroup.setDescription('This group supports objects for configuring parameters for\n        segment endpoints in HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointCurrGroup.setDescription('This group supports objects that provide current status and\n        performance measurements relating to segment endpoints in\n        HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl15MinIntervalGroup.setDescription('This group supports objects that maintain historic\n        performance measurements relating to segment endpoints in\n        HDSL2/SHDSL lines in 15-minute intervals.')
...
if mibBuilder.loadTexts:
    hdsl2Shdsl1DayIntervalGroup.setDescription('This group supports objects that maintain historic\n        performance measurements relating to segment endpoints in\n        HDSL2/SHDSL lines in 1-day intervals.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslMaintenanceGroup.setDescription('This group supports objects that provide support for\n        maintenance actions for HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslEndpointAlarmConfGroup.setDescription('This group supports objects that allow configuration of alarm\n        thresholds for various performance parameters for HDSL2/SHDSL\n        lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslNotificationGroup.setDescription('This group supports notifications of significant conditions\n        associated with HDSL2/SHDSL lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslSpanConfProfileGroup.setDescription('This group supports objects that constitute configuration\n        profiles for configuring span-related parameters in SHDSL\n        lines.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslWirePairGroup.setDescription('This group supports objects that provide the status\n        of SHDSL-specific wire pairs.')
...
if mibBuilder.loadTexts:
    hdsl2ShdslPayloadRateGroup.setDescription('This group supports objects for retrieving payload rates\n        that exclude any framing overhead.')
