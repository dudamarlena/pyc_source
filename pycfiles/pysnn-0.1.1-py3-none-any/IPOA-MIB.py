...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IPOA-MIB.py
# Compiled at: 2016-02-13 18:18:13
...
if mibBuilder.loadTexts:
    ipoaMIB.setLastUpdated('9802090000Z')
if mibBuilder.loadTexts:
    ipoaMIB.setOrganization('IETF Internetworking Over NBMA Working\n                    Group (ion)')
if mibBuilder.loadTexts:
    ipoaMIB.setContactInfo('Maria Greene (greene@xedia.com)\n           Xedia Corp.\n\n           Jim Luciani (jluciani@BayNetworks.com)\n           Bay Networks\n\n           Kenneth White (kennethw@vnet.ibm.com)\n           IBM Corp.\n\n           Ted Kuo (tkuo@eos.ncsu.edu)\n           Bay Networks')
if mibBuilder.loadTexts:
    ipoaMIB.setDescription('This module defines a portion of the management\n          information base (MIB) for managing Classical IP and\n          ARP over ATM entities.')
...
if mibBuilder.loadTexts:
    ipoaLisQDepth.setDescription('The maximum number of outstanding requests that are\n           allowed while waiting for ATMARP replies and\n           InATMARP replies for this LIS.')
...
if mibBuilder.loadTexts:
    ipoaLisMaxCalls.setDescription('The maximum number of SVCs that can be established\n          simultaneously for this LIS.')
...
if mibBuilder.loadTexts:
    ipoaLisRetries.setDescription('The number of times the ATMARP request will be retried\n          when no response is received in the timeout interval\n          indicated by ipoaLisTimeout.')
...
if mibBuilder.loadTexts:
    ipoaVcNegotiatedMtu.setDescription('The MTU used when communicating over this circuit.')
ipoaConfigPvcTable = MibTable((1, 3, 6, 1, 2, 1, 10, 46, 1, 8))
if mibBuilder.loadTexts:
    ipoaConfigPvcTable.setDescription('This table MUST be supported when PVCs are intended to\n          be supported in order to enable the setup of PVCs for\n          use by IP.')
ipoaConfigPvcEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 46, 1, 8, 1)).setIndexNames((0,
                                                                                     'IPOA-MIB',
                                                                                     'ipoaConfigPvcIfIndex'), (0,
                                                                                                               'IPOA-MIB',
                                                                                                               'ipoaConfigPvcVpi'), (0,
                                                                                                                                     'IPOA-MIB',
                                                                                                                                     'ipoaConfigPvcVci'))
if mibBuilder.loadTexts:
    ipoaConfigPvcEntry.setDescription('Defines a single PVC that exists at this host for\n          use by IP.')
ipoaConfigPvcIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 46, 1, 8, 1, 1), InterfaceIndex())
if mibBuilder.loadTexts:
    ipoaConfigPvcIfIndex.setDescription('The ifIndex of the ATM Interface that this PVC\n           is associated with.')
ipoaConfigPvcVpi = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 46, 1, 8, 1, 2), IpoaVpiInteger())
if mibBuilder.loadTexts:
    ipoaConfigPvcVpi.setDescription('The VPI value for the Virtual Circuit.')
ipoaConfigPvcVci = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 46, 1, 8, 1, 3), IpoaVciInteger())
if mibBuilder.loadTexts:
    ipoaConfigPvcVci.setDescription('The VCI value for the Virtual Circuit.')
...
if mibBuilder.loadTexts:
    ipoaCompliance.setDescription('The compliance statement for agents that support the\n          IPOA-MIB.')
...
if mibBuilder.loadTexts:
    ipoaGeneralGroup.setDescription('This group is mandatory for all IP over ATM entities.')
...
if mibBuilder.loadTexts:
    ipoaClientGroup.setDescription('This group is mandatory for all hosts where an IP\n          over ATM client is present.')
...
if mibBuilder.loadTexts:
    ipoaSrvrGroup.setDescription('This group is mandatory for all hosts where ATMARP\n          Servers are present.')
ipoaBasicNotificationsGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 10, 46, 3, 1, 4)).setObjects(*(('IPOA-MIB', 'ipoaMtuExceeded'), ))
if mibBuilder.loadTexts:
    ipoaBasicNotificationsGroup.setDescription('The notification which an IP over ATM entity\n          is required to implement.')
ipoaSrvrNotificationsGroup = NotificationGroup((1, 3, 6, 1, 2, 1, 10, 46, 3, 1, 5)).setObjects(*(('IPOA-MIB', 'ipoaDuplicateIpAddress'), ))
if mibBuilder.loadTexts:
    ipoaSrvrNotificationsGroup.setDescription('The notification which an IP over ATM ATMARP\n              Server is required to implement.')
