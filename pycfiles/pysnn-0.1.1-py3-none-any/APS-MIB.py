...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/APS-MIB.py
...
class ApsSwitchCommand(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noCmd', 1), ('clear', 2), ('lockoutOfProtection', 3), ('forcedSwitchWorkToProtect',
                                                                                       4), ('forcedSwitchProtectToWork',
                                                                                            5), ('manualSwitchWorkToProtect',
                                                                                                 6), ('manualSwitchProtectToWork',
                                                                                                      7), ('exercise',
                                                                                                           8))
...
class ApsControlCommand(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('noCmd', 1), ('lockoutWorkingChannel', 2), ('clearLockoutWorkingChannel',
                                                                           3))
...
if mibBuilder.loadTexts:
    apsConfigGroups.setDescription('The count of APS groups. This count includes all rows in\n         apsConfigTable, regardless of the value of apsConfigRowStatus.')
apsConfigTable = MibTable((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 1, 2))
if mibBuilder.loadTexts:
    apsConfigTable.setDescription('This table lists the APS groups that have been configured\n         on the system.')
apsConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 1, 2, 1)).setIndexNames((1,
                                                                                         'APS-MIB',
                                                                                         'apsConfigName'))
if mibBuilder.loadTexts:
    apsConfigEntry.setDescription('A conceptual row in the apsConfigTable.')
...
if mibBuilder.loadTexts:
    apsStatusEntry.setDescription('A conceptual row in the apsStatusTable.')
apsStatusK1K2Rcv = MibTableColumn((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 2, 1, 1), ApsK1K2()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    apsStatusK1K2Rcv.setDescription('The current value of the K1 and K2 bytes received on the\n\n\n         protection channel.')
apsStatusK1K2Trans = MibTableColumn((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 2, 1, 2), ApsK1K2()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    apsStatusK1K2Trans.setDescription('The current value of the K1 and K2 bytes transmitted on the\n         protection channel.')
apsStatusCurrent = MibTableColumn((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 2, 1, 3), Bits().clone(namedValues=NamedValues(('modeMismatch',
                                                                                                                     0), ('channelMismatch',
                                                                                                                          1), ('psbf',
                                                                                                                               2), ('feplf',
                                                                                                                                    3), ('extraTraffic',
...
if mibBuilder.loadTexts:
    apsChanLTEs.setDescription('The count of SONET LTE interfaces on the system.\n         Each interface that is included has an ifType value of sonet(39).')
apsMapTable = MibTable((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 3, 2))
if mibBuilder.loadTexts:
    apsMapTable.setDescription('This table lists the SONET LTE interfaces on the system.\n         Each interface that is listed has an ifType value of sonet(39).')
apsMapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 3, 2, 1)).setIndexNames((0,
                                                                                      'IF-MIB',
                                                                                      'ifIndex'))
if mibBuilder.loadTexts:
    apsMapEntry.setDescription('A conceptual row in the apsMapTable.')
...
if mibBuilder.loadTexts:
    apsMapChanNumber.setDescription('This field is set to a unique channel number within an APS group.\n         The value 0 indicates the null channel. The values 1-14 define a\n         working channel. If the SONET LTE is not part of an APS group this\n         value is set to -1.\n\n         When an instance of apsChanConfigIfIndex is set equal to an\n         instance of ifIndex that has an  ifType value of sonet(39),\n         apsMapChanNumber is set equal to the corresponding value of\n         apsChanConfigNumber.\n\n         If an instance of ifIndex that has an  ifType value of sonet(39)\n         ceases to be equal to an instance of apsChanConfigIfIndex, either\n         because of a change in the value of apsChanConfigIfIndex, or\n         because of row deletion in the ApsChanConfigTable,\n         apsMapChanNumber is set to -1.')
apsChanConfigTable = MibTable((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 4))
if mibBuilder.loadTexts:
    apsChanConfigTable.setDescription('This table lists the APS channels that have been configured\n         in APS groups.')
apsChanConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 4, 1)).setIndexNames((0,
                                                                                          'APS-MIB',
                                                                                          'apsChanConfigGroupName'), (0,
                                                                                                                      'APS-MIB',
                                                                                                                      'apsChanConfigNumber'))
if mibBuilder.loadTexts:
    apsChanConfigEntry.setDescription('A conceptual row in the apsChanConfigTable.')
...
if mibBuilder.loadTexts:
    apsChanStatusEntry.setDescription('A conceptual row in the apsChanStatusTable.')
apsChanStatusCurrent = MibTableColumn((1, 3, 6, 1, 4, 1, 2636, 3, 24, 1, 6, 1, 1), Bits().clone(namedValues=NamedValues(('lockedOut',
                                                                                                                         0), ('sd',
                                                                                                                              1), ('sf',
                                                                                                                                   2), ('switched',
                                                                                                                                        3), ('wtr',
...
if mibBuilder.loadTexts:
    apsEventSwitchover.setDescription('An apsEventSwitchover notification is sent when the\n        value of an instance of apsChanStatusSwitchovers increments.')
...
if mibBuilder.loadTexts:
    apsEventModeMismatch.setDescription('An apsEventModeMismatch notification is sent when the\n        value of an instance of apsStatusModeMismatches increments.')
...
if mibBuilder.loadTexts:
    apsStatusGeneral.setDescription('A collection of apsStatusTable objects providing status information\n         applicable to all linear APS groups.')
...
if mibBuilder.loadTexts:
    apsEventGroup.setDescription('A collection of SONET linear APS notifications.')
