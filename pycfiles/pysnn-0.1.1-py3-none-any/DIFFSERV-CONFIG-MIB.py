...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/DIFFSERV-CONFIG-MIB.py
# Compiled at: 2016-02-13 18:07:26
...
if mibBuilder.loadTexts:
    diffServConfigMIBConfigGroup.setDescription('The per-hop-behavior Group defines the MIB objects that\n       describe the configuration template for the per-hop-behavior.')
