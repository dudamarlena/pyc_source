...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/PIM-MIB.py
# Compiled at: 2016-02-13 18:23:34
...
if mibBuilder.loadTexts:
    pimMIB.setLastUpdated('200009280000Z')
if mibBuilder.loadTexts:
    pimMIB.setOrganization('IETF IDMR Working Group.')
if mibBuilder.loadTexts:
    pimMIB.setContactInfo(' Dave Thaler\n              Microsoft Corporation\n              One Microsoft Way\n              Redmond, WA  98052-6399\n              US\n\n              Phone: +1 425 703 8835\n              EMail: dthaler@microsoft.com')
if mibBuilder.loadTexts:
    pimMIB.setDescription('The MIB module for management of PIM routers.')
...
if mibBuilder.loadTexts:
    pimJoinPruneInterval.setDescription('The default interval at which periodic PIM-SM Join/Prune\n            messages are to be sent.')
...
pimInterfaceEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 2, 1)).setIndexNames((0,
                                                                                'PIM-MIB',
                                                                                'pimInterfaceIfIndex'))
if mibBuilder.loadTexts:
    pimInterfaceEntry.setDescription('An entry (conceptual row) in the pimInterfaceTable.')
...
if mibBuilder.loadTexts:
    pimInterfaceAddress.setDescription('The IP address of the PIM interface.')
pimInterfaceNetMask = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 2, 1, 3), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimInterfaceNetMask.setDescription('The network mask for the IP address of the PIM interface.')
pimInterfaceMode = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 2, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('dense',
                                                                                                                                                                                       1), ('sparse',
                                                                                                                                                                                            2), ('sparseDense',
                                                                                                                                                                                                 3))).clone('dense')).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    pimInterfaceMode.setDescription('The configured mode of this PIM interface.  A value of\n            sparseDense is only valid for PIMv1.')
pimInterfaceDR = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 2, 1, 5), IpAddress()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimInterfaceDR.setDescription('The Designated Router on this PIM interface.  For point-to-\n            point interfaces, this object has the value 0.0.0.0.')
...
if mibBuilder.loadTexts:
    pimInterfaceJoinPruneInterval.setDescription('The frequency at which PIM Join/Prune messages are\n            transmitted on this PIM interface.  The default value of\n            this object is the pimJoinPruneInterval.')
...
pimNeighborEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 3, 1)).setIndexNames((0, 'PIM-MIB',
                                                                               'pimNeighborAddress'))
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    pimNeighborAddress.setDescription('The IP address of the PIM neighbor for which this entry\n            contains information.')
...
if mibBuilder.loadTexts:
    pimNeighborExpiryTime.setDescription('The minimum time remaining before this PIM neighbor will be\n            aged out.')
pimNeighborMode = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 3, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('dense',
                                                                                                                                                                                   1), ('sparse',
                                                                                                                                                                                        2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimNeighborMode.setDescription('The active PIM mode of this neighbor.  This object is\n            deprecated for PIMv2 routers since all neighbors on the\n            interface must be either dense or sparse as determined by\n            the protocol running on the interface.')
pimIpMRouteTable = MibTable((1, 3, 6, 1, 3, 61, 1, 1, 4))
if mibBuilder.loadTexts:
    pimIpMRouteTable.setDescription('The (conceptual) table listing PIM-specific information on\n            a subset of the rows of the ipMRouteTable defined in the IP\n            Multicast MIB.')
pimIpMRouteEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 4, 1)).setIndexNames((0, 'IPMROUTE-STD-MIB',
                                                                               'ipMRouteGroup'), (0,
                                                                                                  'IPMROUTE-STD-MIB',
                                                                                                  'ipMRouteSource'), (0,
                                                                                                                      'IPMROUTE-STD-MIB',
...
if mibBuilder.loadTexts:
    pimIpMRouteNextHopEntry.setDescription('An entry (conceptual row) in the pimIpMRouteNextHopTable.\n            There is one entry per entry in the ipMRouteNextHopTable\n            whose interface is running PIM and whose\n            ipMRouteNextHopState is pruned(1).')
pimIpMRouteNextHopPruneReason = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 7, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(('other',
                                                                                                                                                                                                    1), ('prune',
                                                                                                                                                                                                         2), ('assert',
                                                                                                                                                                                                              3)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimIpMRouteNextHopPruneReason.setDescription('This object indicates why the downstream interface was\n            pruned, whether in response to a PIM prune message or due to\n            PIM Assert processing.')
pimRPTable = MibTable((1, 3, 6, 1, 3, 61, 1, 1, 5))
if mibBuilder.loadTexts:
    pimRPTable.setDescription('The (conceptual) table listing PIM version 1 information\n            for the Rendezvous Points (RPs) for IP multicast groups.\n            This table is deprecated since its function is replaced by\n            the pimRPSetTable for PIM version 2.')
pimRPEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 5, 1)).setIndexNames((0, 'PIM-MIB',
                                                                         'pimRPGroupAddress'), (0,
                                                                                                'PIM-MIB',
                                                                                                'pimRPAddress'))
if mibBuilder.loadTexts:
    pimRPEntry.setDescription('An entry (conceptual row) in the pimRPTable.  There is one\n            entry per RP address for each IP multicast group.')
pimRPGroupAddress = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 1), IpAddress())
if mibBuilder.loadTexts:
    pimRPGroupAddress.setDescription('The IP multicast group address for which this entry\n            contains information about an RP.')
pimRPAddress = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 2), IpAddress())
if mibBuilder.loadTexts:
    pimRPAddress.setDescription('The unicast address of the RP.')
pimRPState = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(('up',
                                                                                                                                                                              1), ('down',
                                                                                                                                                                                   2)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimRPState.setDescription('The state of the RP.')
pimRPStateTimer = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 4), TimeTicks()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimRPStateTimer.setDescription('The minimum time remaining before the next state change.\n            When pimRPState is up, this is the minimum time which must\n            expire until it can be declared down.  When pimRPState is\n            down, this is the time until it will be declared up (in\n            order to retry).')
pimRPLastChange = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 5), TimeTicks()).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    pimRPLastChange.setDescription('The value of sysUpTime at the time when the corresponding\n            instance of pimRPState last changed its value.')
pimRPRowStatus = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 6), RowStatus()).setMaxAccess('readcreate')
if mibBuilder.loadTexts:
    pimRPRowStatus.setDescription('The status of this row, by which new entries may be\n            created, or old entries deleted from this table.')
pimRPSetTable = MibTable((1, 3, 6, 1, 3, 61, 1, 1, 6))
if mibBuilder.loadTexts:
    pimRPSetTable.setDescription('The (conceptual) table listing PIM information for\n            candidate Rendezvous Points (RPs) for IP multicast groups.\n            When the local router is the BSR, this information is\n            obtained from received Candidate-RP-Advertisements.  When\n            the local router is not the BSR, this information is\n            obtained from received RP-Set messages.')
pimRPSetEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 6, 1)).setIndexNames((0, 'PIM-MIB',
                                                                            'pimRPSetComponent'), (0,
                                                                                                   'PIM-MIB',
                                                                                                   'pimRPSetGroupAddress'), (0,
                                                                                                                             'PIM-MIB',
                                                                                                                             'pimRPSetGroupMask'), (0,
                                                                                                                                                    'PIM-MIB',
                                                                                                                                                    'pimRPSetAddress'))
if mibBuilder.loadTexts:
    pimRPSetEntry.setDescription('An entry (conceptual row) in the pimRPSetTable.')
pimRPSetGroupAddress = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 6, 1, 1), IpAddress())
if mibBuilder.loadTexts:
    pimRPSetGroupAddress.setDescription('The IP multicast group address which, when combined with\n            pimRPSetGroupMask, gives the group prefix for which this\n            entry contains information about the Candidate-RP.')
pimRPSetGroupMask = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 6, 1, 2), IpAddress())
if mibBuilder.loadTexts:
    pimRPSetGroupMask.setDescription('The multicast group address mask which, when combined with\n            pimRPSetGroupAddress, gives the group prefix for which this\n            entry contains information about the Candidate-RP.')
pimRPSetAddress = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 6, 1, 3), IpAddress())
if mibBuilder.loadTexts:
    pimRPSetAddress.setDescription('The IP address of the Candidate-RP.')
...
if mibBuilder.loadTexts:
    pimV1MIBCompliance.setDescription('The compliance statement for routers running PIMv1 and\n            implementing the PIM MIB.')
...
if mibBuilder.loadTexts:
    pimSparseV2MIBCompliance.setDescription('The compliance statement for routers running PIM Sparse\n            Mode and implementing the PIM MIB.')
pimDenseV2MIBCompliance = ModuleCompliance((1, 3, 6, 1, 3, 61, 2, 1, 3)).setObjects(*(('PIM-MIB', 'pimDenseV2MIBGroup'), ))
if mibBuilder.loadTexts:
    pimDenseV2MIBCompliance.setDescription('The compliance statement for routers running PIM Dense Mode\n            and implementing the PIM MIB.')
...
if mibBuilder.loadTexts:
    pimV2MIBGroup.setDescription('A collection of objects to support management of PIM Sparse\n            Mode (version 2) routers.')
pimDenseV2MIBGroup = ObjectGroup((1, 3, 6, 1, 3, 61, 2, 2, 5)).setObjects(*(('PIM-MIB', 'pimNeighborIfIndex'), ('PIM-MIB', 'pimNeighborUpTime'), ('PIM-MIB', 'pimNeighborExpiryTime'), ('PIM-MIB', 'pimInterfaceAddress'), ('PIM-MIB', 'pimInterfaceNetMask'), ('PIM-MIB', 'pimInterfaceDR'), ('PIM-MIB', 'pimInterfaceHelloInterval'), ('PIM-MIB', 'pimInterfaceStatus'), ('PIM-MIB', 'pimInterfaceMode')))
if mibBuilder.loadTexts:
    pimDenseV2MIBGroup.setDescription('A collection of objects to support management of PIM Dense\n            Mode (version 2) routers.')
...
if mibBuilder.loadTexts:
    pimV2CandidateRPMIBGroup.setDescription('A collection of objects to support configuration of which\n            groups a router is to advertise itself as a Candidate-RP.')
