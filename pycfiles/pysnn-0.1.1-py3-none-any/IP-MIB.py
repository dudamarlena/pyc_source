...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/IP-MIB.py
...
class IpAddressOriginTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('manual', 2), ('dhcp', 4), ('linklayer',
                                                                         5), ('random',
                                                                              6))
...
class IpAddressStatusTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('preferred', 1), ('deprecated', 2), ('invalid', 3), ('inaccessible',
                                                                                    4), ('unknown',
                                                                                         5), ('tentative',
                                                                                              6), ('duplicate',
                                                                                                   7), ('optimistic',
...
class IpAddressPrefixOriginTC(Integer32, TextualConvention):
    ...
    namedValues = NamedValues(('other', 1), ('manual', 2), ('wellknown', 3), ('dhcp',
                                                                              4), ('routeradv',
                                                                                   5))
