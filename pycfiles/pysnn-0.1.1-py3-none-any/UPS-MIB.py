...
# Embedded file name: build/bdist.linux-x86_64/egg/pysnmp_mibs/UPS-MIB.py
# Compiled at: 2016-02-13 18:32:33
...
if mibBuilder.loadTexts:
    upsMIB.setContactInfo('        Jeffrey D. Case\n\n                Postal: SNMP Research, Incorporated\n                        3001 Kimberlin Heights Road\n                        Knoxville, TN  37920\n                        US\n\n                   Tel: +1 615 573 1434\n                   Fax: +1 615 573 9197\n\n                E-mail: case@snmp.com')
if mibBuilder.loadTexts:
    upsMIB.setDescription('The MIB module to describe Uninterruptible Power\n               Supplies.')
...
if mibBuilder.loadTexts:
    upsIdentManufacturer.setDescription('The name of the UPS manufacturer.')
...
if mibBuilder.loadTexts:
    upsIdentModel.setDescription('The UPS Model designation.')
...
if mibBuilder.loadTexts:
    upsIdentUPSSoftwareVersion.setDescription('The UPS firmware/software version(s).  This variable\n               may or may not have the same value as\n               upsIdentAgentSoftwareVersion in some implementations.')
...
if mibBuilder.loadTexts:
    upsIdentAgentSoftwareVersion.setDescription('The UPS agent software version.  This variable may or\n               may not have the same value as\n               upsIdentUPSSoftwareVersion in some implementations.')
...
if mibBuilder.loadTexts:
    upsIdentName.setDescription('A string identifying the UPS.  This object should be\n               set by the administrator.')
...
if mibBuilder.loadTexts:
    upsIdentAttachedDevices.setDescription('A string identifying the devices attached to the\n               output(s) of the UPS.  This object should be set by\n               the administrator.')
upsBattery = MibIdentifier((1, 3, 6, 1, 2, 1, 33, 1, 2))
upsBatteryStatus = MibScalar((1, 3, 6, 1, 2, 1, 33, 1, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(('unknown',
                                                                                                                                                                                  1), ('batteryNormal',
                                                                                                                                                                                       2), ('batteryLow',
                                                                                                                                                                                            3), ('batteryDepleted',
                                                                                                                                                                                                 4)))).setMaxAccess('readonly')
if mibBuilder.loadTexts:
    upsBatteryStatus.setDescription("The indication of the capacity remaining in the UPS\n               system's batteries.   A value of batteryNormal\n               indicates that the remaining run-time is greater than\n               upsConfigLowBattTime.  A value of batteryLow indicates\n               that the remaining battery run-time is less than or\n               equal to upsConfigLowBattTime.  A value of\n               batteryDepleted indicates that the UPS will be unable\n               to sustain the present load when and if the utility\n               power is lost (including the possibility that the\n               utility power is currently absent and the UPS is\n               unable to sustain the output).")
upsSecondsOnBattery = MibScalar((1, 3, 6, 1, 2, 1, 33, 1, 2, 2), NonNegativeInteger()).setUnits('seconds').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    upsSecondsOnBattery.setDescription('If the unit is on battery power, the elapsed time\n               since the UPS last switched to battery power, or the\n               time since the network management subsystem was last\n               restarted, whichever is less.  Zero shall be returned\n               if the unit is not on battery power.')
upsEstimatedMinutesRemaining = MibScalar((1, 3, 6, 1, 2, 1, 33, 1, 2, 3), PositiveInteger()).setUnits('minutes').setMaxAccess('readonly')
if mibBuilder.loadTexts:
    upsEstimatedMinutesRemaining.setDescription('An estimate of the time to battery charge depletion\n               under the present load conditions if the utility power\n               is off and remains off, or if it were to be lost and\n               remain off.')
...
if mibBuilder.loadTexts:
    upsOutputPercentLoad.setDescription('The percentage of the UPS power capacity presently\n               being used on this output line, i.e., the greater of\n               the percent load of true power capacity and the\n               percent load of VA.')
...
if mibBuilder.loadTexts:
    upsConfigLowVoltageTransferPoint.setDescription('The minimum input line voltage allowed before the UPS\n               system transfers to battery backup.')
...
if mibBuilder.loadTexts:
    upsConfigHighVoltageTransferPoint.setDescription('The maximum line voltage allowed before the UPS\n               system transfers to battery backup.')
...
if mibBuilder.loadTexts:
    upsTrapOnBattery.setDescription('The UPS is operating on battery power.  This trap is\n               persistent and is resent at one minute intervals until\n               the UPS either turns off or is no longer running on\n               battery.')
...
if mibBuilder.loadTexts:
    upsSubsetCompliance.setDescription('The compliance statement for UPSs that only support\n               the two-contact communication protocol.')
...
if mibBuilder.loadTexts:
    upsBasicCompliance.setDescription('The compliance statement for UPSs that support\n               full-featured functions, such as control.')
...
if mibBuilder.loadTexts:
    upsFullCompliance.setDescription('The compliance statement for UPSs that support\n               advanced full-featured functions.')
...
if mibBuilder.loadTexts:
    upsSubsetAlarmGroup.setDescription('The upsSubsetAlarmGroup defines the objects that are\n               common to the Alarm groups of two-contact UPSs.')
...
if mibBuilder.loadTexts:
    upsSubsetControlGroup.setDescription('The upsSubsetControlGroup defines the objects that\n               are common to the Control groups of two-contact UPSs.')
...
if mibBuilder.loadTexts:
    upsSubsetConfigGroup.setDescription('The upsSubsetConfigGroup defines the objects that are\n               common to the Config groups of two-contact UPSs.')
...
if mibBuilder.loadTexts:
    upsBasicInputGroup.setDescription('The upsBasicInputGroup defines the objects that are\n               common to the Input groups of compliant UPSs which\n               support basic functions.')
...
if mibBuilder.loadTexts:
    upsBasicOutputGroup.setDescription('The upsBasicOutputGroup defines the objects that are\n               common to the Output groups of compliant UPSs which\n               support basic functions.')
...
if mibBuilder.loadTexts:
    upsBasicBypassGroup.setDescription('The upsBasicBypassGroup defines the objects that are\n               common to the Bypass groups of compliant UPSs which\n               support basic functions.')
...
if mibBuilder.loadTexts:
    upsBasicAlarmGroup.setDescription('The upsBasicAlarmGroup defines the objects that are\n               common to the Alarm  groups of compliant UPSs which\n               support basic functions.')
...
if mibBuilder.loadTexts:
    upsBasicTestGroup.setDescription('The upsBasicTestGroup defines the objects that are\n               common to the Test groups of compliant UPSs which\n               support basic functions.')
...
if mibBuilder.loadTexts:
    upsBasicControlGroup.setDescription('The upsBasicControlGroup defines the objects that are\n               common to the Control groups of compliant UPSs which\n               support basic functions.')
...
if mibBuilder.loadTexts:
    upsBasicConfigGroup.setDescription('The upsBasicConfigGroup defines the objects that are\n               common to the Config groups of UPSs which support\n               basic functions.')
...
if mibBuilder.loadTexts:
    upsFullIdentGroup.setDescription('The upsFullIdentGroup defines objects which are\n               common to the Ident group of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullBatteryGroup.setDescription('The upsFullBatteryGroup defines the objects that are\n               common to the battery groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullInputGroup.setDescription('The upsFullInputGroup defines the objects that are\n               common to the Input groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullOutputGroup.setDescription('The upsFullOutputGroup defines the objects that are\n               common to the Output groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullBypassGroup.setDescription('The upsFullBypassGroup defines the objects that are\n               common to the Bypass groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullAlarmGroup.setDescription('The upsFullAlarmGroup defines the objects that are\n               common to the Alarm  groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullTestGroup.setDescription('The upsFullTestGroup defines the objects that are\n               common to the Test groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullControlGroup.setDescription('The upsFullControlGroup defines the objects that are\n   common to the Control groups of fully compliant UPSs.')
...
if mibBuilder.loadTexts:
    upsFullConfigGroup.setDescription('The upsFullConfigGroup defines the objects that are\n               common to the Config groups of fully compliant UPSs.')
