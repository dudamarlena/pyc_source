...
# [GCC 8.4.0]
# Embedded file name: /Users/sage/fatedoc/FATE/arch/api/federation.py
# Compiled at: 2020-05-04 00:28:49
...
def init(job_id: str, runtime_conf, server_conf_path='arch/conf/server_conf.json'):
    ...
    RuntimeInstance.FEDERATION = builder.build_federation(federation_id=job_id, runtime_conf=runtime_conf,
