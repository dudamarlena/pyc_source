...
# [GCC 8.4.0]
# Embedded file name: /Users/sage/fatedoc/FATE/fate_flow/fate_flow_server.py
# Compiled at: 2020-05-06 03:08:10
# Size of source mod 2**32: 5526 bytes
import os, signal, sys, time
from concurrent import futures
import traceback, grpc
from flask import Flask
from grpc._cython import cygrpc
from werkzeug.serving import run_simple
from werkzeug.wsgi import DispatcherMiddleware
from fate_flow.utils.proto_compatibility import proxy_pb2_grpc
import fate_flow.apps.data_access_app as data_access_app_manager
import fate_flow.apps.job_app as job_app_manager
import fate_flow.apps.model_app as model_app_manager
import fate_flow.apps.pipeline_app as pipeline_app_manager
import fate_flow.apps.table_app as table_app_manager
import fate_flow.apps.tracking_app as tracking_app_manager
import fate_flow.apps.schedule_app as schedule_app_manager
import fate_flow.apps.permission_app as permission_app_manager
...
from fate_flow.settings import IP, GRPC_PORT, CLUSTER_STANDALONE_JOB_SERVER_PORT, _ONE_DAY_IN_SECONDS, MAX_CONCURRENT_JOB_RUN, stat_logger, API_VERSION, ZOOKEEPER_HOSTS, USE_CONFIGURATION_CENTER, SERVINGS_ZK_PATH, FATE_FLOW_ZK_PATH, HTTP_PORT, FATE_FLOW_MODEL_TRANSFER_PATH, DETECT_TABLE
...
if __name__ == '__main__':
    ...
    app = DispatcherMiddleware(manager, {'/{}/data'.format(API_VERSION): data_access_app_manager, 
    ...
    PrivilegeAuth.init()
    CenterConfig.init(ZOOKEEPER_HOSTS, USE_CONFIGURATION_CENTER, FATE_FLOW_ZK_PATH, HTTP_PORT, FATE_FLOW_MODEL_TRANSFER_PATH)
    job_detector.JobDetector(interval=5000).start()
