...
# [GCC 8.4.0]
# Embedded file name: /Users/sage/fatedoc/FATE/arch/api/impl/based_1x/build.py
...
class Builder(build.Builder):
    ...
    def build_session(self):
        return build_session(job_id=(self._session_id), work_mode=(self._work_mode), persistent_engine=(self._persistent_engine))
    ...
    def build_federation(self, federation_id, runtime_conf, server_conf_path):
        ...
        if self._work_mode.is_cluster():
            ...
            if CONF_KEY_FEDERATION not in server_conf.get(CONF_KEY_SERVER):
                raise EnvironmentError('The {} should be a json file containing key: {}'.format(server_conf_path, CONF_KEY_FEDERATION))
