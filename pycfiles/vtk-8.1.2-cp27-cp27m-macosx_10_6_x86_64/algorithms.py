...
# [GCC 8.4.0]
# Embedded file name: /Users/prabhu/src/git/VTKPythonPackage/VTK-osx_2.7/Wrapping/Python/vtk/numpy_interface/algorithms.py
...
def apply_dfunc(dfunc, array1, val2):
    ...
    if type(array1) == dsa.VTKCompositeDataArray and type(val2) == dsa.VTKCompositeDataArray:
        ...
        if type(array1) == dsa.VTKCompositeDataArray:
            res = []
...
def make_mask_from_NaNs(array, ghost_array=dsa.NoneArray, is_cell=False):
    ...
    return bitwise_or(isnan(array).astype(numpy.uint8) * mask_value, ghost_array)
