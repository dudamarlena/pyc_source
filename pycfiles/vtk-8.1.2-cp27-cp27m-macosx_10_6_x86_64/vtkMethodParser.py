...
# [GCC 8.4.0]
# Embedded file name: /Users/prabhu/src/git/VTKPythonPackage/VTK-osx_2.7/Wrapping/Python/vtk/util/vtkMethodParser.py
...
class VtkDirMethodParser:
    ...
    def parse_methods(self, vtk_obj):
        ...
        for method in self.methods[:]:
            if method[:3].find('Set') >= 0 and self.state_patn.search(method) is not None:
                try:
