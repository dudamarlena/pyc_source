...
# [GCC 8.4.0]
# Embedded file name: /Users/prabhu/src/git/VTKPythonPackage/VTK-osx_2.7/Wrapping/Python/vtk/util/vtkImageExportToArray.py
...
Methods from vtkImageExport
  ...
  GetDataOrigin()
"""
import numpy, numpy.core.umath as umath
...
class vtkImageExportToArray:
    ...
    __typeDict = {VTK_SIGNED_CHAR: 'b', VTK_UNSIGNED_CHAR: 'B', 
       VTK_SHORT: 'h', 
    ...
    def GetArray(self):
        ...
        if type == VTK_UNSIGNED_SHORT and self.__ConvertUnsignedShortToInt:
            imArray = umath.bitwise_and(imArray.astype('i'), 65535)
        return imArray
