...
# [GCC 8.4.0]
# Embedded file name: /Users/prabhu/src/git/VTKPythonPackage/VTK-osx_2.7/Wrapping/Python/vtk/util/_argparse.py
...
__all__ = [
 ...
 'SUPPRESS',
 'ZERO_OR_MORE']
import collections as _collections, copy as _copy, os as _os, re as _re, sys as _sys, textwrap as _textwrap
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    def _check_value(self, action, value):
        if action.choices is not None and value not in action.choices:
            tup = (
             value, (', ').join([ repr(x) for x in action.choices ]))
