...
# [GCC 8.4.0]
# Embedded file name: /Users/prabhu/src/git/VTKPythonPackage/VTK-osx_2.7/Wrapping/Python/vtk/wx/wxVTKRenderWindow.py
...
class wxVTKRenderWindow(baseClass):
    ...
    def __init__(self, parent, ID, *args, **kw):
        ...
        if baseClass.__name__ == 'GLCanvas':
            baseClass.__init__(self, parent, ID, pos=position, size=size, style=style, attribList=[
    ...
    def PickActor(self, event):
        ...
        if self._CurrentRenderer:
            ...
            if self._PickedActor != None and self._PrePickedProperty != None:
