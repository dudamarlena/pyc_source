...
# [GCC 8.4.0]
# Embedded file name: /Users/prabhu/src/git/VTKPythonPackage/VTK-osx_2.7/Wrapping/Python/vtk/test/Testing.py
...
import sys, os, time, os.path, unittest, getopt, vtk
...
def _printCDashImageError(img_err, err_index, img_base):
    ...
    print '<DartMeasurement name="ImageError" type="numeric/double"> %f </DartMeasurement>' % img_err
    if err_index <= 0:
        print '<DartMeasurement name="BaselineImage" type="text/string">Standard</DartMeasurement>'
    else:
        print '<DartMeasurement name="BaselineImage" type="numeric/integer"> %d </DartMeasurement>' % err_index
    print '<DartMeasurementFile name="TestImage" type="image/png"> %s </DartMeasurementFile>' % (img_base + '.png')
    print '<DartMeasurementFile name="DifferenceImage" type="image/png"> %s </DartMeasurementFile>' % (img_base + '.diff.png')
    print '<DartMeasurementFile name="ValidImage" type="image/png"> %s </DartMeasurementFile>' % (img_base + '.valid.png')
...
def main(cases):
    ...
    print '<DartMeasurement name="WallTime" type="numeric/double">  %f </DartMeasurement>' % tot_wall_time
    print '<DartMeasurement name="CPUTime" type="numeric/double">  %f </DartMeasurement>' % tot_time
    del cases
    del timer
