...
# Embedded file name: /Users/juancomish/miniconda3/lib/python3.7/site-packages/pyehub/multi_run_period.py
# Compiled at: 2019-07-30 13:57:16
# Size of source mod 2**32: 6373 bytes
import argparse, os, numpy as np, copy
...
import excel_to_request_format, pylp
...
def split_hubs(excel=None, request=None, max_carbon=None, num_periods=1, len_periods=24, num_periods_in_sample_period=1, sample_period_position=0):
    ...
    for i in range(0, num_periods):
        ...
        for stream in temp_request['time_series']:
            stream['data'] = stream['data'][len_periods * (i + i * (num_periods_in_sample_period - 1) + sample_period_position):len_periods * (i + 1 + i * (num_periods_in_sample_period - 1) + sample_period_position)]
