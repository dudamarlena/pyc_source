...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/wordtex/cloudtb/extra/PyQt/treeview.py
...
def _get_filelist_nodes(iter_file_list, dir_path=''):
    ...
    while True:
        ...
        if os.path.isdir(fpath):
            iter_file_list, new_files = _get_filelist_nodes(iter_file_list, dir_path=fpath)
            files.append((fpath, new_files))
        else:
            files.append((fpath,))

    return (
     iter_file_list, files)
