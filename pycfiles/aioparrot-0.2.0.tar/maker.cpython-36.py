...
# Embedded file name: /home/fw/development/AutoBuddy/aioouimeaux/aioouimeaux/device/maker.py
# Compiled at: 2017-11-22 04:42:45
        ...
        for attribute in attributes:
            if attribute[0].text == 'Switch':
                ...
                if attribute[0].text == 'Sensor':
                    ...
                    if attribute[0].text == 'SwitchMode':
                        switchmode = attribute[1].text
                    else:
                        if attribute[0].text == 'SensorPresent':
