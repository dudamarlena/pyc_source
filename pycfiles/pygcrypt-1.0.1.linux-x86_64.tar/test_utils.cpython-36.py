...
# [GCC 8.4.0]
# Embedded file name: /home/okhin/git/orage.io/pygcrypt/env/lib/python3.6/site-packages/pygcrypt/test/test_utils.py
# Compiled at: 2017-04-09 06:57:58
...
def test_utils_random(context):
    if not len(utils.rand(128)) <= 128:
        raise AssertionError
    elif not utils.rand(128) != utils.rand(128):
        raise AssertionError


def test_utils_srandom(context):
    if not len(utils.srand(128)) <= 128:
        raise AssertionError
    elif not utils.srand(128) != utils.srand(128):
        raise AssertionError