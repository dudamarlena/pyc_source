...
# [GCC 8.4.0]
# Embedded file name: /home/szczepan/.virtualenvs/pyh/lib/python2.7/site-packages/pyhistory/utilities.py
...
def format_line(prefix, content, line_length):
    ...
    lines = chain([
     _prefix_line(prefix, content[0])], [ _prefix_line(secondary_prefix, line) for line in content[1:] ])
    return ('\n').join(lines)
