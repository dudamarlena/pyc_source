...
# [GCC 8.4.0]
# Embedded file name: backstage/venue/venue_utils.py
# Compiled at: 2014-07-03 16:00:26
import os, sys
...
def use_venue(venue_home):
    ...
    paths = [
     venue.venue_home, venue.venue_root]
    for pth in paths:
    ...
    venue.themes = [
     'default', 'default24', 'fluid', 'container', 'hero']
    try:
        venue.connect()
    except:
