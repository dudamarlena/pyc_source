...
# [GCC 8.4.0]
# Embedded file name: backstage/utils/uwsgi/uwsgi_utils.py
# Compiled at: 2014-07-09 09:49:00
table = 'uwsgi_vassals'
config = 'dummy text'
uid = 'backstage'
gid = 'adm'
uwsgi_defaults = {'master': 'True', 
   'processes': '8', 
   ...
   'logfile-chown': 'true', 
   'logfile-chmod': '666'}
venue_seeds = {'home': '{VENUE_HOME}/venv', 
...
act_seeds = {'home': '{VENUE_HOME}/venv', 
   'virtualenv': '{VENUE_HOME}/venv', 
...
def build_uwsgi(obj, objtype):
    ...
    options = {'act': format_act_options, 
