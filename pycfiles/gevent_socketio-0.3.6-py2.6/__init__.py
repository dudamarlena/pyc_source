...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/socketio/__init__.py
# Compiled at: 2014-02-03 00:13:04
__version__ = (0, 3, 5)
import logging, gevent
log = logging.getLogger(__name__)

def socketio_manage(environ, namespaces, request=None, error_handler=None, json_loads=None, json_dumps=None):
