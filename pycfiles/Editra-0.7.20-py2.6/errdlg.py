...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/errdlg.py
...
__all__ = [
 ...
 'TimeStamp']
import os, sys, platform, time, traceback, wx, ecbasewin
_ = wx.GetTranslation
...
class ErrorDialog(ecbasewin.ECBaseDlg):
    ...
    def __init__(self, parent, id=wx.ID_ANY, title='', pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER, name='ErrorReporterDlg', message=''):
        ...
        super(ErrorDialog, self).__init__(parent, id, title, pos, size, style, name)
...
class ErrorPanel(wx.Panel):
    ...
    def __DoLayout(self):
        ...
        tctrl = wx.TextCtrl(self, value=self.err_msg, style=wx.TE_MULTILINE | wx.TE_READONLY)
