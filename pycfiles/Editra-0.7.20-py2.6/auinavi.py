...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/auinavi.py
...
class AuiPaneNavigator(wx.Dialog):
    ...
    def __init__(self, parent, auiMgr, icon=None, title=''):
        ...
        """
        super(AuiPaneNavigator, self).__init__(parent, wx.ID_ANY, '', style=wx.STAY_ON_TOP)
        self._auimgr = auiMgr
        ...
        self._navi_keys = [wx.WXK_TAB, ord('1')]
        self._listBox = None
        self._panel = None
    ...
    def __DoLayout(self, icon, title):
        ...
        self._listBox = wx.ListBox(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(200, 150), list(), wx.LB_SINGLE | wx.NO_BORDER)
        self._panel = ctrlbox.ControlBar(self, style=ctrlbox.CTRLBAR_STYLE_GRADIENT)
