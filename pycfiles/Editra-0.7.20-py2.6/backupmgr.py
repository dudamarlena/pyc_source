...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/ebmlib/backupmgr.py
...
__all__ = [
 'FileBackupMgr']
import os, shutil, fileutil, fchecker
...
class FileBackupMgr(object):
    ...
    def GetBackupFilename(self, fname):
        ...
        if self.header is not None and not self.checker.IsBinary(fname) and os.path.exists(rname):
