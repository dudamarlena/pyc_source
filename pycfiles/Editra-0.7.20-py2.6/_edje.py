...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_edje.py
...
EDJE_KW = (0, 'action after align aspect border clip_to color color2 color3 color_class effect fit font image inherit name normal max min mouse_events offset relative repeat_events signal size smooth source state step target text_class to to_x to_y transition tween type visible')
EDJE_SEC = (1, 'collections description fill group images part parts program programs rel1 rel2 text')
