...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/ed_print.py
# Compiled at: 2011-04-22 17:53:30
"""
...
import wx, wx.stc, ed_glob, util, extern.stcprint as stcprint
_ = wx.GetTranslation
COLOURMODES = {ed_glob.PRINT_BLACK_WHITE: wx.stc.STC_PRINT_BLACKONWHITE, ed_glob.PRINT_COLOR_WHITE: wx.stc.STC_PRINT_COLOURONWHITE, 
...
class EdPrinter(object):
    ...
    def CreatePrintout(self):
        ...
        printout = stcprint.STCPrintout(self.stc, page_setup_data=dlg_data, print_mode=colour, title=self.title, job_title=fname)
        return printout
