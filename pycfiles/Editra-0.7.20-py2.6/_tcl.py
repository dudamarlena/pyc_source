...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_tcl.py
...
SYNTAX_ITEMS = [
 (
  stc.STC_TCL_BLOCK_COMMENT, 'comment_style'),
 (
 ...
 (
  stc.STC_TCL_SUB_BRACE, 'string_style'),
 (
  stc.STC_TCL_WORD, 'keyword_style'),
 (
  stc.STC_TCL_WORD2, 'keyword2_style'),
 (
  stc.STC_TCL_WORD3, 'keyword3_style'),
 (
  stc.STC_TCL_WORD4, 'keyword4_style'),
 (
...
class SyntaxData(syndata.SyntaxDataBase):
    ...
    def GetKeywords(self):
        ...
        return [
         TCL_KW, TK_KW, ITCL_KW, TK_COMMANDS]
