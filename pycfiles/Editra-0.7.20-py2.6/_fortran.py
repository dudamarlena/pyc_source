...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_fortran.py
...
class SyntaxData(syndata.SyntaxDataBase):
    ...
    def GetKeywords(self):
        ...
        return [
         FORT_KEYWORDS, FORT_FUNC, FORT_EXT]
    ...
    def GetCommentPattern(self):
        ...
        if self.LangId == synglob.ID_LANG_F77:
            ...
            if self.LangId == synglob.ID_LANG_F95:
                return ['!']
            return list()
