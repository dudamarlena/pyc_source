...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_mako.py
...
(STC_MAKO_DEFAULT, STC_MAKO_COMMENT, STC_MAKO_NUMBER, STC_MAKO_STRING, STC_MAKO_STRINGEOL, STC_MAKO_SCALAR, STC_MAKO_OPERATOR, STC_MAKO_PREPROCESSOR, STC_MAKO_ATTRIBUTE, STC_MAKO_TAG, STC_MAKO_BUILTIN, STC_MAKO_KEYWORD) = range(12)
KEYWORDS = 'include inherit namespace page'
SYNTAX_ITEMS = [
 (
  STC_MAKO_DEFAULT, 'default_style'),
 (
...
def StyleText(stc, start, end):
    ...
    for (token, txt) in lexer.get_tokens(doctxt):
        ...
        if style == STC_MAKO_PREPROCESSOR and txt.startswith('#'):
...
TOKEN_MAP = {Token.Literal.String: STC_MAKO_STRING, Token.Comment.Preproc: STC_MAKO_PREPROCESSOR, 
