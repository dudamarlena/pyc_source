...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_haskell.py
...
HA_KEYWORDS = (0, 'as case class data default deriving do forall foreign hiding if import in infix infixl infixr instance else let mdo module newtype of qualified then type where')
SYNTAX_ITEMS = [
 (
  stc.STC_HA_CAPITAL, 'default_style'),
 (
 ...
 (
  stc.STC_HA_IMPORT, 'default_style'),
 (
