...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_postscript.py
...
SYNTAX_ITEMS = [
 ...
 (
  stc.STC_PS_DSC_VALUE, 'comment_style'),
 (
  stc.STC_PS_HEXSTRING, 'number_style'),
 (
  stc.STC_PS_IMMEVAL, 'comment_style'),
 (
 ...
 (
  stc.STC_PS_PAREN_ARRAY, 'default_style'),
 (
  stc.STC_PS_PAREN_DICT, 'default_style'),
 (
  stc.STC_PS_PAREN_PROC, 'default_style'),
 (
