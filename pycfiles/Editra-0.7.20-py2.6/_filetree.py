...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/_filetree.py
# Compiled at: 2013-01-05 14:59:58
"""
...
class FileTree(wx.TreeCtrl):
    ...
    def __init__(self, parent):
        super(FileTree, self).__init__(parent, style=wx.TR_HIDE_ROOT | wx.TR_FULL_ROW_HIGHLIGHT | wx.TR_LINES_AT_ROOT | wx.TR_HAS_BUTTONS | wx.TR_MULTIPLE | wx.TR_EDIT_LABELS)
        self._watch = list()
        self._il = None
