...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_nsis.py
...
SYNTAX_ITEMS = [
 (
  stc.STC_NSIS_DEFAULT, 'default_style'),
 (
