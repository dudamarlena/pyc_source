...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/extern/stcspellcheck.py
# Compiled at: 2011-11-30 22:04:32
...
class STCSpellCheck(object):
    ...
    def __init__(self, stc, *args, **kwargs):
        ...
        """
        self.stc = stc
        self.setIndicator(kwargs.get('indicator', 2), kwargs.get('indicator_color', '#FF0000'), kwargs.get('indicator_style', wx.stc.STC_INDIC_SQUIGGLE))
    ...
    def setIndicator(self, indicator=None, color=None, style=None):
        ...
        """
        indicators = {0: wx.stc.STC_INDIC0_MASK, 1: wx.stc.STC_INDIC1_MASK, 
        ...
        self.stc.IndicatorSetForeground(self._spelling_indicator, self._spelling_color)
        if style is not None:
            if style > wx.stc.STC_INDIC_MAX:
                style = wx.stc.STC_INDIC_MAX
            self._spelling_style = style
        self.stc.IndicatorSetStyle(self._spelling_indicator, self._spelling_style)
        return
