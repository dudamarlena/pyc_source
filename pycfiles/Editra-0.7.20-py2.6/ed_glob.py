...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/ed_glob.py
...
__all__ = [
 'CONFIG', 'SB_INFO', 'VERSION', 'PROG_NAME', 'ID_NEW', 'ID_OPEN',
...
PRINT_INVERT = 3
PRINT_NORMAL = 4
ID_2_PROF = {ID_PREF_AALIAS: 'AALIASING', 
...
def EOLModeMap():
    ...
    return {EOL_MODE_CR: _('Old Machintosh (\\r)'), EOL_MODE_LF: _('Unix (\\n)'), 
       EOL_MODE_CRLF: _('Windows (\\r\\n)')}


DEFAULT_PLUGINS = ('generator.Html', 'generator.LaTeX', 'generator.Rtf', 'iface.Shelf',
                   'ed_theme.TangoTheme', 'ed_log.EdLogViewer', 'ed_search.EdFindResults',
                   'ed_bookmark.EdBookmarks')