...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/extern/stcprint.py
# Compiled at: 2011-04-22 17:53:29
...
class STCPrintout(wx.Printout):
    ...
    def __init__(self, stc, page_setup_data=None, print_mode=None, title=None, border=False, lines_per_page=None, output_point_size=None, job_title=None):
        """Constructor.
    ...
    def GetPageInfo(self):
        ...
        """
        return (
         1, self.page_count, 1, self.page_count)
    ...
    def setHeaderFont(self, point_size=10, family=wx.FONTFAMILY_SWISS, style=wx.FONTSTYLE_NORMAL, weight=wx.FONTWEIGHT_NORMAL):
...
if __name__ == '__main__':
    ...
    class Frame(wx.Frame):
        ...
        def OnOpenFile(self, evt):
            dlg = wx.FileDialog(self, 'Choose a text file', defaultDir='', defaultFile='', wildcard='*')
        ...
        def showPrintPreview(self):
            ...
            if preview.IsOk():
                ...
                wx.MessageBox(_('Failed to create print preview'), _('Print Error'), style=wx.ICON_ERROR | wx.OK)
        ...
        def showPrint(self):
            ...
            if result:
                ...
                wx.MessageBox(_('There was an error when printing.\nCheck that your printer is properly connected.'), _('Printer Error'), style=wx.ICON_ERROR | wx.OK)
            printout.Destroy()
