...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/extern/pygments/lexers/_phpbuiltins.py
...
MODULES = {'.NET': ['dotnet_load'], 'APD': [
   ...
   'Pspell': [
            ...
            'pspell_suggest'], 
   'Rar': [
         'rar_close', 'rar_entry_get', 'rar_list', 'rar_open'], 
   'Readline': [
              'readline',
...
if __name__ == '__main__':
    ...
    def get_function_module(func_name):
        ...
        regex = re.compile('<li class="header up"><a href="ref\\..*?\\.php">([a-zA-Z0-9\\s]+)</a></li>')
        for line in uf:
