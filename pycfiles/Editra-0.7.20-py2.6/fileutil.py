...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/ebmlib/fileutil.py
...
__all__ = [
 'GetAbsPath', 'GetFileExtension', 'GetFileModTime', 'GetFileName',
...
import wx, ctypes, os, platform, urllib2, stat, subprocess
UNIX = WIN = False
...
class File(object):
    ...
    ModTime = property(lambda self: self.modtime, lambda self, mod: setattr(self, 'modtime', mod))
