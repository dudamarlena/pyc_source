...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_masm.py
...
class SyntaxData(syndata.SyntaxDataBase):
    ...
    def GetKeywords(self):
        ...
        return [
         MASM_CPU_INST, MASM_FPU_INST, MASM_REGISTERS, MASM_DIRECTIVES,
