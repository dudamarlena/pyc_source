...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/eclutil.py
...
__all__ = [
 'AdjustAlpha', 'AdjustColour', 'BestLabelColour', 'HexToRGB',
...
DRAW_CIRCLE_LARGE = 2
__CircleDefs = {DRAW_CIRCLE_SMALL: dict(size=(8, 8), xpath=(
                     (1.75, 2), (4.75, 5),
                     (1.75, 5), (4.75, 2))), 
   DRAW_CIRCLE_NORMAL: dict(size=(16, 16), xpath=(
                      (4.5, 4), (10.5, 10),
                      (4.5, 10), (10.5, 4))), 
   DRAW_CIRCLE_LARGE: dict(size=(32, 32), xpath=(
                     (8, 8), (20, 20),
                     (8, 20), (20, 8)))}
...
def AdjustColour(color, percent, alpha=wx.ALPHA_OPAQUE):
    ...
    """
    (radj, gadj, badj) = [ int(val * (abs(percent) / 100.0)) for val in color.Get()
                         ]
    if percent < 0:
