...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_css.py
...
class SyntaxData(syndata.SyntaxDataBase):
    ...
    def GetKeywords(self):
        ...
        kwlist = [
         CSS1_KEYWORDS, CSS_PSUEDO_CLASS]
        if wx.VERSION < (2, 9, 0, 0, ''):
            css2_kw = (
             CSS2_KEYWORDS[0], (' ').join((CSS2_KEYWORDS[1], CSS3_KEYWORDS[1])))
