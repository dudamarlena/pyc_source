...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/filterdlg.py
# Compiled at: 2010-08-07 18:48:54
"""
...
class FilterDialog(ecbasewin.ECBaseDlg):
    ...
    def __init__(self, parent, id=wx.ID_ANY, title='', pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE, name='FilterDialog'):
        super(FilterDialog, self).__init__(parent, id, title, pos, size, style, name)
...
class FilterPanel(wx.Panel):
    ...
    def OnButton(self, evt):
        ...
        if e_id in (wx.ID_ADD, wx.ID_REMOVE):
            cmap = {wx.ID_ADD: (self._left, self._right), wx.ID_REMOVE: (self._right, self._left)}
            idxs = list()
