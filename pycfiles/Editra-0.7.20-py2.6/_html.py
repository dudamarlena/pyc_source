...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_html.py
...
SYNTAX_ITEMS = [
 (
  stc.STC_H_DEFAULT, 'default_style'),
 (
 ...
 (
  stc.STC_H_CDATA, 'default_style'),
 (
  stc.STC_H_COMMENT, 'comment_style'),
 (
  stc.STC_H_DOUBLESTRING, 'string_style'),
 (
  stc.STC_H_ENTITY, 'default_style'),
 (
  stc.STC_H_NUMBER, 'number_style'),
 (
  stc.STC_H_OTHER, 'default_style'),
 (
  stc.STC_H_QUESTION, 'scalar_style'),
 (
  stc.STC_H_SCRIPT, 'funct_style'),
 (
  stc.STC_H_SGML_1ST_PARAM, 'keyword2_style'),
 (
  stc.STC_H_SGML_1ST_PARAM_COMMENT, 'comment_style'),
 (
  stc.STC_H_SGML_BLOCK_DEFAULT, 'default_style'),
 (
  stc.STC_H_SGML_COMMAND, 'keyword_style'),
 (
  stc.STC_H_SGML_COMMENT, 'comment_style'),
 (
  stc.STC_H_SGML_DEFAULT, 'array_style'),
 (
  stc.STC_H_SGML_DOUBLESTRING, 'string_style'),
 (
  stc.STC_H_SGML_ENTITY, 'default_style'),
 (
  stc.STC_H_SGML_ERROR, 'error_style'),
 (
  stc.STC_H_SGML_SIMPLESTRING, 'string_style'),
 (
  stc.STC_H_SGML_SPECIAL, 'default_style'),
 (
 ...
 (
  stc.STC_HJ_DOUBLESTRING, 'default_style'),
 (
  stc.STC_HJ_KEYWORD, 'default_style'),
 (
  stc.STC_HJ_NUMBER, 'default_style'),
 (
  stc.STC_HJ_REGEX, 'default_style'),
 (
  stc.STC_HJ_SINGLESTRING, 'default_style'),
 (
  stc.STC_HJ_START, 'default_style'),
 (
  stc.STC_HJ_STRINGEOL, 'default_style'),
 (
  stc.STC_HJ_SYMBOLS, 'default_style'),
 (
  stc.STC_HJ_WORD, 'default_style'),
 (
 ...
 (
  stc.STC_HJA_DOUBLESTRING, 'default_style'),
 (
  stc.STC_HJA_KEYWORD, 'default_style'),
 (
  stc.STC_HJA_NUMBER, 'default_style'),
 (
  stc.STC_HJA_REGEX, 'default_style'),
 (
  stc.STC_HJA_SINGLESTRING, 'default_style'),
 (
  stc.STC_HJA_START, 'default_style'),
 (
  stc.STC_HJA_STRINGEOL, 'default_style'),
 (
  stc.STC_HJA_SYMBOLS, 'default_style'),
 (
  stc.STC_HJA_WORD, 'default_style'),
 (
  stc.STC_HBA_DEFAULT, 'operator_style'),
 (
  stc.STC_HBA_COMMENTLINE, 'comment_style'),
 (
  stc.STC_HBA_IDENTIFIER, 'default_style'),
 (
  stc.STC_HBA_NUMBER, 'number_style'),
 (
  stc.STC_HBA_START, 'default_style'),
 (
...
class SyntaxData(syndata.SyntaxDataBase):
    ...
    def GetKeywords(self):
        ...
        if self.LangId == synglob.ID_LANG_COLDFUSION:
            ...
            return [
             HTML_TAGS, JS_KEYWORDS, SGML_KEYWORDS, VBS_KEYWORDS]
...
def AutoIndenter(estc, pos, ichar):
    ...
    if tmp.endswith('>'):
        ...
        if tagstart >= 0:
            tagval = tmp[tagstart:]
            if not tagval.startswith('</') and not tagval.endswith('/>') and not tagval.endswith('?>'):
                levels = tagstart / tabw
