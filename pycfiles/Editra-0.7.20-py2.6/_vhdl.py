...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_vhdl.py
...
VHDL_AT = (2, "'high 'left 'length 'low 'range 'reverse_range 'right 'foreign 'ascending 'behavior 'structure 'simple_name 'instance_name 'path_name 'active 'delayed 'event 'last_active 'last_event 'last_value 'quiet 'stable 'transaction 'driving 'driving_value 'base 'high 'left 'leftof 'low 'pos 'pred 'rightof 'succ 'val 'image 'value")
VHDL_STDF = (3, 'now readline read writeline write endfile to_stdulogicvector to_bitvector to_stdulogic to_stdlogicvector resolved to_bit  to_x01 to_x01z to_UX01 rising_edge falling_edge is_x shift_right rotate_left rotate_right resize to_integer to_unsigned to_signed std_match to_01 shift_left ')
VHDL_STDP = (4, 'std ieee work standard textio std_logic_1164 std_logic_arith std_logic_misc std_logic_signed std_logic_textio numeric_bit numeric_std math_complex math_real vital_timing std_logic_unsigned vital_primitives ')
...
SYNTAX_ITEMS = [
 (
  stc.STC_VHDL_DEFAULT, 'default_style'),
 (
  stc.STC_VHDL_ATTRIBUTE, 'default_style'),
 (
...
class SyntaxData(syndata.SyntaxDataBase):
    ...
    def GetKeywords(self):
        ...
        return [
         VHDL_KW, VHDL_AT, VHDL_STDF, VHDL_STDP, VHDL_STDT]
