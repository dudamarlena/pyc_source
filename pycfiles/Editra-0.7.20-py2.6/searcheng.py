...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/ebmlib/searcheng.py
...
__all__ = [
 'SearchEngine']
import os, re, fnmatch, types, unicodedata
...
class SearchEngine(object):
    ...
    def SearchInDirectory(self, directory, recursive=True):
        ...
        if self._regex is None:
            ...
            paths = [ os.path.join(directory, fname) for fname in os.listdir(directory) if not fname.startswith('.') ]
