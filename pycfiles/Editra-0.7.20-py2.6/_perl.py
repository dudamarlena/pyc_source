...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/syntax/_perl.py
...
SYNTAX_ITEMS = [
 ...
 (
  stc.STC_PL_DATASECTION, 'default_style'),
 (
 ...
 (
  stc.STC_PL_LONGQUOTE, 'default_style'),
 (
 ...
 (
  stc.STC_PL_PUNCTUATION, 'default_style'),
 (
 ...
 (
  stc.STC_PL_SYMBOLTABLE, 'default_style'),
 (
  stc.STC_PL_WORD, 'keyword_style')]
if wx.VERSION >= (2, 9, 0, 0, ''):
    SYNTAX_ITEMS.append((stc.STC_PL_FORMAT, 'default_style'))
    SYNTAX_ITEMS.append((stc.STC_PL_FORMAT_IDENT, 'default_style'))
    SYNTAX_ITEMS.append((stc.STC_PL_SUB_PROTOTYPE, 'default_style'))
FOLD = ('fold', '1')
