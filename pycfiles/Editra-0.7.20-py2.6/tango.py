...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/extern/pygments/styles/tango.py
...
class TangoStyle(Style):
    ...
    default_style = ''
    styles = {Whitespace: 'underline #f8f8f8', 
       Error: '#a40000 border:#ef2929', 
       Other: '#000000', 
       Comment: 'italic #8f5902', 
       Comment.Multiline: 'italic #8f5902', 
       Comment.Preproc: 'italic #8f5902', 
       Comment.Single: 'italic #8f5902', 
       Comment.Special: 'italic #8f5902', 
       Keyword: 'bold #204a87', 
       ...
       Number: 'bold #0000cf', 
       Number.Float: 'bold #0000cf', 
       Number.Hex: 'bold #0000cf', 
       Number.Integer: 'bold #0000cf', 
       Number.Integer.Long: 'bold #0000cf', 
       Number.Oct: 'bold #0000cf', 
       Literal: '#000000', 
       Literal.Date: '#000000', 
       String: '#4e9a06', 
