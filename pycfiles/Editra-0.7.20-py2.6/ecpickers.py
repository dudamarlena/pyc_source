...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/ecpickers.py
...
class PyFontPicker(wx.Panel):
    ...
    def ShowFontDlg(self):
        ...
        if fdlg.ShowModal() == wx.ID_OK:
            ...
            wx.PostEvent(self, wx.FontPickerEvent(self, self.GetId(), fdata.GetChosenFont()))
        fdlg.Destroy()