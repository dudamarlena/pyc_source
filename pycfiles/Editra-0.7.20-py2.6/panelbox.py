...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/Editra/src/eclib/panelbox.py
# Compiled at: 2011-03-18 14:09:10
"""
...
class PanelBox(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.HSCROLL | wx.VSCROLL, name='PanelBox'):
    ...
    def OnItemClicked(self, evt):
        ...
        if idx == -1:
            ...
            self._last_sel = selected or idx
        else:
            self._last_sel = -1
...
class PanelBoxItemBase(wx.PyPanel):
    ...
    def __init__(self, parent):
        ...
        super(PanelBoxItemBase, self).__init__(parent, style=wx.NO_BORDER | wx.TAB_TRAVERSAL)
    ...
    def _UpdateForeground(self, color):
        ...
        """
        if sum(color.Get()[:3]) < 381:
            ncolor = wx.WHITE
        else:
            ncolor = wx.BLACK
        for child in self.GetChildren():
            if hasattr(child, 'SetForegroundColour') and not isinstance(child, wx.Button):
