...
# Embedded file name: build/bdist.macosx-10.3-i386/egg/catwalk/test/model.py
# Compiled at: 2009-01-11 13:19:44
...
class Document(DeclarativeBase):
    ...
    address = synonym('address', descriptor=property(_get_address, _set_address))