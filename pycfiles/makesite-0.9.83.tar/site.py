...
# [GCC 8.4.0]
# Embedded file name: /home/klen/Projects/makesite/makesite/site.py
# Compiled at: 2012-09-07 10:21:37
...
class Site(settings.MakesiteParser):
    ...
    def run_check(self, template_name=None, service_dir=None):
        ...
        map(lambda cmd: call('bash %s' % cmd), self._gen_scripts('check', template_name=template_name, service_dir=service_dir))
        return True
    ...
    def add_template(self, template_name):
        assert template_name not in self.templates, 'Template already installed.'
