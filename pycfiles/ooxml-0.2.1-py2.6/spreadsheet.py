...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ooxml/spreadsheet.py
# Compiled at: 2011-03-05 00:03:13
import os, sys
...
class Spreadsheet(OOXMLBase):
    ...
    def _get_part_relationship(self):
        ...
        for elm in doc.tree:
            self.part_relationship[elm.get('Id')] = (
             elm.get('Type'), elm.get('Target'))
    ...
    def add_sheet(self, name):
        ...
        if not self.docpath:
            self.docpath = 'xl'
        self._sheet[id] = Worksheet(name, self, '')
