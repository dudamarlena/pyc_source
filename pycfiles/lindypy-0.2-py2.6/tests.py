...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/lindypy/tests.py
# Compiled at: 2011-03-07 15:10:35
import os, sys, time, unittest, multiprocessing
from lindypy import *
...
class TestCase000Space(unittest.TestCase):
    ...
    def testComplexPatterns(self):
        ...
        self.assertEqual(ts.get((1, 2, object, object, 5, object)), (1, 2, 3, 4, 5,
                                                                     6))
