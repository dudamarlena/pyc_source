...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/DoapView/DoapView.py
# Compiled at: 2008-07-04 00:28:08
"""
DoapView
...
LOADER = TemplateLoader(get_templates_dir(), auto_reload=True)
...
class DoapViewMacro(WikiMacroBase):
    ...
    def expand_macro(self, formatter, name, content):
        ...
        return tmpl.generate(name=doap.name, doap=doap, foaf=FOAF).render('html', doctype='html')