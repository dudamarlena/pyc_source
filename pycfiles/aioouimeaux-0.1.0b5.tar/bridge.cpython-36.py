...
# [GCC 8.4.0]
# Embedded file name: /home/fw/development/AutoBuddy/aioouimeaux/aioouimeaux/device/bridge.py
# Compiled at: 2017-11-22 04:29:42
...
class Bridge(Device):
    ...
    def light_attributes(self, light):
        return {'devIndex':light.find('DeviceIndex').text, 
    ...
    def group_attributes(self, group):
        return {'GroupID':group.find('GroupID').text, 
