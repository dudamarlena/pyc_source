...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/library_simulator/simulator.py
# Compiled at: 2019-06-02 23:30:37
...
class LibrarySimulator:
    ...
    def __init__(self, fasta_file, mutation_spectrum='published', spectrum_tolerance=0.01):
        ...
        """
        self._generator = generator.LibraryGenerator(fasta_file=fasta_file, mutation_spectrum=mutation_spectrum,
    ...
    def simulate(self, num_samples=1000, mutation_rate=1):
        ...
        self._df = pd.DataFrame({'aa':aa,  'base':base, 
         'num':num, 
         'indel':indel, 
         'stop':stop, 
         'start':start})
