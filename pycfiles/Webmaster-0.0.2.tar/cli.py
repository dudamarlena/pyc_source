...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/web-portfolio/webmaster/cli.py
# Compiled at: 2016-01-08 01:04:44
"""
Webmaster
...
def create(app):
    ...
    click.echo('- Launch local server, run [ webcli local -a %s ]' % app)
    click.echo('')
