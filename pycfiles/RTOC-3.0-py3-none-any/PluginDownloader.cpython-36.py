...
# [GCC 8.4.0]
# Embedded file name: D:\Benutzer\haschtl\Dokumente\GIT\kellerlogger\RTOC\PluginDownloader.py
# Compiled at: 2019-05-05 16:33:45
# Size of source mod 2**32: 10509 bytes
import sys, os
from PyQt5 import uic
from PyQt5 import QtWidgets
from PyQt5.QtCore import QCoreApplication
import json, traceback, urllib.request, logging as log
...
class PluginDownloader(QtWidgets.QWidget):
    ...
    def installPlugin(self):
        ...
        if ok:
            ...
            pyqtlib.info_message(translate('Downloader', 'Fertig'), translate('Downloader', 'Installation abgeschlossen'), translate('Downloader', 'Bitte starte RTOC neu, um Fehler zu vermeiden'))
            if self.self:
    ...
    def download_directory(self, server_path):
        ...
        for content in contents:
            ...
            if content.type == 'dir' and '__pycache__' not in content.path:
                ...
                if '__pycache__' not in content.path:
                    try:
                        path = content.path
