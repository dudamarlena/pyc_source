...
# [GCC 8.4.0]
# Embedded file name: D:\Benutzer\haschtl\Dokumente\GIT\kellerlogger\RTOC\RTOC_GUI\scriptWidget.py
# Compiled at: 2019-06-12 19:21:08
...
class ScriptWidget(QtWidgets.QWidget):
    ...
    def loadScriptAction(self):
        ...
        fname, mask = fileBrowser.getOpenFileName(self, translate('RTOC', 'Load script'), dir_path, 'Python (*.py)')
        if fname:
            fileName = fname
            if mask == 'Python (*.py)':
                text = ''
