...
# [GCC 8.4.0]
# Embedded file name: D:\Benutzer\haschtl\Dokumente\GIT\kellerlogger\RTOC\RTOC_GUI\remoteWidget.py
# Compiled at: 2020-01-06 18:13:54
...
class RemoteWidget(QtWidgets.QWidget):
    ...
    def toggleEditView(self, value):
        if value:
            ...
            self.passwordLineEdit.setText(self.remote._RemoteWidget__password)
    ...
    def selectionChanged(self):
        ...
        print('seclection changed')
        print(t)
        self.remote.sigSelectList = t

    def updateList(self):
        print('update signal list')
        t = []
        for o in self.listWidget.selectedItems():
            t.append(o.text())

        self.listWidget.clear()
        print(self.remote.siglist)
    ...
    def saveRemoteSession(self):
        if self.editButton.isChecked():
            ...
            fileName, _ = QtWidgets.QFileDialog.getSaveFileName(self, title, QtCore.QDir.homePath() + '/' + examplename + '.json', 'JSON Files (*.json)')
        if fileName:
