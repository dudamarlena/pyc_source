...
# [GCC 8.4.0]
# Embedded file name: D:\Benutzer\haschtl\Dokumente\GIT\kellerlogger\RTOC\RTOC_GUI\csvSignalWidget.py
# Compiled at: 2019-06-12 19:00:19
...
class CsvSignalWidget(QtWidgets.QWidget):
    ...
    def __init__(self, importer, setup=[
 '', '', 0, 0, '']):
    ...
    def checkValidity(self):
        ...
        if self.xSpinBox.value() == 0:
            ...
            if self.xSpinBox.value() > self.self.model.columnCount():
                error = 1
    ...
    def updateName(self, lastDevice='', lastSignal='', lastUnit=''):
        ...
        return (
         thisDevice, thisSignal, thisUnit)
