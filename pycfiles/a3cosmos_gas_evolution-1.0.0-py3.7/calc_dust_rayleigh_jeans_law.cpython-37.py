...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/a3cosmos_gas_evolution/Common_Python_Code/calc_dust_rayleigh_jeans_law.py
...
if sys.version_info.major >= 3:
    ...
    if __name__ == '__main__':
        ...
        cal_Lv_obs_erg_s_Hz_2 = 2 * const.k_B.to('erg/K').value * (const.c.to('cm/s').value / (lambda_um / 10000.0)) ** 2 / const.c.to('cm/s').value ** 2 * T_dust
