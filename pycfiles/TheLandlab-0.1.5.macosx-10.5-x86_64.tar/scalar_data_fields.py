...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/field/scalar_data_fields.py
...
class ScalarDataFields(dict):
    ...
    def add_field(self, name, value_array, units=_UNKNOWN_UNITS, copy=False, noclobber=False):
