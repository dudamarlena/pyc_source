...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/components/cellular_automata/landlab_ca.py
    ...
    def __init__(self, model_grid, node_state_dict, transition_list, initial_node_states):
        ...
        for t in transition_list:
            try:
                ...
                assert t.from_state[(-1)] < self.number_of_orientations, 'Encoding for orientation in from_state must be < number of orientations.'
                assert t.to_state[(-1)] < self.number_of_orientations, 'Encoding for orientation in to_state must be < number of orientations.'
                this_type = tuple
