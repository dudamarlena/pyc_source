...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/components/flow_accum/flow_accumulation.py
...
class AccumFlow(object):
    ...
    def calc_flowacc(self, grid, data):
        ...
        try:
            height_order_active_cells = np.argsort(data.elev[active_cell_ids])[::-1]
        except:
