...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/examples/coupled_driver.py
...
mg.at_node['topographic_elevation'] = z + np.random.rand(len(z)) / 100000.0
...
pylab.close()
pylab.figure(1)
im = imshow_node_grid(mg, 'water_discharges', cmap='PuBu')
pylab.figure(2)
