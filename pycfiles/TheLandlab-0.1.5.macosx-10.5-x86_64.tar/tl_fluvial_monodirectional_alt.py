...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/components/transport_limited_fluvial/tl_fluvial_monodirectional_alt.py
...
class TransportLimitedEroder(object):
    ...
    def erode(self, grid, dt, node_drainage_areas='drainage_area', node_elevs='topographic_elevation', node_receiving_flow='flow_receiver', W_if_used=None, Q_if_used=None, Dchar_if_used=None, io=None):
        """
        ...
        *Dchar_if_used* must be set as a grid field string or nnoodes-long array
        ...
        for reps in xrange(num_reps_internal + 1):
            ...
            mean_diffusivities_byspacing[nodes_not_giving] = 0.0
