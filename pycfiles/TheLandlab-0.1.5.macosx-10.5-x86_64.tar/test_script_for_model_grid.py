...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/examples/test_script_for_model_grid.py
...
def main():
    ...
    for i in arange(0, size(my_bc.boundary_code)):
        print (
         i, my_bc.boundary_code[i], my_bc.boundary_gradient[i],
         my_bc.tracks_cell[i])
