...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/io/vtk/vtkxml.py
# Compiled at: 2014-09-23 12:37:24
import sys, numpy as np, xml.dom.minidom
...
class VtkDataElement(VtkElement):
    ...
    def addData(self, data, name, append=None, encoding='ascii', **kwargs):
        ...
        data_array = VtkDataArrayElement(data_string, Name=name, type=NUMPY_TO_VTK_TYPE[str(data.dtype)], **kwargs)
...
class VtkRootElement(VtkElement):
    ...
    def __init__(self, type):
        VtkElement.__init__(self, 'VTKFile', type=type, version='0.1', byte_order=str(SYS_TO_VTK_ENDIAN[sys.byteorder]))
    ...
    def __init__(self, xyz, **kwargs):
        ...
        for i, label in enumerate(['x', 'y', 'z']):
            try:
                ...
                self.addData((np.array(xyz[0]) * 0.0), (label + '_coordinates'), NumberOfComponents=1, **kwargs)
