...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/components/gFlex/flexure.py
...
class gFlex(Component):
    ...
    _var_units = {'earth_material_load__magnitude_of_stress': 'Pa', 'earth_material_load__x_positions': 'm', 
    ...
    _var_mapping = {'earth_material_load__magnitude_of_stress': 'node', 'earth_material_load__x_positions': 'node', 
    ...
    _var_defs = {'earth_material_load__magnitude_of_stress': 'Magnitude of stress exerted by surface load', 'earth_material_load__x_positions': 'x position of any surface load', 
