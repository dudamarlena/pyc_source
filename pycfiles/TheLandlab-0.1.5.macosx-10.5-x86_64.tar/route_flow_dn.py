...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/components/flow_routing/route_flow_dn.py
...
class FlowRouter:
    ...
    def route_flow(self, elevs=None, grid=None, runoff_rate=1.0, boundary_nodes=None):
        """
        ...
        receiver, steepest_slope, sink, recvr_link = flow_direction_DN.flow_directions(elevs, self._active_links, self._activelink_from, self._activelink_to, link_slope, grid=grid, baselevel_nodes=baselevel_nodes, use_weave=self.weave_flag)
        a, q, s = flow_accum_bw.flow_accumulation(receiver, sink, node_cell_area, runoff_rate, boundary_nodes, self.weave_flag)
        ...
        if grid:
            ...
            return (
             receiver, a, q, steepest_slope, s, recvr_link)
            return
