...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/io/netcdf/write.py
...
from landlab.io.netcdf._constants import _AXIS_DIMENSION_NAMES, _AXIS_COORDINATE_NAMES, _NP_TO_NC_TYPE
...
def _add_variables_at_points(root, fields, names=None):
    ...
    for var_name in names:
        try:
            ...
            var = root.createVariable(var_name, _NP_TO_NC_TYPE[str(node_fields[var_name].dtype)], [
...
def write_netcdf(path, fields, attrs=None, append=False, format='NETCDF3_64BIT', names=None):
