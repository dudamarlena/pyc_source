...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/io/vtk/vtktypes.py
# Compiled at: 2014-09-23 12:37:24
from landlab.io.vtk.encoders import AsciiEncoder, RawEncoder, Base64Encoder
...
NUMPY_TO_VTK_TYPE = {'uint8': VtkUInt8, 
   'int32': VtkInt32, 
   'int64': VtkInt64, 
   'float32': VtkFloat32, 
   'float64': VtkFloat64}
VTK_TO_NUMPY_TYPE = {'UInt8': 'uint8', 
   'Int32': 'int32', 
   'Int64': 'int64', 
   'Float32': 'float32', 
   'Float64': 'float64'}
