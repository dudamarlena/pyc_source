...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/plot/channel_profile.py
...
def channel_nodes(grid, steepest_nodes, drainage_area, upstream_ID_order, flow_receiver, number_of_channels=1, threshold=None):
    if threshold == None:
        threshold = 2.0 * numpy.amin(grid.cell_areas)
...
def analyze_channel_network_and_plot(grid, elevations='topographic_elevation', drainage_area='drainage_area', upstream_ID_order='upstream_ID_order', flow_receiver='flow_receiver', links_to_flow_receiver='links_to_flow_receiver', number_of_channels=1, starting_nodes=None, threshold=None):
    """
