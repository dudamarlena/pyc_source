...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/components/single_vegetation/vegetation_multi_pft.py
...
class Vegetation(Component):
    ...
    def initialize(self, **kwds):
        ...
        self._ETthresholddown = kwds.pop('ETTdwn', 6.8)
        self._cell_values = self.grid['cell']
