...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/framework/component.py
...
def iscomponent(value, cls):
    ...
    """
    try:
        return cls in value.__implements__ or cls.__name__ in value.__implements__ or isinstance(value, cls)
