...
# [GCC 8.4.0]
# Embedded file name: /anaconda/lib/python2.7/site-packages/landlab/framework/collections.py
    ...
    def find_connections(self):
        ...
        for var_name in self.uses():
            ...
            if len(providers) > 1:
                ...
                try:
                    connections[providers[0]].update({var_name: self.find_user(var_name)})
                except KeyError:
