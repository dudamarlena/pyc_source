...
# [GCC 8.4.0]
# Embedded file name: /Users/dinoboff/Documents/workspace/skeleton/src/build/lib/skeleton/examples/licenses.py
# Compiled at: 2010-05-11 18:08:00
"""
...
class BSD(Skeleton):
    ...
    variables = [
     Var('author'),
     Var('organization', default='', description='required for a 3 clauses-BSD license - leave it empty for a 2 clauses-BSD license.')]
...
class LicenseChoice(Skeleton):
    ...
    def license_skel(self):
        ...
        if self._licence_skel is None:
            self._licence_skel = self.supported_licenses.get(self.get('license').upper(), self.default_license)(self)
