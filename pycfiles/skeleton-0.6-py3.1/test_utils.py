...
# [GCC 8.4.0]
# Embedded file name: /Users/dinoboff/Documents/workspace/skeleton/src/build/lib/skeleton/tests/test_utils.py
# Compiled at: 2010-05-11 10:16:00
"""
Tests in skeleton.utils.*
"""
import optparse, unittest
...
class TestInsertIntoFile(TestCase):
    ...
    def test_insert_with_indent(self):
        ...
        with TempDir() as (tmp_dir):
            ...
            insert_into_file(target, 'insert here', 'bar\nfooz\n')
            with open(target) as (f_target):
                self.assertEqual(f_target.read().strip(), 'foo\n  # -*- insert here -*- #\n  bar\n  fooz\nbaz')
...
class TestVarsToOptparser(unittest.TestCase):
    ...
    def test_create_parser(self):
        ...
        """
        self.assertTrue(isinstance(vars_to_optparser([]), optparse.OptionParser))
