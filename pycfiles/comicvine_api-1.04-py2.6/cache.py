...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/cache.py
# Compiled at: 2010-09-01 16:36:30
"""
urllib2 caching handler
Modified from http://github.com/dbr/comicvine_api
"""
from __future__ import with_statement
__author__ = 'Samus'
__version__ = '1.01'
import os, time, errno, httplib, urllib2, StringIO
...
class CachedResponse(StringIO.StringIO):
    ...
    def recache(self):
        ...
        set_cache_header = store_in_cache(self.cache_location, new_request.url, new_request)
