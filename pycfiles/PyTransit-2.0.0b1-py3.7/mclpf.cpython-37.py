...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/pytransit/lpf/mclpf.py
...
class MCLPF(BaseLPF):
    ...
    def _init_p_planet(self):
        ...
        """
        pk2 = [PParameter(f"k2_{pb}", f"{pb} area ratio", 'A_s', UP(0.004900000000000001, 0.0144), (0, inf)) for pb in self.passbands]
