...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/pytransit/models/transitmodel.py
# Compiled at: 2020-03-26 18:34:34
...
class TransitModel(object):
    __doc__ = 'Exoplanet transit light curve model \n    '
    ...
    def set_data(self, time: Union[(ndarray, List)], lcids: Optional[Union[(ndarray, List)]]=None, pbids: Optional[Union[(ndarray, List)]]=None, nsamples: Optional[Union[(ndarray, List)]]=None, exptimes: Optional[Union[(ndarray, List)]]=None, epids: Optional[Union[(ndarray, List)]]=None) -> None:
    ...
    def evaluate_ps(self, k: float, ldc: ndarray, t0: float, p: float, a: float, i: float, e: float=0.0, w: float=0.0, copy: bool=True) -> ndarray:
        raise NotImplementedError
