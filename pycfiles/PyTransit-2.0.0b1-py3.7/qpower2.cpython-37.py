...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/pytransit/models/qpower2.py
# Compiled at: 2020-03-28 19:16:40
# Size of source mod 2**32: 7012 bytes
...
class QPower2Model(TransitModel):
    __doc__ = 'QPower2 transit model by Maxted & Gill (A&A, 622, A33, 2019).\n    '
    ...
    def evaluate(self, k: Union[(float, ndarray)], ldc: ndarray, t0: Union[(float, ndarray)], p: Union[(float, ndarray)], a: Union[(float, ndarray)], i: Union[(float, ndarray)], e: Optional[Union[(float, ndarray)]]=None, w: Optional[Union[(float, ndarray)]]=None, copy: bool=True) -> ndarray:
        ...
        if isinstance(t0, float):
            ...
            flux = qpower2_model_v(self.time, k, ldc, t0, p, a, i, e, w, self.lcids, self.pbids, self.nsamples, self.exptimes, self._es, self._ms, self._tae)
        return squeeze(flux)

    def evaluate_ps(self, k: float, ldc: ndarray, t0: float, p: float, a: float, i: float, e: float=0.0, w: float=0.0) -> ndarray:
