...
# [GCC 8.4.0]
# Embedded file name: /home/swails/src/ParmEd/parmed/namd/namdbinfiles.py
...
class NamdBinCoor(NamdBinFile):
    __doc__ = ' Class to read or write NAMD "bincoordinates" files. '
...
class NamdBinVel(NamdBinFile):
    __doc__ = ' Class to read or write NAMD "binvelocities" files. '
