...
# [GCC 8.4.0]
# Embedded file name: /home/swails/src/ParmEd/parmed/rosetta/pose.py
        ...
        for resid in range(1, pose.total_residue() + 1):
            ...
            for atno, at in enumerate((res.atoms()), start=1):
                try:
                    ...
                    raise RosettaError('Could not recognize element: %s.' % atsym)

                params = dict(atomic_number=atomic_number, name=atname, charge=0.0,
                  mass=mass,
                  occupancy=0.0,
                  bfactor=0.0,
                  altloc='',
