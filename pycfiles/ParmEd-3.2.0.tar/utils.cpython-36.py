...
# [GCC 8.4.0]
# Embedded file name: /home/swails/src/ParmEd/parmed/openmm/utils.py
...
@needs_openmm
def energy_decomposition_system(structure, system, platform=None, nrg=u.kilocalories_per_mole):
    """
    ...
    try:
        ...
        if platform is None:
            ...
            con = mm.Context(system, mm.VerletIntegrator(0.001), mm.Platform.getPlatformByName(platform))
