...
# [GCC 8.4.0]
# Embedded file name: /home/swails/src/ParmEd/parmed/residue.py
...
"""
__all__ = [
 'AminoAcidResidue', 'RNAResidue', 'DNAResidue', 'ALA', 'ARG', 'ASN',
...
class BiomolecularResidue(object):
    __doc__ = ' Base class for different classes of biopolymer residues '
...
class RNAResidue(DNAResidue):
    __doc__ = ' An individual RNA residue\n\n    Parameters\n    ----------\n    name : str\n        The name of the residue\n    abbr : str\n        The abbreviation of the nucleic acid residue\n    aliases : list of str, optional\n        A list of other abbreviations that *also* refer to this residue\n    '
    _all_residues_by_name = dict()
    _all_residues_by_abbr = dict()
    _all_residues_by_symbol = dict()
    all_residues = []
...
T = RNAResidue('Thymine', 'T', ['THY', 'T3', 'T5', 'TN',
 'RT', 'RT3', 'RT5', 'RTN'])
WATER_NAMES = {
 'WAT', 'HOH', 'TIP3', 'TIP4', 'TIP5', 'SPCE', 'SPC'}
