...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/couchish/schemaish_jsonbuilder.py
# Compiled at: 2009-06-10 05:07:11
import schemaish
...
class SchemaishTypeRegistry(object):
    ...
    def __init__(self):
        self.registry = {'String': self.string_factory, 
