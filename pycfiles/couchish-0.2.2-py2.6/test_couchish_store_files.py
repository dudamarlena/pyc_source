...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/couchish/tests/test_couchish_store_files.py
# Compiled at: 2009-07-21 09:44:12
from __future__ import with_statement
import unittest, os.path, couchdb
...
class TestFiles(unittest.TestCase):
    ...
    def test_remove_file(self):
        ...
        with self.S.session() as (S):
            matt = S.doc_by_id(matt_id)
        assert '_attachments' not in matt
