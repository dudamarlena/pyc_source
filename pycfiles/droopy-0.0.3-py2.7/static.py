...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\droopy\static.py
# Compiled at: 2011-10-24 17:09:11
import re
...
class Static(object):
    ...
    def sentences(self, d):
        PUNCTUATION_RE = '\\.\\?!:'
        split_by = '[%s]+\\s+[%s]' % (PUNCTUATION_RE, d.bigs)
