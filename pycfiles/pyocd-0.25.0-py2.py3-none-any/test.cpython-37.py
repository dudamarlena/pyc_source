...
class TestFileAccess(unittest.TestCase):
    ...
    def test_move_rename_in_place(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'renamed in place.txt'), 'to rename')
    ...
    def test_move_and_rename(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/file renamed.txt'), 'first file')
    ...
    def test_move_to_dir(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/movetodir.txt'), 'z file')
    ...
    def test_rename_unicode(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + '更多中文.txt'), '1')
    ...
    def test_move_unicode(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/中文.txt'), '2')
    ...
    def test_move_to_non_existing_dir(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'move not possible.txt'), 'x')
    ...
    def test_copy_in_place(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copied in place.txt'), 'to copy')
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copy this file!.txt'), 'to copy')
    ...
    def test_copy_into_subdir(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/file copied.txt'), 'first file')
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copy into subdir.txt'), 'first file')
    ...
    def test_copy_unicode(self):
        ...
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/दिलै होस छोरा होस.txt'), 'content')
        self.assertEqual(self.client.get_file_contents(self.test_root + 'दिलै होस छोरा होस.txt'), 'content')
    ...
    def test_copy_to_non_existing_dir(self):
        ...
        self.assertEqual(e.exception.status_code, 409)
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copy not possible.txt'), 'x')
