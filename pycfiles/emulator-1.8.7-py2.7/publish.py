...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/emulator/paho/mqtt/publish.py
...
def multiple(msgs, hostname='localhost', port=1883, client_id='', keepalive=60, will=None, auth=None, tls=None, protocol=paho.MQTTv311, transport='tcp'):
...
def single(topic, payload=None, qos=0, retain=False, hostname='localhost', port=1883, client_id='', keepalive=60, will=None, auth=None, tls=None, protocol=paho.MQTTv311, transport='tcp'):
