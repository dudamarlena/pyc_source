...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/emulator/paho/mqtt/subscribe.py
...
"""
import emulator.paho.mqtt.client as paho, emulator.paho.mqtt as mqtt
...
def callback(callback, topics, qos=0, userdata=None, hostname='localhost', port=1883, client_id='', keepalive=60, will=None, auth=None, tls=None, protocol=paho.MQTTv311, transport='tcp', clean_session=True):
    ...
    callback_userdata = {'callback': callback, 
       'topics': topics, 
       'qos': qos, 
       'userdata': userdata}
...
def simple(topics, qos=0, msg_count=1, retained=True, hostname='localhost', port=1883, client_id='', keepalive=60, will=None, auth=None, tls=None, protocol=paho.MQTTv311, transport='tcp', clean_session=True):
    ...
    callback(_on_message_simple, topics, qos, userdata, hostname, port, client_id, keepalive, will, auth, tls, protocol, transport, clean_session)
