...
# Embedded file name: /Users/boyhack/programs/pocsuite3/pocsuite3/thirdparty/colorama/ansitowin32.py
...
class StreamWrapper(object):
    ...
    def closed(self):
        stream = self._StreamWrapper__wrapped
        return not hasattr(stream, 'closed') or 
