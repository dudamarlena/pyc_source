...
# Embedded file name: /Users/hysia/Code/Pocsuite/pocsuite/lib/core/option.py
# Compiled at: 2018-12-07 04:32:38
__doc__ = "\nCopyright (c) 2014-2016 pocsuite developers (https://seebug.org)\nSee the file 'docs/COPYING' for copying permission\n"
import re, os, ast, copy, random, Queue, urlparse, socket
            ...
            if conf.url:
                if conf.url.endswith('/24'):
                    try:
                        ...
                        target_urls = [ ('{}{}').format(base_addr, i) for i in xrange(1, 256)
                                      ]
                    except socket.error:
