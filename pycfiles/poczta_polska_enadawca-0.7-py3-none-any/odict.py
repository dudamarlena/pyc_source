...
# Embedded file name: /Users/hysia/Code/Pocsuite/pocsuite/thirdparty/odict/odict.py
# Compiled at: 2018-11-28 03:20:09
__doc__ = 'A dict that keeps keys in insertion order'
from __future__ import generators
__author__ = 'Nicola Larosa <nico-NoSp@m-tekNico.net>,Michael Foord <fuzzyman AT voidspace DOT org DOT uk>'
__docformat__ = 'restructuredtext en'
__version__ = '0.2.2'
__all__ = [
 'OrderedDict', 'SequenceOrderedDict']
import sys
    ...
    def __setitem__(self, index, name):
        ...
        if isinstance(index, types.SliceType):
            ...
            if len(indexes) != len(name):
                raise ValueError('attempt to assign sequence of size %s to slice of size %s' % (
                 len(name), len(indexes)))
