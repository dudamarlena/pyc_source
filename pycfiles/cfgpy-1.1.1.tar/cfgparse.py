...
# Embedded file name: build\bdist.win32\egg\cfgparse.py
# Compiled at: 2007-09-17 13:54:55
__doc__ = 'cfgparse - a powerful, extensible, and easy-to-use configuration parser.\n\nBy Dan Gass <dan.gass@gmail.com>\n\nIf you have problems with this module, please file bugs through the Source\nForge project page:\n  http://sourceforge.net/projects/cfgparse\n'
__version__ = '1.3'
__all__ = []
...
import ConfigParser as _ConfigParser, cStringIO, os, re, sys, textwrap
try:
...
class Value(object):
    ...
    def get_roots(self):
        return [
         'File: %s' % self.parent.get_filename(),
...
class Option(object):
    ...
    def convert_complex(self, value):
        try:
            ...
            return (
             None, "Cannot convert '%s' to a complex number" % value)
    ...
    def convert_float(self, value):
        try:
            ...
            return (
             None, "Cannot convert '%s' to a float" % value)
    ...
    def convert_int(self, value):
        try:
            ...
            return (
             None, "Cannot convert '%s' to an integer" % value)
    ...
    def convert_long(self, value):
        try:
            ...
            return (
             None, "Cannot convert '%s' to a long" % value)
    ...
    def convert_string(self, value):
        try:
            ...
            return (
             None, "Cannot convert '%s' to a string" % value)
    ...
    conversions = {'choice': convert_choice, 
