...
# [GCC 8.4.0]
# Embedded file name: /home/vagrant/envs/conversocial/lib/python2.7/site-packages/djangosampler/models.py
...
class Query(models.Model):
    ...
    created_dt = models.DateTimeField(default=datetime.now, editable=False, db_index=True)
