...
# [GCC 8.4.0]
# Embedded file name: /home/vagrant/envs/conversocial/lib/python2.7/site-packages/djangosampler/plugins/request.py
...
class SamplingMiddleware(object):
    ...
    def process_response(self, request, response):
        ...
        view_fallback = {'function': request.path, 
           'args': [], 'kwargs': {}}
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        self.request_view_calls[request] = {'function': view_func.func_name, 
           'args': view_args, 
           'kwargs': view_kwargs}
        return
...
class Request(object):
    ...
    @staticmethod
    def install():
        settings.MIDDLEWARE_CLASSES = ('djangosampler.plugins.request.SamplingMiddleware', ) + tuple(settings.MIDDLEWARE_CLASSES)