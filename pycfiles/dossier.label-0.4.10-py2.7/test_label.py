...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dossier/label/tests/test_label.py
...
@qc
def test_label_reverse_equality(cid1=id_, cid2=id_, ann=id_, v=coref_value, t=time_value):
...
@qc
def test_subtopic_id(cid1=id_, cid2=id_, s1=id_, s2=id_, ann=id_, v=coref_value):
...
@qc
def test_same_subject(cid1=id_, cid2=id_, s1=id_, s2=id_, ann=id_, v1=coref_value, v2=coref_value, t1=time_value, t2=time_value):
    l1 = Label(cid1, cid2, ann, v1, epoch_ticks=t1, subtopic_id1=s1, subtopic_id2=s2)
    l2 = Label(cid1, cid2, ann, v2, epoch_ticks=t2, subtopic_id1=s1, subtopic_id2=s2)
    assert l1.same_subject_as(l2)
    assert l2.same_subject_as(l1)


@qc
def test_label_most_recent_first(cid1=id_, cid2=id_, ann=id_, v1=coref_value, v2=coref_value, t=time_value):
...
@qc
def test_label_most_recent_first_unordered(cid1=id_, cid2=id_, ann=id_, v1=coref_value, v2=coref_value, t=time_value):
    lab1 = Label(cid1, cid2, ann, v1, epoch_ticks=t)
...
@qc
def test_label_order_on_value(cid1=id_, cid2=id_, ann=id_, t=time_value, v1=coref_value, v2=coref_value):
    lab1 = Label(cid1, cid2, ann, v1, epoch_ticks=t)
    lab2 = Label(cid1, cid2, ann, v2, epoch_ticks=t)
    assert v1 < v2 and lab1 < lab2 or v1 == v2 and lab1 == lab2 or v1 > v2 and lab1 > lab2
...
def test_label_diff_simple():
    ...
    assert diff_labels_sets(old, new) == {'add': {
             label('a', 'd')}, 
       'delete': {
                label('a', 'c')}, 
       'change': set()}
...
def test_label_diff_change():
    ...
    assert diff_labels_sets(old, new) == {'add': set(), 
       'delete': set(), 
       'change': {
                label('a', 'b', v=CorefValue.Negative)}}


def test_label_diff_empty():
    old = [
     Label('a', 'b', 'foo', 1, epoch_ticks=0)]
