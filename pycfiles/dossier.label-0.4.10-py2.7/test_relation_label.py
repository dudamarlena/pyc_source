...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dossier/label/tests/test_relation_label.py
...
@qc
def test_label_reverse_equality(cid1=id_, cid2=id_, ann=id_, v=relation_type, t=time_value):
...
@qc
def test_label_order_on_value(cid1=id_, cid2=id_, ann=id_, t=time_value, v1=relation_type, v2=relation_type):
