...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dossier/label/tests/test_combined_store.py
...
from dossier.label.relation_label import RelationLabelStore, RelationLabel, RelationStrength
...
def test_relationship_graph(combined_label_store):
    ...
    combined_label_store.rel_label_store.put(rl1, rl2, rl3, rl4, rl5)
