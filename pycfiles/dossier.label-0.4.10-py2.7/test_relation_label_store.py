...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dossier/label/tests/test_relation_label_store.py
...
def test_get_related(rel_label_store):
    ...
    strong_related = frozenset(rel_label_store.get_related('A', min_strength=RelationStrength.STRONG))
