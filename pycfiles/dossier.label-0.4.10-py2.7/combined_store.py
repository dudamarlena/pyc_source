...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dossier/label/combined_store.py
...
class CombinedLabelStore(object):
    ...
    def get_related_coref_relationships(self, content_id, min_strength=None):
        ...
        """
        related_labels = self.rel_label_store.get_related(content_id, min_strength=min_strength)
    ...
    def get_related_flat(self, content_id, min_strength=None):
        ...
        """
        rel_id_to_idents = self.get_related_coref_relationships(content_id, min_strength=min_strength)
        flat_list = []
