...
# [GCC 8.4.0]
# Embedded file name: /Users/davidsingleton/proj/pocket-cronv/venv/lib/python2.7/site-packages/simplescheduler/scheduler.py
# Compiled at: 2015-04-11 17:10:22
import importlib, redis, time, os, pickle, traceback
...
class Scheduler(object):
    ...
    def __init__(self, custom_redis=None, clock_source=None, sleeper=None, interval=5, verbose=False):
        ...
        if custom_redis:
            ...
            self._redis = redis.StrictRedis(host=os.environ['REDIS_HOST'], port=int(os.environ['REDIS_PORT']), db=int(os.environ['REDIS_DB']), password=os.environ['REDIS_KEY'])
    ...
    def schedule_in(self, job, timedelta):
        ...
        now = long(self._now() * 1000000.0)
        when = now + timedelta.total_seconds() * 1000000.0
