...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/webundo/__init__.py
# Compiled at: 2010-02-20 23:52:04
...
import uuid
__all__ = [
 'unproxy_closure', 'ThreadLostError', 'launch_cancelable_job',
 'launch_undoable_job', 'cancel_job', 'undo_job']
waiting_threads = {'cancelable_jobs': {}, 'undoable_jobs': {}}
...
def unproxy_closure(func):
    ...
    return new.function(func.func_code, func.func_globals, func.func_name, func.func_defaults, tuple((create_cell(cell.cell_contents._current_obj()) if callable(cell.cell_contents._current_obj) else cell) for cell in func.func_closure if hasattr(cell.cell_contents, '_current_obj')))
