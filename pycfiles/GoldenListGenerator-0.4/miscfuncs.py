...
# [GCC 8.4.0]
# Embedded file name: C:\Users\alii\Documents\KapschWorkspace\test_results\livetrafficevaluation\goldenlistgenpackage\GoldenListGenerator\miscfuncs.py
# Compiled at: 2017-07-10 14:36:53
...
def findTrxsInLeftNotInRight(dataframe_left, dataframe_right, field):
    ...
    logger.info('finding rows in left dataframe that do NOT exist in right dataframe returningleft dataframe filtered to those rows')
