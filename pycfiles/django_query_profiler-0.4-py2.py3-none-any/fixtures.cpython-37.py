...
# [GCC 8.4.0]
# Embedded file name: /Users/yash/Desktop/django-query-profiler/tests/integration/fixtures.py
...
def bulk_create_toppings_pizzas_restaurants() -> None:
    ...
    north_beach_restaurant = Restaurant.objects.create(name='North Beach',
    ...
    amici_restaurant = Restaurant.objects.create(name='Amici',
