...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dubbo_client/rpclib.py
...
from jsonrpcclient.exceptions import JsonRpcClientError, ReceivedNon2xxResponseError, ReceivedErrorResponseError
