...
# [GCC 8.4.0]
# Embedded file name: /home/gerard/1r_MASTER/2n_TRIMESTRE/SBI/PROJECT/Clear_complex_Builder_v11/modules/sequencesalignment.py
# Compiled at: 2020-03-27 20:13:14
...
def SequenceAlignment(fasta_file):
    ...
    for sequence in record:
        ...
        if name_chain1 not in chains_included:
            chains_equivalence[name_chain1] = [
             name_chain1]
