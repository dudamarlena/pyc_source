...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.7/site-packages/vbp/ucod/icd.py
# Compiled at: 2019-04-28 23:34:26
# Size of source mod 2**32: 19970 bytes
import vbp, numpy
from vbp import DictTree

class ICD:
    icd10_chapters_and_subchapters = DictTree({1:DictTree(value='Certain infectious and parasitic diseases (A00-B99)', d={2:'Intestinal infectious diseases (A00-A09)', 
     ...
     23:DictTree(value='Neoplasms (C00-D48)', d={24:'Malignant neoplasms (C00-C97)', 
      25:'In situ neoplasms (D00-D09)', 
      26:'Benign neoplasms (D10-D36)', 
      27:'Neoplasms of uncertain or unknown behaviour (D37-D48)'}), 
     28:DictTree(value='Diseases of the blood and blood-forming organs and certain disorders involving the immune mechanism (D50-D89)', d={29:'Nutritional anaemias (D50-D53)', 
     ...
     35:DictTree(value='Endocrine, nutritional and metabolic diseases (E00-E90)', d={36:'Disorders of thyroid gland (E00-E07)', 
     ...
     44:DictTree(value='Mental and behavioural disorders (F00-F99)', d={45:'Organic, including symptomatic, mental disorders (F00-F09)', 
     ...
     56:DictTree(value='Diseases of the nervous system (G00-G99)', d={57:'Inflammatory diseases of the central nervous system (G00-G09)', 
     ...
     68:DictTree(value='Diseases of the eye and adnexa (H00-H59)', d={69:'Disorders of eyelid, lacrimal system and orbit (H00-H06)', 
     ...
     80:DictTree(value='Diseases of the ear and mastoid process (H60-H95)', d={81:'Diseases of external ear (H60-H62)', 
      82:'Diseases of middle ear and mastoid (H65-H75)', 
      83:'Diseases of inner ear (H80-H83)', 
      84:'Other disorders of ear (H90-H95)'}), 
     85:DictTree(value='Diseases of the circulatory system (I00-I99)', d={86:'Acute rheumatic fever (I00-I02)', 
     ...
     96:DictTree(value='Diseases of the respiratory system (J00-J99)', d={97:'Acute upper respiratory infections (J00-J06)', 
     ...
     107:DictTree(value='Diseases of the digestive system (K00-K93)', d={108:'Diseases of oral cavity, salivary glands and jaws (K00-K14)', 
     ...
     118:DictTree(value='Diseases of the skin and subcutaneous tissue (L00-L99)', d={119:'Infections of the skin and subcutaneous tissue (L00-L08)', 
     ...
     127:DictTree(value='Diseases of the musculoskeletal system and connective tissue (M00-M99)', d={128:'Arthropathies (M00-M25)', 
     ...
     134:DictTree(value='Diseases of the genitourinary system (N00-N99)', d={135:'Glomerular diseases (N00-N08)', 
     ...
     146:DictTree(value='Pregnancy, childbirth and the puerperium (O00-O99)', d={147:'Pregnancy with abortive outcome (O00-O08)', 
     ...
     155:DictTree(value='Certain conditions originating in the perinatal period (P00-P96)', d={156:'Fetus and newborn affected by maternal factors and by complications of pregnancy, labour and delivery (P00-P04)', 
     ...
     167:DictTree(value='Congenital malformations, deformations and chromosomal abnormalities (Q00-Q99)', d={168:'Congenital malformations of the nervous system (Q00-Q07)', 
     ...
     179:DictTree(value='Symptoms, signs and abnormal clinical and laboratory findings, not elsewhere classified (R00-R99)', d={180:'Symptoms and signs involving the circulatory and respiratory systems (R00-R09)', 
     ...
     193:DictTree(value='Injury, poisoning and certain other consequences of external causes (S00-T98)', d={194:'Injuries to the head (S00-S09)', 
     ...
     215:DictTree(value='External causes of morbidity and mortality (V01-Y98)', d={216:'Accidents (V01-X59)', 
     ...
     224:DictTree(value='Factors influencing health status and contact with health services (Z00-Z99)', d={225:'Persons encountering health services for examination and investigation (Z00-Z13)', 
     ...
     232:DictTree(value='Codes for special purposes (U00-U99)', d={233:'Provisional assignment of new diseases of uncertain etiology or emergency use (U00-U49)', 
    ...
    def convert_age_minutes(x):
        if len(x) < 3:
            return int(int(x) * 365.25 * 24 * 60)
        if x[1:] == '999':
            return numpy.NaN
        ageType = x[0]
        if ageType == '0' or ageType == '1':
            return int(int(x[1:]) * 365.25 * 24 * 60)
        if ageType == '2':
            return int(int(x[1:]) * 43830.0)
        if ageType == '3':
            return int(int(x[1:]) * 70802.3076923077)
        if ageType == '4':
