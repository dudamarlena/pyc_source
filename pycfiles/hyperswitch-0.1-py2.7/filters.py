...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hyperswitch/filters.py
# Compiled at: 2017-09-16 20:49:52
...
class CamelHumpFilter(object):
    ...
    def is_match_from_word(self, words, word_index, start_filter_index=0):
        ...
        while filter_index < len(self._processed_filter_string):
            ...
            if filter_index > start_filter_index and next_word is not None and next_word.starts_with(current_char):
                next_word_start_indexes.append(filter_index)
            if len(current_word) > current_word_index and current_word.char_equal(current_char, current_word_index):
                filter_index += 1
