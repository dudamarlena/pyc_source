...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/seq2annotation/trainer/lookup_train_model.py
...
def train_model(**kwargs):
    ...
    params = {'dim':300, 
     ...
     'preds':{'train':str(Path(result_dir, '{}.txt'.format('preds_train'))), 
    ...
    train_inpf = functools.partial(input_fn, (fwords('train')), params,
    ...
    hook = tf.contrib.estimator.stop_if_no_increase_hook(estimator,
      'f1', max_steps_without_increase=(hook_params['max_steps_without_increase']),
    ...
    estimator.export_saved_model(params['saved_model_dir'], serving_input_receiver_fn)