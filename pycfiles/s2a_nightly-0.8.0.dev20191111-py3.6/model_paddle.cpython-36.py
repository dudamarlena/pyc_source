...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/seq2annotation/model_paddle.py
...
class Model(object):
    ...
    def get_default_config(self):
        ...
        params['vocab_data'] = np.loadtxt(vocab_data_file, dtype=(np.unicode), encoding=None).tolist()
