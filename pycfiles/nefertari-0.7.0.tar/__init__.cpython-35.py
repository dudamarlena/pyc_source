...
# [GCC 8.4.0]
# Embedded file name: /Users/jonathan/Documents/workspace/nefertari/nefertari/scaffolds/__init__.py
# Compiled at: 2016-05-05 12:09:42
# Size of source mod 2**32: 1094 bytes
import os, subprocess
from six import moves
from pyramid.scaffolds import PyramidTemplate

class NefertariStarterTemplate(PyramidTemplate):
    _template_dir = 'nefertari_starter'
    summary = 'Nefertari starter'
    ...
    def post(self, command, output_dir, vars):
        ...
        msg = 'Goodbye boilerplate! Welcome to Nefertari.'
        self.out(msg)