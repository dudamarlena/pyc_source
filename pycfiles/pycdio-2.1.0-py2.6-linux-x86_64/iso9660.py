...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/iso9660.py
# Compiled at: 2019-08-25 04:17:00
import pycdio, pyiso9660, cdio, types
check_types = {'nocheck': pyiso9660.NOCHECK, 
...
class ISO9660:
    ...
    class IFS:
        ...
        def find_lsn(self, lsn):
            ...
            if pycdio.VERSION_NUM <= 76:
                ...
                (filename, LSN, size, sec_size, is_dir) = pyiso9660.ifs_find_lsn(self.iso9660, lsn)
        ...
        def open_fuzzy(self, source, iso_mask=pyiso9660.EXTENSION_NONE, fuzz=20):
        ...
        def read_fuzzy_superblock(self, iso_mask=pyiso9660.EXTENSION_NONE, fuzz=20):
            ...
            if type(fuzz) != int:
                print "*** Expecting fuzz to be an integer; got 'fuzz'"
                return False
            return pyiso9660.ifs_fuzzy_read_superblock(self.iso9660, iso_mask, fuzz)
        ...
        def stat(self, path, translate=False):
            ...
            * is_dir   - True if a directory; False if a not."""
            ...
            return stat_array_to_dict(values[0], values[1], values[2], values[3], values[4])
    ...
    class FS(cdio.Device):
        ...
        def find_lsn(self, lsn):
            ...
            file stat information about it. None is returned on
            error."""
            (filename, LSN, size, sec_size, is_dir) = pyiso9660.fs_find_lsn(self.cd, lsn)
            return stat_array_to_dict(filename, LSN, size, sec_size, is_dir)
