...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/Clumsy/io/EdfWriting.py
# Compiled at: 2018-11-05 17:37:39
...
def preprocess_raw_edf(file_path, correct_channels, save_path):
    ...
    coords = {'channels':signal_labels[match_indx],  'time':time, 
     'samplerate':sfreq}
...
if __name__ == '__main__':
    ...
    reader = CMLReader(subject='R1207J', experiment='FR1', session=1, localization=0,
      montage=0)
