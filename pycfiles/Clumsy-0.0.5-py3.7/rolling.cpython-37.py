...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/Clumsy/signal/rolling.py
# Compiled at: 2018-11-05 17:00:12
# Size of source mod 2**32: 10051 bytes
import numpy as np
...
def xarray_rolling_average(timeseries, desired_window, desired_step):
    ...
    if dims_reordered:
        timeseries_rolled = reorder_dims(darray=timeseries_rolled, dim1='time',
          dim2=first_dim)
