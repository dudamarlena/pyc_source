...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/picka/picka_utils.py
# Compiled at: 2016-08-31 14:53:26
...
path = os.path.join(os.path.dirname(__file__) + '/data/db.sqlite')
...
class _Book:
    ...
    _path = join(dirname(__file__) + '/data/book_sherlock.txt')
