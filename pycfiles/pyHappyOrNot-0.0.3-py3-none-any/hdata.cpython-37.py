...
__doc__ = "Houdini Engine's internal data types\nAuthor  : Maajor\nEmail   : info@ma-yidong.com\n"
...
class ParmInfo(StructureWithEnums):
    ...
    def is_int(self):
        ...
        """
        return self.type >= ParmType.INT_START and self.type <= ParmType.INT_END or self.type == ParmType.MULTIPARMLIST or 
    ...
    def is_string(self):
        ...
        """
        return self.type >= ParmType.STRING_START and self.type <= ParmType.STRING_END or self.type == ParmType.LABEL or 
