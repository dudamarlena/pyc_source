...
# Embedded file name: build/bdist.linux-x86_64/egg/psphere/managedobjects.py
...
class ManagedEntity(ExtensibleManagedObject):
    ...
    def get(cls, client, **kwargs):
        ...
        return client.find_entity_view(cls.__name__, filter=filter, properties=properties)
