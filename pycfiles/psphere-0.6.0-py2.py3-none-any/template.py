...
# Embedded file name: build/bdist.linux-x86_64/egg/psphere/template.py
# Compiled at: 2013-04-04 22:22:41
import glob, os, yaml, logging
from psphere import config
from psphere.errors import TemplateNotFoundError
logger = logging.getLogger(__name__)
template_path = os.path.expanduser(config._config_value('general', 'template_dir'))
