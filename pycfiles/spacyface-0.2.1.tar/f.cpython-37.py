...
# [GCC 8.4.0]
# Embedded file name: /Users/benjamin.hoover@ibm.com/Projects/spacyface-aligner/aligner/utils/f.py
...
def delegates(to=None, keep=False):
    ...
    def _f(f):
        ...
        k = sigd.pop('kwargs')
        s2 = {k:v for k, v in inspect.signature(to_f).parameters.items() if k not in sigd}
        sigd.update(s2)
        if keep:
            sigd['kwargs'] = k
