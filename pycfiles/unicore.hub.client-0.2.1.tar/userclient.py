...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/universalcore/unicore.hub.client/unicore/hub/client/userclient.py
# Compiled at: 2015-05-26 03:45:58
from urllib import urlencode
from urlparse import urlparse
from unicore.hub.client.base import ClientException, BaseClient, BaseClientObject
...
class UserClient(BaseClient):
    ...
    def get_login_redirect_url(self, login_callback_url=None, locale=None):
        ...
        return self._make_url('/sso/login?%s' % urlencode(params), use_https=use_https)
