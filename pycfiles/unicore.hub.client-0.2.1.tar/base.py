...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/universalcore/unicore.hub.client/unicore/hub/client/base.py
...
class BaseClient(object):
    ...
    def __init__(self, **settings):
        ...
        self.session.auth = HTTPBasicAuth(settings['app_id'], settings['app_key'])
