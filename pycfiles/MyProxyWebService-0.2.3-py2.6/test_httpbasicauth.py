...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/myproxy/ws/test/test_httpbasicauth.py
# Compiled at: 2012-08-01 06:51:11
...
__revision__ = '$Id: $'
import unittest, os, base64, paste.fixture
from paste.deploy import loadapp
from myproxy.ws.server.wsgi.httpbasicauth import HttpBasicAuthMiddleware, HttpBasicAuthResponseException
...
class TestHttpBasicAuthCallBackAppMiddleware(object):
    ...
    def __call__(self, environ, start_response):
        ...
        def authenticationApp(environ, start_response, username, password):
            ...
            """
            if username == self.__class__.USERNAME and password == self.__class__.PASSWORD:
...
class TestHttpBasicAuthCallBackMiddleware(object):
    ...
    def __call__(self, environ, start_response):
        ...
        def authenticate(environ, start_response, username, password):
            ...
            if username != self.__class__.USERNAME or password != self.__class__.PASSWORD:
...
class HttpBasicAuthMiddlewareTestCase(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        configFilePath = 'config:%s' % HttpBasicAuthMiddlewareTestCase.CONFIG_FILE
    ...
    def test02ValidCredentials(self):
        ...
        self.assert_(TestHttpBasicAuthCallBackAppMiddleware.SUCCESS_RESPONSE in response)
    ...
    def test03InvalidCredentials(self):
        ...
        self.assert_(TestHttpBasicAuthCallBackAppMiddleware.FAILURE_RESPONSE in response)

    def _createCallbackMiddleware(self):
        app = TestApp({})
        app = HttpBasicAuthMiddleware.filter_app_factory(app, {}, prefix='', authnFuncEnvironKeyName='HTTPBASICAUTH_FUNC')
