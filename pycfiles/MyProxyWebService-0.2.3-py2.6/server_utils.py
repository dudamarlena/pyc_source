...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/myproxy/ws/test/server_utils.py
# Compiled at: 2012-05-28 10:37:10
...
class PasteDeployAppServer(object):
    ...
    def __init__(self, app=None, cfgFilePath=None, port=7443, host='0.0.0.0', ssl_context=None, withLoggingConfig=True):
        ...
        if cfgFilePath:
            ...
            raise KeyError('Either the "cfgFilePath" or "app" keyword must be set')
        self.__pasteServer = paste.httpserver.serve(app, host=host, port=port, start_loop=False, ssl_context=ssl_context)
        return
