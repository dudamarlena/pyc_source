...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-oauth-tokens/oauth_tokens/base.py
# Compiled at: 2016-01-18 08:17:38
...
class AccessTokenBase(object, SettingsMixin):
    ...
    def oauth1_get(self):
        ...
        self.oauth = OAuth1Session(self.client_id, client_secret=self.client_secret, resource_owner_key=resource_owner_key, resource_owner_secret=resource_owner_secret, verifier=verifier)
    ...
    def oauth2_refresh(self, token):
        ...
        token = self.oauth.refresh_token(self.access_token_url, client_id=self.client_id, client_secret=self.client_secret)
        token['scope'] = self.scope
        return token

    def fetch_token(self, authorization_response_url):
        return self.oauth.fetch_token(self.access_token_url, authorization_response=authorization_response_url, client_secret=self.client_secret)
