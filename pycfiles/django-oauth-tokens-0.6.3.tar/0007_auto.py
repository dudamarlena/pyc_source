...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-oauth-tokens/oauth_tokens/migrations/0007_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('oauth_tokens_accesstoken', ['provider'])

    def backwards(self, orm):
        db.delete_index('oauth_tokens_accesstoken', ['provider'])
