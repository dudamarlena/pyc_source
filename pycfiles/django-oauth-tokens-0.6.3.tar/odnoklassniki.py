...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-oauth-tokens/oauth_tokens/providers/odnoklassniki.py
...
class OdnoklassnikiAccessToken(AccessTokenBase):
    ...
    def authorization_permissions_request(self, response):
        if 'OAuth2Permissions' in response.content:
            ...
            data.update({'button_accept_request': 'clicked', 
