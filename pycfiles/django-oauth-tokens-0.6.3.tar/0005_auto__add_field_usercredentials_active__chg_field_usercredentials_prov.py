...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-oauth-tokens/oauth_tokens/migrations/0005_auto__add_field_usercredentials_active__chg_field_usercredentials_prov.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('oauth_tokens_usercredentials', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
