...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/frame/util.py
...
def make_resource(controller, path):
    ...
    controller.__resource__ = {'base_uri': path, 
...
def jsonify(require_content_type=False):
    ...
    def wrapper(f):
        ...
        def handler(*args, **kwargs):
            if not require_content_type or require_content_type and 'content_type' in kwargs and kwargs['content_type'] == 'json':
