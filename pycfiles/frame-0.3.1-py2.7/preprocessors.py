...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/frame/testsuite/preprocessors.py
# Compiled at: 2013-03-16 04:09:31
import unittest
...
from frame.preprocessors import form_url_decoder, form_json_decoder, form_multipart_decoder, handle_query_string
...
class TestPreprocessors(unittest.TestCase):
    ...
    def test_form_json_decoder(self):
        ...
        environ.update({'HTTP_CONTENT_TYPE': 'application/json', 
    ...
    def test_handle_query_string(self):
        environ = dict(_environ)
        environ.update({'QUERY_STRING': 'data=some_data'})
        request = Request(environ)
