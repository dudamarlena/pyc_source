...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/frame/testsuite/request.py
# Compiled at: 2013-03-16 04:04:43
import unittest
from StringIO import StringIO
from frame.request import Request
_request_body = 'name=Bob%20The%20Builder'
_environ = {'wsgi.input': StringIO(_request_body), 
   'wsgi.multithreaded': True, 
   'wsgi.multiprocess': False, 
   'HTTP_COOKIE': 'FrameSession=sahiosadnlk2n34o23asd', 
   'HTTP_ACCEPT': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8', 
   'HTTP_USER_AGENT': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.160 Safari/537.22', 
