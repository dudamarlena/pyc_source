...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/frame/driverdatabase.py
# Compiled at: 2013-07-28 12:54:27
"""
...
from postprocessors import deflate, handle_head_request, add_last_modified, jsonify, add_date
from preprocessors import form_url_decoder, form_json_decoder, form_multipart_decoder, handle_query_string
...
class PreprocessorInterface(DriverInterface):
    ...
    def __init__(self, *args, **kwargs):
        DriverInterface.__init__(self, *args, **kwargs)
        self.update({'form_url_decoder': form_url_decoder, 
...
class DispatcherInterface(DriverInterface):
    ...
    def __init__(self, *args, **kwargs):
        DriverInterface.__init__(self, *args, **kwargs)
        self.update({'routes': RoutesDispatcher})
...
class LogInterface(DriverInterface):
    ...
    def __init__(self, *args, **kwargs):
        DriverInterface.__init__(self, *args, **kwargs)
        self.logger = None
        self.update({'stdout': logger.StdoutLogger, 
