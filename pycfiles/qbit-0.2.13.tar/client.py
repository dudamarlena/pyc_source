...
# [GCC 8.4.0]
# Embedded file name: /root/bin/clients/qbit/client.py
# Compiled at: 2019-02-28 15:04:12
...
def client(root_certs=None, auth_url='https://portal-api.1qbit.com/v1/get_project_token', host='grpc.1qb.it', client_id=None, client_secret=None, insecure=False):
    if insecure:
