...
# [GCC 8.4.0]
# Embedded file name: /var/lib/jenkins/jobs/Lucterios_Standard/workspace/lct-documents/lucterios/documents/migrations/0004_newcontainers.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='AbstractContainer',
       fields=[
      (
     ...
     migrations.CreateModel(name='DocumentContainer',
       fields=[
      (
      ...
      'default_permissions':[],  'ordering':[
       'parent__name', 'name']},
       bases=('documents.abstractcontainer', )),
     migrations.CreateModel(name='FolderContainer',
       fields=[
      (
       'abstractcontainer_ptr', models.OneToOneField(auto_created=True, on_delete=(django.db.models.deletion.CASCADE), parent_link=True, primary_key=True, serialize=False, to='documents.AbstractContainer')),
      (
      ...
      'default_permissions':[],  'ordering':[
       'parent__name', 'name']},
       bases=('documents.abstractcontainer', )),
     migrations.AddField(model_name='abstractcontainer',
       name='parent',
