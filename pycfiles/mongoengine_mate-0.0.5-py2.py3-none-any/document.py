...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/mongoengine_mate-project/mongoengine_mate/document.py
# Compiled at: 2019-12-27 12:38:54
"""
    ...
    **中文文档**
    ...
    def to_dict(self, include_none=True):
        ...
        if include_none:
            ...
            return {key:value for key, value in self.items() if value is not None if value is not None}
    ...
    def to_OrderedDict(self, include_none=True):
        ...
        if include_none:
            ...
            return OrderedDict([ (key, value) for key, value in self.items() if value is not None
                               ])
            return
    ...
    def _smart_update(cls, obj, upsert=False):
        ...
        if isinstance(obj, cls):
            ...
            return cls.objects(__raw__={'_id': obj.id}).update_one(upsert=upsert, **dct)
        raise TypeError
