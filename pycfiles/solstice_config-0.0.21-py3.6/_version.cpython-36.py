...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/solstice/config/_version.py
# Compiled at: 2020-05-03 22:16:49
...
def get_config():
    ...
    cfg.versionfile_source = 'solstice/config/_version.py'
    cfg.verbose = False
    return cfg
