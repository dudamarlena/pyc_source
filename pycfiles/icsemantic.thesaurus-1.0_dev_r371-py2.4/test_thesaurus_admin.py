...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/icsemantic/thesaurus/tests/test_thesaurus_admin.py
...
class TestThesaurusAdmin(base.icSemanticTestCase):
    ...
    def thesaurusConceptsListHTML(self, languages=[
 'en'], page='', elementsbypage=''):
    ...
    def readTermConceptsHTML(self, term, languages=[
 'en'], page='', elementsbypage=''):
    ...
    def searchConceptsHTML(self, search_expression, languages=[
 'en'], page='', elementsbypage=''):
    ...
    def searchConceptsPageList(self, search_expression, languages=[
 'en'], page='', elementsbypage=''):
        self.app.REQUEST.set('search', search_expression)
        self.app.REQUEST.set('languages', (',').join(languages))
        self.app.REQUEST.set('format', 'simple')
