...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/voice/migrations/0003_auto__del_request__add_feature__del_field_vote_request__add_field_vote.py
# Compiled at: 2011-09-22 20:01:33
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'voice.feature': {'Meta': {'object_name': 'Feature'}, 'created': (
                         ...
                         'state': (
                                 'django.db.models.fields.CharField', [], {'default': "'V'", 'max_length': '1'}), 
                         'title': (
                                 'django.db.models.fields.CharField', [], {'max_length': '50'}), 
                         'votes_needed': (
                                        'django.db.models.fields.IntegerField', [], {})}, 
       'voice.vote': {'Meta': {'unique_together': "(('feature', 'voter'),)", 'object_name': 'Vote'}, 'feature': (
                                'django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': "orm['voice.Feature']"}), 
                      'id': (
                           'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                      'used_facebook': (
