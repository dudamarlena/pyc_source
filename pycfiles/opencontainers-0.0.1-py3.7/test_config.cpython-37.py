...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/opencontainers/tests/test_config.py
# Compiled at: 2019-11-04 15:07:09
# Size of source mod 2**32: 5019 bytes
from opencontainers.image.v1 import Image
import os, pytest
config_invalid_os = {'architecture':'amd64', 
 'os':123, 
 'rootfs':{'diff_ids':[
   'sha256:5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef'], 
  'type':'layers'}}
config_invalid_user = {'created':'2015-10-31T22:22:56.015925234Z', 
 ...
 'rootfs':{'diff_ids':[
   'sha256:5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef'], 
  'type':'layers'}}
config_invalid_history = {'history':'should be an array', 
 'architecture':'amd64', 
 'os':'linux', 
 'rootfs':{'diff_ids':[
   'sha256:5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef'], 
  'type':'layers'}}
config_invalid_envint = {'architecture':'amd64', 
 'os':'linux', 
 'config':{'Env': [
          7353]}, 
 'rootfs':{'diff_ids':[
   'sha256:5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef'], 
  'type':'layers'}}
config_invalid_volumes = {'architecture':'amd64', 
 'os':'linux', 
 'config':{'Volumes': [
              '/var/job-result-data',
              '/var/log/my-app-logs']}, 
 'rootfs':{'diff_ids':[
   'sha256:5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef'], 
  'type':'layers'}}
config_valid_with_optional = {'created':'2015-10-31T22:22:56.015925234Z', 
 'author':'Alyssa P. Hacker <alyspdev@example.com>', 
 'architecture':'amd64', 
 'os':'linux', 
 'config':{'User':'1:1', 
  ...
  'Volumes':{'/var/job-result-data':{},  '/var/log/my-app-logs':{}},  'StopSignal':'SIGKILL', 
 ...
 'history':[
  ...
  {'created':'2015-10-31T22:22:55.613815829Z', 
   ...
   'empty_layer':True}]}
config_valid_required = {'architecture':'amd64', 
 'os':'linux', 
 'rootfs':{'diff_ids':[
   'sha256:5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef'], 
  'type':'layers'}}
config_invalid_env = {'architecture':'amd64', 
 'os':'linux', 
 'config':{'Env': [
          'foo']}, 
 'rootfs':{'diff_ids':[
