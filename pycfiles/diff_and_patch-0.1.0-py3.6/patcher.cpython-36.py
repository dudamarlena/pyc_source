...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/diff_and_patch/patch/patcher.py
# Compiled at: 2018-08-26 08:46:10
...
class Patcher(object):
    ...
    def __repr__(self):
        return '{kls}: ({p})'.format(kls=(self.__class__.__name__), p=(','.join([str(i) for i in self._patch_items])))
