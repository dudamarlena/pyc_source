...
# [GCC 8.4.0]
# Embedded file name: /home/marx/venv3/lib/python3.6/site-packages/tsr/spiders/searchAPI.py
# Compiled at: 2018-05-13 09:02:24
# Size of source mod 2**32: 7742 bytes
...
def main_raw(**kwargs):
    ...
    def parse_threadpage(url):
        ...
        print('soups.parse_threadpage({}, {}, {}, overwrite_posts={})'.format('soup', url, thread_type, overwrite_posts))
    ...
    def parse_threadpages(thread_type, thread_or_post_id):
        ...
        if thread_id:
            while page_current <= page_last:
                ...
                print('Parsed {} {} - Page {}/{}'.format(thread_type, str(thread_id), str(page_current), str(page_last)))
                page_current += 1
                time.sleep(delay)
...
def main():
    args = sys.argv[1:]
    main_raw(**vars(parser.parse_args(args)))
