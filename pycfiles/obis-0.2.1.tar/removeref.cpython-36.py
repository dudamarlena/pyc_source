...
# [GCC 8.4.0]
# Embedded file name: /Users/vermeul/openbis/obis/src/python/obis/dm/commands/removeref.py
...
class Removeref(OpenbisCommand):
    ...
    def _remove_content_copies_from_repository(self):
        ...
        content_copies_to_delete = list(filter(lambda cc: cc['externalDms']['code'] == self.external_dms_id() and cc['path'] == self.path(), content_copies))
