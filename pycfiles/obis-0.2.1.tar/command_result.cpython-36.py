...
# [GCC 8.4.0]
# Embedded file name: /Users/vermeul/openbis/obis/src/python/obis/dm/command_result.py
# Compiled at: 2019-05-21 15:45:31
# Size of source mod 2**32: 1347 bytes


class CommandResult(object):
    __doc__ = 'Encapsulate result from a subprocess call.'
...
class CommandException(Exception):
    __doc__ = ' Instead of returning a CommandResult for all actions, we can also return \n    a result normally and throw a CommandException instead on error. '
