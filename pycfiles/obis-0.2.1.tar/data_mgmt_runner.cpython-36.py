...
# [GCC 8.4.0]
# Embedded file name: /Users/vermeul/openbis/obis/src/python/obis/scripts/data_mgmt_runner.py
# Compiled at: 2018-10-23 04:48:35
# Size of source mod 2**32: 4808 bytes
...
class DataMgmtRunner(object):
    ...
    def _get_dm(self):
        ...
        log = CommandLog()
        if self.halt_on_error_log:
            if log.any_log_exists():
