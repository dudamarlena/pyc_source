...
# [GCC 8.4.0]
# Embedded file name: d:\Dropbox\vk\django-trusted-html\trustedhtml\rules\html\contents.py
...
preformatted = [
 'pre']
block = heading + list + preformatted + ['p', 'dl', 'div', 'center', 'noscript', 'noframes', 'blockquote', 'form', 'isindex', 'hr', 'table', 'fieldset', 'address'] + [
 'noindex']
flow = block + inline
...
contents['bdo'] = inline
contents['blockquote'] = flow
contents['body'] = block + ['script'] + ['ins', 'del']
contents['br'] = empty
