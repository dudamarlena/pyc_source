...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/termprop/termprop.py
# Compiled at: 2014-01-23 11:39:12
import sys, os, termios, select, re, wcwidth as ww
...
_bg_pattern = re.compile('\x1b\\][0-9]+;rgb\\:([0-9A-Fa-f]+\\/[0-9A-Fa-f]+\\/[0-9A-Fa-f]+)')
