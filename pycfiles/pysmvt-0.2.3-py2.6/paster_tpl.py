...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysmvt/paster_tpl.py
...
def run_template(interactive, verbose, overwrite, vars, output_dir, tname, type):
...
def extend_templates(templates, tmpl_name, type):
    ...
    if dist_name is None:
        ...
        entry = dist.get_entry_info('pysmvt.%s' % type, tmpl_name)
        tmpl = entry.load()(entry.name)
