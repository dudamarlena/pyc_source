...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/musixmatch/track.py
# Compiled at: 2011-08-11 04:57:31
"""
...
class Track(Item):
    ...
    **track.get** or from an already well-formed :py:class:`dict`. Create a
    ...
    def get(self, key, default=_marker):
        ...
        result is saved.
        """
        special = {'lyrics': lyrics.Lyrics, 
           'subtitle': subtitle.Subtitle}
        if key in special and key not in self:
    ...
    def postFeedback(self, feedback):
        ...
        if feedback in accepted:
            message = track.lyrics.feedback.post(track_id=self['track_id'], lyrics_id=self['track_id']['lyrics']['lyrics_id'], feedback=feedback)
