...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/musixmatch/base.py
# Compiled at: 2011-07-18 17:00:48
"""
...
class ItemsCollection(Base, list):
    ...
    def paged(self, page_size=3):
        ...
        """
        return [ self.page(i, page_size) for i in range(self.pages(page_size))
               ]
