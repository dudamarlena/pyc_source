...
# [GCC 8.4.0]
# Embedded file name: build/lib.macosx-10.6-intel-2.7/QuantLib/QuantLib.py
# Compiled at: 2020-03-19 18:37:48
...
class LevenbergMarquardt(OptimizationMethod):
    ...
    def __init__(self, epsfcn=1e-08, xtol=1e-08, gtol=1e-08, useCostFunctionsJacobian=False):
...
class SmileSection(Observable):
    ...
    def density(self, strike, discount=1.0, gap=0.0001):
...
def shiftedSabrVolatility(strike, forward, expriyTime, alpha, beta, nu, rho, shift):
    return _QuantLib.shiftedSabrVolatility(strike, forward, expriyTime, alpha, beta, nu, rho, shift)
...
class AndreasenHugeVolatilityAdapter(BlackVolTermStructure):
    ...
    def __init__(self, volInterpl, eps=1e-06):
...
class HestonProcess(StochasticProcess):
    ...
    def __init__(self, riskFreeTS, dividendTS, s0, v0, kappa, theta, sigma, rho):
        _QuantLib.HestonProcess_swiginit(self, _QuantLib.new_HestonProcess(riskFreeTS, dividendTS, s0, v0, kappa, theta, sigma, rho))
...
def MakeSchedule(effectiveDate=None, terminationDate=None, tenor=None, frequency=None, calendar=None, convention=None, terminalDateConvention=None, rule=None, forwards=False, backwards=False, endOfMonth=None, firstDate=None, nextToLastDate=None):
    ms = _MakeSchedule()
...
class NumericHaganPricer(CmsCouponPricer):
    ...
    def __init__(self, v, model, meanReversion, lowerLimit=0.0, upperLimit=1.0, precision=1e-06):
...
class LinearTsrPricerSettings(object):
    ...
    def withRateBound(self, lowerRateBound=0.0001, upperRateBound=2.0):
...
class VanillaOption(OneAssetOption):
    ...
    def impliedVolatility(self, targetValue, process, accuracy=0.0001, maxEvaluations=100, minVol=0.0001, maxVol=4.0):
...
def MCEuropeanEngine(process, traits, timeSteps=None, timeStepsPerYear=None, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    ...
    return cls(process, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
...
def MCAmericanEngine(process, traits, timeSteps=None, timeStepsPerYear=None, antitheticVariate=False, controlVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0, polynomOrder=2, polynomType=LsmBasisSystem.Monomial, nCalibrationSamples=2048, antitheticVariateCalibration=None, seedCalibration=None):
    ...
    if traits == 'pr' or traits == 'pseudorandom':
        ...
        raise RuntimeError('unknown MC traits: %s' % traits)
    return cls(process, timeSteps, timeStepsPerYear, antitheticVariate, controlVariate, requiredSamples, requiredTolerance, maxSamples, seed, polynomOrder, polynomType, nCalibrationSamples, antitheticVariateCalibration, seedCalibration if seedCalibration is not None else nullInt())
...
def MCEuropeanHestonEngine(process, traits, timeSteps=None, timeStepsPerYear=None, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
        ...
        raise RuntimeError('unknown MC traits: %s' % traits)
    return cls(process, timeSteps, timeStepsPerYear, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
...
def MCBarrierEngine(process, traits, timeSteps=None, timeStepsPerYear=None, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, isBiased=False, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
        ...
        raise RuntimeError('unknown MC traits: %s' % traits)
    return cls(process, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, isBiased, seed)
...
def MCDiscreteArithmeticAPEngine(process, traits, brownianBridge=False, antitheticVariate=False, controlVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
        ...
        raise RuntimeError('unknown MC traits: %s' % traits)
    return cls(process, brownianBridge, antitheticVariate, controlVariate, requiredSamples, requiredTolerance, maxSamples, seed)
...
def MCDiscreteArithmeticASEngine(process, traits, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
        ...
        raise RuntimeError('unknown MC traits: %s' % traits)
    return cls(process, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
...
def MCDiscreteGeometricAPEngine(process, traits, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
...
def MCEuropeanGJRGARCHEngine(process, traits, timeSteps=None, timeStepsPerYear=None, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
...
def MCEuropeanBasketEngine(process, traits, timeSteps=None, timeStepsPerYear=None, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
...
def MCAmericanBasketEngine(process, traits, timeSteps=None, timeStepsPerYear=None, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0, nCalibrationSamples=2048, polynomOrder=2, polynomType=LsmBasisSystem.Monomial):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
        ...
        raise RuntimeError('unknown MC traits: %s' % traits)
    return cls(process, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed, nCalibrationSamples, polynomOrder, polynomType)
...
def MCEverestEngine(process, traits, timeSteps=None, timeStepsPerYear=None, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
...
def MCHimalayaEngine(process, traits, brownianBridge=False, antitheticVariate=False, requiredSamples=None, requiredTolerance=None, maxSamples=None, seed=0):
    traits = traits.lower()
    if traits == 'pr' or traits == 'pseudorandom':
...
def MakeVanillaSwap(swapTenor, iborIndex, fixedRate, forwardStart, receiveFixed=None, swapType=None, Nominal=None, settlementDays=None, effectiveDate=None, terminationDate=None, dateGenerationRule=None, fixedLegTenor=None, fixedLegCalendar=None, fixedLegConvention=None, fixedLegDayCount=None, floatingLegTenor=None, floatingLegCalendar=None, floatingLegConvention=None, floatingLegDayCount=None, floatingLegSpread=None, discountingTermStructure=None, pricingEngine=None, fixedLegTerminationDateConvention=None, fixedLegDateGenRule=None, fixedLegEndOfMonth=None, fixedLegFirstDate=None, fixedLegNextToLastDate=None, floatingLegTerminationDateConvention=None, floatingLegDateGenRule=None, floatingLegEndOfMonth=None, floatingLegFirstDate=None, floatingLegNextToLastDate=None):
...
def MakeOIS(swapTenor, overnightIndex, fixedRate, fwdStart=Period(0, Days), receiveFixed=True, swapType=OvernightIndexedSwap.Payer, nominal=1.0, settlementDays=2, effectiveDate=None, terminationDate=None, dateGenerationRule=DateGeneration.Backward, paymentFrequency=Annual, paymentAdjustmentConvention=Following, paymentLag=0, paymentCalendar=None, endOfMonth=True, fixedLegDayCount=None, overnightLegSpread=0.0, discountingTermStructure=None, telescopicValueDates=False, pricingEngine=None):
...
class YoYInflationCapFloor(Instrument):
    ...
    def impliedVolatility(self, price, curve, guess, accuracy=0.0001, maxEvaluations=100, minVol=1e-07, maxVol=4.0):
...
class CallableBond(Bond):
    ...
    def effectiveDuration(self, oas, engineTS, dayCounter, compounding, frequency, bump=0.0002):
        return _QuantLib.CallableBond_effectiveDuration(self, oas, engineTS, dayCounter, compounding, frequency, bump)

    def effectiveConvexity(self, oas, engineTS, dayCounter, compounding, frequency, bump=0.0002):
...
class CapFloor(Instrument):
    ...
    def impliedVolatility(self, price, disc, guess, accuracy=0.0001, maxEvaluations=100, minVol=1e-07, maxVol=4.0, type=ShiftedLognormal, displacement=0.0):
...
class CdsOption(Option):
    ...
    def impliedVolatility(self, price, termStructure, arg4, recoveryRate, accuracy=0.0001, maxEvaluations=100, minVol=1e-07, maxVol=4.0):
...
class InverseNonCentralCumulativeChiSquareDistribution(object):
    ...
    def __init__(self, df, ncp, maxEvaluations=10, accuracy=1e-08):
...
class InverseCumulativeStudent(object):
    ...
    def __init__(self, n, accuracy=1e-06, maxIterations=50):
...
class ExponentialJump1dMesher(Fdm1dMesher):
    ...
    def __init__(self, steps, beta, jumpIntensity, eta, eps=0.001):
...
class HestonRNDCalculator(RiskNeutralDensityCalculator):
    ...
    def __init__(self, hestonProcess, integrationEps=1e-06, maxIntegrationIterations=10000):
...
class RungeKutta(object):
    ...
    def __init__(self, eps=1e-06, h1=0.0001, hmin=0.0):
...
class Swaption(Option):
    ...
    def impliedVolatility(self, price, discountCurve, guess, accuracy=0.0001, maxEvaluations=100, minVol=1e-07, maxVol=4.0, type=ShiftedLognormal, displacement=0.0):
