...
# [GCC 8.4.0]
# Embedded file name: mangopayments/helpers/payin_helpers.py
# Compiled at: 2019-01-24 06:42:52
...
def create_mangopay_card_registration(mangopay_user, currency, card_type):
    ...
    return {'access_key': access_key, 'card_registration_URL': card_registration_url, 
...
def create_mangopay_payin(mangopay_user, mangopay_wallet, mangopay_card, debited_funds, fees, currency, secure_mode_return_url):
    """
    ...
    """
    payin = MangoPayPayInByCard(mangopay_user=mangopay_user, mangopay_wallet=mangopay_wallet, mangopay_card=mangopay_card, debited_funds=debited_funds, currency=currency, fees=fees)
    payin.save()
