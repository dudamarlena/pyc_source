...
# Compiled at: 2019-01-31 02:29:03
# Size of source mod 2**32: 16448 bytes
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='MangoPayBankAccount', fields=[
      (
     ...
     migrations.CreateModel(name='MangoPayCard', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
     ...
     migrations.CreateModel(name='MangoPayCardRegistration', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
      (
       'mangopay_card',
       models.OneToOneField(related_name='mangopay_card_registration', null=True, blank=True, to='mangopayments.MangoPayCard', on_delete=models.PROTECT))]),
     migrations.CreateModel(name='MangoPayDocument', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
     ...
     migrations.CreateModel(name='MangoPayPage', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
     ...
     migrations.CreateModel(name='MangoPayPayIn', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
     ...
     migrations.CreateModel(name='MangoPayPayOut', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
     ...
     migrations.CreateModel(name='MangoPayRefund', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
     ...
     migrations.CreateModel(name='MangoPayTransfer', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
      ...
      (
       'result_code', models.CharField(max_length=6, null=True, blank=True))]),
     migrations.CreateModel(name='MangoPayUser', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
     ...
     migrations.CreateModel(name='MangoPayWallet', fields=[
      (
       'id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
      (
       'mangopay_id', models.PositiveIntegerField(null=True, blank=True)),
     ...
     migrations.CreateModel(name='MangoPayLegalUser', fields=[
      (
      ...
      (
       'headquarters_country_code', models.CharField(max_length=255, null=True, blank=True))], bases=('mangopayments.mangopayuser', )),
     migrations.CreateModel(name='MangoPayNaturalUser', fields=[
      (
       'mangopayuser_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
      (
       'occupation', models.CharField(max_length=254, null=True, blank=True)),
      (
       'income_range', models.SmallIntegerField(blank=True, null=True, choices=[(1, b'0 - 1,500'), (2, b'1,500 - 2,499'), (3, b'2,500 - 3,999'), (4, b'4,000 - 7,499'), (5, b'7,500 - 9,999'), (6, b'10,000 +')]))], bases=('mangopayments.mangopayuser', )),
     migrations.AddField(model_name='mangopaywallet', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_wallets', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopayuser', name='user', field=models.ForeignKey(related_name='mangopay_users', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaytransfer', name='mangopay_credited_wallet', field=models.ForeignKey(related_name='mangopay_credited_wallets', to='mangopayments.MangoPayWallet', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaytransfer', name='mangopay_debited_wallet', field=models.ForeignKey(related_name='mangopay_debited_wallets', to='mangopayments.MangoPayWallet', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopayrefund', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_refunds', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaypayout', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_payouts', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaypayout', name='mangopay_wallet', field=models.ForeignKey(related_name='mangopay_payouts', to='mangopayments.MangoPayWallet', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaypayin', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_payins', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaypayin', name='mangopay_wallet', field=models.ForeignKey(related_name='mangopay_payins', to='mangopayments.MangoPayWallet', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaydocument', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_documents', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaycardregistration', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_card_registrations', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.AddField(model_name='mangopaybankaccount', name='mangopay_user', field=models.ForeignKey(related_name='mangopay_bank_accounts', to='mangopayments.MangoPayUser', on_delete=models.PROTECT)),
     migrations.CreateModel(name='MangoPayPayInBankWire', fields=[], options={'proxy': True}, bases=('mangopayments.mangopaypayin', )),
     migrations.CreateModel(name='MangoPayPayInByCard', fields=[], options={'proxy': True}, bases=('mangopayments.mangopaypayin', ))]