...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterField(model_name='mangopaypayin', name='type', field=models.CharField(choices=[(b'BANK_WIRE', 'Bank Wire'), (b'CARD', 'Card'), (b'PREAUTHORIZED', 'Preauthorized'), (b'DIRECT_DEBIT', 'Direct Debit')], default=b'CARD', max_length=20))]