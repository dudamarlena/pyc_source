...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\xicam\toolbar.py
...
class difftoolbar(QtGui.QToolBar):
    ...
    def connecttriggers(self, calibrate, centerfind, refine, showmask, cake, remesh, linecut, vertcut, horzcut, logint, radialsym, mirrorsym, roi, arc, polymask, process=None, video=None, capture=None, removecosmics=None, thresholdmask=None):
