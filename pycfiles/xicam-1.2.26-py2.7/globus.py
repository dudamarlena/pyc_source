...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\client\globus.py
...
class GlobusClient(User):
    ...
    """
    AUTH_URL = 'https://nexus.api.globusonline.org/goauth/token?grant_type=client_credentials'
    ...
    def login(self, username, password):
        ...
        if r.ok:
            ...
            self.authentication = {'Authorization': 'Globus-Goauthtoken %s' % access_token}
    ...
    def determine_local_endpoint(self):
        ...
        for endpoint in user_endpoints:
            ...
            r = self.get(self.TRANSFER_URL + '/endpoint/' + quote(endpoint) + '/ls', headers=self.authentication, params=params)
            try:
    ...
    def delete_file(self, endpoint, fpath):
        ...
        r = self.post(self.TRANSFER_URL + '/delete', json=delete_submission, headers=self.authentication)
