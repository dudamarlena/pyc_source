...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\modpkgs\pyqtgraphmod.py
...
class fixedexporter(ImageExporter):
    ...
    def export(self, fileName=None, toBytes=False, copy=False):
        if fileName is None and not toBytes and not copy:
            ...
            try:
                self.setExportMode(True, {'antialias': self.params['antialias'], 'background': self.params['background'], 'painter': painter, 
