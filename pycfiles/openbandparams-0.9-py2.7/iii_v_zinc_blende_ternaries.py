...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/openbandparams/iii_v_zinc_blende_ternaries.py
# Compiled at: 2015-04-09 02:47:55
from .iii_v_zinc_blende_ternary import IIIVZincBlendeTernary
from .iii_v_zinc_blende_binaries import AlN, GaN, InN, AlP, GaP, InP, AlAs, GaAs, InAs, AlSb, GaSb, InSb
...
GaInP = IIIVZincBlendeTernary(name='GaInP', elements=('Ga', 'In', 'P'), binaries=(
 GaP, InP), parameters=[
...
AlGaAs = IIIVZincBlendeTernary(name='AlGaAs', elements=('Al', 'Ga', 'As'), binaries=(
 AlAs, GaAs), parameters=[
...
AlGaAs.add_parameter(FunctionParameter('Eg_Gamma_bowing', AlGaAs_Eg_Gamma_bowing, units='eV', references=[
 vurgaftman_2001]))
AlInAs = IIIVZincBlendeTernary(name='AlInAs', elements=('Al', 'In', 'As'), binaries=(
 AlAs, InAs), parameters=[
...
GaInAs = IIIVZincBlendeTernary(name='GaInAs', elements=('Ga', 'In', 'As'), binaries=(
 GaAs, InAs), parameters=[
 ValueParameter('Delta_SO_bowing', 0.15, 'eV', references=[vurgaftman_2001]),
...
AlGaSb = IIIVZincBlendeTernary(name='AlGaSb', elements=('Al', 'Ga', 'Sb'), binaries=(
 AlSb, GaSb), parameters=[
...
AlGaSb.add_parameter(FunctionParameter('Eg_Gamma_bowing', AlGaSb_Eg_Gamma_bowing, units='eV', references=[
 vurgaftman_2001]))
AlInSb = IIIVZincBlendeTernary(name='AlInSb', elements=('Al', 'In', 'Sb'), binaries=(
 AlSb, InSb), parameters=[
...
GaInSb = IIIVZincBlendeTernary(name='GaInSb', elements=('Ga', 'In', 'Sb'), binaries=(
 GaSb, InSb), parameters=[
...
AlNP = IIIVZincBlendeTernary(name='AlNP', elements=('Al', 'N', 'P'), binaries=(
 AlN, AlP), parameters=[])
GaNP = IIIVZincBlendeTernary(name='GaNP', elements=('Ga', 'N', 'P'), binaries=(
 GaN, GaP), parameters=[
 ValueParameter('Eg_Gamma_bowing', 3.9, 'eV', references=[vurgaftman_2001]),
 ValueParameter('Eg_X_bowing', 10.0, 'eV', references=[vurgaftman_2001])])
InNP = IIIVZincBlendeTernary(name='InNP', elements=('In', 'N', 'P'), binaries=(
 InN, InP), parameters=[
 ValueParameter('Eg_Gamma_bowing', 15, 'eV', references=[vurgaftman_2001])])
AlNAs = IIIVZincBlendeTernary(name='AlNAs', elements=('Al', 'N', 'As'), binaries=(
 AlN, AlAs), parameters=[])
GaNAs = IIIVZincBlendeTernary(name='GaNAs', elements=('Ga', 'N', 'As'), binaries=(
 GaN, GaAs), parameters=[])

def GaNAs_Eg_Gamma(self, **kwargs):
    linear = self._interpolate('Eg_Gamma', kwargs)
    x = self._x
    return linear + 20.4 * x ** 2 - 100.0 * x ** 3


GaNAs.add_parameter(MethodParameter('Eg_Gamma', GaNAs_Eg_Gamma, dependencies=[
 'Eg_Gamma'], units='eV', references=[
 vurgaftman_2001]), overload=True)
InNAs = IIIVZincBlendeTernary(name='InNAs', elements=('In', 'N', 'As'), binaries=(
 InN, InAs), parameters=[
 ValueParameter('Eg_Gamma_bowing', 4.22, 'eV', references=[vurgaftman_2001])])
AlPAs = IIIVZincBlendeTernary(name='AlPAs', elements=('Al', 'P', 'As'), binaries=(
 AlP, AlAs), parameters=[
...
GaPAs = IIIVZincBlendeTernary(name='GaPAs', elements=('Ga', 'P', 'As'), binaries=(
 GaP, GaAs), parameters=[
...
InPAs = IIIVZincBlendeTernary(name='InPAs', elements=('In', 'P', 'As'), binaries=(
 InP, InAs), parameters=[
 ValueParameter('Delta_SO_bowing', 0.16, 'eV', references=[vurgaftman_2001]),
 ValueParameter('Eg_Gamma_bowing', 0.1, 'eV', references=[vurgaftman_2001]),
...
AlPSb = IIIVZincBlendeTernary(name='AlPSb', elements=('Al', 'P', 'Sb'), binaries=(
 AlP, AlSb), parameters=[
...
GaPSb = IIIVZincBlendeTernary(name='GaPSb', elements=('Ga', 'P', 'Sb'), binaries=(
 GaP, GaSb), parameters=[
 ValueParameter('Eg_Gamma_bowing', 2.7, 'eV', references=[vurgaftman_2001]),
 ValueParameter('Eg_L_bowing', 2.7, 'eV', references=[vurgaftman_2001]),
 ValueParameter('Eg_X_bowing', 2.7, 'eV', references=[vurgaftman_2001])])
InPSb = IIIVZincBlendeTernary(name='InPSb', elements=('In', 'P', 'Sb'), binaries=(
 InP, InSb), parameters=[
...
AlAsSb = IIIVZincBlendeTernary(name='AlAsSb', elements=('Al', 'As', 'Sb'), binaries=(
 AlAs, AlSb), parameters=[
 ValueParameter('Delta_SO_bowing', 0.15, 'eV', references=[vurgaftman_2001]),
...
GaAsSb = IIIVZincBlendeTernary(name='GaAsSb', elements=('Ga', 'As', 'Sb'), binaries=(
 GaAs, GaSb), parameters=[
...
InAsSb = IIIVZincBlendeTernary(name='InAsSb', elements=('In', 'As', 'Sb'), binaries=(
 InAs, InSb), parameters=[
