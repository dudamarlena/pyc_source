...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/openbandparams/iii_v_zinc_blende_mixed_alloy.py
...
class IIIVZincBlendeMixedAlloy(IIIVZincBlendeAlloy):
    ...
    @method_parameter(dependencies=['Delta_SO'], units='eV')
    def Delta_SO(self, **kwargs):
        return self._interpolate('Delta_SO', kwargs)

    @method_parameter(dependencies=['Eg_Gamma'], units='eV')
    def Eg_Gamma(self, **kwargs):
        return self._interpolate('Eg_Gamma', kwargs)

    @method_parameter(dependencies=['Eg_L'], units='eV')
    def Eg_L(self, **kwargs):
        return self._interpolate('Eg_L', kwargs)

    @method_parameter(dependencies=['Eg_X'], units='eV')
    def Eg_X(self, **kwargs):
        return self._interpolate('Eg_X', kwargs)

    @method_parameter(dependencies=['Ep'], units='eV', references=[vurgaftman_2001])
    def Ep(self, **kwargs):
        """
    ...
    @method_parameter(dependencies=['F'], units='dimensionless', references=[vurgaftman_2001])
    def F(self, **kwargs):
        """
        Linear interpolation is recommended for alloys.
        """
    ...
    @method_parameter(dependencies=['VBO'], units='eV')
    def VBO(self, **kwargs):
        return self._interpolate('VBO', kwargs)

    @method_parameter(dependencies=['a_300K'], units='angstrom')
    ...
    @method_parameter(dependencies=['a_c'], units='eV')
    def a_c(self, **kwargs):
        return self._interpolate('a_c', kwargs)

    @method_parameter(dependencies=['a_v'], units='eV')
    def a_v(self, **kwargs):
        return self._interpolate('a_v', kwargs)

    @method_parameter(dependencies=['b'], units='eV')
    def b(self, **kwargs):
        return self._interpolate('b', kwargs)

    @method_parameter(dependencies=['c11'], units='eV')
    def c11(self, **kwargs):
        return self._interpolate('c11', kwargs)

    @method_parameter(dependencies=['c12'], units='eV')
    def c12(self, **kwargs):
        return self._interpolate('c12', kwargs)

    @method_parameter(dependencies=['c44'], units='eV')
    def c44(self, **kwargs):
        return self._interpolate('c44', kwargs)

    @method_parameter(dependencies=['d'], units='eV')
    def d(self, **kwargs):
        return self._interpolate('d', kwargs)

    @method_parameter(dependencies=['dielectric'], units='dimensionless')
    def dielectric(self, **kwargs):
        return self._interpolate('dielectric', kwargs)

    @method_parameter(dependencies=['dielectric_high_frequency'], units='dimensionless')
    def dielectric_high_frequency(self, **kwargs):
        return self._interpolate('dielectric_high_frequency', kwargs)

    @method_parameter(dependencies=['meff_hh_100', 'meff_lh_100'], units='dimensionless')
    def luttinger1(self, **kwargs):
        return (1.0 / self.meff_lh_100(**kwargs) + 1.0 / self.meff_hh_100(**kwargs)) / 2.0

    @method_parameter(dependencies=['meff_hh_100', 'meff_lh_100'], units='dimensionless')
    def luttinger2(self, **kwargs):
        return (1.0 / self.meff_lh_100(**kwargs) - 1.0 / self.meff_hh_100(**kwargs)) / 4.0

    @method_parameter(dependencies=['luttinger2', 'luttinger32'], units='dimensionless')
    def luttinger3(self, **kwargs):
        return self.luttinger32(**kwargs) + self.luttinger2(**kwargs)

    @method_parameter(dependencies=['luttinger32'], units='dimensionless')
    ...
    @method_parameter(dependencies=['meff_e_L_DOS'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['meff_e_L_long'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['meff_e_L_trans'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['meff_e_X_DOS'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['meff_e_X_long'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['meff_e_X_trans'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['meff_SO'], units='m_e', references=[vurgaftman_2001])
    ...
    @method_parameter(dependencies=['thermal_expansion'], units='angstrom/K')
