...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/softwarefabrica/django/forms/tests/tests.py
# Compiled at: 2010-02-04 04:29:52
"""
>>> import os
...
>>> print form
<tr id="id_fieldrow_form_name"><th><label for="id_name" class="required">Name *:</label></th><td><input id="id_name" type="text" name="name" maxlength="50" /></td></tr>
<tr id="id_fieldrow_form_last_name"><th><label for="id_last_name" class="required">Last name *:</label></th><td><input id="id_last_name" type="text" name="last_name" maxlength="50" /></td></tr>
<tr id="id_fieldrow_form_birth_year"><th><label for="id_birth_year" class="required">Birth year *:</label></th><td><input type="text" name="birth_year" id="id_birth_year" /></td></tr>
<tr id="id_fieldrow_form_active"><th><label for="id_active" class="required">Active *:</label></th><td><input type="checkbox" name="active" id="id_active" /></td></tr>
