...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/redomino/workgroup/Extensions/Install.py
# Compiled at: 2008-06-25 09:09:13
import transaction
from Products.CMFCore.utils import getToolByName
PRODUCT_DEPENDENCIES = ('plone.browserlayer', 'membrane', 'remember')
EXTENSION_PROFILES = ('redomino.workgroup:default', )
