...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\jinja\tests.py
...
def test_numeric():
    ...
    """
    return lambda e, c, v: isinstance(v, (int, long, float)) or isinstance(v, basestring) and number_re.match(v) is not None
