...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\jinja\environment.py
# Compiled at: 2007-10-21 17:00:18
"""
    jinja.environment
    ~~~~~~~~~~~~~~~~~
...
from jinja.exceptions import FilterNotFound, TestNotFound, SecurityException, TemplateSyntaxError
...
class Environment(object):
    ...
    def call_function(self, f, context, args, kwargs, dyn_args, dyn_kwargs):
        ...
        if _getattr(f, 'jinja_unsafe_call', False) or _getattr(f, 'alters_data', False):
            return self.undefined_singleton
