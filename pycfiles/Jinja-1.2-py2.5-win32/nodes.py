...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\jinja\nodes.py
...
class ForLoop(Node):
    ...
    def __init__(self, item, seq, body, else_, recursive, lineno=None, filename=None):
        Node.__init__(self, lineno, filename)
        self.item = item
        self.seq = seq
        self.body = body
    ...
    def get_items(self):
        return [
         self.item, self.seq, self.body, self.else_, self.recursive]
...
class Macro(Node):
    ...
    def get_items(self):
        return [
         self.name] + list(chain(*self.arguments)) + [self.body]
...
class Set(Node):
    ...
    def get_items(self):
        return [
         self.name, self.expr, self.scope_local]
...
class Trans(Node):
    ...
    def __init__(self, singular, plural, indicator, replacements, lineno=None, filename=None):
        Node.__init__(self, lineno, filename)
    ...
    def get_items(self):
        rv = [
         self.singular, self.plural, self.indicator]
...
class ConditionalExpression(Expression):
    ...
    def get_items(self):
        return [
         self.test, self.expr1, self.expr2]
...
class TestExpression(Expression):
    ...
    def get_items(self):
        return [
         self.node, self.name] + list(self.args)
...
class CallExpression(Expression):
    ...
    def __init__(self, node, args, kwargs, dyn_args, dyn_kwargs, lineno=None, filename=None):
        Expression.__init__(self, lineno, filename)
        self.node = node
        self.args = args
        self.kwargs = kwargs
    ...
    def get_items(self):
        return [
         self.node, self.args, self.kwargs, self.dyn_args,
         self.dyn_kwargs]
