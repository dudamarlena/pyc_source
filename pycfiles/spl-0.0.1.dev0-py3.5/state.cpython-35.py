...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spl/state.py
# Compiled at: 2016-12-14 12:14:21
# Size of source mod 2**32: 3762 bytes
import lockfile, os, simplejson
from enum import Enum
from spl.errors import CannotGetStateLockException
_INITIAL_STATE = {'installed_resources': {}}
_STATE_DIR = '.spl/'
