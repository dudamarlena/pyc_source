...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/spl/spiget.py
# Compiled at: 2016-12-14 10:53:38
# Size of source mod 2**32: 4814 bytes
import cfscrape, collections, datetime, requests, spl.metadata as metadata
...
class Resource(object):
    ...
    def for_json(self):
        return {'type': 'spl.spiget.Resource', 
         'id': self.id, 
         'name': self.name, 
         'tag': self.tag, 
...
class Version(object):
    ...
    def for_json(self):
        return {'type': 'spl.spiget.Version', 
         'id': self.id, 
         'name': self.name, 
...
class SpiGet(object):
    ...
    def __init__(self):
        ...
        self.session = CacheControl(session, cache=FileCache('.spl/cache'))
