...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/repoze/who/plugins/testutil.py
# Compiled at: 2010-02-22 17:13:28
...
from repoze.who.config import WhoConfig, make_middleware_with_config as mk_mw_cfg
from repoze.who.interfaces import IIdentifier, IAuthenticator, IChallenger
__all__ = [
 'AuthenticationForgerPlugin', 'AuthenticationForgerMiddleware',
 'make_middleware', 'make_middleware_with_config']
_HTTP_STATUS_PATTERN = compile_regex('^(?P<code>[0-9]{3}) (?P<reason>.*)$')
...
class AuthenticationForgerPlugin(object):
    ...
    def __init__(self, fake_user_key='REMOTE_USER', remote_user_key='repoze.who.testutil.userid'):
        """
...
class AuthenticationForgerMiddleware(PluggableAuthenticationMiddleware):
    ...
    def __init__(self, app, identifiers, authenticators, challengers, mdproviders, classifier, challenge_decider, log_stream=None, log_level=INFO, remote_user_key='REMOTE_USER'):
        """
        ...
        * ``challengers``. Any challenger passed will be ignored; such
        ...
        init(app, identifiers, authenticators, challengers, mdproviders, classifier, challenge_decider, log_stream, log_level, 'repoze.who.testutil.userid')
...
def make_middleware_with_config(app, global_conf, config_file, log_file=None, log_level=None, skip_authentication=False):
    """
    ...
    return AuthenticationForgerMiddleware(app, parser.identifiers, parser.authenticators, parser.challengers, parser.mdproviders, parser.request_classifier, parser.challenge_decider, remote_user_key=parser.remote_user_key)