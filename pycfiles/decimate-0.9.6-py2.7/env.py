...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/decimate/env.py
# Compiled at: 2018-04-07 17:52:33
"""
module finding the environment in where program is called
"""
import datetime, fnmatch, os, re, socket, sys
ERROR = 'err'
CRITICAL = 'critical'
WARNING = 'warning'
INFO = 'info'
SCHEDULER = {'neser': ('loadleveler', 8, ' -l nodes=1:ppn=4,walltime=12:00:00'), 
   'localhost': ('unix', 10, '')}
TMPDIR = '/tmp'
PYTHON_EXE = 'python'
if os.name == 'nt':
...
def get_machine():
    global CORE_PER_NODE_REGARDING_QUEUE
...
# global SCHED_TYPE ## Warning: Unused global