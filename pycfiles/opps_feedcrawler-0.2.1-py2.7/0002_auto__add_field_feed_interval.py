...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/opps/feedcrawler/migrations/0002_auto__add_field_feed_interval.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('feedcrawler_feed', 'interval', self.gf('django.db.models.fields.PositiveIntegerField')(default=20, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('feedcrawler_feed', 'interval')
