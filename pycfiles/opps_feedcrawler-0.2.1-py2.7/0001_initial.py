...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/opps/feedcrawler/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('feedcrawler_feedtype', (
         (
        ...
        db.send_create_signal('feedcrawler', ['FeedType'])
        db.create_table('feedcrawler_group', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250))))
        db.send_create_signal('feedcrawler', ['Group'])
        db.create_table('feedcrawler_feed', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
        ...
        db.send_create_signal('feedcrawler', ['Feed'])
        db.create_table('feedcrawler_entry', (
         (
          'container_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['containers.Container'], unique=True, primary_key=True)),
         (
        ...
        db.send_create_signal('feedcrawler', ['Entry'])
        db.create_table('feedcrawler_processlog', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
        ...
        db.send_create_signal('feedcrawler', ['ProcessLog'])

    def backwards(self, orm):
        db.delete_table('feedcrawler_feedtype')
        db.delete_table('feedcrawler_group')
        db.delete_table('feedcrawler_feed')
        db.delete_table('feedcrawler_entry')
        db.delete_table('feedcrawler_processlog')
    ...
    models = {'%s.%s' % (User._meta.app_label, User._meta.module_name): {'Meta': {'object_name': User.__name__}}, 'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'containers.container': {'Meta': {'ordering': "['-date_available']", 'unique_together': "(('site', 'child_class', 'channel_long_slug', 'slug'),)", 'object_name': 'Container'}, 'channel': (
