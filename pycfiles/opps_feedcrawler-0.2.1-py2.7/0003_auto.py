...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/opps/feedcrawler/migrations/0003_auto.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        m2m_table_name = db.shorten_name('feedcrawler_feed_mirror_site')
        db.create_table(m2m_table_name, (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'feed', models.ForeignKey(orm['feedcrawler.feed'], null=False)),
         (
          'site', models.ForeignKey(orm['sites.site'], null=False))))
        db.create_unique(m2m_table_name, ['feed_id', 'site_id'])

    def backwards(self, orm):
        db.delete_table(db.shorten_name('feedcrawler_feed_mirror_site'))
