...
class TaskException(Exception):
    __doc__ = 'Base task exception.'


class TaskError(TaskException):
    __doc__ = 'Base task error exception.'


class TimeoutError(TaskError):
    __doc__ = 'Raised when the task timed out.'


class AlreadyRunningError(TaskError):
    __doc__ = 'Raised when trying to resume an already running task.'


class TaskMsgTreeError(TaskError):
    __doc__ = 'Raised when trying to access disabled MsgTree.'
...
class Task(object):
    ...
    class _SuspendCondition(object):
        __doc__ = 'Special class to manage task suspend condition.'
