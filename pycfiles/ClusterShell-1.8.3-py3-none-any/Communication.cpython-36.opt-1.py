...
class MessageProcessingError(Exception):
    __doc__ = 'base exception raised when an error occurs while processing incoming or\n    outgoing messages.\n    '


class XMLReader(ContentHandler):
    __doc__ = 'SAX handler for XML -> Messages instances conversion'
...
class ConfigurationMessage(Message):
    __doc__ = 'configuration propagation container'
    ident = 'CFG'
    has_payload = True
...
class RoutedMessageBase(Message):
    __doc__ = 'abstract class for routed message (with worker source id)'
...
class ACKMessage(Message):
    __doc__ = 'acknowledgement message'
    ident = 'ACK'
...
class StdOutMessage(RoutedMessageBase):
    __doc__ = 'container message for standard output'
    ident = 'OUT'
    has_payload = True
...
class StdErrMessage(StdOutMessage):
    __doc__ = 'container message for stderr output'
    ident = 'SER'


class RetcodeMessage(RoutedMessageBase):
    __doc__ = 'container message for return code'
    ident = 'RET'
...
class TimeoutMessage(RoutedMessageBase):
    __doc__ = 'container message for timeout notification'
    ident = 'TIM'
...
class StartMessage(Message):
    __doc__ = 'message indicating the start of a channel communication'
    ident = 'CHA'


class EndMessage(Message):
    __doc__ = 'end of channel message'
    ident = 'END'