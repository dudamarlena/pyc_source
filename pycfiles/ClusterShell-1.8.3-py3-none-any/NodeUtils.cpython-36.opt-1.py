...
class GroupSourceError(Exception):
    __doc__ = 'Base GroupSource error exception'
...
class FileGroupSource(GroupSource):
    __doc__ = 'File-based Group Source using loader for file format and cache expiry.'
