...
class WorkerException(Exception):
    __doc__ = 'Generic worker exception.'


class WorkerError(WorkerException):
    __doc__ = 'Generic worker error.'
