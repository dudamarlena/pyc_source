...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/Bep/tests/test_commands.py
# Compiled at: 2015-11-21 12:48:53
...
def test_local_repo():
    yield (
     check_local_repo, ('git clone https://github.com/{}').format(github_repo1), 'github_testrepo_local1', 'master')
...
def test_install_github_repo():
    yield (
     check_install_github_repo, github_repo1)
...
def test_install_bitbucket_hg_repo():
    yield (
     check_install_bitbucket_repo, bitbucket_repo_git, 'git')
