...
# Embedded file name: /Library/Python/2.7/site-packages/ctznosx/monitors.py
...
def install(args):
    ...
    if validate_repo(args[0]):
        ...
        shell_out(b'sudo chown -R _ctznosx %s' % MONITOR_PATH)
        if does_monitor_exist(args[0]):
...
def list(args):
    print b'The following ctznOSX monitors are installed:\n'
