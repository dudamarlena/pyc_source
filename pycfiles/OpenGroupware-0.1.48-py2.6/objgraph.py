...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/foundation/api/objgraph/objgraph.py
...
__version__ = '1.3.1'
__date__ = '2010-07-17'
import gc, inspect, types, weakref, operator
...
def draw_backrefs(handle, objs, max_depth=3, extra_ignore=(), filter=None, too_many=10, highlight=None, filename=None, extra_info=lambda _: ''):
    ...
    """
    draw_graph(handle, objs, max_depth=max_depth, extra_ignore=extra_ignore, filter=filter, too_many=too_many, highlight=highlight, edge_func=gc.get_referrers, swap_source_target=False, filename=filename, extra_info=extra_info)


def draw_refs(handle, objs, max_depth=3, extra_ignore=(), filter=None, too_many=10, highlight=None, filename=None, extra_info=lambda _: ''):
    ...
    """
    draw_graph(handle, objs, max_depth=max_depth, extra_ignore=extra_ignore, filter=filter, too_many=too_many, highlight=highlight, edge_func=gc.get_referents, swap_source_target=True, filename=filename, extra_info=extra_info)


def draw_graph(handle, objs, edge_func, swap_source_target, max_depth=3, extra_ignore=(), filter=None, too_many=10, highlight=None, filename=None, extra_info=lambda _: ''):
    ...
    while queue:
        ...
        (h, s, v) = gradient((0, 0, 1), (0, 0, 0.3), tdepth, max_depth)
