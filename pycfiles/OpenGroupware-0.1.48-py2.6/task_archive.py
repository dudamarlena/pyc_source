...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/workflow/actions/gw/task_archive.py
...
class ArchiveTaskAction(ActionCommand):
    ...
    def do_action(self):
        task = self._ctx.run_command('task::comment', values={'action': 'archive', 'comment': self._comment}, id=self._task_id)
