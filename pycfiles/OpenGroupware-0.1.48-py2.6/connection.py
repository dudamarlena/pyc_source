...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/foundation/api/amq/connection.py
...
__all__ = [
 'Connection']
LIBRARY_PROPERTIES = {'library': 'Python amqplib', 
...
class Connection(AbstractChannel):
    ...
    def __init__(self, host='localhost', userid='guest', password='guest', login_method='AMQPLAIN', login_response=None, virtual_host='/', locale='en_US', client_properties=None, ssl=False, insist=False, connect_timeout=None, **kwargs):
        """
    ...
    def _wait_method(self, channel_id, allowed_methods, timeout=None):
        ...
        for queued_method in method_queue:
            ...
            if allowed_methods is None or method_sig in allowed_methods or method_sig == (20,
                                                                                          40):
        ...
        while True:
            ...
            if channel == channel_id and (allowed_methods is None or method_sig in allowed_methods or method_sig == (20,
                                                                                                                     40)):
                pass
            else:
                return (
