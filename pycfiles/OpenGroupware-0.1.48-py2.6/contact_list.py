...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/workflow/actions/gw/contact_list.py
...
class ContactList(ActionCommand):
    ...
    def do_action(self):
        result = self._ctx.run_command('contact::list', contexts=[
         self._context_id], properties=[
         Contact], limit=self._limit)
