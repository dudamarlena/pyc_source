...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/workflow/actions/doc/django1778.py
...
"""
 ...
 Example: produce PDF document from text and output it as HTTPResponse object (Django)
    ...
    Code:
"""
import sys, os, string, time, getopt
LF_EXTRA = 0
LINE_END = '\r'
FF = chr(12)
...
class pyText2Pdf:
    ...
    def __init__(self, input_stream=None, output_stream=None, title='', font='/Courier', ptSize=10, tab=4, cols=80, do_ffs=0):
        self._version = '1.2.2'
        self._IsoEnc = 0
        self._doFFs = do_ffs
