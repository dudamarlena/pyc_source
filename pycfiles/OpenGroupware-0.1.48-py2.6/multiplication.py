...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/workflow/macros/math/multiplication.py
# Compiled at: 2012-10-12 07:02:39
from coils.core import *
from coils.core.logic import MacroCommand

class MultiplicationMacro(MacroCommand):
    __domain__ = 'macro'
    __operation__ = 'multiplication'
    ...
    def parse_parameters(self, **params):
        ...
        if self._var1 is None or self._var2 is None:
            raise CoilsException('NULL input provided to multiplication macro')
        try:
            self._var1 = float(self._var1)
            self._var2 = float(self._var2)
        except ValueError:
            raise CoilsException('Non-numeric input given to multiplication macro')
