...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/protocol/dav/workflow/formatobject.py
...
class FormatObject(DAVObject):
    ...
    def __init__(self, parent, name, **params):
        ...
        self.log.debug((' FormatObject named {0} is entity {1}').format(name, repr(self.entity)))
        self._yaml = None
        return
    ...
    def get_property_webdav_getetag(self):
        return ('{0}').format(self.entity.get_name())
