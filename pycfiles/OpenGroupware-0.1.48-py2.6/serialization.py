...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/foundation/api/amq/serialization.py
...
class GenericContent(object):
    ...
    def __getattr__(self, name):
        ...
        if 'delivery_info' in self.__dict__ and name in self.delivery_info:
