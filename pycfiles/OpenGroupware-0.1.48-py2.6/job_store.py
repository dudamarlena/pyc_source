...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/workflow/services/job_store.py
...
class CoilsAlchemyJobStore(SQLAlchemyJobStore):
    ...
    def __init__(self, url=None, engine=None, tablename='process_schedule', metadata=None, pickle_protocol=pickle.HIGHEST_PROTOCOL):
        self.jobs = []
