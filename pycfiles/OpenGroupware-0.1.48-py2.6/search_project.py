...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/project/search_project.py
...
class SearchProjects(SearchCommand):
    __domain__ = 'project'
    ...
    def run(self):
        self._query = self._parse_criteria(self._criteria, Project, COILS_PROJECT_KEYMAP)
