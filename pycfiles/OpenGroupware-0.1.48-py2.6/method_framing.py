...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/foundation/api/amq/method_framing.py
...
class MethodWriter(object):
    ...
    def write_method(self, channel, method_sig, args, content=None):
        ...
        if content:
            body = content.body
            payload = pack('>HHQ', method_sig[0], 0, len(body)) + content._serialize_properties()
