...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/foundation/get_union.py
# Compiled at: 2012-10-12 07:02:39
from sqlalchemy import *
from coils.core import *

class GetUnionOfEntities(Command):
    __domain__ = 'collection'
    __operation__ = 'get-union'
    mode = None
    ...
    def run(self):
        ...
        union_query = db.execute(union(*query_list)).fetchall()
        ids = []
        for id in union_query:
            ids.append(id[0])
