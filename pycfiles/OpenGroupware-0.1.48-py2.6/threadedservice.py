...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/core/threadedservice.py
...
class ThreadedService(object):
    ...
    def prepare(self):
        ...
        packet = Packet(('{0}/__hello_ack').format(self.__service__), 'coils.master/__hello', self.__service__)
