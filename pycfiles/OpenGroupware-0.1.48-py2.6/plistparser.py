...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/foundation/plist/plistparser.py
        ...
        while i < len(s) and s[i] != '"':
            if s[i] == '\\':
                ...
                if s[i] == 'n':
                    ...
                    stringbuffer.append('\x0c')
                    i += 1
                elif s[i] == 'b':
                    stringbuffer.append('\x08')
                    i += 1
                elif s[i] == 'a':
                    stringbuffer.append('\x07')
                    i += 1
                elif s[i] == 'v':
                    stringbuffer.append('\x0b')
                    i += 1
                elif s[i] == 'u' or s[i] == 'U':
                    if i + 4 >= len(s):
