...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/coils/logic/workflow/macros/math/round_.py
...
class RoundMacro(MacroCommand):
    ...
    @property
    def descriptor(self):
        return {'name': 'round', 'parameters': {'var1': {'type': 'numeric'}, 'precision': {'type': 'numeric'}}, 'help': 'Round given value to digits set by precision'}
