...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toml_ply.py
# Compiled at: 2013-02-28 23:06:38
from datetime import datetime
import ply.lex as lex, ply.yacc as yacc
tokens = ('KEY', 'KEYGROUP', 'EQUALS', 'BOOLEAN', 'DATETIME', 'STRING', 'FLOAT', 'INTEGER')
literals = '[,]'
t_ignore = ' \t'
