...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/generic/admin.py
# Compiled at: 2011-09-27 09:33:16
from django import forms
from django.contrib import admin
from django.contrib.auth.models import User
from django.conf import settings
from preferences.admin import PreferencesAdmin
from generic.models import ElementOption, ElementPreferences, Link, MenuLinkPosition, MenuPreferences, NavbarLinkPosition, NavbarPreferences, GeneralPreferences, GeneralPreferences, RegistrationPreferences, LoginPreferences
...
class LinkAdminForm(forms.ModelForm):
    view_name = forms.ChoiceField(label='View Name', help_text='View name to which this link will redirect. This takes precedence over url field below.', required=False)
...
class RegistrationPreferencesAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        choices = [ (f.name, f.name) for f in User._meta.fields if f.blank if f.name not in protected_fields ]
