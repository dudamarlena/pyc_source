...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/tests/fixtures.py
# Compiled at: 2020-05-11 13:53:29
# Size of source mod 2**32: 23015 bytes
...
API_ACCOUNT_LIST = [
 {'id':174, 
  ...
  'CreateDate':datetime(2012, 10, 24, 5, 0, tzinfo=tzoffset(None, 3600)), 
  'Fax':'555-555-6677', 
  'LastActivityDate':datetime(2012, 6, 18, 13, 15, 47, tzinfo=tzoffset(None, 3600)), 
...
API_ACCOUNT_PHYSICAL_LOCATION = {'id':55, 
 'Name':'Primary Location', 
 'AccountID':174, 
 'Active':True}
API_ACCOUNT_PHYSICAL_LOCATION_LIST = [
...
API_PROJECT_LIST = [
 {'id':4, 
  ...
  'Description':'', 
  'ContractID':29684183, 
  'CreateDateTime':datetime(2012, 6, 18, 5, 0, tzinfo=tzoffset(None, 3600)), 
  'CreatorResourceID':4, 
  'StartDateTime':datetime(2012, 6, 19, 5, 0, tzinfo=tzoffset(None, 3600)), 
  'EndDateTime':datetime(2012, 10, 24, 5, 0, tzinfo=tzoffset(None, 3600)), 
  'Duration':59, 
  'ActualHours':0.0, 
  ...
  'CompletedDateTime':datetime(2019, 9, 18, 5, 0, tzinfo=tzoffset(None, 3600)), 
  'StatusDetail':'', 
  'StatusDateTime':datetime(2012, 6, 18, 5, 0, tzinfo=tzoffset(None, 3600)), 
  'LineOfBusiness':6, 
  'PurchaseOrderNumber':'', 
  'BusinessDivisionSubdivisionID':6, 
  'LastActivityResourceID':4, 
  'LastActivityDateTime':datetime(2012, 6, 18, 1, 0, tzinfo=tzoffset(None, 3600)), 
...
API_SECONDARY_RESOURCE_LIST = [
 ...
 {'id':29684156, 
  ...
  'ResourceID':29683915, 
  'RoleID':29683395}]
API_RESOURCE = {'AccountingReferenceID':'', 
 'Active':True, 
...
API_TICKET = {'AccountID':29683561, 
 ...
 'CompletedDate':datetime(2019, 9, 5, 8, 23, tzinfo=tzoffset(None, 3600)), 
 'ContactID':29683586, 
 'ContractID':29684183, 
 'CreateDate':datetime(2019, 8, 18, 1, 0, tzinfo=tzoffset(None, 3600)), 
 'CreatorResourceID':4, 
 'CreatorType':1, 
 'Description':'Monthy Services Checkup', 
 'DueDateTime':datetime(2012, 9, 7, 1, 0, tzinfo=tzoffset(None, 3600)), 
 'EstimatedHours':2.0, 
 'ExternalID':'', 
 'FirstResponseDateTime':datetime(2012, 6, 18, 1, 0, tzinfo=tzoffset(None, 3600)), 
 'HoursToBeScheduled':0.0, 
 'IssueType':10, 
 'LastActivityDate':datetime(2019, 9, 23, 11, 0, tzinfo=tzoffset(None, 3600)), 
 'LastActivityPersonType':1, 
 'LastActivityResourceID':4, 
 'Priority':3, 
 'PurchaseOrderNumber':'', 
...
API_TASK = {'id':7733, 
 ...
 'CreateDateTime':datetime(2018, 1, 20, 11, 0, tzinfo=tzoffset(None, 3600)), 
 'CreatorResourceID':4, 
 ...
 'LastActivityDateTime':datetime(2019, 10, 6, 11, 0, tzinfo=tzoffset(None, 3600)), 
 'PhaseID':7732, 
 'Priority':0, 
 'PriorityLabel':1, 
 'ProjectID':4, 
...
API_TASK_LIST = [
 API_TASK]
API_TASK_SECONDARY_RESOURCE = {'id':29684411, 
 'UserDefinedFields':None, 
 'TaskID':7733, 
 'ResourceID':29683794, 
 'RoleID':29683461}
API_TASK_SECONDARY_RESOURCE_LIST = [
 API_TASK_SECONDARY_RESOURCE]
API_TICKET_NOTE = {'id':45, 
 'CreateDateTime':datetime(2018, 1, 23, 11, 0, tzinfo=tzoffset(None, 3600)), 
 'Description':'Note description', 
 'CreatorResourceID':29683794, 
 'LastActivityDate':datetime(2018, 1, 23, 11, 0, tzinfo=tzoffset(None, 3600)), 
 'NoteType':2, 
 'Publish':1, 
 'TicketID':7688, 
 'Title':'Note Title'}
API_TICKET_NOTE_LIST = [
 API_TICKET_NOTE]
API_TASK_NOTE = {'id':45, 
 'CreateDateTime':datetime(2018, 1, 23, 11, 0, tzinfo=tzoffset(None, 3600)), 
 'Description':'Note description', 
...
API_TIME_ENTRY_TICKET = {'id':4, 
 ...
 'RoleID':29683396, 
 'CreateDateTime':datetime(2018, 1, 23, 9, 50, tzinfo=tzoffset(None, 3600)), 
 'ResourceID':28, 
 'CreatorUserID':29683794, 
 'LastModifiedUserID':29683794, 
 'LastModifiedDateTime':datetime(2018, 1, 23, 13, 0, tzinfo=tzoffset(None, 3600)), 
 'AllocationCodeID':29683403, 
 'ContractID':29684054, 
 'ShowOnInvoice':True, 
 'NonBillable':False, 
 'BillingApprovalLevelMostRecent':0}
API_TIME_ENTRY_TASK = {'id':5, 
 'UserDefinedFields':None, 
 'TaskID':7734, 
 'InternalAllocationCodeID':29683403, 
 'Type':2, 
 ...
 'BillingApprovalLevelMostRecent':0}
API_TIME_ENTRY_LIST = [
 API_TIME_ENTRY_TICKET, API_TIME_ENTRY_TASK]
API_USE_TYPE_LIST = [
 {'Value':1, 
...
API_ALLOCATION_CODE_LIST = [
 API_ALLOCATION_CODE]
API_ROLE = {'id':29683396, 
...
API_ROLE_LIST = [
 API_ROLE]
API_DEPARTMENT = {'id':29683384, 
 'Name':'Finance', 
 'Description':'Finance Dept', 
 'Number':''}
API_DEPARTMENT_LIST = [
 API_DEPARTMENT]
API_RESOURCE_ROLE_DEPARTMENT = {'id':32, 
 'Default':True, 
 ...
 'RoleID':29683396, 
 'DepartmentLead':True}
API_RESOURCE_ROLE_DEPARTMENT_LIST = [
 API_RESOURCE_ROLE_DEPARTMENT]
API_RESOURCE_SERVICE_DESK_ROLE = {'id':32, 
 'Default':True, 
 'Active':True, 
 'ResourceID':29683794, 
 'RoleID':29683396}
API_RESOURCE_SERVICE_DESK_ROLE_LIST = [
 API_RESOURCE_SERVICE_DESK_ROLE]
API_CONTRACT = {'id':29684183, 
 'UserDefinedFields':'', 
 'AccountID':174, 
 'BillingPreference':2, 
 'Compliance':True, 
 ...
 'PurchaseOrderNumber':'', 
 'InternalCurrencySetupFee':995.0}
API_CONTRACT_LIST = [
 API_CONTRACT]
API_SERVICE_CALL = {'id':2, 
 'Description':'Email just in, printer is down.', 
 'Complete':False, 
 'Duration':1, 
 'CreateDateTime':datetime(2020,
   1, 22, 13, 0, tzinfo=tzoffset(None, 3600)), 
...
API_SERVICE_CALL_LIST = [
 API_SERVICE_CALL]
API_SERVICE_CALL_TICKET = {'id':4, 
 'ServiceCallID':2, 
 'TicketID':7688}
API_SERVICE_CALL_TICKET_LIST = [
 API_SERVICE_CALL_TICKET]
API_SERVICE_CALL_TASK = {'id':4, 
 'ServiceCallID':2, 
 'TaskID':7733}
API_SERVICE_CALL_TASK_LIST = [
 API_SERVICE_CALL_TASK]
API_SERVICE_CALL_TICKET_RESOURCE = {'id':4, 
 'ServiceCallTicketID':4, 
 'ResourceID':29683794}
API_SERVICE_CALL_TICKET_RESOURCE_LIST = [
 API_SERVICE_CALL_TICKET_RESOURCE]
API_SERVICE_CALL_TASK_RESOURCE = {'id':4, 
 'ServiceCallTaskID':4, 
 'ResourceID':29683794}
API_SERVICE_CALL_TASK_RESOURCE_LIST = [
