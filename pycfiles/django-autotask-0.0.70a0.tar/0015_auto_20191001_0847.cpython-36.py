...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/migrations/0015_auto_20191001_0847.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='DisplayColor',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name_plural': 'Display colors'}),
     migrations.AddField(model_name='ticketcategory',
       name='display_color',
