...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/models.py
# Compiled at: 2020-05-11 13:53:29
# Size of source mod 2**32: 25103 bytes
...
class Ticket(TimeStampedModel, ResourceAssignableModel):
    ...
    estimated_hours = models.DecimalField(blank=True,
      null=True,
      decimal_places=2,
      max_digits=6)
    ...
    priority = models.ForeignKey('Priority',
      blank=True, null=True, on_delete=(models.SET_NULL))
    assigned_resource = models.ForeignKey('Resource',
      blank=True, null=True, on_delete=(models.SET_NULL))
    secondary_resources = models.ManyToManyField('Resource',
      through='TicketSecondaryResource', related_name='secondary_resource_tickets')
    ...
    issue_type = models.ForeignKey('IssueType',
      blank=True, null=True, on_delete=(models.SET_NULL))
    sub_issue_type = models.ForeignKey('SubIssueType',
      blank=True, null=True, on_delete=(models.SET_NULL))
    type = models.ForeignKey('TicketType',
      blank=True, null=True, on_delete=(models.SET_NULL))
    assigned_resource_role = models.ForeignKey('Role',
      blank=True, null=True, on_delete=(models.SET_NULL))
    allocation_code = models.ForeignKey('AllocationCode',
...
class SubIssueType(Picklist):
    parent_value = models.ForeignKey('IssueType',
...
class Resource(TimeStampedModel):
    ...
    default_service_desk_role = models.ForeignKey('Role',
      null=True, blank=True, on_delete=(models.SET_NULL))
    objects = models.Manager()
...
class TicketCategory(TimeStampedModel):
    ...
    active = models.BooleanField(default=False)
    display_color = models.ForeignKey('DisplayColor',
      null=True, on_delete=(models.SET_NULL))
...
class TicketNote(TimeStampedModel, Note):
    ...
    note_type = models.ForeignKey('NoteType',
      blank=True, null=True, on_delete=(models.SET_NULL))
    creator_resource = models.ForeignKey('Resource',
      blank=True, null=True, on_delete=(models.SET_NULL))
...
class Project(TimeStampedModel):
    ...
    estimated_time = models.DecimalField(null=True,
      decimal_places=2,
      max_digits=9)
    last_activity_date_time = models.DateTimeField(null=True)
    project_lead_resource = models.ForeignKey('Resource',
      null=True, on_delete=(models.SET_NULL))
    account = models.ForeignKey('Account',
      null=True, on_delete=(models.SET_NULL))
...
class Phase(TimeStampedModel):
    ...
    last_activity_date = models.DateTimeField(blank=True, null=True)
    parent_phase = models.ForeignKey('self',
      null=True, on_delete=(models.SET_NULL))
    project = models.ForeignKey('Project',
      null=True, on_delete=(models.SET_NULL))
...
class Task(TimeStampedModel, ResourceAssignableModel):
    ...
    estimated_hours = models.DecimalField(blank=True,
      ...
      decimal_places=2,
      max_digits=6)
    remaining_hours = models.DecimalField(blank=True,
      null=True,
      decimal_places=2,
      max_digits=6)
    last_activity_date = models.DateTimeField(blank=True, null=True)
    assigned_resource = models.ForeignKey('Resource',
      null=True, on_delete=(models.SET_NULL))
    secondary_resources = models.ManyToManyField('Resource',
      through='TaskSecondaryResource', related_name='secondary_resource_tasks')
    project = models.ForeignKey('Project',
      null=True, on_delete=(models.SET_NULL))
    priority = models.ForeignKey('Priority',
      null=True, blank=True, on_delete=(models.SET_NULL))
...
class TimeEntry(TimeStampedModel):
    ...
    hours_worked = models.DecimalField(blank=True,
      null=True,
      decimal_places=4,
      max_digits=9)
    hours_to_bill = models.DecimalField(blank=True,
      null=True,
      decimal_places=4,
      max_digits=9)
    offset_hours = models.DecimalField(blank=True,
      null=True,
      decimal_places=4,
      max_digits=9)
    resource = models.ForeignKey('Resource',
    ...
    task = models.ForeignKey('Task',
      blank=True, null=True, on_delete=(models.CASCADE))
    type = models.ForeignKey('TaskTypeLink',
      blank=True, null=True, on_delete=(models.SET_NULL))
    allocation_code = models.ForeignKey('AllocationCode',
      blank=True, null=True, on_delete=(models.SET_NULL))
    role = models.ForeignKey('Role',
...
class AllocationCode(TimeStampedModel):
    ...
    active = models.BooleanField(default=False)
    use_type = models.ForeignKey('UseType',
      blank=True, null=True, on_delete=(models.SET_NULL))
...
class Role(models.Model):
    ...
    hourly_factor = models.DecimalField(blank=True,
      null=True,
      decimal_places=2,
      max_digits=9)
...
class ServiceCall(TimeStampedModel):
    ...
    account = models.ForeignKey('Account',
      on_delete=(models.CASCADE))
    status = models.ForeignKey('ServiceCallStatus',
      on_delete=(models.CASCADE))
    creator_resource = models.ForeignKey('Resource',
      blank=True,
      null=True,
    ...
    canceled_by_resource = models.ForeignKey('Resource',
      blank=True,
      null=True,
      on_delete=(models.SET_NULL),
      related_name='cancelled_service_calls')
    tickets = models.ManyToManyField('Ticket',
      through='ServiceCallTicket', related_name='ticket_service_calls')
    tasks = models.ManyToManyField('Task',
      through='ServiceCallTask', related_name='task_service_calls')
...
class ServiceCallTicket(TimeStampedModel):
    ...
    resources = models.ManyToManyField('Resource',
      through='ServiceCallTicketResource', related_name='resource_service_call_ticket')
...
class ServiceCallTask(TimeStampedModel):
    ...
    resources = models.ManyToManyField('Resource',
      through='ServiceCallTaskResource', related_name='resource_service_call_task')
...
class ServiceCallTicketResource(TimeStampedModel):
    service_call_ticket = models.ForeignKey('ServiceCallTicket',
      on_delete=(models.CASCADE))
...
class ServiceCallTaskResource(TimeStampedModel):
    service_call_task = models.ForeignKey('ServiceCallTask',
      on_delete=(models.CASCADE))
    resource = models.ForeignKey('Resource', on_delete=(models.CASCADE))
