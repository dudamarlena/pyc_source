...
# [GCC 8.4.0]
# Embedded file name: /home/cameron/Dev/kanban-dev/django-autotask/djautotask/tests/test_sync.py
...
class FilterProjectTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.complete_status = ProjectStatus.objects.create(label=(ProjectStatus.COMPLETE),
          is_active=True)
        cls.inactive_status = ProjectStatus.objects.create(label='New (Inactive)',
          is_active=False)
