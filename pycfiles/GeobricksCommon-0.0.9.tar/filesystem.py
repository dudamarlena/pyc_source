...
# [GCC 8.4.0]
# Embedded file name: /home/vortex/repos/geobricks/geobricks/server/geobricks_common/geobricks_common/core/filesystem.py
# Compiled at: 2015-06-04 04:13:35
import os, tempfile, uuid, zipfile, shutil, requests, json
...
def get_vector_by_datasource(metadata):
    ...
    if 'datasource' in metadata:
        ...
        if 'geoserver' in metadata['datasource']:
