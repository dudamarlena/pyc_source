...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/funkload/demo/cps/CPS340TestCase.py
...
class CPSTestCase(ZopeTestCase):
    ...
    def cpsLogin(self, login, password, comment=None):
        ...
        self.assert_([ link for link in self.listHref() if link.endswith('logout')
    ...
    def cpsCreateSite(self, admin_id, admin_pwd, manager_id, manager_password, manager_mail, langs=None, title=None, description=None, interface='portlets', zope_url=None, site_id=None, extensions=None):
        """Create a CPS Site.
        ...
        self.post('%s/manage_addProduct/CPSDefault/addConfiguredCPSSite' % zope_url, params, description='Create a CPS Site')
        self.clearBasicAuth()
        return
    ...
    def cpsCreateFolder(self, type, parent_url, title, description, lang):
        ...
        self.post('%s/cpsdocument_create' % parent_url, params, 'Create a %s' % type)
    ...
    def cpsCreateDocument(self, parent_url):
        ...
        params = [['type_name', 'Document'],
         ...
         [
          'cpsdocument_create_button', 'Create']]
        self.post('%s/cpsdocument_create' % parent_url, params, description='Creating a document')
    ...
    def cpsCreateNewsItem(self, parent_url, photo_path=None):
        ...
        params = [['cpsformuid', self._lipsum.getUniqWord()],
         ...
         [
          'cpsdocument_create_button', 'Create']]
        self.post('%s/cpsdocument_create' % parent_url, params, description='Creating a news item')
