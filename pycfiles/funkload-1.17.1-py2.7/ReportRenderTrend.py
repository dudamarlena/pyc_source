...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/funkload/ReportRenderTrend.py
...
class RenderTrend(RenderHtmlBase):
    ...
    def createRstFile(self):
        ...
        reports_rpath = [ getRPath(self.report_dir, os.path.join(report, 'index.html').replace('\\', '/')) for report in reports
                        ]
