...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/segmenttree/__init__.py
# Compiled at: 2016-01-11 06:17:24
        ...
        if start == in_start and end == in_end:
            ...
            if mid >= end:
                ...
                if mid + 1 <= start:
                    ...
                    ans = max(self._query_max(start, mid, in_start, mid), self._query_max(mid + 1, end, mid + 1, in_end))
        return ans
