...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\schedule_source.py
...
class ScheduleSource(object):
    ...
    def __init__(self):
        """ScheduleSource - a model defined in OpenAPI"""
...
(item[0], item[1].to_dict()) # Avoid dead code: item, value.items()))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleSource):
            return False
