...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\people_detail_event_with_snaps.py
# Compiled at: 2019-11-14 01:19:39
# Size of source mod 2**32: 8303 bytes
"""
    Engine api
...
class PeopleDetailEventWithSnaps(object):
    ...
    def __init__(self, id=None, event_details=None, event_snaps=None, meta_people_detail_event=None, updated=None, created=None, etag=None, links=None):
        """PeopleDetailEventWithSnaps - a model defined in OpenAPI"""
        self._id = None
