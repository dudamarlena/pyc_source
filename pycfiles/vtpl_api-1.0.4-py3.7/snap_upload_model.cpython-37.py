...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\snap_upload_model.py
...
class SnapUploadModel(object):
    ...
    openapi_types = {'portfolio_id':'str', 
     'full_name':'str', 
     'age':'int', 
     'sex':'Gender', 
     'type':'FaceCategory', 
     'snaps':'list[UploadSnap]'}
    attribute_map = {'portfolio_id':'portfolioId', 
     'full_name':'fullName', 
     'age':'age', 
     'sex':'sex', 
     'type':'type', 
    ...
    def __init__(self, portfolio_id=None, full_name=None, age=None, sex=None, type=None, snaps=None):
        """SnapUploadModel - a model defined in OpenAPI"""
