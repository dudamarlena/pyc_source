...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\clip.py
...
class Clip(object):
    ...
    def __init__(self, id=None, clip=None, clip_id=None, starp_time_stamp=None, end_time_stamp=None, updated=None, created=None, etag=None, links=None):
