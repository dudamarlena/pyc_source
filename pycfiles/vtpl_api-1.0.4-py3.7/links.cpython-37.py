...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\links.py
...
class Links(object):
    ...
    openapi_types = {'parent':'LinksSelfSelf', 
     '_self':'LinksSelfSelf', 
     'next':'LinksSelfSelf', 
     'last':'LinksSelfSelf', 
     'prev':'LinksSelfSelf', 
     'collection':'LinksSelfSelf'}
    attribute_map = {'parent':'parent', 
     '_self':'self', 
     'next':'next', 
     'last':'last', 
     'prev':'prev', 
    ...
    def __init__(self, parent=None, _self=None, next=None, last=None, prev=None, collection=None):
        """Links - a model defined in OpenAPI"""
        self._parent = None
        self._Links__self = None
        self._next = None
        self._last = None
        self._prev = None
