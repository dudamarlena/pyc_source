...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\links_self.py
...
class LinksSelf(object):
    ...
    @property
    def _self(self):
        """Gets the _self of this LinksSelf.  # noqa: E501

        :return: The _self of this LinksSelf.  # noqa: E501
        :rtype: LinksSelfSelf
        """
        return self._LinksSelf__self
...
(item[0], item[1].to_dict()) # Avoid dead code: item, value.items()))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinksSelf):
            return False
