...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\snap.py
...
class Snap(object):
    ...
    def __init__(self, id=None, snap=None, snap_id=None, snap_time_stamp=None, updated=None, created=None, etag=None, links=None):
        """Snap - a model defined in OpenAPI"""
        self._id = None
        self._snap = None
        self._snap_id = None
