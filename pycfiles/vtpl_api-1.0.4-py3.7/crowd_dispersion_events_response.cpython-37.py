...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\crowd_dispersion_events_response.py
...
class CrowdDispersionEventsResponse(object):
    ...
    openapi_types = {'items':'list[CrowdDispersionEvent]', 
     'links':'Links', 
     'meta':'Meta'}
    ...
    def __init__(self, items=None, links=None, meta=None):
        """CrowdDispersionEventsResponse - a model defined in OpenAPI"""
        self._items = None
        self._links = None
        self._meta = None
