...
class NoHelmetEvent(object):
    ...
    openapi_types = {'meta_no_helmet_event': 'MetaNoHelmetEvent'}
    attribute_map = {'meta_no_helmet_event': 'metaNoHelmetEvent'}

    def __init__(self, meta_no_helmet_event=None):
        """NoHelmetEvent - a model defined in OpenAPI"""
