...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\face_snap.py
...
class FaceSnap(object):
    ...
    def __init__(self, id=None, snap=None, snap_id=None, process_count=0, registered_face_id=None, feature_vector1=None, feature_vector2=None, confidence=0, updated=None, created=None, etag=None, links=None):
        """FaceSnap - a model defined in OpenAPI"""
        self._id = None
        self._snap = None
        self._snap_id = None
