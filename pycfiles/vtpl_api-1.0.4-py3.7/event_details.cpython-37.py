...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\event_details.py
...
class EventDetails(object):
    ...
    def __init__(self, source_id=None, engine_task_id=None, zone_id=0, confidence=0, start_time_stamp=None, end_time_stamp=None, extras=None):
