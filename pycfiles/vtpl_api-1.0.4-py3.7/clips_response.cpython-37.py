...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\clips_response.py
...
class ClipsResponse(object):
    ...
    def __init__(self, items=None, links=None, meta=None):
        """ClipsResponse - a model defined in OpenAPI"""
        self._items = None
        self._links = None
        self._meta = None
    ...
    @property
    def items(self):
        """Gets the items of this ClipsResponse.  # noqa: E501

        :return: The items of this ClipsResponse.  # noqa: E501
        :rtype: list[Clip]
        """
        return self._items
    ...
    @property
    def links(self):
        """Gets the links of this ClipsResponse.  # noqa: E501

        :return: The links of this ClipsResponse.  # noqa: E501
        :rtype: Links
        """
        return self._links
    ...
    @property
    def meta(self):
        """Gets the meta of this ClipsResponse.  # noqa: E501

        :return: The meta of this ClipsResponse.  # noqa: E501
        :rtype: Meta
        """
        return self._meta
...
(item[0], item[1].to_dict()) # Avoid dead code: item, value.items()))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClipsResponse):
            return False
