...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\zone.py
...
class Zone(object):
    ...
    openapi_types = {'zone_id':'int', 
     'zone_type':'ZoneType', 
     'number_of_vertices':'int', 
     'vertices':'list[Vertex]', 
     'line_setting':'Line', 
     'config':'list[Config]'}
    attribute_map = {'zone_id':'zoneId', 
     'zone_type':'zoneType', 
    ...
    def __init__(self, zone_id=0, zone_type=None, number_of_vertices=4, vertices=None, line_setting=None, config=None):
