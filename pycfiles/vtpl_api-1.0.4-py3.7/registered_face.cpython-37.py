...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\registered_face.py
# Compiled at: 2019-11-14 01:19:39
# Size of source mod 2**32: 9758 bytes
"""
    Engine api
...
class RegisteredFace(object):
    ...
    def __init__(self, id=None, registered_face_id=None, full_name=None, face_snaps=None, age=None, sex=None, type=None, updated=None, created=None, etag=None, links=None):
        """RegisteredFace - a model defined in OpenAPI"""
        self._id = None
