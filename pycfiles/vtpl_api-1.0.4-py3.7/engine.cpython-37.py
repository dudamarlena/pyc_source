...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\engine.py
...
class Engine(object):
    ...
    def __init__(self, id=None, machine_id=None, capabilities=None, updated=None, created=None, etag=None, links=None):
