...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\meta_vehicle_congestion_event.py
...
class MetaVehicleCongestionEvent(object):
    ...
    openapi_types = {'no_of_vehicle': 'int'}
    attribute_map = {'no_of_vehicle': 'noOfVehicle'}

    def __init__(self, no_of_vehicle=0):
        """MetaVehicleCongestionEvent - a model defined in OpenAPI"""
