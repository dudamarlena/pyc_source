...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\evidence_config.py
...
class EvidenceConfig(object):
    ...
    openapi_types = {'source':'ScheduleSource', 
     'count':'int', 
     'pre_event_sec':'int', 
     'post_event_sec':'int'}
    ...
    def __init__(self, source=None, count=1, pre_event_sec=0, post_event_sec=0):
        """EvidenceConfig - a model defined in OpenAPI"""
        self._source = None
        self._count = None
