...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\engine_task.py
# Compiled at: 2019-11-14 01:19:39
# Size of source mod 2**32: 13297 bytes
"""
    Engine api
...
class EngineTask(object):
    ...
    def __init__(self, id=None, capbilities_type=None, event_type=None, engine_machine_id=None, is_expired=False, time_to_live=-1, source=None, destination=None, zone_setting=None, line_setting=None, config=None, updated=None, created=None, etag=None, links=None):
        """EngineTask - a model defined in OpenAPI"""
        self._id = None
