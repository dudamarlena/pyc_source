...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\crowd_abnormality_event.py
...
class CrowdAbnormalityEvent(object):
    __doc__ = 'NOTE: This class is auto generated by OpenAPI Generator.\n    Ref: https://openapi-generator.tech\n\n    Do not edit the class manually.\n    '
    openapi_types = {}
    attribute_map = {}

    def __init__(self):
        """CrowdAbnormalityEvent - a model defined in OpenAPI"""
...
(item[0], item[1].to_dict()) # Avoid dead code: item, value.items()))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CrowdAbnormalityEvent):
            return False
