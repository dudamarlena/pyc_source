...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\source_end_point_source_list.py
...
class SourceEndPointSourceList(object):
    ...
    def __init__(self, source_id=None, type=None, base_url=None, user=None, _pass=None):
        """SourceEndPointSourceList - a model defined in OpenAPI"""
        self._source_id = None
        self._type = None
        self._base_url = None
        self._user = None
        self._SourceEndPointSourceList__pass = None
    ...
    def _pass(self):
        ...
        :rtype: str
        """
        return self._SourceEndPointSourceList__pass
    ...
    def _pass(self, _pass):
        ...
        :type: str
        """
        self._SourceEndPointSourceList__pass = _pass
