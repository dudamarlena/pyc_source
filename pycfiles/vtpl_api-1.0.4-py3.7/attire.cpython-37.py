...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\attire.py
...
class Attire(object):
    ...
    PANTSHIRT = 'PantShirt'
    SARI = 'Sari'
    SALWARKAMEEZ = 'SalwarKameez'
    SHIRTLUNGI = 'ShirtLungi'
    ...
    def __init__(self):
        """Attire - a model defined in OpenAPI"""
...
(item[0], item[1].to_dict()) # Avoid dead code: item, value.items()))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Attire):
            return False
