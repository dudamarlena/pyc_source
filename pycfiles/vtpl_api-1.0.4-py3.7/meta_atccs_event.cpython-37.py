...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\meta_atccs_event.py
...
class MetaAtccsEvent(object):
    ...
    def __init__(self, vehicle_class=None, vehicle_count=0):
        """MetaAtccsEvent - a model defined in OpenAPI"""
