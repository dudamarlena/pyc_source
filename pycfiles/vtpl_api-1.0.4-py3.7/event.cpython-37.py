...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\event.py
...
class Event(object):
    ...
    attribute_map = {'id':'_id', 
     ...
     'etag':'etag', 
     'links':'links'}
    discriminator_value_class_map = {'vehicleCongestionEvent':'VehicleCongestionEvent', 
    ...
    def __init__(self, id=None, capbilities_type=None, event_type=None, event_details=None, event_snaps=None, event_clips=None, updated=None, created=None, etag=None, links=None):
