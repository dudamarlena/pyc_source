...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\vtpl_api\models\source_end_point.py
...
class SourceEndPoint(object):
    ...
    def __init__(self, source_list=None, start_time_stamp=None, end_time_stamp=None, snaps=None, clips=None, schedule=None):
        """SourceEndPoint - a model defined in OpenAPI"""
