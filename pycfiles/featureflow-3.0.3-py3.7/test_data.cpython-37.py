...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/featureflow/test_data.py
# Compiled at: 2019-03-01 22:03:23
# Size of source mod 2**32: 2610 bytes
import unittest2
from uuid import uuid4
from .data import InMemoryDatabase, UserSpecifiedIdProvider, FileSystemDatabase, StringDelimitedKeyBuilder
import shutil
...
class FileSystemDatabaseTests(unittest2.TestCase):
    ...
    def _make_db(self, createdirs):
        return FileSystemDatabase(path=(self._path),
