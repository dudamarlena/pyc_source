...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/featureflow/bytestream.py
# Compiled at: 2019-03-06 21:24:12
...
class ByteStream(Node):
    ...
    def _get_strategy(self, data):
        ...
        if isinstance(data, str):
            ...
            if is_url:
                return self._handle_simple_get
...
class ByteStreamFeature(Feature):
 ...
 extractor, needs=needs, 
         ...
         decoder=BytesWithTotalLengthDecoder(chunksize=(extractor_args['chunksize'])), 
