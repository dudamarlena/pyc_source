...
# Embedded file name: build\bdist.win32\egg\pyojo\js\dojo\_dom.py
# Compiled at: 2013-06-05 12:09:39
__doc__ = ' Document Object Model manipulation.  \n'
...
class html(Dojo):
    ...
    def set(node, cont, params=None):
        u""" Replace an element’s content.
...
class uacss(Dojo):
    u""" Adds browser “centric” CSS classes to a the document’s <html> tag.
    """
    require = [
     'dojo/uacss']
...
class domConstruct(Dojo):
    ...
    def place(node, refNode, pos='last'):
        u""" A DOM node placement utility function.
