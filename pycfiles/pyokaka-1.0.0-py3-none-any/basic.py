...
# Embedded file name: build\bdist.win32\egg\pyojo\js\dijit\basic.py
# Compiled at: 2013-06-07 05:40:45
__doc__ = ' Dojo Dijit widget collection.\n'
from . import Dijit
...
class Dialog(Dijit):
    ...
    """
    require = [
     'dojo/ready', 'dijit/Dialog']


class Tree(Dijit):
    require = [
     'dojo/ready', 'dijit/Tree']
