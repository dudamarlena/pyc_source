...
# Embedded file name: build\bdist.win32\egg\pyojo\js\dojo\mixins.py
# Compiled at: 2013-06-04 18:55:57
__doc__ = ' Common methods..  \n'
...
__NodeList_dom_events = {'onclick': 'The user clicked a node.', 
...
__NodeList_NodeList = {'andSelf': 'Adds the nodes from the previous NodeList to the current NodeList.', 
...
__NodeList_obj = {'animateProperty': 'nimate all elements of this NodeList across the properties specified.', 
...
__NodeList_query = {'appendTo': 'Appends nodes in this NodeList to the nodes matched by the query.', 
...
__NodeList_query_opt = {'next': 'Returns the next element for nodes in this dojo.NodeList.', 
...
__NodeList_content = {'after': 'Places the content after every node in the NodeList.', 
