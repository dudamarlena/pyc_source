...
# [GCC 8.4.0]
# Embedded file name: /root/project/datamaestro/test/test_download_handlers.py
# Compiled at: 2020-02-25 07:34:23
# Size of source mod 2**32: 1710 bytes
import builtins as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, unittest, contextlib, logging, tempfile
from pathlib import Path
import shutil, datamaestro.download.single as single
...
if __name__ == '__main__':
    ...
    with make_temporary() as (dir):
        ...
        context = Context(dir)
        unittest.main()
# global context ## Warning: Unused global