...
# Embedded file name: build/bdist.macosx-10.10-intel/egg/circonus/metric.py
# Compiled at: 2015-01-26 11:46:22
...
def get_datapoints(check_id, metrics, custom=None):
    ...
    datapoints = []
    for m in metrics:
        dp = {'alpha': m.get('alpha'), 'axis': 'l', 'check_id': check_id, 
