...
# Embedded file name: /home/ad254919/aiida_plugin/aiida-bigdft/aiida_bigdft/PyBigDFT/BigDFT/Calculators.py
...
class SystemCalculator(Runner):
    ...
    def __init__(self, omp=os.environ.get('OMP_NUM_THREADS', '1'), mpi_run=os.environ.get('BIGDFT_MPIRUN', ''), dry_run=False, skip=False, verbose=True):
        ...
        safe_print('Initialize a Calculator with OMP_NUM_THREADS=%s and command %s' % (
    ...
    def _get_debugfile_date(self):
        ...
        """
        from futile.Utils import file_time
        return file_time(os.path.join(self.run_dir, 'debug', 'bigdft-err-0.yaml'))
