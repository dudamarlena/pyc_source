...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/socialcommerce/apps/cms/plugins/link/migrations/0003_page_link.py
...
class Migration:
    ...
    models = {'cms.cmsplugin': {'_stub': True, 
       ...
       'link.link': {'Meta': {'_bases': ['cms.models.CMSPlugin']}, 'cmsplugin_ptr': (
                                     'models.OneToOneField', ['CMSPlugin'], {}), 
                     'name': (
                            'models.CharField', ['_("name")'], {'max_length': '40'}), 
                     'page_link': (
