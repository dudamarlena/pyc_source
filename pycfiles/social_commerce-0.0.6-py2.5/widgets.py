...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/socialcommerce/apps/cms/plugins/text/widgets.py
...
class WYMEditor(Textarea):
    ...
    class Media:
        js = [ join(CMS_MEDIA_URL, path) for path in ('wymeditor/jquery.wymeditor.js',
                                                      'wymeditor/plugins/resizable/jquery.wymeditor.resizable.js',
                                                      'javascript/wymeditor/plugins/wymeditor.placeholdereditor.js',
                                                      'javascript/jquery.ui.js',
                                                      'javascript/placeholder_editor_registry.js')
             ]
        css = {'all': [ join(CMS_MEDIA_URL, path) for path in ('css/jquery/cupertino/jquery-ui.css', )
                ]}
