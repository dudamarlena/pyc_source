...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/socialcommerce/apps/cms/plugin_pool.py
                ...
                if cms_settings.CMS_PLACEHOLDER_CONF:
                    if placeholder in cms_settings.CMS_PLACEHOLDER_CONF:
                        if 'plugins' in cms_settings.CMS_PLACEHOLDER_CONF[placeholder]:
                            if plugin.__name__ not in cms_settings.CMS_PLACEHOLDER_CONF[placeholder]['plugins']:
                                found = False
                elif found:
