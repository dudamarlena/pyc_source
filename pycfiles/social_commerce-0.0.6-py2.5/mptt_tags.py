...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/socialcommerce/apps/mptt/templatetags/mptt_tags.py
...
class DrilldownTreeForNodeNode(template.Node):
    ...
    def __init__(self, node, context_var, foreign_key=None, count_attr=None, cumulative=False):
