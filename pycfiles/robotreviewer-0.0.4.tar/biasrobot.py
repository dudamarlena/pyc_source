...
# [GCC 8.4.0]
# Embedded file name: robotreviewer/biasrobot.py
...
class BiasRobot:
    ...
    def __init__(self):
        ...
        self.vec = ModularVectorizer(norm=None, non_negative=True, binary=True, ngram_range=(1,
                                                                                             2), n_features=67108864)
        self.bias_domains = [
    ...
    def annotate(self, doc_text, top_k=3):
        ...
        for domain in self.bias_domains:
            ...
            marginalia.append({'type': 'Risk of Bias', 
               'title': domain, 
               'annotations': [ {'content': sent, 'uuid': str(uuid.uuid1())} for sent in high_prob_sents ], 'description': '**Overall risk of bias prediction**: ' + bias_class})
