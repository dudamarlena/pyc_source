...
# [GCC 8.4.0]
# Embedded file name: /Users/rick/workspace/dropbox/dropbox/rest.py
# Compiled at: 2013-09-20 14:25:25
"""
...
"""
import httplib, pkg_resources, re, socket, ssl, sys, urllib, urlparse
from . import util
try:
    import json
except ImportError:
...
class RESTClientObject(object):
    ...
    def POST(self, url, params=None, headers=None, raw_response=False):
        ...
        if params is None:
            params = {}
        return self.request('POST', url, post_params=params, headers=headers, raw_response=raw_response)
...
class ErrorResponse(Exception):
    ...
    def __str__(self):
        if self.user_error_msg and self.user_error_msg != self.error_msg:
            ...
            msg = 'Error parsing response body or headers: ' + 'Body - %s Headers - %s' % (self.body, self.headers)
