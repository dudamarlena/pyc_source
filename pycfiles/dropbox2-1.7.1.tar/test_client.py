...
# [GCC 8.4.0]
# Embedded file name: /Users/rick/workspace/dropbox/tests/test_client.py
# Compiled at: 2013-07-08 01:43:34
from __future__ import with_statement
from StringIO import StringIO
import unittest, os, posixpath, sys
...
class BaseClientTests(object):
    ...
    def assert_file(self, dictionary, filename, *args, **kwargs):
        import os
        defaults = dict(bytes=os.path.getsize(filename), is_dir=False)
    ...
    def test_account_info(self):
        ...
        self.dict_has(account_info, 'country', 'display_name', 'referral_link', 'quota_info', 'uid')
    ...
    def test_put_file_overwrite(self):
        ...
        self.dict_has(metadata, size='15 bytes', bytes=15, is_dir=False, path=path, mime_type='text/plain')
    ...
    def test_metadata_bad(self):
        ...
        self.assertRaises(ErrorResponse, lambda : self.client.metadata(posixpath.join(self.test_dir, 'foo_does_not_exist.txt')))
    ...
    def test_create_folder(self):
        ...
        self.dict_has(metadata, size='0 bytes', bytes=0, is_dir=True, path=path)
    ...
    def test_create_folder_dupe(self):
        ...
        metadata = self.client.file_create_folder(path)
        self.assertRaises(ErrorResponse, lambda : self.client.file_create_folder(path))
    ...
    def test_delete(self):
        ...
        metadata = self.client.metadata(path)
        self.assert_file(metadata, self.foo, path=path, bytes=0, size='0 bytes', is_deleted=True)
    ...
    def test_stream(self):
        ...
        self.dict_has(link, 'url', 'expires')
    ...
    def test_copy_ref(self):
        ...
        self.dict_has(copy_ref, 'expires', 'copy_ref')
