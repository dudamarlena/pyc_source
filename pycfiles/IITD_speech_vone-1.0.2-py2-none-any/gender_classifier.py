...
# [GCC 8.4.0]
# Embedded file name: /Users/ravijayanth/Desktop/project/library/Gender/gender_classifier.py
# Compiled at: 2019-11-07 09:25:00
import numpy as np, csv, soundfile as sf
...
import matplotlib.pyplot as plt, seaborn as sn, pickle
...
def k_fold_validation_train_model(input_file, k=10):
    ...
    print (
     'F1_score', f1_score(test_true, test_predicted, average=None))
