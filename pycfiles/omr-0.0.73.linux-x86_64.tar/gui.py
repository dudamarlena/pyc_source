...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/omr/gui.py
# Compiled at: 2014-05-04 13:55:43
...
CMD = [
 'python', resource_filename(__name__, 'omrcmd.py')]
...
class Gui(Tkinter.Frame):
    ...
    def __init__(self, master):
        ...
        self.prechecks = OrderedDict({'self.cmd': 'No command line application.\n', 
