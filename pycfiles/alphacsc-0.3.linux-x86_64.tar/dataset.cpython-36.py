...
# [GCC 8.4.0]
# Embedded file name: /home/tom/.local/miniconda/lib/python3.6/site-packages/alphacsc/other/sdtw/dataset.py
...
def load_ucr(name):
    ...
    try:
        ...
        raise IOError('Please copy UCR_TS_Archive_2015/ to $HOME/sdtw_data/. Download from www.cs.ucr.edu/~eamonn/time_series_data.')
