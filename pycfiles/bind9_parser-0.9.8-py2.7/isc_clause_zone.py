...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bind9_parser/isc_clause_zone.py
# Compiled at: 2019-11-23 13:39:21
"""
...
zone_all_stmts_set = zone_statements_set | optzone_statements_set | optviewzone_statements_set | optviewzoneserver_statements_set | viewzone_statements_set
zone_all_stmts_series = ZeroOrMore(zone_all_stmts_set)
clause_stmt_zone_standalone = (Keyword('zone').suppress() - Group(zone_name('zone_name') - Optional(rr_domain_name) - lbrack - zone_all_stmts_series('') + rbrack)('zone') + semicolon)('')
clause_stmt_zone_series = OneOrMore(Group(clause_stmt_zone_standalone)(''))('')('zones')