...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bind9_parser/isc_clause_view.py
# Compiled at: 2019-11-22 14:49:57
"""
...
view_all_statements_set = view_statements_set | optview_statements_set | optviewserver_statements_set | optviewzone_statements_set | optviewzoneserver_statements_set | viewzone_statements_set | clause_stmt_zone_standalone | clause_stmt_trusted_keys_standalone | managed_keys_statement_standalone
view_all_statements_series = ZeroOrMore(view_all_statements_set)
clause_stmt_view_standalone = (Keyword('view').suppress() - Group(view_name('view_name') - Optional(rr_class_set('rr_class')) - Group(lbrack + view_all_statements_series + rbrack)('configs'))('') + semicolon)('view')
