...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/bind9_parser/isc_clause_options.py
# Compiled at: 2019-11-22 14:48:52
"""
...
class InvalidArgumentException(ParseFatalException):
    ...
    def __init__(self, s, loc, msg):
        ...
        super(InvalidArgumentException, self).__init__(s, loc, "invalid argument '%s'" % msg)


class InvalidFunctionException(ParseFatalException):

    def __init__(self, s, loc, msg):
        super(InvalidFunctionException, self).__init__(s, loc, "invalid function '%s'" % msg)
...
options_all_statements_set = options_statements_set | optview_statements_set | optviewserver_statements_set | optviewzone_statements_set | optviewzoneserver_statements_set | optzone_statements_set
options_all_statements_series = ZeroOrMore(options_all_statements_set)('')('')
clause_stmt_options = (Keyword('options').setParseAction(counter_options).suppress() - Group(lbrack - options_all_statements_series + rbrack)('') + semicolon)('options')
