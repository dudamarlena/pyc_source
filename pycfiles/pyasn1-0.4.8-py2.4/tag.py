...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1/type/tag.py
# Compiled at: 2019-10-17 01:00:19
from pyasn1 import error
__all__ = [
 'tagClassUniversal', 'tagClassApplication', 'tagClassContext', 'tagClassPrivate', 'tagFormatSimple', 'tagFormatConstructed', 'tagCategoryImplicit', 'tagCategoryExplicit', 'tagCategoryUntagged', 'Tag', 'TagSet']
tagClassUniversal = 0
...
class Tag(object):
    ...
    *Tag* objects are immutable and duck-type Python :class:`tuple` objects
    ...
    def __and__(self, otherTag):
        return self.__class__(self.__tagClass & otherTag.tagClass, self.__tagFormat & otherTag.tagFormat, self.__tagId & otherTag.tagId)
