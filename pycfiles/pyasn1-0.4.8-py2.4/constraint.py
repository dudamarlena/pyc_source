...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyasn1/type/constraint.py
# Compiled at: 2019-11-16 12:15:24
import sys
from pyasn1.type import error
__all__ = [
 'SingleValueConstraint', 'ContainedSubtypeConstraint', 'ValueRangeConstraint', 'ValueSizeConstraint', 'PermittedAlphabetConstraint', 'InnerTypeConstraint', 'ConstraintsExclusion', 'ConstraintsIntersection', 'ConstraintsUnion']
    ...
    def _setValues(self, values):
        ...
        for v in values:
            if isinstance(v, tuple):
                self.__multipleTypeConstraint[v[0]] = (
                 v[1], v[2])
            else:
