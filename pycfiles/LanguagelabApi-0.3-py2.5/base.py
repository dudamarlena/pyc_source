...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/llapi/base.py
# Compiled at: 2009-02-23 12:24:28
...
class PartnerClient(object):
    ...
    def create_user(self, first_name, last_name, dob, email, city, country, avatar_first_name, avatar_last_name_id=None, avatar_last_name=None, existing_avatar=False, password=None):
    ...
    def _post(self, controller, method, params=None):
        if not params:
            params = {}
        return self._api_request(Request(self._url_for(controller, method), urlencode(params)))
