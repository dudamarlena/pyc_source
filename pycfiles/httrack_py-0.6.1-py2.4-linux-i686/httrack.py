...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/httrack.py
# Compiled at: 2007-05-09 04:53:06
...
class Htcb:
    ...
    def __init__(self):
        self.urls = []
        try:
            self.error_policy = {'__default__': REGULAR_STOP, 'start': IMMEDIATE_STOP, 'end': IGNORE_EXCEPTION}
        except NameError:
            import httracklib
            self.error_policy = {'__default__': httracklib.REGULAR_STOP, 'start': httracklib.IMMEDIATE_STOP, 'end': httracklib.IGNORE_EXCEPTION}
