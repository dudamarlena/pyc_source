...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/torrenthelper/classify.py
# Compiled at: 2010-11-03 18:07:43
...
classifiers = [
 TVShowSeason.classify, TVShow.classify, MusicAlbum.classify, Movie.classify]
...
__all__ = [
 'classify', 'Movie', 'MusicAlbum', 'TVShow', 'TVShowSeason']