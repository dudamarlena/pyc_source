...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/django_s3_storage2/tests.py
...
class TestS3Storage(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.insecure_storage = S3Storage(aws_s3_key_prefix=cls.key_prefix, aws_s3_bucket_auth=False, aws_s3_max_age_seconds=31536000)
    ...
    def testIOErrorRaisedOnOpenMissingFile(self):
        ...
        self.assertEqual(force_text(cm.exception), 'File {name} does not exist'.format(name=upload_path))
    ...
    def testSize(self):
        ...
        self.assertLess(size, len(self.file_contents))
    ...
    def testStaticS3StorageDefaultsToLongMaxAge(self):
        self.assertEqual(self.static_storage.aws_s3_max_age_seconds, 31536000)