...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/django_s3_storage2/storage.py
# Compiled at: 2015-11-24 02:32:06
...
class S3Storage(Storage):
    ...
    def __init__(self, aws_region=None, aws_access_key_id=None, aws_secret_access_key=None, aws_s3_bucket_name=None, aws_s3_calling_format=None, aws_s3_key_prefix=None, aws_s3_bucket_auth=None, aws_s3_max_age_seconds=None, aws_s3_public_url=None, aws_s3_reduced_redundancy=False):
        ...
        connection_kwargs = {'calling_format': self.aws_s3_calling_format}
    ...
    def _get_cache_control(self):
        ...
        if self.aws_s3_bucket_auth:
            ...
            privacy = 'public'
        return '{privacy},max-age={max_age}'.format(privacy=privacy, max_age=self.aws_s3_max_age_seconds)
    ...
    def _temporary_file(self):
        ...
        """
        return SpooledTemporaryFile(max_size=10485760)
    ...
    def _generate_url(self, name):
        ...
        """
        return self.s3_connection.generate_url(method='GET', bucket=self.aws_s3_bucket_name, key=self._get_key_name(name), expires_in=self.aws_s3_max_age_seconds, query_auth=self.aws_s3_bucket_auth)
    ...
    def _save(self, name, content):
        with self._process_file_for_upload(name, content) as (content, content_type, content_encoding):
            ...
            self._get_key(name).set_contents_from_file(content, policy=self._get_canned_acl(), headers=headers, reduced_redundancy=self.aws_s3_reduced_redundancy)
            return name
