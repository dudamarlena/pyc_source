...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dottedish/dotteddict.py
# Compiled at: 2009-06-20 10:02:52
...
class DottedDict(object):
    ...
    def iteritems(self):
        return ((str(key), api.wrap(value)) for (key, value) in self._o.iteritems())
