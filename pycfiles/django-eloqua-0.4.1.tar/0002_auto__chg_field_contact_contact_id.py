...
# [GCC 8.4.0]
# Embedded file name: /Users/svdgraaf/Projects/nl.focusmedia/lib/python2.7/site-packages/eloqua/migrations/0002_auto__chg_field_contact_contact_id.py
# Compiled at: 2013-02-25 04:18:49
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('eloqua_contact', 'contact_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Contact.contact_id' and its values cannot be restored.")
