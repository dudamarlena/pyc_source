...
# [GCC 8.4.0]
# Embedded file name: /Users/svdgraaf/Projects/nl.focusmedia/lib/python2.7/site-packages/eloqua/migrations/0001_initial.py
# Compiled at: 2013-02-25 04:14:29
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('eloqua_contact', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='eloqua_profile', unique=True, to=orm['auth.User'])),
         (
          'contact_id', self.gf('django.db.models.fields.PositiveIntegerField')())))
        db.send_create_signal('eloqua', ['Contact'])

    def backwards(self, orm):
        db.delete_table('eloqua_contact')
