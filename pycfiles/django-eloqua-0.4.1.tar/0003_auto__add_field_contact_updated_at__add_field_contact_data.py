...
# [GCC 8.4.0]
# Embedded file name: /Users/svdgraaf/Projects/nl.focusmedia/lib/python2.7/site-packages/eloqua/migrations/0003_auto__add_field_contact_updated_at__add_field_contact_data.py
# Compiled at: 2013-02-25 05:21:56
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('eloqua_contact', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 25, 11, 21, 56, 949265), blank=True), keep_default=False)
        db.add_column('eloqua_contact', 'data', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('eloqua_contact', 'updated_at')
        db.delete_column('eloqua_contact', 'data')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'eloqua.contact': {'Meta': {'object_name': 'Contact'}, 'contact_id': (
                          ...
                          'user': (
                                 'django.db.models.fields.related.OneToOneField', [], {'related_name': "'eloqua_profile'", 'unique': 'True', 'to': "orm['auth.User']"})}}
    complete_apps = [
     'eloqua']