...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/pyramid_xslt/__init__.py
# Compiled at: 2013-07-15 03:13:21
import os.path
...
class XsltRendererFactory(object):
    ...
    def __call__(self, value, system):
        ...
        try:
            ...
            xsl = XslRenderer(os.path.join(package_path(self._info.package), system['renderer_name']))
...
class XslRenderer(object):
    ...
    def _mkdoc(value):
        ...
        if isinstance(value, etree._Element):
            ...
            if value.startswith('http') or os.path.isfile(value):
