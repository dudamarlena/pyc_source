...
# [GCC 8.4.0]
# Embedded file name: /home/plusshaun/Projects/proxytest/parts/panya/panya/view_modifiers/items.py
...
class ThisMonthItem(GetItem):
    ...
    def modify(self, view):
        view.params['queryset'] = view.params['queryset'].filter(**{'%s__year' % self.field_name: datetime.today().year, 
...
class ThisWeekItem(GetItem):
    ...
    def modify(self, view):
        view.params['queryset'] = view.params['queryset'].filter(**{'%s__gte' % self.field_name: (datetime.today() - timedelta(days=7)).strftime('%Y-%m-%d'), 
