...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/APNSWrapper/notifications.py
# Compiled at: 2010-04-24 05:11:57
...
class APNSNotificationWrapper(object):
    ...
    def __init__(self, certificate=None, sandbox=True, debug_ssl=False, force_ssl_command=False):
        self.debug_ssl = debug_ssl
        self.force_ssl_command = False
        self.connection = APNSConnection(certificate=certificate, force_ssl_command=self.force_ssl_command, debug=self.debug_ssl)
...
class APNSNotification(object):
    ...
    def payload(self):
        ...
        return struct.pack(apnsPackFormat, self.command, tokenLength, self.deviceToken, payloadLength, payload)