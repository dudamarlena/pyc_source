...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/powerline/database.py
# Compiled at: 2008-04-11 18:22:36
import dbwrap
from os import path
...
class hours_model(object):
    ...
    def update(self, new_hours):
        ...
        assert len(new_hours) == 7 and all((type(hours[0]) == type(hours[1]) == datetime.time for hours in new_hours if len(hours) == 2))
