...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/powerline/tools/client.py
# Compiled at: 2008-04-11 15:13:57
import pygtk
pygtk.require('2.0')
import gtk, gobject, pango, xmlrpclib, sys, time
...
class client_widget(gtk.VBox, client):
    ...
    def __init__(self, system_id):
        ...
        status_attrs.insert(pango.AttrSize(12000, 0, 1000))
        ...
        try:
            ...
            while True:
                try:
                    ...
                    if result['status_code'] != 'TIMEUNCHANGED':
                        print 'Session status: ', result['status_message']
