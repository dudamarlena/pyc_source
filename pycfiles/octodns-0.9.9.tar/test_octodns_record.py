...
# Compiled at: 2019-11-04 17:54:07
...
class TestDynamicRecords(TestCase):
    ...
    def test_dynamic_validation(self):
        ...
        with self.assertRaises(ValidationError) as (ctx):
            Record.new(self.zone, b'bad', a_data)
        self.assertEquals([b'missing rules'], ctx.exception.reasons)
        a_data = {b'dynamic': {b'pools': {b'one': {b'values': [
                                                      {b'value': b'3.3.3.3'}]}, 
                                   b'two': {b'values': [
                                                      {b'value': b'4.4.4.4'},
        ...
        with self.assertRaises(ValidationError) as (ctx):
            Record.new(self.zone, b'bad', a_data)
        self.assertEquals([b'rules must be a list'], ctx.exception.reasons)
        a_data = {b'dynamic': {b'pools': {b'one': {b'values': [
                                                      {b'value': b'3.3.3.3'}]}, 
                                   b'two': {b'values': [
                                                      {b'value': b'4.4.4.4'},
        ...
        with self.assertRaises(ValidationError) as (ctx):
            Record.new(self.zone, b'bad', a_data)
        self.assertEquals([b'rule 1 missing pool'], ctx.exception.reasons)
        a_data = {b'dynamic': {b'pools': {b'one': {b'values': [
                                                      {b'value': b'3.3.3.3'}]}, 
                                   b'two': {b'values': [
                                                      {b'value': b'4.4.4.4'},
        ...
        with self.assertRaises(ValidationError) as (ctx):
            Record.new(self.zone, b'bad', a_data)
        self.assertEquals([b'rule 1 invalid pool "[]"'], ctx.exception.reasons)
        a_data = {b'dynamic': {b'pools': {b'one': {b'values': [
                                                      {b'value': b'3.3.3.3'}]}, 
                                   b'two': {b'values': [
                                                      {b'value': b'4.4.4.4'},
        ...
        with self.assertRaises(ValidationError) as (ctx):
            Record.new(self.zone, b'bad', a_data)
        self.assertEquals([b'rule 1 undefined pool "non-existent"'], ctx.exception.reasons)
        a_data = {b'dynamic': {b'pools': {b'one': {b'values': [
                                                      {b'value': b'3.3.3.3'}]}, 
                                   b'two': {b'values': [
                                                      {b'value': b'4.4.4.4'},
