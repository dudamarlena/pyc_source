...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\pysfm\pysfm_module.py
# Compiled at: 2018-03-19 19:49:30
from core import *
from api import *
import serial, time, inspect, platform
...
class ModuleBase():
    ...
    def __init__(self, port=None, baudrate=115200, protocol=UF_PROTOCOL.UF_SINGLE_PROTOCOL, ascii_mode=False, module_id=1):
        ...
        self.hcomm = None
        self.generic_command_timeout = 10.0
    ...
    def system_status_check(self):
        ...
        while cnt < 10:
            ...
            received_packet = self.read_response_command(1)
            if self.response_command.error is UF_PROTO_RET_SUCCESS:
                break
            cnt += 1
    ...
    def send_end_packet(self, timeout=0):
        return self.send_packet(chr(10))
    ...
    def scan_image(self, image):
        ...
        image[0] = received_data
        return True

    def uf_scan_image(self, image):
        return self.scan_image(image)

    def uf_enroll(self, userID=0, option=121):
        enrollID = 0
        imageQuality = 0
        ...
        if enrollMode == 65:
            ...
            if ret != UF_PROTO_RET_SUCCESS:
                print 'ERROR'
            return (
             UF_RET_SUCCESS, enrollID, imageQuality)

    def uf_identify(self):
