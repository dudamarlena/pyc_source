...
# Embedded file name: build\bdist.win-amd64\egg\arcadeplus\examples\tetris.py
# Compiled at: 2020-03-29 18:11:09
...
def remove_row(board, row):
    ...
    del board[row]
    return [
     [0 for _ in range(COLUMN_COUNT)]] + board
