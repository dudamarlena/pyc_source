...
# [GCC 8.4.0]
# Embedded file name: C:\Users\shu\PycharmProjects\py34\cazipcode-project\cazipcode\pkg\fuzzywuzzy\StringMatcher.py
...
class StringMatcher:
    __doc__ = 'A SequenceMatcher-like class built on the top of Levenshtein'
