...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tgopenidlogin/controllers.py
# Compiled at: 2007-03-26 09:54:21
...
class OpenIDLoginController(controllers.Controller):
    ...
    def login(self, forward_url=None, msg=None, identity_url=None, *args, **kw):
        ...
        return dict(message=msg, logging_in=True, original_parameters=parameters, forward_url=forward_url, openid_path=self.openid_path)
