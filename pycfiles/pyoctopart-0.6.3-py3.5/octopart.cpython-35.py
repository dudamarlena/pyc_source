...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyoctopart/octopart.py
# Compiled at: 2016-03-05 13:07:37
# Size of source mod 2**32: 34342 bytes
"""
...
"""
import copy, json, requests, datetime, pkg_resources
...
class OctopartBrand(object):
    ...
    def __hash__(self):
        return (
         hash(self.__class__), hash(self.id))
...
class OctopartCategory(object):
    ...
    def new_from_dict(cls, category_dict):
        ...
        new = cls(new_dict['id'], new_dict['parent_id'], new_dict['nodename'], new_dict['images'], new_dict['children_ids'], new_dict['ancestor_ids'], new_dict.get('ancestors', []), new_dict['num_parts'])
        return new
...
class OctopartPart(object):
    ...
    @classmethod
    def includes(cls, include_short_description: bool=False,
    ...
    @classmethod
    def shows(cls, show_uid: bool=False,
              show_mpn: bool=False,
    ...
    @classmethod
    def hides(cls, hide_uid: bool=False,
              hide_mpn: bool=False,
    ...
    def equals_json(self, resource, hide_datasheets=False, hide_descriptions=False, hide_images=False, hide_offers=False, hide_unauthorized_offers=False, hide_specs=False):
        ...
        def compare_offers(class_offer, json_offer):
            ...
            """
            class_attribs = (
             class_offer['sku'], class_offer['avail'], class_offer['prices'],
    ...
    def __hash__(self):
        return (
         hash(self.__class__), hash(self.uid), hash(self.mpn))
...
class OctopartPartAttribute(object):
    ...
    def __hash__(self):
        return (
         hash(self.__class__), hash(self.fieldname))
...
class Octopart(object):
    ...
    def parts_match(self, queries: list, exact_only: bool=False, **show_hide):
        method = 'parts/match'
    ...
    def parts_suggest_v2(self, q: str, limit: int=25,
                         start: int=0):
    ...
    def bom_match(self, lines: list, optimize_return_stubs: bool=False, optimize_hide_datasheets: bool=False,
        ...
        def check_line(q: str, mpn: str=None,
