...
# [GCC 8.4.0]
# Embedded file name: /home/www.django/erp.juanmitaboada.com/codenerix_payments/migrations/0001_initial.py
# Compiled at: 2018-05-26 09:28:49
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Currency', fields=[
      ...
      (
       'price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Price'))], options={'abstract': False, 
     ...
     migrations.CreateModel(name='PaymentAnswer', fields=[
      ...
      (
       'answer_date', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='Answer date'))], options={'abstract': False, 
      'default_permissions': ('add', 'change', 'delete', 'view', 'list')}),
     migrations.CreateModel(name='PaymentConfirmation', fields=[
      ...
      (
       'error', models.BooleanField(default=False, verbose_name='Error')),
      (
       'error_txt', models.TextField(blank=True, null=True, verbose_name='Error Text'))], options={'abstract': False, 
      'default_permissions': ('add', 'change', 'delete', 'view', 'list')}),
     migrations.CreateModel(name='PaymentRequest', fields=[
      ...
      (
       'currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='codenerix_payments.Currency'))], options={'abstract': False, 
      'default_permissions': ('add', 'change', 'delete', 'view', 'list')}),
