...
# [GCC 8.4.0]
# Embedded file name: /Users/jacob/Projects/cloudservers/tests/test_servers.py
# Compiled at: 2010-08-16 13:12:21
import StringIO
...
def test_create_server():
    s = cs.servers.create(name='My server', image=1, flavor=1, meta={'foo': 'bar'}, ipgroup=1, files={'/etc/passwd': 'some data', 
       '/tmp/foo.txt': StringIO.StringIO('data')})
