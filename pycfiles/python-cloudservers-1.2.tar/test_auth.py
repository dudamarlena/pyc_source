...
# [GCC 8.4.0]
# Embedded file name: /Users/jacob/Projects/cloudservers/tests/test_auth.py
# Compiled at: 2010-08-16 13:17:07
import mock, cloudservers, httplib2
from nose.tools import assert_raises, assert_equal

def test_authenticate_success():
    cs = cloudservers.CloudServers('username', 'apikey')
    auth_response = httplib2.Response({'status': 204, 
    ...
    def test_auth_call():
        ...
        mock_request.assert_called_with(cs.client.AUTH_URL, 'GET', headers={'X-Auth-User': 'username', 
           'X-Auth-Key': 'apikey', 
