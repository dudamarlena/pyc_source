...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mote/templatetags/mote_tags.py
...
class GetElementDataNode(template.Node):
    ...
    def render(self, context):
        ...
        di = xmltodict.parse(render_to_string(template_name, context=context.flatten(), request=request))
