...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyams_batching/tests/test_utilsdocstrings.py
# Compiled at: 2019-12-05 08:43:35
# Size of source mod 2**32: 1867 bytes
"""
Generic test case for pyams_batching docstrings
"""
__docformat__ = 'restructuredtext'
import doctest, os, unittest
from pyams_batching.tests import get_package_dir
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        if '>>> ' not in content:
            ...
            location = 'pyams_batching.%s' % test
