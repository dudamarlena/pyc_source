...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tcpwave_client/networks.py
# Compiled at: 2020-04-14 09:18:26
# Size of source mod 2**32: 16390 bytes
...
class NetworkManager(object):
    ...
    def create_network(cls, network):
        ...
        payload = {'body':{'address':network_ip, 
          'addr1':str(ips[0]), 
          'addr2':str(ips[1]), 
          'addr3':str(ips[2]), 
          'addr4':str(ips[3]), 
    ...
    def get_network_detail(cls, network):
        ...
        payload = {'method':'GET', 
         ...
         'headers':{'Content-Type':'text/plain', 
          'Accept-Type':'application/json'}, 
         'params':{'organizationName':network_obj['organization_name'], 
          'addr1':ip_bits[0], 
          'addr2':ip_bits[1], 
          'addr3':ip_bits[2], 
          'addr4':ip_bits[3], 
    ...
    def delete_network(cls, network):
        ...
        cert = network_obj['provider']['cert']
        key = network_obj['provider']['key']
        payload = {'body':{'address':str(address), 
    ...
    def create_subnet(cls, subnet):
        ...
        network_ip = str(network_address.network_address)
        ips = network_ip.split('.')
        payload = {'body':{'network_address':network_ip, 
          'addr1':str(ips[0]), 
          'addr2':str(ips[1]), 
          'addr3':str(ips[2]), 
          'addr4':str(ips[3]), 
    ...
    def get_subnet_detail(cls, subnet):
        ...
        payload = {'method':'GET', 
         ...
         'headers':{'Content-Type':'text/plain', 
          'Accept-Type':'application/json'}, 
         'params':{'subnet_address':str(subnet_address.network_address), 
    ...
    def list_all_subnets(cls, subnet):
        ...
        payload = {'method':'GET', 
         ...
         'headers':{'Content-Type':'text/plain', 
          'Accept-Type':'application/json'}, 
         'params':{'network_address':str(network_address.network_address), 
          'org_name':subnet_obj['organization_name'], 
          'start':0, 
          'length':page_size, 
          'sort':'fullAddress', 
    ...
    def delete_subnet(cls, subnet):
        ...
        cert = subnet_obj['provider']['cert']
        key = subnet_obj['provider']['key']
        payload = {'body':{'addressList':address_list, 
    ...
    def get_next_available_ip(cls, subnet):
        ...
        payload = {'method':'GET', 
         ...
         'headers':{'Content-Type':'text/plain', 
          'Accept-Type':'application/json'}, 
         'params':{'org_name':subnet_obj['organization_name'], 
    ...
    def release_ip(cls, ip_payload):
        ...
        payload = {'method':'POST', 
         ...
         'headers':{'Content-Type':'application/json', 
          'Accept-Type':'application/json'}, 
         'body':{'organization_name':ip_obj['organization_name'], 
