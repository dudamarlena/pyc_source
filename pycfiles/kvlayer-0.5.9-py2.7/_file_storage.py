...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kvlayer/_file_storage.py
...
import os, shutil, shelve, logging, cPickle
    ...
    def __init__(self, *args, **kwargs):
        ...
        if filename in self._datas:
            ...
            if os.path.exists(filename) and os.path.getsize(filename) == 0:
                os.remove(filename)
            self._data = shelve.open(filename, protocol=cPickle.HIGHEST_PROTOCOL, writeback=True)
