...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kvlayer/__init__.py
# Compiled at: 2015-07-31 13:31:44
r"""Database abstraction for key/value stores.
...
from kvlayer.config import config_name, default_config, add_arguments, runtime_keys, discover_config, check_config
