...
class IBANTestCase(TestCase):
    ...
    invalid = {'GB82WEST1234569876543': ['This IBAN does not match the requirements for GB.'], 
     'CA34CIBC123425345': ['CA IBANs are not allowed in this field.'], 
     'GB29ÉWBK60161331926819': ['This IBAN does not start with a country code and checksum, or contains invalid characters.'], 
    ...
    include_countries_invalid = {'GB82WEST12345698765432': ['GB IBANs are not allowed in this field.']}
...
class BICTestCase(TestCase):
    ...
    invalid = {'NEDSZAJJXX': ['This Bank Identifier Code (BIC) is invalid.'], 
