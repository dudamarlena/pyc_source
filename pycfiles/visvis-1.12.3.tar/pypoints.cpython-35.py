...
# [GCC 8.4.0]
# Embedded file name: d:\dev\pylib\visvis\utils\pypoints.py
# Compiled at: 2016-03-22 04:56:47
# Size of source mod 2**32: 58156 bytes
""" Module pypoints
...
class Pointset(BasePoints):
    ...
    def __init__(self, ndim):
        ...
        data = ndim
        initialLength = 16
        if isinstance(data, np.ndarray) and data.size == 1 and len(data.shape) in (0,
                                                                                   1):
            data = ndim = int(data)
