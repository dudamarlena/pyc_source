...
# [GCC 8.4.0]
# Embedded file name: d:\dev\pylib\visvis\vvmovie\images2avi.py
...
def writeAvi(filename, images, duration=0.1, encoding='mpeg4', inputOptions='', outputOptions=''):
    ...
    command += 'output.avi'
    S = subprocess.Popen(command, shell=True, cwd=tempDir, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
