...
# [GCC 8.4.0]
# Embedded file name: c:\dev\pylib\visvis\utils\ssdf\classmanager.py
    ...
    def is_incompatible_class(manager, cls):
        ...
        if not hasattr(cls, '__to_ssdf__'):
            ...
            if not hasattr(cls, '__from_ssdf__'):
                ...
                return isinstance(cls, type) or 'class is not a type (does not inherit object on Python 2.x)'
