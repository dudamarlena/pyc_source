...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/core/image.py
# Compiled at: 2020-04-24 23:12:07
# Size of source mod 2**32: 13183 bytes
"""
Module that contains utility functions related with images
"""
from __future__ import print_function, division, absolute_import
import os, re, base64, logging, traceback
try:
...
ImageFormats = {QImage.Format_Mono: 'L', 
 QImage.Format_MonoLSB: 'L', 
 QImage.Format_Indexed8: 'P', 
 QImage.Format_RGB32: 'RGB', 
 QImage.Format_ARGB32: 'RGBA', 
 QImage.Format_ARGB32_Premultiplied: 'RGBA', 
 QImage.Format_RGB16: 'RGB', 
 QImage.Format_ARGB8565_Premultiplied: 'RGBA', 
 QImage.Format_RGB666: 'RGB', 
 QImage.Format_ARGB6666_Premultiplied: 'RGBA', 
 QImage.Format_RGB555: 'RGB', 
 QImage.Format_ARGB8555_Premultiplied: 'RGBA', 
 QImage.Format_RGB888: 'RGB', 
 QImage.Format_RGB444: 'RGB', 
 QImage.Format_ARGB4444_Premultiplied: 'RGB'}
...
def paint_background(image, background_color=None):
    ...
    if type(background_color) not in (list, tuple) or len(background_color) != 3:
        LOGGER.warning('background_color argument is not valid ({}) using black color instead!'.format(background_color))
    ...
    for i in range(len(background_color)):
        if background_color[i] < 0 or background_color[i] > 255:
            LOGGER.warning('Background color channel ({})({}) out of limit (0, 255). Fixing to fit range ...'.format(i, background_color[i]))
