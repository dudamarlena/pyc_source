...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/externals/pysideuic/icon_cache.py
# Compiled at: 2020-04-24 23:12:07
# Size of source mod 2**32: 4533 bytes
import os.path

class IconCache(object):
    __doc__ = 'Maintain a cache of icons.  If an icon is used more than once by a GUI\n    then ensure that only one copy is created.\n    '
...
class _IconSet(object):
    __doc__ = 'An icon set, ie. the mode and state and the pixmap used for each.'
