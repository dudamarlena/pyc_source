...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/group.py
...
class BaseButtonGroup(base.BaseWidget, object):
    ...
    def get_main_layout(self):
        main_layout = QBoxLayout(QBoxLayout.LeftToRight if self._orientation == 'horizontal' else QBoxLayout.TopToBottom)
    ...
    def create_button(self, data_dict):
        ...
        """
        raise NotImplementedError('Function create_button for class "{}" is not implemented!'.format(self.__class__.__name__))
