...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/treewidgets.py
# Compiled at: 2020-04-24 23:12:07
# Size of source mod 2**32: 42378 bytes
"""
        ...
        if item:
            ...
            if self._drop_indicator_position == self.AboveItem:
                ...
                if self._drop_indicator_position == self.BelowItem:
                    ...
                    if self._drop_indicator_position == self.OnItem:
...
class EditFileTreeWidget(base.DirectoryWidget, object):
    ...
    def ui(self):
        ...
        self.edit_mode_btn = buttons.IconButton(icon=drag_reorder_icon,
          icon_padding=2,
