...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/library/savewidget.py
# Compiled at: 2020-04-24 23:12:07
# Size of source mod 2**32: 18397 bytes
"""
...
class SaveWidget(base.BaseWidget, object):
    ...
    def show_by_frame_dialog(self):
        ...
        if duration > 100:
            if by_frame == 1:
                ...
                result = messagebox.MessageBox.question((self.library_window()),
                  title='Tip', text=help_text, buttons=buttons, enable_dont_show_checkbox=True)
    ...
    def show_thumbnail_capture_dialog(self):
        ...
        btn = messagebox.MessageBox.question(None,
          'Create a thumbnail', 'Would you like to capture a thumbnail?', buttons=buttons)
    ...
    def thumbnail_capture(self, show=False):
        ...
        if not tp.is_maya():
            ...
            try:
                thumbnail.ThumbnailCaptureDialog.thumbnail_capture(path=(self._temp_path),
                  show=show,
