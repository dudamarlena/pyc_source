...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/kinopoiskpy/kinopoisk/tests/person.py
# Compiled at: 2019-07-02 23:05:39
...
class PersonTest(BaseTest):
    ...
    def test_person_main_page_source(self):
        ...
        self.assertEqual(role.name, 'Sherlock Gnomes')
        ...
        self.assertEqual(p.career['actor'][9].name, 'Abel')
