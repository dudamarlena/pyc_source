...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/aws_secretsmanager_caching/cache/lru.py
...
class LRUCache:
    __doc__ = 'Least recently used cache'
...
class LRUItem:
    __doc__ = 'An item for use in the LRU cache.'
