...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/iw/rotatezlogs/tests/test_rotatezlogsdocstrings.py
# Compiled at: 2008-07-29 13:25:22
"""
Generic Test case for iw.rotatezlogs doc strings
"""
...
def doc_suite(test_dir, globs=None):
    ...
    for test in docs:
        ...
        suite.append(doctest.DocTestSuite('iw.rotatezlogs.%s' % test, optionflags=flags, globs=globs))
