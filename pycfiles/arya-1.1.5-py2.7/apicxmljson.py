...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/arya/apicxmljson.py
# Compiled at: 2014-12-08 12:53:46
"""
...
import xml.etree.ElementTree as ET, json, StringIO
...
def main():
    ...
    parser.add_argument('-s', '--stdin', help='Parse input from stdin, for ' + 'use as a filter, e.g., cat doc.xml | %s -s' % str(basename(sys.argv[0])), action='store_true', default=False, required=False)
