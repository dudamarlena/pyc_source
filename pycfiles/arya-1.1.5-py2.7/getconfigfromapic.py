...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/arya/getconfigfromapic.py
# Compiled at: 2014-12-08 12:53:46
from argparse import ArgumentParser
import httplib, logging
from arya import arya
try:
    import cobra.mit.access, cobra.mit.session, cobra.mit.request
...
def main():
    ...
    parser.add_argument('-e', '--endpoint', help='Use old EndPoint object', default=False)
    ...
    elif args.apic.startswith(('http://', 'https://')):
