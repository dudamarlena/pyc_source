...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/django_support_page/views.py
# Compiled at: 2018-06-05 21:38:21
...
def support_page(request, form_class=SupportForm, template_name='django_support_page/support_form.html', success_url=None, extra_context=None, fail_silently=False):
    """
...
def support_form_sent(request, template_name='django_support_page/form_sent.html', extra_context=None):
    """
