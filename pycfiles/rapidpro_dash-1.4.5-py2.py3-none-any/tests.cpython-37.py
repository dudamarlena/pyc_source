...
# [GCC 8.4.0]
# Embedded file name: /Users/rowan/Nyaruka/dash/dash_test_runner/tests.py
# Compiled at: 2019-02-01 11:30:57
# Size of source mod 2**32: 126077 bytes
import json
...
class UserTest(SmartminTest):
    ...
    def test_user_profile(self):
        ...
        post_data = dict(username='denzel@nyaruka.com', first_name='Denzel', last_name='Washington', email='washington@nyaruka.com',
...
class DashTest(SmartminTest):
    ...
    def create_org(self, subdomain, user):
        ...
        if not org_backend:
            org.backends.get_or_create(api_token=(random_string(32)), slug='rapidpro', created_by=user,
              modified_by=user)
...
class SetOrgMiddlewareTest(DashTest):
    ...
    def test_process(self):
        ...
        self.assertIsNone(self.request.user.get_org())
        self.assertEquals(response.status_code, 302)
        empty_subdomain_org = Org.objects.create(subdomain='', name='global', language='en', created_by=(self.admin),
...
class OrgTest(DashTest):
    ...
    def test_org_model(self):
        ...
        self.assertEqual(client.headers['Authorization'], 'Token %s' % self.org.backends.filter(slug='rapidpro').first().api_token)
    ...
    def test_org_create(self):
        ...
        data = dict(name='kLab', subdomain='klab', domain='ureport.io', timezone='Africa/Kigali',
          administrators=[user_alice.pk])
        response = self.client.post(create_url, data)
        self.assertEquals(response.status_code, 200)
        self.assertTrue(response.context['form'])
        self.assertTrue(response.context['form'].errors)
        data = dict(name='kLab', subdomain='klab', domain='klab.rw', timezone='Africa/Kigali',
          administrators=[user_alice.pk])
        ...
        data = dict(name='rwanda', subdomain='rwanda', domain='', timezone='Africa/Kigali',
          administrators=[user_alice.pk])
        response = self.client.post(create_url, data, follow=True)
        self.assertNotIn('form', response.context)
        self.assertTrue(Org.objects.filter(name='rwanda'))
        self.assertTrue(Org.objects.get(name='rwanda'))
        data = dict(name='burundi', subdomain='burundi', domain='', timezone='Africa/Kigali',
          administrators=[user_alice.pk])
        response = self.client.post(create_url, data, follow=True)
        self.assertNotIn('form', response.context)
    ...
    def test_org_update(self):
        ...
        post_data = dict(name='Burundi', timezone='Africa/Bujumbura', subdomain='burundi', domain='ureport.io', is_active=True,
          male_label='male',
          female_label='female',
        ...
        self.assertTrue(response.context['form'])
        self.assertTrue(response.context['form'].errors)
        post_data = dict(name='Burundi', timezone='Africa/Bujumbura', subdomain='burundi', domain='ureport.bi', is_active=True,
          male_label='male',
          female_label='female',
          administrators=(self.admin.pk))
        response = self.client.post(update_url, post_data)
    ...
    def test_org_edit(self):
        ...
        self.assertEquals(len([f for f in response.context['form'].fields.items() if f[1].widget.attrs.get('readonly', '') == 'readonly']), 9)
        ...
        self.assertEquals(len([f for f in response.context['form'].fields.items() if f[1].widget.attrs.get('readonly', '') == 'readonly']), 0)
    ...
    def test_invitation_model(self):
        invitation = Invitation.objects.create(org=(self.org), user_group='V',
          email='norkans7@gmail.com',
          created_by=(self.admin),
          modified_by=(self.admin))
        with patch('dash.orgs.models.Invitation.generate_random_string') as (mock):
            mock.side_effect = [
             invitation.secret, 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA']
            second_invitation = Invitation.objects.create(org=(self.org), user_group='E',
              email='eric@gmail.com',
              created_by=(self.admin),
              modified_by=(self.admin))
            self.assertEquals(second_invitation.secret, 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA')
    ...
    def test_join(self):
        editor_invitation = Invitation.objects.create(org=(self.org), user_group='E', email='norkans7@gmail.com', created_by=(self.admin),
          modified_by=(self.admin))
        ...
        self.assertEquals(response.request['PATH_INFO'], reverse('orgs.org_create_login', args=[
        ...
        with self.settings(SITE_USER_HOME='/example/home'):
            invitation = Invitation.objects.create(org=(self.org), user_group='E', email='norkans7@gmail.com', created_by=(self.admin),
              modified_by=(self.admin))
    ...
    def test_create_login(self):
        admin_invitation = Invitation.objects.create(org=(self.org), user_group='A',
          email='norkans7@gmail.com',
          created_by=(self.admin),
          modified_by=(self.admin))
        self.org2 = self.create_org('kenya', self.admin)
        ...
        viewer_invitation = Invitation.objects.create(org=(self.org), user_group='V',
          email='norkans7@gmail.com',
          created_by=(self.admin),
          modified_by=(self.admin))
...
class OrgTaskTest(DashTest):
    ...
    def test_org_task(self, mock_over_time_window):
        ...
        self.assertEqual(state3.last_successfully_started_on, state2.started_on)
...
class CategoryTest(DashTest):
    ...
    def test_category_model(self):
        category1 = Category.objects.create(name='category 1', org=(self.uganda),
        ...
        category2 = Category.objects.create(name='Освіта', org=(self.uganda),
          image='categories/image.jpg',
          created_by=(self.admin),
          modified_by=(self.admin))
        ...
        with self.assertRaises(IntegrityError):
            Category.objects.create(name='category 1', org=(self.uganda),
              created_by=(self.admin),
              modified_by=(self.admin))
    ...
    def test_category_get_first_image(self):
        ...
        category_image1 = CategoryImage.objects.create(category=category1, name='image 1',
          image=None,
          created_by=(self.admin),
          modified_by=(self.admin))
    ...
    def test_list_category(self):
        uganda_health = Category.objects.create(name='Health', org=(self.uganda), created_by=(self.admin),
          modified_by=(self.admin))
        uganda_education = Category.objects.create(name='Education', org=(self.uganda), created_by=(self.admin),
          modified_by=(self.admin))
        nigeria_health = Category.objects.create(name='Health', org=(self.nigeria), created_by=(self.admin),
          modified_by=(self.admin))
    ...
    def test_create_category_image(self):
        ...
        nigeria_law = Category.objects.create(name='Law', org=(self.nigeria), is_active=False, created_by=(self.admin),
          modified_by=(self.admin))
        response = self.client.get(create_url, SERVER_NAME='nigeria.ureport.io')
        self.assertEquals(response.status_code, 200)
        self.assertEquals(len(response.context['form'].fields), 4)
...
class StoryTest(DashTest):
    ...
    def setUp(self):
        ...
        self.uganda = self.create_org('uganda', self.admin)
        self.nigeria = self.create_org('nigeria', self.admin)
        self.health_uganda = Category.objects.create(org=(self.uganda), name='Health',
          created_by=(self.admin),
          modified_by=(self.admin))
        self.education_nigeria = Category.objects.create(org=(self.nigeria), name='Education',
          created_by=(self.admin),
          modified_by=(self.admin))
    ...
    def test_story_model(self):
        self.story = Story.objects.create(title='Story 1', content='content content content content content content content content content content content content content content content content content content content content ',
          org=(self.uganda),
          created_by=(self.admin),
          modified_by=(self.admin))
        ...
        self.story.content = 'content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content '
        self.story.save()
        self.assertEquals(self.story.teaser(self.story.summary, 30), '')
        self.assertEquals(self.story.teaser(self.story.content, 30), 'content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content ..')
        self.assertEquals(self.story.long_teaser(), 'content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content ..')
        self.assertEquals(self.story.short_teaser(), 'content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content content ..')
        self.story.summary = 'summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary '
        self.story.save()
        self.assertEquals(self.story.long_teaser(), 'summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary ..')
        self.assertEquals(self.story.short_teaser(), 'summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary ..')
        ...
        story_image_1 = StoryImage.objects.create(name='image 1', story=(self.story),
          image='',
          created_by=(self.admin),
          modified_by=(self.admin))
        ...
        self.assertEquals(self.story.get_category_image(), 'stories/someimage.jpg')
        self.assertEquals(self.story.get_image(), 'stories/someimage.jpg')
        CategoryImage.objects.create(category=(self.health_uganda), name='image 1',
    ...
    def test_create_story(self):
        ...
        post_data = dict(title='foo', content='bar', category=(self.health_uganda.pk), featured=True, summary='baz', audio_link='example.com/foo.mp3',
          video_id='yt_id',
    ...
    def test_update_story(self):
        story1 = Story.objects.create(title='foo', content='bar',
          category=(self.health_uganda),
          org=(self.uganda),
          created_by=(self.admin),
          modified_by=(self.admin))
        story2 = Story.objects.create(title='foo', content='bar',
        ...
        self.assertTrue('title' in errors)
        self.assertTrue('content' in errors)
        post_data = dict(title='foo updated', content='bar updated', category=(self.health_uganda.pk), featured=True, summary='baz updated',
...
class DashBlockTypeTest(DashTest):
    ...
    def test_list_dashblocktype(self):
        ...
        dashblock_type = DashBlockType.objects.create(name='Test', slug='test', description='foo',
          has_title=True,
          has_image=True,
          has_rich_text=True,
          has_summary=True,
...
class DashBlockTest(DashTest):
    ...
    def setUp(self):
        ...
        self.uganda = self.create_org('uganda', self.admin)
        self.nigeria = self.create_org('nigeria', self.admin)
        self.type_foo = DashBlockType.objects.create(name='Foo', slug='foo', description='foo description',
          has_title=True,
          has_image=True,
          has_rich_text=True,
          has_summary=True,
          ...
          created_by=(self.admin),
          modified_by=(self.admin))
        self.type_bar = DashBlockType.objects.create(name='Bar', slug='bar', description='bar description',
          has_title=False,
          has_image=False,
          has_rich_text=False,
          has_summary=False,
    ...
    def test_dashblock_model(self):
        dashblock1 = DashBlock.objects.create(dashblock_type=(self.type_foo), org=(self.uganda),
          title='First',
        ...
        dashblock2 = DashBlock.objects.create(dashblock_type=(self.type_bar), org=(self.uganda),
          content='Bar content',
        ...
        dashblock1.content = 'ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab '
        dashblock1.summary = 'cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd '
        dashblock1.save()
        self.assertEquals(dashblock1.long_content_teaser(), 'ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ...')
        self.assertEquals(dashblock1.short_content_teaser(), 'ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ab ...')
        self.assertEquals(dashblock1.long_summary_teaser(), 'cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd ...')
        self.assertEquals(dashblock1.short_summary_teaser(), 'cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd cd ...')
    ...
    def test_create_dashblock(self):
        ...
        response = self.client.post((create_url + '?type=%d' % self.type_foo.pk), post_data, follow=True,
    ...
    def test_list_dashblock(self):
        ...
        dashblock2 = DashBlock.objects.create(dashblock_type=(self.type_bar), org=(self.uganda),
          ...
          created_by=(self.admin),
          modified_by=(self.admin))
        dashblock3 = DashBlock.objects.create(dashblock_type=(self.type_foo), org=(self.nigeria),
          title='third',
    ...
    def test_template_tags(self):
        ...
        self.assertEquals(load_qbs(context, self.uganda, 'invalid_slug'), getattr(settings, 'DASHBLOCK_STRING_IF_INVALID', '<b><font color="red">DashBlockType with slug: %s not found</font></b>') % 'invalid_slug')
        self.assertFalse(context)
        ...
        dashblock4 = DashBlock.objects.create(dashblock_type=(self.type_foo), org=(self.uganda),
          title='Fourth',
