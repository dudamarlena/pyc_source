...
# [GCC 8.4.0]
# Embedded file name: /Users/leo/Devel/Naeka/wagtailmodelchooser/wagtailmodelchooser/views.py
# Compiled at: 2018-10-29 13:43:33
...
class ModelChooserView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update(model_chooser_url_name=self.model_chooser_url_name, model_chosen_url_name=self.model_chosen_url_name, is_searching=self.is_searching, model_verbose_name=self.model._meta.verbose_name, model_verbose_name_plural=self.model._meta.verbose_name_plural)
        return context
    ...
    def get(self, request, *args, **kwargs):
        ...
        if 'q' in self.request.GET or 'p' in self.request.GET:
            ...
            if searchform.is_valid():
                ...
                self.object_list = self.object_list.filter(**{'{}__icontains'.format(self.title_field): searchform.cleaned_data.get('q')})
...
class ModelChosenView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render_modal_workflow(request, None, 'wagtailmodelchooser/chooser/model_chosen.js', {'model_json': json.dumps(self.model_data_extractor(self.object, self.title_field))})