        ...
        if widget_class:
            ...
            if chooser_view:
                if not getattr(chooser_view, 'model', None) == model:
                    raise AssertionError("Incorrect model attribute for {}: '{}.{}' is expected".format(chooser_view.__name__, model.__module__, model.__name__))
                else:
            ...
            assert chosen_view and getattr(chosen_view, 'model', None) == model, "Incorrect model attribute for {}: '{}.{}' is expected".format(chosen_view.__name__, model.__module__, model.__name__)
