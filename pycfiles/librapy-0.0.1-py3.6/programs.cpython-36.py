...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/librapy/programs/programs.py
# Compiled at: 2019-09-05 07:11:50
...
class PeerToPeerTransfer(Program):
    ...
    def get_path(self):
        return os.path.join(os.path.dirname(__file__), 'peer_to_peer_transfer.prg')
...
class RotateAuthenticationKey(Program):
    ...
    def get_path(self):
        return os.path.join(os.path.dirname(__file__), 'rotate_authentication_key.prg')