...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/librapy/types/transactions.py
# Compiled at: 2019-09-05 07:09:38
...
class RawTransaction:
    ...
    def __init__(self, sender, sequence_number, payload, max_gas_amount, gas_unit_price, expiration):
        self.sender = sender
    ...
    def __repr__(self):
        return 'RawTransaction (\n\tsender: {}\n\tsequence_number: {}\n\tpayload: {}\n\tmax_gas_amount: {}\n\tgas_unit_price: {}\n\texpiration: {}\n)'.format(self.sender, self.sequence_number, self.payload, self.max_gas_amount, self.gas_unit_price, self.expiration)

    def deserialize(deserializer):
        return RawTransaction(deserializer.decode_struct(AccountAddress), deserializer.decode_u64(), deserializer.decode_struct(TransactionPayload), deserializer.decode_u64(), deserializer.decode_u64(), deserializer.decode_u64())
...
class SignedTransaction:
    ...
    def __repr__(self):
        return 'SignedTransaction (\n\traw_txn: {}\n\tpublic_key: {}\n\tsignature: {}\n)'.format(self.raw_txn, self.public_key.encode().hex(), self.signature.hex())

    def deserialize(deserializer):
        return SignedTransaction(deserializer.decode_struct(RawTransaction), VerifyKey(deserializer.decode_bytes()), deserializer.decode_bytes())
