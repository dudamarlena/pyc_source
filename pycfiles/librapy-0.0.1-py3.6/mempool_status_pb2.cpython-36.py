...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/librapy/proto/mempool_status_pb2.py
...
_MEMPOOLADDTRANSACTIONSTATUSCODE = _descriptor.EnumDescriptor(name='MempoolAddTransactionStatusCode',
 ...
 _descriptor.EnumValueDescriptor(name='Valid',
   ...
   serialized_options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='InsufficientBalance',
   index=1,
   number=1,
   serialized_options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='InvalidSeqNumber',
   index=2,
   number=2,
   serialized_options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='MempoolIsFull',
   index=3,
   number=3,
   serialized_options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='TooManyTransactions',
   index=4,
   number=4,
   serialized_options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='InvalidUpdate',
   index=5,
   number=5,
   serialized_options=None,
   type=None)],
...
InvalidUpdate = 5
_MEMPOOLADDTRANSACTIONSTATUS = _descriptor.Descriptor(name='MempoolAddTransactionStatus',
 ...
 _descriptor.FieldDescriptor(name='code',
   full_name='mempool.MempoolAddTransactionStatus.code',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
 ...
 _descriptor.FieldDescriptor(name='message',
   full_name='mempool.MempoolAddTransactionStatus.message',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
...
MempoolAddTransactionStatus = _reflection.GeneratedProtocolMessageType('MempoolAddTransactionStatus', (_message.Message,), {'DESCRIPTOR':_MEMPOOLADDTRANSACTIONSTATUS, 
