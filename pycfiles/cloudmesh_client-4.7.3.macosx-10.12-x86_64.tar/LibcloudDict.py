...
# [GCC 8.4.0]
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/common/LibcloudDict.py
# Compiled at: 2017-04-23 10:30:41
from pprint import pprint

class LibcloudDict(object):
    Libcloud_category_list = [
     'chameleon-ec2',
     'cybera-ec2',
     'aws']
