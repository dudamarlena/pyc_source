...
# [GCC 8.4.0]
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/shell/plugins/DefaultCommand.py
...
class DefaultCommand(PluginCommand, CloudPluginCommand, CometPluginCommand):
    ...
    def do_default(self, args, arguments):
        ...
        """
        general_keys = [
         'cloud', 'cluster', 'queue', 'key', 'group', 'user', 'secgroup', 'vm',
        ...
        if arguments['KEY'] in general_keys:
            ...
            if args == '':
                ...
                result = Default.list(category=cloud, order=order, output=output_format)
                print(result)
                return ''
        ...
        if arguments['delete']:
            ...
            if not result:
                ...
                Console.ok(('Deleted key {} for cloud {}. ok.').format(key, cloud))
            return ''
        if '=' in arguments['KEY']:
