...
# [GCC 8.4.0]
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/shell/plugins/HpcCommand.py
...
from cloudmesh_client.shell.command import PluginCommand, HPCPluginCommand, CometPluginCommand
        ...
        if arguments['queue']:
            ...
            if arguments['ID']:
                ...
                if result is not None:
                    ...
                    Console.error(('Could not find experiment {ID} on {CLUSTER}').format(**arguments))
                    return ''
                force = yn_choice(('Would you like to delete the experiments {experiments} on Cluster {CLUSTER}').format(**arguments))
                if force:
                    try:
