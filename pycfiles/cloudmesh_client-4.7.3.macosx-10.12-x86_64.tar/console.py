...
# [GCC 8.4.0]
# Embedded file name: /Users/grey/.pyenv/versions/cm/lib/python2.7/site-packages/cloudmesh_client/shell/console.py
...
class Console(object):
    ...
    color = True
    debug = True
    theme_color = {'HEADER': Fore.MAGENTA, 
       'BLACK': Fore.BLACK, 
       'CYAN': Fore.CYAN, 
       'WHITE': Fore.WHITE, 
       'BLUE': Fore.BLUE, 
    ...
    def cprint(color, prefix, message):
        message = message or ''
        prefix = prefix or ''
        print(Console.theme[color] + prefix + message + Console.theme['ENDC'])
