...
# Embedded file name: build/bdist.linux-x86_64/egg/apgl/graph/AbstractMatrixGraph.py
# Compiled at: 2013-11-11 09:25:43
import numpy, heapq, scipy, logging, os.path, tempfile, base64, shutil
try:
    import Queue
except ImportError:
    import queue
...
class AbstractMatrixGraph(AbstractSingleGraph):
    ...
    def adjacencyList(self, useWeights=True):
        ...
        return (
         neighbourIndices, neighbourWeights)
    ...
    def fromNetworkXGraph(cls, networkXGraph):
        ...
        if type(networkXGraph) == networkx.classes.graph.Graph:
            ...
            if type(networkXGraph) == networkx.classes.digraph.DiGraph:
                undirected = False
            else:
