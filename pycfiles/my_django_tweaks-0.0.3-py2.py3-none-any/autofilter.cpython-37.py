...
# [GCC 8.4.0]
# Embedded file name: /Users/ricard/develop/my_django_tweaks/my_django_tweaks/autofilter.py
...
def autofilter(extra_ordering=None, extra_filter=None, exclude_fields=None):
    ...
    def wrapped(cls):
        ...
        for serializer_field in serializer_class()._readable_fields:
            ...
            try:
                if name == 'id' or getattr(model_cls._meta.get_field(name), 'db_index', False) or getattr(model_cls._meta.get_field(name), 'unique', False):
