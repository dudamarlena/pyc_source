...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.6/dist-packages/defi_trainer/defi_train.py
# Compiled at: 2009-05-25 17:31:02
"""
...
class DefiTrainer(QtCore.QObject):
    ...
    def __init__(self):
        ...
        if len(self.model.get_section_list()) > 1:
            self.select_diag = SelectSectionDlg(self.model.get_section_list(), None)
