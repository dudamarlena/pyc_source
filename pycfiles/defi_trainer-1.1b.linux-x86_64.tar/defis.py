...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.6/dist-packages/defi_trainer/parser/defis.py
# Compiled at: 2009-05-31 11:29:09
"""
...
"""
import logging, copy, docutils.parsers.rst
...
class Defis(object):
    ...
    def __choose_parsing_func(self, item):
        ...
        """
        option_dict = {'section': self.__parse_section, 'enumerated_list': self.__parse_enum_list, 
        ...
        try:
            ...
            logging.warning('Error in definition file after:%s' % self.text_temp)