...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/feynman/tests/test_v2_4_circle.py
# Compiled at: 2018-05-31 10:24:10
...
def test_simple():
    ...
    ax.set_yticks([])
    D = Diagram(ax)
    v1 = D.vertex(xy=(0.2, 0.2), marker='')
    v2 = D.vertex(xy=(0.5, 0.2))
    v3 = D.vertex(xy=(0.8, 0.2), marker='')
    v4 = D.vertex(xy=(0.5, 0.6))
...
@image_comparison(baseline_images=['angle'], extensions=[
 'png'])
def test_angle():
    fig = plt.figure(figsize=(6, 6))
    ax = fig.add_subplot(111)
