...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/feynman/diagrams/diagrams.py
# Compiled at: 2018-05-30 17:37:46
"""Diagram class"""
from copy import deepcopy
import warnings, numpy as np, matplotlib as mpl, matplotlib.pyplot as plt, matplotlib.patches as mpa, matplotlib.text as mpt
...
class Diagram(Plotter):
    ...
    def verticle(self, *args, **kwargs):
        warnings.warn('Diagram.verticle is deprecated. ' + 'Use Diagram.vertex instead.')
        return self.vertex(*args, **kwargs)

    def verticles(self, *args, **kwargs):
        warning.warn('Diagram.verticles is deprecated. ' + 'Use Diagram.vertices instead.')
