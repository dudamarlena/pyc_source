...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/feynman/core/operators.py
# Compiled at: 2018-05-30 16:55:41
...
__all__ = [
 'Operator', 'RegularOperator', 'RegularBubbleOperator']
    ...
    **kwargs:
    ...
    def __init__(self, vertices, **kwargs):
        ...
        if self.N == 2:
            ...
            self.style = dict(edgecolor='k', facecolor=colors.lightblue, linewidth=3)
            self.style.update(kwargs)
            self.line_prop = kwargs.pop('line_prop', dict())
            default_line_prop = dict(style='simple straight linear', arrow=False, zorder=1, linewidth=3)
    ...
    def get_patch(self, *args, **kwargs):
        ...
        if self.shape.lower() == 'polygon':
            return self.get_polygon(*args, **kwargs)
        if self.shape.lower() == 'bubble':
    ...
    def text(self, s, x=0.0, y=0.0, **kwargs):
        """
