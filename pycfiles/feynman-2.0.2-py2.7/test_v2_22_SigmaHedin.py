...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/feynman/tests/test_v2_22_SigmaHedin.py
# Compiled at: 2018-05-31 10:24:04
import numpy as np, matplotlib.pyplot as plt
from matplotlib.testing.decorators import image_comparison
from ..diagrams import Diagram

@image_comparison(baseline_images=['sigma'], extensions=[
 'png'])
def test_diagram():
    ...
    G_style = dict(style='double', arrow=True, arrow_param={'t': 0.5, 'width': 0.05})
    D1 = Diagram(ax)
    v1 = D1.vertex([x0, y0])
