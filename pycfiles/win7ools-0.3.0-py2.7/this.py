...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\win7ools\this.py
# Compiled at: 2014-12-26 18:14:34
"""Augmented Zen of Python"""
from distutils.log import warn
print 'The *Augmented* Zen of Python'
print ''
...
warn('Only warn after unexpected behavior.')
warn('"enable" functions should always return a "success" boolean.')
warn('Print/warn at the lowest level to avoid unnecessary code.')