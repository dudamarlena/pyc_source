...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/ruamel/yaml/comments.py
# Compiled at: 2017-07-27 07:36:53
from __future__ import absolute_import
from __future__ import print_function
from collections import MutableSet
__all__ = [
 'CommentedSeq', 'CommentedMap', 'CommentedOrderedMap',
...
class CommentedBase(object):
    ...
    def yaml_key_comment_extend(self, key, comment, clear=False):
        ...
        if clear or l[1] is None:
            assert comment[1] is not None and isinstance(comment[1], list)
            l[1] = comment[1]
        else:
...
class CommentedMap(ordereddict, CommentedBase):
    ...
    def mlget(self, key, default=None, list_ok=False):
        ...
        def get_one_level(key_list, level, d):
            assert list_ok or isinstance(d, dict)
