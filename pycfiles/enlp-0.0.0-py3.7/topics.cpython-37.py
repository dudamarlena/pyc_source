...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/enlp/understanding/topics.py
...
"""
import gensim, nltk, pandas as pd
...
def bow_topic_modelling(docs, no_topics=10):
    ...
    bow_model = gensim.models.LdaMulticore(bow_corpus, num_topics=no_topics,
      id2word=dictionary)
    return (
     bow_model, dictionary)
...
def tfidf_topic_modelling(docs, no_topics=10):
    ...
    tfidf_model = gensim.models.LdaMulticore(tfidf_corpus, num_topics=no_topics,
      id2word=dictionary)
    return (
