...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/enlp/processing/stdtools.py
# Compiled at: 2019-11-27 15:57:30
# Size of source mod 2**32: 8704 bytes
"""
...
def spacy_lemmatize(model, text):
    ...
    """
    lemma_tx = [t.text if t.lemma_ == '-PRON-' else t.lemma_ for t in model(text)]
