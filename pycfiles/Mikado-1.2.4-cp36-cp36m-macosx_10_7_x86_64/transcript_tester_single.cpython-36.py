...
# [GCC 8.4.0]
# Embedded file name: /Users/venturil/workspace/mikado/Mikado/tests/transcript_tester_single.py
# Compiled at: 2018-05-23 17:14:36
# Size of source mod 2**32: 33342 bytes
"""
Unit test for monoexonic transcripts.
"""
import operator, re, unittest, Mikado.exceptions, Mikado.loci, Mikado.parsers
...
class TranscriptTester(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.orf.strand = '+'
        self.orf.score = 0
        self.orf.thick_start = 2644
        self.orf.thick_end = 2739
    ...
    def test_cds(self):
        ...
        self.assertEqual(self.tr.combined_cds, [
         tuple([8571, 8666])], self.tr.combined_cds)
    ...
    def test_equality(self):
        ...
        self.assertFalse(new_transcript == self.tr)
    ...
    def test_mono_finalising(self):
        ...
        exon_lines = [line for line in self.tr_gff_lines if line.is_exon is True if 'UTR' not in line.feature.upper()]
    ...
    def test_utr_metrics(self):
        ...
        self.assertEqual(self.tr.five_utr_length, 2643)
        self.assertEqual(self.tr.three_utr_length, 71)
        self.assertEqual(self.tr.selected_start_distance_from_tss, 2643, self.tr.selected_end_distance_from_tes)
        self.assertEqual(self.tr.selected_end_distance_from_tes, 71, (
    ...
    def test_introns(self):
        ...
        self.assertEqual(self.tr.combined_cds_introns, set([]), self.tr.combined_cds_introns)
        self.assertEqual(self.tr.selected_cds_introns, set([]), self.tr.selected_cds_introns)
...
class TestWheatRNA(unittest.TestCase):
    ...
    def test_negative_orf(self):
        ...
        transcript.score = 23
        transcript.finalize()
        bed = Mikado.parsers.bed12.BED12()
        ...
        bed2 = Mikado.parsers.bed12.BED12()
        ...
        self.assertEqual((transcript.start,
         ...
         transcript.end), (215963, 217516, 217046, 217518))
    ...
    def test_orf_sorter(self):
        ...
        bed2.has_start_codon = False
        bed2.has_stop_codon = False
        after_sorting = sorted([bed, bed2], reverse=True,
...
class TestNegativeSplit(unittest.TestCase):
    ...
    def test_loading(self):
        ...
        self.assertEqual(self.tr.number_internal_orfs, 2)
        self.assertEqual(self.tr.selected_cds_start, 74914)
        self.assertEqual(self.tr.selected_cds_end, 74336)
        self.assertEqual(self.tr.combined_cds_end, 74336)
        self.assertEqual(self.tr.combined_cds_start, 75804)
