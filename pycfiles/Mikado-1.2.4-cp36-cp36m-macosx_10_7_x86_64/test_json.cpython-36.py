...
# [GCC 8.4.0]
# Embedded file name: /Users/venturil/workspace/mikado/Mikado/tests/test_json.py
# Compiled at: 2018-05-23 17:14:36
# Size of source mod 2**32: 6336 bytes
import Mikado.utilities, Mikado.exceptions, Mikado.configuration, unittest, os, pkg_resources
...
class TestScoring(unittest.TestCase):
    ...
    def test_available_scoring_files(self):
        for scorer in pkg_resources.resource_listdir('Mikado.configuration', 'scoring_files'):
            ...
            self.assertIsInstance(Mikado.configuration.configurator.check_json(conf), dict, scorer)
