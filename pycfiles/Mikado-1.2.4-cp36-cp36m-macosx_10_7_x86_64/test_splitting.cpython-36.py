...
# [GCC 8.4.0]
# Embedded file name: /Users/venturil/workspace/mikado/Mikado/tests/test_splitting.py
# Compiled at: 2018-05-23 17:14:36
# Size of source mod 2**32: 17520 bytes
import logging, operator, unittest
...
class TestSplitMonoexonic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.transcript.json_conf['pick']['chimera_split']['blast_params']['minimal_hsp_overlap'] = 0.8
        ...
        self.assertEqual(self.transcript.number_internal_orfs, 2, str(self.transcript))
        ...
        hit1['query_aligned_length'] = 2700
        hit1['target_aligned_length'] = 2999
        hsp1_1 = dict()
        hsp1_1['hsp_evalue'] = 1e-06
    ...
    def test_lenient_split(self):
        ...
        for orf in sorted((self.transcript.loaded_bed12), key=(operator.attrgetter('thick_start', 'thick_end'))):
            cds_boundaries[(orf.thick_start, orf.thick_end)] = [
             orf]

        self.assertEqual(1, len(splitting.check_split_by_blast(self.transcript, cds_boundaries)))
    ...
    def get_second_hit():
        ...
        hit1['evalue'] = 1e-06
        hit1['global_identity'] = 100
        hit1['query_aligned_length'] = 1150
    ...
    def test_deleted_hits(self):
        ...
        with self.assertLogs('null', level='WARNING') as (log_split):
            self.assertEqual(2, len(list(splitting.split_by_cds(self.transcript))))
        self.assertIn('WARNING:null:BLAST hits store lost for transcript1! Creating a mock one to avoid a crash', log_split.output)
