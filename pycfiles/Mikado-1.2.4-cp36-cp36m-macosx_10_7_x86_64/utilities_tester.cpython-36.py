...
# [GCC 8.4.0]
# Embedded file name: /Users/venturil/workspace/mikado/Mikado/tests/utilities_tester.py
# Compiled at: 2018-05-23 17:14:36
# Size of source mod 2**32: 6839 bytes
import Mikado.utilities, unittest, os, tempfile, logging, queue
...
class UtilTester(unittest.TestCase):
    ...
    def test_path(self):
        ...
        self.assertEqual(os.path.join(cur_dir, nonabs), Mikado.utilities.path_join(cur_dir, nonabs))
    ...
    def test_merger(self):
        ...
        with open(first_name, 'wt') as (first):
            with open(second_name, 'wt') as (second):
                with open(third_name, 'wt') as (third):
...
class LogUtilsTester(unittest.TestCase):
    ...
    def test_null_log(self):
        ...
        null2 = Mikado.utilities.log_utils.create_null_logger('test', 'will_nilly', useless_val=None)
