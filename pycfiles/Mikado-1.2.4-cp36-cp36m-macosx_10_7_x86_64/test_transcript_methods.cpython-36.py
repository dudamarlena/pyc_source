...
# [GCC 8.4.0]
# Embedded file name: /Users/venturil/workspace/mikado/Mikado/tests/test_transcript_methods.py
...
class TestRetrieval(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tr.finalize()
        conf = to_json(os.path.join(os.path.dirname(__file__), 'configuration.yaml'))
    ...
    def test_load_pos_and_neg(self):
        ...
        self.assertEqual(after_overlap_check, [
         b1, b2], [_.name for _ in after_overlap_check])
