...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/qi/xmpp/client/filetransfer.py
# Compiled at: 2008-08-01 13:19:37
from twisted.words.xish.domish import Element
from twisted.internet import protocol, reactor, error
import sha, StringIO, struct, qi.xmpp.client.ns as ns, qi.xmpp.client.xmppComm as xmppComm
fileTransferSupportedFeatures = [
 ns.NS_S5B]
