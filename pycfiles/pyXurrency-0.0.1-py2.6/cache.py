...
# [GCC 8.4.0]
# Embedded file name: _build\bdist.win32\egg\xurrency\cache.py
# Compiled at: 2011-02-28 21:07:57
import datetime
...
class CacheWithTimeLimit(object):
    ...
    def __init__(self, seconds=0):
        ...
        """
        if seconds < 0:
            raise CacheWithTimeLimitError('Please specify the value of 0 or more.')
        self._cache = {}
