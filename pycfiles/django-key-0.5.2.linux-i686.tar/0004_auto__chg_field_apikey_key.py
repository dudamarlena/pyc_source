...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/key/migrations/0004_auto__chg_field_apikey_key.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('key_apikey', 'key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16))

    def backwards(self, orm):
        db.alter_column('key_apikey', 'key', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'key.apikey': {'Meta': {'ordering': "['-created']", 'object_name': 'ApiKey'}, 'created': (
                                'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}), 
                      'id': (
                           'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                      'key': (
                            'django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '16', 'blank': 'True'}), 
                      'last_used': (
                                  'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}), 
                      'logged_ip': (
                                  'django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '32', 'null': 'True', 'blank': 'True'}), 
                      'profile': (
                                'django.db.models.fields.related.ForeignKey', [], {'related_name': "'api_keys'", 'to': "orm['key.ApiKeyProfile']"})}, 
       'key.apikeyprofile': {'Meta': {'object_name': 'ApiKeyProfile'}, 'id': (
                                  'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                             'last_access': (
                                           'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}), 
                             'max_keys': (
                             ...
                             'user': (
                                    'django.db.models.fields.related.OneToOneField', [], {'related_name': "'key_profile'", 'unique': 'True', 'to': "orm['auth.User']"})}}
    complete_apps = [
     'key']