...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/key/migrations/0006_auto__add_apikey__add_apikeyprofile.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('key_apikey', (
         ...
         (
          'key', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=16, blank=True)),
         (
