...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/key/migrations/0002_auto__add_field_apikeyprofile_last_access.py
# Compiled at: 2011-07-18 11:41:09
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('key_apikeyprofile', 'last_access', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow), keep_default=False)

    def backwards(self, orm):
        db.delete_column('key_apikeyprofile', 'last_access')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'key.apikey': {'Meta': {'ordering': "['-created']", 'object_name': 'ApiKey'}, 'created': (
                      ...
                      'id': (
                           'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                      'key': (
                            'django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}), 
                      'last_used': (
                                  'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}), 
                      'logged_ip': (
                                  'django.db.models.fields.IPAddressField', [], {'max_length': '15', 'null': 'True'}), 
                      'profile': (
