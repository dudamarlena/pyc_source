...
# [GCC 8.4.0]
# Embedded file name: ..\../gm3\indicatorModule\pyalgotrade\tools\quandl.py
# Compiled at: 2019-06-05 03:26:20
# Size of source mod 2**32: 8393 bytes
"""
.. moduleauthor:: Gabriel Martin Becedillas Ruiz <gabriel.becedillas@gmail.com>
"""
import datetime, os, argparse, six
...
def download_csv(sourceCode, tableCode, begin, end, frequency, authToken):
    ...
    params = {'trim_start':begin.strftime('%Y-%m-%d'), 
...
def download_weekly_bars(sourceCode, tableCode, year, csvFile, authToken=None):
    ...
    :type authToken: string.
    """
    begin = dt.get_first_monday(year) - datetime.timedelta(days=1)
    end = dt.get_last_monday(year) - datetime.timedelta(days=1)
...
def build_feed(sourceCode, tableCodes, fromYear, toYear, storage, frequency=bar.Frequency.DAY, timezone=None, skipErrors=False, authToken=None, columnNames={}, forceDownload=False, skipMalformedBars=False):
