...
# Size of source mod 2**32: 15223 bytes
"""
...
def combine_frames(this, *args, how='full'):
    ...
    if get_option('compute.ops_on_diff_frames'):
        ...
        return DataFrame(this._internal.copy(sdf=joined_df, data_columns=new_data_columns, column_index=column_index,
        ...
        for combined_idx in combined_column_index:
            for common_idx in common_column_index:
                if combined_idx == tuple(['this', *common_idx]):
                    ...
                    if combined_idx == tuple(['that', *common_idx]):
