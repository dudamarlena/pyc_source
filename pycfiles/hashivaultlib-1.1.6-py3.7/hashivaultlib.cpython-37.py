...
# [GCC 8.4.0]
# Embedded file name: /Users/ctyfoxylos/SBP/python/hashivaultlib/hashivaultlib/hashivaultlib.py
# Compiled at: 2019-05-22 07:27:30
# Size of source mod 2**32: 13402 bytes
"""
...
class Vault(Client):
    __doc__ = 'Extends the hvac client for vault with some extra handy usability'
    ...
    def tokens(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=30) as (executor):
            futures = [executor.submit((self.session.post), url, headers=headers, data=(json.dumps({'accessor': accessor}))) for accessor in self._token_accessors]
...
class TokenFactory:
    __doc__ = 'Factory to create the appropriate Token type'
...
class Token:
    __doc__ = 'Models a vault token and provides delete capabilities'
...
class BrokenToken(Token):
    __doc__ = 'Models a broken token with only an accessor ID and errors messages'
