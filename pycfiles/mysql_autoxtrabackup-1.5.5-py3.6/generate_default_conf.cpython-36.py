...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/general_conf/generate_default_conf.py
...
class GenerateDefaultConfig:
    ...
    def generate_config_file(self):
        with open(self.conf, 'w+') as (cfgfile):
            ...
            config.set(section3, '#Optional: pass general additional options; it will go to both for backup and prepare')
            ...
            config.set(section3, '#Optional: WARNING(Enable this if you want to take partial backups). Specify database names or table names.')
            ...
            config.set(section4, '#Enable if you want to remove .qp files after decompression.(Available from PXB 2.3.7 and 2.4.6)')
            ...
            config.set(section5, '#Enable if you want to remove .qp files after decompression.(Available from PXB 2.3.7 and 2.4.6)')
