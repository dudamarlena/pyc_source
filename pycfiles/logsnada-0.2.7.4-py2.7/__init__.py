...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/logsnada/__init__.py
# Compiled at: 2013-12-09 19:20:43
"""
...
class PatternComposer(object):
    ...
    def compose(self, logger):
        ...
        if not logger.name.endswith(self.__keyword):
            ...
            if isinstance(parent, CustomLogger) and parent.pattern_logger:
...
class CustomManager(object):
    ...
    def getLogger(self, name):
        ...
        elif isinstance(logger.parent, CustomLogger) and logger.parent.pattern_logger:
