...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jsonrpcproxy.py
# Compiled at: 2019-10-14 11:28:45
...
import requests, uuid, json, logging, re, six
import requests.exceptions as ConnectionError
import requests.exceptions as TimeoutError
__all__ = [
 'ServiceProxy', 'JsonRpcError', 'HttpError', 'ConnectionError',
 'TimeoutError', 'Client']
...
class Client(object):
    ...
    def _call(self, method, params=None):
        ...
        resp = requests.post((self._endpoint), data=(json.dumps(request)), timeout=(self._timeout), headers={'content-type': 'application/json'})
        resp_data = resp.text
