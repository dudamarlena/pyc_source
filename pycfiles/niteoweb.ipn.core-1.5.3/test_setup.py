...
# [GCC 8.4.0]
# Embedded file name: /home/matej/workarea/nw1/niteoweb.ipn.core/src/niteoweb/ipn/core/tests/test_setup.py
# Compiled at: 2013-10-02 05:46:37
...
class TestInstall(IntegrationTestCase):
    ...
    def test_record_validity_secret(self):
        ...
        record_secretkey = registry.records['niteoweb.ipn.core.validity.secret']
    ...
    def test_portal_tabs_auto_creation_disabled(self):
        ...
        self.assertTrue(self.portal.portal_properties.site_properties.use_email_as_login)
    ...
    def test_fields_added_to_member(self):
        ...
        self.assertEquals(str(memberdata.getProperty('product_id').__class__), "<type 'str'>")
        self.assertTrue(hasattr(memberdata, 'affiliate'))
        self.assertEquals(str(memberdata.getProperty('affiliate').__class__), "<type 'str'>")
        self.assertTrue(hasattr(memberdata, 'valid_to'))
        self.assertIn('DateTime.DateTime.DateTime', str(memberdata.getProperty('valid_to').__class__))
        self.assertTrue(hasattr(memberdata, 'history'))
        self.assertEquals(str(memberdata.getProperty('history').__class__), "<type 'tuple'>")
