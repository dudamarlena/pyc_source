...
# Compiled at: 2020-04-27 10:55:18
# Size of source mod 2**32: 118807 bytes
...
REGEX_ISODATE = '(19|20)\\d\\d-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])'
...
class DteDbRelationship:
    ...
    def col_options(self):
        ...
        col['type'] = 'select2'
        col['onFocus'] = 'focus'
        col['opts'] = {'minimumResultsForSearch':0 if self.searchbox else 'Infinity',  'multiple':self.uselist, 
        ...
        if request.path[-7:] == '/saform':
            ...
            if request.path[-9:] == '/saformjs':
                ...
                js = [
                 ...
                 '                              var newval = {{label:resp.data[0].{}, value:resp.data[0].{}.toString()}};'.format(labelfield, self.idSrc),
