...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\tests\test_sqlalchemy_helpers.py
# Compiled at: 2018-07-04 05:49:12
...
class SqlalchemyHelpersTest(unittest.TestCase):
    ...
    def make_severalattrs(self):
        f = Faker()
        record = SeveralAttrs(intAttr1=(randint(25, 42)), strAttr2=(f.name()),
          strAttr3=(f.ssn()),
    ...
    def test_update(self):
        ...
        newinst = SeveralAttrs(intAttr1=(oldinst.intAttr1), strAttr2=(oldinst.strAttr2),
          strAttr3=newattr3,
