...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyevolve\GAllele.py
# Compiled at: 2009-01-21 20:10:44
"""
   ...
   """
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            Util.raiseException("An error was occurred while finding allele for the %d position of chromosome.\n           You may consider use the 'homogeneous' parameter of the GAlleles class.\n         " % (index,))
...
class GAlleleRange:
   ...
   """
    ...
    def __init__(self, begin=Consts.CDefRangeMin, end=Consts.CDefRangeMax, real=False):
