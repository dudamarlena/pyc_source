...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyevolve\Statistics.py
   ...
   **fitMax, fitMin, fitAve**
   ...
   """
    ...
    def __init__(self):
        ...
        self.internalDict = {'rawMax': 0.0, 'rawMin': 0.0, 
           'rawAve': 0.0, 
           'rawDev': 0.0, 
           'rawVar': 0.0, 
           'fitMax': 0.0, 
           'fitMin': 0.0, 
           'fitAve': 0.0}
        self.descriptions = {'rawMax': 'Maximum raw score', 'rawMin': 'Minimum raw score', 
