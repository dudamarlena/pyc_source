...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\pyevolve\DBAdapters.py
...
"""
import Consts, sqlite3, logging, types, datetime, Statistics, urllib, csv
...
class DBFileCSV:
   ...
   """
    ...
    def __init__(self, filename=Consts.CDefCSVFileName, identify=None, frequency=Consts.CDefCSVFileStatsGenFreq, reset=True):
...
class DBURLPost:
   ...
   **identify**
   ...
   """
    ...
    def __init__(self, url, identify=None, frequency=Consts.CDefURLPostStatsGenFreq, post=True):
...
class DBSQLite:
   ...
   """
    ...
    def __init__(self, dbname=Consts.CDefSQLiteDBName, identify=None, resetDB=False, resetIdentify=True, frequency=Consts.CDefSQLiteStatsGenFreq, commit_freq=Consts.CDefSQLiteStatsCommitFreq):
