...
# [GCC 8.4.0]
# Embedded file name: /home/ioo/Projets/Django-billjobs/django-billjobs/billjobs/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Bill',
       fields=[
      (
     ...
     migrations.CreateModel(name='BillLine',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name_plural':'Bill Lines', 
     ...
     migrations.CreateModel(name='UserProfile',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
