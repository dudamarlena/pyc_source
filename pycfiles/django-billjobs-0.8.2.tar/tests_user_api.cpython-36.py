...
# [GCC 8.4.0]
# Embedded file name: /home/ioo/Projets/Django-billjobs/django-billjobs/billjobs/tests/tests_user_api.py
# Compiled at: 2017-10-27 10:10:40
# Size of source mod 2**32: 14416 bytes
...
class AnonymousUserAPITest(GenericAPITest):
    ...
    def setUp(self):
        ...
        self.expected_content = {'GET':self.error_message['401'], 
         'POST':{'url':'http://testserver/billjobs/api/1.0/users/6/', 
          'username':'foo', 
          'password':'bar', 
          'email':'foo@bar.org'}, 
...
class UserUserAPITest(GenericAPITest):
    ...
    def setUp(self):
        ...
        self.expected_status = {'GET':200, 
         ...
         'PATCH':403, 
         'DELETE':403}
        self.expected_content = {'GET':{'url':'http://testserver/billjobs/api/1.0/users/3/', 
          'username':'bill', 
...
class UserUserDetailAPITest(GenericAPITest):
    ...
    def setUp(self):
        ...
        self.expected_content = {'GET':{'url':'http://testserver/billjobs/api/1.0/users/3/', 
         ...
         'PUT':{'url':'http://testserver/billjobs/api/1.0/users/3/', 
          'username':'bar', 
          'email':'bill@billjobs.org'}, 
         'HEAD':self.error_message['403'], 
         'OPTIONS':self.error_message['403'], 
...
class AdminUserAPITest(GenericAPITest):
    ...
    def setUp(self):
        ...
        self.expected_status = {'GET':200, 
         ...
         'PATCH':405, 
         'DELETE':405}
        self.expected_length = {'GET':5, 
         'POST':1}
        self.expected_content = {'GET':[
          collections.OrderedDict({'url':'http://testserver/billjobs/api/1.0/users/1/', 
           'username':'superuser', 
           ...
           'is_superuser':True, 
           'groups':[]}),
          collections.OrderedDict({'url':'http://testserver/billjobs/api/1.0/users/2/', 
           'username':'admin', 
           'email':'admin@billjobs.org', 
           'is_staff':True, 
           'is_superuser':False, 
           'groups':[
            'http://testserver/billjobs/api/1.0/groups/1/']}),
          collections.OrderedDict({'url':'http://testserver/billjobs/api/1.0/users/3/', 
           'username':'bill', 
           'email':'bill@billjobs.org', 
           'is_staff':False, 
           'is_superuser':False, 
          ...
          collections.OrderedDict({'url':'http://testserver/billjobs/api/1.0/users/4/', 
           'username':'steve', 
           'email':'steve@billjobs.org', 
           'is_staff':False, 
           'is_superuser':False}),
          collections.OrderedDict({'url':'http://testserver/billjobs/api/1.0/users/5/', 
           'groups':[],  'is_superuser':False, 
           'username':'no-group', 
         ...
         'HEAD':[],  'OPTIONS':{},  'PATCH':self.error_message['405_PATCH'], 
