...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AddField(model_name='userprofile', name='accounting_number', field=models.CharField(max_length=8, null=True, blank=True, validators=[
      billjobs.validators.validate_accounting_number], verbose_name='Accounting number')),
