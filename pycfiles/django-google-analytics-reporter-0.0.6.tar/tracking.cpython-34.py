...
# [GCC 8.4.0]
# Embedded file name: /venv/smoothierecipes/src/django-google-analytics-reporter/google_analytics_reporter/tracking.py
# Compiled at: 2016-10-03 20:22:57
...
class Tracker(object):
    valid_anal_types = ('pageview', 'event', 'social', 'screenview', 'transaction',
                        'item', 'exception', 'timing')
...
class PageView(Tracker):
    ...
    def type_params(self, *args, **kwargs):
        ...
        params = {'t': self.anal_type, 
         'dh': domain or settings.DEFAULT_TRACKING_DOMAIN, 
         'dp': page, 
         'dt': title}
        if label:
            params['el'] = label
