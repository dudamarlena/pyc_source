...
# [GCC 8.4.0]
# Embedded file name: /root/Projects/tenable/nessrest/nessrest/credentials.py
# Compiled at: 2015-09-30 15:55:04
...
class SshUserCert(SshPublicKey):
    ...
    def __init__(self, username, user_cert_filename, private_key_filename, private_key_passphrase):
        ...
        super(SshUserCert, self).__init__(username=username, private_key_filename=private_key_filename, private_key_passphrase=private_key_passphrase)
...
class Oracle(Database):
    ...
    def __init__(self, username, password, oracle_sid, port=1521, oracle_auth_type='SYSDBA'):
        ...
        self.oracle_auth_type = oracle_auth_type
...
class SQLServer(Database):
    ...
    def __init__(self, username, password, db_sid='', port=1433, auth_type='SQL'):
        ...
        self.db_sid = db_sid
        self.sql_server_auth_type = auth_type
