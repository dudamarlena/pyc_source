...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/mtstat/plugins/mtstat_nfs3op.py
# Compiled at: 2006-12-12 18:59:17
import string

class mtstat_nfs3op(mtstat):
    ...
    def __init__(self):
        ...
        info(1, 'Module mtstat_nfs3op is still experimental.')
