...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pythogic/base/utils.py
# Compiled at: 2018-03-16 15:02:41
# Size of source mod 2**32: 2023 bytes
import re
from itertools import chain, combinations
import pythomata.base.DFA, pythomata.base.NFA
...
def _to_pythomata_nfa(nfa: dict) -> pythomata.base.NFA.NFA:
    ...
    res = pythomata.base.NFA.NFA.fromTransitions(Alphabet(nfa['alphabet']), nfa['states'], nfa['initial_states'], nfa['accepting_states'], nfa['transitions'])
    return res


def _to_pythomata_dfa(nfa_dict: dict, minimize=True,
                      trimming=True) -> pythomata.base.DFA.DFA:
