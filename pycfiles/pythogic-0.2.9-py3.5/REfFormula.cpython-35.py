...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pythogic/ref/syntax/REfFormula.py
# Compiled at: 2018-02-24 16:08:06
...
class REfUnion(REfFormula):
    ...
    def _members(self):
        return (
         self.f1, self.operator_symbol, self.f2)
