...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pythogic/fol/semantics/Interpretation.py
...
class Interpretation(object):
    ...
    def __init__(self, alphabet: FOLAlphabet, domain: Set[object], relations: Set[Relation], functions: Set[Function]):
    ...
    def fromRelationsAndFunctions(functions: Set[Function], relations: Set[Relation]):
        ...
        objects_from_relations = set(e for r in relations for t in r.tuples)
        ...
        constants = set(Function(ConstantSymbol(str(o)), {(): o}) for o in domain)
