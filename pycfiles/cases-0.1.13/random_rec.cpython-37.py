...
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/random_rec.py
...
class RandomRec(BaseRatingPrediction):
    ...
    def __init__(self, train_file, test_file, uniform=True, output_file=None, sep='\t', output_sep='\t', random_seed=None):
        ...
        """
        super(RandomRec, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, sep=sep,
