...
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/item_attribute_knn.py
...
class ItemAttributeKNN(ItemKNN):
    ...
    def __init__(self, train_file=None, test_file=None, output_file=None, metadata_file=None, similarity_file=None, k_neighbors=30, as_similar_first=True, metadata_as_binary=False, metadata_similarity_sep='\t', similarity_metric='cosine', sep='\t', output_sep='\t'):
        ...
        """
        super(ItemAttributeKNN, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, k_neighbors=k_neighbors,
