...
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/utils/process_data.py
...
class ReadFile(object):
    ...
    def read(self):
        ...
        dict_file = {'feedback':dict_feedback, 
         'users':list_users, 
         'items':list_items, 
         'sparsity':sparsity, 
    ...
    def read_item_category(self):
        ...
        return [
         dict_category, list_item_category, set_items, dict_item_category]
