...
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/rating_prediction/svd.py
...
class SVD(BaseRatingPrediction):
    ...
    def __init__(self, train_file=None, test_file=None, output_file=None, factors=10, sep='\t', output_sep='\t', random_seed=None):
        ...
        """
        super(SVD, self).__init__(train_file=train_file, test_file=test_file, output_file=output_file, sep=sep, output_sep=output_sep)
