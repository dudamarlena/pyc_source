...
# Embedded file name: build/bdist.linux-x86_64/egg/caserec/recommenders/item_recommendation/base_item_recommendation.py
...
class BaseItemRecommendation(object):
    ...
    def __init__(self, train_file, test_file, output_file=None, as_binary=False, rank_length=10, similarity_metric='cosine', sep='\t', output_sep='\t'):
        """
    ...
    def evaluate(self, metrics, verbose=True, as_table=False, table_sep='\t', n_ranks=None):
        ...
        results = ItemRecommendationEvaluation(verbose=verbose, as_table=as_table, table_sep=table_sep, metrics=metrics,
          n_ranks=n_ranks)
    ...
    def compute(self, verbose=True):
        ...
        if verbose:
            test_info = None
            main_info = {'title':'Item Recommendation > ' + self.recommender_name, 
