...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/py_daemon/py_daemon.py
# Compiled at: 2016-09-24 14:30:17
"""
***
...
class Daemon(object):
    ...
    def __init__(self, pidfile, stdin=os.devnull, stdout=os.devnull, stderr=os.devnull, home_dir='.', umask=18, verbose=1, use_gevent=False):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
