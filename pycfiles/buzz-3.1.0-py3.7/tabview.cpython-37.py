...
# Compiled at: 2019-08-19 16:10:03
# Size of source mod 2**32: 55367 bytes
...
"""
import csv, locale, os, re, string, sys, unicodedata
from collections import Counter
from operator import itemgetter
from subprocess import PIPE, Popen
from textwrap import wrap
import _curses, curses, curses.ascii, io, numpy as np, pandas as pd
...
class TextBox(object):
    __doc__ = 'Display a scrollable text box in the bottom half of the screen.\n\n    '
        ...
        while True:
            try:
                if isinstance(data, str):
                    ...
                    if isinstance(data, (io.IOBase, io.FileIO)):
