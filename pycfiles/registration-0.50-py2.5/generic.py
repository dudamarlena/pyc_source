...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/registration/ormmanager/tests/generic.py
...
class GeneralTests(object):
    ...
    def test_retrieve_multipleKW(self):
        ...
        u = ormmanager.retrieve(User, user_name='bobvilla', email_address='bob@homedepot.com')
        assert len(u) == 1, u
        assert u[0].password == 'toughasnails'
    ...
    def test_retrieve_one_multipleKW(self):
        ...
        u = ormmanager.retrieve_one(User, user_name='bobvilla', email_address='bob@homedepot.com')
        assert isinstance(u, User)
        assert u.password == 'toughasnails'
