...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/registration/ormmanager/sodispatch.py
...
so_retrieve = retrieve.when('issubclass(class_, so.SQLObject)')(so_retrieve)
...
so_retrieve_one = retrieve_one.when('issubclass(class_, so.SQLObject)')(so_retrieve_one)
