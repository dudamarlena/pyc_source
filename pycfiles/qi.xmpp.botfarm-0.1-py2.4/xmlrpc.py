...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/qi/xmpp/botfarm/xmlrpc.py
# Compiled at: 2008-08-11 03:12:24
from twisted.web import server
from twisted.internet import defer
from twisted.web.xmlrpc import XMLRPC
from qi.xmpp.botfarm.logutil import LogEvent, INFO, WARN, ERROR
import qi.xmpp.botfarm.config as config, xmlrpclib
