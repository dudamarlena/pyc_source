...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/qi/xmpp/botfarm/xmlConfig.py
# Compiled at: 2008-08-11 03:10:55
import elementtree.ElementTree as ET, sys, os, qi.xmpp.botfarm.config as config
