...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/hn2016_falwa/qgpv_lwa.py
# Compiled at: 2017-08-28 08:36:56
...
def qgpv_eqlat_lwa(ylat, vort, area, dmu, nlat_s=None, planet_radius=6378000.0):
    """
    Input variables:
