...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/hn2016_falwa/qgpv.py
# Compiled at: 2017-04-18 12:48:20
# Size of source mod 2**32: 2953 bytes
from math import pi, exp
import numpy as np

def compute_qgpv_givenvort(omega, nlat, nlon, kmax, unih, ylat, avort, potential_temp, t0_cn, t0_cs, stat_cn, stat_cs, scale_height=7000.0):
    """
    Input variables:
