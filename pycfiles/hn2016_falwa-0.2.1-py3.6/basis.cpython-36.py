...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/hn2016_falwa/basis.py
# Compiled at: 2017-11-20 23:26:14
# Size of source mod 2**32: 4557 bytes
import numpy as np
from math import pi
...
def lwa(nlon, nlat, vort, q_part, dy, ncforce=None):
    """
    ...
    dy: sequence or array_like
        1-d numpy array of latitudinal differential length element (e.g. dy = cos(lat) d(lat)). Size = nlat.
