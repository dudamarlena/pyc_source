...
# [GCC 8.4.0]
# Embedded file name: /Users/dsupplee/dev/apis-client-generator/src/googleapis/codegen/filesys/library_package.py
...
class LibraryPackage(object):
    ...
    """
        raise NotImplementedError('Subclasses of LibraryPackage must implement StartFile')
