...
# [GCC 8.4.0]
# Embedded file name: /Users/dsupplee/dev/apis-client-generator/src/googleapis/codegen/gwt_generator.py
...
class GwtGenerator(java_generator.BaseJavaGenerator):
    ...
    def __init__(self, discovery, options=None):
        super(GwtGenerator, self).__init__(discovery, 'gwt', GwtLanguageModel(options=options), options=options)
    ...
    def AnnotateMethod(self, api, method, unused_resource):
        ...
        method.SetTemplateValue('className', '%sRequest' % method.values['className'])
...
class GwtLanguageModel(java_generator.JavaLanguageModel):
    ...
    TYPE_FORMAT_TO_DATATYPE_AND_IMPORTS = {('boolean', None): (
                         'Boolean', ImportDefinition(['java.lang.Boolean'])), 
       ('any', None): (
                     'String', ImportDefinition(['java.lang.String'])), 
       ('integer', 'int16'): (
                            'Short', ImportDefinition(['java.lang.Short'])), 
       ('integer', 'int32'): (
                            'Integer',
                            ImportDefinition(['java.lang.Integer'])), 
       ('integer', 'uint32'): (
                             'Long', ImportDefinition(['java.lang.Long'])), 
       ('number', 'double'): (
                            'Double', ImportDefinition(['java.lang.Double'])), 
       ('number', 'float'): (
                           'Float', ImportDefinition(['java.lang.Float'])), 
       ('object', None): (
                        'Splittable',
                        ImportDefinition([
    ...
    def DefaultContainerPathForOwner(self, module):
        ...
        return '%s/api/gwt/services' % ('/').join(utilities.ReversedDomainComponents(module.owner_domain))