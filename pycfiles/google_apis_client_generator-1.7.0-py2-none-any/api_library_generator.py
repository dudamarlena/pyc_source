...
# [GCC 8.4.0]
# Embedded file name: /Users/dsupplee/dev/apis-client-generator/src/googleapis/codegen/api_library_generator.py
...
class ApiLibraryGenerator(TemplateGenerator):
    ...
    def __init__(self, api_loader, discovery, language, language_model=None, options=None):
    ...
    """
        super(ApiLibraryGenerator, self).__init__(language_model=language_model, options=options)
        options = options or {}
    ...
    def GeneratePackage(self, package_writer, path_replacements=None, extra_defines=None):
    ...
    """
        ...
        if self._options.get('include_dependencies'):
            self.WalkTemplateTree('dependencies', self._path_replacements, {}, self._top_level_defines, package_writer)
    ...
    """
        self._path_replacements = {'___package___': self._api.module.path, 
        ...
        if not isinstance(self._api.values['revision'], (unicode, str)):
            self._path_replacements['___api_revision___'] = str(self._api.values['revision'])
    ...
    """
        list_replacements = {'___models_': [
                        'model', api.ModelClasses()], 
           '___topLevelModels_': [
                                'model', api.TopLevelModelClasses()]}
