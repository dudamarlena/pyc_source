...
# [GCC 8.4.0]
# Embedded file name: /Users/dsupplee/dev/apis-client-generator/src/googleapis/codegen/dart_generator.py
...
class DartLanguageModel(language_model.LanguageModel):
    ...
    language = 'dart'
    _SCHEMA_TYPE_TO_DART_TYPE = {'any': 'core.Object', 
       'boolean': 'core.bool', 
       'integer': 'core.int', 
       'long': 'core.int', 
       'number': 'core.double', 
    ...
    array_of_policy = language_model.NamingPolicy(format_string='core.List<{name}>')
    map_of_policy = language_model.NamingPolicy(format_string='core.Map<core.String, {name}>')
...
class DartGenerator(api_library_generator.ApiLibraryGenerator):
    ...
    def __init__(self, discovery, options=None):
        super(DartGenerator, self).__init__(DartApi, discovery, language='dart', language_model=DART_LANGUAGE_MODEL, options=options)
