...
# [GCC 8.4.0]
# Embedded file name: /Users/dsupplee/dev/apis-client-generator/src/googleapis/codegen/template_objects.py
# Compiled at: 2019-02-15 15:39:52
...
class CodeObject(UseableInTemplates):
  ...
  """
    ...
    def __init__(self, def_dict, api, parent=None, wire_name=None, language_model=None):
    ...
    """
        ...
        self._module = None
        if wire_name:
            self.SetTemplateValue('wireName', wire_name, meaning='The name of this object as it appears in the data stream.')
        self.SetParent(parent)
        d = def_dict.get('description')
        if d:
            self.SetTemplateValue('description', self.ValidateAndSanitizeComment(self.StripHTML(d)))
        return
    ...
    @property
    def packageRelativeClassName(self):
    ...
    """
        ...
        full_name += self.values.get('className') or self.values.get('codeName') or self.values.get('name', '')
        return full_name
    ...
    def constantName(self):
        ...
        return self.language_model.ApplyPolicy('constant', self, self.values['wireName'])

    @property
    def memberName(self):
        """Returns a name for this object when used as an class member."""
        return self.language_model.ApplyPolicy('member', self, self.values['wireName'])

    @property
    def getterName(self):
        """Returns a name for the getter of memberName."""
        return self.language_model.ApplyPolicy('getter', self, self.values['wireName'])

    @property
    def setterName(self):
        """Returns a name for the setter of memberName."""
        return self.language_model.ApplyPolicy('setter', self, self.values['wireName'])
    ...
    def unsetName(self):
        ...
        return self.language_model.ApplyPolicy('unset', self, self.values['wireName'])

    @property
    def parameterName(self):
        """Returns a name for this object when used as the parameter to a method."""
        return self.language_model.ApplyPolicy('parameter_name', self, self.values['wireName'])
...
class Module(CodeObject):
  ...
  """
    ...
    def __init__(self, package_path=None, owner_name=None, owner_domain=None, parent=None, language_model=None):
        """Construct a Module.
    ...
    """
        ...
        if not lib_def:
            ...
            return Module(package_path=lib_def.get('modulePath') or lib_def.get('packagePath') or '', owner_name=lib_def.get('owner'), owner_domain=lib_def.get('domain'))
    ...
    def name(self):
        ...
        if not self._name:
            self._name = self.path.replace('/', self.language_model.module_name_delimiter)
        return self._name
...
class Constant(CodeObject):
  ...
  """
    ...
    def __init__(self, value, name=None, description=None, parent=None, language_model=None):
        """Construct a Module.
    ...
    Args:
      ...
      language_model: (LanguageModel) The language we are targetting.
        Dynamically defaults to the parent's language model.
    """
        super(Constant, self).__init__({}, None, parent=parent, language_model=language_model)
        self._value = str(value)
        self.SetTemplateValue('wireName', self._value)
        if description:
            self._description = self.ValidateAndSanitizeComment(self.StripHTML(description))
        else:
