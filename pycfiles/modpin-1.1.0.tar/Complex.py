...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/contacts/Complex.py
...
class Complex(object):
    ...
    def __init__(self, pdb, biomolecule=False, PPI=True, PPI_type='cb', PPI_distance=12, PNI=True, PNI_type='min', PNI_distance=8, PHI=True, PHI_type='min', PHI_distance=6):
        self._pdb = pdb
    ...
    @property
    def PPInterfaces(self):
        return self._PPInterface.values()

    @property
    def PNInterfaces(self):
        return self._PNInterface.values()

    @property
    def PHInterfaces(self):
        return self._PHInterface.values()
    ...
    def _build(self):
        ...
        for biom in structures:
            ...
            total_chains = 0
            if self._PPIdo:
                total_chains += len(protein_chains)
            if self._PNIdo:
                total_chains += len(nucleotide_chains)
