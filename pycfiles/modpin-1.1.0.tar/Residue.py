...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/residue/Residue.py
...
class Residue(object):
    ...
    def all_coordinates(self):
        ...
        if self._backbone_coordinates is not None and self._sidechain_coordinates is not None:
            ...
            if self._sidechain_coordinates is not None:
    ...
    def add_atom(self, atom):
        ...
        """
        if atom.is_backbone:
            self._backbone_atoms.append(atom)
        else:
            self._sidechain_atoms.append(atom)
    ...
    def distance(self, residue, dist_type='min'):
        ...
        """
        if dist_type not in set(['min', 'geometric', 'backbone']):
            dist_type = 'min'
    ...
    def _distance_geometric_center(self, residue):
        ...
        """
        return (
         None, None, sp.distance.euclidean(self.geometric_center, residue.geometric_center))
