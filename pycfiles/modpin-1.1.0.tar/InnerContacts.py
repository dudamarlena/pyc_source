...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/contacts/InnerContacts.py
...
class InnerContacts(object):
    ...
    def __init__(self, pdb, AA=False, AA_type='cb', AA_distance=12, NC=False, NC_type='min', NC_distance=8, HT=True, HT_type='min', HT_distance=6):
        self._pdb = pdb
        self._AAdo = AA
        self._AAcontacts = {}
    ...
    @property
    def AAcontacts(self):
        return self._AAcontacts.values()

    @property
    def NCcontacts(self):
        return self._NCcontacts.values()

    @property
    def HTcontacts(self):
        return self._HTcontacts.values()
