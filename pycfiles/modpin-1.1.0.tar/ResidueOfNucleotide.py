...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/residue/ResidueOfNucleotide.py
...
class ResidueOfNucleotide(Residue):
    ...
    def is_followed(self, residue):
        ...
        if p0 is not None and p1 is not None and o30 is not None and o31 is not None:
            return o30.distance(p1) < o31.distance(p0) and distance <= 7.0
        else:
            return self._backbone_atoms[(-1)].distance(residue._backbone_atoms[0]) < residue._backbone_atoms[(-1)].distance(self._backbone_atoms[0]) and distance <= 7.0
            return