...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/beans/Executable.py
...
class Executable(object):
    ...
    def __init__(self, executable, path=None, variable_path=None):
        ...
        if variable_path is None:
            ...
            elif not self._load_executable_path():
    ...
    def execute(self, stdout=False, silent=False):
        ...
        if self.command is None:
            ...
            p = subprocess.Popen(self.command, stdout=stdoutPIPE, stderr=stderrPIPE)
    ...
    def _load_executable_path(self):
        ...
        if self._path is not None:
            ...
            p = subprocess.Popen(search, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            out, err = p.communicate()
            if out != '':
