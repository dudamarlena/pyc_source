...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/chain/ChainOfNucleotide.py
...
class ChainOfNucleotide(Chain):
    ...
    def full_nucleotide_sequence(self):
        ...
        @rtype: String
        """
        if self.nucleotides[0].number <= 1:
            return self.gapped_nucleotide_sequence()
        seq = ''
        for x in range(self.nucleotides[0].number - 1):
            seq += 'x'
