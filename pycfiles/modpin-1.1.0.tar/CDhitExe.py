...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/external/CDhit/CDhitExe.py
...
class CDhitExe(object):
    ...
    def __init__(self, fasta, threshold, output_dir=None, execute=True):
        ...
        self._exe = Executable(executable=self._configurator.get('cd-hit', 'executable'), path=self._configurator.get('cd-hit', 'path'))
        self._input = fasta
