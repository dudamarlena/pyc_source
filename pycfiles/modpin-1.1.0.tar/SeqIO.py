...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/Pictures/modpin/modpin/./src/functions/SeqIO.py
# Compiled at: 2018-02-02 06:38:57
import math, string, sys, os
protein_letters = 'ACDEFGHIKLMNPQRSTVWYXUBZ'
rna_letters = 'GAUC'
dna_letters = 'GATC'
protein_weights = {'A': 89.09, 'C': 121.16, 'E': 147.13, 'D': 133.1, 'G': 75.07, 'F': 165.19, 'I': 131.18, 'H': 155.16, 
   'K': 146.19, 'M': 149.21, 'L': 131.18, 'N': 132.12, 'Q': 146.15, 'P': 115.13, 'S': 105.09, 
   'R': 174.2, 'T': 119.12, 'W': 204.23, 'V': 117.15, 'Y': 181.19, 'X': 0.0, 'U': 0.0, 
   'B': 0.0, 'Z': 0.0}
...
class IncorrectSequenceLetter(Exception):
    ...
    def __init__(self, letter, class_name):
        super(IncorrectSequenceLetter, self).__init__("The _sequence items: '%s' are not found in the alphabet of class %s\n" % (letter, class_name))
