...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/contacts/contact/ContactAA.py
...
class ContactAA(Contact):
    ...
    def min_distance(self):
        return self._distance['min'][2]

    @property
    def min_atoms(self):
        return self._distance['min'][0:2]

    @property
    def ca_distance(self):
        return self._distance['ca'][2]

    @property
    def ca_atoms(self):
        return self._distance['ca'][0:2]

    @property
    def cb_distance(self):
        return self._distance['cb'][2]

    @property
    def cb_atoms(self):
        return self._distance['cb'][0:2]

    @property
    def geometric_distance(self):
        return self._distance['geometric'][2]

    @property
    def backbone_distance(self):
        return self._distance['backbone'][2]

    @property
    def backbone_atoms(self):
        return self._distance['backbone'][0:2]
    ...
    def _build(self):
        ...
        if float(self._distance[self._threshold_type][2]) <= self._threshold_distance and float(self._distance[self._threshold_type][2]) >= 0:
