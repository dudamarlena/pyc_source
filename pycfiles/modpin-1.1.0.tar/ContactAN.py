...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/contacts/contact/ContactAN.py
...
class ContactAN(Contact):
    ...
    @property
    def cbbackbone_distance(self):
        return self._distance['cbbackbone'][2]

    @property
    def cbbackbone_atoms(self):
        return self._distance['cbbackbone'][0:2]
