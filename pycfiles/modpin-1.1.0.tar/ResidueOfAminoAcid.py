...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/structure/residue/ResidueOfAminoAcid.py
...
class ResidueOfAminoAcid(Residue):
    ...
    def has_full_backbone(self):
        return self._ca is not None and self._c is not None and self._n is not None and self._o is not None
    ...
    def is_followed(self, residue):
        ...
        if c0 is not None and n1 is not None:
            return c0.distance(n1) <= 1.5
        else:
            if ca0 is not None and ca1 is not None:
                return ca0.distance(ca1) <= 4
