...
# [GCC 8.4.0]
# Embedded file name: /home/patricia/patricia/modppi/./src/SBI/external/blast/BlastResult.py
...
class BlastResult(StorableObject):
    ...
    def __init__(self, queryname=None, querylength=0, blastversion=None, blastmatrix=None, gap_open=0, gap_extend=0, blastdb=0, BlastResultFile=None, queryseq=None):
        """
        The BlastResult object contains the data from a single blastpgp XML file.
        ...
        if BlastResultFile != None:
            ...
            self._query = queryname
            self._query_length = int(querylength)
            self._query_sequence = queryseq
            self._version = blastversion
            self._matrix = blastmatrix
    ...
    @property
    def gap_open(self):
        return int(self._gap_open)

    @property
    def gap_extend(self):
        return int(self._gap_extend)
        ...
        if iteration == None:
            ...
            for hit in self._hits:
                if hit.iteration == iteration:
                    if evalue == None or hit.evalue <= float(evalue):
    ...
    def same_blast_version(self, blastObject=None):
        ...
        if self.version == blastObject.version:
            return True
        else:
            return False
    ...
    def same_blast_database(self, blastObject=None):
        ...
        if blastObject == None:
            raise AttributeError('A second object needs to be given for the comparison\n')
        if self.database == blastObject.database:
            return True
        else:
            return False
    ...
    def same_blast_matrix(self, blastObject=None):
        ...
        if blastObject == None:
            raise AttributeError('A second object needs to be given for the comparison\n')
        if self.matrix == blastObject.matrix:
            return True
        else:
            return False
    ...
    def same_blast_iterations(self, blastObject=None):
        ...
        if blastObject == None:
            raise AttributeError('A second object needs to be given for the comparison\n')
        if self.lastiteration == blastObject.lastiteration:
            return True
        else:
            return False
    ...
    def same_blast_gap_properties(self, blastObject=None):
        ...
        if blastObject == None:
            raise AttributeError('A second object needs to be given for the comparison\n')
        if self.gap_open == blastObject.gap_open and self.gap_extend == blastObject.gap_extend:
            return True
        else:
            return False
    ...
    def comparable(self, blastObject=None):
        ...
        if blastObject == None:
            raise AttributeError('A second object needs to be given for the comparison\n')
        if self.same_blast_database(blastObject=blastObject) and self.same_blast_version(blastObject=blastObject) and self.same_blast_matrix(blastObject=blastObject) and self.same_blast_gap_properties(blastObject=blastObject) and self.same_blast_iterations(blastObject=blastObject):
            return True
        else:
            return False
