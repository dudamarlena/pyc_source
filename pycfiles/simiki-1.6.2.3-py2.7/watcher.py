...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-intel/egg/simiki/watcher.py
...
class YAPatternMatchingEventHandler(PatternMatchingEventHandler):
    ...
    def get_ofile(ifile):
        ...
        ofile = os.path.join(_base_path, _site_config['destination'], category, ('{0}.html').format(os.path.splitext(filename)[0]))
        return ofile
    ...
    def generate_catalog():
        ...
        ofile = os.path.join(_base_path, _site_config['destination'], 'index.html')
