...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-fat/egg/apydia/descriptors.py
# Compiled at: 2007-12-05 06:34:31
"""
    Descriptors
    ===========
...
from inspect import ismodule, isclass, isfunction, ismethod, isbuiltin, getmodule, getsourcefile, findsource, getdoc, getcomments, getargspec, formatargspec
...
def _getcomments(value):
    ...
    if comment:
        ...
        for line in comment:
            s = line.lstrip()
            if s:
                indent = min(indent, len(line) - len(s))
...
class Descriptor(object):
    ...
    __module__ = __name__
    represents = 'Object'
    matches = staticmethod(lambda v: True)
    instances = dict()
