...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\strategycontainer\tsp\factors\basic.py
# Compiled at: 2018-01-16 04:44:37
# Size of source mod 2**32: 13081 bytes
"""Simple common factors.
"""
from numbers import Number
from numpy import arange, average, exp, fmax, full, isnan, log, NINF, sqrt, sum as np_sum
from strategycontainer.tsp.data import USEquityPricing
from strategycontainer.utils.input_validation import expect_types
from strategycontainer.utils.math_utils import nanargmax, nanmax, nanmean, nanstd, nansum
from strategycontainer.utils.numpy_utils import float64_dtype, ignore_nanwarnings
...
class Returns(CustomFactor):
    ...
    def _validate(self):
        ...
        if self.window_length < 2:
            raise ValueError("'Returns' expected a window length of at least 2, but was given {window_length}. For daily returns, use a window length of 2.".format(window_length=(self.window_length)))
...
class _ExponentialWeightedFactor(SingleInputMixin, CustomFactor):
    ...
    def from_center_of_mass(cls, inputs, window_length, center_of_mass, **kwargs):
        ...
        return cls(inputs=inputs, 
         window_length=window_length, 
         decay_rate=1.0 - 1.0 / (1.0 + center_of_mass), **kwargs)
