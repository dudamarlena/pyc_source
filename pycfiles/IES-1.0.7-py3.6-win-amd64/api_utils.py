...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\strategycontainer\tsp\api_utils.py
# Compiled at: 2018-01-16 04:18:53
# Size of source mod 2**32: 1664 bytes
"""
Utilities for creating public APIs (e.g. argument validation decorators).
"""
from strategycontainer.utils.input_validation import preprocess
...
def restrict_to_dtype(dtype, message_template):
    ...
    def processor(term_method, _, term_instance):
        ...
        if term_dtype != dtype:
            raise TypeError(message_template.format(method_name=(term_method.__name__),
