...
# Embedded file name: build\bdist.win-amd64\egg\cvrptw_optimization\src\single_depot_column_generation_pulp_inputs.py
# Compiled at: 2020-04-07 14:19:54
# Size of source mod 2**32: 8063 bytes
__doc__ = '\nInput data sets\nCVRPTW formulation\n'
import numpy as np
...
class ModelInputs:
    ...
    def __init__(self, transportation_matrix, customers, depots, vehicles):
        transportation_matrix = transportation_matrix[(transportation_matrix['FROM_LOCATION_NAME'] != transportation_matrix['TO_LOCATION_NAME'])]
    ...
    def create_vertices(self):
        ...
        :return:
        """
        self.vertices = self.depots[['LOCATION_NAME', 'TIME_WINDOW_START', 'TIME_WINDOW_END']].append(self.customers[['LOCATION_NAME', 'TIME_WINDOW_START', 'TIME_WINDOW_END']])
    ...
    def create_transit(self):
        ...
        self.transit_starting_customers_dict = self._create_parameter_dict(self.transportation_matrix_starting_customers, [
         'FROM_LOCATION_NAME', 'TO_LOCATION_NAME'], [
         'DRIVE_MINUTES', 'TRANSPORTATION_COST'])
    ...
    def create_initial_paths(self):
        ...
        for path in self.paths_list:
            self.paths_dict[path[0]] = [
             self.depot_names[0] + '_LEAVE', path[1], self.depot_names[0] + '_ENTER']
