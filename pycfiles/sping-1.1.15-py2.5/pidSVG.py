...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\sping\SVG\pidSVG.py
# Compiled at: 2002-01-21 21:53:04
"""pidSVG

This module implements an SVG Sping canvas.
...
class SVGCanvas(Canvas):
    ...
    def _initOutput(self):
        self._txt = SVG_HEADER + '<svg xml:space="preserve" width="%dpx" height="%dpx">\n' % self.size
    ...
    def drawArc(self, x1, y1, x2, y2, theta1=0, extent=360, edgeColor=None, edgeWidth=None, fillColor=None):
        filling = 0
        if not fillColor:
    ...
    def drawCurve(self, x1, y1, x2, y2, x3, y3, x4, y4, edgeColor=None, edgeWidth=None, fillColor=transparent, closed=0):
