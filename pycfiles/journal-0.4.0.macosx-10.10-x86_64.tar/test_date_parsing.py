...
# [GCC 8.4.0]
# Embedded file name: /Users/mbehrens/.pyenv/versions/2.7.8/lib/python2.7/site-packages/tests/test_date_parsing.py
...
class TestParser(unittest.TestCase):
    ...
    def test_parsing_dates(self):
        dates = [
         '2/6/1977', '02/06/77', '1977-06-02', 'June 2, 1977', 'Jun 2, 1977', '2 June', 'Jun 2']
