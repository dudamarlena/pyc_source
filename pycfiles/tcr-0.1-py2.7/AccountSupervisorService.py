...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\AccountSupervisorService.py
...
class getRSAKey_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (RSAKey, RSAKey.thrift_spec), None),
     (
...
class notifyEmailConfirmationResult_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.MAP, 'parameterMap', (TType.STRING, None, TType.STRING, None), None))
...
class registerVirtualAccount_args:
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'encryptedVirtualUserId', None, None),
     (
      4, TType.STRING, 'encryptedPassword', None, None))
...
class requestVirtualAccountPasswordChange_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'virtualMid', None, None),
     (
      3, TType.STRING, 'encryptedVirtualUserId', None, None),
     (
      4, TType.STRING, 'encryptedOldPassword', None, None),
     (
      5, TType.STRING, 'encryptedNewPassword', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'encryptedVirtualUserId', None, None),
     (
      4, TType.STRING, 'encryptedNewPassword', None, None))
