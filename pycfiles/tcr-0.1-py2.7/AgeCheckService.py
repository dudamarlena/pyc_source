...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\AgeCheckService.py
...
class checkUserAge_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'carrier', None, None),
     (
      3, TType.STRING, 'sessionId', None, None),
     (
      4, TType.STRING, 'verifier', None, None),
     (
      5, TType.I32, 'standardAge', None, None))
...
class checkUserAgeWithDocomo_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'openIdRedirectUrl', None, None),
     (
      3, TType.I32, 'standardAge', None, None),
     (
      4, TType.STRING, 'verifier', None, None))
...
class checkUserAgeWithDocomo_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (AgeCheckDocomoResult, AgeCheckDocomoResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class retrieveRequestToken_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (AgeCheckRequestResult, AgeCheckRequestResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
