...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\UniversalNotificationService.py
...
class notify_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'event', (GlobalEvent, GlobalEvent.thrift_spec), None))
...
class notify_result:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'e', (UniversalNotificationServiceException, UniversalNotificationServiceException.thrift_spec), None))
