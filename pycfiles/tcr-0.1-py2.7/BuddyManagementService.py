...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\BuddyManagementService.py
...
class addBuddyMember_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRING, 'userMid', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.LIST, 'userMids', (TType.STRING, None), None))
...
class commitSendMessagesToAll_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'requestIdList', (TType.STRING, None), None))
...
class commitSendMessagesToAll_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (SendBuddyMessageResult, SendBuddyMessageResult.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRING, 'messageId', None, None))
...
class getBuddyDetailByMid_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (BuddyDetail, BuddyDetail.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getBuddyProfile_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (BuddyProfile, BuddyProfile.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getContactTicket_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Ticket, Ticket.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getSendBuddyMessageResult_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'sendBuddyMessageRequestId', None, None))
...
class getSendBuddyMessageResult_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SendBuddyMessageResult, SendBuddyMessageResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getSetBuddyOnAirResult_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'setBuddyOnAirRequestId', None, None))
...
class getSetBuddyOnAirResult_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SetBuddyOnAirResult, SetBuddyOnAirResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getUpdateBuddyProfileResult_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'updateBuddyProfileRequestId', None, None))
...
class getUpdateBuddyProfileResult_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (UpdateBuddyProfileResult, UpdateBuddyProfileResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRUCT, 'msg', (Message, Message.thrift_spec), None),
     (
      3, TType.STRING, 'sourceContentId', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'sourceContentId', None, None),
     (
      4, TType.LIST, 'mids', (TType.STRING, None), None))
...
class notifyBuddyBlocked_args():
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'blockerMid', None, None))
...
class registerBuddy_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'buddyId', None, None),
     (
      3, TType.STRING, 'searchId', None, None),
     (
      4, TType.STRING, 'displayName', None, None),
     (
      5, TType.STRING, 'statusMeessage', None, None),
     (
      6, TType.STRING, 'picture', None, None),
     (
      7, TType.MAP, 'settings', (TType.STRING, None, TType.STRING, None), None))
  ...
  """
    thrift_spec = (
     ...
     (
      4, TType.STRING, 'displayName', None, None),
     (
      5, TType.STRING, 'statusMessage', None, None),
     (
      6, TType.STRING, 'picture', None, None))
...
class reissueContactTicket_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      3, TType.I64, 'expirationTime', None, None),
     (
      4, TType.I32, 'maxUseCount', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRUCT, 'msg', (Message, Message.thrift_spec), None),
     (
      3, TType.STRING, 'content', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRUCT, 'msg', (Message, Message.thrift_spec), None),
     (
      3, TType.LIST, 'mids', (TType.STRING, None), None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'buddyMid', None, None),
     (
      3, TType.I32, 'notificationStatus', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRUCT, 'messageRequest', (BuddyMessageRequest, BuddyMessageRequest.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.MAP, 'attributes', (TType.STRING, None, TType.STRING, None), None))
                ...
                if fid == 1:
                    ...
                    if ftype == TType.MAP:
                        ...
                        for _i1088 in xrange(_size1084):
                            _key1089 = iprot.readString()
                            _val1090 = iprot.readString()
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRING, 'picture', None, None))
                ...
                if fid == 1:
                    ...
                    if ftype == TType.MAP:
                        ...
                        for _i1097 in xrange(_size1093):
                            _key1098 = iprot.readString()
                            _val1099 = iprot.readString()
        ...
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            ...
            if self.attributes is not None:
                ...
                for kiter1100, viter1101 in self.attributes.items():
                    oprot.writeString(kiter1100)
                    oprot.writeString(viter1101)
        ...
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            ...
            if self.attributes is not None:
                ...
                for kiter1109, viter1110 in self.attributes.items():
                    oprot.writeString(kiter1109)
                    oprot.writeString(viter1110)
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRING, 'image', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'requestId', None, None),
     (
      2, TType.STRING, 'searchId', None, None))
...
class updateBuddySettings_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.MAP, 'settings', (TType.STRING, None, TType.STRING, None), None))
        ...
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            ...
            if self.settings is not None:
                ...
                for kiter1118, viter1119 in self.settings.items():
                    oprot.writeString(kiter1118)
                    oprot.writeString(viter1119)
...
class uploadBuddyContent_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'contentType', None, None),
     (
      3, TType.STRING, 'content', None, None))
