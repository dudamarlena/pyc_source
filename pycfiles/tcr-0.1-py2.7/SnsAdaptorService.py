...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\SnsAdaptorService.py
...
class getSnsFriends_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'snsIdType', None, None),
     (
      3, TType.STRING, 'snsAccessToken', None, None),
     (
      4, TType.I32, 'startIdx', None, None),
     (
...
class getSnsFriends_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SnsFriends, SnsFriends.thrift_spec), None),
     (
...
class getSnsMyProfile_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SnsProfile, SnsProfile.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'snsAccessToken', None, None),
     (
      4, TType.STRING, 'toSnsUserId', None, None))
