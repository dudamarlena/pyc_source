...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\MessageService.py
...
class fetchMessageOperations_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I64, 'localRevision', None, None),
     (
      3, TType.I64, 'lastOpTimestamp', None, None),
     (
      4, TType.I32, 'count', None, None))
...
class fetchMessageOperations_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (MessageOperations, MessageOperations.thrift_spec), None),
     (
...
class getLastReadMessageIds_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'chatId', None, None))
...
class getLastReadMessageIds_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (LastReadMessageIds, LastReadMessageIds.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class multiGetLastReadMessageIds_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.LIST, 'chatIds', (TType.STRING, None), None))
...
class multiGetLastReadMessageIds_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (LastReadMessageIds, LastReadMessageIds.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
