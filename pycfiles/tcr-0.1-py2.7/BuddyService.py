...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\BuddyService.py
...
class findBuddyContactsByQuery_args():
  ...
  """
    thrift_spec = (
     ...
     (
      4, TType.STRING, 'query', None, None),
     (
      5, TType.I32, 'fromIndex', None, None),
     (
      6, TType.I32, 'count', None, None),
     (
      7, TType.I32, 'requestSource', None, None))
...
class findBuddyContactsByQuery_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (BuddySearchResult, BuddySearchResult.thrift_spec)), None),
     (
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'country', None, None),
     (
      4, TType.STRING, 'classification', None, None),
     (
      5, TType.I32, 'fromIndex', None, None),
     (
      6, TType.I32, 'count', None, None))
...
class getBuddyDetail_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      4, TType.STRING, 'buddyMid', None, None))
...
class getBuddyOnAir_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (BuddyOnAir, BuddyOnAir.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'country', None, None),
     (
      4, TType.I32, 'applicationType', None, None),
     (
      5, TType.STRING, 'resourceSpecification', None, None))
...
class getPopularBuddyBanner_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (BuddyBanner, BuddyBanner.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPopularBuddyLists_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (BuddyList, BuddyList.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
