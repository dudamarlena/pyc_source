...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\SpotService.py
...
class lookupByPhoneNumber_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'countryAreaCode', None, None),
     (
...
class lookupByPhoneNumber_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SpotPhoneNumberResponse, SpotPhoneNumberResponse.thrift_spec), None),
     (
...
class lookupNearby_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'location', (Location, Location.thrift_spec), None),
     (
      3, TType.I32, 'category', None, None),
     (
      4, TType.STRING, 'query', None, None),
     (
      5, TType.STRING, 'countryAreaCode', None, None))
...
class lookupNearby_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SpotNearbyResponse, SpotNearbyResponse.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
