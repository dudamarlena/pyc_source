...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\ChannelApplicationProvidedService.py
            ...
            while True:
                ...
                if fid == 0:
                    if ftype == TType.LIST:
                        ...
                        for _i1210 in xrange(_size1206):
...
class removeNotificationStatus_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'notificationStatus', None, None))
