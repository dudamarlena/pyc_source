...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\CallService.py
...
class getUserStatus_result():
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class updateProfileAttributeForChannel_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'profileAttribute', None, None),
     (
      3, TType.STRING, 'value', None, None))
...
class updateExtendedProfileAttribute_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'attr', None, None),
     (
      2, TType.STRUCT, 'extendedProfile', (ExtendedProfile, ExtendedProfile.thrift_spec), None))
...
class getAllSimpleChannelContacts_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.BOOL, 'statusSticonFallbackDisabled', None, None))
...
class getAllSimpleChannelContacts_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (SimpleChannelContact, SimpleChannelContact.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getUserIdentities_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.MAP, 'success', (TType.I32, None, TType.STRING, None), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class markPaidCallAd_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'dialedNumber', None, None),
     (
      3, TType.STRING, 'language', None, None),
     (
      4, TType.BOOL, 'disableCallerId', None, None))
...
class markPaidCallAd_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaidCallDialing, PaidCallDialing.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class isGroupMember_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'groupId', None, None))
...
class getPhoneInfoFromPhoneNumber_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'region', None, None),
     (
      2, TType.STRING, 'phoneNumber', None, None))
...
class getPhoneInfoFromPhoneNumber_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PhoneInfoForChannel, PhoneInfoForChannel.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class redeemPaidCallVoucher_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'serial', None, None),
     (
      3, TType.STRING, 'language', None, None))
...
class redeemPaidCallVoucher_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaidCallRedeemResult, PaidCallRedeemResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPreferredDisplayName_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'mids', (TType.STRING, None), None))
...
class getPreferredDisplayName_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.MAP, 'success', (TType.STRING, None, TType.STRING, None), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getContactsForChannel_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.LIST, 'ids', (TType.STRING, None), None))
...
class getContactsForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (Contact, Contact.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getCallCreditProducts_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'appStoreCode', None, None),
     (
      3, TType.I32, 'pgCode', None, None),
     (
      4, TType.STRING, 'country', None, None),
     (
      5, TType.STRING, 'language', None, None))
...
class getCallCreditProducts_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (CoinProductItem, CoinProductItem.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getCompactContacts_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I64, 'lastModifiedTimestamp', None, None))
...
class getCompactContacts_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (CompactContact, CompactContact.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class notifyNotiCenterEvent_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'event', (NotiCenterEventData, NotiCenterEventData.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'groupId', None, None),
     (
      2, TType.LIST, 'mids', (TType.STRING, None), None))
...
class getRoomInformation_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'roomMid', None, None))
...
class getRoomInformation_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Room, Room.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getGroupCall_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'chatMid', None, None))
...
class getGroupCall_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (GroupCall, GroupCall.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPrimaryClientForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SimpleChannelClient, SimpleChannelClient.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class createRoomWithBuddy_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'reqSeq', None, None),
     (
      2, TType.STRING, 'buddyMid', None, None),
     (
      3, TType.LIST, 'contactIds', (TType.STRING, None), None))
...
class getPaidCallMetadata_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'language', None, None))
...
class getPaidCallMetadata_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaidCallMetadataResult, PaidCallMetadataResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getUserCountryForBilling_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'country', None, None),
     (
      3, TType.STRING, 'remoteIp', None, None))
...
class getFavoriteGroupIdsForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRING, None), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPaidCallHistory_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I64, 'start', None, None),
     (
      3, TType.I32, 'size', None, None),
     (
      4, TType.STRING, 'language', None, None))
...
class getPaidCallHistory_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaidCallHistoryResult, PaidCallHistoryResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class sendPinCodeOperation_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'verifier', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'chatMid', None, None),
     (
      3, TType.LIST, 'memberMids', (TType.STRING, None), None),
     (
      4, TType.I32, 'mediaType', None, None))
...
class getMetaProfile_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (MetaProfile, MetaProfile.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class sendMessageForChannel_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'message', (Message, Message.thrift_spec), None))
...
class sendMessageForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Message, Message.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getCallCreditPurchaseHistory_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'request', (CoinHistoryCondition, CoinHistoryCondition.thrift_spec), None))
...
class getCallCreditPurchaseHistory_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (CoinHistoryResult, CoinHistoryResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class isRoomMember_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'roomId', None, None))
...
class sendSystemOAMessage_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'message', (Message, Message.thrift_spec), None))
...
class acquirePaidCallRoute_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I32, 'paidCallType', None, None),
     (
      3, TType.STRING, 'dialedNumber', None, None),
     (
      4, TType.STRING, 'language', None, None),
     (
      5, TType.STRING, 'networkCode', None, None),
     (
      6, TType.BOOL, 'disableCallerId', None, None),
     (
      7, TType.STRING, 'referer', None, None),
     (
      8, TType.STRING, 'adSessionId', None, None))
...
class acquirePaidCallRoute_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaidCallResponse, PaidCallResponse.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getGroupsForChannel_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'groupIds', (TType.STRING, None), None))
...
class getGroupsForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (Group, Group.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class registerChannelCP_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'cpId', None, None),
     (
      3, TType.STRING, 'registerPassword', None, None))
...
class reserveCallCreditPurchase_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'request', (CoinPurchaseReservation, CoinPurchaseReservation.thrift_spec), None))
...
class reserveCallCreditPurchase_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaymentReservationResult, PaymentReservationResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class acquirePaidCallCurrencyExchangeRate_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (PaidCallCurrencyExchangeRate, PaidCallCurrencyExchangeRate.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPaidCallBalanceList_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (PaidCallBalance, PaidCallBalance.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPersonalInfos_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.SET, 'requiredPersonalInfos', (TType.I32, None), None))
...
class getPrimaryClientsForChannel_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'userMids', (TType.STRING, None), None))
...
class getPrimaryClientsForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (SimpleChannelClient, SimpleChannelClient.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class addBuddyToContact_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'buddyMid', None, None))
...
class addBuddyToContact_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ContactTransition, ContactTransition.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'language', None, None),
     (
      4, TType.STRING, 'referer', None, None))
...
class getExtendedProfile_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ExtendedProfile, ExtendedProfile.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getReverseCompactContacts_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'ids', (TType.STRING, None), None))
...
class getReverseCompactContacts_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.MAP, 'success', (TType.STRING, None, TType.STRUCT, (CompactContact, CompactContact.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getPaidCallAdStatus_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (PaidCallAdResult, PaidCallAdResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class findContactByUseridWithoutAbuseBlockForChannel_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'userid', None, None))
...
class findContactByUseridWithoutAbuseBlockForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Contact, Contact.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class displayBuddySubscriberCountInBulk_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.MAP, 'success', (TType.STRING, None, TType.I64, None), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getProfileForChannel_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Profile, Profile.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getUserTickets_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (UserTicketResponse, UserTicketResponse.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class searchPaidCallUserRate_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'countryCode', None, None),
     (
      3, TType.STRING, 'language', None, None))
...
class searchPaidCallUserRate_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (PaidCallUserRate, PaidCallUserRate.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'chatMid', None, None),
     (
      3, TType.I32, 'mediaType', None, None))
...
class acquireGroupCallRoute_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (GroupCallRoute, GroupCallRoute.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getIdentityCredential_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (IdentityCredential, IdentityCredential.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class addOperationForChannel_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'opType', None, None),
     (
      2, TType.STRING, 'param1', None, None),
     (
      3, TType.STRING, 'param2', None, None),
     (
      4, TType.STRING, 'param3', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.LIST, 'ids', (TType.STRING, None), None),
     (
      2, TType.BOOL, 'statusSticonFallbackDisabled', None, None))
