...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\BotService.py
...
class notifyLeaveGroup_args:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'groupMid', None, None))
...
class getBotUseInfo_args:
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'botMid', None, None))
...
class getBotUseInfo_result:
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (BotUseInfo, BotUseInfo.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class sendChatCheckedByWatermark_args:
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'seq', None, None),
     (
      2, TType.STRING, 'mid', None, None),
     (
      3, TType.I64, 'watermark', None, None),
     (
      4, TType.BYTE, 'sessionId', None, None))
