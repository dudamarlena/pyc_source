...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\AuthService.py
...
class normalizePhoneNumber_args():
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'phoneNumber', None, None),
     (
      4, TType.STRING, 'countryCodeHint', None, None))
    ...
    def __hash__(self):
        ...
        value = value * 31 ^ hash(self.countryCodeHint)
        return value
...
class respondE2EELoginRequest_args():
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRUCT, 'publicKey', (E2EEPublicKey, E2EEPublicKey.thrift_spec), None),
     (
      3, TType.STRING, 'encryptedKeyChain', None, None),
     (
      4, TType.STRING, 'hashKeyChain', None, None),
     (
      5, TType.I32, 'errorCode', None, None))
    ...
    def __hash__(self):
        ...
        value = value * 31 ^ hash(self.encryptedKeyChain)
        value = value * 31 ^ hash(self.hashKeyChain)
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'verifier', None, None),
     (
      2, TType.STRING, 'deviceSecret', None, None))
    ...
    def __hash__(self):
        value = 17
        value = value * 31 ^ hash(self.verifier)
        value = value * 31 ^ hash(self.deviceSecret)
        return value
...
class loginZ_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'loginRequest', (LoginRequest, LoginRequest.thrift_spec), None))
...
class loginZ_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (LoginResult, LoginResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class issueTokenForAccountMigrationSettings_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.BOOL, 'enforce', None, None))
    ...
    def __hash__(self):
        value = 17
        value = value * 31 ^ hash(self.enforce)
        return value
...
class issueTokenForAccountMigrationSettings_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (SecurityCenterResult, SecurityCenterResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class issueTokenForAccountMigration_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'migrationSessionId', None, None))
    ...
    def __hash__(self):
        value = 17
        value = value * 31 ^ hash(self.migrationSessionId)
        return value
...
class verifyQrcodeWithE2EE_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'verifier', None, None),
     (
      3, TType.STRING, 'pinCode', None, None),
     (
      4, TType.I32, 'errorCode', None, None),
     (
      5, TType.STRUCT, 'publicKey', (E2EEPublicKey, E2EEPublicKey.thrift_spec), None),
     (
      6, TType.STRING, 'encryptedKeyChain', None, None),
     (
      7, TType.STRING, 'hashKeyChain', None, None))
