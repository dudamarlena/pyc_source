...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\ChannelService.py
...
class issueOTP_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'channelId', None, None))
...
class issueOTP_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (OTPResult, OTPResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class approveChannelAndIssueChannelToken_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'channelId', None, None))
...
class approveChannelAndIssueChannelToken_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ChannelToken, ChannelToken.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'channelId', None, None),
     (
      2, TType.STRING, 'otpId', None, None))
...
class fetchNotificationItems_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I64, 'localRev', None, None))
...
class fetchNotificationItems_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (NotificationFetchResult, NotificationFetchResult.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class getApprovedChannels_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I64, 'lastSynced', None, None),
     (
      3, TType.STRING, 'locale', None, None))
...
class getApprovedChannels_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ApprovedChannelInfos, ApprovedChannelInfos.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class getChannelInfo_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ChannelInfo, ChannelInfo.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      1, TType.STRING, 'channelId', None, None),
     (
      2, TType.STRING, 'locale', None, None))
...
class getChannelNotificationSetting_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ChannelNotificationSetting, ChannelNotificationSetting.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class getChannelNotificationSettings_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRING, 'locale', None, None))
...
class getChannelNotificationSettings_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.LIST, 'success', (TType.STRUCT, (ChannelNotificationSetting, ChannelNotificationSetting.thrift_spec)), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class getChannels_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ChannelInfos, ChannelInfos.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class getDomains_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ChannelDomains, ChannelDomains.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class getFriendChannelMatrices_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'channelIds', (TType.STRING, None), None))
...
class getFriendChannelMatrices_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (FriendChannelMatricesResponse, FriendChannelMatricesResponse.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class updateChannelSettings_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.STRUCT, 'channelSettings', (ChannelSettings, ChannelSettings.thrift_spec), None))
    ...
    def __hash__(self):
        value = 17
        value = value * 31 ^ hash(self.channelSettings)
        return value
...
class getCommonDomains_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I64, 'lastSynced', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'otpId', None, None),
     (
      3, TType.LIST, 'authScheme', (TType.STRING, None), None),
     (
      4, TType.STRING, 'returnUrl', None, None))
...
class issueRequestTokenWithAuthScheme_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (RequestTokenResponse, RequestTokenResponse.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
  ...
  """
    thrift_spec = (
     ...
     (
      2, TType.STRING, 'channelId', None, None),
     (
      3, TType.STRING, 'otpId', None, None),
     (
      4, TType.STRING, 'redirectUrl', None, None))
...
class getUpdatedChannelIds_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'channelIds', (TType.STRUCT, (ChannelIdWithLastUpdated, ChannelIdWithLastUpdated.thrift_spec)), None))
...
class reserveCoinUse_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'request', (CoinUseReservation, CoinUseReservation.thrift_spec), None),
     (
      3, TType.STRING, 'locale', None, None))
...
class syncChannelData_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ChannelSyncDatas, ChannelSyncDatas.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (ChannelException, ChannelException.thrift_spec), None))
...
class updateChannelNotificationSetting_args():
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.LIST, 'setting', (TType.STRUCT, (ChannelNotificationSetting, ChannelNotificationSetting.thrift_spec)), None))
