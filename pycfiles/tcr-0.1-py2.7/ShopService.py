...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tcr\ShopService.py
...
class buyCoinProduct_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRUCT, 'paymentReservation', (PaymentReservation, PaymentReservation.thrift_spec), None))
...
class buyFreeProduct_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'receiverMid', None, None),
     (
      3, TType.STRING, 'productId', None, None),
     (
      4, TType.I32, 'messageTemplate', None, None),
     (
      5, TType.STRING, 'language', None, None),
     (
      6, TType.STRING, 'country', None, None),
     (
      7, TType.I64, 'packageId', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      7, TType.I64, 'packageId', None, None),
     (
      8, TType.STRING, 'serialNumber', None, None))
...
class checkCanReceivePresent_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.STRING, 'recipientMid', None, None),
     (
      3, TType.I64, 'packageId', None, None),
     (
      4, TType.STRING, 'language', None, None),
     (
      5, TType.STRING, 'country', None, None))
...
class getActivePurchases_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ProductList, ProductList.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getActivePurchaseVersions_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (ProductSimpleList, ProductSimpleList.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getCoinProducts_args():
  ...
  """
    thrift_spec = (
     ...
     (
      3, TType.STRING, 'country', None, None),
     (
      4, TType.STRING, 'language', None, None))
...
class getProduct_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.I64, 'packageID', None, None),
     (
...
class getProduct_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Product, Product.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
...
class getProductList_args():
  ...
  """
    thrift_spec = (
     ...
     None,
     (
      2, TType.LIST, 'productIdList', (TType.STRING, None), None),
     (
      3, TType.STRING, 'language', None, None),
     (
      4, TType.STRING, 'country', None, None))
  ...
  """
    thrift_spec = (
     ...
     (
      4, TType.STRING, 'country', None, None),
     (
      5, TType.STRING, 'carrierCode', None, None))
...
class getTotalBalance_result():
  ...
  """
    thrift_spec = (
     (
      0, TType.STRUCT, 'success', (Coin, Coin.thrift_spec), None),
     (
      1, TType.STRUCT, 'e', (TalkException, TalkException.thrift_spec), None))
