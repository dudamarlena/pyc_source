...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/sipphone/pjsua_lib/Recorder.py
...
class PjsuaRecorder(RecorderAbstractBaseClass):
    ...
    def record_filename(self):
        return self.__record_filename

    @property
    def parsed_record_filename(self):
        return DoorPi().parse_string(self.__record_filename)

    @property
    def last_record_filename(self):
