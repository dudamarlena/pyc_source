...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/status/requirements_lib/req_sipphone.py
# Compiled at: 2016-08-01 11:57:45
import logging
logger = logging.getLogger(__name__)
logger.debug('%s loaded', __name__)
from doorpi.sipphone.AbstractBaseClass import SIPPHONE_SECTION
REQUIREMENT = dict(fulfilled_with_one=True, text_description='Die Aufgabe von einem SIP-Phone innerhalb von DoorPi ist es, die Telefeongespräche (VoIP-Verbindungen) herzustellen. Dazu kann das Sip-Phone entweder mit oder ohne einem SIP-Server (z.B. FritzBox oder Asterisk) zusammen arbeiten.', events=[
 ...
 dict(name='OnRecorderCreated', description='Es wurde eine Recorder erstellt wurde und bereit ist Anrufe aufzuzeichnen.')], configuration=[
 ...
 dict(section=SIPPHONE_SECTION, key='audio_codecs', type='array', default='PCMA,PCMU', mandatory=False, description='Audio-Codecs die aktiviert und genutzt werden können.')], text_links={'linphone.org': {'Übersicht Liblinphone': 'http://www.linphone.org/technical-corner/liblinphone/overview', 
   ...
   'linphone auf wikipedia.de': 'https://de.wikipedia.org/wiki/Linphone'}), pjsua=dict(text_warning='Das SIP-Phone pjsua wird aktuell nicht mehr im DoorPi Projekt unterstützt. Es wird dringend empfohlen auf <a href="{BASE_URL}/help/modules.overview.html?module=sipphone&name=linphone">linphone</a> zu wechseln.', text_description='', text_installation='', text_test='Der Status kann gestestet werden, in dem im Python-Interpreter <code>import {MODULE_NAME}</code> eingeben wird.', text_configuration='', configuration=[], text_links={'Homepage Pjsua': 'http://www.pjsip.org/pjsua.htm', 
