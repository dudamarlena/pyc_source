...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/metadata.py
...
epilog = ("\n    ___                  ___ _\n   /   \\___   ___  _ __ / _ (_)  {project}\n  / /\\ / _ \\ / _ \\| '__/ /_)/ |  version:   {version}\n / /_// (_) | (_) | | / ___/| |  license:   {license}\n/___,' \\___/ \\___/|_| \\/    |_|  URL:       <{url}>\n\nAuthors:    {authors}\nSupporter:  {supporters}\n").format(license=license, project=project, version=version, authors=('\n').join(author_strings), supporters=('\n            ').join(supporters), url=url)
if os.name == 'posix':
