...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/action/SingleActions/mailto.py
    ...
    try:
        ...
        try:
            with open(smtp_snapshot, 'rb') as (snapshot_file):
                ...
                part.add_header('Content-Disposition', 'attachment; filename="%s"' % os.path.basename(smtp_snapshot))
                msg.attach(part)
