...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/action/SingleActions/take_snapshot.py
# Compiled at: 2016-08-01 11:57:45
import logging
from doorpi.action.base import SingleAction
import doorpi, subprocess as sub, os, datetime, glob
...
def get_next_filename(snapshot_path):
    ...
    return os.path.join(snapshot_path, datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '.jpg')
