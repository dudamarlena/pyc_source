...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/status/webserver.py
...
class WebServerFakeRequestAction(SingleAction):
    pass


class WebServerShutdownAction(SingleAction):
    pass


class WebServerInformUrl(SingleAction):
    pass
