...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/doorpi/sipphone/pjsua_lib/Player.py
...
class PjsuaPlayer(PlayerAbstractBaseClass):
    ...
    @property
    def player_filename(self):
        return self.__player_filename

    def __init__(self):
        self.__player_filename = doorpi.DoorPi().config.get_string_parsed(SIPPHONE_SECTION, 'dialtone', '!BASEPATH!/media/ShortDialTone.wav')
