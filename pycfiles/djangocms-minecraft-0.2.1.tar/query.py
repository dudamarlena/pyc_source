...
# [GCC 8.4.0]
# Embedded file name: /home/growlf/django/website/minecraft/query.py
# Compiled at: 2014-08-24 20:19:56
...
class MinecraftQuery:
    ...
    PACKET_TYPE_QUERY = 0
    HUMAN_READABLE_NAMES = dict(game_id='Game Name', gametype='Game Type', motd='Message of the Day', hostname='Server Address', hostport='Server Port', map='Main World Name', maxplayers='Maximum Players', numplayers='Players Online', players='List of Players', plugins='List of Plugins', raw_plugins='Raw Plugin Info', software='Server Software', version='Game Version')
