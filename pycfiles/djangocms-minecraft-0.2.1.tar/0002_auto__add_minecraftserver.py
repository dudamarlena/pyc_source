...
# [GCC 8.4.0]
# Embedded file name: /home/growlf/django/apps/djangocms-minecraft/djangocms_minecraft/migrations/0002_auto__add_minecraftserver.py
# Compiled at: 2014-08-28 10:58:07
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('djangocms_minecraft_minecraftserver', (
         (
        ...
        db.send_create_signal('djangocms_minecraft', ['MinecraftServer'])

    def backwards(self, orm):
        db.delete_table('djangocms_minecraft_minecraftserver')
