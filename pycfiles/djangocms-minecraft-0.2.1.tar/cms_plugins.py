...
# [GCC 8.4.0]
# Embedded file name: /home/growlf/django/apps/djangocms-minecraft/djangocms_minecraft/cms_plugins.py
# Compiled at: 2014-08-31 20:51:54
...
class MinecraftPluginsListPlugin(CMSPluginBase):
    ...
    def render(self, context, instance, placeholder):
        ...
        context['plugins'] = status['plugins']
        context['instance'] = instance
        return context
