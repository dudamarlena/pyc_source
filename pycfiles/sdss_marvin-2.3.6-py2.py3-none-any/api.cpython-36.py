...
# Size of source mod 2**32: 12356 bytes
...
class BrainInteraction(object):
    __doc__ = ' This class defines convenience wrappers for the Brain RESTful API '
    ...
    def _checkResponse(self, response):
        ...
        try:
            ...
            if not isbad is None:
                raise AssertionError('Http status code should not be bad')
            else:
