...
# Size of source mod 2**32: 16453 bytes
...
class ReadOnlyBeanDbPersister(DbPersister):
    ...
    select_name = field(default=None)
    select_name: str
    select_by_id = field(default=None)
    select_by_id: str
    select_exists = field(default=None)
    select_exists: str
    row_factory = field(default='tuple')
    row_factory: str
...
class InsertableBeanDbPersister(ReadOnlyBeanDbPersister):
    ...
    insert_name = field(default=None)
    insert_name: str
...
class UpdatableBeanDbPersister(InsertableBeanDbPersister):
    ...
    update_name = field(default=None)
    update_name: str
    delete_name = field(default=None)
    delete_name: str
...
class BeanDbPersister(UpdatableBeanDbPersister):
    __doc__ = "A class that contains the remaining CRUD funtionality the super class\n    doesn't have.\n\n    :param update_name: the name of the SQL entry used to update data/class\n                        instance\n    "
    keys_name = field(default=None)
    keys_name: str
    count_name = field(default=None)
    count_name: str
