...
# Embedded file name: /home/uros/Projects/BrickBreaker/BrickBreaker/ball.py
# Compiled at: 2017-12-16 06:06:33
...
class Ball(GameObject):
    ...
    def change_direction(self, game_object):
        ...
        if object_position[1] + object_size[1] > position[1] > object_position[1]:
            if object_position[0] + object_size[0] > position[0] > object_position[0]:
                self.set_position((position[0], object_position[1] + object_size[1]))
                self._direction[1] *= -1
        if object_position[1] + object_size[1] > position[1] + size[1] > object_position[1] and object_position[0] + object_size[0] > position[0] > object_position[0]:
            self.set_position((position[0], object_position[1] - object_size[1]))
            self._direction[1] *= -1
        else:
            if object_position[0] + object_size[0] > position[0] + size[0] > object_position[0]:
