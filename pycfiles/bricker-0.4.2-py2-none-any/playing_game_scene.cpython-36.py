...
# Embedded file name: /home/uros/Projects/BrickBreaker/BrickBreaker/Scenes/playing_game_scene.py
# Compiled at: 2017-12-16 06:08:09
...
class PlayingGameScene(Scene):
    ...
    def render(self):
        ...
        self.add_text(f"Bonus: x{str(game.get_bonus())}", x=(GameConstants.SCREEN_SIZE[0] - 100), y=(GameConstants.SCREEN_SIZE[1] - 30),
          size=30)
