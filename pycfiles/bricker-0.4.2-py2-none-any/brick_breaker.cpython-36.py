...
# Embedded file name: /home/uros/Projects/BrickBreaker/BrickBreaker/brick_breaker.py
# Compiled at: 2017-12-17 14:08:23
...
class BrickBreaker:
    ...
    def __init__(self):
        ...
        self._pad = Pad((GameConstants.SCREEN_SIZE[0] / 2,
         GameConstants.SCREEN_SIZE[1] - GameConstants.PAD_SIZE[1]), pygame.image.load(GameConstants.PAD_IMAGE))
        self._balls = [
    ...
    def double_pad(self):
        ...
        self._pad = DoublePad((GameConstants.SCREEN_SIZE[0] / 2,
         GameConstants.SCREEN_SIZE[1] - GameConstants.DOUBLE_PAD_SIZE[1]), pygame.image.load(GameConstants.DOUBLE_PAD_IMAGE))
        if keyboard:
