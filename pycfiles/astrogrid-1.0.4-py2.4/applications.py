...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-9.6.0-i386/egg/astrogrid/applications.py
# Compiled at: 2008-03-28 06:36:46
"""
...
class Applications:
    ...
    def submit(self, server=None, validate=True):
        ...
        if validate:
            self.applications.validate(doc)
        if not server:
...
class DSA:
    ...
    def __init__(self, service):
        ...
        self.formats = {'votable': 'VOTABLE', 'votbin': 'VOTABLE-BINARY', 'csv': 'COMMA-SEPARATED'}
        return
