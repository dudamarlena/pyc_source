...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-9.6.0-i386/egg/astrogrid/__init__.py
# Compiled at: 2008-10-07 07:05:08
"""
...
import getpass, signal, os, sys, time, xmlrpclib, socket
from threadmethod import threadmethod
from SimpleXMLRPCServer import SimpleXMLRPCServer
import urllib2, urlparse, tempfile, logging, exceptions
...
class PlasticServer:
    ...
    def start(self):
        ...
        msg = ['ivo://votech.org/info/getName', 'ivo://votech.org/votable/loadFromURL', 'ivo://votech.org/info/getIconURL', 'ivo://votech.org/votable/load']
        self.hub = self._acr.plastic.hub
        self.id = self.hub.registerXMLRPC('Python', msg, 'http://%s:%s' % (ipaddr, port))
        try:
    ...
    def loadFromURL(self, sender, message, url):
        ...
        self.data.append([acr.plastic.hub.getName(sender), url, urllib2.urlopen(url).read()])
        return True
