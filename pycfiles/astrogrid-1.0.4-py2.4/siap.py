...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-9.6.0-i386/egg/astrogrid/siap.py
# Compiled at: 2008-10-30 10:21:53
"""
...
class SiapSearch:
    ...
    @watcherrors
    def execute(self, ra, dec, radius, format='ALL', pars=None, saveAs=None, clobber=False, saveDatasets=None):
        """
