...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-9.6.0-i386/egg/astrogrid/stap.py
...
class StapSearch:
    ...
    @watcherrors
    def execute(self, start, end, format='ALL', saveAs=None, clobber=False, saveDatasets=None):
        """
