...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-9.6.0-i386/egg/astrogrid/VOTable.py
# Compiled at: 2007-03-23 05:44:46
...
class VOTable(VOXML):
    ...
    def __getitem__(self, namecol):
        idx = self.getColumnIdx(namecol)
        rows = self.getDataRows()
        return [ self.getData(row)[idx] for row in rows ]
