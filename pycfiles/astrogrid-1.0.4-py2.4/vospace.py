...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-9.6.0-i386/egg/astrogrid/vospace.py
# Compiled at: 2008-03-28 09:45:45
"""
...
class VOSpace:
    """
        Perform operations in VOSpace.
        
          >>> from astrogrid import VOSpace
          >>> m = VOSpace()
          >>> m.ls()    # list contents
    ...
    def __init__(self):
        ...
        self.vospace = acr.astrogrid.myspace
    ...
    def ls(self, directory=None, pprint=False, recursive=False, depth=0):
        ...
        for n in nl:
            ...
            if pprint:
                ...
                if recursive and ni['folder']:
                    self.ls(n, pprint, recursive, depth + 1)
