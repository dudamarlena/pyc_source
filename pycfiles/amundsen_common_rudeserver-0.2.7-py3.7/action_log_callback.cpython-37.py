...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/amundsen_common/log/action_log_callback.py
...
def register_post_exec_callback(action_log_callback: Callable[(..., Any)]) -> None:
    """
