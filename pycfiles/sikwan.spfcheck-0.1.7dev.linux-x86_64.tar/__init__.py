...
# [GCC 8.4.0]
# Embedded file name: /home/sikwan/.pyenv/versions/2.6.8/lib/python2.6/site-packages/sikwan/spfcheck/__init__.py
# Compiled at: 2013-11-21 05:54:33
import re, dns
...
class SPFCheck:
    ...
    def process_spf(cls, spf, ip, domain, inc_index=0):
        ...
        return (
         'None', '%s does not match any rules.' % ip)
            ...
            if rule[:3] == 'ptr':
                ...
                if reg.group('domain') is not None:
                    ...
                    try:
                        ...
                        for returned_ip in answers:
                            return (
                             action, '%s match rule %s' % (domain, rule))
