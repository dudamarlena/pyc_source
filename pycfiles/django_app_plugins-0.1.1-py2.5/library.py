...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/app_plugins/library.py
...
class Library(object):
    ...
    def plugin(self, call=None, **options):
        if not callable(call) and cal is not None:
            ...
            point_app = ''
        return _register(self, self.plugin_calls, point_app, options, False, call)
