...
# [GCC 8.4.0]
# Embedded file name: /root/droopescan/dscan/plugins/drupal.py
...
class Drupal(BasePlugin):
    ...
    def update_version_check(self):
        ...
        """
        return ua.github_tags_newer('drupal/drupal/', self.versions_file, update_majors=self.update_majors)

    def update_version(self):
        """
        @return: updated VersionsFile
        """
        gr, versions_file, new_tags = ua.github_repo_new('drupal/drupal/', 'drupal/drupal', self.versions_file, self.update_majors)
        hashes = {}
