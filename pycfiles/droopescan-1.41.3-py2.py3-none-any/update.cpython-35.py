...
# [GCC 8.4.0]
# Embedded file name: /root/droopescan/dscan/plugins/update.py
...
import dscan.common.plugins_util as pu, sys, dscan
    ...
    class Meta:
        ...
        arguments = [
         (
          [
           '--skip-version'],
          dict(action='store_true', help='Skip version updates.', required=False, default=None)),
         (
          [
           '--skip-modules'],
          dict(action='store_true', help='Skip module updates.', required=False, default=None)),
         (
          [
           '--update', '-u'],
          dict(action='store', help='Run update for only this module', required=False, default=None))]
        ...
        if must_update:
            ...
            with open(plugin.versions_file, 'w') as (f):
                ...
                if self.is_valid(new_xml):
                    ...
                    self.msg('Prevented write of invalid XML %s' % new_xml)
