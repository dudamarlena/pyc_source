...
# [GCC 8.4.0]
# Embedded file name: /root/droopescan/dscan/plugins/wordpress.py
...
import dscan.common.update_api as ua, dscan.common.versions, requests
...
class Wordpress(BasePlugin):
    ...
    interesting_urls = [
     ('readme.html', "This CMS' default changelog.")]
    ...
    def update_version_check(self):
        ...
        """
        return ua.github_tags_newer('wordpress/wordpress/', self.versions_file, update_majors=self.update_majors)

    def update_version(self):
        """
        @return: updated VersionsFile
        """
        gr, versions_file, new_tags = ua.github_repo_new('wordpress/wordpress/', 'wordpress/wordpress/', self.versions_file, self.update_majors)
        hashes = {}
    ...
    def update_plugins(self):
        base_data = open(dscan.PWD + 'plugins/wordpress/base_api_request.txt').read()
