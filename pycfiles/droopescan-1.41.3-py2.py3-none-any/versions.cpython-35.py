...
class VersionsFile:
    ...
    def version_exists(self, file, check_version, expected_hash):
        ...
        for version in versions:
            nb = version.attrib['nb']
            hsh = version.attrib['md5']
            if nb == check_version and hsh == expected_hash:
                return True
