...
# [GCC 8.4.0]
# Embedded file name: /root/droopescan/dscan/common/output.py
# Compiled at: 2019-06-14 01:34:00
# Size of source mod 2**32: 5928 bytes
from __future__ import print_function
from dscan.common.functions import template, strip_whitespace, result_anything_found
...
class StandardOutput:
    ...
    def result(self, result, functionality):
        ...
        for enumerate in result:
            if not enumerate == 'host':
                if enumerate == 'cms_name':
                    pass
                else:
                    ...
                    template_params = {'noun': enumerate, 
    ...
    def fatal(self, msg):
        ...
        """
        if not self.log_to_file:
            msg = strip_whitespace(colors['red'] + '[+] ' + msg + colors['endc'])
        else:
            msg = '[' + time.strftime('%c') + '] ' + msg
