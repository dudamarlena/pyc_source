...
# [GCC 8.4.0]
# Embedded file name: /root/droopescan/dscan/common/release_api.py
# Compiled at: 2019-06-14 16:43:11
# Size of source mod 2**32: 3547 bytes
from __future__ import print_function
from distutils.util import strtobool
import dscan.common.functions as f, dscan, os.path, subprocess, sys, tempfile
CHANGELOG = './CHANGELOG'
...
def changelog_modify():
    ...
    version_nb = get_input('Version number (prev %s):' % prev_version_nb)
