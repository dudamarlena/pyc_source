...
# [GCC 8.4.0]
# Embedded file name: /root/droopescan/dscan/plugins/joomla.py
...
import dscan.common.update_api as ua, dscan.common.versions
...
class Joomla(BasePlugin):
    ...
    def update_version_check(self):
        ...
        """
        return ua.github_tags_newer('joomla/joomla-cms/', self.versions_file, update_majors=self.update_majors)

    def update_version(self):
        """
        @return: updated VersionsFile
        """
        gr, versions_file, new_tags = ua.github_repo_new('joomla/joomla-cms/', 'joomla/joomla-cms/', self.versions_file, self.update_majors)
        hashes = {}
