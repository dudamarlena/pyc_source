...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/zhihu/activity.py
# Compiled at: 2016-09-17 11:38:58
# Size of source mod 2**32: 7408 bytes
...
class Activity:
    __doc__ = '用户动态类，请使用Author.activities获取.'
    ...
    def __find_post(self, act):
        ...
        return Post(post_url, column, author, post_title, post_upvote_num, post_comment_num, session=self._session)

    def _assemble_create_post(self, act):
        return self._Activity__find_post(act)
    ...
    def _assemble_follow_question(self, act):
        return Question(Zhihu_URL + act.div.a['href'], act.div.a.text.strip(), session=self._session)
    ...
    def _get_assemble_method(self, act_type):
        assemble_methods = {ActType.UPVOTE_POST: self._assemble_voteup_post, 
