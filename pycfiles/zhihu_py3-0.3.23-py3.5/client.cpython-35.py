...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/zhihu/client.py
# Compiled at: 2016-09-12 06:54:34
# Size of source mod 2**32: 9167 bytes
import getpass, importlib, json, time
from urllib.parse import urlencode
import requests
from .common import *

class ZhihuClient:
    __doc__ = '知乎客户端类，内部维护了自己专用的网络会话，可用cookies或账号密码登录.'
    ...
    def me(self):
        ...
        name = json_data['name']
        motto = json_data['bio']
        photo = json_data['avatar']['template'].format(id=json_data['avatar']['id'], size='r')
