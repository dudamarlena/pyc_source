...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.5/site-packages/bankpassweb/webresults.py
# Compiled at: 2008-01-28 10:56:08
...
class Transaction(object):
    ...
    def _get_item_summary(self, attr, desc):
        ...
        elif not isinstance(summary, basestring) and hasattr(summary, '__class__'):
            try:
