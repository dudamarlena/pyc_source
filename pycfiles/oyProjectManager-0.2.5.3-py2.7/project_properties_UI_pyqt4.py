...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/oyProjectManager/ui/project_properties_UI_pyqt4.py
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.code_lineEdit, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.resolution_comboBox, 3, 2, 1, 1)
        self.fps_label = QtGui.QLabel(self.tab)
        self.fps_label.setObjectName(_fromUtf8('fps_label'))
        self.gridLayout.addWidget(self.fps_label, 4, 0, 1, 1)
        self.label = QtGui.QLabel(self.tab)
        self.label.setObjectName(_fromUtf8('label'))
        self.gridLayout.addWidget(self.label, 2, 0, 1, 1)
        self.clients_comboBox = QtGui.QComboBox(self.tab)
        self.clients_comboBox.setEditable(True)
        self.clients_comboBox.setObjectName(_fromUtf8('clients_comboBox'))
        self.gridLayout.addWidget(self.clients_comboBox, 2, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate('Dialog', 'Client', None, QtGui.QApplication.UnicodeUTF8))
