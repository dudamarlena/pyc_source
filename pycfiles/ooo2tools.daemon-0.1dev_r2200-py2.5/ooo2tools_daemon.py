...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/ooo2tools/daemon/ooo2tools_daemon.py
# Compiled at: 2009-02-26 13:19:58
...
def check_share():
    ...
    for item in files:
        if item + '.lock' not in files and item + '.processed' not in files and isdir(item):
