...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/kleio/prov.py
# Compiled at: 2016-07-28 09:35:49
# Size of source mod 2**32: 56445 bytes
from rdflib import Literal, BNode, Namespace, URIRef, Graph, Dataset, RDF, RDFS, XSD
import rdflib.resource
__author__ = 'szednik'
PROV = Namespace('http://www.w3.org/ns/prov#')
context = {'prov': 'http://www.w3.org/ns/prov#',  'rdf': 'http://www.w3.org/1999/02/22-rdf-syntax-ns#', 
 'rdfs': 'http://www.w3.org/2000/01/rdf-schema#', 
 'xsd': 'http://www.w3.org/2001/XMLSchema#'}
ds = Dataset(default_union=True)
ds.bind('prov', PROV)
default_graph = ds
config = {'useInverseProperties': False, 
...
class Activity(Resource):
    ...
    def get_was_influenced_by(self):
        ...
        """
        return [
         self.graph.objects(self.identifier, PROV.influenced)]
