...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/MangaCrawler/MangaSite.py
# Compiled at: 2017-04-24 15:42:43
...
"""
  ...
  10/2016
"""
import re, http.client, urllib.request, urllib.parse, urllib.error, base64
...
class MangaSite:
    ...
    @staticmethod
    def trim(string):
        return unidecode(re.sub('\\W+', '', re.sub('\\([^)]*\\)', '', string.lower()).strip()))
