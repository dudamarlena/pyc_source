...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/nonocaptcha/launcher.py
# Compiled at: 2019-02-17 16:33:22
...
class Launcher(launcher.Launcher):
    __doc__ = 'Chrome parocess launcher class.'
    ...
    def __init__(self, options, **kwargs) -> None:
        ...
        self.cmd = [
         self.exec] + self.chrome_args

    async def launch(self):
        self.chromeClosed = False
        self.connection = None
        env = self.options.get('env')
        self.proc = await (asyncio.subprocess.create_subprocess_exec)(*self.cmd, stdout=asyncio.subprocess.DEVNULL, 
        ...
        return await Browser.create(self.connection, self.options, self.proc, self.killChrome)
    ...
    async def _get_ws_endpoint(self) -> str:
        ...
        while 1:
            ...
            raise BrowserError('Browser closed unexpectedly:\n{}'.format(await self.proc.stdout.read().decode()))
