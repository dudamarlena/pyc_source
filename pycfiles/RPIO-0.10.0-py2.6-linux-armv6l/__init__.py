...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv6l/egg/RPIO/__init__.py
...
GPIO_LIST_R2 = (2, 3, 4, 7, 8, 9, 10, 11, 14, 15, 17, 18, 22, 23, 24, 25, 27, 28, 29,
                30, 31)
HEADER_P5 = 1280
...
def sysinfo():
    ...
    return (
     RPI_REVISION_HEX,) + MODEL_DATA[RPI_REVISION_HEX.lstrip('0')]


def version():
    """ Returns a tuple of (VERSION, VERSION_GPIO) """
    return (
     VERSION, VERSION_GPIO)
...
def add_interrupt_callback(gpio_id, callback, edge='both', pull_up_down=PUD_OFF, threaded_callback=False, debounce_timeout_ms=None):
    ...
    """
    _rpio.add_interrupt_callback(gpio_id, callback, edge, pull_up_down, threaded_callback, debounce_timeout_ms)
