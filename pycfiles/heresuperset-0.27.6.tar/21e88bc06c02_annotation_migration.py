...
# [GCC 8.4.0]
# Embedded file name: /Users/moretti/PycharmProjects/incubator-superset/superset/migrations/versions/21e88bc06c02_annotation_migration.py
        ...
        if layers:
            ...
            for layer in layers:
                new_layers.append({'annotationType': 'INTERVAL', 
                   ...
                   'show': True, 
                   'overrides': {'since': None, 'until': None}, 'value': layer, 
                   'width': 1, 
                   'sourceType': 'NATIVE'})
