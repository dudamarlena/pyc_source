...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/robograph/datamodel/nodes/serializer.py
# Compiled at: 2016-07-13 17:51:17
import json, cloudpickle, jsonpickle
...
class NodeSerializer:
    ...
    def to_dict(cls, node):
        ...
        return {'class': str(node.__class__), 'name': node._name, 
           'params': params, 
...
class GraphSerializer:
    ...
    def to_dict(cls, graph):
        ...
        for edge in graph.edges:
            ...
            result['edges'].append(dict(id_node_from=id_node_from, id_node_to=id_node_to, output_label=edge['output_label']))
    ...
    def deserialize(cls, json_string):
        ...
        try:
            ...
            for e in graph_dict['edges']:
                result.connect(nodes[e['id_node_from']], nodes[e['id_node_to']], e['output_label'])
