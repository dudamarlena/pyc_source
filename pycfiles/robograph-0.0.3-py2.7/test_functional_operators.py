...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/robograph/datamodel/tests/test_functional_operators.py
...
def test_reverse_sorter():
    ...
    assert instance.requirements == expected_reqs
    instance.input(dict(reverse_sorting_function=reverse_sorting_function, sequence=seq))
    instance.set_output_label('any')
    assert instance.output() == expected_seq
