...
# [GCC 8.4.0]
# Embedded file name: /Users/john/runscope/requests-runscope/requests_runscope/runscope_adapter.py
# Compiled at: 2014-02-14 18:10:28
"""
runscope_adapter.py
~~~~~~~~~~
...
class RunscopeAdapter(HTTPAdapter):
    ...
    def proxify(self, original_url, bucket_key, gateway_host='runscope.net'):
        ...
        if gateway_host in original_url:
            return (
             original_url, port if parts.port else None)
