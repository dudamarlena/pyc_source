...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/picalo/lib/pyExcelerator/ExcelFormulaParser.py
...
class Parser(antlr.LLkParser):
    ...
    def primary(self, arg_type):
        ...
        if False:
            ...
            if func_tok.text.upper() in std_func_by_name:
                (opcode, min_argc, max_argc, func_type, arg_type_list, volatile_func) = std_func_by_name[func_tok.text.upper()]
            else:
    ...
    def expr_list(self, arg_type_list, min_argc, max_argc):
        ...
        if False:
            ...
            if la1 and la1 in [TRUE_CONST, FALSE_CONST, STR_CONST, NUM_CONST, INT_CONST, NAME, SUB, LP, REF2D]:
                self.expr(arg_type)
                arg_cnt += 1
                while True:
