...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/picalo/Project.py
# Compiled at: 2011-03-14 12:27:47
from picalo import check_valid_table
from Error import error
from Table import Table
import types, os, os.path, transaction, ZODB.DB, ZODB.FileStorage.FileStorage, persistent
