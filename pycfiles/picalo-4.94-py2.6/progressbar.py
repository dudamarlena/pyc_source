...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/picalo/lib/progressbar.py
...
class ProgressBarWidgetHFill(object):
    r"""This is a variable width element of ProgressBar formatting.
...
if __name__ == '__main__':
    ...
    def example1():
        widgets = [
         'Test: ', Percentage(), ' ', Bar(marker=RotatingMarker()),
