...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsmclient/v1/vsms.py
...
class VolumeManager(base.ManagerWithFind):
    ...
    def create(self, size, snapshot_id=None, source_volid=None, display_name=None, display_description=None, vsm_type=None, user_id=None, project_id=None, availability_zone=None, metadata=None, imageRef=None):
        """
        Create a vsm.
        ...
        body = {'vsm': {'size': size, 'snapshot_id': snapshot_id, 
    ...
    def list(self, detailed=True, search_opts=None):
        ...
        if detailed:
            detail = '/detail'
        ret = self._list('/conductor%s%s' % (detail, query_string), 'conductor')
        return ret
