...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsmclient/utils.py
# Compiled at: 2016-06-13 14:11:03
import os, re, sys, uuid, six, prettytable
...
def add_arg(f, *args, **kwargs):
    ...
    if not hasattr(f, 'arguments'):
        f.arguments = []
    if (
     args, kwargs) not in f.arguments:
...
def find_resource(manager, name_or_id):
    ...
    try:
        ...
        msg = "Multiple %s matches found for '%s', use an ID to be more specific." % (
