...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsmclient/openstack/common/jsonutils.py
...
This module provides a few things:
    ...
    is available.
"""
import datetime, functools, inspect, itertools, json, types, xmlrpclib, six
...
_nasty_type_tests = [
 ...
 inspect.isabstract]
_simple_types = (
 types.NoneType, int, basestring, bool, float, long)
