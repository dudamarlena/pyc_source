...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsmclient/v1/storage_groups.py
...
class StorageGroupsManager(base.ManagerWithFind):
    ...
    def list(self, detailed=False, search_opts=None):
        ...
        if detailed:
            detail = '/detail'
        ret = self._list('/storage_groups%s%s' % (detail, query_string), 'storage_groups')
        return ret
