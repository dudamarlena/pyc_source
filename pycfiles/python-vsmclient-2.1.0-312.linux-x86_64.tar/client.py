...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vsmclient/v1/client.py
...
class Client(object):
    ...
    def __init__(self, username, api_key, project_id=None, auth_url='', insecure=False, timeout=None, tenant_id=None, proxy_tenant_id=None, proxy_token=None, region_name=None, endpoint_type='publicURL', extensions=None, service_type='vsm', service_name=None, vsm_service_name=None, retries=None, http_log_debug=False, cacert=None):
        password = api_key
        ...
        self.client = client.HTTPClient(username, password, project_id, auth_url, insecure=insecure, timeout=timeout, tenant_id=tenant_id, proxy_token=proxy_token, proxy_tenant_id=proxy_tenant_id, region_name=region_name, endpoint_type=endpoint_type, service_type=service_type, service_name=service_name, vsm_service_name=vsm_service_name, retries=retries, http_log_debug=http_log_debug, cacert=cacert)
