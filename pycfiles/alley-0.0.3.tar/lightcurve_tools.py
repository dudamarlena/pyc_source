...
# Embedded file name: /Users/mx/Dropbox (MIT)/Science/Code/exoworlds/lightcurves/lightcurve_tools.py
# Compiled at: 2018-11-19 15:27:10
...
def plot_phase_folded_lightcurve(time, flux, period, epoch, ax=None, xlim=[-0.25, 0.75], dt=0.02, ferr=None, ferr_type='medsig', ferr_style='sem', normalize=True, title='', period_factor=1.0):
    if ax is None:
        fig, ax = plt.subplots()
    if normalize:
...
def plot_phase_folded_lightcurve_dic(ax, dic, obj_id=None, ferr_type='medsig', ferr_style='std', period_factor=1.0):
