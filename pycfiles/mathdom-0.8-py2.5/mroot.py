...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mathml/pmathml/mroot.py
# Compiled at: 2003-10-22 11:16:52
from element import *
from mrow import *
import math
...
class MRoot(Element):
    ...
    def _layout(self, base, index=None):
        (self.base_width, self.base_height, base_axis) = self.row_strategy.layout(base)
        self.spacing = self.font_size / 10
        self.v_width = max(self.base_height * 0.1, self.font_size / 2)
        ...
        if index is not None:
            ...
            self.index_x = self.v_start + self.v_width * 0.6
        ...
        self.width = self.v_start + self.v_width + self.spacing * 2 + self.base_width
    ...
    def draw(self):
        ...
        self.plotter.lineto(self.v_start + self.v_width + self.spacing * 2 + self.base_width, top_line_y)
