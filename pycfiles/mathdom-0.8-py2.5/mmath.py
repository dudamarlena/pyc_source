...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/mathml/pmathml/mmath.py
# Compiled at: 2003-10-10 11:08:19
from element import *
from mrow import MRow
_default_math_attributes = {'fontsize': '12pt', 
   'scriptlevel': '0', 
...
class Math(Element):
    ...
    def update(self):
        ...
        if display == 'inline':
            ...
            raise ValueError("<math> display attribute must be 'block' or 'inline', not '%s'" % display)
