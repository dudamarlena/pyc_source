...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/photologue/utils/EXIF.py
...
EXIF_TAGS = {256: (
   ...
   41990: (
         'SceneCaptureType',
         {0: 'Standard', 1: 'Landscape', 
            2: 'Portrait', 
            3: 'Night)'}), 
   41991: (
         'GainControl',
         {0: 'None', 1: 'Low gain up', 
            2: 'High gain up', 
            3: 'Low gain down', 
            4: 'High gain down'}), 
   41992: (
