...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/gfx/ext.py
# Compiled at: 2007-07-30 11:13:50
import os
...
class GLSurface(object):
    ...
    def __del__(self):
        if hasattr(gl, 'delete'):
            gl.delete(self.texture_id)
...
class ImageBatch(object):
    ...
    def set_quad(self, index, vertices, colors=None, texture_coords=None):
        ...
        if texture_coords is None:
            texture_coords = ((0.0, 0.0), (0.0, 1.0), (1.0, 1.0), (1.0, 0.0))
