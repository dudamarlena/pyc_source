...
# Embedded file name: /usr/local/lib/python2.7/dist-packages/robots/poses/position.py
# Compiled at: 2015-01-26 11:58:05
import logging
logger = logging.getLogger('robots.position')
import math, numpy, transformations
