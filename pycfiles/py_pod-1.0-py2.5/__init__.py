...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pod/__init__.py
...
"""
__all__ = [
 'decompose', 'combined_distance', 'DecompositionBasic']
import os, logging, vecspace
...
def combined_distance(generator_weight):
  ...
  """
    ...
    def func(start_point, projected_point, generator_point, w=generator_weight):
...
def decompose(source, references, epsilon=1e-10, max_iter=20, max_factors=None, max_weight=None, distance=combined_distance(0.0)):
    """
...
class BaseDecomposition(IterativeDecomposition):
    ...
    def __init__(self, references, epsilon=1e-10, max_iter=20, max_factors=None, max_weight=None, distance=combined_distance(0.0)):
        """
