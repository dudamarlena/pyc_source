...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/parguments/__init__.py
# Compiled at: 2013-07-07 07:41:51
...
class Parguments(object):
    ...
    def parse(self, doc, argv, help, first=False):
        if first and argv in [['-h'], ['--help']]:
            print doc
            return {}
        return docopt(doc, argv, help, self._version, self._options_first)
