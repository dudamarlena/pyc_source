...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitmarket.py
...
class bitmarket(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitmarket, self).describe(), {'id': 'bitmarket', 
           'name': 'BitMarket', 
           'countries': [
                       'PL', 'EU'], 
           'rateLimit': 1500, 
           ...
           'timeframes': {'90m': '90m', 
                          ...
                          '6M': '6m', 
                          '1y': '1y'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27767256-a8555200-5ef9-11e7-96fd-469a65e2b0bd.jpg', 
                    'api': {'public': 'https://www.bitmarket.net', 
           ...
           'api': {'public': {'get': [
                   ...
                   'private': {'post': [
                                      ...
                                      'swapOpen',
                                      'swapClose']}}, 
           'markets': {'BCH/PLN': {'id': 'BCCPLN', 'symbol': 'BCH/PLN', 'base': 'BCH', 'quote': 'PLN'}, 'BTG/PLN': {'id': 'BTGPLN', 'symbol': 'BTG/PLN', 'base': 'BTG', 'quote': 'PLN'}, 'BTC/PLN': {'id': 'BTCPLN', 'symbol': 'BTC/PLN', 'base': 'BTC', 'quote': 'PLN'}, 'BTC/EUR': {'id': 'BTCEUR', 'symbol': 'BTC/EUR', 'base': 'BTC', 'quote': 'EUR'}, 'LTC/PLN': {'id': 'LTCPLN', 'symbol': 'LTC/PLN', 'base': 'LTC', 'quote': 'PLN'}, 'LTC/BTC': {'id': 'LTCBTC', 'symbol': 'LTC/BTC', 'base': 'LTC', 'quote': 'BTC'}, 'LiteMineX/BTC': {'id': 'LiteMineXBTC', 'symbol': 'LiteMineX/BTC', 'base': 'LiteMineX', 'quote': 'BTC'}}, 'fees': {'trading': {'tierBased': True, 
                                'percentage': True, 
                                'taker': 0.45 / 100, 
                                'maker': 0.15 / 100, 
                                'tiers': {'taker': [
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        orderbook = self.publicGetJsonMarketOrderbook(self.extend({'market': self.market_id(symbol)}, params))
        return self.parse_order_book(orderbook)

    def fetch_ticker(self, symbol, params={}):
        ticker = self.publicGetJsonMarketTicker(self.extend({'market': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetJsonMarketTrades(self.extend({'market': market['id']}, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='90m', since=None, limit=None, params={}):
        ...
        market = self.market(symbol)
        response = getattr(self, method)(self.extend({'market': market['id']}, params))
        return self.parse_ohlcvs(response, market, timeframe, since, limit)

    def create_order(self, symbol, type, side, amount, price=None, params={}):
        response = self.privatePostTrade(self.extend({'market': self.market_id(symbol), 
           'type': side, 
           'amount': amount, 
           'rate': price}, params))
