...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitflyer.py
# Compiled at: 2018-04-27 06:36:19
...
class bitflyer(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitflyer, self).describe(), {'id': 'bitflyer', 
           'name': 'bitFlyer', 
           'countries': 'JP', 
           'version': 'v1', 
           'rateLimit': 1000, 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/28051642-56154182-660e-11e7-9b0d-6042d1e6edd8.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetGetboard(self.extend({'product_code': self.market_id(symbol)}, params))
        return self.parse_order_book(orderbook, None, 'bids', 'asks', 'price', 'size')

    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        ticker = self.publicGetGetticker(self.extend({'product_code': self.market_id(symbol)}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetGetexecutions(self.extend({'product_code': market['id']}, params))
        return self.parse_trades(response, market, since, limit)

    def create_order(self, symbol, type, side, amount, price=None, params={}):
        self.load_markets()
        order = {'product_code': self.market_id(symbol), 
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        self.load_markets()
        return self.privatePostCancelchildorder(self.extend({'product_code': self.market_id(symbol), 
           'child_order_acceptance_id': id}, params))
    ...
    def parse_order(self, order, market=None):
        ...
        if feeCost is not None:
            fee = {'cost': feeCost, 'currency': None, 
               'rate': None}
        return {'id': order['child_order_acceptance_id'], 
           'info': order, 
           'timestamp': timestamp, 
           'datetime': self.iso8601(timestamp), 
    ...
    def fetch_orders(self, symbol=None, since=None, limit=100, params={}):
        ...
        self.load_markets()
        market = self.market(symbol)
        request = {'product_code': market['id'], 
           'count': limit}
    ...
    def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = self.privatePostWithdraw(self.extend({'currency_code': currency['id'], 
        ...
        if api == 'private':
            ...
            if params:
                if method != 'GET':
                    ...
                    auth += body
            headers = {'ACCESS-KEY': self.apiKey, 
