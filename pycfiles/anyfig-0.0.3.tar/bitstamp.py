...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitstamp.py
...
class bitstamp(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitstamp, self).describe(), {'id': 'bitstamp', 
           'name': 'Bitstamp', 
           'countries': 'GB', 
           'rateLimit': 1000, 
           'version': 'v2', 
           'has': {'CORS': True, 
                   ...
                   'fetchMyTrades': True, 
                   'withdraw': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27786377-8c8ab57e-5fe9-11e7-8ea4-2b05b6bcceec.jpg', 
    ...
    def fetch_markets(self):
        ...
        for i in range(0, len(markets)):
            ...
            precision = {'amount': market['base_decimals'], 
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetTransactionsPair(self.extend({'pair': market['id'], 
           'time': 'hour'}, params))
        ...
        if transactions is not None:
            if isinstance(transactions, list):
                for i in range(0, len(transactions)):
                    trade = self.parse_trade(self.extend({'order_id': id, 
                       'side': side}, transactions[i]), market)
                    filled += trade['amount']
                    if feeCost is None:
                        feeCost = 0.0
