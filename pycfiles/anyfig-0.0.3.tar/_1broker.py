...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/_1broker.py
# Compiled at: 2018-04-27 06:36:29
...
class _1broker(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(_1broker, self).describe(), {'id': '_1broker', 
           'name': '1Broker', 
           'countries': 'US', 
           'rateLimit': 1500, 
           'version': 'v2', 
           ...
           'timeframes': {'1m': '60', 
                          ...
                          '1h': '3600', 
                          '1d': '86400'}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766021-420bd9fc-5ecb-11e7-8ed6-56d0081efed2.jpg', 
    ...
    def fetch_markets(self):
        ...
        for c in range(0, len(categories)):
            ...
            markets = self_.privateGetMarketList({'category': category.lower()})
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        response = self.privateGetMarketQuotes(self.extend({'symbols': self.market_id(symbol)}, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        self.load_markets()
        result = self.privateGetMarketBars(self.extend({'symbol': self.market_id(symbol), 
           'resolution': 60, 
           'limit': 1}, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        if since is not None:
            request['date_start'] = self.iso8601(since)
