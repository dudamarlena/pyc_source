...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/therock.py
...
class therock(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(therock, self).describe(), {'id': 'therock', 
           'name': 'TheRockTrading', 
           'countries': 'MT', 
           'rateLimit': 1000, 
           'version': 'v1', 
           'has': {'CORS': False, 
                   'fetchTickers': True}, 
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/27766869-75057fa2-5ee9-11e7-9a6f-13e641fa4707.jpg', 
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        self.load_markets()
        orderbook = self.publicGetFundsIdOrderbook(self.extend({'id': self.market_id(symbol)}, params))
    ...
    def parse_ticker(self, ticker, market=None):
        ...
        return {'symbol': symbol, 
           ...
           'close': last, 
           'last': last, 
           'previousClose': float(ticker['close']), 
           'change': None, 
           'percentage': None, 
           'average': None, 
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        ticker = self.publicGetFundsIdTicker(self.extend({'id': market['id']}, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        response = self.publicGetFundsIdTrades(self.extend({'id': market['id']}, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if type == 'market':
            price = 0
        response = self.privatePostFundsFundIdOrders(self.extend({'fund_id': self.market_id(symbol), 
           'side': side, 
           'amount': amount, 
           'price': price}, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        self.load_markets()
        return self.privateDeleteFundsFundIdOrdersId(self.extend({'id': id}, params))
