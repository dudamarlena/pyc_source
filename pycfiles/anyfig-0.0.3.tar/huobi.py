...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/huobi.py
...
class huobi(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(huobi, self).describe(), {'id': 'huobi', 
           'name': 'Huobi', 
           'countries': 'CN', 
           'rateLimit': 2000, 
           'version': 'v3', 
           ...
           'api': {'staticmarket': {'get': [
                   ...
                   'trade': {'post': [
                                    ...
                                    'get_loan_available',
                                    'get_loans']}}, 
           'markets': {'BTC/CNY': {'id': 'btc', 'symbol': 'BTC/CNY', 'base': 'BTC', 'quote': 'CNY', 'type': 'staticmarket', 'coinType': 1}, 'LTC/CNY': {'id': 'ltc', 'symbol': 'LTC/CNY', 'base': 'LTC', 'quote': 'CNY', 'type': 'staticmarket', 'coinType': 2}}})
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = getattr(self, method)(self.extend({'id': market['id']}, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        ohlcvs = getattr(self, method)(self.extend({'id': market['id'], 
           'period': self.timeframes[timeframe]}, params))
        return ohlcvs

    def create_order(self, symbol, type, side, amount, price=None, params={}):
        market = self.market(symbol)
        method = 'tradePost' + self.capitalize(side)
        order = {'coin_type': market['coinType'], 
           'amount': amount, 
