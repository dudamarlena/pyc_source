...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/wex.py
...
class wex(liqui):
    ...
    def describe(self):
        return self.deep_extend(super(wex, self).describe(), {'id': 'wex', 
           'name': 'WEX', 
           'countries': 'NZ', 
           'version': '3', 
           'has': {'CORS': False, 
           ...
           'urls': {'logo': 'https://user-images.githubusercontent.com/1294454/30652751-d74ec8f8-9e31-11e7-98c5-71469fcef03e.jpg', 
                    'api': {'public': 'https://wex.nz/api', 
