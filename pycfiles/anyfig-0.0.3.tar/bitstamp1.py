...
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/anyex/bitstamp1.py
# Compiled at: 2018-04-27 06:36:15
...
class bitstamp1(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitstamp1, self).describe(), {'id': 'bitstamp1', 
           'name': 'Bitstamp v1', 
           'countries': 'GB', 
           'rateLimit': 1000, 
           'version': 'v1', 
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetTransactions(self.extend({'time': 'minute'}, params))
