...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/quickder/rfc/rfc3280.py
# Compiled at: 2020-03-04 06:24:38
# Size of source mod 2**32: 82646 bytes
...
class HoldInstructionCode(_api.ASN1OID):
    _der_packer = chr(_api.DER_PACK_STORE | _api.DER_TAG_OBJECTIDENTIFIER) + chr(_api.DER_PACK_END)
    _recipe = ('_TYPTR', ['_api.ASN1OID'], 0)
    _context = globals()
    _numcursori = 1
...
class PrivateKeyUsagePeriod(_api.ASN1ConstructedType):
    _der_packer = chr(_api.DER_PACK_ENTER | _api.DER_TAG_SEQUENCE) + chr(_api.DER_PACK_OPTIONAL) + chr(_api.DER_PACK_ENTER | _api.DER_TAG_CONTEXT(0)) + chr(_api.DER_PACK_STORE | _api.DER_TAG_GENERALIZEDTIME) + chr(_api.DER_PACK_LEAVE) + chr(_api.DER_PACK_OPTIONAL) + chr(_api.DER_PACK_ENTER | _api.DER_TAG_CONTEXT(1)) + chr(_api.DER_PACK_STORE | _api.DER_TAG_GENERALIZEDTIME) + chr(_api.DER_PACK_LEAVE) + chr(_api.DER_PACK_LEAVE) + chr(_api.DER_PACK_END)
    _recipe = ('_NAMED',
     {'notBefore':(
       '_TYPTR', ['_api.ASN1GeneralizedTime'], 0), 
      'notAfter':(
       '_TYPTR', ['_api.ASN1GeneralizedTime'], 1)})
    _context = globals()
    _numcursori = 2
...
holdInstruction = _api.ASN1OID(bindata=[_api.der_format_OID('1.2.840.10040.2')], context={})
...
id_ce_cRLReason = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(id_ce.get()) + '.21')], context={})
...
id_ce_freshestCRL = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(id_ce.get()) + '.46')], context={})
id_ce_holdInstructionCode = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(id_ce.get()) + '.23')], context={})
...
id_ce_privateKeyUsagePeriod = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(id_ce.get()) + '.16')], context={})
...
id_holdinstruction_callissuer = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(holdInstruction.get()) + '.2')], context={})
id_holdinstruction_none = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(holdInstruction.get()) + '.1')], context={})
id_holdinstruction_reject = _api.ASN1OID(bindata=[_api.der_format_OID(_api.der_parse_OID(holdInstruction.get()) + '.3')], context={})
