...
class QuickDER2c(QuickDERgeneric):
    ...
    def __init__(self, semamod, outfn, refmods, outdir):
        ...
        super(QuickDER2c, self).__init__(outdir, outfn, '.h')
        self.overlay_funmap = {DefinedType: self.overlayDefinedType, 
         ...
         ComponentType: self.overlaySimpleType}
        ...
        self.psub_funmap = {DefinedType: self.psubDefinedType, 
         ...
         ComponentType: self.psubSimpleType}
    ...
    def psubDefinedType(self, node, tp, fld, prim):
        ...
        fld2 = '0'
        subtuples = self.generate_psub_node(thetype, tp2, fld2, prim and popunit == self.unit and tp == tp2)
