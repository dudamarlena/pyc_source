...
# [GCC 8.4.0]
# Embedded file name: C:\Users\crist\Development\clave_unica\src\clave_unica_auth\lib\utils\oauth2_claveunica.py
# Compiled at: 2019-06-30 03:49:22
...
def get_url_params_authorization_code(client_id, redirect_uri, state=uuid.uuid4()):
    ...
    return encode_dict_to_uri({'client_id':client_id, 
     'response_type':'code', 
...
def get_headers_bearer_token(access_token):
    ...
    return {'Authorization':'Bearer {access_token}'.format(access_token=access_token), 
     'Accept':'application/json', 
     'User-Agent':'My User Agent 1.0'}
