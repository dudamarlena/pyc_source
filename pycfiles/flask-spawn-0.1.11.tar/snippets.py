...
# [GCC 8.4.0]
# Embedded file name: /Users/mattpease/DevTools/Workspaces/flask-spawn/flaskspawn/snippets/snippets.py
# Compiled at: 2015-07-22 15:50:56
...
def add_import(imports):
    for key in imports:
        if imports[key] not in open(key).read():
