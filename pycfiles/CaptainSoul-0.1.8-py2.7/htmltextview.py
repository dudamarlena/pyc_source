...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cptsoul/htmltextview.py
# Compiled at: 2014-01-13 07:06:07
"""
A gtk.TextView-based renderer for XHTML-IM, as described in:
  http://www.jabber.org/jeps/jep-0071.html
"""
import gobject, pango, gtk, xml.sax, xml.sax.handler, re, warnings
...
display_resolution = 0.3514598 * (gtk.gdk.screen_height() / float(gtk.gdk.screen_height_mm()))
...
class HtmlHandler(xml.sax.handler.ContentHandler):
    ...
    def _parse_length(self, value, font_relative, callback, *args):
        ...
        if value.endswith('%'):
            ...
            if font_relative:
                ...
                self.__parse_length_frac_size_allocate(self.textview, alloc, frac, callback, args)
                self.textview.connect('size-allocate', self.__parse_length_frac_size_allocate, frac, callback, args)
    ...
    def _parse_style_margin_left(self, tag, value):
        self._parse_length(value, False, self.__frac_length_tag_cb, tag, 'left-margin')

    def _parse_style_margin_right(self, tag, value):
        self._parse_length(value, False, self.__frac_length_tag_cb, tag, 'right-margin')
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'br':
            ...
            try:
                mem = urllib2.urlopen(attrs['src']).read(10485760)
