...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/static/lib/db.py
# Compiled at: 2014-04-20 17:43:48
import re, logging
...
class Length(BaseValidator):
    ...
    def validate(self, field):
        if self.min <= len(field) <= self.max:
            return field
        raise IOError(self.message)
