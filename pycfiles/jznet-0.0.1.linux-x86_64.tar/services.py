...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/pyjznet/services.py
# Compiled at: 2014-12-12 03:19:24
...
class ServerRemoteService(RemoteService):
    ...
    def call_rpc_async(self, service_name, method_name, *method_args):
        msg = messages.RpcMessage(id_helper.generate_request_id(), messages.RpcMessage.RPC_EVENT_NAME, service_name, method_name, method_args, None, None)
