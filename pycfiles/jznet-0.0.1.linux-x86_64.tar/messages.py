...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/pyjznet/messages.py
# Compiled at: 2014-12-12 03:27:48
                ...
                if json_data.get('requestId') and json_data.get('eventName'):
                    ...
                    if RpcMessage.RPC_EVENT_NAME == event_name or RpcMessage.RPC_RESPONSE_EVENT_NAME == event_name:
                        ...
                        if method_args is None:
                            method_args = []
                        msgs.append(RpcMessage(request_id, event_name, service_name, method_name, method_args, data, json_data))
            return msgs