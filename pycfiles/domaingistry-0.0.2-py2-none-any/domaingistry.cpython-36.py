...
# [GCC 8.4.0]
# Embedded file name: /home/roooot/Documents/JGithub/python-domaingistry/domaingistry/domaingistry.py
# Compiled at: 2019-10-05 12:08:58
# Size of source mod 2**32: 7190 bytes
import json
new_domain = [
 'app', 'site', 'online', 'xyz', 'tech', 'shop', 'blog', 'space', 'live', 'life', 'website', 'news', 'ninja', 'solutions', 'expert', 'services', 'media', 'rocks', 'company', 'guru', 'club', 'today', 'agency', 'technology', 'tips', 'center', 'link', 'click', 'ltd', 'win', 'work']
...
class Domain(object):
    ...
    def to_json(self):
        ...
        result = {'common domains':cust_list_common,  'extra domains':cust_list_extra, 
