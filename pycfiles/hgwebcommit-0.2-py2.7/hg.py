...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hgwebcommit/repository/hg.py
...
class MercurialRepository(BaseRepository):
    ...
    def commit(self, files, commit_message):
        self.repository.commit(text=commit_message.encode(self.encoding), match=match(self.repository.root, self.repository.root, None, include=files))
        return
