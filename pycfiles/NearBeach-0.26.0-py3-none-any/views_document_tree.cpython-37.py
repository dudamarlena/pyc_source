...
# [GCC 8.4.0]
# Embedded file name: /home/luke/PycharmProjects/untitled1/NearBeach/views_document_tree.py
...
def document_tree_folder--- This code section failed: ---
 ...
 L.  64        42  LOAD_FAST                'request'
               44  LOAD_ATTR                user
               46  LOAD_CONST               ('folder_description', 'change_user')
...
def document_tree_upload--- This code section failed: ---
 ...
 L. 225       102  LOAD_FAST                'request'
              104  LOAD_ATTR                user
              106  LOAD_CONST               ('document_description', 'document', 'change_user')
 ...
 L. 231       124  LOAD_FAST                'request'
              126  LOAD_ATTR                user
              128  LOAD_CONST               ('document_key', 'change_user')
 ...
 L. 264       406  LOAD_STR                 'POST'
              408  LOAD_CONST               ('name', 'size', 'url', 'thumbnail_url', 'delete_url', 'delete_type')
...
def document_tree_url--- This code section failed: ---
 ...
 L. 289        72  LOAD_FAST                'request'
               74  LOAD_ATTR                user
               76  LOAD_CONST               ('document_url_location', 'document_description', 'change_user')
 ...
 L. 295        94  LOAD_FAST                'request'
               96  LOAD_ATTR                user
               98  LOAD_CONST               ('document_key', 'change_user')
 ...
 L. 309       250  LOAD_FAST                'location_id'
              252  LOAD_CONST               ('requirement_item_id',)
