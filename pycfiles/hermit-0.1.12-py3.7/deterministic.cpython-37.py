...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pybitcointools/deterministic.py
...
TESTNET_PRIVATE = b'\x045\x83\x94'
TESTNET_PUBLIC = b'\x045\x87\xcf'
...
def bip32_master_key(seed, vbytes=MAINNET_PRIVATE):
    ...
    return bip32_serialize((vbytes, 0, b'\x00\x00\x00\x00', 0, I[32:], I[:32] + b'\x01'))
...
def coinvault_pub_to_bip32(*args):
    ...
    return bip32_serialize((MAINNET_PUBLIC, 0, b'\x00\x00\x00\x00', 0, I2, I1))
...
def coinvault_priv_to_bip32(*args):
    ...
    return bip32_serialize((MAINNET_PRIVATE, 0, b'\x00\x00\x00\x00', 0, I2, I3 + b'\x01'))
