...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pybitcointools/stealth.py
# Compiled at: 2018-12-04 13:59:45
# Size of source mod 2**32: 3713 bytes
import pybitcointools.main as main
import pybitcointools.transaction as tx
...
def mk_stealth_tx_outputs(stealth_addr, value, ephem_privkey, nonce, network='btc'):
    ...
    output0 = {'script':mk_stealth_metadata_script(ephem_pubkey, nonce),  'value':0}
