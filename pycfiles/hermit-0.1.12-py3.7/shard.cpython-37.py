...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hermit/shards/shard.py
# Compiled at: 2019-08-22 14:02:08
...
class Shard(object):
    __doc__ = 'Represents a single Shamir shard.\n\n    '
    ...
    def __init__(self, name: str, encrypted_mnemonic: Optional[str], interface: ShardWordUserInterface=None) -> None:
    ...
    def change_password(self):
        ...
        self.encrypted_mnemonic = shamir_share.reencrypt_mnemonic(self.encrypted_mnemonic, old_password, new_password)
    ...
    def _unpack_share(self) -> None:
        self._share_id, _, self._group_id, self._group_threshold, _, self._member_id, self._member_threshold, _ = shamir_share.decode_mnemonic(self.encrypted_mnemonic)

    def to_str(self) -> str:
        """Return a user friendly string describing this shard and its membership in a group"""
        identifier, _, group_index, _, _, member_identifier, _, _ = shamir_share.decode_mnemonic(self.encrypted_mnemonic)
