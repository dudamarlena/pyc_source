...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pybitcointools/mnemonic.py
# Compiled at: 2018-12-04 13:59:45
# Size of source mod 2**32: 4157 bytes
import hashlib, os.path, binascii, random
...
def mnemonic_int_to_words(mint, mint_num_words, wordlist=wordlist_english):
    backwords = [wordlist[(mint >> 11 * x & 2047)].strip() for x in range(mint_num_words)]
    return backwords[::-1]
