...
# Embedded file name: /Users/mpcabd/Projects/pyentist/env/lib/python3.5/site-packages/pyentist/experiment.py
# Compiled at: 2016-03-06 15:31:53
...
class Experiment(object):
    ...
    def run(self, name='control'):
        ...
        control = next((observation for observation in observations if observation.name == name), None)
