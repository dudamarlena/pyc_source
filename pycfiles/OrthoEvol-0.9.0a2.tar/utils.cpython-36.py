...
# [GCC 8.4.0]
# Embedded file name: C:\Users\rgilmore\PycharmProjects\OrthoEvolution\OrthoEvol\Cookies\utils.py
# Compiled at: 2017-11-20 17:46:53
# Size of source mod 2**32: 4645 bytes
import yaml, shutil, datetime, os
from pathlib import Path
from OrthoEvol.Tools.logit import LogIt
archive_options = {'Full':Path(''), 
 'NCBI':Path('NCBI'), 
 'ITIS':Path('ITIS'), 
...
def archive(database_path, archive_path, option, delete_flag=False):
    ...
    for arch_name, data_path in archive_dict.items():
        ...
        archive_filename = shutil.make_archive(base_name=(str(output_pathname)), format='xztar', root_dir=root_dir, base_dir=base_dir)
