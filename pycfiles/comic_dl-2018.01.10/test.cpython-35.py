...
# Embedded file name: build/bdist.linux-x86_64/egg/ComicThief/test.py
# Compiled at: 2017-02-05 14:19:01
...
class TestAll(unittest.TestCase):
    ...
    def test_download_images_list(self):
        ...
        self.fetcher.download_images_list(Path(self.test_cwd, self.output_dir, self.episode_name, self.img_dir), images_list)
    ...
    def test_create_cbz_file(self):
        ...
        self.assertTrue(Path(self.test_cwd, self.output_dir, self.episode_name, '{}.cbz'.format(self.episode_name)).exists())
