...
# [GCC 8.4.0]
# Embedded file name: /home/jens/repos/trixi/trixi/experiment_browser/browser.py
# Compiled at: 2019-06-14 09:35:56
# Size of source mod 2**32: 10434 bytes
...
def parse_args():
    if len(sys.argv) > 1:
        ...
        parser.add_argument('base_directory', help='Give the path to the base directory of your project files',
          type=str,
          default='.')
        parser.add_argument('-d', '--debug', action='store_true', help='Turn debug mode on, eg. for live reloading.')
        parser.add_argument('-x', '--expose', action='store_true', help='Make server externally visible')
        parser.add_argument('-p', '--port', default=5000, type=int, help='Port to start the server on (5000 by default)')
