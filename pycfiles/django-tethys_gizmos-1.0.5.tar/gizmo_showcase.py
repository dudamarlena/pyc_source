...
# [GCC 8.4.0]
# Embedded file name: /Users/swainn/projects/tethysdev/django-tethys_gizmos/tethys_gizmos/views/gizmo_showcase.py
# Compiled at: 2015-03-13 16:27:57
import json
...
def index(request):
    ...
    single_button = {'buttons': [
                 {'display_text': 'Click Me', 'name': 'click_me_name', 
                    'attributes': 'onclick=alert(this.name);', 
                    'type': 'submit'}]}
    horizontal_buttons = {'buttons': [
                 {'display_text': 'Add', 'icon': 'glyphicon glyphicon-plus', 
                    'style': 'success'},
                 {'display_text': 'Delete', 'icon': 'glyphicon glyphicon-trash', 
                    'disabled': True, 
                    'style': 'danger'}]}
    vertical_buttons = {'buttons': [
                 {'display_text': 'Edit', 'icon': 'glyphicon glyphicon-wrench', 
                    'style': 'warning', 
                    'attributes': 'id=edit_button'},
                 {'display_text': 'Info', 'icon': 'glyphicon glyphicon-question-sign', 
                    'style': 'info', 
                    'attributes': 'name=info'},
                 {'display_text': 'Apps', 'icon': 'glyphicon glyphicon-home', 
                    'href': '/apps', 
                    'style': 'primary'}], 
       'vertical': True}
    date_picker = {'display_text': 'Date', 'name': 'date1', 
       'autoclose': True, 
       'format': 'MM d, yyyy', 
    ...
    date_picker_error = {'display_text': 'Date', 'name': 'date2', 
       'initial': '10/2/2013', 
       'disabled': True, 
       'error': 'Here is my error text'}
    slider1 = {'display_text': 'Slider 1', 'name': 'slider1', 
       'min': 0, 
       'max': 100, 
       'initial': 50, 
       'step': 1}
    slider2 = {'display_text': 'Slider 2', 'name': 'slider2', 
       'min': 0, 
       'max': 1, 
       'initial': 0.5, 
       'step': 0.1, 
    ...
    select_input2 = {'display_text': 'Select2', 'name': 'select1', 
       'multiple': False, 
       'options': [
                 ('One', '1'), ('Two', '2'), ('Three', '3')], 
       'initial': [
                 'Two']}
    select_input2_multiple = {'display_text': 'Select2 Multiple', 'name': 'select2', 
       'multiple': True, 
       'options': [
                 ('One', '1'), ('Two', '2'), ('Three', '3')]}
    select_input_multiple = {'display_text': 'Select Multiple', 'name': 'select2.1', 
       'multiple': True, 
       'original': True, 
       'options': [
                 ('One', '1'), ('Two', '2'), ('Three', '3')]}
    select_input2_error = {'display_text': 'Select2 Disabled', 'name': 'select3', 
       'multiple': False, 
       'options': [
                 ('One', '1'), ('Two', '2'), ('Three', '3')], 
       'disabled': True, 
       'error': 'Here is my error text'}
    text_input = {'display_text': 'Text', 'name': 'inputAmount', 
       'placeholder': 'e.g.: 10.00', 
       'prepend': '$'}
    text_error_input = {'display_text': 'Text Error', 'name': 'inputEmail', 
       'initial': 'bob@example.com', 
       'disabled': True, 
       'icon_append': 'glyphicon glyphicon-envelope', 
       'error': 'Here is my error text'}
    toggle_switch = {'display_text': 'Defualt Toggle', 'name': 'toggle1'}
    toggle_switch_styled = {'display_text': 'Styled Toggle', 'name': 'toggle2', 
       'on_label': 'Yes', 
       'off_label': 'No', 
       'on_style': 'success', 
       'off_style': 'danger', 
       'initial': True, 
       'size': 'large'}
    toggle_switch_disabled = {'display_text': 'Disabled Toggle', 'name': 'toggle3', 
       'on_label': 'On', 
       'off_label': 'Off', 
       'on_style': 'success', 
       'off_style': 'warning', 
       ...
       'disabled': True, 
       'error': 'Here is my error text'}
    highcharts_object = {'chart': {'type': 'spline'}, 
       ...
       'series': [
                {'name': 'Air Temp', 
                   'color': '#0066ff', 
                   'dashStyle': 'ShortDash', 
                   'marker': {'enabled': False}, 'data': [
                          [
                           0, 5], [10, -70], [20, -86.5], [30, -66.5], [40, -32.1],
                          [
    ...
    line_plot_view = {'highcharts_object': highcharts_object, 'width': '500px', 
       'height': '500px'}
    web_plot_object = {'chart': {'polar': True, 
                 'type': 'line'}, 
       'title': {'text': 'Polar Chart'}, 
       'pane': {'size': '80%'}, 
       'xAxis': {'categories': [
                              'Infiltration', 'Soil Moisture', 'Precipitation', 'Evaporation',
       ...
       'series': [
                {'name': 'Park City', 
                   'data': [
                          0.2, 0.5, 0.1, 0.8, 0.2, 0.6, 0.8, 0.3], 
                   'pointPlacement': 'on'},
                {'name': 'Little Dell', 
                   'data': [
                          0.8, 0.3, 0.2, 0.5, 0.1, 0.8, 0.2, 0.6], 
                   'pointPlacement': 'on'}]}
    web_plot = {'highcharts_object': web_plot_object, 'width': '500px', 
       'height': '500px'}
    timeseries_plot_object = {'chart': {'type': 'area', 
                 'zoomType': 'x'}, 
       'title': {'text': 'Irregular Timeseries Plot'}, 
       'xAxis': {'maxZoom': 2592000000, 
                 'type': 'datetime'}, 
       ...
       'series': [
                {'name': 'Winter 2007-2008', 
                   'data': [
                          ...
                          [
                           datetime(2009, 2, 10), 1.8],
                          [
                           datetime(2009, 2, 18), 1.8],
                          [
    ...
    timeseries_plot = {'highcharts_object': timeseries_plot_object, 'width': '500px', 
       'height': '500px'}
    table_view = {'column_names': ('Name', 'Age', 'Job'), 'rows': [
              ('Bill', 30, 'contractor'),
              ('Fred', 18, 'programmer'),
              ('Bob', 26, 'boss')], 
       'hover': True, 
       ...
       'bordered': False, 
       'condensed': False}
    table_view_edit = {'column_names': ('Name', 'Age', 'Job'), 'rows': [
              ('Bill', 30, 'contractor'),
              ('Fred', 18, 'programmer'),
              ('Bob', 26, 'boss')], 
       'hover': True, 
    ...
    fetchclimate_array = {'serverUrl': 'http://fetchclimate2.cloudapp.net', 
       'variables': {'prate': [
                             423, 432, 426, 424], 
                     'elev': []}, 
       'grid': {'title': 'Provo Canyon Watershed', 
                'boundingBox': [
                              40.308836, 40.381579, -111.654462, -111.550778], 
                'gridResolution': [
                                 25, 25]}, 
       'point': {'title': 'Clyde Building', 
                 'location': [
                            40.246942, -111.647971]}, 
       'dataEvent': True}
    map_view = {'height': '500px', 'width': '100%', 
       'controls': [
                  'ZoomSlider',
                  'Rotate',
                  'FullScreen', {'MousePosition': {'projection': 'EPSG:4326'}}], 
       'layers': [
                {'WMS': {'url': 'http://demo.opengeo.org/geoserver/wms', 'params': {'LAYERS': 'topp:states'}, 'serverType': 'geoserver'}}], 
       'view': {'projection': 'EPSG:4326', 'center': [-100, 40], 'zoom': 3.5, 'maxZoom': 18, 'minZoom': 3}, 'base_map': 'OpenStreetMap', 
       'draw': [
              'Point', 'Line', 'Polygon'], 
       'legend': False}
    context = {'single_button': single_button, 'horizontal_buttons': horizontal_buttons, 
...
def swap_overlays(request):
    ...
    """
    overlay_json = {'type': 'GeometryCollection', 'geometries': [
                    {'type': 'Polygon', 'coordinates': [
                                     [
                                      40.643135583312805, -111.48951530456543],
                                     [
                       ...
                       'properties': {'id': 4, 'value': 5}, 'crs': {'type': 'link', 'properties': {'href': 'http://spatialreference.org/ref/epsg/4326/proj4/', 
                                              'type': 'proj4'}}},
                    {'type': 'Point', 'coordinates': [
                                     40.629587853312174, -111.50959968566895], 
                       'properties': {'id': 5, 'value': 6}, 'crs': {'type': 'link', 'properties': {'href': 'http://spatialreference.org/ref/epsg/4326/proj4/', 
                                              'type': 'proj4'}}},
                    {'type': 'LineString', 'coordinates': [
                                     [
                                      40.62737305910759, -111.50118827819824],
                                     [
                       ...
                       'properties': {'id': 6, 'value': 7}, 'crs': {'type': 'link', 'properties': {'href': 'http://spatialreference.org/ref/epsg/4326/proj4/', 
                                              'type': 'proj4'}}}]}
...
def editable_map(request):
    ...
    google_map_view = {'height': '600px', 'width': '100%', 
       ...
       'drawing_types_enabled': [
                               'POLYGONS', 'POINTS', 'POLYLINES'], 
       'initial_drawing_mode': 'POINTS', 
       'input_overlays': {'type': 'GeometryCollection', 'geometries': [
                                       {'type': 'Point', 'coordinates': [
                                                        40.629197012613545, -111.5123462677002], 
                                          'properties': {'id': 1, 'value': 1}},
                                       {'type': 'Polygon', 'coordinates': [
                                                        [
                                                         40.63193284946615, -111.50153160095215],
                                                        [
                                       ...
                                       {'type': 'LineString', 'coordinates': [
                                                        [
                                                         40.65003865742191, -111.49123191833496],
                                                        [
...
def google_map(request):
    ...
    """
    google_map = {'height': '600px', 'width': '100%', 
...
def map_view(request):
    ...
    map_view = {'controls': ['ZoomSlider',
                  'Rotate', {'ZoomToExtent': {'projection': 'EPSG:4326', 'extent': [-135, 22, -55, 54]}},
                  'FullScreen', {'MousePosition': {'projection': 'EPSG:4326'}},
                  'ScaleLine'], 
       'layers': [
                {'WMS': {'url': 'http://demo.opengeo.org/geoserver/wms', 'params': {'LAYERS': 'topp:states'}, 'serverType': 'geoserver'}}], 
       'view': {'projection': 'EPSG:4326', 'center': [-100, 40], 'zoom': 4, 'maxZoom': 18, 'minZoom': 3}, 'base_map': 'OpenStreetMap', 
       'draw': [
              'Point', 'Line', 'Polygon'], 
       'legend': False, 
       'height': '500px', 
...
def fetchclimate_map(request):
    ...
    Place to show off the new map view
    """
    fetchclimate_map = {'serverUrl': 'http://fetchclimate2.cloudapp.net', 
       'variables': {'prate': [
                             423, 432, 426, 424], 
                     'elev': []}, 
       'map': {'css': {'height': '600px', 'width': '100%'}, 
               'map_data': {'drawing_types_enabled': [
                                                    'RECTANGLE', 'POINTS'], 
       ...
       'point': {'title': 'Clyde Building', 
                 'location': [
                            40.246942, -111.647971]}, 
       'plot': {'dimensions': {'height': 350, 'width': 500}}}
