...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/unlocker/client.py
# Compiled at: 2018-04-03 09:11:42
# Size of source mod 2**32: 2984 bytes
import asyncio, logging, asyncssh
...
class ServerUnlocker:
    ...
    def __init__(self, servers):
        ...
        self.tasks = (asyncio.gather)(*(self.unlock_server(config) for config in self.servers))
