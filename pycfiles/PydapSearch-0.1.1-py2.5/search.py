...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/pydap/wsgi/search.py
# Compiled at: 2010-08-19 14:30:38
import os
...
class SearchMiddleware(object):
    ...
    def __call__(self, environ, start_response):
        ...
        if req.path_info == '/_index':
            ...
            res = Response(body=dumps(output), content_type='application/json', charset='utf-8')
        else:
    ...
    def _index(self):
        ...
        for url in crawl(self.catalog):
            ...
            for var in walk(dataset):
                ...
                writer.add_document(title=title.decode('utf-8'), path=path.decode('utf-8'), content=content.decode('utf-8'))
