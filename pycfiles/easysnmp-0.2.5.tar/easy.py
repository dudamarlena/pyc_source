...
# [GCC 8.4.0]
# Embedded file name: /Users/kentcoble/Documents/workspace/easysnmp/easysnmp/easy.py
# Compiled at: 2017-06-13 22:48:47
...
def snmp_walk(oids=b'.1.3.6.1.2.1', **session_kargs):
    """
...
def snmp_bulkwalk(oids=b'.1.3.6.1.2.1', non_repeaters=0, max_repetitions=10, **session_kargs):
    """
