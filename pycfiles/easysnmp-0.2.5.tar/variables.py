...
# [GCC 8.4.0]
# Embedded file name: /Users/kentcoble/Documents/workspace/easysnmp/easysnmp/variables.py
...
class SNMPVariable(object):
    ...
    def __repr__(self):
        ...
        return (b'<{0} value={1} (oid={2}, oid_index={3}, snmp_type={4})>').format(self.__class__.__name__, urepr(printable_value), urepr(self.oid), urepr(self.oid_index), urepr(self.snmp_type))
