...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hamtools/ctydat.py
# Compiled at: 2016-10-02 09:13:56
"""
...
class CtyDat(object):
    fields = [
     'name', 'cq', 'itu', 'cont', 'lat', 'lon', 'utcoff', 'prefix']
    ...
    def getdxcc(self, call):
        ...
        if re.search('(^OH/)|(/OH[1-9]?$)', call) is not None:
            ...
            if re.search('(^3D2R)|(^3D2.+\\/R)', call) is not None:
                call = '3D2RR'
            else:
                if re.search('^3D2C', call) is not None:
                    call = '3D2CR'
                elif '/' in call:
        ...
        if mydxcc['prefix'].startswith('*'):
            if mydxcc['prefix'] == '*TA1':
                mydxcc['prefix'] = 'TA'
            if mydxcc['prefix'] == '*4U1V':
                mydxcc['prefix'] = 'OE'
            if mydxcc['prefix'] == '*GM/s':
                mydxcc['prefix'] = 'GM'
            if mydxcc['prefix'] == '*IG9':
                mydxcc['prefix'] = 'I'
            if mydxcc['prefix'] == '*IT9':
                mydxcc['prefix'] = 'I'
            if mydxcc['prefix'] == '*JW/b':
                mydxcc['prefix'] = 'JW'
        return mydxcc