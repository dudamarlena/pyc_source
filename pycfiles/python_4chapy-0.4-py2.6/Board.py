...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/Fourchapy/Board.py
# Compiled at: 2012-12-26 16:38:47
"""
...
class FourchapyBoard(object):
    """ A 4chan board
    """
    POSTOBJECTS = {'board': dict(type=unicode, name='Board', desc='Board ID string'), 
    ...
    def getPages(self, minPage=0, maxPage=None):
        ...
        for pageID in xrange(minPage, maxPage + 1):
            pages.append(FourchapyThreadPage(boardID=self.Board, pageID=pageID, proto=self.Proto, proxies=self.Proxies))
