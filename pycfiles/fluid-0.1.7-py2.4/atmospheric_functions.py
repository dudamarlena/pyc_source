...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/fluid/atmosphere/atmospheric_functions.py
...
def air_viscosity(T_a):
    ...
    """
    viscair = 1.326e-05 * (1 + 0.006542 * T_a + 8.301e-06 * T_a ** 2 - 4.84e-09 * T_a ** 3)
    return viscair
...
def potential_temperature(T, p, R, p0=100000.0, cp=_cp):
