...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\cmdlinetest1\clirest_api.py
# Compiled at: 2020-03-26 15:21:33
# Size of source mod 2**32: 10611 bytes
import argparse, getpass, requests, json
...
def transferDbxtoGdrive(credential1, credential2, fileName):
    ...
    headers = {'content-type':'application/json', 
     'Authorization':'Bearer ' + token}
    data = {'src':{'credential':{'name':'credential1', 
       'tokenSaved':False, 
      ...
      'map':[
       {'id':None, 
        'path':'dropbox:///'}]}, 
     'dest':{'credential':{'name':'credential2', 
       'tokenSaved':False, 
       'token':'ya29.a0Adw1xeV5xaBqlOx9HyXUKh7j9ILhOyyOCOjFa_C800UP5ElveYGvDpwQKDWU02DZ4yFI1JrCql_1I7IpIJ4nQBuRG9_YaJ6g95muminHkKFWqM-uAEWbWTlMnmOwEqMwF88cxqpd4zOEj34HsbLo1J_1v9DREvinAcg'}, 
      'id':None, 
