...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/updatorr/utils.py
# Compiled at: 2013-04-01 10:46:46
import time, os
...
def get_new_prefs(full_prefs, new_torrent_info):
    ...
    info_to_drop = ('comment', 'hash', 'peers', 'progress', 'num_seeds', 'ratio', 'total_peers',
                    'total_wanted', 'distributed_copies', 'time_added', 'active_time',
                    'next_announce', 'tracker', 'tracker_host', 'tracker_status',
                    'trackers', 'files', 'file_priorities', 'file_progress', 'num_files',
                    'is_seed', 'seed_rank', 'seeding_time', 'download_payload_rate',
                    'message', 'num_peers', 'compact', 'total_uploaded', 'total_done',
                    'num_pieces', 'total_payload_download', 'total_seeds', 'piece_length',
                    'all_time_download', 'name', 'seeds_peers_ratio', 'eta', 'is_finished',
                    'total_size', 'state', 'upload_payload_rate')
