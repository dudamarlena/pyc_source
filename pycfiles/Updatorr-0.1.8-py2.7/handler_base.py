...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/updatorr/handler_base.py
# Compiled at: 2013-02-17 00:00:06
import os, re, tempfile, urllib2
from urllib import urlencode
from updatorr.utils import Cookies
RE_LINK = re.compile('href\\s*=\\s*"\\s*([^"]+)\\s*"[^>]*>', re.S | re.I | re.M)
COOKIES_REGISTRY = {}
...
class BaseTrackerHandler(object):
    ...
    def get_resource(self, url, form_data=None):
        ...
        request = urllib2.Request(url, form_data, {'User-agent': 'Mozilla/5.0 (Ubuntu; X11; Linux i686; rv:8.0) Gecko/20100'})
        try:
