...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/drench/visualizer.py
# Compiled at: 2013-12-03 23:10:36
import txws
...
class MyRequestHandler(http.Request):
    ...
    def process(self):
        ...
        if self.path in self.resources:
            ...
            self.setResponseCode(http.NOT_FOUND, 'Sorry, dogg. We dont have those here')
        self.finish()
