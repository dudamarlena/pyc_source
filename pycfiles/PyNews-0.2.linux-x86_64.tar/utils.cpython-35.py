...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.5/site-packages/pynews/utils.py
...
def get_story(new):
    ...
    try:
        ...
        raise req.TooManyRedirects('The request exceeds the configured number            of maximum redirections.')
    else:
        return data.json()
