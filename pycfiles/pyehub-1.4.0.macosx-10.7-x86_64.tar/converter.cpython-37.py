...
# [GCC 8.4.0]
# Embedded file name: /Users/juancomish/miniconda3/lib/python3.7/site-packages/pyehub/data_formats/request_format/converter.py
...
class Converter:
    __doc__ = 'A wrapper for a request format converter.'
    ...
    def is_dispatch(self) -> bool:
        ...
        return not self.is_solar and self.name != 'Grid'
