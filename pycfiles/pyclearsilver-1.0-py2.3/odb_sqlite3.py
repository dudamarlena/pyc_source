...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pyclearsilver/odb_sqlite3.py
# Compiled at: 2005-10-08 17:25:24
"""
...
import odb, sqlite3
sqlite = sqlite3
odb.OperationalError = sqlite.OperationalError
...
class Connection(odb.Connection):
    ...
    def escape(self, str):
        if str is None:
            ...
            raise 'unknown column data type: <%s> value=%s' % (type(str), str[:100])
        return
