...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/pyclearsilver/log.py
...
LOGGING_STATUS = {DEV: 1, DEV_UPDATE: 0, DEV_SELECT: 0, DEV_REPORT: 0}
tstart = 0
...
def ansicolor(str, fgcolor=None, bgcolor=None):
    ...
    if fgcolor:
        if fgcolor & kBRIGHT:
            ...
            bright = ''
        o = o + '%c[3%d%sm' % (chr(27), fgcolor & 7, bright)
    if bgcolor:
...
def warnred(*args):
    args = tuple(['\x1b[31m'] + list(args) + ['\x1b[0m'])
    apply(_log, args)
