...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/pandasticsearch/operators/aggregator.py
# Compiled at: 2018-09-25 01:28:44
_metric_aggs = ('avg', 'min', 'max', 'cardinality', 'value_count', 'sum', 'percentiles',
                'percentile_ranks', 'stats', 'extended_stats')
