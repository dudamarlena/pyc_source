...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-migration/vkontakte_groups_migration/migrations/0004_auto.py
# Compiled at: 2013-11-15 03:40:36
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('vkontakte_groups_groupstatmembers', ['time'])
        db.create_index('vkontakte_groups_groupstatmembers', ['hidden'])

    def backwards(self, orm):
        db.delete_index('vkontakte_groups_groupstatmembers', ['hidden'])
        db.delete_index('vkontakte_groups_groupstatmembers', ['time'])
