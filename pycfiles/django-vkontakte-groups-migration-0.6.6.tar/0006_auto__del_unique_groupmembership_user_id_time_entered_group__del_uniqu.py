...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-migration/vkontakte_groups_migration/migrations/0006_auto__del_unique_groupmembership_user_id_time_entered_group__del_uniqu.py
# Compiled at: 2014-01-28 03:02:25
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique('vkontakte_groups_migration_groupmembership', ['user_id', 'group_id', 'time_left'])
        db.delete_unique('vkontakte_groups_migration_groupmembership', ['user_id', 'time_entered', 'group_id'])

    def backwards(self, orm):
        db.create_unique('vkontakte_groups_migration_groupmembership', ['user_id', 'time_entered', 'group_id'])
        db.create_unique('vkontakte_groups_migration_groupmembership', ['user_id', 'group_id', 'time_left'])
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_migration.groupmembership': {'Meta': {'ordering': "('group', 'user_id', 'id')", 'object_name': 'GroupMembership'}, 'group': (
