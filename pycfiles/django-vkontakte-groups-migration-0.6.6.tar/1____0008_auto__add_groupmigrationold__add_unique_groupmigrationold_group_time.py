...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-migration/vkontakte_groups_migration/migrations/1____0008_auto__add_groupmigrationold__add_unique_groupmigrationold_group_time.py
# Compiled at: 2013-11-29 01:24:59
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('vkontakte_groups_groupstatmembers', (
         ...
         (
          'group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='migrations_old', to=orm['vkontakte_groups.Group'])),
         (
        ...
        db.send_create_signal('vkontakte_groups_migration', ['GroupMigrationOld'])
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_migration.groupmigrationuser': {'Meta': {'unique_together': "(('migration', 'user_id', 'type'),)", 'object_name': 'GroupMigrationUser'}, 'id': (
                                                         ...
                                                         'type': (
                                                                'django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}), 
                                                         'user_id': (
