...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-migration/vkontakte_groups_migration/migrations/0005_auto__add_groupmigrationuser__add_groupmigrationnew__add_unique_groupm.py
# Compiled at: 2013-11-15 08:55:39
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('vkontakte_groups_migration_groupmigrationuser', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'migration', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['vkontakte_groups_migration.GroupMigration'])),
         (
          'user_id', self.gf('django.db.models.fields.PositiveIntegerField')())))
        db.send_create_signal('vkontakte_groups_migration', ['GroupMigrationUser'])
        db.create_table('vkontakte_groups_migration_groupmigration', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='migrations_new', to=orm['vkontakte_groups.Group'])),
         (
          'time', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
         (
        ...
        db.send_create_signal('vkontakte_groups_migration', ['GroupMigrationNew'])
        db.create_unique('vkontakte_groups_migration_groupmigration', ['group_id', 'time'])

    def backwards(self, orm):
        db.delete_unique('vkontakte_groups_migration_groupmigration', ['group_id', 'time'])
        db.delete_table('vkontakte_groups_migration_groupmigrationuser')
        db.delete_table('vkontakte_groups_migration_groupmigration')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_migration.groupmigrationnew': {'Meta': {'ordering': "('group', 'time', '-id')", 'unique_together': "(('group', 'time'),)", 'object_name': 'GroupMigrationNew', 'db_table': "'vkontakte_groups_migration_groupmigration'"}, 'group': (
                                                                'django.db.models.fields.related.ForeignKey', [], {'related_name': "'migrations_new'", 'to': "orm['vkontakte_groups.Group']"}), 
                                                        'hidden': (
                                                        ...
                                                        'time': (
                                                               'django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'})}, 
       'vkontakte_groups_migration.groupmigrationuser': {'Meta': {'object_name': 'GroupMigrationUser'}, 'id': (
                                                              'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                                         'migration': (
                                                                     'django.db.models.fields.related.ForeignKey', [], {'related_name': "'users'", 'to': "orm['vkontakte_groups_migration.GroupMigration']"}), 
                                                         'user_id': (
