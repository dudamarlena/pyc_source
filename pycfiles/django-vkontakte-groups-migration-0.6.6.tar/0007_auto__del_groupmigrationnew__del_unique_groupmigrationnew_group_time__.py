...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-migration/vkontakte_groups_migration/migrations/0007_auto__del_groupmigrationnew__del_unique_groupmigrationnew_group_time__.py
# Compiled at: 2013-12-03 07:35:45
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('vkontakte_groups_migration_groupmigrationuser', 'type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True), keep_default=False)
        db.create_unique('vkontakte_groups_migration_groupmigrationuser', ['type', 'user_id', 'migration_id'])
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_migration.groupmigration': {'Meta': {'ordering': "('group', '-time', '-id')", 'unique_together': "(('group', 'time'),)", 'object_name': 'GroupMigration'}, 'group': (
       ...
       'vkontakte_groups_migration.groupmigrationold': {'Meta': {'ordering': "('group', 'time', '-id')", 'unique_together': "(('group', 'time'),)", 'object_name': 'GroupMigrationOld', 'db_table': "'vkontakte_groups_groupstatmembers'"}, 'group': (
                                                                'django.db.models.fields.related.ForeignKey', [], {'related_name': "'migrations_old'", 'to': "orm['vkontakte_groups.Group']"}), 
                                                        'hidden': (
                                                                 'django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}), 
                                                        'id': (
                                                             'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                                        ...
                                                        'time': (
                                                               'django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'})}, 
       'vkontakte_groups_migration.groupmigrationuser': {'Meta': {'unique_together': "(('migration', 'user_id', 'type'),)", 'object_name': 'GroupMigrationUser'}, 'id': (
                                                              'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                                         'migration': (
