...
# [GCC 8.4.0]
# Embedded file name: /home/ramusus/workspace/manufacture/env/src/django-vkontakte-groups-migration/vkontakte_groups_migration/migrations/0006_auto__chg_field_groupmigrationuser_migration__add_unique_groupmigratio.py
# Compiled at: 2013-11-15 09:05:03
import datetime
...
class Migration(SchemaMigration):
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
       ...
       'vkontakte_groups_migration.groupmigrationnew': {'Meta': {'ordering': "('group', 'time', '-id')", 'unique_together': "(('group', 'time'),)", 'object_name': 'GroupMigrationNew', 'db_table': "'vkontakte_groups_migration_groupmigration'"}, 'group': (
                                                        ...
                                                        'time': (
                                                               'django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'})}, 
       'vkontakte_groups_migration.groupmigrationuser': {'Meta': {'unique_together': "(('migration', 'user_id'),)", 'object_name': 'GroupMigrationUser'}, 'id': (
                                                              'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                                         'migration': (
                                                                     'django.db.models.fields.related.ForeignKey', [], {'related_name': "'users'", 'to': "orm['vkontakte_groups_migration.GroupMigrationNew']"}), 
                                                         'user_id': (
