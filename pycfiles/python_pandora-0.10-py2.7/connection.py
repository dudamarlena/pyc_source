...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pandora/connection.py
# Compiled at: 2013-07-04 07:34:13
import json, urllib, urllib2, time, crypt
...
class PandoraConnection(object):
    ...
    def __init__(self):
        self.rid = '%07i' % (time.time() % 10000000.0)
        self.timedelta = 0
        try:
