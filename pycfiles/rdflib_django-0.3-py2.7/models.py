...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/rdflib_django/models.py
...
class NamedGraph(models.Model):
    ...
    def __unicode__(self):
        return ('{0}').format(self.identifier, 'identifier')
...
class URIStatement(models.Model):
    ...
    def __unicode__(self):
        return ('{0}, {1}').format(self.as_triple(), self.context.identifier)
