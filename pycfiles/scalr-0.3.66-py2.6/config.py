...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-intel/egg/scalrtools/config.py
...
class Environment(ConfigSection):
    ...
    options = dict(url='scalr_url', key_id='scalr_key_id', key='scalr_api_key', env_id='env_id', api_version='version', auth_type='auth_type', ldap_login='ldap_login')
