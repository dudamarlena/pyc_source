...
# [GCC 8.4.0]
# Embedded file name: D:\FilePkl\hasil_development\Deploymentnew\Deployment\Deploymentapp\views.py
# Compiled at: 2014-11-11 22:11:58
...
def createscript(request):
    open('temp/' + request.session['name'] + '_execute.py', 'w')
