...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_refunds.py
# Compiled at: 2015-06-08 06:37:42
from .resources import Transfer, TransferRefund, PayInRefund, DirectPayIn, Refund, Wallet
...
class RefundsTest(BaseTest):
    ...
    def test_create_transfer_refunds(self):
        self.register_mock([
         ...
         {'method': responses.POST, 
            ...
            'body': {'Id': '6784288', 
                     ...
                     'DebitedFunds': {'Currency': 'EUR', 'Amount': 10000}, 'CreditedFunds': {'Currency': 'EUR', 'Amount': 9900}, 'Fees': {'Currency': 'EUR', 'Amount': 100}, 'Status': 'SUCCEEDED', 
                     'ResultCode': '000000', 
        ...
        self.mock_card()
        direct_payin_params = {'author': self.legal_user, 
        ...
        self.register_mock([
         {'method': responses.GET, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/refunds/123456708', 
            'body': {'Id': '123456708', 
                     'Tag': None, 
                     ...
                     'RefundReason': {'RefundReasonMessage': None, 
                                      'RefundReasonType': 'INITIALIZED_BY_CLIENT'}}, 
            'status': 200},
         {'method': responses.POST, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/transfers/1169434/refunds', 
            'body': {'Id': '123456708', 
                     'Tag': None, 
                     ...
                     'RefundReason': {'RefundReasonType': 'INITIALIZED_BY_CLIENT'}}, 
            'status': 200}])
        params = {'author': self.legal_user, 
           'transfer': transfer}
    ...
    def test_create_payin_refund(self):
        ...
        self.register_mock([
         ...
         {'method': responses.POST, 
            ...
            'body': {'Id': '6784288', 
                     ...
                     'SecureModeNeeded': False}, 
            'status': 200}])
        direct_payin_params = {'author': self.card.user, 
           'debited_funds': Money(amount=100, currency='EUR'), 
           'fees': Money(amount=1, currency='EUR'), 
           'credited_wallet': self.legal_user_wallet, 
           'card': self.card, 
        ...
        self.register_mock({'method': responses.POST, 
           'url': 'https://api.sandbox.mangopay.com/v2/chouette/payins/6784288/refunds', 
           'body': {'Id': '1632606', 
                    'Tag': None, 
