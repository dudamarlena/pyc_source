...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_base.py
...
from .resources import NaturalUser, LegalUser, Wallet, CardRegistration, Card
...
class BaseTest(RegisteredMocks):
    ...
    def natural_user(self):
        natural_user_params = {'first_name': 'Victor', 
           'last_name': 'Hugo', 
    ...
    @fixture
    def legal_user(self):
        legal_user_params = {'name': 'MangoPay', 
    ...
    def legal_user_wallet(self):
        legal_user_wallet_params = {'tag': 'My custom tag', 
           'owners': [
                    self.legal_user], 
    ...
    def natural_user_wallet(self):
        natural_user_wallet_params = {'tag': 'My custom tag', 
           'owners': [
                    self.natural_user], 
           'description': 'Wallet of Victor Hugo', 
           'currency': 'EUR'}
    ...
    def card(self):
        ...
        client = Http()
        header, response = client.request(card_registration.card_registration_url, 'POST', urlrequest.urlencode({'cardNumber': '4970100000000154', 
           'cardCvx': '123', 
    ...
    def natural_user_card(self):
        ...
        card_registration.save()
        client = Http()
        header, response = client.request(card_registration.card_registration_url, 'POST', urlrequest.urlencode({'cardNumber': '4970101122334422', 
           'cardCvx': '123', 
           'cardExpirationDate': '0120', 
           'accessKeyRef': card_registration.access_key, 
           'data': card_registration.preregistration_data}))
    ...
    def legal_user_card(self):
        card_params = {'user': self.legal_user, 
           'currency': 'EUR'}
        card_registration = CardRegistration(**card_params)
        card_registration.save()
        client = Http()
        header, response = client.request(card_registration.card_registration_url, 'POST', urlrequest.urlencode({'cardNumber': '4970101122334406', 
           'cardCvx': '123', 
           'cardExpirationDate': '0120', 
           'accessKeyRef': card_registration.access_key, 
           'data': card_registration.preregistration_data}))
