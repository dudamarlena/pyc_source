...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_payins.py
# Compiled at: 2015-06-08 06:37:42
from .resources import Wallet, PayIn, DirectPayIn, BankWirePayIn, CardViaWebTemplatePayIn, DirectDebitViaWebTemplatePayIn
        ...
        self.register_mock([
         ...
         {'method': responses.GET, 
            ...
            'body': {'Owners': [
                     ...
                     'Balance': {'Currency': 'EUR', 'Amount': 9900}, 'Currency': 'EUR', 
                     'Id': '6784284', 
                     'Tag': 'My custom tag', 
    ...
    def test_create_bank_wire_payins(self):
        ...
        self.register_mock({'method': responses.POST, 
           ...
           'body': {'Id': '117609', 
                    ...
                    'ExecutionType': 'DIRECT', 
                    'DeclaredDebitedFunds': {'Currency': 'EUR', 
                                             'Amount': 1000}, 
                    'DeclaredFees': {'Currency': 'EUR', 
                                     'Amount': 100}, 
           ...
           'status': 200})
        bank_wire_payin_params = {'author': self.natural_user, 
           'tag': 'Custom data', 
    ...
    def test_create_card_via_web_interface_payin(self):
        ...
        self.register_mock({'method': responses.POST, 
           ...
           'body': {'Id': '1169430', 
                    ...
                    'SecureMode': 'DEFAULT'}, 
           'status': 200})
        params = {'author': self.natural_user, 
           'debited_funds': Money(amount=100, currency='EUR'), 
           'fees': Money(amount=1, currency='EUR'), 
           'credited_wallet': self.legal_user_wallet, 
           'return_url': 'http://www.ulule.com/', 
           'template_url_options': {'PAYLINE': 'https://www.mysite.com/payline_template/'}, 
           'culture': 'FR', 
