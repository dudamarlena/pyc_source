...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_payouts.py
# Compiled at: 2015-06-08 06:37:42
from .resources import BankAccount, PayOut
...
class PayOutsTest(BaseTest):
    ...
    def test_create_bank_wire_payout(self):
        ...
        self.register_mock([
         ...
         {'method': responses.POST, 
            ...
            'body': {'Id': 30047, 
                     ...
                     'DebitedFunds': {'Currency': 'EUR', 'Amount': 1000}, 'BankAccountId': 6784645, 
                     'AuthorId': 6784642, 
                     'Tag': 'Custom data', 
                     'Fees': {'Currency': 'EUR', 'Amount': 100}, 'DebitedWalletId': 6784644}, 
            'status': 200},
        ...
        bankaccount.save()
        bank_wire_payout_params = {'tag': 'Custom data', 
        ...
        bank_wire_payout = PayOut(**bank_wire_payout_params)
        ...
        retrieved_payout = PayOut.get(bank_wire_payout.get_pk())
        self.assertIsNotNone(retrieved_payout.get_pk())
        self.assertIsInstance(retrieved_payout, PayOut)
