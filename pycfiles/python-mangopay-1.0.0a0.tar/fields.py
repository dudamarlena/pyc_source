...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/mangopay/fields.py
# Compiled at: 2015-06-08 06:37:42
import re, time, datetime, six
...
class Field(object):
    ...
    def __init__(self, null=False, api_name=None, help_text=None, api_value_callback=None, choices=None, default=None, python_value_callback=None, *args, **kwargs):
        self.null = null
...
class MoneyField(Field):
    ...
    def api_value(self, value):
        ...
        if isinstance(value, Money):
            value = {'Currency': value.currency, 'Amount': int(value.amount) * 100.0}
        return value
