...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_notifications.py
    ...
    def test_create_notifications(self):
        self.register_mock([
         {'method': responses.POST, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/hooks', 
            'body': {'Url': 'http://wwww.mynotificationurl.com', 
                     'Status': 'DISABLED', 
                     'Validity': 'VALID', 
         ...
         {'method': responses.GET, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/hooks/1248727', 
            'body': {'Url': 'http://wwww.mynotificationurl.com', 
                     'Status': 'DISABLED', 
                     'Validity': 'VALID', 
                     'EventType': 'PAYIN_NORMAL_SUCCEEDED', 
         ...
         {'method': responses.PUT, 
            ...
            'body': {'Url': 'http://wwww.mynotificationurl.com', 
                     ...
                     'CreationDate': 1392808584}, 
            'status': 200}])
        params = {'url': 'http://wwww.mynotificationurl.com', 
    ...
    def test_retrieve_notification(self):
        self.register_mock([
         ...
         {'method': responses.GET, 
            ...
            'status': 200},
         {'method': responses.GET, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/hooks/1248728', 
        ...
        notification = Notification(**params)
        notification.save()
        self.assertRaises(Notification.DoesNotExist, Notification.get, notification.get_pk() + 1)
        self.assertIsNotNone(notification.get_pk())
    ...
    def test_retrieve_all_events(self):
        self.register_mock([
         {'method': responses.POST, 
            ...
            'status': 200},
         {'method': responses.GET, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/events', 
            'body': [
                   {'RessourceId': '88263', 
                      'EventType': 'PAYIN_NORMAL_CREATED', 
                      'Date': 1383066833},
