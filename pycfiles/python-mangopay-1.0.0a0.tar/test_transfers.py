...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_transfers.py
    ...
    def test_create_transfers(self):
        ...
        self.register_mock([
         ...
         {'method': responses.POST, 
            ...
            'status': 200},
         {'method': responses.GET, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/transfers/1169434', 
            'body': {'Id': '1169434', 
                     'Tag': 'DefaultTag', 
