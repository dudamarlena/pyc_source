...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_transactions.py
...
class TransactionsTest(BaseTest):
    ...
    def test_retrieve_transactions(self):
        ...
        transactions = Transaction.all(user_id=self.legal_user.get_pk(), status='FAILED', sort='CreationDate:asc')
