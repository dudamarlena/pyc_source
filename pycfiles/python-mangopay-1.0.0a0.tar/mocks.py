...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/mocks.py
# Compiled at: 2015-06-08 06:37:42
import unittest
from datetime import date
import responses, json, time, sys, re, os
...
class RegisteredMocks(unittest.TestCase):
    ...
    def register_mock(self, data):
        ...
        if isinstance(data, list):
            ...
            responses.add(data['method'], data['url'], body=data['body'], status=data['status'], content_type='application/json', match_querystring=match_querystring)
    ...
    def mock_card(self):
        self.register_mock([
         ...
         {'method': responses.PUT, 
            'url': re.compile('https://api.sandbox.mangopay.com/v2/chouette/cardregistrations/\\d+'), 
            'body': get_fixture('cardregistrations_update'), 
            'status': 200},
         {'method': responses.GET, 
            'url': re.compile('https://api.sandbox.mangopay.com/v2/chouette/cards/\\d+'), 
