...
# [GCC 8.4.0]
# Embedded file name: /Users/thoas/Sites/Python/ulule/python-mangopay/tests/test_wallets.py
    ...
    def test_create_wallet(self):
        ...
        self.register_mock([
         ...
         {'method': responses.PUT, 
            ...
            'status': 200},
         {'method': responses.GET, 
            'url': 'https://api.sandbox.mangopay.com/v2/chouette/users/1169419/wallets', 
            'body': [
                   {'Owners': [
                               '1169419'], 
                      'Description': 'Wallet of Victor Hugo', 
        ...
        for k, v in wallet_params.items():
            if isinstance(v, list):
                self.assertEqual([self.natural_user], v)
            else:
