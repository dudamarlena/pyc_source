...
# [GCC 8.4.0]
# Embedded file name: /Users/jim/Documents/tfstage/tfstage/tfstage.py
# Compiled at: 2017-06-30 19:24:33
from __future__ import absolute_import
from __future__ import print_function
from __future__ import division
import os, pip, pystache, termcolor
...
def generate_project(project_name, install_dependencies=False):
    ...
    template_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), 'templates', 'template'))
