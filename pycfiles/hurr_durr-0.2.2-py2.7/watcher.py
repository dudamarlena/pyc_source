...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hurr_durr/watcher.py
# Compiled at: 2014-10-26 10:21:51
    ...
    def _handle(self, response):
        if response.code == 200:
            ...
            try:
                ...
                logger.info('Thread %d has %d posts, had %d => %d new', self._thread_id, curr_len, prev_len, curr_len - prev_len)
            except ValueError:
