...
# [GCC 8.4.0]
# Embedded file name: /Users/mrdon/dev/flask-async/venv/lib/python3.3/site-packages/flask/templating.py
...
class Environment(BaseEnvironment):
    __doc__ = "Works like a regular Jinja2 environment but has some additional\n    knowledge of how Flask's blueprint works so that it can prepend the\n    name of the blueprint to referenced templates if necessary.\n    "
...
class DispatchingJinjaLoader(BaseLoader):
    __doc__ = 'A loader that looks for templates in the application and all\n    the blueprint folders.\n    '
