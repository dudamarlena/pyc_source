...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/utils.py
...
parse_date_time_functions = {STYLE_DATE_TIME_NUMBERS: parse_date_time_numbers, 
...
def get_email_company_footer(logo, web_address):
    return '<br /> <div><img alt="" src="%s" (="" 62="" in="1.57" m)=" 113="" height="62" width="113"></div> <div><span style="font-family: Calibri;">Print Outsource International (POINT) </span></div> <div><span style="font-family: Calibri;">Leaders in Managed Print Solutions </span></div> <div><span style="font-family: Calibri;"><a href="http://%s">%s</a></div>' % (
