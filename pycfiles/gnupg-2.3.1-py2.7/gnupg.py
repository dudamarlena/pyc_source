...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gnupg/gnupg.py
...
import encodings, functools, os, re, textwrap
from . import _util
from . import _trust
...
class GPG(GPGBase):
    ...
    def __init__(self, binary=None, homedir=None, verbose=False, use_agent=False, keyring=None, secring=None, ignore_homedir_permissions=False, options=None):
        ...
        '/usr/bin/gpg'
        """
        super(GPG, self).__init__(binary=binary, home=homedir, keyring=keyring, secring=secring, options=options, verbose=verbose, use_agent=use_agent, ignore_homedir_permissions=ignore_homedir_permissions)
    ...
    def gen_key_input(self, separate_keyring=False, save_batchfile=False, testing=False, **kwargs):
        u"""Generate a batch file for input to :meth:`~gnupg.GPG.gen_key`.
