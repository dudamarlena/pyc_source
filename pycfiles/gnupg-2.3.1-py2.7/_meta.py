...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gnupg/_meta.py
# Compiled at: 2017-09-06 19:23:50
"""Meta and base classes for hiding internal functions, and controlling
attribute creation and handling.
"""
from __future__ import absolute_import
import atexit, codecs, encodings, locale, os, platform, shlex, subprocess, sys, threading
try:
    import psutil
except ImportError:
    psutil = None
