...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gnupg/_parsers.py
# Compiled at: 2017-09-06 19:13:23
    ...
    def _handle_status(self, key, value):
        ...
        if key in self.TRUST_LEVELS:
            ...
            self.trust_level = self.TRUST_LEVELS[key]
                     ...
                     'POLICY_URL', 'DECRYPTION_INFO', 'DECRYPTION_OKAY', 'INV_SGNR',
                     'PROGRESS', 'PINENTRY_LAUNCHED', 'SUCCESS'):
            pass
        elif key == 'KEY_CONSIDERED':
