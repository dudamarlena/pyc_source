...
# Size of source mod 2**32: 34502 bytes
"""
...
def parse_args():
    ...
    parser.add_argument('-u', '--UV', type=float, default=1.0, help='Value for the UV parameter for the model (default is 1.0)')
    ...
    parser.add_argument('-n', '--nsteps', type=int, default=None, help='Maximum number of steps (days) to run for the simulation. Each step represents one day in the outbreak (default is to run until the outbreak has finished).')
