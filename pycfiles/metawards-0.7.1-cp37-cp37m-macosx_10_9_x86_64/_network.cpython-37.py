...
class Network:
    ...
    @staticmethod
    def build(params: Parameters, calculate_distances: bool=True, build_function=None, distance_function=None, max_nodes: int=10050, max_links: int=2414000, nthreads: int=1, profile: bool=True, profiler=None):
