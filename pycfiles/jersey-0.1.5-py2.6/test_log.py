...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jersey/cases/test_log.py
...
class CLIObserverEmitCases(CLIObserverTestBase, TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = self.patch(self.cliObserverClass, '_getStream', self._getStream)
        CLIObserverTestBase.setUp(self)
