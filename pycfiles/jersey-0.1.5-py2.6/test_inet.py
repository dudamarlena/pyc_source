...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jersey/cases/test_inet.py
...
class AddressTestCase(TestCase):
    ...
    def test_AbstractAddress_fromBytes_error(self):
        self.assertRaises(AssertionError, inet.AbstractAddress.fromBytes, self.v4Bytes)
        self.assertRaises(AssertionError, inet.AbstractAddress.fromBytes, self.v6Bytes)
