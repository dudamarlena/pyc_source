...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/jersey/cli.py
...
from twisted.internet.defer import Deferred, succeed, fail, inlineCallbacks, returnValue, maybeDeferred, gatherResults
...
class AbstractCommandRunner(app.ApplicationRunner):
    ...
    def eb_setExitValue(self, reason):
        ...
        log.debug(('Setting exit value to {0} from {1}').format(self.exitValue, reason.getErrorMessage()))
        return reason
