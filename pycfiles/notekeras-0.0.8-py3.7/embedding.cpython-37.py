...
# Compiled at: 2020-01-19 03:59:05
# Size of source mod 2**32: 20812 bytes
...
__all__ = [
 'EmbeddingRet', 'EmbeddingSim', 'PositionEmbedding', 'TrigPosEmbedding', 'get_custom_objects',
...
def get_embedding(inputs, token_num, pos_num, embed_dim, dropout_rate=0.1, trainable=True):
    ...
    embeddings = [
     ...
     layers.Embedding(input_dim=2, output_dim=embed_dim,
       trainable=trainable,
