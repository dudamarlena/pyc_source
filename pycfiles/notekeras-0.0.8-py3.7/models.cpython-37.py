...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/algorithm/models.py
# Compiled at: 2020-01-19 04:16:28
...
class WrapLayer0(keras.models.Model):
    ...
    def __init__(self, name, dropout_rate=0.0, trainable=True, use_adapter=False, adapter_units=None, adapter_activation='relu', is_list=False):
