...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/optimizers/warmup.py
# Compiled at: 2020-01-19 04:11:51
# Size of source mod 2**32: 5753 bytes
...
class AdamWarmup(keras.optimizers.Optimizer):
    ...
    def __init__(self, decay_steps, warmup_steps, min_lr=0.0, learning_rate=0.001, beta_1=0.9, beta_2=0.999, epsilon=None, weight_decay=0.0, weight_decay_pattern=None, amsgrad=False, name='', **kwargs):
    ...
    def get_updates(self, loss, params):
        ...
        lr = K.switch(t <= self.warmup_steps, self.lr * (t / self.warmup_steps), self.min_lr + (self.lr - self.min_lr) * (1.0 - K.minimum(t, self.decay_steps) / self.decay_steps))
    ...
    def get_config(self):
        config = {'decay_steps':float(K.get_value(self.decay_steps)), 
