...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/storage/api.py
...
def initWorkerPostFork():
    ...
    logger.warning('Arbitrary sleep done here in order to minimize race conditions on opened connections to management database')
