...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dataclay/communication/grpc/clients/ExecutionEnvGrpcClient.py
# Compiled at: 2020-02-11 08:52:35
# Size of source mod 2**32: 21184 bytes
""" Class description goes here. """
import logging, sys, traceback, six, grpc
if six.PY2:
...
class EEClient(object):
    ...
    def ds_deploy_metaclasses(self, namespace_name, deployment_pack):
        ...
        request = dataservice_messages_pb2.DeployMetaClassesRequest(namespace=namespace_name,
    ...
    def ds_new_persistent_instance(self, session_id, class_id, implementation_id, i_face_bitmaps, params):
        logger.debug('Ready to call to a DS to build a new persistent instance for class {%s}', class_id)
        temp_iface_b = dict()
        temp_param = None
        ...
        request = dataservice_messages_pb2.NewPersistentInstanceRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def ds_store_objects(self, session_id, objects, moving, ids_with_alias):
        ...
        request = dataservice_messages_pb2.StoreObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objects=obj_list,
          moving=moving,
    ...
    def ds_new_metadata(self, md_infos):
        ...
        request = dataservice_messages_pb2.NewMetaDataRequest(mdInfos=md_infos_dict)
        try:
    ...
    def ds_get_copy_of_object(self, session_id, object_id, recursive):
        request = dataservice_messages_pb2.GetCopyOfObjectRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def ds_update_object(self, session_id, into_object_id, from_object):
        request = dataservice_messages_pb2.UpdateObjectRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def ds_get_objects(self, session_id, object_ids, recursive, moving):
        ...
        request = dataservice_messages_pb2.GetObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def get_referenced_objects_ids(self, session_id, object_ids):
        ...
        request = dataservice_messages_pb2.GetReferencedObjectIDsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectIDS=object_ids_list)
        try:
    ...
    def ds_get_federated_objects(self, dc_instance_id, object_ids):
        ...
        request = dataservice_messages_pb2.GetFederatedObjectsRequest(extDataClayID=(Utils.get_msg_options['dataclay_instance'](dc_instance_id)),
          objectIDS=object_ids_list)
        try:
    ...
    def ds_new_version(self, session_id, object_id, metadata_info):
        ...
        request = dataservice_messages_pb2.NewVersionRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def ds_consolidate_version(self, session_id, version_info):
        request = dataservice_messages_pb2.ConsolidateVersionRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def ds_upsert_objects(self, session_id, object_bytes):
        ...
        request = dataservice_messages_pb2.UpsertObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def make_persistent(self, session_id, params):
        ...
        request = dataservice_messages_pb2.MakePersistentRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def federate(self, session_id, params):
        request = dataservice_messages_pb2.FederateRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          params=(Utils.get_param_or_return(params)))
        try:
    ...
    def ds_execute_implementation(self, object_id, implementation_id, session_id, params):
        ...
        request = dataservice_messages_pb2.ExecuteImplementationRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          implementationID=(Utils.get_msg_options['implem'](implementation_id)),
          params=(Utils.get_param_or_return(params)),
          objectID=(Utils.get_msg_options['object'](object_id)))
        try:
    ...
    def ds_new_replica(self, session_id, object_id, recursive):
        request = dataservice_messages_pb2.NewReplicaRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
          recursive=recursive)
        try:
    ...
    def ds_move_objects(self, session_id, object_id, dest_st_location, recursive):
        request = dataservice_messages_pb2.MoveObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def ds_remove_objects(self, session_id, object_ids, recursive, moving, new_hint):
        ...
        request = dataservice_messages_pb2.RemoveObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def update_refs(self, ref_counting):
        ...
        request = dataservice_messages_pb2.UpdateRefsRequest(refsToUpdate=ref_counting)
        try:
    ...
    def store_to_db(self, execution_environment_id, object_id, obj_bytes):
        request = dataservice_messages_pb2.StoreToDBRequest(executionEnvironmentID=(Utils.get_msg_id_backend_id(execution_environment_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
          objBytes=obj_bytes)
        try:
    ...
    def get_from_db(self, execution_environment_id, object_id):
        request = dataservice_messages_pb2.GetFromDBRequest(executionEnvironmentID=(Utils.get_msg_id_backend_id(execution_environment_id)),
          objectID=(Utils.get_msg_options['object'](object_id)))
        try:
    ...
    def update_to_db(self, execution_environment_id, object_id, new_obj_bytes, dirty):
        request = dataservice_messages_pb2.UpdateToDBRequest(executionEnvironmentID=(Utils.get_msg_id_backend_id(execution_environment_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def delete_to_db(self, execution_environment_id, object_id):
        request = dataservice_messages_pb2.DeleteToDBRequest(executionEnvironmentID=(Utils.get_msg_id_backend_id(execution_environment_id)),
          objectID=(Utils.get_msg_options['object'](object_id)))
        try:
    ...
    def associate_execution_environment(self, execution_environment_id):
        request = dataservice_messages_pb2.AssociateExecutionEnvironmentRequest(executionEnvironmentID=(Utils.get_msg_id_backend_id(execution_environment_id)))
        try:
