...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dataclay/serialization/python/lang/FloatWrapper.py
...
class FloatWrapper(DataClayPythonWrapper):
    __doc__ = 'Single or double precision floating value type.'
