...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dataclay/communication/grpc/clients/LogicModuleGrpcClient.py
# Compiled at: 2020-02-11 08:52:35
# Size of source mod 2**32: 71366 bytes
""" Class description goes here. """
from datetime import datetime
import itertools, traceback, logging, sys, grpc, six
if six.PY2:
...
class LMClient(object):
    ...
    def create_stubs(self, hostname, port):
        ...
        if not Configuration.SSL_CLIENT_TRUSTED_CERTIFICATES != '':
            if Configuration.SSL_CLIENT_CERTIFICATE != '' or Configuration.SSL_CLIENT_KEY != '':
                try:
                ...
                if trusted_certs is not None:
                    credentials = grpc.ssl_channel_credentials(root_certificates=trusted_certs, private_key=client_key,
                      certificate_chain=client_cert)
                else:
                    credentials = grpc.ssl_channel_credentials(private_key=client_key, certificate_chain=client_cert)
    ...
    def autoregister_ee(self, id, name, hostname, port, lang):
        request = logicmodule_messages_pb2.AutoRegisterEERequest(executionEnvironmentID=(Utils.get_msg_options['backend_id'](id)),
          eeName=name,
          eeHostname=hostname,
          eePort=port,
          lang=lang)
    ...
    def perform_set_of_new_accounts(self, admin_id, admin_credential, yaml_file):
        request = logicmodule_messages_pb2.PerformSetAccountsRequest(accountID=(Utils.get_msg_options['account'](admin_id)),
    ...
    def perform_set_of_operations(self, performer_id, performer_credential, yaml_file):
        request = logicmodule_messages_pb2.PerformSetOperationsRequest(accountID=(Utils.get_msg_options['account'](performer_id)),
    ...
    def publish_address(self, hostname, port):
        request = logicmodule_messages_pb2.PublishAddressRequest(hostname=hostname,
          port=port)
    ...
    def new_account(self, admin_account_id, admin_credential, account):
        ...
        request = logicmodule_messages_pb2.NewAccountRequest(adminID=(Utils.get_msg_options['account'](admin_account_id)),
    ...
    def get_account_list(self, admin_account_id, admin_credential):
        request = logicmodule_messages_pb2.GetAccountListRequest(adminID=(Utils.get_msg_options['account'](admin_account_id)),
          admincredential=(Utils.get_credential(admin_credential)))
    ...
    def new_session(self, account_id, credential, contracts, data_sets, data_set_for_store, new_session_lang):
        ...
        request = logicmodule_messages_pb2.NewSessionRequest(accountID=(Utils.get_msg_options['account'](account_id)),
    ...
    def get_info_of_session_for_ds(self, session_id):
        request = logicmodule_messages_pb2.GetInfoOfSessionForDSRequest(sessionID=(Utils.get_msg_options['session'](session_id)))
        ...
        calendar = datetime.fromtimestamp(response.date / 1000.0).strftime('%Y-%m-%d %H:%M:%S')
        data_sets = set()
    ...
    def new_namespace(self, account_id, credential, namespace):
        ...
        request = logicmodule_messages_pb2.NewNamespaceRequest(accountID=account_id,
          credential=(Utils.get_credential(credential)),
    ...
    def remove_namespace(self, account_id, credential, namespace_name):
        request = logicmodule_messages_pb2.RemoveNamespaceRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_namespace_id(self, account_id, credential, namespace_name):
        request = logicmodule_messages_pb2.GetNamespaceIDRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespaceName=namespace_name)
    ...
    def get_object_dataset_id(self, session_id, oid):
        request = logicmodule_messages_pb2.GetObjectDataSetIDRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def get_info_of_classes_in_namespace(self, account_id, credential, namespace_id):
        request = logicmodule_messages_pb2.GetInfoOfClassesInNamespaceRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_classname_and_namespace_for_ds(self, class_id):
        request = logicmodule_messages_pb2.GetClassNameAndNamespaceForDSRequest(classID=(Utils.get_msg_options['class'](class_id)))
    ...
    def new_dataset(self, account_id, credential, dataset):
        ...
        request = logicmodule_messages_pb2.NewDataSetRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          datasetYaml=ds_yaml)
    ...
    def remove_dataset(self, account_id, credential, dataset_name):
        request = logicmodule_messages_pb2.RemoveDataSetRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_dataset_id(self, account_id, credential, dataset_name):
        request = logicmodule_messages_pb2.GetDataSetIDRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          dataSetName=dataset_name)
    ...
    def new_class(self, account_id, credential, language, new_classes):
        ...
        request = logicmodule_messages_pb2.NewClassRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          language=language,
          newClasses=new_cl)
    ...
    def new_class_id(self, account_id, credential, class_name, language, new_classes):
        ...
        request = logicmodule_messages_pb2.NewClassIDRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          language=language,
    ...
    def remove_class(self, account_id, credential, namespace_id, class_name):
        request = logicmodule_messages_pb2.RemoveClassRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          className=class_name)
    ...
    def remove_operation(self, account_id, credential, namespace_id, class_name, operation_signature):
        request = logicmodule_messages_pb2.RemoveOperationRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespace_id=(Utils.get_msg_options['namespace'](namespace_id)),
          className=class_name,
    ...
    def remove_implementation(self, account_id, credential, namespace_id, implementation_id):
        request = logicmodule_messages_pb2.RemoveImplementationRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespace_id=(Utils.get_msg_options['namespace'](namespace_id)),
    ...
    def get_operation_id(self, account_id, credential, namespace_id, class_name, operation_signature):
        request = logicmodule_messages_pb2.GetOperationIDRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespace_id=(Utils.get_msg_options['namespace'](namespace_id)),
          className=class_name,
          operationNameAndSignature=operation_signature)
    ...
    def get_property_id(self, account_id, credential, namespace_id, class_name, property_name):
        request = logicmodule_messages_pb2.GetPropertyIDRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_class_id(self, account_id, credential, namespace_id, class_name):
        request = logicmodule_messages_pb2.GetClassIDRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespaceID=(Utils.get_msg_options['namespace'](namespace_id)),
          className=class_name)
    ...
    def get_class_info(self, account_id, credential, namespace_id, class_name):
        request = logicmodule_messages_pb2.GetClassInfoRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespace_id=(Utils.get_msg_options['namespace'](namespace_id)),
          className=class_name)
    ...
    def new_contract(self, account_id, credential, new_contract_s):
        ...
        request = logicmodule_messages_pb2.NewContractRequest(accountID=(Utils.get_msg_options['account'](account_id)),
    ...
    def register_to_public_contract(self, account_id, credential, contract_id):
        request = logicmodule_messages_pb2.RegisterToPublicContractRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential),
    ...
    def get_contractids_of_applicant(self, applicant_account_id, credential):
        request = logicmodule_messages_pb2.GetContractIDsOfApplicantRequest(applicantID=(Utils.get_msg_options['account'](applicant_account_id)),
          credential=(Utils.get_credential(credential)))
    ...
    def get_contractids_of_provider(self, account_id, credential, namespaceid_of_provider):
        request = logicmodule_messages_pb2.GetDataContractIDsOfProviderRequest(providerID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_contractids_of_applicant_with_provider(self, account_id, credential, namespaceid_of_provider):
        request = logicmodule_messages_pb2.GetContractsOfApplicantWithProvRequest(applicantID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespaceIDOfProvider=(Utils.get_msg_options['namespace'](namespaceid_of_provider)))
    ...
    def new_data_contract(self, account_id, credential, new_datacontract):
        ...
        request = logicmodule_messages_pb2.NewDataContractRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def register_to_public_datacontract(self, account_id, credential, datacontract_id):
        request = logicmodule_messages_pb2.RegisterToPublicDataContractRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_datacontractids_of_provider(self, account_id, credential, datasetid_of_provider):
        request = logicmodule_messages_pb2.GetDataContractIDsOfProviderRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_datacontractids_of_applicant(self, applicant_accountid, credential):
        request = logicmodule_messages_pb2.GetDataContractIDsOfApplicantRequest(applicantID=(Utils.get_msg_options['account'](applicant_accountid)),
          credential=(Utils.get_credential(credential)))
    ...
    def get_datacontract_info_of_applicant_with_provider(self, applicant_accountid, credential, datasetid_of_provider):
        request = logicmodule_messages_pb2.GetDataContractInfoOfApplicantWithProvRequest(applicantID=(Utils.get_msg_options['account'](applicant_accountid)),
          credential=(Utils.get_credential(credential)),
          dataSetIDOfProvider=(Utils.get_msg_options['dataset'](datasetid_of_provider)))
    ...
    def new_interface(self, account_id, credential, new_interface_s):
        ...
        request = logicmodule_messages_pb2.NewInterfaceRequest(applicantID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def get_interface_info(self, account_id, credential, interface_id):
        request = logicmodule_messages_pb2.GetInterfaceInfoRequest(applicantID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
    ...
    def remove_interface(self, account_id, credential, namespace_id, interface_id):
        request = logicmodule_messages_pb2.RemoveInterfaceRequest(applicantID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          namespaceID=(Utils.get_msg_options['namespace'](namespace_id)),
          interfaceID=(Utils.get_msg_options['interface'](interface_id)))
    ...
    def get_storage_location_for_ds(self, st_loc_id):
        request = logicmodule_messages_pb2.GetStorageLocationForDSRequest(storageLocationID=(Utils.get_msg_options['storage_loc'](st_loc_id)))
    ...
    def get_executionenvironment_for_ds(self, backend_id):
        request = logicmodule_messages_pb2.GetExecutionEnvironmentForDSRequest(execEnvID=(Utils.get_msg_options['exec_env'](backend_id)))
    ...
    def get_dataclays_object_is_federated_with(self, object_id):
        request = logicmodule_messages_pb2.GetDataClaysObjectIsFederatedWithRequest(objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def get_external_source_of_dataclay_object(self, object_id):
        request = logicmodule_messages_pb2.GetExternalSourceDataClayOfObjectRequest(objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def register_objects_from_gc(self, reg_info, backend_id):
        reg_info_set = CommonMessages.RegistrationInfo(objectID=(Utils.get_msg_options['object'](reg_info[0])),
        ...
        request = logicmodule_messages_pb2.RegisterObjectForGCRequest(regInfo=reg_info_set,
    ...
    def register_object(self, reg_info, backend_id, alias, lang):
        reg_info = CommonMessages.RegistrationInfo(objectID=(Utils.get_msg_options['object'](reg_info[0])),
          classID=(Utils.get_msg_options['meta_class'](reg_info[1])),
          sessionID=(Utils.get_msg_options['session'](reg_info[2])),
          dataSetID=(Utils.get_msg_options['dataset'](reg_info[3])))
        request = logicmodule_messages_pb2.RegisterObjectRequest(regInfo=reg_info,
          backendID=(Utils.get_msg_options['backend_id'](backend_id)),
          alias=alias,
    ...
    def set_dataset_id_from_garbage_collector(self, object_id, dataset_id):
        request = logicmodule_messages_pb2.SetDataSetIDFromGarbageCollectorRequest(objectID=(Utils.get_msg_options['object'](object_id)),
          datasetID=(Utils.get_msg_options['dataset'](dataset_id)))
        try:
            logger.trace('Asynchronous call to register object from Garbage Collector for object %s', object_id)
    ...
    def federate_object(self, session_id, object_id, ext_dataclay_id, recursive):
        request = logicmodule_messages_pb2.FederateObjectRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def unfederate_object(self, session_id, object_id, ext_dataclay_id, recursive):
        request = logicmodule_messages_pb2.UnfederateObjectRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
          extDataClayID=(Utils.get_msg_options['dataclay_instance'](ext_dataclay_id)),
          recursive=recursive)
    ...
    def unfederate_all_objects(self, session_id, ext_dataclay_id):
        request = logicmodule_messages_pb2.UnfederateAllObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          extDataClayID=(Utils.get_msg_options['dataclay_instance'](ext_dataclay_id)))
    ...
    def unfederate_all_objects_with_all_dcs(self, session_id):
        request = logicmodule_messages_pb2.UnfederateAllObjectsWithAllDCsRequest(sessionID=(Utils.get_msg_options['session'](session_id)))
    ...
    def unfederate_object_with_all_dcs(self, session_id, object_id, recursive):
        request = logicmodule_messages_pb2.UnfederateObjectWithAllDCsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
          recursive=recursive)
    ...
    def federate_all_objects(self, session_id, dest_dataclay_id):
        request = logicmodule_messages_pb2.FederateAllObjectsRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          externalDestinationDataClayID=(Utils.get_msg_options['dataclay_instance'](dest_dataclay_id)))
    ...
    def get_external_dataclay_id(self, dcHost, dcPort):
        request = logicmodule_messages_pb2.GetExternalDataclayIDRequest(host=dcHost,
          port=dcPort)
    ...
    def get_external_dataclay_info(self, ext_dataclay_id):
        request = logicmodule_messages_pb2.GetExtDataClayInfoRequest(extDataClayID=(Utils.get_msg_options['dataclay_instance'](ext_dataclay_id)))
    ...
    def check_object_is_federated_with_dataclay_instance(self, object_id, ext_dataclay_id):
        request = logicmodule_messages_pb2.CheckObjectFederatedWithDataClayInstanceRequest(objectID=(Utils.get_msg_options['object'](object_id)),
          extDataClayID=(Utils.get_msg_options['dataclay_instance'](ext_dataclay_id)))
    ...
    def get_execution_environments_info(self, session_id, language, from_client):
        request = logicmodule_messages_pb2.GetExecutionEnvironmentsInfoRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def get_execution_environments_names(self, account_id, credential, language):
        request = logicmodule_messages_pb2.GetExecutionEnvironmentsNamesRequest(accountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)),
          execEnvLang=language)
    ...
    def get_object_info(self, session_id, object_id):
        request = logicmodule_messages_pb2.GetObjectInfoRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def get_object_from_alias(self, session_id, alias):
        request = logicmodule_messages_pb2.GetObjectFromAliasRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          alias=alias)
    ...
    def delete_alias(self, session_id, alias):
        request = logicmodule_messages_pb2.DeleteAliasRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          alias=alias)
    ...
    def set_dataset_id(self, session_id, object_id, dataset_id):
        request = logicmodule_messages_pb2.SetDataSetIDRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
          datasetID=(Utils.get_msg_options['dataset'](dataset_id)))
    ...
    def new_version(self, session_id, object_id, optional_dest_backend_id):
        request = logicmodule_messages_pb2.NewVersionRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def consolidate_version(self, session_id, version):
        request = logicmodule_messages_pb2.ConsolidateVersionRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def new_replica(self, session_id, object_id, backend_id, recursive):
        request = logicmodule_messages_pb2.NewReplicaRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def move_object(self, session_id, object_id, src_backend_id, dest_backend_id, recursive):
        request = logicmodule_messages_pb2.MoveObjectRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def set_object_read_only(self, session_id, object_id):
        request = logicmodule_messages_pb2.SetObjectReadOnlyRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def set_object_read_write(self, session_id, object_id):
        request = logicmodule_messages_pb2.SetObjectReadWriteRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def register_external_dataclay(self, exthostname, extport):
        request = logicmodule_messages_pb2.RegisterExternalDataClayRequest(hostname=exthostname,
          port=extport)
    ...
    def notify_registration_of_external_dataclay(self, dataclayid, exthostname, extport):
        request = logicmodule_messages_pb2.NotifyRegistrationOfExternalDataClayRequest(extDataClayID=dataclayid,
    ...
    def get_metadata_by_oid(self, session_id, object_id):
        request = logicmodule_messages_pb2.GetMetadataByOIDRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def execute_implementation(self, session_id, operation_id, remote_implementation, object_id, params):
        request = logicmodule_messages_pb2.ExecuteImplementationRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
    ...
    def execute_method_on_target(self, session_id, object_id, operation_signature, params, backend_id):
        request = logicmodule_messages_pb2.ExecuteMethodOnTargetRequest(sessionID=(Utils.get_msg_options['session'](session_id)),
          objectID=(Utils.get_msg_options['object'](object_id)),
          operationNameAndSignature=operation_signature,
          params=(Utils.get_param_or_return(params)),
    ...
    def synchronize_federated_object(self, dataclay_id, object_id, impl_id, params):
        if params is not None:
            request = logicmodule_messages_pb2.SynchronizeFederatedObjectRequest(extDataClayID=(Utils.get_msg_options['dataclay_instance'](dataclay_id)),
              objectID=(Utils.get_msg_options['object'](object_id)),
    ...
    def object_exists_in_dataclay(self, object_id):
        request = logicmodule_messages_pb2.ObjectExistsInDataClayRequest(objectID=(Utils.get_msg_options['object'](object_id)))
    ...
    def get_stubs(self, applicant_account_id, applicant_credential, language, contracts_ids):
        ...
        request = logicmodule_messages_pb2.GetStubsRequest(applicantAccountID=(Utils.get_msg_options['account'](applicant_account_id)),
    ...
    def get_babel_stubs(self, applicant_account_id, applicant_credential, contracts_ids):
        ...
        request = logicmodule_messages_pb2.GetBabelStubsRequest(accountID=(Utils.get_msg_options['account'](applicant_account_id)),
          credentials=(Utils.get_credential(applicant_credential)),
          contractIDs=cid_list)
    ...
    def register_event_listener_implementation(self, account_id, credential, new_event_listener):
        request = logicmodule_messages_pb2.RegisterECARequest(applicantAccountID=(Utils.get_msg_options['account'](account_id)),
    ...
    def advise_event(self, new_event):
        request = logicmodule_messages_pb2.AdviseEventRequest(eventYaml=(dataclay_yaml_dump(new_event)))
    ...
    def get_class_name_for_ds(self, class_id):
        request = logicmodule_messages_pb2.GetClassNameForDSRequest(classID=(Utils.get_msg_options['meta_class'](class_id)))
    ...
    def get_class_name_and_namespace_for_ds(self, class_id):
        request = logicmodule_messages_pb2.GetClassNameAndNamespaceForDSRequest(classID=(Utils.get_msg_options['meta_class'](class_id)))
        lm_function = lambda request: self.lm_stub.getClassNameAndNamespaceForDS.future(request=request, metadata=(self.metadata_call))
        response = self._call_logicmodule(request, lm_function)
        if response.excInfo.isException:
            raise DataClayException(response.excInfo.exceptionMessage)
    ...
    def get_contract_id_of_dataclay_provider(self, account_id, credential):
        request = logicmodule_messages_pb2.GetContractIDOfDataClayProviderRequest(applicantAccountID=(Utils.get_msg_options['account'](account_id)),
          credential=(Utils.get_credential(credential)))
    ...
    def close_session(self, session_id):
        request = logicmodule_messages_pb2.CloseSessionRequest(sessionID=(Utils.get_msg_options['session'](session_id)))
    ...
    def add_alias(self, object_id, alias):
        request = logicmodule_messages_pb2.AddAliasRequest(objectIDToHaveAlias=(Utils.get_msg_options['object_id'](object_id)),
          alias=alias)
