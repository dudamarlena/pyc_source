...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterField(model_name=b'voucher', name=b'expire_at', field=models.DateTimeField(default=datetime.datetime(2219, 1, 29, 17, 28, 5, 432761), verbose_name=b'Expire at'))]