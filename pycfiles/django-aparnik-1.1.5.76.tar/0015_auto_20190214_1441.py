...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterField(model_name=b'user', name=b'username_mention', field=models.CharField(default=b'a', max_length=100, unique=True, verbose_name=b'Username for mention'), preserve_default=False)]