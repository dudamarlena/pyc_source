...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/autoforms/models.py
...
def form_fill_notify(sender, form, instance, **kwargs):
    if getattr(settings, 'NOTIFY_FORM_CHANGE', False):
        ...
        send_mail('New commit for form %s' % form.name, msg, 'notfiy@jeffkit.info', [form.user.email], fail_silently=True)
