...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/autoforms/forms.py
...
field_types = {'boolean': forms.BooleanField, 
...
widget_types = {'text': forms.TextInput, 
...
field_required_arguments = {'choice': 'choices', 
        ...
        for field in fields:
            ...
            if field.type in ('modelChoice', 'modelMultipleChoice'):
                if field.datasource:
                    ...
                    raise ValueError, '%s need a datasource!' % field.name
                ...
                if required_arguments:
                    ...
                    for arg in required_arguments:
                        if arg not in kwargs:
                            raise ValueError, 'argument "%s" for %s is required' % (arg, field.name)
