...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/adminlteui/models.py
...
class Menu(MP_Node):
    ...
    priority_level = models.IntegerField(default=100, verbose_name=(_('Priority Level')),
