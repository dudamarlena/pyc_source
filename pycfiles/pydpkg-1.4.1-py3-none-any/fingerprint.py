...
# Embedded file name: /home/orient/pydpi/src/pydpi/drug/fingerprint.py
# Compiled at: 2012-10-15 22:37:43
...
def CalculateAtomPairsFingerprint(mol):
    ...
    return (
     res.GetLength(), res.GetNonzeroElements(), res)
...
_FingerprintFuncs = {'topological': CalculateDaylightFingerprint, 'Estate': CalculateEstateFingerprint, 
...
if __name__ == '__main__':
    print 'fingerprint......'
    ms = [
     Chem.MolFromSmiles('CCOC=N'), Chem.MolFromSmiles('CCO')]
