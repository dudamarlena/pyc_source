...
# Embedded file name: /home/orient/pydpi/src/pydpi/drug/topology.py
# Compiled at: 2013-07-13 03:09:41
...
_Topology = {'W': CalculateWeiner, 'AW': CalculateMeanWeiner, 
   'J': CalculateBalaban, 
...
if __name__ == '__main__':
    smis = [
     'CCCC', 'CCCCC', 'CCCCCC', 'CC(N)C(=O)O', 'CC(N)C(=O)[O-]']
