...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gleipnir/pysb_utilities/hyp_selector.py
# Compiled at: 2019-07-02 15:48:17
# Size of source mod 2**32: 12699 bytes
import numpy as np, pandas as pd, os, shutil, glob, importlib, warnings
try:
    import HypBuilder
...
class HypSelector(object):
    ...
    def gen_nested_samplers(self, timespan, observable_data, solver=pysb.simulator.ScipyOdeSimulator, solver_kwargs=None, ns_version='gleipnir-classic', ns_population_size=1000, ns_kwargs=None, log_likelihood_type='logpdf'):
        ...
        for i, model in enumerate(self.models):
            sample_it = NestedSampleIt(model, observable_data, timespan, solver=solver,
              solver_kwargs=solver_kwargs)
            ns_sampler = sample_it(ns_version, ns_population_size=ns_population_size,
              ns_kwargs=ns_kwargs,
    ...
    def bayes_factors(self):
        ...
        return pd.DataFrame(bayes_factors, index=mod_list, columns=mod_list)
