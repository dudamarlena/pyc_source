...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gleipnir/nsbase.py
...
class NestedSamplingBase(ABC):
    __doc__ = 'Abstract base class for Nested Samplers.'
    ...
    def best_fit_posterior(self):
        ...
        return (
         np.array(mparms), np.array(errors) / 2.0)