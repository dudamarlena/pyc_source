...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/h5pyd/_apps/hsload.py
# Compiled at: 2020-02-03 14:33:59
...
def main():
    ...
    if len(src_files) > 1 and not domain[0] != '/':
        if domain[(-1)] != '/':
    ...
    try:
        for src_file in src_files:
            ...
            if not src_file_chk.scheme == 'http':
                if src_file_chk.scheme == 'https' or src_file_chk.scheme == 'ftp':
