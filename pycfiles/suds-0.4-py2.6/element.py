...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/suds/sax/element.py
# Compiled at: 2010-08-31 10:51:22
"""
...
class Element():
    ...
    def __eq__(self, rhs):
        return rhs is not None and isinstance(rhs, Element) and self.name == rhs.name and self.namespace()[1] == rhs.namespace()[1]
