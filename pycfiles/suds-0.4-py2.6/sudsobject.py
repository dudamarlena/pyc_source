...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/suds/sudsobject.py
# Compiled at: 2010-01-20 19:14:24
"""
    ...
    def __keylist(self, sobject):
        ...
        try:
            ...
            if not ordered.issuperset(keyset):
                log.debug('%s must be superset of %s, ordering ignored', keylist, ordering)
                raise KeyError()
            return ordering
        except:
            return keylist
