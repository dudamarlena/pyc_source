...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/suds/xsd/sxbasic.py
# Compiled at: 2010-08-17 11:05:58
"""
...
class Complex(SchemaObject):
    ...
    def childtags(self):
        return ('attribute', 'attributeGroup', 'sequence', 'all', 'choice', 'complexContent',
                'simpleContent', 'any', 'group')
...
class Factory:
    ...
    def collate(cls, children):
        ...
        return (
         children, imports, attributes, elements, types, groups, agrps)


Import.bind('http://schemas.xmlsoap.org/soap/encoding/', 'suds://schemas.xmlsoap.org/soap/encoding/')
