...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dynamo\handlers.py
...
from dynamo import pre_model_creation, post_model_creation, pre_model_update, post_model_update, pre_model_delete, post_model_delete, pre_field_creation, post_field_creation, pre_field_update, post_field_update, pre_field_delete, post_field_delete
