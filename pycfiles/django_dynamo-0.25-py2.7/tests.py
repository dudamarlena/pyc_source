...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\dynamo\tests.py
...
class TestDynamicModel(TestCase):
    ...
    def setUp(self):
        ...
        self.field3.save()
        self.field4 = MetaField(meta_model=self.meta1, name='field4', description='field2', type='ForeignKey', related_model='dynamo_app.TestModel', order=4)
        self.field4.save()
        self.field5 = MetaField(meta_model=self.meta1, name='field5', description='field2', type='ForeignKey', related_model='dynamo.%s' % self.meta2.model_name, order=5)
        self.field5.save()
