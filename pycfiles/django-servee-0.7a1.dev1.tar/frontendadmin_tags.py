...
# [GCC 8.4.0]
# Embedded file name: /Users/issackelly/Projects/python/servee/servee/frontendadmin/templatetags/frontendadmin_tags.py
# Compiled at: 2012-09-09 14:37:06
...
class AddObject(Tag):
    ...
    **add_class** Optional. Optional class to add to the link.
    ...
    options = Options(Argument('querysetish', required=True), Argument('label', required=False, resolve=False), Argument('add_class', required=False, resolve=False))
    ...
    def render_tag(self, context, querysetish, label=None, add_class=None):
        if isinstance(querysetish, basestring) and '.' in querysetish:
            ...
            if isinstance(querysetish, QuerySet):
...
class ChangeObject(Tag):
    ...
    **add_class** Optional. Optional class to add to the link.
    ...
    options = Options(Argument('model_instance', required=True), Argument('label', required=False, resolve=False), Argument('add_class', required=False, resolve=False))
...
class ListObjects(Tag):
    ...
    **add_class** Optional. Optional class to add to the link.
    ...
    options = Options(Argument('modelish', required=True), Argument('label', required=False, resolve=False), Argument('add_class', required=False, resolve=False))
    ...
    def render_tag(self, context, modelish, label=None, add_class=None):
        if isinstance(modelish, basestring) and '.' in modelish:
            ...
            if isinstance(modelish, QuerySet):
