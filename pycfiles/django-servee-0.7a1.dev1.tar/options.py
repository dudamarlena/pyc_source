...
# [GCC 8.4.0]
# Embedded file name: /Users/issackelly/Projects/python/servee/servee/frontendadmin/options.py
...
class ServeeModelAdmin(ModelAdmin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_form_template = [
         ...
         'admin/%s/add_form.html' % app_label].append(self.change_form_template)
