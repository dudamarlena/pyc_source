...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/hadoop_mock/hadoop_ssh.py
# Compiled at: 2015-04-20 10:25:55
...
def main(host, opts, sudo, args):
    ...
    try:
        try:
            subprocess.check_call(ssh_cmd + sudo + ['hadoop'] + [ quote(arg) for arg in args ])
