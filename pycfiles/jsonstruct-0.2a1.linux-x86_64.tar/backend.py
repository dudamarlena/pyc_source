...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/jsonstruct/backend.py
...
class JSONBackend(object):
    ...
    def __init__(self):
        ...
        json_opts = (
         (), {'sort_keys': True})
        self._encoder_options = {'json': json_opts, 
    ...
    def _verify(self):
        ...
        if self._verified:
            return
        raise AssertionError('jsonstruct requires at least one of the following:\n    python2.6, simplejson, or demjson')
