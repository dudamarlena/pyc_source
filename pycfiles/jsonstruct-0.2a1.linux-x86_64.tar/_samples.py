...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/jsonstruct/_samples.py
# Compiled at: 2013-08-09 10:47:32
import collections, datetime, jsonstruct
...
class ThingWithProps(object):
    ...
    def _get_identity(self):
        keys = [
         self.dogs, self.monkies, self.name]
    ...
    def __getstate__(self):
        out = dict(__identity__=self.identity, nom=self.name, dogs=self.dogs, monkies=self.monkies)
        return out
