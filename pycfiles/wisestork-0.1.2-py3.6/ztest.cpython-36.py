...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/wisestork/ztest.py
...
import sys, numpy as np, progressbar
...
def ztest(input_path, output_path, database_path):
    ...
    if not len(bedlines) == len(refdict):
        raise ValueError('Reference and query bed files are of different size!')
