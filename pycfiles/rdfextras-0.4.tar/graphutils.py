...
# [GCC 8.4.0]
# Embedded file name: /home/grimnes/projects/rdflib/rdfextras/rdfextras/utils/graphutils.py
# Compiled at: 2012-10-05 05:39:21
...
def get_tree(graph, root, prop, mapper=lambda x: x, sortkey=None, done=None, dir='down'):
    ...
    if root in done:
        ...
        return (
         mapper(root), sorted(tree, key=sortkey))
