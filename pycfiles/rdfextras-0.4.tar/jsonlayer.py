...
# [GCC 8.4.0]
# Embedded file name: /home/grimnes/projects/rdflib/rdfextras/rdfextras/sparql/results/jsonlayer.py
...
def _initialize():
    ...
    def _init_simplejson():
        ...
        _encode = lambda obj, dumps=simplejson.dumps: dumps(obj, allow_nan=False, ensure_ascii=False)
    ...
    def _init_stdlib():
        ...
        _encode = lambda obj, dumps=json.dumps: dumps(obj, allow_nan=False, ensure_ascii=False)
