...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/kdsearch/kdtree.py
# Compiled at: 2017-03-03 07:36:06
# Size of source mod 2**32: 3078 bytes
import numpy
from .statistics import Statistics

class KDTree:
    __doc__ = 'Tree structure for fast queries on multi-dimensional data'
