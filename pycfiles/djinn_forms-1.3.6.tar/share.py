...
# [GCC 8.4.0]
# Embedded file name: /home/bouma/gitprojects/provgroningen/buildout/src/djinn_forms/djinn_forms/widgets/share.py
...
class ShareWidget(Widget):
    ...
    def render(self, name, value, attrs=None):
        ...
        if value:
            related = [ (object_to_urn(obj), unicode(obj)) for obj in value.get('add', []) ]
        if value:
