...
# [GCC 8.4.0]
# Embedded file name: /home/bouma/gitprojects/provgroningen/buildout/src/djinn_forms/djinn_forms/widgets/attachment.py
...
class AttachmentWidget(forms.widgets.Widget):
    ...
    def value_from_datadict(self, data, files, name):
        ...
        if self.attrs.get('multiple', False):
            ...
            try:
                _val = int(re.search('([0-9]+)', data.get(name)).group(1))
            except:
                pass
