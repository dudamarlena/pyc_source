...
# [GCC 8.4.0]
# Embedded file name: /home/bouma/gitprojects/provgroningen/buildout/src/djinn_forms/djinn_forms/widgets/richtext.py
# Compiled at: 2014-12-01 06:49:49
...
class RichTextWidget(Widget):
    ...
    def __init__(self, img_type='djinn_contenttypes.ImgAttachment', enable_images=True, enable_links=True, maxchars=-1, attrs=None):
    ...
    def _media(self):
        """ Add JS for TinyMCE """
        return Media(js=('tinymce/tinymce.jquery.js', 'tinymce/jquery.tinymce.min.js',
                         'js/djinn_forms_richtext.js', 'js/djinn_forms_link.js'))
    ...
    def render(self, name, value, attrs=None):
        ...
        context = {'attributes': flatatt(final_attrs), 
           'name': name, 
