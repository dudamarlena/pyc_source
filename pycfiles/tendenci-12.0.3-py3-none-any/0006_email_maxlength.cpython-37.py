...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/helpdesk/migrations/0006_email_maxlength.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterField(model_name='queue',
       name='email_address',
     ...
     migrations.AlterField(model_name='ticketcc',
       name='email',
