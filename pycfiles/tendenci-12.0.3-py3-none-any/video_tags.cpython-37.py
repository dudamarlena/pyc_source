...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/videos/templatetags/video_tags.py
...
def video_current_app(context, user, video=None):
    context.update({'app_object':video, 
     'user':user})
    return context
...
def video_options(context, user, video):
    context.update({'opt_object':video, 
     'user':user})
    return context
