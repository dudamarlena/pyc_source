...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/testimonials/templatetags/testimonial_tags.py
...
def testimonial_options(context, user, testimonial):
    context.update({'opt_object':testimonial, 
     'user':user})
    return context
...
def testimonial_current_app(context, user, testimonial=None):
    context.update({'app_object':testimonial, 
     'user':user})
    return context
