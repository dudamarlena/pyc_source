...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/libs/model_report/highcharts/options.py
...
def get_highchart_data():
    ...
    ChartData = {'alignTicks':true, 
     ...
     'width':null, 
     'zoomType':''}
    CreditsData = {'enabled': false}
    TitleData = {'align':'center', 
     'floating':false, 
     'margin':15, 
     'text':null, 
     ...
     'x':15, 
     'y':15}
    SubtitleData = {'align':'center', 
     'floating':false, 
     'text':'', 
     'style':{},  'verticalAlign':'top', 
     'x':0, 
     'y':30}
    xAxisData = {'allowDecimals':true, 
     'alternateGridColor':null, 
     'categories':[],  'dateTimeLabelFormats':null, 
     'endOnTick':false, 
     'events':{},  'gridLineColor':'#C0C0C0', 
     'gridLineDashStyle':Solid, 
     'gridLineWidth':0, 
     'id':null, 
     'labels':{},  'lineColor':'#C0D0E0', 
     'lineWidth':1, 
     'linkedTo':null, 
     'max':null, 
     'maxPadding':0.01, 
     ...
     'offset':0, 
     'opposite':false, 
     'plotBands':[{}],  'plotLines':[{}],  'reversed':false, 
     'showFirstLabel':true, 
     'showLastLabel':false, 
     'startOfWeek':1, 
     'startOnTick':false, 
     ...
     'type':'linear'}
    yAxisPlotData = {'value':null, 
     'width':null, 
     'color':null}
    yAxisData = {'endOnTick':true, 
     'gridLineWidth':1, 
     'lineWidth':0, 
     'maxPadding':0.05, 
     'minPadding':0.05, 
     'showLastLabel':true, 
     'stackLabels':{},  'startOnTick':true, 
     'tickWidth':0, 
     'allowDecimals':true, 
     'alternateGridColor':null, 
     'categories':[],  'dateTimeLabelFormats':null, 
     ...
     'offset':0, 
     'opposite':false, 
     'plotBands':[{}],  'plotLines':CollectionObject(), 
     'reversed':false, 
     'showFirstLabel':true, 
     'startOfWeek':1, 
     'tickColor':'#C0D0E0', 
     ...
     'title':DictObject(**TitleData), 
     'type':'linear'}
    TooltipData = {'backgroundColor':'rgba(255, 255, 255, .85)', 
     'borderColor':'auto', 
     'borderRadius':5, 
     'borderWidth':2, 
     'crosshairs':null, 
     ...
     'shared':false, 
     'snap':0.4, 
     'style':{},  'valueDecimals':null, 
     'valuePrefix':'', 
     'valueSuffix':'', 
     'xDateFormat':null, 
     'useHTML':false}
    SeriesData = {'data':[],  'dataParser':null, 
     'dataURL':null, 
    ...
    plotOptionsDataPIE_Labels = {'align':null, 
     'connectorWidth':1, 
     ...
     'y':-6, 
     'overflow':undefined}
    plotOptionsDataPIE = {'borderColor':'#FFFFFF', 
     'borderWidth':1, 
     'center':[
      '50%', '50%'], 
     'innerSize':0, 
     ...
     'events':{},  'id':null, 
     'lineWidth':2, 
     'marker':{},  'point':{},  'pointStart':0, 
     'pointInterval':1, 
     'selected':false, 
     'shadow':true, 
     'showCheckbox':false, 
     'stacking':null, 
     'states':{},  'stickyTracking':true, 
     'tooltip':{},  'turboThreshold':1000, 
     'visible':true, 
     'zIndex':null}
    plotOptionsDataCOLUMN = {'borderColor':'#FFFFFF', 
     'borderRadius':0, 
     'borderWidth':1, 
     'colorByPoint':false, 
     'cropThreshold':50, 
     ...
     'cursor':'', 
     'dashStyle':null, 
     'dataLabels':{},  'enableMouseTracking':true, 
     'events':{},  'id':null, 
     'lineWidth':2, 
     'marker':{},  'point':{},  'pointStart':0, 
     'pointInterval':1, 
     ...
     'visible':true, 
     'zIndex':null}
    plotOptionsDataLINEdataLabels = {'align':'center', 
     'backgroundColor':undefined, 
     'borderColor':undefined, 
     'borderRadius':0, 
     'borderWidth':0, 
     ...
     'x':0, 
     'y':-6}
    plotOptionsDataLINE = {'allowPointSelect':false, 
     'animation':true, 
     'connectEnds':true, 
     'connectNulls':false, 
     'cropThreshold':300, 
     ...
     'visible':true, 
     'zIndex':null}
    plotOptionsData = {'area':{},  'areaspline':{},  'bar':{},  'column':DictObject(**plotOptionsDataCOLUMN), 
     'line':DictObject(**plotOptionsDataLINE), 
     'pie':DictObject(**plotOptionsDataPIE), 
     'series':[{}],  'scatter':{},  'spline':{}}
    legendData = {'align':'center', 
     ...
     'enabled':true, 
     'floating':false, 
     'itemHiddenStyle':{},  'itemHoverStyle':{},  'itemMarginBottom':0, 
     'itemMarginTop':0, 
     'itemStyle':{},  'itemWidth':null, 
     'layout':'horizontal', 
     'labelFormatter':null, 
     'lineHeight':16, 
     'margin':15, 
     'navigation':{},  'padding':8, 
     'reversed':false, 
     'rtl':false, 
     'shadow':false, 
     'style':{},  'symbolPadding':5, 
     'symbolWidth':30, 
     'verticalAlign':'bottom', 
     'width':null, 
     'x':0, 
     'y':0}
    langData = {'decimalPoint':'.', 
    ...
    HighchartData = dict(credits=DictObject(**CreditsData),
