...
# [GCC 8.4.0]
# Embedded file name: /Users/jennyq/.pyenv/versions/venv_t12/lib/python3.7/site-packages/tendenci/apps/jobs/templatetags/job_tags.py
# Compiled at: 2020-02-26 14:48:40
# Size of source mod 2**32: 4346 bytes
...
def job_pricing_options(context, user, job_pricing):
    context.update({'opt_object':job_pricing, 
     'user':user})
    return context
...
def job_pricing_table(context):
    ...
    context.update({'job_pricings':job_pricings, 
...
def job_pricing_current_app(context, user, job_pricing=None):
    context.update({'app_object':job_pricing, 
     'user':user})
    return context
