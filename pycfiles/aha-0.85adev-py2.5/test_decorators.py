...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/aha/controller/tests/test_decorators.py
# Compiled at: 2011-03-07 01:50:56
...
class TestDecorators(TestCase):
    ...
    def test_cache(self):
        ...
        hdn2.handle3()
        assert_equal(memcache.get('/the_url'), None)
        assert_equal(memcache.get('/the_url', namespace='ns').get('body'), 'handle3')
        return