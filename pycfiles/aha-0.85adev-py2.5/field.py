...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.3-i386/egg/aha/widget/field.py
# Compiled at: 2011-03-30 04:05:57
"""
...
__licence__ = 'BSD'
__all__ = ('BaseField', 'TextField', 'HiddenField', 'RadioField', 'CheckboxGroup',
           'PasswordField', 'ButtonField', 'CheckboxField', 'SelectField', 'TextArea',
           'RichText', 'DescriptionField', 'FileField', 'ImageField')
import os
...
class TextField(BaseField):
    ...
    def __init__(self, name=None, enginename='', title='', desc='', args={}, objects=[], required=False, default='', validator=None, generate_id=False, collapsable=False):
        """
    ...
    def render_body(self, value=None, engine='', translate=unicode):
        ...
        """
        context = {'args': self.expand_args(value=value), 
           'title': self.title, 
           'TYPE': self.TYPE}
...
class CheckboxField(TextField):
    ...
    def __init__(self, name=None, enginename='', title='', desc='', field_desc='', value='', args={}, objects=[], required=False, default='', validator=None, generate_id=False, collapsable=False):
        """
        A initialization method.
        """
        self.value = value
        self.field_desc = field_desc
        TextField.__init__(self, name, enginename, title, desc, args, objects, required, id, validator, generate_id, collapsable)
...
class RadioField(TextField):
    ...
    def __init__(self, name=None, enginename='', title='', desc='', values=[], args={}, objects=[], required=False, default='', validator=None, generate_id=False, collapsable=False, vertical=False):
        """
        Initialization function.
        """
        ...
        self.values = values
        TextField.__init__(self, name, enginename, title, desc, args, objects, required, default, validator, generate_id, collapsable)
...
class CheckboxGroup(TextField):
    ...
    def __init__(self, name=None, enginename='', title='', desc='', values=[], args={}, objects=[], required=False, default='', validator=None, generate_id=False, vertical=False, collapsable=False):
        """
        Initialization function.
        """
        self.vertical = vertical
