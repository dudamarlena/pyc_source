...
# [GCC 8.4.0]
# Embedded file name: /home/goose/miniconda3/envs/railgun/lib/python3.7/site-packages/railgun/railgun.py
# Compiled at: 2019-06-23 16:11:29
...
class Railgun(object):
    ...
    def __init__(self, semaphores_count: Optional[int]=50, timeout: Optional[int]=5, retry: Optional[bool]=False, loop: Optional[any]=asyncio.get_event_loop()):
    ...
    def _setup_jobs(self, *args) -> list:
        ...
        :return: list
        """
        return [asyncio.ensure_future(self.run_async_job(deepcopy(task), self.semaphores)) for task in args]
    ...
    def _setup_repeat_jobs(self, func, args, repeat=0) -> list:
        ...
        :return: list
        """
        return [asyncio.ensure_future(self.run_async_job(deepcopy(func(*args)), self.semaphores)) for _ in range(0, repeat)]
