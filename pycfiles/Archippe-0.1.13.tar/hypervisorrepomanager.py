...
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagentvmcasting/hypervisorrepomanager.py
# Compiled at: 2013-03-20 13:50:16
import os, sqlite3, time, urllib, urllib2, vmcastmaker, xmpp
...
class TNHypervisorRepoManager(TNArchipelPlugin):
    ...
    def __init__(self, configuration, entity, entry_point_group):
        ...
        self.own_vmcastmaker = vmcastmaker.VMCastMaker(self.configuration.get('VMCASTING', 'own_vmcast_name').replace('$HOSTNAME', self.entity.resource), self.configuration.get('VMCASTING', 'own_vmcast_uuid'), self.configuration.get('VMCASTING', 'own_vmcast_description').replace('$HOSTNAME', self.entity.resource), self.configuration.get('VMCASTING', 'own_vmcast_lang'), self.configuration.get('VMCASTING', 'own_vmcast_url'), self.configuration.get('VMCASTING', 'own_vmcast_path'))
    ...
    def getFeed(self, data):
        ...
        return (
         feed_content, feed_uuid, feed_description, feed_name, items)
