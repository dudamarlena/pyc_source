...
# Embedded file name: build/bdist.linux-x86_64/egg/archipel/archipelVirtualMachine.py
...
import libvirt, os, shutil, thread, xmpp, tempfile, base64, time
...
class TNArchipelVirtualMachine(TNArchipelEntity, TNHookableEntity, TNAvatarControllableEntity, TNTaggableEntity, TNRosterQueryableEntity):
    ...
    def init_vocabulary(self):
        ...
        registrar_items = [
         {'commands': ['start', 'create', 'boot', 'play', 'run'], 'parameters': [], 'method': self.message_create, 
            'permissions': [
                          'create'], 
            'description': "I'll start"},
         {'commands': ['shutdown', 'stop'], 'parameters': [], 'method': self.message_shutdown, 
            'permissions': [
                          'shutdown'], 
            'description': "I'll shutdown"},
         {'commands': ['destroy'], 'parameters': [], 'method': self.message_destroy, 
            'permissions': [
                          'destroy'], 
            'description': "I'll destroy myself"},
         {'commands': ['pause', 'suspend'], 'parameters': [], 'method': self.message_suspend, 
            'permissions': [
                          'suspend'], 
            'description': "I'll suspend"},
         {'commands': ['resume', 'unpause'], 'parameters': [], 'method': self.message_resume, 
            'permissions': [
                          'resume'], 
            'description': "I'll resume"},
         {'commands': ['info', 'how are you', 'and you'], 'parameters': [], 'method': self.message_info, 
            'permissions': [
                          'info'], 
            'description': "I'll give info about me"},
         {'commands': ['desc', 'xml'], 'parameters': [], 'permissions': [
                          'xmldesc'], 
            'method': self.message_xmldesc, 
            'description': "I'll show my description"},
         {'commands': ['net', 'stat'], 'parameters': [], 'method': self.message_networkinfo, 
            'permissions': [
                          'networkinfo'], 
            'description': "I'll show my network stats"},
         {'commands': ['fuck', 'asshole', 'jerk', 'stupid', 'suck'], 'ignore': True, 
            'parameters': [], 'method': self.message_insult, 
            'description': ''},
         {'commands': ['hello', 'hey', 'hi', 'good morning', 'yo'], 'ignore': True, 
            'parameters': [], 'method': self.message_hello, 
            'description': ''}]
    ...
    def message_info(self, msg):
        ...
        try:
            i = self.info()
            states = ('no state', 'running', 'blocked', 'paused', 'shutdown', 'shut off',
                      'crashed')
