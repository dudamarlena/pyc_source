...
# [GCC 8.4.0]
# Embedded file name: /home/devel/thasso/git/github/gemtools/python/test/mapper_tests.py
...
def test_merging_maps_files():
    ...
    for read in merger:
        ...
        if read.tag == 'HWI-ST661:153:D0FTJACXX:2:1102:13866:124450':
            ...
            assert read.tag == 'HWI-ST661:153:D0FTJACXX:2:1102:14211:124259' and read.to_map().split('\t')[3] == '1', read.to_map()
...
def test_merging_maps_to_file():
    ...
    for read in merger:
        ...
        if read.tag == 'HWI-ST661:153:D0FTJACXX:2:1102:13866:124450 1:N:0:GCCAAT':
            ...
            assert read.tag == 'HWI-ST661:153:D0FTJACXX:2:1102:14211:124259 1:N:0:GCCAAT' and read.to_map().split('\t')[3] == '1'
            assert read.to_map().split('\t')[4] == 'chr15:+:72492866:75'
...
def test_interleaved_pair_aligner_run():
    ...
    assert sum(1 for x in paired) == 20000
    return
