...
# Embedded file name: build/bdist.linux-armv7l/egg/pycuda/cumath.py
# Compiled at: 2015-06-16 13:16:13
from __future__ import absolute_import
import pycuda.gpuarray as gpuarray, pycuda.elementwise as elementwise, numpy as np, warnings
...
def _make_unary_array_func(name):
    ...
    def f(array, stream_or_out=None, **kwargs):
        ...
        func.prepared_async_call(array._grid, array._block, stream, array.gpudata, out.gpudata, array.mem_size)
        return out
...
def fmod(arg, mod, stream=None):
    ...
    func.prepared_async_call(arg._grid, arg._block, stream, arg.gpudata, mod.gpudata, result.gpudata, arg.mem_size)
    return result
...
def frexp(arg, stream=None):
    ...
    func.prepared_async_call(arg._grid, arg._block, stream, arg.gpudata, sig.gpudata, expt.gpudata, arg.mem_size)
    return (
     sig, expt)
...
def ldexp(significand, exponent, stream=None):
    ...
    func.prepared_async_call(significand._grid, significand._block, stream, significand.gpudata, exponent.gpudata, result.gpudata, significand.mem_size)
    return result
...
def modf(arg, stream=None):
    ...
    func.prepared_async_call(arg._grid, arg._block, stream, arg.gpudata, intpart.gpudata, fracpart.gpudata, arg.mem_size)
    return (
     fracpart, intpart)