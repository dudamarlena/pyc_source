...
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_workflow.py
# Compiled at: 2020-05-06 10:05:57
# Size of source mod 2**32: 6267 bytes
import shlex
...
class WorkflowTestCase(BaseTestCase):
    ...
    @mock.patch('compose_flow.commands.workflow.Workflow.subcommand',
      new_callable=(mock.PropertyMock))
