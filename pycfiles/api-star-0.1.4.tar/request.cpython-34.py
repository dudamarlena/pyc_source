...
# [GCC 8.4.0]
# Embedded file name: /Users/tomchristie/GitHub/api-star/api_star/request.py
# Compiled at: 2016-04-14 17:21:25
...
def _negotiate_renderer(accept, renderers):
    ...
    if accept is None:
        return renderers[0]
    acceptable = set([item.split(';')[0].strip().lower() for item in accept.split(',')])
...
class RequestMixin(object):
    _parsers = (
     json_parser(), multipart_parser(), urlencoded_parser())
