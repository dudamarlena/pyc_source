...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/cblog/model.py
# Compiled at: 2006-12-13 19:45:33
__all__ = [
 'hub', 'Entry', 'Comment', 'Tag', 'Review', 'Subscription', 'User', 'Group', 'Permission', 'VisitIdentity']
...
def rest2html(text):
    ...
    return publish_parts(text, settings_overrides=overrides, writer_name='html')['html_body']
...
class Entry(SQLObject, Formattible):
    ...
    def _get_teaser(self):
        ...
        if firstpar.tag in ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'] or len(firstpar_html) <= config.get('cblog.teaser.minlength', 100):
