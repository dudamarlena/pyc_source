...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/idioms/utils/soundutils.py
# Compiled at: 2019-05-07 16:45:33
...
def play(path_to_soundfile, volume_coeff=1, autostart=True, loglevel='ERROR', suppress_log_messages=True):
    ...
    if volume_coeff > 1.5:
        raise ValueError('volume_coeff too high. Maximum permitted value for this multiplier is 1.5')
