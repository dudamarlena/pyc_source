...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/colubrid/application.py
# Compiled at: 2006-08-30 09:03:31
"""
...
import re
__all__ = (
 'BaseApplication', 'RegexApplication', 'ResolveRegexApplication', 'PathApplication', 'ObjectApplication', 'WebpyApplication', 'RoutesApplication')
    ...
    def __iter__(self):
        try:
            ...
            if isinstance(self.request, ResponseRequest):
                ...
                assert isinstance(response, HttpResponse), 'process_request() must return a HttpResponse instance'
...
class RoutesApplication(BaseApplication):
    ...
    def __init__(self, environ, start_response):
        ...
        super(RoutesApplication, self).__init__(environ, start_response, create_request)
