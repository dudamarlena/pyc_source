...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/colubrid/utils.py
# Compiled at: 2006-07-23 06:19:43
"""
    Colubrid Utilities
    ------------------
"""
...
def splitpath(p):
    return [ s for s in (posixpath.normpath(posixpath.join('/', p)) + (p and p[(-1)] == '/' and '/' or '')).split('/') if s ]
