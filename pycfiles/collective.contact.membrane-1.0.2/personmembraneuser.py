...
# [GCC 8.4.0]
# Embedded file name: /home/cedricmessiant/workspace/buildouts/webpro/src/collective.contact.membrane/src/collective/contact/membrane/behaviors/personmembraneuser.py
# Compiled at: 2015-01-30 02:38:26
from five import grok
from plone.dexterity.behavior import DexterityBehaviorAssignable
from dexterity.membrane.behavior.membraneuser import IMembraneUser, DxUserObject, MembraneUserWorkflow, IMembraneUserObject, IMembraneUserWorkflow, MembraneUserProperties
from Products.membrane.interfaces import IGroup
from Products.membrane.interfaces.user import IMembraneUserGroups, IMembraneUserProperties
from Products.PlonePAS.sheet import MutablePropertySheet
from collective.contact.core.interfaces import IContactable, IPersonHeldPositions
...
class PersonMembraneUser(DxUserObject):
    ...
    """
    _default = {'use_email_as_username': True, 'use_uuid_as_userid': True}
...
class PersonMembraneUserWorkflow(grok.Adapter, MembraneUserWorkflow, PersonMembraneUser):
    grok.context(IPersonMembraneUser)
    grok.implements(IMembraneUserWorkflow)
    allowed_states = ('active', )


class PersonMembraneUserProperties(grok.Adapter, MembraneUserProperties, PersonMembraneUser):
    grok.context(IPersonMembraneUser)
    grok.implements(IMembraneUserProperties)
    property_map = dict(email='email', home_page='website', location='city')
    ...
    def getPropertiesForUser(self, user, request=None):
        ...
        for prop_name, field_name in self.property_map.items():
            properties[prop_name] = details.get(field_name, details['address'].get(field_name, None)) or ''
