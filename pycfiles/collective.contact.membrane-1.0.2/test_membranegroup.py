...
# [GCC 8.4.0]
# Embedded file name: /home/cedricmessiant/workspace/buildouts/webpro/src/collective.contact.membrane/src/collective/contact/membrane/tests/test_membranegroup.py
...
class TestMembraneGroup(IntegrationTestCase, BaseTest):
    ...
    def setUp(self):
        ...
        self.dummyperson = api.content.create(type='person', id='dummyperson', container=portal.mydirectory)
    ...
    def test_get_organization_group_members(self):
        ...
        api.content.create(container=dummyperson, type='held_position', id='dummyperson_adt', position=relation)
    ...
    def test_get_position_group_members(self):
        ...
        api.content.create(container=dummyperson, type='held_position', id='dummyperson_gadt', position=relation)
        self.assertEqual(len(adapter.getGroupMembers()), 2)
        self.assertIn(dummyperson.UID(), adapter.getGroupMembers())
    ...
    def test_get_groups_for_principal(self):
        ...
        api.content.create(container=dummyperson, type='held_position', id='dummyperson_sergent_lh', position=relation)
        ...
        self.assertIn('armeedeterre_corpsa_divisionalpha_regimenth_brigadelh', groups)
