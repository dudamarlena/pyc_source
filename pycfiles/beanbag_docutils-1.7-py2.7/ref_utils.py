...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-x86_64/egg/beanbag_docutils/sphinx/ext/ref_utils.py
...
def setup(app):
    ...
    def _setup_ref_role(role):
        ...
        role.process_link = lambda *args, **kwargs: _process_link(orig_process_link, *args, **kwargs)
