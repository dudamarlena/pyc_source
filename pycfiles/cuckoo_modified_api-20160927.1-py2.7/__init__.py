...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\CuckooAPI\__init__.py
# Compiled at: 2016-09-27 09:09:07
...
def buildapiurl(proto='http', host='127.0.0.1', port=8000, action=None, APIPY=False):
    """
...
class CuckooAPI(object):
    ...
    def __init__(self, host='127.0.0.1', port=8000, proto='http', APIPY=False):
        """
    ...
    def getcuckoostatus(self):
        ...
        """
        apiurl = buildapiurl(self.proto, self.host, self.port, '/cuckoo/status', self.APIPY)
    ...
    def listmachines(self):
        ...
        """
        apiurl = buildapiurl(self.proto, self.host, self.port, '/machines/list', self.APIPY)
        request = requests.get(apiurl)
        if request.status_code == 200:
            jsonreply = json.loads(request.text)
            return jsonreply
    ...
    def viewmachine(self, vmname=None):
        ...
        apiurl = buildapiurl(self.proto, self.host, self.port, '/machines/view/' + vmname, self.APIPY)
        request = requests.get(apiurl)
        if request.status_code == 200:
            jsonreply = json.loads(request.text)
            return jsonreply
    ...
    def taskslist(self, limit=None, offset=None):
        ...
        apiurl = buildapiurl(self.proto, self.host, self.port, baseurl, self.APIPY)
        request = requests.get(apiurl)
        if request.status_code == 200:
            jsonreply = json.loads(request.text)
            return jsonreply
    ...
    def taskview(self, taskid=None):
        ...
        apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/view/' + str(taskid), self.APIPY)
        request = requests.get(apiurl)
        if request.status_code == 200:
            jsonreply = json.loads(request.text)
            return jsonreply
    ...
    def taskstatus(self, taskid=None):
        ...
        if taskid is None or taskid < 1:
            raise CuckooAPINoTaskID(taskid)
        apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/status/' + str(taskid), self.APIPY)
    ...
    def taskreport(self, taskid=None, reportformat='json'):
        ...
        if taskid is None or taskid < 1:
            raise CuckooAPINoTaskID(taskid)
        if self.APIPY is True:
            apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/report/' + str(taskid) + '/' + reportformat, self.APIPY)
        else:
            apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/get/report/' + str(taskid) + '/' + reportformat, self.APIPY)
    ...
    def taskdelete(self, taskid=None):
        ...
        if taskid is None or taskid < 1:
            raise CuckooAPINoTaskID(taskid)
        apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/delete/' + str(taskid), self.APIPY)
        request = requests.get(apiurl)
        if request.status_code == 200:
            jsonreply = json.loads(request.text)
            return jsonreply
    ...
    def submitfile(self, filepath, data=None):
        ...
        apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/create/file', self.APIPY)
    ...
    def submiturl(self, url, data=None):
        ...
        """
        apiurl = buildapiurl(self.proto, self.host, self.port, '/tasks/create/url', self.APIPY)
    ...
    def tasksearch(self, hashid=None, hashtype=None):
        ...
        apiurl = buildapiurl(self.proto, self.host, self.port, '/files/view/' + hashtype + '/' + hashid, self.APIPY)
        if self.APIPY is True:
            raise CuckooAPINotAvailable(apiurl)
        request = requests.get(apiurl)
        if request.status_code == 200:
    ...
    def sampledownload(self, hashid=None, hashtype=None, filepath=None):
        """
