...
def main():
    ...
    for sim_pdata in fitter.simulated_pdata_iter(n=2,
      dataset=(cf.read_dataset('etas-Ds.h5')),
      p_exact=(fit.pmean)):
        print('\n==================== simulation')
        sim_fit = fitter.lsqfit(pdata=sim_pdata,
          prior=prior,
          p0=(fit.pmean),
          svdcut=SVDCUT)
