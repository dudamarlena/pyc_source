...
# [GCC 8.4.0]
# Embedded file name: /Users/runner/runners/2.169.1/work/MetaWards/MetaWards/tests/../build/lib.macosx-10.14-x86_64-3.7/metawards/iterators/_iterate_weekday.py
...
def iterate_weekday(**kwargs):
    ...
    return [
     advance_infprob, advance_fixed, advance_play]