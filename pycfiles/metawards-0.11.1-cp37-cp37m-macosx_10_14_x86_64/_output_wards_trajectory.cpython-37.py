...
# [GCC 8.4.0]
# Embedded file name: /Users/runner/runners/2.169.1/work/MetaWards/MetaWards/tests/../build/lib.macosx-10.14-x86_64-3.7/metawards/extractors/_output_wards_trajectory.py
...
__all__ = [
 'output_wards_trajectory', 'output_wards_trajectory_serial']

def output_wards_trajectory_serial(network: Network, population: Population, output_dir: OutputFiles, workspace: Workspace, **kwargs):
...
def output_wards_trajectory(nthreads: int=1, **kwargs):
    """This will output the complete trajectory for
       ...
       **kwargs:
         Other arguments not needed by this function
    """
    call_function_on_network(nthreads=1, func=output_wards_trajectory_serial, 
