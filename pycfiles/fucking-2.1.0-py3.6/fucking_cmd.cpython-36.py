...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\Fucking\fuck\fucking_cmd.py
# Compiled at: 2019-11-25 18:02:32
# Size of source mod 2**32: 2254 bytes
import getopt, socket, sys
from .dbcache import get_size
help_info = {'fucking word':'Get the pronunciation and the definition of the `word`. \n\t\t\t\t\t(double quotation marks are needed if the `word` is a phrase or a sentence)', 
