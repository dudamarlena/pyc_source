...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/notifications/tasks.py
# Compiled at: 2019-08-12 19:50:35
...
def _import_channel(channel_alias):
    ...
    try:
        ...
        raise AttributeError('"%s" is not a valid delivery channel alias. Check your applications settings for NOTIFICATIONS_CHANNELS' % channel_alias)
