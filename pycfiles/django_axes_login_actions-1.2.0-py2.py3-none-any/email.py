...
# [GCC 8.4.0]
# Embedded file name: /home/enrico/pyenv/titschendorf.de/axes_login_actions/actions/email.py
# Compiled at: 2017-03-26 03:38:58
...
def notify(access_attempt, **kwargs):
    ...
    if access_attempt.failures == 0:
        ...
        login_success = False
    context = dict(current_time=now(), attempt_time=access_attempt.attempt_time, failures=access_attempt.failures, fqdn=fqdn, site_domain=site.domain, site=site, ip_address=ip_address, login_success=login_success, login_success_msg=login_success_msg, user_agent=access_attempt.user_agent, username=access_attempt.username)
...
def _resolve_ip_address_to_fqdn(ip_address):
    if ip_address is None:
        ...
        try:
            ...
            logger.warn('IP -> FQDN resolution failed for "%s": %s', ip_address, unicode(e))
