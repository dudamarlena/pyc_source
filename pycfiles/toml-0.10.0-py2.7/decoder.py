...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/toml/decoder.py
...
class TomlDecoder(object):
    ...
    def load_line(self, line, currentlevel, multikey, multibackslash):
        ...
        if '.' in pair[0]:
            ...
            if (pair[0][0] == '"' or pair[0][0] == "'") and pair[0][(-1)] == pair[0][0]:
                pair[0] = pair[0][1:-1]
        ...
        if v == 'true':
            ...
            if v == 'false':
                ...
                if '.' in v or 'x' not in v and ('e' in v or 'E' in v):
                    ...
                    if len(lowerv) == 3 and (lowerv == 'inf' or lowerv == 'nan'):
                        v = float(v)
                        itype = 'float'
                    if itype == 'int':
                        v = int(v, 0)
