...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/lo/iterative/sparse.py
# Compiled at: 2010-12-15 03:31:28
"""
...
def irls(A0, x0, tol1=1e-05, maxiter1=10, p=1, optimizer=spl.cgs, **kargs):
...
def rirls(M, y, Ds=[], tol1=1e-05, maxiter1=10, p=1, optimizer=spl.cgs, **kargs):
