...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/lo/operators.py
# Compiled at: 2011-02-08 06:06:46
...
class NDOperator(LinearOperator):
    ...
    def __init__(self, shapein, shapeout, matvec, rmatvec=None, matmat=None, rmatmat=None, dtypein=None, dtypeout=None, dtype=None):
        ...
        if rmatvec is not None:
            ...
            ndrmatvec = None
        LinearOperator.__init__(self, shape, ndmatvec, ndrmatvec, dtype=dtype, dtypein=dtypein, dtypeout=dtypeout)
...
class NDSOperator(NDOperator):
    ...
    def __init__(self, shapein=None, shapeout=None, classin=None, classout=None, dictin=None, dictout=None, xin=None, xout=None, matvec=None, rmatvec=None, dtype=np.float64, dtypein=None, dtypeout=None):
        ...
        if rmatvec is not None:
            ...
            rmatvec = None
        NDOperator.__init__(self, shapein, shapeout, smatvec, rmatvec=srmatvec, dtypein=dtypein, dtypeout=dtypeout, dtype=dtype)
        return
...
def masubclass(xin=None, xout=None, shapein=None, shapeout=None, classin=None, classout=None, dictin=None, dictout=None, matvec=None, rmatvec=None, dtype=np.float64, dtypein=None, dtypeout=None):
    ...
    if rmatvec is not None:
        ...
        ndrmatvec = None
    return LinearOperator(shape, matvec=ndmatvec, rmatvec=ndrmatvec, dtype=dtype, dtypein=dtypein, dtypeout=dtypeout)
...
def fftn(shapein, dtypein=np.float64, dtypeout=np.complex128, s=None, axes=None):
    ...
    return ndoperator(shapein, shapeout, matvec, rmatvec, dtypein=dtypein, dtypeout=dtypeout)
...
def binning(shapein, factor, axis=-1, dtype=np.float64):
    ...
    return ndoperator(shapein, shapeout, matvec=matvec, rmatvec=rmatvec, dtype=dtype)
...
def axis_mul(shapein, vect, axis=-1, dtype=np.float64):
    ...
    return ndoperator(shapein, shapeout, matvec=matvec, rmatvec=matvec, dtype=dtype)
