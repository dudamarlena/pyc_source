...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/lo/wrappers/pywt_lo.py
# Compiled at: 2011-01-31 12:13:05
""" Wrap pywt transform into LinearOperators """
import numpy as np, pywt, lo
...
def wavedec(shapein, wavelet, mode='sym', level=None, dtype=np.float64):
    ...
    return lo.LinearOperator((shapeout, shapein), matvec=matvec, rmatvec=rmatvec, dtype=dtype)
