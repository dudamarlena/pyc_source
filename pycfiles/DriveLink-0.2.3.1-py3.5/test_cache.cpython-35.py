...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/test_cache.py
# Compiled at: 2017-09-04 17:19:01
...
class cachedTest(ut.TestCase):
    ...
    def test_speed(self):
        ...
        with Timer() as (t2):
            _ = self.c(32)
        self.assertTrue(t2.interval < t1.interval, "There isn't a speed up... This is useless then, I suppose.")
        with Timer() as (t1):
            _ = self.c(32)
        self.assertTrue(t2.interval > t1.interval, "There isn't a speed up... This is useless then, I suppose.")
