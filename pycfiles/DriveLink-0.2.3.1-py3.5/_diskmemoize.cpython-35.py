...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/drivelink/_diskmemoize.py
# Compiled at: 2017-09-04 17:21:54
...
class _Cached:
    __doc__ = 'This will shine the most with recursive functions. But the recursion has to call the cached function, not the function itself.'
    f = None
    c = None
