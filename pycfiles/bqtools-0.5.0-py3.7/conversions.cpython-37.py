...
def convert--- This code section failed: ---
 ...
 L.  67       444  LOAD_GLOBAL              convert
              ...
              470  CALL_FUNCTION_4       4  '4 positional arguments'
 ...
 L.  70       526  LOAD_GLOBAL              isinstance
              ...
              536  CALL_FUNCTION_2       2  '2 positional arguments'
 ...
 L.  75       580  LOAD_GLOBAL              convert
              ...
              606  CALL_FUNCTION_4       4  '4 positional arguments'
 ...
 L.  81       660  LOAD_GLOBAL              ValueError
              ...
              672  RAISE_VARARGS_1       1  'exception instance'
...
def to_integer(value, mode='NULLABLE', infer_required=False):
    ...
    if isinstancevalueNoneType:
        ...
        if isinstancevaluefloat and math.isnanvalue:
            int_value = handle_none()
        else:
            if isinstancevaluebytes:
                int_value = value.from_bytes(value, byteorder='big', signed=False)
            else:
                if isinstancevaluestr:
                    if value.isnumeric:
                        int_value = int(value)
                    elif value == 'False':
                        int_value = 0
    ...
    if isinstancevalueNoneType:
        ...
        if isinstancevaluefloat and math.isnanvalue:
            ...
            if isinstancevaluestr:
                ...
                if isinstancevalue(tuple, list):
                    dt_value = (datetime.datetime)(*value)
                else:
                    if isinstancevaluedict:
                        dt_value = (datetime.datetime)(**value)
                    else:
                        if isinstancevaluedatetime.datetime:
                            dt_value = value
