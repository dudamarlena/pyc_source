...
# Embedded file name: build/bdist.linux-i686/egg/pydbgr/lib/breakpoint.py
# Compiled at: 2013-03-23 01:54:40
__doc__ = 'Breakpoints as used in a debugger.\n\nThis code is a rewrite of the stock python bdb.Breakpoint'
__all__ = [
...
class BreakpointManager:
    ...
    def get_breakpoint(self, i):
        ...
        if 1 == len(self.bpbynumber):
            ...
            return (False, 'Breakpoint number %d out of range 1..%d.' % (i, len(self.bpbynumber) - 1), None)
