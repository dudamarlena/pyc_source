...
# Embedded file name: build/bdist.linux-i686/egg/pydbgr/processor/subcmd.py
# Compiled at: 2013-03-15 20:20:36
__doc__ = 'Handles gdb-like subcommand processing.'
...
class Subcmd:
    ...
    def help(self, *args):
        ...
        if entry and hasattr(entry, 'help'):
            ...
            self.cmd_obj.errmsg("Unknown 'help %s' subcommand %s" % (self.name, subcmd_prefix))
    ...
    def undefined_subcmd(self, cmd, subcmd):
        ...
        self.cmd_obj.errmsg('Undefined "%s" command: "%s". Try "help".' % (cmd, subcmd))
