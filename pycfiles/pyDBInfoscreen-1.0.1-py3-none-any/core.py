...
class DebuggerCore:
    __module__ = __name__
    DEFAULT_INIT_OPTS = {'processor': None, 'step_ignore': 0, 'ignore_filter': None}
    ...
    def start(self, opts=None):
        ...
        try:
            ...
            elif get_option('force') and not tracer.find_hook(self.trace_dispatch):
