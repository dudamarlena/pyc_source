...
# [GCC 8.4.0]
# Embedded file name: /Users/rmartins/Desenvolvimento/Django/Apps/wagtaildemo/smart_selects/db_fields.py
...
class ChainedManyToManyField(ManyToManyField):
    ...
    def __init__(self, to, chained_field=None, chained_model_field=None, auto_choose=False, **kwargs):
        """
        examples:
    ...
    def deconstruct(self):
        field_name, path, args, kwargs = super(ChainedManyToManyField, self).deconstruct()
        defaults = {'chain_field': None, 
           'chained_model_field': None, 
           'auto_choose': False}
        attr_to_kwarg_names = {'chain_field': 'chained_field', 
    ...
    def formfield(self, **kwargs):
        ...
        defaults = {'form_class': form_fields.ChainedManyToManyField, 
...
class ChainedForeignKey(ForeignKey):
    ...
    def deconstruct(self):
        ...
        defaults = {'chained_field': None, 
           'chained_model_field': None, 
           'show_all': False, 
           'auto_choose': False, 
           'view_name': None}
        attr_to_kwarg_names = {'chained_field': 'chained_field', 
           'chained_model_field': 'chained_model_field', 
           'show_all': 'show_all', 
           'auto_choose': 'auto_choose', 
           'view_name': 'view_name'}
    ...
    def formfield(self, **kwargs):
        ...
        foreign_key_model_name = self.model._meta.object_name
        foreign_key_field_name = self.name
        defaults = {'form_class': form_fields.ChainedModelChoiceField, 
           'queryset': self.rel.to._default_manager.complex_filter(self.rel.limit_choices_to), 
...
class GroupedForeignKey(ForeignKey):
    ...
    def formfield(self, **kwargs):
        defaults = {'form_class': form_fields.GroupedModelSelect, 
           'queryset': self.rel.to._default_manager.complex_filter(self.rel.limit_choices_to), 
           'to_field_name': self.rel.field_name, 
