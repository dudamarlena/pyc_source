...
# [GCC 8.4.0]
# Embedded file name: /home/musy/Projects/vtkplotter/vtkplotter/colors.py
# Compiled at: 2020-03-04 05:42:18
from __future__ import division, print_function
import vtk, numpy as np, sys, vtkplotter.docs as docs, vtkplotter.settings as settings
...
__all__ = [
 ...
 'kelvin2rgb']
try:
    import matplotlib, matplotlib.cm as cm_mpl
    _mapscales = cm_mpl
except:
    _mapscales = None
...
color_nicks = {'a': 'aqua', 
   ...
   'ds': 'darksalmon', 
   'dv': 'darkviolet'}
_mapscales_cmaps = ('Accent', 'Accent_r', 'Blues', 'Blues_r', 'BrBG', 'BrBG_r', 'BuGn',
                    ...
                    'gnuplot2', 'gnuplot2_r', 'gnuplot_r', 'gray_r', 'hot', 'hot_r',
...
def makeLUT(colorlist, interpolate=False, vmin=None, vmax=None, belowColor=None, aboveColor=None, nanColor=None):
    """
