...
# [GCC 8.4.0]
# Embedded file name: /home/musy/Projects/vtkplotter/vtkplotter/picture.py
# Compiled at: 2020-03-04 05:42:18
from __future__ import division, print_function
import numpy as np, vtk, vtkplotter.colors as colors, vtkplotter.docs as docs, vtkplotter.utils as utils, vtkplotter.settings as settings
...
class Picture(vtk.vtkImageActor, ActorBase):
    ...
    def text(self, txt, pos=(0, 0, 0), s=1, c=None, alpha=1, bg=None, font='Gula', dpi=500, justify='bottom-left'):
