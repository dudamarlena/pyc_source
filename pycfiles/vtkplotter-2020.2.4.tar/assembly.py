...
# [GCC 8.4.0]
# Embedded file name: /home/musy/Projects/vtkplotter/vtkplotter/assembly.py
# Compiled at: 2020-03-04 05:42:18
from __future__ import division, print_function
import vtk, vtkplotter.docs as docs
...
class Assembly(vtk.vtkAssembly, ActorBase):
    ...
    def lighting(self, style='', ambient=None, diffuse=None, specular=None, specularPower=None, specularColor=None, enabled=True):
        ...
        """
        for a in self.actors:
            a.lighting(style, ambient, diffuse, specular, specularPower, specularColor, enabled)
