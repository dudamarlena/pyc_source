...
# Compiled at: 2020-03-16 14:45:45
...
def _histogram1D(data, format=None, bins=25, aspect=1.3333333333333333, xlim=None, ylim=(0, None), errors=False, title='', xtitle='x', ytitle='dN/dx', titleSize=None, titleColor=None, fill=True, c='olivedrab', gap=0.02, alpha=1, outline=False, lw=2, lc='k', marker='', ms=None, mc=None, ma=None, pad=0.05, axes={}, bc='k'):
    settings.defaultAxesType = 0
    ncolls = len(settings.collectable_actors)
...
def cornerHistogram(values, bins=20, vrange=None, minbin=0, logscale=False, title='', c='g', bg='k', pos=1, s=0.2, lines=True):
    """
