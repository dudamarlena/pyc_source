...
# [GCC 8.4.0]
# Embedded file name: /home/musy/Projects/vtkplotter/vtkplotter/volume.py
# Compiled at: 2020-04-09 12:00:51
from __future__ import division, print_function
import numpy as np, vtk, vtkplotter.colors as colors, vtkplotter.docs as docs, vtkplotter.utils as utils
...
class Volume(vtk.vtkVolume, ActorBase):
    ...
    def __init__(self, inputobj=None, c=('b', 'lb', 'lg', 'y', 'r'), alpha=(0.0, 0.0, 0.2, 0.4, 0.8, 1), alphaGradient=None, mode=0, origin=None, spacing=None, shape=None, mapperType='smart'):
        ...
        if inputobj is None:
            ...
            if isinstance(inputobj[0], str):
                ...
                varr = numpy_to_vtk(inputobj.ravel(order='F'), deep=True, array_type=vtk.VTK_FLOAT)
    ...
    def alpha(self, alpha):
        ...
        if utils.isSequence(alpha):
            ...
            opacityTransferFunction.AddPoint(smin, alpha)
    ...
    def crop(self, top=None, bottom=None, right=None, left=None, front=None, back=None, VOI=()):
    ...
    def cutWithPlane(self, origin=(0, 0, 0), normal=(1, 0, 0)):
        ...
        clipper.Mixed3DCellGenerationOff()
        clipper.SetValue(0)
        clipper.Update()
    ...
    def resize(self, *newdims):
        ...
        new_spac = old_spac * old_dims / newdims
