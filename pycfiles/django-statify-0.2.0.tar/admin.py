...
# [GCC 8.4.0]
# Embedded file name: /Users/chschw/Workspace/django/lab/django-cms/site/statify/admin.py
...
class URLForm(forms.ModelForm):
    ...
    def clean(self):
        if 'url' not in self.cleaned_data or self.cleaned_data['url'] is '':
            raise forms.ValidationError(_('The URL field must be filled.'))
        cleaned_url = self.cleaned_data['url']
        url = 'http://%s%s' % (CURRENT_SITE, cleaned_url)
