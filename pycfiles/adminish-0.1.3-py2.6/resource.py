...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/adminish/resource.py
# Compiled at: 2010-03-11 08:09:24
...
PAGER_FACTORIES = {'Paging': make_Pager, 'SkipLimitPaging': make_SkipLimitPager}
...
class ItemsPage(BasePage):
    ...
    def resource_child(self, request, segments):
        return (
         self.item_resource(segments[0]), segments[1:])
...
class NewItemPage(BasePage):
    ...
    def _html(self, request, form=None):
        ...
        return templating.render_response(request, self, M['templates']['new_item'], {'metadata': M, 'form': form})
...
def _form_for_type(request, C, defn, add_id_and_rev=False):
    ...
    """
    form = build(defn, C, add_id_and_rev=add_id_and_rev, widget_registry=_widget_registry(request))
