...
# [GCC 8.4.0]
# Embedded file name: /home/rachelle2/webprojects/toucan-connectors/toucan_connectors/google_spreadsheet/google_spreadsheet_connector.py
...
class GoogleSpreadsheetDataSource(ToucanDataSource):
    spreadsheet_id: str = Field(...,
      ...
      description='You can find this ID in the URL of your spreadsheet, just after the base path "https://docs.google.com/spreadsheets/d/"')
    sheetname: str = Field(None,
      description='If not specified, the first sheet will be extracted by default')
    skip_rows: int = Field(0,
