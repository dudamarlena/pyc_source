...
# [GCC 8.4.0]
# Embedded file name: /Users/neokami1/Dropbox/Neokami/Code/Bitbucket/neokami-python-sdk/neokami/src/Neokami/SentimentAnalyser.py
...
class SentimentAnalyser(NeokamiRequest):
    ...
    def analyse(self):
        ...
        if self.checkHasAllParameters(['text']):
            response = NeokamiHttpClient.post(self.getUrl('/analyse/text/sentiment'), self.getApiKey(), {'wait': self.getWait(), 
