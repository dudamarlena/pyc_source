...
# [GCC 8.4.0]
# Embedded file name: /Users/neokami1/Dropbox/Neokami/Code/Bitbucket/neokami-python-sdk/neokami/src/Neokami/VisualCortex.py
...
class VisualCortex(NeokamiRequest):
    ...
    def postBinary(self, bytestream):
        ...
        :return <Response>:
        """
        return NeokamiHttpClient.postBinary(self.getUrl('/cortex/analyse'), bytestream, self.getApiKey(), {'wait': self.getWait(), 
    ...
    def sendFeedBack(self):
        ...
        self.check_base64()
        response = NeokamiHttpClient.post(self.getUrl('/feedback/image'), self.getApiKey(), {'data': self.getFile(), 
           'label': self.getLabel(), 
