...
# Embedded file name: /home/matej/workarea/plone.hud/plone.app.hud/src/plone/app/hud/hud_best_practices.py
# Compiled at: 2013-09-14 10:04:39
...
class BestPracticesPanelView(HUDPanelView):
    ...
    def render(self):
        ...
        self.zope_writable_files = self.check_write_permissions(self.portal.Control_Panel.getSOFTWARE_HOME())
        self.check_caching()
        ...
        self.formatted_days_from_oldest_transaction = ('{0:.1f}').format(self.check_oldest_transaction())
    ...
    def check_caching(self):
        ...
        self.is_caching_installed = self.installer.isProductInstalled('plone.app.caching')
        ...
        self.is_caching_ok = self.is_caching_installed and self.is_caching_enabled
