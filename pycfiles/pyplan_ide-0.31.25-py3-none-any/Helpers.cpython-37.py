...
# Embedded file name: /home/fabian/devs/novix/python/pyplan-core/pyplan_core/cubepy/Helpers.py
# Compiled at: 2020-04-30 15:43:10
# Size of source mod 2**32: 31835 bytes
import inspect, numbers, os
...
class Helpers(object):
    ...
    def copyAsValues(self, source, targetId):
        ...
        if isinstance(source, str):
            ...
            if not isinstance(source, cubepy.Cube):
                if not isinstance(source, cubepy.Index):
                    raise ValueError("The 'source' parameter must be a cp.cube or cp.index object")
        ...
        self.node.model.getNode(targetId).definition = source.generateDefinition()
        return True
    ...
    def describe(text, prefix, objectType=None):
        ...
        for _member in _members:
            if not '__' not in str(_member[0]) or text is None or text in str(_member[0]).lower():
