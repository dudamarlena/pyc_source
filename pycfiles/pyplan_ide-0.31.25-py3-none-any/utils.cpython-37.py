...
__doc__ = 'Utility functions imported by cubepy.cube and cubepy.axes.\nDo not import these in order to avoid circular imports.\n'
...
def align_arrays(axis1, axis2, axis_index1, axis_index2, values1, values2):
    ...
    if axis1 is axis2:
        ...
        if is_indexed(axis2):
            ...
            return (
             axis1, values1, values2.take(value_indices, axis_index2))
        if is_indexed(axis1):
            value_indices = axis1.indexof(axis2.values)
            return (
             axis2, values1.take(value_indices, axis_index1), values2)
