...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/esdrt/content/upgrades/29_30.py
...
VERSION_POLICIES = [
 dict(id='off', policy=(), title=_PMF('versioning_off', default='No versioning')),
 dict(id='manual', policy=('version_on_revert', ), title=_PMF('versioning_manual', default='Manual')),
 dict(id='automatic', policy=('at_edit_autoversion', 'version_on_revert'), title=_PMF('versioning_automatic', default='Automatic'))]
