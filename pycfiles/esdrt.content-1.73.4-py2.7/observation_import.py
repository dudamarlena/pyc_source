...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/esdrt/content/browser/observation_import.py
...
UNUSED_FIELDS = ('closing_comments', 'closing_deny_comments', 'closing_comments_phase2',
...
INVENTORY_COLS = ('year', 'gas', 'review_year', 'fuel', 'ms_key_catagory', 'eu_key_catagory',
                  'parameter', 'highlight')
...
class ObservationXLSImport(BrowserView):
    ...
    def do_import(self):
        ...
        get_vocabulary = _cached_get_vocabulary(self.context, prefix='esdrt.content.')
        entries = []
        for row in valid_rows:
            entries.append(Entry(row, constants, get_vocabulary))
