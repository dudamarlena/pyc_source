...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/esdrt/content/upgrades/55_56.py
...
WORKFLOWS = ('esd-answer-workflow', 'esd-comment-workflow', 'esd-conclusion-phase2-workflow',
             'esd-conclusion-workflow', 'esd-file-workflow', 'esd-question-review-workflow',
             'esd-review-workflow', 'esd-reviewtool-folder-workflow')
PERMISSIONS = ('Access contents information', 'View')
TYPES = ('ConclusionsPhase2', 'Conclusion', 'ESDRTFile', 'CommentAnswer', 'Comment',
         'Question', 'Observation', 'ReviewFolder')
