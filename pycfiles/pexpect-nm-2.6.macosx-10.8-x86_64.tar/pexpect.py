...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/pexpect.py
# Compiled at: 2013-09-16 02:54:59
...
class spawn(object):
    ...
    def __init__(self, command, args=[], timeout=30, maxread=2000, searchwindowsize=None, logfile=None, cwd=None, env=None, ignore_sighup=False):
    ...
    def __pty_make_controlling_tty(self, tty_fd):
        ...
        try:
            ...
            if fd >= 0:
                os.close(fd)
                raise ExceptionPexpect('Failed to disconnect from ' + 'controlling tty. It is still possible to open /dev/tty.')
        except:
            pass
    ...
    def readline(self, size=-1):
        r"""This reads and returns one entire line. The newline at the end of
    ...
    def wait(self):
        ...
        if os.WIFEXITED(status):
            ...
            raise ExceptionPexpect('Called wait() on a stopped child ' + 'process. This is not supported. Is some other ' + 'process attempting job control with our child pid?')
