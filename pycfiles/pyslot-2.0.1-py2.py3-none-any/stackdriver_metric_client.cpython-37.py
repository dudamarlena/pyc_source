...
# Embedded file name: build/bdist.linux-x86_64/egg/pyslo/metric_client/stackdriver/stackdriver_metric_client.py
# Compiled at: 2020-04-02 17:00:28
# Size of source mod 2**32: 9611 bytes
__doc__ = 'Stackdriver specific MetricClient\n'
import time, datetime, pytz, pandas as pd
...
class StackdriverMetricClient(MetricClient):
    ...
    def get_timeseries_iter(self, interval):
        ...
        results_iter = self._client.list_time_series(project_name, self._filter.string, interval, monitoring_v3.enums.ListTimeSeriesRequest.TimeSeriesView.FULL)
        return results_iter
    ...
    def point_dict(self, point, labels):
        ...
        Returns:
            ...
            and labels
        """
        point_dict = {'start_timestamp':StackdriverMetricClient.convert_point_time(point.interval.start_time,
           as_timestamp=False), 
         'end_timestamp':StackdriverMetricClient.convert_point_time(point.interval.end_time,
           as_timestamp=False), 
    ...
    def convert_point_time(point_time, as_timestamp):
        ...
        return datetime.datetime.fromtimestamp((seconds + nanos / 1000000000), tz=(pytz.UTC))
