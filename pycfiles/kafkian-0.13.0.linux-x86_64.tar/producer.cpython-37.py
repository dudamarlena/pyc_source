...
# [GCC 8.4.0]
# Embedded file name: /home/sbeilin/.pyenv/versions/3.7.0/lib/python3.7/site-packages/kafkian/producer.py
# Compiled at: 2019-08-21 06:54:36
# Size of source mod 2**32: 4883 bytes
import atexit, logging, socket, typing
...
class Producer:
    ...
    DEFAULT_CONFIG = {'api.version.request':True, 
    ...
    def __init__(self, config: typing.Dict, value_serializer=Serializer(), key_serializer=Serializer(), error_callback: typing.Optional[typing.Callable]=None, delivery_success_callback: typing.Optional[typing.Callable]=None, delivery_error_callback: typing.Optional[typing.Callable]=None, metrics=None) -> None:
    ...
    def _on_delivery(self, err, msg):
        if err:
            logger.warning('Producer send failed',
            ...
            logger.debug('Producer send succeeded',
              extra=dict(topic=(msg.topic()),
              key=(msg.key()),
              partition=(msg.partition())))
