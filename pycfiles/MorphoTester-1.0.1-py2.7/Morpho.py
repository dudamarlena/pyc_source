...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/MorphoTester/Morpho.py
# Compiled at: 2015-10-02 16:05:10
"""
...
import plython, DNE, RFI, OPC, sys
...
class MayaviView(HasTraits):
    ...
    def VisualizeOPCR(self, hexcolormap, facelength):
        ...
        if '#000000' in hexcolormap:
            ...
            colors = [
             (0, 0, 0, 255), (255, 0, 0, 255), (150, 75, 0, 255), (255, 255, 0, 255), (0, 255, 255, 255), (0, 0, 255, 255), (144, 238, 144, 255), (1, 68, 33, 255), (255, 192, 203, 255)]
            ...
            colors = [
             (255, 0, 0, 255), (150, 75, 0, 255), (255, 255, 0, 255), (0, 255, 255, 255), (0, 0, 255, 255), (144, 238, 144, 255), (1, 68, 33, 255), (255, 192, 203, 255)]
