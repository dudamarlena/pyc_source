...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/MorphoTester/plython.py
# Compiled at: 2015-10-02 12:22:39
"""
...
def createarray(filepath):
    ...
    return [
     varray, vfarray, farray]


def savearray(vertex, faceindex, filename):
