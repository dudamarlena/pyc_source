...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\elastic3rd\esutils.py
# Compiled at: 2020-01-13 10:27:01
# Size of source mod 2**32: 5759 bytes
import numpy as np, re, os

def read_input(INPUT='INPUT'):
    ParaIn = {'Continue':0, 
     'EnergyCode':'CASTEP',  'EnergyRun':1,  'CrystalType':'Cubic1',  'Ord':3,  'MaxStrain':5, 
     'NP':1,  'STEPS':5,  'BaseName':'Si',  'CalMode':'W',  'FlagSE':'E'}
    fopen = open(INPUT, 'r')
