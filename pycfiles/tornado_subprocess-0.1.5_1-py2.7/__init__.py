...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/tornado_subprocess/__init__.py
# Compiled at: 2012-10-25 04:00:54
"""
Copyright (c) 2012, Vukasin Toroman <vukasin@toroman.name>
"""
import subprocess, tornado.ioloop, time, fcntl, os
...
"""
    ...
    def start(self):
        ...
        for fd, d in self.streams:
            ...
            self.ioloop.add_handler(fd, self.stat, self.ioloop.READ | self.ioloop.ERROR)
