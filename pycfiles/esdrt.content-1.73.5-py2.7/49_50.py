...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/esdrt/content/upgrades/49_50.py
...
def upgrade(context, logger=None):
    if logger is None:
        logger = getLogger('esdrt.content.upgrades.49_50')
    ...
    for idx, observation in enumerate(observations, start=1):
        catalog.catalog_object(observation, idxs=('observation_questions_workflow', ), update_metadata=1)
        if idx % 50 == 0:
