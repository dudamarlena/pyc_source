...
# [GCC 8.4.0]
# Embedded file name: /Users/Ari/src/callisto-core/callisto_core/wizard_builder/models.py
...
class Page(models.Model):
    ...
    def set_page_position(self):
        ...
        if cls.objects.count() == 0:
            self.position = 1
        elif bool(cls.objects.exclude(pk=(self.pk))):
...
class FormQuestion(models.Model):
    ...
    page = models.ForeignKey(Page,
      editable=True, null=True, blank=False, on_delete=(models.CASCADE))
    sites = models.ManyToManyField(Site)
    position = models.PositiveSmallIntegerField('position', default=0)
    type = models.TextField(choices=(fields.get_field_options()),
      null=True,
    ...
    def serialized(self):
        ...
        data.update({'sites':[site.id for site in self.sites.all()], 
