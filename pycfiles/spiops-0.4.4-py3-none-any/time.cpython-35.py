...
# [GCC 8.4.0]
# Embedded file name: /Users/mcosta/Dropbox/SPICE/SPICE_CROSS_MISSION/spiops/spiops/utils/time.py
# Compiled at: 2018-10-19 11:53:09
...
def cov_int(object_cov, object_id, kernel, time_format='TDB', global_boundary=False, report=False):
    ...
    if report and not global_boundary:
        ...
        print('Coverage for {} in {} [{}]:'.format(body_name, kernel, time_format))
