...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.5/dist-packages/megdata/bti_pdf.py
...
class BTIPDF(object):
    ...
    def read_raw_data(self, slices=None, indices=None):
        ...
        unordered_data = numpy.reshape(numpy.fromfile(self.fd, dtype=self.numpy_datatype, count=(endp - startp) * self.hdr.total_chans), [
