...
# Embedded file name: build/bdist.linux-x86_64/egg/pymoso/chnbase.py
# Compiled at: 2019-09-10 14:28:59
# Size of source mod 2**32: 38623 bytes
...
class RASolver(MOSOSolver):
    ...
    resdict : dict
        ...
        resdict = {'itersoln':lesnu, 
         'simcalls':simcalls,  'endseed':self.endseed}
        return resdict
    ...
    Set of feasible points which cause mcS to not be an ALES
        ...
        for s in mcS:
            ...
            for x in snb:
                ...
                if isfeas and does_strict_dominate(fx, fs, delzero, delzero):
                    ncn |= {x}
            ...
            if isfeas:
                ...
                for s in mcS:
                    ...
                    if does_weak_dominate(fs, fx, delzero, delzero):
                        notweakdom = False
                    if does_dominate(fx, fs, delzero, delzero):
                        if does_weak_dominate(fs, fx, dels, delx):
                            notrelaxdom = False
