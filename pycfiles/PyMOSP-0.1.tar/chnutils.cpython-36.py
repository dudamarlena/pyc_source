...
# Embedded file name: build/bdist.linux-x86_64/egg/pymoso/chnutils.py
# Compiled at: 2019-09-10 14:28:10
# Size of source mod 2**32: 18914 bytes
...
def solve(problem, solver, x0, **kwargs):
    ...
    return (
     res['itersoln'][lastnu], res['endseed'])
...
def get_testsolve_prnstreams(num_trials, iseed, crn):
    ...
    return (
     orcprn_lst, solprn_lst, xprn, iseed)
