...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syfilebrowser/templatetags/fb_pagination.py
...
@register.inclusion_tag(b'syfilebrowser/include/paginator.html', takes_context=True)
