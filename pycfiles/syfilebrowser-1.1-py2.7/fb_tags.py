...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syfilebrowser/templatetags/fb_tags.py
# Compiled at: 2016-04-18 13:43:03
from __future__ import unicode_literals
from future.builtins import str
from django import template
from django.utils.http import urlquote
from syfilebrowser.settings import SELECT_FORMATS
register = template.Library()

@register.inclusion_tag(b'syfilebrowser/include/_response.html', takes_context=True)
