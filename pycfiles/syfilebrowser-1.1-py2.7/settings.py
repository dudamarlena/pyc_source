...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syfilebrowser/settings.py
# Compiled at: 2016-04-20 06:46:02
...
URL_FILEBROWSER_MEDIA = getattr(settings, b'FILEBROWSER_URL_FILEBROWSER_MEDIA', b'%ssyfilebrowser/' % settings.STATIC_URL)
PATH_FILEBROWSER_MEDIA = getattr(settings, b'FILEBROWSER_PATH_FILEBROWSER_MEDIA', os.path.join(settings.MEDIA_ROOT, b'syfilebrowser/'))
