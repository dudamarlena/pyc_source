...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syfilebrowser/functions.py
...
def get_directory():
    ...
    """
    from shuyucms.conf import settings as mezz_settings
    dirname = DIRECTORY
...
def get_settings_var():
    """
    Get settings variables used for SyFileBrowser listing.
    """
    settings_var = {}
...
def convert_filename(value):
    """
    Convert Filename.
    https://github.com/sehmaschine/django-syfilebrowser/blob/master/syfilebrowser/functions.py
    """
