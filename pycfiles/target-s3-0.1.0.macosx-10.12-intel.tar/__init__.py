...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/target_s3/__init__.py
# Compiled at: 2018-02-12 00:48:31
import io, os, sys, datetime, json, boto3, botocore, singer
...
def main():
    global S3
    required_keys = [
     'summoner_name', 'region', 'queue', 'season']
    ...
    s3_file = ('{}/{}/{}.json').format(CONFIG['season'], CONFIG['summoner_name'], CONFIG['queue'])
