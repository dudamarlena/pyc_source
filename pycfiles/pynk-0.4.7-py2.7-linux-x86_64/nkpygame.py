...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pynk/nkpygame.py
# Compiled at: 2019-01-03 04:37:50
"""
A library for interfacing with the nuklear C library from Python.
"""
import collections, pygame, unicodedata
        ...
        while nuklear_command:
            if nuklear_command.type == lib.NK_COMMAND_NOP:
                ...
                pygame.draw.line(screen, (
                 ...
                 c.begin.x, c.begin.y), (
                 c.end.x, c.end.y), c.line_thickness)
