...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cantools/db/sql/model.py
# Compiled at: 2020-05-01 12:38:19
...
class CTMeta(DeclarativeMeta):
    ...
    def __new__(cls, name, bases, attrs):
        ...
        if lname != 'modelbase':
            attrs['__mapper_args__'] = {'polymorphic_identity': lname}
...
class ModelBase(with_metaclass(CTMeta, sa_dbase)):
    ...
    polytype = String()
    key = CompositeKey()
    __mapper_args__ = {'polymorphic_on': polytype, 
