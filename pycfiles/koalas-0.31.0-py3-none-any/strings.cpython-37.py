...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/databricks/koalas/strings.py
# Compiled at: 2020-02-24 17:25:58
# Size of source mod 2**32: 61483 bytes
"""
...
class StringMethods(object):
    __doc__ = 'String methods for Koalas Series'
    ...
    def capitalize(self) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.capitalize(), StringType()).alias(self.name)
    ...
    def swapcase(self) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.swapcase(), StringType()).alias(self.name)
    ...
    def startswith(self, pattern, na=None) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.startswith(pattern, na), BooleanType()).alias(self.name)
    ...
    def endswith(self, pattern, na=None) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.endswith(pattern, na), BooleanType()).alias(self.name)
    ...
    def strip(self, to_strip=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.strip(to_strip), StringType()).alias(self.name)
    ...
    def lstrip(self, to_strip=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.lstrip(to_strip), StringType()).alias(self.name)
    ...
    def rstrip(self, to_strip=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.rstrip(to_strip), StringType()).alias(self.name)
    ...
    def isalnum(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isalnum(), BooleanType()).alias(self.name)
    ...
    def isalpha(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isalpha(), BooleanType()).alias(self.name)
    ...
    def isdigit(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isdigit(), BooleanType()).alias(self.name)
    ...
    def isspace(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isspace(), BooleanType()).alias(self.name)
    ...
    def islower(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.islower(), BooleanType()).alias(self.name)
    ...
    def isupper(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isupper(), BooleanType()).alias(self.name)
    ...
    def istitle(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.istitle(), BooleanType()).alias(self.name)
    ...
    def isnumeric(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isnumeric(), BooleanType()).alias(self.name)
    ...
    def isdecimal(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.isdecimal(), BooleanType()).alias(self.name)
    ...
    def center(self, width, fillchar=' ') -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.center(width, fillchar), StringType()).alias(self.name)
    ...
    def contains(self, pat, case=True, flags=0, na=None, regex=True) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.contains(pat, case, flags, na, regex), BooleanType()).alias(self.name)
    ...
    def count(self, pat, flags=0) -> 'ks.Series':
        ...
        Name: 0, dtype: int32
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.count(pat, flags), IntegerType()).alias(self.name)
    ...
    def find(self, sub, start=0, end=None) -> 'ks.Series':
        ...
        Name: 0, dtype: int32
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.find(sub, start, end), IntegerType()).alias(self.name)
    ...
    def findall(self, pat, flags=0) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.findall(pat, flags), ArrayType((StringType()), containsNull=True)).alias(self.name)
    ...
    def index(self, sub, start=0, end=None) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.index(sub, start, end), LongType()).alias(self.name)
    ...
    def ljust(self, width, fillchar=' ') -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.ljust(width, fillchar), StringType()).alias(self.name)
    ...
    def match(self, pat, case=True, flags=0, na=np.NaN) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.match(pat, case, flags, na), BooleanType()).alias(self.name)
    ...
    def normalize(self, form) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.normalize(form), StringType()).alias(self.name)
    ...
    def pad(self, width, side='left', fillchar=' ') -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.pad(width, side, fillchar), StringType()).alias(self.name)
    ...
    def repeat(self, repeats) -> 'ks.Series':
        ...
        return _wrap_accessor_pandas(self, lambda x: x.str.repeat(repeats=repeats), StringType()).alias(self.name)
    ...
    def replace(self, pat, repl, n=-1, case=None, flags=0, regex=True) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.replace(pat, repl, n=n, case=case, flags=flags, regex=regex), StringType()).alias(self.name)
    ...
    def rfind(self, sub, start=0, end=None) -> 'ks.Series':
        ...
        Name: 0, dtype: int32
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.rfind(sub, start, end), IntegerType()).alias(self.name)
    ...
    def rindex(self, sub, start=0, end=None) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.rindex(sub, start, end), LongType()).alias(self.name)
    ...
    def rjust(self, width, fillchar=' ') -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.rjust(width, fillchar), StringType()).alias(self.name)
    ...
    def slice(self, start=None, stop=None, step=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.slice(start, stop, step), StringType()).alias(self.name)
    ...
    def slice_replace(self, start=None, stop=None, repl=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.slice_replace(start, stop, repl), StringType()).alias(self.name)
    ...
    def split(self, pat=None, n=-1, expand=False) -> 'ks.Series':
        ...
        return _wrap_accessor_pandas(self, lambda x: x.str.split(pat, n, expand), ArrayType((StringType()), containsNull=True)).alias(self.name)
    ...
    def rsplit(self, pat=None, n=-1, expand=False) -> 'ks.Series':
        ...
        if expand:
            raise NotImplementedError('expand=True is currently not supported.')
        return _wrap_accessor_pandas(self, lambda x: x.str.rsplit(pat, n, expand), ArrayType((StringType()), containsNull=True)).alias(self.name)
    ...
    def translate(self, table) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.translate(table), StringType()).alias(self.name)
    ...
    def wrap(self, width, **kwargs) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: (x.str.wrap)(width, **kwargs), StringType()).alias(self.name)
    ...
    def zfill(self, width) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.zfill(width), StringType()).alias(self.name)
