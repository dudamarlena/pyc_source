...
# Compiled at: 2019-09-16 18:12:13
# Size of source mod 2**32: 62691 bytes
"""
...
class StringMethods(object):
    ...
    def replace(self, pat, repl, n=-1, case=None, flags=0, regex=True) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.str.replace(pat,
          repl, n=n, case=case, flags=flags, regex=regex), StringType()).alias(self.name)
