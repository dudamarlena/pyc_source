...
# [GCC 8.4.0]
# Embedded file name: ./build/lib/databricks/koalas/datetimes.py
# Compiled at: 2020-02-24 17:25:58
# Size of source mod 2**32: 24271 bytes
"""
...
class DatetimeMethods(object):
    __doc__ = 'Date/Time methods for Koalas Series'
    ...
    def dayofweek(self) -> 'ks.Series':
        ...
        Name: 0, dtype: int64
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.dayofweek, LongType()).alias(self._data.name)
    ...
    def dayofyear(self) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.dayofyear, LongType()).alias(self._data.name)
    ...
    def quarter(self) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.quarter, LongType()).alias(self._data.name)
    ...
    def is_month_start(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_month_start, BooleanType()).alias(self._data.name)
    ...
    def is_month_end(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_month_end, BooleanType()).alias(self._data.name)
    ...
    def is_quarter_start(self) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_quarter_start, BooleanType()).alias(self._data.name)
    ...
    def is_quarter_end(self) -> 'ks.Series':
        ...
        Name: dates, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_quarter_end, BooleanType()).alias(self._data.name)
    ...
    def is_year_start(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_year_start, BooleanType()).alias(self._data.name)
    ...
    def is_year_end(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_year_end, BooleanType()).alias(self._data.name)
    ...
    def is_leap_year(self) -> 'ks.Series':
        ...
        Name: 0, dtype: bool
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.is_leap_year, BooleanType()).alias(self._data.name)
    ...
    def daysinmonth(self) -> 'ks.Series':
        ...
        """
        return _wrap_accessor_pandas(self, lambda s: s.dt.daysinmonth, LongType()).alias(self._data.name)
    ...
    def normalize(self) -> 'ks.Series':
        ...
        Name: 0, dtype: datetime64[ns]
        """
        return _wrap_accessor_pandas(self, lambda x: x.dt.normalize(), TimestampType()).alias(self.name)
    ...
    def strftime(self, date_format) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.dt.strftime(date_format), StringType()).alias(self.name)
    ...
    def round(self, freq, *args, **kwargs) -> 'ks.Series':
        ...
        Name: 0, dtype: datetime64[ns]
        """
        return _wrap_accessor_pandas(self, lambda x: (x.dt.round)(freq, *args, **kwargs), TimestampType()).alias(self.name)
    ...
    def floor(self, freq, *args, **kwargs) -> 'ks.Series':
        ...
        Name: 0, dtype: datetime64[ns]
        """
        return _wrap_accessor_pandas(self, lambda x: x.dt.floor(freq), TimestampType()).alias(self.name)
    ...
    def ceil(self, freq, *args, **kwargs) -> 'ks.Series':
        ...
        Name: 0, dtype: datetime64[ns]
        """
        return _wrap_accessor_pandas(self, lambda x: x.dt.ceil(freq), TimestampType()).alias(self.name)
    ...
    def month_name(self, locale=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.dt.month_name(locale), StringType()).alias(self.name)
    ...
    def day_name(self, locale=None) -> 'ks.Series':
        ...
        Name: 0, dtype: object
        """
        return _wrap_accessor_pandas(self, lambda x: x.dt.day_name(locale), StringType()).alias(self.name)