...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syzygy/SAMpileuphelper.py
...
def return_snd_list_SAM(mapqval, qval, qlist, mapqlist, allele_list, sndlist):
    ...
    return (
     allele_threshold, sndlist_threshold)
...
def computesndLODfwd(allelethreshold, sndthreshold, snpsndlodfwd, ref, alt):
    ...
    snpsndlodfwd -= return_loglr(r.log10(r.dbinom(altsndfwd, refbstfwd, 0.42)[0])[0])
    snpsndlodfwd -= return_loglr(r.log10(r.dbinom(refsndfwd, altbstfwd, 0.42)[0])[0])
    snpsndlodfwd += return_loglr(r.log10(r.dbinom(altsndfwd, refbstfwd, 0.75)[0])[0])
    snpsndlodfwd += return_loglr(r.log10(r.dbinom(refsndfwd, altbstfwd, 0.75)[0])[0])
    return snpsndlodfwd
...
def computesndLODrev(allelethreshold, sndthreshold, snpsndlodrev, ref, alt):
    ...
    snpsndlodrev -= return_loglr(r.log10(r.dbinom(altsndrev, refbstrev, 0.42)[0])[0])
    snpsndlodrev -= return_loglr(r.log10(r.dbinom(refsndrev, altbstrev, 0.42)[0])[0])
    snpsndlodrev += return_loglr(r.log10(r.dbinom(altsndrev, refbstrev, 0.75)[0])[0])
    snpsndlodrev += return_loglr(r.log10(r.dbinom(refsndrev, altbstrev, 0.75)[0])[0])
    return snpsndlodrev
