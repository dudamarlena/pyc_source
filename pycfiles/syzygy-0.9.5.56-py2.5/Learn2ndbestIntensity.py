...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syzygy/Learn2ndbestIntensity.py
...
def main(argv=None):
    ...
    parser.add_option('--mqthr', default=1)
    parser.add_option('--out', default='2ndbest.LOD')
