...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/syzygy/SyzygyPower.py
...
def main(argv=None):
    ...
    parser.add_option('--ncpu', default=1)
    ...
    if not options.force:
        ...
        for linef in poolfile[1:]:
            ...
            jobs.append(job_server.submit(EvaluatePower, (inputefile, exonfile, chromosomes, powerdict), (), ('math',
                                                                                                              'numpy',
                                                                                                              'rpy2.rpy_classic',
                                                                                                              'rpy2')))
