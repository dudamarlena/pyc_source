...
# [GCC 8.4.0]
# Embedded file name: /Users/dunfield/cypari/Version2/build/lib.macosx-10.6-intel-2.7/cypari/test.py
...
cpu_width = '64bit' if sys.maxsize > 4294967296 else '32bit'
...
def runtests(verbose=False):
    ...
    for module, extra_globals in modules_to_test:
        ...
        runner = doctest.DocTestRunner(verbose=verbose, optionflags=doctest.ELLIPSIS | doctest.IGNORE_EXCEPTION_DETAIL)
        count = 0
