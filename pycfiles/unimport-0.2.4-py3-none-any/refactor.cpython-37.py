...
# Compiled at: 2020-04-16 09:00:24
# Size of source mod 2**32: 4784 bytes
from contextlib import contextmanager
from lib2to3.fixer_base import BaseFix
from lib2to3.fixer_util import BlankLine, FromImport, Leaf, Newline, syms, token
...
class RefactorImports(BaseFix):
    ...
    def transform(self, node, results):
        ...
        if imp:
            ...
            if node.children[0].type == syms.import_name:
    ...
    def transform_inner_children(self, node, imports):
        if not imports.type == syms.import_as_name:
    ...
    def is_module_unused(self, import_name, node):
        for imp in self.unused_modules:
            if imp['name'] == import_name and imp['lineno'] == node.get_lineno():
                return imp
