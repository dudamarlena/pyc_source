...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-ppc/egg/validino/field.py
...
class DateField(Field):
    ...
    def _make_validator(self, validators):
        validators = (
         V.parse_date(self.format),) + validators
...
class DateTimeField(Field):
    ...
    def _make_validator(self, validators):
        validators = (
         V.parse_datetime(self.format),) + validators
...
class TimeField(Field):
    ...
    def _make_validator(self, validators):
        validators = (
         V.parse_time(self.format),) + validators
