...
# [GCC 8.4.0]
# Embedded file name: /opt/vol1/home/dpgaspar/workarea/preset/elasticsearch-dbapi/es/tests/test_dbapi.py
# Compiled at: 2019-10-23 13:13:03
...
class TestData(unittest.TestCase):
    ...
    def test_execute_empty_results(self):
        ...
        """
        rows = self.cursor.execute("select Carrier from flights where Carrier='NORESULT'").fetchall()
    ...
    def test_boolean_description(self):
        ...
        self.assertEquals(rows.description, [
         (
    ...
    def test_simple_group_by(self):
        ...
        """
        rows = self.cursor.execute('select COUNT(*) as c, Carrier from flights GROUP BY Carrier').fetchall()
        self.assertGreater(len(rows), 1)
