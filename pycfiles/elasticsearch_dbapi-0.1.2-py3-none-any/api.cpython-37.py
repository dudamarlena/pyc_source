...
# [GCC 8.4.0]
# Embedded file name: /opt/vol1/home/dpgaspar/workarea/preset/elasticsearch-dbapi/es/opendistro/api.py
# Compiled at: 2019-10-23 12:33:09
# Size of source mod 2**32: 5490 bytes
...
def connect(host='localhost', port=443, path='', scheme='https', user=None, password=None, context=None, **kwargs):
    """
...
class Connection(BaseConnection):
    ...
    def __init__(self, host='localhost', port=443, path='', scheme='https', user=None, password=None, context=None, **kwargs):
