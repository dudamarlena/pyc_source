...
# [GCC 8.4.0]
# Embedded file name: /Users/dylanjay/Projects/collective/mr.migrator/mr/migrator/browser/helper.py
# Compiled at: 2011-03-26 12:54:42
import urllib
...
class IMigrator(Interface):
    """ remote source interface """
    config = Choice(title=_('Select configuration'), description=_('Registered configurations to choose from.'), vocabulary='collective-migrator-configurations')
