...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-x86_64/egg/macroeco/misc/format_data.py
# Compiled at: 2015-09-16 14:12:24
...
def data_read_write(data_path_in, data_path_out, format_type, **kwargs):
    ...
    if format_type == 'dense':
        ...
        arch_data = pd.read_csv(data_path_in, sep=kwargs['delimiter'], na_values=kwargs['na_values'])
...
def format_dense(base_data, non_label_cols, **kwargs):
    ...
    columnar_data.rename(columns={0: kwargs['count_col'], 'level_%i' % num: kwargs['label_col']}, inplace=True)
