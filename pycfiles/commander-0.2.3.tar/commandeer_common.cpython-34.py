...
# Embedded file name: /home/js/prog/commandeer/env/lib/python3.4/site-packages/tests/commandeer_common.py
# Compiled at: 2015-05-21 14:32:43
# Size of source mod 2**32: 12056 bytes
__doc__ = 'Test data for Commandeer.'
...
class TestArgParsing(unittest.TestCase):
    ...
    def test_switchesonly1(self):
        testinput = [
         'sample.py', '--something=very good', '--somethingelse', '-s', 'good']
    ...
    def test_arg1(self):
        testinput = [
         'sample.py', 'help', '--something=very good', '--somethingelse', '-s', 'good', 'somefile', 'someotherfile']
        callfile, command, switches, args = commandeer._argparse(testinput)
        self.assertEqual(callfile, 'sample.py')
    ...
    def test_arg2(self):
        testinput = [
         'sample.py', 'cmd', 'a0', '--s0=v 0', 'a1', '--s1', '-s2', 'v2', 'a2']
        callfile, command, switches, args = commandeer._argparse(testinput)
        self.assertEqual(callfile, 'sample.py')
    ...
    def test_arg2(self):
        testinput = [
         'sample.py', '--s-1=abc', 'a0', '--s0=v 0', 'a1', '--s1', '-s2', 'v2', 'a2']
        callfile, command, switches, args = commandeer._argparse(testinput)
        self.assertEqual(callfile, 'sample.py')
        self.assertEqual(command, '')
    ...
    def test_arg3(self):
        testinput = [
         'sample.py', 'echo', 'something good', '--indent', '4', '--timestamp']
        callfile, command, switches, args = commandeer._argparse(testinput)
        self.assertEqual(callfile, 'sample.py')
