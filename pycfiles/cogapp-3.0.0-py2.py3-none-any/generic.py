...
# Embedded file name: build/bdist.macosx-10.13-intel/egg/cogandmem/generic.py
# Compiled at: 2018-06-23 15:28:02
...
import sys, os, numpy, time, pygame
...
def exclude_rect(rect1, rect2=None):
    ...
    if rect2.top < rect1.top:
        rects.append(pygame.Rect(rect2.left, rect2.top, rect2.width, rect1.top - rect2.top))
    if rect2.bottom > rect1.bottom:
        rects.append(pygame.Rect(rect2.left, rect2.bottom, rect2.width, rect2.bottom - rect1.bottom))
    if rect2.left < rect1.left:
        rects.append(pygame.Rect(rect2.left, rect2.top, rect1.left - rect2.left, rect2.height))
    if rect2.right > rect1.right:
        rects.append(pygame.Rect(rect1.right, rect2.top, rect2.right - rect1.right, rect2.height))
    return rects
