...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyams_utils/encoding.py
...
ENCODINGS = {'ascii': _('English (ASCII)'), 
...
class EncodingsVocabulary(SimpleVocabulary):
    __doc__ = 'A vocabulary containing a set of registered encodings'
