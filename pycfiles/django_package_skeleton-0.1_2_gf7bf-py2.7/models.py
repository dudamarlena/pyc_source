...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/tests/blogs/models.py
# Compiled at: 2012-01-14 11:36:17
"""
Mini blog models
...
class Entry(models.Model):
    ...
    created_at = models.DateTimeField(_('date and time created'), auto_now_add=True)
    updated_at = models.DateTimeField(_('date and time updated'), auto_now=True)
    ...
    def clean(self):
        ...
        if self.title in ('create', 'update', 'delete'):
            raise ValidationError("The title cannot be 'create', 'update' or 'delete'")