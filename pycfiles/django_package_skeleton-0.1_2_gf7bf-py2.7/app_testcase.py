...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/package/tests/app_testcase.py
# Compiled at: 2012-01-14 11:27:12
"""
Django App TestCase
...
class AppTestCase(test.TestCase):
    """Add required INSTALLED_APPS and MIDDLEWARE_CLASSES independently"""
    installed_apps = []
    middleware_classes = []
    ...
    def _clear_all_meta_caches(self):
        ...
        def clear_meta_caches(meta):
            CACHE_NAMES = ('_m2m_cache', '_field_cache', '_name_map', '_related_objects_cache',
