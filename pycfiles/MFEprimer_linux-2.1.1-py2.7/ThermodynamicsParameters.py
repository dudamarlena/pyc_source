...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/MFEprimer/chilli/ThermodynamicsParameters.py
...
dS_full = {'AATT': -22.2, 
   ...
   'TCAG': -22.2, 'CGGC': -27.2, 
   'GCCG': -24.4, 'GGCC': -19.9, 
   'CCGG': -19.9, 'initCG': -2.8, 
   'initGC': -2.8, 'initAT': 4.1, 
   'initTA': 4.1, 'sym': -1.4, 
   'AATA': 1.7, 
   'ATAA': 1.7, 'CAGA': -4.2, 
   'AGAC': -4.2, 'GACA': -9.8, 
