...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/MFEprimer/chilli/GelMobility.py
...
def load_gel_para_dict(gel_conc=1.0, formula='Helling'):
    ...
    gel_para = {}
    gel_para[0.5] = {'a': 2.7094, 
       'b': 0.2691, 
       'k': 464.4412}
    gel_para[1.0] = {'a': 2.3977, 
       'b': 0.27, 
       'k': 73.9788}
    gel_para[1.5] = {'a': 2.3221, 
       'b': 0.2634, 
       'k': 48.0873}
    gel_para[2.0] = {'a': 2.1333, 
       'b': 0.2561, 
       'k': 18.5417}
