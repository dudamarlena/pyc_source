...
def to_complex(data, deg=False):
    ...
    if deg:
        ...
        d = data.copy()
    return np.exp(d * complex(0.0, 1.0))
...
def _mean(alpha, nanrobust, axis=None, w=None, fconf=False):
    if w is None:
        ...
        t = w * np.exp(complex(0.0, 1.0) * alpha)
        if nanrobust:
...
def mean(alpha, axis=None, w=None, fconf=False, nancheck=True):
    ...
    if nancheck:
        if np.isnan(alpha).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the mean robust to NaNs, please use the nanmean function instead.')
...
def resvec(alpha, axis=None, w=None, d=0, nancheck=True):
    ...
    if nancheck:
        if np.isnan(alpha).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the mean robust to NaNs, please use the nanresvec function instead.')
...
def var(alpha, axis=None, w=None, d=0, angvar=False, nancheck=True):
    ...
    if nancheck:
        if np.isnan(alpha).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the mean robust to NaNs, please use the nanvar function instead.')
...
def std(data, axis=None, deg=False, varroot=False, nancheck=True):
    ...
    if nancheck:
        if np.isnan(data).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the stddev robust to NaNs, please use the nanstd function instead.')
...
def confmean(alpha, axis=None, ci=0.95, w=None, d=0, nancheck=True):
    ...
    if nancheck:
        if np.isnan(alpha).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the mean robust to NaNs, please use the nanconfmean function instead.')
...
def _corrcc(alpha1, alpha2, nanrobust, axis=None):
    if axis is not None:
        if alpha1.shape[axis] != alpha2.shape[axis]:
            raise (
...
def corrcc(alpha1, alpha2, axis=None, nancheck=True):
    ...
    """
    if nancheck:
        if np.isnan(alpha1).any() or np.isnan(alpha2).any():
            raise ValueError('NaN(s) detected in the input array. If you want to ignore this message, please set nancheck to False. If you want to make the mean robust to NaNs, please use the nancorrcc function instead.')
...
def vmpar(alpha, axis=None, w=None, d=0, nancheck=True):
    ...
    if nancheck:
        if np.isnan(alpha).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the mean robust to NaNs, please use the nanvmpar function instead.')
...
def _kappa(alpha, nanrobust, axis=None, w=None, d=0):
    ...
    kappa[i2] = -0.4 + 1.39 * R[i2] + 0.43 / (1 - R[i2])
...
def kappa(alpha, axis=None, w=None, d=0, nancheck=True):
    ...
    if nancheck:
        if np.isnan(alpha).any():
            raise (
             ValueError,
             'NaN(s) detected in the input array.  If you want to ignore this message, please set nancheck to False.  If you want to make the mean robust to NaNs, please use the nankappa function instead.')
