...
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/Clumsy/misc/matplotlibmisc.py
# Compiled at: 2018-11-24 17:01:43
...
try:
    ...
    try:
        print('Encountering ImportErrors due to issues with python package matplotlib', 'not playing nice with an OS X background', '\nAttempting to fix...')
        plt = None
