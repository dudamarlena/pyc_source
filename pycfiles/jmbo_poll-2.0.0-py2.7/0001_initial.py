...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/poll/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('poll_polloption', (
         (
        ...
        db.send_create_signal('poll', ['PollOption'])

    def backwards(self, orm):
        db.delete_table('poll_poll')
        db.delete_table('poll_poll_target')
        db.delete_table('poll_polloption')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'poll.poll': {'Meta': {'ordering': "('-created',)", 'object_name': 'Poll', '_ormbases': ['jmbo.ModelBase']}, 'modelbase_ptr': (
                                     'django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}), 
                     'target': (
                              'django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'poll_target'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['jmbo.ModelBase']"})}, 
