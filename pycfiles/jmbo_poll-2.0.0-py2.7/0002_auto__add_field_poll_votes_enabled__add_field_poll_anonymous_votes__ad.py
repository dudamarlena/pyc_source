...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/poll/migrations/0002_auto__add_field_poll_votes_enabled__add_field_poll_anonymous_votes__ad.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('poll_poll', 'votes_enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        db.add_column('poll_poll', 'anonymous_votes', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        db.add_column('poll_poll', 'votes_closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'poll.poll': {'Meta': {'ordering': "('-created',)", 'object_name': 'Poll', '_ormbases': ['jmbo.ModelBase']}, 'anonymous_votes': (
                                       'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                     'modelbase_ptr': (
                     ...
                     'votes_enabled': (
                                     'django.db.models.fields.BooleanField', [], {'default': 'True'})}, 
       'poll.polloption': {'Meta': {'object_name': 'PollOption'}, 'id': (
                                'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                           'is_correct_answer': (
                                               'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                           'poll': (
                                  'django.db.models.fields.related.ForeignKey', [], {'to': "orm['poll.Poll']"}), 
                           'title': (
