...
# [GCC 8.4.0]
# Embedded file name: /home/hansek/projects/django-translation-manager/translation_manager/filters.py
...
if VERSION[0] == 1 and VERSION[1] >= 4 or VERSION[0] > 1:
    ...
    class TranslationStateFilter(admin.SimpleListFilter):
        ...
        def queryset(self, request, queryset):
            ...
            translated_title = '{translated_label} ({translated_count} / {all_count})'.format(translated_label=(self.lookup_choices[0][1]),
              translated_count=translated_count,
              all_count=all_count)
            untranslated_title = '{translated_label} ({untranslated_count} / {all_count})'.format(translated_label=(self.lookup_choices[1][1]),
