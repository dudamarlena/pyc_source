...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rekog2json2mongo/compare.py
# Compiled at: 2018-03-04 16:08:51
import os, sys
...
client = boto3.client('rekognition', region_name='us-east-1', aws_access_key_id=secret.aws_id, aws_secret_access_key=secret.aws_key)
try:
