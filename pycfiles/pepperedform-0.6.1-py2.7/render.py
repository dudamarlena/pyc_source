...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pepperedform/render.py
# Compiled at: 2012-08-19 14:37:06
"""
...
from pepperedform.renderutils import sequence_getter, make_start_token, _to_css_class, tag
SEQUENCE = 'sequence'
MAPPING = 'mapping'
RENAME = 'rename'

def primary_form_action(context, state, value, css_classes=None, **attrs):
    """
    ...
    """
    attrs['class_'] = _to_css_class(state.determine_css_classes('primary_form_action', add_css_classes=css_classes))
...
def secondary_form_action(context, state, value, tag_name='input', css_classes=None, **attrs):
    """
    ...
    """
    attrs['class_'] = _to_css_class(state.determine_css_classes('secondary_form_action', add_css_classes=css_classes))
    if tag_name == 'input':
...
def hidden_field(context, state, name, value=NotGiven, id=NotGiven, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    attrs['class_'] = _to_css_class(state.determine_css_classes('hidden_field'))
    field_parts = {}
...
def file_field(context, state, name, value=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    if error:
        ...
        field_parts['error'] = error
    field_part_list = state.determine_field_part_list(field_parts, field_part_order)
    css_class = _to_css_class(state.determine_css_classes('file_field', add_css_classes=add_css_classes))
    context.write(tag('div', class_=css_class, *field_part_list))
    return ''


def password_field(context, state, name, value=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    if error:
        ...
        field_parts['error'] = error
    field_part_list = state.determine_field_part_list(field_parts, field_part_order)
    css_class = _to_css_class(state.determine_css_classes('password_field', add_css_classes=add_css_classes))
    context.write(tag('div', class_=css_class, *field_part_list))
    return ''


def text_field(context, state, name, value=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    if error:
        add_css_classes.update(state.determine_css_classes('field_has_error'))
        field_parts['error'] = error
    css_class = _to_css_class(state.determine_css_classes('text_field', add_css_classes=add_css_classes))
    if field_extras:
        field_parts.update(state.determine_extra_field_parts(field_parts, field_extras))
    field_part_list = state.determine_field_part_list(field_parts, field_part_order)
    context.write(tag('div', class_=css_class, *field_part_list))
...
def checkbox_field(context, state, name, checked=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    attrs['_closed'] = state.is_closed()
    field_parts = {}
    field_parts['input'] = tag('input', name=name, value='1', checked=checked, id=id, type='checkbox', **attrs)
    if label:
        field_parts['label'] = tag('label', label, for_=id)
    error = state.render_field_errors(name)
    if field_classes:
    ...
    if field_extras:
        field_parts.update(state.determine_extra_field_parts(field_parts, field_extras))
    field_part_list = state.determine_field_part_list(field_parts, field_part_order, field_type=field_type)
    css_class = _to_css_class(state.determine_css_classes(field_type, add_css_classes=add_css_classes))
    context.write(tag('div', class_=css_class, *field_part_list))
    return ''


def textarea_field(context, state, name, value=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
...
def single_select_field(context, state, name, options, value=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    if field_extras:
        field_parts.update(state.determine_extra_field_parts(field_parts, field_extras))
    field_part_list = state.determine_field_part_list(field_parts, field_part_order)
    css_class = _to_css_class(state.determine_css_classes('single_select_field', add_css_classes=add_css_classes))
    context.write(tag('div', class_=css_class, *field_part_list))
    return ''


def multiple_select_field(context, state, name, options, values=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    if field_extras:
        field_parts.update(state.determine_extra_field_parts(field_parts, field_extras))
    field_part_list = state.determine_field_part_list(field_parts, field_part_order)
    css_class = _to_css_class(state.determine_css_classes('multiple_select_field', add_css_classes=add_css_classes))
    context.write(tag('div', class_=css_class, *field_part_list))
    return ''


def multiple_select_list_field(context, state, name, options, values=NotGiven, label=NotGiven, id=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    item_css_class = _to_css_class(state.determine_css_classes('multiple_select_list_item'))
    field_parts['input'] = []
    for index, option in enumerate(options):
        ...
        if option_value in values:
            ...
            checked = None
        option_id = id + '_' + unicode(option_value)
        field_parts['input'].append(tag('div', tag('input', name=name, value=option_value, id=option_id, checked=checked, type='checkbox', **attrs), tag('label', option_label, for_=option_id), class_=item_css_class))
    ...
    field_part_list.append(tag('input', type='hidden', name='__end__', value=start_token, _closed=closed))
    css_class = _to_css_class(state.determine_css_classes('multiple_select_list_field', add_css_classes=add_css_classes))
    context.write(tag('div', tag('fieldset', *field_part_list), class_=css_class))
    return ''


def single_select_list_field(context, state, name, options, value=NotGiven, id=NotGiven, label=NotGiven, field_extras=None, field_part_order=None, field_classes=None, **attrs):
    """
    ...
    if label:
        field_parts['label'] = tag('legend', label)
    item_css_class = _to_css_class(state.determine_css_classes('single_select_list_item'))
    field_parts['input'] = []
    for index, option in enumerate(options):
        option_value, option_label = option
        ...
        if checked:
            ...
            checked = None
        option_id = id + '_' + option_value
        field_parts['input'].append(tag('div', tag('input', name=name, value=option_value, id=option_id, checked=checked, type='radio', **attrs), tag('label', option_label, for_=option_id), class_=item_css_class))
    ...
    if field_extras:
        field_parts.update(state.determine_extra_field_parts(field_parts, field_extras))
    field_part_list = state.determine_field_part_list(field_parts, field_part_order)
    css_class = _to_css_class(state.determine_css_classes('single_select_list_field', add_css_classes=add_css_classes))
    context.write(tag('div', tag('fieldset', *field_part_list), class_=css_class))
    return ''
...
def sequence_repeater(context, state, name=None, with_adder=False, with_removers=False):
    ...
    template_state = state.clone(defaults=None, errors=None, id_stack=state.push_id_stack(name, '__REPEATER__'), getter=sequence_getter)
