...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/Topics/onlineldavb/onlineldavb.py
# Compiled at: 2013-03-09 15:34:08
import sys, re, time, string, numpy as np
...
class OnlineLDA:
    ...
    def __init__(self, vocab, K, D, alpha, eta, tau0, kappa):
        ...
        self._kappa = kappa
        self._updatect = 0
        self._lambda = 1 * np.random.gamma(100.0, 1.0 / 100.0, (self._K, self._W))
    ...
    def do_e_step(self, docs):
        ...
        batchD = len(docs)
        gamma = 1 * np.random.gamma(100.0, 1.0 / 100.0, (batchD, self._K))
