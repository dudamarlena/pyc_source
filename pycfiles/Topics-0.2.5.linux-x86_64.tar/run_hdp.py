...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/Topics/onlinehdp/run_hdp.py
# Compiled at: 2013-03-01 12:59:26
import os, cPickle, random, time
from optparse import OptionParser
from glob import glob
from numpy import sum
from Topics.onlinehdp import hdp
from corpus import *
np = hdp.np

def parse_args():
    parser = OptionParser()
    parser.set_defaults(T=300, K=20, D=-1, W=-1, eta=0.01, alpha=1.0, gamma=1.0, max_time=100, max_iter=-1, var_converge=0.0001, random_seed=999931111, corpus_name=None, data_path=None, test_data_path=None, test_data_path_in_folds=None, directory=None)
    ...
    parser.add_option('--test_data_path_in_folds', type='string', dest='test_data_path_in_folds', help='testing data prefix for different folds [None]')
