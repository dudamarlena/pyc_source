...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/Topics/onlinehdp/corpus.py
# Compiled at: 2012-01-14 18:37:40
import os
...
class corpus:
    ...
    def read_data(self, filename):
        ...
        for line in file(filename):
            ...
            for w, pair in enumerate(re.finditer('(\\d+):(\\d+)', line)):
