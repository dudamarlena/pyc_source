...
class hdp:
    ...
    def em_on_large_data(self, filename, var_converge, fresh):
        ...
        ss.set_zero()
        Elogbeta = dirichlet_expectation(self.m_beta)
        ...
        if self.m_hdp_hyperparam.m_hyper_opt:
            ...
            likelihood += self.m_hdp_hyperparam.m_gamma_a * log(self.m_hdp_hyperparam.m_gamma_b) - sp.gammaln(self.m_hdp_hyperparam.m_gamma_a)
            likelihood -= self.m_var_gamma_a * log(self.m_var_gamma_b) - sp.gammaln(self.m_var_gamma_a)
            likelihood += (self.m_hdp_hyperparam.m_gamma_a - self.m_var_gamma_a) * log_gamma - (self.m_hdp_hyperparam.m_gamma_b - self.m_var_gamma_b) * self.m_gamma
        else:
