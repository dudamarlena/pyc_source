...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tablemate/__init__.py
# Compiled at: 2015-04-12 21:22:14
"""
...
__url__ = b'https://github.com/jhermann/tablemate'
__version__ = b'0.1.0'
__license__ = b'Apache 2.0'
__author__ = b'Jürgen Hermann'
__author_email__ = b'jh@web.de'
__keywords__ = b'hosted.by.github tables console color unicode csv prettyprint prettify'
__all__ = []