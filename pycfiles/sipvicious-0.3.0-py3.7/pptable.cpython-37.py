...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sipvicious/libs/pptable.py
# Compiled at: 2020-02-26 03:15:12
...
def to_string(data, header=None, alignment='l', padding=(0, 1), style=style):
    if len(data) == 0:
        return 'no results'
    try:
