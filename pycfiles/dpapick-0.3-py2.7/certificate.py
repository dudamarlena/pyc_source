...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DPAPI/Probes/certificate.py
# Compiled at: 2014-10-06 14:50:47
...
class PrivateKeyBlob(probe.DPAPIProbe):
    r"""This class represents a RSA private key file as used by Internet Explorer
    ...
    class RSAKey(probe.DPAPIProbe):
        ...
        class RSAKeyASN1(univ.Sequence):
            ...
            """
            componentType = namedtype.NamedTypes(namedtype.NamedType('version', univ.Integer()), namedtype.NamedType('modulus', univ.Integer()), namedtype.NamedType('pubexpo', univ.Integer()), namedtype.NamedType('privexpo', univ.Integer()), namedtype.NamedType('prime1', univ.Integer()), namedtype.NamedType('prime2', univ.Integer()), namedtype.NamedType('exponent1', univ.Integer()), namedtype.NamedType('exponent2', univ.Integer()), namedtype.NamedType('coefficient', univ.Integer()))
    ...
    class RSAFlags(probe.DPAPIProbe):
        ...
        def preprocess(self, **k):
            self.entropy = 'Hj1diQ6kpUx7VC4m\x00'
            if hasattr(k, 'strong'):
