...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/DPAPI/Core/blob.py
    ...
    def decrypt(self, masterkey, entropy=None, strongPassword=None):
        ...
        for algo in [crypto.CryptSessionKeyXP, crypto.CryptSessionKeyWin7]:
            try:
                ...
                cipher = M2Crypto.EVP.Cipher(self.cipherAlgo.m2name, key[:self.cipherAlgo.keyLength], '\x00' * self.cipherAlgo.ivLength, M2Crypto.decrypt, 0)
