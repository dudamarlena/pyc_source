...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/HackerNewsAPI/API.py
# Compiled at: 2014-10-18 14:55:02
...
class HackerNewsAPI(object):
    ...
    def get_user(self, user_name, raw=False):
        ...
        if raw:
            return user_data
        return HackerNewsUpdates(**user_data)
    ...
    def get_recent_updates(self, raw=True):
        ...
        if raw:
            return updates_data
        return HackerNewsUpdates(**updates_data)
