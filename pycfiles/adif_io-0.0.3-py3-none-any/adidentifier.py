...
# Embedded file name: /Users/alecyrus/Code/AdIdentifier/adidentifier/adidentifier.py
# Compiled at: 2018-05-02 04:42:49
import os, copy, requests, urlparse4 as urlparse
...
class AdIdentifier(object):
    ...
    def __init__(self):
        ...
        self.base_headers = {'Accept-Language': 'en-US,en;q=0.9', 'Accept-Encoding': 'gzip, deflate, br', 
    ...
    def _initialize_adfilters(self):
        try:
            self.filter = AdblockRules(self.raw_rules, use_re2=True, max_mem=536870912)
        except Exception as e:
            print e
