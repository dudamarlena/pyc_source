...
# [GCC 8.4.0]
# Embedded file name: /css_html_js_minify/js_minifier.py
# Compiled at: 2018-04-14 11:03:09
...
def simple_replacer_js(js):
    ...
    return condense_semicolons(js.replace('debugger;', ';').replace(';}', '}').replace('; ', ';').replace(' ;', ';').rstrip('\n;'))
...
def force_single_line_js(js):
    ...
    if len(js.splitlines()) > 1:
        return ';'.join(js.splitlines())
    else:
        return js


class JavascriptMinify(object):
    __doc__ = 'Minify an input stream of Javascript, writing to an output stream.'
    ...
    def minify(self, instream=None, outstream=None):
        ...
        if instream:
            ...
            space_strings = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$\\'
            starters, enders = ('{[(+-', '}])+-"\'')
                ...
                if doing_single_comment:
                    if next1 in '\r\n':
                        ...
                        if previous_before_comment in ')}]':
                            ...
                            if previous_before_comment in space_strings:
                                write('\n')
                else:
                    if in_quote:
                        ...
                        if next1 in '\r\n':
                            ...
                            if conditional_5 or conditional_6:
                                if conditional_4:
                                    do_space = True
                        else:
                            if next1 == '/':
