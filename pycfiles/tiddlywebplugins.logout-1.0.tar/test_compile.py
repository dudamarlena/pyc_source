...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.logout/test/test_compile.py
# Compiled at: 2010-01-31 11:29:58


def test_compile--- This code section failed: ---

 L.   3         0  SETUP_EXCEPT         28  'to 31'

 L.   4         3  LOAD_CONST               -1
                6  LOAD_CONST               None
                9  IMPORT_NAME           0  'tiddlywebplugins.logout'
               12  STORE_FAST            0  'tiddlywebplugins'

 L.   5        15  LOAD_GLOBAL           1  'True'
