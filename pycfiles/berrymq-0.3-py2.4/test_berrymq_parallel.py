...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/tests/test_berrymq_parallel.py
# Compiled at: 2009-07-31 13:33:23
import unittest
berrymq = None
import time
...
class ThreadPoolTest(unittest.TestCase):
    ...
    def test_create1(self):
        global berrymq
        self.assertRaises(ValueError, berrymq.ThreadPool.make_thread_pool, -1)
...
class PrallelWorkTest(unittest.TestCase):
    ...
    def test_parallel_working(self):
        ...
        exp()
        self.assertEqual(['com1_1', 'com1_2', 'com2_1', 'com2_2', 'exp_1', 'exp_2'], call_history)
    ...
    def test_parallel_working2(self):
        ...
        self.assertEqual(['exp_1', 'com1_1', 'com2_1', 'exp_2', 'com1_2', 'com2_2'], call_history)
