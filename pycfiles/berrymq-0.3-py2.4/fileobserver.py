...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/berrymq/adapter/fileobserver.py
# Compiled at: 2009-11-07 07:20:30
import os, glob, time, threading, berrymq
