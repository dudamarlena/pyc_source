...
# [GCC 8.4.0]
# Embedded file name: /Users/sanhehu/Documents/GitHub/dupe_remove-project/dupe_remove/tests/with_redshift.py
# Compiled at: 2019-03-07 13:40:34
# Size of source mod 2**32: 1620 bytes
import uuid, pandas as pd
from datetime import datetime
from s3iotools.io.dataframe import S3Dataframe

def create_test_data(id_col_name, sort_col_name, start, n_month, n_rows_each_month, dupe_perc, s3_resource, bucket_name):
    """
    ...
    """
    start_eod = datetime(year=(start.year), month=(start.month), day=(start.day),
      hour=23,
      minute=59,
      second=59)
    ...
    for end_time in pd.date_range(start=start_eod, periods=n_month, freq='1m'):
        start_time = datetime(year=(end_time.year),
