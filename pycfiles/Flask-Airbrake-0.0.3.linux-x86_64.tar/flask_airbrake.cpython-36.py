...
# [GCC 8.4.0]
# Embedded file name: /home/ppoteralski/Projects/flask-airbrake/venv/lib/python3.6/site-packages/flask_airbrake.py
# Compiled at: 2017-03-10 09:11:29
...
def make_client(client_cls, app, environment=None, base_url=None):
    ...
    return client_cls(project_id, api_key, environment, base_url)


EXCLUDE_LOGGER_DEFAULTS = ('gunicorn', )
...
class Airbrake(object):
    ...
    def __init__(self, app=None, logging=False, logging_exclusions=None, level=logging.NOTSET, wrap_wsgi=None, register_signal=True):
    ...
    def init_app(self, app, logging=None, level=None, logging_exclusions=None, wrap_wsgi=None, register_signal=None):
        self.app = app
