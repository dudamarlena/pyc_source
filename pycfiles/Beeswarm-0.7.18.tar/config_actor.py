...
# [GCC 8.4.0]
# Embedded file name: /home/travis/build/honeynet/beeswarm/beeswarm/server/misc/config_actor.py
...
class ConfigActor(Greenlet):
    ...
    def _handle_command_getkeys(self, name):
        ...
        self.config_commands.send(Messages.OK.value + ' ' + json.dumps({'public_key': publickey, 'private_key': private_key}))
