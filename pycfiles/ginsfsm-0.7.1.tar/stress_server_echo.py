...
# [GCC 8.4.0]
# Embedded file name: /home/gines/midesarrollo/hg-projects/ginsfsm/ginsfsm/examples/essential_gobjs/stress_server_echo.py
...
SERVER_GCONFIG = {'verbose': [
             int, 1, 0, None, 'Increase output verbosity. Values [0,1,2]']}
...
class OnServer(GObj):
    ...
    *Output-Events:*
    ...
    def start_up(self):
        ...
        self.set_timeout(5)
        self.server = self.create_gobj(None, GServerSock, self, host='0.0.0.0', port=8000, transmit_ready_event_name=None)
        return
...
if __name__ == '__main__':
    ...
    ga_srv.create_gobj('server', OnServer, ga_srv)
    try:
        ga_srv.start()
