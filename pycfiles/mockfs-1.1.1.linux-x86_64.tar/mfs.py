...
# [GCC 8.4.0]
# Embedded file name: /home/david/src/python/mockfs/env27/lib/python2.7/site-packages/mockfs/mfs.py
# Compiled at: 2020-03-21 23:28:53
"""mockfs: A simple mock filesystem for unit tests."""
import copy, errno, fnmatch, glob, os, shutil, sys
from . import compat
from . import util
builtins = {'glob.glob': glob.glob, 
   'os.chdir': os.chdir, 
   'os.getcwd': os.getcwd, 
