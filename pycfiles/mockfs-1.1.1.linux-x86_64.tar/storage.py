...
# [GCC 8.4.0]
# Embedded file name: /home/david/src/python/mockfs/env27/lib/python2.7/site-packages/mockfs/storage.py
...
from . import util
__all__ = [
 'file', 'open', 'replace_builtins', 'restore_builtins', 'original_open']
...
Note that not all file objects are seekable."""
    ...
    softspace = property(_get_softspace, _set_softspace, doc='flag indicating that a space needs to be printed; used by print')
