...
# [GCC 8.4.0]
# Embedded file name: /usr/local/var/pyenv/versions/3.5.3/lib/python3.5/site-packages/tests/urlmatch_test.py
...
class URLMatchTest(unittest.TestCase):
    __doc__ = 'Tests that verify that the `urlmatch module functions correctly'
    ...
    def test_http_auth(self):
        ...
        pattern = 'http://test.com/'
        good_urls = [
         'http://user@test.com/', 'http://user:test@test.com/']
        self._check_urls(pattern, good_urls, expected_result=True)
        bad_urls = [
         'http://user:@test.com/', 'http://:@test.com/',
