...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/test/test_script_api.py
...
class TestScriptApi(unittest.TestCase):
    __doc__ = 'ScriptApi unit test stubs'

    def setUp(self):
        self.api = colormeshop.api.script_api.ScriptApi()
    ...
    def test_delete_script_tag(self):
    ...
    def test_update_script_tag(self):
