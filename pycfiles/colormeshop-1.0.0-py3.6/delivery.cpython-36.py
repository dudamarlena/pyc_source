...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/delivery.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 23884 bytes
r"""
    カラーミーショップ API
...
class Delivery(object):
    ...
    def __init__(self, id=None, account_id=None, name=None, image_url=None, charge_free_type=None, charge_free_limit=None, charge_type=None, charge=None, tax_included=None, slip_number_use=None, slip_number_url=None, memo=None, memo2=None, sort=None, display_state=None, preferred_date_use=None, preferred_period_use=None, make_date=None, update_date=None):
    ...
    def charge_free_type(self, charge_free_type):
        ...
        """
        allowed_values = [
         'not_free', 'free', 'free_to_limit']
        if charge_free_type not in allowed_values:
            raise ValueError('Invalid value for `charge_free_type` ({0}), must be one of {1}'.format(charge_free_type, allowed_values))
    ...
    def charge_type(self, charge_type):
        ...
        """
        allowed_values = [
         'fixed', 'by_price', 'by_area', 'by_weight']
        if charge_type not in allowed_values:
            raise ValueError('Invalid value for `charge_type` ({0}), must be one of {1}'.format(charge_type, allowed_values))
    ...
    def display_state(self, display_state):
        ...
        if display_state not in allowed_values:
            raise ValueError('Invalid value for `display_state` ({0}), must be one of {1}'.format(display_state, allowed_values))
