...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/product_category.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 16014 bytes
r"""
    カラーミーショップ API
...
class ProductCategory(object):
    ...
    def __init__(self, id_big=None, id_small=None, account_id=None, name=None, image_url=None, expl=None, sort=None, display_state=None, make_date=None, update_date=None, children=None):
    ...
    def display_state(self, display_state):
        ...
        """
        allowed_values = [
         'showing', 'hidden', 'showing_for_members', 'sale_for_members']
