...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/test/test_delivery_api.py
...
class TestDeliveryApi(unittest.TestCase):
    __doc__ = 'DeliveryApi unit test stubs'

    def setUp(self):
        self.api = colormeshop.api.delivery_api.DeliveryApi()
