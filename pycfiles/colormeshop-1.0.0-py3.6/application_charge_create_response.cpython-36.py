...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/application_charge_create_response.py
...
class ApplicationChargeCreateResponse(object):
    ...
    def __init__(self, id=None, account_id=None, oauth_application_id=None, application_charge_plan_id=None, return_url=None, confirmation_url=None, status=None, make_date=None, update_date=None):
        """ApplicationChargeCreateResponse - a model defined in OpenAPI"""
        self._id = None
