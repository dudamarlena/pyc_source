...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/test/test_category_api.py
...
class TestCategoryApi(unittest.TestCase):
    __doc__ = 'CategoryApi unit test stubs'

    def setUp(self):
        self.api = colormeshop.api.category_api.CategoryApi()
