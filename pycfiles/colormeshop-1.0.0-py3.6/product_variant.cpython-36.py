...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/product_variant.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 16903 bytes
r"""
    カラーミーショップ API
...
class ProductVariant(object):
    ...
    openapi_types = {'product_id':'int', 
     ...
     'make_date':'int', 
     'update_date':'int'}
    attribute_map = {'product_id':'product_id', 
    ...
    def __init__(self, product_id=None, account_id=None, option1_value=None, option2_value=None, title=None, stocks=None, few_num=None, model_number=None, option_price=None, option_members_price=None, make_date=None, update_date=None):
