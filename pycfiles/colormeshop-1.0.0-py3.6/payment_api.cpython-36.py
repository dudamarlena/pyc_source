...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/api/payment_api.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 8280 bytes
r"""
    カラーミーショップ API
    ...
    def get_payments_with_http_info(self, **kwargs):
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method get_payments" % key)
            params[key] = val
        ...
        auth_settings = [
         'OAuth2']
        return self.api_client.call_api('/v1/payments.json',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
