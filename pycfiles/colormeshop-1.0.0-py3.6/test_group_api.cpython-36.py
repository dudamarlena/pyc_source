...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/test/test_group_api.py
...
class TestGroupApi(unittest.TestCase):
    __doc__ = 'GroupApi unit test stubs'

    def setUp(self):
        self.api = colormeshop.api.group_api.GroupApi()
