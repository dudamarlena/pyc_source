...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/customer.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 20863 bytes
r"""
    カラーミーショップ API
...
class Customer(object):
    ...
    def __init__(self, id=None, account_id=None, name=None, furigana=None, hojin=None, busho=None, sex=None, postal=None, pref_id=None, pref_name=None, address1=None, address2=None, mail=None, tel=None, fax=None, tel_mobile=None, memo=None, points=None, member=None, sales_count=None):
