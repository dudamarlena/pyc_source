...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/test/test_customer_api.py
...
class TestCustomerApi(unittest.TestCase):
    __doc__ = 'CustomerApi unit test stubs'

    def setUp(self):
        self.api = colormeshop.api.customer_api.CustomerApi()
