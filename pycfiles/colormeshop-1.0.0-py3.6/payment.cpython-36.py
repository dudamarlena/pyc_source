...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/payment.py
# Compiled at: 2018-07-29 03:49:51
# Size of source mod 2**32: 22387 bytes
r"""
    カラーミーショップ API
...
class Payment(object):
    ...
    def __init__(self, id=None, account_id=None, name=None, fee=None, ip_code=None, memo=None, memo_mobile=None, sort=None, image_url=None, type=None, display=None, use_mobile=None, make_date=None, update_date=None, cod=None, card=None, financial=None):
    ...
    def type(self, type):
        ...
        if type is not None:
            if type < 0:
                raise ValueError('Invalid value for `type`, must be a value greater than or equal to `0`')
        self._type = type
