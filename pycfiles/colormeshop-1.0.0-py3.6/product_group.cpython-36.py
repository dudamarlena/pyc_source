...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/colormeshop/models/product_group.py
...
class ProductGroup(object):
    ...
    def __init__(self, id=None, account_id=None, name=None, image_url=None, expl=None, sort=None, display_state=None):
