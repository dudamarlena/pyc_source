...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/examples/git_builder.py
...
def setup_automaton():
    world_state_matrix = {'git_repo_updated':'Unknown', 
     'build_project':'Unknown', 
     'notify_build':'Unknown'}
    automaton = AutomatonController(name='directory_watcher',
