...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.6/site-packages/akamu/demo/gsp_validator.py
# Compiled at: 2012-12-09 11:55:48
...
@xslt_rest(os.path.join(config().get('demo_path'), 'gsp_validator.xslt'))
def validator_form(message=None):
    if message:
        return (NOOPXML, {'message': message})
    else:
        return NOOPXML
...
GRAPH1 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <foaf:Person rdf:about="%s">\n        <foaf:businessCard>\n            <v:VCard>\n                <v:fn>%s</v:fn>\n            </v:VCard>\n        </foaf:businessCard>\n    </foaf:Person>\n</rdf:RDF>'
GRAPH2 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <foaf:Person rdf:about="%s">\n        <foaf:businessCard>\n            <v:VCard>\n                <v:given-name>%s</v:given-name>\n            </v:VCard>\n        </foaf:businessCard>\n    </foaf:Person>\n</rdf:RDF>'
GRAPH3 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <rdf:Description rdf:about="%s">\n        <foaf:name>%s</foaf:name>\n    </rdf:Description>\n</rdf:RDF>'
GRAPH4 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <foaf:Person rdf:about="%s">\n        <foaf:name>%s</foaf:name>\n        <foaf:businessCard>\n            <v:VCard>\n                <v:fn>%s</v:fn>\n            </v:VCard>\n        </foaf:businessCard>\n    </foaf:Person>\n</rdf:RDF>'
GRAPH5 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <rdf:Description rdf:about="%s">\n        <foaf:familyName>%s</foaf:familyName>\n    </rdf:Description>\n</rdf:RDF>\n'
GRAPH6 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <rdf:Description rdf:about="%s">\n        <foaf:givenName>%s</foaf:givenName>\n    </rdf:Description>\n</rdf:RDF>\n'
GRAPH7 = '<?xml version="1.0"?>\n<rdf:RDF\n    xmlns:rdf ="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n    xmlns:foaf="http://xmlns.com/foaf/0.1/"\n    xmlns:v   ="http://www.w3.org/2006/vcard/ns#"\n    >\n    <foaf:Person rdf:about="%s">\n        <foaf:name>%s</foaf:name>\n        <foaf:givenName>Jane</foaf:givenName>\n        <foaf:familyName>Doe</foaf:familyName>\n        <foaf:businessCard>\n            <v:VCard>\n                <v:fn>%s</v:fn>\n            </v:VCard>\n        </foaf:businessCard>\n    </foaf:Person>\n</rdf:RDF>'
TEST_GRAPHS = {'PUT - Initial state': (
                         GRAPH1, 'person/1', 'xml', 'John Doe'), 
   'PUT - graph already in store': (
                                  GRAPH1, 'person/1', 'xml', 'Jane Doe'), 
   'PUT - default graph': (
                         GRAPH2, '', 'xml', 'Alice'), 
   'PUT - mismatched payload': (
                              GRAPH1, 'person/1', 'xml', 'Jane Doe'), 
   ...
   'PUT - replace empty graph': (
                               GRAPH2, '', 'xml', 'Alice'), 
   'POST - existing graph': (
                           GRAPH3, 'person/1', 'xml', 'Jane Doe'), 
   'HEAD on an existing graph': (
                               GRAPH1, 'person/1', 'xml', 'John Doe'), 
   'HEAD on a non-existing graph': (
                                  None, None, None, None), 
   'GET of POST - existing graph': (
                                  GRAPH4, 'person/1', 'xml', ('Jane Doe',) * 2), 
   'POST - create  new graph': (
                              GRAPH2, '', 'xml', 'Alice'), 
   'POST - empty graph to existing graph': (
                                          None, None, None, None), 
   'multipart/form-data graph 1': (
                                 GRAPH5, 'person/1', 'xml', 'Doe'), 
   'multipart/form-data graph 2': (
                                 GRAPH6, 'person/1', 'xml', 'Jane'), 
   'GET of POST - multipart/form-data': (
                                       GRAPH7, 'person/1', 'xml', ('Jane Doe',) * 2)}
...
class GraphStoreValidator(object):
    ...
    def __init__(self, graph_store_url, gs_url_internal):
        ...
        if gs_url_internal:
            self.gs_url_internal = gs_url_internal if gs_url_internal[(-1)] == '/' else gs_url_internal + '/'
        self.graph_store_url = graph_store_url
        self.graphs = TEST_GRAPHS.copy()
        self.graph_store_url_base = graph_store_url if graph_store_url[(-1)] == '/' else graph_store_url + '/'
        for (testName, (src, relUrl, format, name)) in list(TEST_GRAPHS.items()):
            if src is None:
                ...
                self.graphs[testName] = IsomorphicTestableGraph().parse(StringIO(src), format=format)

        return

    def yieldResultElem(self, testName, successful, url, message=None):
        path_and_query = urlparse(url).path
        path_and_query = path_and_query + '?' + urlparse(url).query if urlparse(url).query else path_and_query
        attrs = {'path': path_and_query, 
           'name': testName, 
           'result': 'passed' if successful else 'failed'}
        assert testName in TESTS, testName
        testId = testName.replace(' ', '_').replace('-', '').replace('/', '_').lower()
        attrs['id'] = testId
        if message:
            return E((
             TEST_NS, 'Result'), attrs, message)
        else:
            return E((
             TEST_NS, 'Result'), attrs)

    def graphSubmit(self, h, url, testName, getTestName=None, expectedStatus=[
 201, 204], imt='text/turtle; charset=utf-8', format='n3', method='PUT', responseInfo=None, getUrl=None):
        responseInfo = responseInfo if responseInfo is not None else []
        graph = self.graphs[testName]
        body = graph.serialize(format=format) if graph is not None else ''
        hasPayload = False
        ...
        (resp, content) = h.request(url, method, body=body if hasPayload else None, headers=headers)
        ...
        if method == 'HEAD':
            if content:
                yield self.yieldResultElem(testName, False, url, 'HEAD response should have no content in the body')
            elif not matchingStatus:
                yield self.yieldResultElem(testName, False, url, 'expected status %s, received %s (%s)' % (
                 expectedStatus,
                 resp.status,
                 content))
            elif 'content-length' not in resp:
                yield self.yieldResultElem(testName, False, url, 'expected content-length header in response')
            elif 'content-type' not in resp:
                yield self.yieldResultElem(testName, False, url, 'expected content-type header in response')
            else:
    ...
    def isomorphCheck(self, testName, h, url, alternativeTestName=None):
        try:
            ...
            yield self.yieldResultElem(testName, False, url, 'Unable to perform content negotiated GET' % repr(e))
        else:
            ...
            if resp.status == 200:
                if 'content-type' not in resp or resp['content-type'].find('text/turtle') + 1:
                    if content is not None and not content.strip():
                        content = None
                    g1 = IsomorphicTestableGraph().parse(StringIO(content), format='n3') if content is not None else None
                    if g1 != self.graphs[testName]:
                        ...
                        print resp
                        print '--------------------'
                        yield self.yieldResultElem(getTestName, False, url, 'unexpected returned RDF graph')
                    else:
                        yield self.yieldResultElem(getTestName, True, url)
                elif 'content-type' in resp:
                    yield self.yieldResultElem(getTestName, False, url, 'expected returned content-type of "text/turtle; charset=utf-8", received %s' % resp['content-type'])
            else:
                yield self.yieldResultElem(getTestName, False, url, 'expected status %s, received %s (%s)' % (
    ...
    def runTests(self):
        ...
        (resp, content) = h.request(iri.absolutize('person/4.ttl', self.graph_store_url_base), 'HEAD')
        if resp.status == 404:
            yield self.yieldResultElem(testName, True, url)
        else:
            yield self.yieldResultElem(testName, False, url, 'expected status %s, received %s (%s)' % (
             ...
             resp.status,
             content))
        testName = 'PUT - graph already in store'
        for el in self.graphSubmit(h, url, testName, expectedStatus=[
         200, 204], getTestName='GET of PUT - graph already in store', getUrl=indirect_url):
            yield el

        url = self.graph_store_url_base + '?default'
        testName = 'PUT - default graph'
        for el in self.graphSubmit(h, url, testName, 'GET of PUT - default graph', expectedStatus=204):
            yield el
        ...
        if self.gs_url_internal:
            ...
            indirect_url = self.graph_store_url_base + '?graph=' + urllib2.quote(url)
        for el in self.graphSubmit(h, indirect_url, 'PUT - empty graph', 'GET of PUT - empty graph', getUrl=url):
            yield el

        h = httplib2.Http()
        url = iri.absolutize('person/2.ttl', self.graph_store_url_base)
        for el in self.graphSubmit(h, url, 'PUT - replace empty graph', 'GET of replacement for empty graph', expectedStatus=[
         201, 204]):
            yield el
        ...
        for el in self.isomorphCheck('GET of POST - existing graph', h, url, alternativeTestName='GET of POST - existing graph'):
            yield el
        ...
        try:
            ...
            (datagen, headers) = multipart_encode([
             MultipartParam('lastName.ttl', self.graphs['multipart/form-data graph 1'].serialize(format='turtle'), filename='lastName.ttl', filetype='text/turtle; charset=utf-8'),
             MultipartParam('firstName.ttl', self.graphs['multipart/form-data graph 2'].serialize(format='turtle'), filename='firstName.ttl', filetype='text/turtle; charset=utf-8')])
            ...
            if resp.code not in (200, 204):
                ...
                yield self.yieldResultElem(testName, True, url)
            for el in self.isomorphCheck('GET of POST - multipart/form-data', h, url, 'GET of POST - multipart/form-data'):
                yield el

        except urllib2.HTTPError, e:
            yield self.yieldResultElem(testName, False, url, 'Invalid Server response: %s' % repr(e))
        except ImportError:
            pass
        ...
        responseInfo = []
        for el in self.graphSubmit(h, url, testName, expectedStatus=201, method='POST', responseInfo=responseInfo):
            yield el
        ...
        if responseInfo:
            ...
            if 'location' in resp:
                yield self.yieldResultElem(testName, True, url)
                url = resp['location']
                for el in self.isomorphCheck('POST - create  new graph', h, url, alternativeTestName='GET of POST - create  new graph'):
                    yield el

                h = httplib2.Http()
                for el in self.graphSubmit(h, url, 'POST - empty graph to existing graph', expectedStatus=[
                 200, 204], method='POST'):
                    yield el

                for el in self.isomorphCheck('POST - create  new graph', h, url, alternativeTestName='GET of POST - after noop'):
                    yield el

            else:
                yield self.yieldResultElem(testName, False, url, 'POST to graph store should return Location header: %s' % repr(resp))
...
class WsgiGSPValidator(object):
    ...
    def __call__(self, environ, start_response):
        ...
        if req.method == 'POST':
            ...
            rt = 'Validation HTTP methods supported are POST and GET: received %s' % req.method
        ...
        if validator_url and implementation_url:
            ...
            w.feed(ROOT(E((
             TEST_NS, 'Results'), (elem for elem in validator.runTests()))))
            requestedRDF = set(layercake_mimetypes).intersection(req.accept)
            if 'HTTP_ACCEPT' not in environ or not requestedRDF:
                rt = transform(src.getvalue(), os.path.join(config().get('demo_path'), 'gsp_validation_results.xslt'), params={'project': project_name, 
            ...
            if requestedRDF:
                ...
                rt = transform(src.getvalue(), os.path.join(config().get('demo_path'), 'gsp_validation_results_earl.xslt'), params={'project': project_name, 
                ...
                g.bind('test', URIRef('http://www.w3.org/2009/sparql/docs/tests/data-sparql11/http-rdf-update/#'))
