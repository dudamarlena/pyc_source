...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/centinel/client.py
# Compiled at: 2015-10-26 01:57:11
import bz2, glob, imp, json, logging, logging.config, os, tarfile, time
...
class Client:
    ...
    def run_exp(self, name, exp_config=None, schedule_name=None):
        if name not in self.experiments:
            ...
            try:
                result_file_path = self.get_result_file(name, start_time.isoformat())
