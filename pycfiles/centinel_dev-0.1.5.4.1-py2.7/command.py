...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/centinel/command.py
...
class Command:
    ...
    def _invoke_cmd(self):
        try:
            self.process = subprocess.Popen(self.command, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
