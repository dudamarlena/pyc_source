...
# [GCC 8.4.0]
# Embedded file name: /home/sam/git/Kanban/django-autotask/djautotask/tests/mocks.py
...
def build_batch_query(side_effect=None):
    mock_call, _patch = create_mock_call('djautotask.sync.TimeEntrySynchronizer.build_batch_queries', [], side_effect=side_effect)
    return (
     mock_call, _patch)