...
# [GCC 8.4.0]
# Embedded file name: /home/sam/git/Kanban/django-autotask/djautotask/migrations/0007_auto_20190917_1009.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Queue', fields=[
      (
      ...
      (
       'is_system', models.BooleanField(default=False))], options={'verbose_name_plural': 'Queues'}),
     migrations.AddField(model_name='ticket', name='queue', field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='djautotask.Queue'))]