...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\sslyzedb\core\dbmodel.py
# Compiled at: 2019-02-25 13:36:55
...
command_map_rev = {CertificateInfoScanCommand: SSLYZECommand.CERTIFICATEINFO, 
...
scan_targets_table = Table('scan_targets_table', Basemodel.metadata, Column('scan_id', Integer, ForeignKey('scans.id')), Column('target_id', Integer, ForeignKey('targets.id')))
