...
# [GCC 8.4.0]
# Embedded file name: /Users/akshay/Documents/Programming/python/testing/hogwatch/hogwatch/server/web_service.py
# Compiled at: 2018-09-13 06:13:58
import json, gevent
...
from bottle import Bottle, static_file, redirect, request, abort
local_path = os.path.abspath(os.path.dirname(__file__))
path_for_static_assets = os.path.join(local_path, 'frontend', 'vendor')
path_for_static_assets += '/'

def app_server(host='0.0.0.0', port=6432, debugMode=False, reloader=True, ws=True):
    ...
    if ws:
        ...
        def handle_websocket(device='all', mode='transfer_rate'):
            ...
            bridge = {'queue': Queue()}
            t = Thread(target=watchdog.watch_transfer, args=(
             mode, bridge))
