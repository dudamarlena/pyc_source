...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vexmpp/suelta/mechanisms/scram_hmac.py
# Compiled at: 2017-02-05 18:19:58
...
class SCRAM_HMAC(Mechanism):
    ...
    def Hi(self, text, salt, iterations):
        ...
        """
        text = bytes(text)
        ui_1 = self.HMAC(text, salt + b'\x00\x00\x00\x01')
        ui = ui_1
