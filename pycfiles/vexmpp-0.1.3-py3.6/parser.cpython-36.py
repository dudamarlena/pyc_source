...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vexmpp/parser.py
# Compiled at: 2017-02-05 18:31:06
# Size of source mod 2**32: 4736 bytes
...
class Parser(object):
    ...
    def _onEndElement(self, name):
        ...
        if self._curr.level == 0:
            ...
            self._curr.reset()
        elif self._curr.elem is not None:
