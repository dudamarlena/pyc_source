...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vexmpp/protocols/iqroster.py
# Compiled at: 2017-02-05 18:39:33
...
async def get(stream, timeout=None):
    iq = await stream.sendAndWaitIq(NS_URI, timeout=timeout, id_prefix='roster_get',
      raise_on_error=True)
    return iq
...
class RosterItem(object):
    ...
    def __init__(self, item_elem=None, jid=None, name=None, subscription=None, groups=None, ask=None):
        if jid:
