...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vexmpp/suelta/mechanisms/digest_md5.py
# Compiled at: 2017-02-05 18:16:23
# Size of source mod 2**32: 8010 bytes
import sys, hmac, random
...
class DIGEST_MD5(Mechanism):
    ...
    def okay(self):
        """
        """
        if self._rspauth_okay:
            if self._qop == b'auth-int':
