...
# Embedded file name: build/bdist.linux-i686/egg/pyndexter/indexers/tests.py
# Compiled at: 2007-02-14 08:08:57
...
class IndexerTestCase(unittest.TestCase):
    ...
    def test_indexing(self):
        ...
        filtered = []
        documents['mock://12'].attributes['changed'] += 1
        self.framework.update(filter=filter)
        filtered.sort()
        self.assertEquals(filtered, [(2, URI('mock://12'))])
    ...
    def test_fetch_via_source(self):
        ...
        self.assertRaises(DocumentNotFound, self.framework.fetch, 'file://foo')
