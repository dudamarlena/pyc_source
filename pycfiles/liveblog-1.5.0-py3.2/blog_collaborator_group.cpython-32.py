...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/livedesk/meta/blog_collaborator_group.py
...
from livedesk.api.blog_collaborator_group import BlogCollaboratorGroupMember, BlogCollaboratorGroup
