...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/superdesk/media_archive/core/impl/thumbnail_processor_ffmpeg.py
...
class ThumbnailProcessorFfmpeg(IThumbnailProcessor):
    ...
    """
    command_transform = '"%(ffmpeg)s" -i "%(source)s" "%(destination)s"'
