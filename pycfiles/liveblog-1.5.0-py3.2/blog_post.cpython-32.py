...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/livedesk/meta/blog_post.py
...
class BlogPostMapped(BlogPostDefinition, PostMapped, BlogPost):
    ...
    AuthorPerson.expression(lambda cls: case([(cls.author == None, cls.Creator)], else_=case([(CollaboratorMapped.User != None, CollaboratorMapped.User)])))