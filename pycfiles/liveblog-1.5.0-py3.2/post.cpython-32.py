...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/superdesk/post/meta/post.py
...
from ally.container.binder_op import validateManaged, validateRequired, EVENT_PROP_UPDATE
