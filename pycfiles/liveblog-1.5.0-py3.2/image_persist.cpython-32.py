...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/superdesk/media_archive/impl/image_persist.py
...
from superdesk.media_archive.meta.image_data import META_TYPE_KEY, ImageDataEntry
...
class ImagePersistanceAlchemy(SessionSupport, IMetaDataHandler):
    ...
    def populateThumbnail(self):
        ...
        """
        self.thumbnailManager.putThumbnail(self.defaultThumbnailFormatId(), abspath(join(pythonPath(), 'resources', 'image.jpg')))
