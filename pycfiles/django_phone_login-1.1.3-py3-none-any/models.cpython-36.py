...
# [GCC 8.4.0]
# Embedded file name: /Users/ray/Work/Rumor/django-phone-login/phone_login/models.py
# Compiled at: 2017-08-23 08:40:12
...
class PhoneToken(models.Model):
    ...
    def create_otp_for_number(cls, number):
        ...
        if otps.count() <= getattr(settings, 'PHONE_LOGIN_ATTEMPTS', 10):
            ...
            message = SmsMessage(body=(render_to_string('otp_sms.txt', {'otp':otp, 
             'id':phone_token.id})),
