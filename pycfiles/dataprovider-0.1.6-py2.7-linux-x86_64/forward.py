...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dataprovider/forward.py
...
class ForwardScanner(object):
    ...
    def _prepare_outputs(self):
        ...
        self.outputs = blend.prepare_outputs(self.scan_spec, self.locs, blend=overlap, blend_mode=blend_mode)
