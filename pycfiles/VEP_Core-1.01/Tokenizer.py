...
# [GCC 8.4.0]
# Embedded file name: C:\LocalUsers\ealexand\VEP_Core\vep_core\Ity\Tokenizers\Tokenizer.py
...
" is captured as a single "newline" token.
    ...
    * The **last** str should be the original str capture (i.e. the most
    ...
    def __init__(self, debug=False, label=None, excluded_token_types=(), case_sensitive=True, preserve_original_strs=False):
        """
