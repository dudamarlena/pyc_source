...
# [GCC 8.4.0]
# Embedded file name: C:\LocalUsers\ealexand\VEP_Core\vep_core\Ity\Formatters\Formatter.py
...
class Formatter(BaseClass):
    ...
    * **Paginated** templates output directories.**
    ...
    def __init__(self, debug=False, label=None, token_str_index=-1, token_whitespace_newline_str_index=0, standalone=True, paginated=False):
        super(Formatter, self).__init__(debug=debug, label=label)
    ...
    @abc.abstractmethod
    def format(self, output_path=None, rules=None, tags=None, tokens=None, text_str=None):
        pass