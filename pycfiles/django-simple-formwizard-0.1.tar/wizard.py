...
# [GCC 8.4.0]
# Embedded file name: form_wizard/wizard.py
# Compiled at: 2013-11-03 07:34:50
...
import uuid
__all__ = [
 'Wizard', 'wizard_check_id', 'wizard_check_data']
...
def wizard_check_id(redirect_to='/'):
    ...
    def decorator(view_func):
        ...
        def _wrapped_view(request, *args, **kwargs):
            if 'wizard_id' not in request.session:
