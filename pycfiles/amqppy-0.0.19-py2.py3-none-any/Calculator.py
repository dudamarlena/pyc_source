...
# Embedded file name: gen-py/tutorial/Calculator.py
# Compiled at: 2009-08-22 04:15:56
...
class add_args(object):
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'num1', None, None),
     (
      2, TType.I32, 'num2', None, None))
...
class calculate_args(object):
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'logid', None, None),
     (
      2, TType.STRUCT, 'w', (Work, Work.thrift_spec), None))
  ...
  """
    thrift_spec = (
     (
      0, TType.I32, 'success', None, None),
     (
      1, TType.STRUCT, 'ouch', (InvalidOperation, InvalidOperation.thrift_spec), None))
