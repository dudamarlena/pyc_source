...
# Embedded file name: gen-py/tutorial/ttypes.py
...
class Work(object):
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'num1', None, 0),
     (
      2, TType.I32, 'num2', None, None),
     (
      3, TType.I32, 'op', None, None),
     (
      4, TType.STRING, 'comment', None, None))
...
class InvalidOperation(Exception):
  ...
  """
    thrift_spec = (
     None,
     (
      1, TType.I32, 'what', None, None),
     (
      2, TType.STRING, 'why', None, None))
