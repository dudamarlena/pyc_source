...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/wmpy_util/web_utils.py
# Compiled at: 2019-12-30 05:06:59
...
def controller(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if isinstance(response_data, HttpResponse):
            ...
            logger.info('%s receive_param=%s,  respond = %s' % (__name, get_cutted_param_string(param, 200), ret_str))
