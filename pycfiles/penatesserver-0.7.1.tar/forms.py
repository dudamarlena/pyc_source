...
# [GCC 8.4.0]
# Embedded file name: /home/mgallet/Github/Penates-Server/penatesserver/glpi/forms.py
...
class ShinkenServiceForm(forms.Form):
    ...
    initial_state = forms.ChoiceField(initial=None, required=False, choices=[
     ('o', 'o'), ('w', 'w'), ('u', 'u'), ('c', 'c')])
    ...
    flap_detection_options = forms.ChoiceField(initial=None, required=False, choices=[
     ('o', 'o'), ('w', 'w'), ('u', 'u'), ('c', 'c')])
    ...
    notification_options = forms.ChoiceField(initial=None, required=False, choices=[
     ('r', 'r'), ('w', 'w'), ('u', 'u'), ('c', 'c'), ('f', 'f'),
     ('s', 's')])
    ...
    stalking_options = forms.ChoiceField(initial=None, required=False, choices=[
     ('o', 'o'), ('w', 'w'), ('u', 'u'), ('c', 'c')])
    ...
    business_rule_host_notification_options = forms.ChoiceField(initial=None, required=False, choices=[
     ('r', 'r'), ('d', 'd'), ('u', 'u'), ('f', 'f'),
     ('s', 's')])
    business_rule_service_notification_options = forms.ChoiceField(initial=None, required=False, choices=[
     ('r', 'r'), ('w', 'w'), ('u', 'u'),
     ('c', 'c'), ('f', 'f'), ('s', 's')])
    ...
    snapshot_criteria = forms.ChoiceField(initial=None, required=False, choices=[
     ('o', 'o'), ('w', 'w'), ('u', 'u'), ('c', 'c')])
