...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/helpcenter/tests/test_models.py
...
from helpcenter.testing_utils import create_article, create_category, instance_to_queryset_string
...
class TestArticleModel(TestCase):
    ...
    def test_create(self):
        ...
        time = timezone.now()
        article = models.Article.objects.create(category=category, title=title, body=body, time_published=time, draft=True)
    ...
    def test_defaults(self):
        ...
        body = 'Test body.'
        start = timezone.now()
        article = models.Article.objects.create(title=title, body=body)
        end = timezone.now()
    ...
    def test_get_absolute_url(self):
        ...
        url = reverse('helpcenter:article-detail', kwargs={'article_pk': article.pk, 
    ...
    def test_get_delete_url(self):
        ...
        """
        article = create_article()
        expected = reverse('helpcenter:article-delete', kwargs={'article_pk': article.pk, 
           'article_slug': article.slug})
    ...
    def test_get_update_url(self):
        ...
        """
        article = create_article()
        expected = reverse('helpcenter:article-update', kwargs={'article_pk': article.pk, 
           'article_slug': article.slug})
...
class TestCategoryModel(TestCase):
    ...
    def test_article_list_default(self):
        ...
        self.assertQuerysetEqual(top_category.article_list, [
    ...
    def test_get_absolute_url(self):
        ...
        """
        category = create_category()
        url = reverse('helpcenter:category-detail', kwargs={'category_pk': category.pk, 
    ...
    def test_get_delete_url(self):
        ...
        """
        category = create_category()
        expected = reverse('helpcenter:category-delete', kwargs={'category_pk': category.pk, 
           'category_slug': category.slug})
    ...
    def test_get_update_url(self):
        ...
        """
        category = create_category()
        expected = reverse('helpcenter:category-update', kwargs={'category_pk': category.pk, 
           'category_slug': category.slug})
