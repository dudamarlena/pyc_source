...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/helpcenter/views.py
...
class ArticleCreateView(OptionalFormMixin, PermissionsMixin, generic.edit.CreateView):
...
class ArticleUpdateView(OptionalFormMixin, PermissionsMixin, generic.edit.UpdateView):
...
class CategoryCreateView(OptionalFormMixin, PermissionsMixin, generic.edit.CreateView):
...
class CategoryUpdateView(OptionalFormMixin, PermissionsMixin, generic.edit.UpdateView):
