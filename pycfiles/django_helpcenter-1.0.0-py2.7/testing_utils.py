...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/helpcenter/testing_utils.py
...
def create_article(title=ARTICLE_TITLE, body=ARTICLE_BODY, time_published=None, category=None, draft=None):
