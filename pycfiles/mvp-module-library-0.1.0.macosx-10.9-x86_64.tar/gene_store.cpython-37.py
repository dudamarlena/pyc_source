...
# [GCC 8.4.0]
# Embedded file name: /Users/deepak.unni3/GIT/mvp-module-library-master/env/lib/python3.7/site-packages/GeneStore/gene_store.py
# Compiled at: 2019-09-12 20:29:16
# Size of source mod 2**32: 967 bytes
import pandas as pd

class FanconiGeneImporter(object):
    sets = {'fa_core':'FA_1_core_complex.txt', 
     'fa_all':'FA_4_all_genes.txt'}
    gh_config = {'base_url':'https://raw.githubusercontent.com/NCATS-Tangerine/cq-notebooks/master/FA_gene_sets/', 
     'columns':[
    ...
    def gene_set_df(self):
        return pd.read_csv((FanconiGeneImporter.gh_config['base_url'] + FanconiGeneImporter.sets[self.gene_set_name]),
          sep='\t', names=(FanconiGeneImporter.gh_config['columns']))
