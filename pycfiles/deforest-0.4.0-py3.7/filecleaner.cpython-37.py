...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/deforest/filecleaner.py
# Compiled at: 2020-03-13 12:20:39
# Size of source mod 2**32: 2448 bytes
from queue import Queue
import logging, sys, yaml, deforest.tags, deforest.cleaners, deforest.constant
...
class ForestCleaner:
    ...
    def _create_queue(self):
        ...
        cleaner_queue = Queue()
        logging.debug('created queue with size {}'.format(cleaner_queue.qsize()))
        ...
        logging.debug('cleaning will use {} methods'.format(cleaner_queue.qsize()))
    ...
    def _enable_cf_tags(self):
        ...
        for t in aws_tags:
            ...
            yaml.SafeDumper.add_multi_representer(deforest.tags.AWSTag, deforest.tags.AWSTag.to_yaml)
