...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/Envs/djangoplus/lib/python3.7/site-packages/pessoas/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.AddField(model_name='pessoa',
       name='endereco',
       field=djangoplus.db.models.fields.OneToOneField(blank=True, null=True, on_delete=(django.db.models.deletion.SET_NULL), to='enderecos.Endereco', verbose_name='Endereço'))]