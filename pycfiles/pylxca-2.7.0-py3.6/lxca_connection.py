...
class Error(Exception):
    __doc__ = 'This exception is raised for any other low level errors '


class ConnectionError(Error):
    __doc__ = 'This exception is raised when a connection related problem occurs, where a retry might make sense.'
