...
# [GCC 8.4.0]
# Embedded file name: /home/tomas/git/euroix/django-cms-qe/cms_qe_analytical/tests/test_tag_google_analytics.py
...
from ..templatetags.google_analytics import SCOPE_PAGE, SCOPE_SESSION, SCOPE_VISITOR, TRACK_MULTIPLE_DOMAINS, TRACK_MULTIPLE_SUBDOMAINS, TRACK_SINGLE_DOMAIN, GoogleAnalyticsNode
from ..tests.utils import TagTestCase, TestCase
...
class GoogleAnalyticsTagTestCase(TagTestCase):
    ...
    @override_settings(GOOGLE_ANALYTICS_TRACKING_STYLE=TRACK_MULTIPLE_SUBDOMAINS, GOOGLE_ANALYTICS_DOMAIN='example.com')
    ...
    @override_settings(GOOGLE_ANALYTICS_TRACKING_STYLE=TRACK_MULTIPLE_DOMAINS, GOOGLE_ANALYTICS_DOMAIN='example.com')
    ...
    def test_render_internal_ip(self):
        ...
        r = GoogleAnalyticsNode().render(context)
        self.assertTrue(r.startswith('<!-- Google Analytics disabled on internal IP address'), r)
