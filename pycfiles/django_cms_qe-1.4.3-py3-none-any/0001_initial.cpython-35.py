...
# [GCC 8.4.0]
# Embedded file name: /home/tomas/git/euroix/django-cms-qe/cms_qe_video/migrations/0001_initial.py
# Compiled at: 2019-02-04 04:18:45
# Size of source mod 2**32: 5704 bytes
from __future__ import unicode_literals
from django.db import migrations, models
import django.db.models.deletion, djangocms_attributes_field.fields, filer.fields.file, filer.fields.image
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='HostingVideoPlayer', fields=[
      (
      ...
      (
       'poster', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='filer.Image', verbose_name='Poster'))], options={'abstract': False}, bases=('cms.cmsplugin', )),
     migrations.CreateModel(name='SourceFileVideoPlayer', fields=[
      (
       'label', models.CharField(blank=True, max_length=255, verbose_name='Label')),
      (
       'width', models.IntegerField(blank=True, help_text='Leave it blank to make a video player of the default width of video source', null=True, verbose_name='Width')),
      ...
      (
       'source_file', filer.fields.file.FilerFileField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='filer.File', verbose_name='Source'))], options={'abstract': False}, bases=('cms.cmsplugin', )),
     migrations.CreateModel(name='VideoTrack', fields=[
      (
      ...
      (
       'attributes', djangocms_attributes_field.fields.AttributesField(blank=True, default=dict, verbose_name='Attributes')),
      (
       'src', filer.fields.file.FilerFileField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='filer.File', verbose_name='Source file'))], options={'abstract': False}, bases=('cms.cmsplugin', ))]