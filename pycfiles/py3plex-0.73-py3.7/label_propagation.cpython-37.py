...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/py3plex/algorithms/network_classification/label_propagation.py
...
import time, multiprocessing as mp, mkl
    ...
    for k in range(repetitions):
        for j in np.arange(0.1, 1, 0.1):
            ...
            for X_train, X_test in rs.split(labels):
                ...
                tmp_labels[X_test] = 0
                probs = label_propagation(matrix, tmp_labels, alpha=alpha_value, normalization=normalization_scheme)
                all_labels = []
