...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/py3plex/core/parsers.py
# Compiled at: 2020-03-13 05:22:00
# Size of source mod 2**32: 17534 bytes
import networkx as nx, json, itertools, glob, operator, numpy as np, scipy.io
...
def parse_gpickle(file_name, directed=False, layer_separator=None):
    ...
    for node in A.nodes(data=True):
        if 'labels' in node[1] and node[1]['labels'] == '':
