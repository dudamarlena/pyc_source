...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mercury_agent/register.py
# Compiled at: 2018-02-03 02:25:42
...
def _get_port_from_config(key, default):
    ...
    try:
        ...
        raise MercuryConfigurationError(f"{key} seems to be invalid in configzURL format is required:proto://address:port")


def register(rpc_backend_client, device_info, local_ip, local_ip6, capabilities):
    agent_info = {'rpc_address':local_ip, 
