...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mercury_agent/hardware/general/mcelog.py
...
JOURNALCTL_COMMAND = 'journalctl -a --output cat --unit=mcelog.service --no-pager'
