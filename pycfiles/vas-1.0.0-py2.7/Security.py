...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/shared/Security.py
...
class Security(object):
    ...
    def __str__(self):
        return ('<{} owner={} group={} permissions={}>').format(self.__class__.__name__, self.__owner, self.__group, self.__permissions)