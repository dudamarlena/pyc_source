...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/sqlfire/LocatorInstances.py
...
class LocatorInstances(MutableCollection):
    ...
    def create(self, installation, name, bind_address=None, client_bind_address=None, client_port=None, initial_heap=None, jvm_options=None, max_heap=None, peer_discovery_address=None, peer_discovery_port=None, run_netserver=None):
...
class LocatorInstance(Instance):
    ...
    def __init__(self, client, location):
        super(LocatorInstance, self).__init__(client, location, Group, Installation, LocatorLiveConfigurations, LocatorPendingConfigurations, LocatorNodeInstance, 'locator-node-instance')
    ...
    def update(self, installation=None, bind_address=None, client_bind_address=None, client_port=None, initial_heap=None, jvm_options=None, max_heap=None, peer_discovery_address=None, peer_discovery_port=None, run_netserver=None):
    ...
    def __str__(self):
        return ('<{} name={} bind_address={} client_bind_address={} client_port={} initial_heap={} jvm_options={} max_heap={} peer_discovery_address={} peer_discovery_port={} run_netserver={}>').format(self.__class__, self.name, self.__bind_address, self.__client_bind_address, self.__client_port, self.__initial_heap, self.__jvm_options, self.__max_heap, self.__peer_discovery_address, self.__peer_discovery_port, self.__run_netserver)
