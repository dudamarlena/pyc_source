...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/sqlfire/LocatorNodeInstances.py
...
class LocatorNodeInstance(NodeInstance):
    ...
    def __init__(self, client, location):
        super(LocatorNodeInstance, self).__init__(client, location, Node, LocatorLogs, LocatorInstance, 'locator-group-instance', LocatorNodeLiveConfigurations)
