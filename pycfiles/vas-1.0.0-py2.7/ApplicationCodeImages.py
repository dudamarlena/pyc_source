...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/gemfire/ApplicationCodeImages.py
...
class ApplicationCodeImage(Resource, Deletable):
    ...
    def live_application_code(self):
        self.__live_application_codes = self.__live_application_codes or self._create_resources_from_links('live-application-code', ApplicationCode)
    ...
    def pending_application_code(self):
        self.__pending_application_codes = self.__pending_application_codes or self._create_resources_from_links('pending-application-code', PendingApplicationCode)
