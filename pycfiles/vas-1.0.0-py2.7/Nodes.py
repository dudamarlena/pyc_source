...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/web_server/Nodes.py
...
class Node(GroupableNode):
    ...
    def __str__(self):
        return ('<{} host_names={} ip_addresses={} ipv4_addresses={} ipv6_addresses={} operating_system={} architecture={} agent_home={} metadata={}>').format(self.__class__.__name__, self.host_names, self.ip_addresses, self.ipv4_addresses, self.ipv6_addresses, self.operating_system, self.architecture, self.agent_home, self.metadata)
