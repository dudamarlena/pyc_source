...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/sqlfire/ServerInstances.py
...
class ServerInstances(MutableCollection):
    ...
    def create(self, installation, name, bind_address=None, client_bind_address=None, client_port=None, critical_heap_percentage=None, initial_heap=None, jvm_options=None, max_heap=None, run_netserver=None):
...
class ServerInstance(Instance):
    ...
    def __init__(self, client, location):
        super(ServerInstance, self).__init__(client, location, Group, Installation, ServerLiveConfigurations, ServerPendingConfigurations, ServerNodeInstance, 'server-node-instance')
    ...
    def update(self, installation=None, bind_address=None, client_bind_address=None, client_port=None, critical_heap_percentage=None, initial_heap=None, jvm_options=None, max_heap=None, run_netserver=None):
    ...
    def __str__(self):
        return ('<{} name={} bind_address={} client_bind_address={} client_port={} critical_heap_percentage={} initial_heap={} jvm_options={} max_heap={} run_netserver={}>').format(self.__class__, self.name, self.__bind_address, self.__client_bind_address, self.__client_port, self.__critical_heap_percentage, self.__initial_heap, self.__jvm_options, self.__max_heap, self.__run_netserver)
