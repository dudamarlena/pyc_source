...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/VFabricAdministrationServer.py
...
class VFabricAdministrationServer(object):
    ...
    def __init__(self, host='localhost', port=8443, username='admin', password='vmware', client=None):
        ...
        self.__web_server = WebServer(client, web_server_location) if self.__is_available(client, web_server_location) else None
        self.__host = host
        self.__port = port
    ...
    def __repr__(self):
        return ('{}(host={}, port={}, username={}, password={}, client={})').format(self.__class__.__name__, repr(self.__host), self.__port, repr(self.__username), repr(self.__password), self.__client)
