...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/vas/tc_server/NodeApplications.py
...
class NodeApplication(Resource):
    ...
    def group_application(self):
        self.__group_application = self.__group_application or Application(self._client, self.__group_application_location)
