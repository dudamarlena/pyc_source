...
# Compiled at: 2019-01-04 03:11:39
# Size of source mod 2**32: 46721 bytes
        ...
        for argument in arguments:
            ...
            try:
                ...
                if argument.default is not None:
                    ...
                    if argument.required and not (isinstance(argument, OutputParameterDescription) and argument.automatic):
