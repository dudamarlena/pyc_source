...
# [GCC 8.4.0]
# Embedded file name: /home/hachterberg/dev/fastr/fastr/fastr/resources/datatypes/MetaImageFile.py
# Compiled at: 2019-06-04 03:32:43
# Size of source mod 2**32: 4202 bytes
import os.path, re, fastr
    ...
    def content(cls, invalue, outvalue=None):
        ...
        try:
            ...
            with open(value, 'r') as (fin):
                data = fin.read()
                match = re.search('^ElementDataFile\\s+=\\s+(.*)$', data, re.MULTILINE)
