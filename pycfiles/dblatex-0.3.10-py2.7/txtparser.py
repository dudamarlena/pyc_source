...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dbtexmf/core/txtparser.py
...
class TextConfig:
    conf_mapping = {'TexInputs': TexMap('--texinputs'), 
