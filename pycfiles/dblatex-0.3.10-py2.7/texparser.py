...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dbtexmf/dblatex/grubber/texparser.py
...
class TexParser:
    ...
    def __init__(self, doc):
        ...
        self.comment_mark = '%'
        self.exclude_mods = []
        self.hooks = {'usepackage': self.h_usepackage, 
    ...
    def update_rehooks(self):
        ...
        pattern = '\\\\(?P<name>%s)\\*? *(\\[(?P<opt>[^\\]]*)\\])? *({(?P<arg>[^{}]*)}|(?=[^A-Za-z]))'
