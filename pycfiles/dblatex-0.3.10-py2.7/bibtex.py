...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dbtexmf/dblatex/grubber/bibtex.py
...
class BibTex(TexModule):
    ...
    def pre_compile(self):
        ...
        if self.doc.must_compile:
            ...
            if self.run_needed:
                return self.run()
            if exists(self.bblfile) and getmtime(self.bblfile) > getmtime(self.doc.logfile):
