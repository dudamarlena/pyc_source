...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/Users/adrie/Desktop/Programmation/better-exceptions/better_exceptions/formatter.py
# Compiled at: 2018-04-29 06:06:07
# Size of source mod 2**32: 14276 bytes
    ...
    def get_relevant_names(self, source):
        ...
        for index, tokentype, value in tokens:
            if tokentype in Token.Name:
                ...
                if tokentype in Token.Operator and value == '.':
                    name += '.'
    ...
    def format_exception(self, exc, value, tb, _seen=None):
        ...
        if value:
            if getattr(value, '__cause__', None) not in _seen:
                for text in self.format_exception(type(value.__cause__), value.__cause__, value.__cause__.__traceback__, _seen=_seen):
                    yield text
            ...
            for text in self.format_exception(type(value.__context__), value.__context__, value.__context__.__traceback__, _seen=_seen):
                yield text
