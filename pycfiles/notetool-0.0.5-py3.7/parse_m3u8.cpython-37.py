...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notetool/download/parse_m3u8.py
...
def parse_url_pages(pages=None, save_path=''):
    cookies = {'nlbi_764880':'109sEf9aoSzt3uQBoEMXnQAAAAD6XZGeY+jpIiJ7/bXcdLNz', 
    ...
    def get_url(tid):
        ...
        url = decrypt(b'gAAAAABeQTmG5eFv4h19N2TwrU50y4cEQVr2ImBSV159qaEIYeRssgg0S6hrFYMgrVns-i7pwxJg0CL6W-6SYVFbgUYeSK5fm6x9CCO70rHX4XNbBV-eyJm0eWruPLPaeVOWGZznwbD0')
