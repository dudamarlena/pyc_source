...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/layers/gru.py
...
class GRU(RecurrentLayer):
    ...
    def merge_inputs(self, input_var, additional_inputs=None):
        ...
        merged_inputs = {'xz_t': sum(z_inputs), 'xr_t': sum(r_inputs), 
           'xh_t': sum(h_inputs)}
    ...
    def prepare(self):
        ...
        self.register_parameters(self.U_z, self.b_z, self.U_r, self.b_r, self.U_h, self.b_h)
        self.input_weights = []
