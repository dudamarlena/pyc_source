...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/multigpu/worker.py
# Compiled at: 2016-05-27 19:41:20
import time, os
...
class MultiGPUTrainer(GeneralNeuralTrainer):
    ...
    def __init__(self, network, config=None, method=None, server_port=5567, start_halving_at=6, end_at=10, step_len=10, valid_freq=1500, learning_rate=None):
        ...
        self._schedule_params = {'learning_rate': learning_rate, 'start_halving_at': start_halving_at, 
           'end_at': end_at, 
           'step_len': step_len, 
    ...
    def train(self, train_set, valid_set=None, test_set=None, train_size=None):
        ...
        worker.send_req({'set_names': None, 
        ...
        while True:
            ...
            if resp == 'stop':
                ...
                worker.send_req({'eval_done': None, 
                ...
                if valid_set:
                    ...
                    self.fix_costs()
                worker.send_req({'valid_done': None, 
                   'valid_costs': self.last_run_costs, 
                   'auto_save': self.config.auto_save})
            elif 'train' in resp:
