...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/utils/decorations.py
    ...
    if type(obj) == tuple:
        ...
        if type(obj) == list:
            ...
            for normal_var, test_var, tensor_found, neural_found in unpacked_list:
                ...
                if neural_found:
                    neural_var_found = True

            return (
             normal_list, test_list, theano_var_found, neural_var_found)
        if type(obj) == dict:
            normal_map = {}
            test_map = {}
            theano_var_found = False
            ...
            return (
             normal_map, test_map, theano_var_found, neural_var_found)
        if type(obj) == NeuralVariable:
            return (obj.tensor, obj.test_tensor, False, True)
        if type(obj) == TensorVariable:
