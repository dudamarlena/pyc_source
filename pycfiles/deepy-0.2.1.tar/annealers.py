...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/trainers/annealers.py
# Compiled at: 2016-05-16 03:37:03
import numpy as np
...
class ExponentialLearningRateAnnealer(TrainingController):
    ...
    def __init__(self, trainer, decay_factor=1.000004, min_lr=1e-06, debug=False):
