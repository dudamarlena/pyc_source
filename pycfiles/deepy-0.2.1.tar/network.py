...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/networks/network.py
# Compiled at: 2016-05-27 03:27:47
import logging as loggers, gzip, cPickle as pickle, os
from threading import Thread
import numpy as np, theano.tensor as T, theano, filelock, deepy
...
class NeuralNetwork(object):
    ...
    def _compile(self):
        if not hasattr(self, '_compute'):
            self._compute = theano.function(filter(lambda x: x not in self.target_variables, self.input_variables), self.test_output, updates=self.updates, allow_input_downcast=True)
