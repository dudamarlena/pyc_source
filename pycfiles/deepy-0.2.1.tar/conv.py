...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/layers/conv.py
# Compiled at: 2016-04-20 00:05:45
import logging as loggers, numpy as np, theano.tensor as T
...
class Convolution(NeuralLayer):
    ...
    def __init__(self, filter_shape, pool_size=(2, 2), reshape_input=False, border_mode='valid', flatten_output=False, disable_pooling=False, activation='linear', init=None):
    ...
    def compute_tensor(self, x):
        ...
        conv_out = conv.conv2d(input=x, filters=self.W_conv, filter_shape=self.filter_shape, image_shape=None, border_mode=self.border_mode)
    ...
    def _default_initializer(self):
        ...
        weight_scale = np.sqrt(6.0 / (fan_in + fan_out))
