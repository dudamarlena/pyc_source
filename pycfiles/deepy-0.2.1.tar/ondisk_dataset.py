...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/dataset/ondisk_dataset.py
...
class OnDiskDataset(Dataset):
    ...
    def __init__(self, train_path, valid_path=None, test_path=None, train_size=None, cached=False, post_processing=None, shuffle_memory=False, curriculum=None):
