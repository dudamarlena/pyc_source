...
# [GCC 8.4.0]
# Embedded file name: /home/shu/research/deepy/deepy/layers/recurrent.py
# Compiled at: 2016-05-18 10:35:39
...
class RecurrentLayer(NeuralLayer):
    ...
    def __init__(self, name, state_names, hidden_size=100, input_type='sequence', output_type='sequence', inner_init=None, outer_init=None, gate_activation='sigmoid', activation='tanh', steps=None, backward=False, mask=None, additional_input_dims=None):
    ...
    def get_initial_states(self, input_var):
        ...
        for state in self.state_names:
            initial_states[state] = T.alloc(np.cast[FLOATX](0.0), input_var.shape[0], self.hidden_size)
...
class RNN(RecurrentLayer):
    ...
    def prepare(self):
        ...
        if self._input_type == 'sequence':
            all_input_dims = [
             self.input_dim] + self.additional_input_dims
