...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/_nmf/widgets/OWNormalizationNMF.py
# Compiled at: 2013-02-14 09:13:37
"""
...
class OWNormalizationNMF(OWWidget):
    settingsList = [
     'logTransform', 'scale', 'scaleMedian', 'subMin', 'normRows']
