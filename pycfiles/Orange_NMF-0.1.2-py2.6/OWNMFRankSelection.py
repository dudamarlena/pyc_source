...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/_nmf/widgets/OWNMFRankSelection.py
# Compiled at: 2013-02-14 09:13:25
"""
<name>Rank selection for NMF</name>
<description>Compute measures for NMF rank selection</description>
<icon>icons/RankSelectionIcon.png</icon>
<priority>30</priority>
    """
import nimfa, numpy as np
from OWWidget import *
import OWGUI

class OWNMFRankSelection(OWWidget):
    settingsList = [
     'nbIter', 'factorizationMethod', 'rangeRanksUB', 'rangeRanksLB', 'initialization', 'nbRuns']

    def __init__(self, parent=None, signalManager=None):
        OWWidget.__init__(self, parent, signalManager, 'Rank selection for NMF')
        self.inputs = [
         (
          'Data', ExampleTable, self.data), ('Initial_W', ExampleTable, self.dataInitW), ('Initial_H', ExampleTable, self.dataInitH)]
        self.outputs = [('Measures', ExampleTable)]
        self.nbIter = 100
        self.factorizationMethod = 0
        self.initialization = 0
        self.rangeRanksUB = 10
        self.rangeRanksLB = 2
        self.nbRuns = 10
        self.doCoph = 1
        self.doSparse = 0
