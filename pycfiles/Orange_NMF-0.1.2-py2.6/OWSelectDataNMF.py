...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/_nmf/widgets/OWSelectDataNMF.py
# Compiled at: 2013-02-14 09:17:37
"""
...
class OWSelectDataNMF(OWWidget):
    ...
    def __init__(self, parent=None, signalManager=None):
        ...
        self.inputs = [
         (
          'X', ExampleTable, self.data), ('Xd', ExampleTable, self.dataXd), ('Xa', ExampleTable, self.dataXa), ('List of variables', ExampleTable, self.dataVar), ('List of observations', ExampleTable, self.dataObs)]
    ...
    def selectData(self):
        ...
        if hasattr(self, 'varList') and self.varList:
            ...
            for i in range(0, len(self.varList)):
                if domainX.__contains__(self.varList[i][0].value) and not domainX.has_meta(self.varList[i][0].value):
            ...
            for i in range(0, len(metas)):
                if not varList2.__contains__(metas[i].name) and not metas[i].name == 'ID':
