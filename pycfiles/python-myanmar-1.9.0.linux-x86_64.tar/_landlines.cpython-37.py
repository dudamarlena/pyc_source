...
# [GCC 8.4.0]
# Embedded file name: /home/trhura/Code/pythonenv/lib/python3.7/site-packages/myanmar/_landlines.py
...
def get_landline_patterns(numberings):
    return (
     re.compile('^(\\+?95)?{0}$'.format(numberings[0])), numberings[1])


_patterns = list(map(get_landline_patterns, [
 [
