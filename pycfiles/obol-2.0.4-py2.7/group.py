...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/obol/group.py
...
class GroupList(Command):
    ...
    def get_parser(self, name):
        ...
        parser.add_argument('--subtree', default=self.app.default('group_tree', 'ou=Group'))
        return parser
...
class GroupAdd(Command):
    ...
    def increment_gid(self, b):
        ...
        try:
            ...
            mod_attrs = [
             (
              ldap.MOD_DELETE, 'uidNumber', gidNumber),
             (
