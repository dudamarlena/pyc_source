...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/obol/user.py
# Compiled at: 2016-07-19 18:08:33
from retrying import retry
from ldif import LDIFWriter
import sys, ldap, os, hashlib, logging
...
class Init(Command):
    ...
    def get_parser(self, name):
        ...
        parser.add_argument('--user_tree', default=self.app.default('user_tree', 'ou=People'))
        parser.add_argument('--group_tree', default=self.app.default('group_tree', 'ou=Group'))
        return parser
...
class UserAdd(Command):
    ...
    def increment_uid(self, b):
        ...
        try:
            ...
            mod_attrs = [
             (
              ldap.MOD_DELETE, 'uidNumber', uidNumber),
             (
    ...
    def get_parser(self, name):
        ...
        parser.add_argument('--subtree', default=self.app.default('user_tree', 'ou=People'))
        parser.add_argument('--grouptree', default=self.app.default('group_tree', 'ou=Group'))
        ...
        parser.add_argument('--groups', type=csep, help='a comma separated list of groups')
        return parser
...
class UserList(Command):
    ...
    def take_action(self, args):
        ...
        attrs = ['uid']
        for _, attrs in conn.search_s(base_dn, ldap.SCOPE_SUBTREE, filter, attrs):
            print attrs['uid'][0]
