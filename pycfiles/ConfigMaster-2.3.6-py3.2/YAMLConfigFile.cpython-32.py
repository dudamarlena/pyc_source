...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/configmaster/YAMLConfigFile.py
# Compiled at: 2015-09-06 05:04:46
    ...
    def actual_load_hook(cfg: ConfigFile):
        ...
        try:
            if not load_net:
                ...
                if load_net and isinstance(cfg, NetworkedConfigObject):
...
NetworkedYAMLConfigFile = GenerateNetworkedConfigFile(load_hook=yaml_load_hook(True), normal_class_load_hook=yaml_load_hook(False), normal_class_dump_hook=yaml_dump_hook)