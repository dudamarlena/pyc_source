...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/gazehound/presentation.py
# Compiled at: 2010-07-15 17:10:34
import csv
...
class Picture(Presentation):
    ...
    def __init__(self, start=None, end=None, name=None, path=None, type=None, width=None, height=None):
