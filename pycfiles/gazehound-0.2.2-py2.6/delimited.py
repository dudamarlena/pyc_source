...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/gazehound/writers/delimited.py
...
class GazeStatsWriter(DelimitedWriter):
    ...
    def __init__(self, out=sys.stdout, delimiter='\t'):
        super(GazeStatsWriter, self).__init__(GazeStatsWriter.mapper, out, delimiter)
...
class FixationStatsWriter(DelimitedWriter):
    ...
    def __init__(self, out=sys.stdout, delimiter='\t'):
        super(FixationStatsWriter, self).__init__(FixationStatsWriter.mapper, out, delimiter)
