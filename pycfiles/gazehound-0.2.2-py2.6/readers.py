...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/gazehound/readers.py
# Compiled at: 2010-07-19 16:39:23
...
class DelimitedReader(object):
    ...
    def __init__(self, file_data=None, skip_comments=True, comment_char='#', opts_for_parser={}, filename=None, skip_lines=0):
    ...
    def __setup_parser(self):
        ...
        if self.parser is None:
            self.parser = csv.reader(self.__content_lines, **self.opts_for_parser)
        return
...
class TimelineReader(DelimitedReader):
    ...
    def __init__(self, file_data=None, filename=None, skip_lines=1):
        super(TimelineReader, self).__init__(file_data=file_data, filename=filename, skip_lines=skip_lines)
