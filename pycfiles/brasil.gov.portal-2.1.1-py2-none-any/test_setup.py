...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/tests/test_setup.py
...
class InstallTestCase(unittest.TestCase):
    ...
    def test_browser_layer(self):
        ...
        self.assertTrue('IBrasilGov' in layers, 'add-on layer was not installed')
    ...
    def test_installed_dependencies(self):
        expected = INSTALLED
        actual = {p['id'] for p in self.qi.listInstalledProducts() if p['id'] != PROJECTNAME if p['id'] != PROJECTNAME}
    ...
    def test_ultimo_upgrade_igual_metadata_xml_filesystem(self):
        u"""Testa se o número do último upgradeStep disponível é o mesmo
