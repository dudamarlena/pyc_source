...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/forcontent/idg/src/brasil.gov.portal/src/brasil/gov/portal/tests/robot/acessibilidade.py
...
class Acessibilidade:
    ...
    def validate_contrast(self, selector, bg, fg, size):
        ...
        if contrast_ratio < ratio:
            msg = 'Contraste incorreto para o seletor %s, valor obtido: %.2f, valor esperado: %.2f' % (
