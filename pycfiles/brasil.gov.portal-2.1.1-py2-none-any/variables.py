...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/forcontent/idgb/src/brasil.gov.portal/src/brasil/gov/portal/tests/robot/variables.py
...
FF_PROFILE = os.path.join(os.path.dirname(tests.__file__), 'robot/ff_profile')