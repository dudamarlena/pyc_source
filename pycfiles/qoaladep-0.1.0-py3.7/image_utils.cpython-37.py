...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/qoaladep/utils/image_utils.py
# Compiled at: 2020-05-11 11:09:08
# Size of source mod 2**32: 3463 bytes
import io, cv2, base64, numpy as np
...
def draw_label(image_array, bbox: [int, int, int, int, int], width: int, height: int, label_text: str, font_size=2, font_scale=2, color=(0, 0, 0)):
    """[summary]
    ...
    img = cv2.putText(img, label_text, (bbox[0] + 5, bbox[1] - 5), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255,
                                                                                                         255,
                                                                                                         255), font_scale, cv2.LINE_AA)
    return img