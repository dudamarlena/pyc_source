...
# Compiled at: 2020-04-10 13:21:30
# Size of source mod 2**32: 63040 bytes
...
import attr
from dataspec.base import INVALID, Conformer, ErrorDetails, Invalid, ObjectSpec, OptionalKey, PredicateSpec, Spec, SpecPredicate, Tag, ValidatorFn, ValidatorSpec, compose_conformers, make_spec, pred_to_validator
T = TypeVar('T')

def tag_maybe(maybe_tag: Union[(Tag, T)], *args: T) -> Tuple[(Optional[str], Tuple[(T, ...)])]:
...
def any_spec(*preds: SpecPredicate, tag_conformed: bool=False, conformer: Optional[Conformer]=None) -> Spec:
    """
...
def all_spec(*preds: SpecPredicate, conformer: Optional[Conformer]=None) -> Spec:
    ...
    return ValidatorSpec((tag or 'all'),
      _all_valid,
      conformer=compose_conformers(*specs, **{'conform_final': conformer}))


def blankable_spec(*args: Union[(Tag, SpecPredicate)], conformer: Optional[Conformer]=None):
    """
    ...
    """
    tag, preds = tag_maybe(*args)
    assert len(preds) == 1, 'Only one predicate allowed'
    return any_spec((tag or 'blankable'),
      (preds[0]), {''}, conformer=conformer)


def bool_spec(tag: Optional[Tag]=None, allowed_values: Optional[Set[bool]]=None, conformer: Optional[Conformer]=None) -> Spec:
    """
...
def bytes_spec(tag: Optional[Tag]=None, type_: Tuple[(Union[(Type[bytes], Type[bytearray])], ...)]=(
 bytes, bytearray), length: Optional[int]=None, minlength: Optional[int]=None, maxlength: Optional[int]=None, conformer: Optional[Conformer]=None) -> Spec:
    """
...
def default_spec(*args: Union[(Tag, SpecPredicate)], default: Any=None, conformer: Optional[Conformer]=None) -> Spec:
    """
...
def every_spec(tag: Optional[Tag]=None, conformer: Optional[Conformer]=None) -> Spec:
    """
...
def _make_datetime_spec_factory(type_: Union[(Type[datetime], Type[date], Type[time])]) -> Callable[(..., Spec)]:
    ...
    def _datetime_spec_factory(tag=None, format_=None, before=None, after=None, is_aware=None, conformer=None):
        ...
        if is_aware is not None:
            if type_ is datetime:
                ...
                if type_ is time:
                    ...
                    @pred_to_validator("Time '{value}' is not aware",
                      complement=is_aware)
        ...
        if format_ is not None:
            ...
            return ValidatorSpec((tag or type.__name__),
...
try:
    ...
    def datetime_str_spec(tag: Optional[Tag]=None, iso_only: bool=False, before: Optional[datetime]=None, after: Optional[datetime]=None, is_aware: Optional[bool]=None, conformer: Optional[Conformer]=None) -> Spec:
        """
        ...
        return ValidatorSpec.from_validators(tag,
          is_str, str_contains_datetime, conformer=(conformer or parse_date))
...
def email_spec(tag: Optional[Tag]=None, conformer: Optional[Conformer]=None, **kwargs) -> Spec:
    """
...
def nilable_spec(*args: Union[(Tag, SpecPredicate)], conformer: Optional[Conformer]=None) -> Spec:
    """
...
def num_spec(tag: Optional[Tag]=None, type_: Union[(Type, Tuple[(Type, ...)])]=(
...
def obj_spec(*args: Union[(Tag, SpecPredicate)], conformer: Optional[Conformer]=None) -> Spec:
...
try:
    ...
    def phonenumber_spec(tag: Optional[Tag]=None, region: Optional[str]=None, is_possible: bool=True, is_valid: bool=True, conformer: Optional[Conformer]=conform_phonenumber) -> Spec:
        """
        ...
        return ValidatorSpec.from_validators(tag,
          is_str, str_contains_phonenumber, conformer=conformer)
...
def register_str_format_spec(name: str, validate: ValidatorSpec, conformer: Optional[Conformer]=None) -> None:
...
def register_str_format(tag: Tag, conformer: Optional[Conformer]=None) -> Callable[([Callable], ValidatorFn)]:
...
def str_spec(tag: Optional[Tag]=None, length: Optional[int]=None, minlength: Optional[int]=None, maxlength: Optional[int]=None, regex: Union[(Pattern, str, None)]=None, format_: Optional[str]=None, conform_format: Optional[str]=None, conformer: Optional[Conformer]=None) -> Spec:
    """
    ...
    if regex is not None:
        if format_ is None:
            if conform_format is None:
                ...
                @pred_to_validator("String '{value}' does match regex '{regex}'",
...
def url_str_spec(tag: Optional[Tag]=None, query: Optional[SpecPredicate]=None, conformer: Optional[Conformer]=None, **kwargs) -> Spec:
    """
...
def uuid_spec(tag: Optional[Tag]=None, versions: Optional[Set[int]]=None, conformer: Optional[Conformer]=None) -> Spec:
    """
