...
# Compiled at: 2020-04-10 13:22:24
# Size of source mod 2**32: 4204 bytes
import functools
from typing import Mapping, Optional, Tuple, Union
from dataspec.base import Conformer, Spec, SpecPredicate, Tag, ValidationError, make_spec
from dataspec.factories import all_spec, any_spec, blankable_spec, bool_spec, bytes_spec, date_spec, datetime_spec, default_spec, email_spec, every_spec, nilable_spec, num_spec, obj_spec, opt_key, str_spec, time_spec, url_str_spec, uuid_spec
try:
...
class SpecAPI:
    ...
    def __call__(self, *args: Union[(Tag, SpecPredicate)], conformer: Optional[Conformer]=None) -> Spec:
