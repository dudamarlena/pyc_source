...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/tests/tests/test_02_integration.py
...
class ExampleIntegrationTest(IntegrationTest):
    ...
    def test_element_mixins(self) -> 'None':
        ...
        self.assertEqual(self.find_next_sibling(test_element), test_next_element, 'Checks that find_next_sibling works as expected')
    ...
    def test_urls(self) -> 'None':
        self.load_live_url('integrationparams',
          url_kwargs={'parameter': 12},
          url_reverse_get_params={'next': 'integration'})
        self.assert_url_equal('integrationparams',
          kwargs={'parameter': 12},
    ...
    def test_fill_form(self, cmock: 'mock.Mock') -> 'None':
        ...
        cmock.reset_mock()
        submit = self.fill_out_form('integration',
          'input_id_submit',
          send_form_keys={'id_a': 'Filled in A'},
        ...
        self.assertEqual(self.find_element('#hoverable').get_attribute('data-hovered'), 'true')