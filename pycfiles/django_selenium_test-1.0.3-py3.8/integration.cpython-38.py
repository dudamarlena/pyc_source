...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/django_selenium_test/integration.py
# Compiled at: 2020-04-25 08:27:31
...
class DummyTestBase:
    __doc__ = ' A dummy base class for type-hinting within integration tests '
    ...
    def assertRaises(self, expected_exception: 'Type[Exception]', *args: 'Any', **kwargs: 'Any'):
        pass
...
class FormElementMixins(DummyTestBase):
    ...
    def fill_out_form(self, url_pattern: 'str', submit_button: 'str'=None, send_form_keys: 'Optional[Dict[str, str]]'=None, select_dropdowns: 'Optional[Dict[str, str]]'=None, select_checkboxes: 'Optional[Dict[str, bool]]'=None, script_value: 'Optional[Dict[str, str]]'=None, selector: 'Optional[str]'=None, url_args: 'Optional[List[str]]'=None, url_kwargs: 'Optional[Dict[str, Any]]'=None, url_reverse_get_params: 'Optional[Dict[str, Any]]'=None, selector_timeout: 'Optional[int]'=None) -> 'WebElement':
        ...
        button = self.load_live_url(url_pattern,
          selector=selector,
          url_args=url_args,
        ...
        if script_value is not None:
            for id_, value in script_value.items():
                element = self.selenium.find_element_by_id(id_)
                self.selenium.execute_script("arguments[0].value = arguments[1];arguments[0].dispatchEvent(new Event('input',{bubbles: true,cancelable: true}));arguments[0].dispatchEvent(new Event('change',{bubbles: true,cancelable: true}));", element, value)
...
class URLMixins(DummyTestBase):
    ...
    def _resolve_url(self, url: 'str', args: 'Optional[List[Any]]'=None, kwargs: 'Optional[Dict[str, Any]]'=None, get_params: 'Option[Dict[str, str]]'=None, reverse_get_params: 'Optional[Dict[str, Any]]'=None) -> 'str':
        ...
        if url.startswith('/'):
            raise AssertionError('_resolve_url() does not accept absolute urls, got: {}'.format(url))
        else:
        ...
        if has_extra_args:
            resolved = resolved + '?' + '&'.join(['{}={}'.format(k, v) for k, v in extra_args.items()])
        return resolved
    ...
    def load_live_url(self, url_pattern: 'str', selector: 'str'=None, url_args: 'Optional[List[Any]]'=None, url_kwargs: 'Optional[Dict[str, Any]]'=None, url_get_params: 'Option[Dict[str, str]]'=None, url_reverse_get_params: 'Optional[Dict[str, Any]]'=None, selector_timeout: 'Optional[int]'=None, selector_clickable: 'bool'=False) -> 'WebElement':
        ...
        """
        url = self._resolve_url(url_pattern,
          args=url_args,
          kwargs=url_kwargs,
        ...
        return self.find_element(selector,
          timeout=selector_timeout, clickable=selector_clickable)
    ...
    def assert_url_follow(self, url: 'str', new_url: 'str', *args, url_args=None, url_kwargs=None, url_reverse_get_params=None, new_url_args=None, new_url_kwargs=None, new_url_reverse_get_params=None, url_selector: 'str'=None, url_selector_timeout: 'int'=None):
        """
            Asserts that loading url (with selector selector) in the browser redirects to new_url. 
        """
        self.load_live_url(url,
          url_args=url_args,
          url_kwargs=url_kwargs,
          url_reverse_get_params=url_reverse_get_params,
 ...
 new_url, *args, **{'args':new_url_args, 
         'kwargs':new_url_kwargs, 
         'reverse_get_params':new_url_reverse_get_params})


class IntegrationTestBase(ElementAssertionMixins, ElementFindMixins, FormElementMixins, URLMixins, DummyTestBase):
    __doc__ = ' A base class for integration tests '
    user = None
    user: 'Optional[User]'
    selenium = None
    selenium: 'SeleniumWrapper'
...
class IntegrationTest(SeleniumTestCase, IntegrationTestBase):
    __doc__ = ' An integration test base class using Selenium '
