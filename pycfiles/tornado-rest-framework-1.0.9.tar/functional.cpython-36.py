...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/utils/functional.py
# Compiled at: 2018-10-12 04:41:52
# Size of source mod 2**32: 9926 bytes
import time, inspect, string, random, hashlib, asyncio, functools
...
def is_simple_callable(obj):
    ...
    if not (inspect.isfunction(obj) or inspect.ismethod(obj)):
        ...
        return all(param.kind == param.VAR_POSITIONAL or param.kind == param.VAR_KEYWORD or param.default != param.empty for param in params)
