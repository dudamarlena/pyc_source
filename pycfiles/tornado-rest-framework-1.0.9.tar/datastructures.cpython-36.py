...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/core/datastructures.py
# Compiled at: 2018-10-20 02:36:05
    ...
    def __init__(self, url: str='', scope: Scope=None):
        if scope is not None:
            ...
            default_port = {'http':80, 
             'https':443,  'ws':80,  'wss':443}[scheme]
