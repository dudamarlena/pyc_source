...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/log.py
...
DEFAULT_LOGGING = {'version':1, 
 ...
 'formatters':{'rest_framework.server': {'format': '%(asctime)s - %(name)s - %(levelname)s - %(message)s'}}, 
 'handlers':{'console':{'level':'INFO', 
   'class':'logging.StreamHandler'}, 
  'rest_framework.server':{'level':'INFO', 
   'class':'logging.StreamHandler', 
   'formatter':'rest_framework.server'}}, 
 'loggers':{'rest_framework':{'handlers':[
    'console'], 
   'level':'INFO'}, 
  'rest_framework.server':{'handlers':[
