...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/forms/forms.py
# Compiled at: 2018-10-12 04:41:52
# Size of source mod 2**32: 8647 bytes
import asyncio, copy
from collections import OrderedDict
from rest_framework.conf import settings
from rest_framework.core.exceptions import ValidationError, SkipFieldError, get_full_details
...
class BaseForm(object):
    ...
    def __getitem__(self, name):
        ...
        try:
            ...
            raise KeyError("Key '%s' not found in '%s'. Choices are: %s." % (
             name,
