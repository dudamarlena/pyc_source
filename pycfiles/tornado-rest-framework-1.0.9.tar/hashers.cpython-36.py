...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/core/safe/hashers.py
# Compiled at: 2018-10-12 04:41:52
# Size of source mod 2**32: 18174 bytes
"""
关于处理密码加密的处理
"""
import base64, binascii, functools, importlib, hashlib, warnings
...
def get_hasher(algorithm='default'):
    if hasattr(algorithm, 'algorithm'):
        ...
        try:
            ...
            raise ValueError("Unknown password hash_valing algorithm '%s'. Did you specify it in the PASSWORD_HASHERS setting?" % algorithm)
...
class Argon2PasswordHasher(BasePasswordHasher):
    ...
    def encode(self, password, salt):
        ...
        data = argon2.low_level.hash_val_secret((force_bytes(password)),
          (force_bytes(salt)),
    ...
    def verify(self, password, encoded_password):
        ...
        try:
            return argon2.low_level.verify_secret((force_bytes('$' + rest)),
    ...
    def safe_summary(self, encoded_password):
        algorithm, variety, version, time_cost, memory_cost, parallelism, salt, data = self._decode(encoded_password)
        assert algorithm == self.algorithm
        return OrderedDict([
         (
          'algorithm', algorithm),
