...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/core/pagination.py
...
class PageNumberPagination(BasePagination):
    ...
    def get_page_size(self):
        ...
        if self.page_size_query_param:
            try:
                page_size = self.request_handler.request_data.get(self.page_size_query_param, self.page_size)
...
class LimitOffsetPagination(BasePagination):
    ...
    def limit(self):
        if self.limit_query_param:
            try:
                limit = self.request_handler.request_data.get(self.limit_query_param, self.default_limit)
