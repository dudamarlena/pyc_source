...
# [GCC 8.4.0]
# Embedded file name: /opt/work/lib/pyenv/versions/3.6.1/envs/maestro/lib/python3.6/site-packages/rest_framework/core/script/commands.py
# Compiled at: 2018-10-12 04:41:52
# Size of source mod 2**32: 7675 bytes
import re, inspect, argparse, asyncio
...
class Group(object):
    ...
    def __init__(self, *options, **kwargs):
        ...
        if self.title or self.description:
            if self.required or self.exclusive:
                raise TypeError('title and/or description cannot be used with required and/or exclusive.')
