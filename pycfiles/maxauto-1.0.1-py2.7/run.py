...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/max/run.py
# Compiled at: 2019-04-27 23:02:52
import subprocess, sys, yaml, argparse, os
...
def main_run():
    ...
    parser.add_argument('--config_path', help='config路径')
