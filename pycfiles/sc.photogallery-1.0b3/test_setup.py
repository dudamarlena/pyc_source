...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/collective/sc.photogallery/src/sc/photogallery/tests/test_setup.py
...
class InstallTestCase(unittest.TestCase):
    ...
    def test_version(self):
        ...
        self.assertEqual(setup.getLastVersionForProfile(profile), ('1001', ))

    @unittest.skipUnless(HAS_COVER, 'requires plone.app.tiles')
    def test_tile(self):
        tiles = api.portal.get_registry_record('plone.app.tiles')
        self.assertIn('sc.photogallery', tiles)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_tile_removed(self):
        tiles = api.portal.get_registry_record('plone.app.tiles')
        self.assertNotIn('sc.photogallery', tiles)
