...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/collective/sc.photogallery/src/sc/photogallery/tests/test_controlpanel.py
...
class ControlPanelTestCase(unittest.TestCase):
    ...
    def test_controlpanel_has_view(self):
        view = api.content.get_view('photogallery-settings', self.portal, self.request)
...
class RegistryTestCase(unittest.TestCase):
    ...
    def test_records_removed_on_uninstall(self):
        ...
        with api.env.adopt_roles(['Manager']):
            qi.uninstallProducts(products=[PROJECTNAME])
        self.assertNotIn(IPhotoGallerySettings.__identifier__ + '.enable_download', self.registry)