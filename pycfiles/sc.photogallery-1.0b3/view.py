...
# [GCC 8.4.0]
# Embedded file name: /home/hvelarde/collective/sc.photogallery/src/sc/photogallery/browser/view.py
...
class View(DefaultView, PhotoGalleryMixin):
    ...
    def zip_url(self):
        ...
        url = ('{0}/@@zip/{1}/{2}.zip').format(base_url, str(self.last_modified), self.context.getId())
        return url
