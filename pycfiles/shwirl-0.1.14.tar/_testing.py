...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/Documents/Etudes/Doctorat/Australie/code/shwirl/extern/vispy/testing/_testing.py
...
def has_ipython(version='3.0'):
    ...
    try:
        ...
        return (
         False, 'IPython library not found')
...
def TestingCanvas(bgcolor='black', size=(100, 100), dpi=None, decorate=False, **kwargs):
    ...
    class TestingCanvas(SceneCanvas):
        ...
        def __init__(self, bgcolor, size, dpi, decorate, **kwargs):
            ...
            SceneCanvas.__init__(self, bgcolor=bgcolor, size=size, dpi=dpi, decorate=decorate, **kwargs)
            return
