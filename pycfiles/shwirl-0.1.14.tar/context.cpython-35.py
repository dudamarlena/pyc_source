...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/code/shwirl/extern/vispy/gloo/context.py
# Compiled at: 2017-04-05 22:12:59
# Size of source mod 2**32: 8558 bytes
"""
...
from .. import config
_default_dict = dict(red_size=8, green_size=8, blue_size=8, alpha_size=8, depth_size=24, stencil_size=0, double_buffer=True, stereo=False, samples=0)
canvasses = []
...
class GLContext(BaseGlooFunctions):
    __doc__ = 'An object encapsulating data necessary for a OpenGL context\n\n    Parameters\n    ----------\n    config : dict | None\n        The requested configuration.\n    shared : instance of GLContext | None\n        The shared context.\n    '
...
class GLShared(object):
    ...
    def parser(self, parser):
        if not isinstance(parser, BaseGlirParser):
