...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/app/timer.py
# Compiled at: 2018-10-01 14:58:41
# Size of source mod 2**32: 5780 bytes
from __future__ import division
from util.event import Event, EmitterGroup
import util.ptime as precision_time
...
class Timer(object):
    ...
    def __init__(self, interval='auto', connect=None, iterations=-1, start=False, app=None):
        self.events = EmitterGroup(source=self, start=Event,
          stop=Event,
          timeout=Event)
        if app is None:
    ...
    def _timeout(self, *args):
        ...
        self.events.timeout(type='timer_timeout',
