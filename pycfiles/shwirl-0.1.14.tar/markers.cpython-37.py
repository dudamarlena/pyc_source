...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/markers.py
# Compiled at: 2018-10-01 14:58:41
# Size of source mod 2**32: 19863 bytes
"""
...
class MarkersVisual(Visual):
    __doc__ = ' Visual displaying marker symbols.\n    '
    ...
    def set_data(self, pos=None, symbol='o', size=10.0, edge_width=1.0, edge_width_rel=None, edge_color='black', face_color='white', scaling=False):
        ...
        if isinstance(pos, np.ndarray):
            if not (pos.ndim == 2 and pos.shape[1] in (2, 3)):
