...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/gloo/gl/_proxy.py
...
class BaseGLProxy(object):
    __doc__ = ' Base proxy class for the GL ES 2.0 API. Subclasses should\n    implement __call__ to process the API calls.\n    '
