...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/gloo/context.py
...
from .. import config
_default_dict = dict(red_size=8, green_size=8, blue_size=8, alpha_size=8, depth_size=24,
  stencil_size=0,
  double_buffer=True,
  stereo=False,
  samples=0)
