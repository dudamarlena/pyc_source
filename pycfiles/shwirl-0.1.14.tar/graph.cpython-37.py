...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/graphs/graph.py
...
class GraphVisual(CompoundVisual):
    ...
    _node_kw_trans = dict(node_symbol='symbol', node_size='size', border_color='edge_color',
    ...
    def __init__(self, adjacency_mat=None, directed=False, layout=None, animate=False, line_color=None, line_width=None, arrow_type=None, arrow_size=None, node_symbol=None, node_size=None, border_color=None, face_color=None, border_width=None):
        ...
        self.set_data(adjacency_mat, line_color=line_color, line_width=line_width,
    ...
    def set_data(self, adjacency_mat=None, **kwargs):
        ...
        **kwargs : dict
        ...
        if adjacency_mat is not None:
            ...
            self._animate or self.set_final_layout()