...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/ext/ipy_inputhook.py
...
class InputHookManager(object):
    __doc__ = 'Manage PyOS_InputHook for different GUI toolkits.\n\n    This class installs various hooks under ``PyOSInputHook`` to handle\n    GUI event loop integration.\n    '
...
class NullInputHook(InputHookBase):
    __doc__ = "A null inputhook that doesn't need to do anything"
