...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/util/fetching.py
# Compiled at: 2018-10-01 14:58:41
# Size of source mod 2**32: 10335 bytes
...
def _chunk_read(response, local_file, chunk_size=65536, initial_size=0):
    ...
    progress = ProgressBar(total_size, initial_value=bytes_so_far, max_chars=40,
      spinner=True,
      mesg='downloading')
    while True:
