...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/Documents/Etudes/Doctorat/Australie/code/shwirl/extern/vispy/visuals/axis.py
# Compiled at: 2017-01-31 17:35:17
...
class Ticker(object):
    ...
    def _get_tick_positions(self, major_tick_fractions, minor_tick_fractions):
        ...
        vectors = np.array([[0.0, 0.0],
         ...
         direction * (self.axis.major_tick_length + self.axis.tick_label_margin) / doc_len], dtype=float)
