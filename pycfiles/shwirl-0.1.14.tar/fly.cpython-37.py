...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/scene/cameras/fly.py
...
class FlyCamera(PerspectiveCamera):
    ...
    def __init__(self, fov=60, rotation=None, **kwargs):
        ...
        self._keymap = {keys.UP: (1, 1), keys.DOWN: (-1, 1), 
    ...
    def viewbox_mouse_event(self, event):
        ...
        if event.type == 'mouse_wheel':
            event.mouse_event.modifiers or self._speed[0] += 0.5 * event.delta[1]
        else:
            ...
            if event.type == 'mouse_move':
                if event.press_event is None:
                    ...
                    if 1 in event.buttons:
                        d_az = modifiers or -float(pos2[0] - pos1[0]) / w
