...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/scene/cameras/perspective.py
...
class Base3DRotationCamera(PerspectiveCamera):
    __doc__ = 'Base class for TurntableCamera and ArcballCamera'
    ...
    def viewbox_mouse_event(self, event):
        ...
        event : instance of Event
            The event.
        """
        return event.handled or self.interactive or None
            ...
            if event.type == 'mouse_press':
                ...
                if event.type == 'mouse_move':
                    ...
                    if 1 in event.buttons:
                        modifiers or self._update_rotation(event)
                    else:
                        if 2 in event.buttons and not modifiers:
                            if self._event_value is None:
                                self._event_value = (
                                 self._scale_factor, self._distance)
                    ...
                    if 1 in event.buttons:
                        if keys.SHIFT in modifiers:
                            ...
                            if not self._event_value is None:
                                if len(self._event_value) == 2:
