...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/cube.py
...
class CubeVisual(CompoundVisual):
    ...
    def __init__(self, size=1.0, vertex_colors=None, face_colors=None, color=(0.5, 0.5, 1, 1), edge_color=None, **kwargs):
        ...
        self._mesh = MeshVisual(vertices=(vertices['position']), faces=filled_indices,
          vertex_colors=vertex_colors,
          face_colors=face_colors,
          color=color)
        if edge_color:
            self._border = MeshVisual(vertices=(vertices['position']), faces=outline_indices,
              color=edge_color,
              mode='lines')
        else:
