...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/io/wavefront.py
...
import ext.gzip_open as gzip_open
...
class WavefrontReader(object):
                    ...
                    if line.startswith('vn '):
                        ...
                        if line.startswith('f '):
                            ...
                            if line.startswith('#'):
                                ...
                                if any((line.startswith(x) for x in ('g ', 's ', 'o ',
                                                                     'usemtl '))):
                                    pass
                                elif not line.strip():
                                    pass
    ...
    def readFace(self, line):
        ...
        if self._faces:
            if len(self._faces[0]) != len(final_face):
    ...
    def write(cls, fname, vertices, faces, normals, texcoords, name='', reshape_faces=True):
        ...
        try:
            try:
                ...
                writer.writeMesh(vertices, faces, normals, texcoords,
                  name, reshape_faces=reshape_faces)
            except EOFError:
                pass
