...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/Documents/Etudes/Doctorat/Australie/code/shwirl/extern/vispy/visuals/shaders/variable.py
...
class Variable(ShaderObject):
    ...
    def value(self, value):
        if isinstance(value, (tuple, list)) and 1 < len(value) < 5:
            ...
            if self._type_locked and (dtype != self._dtype or vtype != self._vtype):
