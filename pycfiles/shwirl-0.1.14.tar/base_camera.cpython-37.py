...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/scene/cameras/base_camera.py
# Compiled at: 2018-10-01 14:58:41
# Size of source mod 2**32: 15969 bytes
...
class BaseCamera(Node):
    ...
    def flip(self, value):
        if not isinstance(value, (list, tuple)):
            ...
            self._flip = (
             bool(value[0]), bool(value[1]), False)
        else:
            if len(value) == 3:
                self._flip = (
    ...
    def set_range(self, x=None, y=None, z=None, margin=0.05):
        ...
        if x is not None:
            ...
            if self._viewbox is None:
                self._set_range_args = (
                 bounds[0], bounds[1], bounds[2], margin)
                return
