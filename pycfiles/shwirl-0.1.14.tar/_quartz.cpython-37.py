...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/util/fonts/_quartz.py
...
def _load_glyph(f, char, glyphs_dict):
    ...
    glyph = dict(char=char, offset=(left, top), bitmap=bitmap, advance=advance,
      kerning={})
