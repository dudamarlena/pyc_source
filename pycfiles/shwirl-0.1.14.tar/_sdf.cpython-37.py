...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/text/_sdf.py
...
class SDFRenderer(object):
    ...
    def render_to_texture(self, data, texture, offset, size):
        ...
        orig_tex = Texture2D((255 - data), format='luminance', wrapping='clamp_to_edge',
    ...
    def _render_edf(self, orig_tex):
        ...
        comp_texs = []
        for _ in range(2):
            tex = Texture2D((sdf_size + (4, )), format='rgba', interpolation='nearest',
