...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/isosurface.py
# Compiled at: 2018-10-01 14:58:41
# Size of source mod 2**32: 3903 bytes
from __future__ import division
from .mesh import MeshVisual
import geometry.isosurface as isosurface
...
class IsosurfaceVisual(MeshVisual):
    ...
    def __init__(self, data=None, level=None, vertex_colors=None, face_colors=None, color=(0.5, 0.5, 1, 1), **kwargs):
        ...
        if data is not None:
            self.set_data(data, vertex_colors=vertex_colors, face_colors=face_colors,
              color=color)
    ...
    def _prepare_draw(self, view):
        ...
        if self._update_meshvisual:
            MeshVisual.set_data(self, vertices=(self._vertices_cache),
