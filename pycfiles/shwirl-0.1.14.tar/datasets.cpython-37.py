...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/io/datasets.py
...
def load_spatial_filters(packed=True):
    ...
    """
    names = ('Bilinear', 'Hanning', 'Hamming', 'Hermite', 'Kaiser', 'Quadric', 'Bicubic',
             'CatRom', 'Mitchell', 'Spline16', 'Spline36', 'Gaussian', 'Bessel',
             'Sinc', 'Lanczos', 'Blackman', 'Nearest')
