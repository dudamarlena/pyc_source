...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/Documents/Etudes/Doctorat/Australie/code/shwirl/extern/vispy/visuals/line/line.py
...
class _GLLineVisual(Visual):
    ...
    def _prepare_draw(self, view):
        ...
        if self._connect is None:
            ...
            elif isinstance(self._connect, string_types) and self._connect == 'segments':
