...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/rectangle.py
 ...
 0.0, 0.0, 0.0, 0.0], **kwargs):
    ...
    def _update(self):
        if not self._center:
            ...
            self._border_color.is_blank or self.border.set_data(pos=(vertices[1:, ..., :2]), color=(self._border_color.rgba))