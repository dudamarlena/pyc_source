...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/code/shwirl/extern/vispy/visuals/graphs/graph.py
...
class GraphVisual(CompoundVisual):
    ...
    _node_kw_trans = dict(node_symbol='symbol', node_size='size', border_color='edge_color', border_width='edge_width')

    def __init__(self, adjacency_mat=None, directed=False, layout=None, animate=False, line_color=None, line_width=None, arrow_type=None, arrow_size=None, node_symbol=None, node_size=None, border_color=None, face_color=None, border_width=None):
        ...
        self.set_data(adjacency_mat, line_color=line_color, line_width=line_width, arrow_type=arrow_type, arrow_size=arrow_size, node_symbol=node_symbol, node_size=node_size, border_color=border_color, face_color=face_color, border_width=border_width)
    ...
    def animate_layout(self):
        if self._layout_iter is None:
            if self._adjacency_mat is None:
                raise ValueError('No adjacency matrix set yet. An adjacency matrix is required to calculate the layout.')
