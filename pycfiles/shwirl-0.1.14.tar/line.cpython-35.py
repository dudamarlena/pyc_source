...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/code/shwirl/extern/vispy/visuals/line/line.py
...
class LineVisual(CompoundVisual):
    ...
    def _interpret_connect(self):
        if isinstance(self._connect, np.ndarray):
            ...
            if self._connect.ndim == 2 and self._connect.shape[1] == 2:
...
class _AggLineVisual(Visual):
    ...
    def __init__(self, parent):
        ...
        self._U = dict(dash_index=dash_index, dash_period=dash_period, linejoin=joins['round'], linecaps=(
         caps['round'], caps['round']), dash_caps=(
         caps['round'], caps['round']), antialias=1.0)
    ...
    def _prepare_draw(self, view):
        ...
        if self._parent._changed['color']:
            ...
            bake = True
        if self._parent._changed['connect'] and self._parent._connect not in (None,
                                                                              'strip'):
