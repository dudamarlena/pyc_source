...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/regular_polygon.py
...
class RegularPolygonVisual(EllipseVisual):
    ...
    def __init__(self, center=None, color='black', border_color=None, border_width=1, radius=0.1, sides=4, **kwargs):
        (EllipseVisual.__init__)(self, center=center, radius=radius, 
         color=color, 
