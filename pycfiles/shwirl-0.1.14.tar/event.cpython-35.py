...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/code/shwirl/extern/vispy/util/event.py
            ...
            if _event_repr_depth > 2:
                ...
                for name in dir(self):
                    if name.startswith('_'):
                        pass
                    elif not not hasattr(type(self), name):
...
class EventEmitter(object):
    ...
    def _invoke_callback(self, cb, event):
        try:
            ...
            _handle_exception(self.ignore_callback_errors, self.print_callback_errors, self, cb_event=(cb, event))
