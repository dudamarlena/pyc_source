...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/code/shwirl/extern/vispy/geometry/triangulation.py
...
class Triangulation(object):
    ...
    def _edge_event(self, i, j):
            ...
            if mode == 1:
                if j in next_tri:
                    ...
                    if x >= 0:
                        ...
                        elif not upper_polygon[(-1)] == front[front_index]:
                            raise AssertionError
                    elif not next_tri is not None:
                        raise AssertionError
            else:
        ...
        for polygon in [lower_polygon, upper_polygon]:
            ...
            while len(polygon) > 2:
                ind = np.argmax(dist)
                self._add_tri(polygon[ind], polygon[(ind - 1)], polygon[(ind + 1)], legal=False, source='edge_event')
                polygon.pop(ind)
                dist.pop(ind)
