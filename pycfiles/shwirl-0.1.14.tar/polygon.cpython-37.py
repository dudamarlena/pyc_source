...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/polygon.py
...
class PolygonVisual(CompoundVisual):
    ...
    def __init__(self, pos=None, color='black', border_color=None, border_width=1, **kwargs):
        ...
        self._mesh.set_gl_state(polygon_offset_fill=True, polygon_offset=(1, 1),
          cull_face=False)
        self.freeze()
