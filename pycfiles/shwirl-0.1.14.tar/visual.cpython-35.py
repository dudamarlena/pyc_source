...
# [GCC 8.4.0]
# Embedded file name: /Users/danyvohl/code/shwirl/extern/vispy/visuals/visual.py
# Compiled at: 2017-04-05 22:13:00
# Size of source mod 2**32: 21410 bytes
"""
...
class BaseVisual(Frozen):
    ...
    def __init__(self, vshare=None):
        ...
        self.events = EmitterGroup(source=self, auto_connect=True, update=Event, bounds_change=Event)
        ...
        for v in view._subvisuals:
            if v.visible:
                ...
                if bounds is None:
                    ...
                    bounds = [
                     min(bounds[0], vb[0]), max(bounds[1], vb[1])]
