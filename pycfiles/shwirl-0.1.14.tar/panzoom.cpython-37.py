...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/scene/cameras/panzoom.py
        ...
        if event.type == 'mouse_wheel':
            ...
            if event.type == 'mouse_move':
                ...
                if 1 in event.buttons:
                    p1 = modifiers or np.array(event.last_event.pos)[:2]
                    ...
                    if 2 in event.buttons:
                        p1c = modifiers or np.array(event.last_event.pos)[:2]
