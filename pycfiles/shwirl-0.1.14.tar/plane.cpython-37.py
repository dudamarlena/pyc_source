...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/plane.py
...
class PlaneVisual(CompoundVisual):
    ...
    def __init__(self, width=1, height=1, width_segments=1, height_segments=1, direction='+z', vertex_colors=None, face_colors=None, color=(0.5, 0.5, 1, 1), edge_color=None):
        ...
        if edge_color:
            self._outline = MeshVisual((vertices['position']), outline_indices, color=edge_color,
              mode='lines')
