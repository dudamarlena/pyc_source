...
# [GCC 8.4.0]
# Embedded file name: /Users/vohl/Documents/code/shwirl/shwirl/extern/vispy/visuals/text/text.py
...
class FontManager(object):
    __doc__ = 'Helper to create TextureFont instances and reuse them when possible'
    ...
    def pos(self, pos):
        ...
        if pos.shape[1] == 2:
            pos = np.concatenate((pos,
             np.zeros((pos.shape[0], 1), np.float32)),
              axis=1)
        else:
            if pos.shape[1] != 3:
