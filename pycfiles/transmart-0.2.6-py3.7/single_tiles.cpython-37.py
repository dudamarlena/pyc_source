...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmart/api/v2/dashboard/single_tiles.py
# Compiled at: 2019-03-27 06:02:14
# Size of source mod 2**32: 7249 bytes
"""
* Copyright (c) 2015-2017 The Hyve B.V.
* This code is licensed under the GNU General Public License,
* version 3.
"""
import logging, abc, bqplot as plt, ipywidgets as widgets
...
class Tile(abc.ABC):
    ...
    def _build_tile(self):
        ...
        self.fig.title_style = {'font-size':'small',  'width':'335px', 
         'overflow-text':'wrap'}
...
class HistogramTile(Tile):
    ...
    def create_fig(self):
        ...
        ax_y = plt.Axis(label='Count', scale=scale_y, orientation='vertical',
          grid_lines='solid')
        selector = plt.interacts.BrushIntervalSelector(scale=scale_x,
          marks=[hist],
          color='SteelBlue')
...
class PieTile(Tile):
    ...
    def create_fig(self, *args):
        ...
        pie = plt.Pie(tooltip=tooltip_widget, interactions={'click':'select', 
         'hover':'tooltip'})
        pie.radius = 110
        pie.inner_radius = 65
