...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmart/api/v2/dashboard/dashboard.py
# Compiled at: 2019-03-27 06:02:14
# Size of source mod 2**32: 5191 bytes
"""
* Copyright (c) 2015-2017 The Hyve B.V.
* This code is licensed under the GNU General Public License,
* version 3.
"""
import logging, ipywidgets as widgets
...
class Dashboard:
    ...
    def __init__(self, api, patients: Queryable=None):
        ...
        self._Dashboard__linked_tile = None
        if isinstance(patients, Queryable):
            self.subject_set_id = api.create_patient_set(repr(patients), patients).get('id')
            counts = api.observations.counts_per_study_and_concept(subject_set_id=(self.subject_set_id))
    ...
    def plotter(self, constraints):
        ...
        if self.subject_set_id is not None:
            ...
            if NUMERIC_VALUE in obs.dataframe.columns:
                ...
                if STRING_VALUE in obs.dataframe.columns:
    ...
    def linked_tile(self):
        return self._Dashboard__linked_tile
    ...
    def linked_tile(self, tile):
        ...
        if isinstance(tile, (PieTile, HistogramTile)):
            ...
            if self.linked_tile is not None:
                ...
                self._Dashboard__linked_tile = tile
