...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmart/api/v2/widgets/concept_picker.py
...
class ConceptPicker:
    ...
    def __init__(self, target, api, allowed_nodes: set=None):
        ...
        self.result_count = ipywidgets.HTML(value=(self.result_count_template.format(self.no_filter_len)),
          layout={'width': '175px'})
    ...
    def _build_concept_list(self):
        ...
        concept_list = ipywidgets.Select(options=(self.list_of_default_options[:MAX_OPTIONS]),
          rows=10,
          disabled=False,
