...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmart/main.py
...
def get_api(host, api_version=2, offline_token=None, kc_url=None, kc_realm=None, print_urls=False, interactive=True, client_id=None, verify=None, **kwargs):
    """
    ...
    return api(host=host, offline_token=offline_token, 
     kc_url=kc_url, 
     kc_realm=kc_realm, 
