...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmart/api/v2/data_structures.py
...
class ObservationSet:
    __doc__ = ' Class to represent observation sets from tranSMART API v2 '
    ...
    def aggregate_numeric_on_trial_visit(self, concept):
        ...
        return df_subset.pivot_table(index='visit_label', values='value',
          columns='subject',
          aggfunc='mean')
