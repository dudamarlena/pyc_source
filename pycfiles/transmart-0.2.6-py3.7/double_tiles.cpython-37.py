...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/transmart/api/v2/dashboard/double_tiles.py
...
* version 3.
"""
import logging, abc, bqplot as plt, ipywidgets as widgets, pandas as pd
