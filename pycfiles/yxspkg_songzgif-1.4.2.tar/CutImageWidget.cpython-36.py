...
# [GCC 8.4.0]
# Embedded file name: F:\pythonAPP\yxspkg_songzgif_module\yxspkg_songzgif\CutImageWidget.py
# Compiled at: 2018-08-03 04:22:22
...
class CutImageWidget(QWidget):
    ...
    def moveto(self, x1=10, y1=10, x2=70, y2=70):
        ...
        def checkCutPart():
            if x2 - x1 > self.MinSize[0]:
                if y2 - y1 > self.MinSize[1]:
                    if x1 >= mx1:
                        if y1 >= my1:
                            if x2 <= mx2:
                                if y2 <= my2:
