...
# [GCC 8.4.0]
# Embedded file name: /home/breno/Envs/djangoplus/lib/python3.6/site-packages/djangoplus/admin/forms.py
...
class LoginForm(forms.Form):
    ...
    password = forms.PasswordField(label='Senha', help_text='Caso tenha esquecido sua senha, clique aqui para <a class="popup" href="/admin/reset_password/">alterá-la</a>.')
...
class UserForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not args[0].user.is_superuser:
            ...
            self.fieldsets = (('Identificação', {'fields': (('name', 'email'), 'photo')}),
             (
...
class RegisterForm(forms.Form):
    ...
    confirm_password = forms.PasswordField(label='Senha', required=True, help_text='Repita a senha digitada anteriormente')
...
class ChangePasswordForm(forms.ModelForm):
    new_password = forms.PasswordField(label='Senha', required=True)
    confirm_password = forms.PasswordField(label='Confirmação', required=True, help_text='Repita a senha digitada anteriormente')
    fieldsets = (
     (
      'Senhas', {'fields': ('new_password', 'confirm_password')}),)
...
class ProfileForm(forms.ModelForm):
    new_password = forms.PasswordField(label='Senha', required=False)
    confirm_password = forms.PasswordField(label='Confirmação', required=False, help_text='Repita a senha digitada anteriormente')
