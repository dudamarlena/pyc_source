...
# [GCC 8.4.0]
# Embedded file name: /home/breno/Envs/djangoplus/lib/python3.6/site-packages/djangoplus/docs/usecase.py
# Compiled at: 2018-09-24 08:48:06
# Size of source mod 2**32: 26231 bytes
...
class UseCase(object):
    ...
    def _find(self, model):
        ...
        if list_required_role:
            if loader.last_authenticated_role:
                if loader.last_authenticated_role not in list_required_role:
                        ...
                        if self.actors and hasattr(form_field, 'queryset'):
                            ...
                            if scopes:
                                ...
                                for role_model in loader.role_models:
                                    if loader.role_models[role_model]['name'] == self.actors[0] and loader.role_models[role_model]['scope'] not in scopes:
                                        ignore_field = True
                                        break
