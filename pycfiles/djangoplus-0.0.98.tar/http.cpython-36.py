...
# [GCC 8.4.0]
# Embedded file name: /home/breno/Envs/djangoplus/lib/python3.6/site-packages/djangoplus/utils/http.py
...
import tempfile, json, os, datetime
...
class ReportResponse(PdfResponse):
    ...
    def __init__(self, title, request, objects, landscape=False, template='report.html'):
        ...
        context = dict(objects=objects, title=title, today=(datetime.date.today()), logo=logo, project_name=project_name,
...
class ComponentResponse(HttpResponse):
    ...
    def __init__(self, component):
        super(ComponentResponse, self).__init__(render_to_string('default.html', context=dict(paginator=component), request=(component.request)))