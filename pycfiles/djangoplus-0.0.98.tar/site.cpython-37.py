...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/Envs/djangoplus/lib/python3.7/site-packages/djangoplus/admin/management/commands/site.py
# Compiled at: 2018-10-16 16:09:02
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--update', action='store_true', dest='update', default=False, help='Updates djangoplus.net')
        parser.add_argument('--update-samples', action='store_true', dest='update_samples', default=False, help='Updates samples at djangoplus.net')
        parser.add_argument('--test-samples', action='store_true', dest='test_samples', default=False, help='Tests samples at djangoplus.net')
