...
# [GCC 8.4.0]
# Embedded file name: /home/breno/Envs/djangoplus/lib/python3.6/site-packages/djangoplus/ui/components/forms/factory.py
# Compiled at: 2018-09-24 08:48:06
# Size of source mod 2**32: 14957 bytes
...
def get_many_to_many_form(request, obj, related_field_name, related_pk):
    ...
    class Form(forms.ModelForm):
        related_objects = forms.MultipleModelChoiceField((related_field_model.objects.all()), label=(get_metadata(related_field_model, 'verbose_name')))
...
def get_action_form(request, obj, action):
    ...
    if initial:
        if hasattr(obj, initial):
            ...
            initial = {}
    elif action_choices and hasattr(obj, action_choices):
