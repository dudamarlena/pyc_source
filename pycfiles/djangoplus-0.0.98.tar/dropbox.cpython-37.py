...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/Envs/djangoplus/lib/python3.7/site-packages/djangoplus/utils/storage/dropbox.py
# Compiled at: 2020-01-24 06:05:17
# Size of source mod 2**32: 13044 bytes
import six, time, hashlib, os.path, itertools, datetime
...
class DropboxStorage(Storage):
    CHUNK_SIZE = 1024 * (settings.DEBUG and 1 or 1024)
    ...
    def size(self, name):
        ...
        if not size:
            ...
            cache.set(cache_key, size, 31536000)
        return size
    ...
    def sync(self):
        ...
        while True:
            ...
            sleep_time = settings.DEBUG and 10 or 3600
...
class DropboxContentHasher(object):
    ...
    def update(self, new_data):
        ...
        assert isinstance(new_data, six.binary_type), 'Expecting a byte string, got {!r}'.format(new_data)
        new_data_pos = 0
