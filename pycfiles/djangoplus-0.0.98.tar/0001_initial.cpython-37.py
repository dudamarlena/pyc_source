...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/Envs/djangoplus/lib/python3.7/site-packages/djangoplus/admin/migrations/0001_initial.py
# Compiled at: 2019-02-12 11:38:29
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='Settings',
      ...
      (
       'icon', djangoplus.db.models.fields.ImageField(blank=True, default=b'blank.png', null=True, upload_to=b'config', verbose_name='Ícone')),
      (
      ...
      (
       'mail_confirmation', djangoplus.db.models.fields.BooleanField(default=False, verbose_name='Confirmação via E-mail')),
      (
       'admin_activation', djangoplus.db.models.fields.BooleanField(default=False, verbose_name='Ativação pelo Administrador')),
      (
      ...
      (
       'version', djangoplus.db.models.fields.CharField(max_length=255, verbose_name='Versão do Sistema')),
      (
