...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/Envs/djangoplus/lib/python3.7/site-packages/djangoplus/ui/components/navigation/dropdown.py
# Compiled at: 2019-04-02 22:06:44
                    ...
                    if not add_action:
                        ...
                        if action_names:
                            ...
                            if lookups:
                                ...
                                if forbidden:
                                    continue
                        elif True not in action_expose:
                            if 'web' not in action_expose:
                                continue
