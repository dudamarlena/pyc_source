...
# [GCC 8.4.0]
# Embedded file name: /home/breno/Envs/djangoplus/lib/python3.6/site-packages/djangoplus/admin/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='Settings',
      ...
      (
       'icon', djangoplus.db.models.fields.ImageField(blank=True, default=b'/static/images/blank.png', null=True, upload_to=b'config', verbose_name='Ícone')),
      (
