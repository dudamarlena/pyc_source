...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/.virtualenvs/djangoplus/lib/python3.7/site-packages/djangoplus/ui/components/select/widgets.py
# Compiled at: 2020-03-26 15:07:38
# Size of source mod 2**32: 14460 bytes
            ...
            if self.lazy:
                if hasattr(self.choices, 'queryset'):
                    ...
                    if hasattr(self.choices, 'queryset'):
                        ...
                        select_template = self.lazy or get_metadata(model, 'select_template')
        ...
        if model:
            ...
            for field_name, lookup in self.form_filters:
                ...
                reload_script = RELOAD_SCRIPT.format(function_name=function_name,
                  field_name=(field_name.replace('popup-', '')),
                  app_label=app_label,
