...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/Envs/djangoplus/lib/python3.7/site-packages/djangoplus/admin/migrations/0010_auto_20190307_1656.py
# Compiled at: 2019-03-07 14:56:27
# Size of source mod 2**32: 8743 bytes
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.AlterModelOptions(name='logindex',
       options={'verbose_name':'Índices', 
      'verbose_name_plural':'Índices'}),
     migrations.AlterModelOptions(name='organization',
       options={'verbose_name':'Organização', 
      'verbose_name_plural':'Organizações'}),
     migrations.AlterModelOptions(name='permission',
       options={'verbose_name':'Permissão', 
      'verbose_name_plural':'Permissões'}),
     migrations.AlterModelOptions(name='role',
       options={'verbose_name':'Função', 
      'verbose_name_plural':'Funções'}),
     migrations.AlterModelOptions(name='scope',
       options={'verbose_name':'Escopo', 
      'verbose_name_plural':'Escopos'}),
     migrations.AlterModelOptions(name='settings',
       options={'verbose_name':'Configurações', 
      'verbose_name_plural':'Configurações'}),
     migrations.AlterModelOptions(name='unit',
     ...
     migrations.AlterField(model_name='logindex',
       name='content_type',
