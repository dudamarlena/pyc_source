...
# [GCC 8.4.0]
# Embedded file name: /home/breno/Envs/djangoplus/lib/python3.6/site-packages/djangoplus/test/management/commands/test.py
...
class Command(test.Command):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--continue', action='store_true', dest='continue', default=False, help='Continues from the last successfull login')
        parser.add_argument('--add', action='store_true', dest='add', default=(), help='Adds test cases in test.py file')
        parser.add_argument('--watch', action='store_true', dest='watch', default=False, help='Run tests in browser intead of headless mode')
        parser.add_argument('--record', action='store_true', dest='record', default=False, help='Record the videos for the functions decorated with @tutorial')
        parser.add_argument('--upload', action='store_true', dest='upload', default=False, help='Upload the videos for the functions decorated with @tutorial')
