...
# [GCC 8.4.0]
# Embedded file name: /Users/breno/.virtualenvs/djangoplus/lib/python3.7/site-packages/djangoplus/utils/relations.py
# Compiled at: 2020-02-10 11:38:48
# Size of source mod 2**32: 16251 bytes
...
class Relation(object):
    ...
    def get_component(self, request, as_pdf=False):
        ...
        if self.is_one_to_one or self.is_many_to_one:
            ...
            component = ModelPanel(request,
              (self.relation_value or self.relation_model()), fieldsets=panel_fieldsets,
              complete=False)
            if self.view_url:
            ...
            if self.delete_url:
                if permissions.has_edit_permission(request, self.model):
                    ...
                    for fieldset in fieldsets:
                        ...
                        if not (is_relation or is_inline):
                            if is_field:
                                pass
                    ...
                    if self.children_info:
                        ...
                        component = Paginator(request,
                          (self.relation_value.all(request.user)), title, relation=self, list_subsets=list_subsets,
                          readonly=False,
                          uid=(slugify(self.relation_name)))
