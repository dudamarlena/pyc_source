...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.7/site-packages/btform/__init__.py
# Compiled at: 2015-09-16 04:15:41
import sys, os, copy, re, itertools, net
__version__ = '0.4'
__author__ = [
 'Aaron Swartz <me@aaronsw.com>',
 'Anand Chitipothu <anandology@gmail.com>jamiesun.net@gmail.com']
...
notnull = Validator('NOT NULL', bool)
...
class regexp(Validator):
    ...
    def valid(self, value):
        return bool(self.rexp.match(str(value)))
