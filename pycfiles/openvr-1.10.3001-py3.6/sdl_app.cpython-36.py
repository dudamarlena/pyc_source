...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\openvr\glframework\sdl_app.py
...
class SdlApp(object):
    __doc__ = 'SdlApp uses sdl2 library to create an opengl context, listen to keyboard events, and clean up'
    renderer = None
    title = None
    ...
    def __init__(self, renderer, title='SDL test'):
        ...
        self.window = None
        self._sdl_event_handlers = {SDL_WINDOWEVENT: self.on_sdl_window_event, 
    ...
    def init_gl(self):
        if self._is_initialized:
            ...
            self.window = SDL_CreateWindow(self.title.encode('utf-8'), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, self.renderer.window_size[0], self.renderer.window_size[1], SDL_WINDOW_SHOWN | SDL_WINDOW_OPENGL)
