...
# [GCC 8.4.0]
# Embedded file name: /MyWork/Projects/PyCK/pyck/mako_utils/multi_selector.py
# Compiled at: 2015-02-06 19:46:05
...
def multi_selector(items, field_name, ignore_prefix=None, do_auto_grouping=True):
    ...
    * Ability to only display data (no checkboxes or radio buttons)
    ...
    output = tmpl.render(field_name=field_name, items=items, ignore_prefix=ignore_prefix)
    if PY3:
