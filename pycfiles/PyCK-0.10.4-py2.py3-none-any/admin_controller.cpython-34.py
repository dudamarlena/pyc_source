...
# Compiled at: 2015-08-25 19:58:07
# Size of source mod 2**32: 11914 bytes
"""
...
def add_admin_handler(config, db_session, models=None, route_name_prefix='', url_pattern_prefix='', handler_class=None):
    ...
    if all_models:
        for model in all_models:
            ...
            CC = type(model.__name__ + 'CRUDController', (pyck.controllers.CRUDController,), {'model': model,  'db_session': db_session,  'base_template': handler_class.base_template, 
...
class AdminController(object):
    ...
    def index(self):
        ...
        return {'base_template': self.base_template,  'route_prefix': self.route_prefix,  'models': self.models, 
         'db_session': self.db_session,  'model_record_counts': record_counts}