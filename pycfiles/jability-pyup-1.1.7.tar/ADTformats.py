...
# [GCC 8.4.0]
# Embedded file name: /Users/fabrom/workspace/jability-python-package/jabilitypyup/hl7/ADTformats.py
# Compiled at: 2013-05-25 04:38:30
import hl7v2

class ADTFormat:
    EVENT_LIST = {'A01': 'Admit / Visit Notification', 'A02': 'Transfer a Patient', 
    ...
    SEGMENT_LIST = {'MSH': 'Message Header', 'EVN': 'Event Type', 
    ...
    NON_STANDARD_SEQUENCE_EVENT_LIST = {'A28': SEGSEQ1, 'A31': SEGSEQ1, 
       'A40': SEGSEQ2, 
       'A44': SEGSEQ2}
