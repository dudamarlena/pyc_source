...
# [GCC 8.4.0]
# Embedded file name: /Users/fabrom/workspace/jability-python-package/jabilitypyup/lockflag.py
...
class lockFlag:
    ...
    def __init__(self, flagname='pid', flagext='lock', flagdir=None):
    ...
    def exists(self):
        u"""Contrôle l'existence de l'indicateur"""
