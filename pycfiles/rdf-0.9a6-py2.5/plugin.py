...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.5-i386/egg/rdf/plugin.py
...
from rdf.exceptions import Error
entry_points = {'rdf.plugins.store': Store, 'rdf.plugins.serializer': Serializer, 
   'rdf.plugins.parser': Parser, 
   'rdf.plugins.query_processor': query.Processor, 
   'rdf.plugins.query_result': query.Result}
_plugins = {}
