...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dtale/column_filters.py
# Compiled at: 2020-05-03 13:27:02
import json, dtale.global_state as global_state
        ...
        if self.cfg is None:
            ...
            if cfg_operand in ('=', 'ne'):
                ...
                if len(state) == 1:
                    ...
                    fltr['query'] = ('{} {} ({})').format(self.column, 'in' if cfg_operand == '=' else 'not in', (', ').join(state))
