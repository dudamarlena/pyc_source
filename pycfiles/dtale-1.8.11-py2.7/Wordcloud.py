...
# [GCC 8.4.0]
# Embedded file name: /home/circleci/man-group/dtale_2_7/dtale/dash_application/components/Wordcloud.py
...
class Wordcloud(Component):
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, data=Component.UNDEFINED, y=Component.UNDEFINED, group=Component.UNDEFINED, height=Component.UNDEFINED, **kwargs):
        self._prop_names = [
         'id', 'data', 'y', 'group', 'height']
