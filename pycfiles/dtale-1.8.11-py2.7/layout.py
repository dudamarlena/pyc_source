...
# Compiled at: 2020-05-03 13:27:02
...
def build_loc_mode_hover(loc_mode):
    return html.Span([
     ...
     html.Div(build_loc_mode_hover_children(loc_mode), className='ml-3 hoverable', style=dict(display='none') if loc_mode is None else dict(borderBottom='none'), id='loc-mode-hover')], className='input-group-addon pt-1 pb-0')
     ...
     html.Div([
      html.Div([
       html.Div([
        ...
        build_input('Group', dcc.Dropdown(id='group-dropdown', options=group_options, multi=True, placeholder='Select a group(s)', value=group, style=dict(width='inherit')), className='col', id='group-input', style=show_style(show_input('group')))], id='non-map-inputs', style={} if not show_map else {'display': 'none'}, className='row p-0 charts-filters'),
       html.Div([
       ...
       html.Div([
        build_input('Aggregation', dcc.Dropdown(id='agg-dropdown', options=[ build_option(v, AGGS[v]) for v in ['raw', 'count', 'nunique', 'sum', 'mean', 'rolling',
       ...
       html.Div([
        ...
        build_input('Barsort', dcc.Dropdown(id='barsort-dropdown', options=barsort_options, value=inputs.get('barsort')), className='col-auto addon-min-width', style=barsort_input_style, id='barsort-input'),
        html.Div(html.Div([
        ...
        build_input('Animate By', dcc.Dropdown(id='animate-by-dropdown', options=animate_opts, value=inputs.get('animate_by')), className='col-auto addon-min-width', style=animate_style, id='animate-by-input')], className='row pt-3 pb-5 charts-filters', id='chart-inputs')], id='main-inputs', className=main_input_class),
