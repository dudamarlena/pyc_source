...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/Products/FinanceFields/fixedpoint.py
...
class FixedPoint(object):
    ...
    def __init__(self, value=0, precision=DEFAULT_PRECISION):
        ...
        if isinstance(value, type(42.0)):
            ...
            self.n = n
            return
        if isinstance(value, type(42 - complex(0.0, 42.0))):
