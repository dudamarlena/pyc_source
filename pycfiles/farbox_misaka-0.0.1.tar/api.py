...
# [GCC 8.4.0]
# Embedded file name: /Users/hepochen/Dev/core/misaka/misaka/api.py
# Compiled at: 2017-01-14 23:13:20
import re
try:
...
from .utils import extension_map, html_flag_map, args_to_int, deprecation, to_string
__all__ = [
 'escape_html',
 'html',
 'smartypants',
...
class BaseRenderer(object):
    ...
    def __init__(self):
        ...
        ffi.cast('hoedown_renderer_data *', self.renderer.opaque).opaque = self._renderer_handle
...
class SaferHtmlRenderer(HtmlRenderer):
    ...
    .. versionadded:: 2.1.0
    """
    _allowed_url_re = re.compile('^https?:', re.I)

    def __init__(self, flags=(), sanitization_mode='skip-html', nesting_level=0, link_rewrite=None, img_src_rewrite=None):
