...
# [GCC 8.4.0]
# Embedded file name: /home/ian/src/github.com/iancmcc/ouimeaux/ouimeaux/pysignals/dispatcher.py
# Compiled at: 2018-08-26 09:51:15
# Size of source mod 2**32: 13464 bytes
from __future__ import absolute_import
import sys, threading, weakref, logging
    ...
    def _clear_dead_receivers(self):
        if self._dead_receivers:
            ...
            for r in self.receivers:
                if isinstance(r[1], weakref.ReferenceType):
                    if r[1]() is None:
                        continue
