...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/noteblog/fzutils/spider/crawler.py
...
from ..ip_pools import fz_ip_pool, ip_proxy_pool
from ..internet_utils import get_random_pc_ua, get_random_phone_ua
from ..log_utils import set_logger
from ..time_utils import get_shanghai_time
from .fz_phantomjs import BaseDriver, CHROME, PHANTOMJS
...
class Crawler(object):
    ...
    def __init__(self, ip_pool_type=ip_proxy_pool, user_agent_type=PC, log_print=False, logger=None, log_save_path=None, logger_name='my_logger:' + get_uuid1(), is_use_driver=False, driver_executable_path=None, driver_type=PHANTOMJS, driver_load_images=False, headless=False, driver_obj=None, driver_cookies=None):
        """
        ...
        if is_use_driver:
            ...
            self.driver = BaseDriver(type=driver_type,
    ...
    def _set_logger(self) -> None:
        ...
        :return:
        """
        self.lg = set_logger(logger_name=(self.logger_name), log_file_name=(self.log_save_path + str(get_shanghai_time())[0:10] + '.txt'), console_log_level=INFO, file_log_level=ERROR) if self.lg is None else self.lg
...
class AsyncCrawler(Crawler):
 ...
 self, *params, **kwargs)
    ...
    async def _get_new_logger(self, logger_name=get_uuid1()):
        ...
        return set_logger(log_file_name=(self.log_save_path + str(get_shanghai_time())[0:10] + '.txt'),
