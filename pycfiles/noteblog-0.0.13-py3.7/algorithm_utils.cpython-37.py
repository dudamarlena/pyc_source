...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/noteblog/fzutils/algorithm_utils.py
...
def heap_sort(collection):
    ...
    def heapify(unsorted, index, heap_size):
        ...
        if left_index < heap_size:
            if unsorted[left_index] > unsorted[largest]:
                largest = left_index
        if right_index < heap_size:
            if unsorted[right_index] > unsorted[largest]:
                largest = right_index
        if largest != index:
