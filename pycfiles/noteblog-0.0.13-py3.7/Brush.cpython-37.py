...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/noteblog/brush/Brush.py
# Compiled at: 2019-04-29 13:20:59
...
class TemMail:
    ...
    def getEmail(self):
        while True:
            ...
            temdata = self.driver.find_by_text('激活您的ProcessOn帐号')
            if len(temdata) == 0:
                sleep(2)
            else:
    ...
    def getEmailDea(self, emlurl):
        ...
        url_verify = re.findall('https://www.processon.com/signup/verification/\\w+', temtext)
