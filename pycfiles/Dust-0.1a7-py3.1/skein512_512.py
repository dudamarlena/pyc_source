...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dust/crypto/skein512_512.py
# Compiled at: 2010-05-24 14:38:07
...
CONFIG = b'SHA3\x01\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00'

def skein512_512(msg, mac=b'', pers=b'', nonce=b'', tree=None):
    ...
    g = ubi(g, bytes(8), 83741363734449699992939844797661708288)
    return g
