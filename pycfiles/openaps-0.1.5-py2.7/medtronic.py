...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/openaps/vendors/medtronic.py
# Compiled at: 2016-05-30 23:11:07
"""
...
class MedtronicTask(scan):
    ...
    def create_session(self):
        ...
        out = dict(device=self.device.name, model=model, vendor=__name__, created_at=now, started=now, expires=now + offset)
        return out
