...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/openaps/vendors/process.py
# Compiled at: 2016-05-30 18:08:43
"""
...
class shell(Use):
  ...
  """
    ...
    def get_params(self, args):
        ...
        params = dict(remainder=getattr(args, 'remainder', []), json_default=getattr(args, 'json_default', True))
