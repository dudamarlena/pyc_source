...
# [GCC 8.4.0]
# Embedded file name: c:\projects\pm\src\epcpm\_version.py
# Compiled at: 2020-04-30 08:43:51
# Size of source mod 2**32: 18456 bytes
...
def get_config():
    ...
    cfg.versionfile_source = 'src/epcpm/_version.py'
    cfg.verbose = False
    return cfg
    ...
    try:
        ...
        for line in f.readlines():
            if line.strip().startswith('git_refnames ='):
                ...
                elif line.strip().startswith('git_full ='):
                    mo = re.search('=\\s*"(.*)"', line)
                    if mo:
