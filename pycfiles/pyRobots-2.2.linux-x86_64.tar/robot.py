...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/robots/robot.py
# Compiled at: 2015-03-06 15:00:57
import logging
logger = logging.getLogger('robots.robot')
if hasattr(logging, 'NullHandler'):
    logger.addHandler(logging.NullHandler())
import time, pkgutil, sys
...
class GenericRobot(object):
    ...
    def __init__(self, actions=None, supports=0, dummy=False, immediate=False, configure_logging=True):
        """
