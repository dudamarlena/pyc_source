...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/qoalai/networks/nasnet5.py
# Compiled at: 2019-12-06 02:25:07
...
from qoalai.networks.cell import PNASCell
...
def build_pnasnet_large(images, num_classes, is_training=True, final_endpoint=None, config=None):
    ...
    cell = PNASCell(hparams.num_conv_filters, hparams.drop_path_keep_prob, total_num_cells, hparams.total_training_steps)
    with arg_scope([slim.dropout, slim.batch_norm], is_training=is_training):
        ...
        reduction_indices = calc_reduction_layers(hparams.num_cells, hparams.num_reduction_layers)
