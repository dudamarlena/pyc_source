...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/qoalai/landmarks/landmark_v2.py
# Compiled at: 2019-10-03 07:59:57
# Size of source mod 2**32: 10490 bytes
...
class Landmark(object):
    ...
    def __init__(self, num_landmark_point, input_height=400, input_width=400, input_channel=3):
        """Constructor
    ...
    def build_densenet_base(self, input_tensor, dropout_rate, is_training, top_layer_depth):
        ...
        out_x = tf.expand_dims(out_x, -1)
        out_y = tf.expand_dims(out_y, -1)
        out = tf.concat([out_x, out_y], axis=(-1))
        print(out_x)
        print(out_y)
        print(out)
        return out
