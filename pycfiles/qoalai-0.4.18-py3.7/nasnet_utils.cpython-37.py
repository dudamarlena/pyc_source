...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/qoalai/networks/nasnet_utils.py
# Compiled at: 2019-12-05 06:31:30
# Size of source mod 2**32: 20468 bytes
...
def factorized_reduction(net, output_filters, stride, data_format=INVALID):
    ...
    if not data_format != INVALID:
        ...
        if data_format == 'NHWC':
            ...
            stride_spec = [
             1, 1, stride, stride]
        path1 = tf.nn.avg_pool(net,
          [1, 1, 1, 1], stride_spec, 'VALID', data_format=data_format)
