...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/qoalai/landmarks/landmark_v6.py
# Compiled at: 2020-03-21 10:57:08
# Size of source mod 2**32: 11964 bytes
...
class Landmark(object):
    ...
    def __init__(self, num_landmark_point, input_height=300, input_width=300, input_channel=3, grid_num=19, threshold=0.6):
        ...
        self.input_placeholder = tf.placeholder((tf.float32), shape=(
         ...
         self.input_width,
         self.input_channel))
        self.output_placeholder = tf.placeholder((tf.float32), shape=(
         None,
         self.grid_num,
         self.grid_num,
    ...
    def build_densenet_base(self, input_tensor, dropout_rate, is_training, top_layer_depth):
        ...
        print('===========', out)
        self.out = new_conv2d_layer(input=out, filter_shape=[
    ...
    def batch_generator(self, batch_size, dataset_path, message):
        ...
        while True:
            ...
            yield (
             np.array(x_batch), np.array(y_pred_map))
    ...
    def optimize(self, iteration, subdivition, cost_tensor, optimizer_tensor, session, saver, train_generator, val_generator, best_loss, path_tosave_model='model/model1'):
        ...
        for i in range(iteration):
            ...
            print('>> epoch: ', i, 'train loss: ', round(t_loss, 3), 'val loss: ', round(loss, 3), 'val map acc: ', round(map_acc, 3), 'val map loss: ', round(pml, 3), sign)