...
# [GCC 8.4.0]
# Embedded file name: /home/afshari9978/Projects/snappion_backend/avishan/misc/bch_datetime.py
# Compiled at: 2020-02-15 16:09:26
# Size of source mod 2**32: 18093 bytes
...
class BchDatetime(object):
    ...
    def __init__(self, year: Union[(int, datetime, date, JalaliDatetime, dict, 'BchDatetime')]=None, month: int=None, day: int=None, hour: int=None, minute: int=None, second: int=None, microsecond: int=None) -> None:
        temp = None
        if not year:
            temp = month or day or hour or minute or second or microsecond or BchDatetime.from_bch_datetime(BchDatetime.now())
        else:
