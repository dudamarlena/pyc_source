...
# [GCC 8.4.0]
# Embedded file name: /home/afshari9978/Projects/parkners_new/avishan/views/class_based.py
# Compiled at: 2020-03-20 17:31:47
# Size of source mod 2**32: 19771 bytes
...
class AvishanModelApiView(AvishanApiView):
    ...
    def documentation() -> Optional[ApiDocumentation]:
        ...
        for model in AvishanModel.get_non_abstract_models():
            ...
            if len(dict(inspect.signature(model_create).parameters.items()).keys()) == 1 and list(dict(inspect.signature(model_create).parameters.items()).keys())[0] == 'kwargs':
