...
# [GCC 8.4.0]
# Embedded file name: /home/afshari9978/Projects/parkners_new/avishan/libraries/openapi3/classes.py
# Compiled at: 2020-02-21 10:20:50
# Size of source mod 2**32: 16280 bytes
...
class SchemaProperty:
    ...
    def __init__(self, name: str, type: Union[(str, type, models.Field, 'Schema')], required: bool=False, raw: bool=False):
        self.name = name
    ...
    def export_json(self):
        if self.raw:
            ...
            return isinstance(self.type, str) or {'$ref': f"#/components/schemas/{self.type.name}"}
...
class Schema:
    ...
    def __init__(self, name: str, type: str='object', properties: List[SchemaProperty]=(), items: 'Schema'=None, raw: bool=False):
        self.name = name
        self.type = type
            ...
            for key, value in data[name].items():
                if isinstance(value, dict):
                    ...
                    if isinstance(value, list):
                        ...
                        if inspect.isclass(value) and issubclass(value, AvishanModel):
                            inner_type = SchemaProperty(name=key,
...
class PathMethod:
    ...
    def __init__(self, summary: str=None, description: str=None, request: PathRequest=None, responses: PathResponseGroup=None, tags: List[str]=()):
...
class OpenApi:
    ...
    def __init__(self, api_version: str, api_title: str, open_api_version: str='3.0.0', api_description: str=None, servers: Tuple[str]=()):
