...
# [GCC 8.4.0]
# Embedded file name: /home/afshari9978/Projects/snappion_backend/avishan/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    dependencies = []
    operations = [
     migrations.CreateModel(name='BaseUser',
       fields=[
      (
     ...
     migrations.CreateModel(name='Email',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='Phone',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'is_verified', models.BooleanField(default=False))],
       options={'abstract': False}),
     migrations.CreateModel(name='RequestTrack',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='UserGroup',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='UserUserGroup',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='RequestTrackMessage',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='RequestTrackException',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.AddField(model_name='requesttrack',
     ...
     migrations.CreateModel(name='PhoneVerification',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='PhonePasswordAuthenticate',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='PhoneOTPAuthenticate',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'user_user_group', models.OneToOneField(on_delete=(django.db.models.deletion.CASCADE), to='avishan.UserUserGroup'))],
       options={'abstract': False}),
     migrations.CreateModel(name='Image',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='File',
      ...
      (
       'base_user', models.ForeignKey(blank=True, null=True, on_delete=(django.db.models.deletion.SET_NULL), to='avishan.BaseUser'))],
       options={'abstract': False}),
     migrations.CreateModel(name='EmailVerification',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'abstract': False}),
     migrations.CreateModel(name='EmailPasswordAuthenticate',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
