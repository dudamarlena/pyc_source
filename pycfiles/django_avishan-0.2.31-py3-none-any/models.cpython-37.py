...
# [GCC 8.4.0]
# Embedded file name: /home/afshari9978/Projects/parkners_new/avishan/models.py
# Compiled at: 2020-03-23 16:27:24
# Size of source mod 2**32: 60658 bytes
import random
...
class AvishanModel(models.Model):
    ...
    def _clean_model_data_kwargs(cls, on_update: bool=False, **kwargs):
        ...
        for field in cls.get_full_fields():
            if cls.is_field_readonly(field):
                continue
            elif cls.is_field_required(field) and (on_update or field.name) not in kwargs.keys():
 ...
 L. 461        20  LOAD_GLOBAL              isinstance
               22  LOAD_FAST                'field'
 ...
 L. 463        56  LOAD_CONST               False
               58  RETURN_VALUE     
             60_0  COME_FROM            54  '54'
             60_1  COME_FROM            42  '42'

 L. 464        60  LOAD_GLOBAL              isinstance
               62  LOAD_FAST                'field'
 ...
 L. 465        72  LOAD_CONST               False
               74  RETURN_VALUE     
             76_0  COME_FROM            70  '70'

 L. 467        76  LOAD_FAST                'field'
               78  LOAD_ATTR                blank
 ...
 L. 468        88  LOAD_CONST               False
               90  RETURN_VALUE     
             92_0  COME_FROM            86  '86'

 L. 470        92  LOAD_CONST               True
               94  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `COME_FROM' instruction at offset 60_1
    ...
    def cast_field_data(cls, data, field: models.Field):
        ...
        if cast_class is None:
            return data
        elif isinstance(cast_class, AvishanModel):
