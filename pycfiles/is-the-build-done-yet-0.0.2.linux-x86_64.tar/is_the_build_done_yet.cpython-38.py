...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.8/site-packages/is_the_build_done_yet/is_the_build_done_yet.py
# Compiled at: 2020-04-07 19:01:55
# Size of source mod 2**32: 6104 bytes
import requests, argparse, json, subprocess, os
...
def run_setup():
    style = style_from_dict({Token.Separator: '#cc5454', 
    ...
    fail_colour = {'r':int(fail_colours[0]), 
     'g':int(fail_colours[1]), 
     'b':int(fail_colours[2])}
    success_colour = {'r':int(success_colours[0]), 
    ...
    for light in lights:
        ...
        questions = [
         {'type':'checkbox',  'message':'Select Lights', 
