...
# Embedded file name: /Library/Python/2.6/site-packages/PyLAF/plotters.py
# Compiled at: 2010-06-11 09:07:06
...
class BasePlot(SimplePlot, PortHolder):
    ...
    def _sig_in(self):
        self.plot(self.sig_in.get().transpose())
        self.show()
...
class Spectrum(BasePlot):
    ...
    def _sig_in(self):
        ...
        try:
            ...
            freq = fftpack.fftshift(fftpack.fftfreq(sig.size, 1.0 / samplerate))
...
def test(master=None):
    ...
    o.samplerate.set(250.0, mode=SLAVE)
    osc.xmin.set(0)
    osc.xmax.set(1000)
