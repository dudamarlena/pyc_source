...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/ORCSchlange/command/db.py
# Compiled at: 2017-07-11 16:41:53
...
class DbCommand(BaseCommand):
    __doc__ = 'The class that contains all db commands.'
