...
# Compiled at: 2017-10-14 21:19:55
# Size of source mod 2**32: 23144 bytes
 ...
 eurl, *args, **kwargs)
    ...
    def prepare(self):
        ...
        if self.hub_api_url or self.hub_api_token or self.hub_base_url:
            ...
            try:
                yield self.http_client.fetch((url_path_join(self.hub_api_url, 'authorizations/cookie', self.hub_cookie_name, quote(encrypted_cookie, safe=''))),
    ...
    def write_error(self, status_code, **kwargs):
        ...
        ns = dict(status_code=status_code,
...
class RenderingHandler(BaseHandler):
    ...
    @gen.coroutine
    def finish_notebook(self, json_notebook, download_url, provider_url=None, provider_icon=None, provider_label=None, msg=None, breadcrumbs=None, public=False, format=None, request=None, title=None):
        ...
        try:
            ...
            with time_block(('Rendered %s' % download_url), debug_limit=0):
                ...
                nbhtml, config = yield self.pool.submit(render_notebook, (self.formats[format]),
                  nb, download_url, config=(self.config))
                render_time.stop()
 ...
 'formats/.html' format, body=nbhtml, 
         nb=nb, 
