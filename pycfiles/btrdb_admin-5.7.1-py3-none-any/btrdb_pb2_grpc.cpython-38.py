...
# Embedded file name: build/bdist.macosx-10.15-x86_64/egg/btrdb/grpcinterface/btrdb_pb2_grpc.py
# Compiled at: 2019-04-30 18:42:34
# Size of source mod 2**32: 15751 bytes
import grpc
...
class BTrDBStub(object):
    ...
    """
        self.RawValues = channel.unary_stream('/v5api.BTrDB/RawValues',
        ...
        self.AlignedWindows = channel.unary_stream('/v5api.BTrDB/AlignedWindows',
        ...
        self.SetStreamAnnotations = channel.unary_unary('/v5api.BTrDB/SetStreamAnnotations',
        ...
        self.SetStreamTags = channel.unary_unary('/v5api.BTrDB/SetStreamTags',
        ...
        self.Create = channel.unary_unary('/v5api.BTrDB/Create',
          request_serializer=(btrdb__pb2.CreateParams.SerializeToString),
          response_deserializer=(btrdb__pb2.CreateResponse.FromString))
        self.ListCollections = channel.unary_stream('/v5api.BTrDB/ListCollections',
        ...
        self.LookupStreams = channel.unary_stream('/v5api.BTrDB/LookupStreams',
        ...
        self.GetMetadataUsage = channel.unary_unary('/v5api.BTrDB/GetMetadataUsage',
        ...
        self.GenerateCSV = channel.unary_stream('/v5api.BTrDB/GenerateCSV',
        ...
        self.SQLQuery = channel.unary_stream('/v5api.BTrDB/SQLQuery',
...
def add_BTrDBServicer_to_server(servicer, server):
    rpc_method_handlers = {'RawValues':grpc.unary_stream_rpc_method_handler(servicer.RawValues,
     ...
     'AlignedWindows':grpc.unary_stream_rpc_method_handler(servicer.AlignedWindows,
     ...
     'Windows':grpc.unary_stream_rpc_method_handler(servicer.Windows,
       request_deserializer=btrdb__pb2.WindowsParams.FromString,
       response_serializer=btrdb__pb2.WindowsResponse.SerializeToString), 
     'StreamInfo':grpc.unary_unary_rpc_method_handler(servicer.StreamInfo,
     ...
     'SetStreamAnnotations':grpc.unary_unary_rpc_method_handler(servicer.SetStreamAnnotations,
     ...
     'SetStreamTags':grpc.unary_unary_rpc_method_handler(servicer.SetStreamTags,
     ...
     'ListCollections':grpc.unary_stream_rpc_method_handler(servicer.ListCollections,
     ...
     'LookupStreams':grpc.unary_stream_rpc_method_handler(servicer.LookupStreams,
     ...
     'Flush':grpc.unary_unary_rpc_method_handler(servicer.Flush,
       request_deserializer=btrdb__pb2.FlushParams.FromString,
       response_serializer=btrdb__pb2.FlushResponse.SerializeToString), 
     'Obliterate':grpc.unary_unary_rpc_method_handler(servicer.Obliterate,
     ...
     'GetMetadataUsage':grpc.unary_unary_rpc_method_handler(servicer.GetMetadataUsage,
     ...
     'GenerateCSV':grpc.unary_stream_rpc_method_handler(servicer.GenerateCSV,
     ...
     'SQLQuery':grpc.unary_stream_rpc_method_handler(servicer.SQLQuery,
    ...
    generic_handler = grpc.method_handlers_generic_handler('v5api.BTrDB', rpc_method_handlers)
