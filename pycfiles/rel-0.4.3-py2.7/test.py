...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rel/test.py
# Compiled at: 2018-01-17 02:30:54
"""
...
from . import rel
rel.override()
import glob, os, signal, sys, _thread, time, unittest
unittest2 = None
...
class EventTest(unittest.TestCase):
    ...
    def test_signal(self):
        if not hasattr(signal, 'SIGUSR1'):
            ...
            event.event(__signal_cb, handle=signal.SIGUSR1, evtype=event.EV_SIGNAL).add()
