...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rel/rel.py
# Compiled at: 2018-02-01 11:40:31
"""
R.E.L.
...
mapping = {'select': SelectRegistrar, 
...
def _display(text):
    ...
    if verbose:
        print (
         'Registered Event Listener output:', text)
    ...
    def check(self):
        if threading.activeCount() > 1:
            if not self.sleeper.pending():
                ...
                self.sleeper.add(0.01)
        elif self.sleeper.pending():
