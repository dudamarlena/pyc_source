...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/linguist/libs/samples.py
# Compiled at: 2013-08-31 12:47:17
import json
...
class Samples(object):
            ...
            for filename in listdir(dirname):
                if filename == 'filenames':
                    ...
                    for subfilename in listdir(subdirname):
                        func({'path': join(subdirname, subfilename), 'language': category, 
                    ...
                    func({'path': path, 'language': category, 
                       'extname': _extname})
    ...
    def data(cls):
        ...
        """
        db = {'extnames': defaultdict(list), 'filenames': defaultdict(list)}
