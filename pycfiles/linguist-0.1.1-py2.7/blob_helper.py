...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/linguist/libs/blob_helper.py
# Compiled at: 2013-08-31 12:57:54
import re, urllib
from os.path import realpath, dirname, splitext, basename, join
import yaml, mime, charlockholmes
...
class BlobHelper(object):
    ...
    def is_binary_mime_type(self):
        ...
        """
        if self._mime_type:
            return self._mime_type.is_binary
        return False
    ...
    def language(self):
        ...
        if _data and isinstance(_data, basestring):
            ...
            data = --- This code section failed: ---

 L. 359         0  LOAD_DEREF            0  'self'
                3  LOAD_ATTR             0  'is_binary_mime_type'
                6  POP_JUMP_IF_TRUE     18  'to 18'
                9  LOAD_DEREF            0  'self'
               12  LOAD_ATTR             1  'is_binary'
             15_0  COME_FROM             6  '6'
...
Parse error at or near `None' instruction at offset -1
    ...
    def lexer(self):
        ...
        return lexers.find_lexer_class('Text only')
