...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/adlib/tests/adversaries/free_range_400.py
...
from adlib.adversaries.free_range_attack import FreeRange
