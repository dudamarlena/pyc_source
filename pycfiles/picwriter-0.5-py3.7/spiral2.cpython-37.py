...
class Spiral2(gdspy.Cell):
    ...
    def build_ports(self):
        ...
        self.portlist['output'] = {'port':self.portlist_output,  'direction':self.direction}


if __name__ == '__main__':
    from picwriter.components.waveguide import WaveguideTemplate
    top = gdspy.Cell('top')
    wgt = WaveguideTemplate(bend_radius=50, wg_width=1.0,
      clad_width=10.0)
    sp1 = Spiral2(wgt, width=2000.0,
      length=20000.0,
      spacing=50.0,
      parity=1,
      port=(0, 0),
