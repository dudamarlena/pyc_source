...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\picwriter\components\zerolengthcavity.py
# Compiled at: 2019-10-06 18:48:06
# Size of source mod 2**32: 9212 bytes
    ...
    def __init__(self, wgt, num_holes, period, radius, radius_taper, gap, wgt_beam_length, num_taper_holes=4, taper_type='FF', port=(0, 0), direction='EAST'):
        ...
        if taper_type == 'FF':
            ...
            if taper_type == 'ratio':
                ...
                self.total_length = num_holes * period + 2 * self.taper_length + 2 * self.wgt_beam_length
        self._ZeroLengthCavity__build_cell()
        self._ZeroLengthCavity__build_ports()
...
if __name__ == '__main__':
 ...
 0.05,
 1,
 6, taper_type='ratio', **wg2.portlist['output'])
    tk.add(top, zlc2)
