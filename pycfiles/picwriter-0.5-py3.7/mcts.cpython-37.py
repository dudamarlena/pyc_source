...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\picwriter\mcts.py
# Compiled at: 2019-10-06 18:48:06
# Size of source mod 2**32: 17082 bytes
"""
...
import numpy as np, meep as mp, h5py, argparse, operator
...
def main(args):
    ...
    if len(port_coords) % 2 != 0:
        ...
        sources = [
         mp.EigenModeSource(src=mp.GaussianSource(fcen, fwidth=df, cutoff=30),
...
if __name__ == '__main__':
    ...
    parser.add_argument('-input_direction',
      type=int,
      default=1,
    ...
    parser.add_argument('-port_coords',
      nargs='+',
      required=True,
