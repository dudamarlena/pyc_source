...
# [GCC 8.4.0]
# Embedded file name: /Users/julio.rama/git/vault-opensource/vault/templatetags/vault_tags.py
# Compiled at: 2020-03-25 17:18:17
...
def set_project(context):
    ...
    for group in groups:
        ...
        group_projects.append({'team':group.name, 
         'projects':gp_projs})
...
def get_logout_url(context):
    request = context.get('request')
    logout_url = settings.LOGOUT_URL.format(request.META['HTTP_HOST'])
    return logout_url
