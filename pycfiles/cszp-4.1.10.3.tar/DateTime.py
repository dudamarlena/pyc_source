...
# Embedded file name: /home/bill/py3/.virtualenvs/pytest/lib/python2.7/site-packages/Csys/DateTime/DateTime.py
# Compiled at: 2009-11-24 20:46:32
__doc__ = 'Encapsulation of date/time values'
...
jd1901 = 2415385
numericTimeZoneMatch = re.compile('[+-][0-9][0-9][0-9][0-9]').match

class _timezone():

    def __init__(self, data):
        self.name, self.timect, self.typect, self.ttrans, self.tindex, self.tinfo, self.az = data
    ...
    def index(self, t=None):
        ...
        if self.timect == 0:
            ...
            if self.timect > 1:
                idx = (
                 ord(self.tindex[(-1)]), ord(self.tindex[(-1)]),
                 ord(self.tindex[(-2)]))
            else:
                idx = (
                 ord(self.tindex[(-1)]), ord(self.tindex[(-1)]),
            ...
            for i in range(self.timect - 1):
                if t < self.ttrans[(i + 1)]:
                    if i == 0:
                        ...
                        idx = (
                         ord(self.tindex[i]), ord(self.tindex[(i + 1)]),
                         ord(self.tindex[(i - 1)]))
                    break
    ...
    def info(self, t=None):
        ...
        return (
         self.tinfo[idx][0], self.tinfo[idx][1], zs[:zs.find('\x00')])
...
class _cache():
    ...
    _zmap = {'aest': 'GMT+1000', 'aedt': 'GMT+1100', 'aus eastern standard time': 'GMT+1000', 
       ...
       'brazil/west': 'Brazil/West', 'canada/atlantic': 'Canada/Atlantic', 
       ...
       'canada/yukon': 'Canada/Yukon', 'central europe standard time': 'GMT+0100', 
       'chile/continental': 'Chile/Continental', 
       'chile/easterisland': 'Chile/EasterIsland', 
       'cst': 'US/Central', 
       'cuba': 'Cuba', 'est': 'US/Eastern', 'egypt': 'Egypt', 'eastern standard time': 'US/Eastern', 
       'us eastern standard time': 'US/Eastern', 
       'central standard time': 'US/Central', 
       'mountain standard time': 'US/Mountain', 
       'pacific standard time': 'US/Pacific', 
       'gb-eire': 'GB-Eire', 
       'gmt': 'GMT', 'gmt+0000': 'GMT+0', 
       'gmt+0': 'GMT+0', 'gmt+0100': 'GMT+1', 
       'gmt+0200': 'GMT+2', 'gmt+0300': 'GMT+3', 'gmt+0400': 'GMT+4', 
       'gmt+0500': 'GMT+5', 'gmt+0600': 'GMT+6', 'gmt+0700': 'GMT+7', 
       'gmt+0800': 'GMT+8', 'gmt+0900': 'GMT+9', 'gmt+1000': 'GMT+10', 
       'gmt+1100': 'GMT+11', 'gmt+1200': 'GMT+12', 'gmt+1300': 'GMT+13', 
       'gmt-0100': 'GMT-1', 
       'gmt-0200': 'GMT-2', 'gmt-0300': 'GMT-3', 'gmt-0400': 'GMT-4', 
       'gmt-0500': 'GMT-5', 'gmt-0600': 'GMT-6', 'gmt-0700': 'GMT-7', 
       'gmt-0800': 'GMT-8', 'gmt-0900': 'GMT-9', 'gmt-1000': 'GMT-10', 
       'gmt-1100': 'GMT-11', 'gmt-1200': 'GMT-12', 'gmt+1': 'GMT+1', 
       'gmt+2': 'GMT+2', 'gmt+3': 'GMT+3', 'gmt+4': 'GMT+4', 
       'gmt+5': 'GMT+5', 'gmt+6': 'GMT+6', 'gmt+7': 'GMT+7', 
       'gmt+8': 'GMT+8', 'gmt+9': 'GMT+9', 'gmt+10': 'GMT+10', 
       'gmt+11': 'GMT+11', 'gmt+12': 'GMT+12', 'gmt+13': 'GMT+13', 
       'gmt-1': 'GMT-1', 
       'gmt-2': 'GMT-2', 'gmt-3': 'GMT-3', 'gmt-4': 'GMT-4', 
       'gmt-5': 'GMT-5', 'gmt-6': 'GMT-6', 'gmt-7': 'GMT-7', 
       'gmt-8': 'GMT-8', 'gmt-9': 'GMT-9', 'gmt-10': 'GMT-10', 
       'gmt-11': 'GMT-11', 'gmt-12': 'GMT-12', 'gmt+130': 'GMT+0130', 
       'gmt+0130': 'GMT+0130', 'gmt+230': 'GMT+0230', 
       'gmt+0230': 'GMT+0230', 'gmt+330': 'GMT+0330', 
       'gmt+0330': 'GMT+0330', 'gmt+430': 'GMT+0430', 
       'gmt+0430': 'GMT+0430', 'gmt+530': 'GMT+0530', 
       'gmt+0530': 'GMT+0530', 'gmt+630': 'GMT+0630', 
       'gmt+0630': 'GMT+0630', 'gmt+730': 'GMT+0730', 
       'gmt+0730': 'GMT+0730', 'gmt+830': 'GMT+0830', 
       'gmt+0830': 'GMT+0830', 'gmt+930': 'GMT+0930', 
       'gmt+0930': 'GMT+0930', 'gmt+1030': 'GMT+1030', 
       'gmt+1130': 'GMT+1130', 
       'gmt+1230': 'GMT+1230', 
       'gmt-130': 'GMT-0130', 
       'gmt-0130': 'GMT-0130', 'gmt-230': 'GMT-0230', 
       ...
       'gmt-1230': 'GMT-1230', 
       'greenwich': 'Greenwich', 
       'hongkong': 'Hongkong', 'iceland': 'Iceland', 
       'iran': 'Iran', 'israel': 'Israel', 'jamaica': 'Jamaica', 
       'japan': 'Japan', 'mexico/bajanorte': 'Mexico/BajaNorte', 
       'mexico/bajasur': 'Mexico/BajaSur', 
       'mexico/general': 'Mexico/General', 'mst': 'US/Mountain', 
       'pst': 'US/Pacific', 'poland': 'Poland', 'singapore': 'Singapore', 
       'turkey': 'Turkey', 'universal': 'Universal', 'utc': 'Universal', 
       'uct': 'Universal', 'us/alaska': 'US/Alaska', 'us/aleutian': 'US/Aleutian', 
       'us/arizona': 'US/Arizona', 'us/central': 'US/Central', 
       'us/eastern': 'US/Eastern', 'us/east-indiana': 'US/East-Indiana', 
       'us/hawaii': 'US/Hawaii', 'us/indiana-starke': 'US/Indiana-Starke', 
       'us/michigan': 'US/Michigan', 'us/mountain': 'US/Mountain', 
       'us/pacific': 'US/Pacific', 'us/samoa': 'US/Samoa', 
       'ut': 'Universal', 
       'bst': 'GMT+1', 
       'mest': 'GMT+2', 'sst': 'GMT+2', 'fst': 'GMT+2', 
       'wadt': 'GMT+8', 'eadt': 'GMT+11', 'nzdt': 'GMT+13', 'wet': 'GMT', 
       'wat': 'GMT-1', 'at': 'GMT-2', 'ast': 'GMT-4', 'nt': 'GMT-11', 
       'idlw': 'GMT-12', 'cet': 'GMT+1', 'cest': 'GMT+2', 'met': 'GMT+1', 
       'mewt': 'GMT+1', 
       'swt': 'GMT+1', 'fwt': 'GMT+1', 'eet': 'GMT+2', 'eest': 'GMT+3', 
       'bt': 'GMT+3', 
       'zp4': 'GMT+4', 'zp5': 'GMT+5', 'zp6': 'GMT+6', 'wast': 'GMT+7', 
       'cct': 'GMT+8', 'jst': 'GMT+9', 'east': 'GMT+10', 'gst': 'GMT+10', 
       'nzt': 'GMT+12', 'nzst': 'GMT+12', 'idle': 'GMT+12', 'ret': 'GMT+4', 
       'ist': 'GMT+0530'}
...
def _calcIndependentSecondEtc(tz, x, ms):
    ...
    t = x_adjusted - long(EPOCH) + 86400
    millis = (x + 86400 - fset) * 1000 + long(round(ms * 1000.0)) - long(EPOCH * 1000.0)
    s = d - math.floor(d)
    return (
     s, d, t, millis)
...
def safegmtime(t):
    ...
    try:
        ...
        raise TimeError, 'The time %f is beyond the range of this Python implementation.' % float(t)
...
class DateTime():
    ...
    def _parse_args(self, *args, **kw):
        ...
        DateTimes may be created with from zero to seven arguments.
          ...
          - If the DateTime function is invoked with a single
            argument that is a DateTime instance, a copy of the 
        ...
        self._fmon, self._amon, self._pmon = self._months[mo], self._months_a[mo], self._months_p[mo]
        self._fday, self._aday, self._pday = self._days[dx], self._days_a[dx], self._days_p[dx]
        sc = round(sc, 3)
        if sc >= 60.0:
            sc = 59.999
    ...
    flt_pattern = re.compile(':([0-9]+\\.[0-9]+)')
    name_pattern = re.compile('([a-zA-Z]+)', re.I)
    space_chars = ' \t\n'
    delimiters = '-/.:,+'
    ...
    _monthmap = {'january': 1, 'jan': 1, 'february': 2, 
       'feb': 2, 'march': 3, 
       'mar': 3, 'april': 4, 
       'apr': 4, 'may': 5, 
       'june': 6, 
    ...
    _daymap = {'sunday': 1, 'sun': 1, 'monday': 2, 
       'mon': 2, 'tuesday': 3, 
       'tues': 3, 'tue': 3, 'wednesday': 4, 
       'wed': 4, 'thursday': 5, 
       'thurs': 5, 'thur': 5, 'thu': 5, 'friday': 6, 
       'fri': 6, 'saturday': 7, 
       'sat': 7}
    ...
    def _parse(self, st, datefmt=getDefaultDateFormat()):
        ...
        while i < l:
            ...
            if ts_results:
                ...
                ls = len(s)
                i = i + ls
                if ls == 4 and d and d in '+-' and len(ints) + (not not month) >= 3:
                    tz = '%s%s' % (d, s)
                else:
                    v = int(s)
                    ints.append(v)
    ...
    def toZone(self, z):
        ...
        try:
            ...
            sc = self._second
            return self.__class__(yr, mo, dy, hr, mn, sc, tz, t, self._d, self.time, millis)
        except:
            ...
            sc = self._second
            ms = sc - math.floor(sc)
            x = _calcDependentSecond2(self._year, self._month, self._day, self._hour, self._minute, sc)
            x_new = x + tzdiff
    ...
    def latestTime(self):
        """Return a new DateTime object that represents the latest
           possible time (in whole seconds) that still falls within
           the current object's day, in the object's timezone context"""
        return self.__class__(self._year, self._month, self._day, 23, 59, 59, self._tz)
    ...
    def parts(self):
        ...
        return (
         self._year, self._month, self._day, self._hour,
    ...
    def strftime(self, format):
        x = _calcDependentSecond2(self._year, self._month, self._day, self._hour, self._minute, self._second)
        ...
        ds = datetime(zself._year, zself._month, zself._day, zself._hour, zself._minute, int(zself._nearsec), microseconds).strftime(format)
    ...
    def __hash__(self):
        ...
        return int(((self._year % 100 * 12 + self._month) * 31 + self._day + self.time) * 100)
        ...
        if t:
            ...
            if z:
                ...
                if fields[4]:
                    raise IndexError
        return (
         year, month, day, hour, minute, seconds, 'GMT%+03d%02d' % (hour_off, min_off))
