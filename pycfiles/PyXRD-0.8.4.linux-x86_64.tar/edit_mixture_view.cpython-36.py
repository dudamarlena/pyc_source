...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyxrd/mixture/views/edit_mixture_view.py
# Compiled at: 2020-03-07 03:51:50
# Size of source mod 2**32: 8941 bytes
...
class EditMixtureView(BaseView):
    ...
    def _get_new_check(self, callback=None):
        ...
        if callback is not None:
            new_check.connect('toggled', callback)
        return new_check
