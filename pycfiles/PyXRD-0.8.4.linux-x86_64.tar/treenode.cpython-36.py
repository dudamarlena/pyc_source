...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/mvc/models/treenode.py
...
class TreeNode(object):
    ...
    def get_next_node(self):
        try:
            return self.parent.get_child_node(self.parent.get_child_node_index(self) + 1)
        except IndexError:
            return
