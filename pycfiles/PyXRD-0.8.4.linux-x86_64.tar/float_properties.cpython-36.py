...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/mvc/models/properties/float_properties.py
...
class FloatProperty(CastProperty):
    ...
    def __init__(self, *args, **kwargs):
        (super(FloatProperty, self).__init__)(args, cast_to=float, **kwargs)
...
class FloatChoiceProperty(CastChoiceProperty):
    ...
    def __init__(self, choices=[], *args, **kwargs):
        (super(FloatChoiceProperty, self).__init__)(args, cast_to=float, choices=choices, **kwargs)