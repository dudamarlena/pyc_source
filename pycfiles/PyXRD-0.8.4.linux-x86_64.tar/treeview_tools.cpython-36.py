...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyxrd/generic/views/treeview_tools.py
# Compiled at: 2020-03-07 03:51:50
# Size of source mod 2**32: 10794 bytes
import gi
gi.require_version('Gtk', '3.0')
from gi.repository import Gtk
sel_modes = {'NONE':Gtk.SelectionMode.NONE, 
 'SINGLE':Gtk.SelectionMode.SINGLE, 
 'BROWSE':Gtk.SelectionMode.BROWSE, 
 'MULTIPLE':Gtk.SelectionMode.MULTIPLE}
sort_types = {'ASCENDING':Gtk.SortType.ASCENDING, 
...
def _get_default_column(title, rend, data_func=None, spacing=0, visible=True, resizable=True, sizing=1, fixed_width=-1, min_width=-1, max_width=-1, expand=True, clickable=False, alignment=0.0, reorderable=False, sort_column_id=-1, sort_indicator=False, sort_order='ASCENDING', col_attrs={}):
    """
...
def new_text_column(title, edited_callback=None, data_func=None, spacing=0, visible=True, resizable=True, sizing=1, fixed_width=-1, min_width=-1, max_width=-1, expand=True, clickable=False, alignment=None, reorderable=False, sort_column_id=-1, sort_indicator=False, sort_order='ASCENDING', **kwargs):
    """
...
def new_pb_column(title, data_func=None, spacing=0, visible=True, resizable=True, sizing=1, fixed_width=-1, min_width=-1, max_width=-1, expand=True, clickable=False, alignment=None, reorderable=False, sort_column_id=-1, sort_indicator=False, sort_order='ASCENDING', **kwargs):
    """
...
def new_toggle_column(title, data_func=None, toggled_callback=None, spacing=0, visible=True, resizable=True, sizing=1, fixed_width=-1, min_width=-1, max_width=-1, expand=True, clickable=False, alignment=None, reorderable=False, sort_column_id=-1, sort_indicator=False, sort_order='ASCENDING', **kwargs):
    """
...
def setup_treeview(tv, model, reset=False, on_cursor_changed=None, on_selection_changed=None, sel_mode='SINGLE'):
    """
