...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyxrd/phases/controllers/atom_relation_controllers.py
# Compiled at: 2020-03-07 03:51:50
# Size of source mod 2**32: 11384 bytes
import logging
logger = logging.getLogger(__name__)
import gi
gi.require_version('Gtk', '3.0')
from gi.repository import Gtk, Pango
from pyxrd.generic.views.treeview_tools import new_text_column, new_pb_column, new_combo_column, create_float_data_func, setup_treeview
...
from pyxrd.generic.controllers import DialogController, InlineObjectListStoreController, BaseController
...
class AtomComboMixin(object):
    ...
    def custom_handler(controller, prop, prefix):
        if prop.label in controller.custom_handler_names:
            combo, store = controller.reset_combo_box(prop.label)
...
class EditUnitCellPropertyController(BaseController, AtomComboMixin):
    ...
    custom_handler_names = [
     'prop']
    widget_handlers = {'combo': 'custom_handler'}
...
class ContentsListController(InlineObjectListStoreController):
    ...
    def _reset_treeview(self, tv, model):
        ...
        tv.append_column(new_combo_column('Atoms',
        ...
        tv.append_column(new_text_column('Default contents', text_col=2, xalign=0.0, editable=True,
    ...
    def __init__(self, treemodel_property_name, **kwargs):
        (super(ContentsListController, self).__init__)(treemodel_property_name=treemodel_property_name, 
         enable_import=False, 
         enable_export=False, **kwargs)
...
class EditAtomRelationsController(InlineObjectListStoreController):
    ...
    def _reset_treeview(self, tv, model):
        ...
        col = new_text_column('Name',
          ...
          editable=True,
          edited_callback=(
         self.on_item_cell_edited, (model, model.c_name)),
          resizable=False,
        ...
        col = new_text_column('Value',
          ...
          editable=True,
          edited_callback=(
         self.on_item_cell_edited, (model, model.c_value)),
          resizable=False,
    ...
    def __init__(self, **kwargs):
        (super(EditAtomRelationsController, self).__init__)(enable_import=False, 
         enable_export=False, **kwargs)
