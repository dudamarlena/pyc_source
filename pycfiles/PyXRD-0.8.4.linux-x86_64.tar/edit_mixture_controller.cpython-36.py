...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyxrd/mixture/controllers/edit_mixture_controller.py
...
class EditMixtureController(BaseController):
    ...
    def _add_phase_view(self, phase_slot):
        ...
        self.view.add_phase_slot((self.phases_treemodel), on_phase_delete,
          on_label_changed, on_check_toggled, on_fraction_changed, (self.on_combo_changed),
    ...
    def _add_specimen_view(self, specimen_slot):
        ...
        self.view.add_specimen_slot((self.phases_treemodel), (self.specimens_treemodel),
          on_specimen_delete, on_scale_changed, on_bgs_changed,
          on_specimen_changed, (self.on_combo_changed), scale=(self.model.scales[specimen_slot]),
