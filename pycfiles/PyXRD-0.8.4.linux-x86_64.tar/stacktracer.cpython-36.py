...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyxrd/stacktracer.py
...
def stacktraces():
    ...
    return highlight('\n'.join(code), PythonLexer(), HtmlFormatter(full=False,
      noclasses=True))
...
class TraceDumper(threading.Thread):
    __doc__ = 'Dump stack traces into a given file periodically.'
