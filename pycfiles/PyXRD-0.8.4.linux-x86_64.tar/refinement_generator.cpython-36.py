...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python3.6/dist-packages/pyxrd/scripts/refinement_generator.py
...
import multiprocessing, os, codecs, numpy as np
...
def run(args):
    ...
    if args and args.filename != '':
        ...
        start_solutions_fname = os.path.join(base_path, 'start_solutions %s mixture %s' % (os.path.basename(project_file), mixture_index))
