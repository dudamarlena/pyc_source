...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/arctic/decorators.py
# Compiled at: 2019-12-06 10:13:42
# Size of source mod 2**32: 2672 bytes
import logging, sys
from functools import wraps
from time import sleep
from pymongo.errors import AutoReconnect, OperationFailure, DuplicateKeyError, ServerSelectionTimeoutError, BulkWriteError
