...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/arctic/scripts/arctic_init_library.py
# Compiled at: 2019-02-02 17:02:31
# Size of source mod 2**32: 2353 bytes
from __future__ import print_function
import argparse, logging, pymongo
...
def main():
    ...
    parser.add_argument('--hashed',
      action='store_true',
      default=False,
      help='Use hashed based sharding. Useful where SYMBOLs share a common prefix (e.g. Bloomberg BBGXXXX symbols) Default: False')
