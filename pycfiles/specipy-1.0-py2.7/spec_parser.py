...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/specipy/spec_parser.py
# Compiled at: 2015-06-10 03:07:47
...
class SpecParser(object):
    ...
    def parse(self):
        ...
        for line in self.file.splitlines():
            ...
            line_number += 1
            if self.multiline_comment_end(line):
                start_ignoring_lines = False
            if start_ignoring_lines:
                continue
