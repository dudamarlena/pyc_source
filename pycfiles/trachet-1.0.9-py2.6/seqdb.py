...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.4-x86_64/egg/trachet/seqdb.py
...
_SEQDB = {' input < <NUL>': 'NUL / Ctrl-@, Ctrl-SP, Ctrl-2', 
   '< <SOH>': 'SOH / Ctrl-A', 
   '< <STX>': 'STX / Ctrl-B', 
   '< <ETX>': 'ETX / Ctrl-C', 
   '< <EOT>': 'EOT / Ctrl-D', 
   ...
   '< CSI >1;1111;0c': 'DA2 Response: VT220 (could be VTE, such as gnome-terminal)', 
   ...
   '< CSI >84;0;0c': 'DA2 Response: could be tmux version>=1.10', 
