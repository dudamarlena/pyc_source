...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/kvadratnet.py
# Compiled at: 2017-03-27 15:17:01
...
__version__ = '0.3.0'
UNITS = [
 '100m', '250m', '1km', '10km', '50km', '100km']
TILE_SIZES = {'100m': 100, '250m': 250, 
   '1km': 1000, 
   '10km': 10000, 
   '50km': 50000, 
   '100km': 100000}
TILE_FACTORS = {'100m': 100, '250m': 10, 
   '1km': 1000, 
   '10km': 10000, 
   '50km': 10000, 
   '100km': 100000}
REGEX = {'100m': '100m_[0-9]{5}_[0-9]{4}', '250m': '250m_[0-9]{6}_[0-9]{5}', 
...
def extent_from_name(name):
    ...
    return TileExtent(tile.easting, tile.northing, tile.easting + tile.size, tile.northing + tile.size)
