...
# Embedded file name: /Library/Python/2.7/site-packages/onitool/toolreg.py
# Compiled at: 2015-09-08 11:55:10
import struct
from . import onifile as oni
import shutil, io, array, os, bisect
from collections import defaultdict
from anyregistration import anyregistration
from PIL import Image
from xndec import xndec
try:
    import png
except:
    png = None
...
class AsusModel:
    ...
    def __init__(self):
        ...
        self.Krgb = (533.9089, 0.0, 321.09951, 0.0, 534.555793, 237.786129, 0.0, 0.0,
                     1.0)
...
def register(args, action, a, b):
    ...
    r = oni.Reader(a)
    w = oni.Writer(b, r.h0)
    modifycolor = action == 'registercolor'
    nidd = None
    nidc = None
    ...
    for primaryframe in primary['data']:
        ...
        if modifycolor:
            ...
            b = io.BytesIO()
            im.save(b, 'JPEG')
            w.addframe(idc, hd['frameid'], args.registersynctime and hd['timestamp'] or hc['timestamp'], b.getvalue())
            ...
            w.addframe(idd, hc['frameid'], args.registersynctime and hc['timestamp'] or hd['timestamp'], ob[0:size])
