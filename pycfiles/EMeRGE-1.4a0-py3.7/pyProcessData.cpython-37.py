...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\ResultDashboard\pyProcessData.py
# Compiled at: 2020-03-15 14:09:51
...
class ProcessData:
    ...
    def __init__(self, Settings, TypePV, DataFolderName='CSVDataFiles'):
        ...
        self.TypePV = TypePV
        self.AssetLevelMetrics = [
         'NVRI', 'LVRI', 'TVRI', 'CRI', 'TE', 'LE', 'TLOF', 'TOG']
    ...
    def SystemLevelData(self):
        ...
        self.SystemLevelMetrics['SALOF_transformer'] = [val if val < 100 else None for val in self.SystemLevelMetrics['SALOF_transformer']]
        ViolationMetrics = [
         'Scenarios', 'x_val', 'SARDI_voltage', 'SARDI_line', 'SARDI_transformer', 'SARDI_aggregated']
