...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\ResultDashboard\Dashboard\DistMetricTabAdvancedPV.py
# Compiled at: 2020-03-15 13:04:44
# Size of source mod 2**32: 15133 bytes
        ...
        def UpdateAssetMetricOverNetwork(Metric, PVScenario, TimeIndex):
            ...
            return (
             ...
             GeoScatterMap((self.DataObject.x_lines), (self.DataObject.y_lines), x_coordinate, y_coordinate, (self.DataObject.initial_x),
               (self.DataObject.initial_y), marker=(self.MarkerDict(AggregatedAssetData['Values'].tolist(), Metric))).layout())