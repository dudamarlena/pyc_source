...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tipfyrecipes/__init__.py
    ...
    for name in names:
        ...
        try:
            if symlinks and os.path.islink(srcname):
                ...
                copytree(srcname, dstname, dirname, symlinks, ignore, logger=logger)
            elif os.path.isfile(dstname):
                if logger:
                    logger.info('%r already exists and will not be created.' % dstname)
            else:
