...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/iscorpio/plonepm/tests/testUtils.py
# Compiled at: 2010-04-14 23:37:10
"""
...
class TestRevision2Link(TestCase):
    ...
    def testRevision2Link(self):
        ...
        sf_result = "this is a test revision <a href='%s?view=rev&revision=%s'>%s</a>" % (sf_base_url, '123', 'r123')
