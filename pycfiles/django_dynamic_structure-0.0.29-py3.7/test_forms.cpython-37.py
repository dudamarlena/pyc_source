...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dyn_struct/tests/test_forms.py
...
class DynamicStructureFormTest(TestCase):
    ...
    def test_init_with_dynamic_template(self):
        test_template = 'test_template'
        test_form = modelform_factory((models.DynamicStructure), form=DynamicStructureForm, fields=('name', ))
        form = test_form(dynamic_structure_name=(self.dyn_struct.name), dynamic_template=test_template)
