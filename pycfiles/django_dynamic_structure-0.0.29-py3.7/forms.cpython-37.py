...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dyn_struct/forms.py
...
class DynamicWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        context = Context({'structure':self.dynamic_structure, 
         'prefix':name, 
         'value':data, 
...
class DynamicField(forms.Field):
    ...
    def clean(self, data, initial=None):
        ...
        dynamic_data = {'structure':self.widget.dynamic_structure.name, 
...
class DynamicStructureForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.id and self.instance.data:
            ...
            dynamic_structure = models.DynamicStructure.standard_objects.get(version=version,
