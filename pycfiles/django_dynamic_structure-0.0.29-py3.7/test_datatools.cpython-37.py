...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dyn_struct/tests/test_datatools.py
...
class DatatoolsTest(TestCase):
    ...
    def test_check_class_arguments_with_one_error_key(self):
        ...
        self.assertIn('{0} - неизвестные ключи для {1}. Выбирайте необходимые из'.format(error_key, class_obj), str(ex.exception))
