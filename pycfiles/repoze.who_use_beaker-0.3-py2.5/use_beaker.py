...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/repoze/who/plugins/use_beaker.py
# Compiled at: 2009-12-08 09:36:11
import os
...
class UseBeakerPlugin(object):
    ...
    def __init__(self, key_name='repoze.who.tkt', session_name='beaker.session', delete_on_logout=False):
...
def make_plugin(key_name='repoze.who.tkt', session_name='beaker.session', delete_on_logout=False):
    return UseBeakerPlugin(key_name, session_name, delete_on_logout)