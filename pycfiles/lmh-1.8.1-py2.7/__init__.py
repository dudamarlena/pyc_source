...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/lmh_core/__init__.py
# Compiled at: 2015-02-05 08:26:11
import os, sys, imp, subprocess, argparse, shutil, signal, imp
...
def run_lmh_legacy(install):
    try:
        args = [
         sys.executable, install + '/bin/lmh'] + sys.argv[1:]
