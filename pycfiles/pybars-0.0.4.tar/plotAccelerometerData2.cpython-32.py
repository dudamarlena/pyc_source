...
# Embedded file name: build/bdist.linux-armv6l/egg/barobo/demo/with_BaroboCtx_sfp/plotAccelerometerData2.py
...
class RecordAccelData(threading.Thread):
    ...
    def plot(self):
        pylab.plot(self.times, self.accs)
        pylab.show()
