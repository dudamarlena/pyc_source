...
# [GCC 8.4.0]
# Embedded file name: /Users/maximebeauchemin/code/superset/superset/examples/world_bank.py
# Compiled at: 2019-11-14 17:12:06
# Size of source mod 2**32: 16105 bytes
...
from .helpers import config, Dash, EXAMPLES_FOLDER, get_example_data, get_slice_json, merge_slice, misc_dash_slices, Slice, TBL, update_slice_ids
...
def load_world_bank_health_n_pop(only_metadata=False, force=False):
    ...
    for m in metrics:
        if not any(col.metric_name == m for col in tbl.metrics):
            ...
            tbl.metrics.append(SqlMetric(metric_name=m, expression=f"{aggr_func}({col})"))
