...
# [GCC 8.4.0]
# Embedded file name: /Users/maximebeauchemin/code/superset/superset/migrations/versions/bebcf3fed1fe_convert_dashboard_v1_positions.py
...
def get_chart_holder(position):
    ...
    if code is not None:
        ...
        return {'type':CHART_TYPE,  'id':'DASHBOARD_CHART_TYPE-{}'.format(generate_id()), 
         'children':[],  'meta':{'width':width, 
