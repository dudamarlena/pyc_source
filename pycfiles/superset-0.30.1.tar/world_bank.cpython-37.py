...
# [GCC 8.4.0]
# Embedded file name: /Users/maximebeauchemin/code/superset/superset/data/world_bank.py
...
from .helpers import config, Dash, DATA_FOLDER, get_example_data, get_slice_json, merge_slice, misc_dash_slices, Slice, TBL, update_slice_ids
...
def load_world_bank_health_n_pop():
    ...
    for m in metrics:
        if not any((col.metric_name == m for col in tbl.metrics)):
            tbl.metrics.append(SqlMetric(metric_name=m,
