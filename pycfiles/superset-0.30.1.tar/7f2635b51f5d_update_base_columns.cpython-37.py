...
# [GCC 8.4.0]
# Embedded file name: /Users/maximebeauchemin/code/superset/superset/migrations/versions/7f2635b51f5d_update_base_columns.py
...
def upgrade():
    ...
    with op.batch_alter_table('table_columns', naming_convention=conv) as (batch_op):
        batch_op.create_unique_constraint('uq_table_columns_column_name', [
...
def downgrade():
    ...
    with op.batch_alter_table('table_columns', naming_convention=conv) as (batch_op):
        batch_op.drop_constraint((generic_find_uq_constraint_name('table_columns', {
         'column_name', 'table_id'}, insp) or 'uq_table_columns_column_name'),
          type_='unique')
    with op.batch_alter_table('table_columns') as (batch_op):
        batch_op.alter_column('column_name',
          existing_type=(String(255)),
