...
# [GCC 8.4.0]
# Embedded file name: /Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/site-packages/simtext/computetext.py
# Compiled at: 2020-04-18 21:41:37
...
class similarity(object):
    ...
    def compute(self, text1, text2):
        ...
        data = {'Sim_Cosine':self.cosine_similarity(vec1, vec2), 
