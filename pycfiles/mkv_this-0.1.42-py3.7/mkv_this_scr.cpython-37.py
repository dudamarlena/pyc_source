...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mkv_this/mkv_this_scr.py
# Compiled at: 2020-04-25 17:47:16
...
"""
import os, re, requests, markovify, sys, argparse, html2text, bs4
...
def parse_the_args():
    ...
    parser.add_argument('outfile', nargs='?', default='./mkv-scr-output.txt', help='the file to save to. if the file is used more than once, subsequent literature will be appended to it. defaults to ./mkv-output.txt.')
    ...
    parser.add_argument('-f', '--well-formed', help="enforce 'well_formed': discard sentences containing []{}()'' from the markov model. use if output is filthy.", action='store_true')
