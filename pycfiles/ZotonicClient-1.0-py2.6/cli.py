...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/zclient/cli.py
# Compiled at: 2011-03-06 06:05:06
...
class CLIController(object):
    ...
    def do_del_app(self, id):
        if id not in self.registry.getApps():
    ...
    def do_del_client(self, id):
        if id not in self.registry.getClients():
