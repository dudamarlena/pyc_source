...
# [GCC 8.4.0]
# Embedded file name: /Users/duranton/Documents/CERFACS/CODES/arnica/src/arnica/phys/yk_from_phi.py
# Compiled at: 2020-04-13 05:57:17
...
def yk_from_phi(phi, c_x, h_y):
    ...
    *Return the mass fraction of elements from a fuel aspect ratio and stoechio element coeff.*
    ...
    if phi == 0.0:
        ...
        y_k['fuel'] = 1.0 / (1.0 + (1.0 + 3.76 * (mass_molar['N2'] / mass_molar['O2'])) * (y_o2_fuel_sto / phi))
    y_air = 1 - y_k['fuel']
