...
# [GCC 8.4.0]
# Embedded file name: <xlwings_pro-1.2.2>/xlwings/rest/api.py
# Compiled at: 2020-03-09 05:37:56
import sys, logging
from werkzeug.routing import PathConverter
import xlwings as xw
from xlwings.rest.serializers import serialize_book, serialize_sheet, serialize_app, serialize_chart, serialize_name, serialize_picture, serialize_range, serialize_shape
try:
    import flask
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/range', methods=['GET'])
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/range/<address>', methods=['GET'])
def get_range_address(address, sheet_name_or_ix, book_name_or_ix=None, fullname_or_name=None, pid=None):
    book = get_book_object(fullname_or_name, book_name_or_ix, pid)
    sheet = get_sheet_object(book, sheet_name_or_ix)
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/names', methods=['GET'])
def get_sheet_names(sheet_name_or_ix, book_name_or_ix=None, fullname_or_name=None, pid=None):
    book = get_book_object(fullname_or_name, book_name_or_ix, pid)
    sheet = get_sheet_object(book, sheet_name_or_ix)
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/names/<sheet_scope_name>', methods=['GET'])
def get_sheet_name(sheet_name_or_ix, sheet_scope_name, book_name_or_ix=None, fullname_or_name=None, pid=None):
    book = get_book_object(fullname_or_name, book_name_or_ix, pid)
    sheet = get_sheet_object(book, sheet_name_or_ix)
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/names/<sheet_scope_name>/range', methods=['GET'])
def get_sheet_name_range(sheet_name_or_ix, sheet_scope_name, book_name_or_ix=None, fullname_or_name=None, pid=None):
    book = get_book_object(fullname_or_name, book_name_or_ix, pid)
    sheet = get_sheet_object(book, sheet_name_or_ix)
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/charts', methods=['GET'])
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/charts/<chart_name_or_ix>', methods=['GET'])
def get_chart(sheet_name_or_ix, chart_name_or_ix, book_name_or_ix=None, fullname_or_name=None, pid=None):
    book = get_book_object(fullname_or_name, book_name_or_ix, pid)
    sheet = get_sheet_object(book, sheet_name_or_ix)
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/shapes', methods=['GET'])
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/shapes/<shape_name_or_ix>', methods=['GET'])
def get_shape(sheet_name_or_ix, shape_name_or_ix, book_name_or_ix=None, fullname_or_name=None, pid=None):
    book = get_book_object(fullname_or_name, book_name_or_ix, pid)
    sheet = get_sheet_object(book, sheet_name_or_ix)
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/pictures', methods=['GET'])
...
@api.route('/book/<path:fullname_or_name>/sheets/<sheet_name_or_ix>/pictures/<picture_name_or_ix>', methods=['GET'])
