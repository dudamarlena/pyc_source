...
# [GCC 8.4.0]
# Embedded file name: <xlwings_pro-1.2.2>/xlwings/cli.py
...
def addin_status(args):
    ...
    elif os.path.isfile(addin_path):
...
def main():
    ...
    restapi_parser = subparsers.add_parser('restapi', help='Runs the xlwings REST API via Flask 1.2.2 server.')
