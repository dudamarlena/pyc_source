...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ml_markdown/templatetags/ml_markdown.py
...
import misaka, bleach
from ml_markdown.utils.default_renderer import DefaultRenderer
register = template.Library()
parse = misaka.Markdown(DefaultRenderer(), apps.get_app_config('ml_markdown').misaka_extensions)
...
def clean(value, white_list=None):
    ...
    output = bleach.clean(text=value, tags=tags, attributes=attributes)
