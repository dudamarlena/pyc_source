...
# [GCC 8.4.0]
# Embedded file name: /home/resteve/virtualenv/nan38mifarma/python-correos/correos/api.py
# Compiled at: 2017-11-15 06:56:22
from correos.utils import correos_url
from xml.dom.minidom import parseString
import urllib2, ssl, base64, os, socket, datetime, genshi, genshi.template
...
class API(object):
    ...
    """
    __slots__ = ('url', 'username', 'password', 'code', 'timeout')
    ...
    def connect(self, xml, action):
        ...
        try:
            response = urllib2.urlopen(request, timeout=self.timeout, context=ssl._create_unverified_context())
    ...
    def test_connection(self):
        ...
        vals = {'now': datetime.datetime.now().strftime('%d-%m-%Y %H:%M:%S')}
    ...
    def oficinas(self, zip):
        ...
        for item in dom.getElementsByTagName('item'):
            oficinas.append({'code': item.getElementsByTagName('ns-980841924:unidad')[0].firstChild.data, 
