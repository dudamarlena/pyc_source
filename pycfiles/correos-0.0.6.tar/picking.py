...
# [GCC 8.4.0]
# Embedded file name: /home/resteve/virtualenv/nan38mifarma/python-correos/correos/picking.py
# Compiled at: 2018-03-16 06:07:30
...
loader = template.TemplateLoader(os.path.join(os.path.dirname(__file__), 'template'), auto_reload=True)
