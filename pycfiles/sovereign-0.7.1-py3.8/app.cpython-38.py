...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sovereign/app.py
...
from sovereign.middlewares import RequestContextLogMiddleware, LoggingMiddleware, get_request_id, ScheduledTasksMiddleware
try:
    import sentry_sdk
    ...
    def init_app() -> FastAPI:
        ...
        application = FastAPI(title='Sovereign',
