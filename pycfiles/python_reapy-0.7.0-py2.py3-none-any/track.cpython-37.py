...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\track\track.py
# Compiled at: 2020-05-09 09:40:15
# Size of source mod 2**32: 19066 bytes
import reapy
...
class Track(ReapyObject):
    ...
    def __init__(self, id, project=None):
        ...
        if isinstance(id, int):
            ...
            if isinstance(id, str):
                if not id.startswith('(MediaTrack*)'):
                    name = id
    ...
    def has_valid_id(self):
        ...
        if self._project is None:
            return any((RPR.ValidatePtr2(p.id, pointer, name) for p in reapy.get_projects()))
    ...
    def midi_hash(self, notes_only=False):
        ...
        str
        """
        return RPR.MIDI_GetTrackHash(self.id, notes_only, 'hash', 1048576)[3]
    ...
    @property
    def receives(self):
        return [reapy.Send(self, i, type='receive') for i in range(self.n_receives)]
