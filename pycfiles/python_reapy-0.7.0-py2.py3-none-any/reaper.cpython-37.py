...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\reaper\reaper.py
...
def open_project(filepath, in_new_tab=False, make_current_project=True):
    ...
    if not make_current_project:
        ...
        make_current_project or current_project.make_current_project()
    return project
