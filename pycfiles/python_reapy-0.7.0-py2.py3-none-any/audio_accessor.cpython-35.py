...
# [GCC 8.4.0]
# Embedded file name: /media/despres/MAIN/Users/despres/Desktop/reaper/scripts/reapy/reapy/core/audio_accessor.py
# Compiled at: 2019-03-03 04:49:25
...
class AudioAccessor(ReapyObject):
    ...
    def get_samples(self, start, n_samples_per_channel, n_channels=1, sample_rate=44100):
        """
        ...
        """
        buffer = [
         0] * n_channels * n_samples_per_channel
        samples = RPR.GetAudioAccessorSamples(self.id, sample_rate, n_channels, start, n_samples_per_channel, buffer)[1]
        return samples
