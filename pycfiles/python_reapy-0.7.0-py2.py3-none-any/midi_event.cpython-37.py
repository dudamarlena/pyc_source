...
# [GCC 8.4.0]
# Embedded file name: C:\Users\despres\Desktop\reaper\scripts\reapy\reapy\core\item\midi_event.py
# Compiled at: 2020-05-08 11:04:14
...
class MIDIEvent(ReapyObject):
    __doc__ = 'Abstract class for MIDI events.'
    ...
    @reapy.inside_reaper()
    def set(self, message=None, position=None, selected=None, muted=None, unit='seconds', sort=True):
        """
        ...
        RPR.MIDI_SetEvt(take.id, self.index, selected, muted, position, message, len(message), not sort)
...
class CC(MIDIEvent):
    ...
    def channel(self):
        ...
        CC.infos
            ...
            a CC.
        """
        return RPR.MIDI_GetCC(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[7]
    ...
    def channel_message(self):
        ...
        CC.infos
            ...
            a CC.
        """
        return RPR.MIDI_GetCC(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[6]
    ...
    def infos(self):
        ...
        :type: dict
        """
        res = list(RPR.MIDI_GetCC(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0))[3:]
        res[0] = bool(res[0])
        res[1] = bool(res[1])
        res[2] = self.parent.ppq_to_time(res[2])
        res[-2] = (res[(-2)], res[(-1)])
        res.pop()
        keys = ('selected', 'muted', 'position', 'channel_message', 'channel', 'messages')
    ...
    def messages(self):
        ...
        CC.infos
            ...
            a CC.
        """
        return RPR.MIDI_GetCC(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[-2:]
    ...
    def muted(self):
        ...
        CC.infos
            ...
            a CC.
        """
        return bool(RPR.MIDI_GetCC(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[4])
    ...
    def selected(self):
        ...
        CC.infos
            ...
            a CC.
        """
        return bool(RPR.MIDI_GetCC(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[3])
...
class Note(MIDIEvent):
    ...
    def channel(self):
        ...
        Note.infos
            ...
            a Note.
        """
        return RPR.MIDI_GetNote(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[7]
    ...
    def infos(self):
        ...
        :type: dict
        """
        res = list(RPR.MIDI_GetNote(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0))[3:]
        res[0] = bool(res[0])
        res[1] = bool(res[1])
        res[2] = self.parent.ppq_to_time(res[2])
        res[3] = self.parent.ppq_to_time(res[3])
        keys = ('selected', 'muted', 'start', 'end', 'channel', 'pitch', 'velocity')
        return {k:r for k, r in zip(keys, res)}
    ...
    def muted(self):
        ...
        Note.infos
            ...
            a Note.
        """
        return bool(RPR.MIDI_GetNote(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[4])
    ...
    def pitch(self):
        ...
        Note.infos
            ...
            a Note.
        """
        return RPR.MIDI_GetNote(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[8]
    ...
    def selected(self):
        ...
        Note.infos
            ...
            a Note.
        """
        return bool(RPR.MIDI_GetNote(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[3])
    ...
    def velocity(self):
        ...
        Note.infos
            ...
            a Note.
        """
        return RPR.MIDI_GetNote(self.parent.id, self.index, 0, 0, 0, 0, 0, 0, 0)[9]
