...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/alpha1p/robot/control.py
# Compiled at: 2020-04-14 08:04:08
# Size of source mod 2**32: 3865 bytes
import usb, pickle, time, pandas as pd, multiprocessing, serial
__all__ = [
 'establish_usb_connection', 'establish_bt_connection', 'execute_csv_only', 'conn_and_execute_csv',
 'play_mp3', 'dance_with_song']

def establish_usb_connection(Vendor=1155, Product=22352):
