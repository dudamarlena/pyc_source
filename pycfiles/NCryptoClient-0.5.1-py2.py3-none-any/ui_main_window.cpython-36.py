...
# [GCC 8.4.0]
# Embedded file name: D:\dev\PyCharm Projects\NCryptoClient\NCryptoClient\UI\ui_main_window.py
...
class UiMainWindow(QMainWindow):
    ...
    def init_chat_widgets(self):
        ...
        self._center_window()
        _translate = QCoreApplication.translate
        self.select_chat_st.setText(_translate('NCryptoClient', 'Please select a chat to start messaging'))
