...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/photo-gen/__main__.py
# Compiled at: 2018-04-19 07:01:35
# Size of source mod 2**32: 8338 bytes
import os, markdown, sys, yaml, shutil
from markdownify import markdownify as md
from PIL import Image
from jinja2 import Environment, FileSystemLoader
default = {'base':"<!doctype html><html lang='en'><head><meta charset='utf-8'><link rel='stylesheet' href='/style.css'/><title></title></head><body>{% block content %}{% endblock %}</body></html>", 
...
def validate_directory(simple=True):
    ...
    if simple is True:
        ...
        return {'config':config_exists, 
         'photos':photos_exists,  'template':template_exists}
    ...
    if not validate_directory():
        ...
        if directory['config'] is False:
            with open(workingdir + '/config.yml', 'w') as (f):
                ...
                f.close()
    elif directory['photos'] is False:
