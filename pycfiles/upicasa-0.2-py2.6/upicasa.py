...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/upicasa.py
# Compiled at: 2010-03-17 08:38:58
...
"""
import os, sys, getopt, getpass, ConfigParser, gdata.photos.service, gdata.media, gdata.geo
...
def get_auth():
    ...
    if not os.path.exists(password_path):
        ...
        if not ans or ans[0] not in 'Nn':
            ...
            os.fchmod(password_file.fileno(), 448)
...
def main():
    ...
    for photo in args:
        ...
        gd_client.InsertPhotoSimple(album_url, filename, title, photo, content_type='image/jpeg')
