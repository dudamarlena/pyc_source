...
# [GCC 8.4.0]
# Embedded file name: /home/altus/gitArchives/django/_instances/django-formfactory/formfactory/tests/test_validators.py
...
class ValidatorTestCase(TestCase):
    ...
    def test_action(self):
        validator = validators.get_registered_validators()[self.dummy_validator]
    ...
    def test_form_field_validation(self):
        ...
        self.assertRaises(ValidationError, lambda : bound_form.fields['number'].run_validators(3))

    def test_registry(self):
        self.assertIn(self.dummy_validator, validators.get_registered_validators())

    def test_unregistry(self):
        validator = validators.get_registered_validators()[self.dummy_validator]
        validators.unregister(validator)
        self.assertNotIn(self.dummy_validator, validators.get_registered_validators())