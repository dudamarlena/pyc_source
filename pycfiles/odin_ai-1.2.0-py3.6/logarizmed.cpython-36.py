...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/odin/bay/distributions/logarizmed.py
# Compiled at: 2019-09-17 08:47:17
# Size of source mod 2**32: 3226 bytes
from __future__ import absolute_import, division, print_function
import numpy as np, tensorflow as tf
from tensorflow_probability.python.bijectors.exp import Exp
from tensorflow_probability.python.distributions import LogNormal, TransformedDistribution, Uniform
from tensorflow_probability.python.internal import dtype_util
__all__ = [
 'LogUniform']

class LogUniform(TransformedDistribution):
    __doc__ = 'The log-uniform distribution (i.e. the logarithm of the\n  samples from this distribution are Uniform) '

    def __init__(self, low=0.0, high=1.0, validate_args=False, allow_nan_stats=True, name='LogUniform'):
    ...
    """
        ...
        with tf.name_scope(name) as (name):
            ...
            super(LogUniform, self).__init__(distribution=Uniform(low=tf.convert_to_tensor(value=low, name='low', dtype=dtype),
