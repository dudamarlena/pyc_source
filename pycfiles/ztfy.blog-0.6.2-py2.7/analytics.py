...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ztfy/blog/defaultskin/viewlets/google/analytics.py
...
class GoogleAnalyticsContentProvider(ContentProviderBase):
