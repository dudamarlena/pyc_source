...
# Embedded file name: /Users/mardochee.macxis/Projects/Python/flask-pilot/pylot/cmd.py
# Compiled at: 2015-05-30 15:14:30
__doc__ = '\nPylot\n\nCommand line tool\n\npylot -c project_name\n\n'
import os, argparse, pkg_resources, pylot
PACKAGE = pylot
CWD = os.getcwd()
...
def create_project(project_name, template='default'):
    ...
    if not os.path.isdir(APPLICATION_DATA_DIR):
        os.makedirs(APPLICATION_DATA_DIR)
    if not os.path.isdir(APPLICATION_UPLOAD_DIR):
        os.makedirs(APPLICATION_UPLOAD_DIR)
...
def main():
    ...
    parser.add_argument('-c', '--create', help='To create a new project. [ie: pylot -c www]')
