...
# [GCC 8.4.0]
# Embedded file name: /home/j/git/lab.gsi/senpy/senpy/senpy/plugins/postprocessing/emotion/centroids.py
# Compiled at: 2019-07-04 11:26:55
...
class CentroidConversion(EmotionConversionPlugin):
    ...
    def convert(self, emotionSet, fromModel, toModel, params):
        ...
        if fromModel == cf and toModel == ct:
            ...
            if fromModel == ct and toModel == cf:
