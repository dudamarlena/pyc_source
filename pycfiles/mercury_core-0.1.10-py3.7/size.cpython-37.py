...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mercury/common/helpers/size.py
    ...
    def _convert(self, value):
        if isinstance(value, Size):
            ...
            if not isinstance(value, str):
                raise SizeObjectValError('Value is not in a format I can understand')
            if value.isdigit():
                return int(value)
