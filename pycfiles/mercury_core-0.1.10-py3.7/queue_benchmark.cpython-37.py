...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/rpc/benchmarking/queue_benchmark.py
...
def concurrent_test(c, reqs, use_async):
    ...
    n = round(reqs / c)
    log.info(f"Starting test [Concurrency: {c}  Requests: {reqs} Async: {use_async} ]")
