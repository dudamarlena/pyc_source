...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/mercury/inventory/db.py
# Compiled at: 2019-01-15 15:48:24
...
class InventoryDBController(object):
    ...
    def query(self, query, extra_projection=None, limit=0, sort='_id', sort_direction=1, offset_id=None):
