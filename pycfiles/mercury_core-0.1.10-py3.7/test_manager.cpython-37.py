...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/common/unit/task_managers/base/test_manager.py
...
class ManagerTest(MercuryCommonUnitTest):
    __doc__ = 'Tests for the mercury.common.task_managers.base.manager'
    ...
    @mock.patch.object((manager.Manager), 'active_workers', new_callable=(mock.PropertyMock))
    ...
    def test_spawn_threads(self, mock_alive, mock_start):
        ...
        self.assertEqual(self.fake_manager.number_of_workers, len(self.fake_manager.workers))
    ...
    def test_manage(self, mock_spawn_threads, mock_kill):
        ...
        """
        mock_spawn_threads.side_effect = [
