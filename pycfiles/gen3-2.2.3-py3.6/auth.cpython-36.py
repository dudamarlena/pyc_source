...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/gen3/auth.py
...
class Gen3Auth(AuthBase):
        ...
        if not refresh_file:
            ...
            if refresh_file:
                try:
                    ...
                    raise ValueError("Couldn't load your refresh token file: {}\n{}".format(self._refresh_file, str(e)))
    ...
    def _get_auth_value(self):
        ...
        if not self._access_token:
            ...
            try:
                self._access_token = requests.post(auth_url,
                  json=(self._refresh_token)).json()['access_token']
            except Exception as e:
                raise Gen3AuthError('Failed to authenticate to {}\n{}'.format(auth_url, str(e)))
