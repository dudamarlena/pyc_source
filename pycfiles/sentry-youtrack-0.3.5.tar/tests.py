...
# [GCC 8.4.0]
# Embedded file name: /Users/adambogdal/git/sentry-youtrack/sentry_youtrack/tests.py
# Compiled at: 2015-02-07 04:00:47
...
class YouTrackProjectFormTest(TestCase):
    ...
    def setUp(self):
        self.youtrack_fields = [{'type': 'float', 'name': 'f1', 'values': None}, {'type': 'integer', 'name': 'f2', 'values': None}, {'type': 'date', 'name': 'f3', 'values': None}, {'type': 'string', 'name': 'f4', 'values': None}, {'type': 'enum[1]', 'name': 'f5', 'values': ['t1', 't2', 't3']}, {'type': 'state[1]', 'name': 'f6', 'values': ['t4', 't5', 't6']}, {'type': 'version[*]', 'name': 'f7', 'values': ['t7', 't8', 't9']}]
        return
    ...
    def test_do_not_build_choice_field_without_value(self):
        fields = [{'type': 'version[*]', 'name': 'f8', 'values': None}, {'type': 'version[1]', 'name': 'f9', 'values': ''}, {'type': 'string', 'name': 'f10', 'values': None}]
    ...
    def test_project_fields_values(self):
        data = {'field_1': 33.0, 
           ...
           'field_7': [
                     't7', 't9']}
        expected_result = {self.youtrack_fields[0]['name']: 33.0, 
