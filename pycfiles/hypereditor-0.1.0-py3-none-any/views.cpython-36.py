...
# [GCC 8.4.0]
# Embedded file name: /Users/shimul/Projects/django-hyper-editor/hypereditor/views.py
# Compiled at: 2019-04-10 07:00:02
...
class AuthMixin(UserPassesTestMixin, LoginRequiredMixin):
    __doc__ = 'Helper mixin for authentication on hyper editor urls'
...
class EditorView(AuthenticationMixin, TemplateView):
    __doc__ = 'View for hyper editor inside iframe'
...
class PreviewView(AuthenticationMixin, TemplateView):
    __doc__ = 'View for preview of a single block'
    http_method_names = [
     'post']
...
class GenerateBlock(AuthenticationMixin, TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        return self.render_to_response(context={'blocks': get_simpler_blocks()})