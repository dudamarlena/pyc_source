...
# Embedded file name: ./CosPropertyService_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 51629 bytes
...
_0_CosPropertyService = omniORB.openModule('CosPropertyService', '/tmp/corba/omni/share/idl/omniORB/COS/CosPropertyService.idl')
_0_CosPropertyService__POA = omniORB.openModule('CosPropertyService__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosPropertyService.idl')
...
_0_CosPropertyService._d_PropertyModeType = (
 omniORB.tcInternal.tv_enum, _0_CosPropertyService.PropertyModeType._NP_RepositoryId, 'PropertyModeType', _0_CosPropertyService.PropertyModeType._items)
...
del PropertyTypes
_0_CosPropertyService._d_PropertyNamesIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPropertyService/PropertyNamesIterator:1.0', 'PropertyNamesIterator')
...
_0_CosPropertyService._d_PropertiesIterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPropertyService/PropertiesIterator:1.0', 'PropertiesIterator')
omniORB.typeMapping['IDL:omg.org/CosPropertyService/PropertiesIterator:1.0'] = _0_CosPropertyService._d_PropertiesIterator
_0_CosPropertyService._d_PropertySetFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPropertyService/PropertySetFactory:1.0', 'PropertySetFactory')
omniORB.typeMapping['IDL:omg.org/CosPropertyService/PropertySetFactory:1.0'] = _0_CosPropertyService._d_PropertySetFactory
_0_CosPropertyService._d_PropertySetDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPropertyService/PropertySetDef:1.0', 'PropertySetDef')
omniORB.typeMapping['IDL:omg.org/CosPropertyService/PropertySetDef:1.0'] = _0_CosPropertyService._d_PropertySetDef
_0_CosPropertyService._d_PropertySet = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPropertyService/PropertySet:1.0', 'PropertySet')
...
_0_CosPropertyService._d_ExceptionReason = (
 omniORB.tcInternal.tv_enum, _0_CosPropertyService.ExceptionReason._NP_RepositoryId, 'ExceptionReason', _0_CosPropertyService.ExceptionReason._items)
...
del _objref_PropertySetFactory
...
class PropertySetFactory(PortableServer.Servant):
    ...
    _omni_op_d = {'create_propertyset':_0_CosPropertyService.PropertySetFactory._d_create_propertyset, 
     'create_constrained_propertyset':_0_CosPropertyService.PropertySetFactory._d_create_constrained_propertyset,  'create_initial_propertyset':_0_CosPropertyService.PropertySetFactory._d_create_initial_propertyset}
...
del PropertySetFactory
__name__ = 'CosPropertyService'
_0_CosPropertyService._d_PropertySetDefFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPropertyService/PropertySetDefFactory:1.0', 'PropertySetDefFactory')
...
PropertySetDefFactory._d_create_constrained_propertysetdef = (
 (
...
del _objref_PropertySetDefFactory
__name__ = 'CosPropertyService__POA'
...
class PropertySetDefFactory(PortableServer.Servant):
    ...
    _omni_op_d = {'create_propertysetdef':_0_CosPropertyService.PropertySetDefFactory._d_create_propertysetdef, 
     'create_constrained_propertysetdef':_0_CosPropertyService.PropertySetDefFactory._d_create_constrained_propertysetdef,  'create_initial_propertysetdef':_0_CosPropertyService.PropertySetDefFactory._d_create_initial_propertysetdef}
...
PropertyNamesIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosPropertyService/PropertyNames:1.0']), None)
...
del _objref_PropertyNamesIterator
__name__ = 'CosPropertyService__POA'
...
class PropertyNamesIterator(PortableServer.Servant):
    ...
    _omni_op_d = {'reset':_0_CosPropertyService.PropertyNamesIterator._d_reset, 
     'next_one':_0_CosPropertyService.PropertyNamesIterator._d_next_one,  'next_n':_0_CosPropertyService.PropertyNamesIterator._d_next_n,  'destroy':_0_CosPropertyService.PropertyNamesIterator._d_destroy}
...
PropertiesIterator._d_next_n = (
 (
  omniORB.tcInternal.tv_ulong,), (omniORB.tcInternal.tv_boolean, omniORB.typeMapping['IDL:omg.org/CosPropertyService/Properties:1.0']), None)
...
del _objref_PropertiesIterator
__name__ = 'CosPropertyService__POA'
...
class PropertiesIterator(PortableServer.Servant):
    ...
    _omni_op_d = {'reset':_0_CosPropertyService.PropertiesIterator._d_reset, 
     'next_one':_0_CosPropertyService.PropertiesIterator._d_next_one,  'next_n':_0_CosPropertyService.PropertiesIterator._d_next_n,  'destroy':_0_CosPropertyService.PropertiesIterator._d_destroy}
