...
# Embedded file name: build/bdist.linux-x86_64/egg/ant/core/node.py
# Compiled at: 2011-10-07 13:56:21
import time, thread, uuid
...
class NetworkKey(object):
    ...
    def __init__(self, name=None, key='\x00\x00\x00\x00\x00\x00\x00\x00'):
        self.key = key
        if name:
            self.name = name
        else:
