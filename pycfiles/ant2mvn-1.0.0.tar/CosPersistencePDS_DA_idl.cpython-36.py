...
# Embedded file name: ./CosPersistencePDS_DA_idl.py
...
_0_CosPersistencePDS_DA = omniORB.openModule('CosPersistencePDS_DA', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistencePDS_DA.idl')
_0_CosPersistencePDS_DA__POA = omniORB.openModule('CosPersistencePDS_DA__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistencePDS_DA.idl')
...
del DAObjectID
_0_CosPersistencePDS_DA._d_PID_DA = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePDS_DA/PID_DA:1.0', 'PID_DA')
...
PID_DA._d__set_oid = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistencePDS_DA/DAObjectID:1.0'],), (), None)
...
class PID_DA(_0_CosPersistencePID__POA.PID):
    ...
    _omni_op_d = {'_get_oid':_0_CosPersistencePDS_DA.PID_DA._d__get_oid, 
     '_set_oid':_0_CosPersistencePDS_DA.PID_DA._d__set_oid}
...
del PID_DA
__name__ = 'CosPersistencePDS_DA'
_0_CosPersistencePDS_DA._d_DAObject = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePDS_DA/DAObject:1.0', 'DAObject')
...
DAObject._d_dado_same = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistencePDS_DA/DAObject:1.0'],), (omniORB.tcInternal.tv_boolean,), None)
...
del DAObject
del _objref_DAObject
__name__ = 'CosPersistencePDS_DA__POA'

class DAObject(PortableServer.Servant):
    _NP_RepositoryId = _0_CosPersistencePDS_DA.DAObject._NP_RepositoryId
    _omni_op_d = {'dado_same':_0_CosPersistencePDS_DA.DAObject._d_dado_same, 
     'dado_oid':_0_CosPersistencePDS_DA.DAObject._d_dado_oid,  'dado_pid':_0_CosPersistencePDS_DA.DAObject._d_dado_pid,  'dado_remove':_0_CosPersistencePDS_DA.DAObject._d_dado_remove,  'dado_free':_0_CosPersistencePDS_DA.DAObject._d_dado_free}
...
del DAObject
__name__ = 'CosPersistencePDS_DA'
_0_CosPersistencePDS_DA._d_DAObjectFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePDS_DA/DAObjectFactory:1.0', 'DAObjectFactory')
...
del DAObjectFactory
__name__ = 'CosPersistencePDS_DA'
_0_CosPersistencePDS_DA._d_DAObjectFactoryFinder = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePDS_DA/DAObjectFactoryFinder:1.0', 'DAObjectFactoryFinder')
...
DAObjectFactoryFinder._d_find_factory = (
 (
  (
   omniORB.tcInternal.tv_string, 0),), (omniORB.typeMapping['IDL:omg.org/CosPersistencePDS_DA/DAObjectFactory:1.0'],), None)
...
del _objref_DAObjectFactoryFinder
__name__ = 'CosPersistencePDS_DA__POA'
...
del DAObjectFactoryFinder
__name__ = 'CosPersistencePDS_DA'
_0_CosPersistencePDS_DA._d_PDS_DA = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistencePDS_DA/PDS_DA:1.0', 'PDS_DA')
...
PDS_DA._d_set_data = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistencePDS_DA/DAObject:1.0'],), (), None)
...
class PDS_DA(_0_CosPersistencePDS__POA.PDS):
    ...
    _omni_op_d = {'get_data':_0_CosPersistencePDS_DA.PDS_DA._d_get_data, 
     'set_data':_0_CosPersistencePDS_DA.PDS_DA._d_set_data,  'lookup':_0_CosPersistencePDS_DA.PDS_DA._d_lookup,  'get_pid':_0_CosPersistencePDS_DA.PDS_DA._d_get_pid,  'get_object_pid':_0_CosPersistencePDS_DA.PDS_DA._d_get_object_pid,  'data_factories':_0_CosPersistencePDS_DA.PDS_DA._d_data_factories}
