...
# Embedded file name: ./ir_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 129310 bytes
...
__name__ = 'CORBA'
_0_CORBA = omniORB.openModule('CORBA', '/tmp/corba/omni/share/idl/omniORB/ir.idl')
_0_CORBA__POA = omniORB.openModule('CORBA__POA', '/tmp/corba/omni/share/idl/omniORB/ir.idl')
...
_0_CORBA._d_DefinitionKind = (
 omniORB.tcInternal.tv_enum, _0_CORBA.DefinitionKind._NP_RepositoryId, 'DefinitionKind', _0_CORBA.DefinitionKind._items)
...
_0_CORBA._d_IRObject = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/IRObject:1.0', 'IRObject')
...
del IRObject
del _objref_IRObject
__name__ = 'CORBA__POA'

class IRObject(PortableServer.Servant):
    _NP_RepositoryId = _0_CORBA.IRObject._NP_RepositoryId
    _omni_op_d = {'_get_def_kind':_0_CORBA.IRObject._d__get_def_kind, 
     'destroy':_0_CORBA.IRObject._d_destroy}
...
del IRObject
__name__ = 'CORBA'
_0_CORBA._d_Contained = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/Contained:1.0', 'Contained')
omniORB.typeMapping['IDL:omg.org/CORBA/Contained:1.0'] = _0_CORBA._d_Contained
_0_CORBA._d_Repository = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/Repository:1.0', 'Repository')
omniORB.typeMapping['IDL:omg.org/CORBA/Repository:1.0'] = _0_CORBA._d_Repository
_0_CORBA._d_Container = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/Container:1.0', 'Container')
...
class Contained(_0_CORBA.IRObject):
    ...
    _d_Description = _0_CORBA.Contained._d_Description = (
     omniORB.tcInternal.tv_struct, Description, Description._NP_RepositoryId, 'Description', 'kind', omniORB.typeMapping['IDL:omg.org/CORBA/DefinitionKind:1.0'], 'value', omniORB.tcInternal.tv_any)
...
Contained._d__set_id = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/RepositoryId:1.0'],), (), None)
...
del Contained
del _objref_Contained
__name__ = 'CORBA__POA'

class Contained(_0_CORBA__POA.IRObject):
    _NP_RepositoryId = _0_CORBA.Contained._NP_RepositoryId
    _omni_op_d = {'_get_id':_0_CORBA.Contained._d__get_id, 
     '_set_id':_0_CORBA.Contained._d__set_id,  '_get_name':_0_CORBA.Contained._d__get_name,  '_set_name':_0_CORBA.Contained._d__set_name,  '_get_version':_0_CORBA.Contained._d__get_version,  '_set_version':_0_CORBA.Contained._d__set_version,  '_get_defined_in':_0_CORBA.Contained._d__get_defined_in,  '_get_absolute_name':_0_CORBA.Contained._d__get_absolute_name,  '_get_containing_repository':_0_CORBA.Contained._d__get_containing_repository,  'describe':_0_CORBA.Contained._d_describe,  'move':_0_CORBA.Contained._d_move}
...
del Contained
__name__ = 'CORBA'
_0_CORBA._d_ModuleDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ModuleDef:1.0', 'ModuleDef')
omniORB.typeMapping['IDL:omg.org/CORBA/ModuleDef:1.0'] = _0_CORBA._d_ModuleDef
_0_CORBA._d_ConstantDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ConstantDef:1.0', 'ConstantDef')
omniORB.typeMapping['IDL:omg.org/CORBA/ConstantDef:1.0'] = _0_CORBA._d_ConstantDef
_0_CORBA._d_IDLType = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/IDLType:1.0', 'IDLType')
omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'] = _0_CORBA._d_IDLType
_0_CORBA._d_StructDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/StructDef:1.0', 'StructDef')
omniORB.typeMapping['IDL:omg.org/CORBA/StructDef:1.0'] = _0_CORBA._d_StructDef
_0_CORBA._d_UnionDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/UnionDef:1.0', 'UnionDef')
omniORB.typeMapping['IDL:omg.org/CORBA/UnionDef:1.0'] = _0_CORBA._d_UnionDef
_0_CORBA._d_EnumDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/EnumDef:1.0', 'EnumDef')
omniORB.typeMapping['IDL:omg.org/CORBA/EnumDef:1.0'] = _0_CORBA._d_EnumDef
_0_CORBA._d_AliasDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/AliasDef:1.0', 'AliasDef')
omniORB.typeMapping['IDL:omg.org/CORBA/AliasDef:1.0'] = _0_CORBA._d_AliasDef
_0_CORBA._d_InterfaceDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/InterfaceDef:1.0', 'InterfaceDef')
omniORB.typeMapping['IDL:omg.org/CORBA/InterfaceDef:1.0'] = _0_CORBA._d_InterfaceDef
_0_CORBA._d_ValueDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ValueDef:1.0', 'ValueDef')
omniORB.typeMapping['IDL:omg.org/CORBA/ValueDef:1.0'] = _0_CORBA._d_ValueDef
_0_CORBA._d_ValueBoxDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ValueBoxDef:1.0', 'ValueBoxDef')
omniORB.typeMapping['IDL:omg.org/CORBA/ValueBoxDef:1.0'] = _0_CORBA._d_ValueBoxDef
_0_CORBA._d_ExceptionDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ExceptionDef:1.0', 'ExceptionDef')
omniORB.typeMapping['IDL:omg.org/CORBA/ExceptionDef:1.0'] = _0_CORBA._d_ExceptionDef
_0_CORBA._d_NativeDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/NativeDef:1.0', 'NativeDef')
omniORB.typeMapping['IDL:omg.org/CORBA/NativeDef:1.0'] = _0_CORBA._d_NativeDef
_0_CORBA._d_AbstractInterfaceDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/AbstractInterfaceDef:1.0', 'AbstractInterfaceDef')
omniORB.typeMapping['IDL:omg.org/CORBA/AbstractInterfaceDef:1.0'] = _0_CORBA._d_AbstractInterfaceDef
_0_CORBA._d_WstringDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/WstringDef:1.0', 'WstringDef')
omniORB.typeMapping['IDL:omg.org/CORBA/WstringDef:1.0'] = _0_CORBA._d_WstringDef
_0_CORBA._d_FixedDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/FixedDef:1.0', 'FixedDef')
...
class Container(_0_CORBA.IRObject):
    ...
    _d_Description = _0_CORBA.Container._d_Description = (
     omniORB.tcInternal.tv_struct, Description, Description._NP_RepositoryId, 'Description', 'contained_object', omniORB.typeMapping['IDL:omg.org/CORBA/Contained:1.0'], 'kind', omniORB.typeMapping['IDL:omg.org/CORBA/DefinitionKind:1.0'], 'value', omniORB.tcInternal.tv_any)
    _tc_Description = omniORB.tcInternal.createTypeCode(_d_Description)
    omniORB.registerType(Description._NP_RepositoryId, _d_Description, _tc_Description)
...
Container._d_lookup = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/ScopedName:1.0'],), (omniORB.typeMapping['IDL:omg.org/CORBA/Contained:1.0'],), None)
...
del IDLType
__name__ = 'CORBA'
_0_CORBA._d_PrimitiveDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/PrimitiveDef:1.0', 'PrimitiveDef')
omniORB.typeMapping['IDL:omg.org/CORBA/PrimitiveDef:1.0'] = _0_CORBA._d_PrimitiveDef
_0_CORBA._d_StringDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/StringDef:1.0', 'StringDef')
omniORB.typeMapping['IDL:omg.org/CORBA/StringDef:1.0'] = _0_CORBA._d_StringDef
_0_CORBA._d_SequenceDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/SequenceDef:1.0', 'SequenceDef')
omniORB.typeMapping['IDL:omg.org/CORBA/SequenceDef:1.0'] = _0_CORBA._d_SequenceDef
_0_CORBA._d_ArrayDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ArrayDef:1.0', 'ArrayDef')
...
_0_CORBA._d_PrimitiveKind = (
 omniORB.tcInternal.tv_enum, _0_CORBA.PrimitiveKind._NP_RepositoryId, 'PrimitiveKind', _0_CORBA.PrimitiveKind._items)
...
Repository._d_lookup_id = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/RepositoryId:1.0'],), (omniORB.typeMapping['IDL:omg.org/CORBA/Contained:1.0'],), None)
...
ConstantDef._d__set_type_def = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'],), (), None)
...
del ConstantDef
del _objref_ConstantDef
__name__ = 'CORBA__POA'

class ConstantDef(_0_CORBA__POA.Contained):
    _NP_RepositoryId = _0_CORBA.ConstantDef._NP_RepositoryId
    _omni_op_d = {'_get_type':_0_CORBA.ConstantDef._d__get_type, 
     '_get_type_def':_0_CORBA.ConstantDef._d__get_type_def,  '_set_type_def':_0_CORBA.ConstantDef._d__set_type_def,  '_get_value':_0_CORBA.ConstantDef._d__get_value,  '_set_value':_0_CORBA.ConstantDef._d__set_value}
    _omni_op_d.update(_0_CORBA__POA.Contained._omni_op_d)
...
_0_CORBA._d_TypedefDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/TypedefDef:1.0', 'TypedefDef')
...
StructDef._d__set_members = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/StructMemberSeq:1.0'],), (), None)
...
del StructDef
del _objref_StructDef
__name__ = 'CORBA__POA'

class StructDef(_0_CORBA__POA.TypedefDef, _0_CORBA__POA.Container):
    _NP_RepositoryId = _0_CORBA.StructDef._NP_RepositoryId
    _omni_op_d = {'_get_members':_0_CORBA.StructDef._d__get_members, 
     '_set_members':_0_CORBA.StructDef._d__set_members}
...
UnionDef._d__set_discriminator_type_def = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'],), (), None)
...
del UnionDef
del _objref_UnionDef
__name__ = 'CORBA__POA'

class UnionDef(_0_CORBA__POA.TypedefDef, _0_CORBA__POA.Container):
    _NP_RepositoryId = _0_CORBA.UnionDef._NP_RepositoryId
    _omni_op_d = {'_get_discriminator_type':_0_CORBA.UnionDef._d__get_discriminator_type, 
     '_get_discriminator_type_def':_0_CORBA.UnionDef._d__get_discriminator_type_def,  '_set_discriminator_type_def':_0_CORBA.UnionDef._d__set_discriminator_type_def,  '_get_members':_0_CORBA.UnionDef._d__get_members,  '_set_members':_0_CORBA.UnionDef._d__set_members}
    _omni_op_d.update(_0_CORBA__POA.TypedefDef._omni_op_d)
    _omni_op_d.update(_0_CORBA__POA.Container._omni_op_d)
...
EnumDef._d__set_members = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/EnumMemberSeq:1.0'],), (), None)
...
class EnumDef(_0_CORBA__POA.TypedefDef):
    ...
    _omni_op_d = {'_get_members':_0_CORBA.EnumDef._d__get_members, 
     '_set_members':_0_CORBA.EnumDef._d__set_members}
    _omni_op_d.update(_0_CORBA__POA.TypedefDef._omni_op_d)
...
AliasDef._d__set_original_type_def = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'],), (), None)
...
del AliasDef
del _objref_AliasDef
__name__ = 'CORBA__POA'

class AliasDef(_0_CORBA__POA.TypedefDef):
    _NP_RepositoryId = _0_CORBA.AliasDef._NP_RepositoryId
    _omni_op_d = {'_get_original_type_def':_0_CORBA.AliasDef._d__get_original_type_def, 
     '_set_original_type_def':_0_CORBA.AliasDef._d__set_original_type_def}
    _omni_op_d.update(_0_CORBA__POA.TypedefDef._omni_op_d)
...
StringDef._d__set_bound = (
 (
  omniORB.tcInternal.tv_ulong,), (), None)
...
del StringDef
del _objref_StringDef
__name__ = 'CORBA__POA'

class StringDef(_0_CORBA__POA.IDLType):
    _NP_RepositoryId = _0_CORBA.StringDef._NP_RepositoryId
    _omni_op_d = {'_get_bound':_0_CORBA.StringDef._d__get_bound, 
     '_set_bound':_0_CORBA.StringDef._d__set_bound}
    _omni_op_d.update(_0_CORBA__POA.IDLType._omni_op_d)
...
del WstringDef
del _objref_WstringDef
__name__ = 'CORBA__POA'

class WstringDef(_0_CORBA__POA.IDLType):
    _NP_RepositoryId = _0_CORBA.WstringDef._NP_RepositoryId
    _omni_op_d = {'_get_bound':_0_CORBA.WstringDef._d__get_bound, 
     '_set_bound':_0_CORBA.WstringDef._d__set_bound}
    _omni_op_d.update(_0_CORBA__POA.IDLType._omni_op_d)
...
FixedDef._d__set_digits = (
 (
  omniORB.tcInternal.tv_ushort,), (), None)
...
del FixedDef
del _objref_FixedDef
__name__ = 'CORBA__POA'

class FixedDef(_0_CORBA__POA.IDLType):
    _NP_RepositoryId = _0_CORBA.FixedDef._NP_RepositoryId
    _omni_op_d = {'_get_digits':_0_CORBA.FixedDef._d__get_digits, 
     '_set_digits':_0_CORBA.FixedDef._d__set_digits,  '_get_scale':_0_CORBA.FixedDef._d__get_scale,  '_set_scale':_0_CORBA.FixedDef._d__set_scale}
    _omni_op_d.update(_0_CORBA__POA.IDLType._omni_op_d)
...
del SequenceDef
del _objref_SequenceDef
__name__ = 'CORBA__POA'

class SequenceDef(_0_CORBA__POA.IDLType):
    _NP_RepositoryId = _0_CORBA.SequenceDef._NP_RepositoryId
    _omni_op_d = {'_get_bound':_0_CORBA.SequenceDef._d__get_bound, 
     '_set_bound':_0_CORBA.SequenceDef._d__set_bound,  '_get_element_type':_0_CORBA.SequenceDef._d__get_element_type,  '_get_element_type_def':_0_CORBA.SequenceDef._d__get_element_type_def,  '_set_element_type_def':_0_CORBA.SequenceDef._d__set_element_type_def}
    _omni_op_d.update(_0_CORBA__POA.IDLType._omni_op_d)
...
del ArrayDef
del _objref_ArrayDef
__name__ = 'CORBA__POA'

class ArrayDef(_0_CORBA__POA.IDLType):
    _NP_RepositoryId = _0_CORBA.ArrayDef._NP_RepositoryId
    _omni_op_d = {'_get_length':_0_CORBA.ArrayDef._d__get_length, 
     '_set_length':_0_CORBA.ArrayDef._d__set_length,  '_get_element_type':_0_CORBA.ArrayDef._d__get_element_type,  '_get_element_type_def':_0_CORBA.ArrayDef._d__get_element_type_def,  '_set_element_type_def':_0_CORBA.ArrayDef._d__set_element_type_def}
    _omni_op_d.update(_0_CORBA__POA.IDLType._omni_op_d)
...
class ExceptionDef(_0_CORBA__POA.Contained, _0_CORBA__POA.Container):
    ...
    _omni_op_d = {'_get_type':_0_CORBA.ExceptionDef._d__get_type, 
     '_get_members':_0_CORBA.ExceptionDef._d__get_members,  '_set_members':_0_CORBA.ExceptionDef._d__set_members}
    _omni_op_d.update(_0_CORBA__POA.Contained._omni_op_d)
    _omni_op_d.update(_0_CORBA__POA.Container._omni_op_d)
...
_0_CORBA._d_AttributeMode = (
 omniORB.tcInternal.tv_enum, _0_CORBA.AttributeMode._NP_RepositoryId, 'AttributeMode', _0_CORBA.AttributeMode._items)
...
_0_CORBA._d_AttributeDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/AttributeDef:1.0', 'AttributeDef')
...
del AttributeDef
del _objref_AttributeDef
__name__ = 'CORBA__POA'

class AttributeDef(_0_CORBA__POA.Contained):
    _NP_RepositoryId = _0_CORBA.AttributeDef._NP_RepositoryId
    _omni_op_d = {'_get_type':_0_CORBA.AttributeDef._d__get_type, 
     '_get_type_def':_0_CORBA.AttributeDef._d__get_type_def,  '_set_type_def':_0_CORBA.AttributeDef._d__set_type_def,  '_get_mode':_0_CORBA.AttributeDef._d__get_mode,  '_set_mode':_0_CORBA.AttributeDef._d__set_mode}
    _omni_op_d.update(_0_CORBA__POA.Contained._omni_op_d)
...
_0_CORBA._d_OperationMode = (
 omniORB.tcInternal.tv_enum, _0_CORBA.OperationMode._NP_RepositoryId, 'OperationMode', _0_CORBA.OperationMode._items)
...
_0_CORBA._d_ParameterMode = (
 omniORB.tcInternal.tv_enum, _0_CORBA.ParameterMode._NP_RepositoryId, 'ParameterMode', _0_CORBA.ParameterMode._items)
...
_0_CORBA._d_OperationDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/OperationDef:1.0', 'OperationDef')
...
OperationDef._d__set_result_def = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'],), (), None)
...
InterfaceDef._d__set_base_interfaces = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/InterfaceDefSeq:1.0'],), (), None)
...
class InterfaceDef(_0_CORBA__POA.Container, _0_CORBA__POA.Contained, _0_CORBA__POA.IDLType):
    ...
    _omni_op_d = {'_get_base_interfaces':_0_CORBA.InterfaceDef._d__get_base_interfaces, 
     '_set_base_interfaces':_0_CORBA.InterfaceDef._d__set_base_interfaces,  'is_a':_0_CORBA.InterfaceDef._d_is_a,  'describe_interface':_0_CORBA.InterfaceDef._d_describe_interface,  'create_attribute':_0_CORBA.InterfaceDef._d_create_attribute,  'create_operation':_0_CORBA.InterfaceDef._d_create_operation}
    _omni_op_d.update(_0_CORBA__POA.Container._omni_op_d)
    _omni_op_d.update(_0_CORBA__POA.Contained._omni_op_d)
    _omni_op_d.update(_0_CORBA__POA.IDLType._omni_op_d)
...
_0_CORBA._d_ValueMemberDef = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CORBA/ValueMemberDef:1.0', 'ValueMemberDef')
...
ValueMemberDef._d__set_type_def = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'],), (), None)
...
del ValueMemberDef
del _objref_ValueMemberDef
__name__ = 'CORBA__POA'

class ValueMemberDef(_0_CORBA__POA.Contained):
    _NP_RepositoryId = _0_CORBA.ValueMemberDef._NP_RepositoryId
    _omni_op_d = {'_get_type':_0_CORBA.ValueMemberDef._d__get_type, 
     '_get_type_def':_0_CORBA.ValueMemberDef._d__get_type_def,  '_set_type_def':_0_CORBA.ValueMemberDef._d__set_type_def,  '_get_access':_0_CORBA.ValueMemberDef._d__get_access,  '_set_access':_0_CORBA.ValueMemberDef._d__set_access}
    _omni_op_d.update(_0_CORBA__POA.Contained._omni_op_d)
...
ValueDef._d__set_supported_interfaces = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/InterfaceDefSeq:1.0'],), (), None)
...
ValueBoxDef._d__set_original_type_def = (
 (
  omniORB.typeMapping['IDL:omg.org/CORBA/IDLType:1.0'],), (), None)
...
del ValueBoxDef
del _objref_ValueBoxDef
__name__ = 'CORBA__POA'

class ValueBoxDef(_0_CORBA__POA.TypedefDef):
    _NP_RepositoryId = _0_CORBA.ValueBoxDef._NP_RepositoryId
    _omni_op_d = {'_get_original_type_def':_0_CORBA.ValueBoxDef._d__get_original_type_def, 
     '_set_original_type_def':_0_CORBA.ValueBoxDef._d__set_original_type_def}
    _omni_op_d.update(_0_CORBA__POA.TypedefDef._omni_op_d)
...
del _objref_AbstractInterfaceDef
__name__ = 'CORBA__POA'
