...
# Size of source mod 2**32: 20663 bytes
...
_0_CosEventChannelAdmin = omniORB.openModule('CosEventChannelAdmin', '/tmp/corba/omni/share/idl/omniORB/COS/CosEventChannelAdmin.idl')
_0_CosEventChannelAdmin__POA = omniORB.openModule('CosEventChannelAdmin__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosEventChannelAdmin.idl')
...
del TypeError
_0_CosEventChannelAdmin._d_ProxyPushConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/ProxyPushConsumer:1.0', 'ProxyPushConsumer')
...
ProxyPushConsumer._d_connect_push_supplier = (
 (
...
del ProxyPushConsumer
__name__ = 'CosEventChannelAdmin'
_0_CosEventChannelAdmin._d_ProxyPullSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/ProxyPullSupplier:1.0', 'ProxyPullSupplier')
...
ProxyPullSupplier._d_connect_pull_consumer = (
 (
...
del ProxyPullSupplier
__name__ = 'CosEventChannelAdmin'
_0_CosEventChannelAdmin._d_ProxyPullConsumer = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/ProxyPullConsumer:1.0', 'ProxyPullConsumer')
...
ProxyPullConsumer._d_connect_pull_supplier = (
 (
...
_0_CosEventChannelAdmin._d_ProxyPushSupplier = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/ProxyPushSupplier:1.0', 'ProxyPushSupplier')
...
ProxyPushSupplier._d_connect_push_consumer = (
 (
...
del ProxyPushSupplier
__name__ = 'CosEventChannelAdmin'
_0_CosEventChannelAdmin._d_ConsumerAdmin = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/ConsumerAdmin:1.0', 'ConsumerAdmin')
...
class ConsumerAdmin(PortableServer.Servant):
    ...
    _omni_op_d = {'obtain_push_supplier':_0_CosEventChannelAdmin.ConsumerAdmin._d_obtain_push_supplier, 
...
del ConsumerAdmin
__name__ = 'CosEventChannelAdmin'
_0_CosEventChannelAdmin._d_SupplierAdmin = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/SupplierAdmin:1.0', 'SupplierAdmin')
...
class SupplierAdmin(PortableServer.Servant):
    ...
    _omni_op_d = {'obtain_push_consumer':_0_CosEventChannelAdmin.SupplierAdmin._d_obtain_push_consumer, 
...
del SupplierAdmin
__name__ = 'CosEventChannelAdmin'
_0_CosEventChannelAdmin._d_EventChannel = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosEventChannelAdmin/EventChannel:1.0', 'EventChannel')
...
class EventChannel(PortableServer.Servant):
    ...
    _omni_op_d = {'for_consumers':_0_CosEventChannelAdmin.EventChannel._d_for_consumers, 
     'for_suppliers':_0_CosEventChannelAdmin.EventChannel._d_for_suppliers,  'destroy':_0_CosEventChannelAdmin.EventChannel._d_destroy}
