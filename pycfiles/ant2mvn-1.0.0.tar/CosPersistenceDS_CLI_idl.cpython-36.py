...
# Embedded file name: ./CosPersistenceDS_CLI_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 23382 bytes
...
_0_CosPersistenceDS_CLI = omniORB.openModule('CosPersistenceDS_CLI', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistenceDS_CLI.idl')
_0_CosPersistenceDS_CLI__POA = omniORB.openModule('CosPersistenceDS_CLI__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosPersistenceDS_CLI.idl')
_0_CosPersistenceDS_CLI._d_UserEnvironment = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/UserEnvironment:1.0', 'UserEnvironment')
...
UserEnvironment._d_set_option = (
 (
  omniORB.tcInternal.tv_long, omniORB.tcInternal.tv_any), (), None)
...
class UserEnvironment(PortableServer.Servant):
    ...
    _omni_op_d = {'set_option':_0_CosPersistenceDS_CLI.UserEnvironment._d_set_option, 
     'get_option':_0_CosPersistenceDS_CLI.UserEnvironment._d_get_option,  'release':_0_CosPersistenceDS_CLI.UserEnvironment._d_release}
...
del UserEnvironment
__name__ = 'CosPersistenceDS_CLI'
_0_CosPersistenceDS_CLI._d_Connection = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/Connection:1.0', 'Connection')
...
del Connection
del _objref_Connection
__name__ = 'CosPersistenceDS_CLI__POA'

class Connection(PortableServer.Servant):
    _NP_RepositoryId = _0_CosPersistenceDS_CLI.Connection._NP_RepositoryId
    _omni_op_d = {'set_option':_0_CosPersistenceDS_CLI.Connection._d_set_option, 
     'get_option':_0_CosPersistenceDS_CLI.Connection._d_get_option}
...
del Connection
__name__ = 'CosPersistenceDS_CLI'
_0_CosPersistenceDS_CLI._d_ConnectionFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/ConnectionFactory:1.0', 'ConnectionFactory')
...
ConnectionFactory._d_create_object = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistenceDS_CLI/UserEnvironment:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosPersistenceDS_CLI/Connection:1.0'],), None)
...
del ConnectionFactory
__name__ = 'CosPersistenceDS_CLI'
_0_CosPersistenceDS_CLI._d_Cursor = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/Cursor:1.0', 'Cursor')
...
class Cursor(PortableServer.Servant):
    ...
    _omni_op_d = {'set_position':_0_CosPersistenceDS_CLI.Cursor._d_set_position, 
     'fetch_object':_0_CosPersistenceDS_CLI.Cursor._d_fetch_object}
...
del Cursor
__name__ = 'CosPersistenceDS_CLI'
_0_CosPersistenceDS_CLI._d_CursorFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/CursorFactory:1.0', 'CursorFactory')
...
CursorFactory._d_create_object = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistenceDS_CLI/Connection:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosPersistenceDS_CLI/Cursor:1.0'],), None)
...
del CursorFactory
__name__ = 'CosPersistenceDS_CLI'
_0_CosPersistenceDS_CLI._d_PID_CLI = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/PID_CLI:1.0', 'PID_CLI')
...
class PID_CLI(_0_CosPersistencePID__POA.PID):
    ...
    _omni_op_d = {'_get_datastore_id':_0_CosPersistenceDS_CLI.PID_CLI._d__get_datastore_id, 
     '_set_datastore_id':_0_CosPersistenceDS_CLI.PID_CLI._d__set_datastore_id,  '_get_id':_0_CosPersistenceDS_CLI.PID_CLI._d__get_id,  '_set_id':_0_CosPersistenceDS_CLI.PID_CLI._d__set_id}
...
del PID_CLI
__name__ = 'CosPersistenceDS_CLI'
_0_CosPersistenceDS_CLI._d_Datastore_CLI = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosPersistenceDS_CLI/Datastore_CLI:1.0', 'Datastore_CLI')
...
Datastore_CLI._d_connect = (
 (
  omniORB.typeMapping['IDL:omg.org/CosPersistenceDS_CLI/Connection:1.0'], (omniORB.tcInternal.tv_string, 0), (omniORB.tcInternal.tv_string, 0), (omniORB.tcInternal.tv_string, 0)), (), None)
