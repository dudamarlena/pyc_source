...
# Embedded file name: ./CosQueryCollection_idl.py
# Compiled at: 2018-07-20 10:03:27
# Size of source mod 2**32: 27271 bytes
...
_0_CosQueryCollection = omniORB.openModule('CosQueryCollection', '/tmp/corba/omni/share/idl/omniORB/COS/CosQueryCollection.idl')
_0_CosQueryCollection__POA = omniORB.openModule('CosQueryCollection__POA', '/tmp/corba/omni/share/idl/omniORB/COS/CosQueryCollection.idl')
...
_0_CosQueryCollection._d_ValueType = (
 omniORB.tcInternal.tv_enum, _0_CosQueryCollection.ValueType._NP_RepositoryId, 'ValueType', _0_CosQueryCollection.ValueType._items)
...
_0_CosQueryCollection._m_FieldValue = (
 (
  0, 'v', omniORB.typeMapping['IDL:omg.org/CosQueryCollection/Value:1.0']),)
...
_0_CosQueryCollection._d_Collection = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosQueryCollection/Collection:1.0', 'Collection')
omniORB.typeMapping['IDL:omg.org/CosQueryCollection/Collection:1.0'] = _0_CosQueryCollection._d_Collection
_0_CosQueryCollection._d_Iterator = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosQueryCollection/Iterator:1.0', 'Iterator')
omniORB.typeMapping['IDL:omg.org/CosQueryCollection/Iterator:1.0'] = _0_CosQueryCollection._d_Iterator
_0_CosQueryCollection._d_CollectionFactory = (
 omniORB.tcInternal.tv_objref, 'IDL:omg.org/CosQueryCollection/CollectionFactory:1.0', 'CollectionFactory')
...
CollectionFactory._d_create = (
 (
  omniORB.typeMapping['IDL:omg.org/CosQueryCollection/ParameterList:1.0'],), (omniORB.typeMapping['IDL:omg.org/CosQueryCollection/Collection:1.0'],), None)
...
Collection._d_add_element = (
 (
  omniORB.tcInternal.tv_any,), (), {_0_CosQueryCollection.ElementInvalid._NP_RepositoryId: _0_CosQueryCollection._d_ElementInvalid})
...
class Collection(PortableServer.Servant):
    ...
    _omni_op_d = {'_get_cardinality':_0_CosQueryCollection.Collection._d__get_cardinality, 
...
class Iterator(PortableServer.Servant):
    ...
    _omni_op_d = {'next':_0_CosQueryCollection.Iterator._d_next, 
     'reset':_0_CosQueryCollection.Iterator._d_reset,  'more':_0_CosQueryCollection.Iterator._d_more}
