...
# Compiled at: 2020-04-25 16:49:17
# Size of source mod 2**32: 51449 bytes
from aerosandbox.geometry.common import *
from aerosandbox.tools.airfoil_fitter.airfoil_fitter import AirfoilFitter

class Airfoil:

    def __init__(self, name=None, coordinates=None, CL_function=None, CDp_function=None, Cm_function=None):
        """
    ...
    def get_xfoil_data(self, a_start=-6, a_end=12, a_step=0.5, a_init=0, Re_start=10000.0, Re_end=10000000.0, n_Res=30, mach=0, max_iter=20, repanel=True, parallel=True, verbose=True):
    ...
    def plot_xfoil_data_polar(self, Res, Cd_plot_max=0.04, cl_step=0.1, repanel=True, parallel=True, max_iter=20, verbose=True):
        """
        ...
        def get_xfoil_data_at_Re(Re):
            import numpy as np
            xfoil_data = self.xfoil_cseq(cl_start=0,
              cl_end=2,
              cl_step=cl_step,
              Re=Re,
              M=0,
