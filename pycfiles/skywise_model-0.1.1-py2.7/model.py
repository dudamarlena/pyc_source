...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/skywisemodel/model.py
# Compiled at: 2017-05-19 14:29:52
from requests import HTTPError
from voluptuous import Any, Schema
from . import ModelApiResource
from .exc import ModelAlreadyExistsException, ModelNotFound, ModelPlatformForecastProductAlreadyExists
...
class _ModelPlatformForecastProduct(ModelApiResource):
    ...
    _serialize = Schema({'name': Any(str, unicode), 
       'description': Any(str, unicode), 
       'model_id': Any(str, unicode), 
       'platform_forecast_product_id': Any(str, unicode)})
