...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/skywisemodel/forecast.py
...
_forecast_deserialize = Schema({'id': Any(None, str, unicode), 
...
_forecast_serialize = Schema({'id': Any(None, str, unicode), 
   'model_id': Any(str, unicode), 
...
class Forecast(ModelApiResource, _ForecastMixin):
    ...
    _args = Schema({'start': datetime_to_str, 
       'end': datetime_to_str, 
       'initTime': datetime_to_str, 
       'limit': int, 
       'sort': Any('asc', 'desc'), 
