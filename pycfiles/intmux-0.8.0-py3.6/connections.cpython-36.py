...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/scripts/connections.py
# Compiled at: 2019-12-06 11:39:49
...
class DockerConnection(Connection):
    ...
    def hosts(cls, parsed_args, prepend_command=''):
        ...
        hosts = []
        names_and_ids = check_output_as_list(prepend_command + "docker ps --format '{{.Names}},{{.ID}}'")
        if len(host_names) == 0:
            ...
            for n_and_i in names_and_ids:
                ...
                if n in host_names:
                    ...
                    if parsed_args.approximate and any(name in i for name in host_names):
                        hosts.append(i)
    ...
    def hosts(cls, parsed_args):
        ...
        for container_name in containers:
            if container_name in parsed_args.hosts:
                ...
                if parsed_args.approximate and any(h in container_name for h in parsed_args.hosts):
                    filtered_hosts.append(container_name)
