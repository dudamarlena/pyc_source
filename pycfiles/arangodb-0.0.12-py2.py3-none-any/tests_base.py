...
# Embedded file name: /Users/maxk/Projects/OpenSource/arango-python/arango/tests/tests_base.py
...
class TestsBase(unittest.TestCase):
    ...
    def build_mock_response(self, *args, **kwargs):
        return RequestsBase.build_response(200, '{}', [], '{}')

    def response_mock(self, status_code=200, text='', method='get'):
        mock_method = lambda self, *a, **kw: RequestsBase.build_response(status_code, '', [], text)
