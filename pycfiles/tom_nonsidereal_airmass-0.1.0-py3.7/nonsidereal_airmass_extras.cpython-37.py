...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tom_nonsidereal_airmass/templatetags/nonsidereal_airmass_extras.py
# Compiled at: 2019-09-20 21:58:17
...
def nonsidereal_target_plan(context):
    ...
    if all((request.GET.get(x) for x in ('start_time', 'end_time'))):
        plan_form = NonsiderealTargetVisibilityForm({'start_time':request.GET.get('start_time'), 
    ...
    return {'form':plan_form,  'target':context['object'], 
