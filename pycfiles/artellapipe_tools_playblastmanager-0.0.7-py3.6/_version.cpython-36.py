...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/playblastmanager/_version.py
...
def get_config():
    ...
    cfg.versionfile_source = 'artellapipe/tools/playblastmanager/_version.py'
    cfg.verbose = False
    return cfg
