...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/playblastmanager/plugins/renderer.py
...
class RendererWidget(plugin.PlayblastPlugin, object):
    ...
    def get_outputs(self):
        return {'viewport_options': {'rendererName': self.get_current_renderer()}}
