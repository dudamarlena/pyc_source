...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/playblastmanager/plugins/tracking.py
...
class TrackerPlugin(plugin.PlayblastPlugin, object):
    ...
    def get_inputs(self, as_preset=False):
        ...
        :return: dict
        """
        return {'tracker_enable':self._upload_playblast_cbx.isChecked(), 
