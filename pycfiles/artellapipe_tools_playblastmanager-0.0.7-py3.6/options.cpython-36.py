...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/playblastmanager/plugins/options.py
...
class PlayblastOptionsWidget(plugin.PlayblastPlugin, object):
    ...
    def ui(self):
        ...
        self.widgets = {'off_screen':self.off_screen, 
