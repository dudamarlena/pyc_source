...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/tools/playblastmanager/plugins/viewport.py
# Compiled at: 2020-05-03 22:03:42
# Size of source mod 2**32: 12354 bytes
"""
...
class ViewportOptionsWidget(plugin.PlayblastPlugin, object):
    ...
    def get_display_lights(self):
        ...
        return {'displayLights':self.display_light_menu.itemData(index), 
         'shadows':self.shadows.isChecked(), 
         'twoSidedLighting':self.two_sided_lighting.isChecked()}
    ...
    def _build_light_menu(self):
        ...
        display_lights = (('Use Default Lighting', 'default'), ('Use All Lights', 'all'),
                          ('Use Selected Lights', 'active'), ('Use Flat Lighting', 'flat'),
                          ('Use No Lights', 'none'))
