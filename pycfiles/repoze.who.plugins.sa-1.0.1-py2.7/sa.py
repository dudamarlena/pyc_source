...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/repoze/who/plugins/sa.py
# Compiled at: 2011-11-23 18:11:47
"""
...
__all__ = ('SQLAlchemyAuthenticatorPlugin', 'SQLAlchemyUserMDPlugin', 'SQLAlchemyUserChecker',
...
class _BaseSQLAlchemyPlugin(object):
    ...
    def get_user(self, username):
        ...
        username_attr = getattr(self.user_class, self.translations['user_name'])
...
def _base_plugin_maker(user_class=None, dbsession=None):
    ...
    return (
     resolveDotted(user_class), resolveDotted(dbsession))


def make_sa_authenticator(user_class=None, dbsession=None, user_name_translation=None, validate_password_translation=None, dummy_validate_password_translation=None):
    """
    ...
    if validate_password_translation:
        authenticator.translations['validate_password'] = validate_password_translation
    if dummy_validate_password_translation:
        authenticator.translations['dummy_validate_password'] = resolveDotted(dummy_validate_password_translation)
    return authenticator


def make_sa_user_mdprovider(user_class=None, dbsession=None, user_name_translation=None):
    """
