...
# [GCC 8.4.0]
# Embedded file name: /net/jansky/data/users/breddels/src/kapteyn-sky2/kapteyn/tabarray.py
# Compiled at: 2016-03-21 11:18:50
# Size of source mod 2**32: 10548 bytes
r"""
================
Module tabarray
================
...
class tabarray(numpy.ndarray):
    ...
    def __new__(cls, source, comchar='#!', sepchar=' \t', lines=None, bad=None, segsep=None):
    ...
    def __init__(self, source, comchar=None, sepchar=None, lines=None, bad=None, segsep=None):
...
def readColumns(filename, comment='!#', cols='all', sepchar=', \t', rows=None, lines=None, bad=0.0, rowslice=(None, ), colslice=(None, )):
    """
