...
# [GCC 8.4.0]
# Embedded file name: /net/jansky/data/users/breddels/src/kapteyn-sky2/kapteyn/positions.py
# Compiled at: 2016-03-23 07:40:06
# Size of source mod 2**32: 105607 bytes
"""
Module positions
================
   ...
   """
    ...
    if i != None and i >= 0:
        return (
         1.0, errmes)
    units = {'DEGREE': (1, 1.0), 
     'ARCMIN': (1, 0.016666666666666666), 
     'ARCSEC': (1, 0.0002777777777777778), 
     'MAS': (1, 2.7777777777777776e-07), 
     'RADIAN': (1, 57.29577951308232), 
     'CIRCLE': (1, 360.0), 
     'DMSSEC': (1, 0.0002777777777777778), 
     'DMSMIN': (1, 0.016666666666666666), 
     'DMSDEG': (1, 1.0), 
     'HMSSEC': (1, 0.004166666666666667), 
     'HMSMIN': (1, 0.25), 
     'HMSHOUR': (1, 15.0), 
     'METER': (2, 1.0), 
     'ANGSTROM': (2, 1e-10), 
            ...
            if delim == 'H':
                ...
                if prevnumber and delim > lastdelim and not (lastdelim == 'D' and delim == 'H'):
                    if number < 0.0:
                        ...
                        if delim in ('M', 'S') and number >= 60.0:
...
class Coordparser(object):
    ...
    def getcoordinate(self, tpos, coordindx):
        ...
        if typ != 'x':
            ...
            if self.types[coordindx] == 'spectral':
