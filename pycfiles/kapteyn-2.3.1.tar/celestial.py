   ...
   """
    ...
    if tex:
        if prec > 0:
            ...
            if delta == None:
                s = s1
            elif delta * 3600.0 % 54000.0 == 0.0:
                s = '$%d^h$' % Ihours
            elif delta * 3600.0 % 900.0 == 0.0:
   ...
   """
    ...
    if tex:
        if prec > 0:
            ...
            if delta == None:
                s = s1
            elif delta * 3600.0 % 3600 == 0.0:
                s = '$%c%d^{\\circ}$' % (si, Ideg)
            elif delta * 3600.0 % 60 == 0.0:
        ...
        if sysin in [eq, ecl]:
            if epochinset == None:
                if refin == fk4 or refin == fk4_no_e:
                    ...
                    epochin = 2000.0
            elif refin == fk4 or refin == fk4_no_e:
