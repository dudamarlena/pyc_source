...
# [GCC 8.4.0]
# Embedded file name: /home/fwilhelm/Sources/pydse/pydse/data/__init__.py
# Compiled at: 2015-10-27 06:06:03
"""
...
def _get_df_from_file(filename):
    ...
    return pd.read_csv(path, sep=';', parse_dates=True, index_col=0, date_parser=parse_dates)
