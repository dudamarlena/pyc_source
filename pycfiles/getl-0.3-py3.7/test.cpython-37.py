...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-x86_64/egg/tests/test.py
# Compiled at: 2019-03-07 10:43:52
...
class TestGetl(unittest.TestCase):
    ...
    def test_load_location_history(self):
        ...
        self.assertEqual(locations[0][6], '2017-07-14 02:40:00')
        ...
        self.assertEqual(locations[1][6], '2014-05-13 16:53:20')
