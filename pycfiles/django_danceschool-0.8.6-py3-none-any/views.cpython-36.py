...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/views.py
...
class GiftCertificateCustomizeView(FormView):
    ...
    def form_valid(self, form):
        ...
        try:
            voucher = Voucher.create_new_code(prefix='GC_',
        ...
        email_class.email_recipient(subject=(template.subject),
