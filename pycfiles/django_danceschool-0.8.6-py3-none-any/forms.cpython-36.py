...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/forms.py
...
class VoucherCustomizationForm(forms.Form):
    ...
    emailType = forms.ChoiceField(label=(_('This email belongs to')),
      widget=(forms.RadioSelect),
      required=True,
      choices=[
     (
      'R', _('The recipient')), ('P', _('The purchaser'))],
