...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/tests.py
...
class VouchersTest(DefaultSchoolTestCase):
    ...
    def create_voucher(self, **kwargs):
        v = Voucher(voucherId=(kwargs.get('voucherId', 'TEST_VOUCHER')),
    ...
    def test_existing_customers_voucher(self):
        ...
        updateConstant('vouchers__enableVouchers', True)
        s = self.create_series(pricingTier=(self.defaultPricing))
        v = self.create_voucher(forPreviousCustomersOnly=True,
    ...
    def test_vouchermakesitfree(self):
        ...
        updateConstant('vouchers__enableVouchers', True)
        s = self.create_series(pricingTier=(self.defaultPricing))
        v = self.create_voucher(originalAmount=(self.defaultPricing.getBasePrice() + 10),
