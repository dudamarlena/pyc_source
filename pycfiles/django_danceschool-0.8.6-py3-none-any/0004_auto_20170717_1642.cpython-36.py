...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/financial/migrations/0004_auto_20170717_1642.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterModelOptions(name='expensecategory',
       options={'verbose_name':'Expense category', 
      'verbose_name_plural':'Expense categories'}),
     migrations.AlterModelOptions(name='expenseitem',
       options={'ordering':[
       '-accrualDate'], 
      'permissions':(('mark_expenses_paid', 'Mark expenses as paid at the time of submission'), ),  'verbose_name':'Expense item',  'verbose_name_plural':'Expense items'}),
     migrations.AlterModelOptions(name='revenuecategory',
       options={'verbose_name':'Revenue category', 
 ...
 ('view_finances_detail', 'View school finances as detailed statement')),  'verbose_name':'Revenue item',  'verbose_name_plural':'Revenue items'}),
     migrations.AlterField(model_name='expensecategory',
       name='defaultRate',
     ...
     migrations.AlterField(model_name='revenuecategory',
       name='defaultAmount',
