...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/handlers.py
...
def checkVoucherCode(sender, **kwargs):
    ...
    if not obj:
        ...
        customer = Customer.objects.filter(first_name=first, last_name=last, email=email).first()
    try:
