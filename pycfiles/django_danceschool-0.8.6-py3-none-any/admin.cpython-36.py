...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/admin.py
...
class CustomerVoucherInlineForm(ModelForm):
    customer = ModelChoiceField(queryset=(Customer.objects.all()),
      widget=autocomplete.ModelSelect2(url='autocompleteCustomer',
      attrs={'data-placeholder':_('Enter a customer name'), 
...
class VoucherAdmin(admin.ModelAdmin):
    inlines = [
     DanceTypeVoucherInline, ClassVoucherInline, SeriesCategoryVoucherInline, PublicEventCategoryVoucherInline, EventSessionVoucherInline, CustomerGroupVoucherInline, CustomerVoucherInline, VoucherUseInline, VoucherCreditInline]
