...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/financial/migrations/0007_auto_20170823_1047.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='GenericRepeatedExpense',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name':'Other repeated expense', 
      'ordering':('name', ), 
     ...
     migrations.AlterField(model_name='repeatedexpenserule',
       name='applyRateRule',
