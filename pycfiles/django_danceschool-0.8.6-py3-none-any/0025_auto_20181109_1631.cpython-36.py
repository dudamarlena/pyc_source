...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/core/migrations/0025_auto_20181109_1631.py
# Compiled at: 2019-04-03 22:56:26
# Size of source mod 2**32: 5600 bytes
from __future__ import unicode_literals
from django.db import migrations, models
import django.db.models.deletion, multiselectfield.db.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.RenameField(model_name='instructor',
       old_name='staffmember_ptr',
       new_name='staffMember'),
     migrations.AlterField(model_name='instructor',
       name='staffMember',
     ...
     migrations.RemoveField(model_name='staffmember',
     ...
     migrations.AlterModelOptions(name='instructor',
       options={'permissions':(('update_instructor_bio', "Can update instructors' bio information"), ('view_own_instructor_stats', "Can view one's own statistics (if an instructor)"),
 ('view_other_instructor_stats', "Can view other instructors' statistics"), ('view_own_instructor_finances', "Can view one's own financial/payment data (if a staff member)"),
 ('view_other_instructor_finances', "Can view other staff members' financial/payment data")), 
      'verbose_name':'Instructor',  'verbose_name_plural':'Instructors'}),
     migrations.AlterField(model_name='staffmemberlistpluginmodel',
     ...
     migrations.AlterField(model_name='staffmember',
       name='categories',
     ...
     migrations.CreateModel(name='SeriesStaffMember',
       fields=[],
       options={'verbose_name':'Series staff member', 
 ...
 ('can_autocomplete_staffmembers', 'Able to use customer and staff member autocomplete features (in admin forms)')),  'verbose_name':'Staff member',  'verbose_name_plural':'Staff members'})]