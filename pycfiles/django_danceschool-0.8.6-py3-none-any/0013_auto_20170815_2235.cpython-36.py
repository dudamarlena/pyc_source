...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/core/migrations/0013_auto_20170815_2235.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Room',
       fields=[
      (
     ...
     migrations.RemoveField(model_name='eventstaffcategory',
       name='defaultRate'),
     migrations.RemoveField(model_name='location',
       name='rentalRate'),
     migrations.AlterUniqueTogether(name='eventstaffmember',
     ...
     migrations.AlterUniqueTogether(name='room',
