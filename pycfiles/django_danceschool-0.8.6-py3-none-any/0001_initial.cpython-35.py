...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    dependencies = [
     ('core', '0001_initial')]
    operations = [
     migrations.CreateModel(name='ClassVoucher', fields=[
      (
     ...
     migrations.CreateModel(name='CustomerVoucher', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Customer'))]),
     migrations.CreateModel(name='DanceTypeVoucher', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='TemporaryVoucherUse', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='VoucherCategory', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'name', models.CharField(max_length=80, unique=True)),
      (
       'description', models.TextField(blank=True, null=True))], options={'verbose_name_plural': 'Voucher categories'}),
     migrations.CreateModel(name='VoucherCredit', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'amount', models.FloatField(validators=[django.core.validators.MinValueValidator(0)])),
     ...
     migrations.CreateModel(name='VoucherReferralDiscount', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='VoucherReferralDiscountUse', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'creationDate', models.DateTimeField(auto_now_add=True, null=True)),
     ...
     migrations.CreateModel(name='VoucherUse', fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'amount', models.FloatField(validators=[django.core.validators.MinValueValidator(0)])),
      ...
      (
       'voucher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vouchers.Voucher'))]),
     migrations.AddField(model_name='voucherreferraldiscountuse', name='voucherUse', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vouchers.VoucherUse')),
     migrations.AddField(model_name='voucher', name='category', field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='vouchers.VoucherCategory')),
     migrations.AddField(model_name='temporaryvoucheruse', name='voucher', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vouchers.Voucher')),
     migrations.AddField(model_name='dancetypevoucher', name='voucher', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vouchers.Voucher')),
     migrations.AddField(model_name='customervoucher', name='voucher', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vouchers.Voucher')),
     migrations.AddField(model_name='classvoucher', name='voucher', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vouchers.Voucher'))]