...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/financial/migrations/0006_auto_20170815_2235.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='RepeatedExpenseRule',
       fields=[
      (
     ...
     migrations.CreateModel(name='LocationRentalInfo',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name_plural':"Locations' rental information", 
      'verbose_name':'Location rental information'},
       bases=('financial.repeatedexpenserule', )),
     migrations.CreateModel(name='RoomRentalInfo',
       fields=[
      (
       'repeatedexpenserule_ptr', models.OneToOneField(auto_created=True, on_delete=(django.db.models.deletion.CASCADE), parent_link=True, primary_key=True, serialize=False, to='financial.RepeatedExpenseRule')),
      (
       ...
       options={'verbose_name_plural':"Rooms' rental information", 
      'verbose_name':'Room rental information'},
       bases=('financial.repeatedexpenserule', )),
     migrations.CreateModel(name='StaffMemberWageInfo',
       fields=[
      (
       'repeatedexpenserule_ptr', models.OneToOneField(auto_created=True, on_delete=(django.db.models.deletion.CASCADE), parent_link=True, primary_key=True, serialize=False, to='financial.RepeatedExpenseRule')),
      (
      ...
      (
       ...
       options={'verbose_name_plural':"Staff members' wage/salary information", 
     ...
     migrations.AlterUniqueTogether(name='staffmemberwageinfo',
