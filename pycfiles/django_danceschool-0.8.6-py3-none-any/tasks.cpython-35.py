...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/django-danceschool/currentmaster/django-danceschool/danceschool/core/tasks.py
# Compiled at: 2018-03-26 19:55:29
...
def sendEmail(subject, content, from_address, from_name='', to=[], cc=[], bcc=[], attachment_name='attachment', attachment=None, html_content=None):
    ...
    with get_connection() as (connection):
        connection.open()
        message = EmailMultiAlternatives(subject=subject, body=content, from_email=from_email, to=recipients, bcc=bcc, reply_to=reply_to, connection=connection)
        if html_content:
