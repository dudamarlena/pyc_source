...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/core/migrations/0008_auto_20170717_1642.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.AlterModelOptions(name='classdescription',
       options={'ordering':('-series__startTime', ), 
      'verbose_name':'Class series description',  'verbose_name_plural':'Class series descriptions'}),
     migrations.AlterModelOptions(name='customer',
       options={'ordering':('last_name', 'first_name'), 
      'permissions':(('can_autocomplete_users', 'Able to use customer and User autocomplete features (in various admin forms)'),
 ('view_other_user_profiles', 'Able to view other Customer and User profile pages')),  'verbose_name':'Customer',  'verbose_name_plural':'Customers'}),
     migrations.AlterModelOptions(name='dancerole',
       options={'ordering':('order', ), 
      'verbose_name':'Dance role',  'verbose_name_plural':'Dance roles'}),
     migrations.AlterModelOptions(name='dancetype',
       options={'ordering':('order', ), 
      'verbose_name':'Dance type',  'verbose_name_plural':'Dance types'}),
     migrations.AlterModelOptions(name='dancetypelevel',
       options={'ordering':('danceType__order', 'order'), 
      'verbose_name':'Level of dance type',  'verbose_name_plural':'Levels of dance type'}),
     migrations.AlterModelOptions(name='emailtemplate',
       options={'permissions':(('send_email', 'Can send emails using the SendEmailView'), ), 
      'verbose_name':'Email template',  'verbose_name_plural':'Email templates'}),
     migrations.AlterModelOptions(name='eventoccurrence',
       options={'verbose_name':'Event occurrence', 
      'verbose_name_plural':'Event occurrences'}),
     migrations.AlterModelOptions(name='eventregistration',
       options={'verbose_name':'Event registration', 
      'verbose_name_plural':'Event registrations'}),
     migrations.AlterModelOptions(name='eventrole',
       options={'verbose_name':'Event dance role', 
      'verbose_name_plural':'Event dance roles'}),
     migrations.AlterModelOptions(name='eventstaffcategory',
       options={'verbose_name':'Event staff category', 
      'verbose_name_plural':'Event staff categories'}),
     migrations.AlterModelOptions(name='eventstaffmember',
       options={'verbose_name':'Event staff member', 
      'verbose_name_plural':'Event staff members'}),
 ...
 ('send_invoices', 'Can send invoices to students requesting payment'), ('process_refunds', 'Can refund customers for registrations and other invoice payments.')), 
     ...
     migrations.AlterModelOptions(name='invoiceitem',
       options={'verbose_name':'Invoice item', 
      'verbose_name_plural':'Invoice items'}),
     migrations.AlterModelOptions(name='location',
       options={'ordering':('orderNum', ), 
      'verbose_name':'Location',  'verbose_name_plural':'Locations'}),
     migrations.AlterModelOptions(name='publicevent',
       options={'verbose_name':'Public event', 
 ...
 ('override_register_dropins', 'Can register students for drop-ins even if the series does not allow drop-in registration.')),  'verbose_name':'Registration',  'verbose_name_plural':'Registrations'}),
     migrations.AlterModelOptions(name='series',
       options={'verbose_name':'Class series', 
      'verbose_name_plural':'Class series'}),
     migrations.AlterModelOptions(name='seriesteacher',
       options={'verbose_name':'Series instructor', 
      'verbose_name_plural':'Series instructors'}),
     migrations.AlterModelOptions(name='staffmember',
       options={'permissions':(('view_staff_directory', 'Can access the staff directory view'), ('view_school_stats', "Can view statistics about the school's performance.")), 
      'verbose_name':'Staff member',  'verbose_name_plural':'Staff members'}),
     migrations.AlterModelOptions(name='substituteteacher',
       options={'permissions':(('report_substitute_teaching', 'Can access the substitute teaching reporting form'), ), 
      'verbose_name':'Substitute instructor',  'verbose_name_plural':'Substitute instructors'}),
     migrations.AlterModelOptions(name='temporaryeventregistration',
       options={'verbose_name':'Temporary event registration', 
      'verbose_name_plural':'Temporary event registrations'}),
     migrations.AlterModelOptions(name='temporaryregistration',
       options={'ordering':('-dateTime', ), 
      'verbose_name':'Temporary registration',  'verbose_name_plural':'Temporary registrations'}),
     migrations.AlterField(model_name='classdescription',
       name='description',
     ...
     migrations.AlterField(model_name='dancerole',
       name='name',
     ...
     migrations.AlterField(model_name='dancetype',
       name='name',
       field=models.CharField(max_length=50, unique=True, verbose_name='Name')),
     migrations.AlterField(model_name='dancetype',
       name='order',
     ...
     migrations.AlterField(model_name='eventlistpluginmodel',
       name='cssClasses',
     ...
     migrations.AlterField(model_name='eventoccurrence',
       name='cancelled',
     ...
     migrations.AlterField(model_name='eventstaffcategory',
       name='defaultRate',
     ...
     migrations.AlterField(model_name='eventstaffcategory',
       name='name',
       field=models.CharField(max_length=50, unique=True, verbose_name='Name')),
     migrations.AlterField(model_name='eventstaffmember',
       name='category',
     ...
     migrations.AlterField(model_name='staffmember',
       name='userAccount',
       field=models.OneToOneField(blank=True, null=True, on_delete=(django.db.models.deletion.CASCADE), to=(settings.AUTH_USER_MODEL), verbose_name='User account')),
     migrations.AlterField(model_name='staffmemberpluginmodel',
       name='staffMember',
