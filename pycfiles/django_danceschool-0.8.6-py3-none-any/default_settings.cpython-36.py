...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/default_settings.py
...
CKEDITOR_SETTINGS = {'language':'', 
 'toolbar_CMS':[
  ...
  {'name':'insert', 
   'items':['FilerImage', 'Table', 'HorizontalRule', 'Smiley', 'Iframe']},
  {'name':'tools', 
...
HUEY = SqliteHuey('danceschool',
  filename=(path.join(path.dirname(path.abspath(getattr(sys.modules['__main__'], '__file__', path.dirname(__file__)))), 'huey.sqlite3')))
...
CMS_PLACEHOLDER_CONF = {None:{'excluded_plugins': ['PictureSplashTemplatePlugin']}, 
 'splash_image':{'name':'Splash Background Image', 
  'plugins':[
   'PictureSplashTemplatePlugin'], 
  'excluded_plugins':[],  'limits':{'global': 1}}, 
 'splash_title':{'name': 'Front Page Title'}, 
 'splash_caption':{'name': 'Front Page Caption'}, 
 'splash_carousel':{'name':'Splash Carousel', 
  'plugins':[
   'Bootstrap4CarouselPlugin'], 
  'excluded_plugins':[],  'limits':{'Bootstrap4CarouselPlugin': 1}}}
