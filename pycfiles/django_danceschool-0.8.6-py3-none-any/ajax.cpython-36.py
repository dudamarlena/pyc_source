...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/prerequisites/ajax.py
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if setMet is not None:
                ...
                cr, created = CustomerRequirement.objects.update_or_create(customer=customer,
                  requirement=req,
                  role=role,
                  defaults={'met': setMet})
