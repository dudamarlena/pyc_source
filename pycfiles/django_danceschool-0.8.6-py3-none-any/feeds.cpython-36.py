...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/private_events/feeds.py
...
class EventFeedItem(object):
    ...
    def __init__(self, object, **kwargs):
        ...
        if kwargs.get('timeZone', None):
            ...
            if hasattr(object.event, 'category'):
                if object.event.category:
