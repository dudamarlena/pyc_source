...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/core/migrations/0005_auto_20170614_1607.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='Invoice',
      ...
      (
       ...
       options={'permissions': (('view_all_invoices', 'Can view invoices without passing the validation string.'),
 ('send_invoices', 'Can send invoices to students requesting payment'), ('process_refunds', 'Can refund customers for registrations and other invoice payments.'))},
       bases=(
      danceschool.core.mixins.EmailRecipientMixin, models.Model)),
     migrations.CreateModel(name='InvoiceItem',
       fields=[
      (
       'id', models.UUIDField(default=(uuid.uuid4), editable=False, primary_key=True, serialize=False)),
      (
      ...
      (
       'fees', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Processing fees'))]),
     migrations.AlterModelOptions(name='registration',
       options={'ordering':('-dateTime', ), 
      'permissions':(('view_registration_summary', 'Can access the series-level registration summary view'),
 ...
 ('override_register_dropins', 'Can register students for drop-ins even if the series does not allow drop-in registration.'))}),
     migrations.RemoveField(model_name='registration',
       name='amountPaid'),
     migrations.RemoveField(model_name='registration',
     ...
     migrations.RemoveField(model_name='registration',
       name='submissionUser'),
     migrations.AlterUniqueTogether(name='eventregistration',
       unique_together=(set([('registration', 'event')]))),
     migrations.AlterUniqueTogether(name='temporaryeventregistration',
       unique_together=(set([('registration', 'event')]))),
     migrations.AddField(model_name='invoiceitem',
