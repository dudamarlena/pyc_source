...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/core/migrations/0012_auto_20170809_1428.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='SeriesCategory',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name_plural':'Series categories', 
      'verbose_name':'Series category'}),
     migrations.AlterModelOptions(name='pricingtier',
       options={'verbose_name':'Pricing tier', 
      'verbose_name_plural':'Pricing tiers'}),
     migrations.RemoveField(model_name='series',
       name='special'),
     migrations.AddField(model_name='publiceventcategory',
     ...
     migrations.AlterField(model_name='series',
       name='allowDropins',
     ...
     migrations.AddField(model_name='series',
       name='category',
     ...
     migrations.AlterField(model_name='publicevent',
       name='category',
