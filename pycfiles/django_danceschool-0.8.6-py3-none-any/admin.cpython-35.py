...
# [GCC 8.4.0]
# Embedded file name: /mnt/c/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/admin.py
# Compiled at: 2018-03-26 19:55:32
# Size of source mod 2**32: 6318 bytes
...
class CustomerVoucherInlineForm(ModelForm):
    customer = ModelChoiceField(queryset=Customer.objects.all(), widget=autocomplete.ModelSelect2(url='autocompleteCustomer', attrs={'data-placeholder': _('Enter a customer name'), 
...
class VoucherAdmin(admin.ModelAdmin):
    inlines = [
     DanceTypeVoucherInline, ClassVoucherInline, CustomerVoucherInline, VoucherUseInline, VoucherCreditInline]
