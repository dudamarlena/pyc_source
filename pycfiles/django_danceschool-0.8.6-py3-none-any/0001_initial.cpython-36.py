...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/vouchers/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    dependencies = [
     ('core', '0001_initial')]
    operations = [
     migrations.CreateModel(name='ClassVoucher',
       fields=[
      (
     ...
     migrations.CreateModel(name='CustomerVoucher',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
       'customer', models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='core.Customer'))]),
     migrations.CreateModel(name='DanceTypeVoucher',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='TemporaryVoucherUse',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='VoucherCategory',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       ...
       options={'verbose_name_plural': 'Voucher categories'}),
     migrations.CreateModel(name='VoucherCredit',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='VoucherReferralDiscount',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='VoucherReferralDiscountUse',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
     ...
     migrations.CreateModel(name='VoucherUse',
       fields=[
      (
       'id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
      (
      ...
      (
       'voucher', models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='vouchers.Voucher'))]),
     migrations.AddField(model_name='voucherreferraldiscountuse',
       name='voucherUse',
     ...
     migrations.AddField(model_name='temporaryvoucheruse',
       name='voucher',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='vouchers.Voucher')),
     migrations.AddField(model_name='dancetypevoucher',
       name='voucher',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='vouchers.Voucher')),
     migrations.AddField(model_name='customervoucher',
       name='voucher',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='vouchers.Voucher')),
     migrations.AddField(model_name='classvoucher',
       name='voucher',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='vouchers.Voucher'))]