...
# [GCC 8.4.0]
# Embedded file name: /c/Users/Lee/Sync/projects/django-danceschool/currentmaster/django-danceschool/danceschool/discounts/migrations/0005_auto_20170830_1159.py
...
def create_initial_category(apps, schema_editor):
    ...
    DiscountCategory.objects.using(db_alias).create(id=1,
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='DiscountCategory',
       fields=[
      (
      ...
      (
       ...
       options={'verbose_name_plural':'Discount categories', 
      'ordering':('order', ), 
      'verbose_name':'Discount category'}),
     migrations.RenameField(model_name='discountcombo',
       old_name='doorGeneralPrice',
       new_name='doorPrice'),
     migrations.RenameField(model_name='discountcombo',
       old_name='onlineGeneralPrice',
       new_name='onlinePrice'),
     migrations.RemoveField(model_name='discountcombo',
     ...
     migrations.AlterField(model_name='registrationdiscount',
       name='registration',
       field=models.ForeignKey(on_delete=(django.db.models.deletion.CASCADE), to='core.Registration', verbose_name='Registration')),
     migrations.AlterField(model_name='temporaryregistrationdiscount',
       name='registration',
     ...
     migrations.AlterUniqueTogether(name='registrationdiscount',
       unique_together=(set([('registration', 'discount')]))),
     migrations.AlterUniqueTogether(name='temporaryregistrationdiscount',
       unique_together=(set([('registration', 'discount')])))]