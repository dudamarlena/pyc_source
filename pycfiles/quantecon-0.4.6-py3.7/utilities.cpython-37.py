...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/quantecon/random/utilities.py
# Compiled at: 2019-09-02 20:05:04
...
_probvec_parallel = guvectorize([
 '(f8[:], f8[:])'],
  '(n), (k)', nopython=True, target='parallel', cache=True)(_probvec)
_probvec_cpu = guvectorize([
 '(f8[:], f8[:])'],
  '(n), (k)', nopython=True, target='cpu', cache=True)(_probvec)
