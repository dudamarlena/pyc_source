...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/quantecon/kalman.py
...
class Kalman:
    ...
    def whitener_lss(self):
        ...
        K = self.K_infinity
        n, k, m, l = (
         self.ss.n, self.ss.k, self.ss.m, self.ss.l)
    ...
    def stationary_values(self, method='doubling'):
        ...
        """
        A, C, G, H = (
         self.ss.A, self.ss.C, self.ss.G, self.ss.H)
