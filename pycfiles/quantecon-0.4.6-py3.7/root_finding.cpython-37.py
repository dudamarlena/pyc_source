...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/quantecon/optimize/root_finding.py
# Compiled at: 2018-09-17 00:03:08
# Size of source mod 2**32: 15050 bytes
import numpy as np
...
@njit
def newton(func, x0, fprime, args=(), tol=1.48e-08, maxiter=50, disp=True):
    """
...
@njit
def newton_halley(func, x0, fprime, fprime2, args=(), tol=1.48e-08, maxiter=50, disp=True):
    """
