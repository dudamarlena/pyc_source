...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/quantecon/tests/test_gridtools.py
...
from quantecon.gridtools import cartesian, mlinspace, _repeat_1d, simplex_grid, simplex_index, num_compositions, num_compositions_jit
...
class TestSimplexGrid:
    ...
    def test_num_compositions_jit(self):
        ...
        eq_(num, len(self.simplex_grid_3_4))
        eq_(num_compositions_jit(100, 50), 0)
