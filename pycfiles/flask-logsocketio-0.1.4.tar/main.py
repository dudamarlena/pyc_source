...
# [GCC 8.4.0]
# Embedded file name: /home/fraoustin/Workspace/flask-logsocketio/flask_logsocketio/main.py
# Compiled at: 2017-08-12 15:29:23
...
class SocketIoHandler(Handler):
    ...
    def emit(self, record):
        ...
        emit('logging', {'msg': self.format(record), 
           'time': now.strftime('%d/%m/%Y %H:%M:%S')}, namespace='/log', broadcast=True)
