...
# [GCC 8.4.0]
# Embedded file name: /home/hugo/developpement/python/libperso/beampy/utils.py
# Compiled at: 2019-01-11 13:24:47
"""
...
def bounding_box(element):
    ...
    corners = [
     (
      'lefttop', element.left, element.top),
     (
    ...
    for args in corners:
        ...
        if anchor_selected == label:
            rc = 'red'
        rectangle(x=ex + center(0), y=ey + center(0), width=rw, height=rh, color=rc, edgecolor=None)
