...
class rectangle(svg):
    ...
    def __init__(self, **kwargs):
        ...
        beampy_svg_kword = {'color': 'fill', 'linewidth': 'stroke-width', 
           'opacity': 'opacity', 
           'edgecolor': 'stroke'}
        self.style = ''
    ...
    def pre_render(self):
        ...
        self.content = self.content.format(width=self.width - self.dxdy * 2, height=self.height - self.dxdy * 2, dx=self.dxdy, dy=self.dxdy, rx=self.rx, ry=self.ry, style=self.style, filter=self.svgfilter, clip=self.svgclip)
        return
...
class line(svg):
    ...
    def __init__(self, x2, y2, **kwargs):
        ...
        beampy_svg_kword = {'color': 'stroke', 'linewidth': 'stroke-width', 
           'opacity': 'opacity'}
        self.style = ''
        for kw in beampy_svg_kword:
            if hasattr(self, kw):
    ...
    def pre_render(self):
        self.content = self.content.format(x2=self.x2, y2=self.y2, style=self.style)
...
class grid_new(svg):
    ...
    def __init__(self, dx, dy, **kwargs):
        ...
        self.content = self.content.format(x2=curslide.curwidth, y2=0, style=self.style, id='hlineXX')
