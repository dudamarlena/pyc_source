...
# [GCC 8.4.0]
# Embedded file name: /home/hugo/developpement/python/libperso/beampy/scour/svg_transform.py
...
lexicon = [
 ...
 ('int', '[-+]?[0-9]+'),
 ('command', '(?:matrix|translate|scale|rotate|skew[XY])'),
 ('coordstart', '\\('),
 ('coordend', '\\)')]
