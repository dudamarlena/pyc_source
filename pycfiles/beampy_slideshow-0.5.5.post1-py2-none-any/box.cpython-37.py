...
# [GCC 8.4.0]
# Embedded file name: /home/hugo/developpement/python/beampy_git/beampy/modules/box.py
...
class box(group):
    ...
    def __init__(self, title=None, x='center', y='auto', width=None, height=None, parentid=None, **kwargs):
        ...
        super(box, self).__init__(x=x, y=y,
          width=width,
          height=height,
          parentid=parentid,
          opengroup=False)
    ...
    def build_title(self):
        ...
        self.title_ypos = 5
        self.bp_title = text((self.title), x=(self.title_xpos), y=(self.title_ypos),
    ...
    def build_background(self):
        ...
        self.main_svg = rectangle(width=(self.width), height=(self.height),
          rx=(self.rounded),
          ry=(self.rounded),
        ...
        if self.bp_title is not None:
            ...
            self.title_svg = rectangle(width=(self.width), height=(self.head_height),
              color=(self.color),
              edgecolor=(self.color),
              linewidth=(self.linewidth),
              svgclip=clipid,
