...
# [GCC 8.4.0]
# Embedded file name: /home/hugo/developpement/python/libperso/beampy/statics/default_theme.py
# Compiled at: 2019-07-07 12:55:23
THEME = {}
THEME['document'] = {'format': 'html5', 
   ...
   'guide': False, 
   'text_box': False, 
   'html': {'background_color': 'black'}, 
   'external_app': {'inkscape': 'auto', 'dvisvgm': 'auto', 
                    'pdfjoin': 'auto', 
                    'video_encoder': 'auto', 
                    'pdf2svg': 'auto'}}
THEME['slide'] = {'background': 'white', 
   'layout': None}
THEME['text'] = {'size': 20, 
   'font': 'CMR', 
   'color': '#000000', 
...
THEME['title'] = {'size': 28, 
   'font': 'CMR', 
   'color': 'ForestGreen', 
   'x': {'shift': 0.5, 'unit': 'cm'}, 'y': {'shift': 1.25, 'unit': 'cm'}, 'reserved_y': '1.5cm', 
   'align': '', 
   'va': 'baseline', 
   'opacity': 1}
THEME['link'] = {'fill': THEME['title']['color']}
THEME['maketitle'] = {'title_size': 30, 
   ...
   'subtitle_size': 20, 
   'template': None}
THEME['tableofcontents'] = {'width': None, 
   'height': None, 
   'x': 25, 
   'y': 'center', 
   'section_yoffset': 50, 
...
THEME['figure'] = {'x': 'center', 
   'y': 'auto', 
   'width': None, 
   'height': None}
THEME['cite'] = {'x': 'center', 
   'y': {'shift': 0.9, 'unit': 'height'}, 'color': THEME['title']['color'], 
   'size': 10}
