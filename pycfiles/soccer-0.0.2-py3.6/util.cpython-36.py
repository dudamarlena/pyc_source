...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\soccer\util.py
# Compiled at: 2018-02-09 14:11:02
# Size of source mod 2**32: 8946 bytes
""" Helper methods """
import datetime, pymongo, configparser, logging, os
SORT_OPTIONS = {'POINTS':'points', 
 'GOALS':'goals', 
...
DEFAULT_TIE_BREAK_RULES = [
 'POINTS', 'GOAL_DIFFERENCE', 'GOALS', 'AWAY_GOALS']
TIE_BREAK_RULES = {'POINTS':{'field':[
   'points'], 
  'descending':True, 
  'head2head':False}, 
