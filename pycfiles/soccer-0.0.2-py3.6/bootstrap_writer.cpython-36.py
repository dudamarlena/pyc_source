...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\soccer\writers\bootstrap_writer.py
# Compiled at: 2018-03-08 12:01:18
...
class BootstrapWriter(BasicWriter):
        ...
        if teams is not None:
            ...
            if rank == 'won':
                ...
                if rank == 'last':
                    ...
                    end_pos = rank + 3
                if start_pos > 2:
                    html = html + "<tr><td colspan='9' class='text-center'>...</td></tr>"
    ...
    def _get_crest_img(self, team, height=30):
        if 'crest_url' in team:
            if team['crest_url'] is not None:
