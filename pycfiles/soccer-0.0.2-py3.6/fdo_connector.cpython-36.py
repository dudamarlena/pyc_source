...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\soccer\data_connectors\fdo_connector.py
# Compiled at: 2017-11-28 08:30:56
...
class FDOConnector(DataConnector):
    ...
    def enrich_fixture(self, fixture):
        ...
        fixture['homeTeam'] = {'team_id': homeId}
        fixture['awayTeam'] = {'team_id': awayId}
