...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\tests\test_soccer.py
# Compiled at: 2018-02-27 07:10:06
# Size of source mod 2**32: 16115 bytes
import datetime
     ...
     {'_id':'1', 
      ...
      'assists':[
       ...
       {'player_id':3, 
        ...
        'type':'goal', 
        'team_id':1}], 
      'lineups':{'home':{},  'away':{}},  'homeTeam':{'team_id':1, 
       'name':'Team 1'}, 
      'awayTeam':{'team_id':2, 
       'name':'Team 2'}}]
...
def test_get_sort_tuple():
    sortBy = (
     [
      'points'], ['goalDifference'], ['goals'], ['away', 'goals'])
    ...
    x = {'goals':8, 
     ...
     'goalDifference':8, 
     'home':{'goals':4, 
      'goalsAgainst':0,  'goalDifference':4,  'wins':4,  'draws':0,  'losses':0}, 
     'away':{'goals':4, 
      'goalsAgainst':0,  'goalDifference':4,  'wins':4,  'draws':0,  'losses':0}, 
     'teamName':'Team 1', 
     'teamId':1}
...
def test_tie_break_rules():
    fixtures = [
     ...
     {'dateObject':datetime.datetime.now(), 
      ...
      'awayTeam':{'team_id': 5}},
     {'dateObject':datetime.datetime.now(), 
      'result':{'goalsHomeTeam':0, 
       'goalsAwayTeam':1}, 
      'homeTeam':{'team_id': 2}, 
      'awayTeam':{'team_id': 1}},
     {'dateObject':datetime.datetime.now(), 
      'result':{'goalsHomeTeam':2, 
       'goalsAwayTeam':1}, 
      'homeTeam':{'team_id': 2}, 
      'awayTeam':{'team_id': 3}},
     {'dateObject':datetime.datetime.now(), 
