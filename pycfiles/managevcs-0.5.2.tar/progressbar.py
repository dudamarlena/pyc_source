...
# [GCC 8.4.0]
# Embedded file name: /Users/dzhiltsov/Development/vcslib/managevcs/utils/progressbar.py
# Compiled at: 2015-06-08 06:25:02
import sys, datetime, string
from managevcs.utils.filesize import filesizeformat
...
class ProgressBar(object):
    ...
    def get_context(self):
        return {'percentage': self.get_rendered_percentage(), 
           'bar': self.get_bar(), 
...
class AnimatedColoredProgressBar(AnimatedProgressBar, ColoredProgressBar):
    pass


class BarOnlyColoredProgressBar(ColoredProgressBar, BarOnlyProgressBar):
    pass
