...
# [GCC 8.4.0]
# Embedded file name: /Users/dzhiltsov/Development/vcslib/managevcs/tests/base.py
...
class BackendTestMixin(object):
    ...
    @classmethod
    def get_backend(cls):
        return managevcs.get_backend(cls.backend_alias)
    ...
    def tearDownClass(cls):
        if not getattr(cls, 'recreate_repo_per_test', False) and 'VCS_REMOVE_TEST_DIRS' in os.environ:
    ...
    def tearDown(self):
        if getattr(self, 'recreate_repo_per_test', False) and 'VCS_REMOVE_TEST_DIRS' in os.environ:
