...
# [GCC 8.4.0]
# Embedded file name: /Users/dzhiltsov/Development/vcslib/vcs/backends/git/config.py
# Compiled at: 2015-05-15 06:06:57
                ...
                if line[0] == '[':
                    ...
                    if len(pts) == 2:
                        if pts[1][0] != '"' or pts[1][(-1)] != '"':
                            raise ValueError('Invalid subsection ' + pts[1])
                        else:
                            pts[1] = pts[1][1:-1]
                        if not _check_section_name(pts[0]):
                            raise ValueError('invalid section name %s' % pts[0])
                        section = (
                         pts[0], pts[1])
                    else:
                        if not _check_section_name(pts[0]):
