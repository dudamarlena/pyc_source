...
# [GCC 8.4.0]
# Embedded file name: /Users/dzhiltsov/Development/vcslib/managevcs/tests/test_tags.py
...
from managevcs.exceptions import TagAlreadyExistError
from managevcs.exceptions import TagDoesNotExistError
...
class TagsTestCaseMixin(BackendTestMixin):
    ...
    def test_tag_already_exist(self):
        ...
        self.assertRaises(TagAlreadyExistError, self.repo.tag, 'last-commit', 'joe', tip.raw_id)
        chset = self.repo.get_changeset(0)
        self.assertRaises(TagAlreadyExistError, self.repo.tag, 'last-commit', 'jane', chset.raw_id)
    ...
    def test_remove_tag_which_does_not_exist(self):
        self.assertRaises(TagDoesNotExistError, self.repo.remove_tag, 'last-commit', user='evil joe')
