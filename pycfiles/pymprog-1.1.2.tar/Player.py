...
# Embedded file name: build/bdist.linux-x86_64/egg/pympris/Player.py
...
class Player(Base):
    ...
    def Seek(self, offset):
        u"""Seeks forward in the current track
        Parameters
    ...
    def SetPosition(self, track_id, position):
        u"""Sets the current track position in microseconds.
        Parameters
