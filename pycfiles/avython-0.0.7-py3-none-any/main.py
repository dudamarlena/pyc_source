...
# [GCC 8.4.0]
# Embedded file name: avython/gitautotag/main.py
...
class GitAutotag(object):
    ...
    def __init__(self, args):
        ...
        parser.add_argument('-r', '--revision', choices=self.__revision_list, help=('Revision of release. Choices: {}').format(str(self.__revision_list)))
    ...
    def list_tags(self, cached=True):
        if not self.__list_tags or cached is False:
            self.__list_tags = self.run_parse('tag', '-l', self.version_pattern)
