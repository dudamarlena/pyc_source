...
# [GCC 8.4.0]
# Embedded file name: /home/prometeo/cosas/avython/avython/download/main.py
...
class Download(object):
    ...
    @property
    def host_path(self):
        self.check_emtpy(self._Download__host_path, 'No host path')
        return self._Download__host_path

    @host_path.setter
    def host_path(self, value):
        self._Download__host_path = value

    @property
    def host_file(self):
        self.check_emtpy(self._Download__host_file, 'No host file')
        return self._Download__host_file

    @host_file.setter
    def host_file(self, value):
        self._Download__host_file = value
    ...
    def get(self):
        ...
        if self.unzip:
            ...
            process = subprocess.Popen(('unzip {} -d {}'.format(os.path.join(self.get_host_tmp_path(), self.get_host_tmp_file()), tmp_unzip_folder)),
              shell=True)
            process.wait()
