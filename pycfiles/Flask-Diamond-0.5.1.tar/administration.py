...
# [GCC 8.4.0]
# Embedded file name: /Users/idm/Work/flask-diamond/flask_diamond/facets/administration.py
# Compiled at: 2016-12-31 11:36:52
...
def init_administration(self, index_view=None, user=None, role=None):
    ...
    >>> )
    """
    admin = Admin(name=self.app.config['PROJECT_NAME'], base_template='admin/login_base.html', index_view=index_view or ForceLoginView(name='Home'))
    from .. import db
...
class UserView(AdminModelView):
    ...
    def create_model(self, form):
        self.model.register(name=form.data['name'], email=form.data['email'], password=form.data['password'], confirmed=True, roles=[
         'User'])
