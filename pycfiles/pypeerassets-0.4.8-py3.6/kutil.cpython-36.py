...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pypeerassets/kutil.py
# Compiled at: 2018-07-27 06:56:35
...
class Kutil:
    ...
    def __init__(self, network: str, privkey: bytearray=None, from_string: str=None, from_wif: str=None) -> None:
        """
        ...
        if from_wif is not None:
            self._private_key = PrivateKey.from_wif(wif=from_wif, network=(self.constants))
        if not privkey:
    ...
    def sign_transaction(self, txins: Union[TxOut], tx: MutableTransaction) -> MutableTransaction:
