...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/FSTA/group.py
# Compiled at: 2017-01-01 15:41:23
...
class group(object):
    ...
    def __init__(self, name, hotword='./resources/hotwords/snowboy.umdl', mqtt_hotword_topic=None, scenarios=[], always_actions=[]):
        """Initialisation
