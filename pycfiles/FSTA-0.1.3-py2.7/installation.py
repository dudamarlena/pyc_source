...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/FSTA/installation.py
# Compiled at: 2017-01-01 15:38:53
import sys, signal, time, paho.mqtt.client, threading, logging, max7219.led as led, speech_recognition as sr, snowboydecoder, os
