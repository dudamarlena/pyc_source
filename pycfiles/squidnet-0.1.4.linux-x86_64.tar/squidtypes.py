...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/squidnet/squidtypes.py
# Compiled at: 2010-04-07 10:18:41
from squidnet.squidtypereg import squidtypes
from squidnet import sexp
from squidnet.combomethods import *
__aall__ = ('SquidBase64FileType', 'SquidBooleanType', 'SquidColorType', 'SquidEnumType',
            'SquidIntegerType', 'SquidRangeType', 'SquidStringType', 'SquidValue',
            'squidtypes', 'SquidEnumFactory')
...
def SquidEnumFactory(*choices):
    return type('SquidEnumValue', (SquidEnumValueBase,), {'choices': list(map(str, choices))})
