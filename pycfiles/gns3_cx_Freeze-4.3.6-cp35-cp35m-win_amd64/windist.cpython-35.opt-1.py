...
# Size of source mod 2**32: 18919 bytes
import distutils.command.bdist_msi, distutils.errors, distutils.util, msilib, os
__all__ = [
 'bdist_msi']
...
class bdist_msi(distutils.command.bdist_msi.bdist_msi):
    ...
    def add_prepare_dialog(self):
        ...
        dialog.text('Description', 15, 70, 320, 40, 196611, 'Please wait while the installer prepares to guide you throughthe installation.')
    ...
    def run(self):
        ...
        self.db = msilib.init_database(self.target_name, msilib.schema, self.distribution.metadata.name, msilib.gen_uuid(), sversion, author)
