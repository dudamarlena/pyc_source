...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/cerberus/user_auth.py
...
class UserAuth(object):
    __doc__ = 'Class to authenticate with username and password and returns a cerberus token'
    ...
    def get_mfa(self, auth_resp):
        ...
        mfa_resp = post_with_retry((self.cerberus_url + '/v2/auth/mfa_check'),
