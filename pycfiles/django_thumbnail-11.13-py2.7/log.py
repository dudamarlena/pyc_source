...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/sorl/thumbnail/log.py
...
class ThumbnailLogHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        if not settings.ADMINS:
            ...
            msg = EmailMessage('[sorl-thumbnail] %s: %s' % (record.levelname, request_path), message, settings.SERVER_EMAIL, [ a[1] for a in settings.ADMINS ], connection=None)
