...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/sorl/thumbnail/templatetags/thumbnail.py
...
register = Library()
kw_pat = re.compile('^(?P<key>[\\w]+)=(?P<value>.+)$')
...
class ThumbnailNode(ThumbnailNodeBase):
    ...
    error_msg = 'Syntax error. Expected: ``thumbnail source geometry [key1=val1 key2=val2...] as var``'
