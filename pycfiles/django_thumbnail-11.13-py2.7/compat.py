...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-intel/egg/sorl/thumbnail/admin/compat.py
    ...
    def render(self, name, value, attrs=None):
        ...
        if value and hasattr(value, 'url'):
            try:
                ...
                output = '<div style="float:left"><a style="width:%spx;display:block;margin:0 0 10px" class="thumbnail" target="_blank" href="%s"><img src="%s"></a>%s</div>' % (
...
class AdminClearWidget(forms.CheckboxInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        output = '<div style="clear:both;padding-top:5px"><label for="id_%s">%s:</label>%s</div>' % (
...
class AdminImageMixin(object):
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        if isinstance(db_field, ImageField):
            ...
            return db_field.formfield(form_class=ClearableImageFormField, widget=AdminClearableImageWidget)
