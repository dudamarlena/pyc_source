...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/jps/subscriber.py
# Compiled at: 2016-06-11 06:32:43
import threading, time, types, zmq
...
class Subscriber(object):
    ...
    def __init__(self, topic_name, callback=None, host=None, sub_port=None, deserializer='DEFAULT'):
        ...
        self._socket.connect(('tcp://{host}:{port}').format(host=host, port=sub_port))
    ...
    def spin_once(self, polling_sec=0.01):
        r"""Read the queued data and call the callback for them.
