...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/jps/publisher.py
...
class Publisher(object):
    ...
    def __init__(self, topic_name, host=None, pub_port=None, serializer='DEFAULT'):
        ...
        self._socket.connect(('tcp://{host}:{port}').format(host=host, port=pub_port))
