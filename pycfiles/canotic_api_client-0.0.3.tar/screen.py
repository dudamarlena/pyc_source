...
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/canossa/screen.py
...
class SupportsExtendedModeTrait():
    ...
    def init_modemap(self):
        self._decset_map = {3: self._set_deccolm, 
           6: self._set_decom, 
           7: self._set_decawm, 
        ...
        self._decrst_map = {3: self._reset_deccolm, 
           6: self._reset_decom, 
...
class IScreenImpl(IScreen):
    ...
    def getyx(self):
        ...
        if widget:
            ...
            return (
             cursor.row + top, cursor.col + left)
        cursor = self.cursor
        return (
...
class Screen(IScreenImpl, IFocusListenerImpl, IMouseListenerImpl, SupportsAnsiModeTrait, SupportsExtendedModeTrait, SupportsTabStopTrait, SupportsDoubleSizedTrait, SuuportsCursorPersistentTrait, SuuportsAlternateScreenTrait, SuuportsISO2022DesignationTrait):
    parent = None
