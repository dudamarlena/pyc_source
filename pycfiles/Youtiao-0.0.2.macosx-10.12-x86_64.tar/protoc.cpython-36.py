...
# [GCC 8.4.0]
# Embedded file name: /Users/quhujun/.pyenv/versions/3.6.0/Python.framework/Versions/3.6/lib/python3.6/site-packages/youtiao/commands/protoc.py
# Compiled at: 2018-05-08 06:16:44
...
@click.command()
@click.option('--proto-path', required=True, type=click.Path(exists=True, dir_okay=False, resolve_path=True), help='path of protobuf file')
@click.option('--out', type=click.Path(exists=True, file_okay=False, resolve_path=True), help='output files location',
  default=None)
