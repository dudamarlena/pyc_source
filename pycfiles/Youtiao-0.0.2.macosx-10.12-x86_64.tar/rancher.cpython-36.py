...
# [GCC 8.4.0]
# Embedded file name: /Users/quhujun/.pyenv/versions/3.6.0/Python.framework/Versions/3.6/lib/python3.6/site-packages/youtiao/utils/rancher.py
# Compiled at: 2018-05-04 05:39:56
...
class RancherClient(object):
    ...
    def service_info(self, environment_id: str, stack_name: str, service_name: str) -> Dict:
        ...
        if not environment_id:
            ...
            r = self.s.get(('{}/projects/{}/stacks'.format(self.endpoint_url, environment_id)), params={'limit':1000, 
             'name':stack_name})
            r.raise_for_status()
            data = r.json()['data']
            if not data:
                ...
                r = self.s.get(('{}/projects/{}/services'.format(self.endpoint_url, environment_id)), params={'name': service_name})
                r.raise_for_status()
                data = r.json()['data']
                return data or None
    ...
    def service_finish_upgrade(self, environment_id: str, service_id: str) -> Dict:
        ...
        if data['state'] == 'active':
            ...
            r = self.s.post(('{}/projects/{}/services/{}/'.format(self.endpoint_url, environment_id, service_id)), params={'action': 'finishupgrade'})
            r.raise_for_status()
            retry = 0
    ...
    def service_upgrade(self, environment_id: str, service_id: str, batch_size: int=1, batch_interval: int=2, sidekicks: bool=False, start_before_stopping: bool=False) -> Dict:
        """
        Upgrade service
        ...
        upgrade_input = {'inServiceStrategy': {'batchSize':batch_size, 
        ...
        r = self.s.post(('{}/projects/{}/services/{}/'.format(self.endpoint_url, environment_id, service_id)), params={'action': 'upgrade'},
          json=upgrade_input)
        r.raise_for_status()
        return r.json()