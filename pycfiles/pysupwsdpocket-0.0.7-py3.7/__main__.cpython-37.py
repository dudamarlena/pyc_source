...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pysupwsdpocket/__main__.py
# Compiled at: 2020-04-22 18:09:08
...
def main():
    parser = argparse.ArgumentParser(prog='pysupwsdpocket',
    ...
    parser.add_argument('-v', '--version', help='Show version.',
      action='version')
    parser.add_argument('-wsd', '--wsd', nargs=5,
      help='Run WSD')
