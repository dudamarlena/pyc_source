...
# [GCC 8.4.0]
# Embedded file name: /Users/Mardix/Dropbox/Projects/Python/webmaster/juice/cli.py
# Compiled at: 2016-03-11 02:55:19
r"""
...
"""
import os, re, sys, logging, importlib, pkg_resources, utils, click, yaml, functools, sh
...
def create_project(project_name, skel='basic'):
    ...
    files = [('%s/__init__.py' % APPLICATION_DIR, '# Juice'),
     (
...
def get_deploy_assets2s3_list(cwd, file='propel.yml'):
    ...
    if 'assets2s3' in conf:
        return conf['assets2s3']
    return []
