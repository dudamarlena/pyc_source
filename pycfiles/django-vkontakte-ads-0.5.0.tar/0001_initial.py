...
# [GCC 8.4.0]
# Embedded file name: /Users/ramusus/workspace/manufacture/env/src/django-vkontakte-ads/vkontakte_ads/migrations/0001_initial.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vkontakte_ads_image', (
         (
          'fetched', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
         (
        ...
        db.send_create_signal('vkontakte_ads', ['Image'])
        db.create_table('vkontakte_ads_targetingstats', (
         (
        ...
        db.send_create_signal('vkontakte_ads', ['TargetingStats'])
        db.create_table('vkontakte_ads_statistic', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'fetched', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
        ...
        db.send_create_signal('vkontakte_ads', ['Statistic'])
        db.create_unique('vkontakte_ads_statistic', ['content_type_id', 'object_id', 'day', 'month', 'overall'])
        db.create_table('vkontakte_ads_budget', (
         (
          'fetched', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
         (
        ...
        db.send_create_signal('vkontakte_ads', ['Budget'])

    def backwards(self, orm):
        db.delete_unique('vkontakte_ads_statistic', ['content_type_id', 'object_id', 'day', 'month', 'overall'])
        ...
        db.delete_table('vkontakte_ads_image')
        db.delete_table('vkontakte_ads_targetingstats')
        db.delete_table('vkontakte_ads_statistic')
        db.delete_table('vkontakte_ads_budget')
    ...
    models = {'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'vkontakte_ads.account': {'Meta': {'ordering': "['remote_id']", 'object_name': 'Account'}, 'access_role': (
       ...
       'vkontakte_ads.ad': {'Meta': {'ordering': "['name']", 'object_name': 'Ad'}, 'account': (
                                      'django.db.models.fields.related.ForeignKey', [], {'related_name': "'bulk_ads'", 'to': "orm['vkontakte_ads.Account']"}), 
                            'all_limit': (
                            ...
                            'archived': (
                                       'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                            'campaign': (
                                       'smart_selects.db_fields.ChainedForeignKey', [], {'related_name': "'bulk_ads'", 'to': "orm['vkontakte_ads.Campaign']"}), 
                            'cost_type': (
                                        'django.db.models.fields.PositiveSmallIntegerField', [], {}), 
                            'cpc': (
                                  'vkontakte_api.fields.IntegerRangeField', [], {'null': 'True', 'blank': 'True'}), 
                            'cpm': (
                            ...
                            'fetched': (
                                      'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                            'name': (
                                   'vkontakte_api.fields.CharRangeLengthField', [], {'max_length': '100'}), 
                            'remote_id': (
                                        'django.db.models.fields.BigIntegerField', [], {'primary_key': 'True'}), 
                            'status': (
                                     'django.db.models.fields.BooleanField', [], {'default': 'False'})}, 
       'vkontakte_ads.budget': {'Meta': {'object_name': 'Budget'}, 'account': (
                                          'django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_ads.Account']", 'primary_key': 'True'}), 
                                'budget': (
                                         'django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}), 
                                'fetched': (
                                          'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})}, 
       'vkontakte_ads.campaign': {'Meta': {'ordering': "['name']", 'object_name': 'Campaign'}, 'account': (
                                            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'campaigns'", 'to': "orm['vkontakte_ads.Account']"}), 
                                  'all_limit': (
                                              'django.db.models.fields.IntegerField', [], {'null': 'True'}), 
                                  'archived': (
                                             'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                  'client': (
                                           'smart_selects.db_fields.ChainedForeignKey', [], {'blank': 'True', 'related_name': "'campaigns'", 'null': 'True', 'to': "orm['vkontakte_ads.Client']"}), 
                                  'day_limit': (
                                              'django.db.models.fields.IntegerField', [], {'null': 'True'}), 
                                  'fetched': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 'name': (
                                         'vkontakte_api.fields.CharRangeLengthField', [], {'max_length': '60'}), 
                                  'remote_id': (
                                              'django.db.models.fields.BigIntegerField', [], {'primary_key': 'True'}), 
                                  'start_time': (
                                  ...
                                  'stop_time': (
                                              'django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})}, 
       'vkontakte_ads.client': {'Meta': {'object_name': 'Client'}, 'account': (
                                          'django.db.models.fields.related.ForeignKey', [], {'related_name': "'clients'", 'to': "orm['vkontakte_ads.Account']"}), 
                                'all_limit': (
                                            'django.db.models.fields.IntegerField', [], {'null': 'True'}), 
                                'archived': (
                                           'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                ...
                                'remote_id': (
                                            'django.db.models.fields.BigIntegerField', [], {'primary_key': 'True'})}, 
       'vkontakte_ads.image': {'Meta': {'object_name': 'Image'}, 'ad': (
                                    'django.db.models.fields.related.OneToOneField', [], {'related_name': "'image'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['vkontakte_ads.Ad']"}), 
                               'aid': (
                                     'django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}), 
                               'fetched': (
                                         'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                               ...
                               'width': (
                                       'django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})}, 
       'vkontakte_ads.layout': {'Meta': {'ordering': "['ad']", 'object_name': 'Layout'}, 'ad': (
                                     'django.db.models.fields.related.OneToOneField', [], {'related_name': "'layout'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['vkontakte_ads.Ad']"}), 
                                'campaign': (
                                           'django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_ads.Campaign']"}), 
                                'description': (
                                              'vkontakte_api.fields.CharRangeLengthField', [], {'max_length': '100'}), 
                                'fetched': (
                                          'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                                ...
                                'preview_link': (
                                               'django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}), 
                                'title': (
                                        'vkontakte_api.fields.CharRangeLengthField', [], {'max_length': '50'})}, 
       'vkontakte_ads.statistic': {'Meta': {'unique_together': "(('content_type', 'object_id', 'day', 'month', 'overall'),)", 'object_name': 'Statistic'}, 'clicks': (
                                   ...
                                   'join_rate': (
                                               'django.db.models.fields.FloatField', [], {'null': 'True'}), 
                                   'month': (
                                           'django.db.models.fields.CharField', [], {'max_length': '7'}), 
                                   'object_id': (
                                   ...
                                   'video_views': (
                                                 'django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})}, 
       'vkontakte_ads.targeting': {'Meta': {'ordering': "['ad']", 'object_name': 'Targeting'}, 'ad': (
                                        'django.db.models.fields.related.OneToOneField', [], {'related_name': "'targeting'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['vkontakte_ads.Ad']"}), 
                                   'age_from': (
                                   ...
                                   'approved': (
                                              'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                   'birthday': (
                                              'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '100', 'blank': 'True'}), 
                                   'browsers': (
                                              'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '500', 'blank': 'True'}), 
                                   'campaign': (
                                              'django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_ads.Campaign']"}), 
                                   'cities': (
                                            'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '500', 'blank': 'True'}), 
                                   ...
                                   'groups': (
                                            'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '500', 'blank': 'True'}), 
                                   'interests': (
                                               'vkontakte_api.fields.CommaSeparatedCharField', [], {'max_length': '500', 'blank': 'True'}), 
                                   'operators': (
                                               'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '500', 'blank': 'True'}), 
                                   'positions': (
                                               'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '500', 'blank': 'True'}), 
                                   ...
                                   'streets': (
                                             'django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '500', 'blank': 'True'}), 
                                   'tags': (
                                          'vkontakte_api.fields.CommaSeparatedCharField', [], {'max_length': '200', 'blank': 'True'}), 
                                   'travellers': (
                                                'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                                   'uni_from': (
                                              'django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}), 
                                   'uni_to': (
                                            'django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})}, 
       'vkontakte_ads.targetingstats': {'Meta': {'object_name': 'TargetingStats'}, 'audience_count': (
                                                         'django.db.models.fields.PositiveIntegerField', [], {}), 
                                        'fetched': (
                                                  'django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}), 
                                        'id': (
