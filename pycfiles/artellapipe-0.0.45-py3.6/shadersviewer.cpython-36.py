...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/shadersviewer.py
# Compiled at: 2020-05-03 00:51:52
# Size of source mod 2**32: 8733 bytes
"""
    ...
    def refresh(self):
        ...
        for shader_extension in shaders_extensions:
            if not shader_extension.startswith('.'):
                ...
                if invalid_paths:
                    result = qtutils.show_question(None, 'Shaders Path not found!', 'Shaders Path is not sync! To start using this tool you should sync this folder first. Do you want to do it?')
