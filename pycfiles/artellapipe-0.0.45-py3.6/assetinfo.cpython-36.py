...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/assetinfo.py
    ...
    def _create_asset_files_buttons(self):
        ...
        if not self._asset_widget:
            ...
            for file_type in self._asset_widget.asset.FILES:
                ...
                file_btn = AssetFileButton(self._asset_widget, self.STATUS, file_type, file_type_name, tpDcc.ResourcesMgr().icon(file_type))
