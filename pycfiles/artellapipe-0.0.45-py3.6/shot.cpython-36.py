...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/widgets/shot.py
    ...
    def update_thumbnail_icon(self, force=False):
        ...
        try:
            ...
            if thumbnail_path and os.path.isfile(thumbnail_path) and not force:
                ...
                self._thumbnail_icon = tpDcc.ResourcesMgr().icon(artellapipe.ShotsMgr().get_default_shot_thumb())
