...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Admin\Documents\GitHub\djmicrosip\djmicrosip\system\forms.py
# Compiled at: 2015-01-28 22:14:41
from django import forms
from django.core.exceptions import ObjectDoesNotExist
from django.contrib.auth.models import User
import fdb, os
from .models import *
from djmicrosip_api.models_base.models import ConexionDB
...
class CustomAuthenticationForm(forms.Form):
    ...
    username = forms.CharField(max_length=150, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Nombre de usuario de djmicrosip'}))
