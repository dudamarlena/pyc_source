...
# [GCC 8.4.0]
# Embedded file name: C:\Users\Admin\Documents\GitHub\djmicrosip\djmicrosip\utils\db\multiple_db.py
...
class ConnectionDatabases(object):
    ...
    def get_connections_dic(self):
        ...
        connections['default'] = {'ENGINE': 'django.db.backends.sqlite3', 
        ...
        for connection in self.connections:
            ...
            connections[database_id] = {'ENGINE': 'firebird', 
               'NAME': database_name, 
               'PORT': '3050', 
               'OPTIONS': {'charset': 'ISO8859_1'}, 'USER': connection.user, 
