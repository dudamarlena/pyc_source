...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-i386/egg/instrumentino/controllers/arduino/spellman.py
# Compiled at: 2015-11-23 10:12:58
from __future__ import division
from instrumentino.controllers.arduino import SysCompArduino, SysVarDigitalArduino, SysVarAnalogArduinoUnipolar, SysVarAnalogArduinoBipolarWithExternalPolarity
__author__ = 'yoelk'
...
class Spellman(SysCompArduino):
    ...
    def __init__(self, name, rangeV, rangeI, pinEnable, pinInV, pinInI, pinOutV, pinOutI=None, highFreqPWM=False, pinsVoltsMax=5, safetyMaxAbsVoltage=None, ctlV_I2cDac=None, ctlI_I2cDac=None):
        ...
        SysCompArduino.__init__(self, name, (
         voltageVar, currentVar, varEnable), 'monitor/change High Voltage variables')
        return
