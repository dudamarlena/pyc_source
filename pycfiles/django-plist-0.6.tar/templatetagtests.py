...
# [GCC 8.4.0]
# Embedded file name: /Users/steingrd/Django/django-plist/django_plist/tests/templatetagtests.py
# Compiled at: 2010-05-19 01:29:02
from datetime import date, datetime, time
from django.db import models
from django.test import TestCase
from django_plist.templatetags.django_plist_tags import RenderPlistObjectNode, PropertyListSerializationFailedError
...
class TemplateNodeRenderTest(TestCase):
    ...
    def test_dict_key_names_is_xml_escaped(self):
        expected = '<dict><key>&lt;&gt;</key><integer>1</integer></dict>'
        fragment = render_object({'<>': 1})
        self.assertEquals(expected, fragment)

    def test_tuple_render_as_array(self):
        expected = '<array><integer>1</integer><integer>2</integer></array>'
    ...
    def test_dict_render_as_dict(self):
        expected = '<dict><key>one</key><integer>1</integer></dict>'
    ...
    def test_time_model_field(self):
        ...
        fragment = render_object(TimeModel(time=time(15, 5, 45)))
        self.assertEquals(expected, fragment)
