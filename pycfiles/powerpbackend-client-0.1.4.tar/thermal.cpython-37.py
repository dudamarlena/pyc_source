...
# Embedded file name: build/bdist.linux-x86_64/egg/powerpack/thermal.py
# Compiled at: 2020-05-10 14:01:09
# Size of source mod 2**32: 76848 bytes
...
class ThermalAnalysis(DessiaObject):
    ...
    _jsonschema = {'definitions':{},  '$schema':'http://json-schema.org/draft-07/schema#', 
     ...
     'required':[],  'properties':{'cooling_price':{'type':'number', 
       'title':'Cooling Price', 
       'examples':[
        1], 
       'editable':False, 
       'description':'Cooling Price'}, 
      'cooling_surface':{'type':'number', 
    ...
    def __init__(self, cooling_price=None, cooling_surface=None, grid_0=None, grid_1=None, grid_2=None, normal_face_cooling=None, internal_cooling=None, use_two_faces=None, alpha=None, htc_mean=None, htc_min=None, htc_max=None, dispersed_power_mean=None, dispersed_power_min=None, dispersed_power_max=None, name=''):
    ...
    def __hash__(self):
        hash_ = int(hash(self.cooling_price) + hash(self.cooling_surface) + hash(self.htc_mean) % 1000000.0)
        return hash_
...
class SpecsCooling(DessiaObject):
    ...
    _jsonschema = {'$schema':'http://json-schema.org/draft-07/schema#', 
     ...
     'required':[
      'internal_parameter', 'thermal_transfer_coefficient_min', 'thermal_transfer_coefficient_max'], 
     'properties':{'thermal_transfer_coefficient_min':{'type':'object', 
      ...
      'thermal_transfer_coefficient_max':{'type':'object', 
      ...
      'title':{'type':'string', 
       ...
       'description':'Title', 
       'order':3}, 
      'internal_parameter':{'type':'number', 
    ...
    def __init__(self, internal_parameter, thermal_transfer_coefficient_min, thermal_transfer_coefficient_max, title='', name=''):
    ...
    def __eq__(self, other_cell):
        equal = self.internal_parameter == other_cell.internal_parameter and self.thermal_transfer_coefficient_min == other_cell.thermal_transfer_coefficient_min and self.thermal_transfer_coefficient_max == other_cell.thermal_transfer_coefficient_max
        return equal
    ...
    def update(self, alpha, thermal_transfer_coefficient):
        ...
        """
        x, y = [], []
        for evol_min_x, evol_min_y, evol_max_x, evol_max_y in zip(self.thermal_transfer_coefficient_min.x, self.thermal_transfer_coefficient_min.y, self.thermal_transfer_coefficient_max.x, self.thermal_transfer_coefficient_max.y):
    ...
    def Plot(self, thermal_transfer_coefficient=None, a=None):
        ...
        points = []
        curves = []
        li_thermal_transfer_coefficient = [
         self.thermal_transfer_coefficient_min, self.thermal_transfer_coefficient_max]
    ...
    def DictToObject(cls, d):
        ...
        """
        specs = cls(internal_parameter=(d['internal_parameter']), thermal_transfer_coefficient_min=(electrical.CombinationEvolution.DictToObject(d['thermal_transfer_coefficient_min'])),
...
class CombinationSpecsCooling(DessiaObject):
    ...
    _jsonschema = {'$schema':'http://json-schema.org/draft-07/schema#', 
     ...
     'required':[
      'specs_coolings'], 
     'properties':{'specs_coolings':{'type':'array', 
       ...
       'items':{'type':'object', 
        'classes':[
         'powerpack.thermal.SpecsCooling']}}, 
      'title':{'type':'string', 
       'title':'Title', 
       'examples':[
        'Title'], 
    ...
    def Plotevaluate(self, alpha, power, thermal_transfer_coefficient, internal_parameter, thermal_transfer_coefficients_other=None, discret=10, a=None):
        """
        Plot all the SpecsCooling curve include in the specs_coolings attribute
        and a thermal_transfer_coefficient curve interpolate with alpha and internal_parameter input
        """
        h_estim = self.evaluate(alpha, power, thermal_transfer_coefficient, internal_parameter, discret)
    ...
    def Interp(self, alpha, thermal_transfer_coefficient, internal_parameter, discret=10):
        ...
        x, y = [], []
        for x_t1, y_t1, x_t2, y_t2 in zip(matrix_interp[0][0], matrix_interp[0][1], matrix_interp[1][0], matrix_interp[1][1]):
...
class CoolingComponent(DessiaObject):
    ...
    _jsonschema = {'$schema':'http://json-schema.org/draft-07/schema#', 
     ...
     'required':[
      'combination_specs_cooling', 'thermal_capacity'], 
     'properties':{'combination_specs_cooling':{'type':'object', 
       'title':'Combination Specs Cooling', 
       'classes':[
        'powerpack.thermal.CombinationSpecsCooling'], 
       'order':1, 
       'editable':True, 
       'description':'Combination specs cooling'}, 
      'thermal_capacity':{'type':'number', 
      ...
      'delta_internal_variable':{'type':'number', 
    ...
    def __init__(self, combination_specs_cooling, thermal_capacity, delta_internal_variable=None, coeff_a_price=None, coeff_b_price=None, name=''):
    ...
    def __eq__(self, other_cell):
        equal = self.combination_specs_cooling == other_cell.combination_specs_cooling and self.thermal_capacity == other_cell.thermal_capacity and self.delta_internal_variable == other_cell.delta_internal_variable and self.coeff_a_price == other_cell.coeff_a_price and self.coeff_b_price == other_cell.coeff_b_price
        return equal
    ...
    def max_htc(self, internal_parameter=293):
        ...
        """
        thermal_transfer_coefficient = electrical.CombinationEvolution(evolution1=[electrical.Evolution()], evolution2=[
        ...
        def fun(x):
            return 1 / self.evaluate(alpha=1, power=x, thermal_transfer_coefficient=thermal_transfer_coefficient, internal_parameter=internal_parameter) ** 2

        res = minimize_scalar(fun, bounds=(min(thermal_transfer_coefficient.x),
         max(thermal_transfer_coefficient.x)),
          method='bounded')
        return self.evaluate(alpha=1, power=(res.x), thermal_transfer_coefficient=thermal_transfer_coefficient, internal_parameter=internal_parameter)

    def evaluate(self, alpha, power, thermal_transfer_coefficient, internal_parameter=293):
        h = self.combination_specs_cooling.evaluate(alpha=alpha, power=power, thermal_transfer_coefficient=thermal_transfer_coefficient,
    ...
    def DictToObject(cls, d):
        ...
        specs = cls(combination_specs_cooling=combination_specs_cooling, thermal_capacity=(d['thermal_capacity']),
...
class CoolingCatalog(DessiaObject):
    ...
    _jsonschema = {'$schema':'http://json-schema.org/draft-07/schema#', 
     ...
     'required':[
      'cooling_components'], 
     'properties':{'cooling_components': {'type':'array', 
                             'order':1, 
                             'editable':True, 
                             'description':'Cooling components', 
                             'items':{'type':'object', 
                              'classes':[
                               'powerpack.thermal.CoolingComponent']}}}}
    _display_angular = []
...
class ThermalModule(DessiaObject):
    ...
    _jsonschema = {'$schema':'http://json-schema.org/draft-07/schema#', 
     ...
     'required':[
      'mech_module', 'cell_size', 'cooling_component', 'face'], 
     'properties':{'mech_module':{'type':'object', 
      ...
      'number_cooling_surface':{'type':'number', 
       'order':8, 
       'step':1, 
       'minimum':0, 
       'examples':[
      ...
      'number_cooling_surface_elem':{'type':'number', 
       'order':9, 
       'step':1, 
       'minimum':0, 
       'examples':[
      ...
      'direction_face_cooling':{'type':'number', 
       'order':10, 
       'step':1, 
       'minimum':0, 
       'examples':[
      ...
      'coeff_number_cooling_price':{'type':'number', 
       'order':11, 
       'step':0.001, 
       'minimum':0, 
       'examples':[
    ...
    def __init__(self, mech_module, cell_size, cooling_component, face, use_two_faces=None, internal=None, cooling_surface=None, number_cooling_surface=None, number_cooling_surface_elem=None, direction_face_cooling=None, coeff_number_cooling_price=None, name=''):
    ...
    def __eq__(self, other_cell):
        equal = self.mech_module == other_cell.mech_module and self.cell_size == other_cell.cell_size and self.cooling_component == other_cell.cooling_component and self.face == other_cell.face and self.use_two_faces == other_cell.use_two_faces and self.number_cooling_surface == other_cell.number_cooling_surface and self.coeff_number_cooling_price == other_cell.coeff_number_cooling_price and self.internal == other_cell.internal and self.number_cooling_surface_elem == other_cell.number_cooling_surface_elem and self.direction_face_cooling == other_cell.direction_face_cooling and self.cooling_surface == other_cell.cooling_surface
        return equal

    def __hash__(self):
        tm_hash = hash(self.mech_module) + hash(self.cooling_component)
        return tm_hash
    ...
    def DictToObject(cls, d):
        ...
        specs = cls(mech_module=mech_module, cell_size=(d['cell_size']),
...
class ThermalModuleResult(DessiaObject):
    ...
    def __init__(self, temperature=None, internal_variable=None, alpha=None, dispersed_power=None, electric_power=None, internal_power=None, htc=None, time=None, name=''):
    ...
    def __eq__(self, other):
        equal = self.temperature == other.temperature and self.internal_variable == other.internal_variable and self.alpha == other.alpha and self.dispersed_power == other.dispersed_power and self.electric_power == other.electric_power and self.internal_power == other.internal_power and self.htc == other.htc and self.time == other.time
        return equal

    def __hash__(self):
        li_hash = hash(self.temperature) + hash(self.internal_variable) + hash(self.alpha) + hash(self.dispersed_power) + hash(self.electric_power) + hash(self.internal_power) + hash(self.htc) + hash(self.time)
        return li_hash

    def Add(self, temperature, internal_variable, dispersed_power, electric_power, internal_power, htc, delta_t):
    ...
    def DictToObject(cls, d):
        ...
        specs = cls(temperature=temperature, internal_variable=internal_variable,
          alpha=(d['alpha']),
...
class PowerPackThermalSimulator(DessiaObject):
    """PowerPackThermalSimulator"""
    _standalone_in_db = True
    _jsonschema = {'$schema':'http://json-schema.org/draft-07/schema#', 
     'definitions':{},  'type':'object', 
     'title':'powerpack.thermal.PowerPackThermalSimulator Base Schema', 
     'required':[
      'powerpack_electric_simulator', 'thermal_module', 'module_temperature_init',
      'module_temperature_max', 'cooling_temperature'], 
     'properties':{'powerpack_electric_simulator':{'type':'object', 
       'title':'Powerpack Electric Simulator', 
       'classes':[
        'powerpack.electrical.PowerPackElectricSimulator'], 
       'order':1, 
       'editable':True, 
       'description':'Electric powerpack simulation'}, 
      'thermal_module':{'type':'object', 
       'title':'Thermal Module', 
       'classes':[
        'powerpack.thermal.ThermalModule'], 
       'order':2, 
       'editable':True, 
       'description':'Thermal module'}, 
      'module_temperature_init':{'type':'number', 
       ...
       'examples':[
        273]}, 
      'module_temperature_max':{'type':'number', 
       ...
       'examples':[
        273]}, 
      'cooling_temperature':{'type':'number', 
       ...
       'examples':[
        273]}, 
      'thermal_module_results':{'type':'array', 
       ...
       'items':{'type':'object', 
        'classes':[
         'powerpack.thermal.ThermalModuleResult']}}, 
      'dtime_power':{'type':'number', 
       'title':'Dtime Power', 
       'order':7, 
       'step':1, 
       'minimum':0, 
      ...
      'analysis':{'type':'object', 
       ...
       'classes':[
        'powerpack.thermal.ThermalAnalysis'], 
       'description':'PowerPack Analysis', 
       'editable':False}}}
    _allowed_methods = [
     'Simulate']

    def __init__(self, powerpack_electric_simulator, thermal_module, module_temperature_init, module_temperature_max, cooling_temperature, thermal_module_results=None, dtime_power=None, analysis=None, name=''):
    ...
    def __eq__(self, other):
        equal = self.thermal_module == other.thermal_module and self.module_temperature_init == other.module_temperature_init and self.module_temperature_max == other.module_temperature_max and self.cooling_temperature == other.cooling_temperature and self.dtime_power == other.dtime_power and self.powerpack_electric_simulator == other.powerpack_electric_simulator
        if self.thermal_module_results is not None and other.thermal_module_results is not None:
            ...
            equal = self.thermal_module_results is None and other.thermal_module_results is None or 
        return equal
    ...
    def _quick_analysis(self):
        ...
        self.analysis = ThermalAnalysis(cooling_price, cooling_surface, grid_0, grid_1, grid_2, normal_face_cooling, internal_cooling, use_two_faces, alpha, htc_mean, htc_min, htc_max, dispersed_power_mean, dispersed_power_min, dispersed_power_max)
    ...
    def Simulate(self, alpha, thermal_transfer_coefficient=None, progress_callback=lambda x: 0):
        ...
        for num_result, (dtime, power_analysis) in enumerate(zip(dtimes, li_power_analysis)):
            ...
            valid_profil_i = self.SimulateElementary(alpha, thermal_transfer_coefficient, dtime=dtime,
    ...
    def SimulateElementary(self, alpha, thermal_transfer_coefficient, dtime, power_analysis, thermal_module_result):
        ...
        def fun(x, electric_power, module_temperature_m, dt):
            ...
            cooling_surface = self.thermal_module.cooling_surface
            htc = self.thermal_module.cooling_component.evaluate(alpha, abs(dispersed_power), thermal_transfer_coefficient, internal_variable)
            h_cooling_elem = htc * (cooling_surface / self.thermal_module.number_cooling_surface_elem)
            h_cell = cell.eval_thermal_transfer(module_temperature, self.thermal_module.direction_face_cooling)
        ...
        def fineq(x, electric_power, module_temperature_m, dt):
            ...
            ineq.append(1e-06 - (dispersed_power_estimate - dispersed_power))
            ineq.append(dispersed_power_estimate - dispersed_power + 1e-06)
            ineq.append(1e-06 - (U - electric_power - dispersed_power_estimate))
            ineq.append(U - electric_power - dispersed_power_estimate - -1e-06)
            return ineq
        ...
        for i, power_elec in enumerate(power_analysis):
            ...
            for itera in range(0, 5):
                ...
                res = minimize(fun, x0, bounds=bound, args=(power_elec,
                 module_temperature_m, dtime),
                  constraints=cons)
                if min(fineq(res.x, power_elec, module_temperature_m, dtime)) > -1e-06:
                    sol_x = res.x
                    ...
                    thermal_module_result.Add(module_temperature, internal_variable, dispersed_power, power_elec, U, H_global, dtime)
                    valid = True
            ...
            if not valid:
                ...
                if module_temperature <= self.module_temperature_max:
                    valid = True
                    thermal_module_result.Add(module_temperature, 0, 0, power_elec, U, 0, dtime)
    ...
    def DictToObject(cls, d):
        ...
        if 'analysis' in d and d['analysis'] is not None:
            ...
            analysis = None
        specs = cls(powerpack_electric_simulator=powerpack_electric_simulator, thermal_module=(ThermalModule.DictToObject(d['thermal_module'])),
