...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/sockspy/socks_impl/socks5.py
# Compiled at: 2017-07-30 10:27:00
...
class Socks5Engine(engine.SocksEngine):
    ...
    def get_handler_in_protocol_validation(self, status, endpoint):
        return {engine.ProtocolStatus.Init: self.validate_method, 
         Socks5Status.MethodValidated: self.method_validated, 
         Socks5Status.ValidateRequest: self.validate_request, 
         Socks5Status.Failed: self.error_response}.get(status)
