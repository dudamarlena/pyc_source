...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/softwarefabrica/django/crud/crud.py
# Compiled at: 2010-04-19 07:24:14
"""
CRUD functionality.
"""
...
class ViewCall(object):
    ...
    def __init__(self, request, view, view_args=None, view_kwargs=None, *args, **kwargs):
        ...
        self.c_page = None
        self.c_page_num = None
        self.c_page_obj = None
        self.c_object_list = None
        self.c_is_paginated = None
        return

    def __repr__(self):
        return '<ViewCall view:%s.%s args:%s kwargs:%s>' % (self.view.__class__.__module__, self.view.__class__.__name__, repr(self.view_args), repr(self.view_kwargs))
...
class View(object):
    ...
    NOT_AUTHORIZED_MSG = 'Access not authorized.'
    VIEWCALL_CLASS = ViewCall
    CACHE_TEMPLATE = True
    _TEMPLATE_CACHE = {}
    __name__ = 'View'

    def __init__(self, template_name=None, template_loader=None, extra_context=None, login_required=None, context_processors=None, cache_template=None, viewcall_class=None):
        """
...
class GenericView(View):
    ...
    def __init__(self, model=None, form_class=None, template_name=None, template_loader=None, extra_context=None, login_required=None, context_processors=None, fields=None, exclude=None, fieldorder=None, formfield_callback=None, formbase=None, viewcall_class=None):
        """
        Arguments:
    ...
    def get_template(self, vcall, template_name=None, template_loader=None):
        ...
        template_name = template_name or ('%s/%s_form.html' % (app_label, object_name), '%s/object_form.html' % app_label, '%s_form.html' % object_name, 'object_form.html')
        vcall.c_template_name = template_name
        return super(GenericView, self).get_template(vcall, template_name=template_name, template_loader=template_loader)

    def get_model_and_form_class(self, vcall, model=None, form_class=None, fields=None, exclude=None, formfield_callback=None, formbase=None, popup_models=None):
        """
        ...
        if form_class and hasattr(form_class, '_meta') and hasattr(form_class._meta, 'model'):
            ...
            return self
        if model:
            form_class = modelform_factory(model, form=formbase, fields=fields, exclude=exclude, formfield_callback=formfield_callback)
            vcall.c_model = model
            vcall.c_form_class = form_class
            return self
        raise GenericViewError('%s view must be called with either a model or form_class argument.' % (self.__class__.__name__,))
...
class CreateObjectView(GenericView):
    ...
    def __call__(self, request, *args, **kwargs):
        ...
        if login_required:
            ...
            if request.method == 'POST' and form.is_valid():
                ...
                raise vcall.c_instance == new_object or AssertionError
    ...
    def dismiss_popup(self, vcall, request, obj):
        ...
        return HttpResponse('<script type="text/javascript">opener.dismissRelatedAddPopup(window, "%s", "%s");</script>' % (escape(obj._get_pk_val()), escape(obj)))
    ...
    def get_redirect(self, vcall, request, post_save_redirect=None, obj=None):
        ...
        if post_save_redirect:
            ...
            raise ImproperlyConfigured('No URL to redirect to.  Either pass a post_save_redirect parameter to the generic view or define a get_absolute_url method on the Model.')
    ...
    def get_template(self, vcall, template_name=None, template_loader=None):
        ...
        app_label = model._meta.app_label
        object_name = model._meta.object_name.lower()
        template_name = template_name or ('%s/%s_create.html' % (app_label, object_name), '%s/object_create.html' % app_label, '%s_create.html' % object_name, 'object_create.html', 'common/object_create.html', '%s/%s_edit.html' % (app_label, object_name), '%s/object_edit.html' % app_label, '%s_edit.html' % object_name, 'object_edit.html', 'common/object_edit.html', '%s/%s_form.html' % (app_label, object_name), '%s/object_form.html' % app_label, '%s_form.html' % object_name, 'object_form.html')
        vcall.c_template_name = template_name
        return super(CreateObjectView, self).get_template(vcall, template_name=template_name, template_loader=template_loader)
...
class UpdateObjectView(CreateObjectView):
    ...
    def lookup_object(self, vcall, model=None, object_id=None, slug=None, slug_field=None):
        ...
        if object_id:
            ...
            raise GenericViewError('%s view must be called with either an object_id or a slug/slug_field.' % (self.__class__.__name__,))
        try:
            return model.objects.get(**lookup_kwargs)
        except ObjectDoesNotExist:
            raise Http404('No %s found for %s' % (force_unicode(model._meta.verbose_name), lookup_kwargs))

    def dismiss_popup(self, vcall, request, obj):
        from django.utils.html import escape
        return HttpResponse('<script type="text/javascript">opener.dismissRelatedEditPopup(window, "%s", "%s");</script>' % (escape(obj._get_pk_val()), escape(obj)))
    ...
    def get_template(self, vcall, template_name=None, template_loader=None):
        ...
        app_label = model._meta.app_label
        object_name = model._meta.object_name.lower()
        template_name = template_name or ('%s/%s_edit.html' % (app_label, object_name), '%s/object_edit.html' % app_label, '%s_edit.html' % object_name, 'object_edit.html', 'common/object_edit.html', '%s/%s_form.html' % (app_label, object_name), '%s/object_form.html' % app_label, '%s_form.html' % object_name, 'object_form.html')
        vcall.c_template_name = template_name
        return super(UpdateObjectView, self).get_template(vcall, template_name=template_name, template_loader=template_loader)
...
class DeleteObjectView(GenericView):
    ...
    def get_template(self, vcall, template_name=None, template_loader=None):
        ...
        app_label = model._meta.app_label
        object_name = model._meta.object_name.lower()
        template_name = template_name or ('%s/%s_confirm_delete.html' % (app_label, object_name), '%s/object_confirm_delete.html' % app_label, '%s_confirm_delete.html' % object_name, 'object_confirm_delete.html', 'common/object_confirm_delete.html')
        vcall.c_template_name = template_name
        return super(DeleteObjectView, self).get_template(vcall, template_name=template_name, template_loader=template_loader)
    ...
    def get_redirect(self, vcall, request, post_delete_redirect):
        ...
        if post_delete_redirect:
            ...
            raise ImproperlyConfigured('No URL to redirect to.  Pass a post_delete_redirect parameter to the generic view.')
...
class DetailObjectView(GenericView):
    ...
    def get_template(self, vcall, template_name=None, template_loader=None):
        ...
        app_label = model._meta.app_label
        object_name = model._meta.object_name.lower()
        template_name = template_name or ('%s/%s_detail.html' % (app_label, object_name), '%s/object_detail.html' % app_label, '%s_detail.html' % object_name, 'object_detail.html', 'common/object_detail.html')
        vcall.c_template_name = template_name
        return super(DetailObjectView, self).get_template(vcall, template_name=template_name, template_loader=template_loader)
...
class ListObjectView(GenericView):
    ...
    def __init__(self, queryset=None, paginate_by=None, allow_empty=None, template_object_name=None, mimetype=None, model=None, lookup_kwargs=None, *args, **kwargs):
    ...
    def get_template(self, vcall, template_name=None, template_loader=None):
        ...
        app_label = model._meta.app_label
        object_name = model._meta.object_name.lower()
        template_name = template_name or ('%s/%s_list.html' % (app_label, object_name), '%s/object_list.html' % app_label, '%s_list.html' % object_name, 'object_list.html', 'common/object_list.html')
        vcall.c_template_name = template_name
        return super(ListObjectView, self).get_template(vcall, template_name=template_name, template_loader=template_loader)
