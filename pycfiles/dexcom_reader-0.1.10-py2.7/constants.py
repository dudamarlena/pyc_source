...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dexcom_reader/constants.py
...
DEXCOM_G4_USB_VENDOR = 8867
DEXCOM_G4_USB_PRODUCT = 71
...
BATTERY_STATES = [
 None, 'CHARGING', 'NOT_CHARGING', 'NTC_FAULT', 'BAD_BATTERY']
RECORD_TYPES = [
...
TREND_ARROW_VALUES = [
 ...
 'OUT_OF_RANGE']
SPECIAL_GLUCOSE_VALUES = {0: None, 1: 'SENSOR_NOT_ACTIVE', 
   2: 'MINIMAL_DEVIATION', 
   3: 'NO_ANTENNA', 
