...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dexcom_reader/util.py
# Compiled at: 2015-12-15 13:09:56
import constants, datetime, os, platform, plistlib, re, subprocess
...
def osx_find_usbserial(vendor, product):
    ...
    sp = subprocess.Popen(['/usr/sbin/ioreg', '-k', 'IODialinDevice',
     '-r', '-t', '-l', '-a', '-x'], stdout=subprocess.PIPE, stdin=subprocess.PIPE, stderr=subprocess.PIPE)
