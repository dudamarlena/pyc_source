...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/dmath/__init__.py
# Compiled at: 2006-09-25 14:52:39
import math, decimal
...
__all__ = [
 'acos', 'asin', 'atan', 'atan2', 'ceil', 'cos', 'cosh', 'degrees', 'e', 'exp', 'floor', 'golden_ratio', 'hypot', 'log', 'log10', 'pi', 'pow', 'radians', 'sign', 'sin', 'sinh', 'sqrt', 'tan', 'tanh']