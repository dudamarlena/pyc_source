...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/hatak/plugin.py
# Compiled at: 2015-03-18 16:44:28
...
class Plugin(object):
    ...
    def add_request_plugin(self, plugin):
        ...
        self.config.add_request_method(plugin.init, plugin.name, reify=True)
