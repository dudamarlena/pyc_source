...
# Embedded file name: /Users/celine/Work/CNRS/workspace/pylmflib/examples/yuanga/setting.py
# Compiled at: 2015-10-21 08:43:50
...
mdf_lmf.update({'dialx': lambda dialx, lexical_entry: lexical_entry.set_usage_note(dialx.replace('GO(s)', 'GOs').replace('GO(n)', 'GOn').replace('WEM', 'WE'), language='nua'), 
...
partOfSpeech_tex.update({'XXX': 'unknown'})
