...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/3.4/lib/python3.4/site-packages/ftpysetup/runtest/acceptlevel.py
...
__all__ = [
 'set_accept_level', 'skip_unless_accept_level',
