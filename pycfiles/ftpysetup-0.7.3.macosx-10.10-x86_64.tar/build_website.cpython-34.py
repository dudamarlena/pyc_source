...
# [GCC 8.4.0]
# Embedded file name: /opt/local/Library/Frameworks/Python.framework/Versions/3.4/lib/python3.4/site-packages/ftpysetup/website/build_website.py
# Compiled at: 2015-01-01 14:41:46
...
__all__ = [
 'WebDistribution', 'BuildWebsite']
import sys
if sys.version_info < (3, 3):
    raise Exception('venv requires Python 3.3 or higher.')
import os, errno, shutil, configparser, subprocess, setuptools
...
class BuildWebsite(setuptools.Command):
    __doc__ = 'Generate the website from reStructured text files.'
    user_options = [
    ...
    def finalize_options(self):
        self.set_undefined_options('build', ('force', 'force'), ('debug', 'debug'))
        ...
        try:
            for dirpath, dirnames, filenames in os.walk(website):
                ...
                for f in filenames:
                    ...
                    dst = os.path.abspath(os.path.join(self.build_base, os.path.splitext(f)[0] + '.html'))
