...
# [GCC 8.4.0]
# Embedded file name: build/bdist.cygwin-2.4.1-x86_64/egg/esix/forum.py
    ...
    def __init__(self, post_id=None, post_data=None):
        ...
        if post_id is not None:
            ...
            try:
                ...
                raise errors.ForumPostNotFoundError('The requested forum ' + 'post could not be found.')
...
class Thread(object):
    ...
    def __init__(self, thread_id=None, thread_data=None):
        ...
        if thread_id is not None:
            ...
            try:
                self._op = Post(thread_id)
            except (errors.APIGetError, errors.JSONError):
                raise errors.ForumPostNotFoundError('The requested forum ' + 'thread could not be found.')
    ...
    def dump_data(self):
        ...
        :rtype: dict
        """
        return dict(self._op.dump_data(), **{'replies': [ r.dump_data() for r in self.replies ]})