...
# [GCC 8.4.0]
# Embedded file name: build/bdist.cygwin-2.4.1-x86_64/egg/esix/pool.py
# Compiled at: 2016-09-19 18:39:15
"""
    ...
    def __init__(self, pool_id=None, pool_data=None):
        ...
        if pool_id is not None:
            ...
            try:
                ...
                raise errors.PoolNotFoundError('The requested pool could ' + 'not be found.')

            if 'posts' in data:
                del data['posts']
        if pool_data is not None:
            for prop in pool_data:
                self._data[prop] = pool_data[prop]
