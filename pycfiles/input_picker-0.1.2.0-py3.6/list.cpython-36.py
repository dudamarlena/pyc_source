...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\input_picker\list.py
# Compiled at: 2018-01-04 06:35:29
# Size of source mod 2**32: 1356 bytes
import typing
from .common import Option, ExceptionOption, Picker, Stop, Help

def pick_item(source: typing.List[str], *, defidx: int=None, allow_none: bool=True, raise_on_help: bool=True) -> int:
    """
