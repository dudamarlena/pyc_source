...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\input_picker\obj.py
# Compiled at: 2018-01-16 13:46:28
# Size of source mod 2**32: 2612 bytes
import os, io
from .common import Option, ExceptionOption, Picker, Stop, Help

def pick_method(obj: object, *, allow_none: bool=True, raise_on_help: bool=True, include_doc: bool=True) -> callable:
    """
