...
# Size of source mod 2**32: 49002 bytes
from django.test import TestCase
from atws.wrapper import Wrapper
import random
from copy import deepcopy
from djautotask.models import Ticket, Status, Resource, SyncJob, TicketSecondaryResource, Priority, Queue, Account, Project, ProjectType, ProjectStatus, TicketCategory, Source, IssueType, SubIssueType, TicketType, DisplayColor, LicenseType, Task, TaskSecondaryResource, Phase, TimeEntry, TicketNote, TaskNote, TaskTypeLink, UseType, AllocationCode, Role, Department, ResourceRoleDepartment, ResourceServiceDeskRole, Contract, AccountType, ServiceCall, ServiceCallStatus
