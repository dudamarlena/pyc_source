...
# [GCC 8.4.0]
# Embedded file name: /home/sam/git/Kanban/django-autotask/djautotask/migrations/0003_auto_20190913_0941.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='TicketStatus', fields=[
      (
      ...
      (
       'is_system', models.BooleanField(default=False))], options={'verbose_name': 'Ticket status', 
      'verbose_name_plural': 'Ticket statuses'}),
     migrations.AddField(model_name='ticket', name='status', field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='djautotask.TicketStatus'))]