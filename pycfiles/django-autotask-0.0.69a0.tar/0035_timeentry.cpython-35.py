...
# [GCC 8.4.0]
# Embedded file name: /home/sam/git/Kanban/django-autotask/djautotask/migrations/0035_timeentry.py
# Compiled at: 2020-01-24 17:36:43
...
class Migration(migrations.Migration):
    ...
    operations = [
     migrations.CreateModel(name='TimeEntry', fields=[
      (
      ...
      (
       'ticket', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='djautotask.Ticket'))], options={'verbose_name_plural': 'Time entries'})]