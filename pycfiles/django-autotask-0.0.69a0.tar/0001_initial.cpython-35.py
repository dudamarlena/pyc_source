...
# [GCC 8.4.0]
# Embedded file name: /home/sam/git/Kanban/django-autotask/djautotask/migrations/0001_initial.py
...
class Migration(migrations.Migration):
    ...
    operations = [
     ...
     migrations.CreateModel(name='Ticket', fields=[
      ...
      (
       'title', models.CharField(blank=True, max_length=255, null=True))], options={'verbose_name': 'Ticket'})]