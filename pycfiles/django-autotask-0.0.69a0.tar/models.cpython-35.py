...
# Size of source mod 2**32: 24786 bytes
...
class Ticket(TimeStampedModel, ResourceAssignableModel):
    ...
    estimated_hours = models.DecimalField(blank=True, null=True, decimal_places=2, max_digits=6)
...
class Task(TimeStampedModel, ResourceAssignableModel):
    ...
    estimated_hours = models.DecimalField(blank=True, null=True, decimal_places=2, max_digits=6)
    remaining_hours = models.DecimalField(blank=True, null=True, decimal_places=2, max_digits=6)
    last_activity_date = models.DateTimeField(blank=True, null=True)
