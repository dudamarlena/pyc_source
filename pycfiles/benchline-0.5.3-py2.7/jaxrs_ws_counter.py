...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/benchline/jaxrs_ws_counter.py
# Compiled at: 2014-07-21 22:47:50
"""
Script to count the number of JAX-RS web services
defined in .java files in a directory.
"""
import re, os, fnmatch, six, benchline.args

def read_in_file(file_name):
    r"""Return the contents of file_name
...
def count_in_str(pattern, source):
    r"""Count number of matches of pattern in source
