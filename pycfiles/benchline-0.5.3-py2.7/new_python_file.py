...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/benchline/new_python_file/new_python_file.py
# Compiled at: 2014-03-23 21:04:18
"""
Script to create new python files quickly.
"""
import os, sys, datetime
from string import Template
import six, benchline.files, benchline.args, benchline.command
...
def main():
    ...
    parser.add_option('--template', help="template file to use (one of 'functional'(default), 'class', 'cmd')", default='functional')
    ...
    n = NewPythonFile()
    n.make_new_python_file(args[0], options.template, options.noedit, options.overwrite)
