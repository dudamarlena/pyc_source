...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/test/context/test_context.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: test_context.py 7955 2011-12-21 18:29:45Z rwilkinson $'
...
class XacmlContextTestCase(XacmlContextBaseTestCase):
    ...
    def test03AbstractCtxHandler(self):
        self.assertRaises(TypeError, CtxHandlerInterface, 'Context handler is an abstract base class')
