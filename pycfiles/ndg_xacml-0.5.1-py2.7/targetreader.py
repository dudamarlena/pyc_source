...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/parsers/etree/targetreader.py
# Compiled at: 2012-03-06 17:01:29
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: targetreader.py 8028 2012-02-27 14:38:01Z rwilkinson $'
        ...
        for childElem in getElementChildren(elem):
            ...
            if localName == xacmlType.SUBJECTS_ELEMENT_LOCAL_NAME:
                for subjElem in getElementChildren(childElem):
                    ...
                    target.subjects.append(SubjectReader.parse(subjElem, common))
                ...
                for resourceElem in getElementChildren(childElem):
                    ...
                    target.resources.append(ResourceReader.parse(resourceElem, common))
                ...
                for targetElem in getElementChildren(childElem):
                    ...
                    target.actions.append(ActionReader.parse(targetElem, common))
                ...
                for environElem in getElementChildren(childElem):
                    ...
                    target.environments.append(EnvironmentReader.parse(environElem, common))

            else:
                raise XMLParseError('XACML Target child element name %r not recognised' % localName)
