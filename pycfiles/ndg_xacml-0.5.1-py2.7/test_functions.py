...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/test/test_functions.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: test_functions.py 8020 2012-02-23 12:35:19Z pjkersha $'
    ...
    class CustomFunctionAbstractFunction(AbstractFunction):
        ...
        def evaluate(self, num):
            ...
            if not isinstance(num, int):
                raise XacmlContextTypeError('%r function expecting "int" type; got %r' % (
...
class FunctionTestCase(unittest.TestCase):
    ...
    def test01LoadMap(self):
        funcMap = FunctionMap()
        funcMap.loadAllCore()
        anyUriMatchNs = 'urn:oasis:names:tc:xacml:2.0:function:anyURI-regexp-match'
    ...
    def test01_add_custom_function(self):
        ...
        func_map.load_custom_function('urn:ndg:xacml:test:integer-square', custom_function_factory)
        self.assertIn('urn:ndg:xacml:test:integer-square', func_map, 'custom function not added into map')
