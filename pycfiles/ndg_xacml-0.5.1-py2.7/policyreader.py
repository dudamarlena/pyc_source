...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/parsers/etree/policyreader.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: policyreader.py 8028 2012-02-27 14:38:01Z rwilkinson $'
...
class PolicyReader(ETreeAbstractReader):
    ...
    def processElement(self, elem, common):
        ...
        policy.version = elem.attrib.get(xacmlType.VERSION_ATTRIB_NAME) or xacmlType.DEFAULT_XACML_VERSION
        for childElem in getElementChildren(elem):
            ...
            if localName == xacmlType.DESCRIPTION_LOCAL_NAME:
                ...
                policy.policyDefaults = PolicyDefaultsReader.parse(childElem, common)
                ...
                raise XMLParseError('XACML Policy child element name %r not recognised' % localName)
