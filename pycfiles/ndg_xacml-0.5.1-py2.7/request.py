...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/context/request.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: request.py 8010 2012-01-30 16:24:06Z rwilkinson $'
import logging
...
class Request(XacmlContextBase):
    ...
    None
    """
    __slots__ = ('__subjects', '__resources', '__action', '__environment', '__ctxHandler',
                 '__attributeSelector')
    ...
    def action(self, value):
        ...
        if not isinstance(value, Action):
            raise TypeError('Expecting %r type for request "action" attribute; got %r' % (
             Action, type(value)))
        self.__action = value
    ...
    def environment(self, value):
        ...
        if not isinstance(value, Environment):
            raise TypeError('Expecting %r type for request "environment" attribute; got %r' % (
    ...
    def ctxHandler(self, value):
        ...
        if not isinstance(value, CtxHandlerInterface):
            raise TypeError('Expecting %r type for "ctxHandler" attribute; got %r' % (
             CtxHandlerInterface, type(value)))
    ...
    def attributeSelector(self, value):
        ...
        if not isinstance(value, XPathSelectorInterface):
            raise TypeError('Expecting %r type for "attributeSelector" attribute; got %r' % (
