...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/condition.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: condition.py 7955 2011-12-21 18:29:45Z rwilkinson $'
...
class Condition(XacmlCoreBase):
    ...
    def expression(self, value):
        ...
        if not isinstance(value, Expression):
            raise TypeError('Expecting Expression or Expression derived type for "expression" attribute; got %r' % type(value))
