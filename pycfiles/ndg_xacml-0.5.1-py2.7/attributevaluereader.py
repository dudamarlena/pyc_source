...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/parsers/etree/attributevaluereader.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: attributevaluereader.py 7955 2011-12-21 18:29:45Z rwilkinson $'
...
class AttributeValueReader(ExpressionReader):
    ...
    def __call__(self, obj, common):
        ...
        if attributeValueClass is None:
            raise XMLParseError('No Attribute Value class available for parsing %r type' % elemAttributeValues[0])
...
class ETreeDataTypeReaderBase(object):
    ...
    def parse(cls, elem, attributeValue):
        if elem.text is None:
            raise XMLParseError('No attribute value element found parsing %r' % AttributeValueReader.TYPE.ELEMENT_LOCAL_NAME)
