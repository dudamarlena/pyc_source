...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/obligation.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: obligation.py 7955 2011-12-21 18:29:45Z rwilkinson $'
...
class Obligation(XacmlCoreBase):
    ...
    def obligationId(self, value):
        ...
        if not isinstance(value, basestring):
            raise TypeError('Expecting %r type for "obligationId" attribute; got %r' % (
    ...
    def fulfillOn(self, value):
        ...
        """
        if not isinstance(value, basestring):
            raise TypeError('Expecting %r type for "fulfillOn" attribute; got %r' % (
             Effect, type(value)))
