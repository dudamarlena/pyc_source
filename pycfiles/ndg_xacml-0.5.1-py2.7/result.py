...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/context/result.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: result.py 8010 2012-01-30 16:24:06Z rwilkinson $'
import logging
...
class StatusCode(XacmlContextBase):
    ...
    CODES = (
     OK, MISSING_ATTRIBUTE, PROCESSING_ERROR, SYNTAX_ERROR)
    ...
    def _setStatusCode(self, value):
        ...
        if not isinstance(value, StatusCode):
            raise TypeError('Child "statusCode" must be a %r derived type, got %r' % (
             StatusCode, type(value)))
        self.__childStatusCode = value

    value = property(fget=_getStatusCode, fset=_setStatusCode, doc='Child Status code')
    ...
    def _setValue(self, value):
        ...
        if not isinstance(value, basestring):
            raise TypeError('"value" must be a basestring derived type, got %r' % value.__class__)
...
class Status(XacmlContextBase):
    ...
    def _setStatusCode(self, value):
        ...
        """
        if not isinstance(value, StatusCode):
            raise TypeError('"statusCode" must be a %r derived type, got %r' % (
             StatusCode, type(value)))
        self.__statusCode = value

    statusCode = property(fget=_getStatusCode, fset=_setStatusCode, doc='status code object')
    ...
    def _setStatusMessage(self, value):
        ...
        """
        if not isinstance(value, basestring):
            raise TypeError('"statusMessage" must be a %r derived type, got %r' % (
             basestring, type(value)))
        self.__statusMessage = value

    statusMessage = property(fget=_getStatusMessage, fset=_setStatusMessage, doc='status message')
    ...
    statusDetail = property(fget=_getStatusDetail, fset=_setStatusDetail, doc='status message')
...
class Decision(object):
    ...
    TYPES = (
     PERMIT_STR, DENY_STR, INDETERMINATE_STR, NOT_APPLICABLE_STR)
    PERMIT = None
    DENY = None
    INDETERMINATE = None
    NOT_APPLICABLE = None
    ...
    def _setValue(self, value):
        ...
        if isinstance(value, Decision):
            ...
            raise TypeError('Expecting string or Decision instance for "value" attribute; got %r instead' % type(value))
        if value not in self.__class__.TYPES:
            raise AttributeError('Permissable decision types are %r; got %r instead' % (
    ...
    def __eq__(self, decision):
        ...
        if isinstance(decision, Decision):
            ...
            raise TypeError('Expecting string or Decision instance for input decision value; got %r instead' % type(value))
        if value not in self.__class__.TYPES:
            raise AttributeError('Permissable decision types are %r; got %r instead' % (
             Decision.TYPES, value))
...
class Result(XacmlContextBase):
    ...
    @classmethod
    def createInitialised(cls, decision=Decision.NOT_APPLICABLE, resourceId='', obligations=None, **kw):
    ...
    def resourceId(self, value):
        ...
        """
        if not isinstance(value, basestring):
            raise TypeError('Expecting %r type for "resourceId" result; got %r' % (
             basestring, type(value)))
    ...
    def decision(self, value):
        ...
        if not isinstance(value, Decision):
            raise TypeError('Expecting %r type for result "decision" attribute; got %r' % (
             Decision, type(value)))
    ...
    def status(self, value):
        ...
        if not isinstance(value, Status):
            raise TypeError('Expecting %r type for result "status" attribute; got %r' % (
             Status, type(value)))
        self.__status = value
    ...
    def obligations(self, value):
        ...
        if not isinstance(value, Obligation):
            raise TypeError('Expecting %r type for result "obligations" attribute; got %r' % (
