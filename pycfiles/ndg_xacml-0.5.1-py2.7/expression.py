...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/expression.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: expression.py 8010 2012-01-30 16:24:06Z rwilkinson $'
...
class Expression(XacmlCoreBase):
    ...
    dataType = property(_get_dataType, _set_dataType, None, 'expression value data type')
