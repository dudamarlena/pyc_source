...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/parsers/etree/reader.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: reader.py 8010 2012-01-30 16:24:06Z rwilkinson $'
import logging
...
class ETreeAbstractReader(AbstractReader):
    ...
    def __init__(self):
        ...
        if self.__class__.TYPE is None:
            raise NotImplementedError('No "TYPE" class variable set to specify the XACML type to instantiate')
