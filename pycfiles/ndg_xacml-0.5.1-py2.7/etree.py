...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/utils/etree.py
# Compiled at: 2012-02-10 11:36:03
...
__revision__ = '$Id: etree.py 8010 2012-01-30 16:24:06Z rwilkinson $'
from ndg.xacml import Config, importElementTree
ElementTree = importElementTree()
from ndg.xacml.parsers.etree import QName
c14nWarning = 'Custom ElementC14N package is not installed, canonicalize function is disabled'
try:
...
class _PrettyPrint(object):
    ...
    def __call__(self, elem, indent='', html=0, space='    '):
    ...
    if Config.use_lxml:
        ...
        def _getNamespacePrefix(self, elem, namespace):
            ...
            raise KeyError('prettyPrint: missing namespace "%s" for elem.nsmap' % namespace)
        ...
        def _getNamespacePrefix(self, elem, namespace):
            ...
            if nsPrefix is None:
                raise KeyError('prettyPrint: missing namespace "%s" for ElementTree._namespace_map' % namespace)
            return nsPrefix
        ...
        def _allocNsPrefix(self, nsURI):
            ...
            if nsPrefix is not None:
                ...
                if nsURI not in ElementTree._namespace_map:
                    raise KeyError('prettyPrint: error adding namespace "%s" to ElementTree._namespace_map' % nsURI)
                return nsPrefix