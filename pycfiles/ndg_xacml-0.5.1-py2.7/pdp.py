...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/context/pdp.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: pdp.py 7955 2011-12-21 18:29:45Z rwilkinson $'
import logging
...
class PDP(PDPInterface):
    ...
    def policy(self, value):
        ...
        if not isinstance(value, PolicyBase):
            raise TypeError('Expecting %r derived type for "policy" input; got %r instead' % (
             PolicyBase, type(value)))
        self.__policy = value
