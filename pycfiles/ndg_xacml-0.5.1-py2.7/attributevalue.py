...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/attributevalue.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: attributevalue.py 8010 2012-01-30 16:24:06Z rwilkinson $'
...
class AttributeValue(Expression):
    ...
    DAYTIMEDURATION_TYPE_URI = 'http://www.w3.org/TR/2002/WD-xquery-operators-20020816#dayTimeDuration'
    YEARMONTHDURATION_TYPE_URI = 'http://www.w3.org/TR/2002/WD-xquery-operators-20020816#yearMonthDuration'
    ...
    TYPE_URIS = (
     ...
     IPADDRESS_TYPE_URI,
     DNSNAME_TYPE_URI)
    TYPE_NAMES = ('String', 'AnyURI', 'Integer', 'Boolean', 'Double', 'Date', 'DateTime',
                  'Time', 'DayTimeDuration', 'YearMonthDuration', 'X500Name', 'Rfc822Name',
                  'HexBinary', 'Base64Binary', 'IpAddress', 'DnsName')
    NATIVE_TYPES = (
     basestring,
     basestring,
     int,
    ...
    def __init__(self, value=None):
        ...
        if self.__class__.TYPE is None:
            raise NotImplementedError('TYPE class variable must be set to a valid type in a derived class')
        self.__value = None
    ...
    def __eq__(self, attrVal):
        ...
        if not isinstance(attrVal, self.__class__):
            raise TypeError('Expecting %r type for "value" attribute; got %r' % (
             self.__class__.TYPE,
             type(attrVal)))
...
class AttributeValueClassFactory(object):
    ...
    _typeName, _type, _identifier, _className, _classVars, _attributeValueClass = (None,
                                                                                   None,
                                                                                   None,
                                                                                   None,
                                                                                   None,
