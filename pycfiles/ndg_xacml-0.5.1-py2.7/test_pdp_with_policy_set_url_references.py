...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/test/context/test_pdp_with_policy_set_url_references.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: test_pdp_with_policy_set_url_references.py 8078 2012-06-19 14:10:35Z pjkersha $'
...
class Test(XacmlContextBaseTestCase):
    ...
    def setUp(self):
        print 'Setting up'
        self.pdp = PDP.fromPolicySource(self.__class__.XACML_POLICY_SET_FILEPATH, ReaderFactory, UrlPolicyFinder(THIS_DIR))
