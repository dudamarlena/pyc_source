...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/attribute.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: attribute.py 8010 2012-01-30 16:24:06Z rwilkinson $'
...
class Attribute(XacmlCoreBase):
    ...
    def attributeValues(self, value):
        ...
        if not isinstance(value, TypedList):
            raise TypeError('Expecting %r type for "attributeValues" attribute; got %r' % (
             TypedList, type(value)))
    ...
    def _set_dataType(self, value):
        ...
        if not isinstance(value, basestring):
            raise TypeError('Expecting %r type for "dataType" attribute; got %r' % (
             basestring, type(value)))
        self.__dataType = value

    dataType = property(_get_dataType, _set_dataType, None, 'Attribute data type')
