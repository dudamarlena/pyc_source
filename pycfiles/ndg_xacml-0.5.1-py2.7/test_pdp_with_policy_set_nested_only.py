...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/test/context/test_pdp_with_policy_set_nested_only.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: test_pdp_with_policy_set_nested_only.py 8078 2012-06-19 14:10:35Z pjkersha $'
...
class Test(XacmlContextBaseTestCase):
    ...
    def test01(self):
        request = self._createRequestCtx(self.__class__.RESOURCE_DL_ID, subjectRoles=('staff', ))
