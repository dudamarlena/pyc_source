...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/ndg/xacml/core/context/pdpinterface.py
...
__contact__ = 'Philip.Kershaw@stfc.ac.uk'
__revision__ = '$Id: pdpinterface.py 7087 2010-06-25 11:23:09Z pjkersha $'
...
class PDPInterface(object):
    ...
    def evaluate(self, request):
        ...
        if not isinstance(request, Request):
            raise TypeError('Expecting %r type for input request; got %r instead' % (
