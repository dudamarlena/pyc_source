...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vagoth/registry/dict_registry.py
# Compiled at: 2013-12-29 04:31:23
"""
...
class DictRegistry(object):
    ...
    def add_node(self, node_id, node_name, node_type, tenant, definition=None, metadata=None, tags=None, unique_keys=None):
        ...
        with self.lock:
            ...
            node = {'node_id': node_id, 'name': node_name, 
               'tenant': tenant, 
               'type': node_type, 
