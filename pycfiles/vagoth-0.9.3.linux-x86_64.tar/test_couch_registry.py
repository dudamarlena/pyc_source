...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vagoth/tests/test_couch_registry.py
# Compiled at: 2013-12-29 04:22:03
"""
...
class test_CouchRegistry(unittest.TestCase, RegistryMixin):
    ...
    def setUp(self):
        ...
        self.registry = CouchRegistry(None, {'couch_server': 'http://example.com:5934', 
    ...
    def test_couch_claim_unique_keys_with_conflict(self):
        self.registry._claim_unique_keys('0x1', ['NEW'])
        self.assertRaises(exceptions.UniqueConstraintViolation, self.registry._claim_unique_keys, '0x2', ['NEW'])
