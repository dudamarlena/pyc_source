...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vagoth/virt/monitor.py
# Compiled at: 2013-12-28 15:38:06
...
class Monitor(object):
    ...
    def create_vm(self, vm_name, vm_status, node):
        ...
        provisioner.provision(vm_name, node_name=vm_name, node_type='vm', definition=vm_status['definition'], metadata={'state': vm_name})
