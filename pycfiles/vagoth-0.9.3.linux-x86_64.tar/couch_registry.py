...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/vagoth/registry/couch_registry.py
# Compiled at: 2013-12-29 04:33:50
import couchdb
    ...
    def add_node(self, node_id, node_name, node_type, tenant=None, definition=None, metadata=None, unique_keys=None, tags=None):
        ...
        try:
            self.nodes[node_id] = {'node_id': node_id, 
               'type': node_type, 
               'name': None, 
               'definition': {}, 'metadata': {}, 'unique_keys': [], 'tags': [], 'parent': None, 
               'tenant': tenant}
        except couchdb.http.ResourceConflict:
