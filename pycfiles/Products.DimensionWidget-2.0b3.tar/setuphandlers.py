...
# Embedded file name: build/bdist.linux-i686/egg/Products/DigestoContentTypes/setuphandlers.py
...
def updateRoleMappings(context):
    ...
    if isNotDigestoContentTypesProfile(context):
        return
...
def postInstall(context):
    ...
    if shortContext != 'DigestoContentTypes':
        return
...
def registerAttachmentsFormControllerActions(context, contentType=None, template='manage_attachments'):
    ...
    pfc.addFormAction(template, 'success', contentType, 'UploadAttachment', 'traverse_to', 'string:widget_attachmentsmanager_upload')
    pfc.addFormAction(template, 'success', contentType, 'RenameAttachments', 'traverse_to', 'string:widget_attachmentsmanager_rename')
    pfc.addFormAction(template, 'success', contentType, 'MoveAttachments', 'traverse_to', 'string:widget_attachmentsmanager_move')
    pfc.addFormAction(template, 'success', contentType, 'DeleteAttachments', 'traverse_to', 'string:widget_attachmentsmanager_delete')
...
def addCatalogIndexes(context):
    ...
    wanted = (('getDate', 'DateIndex'), ('getSource', 'FieldIndex'), ('getNumber', 'FieldIndex'), ('getRepeals', 'FieldIndex'), ('getModifies', 'FieldIndex'), ('getRepealedBy', 'FieldIndex'), ('getKind', 'FieldIndex'), ('getAbbreviation', 'FieldIndex'), ('getArea', 'FieldIndex'), ('getCudap', 'FieldIndex'))
