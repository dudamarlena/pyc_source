...
# Embedded file name: build/bdist.linux-i686/egg/Products/DigestoContentTypes/tests/test_setup.py
# Compiled at: 2009-04-26 22:17:24
__doc__ = 'Test product installation\n'
import unittest
...
class TestDCTSetup(DigestoContentTypesTestCase):
    ...
    def afterSetUp(self):
        ...
        self.placeful_workflow = getToolByName(self.portal, 'portal_placeful_workflow')
    ...
    def test_workflows_installed(self):
        ...
        self.assertEquals(self.workflow.getChainForPortalType('Normativa'), ('normativa_workflow', ))
        self.assertEquals(self.workflow.getChainForPortalType('Area'), ('area_workflow', ))
    ...
    def test_area_placeful_workflow_policy(self):
        ...
        self.assertEquals(area_wf.getChainFor('Folder'), ('area_workflow', ))
        self.assertEquals(area_wf.getChainFor('Large Plone Folder'), ('area_workflow', ))
        self.assertEquals(area_wf.getChainFor('Normativa'), ('normativa_workflow', ))

    def test_indexes_added(self):
        """Test that indexes are added at install time
        """
        indexes = (
         ('getDate', 'DateIndex'), ('getSource', 'FieldIndex'), ('getNumber', 'FieldIndex'), ('getRepeals', 'FieldIndex'), ('getModifies', 'FieldIndex'), ('getRepealedBy', 'FieldIndex'), ('getKind', 'FieldIndex'), ('getAbbreviation', 'FieldIndex'), ('getArea', 'FieldIndex'), ('getCudap', 'FieldIndex'))
