...
class CSS(UIModule):
 ...
 L.   9         0  LOAD_FAST             0  'self'
                3  LOAD_ATTR             0  'handler'
                6  LOAD_ATTR             1  'css_debug'
