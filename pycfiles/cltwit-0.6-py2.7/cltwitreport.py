...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/cltwit/cltwitreport.py
# Compiled at: 2013-02-03 16:38:10
"""
...
def setItems(n, obj, attr, values):
    u"""définir la couleur des slices"""
    m = len(values)
    i = m // n
    for j in xrange(n):
