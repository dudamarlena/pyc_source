...
# [GCC 8.4.0]
# Embedded file name: /Users/ali/ownCloud/Project/python/django-aparnik-framework-project/testandbuildprojectframework/aparnik/contrib/settings/migrations/0022_auto_20191102_2142.py
...
def add_keys(apps, schema_editor):
    ...
    try:
        ...
        Setting.objects.create(title='مرچنت کد بانک ملی',
          key=key,
          value='',
          value_type='s',
          is_show=False,
    ...
    try:
        ...
        Setting.objects.create(title='ترمینال کد بانک ملی',
          key=key,
          value='',
          value_type='s',
          is_show=False,
    ...
    try:
        ...
        Setting.objects.create(title=' کلید خصوصی بانک ملی',
          key=key,
          value='',
          value_type='s',
          is_show=False,
