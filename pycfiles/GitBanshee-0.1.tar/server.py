...
# [GCC 8.4.0]
# Embedded file name: /root/Brightroar/GitBanshee/gitbanshee/server.py
# Compiled at: 2013-06-19 05:17:35
import os
...
def main():
    ...
    SocketIOServer(('0.0.0.0', 80), Application(), resource='socket.io', policy_server=True, policy_listener=('0.0.0.0',
                                                                                                              10843)).serve_forever()
