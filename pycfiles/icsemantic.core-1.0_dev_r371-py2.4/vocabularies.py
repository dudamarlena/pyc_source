...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/icsemantic/core/vocabularies.py
    ...
    def __call__(self, context):
        ...
        for type in portal_types.objectValues():
            if type.getId() not in types_not_searched:
                terms.append(vocabulary.SimpleTerm(unicode(type.content_meta_type), title=unicode(type.title_or_id())))
