...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/icsemantic/core/setuphandlers.py
...
def setup_site(portal, out):
    ...
    if not sm.queryUtility(interfaces.IicSemanticManagementContentTypes, name='icsemantic.configuration'):
        if HAS_PLONE3:
            sm.registerUtility(icSemanticManagementContentTypes(), interfaces.IicSemanticManagementContentTypes, 'icsemantic.configuration')
        else:
            sm.registerUtility(interfaces.IicSemanticManagementContentTypes, icSemanticManagementContentTypes(), 'icsemantic.configuration')
