...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/icsemantic/core/tests/base.py
...
setup_icsemantic_core()
ptc.setupPloneSite(products=[PROJECTNAME])

class icSemanticTestCase(ptc.PloneTestCase, ztc.ZopeTestCase):
...
class icSemanticFunctionalTestCase(ptc.FunctionalTestCase):
    ...
    def setUp(self):
        super(icSemanticFunctionalTestCase, self).setUp()