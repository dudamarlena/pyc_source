...
# [GCC 8.4.0]
# Embedded file name: /home/orpheus/Desarrollo/netflix/freedesktop_setup/icons.py
# Compiled at: 2017-03-11 16:00:36
...
class update_icons(Command):
    __doc__ = 'Distutils subcommand to regenerate icon cache'
    ...
    user_options = [
     ...
     ('icon-themes-dir=', 'd', 'base directory for icon themes (default: {install-dir}/share/icons)'),
    ...
    def run(self):
        ...
        for name in themes:
            ...
            permission = os.access(cachefile, os.W_OK) or os.access(path, os.W_OK) and not os.path.exists(cachefile)
            if permission or self.force:
                ...
                if self.force:
                    raise DistutilsSetupError('no write permissions for %r' % cachefile)
                else:
