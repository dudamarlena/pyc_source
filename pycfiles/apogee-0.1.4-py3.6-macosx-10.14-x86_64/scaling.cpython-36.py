...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/apogee/core/scaling.py
...
def normalise(x: np.ndarray, a_min: np.float32=-np.inf, a_max: np.float32=np.inf, method: str='default', **kwargs):
    """
