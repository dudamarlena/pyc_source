...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/apogee/models/bayes/discrete/network.py
# Compiled at: 2019-06-30 07:04:15
...
class BayesianNetwork:
    __doc__ = 'A utility class for building Bayesian Networks from Factors and FactorSets.'
    ...
    def to_dict(self) -> dict:
        ...
        for name, variable in self._variables.items():
            data[name] = dict(states=(variable.states.tolist()),
