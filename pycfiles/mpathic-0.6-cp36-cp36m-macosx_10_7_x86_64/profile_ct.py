...
# [GCC 8.4.0]
# Embedded file name: mpathic/src/profile_ct.py
...
def add_subparser(subparsers):
    ...
    p.add_argument('-b', '--bin', type=int, default=None, help='Dataset bin to use for counts. If blank, total counts will be used')
    p.add_argument('-i', '--i', type=str, default=None, help='Input file, otherwise input through the standard input.')
    ...
    p.add_argument('-o', '--out', type=str, default=None, help='Output file, otherwise use standard output.')
