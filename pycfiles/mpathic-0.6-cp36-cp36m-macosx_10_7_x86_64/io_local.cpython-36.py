...
# [GCC 8.4.0]
# Embedded file name: /Users/tareen/Desktop/Desktop_Tests/MPathic3/mpathic/src/io_local.py
# Compiled at: 2018-07-12 00:29:59
# Size of source mod 2**32: 10288 bytes
...
def load_text(file_arg):
    ...
    try:
        df = pd.io.parsers.read_csv(file_handle, delim_whitespace=True, comment='#',
...
def load_dataset(file_arg, file_type='text', seq_type=None):
    ...
    if file_arg == 'sort_seq_data.txt':
        ...
        if seq_type:
            if seq_type not in qc.seqtypes:
