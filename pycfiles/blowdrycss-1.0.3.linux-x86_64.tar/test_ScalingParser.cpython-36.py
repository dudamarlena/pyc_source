...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/unit_tests/test_ScalingParser.py
# Compiled at: 2018-03-07 18:42:13
# Size of source mod 2**32: 8209 bytes
...
class TestBreakpointParser(TestCase):
    ...
    def test_is_scaling_True(self):
        valid_css_classes = [
         'font-size-24-s', 'font-size-24-s-i', 'padding-10-s', 'margin-30-s-i']
    ...
    def test_strip_scaling_flag(self):
        ...
        names = [
         'font-size', 'font-size', 'padding', 'margin', 'font-size', 'font-size']
