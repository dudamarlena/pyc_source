...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/blowdry.py
# Compiled at: 2018-03-07 18:42:13
# Size of source mod 2**32: 9136 bytes
...
from blowdrycss.datalibrary import clashing_alias_markdown, property_alias_markdown, clashing_alias_html, property_alias_html, clashing_alias_rst, property_alias_rst
...
def boilerplate():
    ...
    if settings.markdown_docs:
        markdown_file = GenericFile(file_directory=(settings.markdown_directory),
    ...
    if settings.html_docs:
        html_file = GenericFile(file_directory=(settings.project_directory),
          file_name='clashing_aliases',
          extension='.html')
    ...
    if settings.rst_docs:
        print('\nDocumentation Directory:', str(settings.docs_directory))
...
.. |sp| raw:: html
    ...
    if settings.media_queries_enabled:
        ...
        css_builder.property_parser.class_set = unassigned_class_set.copy()
        css_builder.property_parser.removed_class_set = set()
        media_query_builder = MediaQueryBuilder(property_parser=class_property_parser)
        logging.debug(msg=('blowdry.media_query_builder.property_parser.class_set:\t' + str(media_query_builder.property_parser.class_set)))
