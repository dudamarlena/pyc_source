...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/unit_tests/test_CSSPropertyValueParser.py
...
class TestCSSPropertyValueParser(TestCase):
    ...
    def test_is_built_in_valid(self):
        property_names = [
         'font-weight', 'color', 'background-repeat']
    ...
    def test_decode_property_value(self):
        ...
        for i, value in enumerate(encoded_property_values):
            self.assertEqual(property_parser.decode_property_value(value=value),
