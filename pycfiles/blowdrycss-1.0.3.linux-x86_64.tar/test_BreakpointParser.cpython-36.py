...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/unit_tests/test_BreakpointParser.py
# Compiled at: 2018-03-07 18:42:13
# Size of source mod 2**32: 23959 bytes
...
class TestBreakpointParser(TestCase):
    ...
    def test_set_breakpoint_key(self):
        ...
        names = [
         'display', 'display', 'color', 'padding', 'display', 'display', 'display', 'display', 'display']
    ...
    def test_set_custom_breakpoint_key_Valid(self):
        valid_css_classes = ('padding-25-820-up', 'display-480-down', 'margin-5-2-5-2-1000-up',
                             'display-960-up-i', 'display-3_2rem-down')
        names = [
    ...
    def test_is_display_True(self):
        valid_css_classes = ('display-small-down', 'medium-only', 'giant-up', 'display-720-up',
                             'display-369-down')
    ...
    def test_is_display_False(self):
        invalid_css_classes = ('inline-small-up', 'inline-giant-down', 'green-xxsmall-only',
                               'padding-10-large-up', 'padding-25-820-up', 'margin-5-2-5-2-1000-up')
    ...
    def test_css_for_only_display(self):
        ...
        name = 'display'
        value = 'none'
        expected = '@media only screen and (max-width: 45.0625em) {\n' + '\t.display-large-only {\n' + '\t\tdisplay: none;\n' + '\t}\n' + '}\n\n' + '@media only screen and (min-width: 64.0em) {\n' + '\t.display-large-only {\n' + '\t\tdisplay: none;\n' + '\t}\n' + '}\n\n'
    ...
    def test_css_for_only_general_usage(self):
        ...
        name = 'padding'
        value = px_to_em('100')
        expected = '@media only screen and (min-width: 45.0625em) and (max-width: 64.0em) {\n' + '\t.padding-100-large-only {\n' + '\t\tpadding: 6.25em;\n' + '\t}\n' + '}\n\n'
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
        css = breakpoint_parser.css_for_only()
        self.assertEqual(css, expected)
    ...
    def test_css_for_only_wrong_limit_key(self):
        ...
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
        breakpoint_parser.limit_key = '-up'
        css = breakpoint_parser.css_for_only()
        self.assertEqual(css, expected)
    ...
    def test_css_for_down_display(self):
        ...
        name = 'display'
        value = 'none'
        expected = '@media only screen and (min-width: 45.0em) {\n' + '\t.display-medium-down {\n' + '\t\tdisplay: none;\n' + '\t}\n' + '}\n\n'
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
    ...
    def test_css_for_down_display_custom(self):
        ...
        name = 'display'
        value = 'none'
        expected = '@media only screen and (min-width: 23.0625em) {\n' + '\t.display-369-down {\n' + '\t\tdisplay: none;\n' + '\t}\n' + '}\n\n'
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
        css = breakpoint_parser.css_for_down()
        self.assertEqual(css, expected)
    ...
    def test_css_for_down_general_usage(self):
        ...
        name = 'padding'
        value = px_to_em('100')
        expected = '@media only screen and (max-width: 45.0em) {\n' + '\t.padding-100-medium-down {\n' + '\t\tpadding: 6.25em;\n' + '\t}\n' + '}\n\n'
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
        css = breakpoint_parser.css_for_down()
        self.assertEqual(css, expected)
    ...
    def test_css_for_down_wrong_limit_key(self):
        ...
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
        breakpoint_parser.limit_key = '-only'
        css = breakpoint_parser.css_for_down()
        self.assertEqual(css, expected)
    ...
    def test_css_for_up_display(self):
        ...
        name = 'display'
        value = 'none'
        expected = '@media only screen and (max-width: 15.0625em) {\n' + '\t.display-small-up {\n' + '\t\tdisplay: none;\n' + '\t}\n' + '}\n\n'
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
    ...
    def test_css_for_up_general_usage(self):
        ...
        name = 'padding'
        value = px_to_em('100')
        expected = '@media only screen and (min-width: 15.0625em) {\n' + '\t.padding-100-small-up {\n' + '\t\tpadding: 6.25em;\n' + '\t}\n' + '}\n\n'
        css_property = Property(name=name, value=value, priority='')
        breakpoint_parser = BreakpointParser(css_class=css_class, css_property=css_property)
        css = breakpoint_parser.css_for_up()
        self.assertEqual(css, expected)
