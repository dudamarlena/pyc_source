...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/unit_tests/test_CSSBuilder.py
...
class TestCSSStyleBuilder(TestCase):
    ...
    def test_build_selector(self):
        css_classes = ('padding-10-i-hover', 'color-hfff-before', 'width-1rem-s-selection',
                       'color-red-checked', 'hfff-hover-i', 'hfff-i-hover', 'color-hfff-hover-i',
                       'color-hfff-i-hover')
        expected_selector_text = ('.padding-10-i-hover:hover', '.color-hfff-before::before',
                                  '.width-1rem-s-selection::selection', '.color-red-checked:checked',
                                  '.hfff-hover-i:hover', '.hfff-i-hover:hover', '.color-hfff-hover-i:hover',
                                  '.color-hfff-i-hover:hover')
