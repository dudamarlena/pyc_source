...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/unit_tests/test_mediaQueryBuilder.py
...
class TestMediaQueryBuilder(TestCase):
    ...
    def test_init_classes(self):
        class_set = {
         ...
         'width-100-xxlarge-down-s', 'padding-50-xxsmall-only-s',
         'squirrel-medium-only',
         'font-size-AA-s',
        ...
        self.assertTrue((media_query_builder.property_parser.class_set == expected_clean_set), msg=(media_query_builder.property_parser.class_set))
        self.assertTrue((media_query_builder.property_parser.removed_class_set == expected_removed_set), msg=(media_query_builder.property_parser.removed_class_set))
    ...
    def test_init_css_media_queries(self):
        ...
        property_parser = ClassPropertyParser(class_set=class_set)
        media_query_builder = MediaQueryBuilder(property_parser=property_parser)
        self.assertTrue((media_query_builder.css_media_queries == expected_css_media_queries), msg=(media_query_builder.css_media_queries))

    def test_get_css_text(self):
        class_set = {
         'giant-only-i', 'color-hfff-xsmall-only', 'font-size-13-s-i'}
