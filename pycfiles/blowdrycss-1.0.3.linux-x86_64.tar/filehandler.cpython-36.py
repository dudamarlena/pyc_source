...
# [GCC 8.4.0]
# Embedded file name: /home/starwater/blowdrycss_venv/lib/python3.6/site-packages/blowdrycss/filehandler.py
# Compiled at: 2018-03-07 18:42:13
# Size of source mod 2**32: 15738 bytes
...
class FileFinder(object):
    ...
    def __init__(self, recent=True):
        ...
        if path.isdir(self.project_directory):
            ...
            raise OSError(self.project_directory + ' is not a directory. Check project_directory setting in blowdrycss_settings.py')
...
class CSSFile(object):
    ...
    def write(self, css_text=''):
        ...
        **Example:**
        ...
        file_path = get_file_path(file_directory=(self.file_directory),
    ...
    def minify(self, css_text=''):
        ...
        **Example:**
        ...
        file_path = get_file_path(file_directory=(self.file_directory),
          file_name=(self.file_name),
          extension=(str('.min' + self.extension)))
        with open(file_path, 'w') as (css_file):
            css_file.write(parse_string.cssText.decode('utf-8'))
        ser.prefs.useDefaults()
    ...
    def is_newer(self, file_path):
        ...
        if settings.human_readable:
            ...
            if settings.minify:
                ...
                raise SystemError('Review blowdrycss_settings.py. Either settings.human_readable or settings.minify must be set to True.')
            try:
