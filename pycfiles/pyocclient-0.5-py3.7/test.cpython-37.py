...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/owncloud/test/test.py
# Compiled at: 2020-01-31 10:27:27
# Size of source mod 2**32: 48264 bytes
import unittest
from unittest_data_provider import data_provider
import os, shutil, owncloud, datetime, time, tempfile, random, six
...
class TestFileAccess(unittest.TestCase):
    ...
    def test_get_file_listing(self):
        ...
        self.assertTrue(self.client.put_file_contents(self.test_root + '中文.txt', ''))
        ...
        self.assertEqual(listing[4].get_name(), '中文.txt')
    ...
    def test_upload_directory(self):
        ...
        self._TestFileAccess__create_file(temp_dir + 'file1.dat', 2048)
        self._TestFileAccess__create_file(temp_dir + 'file2.dat', 23068672)
        self._TestFileAccess__create_file(temp_dir + 'levelone/file3.dat', 23068672)
        self._TestFileAccess__create_file(temp_dir + 'levelone/leveltwo/file4.dat', 8388608)
        self._TestFileAccess__create_file(temp_dir + 'levelone/文件.dat', 7340032)
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        ...
        self.assertIsNotNone(self.client.file_info(self.test_root + 'subdir/pyoctest.dir/levelone/文件.dat'))
    ...
    def test_move_rename_in_place(self):
        ...
        self.assertTrue(self.client.put_file_contents(self.test_root + 'rename this file!.txt', 'to rename'))
        self.assertTrue(self.client.move(self.test_root + 'rename this file!.txt', self.test_root + 'renamed in place.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'renamed in place.txt'), b'to rename')

    def test_move_and_rename(self):
        """Test rename into subdir"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'move and rename.txt', 'first file'))
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        self.assertTrue(self.client.move(self.test_root + 'move and rename.txt', self.test_root + 'subdir/file renamed.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/file renamed.txt'), b'first file')

    def test_move_to_dir(self):
        """Test move into directory"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'movetodir.txt', 'z file'))
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        self.assertTrue(self.client.move(self.test_root + 'movetodir.txt', self.test_root + 'subdir/'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/movetodir.txt'), b'z file')

    def test_move_subdir(self):
        """Test move subdir"""
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir_to_move'))
        self.assertTrue(self.client.put_file_contents(self.test_root + 'subdir_to_move/file two.txt', 'second file'))
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        self.assertTrue(self.client.move(self.test_root + 'subdir_to_move', self.test_root + 'subdir/'))

    def test_rename_unicode(self):
        """Test rename unicode"""
        self.assertTrue(self.client.put_file_contents(self.test_root + '中文.txt', '1'))
        self.assertTrue(self.client.move(self.test_root + '中文.txt', self.test_root + '更多中文.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + '更多中文.txt'), b'1')

    def test_move_unicode(self):
        """Test move unicode to dir"""
        self.assertTrue(self.client.put_file_contents(self.test_root + '中文.txt', '2'))
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        self.assertTrue(self.client.move(self.test_root + '中文.txt', self.test_root + 'subdir/中文.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/中文.txt'), b'2')

    def test_move_to_non_existing_dir(self):
        """Test error when moving to non existing dir"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'move not possible.txt', 'x'))
        with self.assertRaises(owncloud.ResponseError) as (e):
            self.client.move(self.test_root + 'move not possible.txt', self.test_root + 'non-existing-dir/subdir/x.txt')
        self.assertEqual(e.exception.status_code, 409)
        self.assertEqual(self.client.get_file_contents(self.test_root + 'move not possible.txt'), b'x')

    def test_copy_in_place(self):
        """Test copy in place"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'copy this file!.txt', 'to copy'))
        self.assertTrue(self.client.copy(self.test_root + 'copy this file!.txt', self.test_root + 'copied in place.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copied in place.txt'), b'to copy')
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copy this file!.txt'), b'to copy')

    def test_copy_into_subdir(self):
        """Test copy into subdir"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'copy into subdir.txt', 'first file'))
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        self.assertTrue(self.client.copy(self.test_root + 'copy into subdir.txt', self.test_root + 'subdir/file copied.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/file copied.txt'), b'first file')
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copy into subdir.txt'), b'first file')

    def test_copy_unicode(self):
        """Test copy unicode to dir"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'दिलै होस छोरा होस.txt', 'content'))
        self.assertTrue(self.client.mkdir(self.test_root + 'subdir'))
        self.assertTrue(self.client.copy(self.test_root + 'दिलै होस छोरा होस.txt', self.test_root + 'subdir/दिलै होस छोरा होस.txt'))
        self.assertEqual(self.client.get_file_contents(self.test_root + 'subdir/दिलै होस छोरा होस.txt'), b'content')
        self.assertEqual(self.client.get_file_contents(self.test_root + 'दिलै होस छोरा होस.txt'), b'content')

    def test_copy_to_non_existing_dir(self):
        """Test error when copy to non existing dir"""
        self.assertTrue(self.client.put_file_contents(self.test_root + 'copy not possible.txt', 'x'))
        with self.assertRaises(owncloud.ResponseError) as (e):
            self.client.copy(self.test_root + 'copy not possible.txt', self.test_root + 'non-existing-dir/subdir/x.txt')
        self.assertEqual(e.exception.status_code, 409)
        self.assertEqual(self.client.get_file_contents(self.test_root + 'copy not possible.txt'), b'x')
    ...
    def test_get_share_user(self, file_name):
        ...
        path = self.test_root + file_name
        self.assertTrue(self.client.put_file_contents(path, 'hello world!'))
        sinfo_run = self.client.share_file_with_user(path,
          (self.share2user),
        ...
        self.assertEqual(sinfo.get_permissions(), self.client.OCS_PERMISSION_READ | self.client.OCS_PERMISSION_SHARE)
...
class TestPrivateDataAccess(unittest.TestCase):
    ...
    def attrs():
        return (('attr1', 'value1'), ('attr+plus space', 'value+plus space and/slash'),
                ('属性1', '值对1'))
...
class TestUserAndGroupActions(unittest.TestCase):
    ...
    def test_get_user(self):
        ...
        expected_output = {'displayname':'admin',  'enabled':'true', 
         'email':None, 
...
class TestOCSRequest(unittest.TestCase):
    ...
    def test_make_request(self):
        kwargs = {'accepted_codes': [100]}
        (self.client.make_ocs_request)(*('GET', '', 'config'), **kwargs)

    def test_make_request_fail_unaccepted_code(self):
        kwargs = {'accepted_codes': [102]}
        with self.assertRaises(owncloud.OCSResponseError) as (e):
            (self.client.make_ocs_request)(*('GET', '', 'config'), **kwargs)
