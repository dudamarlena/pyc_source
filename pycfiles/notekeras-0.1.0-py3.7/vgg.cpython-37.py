...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/model/retinanet/models/vgg.py
# Compiled at: 2020-04-26 08:17:53
...
def vgg_retinanet(num_classes, backbone='vgg16', inputs=None, modifier=None, **kwargs):
    ...
    return RetinaNetModel(inputs=inputs, num_classes=num_classes, backbone_layers=layer_outputs, **kwargs)