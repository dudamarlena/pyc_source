...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/model/din.py
# Compiled at: 2019-12-03 04:37:11
...
from notekeras.input import build_input_features, SparseFeat, DenseFeat, VarLenSparseFeat, create_embedding_matrix, embedding_lookup, get_dense_input, get_varlen_pooling_list, varlen_embedding_lookup, combined_dnn_input
Dense = keras.layers.Dense
Concatenate = keras.layers.Concatenate
Flatten = keras.layers.Flatten
Model = keras.models.Model

def DIN(dnn_feature_columns, history_feature_list, dnn_use_bn=False, dnn_hidden_units=(200, 80), dnn_activation='relu', att_hidden_size=(80, 40), att_activation='dice', att_weight_normalization=False, l2_reg_dnn=0, l2_reg_embedding=1e-06, dnn_dropout=0, init_std=0.0001, seed=1024, task='binary'):
