...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/model/benchmarks.py
# Compiled at: 2020-04-22 05:42:07
# Size of source mod 2**32: 3427 bytes
import os.path, click, keras_resnet.metrics, keras_resnet.models, numpy, pkg_resources, sklearn.model_selection, tensorflow, tensorflow.keras.preprocessing.image
from tensorflow import keras
_benchmarks = {'CIFAR-10':keras.datasets.cifar10, 
 'CIFAR-100':keras.datasets.cifar100, 
 'MNIST':keras.datasets.mnist}
_names = {'ResNet-18':keras_resnet.models.ResNet2D18, 
