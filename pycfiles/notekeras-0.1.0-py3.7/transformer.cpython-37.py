...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/model/transformer.py
# Compiled at: 2020-04-03 03:51:55
# Size of source mod 2**32: 13237 bytes
import numpy as np
...
__all__ = [
 'get_custom_objects', 'TransformerModel']
...
class TransformerModel(Model):
    ...
    def __init__(self, token_num, embed_dim, encoder_num, decoder_num, head_num, hidden_dim, name='transformer', attention_activation=None, feed_forward_activation='relu', dropout_rate=0.0, use_same_embed=True, embed_weights=None, embed_trainable=None, trainable=True, use_adapter=False, adapter_units=None, adapter_activation='relu', layer_depth=2):
        ...
        self._build()
        super(TransformerModel, self).__init__(inputs=(self.input_layer), outputs=(self.output_layer), name=name, trainable=trainable)
    ...
    def _build(self):
        ...
        encoded_layer = EncoderList(encoder_num=(self.encoder_num), head_num=(self.head_num),
          ...
          layer_depth=(self.layer_depth))(encoder_embed)
        ...
        decoded_layer = DecoderList(decoder_num=(self.decoder_num), head_num=(self.head_num),
          hidden_dim=(self.hidden_dim),
          attention_activation=(self.attention_activation),
          feed_forward_activation=(self.feed_forward_activation),
          dropout_rate=(self.dropout_rate),
