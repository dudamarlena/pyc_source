...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/model/inception.py
# Compiled at: 2020-04-14 23:33:18
# Size of source mod 2**32: 13252 bytes
...
from tensorflow.keras.layers import AveragePooling2D, MaxPooling2D, GlobalAveragePooling2D, Dense
from tensorflow.keras.layers import concatenate, Input, Conv2D, BatchNormalization, Activation, GlobalMaxPooling2D
...
def InceptionV3(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000, **kwargs):
    ...
    if not weights in {None, 'imagenet'}:
        if not os.path.exists(weights):
            ...
            weights_path = keras_utils.get_file('inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5',
              WEIGHTS_PATH_NO_TOP,
              cache_subdir='models',
