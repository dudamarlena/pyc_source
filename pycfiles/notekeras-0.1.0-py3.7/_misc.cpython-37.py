...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/notekeras/model/retinanet/layers/_misc.py
# Compiled at: 2020-04-22 05:28:30
# Size of source mod 2**32: 2792 bytes
import numpy as np
import tensorflow.keras.backend as K
from tensorflow.keras.layers import Layer
import notekeras.model.retinanet.utils as utils_anchors
from notekeras.utils import utils_retinanet

class Anchors(Layer):
    __doc__ = ' Keras layer for generating achors for a given shape.\n    '
    ...
    def __init__(self, size, stride, ratios=None, scales=None, *args, **kwargs):
        ...
        if ratios is None:
            ...
            self.anchors = K.variable(utils_anchors.generate_anchors(base_size=(self.size),
              ratios=(self.ratios),
              scales=(self.scales)))
