...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyams_i18n/language.py
# Compiled at: 2020-02-20 11:01:05
# Size of source mod 2**32: 15044 bytes
...
class BaseLanguagesVocabulary(SimpleVocabulary):
    __doc__ = 'Base languages vocabulary, matching ISO 639-1 languages codes'

    def __init__(self, context=None):
        request = check_request()
        translate = request.localizer.translate
        terms = sorted([SimpleTerm(v, title=translate(t)) for v, t in BASE_LANGUAGES.items()], key=lambda x: x.title)
...
class ISOLanguagesVocabulary(SimpleVocabulary):
    __doc__ = 'Get vocabulary of ISO languages'
