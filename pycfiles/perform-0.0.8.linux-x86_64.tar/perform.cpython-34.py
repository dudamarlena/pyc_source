...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python3.4/site-packages/perform.py
# Compiled at: 2015-02-12 13:45:35
...
import os, re, subprocess, sys, doctest
from os import path
...
def refresh_listing():
    ...
    for program in get_programs():
        if re.match('^[a-zA-Z_][a-zA-Z_0-9]*$', program) is not None:
