...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/qiita/users.py
# Compiled at: 2012-10-19 04:22:42
"""
    qiita.users
    ~~~~~~~~~~~
...
class Users(Client):
    ...
    def user_items(self, url_name=None, params=None):
        ...
        :param params:
        """
        path = '/items' if url_name is None else ('/users/{0}/items').format(url_name)
    ...
    def user_stocks(self, url_name=None, params=None):
        ...
        :param params:
        """
        path = '/stocks' if url_name is None else ('/users/{0}/stocks').format(url_name)
        params = {} if params is None else params
        return self.get(path, params)
