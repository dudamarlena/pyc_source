...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-x86_64/egg/qiita/client.py
# Compiled at: 2012-10-19 12:05:19
"""
    qiita.client
    ~~~~~~~~~~~~
...
class Client(object):
    ...
    def _request(self, method, path, params=None):
        ...
        if method == 'get':
            ...
            response = self.requests.delete(uri, params=params, headers=headers)
        elif method == 'post':
            response = self.requests.post(uri, data=json.dumps(params), headers=headers)
        elif method == 'put':
            response = self.requests.put(uri, data=json.dumps(params), headers=headers)
