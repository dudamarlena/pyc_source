...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/hcpre/config.py
# Compiled at: 2014-05-16 08:25:33
import os, sys
...
def update_conf(conf_path):
    ...
    if needs_smap:
        ...
        pool = Pool(processes=min(15, int(round(cpu_count() * 0.75))))
