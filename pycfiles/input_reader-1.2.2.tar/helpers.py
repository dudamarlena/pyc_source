...
# [GCC 8.4.0]
# Embedded file name: /Users/Seth/Programming/input_reader/input_reader/helpers.py
...
class Namespace(object):
    ...
    def __repr__(self):
        ...
        for name, value in self._get_kwargs():
            arg_strings.append((b'{0}={1!r}').format(name, value))

        return (b'{0}({1})').format(type_name, (b', ').join(arg_strings))
