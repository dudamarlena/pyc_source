...
# Compiled at: 2019-02-26 10:18:01
...
def plot_dos_tf(energies, dos_t, dos_f):
    ...
    if len(dos_t) == 1:
        ax.fill_between(energies,
          0, (dos_t[0]), facecolor='grey', alpha=0.5)
        ...
        ax.fill_between(energies,
          0, (dos_t[0]), facecolor='grey', alpha=0.5)
        ax.fill_between(energies,
          0, (-dos_t[1]), facecolor='grey', alpha=0.5)
...
def driver_plot_dos():
    ...
    if '-h' in sys.argv:
        ...
        if '-ch' in sys.argv:
            ...
            coherentonly = False
    energies, dos_t, dos_f = h5get_dos(ewin=(emin, emax), delta=delta, npts=npts,
