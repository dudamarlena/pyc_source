...
# Embedded file name: /home/ykent/GitLab/pygrisb/pygrisb/pygrisb/gutz/self_energy.py
# Compiled at: 2019-02-23 23:09:12
# Size of source mod 2**32: 6475 bytes
import numpy as np
from scipy.linalg import block_diag
from pygrisb.math.matrix_util import trans_orbital_fast_to_spin_fast
from pygrisb.symm.angular_momentum_1p import get_J_generator, get_JU_relat_sph_harm_cg
...
def get_self_energy_cf_nosoc(l_list, ispin, rotations):
    ...
    if ispin == 2:
        ...
        shift = 0
    self_energy = block_diag(self_energy_half, shift_self_energy(self_energy_half, shift))
    self_energy = trans_orbital_fast_to_spin_fast(self_energy)
    dim_t = Uhalf.shape[0]
    J = []
    for Jh1 in Jhalf:
...
if __name__ == '__main__':
    ...
    U, self_energy = get_self_energy(l_list, ispin, orbital_pol, cf, iso, rotations)
    print(' self_energy = ')
    print(self_energy)
    symbols = [
     'H', 'H', 'H', 'H', 'H', 'H']
    ...
    from pygrisb.gutz.molecule import xyz_get_rot_list
    ...
    orbital_pol = 'n'
    cf = 'y'
    J, U, self_energy = get_self_energy(l_list, ispin, orbital_pol, cf, iso, rotations)
    print(' self_energy = ')
    print(self_energy)