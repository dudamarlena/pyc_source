...
# [GCC 8.4.0]
# Embedded file name: f:\works\py\ipdiranproject\django-role-permissions\rolepermissions\roles.py
...
class AbstractUserRole(object):
    ...
    def get_or_create_permissions(cls, permission_names):
        ...
        permissions = list(Permission.objects.filter(content_type=user_ct,
          codename__in=permission_names).all())
