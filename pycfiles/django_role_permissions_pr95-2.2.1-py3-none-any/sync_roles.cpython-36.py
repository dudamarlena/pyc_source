...
# [GCC 8.4.0]
# Embedded file name: F:\Works\Py\IPDIranProject\django-role-permissions\rolepermissions\management\commands\sync_roles.py
# Compiled at: 2018-12-21 08:02:13
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--reset_user_permissions',
          action='store_true',
