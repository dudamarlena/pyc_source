...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/dbETL/batch2mysql.py
# Compiled at: 2018-02-26 23:35:57
...
db = pymysql.connect(host=dburl, user=dbusername, passwd=dbpasswd, port=3306, db='research', charset='utf8')
cur = db.cursor()
