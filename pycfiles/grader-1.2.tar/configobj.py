...
# [GCC 8.4.0]
# Embedded file name: /home/luis/Dropbox/projects/grader/grader/configobj.py
# Compiled at: 2010-02-28 00:36:16
...
class Section(dict):
 ...
 L. 596         0  LOAD_GLOBAL           0  'isinstance'
                3  LOAD_FAST             1  'key'
                6  LOAD_GLOBAL           1  'basestring'
                9  CALL_FUNCTION_2       2  None
               12  POP_JUMP_IF_TRUE     34  'to 34'

 L. 597        15  LOAD_GLOBAL           2  'ValueError'
               18  LOAD_CONST               'The key "%s" is not a string.'
               21  LOAD_FAST             1  'key'
               24  BINARY_MODULO    
               25  CALL_FUNCTION_1       1  None
               28  RAISE_VARARGS_1       1  None
               31  JUMP_FORWARD          0  'to 34'
             34_0  COME_FROM            31  '31'

 L. 600        34  LOAD_FAST             1  'key'
               37  LOAD_FAST             0  'self'
               40  LOAD_ATTR             3  'comments'
               43  COMPARE_OP            7  not-in
               46  POP_JUMP_IF_FALSE    78  'to 78'

 L. 601        49  BUILD_LIST_0          0 
               52  LOAD_FAST             0  'self'
               55  LOAD_ATTR             3  'comments'
               58  LOAD_FAST             1  'key'
               61  STORE_SUBSCR     

 L. 602        62  LOAD_CONST               ''
               65  LOAD_FAST             0  'self'
               68  LOAD_ATTR             4  'inline_comments'
               71  LOAD_FAST             1  'key'
               74  STORE_SUBSCR     
               75  JUMP_FORWARD          0  'to 78'
             78_0  COME_FROM            75  '75'

 L. 604        78  LOAD_FAST             1  'key'
               81  LOAD_FAST             0  'self'
               84  LOAD_ATTR             5  'defaults'
               87  COMPARE_OP            6  in
               90  POP_JUMP_IF_FALSE   112  'to 112'

 L. 605        93  LOAD_FAST             0  'self'
               96  LOAD_ATTR             5  'defaults'
               99  LOAD_ATTR             6  'remove'
              102  LOAD_FAST             1  'key'
 ...
 L. 607       112  LOAD_GLOBAL           0  'isinstance'
              115  LOAD_FAST             2  'value'
              118  LOAD_GLOBAL           7  'Section'
              121  CALL_FUNCTION_2       2  None
              124  POP_JUMP_IF_FALSE   180  'to 180'

 L. 608       127  LOAD_FAST             1  'key'
              130  LOAD_FAST             0  'self'
              133  COMPARE_OP            7  not-in
              136  POP_JUMP_IF_FALSE   158  'to 158'

 L. 609       139  LOAD_FAST             0  'self'
              142  LOAD_ATTR             8  'sections'
              145  LOAD_ATTR             9  'append'
              148  LOAD_FAST             1  'key'
              151  CALL_FUNCTION_1       1  None
              154  POP_TOP          
              155  JUMP_FORWARD          0  'to 158'
            158_0  COME_FROM           155  '155'

 L. 610       158  LOAD_GLOBAL          10  'dict'
              161  LOAD_ATTR            11  '__setitem__'
              164  LOAD_FAST             0  'self'
              167  LOAD_FAST             1  'key'
              170  LOAD_FAST             2  'value'
              173  CALL_FUNCTION_3       3  None
              176  POP_TOP          
              177  JUMP_FORWARD        289  'to 469'

 L. 611       180  LOAD_GLOBAL           0  'isinstance'
              183  LOAD_FAST             2  'value'
              186  LOAD_GLOBAL          10  'dict'
              189  CALL_FUNCTION_2       2  None
              192  POP_JUMP_IF_FALSE   295  'to 295'
              195  LOAD_FAST             3  'unrepr'
              198  UNARY_NOT        
            199_0  COME_FROM           192  '192'
              199  POP_JUMP_IF_FALSE   295  'to 295'

 L. 614       202  LOAD_FAST             1  'key'
              205  LOAD_FAST             0  'self'
              208  COMPARE_OP            7  not-in
              211  POP_JUMP_IF_FALSE   233  'to 233'

 L. 615       214  LOAD_FAST             0  'self'
              217  LOAD_ATTR             8  'sections'
 ...
 L. 616       233  LOAD_FAST             0  'self'
              236  LOAD_ATTR            12  'depth'
              239  LOAD_CONST               1
              242  BINARY_ADD       
              243  STORE_FAST            4  'new_depth'

 L. 617       246  LOAD_GLOBAL          10  'dict'
              249  LOAD_ATTR            11  '__setitem__'

 L. 618       252  LOAD_FAST             0  'self'

 L. 619       255  LOAD_FAST             1  'key'

 L. 620       258  LOAD_GLOBAL           7  'Section'

 L. 621       261  LOAD_FAST             0  'self'

 L. 622       264  LOAD_FAST             4  'new_depth'

 L. 623       267  LOAD_FAST             0  'self'
              270  LOAD_ATTR            13  'main'
              273  LOAD_CONST               'indict'

 L. 624       276  LOAD_FAST             2  'value'
              279  LOAD_CONST               'name'

 L. 625       282  LOAD_FAST             1  'key'
              285  CALL_FUNCTION_515   515  None
              288  CALL_FUNCTION_3       3  None
              291  POP_TOP          
              292  JUMP_FORWARD        174  'to 469'

 L. 627       295  LOAD_FAST             1  'key'
              298  LOAD_FAST             0  'self'
              301  COMPARE_OP            7  not-in
              304  POP_JUMP_IF_FALSE   326  'to 326'

 L. 628       307  LOAD_FAST             0  'self'
              310  LOAD_ATTR            14  'scalars'
              313  LOAD_ATTR             9  'append'
              316  LOAD_FAST             1  'key'
              319  CALL_FUNCTION_1       1  None
              322  POP_TOP          
              323  JUMP_FORWARD          0  'to 326'
            326_0  COME_FROM           323  '323'

 L. 629       326  LOAD_FAST             0  'self'
              329  LOAD_ATTR            13  'main'
              332  LOAD_ATTR            15  'stringify'
              335  POP_JUMP_IF_TRUE    450  'to 450'

 L. 630       338  LOAD_GLOBAL           0  'isinstance'
              341  LOAD_FAST             2  'value'
              344  LOAD_GLOBAL           1  'basestring'
              347  CALL_FUNCTION_2       2  None
            350_0  COME_FROM           335  '335'
              350  POP_JUMP_IF_FALSE   356  'to 356'

 L. 631       353  JUMP_ABSOLUTE       450  'to 450'

 L. 632       356  LOAD_GLOBAL           0  'isinstance'
              359  LOAD_FAST             2  'value'
              362  LOAD_GLOBAL          16  'list'
              365  LOAD_GLOBAL          17  'tuple'
              368  BUILD_TUPLE_2         2 
              371  CALL_FUNCTION_2       2  None
              374  POP_JUMP_IF_FALSE   431  'to 431'

 L. 633       377  SETUP_LOOP           67  'to 447'
              380  LOAD_FAST             2  'value'
              383  GET_ITER         
              384  FOR_ITER             40  'to 427'
              387  STORE_FAST            5  'entry'

 L. 634       390  LOAD_GLOBAL           0  'isinstance'
              393  LOAD_FAST             5  'entry'
              396  LOAD_GLOBAL           1  'basestring'
              399  CALL_FUNCTION_2       2  None
              402  POP_JUMP_IF_TRUE    384  'to 384'

 L. 635       405  LOAD_GLOBAL          18  'TypeError'
              408  LOAD_CONST               'Value is not a string "%s".'
              411  LOAD_FAST             5  'entry'
              414  BINARY_MODULO    
              415  CALL_FUNCTION_1       1  None
              418  RAISE_VARARGS_1       1  None
              421  JUMP_BACK           384  'to 384'
              424  JUMP_BACK           384  'to 384'
              427  POP_BLOCK        
            428_0  COME_FROM           377  '377'
              428  JUMP_ABSOLUTE       450  'to 450'

 L. 637       431  LOAD_GLOBAL          18  'TypeError'
              434  LOAD_CONST               'Value is not a string "%s".'
              437  LOAD_FAST             2  'value'
              440  BINARY_MODULO    
              441  CALL_FUNCTION_1       1  None
              444  RAISE_VARARGS_1       1  None
              447  JUMP_FORWARD          0  'to 450'
            450_0  COME_FROM           447  '447'

 L. 638       450  LOAD_GLOBAL          10  'dict'
              453  LOAD_ATTR            11  '__setitem__'
              456  LOAD_FAST             0  'self'
              459  LOAD_FAST             1  'key'
              462  LOAD_FAST             2  'value'
              465  CALL_FUNCTION_3       3  None
              468  POP_TOP          
            469_0  COME_FROM           292  '292'
            469_1  COME_FROM           177  '177'

Parse error at or near `JUMP_ABSOLUTE' instruction at offset 353
...
class ConfigObj(Section):
    ...
    def __init__(self, infile=None, options=None, configspec=None, encoding=None, interpolation=True, raise_errors=False, list_values=True, create_empty=False, file_error=False, stringify=True, indent_type=None, default_encoding=None, unrepr=False, write_empty_values=False, _inspec=False):
        ...
        infile = infile or []
        _options = {'configspec': configspec, 'encoding': encoding, 
        ...
        if options is None:
            ...
            import warnings
            warnings.warn('Passing in an options dictionary to ConfigObj() is deprecated. Use **options instead.', DeprecationWarning, stacklevel=2)
