...
# [GCC 8.4.0]
# Embedded file name: /home/uros/Projects/BrickBreaker/BrickBreaker/double_pad.py
# Compiled at: 2017-12-13 09:34:09
# Size of source mod 2**32: 1146 bytes
from BrickBreaker.Shared import *

class DoublePad(GameObject):
    ...
    def __init__(self, position, image):
        ...
        self._mouse = False
        self._keyboard = True
        super().__init__(position, GameConstants.DOUBLE_PAD_SIZE, image)
