...
# [GCC 8.4.0]
# Embedded file name: BrickBreaker/ball.py
...
class Ball(GameObject):
    ...
    def change_direction(self, game_object):
        ...
        if object_position[1] + object_size[1] > position[1] > object_position[1] and object_position[0] + object_size[0] > position[0] > object_position[0]:
            self.set_position((position[0], object_position[1] + object_size[1]))
            self._direction[1] *= -1
        elif object_position[1] + object_size[1] > position[1] + size[1] > object_position[1] and object_position[0] + object_size[0] > position[0] > object_position[0]:
            self.set_position((position[0], object_position[1] - object_size[1]))
            self._direction[1] *= -1
