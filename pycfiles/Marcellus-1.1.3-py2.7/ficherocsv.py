...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/marcellus/ficherocsv.py
# Compiled at: 2013-11-04 14:04:20
import cStringIO, csv
from decimal import Decimal
import datetime
from marcellus.util import default_fmt_float, datetostr, timetostr
...
class FicheroCSV(object):
    ...
    def __init__(self):
        ...
        self.w_csv = csv.writer(self.fichero_csv, delimiter=';', quoting=csv.QUOTE_ALL)
