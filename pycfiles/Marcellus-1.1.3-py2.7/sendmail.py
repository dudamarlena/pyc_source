...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/marcellus/sendmail.py
# Compiled at: 2014-07-30 13:02:10
...
def send_mail(from_, to_, subject, message, server, login, password, files=[], images=[], html='', cc=[], bcc=[], reply_to=None, charset='utf-8', ssl=False):
    u"""
    IN
