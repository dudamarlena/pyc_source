...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/ups/model.py
# Compiled at: 2014-08-02 21:25:12
import re

class Package(object):

    def __init__(self, weight, length, width, height, value=0, require_signature=False, reference=''):
        self.weight = weight
        self.length = length
        self.width = width
        self.height = height
