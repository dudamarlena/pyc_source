...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/softwarefabrica/django/utils/tests/settings.py
...
INSTALLED_APPS = ('django.contrib.contenttypes', 'softwarefabrica.django.utils', 'softwarefabrica.django.utils.tests')