...
# Embedded file name: build/bdist.linux-x86_64/egg/pyquchk/arbitraries/primitives.py
# Compiled at: 2013-09-22 13:27:43
import random
from string import ascii_letters
from .arbitrary import Arbitrary, get_arbitrary, with_samples
from .utils import roundrobin, filter_possible, unique
__all__ = [
 'const', 'elements', 'oneof', 'bool_', 'char', 'letter']
...
class oneof(Arbitrary):
    ...
    def __init__(self, *arbitraries):
        arbitraries = [ arb if isinstance(arb, tuple) else (arb, 1) for arb in arbitraries
                      ]
