...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pynestml/meta_model/ast_small_stmt.py
# Compiled at: 2020-03-05 05:49:41
# Size of source mod 2**32: 6587 bytes
...
class ASTSmallStmt(ASTNode):
    ...
    def equals(self, other):
        ...
        if self.is_declaration() + other.is_declaration() == 1:
            return False
        if self.is_declaration() and other.is_declaration() and not self.get_declaration().equals(other.get_declaration()):
            return False
