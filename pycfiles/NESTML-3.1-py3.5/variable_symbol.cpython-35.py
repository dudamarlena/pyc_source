...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pynestml/symbols/variable_symbol.py
# Compiled at: 2020-03-05 05:49:41
# Size of source mod 2**32: 16819 bytes
...
class VariableSymbol(Symbol):
    ...
    def __init__(self, element_reference=None, scope=None, name=None, block_type=None, vector_parameter=None, declaring_expression=None, is_predefined=False, is_function=False, is_recordable=False, type_symbol=None, initial_value=None, variable_type=None):
        """
        ...
        """
        super(VariableSymbol, self).__init__(element_reference=element_reference, scope=scope, name=name, symbol_kind=SymbolKind.VARIABLE)
    ...
    def has_declaring_expression(self):
        ...
        :rtype: bool
        """
        return self.declaring_expression is not None and (isinstance(self.declaring_expression, ASTSimpleExpression) or isinstance(self.declaring_expression, ASTExpression))
    ...
    def print_symbol(self):
        ...
        return 'VariableSymbol[' + self.get_symbol_name() + ', type=' + typ_e + ', ' + str(self.block_type) + ', ' + recordable + func + conductance_based + 'array parameter=' + vector_value + ', @' + source_position + ')'
    ...
    def is_ode_defined(self):
        ...
        :rtype: bool
        """
        return self.ode_declaration is not None and (isinstance(self.ode_declaration, ASTExpression) or isinstance(self.ode_declaration, ASTSimpleExpression))
    ...
    def has_initial_value(self):
        ...
        :rtype: bool
        """
        return self.initial_value is not None and (isinstance(self.initial_value, ASTSimpleExpression) or isinstance(self.initial_value, ASTExpression))
