...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pynestml/frontend/frontend_configuration.py
# Compiled at: 2020-03-05 05:49:41
# Size of source mod 2**32: 10965 bytes
import argparse, os, re, pynestml
...
class FrontendConfiguration(object):
    ...
    def parse_config(cls, args):
        ...
        if parsed_args.module_name is not None:
            ...
            if os.path.isfile(parsed_args.input_path):
                ...
                if os.path.isdir(parsed_args.input_path):
    ...
    def handle_input_path(cls, path):
        ...
        if os.path.isfile(cls.provided_path):
            ...
            if os.path.isdir(cls.provided_path):
