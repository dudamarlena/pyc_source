...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tests/expression_parser_test.py
...
class ExpressionParsingTest(unittest.TestCase):
    ...
    def test(self):
        input_file = FileStream(os.path.join(os.path.realpath(os.path.join(os.path.dirname(__file__), 'resources')), 'ExpressionCollection.nestml'))
