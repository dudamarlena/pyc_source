...
# [GCC 8.4.0]
# Embedded file name: /Users/benjaminweb/22_Projekte/Pareto/python/venv/lib/python3.6/site-packages/effectus/pareto.py
# Compiled at: 2017-01-27 14:08:44
...
def entropy(effect_values):
    ...
    if negatives > 0:
        if positives > 0:
            raise ValueError("You may use positive OR negative values only. Don't mix them ")
...
def ratio(effect_values, precision=3):
    ...
    Example:
        ...
        0.707
    """
    return round(entropy(effect_values) / control_limit(len(effect_values)), precision)
