...
# Compiled at: 2016-02-25 15:06:42
"""
...
def upload_all_books(book_id_start, book_id_end, rdf_library=None):
    ...
    """
    logging.info(('starting a gitberg mass upload: {0} -> {1}').format(book_id_start, book_id_end))
...
def upload_book(book_id, rdf_library=None):
    ...
    try:
        ...
        logging.error(("Can't parse metadata for this book: {0}").format(book.book_id))
        return
