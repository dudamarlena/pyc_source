...
# [GCC 8.4.0]
# Embedded file name: /Users/eric/github/local/gitberg/gitenberg/tests/test_metadata.py
# Compiled at: 2016-03-04 12:26:18
import os, unittest, yaml, json, gitenberg.metadata.marc as marc, pymarc
...
class Yaml2MarcTest(unittest.TestCase):
    ...
    def test_pandata(self):
        ...
        self.assertEqual(self.pandata.subjects[0][0], 'lcsh')
...
class PandataTest(unittest.TestCase):
    ...
    def test_editions(self):
        ...
        self.assertEqual(ed2.edition_identifiers['edition_id'], 'repo:Space-Viking_20728#9781111122223')
        pandata = Pandata('https://github.com/gitenberg-dev/metadata/raw/master/samples/pandata.yaml')
