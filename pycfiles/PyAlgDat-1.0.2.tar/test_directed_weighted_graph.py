...
# [GCC 8.4.0]
# Embedded file name: /Users/horn/Code/pythonprojects/py_alg_dat/testsuite/test_directed_weighted_graph.py
...
class TestDirectedWeightedGraph(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph1.add_edge(self.v1_g1, self.v2_g1, 10)
        self.graph1.add_edge(self.v1_g1, self.v4_g1, 5)
        self.graph1.add_edge(self.v2_g1, self.v3_g1, 1)
        self.graph1.add_edge(self.v2_g1, self.v4_g1, 2)
        self.graph1.add_edge(self.v3_g1, self.v5_g1, 4)
        self.graph1.add_edge(self.v4_g1, self.v2_g1, 3)
        self.graph1.add_edge(self.v4_g1, self.v3_g1, 9)
        self.graph1.add_edge(self.v4_g1, self.v5_g1, 2)
        self.graph1.add_edge(self.v5_g1, self.v3_g1, 6)
        self.graph1.add_edge(self.v5_g1, self.v1_g1, 7)
        ...
        self.graph2.add_edge(self.v0_g2, self.v1_g2, 10)
        self.graph2.add_edge(self.v0_g2, self.v2_g2, 11)
        self.graph2.add_edge(self.v0_g2, self.v4_g2, 12)
        self.graph2.add_edge(self.v1_g2, self.v3_g2, 13)
        self.graph2.add_edge(self.v1_g2, self.v4_g2, 14)
        self.graph2.add_edge(self.v2_g2, self.v7_g2, 15)
        self.graph2.add_edge(self.v2_g2, self.v5_g2, 16)
        self.graph2.add_edge(self.v3_g2, self.v6_g2, 17)
        self.graph2.add_edge(self.v4_g2, self.v6_g2, 18)
        self.graph2.add_edge(self.v4_g2, self.v8_g2, 19)
        self.graph2.add_edge(self.v4_g2, self.v7_g2, 20)
        self.graph2.add_edge(self.v5_g2, self.v7_g2, 21)
        self.graph2.add_edge(self.v6_g2, self.v8_g2, 22)
        self.graph2.add_edge(self.v7_g2, self.v8_g2, 24)
