...
# [GCC 8.4.0]
# Embedded file name: /Users/horn/Code/pythonprojects/py_alg_dat/testsuite/test_graph_algorithms.py
...
class TestGraphAlgorithms(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph1.add_edge(self.v1_g1, self.v2_g1, 7)
        self.graph1.add_edge(self.v1_g1, self.v4_g1, 5)
        self.graph1.add_edge(self.v2_g1, self.v3_g1, 8)
        self.graph1.add_edge(self.v2_g1, self.v4_g1, 9)
        self.graph1.add_edge(self.v2_g1, self.v5_g1, 7)
        self.graph1.add_edge(self.v3_g1, self.v5_g1, 5)
        self.graph1.add_edge(self.v4_g1, self.v5_g1, 15)
        self.graph1.add_edge(self.v4_g1, self.v6_g1, 6)
        self.graph1.add_edge(self.v5_g1, self.v6_g1, 8)
        self.graph1.add_edge(self.v5_g1, self.v7_g1, 9)
        self.graph1.add_edge(self.v6_g1, self.v7_g1, 11)
        ...
        self.graph2.add_edge(self.v0_g2, self.v1_g2, 7)
        self.graph2.add_edge(self.v1_g2, self.v2_g2, 2)
        self.graph2.add_edge(self.v1_g2, self.v6_g2, 3)
        self.graph2.add_edge(self.v2_g2, self.v3_g2, 2)
        self.graph2.add_edge(self.v2_g2, self.v6_g2, 4)
        self.graph2.add_edge(self.v3_g2, self.v4_g2, 5)
        self.graph2.add_edge(self.v3_g2, self.v6_g2, 1)
        self.graph2.add_edge(self.v4_g2, self.v5_g2, 6)
        self.graph2.add_edge(self.v5_g2, self.v0_g2, 1)
        self.graph2.add_edge(self.v5_g2, self.v6_g2, 4)
        self.graph2.add_edge(self.v6_g2, self.v0_g2, 7)
        self.graph2.add_edge(self.v6_g2, self.v4_g2, 1)
