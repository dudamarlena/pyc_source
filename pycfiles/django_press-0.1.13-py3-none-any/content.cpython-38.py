...
# [GCC 8.4.0]
# Embedded file name: C:\Users\yuuta\YCU-Programing\Code_Review\ura_1\django_press\models\page\content.py
...
class PageContent(PolymorphicModel):
    ...
    priority = models.PositiveSmallIntegerField(verbose_name='ページ内の表示順(昇順)',
      default=1,
...
class ImageSlider(PageContent):
    ...
    content = models.ManyToManyField(to=ImageFile,
      verbose_name='画像')
...
class Tab(PageContent):
    ...
    tabs = models.ManyToManyField(to=TabElement,
      verbose_name='タブ要素')
...
class ContactContent(PageContent):
    ...
    form = models.CharField(max_length=100,
      choices=((
     inquiry.__module__, inquiry.__name__) for inquiry in BaseInquiry.__subclasses__()))
    success_page = models.ForeignKey(to='Page',
