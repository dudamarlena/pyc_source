...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-ncu5lfw4/arelle/arelle/UITkTable.py
# Compiled at: 2018-08-09 04:11:41
# Size of source mod 2**32: 39295 bytes
"""
...
class Coordinate(object):
    ...
    def __lt__(self, other):
        return self._ne_(other) and (self.y < other.y or self.y == other.y and self.x < other.x)
...
class XbrlTable(TkTableWrapper.Table):
    ...
    ANCHOR_POSITIONS = {TG_LEFT_JUSTIFIED: W, 
     TG_RIGHT_JUSTIFIED: E, 
     TG_CENTERED: CENTER, 
     TG_TOP_LEFT_JUSTIFIED: NW}
    JUSTIFICATIONS = {TG_LEFT_JUSTIFIED: LEFT, 
     TG_RIGHT_JUSTIFIED: RIGHT, 
     TG_CENTERED: CENTER, 
    ...
    BORDERWIDTHS = {TG_NO_BORDER: (0, 0, 0, 0), 
    ...
    def getCoordinatesFromEventXY(self, event):
        indexArg = '@' + str(event.x) + ',' + str(event.y)
    ...
    def __init__(self, parentWidget, rows, columns, titleRows, titleColumns, tableName=None, browsecmd=None):
        """
        ...
        if browsecmd is None:
            if USE_resizeTableCells:
                super(XbrlTable, self).__init__(parentWidget, rows=rows, cols=columns, state='normal', titlerows=titleRows, titlecols=titleColumns, roworigin=0, colorigin=0, selectmode='extended', selecttype='cell', rowstretch='none', colstretch='none', rowheight=self.DEFAULT_ROW_HEIGHT, colwidth=self.DEFAULT_COLUMN_WIDTH, flashmode='off', anchor=NE, usecommand=1, background='#d00d00d00', relief='ridge', command=self._valueCommand, takefocus=False, rowseparator='\n', wrap=1, borderwidth=(1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             0), multiline=1)
            else:
                super(XbrlTable, self).__init__(parentWidget, rows=rows, cols=columns, state='normal', titlerows=titleRows, titlecols=titleColumns, roworigin=0, colorigin=0, selectmode='extended', selecttype='cell', rowstretch='none', colstretch='none', rowheight=-30, colwidth=15, flashmode='off', anchor=NE, usecommand=1, background='#d00d00d00', relief='ridge', command=self._valueCommand, takefocus=False, rowseparator='\n', wrap=1, borderwidth=(1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  0), multiline=1)
        else:
            if USE_resizeTableCells:
                super(XbrlTable, self).__init__(parentWidget, rows=rows, cols=columns, state='normal', titlerows=titleRows, titlecols=titleColumns, roworigin=0, colorigin=0, selectmode='extended', selecttype='cell', rowstretch='none', colstretch='none', rowheight=self.DEFAULT_ROW_HEIGHT, colwidth=self.DEFAULT_COLUMN_WIDTH, flashmode='off', anchor=NE, usecommand=1, background='#d00d00d00', relief='ridge', command=self._valueCommand, takefocus=False, rowseparator='\n', wrap=1, multiline=1, borderwidth=(1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          0), browsecmd=browsecmd)
            else:
                super(XbrlTable, self).__init__(parentWidget, rows=rows, cols=columns, state='normal', titlerows=titleRows, titlecols=titleColumns, roworigin=0, colorigin=0, selectmode='extended', selecttype='cell', rowstretch='none', colstretch='none', rowheight=-30, colwidth=15, flashmode='off', anchor=NE, usecommand=1, background='#d00d00d00', relief='ridge', command=self._valueCommand, takefocus=False, rowseparator='\n', wrap=1, multiline=1, borderwidth=(1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               0,
        ...
        self.tag_configure('sel', background='#b00e00e60', fg='#000000000')
        self.tag_configure('active', background='#000f70ff0', fg='#000000000')
        self.tag_configure('title', anchor='w', bg='#d00d00d00', fg='#000000000', relief='ridge')
        self.tag_configure(XbrlTable.TG_DISABLED, bg='#d00d00d00', fg='#000000000', relief='flat', state='disabled')
        if rows + columns > 2:
            topCell = '0,0'
    ...
    def _applyFormat(self, tagname, option):
        ...
        if option in XbrlTable.BORDERWIDTHS:
            ...
            self.tag_configure(tagname, relief='ridge', borderwidth=c)
        else:
            if option in XbrlTable.COLOURS:
                self.tag_configure(tagname, bg=XbrlTable.COLOURS[option])
            elif option in XbrlTable.ANCHOR_POSITIONS:
                self.tag_configure(tagname, anchor=XbrlTable.ANCHOR_POSITIONS[option])
                self.tag_configure(tagname, justify=XbrlTable.JUSTIFICATIONS[option])
    ...
    def set(self, rc=None, index=None, objectId=None, *args, **kwargs):
        super(XbrlTable, self).set(*args, **kwargs)
    ...
    def isHeaderCell(self, coordinate):
        return coordinate.y < self.titleRows or coordinate.x < self.titleColumns
    ...
    def initCellValue(self, value, x, y, backgroundColourTag='bg-white', justification='left', objectId=None):
        """
        ...
        if backgroundColourTag is not None and backgroundColourTag in XbrlTable.COLOURS:
    ...
    def initCellCombobox(self, value, values, x, y, isOpen=False, objectId=None, selectindex=None, comboboxselected=None, codes=dict()):
        """
        ...
        """
        cellIndex = '%i,%i' % (y, x)
        combobox = TableCombobox(self, values=values, state='active' if isOpen else 'readonly')
        ...
        combobox.bind(sequence='<<ComboboxSelected>>', func=self._setValueFromCombobox, add='+')
        if comboboxselected:
            combobox.bind(sequence='<<ComboboxSelected>>', func=comboboxselected, add='+')
        self.window_configure(cellIndex, window=combobox, sticky=(
         N, E, S, W))
    ...
    def _updateMaxSizes(self, value, x, y, colspan, rowspan, minWidth=0):
        ...
        if value is not None:
            ...
            colWidthBeforeWrapping = (valueSize + colspan) // colspanPlus1
    ...
    def initHeaderCellValue(self, value, x, y, colspan, rowspan, justification, objectId=None, isRollUp=False):
        """
        ...
        self.initHeaderBorder(x, y, hasLeftBorder=True, hasTopBorder=True, hasRightBorder=True, hasBottomBorder=not isRollUp)
        if isRollUp:
    ...
    def initHeaderCombobox(self, x, y, value='', values=(), colspan=0, rowspan=0, isOpen=True, objectId=None, selectindex=None, comboboxselected=None, codes=dict(), isRollUp=False):
        """
        ...
        return self.initCellCombobox(value, values, x, y, isOpen=isOpen, objectId=objectId, selectindex=selectindex, comboboxselected=comboboxselected, codes=codes)
    ...
    def initHeaderBorder(self, x, y, cellsToTheRight=0, cellsBelow=0, hasLeftBorder=False, hasTopBorder=False, hasRightBorder=False, hasBottomBorder=False):
        """
    ...
    def resizeTable(self, rows, columns, titleRows=-1, titleColumns=-1, clearData=True):
        """
        ...
        try:
            ...
            messagebox.showwarning(_('arelle - Error'), 'Failed resize table:\n{0}'.format(err), parent=self.master.view.modelXbrl.modelManager.cntlr.parent)
...
class ScrolledTkTableFrame(Frame):
    ...
    def __init__(self, parent, browseCmd, *args, **kw):
        ...
        self.verticalScrollbar = Scrollbar(self, orient='vertical', command=table.yview_scroll)
        self.horizontalScrollbar = Scrollbar(self, orient='horizontal', command=table.xview_scroll)
        table.config(xscrollcommand=self.horizontalScrollbar.set, yscrollcommand=self.verticalScrollbar.set)
