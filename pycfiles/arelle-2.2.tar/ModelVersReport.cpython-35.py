                ...
                if isinstance(modelObject, ModelObject):
                    ...
                    if ns in (XbrlConst.vercu, XbrlConst.vercb):
                        ...
                        if ns in (XbrlConst.vercd, XbrlConst.verce):
                            if ln in {'conceptTypeChange', 'conceptLabelChange', 'conceptFinalChange', 'conceptFixedChange', 'tupleContentModelChange', 'conceptLabelDelete', 'conceptAttributeAdd', 'conceptBlockChange', 'conceptSubstitutionGroupChange', 'conceptIDChange', 'conceptDefaultChange', 'conceptBalanceChange', 'conceptNillableChange', 'conceptPeriodTypeChange', 'conceptReferenceAdd', 'conceptAbstractChange', 'conceptAttributeChange', 'conceptAttributeDelete', 'conceptReferenceChange', 'conceptLabelAdd', 'conceptReferenceDelete'} and modelAction is not None:
                                modelAction.events.append(modelObject)
                        else:
