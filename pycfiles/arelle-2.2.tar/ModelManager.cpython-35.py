...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-ncu5lfw4/arelle/arelle/ModelManager.py
...
class ModelManager:
    ...
    def create(self, newDocumentType=None, url=None, schemaRefs=None, createModelDocument=True, isEntry=False, errorCaptureLevel=None, initialXml=None, base=None):
        self.modelXbrl = ModelXbrl.create(self, newDocumentType=newDocumentType, url=url, schemaRefs=schemaRefs, createModelDocument=createModelDocument, isEntry=isEntry, errorCaptureLevel=errorCaptureLevel, initialXml=initialXml, base=base)
        self.loadedModelXbrls.append(self.modelXbrl)
        return self.modelXbrl
    ...
    def compareDTSes(self, versReportFile, writeReportFile=True):
        ...
        if len(self.loadedModelXbrls) >= 2:
            ...
            modelVersReport = self.create(newDocumentType=Type.VERSIONINGREPORT, url=versReportFile, createModelDocument=False)
