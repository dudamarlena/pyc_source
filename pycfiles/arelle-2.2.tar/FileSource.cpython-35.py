                ...
                if self.isEis:
                    ...
                    try:
                        ...
                        while more:
                            ...
                            if len(l) < 8:
                                break
                            if len(buf) == 0 and l.startswith(b'<?xml '):
                                buf = l + file.read()
                                break
        ...
        if archiveFileSource.isZip:
            try:
                ...
                if binary:
                    ...
                    return (
                     FileNamedTextIOWrapper(filepath, io.BytesIO(b), encoding=encoding),
                     encoding)
            except KeyError:
                        ...
                        if outfn == archiveFileName:
                            ...
                            if b64data:
                                ...
                                if binary:
                                    ...
                                    return (
                                     io.TextIOWrapper(io.BytesIO(b), encoding=encoding),
                                     encoding)
