...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-ncu5lfw4/arelle/arelle/PythonUtil.py
...
class attrdict(dict):
    __doc__ = ' utility to simulate an object with named fields from a dict '
...
class OrderedDefaultDict(OrderedDict):
    __doc__ = ' call with default factory and optional sorted initial entries\n        e.g., OrderedDefaultDict(list, ((1,11),(2,22),...))\n    '
