...
# Embedded file name: /usr/local/lib/python2.7/site-packages/coinspot/coinspot.py
# Compiled at: 2014-10-23 23:16:44
__author__ = 'Peter Dyson <pete@geekpete.com>'
__version__ = '0.2.2'
__license__ = 'GPLv3'
__source__ = 'http://github.com/geekpete/py-coinspot-api/coinspot.py'
import hmac, hashlib, httplib, json, yaml, os, sys, logging
