...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/ipynbviewer/app.py
# Compiled at: 2015-01-26 23:27:25
import os, argparse, markdown
...
def main():
    ...
    notebook_manager = FileNotebookManager(notebook_dir=current_path, log=app_log)
    settings = dict(jinja2_env=env, static_path=static_path, exporter=exporter, config=config, pool=ThreadPoolExecutor(threads), gzip=True, log=app_log, render_timeout=20, document_path=document_path, notebook_manager=notebook_manager)
