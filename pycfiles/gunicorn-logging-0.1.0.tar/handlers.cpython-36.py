...
# [GCC 8.4.0]
# Embedded file name: /www/api/gunicorn-logging/gunicorn_logging/handlers.py
# Compiled at: 2018-06-19 03:25:23
...
class LogstashHandler(AsynchronousLogstashHandler):
    ...
    def __init__(self, port=None, host=None, database_path=None, transport=None, ssl_enable=None, ssl_verify=None, keyfile=None, certfile=None, ca_certs=None, enable=True, event_ttl=None, encoding=None):
        ...
        super(LogstashHandler, self).__init__(host=host, port=port, database_path=database_path, transport=transport, ssl_enable=ssl_enable,
