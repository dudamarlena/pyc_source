...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/nubo/clouds/rackspace.py
# Compiled at: 2013-04-13 08:47:15
"""     
...
class Rackspace(BaseCloud):
    ...
    def deploy(self, image_id, size_idx=0, location_idx=0, name='test'):
        ...
        script = ScriptDeployment('/bin/true')
        ...
        return node2dict(self.driver.deploy_node(name=name, image=Image, size=size, location=location, deploy=msd))