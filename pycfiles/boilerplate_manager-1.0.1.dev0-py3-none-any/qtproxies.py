...
# Embedded file name: C:\symlinks\repos\boilerplate_dcc_pyside_widget\boilerplate_dcc_pyside_widget\lib\third_party\pysideuic\Compiler\qtproxies.py
...
class QtGui(ProxyNamespace):
    ...
    class QToolBox(QFrame):
        ...
        def layout(self):
            return QtGui.QLayout('%s.layout()' % self, False, (), noInstantiation=True)
