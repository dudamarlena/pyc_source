...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/multistring/MultiString.py
# Compiled at: 2013-03-20 16:47:29
...
class MultiString(object):
    ...
    def translate(self, destination, flags=0, callback=None):
        ...
        """
        trx = None
        if self.context not in self.__trx__ or destination not in self.__trx__[self.context]:
            if callback:
