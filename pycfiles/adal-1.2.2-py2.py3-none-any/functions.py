...
# Embedded file name: /opt/adagios/adagios/pnp/functions.py
# Compiled at: 2018-05-16 10:07:32
import os, pynag.Utils
...
def find_pnp_path():
    ...
    raise PynagError(_('Could not find pnp4nagios/index.php. Please specify it in adagios->settings->PNP. Tried %s') % possible_paths)