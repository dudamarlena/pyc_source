...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/godirect/__init__.py
# Compiled at: 2020-04-22 13:26:30
# Size of source mod 2**32: 3103 bytes
import logging, importlib.util, platform
from .device import GoDirectDevice
from .sensor import GoDirectSensor
from .backend import GoDirectBackend

class GoDirect:
    __doc__ = ' The godirect module wraps the hidapi and pygatt modules to create an easy way to\n\tinteract with Vernier GoDirect devices.\n\t'
    VERSION = '1.0.7'
    BLE_AUTO_CONNECT_RSSI_THRESHOLD = -50
