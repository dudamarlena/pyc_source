...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/godirect/device_bleak.py
# Compiled at: 2020-04-22 13:26:08
...
class GoDirectDeviceBleak(GoDirectDevice):
    __doc__ = ' GoDirectDeviceBleak overrides GoDirectDevice with bleak module functions for connecting,\n\tdisconnecting, writing, and reading. The bleak module supports native BLE radios.\n\t'
    ...
    def _notify_callback(self, handle, value):
        ...
        if buflen >= 1:
            if buflen == int(self._response_buffer[1]):
