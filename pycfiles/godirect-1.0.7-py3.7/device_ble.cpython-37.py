...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-x86_64/egg/godirect/device_ble.py
# Compiled at: 2019-09-12 14:58:03
...
class GoDirectDeviceBLE(GoDirectDevice):
    __doc__ = ' GoDirectDeviceBLE overrides GoDirectDevice with BLE specific functions for connecting,\n\tdisconnecting, writing, and reading.\n\t'
