...
# [GCC 8.4.0]
# Embedded file name: /home/hari/greasehouse/crud/singleurlcrud/templatetags/crud_tags.py
# Compiled at: 2016-05-05 22:30:47
...
def render_item(context, item, rowindex, template):
    ...
    context['item_deletable'] = view.item_deletable(item) and not getattr(item, 'is_readonly', False)
    context['item_editable'] = view.item_editable(item) and not getattr(item, 'is_readonly', False)
