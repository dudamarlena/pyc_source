...
# [GCC 8.4.0]
# Embedded file name: /Users/scjurgen/Projects/hpd-20/hpd20/scales.py
# Compiled at: 2017-01-15 17:09:04
...
class Scale:
    ...
    scale_patterns = {'major': [
       ...
       'pentatonic minor': [
                          0, 3, 5, 7, 10], 
       'pentatonic blues min + maj 3rd': [
                                        0, 3, 4, 5, 7, 10], 
       'pentatonic blues min + b5': [
                                   0, 3, 5, 6, 7, 10], 
       'pentatonic blues min + 3rd+b5': [
                                       0, 3, 4, 5, 6, 7, 10]}
    keys = [
