...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/canoe/config/parser.py
...
def p_watch_block(p):
    """watch_block : WATCH STRING LCURLY filter_declarations                      route_declaration RCURLY
