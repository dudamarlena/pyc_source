...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-x86_64/egg/provneo4j/connectors/neo4j_rest/neo4j_serializer.py
    ...
    def create_node(self, node):
        ...
        if isinstance(node, ProvElement):
            ...
            n.properties = dict(map(lambda (key, value): (Serializer.encode_string_value(key),
             Serializer.encode_string_value(value)), node.attributes))
        else:
