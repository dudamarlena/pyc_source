...
# Embedded file name: /home/fantomas/dev/buildout-versions-checker-py3/bvc/scripts/find_unused_versions.py
# Compiled at: 2020-03-06 05:52:55
# Size of source mod 2**32: 3235 bytes
__doc__ = 'Command line for finding unused pinned versions'
import logging, sys
...
def cmdline(argv=sys.argv[1:]):
    ...
    filter_group.add_argument('--eggs',
      dest='eggs',
      default='./eggs/',
      help='The directory where the eggs are located (default: ./eggs/)')
