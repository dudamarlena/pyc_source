...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.9.1-i386/egg/email/test/test_email_codecs_renamed.py
...
class TestEmailAsianCodecs(TestEmailBase):
    ...
    def test_japanese_codecs(self):
        ...
        eq(decode_header(h.encode()), [
         ('Hello World!', None), ('\x1b$B%O%m!<%o!<%k%I!*\x1b(B', 'iso-2022-jp'), (b'Gr\xfc\xdf Gott!', 'iso-8859-1')])
