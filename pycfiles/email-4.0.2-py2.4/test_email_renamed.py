...
# [GCC 8.4.0]
# Embedded file name: build/bdist.darwin-8.9.1-i386/egg/email/test/test_email_renamed.py
...
class TestMessageAPI(TestEmailBase):
    ...
    def test_get_decoded_payload(self):
        ...
        eq(msg.get_payload(3).get_payload(decode=True), 'This has no Content-Transfer-Encoding: header.\n')
        return
    ...
    def test_del_param(self):
        ...
        eq(msg.get_params(), [
         ('multipart/report', ''), ('report-type', 'delivery-status'), ('boundary', 'D1690A7AC1.996856090/mail.example.com')])
        old_val = msg.get_param('report-type')
        msg.del_param('report-type')
        eq(msg.get_params(), [
         ('multipart/report', ''), ('boundary', 'D1690A7AC1.996856090/mail.example.com')])
        msg.set_param('report-type', old_val)
        eq(msg.get_params(), [
         ('multipart/report', ''), ('boundary', 'D1690A7AC1.996856090/mail.example.com'), ('report-type', old_val)])
...
class TestLongHeaders(TestEmailBase):
    ...
    def test_long_received_header(self):
        ...
        msg['Received-2'] = h
        self.assertEqual(msg.as_string(), 'Received-1: from FOO.TLD (vizworld.acl.foo.tld [123.452.678.9]) by\n\throthgar.la.mastaler.com (tmda-ofmipd) with ESMTP;\n\tWed, 05 Mar 2003 18:10:18 -0700\nReceived-2: from FOO.TLD (vizworld.acl.foo.tld [123.452.678.9]) by\n\throthgar.la.mastaler.com (tmda-ofmipd) with ESMTP;\n\tWed, 05 Mar 2003 18:10:18 -0700\n\n')
    ...
    def test_string_headerinst_eq(self):
        ...
        msg['Received-2'] = h
        self.assertEqual(msg.as_string(), 'Received-1: <15975.17901.207240.414604@sgigritzmann1.mathematik.tu-muenchen.de>\n\t(David Bremner\'s message of "Thu, 6 Mar 2003 13:58:21 +0100")\nReceived-2: <15975.17901.207240.414604@sgigritzmann1.mathematik.tu-muenchen.de>\n\t(David Bremner\'s message of "Thu, 6 Mar 2003 13:58:21 +0100")\n\n')
    ...
    def test_long_lines_with_different_header(self):
        ...
        eq(msg.as_string(), 'List: List-Unsubscribe: <https://lists.sourceforge.net/lists/listinfo/spamassassin-talk>,\n\t<mailto:spamassassin-talk-request@lists.sourceforge.net?subject=unsubscribe>\nList: List-Unsubscribe: <https://lists.sourceforge.net/lists/listinfo/spamassassin-talk>,\n <mailto:spamassassin-talk-request@lists.sourceforge.net?subject=unsubscribe>\n\n')
...
class TestNonConformant(TestEmailBase):
    ...
    def test_same_boundary_inner_outer(self):
        ...
        unless(isinstance(inner.defects[0], errors.StartBoundaryNotFoundDefect))
    ...
    def test_multipart_no_boundary(self):
        ...
        unless(isinstance(msg.defects[1], errors.MultipartInvariantViolationDefect))
    ...
    def test_missing_start_boundary(self):
        ...
        self.failUnless(isinstance(bad.defects[0], errors.StartBoundaryNotFoundDefect))
...
class TestRFC2047(unittest.TestCase):
    ...
    def test_rfc2047_multiline(self):
        ...
        dh = decode_header(s)
        eq(dh, [('Re:', None), (b'r\x8aksm\x9arg\x8cs', 'mac-iceland'), ('baz foo bar', None), (b'r\x8aksm\x9arg\x8cs', 'mac-iceland')])
    ...
    def test_whitespace_eater_unicode_2(self):
        ...
        dh = decode_header(s)
        eq(dh, [('The', None), ('quick brown fox', 'iso-8859-1'), ('jumped over the', None), ('lazy dog', 'iso-8859-1')])
    ...
    def test_rfc2047_with_whitespace(self):
        s = 'Sm =?ISO-8859-1?B?9g==?= rg =?ISO-8859-1?B?5Q==?= sbord'
        dh = decode_header(s)
        self.assertEqual(dh, [('Sm', None), (b'\xf6', 'iso-8859-1'), ('rg', None), (b'\xe5', 'iso-8859-1'), ('sbord', None)])
        return
...
class TestMiscellaneous(TestEmailBase):
    ...
    def test__all__(self):
        ...
        all = module.__all__[:]
        all.sort()
        self.assertEqual(all, ['Charset', 'Encoders', 'Errors', 'Generator', 'Header', 'Iterators', 'MIMEAudio', 'MIMEBase', 'MIMEImage', 'MIMEMessage', 'MIMEMultipart', 'MIMENonMultipart', 'MIMEText', 'Message', 'Parser', 'Utils', 'base64MIME', 'base64mime', 'charset', 'encoders', 'errors', 'generator', 'header', 'iterators', 'message', 'message_from_file', 'message_from_string', 'mime', 'parser', 'quopriMIME', 'quoprimime', 'utils'])
    ...
    def test_getaddresses(self):
        eq = self.assertEqual
        eq(utils.getaddresses(['aperson@dom.ain (Al Person)', 'Bud Person <bperson@dom.ain>']), [
...
class TestParsers(TestEmailBase):
    ...
    def test_three_lines(self):
        lines = [
         'From: Andrew Person <aperson@dom.ain', 'Subject: Test', 'Date: Tue, 20 Aug 2002 16:43:45 +1000']
...
class TestHeader(TestEmailBase):
    ...
    def test_multilingual(self):
        ...
        eq(decode_header(enc), [
         (
          g_head, 'iso-8859-1'), (cz_head, 'iso-8859-2'), (utf8_head, 'utf-8')])
        ustr = unicode(h)
