...
# [GCC 8.4.0]
# Embedded file name: /data/envs/dfuzz/project/dfuzz/dfuzz/tests/test_incident.py
# Compiled at: 2011-05-04 04:56:36
import unittest
...
class testIncident(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fuzzer = 'test'
        self.i = incident.Incident(self.dc, self.fuzzer, self.dh_class)
