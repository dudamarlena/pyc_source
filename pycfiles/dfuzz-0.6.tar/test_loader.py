...
# [GCC 8.4.0]
# Embedded file name: test_loader.py
# Compiled at: 2011-04-27 11:24:24
import unittest
...
class testLoader(unittest.TestCase):
    ...
    def test_validate_module(self):
        ...
        self.assertEqual(self.ml.validate_module(self.complete), self.cls_complete)
        self.assertEqual(self.ml.validate_module(self.standard), self.cls_standard)
