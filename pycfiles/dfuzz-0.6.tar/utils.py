...
# [GCC 8.4.0]
# Embedded file name: /data/envs/dfuzz/project/dfuzz/dfuzz/core/utils.py
# Compiled at: 2011-05-10 06:29:58
...
def get_class_by_path(str_path):
    ...
    if hasattr(mod, cls_name):
        ...
        return cls
    logging.error('Module "%s" has no "%s" class.', module_name, cls_name)
    return False
