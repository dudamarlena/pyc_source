...
# [GCC 8.4.0]
# Embedded file name: /data/envs/dfuzz/project/dfuzz/dfuzz/tests/test_sanity.py
# Compiled at: 2011-05-21 13:26:32
...
class testDirIntegrity(unittest.TestCase):
    ...
    def test_dir_integrity_writable_wd(self):
        ...
        is not writable.
        """
        os.chmod(self.test_dir, 365)
        ret = sanity.dir_integrity(self.cfg)
        os.chmod(self.test_dir, 511)
