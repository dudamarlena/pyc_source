...
# [GCC 8.4.0]
# Embedded file name: /Users/bluemoon/Desktop/flask-administration/flask_administration/__init__.py
# Compiled at: 2012-04-04 22:16:24
from __future__ import absolute_import
import datetime
from functools import wraps
import inspect, os, time, types, flask
...
def create_adminitizr_blueprint(view_decorator=view_decorator, template_folder=None, static_folder=None):
    ...
    admin_blueprint = flask.Blueprint('adminitizr', 'flask.ext.adminitizr', static_folder=static_folder, template_folder=template_folder)
    ...
    def get_model_url_key(model_instance):
        ...
        return ('/').join([ unicode(value) if value else empty_sequence for value in values
                          ])
