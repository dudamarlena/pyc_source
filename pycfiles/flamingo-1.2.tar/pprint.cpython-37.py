...
# [GCC 8.4.0]
# Embedded file name: /home/fsc/work/devel/flamingo/flamingo/core/utils/pprint.py
# Compiled at: 2020-03-20 07:35:33
...
def _safe_repr(object, context, maxlevels, level):
    ...
    if not (issubclass(typ, list) and r is list.__repr__):
        if not issubclass(typ, tuple) or r is tuple.__repr__:
        ...
        elif isinstance(object, (Content, ContentSet)):
...
def pprint(object, stream=None, indent=1, width=80, depth=None, *, compact=False, full_content_repr=True):
    FlamingoPrettyPrinter(stream=stream,
      indent=indent,
      width=width,
      depth=depth,
      compact=compact,
      full_content_repr=full_content_repr).pprint(object)


def pformat(object, indent=1, width=80, depth=None, *, compact=False, full_content_repr=True):
    return FlamingoPrettyPrinter(indent=indent,
      width=width,
      depth=depth,
      compact=compact,
      full_content_repr=full_content_repr).pformat(object)