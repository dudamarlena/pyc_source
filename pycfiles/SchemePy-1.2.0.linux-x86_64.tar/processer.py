...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python2.7/site-packages/scheme/processer.py
# Compiled at: 2015-09-04 17:37:43
...
class Processer(object):
    ...
    def getContinuation(self):
        ...
        return dict(env=self.cenv, callDepth=self.callDepth + pc['callDepth'], callStack=deepcopy(self.callStack.queue) + pc['callStack'], initialCallDepth=self.initialCallDepth + pc['initialCallDepth'], stackPointer=self.stackPointer)
