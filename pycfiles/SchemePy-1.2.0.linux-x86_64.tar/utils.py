...
# [GCC 8.4.0]
# Embedded file name: /usr/lib64/python2.7/site-packages/scheme/utils.py
# Compiled at: 2015-09-05 17:35:21
...
def expand_syntax(lst):
    for idx, this in enumerate(lst):
        if this == "#'":
            ...
            lst[idx] = [
             Symbol('quasisyntax'), quoteTarget]
