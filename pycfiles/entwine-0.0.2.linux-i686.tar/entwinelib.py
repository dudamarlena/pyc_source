...
# [GCC 8.4.0]
# Embedded file name: /usr/lib/python2.5/site-packages/entwine/entwinelib.py
# Compiled at: 2008-03-13 15:54:27
"""
...
def get_profile(profile_username):
    ...
    opener.addheaders = [('Accept', 'application/rdf+xml'),
     ...
     (
      'User-agent',
      'Mozilla/5.0 (compatible; entwine ' + 'http://code.google.com/p/entwine)')]
