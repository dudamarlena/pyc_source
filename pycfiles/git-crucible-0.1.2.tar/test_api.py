...
# [GCC 8.4.0]
# Embedded file name: /Users/joshbraegger/bc/git-crucible/crucible/tests/test_api.py
# Compiled at: 2012-03-23 23:43:38
import unittest
...
class TestAPI(unittest.TestCase):
    ...
    def test_create_review(self, request_mock):
        ...
        request_mock.assert_called_once_with('http://localhost/crucible/rest-service/reviews-v1', method='POST', username='jim', password='bob', body=body)

    @patch('crucible.client.request')
    def test_add_reviewers(self, request_mock):
        self.api.add_reviewers('CR-1234', 'nbrunson,aglemann')
        request_mock.assert_called_once_with('http://localhost/crucible/rest-service/reviews-v1/CR-1234/reviewers', method='POST', username='jim', password='bob', body='nbrunson,aglemann')

    @patch('crucible.client.request')
    def test_add_patch(self, request_mock):
        self.api.add_patch('CR-1234', 'a patch', 'repo')
        request_mock.assert_called_once_with('http://localhost/crucible/rest-service/reviews-v1/CR-1234/patch', method='POST', username='jim', password='bob', body=_read_file('add_patch_success_body.xml'))
