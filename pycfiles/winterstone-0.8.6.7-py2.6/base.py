...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/winterstone/base.py
...
class WinterObject(object):
    ...
    def info(self, spacing=30, collapse=1):
        ...
        print ('\n').join([ '%s %s' % (method.ljust(spacing), processFunc(str(getattr(self, method).__doc__))) for method in methodList
                          ])
