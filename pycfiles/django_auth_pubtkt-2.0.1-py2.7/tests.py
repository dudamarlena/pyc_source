...
class MiddlewareTest(TestCase):
    ...
    def test_expired_ticke(self):
        self.client.cookies = SimpleCookie({'auth_pubtkt': 'uid=foobar;validuntil=123456789;tokens=;udata=;sig=MEUCIFqF5cxYi85Lsm0M6+1jIEb9AKX3bYa1XsH6h/ggTe6oAiEA0i3laZmjOGXJ/v9N6tt/B0PCFqOKpe7cFwegAU8GYWo='})
        response = self.client.get('/')
        self.assertEqual(response.status_code, 302)

    def test_success(self):
        self.client.cookies = SimpleCookie({'auth_pubtkt': 'uid=foobar;validuntil=4102444800;tokens=;udata=;sig=MEUCIQDPpPA1SEeXP8r/UoeNAehom31cS9/Le6eXZmokKbY7QwIgExWb6R0tPG6vKDZET0ojVnDxHoYxUx81fm+knwd0xZM='})
        response = self.client.get('/')
