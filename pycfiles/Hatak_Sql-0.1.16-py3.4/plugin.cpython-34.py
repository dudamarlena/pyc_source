...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/haplugin/sql/plugin.py
# Compiled at: 2015-03-22 15:48:53
    ...
    def append_settings(self):
        ...
        def morf_main_sql_url(obj, url):
            if obj['type'] == 'sqlite':
                ...
                return '%(type)s://%(login)s:%(password)s@%(host)s:%(port)s/postgres' % obj
