...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.7-x86_64/egg/ecgkit/ecg_plot/ecg_plot.py
# Compiled at: 2019-06-09 21:20:09
...
def plot_12(ecg, sample_rate=500, title='ECG 12', lead_index=lead_index, lead_order=None, columns=2):
    ...
    fig, ax = plt.subplots((ceil(len(lead_order) / columns)),
      columns, sharex=True,
      sharey=True,
      figsize=(
     0.7 * seconds * columns, 1.1 * leads / columns))
