...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/kyoka/algorithm/td_learning/eligibility_trace/action_eligibility_trace.py
...
class ActionEligibilityTrace:
    ...
    def dump(self):
        return (
         self.update_type, self.discard_threshold,
    ...
    def __validate_update_type(self, update_type):
        if update_type not in [self.TYPE_ACCUMULATING, self.TYPE_REPLACING]:
