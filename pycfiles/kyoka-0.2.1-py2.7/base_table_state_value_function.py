...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/kyoka/value_function/base_table_state_value_function.py
...
class BaseTableStateValueFunction(BaseStateValueFunction):
    SAVE_FILE_NAME = 'table_state_value_function_data.pickle'
    ...
    def load(self, load_dir_path):
        ...
        if not os.path.exists(file_path):
            raise IOError('The saved data of "TableStateValueFunction" is not found on [ %s ]' % load_dir_path)
