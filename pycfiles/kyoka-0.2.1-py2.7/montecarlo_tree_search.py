...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/kyoka/algorithm/montecarlo_tree_search.py
# Compiled at: 2016-12-16 03:48:35
import random, math
...
class BaseEdge(object):
    ...
    def update_by_new_reward(self, new_reward):
        self.average_reward = self._calc_average_in_incremental_way(self.average_reward, self.visit_count, new_reward)
