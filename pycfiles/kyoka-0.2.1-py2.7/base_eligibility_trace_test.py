...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/kyoka/algorithm/td_learning/eligibility_trace/base_eligibility_trace_test.py
...
class ActionEligibilityTraceTest(BaseUnitTest):
    ...
    def test_decay_discard(self):
        trace = ActionEligibilityTrace('accumulating_trace', discard_threshold=0.0001, gamma=0.99, lambda_=0.9)
        trace.update(0, 0)
        trace.update(100, 200)
