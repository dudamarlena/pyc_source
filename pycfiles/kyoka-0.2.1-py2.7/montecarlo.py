...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/kyoka/algorithm/montecarlo.py
...
def validate_value_function(value_function):
    value_function_check('MonteCarlo', [
     MonteCarloTabularActionValueFunction, MonteCarloApproxActionValueFunction], value_function)