...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/kyoka/algorithm/td_learning/deep_q_learning.py
...
class DeepQLearning(BaseTDMethod):
    ...
    def load_algorithm_state(self, load_dir_path):
        ...
        self.gamma, replay_memory_serial, self.C, self.minibatch_size, self.replay_start_size, self.reset_step_counter = state
        self.greedy_policy = GreedyPolicy()
