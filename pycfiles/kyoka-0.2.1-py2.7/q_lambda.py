...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/kyoka/algorithm/td_learning/q_lambda.py
...
class QLambda(BaseTDMethod):
    ...
    def update_action_value_function(self, domain, policy, value_function):
        ...
        while not domain.is_terminal_state(current_state):
            ...
            delta = self.__calculate_delta(value_function, current_state, current_action, next_state, greedy_action, reward)
    ...
    def __calculate_delta(self, value_function, state, action, next_state, greedy_action, reward):
