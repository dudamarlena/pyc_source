...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/kyoka/policy/epsilon_greedy_policy_test.py
...
class EpsilonGreedyPolicyTest(BaseUnitTest):
    ...
    def test_choose_action_boundary_test(self):
        ...
        self.eq(2, self.__choose_action_with_rand_value(0.2 + 0.7 - eps))
        self.eq(3, self.__choose_action_with_rand_value(0.2 + 0.7))
