...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/kyoka/algorithm/td_learning/q_lambda_test.py
...
class QLambaTest(BaseUnitTest):
    ...
    def setUp(self):
        trace = EligibilityTrace(EligibilityTrace.TYPE_ACCUMULATING, discard_threshold=0.0002, gamma=0.1, lambda_=0.1)
