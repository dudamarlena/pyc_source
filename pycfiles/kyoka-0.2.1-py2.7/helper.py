...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/examples/ticktacktoe/helper.py
# Compiled at: 2016-12-01 20:28:12
...
def play_with_agent(value_func):
    ...
    players = [
     GreedyPolicy(), TickTackToeManualPolicy()]
