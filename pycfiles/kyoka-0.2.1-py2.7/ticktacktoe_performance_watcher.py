...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/sample/ticktacktoe/ticktacktoe_performance_watcher.py
...
class TickTackToePerformanceWatcher(BasePerformanceWatcher):
    ...
    def run_performance_test(self, domain, value_function):
        ...
        game_results = [ TickTackToeHelper.measure_performance(domain, value_function, players) for _ in range(self.test_game_count)
                       ]
