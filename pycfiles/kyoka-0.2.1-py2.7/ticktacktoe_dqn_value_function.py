...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/sample/ticktacktoe/ticktacktoe_dqn_value_function.py
...
class TickTackToeDQNValueFunction(BaseDeepQLearningActionValueFunction):
    ...
    def train_on_minibatch(self, q_network, learning_minibatch):
        processed_minibatch = [ (self.__transform_state_action_into_input(state, action), target) for state, action, target in learning_minibatch
                              ]
