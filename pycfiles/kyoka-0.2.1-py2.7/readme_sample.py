...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/sample/maze/readme_sample.py
# Compiled at: 2016-10-28 07:56:39
...
class MazeDomain(BaseDomain):
    ...
    def generate_possible_actions(self, state):
        return [
         self.ACTION_UP, self.ACTION_DOWN, self.ACTION_RIGHT, self.ACTION_LEFT]
