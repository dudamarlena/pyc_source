...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.12-intel/egg/tests/kyoka/callback_test.py
# Compiled at: 2016-12-01 23:40:36
import os, sys, StringIO
from nose.tools import raises
from mock import patch, Mock
from kyoka.callback import BaseCallback, BasePerformanceWatcher, EpsilonAnnealer, LearningRecorder, BaseFinishRule, ManualInterruption, WatchIterationCount
...
class WatchIterationCountTest(BaseUnitTest):
    ...
    def test_message_for_lifecycle(self):
        ...
        mock_time_return = [
         ...
         1477462679.056145]
        expected_calc_time = [
         1.0354280471801758, 4.082134008407593]
