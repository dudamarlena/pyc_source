...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\filthypasswordgenerator\data\english.py
# Compiled at: 2019-02-22 11:20:36
# Size of source mod 2**32: 4704 bytes
dictionary = ('2g1c', '2 girls 1 cup', 'acrotomophilia', 'alabama hot pocket', 'alaskan pipeline',
              ...
              'barenaked', 'bastard', 'bastardo', 'bastinado', 'bbw', 'bdsm', 'beaner',
              'beaners', 'beaver cleaver', 'beaver lips', 'bestiality', 'big black',
              ...
              'bollocks', 'bondage', 'boner', 'boob', 'boobs', 'booty call', 'brown showers',
              ...
              'chocolate rosebuds', 'circlejerk', 'cleveland steamer', 'clit', 'clitoris',
              ...
              'eunuch', 'faggot', 'fecal', 'felch', 'fellatio', 'feltch', 'female squirting',
              'femdom', 'figging', 'fingerbang', 'fingering', 'fisting', 'foot fetish',
              'footjob', 'frotting', 'fuck', 'fuck buttons', 'fuckin', 'fucking',
              'fucktards', 'fudge packer', 'fudgepacker', 'futanari', 'gang bang',
              ...
              'lovemaking', 'make me come', 'male squirting', 'masturbate', 'menage a trois',
              'milf', 'missionary position', 'motherfucker', 'mound of venus', 'mr hands',
              'muff diver', 'muffdiving', 'nambla', 'nawashi', 'negro', 'neonazi',
              ...
              'phone sex', 'piece of shit', 'pissing', 'piss pig', 'pisspig', 'playboy',
              ...
              'rusty trombone', 'sadism', 'santorum', 'scat', 'schlong', 'scissoring',
              'semen', 'sex', 'sexo', 'sexy', 'shaved beaver', 'shaved pussy', 'shemale',
              'shibari', 'shit', 'shitblimp', 'shitty', 'shota', 'shrimping', 'skeet',
              'slanteye', 'slut', 's&m', 'smut', 'snatch', 'snowballing', 'sodomize',
              'sodomy', 'spic', 'splooge', 'splooge moose', 'spooge', 'spread legs',
