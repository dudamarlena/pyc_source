...
# Embedded file name: build/bdist.macosx-10.8-intel/egg/porter.py
# Compiled at: 2013-07-03 13:43:30
__doc__ = 'Porter: Simple File Operations in Python\n\n* https://github.com/shunfan/porter\n* MIT License\n* Copyright (c) 2013 Shunfan Du, i@perry.asia\n\n'
import os, shutil
__all__ = [
 'TargetFile', 'TargetDirectory', 'mkdir', 'rename', 'remove',
