...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/fever/api/web_server.py
# Compiled at: 2019-06-10 18:26:43
            ...
            try:
                ...
                if isinstance(request.json['instances'], str):
                    ...
                    if all(map(lambda instance: isinstance(instance, str), request.json['instances'])):
                        ...
                        if all(map(lambda instance: 'id' in instance and 'claim' in instance and isinstance(instance['id'], int) and isinstance(instance['claim'], str), request.json['instances'])):
