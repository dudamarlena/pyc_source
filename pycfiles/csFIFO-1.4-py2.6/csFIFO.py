...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/csFIFO/csFIFO.py
# Compiled at: 2013-02-28 09:13:28
...
class FIFO(object):
    ...
    """
        self.log = logging.getLogger('csFIFO-%s' % id(self))
    ...
    def __repr__(self):
        ...
        s += 'Resize:   %d\n' % self.resize_count
        s += 'Idle time: %0.2fs' % (time.time() - self.wrTime)
        self.lock.release()
        return s
