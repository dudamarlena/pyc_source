...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/transitfeed/gtfsfactory.py
...
class GtfsFactory(object):
    ...
    def __init__(self):
        self._class_mapping = {'Agency': Agency, 
           ...
           'Schedule': Schedule, 
           'Loader': Loader}
        self._file_mapping = {'agency.txt': {'required': True, 'loading_order': 0, 'classes': [
                                    'Agency']}, 
           'calendar.txt': {'required': False, 'loading_order': None, 'classes': [
                                      'ServicePeriod']}, 
           'calendar_dates.txt': {'required': False, 'loading_order': None, 'classes': [
                                            'ServicePeriod']}, 
           'fare_attributes.txt': {'required': False, 'loading_order': 50, 'classes': [
                                             'FareAttribute']}, 
           'fare_rules.txt': {'required': False, 'loading_order': 60, 'classes': [
                                        'FareRule']}, 
           'feed_info.txt': {'required': False, 'loading_order': 100, 'classes': [
                                       'FeedInfo']}, 
           'frequencies.txt': {'required': False, 'loading_order': 70, 'classes': [
                                         'Frequency']}, 
           'shapes.txt': {'required': False, 'loading_order': None, 'classes': [
                                    'Shape', 'ShapePoint']}, 
           'stops.txt': {'required': True, 'loading_order': 10, 'classes': [
                                   'Stop']}, 
           'stop_times.txt': {'required': True, 'loading_order': None, 'classes': [
                                        'StopTime']}, 
           'routes.txt': {'required': True, 'loading_order': 20, 'classes': [
                                    'Route']}, 
           'transfers.txt': {'required': False, 'loading_order': 30, 'classes': [
                                       'Transfer']}, 
           'trips.txt': {'required': True, 'loading_order': 40, 'classes': [
                                   'Trip']}}
        return
