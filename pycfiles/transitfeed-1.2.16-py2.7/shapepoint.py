...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/transitfeed/shapepoint.py
# Compiled at: 2018-01-24 00:52:58
import bisect
from gtfsobjectbase import GtfsObjectBase
import problems as problems_module, util, sys
...
class ShapePoint(GtfsObjectBase):
  ...
  """
    ...
    def __init__(self, shape_id=None, lat=None, lon=None, seq=None, dist=None, field_dict=None):
