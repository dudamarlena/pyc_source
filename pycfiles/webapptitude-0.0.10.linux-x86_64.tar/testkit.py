...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/webapptitude/testkit.py
# Compiled at: 2016-08-31 16:32:16
import unittest, traceback, sys, os, pdb, cStringIO, base64
from google.appengine.ext import testbed
from google.appengine.ext import ndb
from google.appengine.api import apiproxy_stub_map
import webob, webapp2, webtest, logging, contextlib
...
try:
    ...
    site_config = {}
    site_config['webapp2_extras.sessions'] = {'secret_key': 'TEST_SESSION_SECRET'}
...
class Testbed(testbed.Testbed):
    service_alias = {'ndb': 'datastore_v3', 
    ...
    def loginUser(self, email='test@example.com', id='123', is_admin=False):
        self.setup_env(user_email=str(email), user_id=str(id), user_is_admin='1' if is_admin else '0', overwrite=True)
...
class TestCase(unittest.TestCase):
    ...
    def application_from(cls, *handlers):
        ...
        return cls.application(webapp2.WSGIApplication(handlers, config=site_config, debug=True))
