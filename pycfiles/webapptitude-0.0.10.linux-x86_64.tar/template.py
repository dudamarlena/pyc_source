...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/webapptitude/template.py
# Compiled at: 2016-08-31 16:32:16
import math, webapp2, os, util
...
class RequestHandler(webapp2.RequestHandler):
    ...
    def jinja2_environment(self):
        ...
        env_filters = {}
        env_globals = {'url_for': self.uri_for, 
        ...
        return {'template_path': getattr(self, 'template_path', template_path), 
    ...
    def respond_with_template(self, template_path, values=None, content_type=None, **context):
        if values is None:
            values = context
...
def TemplatePartial(template_path, chunk_name=None, base_class=RequestHandler):
    ...
    class _partial(base_class):
        ...
        def get_partial(self, *args, **kwargs):
            _jinja2 = self.jinja2
            _part = _jinja2.get_template_attribute(template_path, chunk_name)
