...
# [GCC 8.4.0]
# Embedded file name: /Users/duranton/Documents/CERFACS/CODES/arnica/src/arnica/utils/plot_density_mesh.py
# Compiled at: 2020-04-23 11:02:32
...
def heat_map_mesh(x_crd, y_crd, z_crd, show=False, save=False, view_axes='xr'):
    ...
    def plot_skin(tuple_data, tuple_labels):
        ...
        ax_.set_title(title)
        ax_.hist2d(x_crd, y_crd, bins=(get_bins(x_crd, y_crd)),
          norm=(LogNorm()))
