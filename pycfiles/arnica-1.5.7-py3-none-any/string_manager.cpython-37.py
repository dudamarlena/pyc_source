...
# [GCC 8.4.0]
# Embedded file name: /Users/duranton/Documents/CERFACS/CODES/arnica/src/arnica/utils/string_manager.py
...
def string_minus_string(string1, string2):
    ...
    chars_differences = list(enumerate([[position, char_diff[(-1)]] for position, char_diff in enumerate(chars_differences) if char_diff[0] == '+']))
