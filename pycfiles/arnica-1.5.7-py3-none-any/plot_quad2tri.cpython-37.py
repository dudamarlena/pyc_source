...
# [GCC 8.4.0]
# Embedded file name: /Users/duranton/Documents/CERFACS/CODES/arnica/src/arnica/utils/plot_quad2tri.py
...
def plot_quad2tri(grid, title, field, shading=True):
    ...
    *Generate a plot of a field on a x,y shell cartesian grid*
    ...
    If shading is False : using 'flat' from mean field value defined at the nodes\xa0or \\
    ...
    if shading:
        ...
        shading = 'flat'
    tpc = ax1.tripcolor(triangulation, field_at_node,
      shading=shading)
