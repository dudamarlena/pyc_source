...
# [GCC 8.4.0]
# Embedded file name: /home/lance/.virtualenvs/wolverine/lib/python3.5/site-packages/wolverine/__init__.py
# Compiled at: 2016-02-11 15:14:00
# Size of source mod 2**32: 3471 bytes
import asyncio
from configparser import ConfigParser
import logging, importlib, os, signal, functools, types
...
class MicroApp(object):
    ...
    def __init__(self, loop=None, config_file='settings.ini'):
        ...
        default_settings = os.path.join(__path__[0], 'settings.ini')
    ...
    def _run(self):
        ...
        for sig in self.SIG_NAMES:
            self.loop.add_signal_handler(getattr(signal, sig), functools.partial(self._exit, sig))
