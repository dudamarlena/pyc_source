...
# [GCC 8.4.0]
# Embedded file name: /home/lance/.virtualenvs/wolverine/lib/python3.5/site-packages/wolverine/gateway/web.py
# Compiled at: 2016-02-11 13:24:36
# Size of source mod 2**32: 2398 bytes
import ast, json, logging, asyncio
...
class GatewayWebModule(MicroModule):
    ...
    def run(self):
        ...
        self.app.web.add_route('GET', '/service/{service}', self.get_service_routes)
        self.app.web.add_route('POST', '/service/{service}/{route}/{version}', self.post_to_route)
    ...
    def post_to_route(self, request):
        try:
            ...
            service_request = yield from self.app.router.send(data, route, version=version, future=future)
