...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\http_request\__init__.py
# Compiled at: 2016-09-04 07:00:04
...
class Request:
    ...
    def parse(self, raw_request):
        try:
            ...
            self.headers = {header:value.strip() for header, value in (HEADER_VALUE_PATTERN.split(raw_h, 1) for raw_h in self.raw_headers)}
            return True
        except ValueError:
            return False
