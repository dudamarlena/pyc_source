...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/artellapipe/launcher/core/plugin.py
...
import os, sys, types, inspect, logging, traceback
        ...
        for plugin_name in dir(module):
            if plugin_name.startswith('_'):
                ...
                if not inspect.isclass(module_obj):
                    pass
                elif not issubclass(module_obj, self.PLUGIN_CLASS):
                    continue
