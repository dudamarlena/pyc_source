...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/vmcontroller/common/FileTransfer.py
# Compiled at: 2011-03-06 20:26:47
"""
...
COMMANDS = {'list': ('list', 'Displays a list of all the available files'), 
