...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/shakespeare/cli.py
# Compiled at: 2008-10-29 17:02:17
import cmd, os, StringIO
...
class ShakespeareAdmin(cmd.Cmd):
    ...
    def do_db(self, line=None):
        ...
        import shakespeare.model, shakespeare
        if line == 'init':
    ...
    def help_index(self, line=None):
        usage = 'Print index of Shakespeare texts to stdout'
        print usage
...
def main():
    ...
    parser.add_option('-c', '--config', dest='config', help='Path to config file', default=None)
