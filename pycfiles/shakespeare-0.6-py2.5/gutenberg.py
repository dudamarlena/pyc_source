...
# [GCC 8.4.0]
# Embedded file name: /home/rgrp/svnroot/shakespeare/trunk/shksprdata/getdata/gutenberg.py
# Compiled at: 2008-09-13 09:23:18
"""Various useful functionality related to Project Gutenberg
"""
import os, StringIO, shakespeare.gutenberg
...
class GutenbergIndex(shakespeare.gutenberg.GutenbergIndexBase):
    ...
    def get_relevant_works(self):
        ...
        results = [
         [
          'Sonnets', 'http://www.gutenberg.org/dirs/etext97/wssnt10.txt', '']]
    ...
    def parse_line_for_normal(self, line):
        ...
        """
        if 'Shakespeare' in line and '[2' in line and 'mp3' not in line and 'Apocrypha' not in line:
            year = line[4:8]
            tmp = line[9:]
