...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/tw2/recaptcha/validator.py
# Compiled at: 2013-02-03 23:12:25
from formencode.validators import FancyValidator
from formencode import Invalid
import urllib, urllib2, gettext
_ = gettext.gettext
...
class ReCaptchaValidator(FancyValidator):
    ...
    def validate_python(self, field_dict, state):
        ...
        if response == '' or challenge == '':
            ...
            raise error
        params = urllib.urlencode({'privatekey': self.private_key, 
           'remoteip': self.remote_ip, 
           'challenge': challenge, 
           'response': response})
        request = urllib2.Request(url='http://%s/verify' % self.verify_server, data=params, headers={'Content-type': 'application/x-www-form-urlencoded', 'User-agent': 'reCAPTCHA Python'})
