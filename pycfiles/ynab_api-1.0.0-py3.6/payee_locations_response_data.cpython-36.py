...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/payee_locations_response_data.py
...
class PayeeLocationsResponseData(object):
    ...
    openapi_types = {'payee_locations': 'list[PayeeLocation]'}
    attribute_map = {'payee_locations': 'payee_locations'}

    def __init__(self, payee_locations=None, local_vars_configuration=None):
    ...
    def payee_locations(self, payee_locations):
        ...
        if self.local_vars_configuration.client_side_validation:
            if payee_locations is None:
                raise ValueError('Invalid value for `payee_locations`, must not be `None`')
