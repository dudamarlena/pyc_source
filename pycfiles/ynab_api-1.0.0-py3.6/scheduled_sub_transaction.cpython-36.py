...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/scheduled_sub_transaction.py
...
class ScheduledSubTransaction(object):
    ...
    def __init__(self, id=None, scheduled_transaction_id=None, amount=None, memo=None, payee_id=None, category_id=None, transfer_account_id=None, deleted=None, local_vars_configuration=None):
    ...
    def scheduled_transaction_id(self, scheduled_transaction_id):
        ...
        if self.local_vars_configuration.client_side_validation:
            if scheduled_transaction_id is None:
                raise ValueError('Invalid value for `scheduled_transaction_id`, must not be `None`')
