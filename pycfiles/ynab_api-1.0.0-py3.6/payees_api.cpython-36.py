...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/api/payees_api.py
...
class PayeesApi(object):
    ...
    def get_payee_by_id(self, budget_id, payee_id, **kwargs):
        ...
        return (self.get_payee_by_id_with_http_info)(budget_id, payee_id, **kwargs)

    def get_payee_by_id_with_http_info(self, budget_id, payee_id, **kwargs):
        """Single payee  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_payee_by_id" % key)
        ...
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_payee_by_id`')
        if self.api_client.client_side_validation:
            if 'payee_id' not in local_var_params or local_var_params['payee_id'] is None:
                raise ApiValueError('Missing the required parameter `payee_id` when calling `get_payee_by_id`')
        collection_formats = {}
        path_params = {}
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/payees/{payee_id}',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_payees(self, budget_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_payees_with_http_info)(budget_id, **kwargs)

    def get_payees_with_http_info(self, budget_id, **kwargs):
        """List payees  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_payees" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_payees`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/payees',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
