...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/category_group.py
...
class CategoryGroup(object):
    ...
    def __init__(self, id=None, name=None, hidden=None, deleted=None, local_vars_configuration=None):
