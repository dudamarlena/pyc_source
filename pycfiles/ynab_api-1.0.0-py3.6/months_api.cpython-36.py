...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/api/months_api.py
# Compiled at: 2019-11-21 19:08:24
# Size of source mod 2**32: 13308 bytes
"""
    YNAB API Endpoints
...
class MonthsApi(object):
    ...
    def get_budget_month(self, budget_id, month, **kwargs):
        ...
        return (self.get_budget_month_with_http_info)(budget_id, month, **kwargs)

    def get_budget_month_with_http_info(self, budget_id, month, **kwargs):
        """Single budget month  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_budget_month" % key)
        ...
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_budget_month`')
        if self.api_client.client_side_validation:
            if 'month' not in local_var_params or local_var_params['month'] is None:
                raise ApiValueError('Missing the required parameter `month` when calling `get_budget_month`')
        collection_formats = {}
        path_params = {}
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/months/{month}',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_budget_months(self, budget_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_budget_months_with_http_info)(budget_id, **kwargs)

    def get_budget_months_with_http_info(self, budget_id, **kwargs):
        """List budget months  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_budget_months" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_budget_months`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/months',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
