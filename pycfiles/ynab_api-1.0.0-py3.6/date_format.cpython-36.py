...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/date_format.py
...
class DateFormat(object):
    ...
    openapi_types = {'format': 'str'}
    attribute_map = {'format': 'format'}

    def __init__(self, format=None, local_vars_configuration=None):
