...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/transactions_response_data.py
...
class TransactionsResponseData(object):
    ...
    openapi_types = {'transactions':'list[TransactionDetail]', 
     'server_knowledge':'int'}
    attribute_map = {'transactions':'transactions', 
     'server_knowledge':'server_knowledge'}

    def __init__(self, transactions=None, server_knowledge=None, local_vars_configuration=None):
