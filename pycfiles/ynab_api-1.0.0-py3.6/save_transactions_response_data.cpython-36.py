...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/save_transactions_response_data.py
...
class SaveTransactionsResponseData(object):
    ...
    def __init__(self, transaction_ids=None, transaction=None, transactions=None, duplicate_import_ids=None, server_knowledge=None, local_vars_configuration=None):
