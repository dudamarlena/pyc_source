...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/save_month_category.py
...
class SaveMonthCategory(object):
    ...
    openapi_types = {'budgeted': 'int'}
    attribute_map = {'budgeted': 'budgeted'}

    def __init__(self, budgeted=None, local_vars_configuration=None):
