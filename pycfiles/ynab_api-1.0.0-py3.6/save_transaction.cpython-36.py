...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/save_transaction.py
...
class SaveTransaction(object):
    ...
    def __init__(self, account_id=None, date=None, amount=None, payee_id=None, payee_name=None, category_id=None, memo=None, cleared=None, approved=None, flag_color=None, import_id=None, local_vars_configuration=None):
        ...
        if self.local_vars_configuration.client_side_validation:
            if payee_name is not None:
                if len(payee_name) > 50:
                    raise ValueError('Invalid value for `payee_name`, length must be less than or equal to `50`')
    ...
    def memo(self, memo):
        ...
        if self.local_vars_configuration.client_side_validation:
            if memo is not None:
                if len(memo) > 200:
                    raise ValueError('Invalid value for `memo`, length must be less than or equal to `200`')
        self._memo = memo
    ...
    def import_id(self, import_id):
        ...
        if self.local_vars_configuration.client_side_validation:
            if import_id is not None:
                if len(import_id) > 36:
                    raise ValueError('Invalid value for `import_id`, length must be less than or equal to `36`')
