...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/error_response.py
...
class ErrorResponse(object):
    ...
    openapi_types = {'error': 'ErrorDetail'}
    attribute_map = {'error': 'error'}

    def __init__(self, error=None, local_vars_configuration=None):
