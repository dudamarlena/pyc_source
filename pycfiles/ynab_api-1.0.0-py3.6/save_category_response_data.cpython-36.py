...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/save_category_response_data.py
...
class SaveCategoryResponseData(object):
    ...
    openapi_types = {'category':'Category', 
     'server_knowledge':'int'}
    attribute_map = {'category':'category', 
     'server_knowledge':'server_knowledge'}

    def __init__(self, category=None, server_knowledge=None, local_vars_configuration=None):
