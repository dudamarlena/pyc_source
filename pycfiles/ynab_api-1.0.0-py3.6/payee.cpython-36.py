...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/payee.py
...
class Payee(object):
    ...
    def __init__(self, id=None, name=None, transfer_account_id=None, deleted=None, local_vars_configuration=None):
