...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/categories_response_data.py
...
class CategoriesResponseData(object):
    ...
    openapi_types = {'category_groups':'list[CategoryGroupWithCategories]', 
     'server_knowledge':'int'}
    attribute_map = {'category_groups':'category_groups', 
     'server_knowledge':'server_knowledge'}

    def __init__(self, category_groups=None, server_knowledge=None, local_vars_configuration=None):
