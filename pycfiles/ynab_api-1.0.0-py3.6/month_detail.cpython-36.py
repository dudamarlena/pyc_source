...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/month_detail.py
...
class MonthDetail(object):
    ...
    def __init__(self, month=None, note=None, income=None, budgeted=None, activity=None, to_be_budgeted=None, age_of_money=None, deleted=None, categories=None, local_vars_configuration=None):
    ...
    def budgeted(self, budgeted):
        ...
        if self.local_vars_configuration.client_side_validation:
            if budgeted is None:
                raise ValueError('Invalid value for `budgeted`, must not be `None`')
    ...
    def to_be_budgeted(self, to_be_budgeted):
        ...
        if self.local_vars_configuration.client_side_validation:
            if to_be_budgeted is None:
                raise ValueError('Invalid value for `to_be_budgeted`, must not be `None`')
