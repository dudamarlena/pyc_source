...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/scheduled_transaction_detail_all_of.py
...
class ScheduledTransactionDetailAllOf(object):
    ...
    openapi_types = {'account_name':'str', 
     'payee_name':'str', 
     'category_name':'str', 
     'subtransactions':'list[ScheduledSubTransaction]'}
    attribute_map = {'account_name':'account_name', 
     'payee_name':'payee_name', 
     'category_name':'category_name', 
     'subtransactions':'subtransactions'}

    def __init__(self, account_name=None, payee_name=None, category_name=None, subtransactions=None, local_vars_configuration=None):
