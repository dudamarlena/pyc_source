...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/scheduled_transaction_detail.py
...
class ScheduledTransactionDetail(object):
    ...
    def __init__(self, id=None, date_first=None, date_next=None, frequency=None, amount=None, memo=None, flag_color=None, account_id=None, payee_id=None, category_id=None, transfer_account_id=None, deleted=None, account_name=None, payee_name=None, category_name=None, subtransactions=None, local_vars_configuration=None):
    ...
    def date_next(self, date_next):
        ...
        if self.local_vars_configuration.client_side_validation:
            if date_next is None:
                raise ValueError('Invalid value for `date_next`, must not be `None`')
    ...
    def frequency(self, frequency):
        ...
        if self.local_vars_configuration.client_side_validation:
            if frequency not in allowed_values:
                raise ValueError('Invalid value for `frequency` ({0}), must be one of {1}'.format(frequency, allowed_values))
