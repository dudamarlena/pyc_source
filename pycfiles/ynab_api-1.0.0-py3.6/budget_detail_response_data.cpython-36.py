...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/budget_detail_response_data.py
...
class BudgetDetailResponseData(object):
    ...
    openapi_types = {'budget':'BudgetDetail', 
     'server_knowledge':'int'}
    attribute_map = {'budget':'budget', 
     'server_knowledge':'server_knowledge'}

    def __init__(self, budget=None, server_knowledge=None, local_vars_configuration=None):
