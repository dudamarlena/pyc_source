...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/user_response_data.py
...
class UserResponseData(object):
    ...
    openapi_types = {'user': 'User'}
    attribute_map = {'user': 'user'}

    def __init__(self, user=None, local_vars_configuration=None):
