...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/api/scheduled_transactions_api.py
# Compiled at: 2019-11-21 19:08:24
# Size of source mod 2**32: 13784 bytes
"""
    YNAB API Endpoints
...
class ScheduledTransactionsApi(object):
    ...
    def get_scheduled_transaction_by_id(self, budget_id, scheduled_transaction_id, **kwargs):
        ...
        return (self.get_scheduled_transaction_by_id_with_http_info)(budget_id, scheduled_transaction_id, **kwargs)

    def get_scheduled_transaction_by_id_with_http_info(self, budget_id, scheduled_transaction_id, **kwargs):
        """Single scheduled transaction  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_scheduled_transaction_by_id" % key)
        ...
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_scheduled_transaction_by_id`')
        if self.api_client.client_side_validation:
            if 'scheduled_transaction_id' not in local_var_params or local_var_params['scheduled_transaction_id'] is None:
                raise ApiValueError('Missing the required parameter `scheduled_transaction_id` when calling `get_scheduled_transaction_by_id`')
        collection_formats = {}
        path_params = {}
        ...
        if 'scheduled_transaction_id' in local_var_params:
            path_params['scheduled_transaction_id'] = local_var_params['scheduled_transaction_id']
        query_params = []
        header_params = {}
        form_params = []
        local_var_files = {}
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/scheduled_transactions/{scheduled_transaction_id}',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_scheduled_transactions(self, budget_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_scheduled_transactions_with_http_info)(budget_id, **kwargs)

    def get_scheduled_transactions_with_http_info(self, budget_id, **kwargs):
        """List scheduled transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_scheduled_transactions" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_scheduled_transactions`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/scheduled_transactions',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
