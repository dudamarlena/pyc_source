...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/models/currency_format.py
...
class CurrencyFormat(object):
    ...
    openapi_types = {'iso_code':'str', 
     ...
     'currency_symbol':'str', 
     'display_symbol':'bool'}
    attribute_map = {'iso_code':'iso_code', 
    ...
    def __init__(self, iso_code=None, example_format=None, decimal_digits=None, decimal_separator=None, symbol_first=None, group_separator=None, currency_symbol=None, display_symbol=None, local_vars_configuration=None):
    ...
    def example_format(self, example_format):
        ...
        if self.local_vars_configuration.client_side_validation:
            if example_format is None:
                raise ValueError('Invalid value for `example_format`, must not be `None`')
    ...
    def decimal_separator(self, decimal_separator):
        ...
        if self.local_vars_configuration.client_side_validation:
            if decimal_separator is None:
                raise ValueError('Invalid value for `decimal_separator`, must not be `None`')
    ...
    def symbol_first(self, symbol_first):
        ...
        if self.local_vars_configuration.client_side_validation:
            if symbol_first is None:
                raise ValueError('Invalid value for `symbol_first`, must not be `None`')
    ...
    def group_separator(self, group_separator):
        ...
        if self.local_vars_configuration.client_side_validation:
            if group_separator is None:
                raise ValueError('Invalid value for `group_separator`, must not be `None`')
    ...
    def display_symbol(self, display_symbol):
        ...
        if self.local_vars_configuration.client_side_validation:
            if display_symbol is None:
                raise ValueError('Invalid value for `display_symbol`, must not be `None`')
