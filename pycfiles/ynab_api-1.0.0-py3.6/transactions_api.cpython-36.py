...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/ynab_api/api/transactions_api.py
# Compiled at: 2019-11-21 19:08:24
# Size of source mod 2**32: 59073 bytes
"""
    YNAB API Endpoints
...
class TransactionsApi(object):
    ...
    def create_transaction(self, budget_id, data, **kwargs):
        ...
        return (self.create_transaction_with_http_info)(budget_id, data, **kwargs)

    def create_transaction_with_http_info(self, budget_id, data, **kwargs):
        """Create a single transaction or multiple transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method create_transaction" % key)
        ...
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `create_transaction`')
        if self.api_client.client_side_validation:
            if 'data' not in local_var_params or local_var_params['data'] is None:
                raise ApiValueError('Missing the required parameter `data` when calling `create_transaction`')
        collection_formats = {}
        path_params = {}
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/transactions',
          'POST', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_transaction_by_id(self, budget_id, transaction_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_transaction_by_id_with_http_info)(budget_id, transaction_id, **kwargs)

    def get_transaction_by_id_with_http_info(self, budget_id, transaction_id, **kwargs):
        """Single transaction  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_transaction_by_id" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_transaction_by_id`')
        if self.api_client.client_side_validation:
            if 'transaction_id' not in local_var_params or local_var_params['transaction_id'] is None:
                raise ApiValueError('Missing the required parameter `transaction_id` when calling `get_transaction_by_id`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        if 'transaction_id' in local_var_params:
            path_params['transaction_id'] = local_var_params['transaction_id']
        query_params = []
        header_params = {}
        form_params = []
        local_var_files = {}
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/transactions/{transaction_id}',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_transactions(self, budget_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_transactions_with_http_info)(budget_id, **kwargs)

    def get_transactions_with_http_info(self, budget_id, **kwargs):
        """List transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_transactions" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_transactions`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        if 'since_date' in local_var_params:
            if local_var_params['since_date'] is not None:
                query_params.append(('since_date', local_var_params['since_date']))
    ...
    def get_transactions_by_account(self, budget_id, account_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_transactions_by_account_with_http_info)(budget_id, account_id, **kwargs)

    def get_transactions_by_account_with_http_info(self, budget_id, account_id, **kwargs):
        """List account transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_transactions_by_account" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_transactions_by_account`')
        if self.api_client.client_side_validation:
            if 'account_id' not in local_var_params or local_var_params['account_id'] is None:
                raise ApiValueError('Missing the required parameter `account_id` when calling `get_transactions_by_account`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        if 'type' in local_var_params:
            if local_var_params['type'] is not None:
                query_params.append(('type', local_var_params['type']))
        if 'last_knowledge_of_server' in local_var_params:
            if local_var_params['last_knowledge_of_server'] is not None:
                query_params.append(('last_knowledge_of_server', local_var_params['last_knowledge_of_server']))
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/accounts/{account_id}/transactions',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_transactions_by_category(self, budget_id, category_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_transactions_by_category_with_http_info)(budget_id, category_id, **kwargs)

    def get_transactions_by_category_with_http_info(self, budget_id, category_id, **kwargs):
        """List category transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_transactions_by_category" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_transactions_by_category`')
        if self.api_client.client_side_validation:
            if 'category_id' not in local_var_params or local_var_params['category_id'] is None:
                raise ApiValueError('Missing the required parameter `category_id` when calling `get_transactions_by_category`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/categories/{category_id}/transactions',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def get_transactions_by_payee(self, budget_id, payee_id, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.get_transactions_by_payee_with_http_info)(budget_id, payee_id, **kwargs)

    def get_transactions_by_payee_with_http_info(self, budget_id, payee_id, **kwargs):
        """List payee transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_transactions_by_payee" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `get_transactions_by_payee`')
        if self.api_client.client_side_validation:
            if 'payee_id' not in local_var_params or local_var_params['payee_id'] is None:
                raise ApiValueError('Missing the required parameter `payee_id` when calling `get_transactions_by_payee`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
        ...
        auth_settings = [
         'bearer']
        return self.api_client.call_api('/budgets/{budget_id}/payees/{payee_id}/transactions',
          'GET', path_params,
          query_params,
          header_params,
          body=body_params,
    ...
    def update_transaction(self, budget_id, transaction_id, data, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.update_transaction_with_http_info)(budget_id, transaction_id, data, **kwargs)

    def update_transaction_with_http_info(self, budget_id, transaction_id, data, **kwargs):
        """Updates an existing transaction  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method update_transaction" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `update_transaction`')
        if self.api_client.client_side_validation:
            if 'transaction_id' not in local_var_params or local_var_params['transaction_id'] is None:
                raise ApiValueError('Missing the required parameter `transaction_id` when calling `update_transaction`')
        if self.api_client.client_side_validation:
            if 'data' not in local_var_params or local_var_params['data'] is None:
                raise ApiValueError('Missing the required parameter `data` when calling `update_transaction`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
    ...
    def update_transactions(self, budget_id, data, **kwargs):
        ...
        """
        kwargs['_return_http_data_only'] = True
        return (self.update_transactions_with_http_info)(budget_id, data, **kwargs)

    def update_transactions_with_http_info(self, budget_id, data, **kwargs):
        """Update multiple transactions  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method update_transactions" % key)
            local_var_params[key] = val

        del local_var_params['kwargs']
        if self.api_client.client_side_validation:
            if 'budget_id' not in local_var_params or local_var_params['budget_id'] is None:
                raise ApiValueError('Missing the required parameter `budget_id` when calling `update_transactions`')
        if self.api_client.client_side_validation:
            if 'data' not in local_var_params or local_var_params['data'] is None:
                raise ApiValueError('Missing the required parameter `data` when calling `update_transactions`')
        collection_formats = {}
        path_params = {}
        if 'budget_id' in local_var_params:
            path_params['budget_id'] = local_var_params['budget_id']
