...
# [GCC 8.4.0]
# Embedded file name: /Users/jacob/Projects/python-storymarket/tests/test_content.py
# Compiled at: 2011-05-30 18:13:02
from __future__ import absolute_import
import mock
from nose.tools import assert_equal, assert_not_equal
from storymarket import Audio, Data, Photo, Text, Video, Category, Subtype, Org, PricingScheme, RightsScheme
from storymarket.content import User, BinaryContentManager
from StringIO import StringIO
from .fakeserver import FakeStorymarket
from .utils import assert_isinstance, assert_list_api, assert_get_api, assert_delete_api, assert_create_api, assert_update_api
sm = FakeStorymarket()
BOUNDARY = 'BOUNDARY'
...
def test_content_apis():
    ...
    create_update_data = {'category': '/content/sub_category/1/', 
       'author': 'frank', 
    ...
    for (manager, cls, urlbit, extra_data) in test_data:
        ...
        yield (
         assert_list_api, sm, manager.all, cls, list_url)
...
def test_related_resource_properties_when_none():
    ...
    for prop in test_properties:
        yield (
         check_related_resource_property_when_none, prop)
