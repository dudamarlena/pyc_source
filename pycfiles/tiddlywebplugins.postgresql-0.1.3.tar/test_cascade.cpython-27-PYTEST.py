...
# [GCC 8.4.0]
# Embedded file name: /Users/cdent/src/tiddlywebplugins.postgresql/test/test_cascade.py
# Compiled at: 2013-08-14 13:01:12
import __builtin__ as @py_builtins, _pytest.assertion.rewrite as @pytest_ar, os, py.test
from tiddlyweb.config import config
from tiddlyweb.store import Store
from tiddlyweb.model.bag import Bag
from tiddlyweb.model.tiddler import Tiddler
from tiddlywebplugins.postgresql import Base, Session
...
def test_cascade():
 ...
 L.  43       151  LOAD_CONST               '%s, but got: text: %s, tag: %s, tiddler: %s, revision: %s, field: %s'

 L.  44       154  LOAD_FAST             1  'message'
              157  LOAD_FAST             2  'text_count'
              160  LOAD_FAST             3  'tag_count'

 L.  45       163  LOAD_FAST             4  'tiddler_count'
 ...
 L.  47       179  LOAD_FAST             2  'text_count'
 ...
 L.  48       204  LOAD_FAST             5  'revision_count'
              207  DUP_TOP          
              208  ROT_THREE        
              209  COMPARE_OP            2  ==
