...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/watchm8/watchers/k8s.py
# Compiled at: 2017-09-11 09:22:32
        ...
        while self._stop_watcher is False:
            ...
            try:
                for event in w.stream(self._stream_func, **kwargs):
                    ...
                    version = int(event['raw_object']['metadata']['resourceVersion'])
