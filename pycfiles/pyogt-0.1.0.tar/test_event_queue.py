...
# Embedded file name: build/bdist.linux-x86_64/egg/pyogp/lib/client/tests/test_event_queue.py
...
class TestEventQueue(unittest.TestCase):
    ...
    def test__decode_eq_result(self):
        data = {'events': [{'body': {'SimulatorInfo': [{'IP': b'\xd8R R', 'Handle': b'\x00\x03\xe4\x00\x00\x03\xe9\x00', 'Port': 13001}]}, 'message': 'EnableSimulator'}, {'body': {'SimulatorInfo': [{'IP': b'\xd8R\x0f\x06', 'Handle': b'\x00\x03\xe5\x00\x00\x03\xe8\x00', 'Port': 13000}]}, 'message': 'EnableSimulator'}, {'body': {'SimulatorInfo': [{'IP': b'\xd8R R', 'Handle': b'\x00\x03\xe4\x00\x00\x03\xe9\x00', 'Port': 13001}]}, 'message': 'EnableSimulator'}, {'body': {'SimulatorInfo': [{'IP': b'\xd8R\x0f\x06', 'Handle': b'\x00\x03\xe5\x00\x00\x03\xe8\x00', 'Port': 13000}]}, 'message': 'EnableSimulator'}], 'id': -2054685694}
