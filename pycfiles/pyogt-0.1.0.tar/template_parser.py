...
# Embedded file name: build/bdist.linux-x86_64/egg/pyogp/lib/base/message/template_parser.py
# Compiled at: 2010-02-07 17:28:31
__doc__ = '\nContributors can be viewed at:\nhttp://svn.secondlife.com/svn/linden/projects/2008/pyogp/lib/base/trunk/CONTRIBUTORS.txt \n\n$LicenseInfo:firstyear=2008&license=apachev2$\n\nCopyright 2009, Linden Research, Inc.\n\nLicensed under the Apache License, Version 2.0.\nYou may obtain a copy of the License at:\n    http://www.apache.org/licenses/LICENSE-2.0\nor in \n    http://svn.secondlife.com/svn/linden/projects/2008/pyogp/lib/base/LICENSE.txt\n\n$/LicenseInfo$\n'
import struct, string, re, pprint, template
...
class MessageTemplateParser(object):
    ...
    def _parse_template_file(self):
        ...
        while True:
            ...
            if self.version == '':
                version_test = re.match(version_re, line)
    ...
    def _start_new_template(self, match):
        ...
        if frequency == MsgFrequency.FIXED_FREQUENCY_MESSAGE:
            ...
            msg_num_hex = struct.pack('>BBB', 255, 255, msg_num)
        elif frequency == MsgFrequency.MEDIUM_FREQUENCY_MESSAGE:
            msg_num_hex = struct.pack('>BB', 255, msg_num)
    ...
    def _start_new_var(self, match):
        ...
        return template.MessageTemplateVariable(match.group(1), var_type, var_size)
...
def print_packet_list(packet_list):
    for packet in packet_list:
        print '================================================================================='
        print packet.get_name() + ' ' + packet.get_frequency_as_string() + ' ' + str(packet.get_message_number()) + ' ' + packet.get_message_hex_num() + ' ' + packet.get_message_trust_as_string() + ' ' + packet.get_message_encoding_as_string() + ' ' + packet.get_deprecation_as_string()
        for block in packet.get_blocks():
            print '\t' + str(block.get_name()) + ' ' + block.get_block_type_as_string() + ' ' + str(block.get_block_number())
...
def get_all_types(packet_list):
    ...
    for packet in packet_list:
        for block in packet.get_blocks():
            for variable in block.get_variables():
                type_set.add(variable.get_type_as_string())
