...
# Embedded file name: build/bdist.macosx-10.6-universal/egg/pyogp/apps/proxy/client_proxy.py
# Compiled at: 2010-01-09 02:16:54
__doc__ = '\nContributors can be viewed at:\nhttp://svn.secondlife.com/svn/linden/projects/2008/pyogp/lib/base/trunk/CONTRIBUTORS.txt \n\n$LicenseInfo:firstyear=2008&license=apachev2$\n\nCopyright 2009, Linden Research, Inc.\n\nLicensed under the Apache License, Version 2.0.\nYou may obtain a copy of the License at:\n    http://www.apache.org/licenses/LICENSE-2.0\nor in \n    http://svn.secondlife.com/svn/linden/projects/2008/pyogp/lib/base/LICENSE.txt\n\n$/LicenseInfo$\n'
import copy, logging, optparse, random, signal, sys, traceback
...
class ViewerProxyApp(object):
    ...
    def start_udp_proxy(self, sim_ip, sim_port):
        ...
        return (
         self.udp_proxy.hostname, self.udp_proxy.proxy_socket.getsockname()[1])
    ...
    def start_caps_proxy(self, seed_cap_url, caps_proxy_port=None):
        ...
        if not self.signal_handler:
            self.signal_handler = signal.signal(signal.SIGINT, self.sigint_handler)
        logger.debug('ViewerProxyApp is spawning caps proxies for region with                        seed_capability of %s' % seed_cap_url)
        ...
        return (
         '127.0.0.1', caps_proxy_port, self.caps_proxy.proxy_map[seed_cap_url])
...
def main():
    ...
    parser.add_option('--port', default='8080', dest='login_port', type='int', help='Port to serve on (default 8080)')
    parser.add_option('--loginuri', default='https://login.aditi.lindenlab.com/cgi-bin/login.cgi', dest='loginuri', help='Specifies the target loginuri to connect proxy to')
    parser.add_option('-v', '--verbose', default=False, dest='verbose', action='store_true', help='enables logging, sets logging level to info, logs names of all             packets')
    parser.add_option('-V', '--verboseverbose', default=False, dest='verboseverbose', action='store_true', help='enables logging, sets logging level to debug, logs contents             of all packets')
