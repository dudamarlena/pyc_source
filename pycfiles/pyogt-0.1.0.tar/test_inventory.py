...
# Embedded file name: build/bdist.linux-x86_64/egg/pyogp/lib/client/tests/test_inventory.py
# Compiled at: 2010-02-09 00:00:15
__doc__ = '\nContributors can be viewed at:\nhttp://svn.secondlife.com/svn/linden/projects/2008/pyogp/lib/base/trunk/CONTRIBUTORS.txt \n\n$LicenseInfo:firstyear=2008&license=apachev2$\n\nCopyright 2009, Linden Research, Inc.\n\nLicensed under the Apache License, Version 2.0.\nYou may obtain a copy of the License at:\n    http://www.apache.org/licenses/LICENSE-2.0\nor in \n    http://svn.secondlife.com/svn/linden/projects/2008/pyogp/lib/base/LICENSE.txt\n\n$/LicenseInfo$\n'
import unittest, uuid
from pyogp.lib.client.inventory import InventoryManager, InventoryFolder, InventoryItem
from pyogp.lib.base.datatypes import UUID
from pyogp.lib.client.agent import Agent
from pyogp.lib.client.region import Region
from pyogp.lib.client.enums import AssetType, InventoryType, WearablesIndex, Permissions
...
class TestInventory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        inventory_item = InventoryItem(uuid_, '0201a00f-afde-477d-967b-e731d186b9d6', uuid_, uuid_, UUID(), 0, 0, 0, 0, 0, False, uuid_, 10, 10, 0, 0, 0, 'a_item', 'a_item_desc', 0, 0)
    ...
    def test_search_inventory_for_folders(self):
        matches = self.inventory.search_inventory(self.inventory.folders, item_id='0201a00f-afde-477d-967b-e731d186b9d6')
        self.assertEqual(len(matches), 1)
        folder = matches.pop()
        self.assertEqual(folder.Name, 'My Inventory')
        matches = self.inventory.search_inventory(self.inventory.folders, name='Trash')
        self.assertTrue(len(matches), 1)
        folder = matches.pop()
        self.assertEqual(str(folder.FolderID), '52aaafe8-7c5e-8fe0-b47e-097198648c9b')

    def test_search_inventory_for_items(self):
        matches = self.inventory.search_inventory(self.inventory.folders, item_id='12345678-1234-1234-1234-123456789abc')
        self.assertTrue(len(matches), 1)
        item = matches.pop()
        self.assertEqual(item.Name, 'a_item')
        matches = self.inventory.search_inventory(self.inventory.folders, name='a_item')
        self.assertTrue(len(matches), 1)
        item = matches.pop()
    ...
    def test_create_new_item(self):
        ...
        matches = self.inventory.search_inventory(self.inventory.folders, name='My Inventory')
        self.assertEqual(len(matches), 1)
        folder = matches.pop()
        self.inventory.create_new_item(folder, 'Name', 'Desc', AssetType.LSLText, InventoryType.LSL, WearablesIndex.WT_SHAPE, 0)
