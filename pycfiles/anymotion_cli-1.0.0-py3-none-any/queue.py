...
# Embedded file name: build/bdist.linux-x86_64/egg/anymeta/queue.py
# Compiled at: 2011-02-23 09:26:42
...
CONNECT_BACKOFF = {'delay': 0.25, 
   'maxDelay': 16, 
   'factor': 2}
HTTP_BACKOFF = {'delay': 10, 
   'maxDelay': 240, 
   'factor': 2}
...
class APIQueuer(object):
    ...
    @type start: C{bool}
    """
    retryableErrors = {error.ConnectError: 'connect', 
    ...
    def trapErrors(self, failure):
        ...
        try:
            ...
            self.runner.delay = min(backoff['maxDelay'], self.runner.delay * backoff['factor'])
