...
# [GCC 8.4.0]
# Embedded file name: /Users/clareau/dat/Research/AryeeResearch/lareau_dev/mgatk/mgatk/mgatkHelp.py
# Compiled at: 2019-12-17 19:12:07
# Size of source mod 2**32: 8535 bytes
import itertools, time, shutil, re, os, sys, subprocess, pysam, filecmp, math, pysam
    ...
    if any(mito_genome in s for s in supported_genomes):
        ...
        if writeFA and write_files:
            ...
            with open(of + '/final/' + mito_genome + '_refAllele.txt', 'w') as (f):
                ...
                f.close()
    return (
     fastaf, mito_genome, mito_length)
