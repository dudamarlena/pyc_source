...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sendgrid/helpers/mail/mail_settings.py
# Compiled at: 2020-04-15 16:00:33
# Size of source mod 2**32: 4986 bytes


class MailSettings(object):
    __doc__ = 'A collection of mail settings that specify how to handle this email.'

    def __init__(self, bcc_settings=None, bypass_list_management=None, footer_settings=None, sandbox_mode=None, spam_check=None):
