...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sendgrid/helpers/mail/tracking_settings.py
# Compiled at: 2020-04-15 16:00:33
# Size of source mod 2**32: 4790 bytes


class TrackingSettings(object):
    __doc__ = 'Settings to track how recipients interact with your email.'

    def __init__(self, click_tracking=None, open_tracking=None, subscription_tracking=None, ganalytics=None):
