...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sendgrid/helpers/mail/personalization.py
# Compiled at: 2020-04-15 16:00:33
# Size of source mod 2**32: 6232 bytes


class Personalization(object):
    __doc__ = 'A Personalization defines who should receive an individual message and\n    how that message should be handled.\n    '
