...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/djangopypi/management/commands/loadclassifiers.py
    ...
    def _get_lines(self, location):
        ...
        try:
            if location.startswith(('http://', 'https://')):
                ...
                fp = open(location)
                return [ e.strip() for e in fp.readlines() if e and not e.isspace()
                       ]
