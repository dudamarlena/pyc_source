...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/djangopypi/migrations/0005_allow_null_distribution_uploader.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('djangopypi_distribution', 'uploader_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Distribution.uploader' and its values cannot be restored.")
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'djangopypi.mirrorlog': {'Meta': {'object_name': 'MirrorLog'}, 'created': (
                                          'django.db.models.fields.DateTimeField', [], {'default': "'now'"}), 
                                'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                'master': (
                                         'django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['djangopypi.MasterIndex']"}), 
                                'releases_added': (
                                                 'django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'mirror_sources'", 'blank': 'True', 'to': "orm['djangopypi.Release']"})}, 
