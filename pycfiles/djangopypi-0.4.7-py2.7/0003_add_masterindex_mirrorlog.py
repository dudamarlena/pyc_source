...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.11-intel/egg/djangopypi/migrations/0003_add_masterindex_mirrorlog.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table('djangopypi_mirrorlog', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
          'master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['djangopypi.MasterIndex'])),
         (
          'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))))
        db.send_create_signal('djangopypi', ['MirrorLog'])
        db.create_table('djangopypi_mirrorlog_releases_added', (
         (
          'id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
         (
          'mirrorlog', models.ForeignKey(orm['djangopypi.mirrorlog'], null=False)),
         (
          'release', models.ForeignKey(orm['djangopypi.release'], null=False))))
        db.create_unique('djangopypi_mirrorlog_releases_added', ['mirrorlog_id', 'release_id'])
        db.create_table('djangopypi_masterindex', (
         (
          'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
         (
        ...
        db.send_create_signal('djangopypi', ['MasterIndex'])

    def backwards(self, orm):
        db.delete_table('djangopypi_mirrorlog')
        db.delete_table('djangopypi_mirrorlog_releases_added')
        db.delete_table('djangopypi_masterindex')
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'contenttypes.contenttype': {'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"}, 'app_label': (
                                    ...
                                    'name': (
                                           'django.db.models.fields.CharField', [], {'max_length': '100'})}, 
       'djangopypi.classifier': {'Meta': {'ordering': "('name',)", 'object_name': 'Classifier'}, 'name': (
       ...
       'djangopypi.masterindex': {'Meta': {'object_name': 'MasterIndex'}, 'id': (
                                       'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                  'title': (
                                          'django.db.models.fields.CharField', [], {'max_length': '255'}), 
                                  'url': (
                                        'django.db.models.fields.CharField', [], {'max_length': '255'})}, 
       'djangopypi.mirrorlog': {'Meta': {'object_name': 'MirrorLog'}, 'created': (
                                          'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}), 
                                'id': (
                                     'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                                'master': (
                                         'django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['djangopypi.MasterIndex']"}), 
                                'releases_added': (
                                                 'django.db.models.fields.related.ManyToManyField', [], {'related_name': "'mirror_sources'", 'symmetrical': 'False', 'to': "orm['djangopypi.Release']"})}, 
       'djangopypi.package': {'Meta': {'ordering': "['name']", 'object_name': 'Package'}, 'allow_comments': (
                                               'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                              'auto_hide': (
                                          'django.db.models.fields.BooleanField', [], {'default': 'True'}), 
                              'maintainers': (
       ...
       'djangopypi.release': {'Meta': {'ordering': "['-created']", 'unique_together': "(('package', 'version'),)", 'object_name': 'Release'}, 'created': (
                                        'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}), 
                              'hidden': (
                                       'django.db.models.fields.BooleanField', [], {'default': 'False'}), 
                              'id': (
