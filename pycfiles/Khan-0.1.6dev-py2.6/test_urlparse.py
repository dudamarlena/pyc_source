...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/tests/test_urlparse.py
...
class TestRuleDispatcher(TestCase):
    ...
    def test(self):
        ...
        dispatcher['/(.*)\\.jpg'] = Response('app_jpg')
        dispatcher['/(.*)\\.png'] = Response('app_png')
