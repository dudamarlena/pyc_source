...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/utils/mapping.py
...
__all__ = [
 'ismapping', 'DictDotted', 'ObjectDictify', 'DictMirror']

def ismapping(obj):
    if isinstance(obj, dict) or hasattr(obj, '__getitem__') and hasattr(obj, '__setitem__') and hasattr(obj, '__delitem__') and hasattr(obj, '__iter__'):
        return True
    else:
        return False
