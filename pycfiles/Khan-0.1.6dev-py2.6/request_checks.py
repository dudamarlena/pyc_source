...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/utils/request_checks.py
...
def reqchecker(checker, on_invalid=None):
    ...
    def d(handler):
        ...
        def check(*args, **kargs):
            ...
            resp = checker(environ) or on_invalid(Request(environ), InvalidException('request restricted'))
            if is_wsgiapp:
