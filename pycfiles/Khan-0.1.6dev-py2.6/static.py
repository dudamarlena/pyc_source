...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/static.py
# Compiled at: 2010-07-22 00:45:37
"""
静态文件服务
=================================
...
def make_file_app(global_conf, file, headers=None, content_type=None, content_encoding=None, conf=None):
    """
...
class StaticCommand(Command):
    ...
    parser.add_option('-s', '--server', dest='host', default='0.0.0.0', help='host. [default: %default]')
    parser.add_option('-p', '--port', dest='port', default='7010', help='port. [default: %default]')
