...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/cache.py
...
__all__ = [
 'cached', 'CacheContainer', 'etag_cached']
log = logging.getLogger(__name__)
DEFAULT_EXPIRES = 300
CATCH_ALL_STATUS = None
CACHE_ALL_HEADERS = None

def cached(container=None, expires=DEFAULT_EXPIRES, catch_status=CATCH_ALL_STATUS, exclude_headers=CACHE_ALL_HEADERS):
    u"""
...
def make_cache_middleware(global_conf, store=None, expires=DEFAULT_EXPIRES, catch_status=CATCH_ALL_STATUS, exclude_headers=CACHE_ALL_HEADERS):
    """
    ...
    def middleware(app):
        ...
        return cached(CacheContainer(store), expires=expires, catch_status=catch_status, exclude_headers=exclude_headers)(app)
