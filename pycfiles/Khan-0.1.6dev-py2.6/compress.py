...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/compress.py
...
class SlimmerForWebMinifier(WebMinifierPlugin):
    mimetypes = [
     'application/x-javascript', 'text/javascript', 'application/javascript', 'text/ecmascript',
    ...
    def __call__(self, resp):
        ...
        slimmer_method = None
        if content_type in ('application/x-javascript', 'text/javascript', 'application/javascript',
                            'text/ecmascript'):
