...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/security/restrict.py
...
__all__ = [
 'RequestFrequencyRestrictor', 'URLRestrictor']
...
def make_request_frequency_restrictor_middleware(global_conf, frequency, interval, store=None, max_entries=None, exc_app=None, conf=None):
    u"""
...
def make_urlrestrictor_middleware(global_conf, deny_handler=None, rulesets=None, conf=None, **rule_directives):
    r"""
    Paste EGG entry point::
    ...
    def middleware(app):
        return URLRestrictor(app, blackrules=blackrules, whiterules=whiterules, deny_handler=deny_handler)
