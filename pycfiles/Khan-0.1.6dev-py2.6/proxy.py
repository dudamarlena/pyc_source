...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/proxy.py
...
import urlparse, urllib, logging, httplib2
...
def make_proxy_app(global_conf, address, timeout=30, allowed_request_methods='', suppress_http_headers=''):
    ...
    return Proxy(address, timeout=timeout, allowed_request_methods=allowed_request_methods, suppress_http_headers=suppress_http_headers)
...
class TransparentProxy(object):
    ...
    def __init__(self, cache=None, timeout=None, force_host=None, force_scheme='http'):
