...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/tests/test_utils/test_decorator.py
...
class TestInvalidHandler(TestCase):
    ...
    def test_basic(self):
        ...
        new_handler = mydecorator(HTTPStatusOnInvalid(200) | OneInvalidResponseFilter() | TwoInvalidResponseFilter() | ThreeInvalidResponseFilter())(handler)
