...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/project/core.py
# Compiled at: 2010-05-16 10:18:15
...
__all__ = [
 'ProjectTemplate', 'ProjectInstaller', 'KhanDeployInstaller']
...
class ProjectTemplate(Template):
    ...
    def post(self, command, output_dir, vars):
        ...
        copydir.copy_dir(base_template_dir, output_dir, vars, verbosity=command.verbose, simulate=command.options.simulate, interactive=command.interactive, overwrite=command.options.overwrite, indent=1, use_cheetah=self.use_cheetah, template_renderer=self.template_renderer)
    ...
    def config_content(self, command, vars):
        ...
        for module in modules:
            if pkg_resources.resource_exists(module, config_file):
                return self.template_renderer(pkg_resources.resource_string(module, config_file), vars, filename=config_file)
