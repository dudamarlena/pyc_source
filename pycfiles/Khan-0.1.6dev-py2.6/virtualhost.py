...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/virtualhost.py
        ...
        def sort(x, y):
            ...
            if domain1 and '*' not in domain1 and domain and '*' in domain:
                ...
                if pat.match(domain1):
                    return -1
                return 0
            return domain and (1 if '*' not in domain and domain1 and '*' in domain1 else cmp(domain, domain1) or cmp(port, port1))
