...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/utils/testing.py
# Compiled at: 2010-07-26 05:14:59
"""
字典工具
=================================
...
__all__ = [
 'unittest', 'assert_dict', 'DictTester',
 'TestCase', 'TestApp', 'PrintValue', 'ProjectTester']
...
class DictTester(object):
    ...
    def test__getitem__(self):
        ...
        self.store.clear()
        self.store['最大'] = 3
        self.assertEqual(self.store['最大'], 3)
    ...
    def test__delitem__(self):
        ...
        self.store['最大'] = 3
        del self.store['最大']
        self.assertEqual('最大' in self.store, False)
    ...
    def test_get(self):
        ...
        self.store.clear()
        self.store['最大'] = 3
        self.assertEqual(self.store.get('最大'), 3)
    ...
    def test_items(self):
        ...
        self.store['一般'] = 7
        slist = list(self.store.items())
        self.assertEqual(('最小', 6) in slist, True)
    ...
    def test_iterkeys(self):
        ...
        self.store['一般'] = 7
        slist = list(self.store.iterkeys())
        self.assertEqual('最小' in slist, True)
    ...
    def test_setdefault(self):
        ...
        self.store['最小'] = 6
        self.store['一般'] = 7
        self.store.setdefault('一般其他', 8)
        self.assertEqual(self.store['一般其他'], 8)
    ...
    def test_update(self):
        ...
        self.store['一般'] = 7
        self.store.update(tstore)
        self.assertEqual(self.store['最小'], 6)
...
class KhanForNose(NosePlugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option('--khan-server', dest='khan_server', metavar='NAME', default=env.get('NOSE_KHAN_SERVER', 'main'), help='Specifie server name in zcml file [default: %default]')
        parser.add_option('--khan-logging', dest='khan_logging', action='count', default=env.get('NOSE_KHAN_LOGGING', True), help='Enable khan project logging [default: %default]')
        parser.add_option('--khan-package', dest='khan_package', metavar='PACKGE', default=env.get('NOSE_KHAN_PACKAGE'), help='Project package.')
        parser.add_option('--khan-zcml', dest='khan_zcml', metavar='ZCML', default=env.get('NOSE_KHAN_ZCML'), help='Project zcml file.')
