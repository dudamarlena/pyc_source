...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/khan/error_document.py
...
class ErrorDocument(object):
    ...
    def __init__(self, app, document_root, catch=CATCH_STATUS, keep_status=True, file_extension=FILE_EXTENSION):
...
def make_error_document_middleware(global_conf, document_root, catch=None, disabled=True, keep_status=True, file_extension=ErrorDocument.FILE_EXTENSION):
    """
