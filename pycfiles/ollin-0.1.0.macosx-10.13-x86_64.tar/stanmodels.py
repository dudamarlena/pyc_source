...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/site-packages/ollin/estimation/stanmodels.py
...
COMPILED_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'compiled_models')
...
class StanModel(EstimationModel):
    ...
    def load_model(self):
        ...
        path = os.path.join(COMPILED_PATH, self.name.replace(' ', '_') + '.pkl')
