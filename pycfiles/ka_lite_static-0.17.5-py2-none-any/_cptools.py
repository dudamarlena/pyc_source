...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cptools.py
...
class SessionTool(Tool):
    ...
    def regenerate(self):
        ...
        sess.regenerate()
        conf = dict([ (k, v) for k, v in self._merged_args().items() if k in ('path',
                                                                              'path_header',
                                                                              'name',
                                                                              'timeout',
                                                                              'domain',
