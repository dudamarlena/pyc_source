...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/gis/geos/tests/test_geos_mutation.py
...
class GEOSMutationTest(unittest.TestCase):
    ...
    def test05_Polygon(self):
        ...
        for pg in (
         Polygon(((1, 0), (4, 1), (6, -1), (8, 10), (1, 0)), (
          (5, 4), (6, 4), (6, 3), (5, 4))),
         fromstr('POLYGON ((1 0,4 1,6 -1,8 10,1 0),(5 4,6 4,6 3,5 4))')):
            self.assertEqual(pg._get_single_external(0), LinearRing((1, 0), (4, 1), (6,
                                                                                     -1), (8,
                                                                                           10), (1,
                                                                                                 0)), 'Polygon _get_single_external(0)')
            self.assertEqual(pg._get_single_external(1), LinearRing((5, 4), (6, 4), (6,
                                                                                     3), (5,
                                                                                          4)), 'Polygon _get_single_external(1)')
            ...
            self.assertEqual(pg.coords, (
             ...
             (
              (4.0, 2.0), (5.0, 2.0), (5.0, 3.0), (4.0, 2.0))), 'Polygon _set_list')
