...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/test_caching.py
# Compiled at: 2018-07-11 18:15:31
import datetime, gzip
from itertools import count
import os
curdir = os.path.join(os.getcwd(), os.path.dirname(__file__))
import sys, threading, time, urllib, cherrypy
from cherrypy._cpcompat import next, ntob, quote, xrange
from cherrypy.lib import httputil
gif_bytes = ntob(b'GIF89a\x01\x00\x01\x00\x82\x00\x01\x99"\x1e\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00,\x00\x00\x00\x00\x01\x00\x01\x00\x02\x03\x02\x08\t\x00;')
...
class CacheTest(helper.CPWebCase):
    ...
    def setup_server():
        ...
        class UnCached(object):
            _cp_config = {'tools.expires.on': True, 'tools.expires.secs': 60, 
    ...
    def testVaryHeader(self):
        ...
        self.assertBody('visit #1')
        self.getPage('/varying_headers/', headers=[
    ...
    def test_antistampede(self):
        ...
        self.assertEqualDates(start, datetime.datetime.now(), seconds=SECONDS + 2)
