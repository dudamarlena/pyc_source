...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/markup/templatetags/markup.py
...
def restructuredtext(value):
    import warnings
    warnings.warn('The restructuredtext filter has been deprecated', category=DeprecationWarning)
    try:
