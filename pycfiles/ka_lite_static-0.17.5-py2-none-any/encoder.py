...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/pyasn1/pyasn1/codec/native/encoder.py
...
tagMap = {univ.Boolean.tagSet: BooleanEncoder(), 
...
typeMap = {univ.Set.typeId: SetEncoder(), 
