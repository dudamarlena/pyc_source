...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/rsa/rsa/cli.py
...
import rsa, rsa.bigfile, rsa.pkcs1
...
def keygen():
    ...
    parser.add_option('--form', help='key format of the private and public keys - default PEM', choices=('PEM',
                                                                                                         'DER'), default='PEM')
...
class CryptoOperation(object):
    ...
    def parse_cli(self):
        ...
        parser.add_option('--keyform', help='Key format of the %s key - default PEM' % self.keyname, choices=('PEM',
                                                                                                              'DER'), default='PEM')
        cli, cli_args = parser.parse_args(sys.argv[1:])
