...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cpwsgi.py
...
"""
import sys as _sys, cherrypy as _cherrypy
...
class ExceptionTrapper(object):
    ...
    def __init__(self, nextapp, throws=(
...
class AppResponse(object):
    ...
    headerNames = {'HTTP_CGI_AUTHORIZATION': 'Authorization', 'CONTENT_LENGTH': 'Content-Length', 
    ...
    def translate_headers(self, environ):
        ...
        for cgiName in environ:
            if cgiName in self.headerNames:
                yield (
                 self.headerNames[cgiName], environ[cgiName])
