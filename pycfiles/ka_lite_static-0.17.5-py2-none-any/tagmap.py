...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/pyasn1/pyasn1/type/tagmap.py
...
class TagMap(object):
    ...
    *TagMap* objects are immutable and duck-type read-only Python
    ...
    def __contains__(self, tagSet):
        return tagSet in self.__presentTypes or self.__defaultType is not None and tagSet not in self.__skipTypes
