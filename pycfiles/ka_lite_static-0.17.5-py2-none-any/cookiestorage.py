...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/formtools/tests/wizard/cookiestorage.py
...
class TestCookieStorage(TestStorage, TestCase):
    ...
    def test_manipulated_cookie(self):
        ...
        storage.request.COOKIES[storage.prefix] = cookie_signer.sign(storage.encoder.encode({'key1': 'value1'}))
    ...
    def test_reset_cookie(self):
        ...
        self.assertJSONEqual(unsigned_cookie_data, {'step_files': {}, 'step': None, 'extra_data': {}, 'step_data': {}})
        return