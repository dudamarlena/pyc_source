...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/modfastcgi.py
...
class ModFCGISupervisor(helper.LocalWSGISupervisor):
    ...
    def start(self, modulename):
        cherrypy.server.httpserver = servers.FlupFCGIServer(application=erase_script_name, bindAddress=('127.0.0.1',
                                                                                                        4000))
