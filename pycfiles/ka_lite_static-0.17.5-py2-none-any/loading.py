...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/db/models/loading.py
...
import imp, sys, os
__all__ = ('get_apps', 'get_app', 'get_models', 'get_model', 'register_models', 'load_app',
           'app_cache_ready')
...
class AppCache(object):
    ...
    """
    __shared_state = dict(app_store=SortedDict(), app_labels={}, app_models=SortedDict(), app_errors={}, loaded=False, handled={}, postponed=[], nesting_level=0, _get_models_cache={})
    ...
    def get_models(self, app_mod=None, include_auto_created=False, include_deferred=False, only_installed=True, include_swapped=False):
        ...
        """
        cache_key = (
         app_mod, include_auto_created, include_deferred, only_installed, include_swapped)
        try:
