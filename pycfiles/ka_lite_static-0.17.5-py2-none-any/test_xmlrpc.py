...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/test_xmlrpc.py
...
def setup_server():
    ...
    class XmlRpc(_cptools.XMLRPCController):
        ...
        def return_composite(self):
            return (
             dict(a=1, z=26), 'hi', ['welcome', 'friend'])
...
class XmlRpcTest(helper.CPWebCase):
    ...
    def testXmlRpc(self):
        ...
        self.assertEqual(proxy.return_datetime(), DateTime((2003, 10, 7, 8, 1, 0, 1,
                                                            280, -1)))
