...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/ply/ply/cpp.py
...
class Preprocessor(object):
    ...
    def macro_prescan(self, macro):
        ...
        while i < len(macro.value):
            ...
            elif macro.value[i].value == '##' and macro.variadic and i > 0 and macro.value[(i - 1)].value == ',' and i + 1 < len(macro.value) and macro.value[(i + 1)].type == self.t_ID:
