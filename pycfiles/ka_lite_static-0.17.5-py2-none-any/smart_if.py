...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django-annoying/annoying/templatetags/smart_if.py
...
class IfParser(object):
    ...
    def get_bool_var(self):
        ...
        if not self.at_end():
            ...
            if isinstance(op_token, basestring) and op_token not in BOOL_OPERATORS:
                op, negate = self.get_operator()
