...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/flatpages/tests/templatetags.py
...
@override_settings(MIDDLEWARE_CLASSES=('django.middleware.common.CommonMiddleware',
                                       ...
                                       'django.contrib.flatpages.middleware.FlatpageFallbackMiddleware'), TEMPLATE_DIRS=(
 os.path.join(os.path.dirname(__file__), 'templates'),), SITE_ID=1)
class FlatpageTemplateTagTests(TestCase):
    ...
    def test_get_flatpages_tag_for_user(self):
        ...
        out = Template('{% load flatpages %}{% get_flatpages for me as flatpages %}{% for page in flatpages %}{{ page.title }},{% endfor %}').render(Context({'me': me}))
    ...
    def test_get_flatpages_with_prefix_for_user(self):
        ...
        me = User.objects.create_user('testuser', 'test@example.com', 's3krit')
        out = Template("{% load flatpages %}{% get_flatpages '/location/' for me as location_flatpages %}{% for page in location_flatpages %}{{ page.title }},{% endfor %}").render(Context({'me': me}))
