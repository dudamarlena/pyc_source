...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/test_config.py
# Compiled at: 2018-07-11 18:15:31
"""Tests for the CherryPy configuration system."""
import os, sys, unittest, cherrypy, cherrypy._cpcompat as compat
...
def setup_server():
    ...
    cherrypy.config.update({'luxuryyacht': 'throatwobblermangrove', 'db.scheme': 'sqlite///memory'})
...
class ConfigTests(helper.CPWebCase):
    ...
    def test_request_body_namespace(self):
        self.getPage('/plain', method='POST', headers=[
         ...
         ('Content-Length', '13')], body=compat.ntob(b'\xff\xfex\x00=\xff\xfea\x00b\x00c\x00'))
        self.assertBody('abc')
