...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/template/loader_tags.py
...
class BaseIncludeNode(Node):
    ...
    def render_template(self, template, context):
        values = dict([ (name, var.resolve(context)) for name, var in six.iteritems(self.extra_context)
                      ])
