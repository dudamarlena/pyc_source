...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/peewee/playhouse/test_utils.py
...
class test_database(object):
    ...
    def __init__(self, db, models, create_tables=True, drop_tables=True, fail_silently=False):
        self.db = db
        self.models = models
