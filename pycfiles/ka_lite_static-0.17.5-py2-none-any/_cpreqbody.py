...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cpreqbody.py
...
class Entity(object):
    ...
    name = None
    params = None
    processors = {'application/x-www-form-urlencoded': process_urlencoded, 'multipart/form-data': process_multipart_form_data, 
    ...
    def __init__(self, fp, headers, params=None, parts=None):
        ...
        if dec:
            self.attempt_charsets = [
             dec] + [ c for c in self.attempt_charsets if c != dec
                    ]
        else:
