...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/peewee/pwiz.py
...
DATABASE_ALIASES = {MySQLDatabase: [
                 'mysql', 'mysqldb'], 
   PostgresqlDatabase: [
                      'postgres', 'postgresql'], 
   SqliteDatabase: [
...
def get_option_parser():
    ...
    ao('-e', '--engine', dest='engine', default='postgresql', choices=engines, help='Database type, e.g. sqlite, mysql or postgresql. Default is "postgresql".')
