...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/utils/unittest/case.py
# Compiled at: 2018-07-11 18:15:30
"""Test case implementation"""
import sys, difflib, pprint, re, unittest, warnings
from django.utils.unittest import result
from django.utils.unittest.util import safe_repr, safe_str, strclass, unorderable_list_difference
...
class TestCase(unittest.TestCase):
    ...
    def assertSequenceEqual(self, seq1, seq2, msg=None, seq_type=None, max_diff=640):
        ...
        if differing is None:
            ...
            elements = (
             seq_type_name.capitalize(), seq1_repr, seq2_repr)
