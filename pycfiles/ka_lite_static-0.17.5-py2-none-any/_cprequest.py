...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cprequest.py
# Compiled at: 2018-07-11 18:15:31
import os, sys, time, warnings, cherrypy
...
class Request(object):
    ...
    throws = (
     KeyboardInterrupt, SystemExit, cherrypy.InternalRedirect)
    throw_errors = False
    closed = False
    stage = None
    namespaces = _cpconfig.NamespaceSet(**{'hooks': hooks_namespace, 'request': request_namespace, 
