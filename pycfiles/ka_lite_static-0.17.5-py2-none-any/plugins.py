...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/process/plugins.py
# Compiled at: 2018-07-11 18:15:31
"""Site services for use with a Web Site Process Bus."""
import os, re, signal as _signal, sys, time, threading
...
class SignalHandler(object):
    ...
    def __init__(self, bus):
        self.bus = bus
        self.handlers = {'SIGTERM': self.bus.exit, 'SIGHUP': self.handle_SIGHUP, 
           'SIGUSR1': self.bus.graceful}
        ...
        for signum, handler in self._previous_handlers.items():
            ...
            try:
                ...
                if our_handler is None:
                    self.bus.log('Restored old %s handler %r, but our handler was not registered.' % (
...
class DropPrivileges(SimplePlugin):
    ...
    umask = property(_get_umask, _set_umask, doc='The default permission mode for newly created files and\n        directories.\n\n        Usually expressed in octal format, for example, ``0644``.\n        Availability: Unix, Windows.\n        ')
