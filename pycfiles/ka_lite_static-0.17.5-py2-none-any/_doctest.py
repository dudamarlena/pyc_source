...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/test/_doctest.py
...
class DocTestCase(unittest.TestCase):
    ...
    def __init__(self, test, optionflags=0, setUp=None, tearDown=None, checker=None, runner=DocTestRunner):
    ...
    def runTest(self):
        ...
        runner = self._dt_runner(optionflags=optionflags, checker=self._dt_checker, verbose=False)
        try:
            runner.DIVIDER = '-' * 70
