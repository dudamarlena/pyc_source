...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/gis/gdal/prototypes/ds.py
...
from django.contrib.gis.gdal.prototypes.generation import const_string_output, double_output, geom_output, int_output, srs_output, void_output, voidptr_output
