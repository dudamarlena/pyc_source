...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/slimit/slimit/ast.py
...
class SetPropAssign(Node):
    ...
    def children(self):
        return [
         self.prop_name] + self.parameters + self.elements
...
class Try(Node):
    ...
    def children(self):
        return [
         self.statements] + [self.catch, self.fin]
...
class FuncBase(Node):
    ...
    def children(self):
        return [
         self.identifier] + self.parameters + self.elements
