...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/peewee/playhouse/sqlcipher_ext.py
...
class _SqlCipherDatabase(object):
    ...
    def _connect(self, database, **kwargs):
        ...
        if len(passphrase) < 8:
            raise ImproperlyConfigured('SqlCipherDatabase passphrase should be at least eight character long.')
        if kdf_iter and kdf_iter < 10000:
            raise ImproperlyConfigured('SqlCipherDatabase kdf_iter should be at least 10000.')
