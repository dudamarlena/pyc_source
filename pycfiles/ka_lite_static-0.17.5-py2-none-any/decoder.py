...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/pyasn1/pyasn1/codec/native/decoder.py
...
tagMap = {univ.Integer.tagSet: AbstractScalarDecoder(), 
   ...
   univ.Sequence.tagSet: SequenceOrSetDecoder(), 
   univ.Set.tagSet: SequenceOrSetDecoder(), 
...
typeMap = {univ.Integer.typeId: AbstractScalarDecoder(), 
