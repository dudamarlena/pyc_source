...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cpcompat_subprocess.py
...
import os, types, traceback, gc, signal, errno
try:
    set
except NameError:
...
if mswindows:
    import threading, msvcrt, _subprocess
