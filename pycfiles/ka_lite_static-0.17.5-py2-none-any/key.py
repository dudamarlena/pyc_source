...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/rsa/rsa/key.py
...
import rsa.prime, rsa.pem, rsa.common, rsa.randnum, rsa.core
...
def calculate_keys_custom_exponent(p, q, exponent):
    ...
    if exponent * d % phi_n != 1:
        raise ValueError('e (%d) and d (%d) are not mult. inv. modulo phi_n (%d)' % (
         exponent, d, phi_n))
    return (exponent, d)
