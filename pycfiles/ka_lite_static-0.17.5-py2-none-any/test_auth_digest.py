...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/test_auth_digest.py
...
class DigestAuthTest(helper.CPWebCase):
    ...
    def setup_server():
        ...
        conf = {'/digest': {'tools.auth_digest.on': True, 'tools.auth_digest.realm': 'localhost', 
