...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/gis/geos/mutable_list.py
...
class ListMixin(object):
    ...
    def __delitem__(self, index):
        ...
        newItems = (self._get_single_internal(i) for i in xrange(origLen) if i not in indexRange)
