...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/rsa/rsa/_version133.py
...
import base64, math, os, random, sys, types, zlib
from rsa._compat import byte
import warnings
warnings.warn('Insecure version of the RSA module is imported as %s, be careful' % __name__)
warnings.warn('This submodule is deprecated and will be completely removed as of version 4.0.', DeprecationWarning)
