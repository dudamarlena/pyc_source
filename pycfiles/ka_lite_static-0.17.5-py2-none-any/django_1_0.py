...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/South/south/hacks/django_1_0.py
...
class Hacks:
    ...
    def set_installed_apps(self, apps):
        ...
        """
        apps = list(apps)
        assert apps and isinstance(apps[0], string_types), 'The argument to set_installed_apps must be a list of strings.'
