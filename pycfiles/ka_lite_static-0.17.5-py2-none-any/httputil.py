...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/lib/httputil.py
...
def protocol_from_http(protocol_str):
    ...
    return (
     int(protocol_str[5]), int(protocol_str[7]))
...
class HeaderMap(CaseInsensitiveDict):
    ...
    def encode(cls, v):
        ...
        raise ValueError('Could not encode header part %r using any of the encodings %r.' % (
         v, cls.encodings))
