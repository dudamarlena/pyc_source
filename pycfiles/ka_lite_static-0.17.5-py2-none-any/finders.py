...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/staticfiles/finders.py
...
class FileSystemFinder(BaseFinder):
    ...
    def __init__(self, apps=None, *args, **kwargs):
        ...
        if not isinstance(settings.STATICFILES_DIRS, (list, tuple)):
            raise ImproperlyConfigured('Your STATICFILES_DIRS setting is not a tuple or list; perhaps you forgot a trailing comma?')
        for root in settings.STATICFILES_DIRS:
            ...
            if os.path.abspath(settings.STATIC_ROOT) == os.path.abspath(root):
                raise ImproperlyConfigured('The STATICFILES_DIRS setting should not contain the STATIC_ROOT setting')
