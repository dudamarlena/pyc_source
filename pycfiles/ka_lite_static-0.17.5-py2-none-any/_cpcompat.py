...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cpcompat.py
...
if sys.version_info >= (3, 0):
    ...
    def ntou(n, encoding='ISO-8859-1'):
        ...
        assert_native(n)
        if encoding == 'escape':
            return unicode(re.sub('\\\\u([0-9a-zA-Z]{4})', lambda m: unichr(int(m.group(1), 16)), n.decode('ISO-8859-1')))
        return n.decode(encoding)
