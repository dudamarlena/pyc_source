...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/lib/jsontools.py
...
def json_in(content_type=[
 ntou('application/json'), ntou('text/javascript')], force=True, debug=False, processor=json_processor):
