...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/lib/cpstats.py
    ...
    def record_stop(self, uriset=None, slow_queries=1.0, slow_queries_count=100, debug=False, **kwargs):
        ...
        if uriset:
            ...
            r = rs.setdefault(uriset, {'Min': None, 
               'Max': None, 'Count': 0, 'Sum': 0, 'Avg': average_uriset_time})
...
class StatsPage(object):
    ...
    pause.exposed = True
    pause.cp_config = {'tools.allow.on': True, 'tools.allow.methods': [
                             'POST']}
    ...
    resume.exposed = True
    resume.cp_config = {'tools.allow.on': True, 'tools.allow.methods': [
                             'POST']}