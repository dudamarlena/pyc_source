...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/test_session.py
# Compiled at: 2018-07-11 18:15:31
import os
localDir = os.path.dirname(__file__)
import sys, threading, time, cherrypy
...
def setup_server():
    ...
    class Root:
        _cp_config = {'tools.sessions.on': True, 'tools.sessions.storage_type': 'ram', 
        ...
        restricted._cp_config = {'tools.allow.on': True, 'tools.allow.methods': [
                                 'GET']}
        ...
        session_cookie._cp_config = {'tools.sessions.path': '/session_cookie', 
...
class SessionTest(helper.CPWebCase):
    ...
    def test_0_Session(self):
        ...
        self.assertEqual(set(cookie_parts.keys()), set(['session_id', 'expires', 'Path']))
    ...
    def test_6_regenerate(self):
        ...
        self.getPage('/testStr')
        id1 = self.cookies[0][1].split(';', 1)[0].split('=', 1)[1]
        self.getPage('/testStr', headers=[
         ('Cookie', 'session_id=maliciousid; expires=Sat, 27 Oct 2017 04:18:28 GMT; Path=/;')])
        id2 = self.cookies[0][1].split(';', 1)[0].split('=', 1)[1]
        self.assertNotEqual(id1, id2)
