...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/test/modfcgid.py
...
class ModFCGISupervisor(helper.LocalSupervisor):
    ...
    def start(self, modulename):
        cherrypy.server.httpserver = servers.FlupFCGIServer(application=cherrypy.tree, bindAddress=('127.0.0.1',
                                                                                                    4000))
