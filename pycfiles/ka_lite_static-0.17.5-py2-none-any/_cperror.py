...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/_cperror.py
...
class HTTPRedirect(CherryPyException):
    ...
    def set_response(self):
        ...
        if status in (300, 301, 302, 303, 307):
            ...
            msg = {300: 'This resource can be found at ', 
               301: 'This resource has permanently moved to ', 
               302: 'This resource resides temporarily at ', 
               303: 'This resource can be found at ', 
               307: 'This resource has moved temporarily to '}[status]
            msg += '<a href=%s>%s</a>.'
            ...
            for key in ('Allow', 'Content-Encoding', 'Content-Language', 'Content-Length',
    ...
    if error_page:
        try:
            if hasattr(error_page, '__call__'):
                ...
                if isinstance(result, cherrypy._cpcompat.unicodestr):
                    return result.encode('utf-8')
                if not isinstance(result, cherrypy._cpcompat.bytestr):
                    raise ValueError('error page function did not return a bytestring, unicodestring or an iterator - returned object of type %s.' % type(result).__name__)
                return result
            else:
...
_ie_friendly_error_sizes = {400: 512, 
   403: 256, 404: 512, 405: 256, 406: 512, 
   408: 512, 409: 512, 410: 256, 500: 512, 
   501: 512, 505: 512}
