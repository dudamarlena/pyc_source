...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/contrib/localflavor/id/id_choices.py
# Compiled at: 2018-07-11 18:15:30
import warnings
from django.utils.translation import ugettext_lazy as _
warnings.warn('There have been recent changes to the ID localflavor. See the release notes for details', RuntimeWarning)
PROVINCE_CHOICES = (
 (
  'ACE', _('Aceh')),
 (
