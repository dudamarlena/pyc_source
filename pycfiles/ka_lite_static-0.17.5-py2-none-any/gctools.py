...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/lib/gctools.py
# Compiled at: 2018-07-11 18:15:31
import gc, inspect, os, sys, time
try:
    import objgraph
except ImportError:
    objgraph = None
...
def get_context(obj):
    ...
    if isinstance(obj, _cprequest.Response):
        return 'status=%s' % obj.status
    if isinstance(obj, _cpwsgi.AppResponse):
        ...
        for cls, minobj, maxobj, msg in self.classes:
            ...
            if lenobj < minobj or lenobj > maxobj:
                ...
                for obj in objs:
                    if objgraph is not None:
                        ig = [
                         id(objs), id(inspect.currentframe())]
