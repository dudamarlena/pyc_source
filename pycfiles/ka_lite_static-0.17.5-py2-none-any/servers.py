...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/cherrypy/cherrypy/process/servers.py
...
def check_port(host, port, timeout=1.0):
    ...
    for res in info:
        ...
        try:
            ...
            raise IOError('Port %s is in use on %s; perhaps the previous httpserver did not shut down properly.' % (
             repr(port), repr(host)))
