...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django-tastypie-legacy/tastypie/south_migrations/0001_initial.py
    ...
    models = {'auth.group': {'Meta': {'object_name': 'Group'}, 'id': (
       ...
       'tastypie.apikey': {'Meta': {'object_name': 'ApiKey'}, 'created': (
                           ...
                           'id': (
                                'django.db.models.fields.AutoField', [], {'primary_key': 'True'}), 
                           'key': (
                                 'django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'blank': 'True'}), 
                           'user': (
