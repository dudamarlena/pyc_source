...
# [GCC 8.4.0]
# Embedded file name: /tmp/pip-install-jkXn_D/django/django/core/files/uploadedfile.py
...
class SimpleUploadedFile(InMemoryUploadedFile):
    ...
    def __init__(self, name, content, content_type='text/plain'):
        content = content or ''
        super(SimpleUploadedFile, self).__init__(BytesIO(content), None, name, content_type, len(content), None)
        return
