...
class RelatedMixin(object):
    ...
    def get_serializer_class(self):
        ...
        if 'related_field' in self.kwargs:
            ...
            assert False, 'Either "included_serializers" or "related_serializers" should be configured'
    ...
    def patch(self, request, *args, **kwargs):
        ...
        if isinstance(related_instance_or_manager, Manager):
            ...
            if hasattr(related_instance_or_manager, 'field'):
                related_instance_or_manager = self.remove_relationships(instance_manager=related_instance_or_manager, field='field')
            else:
                related_instance_or_manager = self.remove_relationships(instance_manager=related_instance_or_manager, field='target_field')
