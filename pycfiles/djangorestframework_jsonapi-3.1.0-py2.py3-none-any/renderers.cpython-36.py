            ...
            for field_name, field in iter(fields.items()):
                ...
                if isinstance(field, relations.HyperlinkedIdentityField):
                    ...
                    if isinstance(field, (ResourceRelatedField,)):
                        ...
                        data.update({field_name: relation_data})
                    elif isinstance(field, (relations.PrimaryKeyRelatedField, relations.HyperlinkedRelatedField)):
                    ...
                    if isinstance(field, ListSerializer):
                        ...
                        if serializer_data:
                            for position in range(len(serializer_data)):
                                ...
                                serializer_fields = utils.get_serializer_fields(serializer.__class__(nested_resource_instance,
    ...
    def build_json_resource_obj(cls, fields, resource, resource_instance, resource_name, force_type_resolution=False):
        ...
        if force_type_resolution:
            ...
            if api_settings.URL_FIELD_NAME in resource:
                if isinstance(fields[api_settings.URL_FIELD_NAME], relations.RelatedField):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        if isinstance(view, RelationshipView):
            ...
            if resource_name is None or resource_name is False:
                ...
                elif view.__class__ and view.__class__.__name__ == 'APIRoot':
