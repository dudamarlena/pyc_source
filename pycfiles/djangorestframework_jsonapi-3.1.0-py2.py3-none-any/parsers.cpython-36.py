...
# Compiled at: 2020-01-24 12:03:41
        ...
        if isinstance(view, RelationshipView):
            ...
            if request.method in ('PATCH', 'PUT'):
                ...
                if str(data.get('id')) != str(view.kwargs[lookup_url_kwarg]):
                    raise exceptions.Conflict("The resource object's id ({data_id}) does not match url's lookup id ({url_id})".format(data_id=(data.get('id')),
