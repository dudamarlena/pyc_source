...
# [GCC 8.4.0]
# Embedded file name: /Users/denny/project/picme/aiommy/build/lib/tests/test_middlewares.py
...
from aiommy.middlewares import auth_middleware, content_type_setter_middleware_factory, encode, logging_middeleware_factory, permissions_middleware
...
class MiddlewareTestCase(AioHTTPTestCase):
    ...
    def setUp(self):
        ...
        self.bearer_request = make_mocked_request('GET',
          '/',
