...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/tests/unit/block/identifier_test.py
...
class TestWithLoggerPatch(ScratchWithExecCtx):
    ...
    def invalid_block_id2(self):
        ...
        """
        bad_id = Token('invalid_block_id', Token.types.TEMPLATE, dummy_file_context)
