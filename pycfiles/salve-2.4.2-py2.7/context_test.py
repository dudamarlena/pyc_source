...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/tests/unit/context_test.py
...
def execctx_tostring():
    ...
    """
    ctx = context.ExecutionContext(startphase=context.ExecutionContext.phases.STARTUP)
