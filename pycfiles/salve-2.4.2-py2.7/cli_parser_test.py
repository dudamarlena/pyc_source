...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/tests/unit/cli/cli_parser_test.py
# Compiled at: 2015-11-14 16:26:10
import mock
from nose.tools import istest
import logging, salve
from salve.cli import parser, deploy
from tests.util import ensure_except, ensure_SystemExit_with_code, MockedGlobals
