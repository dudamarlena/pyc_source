...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/tests/system/failure_test.py
...
class TestWithScratchdir(system.RunScratchContainer):
    ...
    def missing_open_fails(self):
        ...
        self._check_errors('missing_open.manifest', [
         'PARSING [INFO] Beginning Tokenization of "{1}"',
         'PARSING [ERROR] {0}, line 5: Unexpected token: }} Expected ' + "['BLOCK_START', 'TEMPLATE'] instead."])
    ...
    def missing_identifier_fails(self):
        ...
        self._check_errors('missing_id.manifest', [
         'PARSING [INFO] Beginning Tokenization of "{1}"',
         'PARSING [ERROR] {0}, line 3: Unexpected token: {{ Expected ' + 'IDENTIFIER instead.'])
    ...
    def missing_value_fails(self):
        ...
        self._check_errors('missing_attr_val.manifest', [
         'PARSING [INFO] Beginning Tokenization of "{1}"',
         'PARSING [ERROR] {0}, line 5: Unexpected token: }} Expected ' + 'TEMPLATE instead.'])
    ...
    def double_open_fails(self):
        ...
        self._check_errors('double_open.manifest', [
         'PARSING [INFO] Beginning Tokenization of "{1}"',
         'PARSING [ERROR] {0}, line 3: Unexpected token: {{ Expected ' + "['BLOCK_END', 'IDENTIFIER'] instead."])
    ...
    def invalid_block_id_fails(self):
        ...
        self._check_errors('invalid_block_id.manifest', [
         ...
         'PARSING [INFO] {0}, line 3: Generating Block From Identifier ' + 'Token: Token(value=file,ty=IDENTIFIER,lineno=3,filename={0})',
         'PARSING [INFO] {0}, line 7: Generating Block From Identifier ' + 'Token: Token(value=invalid_block_id,ty=IDENTIFIER,lineno=7,' + 'filename={0})',
