...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-armv7l/egg/salve/action/modify/file_chmod.py
...
class FileChmodAction(ChmodAction):
    ...
    def __str__(self):
        return 'FileChmodAction(target=' + str(self.target) + ',mode=' + ('{0:o}').format(self.mode) + ',context=' + repr(self.file_context) + ')'
