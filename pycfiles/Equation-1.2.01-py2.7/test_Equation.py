...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\tests\test_Equation.py
...
class TestComplexEquation(unittest.TestCase):
    ...
    def testCall(self):
        for expr, value in [('-8-2j', complex(-8.0, -2.0)),
         (
          '-(8+2j)', complex(-8.0, -2.0)),
         (
          '- 8+2j', complex(-8.0, 2.0)),
         (
          '-8-2i', complex(-8.0, -2.0)),
         (
          '-(8+2i)', complex(-8.0, -2.0)),
         (
          '- 8+2i', complex(-8.0, 2.0)),
...
class TestFloorEquation(unittest.TestCase):
    ...
    def testCall(self):
        ...
        self.assertEqual(self.fn2(np.linspace(0, 1, 5)).tolist(), [2.0, 4.0, 2.0, 0.0, 1.0])
...
class TestCeilEquation(unittest.TestCase):
    ...
    def testCall(self):
        ...
        self.assertEqual(self.fn2(np.linspace(0, 1, 5)).tolist(), [2.0, 4.0, 3.0, 0.0, 2.0])
...
class TestRoundEquation(unittest.TestCase):
    ...
    def testCall(self):
        ...
        self.assertEqual(self.fn(1.5), 2)
        self.assertEqual(self.fn2(np.linspace(0, 1, 5)).tolist(), [2.0, 4.0, 2.0, 0.0, 2.0])
...
class TestNegEquation(unittest.TestCase):
    ...
    def testCall(self):
        ...
        self.assertEqual(self.fn(complex(6.0, 3.0)), complex(-6.0, -3.0))
