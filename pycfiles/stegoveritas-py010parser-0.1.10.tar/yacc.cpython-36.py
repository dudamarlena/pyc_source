...
# [GCC 8.4.0]
# Embedded file name: ../py010parser/ply/yacc.py
# Compiled at: 2019-04-24 09:45:01
# Size of source mod 2**32: 128492 bytes
__version__ = '3.4'
__tabversion__ = '3.2'
yaccdebug = 1
            ...
            for level, p in enumerate(self.prec):
                if not isinstance(p, (list, tuple)):
                    ...
                    if len(p) < 2:
                        ...
                        assoc = p[0]
                        isinstance(assoc, str) or self.log.error('precedence associativity must be a string')
                        self.error = 1
                        return
                for term in p[1:]:
