...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/rediscluster/cluster_client.py
# Compiled at: 2013-05-26 22:22:17
import binascii, redis
from redis._compat import b, iteritems, dictkeys, dictvalues, basestring, bytes
...
class StrictRedisCluster:
    ...
    """
    _read_keys = {'debug': 'debug', 
       'getbit': 'getbit', 'get': 'get', 
       'getrange': 'getrange', 'hget': 'hget', 'hgetall': 'hgetall', 
       'hkeys': 'hkeys', 'hlen': 'hlen', 'hmget': 'hmget', 'hvals': 'hvals', 
       'lindex': 'lindex', 'llen': 'llen', 'lrange': 'lrange', 
       'object': 'object', 'scard': 'scard', 
       'sismember': 'sismember', 'smembers': 'smembers', 'srandmember': 'srandmember', 
       'strlen': 'strlen', 'type': 'type', 'zcard': 'zcard', 
       'zcount': 'zcount', 'zrange': 'zrange', 'zrangebyscore': 'zrangebyscore', 'zrank': 'zrank', 
       'zrevrange': 'zrevrange', 'zrevrangebyscore': 'zrevrangebyscore', 'zrevrank': 'zrevrank', 
       'zscore': 'zscore', 'mget': 'mget', 
       'bitcount': 'bitcount', 'echo': 'echo', 'debug_object': 'debug_object', 'substr': 'substr', 
       'keys': 'keys', 'randomkey': 'randomkey'}
    _write_keys = {'append': 'append', 
       'blpop': 'blpop', 'brpop': 'brpop', 'brpoplpush': 'brpoplpush', 'decr': 'decr', 
       'decrby': 'decrby', 'del': 'del', 'exists': 'exists', 'hexists': 'hexists', 'expire': 'expire', 
       'expireat': 'expireat', 'pexpire': 'pexpire', 'pexpireat': 'pexpireat', 'getset': 'getset', 'hdel': 'hdel', 'hincrby': 'hincrby', 
       'hincrbyfloat': 'hincrbyfloat', 'hset': 'hset', 'hsetnx': 'hsetnx', 'hmset': 'hmset', 'incr': 'incr', 
       'incrby': 'incrby', 'incrbyfloat': 'incrbyfloat', 'linsert': 'linsert', 'lpop': 'lpop', 'lpush': 'lpush', 
       'lpushx': 'lpushx', 'lrem': 'lrem', 'lset': 'lset', 'ltrim': 'ltrim', 
       'move': 'move', 'bitop': 'bitop', 'persist': 'persist', 
       'publish': 'publish', 'psubscribe': 'psubscribe', 'punsubscribe': 'punsubscribe', 'rpop': 'rpop', 
       'rpoplpush': 'rpoplpush', 'rpush': 'rpush', 'rpushx': 'rpushx', 
       'sadd': 'sadd', 'sdiff': 'sdiff', 'sdiffstore': 'sdiffstore', 'set': 'set', 
       'setbit': 'setbit', 'setex': 'setex', 'setnx': 'setnx', 'setrange': 'setrange', 
       'sinter': 'sinter', 'sinterstore': 'sinterstore', 'smove': 'smove', 'sort': 'sort', 
       'spop': 'spop', 'srem': 'srem', 'subscribe': 'subscribe', 'sunion': 'sunion', 
       'sunionstore': 'sunionstore', 'unsubscribe': 'unsubscribe', 'unwatch': 'unwatch', 'watch': 'watch', 
       'zadd': 'zadd', 'zincrby': 'zincrby', 'zinterstore': 'zinterstore', 'zrem': 'zrem', 
       'zremrangebyrank': 'zremrangebyrank', 'zremrangebyscore': 'zremrangebyscore', 'zunionstore': 'zunionstore', 'mset': 'mset', 
       'msetnx': 'msetnx', 'rename': 'rename', 'renamenx': 'renamenx', 'del': 'del', 
       'delete': 'delete', 'ttl': 'ttl', 'pttl': 'pttl', 'flushall': 'flushall', 'flushdb': 'flushdb'}
    _dont_hash = {'auth': 'auth', 
       'monitor': 'monitor', 'quit': 'quit', 'shutdown': 'shutdown', 
       'slaveof': 'slaveof', 'slowlog': 'slowlog', 'sync': 'sync', 'discard': 'discard', 
       'exec': 'exec', 'multi': 'multi'}
    _tag_keys = {'mget': 'mget', 
       'rename': 'rename', 'renamenx': 'renamenx', 'mset': 'mset', 
       'msetnx': 'msetnx', 'brpoplpush': 'brpoplpush', 
       'rpoplpush': 'rpoplpush', 'sdiff': 'sdiff', 
       'sdiffstore': 'sdiffstore', 'sinter': 'sinter', 
       'sinterstore': 'sinterstore', 'sunion': 'sunion', 
       'sunionstore': 'sunionstore', 'smove': 'smove', 
       'zinterstore': 'zinterstore', 'zunionstore': 'zunionstore', 
       'sort': 'sort'}
    _loop_keys = {'keys': 'keys', 
       'dbsize': 'dbsize', 'save': 'save', 
       'bgsave': 'bgsave', 'bgrewriteaof': 'bgrewriteaof', 
       'dbsize': 'dbsize', 
       'info': 'info', 'lastsave': 'lastsave', 
       'ping': 'ping', 'flushall': 'flushall', 
       'flushdb': 'flushdb', 'sync': 'sync', 
       'config_set': 'config_set', 
       'config_get': 'config_get', 'time': 'time', 
       'client_list': 'client_list'}
    _loop_keys_admin = {'save': 'save', 
       'bgsave': 'bgsave', 'bgrewriteaof': 'bgrewriteaof', 
       'info': 'info', 
       'lastsave': 'lastsave', 
       'ping': 'ping', 'flushall': 'flushall', 
    ...
    def __init__(self, cluster={}, db=0):
        ...
        self.no_servers = len(self.cluster['master_of']) if 'master_of' in self.cluster else len(self.cluster['nodes'])
        self.redises = {}
        redises_cons = {}
        self.cluster['slaves'] = {}
        for alias, server in iteritems(self.cluster['nodes']):
            if 'master_of' in self.cluster and alias not in self.cluster['master_of']:
                continue
            server_str = str(server)
            if server_str in redises_cons:
                self.redises[alias] = redises_cons[server_str]['master']
                self.redises[alias + '_slave'] = redises_cons[server_str]['slave']
                self.cluster['slaves'][alias + '_slave'] = redises_cons[server_str]['slave_node']
            else:
                try:
                    self.__redis = redis.StrictRedis(db=db, **server)
                    info = self.__redis.info()
                    if info['role'] != 'master':
                        raise redis.DataError('rediscluster: server %s is not a master.' % (server,))
                    ...
                    if 'connected_slaves' in info and info['connected_slaves'] > 0:
                        slave_host, slave_port, slave_online = info['slave0'].split(',')
                        if slave_online == 'online':
                            try:
                                ...
                                self.cluster['slaves'][alias + '_slave'] = {'host': slave_host, 
                                   'port': slave_port}
                                redises_cons[server_str]['slave'] = self.redises[(alias + '_slave')]
    ...
    def _getnodenamefor(self, name):
        ...
        return 'node_' + str(abs(binascii.crc32(b(name)) & 4294967295) % self.no_servers + 1)
