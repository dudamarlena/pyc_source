...
# [GCC 8.4.0]
# Embedded file name: /Users/jrief/Workspace/virtualenvs/gfg/src/cmsplugin-text-wrapper/cmsplugin_text_wrapper/migrations/0003_add_field_textwrapper_classes.py
# Compiled at: 2013-07-25 09:16:40
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('cmsplugin_text', 'classes', self.gf('cmsplugin_text_wrapper.fields.MultiSelectField')(max_length=250, null=True, blank=True), keep_default=False)
    ...
    models = {'cms.cmsplugin': {'Meta': {'object_name': 'CMSPlugin'}, 'changed_date': (
       ...
       'cmsplugin_text_wrapper.textwrapper': {'Meta': {'object_name': 'TextWrapper', 'db_table': "'cmsplugin_text'"}, 'body': (
                                              ...
                                              'classes': (
                                                        'cmsplugin_text_wrapper.fields.MultiSelectField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}), 
                                              'cmsplugin_ptr': (
