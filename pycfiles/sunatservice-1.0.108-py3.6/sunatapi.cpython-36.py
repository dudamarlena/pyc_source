...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/sunatservice/sunatapi.py
# Compiled at: 2020-01-18 14:06:03
# Size of source mod 2**32: 13616 bytes
                    ...
                    for getStatusResponse in Body.iter('{http://service.sunat.gob.pe}getStatusResponse'):
                        for status in getStatusResponse.iter('status'):
                            ...
                            if len(content.text) > 20:
                                ...
                                responseZipFile.write(base64.b64decode(zipped.encode('ascii')))
