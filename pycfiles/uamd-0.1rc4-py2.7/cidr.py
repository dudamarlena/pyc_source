...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-i686/egg/uamd/cidr.py
...
class CIDR(object):
    ...
    def __contains__(self, x):
        """whether the cidr contain the IP"""
...
class Loader(object):
    """CIDR loader base class. subclass must override :meth:`get` method."""

    def get(self, carrier):
        """get cidr via carrier. subclass must override this method.
    ...
    def fetch(self, carrier):
        """fetch CIDR via carrier from Internet.
...
class DefaultLoader(Loader):
    ...
    def get(self, carrier):
        """get cidr via carrier from instance cache or internet
