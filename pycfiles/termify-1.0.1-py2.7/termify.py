...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.13-intel/egg/src/termify.py
# Compiled at: 2017-11-04 13:46:04
...
service_language = {'en': [
   ...
   'es': [
        'lyrics/', '/translation/spanish'], 
   'it': [
        'it/testo/', '/traduzione/italiano'], 
   'fr': [
        'fr/paroles/', '/traduction/francais'], 
   'jp': [
        'ja/lyrics/', '/translation/japanese'], 
   'de': [
        'de/songtext/', '/ubersetzung/deutsche'], 
   'ko': [
        'ko/lyrics/', '/translation/korean'], 
   'pt': [
        'pt/letras/', '/traducao/portugues'], 
   'pt-br': [
           'pt-br/letras/', '/traducao/portugues']}
