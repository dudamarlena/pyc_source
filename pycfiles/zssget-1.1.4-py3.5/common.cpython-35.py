...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\zssget\common.py
# Compiled at: 2016-07-24 01:54:27
# Size of source mod 2**32: 2675 bytes
import logging, socket, os, time, sys
...
class SimpleProgressBar:
    ...
    def update_received(self, n):
        ...
        if bytes_ps >= 1073741824:
            self.speed = '{:4.0f} GB/s'.format(bytes_ps / 1073741824)
        else:
            if bytes_ps >= 1048576:
