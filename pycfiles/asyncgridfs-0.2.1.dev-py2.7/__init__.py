...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-intel/egg/asyncgridfs/__init__.py
# Compiled at: 2014-05-16 22:09:09
"""
...
class GridIn(object):
    ...
    def __flush_data(self, data):
        ...
        chunk = {'files_id': self._file['_id'], 'n': self._chunk_number, 
           'data': Binary(data)}
