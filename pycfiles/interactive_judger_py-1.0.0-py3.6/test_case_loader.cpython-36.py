...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/interactive_judger/test_case_loader.py
# Compiled at: 2018-08-03 00:41:16
# Size of source mod 2**32: 4331 bytes
import contextlib

class _Reader:
    __slots__ = [
     'data', 'cursor', 'end', 'line_number']
