...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-intel/egg/interactive_judger/tester.py
# Compiled at: 2018-08-03 01:01:46
# Size of source mod 2**32: 2623 bytes
import importlib, signal, os, sys
...
class Tester:
    __slots__ = [
     'program_name', 'method_name', 'precision_resolver', 'judge_method',
     'time_limit', 'src_path']

    def __init__(self):
        pass

    def __init__(self, program_name: str, src_path: str, method_name: str, time_limit=10, precision_resolver=None, judger=equality_judger):
    ...
    def run_test(self, test_data: tuple, expected_answer):
        if test_data:
            if expected_answer is not None and self.program_name is not None:
