...
# [GCC 8.4.0]
# Embedded file name: /Library/Python/2.7/site-packages/redis_cache/test_rediscache.py
...
class SimpleCacheTest(TestCase):
    ...
    def test_decorator_do_not_cache(self):
        ...
        r3 = test_no_cache(30)
        r4 = test_no_cache(20)
        self.assertEqual(r1, 200)
        self.assertEqual(r2, 100)
        self.assertEqual(r3, 300)
        self.assertEqual(r4, 200)
