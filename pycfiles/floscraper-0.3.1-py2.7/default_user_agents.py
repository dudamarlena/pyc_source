...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\floscraper\default_user_agents.py
# Compiled at: 2017-10-05 19:07:44
"""
...
__version__ = '0.1.1'
__date__ = '2017-10-06'
default_user_agents = {'browser': {'keith': 'Mozilla/5.0 (compatible; KeithScraper/0.1)', 
               ...
               'chrome_v33': 'Mozilla/5.0 ({}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.152 Safari/537.36', 
               'chrome_v41': 'Mozilla/5.0 ({}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36', 
               'chrome_v47': 'Mozilla/5.0 ({}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.0 Safari/537.36', 
               'safari_v7_0_2': 'Mozilla/5.0 ({}) AppleWebKit/537.74.9 (KHTML, like Gecko) Version/7.0.2 Safari/537.74.9', 
               'safari_v7_0_3': 'Mozilla/5.0 ({}) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A', 
               'opera_v20': 'Mozilla/5.0 ({}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.154 Safari/537.36 OPR/20.0.1387.82', 
               'googlebot_v2_1': 'Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)', 
               'archive.org_bot': 'Mozilla/5.0 (compatible; archive.org_bot +http://www.archive.org/details/archive.org_bot)'}, 
   'os': {'linux_x86_64': 'X11; Linux x86_64', 
