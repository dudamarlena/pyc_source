...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\atomia_client\atomia_entities.py
# Compiled at: 2012-04-23 09:42:19


class AtomiaAccount(object):

    def __init__(self, account_id=None, account_description=None, current_request_id=None, account_properties=None, is_active=None, provisioning_description=None):
    ...
    def to_xml_friendly_object(self, xml_tag_with_namespace=None, xml_tag=None):
        ...
        if self.account_description is not None:
            xml_friendly['account_description'] = {'xml_tag_with_namespace': 'atom:AccountDescription', 'xml_tag': 'AccountDescription', 'value': self.account_description, 
               'order': 1}
        if self.account_id is not None:
            xml_friendly['account_id'] = {'xml_tag_with_namespace': 'atom:AccountId', 'xml_tag': 'AccountId', 'value': self.account_id, 
               'order': 2}
        if self.current_request_id is not None:
            xml_friendly['current_request_id'] = {'xml_tag_with_namespace': 'atom:CurrentRequestId', 'xml_tag': 'CurrentRequestId', 'value': self.current_request_id, 
               'order': 4}
        if self.is_active is not None:
            xml_friendly['is_active'] = {'xml_tag_with_namespace': 'atom:IsActive', 'xml_tag': 'IsActive', 'value': self.is_active, 
               'order': 5}
        if self.provisioning_description is not None:
            xml_friendly['provisioning_description'] = {'xml_tag_with_namespace': 'atom:ProvisioningDescription', 'xml_tag': 'ProvisioningDescription', 'value': self.provisioning_description, 
               'order': 6}
        if self.account_properties is not None and len(self.account_properties) > 0:
            ...
            xml_friendly['account_properties'] = {'xml_tag_with_namespace': 'atom:AccountProperties', 'xml_tag': 'AccountProperties', 
...
class AtomiaAccountProperty(object):
    ...
    def to_xml_friendly_object(self, xml_tag_with_namespace, xml_tag):
        ...
        if self.key is not None:
            xml_friendly['key'] = {'xml_tag_with_namespace': 'arr:Key', 'xml_tag': 'Key', 'value': self.key, 
               'order': 1}
        if self.value is not None:
            xml_friendly['value'] = {'xml_tag_with_namespace': 'arr:Value', 'xml_tag': 'Value', 'value': self.value, 
               'order': 2}
        return xml_friendly
...
class AtomiaPackage(object):
    ...
    def to_xml_friendly_object(self, xml_tag_with_namespace=None, xml_tag=None):
        ...
        if self.disable_script_name is not None:
            xml_friendly['disable_script_name'] = {'xml_tag_with_namespace': 'atom:DisableScriptName', 'xml_tag': 'DisableScriptName', 'value': self.disable_script_name, 
               'order': 2}
        if self.package_id is not None:
            xml_friendly['package_id'] = {'xml_tag_with_namespace': 'atom:ID', 'xml_tag': 'ID', 'value': self.package_id, 
               'order': 3}
        if self.package_name is not None:
            xml_friendly['package_name'] = {'xml_tag_with_namespace': 'atom:Name', 'xml_tag': 'Name', 'value': self.package_name, 
               'order': 4}
        xml_friendly['package_extensions'] = {'xml_tag_with_namespace': 'atom:PackageExtensions', 'xml_tag': 'PackageExtensions', 
           'value': '', 
           'order': 5}
        return xml_friendly
...
class AtomiaService(object):
    ...
    def __init__(self, account_owner_id=None, current_request_id=None, status=None, disabled=None, friendly_name=None, logical_id=None, name=None, physical_id=None, properties=[], provisioning_description=None, parent=None, show_simple_props=False):
    ...
    def to_xml_friendly_object(self, xml_tag_with_namespace=None, xml_tag=None):
        ...
        if self.logical_id is not None:
            xml_friendly['logical_id'] = {'xml_tag_with_namespace': 'atom:logicalId', 'xml_tag': 'logicalId', 'value': self.logical_id, 
               'order': 6}
        if self.account_owner_id is not None:
            xml_friendly['account_owner_id'] = {'xml_tag_with_namespace': 'atom:AccountOwnerId', 'xml_tag': 'AccountOwnerId', 'value': self.account_owner_id, 
               'order': 0}
        if self.physical_id is not None:
            xml_friendly['physical_id'] = {'xml_tag_with_namespace': 'atom:physicalId', 'xml_tag': 'physicalId', 'value': self.physical_id, 
               'order': 8}
        if self.current_request_id is not None:
            xml_friendly['current_request_id'] = {'xml_tag_with_namespace': 'atom:CurrentRequestId', 'xml_tag': 'CurrentRequestId', 'value': self.current_request_id, 
               'order': 1}
        if self.status is not None:
            xml_friendly['status'] = {'xml_tag_with_namespace': 'atom:Status', 'xml_tag': 'Status', 'value': self.status, 
               'order': 3}
        if self.disabled is not None:
            xml_friendly['disabled'] = {'xml_tag_with_namespace': 'atom:disabled', 'xml_tag': 'disabled', 'value': self.disabled, 
               'order': 4}
        if self.friendly_name is not None:
            xml_friendly['friendly_name'] = {'xml_tag_with_namespace': 'atom:friendlyName', 'xml_tag': 'friendlyName', 'value': self.friendly_name, 
               'order': 5}
        if self.name is not None:
            xml_friendly['name'] = {'xml_tag_with_namespace': 'atom:name', 'xml_tag': 'name', 'value': self.name, 
               'order': 7}
        if self.properties is not None and len(self.properties) > 0:
            ...
            xml_friendly['properties'] = {'xml_tag_with_namespace': 'atom:properties', 'xml_tag': 'properties', 
               'value': properties_list, 
               'order': 9}
        else:
            xml_friendly['properties'] = {'xml_tag_with_namespace': 'atom:properties', 'xml_tag': 'properties', 
        ...
        if self.provisioning_description is not None:
            xml_friendly['provisioning_description'] = {'xml_tag_with_namespace': 'atom:provisioningDescription', 'xml_tag': 'provisioningDescription', 'value': self.provisioning_description, 
               'order': 10}
        xml_friendly['parent'] = {'xml_tag_with_namespace': 'atom:Parent', 'xml_tag': 'Parent', 
           'value': '', 
           'order': 2}
        return xml_friendly
    ...
    def update_property(self, name, newvalue):
        for prop in self.properties:
            if prop.name == name:
                prop.prop_string_value = newvalue
                if self.simple_properties is not None:
                    self.simple_properties[prop.name] = prop.prop_string_value
                return
    ...
    def add_property(self, name, value):
        ...
        prop = AtomiaServiceProperty(name=name, prop_string_value=value)
...
class AtomiaServiceSearchCriteria(object):
    ...
    def to_xml_friendly_object(self, xml_tag_with_namespace, xml_tag):
        ...
        if self.service_name is not None:
            xml_friendly['service_name'] = {'xml_tag_with_namespace': 'atom:ServiceName', 'xml_tag': 'ServiceName', 'value': self.service_name, 
               'order': 1}
        if self.service_path is not None:
            xml_friendly['service_path'] = {'xml_tag_with_namespace': 'atom:ServicePath', 'xml_tag': 'ServicePath', 'value': self.service_path, 
               'order': 2}
        if self.parent_service is not None:
            xml_friendly['parent_service'] = {'xml_tag_with_namespace': 'atom:ParentService', 'xml_tag': 'ParentService', 'value': self.parent_service.to_xml_friendly_object('atom:ParentService', 'ParentService'), 
               'order': 0}
        return xml_friendly
...
class AtomiaServiceProperty(object):
    ...
    def to_xml_friendly_object(self, xml_tag_with_namespace, xml_tag):
        ...
        if self.id is not None:
            xml_friendly['id'] = {'xml_tag_with_namespace': 'atom:ID', 'xml_tag': 'ID', 'value': self.id, 
               'order': 1}
        if self.is_key is not None:
            xml_friendly['is_key'] = {'xml_tag_with_namespace': 'atom:IsKey', 'xml_tag': 'IsKey', 'value': self.is_key, 
               'order': 2}
        if self.name is not None:
            xml_friendly['name'] = {'xml_tag_with_namespace': 'atom:Name', 'xml_tag': 'Name', 'value': self.name, 
               'order': 3}
        if self.property_type is not None:
            xml_friendly['property_type'] = {'xml_tag_with_namespace': 'atom:PropertyType', 'xml_tag': 'PropertyType', 'value': self.property_type, 
               'order': 4}
        if self.prop_string_value is not None:
            xml_friendly['prop_string_value'] = {'xml_tag_with_namespace': 'atom:propStringValue', 'xml_tag': 'propStringValue', 'value': self.prop_string_value, 
               'order': 5}
        return xml_friendly
