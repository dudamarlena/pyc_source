...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.10-x86_64/egg/ulutil/statstools.py
# Compiled at: 2014-12-19 21:47:30
import random, numpy as np, scipy as sp, scipy.stats, scipy.spatial
random.seed()
np.random.seed()
