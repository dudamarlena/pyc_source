...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/blink1py/blink1.py
# Compiled at: 2013-05-30 12:58:59
...
def open_blink1(id=None, serial=None, path=None):
    ...
    if not blink1:
        raise Blink1NotFoundError('blink(1) library could not find a blink(1) device')
