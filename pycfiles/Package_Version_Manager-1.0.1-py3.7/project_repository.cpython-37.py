...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/package_version_manager/project_repository.py
# Compiled at: 2020-04-11 12:51:34
# Size of source mod 2**32: 4927 bytes
import re
from os.path import join, isfile, sep
from git import Repo
from logging import getLogger
from package_version_manager.constants import CHANGELOG_FILE, VERSION_REGEX, VERSION_CONSTANT_FILE, VERSION_CONSTANT, README_FILE, VERSION_COMMIT_PREFIX, VERSION_BRANCH_PREFIX, REMOTE_NAME
        ...
        if isfile(file_path):
            with open(file_path, 'r+', encoding='utf-8') as (f):
                ...
                if to_replace_old in content and to_replace_new not in content:
                    ...
                    self.logger.warning(f"Previous version ({self.previous_version}) not found in {file_path}, version number can't be updated there. This might be normal if this file does not contain version in this form or has already been updated.")
        else:
