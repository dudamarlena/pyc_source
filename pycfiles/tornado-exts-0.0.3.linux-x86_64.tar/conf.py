...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/tornado_extensions/conf.py
# Compiled at: 2013-09-03 05:36:04
import importlib, simplejson as json
...
class Settings(BaseSettings):
    ...
    def read_cfg(self, cfg_file):
        ...
        assert cfg_file in parser.read(cfg_file), ('Could not find: {}').format(cfg_file)
    ...
    def read_json(self, json_file):
        ...
        assert isinstance(json_data, dict), ('Is not dictionary : {}').format(json_file)
