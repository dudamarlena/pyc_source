...
# Embedded file name: /home/giovanni/gitstuff/pyslurm/tests/test-node.py
# Compiled at: 2016-03-30 23:13:02
...
def test_node_scontrol():
    ...
    scontrol = subprocess.Popen(['scontrol', '-d', 'show', 'node', test_node], stdout=subprocess.PIPE).communicate()
