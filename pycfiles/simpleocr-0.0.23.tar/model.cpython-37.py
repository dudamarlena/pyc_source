...
# [GCC 8.4.0]
# Embedded file name: E:\cdc\Project\Snapnews\opensource\simpleocr\recognition\model.py
# Compiled at: 2020-05-01 04:02:49
# Size of source mod 2**32: 10199 bytes
import tensorflow as tf
from tensorflow.python.keras.layers import Dense, MaxPooling2D, Conv2D, Reshape, BatchNormalization, Layer
...
class VGGNetModel(Model):
    ...
    def __init__(self, output_size):
        ...
        self.block1_conv1 = Conv2D(64, (3, 3), activation='relu',
          padding='same',
          name='block1_conv1',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block1_conv2 = Conv2D(64, (3, 3), activation='relu',
          padding='same',
          name='block1_conv2',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        ...
        self.block2_conv1 = Conv2D(128, (3, 3), activation='relu',
          padding='same',
          name='block2_conv1',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block2_conv2 = Conv2D(128, (3, 3), activation='relu',
          padding='same',
          name='block2_conv2',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        ...
        self.block3_conv1 = Conv2D(256, (3, 3), activation='relu',
          padding='same',
          name='block3_conv1',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block3_conv2 = Conv2D(256, (3, 3), activation='relu',
          padding='same',
          name='block3_conv2',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block3_conv3 = Conv2D(256, (3, 3), activation='relu',
          padding='same',
          name='block3_conv3',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        ...
        self.block4_conv1 = Conv2D(512, (3, 3), activation='relu',
          padding='same',
          name='block4_conv1',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block4_conv2 = Conv2D(512, (3, 3), activation='relu',
          padding='same',
          name='block4_conv2',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block4_conv3 = Conv2D(512, (3, 3), activation='relu',
          padding='same',
          name='block4_conv3',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        ...
        self.blcok5_conv1 = Conv2D(512, (3, 3), activation='relu',
          padding='same',
          name='block5_conv1',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block5_conv2 = Conv2D(512, (3, 3), activation='relu',
          padding='same',
          name='block5_conv2',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        self.block5_conv3 = Conv2D(512, (3, 3), activation='relu',
          padding='same',
          name='block5_conv3',
          kernel_regularizer=(tf.keras.regularizers.l2()))
        ...
        self.prediction = Dense(units=output_size, kernel_initializer='he_normal', kernel_regularizer=(tf.keras.regularizers.l2()),
          name='prediction')
...
def decode_predict_ctc(out, charset):
    ...
    decoded = tf.nn.ctc_greedy_decoder(out, sequence_length=tf.cast((tf.ones(out.shape[1]) * out.shape[0]), dtype=(tf.int32)))[0]
    labels = [tf.sparse.to_dense(st, default_value=(-1)) for st in decoded][0]
