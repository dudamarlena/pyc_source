...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/marrow/util/convert.py
# Compiled at: 2012-10-11 17:41:43
"""Useful datatype converters."""
import re, collections, inspect
from marrow.util.compat import binary, unicode
__all__ = [
 'boolean', 'array', 'integer', 'number', 'KeywordProcessor', 'tags', 'terms']
    ...
    def join(self, values):
        ...
        if self.group is dict:
            if not isinstance(values, dict):
                raise ValueError('Dictionary grouped values must be passed as a dictionary.')
