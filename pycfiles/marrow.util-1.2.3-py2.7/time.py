...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.8-intel/egg/marrow/util/time.py
# Compiled at: 2012-07-26 02:07:58
from datetime import timedelta, tzinfo
__all__ = [
 'UTC', 'delta_to_seconds',
 'day', 'week', 'hour', 'minute', 'second', 'month', 'yearminute_range',
 'hour_range', 'dom_range', 'month_range', 'dow_range',
 'map_month', 'map_dow']
