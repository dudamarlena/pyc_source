...
# Compiled at: 2020-05-12 08:42:30
# Size of source mod 2**32: 17399 bytes
"""
...
class PAMAuthcReq(PAMRequest):
    ...
    def _cache_key(self):
        key_bytes = repr([(
         key, self._params[key]) for key in sorted(self._params.keys()) if key in CFG.pam_authc_cache_attrs]).encode('ascii')
        self._log(logging.DEBUG, 'key_bytes = %r', key_bytes)
