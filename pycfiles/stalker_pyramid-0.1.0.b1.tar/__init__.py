...
# [GCC 8.4.0]
# Embedded file name: /home/eoyilmaz/Documents/development/stalker_pyramid/stalker_pyramid/stalker_pyramid/__init__.py
# Compiled at: 2013-06-18 15:58:44
"""
...
def main(global_config, **settings):
    ...
    db.setup(settings)
    authn_policy = AuthTktAuthenticationPolicy('sosecret', hashalg='sha512', callback=group_finder)
    authz_policy = ACLAuthorizationPolicy()
    config = Configurator(settings=settings, root_factory='stalker.models.auth.RootFactory')
    ...
    config.add_route('serve_files', defaults.server_side_storage_path + '/{partial_file_path:[a-zA-Z0-9/\\.]+}')
    ...
    config.add_route('get_root_tasks', 'get/root/tasks/{project_id}')
    config.add_route('get_gantt_tasks', 'get/gantt/tasks/{entity_id}')
    config.add_route('auto_schedule_tasks', 'auto_schedule_tasks')
    config.add_route('view_task_nav_bar', 'view/task_nav_bar/{entity_id}')
    ...
    config.add_route('get_time_logs', 'get/time_logs/{entity_id}')
    config.add_route('list_time_logs', 'list/time_logs/{entity_id}')
    config.add_route('dialog_create_ticket', 'dialog/create/ticket/{entity_id}')
    config.add_route('dialog_update_ticket', 'dialog/update/ticket/{ticket_id}')
    ...
    config.add_route('get_tickets', 'get/tickets/{entity_id}')
    config.add_route('list_tickets', 'list/tickets/{entity_id}')
    config.add_route('dialog_create_vacation', 'dialog/create/vacation/{user_id}')
    config.add_route('dialog_update_vacation', 'dialog/update/vacation/{vacation_id}')
    config.add_route('create_vacation', 'create/vacation')
    config.add_route('update_vacation', 'update/vacation')
    config.add_route('get_vacations', 'get/vacations/{user_id}')
    config.add_route('list_vacations', 'list/vacations/{user_id}')
    config.add_route('dialog_create_version', 'dialog/create/version/{task_id}')
    config.add_route('dialog_update_version', 'dialog/update/version/{version_id}')
    ...
    config.add_route('get_versions', 'get/versions/{task_id}')
    config.add_route('list_versions', 'list/versions/{task_id}')
    config.add_route('list_version_outputs', 'list/version/outputs/{version_id}')
    config.add_route('list_version_inputs', 'list/version/inputs/{version_id}')
    config.add_route('list_version_children', 'list/version/children/{version_id}')
