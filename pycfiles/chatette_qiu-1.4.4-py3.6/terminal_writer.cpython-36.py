...
class TerminalWriter(object):
    __doc__ = 'Wrapper of `print` that can write to stdout or to a file.'
    ...
    def get_redirection(self):
        ...
        if self._file_mode is None:
            ...
            if self._file_mode == 'a+':
                return (
                 RedirectionType.append, self.redirection_file_path)
            if self._file_mode == 'w+':
                return (
                 RedirectionType.truncate, self.redirection_file_path)
