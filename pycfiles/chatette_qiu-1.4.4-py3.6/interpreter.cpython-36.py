...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win-amd64\egg\chatette_qiu\cli\interpreter.py
# Compiled at: 2019-03-27 03:00:31
# Size of source mod 2**32: 6462 bytes
"""
Module `chatette_qiu.cli`
...
from chatette_qiu.cli.interactive_commands import exit_command, stats_command, parse_command, exist_command, rename_command, delete_command, examples_command, hide_command, unhide_command, execute_command, show_command, rule_command, generate_command, add_rule_command, declare_command, set_modifier_command, save_command
...
class CommandLineInterpreter(object):
    ...
    def __init__(self, facade, commands_file_path):
        ...
        if commands_file_path is not None:
            self._dont_enter_interactive_mode = self._execute_commands_file(commands_file_path)
        else:
