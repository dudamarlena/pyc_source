...
# [GCC 8.4.0]
# Embedded file name: /Users/daniel_lamotte/sandbox/krankshaft/krankshaft/authz.py
# Compiled at: 2014-03-12 16:24:23
    ...
    def is_authorized_object(self, request, authned, obj):
        if self.perms:
            ...
            if method in self.methods_read:
                ...
                if method in self.methods_create:
...
class AuthzDjangoAnonRead(AuthzDjango):
    ...
    def is_authorized_object_forward(self, request, authned, obj):
        if request.method.lower() in self.methods_read:
            ...
            return super(AuthzDjangoAnonRead, self).is_authorized_object_forward(request, authned, obj)
...
class AuthzReadonly(Authz):
    ...
    def is_authorized_request(self, request, authned):
        return super(AuthzReadonly, self).is_authorized_request(request, authned) and request.method.lower() in self.methods_read
