...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/adminbrowse/related.py
# Compiled at: 2010-12-02 17:52:35
from django.contrib import admin
from django.utils.text import force_unicode
from django.utils.translation import ugettext as _
from django.db.models import FieldDoesNotExist
from django.core.urlresolvers import reverse
from adminbrowse.base import ChangeListModelFieldColumn, ChangeListTemplateColumn
...
class ChangeLink(ChangeListTemplateColumn, ChangeListModelFieldColumn):
    ...
    def __init__(self, model, name, short_description=None, default='', template_name=None, extra_context=None):
        ChangeListTemplateColumn.__init__(self, short_description, template_name or self.template_name, extra_context, name)
    ...
    def get_context(self, obj):
        ...
        if value is not None:
            ...
            url = title = None
        context = {'column': self, 'object': obj, 'value': value, 'url': url, 'title': title}
...
class ChangeListLink(ChangeListTemplateColumn, ChangeListModelFieldColumn):
    ...
    def __init__(self, model, name, short_description=None, text=len, default='', template_name=None, extra_context=None):
    ...
    def get_context(self, obj):
        ...
        if text:
            ...
            url = title = None
        context = {'column': self, 'object': obj, 'value': value, 'text': text, 'url': url, 'title': title}
        context.update(self.extra_context)
        return context
    ...
    def get_title(self, obj, value):
        strings = {'related_verbose_name_plural': self.to_opts.verbose_name_plural, 
           'object_verbose_name': self.opts.verbose_name if self.m2m else self.field.verbose_name}
        return _('List %(related_verbose_name_plural)s with this %(object_verbose_name)s') % strings
