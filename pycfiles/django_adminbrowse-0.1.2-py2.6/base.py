...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/adminbrowse/base.py
# Compiled at: 2010-12-02 17:51:08
...
class ChangeListTemplateColumn(ChangeListColumn):
    ...
    def __init__(self, short_description, template_name=None, extra_context=None, admin_order_field=None):
...
class ChangeListModelFieldColumn(ChangeListColumn):
    ...
    def __init__(self, model, name, short_description=None, default=''):
        ...
        try:
            (field, model_, self.direct, self.m2m) = model._meta.get_field_by_name(name)
