...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.6-universal/egg/adminbrowse/columns.py
# Compiled at: 2010-12-02 17:52:54
...
class URLColumn(ChangeListModelFieldColumn):
    ...
    def __init__(self, model, name, short_description=None, default='', target='_blank', classes='external'):
...
class TruncatedFieldColumn(ChangeListModelFieldColumn):
    ...
    def __init__(self, model, name, max_length, short_description=None, default='', tail='…'):
        ChangeListModelFieldColumn.__init__(self, model, name, short_description, default)
