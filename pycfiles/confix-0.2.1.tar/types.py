...
# Embedded file name: build/bdist.linux-x86_64/egg/confiture/schema/types.py
# Compiled at: 2016-10-12 14:42:14
__doc__ = ' Builtin types of confiture.schema\n'
import re, sys, numbers, socket, os.path
