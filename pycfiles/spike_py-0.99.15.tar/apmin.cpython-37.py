...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/plugins/apmin.py
...
def neg_wing(d, bcorr=False, inwater=False, apt=False):
    ...
    if bcorr:
        ...
        if not bcorr:
            wind = [
             int(0.05 * lendata), int(0.95 * lendata)]
    ...
    while abs(P0step) >= 1.0:
        ...
        while moved:
            ...
            if first_order:
                PPlist = (
                 (
                  P0step, 0), (-P0step, 0), (0, P1step), (0, -P1step))
            else:
                PPlist = (
                 (
                  P0step, 0), (-P0step, 0))
            for dP0, dP1 in PPlist:
                ...
                if debug:
                    print(' %.2f %.2f %g' % (P0min + dP0, P1min + dP1, pw))
                if pw < valmin:
                    moved = 1
                    valmin = pw
                    P0minnext = P0min + dP0
