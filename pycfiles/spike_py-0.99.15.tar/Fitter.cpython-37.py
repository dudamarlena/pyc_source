...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/plugins/Fitter.py
# Compiled at: 2020-01-30 08:38:13
...
import numpy as np, unittest, scipy
...
class FitTests(unittest.TestCase):
    ...
    def test_fit1d(self):
        ...
        d.fit()
        self.assertAlmostEqual((d.peaks.chi2), 15.0445981291, places=2)
        d.pp(threshold=1000)
        d.centroid()
        d.fit(zoom=(140, 200))
        self.assertAlmostEqual((d.peaks.chi2), 12.4304236435, places=1)
        self.assertAlmostEqual((sum(list(d.peaks.pos))), 517.7481723724663, places=2)
