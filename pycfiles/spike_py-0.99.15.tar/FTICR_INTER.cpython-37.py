...
# [GCC 8.4.0]
# Embedded file name: /home/mad/Documents/spike/spike/Interactive/FTICR_INTER.py
# Compiled at: 2019-11-01 14:17:57
# Size of source mod 2**32: 28084 bytes
"""
...
class MR_interact(MR):
    ...
    def zoom_box(self):
        ...
        self.z1l = wf(value=(self._zoom[0]), min=(ref.axis1.lowmass), max=(ref.highmass[0]), description='F1:',
          style=style,
          layout=lay)
        self.z1h = wf(value=(self._zoom[1]), min=(ref.axis1.lowmass), max=(ref.highmass[0]), description='..',
          style=style,
          layout=lay)
        self.z2l = wf(value=(self._zoom[2]), min=(ref.axis2.lowmass), max=(ref.highmass[1]), description='F2:',
          style=style,
          layout=lay)
        self.z2h = wf(value=(self._zoom[3]), min=(ref.axis2.lowmass), max=(ref.highmass[1]), description='..',
          style=style,
          layout=lay)
    ...
    def show(self):
        ...
        spacer = HTML('&nbsp;&nbsp;&nbsp;&nbsp;')
        zbox = self.zoom_box()
        display(HBox([zmbox1, zmbox2, zmbox3, spacer, zmbox4, spacer, zbox], layout=Layout(height='100px')))
        self.update()
        self.display()
    ...
    def display(self, zoom=None, scale=None, redraw=None):
        ...
        self.check_fig()
        self.pltaxe.clear()
        datasel.display(zoom=zz, scale=(self.scale), absmax=(self.absmax), xlabel='F2    m/z',
          ylabel='F1    m/z',
          show=False,
          figure=(self.pltaxe),
          new_fig=nf)
...
class MSPeaker(object):
    ...
    def __init__(self, npkd, pkname):
        ...
        self.thresh = widgets.FloatLogSlider(value=20.0, min=(np.log10(3)),
          max=2.0,
          base=10,
          step=0.01,
