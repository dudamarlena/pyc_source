...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/core/dialog.py
# Compiled at: 2020-05-03 00:26:03
# Size of source mod 2**32: 39527 bytes
"""
...
class Dialog(QDialog, object):
    ...
    def set_resize_directions(self):
        ...
        self._bottom_right_resizer.set_resize_direction(resizers.ResizeDirection.Right | resizers.ResizeDirection.Bottom)
    ...
    def get_resizers_height(self):
        ...
        """
        resizers = [
         self._top_resizer, self._bottom_resizer]
        total_height = 0
        for r in resizers:
            if not r.isHidden():
    ...
    def get_resizers_width(self):
        ...
        """
        resizers = [
         self._left_resizer, self._right_resizer]
        total_width = 0
        for r in resizers:
            if not r.isHidden():
...
class ColorDialog(Dialog, object):
    ...
    maya_colors = [
     (0.467, 0.467, 0.467), (0.0, 0.0, 0.0), (0.247, 0.247, 0.247), (0.498, 0.498, 0.498), (0.608, 0, 0.157),
...
class SelectFolderDialog(BaseFileFolderDialog, object):
    ...
    def __init__(self, name='SelectFolder', title='Select Folder', size=(200, 125), fixed_size=False, frame_less=True, hide_title=False, use_app_browser=False, parent=None, **kwargs):
        ...
        (super(SelectFolderDialog, self).__init__)(name=name, 
         title=title, size=size, fixed_size=fixed_size, frame_less=frame_less, hide_title=hide_title, use_app_browser=use_app_browser, 
