...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/core/animation.py
...
class BaseAnimObject(object):
    ...
    for index in range(1, 11):
        _glow_pens[index] = [
         QPen(QColor(0, 255, 0, 12 * index), 1, Qt.SolidLine),
...
def property_animation(start=[
 0, 0], end=[30, 0], duration=300, object=None, property='iconSize', on_finished=None):
    """
