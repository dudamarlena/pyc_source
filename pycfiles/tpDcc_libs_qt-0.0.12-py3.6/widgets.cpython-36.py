...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/library/widgets.py
# Compiled at: 2020-05-03 00:26:03
# Size of source mod 2**32: 49387 bytes
"""
...
class LibraryImageSequenceWidget(QToolButton, object):
    ...
    def addAction(self, path, text, tip, callback):
        ...
        :return: QAction
        """
        action_icon = icon.Icon.state_icon(path,
    ...
    def mouseMoveEvent(self, event):
        ...
        if qtutils.is_control_modifier():
            if self._image_sequence.frame_count() > 1:
...
class LibrarySearchWidget(QLineEdit, object):
    ...
    def query(self):
        ...
        return {'name':unique_name, 
         'operator':self.space_operator(),  'filters':filters}
...
class LibrarySideBarWidgetItem(QTreeWidgetItem, object):
    ...
    def set_icon_color(self, icon_color):
        ...
        if isinstance(icon_color, QColor):
            ...
            if isinstance(icon_color, (str, unicode)):
    ...
    def setTextColor(self, text_color):
        ...
        if isinstance(text_color, QColor):
            ...
            if isinstance(text_color, (str, unicode)):
...
class FilterByMenu(QMenu, object):
    ...
    def _on_search_init(self):
        ...
        query = {'name':self.name(),  'operator':'and', 
         'filters':filters}
