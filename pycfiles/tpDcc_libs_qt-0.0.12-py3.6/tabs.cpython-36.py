...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/tabs.py
# Compiled at: 2020-05-03 00:26:03
# Size of source mod 2**32: 23873 bytes
"""
...
class BaseTabWidget(QTabWidget, object):
    ...
    def removeTab(self, index):
        if self._show_close_message:
            can_close = qtutils.get_permission(message='Save graph before closing it?',
              cancel=(self._show_can_cancel),
              title='Closing Graph',
              parent=self)
