...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/tpDcc/libs/qt/widgets/stack.py
# Compiled at: 2020-05-03 00:26:03
# Size of source mod 2**32: 19560 bytes
"""
...
class StackItem(QFrame, object):
    ...
    def __init__(self, title, parent, collapsed=False, collapsable=True, icon=None, start_hidden=False, shift_arrows_enabled=True, delete_button_enabled=True, title_editable=True, icon_size=12, title_frame=None, show_item_icon=True):
    ...
    def ui(self):
        ...
        self.main_layout = layouts.VerticalLayout(margins=(
         border_width, border_width, border_width, border_width),
          spacing=0)
        self.setLayout(self.main_layout)
        if not self._title_frame:
            self._title_frame = StackTitleFrame(title=(self._title),
              icon=(self._icon),
...
class StackTitleFrame(QFrame, dpi.DPIScaling):
    ...
    def __init__(self, title='', title_editable=False, icon=None, item_icon_size=16, collapsed=True, shift_arrows_enabled=True, delete_button_enabled=True, parent=None):
    ...
    def collapse(self):
        self._expand_toggle_btn.set_icon((self._collapsed_icon), colors=(192, 192,
                                                                         192), size=12)
