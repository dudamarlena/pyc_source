...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/dictops.py
...
class dict_of_averages(dict):
    ...
    def get_avg--- This code section failed: ---

 L. 273         0  LOAD_FAST             0  'self'
                3  LOAD_FAST             1  'key'
                6  BINARY_SUBSCR    
                7  STORE_FAST            2  'vw'

 L. 274        10  LOAD_FAST             2  'vw'
               13  LOAD_ATTR             0  'imag'
               16  LOAD_CONST               0.0
               19  COMPARE_OP            4  >
               22  POP_JUMP_IF_TRUE     47  'to 47'
               25  LOAD_ASSERT              AssertionError
               28  LOAD_CONST               'Weight for key=%s is nonpositive(%g)'
               31  LOAD_FAST             1  'key'
               34  LOAD_FAST             2  'vw'
               37  LOAD_ATTR             0  'imag'
               40  BUILD_TUPLE_2         2 
...
Parse error at or near `RETURN_VALUE' instruction at offset 60
    ...
    def get_avgs--- This code section failed: ---

 L. 278         0  BUILD_MAP_0           0  None
                3  STORE_FAST            1  'o'

 L. 279         6  SETUP_LOOP           83  'to 92'
                9  LOAD_FAST             0  'self'
 ...
 L. 280        31  LOAD_FAST             3  'vw'
               34  LOAD_ATTR             1  'imag'
               37  LOAD_CONST               0.0
               40  COMPARE_OP            4  >
               43  POP_JUMP_IF_TRUE     68  'to 68'
               46  LOAD_ASSERT              AssertionError
               49  LOAD_CONST               'Weight for key=%s is nonpositive(%g)'
               52  LOAD_FAST             2  'k'
               55  LOAD_FAST             3  'vw'
               58  LOAD_ATTR             1  'imag'
               61  BUILD_TUPLE_2         2 
 ...
 L. 282        92  LOAD_FAST             1  'o'
               95  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `POP_BLOCK' instruction at offset 91
