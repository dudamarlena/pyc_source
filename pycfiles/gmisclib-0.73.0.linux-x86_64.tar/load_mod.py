...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/load_mod.py
# Compiled at: 2011-02-15 16:18:12
...
def load(name, path):
    ...
    if name in sys.modules and hasattr(sys.modules[name], '__file__') and os.path.dirname(sys.modules[name].__file__) == os.path.dirname(pn):
        fd.close()
