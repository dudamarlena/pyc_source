...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/ortho_poly.py
# Compiled at: 2009-08-24 20:50:40
import math, numpy
...
class ortho:
    ...
    def __init__(self, n=None, x=None):
        ...
        if x is not None:
            ...
            if not (n is not None and int(n) == len(x)):
                raise AssertionError, 'X and N mismatch: %d vs %s' % (len(x), n)
...
class SLTB(ortho):
    r"""Smooth Local Trigonometric Basis.
