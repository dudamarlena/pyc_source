...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/multivariance_q.py
# Compiled at: 2008-02-16 08:20:11
"""This a helper module for multivariance.py"""
import multivariance_classes as M, Num, random, gpkmisc
HUGE = 1e+30
...
class quadratic(M.modeldesc):
    ...
    def start(self, data):
        ...
        return (
         packedpos, gpkmisc.make_diag(packedsize))
