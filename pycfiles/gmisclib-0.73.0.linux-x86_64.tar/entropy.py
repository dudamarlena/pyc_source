...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/entropy.py
# Compiled at: 2008-08-09 19:59:22
import math, random
...
def information_gained(c, pc=None):
    ...
    for i in range(N):
        ...
        xp = mcmc.bootstepper(multinomial_logp, pstart[i, :], pV, c=(
         c[i, :], F), fixer=multinomial_fixer)
