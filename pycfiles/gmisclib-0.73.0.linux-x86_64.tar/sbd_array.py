...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/sbd_array.py
...
def solve(a, b0):
    ...
    import lapack_dpb
    result = lapack_dpb.dpbsv('L', a.n, a.kd, b.shape[0], a.d, a.ldab, b, max(1, a.n), 0)
    if result['info'] != 0:
...
def multiply(a, x):
    ...
    result = dblas.dsbmv('L', a.n, a.kd, Num.ones((1, ), Num.Float), a.d, a.ldab, xx, 1, Num.zeros((1, ), Num.Float), y, 1)
    assert result == 0
    return y
