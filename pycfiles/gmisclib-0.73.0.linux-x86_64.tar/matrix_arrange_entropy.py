...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/matrix_arrange_entropy.py
...
def make_min_entropy(x, extra_entropy=0.0):
    ...
    stpr = mcmc.bootstepper(fom, [prmvec], v=gpkmisc.make_diag(Num.square(prmvec)), c=(
     Num.transpose(x), nvec, extra_entropy, 20.0), fixer=fixer)
