...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/system_load.py
# Compiled at: 2011-04-08 03:49:10
import os, re, die
...
class pstat(object):
    _spat = re.compile('(\\d+) \\((.*)\\) ([A-Z]) ([0-9]+) ([0-9 -]+)')
    _map = {'minflt': 5, 'cminflt': 6, 'majflt': 7, 'cmajflt': 8, 'utime': 9, 
       'stime': 10, 'cutime': 11, 'cstime': 12, 'priority': 13, 
       'nice': 14, 'num_threads': 15, 'vsize': 18, 
       'rss': 19, 'rsslim': 20}
