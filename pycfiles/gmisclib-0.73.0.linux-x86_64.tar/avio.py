...
# [GCC 8.4.0]
# Embedded file name: /usr/local/lib/python2.7/dist-packages/gmisclib/avio.py
# Compiled at: 2010-10-27 06:43:04
"""Module to parse and create lines in "a=v;" format.
Normally, the entry points are parse() and concoct().
"""
import die, g_encode, gpk_writer
...
def parse(s, sep=';'):
    ...
    for av in avlist:
        ...
        except g_encode.BadFormatError as x:
