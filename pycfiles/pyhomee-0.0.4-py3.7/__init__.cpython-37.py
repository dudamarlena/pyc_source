...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.14-x86_64/egg/pyhomee/__init__.py
# Compiled at: 2019-07-29 10:44:50
# Size of source mod 2**32: 3054 bytes
import hashlib, asyncio, websockets, time, json, aiohttp, urllib, logging
...
class HomeeCube:
    ...
    async def _get_token(self):
        ...
        form = {'device_name':'Home Assistant 2', 
