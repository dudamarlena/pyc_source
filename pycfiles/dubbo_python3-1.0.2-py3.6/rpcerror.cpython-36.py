...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/dubbo_client/rpcerror.py
...
class DubboClientError(RuntimeError):
    ...
    def __str__(self):
        return 'DubboError({code}): {message}'.format(code=(self.code),
          message=(str(self.message)))

    def __unicode__(self):
        return 'DubboClientError({code}): {message}'.format(code=(self.code),
