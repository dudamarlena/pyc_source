...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/composer/tests/settings/111.py
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql', 
               ...
               'HOST': '', 
               'PORT': ''}}
INSTALLED_APPS = ('composer.tests', 'composer.tests.additionals', 'composer', 'django.contrib.admin',
...
MIDDLEWARE_CLASSES = ('django.middleware.common.CommonMiddleware', 'django.contrib.sessions.middleware.SessionMiddleware',
                      ...
                      'django.contrib.messages.middleware.MessageMiddleware', 'composer.middleware.ComposerFallbackMiddleware')
