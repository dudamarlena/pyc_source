...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/astropysics/utils/gen.py
...
def _add_docs_deco(nmdocs, func):
    ...
    for n, d in nmdocs:
        replstr = '{docstr:%s}' % n
        d = (_ignore_add_docs or change_indentation)(d, indent) if 1 else ''
        if replstr in doc:
