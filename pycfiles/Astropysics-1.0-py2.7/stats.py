...
# [GCC 8.4.0]
# Embedded file name: build/bdist.macosx-10.9-x86_64/egg/astropysics/utils/stats.py
...
def interquartile_range(values, scaletonormal=False):
    ...
    if scaletonormal:
        nrm = 2.8284271247461903 * erfinv(0.5)
        return res / nrm
    else:
        return res
...
def median_absolute_deviation(values, scaletonormal=False, cenestimator=np.median):
    ...
    if scaletonormal:
        nrm = 1.4142135623730951 * erfinv(0.5)
        return res / nrm
    else:
        return res
