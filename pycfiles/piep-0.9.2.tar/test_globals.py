...
# [GCC 8.4.0]
# Embedded file name: /home/tim/dev/python/piep/test/test_globals.py
# Compiled at: 2014-04-26 07:13:39
...
class TestShellCommands(TestCase):
    ...
    def test_simple_shell_commands(self):
        self.assertEqual(run('sh(*shellsplit(p))', ['echo "1   2 3"', 'echo 1   2 3']), [
         '1   2 3', '1 2 3'])
    ...
    def test_shell_failures_are_suppressed(self):
        self.assertEqual(run('sh("false") or "failed"', ['1']), [
         'failed'])
