...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/pyf/dataflow/reordering.py
...
def reorder_flow(iterator, key, continue_val=None, serializer=apickle):
    ...
    lines_ordered = itertools.imap(operator.itemgetter(0), sorted(line_keys.items(), key=operator.itemgetter(1)))
