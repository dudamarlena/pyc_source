...
# [GCC 8.4.0]
# Embedded file name: /Users/stalk/develop/django_affiliate/django-affiliate/affiliate/middleware.py
# Compiled at: 2016-04-10 16:19:15
import logging
...
def _get_affiliate_instance(aid_code):
    try:
        ...
        l.warning('Bad aid_code type: %s. Error message: %s.', aid_code, e)
        return
