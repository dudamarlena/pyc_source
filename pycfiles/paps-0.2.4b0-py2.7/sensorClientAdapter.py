...
# [GCC 8.4.0]
# Embedded file name: build\bdist.win32\egg\paps\si\sensorClientAdapter.py
# Compiled at: 2016-04-05 18:29:05
...
class SensorClientAdapter(Logable, ChangeInterface, StartStopable):
