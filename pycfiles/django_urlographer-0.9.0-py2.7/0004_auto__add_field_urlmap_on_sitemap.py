...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/urlographer/migrations/0004_auto__add_field_urlmap_on_sitemap.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('urlographer_urlmap', 'on_sitemap', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
