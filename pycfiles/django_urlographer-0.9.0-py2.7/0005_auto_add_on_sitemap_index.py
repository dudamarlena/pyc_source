...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/urlographer/migrations/0005_auto_add_on_sitemap_index.py
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('urlographer_urlmap', ['on_sitemap'])

    def backwards(self, orm):
        db.delete_index('urlographer_urlmap', ['on_sitemap'])
