...
# [GCC 8.4.0]
# Embedded file name: /home/nex/projects/phishdetect/phishdetect-python/phishdetect/phishdetect.py
# Compiled at: 2020-01-02 09:28:05
...
class PhishDetect:
    ...
    def request(self, method, path, data=None, json=None, files=None, params=None):
        ...
        response = self._session.request(method=method, url=url, data=data, json=json,
          files=files,
          params=params)
    ...
    def post(self, path, data=None, json=None, files=None, params=None):
        ...
        :param params: Query paramaters to send with the request.
        """
        return self.request(method='POST', path=path, data=data, json=json,
          files=files,
          params=params)
