...
# Compiled at: 2018-02-12 23:22:21
...
def execute(output):
    ...
    sim.add_polymerase(name='ribosome', copy_number=100, speed=30,
      footprint=10)
    plasmid = pt.Genome(name='T7', length=230)
    plasmid.add_promoter(name='phi1', start=1, stop=10, interactions={'rnapol': 200000000.0})
    plasmid.add_gene(name='proteinX', start=26, stop=225, rbs_start=11,
      rbs_stop=26,
