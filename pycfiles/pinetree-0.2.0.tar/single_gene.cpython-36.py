...
# [GCC 8.4.0]
# Embedded file name: /Users/ben/Box Sync/projects/2018/pinetree/tests/models/single_gene.py
...
def execute(output):
    ...
    plasmid.add_gene(name='rnapol', start=26, stop=225, rbs_start=11,
      rbs_stop=26,
      rbs_strength=10000000.0)
    plasmid.add_gene(name='proteinX', start=241, stop=280, rbs_start=226,
      rbs_stop=241,
      rbs_strength=10000000.0)
    plasmid.add_gene(name='proteinY', start=296, stop=595, rbs_start=281,
      rbs_stop=296,
      rbs_strength=10000000.0)
