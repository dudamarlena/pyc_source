...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/archipelagenthypervisorplatformrequest/__init__.py
...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [
     {'info': platformrequests.TNPlatformRequests.plugin_info(), 'plugin': platformrequests.TNPlatformRequests(configuration, entity, group)}]
...
def version():
    ...
    return (
     __name__, pkg_resources.get_distribution('archipel-agent-hypervisor-platformrequest').version, [platformrequests.TNPlatformRequests.plugin_info()])