...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/django_pyowm/tests.py
...
from django_pyowm.models import Location, Weather, Observation, Forecast, Station, StationHistory, UVIndex, COIndex, Ozone
...
class Databox:
    ...
    reception_time = datetime.strptime('2013-09-06 09:20:00+00', '%Y-%m-%d %H:%M:%S+00').replace(tzinfo=UTC())
    reference_time_unix = 1378459200
    reference_time = datetime.strptime('2013-09-06 09:20:00+00', '%Y-%m-%d %H:%M:%S+00').replace(tzinfo=UTC())
    sunset_time_unix = 1378496400
    sunset_time = datetime.strptime('2013-09-06 19:40:00+00', '%Y-%m-%d %H:%M:%S+00').replace(tzinfo=UTC())
    sunrise_time_unix = 1378449600
    sunrise_time = datetime.strptime('2013-09-06 06:40:00+00', '%Y-%m-%d %H:%M:%S+00').replace(tzinfo=UTC())
    clouds = 67
    rain = {'all': 20}
    snow = {'all': 0}
    wind = {'deg': 252.002, 'speed': 1.1}
    humidity = 57
    pressure = {'press': 1030.119, 'sea_level': 1038.589}
    temperature = {'temp': 294.199, 'temp_kf': -1.899, 'temp_max': 296.098, 
       'temp_min': 294.199}
    celsius_temperature = {'temp': 21.049, 'temp_kf': -1.899, 'temp_max': 22.948, 
       'temp_min': 21.049}
    fahrenheit_temperature = {'temp': 69.888, 'temp_kf': -1.899, 'temp_max': 73.306, 
       'temp_min': 69.888}
    status = 'Clouds'
    ...
    humidex = 298.0
    heat_index = 40.0
    weather = WeatherEntity(reference_time_unix, sunset_time_unix, sunrise_time_unix, clouds, rain, snow, wind, humidity, pressure, temperature, status, detailed_status, weather_code, weather_icon_name, visibility_distance, dewpoint, humidex, heat_index)
    ...
    station = StationEntity(station_name, station_id, station_type, station_status, lat, lon, station_distance, weather)
    station_history_interval = 'tick'
    station_history_measurements = {1362933983: {'temperature': 266.25, 
                    'humidity': 27.3, 
                    'pressure': 1010.02, 
                    'rain': None, 
                    'wind': 4.7}, 
       1362934043: {'temperature': 266.85, 
                    'humidity': 27.7, 
                    'pressure': 1010.09, 
                    'rain': None, 
                    'wind': 4.7}}
    station_history = StationHistoryEntity(station_id, station_history_interval, reception_time_unix, station_history_measurements)
    uvindex_intensity = 6.8
    uvindex_interval = 'day'
    uvindex = UVIndexEntity(reference_time_unix, location, uvindex_interval, uvindex_intensity, reception_time_unix)
    co_samples = [
     {'precision': -4.999999987376214e-07, 
        'pressure': 1000, 
        'value': 8.168363052618588e-08},
     {'precision': -4.999999987376214e-07, 
        'pressure': 681.2920532226562, 
        'value': 8.686949115599418e-08}]
    coindex_interval = 'month'
    coindex = COIndexEntity(reference_time_unix, location, coindex_interval, co_samples, reception_time_unix)
    du_value = 6.8
    ozone_interval = 'year'
    ozone = OzoneEntity(reference_time_unix, location, ozone_interval, du_value, reception_time_unix)
...
class Asserter:
    ...
    def assertWeatherModelsEqual(testcase, expected, result):
        ...
        testcase.assertEquals(json.loads(expected.temperature), json.loads(result.temperature))
...
class TestLocationModel(TestCase):
    ...
    def test_from_entity(self):
        expected = Location(name=Databox.location_name, lon=Databox.lon, lat=Databox.lat, city_id=Databox.city_id, country=Databox.country)
        result = Location.from_entity(Databox.location)
        Asserter.assertLocationModelsEqual(self, expected, result)

    def test_to_entity(self):
        model = Location(name=Databox.location_name, lon=Databox.lon, lat=Databox.lat, city_id=Databox.city_id, country=Databox.country)
...
class TestWeatherModel(TestCase):
    ...
    def test_from_entity(self):
        expected = Weather(reference_time=Databox.reference_time, sunset_time=Databox.sunset_time, sunrise_time=Databox.sunrise_time, clouds=Databox.clouds, rain=json.dumps(Databox.rain), snow=json.dumps(Databox.snow), wind=json.dumps(Databox.wind), humidity=Databox.humidity, pressure=json.dumps(Databox.pressure), temperature=json.dumps(Databox.temperature), status=Databox.status, detailed_status=Databox.detailed_status, weather_code=Databox.weather_code, weather_icon_name=Databox.weather_icon_name, visibility_distance=Databox.visibility_distance, dewpoint=Databox.dewpoint, humidex=Databox.humidex, heat_index=Databox.heat_index)
        result = Weather.from_entity(Databox.weather)
        Asserter.assertWeatherModelsEqual(self, expected, result)

    def test_to_entity(self):
        model = Weather(reference_time=Databox.reference_time, sunset_time=Databox.sunset_time, sunrise_time=Databox.sunrise_time, clouds=Databox.clouds, rain=json.dumps(Databox.rain), snow=json.dumps(Databox.snow), wind=json.dumps(Databox.wind), humidity=Databox.humidity, pressure=json.dumps(Databox.pressure), temperature=json.dumps(Databox.temperature), status=Databox.status, detailed_status=Databox.detailed_status, weather_code=Databox.weather_code, weather_icon_name=Databox.weather_icon_name, visibility_distance=Databox.visibility_distance, dewpoint=Databox.dewpoint, humidex=Databox.humidex, heat_index=Databox.heat_index)
...
class TestObservationModel(TestCase):
    ...
    def test_from_entity(self):
        ...
        expected = Observation(reception_time=Databox.reception_time, location=location, weather=weather)
    ...
    def test_to_entity(self):
        location = Location.from_entity(Databox.location)
        weather = Weather.from_entity(Databox.weather)
        model = Observation(reception_time=Databox.reception_time, location=location, weather=weather)
        result = model.to_entity()
        expected = Databox.observation
        self.assertEquals(expected.get_reception_time(), result.get_reception_time())
        Asserter.assertLocationEntitiesEqual(self, expected.get_location(), result.get_location())
        Asserter.assertWeatherEntitiesEqual(self, expected.get_weather(), result.get_weather())

    def test_save_all(self):
        location = Location.from_entity(Databox.location)
        weather = Weather.from_entity(Databox.weather)
        observation = Observation(reception_time=Databox.reception_time, location=location, weather=weather)
...
class TestForecastModel(TestCase):
    ...
    def test_from_entity(self):
        location = Location.from_entity(Databox.location)
        expected = Forecast(interval=Databox.interval, reception_time=Databox.reception_time, location=location)
    ...
    def test_to_entity(self):
        ...
        loc.save()
        model = Forecast(interval=Databox.interval, reception_time=Databox.reception_time, location=loc)
        model.save()
        for w in weats:
    ...
    def test_save_all(self):
        ...
        location = Location.from_entity(Databox.location)
        forecast = Forecast(interval=Databox.interval, reception_time=Databox.reception_time, location=location)
        self.assertIsNone(location.pk)
        for w in weathers:
...
class TestStationModel(TestCase):
    ...
    def test_from_entity(self):
        expected = Station(name=Databox.station_name, station_id=Databox.station_id, station_type=Databox.station_type, station_status=Databox.station_status, lat=Databox.lat, lon=Databox.lon, distance=Databox.station_distance, last_weather=Weather.from_entity(Databox.weather))
        ...
        Asserter.assertWeatherModelsEqual(self, expected.last_weather, result.last_weather)

    def test_to_entity(self):
        model = Station(name=Databox.station_name, station_id=Databox.station_id, station_type=Databox.station_type, station_status=Databox.station_status, lat=Databox.lat, lon=Databox.lon, distance=Databox.station_distance, last_weather=Weather.from_entity(Databox.weather))
        result = model.to_entity()
        ...
        Asserter.assertWeatherEntitiesEqual(self, expected.get_last_weather(), result.get_last_weather())

    def test_save_all(self):
        last_weather = Weather.from_entity(Databox.weather)
        station = Station(name=Databox.station_name, station_id=Databox.station_id, station_type=Databox.station_type, station_status=Databox.station_status, lat=Databox.lat, lon=Databox.lon, distance=Databox.station_distance, last_weather=last_weather)
...
class TestStationHistoryModel(TestCase):
    ...
    def test_from_entity(self):
        expected = StationHistory(station_id=Databox.station_id, interval=Databox.station_history_interval, reception_time=Databox.reception_time, measurements=json.dumps(Databox.station_history_measurements))
    ...
    def test_to_entity(self):
        model = StationHistory(station_id=Databox.station_id, interval=Databox.station_history_interval, reception_time=Databox.reception_time, measurements=json.dumps(Databox.station_history_measurements))
        result = model.to_entity()
...
class TestUVIndexModel(TestCase):
    ...
    def test_from_entity(self):
        expected = UVIndex(reference_time=Databox.reference_time, location=Location.from_entity(Databox.location), value=Databox.uvindex_intensity, interval=Databox.uvindex_interval, reception_time=Databox.reception_time)
    ...
    def test_to_entity(self):
        model = UVIndex(reference_time=Databox.reference_time, location=Location.from_entity(Databox.location), value=Databox.uvindex_intensity, interval=Databox.uvindex_interval, reception_time=Databox.reception_time)
        result = model.to_entity()
    ...
    def test_save_all(self):
        location = Location.from_entity(Databox.location)
        uvindex = UVIndex(reference_time=Databox.reference_time, location=location, value=Databox.uvindex_intensity, interval=Databox.uvindex_interval, reception_time=Databox.reception_time)
        self.assertIsNone(location.pk)
...
class TestCOIndexModel(TestCase):
    ...
    def test_from_entity(self):
        expected = COIndex(reference_time=Databox.reference_time, location=Location.from_entity(Databox.location), interval=Databox.coindex_interval, reception_time=Databox.reception_time, co_samples=json.dumps(Databox.co_samples))
    ...
    def test_to_entity(self):
        model = COIndex(reference_time=Databox.reference_time, location=Location.from_entity(Databox.location), interval=Databox.coindex_interval, reception_time=Databox.reception_time, co_samples=json.dumps(Databox.co_samples))
        result = model.to_entity()
    ...
    def test_save_all(self):
        location = Location.from_entity(Databox.location)
        coindex = COIndex(reference_time=Databox.reference_time, location=location, interval=Databox.coindex_interval, reception_time=Databox.reception_time, co_samples=json.dumps(Databox.co_samples))
        self.assertIsNone(location.pk)
...
class TestOzoneModel(TestCase):
    ...
    def test_from_entity(self):
        expected = Ozone(reference_time=Databox.reference_time, location=Location.from_entity(Databox.location), du_value=Databox.du_value, interval=Databox.ozone_interval, reception_time=Databox.reception_time)
    ...
    def test_to_entity(self):
        model = Ozone(reference_time=Databox.reference_time, location=Location.from_entity(Databox.location), du_value=Databox.du_value, interval=Databox.ozone_interval, reception_time=Databox.reception_time)
        result = model.to_entity()
    ...
    def test_save_all(self):
        location = Location.from_entity(Databox.location)
        ozone = Ozone(reference_time=Databox.reference_time, location=location, du_value=Databox.du_value, interval=Databox.ozone_interval, reception_time=Databox.reception_time)
        self.assertIsNone(location.pk)
