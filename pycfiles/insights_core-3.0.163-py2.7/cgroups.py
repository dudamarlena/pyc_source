...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/cgroups.py
...
class Cgroups(Parser):
    ...
    def parse_content(self, content):
        self.data = parse_delimited_table(content, heading_ignore=[
         '#subsys_name', 'hierarchy'], header_substitute=[
