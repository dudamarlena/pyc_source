...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/tests/test_specs.py
...
from insights.core.spec_factory import DatasourceProvider, simple_file, simple_command, glob_file, SpecSet
import tempfile, pytest, glob
