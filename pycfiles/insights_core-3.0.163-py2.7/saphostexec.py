...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/saphostexec.py
...
class SAPHostExecVersion(CommandParser, LegacyItemAccess):
    ...
    Examples:
        ...
        '1011'
    """
    SAPComponent = namedtuple('SAPComponent', field_names=[
     'version', 'patch', 'changelist'])
