...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/systool.py
    ...
    def _record_pair(self, k, _v):
        ...
        if k == 'Device':
            ...
            try:
                ...
                raise ParseException('Parsing Error for no heading Device-name                                       of (key, value) pair: (%s, %s)' % (k, v))
