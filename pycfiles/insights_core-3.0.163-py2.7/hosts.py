...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/hosts.py
...
class Hosts(Parser):
    ...
    def get_nonlocal(self):
        ...
        """
        return dict((ip, host_list) for ip, host_list in self._data.items() if ip not in ('127.0.0.1',
                                                                                          '::1'))
