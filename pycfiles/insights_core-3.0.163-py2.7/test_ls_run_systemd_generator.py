...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_ls_run_systemd_generator.py
...
def test_ls_run_systemd_generator():
    ls = LsRunSystemdGenerator(context_wrap(LS_RUN_SYSTEMD_GENERATOR, path=PATH_OF_LS_RUN_SYSTEMD_GENERATOR))
