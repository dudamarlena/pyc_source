...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_vmcore_dmesg.py
...
def test_vmcore_dmesg_doctest():
    env = {'vmcore_dmesg': VMCoreDmesg(context_wrap(VMCORE_DMESG_CRASH))}
