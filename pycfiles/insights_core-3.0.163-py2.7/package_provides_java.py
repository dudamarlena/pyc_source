...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/package_provides_java.py
...
class PackageProvidesJava(CommandParser):
    ...
    def parse_content(self, content):
        ...
        l = content[0].split()
        if len(l) != 2:
            raise SkipException('Error: ', 'current running java command is not provided by package installed through yum or rpm')
        self.command = l[0]
        self.package = l[1]