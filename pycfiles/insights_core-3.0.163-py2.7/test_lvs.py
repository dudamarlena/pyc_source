...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/tests/test_lvs.py
...
LVS_ROOT_INFO = {'MergeFailed': 'unknown', 
   '#Seg': '1', 
   'Ancestors': '', 
   'Layout': 'linear', 
   'Meta%': '', 
...
LVS_DOCKER_INFO1 = {'Log': '', 
   ...
   'LSize': '<6.59g'}
LVS_DOCKER_INFO2 = {'CacheDirtyBlocks': '', 
   '#Seg': '1', 
   'Ancestors': '', 
   'Layout': 'thin,pool', 
   'Meta%': '2.54', 
...
class TestLVS(object):
    ...
    def test_lvs1(self):
        ...
        assert compare_partial_dicts(rhel_vg[0], {'LV': 'root', 
           'VG': 'rhel', 'LVM2_LV_SIZE': '<13.62g', 'LVM2_REGION_SIZE': '0', 
           'LVM2_MIRROR_LOG': '', 'LVM2_LV_ATTR': '-wi-ao----', 
           'LVM2_DEVICES': '/dev/sda2(416)'})
