...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsr/examples/nginx_conf.py
# Compiled at: 2019-11-14 13:57:46
import string
from insights.parsr import EOF, Forward, LeftCurly, Lift, LineEnd, RightCurly, Many, Number, OneLineComment, PosMarker, SemiColon, QuotedString, skip_none, String, WS, WSChar
