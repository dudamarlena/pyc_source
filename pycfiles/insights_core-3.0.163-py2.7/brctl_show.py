...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/brctl_show.py
    ...
    def parse_content(self, content):
        ...
        if iface:
            ...
            for entry in self.data:
                self._group_by_iface[entry['bridge name']] = dict((k, v) for k, v in entry.items() if k != 'bridge name')
