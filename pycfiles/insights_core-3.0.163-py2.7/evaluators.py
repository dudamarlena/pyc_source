...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/core/evaluators.py
...
class SingleEvaluator(Evaluator):
    ...
    def get_response(self):
        ...
        r.update({'system': {'metadata': self.metadata, 
        ...
        r['analysis_metadata'] = {'start': self.start_time.isoformat(), 
    ...
    def handle_result(self, plugin, r):
        ...
        if type_ == 'skip':
            ...
            key = r.get_key()
            self.results[type_].append(self.format_result({response_id: ('{0}|{1}').format(get_simple_module_name(plugin), key), 
