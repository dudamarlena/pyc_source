...
# [GCC 8.4.0]
# Embedded file name: build/bdist.linux-x86_64/egg/insights/parsers/ovs_vsctl_show.py
    ...
    def parse_content(self, content):
        ...
        for line in content[1:-1]:
            ...
            if prefix == 'Bridge':
                ...
                port_dict['options'] = dict((item.split('=')[0], item.split('=')[1].replace('"', '')) for item in options_items)
