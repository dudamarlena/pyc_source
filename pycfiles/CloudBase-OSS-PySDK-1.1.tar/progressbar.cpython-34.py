...
# Embedded file name: /Users/chibiegg/.pyenv/versions/cloudbackup/lib/python3.4/site-packages/cloudbackup/progressbar/progressbar.py
# Compiled at: 2014-12-28 14:20:28
# Size of source mod 2**32: 9453 bytes
__doc__ = 'Main ProgressBar class.'
...
class ProgressBar(object):
    """ProgressBar"""
    __slots__ = ('currval', 'fd', 'finished', 'last_update_time', 'left_justify', 'maxval',
                 'next_update', 'num_intervals', 'poll', 'seconds_elapsed', 'signal_set',
                 'start_time', 'term_width', 'update_interval', 'widgets', '_time_sensitive',
                 '__iterable')
    _DEFAULT_MAXVAL = 100
    ...
    def __next__(self):
        try:
            value = next(self._ProgressBar__iterable)
    ...
    def update(self, value=None):
        ...
        self.fd.write(self._format_line().encode() + '\r')
