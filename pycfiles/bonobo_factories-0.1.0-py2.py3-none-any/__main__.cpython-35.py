...
# Embedded file name: build/bdist.macosx-10.6-intel/egg/bonobo_docker/__main__.py
...
class BuildCommand(BaseCommand):
    ...
    def call(self, *, version=None, push=False, no_cache=False, dry_run=False):
        ...
        docker_command = [
         'build', *['--no-cache'] if no_cache else [], '--build-arg BONOBO_VERSION={}'.format(version), '-t {}:{}'.format(settings.IMAGE, tag) for tag in tags, images.__path__[0]]
