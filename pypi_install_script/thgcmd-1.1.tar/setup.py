...
# coding=utf-8
"""
Setuptools setup file, used to install or test 'thgcmd'
"""
import codecs
from setuptools import setup

DESCRIPTION = "thgcmd - quickly build feature-rich and user-friendly interactive command line applications in Python"
...
setup(
    ...
    url='https://github.com/darkcode357/thgcmd',
    download_url="https://github.com/darkcode357/thgcmd/archive/1.1.tar.gz",
    license='MIT',
    platforms=['any'],
    packages=['thgcmd'],
