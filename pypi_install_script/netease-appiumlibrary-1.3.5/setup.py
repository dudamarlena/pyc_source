...
execfile(join(dirname(__file__), 'src', 'BetaLibrary', 'version.py'))

setup(name         = 'netease-appiumlibrary',
      version      = VERSION,
      ...
      py_modules=['ez_setup'],
      package_dir  = {'' : 'src'},
      packages     = ['BetaLibrary','BetaLibrary.keywords','BetaLibrary.locators',
                      'BetaLibrary.utils'],
