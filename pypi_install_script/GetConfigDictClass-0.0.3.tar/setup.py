...
setuptools.setup(
    name="GetConfigDictClass",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.0.3",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="hanziguo",                                       # 作者名字
    author_email="hanziguo@foxmail.com",                      # 作者邮箱
    description="PyPI GetConfigDictClass",                            # 包的简介描述
    ...
    url="https://github.com/laughterGod",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
