...
setup(
    name='lmselfie',
    version='0.0.16', # Cada vez que lo subis'time', 'picamera' lo tenes que incrementar
    ...
    install_requires=['gpiozero', 'picamera>=1.13', 'RPi.GPIO', 'jpeg4py', 'Pillow'], # no admite repos de GIT solo paquetes
    entry_points={
