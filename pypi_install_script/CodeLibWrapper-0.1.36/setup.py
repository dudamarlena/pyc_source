...
setup (
    ...
    packages=find_packages (exclude=["*.UnConfirmCode", "*.UnConfirmCode.*",
                                     "UnConfirmCode.*", "UnConfirmCode",
                                        "*.PythonStudyCase", "*.PythonStudyCase.*",
                                     "PythonStudyCase.*", "PythonStudyCase",
                                    ]),
    package_data={
    ...
    exclude_package_data={'PythonStudyCase': ['*.*']},
    ...
    long_description=open ('CodeLibWrapper/README.txt').read (),  # Readme File
