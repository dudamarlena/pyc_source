...
extensions = [Extension("shapelibc",
              ...
              Extension("shptree",
                        ["shptreemodule.c", shp_dir + "/safileio.c"],
                        include_dirs = [shp_dir]),
              Extension("dbflibc",
                        ["dbflib_wrap.c",
                         shp_dir + "/dbfopen.c", shp_dir + "/safileio.c"],
                        include_dirs = [shp_dir],
                        define_macros = dbf_macros())]

setup(name = "pyshapelib",
      version = "0.0.1",
      description = "Python bindings for shapelib and extent to process shp/dbf",
      author = "Bernhard Herzog, firewzy",
      author_email = "bh@intevation.de",
      url = "https://pypi.python.org/pypi/pyshapelib",
