...
setuptools.setup(
  ...
  description = 'speclear - delete specific history in major windows browsers',
  long_description = ld,
  ...
  download_url = 'https://github.com/Shivanshu26shiv/speclear/archive/v_0.1.1.tar.gz',    # I explain this later on
