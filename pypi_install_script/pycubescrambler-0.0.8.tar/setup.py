...
setup(
  ...
  description = 'a python module to generate scrambles for most wca puzzles check https://repl.it/@MidnightCuberX1/example for an example',   # Give a short description about your library
  ...
  download_url = 'https://github.com/midnightcuberx/pycubescrambler/archive/v_0.0.8.tar.gz',    # I explain this later on
