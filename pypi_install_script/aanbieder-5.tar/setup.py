...
setup(
    name='aanbieder',
    version='5',
    url='https://pikacode.com/bart/aanbieder',
    author='Bart Thate',
    author_email='bthate@dds.nl',
    description=" AANBIEDER - indien het misdrijf wordt gepleegd door toediening van voor het leven of de gezondheid schadelijke stoffen ",
    license='MIT',
    include_package_data=False,
    zip_safe=False,
    install_requires=["meds"],
    scripts=["bin/aanbieder"],
    packages=['aanbieder',
             ],
    long_description="""
