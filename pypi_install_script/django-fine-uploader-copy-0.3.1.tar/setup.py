...
version = get_version("django_fine_uploader_copy", "__init__.py")
...
setup(
    name='django-fine-uploader-copy',
    version=version,
    description="""Simple, Chunked and Concurrent uploads with Django + Fine Uploader""",
    long_description=readme + '\n\n' + history,
    author='Douglas Miranda',
    author_email='norcom143@gmail.com',
    url='https://github.com/shahidir/django-fine-uploader-copy.git',
    packages=find_packages(),
    include_package_data=True,
    install_requires=[],
    license="MIT",
    zip_safe=False,
    keywords='django-fine-uploader-copy',
    classifiers=[
