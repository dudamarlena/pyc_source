...
console_scripts = ['GFETStimulation = PyCharactStimulation.GuiGuiStim:main',
                  ]
...
setup(name="PyCharactStimulation",
      version=_version,
      ...
      url="https://github.com/jmartinezaguilar/PyCharactStimulation",
      download_url="https://github.com/jmartinezaguilar/PyCharactStimulation",
      license="GPLv3",
