...
setup(
  name = 'logion_operations',         # How you named your package folder (MyLib)
  packages = ['logion_operations'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/pythonDev2060/logion_operations/archive/v_03.tar.gz',    # I explain this later on
