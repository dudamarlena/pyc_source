...
confkcw['version']='2.40.4'							#项目版本
confkcw['description']='基于python后端开发框架'       #项目的简单描述
confkcw['long_description']="完整文档：http://intapp.kwebapp.cn/index/index/doc/docde/1"     #项目详细描述
confkcw['license']='MIT License'                    #开源协议   mit开源
confkcw['url']='http://intapp.kwebapp.cn/index/index/doc/docde/1'
