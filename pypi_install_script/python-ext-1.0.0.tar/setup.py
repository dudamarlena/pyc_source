...
setup(
    ...
    ##
    ##      pip install python-ext
    ##
    ##  and where this project lives on pypi:
    ##
    ##  <https://pypi.org/project/python-ext/>
    ##
    ...
    ##
    url='https://github.com/cykerway/python-ext',
...
#        ],
    ...
    ##
    project_urls={
        'Bug Reports': 'https://github.com/cykerway/python-ext/issues',
        'Funding': 'https://donate.pypi.org',
        'Say Thanks!': 'http://saythanks.io/to/example',
        'Source': 'https://github.com/cykerway/python-ext/',
    },
)
