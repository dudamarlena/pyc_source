...
try:
    ...
    README = 'https://github.com/geopython/geopython/blob/master/README.md'


setup(name='geopython',
      version=version,
      description='a tool for daily geology related task. visit geopython.com for further information',
      longdescription=README,
      author='cycleuser',
      author_email='cycleuser@cycleuser.org',
      url='https://github.com/geopython/geopython',
      packages=['geopython'],
      package_data={
          'geopython': ['*.py','*.png','*.qm','*.ttf','*.ini','*.md'],
      },
