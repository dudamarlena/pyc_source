...
INSTALL_REQUIRES = [
    ...
    "pyqtgraph",
    "AnyQt",
    "arithmos-canvas-core>=0.1.8a,<0.2a",
]
...
def write_version_py(filename='arithmoswidget/version.py'):
    # Copied from numpy setup.py
    cnt = f"""\
...
"""
    ...
    if os.path.exists('.git'):
        ...
        import imp
        version = imp.load_source("arithmoswidget.version", filename)
...
# hierarchy
PACKAGE_DATA = {
    "arithmoswidget": ["icons/*.png", "icons/*.svg"],
    "arithmoswidget.report": ["icons/*.svg", "*.html"],
    "arithmoswidget.utils": ["_webview/*.js"],
}
