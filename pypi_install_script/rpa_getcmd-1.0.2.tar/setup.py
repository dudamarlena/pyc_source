...
setuptools.setup(
    name="rpa_getcmd",                                     # 包的分发名称，使用字母、数字、_、-
    version="1.0.2",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="qi.you",                                       # 作者名字
    author_email="youqi6588@126.com",                      # 作者邮箱
    description="取RPA传入的参数并解析，包括程序名和json参数",                            # 包的简介描述
    ...
    url="https://github.com/youqi6588/RPA",                              # 项目开源地址
