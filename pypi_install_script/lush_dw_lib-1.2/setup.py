...
setup(
  name = 'lush_dw_lib',         # How you named your package folder (MyLib)
  packages = ['lush_dw_lib'],   # Chose the same as "name"
  ...
  download_url = 'http://zonec.net/lush_dw_lib.tar',    # I explain this later on
