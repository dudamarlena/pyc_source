...
version = get_version('django_girosolution')
...
setup(
    ...
    description=u'Django integration of girosolution',
    version=version,
    url='https://github.com/ParticulateSolutions/django-girosolution',
    packages=get_packages('django_girosolution'),
    package_data=get_package_data('django_girosolution'),
