...
setup(
  name = 'SIMDprofiler',         # How you named your package folder (MyLib)
  packages = ['SIMDprofiler'],   # Chose the same as "name"
  ...
  url = 'https://github.com/neftaliw/SIMDprofiler',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/neftaliw/SIMDprofiler/archive/0.3.1.tar.gz',    # I explain this later on
