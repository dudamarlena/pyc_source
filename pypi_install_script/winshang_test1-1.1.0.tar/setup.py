...
setuptools.setup(
    name="winshang_test1",              # 包的分发名称，使用字母、数字、_、-
    version="1.1.0",                   # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="jianling",                 # 作者名字
    author_email="laojianling@winshang.com",                # 作者邮箱
    ...
    url="https://github.com/",                              # 项目开源地址，大家可以写自己真实的开源网址
