...
setuptools.setup(
    name="pyspeeder",  # 包的分发名称，使用字母、数字、_、-
    version="0.0.9",  # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="sumriser",  # 作者名字
    author_email="sumriser@163.com",  # 作者邮箱
    description="Distribute web crawler based on redis.",  # 包的简介描述
    ...
    url="https://github.com/",  # 项目开源地址，我这里写的是github，大家可以写自己真实的开源网址
