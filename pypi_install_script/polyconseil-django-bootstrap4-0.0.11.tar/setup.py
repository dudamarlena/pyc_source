...
if sys.argv[-1] == "publish":
    ...
    os.system("twine upload dist/polyconseil-django-bootstrap4-{}.tar.gz".format(VERSION))

    message = "\nreleased [{version}](https://pypi.python.org/pypi/polyconseil-django-bootstrap4/{version})"
...
setup(
    name="polyconseil-django-bootstrap4",
    version=VERSION,
    description="""Bootstrap support for Django projects""",
    long_description=readme + "\n\n" + history,
    author="Polyconseil dev team",
    author_email="opensource+django-bootstrap4@polyconseil.fr",
    url="https://github.com/Polyconseil/django-bootstrap4",
    packages=["bootstrap4"],
