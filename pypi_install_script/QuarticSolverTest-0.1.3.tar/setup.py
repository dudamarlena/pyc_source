...
if __name__=="__main__":
    ...
    setup(
        ...
        url = 'https://github.com/qureshizawar/quartic-solver-test',
        download_url = 'https://github.com/qureshizawar/quartic-solver-test/archive/v_013.tar.gz',
        ...
        ext_modules=[CMakeExtension('QuarticSolverTest')],
