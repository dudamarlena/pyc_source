...
setup(
    name='tapioca-ollhd-com',
    version=get_version(package),
    description='ollhd com API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/InzGIBA/tapioca-ollhd-com',
    packages=[
        'tapioca_ollhd_com',
    ],
    package_dir={'tapioca_ollhd_com': 'tapioca_ollhd_com'},
