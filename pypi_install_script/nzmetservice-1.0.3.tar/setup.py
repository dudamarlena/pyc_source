...
setup(
    ...
    description='functions to download and process metservice data',  # Required
    ...
    url='https://github.com/mullenkamp/nzmetservice',  # Optional
    ...
    keywords='rainfall forecast',  # Optional
