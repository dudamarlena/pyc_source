...
def get_version(mod_root):
    ...
    try:
        ...
        version_detail = re.sub('[^a-zA-Z0-9+@.-]+', '', version_detail)
...
setup_args = {
    ...
    'version'            : version,
    'description'        : 'SOCKS-5 implementation (RFC.1928)',
  # 'long_description'   : (read('README.md') + '\n\n' + read('CHANGES.md')),
    'author'             : 'Andre Merzky',
    'author_email'       : 'andre@merzky.net',
    'maintainer'         : 'RADICAL-Consulting UG',
    'maintainer_email'   : 'software@radical-consulting.com',
    'url'                : 'https://www.github.com/radical-consulting/rc.rfc.1928/',
    'license'            : 'AGPL',
    'keywords'           : 'SOCKS5 RFC.1928',
    'classifiers'        : [
