...
setup(
  ...
  description = 'a python module to generate scrambles for most wca puzzles check github for examples',   # Give a short description about your library
  ...
  download_url = 'https://github.com/midnightcuberx/pycubescrambler/archive/v_0.0.4.tar.gz',    # I explain this later on
