...
"""
@File    :   setup.py.py    
@Email :   601540072@qq.com

@Modify Time      @Author    @Version    @Desciption
------------      -------    --------    -----------
2020/3/20 17:12    Dong        1.0         -----
"""
...
setuptools.setup(
    name="auto_control",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.9.0",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="dong",                                       # 作者名字
    author_email="15764315865@163.com",                      # 作者邮箱
    description="simples",                            # 包的简介描述
    ...
    url="",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
