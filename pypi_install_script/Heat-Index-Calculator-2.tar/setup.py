...
from heat_index import __version__ as VERSION
...
setup(
    ...
    version = VERSION, 
    py_modules = ['heat_index'], 
    license = 'BSD License', 
    description = 'A tool to calculate the heat index.',
    long_description = README,
    url = 'https://bitbucket.org/notequal/heat-index-calculator',
