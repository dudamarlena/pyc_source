...
setup(
  ...
  name = 'palki_101703381',         # How you named your package folder (MyLib)

  packages = ['palki_101703381'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/palkibansal31/topsis/archive/v_01.tar.gz',    # I explain this later on
