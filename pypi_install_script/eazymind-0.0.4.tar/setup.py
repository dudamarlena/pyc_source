...
setup(
  ...
  packages = ['eazymind','eazymind/nlp','eazymind/vision'],   # Chose the same as "name",
  ...
  download_url = 'https://github.com/theamrzaki/eazymind/archive/v0.0.4.tar.gz',    # I explain this later on
