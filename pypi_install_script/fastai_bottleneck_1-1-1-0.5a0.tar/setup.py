...
dep_groups = {
    'core':   to_list("""
        bottleneck==1.1.0           # performance-improvement for numpy
...
setup(
    ...
    description = "This is not the official fastai package.",
    ...
    url = 'https://github.com/H4dr1en/fastai',
