...
setup(
  ...
  version = '0.2.10',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/Picsell-ia/picsellia-sdk/archive/v0.2.tar.gz',    # I explain this later on
