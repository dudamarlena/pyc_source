"""Setup script for kalabash-admin."""

import re
import os
from setuptools import setup, find_packages

from kalabash_pfxadmin_migrate import __version__
...
setup(
    name="kalabash-pfxadmin-migrate",
    url='https://alphamonak.com/',
     version="1.1.5",
    description="A script to migrate from PostfixAdmin to Kalabash",
