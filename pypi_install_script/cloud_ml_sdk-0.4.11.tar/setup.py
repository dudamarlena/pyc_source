...
default_release_version = "0.4.11"
setup(name="cloud_ml_sdk",
      ...
      install_requires=["requests>=2.6.0", "pyOpenSSL>=16.1.0",
                        "argcomplete>=1.4.1", "grpcio>=1.2.0",
                        "cloud-ml-common>=0.2.2", "galaxy-fds-sdk>=1.2.16",
                        "pyyaml>=3.12", "netaddr>=0.7.19", "protobuf", "tensorflow-serving-api", "inflection"],
      description="Xiaomi Cloud-ml SDK",
      packages=["cloud_ml_sdk",
                "cloud_ml_sdk.models",
                "cloud_ml_sdk.predict_client",
                "cloud_ml_sdk.command",
                "cloud_ml_sdk.cmd_base",
                "cloud_ml_sdk.cmd_plugins",
                "cloud_ml_sdk.utils",
                "cloud_ml_sdk.thetis",
      ],
      entry_points={
