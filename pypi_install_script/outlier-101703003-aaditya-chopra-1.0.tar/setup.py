# -*- coding: utf-8 -*-
"""
Created on SAT Feb 8 15:52:12 2020
...
setup(
  name = 'outlier-101703003-aaditya-chopra',         # How you named your package folder (MyLib)
  packages = ['outlier-101703003-aaditya-chopra'],   # Chose the same as "name"
  version = '1.0',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Removal of outlier',   # Give a short description about your library
