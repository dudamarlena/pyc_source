...
sourcecython = ""
entry_points = {}
projectname = "metaphor_nntoolbox"
...
main_ns = {}
ver_path = os.path.join(modulepath, "version_nntoolbox.py")
...
#         from metaphor.monal.util.utils import runCo mpileM onalLib
#         run Compi leMona lLib(doprint=True, freesource=True, force=True, 
#             debug=self.debug, logfile=outfilename)
...
def runsetup(projectname, cythonlist, cythonModlist):  #, no_cython
...
#     sys.stdout.write("\n")
    ...
    setup(name=projectname,
          ...
          description="Neural network toolbox utilities",
...
if __name__ == "__main__":
    ...
    if is_test:
        ...
        runsetup(projectname, cythonlist, cythonpathlist) #no_cython
    ...
    if distaction and not no_cython:
        ...
        print("afterRun done")
    if distaction:
        print("metaphor_nntoolbox setup done")