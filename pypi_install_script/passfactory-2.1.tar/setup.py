...
setup(
  ...
  url = 'https://github.com/Tester86/passfactory',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Tester86/passfactory/passfactory.py/v_01.tar.gz',    # I explain this later on
  keywords = ['PASSWORD', 'TOOLBOX', 'GENERATOR'],   # Keywords that define your package best
