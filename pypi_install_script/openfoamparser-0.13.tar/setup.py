...
setup(
    ...
    description='Lightweight library to parse OpenFOAM files using Numpy (Ofpp Fork)',  # Optional
    ...
    url='https://www.ccs-labs.org/',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='CCS-Labs',  # Optional
    ...
    keywords='openfoam cfd parser',  # Optional
