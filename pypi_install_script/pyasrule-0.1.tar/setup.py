...
setup(
  name = 'pyasrule',         # How you named your package folder (MyLib)
  packages = ['pyasrule'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Python package for generating association rule using item to item collaborative filtering with multiple evaluation metrics',   # Give a short description about your library
