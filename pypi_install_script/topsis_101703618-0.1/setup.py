...
setup(
  ...
  url = 'https://github.com/vikramu9td/topsis',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/vikramu9td/topsis/archive/0.1.tar.gz',    # I explain this later on
