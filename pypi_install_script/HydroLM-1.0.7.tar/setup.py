...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['numpy', 'pandas', 'statsmodels', 'matplotlib', 'scipy']
...
setup(
    ...
    description='Class and functions to do linear regressions for hydrology',  # Required
    ...
    url='https://github.com/mullenkamp/HydroLM',  # Optional
