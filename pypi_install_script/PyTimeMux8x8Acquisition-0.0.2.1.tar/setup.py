...
setup(name="PyTimeMux8x8Acquisition",
      version=_version,
      description="8x8 matrix device acquisition tools",
      ...
      url="https://github.com/jmartinezaguilar/PyTimeMux8x8Acquisition",
      download_url="https://github.com/jmartinezaguilar/PyTimeMux8x8Acquisition",
      license="GPLv3",
