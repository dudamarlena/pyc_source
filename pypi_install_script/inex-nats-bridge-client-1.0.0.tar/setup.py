...
setup(
    ...
    name="inex-nats-bridge-client",  # Required
    ...
    description="DMZ-LAN NATS bridge client",  # Optional
    ...
    author_email="dev.viten.center@gmail.com",  # Optional
