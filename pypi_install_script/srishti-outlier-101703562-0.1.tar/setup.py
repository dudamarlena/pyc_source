...
setup(
  name = 'srishti-outlier-101703562',         # How you named your package folder (MyLib)
  packages = ['srishti-outlier-101703562'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'for outlier row removal',   # Give a short description about your library
  ...
  keywords = ['OUTLIER', 'PACKAGE', 'ROW REMOVAL'],   # Keywords that define your package best
