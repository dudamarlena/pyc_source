...
setup(
  name = 'secretig',         # How you named your package folder (MyLib)
  packages = ['secretig'],   # Chose the same as "name"
  version = '0.0.1.6',      # Start with a small number and increase it with every change you make
