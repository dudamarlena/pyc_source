...
setup(
  name = 'igtool',         # How you named your package folder (MyLib)
  packages = ['igtool'],   # Chose the same as "name"
  version = '0.0.0.7',      # Start with a small number and increase it with every change you make
