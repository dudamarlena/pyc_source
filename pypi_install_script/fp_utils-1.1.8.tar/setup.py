...
setup(
    ...
    download_url = 'https://github.com/fifth-partners/fp-utils/archive/1.1.8.tar.gz',
    ...
    'pymongo', 'datetime', 'bs4', 'pathlib','pandas','numpy','requests','oauth2client','python-dotenv','boto3','os',
    'pybase64','ast'],
    classifiers = [
