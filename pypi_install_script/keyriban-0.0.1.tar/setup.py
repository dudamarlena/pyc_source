...
setup(
    name='keyriban',
    version=coerce_file('keyriban/__init__.py').version,
    description=coerce_file('keyriban/__init__.py').docstring,
    long_description=coerce_file('README.md'),
    author='Fabrice Laporte',
    author_email='kraymer@gmail.com',
    url='https://github.com/KraYmer/keyriban',
    license='MIT',
    platforms='Linux',
    packages=['keyriban', 'keyriban.view'],
    include_package_data=True,
    entry_points={
        'console_scripts': [
            'keyriban = keyriban:keyriban_cli',
        ],
    },
)
