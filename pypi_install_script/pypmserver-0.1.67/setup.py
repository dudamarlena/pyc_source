...
from pypmserver.info import NAME_SHORT, DESCR, VER_MAJOR, VER_MINOR
...
setuptools.setup(
  ...
  license      = 'GPLv3',
  packages     = [ NAME_SHORT ],
  package_data = { NAME_SHORT : [
    'templates/*.html',
  ] },
  zip_safe     = True,
  install_requires = [
    ##  Hack that emulates local context in 'with' statements. Allows to
    ##  write clean, ruby-like embedded DSL.
    'pyedsl',
    ##  Standalone web server.
    'cherrypy',
    ##  |cherrypy| can use it for regexp HTTP routing.
    'routes',
    ##  Object relational mapper for database manipulation.
    'sqlobject',
    ##  Template system for web server.
    'jinja2',
  ],
  entry_points = {
    'console_scripts' : [
      '{0} = {0}.main:main'.format( NAME_SHORT ),
    ],
  },
