...
setup(name         = 'robotframework-sofrecomappiumlibrary',
      version      = VERSION,
      description  = 'app testing library for Robot Framework',
      long_description = open(join(dirname(__file__), 'README.rst')).read(),
      author       = 'Dhia Eddine Saidi',
      author_email = '<dhiasaidi.ensit@gmail.com>',
      url          = 'https://github.com/DhiaEddineSaidi/robotfrmework-sofrecomappiumlibrary',
