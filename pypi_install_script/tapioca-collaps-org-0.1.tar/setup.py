...
setup(
    name='tapioca-collaps-org',
    version=get_version(package),
    description='collaps org API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/InzGIBA/tapioca-collaps-org',
    packages=[
        'tapioca_collaps_org',
    ],
    package_dir={'tapioca_collaps_org': 'tapioca_collaps_org'},
    include_package_data=True,
    install_requires=requirements,
    license="MIT",
    zip_safe=False,
    keywords='collaps-org',
    classifiers=[
