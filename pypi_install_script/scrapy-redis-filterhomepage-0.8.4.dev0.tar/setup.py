...
setup(
    name='scrapy-redis-filterhomepage',

    version=read_file('VERSION'),

    description="Redis-filterhomepage for Scrapy.",
    author="deng jian ping ",
    author_email='754335383@qq.com',
    ...
    license="MIT",
    keywords='scrapy-redis-filterhomepage',
    classifiers=[
