...
setuptools.setup(
  ...
  version = '0.2.4.2',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'devcon_win - interact with devcon.exe in NT systems',
  long_description = ld,
  ...
  download_url = 'https://github.com/Shivanshu26shiv/devcon_win/archive/v_02.4.2.tar.gz',    # I explain this later on
