...
setup(
    ...
    keywords='python packages import',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/LotharSpiegel/squyrrel/issues',
        #'Funding': 'https://donate.pypi.org',
        'Source': 'https://github.com/LotharSpiegel/squyrrel',
    },
)