...
setup(
    ...
    packages=['goescalibration', 'goescalibration.channels'],
    url='https://github.com/gersolar/goescalibration',
    license='MIT',
    description=('A python library that allow to calibrate netcdf images '
                 'of the NOAA CLASS (Comprehensive Large Array-Data '
                 'Stewardship System).'),
