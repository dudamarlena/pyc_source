...
setup(
    ...
    install_requires=[
        'function_scheduling_distributed_framework==6.3',
    ]
)
"""
打包上传
...
twine upload dist/fsdf-6.2.tar.gz
twine upload dist/*


python -m pip install dfsf --upgrade -i https://pypi.org/simple   # 及时的方式，不用等待 阿里云 豆瓣 同步
"""
