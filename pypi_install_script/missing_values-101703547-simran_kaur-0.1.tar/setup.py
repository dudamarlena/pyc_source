...
setup(
      name = 'missing_values-101703547-simran_kaur',         # How you named your package folder (MyLib)
      packages = ['missing_values-101703547-simran_kaur'],   # Chose the same as "name"
      version = '0.1',      # Start with a small number and increase it with every change you make
      license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
      description = 'this is package for handling missing values',   # Give a short description about your library
