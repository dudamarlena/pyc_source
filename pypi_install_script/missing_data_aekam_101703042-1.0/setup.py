...
setup(
  name = 'missing_data_aekam_101703042',         # How you named your package folder (MyLib)
  packages = ['missing_data_aekam_101703042'],   # Chose the same as "name"
  version = '1.0',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Missing_Data',   # Give a short description about your library
